...
#'
#' Mirrors the Python `moirais.run_weighted_logistic_analysis()`. Fits a
...
#'
#' Mirrors the Python `moirais.compare_nested_logistic_models()`. Fits a
...
#'
#' Mirrors the Python `moirais.run_treatment_effects_analysis()`. Convenience
