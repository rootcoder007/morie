...
#'
#' Mirrors the Python `moirais.inspect_output()`. Reads a structured output
...
#'
#' Mirrors the Python `moirais.verify_statistical_output()`. Runs a small
#' suite of sanity checks on a JSON output containing fields commonly used
#' across MOIRAIS estimators: `ate`, `se`, `ci_lower`, `ci_upper`, `n`,
