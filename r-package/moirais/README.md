...
`moirais` is a dual-language (Python + R) scientific computing package for epidemiological and statistical modeling.

## What it does

- **87 exported R functions** across causal inference, sampling, psychometrics, OTIS correctional analysis, and more.
- Mirrors the Python `moirais.fn` library (5724 individual functions across 218 categories) for cross-language parity.
...
- Accesses the shared SQLite database (`moirais_datasets.db`) with 41 built-in datasets.
