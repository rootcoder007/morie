...
effect?" rather than "is there an effect at all?". MOIRAIS exposes
...
For a binomial proportion, MOIRAIS exposes Wilson, Clopper--Pearson
...
- For survey-weighted versions of `cohens_d` and `cramers_v`, see
