...
Beyond its causal-inference and survey-statistics surfaces, MOIRAIS
...
the Python `moirais.signal_processing` and
`moirais.homomorphic_deconvolution` modules. The R wrappers cover
...
- Spectral analysis with windowing, multitaper estimation, and
  ...
  `moirais.signal_processing` module --- with the same RichResult
...
- Homomorphic deconvolution and cepstral methods (used in forensic
  ...
  `moirais.homomorphic_deconvolution`.
