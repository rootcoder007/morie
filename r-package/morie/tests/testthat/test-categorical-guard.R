...
test_that("binary-treatment guard refuses factor coercion", {
  expect_error(
    morie:::.morie_guard_binary_treatment(factor(c("no", "yes")),
                                           "treated"),
    "level INDICES")
  expect_error(
    morie:::.morie_guard_binary_treatment(c(1, 2, 1), "treated"),
    "binary 0/1")
  expect_true(morie:::.morie_guard_binary_treatment(c(0, 1, NA),
                                                     "treated"))
})
