...
#'
#' Same source and same equations as \code{Neyman} -- Neyman, J. (1934),
#' Journal of the Royal Statistical Society 97(4), 558-625, JSTOR 2342192,
#' p. 580 eq. (39) and eq. (41), read as a rendered page image.  This entry
#' point differs only in taking the population size N = M_0 as its first
#' argument instead of the stratum means, and in checking it against
#' sum_h N_h, which eq. (39) requires to be the same number.
#'
...
#' \code{Neyman}; that file is the primary write-up.
#'
...
#'   roles; NULL skips the check and uses sum_h N_h.
...
#' @return list: estimate, allocation, allocation_int, variance, A, B, C,
#'   N, n, method.
#' @keywords internal
#' @examples
