...
#' @return Named list with ``covariance``, ``form``, ``cross``, ``jh``, ``j4h``, ``h``, ``n``, ``method``.
#' @references Fauzi and Maesono (2023), Theorem 1.4; Fauzi (2020), Kyushu University doctoral thesis, Theorem 2.1.7.
#' @examples
