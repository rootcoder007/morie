...
morie_dataset_catalog <- function() {
  entries <- list(
    ...
    list(key = "otisa01", name = "OTIS a01: Restrictive Confinement - Detailed Dataset",
    ...
    list(key = "otisb01", name = "OTIS b01: Segregation - Detailed Dataset",
    ...
    list(key = "otisb09", name = "OTIS b09: Individuals in Segregation - Number of Placements",
    ...
    list(key = "otisc11", name = "OTIS c11: Individuals in Segregation/RC by Aggregate Length",
    ...
    list(key = "tpshomicides", name = "TPS Homicides open-data events 2004-present",
    ...
    list(key = "tpsshootings", name = "TPS Shootings and Firearm Discharges 2004-present",
