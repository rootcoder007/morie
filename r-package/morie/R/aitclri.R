...
#' row in EXTERNAL_SOURCES.md.  The inverse of clr is the closure of the exponentiated
#' coordinates.  It is well defined for any real z, not only for z summing to zero:
