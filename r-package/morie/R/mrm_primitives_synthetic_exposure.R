...
#'
#' \enumerate{
#'   \item Fit \eqn{P(\text{trait} | \text{covariates})} on a national
...
#'     ACS / census to predict \eqn{P(\text{trait})} per area.
...
#'
#' \enumerate{
#'   \item Fit logistic \eqn{P(\text{trait} | \text{covariates})} on
