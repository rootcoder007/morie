...
#' row in EXTERNAL_SOURCES.md.  The squared distance printed immediately after equation
#' (10).  It is relative: it is unchanged by perturbing both arguments by the same
#' composition, and scales by |a| under powering.
#' @export
#' @examples
#' V <- c(1, 2, 3, 4, 5, 6, 7, 8)
#' Compdist(V, V)
