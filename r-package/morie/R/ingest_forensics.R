...
.MORIE_FORENSICS_DEFAULT_UA <- "morie/r (+https://github.com/rootcoder007/morie)"
...
morie_ingest_forensics_namus_missing <- function(
  ...
  # projections -> empty results even when count > 0). This projection
  # set was validated against the live API 2026-07.
  body <- list(
