...
#' delta = 0.5 (c_{-1} - c_{+1}) / (c_{-1} - 2 c_0 + c_{+1}), zero when the
#' criterion is symmetric about the integer minimiser, so an exactly shifted
#' pair recovers its shift exactly.
#'
