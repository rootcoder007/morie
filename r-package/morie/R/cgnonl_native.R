...
#' .cgnonl_dot
#'
#' A step of the cgnonl_native implementation. Called by \code{.cgnonl_exact_quadratic_step}, \code{cgnonl_beta_fletcher_reeves}, \code{cgnonl_beta_polak_ribiere} and 2 others in the module.
