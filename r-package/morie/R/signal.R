...
#' Real cepstrum
#'
#' Real cepstrum \\eqn{c[n] = \\mathrm{IFFT}(\\log |\\mathrm{FFT}(x)|)}. Useful
...
#'
#' Complex cepstrum: inverse FFT of \\eqn{\\log X(\\omega)} using the unwrapped
...
#'
#' Estimates the DFA scaling exponent \\eqn{\\alpha}. White noise gives
#' \\eqn{\\alpha \\approx 0.5}; pink (1/f) noise \\eqn{\\alpha \\approx 1.0};
#' Brownian motion \\eqn{\\alpha \\approx 1.5}.
#'
...
#' \\log_{10}(N / (N + 0.4 N_\\delta)))}, where \\eqn{N_\\delta} counts sign
...
#' signal, computes \\eqn{-x^2 \\log x^2}, then box-smooths over a 20 ms
