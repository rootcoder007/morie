...
.morie_random_uniform <- function(n, seed = 0, stream = 0) {
  ...
  ctr <- cbind(idx %% 4294967296, idx %/% 4294967296,
               rep(stream %% 4294967296, blocks), rep(0, blocks))
  words <- .morie_philox4x32(ctr, c(seed %% 4294967296,
...
.MORIE_AS241_A <- c(3.3871328727963666080, 1.3314166789178437745e2,
...
.MORIE_AS241_B <- c(1, 4.2313330701600911252e1, 6.8718700749205790830e2,
                    5.3941960214247511077e3, 2.1213794301586595867e4,
                    3.9307895800092710610e4, 2.8729085735721942674e4,
                    5.2264952788528545610e3)
.MORIE_AS241_C <- c(1.42343711074968357734, 4.63033784615654529590,
                    5.76949722146069140550, 3.64784832476320460504,
                    1.27045825245236838258, 2.41780725177450611770e-1,
                    2.27238449892691845833e-2, 7.74545014278341407640e-4)
.MORIE_AS241_D <- c(1, 2.05319162663775882187, 1.67638483018380384940,
                    6.89767334985100004550e-1, 1.48103976427480074590e-1,
                    1.51986665636164571966e-2, 5.47593808499534494600e-4,
                    1.05075007164441684324e-9)
.MORIE_AS241_E <- c(6.65790464350110377720, 5.46378491116411436990,
                    1.78482653991729133580, 2.96560571828504891230e-1,
                    2.65321895265761230930e-2, 1.24266094738807843860e-3,
                    2.71155556874348757815e-5, 2.01033439929228813265e-7)
.MORIE_AS241_F <- c(1, 5.99832206555887937690e-1, 1.36929880922735805310e-1,
