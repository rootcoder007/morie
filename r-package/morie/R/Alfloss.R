...
#' @examples
#' morie:::Alfloss(fape = c(1, 2, 3, 4, 5, 6, 7, 8), aux = c(1, 2, 3, 4, 5, 6, 7, 8), dist = c(1, 2, 3, 4, 5, 6, 7, 8), msa = c(1, 2, 3, 4, 5, 6, 7, 8), conf = 0.5)
Alfloss <- function(fape, aux, dist, msa, conf, expres = 0, viol = 0,
  ...
  terms <- list(fape = 0.5 * fape, aux = 0.5 * aux, dist = 0.3 * dist,
  ...
  list(terms = terms, estimate = total * scale, unscaled = total,
