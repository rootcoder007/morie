...
.morie_db_index_registry <- function() {
  list(
    ...
    c02 = list(
      ...
      list(
        name = "idx_c02_year_region",
        cols = c("EndFiscalYear", "Region_MostRecentPlacement")
      )
    ),
    c03 = list(
      list(
        name = "idx_c03_year_race",
        cols = c("EndFiscalYear", "Race")
      )
    ),
    c04 = list(
      list(
        name = "idx_c04_year_race",
        cols = c("EndFiscalYear", "Race")
      )
    ),
    c05 = list(
      list(
        name = "idx_c05_year_religion",
        cols = c("EndFiscalYear", "Religion")
      )
    ),
    c06 = list(
      list(
        name = "idx_c06_year_age",
        cols = c("EndFiscalYear", "Age_Category")
      )
    ),
    c07 = list(
      list(
        name = "idx_c07_year_alert",
        cols = c("EndFiscalYear", "Alert_Type")
      )
    ),
    c08 = list(
      list(
        name = "idx_c08_year_religion",
        cols = c("EndFiscalYear", "Religion")
      )
    ),
    c09 = list(
      list(
        name = "idx_c09_year_age",
        cols = c("EndFiscalYear", "Age_Category")
      )
    ),
    c10 = list(
...
.morie_db_indexes_for <- function(table_name) {
  ...
  tps_pat <- paste0(
    "^(tps_|assault|robbery|homicide|theft|hate|bicycle|",
