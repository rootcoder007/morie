...
#
# Reproducible generator for the morie hex sticker (r-package/morie + repo README).
#
...
g <- ggplot() +
  ...
  # wordmark
  annotate("text", 0, -0.52, label = "morie",
           family = "cantarell", fontface = "bold",
           size = 5.8, colour = "#241f31") +
  annotate("text", 0, -0.72, label = "\u68ee",
           family = "notojp", size = 3.4, colour = "#26a269") +
