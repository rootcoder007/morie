...
from morie.fn.chapman_hall_crc_handbooks_of_modern_statistical_methods_jos16e6 import (
    chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_16_equation_6,
)
