...
from morie.fn.spatiotemporal_methods_in_environmental_epidemiology_with_r_8e6 import (
    spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_8_equation_6,
)
