"""Verification tests for david_j_morin_probability_for_the_enthusiastic_beginner6e43.

Morin (2016), eq (6.42)-(6.49) -- the least-squares line. Expected values are recomputed
...
def test_least_squares_line_on_the_books_worked_data():
    ...
    res = david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_43(x, y)
