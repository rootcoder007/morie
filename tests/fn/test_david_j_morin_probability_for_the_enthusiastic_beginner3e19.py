...
import numpy as np
import pytest
from morie.fn.david_j_morin_probability_for_the_enthusiastic_beginner3e19 import david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_19
