...
from morie.fn.statistics_fourth_edition_david_freeman_robert_pisani_and_ro17u87 import (
    statistics_fourth_edition_david_freeman_robert_pisani_and_ro_chapter_17_unnumbered_87,
)
