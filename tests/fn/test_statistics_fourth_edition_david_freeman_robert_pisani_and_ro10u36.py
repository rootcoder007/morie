...
from morie.fn.statistics_fourth_edition_david_freeman_robert_pisani_and_ro10u36 import (
    statistics_fourth_edition_david_freeman_robert_pisani_and_ro_chapter_10_unnumbered_36,
)
