"""Verification tests for msm207.

The stub generator stamped several extracted page fragments with the
same function name, so mvsml_ridge_lasso_elastic_eq_9_30 lives once in msm204 and this module
...
import morie.fn.msm207 as alias
...
def test_the_alias_carries_the_hosts_documentation_unchanged():
    assert alias.mvsml_ridge_lasso_elastic_eq_9_30.__module__ == getattr(host, "mvsml_ridge_lasso_elastic_eq_9_30").__module__
    assert alias.mvsml_ridge_lasso_elastic_eq_9_30.__doc__ == getattr(host, "mvsml_ridge_lasso_elastic_eq_9_30").__doc__


def test_the_alias_module_carries_its_own_cheatsheet():
    assert "msm207" in alias.cheatsheet()
