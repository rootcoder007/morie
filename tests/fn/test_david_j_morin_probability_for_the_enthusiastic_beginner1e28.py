"""Verification tests for david_j_morin_probability_for_the_enthusiastic_beginner1e28.

Morin (2016), eq (1.28), (1.60) -- Pascal's addition rule. Expected values are recomputed
...
def test_pascals_rule_holds_and_both_terms_are_returned():
    ...
    for n, k in ((5, 2), (9, 4), (12, 1), (7, 6)):
        res = david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_28(n, k)
...
def test_pascals_rule_needs_both_right_hand_terms_to_exist():
    with pytest.raises(ValueError):
        david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_28(5, 0)
    with pytest.raises(ValueError):
        david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_28(5, 5)
