"""Verification tests for msm093.

The stub generator stamped several extracted page fragments with the
same function name, so mvsml_bayesian_regression_pt2_eq_7_3 lives once in msm092 and this module
...
import morie.fn.msm093 as alias
...
def test_the_alias_module_carries_its_own_cheatsheet():
    assert "msm093" in alias.cheatsheet()
