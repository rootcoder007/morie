...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo2u207 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_2_unnumbered_207,
)
