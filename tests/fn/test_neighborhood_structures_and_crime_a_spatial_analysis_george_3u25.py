...
from morie.fn.neighborhood_structures_and_crime_a_spatial_analysis_george_3u25 import (
    neighborhood_structures_and_crime_a_spatial_analysis_george__chapter_3_unnumbered_25,
)
