...
from morie.fn.cornelius_llewellyn_j_harrington_donna_a_social_justice_appr6u5 import (
    cornelius_llewellyn_j_harrington_donna_a_social_justice_appr_chapter_6_unnumbered_5,
)
