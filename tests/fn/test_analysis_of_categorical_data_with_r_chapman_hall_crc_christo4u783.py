...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo4u783 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_4_unnumbered_783,
)
