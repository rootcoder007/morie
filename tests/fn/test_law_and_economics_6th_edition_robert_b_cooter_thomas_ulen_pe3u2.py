...
from morie.fn.law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe3u2 import (
    law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_3_unnumbered_2,
)
