...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo1u300 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_1_unnumbered_300,
)
