...
from morie.fn.franz_kronthaler_statistics_applied_with_the_r_commander_dat3u38 import (
    franz_kronthaler_statistics_applied_with_the_r_commander_dat_chapter_3_unnumbered_38,
)
