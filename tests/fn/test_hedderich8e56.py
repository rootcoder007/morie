"""Verification tests for hedderich8e56.

Hedderich, eq (8.56) -- the Wald interval for a logistic coefficient. Every expected value is recomputed in the test body
...
from morie.fn.hedderich8e56 import hedderich_chapter_8_equation_56
...
def test_wald_p_value_is_the_two_sided_normal_tail():
    ...
    res = hedderich_chapter_8_equation_56([1.959963984540054], [1.0], level=0.95)
...
def test_wald_rejects_a_non_positive_standard_error():
    with pytest.raises(ValueError):
        hedderich_chapter_8_equation_56([1.0], [0.0])
    with pytest.raises(ValueError):
        hedderich_chapter_8_equation_56([1.0, 2.0], [1.0])
