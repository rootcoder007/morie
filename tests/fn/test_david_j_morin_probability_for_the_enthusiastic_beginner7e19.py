...
from morie.fn.david_j_morin_probability_for_the_enthusiastic_beginner7e19 import (
    david_j_morin_probability_for_the_enthusiastic_beginner_chapter_7_equation_19,
)
