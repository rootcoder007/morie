...
from morie.fn.springer_texts_in_statistics_series_gareth_james_daniela_wit4e6 import (
    springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_4_equation_6,
)
