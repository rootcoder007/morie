...
from morie.fn.statistics_fourth_edition_david_freeman_robert_pisani_and_ro7u187 import (
    statistics_fourth_edition_david_freeman_robert_pisani_and_ro_chapter_7_unnumbered_187,
)
