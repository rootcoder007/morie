...
from morie.fn.edward_frenkel_love_and_math_the_heart_of_hidden_reality18u95 import (
    edward_frenkel_love_and_math_the_heart_of_hidden_reality_chapter_18_unnumbered_95,
)
