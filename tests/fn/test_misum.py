...
class TestMiSummary:
    def test_returns_dataframe(self):
        fits = [
            {
                "level": "configural",
                "fit": {"chi2": 100, "df": 50, "cfi": 0.95, "tli": 0.94, "rmsea": 0.04, "srmr": 0.05},
                "delta_fit": {},
                "passed": True,
            },
            {
                "level": "metric",
                "fit": {"chi2": 110, "df": 55, "cfi": 0.94, "tli": 0.93, "rmsea": 0.045, "srmr": 0.055},
                "delta_fit": {"delta_cfi": 0.01, "delta_rmsea": 0.005},
                "passed": True,
            },
        ]
