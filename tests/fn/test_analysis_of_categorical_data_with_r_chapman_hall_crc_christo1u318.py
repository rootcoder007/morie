...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo1u318 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_1_unnumbered_318,
)
