...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo3u499 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_unnumbered_499,
)
