...
import numpy as np
import pytest
from moirais.fn.information_theory_mackay1e41 import information_theory_mackay_chapter_1_equation_41


def test_information_theory_mackay1e41_basic():
    """Test basic functionality."""
    x = np.random.default_rng(42).normal(0, 1, 100)
    result = information_theory_mackay_chapter_1_equation_41(x)
