...
import morie.fn.msm051 as alias
from morie.fn.msm051 import mvsml_bayesian_regression_eq_6_4
...
def test_the_alias_module_carries_its_own_cheatsheet():
    assert "msm051" in alias.cheatsheet()
