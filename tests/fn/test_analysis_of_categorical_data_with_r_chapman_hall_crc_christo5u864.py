...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo5u864 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_5_unnumbered_864,
)
