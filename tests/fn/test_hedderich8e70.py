"""Verification tests for hedderich8e70.

Hedderich, eq (8.70) -- McFadden's pseudo R-squared. Every expected value is recomputed in the test body
...
def test_the_three_pseudo_r2_measures():
    ...
    res = hedderich_chapter_8_equation_70(ll, ll0, n)
...
def test_a_model_no_better_than_the_null_scores_zero():
    res = hedderich_chapter_8_equation_70(-60.0, -60.0, 100)
...
def test_nagelkerke_rescales_cox_snell_to_reach_one():
    ...
    res = hedderich_chapter_8_equation_70(-1e-9, -60.0, 100)
...
def test_requires_a_strictly_negative_null_log_likelihood():
    with pytest.raises(ValueError):
        hedderich_chapter_8_equation_70(-10.0, 0.0, 50)
