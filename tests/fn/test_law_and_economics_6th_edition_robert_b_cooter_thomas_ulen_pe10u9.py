...
from morie.fn.law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u9 import (
    law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_9,
)
