...
from morie.fn.david_j_morin_probability_for_the_enthusiastic_beginner4e79 import (
    david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_79,
)
