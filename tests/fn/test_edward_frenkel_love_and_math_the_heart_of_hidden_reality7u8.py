...
from morie.fn.edward_frenkel_love_and_math_the_heart_of_hidden_reality7u8 import (
    edward_frenkel_love_and_math_the_heart_of_hidden_reality_chapter_7_unnumbered_8,
)
