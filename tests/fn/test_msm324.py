...
same function name, so mvsml_functional_regression_eq_15_1 lives once in msm323 and this module
...
def test_the_alias_carries_the_hosts_documentation_unchanged():
    assert alias.mvsml_functional_regression_eq_15_1.__module__ == getattr(host, "mvsml_functional_regression_eq_15_1").__module__
    assert alias.mvsml_functional_regression_eq_15_1.__doc__ == getattr(host, "mvsml_functional_regression_eq_15_1").__doc__
