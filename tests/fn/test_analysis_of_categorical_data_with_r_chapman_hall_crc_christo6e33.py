...
from morie.fn.analysis_of_categorical_data_with_r_chapman_hall_crc_christo6e33 import (
    analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_33,
)
