...
from morie.fn.david_j_morin_probability_for_the_enthusiastic_beginner5u402 import (
    david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_402,
)
