/*
 * semipar_kernels.h — MOIRAIS Semiparametric Kernel Operations
 *
...
#ifndef MOIRAIS_SEMIPAR_KERNELS_H
#define MOIRAIS_SEMIPAR_KERNELS_H
...
#endif /* MOIRAIS_SEMIPAR_KERNELS_H */
