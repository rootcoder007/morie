...
Stores ML-KEM-768 key pairs at ``~/.moirais/keys/keystore.json``, encrypted
...
_DEFAULT_PATH = "~/.moirais/keys/keystore.json"
_SCRYPT_N = 2**14
_SCRYPT_R = 8
_SCRYPT_P = 1
_SCRYPT_DKLEN = 32
...
def create_keystore(password: str, path: str = _DEFAULT_PATH) -> None:
    ...
    :param path: File path (default ``~/.moirais/keys/keystore.json``).
