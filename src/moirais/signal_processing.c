...
/*
 * signal_processing.c — MOIRAIS Signal Processing Kernels
 *
 * References:
...
int moirais_psd_welch(
    ...
    moirais_window_hanning(win, seg_len);
...
int moirais_convolve_fft(
    ...
    moirais_fft(xr, xi, nfft);
    moirais_fft(hr, hi, nfft);
