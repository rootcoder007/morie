"""
Environmental-health composition module for MOIRAIS.

Composes primitives from `moirais.fn.*` (IPW, AIPW, DML, PLR, etc.) into
...
def exposure_response_sensitivity(
    ...
    *,
    ...
    Wraps :func:`moirais.fn.plr.estimate_plr` (RidgeCV nuisances, continuous
...
def cheatsheet() -> str:
    return (
        "moirais.envhealth: concentration_response_pm25/no2, attributable_fraction, "
