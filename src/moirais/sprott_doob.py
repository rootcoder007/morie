"""moirais.sprott_doob — Sprott & Doob (CRIMSL UToronto) SIU analyses.
...
author. This is documented and indexed in `moirais.siuiap.
...
def analyze_table23_regional_torture_rates() -> RichResult:
    ...
    return RichResult(
        ...
        interpretation=(
            ...
            "Companion analysis in moirais: Ontario's *provincial* "
...
def analyze_iedm_table1_population() -> RichResult:
    ...
    return RichResult(
        ...
        interpretation=(
            ...
            "subgroup analyzers in moirais.otis_all_analyze cover "
