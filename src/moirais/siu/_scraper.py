...
# rest of moirais uses for pickled / RDS / SQLite caches.
# __file__ is .../libexec/config/tools/py-package/moirais/siu/_scraper.py
# parents[6] climbs back to dev/sphinx/project/.
DEFAULT_CACHE = Path(__file__).resolve().parents[6] / "data" / "cache" / "siu"

USER_AGENT = (
    "moirais-siu-scraper/0.1 "
    "(+https://github.com/hadesllm/moirais; research; rate-limited)"
)
