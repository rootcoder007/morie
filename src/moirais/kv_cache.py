"""TurboQuant-compressed KV cache for MOIRAIS's inference engine.
...
This plugs into :class:`moirais.engine.MOIRAISEngine` to provide KV-cache
...
class TurboQuantKVCache:
    ...
    Each key/value vector is quantized via :func:`moirais.quant.turboquant_mse`
