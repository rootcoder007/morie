...
def cheatsheet(fn_name: str) -> str:
    ...
    """
    try:
        module = importlib.import_module(f"moirais.fn.{fn_name}")
    ...
    parts.append(f"Import     from moirais.fn import {fn_name}")
    if ref_text:
