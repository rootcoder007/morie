...
Produces publication-ready statistical reports from MOIRAIS pipeline outputs.
...
def generate_methods(
    *,
    ...
    if software:
        ...
        stat_parts.append(
            "Analyses were performed using the MOIRAIS (Methods for Observational Inference and Robust Analysis of Interventions in Scientific Experimentation) Python package."
        )
...
def generate_reproducibility_statement(
    *,
    ...
    if software:
        ...
        parts.append("Analyses were conducted using the MOIRAIS Python package.")
...
def generate_full_report(
    ...
    *,
    title: str = "MOIRAIS Analysis Report",
    ...
    ----------
    results_dir : str | Path
        Directory containing CSV outputs from MOIRAIS modules.
    title : str
        Report title.
    ...
    if authors is None:
        authors = ["MOIRAIS Analysis Pipeline"]
