# describe('wvcor') — wavelet_correlation
...
`print(result)` render. See `moirais.fn.describe('wvcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvcor import *
import numpy as np
# See the function signature in fn/wvcor.py for argument names.
```
