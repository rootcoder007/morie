...
`print(result)` render. See `moirais.fn.describe('mssts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssts import *
import numpy as np
# See the function signature in fn/mssts.py for argument names.
```
