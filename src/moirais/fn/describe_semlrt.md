...
`print(result)` render. See `moirais.fn.describe('semlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semlrt import *
import numpy as np
# See the function signature in fn/semlrt.py for argument names.
```
