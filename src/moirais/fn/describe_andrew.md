...
`print(result)` render. See `moirais.fn.describe('andrew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.andrew import *
import numpy as np
# See the function signature in fn/andrew.py for argument names.
```
