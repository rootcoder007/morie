...
__all__ = ["wilcox_chapter_12_unnumbered_1387"]


def wilcox_chapter_12_unnumbered_1387(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 4(2.58)(8)(1/10 + 1/10) = 4 .06, reject. (f) f = 2.62, A = 11.3, reject. 4.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1387')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1387: GeneralStatistics expression (auto-extracted; see ref)."
