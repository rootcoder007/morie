...
`print(result)` render. See `moirais.fn.describe('gafdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gafdir import *
import numpy as np
# See the function signature in fn/gafdir.py for argument names.
```
