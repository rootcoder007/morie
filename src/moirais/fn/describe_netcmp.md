# describe('netcmp') — network_comparison
...
`print(result)` render. See `moirais.fn.describe('netcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcmp import *
import numpy as np
# See the function signature in fn/netcmp.py for argument names.
```
