...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_43"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_43(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] δk(x)= x· μk
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit2u43')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit2u43: GeneralStatistics expression (auto-extracted; see ref)."
