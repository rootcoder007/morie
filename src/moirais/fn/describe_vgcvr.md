...
`print(result)` render. See `moirais.fn.describe('vgcvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcvr import *
import numpy as np
# See the function signature in fn/vgcvr.py for argument names.
```
