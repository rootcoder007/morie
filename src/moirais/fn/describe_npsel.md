...
`print(result)` render. See `moirais.fn.describe('npsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npsel import *
import numpy as np
# See the function signature in fn/npsel.py for argument names.
```
