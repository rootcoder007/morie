...
__all__ = ["hedderich_chapter_9_unnumbered_2028"]


def hedderich_chapter_9_unnumbered_2028(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [10 + 10−2] + [10 + 10−2] = 2.535> 2.028 = t36;0.975
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2028')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2028: GeneralStatistics expression (auto-extracted; see ref)."
