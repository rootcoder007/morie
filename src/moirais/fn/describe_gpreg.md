# describe('gpreg') — gaussian_process_regression
...
`print(result)` render. See `moirais.fn.describe('gpreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpreg import *
import numpy as np
# See the function signature in fn/gpreg.py for argument names.
```
