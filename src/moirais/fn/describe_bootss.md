# describe('bootss') — bootstrap_survey
...
`print(result)` render. See `moirais.fn.describe('bootss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bootss import *
import numpy as np
# See the function signature in fn/bootss.py for argument names.
```
