...
__all__ = ["wilcox_chapter_13_unnumbered_1105"]


def wilcox_chapter_13_unnumbered_1105(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: regci(x, y, regfun = tsreg, nboot = 599, alpha = 0.05, SEED = TRUE, pr =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1105')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1105: GeneralStatistics expression (auto-extracted; see ref)."
