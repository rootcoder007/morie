# describe('pseudo') — path_specific_effect
...
`print(result)` render. See `moirais.fn.describe('pseudo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pseudo import *
import numpy as np
# See the function signature in fn/pseudo.py for argument names.
```
