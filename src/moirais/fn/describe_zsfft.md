...
`print(result)` render. See `moirais.fn.describe('zsfft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsfft import *
import numpy as np
# See the function signature in fn/zsfft.py for argument names.
```
