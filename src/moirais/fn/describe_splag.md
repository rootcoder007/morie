...
`print(result)` render. See `moirais.fn.describe('splag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splag import *
import numpy as np
# See the function signature in fn/splag.py for argument names.
```
