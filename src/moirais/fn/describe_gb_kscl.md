# describe('gb_kscl') — gibbons_ks_critical_values
...
`print(result)` render. See `moirais.fn.describe('gb_kscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_kscl import *
import numpy as np
# See the function signature in fn/gb_kscl.py for argument names.
```
