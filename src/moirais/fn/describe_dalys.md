# describe('dalys') — disability_adjusted_life_years
...
`print(result)` render. See `moirais.fn.describe('dalys')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dalys import *
import numpy as np
# See the function signature in fn/dalys.py for argument names.
```
