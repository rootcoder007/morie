# describe('zipmd') — zero_inflated_poisson
...
`print(result)` render. See `moirais.fn.describe('zipmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zipmd import *
import numpy as np
# See the function signature in fn/zipmd.py for argument names.
```
