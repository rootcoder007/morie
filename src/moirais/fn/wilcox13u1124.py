...
__all__ = ["wilcox_chapter_13_unnumbered_1124"]


def wilcox_chapter_13_unnumbered_1124(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: xlab="X", ylab="Y", zlab="", theta=50, phi=25) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1124')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1124: GeneralStatistics expression (auto-extracted; see ref)."
