...
`print(result)` render. See `moirais.fn.describe('srhm3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srhm3 import *
import numpy as np
# See the function signature in fn/srhm3.py for argument names.
```
