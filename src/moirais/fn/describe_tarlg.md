...
`print(result)` render. See `moirais.fn.describe('tarlg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tarlg import *
import numpy as np
# See the function signature in fn/tarlg.py for argument names.
```
