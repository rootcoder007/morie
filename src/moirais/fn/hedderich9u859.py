...
__all__ = ["hedderich_chapter_9_unnumbered_859"]


def hedderich_chapter_9_unnumbered_859(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (3) P (X <15.11) = 1−0.06 = 0.94;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u859')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u859: GeneralStatistics expression (auto-extracted; see ref)."
