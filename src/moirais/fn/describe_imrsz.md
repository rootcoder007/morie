# describe('imrsz') — image_resize

## WHAT IT DOES

Bilinear interpolation image resize. 'Real knowledge is to know the extent of one's ignorance. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('imrsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imrsz import *
import numpy as np
# See the function signature in fn/imrsz.py for argument names.
```
