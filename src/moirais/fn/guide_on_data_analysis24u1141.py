...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1141"]


def guide_on_data_analysis_chapter_24_unnumbered_1141(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑆𝑆𝐴𝐵 = 𝑆𝑆𝑇𝑂 − 𝑆𝑆𝐸 − 𝑆𝑆𝐴 − 𝑆𝑆𝐵
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1141')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1141: GeneralStatistics expression (auto-extracted; see ref)."
