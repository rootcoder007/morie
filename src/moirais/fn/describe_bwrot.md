...
`print(result)` render. See `moirais.fn.describe('bwrot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwrot import *
import numpy as np
# See the function signature in fn/bwrot.py for argument names.
```
