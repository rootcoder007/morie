...
__all__ = ["hedderich_chapter_9_unnumbered_3279"]


def hedderich_chapter_9_unnumbered_3279(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆy−ˆ y(i) = X′( ˆβ−ˆβ(i)) withi = 1,...,n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3279')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3279: GeneralStatistics expression (auto-extracted; see ref)."
