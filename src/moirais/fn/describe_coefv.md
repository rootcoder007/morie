# describe('coefv') — coefficient_of_variation
...
`print(result)` render. See `moirais.fn.describe('coefv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coefv import *
import numpy as np
# See the function signature in fn/coefv.py for argument names.
```
