# describe('micomp') — mi_compare_models
...
`print(result)` render. See `moirais.fn.describe('micomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.micomp import *
import numpy as np
# See the function signature in fn/micomp.py for argument names.
```
