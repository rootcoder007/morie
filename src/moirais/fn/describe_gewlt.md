...
`print(result)` render. See `moirais.fn.describe('gewlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gewlt import *
import numpy as np
# See the function signature in fn/gewlt.py for argument names.
```
