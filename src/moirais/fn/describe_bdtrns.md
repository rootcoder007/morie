# describe('bdtrns') — bound_transport
...
`print(result)` render. See `moirais.fn.describe('bdtrns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdtrns import *
import numpy as np
# See the function signature in fn/bdtrns.py for argument names.
```
