...
`print(result)` render. See `moirais.fn.describe('xvrig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xvrig import *
import numpy as np
# See the function signature in fn/xvrig.py for argument names.
```
