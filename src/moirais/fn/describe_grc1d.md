# describe('grc1d') — geron_causal_1d_cnn
...
`print(result)` render. See `moirais.fn.describe('grc1d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grc1d import *
import numpy as np
# See the function signature in fn/grc1d.py for argument names.
```
