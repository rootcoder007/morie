# describe('flmtst') — fleming_harrington
...
`print(result)` render. See `moirais.fn.describe('flmtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flmtst import *
import numpy as np
# See the function signature in fn/flmtst.py for argument names.
```
