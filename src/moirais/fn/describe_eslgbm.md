...
`print(result)` render. See `moirais.fn.describe('eslgbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslgbm import *
import numpy as np
# See the function signature in fn/eslgbm.py for argument names.
```
