# describe('aitdrf') — dirichlet_fit_mom
...
`print(result)` render. See `moirais.fn.describe('aitdrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdrf import *
import numpy as np
# See the function signature in fn/aitdrf.py for argument names.
```
