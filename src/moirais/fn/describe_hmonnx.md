# describe('hmonnx') — geron_onnx_export
...
`print(result)` render. See `moirais.fn.describe('hmonnx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmonnx import *
import numpy as np
# See the function signature in fn/hmonnx.py for argument names.
```
