...
`print(result)` render. See `moirais.fn.describe('zecss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zecss import *
import numpy as np
# See the function signature in fn/zecss.py for argument names.
```
