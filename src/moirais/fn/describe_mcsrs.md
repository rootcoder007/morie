...
`print(result)` render. See `moirais.fn.describe('mcsrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcsrs import *
import numpy as np
# See the function signature in fn/mcsrs.py for argument names.
```
