...
__all__ = ["hedderich_chapter_9_unnumbered_1641"]


def hedderich_chapter_9_unnumbered_1641(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n = (zβ−z1−α)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1641')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1641: PowerAndDesign expression (auto-extracted; see ref)."
