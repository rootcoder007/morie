...
`print(result)` render. See `moirais.fn.describe('logns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logns import *
import numpy as np
# See the function signature in fn/logns.py for argument names.
```
