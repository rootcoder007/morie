...
`print(result)` render. See `moirais.fn.describe('gdred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdred import *
import numpy as np
# See the function signature in fn/gdred.py for argument names.
```
