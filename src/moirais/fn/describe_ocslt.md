...
`print(result)` render. See `moirais.fn.describe('ocslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocslt import *
import numpy as np
# See the function signature in fn/ocslt.py for argument names.
```
