# describe('femeta') — fixed_effects_meta
...
`print(result)` render. See `moirais.fn.describe('femeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.femeta import *
import numpy as np
# See the function signature in fn/femeta.py for argument names.
```
