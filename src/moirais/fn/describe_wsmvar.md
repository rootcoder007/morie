# describe('wsmvar') — wasserman_variance
...
`print(result)` render. See `moirais.fn.describe('wsmvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmvar import *
import numpy as np
# See the function signature in fn/wsmvar.py for argument names.
```
