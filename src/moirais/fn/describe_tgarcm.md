...
`print(result)` render. See `moirais.fn.describe('tgarcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgarcm import *
import numpy as np
# See the function signature in fn/tgarcm.py for argument names.
```
