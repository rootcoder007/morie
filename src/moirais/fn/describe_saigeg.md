# describe('saigeg') — saige_gwas

## WHAT IT DOES

SAIGE for case-control GWAS.
...
`print(result)` render. See `moirais.fn.describe('saigeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saigeg import *
import numpy as np
# See the function signature in fn/saigeg.py for argument names.
```
