...
`print(result)` render. See `moirais.fn.describe('mtres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtres import *
import numpy as np
# See the function signature in fn/mtres.py for argument names.
```
