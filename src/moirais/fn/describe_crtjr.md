...
`print(result)` render. See `moirais.fn.describe('crtjr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtjr import *
import numpy as np
# See the function signature in fn/crtjr.py for argument names.
```
