# describe('gb5413') — gibbons_sign_zeros
...
`print(result)` render. See `moirais.fn.describe('gb5413')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5413 import *
import numpy as np
# See the function signature in fn/gb5413.py for argument names.
```
