# describe('vpred') — validity_predictive
...
`print(result)` render. See `moirais.fn.describe('vpred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vpred import *
import numpy as np
# See the function signature in fn/vpred.py for argument names.
```
