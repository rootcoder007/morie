...
`print(result)` render. See `moirais.fn.describe('bpdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpdn import *
import numpy as np
# See the function signature in fn/bpdn.py for argument names.
```
