...
`print(result)` render. See `moirais.fn.describe('hsdwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsdwn import *
import numpy as np
# See the function signature in fn/hsdwn.py for argument names.
```
