...
`print(result)` render. See `moirais.fn.describe('vmprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmprd import *
import numpy as np
# See the function signature in fn/vmprd.py for argument names.
```
