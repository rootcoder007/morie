...
`print(result)` render. See `moirais.fn.describe('entrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entrp import *
import numpy as np
# See the function signature in fn/entrp.py for argument names.
```
