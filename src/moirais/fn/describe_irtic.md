...
`print(result)` render. See `moirais.fn.describe('irtic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtic import *
import numpy as np
# See the function signature in fn/irtic.py for argument names.
```
