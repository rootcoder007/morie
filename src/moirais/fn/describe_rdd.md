# describe('rdd') — reg_discontinuity
...
`print(result)` render. See `moirais.fn.describe('rdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdd import *
import numpy as np
# See the function signature in fn/rdd.py for argument names.
```
