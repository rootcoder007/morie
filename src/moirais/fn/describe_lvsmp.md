...
`print(result)` render. See `moirais.fn.describe('lvsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvsmp import *
import numpy as np
# See the function signature in fn/lvsmp.py for argument names.
```
