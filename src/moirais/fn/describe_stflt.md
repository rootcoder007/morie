...
`print(result)` render. See `moirais.fn.describe('stflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stflt import *
import numpy as np
# See the function signature in fn/stflt.py for argument names.
```
