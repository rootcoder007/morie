...
`print(result)` render. See `moirais.fn.describe('rlwe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlwe import *
import numpy as np
# See the function signature in fn/rlwe.py for argument names.
```
