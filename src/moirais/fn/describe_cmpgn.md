# describe('cmpgn') — compliance_by_gender
...
`print(result)` render. See `moirais.fn.describe('cmpgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpgn import *
import numpy as np
# See the function signature in fn/cmpgn.py for argument names.
```
