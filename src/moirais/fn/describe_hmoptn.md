...
`print(result)` render. See `moirais.fn.describe('hmoptn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmoptn import *
import numpy as np
# See the function signature in fn/hmoptn.py for argument names.
```
