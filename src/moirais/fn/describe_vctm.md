# describe('vctm') — victimization_rate
...
`print(result)` render. See `moirais.fn.describe('vctm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vctm import *
import numpy as np
# See the function signature in fn/vctm.py for argument names.
```
