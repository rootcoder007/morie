...
__all__ = ["hedderich_chapter_9_unnumbered_95"]


def hedderich_chapter_9_unnumbered_95(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • A matrix A is positive semidefinite, ifλi≥0 and at least oneλi = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u95')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u95: GeneralStatistics expression (auto-extracted; see ref)."
