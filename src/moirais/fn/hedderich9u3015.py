...
__all__ = ["hedderich_chapter_9_unnumbered_3015"]


def hedderich_chapter_9_unnumbered_3015(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: + quant <− qchisq ( alpha , df =nu , lower =FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3015')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3015: ContingencyTables expression (auto-extracted; see ref)."
