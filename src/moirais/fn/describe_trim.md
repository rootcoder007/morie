...
`print(result)` render. See `moirais.fn.describe('trim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trim import *
import numpy as np
# See the function signature in fn/trim.py for argument names.
```
