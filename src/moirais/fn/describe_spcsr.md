# describe('spcsr') — schabenberger_csr_def
...
`print(result)` render. See `moirais.fn.describe('spcsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcsr import *
import numpy as np
# See the function signature in fn/spcsr.py for argument names.
```
