...
`print(result)` render. See `moirais.fn.describe('vmlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmlin import *
import numpy as np
# See the function signature in fn/vmlin.py for argument names.
```
