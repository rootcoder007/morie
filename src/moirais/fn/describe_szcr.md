# describe('szcr') — zero_crossing_rate
...
`print(result)` render. See `moirais.fn.describe('szcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.szcr import *
import numpy as np
# See the function signature in fn/szcr.py for argument names.
```
