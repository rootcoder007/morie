...
`print(result)` render. See `moirais.fn.describe('tmloess')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmloess import *
import numpy as np
# See the function signature in fn/tmloess.py for argument names.
```
