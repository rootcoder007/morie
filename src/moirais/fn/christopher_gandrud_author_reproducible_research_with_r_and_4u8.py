...
__all__ = ["A journey of a thousand miles begins with a single step. — Lao Tzu"]


def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_8(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The third line (OUT_FILES = $(RSOURCE:.R=.Rout)) creates a variable for
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('A journey of a thousand miles begins with a single step. — Lao Tzu')`` for the full guide.
