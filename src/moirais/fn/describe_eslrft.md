# describe('eslrft') — esl_random_forest
...
`print(result)` render. See `moirais.fn.describe('eslrft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslrft import *
import numpy as np
# See the function signature in fn/eslrft.py for argument names.
```
