# describe('pcm'Confine yourself to the present. — Marcus Aurelius's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('pcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcm import *
import numpy as np
# See the function signature in fn/pcm.py for argument names.
```
