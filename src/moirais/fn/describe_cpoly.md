# describe('cpoly') — chacha20_encrypt
...
`print(result)` render. See `moirais.fn.describe('cpoly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpoly import *
import numpy as np
# See the function signature in fn/cpoly.py for argument names.
```
