...
__all__ = ["hedderich_chapter_9_unnumbered_1999"]


def hedderich_chapter_9_unnumbered_1999(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: AB = 7 0 . 5 , p− value = 0 . 0 1 8 3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1999')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1999: GeneralStatistics expression (auto-extracted; see ref)."
