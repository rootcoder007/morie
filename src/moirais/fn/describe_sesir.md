...
`print(result)` render. See `moirais.fn.describe('sesir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sesir import *
import numpy as np
# See the function signature in fn/sesir.py for argument names.
```
