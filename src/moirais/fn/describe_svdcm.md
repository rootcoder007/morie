...
`print(result)` render. See `moirais.fn.describe('svdcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdcm import *
import numpy as np
# See the function signature in fn/svdcm.py for argument names.
```
