...
__all__ = ["wilcox_chapter_5_unnumbered_407"]


def wilcox_chapter_5_unnumbered_407(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] is ˆY = −0.0405 + 4 .581(3) = 13.7.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u407')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u407: GeneralStatistics expression (auto-extracted; see ref)."
