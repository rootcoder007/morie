# describe('objfair') — individual_fairness_lipschitz
...
`print(result)` render. See `moirais.fn.describe('objfair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.objfair import *
import numpy as np
# See the function signature in fn/objfair.py for argument names.
```
