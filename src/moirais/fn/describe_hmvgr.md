# describe('hmvgr') — geron_vanishing_gradients
...
`print(result)` render. See `moirais.fn.describe('hmvgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvgr import *
import numpy as np
# See the function signature in fn/hmvgr.py for argument names.
```
