# describe('mtxop') — matrix_function
...
`print(result)` render. See `moirais.fn.describe('mtxop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtxop import *
import numpy as np
# See the function signature in fn/mtxop.py for argument names.
```
