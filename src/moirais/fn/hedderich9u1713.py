...
__all__ = ["hedderich_chapter_9_unnumbered_1713"]


def hedderich_chapter_9_unnumbered_1713(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Bounds for D 1.073/√n 1.224/√n 1.358/√n 1.517/√n 1.628/√n 1.731/√n 1.949/√n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1713')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1713: GeneralStatistics expression (auto-extracted; see ref)."
