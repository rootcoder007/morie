# describe('contam') — epsilon_contamination
...
`print(result)` render. See `moirais.fn.describe('contam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.contam import *
import numpy as np
# See the function signature in fn/contam.py for argument names.
```
