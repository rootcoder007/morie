...
`print(result)` render. See `moirais.fn.describe('bloos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bloos import *
import numpy as np
# See the function signature in fn/bloos.py for argument names.
```
