...
`print(result)` render. See `moirais.fn.describe('sehyb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sehyb import *
import numpy as np
# See the function signature in fn/sehyb.py for argument names.
```
