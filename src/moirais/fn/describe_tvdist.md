# describe('tvdist') — total_variation_distance
...
`print(result)` render. See `moirais.fn.describe('tvdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tvdist import *
import numpy as np
# See the function signature in fn/tvdist.py for argument names.
```
