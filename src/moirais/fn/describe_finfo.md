...
`print(result)` render. See `moirais.fn.describe('finfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.finfo import *
import numpy as np
# See the function signature in fn/finfo.py for argument names.
```
