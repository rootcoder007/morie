...
`print(result)` render. See `moirais.fn.describe('oblmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oblmn import *
import numpy as np
# See the function signature in fn/oblmn.py for argument names.
```
