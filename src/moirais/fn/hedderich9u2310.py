...
__all__ = ["hedderich_chapter_9_unnumbered_2310"]


def hedderich_chapter_9_unnumbered_2310(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A single null hypothesis H0j is therefore to be rejected if |tj|≥cj or pj ≤αj, where cj and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2310')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2310: GeneralStatistics expression (auto-extracted; see ref)."
