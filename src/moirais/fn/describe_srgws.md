...
`print(result)` render. See `moirais.fn.describe('srgws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgws import *
import numpy as np
# See the function signature in fn/srgws.py for argument names.
```
