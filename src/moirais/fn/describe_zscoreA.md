# describe('zscoreA') — zscore_anomaly
...
`print(result)` render. See `moirais.fn.describe('zscoreA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscoreA import *
import numpy as np
# See the function signature in fn/zscoreA.py for argument names.
```
