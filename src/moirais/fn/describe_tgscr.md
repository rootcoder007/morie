...
`print(result)` render. See `moirais.fn.describe('tgscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgscr import *
import numpy as np
# See the function signature in fn/tgscr.py for argument names.
```
