# describe('morebs') — empirical_bayes_moran
...
`print(result)` render. See `moirais.fn.describe('morebs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morebs import *
import numpy as np
# See the function signature in fn/morebs.py for argument names.
```
