# describe('sgtkem') — sgt_katz_centrality
...
`print(result)` render. See `moirais.fn.describe('sgtkem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtkem import *
import numpy as np
# See the function signature in fn/sgtkem.py for argument names.
```
