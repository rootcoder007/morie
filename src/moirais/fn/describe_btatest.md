# describe('btatest') — boot_anderson_test
...
`print(result)` render. See `moirais.fn.describe('btatest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btatest import *
import numpy as np
# See the function signature in fn/btatest.py for argument names.
```
