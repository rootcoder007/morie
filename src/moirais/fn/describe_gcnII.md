...
`print(result)` render. See `moirais.fn.describe('gcnII')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcnII import *
import numpy as np
# See the function signature in fn/gcnII.py for argument names.
```
