# describe('kmlv') — kamath_llava_visual_instruction
...
`print(result)` render. See `moirais.fn.describe('kmlv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmlv import *
import numpy as np
# See the function signature in fn/kmlv.py for argument names.
```
