...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1042"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1042(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i=1(ni − 1) elements of U− and U+.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1042')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1042: GeneralStatistics expression (auto-extracted; see ref)."
