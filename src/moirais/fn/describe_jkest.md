# describe('jkest') — jackknife_estimator
...
`print(result)` render. See `moirais.fn.describe('jkest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jkest import *
import numpy as np
# See the function signature in fn/jkest.py for argument names.
```
