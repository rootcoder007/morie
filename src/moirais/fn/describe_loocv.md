...
`print(result)` render. See `moirais.fn.describe('loocv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.loocv import *
import numpy as np
# See the function signature in fn/loocv.py for argument names.
```
