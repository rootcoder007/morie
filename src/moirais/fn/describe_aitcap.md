# describe('aitcap') — compositional_classifyAP
...
`print(result)` render. See `moirais.fn.describe('aitcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitcap import *
import numpy as np
# See the function signature in fn/aitcap.py for argument names.
```
