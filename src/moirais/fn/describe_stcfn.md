...
`print(result)` render. See `moirais.fn.describe('stcfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stcfn import *
import numpy as np
# See the function signature in fn/stcfn.py for argument names.
```
