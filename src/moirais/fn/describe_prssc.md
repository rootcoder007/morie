...
`print(result)` render. See `moirais.fn.describe('prssc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prssc import *
import numpy as np
# See the function signature in fn/prssc.py for argument names.
```
