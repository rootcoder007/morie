...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1132"]


def guide_on_data_analysis_chapter_24_unnumbered_1132(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ( ̂𝛼𝛽)𝑖𝑗 = ̄𝑌𝑖𝑗. − ̄𝑌𝑖.. − ̄𝑌.𝑗. + ̄𝑌...
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1132')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1132: GeneralStatistics expression (auto-extracted; see ref)."
