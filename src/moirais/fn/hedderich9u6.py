...
__all__ = ["hedderich_chapter_9_unnumbered_6"]


def hedderich_chapter_9_unnumbered_6(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Addition: Addend + Addend = Calculated Sum [5 + 8 = 13]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u6')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u6: GeneralStatistics expression (auto-extracted; see ref)."
