# describe('jolog') — joseph_log_transform
...
`print(result)` render. See `moirais.fn.describe('jolog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jolog import *
import numpy as np
# See the function signature in fn/jolog.py for argument names.
```
