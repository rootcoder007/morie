...
`print(result)` render. See `moirais.fn.describe('zeby2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeby2 import *
import numpy as np
# See the function signature in fn/zeby2.py for argument names.
```
