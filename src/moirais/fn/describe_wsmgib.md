# describe('wsmgib') — wasserman_gibbs_sampler
...
`print(result)` render. See `moirais.fn.describe('wsmgib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmgib import *
import numpy as np
# See the function signature in fn/wsmgib.py for argument names.
```
