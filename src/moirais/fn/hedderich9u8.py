...
__all__ = ["hedderich_chapter_9_unnumbered_8"]


def hedderich_chapter_9_unnumbered_8(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u8')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u8: GeneralStatistics expression (auto-extracted; see ref)."
