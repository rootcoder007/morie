...
`print(result)` render. See `moirais.fn.describe('hmadmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmadmw import *
import numpy as np
# See the function signature in fn/hmadmw.py for argument names.
```
