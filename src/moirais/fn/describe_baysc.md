...
`print(result)` render. See `moirais.fn.describe('baysc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysc import *
import numpy as np
# See the function signature in fn/baysc.py for argument names.
```
