...
`print(result)` render. See `moirais.fn.describe('gdadr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdadr import *
import numpy as np
# See the function signature in fn/gdadr.py for argument names.
```
