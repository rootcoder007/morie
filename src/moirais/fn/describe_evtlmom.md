# describe('evtlmom') — evt_trimmed_lmom
...
`print(result)` render. See `moirais.fn.describe('evtlmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtlmom import *
import numpy as np
# See the function signature in fn/evtlmom.py for argument names.
```
