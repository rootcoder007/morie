...
__all__ = ["use_r_chapter_2_unnumbered_45"]


def use_r_chapter_2_unnumbered_45(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +to_meter=1.0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u45')`` for the full guide.
...
def cheatsheet():
    return "use_r2u45: GeneralStatistics expression (auto-extracted; see ref)."
