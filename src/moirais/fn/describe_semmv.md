# describe('semmv') — spatial_error_ml
...
`print(result)` render. See `moirais.fn.describe('semmv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semmv import *
import numpy as np
# See the function signature in fn/semmv.py for argument names.
```
