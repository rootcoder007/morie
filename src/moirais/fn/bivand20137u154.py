...
__all__ = ["bivand2013_chapter_7_unnumbered_154"]


def bivand2013_chapter_7_unnumbered_154(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + "Sph", 900), nmin = 20, nmax = 40, maxdist = 1000)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u154')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u154: GeneralStatistics expression (auto-extracted; see ref)."
