# describe('grfp6'Out of chaos, comes order. — Friedrich Nietzsche's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('grfp6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grfp6 import *
import numpy as np
# See the function signature in fn/grfp6.py for argument names.
```
