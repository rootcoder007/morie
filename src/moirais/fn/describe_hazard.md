...
`print(result)` render. See `moirais.fn.describe('hazard')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hazard import *
import numpy as np
# See the function signature in fn/hazard.py for argument names.
```
