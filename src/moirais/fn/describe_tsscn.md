...
`print(result)` render. See `moirais.fn.describe('tsscn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsscn import *
import numpy as np
# See the function signature in fn/tsscn.py for argument names.
```
