...
`print(result)` render. See `moirais.fn.describe('lmsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmsdm import *
import numpy as np
# See the function signature in fn/lmsdm.py for argument names.
```
