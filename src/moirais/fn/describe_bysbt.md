...
`print(result)` render. See `moirais.fn.describe('bysbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bysbt import *
import numpy as np
# See the function signature in fn/bysbt.py for argument names.
```
