...
__all__ = ["hedderich_chapter_9_unnumbered_2793"]


def hedderich_chapter_9_unnumbered_2793(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] (16−5)/40−1.96√16 + 5/40<π1−π2 <(16−5)/40 + 1.96√16 + 5/40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2793')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2793: CausalInference expression (auto-extracted; see ref)."
