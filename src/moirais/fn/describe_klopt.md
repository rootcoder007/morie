...
`print(result)` render. See `moirais.fn.describe('klopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klopt import *
import numpy as np
# See the function signature in fn/klopt.py for argument names.
```
