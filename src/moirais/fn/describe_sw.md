...
`print(result)` render. See `moirais.fn.describe('sw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sw import *
import numpy as np
# See the function signature in fn/sw.py for argument names.
```
