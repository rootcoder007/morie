# describe('cxcep') — complex_cepstrum
...
`print(result)` render. See `moirais.fn.describe('cxcep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxcep import *
import numpy as np
# See the function signature in fn/cxcep.py for argument names.
```
