# describe('clrpt') — classification_report
...
`print(result)` render. See `moirais.fn.describe('clrpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clrpt import *
import numpy as np
# See the function signature in fn/clrpt.py for argument names.
```
