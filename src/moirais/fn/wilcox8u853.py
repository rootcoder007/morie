...
__all__ = ["wilcox_chapter_8_unnumbered_853"]


def wilcox_chapter_8_unnumbered_853(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ 1 = · · · =θ J, (11.4)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u853')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u853: GeneralStatistics expression (auto-extracted; see ref)."
