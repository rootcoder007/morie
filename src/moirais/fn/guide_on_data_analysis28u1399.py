...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1399"]


def guide_on_data_analysis_chapter_28_unnumbered_1399(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: abline(v = T_star, lwd = 2, col = "black")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1399')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1399: GeneralStatistics expression (auto-extracted; see ref)."
