...
`print(result)` render. See `moirais.fn.describe('rpgap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpgap import *
import numpy as np
# See the function signature in fn/rpgap.py for argument names.
```
