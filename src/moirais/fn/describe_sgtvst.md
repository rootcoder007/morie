# describe('sgtvst') — sgt_vertex_strengths
...
`print(result)` render. See `moirais.fn.describe('sgtvst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtvst import *
import numpy as np
# See the function signature in fn/sgtvst.py for argument names.
```
