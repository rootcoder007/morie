...
`print(result)` render. See `moirais.fn.describe('tbund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbund import *
import numpy as np
# See the function signature in fn/tbund.py for argument names.
```
