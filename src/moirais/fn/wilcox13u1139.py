...
__all__ = ["wilcox_chapter_13_unnumbered_1139"]


def wilcox_chapter_13_unnumbered_1139(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pyhat=FALSE, pts=NA, npts=25, xout=FALSE, xlab="X", ylab="Y", low.span=2/3,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1139')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1139: GeneralStatistics expression (auto-extracted; see ref)."
