# describe('kmlora') — kamath_lora_weight_update
...
`print(result)` render. See `moirais.fn.describe('kmlora')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmlora import *
import numpy as np
# See the function signature in fn/kmlora.py for argument names.
```
