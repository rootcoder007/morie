# describe('rcdbi') — recidivism_burden
...
`print(result)` render. See `moirais.fn.describe('rcdbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdbi import *
import numpy as np
# See the function signature in fn/rcdbi.py for argument names.
```
