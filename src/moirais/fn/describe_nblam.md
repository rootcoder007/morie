# describe('nblam') — cloud_mass_function
...
`print(result)` render. See `moirais.fn.describe('nblam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nblam import *
import numpy as np
# See the function signature in fn/nblam.py for argument names.
```
