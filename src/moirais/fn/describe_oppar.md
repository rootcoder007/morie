...
`print(result)` render. See `moirais.fn.describe('oppar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oppar import *
import numpy as np
# See the function signature in fn/oppar.py for argument names.
```
