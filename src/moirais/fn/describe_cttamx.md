...
`print(result)` render. See `moirais.fn.describe('cttamx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cttamx import *
import numpy as np
# See the function signature in fn/cttamx.py for argument names.
```
