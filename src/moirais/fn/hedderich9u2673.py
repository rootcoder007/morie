...
__all__ = ["hedderich_chapter_9_unnumbered_2673"]


def hedderich_chapter_9_unnumbered_2673(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The parametersδ,ψandωcorresponding (marked with a "hat") estimates ˆδ, ˆψand ˆωcan only be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2673')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2673: GeneralStatistics expression (auto-extracted; see ref)."
