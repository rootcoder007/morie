...
`print(result)` render. See `moirais.fn.describe('spprprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprprd import *
import numpy as np
# See the function signature in fn/spprprd.py for argument names.
```
