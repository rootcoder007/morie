...
`print(result)` render. See `moirais.fn.describe('hmopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmopt import *
import numpy as np
# See the function signature in fn/hmopt.py for argument names.
```
