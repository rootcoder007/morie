# describe('msm023') — mvsml_linear_mixed_models_eq_5_4
...
`print(result)` render. See `moirais.fn.describe('msm023')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm023 import *
import numpy as np
# See the function signature in fn/msm023.py for argument names.
```
