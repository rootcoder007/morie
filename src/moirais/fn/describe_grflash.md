# describe('grflash') — geron_flash_attention_tile
...
`print(result)` render. See `moirais.fn.describe('grflash')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grflash import *
import numpy as np
# See the function signature in fn/grflash.py for argument names.
```
