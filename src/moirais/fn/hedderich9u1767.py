...
__all__ = ["hedderich_chapter_9_unnumbered_1767"]


def hedderich_chapter_9_unnumbered_1767(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: less than or equal to P (X=xobs|π0) must be determined. Forn=20,xobs=15 andπ0=0.20, an
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1767')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1767: GeneralStatistics expression (auto-extracted; see ref)."
