...
`print(result)` render. See `moirais.fn.describe('agame')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agame import *
import numpy as np
# See the function signature in fn/agame.py for argument names.
```
