...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_903"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_903(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fR = Lin., fτ = Lin. 0.50 0.90 0.19 –
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u903')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u903: GeneralStatistics expression (auto-extracted; see ref)."
