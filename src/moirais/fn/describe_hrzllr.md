# describe('hrzllr') — horowitz_local_linear
...
`print(result)` render. See `moirais.fn.describe('hrzllr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzllr import *
import numpy as np
# See the function signature in fn/hrzllr.py for argument names.
```
