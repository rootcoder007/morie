...
__all__ = ["wilcox_chapter_4_unnumbered_125"]


def wilcox_chapter_4_unnumbered_125(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E(X1 +X2) = E(X1) +E(X2), (3.19)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u125')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u125: GeneralStatistics expression (auto-extracted; see ref)."
