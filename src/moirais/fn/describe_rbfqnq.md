...
`print(result)` render. See `moirais.fn.describe('rbfqnq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfqnq import *
import numpy as np
# See the function signature in fn/rbfqnq.py for argument names.
```
