# describe('sgpql') — pql_spatial_glmm
...
`print(result)` render. See `moirais.fn.describe('sgpql')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpql import *
import numpy as np
# See the function signature in fn/sgpql.py for argument names.
```
