...
`print(result)` render. See `moirais.fn.describe('slvgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slvgrf import *
import numpy as np
# See the function signature in fn/slvgrf.py for argument names.
```
