# describe('msm086') — mvsml_bayesian_regression_pt2_eq_7_1
...
`print(result)` render. See `moirais.fn.describe('msm086')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm086 import *
import numpy as np
# See the function signature in fn/msm086.py for argument names.
```
