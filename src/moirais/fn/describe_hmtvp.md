# describe('hmtvp') — geron_torchvision_pretrained
...
`print(result)` render. See `moirais.fn.describe('hmtvp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtvp import *
import numpy as np
# See the function signature in fn/hmtvp.py for argument names.
```
