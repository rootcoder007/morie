# describe('chstr') — chain_structure
...
`print(result)` render. See `moirais.fn.describe('chstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chstr import *
import numpy as np
# See the function signature in fn/chstr.py for argument names.
```
