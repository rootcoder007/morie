# describe('hdptpc') — hdp_topic_model
...
`print(result)` render. See `moirais.fn.describe('hdptpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdptpc import *
import numpy as np
# See the function signature in fn/hdptpc.py for argument names.
```
