...
`print(result)` render. See `moirais.fn.describe('irtcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtcl import *
import numpy as np
# See the function signature in fn/irtcl.py for argument names.
```
