# describe('alocp') — alammar_openclip_contrastive
...
`print(result)` render. See `moirais.fn.describe('alocp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alocp import *
import numpy as np
# See the function signature in fn/alocp.py for argument names.
```
