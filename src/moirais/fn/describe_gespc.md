...
`print(result)` render. See `moirais.fn.describe('gespc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gespc import *
import numpy as np
# See the function signature in fn/gespc.py for argument names.
```
