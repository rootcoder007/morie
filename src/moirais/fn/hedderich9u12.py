...
__all__ = ["hedderich_chapter_9_unnumbered_12"]


def hedderich_chapter_9_unnumbered_12(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i=1(3 + 2xi +x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u12')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u12: GeneralStatistics expression (auto-extracted; see ref)."
