...
__all__ = ["wilcox_chapter_10_unnumbered_985"]


def wilcox_chapter_10_unnumbered_985(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ˆΨ 1 = 10 + 14 − 18 − 12 = −6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u985')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u985: PowerAndDesign expression (auto-extracted; see ref)."
