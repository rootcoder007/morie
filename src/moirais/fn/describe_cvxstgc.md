# describe('cvxstgc') — boyd_strong_convex
...
`print(result)` render. See `moirais.fn.describe('cvxstgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxstgc import *
import numpy as np
# See the function signature in fn/cvxstgc.py for argument names.
```
