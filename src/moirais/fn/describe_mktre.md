...
`print(result)` render. See `moirais.fn.describe('mktre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mktre import *
import numpy as np
# See the function signature in fn/mktre.py for argument names.
```
