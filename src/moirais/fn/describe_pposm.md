# describe('pposm') — posterior_predictive_mean
...
`print(result)` render. See `moirais.fn.describe('pposm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pposm import *
import numpy as np
# See the function signature in fn/pposm.py for argument names.
```
