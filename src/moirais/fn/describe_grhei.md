...
`print(result)` render. See `moirais.fn.describe('grhei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grhei import *
import numpy as np
# See the function signature in fn/grhei.py for argument names.
```
