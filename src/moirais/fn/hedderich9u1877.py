...
__all__ = ["hedderich_chapter_9_unnumbered_1877"]


def hedderich_chapter_9_unnumbered_1877(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Two-sided test: For ru;α/2<ˆr<ro;α/2,H0 is maintained;H0 is rejected as soon as
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1877')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1877: GeneralStatistics expression (auto-extracted; see ref)."
