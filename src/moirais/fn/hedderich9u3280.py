...
__all__ = ["hedderich_chapter_9_unnumbered_3280"]


def hedderich_chapter_9_unnumbered_3280(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Di = (ˆy−ˆ y(i))′(ˆy−ˆ y(i))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3280')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3280: GeneralStatistics expression (auto-extracted; see ref)."
