...
`print(result)` render. See `moirais.fn.describe('clcha')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcha import *
import numpy as np
# See the function signature in fn/clcha.py for argument names.
```
