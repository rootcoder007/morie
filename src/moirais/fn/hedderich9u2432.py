...
__all__ = ["hedderich_chapter_9_unnumbered_2432"]


def hedderich_chapter_9_unnumbered_2432(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (k−1)F(k−1;n−k;1−α) =Sα (7.234)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2432')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2432: GeneralStatistics expression (auto-extracted; see ref)."
