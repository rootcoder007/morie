...
`print(result)` render. See `moirais.fn.describe('rmstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmstd import *
import numpy as np
# See the function signature in fn/rmstd.py for argument names.
```
