# describe('baysrnd') — shrinkage_random
...
`print(result)` render. See `moirais.fn.describe('baysrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysrnd import *
import numpy as np
# See the function signature in fn/baysrnd.py for argument names.
```
