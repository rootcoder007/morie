# describe('gb221') — gibbons_quantile_deriv
...
`print(result)` render. See `moirais.fn.describe('gb221')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb221 import *
import numpy as np
# See the function signature in fn/gb221.py for argument names.
```
