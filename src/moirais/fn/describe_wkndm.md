# describe('wkndm') — pareto_optimize
...
`print(result)` render. See `moirais.fn.describe('wkndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wkndm import *
import numpy as np
# See the function signature in fn/wkndm.py for argument names.
```
