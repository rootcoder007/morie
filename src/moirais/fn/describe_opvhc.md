...
`print(result)` render. See `moirais.fn.describe('opvhc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opvhc import *
import numpy as np
# See the function signature in fn/opvhc.py for argument names.
```
