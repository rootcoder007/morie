# describe('gb434bt') — gibbons_ks_bt_formula
...
`print(result)` render. See `moirais.fn.describe('gb434bt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb434bt import *
import numpy as np
# See the function signature in fn/gb434bt.py for argument names.
```
