...
`print(result)` render. See `moirais.fn.describe('sobor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobor import *
import numpy as np
# See the function signature in fn/sobor.py for argument names.
```
