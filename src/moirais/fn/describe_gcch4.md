...
`print(result)` render. See `moirais.fn.describe('gcch4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcch4 import *
import numpy as np
# See the function signature in fn/gcch4.py for argument names.
```
