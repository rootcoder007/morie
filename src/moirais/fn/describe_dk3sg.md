...
`print(result)` render. See `moirais.fn.describe('dk3sg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3sg import *
import numpy as np
# See the function signature in fn/dk3sg.py for argument names.
```
