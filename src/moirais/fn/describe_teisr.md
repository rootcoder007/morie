# describe('teisr') — eisenstein_series
...
`print(result)` render. See `moirais.fn.describe('teisr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.teisr import *
import numpy as np
# See the function signature in fn/teisr.py for argument names.
```
