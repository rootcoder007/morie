# describe('mhrate') — mantel_haenszel_rate
...
`print(result)` render. See `moirais.fn.describe('mhrate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhrate import *
import numpy as np
# See the function signature in fn/mhrate.py for argument names.
```
