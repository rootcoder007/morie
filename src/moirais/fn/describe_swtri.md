...
`print(result)` render. See `moirais.fn.describe('swtri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swtri import *
import numpy as np
# See the function signature in fn/swtri.py for argument names.
```
