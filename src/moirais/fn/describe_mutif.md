# describe('mutif') — mutual_information
...
`print(result)` render. See `moirais.fn.describe('mutif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mutif import *
import numpy as np
# See the function signature in fn/mutif.py for argument names.
```
