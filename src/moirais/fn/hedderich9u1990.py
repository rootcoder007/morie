...
__all__ = ["hedderich_chapter_9_unnumbered_1990"]


def hedderich_chapter_9_unnumbered_1990(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] + elseif ( i% %2==0 & n / 2< i & i <=n ) { g [ i ] <− 2* ( n− i )+2 }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1990')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1990: PowerAndDesign expression (auto-extracted; see ref)."
