...
`print(result)` render. See `moirais.fn.describe('hmswin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmswin import *
import numpy as np
# See the function signature in fn/hmswin.py for argument names.
```
