...
__all__ = ["hedderich_chapter_9_unnumbered_3540"]


def hedderich_chapter_9_unnumbered_3540(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: + corstr =" exchangeable " , famil y= binomial ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3540')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3540: CountModels expression (auto-extracted; see ref)."
