...
`print(result)` render. See `moirais.fn.describe('viterb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.viterb import *
import numpy as np
# See the function signature in fn/viterb.py for argument names.
```
