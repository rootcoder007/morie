...
`print(result)` render. See `moirais.fn.describe('luvR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luvR import *
import numpy as np
# See the function signature in fn/luvR.py for argument names.
```
