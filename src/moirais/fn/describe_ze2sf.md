...
`print(result)` render. See `moirais.fn.describe('ze2sf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ze2sf import *
import numpy as np
# See the function signature in fn/ze2sf.py for argument names.
```
