...
__all__ = ["hedderich_chapter_9_unnumbered_102"]


def hedderich_chapter_9_unnumbered_102(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Representation of the linear functionsf (x) = 2+3x andg(x) = 5−2x in the Cartesian
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u102')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u102: GeneralStatistics expression (auto-extracted; see ref)."
