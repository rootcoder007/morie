# describe('ripG') — ripley_g_function
...
`print(result)` render. See `moirais.fn.describe('ripG')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ripG import *
import numpy as np
# See the function signature in fn/ripG.py for argument names.
```
