...
`print(result)` render. See `moirais.fn.describe('ebac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebac import *
import numpy as np
# See the function signature in fn/ebac.py for argument names.
```
