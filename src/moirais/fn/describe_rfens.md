# describe('rfens') — random_forest_ensemble
...
`print(result)` render. See `moirais.fn.describe('rfens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfens import *
import numpy as np
# See the function signature in fn/rfens.py for argument names.
```
