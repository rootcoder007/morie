# describe('ogkcv') — orthogonalized_gk
...
`print(result)` render. See `moirais.fn.describe('ogkcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ogkcv import *
import numpy as np
# See the function signature in fn/ogkcv.py for argument names.
```
