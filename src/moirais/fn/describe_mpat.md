...
`print(result)` render. See `moirais.fn.describe('mpat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpat import *
import numpy as np
# See the function signature in fn/mpat.py for argument names.
```
