...
`print(result)` render. See `moirais.fn.describe('nflor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nflor import *
import numpy as np
# See the function signature in fn/nflor.py for argument names.
```
