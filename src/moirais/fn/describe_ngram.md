...
`print(result)` render. See `moirais.fn.describe('ngram')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ngram import *
import numpy as np
# See the function signature in fn/ngram.py for argument names.
```
