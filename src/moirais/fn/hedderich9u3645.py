...
__all__ = ["hedderich_chapter_9_unnumbered_3645"]


def hedderich_chapter_9_unnumbered_3645(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfcol = c ( 1 , 1 ) , lwd =2 , font . a x i s=2 , b t y =" n " , ps =14)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3645')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3645: GeneralStatistics expression (auto-extracted; see ref)."
