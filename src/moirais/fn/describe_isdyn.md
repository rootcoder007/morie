...
`print(result)` render. See `moirais.fn.describe('isdyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isdyn import *
import numpy as np
# See the function signature in fn/isdyn.py for argument names.
```
