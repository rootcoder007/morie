...
`print(result)` render. See `moirais.fn.describe('stdcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdcv import *
import numpy as np
# See the function signature in fn/stdcv.py for argument names.
```
