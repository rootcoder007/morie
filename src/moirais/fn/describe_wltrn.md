...
`print(result)` render. See `moirais.fn.describe('wltrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wltrn import *
import numpy as np
# See the function signature in fn/wltrn.py for argument names.
```
