...
__all__ = ["legal_ontology_chapter_10_unnumbered_15"]


def legal_ontology_chapter_10_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('legal_ontology10u15')`` for the full guide.
...
def cheatsheet():
    return "legal_ontology10u15: GeneralStatistics expression (auto-extracted; see ref)."
