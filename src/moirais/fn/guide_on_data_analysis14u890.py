...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_890"]


def guide_on_data_analysis_chapter_14_unnumbered_890(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> z = 13.108, p = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u890')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u890: GeneralStatistics expression (auto-extracted; see ref)."
