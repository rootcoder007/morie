...
`print(result)` render. See `moirais.fn.describe('wpiece')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wpiece import *
import numpy as np
# See the function signature in fn/wpiece.py for argument names.
```
