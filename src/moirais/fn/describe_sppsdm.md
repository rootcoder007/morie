...
`print(result)` render. See `moirais.fn.describe('sppsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppsdm import *
import numpy as np
# See the function signature in fn/sppsdm.py for argument names.
```
