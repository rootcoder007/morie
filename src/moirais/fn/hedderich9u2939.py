...
__all__ = ["hedderich_chapter_9_unnumbered_2939"]


def hedderich_chapter_9_unnumbered_2939(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + elseif ( alternative == " greater " ) { # one−s idedgreater
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2939')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2939: GeneralStatistics expression (auto-extracted; see ref)."
