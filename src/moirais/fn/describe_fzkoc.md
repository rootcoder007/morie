# describe('fzkoc') — fauzi_kernel_order_m_condition
...
`print(result)` render. See `moirais.fn.describe('fzkoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzkoc import *
import numpy as np
# See the function signature in fn/fzkoc.py for argument names.
```
