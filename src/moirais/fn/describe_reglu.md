# describe('reglu') — reglu_activation
...
`print(result)` render. See `moirais.fn.describe('reglu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reglu import *
import numpy as np
# See the function signature in fn/reglu.py for argument names.
```
