...
__all__ = ["wilcox_chapter_13_unnumbered_1366"]


def wilcox_chapter_13_unnumbered_1366(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Z = 10, reject. 11.Z = 2.12. Reject. 19. Increase α . 20. (a) T = 1, fail to reject. (b) T =.5,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1366')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1366: GeneralStatistics expression (auto-extracted; see ref)."
