# describe('mskbnd2') — manski_no_assumption_outcome
...
`print(result)` render. See `moirais.fn.describe('mskbnd2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mskbnd2 import *
import numpy as np
# See the function signature in fn/mskbnd2.py for argument names.
```
