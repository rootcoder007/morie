# describe('hmcae') — geron_convolutional_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmcae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcae import *
import numpy as np
# See the function signature in fn/hmcae.py for argument names.
```
