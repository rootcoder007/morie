...
`print(result)` render. See `moirais.fn.describe('maref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maref import *
import numpy as np
# See the function signature in fn/maref.py for argument names.
```
