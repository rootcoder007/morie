# describe('zxphl') — persistence_land
...
`print(result)` render. See `moirais.fn.describe('zxphl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxphl import *
import numpy as np
# See the function signature in fn/zxphl.py for argument names.
```
