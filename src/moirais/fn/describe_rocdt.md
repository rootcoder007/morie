...
`print(result)` render. See `moirais.fn.describe('rocdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rocdt import *
import numpy as np
# See the function signature in fn/rocdt.py for argument names.
```
