...
`print(result)` render. See `moirais.fn.describe('msdmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdmn import *
import numpy as np
# See the function signature in fn/msdmn.py for argument names.
```
