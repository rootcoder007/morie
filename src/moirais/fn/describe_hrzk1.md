# describe('hrzk1') — horowitz_kernel_density
...
`print(result)` render. See `moirais.fn.describe('hrzk1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzk1 import *
import numpy as np
# See the function signature in fn/hrzk1.py for argument names.
```
