# describe('sgblz') — boltzmann_accept
...
`print(result)` render. See `moirais.fn.describe('sgblz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgblz import *
import numpy as np
# See the function signature in fn/sgblz.py for argument names.
```
