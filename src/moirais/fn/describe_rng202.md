# describe('rng202') — rangayyan_ch4_ccf_discrete_with_delay
...
`print(result)` render. See `moirais.fn.describe('rng202')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng202 import *
import numpy as np
# See the function signature in fn/rng202.py for argument names.
```
