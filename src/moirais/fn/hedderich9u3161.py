...
__all__ = ["hedderich_chapter_9_unnumbered_3161"]


def hedderich_chapter_9_unnumbered_3161(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n = (z1−α/2 +z1−β)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3161')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3161: PowerAndDesign expression (auto-extracted; see ref)."
