# describe('sgtnbe') — sgt_nonbacktracking_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtnbe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtnbe import *
import numpy as np
# See the function signature in fn/sgtnbe.py for argument names.
```
