# describe('rng060') — rangayyan_ch3_frequency_response_from_pole_zero
...
`print(result)` render. See `moirais.fn.describe('rng060')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng060 import *
import numpy as np
# See the function signature in fn/rng060.py for argument names.
```
