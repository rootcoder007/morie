...
`print(result)` render. See `moirais.fn.describe('enwdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enwdr import *
import numpy as np
# See the function signature in fn/enwdr.py for argument names.
```
