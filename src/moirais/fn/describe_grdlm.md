# describe('grdlm') — geron_dataloader_minibatch
...
`print(result)` render. See `moirais.fn.describe('grdlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdlm import *
import numpy as np
# See the function signature in fn/grdlm.py for argument names.
```
