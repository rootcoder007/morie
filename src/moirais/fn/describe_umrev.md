...
`print(result)` render. See `moirais.fn.describe('umrev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umrev import *
import numpy as np
# See the function signature in fn/umrev.py for argument names.
```
