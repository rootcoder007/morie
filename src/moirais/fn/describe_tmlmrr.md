# describe('tmlmrr') — tmle_marginal_rr
...
`print(result)` render. See `moirais.fn.describe('tmlmrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmrr import *
import numpy as np
# See the function signature in fn/tmlmrr.py for argument names.
```
