...
`print(result)` render. See `moirais.fn.describe('grvae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grvae import *
import numpy as np
# See the function signature in fn/grvae.py for argument names.
```
