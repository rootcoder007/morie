# describe('gb_lsm') — gibbons_large_sample_moments
...
`print(result)` render. See `moirais.fn.describe('gb_lsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_lsm import *
import numpy as np
# See the function signature in fn/gb_lsm.py for argument names.
```
