# describe('imfplt') — plot_imf_stack_fn
...
`print(result)` render. See `moirais.fn.describe('imfplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imfplt import *
import numpy as np
# See the function signature in fn/imfplt.py for argument names.
```
