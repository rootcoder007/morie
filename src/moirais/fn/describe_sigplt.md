# describe('sigplt') — plot_signal_fn
...
`print(result)` render. See `moirais.fn.describe('sigplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sigplt import *
import numpy as np
# See the function signature in fn/sigplt.py for argument names.
```
