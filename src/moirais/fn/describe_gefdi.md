...
`print(result)` render. See `moirais.fn.describe('gefdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gefdi import *
import numpy as np
# See the function signature in fn/gefdi.py for argument names.
```
