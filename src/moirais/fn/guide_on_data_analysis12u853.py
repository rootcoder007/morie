...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_853"]


def guide_on_data_analysis_chapter_12_unnumbered_853(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] log(𝑥𝑖 + 1) if 𝜆 = 0, 𝑥𝑖 ≥ 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u853')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u853: GeneralStatistics expression (auto-extracted; see ref)."
