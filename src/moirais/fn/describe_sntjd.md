# describe('sntjd') — sentence_judicial
...
`print(result)` render. See `moirais.fn.describe('sntjd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntjd import *
import numpy as np
# See the function signature in fn/sntjd.py for argument names.
```
