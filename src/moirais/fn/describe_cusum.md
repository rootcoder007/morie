...
`print(result)` render. See `moirais.fn.describe('cusum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cusum import *
import numpy as np
# See the function signature in fn/cusum.py for argument names.
```
