...
`print(result)` render. See `moirais.fn.describe('mapho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapho import *
import numpy as np
# See the function signature in fn/mapho.py for argument names.
```
