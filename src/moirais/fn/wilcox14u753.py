...
__all__ = ["wilcox_chapter_14_unnumbered_753"]


def wilcox_chapter_14_unnumbered_753(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: cision Rule : Reject if D ≥ f , the 1 − α quantile of an F distribution with ˆ ν 1 and ˆν 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u753')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u753: GeneralStatistics expression (auto-extracted; see ref)."
