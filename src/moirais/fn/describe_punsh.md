# describe('punsh') — penalty_regression
...
`print(result)` render. See `moirais.fn.describe('punsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.punsh import *
import numpy as np
# See the function signature in fn/punsh.py for argument names.
```
