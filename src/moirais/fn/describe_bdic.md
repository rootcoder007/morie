...
`print(result)` render. See `moirais.fn.describe('bdic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdic import *
import numpy as np
# See the function signature in fn/bdic.py for argument names.
```
