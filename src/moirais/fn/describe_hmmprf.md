...
`print(result)` render. See `moirais.fn.describe('hmmprf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmprf import *
import numpy as np
# See the function signature in fn/hmmprf.py for argument names.
```
