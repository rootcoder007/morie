# describe('sgtcoml') — sgt_louvain_step
...
`print(result)` render. See `moirais.fn.describe('sgtcoml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtcoml import *
import numpy as np
# See the function signature in fn/sgtcoml.py for argument names.
```
