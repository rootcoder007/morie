# describe('ibs') — identity_by_state
...
`print(result)` render. See `moirais.fn.describe('ibs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibs import *
import numpy as np
# See the function signature in fn/ibs.py for argument names.
```
