# describe('winfn') — window_functions
...
`print(result)` render. See `moirais.fn.describe('winfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.winfn import *
import numpy as np
# See the function signature in fn/winfn.py for argument names.
```
