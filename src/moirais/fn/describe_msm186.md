# describe('msm186') — mvsml_ridge_lasso_elastic_eq_9_13
...
`print(result)` render. See `moirais.fn.describe('msm186')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm186 import *
import numpy as np
# See the function signature in fn/msm186.py for argument names.
```
