...
`print(result)` render. See `moirais.fn.describe('reedm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reedm import *
import numpy as np
# See the function signature in fn/reedm.py for argument names.
```
