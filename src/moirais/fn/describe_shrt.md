# describe('shrt') — shortest_path_dijkstra
...
`print(result)` render. See `moirais.fn.describe('shrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrt import *
import numpy as np
# See the function signature in fn/shrt.py for argument names.
```
