# describe('btiseq') — boot_iter_calibrated
...
`print(result)` render. See `moirais.fn.describe('btiseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btiseq import *
import numpy as np
# See the function signature in fn/btiseq.py for argument names.
```
