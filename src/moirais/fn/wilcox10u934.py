...
__all__ = ["wilcox_chapter_10_unnumbered_934"]


def wilcox_chapter_10_unnumbered_934(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: k α = 0 .05 α = 0.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u934')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u934: GeneralStatistics expression (auto-extracted; see ref)."
