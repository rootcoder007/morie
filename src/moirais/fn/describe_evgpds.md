# describe('evgpds') — evt_gpd_sample
...
`print(result)` render. See `moirais.fn.describe('evgpds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpds import *
import numpy as np
# See the function signature in fn/evgpds.py for argument names.
```
