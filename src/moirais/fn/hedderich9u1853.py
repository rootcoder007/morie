...
__all__ = ["hedderich_chapter_9_unnumbered_1853"]


def hedderich_chapter_9_unnumbered_1853(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0 = 60 againstσ2 >σ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1853')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1853: GeneralStatistics expression (auto-extracted; see ref)."
