# describe('mtoint') — mto_intersection
...
`print(result)` render. See `moirais.fn.describe('mtoint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtoint import *
import numpy as np
# See the function signature in fn/mtoint.py for argument names.
```
