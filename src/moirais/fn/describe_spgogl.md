# describe('spgogl') — schabenberger_getis_ord_gstar
...
`print(result)` render. See `moirais.fn.describe('spgogl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgogl import *
import numpy as np
# See the function signature in fn/spgogl.py for argument names.
```
