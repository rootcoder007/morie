...
__all__ = ["hedderich_chapter_9_unnumbered_3226"]


def hedderich_chapter_9_unnumbered_3226(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] b1−b2±t√ with √from (5.104) or (5.106) (7.430)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3226')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3226: GeneralStatistics expression (auto-extracted; see ref)."
