...
`print(result)` render. See `moirais.fn.describe('srgns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgns import *
import numpy as np
# See the function signature in fn/srgns.py for argument names.
```
