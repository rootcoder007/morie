...
`print(result)` render. See `moirais.fn.describe('abspor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abspor import *
import numpy as np
# See the function signature in fn/abspor.py for argument names.
```
