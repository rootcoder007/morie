# describe('focal') — focal

## WHAT IT DOES

rFocal loss for class imbalance.
...
`print(result)` render. See `moirais.fn.describe('focal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focal import *
import numpy as np
# See the function signature in fn/focal.py for argument names.
```
