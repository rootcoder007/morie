# describe('sgtwh') — sgt_wiener_index
...
`print(result)` render. See `moirais.fn.describe('sgtwh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtwh import *
import numpy as np
# See the function signature in fn/sgtwh.py for argument names.
```
