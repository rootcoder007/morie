...
`print(result)` render. See `moirais.fn.describe('dkvck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkvck import *
import numpy as np
# See the function signature in fn/dkvck.py for argument names.
```
