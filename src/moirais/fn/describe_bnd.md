...
`print(result)` render. See `moirais.fn.describe('bnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnd import *
import numpy as np
# See the function signature in fn/bnd.py for argument names.
```
