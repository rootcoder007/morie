...
`print(result)` render. See `moirais.fn.describe('geenr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geenr import *
import numpy as np
# See the function signature in fn/geenr.py for argument names.
```
