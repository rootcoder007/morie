# describe('parzn') — parzen_classify
...
`print(result)` render. See `moirais.fn.describe('parzn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.parzn import *
import numpy as np
# See the function signature in fn/parzn.py for argument names.
```
