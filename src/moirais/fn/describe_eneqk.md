...
`print(result)` render. See `moirais.fn.describe('eneqk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eneqk import *
import numpy as np
# See the function signature in fn/eneqk.py for argument names.
```
