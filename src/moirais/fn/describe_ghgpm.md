# describe('ghgpm') — ghosal_gp_matern
...
`print(result)` render. See `moirais.fn.describe('ghgpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghgpm import *
import numpy as np
# See the function signature in fn/ghgpm.py for argument names.
```
