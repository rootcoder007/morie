...
__all__ = ["wilcox_chapter_13_unnumbered_1263"]


def wilcox_chapter_13_unnumbered_1263(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: alpha=0.05,plotit=TRUE,plot.dif=FALSE,pts=NA,sm=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1263')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1263: PowerAndDesign expression (auto-extracted; see ref)."
