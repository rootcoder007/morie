...
`print(result)` render. See `moirais.fn.describe('tssdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssdb import *
import numpy as np
# See the function signature in fn/tssdb.py for argument names.
```
