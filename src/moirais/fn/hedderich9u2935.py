...
__all__ = ["hedderich_chapter_9_unnumbered_2935"]


def hedderich_chapter_9_unnumbered_2935(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( d i r== " less " ) result <− s . nelse NA
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2935')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2935: GeneralStatistics expression (auto-extracted; see ref)."
