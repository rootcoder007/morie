...
__all__ = ["hedderich_chapter_9_unnumbered_2327"]


def hedderich_chapter_9_unnumbered_2327(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: z = 2.602712 and combined P− value = 0.004624487
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2327')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2327: GeneralStatistics expression (auto-extracted; see ref)."
