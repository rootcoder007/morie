...
`print(result)` render. See `moirais.fn.describe('eslzst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslzst import *
import numpy as np
# See the function signature in fn/eslzst.py for argument names.
```
