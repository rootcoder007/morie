# describe('goalc') — goal_conditioned
...
`print(result)` render. See `moirais.fn.describe('goalc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.goalc import *
import numpy as np
# See the function signature in fn/goalc.py for argument names.
```
