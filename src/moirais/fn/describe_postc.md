# describe('postc') — posterior_consistency_rate
...
`print(result)` render. See `moirais.fn.describe('postc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.postc import *
import numpy as np
# See the function signature in fn/postc.py for argument names.
```
