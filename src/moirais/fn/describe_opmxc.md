...
`print(result)` render. See `moirais.fn.describe('opmxc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opmxc import *
import numpy as np
# See the function signature in fn/opmxc.py for argument names.
```
