...
`print(result)` render. See `moirais.fn.describe('gmmcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmmcl import *
import numpy as np
# See the function signature in fn/gmmcl.py for argument names.
```
