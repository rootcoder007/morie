...
`print(result)` render. See `moirais.fn.describe('hmvqv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvqv import *
import numpy as np
# See the function signature in fn/hmvqv.py for argument names.
```
