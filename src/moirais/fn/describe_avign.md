# describe('avign') — anchoring_vignettes_fn
...
`print(result)` render. See `moirais.fn.describe('avign')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avign import *
import numpy as np
# See the function signature in fn/avign.py for argument names.
```
