# describe('wsmbpv') — wasserman_bootstrap_pivotal
...
`print(result)` render. See `moirais.fn.describe('wsmbpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbpv import *
import numpy as np
# See the function signature in fn/wsmbpv.py for argument names.
```
