...
`print(result)` render. See `moirais.fn.describe('gwrgaus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrgaus import *
import numpy as np
# See the function signature in fn/gwrgaus.py for argument names.
```
