...
`print(result)` render. See `moirais.fn.describe('ppchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppchg import *
import numpy as np
# See the function signature in fn/ppchg.py for argument names.
```
