...
`print(result)` render. See `moirais.fn.describe('ocros')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocros import *
import numpy as np
# See the function signature in fn/ocros.py for argument names.
```
