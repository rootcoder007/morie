# describe('svyglm') — cheatsheet

## WHAT IT DOES

Complex survey GLM with weights, clustering, and strata. 'Patience is bitter, but its fruit is sweet. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('svyglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svyglm import *
import numpy as np
# See the function signature in fn/svyglm.py for argument names.
```
