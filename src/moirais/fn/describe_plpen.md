...
`print(result)` render. See `moirais.fn.describe('plpen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plpen import *
import numpy as np
# See the function signature in fn/plpen.py for argument names.
```
