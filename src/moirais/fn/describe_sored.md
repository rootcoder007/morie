...
`print(result)` render. See `moirais.fn.describe('sored')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sored import *
import numpy as np
# See the function signature in fn/sored.py for argument names.
```
