...
`print(result)` render. See `moirais.fn.describe('eslmrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslmrf import *
import numpy as np
# See the function signature in fn/eslmrf.py for argument names.
```
