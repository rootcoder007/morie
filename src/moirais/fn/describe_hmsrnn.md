# describe('hmsrnn') — geron_simple_rnn
...
`print(result)` render. See `moirais.fn.describe('hmsrnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsrnn import *
import numpy as np
# See the function signature in fn/hmsrnn.py for argument names.
```
