...
`print(result)` render. See `moirais.fn.describe('crpsF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crpsF import *
import numpy as np
# See the function signature in fn/crpsF.py for argument names.
```
