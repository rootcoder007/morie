# describe('contse') — contrastive_sent
...
`print(result)` render. See `moirais.fn.describe('contse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.contse import *
import numpy as np
# See the function signature in fn/contse.py for argument names.
```
