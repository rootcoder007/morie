# describe('amscl') — aldrich_mckelvey_scaling
...
`print(result)` render. See `moirais.fn.describe('amscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amscl import *
import numpy as np
# See the function signature in fn/amscl.py for argument names.
```
