...
`print(result)` render. See `moirais.fn.describe('coitg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coitg import *
import numpy as np
# See the function signature in fn/coitg.py for argument names.
```
