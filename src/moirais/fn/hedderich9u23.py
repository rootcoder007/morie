...
__all__ = ["hedderich_chapter_9_unnumbered_23"]


def hedderich_chapter_9_unnumbered_23(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 20.9−4.8 = 16 .1 or 15.6.3 is approximately equal to 5, exactly 5.2; Test 5.2·3 = 15 .6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u23')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u23: GeneralStatistics expression (auto-extracted; see ref)."
