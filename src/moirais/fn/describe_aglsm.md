...
`print(result)` render. See `moirais.fn.describe('aglsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglsm import *
import numpy as np
# See the function signature in fn/aglsm.py for argument names.
```
