...
`print(result)` render. See `moirais.fn.describe('jntnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntnt import *
import numpy as np
# See the function signature in fn/jntnt.py for argument names.
```
