# describe('km144') — kamath_ch9_mm_instr_predict
...
`print(result)` render. See `moirais.fn.describe('km144')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km144 import *
import numpy as np
# See the function signature in fn/km144.py for argument names.
```
