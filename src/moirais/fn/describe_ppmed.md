...
`print(result)` render. See `moirais.fn.describe('ppmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmed import *
import numpy as np
# See the function signature in fn/ppmed.py for argument names.
```
