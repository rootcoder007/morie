# describe('rng070') — rangayyan_ch3_idft_definition
...
`print(result)` render. See `moirais.fn.describe('rng070')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng070 import *
import numpy as np
# See the function signature in fn/rng070.py for argument names.
```
