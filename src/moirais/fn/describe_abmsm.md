...
`print(result)` render. See `moirais.fn.describe('abmsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abmsm import *
import numpy as np
# See the function signature in fn/abmsm.py for argument names.
```
