...
`print(result)` render. See `moirais.fn.describe('rgksv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgksv import *
import numpy as np
# See the function signature in fn/rgksv.py for argument names.
```
