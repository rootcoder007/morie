# describe('dagre') — diagnostic_agreement

## WHAT IT DOES

Diagnostic agreement (Cohen's kappa). 'Judge me by my size, do you?'Knowing yourself is the beginning of all wisdom. — Aristotle's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('dagre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dagre import *
import numpy as np
# See the function signature in fn/dagre.py for argument names.
```
