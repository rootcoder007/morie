# describe('msm112') — mvsml_bayesian_regression_pt2_eq_7_9
...
`print(result)` render. See `moirais.fn.describe('msm112')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm112 import *
import numpy as np
# See the function signature in fn/msm112.py for argument names.
```
