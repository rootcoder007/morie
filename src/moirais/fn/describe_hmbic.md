...
`print(result)` render. See `moirais.fn.describe('hmbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbic import *
import numpy as np
# See the function signature in fn/hmbic.py for argument names.
```
