# describe('kmmbi') — kamath_membership_inference
...
`print(result)` render. See `moirais.fn.describe('kmmbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmmbi import *
import numpy as np
# See the function signature in fn/kmmbi.py for argument names.
```
