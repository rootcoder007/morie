...
`print(result)` render. See `moirais.fn.describe('dk4sm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk4sm import *
import numpy as np
# See the function signature in fn/dk4sm.py for argument names.
```
