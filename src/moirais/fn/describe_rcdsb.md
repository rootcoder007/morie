# describe('rcdsb') — recidivism_subgroup
...
`print(result)` render. See `moirais.fn.describe('rcdsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdsb import *
import numpy as np
# See the function signature in fn/rcdsb.py for argument names.
```
