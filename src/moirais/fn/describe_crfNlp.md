...
`print(result)` render. See `moirais.fn.describe('crfNlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfNlp import *
import numpy as np
# See the function signature in fn/crfNlp.py for argument names.
```
