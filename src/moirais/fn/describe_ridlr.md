# describe('ridlr') — cipher_frequency
...
`print(result)` render. See `moirais.fn.describe('ridlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ridlr import *
import numpy as np
# See the function signature in fn/ridlr.py for argument names.
```
