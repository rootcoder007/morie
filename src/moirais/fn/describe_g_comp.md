# describe('g_comp') — estimate_ate_gcomputation
...
`print(result)` render. See `moirais.fn.describe('g_comp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.g_comp import *
import numpy as np
# See the function signature in fn/g_comp.py for argument names.
```
