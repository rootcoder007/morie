...
__all__ = ["hedderich_chapter_9_unnumbered_776"]


def hedderich_chapter_9_unnumbered_776(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] ˆq =n−k + 1 (5.103)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u776')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u776: CountModels expression (auto-extracted; see ref)."
