...
`print(result)` render. See `moirais.fn.describe('trigen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trigen import *
import numpy as np
# See the function signature in fn/trigen.py for argument names.
```
