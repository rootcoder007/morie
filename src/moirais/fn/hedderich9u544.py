...
__all__ = ["hedderich_chapter_9_unnumbered_544"]


def hedderich_chapter_9_unnumbered_544(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (8) P (aX̄ <b) = F (b)−F (a) +P (X =a)−P (X =b)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u544')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u544: GeneralStatistics expression (auto-extracted; see ref)."
