# describe('km007') — kamath_ch2_attention_score
...
`print(result)` render. See `moirais.fn.describe('km007')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km007 import *
import numpy as np
# See the function signature in fn/km007.py for argument names.
```
