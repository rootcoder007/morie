...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_133"]


def information_theory_mackay_chapter_6_unnumbered_133(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] isPX =fp0 =0.5;p1 =0.5g.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u133')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u133: GeneralStatistics expression (auto-extracted; see ref)."
