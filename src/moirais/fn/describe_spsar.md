# describe('spsar') — schabenberger_sar_model
...
`print(result)` render. See `moirais.fn.describe('spsar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsar import *
import numpy as np
# See the function signature in fn/spsar.py for argument names.
```
