# describe('sglml') — lm_test_spatial
...
`print(result)` render. See `moirais.fn.describe('sglml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglml import *
import numpy as np
# See the function signature in fn/sglml.py for argument names.
```
