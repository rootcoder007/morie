# describe('laplc') — laplace_mechanism
...
`print(result)` render. See `moirais.fn.describe('laplc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laplc import *
import numpy as np
# See the function signature in fn/laplc.py for argument names.
```
