...
`print(result)` render. See `moirais.fn.describe('whitt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whitt import *
import numpy as np
# See the function signature in fn/whitt.py for argument names.
```
