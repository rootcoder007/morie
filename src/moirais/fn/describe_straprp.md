# describe('straprp') — stratified_proportion
...
`print(result)` render. See `moirais.fn.describe('straprp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.straprp import *
import numpy as np
# See the function signature in fn/straprp.py for argument names.
```
