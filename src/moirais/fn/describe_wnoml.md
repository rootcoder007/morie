# describe('wnoml') — wnominate_logit
...
`print(result)` render. See `moirais.fn.describe('wnoml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnoml import *
import numpy as np
# See the function signature in fn/wnoml.py for argument names.
```
