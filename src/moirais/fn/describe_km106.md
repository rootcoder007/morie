# describe('km106') — kamath_ch6_self_diagnosis_prob
...
`print(result)` render. See `moirais.fn.describe('km106')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km106 import *
import numpy as np
# See the function signature in fn/km106.py for argument names.
```
