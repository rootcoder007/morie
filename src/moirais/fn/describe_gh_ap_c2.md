# describe('gh_ap_c2') — ghosal_packing_num
...
`print(result)` render. See `moirais.fn.describe('gh_ap_c2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_c2 import *
import numpy as np
# See the function signature in fn/gh_ap_c2.py for argument names.
```
