# describe('cvxcvv') — boyd_cvxlin_complement
...
`print(result)` render. See `moirais.fn.describe('cvxcvv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxcvv import *
import numpy as np
# See the function signature in fn/cvxcvv.py for argument names.
```
