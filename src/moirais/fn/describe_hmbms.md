# describe('hmbms') — geron_beam_search
...
`print(result)` render. See `moirais.fn.describe('hmbms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbms import *
import numpy as np
# See the function signature in fn/hmbms.py for argument names.
```
