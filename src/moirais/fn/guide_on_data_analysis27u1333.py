...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1333"]


def guide_on_data_analysis_chapter_27_unnumbered_1333(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌 |𝑍 = 1] − 𝐸[𝑌 |𝑍 = 0]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1333')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1333: GeneralStatistics expression (auto-extracted; see ref)."
