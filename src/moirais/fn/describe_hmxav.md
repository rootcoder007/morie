# describe('hmxav') — geron_glorot_init
...
`print(result)` render. See `moirais.fn.describe('hmxav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmxav import *
import numpy as np
# See the function signature in fn/hmxav.py for argument names.
```
