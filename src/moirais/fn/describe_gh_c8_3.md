# describe('gh_c8_3') — ghosal_test_cond
...
`print(result)` render. See `moirais.fn.describe('gh_c8_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c8_3 import *
import numpy as np
# See the function signature in fn/gh_c8_3.py for argument names.
```
