...
`print(result)` render. See `moirais.fn.describe('rsfpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsfpr import *
import numpy as np
# See the function signature in fn/rsfpr.py for argument names.
```
