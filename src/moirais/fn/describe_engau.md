...
`print(result)` render. See `moirais.fn.describe('engau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.engau import *
import numpy as np
# See the function signature in fn/engau.py for argument names.
```
