...
`print(result)` render. See `moirais.fn.describe('zxscv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxscv import *
import numpy as np
# See the function signature in fn/zxscv.py for argument names.
```
