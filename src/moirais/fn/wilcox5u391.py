...
__all__ = ["wilcox_chapter_5_unnumbered_391"]


def wilcox_chapter_5_unnumbered_391(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: σ = 5, the manufacturer tests H0: µ ≥ 48, the idea being that if it is rejected,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u391')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u391: GeneralStatistics expression (auto-extracted; see ref)."
