# describe('smpdi') — simpson_diversity
...
`print(result)` render. See `moirais.fn.describe('smpdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpdi import *
import numpy as np
# See the function signature in fn/smpdi.py for argument names.
```
