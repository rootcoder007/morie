...
`print(result)` render. See `moirais.fn.describe('rlad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlad import *
import numpy as np
# See the function signature in fn/rlad.py for argument names.
```
