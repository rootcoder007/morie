...
__all__ = ["hedderich_chapter_9_unnumbered_1347"]


def hedderich_chapter_9_unnumbered_1347(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( side == " one − sided " ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1347')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1347: PowerAndDesign expression (auto-extracted; see ref)."
