# describe('robin') — winsorized_mean
...
`print(result)` render. See `moirais.fn.describe('robin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robin import *
import numpy as np
# See the function signature in fn/robin.py for argument names.
```
