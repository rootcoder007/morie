...
`print(result)` render. See `moirais.fn.describe('wsmlln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlln import *
import numpy as np
# See the function signature in fn/wsmlln.py for argument names.
```
