# describe('cvxsup') — boyd_support_hyperplane
...
`print(result)` render. See `moirais.fn.describe('cvxsup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsup import *
import numpy as np
# See the function signature in fn/cvxsup.py for argument names.
```
