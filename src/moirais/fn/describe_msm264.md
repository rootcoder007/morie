# describe('msm264') — mvsml_convolutional_nn_eq_14_3
...
`print(result)` render. See `moirais.fn.describe('msm264')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm264 import *
import numpy as np
# See the function signature in fn/msm264.py for argument names.
```
