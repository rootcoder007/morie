...
__all__ = ["hedderich_chapter_9_unnumbered_1691"]


def hedderich_chapter_9_unnumbered_1691(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + j <− which ( v == max( v ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1691')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1691: GeneralStatistics expression (auto-extracted; see ref)."
