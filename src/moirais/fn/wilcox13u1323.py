...
__all__ = ["wilcox_chapter_13_unnumbered_1323"]


def wilcox_chapter_13_unnumbered_1323(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: ∑ ∑wijpij − ∑ ∑wijpi+p+j
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1323')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1323: ContingencyTables expression (auto-extracted; see ref)."
