# describe('rgs') — functional_regression
...
`print(result)` render. See `moirais.fn.describe('rgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgs import *
import numpy as np
# See the function signature in fn/rgs.py for argument names.
```
