# describe('gh_sobol_prior') — ghosal_sobolev_prior
...
`print(result)` render. See `moirais.fn.describe('gh_sobol_prior')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_sobol_prior import *
import numpy as np
# See the function signature in fn/gh_sobol_prior.py for argument names.
```
