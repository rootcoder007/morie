...
`print(result)` render. See `moirais.fn.describe('km086')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km086 import *
import numpy as np
# See the function signature in fn/km086.py for argument names.
```
