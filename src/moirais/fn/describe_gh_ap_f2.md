# describe('gh_ap_f2') — ghosal_glivenko
...
`print(result)` render. See `moirais.fn.describe('gh_ap_f2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_f2 import *
import numpy as np
# See the function signature in fn/gh_ap_f2.py for argument names.
```
