# describe('rghhtsp') — rangayyan_hht_spectrum
...
`print(result)` render. See `moirais.fn.describe('rghhtsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghhtsp import *
import numpy as np
# See the function signature in fn/rghhtsp.py for argument names.
```
