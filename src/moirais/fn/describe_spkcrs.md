# describe('spkcrs') — schabenberger_cross_k_function
...
`print(result)` render. See `moirais.fn.describe('spkcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkcrs import *
import numpy as np
# See the function signature in fn/spkcrs.py for argument names.
```
