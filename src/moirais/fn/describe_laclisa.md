...
`print(result)` render. See `moirais.fn.describe('laclisa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laclisa import *
import numpy as np
# See the function signature in fn/laclisa.py for argument names.
```
