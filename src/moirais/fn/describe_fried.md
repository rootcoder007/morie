...
`print(result)` render. See `moirais.fn.describe('fried')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fried import *
import numpy as np
# See the function signature in fn/fried.py for argument names.
```
