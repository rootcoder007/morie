...
__all__ = ["hedderich_chapter_9_unnumbered_2822"]


def hedderich_chapter_9_unnumbered_2822(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆχ2 = 8, 90 ˆ χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2822')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2822: GeneralStatistics expression (auto-extracted; see ref)."
