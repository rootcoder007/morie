...
`print(result)` render. See `moirais.fn.describe('envlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.envlc import *
import numpy as np
# See the function signature in fn/envlc.py for argument names.
```
