# describe('acwhe') — private_accuracy_tradeoff
...
`print(result)` render. See `moirais.fn.describe('acwhe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acwhe import *
import numpy as np
# See the function signature in fn/acwhe.py for argument names.
```
