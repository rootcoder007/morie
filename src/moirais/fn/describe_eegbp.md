# describe('eegbp') — eeg_band_power_fn
...
`print(result)` render. See `moirais.fn.describe('eegbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eegbp import *
import numpy as np
# See the function signature in fn/eegbp.py for argument names.
```
