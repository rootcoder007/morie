# describe('bsmed') — bootstrap_mediation_ci
...
`print(result)` render. See `moirais.fn.describe('bsmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsmed import *
import numpy as np
# See the function signature in fn/bsmed.py for argument names.
```
