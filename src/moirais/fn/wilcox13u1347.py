...
__all__ = ["wilcox_chapter_13_unnumbered_1347"]


def wilcox_chapter_13_unnumbered_1347(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x=matrix(c(8,67,5,20),ncol=2,nrow=2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1347')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1347: GeneralStatistics expression (auto-extracted; see ref)."
