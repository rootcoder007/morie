...
`print(result)` render. See `moirais.fn.describe('ubprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubprv import *
import numpy as np
# See the function signature in fn/ubprv.py for argument names.
```
