...
`print(result)` render. See `moirais.fn.describe('boltz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boltz import *
import numpy as np
# See the function signature in fn/boltz.py for argument names.
```
