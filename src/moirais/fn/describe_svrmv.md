...
`print(result)` render. See `moirais.fn.describe('svrmv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrmv import *
import numpy as np
# See the function signature in fn/svrmv.py for argument names.
```
