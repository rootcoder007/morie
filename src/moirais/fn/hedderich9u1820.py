...
__all__ = ["hedderich_chapter_9_unnumbered_1820"]


def hedderich_chapter_9_unnumbered_1820(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t = 2 . 1 3 5 5 , df = 7 , p− value = 0 .0 3 5 05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1820')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1820: GeneralStatistics expression (auto-extracted; see ref)."
