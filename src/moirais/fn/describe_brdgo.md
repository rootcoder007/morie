# describe('brdgo') — bridge_observations
...
`print(result)` render. See `moirais.fn.describe('brdgo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brdgo import *
import numpy as np
# See the function signature in fn/brdgo.py for argument names.
```
