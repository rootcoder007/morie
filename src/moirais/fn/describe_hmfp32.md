...
`print(result)` render. See `moirais.fn.describe('hmfp32')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfp32 import *
import numpy as np
# See the function signature in fn/hmfp32.py for argument names.
```
