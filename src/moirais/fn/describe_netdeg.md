# describe('netdeg') — degree_centrality
...
`print(result)` render. See `moirais.fn.describe('netdeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netdeg import *
import numpy as np
# See the function signature in fn/netdeg.py for argument names.
```
