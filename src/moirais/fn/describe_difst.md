# describe('difst') — dif_stocking_lord
...
`print(result)` render. See `moirais.fn.describe('difst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difst import *
import numpy as np
# See the function signature in fn/difst.py for argument names.
```
