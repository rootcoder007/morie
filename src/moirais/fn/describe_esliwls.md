...
`print(result)` render. See `moirais.fn.describe('esliwls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esliwls import *
import numpy as np
# See the function signature in fn/esliwls.py for argument names.
```
