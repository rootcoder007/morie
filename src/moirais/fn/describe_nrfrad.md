...
`print(result)` render. See `moirais.fn.describe('nrfrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrfrad import *
import numpy as np
# See the function signature in fn/nrfrad.py for argument names.
```
