...
`print(result)` render. See `moirais.fn.describe('db2pw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.db2pw import *
import numpy as np
# See the function signature in fn/db2pw.py for argument names.
```
