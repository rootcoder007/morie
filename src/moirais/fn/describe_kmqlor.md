# describe('kmqlor') — kamath_qlora_4bit
...
`print(result)` render. See `moirais.fn.describe('kmqlor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmqlor import *
import numpy as np
# See the function signature in fn/kmqlor.py for argument names.
```
