# describe('mac3') — ma_centered_predictors
...
`print(result)` render. See `moirais.fn.describe('mac3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mac3 import *
import numpy as np
# See the function signature in fn/mac3.py for argument names.
```
