...
__all__ = ["use_r_chapter_2_unnumbered_145"]


def use_r_chapter_2_unnumbered_145(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: example λ = − 0.2, might be somewhat better than log-transforming for those
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u145')`` for the full guide.
...
def cheatsheet():
    return "use_r2u145: GeneralStatistics expression (auto-extracted; see ref)."
