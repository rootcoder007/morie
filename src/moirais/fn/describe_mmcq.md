...
`print(result)` render. See `moirais.fn.describe('mmcq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmcq import *
import numpy as np
# See the function signature in fn/mmcq.py for argument names.
```
