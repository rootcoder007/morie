# describe('rng041') — rangayyan_ch3_lsi_series_intermediate
...
`print(result)` render. See `moirais.fn.describe('rng041')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng041 import *
import numpy as np
# See the function signature in fn/rng041.py for argument names.
```
