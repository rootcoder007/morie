# describe('volgvar') — vol_garch_var_backtest
...
`print(result)` render. See `moirais.fn.describe('volgvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgvar import *
import numpy as np
# See the function signature in fn/volgvar.py for argument names.
```
