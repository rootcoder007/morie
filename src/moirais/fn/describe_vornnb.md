...
`print(result)` render. See `moirais.fn.describe('vornnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vornnb import *
import numpy as np
# See the function signature in fn/vornnb.py for argument names.
```
