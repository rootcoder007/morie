...
`print(result)` render. See `moirais.fn.describe('dpsum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsum import *
import numpy as np
# See the function signature in fn/dpsum.py for argument names.
```
