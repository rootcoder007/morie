...
`print(result)` render. See `moirais.fn.describe('mttng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mttng import *
import numpy as np
# See the function signature in fn/mttng.py for argument names.
```
