...
`print(result)` render. See `moirais.fn.describe('bsctn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsctn import *
import numpy as np
# See the function signature in fn/bsctn.py for argument names.
```
