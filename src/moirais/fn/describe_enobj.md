# describe('enobj') — elastic_net_objective
...
`print(result)` render. See `moirais.fn.describe('enobj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enobj import *
import numpy as np
# See the function signature in fn/enobj.py for argument names.
```
