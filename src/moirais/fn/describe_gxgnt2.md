# describe('gxgnt2') — gxg_interaction
...
`print(result)` render. See `moirais.fn.describe('gxgnt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gxgnt2 import *
import numpy as np
# See the function signature in fn/gxgnt2.py for argument names.
```
