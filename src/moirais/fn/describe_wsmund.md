# describe('wsmund') — wasserman_undirected_graph
...
`print(result)` render. See `moirais.fn.describe('wsmund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmund import *
import numpy as np
# See the function signature in fn/wsmund.py for argument names.
```
