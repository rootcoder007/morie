# describe('tqprd') — turboquant_prod
...
`print(result)` render. See `moirais.fn.describe('tqprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqprd import *
import numpy as np
# See the function signature in fn/tqprd.py for argument names.
```
