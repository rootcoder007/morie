...
`print(result)` render. See `moirais.fn.describe('brent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brent import *
import numpy as np
# See the function signature in fn/brent.py for argument names.
```
