# describe('spnug') — schabenberger_nugget_effect
...
`print(result)` render. See `moirais.fn.describe('spnug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnug import *
import numpy as np
# See the function signature in fn/spnug.py for argument names.
```
