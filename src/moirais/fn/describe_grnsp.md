# describe('grnsp') — geron_bert_nsp_loss
...
`print(result)` render. See `moirais.fn.describe('grnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnsp import *
import numpy as np
# See the function signature in fn/grnsp.py for argument names.
```
