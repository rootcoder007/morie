# describe('detrnd') — detrend_climate
...
`print(result)` render. See `moirais.fn.describe('detrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.detrnd import *
import numpy as np
# See the function signature in fn/detrnd.py for argument names.
```
