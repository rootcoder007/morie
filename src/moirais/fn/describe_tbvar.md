...
`print(result)` render. See `moirais.fn.describe('tbvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbvar import *
import numpy as np
# See the function signature in fn/tbvar.py for argument names.
```
