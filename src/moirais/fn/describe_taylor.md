# describe('taylor') — taylor_linearization
...
`print(result)` render. See `moirais.fn.describe('taylor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taylor import *
import numpy as np
# See the function signature in fn/taylor.py for argument names.
```
