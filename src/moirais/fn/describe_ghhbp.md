# describe('ghhbp') — ghosal_hierarchical_bayes
...
`print(result)` render. See `moirais.fn.describe('ghhbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghhbp import *
import numpy as np
# See the function signature in fn/ghhbp.py for argument names.
```
