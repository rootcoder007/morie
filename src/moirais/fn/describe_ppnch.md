...
`print(result)` render. See `moirais.fn.describe('ppnch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppnch import *
import numpy as np
# See the function signature in fn/ppnch.py for argument names.
```
