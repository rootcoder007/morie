...
__all__ = ["law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_3_unnumbered_2"]


def law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_3_unnumbered_2(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (value of fatal risk) = 100>11>10,0002,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe3u2')`` for the full guide.
...
def cheatsheet():
    return "law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe3u2: GeneralStatistics expression (auto-extracted; see ref)."
