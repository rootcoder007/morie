...
`print(result)` render. See `moirais.fn.describe('ubsho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubsho import *
import numpy as np
# See the function signature in fn/ubsho.py for argument names.
```
