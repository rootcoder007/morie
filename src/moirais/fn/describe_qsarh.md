...
`print(result)` render. See `moirais.fn.describe('qsarh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qsarh import *
import numpy as np
# See the function signature in fn/qsarh.py for argument names.
```
