...
`print(result)` render. See `moirais.fn.describe('s2var')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.s2var import *
import numpy as np
# See the function signature in fn/s2var.py for argument names.
```
