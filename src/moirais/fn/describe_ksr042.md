# describe('ksr042') — kosorok_ch2_functional_delta_method
...
`print(result)` render. See `moirais.fn.describe('ksr042')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr042 import *
import numpy as np
# See the function signature in fn/ksr042.py for argument names.
```
