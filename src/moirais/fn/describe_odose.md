# describe('odose') — otis_dose_response
...
`print(result)` render. See `moirais.fn.describe('odose')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odose import *
import numpy as np
# See the function signature in fn/odose.py for argument names.
```
