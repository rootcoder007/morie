...
`print(result)` render. See `moirais.fn.describe('bpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpb import *
import numpy as np
# See the function signature in fn/bpb.py for argument names.
```
