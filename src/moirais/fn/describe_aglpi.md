...
`print(result)` render. See `moirais.fn.describe('aglpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglpi import *
import numpy as np
# See the function signature in fn/aglpi.py for argument names.
```
