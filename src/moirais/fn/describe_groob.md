# describe('groob') — geron_oob_error
...
`print(result)` render. See `moirais.fn.describe('groob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groob import *
import numpy as np
# See the function signature in fn/groob.py for argument names.
```
