...
`print(result)` render. See `moirais.fn.describe('pleri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pleri import *
import numpy as np
# See the function signature in fn/pleri.py for argument names.
```
