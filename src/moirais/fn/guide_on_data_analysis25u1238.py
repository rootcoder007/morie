...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1238"]


def guide_on_data_analysis_chapter_25_unnumbered_1238(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] • 𝑔𝑖𝑗 = (y𝑖 − ̄y)′S−1(y𝑗 − ̄y),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1238')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1238: GeneralStatistics expression (auto-extracted; see ref)."
