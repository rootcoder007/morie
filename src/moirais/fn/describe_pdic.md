# describe('pdic') — effective_parameters_dic
...
`print(result)` render. See `moirais.fn.describe('pdic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdic import *
import numpy as np
# See the function signature in fn/pdic.py for argument names.
```
