...
__all__ = ["hedderich_chapter_9_unnumbered_75"]


def hedderich_chapter_9_unnumbered_75(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (A + B) + C = A + (B + C)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u75')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u75: GeneralStatistics expression (auto-extracted; see ref)."
