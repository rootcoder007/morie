...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_481"]


def guide_on_data_analysis_chapter_6_unnumbered_481(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] • Δ𝜃(𝑗)= 𝜃(𝑗+1)− 𝜃(𝑗),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u481')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u481: GeneralStatistics expression (auto-extracted; see ref)."
