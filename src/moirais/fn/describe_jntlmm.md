# describe('jntlmm') — joint_longitudinal_survival
...
`print(result)` render. See `moirais.fn.describe('jntlmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntlmm import *
import numpy as np
# See the function signature in fn/jntlmm.py for argument names.
```
