...
`print(result)` render. See `moirais.fn.describe('smplxs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smplxs import *
import numpy as np
# See the function signature in fn/smplxs.py for argument names.
```
