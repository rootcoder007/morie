# describe('hmdrnn') — geron_deep_rnn
...
`print(result)` render. See `moirais.fn.describe('hmdrnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdrnn import *
import numpy as np
# See the function signature in fn/hmdrnn.py for argument names.
```
