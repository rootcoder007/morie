# describe('ksr034') — kosorok_ch2_glivenko_cantelli_bracketing
...
`print(result)` render. See `moirais.fn.describe('ksr034')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr034 import *
import numpy as np
# See the function signature in fn/ksr034.py for argument names.
```
