# describe('exchg') — exchangeability_assumption
...
`print(result)` render. See `moirais.fn.describe('exchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.exchg import *
import numpy as np
# See the function signature in fn/exchg.py for argument names.
```
