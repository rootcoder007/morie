# describe('svdsc') — discount_utility
...
`print(result)` render. See `moirais.fn.describe('svdsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdsc import *
import numpy as np
# See the function signature in fn/svdsc.py for argument names.
```
