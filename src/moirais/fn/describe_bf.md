...
`print(result)` render. See `moirais.fn.describe('bf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bf import *
import numpy as np
# See the function signature in fn/bf.py for argument names.
```
