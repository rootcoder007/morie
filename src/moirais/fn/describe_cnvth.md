# describe('cnvth') — convolution_theorem_verify
...
`print(result)` render. See `moirais.fn.describe('cnvth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnvth import *
import numpy as np
# See the function signature in fn/cnvth.py for argument names.
```
