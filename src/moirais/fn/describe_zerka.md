# describe('zerka') — risk_adaptive_bw
...
`print(result)` render. See `moirais.fn.describe('zerka')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zerka import *
import numpy as np
# See the function signature in fn/zerka.py for argument names.
```
