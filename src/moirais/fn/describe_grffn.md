# describe('grffn') — geron_transformer_feedforward
...
`print(result)` render. See `moirais.fn.describe('grffn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grffn import *
import numpy as np
# See the function signature in fn/grffn.py for argument names.
```
