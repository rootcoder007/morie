# describe('ufstr') — unfolding_stress
...
`print(result)` render. See `moirais.fn.describe('ufstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ufstr import *
import numpy as np
# See the function signature in fn/ufstr.py for argument names.
```
