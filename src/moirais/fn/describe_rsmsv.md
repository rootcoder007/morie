...
`print(result)` render. See `moirais.fn.describe('rsmsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmsv import *
import numpy as np
# See the function signature in fn/rsmsv.py for argument names.
```
