...
`print(result)` render. See `moirais.fn.describe('sppres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppres import *
import numpy as np
# See the function signature in fn/sppres.py for argument names.
```
