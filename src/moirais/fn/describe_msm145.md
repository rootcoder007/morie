# describe('msm145') — mvsml_categorical_count_eq_8_11
...
`print(result)` render. See `moirais.fn.describe('msm145')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm145 import *
import numpy as np
# See the function signature in fn/msm145.py for argument names.
```
