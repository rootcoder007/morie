...
`print(result)` render. See `moirais.fn.describe('krigsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krigsv import *
import numpy as np
# See the function signature in fn/krigsv.py for argument names.
```
