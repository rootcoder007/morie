...
__all__ = ["hedderich_chapter_9_unnumbered_79"]


def hedderich_chapter_9_unnumbered_79(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] A(B + C) = AB + AC
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u79')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u79: GeneralStatistics expression (auto-extracted; see ref)."
