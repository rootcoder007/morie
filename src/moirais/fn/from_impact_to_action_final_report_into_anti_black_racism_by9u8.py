...
__all__ = ["from_impact_to_action_final_report_into_anti_black_racism_by_chapter_9_unnumbered_8"]


def from_impact_to_action_final_report_into_anti_black_racism_by_chapter_9_unnumbered_8(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('from_impact_to_action_final_report_into_anti_black_racism_by9u8')`` for the full guide.
...
def cheatsheet():
    return "from_impact_to_action_final_report_into_anti_black_racism_by9u8: GeneralStatistics expression (auto-extracted; see ref)."
