# describe('ccngg') — nakagawa_conditional_r2
...
`print(result)` render. See `moirais.fn.describe('ccngg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccngg import *
import numpy as np
# See the function signature in fn/ccngg.py for argument names.
```
