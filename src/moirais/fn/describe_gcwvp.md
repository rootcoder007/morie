...
`print(result)` render. See `moirais.fn.describe('gcwvp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcwvp import *
import numpy as np
# See the function signature in fn/gcwvp.py for argument names.
```
