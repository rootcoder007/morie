# describe('dpamp') — privacy_amplification
...
`print(result)` render. See `moirais.fn.describe('dpamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpamp import *
import numpy as np
# See the function signature in fn/dpamp.py for argument names.
```
