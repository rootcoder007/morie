# describe('rgwvth') — rangayyan_wavelet_threshold
...
`print(result)` render. See `moirais.fn.describe('rgwvth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvth import *
import numpy as np
# See the function signature in fn/rgwvth.py for argument names.
```
