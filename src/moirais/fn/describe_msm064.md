# describe('msm064') — mvsml_bayesian_regression_eq_6_5
...
`print(result)` render. See `moirais.fn.describe('msm064')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm064 import *
import numpy as np
# See the function signature in fn/msm064.py for argument names.
```
