...
`print(result)` render. See `moirais.fn.describe('orooc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orooc import *
import numpy as np
# See the function signature in fn/orooc.py for argument names.
```
