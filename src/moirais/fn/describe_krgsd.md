...
`print(result)` render. See `moirais.fn.describe('krgsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgsd import *
import numpy as np
# See the function signature in fn/krgsd.py for argument names.
```
