...
__all__ = ["hedderich_chapter_9_unnumbered_412"]


def hedderich_chapter_9_unnumbered_412(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For example,P (5) = lg 6−lg 5 = 0.0792.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u412')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u412: GeneralStatistics expression (auto-extracted; see ref)."
