...
`print(result)` render. See `moirais.fn.describe('sawgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawgb import *
import numpy as np
# See the function signature in fn/sawgb.py for argument names.
```
