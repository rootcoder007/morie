# describe('brnstn') — bernstein_inequality
...
`print(result)` render. See `moirais.fn.describe('brnstn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brnstn import *
import numpy as np
# See the function signature in fn/brnstn.py for argument names.
```
