...
__all__ = ["wilcox_chapter_4_unnumbered_197"]


def wilcox_chapter_4_unnumbered_197(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.95, as previously indicated, so P (T ≥ 2.132) = 1 − P (T ≤ 2.132) = 0.05.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u197')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u197: GeneralStatistics expression (auto-extracted; see ref)."
