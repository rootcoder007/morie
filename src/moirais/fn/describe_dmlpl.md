...
`print(result)` render. See `moirais.fn.describe('dmlpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmlpl import *
import numpy as np
# See the function signature in fn/dmlpl.py for argument names.
```
