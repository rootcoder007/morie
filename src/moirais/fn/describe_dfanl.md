...
`print(result)` render. See `moirais.fn.describe('dfanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfanl import *
import numpy as np
# See the function signature in fn/dfanl.py for argument names.
```
