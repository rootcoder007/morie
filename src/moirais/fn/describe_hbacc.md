# describe('hbacc') — hbond_acceptor_count
...
`print(result)` render. See `moirais.fn.describe('hbacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hbacc import *
import numpy as np
# See the function signature in fn/hbacc.py for argument names.
```
