...
`print(result)` render. See `moirais.fn.describe('enrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enrad import *
import numpy as np
# See the function signature in fn/enrad.py for argument names.
```
