# describe('rng063') — rangayyan_ch3_complex_exponential
...
`print(result)` render. See `moirais.fn.describe('rng063')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng063 import *
import numpy as np
# See the function signature in fn/rng063.py for argument names.
```
