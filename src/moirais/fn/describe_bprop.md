# describe('bprop') — backpropagation_chain_rule
...
`print(result)` render. See `moirais.fn.describe('bprop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bprop import *
import numpy as np
# See the function signature in fn/bprop.py for argument names.
```
