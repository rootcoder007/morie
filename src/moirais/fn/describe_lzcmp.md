# describe('lzcmp') — lempel_ziv_complexity
...
`print(result)` render. See `moirais.fn.describe('lzcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lzcmp import *
import numpy as np
# See the function signature in fn/lzcmp.py for argument names.
```
