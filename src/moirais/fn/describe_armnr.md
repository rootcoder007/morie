# describe('armnr') — arma_newton_raphson_fn
...
`print(result)` render. See `moirais.fn.describe('armnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.armnr import *
import numpy as np
# See the function signature in fn/armnr.py for argument names.
```
