...
`print(result)` render. See `moirais.fn.describe('km122')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km122 import *
import numpy as np
# See the function signature in fn/km122.py for argument names.
```
