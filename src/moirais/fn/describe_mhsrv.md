# describe('mhsrv') — service_utilization
...
`print(result)` render. See `moirais.fn.describe('mhsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhsrv import *
import numpy as np
# See the function signature in fn/mhsrv.py for argument names.
```
