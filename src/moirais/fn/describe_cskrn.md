...
`print(result)` render. See `moirais.fn.describe('cskrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cskrn import *
import numpy as np
# See the function signature in fn/cskrn.py for argument names.
```
