# describe('prflt') — polyphase_filter
...
`print(result)` render. See `moirais.fn.describe('prflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prflt import *
import numpy as np
# See the function signature in fn/prflt.py for argument names.
```
