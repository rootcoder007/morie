...
`print(result)` render. See `moirais.fn.describe('You have power over your mind — not outside events. — Marcus Aurelius'The happiness of your life depends upon the quality of your thoughts. — Marcus Aurelius's `References` block.
