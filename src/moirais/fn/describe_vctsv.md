# describe('vctsv') — victim_severity
...
`print(result)` render. See `moirais.fn.describe('vctsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vctsv import *
import numpy as np
# See the function signature in fn/vctsv.py for argument names.
```
