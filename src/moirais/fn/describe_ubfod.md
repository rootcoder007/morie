...
`print(result)` render. See `moirais.fn.describe('ubfod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubfod import *
import numpy as np
# See the function signature in fn/ubfod.py for argument names.
```
