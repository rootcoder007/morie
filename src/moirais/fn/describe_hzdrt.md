...
`print(result)` render. See `moirais.fn.describe('hzdrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hzdrt import *
import numpy as np
# See the function signature in fn/hzdrt.py for argument names.
```
