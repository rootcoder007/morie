# describe('plidl') — plot_ideal_and_stimuli
...
`print(result)` render. See `moirais.fn.describe('plidl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plidl import *
import numpy as np
# See the function signature in fn/plidl.py for argument names.
```
