...
__all__ = ["hedderich_chapter_9_unnumbered_2589"]


def hedderich_chapter_9_unnumbered_2589(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆp2=30/300=0.10 (notenˆp2=300·0.10=30>5), ˆp=(54+30)/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2589')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2589: GeneralStatistics expression (auto-extracted; see ref)."
