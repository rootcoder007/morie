...
`print(result)` render. See `moirais.fn.describe('ganls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ganls import *
import numpy as np
# See the function signature in fn/ganls.py for argument names.
```
