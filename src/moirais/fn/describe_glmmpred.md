...
`print(result)` render. See `moirais.fn.describe('glmmpred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmpred import *
import numpy as np
# See the function signature in fn/glmmpred.py for argument names.
```
