...
__all__ = ["hedderich_chapter_9_unnumbered_876"]


def hedderich_chapter_9_unnumbered_876(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: One-sided truncated distributions are obtained for b=∞(Φ(zb)=1) or for a=−∞(Φ(za)=0).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u876')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u876: GeneralStatistics expression (auto-extracted; see ref)."
