# describe('derivf') — derivative_function
...
`print(result)` render. See `moirais.fn.describe('derivf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.derivf import *
import numpy as np
# See the function signature in fn/derivf.py for argument names.
```
