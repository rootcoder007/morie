...
`print(result)` render. See `moirais.fn.describe('abmld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abmld import *
import numpy as np
# See the function signature in fn/abmld.py for argument names.
```
