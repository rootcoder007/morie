...
__all__ = ["hedderich_chapter_9_unnumbered_97"]


def hedderich_chapter_9_unnumbered_97(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ⇒ x′Ax = (Py)′APy = y′P′APy = y′Λy =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u97')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u97: GeneralStatistics expression (auto-extracted; see ref)."
