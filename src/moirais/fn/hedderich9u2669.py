...
__all__ = ["hedderich_chapter_9_unnumbered_2669"]


def hedderich_chapter_9_unnumbered_2669(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: upper triangle: α = 0.01; upper number: Power = 0.9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2669')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2669: PowerAndDesign expression (auto-extracted; see ref)."
