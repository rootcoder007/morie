# describe('mlpv') — multilevel_pseudo_variance_ratio
...
`print(result)` render. See `moirais.fn.describe('mlpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlpv import *
import numpy as np
# See the function signature in fn/mlpv.py for argument names.
```
