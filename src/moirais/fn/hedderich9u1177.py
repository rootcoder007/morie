...
__all__ = ["hedderich_chapter_9_unnumbered_1177"]


def hedderich_chapter_9_unnumbered_1177(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.7−0.6−0.0045 = 0.0955 ; 95%-CI: 0.008 ⪅π1−π2 ⪅ 0.183 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1177')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1177: GeneralStatistics expression (auto-extracted; see ref)."
