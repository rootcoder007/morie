...
__all__ = ["hedderich_chapter_9_unnumbered_106"]


def hedderich_chapter_9_unnumbered_106(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y =a +b1x +b2x2 +...+bnxn (2.55)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u106')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u106: GeneralStatistics expression (auto-extracted; see ref)."
