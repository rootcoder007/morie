...
`print(result)` render. See `moirais.fn.describe('trgra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trgra import *
import numpy as np
# See the function signature in fn/trgra.py for argument names.
```
