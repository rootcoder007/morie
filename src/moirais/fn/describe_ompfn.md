...
`print(result)` render. See `moirais.fn.describe('ompfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ompfn import *
import numpy as np
# See the function signature in fn/ompfn.py for argument names.
```
