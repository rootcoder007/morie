...
`print(result)` render. See `moirais.fn.describe('rsreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsreg import *
import numpy as np
# See the function signature in fn/rsreg.py for argument names.
```
