# describe('atmfl') — alpha_trimmed_mean_filter
...
`print(result)` render. See `moirais.fn.describe('atmfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atmfl import *
import numpy as np
# See the function signature in fn/atmfl.py for argument names.
```
