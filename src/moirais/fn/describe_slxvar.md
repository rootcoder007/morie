...
`print(result)` render. See `moirais.fn.describe('slxvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxvar import *
import numpy as np
# See the function signature in fn/slxvar.py for argument names.
```
