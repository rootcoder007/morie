# describe('fzc2x') — fauzi_c2_coefficient
...
`print(result)` render. See `moirais.fn.describe('fzc2x')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzc2x import *
import numpy as np
# See the function signature in fn/fzc2x.py for argument names.
```
