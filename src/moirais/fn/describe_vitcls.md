...
`print(result)` render. See `moirais.fn.describe('vitcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitcls import *
import numpy as np
# See the function signature in fn/vitcls.py for argument names.
```
