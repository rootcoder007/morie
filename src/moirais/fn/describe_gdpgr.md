...
`print(result)` render. See `moirais.fn.describe('gdpgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdpgr import *
import numpy as np
# See the function signature in fn/gdpgr.py for argument names.
```
