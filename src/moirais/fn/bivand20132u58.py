...
__all__ = ["bivand2013_chapter_2_unnumbered_58"]


def bivand2013_chapter_2_unnumbered_58(x):
    """
    Spatial expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u58')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u58: Spatial expression (auto-extracted; see ref)."
