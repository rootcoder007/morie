# describe('bfreg') — biweight_regression
...
`print(result)` render. See `moirais.fn.describe('bfreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfreg import *
import numpy as np
# See the function signature in fn/bfreg.py for argument names.
```
