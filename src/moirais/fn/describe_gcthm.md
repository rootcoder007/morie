...
`print(result)` render. See `moirais.fn.describe('gcthm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcthm import *
import numpy as np
# See the function signature in fn/gcthm.py for argument names.
```
