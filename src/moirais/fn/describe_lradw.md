...
`print(result)` render. See `moirais.fn.describe('lradw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lradw import *
import numpy as np
# See the function signature in fn/lradw.py for argument names.
```
