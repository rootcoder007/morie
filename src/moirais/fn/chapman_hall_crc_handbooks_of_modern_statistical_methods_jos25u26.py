...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_26"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_26(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0 < Pr ( Z = 1 | x, u, rT , rC) = Pr ( Z = 1 | x, u) < 1 (2.9)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u26')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u26: GeneralStatistics expression (auto-extracted; see ref)."
