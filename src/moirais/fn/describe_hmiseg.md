# describe('hmiseg') — geron_image_segmentation
...
`print(result)` render. See `moirais.fn.describe('hmiseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmiseg import *
import numpy as np
# See the function signature in fn/hmiseg.py for argument names.
```
