...
`print(result)` render. See `moirais.fn.describe('hytrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hytrb import *
import numpy as np
# See the function signature in fn/hytrb.py for argument names.
```
