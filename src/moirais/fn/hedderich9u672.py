...
__all__ = ["hedderich_chapter_9_unnumbered_672"]


def hedderich_chapter_9_unnumbered_672(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + byrow=FALSE , nrow = 3 ) ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u672')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u672: GeneralStatistics expression (auto-extracted; see ref)."
