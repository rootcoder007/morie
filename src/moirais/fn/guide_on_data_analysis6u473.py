...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_473"]


def guide_on_data_analysis_chapter_6_unnumbered_473(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑚𝑗(𝛿) = 𝑄(̂𝜃(𝑗)) + ∇𝑄(̂𝜃(𝑗))′𝛿 + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u473')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u473: GeneralStatistics expression (auto-extracted; see ref)."
