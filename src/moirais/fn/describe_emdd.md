# describe('emdd') — earth_mover_dist
...
`print(result)` render. See `moirais.fn.describe('emdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdd import *
import numpy as np
# See the function signature in fn/emdd.py for argument names.
```
