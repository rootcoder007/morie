...
__all__ = ["wilcox_chapter_10_unnumbered_1035"]


def wilcox_chapter_10_unnumbered_1035(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: bbwmcp(J, K, L, x, tr = 0.2, JKL = J * K * L, con = 0, alpha = 0.05, grp =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1035')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1035: Resampling expression (auto-extracted; see ref)."
