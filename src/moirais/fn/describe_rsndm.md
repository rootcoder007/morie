...
`print(result)` render. See `moirais.fn.describe('rsndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsndm import *
import numpy as np
# See the function signature in fn/rsndm.py for argument names.
```
