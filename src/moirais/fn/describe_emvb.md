# describe('emvb') — em_variational_bayes
...
`print(result)` render. See `moirais.fn.describe('emvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emvb import *
import numpy as np
# See the function signature in fn/emvb.py for argument names.
```
