# describe('dbscl') — dbscan_clustering
...
`print(result)` render. See `moirais.fn.describe('dbscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbscl import *
import numpy as np
# See the function signature in fn/dbscl.py for argument names.
```
