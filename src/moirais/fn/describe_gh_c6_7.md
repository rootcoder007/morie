# describe('gh_c6_7') — ghosal_kl_diverge
...
`print(result)` render. See `moirais.fn.describe('gh_c6_7')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c6_7 import *
import numpy as np
# See the function signature in fn/gh_c6_7.py for argument names.
```
