# describe('clipxi') — clip_image_encoder
...
`print(result)` render. See `moirais.fn.describe('clipxi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clipxi import *
import numpy as np
# See the function signature in fn/clipxi.py for argument names.
```
