# describe('bpost') — conjugate_posterior
...
`print(result)` render. See `moirais.fn.describe('bpost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpost import *
import numpy as np
# See the function signature in fn/bpost.py for argument names.
```
