# describe('sgcsm') — conditional_simulation
...
`print(result)` render. See `moirais.fn.describe('sgcsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcsm import *
import numpy as np
# See the function signature in fn/sgcsm.py for argument names.
```
