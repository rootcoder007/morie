# describe('rfgen') — random_forest_genomic
...
`print(result)` render. See `moirais.fn.describe('rfgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfgen import *
import numpy as np
# See the function signature in fn/rfgen.py for argument names.
```
