...
`print(result)` render. See `moirais.fn.describe('mpmnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpmnt import *
import numpy as np
# See the function signature in fn/mpmnt.py for argument names.
```
