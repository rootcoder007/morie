...
__all__ = ["wilcox_chapter_5_unnumbered_411"]


def wilcox_chapter_5_unnumbered_411(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where again t is the 1 − α/2 quantile of Student’s t distribution with ν = n − 2 degrees of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u411')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u411: GeneralStatistics expression (auto-extracted; see ref)."
