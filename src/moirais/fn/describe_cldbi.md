# describe('cldbi') — cldbi

## WHAT IT DOES

Davies-Bouldin spatial
...
`print(result)` render. See `moirais.fn.describe('cldbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cldbi import *
import numpy as np
# See the function signature in fn/cldbi.py for argument names.
```
