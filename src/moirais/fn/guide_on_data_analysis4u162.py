...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_162"]


def guide_on_data_analysis_chapter_4_unnumbered_162(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜋(𝜇) = Φ (−𝑧𝛼/2+ (𝜇 − 𝜇0)√𝑛
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u162')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u162: GeneralStatistics expression (auto-extracted; see ref)."
