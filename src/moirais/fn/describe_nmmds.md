...
`print(result)` render. See `moirais.fn.describe('nmmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmmds import *
import numpy as np
# See the function signature in fn/nmmds.py for argument names.
```
