# describe('gaussm') — gaussian_mechanism
...
`print(result)` render. See `moirais.fn.describe('gaussm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaussm import *
import numpy as np
# See the function signature in fn/gaussm.py for argument names.
```
