...
`print(result)` render. See `moirais.fn.describe('pburg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pburg import *
import numpy as np
# See the function signature in fn/pburg.py for argument names.
```
