# describe('ksr19') — kosorok_cox_partial_likelihood
...
`print(result)` render. See `moirais.fn.describe('ksr19')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr19 import *
import numpy as np
# See the function signature in fn/ksr19.py for argument names.
```
