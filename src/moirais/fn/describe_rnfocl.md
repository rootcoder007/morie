...
`print(result)` render. See `moirais.fn.describe('rnfocl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnfocl import *
import numpy as np
# See the function signature in fn/rnfocl.py for argument names.
```
