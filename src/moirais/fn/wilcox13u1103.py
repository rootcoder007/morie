...
__all__ = ["wilcox_chapter_13_unnumbered_1103"]


def wilcox_chapter_13_unnumbered_1103(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: regtestMC(x, y, regfun = tsreg, nboot = 600, alpha = 0.05, plotit = TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1103')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1103: GeneralStatistics expression (auto-extracted; see ref)."
