# describe('corrd') — correlation_dist
...
`print(result)` render. See `moirais.fn.describe('corrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.corrd import *
import numpy as np
# See the function signature in fn/corrd.py for argument names.
```
