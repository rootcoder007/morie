...
`print(result)` render. See `moirais.fn.describe('macur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.macur import *
import numpy as np
# See the function signature in fn/macur.py for argument names.
```
