...
__all__ = ["hedderich_chapter_9_unnumbered_3652"]


def hedderich_chapter_9_unnumbered_3652(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + v . names =" value " , direction =" long " ) # longformat
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3652')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3652: GeneralStatistics expression (auto-extracted; see ref)."
