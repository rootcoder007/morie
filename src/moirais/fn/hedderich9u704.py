...
__all__ = ["hedderich_chapter_9_unnumbered_704"]


def hedderich_chapter_9_unnumbered_704(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] and: P (X≥x) = 1−P (Xx̄−1).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u704')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u704: CountModels expression (auto-extracted; see ref)."
