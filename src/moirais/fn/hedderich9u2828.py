...
__all__ = ["hedderich_chapter_9_unnumbered_2828"]


def hedderich_chapter_9_unnumbered_2828(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : ωi = 1 against HA : ωi =ωM H̸= 1 for alli = 1,...,k .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2828')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2828: GeneralStatistics expression (auto-extracted; see ref)."
