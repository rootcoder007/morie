# describe('msm123') — mvsml_categorical_count_eq_8_1
...
`print(result)` render. See `moirais.fn.describe('msm123')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm123 import *
import numpy as np
# See the function signature in fn/msm123.py for argument names.
```
