# describe('zscnm') — zscore_normalization
...
`print(result)` render. See `moirais.fn.describe('zscnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscnm import *
import numpy as np
# See the function signature in fn/zscnm.py for argument names.
```
