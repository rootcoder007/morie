...
__all__ = ["hedderich_chapter_9_unnumbered_2620"]


def hedderich_chapter_9_unnumbered_2620(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = n(ad−bc)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2620')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2620: GeneralStatistics expression (auto-extracted; see ref)."
