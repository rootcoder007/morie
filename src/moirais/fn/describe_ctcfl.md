# describe('ctcfl') — counterfactual_notation
...
`print(result)` render. See `moirais.fn.describe('ctcfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctcfl import *
import numpy as np
# See the function signature in fn/ctcfl.py for argument names.
```
