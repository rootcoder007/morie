...
__all__ = ["hedderich_chapter_9_unnumbered_874"]


def hedderich_chapter_9_unnumbered_874(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u874')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u874: GeneralStatistics expression (auto-extracted; see ref)."
