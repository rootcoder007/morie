...
`print(result)` render. See `moirais.fn.describe('hrvnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvnl import *
import numpy as np
# See the function signature in fn/hrvnl.py for argument names.
```
