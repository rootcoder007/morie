...
__all__ = ["wilcox_chapter_13_unnumbered_1312"]


def wilcox_chapter_13_unnumbered_1312(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Y = 1 (High) π (1) π (0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1312')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1312: GeneralStatistics expression (auto-extracted; see ref)."
