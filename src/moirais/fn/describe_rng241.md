# describe('rng241') — rangayyan_ch4_log_power_series
...
`print(result)` render. See `moirais.fn.describe('rng241')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng241 import *
import numpy as np
# See the function signature in fn/rng241.py for argument names.
```
