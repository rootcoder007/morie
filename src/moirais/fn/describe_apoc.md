# describe('apoc') — articulation_points
...
`print(result)` render. See `moirais.fn.describe('apoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apoc import *
import numpy as np
# See the function signature in fn/apoc.py for argument names.
```
