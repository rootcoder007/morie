# describe('hrzkd2') — horowitz_multivariate_kde
...
`print(result)` render. See `moirais.fn.describe('hrzkd2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzkd2 import *
import numpy as np
# See the function signature in fn/hrzkd2.py for argument names.
```
