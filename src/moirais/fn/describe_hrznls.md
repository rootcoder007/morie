# describe('hrznls') — horowitz_nls_sim
...
`print(result)` render. See `moirais.fn.describe('hrznls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznls import *
import numpy as np
# See the function signature in fn/hrznls.py for argument names.
```
