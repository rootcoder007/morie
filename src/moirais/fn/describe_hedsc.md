...
`print(result)` render. See `moirais.fn.describe('hedsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hedsc import *
import numpy as np
# See the function signature in fn/hedsc.py for argument names.
```
