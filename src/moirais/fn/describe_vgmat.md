...
`print(result)` render. See `moirais.fn.describe('vgmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgmat import *
import numpy as np
# See the function signature in fn/vgmat.py for argument names.
```
