# describe('gb_cvo') — gibbons_order_covariance
...
`print(result)` render. See `moirais.fn.describe('gb_cvo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_cvo import *
import numpy as np
# See the function signature in fn/gb_cvo.py for argument names.
```
