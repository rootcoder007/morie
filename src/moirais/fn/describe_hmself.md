# describe('hmself') — geron_self_supervised
...
`print(result)` render. See `moirais.fn.describe('hmself')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmself import *
import numpy as np
# See the function signature in fn/hmself.py for argument names.
```
