...
`print(result)` render. See `moirais.fn.describe('gegry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gegry import *
import numpy as np
# See the function signature in fn/gegry.py for argument names.
```
