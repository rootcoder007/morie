# describe('msm084') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm084')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm084 import *
import numpy as np
# See the function signature in fn/msm084.py for argument names.
```
