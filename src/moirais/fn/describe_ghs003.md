# describe('ghs003') — ghosal_ch2_basis_truncation_error
...
`print(result)` render. See `moirais.fn.describe('ghs003')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs003 import *
import numpy as np
# See the function signature in fn/ghs003.py for argument names.
```
