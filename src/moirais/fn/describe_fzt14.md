# describe('fzt14') — fauzi_thm1_4_asympnorm_mgkde
...
`print(result)` render. See `moirais.fn.describe('fzt14')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt14 import *
import numpy as np
# See the function signature in fn/fzt14.py for argument names.
```
