# describe('optnm') — nelder_mead_mds
...
`print(result)` render. See `moirais.fn.describe('optnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optnm import *
import numpy as np
# See the function signature in fn/optnm.py for argument names.
```
