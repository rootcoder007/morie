# describe('hrztmod') — horowitz_transformation_model
...
`print(result)` render. See `moirais.fn.describe('hrztmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztmod import *
import numpy as np
# See the function signature in fn/hrztmod.py for argument names.
```
