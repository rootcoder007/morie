...
`print(result)` render. See `moirais.fn.describe('gethl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gethl import *
import numpy as np
# See the function signature in fn/gethl.py for argument names.
```
