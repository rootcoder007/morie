# describe('rng008') — rangayyan_ch3_sample_mean_squared
...
`print(result)` render. See `moirais.fn.describe('rng008')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng008 import *
import numpy as np
# See the function signature in fn/rng008.py for argument names.
```
