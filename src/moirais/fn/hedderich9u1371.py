...
__all__ = ["hedderich_chapter_9_unnumbered_1371"]


def hedderich_chapter_9_unnumbered_1371(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 95%-CI: 0.065≤σ≤0.172.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1371')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1371: GeneralStatistics expression (auto-extracted; see ref)."
