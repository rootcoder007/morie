...
`print(result)` render. See `moirais.fn.describe('jacbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jacbi import *
import numpy as np
# See the function signature in fn/jacbi.py for argument names.
```
