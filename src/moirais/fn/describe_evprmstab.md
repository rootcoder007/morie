# describe('evprmstab') — evt_param_stability
...
`print(result)` render. See `moirais.fn.describe('evprmstab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evprmstab import *
import numpy as np
# See the function signature in fn/evprmstab.py for argument names.
```
