# describe('netbt') — network_betweenness
...
`print(result)` render. See `moirais.fn.describe('netbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netbt import *
import numpy as np
# See the function signature in fn/netbt.py for argument names.
```
