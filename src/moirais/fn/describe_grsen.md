# describe('grsen') — geron_senet_squeeze_excite
...
`print(result)` render. See `moirais.fn.describe('grsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsen import *
import numpy as np
# See the function signature in fn/grsen.py for argument names.
```
