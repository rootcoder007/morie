# describe('aryw') — ar_yule_walker_fn
...
`print(result)` render. See `moirais.fn.describe('aryw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aryw import *
import numpy as np
# See the function signature in fn/aryw.py for argument names.
```
