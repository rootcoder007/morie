# describe('spcnds') — schabenberger_conditional_sim
...
`print(result)` render. See `moirais.fn.describe('spcnds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcnds import *
import numpy as np
# See the function signature in fn/spcnds.py for argument names.
```
