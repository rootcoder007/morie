# describe('ssin') — sample_size_noninferiority
...
`print(result)` render. See `moirais.fn.describe('ssin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssin import *
import numpy as np
# See the function signature in fn/ssin.py for argument names.
```
