# describe('dirml') — directional_model
...
`print(result)` render. See `moirais.fn.describe('dirml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dirml import *
import numpy as np
# See the function signature in fn/dirml.py for argument names.
```
