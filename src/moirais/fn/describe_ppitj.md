...
`print(result)` render. See `moirais.fn.describe('ppitj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppitj import *
import numpy as np
# See the function signature in fn/ppitj.py for argument names.
```
