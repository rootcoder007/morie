...
`print(result)` render. See `moirais.fn.describe('dpkb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpkb import *
import numpy as np
# See the function signature in fn/dpkb.py for argument names.
```
