...
`print(result)` render. See `moirais.fn.describe('rndist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndist import *
import numpy as np
# See the function signature in fn/rndist.py for argument names.
```
