...
__all__ = ["hedderich_chapter_9_unnumbered_1052"]


def hedderich_chapter_9_unnumbered_1052(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (x,y ) = xye−(x+y) =xe−x·ye−y =f1(x)·f2(y)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1052')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1052: GeneralStatistics expression (auto-extracted; see ref)."
