...
__all__ = ["hedderich_chapter_9_unnumbered_1980"]


def hedderich_chapter_9_unnumbered_1980(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = [2·134−210−1]/26.4575 = 2.154 or
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1980')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1980: GeneralStatistics expression (auto-extracted; see ref)."
