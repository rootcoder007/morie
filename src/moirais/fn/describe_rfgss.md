...
`print(result)` render. See `moirais.fn.describe('rfgss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfgss import *
import numpy as np
# See the function signature in fn/rfgss.py for argument names.
```
