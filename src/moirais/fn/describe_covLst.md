# describe('covLst') — catalog_coverage
...
`print(result)` render. See `moirais.fn.describe('covLst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covLst import *
import numpy as np
# See the function signature in fn/covLst.py for argument names.
```
