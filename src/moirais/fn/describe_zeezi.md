...
`print(result)` render. See `moirais.fn.describe('zeezi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeezi import *
import numpy as np
# See the function signature in fn/zeezi.py for argument names.
```
