...
`print(result)` render. See `moirais.fn.describe('sacconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacconv import *
import numpy as np
# See the function signature in fn/sacconv.py for argument names.
```
