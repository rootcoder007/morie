...
`print(result)` render. See `moirais.fn.describe('npsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npsd import *
import numpy as np
# See the function signature in fn/npsd.py for argument names.
```
