...
`print(result)` render. See `moirais.fn.describe('rcltz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcltz import *
import numpy as np
# See the function signature in fn/rcltz.py for argument names.
```
