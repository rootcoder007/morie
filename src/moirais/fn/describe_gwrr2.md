...
`print(result)` render. See `moirais.fn.describe('gwrr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrr2 import *
import numpy as np
# See the function signature in fn/gwrr2.py for argument names.
```
