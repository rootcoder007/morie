# describe('tritta') — alphafold_triangle_attn
...
`print(result)` render. See `moirais.fn.describe('tritta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tritta import *
import numpy as np
# See the function signature in fn/tritta.py for argument names.
```
