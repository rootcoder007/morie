...
`print(result)` render. See `moirais.fn.describe('agagg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agagg import *
import numpy as np
# See the function signature in fn/agagg.py for argument names.
```
