# describe('gb5412') — gibbons_sign_normal_approx
...
`print(result)` render. See `moirais.fn.describe('gb5412')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5412 import *
import numpy as np
# See the function signature in fn/gb5412.py for argument names.
```
