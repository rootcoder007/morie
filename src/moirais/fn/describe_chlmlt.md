...
`print(result)` render. See `moirais.fn.describe('chlmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlmlt import *
import numpy as np
# See the function signature in fn/chlmlt.py for argument names.
```
