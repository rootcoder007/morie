...
`print(result)` render. See `moirais.fn.describe('kbwrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbwrt import *
import numpy as np
# See the function signature in fn/kbwrt.py for argument names.
```
