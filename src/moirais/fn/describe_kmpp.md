...
`print(result)` render. See `moirais.fn.describe('kmpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpp import *
import numpy as np
# See the function signature in fn/kmpp.py for argument names.
```
