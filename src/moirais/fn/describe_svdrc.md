...
`print(result)` render. See `moirais.fn.describe('svdrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdrc import *
import numpy as np
# See the function signature in fn/svdrc.py for argument names.
```
