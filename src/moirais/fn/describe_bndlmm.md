# describe('bndlmm') — bound_linear_min_max
...
`print(result)` render. See `moirais.fn.describe('bndlmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndlmm import *
import numpy as np
# See the function signature in fn/bndlmm.py for argument names.
```
