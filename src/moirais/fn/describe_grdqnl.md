# describe('grdqnl') — geron_dqn_loss
...
`print(result)` render. See `moirais.fn.describe('grdqnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdqnl import *
import numpy as np
# See the function signature in fn/grdqnl.py for argument names.
```
