...
__all__ = ["hedderich_chapter_9_unnumbered_1649"]


def hedderich_chapter_9_unnumbered_1649(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] OC (ϑ) = P (T∈Kα|ϑ) = 1−G(ϑ) (7.13)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1649')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1649: PowerAndDesign expression (auto-extracted; see ref)."
