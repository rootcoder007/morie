# describe('gcvgn') — genomic_cross_validation
...
`print(result)` render. See `moirais.fn.describe('gcvgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcvgn import *
import numpy as np
# See the function signature in fn/gcvgn.py for argument names.
```
