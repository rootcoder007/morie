...
__all__ = ["hedderich_chapter_9_unnumbered_30"]


def hedderich_chapter_9_unnumbered_30(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u30')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u30: GeneralStatistics expression (auto-extracted; see ref)."
