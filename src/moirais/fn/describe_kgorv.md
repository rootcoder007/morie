...
`print(result)` render. See `moirais.fn.describe('kgorv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgorv import *
import numpy as np
# See the function signature in fn/kgorv.py for argument names.
```
