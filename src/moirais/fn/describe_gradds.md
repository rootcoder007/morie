# describe('gradds') — gradient_descent
...
`print(result)` render. See `moirais.fn.describe('gradds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gradds import *
import numpy as np
# See the function signature in fn/gradds.py for argument names.
```
