# describe('hddif') — hadamard_differentiability
...
`print(result)` render. See `moirais.fn.describe('hddif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hddif import *
import numpy as np
# See the function signature in fn/hddif.py for argument names.
```
