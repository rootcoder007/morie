...
`print(result)` render. See `moirais.fn.describe('wlamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlamp import *
import numpy as np
# See the function signature in fn/wlamp.py for argument names.
```
