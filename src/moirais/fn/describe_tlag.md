# describe('tlag') — time_lag_analysis
...
`print(result)` render. See `moirais.fn.describe('tlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tlag import *
import numpy as np
# See the function signature in fn/tlag.py for argument names.
```
