# describe('gb571') — gibbons_wilcoxon_signed_rank
...
`print(result)` render. See `moirais.fn.describe('gb571')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb571 import *
import numpy as np
# See the function signature in fn/gb571.py for argument names.
```
