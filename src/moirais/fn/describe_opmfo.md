...
`print(result)` render. See `moirais.fn.describe('opmfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opmfo import *
import numpy as np
# See the function signature in fn/opmfo.py for argument names.
```
