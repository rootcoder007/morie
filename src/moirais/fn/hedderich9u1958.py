...
__all__ = ["hedderich_chapter_9_unnumbered_1958"]


def hedderich_chapter_9_unnumbered_1958(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = |(s1/¯x1)−(s2/¯x2)|√( 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1958')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1958: GeneralStatistics expression (auto-extracted; see ref)."
