...
__all__ = ["hedderich_chapter_9_unnumbered_2722"]


def hedderich_chapter_9_unnumbered_2722(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: withpc = π(rψ+ 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2722')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2722: GeneralStatistics expression (auto-extracted; see ref)."
