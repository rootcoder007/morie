...
`print(result)` render. See `moirais.fn.describe('thopf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thopf import *
import numpy as np
# See the function signature in fn/thopf.py for argument names.
```
