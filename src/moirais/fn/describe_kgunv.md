...
`print(result)` render. See `moirais.fn.describe('kgunv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgunv import *
import numpy as np
# See the function signature in fn/kgunv.py for argument names.
```
