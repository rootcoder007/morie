...
__all__ = ["hedderich_chapter_9_unnumbered_3601"]


def hedderich_chapter_9_unnumbered_3601(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] f (w) = exp(w−exp(w)) with σ= 1/p
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3601')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3601: Logistic expression (auto-extracted; see ref)."
