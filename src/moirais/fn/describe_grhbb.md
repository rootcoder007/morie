# describe('grhbb') — geron_hebb_rule
...
`print(result)` render. See `moirais.fn.describe('grhbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grhbb import *
import numpy as np
# See the function signature in fn/grhbb.py for argument names.
```
