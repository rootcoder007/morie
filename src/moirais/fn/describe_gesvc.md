...
`print(result)` render. See `moirais.fn.describe('gesvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gesvc import *
import numpy as np
# See the function signature in fn/gesvc.py for argument names.
```
