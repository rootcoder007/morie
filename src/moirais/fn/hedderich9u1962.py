...
__all__ = ["hedderich_chapter_9_unnumbered_1962"]


def hedderich_chapter_9_unnumbered_1962(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 10−12−2 = 0.2275
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1962')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1962: GeneralStatistics expression (auto-extracted; see ref)."
