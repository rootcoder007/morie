...
__all__ = ["hedderich_chapter_9_unnumbered_2941"]


def hedderich_chapter_9_unnumbered_2941(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pv1 <− dbinom ( 1 : k , k , prob = theta )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2941')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2941: GeneralStatistics expression (auto-extracted; see ref)."
