...
`print(result)` render. See `moirais.fn.describe('mhlds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhlds import *
import numpy as np
# See the function signature in fn/mhlds.py for argument names.
```
