# describe('hmstrn') — history_adjusted_msm
...
`print(result)` render. See `moirais.fn.describe('hmstrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmstrn import *
import numpy as np
# See the function signature in fn/hmstrn.py for argument names.
```
