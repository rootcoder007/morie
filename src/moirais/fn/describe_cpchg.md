# describe('cpchg') — changepoint_pelt
...
`print(result)` render. See `moirais.fn.describe('cpchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpchg import *
import numpy as np
# See the function signature in fn/cpchg.py for argument names.
```
