...
`print(result)` render. See `moirais.fn.describe('tssfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssfe import *
import numpy as np
# See the function signature in fn/tssfe.py for argument names.
```
