# describe('scpct') — percentile_norms
...
`print(result)` render. See `moirais.fn.describe('scpct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpct import *
import numpy as np
# See the function signature in fn/scpct.py for argument names.
```
