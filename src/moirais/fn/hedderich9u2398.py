...
__all__ = ["hedderich_chapter_9_unnumbered_2398"]


def hedderich_chapter_9_unnumbered_2398(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 3 = 3.95. As an example, the test ofH0 :µ1 =µ2 againstHA :µ1 >µ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2398')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2398: GeneralStatistics expression (auto-extracted; see ref)."
