# describe('ltsreg') — least_trimmed_squares
...
`print(result)` render. See `moirais.fn.describe('ltsreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltsreg import *
import numpy as np
# See the function signature in fn/ltsreg.py for argument names.
```
