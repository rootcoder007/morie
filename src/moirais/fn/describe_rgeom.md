...
`print(result)` render. See `moirais.fn.describe('rgeom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeom import *
import numpy as np
# See the function signature in fn/rgeom.py for argument names.
```
