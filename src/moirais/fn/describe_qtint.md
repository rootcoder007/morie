...
`print(result)` render. See `moirais.fn.describe('qtint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qtint import *
import numpy as np
# See the function signature in fn/qtint.py for argument names.
```
