...
`print(result)` render. See `moirais.fn.describe('swlag2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swlag2 import *
import numpy as np
# See the function signature in fn/swlag2.py for argument names.
```
