...
`print(result)` render. See `moirais.fn.describe('mvtbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtbi import *
import numpy as np
# See the function signature in fn/mvtbi.py for argument names.
```
