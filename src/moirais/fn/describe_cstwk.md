# describe('cstwk') — custody_work_program
...
`print(result)` render. See `moirais.fn.describe('cstwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstwk import *
import numpy as np
# See the function signature in fn/cstwk.py for argument names.
```
