# describe('ngomtx') — next_generation_matrix
...
`print(result)` render. See `moirais.fn.describe('ngomtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ngomtx import *
import numpy as np
# See the function signature in fn/ngomtx.py for argument names.
```
