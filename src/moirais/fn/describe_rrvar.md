...
`print(result)` render. See `moirais.fn.describe('rrvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rrvar import *
import numpy as np
# See the function signature in fn/rrvar.py for argument names.
```
