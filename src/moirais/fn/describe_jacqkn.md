# describe('jacqkn') — jacquez_k_nn_test
...
`print(result)` render. See `moirais.fn.describe('jacqkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jacqkn import *
import numpy as np
# See the function signature in fn/jacqkn.py for argument names.
```
