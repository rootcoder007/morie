...
__all__ = ["wilcox_chapter_13_unnumbered_1266"]


def wilcox_chapter_13_unnumbered_1266(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SCAT=TRUE,xlab="X",ylab="Y",pch1="*",pch2="+",...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1266')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1266: GeneralStatistics expression (auto-extracted; see ref)."
