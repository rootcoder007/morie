...
`print(result)` render. See `moirais.fn.describe('seebl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seebl import *
import numpy as np
# See the function signature in fn/seebl.py for argument names.
```
