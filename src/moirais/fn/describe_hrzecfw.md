# describe('hrzecfw') — horowitz_empirical_cf
...
`print(result)` render. See `moirais.fn.describe('hrzecfw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzecfw import *
import numpy as np
# See the function signature in fn/hrzecfw.py for argument names.
```
