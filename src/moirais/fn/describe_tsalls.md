# describe('tsalls') — tsallis_entropy
...
`print(result)` render. See `moirais.fn.describe('tsalls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsalls import *
import numpy as np
# See the function signature in fn/tsalls.py for argument names.
```
