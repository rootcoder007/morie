# describe('qrntcq') — quarantine_efficacy
...
`print(result)` render. See `moirais.fn.describe('qrntcq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrntcq import *
import numpy as np
# See the function signature in fn/qrntcq.py for argument names.
```
