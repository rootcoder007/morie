...
`print(result)` render. See `moirais.fn.describe('csars')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csars import *
import numpy as np
# See the function signature in fn/csars.py for argument names.
```
