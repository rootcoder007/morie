...
`print(result)` render. See `moirais.fn.describe('vmcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcrs import *
import numpy as np
# See the function signature in fn/vmcrs.py for argument names.
```
