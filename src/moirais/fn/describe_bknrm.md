# describe('bknrm') — burkov_vector_norm
...
`print(result)` render. See `moirais.fn.describe('bknrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bknrm import *
import numpy as np
# See the function signature in fn/bknrm.py for argument names.
```
