...
`print(result)` render. See `moirais.fn.describe('mvtwe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtwe import *
import numpy as np
# See the function signature in fn/mvtwe.py for argument names.
```
