# describe('aitcrg') — compositional_regression
...
`print(result)` render. See `moirais.fn.describe('aitcrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitcrg import *
import numpy as np
# See the function signature in fn/aitcrg.py for argument names.
```
