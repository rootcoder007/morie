...
`print(result)` render. See `moirais.fn.describe('mcvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcvar import *
import numpy as np
# See the function signature in fn/mcvar.py for argument names.
```
