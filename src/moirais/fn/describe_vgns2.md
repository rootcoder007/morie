# describe('vgns2') — vario_nested_fit
...
`print(result)` render. See `moirais.fn.describe('vgns2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgns2 import *
import numpy as np
# See the function signature in fn/vgns2.py for argument names.
```
