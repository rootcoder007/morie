...
`print(result)` render. See `moirais.fn.describe('srs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srs import *
import numpy as np
# See the function signature in fn/srs.py for argument names.
```
