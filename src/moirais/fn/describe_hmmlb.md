# describe('hmmlb') — geron_multilabel
...
`print(result)` render. See `moirais.fn.describe('hmmlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmlb import *
import numpy as np
# See the function signature in fn/hmmlb.py for argument names.
```
