...
`print(result)` render. See `moirais.fn.describe('gdtrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdtrb import *
import numpy as np
# See the function signature in fn/gdtrb.py for argument names.
```
