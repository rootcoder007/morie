# describe('hkgrl') — hawking_temperature
...
`print(result)` render. See `moirais.fn.describe('hkgrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hkgrl import *
import numpy as np
# See the function signature in fn/hkgrl.py for argument names.
```
