...
`print(result)` render. See `moirais.fn.describe('endrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.endrt import *
import numpy as np
# See the function signature in fn/endrt.py for argument names.
```
