# describe('farr') — farrington_detect
...
`print(result)` render. See `moirais.fn.describe('farr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.farr import *
import numpy as np
# See the function signature in fn/farr.py for argument names.
```
