# describe('msm317') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm317')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm317 import *
import numpy as np
# See the function signature in fn/msm317.py for argument names.
```
