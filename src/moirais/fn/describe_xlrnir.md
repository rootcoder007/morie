...
`print(result)` render. See `moirais.fn.describe('xlrnir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xlrnir import *
import numpy as np
# See the function signature in fn/xlrnir.py for argument names.
```
