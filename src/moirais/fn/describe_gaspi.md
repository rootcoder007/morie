...
`print(result)` render. See `moirais.fn.describe('gaspi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaspi import *
import numpy as np
# See the function signature in fn/gaspi.py for argument names.
```
