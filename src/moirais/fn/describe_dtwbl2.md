...
`print(result)` render. See `moirais.fn.describe('dtwbl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtwbl2 import *
import numpy as np
# See the function signature in fn/dtwbl2.py for argument names.
```
