# describe('sbreli') — spearman_brown
...
`print(result)` render. See `moirais.fn.describe('sbreli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbreli import *
import numpy as np
# See the function signature in fn/sbreli.py for argument names.
```
