...
`print(result)` render. See `moirais.fn.describe('mxent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxent import *
import numpy as np
# See the function signature in fn/mxent.py for argument names.
```
