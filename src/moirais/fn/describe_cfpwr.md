...
`print(result)` render. See `moirais.fn.describe('cfpwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfpwr import *
import numpy as np
# See the function signature in fn/cfpwr.py for argument names.
```
