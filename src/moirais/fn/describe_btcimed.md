# describe('btcimed') — boot_ci_median
...
`print(result)` render. See `moirais.fn.describe('btcimed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btcimed import *
import numpy as np
# See the function signature in fn/btcimed.py for argument names.
```
