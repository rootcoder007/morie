...
__all__ = ["hedderich_chapter_9_unnumbered_1922"]


def hedderich_chapter_9_unnumbered_1922(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: Z = n−u·d0√u·n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1922')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1922: CountModels expression (auto-extracted; see ref)."
