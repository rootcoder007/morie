# describe('zscnd') — conditional_sim
...
`print(result)` render. See `moirais.fn.describe('zscnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscnd import *
import numpy as np
# See the function signature in fn/zscnd.py for argument names.
```
