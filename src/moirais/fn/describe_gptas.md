# describe('gptas') — gpt_assistant_decode
...
`print(result)` render. See `moirais.fn.describe('gptas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gptas import *
import numpy as np
# See the function signature in fn/gptas.py for argument names.
```
