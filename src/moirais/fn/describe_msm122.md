# describe('msm122') — mvsml_bayesian_regression_pt2_eq_7_11
...
`print(result)` render. See `moirais.fn.describe('msm122')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm122 import *
import numpy as np
# See the function signature in fn/msm122.py for argument names.
```
