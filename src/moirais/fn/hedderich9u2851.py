...
__all__ = ["hedderich_chapter_9_unnumbered_2851"]


def hedderich_chapter_9_unnumbered_2851(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( healing =c ( " healed −x " , " healed −x+y " , " died " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2851')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2851: GeneralStatistics expression (auto-extracted; see ref)."
