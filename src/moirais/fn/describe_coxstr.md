# describe('coxstr') — cox_stratified
...
`print(result)` render. See `moirais.fn.describe('coxstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxstr import *
import numpy as np
# See the function signature in fn/coxstr.py for argument names.
```
