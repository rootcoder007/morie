...
`print(result)` render. See `moirais.fn.describe('mdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdist import *
import numpy as np
# See the function signature in fn/mdist.py for argument names.
```
