# describe('sgsph') — spherical_variogram
...
`print(result)` render. See `moirais.fn.describe('sgsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsph import *
import numpy as np
# See the function signature in fn/sgsph.py for argument names.
```
