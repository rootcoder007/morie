# describe('huber') — huber

## WHAT IT DOES

rHuber loss (robust regression).
...
`print(result)` render. See `moirais.fn.describe('huber')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.huber import *
import numpy as np
# See the function signature in fn/huber.py for argument names.
```
