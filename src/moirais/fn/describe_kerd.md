# describe('kerd') — kernel_density_fda
...
`print(result)` render. See `moirais.fn.describe('kerd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kerd import *
import numpy as np
# See the function signature in fn/kerd.py for argument names.
```
