...
__all__ = ["wilcox_chapter_14_unnumbered_634"]


def wilcox_chapter_14_unnumbered_634(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: rmmest(x, y = NA, alpha = 0.05, con = 0, est = onestep, plotit = TRUE, dif =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u634')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u634: Resampling expression (auto-extracted; see ref)."
