# describe('fzt12') — fauzi_thm1_2_var_mgkde
...
`print(result)` render. See `moirais.fn.describe('fzt12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt12 import *
import numpy as np
# See the function signature in fn/fzt12.py for argument names.
```
