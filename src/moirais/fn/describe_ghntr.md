# describe('ghntr') — ghosal_neutral_right
...
`print(result)` render. See `moirais.fn.describe('ghntr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghntr import *
import numpy as np
# See the function signature in fn/ghntr.py for argument names.
```
