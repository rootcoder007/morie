# describe('msm059') — mvsml_bayesian_regression_eq_6_1
...
`print(result)` render. See `moirais.fn.describe('msm059')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm059 import *
import numpy as np
# See the function signature in fn/msm059.py for argument names.
```
