# describe('irfun') — impulse_response
...
`print(result)` render. See `moirais.fn.describe('irfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irfun import *
import numpy as np
# See the function signature in fn/irfun.py for argument names.
```
