...
`print(result)` render. See `moirais.fn.describe('secarg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secarg import *
import numpy as np
# See the function signature in fn/secarg.py for argument names.
```
