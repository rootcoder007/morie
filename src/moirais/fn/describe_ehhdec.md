...
`print(result)` render. See `moirais.fn.describe('ehhdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ehhdec import *
import numpy as np
# See the function signature in fn/ehhdec.py for argument names.
```
