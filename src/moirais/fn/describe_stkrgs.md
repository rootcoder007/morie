...
`print(result)` render. See `moirais.fn.describe('stkrgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkrgs import *
import numpy as np
# See the function signature in fn/stkrgs.py for argument names.
```
