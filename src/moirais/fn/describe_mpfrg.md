...
`print(result)` render. See `moirais.fn.describe('mpfrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpfrg import *
import numpy as np
# See the function signature in fn/mpfrg.py for argument names.
```
