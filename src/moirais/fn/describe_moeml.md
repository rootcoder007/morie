# describe('moeml') — mixture_of_experts
...
`print(result)` render. See `moirais.fn.describe('moeml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moeml import *
import numpy as np
# See the function signature in fn/moeml.py for argument names.
```
