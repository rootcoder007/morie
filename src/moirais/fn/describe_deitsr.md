...
`print(result)` render. See `moirais.fn.describe('deitsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deitsr import *
import numpy as np
# See the function signature in fn/deitsr.py for argument names.
```
