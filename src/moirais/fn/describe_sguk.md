# describe('sguk') — universal_kriging
...
`print(result)` render. See `moirais.fn.describe('sguk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sguk import *
import numpy as np
# See the function signature in fn/sguk.py for argument names.
```
