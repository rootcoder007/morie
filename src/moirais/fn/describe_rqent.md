# describe('rqent') — recurrence_entropy
...
`print(result)` render. See `moirais.fn.describe('rqent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rqent import *
import numpy as np
# See the function signature in fn/rqent.py for argument names.
```
