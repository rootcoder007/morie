...
__all__ = ["guide_on_data_analysis_chapter_13_unnumbered_866"]


def guide_on_data_analysis_chapter_13_unnumbered_866(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: gg_miss_var(data, facet = group)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis13u866')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis13u866: GeneralStatistics expression (auto-extracted; see ref)."
