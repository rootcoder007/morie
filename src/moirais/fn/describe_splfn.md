...
`print(result)` render. See `moirais.fn.describe('splfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splfn import *
import numpy as np
# See the function signature in fn/splfn.py for argument names.
```
