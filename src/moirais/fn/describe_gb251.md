...
`print(result)` render. See `moirais.fn.describe('gb251')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb251 import *
import numpy as np
# See the function signature in fn/gb251.py for argument names.
```
