# describe('mcfmt') — multiclass_confusion_matrix
...
`print(result)` render. See `moirais.fn.describe('mcfmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcfmt import *
import numpy as np
# See the function signature in fn/mcfmt.py for argument names.
```
