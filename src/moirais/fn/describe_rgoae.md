...
`print(result)` render. See `moirais.fn.describe('rgoae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgoae import *
import numpy as np
# See the function signature in fn/rgoae.py for argument names.
```
