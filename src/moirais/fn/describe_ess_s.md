...
`print(result)` render. See `moirais.fn.describe('ess_s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ess_s import *
import numpy as np
# See the function signature in fn/ess_s.py for argument names.
```
