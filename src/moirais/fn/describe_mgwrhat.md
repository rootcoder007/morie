...
`print(result)` render. See `moirais.fn.describe('mgwrhat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrhat import *
import numpy as np
# See the function signature in fn/mgwrhat.py for argument names.
```
