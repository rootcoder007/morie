# describe('ztfrq') — freq_response_at
...
`print(result)` render. See `moirais.fn.describe('ztfrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ztfrq import *
import numpy as np
# See the function signature in fn/ztfrq.py for argument names.
```
