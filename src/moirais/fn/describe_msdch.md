...
`print(result)` render. See `moirais.fn.describe('msdch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdch import *
import numpy as np
# See the function signature in fn/msdch.py for argument names.
```
