# describe('svyqtl') — survey_quantile
...
`print(result)` render. See `moirais.fn.describe('svyqtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svyqtl import *
import numpy as np
# See the function signature in fn/svyqtl.py for argument names.
```
