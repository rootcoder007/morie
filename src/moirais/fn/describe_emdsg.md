# describe('emdsg') — _count_zero_crossings
...
`print(result)` render. See `moirais.fn.describe('emdsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdsg import *
import numpy as np
# See the function signature in fn/emdsg.py for argument names.
```
