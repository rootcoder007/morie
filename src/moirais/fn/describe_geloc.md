...
`print(result)` render. See `moirais.fn.describe('geloc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geloc import *
import numpy as np
# See the function signature in fn/geloc.py for argument names.
```
