# describe('jotsmx') — joseph_tsmixer
...
`print(result)` render. See `moirais.fn.describe('jotsmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jotsmx import *
import numpy as np
# See the function signature in fn/jotsmx.py for argument names.
```
