...
__all__ = ["hedderich_chapter_9_unnumbered_3576"]


def hedderich_chapter_9_unnumbered_3576(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α·(1−exp(αt))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3576')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3576: GeneralStatistics expression (auto-extracted; see ref)."
