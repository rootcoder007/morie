# describe('lzcomp') — lempel_ziv_complexity
...
`print(result)` render. See `moirais.fn.describe('lzcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lzcomp import *
import numpy as np
# See the function signature in fn/lzcomp.py for argument names.
```
