...
`print(result)` render. See `moirais.fn.describe('gdntm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdntm import *
import numpy as np
# See the function signature in fn/gdntm.py for argument names.
```
