...
`print(result)` render. See `moirais.fn.describe('fosdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fosdx import *
import numpy as np
# See the function signature in fn/fosdx.py for argument names.
```
