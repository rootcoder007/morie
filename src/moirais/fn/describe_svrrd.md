...
`print(result)` render. See `moirais.fn.describe('svrrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrrd import *
import numpy as np
# See the function signature in fn/svrrd.py for argument names.
```
