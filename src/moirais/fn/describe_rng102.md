# describe('rng102') — rangayyan_ch3_integral_general
...
`print(result)` render. See `moirais.fn.describe('rng102')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng102 import *
import numpy as np
# See the function signature in fn/rng102.py for argument names.
```
