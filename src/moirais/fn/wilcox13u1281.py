...
__all__ = ["wilcox_chapter_13_unnumbered_1281"]


def wilcox_chapter_13_unnumbered_1281(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Sum p+1 =p11 +p21 p+2 =p12 +p22
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1281')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1281: GeneralStatistics expression (auto-extracted; see ref)."
