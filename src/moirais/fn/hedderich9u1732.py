...
__all__ = ["hedderich_chapter_9_unnumbered_1732"]


def hedderich_chapter_9_unnumbered_1732(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X≦1|λ=1.8)=0.1653 +P (X=1|λ=1.8)=0.1653 + 1.81e−1.8/1!=0.46284 etc.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1732')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1732: GeneralStatistics expression (auto-extracted; see ref)."
