# describe('ca3u58') — ca_chapter_3_unnumbered_58
...
y = b0 + b1x1 + b2 x1x1() = b0 + b1x1 + b2x2
...
```python
from moirais.fn.ca3u58 import ca_chapter_3_unnumbered_58
import numpy as np
result = ca_chapter_3_unnumbered_58(np.random.default_rng(42).normal(0, 1, 100))
