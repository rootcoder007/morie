...
__all__ = ["hedderich_chapter_9_unnumbered_273"]


def hedderich_chapter_9_unnumbered_273(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i.e., in the case of an even distribution withp1 =p2 =...=pN = 1/N,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u273')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u273: GeneralStatistics expression (auto-extracted; see ref)."
