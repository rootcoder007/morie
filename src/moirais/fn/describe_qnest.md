# describe('qnest') — qn_estimator

## WHAT IT DOES

Qn scale estimator. 'When I let go of what I am, I become what I might be. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('qnest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qnest import *
import numpy as np
# See the function signature in fn/qnest.py for argument names.
```
