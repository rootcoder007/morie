...
`print(result)` render. See `moirais.fn.describe('randwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.randwk import *
import numpy as np
# See the function signature in fn/randwk.py for argument names.
```
