# describe('ksr035') — kosorok_ch2_donsker_bracketing_integral
...
`print(result)` render. See `moirais.fn.describe('ksr035')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr035 import *
import numpy as np
# See the function signature in fn/ksr035.py for argument names.
```
