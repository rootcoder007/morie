# describe('smplep') — sample_overlap
...
`print(result)` render. See `moirais.fn.describe('smplep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smplep import *
import numpy as np
# See the function signature in fn/smplep.py for argument names.
```
