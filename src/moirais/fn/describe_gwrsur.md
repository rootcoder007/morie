...
`print(result)` render. See `moirais.fn.describe('gwrsur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrsur import *
import numpy as np
# See the function signature in fn/gwrsur.py for argument names.
```
