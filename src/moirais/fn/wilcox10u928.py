...
__all__ = ["wilcox_chapter_10_unnumbered_928"]


def wilcox_chapter_10_unnumbered_928(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1 − α confidence interval for µ j − µ k is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u928')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u928: GeneralStatistics expression (auto-extracted; see ref)."
