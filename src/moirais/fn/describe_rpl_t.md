...
`print(result)` render. See `moirais.fn.describe('rpl_t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_t import *
import numpy as np
# See the function signature in fn/rpl_t.py for argument names.
```
