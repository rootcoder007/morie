...
__all__ = ["wilcox_chapter_13_unnumbered_1298"]


def wilcox_chapter_13_unnumbered_1298(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1298')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1298: GeneralStatistics expression (auto-extracted; see ref)."
