# describe('irtoc') — irt_option_curves
...
`print(result)` render. See `moirais.fn.describe('irtoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtoc import *
import numpy as np
# See the function signature in fn/irtoc.py for argument names.
```
