# describe('fzlst') — fauzi_l_statistic
...
`print(result)` render. See `moirais.fn.describe('fzlst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzlst import *
import numpy as np
# See the function signature in fn/fzlst.py for argument names.
```
