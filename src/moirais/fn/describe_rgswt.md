...
`print(result)` render. See `moirais.fn.describe('rgswt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgswt import *
import numpy as np
# See the function signature in fn/rgswt.py for argument names.
```
