...
`print(result)` render. See `moirais.fn.describe('pprth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pprth import *
import numpy as np
# See the function signature in fn/pprth.py for argument names.
```
