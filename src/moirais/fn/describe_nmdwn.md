...
`print(result)` render. See `moirais.fn.describe('nmdwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdwn import *
import numpy as np
# See the function signature in fn/nmdwn.py for argument names.
```
