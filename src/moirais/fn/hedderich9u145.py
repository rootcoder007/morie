...
__all__ = ["hedderich_chapter_9_unnumbered_145"]


def hedderich_chapter_9_unnumbered_145(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + cex . axis = 1 . 3 , cex . names = 1 . 1 ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u145')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u145: GeneralStatistics expression (auto-extracted; see ref)."
