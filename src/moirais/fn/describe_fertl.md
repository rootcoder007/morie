...
`print(result)` render. See `moirais.fn.describe('fertl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fertl import *
import numpy as np
# See the function signature in fn/fertl.py for argument names.
```
