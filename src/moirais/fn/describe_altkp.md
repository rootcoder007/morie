# describe('altkp') — alammar_tokenization_pipeline
...
`print(result)` render. See `moirais.fn.describe('altkp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.altkp import *
import numpy as np
# See the function signature in fn/altkp.py for argument names.
```
