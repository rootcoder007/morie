# describe('zxcpc') — copula_clayton_sp

## WHAT IT DOES

Clayton copula spatial
...
`print(result)` render. See `moirais.fn.describe('zxcpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxcpc import *
import numpy as np
# See the function signature in fn/zxcpc.py for argument names.
```
