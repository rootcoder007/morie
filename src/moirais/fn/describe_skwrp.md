...
`print(result)` render. See `moirais.fn.describe('skwrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.skwrp import *
import numpy as np
# See the function signature in fn/skwrp.py for argument names.
```
