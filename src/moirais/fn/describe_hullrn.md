...
`print(result)` render. See `moirais.fn.describe('hullrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hullrn import *
import numpy as np
# See the function signature in fn/hullrn.py for argument names.
```
