# describe('mssm') — marginal_structural_med
...
`print(result)` render. See `moirais.fn.describe('mssm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssm import *
import numpy as np
# See the function signature in fn/mssm.py for argument names.
```
