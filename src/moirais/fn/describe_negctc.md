# describe('negctc') — negative_control_outcome
...
`print(result)` render. See `moirais.fn.describe('negctc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.negctc import *
import numpy as np
# See the function signature in fn/negctc.py for argument names.
```
