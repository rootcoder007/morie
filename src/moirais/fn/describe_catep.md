# describe('catep') — cate_estimation
...
`print(result)` render. See `moirais.fn.describe('catep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catep import *
import numpy as np
# See the function signature in fn/catep.py for argument names.
```
