...
`print(result)` render. See `moirais.fn.describe('cdinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdinc import *
import numpy as np
# See the function signature in fn/cdinc.py for argument names.
```
