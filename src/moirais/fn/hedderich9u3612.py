...
__all__ = ["hedderich_chapter_9_unnumbered_3612"]


def hedderich_chapter_9_unnumbered_3612(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] log(H(ti)) = p log(˜λ) +p log(ti)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3612')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3612: GeneralStatistics expression (auto-extracted; see ref)."
