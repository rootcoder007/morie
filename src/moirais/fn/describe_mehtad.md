# describe('mehtad') — mehrotras_predictor
...
`print(result)` render. See `moirais.fn.describe('mehtad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mehtad import *
import numpy as np
# See the function signature in fn/mehtad.py for argument names.
```
