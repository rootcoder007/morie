# describe('cvxlin') — boyd_linear_program
...
`print(result)` render. See `moirais.fn.describe('cvxlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlin import *
import numpy as np
# See the function signature in fn/cvxlin.py for argument names.
```
