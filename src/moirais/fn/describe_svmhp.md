...
`print(result)` render. See `moirais.fn.describe('svmhp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmhp import *
import numpy as np
# See the function signature in fn/svmhp.py for argument names.
```
