...
`print(result)` render. See `moirais.fn.describe('rskth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskth import *
import numpy as np
# See the function signature in fn/rskth.py for argument names.
```
