...
`print(result)` render. See `moirais.fn.describe('mafsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafsn import *
import numpy as np
# See the function signature in fn/mafsn.py for argument names.
```
