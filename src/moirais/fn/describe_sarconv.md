...
`print(result)` render. See `moirais.fn.describe('sarconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarconv import *
import numpy as np
# See the function signature in fn/sarconv.py for argument names.
```
