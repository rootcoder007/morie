# describe('alfsts') — alphafold_structure_transition
...
`print(result)` render. See `moirais.fn.describe('alfsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfsts import *
import numpy as np
# See the function signature in fn/alfsts.py for argument names.
```
