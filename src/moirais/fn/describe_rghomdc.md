# describe('rghomdc') — rangayyan_homomorphic_deconv
...
`print(result)` render. See `moirais.fn.describe('rghomdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghomdc import *
import numpy as np
# See the function signature in fn/rghomdc.py for argument names.
```
