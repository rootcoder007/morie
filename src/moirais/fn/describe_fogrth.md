...
`print(result)` render. See `moirais.fn.describe('fogrth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fogrth import *
import numpy as np
# See the function signature in fn/fogrth.py for argument names.
```
