...
`print(result)` render. See `moirais.fn.describe('kwone')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kwone import *
import numpy as np
# See the function signature in fn/kwone.py for argument names.
```
