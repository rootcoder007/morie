...
`print(result)` render. See `moirais.fn.describe('pacop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacop import *
import numpy as np
# See the function signature in fn/pacop.py for argument names.
```
