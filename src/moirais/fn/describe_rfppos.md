# describe('rfppos') — reactive_pose_filter
...
`print(result)` render. See `moirais.fn.describe('rfppos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfppos import *
import numpy as np
# See the function signature in fn/rfppos.py for argument names.
```
