# describe('msm095') — mvsml_bayesian_regression_pt2_eq_7_4
...
`print(result)` render. See `moirais.fn.describe('msm095')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm095 import *
import numpy as np
# See the function signature in fn/msm095.py for argument names.
```
