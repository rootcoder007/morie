...
__all__ = ["wilcox_chapter_13_unnumbered_1111"]


def wilcox_chapter_13_unnumbered_1111(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: zlab="p-values", theta=50, phi=25, MC=FALSE, nreps=1000, SM=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1111')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1111: GeneralStatistics expression (auto-extracted; see ref)."
