...
`print(result)` render. See `moirais.fn.describe('stqft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stqft import *
import numpy as np
# See the function signature in fn/stqft.py for argument names.
```
