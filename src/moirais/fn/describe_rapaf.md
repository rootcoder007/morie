...
`print(result)` render. See `moirais.fn.describe('rapaf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rapaf import *
import numpy as np
# See the function signature in fn/rapaf.py for argument names.
```
