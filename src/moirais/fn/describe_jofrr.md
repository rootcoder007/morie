# describe('jofrr') — joseph_fourier_features
...
`print(result)` render. See `moirais.fn.describe('jofrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jofrr import *
import numpy as np
# See the function signature in fn/jofrr.py for argument names.
```
