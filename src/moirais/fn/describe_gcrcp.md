...
`print(result)` render. See `moirais.fn.describe('gcrcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcrcp import *
import numpy as np
# See the function signature in fn/gcrcp.py for argument names.
```
