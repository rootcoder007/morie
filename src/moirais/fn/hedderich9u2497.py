...
__all__ = ["hedderich_chapter_9_unnumbered_2497"]


def hedderich_chapter_9_unnumbered_2497(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] {182(2·18 + 3)−[62(2·6 + 3) + 6 2(2·6 + 3) + 6 2(2·6 + 3)]}/72 = 12.369
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2497')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2497: GeneralStatistics expression (auto-extracted; see ref)."
