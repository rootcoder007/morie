...
`print(result)` render. See `moirais.fn.describe('ipfsfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipfsfa import *
import numpy as np
# See the function signature in fn/ipfsfa.py for argument names.
```
