# describe('relbt') — reliability_metric
...
`print(result)` render. See `moirais.fn.describe('relbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relbt import *
import numpy as np
# See the function signature in fn/relbt.py for argument names.
```
