...
__all__ = ["hedderich_chapter_9_unnumbered_654"]


def hedderich_chapter_9_unnumbered_654(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 6 = 20 and s =√npq =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u654')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u654: GeneralStatistics expression (auto-extracted; see ref)."
