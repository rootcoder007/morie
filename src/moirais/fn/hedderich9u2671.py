...
__all__ = ["hedderich_chapter_9_unnumbered_2671"]


def hedderich_chapter_9_unnumbered_2671(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: By the way, if all 4 marginal sums are equal [a +b =c +d =a +c =b +d]:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2671')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2671: GeneralStatistics expression (auto-extracted; see ref)."
