...
`print(result)` render. See `moirais.fn.describe('luke')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luke import *
import numpy as np
# See the function signature in fn/luke.py for argument names.
```
