...
__all__ = ["wilcox_chapter_7_unnumbered_342"]


def wilcox_chapter_7_unnumbered_342(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: trimci(x,tr=0.2,alpha=0.05,nv=0),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u342')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u342: GeneralStatistics expression (auto-extracted; see ref)."
