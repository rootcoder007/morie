...
__all__ = ["hedderich_chapter_9_unnumbered_427"]


def hedderich_chapter_9_unnumbered_427(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: For the eventsA andB, the probabilitiesP (A) = 0.8,P (B) = 0.7 andP (A∩B) = 0.6
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u427')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u427: GeneralStatistics expression (auto-extracted; see ref)."
