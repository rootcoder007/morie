# describe('otker') — ot_kernel_emd_approx
...
`print(result)` render. See `moirais.fn.describe('otker')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otker import *
import numpy as np
# See the function signature in fn/otker.py for argument names.
```
