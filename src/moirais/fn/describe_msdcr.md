# describe('msdcr') — dist_correlation
...
`print(result)` render. See `moirais.fn.describe('msdcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdcr import *
import numpy as np
# See the function signature in fn/msdcr.py for argument names.
```
