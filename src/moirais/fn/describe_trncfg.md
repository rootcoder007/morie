# describe('trncfg') — truncated_cf_estimator
...
`print(result)` render. See `moirais.fn.describe('trncfg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trncfg import *
import numpy as np
# See the function signature in fn/trncfg.py for argument names.
```
