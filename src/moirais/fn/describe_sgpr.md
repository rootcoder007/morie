...
`print(result)` render. See `moirais.fn.describe('sgpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpr import *
import numpy as np
# See the function signature in fn/sgpr.py for argument names.
```
