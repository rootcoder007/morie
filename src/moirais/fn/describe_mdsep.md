...
`print(result)` render. See `moirais.fn.describe('mdsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsep import *
import numpy as np
# See the function signature in fn/mdsep.py for argument names.
```
