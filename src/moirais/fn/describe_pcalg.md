...
`print(result)` render. See `moirais.fn.describe('pcalg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcalg import *
import numpy as np
# See the function signature in fn/pcalg.py for argument names.
```
