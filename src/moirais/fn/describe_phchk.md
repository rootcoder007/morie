...
`print(result)` render. See `moirais.fn.describe('phchk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phchk import *
import numpy as np
# See the function signature in fn/phchk.py for argument names.
```
