# describe('causrho') — causal_proximal_proxy
...
`print(result)` render. See `moirais.fn.describe('causrho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrho import *
import numpy as np
# See the function signature in fn/causrho.py for argument names.
```
