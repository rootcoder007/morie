...
`print(result)` render. See `moirais.fn.describe('evgpdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdp import *
import numpy as np
# See the function signature in fn/evgpdp.py for argument names.
```
