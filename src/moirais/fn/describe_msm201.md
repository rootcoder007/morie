# describe('msm201') — mvsml_ridge_lasso_elastic_eq_9_27
...
`print(result)` render. See `moirais.fn.describe('msm201')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm201 import *
import numpy as np
# See the function signature in fn/msm201.py for argument names.
```
