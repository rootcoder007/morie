...
`print(result)` render. See `moirais.fn.describe('mhstg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhstg import *
import numpy as np
# See the function signature in fn/mhstg.py for argument names.
```
