...
`print(result)` render. See `moirais.fn.describe('mkflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mkflt import *
import numpy as np
# See the function signature in fn/mkflt.py for argument names.
```
