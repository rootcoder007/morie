# describe('hmsae') — geron_stacked_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmsae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsae import *
import numpy as np
# See the function signature in fn/hmsae.py for argument names.
```
