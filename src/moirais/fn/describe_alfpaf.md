# describe('alfpaf') — alphafold_pair_repr
...
`print(result)` render. See `moirais.fn.describe('alfpaf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfpaf import *
import numpy as np
# See the function signature in fn/alfpaf.py for argument names.
```
