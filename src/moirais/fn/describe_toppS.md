...
`print(result)` render. See `moirais.fn.describe('toppS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.toppS import *
import numpy as np
# See the function signature in fn/toppS.py for argument names.
```
