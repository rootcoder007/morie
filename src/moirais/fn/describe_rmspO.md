# describe('rmspO') — rmsprop_optimizer
...
`print(result)` render. See `moirais.fn.describe('rmspO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmspO import *
import numpy as np
# See the function signature in fn/rmspO.py for argument names.
```
