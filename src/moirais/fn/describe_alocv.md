# describe('alocv') — alammar_output_verification
...
`print(result)` render. See `moirais.fn.describe('alocv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alocv import *
import numpy as np
# See the function signature in fn/alocv.py for argument names.
```
