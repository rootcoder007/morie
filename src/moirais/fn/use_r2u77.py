...
__all__ = ["use_r_chapter_2_unnumbered_77"]


def use_r_chapter_2_unnumbered_77(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + }, alpha = alphabeta[1], beta = alphabeta[-1])
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u77')`` for the full guide.
...
def cheatsheet():
    return "use_r2u77: GeneralStatistics expression (auto-extracted; see ref)."
