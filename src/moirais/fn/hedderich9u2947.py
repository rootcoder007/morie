...
__all__ = ["hedderich_chapter_9_unnumbered_2947"]


def hedderich_chapter_9_unnumbered_2947(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( "B ( one − sidedlessthan ) =" ,B . min , " , ( P =" , round ( p . val , 8 ) , " ) \ n " ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2947')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2947: GeneralStatistics expression (auto-extracted; see ref)."
