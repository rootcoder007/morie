# describe('msm141') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm141')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm141 import *
import numpy as np
# See the function signature in fn/msm141.py for argument names.
```
