...
__all__ = ["hedderich_chapter_9_unnumbered_1115"]


def hedderich_chapter_9_unnumbered_1115(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > plotCI ( par , u i =upp , l i =low , xlim =c ( 0 . 8 , 3 . 2 ) , ylim =c ( 0 . 5 , 2 . 5 ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1115')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1115: GeneralStatistics expression (auto-extracted; see ref)."
