# describe('beast') — jukes_cantor_rate
...
`print(result)` render. See `moirais.fn.describe('beast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.beast import *
import numpy as np
# See the function signature in fn/beast.py for argument names.
```
