...
`print(result)` render. See `moirais.fn.describe('vmexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmexp import *
import numpy as np
# See the function signature in fn/vmexp.py for argument names.
```
