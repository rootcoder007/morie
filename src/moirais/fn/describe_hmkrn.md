# describe('hmkrn') — geron_filter_kernel
...
`print(result)` render. See `moirais.fn.describe('hmkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkrn import *
import numpy as np
# See the function signature in fn/hmkrn.py for argument names.
```
