# describe('ca4e2') — ca_chapter_4_equation_2
...
```python
from moirais.fn.ca4e2 import ca_chapter_4_equation_2
import numpy as np
result = ca_chapter_4_equation_2(np.random.default_rng(42).normal(0, 1, 100))
