...
__all__ = ["hedderich_chapter_9_unnumbered_373"]


def hedderich_chapter_9_unnumbered_373(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > lines( spline( x , y , xout = seq ( 1 , 2 1 , by = 0 . 1 ) ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u373')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u373: GeneralStatistics expression (auto-extracted; see ref)."
