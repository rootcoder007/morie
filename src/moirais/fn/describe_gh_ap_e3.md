# describe('gh_ap_e3') — ghosal_wavelet_mra
...
`print(result)` render. See `moirais.fn.describe('gh_ap_e3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_e3 import *
import numpy as np
# See the function signature in fn/gh_ap_e3.py for argument names.
```
