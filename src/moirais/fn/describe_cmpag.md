# describe('cmpag') — compliance_by_age
...
`print(result)` render. See `moirais.fn.describe('cmpag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpag import *
import numpy as np
# See the function signature in fn/cmpag.py for argument names.
```
