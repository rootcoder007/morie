...
__all__ = ["hedderich_chapter_9_unnumbered_1016"]


def hedderich_chapter_9_unnumbered_1016(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example (χ2-distribution, Table 5.9 on page 305): For the P -value to ˆχ2 = 6.43 with 2 degrees
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1016')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1016: GeneralStatistics expression (auto-extracted; see ref)."
