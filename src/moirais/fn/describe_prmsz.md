...
`print(result)` render. See `moirais.fn.describe('prmsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prmsz import *
import numpy as np
# See the function signature in fn/prmsz.py for argument names.
```
