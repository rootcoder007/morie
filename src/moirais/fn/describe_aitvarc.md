# describe('aitvarc') — aitchison_clr_covariance
...
`print(result)` render. See `moirais.fn.describe('aitvarc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitvarc import *
import numpy as np
# See the function signature in fn/aitvarc.py for argument names.
```
