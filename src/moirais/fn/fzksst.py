...
def fauzi_ks_statistic(data, cdf):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Kolmogorov-Smirnov test statistic"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Kolmogorov-Smirnov test statistic"})
