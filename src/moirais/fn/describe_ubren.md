...
`print(result)` render. See `moirais.fn.describe('ubren')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubren import *
import numpy as np
# See the function signature in fn/ubren.py for argument names.
```
