# describe('gb621') — gibbons_ks2samp
...
`print(result)` render. See `moirais.fn.describe('gb621')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb621 import *
import numpy as np
# See the function signature in fn/gb621.py for argument names.
```
