...
`print(result)` render. See `moirais.fn.describe('gddvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gddvr import *
import numpy as np
# See the function signature in fn/gddvr.py for argument names.
```
