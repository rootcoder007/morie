...
__all__ = ["hedderich_chapter_9_unnumbered_1178"]


def hedderich_chapter_9_unnumbered_1178(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + round ( p1 − p2 , digits = 4 ) , " \ nlower and upperlimitsare : " ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1178')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1178: GeneralStatistics expression (auto-extracted; see ref)."
