# describe('hrzk2') — horowitz_kernel_regression
...
`print(result)` render. See `moirais.fn.describe('hrzk2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzk2 import *
import numpy as np
# See the function signature in fn/hrzk2.py for argument names.
```
