...
`print(result)` render. See `moirais.fn.describe('dkmvk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkmvk import *
import numpy as np
# See the function signature in fn/dkmvk.py for argument names.
```
