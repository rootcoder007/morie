...
`print(result)` render. See `moirais.fn.describe('lrtsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrtsts import *
import numpy as np
# See the function signature in fn/lrtsts.py for argument names.
```
