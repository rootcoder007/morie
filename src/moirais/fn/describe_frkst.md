...
`print(result)` render. See `moirais.fn.describe('frkst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frkst import *
import numpy as np
# See the function signature in fn/frkst.py for argument names.
```
