...
`print(result)` render. See `moirais.fn.describe('ppare')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppare import *
import numpy as np
# See the function signature in fn/ppare.py for argument names.
```
