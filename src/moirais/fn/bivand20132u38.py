...
__all__ = ["bivand2013_chapter_2_unnumbered_38"]


def bivand2013_chapter_2_unnumbered_38(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + type = "Byte", colorTable = list(pal), mvFlag = length(brks) -
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u38')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u38: GeneralStatistics expression (auto-extracted; see ref)."
