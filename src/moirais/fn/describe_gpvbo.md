# describe('gpvbo') — gp_variational_bayes_opt
...
`print(result)` render. See `moirais.fn.describe('gpvbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpvbo import *
import numpy as np
# See the function signature in fn/gpvbo.py for argument names.
```
