# describe('alfsdc') — alphafold_sidechain
...
`print(result)` render. See `moirais.fn.describe('alfsdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfsdc import *
import numpy as np
# See the function signature in fn/alfsdc.py for argument names.
```
