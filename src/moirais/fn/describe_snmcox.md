...
`print(result)` render. See `moirais.fn.describe('snmcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snmcox import *
import numpy as np
# See the function signature in fn/snmcox.py for argument names.
```
