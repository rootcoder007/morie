# describe('cvxlpl') — boyd_linear_program_dual
...
`print(result)` render. See `moirais.fn.describe('cvxlpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlpl import *
import numpy as np
# See the function signature in fn/cvxlpl.py for argument names.
```
