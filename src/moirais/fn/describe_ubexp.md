...
`print(result)` render. See `moirais.fn.describe('ubexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubexp import *
import numpy as np
# See the function signature in fn/ubexp.py for argument names.
```
