# describe('occex') — occupational_exposure
...
`print(result)` render. See `moirais.fn.describe('occex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.occex import *
import numpy as np
# See the function signature in fn/occex.py for argument names.
```
