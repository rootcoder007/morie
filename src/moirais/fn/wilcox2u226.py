...
__all__ = ["wilcox_chapter_2_unnumbered_226"]


def wilcox_chapter_2_unnumbered_226(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] D = 81x2 − 9x(2 +c2) + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u226')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u226: GeneralStatistics expression (auto-extracted; see ref)."
