# describe('hntfst') — honest_random_forest
...
`print(result)` render. See `moirais.fn.describe('hntfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hntfst import *
import numpy as np
# See the function signature in fn/hntfst.py for argument names.
```
