...
`print(result)` render. See `moirais.fn.describe('ubtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubtrn import *
import numpy as np
# See the function signature in fn/ubtrn.py for argument names.
```
