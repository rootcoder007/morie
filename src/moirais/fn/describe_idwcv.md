...
`print(result)` render. See `moirais.fn.describe('idwcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwcv import *
import numpy as np
# See the function signature in fn/idwcv.py for argument names.
```
