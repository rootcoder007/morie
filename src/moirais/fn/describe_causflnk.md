# describe('causflnk') — causal_falsification_test
...
`print(result)` render. See `moirais.fn.describe('causflnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causflnk import *
import numpy as np
# See the function signature in fn/causflnk.py for argument names.
```
