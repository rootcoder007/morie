...
`print(result)` render. See `moirais.fn.describe('sdmjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmjac import *
import numpy as np
# See the function signature in fn/sdmjac.py for argument names.
```
