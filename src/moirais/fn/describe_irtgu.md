...
`print(result)` render. See `moirais.fn.describe('irtgu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtgu import *
import numpy as np
# See the function signature in fn/irtgu.py for argument names.
```
