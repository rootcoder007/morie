...
`print(result)` render. See `moirais.fn.describe('dcblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcblk import *
import numpy as np
# See the function signature in fn/dcblk.py for argument names.
```
