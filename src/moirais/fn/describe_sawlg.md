# describe('sawlg') — sawlg

## WHAT IT DOES

Spatial weight lag operator
...
`print(result)` render. See `moirais.fn.describe('sawlg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawlg import *
import numpy as np
# See the function signature in fn/sawlg.py for argument names.
```
