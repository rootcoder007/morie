# describe('gb1122tr') — gibbons_kendall_trend
...
`print(result)` render. See `moirais.fn.describe('gb1122tr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1122tr import *
import numpy as np
# See the function signature in fn/gb1122tr.py for argument names.
```
