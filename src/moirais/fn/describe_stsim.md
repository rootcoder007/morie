...
`print(result)` render. See `moirais.fn.describe('stsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stsim import *
import numpy as np
# See the function signature in fn/stsim.py for argument names.
```
