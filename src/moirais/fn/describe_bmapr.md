# describe('bmapr') — bayesian_model_averaging
...
`print(result)` render. See `moirais.fn.describe('bmapr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmapr import *
import numpy as np
# See the function signature in fn/bmapr.py for argument names.
```
