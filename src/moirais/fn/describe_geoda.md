...
`print(result)` render. See `moirais.fn.describe('geoda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geoda import *
import numpy as np
# See the function signature in fn/geoda.py for argument names.
```
