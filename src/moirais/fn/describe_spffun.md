# describe('spffun') — schabenberger_f_function
...
`print(result)` render. See `moirais.fn.describe('spffun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spffun import *
import numpy as np
# See the function signature in fn/spffun.py for argument names.
```
