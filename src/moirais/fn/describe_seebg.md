...
`print(result)` render. See `moirais.fn.describe('seebg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seebg import *
import numpy as np
# See the function signature in fn/seebg.py for argument names.
```
