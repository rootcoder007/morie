...
__all__ = ["wilcox_chapter_13_unnumbered_1108"]


def wilcox_chapter_13_unnumbered_1108(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: regYci(x,y,regfun=tsreg, pts=unique(x), nboot=100, ADJ=FALSE, xout=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1108')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1108: GeneralStatistics expression (auto-extracted; see ref)."
