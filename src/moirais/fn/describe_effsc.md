...
`print(result)` render. See `moirais.fn.describe('effsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effsc import *
import numpy as np
# See the function signature in fn/effsc.py for argument names.
```
