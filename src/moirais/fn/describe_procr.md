# describe('procr') — procrustes_rotation
...
`print(result)` render. See `moirais.fn.describe('procr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.procr import *
import numpy as np
# See the function signature in fn/procr.py for argument names.
```
