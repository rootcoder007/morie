# describe('gb1331s') — gibbons_sign_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb1331s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1331s import *
import numpy as np
# See the function signature in fn/gb1331s.py for argument names.
```
