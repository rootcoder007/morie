...
`print(result)` render. See `moirais.fn.describe('alcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alcov import *
import numpy as np
# See the function signature in fn/alcov.py for argument names.
```
