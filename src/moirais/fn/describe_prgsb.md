# describe('prgsb') — program_subgroup
...
`print(result)` render. See `moirais.fn.describe('prgsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgsb import *
import numpy as np
# See the function signature in fn/prgsb.py for argument names.
```
