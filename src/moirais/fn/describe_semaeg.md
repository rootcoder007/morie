# describe('semaeg') — sam_image_encoder
...
`print(result)` render. See `moirais.fn.describe('semaeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semaeg import *
import numpy as np
# See the function signature in fn/semaeg.py for argument names.
```
