# describe('mafshi') — ma_fishers_z_inverse
...
`print(result)` render. See `moirais.fn.describe('mafshi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafshi import *
import numpy as np
# See the function signature in fn/mafshi.py for argument names.
```
