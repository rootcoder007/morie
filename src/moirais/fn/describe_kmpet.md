# describe('kmpet') — kamath_pet_loss
...
`print(result)` render. See `moirais.fn.describe('kmpet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpet import *
import numpy as np
# See the function signature in fn/kmpet.py for argument names.
```
