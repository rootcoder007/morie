...
`print(result)` render. See `moirais.fn.describe('ghoste')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghoste import *
import numpy as np
# See the function signature in fn/ghoste.py for argument names.
```
