...
`print(result)` render. See `moirais.fn.describe('grdgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdgen import *
import numpy as np
# See the function signature in fn/grdgen.py for argument names.
```
