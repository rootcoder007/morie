# describe('rng138') — rangayyan_ch3_wiener_filter_output_convolution
...
`print(result)` render. See `moirais.fn.describe('rng138')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng138 import *
import numpy as np
# See the function signature in fn/rng138.py for argument names.
```
