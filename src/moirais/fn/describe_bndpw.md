...
`print(result)` render. See `moirais.fn.describe('bndpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpw import *
import numpy as np
# See the function signature in fn/bndpw.py for argument names.
```
