# describe('altsd') — alammar_tsdae_objective
...
`print(result)` render. See `moirais.fn.describe('altsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.altsd import *
import numpy as np
# See the function signature in fn/altsd.py for argument names.
```
