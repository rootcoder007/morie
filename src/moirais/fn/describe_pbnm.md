...
`print(result)` render. See `moirais.fn.describe('pbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pbnm import *
import numpy as np
# See the function signature in fn/pbnm.py for argument names.
```
