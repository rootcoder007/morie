# describe('bwavl') — bayesian_wavelet_shrinkage
...
`print(result)` render. See `moirais.fn.describe('bwavl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwavl import *
import numpy as np
# See the function signature in fn/bwavl.py for argument names.
```
