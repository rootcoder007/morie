...
__all__ = ["hedderich_chapter_9_unnumbered_1067"]


def hedderich_chapter_9_unnumbered_1067(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n−1 [(n−1)σ2]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1067')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1067: GeneralStatistics expression (auto-extracted; see ref)."
