...
`print(result)` render. See `moirais.fn.describe('caCMIP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caCMIP import *
import numpy as np
# See the function signature in fn/caCMIP.py for argument names.
```
