# describe('msm195') — mvsml_ridge_lasso_elastic_eq_9_23
...
`print(result)` render. See `moirais.fn.describe('msm195')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm195 import *
import numpy as np
# See the function signature in fn/msm195.py for argument names.
```
