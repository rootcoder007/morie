...
`print(result)` render. See `moirais.fn.describe('jrqbq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jrqbq import *
import numpy as np
# See the function signature in fn/jrqbq.py for argument names.
```
