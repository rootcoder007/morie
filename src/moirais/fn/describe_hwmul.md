# describe('hwmul') — holt_winters_mult
...
`print(result)` render. See `moirais.fn.describe('hwmul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hwmul import *
import numpy as np
# See the function signature in fn/hwmul.py for argument names.
```
