# describe('nash') — nash_equilibrium
...
`print(result)` render. See `moirais.fn.describe('nash')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nash import *
import numpy as np
# See the function signature in fn/nash.py for argument names.
```
