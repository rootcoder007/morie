...
`print(result)` render. See `moirais.fn.describe('farmlmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.farmlmm import *
import numpy as np
# See the function signature in fn/farmlmm.py for argument names.
```
