...
`print(result)` render. See `moirais.fn.describe('evstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evstd import *
import numpy as np
# See the function signature in fn/evstd.py for argument names.
```
