# describe('msm220') — mvsml_ridge_lasso_elastic_eq_9_36
...
`print(result)` render. See `moirais.fn.describe('msm220')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm220 import *
import numpy as np
# See the function signature in fn/msm220.py for argument names.
```
