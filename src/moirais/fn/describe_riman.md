...
`print(result)` render. See `moirais.fn.describe('riman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.riman import *
import numpy as np
# See the function signature in fn/riman.py for argument names.
```
