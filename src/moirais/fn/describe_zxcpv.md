...
`print(result)` render. See `moirais.fn.describe('zxcpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxcpv import *
import numpy as np
# See the function signature in fn/zxcpv.py for argument names.
```
