...
`print(result)` render. See `moirais.fn.describe('dispr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dispr import *
import numpy as np
# See the function signature in fn/dispr.py for argument names.
```
