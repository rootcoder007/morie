...
`print(result)` render. See `moirais.fn.describe('slope1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slope1 import *
import numpy as np
# See the function signature in fn/slope1.py for argument names.
```
