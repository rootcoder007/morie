...
`print(result)` render. See `moirais.fn.describe('glrcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glrcd import *
import numpy as np
# See the function signature in fn/glrcd.py for argument names.
```
