...
`print(result)` render. See `moirais.fn.describe('rmsnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsnr import *
import numpy as np
# See the function signature in fn/rmsnr.py for argument names.
```
