...
`print(result)` render. See `moirais.fn.describe('lacscat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacscat import *
import numpy as np
# See the function signature in fn/lacscat.py for argument names.
```
