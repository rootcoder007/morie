...
`print(result)` render. See `moirais.fn.describe('otmxh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmxh import *
import numpy as np
# See the function signature in fn/otmxh.py for argument names.
```
