# describe('b202') — burkov_lm_ch2_lm_next_token
...
`print(result)` render. See `moirais.fn.describe('b202')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b202 import *
import numpy as np
# See the function signature in fn/b202.py for argument names.
```
