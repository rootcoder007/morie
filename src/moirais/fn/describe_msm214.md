# describe('msm214') — mvsml_ridge_lasso_elastic_eq_9_32
...
`print(result)` render. See `moirais.fn.describe('msm214')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm214 import *
import numpy as np
# See the function signature in fn/msm214.py for argument names.
```
