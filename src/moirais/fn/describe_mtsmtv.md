# describe('mtsmtv') — mts_mtr_combined
...
`print(result)` render. See `moirais.fn.describe('mtsmtv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtsmtv import *
import numpy as np
# See the function signature in fn/mtsmtv.py for argument names.
```
