...
`print(result)` render. See `moirais.fn.describe('hinge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hinge import *
import numpy as np
# See the function signature in fn/hinge.py for argument names.
```
