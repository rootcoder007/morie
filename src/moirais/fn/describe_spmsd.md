# describe('spmsd') — schabenberger_ms_differentiability
...
`print(result)` render. See `moirais.fn.describe('spmsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmsd import *
import numpy as np
# See the function signature in fn/spmsd.py for argument names.
```
