# describe('bdmnts') — bound_monot_inst
...
`print(result)` render. See `moirais.fn.describe('bdmnts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdmnts import *
import numpy as np
# See the function signature in fn/bdmnts.py for argument names.
```
