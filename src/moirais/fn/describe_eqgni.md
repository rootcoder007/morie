# describe('eqgni') — gini_coefficient
...
`print(result)` render. See `moirais.fn.describe('eqgni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqgni import *
import numpy as np
# See the function signature in fn/eqgni.py for argument names.
```
