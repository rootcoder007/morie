...
`print(result)` render. See `moirais.fn.describe('dttvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dttvs import *
import numpy as np
# See the function signature in fn/dttvs.py for argument names.
```
