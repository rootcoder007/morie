...
`print(result)` render. See `moirais.fn.describe('svexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svexp import *
import numpy as np
# See the function signature in fn/svexp.py for argument names.
```
