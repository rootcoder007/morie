# describe('kmbon') — kamath_best_of_n_sampling
...
`print(result)` render. See `moirais.fn.describe('kmbon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbon import *
import numpy as np
# See the function signature in fn/kmbon.py for argument names.
```
