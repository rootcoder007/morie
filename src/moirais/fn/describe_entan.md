# describe('entan') — entanglement_entropy
...
`print(result)` render. See `moirais.fn.describe('entan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entan import *
import numpy as np
# See the function signature in fn/entan.py for argument names.
```
