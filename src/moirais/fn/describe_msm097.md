# describe('msm097') — mvsml_bayesian_regression_pt2_eq_7_3
...
`print(result)` render. See `moirais.fn.describe('msm097')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm097 import *
import numpy as np
# See the function signature in fn/msm097.py for argument names.
```
