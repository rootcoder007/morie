# describe('bnsnig') — bound_no_unobserved_inv
...
`print(result)` render. See `moirais.fn.describe('bnsnig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsnig import *
import numpy as np
# See the function signature in fn/bnsnig.py for argument names.
```
