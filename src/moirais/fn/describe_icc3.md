# describe('icc3') — icc_two_way_mixed
...
`print(result)` render. See `moirais.fn.describe('icc3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc3 import *
import numpy as np
# See the function signature in fn/icc3.py for argument names.
```
