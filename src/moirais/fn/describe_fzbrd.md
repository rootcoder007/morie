# describe('fzbrd') — fauzi_bias_reduced_kdfe
...
`print(result)` render. See `moirais.fn.describe('fzbrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzbrd import *
import numpy as np
# See the function signature in fn/fzbrd.py for argument names.
```
