# describe('rng120') — rangayyan_ch3_baseline_wander_filter_z_form_a
...
`print(result)` render. See `moirais.fn.describe('rng120')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng120 import *
import numpy as np
# See the function signature in fn/rng120.py for argument names.
```
