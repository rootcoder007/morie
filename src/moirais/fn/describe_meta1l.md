# describe('meta1l') — meta_learner_ensemble
...
`print(result)` render. See `moirais.fn.describe('meta1l')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.meta1l import *
import numpy as np
# See the function signature in fn/meta1l.py for argument names.
```
