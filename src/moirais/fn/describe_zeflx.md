...
`print(result)` render. See `moirais.fn.describe('zeflx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeflx import *
import numpy as np
# See the function signature in fn/zeflx.py for argument names.
```
