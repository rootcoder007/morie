# describe('combn') — combinations_count
...
`print(result)` render. See `moirais.fn.describe('combn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.combn import *
import numpy as np
# See the function signature in fn/combn.py for argument names.
```
