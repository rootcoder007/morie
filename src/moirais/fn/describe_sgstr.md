# describe('sgstr') — strict_stationarity_test
...
`print(result)` render. See `moirais.fn.describe('sgstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgstr import *
import numpy as np
# See the function signature in fn/sgstr.py for argument names.
```
