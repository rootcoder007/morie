...
`print(result)` render. See `moirais.fn.describe('geoidh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geoidh import *
import numpy as np
# See the function signature in fn/geoidh.py for argument names.
```
