# describe('hmrpca') — geron_randomized_pca
...
`print(result)` render. See `moirais.fn.describe('hmrpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrpca import *
import numpy as np
# See the function signature in fn/hmrpca.py for argument names.
```
