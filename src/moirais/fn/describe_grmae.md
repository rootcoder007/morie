...
`print(result)` render. See `moirais.fn.describe('grmae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmae import *
import numpy as np
# See the function signature in fn/grmae.py for argument names.
```
