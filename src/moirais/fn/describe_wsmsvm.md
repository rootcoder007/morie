...
`print(result)` render. See `moirais.fn.describe('wsmsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmsvm import *
import numpy as np
# See the function signature in fn/wsmsvm.py for argument names.
```
