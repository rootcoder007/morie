# describe('svsl2') — salience_2issue
...
`print(result)` render. See `moirais.fn.describe('svsl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsl2 import *
import numpy as np
# See the function signature in fn/svsl2.py for argument names.
```
