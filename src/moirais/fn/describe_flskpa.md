...
`print(result)` render. See `moirais.fn.describe('flskpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flskpa import *
import numpy as np
# See the function signature in fn/flskpa.py for argument names.
```
