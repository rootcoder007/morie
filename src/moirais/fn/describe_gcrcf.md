...
`print(result)` render. See `moirais.fn.describe('gcrcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcrcf import *
import numpy as np
# See the function signature in fn/gcrcf.py for argument names.
```
