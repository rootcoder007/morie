# describe('wsmlpr') — wasserman_local_polynomial
...
`print(result)` render. See `moirais.fn.describe('wsmlpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlpr import *
import numpy as np
# See the function signature in fn/wsmlpr.py for argument names.
```
