# describe('relgr') — reliability_growth
...
`print(result)` render. See `moirais.fn.describe('relgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relgr import *
import numpy as np
# See the function signature in fn/relgr.py for argument names.
```
