...
__all__ = ["hedderich_chapter_9_unnumbered_3075"]


def hedderich_chapter_9_unnumbered_3075(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: p− value = 5 . 4 7 e −09
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3075')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3075: GeneralStatistics expression (auto-extracted; see ref)."
