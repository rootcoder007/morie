...
__all__ = ["legal_ontology_chapter_10_unnumbered_24"]


def legal_ontology_chapter_10_unnumbered_24(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('legal_ontology10u24')`` for the full guide.
...
def cheatsheet():
    return "legal_ontology10u24: GeneralStatistics expression (auto-extracted; see ref)."
