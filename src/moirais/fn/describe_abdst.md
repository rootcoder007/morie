...
`print(result)` render. See `moirais.fn.describe('abdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abdst import *
import numpy as np
# See the function signature in fn/abdst.py for argument names.
```
