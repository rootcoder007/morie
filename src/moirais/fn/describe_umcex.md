...
`print(result)` render. See `moirais.fn.describe('umcex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umcex import *
import numpy as np
# See the function signature in fn/umcex.py for argument names.
```
