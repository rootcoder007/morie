# describe('prtMK') — prewhitening_mk
...
`print(result)` render. See `moirais.fn.describe('prtMK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prtMK import *
import numpy as np
# See the function signature in fn/prtMK.py for argument names.
```
