# describe('prsval') — presmessick_validity
...
`print(result)` render. See `moirais.fn.describe('prsval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsval import *
import numpy as np
# See the function signature in fn/prsval.py for argument names.
```
