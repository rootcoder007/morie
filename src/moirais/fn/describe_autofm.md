...
`print(result)` render. See `moirais.fn.describe('autofm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.autofm import *
import numpy as np
# See the function signature in fn/autofm.py for argument names.
```
