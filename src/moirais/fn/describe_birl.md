...
`print(result)` render. See `moirais.fn.describe('birl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.birl import *
import numpy as np
# See the function signature in fn/birl.py for argument names.
```
