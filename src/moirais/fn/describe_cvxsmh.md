# describe('cvxsmh') — boyd_smooth_huber_grad
...
`print(result)` render. See `moirais.fn.describe('cvxsmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsmh import *
import numpy as np
# See the function signature in fn/cvxsmh.py for argument names.
```
