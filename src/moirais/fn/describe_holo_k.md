...
`print(result)` render. See `moirais.fn.describe('holo_k')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_k import *
import numpy as np
# See the function signature in fn/holo_k.py for argument names.
```
