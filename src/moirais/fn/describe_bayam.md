# describe('bayam') — bayesian_am_scaling
...
`print(result)` render. See `moirais.fn.describe('bayam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayam import *
import numpy as np
# See the function signature in fn/bayam.py for argument names.
```
