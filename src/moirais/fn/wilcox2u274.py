...
__all__ = ["wilcox_chapter_2_unnumbered_274"]


def wilcox_chapter_2_unnumbered_274(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u274')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u274: PowerAndDesign expression (auto-extracted; see ref)."
