...
`print(result)` render. See `moirais.fn.describe('ddpgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddpgc import *
import numpy as np
# See the function signature in fn/ddpgc.py for argument names.
```
