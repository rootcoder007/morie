# describe('pstdn') — posterior_density_data
...
`print(result)` render. See `moirais.fn.describe('pstdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstdn import *
import numpy as np
# See the function signature in fn/pstdn.py for argument names.
```
