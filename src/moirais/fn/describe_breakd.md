# describe('breakd') — breakdown_point
...
`print(result)` render. See `moirais.fn.describe('breakd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.breakd import *
import numpy as np
# See the function signature in fn/breakd.py for argument names.
```
