...
`print(result)` render. See `moirais.fn.describe('soseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soseq import *
import numpy as np
# See the function signature in fn/soseq.py for argument names.
```
