# describe('venmm') — cooccurrence_matrix
...
`print(result)` render. See `moirais.fn.describe('venmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.venmm import *
import numpy as np
# See the function signature in fn/venmm.py for argument names.
```
