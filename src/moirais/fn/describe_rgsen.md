# describe('rgsen') — rangayyan_sensitivity
...
`print(result)` render. See `moirais.fn.describe('rgsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsen import *
import numpy as np
# See the function signature in fn/rgsen.py for argument names.
```
