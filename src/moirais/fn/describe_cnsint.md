# describe('cnsint') — concurrent_calibration
...
`print(result)` render. See `moirais.fn.describe('cnsint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnsint import *
import numpy as np
# See the function signature in fn/cnsint.py for argument names.
```
