...
`print(result)` render. See `moirais.fn.describe('diflr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diflr import *
import numpy as np
# See the function signature in fn/diflr.py for argument names.
```
