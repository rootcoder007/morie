...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_79"]


def guide_on_data_analysis_chapter_2_unnumbered_79(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑘! ⋅ Γ((𝑣 + 𝑘 + 1)/2)√𝑣𝜋Γ((𝑣 + 𝑘)/2)(1 +𝑥2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u79')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u79: GeneralStatistics expression (auto-extracted; see ref)."
