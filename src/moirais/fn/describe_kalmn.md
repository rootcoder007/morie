...
`print(result)` render. See `moirais.fn.describe('kalmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kalmn import *
import numpy as np
# See the function signature in fn/kalmn.py for argument names.
```
