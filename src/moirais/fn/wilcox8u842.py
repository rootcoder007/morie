...
__all__ = ["wilcox_chapter_8_unnumbered_842"]


def wilcox_chapter_8_unnumbered_842(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯X2. = 250 + 220 + 190
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u842')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u842: GeneralStatistics expression (auto-extracted; see ref)."
