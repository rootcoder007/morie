...
__all__ = ["hedderich_chapter_9_unnumbered_3054"]


def hedderich_chapter_9_unnumbered_3054(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: πA−πB, can be formed based on the sums of the table: first we get the empirical success proportions
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3054')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3054: GeneralStatistics expression (auto-extracted; see ref)."
