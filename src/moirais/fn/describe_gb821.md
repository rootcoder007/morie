# describe('gb821') — gibbons_wilcoxon_ranksum
...
`print(result)` render. See `moirais.fn.describe('gb821')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb821 import *
import numpy as np
# See the function signature in fn/gb821.py for argument names.
```
