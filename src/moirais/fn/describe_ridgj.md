# describe('ridgj') — ridge_objective
...
`print(result)` render. See `moirais.fn.describe('ridgj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ridgj import *
import numpy as np
# See the function signature in fn/ridgj.py for argument names.
```
