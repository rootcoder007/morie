# describe('ca2u28') — ca_chapter_2_unnumbered_28
...
```python
from moirais.fn.ca2u28 import ca_chapter_2_unnumbered_28
import numpy as np
result = ca_chapter_2_unnumbered_28(np.random.default_rng(42).normal(0, 1, 100))
