...
`print(result)` render. See `moirais.fn.describe('svdut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdut import *
import numpy as np
# See the function signature in fn/svdut.py for argument names.
```
