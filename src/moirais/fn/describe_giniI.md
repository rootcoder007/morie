...
`print(result)` render. See `moirais.fn.describe('giniI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.giniI import *
import numpy as np
# See the function signature in fn/giniI.py for argument names.
```
