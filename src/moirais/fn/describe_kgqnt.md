# describe('kgqnt') — kriging_quantile
...
`print(result)` render. See `moirais.fn.describe('kgqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgqnt import *
import numpy as np
# See the function signature in fn/kgqnt.py for argument names.
```
