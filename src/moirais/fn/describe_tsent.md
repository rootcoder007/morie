# describe('tsent') — tsallis_entropy
...
`print(result)` render. See `moirais.fn.describe('tsent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsent import *
import numpy as np
# See the function signature in fn/tsent.py for argument names.
```
