...
__all__ = ["hedderich_chapter_9_unnumbered_522"]


def hedderich_chapter_9_unnumbered_522(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] IE = (0.333−0.01)/(0.333·0.99) = 0.98
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u522')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u522: GeneralStatistics expression (auto-extracted; see ref)."
