# describe('smixd') — spatial_mixed_model
...
`print(result)` render. See `moirais.fn.describe('smixd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smixd import *
import numpy as np
# See the function signature in fn/smixd.py for argument names.
```
