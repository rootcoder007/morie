# describe('omegah') — omega_hierarchical
...
`print(result)` render. See `moirais.fn.describe('omegah')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omegah import *
import numpy as np
# See the function signature in fn/omegah.py for argument names.
```
