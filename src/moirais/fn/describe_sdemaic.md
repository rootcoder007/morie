...
`print(result)` render. See `moirais.fn.describe('sdemaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemaic import *
import numpy as np
# See the function signature in fn/sdemaic.py for argument names.
```
