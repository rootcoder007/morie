...
`print(result)` render. See `moirais.fn.describe('qnscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qnscl import *
import numpy as np
# See the function signature in fn/qnscl.py for argument names.
```
