# describe('lyapun') — lyapunov_exponent
...
`print(result)` render. See `moirais.fn.describe('lyapun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lyapun import *
import numpy as np
# See the function signature in fn/lyapun.py for argument names.
```
