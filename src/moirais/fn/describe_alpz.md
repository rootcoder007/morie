# describe('alpz') — alphazero_search
...
`print(result)` render. See `moirais.fn.describe('alpz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alpz import *
import numpy as np
# See the function signature in fn/alpz.py for argument names.
```
