# describe('mafix') — ma_fixed_effect
...
`print(result)` render. See `moirais.fn.describe('mafix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafix import *
import numpy as np
# See the function signature in fn/mafix.py for argument names.
```
