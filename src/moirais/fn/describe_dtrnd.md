...
`print(result)` render. See `moirais.fn.describe('dtrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtrnd import *
import numpy as np
# See the function signature in fn/dtrnd.py for argument names.
```
