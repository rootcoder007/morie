...
__all__ = ["wilcox_chapter_4_unnumbered_16"]


def wilcox_chapter_4_unnumbered_16(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.41667. Because X(3) = −19 .7 and X(4) = 15.4,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u16')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u16: GeneralStatistics expression (auto-extracted; see ref)."
