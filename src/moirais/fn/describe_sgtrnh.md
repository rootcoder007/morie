# describe('sgtrnh') — sgt_randic_index
...
`print(result)` render. See `moirais.fn.describe('sgtrnh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtrnh import *
import numpy as np
# See the function signature in fn/sgtrnh.py for argument names.
```
