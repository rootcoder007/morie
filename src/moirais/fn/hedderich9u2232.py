...
__all__ = ["hedderich_chapter_9_unnumbered_2232"]


def hedderich_chapter_9_unnumbered_2232(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (1−β) = Φ(−∞<z <z β) with zβ =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2232')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2232: PowerAndDesign expression (auto-extracted; see ref)."
