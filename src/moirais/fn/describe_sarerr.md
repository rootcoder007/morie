# describe('sarerr') — spatial_ar_error_model
...
`print(result)` render. See `moirais.fn.describe('sarerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarerr import *
import numpy as np
# See the function signature in fn/sarerr.py for argument names.
```
