# describe('depthP') — projection_depth
...
`print(result)` render. See `moirais.fn.describe('depthP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depthP import *
import numpy as np
# See the function signature in fn/depthP.py for argument names.
```
