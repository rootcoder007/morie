# describe('crfboot') — causal_forest_bootstrap
...
`print(result)` render. See `moirais.fn.describe('crfboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfboot import *
import numpy as np
# See the function signature in fn/crfboot.py for argument names.
```
