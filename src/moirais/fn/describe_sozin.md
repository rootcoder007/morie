...
`print(result)` render. See `moirais.fn.describe('sozin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sozin import *
import numpy as np
# See the function signature in fn/sozin.py for argument names.
```
