# describe('gb1021') — gibbons_k_median_test
...
`print(result)` render. See `moirais.fn.describe('gb1021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1021 import *
import numpy as np
# See the function signature in fn/gb1021.py for argument names.
```
