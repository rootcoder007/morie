...
__all__ = ["hedderich_chapter_9_unnumbered_256"]


def hedderich_chapter_9_unnumbered_256(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (xijk−¯x.jk )2 forj = 1,...,L andk = 1,...,K
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u256')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u256: GeneralStatistics expression (auto-extracted; see ref)."
