...
`print(result)` render. See `moirais.fn.describe('holo_v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_v import *
import numpy as np
# See the function signature in fn/holo_v.py for argument names.
```
