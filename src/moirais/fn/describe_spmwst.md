# describe('spmwst') — schabenberger_moving_window
...
`print(result)` render. See `moirais.fn.describe('spmwst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmwst import *
import numpy as np
# See the function signature in fn/spmwst.py for argument names.
```
