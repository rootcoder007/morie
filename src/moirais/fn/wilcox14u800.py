...
__all__ = ["wilcox_chapter_14_unnumbered_800"]


def wilcox_chapter_14_unnumbered_800(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ǫ ijk =Xijk − ¯µ − α j − β k − γ jk.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u800')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u800: GeneralStatistics expression (auto-extracted; see ref)."
