# describe('abuvr') — abuvr

## WHAT IT DOES

UV radiation spatial
...
`print(result)` render. See `moirais.fn.describe('abuvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abuvr import *
import numpy as np
# See the function signature in fn/abuvr.py for argument names.
```
