...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1244"]


def guide_on_data_analysis_chapter_25_unnumbered_1244(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 0.92071, p-value = 0.04671
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1244')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1244: GeneralStatistics expression (auto-extracted; see ref)."
