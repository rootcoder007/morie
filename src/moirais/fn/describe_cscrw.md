...
`print(result)` render. See `moirais.fn.describe('cscrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscrw import *
import numpy as np
# See the function signature in fn/cscrw.py for argument names.
```
