...
`print(result)` render. See `moirais.fn.describe('ecesm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecesm import *
import numpy as np
# See the function signature in fn/ecesm.py for argument names.
```
