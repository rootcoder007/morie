# describe('tcc') — test_characteristic_curve
...
`print(result)` render. See `moirais.fn.describe('tcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcc import *
import numpy as np
# See the function signature in fn/tcc.py for argument names.
```
