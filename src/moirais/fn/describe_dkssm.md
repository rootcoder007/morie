...
`print(result)` render. See `moirais.fn.describe('dkssm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkssm import *
import numpy as np
# See the function signature in fn/dkssm.py for argument names.
```
