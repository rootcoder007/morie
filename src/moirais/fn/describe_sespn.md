...
`print(result)` render. See `moirais.fn.describe('sespn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sespn import *
import numpy as np
# See the function signature in fn/sespn.py for argument names.
```
