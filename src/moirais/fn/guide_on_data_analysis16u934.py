...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_934"]


def guide_on_data_analysis_chapter_16_unnumbered_934(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: axis.title = element_text(size = 14),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u934')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u934: GeneralStatistics expression (auto-extracted; see ref)."
