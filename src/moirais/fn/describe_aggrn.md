...
`print(result)` render. See `moirais.fn.describe('aggrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aggrn import *
import numpy as np
# See the function signature in fn/aggrn.py for argument names.
```
