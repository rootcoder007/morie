...
__all__ = ["hedderich_chapter_9_unnumbered_2917"]


def hedderich_chapter_9_unnumbered_2917(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + Alcohol = c ( " 0 " , " <1 " , " 1−2 " , " 3−5 " , " >5 " ) ) ) ; malform
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2917')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2917: GeneralStatistics expression (auto-extracted; see ref)."
