# describe('gb736') — gibbons_linrank_sym_special
...
`print(result)` render. See `moirais.fn.describe('gb736')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb736 import *
import numpy as np
# See the function signature in fn/gb736.py for argument names.
```
