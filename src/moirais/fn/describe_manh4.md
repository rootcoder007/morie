...
`print(result)` render. See `moirais.fn.describe('manh4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manh4 import *
import numpy as np
# See the function signature in fn/manh4.py for argument names.
```
