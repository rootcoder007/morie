...
`print(result)` render. See `moirais.fn.describe('fcrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fcrit import *
import numpy as np
# See the function signature in fn/fcrit.py for argument names.
```
