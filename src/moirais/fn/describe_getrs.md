...
`print(result)` render. See `moirais.fn.describe('getrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getrs import *
import numpy as np
# See the function signature in fn/getrs.py for argument names.
```
