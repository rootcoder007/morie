...
`print(result)` render. See `moirais.fn.describe('vgcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcov import *
import numpy as np
# See the function signature in fn/vgcov.py for argument names.
```
