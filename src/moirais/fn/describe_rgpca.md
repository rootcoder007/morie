# describe('rgpca') — rangayyan_pca_signals
...
`print(result)` render. See `moirais.fn.describe('rgpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpca import *
import numpy as np
# See the function signature in fn/rgpca.py for argument names.
```
