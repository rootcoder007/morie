...
`print(result)` render. See `moirais.fn.describe('jormse2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jormse2 import *
import numpy as np
# See the function signature in fn/jormse2.py for argument names.
```
