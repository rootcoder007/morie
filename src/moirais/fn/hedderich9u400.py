...
__all__ = ["hedderich_chapter_9_unnumbered_400"]


def hedderich_chapter_9_unnumbered_400(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A1∪A2∪...∪An) = 1−(1−p)n (4.16)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u400')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u400: GeneralStatistics expression (auto-extracted; see ref)."
