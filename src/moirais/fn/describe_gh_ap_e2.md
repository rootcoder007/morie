# describe('gh_ap_e2') — ghosal_spline_space
...
`print(result)` render. See `moirais.fn.describe('gh_ap_e2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_e2 import *
import numpy as np
# See the function signature in fn/gh_ap_e2.py for argument names.
```
