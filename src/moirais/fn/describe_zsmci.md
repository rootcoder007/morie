...
`print(result)` render. See `moirais.fn.describe('zsmci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsmci import *
import numpy as np
# See the function signature in fn/zsmci.py for argument names.
```
