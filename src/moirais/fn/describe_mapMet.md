...
`print(result)` render. See `moirais.fn.describe('mapMet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapMet import *
import numpy as np
# See the function signature in fn/mapMet.py for argument names.
```
