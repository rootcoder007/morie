# describe('cmuit') — conditional_mutual_information
...
`print(result)` render. See `moirais.fn.describe('cmuit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmuit import *
import numpy as np
# See the function signature in fn/cmuit.py for argument names.
```
