# describe('ca8e6') — ca_chapter_8_equation_6
...
```python
from moirais.fn.ca8e6 import ca_chapter_8_equation_6
import numpy as np
result = ca_chapter_8_equation_6(np.random.default_rng(42).normal(0, 1, 100))
