# describe('crcon') — circular_convolution
...
`print(result)` render. See `moirais.fn.describe('crcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crcon import *
import numpy as np
# See the function signature in fn/crcon.py for argument names.
```
