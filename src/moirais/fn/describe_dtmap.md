...
`print(result)` render. See `moirais.fn.describe('dtmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmap import *
import numpy as np
# See the function signature in fn/dtmap.py for argument names.
```
