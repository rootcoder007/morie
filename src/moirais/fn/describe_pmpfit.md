...
`print(result)` render. See `moirais.fn.describe('pmpfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmpfit import *
import numpy as np
# See the function signature in fn/pmpfit.py for argument names.
```
