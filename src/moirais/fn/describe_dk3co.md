...
`print(result)` render. See `moirais.fn.describe('dk3co')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3co import *
import numpy as np
# See the function signature in fn/dk3co.py for argument names.
```
