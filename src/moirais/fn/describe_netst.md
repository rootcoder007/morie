# describe('netst') — network_strength
...
`print(result)` render. See `moirais.fn.describe('netst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netst import *
import numpy as np
# See the function signature in fn/netst.py for argument names.
```
