...
__all__ = ["hedderich_chapter_9_unnumbered_2136"]


def hedderich_chapter_9_unnumbered_2136(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] A:m = 8, R1 = 83.5 B:n = 8, R2 = 52.5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2136')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2136: GeneralStatistics expression (auto-extracted; see ref)."
