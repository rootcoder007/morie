...
`print(result)` render. See `moirais.fn.describe('ubvac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubvac import *
import numpy as np
# See the function signature in fn/ubvac.py for argument names.
```
