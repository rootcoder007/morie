...
`print(result)` render. See `moirais.fn.describe('wvkol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvkol import *
import numpy as np
# See the function signature in fn/wvkol.py for argument names.
```
