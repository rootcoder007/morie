...
`print(result)` render. See `moirais.fn.describe('hstrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hstrp import *
import numpy as np
# See the function signature in fn/hstrp.py for argument names.
```
