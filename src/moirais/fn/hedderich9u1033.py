...
__all__ = ["hedderich_chapter_9_unnumbered_1033"]


def hedderich_chapter_9_unnumbered_1033(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X =x,Y =y) = P (x,y )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1033')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1033: GeneralStatistics expression (auto-extracted; see ref)."
