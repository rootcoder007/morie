...
`print(result)` render. See `moirais.fn.describe('madoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madoc import *
import numpy as np
# See the function signature in fn/madoc.py for argument names.
```
