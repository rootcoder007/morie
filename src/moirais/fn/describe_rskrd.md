# describe('rskrd') — risk_reclassification
...
`print(result)` render. See `moirais.fn.describe('rskrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskrd import *
import numpy as np
# See the function signature in fn/rskrd.py for argument names.
```
