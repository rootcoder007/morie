...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_875"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_875(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ( ˆβ0, ˆβ1)∈ arg minβ0,β1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u875')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u875: GeneralStatistics expression (auto-extracted; see ref)."
