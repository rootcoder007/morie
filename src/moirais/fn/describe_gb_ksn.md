# describe('gb_ksn') — gibbons_ks_sample_size
...
`print(result)` render. See `moirais.fn.describe('gb_ksn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ksn import *
import numpy as np
# See the function signature in fn/gb_ksn.py for argument names.
```
