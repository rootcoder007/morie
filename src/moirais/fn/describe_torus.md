...
`print(result)` render. See `moirais.fn.describe('torus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.torus import *
import numpy as np
# See the function signature in fn/torus.py for argument names.
```
