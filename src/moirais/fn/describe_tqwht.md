# describe('tqwht') — turboquant_walsh_hadamard_transform
...
`print(result)` render. See `moirais.fn.describe('tqwht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqwht import *
import numpy as np
# See the function signature in fn/tqwht.py for argument names.
```
