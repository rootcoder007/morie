# describe('drpdid') — placebo_dr_did
...
`print(result)` render. See `moirais.fn.describe('drpdid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drpdid import *
import numpy as np
# See the function signature in fn/drpdid.py for argument names.
```
