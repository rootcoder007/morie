# describe('leadsl') — lead_service_line_risk
...
`print(result)` render. See `moirais.fn.describe('leadsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.leadsl import *
import numpy as np
# See the function signature in fn/leadsl.py for argument names.
```
