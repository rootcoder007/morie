# describe('moodm') — mood_median_test
...
`print(result)` render. See `moirais.fn.describe('moodm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moodm import *
import numpy as np
# See the function signature in fn/moodm.py for argument names.
```
