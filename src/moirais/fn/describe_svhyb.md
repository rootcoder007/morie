...
`print(result)` render. See `moirais.fn.describe('svhyb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svhyb import *
import numpy as np
# See the function signature in fn/svhyb.py for argument names.
```
