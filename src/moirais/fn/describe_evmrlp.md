# describe('evmrlp') — evt_mean_residual_life
...
`print(result)` render. See `moirais.fn.describe('evmrlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evmrlp import *
import numpy as np
# See the function signature in fn/evmrlp.py for argument names.
```
