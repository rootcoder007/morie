...
`print(result)` render. See `moirais.fn.describe('xrgrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgrv import *
import numpy as np
# See the function signature in fn/xrgrv.py for argument names.
```
