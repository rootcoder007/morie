# describe('cvxcjg') — boyd_conjugate
...
`print(result)` render. See `moirais.fn.describe('cvxcjg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxcjg import *
import numpy as np
# See the function signature in fn/cvxcjg.py for argument names.
```
