...
`print(result)` render. See `moirais.fn.describe('autocor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.autocor import *
import numpy as np
# See the function signature in fn/autocor.py for argument names.
```
