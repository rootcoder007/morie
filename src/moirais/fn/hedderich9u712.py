...
__all__ = ["hedderich_chapter_9_unnumbered_712"]


def hedderich_chapter_9_unnumbered_712(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1! =λe−λ≃2.74·0.065 = 0.178
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u712')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u712: GeneralStatistics expression (auto-extracted; see ref)."
