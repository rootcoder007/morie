# describe('prmnt') — permutation_entropy
...
`print(result)` render. See `moirais.fn.describe('prmnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prmnt import *
import numpy as np
# See the function signature in fn/prmnt.py for argument names.
```
