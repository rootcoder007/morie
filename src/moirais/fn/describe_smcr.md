# describe('smcr') — mean_crossing_rate
...
`print(result)` render. See `moirais.fn.describe('smcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcr import *
import numpy as np
# See the function signature in fn/smcr.py for argument names.
```
