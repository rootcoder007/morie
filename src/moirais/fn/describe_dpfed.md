...
`print(result)` render. See `moirais.fn.describe('dpfed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpfed import *
import numpy as np
# See the function signature in fn/dpfed.py for argument names.
```
