# describe('gb1421') — gibbons_chisq_contingency
...
`print(result)` render. See `moirais.fn.describe('gb1421')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1421 import *
import numpy as np
# See the function signature in fn/gb1421.py for argument names.
```
