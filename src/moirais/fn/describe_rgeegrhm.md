# describe('rgeegrhm') — rangayyan_eeg_rhythm_detect
...
`print(result)` render. See `moirais.fn.describe('rgeegrhm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeegrhm import *
import numpy as np
# See the function signature in fn/rgeegrhm.py for argument names.
```
