...
`print(result)` render. See `moirais.fn.describe('gctmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gctmp import *
import numpy as np
# See the function signature in fn/gctmp.py for argument names.
```
