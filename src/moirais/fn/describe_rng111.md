# describe('rng111') — rangayyan_ch3_first_difference_operator
...
`print(result)` render. See `moirais.fn.describe('rng111')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng111 import *
import numpy as np
# See the function signature in fn/rng111.py for argument names.
```
