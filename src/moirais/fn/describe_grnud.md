# describe('grnud') — geron_numerical_differentiation
...
`print(result)` render. See `moirais.fn.describe('grnud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnud import *
import numpy as np
# See the function signature in fn/grnud.py for argument names.
```
