...
`print(result)` render. See `moirais.fn.describe('tsscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsscr import *
import numpy as np
# See the function signature in fn/tsscr.py for argument names.
```
