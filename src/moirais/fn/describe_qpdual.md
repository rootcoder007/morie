# describe('qpdual') — quadratic_program
...
`print(result)` render. See `moirais.fn.describe('qpdual')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qpdual import *
import numpy as np
# See the function signature in fn/qpdual.py for argument names.
```
