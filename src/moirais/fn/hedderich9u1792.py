...
__all__ = ["hedderich_chapter_9_unnumbered_1792"]


def hedderich_chapter_9_unnumbered_1792(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: location-dependentδ=π−π0 = 0.10
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1792')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1792: CountModels expression (auto-extracted; see ref)."
