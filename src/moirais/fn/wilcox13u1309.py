...
__all__ = ["wilcox_chapter_13_unnumbered_1309"]


def wilcox_chapter_13_unnumbered_1309(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] Z = 150 − 86√ 150 + 86 = 4.2,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1309')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1309: ContingencyTables expression (auto-extracted; see ref)."
