...
`print(result)` render. See `moirais.fn.describe('klmnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klmnf import *
import numpy as np
# See the function signature in fn/klmnf.py for argument names.
```
