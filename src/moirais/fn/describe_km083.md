# describe('km083') — kamath_ch6_ceat_random_effects
...
`print(result)` render. See `moirais.fn.describe('km083')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km083 import *
import numpy as np
# See the function signature in fn/km083.py for argument names.
```
