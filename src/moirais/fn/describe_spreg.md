...
`print(result)` render. See `moirais.fn.describe('spreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spreg import *
import numpy as np
# See the function signature in fn/spreg.py for argument names.
```
