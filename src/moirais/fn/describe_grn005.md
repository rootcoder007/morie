# describe('grn005') — geron_ch4_normal_equation
...
`print(result)` render. See `moirais.fn.describe('grn005')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grn005 import *
import numpy as np
# See the function signature in fn/grn005.py for argument names.
```
