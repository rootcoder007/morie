# describe('tpspr') — tps_patrol_efficiency
...
`print(result)` render. See `moirais.fn.describe('tpspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpspr import *
import numpy as np
# See the function signature in fn/tpspr.py for argument names.
```
