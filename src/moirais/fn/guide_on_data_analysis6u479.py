...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_479"]


def guide_on_data_analysis_chapter_6_unnumbered_479(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜃(𝑗+1)= 𝜃(𝑗)− B(𝑗)𝐹(𝜃(𝑗)),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u479')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u479: GeneralStatistics expression (auto-extracted; see ref)."
