...
`print(result)` render. See `moirais.fn.describe('sobtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobtst import *
import numpy as np
# See the function signature in fn/sobtst.py for argument names.
```
