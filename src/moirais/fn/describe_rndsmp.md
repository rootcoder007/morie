...
`print(result)` render. See `moirais.fn.describe('rndsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndsmp import *
import numpy as np
# See the function signature in fn/rndsmp.py for argument names.
```
