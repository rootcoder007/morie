...
__all__ = ["bivand2013_chapter_7_unnumbered_202"]


def bivand2013_chapter_7_unnumbered_202(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, family = "SMA", listw = NYlistw, weights = POP8)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u202')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u202: GeneralStatistics expression (auto-extracted; see ref)."
