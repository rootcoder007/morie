# describe('btsubs') — boot_subsampling
...
`print(result)` render. See `moirais.fn.describe('btsubs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsubs import *
import numpy as np
# See the function signature in fn/btsubs.py for argument names.
```
