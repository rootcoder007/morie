...
__all__ = ["hedderich_chapter_9_unnumbered_2704"]


def hedderich_chapter_9_unnumbered_2704(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The test statistic ˆz = ln(ˆω)/ˆσln(ˆω) is approximately standard normally distributed under the null
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2704')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2704: GeneralStatistics expression (auto-extracted; see ref)."
