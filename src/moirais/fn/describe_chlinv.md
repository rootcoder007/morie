...
`print(result)` render. See `moirais.fn.describe('chlinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlinv import *
import numpy as np
# See the function signature in fn/chlinv.py for argument names.
```
