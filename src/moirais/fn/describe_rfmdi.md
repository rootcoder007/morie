# describe('rfmdi') — rf_mdi_importance
...
`print(result)` render. See `moirais.fn.describe('rfmdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfmdi import *
import numpy as np
# See the function signature in fn/rfmdi.py for argument names.
```
