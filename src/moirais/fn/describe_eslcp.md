...
`print(result)` render. See `moirais.fn.describe('eslcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslcp import *
import numpy as np
# See the function signature in fn/eslcp.py for argument names.
```
