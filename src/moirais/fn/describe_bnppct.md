# describe('bnppct') — bnp_percent_quantile
...
`print(result)` render. See `moirais.fn.describe('bnppct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnppct import *
import numpy as np
# See the function signature in fn/bnppct.py for argument names.
```
