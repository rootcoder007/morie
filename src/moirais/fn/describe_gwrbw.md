...
`print(result)` render. See `moirais.fn.describe('gwrbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrbw import *
import numpy as np
# See the function signature in fn/gwrbw.py for argument names.
```
