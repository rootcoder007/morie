...
__all__ = ["wilcox_chapter_10_unnumbered_891"]


def wilcox_chapter_10_unnumbered_891(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] N =K ∑nj =Kn.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u891')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u891: GeneralStatistics expression (auto-extracted; see ref)."
