# describe('stbck') — stability_check
...
`print(result)` render. See `moirais.fn.describe('stbck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stbck import *
import numpy as np
# See the function signature in fn/stbck.py for argument names.
```
