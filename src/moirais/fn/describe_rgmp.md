# describe('rgmp') — rangayyan_matching_pursuit
...
`print(result)` render. See `moirais.fn.describe('rgmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmp import *
import numpy as np
# See the function signature in fn/rgmp.py for argument names.
```
