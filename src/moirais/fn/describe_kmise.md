...
`print(result)` render. See `moirais.fn.describe('kmise')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmise import *
import numpy as np
# See the function signature in fn/kmise.py for argument names.
```
