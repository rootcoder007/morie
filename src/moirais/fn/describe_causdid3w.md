# describe('causdid3w') — causal_did_three_way
...
`print(result)` render. See `moirais.fn.describe('causdid3w')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdid3w import *
import numpy as np
# See the function signature in fn/causdid3w.py for argument names.
```
