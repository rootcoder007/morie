# describe('cb15e4') — cb_chapter_15_equation_4
...
```python
from moirais.fn.cb15e4 import cb_chapter_15_equation_4
import numpy as np
result = cb_chapter_15_equation_4(np.random.default_rng(42).normal(0, 1, 100))
