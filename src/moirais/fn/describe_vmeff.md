...
`print(result)` render. See `moirais.fn.describe('vmeff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmeff import *
import numpy as np
# See the function signature in fn/vmeff.py for argument names.
```
