...
__all__ = ["use_r_chapter_2_unnumbered_113"]


def use_r_chapter_2_unnumbered_113(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u113')`` for the full guide.
...
def cheatsheet():
    return "use_r2u113: GeneralStatistics expression (auto-extracted; see ref)."
