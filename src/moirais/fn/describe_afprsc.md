...
`print(result)` render. See `moirais.fn.describe('afprsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afprsc import *
import numpy as np
# See the function signature in fn/afprsc.py for argument names.
```
