...
`print(result)` render. See `moirais.fn.describe('ghpnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghpnl import *
import numpy as np
# See the function signature in fn/ghpnl.py for argument names.
```
