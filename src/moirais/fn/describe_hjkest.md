# describe('hjkest') — hajek_estimator
...
`print(result)` render. See `moirais.fn.describe('hjkest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hjkest import *
import numpy as np
# See the function signature in fn/hjkest.py for argument names.
```
