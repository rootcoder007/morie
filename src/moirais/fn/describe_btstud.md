# describe('btstud') — boot_studentized_ci
...
`print(result)` render. See `moirais.fn.describe('btstud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btstud import *
import numpy as np
# See the function signature in fn/btstud.py for argument names.
```
