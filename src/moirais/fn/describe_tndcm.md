# describe('tndcm') — tensor_decompose
...
`print(result)` render. See `moirais.fn.describe('tndcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tndcm import *
import numpy as np
# See the function signature in fn/tndcm.py for argument names.
```
