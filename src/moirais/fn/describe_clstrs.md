# describe('clstrs') — cluster_design
...
`print(result)` render. See `moirais.fn.describe('clstrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clstrs import *
import numpy as np
# See the function signature in fn/clstrs.py for argument names.
```
