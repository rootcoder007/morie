...
`print(result)` render. See `moirais.fn.describe('gblpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gblpf import *
import numpy as np
# See the function signature in fn/gblpf.py for argument names.
```
