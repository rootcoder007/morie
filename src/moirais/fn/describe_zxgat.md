# describe('zxgat') — graph_attention_sp
...
`print(result)` render. See `moirais.fn.describe('zxgat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxgat import *
import numpy as np
# See the function signature in fn/zxgat.py for argument names.
```
