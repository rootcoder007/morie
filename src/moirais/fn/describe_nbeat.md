...
`print(result)` render. See `moirais.fn.describe('nbeat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbeat import *
import numpy as np
# See the function signature in fn/nbeat.py for argument names.
```
