# describe('isssb') — issue_subset_extract
...
`print(result)` render. See `moirais.fn.describe('isssb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isssb import *
import numpy as np
# See the function signature in fn/isssb.py for argument names.
```
