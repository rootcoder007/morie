...
`print(result)` render. See `moirais.fn.describe('zsgph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgph import *
import numpy as np
# See the function signature in fn/zsgph.py for argument names.
```
