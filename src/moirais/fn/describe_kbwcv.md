...
`print(result)` render. See `moirais.fn.describe('kbwcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbwcv import *
import numpy as np
# See the function signature in fn/kbwcv.py for argument names.
```
