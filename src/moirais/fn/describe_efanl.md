# describe('efanl') — efa_principal_axis
...
`print(result)` render. See `moirais.fn.describe('efanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.efanl import *
import numpy as np
# See the function signature in fn/efanl.py for argument names.
```
