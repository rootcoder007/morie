# describe('lpcsp') — lpc_spectrum_fn
...
`print(result)` render. See `moirais.fn.describe('lpcsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpcsp import *
import numpy as np
# See the function signature in fn/lpcsp.py for argument names.
```
