# describe('msm134') — mvsml_categorical_count_eq_8_3
...
`print(result)` render. See `moirais.fn.describe('msm134')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm134 import *
import numpy as np
# See the function signature in fn/msm134.py for argument names.
```
