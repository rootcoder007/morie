...
`print(result)` render. See `moirais.fn.describe('svdot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdot import *
import numpy as np
# See the function signature in fn/svdot.py for argument names.
```
