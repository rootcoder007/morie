...
`print(result)` render. See `moirais.fn.describe('fonchm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fonchm import *
import numpy as np
# See the function signature in fn/fonchm.py for argument names.
```
