# describe('vacef') — vaccine_efficacy
...
`print(result)` render. See `moirais.fn.describe('vacef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vacef import *
import numpy as np
# See the function signature in fn/vacef.py for argument names.
```
