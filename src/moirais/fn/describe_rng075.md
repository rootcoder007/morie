# describe('rng075') — rangayyan_ch3_idft_real_imag
...
`print(result)` render. See `moirais.fn.describe('rng075')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng075 import *
import numpy as np
# See the function signature in fn/rng075.py for argument names.
```
