...
`print(result)` render. See `moirais.fn.describe('copod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copod import *
import numpy as np
# See the function signature in fn/copod.py for argument names.
```
