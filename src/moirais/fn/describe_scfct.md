...
`print(result)` render. See `moirais.fn.describe('scfct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scfct import *
import numpy as np
# See the function signature in fn/scfct.py for argument names.
```
