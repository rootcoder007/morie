# describe('hibrid') — hibrid_prediction
...
`print(result)` render. See `moirais.fn.describe('hibrid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hibrid import *
import numpy as np
# See the function signature in fn/hibrid.py for argument names.
```
