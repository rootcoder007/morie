# describe('cstcl') — custody_classification
...
`print(result)` render. See `moirais.fn.describe('cstcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstcl import *
import numpy as np
# See the function signature in fn/cstcl.py for argument names.
```
