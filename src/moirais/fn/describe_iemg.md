# describe('iemg') — integrated_emg_fn
...
`print(result)` render. See `moirais.fn.describe('iemg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iemg import *
import numpy as np
# See the function signature in fn/iemg.py for argument names.
```
