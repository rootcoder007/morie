...
`print(result)` render. See `moirais.fn.describe('wsrkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsrkt import *
import numpy as np
# See the function signature in fn/wsrkt.py for argument names.
```
