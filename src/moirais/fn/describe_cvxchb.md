# describe('cvxchb') — boyd_chebyshev_center
...
`print(result)` render. See `moirais.fn.describe('cvxchb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxchb import *
import numpy as np
# See the function signature in fn/cvxchb.py for argument names.
```
