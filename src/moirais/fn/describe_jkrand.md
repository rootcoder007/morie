# describe('jkrand') — jackknife_repl
...
`print(result)` render. See `moirais.fn.describe('jkrand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jkrand import *
import numpy as np
# See the function signature in fn/jkrand.py for argument names.
```
