...
`print(result)` render. See `moirais.fn.describe('msitr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msitr import *
import numpy as np
# See the function signature in fn/msitr.py for argument names.
```
