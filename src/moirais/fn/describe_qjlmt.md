...
`print(result)` render. See `moirais.fn.describe('qjlmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qjlmt import *
import numpy as np
# See the function signature in fn/qjlmt.py for argument names.
```
