...
__all__ = ["hedderich_chapter_9_unnumbered_2943"]


def hedderich_chapter_9_unnumbered_2943(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( "B ( one − sidedgreater ) =" ,B . plus , " , ( P =" , round ( p . val , 8 ) , " ) \ n " ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2943')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2943: GeneralStatistics expression (auto-extracted; see ref)."
