# describe('locS') — location_scale_estimator
...
`print(result)` render. See `moirais.fn.describe('locS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.locS import *
import numpy as np
# See the function signature in fn/locS.py for argument names.
```
