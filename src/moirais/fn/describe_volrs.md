# describe('volrs') — vol_rogers_satchell
...
`print(result)` render. See `moirais.fn.describe('volrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrs import *
import numpy as np
# See the function signature in fn/volrs.py for argument names.
```
