# describe('zfmech') — z_dp_mechanism
...
`print(result)` render. See `moirais.fn.describe('zfmech')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zfmech import *
import numpy as np
# See the function signature in fn/zfmech.py for argument names.
```
