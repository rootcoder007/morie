...
`print(result)` render. See `moirais.fn.describe('hmswi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmswi import *
import numpy as np
# See the function signature in fn/hmswi.py for argument names.
```
