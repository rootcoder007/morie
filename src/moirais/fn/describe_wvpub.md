# describe('wvpub') — wvpub

## WHAT IT DOES

Public goods power index.
...
`print(result)` render. See `moirais.fn.describe('wvpub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvpub import *
import numpy as np
# See the function signature in fn/wvpub.py for argument names.
```
