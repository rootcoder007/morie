...
__all__ = ["hedderich_chapter_9_unnumbered_2004"]


def hedderich_chapter_9_unnumbered_2004(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: AB = 4 3 . 5 , p− value = 0 . 5 2 0 4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2004')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2004: GeneralStatistics expression (auto-extracted; see ref)."
