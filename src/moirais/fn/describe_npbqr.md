# describe('npbqr') — np_bayes_quant_reg
...
`print(result)` render. See `moirais.fn.describe('npbqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npbqr import *
import numpy as np
# See the function signature in fn/npbqr.py for argument names.
```
