...
`print(result)` render. See `moirais.fn.describe('mscnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscnt import *
import numpy as np
# See the function signature in fn/mscnt.py for argument names.
```
