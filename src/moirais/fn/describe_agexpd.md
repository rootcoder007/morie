# describe('agexpd') — alphazero_expand
...
`print(result)` render. See `moirais.fn.describe('agexpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agexpd import *
import numpy as np
# See the function signature in fn/agexpd.py for argument names.
```
