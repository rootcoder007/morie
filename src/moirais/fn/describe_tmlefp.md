# describe('tmlefp') — tmle_effective_pi
...
`print(result)` render. See `moirais.fn.describe('tmlefp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlefp import *
import numpy as np
# See the function signature in fn/tmlefp.py for argument names.
```
