# describe('toptor') — topological_torsion
...
`print(result)` render. See `moirais.fn.describe('toptor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.toptor import *
import numpy as np
# See the function signature in fn/toptor.py for argument names.
```
