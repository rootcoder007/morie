# describe('pcgxe') — pc_gxe_reduction
...
`print(result)` render. See `moirais.fn.describe('pcgxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcgxe import *
import numpy as np
# See the function signature in fn/pcgxe.py for argument names.
```
