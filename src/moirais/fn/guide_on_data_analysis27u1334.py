...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1334"]


def guide_on_data_analysis_chapter_27_unnumbered_1334(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝐷|𝑍 = 1] − 𝐸[𝐷|𝑍 = 0]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1334')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1334: GeneralStatistics expression (auto-extracted; see ref)."
