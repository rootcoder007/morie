# describe('dbldt') — double_threshold
...
`print(result)` render. See `moirais.fn.describe('dbldt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbldt import *
import numpy as np
# See the function signature in fn/dbldt.py for argument names.
```
