...
`print(result)` render. See `moirais.fn.describe('xrsac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrsac import *
import numpy as np
# See the function signature in fn/xrsac.py for argument names.
```
