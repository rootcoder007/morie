...
`print(result)` render. See `moirais.fn.describe('miexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miexp import *
import numpy as np
# See the function signature in fn/miexp.py for argument names.
```
