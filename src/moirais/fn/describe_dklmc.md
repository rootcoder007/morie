...
`print(result)` render. See `moirais.fn.describe('dklmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dklmc import *
import numpy as np
# See the function signature in fn/dklmc.py for argument names.
```
