...
__all__ = ["bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_613"]


def bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_613(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bookadvanced_elementsofstatisticallearning3u613')`` for the full guide.
...
def cheatsheet():
    return "bookadvanced_elementsofstatisticallearning3u613: GeneralStatistics expression (auto-extracted; see ref)."
