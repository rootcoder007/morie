...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_466"]


def guide_on_data_analysis_chapter_6_unnumbered_466(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ̂𝜃(𝑗+1)= ̂𝜃(𝑗)− 𝛼𝑗 [𝜕2𝑄(̂𝜃(𝑗))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u466')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u466: GeneralStatistics expression (auto-extracted; see ref)."
