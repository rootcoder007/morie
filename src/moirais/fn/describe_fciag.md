...
`print(result)` render. See `moirais.fn.describe('fciag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fciag import *
import numpy as np
# See the function signature in fn/fciag.py for argument names.
```
