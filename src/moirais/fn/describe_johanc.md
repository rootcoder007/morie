# describe('johanc') — johansen_cointegration
...
`print(result)` render. See `moirais.fn.describe('johanc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johanc import *
import numpy as np
# See the function signature in fn/johanc.py for argument names.
```
