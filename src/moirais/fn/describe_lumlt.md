...
`print(result)` render. See `moirais.fn.describe('lumlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lumlt import *
import numpy as np
# See the function signature in fn/lumlt.py for argument names.
```
