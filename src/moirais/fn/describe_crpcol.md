...
`print(result)` render. See `moirais.fn.describe('crpcol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crpcol import *
import numpy as np
# See the function signature in fn/crpcol.py for argument names.
```
