...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_10_equation_24(x):
    """
    Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R.

    Formula: [EQ] 𝑍(𝑥𝑘)=𝛽𝑥 𝑘 +𝜖 𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r10e24')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r10e24: Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R."
