...
`print(result)` render. See `moirais.fn.describe('ptjfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptjfn import *
import numpy as np
# See the function signature in fn/ptjfn.py for argument names.
```
