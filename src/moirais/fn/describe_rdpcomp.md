# describe('rdpcomp') — rdp_subsampled_composition
...
`print(result)` render. See `moirais.fn.describe('rdpcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdpcomp import *
import numpy as np
# See the function signature in fn/rdpcomp.py for argument names.
```
