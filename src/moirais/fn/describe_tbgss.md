...
`print(result)` render. See `moirais.fn.describe('tbgss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbgss import *
import numpy as np
# See the function signature in fn/tbgss.py for argument names.
```
