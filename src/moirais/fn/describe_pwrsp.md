...
`print(result)` render. See `moirais.fn.describe('pwrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwrsp import *
import numpy as np
# See the function signature in fn/pwrsp.py for argument names.
```
