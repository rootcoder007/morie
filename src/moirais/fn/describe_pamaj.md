...
`print(result)` render. See `moirais.fn.describe('pamaj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pamaj import *
import numpy as np
# See the function signature in fn/pamaj.py for argument names.
```
