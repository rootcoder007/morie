# describe('galct') — depletion_model
...
`print(result)` render. See `moirais.fn.describe('galct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.galct import *
import numpy as np
# See the function signature in fn/galct.py for argument names.
```
