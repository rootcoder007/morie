...
`print(result)` render. See `moirais.fn.describe('lmdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmdiag import *
import numpy as np
# See the function signature in fn/lmdiag.py for argument names.
```
