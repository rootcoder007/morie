# describe('dicg') — deviance_information_criterion
...
`print(result)` render. See `moirais.fn.describe('dicg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dicg import *
import numpy as np
# See the function signature in fn/dicg.py for argument names.
```
