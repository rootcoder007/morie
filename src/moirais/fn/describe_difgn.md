...
`print(result)` render. See `moirais.fn.describe('difgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difgn import *
import numpy as np
# See the function signature in fn/difgn.py for argument names.
```
