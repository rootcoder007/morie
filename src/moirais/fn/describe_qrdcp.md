# describe('qrdcp') — qr_decomposition
...
`print(result)` render. See `moirais.fn.describe('qrdcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrdcp import *
import numpy as np
# See the function signature in fn/qrdcp.py for argument names.
```
