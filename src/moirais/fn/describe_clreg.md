...
`print(result)` render. See `moirais.fn.describe('clreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clreg import *
import numpy as np
# See the function signature in fn/clreg.py for argument names.
```
