# describe('vitlrn') — vit_layer_norm
...
`print(result)` render. See `moirais.fn.describe('vitlrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitlrn import *
import numpy as np
# See the function signature in fn/vitlrn.py for argument names.
```
