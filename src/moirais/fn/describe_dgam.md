...
`print(result)` render. See `moirais.fn.describe('dgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dgam import *
import numpy as np
# See the function signature in fn/dgam.py for argument names.
```
