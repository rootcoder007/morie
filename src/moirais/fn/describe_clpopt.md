...
`print(result)` render. See `moirais.fn.describe('clpopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clpopt import *
import numpy as np
# See the function signature in fn/clpopt.py for argument names.
```
