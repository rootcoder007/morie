# describe('grbn') — geron_batch_normalization
...
`print(result)` render. See `moirais.fn.describe('grbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbn import *
import numpy as np
# See the function signature in fn/grbn.py for argument names.
```
