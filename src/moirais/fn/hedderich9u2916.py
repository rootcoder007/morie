...
__all__ = ["hedderich_chapter_9_unnumbered_2916"]


def hedderich_chapter_9_unnumbered_2916(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( Malformation =c ( " yes " , " no " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2916')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2916: GeneralStatistics expression (auto-extracted; see ref)."
