# describe('rgloo') — rangayyan_loo_cv
...
`print(result)` render. See `moirais.fn.describe('rgloo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgloo import *
import numpy as np
# See the function signature in fn/rgloo.py for argument names.
```
