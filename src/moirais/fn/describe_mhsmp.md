# describe('mhsmp') — metropolis_hastings
...
`print(result)` render. See `moirais.fn.describe('mhsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhsmp import *
import numpy as np
# See the function signature in fn/mhsmp.py for argument names.
```
