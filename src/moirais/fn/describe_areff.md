...
`print(result)` render. See `moirais.fn.describe('areff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.areff import *
import numpy as np
# See the function signature in fn/areff.py for argument names.
```
