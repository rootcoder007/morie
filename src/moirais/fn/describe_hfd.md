...
`print(result)` render. See `moirais.fn.describe('hfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hfd import *
import numpy as np
# See the function signature in fn/hfd.py for argument names.
```
