# describe('msm289') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm289')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm289 import *
import numpy as np
# See the function signature in fn/msm289.py for argument names.
```
