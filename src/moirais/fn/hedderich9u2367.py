...
__all__ = ["hedderich_chapter_9_unnumbered_2367"]


def hedderich_chapter_9_unnumbered_2367(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆF = [3(242 + 202 + 282)−722]/(3−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2367')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2367: GeneralStatistics expression (auto-extracted; see ref)."
