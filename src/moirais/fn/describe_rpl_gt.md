# describe('rpl_gt') — rplace_gender_trend
...
`print(result)` render. See `moirais.fn.describe('rpl_gt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_gt import *
import numpy as np
# See the function signature in fn/rpl_gt.py for argument names.
```
