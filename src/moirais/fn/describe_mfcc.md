# describe('mfcc') — mel_cepstral_coeffs
...
`print(result)` render. See `moirais.fn.describe('mfcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mfcc import *
import numpy as np
# See the function signature in fn/mfcc.py for argument names.
```
