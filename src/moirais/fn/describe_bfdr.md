...
`print(result)` render. See `moirais.fn.describe('bfdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfdr import *
import numpy as np
# See the function signature in fn/bfdr.py for argument names.
```
