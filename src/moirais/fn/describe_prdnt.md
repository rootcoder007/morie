# describe('prdnt') — prediction_intervals
...
`print(result)` render. See `moirais.fn.describe('prdnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdnt import *
import numpy as np
# See the function signature in fn/prdnt.py for argument names.
```
