# describe('grbag') — geron_bagging_predictor
...
`print(result)` render. See `moirais.fn.describe('grbag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbag import *
import numpy as np
# See the function signature in fn/grbag.py for argument names.
```
