...
`print(result)` render. See `moirais.fn.describe('hyret')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyret import *
import numpy as np
# See the function signature in fn/hyret.py for argument names.
```
