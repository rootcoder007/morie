...
`print(result)` render. See `moirais.fn.describe('ghcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcov import *
import numpy as np
# See the function signature in fn/ghcov.py for argument names.
```
