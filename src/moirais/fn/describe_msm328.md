# describe('msm328') — mvsml_functional_regression_eq_15_3
...
`print(result)` render. See `moirais.fn.describe('msm328')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm328 import *
import numpy as np
# See the function signature in fn/msm328.py for argument names.
```
