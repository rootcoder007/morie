# describe('grdpml') — geron_ddpm_simple_loss
...
`print(result)` render. See `moirais.fn.describe('grdpml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdpml import *
import numpy as np
# See the function signature in fn/grdpml.py for argument names.
```
