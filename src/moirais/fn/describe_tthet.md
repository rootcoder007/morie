...
`print(result)` render. See `moirais.fn.describe('tthet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tthet import *
import numpy as np
# See the function signature in fn/tthet.py for argument names.
```
