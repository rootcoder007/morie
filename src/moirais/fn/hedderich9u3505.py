...
__all__ = ["hedderich_chapter_9_unnumbered_3505"]


def hedderich_chapter_9_unnumbered_3505(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: WithVar (ϵ) = σ2I denotes
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3505')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3505: ANOVA expression (auto-extracted; see ref)."
