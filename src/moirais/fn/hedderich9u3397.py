...
__all__ = ["hedderich_chapter_9_unnumbered_3397"]


def hedderich_chapter_9_unnumbered_3397(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] AUC =P (ˆp(x)> ˆp(x′)|y(x) = 1 andy(x′) = 0) (8.74)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3397')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3397: GeneralStatistics expression (auto-extracted; see ref)."
