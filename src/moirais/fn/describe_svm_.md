...
`print(result)` render. See `moirais.fn.describe('svm_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svm_ import *
import numpy as np
# See the function signature in fn/svm_.py for argument names.
```
