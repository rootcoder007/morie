...
`print(result)` render. See `moirais.fn.describe('socop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socop import *
import numpy as np
# See the function signature in fn/socop.py for argument names.
```
