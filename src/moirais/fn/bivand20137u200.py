...
__all__ = ["bivand2013_chapter_7_unnumbered_200"]


def bivand2013_chapter_7_unnumbered_200(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: listw = NYlistw, weights = POP8, family = "SAR", method = "Matrix")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u200')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u200: GeneralStatistics expression (auto-extracted; see ref)."
