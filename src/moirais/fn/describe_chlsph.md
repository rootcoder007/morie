...
`print(result)` render. See `moirais.fn.describe('chlsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlsph import *
import numpy as np
# See the function signature in fn/chlsph.py for argument names.
```
