...
`print(result)` render. See `moirais.fn.describe('sym8f')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sym8f import *
import numpy as np
# See the function signature in fn/sym8f.py for argument names.
```
