...
__all__ = ["wilcox_chapter_10_unnumbered_925"]


def wilcox_chapter_10_unnumbered_925(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: number of comparisons is C = 5. If α = 0.05 and the degrees of freedom are 30, the critical
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u925')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u925: GeneralStatistics expression (auto-extracted; see ref)."
