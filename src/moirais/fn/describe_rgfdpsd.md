# describe('rgfdpsd') — rangayyan_fd_psd_slope
...
`print(result)` render. See `moirais.fn.describe('rgfdpsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfdpsd import *
import numpy as np
# See the function signature in fn/rgfdpsd.py for argument names.
```
