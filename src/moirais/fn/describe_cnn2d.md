...
`print(result)` render. See `moirais.fn.describe('cnn2d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnn2d import *
import numpy as np
# See the function signature in fn/cnn2d.py for argument names.
```
