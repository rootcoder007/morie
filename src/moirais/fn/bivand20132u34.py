...
__all__ = ["bivand2013_chapter_2_unnumbered_34"]


def bivand2013_chapter_2_unnumbered_34(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dataset_options = "GPX_USE_EXTENSIONS=YES")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u34')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u34: GeneralStatistics expression (auto-extracted; see ref)."
