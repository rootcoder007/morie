...
`print(result)` render. See `moirais.fn.describe('irttf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irttf import *
import numpy as np
# See the function signature in fn/irttf.py for argument names.
```
