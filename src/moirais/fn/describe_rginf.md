# describe('rginf') — rangayyan_infomax_ica
...
`print(result)` render. See `moirais.fn.describe('rginf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rginf import *
import numpy as np
# See the function signature in fn/rginf.py for argument names.
```
