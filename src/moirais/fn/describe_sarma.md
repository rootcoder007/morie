...
`print(result)` render. See `moirais.fn.describe('sarma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarma import *
import numpy as np
# See the function signature in fn/sarma.py for argument names.
```
