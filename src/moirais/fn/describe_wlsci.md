...
`print(result)` render. See `moirais.fn.describe('wlsci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlsci import *
import numpy as np
# See the function signature in fn/wlsci.py for argument names.
```
