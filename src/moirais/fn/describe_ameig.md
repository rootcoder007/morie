...
`print(result)` render. See `moirais.fn.describe('ameig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ameig import *
import numpy as np
# See the function signature in fn/ameig.py for argument names.
```
