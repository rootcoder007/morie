# describe('hmeg') — geron_epsilon_greedy
...
`print(result)` render. See `moirais.fn.describe('hmeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmeg import *
import numpy as np
# See the function signature in fn/hmeg.py for argument names.
```
