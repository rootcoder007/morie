# describe('smrest') — standardized_mortality_ratio
...
`print(result)` render. See `moirais.fn.describe('smrest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smrest import *
import numpy as np
# See the function signature in fn/smrest.py for argument names.
```
