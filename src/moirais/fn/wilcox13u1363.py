...
__all__ = ["wilcox_chapter_13_unnumbered_1363"]


def wilcox_chapter_13_unnumbered_1363(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (d) 1/6. 17. y × (1/60) = 0 .8, y = 48. 18. (a) 0.0668, (b) 0.0062, (c) 0.0062, (d) 0.683. 19.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1363')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1363: GeneralStatistics expression (auto-extracted; see ref)."
