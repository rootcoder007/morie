...
`print(result)` render. See `moirais.fn.describe('fabdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fabdt import *
import numpy as np
# See the function signature in fn/fabdt.py for argument names.
```
