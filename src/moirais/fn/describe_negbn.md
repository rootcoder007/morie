# describe('negbn') — negative_binomial_reg

## WHAT IT DOES

Negative binomial regression. 'We are what we repeatedly do. Excellence is a habit. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('negbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.negbn import *
import numpy as np
# See the function signature in fn/negbn.py for argument names.
```
