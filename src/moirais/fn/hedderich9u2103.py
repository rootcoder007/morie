...
__all__ = ["hedderich_chapter_9_unnumbered_2103"]


def hedderich_chapter_9_unnumbered_2103(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 1.91< 4.30 = t2;0.975
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2103')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2103: GeneralStatistics expression (auto-extracted; see ref)."
