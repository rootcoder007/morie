# describe('phrx') — prescription_patterns
...
`print(result)` render. See `moirais.fn.describe('phrx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phrx import *
import numpy as np
# See the function signature in fn/phrx.py for argument names.
```
