...
__all__ = ["hedderich_chapter_9_unnumbered_1411"]


def hedderich_chapter_9_unnumbered_1411(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 95%-CI: 0.103≤σy.x≤0.194.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1411')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1411: GeneralStatistics expression (auto-extracted; see ref)."
