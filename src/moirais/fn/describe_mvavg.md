...
`print(result)` render. See `moirais.fn.describe('mvavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvavg import *
import numpy as np
# See the function signature in fn/mvavg.py for argument names.
```
