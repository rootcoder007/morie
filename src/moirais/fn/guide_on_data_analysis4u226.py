...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_226"]


def guide_on_data_analysis_chapter_4_unnumbered_226(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐶𝑀𝐻 = (∑𝑘 (𝑂𝑘 − 𝐸𝑘))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u226')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u226: GeneralStatistics expression (auto-extracted; see ref)."
