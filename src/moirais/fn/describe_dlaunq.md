...
`print(result)` render. See `moirais.fn.describe('dlaunq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlaunq import *
import numpy as np
# See the function signature in fn/dlaunq.py for argument names.
```
