...
`print(result)` render. See `moirais.fn.describe('gppred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gppred import *
import numpy as np
# See the function signature in fn/gppred.py for argument names.
```
