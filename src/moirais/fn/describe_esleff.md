# describe('esleff') — esl_effective_dof
...
`print(result)` render. See `moirais.fn.describe('esleff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esleff import *
import numpy as np
# See the function signature in fn/esleff.py for argument names.
```
