# describe('zxdps') — dirichlet_proc_sp
...
`print(result)` render. See `moirais.fn.describe('zxdps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxdps import *
import numpy as np
# See the function signature in fn/zxdps.py for argument names.
```
