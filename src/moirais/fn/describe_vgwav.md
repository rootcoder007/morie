...
`print(result)` render. See `moirais.fn.describe('vgwav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgwav import *
import numpy as np
# See the function signature in fn/vgwav.py for argument names.
```
