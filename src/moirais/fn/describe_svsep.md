...
`print(result)` render. See `moirais.fn.describe('svsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsep import *
import numpy as np
# See the function signature in fn/svsep.py for argument names.
```
