...
__all__ = ["hedderich_chapter_9_unnumbered_157"]


def hedderich_chapter_9_unnumbered_157(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Q3 =x(m) with m =⌊(n + 1)·0.75⌋
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u157')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u157: GeneralStatistics expression (auto-extracted; see ref)."
