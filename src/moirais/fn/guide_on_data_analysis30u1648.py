...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1648"]


def guide_on_data_analysis_chapter_30_unnumbered_1648(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] mutate(y = if_else(y > 0, y, 0))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1648')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1648: GeneralStatistics expression (auto-extracted; see ref)."
