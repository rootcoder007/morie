...
__all__ = ["bivand2013_chapter_7_unnumbered_106"]


def bivand2013_chapter_7_unnumbered_106(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = spasthma[spasthma$Gender = = 1 | spasthma$Gender ==
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u106')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u106: GeneralStatistics expression (auto-extracted; see ref)."
