...
__all__ = ["wilcox_chapter_8_unnumbered_845"]


def wilcox_chapter_8_unnumbered_845(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: For the rabbit data, MSB = 2787 .5/2 = 1393 .75, MSE = 6395 .83/22 = 290 .72, so
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u845')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u845: PowerAndDesign expression (auto-extracted; see ref)."
