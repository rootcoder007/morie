...
`print(result)` render. See `moirais.fn.describe('vmcub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcub import *
import numpy as np
# See the function signature in fn/vmcub.py for argument names.
```
