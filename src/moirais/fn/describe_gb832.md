# describe('gb832') — gibbons_vdw_test
...
`print(result)` render. See `moirais.fn.describe('gb832')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb832 import *
import numpy as np
# See the function signature in fn/gb832.py for argument names.
```
