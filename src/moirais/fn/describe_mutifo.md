# describe('mutifo') — mutual_information
...
`print(result)` render. See `moirais.fn.describe('mutifo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mutifo import *
import numpy as np
# See the function signature in fn/mutifo.py for argument names.
```
