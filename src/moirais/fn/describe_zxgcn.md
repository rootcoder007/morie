...
`print(result)` render. See `moirais.fn.describe('zxgcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxgcn import *
import numpy as np
# See the function signature in fn/zxgcn.py for argument names.
```
