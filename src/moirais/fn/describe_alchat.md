# describe('alchat') — alammar_chat_template
...
`print(result)` render. See `moirais.fn.describe('alchat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alchat import *
import numpy as np
# See the function signature in fn/alchat.py for argument names.
```
