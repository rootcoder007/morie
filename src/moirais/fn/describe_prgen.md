# describe('prgen') — program_enrollment
...
`print(result)` render. See `moirais.fn.describe('prgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgen import *
import numpy as np
# See the function signature in fn/prgen.py for argument names.
```
