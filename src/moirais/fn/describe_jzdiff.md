# describe('jzdiff') — jenson_zhang_disparity
...
`print(result)` render. See `moirais.fn.describe('jzdiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jzdiff import *
import numpy as np
# See the function signature in fn/jzdiff.py for argument names.
```
