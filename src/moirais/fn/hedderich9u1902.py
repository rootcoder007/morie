...
__all__ = ["hedderich_chapter_9_unnumbered_1902"]


def hedderich_chapter_9_unnumbered_1902(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H0 :λ=λ0 against HA :λ=λA >λ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1902')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1902: CountModels expression (auto-extracted; see ref)."
