# describe('fzb5t') — fauzi_b5_coefficient_mrl
...
`print(result)` render. See `moirais.fn.describe('fzb5t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzb5t import *
import numpy as np
# See the function signature in fn/fzb5t.py for argument names.
```
