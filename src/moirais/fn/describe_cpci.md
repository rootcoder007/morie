...
`print(result)` render. See `moirais.fn.describe('cpci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpci import *
import numpy as np
# See the function signature in fn/cpci.py for argument names.
```
