# describe('ghwav') — ghosal_wavelet_prior
...
`print(result)` render. See `moirais.fn.describe('ghwav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghwav import *
import numpy as np
# See the function signature in fn/ghwav.py for argument names.
```
