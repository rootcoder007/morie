...
`print(result)` render. See `moirais.fn.describe('xentc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xentc import *
import numpy as np
# See the function signature in fn/xentc.py for argument names.
```
