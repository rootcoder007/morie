# describe('gh_c12_8') — ghosal_cox_bvm_sp
...
`print(result)` render. See `moirais.fn.describe('gh_c12_8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_8 import *
import numpy as np
# See the function signature in fn/gh_c12_8.py for argument names.
```
