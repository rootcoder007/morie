...
`print(result)` render. See `moirais.fn.describe('prsiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsiv import *
import numpy as np
# See the function signature in fn/prsiv.py for argument names.
```
