# describe('shrpd') — shepard_diagram
...
`print(result)` render. See `moirais.fn.describe('shrpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrpd import *
import numpy as np
# See the function signature in fn/shrpd.py for argument names.
```
