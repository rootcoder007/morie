# describe('lyapn') — lyapunov_stability
...
`print(result)` render. See `moirais.fn.describe('lyapn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lyapn import *
import numpy as np
# See the function signature in fn/lyapn.py for argument names.
```
