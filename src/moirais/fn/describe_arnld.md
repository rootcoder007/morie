...
`print(result)` render. See `moirais.fn.describe('arnld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arnld import *
import numpy as np
# See the function signature in fn/arnld.py for argument names.
```
