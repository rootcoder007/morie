...
`print(result)` render. See `moirais.fn.describe('rankt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rankt import *
import numpy as np
# See the function signature in fn/rankt.py for argument names.
```
