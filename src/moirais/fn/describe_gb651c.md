# describe('gb651c') — gibbons_ctrl_median_curtail
...
`print(result)` render. See `moirais.fn.describe('gb651c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb651c import *
import numpy as np
# See the function signature in fn/gb651c.py for argument names.
```
