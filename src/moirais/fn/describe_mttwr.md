...
`print(result)` render. See `moirais.fn.describe('mttwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mttwr import *
import numpy as np
# See the function signature in fn/mttwr.py for argument names.
```
