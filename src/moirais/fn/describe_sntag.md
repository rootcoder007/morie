# describe('sntag') — sentence_by_age
...
`print(result)` render. See `moirais.fn.describe('sntag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntag import *
import numpy as np
# See the function signature in fn/sntag.py for argument names.
```
