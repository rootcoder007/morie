# describe('rng235') — rangayyan_ch4_complex_log_of_product
...
`print(result)` render. See `moirais.fn.describe('rng235')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng235 import *
import numpy as np
# See the function signature in fn/rng235.py for argument names.
```
