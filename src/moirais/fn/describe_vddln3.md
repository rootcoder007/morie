...
`print(result)` render. See `moirais.fn.describe('vddln3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vddln3 import *
import numpy as np
# See the function signature in fn/vddln3.py for argument names.
```
