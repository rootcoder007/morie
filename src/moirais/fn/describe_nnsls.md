...
`print(result)` render. See `moirais.fn.describe('nnsls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnsls import *
import numpy as np
# See the function signature in fn/nnsls.py for argument names.
```
