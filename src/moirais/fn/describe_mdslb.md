# describe('mdslb') — label_mds_points
...
`print(result)` render. See `moirais.fn.describe('mdslb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdslb import *
import numpy as np
# See the function signature in fn/mdslb.py for argument names.
```
