# describe('kngpn') — crime_network_centrality
...
`print(result)` render. See `moirais.fn.describe('kngpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kngpn import *
import numpy as np
# See the function signature in fn/kngpn.py for argument names.
```
