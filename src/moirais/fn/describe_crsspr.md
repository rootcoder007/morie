...
`print(result)` render. See `moirais.fn.describe('crsspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsspr import *
import numpy as np
# See the function signature in fn/crsspr.py for argument names.
```
