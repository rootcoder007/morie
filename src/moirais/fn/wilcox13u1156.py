...
__all__ = ["wilcox_chapter_13_unnumbered_1156"]


def wilcox_chapter_13_unnumbered_1156(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] fy(Y ) = f1(X1) + · · · +fp(Xp) +e
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1156')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1156: GeneralStatistics expression (auto-extracted; see ref)."
