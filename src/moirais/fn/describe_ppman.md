...
`print(result)` render. See `moirais.fn.describe('ppman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppman import *
import numpy as np
# See the function signature in fn/ppman.py for argument names.
```
