...
__all__ = ["hedderich_chapter_9_unnumbered_1058"]


def hedderich_chapter_9_unnumbered_1058(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1058')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1058: GeneralStatistics expression (auto-extracted; see ref)."
