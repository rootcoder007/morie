# describe('fzt59') — fauzi_thm5_9_edgeworth_wilcoxon
...
`print(result)` render. See `moirais.fn.describe('fzt59')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt59 import *
import numpy as np
# See the function signature in fn/fzt59.py for argument names.
```
