...
__all__ = ["hedderich_chapter_9_unnumbered_2485"]


def hedderich_chapter_9_unnumbered_2485(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz1 = (12.5−6.4)/2.883 = 2.12<2.24
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2485')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2485: GeneralStatistics expression (auto-extracted; see ref)."
