# describe('cstgp') — custody_gender_parity
...
`print(result)` render. See `moirais.fn.describe('cstgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstgp import *
import numpy as np
# See the function signature in fn/cstgp.py for argument names.
```
