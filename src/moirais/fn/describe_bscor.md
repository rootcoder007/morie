# describe('bscor') — baseline_corrected_correlation
...
`print(result)` render. See `moirais.fn.describe('bscor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bscor import *
import numpy as np
# See the function signature in fn/bscor.py for argument names.
```
