# describe('nemed') — nested_counterfactual_mediation
...
`print(result)` render. See `moirais.fn.describe('nemed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nemed import *
import numpy as np
# See the function signature in fn/nemed.py for argument names.
```
