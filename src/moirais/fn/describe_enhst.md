...
`print(result)` render. See `moirais.fn.describe('enhst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enhst import *
import numpy as np
# See the function signature in fn/enhst.py for argument names.
```
