# describe('gh_c6_15') — ghosal_martg_consist
...
`print(result)` render. See `moirais.fn.describe('gh_c6_15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c6_15 import *
import numpy as np
# See the function signature in fn/gh_c6_15.py for argument names.
```
