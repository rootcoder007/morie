...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1266"]


def guide_on_data_analysis_chapter_25_unnumbered_1266(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1266')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1266: GeneralStatistics expression (auto-extracted; see ref)."
