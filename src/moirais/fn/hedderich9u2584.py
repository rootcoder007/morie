...
__all__ = ["hedderich_chapter_9_unnumbered_2584"]


def hedderich_chapter_9_unnumbered_2584(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: question:π1 >πorπ1 <π).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2584')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2584: Resampling expression (auto-extracted; see ref)."
