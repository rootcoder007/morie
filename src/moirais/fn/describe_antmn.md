# describe('antmn') — allometric_regression
...
`print(result)` render. See `moirais.fn.describe('antmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.antmn import *
import numpy as np
# See the function signature in fn/antmn.py for argument names.
```
