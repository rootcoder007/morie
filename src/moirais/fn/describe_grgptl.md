# describe('grgptl') — geron_gpt_autoregressive_loss
...
`print(result)` render. See `moirais.fn.describe('grgptl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgptl import *
import numpy as np
# See the function signature in fn/grgptl.py for argument names.
```
