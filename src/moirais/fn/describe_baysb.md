...
`print(result)` render. See `moirais.fn.describe('baysb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysb import *
import numpy as np
# See the function signature in fn/baysb.py for argument names.
```
