...
`print(result)` render. See `moirais.fn.describe('idwlcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwlcl import *
import numpy as np
# See the function signature in fn/idwlcl.py for argument names.
```
