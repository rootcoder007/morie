# describe('aniso') — anisotropy_test
...
`print(result)` render. See `moirais.fn.describe('aniso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aniso import *
import numpy as np
# See the function signature in fn/aniso.py for argument names.
```
