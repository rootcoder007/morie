# describe('grn024') — geron_ch4_cross_entropy_gradient_vector
...
`print(result)` render. See `moirais.fn.describe('grn024')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grn024 import *
import numpy as np
# See the function signature in fn/grn024.py for argument names.
```
