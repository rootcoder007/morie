...
__all__ = ["hedderich_chapter_9_unnumbered_14"]


def hedderich_chapter_9_unnumbered_14(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u14')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u14: GeneralStatistics expression (auto-extracted; see ref)."
