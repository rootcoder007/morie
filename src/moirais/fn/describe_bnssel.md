# describe('bnssel') — bound_selection
...
`print(result)` render. See `moirais.fn.describe('bnssel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnssel import *
import numpy as np
# See the function signature in fn/bnssel.py for argument names.
```
