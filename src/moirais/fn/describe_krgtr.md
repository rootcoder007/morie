...
`print(result)` render. See `moirais.fn.describe('krgtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgtr import *
import numpy as np
# See the function signature in fn/krgtr.py for argument names.
```
