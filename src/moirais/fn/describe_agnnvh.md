# describe('agnnvh') — alphazero_value_head
...
`print(result)` render. See `moirais.fn.describe('agnnvh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agnnvh import *
import numpy as np
# See the function signature in fn/agnnvh.py for argument names.
```
