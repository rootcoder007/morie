# describe('nmrca') — roll_call_agree
...
`print(result)` render. See `moirais.fn.describe('nmrca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmrca import *
import numpy as np
# See the function signature in fn/nmrca.py for argument names.
```
