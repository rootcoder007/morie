...
`print(result)` render. See `moirais.fn.describe('nmoc2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmoc2 import *
import numpy as np
# See the function signature in fn/nmoc2.py for argument names.
```
