...
`print(result)` render. See `moirais.fn.describe('glmft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmft import *
import numpy as np
# See the function signature in fn/glmft.py for argument names.
```
