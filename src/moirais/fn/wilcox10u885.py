...
__all__ = ["wilcox_chapter_10_unnumbered_885"]


def wilcox_chapter_10_unnumbered_885(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: for level two of Factor A let Di2 = Xi21 − Xi22, i = 1,...,n 2, and let θ d1 and θ d2 be the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u885')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u885: GeneralStatistics expression (auto-extracted; see ref)."
