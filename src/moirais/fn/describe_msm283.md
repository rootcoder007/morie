# describe('msm283') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm283')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm283 import *
import numpy as np
# See the function signature in fn/msm283.py for argument names.
```
