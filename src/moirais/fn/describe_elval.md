...
`print(result)` render. See `moirais.fn.describe('elval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elval import *
import numpy as np
# See the function signature in fn/elval.py for argument names.
```
