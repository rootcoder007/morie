...
__all__ = ["hedderich_chapter_9_unnumbered_2953"]


def hedderich_chapter_9_unnumbered_2953(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X =i, Y =j) = e−λij
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2953')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2953: CountModels expression (auto-extracted; see ref)."
