...
`print(result)` render. See `moirais.fn.describe('crsfmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsfmr import *
import numpy as np
# See the function signature in fn/crsfmr.py for argument names.
```
