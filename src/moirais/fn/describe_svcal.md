...
`print(result)` render. See `moirais.fn.describe('svcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcal import *
import numpy as np
# See the function signature in fn/svcal.py for argument names.
```
