# describe('plcmt') — rank_placements
...
`print(result)` render. See `moirais.fn.describe('plcmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcmt import *
import numpy as np
# See the function signature in fn/plcmt.py for argument names.
```
