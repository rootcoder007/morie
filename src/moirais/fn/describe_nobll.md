# describe('nobll') — nominate_bill_params
...
`print(result)` render. See `moirais.fn.describe('nobll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nobll import *
import numpy as np
# See the function signature in fn/nobll.py for argument names.
```
