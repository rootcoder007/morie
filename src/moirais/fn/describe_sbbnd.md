...
`print(result)` render. See `moirais.fn.describe('sbbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbbnd import *
import numpy as np
# See the function signature in fn/sbbnd.py for argument names.
```
