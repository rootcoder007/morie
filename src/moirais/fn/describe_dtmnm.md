...
`print(result)` render. See `moirais.fn.describe('dtmnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmnm import *
import numpy as np
# See the function signature in fn/dtmnm.py for argument names.
```
