...
`print(result)` render. See `moirais.fn.describe('sedrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sedrv import *
import numpy as np
# See the function signature in fn/sedrv.py for argument names.
```
