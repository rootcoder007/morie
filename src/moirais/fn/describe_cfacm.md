...
`print(result)` render. See `moirais.fn.describe('cfacm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfacm import *
import numpy as np
# See the function signature in fn/cfacm.py for argument names.
```
