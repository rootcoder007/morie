# describe('jopql') — joseph_pinball_quantile_loss
...
`print(result)` render. See `moirais.fn.describe('jopql')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jopql import *
import numpy as np
# See the function signature in fn/jopql.py for argument names.
```
