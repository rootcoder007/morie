...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_404"]


def guide_on_data_analysis_chapter_5_unnumbered_404(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = ￿ + E(X′￿−1X′￿−1￿|X)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u404')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u404: GeneralStatistics expression (auto-extracted; see ref)."
