...
`print(result)` render. See `moirais.fn.describe('dtxpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtxpl import *
import numpy as np
# See the function signature in fn/dtxpl.py for argument names.
```
