# describe('shscl') — scaled_schoenfeld_residual
...
`print(result)` render. See `moirais.fn.describe('shscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shscl import *
import numpy as np
# See the function signature in fn/shscl.py for argument names.
```
