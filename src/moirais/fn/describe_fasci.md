...
`print(result)` render. See `moirais.fn.describe('fasci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fasci import *
import numpy as np
# See the function signature in fn/fasci.py for argument names.
```
