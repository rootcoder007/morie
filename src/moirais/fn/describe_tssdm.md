...
`print(result)` render. See `moirais.fn.describe('tssdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssdm import *
import numpy as np
# See the function signature in fn/tssdm.py for argument names.
```
