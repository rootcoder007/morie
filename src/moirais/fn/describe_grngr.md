...
`print(result)` render. See `moirais.fn.describe('grngr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grngr import *
import numpy as np
# See the function signature in fn/grngr.py for argument names.
```
