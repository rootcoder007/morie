# describe('volaprch') — vol_aparch_fit
...
`print(result)` render. See `moirais.fn.describe('volaprch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volaprch import *
import numpy as np
# See the function signature in fn/volaprch.py for argument names.
```
