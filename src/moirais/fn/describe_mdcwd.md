...
`print(result)` render. See `moirais.fn.describe('mdcwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdcwd import *
import numpy as np
# See the function signature in fn/mdcwd.py for argument names.
```
