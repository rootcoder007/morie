# describe('spflm') — spectral_flatness
...
`print(result)` render. See `moirais.fn.describe('spflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spflm import *
import numpy as np
# See the function signature in fn/spflm.py for argument names.
```
