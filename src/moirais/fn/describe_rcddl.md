...
`print(result)` render. See `moirais.fn.describe('rcddl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcddl import *
import numpy as np
# See the function signature in fn/rcddl.py for argument names.
```
