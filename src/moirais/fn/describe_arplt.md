# describe('arplt') — plot_ar_poles_fn
...
`print(result)` render. See `moirais.fn.describe('arplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arplt import *
import numpy as np
# See the function signature in fn/arplt.py for argument names.
```
