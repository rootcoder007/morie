# describe('hergp') — herg_inhibition
...
`print(result)` render. See `moirais.fn.describe('hergp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hergp import *
import numpy as np
# See the function signature in fn/hergp.py for argument names.
```
