...
`print(result)` render. See `moirais.fn.describe('rprat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rprat import *
import numpy as np
# See the function signature in fn/rprat.py for argument names.
```
