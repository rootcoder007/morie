# describe('otwsg') — ot_wasserstein_gauss
...
`print(result)` render. See `moirais.fn.describe('otwsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otwsg import *
import numpy as np
# See the function signature in fn/otwsg.py for argument names.
```
