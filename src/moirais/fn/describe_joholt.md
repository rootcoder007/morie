# describe('joholt') — joseph_holt_linear
...
`print(result)` render. See `moirais.fn.describe('joholt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joholt import *
import numpy as np
# See the function signature in fn/joholt.py for argument names.
```
