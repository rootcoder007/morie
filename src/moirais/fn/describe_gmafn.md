# describe('gmafn') — gemma_function_call
...
`print(result)` render. See `moirais.fn.describe('gmafn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmafn import *
import numpy as np
# See the function signature in fn/gmafn.py for argument names.
```
