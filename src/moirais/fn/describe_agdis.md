...
`print(result)` render. See `moirais.fn.describe('agdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdis import *
import numpy as np
# See the function signature in fn/agdis.py for argument names.
```
