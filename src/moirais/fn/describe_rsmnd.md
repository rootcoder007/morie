...
`print(result)` render. See `moirais.fn.describe('rsmnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmnd import *
import numpy as np
# See the function signature in fn/rsmnd.py for argument names.
```
