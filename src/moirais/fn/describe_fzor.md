...
`print(result)` render. See `moirais.fn.describe('fzor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzor import *
import numpy as np
# See the function signature in fn/fzor.py for argument names.
```
