...
__all__ = ["wilcox_chapter_14_unnumbered_629"]


def wilcox_chapter_14_unnumbered_629(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: greater than or equal to X(n−g )j, set Yij =X(n−g )j. Let
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u629')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u629: GeneralStatistics expression (auto-extracted; see ref)."
