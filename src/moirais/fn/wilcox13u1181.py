...
__all__ = ["wilcox_chapter_13_unnumbered_1181"]


def wilcox_chapter_13_unnumbered_1181(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: c = 2.09 − 5.596√ n .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1181')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1181: Resampling expression (auto-extracted; see ref)."
