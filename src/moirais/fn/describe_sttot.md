# describe('sttot') — subscale_total_corr
...
`print(result)` render. See `moirais.fn.describe('sttot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sttot import *
import numpy as np
# See the function signature in fn/sttot.py for argument names.
```
