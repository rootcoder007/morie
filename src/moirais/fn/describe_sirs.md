...
`print(result)` render. See `moirais.fn.describe('sirs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirs import *
import numpy as np
# See the function signature in fn/sirs.py for argument names.
```
