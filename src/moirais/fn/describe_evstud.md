# describe('evstud') — event_study_coefficients
...
`print(result)` render. See `moirais.fn.describe('evstud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evstud import *
import numpy as np
# See the function signature in fn/evstud.py for argument names.
```
