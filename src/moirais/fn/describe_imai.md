# describe('imai') — imai_keele_yamamoto_mediation
...
`print(result)` render. See `moirais.fn.describe('imai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imai import *
import numpy as np
# See the function signature in fn/imai.py for argument names.
```
