# describe('otmnge') — ot_marginal_negent
...
`print(result)` render. See `moirais.fn.describe('otmnge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmnge import *
import numpy as np
# See the function signature in fn/otmnge.py for argument names.
```
