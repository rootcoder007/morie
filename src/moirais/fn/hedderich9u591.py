...
__all__ = ["hedderich_chapter_9_unnumbered_591"]


def hedderich_chapter_9_unnumbered_591(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u591')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u591: PowerAndDesign expression (auto-extracted; see ref)."
