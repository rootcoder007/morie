...
`print(result)` render. See `moirais.fn.describe('pgdsdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgdsdg import *
import numpy as np
# See the function signature in fn/pgdsdg.py for argument names.
```
