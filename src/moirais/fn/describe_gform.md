...
`print(result)` render. See `moirais.fn.describe('gform')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gform import *
import numpy as np
# See the function signature in fn/gform.py for argument names.
```
