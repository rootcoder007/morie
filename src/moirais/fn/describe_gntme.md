# describe('gntme') — generation_time
...
`print(result)` render. See `moirais.fn.describe('gntme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gntme import *
import numpy as np
# See the function signature in fn/gntme.py for argument names.
```
