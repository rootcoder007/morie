...
`print(result)` render. See `moirais.fn.describe('svcut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcut import *
import numpy as np
# See the function signature in fn/svcut.py for argument names.
```
