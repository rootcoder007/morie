# describe('gb_md2') — gibbons_median_test_2sided
...
`print(result)` render. See `moirais.fn.describe('gb_md2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_md2 import *
import numpy as np
# See the function signature in fn/gb_md2.py for argument names.
```
