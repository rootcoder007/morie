...
`print(result)` render. See `moirais.fn.describe('sdmcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmcf import *
import numpy as np
# See the function signature in fn/sdmcf.py for argument names.
```
