...
`print(result)` render. See `moirais.fn.describe('hrvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvar import *
import numpy as np
# See the function signature in fn/hrvar.py for argument names.
```
