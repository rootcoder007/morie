# describe('rkmeans') — trimmed_kmeans
...
`print(result)` render. See `moirais.fn.describe('rkmeans')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkmeans import *
import numpy as np
# See the function signature in fn/rkmeans.py for argument names.
```
