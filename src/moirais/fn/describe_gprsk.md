# describe('gprsk') — gp_residual_kernel
...
`print(result)` render. See `moirais.fn.describe('gprsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gprsk import *
import numpy as np
# See the function signature in fn/gprsk.py for argument names.
```
