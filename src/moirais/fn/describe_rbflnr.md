...
`print(result)` render. See `moirais.fn.describe('rbflnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbflnr import *
import numpy as np
# See the function signature in fn/rbflnr.py for argument names.
```
