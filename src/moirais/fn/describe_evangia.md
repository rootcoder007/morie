# describe('evangia') — evt_angular_measure
...
`print(result)` render. See `moirais.fn.describe('evangia')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evangia import *
import numpy as np
# See the function signature in fn/evangia.py for argument names.
```
