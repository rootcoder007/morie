...
`print(result)` render. See `moirais.fn.describe('s_er')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.s_er import *
import numpy as np
# See the function signature in fn/s_er.py for argument names.
```
