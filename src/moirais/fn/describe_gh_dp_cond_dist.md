# describe('gh_dp_cond_dist') — ghosal_dp_conditional_distribution
...
`print(result)` render. See `moirais.fn.describe('gh_dp_cond_dist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_dp_cond_dist import *
import numpy as np
# See the function signature in fn/gh_dp_cond_dist.py for argument names.
```
