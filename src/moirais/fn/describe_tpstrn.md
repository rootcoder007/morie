# describe('tpstrn') — tps_crime_trend
...
`print(result)` render. See `moirais.fn.describe('tpstrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpstrn import *
import numpy as np
# See the function signature in fn/tpstrn.py for argument names.
```
