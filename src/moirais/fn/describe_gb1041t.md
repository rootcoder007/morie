# describe('gb1041t') — gibbons_kw_ties
...
`print(result)` render. See `moirais.fn.describe('gb1041t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1041t import *
import numpy as np
# See the function signature in fn/gb1041t.py for argument names.
```
