...
`print(result)` render. See `moirais.fn.describe('sobolI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobolI import *
import numpy as np
# See the function signature in fn/sobolI.py for argument names.
```
