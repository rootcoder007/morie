...
`print(result)` render. See `moirais.fn.describe('hmblip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmblip import *
import numpy as np
# See the function signature in fn/hmblip.py for argument names.
```
