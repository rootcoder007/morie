# describe('svipa') — ideal_point_adapt

## WHAT IT DOES

Adaptive ideal point estimation
...
`print(result)` render. See `moirais.fn.describe('svipa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipa import *
import numpy as np
# See the function signature in fn/svipa.py for argument names.
```
