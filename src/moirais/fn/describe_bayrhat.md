...
`print(result)` render. See `moirais.fn.describe('bayrhat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayrhat import *
import numpy as np
# See the function signature in fn/bayrhat.py for argument names.
```
