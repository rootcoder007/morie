...
__all__ = ["wilcox_chapter_2_unnumbered_291"]


def wilcox_chapter_2_unnumbered_291(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • ForH0:µ =µ 0, reject if T ≥ c orT ≤ − c, where nowc is the 1 − α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u291')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u291: GeneralStatistics expression (auto-extracted; see ref)."
