# describe('facto') — factorial_design
...
`print(result)` render. See `moirais.fn.describe('facto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.facto import *
import numpy as np
# See the function signature in fn/facto.py for argument names.
```
