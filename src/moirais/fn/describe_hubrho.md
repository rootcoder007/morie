...
`print(result)` render. See `moirais.fn.describe('hubrho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubrho import *
import numpy as np
# See the function signature in fn/hubrho.py for argument names.
```
