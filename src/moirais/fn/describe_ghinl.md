...
`print(result)` render. See `moirais.fn.describe('ghinl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghinl import *
import numpy as np
# See the function signature in fn/ghinl.py for argument names.
```
