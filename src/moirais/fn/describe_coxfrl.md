...
`print(result)` render. See `moirais.fn.describe('coxfrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxfrl import *
import numpy as np
# See the function signature in fn/coxfrl.py for argument names.
```
