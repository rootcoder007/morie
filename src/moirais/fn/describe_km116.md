# describe('km116') — kamath_ch8_brevity_penalty
...
`print(result)` render. See `moirais.fn.describe('km116')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km116 import *
import numpy as np
# See the function signature in fn/km116.py for argument names.
```
