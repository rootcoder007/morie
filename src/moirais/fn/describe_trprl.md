# describe('trprl') — trapezoidal_integrate
...
`print(result)` render. See `moirais.fn.describe('trprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trprl import *
import numpy as np
# See the function signature in fn/trprl.py for argument names.
```
