...
__all__ = ["wilcox_chapter_10_unnumbered_940"]


def wilcox_chapter_10_unnumbered_940(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [1] ≤ α 1, where α 1 is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u940')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u940: GeneralStatistics expression (auto-extracted; see ref)."
