# describe('csttm') — custody_time_served
...
`print(result)` render. See `moirais.fn.describe('csttm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csttm import *
import numpy as np
# See the function signature in fn/csttm.py for argument names.
```
