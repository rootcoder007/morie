# describe('calpl') — calibration_plot
...
`print(result)` render. See `moirais.fn.describe('calpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.calpl import *
import numpy as np
# See the function signature in fn/calpl.py for argument names.
```
