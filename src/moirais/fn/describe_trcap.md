...
`print(result)` render. See `moirais.fn.describe('trcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcap import *
import numpy as np
# See the function signature in fn/trcap.py for argument names.
```
