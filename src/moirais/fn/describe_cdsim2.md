...
`print(result)` render. See `moirais.fn.describe('cdsim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdsim2 import *
import numpy as np
# See the function signature in fn/cdsim2.py for argument names.
```
