# describe('rgwelch') — rangayyan_welch_psd
...
`print(result)` render. See `moirais.fn.describe('rgwelch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwelch import *
import numpy as np
# See the function signature in fn/rgwelch.py for argument names.
```
