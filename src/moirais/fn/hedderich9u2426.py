...
__all__ = ["hedderich_chapter_9_unnumbered_2426"]


def hedderich_chapter_9_unnumbered_2426(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] V1:µ1 =µ2 =µA with µ3 =µ4 =µ5 =µB
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2426')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2426: GeneralStatistics expression (auto-extracted; see ref)."
