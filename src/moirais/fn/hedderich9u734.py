...
__all__ = ["hedderich_chapter_9_unnumbered_734"]


def hedderich_chapter_9_unnumbered_734(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u734')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u734: CountModels expression (auto-extracted; see ref)."
