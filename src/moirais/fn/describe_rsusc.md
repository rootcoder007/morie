...
`print(result)` render. See `moirais.fn.describe('rsusc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsusc import *
import numpy as np
# See the function signature in fn/rsusc.py for argument names.
```
