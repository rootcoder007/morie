...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_113"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_113(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ii. Y = β0 +β1X +β2X2 +ϵ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u113')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u113: GeneralStatistics expression (auto-extracted; see ref)."
