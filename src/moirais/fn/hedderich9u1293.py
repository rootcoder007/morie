...
__all__ = ["hedderich_chapter_9_unnumbered_1293"]


def hedderich_chapter_9_unnumbered_1293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Investigation group: n1 = 42 . ¯x1 = 11.33 .s1 = 7.59
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1293')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1293: GeneralStatistics expression (auto-extracted; see ref)."
