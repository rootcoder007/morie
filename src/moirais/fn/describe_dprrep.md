# describe('dprrep') — randomized_response_dp
...
`print(result)` render. See `moirais.fn.describe('dprrep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dprrep import *
import numpy as np
# See the function signature in fn/dprrep.py for argument names.
```
