...
`print(result)` render. See `moirais.fn.describe('hmbf16')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbf16 import *
import numpy as np
# See the function signature in fn/hmbf16.py for argument names.
```
