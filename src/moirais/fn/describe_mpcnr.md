...
`print(result)` render. See `moirais.fn.describe('mpcnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpcnr import *
import numpy as np
# See the function signature in fn/mpcnr.py for argument names.
```
