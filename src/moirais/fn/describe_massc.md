...
`print(result)` render. See `moirais.fn.describe('massc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.massc import *
import numpy as np
# See the function signature in fn/massc.py for argument names.
```
