# describe('sggau') — gaussian_variogram
...
`print(result)` render. See `moirais.fn.describe('sggau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sggau import *
import numpy as np
# See the function signature in fn/sggau.py for argument names.
```
