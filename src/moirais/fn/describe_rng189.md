# describe('rng189') — rangayyan_ch4_pan_tompkins_moving_window_integrator
...
`print(result)` render. See `moirais.fn.describe('rng189')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng189 import *
import numpy as np
# See the function signature in fn/rng189.py for argument names.
```
