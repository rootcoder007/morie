...
__all__ = ["hedderich_chapter_9_unnumbered_790"]


def hedderich_chapter_9_unnumbered_790(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2π), forσ= 1 it has the value0.398942≃0.4.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u790')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u790: GeneralStatistics expression (auto-extracted; see ref)."
