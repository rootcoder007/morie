...
`print(result)` render. See `moirais.fn.describe('youden')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.youden import *
import numpy as np
# See the function signature in fn/youden.py for argument names.
```
