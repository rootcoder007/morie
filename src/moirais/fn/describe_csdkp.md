...
`print(result)` render. See `moirais.fn.describe('csdkp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdkp import *
import numpy as np
# See the function signature in fn/csdkp.py for argument names.
```
