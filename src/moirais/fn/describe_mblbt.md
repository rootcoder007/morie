# describe('mblbt') — moving_block_bootstrap
...
`print(result)` render. See `moirais.fn.describe('mblbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mblbt import *
import numpy as np
# See the function signature in fn/mblbt.py for argument names.
```
