...
`print(result)` render. See `moirais.fn.describe('hybas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hybas import *
import numpy as np
# See the function signature in fn/hybas.py for argument names.
```
