# describe('cdpamp') — cdp_subgaussian_amplification
...
`print(result)` render. See `moirais.fn.describe('cdpamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdpamp import *
import numpy as np
# See the function signature in fn/cdpamp.py for argument names.
```
