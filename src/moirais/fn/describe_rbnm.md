...
`print(result)` render. See `moirais.fn.describe('rbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbnm import *
import numpy as np
# See the function signature in fn/rbnm.py for argument names.
```
