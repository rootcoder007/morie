...
`print(result)` render. See `moirais.fn.describe('mselb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mselb import *
import numpy as np
# See the function signature in fn/mselb.py for argument names.
```
