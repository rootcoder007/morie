# describe('rng078') — rangayyan_ch3_twiddle_periodicity
...
`print(result)` render. See `moirais.fn.describe('rng078')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng078 import *
import numpy as np
# See the function signature in fn/rng078.py for argument names.
```
