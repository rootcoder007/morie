# describe('cohfn') — coherence_function_fn
...
`print(result)` render. See `moirais.fn.describe('cohfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cohfn import *
import numpy as np
# See the function signature in fn/cohfn.py for argument names.
```
