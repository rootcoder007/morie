...
`print(result)` render. See `moirais.fn.describe('dlaumn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlaumn import *
import numpy as np
# See the function signature in fn/dlaumn.py for argument names.
```
