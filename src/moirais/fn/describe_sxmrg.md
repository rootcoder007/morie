...
`print(result)` render. See `moirais.fn.describe('sxmrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sxmrg import *
import numpy as np
# See the function signature in fn/sxmrg.py for argument names.
```
