...
__all__ = ["hedderich_chapter_9_unnumbered_2857"]


def hedderich_chapter_9_unnumbered_2857(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 8.759> 5.991 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2857')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2857: GeneralStatistics expression (auto-extracted; see ref)."
