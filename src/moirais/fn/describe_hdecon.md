# describe('hdecon') — homomorphic_deconvolve
...
`print(result)` render. See `moirais.fn.describe('hdecon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdecon import *
import numpy as np
# See the function signature in fn/hdecon.py for argument names.
```
