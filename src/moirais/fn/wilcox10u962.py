...
__all__ = ["wilcox_chapter_10_unnumbered_962"]


def wilcox_chapter_10_unnumbered_962(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: TRUE, SEED = TRUE, xlab = "Group 1", ylab = "Est.1-Est.2", tr=0.2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u962')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u962: GeneralStatistics expression (auto-extracted; see ref)."
