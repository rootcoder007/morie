...
`print(result)` render. See `moirais.fn.describe('amhst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amhst import *
import numpy as np
# See the function signature in fn/amhst.py for argument names.
```
