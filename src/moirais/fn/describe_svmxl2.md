...
`print(result)` render. See `moirais.fn.describe('svmxl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmxl2 import *
import numpy as np
# See the function signature in fn/svmxl2.py for argument names.
```
