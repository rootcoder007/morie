...
`print(result)` render. See `moirais.fn.describe('iccC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iccC import *
import numpy as np
# See the function signature in fn/iccC.py for argument names.
```
