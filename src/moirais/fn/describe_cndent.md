# describe('cndent') — conditional_entropy
...
`print(result)` render. See `moirais.fn.describe('cndent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cndent import *
import numpy as np
# See the function signature in fn/cndent.py for argument names.
```
