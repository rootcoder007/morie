# describe('plakb') — plackett_burman
...
`print(result)` render. See `moirais.fn.describe('plakb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plakb import *
import numpy as np
# See the function signature in fn/plakb.py for argument names.
```
