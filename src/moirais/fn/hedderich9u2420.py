...
__all__ = ["hedderich_chapter_9_unnumbered_2420"]


def hedderich_chapter_9_unnumbered_2420(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α = 0.05 P = 1−α = 0.95
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2420')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2420: GeneralStatistics expression (auto-extracted; see ref)."
