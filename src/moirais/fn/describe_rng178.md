# describe('rng178') — rangayyan_ch4_qrs_combined_balda
...
`print(result)` render. See `moirais.fn.describe('rng178')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng178 import *
import numpy as np
# See the function signature in fn/rng178.py for argument names.
```
