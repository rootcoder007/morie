...
__all__ = ["hedderich_chapter_9_unnumbered_2794"]


def hedderich_chapter_9_unnumbered_2794(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: 95%-CI: 0.05<π1−π2 <0.50
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2794')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2794: CausalInference expression (auto-extracted; see ref)."
