...
`print(result)` render. See `moirais.fn.describe('trspb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trspb import *
import numpy as np
# See the function signature in fn/trspb.py for argument names.
```
