...
`print(result)` render. See `moirais.fn.describe('wqcol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqcol import *
import numpy as np
# See the function signature in fn/wqcol.py for argument names.
```
