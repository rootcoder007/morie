# describe('hmbv') — geron_bias_variance_tradeoff
...
`print(result)` render. See `moirais.fn.describe('hmbv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbv import *
import numpy as np
# See the function signature in fn/hmbv.py for argument names.
```
