...
`print(result)` render. See `moirais.fn.describe('medkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medkt import *
import numpy as np
# See the function signature in fn/medkt.py for argument names.
```
