...
`print(result)` render. See `moirais.fn.describe('mmslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmslt import *
import numpy as np
# See the function signature in fn/mmslt.py for argument names.
```
