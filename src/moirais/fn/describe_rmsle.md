...
`print(result)` render. See `moirais.fn.describe('rmsle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsle import *
import numpy as np
# See the function signature in fn/rmsle.py for argument names.
```
