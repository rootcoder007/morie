# describe('whtet') — white_heterosc_test
...
`print(result)` render. See `moirais.fn.describe('whtet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whtet import *
import numpy as np
# See the function signature in fn/whtet.py for argument names.
```
