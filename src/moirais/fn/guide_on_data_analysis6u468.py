...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_468"]


def guide_on_data_analysis_chapter_6_unnumbered_468(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u468')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u468: GeneralStatistics expression (auto-extracted; see ref)."
