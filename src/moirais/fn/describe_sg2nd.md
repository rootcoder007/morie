# describe('sg2nd') — second_order_intensity
...
`print(result)` render. See `moirais.fn.describe('sg2nd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sg2nd import *
import numpy as np
# See the function signature in fn/sg2nd.py for argument names.
```
