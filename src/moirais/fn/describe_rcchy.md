...
`print(result)` render. See `moirais.fn.describe('rcchy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcchy import *
import numpy as np
# See the function signature in fn/rcchy.py for argument names.
```
