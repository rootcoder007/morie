# describe('rng071') — rangayyan_ch3_twiddle_factor
...
`print(result)` render. See `moirais.fn.describe('rng071')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng071 import *
import numpy as np
# See the function signature in fn/rng071.py for argument names.
```
