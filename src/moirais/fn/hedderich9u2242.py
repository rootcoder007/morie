...
__all__ = ["hedderich_chapter_9_unnumbered_2242"]


def hedderich_chapter_9_unnumbered_2242(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: CM =0.875 > 0.461=Cα, the null hypothesis can also be rejected at the 5% significance level
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2242')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2242: GeneralStatistics expression (auto-extracted; see ref)."
