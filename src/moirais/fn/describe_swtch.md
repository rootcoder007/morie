...
`print(result)` render. See `moirais.fn.describe('swtch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swtch import *
import numpy as np
# See the function signature in fn/swtch.py for argument names.
```
