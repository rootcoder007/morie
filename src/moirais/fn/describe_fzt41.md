# describe('fzt41') — fauzi_thm4_1_surv_bias_var
...
`print(result)` render. See `moirais.fn.describe('fzt41')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt41 import *
import numpy as np
# See the function signature in fn/fzt41.py for argument names.
```
