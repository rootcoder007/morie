# describe('unobts') — unobserved_components
...
`print(result)` render. See `moirais.fn.describe('unobts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unobts import *
import numpy as np
# See the function signature in fn/unobts.py for argument names.
```
