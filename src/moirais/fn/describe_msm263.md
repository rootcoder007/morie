# describe('msm263') — mvsml_convolutional_nn_eq_14_1
...
`print(result)` render. See `moirais.fn.describe('msm263')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm263 import *
import numpy as np
# See the function signature in fn/msm263.py for argument names.
```
