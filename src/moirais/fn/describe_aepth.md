...
`print(result)` render. See `moirais.fn.describe('aepth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aepth import *
import numpy as np
# See the function signature in fn/aepth.py for argument names.
```
