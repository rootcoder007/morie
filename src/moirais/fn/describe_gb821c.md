# describe('gb821c') — gibbons_wrs_ci
...
`print(result)` render. See `moirais.fn.describe('gb821c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb821c import *
import numpy as np
# See the function signature in fn/gb821c.py for argument names.
```
