# describe('icc2') — icc_two_way_random
...
`print(result)` render. See `moirais.fn.describe('icc2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc2 import *
import numpy as np
# See the function signature in fn/icc2.py for argument names.
```
