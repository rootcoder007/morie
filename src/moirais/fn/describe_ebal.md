...
`print(result)` render. See `moirais.fn.describe('ebal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebal import *
import numpy as np
# See the function signature in fn/ebal.py for argument names.
```
