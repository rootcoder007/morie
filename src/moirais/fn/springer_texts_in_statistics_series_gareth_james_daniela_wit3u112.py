...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_112"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_112(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i. Y = β0 +β1X +ϵ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u112')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u112: GeneralStatistics expression (auto-extracted; see ref)."
