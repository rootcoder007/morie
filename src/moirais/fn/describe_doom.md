...
`print(result)` render. See `moirais.fn.describe('doom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.doom import *
import numpy as np
# See the function signature in fn/doom.py for argument names.
```
