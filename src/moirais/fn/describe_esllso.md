...
`print(result)` render. See `moirais.fn.describe('esllso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllso import *
import numpy as np
# See the function signature in fn/esllso.py for argument names.
```
