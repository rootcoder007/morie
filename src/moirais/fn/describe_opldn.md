...
`print(result)` render. See `moirais.fn.describe('opldn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opldn import *
import numpy as np
# See the function signature in fn/opldn.py for argument names.
```
