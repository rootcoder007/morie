# describe('fitst') — fit_statistic_correct
...
`print(result)` render. See `moirais.fn.describe('fitst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fitst import *
import numpy as np
# See the function signature in fn/fitst.py for argument names.
```
