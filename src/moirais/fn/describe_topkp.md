# describe('topkp') — topkp

## WHAT IT DOES

rTop-k and top-p (nucleus) sampling.
...
`print(result)` render. See `moirais.fn.describe('topkp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.topkp import *
import numpy as np
# See the function signature in fn/topkp.py for argument names.
```
