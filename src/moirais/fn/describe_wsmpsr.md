# describe('wsmpsr') — wasserman_poisson_regression
...
`print(result)` render. See `moirais.fn.describe('wsmpsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmpsr import *
import numpy as np
# See the function signature in fn/wsmpsr.py for argument names.
```
