...
`print(result)` render. See `moirais.fn.describe('sapmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sapmo import *
import numpy as np
# See the function signature in fn/sapmo.py for argument names.
```
