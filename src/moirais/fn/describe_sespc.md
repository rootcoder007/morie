...
`print(result)` render. See `moirais.fn.describe('sespc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sespc import *
import numpy as np
# See the function signature in fn/sespc.py for argument names.
```
