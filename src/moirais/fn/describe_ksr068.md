# describe('ksr068') — kosorok_ch3_cox_profile_score
...
`print(result)` render. See `moirais.fn.describe('ksr068')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr068 import *
import numpy as np
# See the function signature in fn/ksr068.py for argument names.
```
