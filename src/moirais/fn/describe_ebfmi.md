# describe('ebfmi') — energy_bayesian_fmi
...
`print(result)` render. See `moirais.fn.describe('ebfmi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebfmi import *
import numpy as np
# See the function signature in fn/ebfmi.py for argument names.
```
