# describe('drspl') — dr_did_split_sample
...
`print(result)` render. See `moirais.fn.describe('drspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drspl import *
import numpy as np
# See the function signature in fn/drspl.py for argument names.
```
