...
__all__ = ["hedderich_chapter_9_unnumbered_2065"]


def hedderich_chapter_9_unnumbered_2065(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + pt ( − quant , df =nu , ncp=nonc , lower . tail = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2065')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2065: PowerAndDesign expression (auto-extracted; see ref)."
