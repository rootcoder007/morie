# describe('msm091') — mvsml_bayesian_regression_pt2_eq_7_1
...
`print(result)` render. See `moirais.fn.describe('msm091')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm091 import *
import numpy as np
# See the function signature in fn/msm091.py for argument names.
```
