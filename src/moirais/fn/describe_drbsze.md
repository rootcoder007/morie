# describe('drbsze') — dr_did_size_correction
...
`print(result)` render. See `moirais.fn.describe('drbsze')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drbsze import *
import numpy as np
# See the function signature in fn/drbsze.py for argument names.
```
