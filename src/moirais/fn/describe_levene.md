...
`print(result)` render. See `moirais.fn.describe('levene')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.levene import *
import numpy as np
# See the function signature in fn/levene.py for argument names.
```
