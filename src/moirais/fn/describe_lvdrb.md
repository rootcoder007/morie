# describe('lvdrb') — levinson_durbin_fn
...
`print(result)` render. See `moirais.fn.describe('lvdrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvdrb import *
import numpy as np
# See the function signature in fn/lvdrb.py for argument names.
```
