# describe('rng211') — rangayyan_ch4_average_output_noise_power
...
`print(result)` render. See `moirais.fn.describe('rng211')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng211 import *
import numpy as np
# See the function signature in fn/rng211.py for argument names.
```
