# describe('phylotr') — phylogenetic_tree
...
`print(result)` render. See `moirais.fn.describe('phylotr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phylotr import *
import numpy as np
# See the function signature in fn/phylotr.py for argument names.
```
