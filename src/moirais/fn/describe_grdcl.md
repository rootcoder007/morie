# describe('grdcl') — gradient_clipping
...
`print(result)` render. See `moirais.fn.describe('grdcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdcl import *
import numpy as np
# See the function signature in fn/grdcl.py for argument names.
```
