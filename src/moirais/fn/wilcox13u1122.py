...
__all__ = ["wilcox_chapter_13_unnumbered_1122"]


def wilcox_chapter_13_unnumbered_1122(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lplot(x,y, span=0.75, pyhat=FALSE, eout=F, xout=F, outfun=out, plotit=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1122')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1122: GeneralStatistics expression (auto-extracted; see ref)."
