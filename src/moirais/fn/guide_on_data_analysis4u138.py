...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_138"]


def guide_on_data_analysis_chapter_4_unnumbered_138(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u138')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u138: GeneralStatistics expression (auto-extracted; see ref)."
