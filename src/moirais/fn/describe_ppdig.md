...
`print(result)` render. See `moirais.fn.describe('ppdig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppdig import *
import numpy as np
# See the function signature in fn/ppdig.py for argument names.
```
