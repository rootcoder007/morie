...
`print(result)` render. See `moirais.fn.describe('afdrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afdrt import *
import numpy as np
# See the function signature in fn/afdrt.py for argument names.
```
