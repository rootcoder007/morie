# describe('ensav') — ensemble_average
...
`print(result)` render. See `moirais.fn.describe('ensav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ensav import *
import numpy as np
# See the function signature in fn/ensav.py for argument names.
```
