# describe('siudem') — siu_demographics
...
`print(result)` render. See `moirais.fn.describe('siudem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siudem import *
import numpy as np
# See the function signature in fn/siudem.py for argument names.
```
