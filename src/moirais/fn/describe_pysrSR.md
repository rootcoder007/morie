# describe('pysrSR') — pysr_regression
...
`print(result)` render. See `moirais.fn.describe('pysrSR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pysrSR import *
import numpy as np
# See the function signature in fn/pysrSR.py for argument names.
```
