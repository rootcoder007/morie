...
`print(result)` render. See `moirais.fn.describe('vaeber')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaeber import *
import numpy as np
# See the function signature in fn/vaeber.py for argument names.
```
