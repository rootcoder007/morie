...
`print(result)` render. See `moirais.fn.describe('snorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snorm import *
import numpy as np
# See the function signature in fn/snorm.py for argument names.
```
