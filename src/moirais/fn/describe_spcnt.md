# describe('spcnt') — spectral_centroid
...
`print(result)` render. See `moirais.fn.describe('spcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcnt import *
import numpy as np
# See the function signature in fn/spcnt.py for argument names.
```
