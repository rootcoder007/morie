...
`print(result)` render. See `moirais.fn.describe('sepst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sepst import *
import numpy as np
# See the function signature in fn/sepst.py for argument names.
```
