# describe('rghrvtv') — rangayyan_hrv_time_varying
...
`print(result)` render. See `moirais.fn.describe('rghrvtv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrvtv import *
import numpy as np
# See the function signature in fn/rghrvtv.py for argument names.
```
