...
`print(result)` render. See `moirais.fn.describe('xrmri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrmri import *
import numpy as np
# See the function signature in fn/xrmri.py for argument names.
```
