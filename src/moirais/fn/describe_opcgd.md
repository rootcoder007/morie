...
`print(result)` render. See `moirais.fn.describe('opcgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opcgd import *
import numpy as np
# See the function signature in fn/opcgd.py for argument names.
```
