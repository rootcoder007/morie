...
`print(result)` render. See `moirais.fn.describe('sgsim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsim2 import *
import numpy as np
# See the function signature in fn/sgsim2.py for argument names.
```
