...
`print(result)` render. See `moirais.fn.describe('idpem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpem import *
import numpy as np
# See the function signature in fn/idpem.py for argument names.
```
