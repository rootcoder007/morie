...
`print(result)` render. See `moirais.fn.describe('lca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lca import *
import numpy as np
# See the function signature in fn/lca.py for argument names.
```
