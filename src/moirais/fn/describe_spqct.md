# describe('spqct') — schabenberger_quadrat_count_test
...
`print(result)` render. See `moirais.fn.describe('spqct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spqct import *
import numpy as np
# See the function signature in fn/spqct.py for argument names.
```
