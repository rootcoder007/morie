...
`print(result)` render. See `moirais.fn.describe('ppstl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppstl import *
import numpy as np
# See the function signature in fn/ppstl.py for argument names.
```
