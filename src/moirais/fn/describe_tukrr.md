# describe('tukrr') — tukey_regression
...
`print(result)` render. See `moirais.fn.describe('tukrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tukrr import *
import numpy as np
# See the function signature in fn/tukrr.py for argument names.
```
