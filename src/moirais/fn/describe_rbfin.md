...
`print(result)` render. See `moirais.fn.describe('rbfin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfin import *
import numpy as np
# See the function signature in fn/rbfin.py for argument names.
```
