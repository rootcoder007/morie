...
`print(result)` render. See `moirais.fn.describe('mgwrfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrfit import *
import numpy as np
# See the function signature in fn/mgwrfit.py for argument names.
```
