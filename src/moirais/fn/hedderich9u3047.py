...
__all__ = ["hedderich_chapter_9_unnumbered_3047"]


def hedderich_chapter_9_unnumbered_3047(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 5·17−[32 + 42 + 32 + 22 + 22 + 32] = 5.412< 9.488 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3047')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3047: GeneralStatistics expression (auto-extracted; see ref)."
