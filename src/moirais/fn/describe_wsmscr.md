# describe('wsmscr') — wasserman_score_test
...
`print(result)` render. See `moirais.fn.describe('wsmscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmscr import *
import numpy as np
# See the function signature in fn/wsmscr.py for argument names.
```
