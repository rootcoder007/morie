...
`print(result)` render. See `moirais.fn.describe('tmlse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlse import *
import numpy as np
# See the function signature in fn/tmlse.py for argument names.
```
