# describe('wsmchi') — wasserman_chi_sq_gof
...
`print(result)` render. See `moirais.fn.describe('wsmchi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmchi import *
import numpy as np
# See the function signature in fn/wsmchi.py for argument names.
```
