# describe('gh_ap_m2') — ghosal_gibbs_sampler
...
`print(result)` render. See `moirais.fn.describe('gh_ap_m2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_m2 import *
import numpy as np
# See the function signature in fn/gh_ap_m2.py for argument names.
```
