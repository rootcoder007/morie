...
`print(result)` render. See `moirais.fn.describe('ahp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ahp import *
import numpy as np
# See the function signature in fn/ahp.py for argument names.
```
