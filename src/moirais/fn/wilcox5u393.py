...
__all__ = ["wilcox_chapter_5_unnumbered_393"]


def wilcox_chapter_5_unnumbered_393(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: (c) ¯X = 43, s = 2, test the hypothesis H0: µ = 42 with α = 0.05 and n = 25.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u393')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u393: PowerAndDesign expression (auto-extracted; see ref)."
