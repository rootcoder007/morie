# describe('grgin') — geron_gini_impurity
...
`print(result)` render. See `moirais.fn.describe('grgin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgin import *
import numpy as np
# See the function signature in fn/grgin.py for argument names.
```
