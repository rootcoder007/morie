...
__all__ = ["wilcox_chapter_14_unnumbered_498"]


def wilcox_chapter_14_unnumbered_498(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (2 − 1.687(1.3), 2 + 1.687(1.3)) = ( −0.193 , 4.193).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u498')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u498: GeneralStatistics expression (auto-extracted; see ref)."
