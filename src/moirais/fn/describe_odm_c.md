# describe('odm_c') — otis_demo_cross
...
`print(result)` render. See `moirais.fn.describe('odm_c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_c import *
import numpy as np
# See the function signature in fn/odm_c.py for argument names.
```
