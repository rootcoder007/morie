...
__all__ = ["hedderich_chapter_9_unnumbered_2973"]


def hedderich_chapter_9_unnumbered_2973(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • Decision: Since 21.58> 9.49 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2973')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2973: GeneralStatistics expression (auto-extracted; see ref)."
