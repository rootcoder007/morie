...
`print(result)` render. See `moirais.fn.describe('blipqf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blipqf import *
import numpy as np
# See the function signature in fn/blipqf.py for argument names.
```
