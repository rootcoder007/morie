...
`print(result)` render. See `moirais.fn.describe('sacrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacrb import *
import numpy as np
# See the function signature in fn/sacrb.py for argument names.
```
