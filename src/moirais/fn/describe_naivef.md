# describe('naivef') — naive_forecast
...
`print(result)` render. See `moirais.fn.describe('naivef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.naivef import *
import numpy as np
# See the function signature in fn/naivef.py for argument names.
```
