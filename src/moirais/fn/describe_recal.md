...
`print(result)` render. See `moirais.fn.describe('recal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.recal import *
import numpy as np
# See the function signature in fn/recal.py for argument names.
```
