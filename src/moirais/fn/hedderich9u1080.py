...
__all__ = ["hedderich_chapter_9_unnumbered_1080"]


def hedderich_chapter_9_unnumbered_1080(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] MSE(ϑ; T) = Var (T) + [E(T)−ϑ]2 . (6.12)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1080')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1080: GeneralStatistics expression (auto-extracted; see ref)."
