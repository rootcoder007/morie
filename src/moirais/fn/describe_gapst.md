...
`print(result)` render. See `moirais.fn.describe('gapst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gapst import *
import numpy as np
# See the function signature in fn/gapst.py for argument names.
```
