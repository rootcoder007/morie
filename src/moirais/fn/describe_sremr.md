...
`print(result)` render. See `moirais.fn.describe('sremr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sremr import *
import numpy as np
# See the function signature in fn/sremr.py for argument names.
```
