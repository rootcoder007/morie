# describe('hmense') — geron_ensemble_eval
...
`print(result)` render. See `moirais.fn.describe('hmense')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmense import *
import numpy as np
# See the function signature in fn/hmense.py for argument names.
```
