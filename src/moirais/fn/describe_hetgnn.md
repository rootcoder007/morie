# describe('hetgnn') — heterogeneous_gnn
...
`print(result)` render. See `moirais.fn.describe('hetgnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hetgnn import *
import numpy as np
# See the function signature in fn/hetgnn.py for argument names.
```
