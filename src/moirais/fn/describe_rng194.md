# describe('rng194') — rangayyan_ch4_heart_rate_from_rr
...
`print(result)` render. See `moirais.fn.describe('rng194')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng194 import *
import numpy as np
# See the function signature in fn/rng194.py for argument names.
```
