# describe('hmrfc') — geron_random_forest
...
`print(result)` render. See `moirais.fn.describe('hmrfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrfc import *
import numpy as np
# See the function signature in fn/hmrfc.py for argument names.
```
