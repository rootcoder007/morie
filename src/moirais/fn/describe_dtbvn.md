...
`print(result)` render. See `moirais.fn.describe('dtbvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbvn import *
import numpy as np
# See the function signature in fn/dtbvn.py for argument names.
```
