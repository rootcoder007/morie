...
__all__ = ["hedderich_chapter_9_unnumbered_2879"]


def hedderich_chapter_9_unnumbered_2879(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 8.213< 9.488 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2879')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2879: GeneralStatistics expression (auto-extracted; see ref)."
