...
__all__ = ["hedderich_chapter_9_unnumbered_2278"]


def hedderich_chapter_9_unnumbered_2278(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2 = 11. A correction value is omitted, since (n1≤n2≤3 + 4n1/3)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2278')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2278: GeneralStatistics expression (auto-extracted; see ref)."
