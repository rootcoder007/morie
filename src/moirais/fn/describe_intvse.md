# describe('intvse') — interventional_effect
...
`print(result)` render. See `moirais.fn.describe('intvse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intvse import *
import numpy as np
# See the function signature in fn/intvse.py for argument names.
```
