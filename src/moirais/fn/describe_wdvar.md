...
`print(result)` render. See `moirais.fn.describe('wdvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wdvar import *
import numpy as np
# See the function signature in fn/wdvar.py for argument names.
```
