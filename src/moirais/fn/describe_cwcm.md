# describe('cwcm') — centering_within_cluster_mean
...
`print(result)` render. See `moirais.fn.describe('cwcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cwcm import *
import numpy as np
# See the function signature in fn/cwcm.py for argument names.
```
