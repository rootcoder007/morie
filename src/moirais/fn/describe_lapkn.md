# describe('lapkn') — laplacian_kernel
...
`print(result)` render. See `moirais.fn.describe('lapkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lapkn import *
import numpy as np
# See the function signature in fn/lapkn.py for argument names.
```
