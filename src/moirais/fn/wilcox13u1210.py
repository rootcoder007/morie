...
__all__ = ["wilcox_chapter_13_unnumbered_1210"]


def wilcox_chapter_13_unnumbered_1210(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Y =β 0 +β 1X1 +β 2X2 +β 3X1X2 +e is unsatisfactory.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1210')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1210: GeneralStatistics expression (auto-extracted; see ref)."
