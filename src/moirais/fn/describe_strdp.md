...
`print(result)` render. See `moirais.fn.describe('strdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strdp import *
import numpy as np
# See the function signature in fn/strdp.py for argument names.
```
