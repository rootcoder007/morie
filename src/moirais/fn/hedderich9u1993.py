...
__all__ = ["hedderich_chapter_9_unnumbered_1993"]


def hedderich_chapter_9_unnumbered_1993(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + x . i <− ( d [ 1 , ] = = x l )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1993')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1993: GeneralStatistics expression (auto-extracted; see ref)."
