...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_1"]


def guide_on_data_analysis_chapter_2_unnumbered_1(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A(B + C) =AB + AC (Distributive property)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u1')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u1: GeneralStatistics expression (auto-extracted; see ref)."
