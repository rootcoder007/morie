# describe('the_r_series_dick_j_brus_spatial_sampling_with_r21e1') — the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_21_equation_1
...
import numpy as np
result = the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_21_equation_1(np.random.default_rng(42).normal(0, 1, 100))
