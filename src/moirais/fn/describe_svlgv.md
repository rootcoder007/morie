...
`print(result)` render. See `moirais.fn.describe('svlgv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlgv import *
import numpy as np
# See the function signature in fn/svlgv.py for argument names.
```
