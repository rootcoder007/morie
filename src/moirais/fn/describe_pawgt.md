...
`print(result)` render. See `moirais.fn.describe('pawgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pawgt import *
import numpy as np
# See the function signature in fn/pawgt.py for argument names.
```
