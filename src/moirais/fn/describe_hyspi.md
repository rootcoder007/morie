...
`print(result)` render. See `moirais.fn.describe('hyspi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyspi import *
import numpy as np
# See the function signature in fn/hyspi.py for argument names.
```
