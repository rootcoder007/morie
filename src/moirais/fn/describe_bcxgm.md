# describe('bcxgm') — _boxcox_transform
...
`print(result)` render. See `moirais.fn.describe('bcxgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcxgm import *
import numpy as np
# See the function signature in fn/bcxgm.py for argument names.
```
