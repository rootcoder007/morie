# describe('kmperp') — kamath_perplexity
...
`print(result)` render. See `moirais.fn.describe('kmperp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmperp import *
import numpy as np
# See the function signature in fn/kmperp.py for argument names.
```
