...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_159"]


def guide_on_data_analysis_chapter_4_unnumbered_159(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> t = -1.1622, df = 99, p-value = 0.248
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u159')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u159: GeneralStatistics expression (auto-extracted; see ref)."
