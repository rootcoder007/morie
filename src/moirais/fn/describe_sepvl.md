...
`print(result)` render. See `moirais.fn.describe('sepvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sepvl import *
import numpy as np
# See the function signature in fn/sepvl.py for argument names.
```
