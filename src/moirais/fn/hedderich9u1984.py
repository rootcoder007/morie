...
__all__ = ["hedderich_chapter_9_unnumbered_1984"]


def hedderich_chapter_9_unnumbered_1984(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: S2 = 12.52 + 12.52 + 16.52 + 16.52 = 857
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1984')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1984: GeneralStatistics expression (auto-extracted; see ref)."
