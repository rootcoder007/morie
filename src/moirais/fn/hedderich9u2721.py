...
__all__ = ["hedderich_chapter_9_unnumbered_2721"]


def hedderich_chapter_9_unnumbered_2721(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ψπ(1−ψπ) +rπ(1−π)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2721')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2721: GeneralStatistics expression (auto-extracted; see ref)."
