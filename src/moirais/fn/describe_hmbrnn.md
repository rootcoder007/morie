# describe('hmbrnn') — geron_bidirectional_rnn
...
`print(result)` render. See `moirais.fn.describe('hmbrnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbrnn import *
import numpy as np
# See the function signature in fn/hmbrnn.py for argument names.
```
