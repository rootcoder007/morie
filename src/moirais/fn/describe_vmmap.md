...
`print(result)` render. See `moirais.fn.describe('vmmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmmap import *
import numpy as np
# See the function signature in fn/vmmap.py for argument names.
```
