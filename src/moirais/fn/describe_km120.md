# describe('km120') — kamath_ch8_bertscore_precision
...
`print(result)` render. See `moirais.fn.describe('km120')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km120 import *
import numpy as np
# See the function signature in fn/km120.py for argument names.
```
