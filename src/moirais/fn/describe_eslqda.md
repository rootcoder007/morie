...
`print(result)` render. See `moirais.fn.describe('eslqda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslqda import *
import numpy as np
# See the function signature in fn/eslqda.py for argument names.
```
