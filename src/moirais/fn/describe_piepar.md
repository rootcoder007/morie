# describe('piepar') — pie_parameters
...
`print(result)` render. See `moirais.fn.describe('piepar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.piepar import *
import numpy as np
# See the function signature in fn/piepar.py for argument names.
```
