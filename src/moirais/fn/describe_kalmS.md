# describe('kalmS') — kalman_smoother
...
`print(result)` render. See `moirais.fn.describe('kalmS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kalmS import *
import numpy as np
# See the function signature in fn/kalmS.py for argument names.
```
