...
`print(result)` render. See `moirais.fn.describe('ubcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcnt import *
import numpy as np
# See the function signature in fn/ubcnt.py for argument names.
```
