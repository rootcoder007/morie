...
`print(result)` render. See `moirais.fn.describe('mgwrbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrbw import *
import numpy as np
# See the function signature in fn/mgwrbw.py for argument names.
```
