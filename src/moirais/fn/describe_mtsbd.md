...
`print(result)` render. See `moirais.fn.describe('mtsbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtsbd import *
import numpy as np
# See the function signature in fn/mtsbd.py for argument names.
```
