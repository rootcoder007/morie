...
`print(result)` render. See `moirais.fn.describe('holo_w')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_w import *
import numpy as np
# See the function signature in fn/holo_w.py for argument names.
```
