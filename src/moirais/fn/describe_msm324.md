# describe('msm324') — mvsml_functional_regression_eq_15_1
...
`print(result)` render. See `moirais.fn.describe('msm324')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm324 import *
import numpy as np
# See the function signature in fn/msm324.py for argument names.
```
