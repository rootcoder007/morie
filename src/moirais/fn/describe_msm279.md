# describe('msm279') — mvsml_convolutional_nn_eq_14_2
...
`print(result)` render. See `moirais.fn.describe('msm279')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm279 import *
import numpy as np
# See the function signature in fn/msm279.py for argument names.
```
