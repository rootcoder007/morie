...
`print(result)` render. See `moirais.fn.describe('hmdale')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdale import *
import numpy as np
# See the function signature in fn/hmdale.py for argument names.
```
