# describe('htprd') — hyperparameter_tuning_grid
...
`print(result)` render. See `moirais.fn.describe('htprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htprd import *
import numpy as np
# See the function signature in fn/htprd.py for argument names.
```
