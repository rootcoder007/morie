...
__all__ = ["wilcox_chapter_14_unnumbered_546"]


def wilcox_chapter_14_unnumbered_546(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: integer, and u = B − ℓ. Then an approximate 1 − α confidence interval for the difference
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u546')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u546: GeneralStatistics expression (auto-extracted; see ref)."
