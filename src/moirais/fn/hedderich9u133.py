...
__all__ = ["hedderich_chapter_9_unnumbered_133"]


def hedderich_chapter_9_unnumbered_133(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: a(5−i)bi =a5b0 + 5a4b1 + 10a3b2 + 10a2b3 + 5a1b4 +a0b5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u133')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u133: CountModels expression (auto-extracted; see ref)."
