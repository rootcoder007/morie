# describe('md_pat') — missing_data_patterns
...
`print(result)` render. See `moirais.fn.describe('md_pat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.md_pat import *
import numpy as np
# See the function signature in fn/md_pat.py for argument names.
```
