# describe('tmlpoy') — tmle_propensity_only
...
`print(result)` render. See `moirais.fn.describe('tmlpoy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlpoy import *
import numpy as np
# See the function signature in fn/tmlpoy.py for argument names.
```
