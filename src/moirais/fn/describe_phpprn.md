# describe('phpprn') — phillips_perron
...
`print(result)` render. See `moirais.fn.describe('phpprn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phpprn import *
import numpy as np
# See the function signature in fn/phpprn.py for argument names.
```
