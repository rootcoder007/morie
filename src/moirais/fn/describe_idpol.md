...
`print(result)` render. See `moirais.fn.describe('idpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpol import *
import numpy as np
# See the function signature in fn/idpol.py for argument names.
```
