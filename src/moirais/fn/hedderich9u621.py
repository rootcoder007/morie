...
__all__ = ["hedderich_chapter_9_unnumbered_621"]


def hedderich_chapter_9_unnumbered_621(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] ¯A ¯A ¯A 0 P (X = 0) (1−p)3 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u621')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u621: CountModels expression (auto-extracted; see ref)."
