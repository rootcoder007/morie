...
`print(result)` render. See `moirais.fn.describe('zegra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zegra import *
import numpy as np
# See the function signature in fn/zegra.py for argument names.
```
