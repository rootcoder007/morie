...
`print(result)` render. See `moirais.fn.describe('spprgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprgmm import *
import numpy as np
# See the function signature in fn/spprgmm.py for argument names.
```
