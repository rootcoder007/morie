...
`print(result)` render. See `moirais.fn.describe('hmkfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkfd import *
import numpy as np
# See the function signature in fn/hmkfd.py for argument names.
```
