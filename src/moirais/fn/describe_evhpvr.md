# describe('evhpvr') — evt_heffernan_tawn
...
`print(result)` render. See `moirais.fn.describe('evhpvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evhpvr import *
import numpy as np
# See the function signature in fn/evhpvr.py for argument names.
```
