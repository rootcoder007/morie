...
__all__ = ["hedderich_chapter_9_unnumbered_1959"]


def hedderich_chapter_9_unnumbered_1959(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] with V = (n1−1)(s1/¯x1) + (n2−1)(s2/¯x2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1959')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1959: GeneralStatistics expression (auto-extracted; see ref)."
