...
__all__ = ["wilcox_chapter_14_unnumbered_761"]


def wilcox_chapter_14_unnumbered_761(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] T = −3(10 + 1) + 12
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u761')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u761: GeneralStatistics expression (auto-extracted; see ref)."
