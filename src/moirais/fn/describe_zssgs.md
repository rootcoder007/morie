...
`print(result)` render. See `moirais.fn.describe('zssgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zssgs import *
import numpy as np
# See the function signature in fn/zssgs.py for argument names.
```
