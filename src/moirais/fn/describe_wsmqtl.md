# describe('wsmqtl') — wasserman_empirical_quantile
...
`print(result)` render. See `moirais.fn.describe('wsmqtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmqtl import *
import numpy as np
# See the function signature in fn/wsmqtl.py for argument names.
```
