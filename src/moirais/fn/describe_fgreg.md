...
`print(result)` render. See `moirais.fn.describe('fgreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fgreg import *
import numpy as np
# See the function signature in fn/fgreg.py for argument names.
```
