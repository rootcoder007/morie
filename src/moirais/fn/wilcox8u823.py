...
__all__ = ["wilcox_chapter_8_unnumbered_823"]


def wilcox_chapter_8_unnumbered_823(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] L = 1,..., (J − 1)(K − 1), ℓ = 1, · · ·,J (K − 1), and cLℓ is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u823')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u823: GeneralStatistics expression (auto-extracted; see ref)."
