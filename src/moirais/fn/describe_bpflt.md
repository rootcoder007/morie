# describe('bpflt') — bandpass_filter
...
`print(result)` render. See `moirais.fn.describe('bpflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpflt import *
import numpy as np
# See the function signature in fn/bpflt.py for argument names.
```
