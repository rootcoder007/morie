# describe('causqte') — causal_quantile_treatment_effect
...
`print(result)` render. See `moirais.fn.describe('causqte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causqte import *
import numpy as np
# See the function signature in fn/causqte.py for argument names.
```
