# describe('trksp') — trksp

## WHAT IT DOES

K shortest paths spatial
...
`print(result)` render. See `moirais.fn.describe('trksp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trksp import *
import numpy as np
# See the function signature in fn/trksp.py for argument names.
```
