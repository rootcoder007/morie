...
`print(result)` render. See `moirais.fn.describe('sgcosm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcosm import *
import numpy as np
# See the function signature in fn/sgcosm.py for argument names.
```
