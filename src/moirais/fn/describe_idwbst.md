...
`print(result)` render. See `moirais.fn.describe('idwbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwbst import *
import numpy as np
# See the function signature in fn/idwbst.py for argument names.
```
