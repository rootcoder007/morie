...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1496"]


def guide_on_data_analysis_chapter_30_unnumbered_1496(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -4 x cohort = 6 0.36 (0.86)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1496')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1496: GeneralStatistics expression (auto-extracted; see ref)."
