...
`print(result)` render. See `moirais.fn.describe('mtlvy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtlvy import *
import numpy as np
# See the function signature in fn/mtlvy.py for argument names.
```
