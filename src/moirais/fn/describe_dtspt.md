...
`print(result)` render. See `moirais.fn.describe('dtspt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtspt import *
import numpy as np
# See the function signature in fn/dtspt.py for argument names.
```
