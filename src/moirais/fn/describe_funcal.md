# describe('funcal') — functional_annotation
...
`print(result)` render. See `moirais.fn.describe('funcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funcal import *
import numpy as np
# See the function signature in fn/funcal.py for argument names.
```
