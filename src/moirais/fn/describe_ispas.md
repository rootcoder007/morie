...
`print(result)` render. See `moirais.fn.describe('ispas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ispas import *
import numpy as np
# See the function signature in fn/ispas.py for argument names.
```
