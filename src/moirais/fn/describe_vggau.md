...
`print(result)` render. See `moirais.fn.describe('vggau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vggau import *
import numpy as np
# See the function signature in fn/vggau.py for argument names.
```
