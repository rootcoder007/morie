...
__all__ = ["wilcox_chapter_4_unnumbered_147"]


def wilcox_chapter_4_unnumbered_147(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 45. If for a binomial, p = 0.4 and n = 25, determine (a) P (X <11), (b) P (X ≤ 11),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u147')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u147: CountModels expression (auto-extracted; see ref)."
