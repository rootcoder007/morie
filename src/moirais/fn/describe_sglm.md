...
`print(result)` render. See `moirais.fn.describe('sglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglm import *
import numpy as np
# See the function signature in fn/sglm.py for argument names.
```
