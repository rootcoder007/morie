# describe('cstin') — custody_incident_rate
...
`print(result)` render. See `moirais.fn.describe('cstin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstin import *
import numpy as np
# See the function signature in fn/cstin.py for argument names.
```
