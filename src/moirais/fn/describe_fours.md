...
`print(result)` render. See `moirais.fn.describe('fours')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fours import *
import numpy as np
# See the function signature in fn/fours.py for argument names.
```
