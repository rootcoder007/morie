...
`print(result)` render. See `moirais.fn.describe('rnkci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnkci import *
import numpy as np
# See the function signature in fn/rnkci.py for argument names.
```
