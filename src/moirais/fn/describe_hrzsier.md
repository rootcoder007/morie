# describe('hrzsier') — horowitz_series_regression
...
`print(result)` render. See `moirais.fn.describe('hrzsier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsier import *
import numpy as np
# See the function signature in fn/hrzsier.py for argument names.
```
