...
`print(result)` render. See `moirais.fn.describe('plbim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plbim import *
import numpy as np
# See the function signature in fn/plbim.py for argument names.
```
