...
`print(result)` render. See `moirais.fn.describe('slest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slest import *
import numpy as np
# See the function signature in fn/slest.py for argument names.
```
