...
`print(result)` render. See `moirais.fn.describe('agprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agprm import *
import numpy as np
# See the function signature in fn/agprm.py for argument names.
```
