...
`print(result)` render. See `moirais.fn.describe('fastxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fastxt import *
import numpy as np
# See the function signature in fn/fastxt.py for argument names.
```
