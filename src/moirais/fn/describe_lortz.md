...
`print(result)` render. See `moirais.fn.describe('lortz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lortz import *
import numpy as np
# See the function signature in fn/lortz.py for argument names.
```
