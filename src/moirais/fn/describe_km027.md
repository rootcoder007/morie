# describe('km027') — kamath_ch2_tlm_loss
...
`print(result)` render. See `moirais.fn.describe('km027')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km027 import *
import numpy as np
# See the function signature in fn/km027.py for argument names.
```
