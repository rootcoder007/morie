...
`print(result)` render. See `moirais.fn.describe('lvsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvsim import *
import numpy as np
# See the function signature in fn/lvsim.py for argument names.
```
