...
`print(result)` render. See `moirais.fn.describe('lothr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lothr import *
import numpy as np
# See the function signature in fn/lothr.py for argument names.
```
