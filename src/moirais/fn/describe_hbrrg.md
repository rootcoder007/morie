# describe('hbrrg') — huber_regression
...
`print(result)` render. See `moirais.fn.describe('hbrrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hbrrg import *
import numpy as np
# See the function signature in fn/hbrrg.py for argument names.
```
