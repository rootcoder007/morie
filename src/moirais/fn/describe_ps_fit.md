# describe('ps_fit') — compute_propensity_scores
...
`print(result)` render. See `moirais.fn.describe('ps_fit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ps_fit import *
import numpy as np
# See the function signature in fn/ps_fit.py for argument names.
```
