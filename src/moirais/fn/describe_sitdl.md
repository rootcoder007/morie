# describe('sitdl') — subscale_item_detail
...
`print(result)` render. See `moirais.fn.describe('sitdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sitdl import *
import numpy as np
# See the function signature in fn/sitdl.py for argument names.
```
