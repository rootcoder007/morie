...
`print(result)` render. See `moirais.fn.describe('gf2ml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gf2ml import *
import numpy as np
# See the function signature in fn/gf2ml.py for argument names.
```
