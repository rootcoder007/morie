...
`print(result)` render. See `moirais.fn.describe('prsclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsclm import *
import numpy as np
# See the function signature in fn/prsclm.py for argument names.
```
