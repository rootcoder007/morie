...
`print(result)` render. See `moirais.fn.describe('ktwos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ktwos import *
import numpy as np
# See the function signature in fn/ktwos.py for argument names.
```
