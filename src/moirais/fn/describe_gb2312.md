# describe('gb2312') — gibbons_edf_consistent
...
`print(result)` render. See `moirais.fn.describe('gb2312')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2312 import *
import numpy as np
# See the function signature in fn/gb2312.py for argument names.
```
