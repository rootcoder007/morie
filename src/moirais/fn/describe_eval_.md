...
`print(result)` render. See `moirais.fn.describe('eval_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eval_ import *
import numpy as np
# See the function signature in fn/eval_.py for argument names.
```
