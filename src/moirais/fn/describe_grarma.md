# describe('grarma') — geron_arima_forecast
...
`print(result)` render. See `moirais.fn.describe('grarma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grarma import *
import numpy as np
# See the function signature in fn/grarma.py for argument names.
```
