...
__all__ = ["hedderich_chapter_9_unnumbered_3098"]


def hedderich_chapter_9_unnumbered_3098(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n−3 withν=n−2 (7.390)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3098')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3098: GeneralStatistics expression (auto-extracted; see ref)."
