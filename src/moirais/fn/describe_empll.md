...
`print(result)` render. See `moirais.fn.describe('empll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.empll import *
import numpy as np
# See the function signature in fn/empll.py for argument names.
```
