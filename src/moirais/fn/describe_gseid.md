...
`print(result)` render. See `moirais.fn.describe('gseid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gseid import *
import numpy as np
# See the function signature in fn/gseid.py for argument names.
```
