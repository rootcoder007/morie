...
`print(result)` render. See `moirais.fn.describe('hot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hot import *
import numpy as np
# See the function signature in fn/hot.py for argument names.
```
