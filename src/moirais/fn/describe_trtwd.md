...
`print(result)` render. See `moirais.fn.describe('trtwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trtwd import *
import numpy as np
# See the function signature in fn/trtwd.py for argument names.
```
