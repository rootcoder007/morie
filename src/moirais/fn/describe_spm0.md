...
`print(result)` render. See `moirais.fn.describe('spm0')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spm0 import *
import numpy as np
# See the function signature in fn/spm0.py for argument names.
```
