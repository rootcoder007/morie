# describe('oiv1') — otis_iv_distance
...
`print(result)` render. See `moirais.fn.describe('oiv1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oiv1 import *
import numpy as np
# See the function signature in fn/oiv1.py for argument names.
```
