# describe('maloo') — ma_leave_one_out
...
`print(result)` render. See `moirais.fn.describe('maloo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maloo import *
import numpy as np
# See the function signature in fn/maloo.py for argument names.
```
