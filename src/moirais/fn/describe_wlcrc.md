...
`print(result)` render. See `moirais.fn.describe('wlcrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcrc import *
import numpy as np
# See the function signature in fn/wlcrc.py for argument names.
```
