...
`print(result)` render. See `moirais.fn.describe('floyd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.floyd import *
import numpy as np
# See the function signature in fn/floyd.py for argument names.
```
