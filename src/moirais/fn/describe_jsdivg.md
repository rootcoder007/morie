# describe('jsdivg') — jensen_shannon_divergence
...
`print(result)` render. See `moirais.fn.describe('jsdivg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jsdivg import *
import numpy as np
# See the function signature in fn/jsdivg.py for argument names.
```
