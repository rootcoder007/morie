...
`print(result)` render. See `moirais.fn.describe('nbvbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbvbr import *
import numpy as np
# See the function signature in fn/nbvbr.py for argument names.
```
