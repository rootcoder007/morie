...
`print(result)` render. See `moirais.fn.describe('psdbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psdbt import *
import numpy as np
# See the function signature in fn/psdbt.py for argument names.
```
