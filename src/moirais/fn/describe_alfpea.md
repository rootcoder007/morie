# describe('alfpea') — alphafold_pae_predict
...
`print(result)` render. See `moirais.fn.describe('alfpea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfpea import *
import numpy as np
# See the function signature in fn/alfpea.py for argument names.
```
