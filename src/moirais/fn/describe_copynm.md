# describe('copynm') — copy_number_variant
...
`print(result)` render. See `moirais.fn.describe('copynm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copynm import *
import numpy as np
# See the function signature in fn/copynm.py for argument names.
```
