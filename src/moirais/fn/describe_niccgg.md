# describe('niccgg') — nakagawa_marginal_r2
...
`print(result)` render. See `moirais.fn.describe('niccgg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.niccgg import *
import numpy as np
# See the function signature in fn/niccgg.py for argument names.
```
