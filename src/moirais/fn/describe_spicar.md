# describe('spicar') — schabenberger_icar_prior
...
`print(result)` render. See `moirais.fn.describe('spicar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spicar import *
import numpy as np
# See the function signature in fn/spicar.py for argument names.
```
