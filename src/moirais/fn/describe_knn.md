...
`print(result)` render. See `moirais.fn.describe('knn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knn import *
import numpy as np
# See the function signature in fn/knn.py for argument names.
```
