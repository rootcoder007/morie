# describe('normfl') — normalizing_flow
...
`print(result)` render. See `moirais.fn.describe('normfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.normfl import *
import numpy as np
# See the function signature in fn/normfl.py for argument names.
```
