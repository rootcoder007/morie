...
`print(result)` render. See `moirais.fn.describe('twoT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.twoT import *
import numpy as np
# See the function signature in fn/twoT.py for argument names.
```
