# describe('zecon') — concentration_idx
...
`print(result)` render. See `moirais.fn.describe('zecon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zecon import *
import numpy as np
# See the function signature in fn/zecon.py for argument names.
```
