# describe('rcpar') — rcpar

## WHAT IT DOES

Party cue roll call model.
...
`print(result)` render. See `moirais.fn.describe('rcpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcpar import *
import numpy as np
# See the function signature in fn/rcpar.py for argument names.
```
