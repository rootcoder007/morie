...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_789"]


def guide_on_data_analysis_chapter_11_unnumbered_789(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: paste0("lagged_residuals_matrix", 1:p, " = 0" ))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u789')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u789: GeneralStatistics expression (auto-extracted; see ref)."
