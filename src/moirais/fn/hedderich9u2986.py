...
__all__ = ["hedderich_chapter_9_unnumbered_2986"]


def hedderich_chapter_9_unnumbered_2986(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] k = 3,n1 =n2 =n3 = 40 andn = 120, we get:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2986')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2986: GeneralStatistics expression (auto-extracted; see ref)."
