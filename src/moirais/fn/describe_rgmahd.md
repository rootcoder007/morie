# describe('rgmahd') — rangayyan_mahalanobis
...
`print(result)` render. See `moirais.fn.describe('rgmahd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmahd import *
import numpy as np
# See the function signature in fn/rgmahd.py for argument names.
```
