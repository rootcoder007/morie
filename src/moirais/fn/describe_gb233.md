# describe('gb233') — gibbons_edf_asymp_normal
...
`print(result)` render. See `moirais.fn.describe('gb233')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb233 import *
import numpy as np
# See the function signature in fn/gb233.py for argument names.
```
