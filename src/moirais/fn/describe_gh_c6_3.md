# describe('gh_c6_3') — ghosal_doob_consist
...
`print(result)` render. See `moirais.fn.describe('gh_c6_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c6_3 import *
import numpy as np
# See the function signature in fn/gh_c6_3.py for argument names.
```
