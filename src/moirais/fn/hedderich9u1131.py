...
__all__ = ["hedderich_chapter_9_unnumbered_1131"]


def hedderich_chapter_9_unnumbered_1131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2(20−7 + 1) = 28 ; 2·7 = 14 ; F28;14;0.025 = 2.75
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1131')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1131: GeneralStatistics expression (auto-extracted; see ref)."
