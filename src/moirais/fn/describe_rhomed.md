# describe('rhomed') — rho_critical_mediation
...
`print(result)` render. See `moirais.fn.describe('rhomed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rhomed import *
import numpy as np
# See the function signature in fn/rhomed.py for argument names.
```
