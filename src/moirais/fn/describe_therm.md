# describe('therm') — feeling_thermometer_scale
...
`print(result)` render. See `moirais.fn.describe('therm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.therm import *
import numpy as np
# See the function signature in fn/therm.py for argument names.
```
