# describe('cdyll') — years_life_lost
...
`print(result)` render. See `moirais.fn.describe('cdyll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdyll import *
import numpy as np
# See the function signature in fn/cdyll.py for argument names.
```
