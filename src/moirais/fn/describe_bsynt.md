# describe('bsynt') — bayesian_synthetic_control
...
`print(result)` render. See `moirais.fn.describe('bsynt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsynt import *
import numpy as np
# See the function signature in fn/bsynt.py for argument names.
```
