# describe('prder') — prediction_error_fn
...
`print(result)` render. See `moirais.fn.describe('prder')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prder import *
import numpy as np
# See the function signature in fn/prder.py for argument names.
```
