# describe('cstpg') — custody_program_rate
...
`print(result)` render. See `moirais.fn.describe('cstpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstpg import *
import numpy as np
# See the function signature in fn/cstpg.py for argument names.
```
