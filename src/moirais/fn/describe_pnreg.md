...
`print(result)` render. See `moirais.fn.describe('pnreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pnreg import *
import numpy as np
# See the function signature in fn/pnreg.py for argument names.
```
