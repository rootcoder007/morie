# describe('ksr030') — kosorok_ch2_brownian_bridge_covariance
...
`print(result)` render. See `moirais.fn.describe('ksr030')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr030 import *
import numpy as np
# See the function signature in fn/ksr030.py for argument names.
```
