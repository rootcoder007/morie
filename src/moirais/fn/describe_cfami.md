...
`print(result)` render. See `moirais.fn.describe('cfami')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfami import *
import numpy as np
# See the function signature in fn/cfami.py for argument names.
```
