...
`print(result)` render. See `moirais.fn.describe('cdreal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdreal import *
import numpy as np
# See the function signature in fn/cdreal.py for argument names.
```
