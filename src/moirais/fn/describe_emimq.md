...
`print(result)` render. See `moirais.fn.describe('emimq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emimq import *
import numpy as np
# See the function signature in fn/emimq.py for argument names.
```
