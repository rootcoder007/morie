...
`print(result)` render. See `moirais.fn.describe('srd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srd import *
import numpy as np
# See the function signature in fn/srd.py for argument names.
```
