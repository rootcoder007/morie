...
__all__ = ["use_r_chapter_2_unnumbered_257"]


def use_r_chapter_2_unnumbered_257(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] T =( r − p)TA(r − p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u257')`` for the full guide.
...
def cheatsheet():
    return "use_r2u257: GeneralStatistics expression (auto-extracted; see ref)."
