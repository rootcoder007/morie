# describe('hrzbkft') — horowitz_backfitting
...
`print(result)` render. See `moirais.fn.describe('hrzbkft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzbkft import *
import numpy as np
# See the function signature in fn/hrzbkft.py for argument names.
```
