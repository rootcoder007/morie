# describe('pacsam') — sample_partial_autocorr
...
`print(result)` render. See `moirais.fn.describe('pacsam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacsam import *
import numpy as np
# See the function signature in fn/pacsam.py for argument names.
```
