...
`print(result)` render. See `moirais.fn.describe('copgmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copgmb import *
import numpy as np
# See the function signature in fn/copgmb.py for argument names.
```
