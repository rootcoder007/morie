...
`print(result)` render. See `moirais.fn.describe('sobfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobfp import *
import numpy as np
# See the function signature in fn/sobfp.py for argument names.
```
