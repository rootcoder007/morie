# describe('unfrm') — uniform_quantize
...
`print(result)` render. See `moirais.fn.describe('unfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unfrm import *
import numpy as np
# See the function signature in fn/unfrm.py for argument names.
```
