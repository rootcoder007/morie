...
__all__ = ["wilcox_chapter_14_unnumbered_681"]


def wilcox_chapter_14_unnumbered_681(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: anova.power(groups=4,power=0.9,delta=1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u681')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u681: ANOVA expression (auto-extracted; see ref)."
