# describe('tmlhrz') — tmle_hazard_ratio
...
`print(result)` render. See `moirais.fn.describe('tmlhrz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlhrz import *
import numpy as np
# See the function signature in fn/tmlhrz.py for argument names.
```
