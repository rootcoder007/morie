...
__all__ = ["wilcox_chapter_10_unnumbered_964"]


def wilcox_chapter_10_unnumbered_964(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: That is Ψ = µ 1 +µ 2 − µ 3 − µ 4, the contrast coefficients are c1 =c2 = 1, c3 =c4 = −1, and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u964')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u964: GeneralStatistics expression (auto-extracted; see ref)."
