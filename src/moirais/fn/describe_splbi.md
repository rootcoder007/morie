...
`print(result)` render. See `moirais.fn.describe('splbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splbi import *
import numpy as np
# See the function signature in fn/splbi.py for argument names.
```
