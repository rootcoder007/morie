...
`print(result)` render. See `moirais.fn.describe('cvxepi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxepi import *
import numpy as np
# See the function signature in fn/cvxepi.py for argument names.
```
