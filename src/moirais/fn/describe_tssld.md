...
`print(result)` render. See `moirais.fn.describe('tssld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssld import *
import numpy as np
# See the function signature in fn/tssld.py for argument names.
```
