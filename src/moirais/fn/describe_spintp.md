# describe('spintp') — schabenberger_intensity_estimation
...
`print(result)` render. See `moirais.fn.describe('spintp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spintp import *
import numpy as np
# See the function signature in fn/spintp.py for argument names.
```
