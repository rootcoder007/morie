# describe('rng101') — rangayyan_ch3_running_integral_window
...
`print(result)` render. See `moirais.fn.describe('rng101')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng101 import *
import numpy as np
# See the function signature in fn/rng101.py for argument names.
```
