# describe('matern') — matern_cluster
...
`print(result)` render. See `moirais.fn.describe('matern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matern import *
import numpy as np
# See the function signature in fn/matern.py for argument names.
```
