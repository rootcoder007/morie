# describe('gb_fwt') — gibbons_fligner_wolfe_test
...
`print(result)` render. See `moirais.fn.describe('gb_fwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_fwt import *
import numpy as np
# See the function signature in fn/gb_fwt.py for argument names.
```
