...
`print(result)` render. See `moirais.fn.describe('svpwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpwt import *
import numpy as np
# See the function signature in fn/svpwt.py for argument names.
```
