...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_31(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: coord_flip() + theme_bw(base_size = 20)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('It is the mark of an educated mind to entertain a thought without accepting it. — Aristotle')`` for the full guide.
