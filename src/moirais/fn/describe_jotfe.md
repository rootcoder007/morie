# describe('jotfe') — joseph_calendar_features
...
`print(result)` render. See `moirais.fn.describe('jotfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jotfe import *
import numpy as np
# See the function signature in fn/jotfe.py for argument names.
```
