...
`print(result)` render. See `moirais.fn.describe('geinq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geinq import *
import numpy as np
# See the function signature in fn/geinq.py for argument names.
```
