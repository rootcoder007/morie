...
`print(result)` render. See `moirais.fn.describe('dpmnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmnp import *
import numpy as np
# See the function signature in fn/dpmnp.py for argument names.
```
