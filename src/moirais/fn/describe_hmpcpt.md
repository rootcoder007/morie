# describe('hmpcpt') — geron_perceptron
...
`print(result)` render. See `moirais.fn.describe('hmpcpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpcpt import *
import numpy as np
# See the function signature in fn/hmpcpt.py for argument names.
```
