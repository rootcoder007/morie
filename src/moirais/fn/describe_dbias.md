...
`print(result)` render. See `moirais.fn.describe('dbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbias import *
import numpy as np
# See the function signature in fn/dbias.py for argument names.
```
