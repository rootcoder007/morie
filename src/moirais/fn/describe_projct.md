...
`print(result)` render. See `moirais.fn.describe('projct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.projct import *
import numpy as np
# See the function signature in fn/projct.py for argument names.
```
