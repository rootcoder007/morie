...
`print(result)` render. See `moirais.fn.describe('bkpts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkpts import *
import numpy as np
# See the function signature in fn/bkpts.py for argument names.
```
