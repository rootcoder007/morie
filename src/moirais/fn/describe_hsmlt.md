...
`print(result)` render. See `moirais.fn.describe('hsmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsmlt import *
import numpy as np
# See the function signature in fn/hsmlt.py for argument names.
```
