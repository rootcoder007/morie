...
__all__ = ["hedderich_chapter_9_unnumbered_351"]


def hedderich_chapter_9_unnumbered_351(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] II ( ∑x)·lga+(∑x2)·lgb = ∑(x·lgy) (3.117)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u351')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u351: GeneralStatistics expression (auto-extracted; see ref)."
