...
`print(result)` render. See `moirais.fn.describe('ummax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ummax import *
import numpy as np
# See the function signature in fn/ummax.py for argument names.
```
