...
__all__ = ["hedderich_chapter_9_unnumbered_3639"]


def hedderich_chapter_9_unnumbered_3639(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfcol = c ( 1 , 1 ) , lwd =2 , font . a x i s=2 , b t y =" n " , ps =15)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3639')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3639: GeneralStatistics expression (auto-extracted; see ref)."
