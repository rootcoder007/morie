# describe('fourT') — fourier_transform
...
`print(result)` render. See `moirais.fn.describe('fourT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fourT import *
import numpy as np
# See the function signature in fn/fourT.py for argument names.
```
