# describe('gh_ppt_consist') — ghosal_polya_tree_consist_rate
...
`print(result)` render. See `moirais.fn.describe('gh_ppt_consist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ppt_consist import *
import numpy as np
# See the function signature in fn/gh_ppt_consist.py for argument names.
```
