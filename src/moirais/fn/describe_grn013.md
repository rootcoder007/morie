# describe('grn013') — geron_ch4_elastic_net_cost_function
...
`print(result)` render. See `moirais.fn.describe('grn013')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grn013 import *
import numpy as np
# See the function signature in fn/grn013.py for argument names.
```
