...
__all__ = ["wilcox_chapter_14_unnumbered_726"]


def wilcox_chapter_14_unnumbered_726(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ 1 − θ 2 =θ 2 − θ 3 =θ 1 − θ 3 = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u726')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u726: PowerAndDesign expression (auto-extracted; see ref)."
