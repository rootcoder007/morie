# describe('gh_c3_14') — ghosal_mpt_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c3_14')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_14 import *
import numpy as np
# See the function signature in fn/gh_c3_14.py for argument names.
```
