...
`print(result)` render. See `moirais.fn.describe('f_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.f_es import *
import numpy as np
# See the function signature in fn/f_es.py for argument names.
```
