...
`print(result)` render. See `moirais.fn.describe('cram')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cram import *
import numpy as np
# See the function signature in fn/cram.py for argument names.
```
