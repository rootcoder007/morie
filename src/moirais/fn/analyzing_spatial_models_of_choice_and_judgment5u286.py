...
def analyzing_spatial_models_of_choice_and_judgment_chapter_5_unnumbered_286(x):
    """
    Bayesian expression (auto-extracted; see ref).

    Formula: beta = list(mu = 0, sigma2 = 100))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment5u286')`` for the full guide.
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment5u286: Bayesian expression (auto-extracted; see ref)."
