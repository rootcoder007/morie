# describe('mambss') — mamba_ssm_step
...
`print(result)` render. See `moirais.fn.describe('mambss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mambss import *
import numpy as np
# See the function signature in fn/mambss.py for argument names.
```
