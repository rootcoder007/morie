...
`print(result)` render. See `moirais.fn.describe('nblmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nblmx import *
import numpy as np
# See the function signature in fn/nblmx.py for argument names.
```
