# describe('mlsms') — mlsmu6_missing_impute
...
`print(result)` render. See `moirais.fn.describe('mlsms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlsms import *
import numpy as np
# See the function signature in fn/mlsms.py for argument names.
```
