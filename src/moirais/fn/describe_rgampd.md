# describe('rgampd') — rangayyan_amplitude_demod
...
`print(result)` render. See `moirais.fn.describe('rgampd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgampd import *
import numpy as np
# See the function signature in fn/rgampd.py for argument names.
```
