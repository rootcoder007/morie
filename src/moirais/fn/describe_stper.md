...
`print(result)` render. See `moirais.fn.describe('stper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stper import *
import numpy as np
# See the function signature in fn/stper.py for argument names.
```
