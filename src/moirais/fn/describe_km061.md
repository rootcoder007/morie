# describe('km061') — kamath_ch4_krona_output
...
`print(result)` render. See `moirais.fn.describe('km061')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km061 import *
import numpy as np
# See the function signature in fn/km061.py for argument names.
```
