# describe('dimts') — dimensionality_test
...
`print(result)` render. See `moirais.fn.describe('dimts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dimts import *
import numpy as np
# See the function signature in fn/dimts.py for argument names.
```
