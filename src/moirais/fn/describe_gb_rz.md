# describe('gb_rz') — gibbons_rz_test
...
`print(result)` render. See `moirais.fn.describe('gb_rz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_rz import *
import numpy as np
# See the function signature in fn/gb_rz.py for argument names.
```
