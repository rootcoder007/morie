# describe('phyltr') — phylogenetic_tree_nj
...
`print(result)` render. See `moirais.fn.describe('phyltr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phyltr import *
import numpy as np
# See the function signature in fn/phyltr.py for argument names.
```
