# describe('hmdld') — geron_dataloader
...
`print(result)` render. See `moirais.fn.describe('hmdld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdld import *
import numpy as np
# See the function signature in fn/hmdld.py for argument names.
```
