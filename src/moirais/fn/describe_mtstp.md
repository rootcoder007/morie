...
`print(result)` render. See `moirais.fn.describe('mtstp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtstp import *
import numpy as np
# See the function signature in fn/mtstp.py for argument names.
```
