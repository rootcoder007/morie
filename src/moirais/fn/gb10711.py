...
def gibbons_ctrl_normal_asymp(groups, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Asymptotic normality of k-sample control median test vector W_N"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Asymptotic normality of k-sample control median test vector W_N"})
