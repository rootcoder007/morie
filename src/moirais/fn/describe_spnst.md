# describe('spnst') — schabenberger_nonstationary_cov
...
`print(result)` render. See `moirais.fn.describe('spnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnst import *
import numpy as np
# See the function signature in fn/spnst.py for argument names.
```
