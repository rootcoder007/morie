...
`print(result)` render. See `moirais.fn.describe('wlsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlsdm import *
import numpy as np
# See the function signature in fn/wlsdm.py for argument names.
```
