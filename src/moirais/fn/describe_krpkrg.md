# describe('krpkrg') — poisson_kriging
...
`print(result)` render. See `moirais.fn.describe('krpkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krpkrg import *
import numpy as np
# See the function signature in fn/krpkrg.py for argument names.
```
