# describe('gibbs') — gibbs_bivariate_normal
...
`print(result)` render. See `moirais.fn.describe('gibbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gibbs import *
import numpy as np
# See the function signature in fn/gibbs.py for argument names.
```
