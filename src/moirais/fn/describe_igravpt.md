...
`print(result)` render. See `moirais.fn.describe('igravpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravpt import *
import numpy as np
# See the function signature in fn/igravpt.py for argument names.
```
