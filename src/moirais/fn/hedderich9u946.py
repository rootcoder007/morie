...
__all__ = ["hedderich_chapter_9_unnumbered_946"]


def hedderich_chapter_9_unnumbered_946(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 8. Γ (x + 1) = xΓ(x) for allx> 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u946')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u946: GeneralStatistics expression (auto-extracted; see ref)."
