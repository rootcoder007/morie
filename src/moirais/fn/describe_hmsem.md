# describe('hmsem') — geron_semisupervised
...
`print(result)` render. See `moirais.fn.describe('hmsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsem import *
import numpy as np
# See the function signature in fn/hmsem.py for argument names.
```
