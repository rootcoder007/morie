...
`print(result)` render. See `moirais.fn.describe('kgbkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgbkd import *
import numpy as np
# See the function signature in fn/kgbkd.py for argument names.
```
