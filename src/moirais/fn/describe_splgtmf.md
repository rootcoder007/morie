...
`print(result)` render. See `moirais.fn.describe('splgtmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgtmf import *
import numpy as np
# See the function signature in fn/splgtmf.py for argument names.
```
