...
`print(result)` render. See `moirais.fn.describe('masat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masat import *
import numpy as np
# See the function signature in fn/masat.py for argument names.
```
