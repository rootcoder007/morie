...
`print(result)` render. See `moirais.fn.describe('bwaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwaic import *
import numpy as np
# See the function signature in fn/bwaic.py for argument names.
```
