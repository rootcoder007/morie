...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1202"]


def guide_on_data_analysis_chapter_24_unnumbered_1202(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] • 𝑛11 = 𝑛13 = 2, 𝑛12 = 1, 𝑛21 = 𝑛22 = 2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1202')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1202: GeneralStatistics expression (auto-extracted; see ref)."
