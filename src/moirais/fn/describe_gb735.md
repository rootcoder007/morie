# describe('gb735') — gibbons_linrank_sym_equal
...
`print(result)` render. See `moirais.fn.describe('gb735')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb735 import *
import numpy as np
# See the function signature in fn/gb735.py for argument names.
```
