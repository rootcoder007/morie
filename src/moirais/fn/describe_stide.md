...
`print(result)` render. See `moirais.fn.describe('stide')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stide import *
import numpy as np
# See the function signature in fn/stide.py for argument names.
```
