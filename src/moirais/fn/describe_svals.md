...
`print(result)` render. See `moirais.fn.describe('svals')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svals import *
import numpy as np
# See the function signature in fn/svals.py for argument names.
```
