...
__all__ = ["hedderich_chapter_9_unnumbered_706"]


def hedderich_chapter_9_unnumbered_706(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] = 1−0.736 = 0.264 = P (X >1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u706')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u706: CountModels expression (auto-extracted; see ref)."
