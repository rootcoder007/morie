# describe('pqenc') — polarquant_encode
...
`print(result)` render. See `moirais.fn.describe('pqenc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pqenc import *
import numpy as np
# See the function signature in fn/pqenc.py for argument names.
```
