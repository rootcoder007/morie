# describe('elpdc') — expected_log_predictive_density
...
`print(result)` render. See `moirais.fn.describe('elpdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elpdc import *
import numpy as np
# See the function signature in fn/elpdc.py for argument names.
```
