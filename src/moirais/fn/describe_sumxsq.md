...
`print(result)` render. See `moirais.fn.describe('sumxsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sumxsq import *
import numpy as np
# See the function signature in fn/sumxsq.py for argument names.
```
