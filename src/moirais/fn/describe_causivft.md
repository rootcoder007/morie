# describe('causivft') — causal_iv_first_stage
...
`print(result)` render. See `moirais.fn.describe('causivft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causivft import *
import numpy as np
# See the function signature in fn/causivft.py for argument names.
```
