...
`print(result)` render. See `moirais.fn.describe('mlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlp import *
import numpy as np
# See the function signature in fn/mlp.py for argument names.
```
