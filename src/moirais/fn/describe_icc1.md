...
`print(result)` render. See `moirais.fn.describe('icc1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc1 import *
import numpy as np
# See the function signature in fn/icc1.py for argument names.
```
