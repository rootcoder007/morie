# describe('km133') — kamath_ch9_clip_image_to_text
...
`print(result)` render. See `moirais.fn.describe('km133')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km133 import *
import numpy as np
# See the function signature in fn/km133.py for argument names.
```
