...
__all__ = ["wilcox_chapter_14_unnumbered_686"]


def wilcox_chapter_14_unnumbered_686(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The ANOV A F test yields F = 2.7 with a critical value of 3.24 when α = 0.05, so you do
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u686')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u686: GeneralStatistics expression (auto-extracted; see ref)."
