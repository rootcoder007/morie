...
`print(result)` render. See `moirais.fn.describe('prc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prc import *
import numpy as np
# See the function signature in fn/prc.py for argument names.
```
