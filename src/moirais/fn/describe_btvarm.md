...
`print(result)` render. See `moirais.fn.describe('btvarm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btvarm import *
import numpy as np
# See the function signature in fn/btvarm.py for argument names.
```
