...
__all__ = ["hedderich_chapter_9_unnumbered_2224"]


def hedderich_chapter_9_unnumbered_2224(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: count 1 = 10 , expectedcount 1 = 6 , p− value = 0 .0 3 8 57
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2224')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2224: CountModels expression (auto-extracted; see ref)."
