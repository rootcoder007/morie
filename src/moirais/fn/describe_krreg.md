...
`print(result)` render. See `moirais.fn.describe('krreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krreg import *
import numpy as np
# See the function signature in fn/krreg.py for argument names.
```
