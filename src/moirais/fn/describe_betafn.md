...
`print(result)` render. See `moirais.fn.describe('betafn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.betafn import *
import numpy as np
# See the function signature in fn/betafn.py for argument names.
```
