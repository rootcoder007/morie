...
__all__ = ["hedderich_chapter_9_unnumbered_3593"]


def hedderich_chapter_9_unnumbered_3593(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (Yi)δi·S(Yi)1−δi
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3593')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3593: GeneralStatistics expression (auto-extracted; see ref)."
