# describe('tmlmed') — tmle_mediation
...
`print(result)` render. See `moirais.fn.describe('tmlmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmed import *
import numpy as np
# See the function signature in fn/tmlmed.py for argument names.
```
