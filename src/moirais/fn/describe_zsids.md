...
`print(result)` render. See `moirais.fn.describe('zsids')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsids import *
import numpy as np
# See the function signature in fn/zsids.py for argument names.
```
