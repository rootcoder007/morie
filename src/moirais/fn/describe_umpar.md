...
`print(result)` render. See `moirais.fn.describe('umpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umpar import *
import numpy as np
# See the function signature in fn/umpar.py for argument names.
```
