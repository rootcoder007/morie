# describe('bndmoq') — bound_moment_qed
...
`print(result)` render. See `moirais.fn.describe('bndmoq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndmoq import *
import numpy as np
# See the function signature in fn/bndmoq.py for argument names.
```
