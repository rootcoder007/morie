...
`print(result)` render. See `moirais.fn.describe('sgblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgblk import *
import numpy as np
# See the function signature in fn/sgblk.py for argument names.
```
