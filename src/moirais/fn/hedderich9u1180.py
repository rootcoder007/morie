...
__all__ = ["hedderich_chapter_9_unnumbered_1180"]


def hedderich_chapter_9_unnumbered_1180(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˘p1 = (x1 + 1)/(n1 + 2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1180')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1180: GeneralStatistics expression (auto-extracted; see ref)."
