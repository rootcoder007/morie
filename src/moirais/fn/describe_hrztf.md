# describe('hrztf') — horowitz_both_nonpar_transform
...
`print(result)` render. See `moirais.fn.describe('hrztf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztf import *
import numpy as np
# See the function signature in fn/hrztf.py for argument names.
```
