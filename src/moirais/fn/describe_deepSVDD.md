...
`print(result)` render. See `moirais.fn.describe('deepSVDD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deepSVDD import *
import numpy as np
# See the function signature in fn/deepSVDD.py for argument names.
```
