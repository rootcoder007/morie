...
__all__ = ["hedderich_chapter_9_unnumbered_2246"]


def hedderich_chapter_9_unnumbered_2246(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Cx = #{i : |xi−µx|>max|yj−µy|}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2246')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2246: GeneralStatistics expression (auto-extracted; see ref)."
