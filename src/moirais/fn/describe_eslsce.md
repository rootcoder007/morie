# describe('eslsce') — esl_score_match
...
`print(result)` render. See `moirais.fn.describe('eslsce')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsce import *
import numpy as np
# See the function signature in fn/eslsce.py for argument names.
```
