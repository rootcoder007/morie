...
`print(result)` render. See `moirais.fn.describe('omprs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omprs import *
import numpy as np
# See the function signature in fn/omprs.py for argument names.
```
