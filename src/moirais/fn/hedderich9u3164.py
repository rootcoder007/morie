...
__all__ = ["hedderich_chapter_9_unnumbered_3164"]


def hedderich_chapter_9_unnumbered_3164(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: earlier forτwithn> 10 than forρS.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3164')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3164: GeneralStatistics expression (auto-extracted; see ref)."
