# describe('smbln') — smd_balance

## WHAT IT DOES

Standardized mean difference balance check. 'Difficulties strengthen the mind, as labor does the body. — Seneca'
...
`print(result)` render. See `moirais.fn.describe('smbln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smbln import *
import numpy as np
# See the function signature in fn/smbln.py for argument names.
```
