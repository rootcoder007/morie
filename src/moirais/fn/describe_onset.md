# describe('onset') — onset_detect_fn
...
`print(result)` render. See `moirais.fn.describe('onset')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.onset import *
import numpy as np
# See the function signature in fn/onset.py for argument names.
```
