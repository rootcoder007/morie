...
`print(result)` render. See `moirais.fn.describe('difsbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difsbs import *
import numpy as np
# See the function signature in fn/difsbs.py for argument names.
```
