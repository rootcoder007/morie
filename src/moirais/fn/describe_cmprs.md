# describe('cmprs') — competing_risks
...
`print(result)` render. See `moirais.fn.describe('cmprs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmprs import *
import numpy as np
# See the function signature in fn/cmprs.py for argument names.
```
