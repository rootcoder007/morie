# describe('msprr') — procrustes_resid
...
`print(result)` render. See `moirais.fn.describe('msprr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msprr import *
import numpy as np
# See the function signature in fn/msprr.py for argument names.
```
