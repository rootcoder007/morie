# describe('mard') — ma_risk_difference
...
`print(result)` render. See `moirais.fn.describe('mard')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mard import *
import numpy as np
# See the function signature in fn/mard.py for argument names.
```
