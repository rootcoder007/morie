...
__all__ = ["hedderich_chapter_9_unnumbered_786"]


def hedderich_chapter_9_unnumbered_786(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u786')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u786: GeneralStatistics expression (auto-extracted; see ref)."
