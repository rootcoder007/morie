...
`print(result)` render. See `moirais.fn.describe('linit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linit import *
import numpy as np
# See the function signature in fn/linit.py for argument names.
```
