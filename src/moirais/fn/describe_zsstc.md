...
`print(result)` render. See `moirais.fn.describe('zsstc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsstc import *
import numpy as np
# See the function signature in fn/zsstc.py for argument names.
```
