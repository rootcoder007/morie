# describe('wsmpst') — wasserman_plug_in_estimator
...
`print(result)` render. See `moirais.fn.describe('wsmpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmpst import *
import numpy as np
# See the function signature in fn/wsmpst.py for argument names.
```
