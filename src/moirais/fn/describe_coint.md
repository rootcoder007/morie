# describe('coint') — cointegration_test
...
`print(result)` render. See `moirais.fn.describe('coint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coint import *
import numpy as np
# See the function signature in fn/coint.py for argument names.
```
