...
`print(result)` render. See `moirais.fn.describe('stcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stcov import *
import numpy as np
# See the function signature in fn/stcov.py for argument names.
```
