# describe('msm144') — mvsml_categorical_count_eq_8_10
...
`print(result)` render. See `moirais.fn.describe('msm144')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm144 import *
import numpy as np
# See the function signature in fn/msm144.py for argument names.
```
