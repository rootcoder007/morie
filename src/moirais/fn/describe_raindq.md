...
`print(result)` render. See `moirais.fn.describe('raindq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raindq import *
import numpy as np
# See the function signature in fn/raindq.py for argument names.
```
