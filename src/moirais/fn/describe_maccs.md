...
`print(result)` render. See `moirais.fn.describe('maccs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maccs import *
import numpy as np
# See the function signature in fn/maccs.py for argument names.
```
