...
__all__ = ["hedderich_chapter_9_unnumbered_966"]


def hedderich_chapter_9_unnumbered_966(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: „two-sided” Prob. P (t≤t1−α/2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u966')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u966: GeneralStatistics expression (auto-extracted; see ref)."
