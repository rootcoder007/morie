...
__all__ = ["hedderich_chapter_9_unnumbered_25"]


def hedderich_chapter_9_unnumbered_25(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 6·2 + 8 : 4 = 12 + 2 = 14
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u25')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u25: GeneralStatistics expression (auto-extracted; see ref)."
