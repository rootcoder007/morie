# describe('ipwsrv') — ipw_with_survey_weights
...
`print(result)` render. See `moirais.fn.describe('ipwsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipwsrv import *
import numpy as np
# See the function signature in fn/ipwsrv.py for argument names.
```
