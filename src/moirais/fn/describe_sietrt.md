...
`print(result)` render. See `moirais.fn.describe('sietrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sietrt import *
import numpy as np
# See the function signature in fn/sietrt.py for argument names.
```
