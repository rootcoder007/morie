# describe('itinft') — item_information_function
...
`print(result)` render. See `moirais.fn.describe('itinft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itinft import *
import numpy as np
# See the function signature in fn/itinft.py for argument names.
```
