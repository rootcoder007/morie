...
`print(result)` render. See `moirais.fn.describe('sacaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacaic import *
import numpy as np
# See the function signature in fn/sacaic.py for argument names.
```
