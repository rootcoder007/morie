# describe('taubrg') — tau_estimator_regression
...
`print(result)` render. See `moirais.fn.describe('taubrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taubrg import *
import numpy as np
# See the function signature in fn/taubrg.py for argument names.
```
