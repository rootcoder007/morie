# describe('causgsw') — causal_generalisability_smd
...
`print(result)` render. See `moirais.fn.describe('causgsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causgsw import *
import numpy as np
# See the function signature in fn/causgsw.py for argument names.
```
