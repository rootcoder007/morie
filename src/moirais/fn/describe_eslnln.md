# describe('eslnln') — esl_elastic_net
...
`print(result)` render. See `moirais.fn.describe('eslnln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnln import *
import numpy as np
# See the function signature in fn/eslnln.py for argument names.
```
