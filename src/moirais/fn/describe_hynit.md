...
`print(result)` render. See `moirais.fn.describe('hynit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hynit import *
import numpy as np
# See the function signature in fn/hynit.py for argument names.
```
