...
`print(result)` render. See `moirais.fn.describe('ppmov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmov import *
import numpy as np
# See the function signature in fn/ppmov.py for argument names.
```
