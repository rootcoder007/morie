...
`print(result)` render. See `moirais.fn.describe('mvtdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtdv import *
import numpy as np
# See the function signature in fn/mvtdv.py for argument names.
```
