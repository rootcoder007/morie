...
`print(result)` render. See `moirais.fn.describe('mamod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mamod import *
import numpy as np
# See the function signature in fn/mamod.py for argument names.
```
