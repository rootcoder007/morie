# describe('ca11e37') — ca_chapter_11_equation_37
...
```python
from moirais.fn.ca11e37 import ca_chapter_11_equation_37
import numpy as np
result = ca_chapter_11_equation_37(np.random.default_rng(42).normal(0, 1, 100))
