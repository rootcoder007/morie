# describe('gearyl') — local_gearys_c
...
`print(result)` render. See `moirais.fn.describe('gearyl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gearyl import *
import numpy as np
# See the function signature in fn/gearyl.py for argument names.
```
