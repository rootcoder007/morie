...
`print(result)` render. See `moirais.fn.describe('gdtnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdtnd import *
import numpy as np
# See the function signature in fn/gdtnd.py for argument names.
```
