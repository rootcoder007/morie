...
__all__ = ["hedderich_chapter_9_unnumbered_1358"]


def hedderich_chapter_9_unnumbered_1358(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Forn = 51 ands2 = 2, we obtain the 95% confidence interval (α= 0.05), i.e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1358')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1358: GeneralStatistics expression (auto-extracted; see ref)."
