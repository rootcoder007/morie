...
__all__ = ["guide_on_data_analysis_chapter_7_unnumbered_602"]


def guide_on_data_analysis_chapter_7_unnumbered_602(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = sign(𝑦𝑖 − ̂ 𝜇𝑖)√𝑑𝑖
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis7u602')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis7u602: GeneralStatistics expression (auto-extracted; see ref)."
