# describe('twins') — phase_locking_value
...
`print(result)` render. See `moirais.fn.describe('twins')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.twins import *
import numpy as np
# See the function signature in fn/twins.py for argument names.
```
