...
`print(result)` render. See `moirais.fn.describe('hmpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpd import *
import numpy as np
# See the function signature in fn/hmpd.py for argument names.
```
