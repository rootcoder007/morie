# describe('logmg') — log_magnitude_spectrum
...
`print(result)` render. See `moirais.fn.describe('logmg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logmg import *
import numpy as np
# See the function signature in fn/logmg.py for argument names.
```
