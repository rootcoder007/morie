...
`print(result)` render. See `moirais.fn.describe('hydrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydrf import *
import numpy as np
# See the function signature in fn/hydrf.py for argument names.
```
