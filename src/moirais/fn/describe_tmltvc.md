# describe('tmltvc') — tmle_time_varying_confound
...
`print(result)` render. See `moirais.fn.describe('tmltvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmltvc import *
import numpy as np
# See the function signature in fn/tmltvc.py for argument names.
```
