...
`print(result)` render. See `moirais.fn.describe('tbens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbens import *
import numpy as np
# See the function signature in fn/tbens.py for argument names.
```
