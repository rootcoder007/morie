# describe('ksr12') — kosorok_information_bound
...
`print(result)` render. See `moirais.fn.describe('ksr12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr12 import *
import numpy as np
# See the function signature in fn/ksr12.py for argument names.
```
