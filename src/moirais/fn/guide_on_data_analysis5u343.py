...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_343"]


def guide_on_data_analysis_chapter_5_unnumbered_343(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] −2𝐸(𝑥′(𝑦 − 𝑥𝛾)) = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u343')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u343: GeneralStatistics expression (auto-extracted; see ref)."
