# describe('zekex') — kernel_exposure
...
`print(result)` render. See `moirais.fn.describe('zekex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zekex import *
import numpy as np
# See the function signature in fn/zekex.py for argument names.
```
