# describe('basisR') — basis_representation
...
`print(result)` render. See `moirais.fn.describe('basisR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.basisR import *
import numpy as np
# See the function signature in fn/basisR.py for argument names.
```
