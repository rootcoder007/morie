...
__all__ = ["hedderich_chapter_9_unnumbered_3017"]


def hedderich_chapter_9_unnumbered_3017(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] > npow . chisq (w= 0 . 3 , r =2 , c =3 , alpha = 0 . 0 5 , power = 0 . 8 0 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3017')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3017: PowerAndDesign expression (auto-extracted; see ref)."
