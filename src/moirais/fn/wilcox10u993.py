...
__all__ = ["wilcox_chapter_10_unnumbered_993"]


def wilcox_chapter_10_unnumbered_993(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: qb values written in ascending order, and let u = (1 − α )B,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u993')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u993: GeneralStatistics expression (auto-extracted; see ref)."
