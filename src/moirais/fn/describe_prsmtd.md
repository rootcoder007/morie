# describe('prsmtd') — propensity_score_method
...
`print(result)` render. See `moirais.fn.describe('prsmtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsmtd import *
import numpy as np
# See the function signature in fn/prsmtd.py for argument names.
```
