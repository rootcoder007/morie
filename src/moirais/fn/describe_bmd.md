...
`print(result)` render. See `moirais.fn.describe('bmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmd import *
import numpy as np
# See the function signature in fn/bmd.py for argument names.
```
