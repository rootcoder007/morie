...
`print(result)` render. See `moirais.fn.describe('tmtrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmtrnd import *
import numpy as np
# See the function signature in fn/tmtrnd.py for argument names.
```
