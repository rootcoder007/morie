# describe('msm198') — mvsml_ridge_lasso_elastic_eq_9_26
...
`print(result)` render. See `moirais.fn.describe('msm198')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm198 import *
import numpy as np
# See the function signature in fn/msm198.py for argument names.
```
