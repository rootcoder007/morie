...
`print(result)` render. See `moirais.fn.describe('serhm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.serhm import *
import numpy as np
# See the function signature in fn/serhm.py for argument names.
```
