...
`print(result)` render. See `moirais.fn.describe('raman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raman import *
import numpy as np
# See the function signature in fn/raman.py for argument names.
```
