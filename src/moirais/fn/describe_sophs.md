...
`print(result)` render. See `moirais.fn.describe('sophs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sophs import *
import numpy as np
# See the function signature in fn/sophs.py for argument names.
```
