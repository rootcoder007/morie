...
`print(result)` render. See `moirais.fn.describe('zxhvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxhvr import *
import numpy as np
# See the function signature in fn/zxhvr.py for argument names.
```
