# describe('gelutn') — gelu_tanh_approx
...
`print(result)` render. See `moirais.fn.describe('gelutn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gelutn import *
import numpy as np
# See the function signature in fn/gelutn.py for argument names.
```
