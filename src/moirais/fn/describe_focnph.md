...
`print(result)` render. See `moirais.fn.describe('focnph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focnph import *
import numpy as np
# See the function signature in fn/focnph.py for argument names.
```
