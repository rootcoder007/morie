# describe('kmroug') — kamath_rouge_n
...
`print(result)` render. See `moirais.fn.describe('kmroug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmroug import *
import numpy as np
# See the function signature in fn/kmroug.py for argument names.
```
