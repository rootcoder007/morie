...
__all__ = ["hedderich_chapter_9_unnumbered_730"]


def hedderich_chapter_9_unnumbered_730(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u730')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u730: CountModels expression (auto-extracted; see ref)."
