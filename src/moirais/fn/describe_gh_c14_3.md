# describe('gh_c14_3') — ghosal_crp_def
...
`print(result)` render. See `moirais.fn.describe('gh_c14_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_3 import *
import numpy as np
# See the function signature in fn/gh_c14_3.py for argument names.
```
