# describe('scmaba') — synthetic_control_method
...
`print(result)` render. See `moirais.fn.describe('scmaba')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scmaba import *
import numpy as np
# See the function signature in fn/scmaba.py for argument names.
```
