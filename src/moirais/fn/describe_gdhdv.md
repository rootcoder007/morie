...
`print(result)` render. See `moirais.fn.describe('gdhdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdhdv import *
import numpy as np
# See the function signature in fn/gdhdv.py for argument names.
```
