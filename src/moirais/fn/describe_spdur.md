...
`print(result)` render. See `moirais.fn.describe('spdur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spdur import *
import numpy as np
# See the function signature in fn/spdur.py for argument names.
```
