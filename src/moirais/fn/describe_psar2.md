# describe('psar2') — polar_surface_area
...
`print(result)` render. See `moirais.fn.describe('psar2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psar2 import *
import numpy as np
# See the function signature in fn/psar2.py for argument names.
```
