# describe('rng123') — rangayyan_ch3_butterworth_lowpass_squared_magnitude
...
`print(result)` render. See `moirais.fn.describe('rng123')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng123 import *
import numpy as np
# See the function signature in fn/rng123.py for argument names.
```
