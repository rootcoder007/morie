# describe('gh_dp_kl_nbhd') — ghosal_dp_kl_nbhd_mass
...
`print(result)` render. See `moirais.fn.describe('gh_dp_kl_nbhd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_dp_kl_nbhd import *
import numpy as np
# See the function signature in fn/gh_dp_kl_nbhd.py for argument names.
```
