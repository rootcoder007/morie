# describe('frcdm') — fractal_dimension
...
`print(result)` render. See `moirais.fn.describe('frcdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frcdm import *
import numpy as np
# See the function signature in fn/frcdm.py for argument names.
```
