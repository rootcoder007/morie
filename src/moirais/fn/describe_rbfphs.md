...
`print(result)` render. See `moirais.fn.describe('rbfphs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfphs import *
import numpy as np
# See the function signature in fn/rbfphs.py for argument names.
```
