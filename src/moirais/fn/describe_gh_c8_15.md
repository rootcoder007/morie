# describe('gh_c8_15') — ghosal_alpha_pst_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c8_15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c8_15 import *
import numpy as np
# See the function signature in fn/gh_c8_15.py for argument names.
```
