# describe('msm183') — mvsml_ridge_lasso_elastic_eq_9_8
...
`print(result)` render. See `moirais.fn.describe('msm183')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm183 import *
import numpy as np
# See the function signature in fn/msm183.py for argument names.
```
