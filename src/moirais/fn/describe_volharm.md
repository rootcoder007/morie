# describe('volharm') — vol_harmonic_volatility
...
`print(result)` render. See `moirais.fn.describe('volharm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volharm import *
import numpy as np
# See the function signature in fn/volharm.py for argument names.
```
