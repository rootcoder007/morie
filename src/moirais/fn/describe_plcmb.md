# describe('plcmb') — plot_coombs_data
...
`print(result)` render. See `moirais.fn.describe('plcmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcmb import *
import numpy as np
# See the function signature in fn/plcmb.py for argument names.
```
