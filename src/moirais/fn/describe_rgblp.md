# describe('rgblp') — rangayyan_butterworth_lp
...
`print(result)` render. See `moirais.fn.describe('rgblp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgblp import *
import numpy as np
# See the function signature in fn/rgblp.py for argument names.
```
