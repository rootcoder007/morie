...
`print(result)` render. See `moirais.fn.describe('zands')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zands import *
import numpy as np
# See the function signature in fn/zands.py for argument names.
```
