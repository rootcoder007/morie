...
`print(result)` render. See `moirais.fn.describe('chlcnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlcnd import *
import numpy as np
# See the function signature in fn/chlcnd.py for argument names.
```
