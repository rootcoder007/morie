...
`print(result)` render. See `moirais.fn.describe('scpois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpois import *
import numpy as np
# See the function signature in fn/scpois.py for argument names.
```
