...
__all__ = ["bivand2013_chapter_7_unnumbered_232"]


def bivand2013_chapter_7_unnumbered_232(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, listw = NYlistwW, model = "error", het = FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u232')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u232: GeneralStatistics expression (auto-extracted; see ref)."
