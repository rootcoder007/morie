...
`print(result)` render. See `moirais.fn.describe('acfub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfub import *
import numpy as np
# See the function signature in fn/acfub.py for argument names.
```
