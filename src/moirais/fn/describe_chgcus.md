# describe('chgcus') — changepoint_cusum
...
`print(result)` render. See `moirais.fn.describe('chgcus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chgcus import *
import numpy as np
# See the function signature in fn/chgcus.py for argument names.
```
