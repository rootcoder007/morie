# describe('dpgen') — dirichlet_process_gen
...
`print(result)` render. See `moirais.fn.describe('dpgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgen import *
import numpy as np
# See the function signature in fn/dpgen.py for argument names.
```
