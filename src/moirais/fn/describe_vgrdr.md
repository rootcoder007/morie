...
`print(result)` render. See `moirais.fn.describe('vgrdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgrdr import *
import numpy as np
# See the function signature in fn/vgrdr.py for argument names.
```
