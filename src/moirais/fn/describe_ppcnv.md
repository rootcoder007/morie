...
`print(result)` render. See `moirais.fn.describe('ppcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppcnv import *
import numpy as np
# See the function signature in fn/ppcnv.py for argument names.
```
