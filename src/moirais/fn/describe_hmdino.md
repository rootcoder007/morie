...
`print(result)` render. See `moirais.fn.describe('hmdino')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdino import *
import numpy as np
# See the function signature in fn/hmdino.py for argument names.
```
