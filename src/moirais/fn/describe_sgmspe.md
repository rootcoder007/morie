...
`print(result)` render. See `moirais.fn.describe('sgmspe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmspe import *
import numpy as np
# See the function signature in fn/sgmspe.py for argument names.
```
