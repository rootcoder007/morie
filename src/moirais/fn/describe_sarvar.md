...
`print(result)` render. See `moirais.fn.describe('sarvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarvar import *
import numpy as np
# See the function signature in fn/sarvar.py for argument names.
```
