# describe('msm063') — mvsml_bayesian_regression_eq_6_7
...
`print(result)` render. See `moirais.fn.describe('msm063')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm063 import *
import numpy as np
# See the function signature in fn/msm063.py for argument names.
```
