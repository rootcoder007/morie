# describe('bayoptr') — bayesian_optimization
...
`print(result)` render. See `moirais.fn.describe('bayoptr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayoptr import *
import numpy as np
# See the function signature in fn/bayoptr.py for argument names.
```
