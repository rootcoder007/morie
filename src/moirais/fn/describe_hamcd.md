...
`print(result)` render. See `moirais.fn.describe('hamcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hamcd import *
import numpy as np
# See the function signature in fn/hamcd.py for argument names.
```
