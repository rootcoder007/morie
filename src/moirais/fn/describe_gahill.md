...
`print(result)` render. See `moirais.fn.describe('gahill')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gahill import *
import numpy as np
# See the function signature in fn/gahill.py for argument names.
```
