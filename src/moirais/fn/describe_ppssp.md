...
`print(result)` render. See `moirais.fn.describe('ppssp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppssp import *
import numpy as np
# See the function signature in fn/ppssp.py for argument names.
```
