# describe('volegar') — vol_egarch_fit
...
`print(result)` render. See `moirais.fn.describe('volegar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volegar import *
import numpy as np
# See the function signature in fn/volegar.py for argument names.
```
