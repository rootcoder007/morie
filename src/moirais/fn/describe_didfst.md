...
`print(result)` render. See `moirais.fn.describe('didfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.didfst import *
import numpy as np
# See the function signature in fn/didfst.py for argument names.
```
