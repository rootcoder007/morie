...
`print(result)` render. See `moirais.fn.describe('tssre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssre import *
import numpy as np
# See the function signature in fn/tssre.py for argument names.
```
