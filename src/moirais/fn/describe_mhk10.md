...
`print(result)` render. See `moirais.fn.describe('mhk10')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhk10 import *
import numpy as np
# See the function signature in fn/mhk10.py for argument names.
```
