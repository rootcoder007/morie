# describe('suage') — substance_by_age
...
`print(result)` render. See `moirais.fn.describe('suage')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suage import *
import numpy as np
# See the function signature in fn/suage.py for argument names.
```
