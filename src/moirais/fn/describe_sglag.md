# describe('sglag') — lagrange_kriging_system
...
`print(result)` render. See `moirais.fn.describe('sglag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglag import *
import numpy as np
# See the function signature in fn/sglag.py for argument names.
```
