# describe('evgevs') — evt_gev_sample
...
`print(result)` render. See `moirais.fn.describe('evgevs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevs import *
import numpy as np
# See the function signature in fn/evgevs.py for argument names.
```
