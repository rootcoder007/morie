# describe('gh_emp_bayes') — ghosal_empirical_bayes_np
...
`print(result)` render. See `moirais.fn.describe('gh_emp_bayes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_emp_bayes import *
import numpy as np
# See the function signature in fn/gh_emp_bayes.py for argument names.
```
