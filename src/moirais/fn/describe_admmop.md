...
`print(result)` render. See `moirais.fn.describe('admmop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.admmop import *
import numpy as np
# See the function signature in fn/admmop.py for argument names.
```
