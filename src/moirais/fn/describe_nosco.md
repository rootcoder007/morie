# describe('nosco') — nominate_score_types
...
`print(result)` render. See `moirais.fn.describe('nosco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nosco import *
import numpy as np
# See the function signature in fn/nosco.py for argument names.
```
