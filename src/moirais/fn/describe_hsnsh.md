...
`print(result)` render. See `moirais.fn.describe('hsnsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsnsh import *
import numpy as np
# See the function signature in fn/hsnsh.py for argument names.
```
