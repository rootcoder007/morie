# describe('inits') — initial_start_values
...
`print(result)` render. See `moirais.fn.describe('inits')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inits import *
import numpy as np
# See the function signature in fn/inits.py for argument names.
```
