# describe('rng203') — rangayyan_ch4_ccf_outer_product_random_signals
...
`print(result)` render. See `moirais.fn.describe('rng203')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng203 import *
import numpy as np
# See the function signature in fn/rng203.py for argument names.
```
