...
`print(result)` render. See `moirais.fn.describe('rgstf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgstf import *
import numpy as np
# See the function signature in fn/rgstf.py for argument names.
```
