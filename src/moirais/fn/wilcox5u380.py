...
__all__ = ["wilcox_chapter_5_unnumbered_380"]


def wilcox_chapter_5_unnumbered_380(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: powt1est(x, delta=0, ci=FALSE, nboot=800)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u380')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u380: PowerAndDesign expression (auto-extracted; see ref)."
