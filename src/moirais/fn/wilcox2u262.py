...
__all__ = ["wilcox_chapter_2_unnumbered_262"]


def wilcox_chapter_2_unnumbered_262(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u262')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u262: PowerAndDesign expression (auto-extracted; see ref)."
