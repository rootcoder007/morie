...
__all__ = ["hedderich_chapter_9_unnumbered_2635"]


def hedderich_chapter_9_unnumbered_2635(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆχ2 = 180·0.0266417 = 4.7955
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2635')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2635: GeneralStatistics expression (auto-extracted; see ref)."
