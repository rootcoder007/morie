...
__all__ = ["hedderich_chapter_9_unnumbered_2365"]


def hedderich_chapter_9_unnumbered_2365(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Since ˆF = 0.689 < 5.14 = F(2;6;0.95), the null hypothesis that all three expected values come
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2365')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2365: GeneralStatistics expression (auto-extracted; see ref)."
