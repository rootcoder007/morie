# describe('gofmd') — gof_mds_interpret
...
`print(result)` render. See `moirais.fn.describe('gofmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gofmd import *
import numpy as np
# See the function signature in fn/gofmd.py for argument names.
```
