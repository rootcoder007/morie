...
__all__ = ["hedderich_chapter_9_unnumbered_1266"]


def hedderich_chapter_9_unnumbered_1266(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] s¯x= s√n = 20√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1266')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1266: GeneralStatistics expression (auto-extracted; see ref)."
