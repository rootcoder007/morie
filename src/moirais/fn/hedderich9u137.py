...
__all__ = ["hedderich_chapter_9_unnumbered_137"]


def hedderich_chapter_9_unnumbered_137(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > v t <− table ( vect ) ; mode <− as . numeric ( names ( v t [ v t == max( v t ) ] ) ) ; mode
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u137')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u137: GeneralStatistics expression (auto-extracted; see ref)."
