# describe('spsph') — schabenberger_spherical_variogram
...
`print(result)` render. See `moirais.fn.describe('spsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsph import *
import numpy as np
# See the function signature in fn/spsph.py for argument names.
```
