# describe('gb242') — gibbons_order_pdf
...
`print(result)` render. See `moirais.fn.describe('gb242')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb242 import *
import numpy as np
# See the function signature in fn/gb242.py for argument names.
```
