# describe('dpool') — jackknife_delete_d
...
`print(result)` render. See `moirais.fn.describe('dpool')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpool import *
import numpy as np
# See the function signature in fn/dpool.py for argument names.
```
