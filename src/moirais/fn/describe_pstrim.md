# describe('pstrim') — propensity_trim
...
`print(result)` render. See `moirais.fn.describe('pstrim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstrim import *
import numpy as np
# See the function signature in fn/pstrim.py for argument names.
```
