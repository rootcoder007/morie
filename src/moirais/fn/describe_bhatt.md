...
`print(result)` render. See `moirais.fn.describe('bhatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhatt import *
import numpy as np
# See the function signature in fn/bhatt.py for argument names.
```
