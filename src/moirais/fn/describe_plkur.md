...
`print(result)` render. See `moirais.fn.describe('plkur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plkur import *
import numpy as np
# See the function signature in fn/plkur.py for argument names.
```
