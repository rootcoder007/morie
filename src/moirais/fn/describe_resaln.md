...
`print(result)` render. See `moirais.fn.describe('resaln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.resaln import *
import numpy as np
# See the function signature in fn/resaln.py for argument names.
```
