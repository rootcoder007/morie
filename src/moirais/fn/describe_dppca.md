...
`print(result)` render. See `moirais.fn.describe('dppca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dppca import *
import numpy as np
# See the function signature in fn/dppca.py for argument names.
```
