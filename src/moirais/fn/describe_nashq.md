# describe('nashq') — nash_q_learning
...
`print(result)` render. See `moirais.fn.describe('nashq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nashq import *
import numpy as np
# See the function signature in fn/nashq.py for argument names.
```
