...
`print(result)` render. See `moirais.fn.describe('ubiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubiso import *
import numpy as np
# See the function signature in fn/ubiso.py for argument names.
```
