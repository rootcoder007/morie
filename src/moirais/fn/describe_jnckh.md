# describe('jnckh') — jonckheere_terpstra
...
`print(result)` render. See `moirais.fn.describe('jnckh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jnckh import *
import numpy as np
# See the function signature in fn/jnckh.py for argument names.
```
