# describe('msm172') — mvsml_ridge_lasso_elastic_eq_9_2
...
`print(result)` render. See `moirais.fn.describe('msm172')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm172 import *
import numpy as np
# See the function signature in fn/msm172.py for argument names.
```
