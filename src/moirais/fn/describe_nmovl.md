...
`print(result)` render. See `moirais.fn.describe('nmovl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmovl import *
import numpy as np
# See the function signature in fn/nmovl.py for argument names.
```
