# describe('svshp') — shapley_spatial
...
`print(result)` render. See `moirais.fn.describe('svshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svshp import *
import numpy as np
# See the function signature in fn/svshp.py for argument names.
```
