# describe('grord') — geron_ordinal_encoding
...
`print(result)` render. See `moirais.fn.describe('grord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grord import *
import numpy as np
# See the function signature in fn/grord.py for argument names.
```
