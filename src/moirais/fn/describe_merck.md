...
`print(result)` render. See `moirais.fn.describe('merck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.merck import *
import numpy as np
# See the function signature in fn/merck.py for argument names.
```
