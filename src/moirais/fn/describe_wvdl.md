# describe('wvdl') — wavelet_dict_learn
...
`print(result)` render. See `moirais.fn.describe('wvdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvdl import *
import numpy as np
# See the function signature in fn/wvdl.py for argument names.
```
