# describe('grsa') — geron_self_attention
...
`print(result)` render. See `moirais.fn.describe('grsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsa import *
import numpy as np
# See the function signature in fn/grsa.py for argument names.
```
