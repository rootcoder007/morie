# describe('dimrd') — dimensionality_test
...
`print(result)` render. See `moirais.fn.describe('dimrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dimrd import *
import numpy as np
# See the function signature in fn/dimrd.py for argument names.
```
