...
`print(result)` render. See `moirais.fn.describe('geimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geimp import *
import numpy as np
# See the function signature in fn/geimp.py for argument names.
```
