# describe('confm') — confusion_matrix_metrics
...
`print(result)` render. See `moirais.fn.describe('confm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.confm import *
import numpy as np
# See the function signature in fn/confm.py for argument names.
```
