...
`print(result)` render. See `moirais.fn.describe('ptcsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptcsr import *
import numpy as np
# See the function signature in fn/ptcsr.py for argument names.
```
