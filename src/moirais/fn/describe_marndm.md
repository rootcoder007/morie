...
`print(result)` render. See `moirais.fn.describe('marndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.marndm import *
import numpy as np
# See the function signature in fn/marndm.py for argument names.
```
