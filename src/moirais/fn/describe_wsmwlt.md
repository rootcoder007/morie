# describe('wsmwlt') — wasserman_wavelet_smooth
...
`print(result)` render. See `moirais.fn.describe('wsmwlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmwlt import *
import numpy as np
# See the function signature in fn/wsmwlt.py for argument names.
```
