# describe('gh_c4_17') — ghosal_dp_median
...
`print(result)` render. See `moirais.fn.describe('gh_c4_17')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_17 import *
import numpy as np
# See the function signature in fn/gh_c4_17.py for argument names.
```
