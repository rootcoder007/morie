# describe('ca11e26') — ca_chapter_11_equation_26
...
```python
from moirais.fn.ca11e26 import ca_chapter_11_equation_26
import numpy as np
result = ca_chapter_11_equation_26(np.random.default_rng(42).normal(0, 1, 100))
