...
`print(result)` render. See `moirais.fn.describe('macrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.macrl import *
import numpy as np
# See the function signature in fn/macrl.py for argument names.
```
