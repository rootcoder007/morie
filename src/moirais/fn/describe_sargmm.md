...
`print(result)` render. See `moirais.fn.describe('sargmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sargmm import *
import numpy as np
# See the function signature in fn/sargmm.py for argument names.
```
