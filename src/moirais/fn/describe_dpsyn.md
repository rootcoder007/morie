# describe('dpsyn') — dp_synthetic_data
...
`print(result)` render. See `moirais.fn.describe('dpsyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsyn import *
import numpy as np
# See the function signature in fn/dpsyn.py for argument names.
```
