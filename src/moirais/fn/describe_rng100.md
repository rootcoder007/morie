# describe('rng100') — rangayyan_ch3_ma_8point_frequency_response
...
`print(result)` render. See `moirais.fn.describe('rng100')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng100 import *
import numpy as np
# See the function signature in fn/rng100.py for argument names.
```
