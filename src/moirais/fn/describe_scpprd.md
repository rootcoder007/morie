...
`print(result)` render. See `moirais.fn.describe('scpprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpprd import *
import numpy as np
# See the function signature in fn/scpprd.py for argument names.
```
