# describe('mafcl') — maf_calculation
...
`print(result)` render. See `moirais.fn.describe('mafcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafcl import *
import numpy as np
# See the function signature in fn/mafcl.py for argument names.
```
