...
`print(result)` render. See `moirais.fn.describe('dknkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dknkr import *
import numpy as np
# See the function signature in fn/dknkr.py for argument names.
```
