...
`print(result)` render. See `moirais.fn.describe('semres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semres import *
import numpy as np
# See the function signature in fn/semres.py for argument names.
```
