...
`print(result)` render. See `moirais.fn.describe('afirr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afirr import *
import numpy as np
# See the function signature in fn/afirr.py for argument names.
```
