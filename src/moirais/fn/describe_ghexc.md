...
`print(result)` render. See `moirais.fn.describe('ghexc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghexc import *
import numpy as np
# See the function signature in fn/ghexc.py for argument names.
```
