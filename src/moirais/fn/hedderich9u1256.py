...
__all__ = ["hedderich_chapter_9_unnumbered_1256"]


def hedderich_chapter_9_unnumbered_1256(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: P (¯x−tn−1;1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1256')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1256: GeneralStatistics expression (auto-extracted; see ref)."
