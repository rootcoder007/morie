...
`print(result)` render. See `moirais.fn.describe('bmi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmi import *
import numpy as np
# See the function signature in fn/bmi.py for argument names.
```
