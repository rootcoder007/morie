...
`print(result)` render. See `moirais.fn.describe('samseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samseg import *
import numpy as np
# See the function signature in fn/samseg.py for argument names.
```
