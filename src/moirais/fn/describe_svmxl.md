# describe('svmxl') — mixed_logit_vote
...
`print(result)` render. See `moirais.fn.describe('svmxl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmxl import *
import numpy as np
# See the function signature in fn/svmxl.py for argument names.
```
