# describe('gb5713') — gibbons_wsrt_simpower
...
`print(result)` render. See `moirais.fn.describe('gb5713')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5713 import *
import numpy as np
# See the function signature in fn/gb5713.py for argument names.
```
