# describe('sub_est') — subpopulation_estimate
...
`print(result)` render. See `moirais.fn.describe('sub_est')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sub_est import *
import numpy as np
# See the function signature in fn/sub_est.py for argument names.
```
