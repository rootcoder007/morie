...
`print(result)` render. See `moirais.fn.describe('svrub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrub import *
import numpy as np
# See the function signature in fn/svrub.py for argument names.
```
