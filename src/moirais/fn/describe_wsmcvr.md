# describe('wsmcvr') — wasserman_kfold_cv
...
`print(result)` render. See `moirais.fn.describe('wsmcvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcvr import *
import numpy as np
# See the function signature in fn/wsmcvr.py for argument names.
```
