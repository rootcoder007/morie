...
__all__ = ["hedderich_chapter_9_unnumbered_502"]


def hedderich_chapter_9_unnumbered_502(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Jc = max (Sensitivity(c) + Specificity(c)−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u502')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u502: GeneralStatistics expression (auto-extracted; see ref)."
