...
`print(result)` render. See `moirais.fn.describe('mirand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mirand import *
import numpy as np
# See the function signature in fn/mirand.py for argument names.
```
