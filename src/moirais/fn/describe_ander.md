...
`print(result)` render. See `moirais.fn.describe('ander')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ander import *
import numpy as np
# See the function signature in fn/ander.py for argument names.
```
