# describe('kmrope') — kamath_rotary_positional_embedding
...
`print(result)` render. See `moirais.fn.describe('kmrope')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrope import *
import numpy as np
# See the function signature in fn/kmrope.py for argument names.
```
