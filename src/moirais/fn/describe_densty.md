...
`print(result)` render. See `moirais.fn.describe('densty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.densty import *
import numpy as np
# See the function signature in fn/densty.py for argument names.
```
