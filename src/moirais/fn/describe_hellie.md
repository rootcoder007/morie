# describe('hellie') — hellinger_distance
...
`print(result)` render. See `moirais.fn.describe('hellie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hellie import *
import numpy as np
# See the function signature in fn/hellie.py for argument names.
```
