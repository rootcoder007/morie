# describe('stner') — stationarity_test
...
`print(result)` render. See `moirais.fn.describe('stner')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stner import *
import numpy as np
# See the function signature in fn/stner.py for argument names.
```
