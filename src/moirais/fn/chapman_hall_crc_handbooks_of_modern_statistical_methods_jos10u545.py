...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_545"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_545(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ACE11 = E [ω1,11(Xi) · Yi | Wi = 1, Si = 1] − E [Yi | Wi = 0, Si = 1]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u545')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u545: GeneralStatistics expression (auto-extracted; see ref)."
