# describe('almqa') — alammar_multi_query_attention
...
`print(result)` render. See `moirais.fn.describe('almqa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.almqa import *
import numpy as np
# See the function signature in fn/almqa.py for argument names.
```
