...
__all__ = ["hedderich_chapter_9_unnumbered_3435"]


def hedderich_chapter_9_unnumbered_3435(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] P =L(π1,...,πm|y1,...,y m)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3435')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3435: ContingencyTables expression (auto-extracted; see ref)."
