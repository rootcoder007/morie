...
`print(result)` render. See `moirais.fn.describe('blade')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blade import *
import numpy as np
# See the function signature in fn/blade.py for argument names.
```
