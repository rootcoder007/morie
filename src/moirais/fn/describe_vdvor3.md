...
`print(result)` render. See `moirais.fn.describe('vdvor3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdvor3 import *
import numpy as np
# See the function signature in fn/vdvor3.py for argument names.
```
