...
`print(result)` render. See `moirais.fn.describe('thiess')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thiess import *
import numpy as np
# See the function signature in fn/thiess.py for argument names.
```
