...
__all__ = ["hedderich_chapter_9_unnumbered_1084"]


def hedderich_chapter_9_unnumbered_1084(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] +kln (π) + (n−k) ln(1−π)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1084')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1084: CountModels expression (auto-extracted; see ref)."
