...
__all__ = ["guide_on_data_analysis_chapter_26_unnumbered_1314"]


def guide_on_data_analysis_chapter_26_unnumbered_1314(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑊𝑖 = 𝑃(𝑍𝑖 = 1 ∣ 𝑋𝑖)(1 − 𝑃(𝑍𝑖 = 1 ∣ 𝑋𝑖)).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis26u1314')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis26u1314: GeneralStatistics expression (auto-extracted; see ref)."
