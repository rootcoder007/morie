# describe('msm252') — mvsml_reproducing_kernel_eq_10_13
...
`print(result)` render. See `moirais.fn.describe('msm252')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm252 import *
import numpy as np
# See the function signature in fn/msm252.py for argument names.
```
