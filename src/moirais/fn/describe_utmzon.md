...
`print(result)` render. See `moirais.fn.describe('utmzon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.utmzon import *
import numpy as np
# See the function signature in fn/utmzon.py for argument names.
```
