# describe('hmssg') — geron_semantic_segmentation
...
`print(result)` render. See `moirais.fn.describe('hmssg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmssg import *
import numpy as np
# See the function signature in fn/hmssg.py for argument names.
```
