...
`print(result)` render. See `moirais.fn.describe('hmpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpol import *
import numpy as np
# See the function signature in fn/hmpol.py for argument names.
```
