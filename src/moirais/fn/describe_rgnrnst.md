# describe('rgnrnst') — rangayyan_nernst_potential
...
`print(result)` render. See `moirais.fn.describe('rgnrnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgnrnst import *
import numpy as np
# See the function signature in fn/rgnrnst.py for argument names.
```
