...
`print(result)` render. See `moirais.fn.describe('afwed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afwed import *
import numpy as np
# See the function signature in fn/afwed.py for argument names.
```
