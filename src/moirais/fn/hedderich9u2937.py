...
__all__ = ["hedderich_chapter_9_unnumbered_2937"]


def hedderich_chapter_9_unnumbered_2937(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + p . v a l <− pchisq (B , df =k , lower . tail = FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2937')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2937: GeneralStatistics expression (auto-extracted; see ref)."
