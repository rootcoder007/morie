# describe('gh_ap_j2') — ghosal_crm_laplace
...
`print(result)` render. See `moirais.fn.describe('gh_ap_j2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_j2 import *
import numpy as np
# See the function signature in fn/gh_ap_j2.py for argument names.
```
