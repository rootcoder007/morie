...
__all__ = ["wilcox_chapter_2_unnumbered_278"]


def wilcox_chapter_2_unnumbered_278(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u278')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u278: PowerAndDesign expression (auto-extracted; see ref)."
