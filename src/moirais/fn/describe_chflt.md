...
`print(result)` render. See `moirais.fn.describe('chflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chflt import *
import numpy as np
# See the function signature in fn/chflt.py for argument names.
```
