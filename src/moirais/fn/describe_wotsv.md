...
`print(result)` render. See `moirais.fn.describe('wotsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wotsv import *
import numpy as np
# See the function signature in fn/wotsv.py for argument names.
```
