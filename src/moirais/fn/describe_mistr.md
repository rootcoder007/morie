...
`print(result)` render. See `moirais.fn.describe('mistr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mistr import *
import numpy as np
# See the function signature in fn/mistr.py for argument names.
```
