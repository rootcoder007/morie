# describe('rng140') — rangayyan_ch3_estimation_error_vector_form
...
`print(result)` render. See `moirais.fn.describe('rng140')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng140 import *
import numpy as np
# See the function signature in fn/rng140.py for argument names.
```
