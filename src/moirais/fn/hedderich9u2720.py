...
__all__ = ["hedderich_chapter_9_unnumbered_2720"]


def hedderich_chapter_9_unnumbered_2720(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (r + 1)pc(1−pc) +z1−β
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2720')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2720: GeneralStatistics expression (auto-extracted; see ref)."
