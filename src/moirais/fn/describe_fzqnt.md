# describe('fzqnt') — fauzi_kernel_quantile_asymptotic
...
`print(result)` render. See `moirais.fn.describe('fzqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzqnt import *
import numpy as np
# See the function signature in fn/fzqnt.py for argument names.
```
