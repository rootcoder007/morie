...
`print(result)` render. See `moirais.fn.describe('valfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.valfn import *
import numpy as np
# See the function signature in fn/valfn.py for argument names.
```
