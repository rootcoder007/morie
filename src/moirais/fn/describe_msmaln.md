# describe('msmaln') — aalen_johansen
...
`print(result)` render. See `moirais.fn.describe('msmaln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmaln import *
import numpy as np
# See the function signature in fn/msmaln.py for argument names.
```
