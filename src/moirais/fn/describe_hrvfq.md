...
`print(result)` render. See `moirais.fn.describe('hrvfq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvfq import *
import numpy as np
# See the function signature in fn/hrvfq.py for argument names.
```
