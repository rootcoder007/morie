...
`print(result)` render. See `moirais.fn.describe('gdgin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdgin import *
import numpy as np
# See the function signature in fn/gdgin.py for argument names.
```
