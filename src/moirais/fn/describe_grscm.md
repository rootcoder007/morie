# describe('grscm') — geron_score_matching_loss
...
`print(result)` render. See `moirais.fn.describe('grscm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grscm import *
import numpy as np
# See the function signature in fn/grscm.py for argument names.
```
