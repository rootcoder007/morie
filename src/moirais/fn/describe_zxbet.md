...
`print(result)` render. See `moirais.fn.describe('zxbet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxbet import *
import numpy as np
# See the function signature in fn/zxbet.py for argument names.
```
