...
`print(result)` render. See `moirais.fn.describe('cuttip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cuttip import *
import numpy as np
# See the function signature in fn/cuttip.py for argument names.
```
