...
`print(result)` render. See `moirais.fn.describe('enlgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enlgr import *
import numpy as np
# See the function signature in fn/enlgr.py for argument names.
```
