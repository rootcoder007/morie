# describe('amfit') — am_fit_statistic
...
`print(result)` render. See `moirais.fn.describe('amfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amfit import *
import numpy as np
# See the function signature in fn/amfit.py for argument names.
```
