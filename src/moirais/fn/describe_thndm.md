...
`print(result)` render. See `moirais.fn.describe('thndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thndm import *
import numpy as np
# See the function signature in fn/thndm.py for argument names.
```
