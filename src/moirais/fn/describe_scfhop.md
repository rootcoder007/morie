...
`print(result)` render. See `moirais.fn.describe('scfhop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scfhop import *
import numpy as np
# See the function signature in fn/scfhop.py for argument names.
```
