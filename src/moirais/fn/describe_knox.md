...
`print(result)` render. See `moirais.fn.describe('knox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knox import *
import numpy as np
# See the function signature in fn/knox.py for argument names.
```
