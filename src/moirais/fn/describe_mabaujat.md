# describe('mabaujat') — ma_baujat_plot_data
...
`print(result)` render. See `moirais.fn.describe('mabaujat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mabaujat import *
import numpy as np
# See the function signature in fn/mabaujat.py for argument names.
```
