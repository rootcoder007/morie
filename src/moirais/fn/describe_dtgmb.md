...
`print(result)` render. See `moirais.fn.describe('dtgmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtgmb import *
import numpy as np
# See the function signature in fn/dtgmb.py for argument names.
```
