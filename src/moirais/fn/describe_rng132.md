# describe('rng132') — rangayyan_ch3_iir_difference_eq_general
...
`print(result)` render. See `moirais.fn.describe('rng132')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng132 import *
import numpy as np
# See the function signature in fn/rng132.py for argument names.
```
