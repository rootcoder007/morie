# describe('rgemdvf') — rangayyan_emd_vf_detect
...
`print(result)` render. See `moirais.fn.describe('rgemdvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemdvf import *
import numpy as np
# See the function signature in fn/rgemdvf.py for argument names.
```
