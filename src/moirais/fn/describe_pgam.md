...
`print(result)` render. See `moirais.fn.describe('pgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgam import *
import numpy as np
# See the function signature in fn/pgam.py for argument names.
```
