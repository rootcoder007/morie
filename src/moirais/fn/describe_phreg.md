...
`print(result)` render. See `moirais.fn.describe('phreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phreg import *
import numpy as np
# See the function signature in fn/phreg.py for argument names.
```
