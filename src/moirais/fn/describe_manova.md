...
`print(result)` render. See `moirais.fn.describe('manova')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manova import *
import numpy as np
# See the function signature in fn/manova.py for argument names.
```
