# describe('rskcb') — risk_calibration
...
`print(result)` render. See `moirais.fn.describe('rskcb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskcb import *
import numpy as np
# See the function signature in fn/rskcb.py for argument names.
```
