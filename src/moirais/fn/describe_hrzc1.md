# describe('hrzc1') — horowitz_censored_regression
...
`print(result)` render. See `moirais.fn.describe('hrzc1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzc1 import *
import numpy as np
# See the function signature in fn/hrzc1.py for argument names.
```
