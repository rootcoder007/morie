# describe('bayopt') — bayesian_optimization
...
`print(result)` render. See `moirais.fn.describe('bayopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayopt import *
import numpy as np
# See the function signature in fn/bayopt.py for argument names.
```
