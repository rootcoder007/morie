...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_827"]


def guide_on_data_analysis_chapter_11_unnumbered_827(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> BP = 80.033, df = 4, p-value < 2.2e-16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u827')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u827: GeneralStatistics expression (auto-extracted; see ref)."
