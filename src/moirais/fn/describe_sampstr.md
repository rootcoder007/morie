...
`print(result)` render. See `moirais.fn.describe('sampstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sampstr import *
import numpy as np
# See the function signature in fn/sampstr.py for argument names.
```
