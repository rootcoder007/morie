# describe('btcalib') — boot_calibrated_ci
...
`print(result)` render. See `moirais.fn.describe('btcalib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btcalib import *
import numpy as np
# See the function signature in fn/btcalib.py for argument names.
```
