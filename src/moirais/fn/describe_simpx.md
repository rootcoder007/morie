...
`print(result)` render. See `moirais.fn.describe('simpx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simpx import *
import numpy as np
# See the function signature in fn/simpx.py for argument names.
```
