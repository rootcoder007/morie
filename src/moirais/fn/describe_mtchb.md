# describe('mtchb') — matched_filter_bank
...
`print(result)` render. See `moirais.fn.describe('mtchb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtchb import *
import numpy as np
# See the function signature in fn/mtchb.py for argument names.
```
