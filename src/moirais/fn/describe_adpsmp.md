...
`print(result)` render. See `moirais.fn.describe('adpsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adpsmp import *
import numpy as np
# See the function signature in fn/adpsmp.py for argument names.
```
