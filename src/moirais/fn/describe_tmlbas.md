# describe('tmlbas') — tmle_baseline_adj
...
`print(result)` render. See `moirais.fn.describe('tmlbas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlbas import *
import numpy as np
# See the function signature in fn/tmlbas.py for argument names.
```
