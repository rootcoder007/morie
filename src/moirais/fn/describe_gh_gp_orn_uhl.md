# describe('gh_gp_orn_uhl') — ghosal_gp_ornstein_uhlenbeck
...
`print(result)` render. See `moirais.fn.describe('gh_gp_orn_uhl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_gp_orn_uhl import *
import numpy as np
# See the function signature in fn/gh_gp_orn_uhl.py for argument names.
```
