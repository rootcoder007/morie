# describe('ksr065') — kosorok_ch3_efficient_influence_general
...
`print(result)` render. See `moirais.fn.describe('ksr065')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr065 import *
import numpy as np
# See the function signature in fn/ksr065.py for argument names.
```
