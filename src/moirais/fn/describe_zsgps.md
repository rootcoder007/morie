...
`print(result)` render. See `moirais.fn.describe('zsgps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgps import *
import numpy as np
# See the function signature in fn/zsgps.py for argument names.
```
