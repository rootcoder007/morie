# describe('ltses') — least_trimmed_squares
...
`print(result)` render. See `moirais.fn.describe('ltses')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltses import *
import numpy as np
# See the function signature in fn/ltses.py for argument names.
```
