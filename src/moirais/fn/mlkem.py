...
def mlkem768_keygen() -> CryptoResult:
    ...
    """
    from moirais.crypto._mlkem import mlkem768_keygen as _keygen
...
def mlkem768_encaps(pk: bytes) -> CryptoResult:
    ...
    """
    from moirais.crypto._mlkem import mlkem768_encaps as _encaps
...
def mlkem768_decaps(sk: bytes, ct: bytes) -> CryptoResult:
    ...
    """
    from moirais.crypto._mlkem import mlkem768_decaps as _decaps
