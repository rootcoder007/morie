...
__all__ = ["hedderich_chapter_9_unnumbered_3539"]


def hedderich_chapter_9_unnumbered_3539(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: geese (formula = height ~ gender , i d = family , data = height ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3539')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3539: GeneralStatistics expression (auto-extracted; see ref)."
