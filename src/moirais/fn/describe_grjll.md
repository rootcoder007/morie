# describe('grjll') — geron_johnson_lindenstrauss_bound
...
`print(result)` render. See `moirais.fn.describe('grjll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grjll import *
import numpy as np
# See the function signature in fn/grjll.py for argument names.
```
