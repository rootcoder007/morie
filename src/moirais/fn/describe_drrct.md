# describe('drrct') — dr_rct_assisted_did
...
`print(result)` render. See `moirais.fn.describe('drrct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drrct import *
import numpy as np
# See the function signature in fn/drrct.py for argument names.
```
