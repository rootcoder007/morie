# describe('svcpw') — copeland_winner
...
`print(result)` render. See `moirais.fn.describe('svcpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcpw import *
import numpy as np
# See the function signature in fn/svcpw.py for argument names.
```
