...
__all__ = ["hedderich_chapter_9_unnumbered_3361"]


def hedderich_chapter_9_unnumbered_3361(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] withn1 = ∑yi and n0 = ∑(1−yi)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3361')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3361: GeneralStatistics expression (auto-extracted; see ref)."
