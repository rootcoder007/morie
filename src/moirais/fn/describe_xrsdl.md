...
`print(result)` render. See `moirais.fn.describe('xrsdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrsdl import *
import numpy as np
# See the function signature in fn/xrsdl.py for argument names.
```
