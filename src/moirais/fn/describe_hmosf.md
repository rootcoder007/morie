...
`print(result)` render. See `moirais.fn.describe('hmosf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmosf import *
import numpy as np
# See the function signature in fn/hmosf.py for argument names.
```
