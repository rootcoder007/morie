# describe('iv_wk') — weak_instrument_test
...
`print(result)` render. See `moirais.fn.describe('iv_wk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iv_wk import *
import numpy as np
# See the function signature in fn/iv_wk.py for argument names.
```
