...
`print(result)` render. See `moirais.fn.describe('lglog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lglog import *
import numpy as np
# See the function signature in fn/lglog.py for argument names.
```
