# describe('matvar') — matern_variogram_model
...
`print(result)` render. See `moirais.fn.describe('matvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matvar import *
import numpy as np
# See the function signature in fn/matvar.py for argument names.
```
