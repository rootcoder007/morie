...
`print(result)` render. See `moirais.fn.describe('gabfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gabfp import *
import numpy as np
# See the function signature in fn/gabfp.py for argument names.
```
