...
`print(result)` render. See `moirais.fn.describe('hmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmm import *
import numpy as np
# See the function signature in fn/hmm.py for argument names.
```
