# describe('selct') — genomic_selection_accuracy
...
`print(result)` render. See `moirais.fn.describe('selct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.selct import *
import numpy as np
# See the function signature in fn/selct.py for argument names.
```
