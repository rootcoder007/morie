# describe('tldepl') — lower_tail_dependence
...
`print(result)` render. See `moirais.fn.describe('tldepl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tldepl import *
import numpy as np
# See the function signature in fn/tldepl.py for argument names.
```
