...
__all__ = ["hedderich_chapter_9_unnumbered_2015"]


def hedderich_chapter_9_unnumbered_2015(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆt = 14.5−13.0√[ 16 + 14
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2015')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2015: GeneralStatistics expression (auto-extracted; see ref)."
