...
__all__ = ["hedderich_chapter_9_unnumbered_2437"]


def hedderich_chapter_9_unnumbered_2437(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3 (14 + 13 + 14) = 4 .17
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2437')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2437: GeneralStatistics expression (auto-extracted; see ref)."
