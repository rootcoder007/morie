# describe('msm203') — mvsml_ridge_lasso_elastic_eq_9_29
...
`print(result)` render. See `moirais.fn.describe('msm203')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm203 import *
import numpy as np
# See the function signature in fn/msm203.py for argument names.
```
