# describe('twostg') — two_stage_hazard
...
`print(result)` render. See `moirais.fn.describe('twostg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.twostg import *
import numpy as np
# See the function signature in fn/twostg.py for argument names.
```
