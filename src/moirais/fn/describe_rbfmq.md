...
`print(result)` render. See `moirais.fn.describe('rbfmq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfmq import *
import numpy as np
# See the function signature in fn/rbfmq.py for argument names.
```
