...
def gemma_function_call(
    ...
    :param tools: List of tool definitions in Ollama format. If None, uses
        a default set of moirais statistical functions.
    ...
    for tc in tool_calls:
        ...
        result = _execute_moirais_function(fn_name, fn_args)
...
def _execute_moirais_function(name: str, args: dict):
    """Execute an moirais fn/ function by name with given arguments."""
    try:
...
def _default_moirais_tools() -> list[dict]:
    """Default set of moirais tools for Gemma function calling."""
    return [
        {
            "type": "function",
            "function": {
