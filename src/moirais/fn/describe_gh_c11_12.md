# describe('gh_c11_12') — ghosal_selfsim_gp
...
`print(result)` render. See `moirais.fn.describe('gh_c11_12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_12 import *
import numpy as np
# See the function signature in fn/gh_c11_12.py for argument names.
```
