# describe('prrcl') — precision_recall
...
`print(result)` render. See `moirais.fn.describe('prrcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prrcl import *
import numpy as np
# See the function signature in fn/prrcl.py for argument names.
```
