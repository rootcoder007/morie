# describe('vcomp') — variance_components_henderson3
...
`print(result)` render. See `moirais.fn.describe('vcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcomp import *
import numpy as np
# See the function signature in fn/vcomp.py for argument names.
```
