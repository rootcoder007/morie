# describe('pabay') — pabay

## WHAT IT DOES

Bayesian aggregation spatial.
...
`print(result)` render. See `moirais.fn.describe('pabay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pabay import *
import numpy as np
# See the function signature in fn/pabay.py for argument names.
```
