...
__all__ = ["wilcox_chapter_7_unnumbered_355"]


def wilcox_chapter_7_unnumbered_355(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯X − t s√ n, ¯X +t s√ n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u355')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u355: GeneralStatistics expression (auto-extracted; see ref)."
