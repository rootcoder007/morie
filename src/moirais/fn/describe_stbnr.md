# describe('stbnr') — stability_margin
...
`print(result)` render. See `moirais.fn.describe('stbnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stbnr import *
import numpy as np
# See the function signature in fn/stbnr.py for argument names.
```
