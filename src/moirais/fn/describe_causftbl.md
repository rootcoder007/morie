# describe('causftbl') — causal_frontdoor_adjustment
...
`print(result)` render. See `moirais.fn.describe('causftbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causftbl import *
import numpy as np
# See the function signature in fn/causftbl.py for argument names.
```
