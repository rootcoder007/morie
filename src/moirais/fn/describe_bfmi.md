...
`print(result)` render. See `moirais.fn.describe('bfmi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfmi import *
import numpy as np
# See the function signature in fn/bfmi.py for argument names.
```
