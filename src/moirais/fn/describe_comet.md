...
`print(result)` render. See `moirais.fn.describe('comet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comet import *
import numpy as np
# See the function signature in fn/comet.py for argument names.
```
