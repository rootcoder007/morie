...
`print(result)` render. See `moirais.fn.describe('srmgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmgb import *
import numpy as np
# See the function signature in fn/srmgb.py for argument names.
```
