# describe('ksr055') — kosorok_ch2_m_estimator_taylor_expansion
...
`print(result)` render. See `moirais.fn.describe('ksr055')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr055 import *
import numpy as np
# See the function signature in fn/ksr055.py for argument names.
```
