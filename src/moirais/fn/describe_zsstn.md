...
`print(result)` render. See `moirais.fn.describe('zsstn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsstn import *
import numpy as np
# See the function signature in fn/zsstn.py for argument names.
```
