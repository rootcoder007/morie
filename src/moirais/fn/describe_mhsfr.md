...
`print(result)` render. See `moirais.fn.describe('mhsfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhsfr import *
import numpy as np
# See the function signature in fn/mhsfr.py for argument names.
```
