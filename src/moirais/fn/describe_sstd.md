...
`print(result)` render. See `moirais.fn.describe('sstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sstd import *
import numpy as np
# See the function signature in fn/sstd.py for argument names.
```
