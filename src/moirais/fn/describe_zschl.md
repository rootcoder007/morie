...
`print(result)` render. See `moirais.fn.describe('zschl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zschl import *
import numpy as np
# See the function signature in fn/zschl.py for argument names.
```
