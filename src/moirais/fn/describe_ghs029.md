# describe('ghs029') — ghosal_ch3_polya_tree_density_moments
...
`print(result)` render. See `moirais.fn.describe('ghs029')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs029 import *
import numpy as np
# See the function signature in fn/ghs029.py for argument names.
```
