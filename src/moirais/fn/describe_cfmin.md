...
`print(result)` render. See `moirais.fn.describe('cfmin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfmin import *
import numpy as np
# See the function signature in fn/cfmin.py for argument names.
```
