...
`print(result)` render. See `moirais.fn.describe('wvshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvshp import *
import numpy as np
# See the function signature in fn/wvshp.py for argument names.
```
