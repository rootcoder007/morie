# describe('cluseff') — intracluster_correlation_rho
...
`print(result)` render. See `moirais.fn.describe('cluseff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cluseff import *
import numpy as np
# See the function signature in fn/cluseff.py for argument names.
```
