# describe('causdml2') — causal_dml_partial_lin
...
`print(result)` render. See `moirais.fn.describe('causdml2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdml2 import *
import numpy as np
# See the function signature in fn/causdml2.py for argument names.
```
