# describe('rng201') — rangayyan_ch4_ccf_continuous_with_delay
...
`print(result)` render. See `moirais.fn.describe('rng201')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng201 import *
import numpy as np
# See the function signature in fn/rng201.py for argument names.
```
