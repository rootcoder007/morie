# describe('rgkfcv') — rangayyan_kfold_cv
...
`print(result)` render. See `moirais.fn.describe('rgkfcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkfcv import *
import numpy as np
# See the function signature in fn/rgkfcv.py for argument names.
```
