...
`print(result)` render. See `moirais.fn.describe('mvtms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtms import *
import numpy as np
# See the function signature in fn/mvtms.py for argument names.
```
