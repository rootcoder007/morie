...
`print(result)` render. See `moirais.fn.describe('gdimm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdimm import *
import numpy as np
# See the function signature in fn/gdimm.py for argument names.
```
