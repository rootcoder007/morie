...
__all__ = ["hedderich_chapter_9_unnumbered_1605"]


def hedderich_chapter_9_unnumbered_1605(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: H0 retained P (T /∈Kα|H0)≥1−αP (T /∈Kα|HA)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1605')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1605: PowerAndDesign expression (auto-extracted; see ref)."
