# describe('msevr') — mse_variance_bias
...
`print(result)` render. See `moirais.fn.describe('msevr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msevr import *
import numpy as np
# See the function signature in fn/msevr.py for argument names.
```
