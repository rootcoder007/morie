...
`print(result)` render. See `moirais.fn.describe('swasym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swasym import *
import numpy as np
# See the function signature in fn/swasym.py for argument names.
```
