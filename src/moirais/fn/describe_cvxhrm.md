# describe('cvxhrm') — boyd_huber_loss
...
`print(result)` render. See `moirais.fn.describe('cvxhrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxhrm import *
import numpy as np
# See the function signature in fn/cvxhrm.py for argument names.
```
