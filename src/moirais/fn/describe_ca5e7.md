# describe('ca5e7') — ca_chapter_5_equation_7
...
```python
from moirais.fn.ca5e7 import ca_chapter_5_equation_7
import numpy as np
result = ca_chapter_5_equation_7(np.random.default_rng(42).normal(0, 1, 100))
