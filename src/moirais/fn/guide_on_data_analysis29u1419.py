...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1419"]


def guide_on_data_analysis_chapter_29_unnumbered_1419(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1419')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1419: GeneralStatistics expression (auto-extracted; see ref)."
