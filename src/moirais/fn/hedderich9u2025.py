...
__all__ = ["hedderich_chapter_9_unnumbered_2025"]


def hedderich_chapter_9_unnumbered_2025(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] s2 = [9·11 + 9·15] + [9·13 + 9·17]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2025')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2025: GeneralStatistics expression (auto-extracted; see ref)."
