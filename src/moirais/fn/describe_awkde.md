...
`print(result)` render. See `moirais.fn.describe('awkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.awkde import *
import numpy as np
# See the function signature in fn/awkde.py for argument names.
```
