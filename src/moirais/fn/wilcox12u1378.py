...
__all__ = ["wilcox_chapter_12_unnumbered_1378"]


def wilcox_chapter_12_unnumbered_1378(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] error). 2. MSWG=11.6. (a) T = |15 − 10|/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1378')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1378: PowerAndDesign expression (auto-extracted; see ref)."
