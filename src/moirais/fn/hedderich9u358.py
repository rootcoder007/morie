...
__all__ = ["hedderich_chapter_9_unnumbered_358"]


def hedderich_chapter_9_unnumbered_358(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] x = −b a>0, b<0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u358')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u358: PowerAndDesign expression (auto-extracted; see ref)."
