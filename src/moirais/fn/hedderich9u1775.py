...
__all__ = ["hedderich_chapter_9_unnumbered_1775"]


def hedderich_chapter_9_unnumbered_1775(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: nπ(1−π) = 16 > 9 we use the approximation over the normal distribution
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1775')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1775: GeneralStatistics expression (auto-extracted; see ref)."
