...
`print(result)` render. See `moirais.fn.describe('abpmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpmf import *
import numpy as np
# See the function signature in fn/abpmf.py for argument names.
```
