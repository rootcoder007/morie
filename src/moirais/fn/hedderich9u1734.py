...
__all__ = ["hedderich_chapter_9_unnumbered_1734"]


def hedderich_chapter_9_unnumbered_1734(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : cholW = 0 . 8 0 6 2 9 , p− value = 9 . 1 8 7 e −06
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1734')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1734: GeneralStatistics expression (auto-extracted; see ref)."
