...
`print(result)` render. See `moirais.fn.describe('sagcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagcr import *
import numpy as np
# See the function signature in fn/sagcr.py for argument names.
```
