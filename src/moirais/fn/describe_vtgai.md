...
`print(result)` render. See `moirais.fn.describe('vtgai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtgai import *
import numpy as np
# See the function signature in fn/vtgai.py for argument names.
```
