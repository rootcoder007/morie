# describe('msm271') — mvsml_convolutional_nn_eq_14_8
...
`print(result)` render. See `moirais.fn.describe('msm271')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm271 import *
import numpy as np
# See the function signature in fn/msm271.py for argument names.
```
