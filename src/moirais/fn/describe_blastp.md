...
`print(result)` render. See `moirais.fn.describe('blastp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blastp import *
import numpy as np
# See the function signature in fn/blastp.py for argument names.
```
