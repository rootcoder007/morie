...
__all__ = ["hedderich_chapter_9_unnumbered_2214"]


def hedderich_chapter_9_unnumbered_2214(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 0 = n(n + 1)(2n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2214')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2214: PowerAndDesign expression (auto-extracted; see ref)."
