# describe('hadpr') — hadamard_product
...
`print(result)` render. See `moirais.fn.describe('hadpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hadpr import *
import numpy as np
# See the function signature in fn/hadpr.py for argument names.
```
