# describe('wvdns') — wavelet_denoise
...
`print(result)` render. See `moirais.fn.describe('wvdns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvdns import *
import numpy as np
# See the function signature in fn/wvdns.py for argument names.
```
