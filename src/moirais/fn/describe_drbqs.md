# describe('drbqs') — dr_did_quantile
...
`print(result)` render. See `moirais.fn.describe('drbqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drbqs import *
import numpy as np
# See the function signature in fn/drbqs.py for argument names.
```
