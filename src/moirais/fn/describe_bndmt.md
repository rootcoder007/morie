...
`print(result)` render. See `moirais.fn.describe('bndmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndmt import *
import numpy as np
# See the function signature in fn/bndmt.py for argument names.
```
