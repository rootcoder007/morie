...
`print(result)` render. See `moirais.fn.describe('scpaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpaic import *
import numpy as np
# See the function signature in fn/scpaic.py for argument names.
```
