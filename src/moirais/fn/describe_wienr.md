...
`print(result)` render. See `moirais.fn.describe('wienr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wienr import *
import numpy as np
# See the function signature in fn/wienr.py for argument names.
```
