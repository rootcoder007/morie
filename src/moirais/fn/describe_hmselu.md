...
`print(result)` render. See `moirais.fn.describe('hmselu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmselu import *
import numpy as np
# See the function signature in fn/hmselu.py for argument names.
```
