# describe('gb961') — gibbons_pct_mod_rank_sc
...
`print(result)` render. See `moirais.fn.describe('gb961')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb961 import *
import numpy as np
# See the function signature in fn/gb961.py for argument names.
```
