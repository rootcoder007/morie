# describe('km073') — kamath_ch5_pref_sigmoid_form
...
`print(result)` render. See `moirais.fn.describe('km073')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km073 import *
import numpy as np
# See the function signature in fn/km073.py for argument names.
```
