# describe('odirt') — ordinal_irt_estimate
...
`print(result)` render. See `moirais.fn.describe('odirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odirt import *
import numpy as np
# See the function signature in fn/odirt.py for argument names.
```
