# describe('km079') — kamath_ch6_alignscore_total_loss
...
`print(result)` render. See `moirais.fn.describe('km079')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km079 import *
import numpy as np
# See the function signature in fn/km079.py for argument names.
```
