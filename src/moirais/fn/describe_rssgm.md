# describe('rssgm') — reassigned_spectrogram
...
`print(result)` render. See `moirais.fn.describe('rssgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rssgm import *
import numpy as np
# See the function signature in fn/rssgm.py for argument names.
```
