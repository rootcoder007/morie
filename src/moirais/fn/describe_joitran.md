# describe('joitran') — joseph_itransformer
...
`print(result)` render. See `moirais.fn.describe('joitran')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joitran import *
import numpy as np
# See the function signature in fn/joitran.py for argument names.
```
