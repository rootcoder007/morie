# describe('sgmtc') — matern_cluster_process
...
`print(result)` render. See `moirais.fn.describe('sgmtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmtc import *
import numpy as np
# See the function signature in fn/sgmtc.py for argument names.
```
