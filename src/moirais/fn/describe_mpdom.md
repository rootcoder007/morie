...
`print(result)` render. See `moirais.fn.describe('mpdom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpdom import *
import numpy as np
# See the function signature in fn/mpdom.py for argument names.
```
