...
`print(result)` render. See `moirais.fn.describe('zsgpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgpp import *
import numpy as np
# See the function signature in fn/zsgpp.py for argument names.
```
