...
__all__ = ["hedderich_chapter_9_unnumbered_721"]


def hedderich_chapter_9_unnumbered_721(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: fi(xi−¯x)2 ν = n−1 degrees of freedom
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u721')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u721: CountModels expression (auto-extracted; see ref)."
