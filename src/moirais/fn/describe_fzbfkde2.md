# describe('fzbfkde2') — fauzi_bdfree_density_from_cdf
...
`print(result)` render. See `moirais.fn.describe('fzbfkde2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzbfkde2 import *
import numpy as np
# See the function signature in fn/fzbfkde2.py for argument names.
```
