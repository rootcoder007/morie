# describe('sarre') — spatial_ar_error
...
`print(result)` render. See `moirais.fn.describe('sarre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarre import *
import numpy as np
# See the function signature in fn/sarre.py for argument names.
```
