...
`print(result)` render. See `moirais.fn.describe('tsvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsvar import *
import numpy as np
# See the function signature in fn/tsvar.py for argument names.
```
