# describe('cluster') — one_stage_cluster
...
`print(result)` render. See `moirais.fn.describe('cluster')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cluster import *
import numpy as np
# See the function signature in fn/cluster.py for argument names.
```
