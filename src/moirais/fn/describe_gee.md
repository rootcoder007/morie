...
`print(result)` render. See `moirais.fn.describe('gee')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gee import *
import numpy as np
# See the function signature in fn/gee.py for argument names.
```
