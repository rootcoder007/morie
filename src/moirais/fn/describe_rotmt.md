# describe('rotmt') — rotation_matrix_2d
...
`print(result)` render. See `moirais.fn.describe('rotmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rotmt import *
import numpy as np
# See the function signature in fn/rotmt.py for argument names.
```
