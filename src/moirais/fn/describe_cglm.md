# describe('cglm') — complex_survey_glm
...
`print(result)` render. See `moirais.fn.describe('cglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cglm import *
import numpy as np
# See the function signature in fn/cglm.py for argument names.
```
