# describe('voltgr') — vol_tgarch_fit
...
`print(result)` render. See `moirais.fn.describe('voltgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voltgr import *
import numpy as np
# See the function signature in fn/voltgr.py for argument names.
```
