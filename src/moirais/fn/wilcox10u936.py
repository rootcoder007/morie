...
__all__ = ["wilcox_chapter_10_unnumbered_936"]


def wilcox_chapter_10_unnumbered_936(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] j = max{i ∈ { 1, · · ·,C } :p(n−i+k ) >kα/i fork = 1,...,i},
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u936')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u936: PowerAndDesign expression (auto-extracted; see ref)."
