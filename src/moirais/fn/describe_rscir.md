...
`print(result)` render. See `moirais.fn.describe('rscir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rscir import *
import numpy as np
# See the function signature in fn/rscir.py for argument names.
```
