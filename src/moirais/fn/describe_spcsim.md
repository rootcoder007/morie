...
`print(result)` render. See `moirais.fn.describe('spcsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcsim import *
import numpy as np
# See the function signature in fn/spcsim.py for argument names.
```
