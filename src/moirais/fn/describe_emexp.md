# describe('emexp') — em_expectation_step
...
`print(result)` render. See `moirais.fn.describe('emexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emexp import *
import numpy as np
# See the function signature in fn/emexp.py for argument names.
```
