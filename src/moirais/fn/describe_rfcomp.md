# describe('rfcomp') — robust_factor_analysis
...
`print(result)` render. See `moirais.fn.describe('rfcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfcomp import *
import numpy as np
# See the function signature in fn/rfcomp.py for argument names.
```
