# describe('sgmkd') — marked_point_summary
...
`print(result)` render. See `moirais.fn.describe('sgmkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmkd import *
import numpy as np
# See the function signature in fn/sgmkd.py for argument names.
```
