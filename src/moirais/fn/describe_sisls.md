...
`print(result)` render. See `moirais.fn.describe('sisls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sisls import *
import numpy as np
# See the function signature in fn/sisls.py for argument names.
```
