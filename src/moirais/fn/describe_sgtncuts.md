# describe('sgtncuts') — sgt_normalised_cut
...
`print(result)` render. See `moirais.fn.describe('sgtncuts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtncuts import *
import numpy as np
# See the function signature in fn/sgtncuts.py for argument names.
```
