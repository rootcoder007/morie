...
`print(result)` render. See `moirais.fn.describe('gcqbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcqbo import *
import numpy as np
# See the function signature in fn/gcqbo.py for argument names.
```
