...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_475(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner5u475')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner5u475: Dispersion expression (auto-extracted; see ref)."
