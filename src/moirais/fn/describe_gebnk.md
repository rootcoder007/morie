...
`print(result)` render. See `moirais.fn.describe('gebnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gebnk import *
import numpy as np
# See the function signature in fn/gebnk.py for argument names.
```
