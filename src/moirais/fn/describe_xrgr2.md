# describe('xrgr2') — gravity_poisson
...
`print(result)` render. See `moirais.fn.describe('xrgr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgr2 import *
import numpy as np
# See the function signature in fn/xrgr2.py for argument names.
```
