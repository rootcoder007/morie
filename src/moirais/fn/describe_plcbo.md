# describe('plcbo') — placebo_refutation
...
`print(result)` render. See `moirais.fn.describe('plcbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcbo import *
import numpy as np
# See the function signature in fn/plcbo.py for argument names.
```
