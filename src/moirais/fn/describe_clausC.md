# describe('clausC') — clausius_clapeyron
...
`print(result)` render. See `moirais.fn.describe('clausC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clausC import *
import numpy as np
# See the function signature in fn/clausC.py for argument names.
```
