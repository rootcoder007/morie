...
`print(result)` render. See `moirais.fn.describe('spemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spemb import *
import numpy as np
# See the function signature in fn/spemb.py for argument names.
```
