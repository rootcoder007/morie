...
`print(result)` render. See `moirais.fn.describe('rsseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsseg import *
import numpy as np
# See the function signature in fn/rsseg.py for argument names.
```
