# describe('hmprcv') — geron_perceiver
...
`print(result)` render. See `moirais.fn.describe('hmprcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmprcv import *
import numpy as np
# See the function signature in fn/hmprcv.py for argument names.
```
