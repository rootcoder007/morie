# describe('hrzb2') — horowitz_smoothed_maximum_score
...
`print(result)` render. See `moirais.fn.describe('hrzb2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzb2 import *
import numpy as np
# See the function signature in fn/hrzb2.py for argument names.
```
