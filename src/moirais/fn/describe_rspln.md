# describe('rspln') — restricted_cubic_spline
...
`print(result)` render. See `moirais.fn.describe('rspln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rspln import *
import numpy as np
# See the function signature in fn/rspln.py for argument names.
```
