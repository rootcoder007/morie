# describe('msm148') — mvsml_categorical_count_eq_8_11
...
`print(result)` render. See `moirais.fn.describe('msm148')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm148 import *
import numpy as np
# See the function signature in fn/msm148.py for argument names.
```
