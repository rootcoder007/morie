...
`print(result)` render. See `moirais.fn.describe('gnsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsim import *
import numpy as np
# See the function signature in fn/gnsim.py for argument names.
```
