# describe('grkdl') — geron_knowledge_distillation_loss
...
`print(result)` render. See `moirais.fn.describe('grkdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkdl import *
import numpy as np
# See the function signature in fn/grkdl.py for argument names.
```
