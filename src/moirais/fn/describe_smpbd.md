...
`print(result)` render. See `moirais.fn.describe('smpbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpbd import *
import numpy as np
# See the function signature in fn/smpbd.py for argument names.
```
