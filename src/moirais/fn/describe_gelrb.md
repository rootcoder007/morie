# describe('gelrb') — gelman_rubin_rhat
...
`print(result)` render. See `moirais.fn.describe('gelrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gelrb import *
import numpy as np
# See the function signature in fn/gelrb.py for argument names.
```
