...
`print(result)` render. See `moirais.fn.describe('fa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fa import *
import numpy as np
# See the function signature in fn/fa.py for argument names.
```
