# describe('ssmod') — state_space_model
...
`print(result)` render. See `moirais.fn.describe('ssmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssmod import *
import numpy as np
# See the function signature in fn/ssmod.py for argument names.
```
