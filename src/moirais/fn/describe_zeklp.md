# describe('zeklp') — scan_prospective
...
`print(result)` render. See `moirais.fn.describe('zeklp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeklp import *
import numpy as np
# See the function signature in fn/zeklp.py for argument names.
```
