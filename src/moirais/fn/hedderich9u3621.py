...
__all__ = ["hedderich_chapter_9_unnumbered_3621"]


def hedderich_chapter_9_unnumbered_3621(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: yes eα1 eα1+β1 eα1+β2 eα1 eα1+β1+γ11 eα1+β2+γ12
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3621')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3621: GeneralStatistics expression (auto-extracted; see ref)."
