...
`print(result)` render. See `moirais.fn.describe('satDP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.satDP import *
import numpy as np
# See the function signature in fn/satDP.py for argument names.
```
