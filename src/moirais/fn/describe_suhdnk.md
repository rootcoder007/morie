# describe('suhdnk') — heavy_drinking
...
`print(result)` render. See `moirais.fn.describe('suhdnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suhdnk import *
import numpy as np
# See the function signature in fn/suhdnk.py for argument names.
```
