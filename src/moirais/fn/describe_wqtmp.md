...
`print(result)` render. See `moirais.fn.describe('wqtmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtmp import *
import numpy as np
# See the function signature in fn/wqtmp.py for argument names.
```
