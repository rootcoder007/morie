# describe('cvxdul') — boyd_lagrangian
...
`print(result)` render. See `moirais.fn.describe('cvxdul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxdul import *
import numpy as np
# See the function signature in fn/cvxdul.py for argument names.
```
