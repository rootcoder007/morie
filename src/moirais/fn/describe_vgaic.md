...
`print(result)` render. See `moirais.fn.describe('vgaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgaic import *
import numpy as np
# See the function signature in fn/vgaic.py for argument names.
```
