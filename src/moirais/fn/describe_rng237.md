# describe('rng237') — rangayyan_ch4_log_of_convolved_signals
...
`print(result)` render. See `moirais.fn.describe('rng237')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng237 import *
import numpy as np
# See the function signature in fn/rng237.py for argument names.
```
