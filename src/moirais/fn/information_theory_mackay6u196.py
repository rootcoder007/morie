...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_196"]


def information_theory_mackay_chapter_6_unnumbered_196(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R(f) = H_2(f)/(1+f)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u196')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u196: GeneralStatistics expression (auto-extracted; see ref)."
