# describe('hrzconf') — horowitz_confidence_bands
...
`print(result)` render. See `moirais.fn.describe('hrzconf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzconf import *
import numpy as np
# See the function signature in fn/hrzconf.py for argument names.
```
