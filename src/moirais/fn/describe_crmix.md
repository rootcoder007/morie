# describe('crmix') — cure_rate_model
...
`print(result)` render. See `moirais.fn.describe('crmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crmix import *
import numpy as np
# See the function signature in fn/crmix.py for argument names.
```
