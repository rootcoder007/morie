...
`print(result)` render. See `moirais.fn.describe('zeklf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeklf import *
import numpy as np
# See the function signature in fn/zeklf.py for argument names.
```
