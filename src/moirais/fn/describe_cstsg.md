# describe('cstsg') — custody_segregation
...
`print(result)` render. See `moirais.fn.describe('cstsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstsg import *
import numpy as np
# See the function signature in fn/cstsg.py for argument names.
```
