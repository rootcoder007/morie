...
__all__ = ["hedderich_chapter_9_unnumbered_119"]


def hedderich_chapter_9_unnumbered_119(x):
    """
    Logistic expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u119')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u119: Logistic expression (auto-extracted; see ref)."
