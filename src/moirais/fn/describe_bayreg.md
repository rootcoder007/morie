...
`print(result)` render. See `moirais.fn.describe('bayreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayreg import *
import numpy as np
# See the function signature in fn/bayreg.py for argument names.
```
