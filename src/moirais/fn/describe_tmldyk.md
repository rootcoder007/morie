# describe('tmldyk') — tmle_diff_kernel
...
`print(result)` render. See `moirais.fn.describe('tmldyk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmldyk import *
import numpy as np
# See the function signature in fn/tmldyk.py for argument names.
```
