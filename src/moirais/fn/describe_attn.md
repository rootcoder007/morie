...
`print(result)` render. See `moirais.fn.describe('attn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attn import *
import numpy as np
# See the function signature in fn/attn.py for argument names.
```
