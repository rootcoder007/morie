# describe('mlsmu') — mlsmu6_unfolding
...
`print(result)` render. See `moirais.fn.describe('mlsmu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlsmu import *
import numpy as np
# See the function signature in fn/mlsmu.py for argument names.
```
