# describe('otgws') — ot_gromov_sinkhorn
...
`print(result)` render. See `moirais.fn.describe('otgws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otgws import *
import numpy as np
# See the function signature in fn/otgws.py for argument names.
```
