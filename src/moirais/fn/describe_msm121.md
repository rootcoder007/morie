# describe('msm121') — mvsml_bayesian_regression_pt2_eq_7_6
...
`print(result)` render. See `moirais.fn.describe('msm121')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm121 import *
import numpy as np
# See the function signature in fn/msm121.py for argument names.
```
