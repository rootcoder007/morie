...
`print(result)` render. See `moirais.fn.describe('wqfsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqfsh import *
import numpy as np
# See the function signature in fn/wqfsh.py for argument names.
```
