...
__all__ = ["wilcox_chapter_4_unnumbered_123"]


def wilcox_chapter_4_unnumbered_123(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Because µ is a constant, E(X − µ) = E(X) − µ = µ − µ = 0. That is, if we subtract
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u123')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u123: GeneralStatistics expression (auto-extracted; see ref)."
