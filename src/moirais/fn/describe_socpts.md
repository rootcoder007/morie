# describe('socpts') — second_order_cone
...
`print(result)` render. See `moirais.fn.describe('socpts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socpts import *
import numpy as np
# See the function signature in fn/socpts.py for argument names.
```
