...
`print(result)` render. See `moirais.fn.describe('gcdrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcdrg import *
import numpy as np
# See the function signature in fn/gcdrg.py for argument names.
```
