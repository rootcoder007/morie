# describe('gb1441') — gibbons_fisher_exact
...
`print(result)` render. See `moirais.fn.describe('gb1441')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1441 import *
import numpy as np
# See the function signature in fn/gb1441.py for argument names.
```
