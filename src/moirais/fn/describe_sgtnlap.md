# describe('sgtnlap') — sgt_normalised_laplacian
...
`print(result)` render. See `moirais.fn.describe('sgtnlap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtnlap import *
import numpy as np
# See the function signature in fn/sgtnlap.py for argument names.
```
