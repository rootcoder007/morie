...
`print(result)` render. See `moirais.fn.describe('fmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fmm import *
import numpy as np
# See the function signature in fn/fmm.py for argument names.
```
