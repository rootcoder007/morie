# describe('hmmpp') — geron_model_parallelism
...
`print(result)` render. See `moirais.fn.describe('hmmpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmpp import *
import numpy as np
# See the function signature in fn/hmmpp.py for argument names.
```
