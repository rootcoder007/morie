# describe('rgsmom') — rangayyan_spectral_moments
...
`print(result)` render. See `moirais.fn.describe('rgsmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsmom import *
import numpy as np
# See the function signature in fn/rgsmom.py for argument names.
```
