...
`print(result)` render. See `moirais.fn.describe('phssp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phssp import *
import numpy as np
# See the function signature in fn/phssp.py for argument names.
```
