# describe('msm029') — mvsml_linear_mixed_models_eq_5_5
...
`print(result)` render. See `moirais.fn.describe('msm029')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm029 import *
import numpy as np
# See the function signature in fn/msm029.py for argument names.
```
