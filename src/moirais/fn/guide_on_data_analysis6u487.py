...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_487"]


def guide_on_data_analysis_chapter_6_unnumbered_487(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜃𝑖 = 𝜃1 + 𝜎(𝜃𝑖 − 𝜃1), ∀𝑖 > 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u487')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u487: GeneralStatistics expression (auto-extracted; see ref)."
