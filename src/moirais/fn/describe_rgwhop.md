# describe('rgwhop') — rangayyan_wiener_hopf
...
`print(result)` render. See `moirais.fn.describe('rgwhop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwhop import *
import numpy as np
# See the function signature in fn/rgwhop.py for argument names.
```
