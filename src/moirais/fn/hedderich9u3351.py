...
__all__ = ["hedderich_chapter_9_unnumbered_3351"]


def hedderich_chapter_9_unnumbered_3351(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] [yi(β0 +β1xi)−log(1 +eβ0+β1xi )] . (8.53)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3351')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3351: Logistic expression (auto-extracted; see ref)."
