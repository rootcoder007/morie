...
`print(result)` render. See `moirais.fn.describe('svmp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmp2 import *
import numpy as np
# See the function signature in fn/svmp2.py for argument names.
```
