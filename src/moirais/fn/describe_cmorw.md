...
`print(result)` render. See `moirais.fn.describe('cmorw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmorw import *
import numpy as np
# See the function signature in fn/cmorw.py for argument names.
```
