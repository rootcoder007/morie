# describe('almrr') — alammar_mean_reciprocal_rank
...
`print(result)` render. See `moirais.fn.describe('almrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.almrr import *
import numpy as np
# See the function signature in fn/almrr.py for argument names.
```
