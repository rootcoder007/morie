...
`print(result)` render. See `moirais.fn.describe('baynet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baynet import *
import numpy as np
# See the function signature in fn/baynet.py for argument names.
```
