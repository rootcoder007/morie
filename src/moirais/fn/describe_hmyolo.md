...
`print(result)` render. See `moirais.fn.describe('hmyolo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmyolo import *
import numpy as np
# See the function signature in fn/hmyolo.py for argument names.
```
