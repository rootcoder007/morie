...
`print(result)` render. See `moirais.fn.describe('dinov2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dinov2 import *
import numpy as np
# See the function signature in fn/dinov2.py for argument names.
```
