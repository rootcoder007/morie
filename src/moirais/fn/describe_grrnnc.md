# describe('grrnnc') — geron_simple_rnn_cell
...
`print(result)` render. See `moirais.fn.describe('grrnnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrnnc import *
import numpy as np
# See the function signature in fn/grrnnc.py for argument names.
```
