# describe('c3po') — concordance_index

## WHAT IT DOES

Concordance index (C-statistic). 'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('c3po')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.c3po import *
import numpy as np
# See the function signature in fn/c3po.py for argument names.
```
