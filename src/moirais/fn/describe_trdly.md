...
`print(result)` render. See `moirais.fn.describe('trdly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdly import *
import numpy as np
# See the function signature in fn/trdly.py for argument names.
```
