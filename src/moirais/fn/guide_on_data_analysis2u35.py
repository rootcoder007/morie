...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_35"]


def guide_on_data_analysis_chapter_2_unnumbered_35(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐹(𝑥) = 𝑃(𝑋 ≤ 𝑥) 𝐹(𝑥) = 𝑃(𝑋 ≤ 𝑥) =∫
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u35')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u35: GeneralStatistics expression (auto-extracted; see ref)."
