...
`print(result)` render. See `moirais.fn.describe('intgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intgn import *
import numpy as np
# See the function signature in fn/intgn.py for argument names.
```
