...
__all__ = ["wilcox_chapter_14_unnumbered_508"]


def wilcox_chapter_14_unnumbered_508(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 1 − α confidence interval for ρ 12 − ρ 34 is (L, U ), where
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u508')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u508: PowerAndDesign expression (auto-extracted; see ref)."
