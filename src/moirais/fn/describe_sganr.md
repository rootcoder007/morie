# describe('sganr') — anisotropy_ratio
...
`print(result)` render. See `moirais.fn.describe('sganr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sganr import *
import numpy as np
# See the function signature in fn/sganr.py for argument names.
```
