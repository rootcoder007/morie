...
__all__ = ["hedderich_chapter_9_unnumbered_2717"]


def hedderich_chapter_9_unnumbered_2717(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] H0 : P1 =P2 i.e. P1/P2 =ψ= 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2717')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2717: PowerAndDesign expression (auto-extracted; see ref)."
