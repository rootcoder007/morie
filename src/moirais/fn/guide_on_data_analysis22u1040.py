...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1040"]


def guide_on_data_analysis_chapter_22_unnumbered_1040(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘 = 𝜇 + 𝛼𝑖 + 𝐵𝑘 + 𝛽𝑗 + (𝛼𝛽)𝑖𝑗 + 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1040')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1040: GeneralStatistics expression (auto-extracted; see ref)."
