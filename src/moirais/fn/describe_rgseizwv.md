# describe('rgseizwv') — rangayyan_seizure_wavelet
...
`print(result)` render. See `moirais.fn.describe('rgseizwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgseizwv import *
import numpy as np
# See the function signature in fn/rgseizwv.py for argument names.
```
