...
`print(result)` render. See `moirais.fn.describe('mtvul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtvul import *
import numpy as np
# See the function signature in fn/mtvul.py for argument names.
```
