# describe('msm142') — mvsml_categorical_count_eq_8_9
...
`print(result)` render. See `moirais.fn.describe('msm142')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm142 import *
import numpy as np
# See the function signature in fn/msm142.py for argument names.
```
