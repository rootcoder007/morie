# describe('sgidx') — index_of_dispersion
...
`print(result)` render. See `moirais.fn.describe('sgidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgidx import *
import numpy as np
# See the function signature in fn/sgidx.py for argument names.
```
