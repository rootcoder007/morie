...
`print(result)` render. See `moirais.fn.describe('entmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entmp import *
import numpy as np
# See the function signature in fn/entmp.py for argument names.
```
