...
__all__ = ["hedderich_chapter_9_unnumbered_1114"]


def hedderich_chapter_9_unnumbered_1114(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfrow= c ( 1 , 1 ) , lwd =2 , b t y =" n " , font =1 , font . a x i s=2 , ps =15)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1114')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1114: GeneralStatistics expression (auto-extracted; see ref)."
