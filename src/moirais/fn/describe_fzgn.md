# describe('fzgn') — fauzi_gn_edgeworth_correction
...
`print(result)` render. See `moirais.fn.describe('fzgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzgn import *
import numpy as np
# See the function signature in fn/fzgn.py for argument names.
```
