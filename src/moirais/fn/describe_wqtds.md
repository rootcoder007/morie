...
`print(result)` render. See `moirais.fn.describe('wqtds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtds import *
import numpy as np
# See the function signature in fn/wqtds.py for argument names.
```
