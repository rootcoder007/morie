...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_312"]


def guide_on_data_analysis_chapter_5_unnumbered_312(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑆𝑆𝑇𝑂/(𝑛 − 1)= 1 − (𝑛 − 1)𝑆𝑆𝐸
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u312')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u312: GeneralStatistics expression (auto-extracted; see ref)."
