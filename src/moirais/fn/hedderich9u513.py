...
__all__ = ["hedderich_chapter_9_unnumbered_513"]


def hedderich_chapter_9_unnumbered_513(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Benefit =π(Sensitivity)−(1−π)(1−Specificity)(pt/(1−pt)) (4.55)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u513')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u513: GeneralStatistics expression (auto-extracted; see ref)."
