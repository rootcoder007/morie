# describe('nchunk') — causal_chunked_attention
...
`print(result)` render. See `moirais.fn.describe('nchunk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nchunk import *
import numpy as np
# See the function signature in fn/nchunk.py for argument names.
```
