...
`print(result)` render. See `moirais.fn.describe('saqmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saqmo import *
import numpy as np
# See the function signature in fn/saqmo.py for argument names.
```
