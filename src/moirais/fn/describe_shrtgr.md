# describe('shrtgr') — shrinkage_propensity
...
`print(result)` render. See `moirais.fn.describe('shrtgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrtgr import *
import numpy as np
# See the function signature in fn/shrtgr.py for argument names.
```
