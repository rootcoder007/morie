...
`print(result)` render. See `moirais.fn.describe('mdrcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdrcd import *
import numpy as np
# See the function signature in fn/mdrcd.py for argument names.
```
