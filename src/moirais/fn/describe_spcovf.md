# describe('spcovf') — schabenberger_covariance_function
...
`print(result)` render. See `moirais.fn.describe('spcovf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcovf import *
import numpy as np
# See the function signature in fn/spcovf.py for argument names.
```
