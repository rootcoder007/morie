# describe('ksr09') — kosorok_z_estimator
...
`print(result)` render. See `moirais.fn.describe('ksr09')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr09 import *
import numpy as np
# See the function signature in fn/ksr09.py for argument names.
```
