...
`print(result)` render. See `moirais.fn.describe('afbio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afbio import *
import numpy as np
# See the function signature in fn/afbio.py for argument names.
```
