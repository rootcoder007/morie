# describe('ssadc') — ssa_decompose_fn
...
`print(result)` render. See `moirais.fn.describe('ssadc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssadc import *
import numpy as np
# See the function signature in fn/ssadc.py for argument names.
```
