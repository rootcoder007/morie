...
`print(result)` render. See `moirais.fn.describe('swkern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swkern import *
import numpy as np
# See the function signature in fn/swkern.py for argument names.
```
