...
`print(result)` render. See `moirais.fn.describe('hyflf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyflf import *
import numpy as np
# See the function signature in fn/hyflf.py for argument names.
```
