...
`print(result)` render. See `moirais.fn.describe('pfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pfd import *
import numpy as np
# See the function signature in fn/pfd.py for argument names.
```
