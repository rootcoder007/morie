# describe('sglen') — signal_arc_length
...
`print(result)` render. See `moirais.fn.describe('sglen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglen import *
import numpy as np
# See the function signature in fn/sglen.py for argument names.
```
