...
__all__ = ["guide_on_data_analysis_chapter_8_unnumbered_665"]


def guide_on_data_analysis_chapter_8_unnumbered_665(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘 = 𝜇 + 𝜌𝑖 + 𝛼𝑗 + 𝑒𝑖𝑗 + 𝛽𝑘 + (𝛼𝛽)𝑗𝑘 + 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis8u665')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis8u665: GeneralStatistics expression (auto-extracted; see ref)."
