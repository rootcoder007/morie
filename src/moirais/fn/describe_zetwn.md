...
`print(result)` render. See `moirais.fn.describe('zetwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zetwn import *
import numpy as np
# See the function signature in fn/zetwn.py for argument names.
```
