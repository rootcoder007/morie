# describe('demin') — deming_regression
...
`print(result)` render. See `moirais.fn.describe('demin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.demin import *
import numpy as np
# See the function signature in fn/demin.py for argument names.
```
