...
`print(result)` render. See `moirais.fn.describe('pfsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pfsim import *
import numpy as np
# See the function signature in fn/pfsim.py for argument names.
```
