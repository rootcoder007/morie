# describe('mhtrn') — mental_health_trend
...
`print(result)` render. See `moirais.fn.describe('mhtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhtrn import *
import numpy as np
# See the function signature in fn/mhtrn.py for argument names.
```
