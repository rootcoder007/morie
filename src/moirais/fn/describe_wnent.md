...
`print(result)` render. See `moirais.fn.describe('wnent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnent import *
import numpy as np
# See the function signature in fn/wnent.py for argument names.
```
