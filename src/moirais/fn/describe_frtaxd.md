# describe('frtaxd') — forest_taxon_diversity
...
`print(result)` render. See `moirais.fn.describe('frtaxd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frtaxd import *
import numpy as np
# See the function signature in fn/frtaxd.py for argument names.
```
