# describe('sphet') — spatial_heterogeneity
...
`print(result)` render. See `moirais.fn.describe('sphet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sphet import *
import numpy as np
# See the function signature in fn/sphet.py for argument names.
```
