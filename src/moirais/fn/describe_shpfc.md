# describe('shpfc') — shape_factor_fn
...
`print(result)` render. See `moirais.fn.describe('shpfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shpfc import *
import numpy as np
# See the function signature in fn/shpfc.py for argument names.
```
