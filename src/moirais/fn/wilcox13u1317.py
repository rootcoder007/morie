...
__all__ = ["wilcox_chapter_13_unnumbered_1317"]


def wilcox_chapter_13_unnumbered_1317(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] (π (0))/[ 1 − π (0)]. (15.8)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1317')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1317: Logistic expression (auto-extracted; see ref)."
