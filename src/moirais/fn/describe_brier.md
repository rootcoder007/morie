...
`print(result)` render. See `moirais.fn.describe('brier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brier import *
import numpy as np
# See the function signature in fn/brier.py for argument names.
```
