...
`print(result)` render. See `moirais.fn.describe('hmsac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsac import *
import numpy as np
# See the function signature in fn/hmsac.py for argument names.
```
