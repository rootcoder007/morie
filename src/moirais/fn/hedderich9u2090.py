...
__all__ = ["hedderich_chapter_9_unnumbered_2090"]


def hedderich_chapter_9_unnumbered_2090(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] PC = 100[(N−V )/V ]% = 100[(N/V )−1]% = 12.5% and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2090')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2090: CausalInference expression (auto-extracted; see ref)."
