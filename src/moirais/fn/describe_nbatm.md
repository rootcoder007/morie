...
`print(result)` render. See `moirais.fn.describe('nbatm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbatm import *
import numpy as np
# See the function signature in fn/nbatm.py for argument names.
```
