# describe('divcd') — divergent_transitions_count
...
`print(result)` render. See `moirais.fn.describe('divcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.divcd import *
import numpy as np
# See the function signature in fn/divcd.py for argument names.
```
