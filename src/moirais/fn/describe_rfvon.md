...
`print(result)` render. See `moirais.fn.describe('rfvon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfvon import *
import numpy as np
# See the function signature in fn/rfvon.py for argument names.
```
