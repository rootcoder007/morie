...
__all__ = ["wilcox_chapter_7_unnumbered_322"]


def wilcox_chapter_7_unnumbered_322(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] N = max(10, [(21.4)2/30 .14] + 1) = 16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u322')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u322: PowerAndDesign expression (auto-extracted; see ref)."
