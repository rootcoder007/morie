...
`print(result)` render. See `moirais.fn.describe('semthe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semthe import *
import numpy as np
# See the function signature in fn/semthe.py for argument names.
```
