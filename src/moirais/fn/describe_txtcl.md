...
`print(result)` render. See `moirais.fn.describe('txtcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.txtcl import *
import numpy as np
# See the function signature in fn/txtcl.py for argument names.
```
