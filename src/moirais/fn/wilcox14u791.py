...
__all__ = ["wilcox_chapter_14_unnumbered_791"]


def wilcox_chapter_14_unnumbered_791(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: if F ≥ f , the 1 − α quantile of an F distribution with ν 1 = (J − 1)(K − 1) and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u791')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u791: GeneralStatistics expression (auto-extracted; see ref)."
