# describe('itopt') — item_option_freq
...
`print(result)` render. See `moirais.fn.describe('itopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itopt import *
import numpy as np
# See the function signature in fn/itopt.py for argument names.
```
