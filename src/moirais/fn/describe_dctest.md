# describe('dctest') — discontinuity_test
...
`print(result)` render. See `moirais.fn.describe('dctest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dctest import *
import numpy as np
# See the function signature in fn/dctest.py for argument names.
```
