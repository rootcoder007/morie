# describe('alfcrp') — alphafold_cropping
...
`print(result)` render. See `moirais.fn.describe('alfcrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfcrp import *
import numpy as np
# See the function signature in fn/alfcrp.py for argument names.
```
