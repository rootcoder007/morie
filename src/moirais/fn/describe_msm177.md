# describe('msm177') — mvsml_ridge_lasso_elastic_eq_9_5
...
`print(result)` render. See `moirais.fn.describe('msm177')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm177 import *
import numpy as np
# See the function signature in fn/msm177.py for argument names.
```
