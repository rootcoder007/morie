...
`print(result)` render. See `moirais.fn.describe('dtghs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtghs import *
import numpy as np
# See the function signature in fn/dtghs.py for argument names.
```
