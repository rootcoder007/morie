...
__all__ = ["wilcox_chapter_14_unnumbered_482"]


def wilcox_chapter_14_unnumbered_482(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To compute a 1 − α confidence interval, let c be (1 − α )B rounded to the nearest integer.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u482')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u482: GeneralStatistics expression (auto-extracted; see ref)."
