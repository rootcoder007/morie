# describe('airbed') — emissions_inventory
...
`print(result)` render. See `moirais.fn.describe('airbed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.airbed import *
import numpy as np
# See the function signature in fn/airbed.py for argument names.
```
