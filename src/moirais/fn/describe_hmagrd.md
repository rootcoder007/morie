# describe('hmagrd') — geron_autograd
...
`print(result)` render. See `moirais.fn.describe('hmagrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmagrd import *
import numpy as np
# See the function signature in fn/hmagrd.py for argument names.
```
