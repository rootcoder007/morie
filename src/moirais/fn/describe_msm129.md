# describe('msm129') — mvsml_categorical_count_eq_8_3
...
`print(result)` render. See `moirais.fn.describe('msm129')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm129 import *
import numpy as np
# See the function signature in fn/msm129.py for argument names.
```
