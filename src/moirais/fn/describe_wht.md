...
`print(result)` render. See `moirais.fn.describe('wht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wht import *
import numpy as np
# See the function signature in fn/wht.py for argument names.
```
