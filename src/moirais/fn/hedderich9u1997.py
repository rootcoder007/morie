...
__all__ = ["hedderich_chapter_9_unnumbered_1997"]


def hedderich_chapter_9_unnumbered_1997(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: a zi∈X and the value 0 for a zi∈Y with i = 1,...,N = m +n, the test statistic for the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1997')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1997: GeneralStatistics expression (auto-extracted; see ref)."
