...
`print(result)` render. See `moirais.fn.describe('mlfac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlfac import *
import numpy as np
# See the function signature in fn/mlfac.py for argument names.
```
