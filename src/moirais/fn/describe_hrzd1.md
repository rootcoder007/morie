# describe('hrzd1') — horowitz_duration_model
...
`print(result)` render. See `moirais.fn.describe('hrzd1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzd1 import *
import numpy as np
# See the function signature in fn/hrzd1.py for argument names.
```
