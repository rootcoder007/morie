...
`print(result)` render. See `moirais.fn.describe('suebac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suebac import *
import numpy as np
# See the function signature in fn/suebac.py for argument names.
```
