...
`print(result)` render. See `moirais.fn.describe('funCA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funCA import *
import numpy as np
# See the function signature in fn/funCA.py for argument names.
```
