# describe('rgann') — rangayyan_ann_mlp
...
`print(result)` render. See `moirais.fn.describe('rgann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgann import *
import numpy as np
# See the function signature in fn/rgann.py for argument names.
```
