...
`print(result)` render. See `moirais.fn.describe('raven')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raven import *
import numpy as np
# See the function signature in fn/raven.py for argument names.
```
