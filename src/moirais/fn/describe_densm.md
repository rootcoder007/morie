...
`print(result)` render. See `moirais.fn.describe('densm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.densm import *
import numpy as np
# See the function signature in fn/densm.py for argument names.
```
