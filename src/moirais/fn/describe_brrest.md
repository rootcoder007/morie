...
`print(result)` render. See `moirais.fn.describe('brrest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brrest import *
import numpy as np
# See the function signature in fn/brrest.py for argument names.
```
