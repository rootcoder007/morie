# describe('ksr15') — kosorok_one_step_estimator
...
`print(result)` render. See `moirais.fn.describe('ksr15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr15 import *
import numpy as np
# See the function signature in fn/ksr15.py for argument names.
```
