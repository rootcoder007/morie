...
__all__ = ["hedderich_chapter_9_unnumbered_1729"]


def hedderich_chapter_9_unnumbered_1729(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: difference ˆD. With ˆD=0.0225<0.043=0.86/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1729')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1729: CountModels expression (auto-extracted; see ref)."
