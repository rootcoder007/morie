...
`print(result)` render. See `moirais.fn.describe('zeenb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeenb import *
import numpy as np
# See the function signature in fn/zeenb.py for argument names.
```
