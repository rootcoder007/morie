...
`print(result)` render. See `moirais.fn.describe('zxilr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxilr import *
import numpy as np
# See the function signature in fn/zxilr.py for argument names.
```
