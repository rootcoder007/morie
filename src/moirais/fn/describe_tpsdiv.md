# describe('tpsdiv') — tps_division_compare
...
`print(result)` render. See `moirais.fn.describe('tpsdiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsdiv import *
import numpy as np
# See the function signature in fn/tpsdiv.py for argument names.
```
