# describe('otws2') — ot_wasserstein_p_1d
...
`print(result)` render. See `moirais.fn.describe('otws2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otws2 import *
import numpy as np
# See the function signature in fn/otws2.py for argument names.
```
