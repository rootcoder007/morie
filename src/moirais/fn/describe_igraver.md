...
`print(result)` render. See `moirais.fn.describe('igraver')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igraver import *
import numpy as np
# See the function signature in fn/igraver.py for argument names.
```
