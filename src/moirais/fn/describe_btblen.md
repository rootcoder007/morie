# describe('btblen') — boot_block_length_pr
...
`print(result)` render. See `moirais.fn.describe('btblen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btblen import *
import numpy as np
# See the function signature in fn/btblen.py for argument names.
```
