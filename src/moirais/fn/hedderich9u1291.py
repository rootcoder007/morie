...
__all__ = ["hedderich_chapter_9_unnumbered_1291"]


def hedderich_chapter_9_unnumbered_1291(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n2−1,1−α/2s2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1291')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1291: GeneralStatistics expression (auto-extracted; see ref)."
