...
__all__ = ["hedderich_chapter_9_unnumbered_359"]


def hedderich_chapter_9_unnumbered_359(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ax +b siny +c = 0 through the straight line ax′+by′+c = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u359')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u359: PowerAndDesign expression (auto-extracted; see ref)."
