...
__all__ = ["wilcox_chapter_10_unnumbered_1003"]


def wilcox_chapter_10_unnumbered_1003(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: size of n = 25, the goal is to compute a confidence interval for H0 : Ψ = 0 with α = 0.05,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1003')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1003: GeneralStatistics expression (auto-extracted; see ref)."
