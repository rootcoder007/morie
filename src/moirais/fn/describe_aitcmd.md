# describe('aitcmd') — compositional_median
...
`print(result)` render. See `moirais.fn.describe('aitcmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitcmd import *
import numpy as np
# See the function signature in fn/aitcmd.py for argument names.
```
