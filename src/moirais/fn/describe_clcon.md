...
`print(result)` render. See `moirais.fn.describe('clcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcon import *
import numpy as np
# See the function signature in fn/clcon.py for argument names.
```
