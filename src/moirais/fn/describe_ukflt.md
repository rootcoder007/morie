...
`print(result)` render. See `moirais.fn.describe('ukflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ukflt import *
import numpy as np
# See the function signature in fn/ukflt.py for argument names.
```
