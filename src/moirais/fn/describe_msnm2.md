...
`print(result)` render. See `moirais.fn.describe('msnm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msnm2 import *
import numpy as np
# See the function signature in fn/msnm2.py for argument names.
```
