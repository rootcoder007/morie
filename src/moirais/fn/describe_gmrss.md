...
`print(result)` render. See `moirais.fn.describe('gmrss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmrss import *
import numpy as np
# See the function signature in fn/gmrss.py for argument names.
```
