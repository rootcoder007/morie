...
`print(result)` render. See `moirais.fn.describe('convhl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.convhl import *
import numpy as np
# See the function signature in fn/convhl.py for argument names.
```
