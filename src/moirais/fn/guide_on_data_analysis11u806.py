...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_806"]


def guide_on_data_analysis_chapter_11_unnumbered_806(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • 𝑔 = Grandmother, 𝑚 = Mother, 𝑗 = Child, 𝑡 = Time.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u806')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u806: GeneralStatistics expression (auto-extracted; see ref)."
