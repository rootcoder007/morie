...
`print(result)` render. See `moirais.fn.describe('egnnL')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egnnL import *
import numpy as np
# See the function signature in fn/egnnL.py for argument names.
```
