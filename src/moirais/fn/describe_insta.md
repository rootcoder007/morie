# describe('insta') — instantaneous_amp
...
`print(result)` render. See `moirais.fn.describe('insta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.insta import *
import numpy as np
# See the function signature in fn/insta.py for argument names.
```
