# describe('agstds') — age_standardize
...
`print(result)` render. See `moirais.fn.describe('agstds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agstds import *
import numpy as np
# See the function signature in fn/agstds.py for argument names.
```
