# describe('msm334') — mvsml_preprocessing_eq_2_22
...
`print(result)` render. See `moirais.fn.describe('msm334')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm334 import *
import numpy as np
# See the function signature in fn/msm334.py for argument names.
```
