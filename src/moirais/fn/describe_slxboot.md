...
`print(result)` render. See `moirais.fn.describe('slxboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxboot import *
import numpy as np
# See the function signature in fn/slxboot.py for argument names.
```
