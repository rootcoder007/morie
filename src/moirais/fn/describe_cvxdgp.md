# describe('cvxdgp') — boyd_dual_problem
...
`print(result)` render. See `moirais.fn.describe('cvxdgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxdgp import *
import numpy as np
# See the function signature in fn/cvxdgp.py for argument names.
```
