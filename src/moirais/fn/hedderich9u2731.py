...
__all__ = ["hedderich_chapter_9_unnumbered_2731"]


def hedderich_chapter_9_unnumbered_2731(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + einseitig =TRUE, r =1) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2731')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2731: PowerAndDesign expression (auto-extracted; see ref)."
