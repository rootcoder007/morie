...
`print(result)` render. See `moirais.fn.describe('aglai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglai import *
import numpy as np
# See the function signature in fn/aglai.py for argument names.
```
