...
__all__ = ["hedderich_chapter_9_unnumbered_2129"]


def hedderich_chapter_9_unnumbered_2129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: W = 53 , p− value = 0 .0 1 4 06
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2129')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2129: GeneralStatistics expression (auto-extracted; see ref)."
