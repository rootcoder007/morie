# describe('gb_pit2') — gibbons_pit_rng
...
`print(result)` render. See `moirais.fn.describe('gb_pit2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_pit2 import *
import numpy as np
# See the function signature in fn/gb_pit2.py for argument names.
```
