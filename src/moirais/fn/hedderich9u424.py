...
__all__ = ["hedderich_chapter_9_unnumbered_424"]


def hedderich_chapter_9_unnumbered_424(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P = 1−P ( ¯M∩¯F ) = 1−0.4599·0.2857 = 1−0.1314 = 0.8686 or
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u424')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u424: GeneralStatistics expression (auto-extracted; see ref)."
