# describe('hrzt2') — horowitz_local_ate
...
`print(result)` render. See `moirais.fn.describe('hrzt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzt2 import *
import numpy as np
# See the function signature in fn/hrzt2.py for argument names.
```
