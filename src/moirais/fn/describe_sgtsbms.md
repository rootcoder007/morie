# describe('sgtsbms') — sgt_sbm_spectral_estimate
...
`print(result)` render. See `moirais.fn.describe('sgtsbms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsbms import *
import numpy as np
# See the function signature in fn/sgtsbms.py for argument names.
```
