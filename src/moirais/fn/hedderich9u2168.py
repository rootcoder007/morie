...
__all__ = ["hedderich_chapter_9_unnumbered_2168"]


def hedderich_chapter_9_unnumbered_2168(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆRp + ˆRn = n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2168')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2168: GeneralStatistics expression (auto-extracted; see ref)."
