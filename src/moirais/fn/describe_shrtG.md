# describe('shrtG') — shortest_path_kernel
...
`print(result)` render. See `moirais.fn.describe('shrtG')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrtG import *
import numpy as np
# See the function signature in fn/shrtG.py for argument names.
```
