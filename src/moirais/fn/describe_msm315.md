# describe('msm315') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm315')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm315 import *
import numpy as np
# See the function signature in fn/msm315.py for argument names.
```
