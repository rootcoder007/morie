# describe('drctf') — dr_continuous_treatment
...
`print(result)` render. See `moirais.fn.describe('drctf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drctf import *
import numpy as np
# See the function signature in fn/drctf.py for argument names.
```
