...
`print(result)` render. See `moirais.fn.describe('idppt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idppt import *
import numpy as np
# See the function signature in fn/idppt.py for argument names.
```
