# describe('arisc') — adjusted_rand_index
...
`print(result)` render. See `moirais.fn.describe('arisc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arisc import *
import numpy as np
# See the function signature in fn/arisc.py for argument names.
```
