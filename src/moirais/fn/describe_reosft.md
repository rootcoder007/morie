...
`print(result)` render. See `moirais.fn.describe('reosft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reosft import *
import numpy as np
# See the function signature in fn/reosft.py for argument names.
```
