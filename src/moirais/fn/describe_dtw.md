...
`print(result)` render. See `moirais.fn.describe('dtw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtw import *
import numpy as np
# See the function signature in fn/dtw.py for argument names.
```
