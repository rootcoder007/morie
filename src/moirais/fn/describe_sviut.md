...
`print(result)` render. See `moirais.fn.describe('sviut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sviut import *
import numpy as np
# See the function signature in fn/sviut.py for argument names.
```
