# describe('eqint') — equalization_inverse
...
`print(result)` render. See `moirais.fn.describe('eqint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqint import *
import numpy as np
# See the function signature in fn/eqint.py for argument names.
```
