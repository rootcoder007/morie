...
__all__ = ["hedderich_chapter_9_unnumbered_2894"]


def hedderich_chapter_9_unnumbered_2894(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] k−1,1−α) (7.338)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2894')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2894: PowerAndDesign expression (auto-extracted; see ref)."
