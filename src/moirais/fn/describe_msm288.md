# describe('msm288') — mvsml_convolutional_nn_eq_14_11
...
`print(result)` render. See `moirais.fn.describe('msm288')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm288 import *
import numpy as np
# See the function signature in fn/msm288.py for argument names.
```
