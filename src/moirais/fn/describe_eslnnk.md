# describe('eslnnk') — esl_nadaraya_watson
...
`print(result)` render. See `moirais.fn.describe('eslnnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnnk import *
import numpy as np
# See the function signature in fn/eslnnk.py for argument names.
```
