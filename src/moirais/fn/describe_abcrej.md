...
`print(result)` render. See `moirais.fn.describe('abcrej')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcrej import *
import numpy as np
# See the function signature in fn/abcrej.py for argument names.
```
