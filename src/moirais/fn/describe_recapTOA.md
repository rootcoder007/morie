# describe('recapTOA') — toa_radiation_balance
...
`print(result)` render. See `moirais.fn.describe('recapTOA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.recapTOA import *
import numpy as np
# See the function signature in fn/recapTOA.py for argument names.
```
