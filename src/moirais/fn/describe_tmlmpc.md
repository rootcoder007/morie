# describe('tmlmpc') — tmle_multi_state_phc
...
`print(result)` render. See `moirais.fn.describe('tmlmpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmpc import *
import numpy as np
# See the function signature in fn/tmlmpc.py for argument names.
```
