...
`print(result)` render. See `moirais.fn.describe('rdpil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdpil import *
import numpy as np
# See the function signature in fn/rdpil.py for argument names.
```
