...
__all__ = ["hedderich_chapter_9_unnumbered_2325"]


def hedderich_chapter_9_unnumbered_2325(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( " z =" , z , " and combined P− value =" , P . value , " \ n " ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2325')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2325: GeneralStatistics expression (auto-extracted; see ref)."
