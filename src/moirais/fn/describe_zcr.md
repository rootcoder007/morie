# describe('zcr') — zero_crossing_rate
...
`print(result)` render. See `moirais.fn.describe('zcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zcr import *
import numpy as np
# See the function signature in fn/zcr.py for argument names.
```
