...
__all__ = ["hedderich_chapter_9_unnumbered_1385"]


def hedderich_chapter_9_unnumbered_1385(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1385')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1385: PowerAndDesign expression (auto-extracted; see ref)."
