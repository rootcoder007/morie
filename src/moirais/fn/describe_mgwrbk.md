...
`print(result)` render. See `moirais.fn.describe('mgwrbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrbk import *
import numpy as np
# See the function signature in fn/mgwrbk.py for argument names.
```
