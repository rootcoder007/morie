# describe('lpdwc') — log_pointwise_predictive_density
...
`print(result)` render. See `moirais.fn.describe('lpdwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpdwc import *
import numpy as np
# See the function signature in fn/lpdwc.py for argument names.
```
