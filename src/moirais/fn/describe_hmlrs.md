# describe('hmlrs') — geron_learning_rate_schedule
...
`print(result)` render. See `moirais.fn.describe('hmlrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrs import *
import numpy as np
# See the function signature in fn/hmlrs.py for argument names.
```
