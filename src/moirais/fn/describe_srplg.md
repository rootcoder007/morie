...
`print(result)` render. See `moirais.fn.describe('srplg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srplg import *
import numpy as np
# See the function signature in fn/srplg.py for argument names.
```
