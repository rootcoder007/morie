...
`print(result)` render. See `moirais.fn.describe('complE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.complE import *
import numpy as np
# See the function signature in fn/complE.py for argument names.
```
