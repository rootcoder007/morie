# describe('gtruncwt') — truncate_weights
...
`print(result)` render. See `moirais.fn.describe('gtruncwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gtruncwt import *
import numpy as np
# See the function signature in fn/gtruncwt.py for argument names.
```
