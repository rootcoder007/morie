...
`print(result)` render. See `moirais.fn.describe('clazp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clazp import *
import numpy as np
# See the function signature in fn/clazp.py for argument names.
```
