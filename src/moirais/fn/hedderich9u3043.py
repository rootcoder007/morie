...
__all__ = ["hedderich_chapter_9_unnumbered_3043"]


def hedderich_chapter_9_unnumbered_3043(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pval <− pchisq ( stat , df =2 , lower . tail = FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3043')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3043: GeneralStatistics expression (auto-extracted; see ref)."
