...
__all__ = ["bivand2013_chapter_7_unnumbered_97"]


def bivand2013_chapter_7_unnumbered_97(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The results for the test with null hypothesisρ=ˆρ0 turned out to be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u97')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u97: GeneralStatistics expression (auto-extracted; see ref)."
