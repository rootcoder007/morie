# describe('ksr032') — kosorok_ch2_weak_convergence_iff
...
`print(result)` render. See `moirais.fn.describe('ksr032')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr032 import *
import numpy as np
# See the function signature in fn/ksr032.py for argument names.
```
