# describe('tmlovo') — tmle_outcome_only_regr
...
`print(result)` render. See `moirais.fn.describe('tmlovo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlovo import *
import numpy as np
# See the function signature in fn/tmlovo.py for argument names.
```
