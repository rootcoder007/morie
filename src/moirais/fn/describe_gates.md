# describe('gates') — logic_gates

## WHAT IT DOES

Logic gate simulation. 'These aren't the droids you'An unexamined life is not worth living. — Socrates'
...
`print(result)` render. See `moirais.fn.describe('gates')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gates import *
import numpy as np
# See the function signature in fn/gates.py for argument names.
```
