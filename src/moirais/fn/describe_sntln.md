# describe('sntln') — sentence_length
...
`print(result)` render. See `moirais.fn.describe('sntln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntln import *
import numpy as np
# See the function signature in fn/sntln.py for argument names.
```
