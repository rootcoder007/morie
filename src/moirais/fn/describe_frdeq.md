...
`print(result)` render. See `moirais.fn.describe('frdeq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frdeq import *
import numpy as np
# See the function signature in fn/frdeq.py for argument names.
```
