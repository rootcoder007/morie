# describe('baipv') — bai_perron_multiple_breaks
...
`print(result)` render. See `moirais.fn.describe('baipv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baipv import *
import numpy as np
# See the function signature in fn/baipv.py for argument names.
```
