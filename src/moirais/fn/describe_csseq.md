...
`print(result)` render. See `moirais.fn.describe('csseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csseq import *
import numpy as np
# See the function signature in fn/csseq.py for argument names.
```
