...
`print(result)` render. See `moirais.fn.describe('sukht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sukht import *
import numpy as np
# See the function signature in fn/sukht.py for argument names.
```
