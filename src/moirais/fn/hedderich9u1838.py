...
__all__ = ["hedderich_chapter_9_unnumbered_1838"]


def hedderich_chapter_9_unnumbered_1838(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: negative values (xi−˜µ0) (i = 1, . . . ,n), and checked: ˆRp + ˆRn =n(n + 1)/2.H0 is rejected at
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1838')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1838: GeneralStatistics expression (auto-extracted; see ref)."
