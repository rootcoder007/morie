...
`print(result)` render. See `moirais.fn.describe('seiqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seiqr import *
import numpy as np
# See the function signature in fn/seiqr.py for argument names.
```
