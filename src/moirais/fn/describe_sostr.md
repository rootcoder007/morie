...
`print(result)` render. See `moirais.fn.describe('sostr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sostr import *
import numpy as np
# See the function signature in fn/sostr.py for argument names.
```
