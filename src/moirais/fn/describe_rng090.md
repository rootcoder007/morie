# describe('rng090') — rangayyan_ch3_hann_impulse_response
...
`print(result)` render. See `moirais.fn.describe('rng090')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng090 import *
import numpy as np
# See the function signature in fn/rng090.py for argument names.
```
