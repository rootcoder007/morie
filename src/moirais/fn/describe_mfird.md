# describe('mfird') — mirt_factor_loading
...
`print(result)` render. See `moirais.fn.describe('mfird')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mfird import *
import numpy as np
# See the function signature in fn/mfird.py for argument names.
```
