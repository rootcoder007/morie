# describe('jotsrg') — joseph_ts_as_regression
...
`print(result)` render. See `moirais.fn.describe('jotsrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jotsrg import *
import numpy as np
# See the function signature in fn/jotsrg.py for argument names.
```
