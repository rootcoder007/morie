# describe('abind') — ab_indirect_effect
...
`print(result)` render. See `moirais.fn.describe('abind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abind import *
import numpy as np
# See the function signature in fn/abind.py for argument names.
```
