# describe('dient') — dispersion_entropy
...
`print(result)` render. See `moirais.fn.describe('dient')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dient import *
import numpy as np
# See the function signature in fn/dient.py for argument names.
```
