...
`print(result)` render. See `moirais.fn.describe('sveir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sveir import *
import numpy as np
# See the function signature in fn/sveir.py for argument names.
```
