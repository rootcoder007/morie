# describe('lgrte') — local_growth_rate
...
`print(result)` render. See `moirais.fn.describe('lgrte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgrte import *
import numpy as np
# See the function signature in fn/lgrte.py for argument names.
```
