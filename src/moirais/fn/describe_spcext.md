...
`print(result)` render. See `moirais.fn.describe('spcext')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcext import *
import numpy as np
# See the function signature in fn/spcext.py for argument names.
```
