...
__all__ = ["hedderich_chapter_9_unnumbered_31"]


def hedderich_chapter_9_unnumbered_31(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u31')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u31: GeneralStatistics expression (auto-extracted; see ref)."
