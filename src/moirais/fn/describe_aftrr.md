...
`print(result)` render. See `moirais.fn.describe('aftrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftrr import *
import numpy as np
# See the function signature in fn/aftrr.py for argument names.
```
