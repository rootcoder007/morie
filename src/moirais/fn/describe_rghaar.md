# describe('rghaar') — rangayyan_haar_wavelet
...
`print(result)` render. See `moirais.fn.describe('rghaar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghaar import *
import numpy as np
# See the function signature in fn/rghaar.py for argument names.
```
