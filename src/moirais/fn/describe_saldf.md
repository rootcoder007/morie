...
`print(result)` render. See `moirais.fn.describe('saldf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saldf import *
import numpy as np
# See the function signature in fn/saldf.py for argument names.
```
