...
__all__ = ["hedderich_chapter_9_unnumbered_3096"]


def hedderich_chapter_9_unnumbered_3096(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (III)H0:ϱ≥0 [againstHA:ϱ<0]:−ˆt≤tn−2;α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3096')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3096: PowerAndDesign expression (auto-extracted; see ref)."
