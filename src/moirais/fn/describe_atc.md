...
`print(result)` render. See `moirais.fn.describe('atc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atc import *
import numpy as np
# See the function signature in fn/atc.py for argument names.
```
