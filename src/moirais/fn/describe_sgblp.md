...
`print(result)` render. See `moirais.fn.describe('sgblp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgblp import *
import numpy as np
# See the function signature in fn/sgblp.py for argument names.
```
