# describe('grcfm') — geron_confusion_matrix
...
`print(result)` render. See `moirais.fn.describe('grcfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcfm import *
import numpy as np
# See the function signature in fn/grcfm.py for argument names.
```
