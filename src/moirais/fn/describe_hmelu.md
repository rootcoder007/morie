...
`print(result)` render. See `moirais.fn.describe('hmelu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmelu import *
import numpy as np
# See the function signature in fn/hmelu.py for argument names.
```
