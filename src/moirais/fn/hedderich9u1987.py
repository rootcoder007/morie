...
__all__ = ["hedderich_chapter_9_unnumbered_1987"]


def hedderich_chapter_9_unnumbered_1987(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ☞If ˜µA and ˜µB differ more strongly (˜µA > ˜µB), it is advisable to subtract the valuek = ˜µA−˜µB
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1987')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1987: GeneralStatistics expression (auto-extracted; see ref)."
