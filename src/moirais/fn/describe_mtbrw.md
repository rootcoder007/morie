...
`print(result)` render. See `moirais.fn.describe('mtbrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtbrw import *
import numpy as np
# See the function signature in fn/mtbrw.py for argument names.
```
