...
__all__ = ["hedderich_chapter_9_unnumbered_85"]


def hedderich_chapter_9_unnumbered_85(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ij = (−1)j+i|Aij|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u85')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u85: GeneralStatistics expression (auto-extracted; see ref)."
