...
`print(result)` render. See `moirais.fn.describe('crime')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crime import *
import numpy as np
# See the function signature in fn/crime.py for argument names.
```
