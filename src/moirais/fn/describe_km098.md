# describe('km098') — kamath_ch6_log_prob_ratio_attr
...
`print(result)` render. See `moirais.fn.describe('km098')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km098 import *
import numpy as np
# See the function signature in fn/km098.py for argument names.
```
