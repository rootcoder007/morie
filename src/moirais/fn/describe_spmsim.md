# describe('spmsim') — schabenberger_mgwr_bandwidth
...
`print(result)` render. See `moirais.fn.describe('spmsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmsim import *
import numpy as np
# See the function signature in fn/spmsim.py for argument names.
```
