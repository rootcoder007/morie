...
`print(result)` render. See `moirais.fn.describe('tobit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tobit import *
import numpy as np
# See the function signature in fn/tobit.py for argument names.
```
