# describe('vbgmm') — vb_gaussian_mixture
...
`print(result)` render. See `moirais.fn.describe('vbgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vbgmm import *
import numpy as np
# See the function signature in fn/vbgmm.py for argument names.
```
