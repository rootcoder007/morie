...
`print(result)` render. See `moirais.fn.describe('entsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entsn import *
import numpy as np
# See the function signature in fn/entsn.py for argument names.
```
