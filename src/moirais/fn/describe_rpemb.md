...
`print(result)` render. See `moirais.fn.describe('rpemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpemb import *
import numpy as np
# See the function signature in fn/rpemb.py for argument names.
```
