# describe('nndist') — nearest_neighbor_distance
...
`print(result)` render. See `moirais.fn.describe('nndist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nndist import *
import numpy as np
# See the function signature in fn/nndist.py for argument names.
```
