...
`print(result)` render. See `moirais.fn.describe('evespot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evespot import *
import numpy as np
# See the function signature in fn/evespot.py for argument names.
```
