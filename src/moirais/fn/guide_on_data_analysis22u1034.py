...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1034"]


def guide_on_data_analysis_chapter_22_unnumbered_1034(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘 = 𝜇 + 𝜏𝑖 + 𝛾𝑗 + (𝜏𝛾)𝑖𝑗 + 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1034')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1034: GeneralStatistics expression (auto-extracted; see ref)."
