...
`print(result)` render. See `moirais.fn.describe('nwker')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwker import *
import numpy as np
# See the function signature in fn/nwker.py for argument names.
```
