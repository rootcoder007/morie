...
`print(result)` render. See `moirais.fn.describe('seclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclp import *
import numpy as np
# See the function signature in fn/seclp.py for argument names.
```
