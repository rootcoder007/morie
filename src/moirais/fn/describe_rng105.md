# describe('rng105') — rangayyan_ch3_integrator_frequency_response
...
`print(result)` render. See `moirais.fn.describe('rng105')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng105 import *
import numpy as np
# See the function signature in fn/rng105.py for argument names.
```
