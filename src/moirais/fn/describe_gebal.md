...
`print(result)` render. See `moirais.fn.describe('gebal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gebal import *
import numpy as np
# See the function signature in fn/gebal.py for argument names.
```
