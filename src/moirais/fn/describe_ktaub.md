...
`print(result)` render. See `moirais.fn.describe('ktaub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ktaub import *
import numpy as np
# See the function signature in fn/ktaub.py for argument names.
```
