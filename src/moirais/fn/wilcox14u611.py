...
__all__ = ["wilcox_chapter_14_unnumbered_611"]


def wilcox_chapter_14_unnumbered_611(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] = sum(x), n1 = length(x), r2 = sum(y), n2 = length(y), x = NA, y
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u611')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u611: PowerAndDesign expression (auto-extracted; see ref)."
