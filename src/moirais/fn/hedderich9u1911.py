...
__all__ = ["hedderich_chapter_9_unnumbered_1911"]


def hedderich_chapter_9_unnumbered_1911(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺per interval occur, this is compatible withH0 :λ=10 againstHA :λ>10 andαone−sided = 0.05.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1911')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1911: GeneralStatistics expression (auto-extracted; see ref)."
