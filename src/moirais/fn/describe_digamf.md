...
`print(result)` render. See `moirais.fn.describe('digamf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.digamf import *
import numpy as np
# See the function signature in fn/digamf.py for argument names.
```
