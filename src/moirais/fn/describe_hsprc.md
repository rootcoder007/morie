...
`print(result)` render. See `moirais.fn.describe('hsprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsprc import *
import numpy as np
# See the function signature in fn/hsprc.py for argument names.
```
