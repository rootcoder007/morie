# describe('kmklr') — kamath_kl_reward_shaping
...
`print(result)` render. See `moirais.fn.describe('kmklr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmklr import *
import numpy as np
# See the function signature in fn/kmklr.py for argument names.
```
