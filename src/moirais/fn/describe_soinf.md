...
`print(result)` render. See `moirais.fn.describe('soinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soinf import *
import numpy as np
# See the function signature in fn/soinf.py for argument names.
```
