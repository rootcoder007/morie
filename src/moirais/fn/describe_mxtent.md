...
`print(result)` render. See `moirais.fn.describe('mxtent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxtent import *
import numpy as np
# See the function signature in fn/mxtent.py for argument names.
```
