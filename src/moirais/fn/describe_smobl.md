...
`print(result)` render. See `moirais.fn.describe('smobl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smobl import *
import numpy as np
# See the function signature in fn/smobl.py for argument names.
```
