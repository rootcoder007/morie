# describe('epdsg') — epidemic_curve_fit
...
`print(result)` render. See `moirais.fn.describe('epdsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epdsg import *
import numpy as np
# See the function signature in fn/epdsg.py for argument names.
```
