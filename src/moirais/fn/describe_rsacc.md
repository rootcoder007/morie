...
`print(result)` render. See `moirais.fn.describe('rsacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsacc import *
import numpy as np
# See the function signature in fn/rsacc.py for argument names.
```
