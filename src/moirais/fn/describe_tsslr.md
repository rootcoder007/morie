...
`print(result)` render. See `moirais.fn.describe('tsslr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsslr import *
import numpy as np
# See the function signature in fn/tsslr.py for argument names.
```
