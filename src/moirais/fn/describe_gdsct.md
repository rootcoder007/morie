# describe('gdsct') — gradient_descent
...
`print(result)` render. See `moirais.fn.describe('gdsct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdsct import *
import numpy as np
# See the function signature in fn/gdsct.py for argument names.
```
