...
__all__ = ["use_r_chapter_2_unnumbered_231"]


def use_r_chapter_2_unnumbered_231(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: number of cases in region i can be calculated as Ei = Pir+,wher er+ is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u231')`` for the full guide.
...
def cheatsheet():
    return "use_r2u231: GeneralStatistics expression (auto-extracted; see ref)."
