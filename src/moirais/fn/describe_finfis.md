# describe('finfis') — fisher_information
...
`print(result)` render. See `moirais.fn.describe('finfis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.finfis import *
import numpy as np
# See the function signature in fn/finfis.py for argument names.
```
