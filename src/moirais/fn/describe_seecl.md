...
`print(result)` render. See `moirais.fn.describe('seecl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seecl import *
import numpy as np
# See the function signature in fn/seecl.py for argument names.
```
