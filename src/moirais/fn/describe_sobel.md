...
`print(result)` render. See `moirais.fn.describe('sobel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobel import *
import numpy as np
# See the function signature in fn/sobel.py for argument names.
```
