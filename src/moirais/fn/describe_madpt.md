...
`print(result)` render. See `moirais.fn.describe('madpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madpt import *
import numpy as np
# See the function signature in fn/madpt.py for argument names.
```
