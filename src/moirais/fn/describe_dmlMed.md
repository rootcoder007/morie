# describe('dmlMed') — dml_mediation_orthogonal
...
`print(result)` render. See `moirais.fn.describe('dmlMed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmlMed import *
import numpy as np
# See the function signature in fn/dmlMed.py for argument names.
```
