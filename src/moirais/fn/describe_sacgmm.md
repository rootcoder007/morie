...
`print(result)` render. See `moirais.fn.describe('sacgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacgmm import *
import numpy as np
# See the function signature in fn/sacgmm.py for argument names.
```
