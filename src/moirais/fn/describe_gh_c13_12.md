# describe('gh_c13_12') — ghosal_smhaz_gp
...
`print(result)` render. See `moirais.fn.describe('gh_c13_12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_12 import *
import numpy as np
# See the function signature in fn/gh_c13_12.py for argument names.
```
