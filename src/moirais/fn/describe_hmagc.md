# describe('hmagc') — geron_agglomerative
...
`print(result)` render. See `moirais.fn.describe('hmagc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmagc import *
import numpy as np
# See the function signature in fn/hmagc.py for argument names.
```
