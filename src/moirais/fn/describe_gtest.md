...
`print(result)` render. See `moirais.fn.describe('gtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gtest import *
import numpy as np
# See the function signature in fn/gtest.py for argument names.
```
