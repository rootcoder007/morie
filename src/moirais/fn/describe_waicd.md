# describe('waicd') — waic_diagnostic
...
`print(result)` render. See `moirais.fn.describe('waicd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.waicd import *
import numpy as np
# See the function signature in fn/waicd.py for argument names.
```
