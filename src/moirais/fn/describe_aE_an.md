# describe('aE_an') — autoencoder_anomaly
...
`print(result)` render. See `moirais.fn.describe('aE_an')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aE_an import *
import numpy as np
# See the function signature in fn/aE_an.py for argument names.
```
