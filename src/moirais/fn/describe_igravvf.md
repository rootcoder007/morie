...
`print(result)` render. See `moirais.fn.describe('igravvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravvf import *
import numpy as np
# See the function signature in fn/igravvf.py for argument names.
```
