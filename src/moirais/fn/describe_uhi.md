# describe('uhi') — urban_heat_island
...
`print(result)` render. See `moirais.fn.describe('uhi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.uhi import *
import numpy as np
# See the function signature in fn/uhi.py for argument names.
```
