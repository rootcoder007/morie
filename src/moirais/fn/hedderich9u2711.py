...
__all__ = ["hedderich_chapter_9_unnumbered_2711"]


def hedderich_chapter_9_unnumbered_2711(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + zbeta <− qnorm ( beta , lower . tail =FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2711')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2711: PowerAndDesign expression (auto-extracted; see ref)."
