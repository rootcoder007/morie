# describe('dcrtc') — dicrotic_notch_detect
...
`print(result)` render. See `moirais.fn.describe('dcrtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcrtc import *
import numpy as np
# See the function signature in fn/dcrtc.py for argument names.
```
