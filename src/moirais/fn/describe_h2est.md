# describe('h2est') — heritability_lmm
...
`print(result)` render. See `moirais.fn.describe('h2est')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.h2est import *
import numpy as np
# See the function signature in fn/h2est.py for argument names.
```
