# describe('msm018') — mvsml_linear_mixed_models_eq_5_4
...
`print(result)` render. See `moirais.fn.describe('msm018')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm018 import *
import numpy as np
# See the function signature in fn/msm018.py for argument names.
```
