# describe('grstk') — geron_stacking_predictor
...
`print(result)` render. See `moirais.fn.describe('grstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grstk import *
import numpy as np
# See the function signature in fn/grstk.py for argument names.
```
