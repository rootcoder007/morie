# describe('sglus') — lu_decomposition_sim
...
`print(result)` render. See `moirais.fn.describe('sglus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglus import *
import numpy as np
# See the function signature in fn/sglus.py for argument names.
```
