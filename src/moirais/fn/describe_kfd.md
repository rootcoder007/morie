...
`print(result)` render. See `moirais.fn.describe('kfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kfd import *
import numpy as np
# See the function signature in fn/kfd.py for argument names.
```
