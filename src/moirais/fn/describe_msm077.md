# describe('msm077') — mvsml_bayesian_regression_eq_6_2
...
`print(result)` render. See `moirais.fn.describe('msm077')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm077 import *
import numpy as np
# See the function signature in fn/msm077.py for argument names.
```
