...
__all__ = ["hedderich_chapter_9_unnumbered_759"]


def hedderich_chapter_9_unnumbered_759(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X≤k =n1|N ;N1;n) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u759')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u759: CountModels expression (auto-extracted; see ref)."
