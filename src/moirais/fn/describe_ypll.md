# describe('ypll') — years_potential_life_lost
...
`print(result)` render. See `moirais.fn.describe('ypll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ypll import *
import numpy as np
# See the function signature in fn/ypll.py for argument names.
```
