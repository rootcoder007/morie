# describe('beams') — beams

## WHAT IT DOES

rBeam search decoding.
...
`print(result)` render. See `moirais.fn.describe('beams')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.beams import *
import numpy as np
# See the function signature in fn/beams.py for argument names.
```
