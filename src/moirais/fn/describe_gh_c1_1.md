# describe('gh_c1_1') — ghosal_bayes_rule_infinite
...
`print(result)` render. See `moirais.fn.describe('gh_c1_1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c1_1 import *
import numpy as np
# See the function signature in fn/gh_c1_1.py for argument names.
```
