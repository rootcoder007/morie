...
`print(result)` render. See `moirais.fn.describe('kgikp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgikp import *
import numpy as np
# See the function signature in fn/kgikp.py for argument names.
```
