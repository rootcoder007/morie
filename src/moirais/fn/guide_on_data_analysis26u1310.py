...
__all__ = ["guide_on_data_analysis_chapter_26_unnumbered_1310"]


def guide_on_data_analysis_chapter_26_unnumbered_1310(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌𝑖(𝑍) = 𝑌𝑖(𝑍,Z−𝑖) ∀ Z−𝑖.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis26u1310')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis26u1310: GeneralStatistics expression (auto-extracted; see ref)."
