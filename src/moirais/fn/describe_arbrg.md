...
`print(result)` render. See `moirais.fn.describe('arbrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arbrg import *
import numpy as np
# See the function signature in fn/arbrg.py for argument names.
```
