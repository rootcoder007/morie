# describe('tft') — temporal_fusion_transformer
...
`print(result)` render. See `moirais.fn.describe('tft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tft import *
import numpy as np
# See the function signature in fn/tft.py for argument names.
```
