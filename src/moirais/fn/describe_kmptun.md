# describe('kmptun') — kamath_prompt_tuning
...
`print(result)` render. See `moirais.fn.describe('kmptun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmptun import *
import numpy as np
# See the function signature in fn/kmptun.py for argument names.
```
