# describe('wvthr') — wavelet_threshold
...
`print(result)` render. See `moirais.fn.describe('wvthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvthr import *
import numpy as np
# See the function signature in fn/wvthr.py for argument names.
```
