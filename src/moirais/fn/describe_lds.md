...
`print(result)` render. See `moirais.fn.describe('lds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lds import *
import numpy as np
# See the function signature in fn/lds.py for argument names.
```
