# describe('sgtspr') — sgt_spectral_radius_bound
...
`print(result)` render. See `moirais.fn.describe('sgtspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtspr import *
import numpy as np
# See the function signature in fn/sgtspr.py for argument names.
```
