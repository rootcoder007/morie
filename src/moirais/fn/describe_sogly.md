...
`print(result)` render. See `moirais.fn.describe('sogly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sogly import *
import numpy as np
# See the function signature in fn/sogly.py for argument names.
```
