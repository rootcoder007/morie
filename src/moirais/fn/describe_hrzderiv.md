# describe('hrzderiv') — horowitz_density_derivative
...
`print(result)` render. See `moirais.fn.describe('hrzderiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzderiv import *
import numpy as np
# See the function signature in fn/hrzderiv.py for argument names.
```
