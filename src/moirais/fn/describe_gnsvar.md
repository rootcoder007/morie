...
`print(result)` render. See `moirais.fn.describe('gnsvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsvar import *
import numpy as np
# See the function signature in fn/gnsvar.py for argument names.
```
