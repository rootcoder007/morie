...
`print(result)` render. See `moirais.fn.describe('tmlphd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlphd import *
import numpy as np
# See the function signature in fn/tmlphd.py for argument names.
```
