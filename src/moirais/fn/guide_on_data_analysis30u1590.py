...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1590"]


def guide_on_data_analysis_chapter_30_unnumbered_1590(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: df = base_stagg |>
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1590')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1590: GeneralStatistics expression (auto-extracted; see ref)."
