# describe('gb431') — gibbons_ks_dist_free
...
`print(result)` render. See `moirais.fn.describe('gb431')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb431 import *
import numpy as np
# See the function signature in fn/gb431.py for argument names.
```
