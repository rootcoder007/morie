# describe('spblk') — spatial_block_kriging
...
`print(result)` render. See `moirais.fn.describe('spblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spblk import *
import numpy as np
# See the function signature in fn/spblk.py for argument names.
```
