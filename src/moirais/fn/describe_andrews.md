...
`print(result)` render. See `moirais.fn.describe('andrews')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.andrews import *
import numpy as np
# See the function signature in fn/andrews.py for argument names.
```
