# describe('gscmcl') — generalized_synthetic_control
...
`print(result)` render. See `moirais.fn.describe('gscmcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gscmcl import *
import numpy as np
# See the function signature in fn/gscmcl.py for argument names.
```
