...
`print(result)` render. See `moirais.fn.describe('cwwsym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cwwsym import *
import numpy as np
# See the function signature in fn/cwwsym.py for argument names.
```
