# describe('rgspe') — rangayyan_specificity
...
`print(result)` render. See `moirais.fn.describe('rgspe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgspe import *
import numpy as np
# See the function signature in fn/rgspe.py for argument names.
```
