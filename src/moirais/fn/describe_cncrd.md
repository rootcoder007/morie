# describe('cncrd') — concordance_incomplete
...
`print(result)` render. See `moirais.fn.describe('cncrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cncrd import *
import numpy as np
# See the function signature in fn/cncrd.py for argument names.
```
