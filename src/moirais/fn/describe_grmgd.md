# describe('grmgd') — geron_minibatch_gradient_descent
...
`print(result)` render. See `moirais.fn.describe('grmgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmgd import *
import numpy as np
# See the function signature in fn/grmgd.py for argument names.
```
