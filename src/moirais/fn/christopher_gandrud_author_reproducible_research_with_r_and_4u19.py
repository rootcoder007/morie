...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_19(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: a border to the table, use: <table border="1">.15
