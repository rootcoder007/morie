...
`print(result)` render. See `moirais.fn.describe('rftrun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rftrun import *
import numpy as np
# See the function signature in fn/rftrun.py for argument names.
```
