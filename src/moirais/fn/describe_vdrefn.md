...
`print(result)` render. See `moirais.fn.describe('vdrefn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdrefn import *
import numpy as np
# See the function signature in fn/vdrefn.py for argument names.
```
