...
`print(result)` render. See `moirais.fn.describe('aitclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitclr import *
import numpy as np
# See the function signature in fn/aitclr.py for argument names.
```
