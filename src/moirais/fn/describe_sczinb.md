...
`print(result)` render. See `moirais.fn.describe('sczinb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sczinb import *
import numpy as np
# See the function signature in fn/sczinb.py for argument names.
```
