...
`print(result)` render. See `moirais.fn.describe('aftres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftres import *
import numpy as np
# See the function signature in fn/aftres.py for argument names.
```
