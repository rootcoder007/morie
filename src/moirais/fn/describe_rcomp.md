# describe('rcomp') — rademacher_complexity
...
`print(result)` render. See `moirais.fn.describe('rcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcomp import *
import numpy as np
# See the function signature in fn/rcomp.py for argument names.
```
