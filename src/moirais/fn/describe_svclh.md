# describe('svclh') — coalition_heart
...
`print(result)` render. See `moirais.fn.describe('svclh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclh import *
import numpy as np
# See the function signature in fn/svclh.py for argument names.
```
