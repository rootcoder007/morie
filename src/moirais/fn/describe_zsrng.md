# describe('zsrng') — random_nongauss
...
`print(result)` render. See `moirais.fn.describe('zsrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrng import *
import numpy as np
# See the function signature in fn/zsrng.py for argument names.
```
