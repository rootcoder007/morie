...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1486"]


def guide_on_data_analysis_chapter_30_unnumbered_1486(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -6 x cohort = 7 -0.04 (0.87)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1486')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1486: GeneralStatistics expression (auto-extracted; see ref)."
