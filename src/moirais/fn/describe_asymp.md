# describe('asymp') — asymptotic_expansion
...
`print(result)` render. See `moirais.fn.describe('asymp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.asymp import *
import numpy as np
# See the function signature in fn/asymp.py for argument names.
```
