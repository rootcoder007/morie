...
__all__ = ["hedderich_chapter_9_unnumbered_1477"]


def hedderich_chapter_9_unnumbered_1477(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: "perfectly not":xn =y1, xn−1 =y2,..., x1 =yn
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1477')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1477: GeneralStatistics expression (auto-extracted; see ref)."
