...
`print(result)` render. See `moirais.fn.describe('mtocyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtocyc import *
import numpy as np
# See the function signature in fn/mtocyc.py for argument names.
```
