# describe('ksr037') — kosorok_ch2_glivenko_cantelli_uniform
...
`print(result)` render. See `moirais.fn.describe('ksr037')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr037 import *
import numpy as np
# See the function signature in fn/ksr037.py for argument names.
```
