...
`print(result)` render. See `moirais.fn.describe('foinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foinv import *
import numpy as np
# See the function signature in fn/foinv.py for argument names.
```
