# describe('faithA') — faithfulness_assumption
...
`print(result)` render. See `moirais.fn.describe('faithA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.faithA import *
import numpy as np
# See the function signature in fn/faithA.py for argument names.
```
