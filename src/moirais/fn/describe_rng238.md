# describe('rng238') — rangayyan_ch4_complex_cepstra_sum
...
`print(result)` render. See `moirais.fn.describe('rng238')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng238 import *
import numpy as np
# See the function signature in fn/rng238.py for argument names.
```
