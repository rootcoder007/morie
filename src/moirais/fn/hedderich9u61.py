...
__all__ = ["hedderich_chapter_9_unnumbered_61"]


def hedderich_chapter_9_unnumbered_61(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: y =ab lgy = lga + lgb a/b̸=b/a lg(a/b) =−lg(b/a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u61')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u61: GeneralStatistics expression (auto-extracted; see ref)."
