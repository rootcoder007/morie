...
`print(result)` render. See `moirais.fn.describe('eckrt4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eckrt4 import *
import numpy as np
# See the function signature in fn/eckrt4.py for argument names.
```
