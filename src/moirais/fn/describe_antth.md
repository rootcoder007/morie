# describe('antth') — antithetic_variates
...
`print(result)` render. See `moirais.fn.describe('antth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.antth import *
import numpy as np
# See the function signature in fn/antth.py for argument names.
```
