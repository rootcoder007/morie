...
`print(result)` render. See `moirais.fn.describe('mdcyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdcyc import *
import numpy as np
# See the function signature in fn/mdcyc.py for argument names.
```
