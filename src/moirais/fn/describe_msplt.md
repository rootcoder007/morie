...
`print(result)` render. See `moirais.fn.describe('msplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msplt import *
import numpy as np
# See the function signature in fn/msplt.py for argument names.
```
