# describe('augla') — augmented_lagrangian
...
`print(result)` render. See `moirais.fn.describe('augla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.augla import *
import numpy as np
# See the function signature in fn/augla.py for argument names.
```
