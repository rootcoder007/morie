...
`print(result)` render. See `moirais.fn.describe('rstml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rstml import *
import numpy as np
# See the function signature in fn/rstml.py for argument names.
```
