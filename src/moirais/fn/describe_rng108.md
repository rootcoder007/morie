# describe('rng108') — rangayyan_ch3_ma_8point_recursive
...
`print(result)` render. See `moirais.fn.describe('rng108')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng108 import *
import numpy as np
# See the function signature in fn/rng108.py for argument names.
```
