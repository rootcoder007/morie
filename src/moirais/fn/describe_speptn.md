...
`print(result)` render. See `moirais.fn.describe('speptn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.speptn import *
import numpy as np
# See the function signature in fn/speptn.py for argument names.
```
