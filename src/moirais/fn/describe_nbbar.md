...
`print(result)` render. See `moirais.fn.describe('nbbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbbar import *
import numpy as np
# See the function signature in fn/nbbar.py for argument names.
```
