# describe('hrztiku') — horowitz_tikhonov_unknown_T
...
`print(result)` render. See `moirais.fn.describe('hrztiku')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztiku import *
import numpy as np
# See the function signature in fn/hrztiku.py for argument names.
```
