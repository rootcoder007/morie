# describe('kmtemp') — kamath_temperature_sampling
...
`print(result)` render. See `moirais.fn.describe('kmtemp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmtemp import *
import numpy as np
# See the function signature in fn/kmtemp.py for argument names.
```
