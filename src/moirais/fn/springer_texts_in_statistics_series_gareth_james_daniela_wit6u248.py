...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_248"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_248(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0 +β1X1 +β2X2 = 0 (9.1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u248')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u248: GeneralStatistics expression (auto-extracted; see ref)."
