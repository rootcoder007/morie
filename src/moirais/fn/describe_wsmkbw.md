# describe('wsmkbw') — wasserman_kde_bandwidth
...
`print(result)` render. See `moirais.fn.describe('wsmkbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmkbw import *
import numpy as np
# See the function signature in fn/wsmkbw.py for argument names.
```
