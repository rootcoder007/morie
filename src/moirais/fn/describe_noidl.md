# describe('noidl') — nominate_ideal_extract
...
`print(result)` render. See `moirais.fn.describe('noidl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.noidl import *
import numpy as np
# See the function signature in fn/noidl.py for argument names.
```
