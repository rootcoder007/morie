# describe('hbdon') — hbond_donor_count
...
`print(result)` render. See `moirais.fn.describe('hbdon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hbdon import *
import numpy as np
# See the function signature in fn/hbdon.py for argument names.
```
