...
__all__ = ["hedderich_chapter_9_unnumbered_2744"]


def hedderich_chapter_9_unnumbered_2744(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1 + 0.5(9−1) = 0.800
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2744')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2744: GeneralStatistics expression (auto-extracted; see ref)."
