# describe('eigcen') — eigenvector_centrality
...
`print(result)` render. See `moirais.fn.describe('eigcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigcen import *
import numpy as np
# See the function signature in fn/eigcen.py for argument names.
```
