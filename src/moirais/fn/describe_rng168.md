# describe('rng168') — rangayyan_ch3_rls_theta_recursion
...
`print(result)` render. See `moirais.fn.describe('rng168')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng168 import *
import numpy as np
# See the function signature in fn/rng168.py for argument names.
```
