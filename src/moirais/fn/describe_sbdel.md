...
`print(result)` render. See `moirais.fn.describe('sbdel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbdel import *
import numpy as np
# See the function signature in fn/sbdel.py for argument names.
```
