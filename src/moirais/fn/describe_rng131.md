# describe('rng131') — rangayyan_ch3_butterworth_digital_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng131')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng131 import *
import numpy as np
# See the function signature in fn/rng131.py for argument names.
```
