# describe('rng173') — rangayyan_ch3_rls_gain_identity
...
`print(result)` render. See `moirais.fn.describe('rng173')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng173 import *
import numpy as np
# See the function signature in fn/rng173.py for argument names.
```
