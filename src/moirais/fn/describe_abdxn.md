...
`print(result)` render. See `moirais.fn.describe('abdxn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abdxn import *
import numpy as np
# See the function signature in fn/abdxn.py for argument names.
```
