...
`print(result)` render. See `moirais.fn.describe('mtmsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtmsd import *
import numpy as np
# See the function signature in fn/mtmsd.py for argument names.
```
