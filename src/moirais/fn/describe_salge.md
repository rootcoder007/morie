...
`print(result)` render. See `moirais.fn.describe('salge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.salge import *
import numpy as np
# See the function signature in fn/salge.py for argument names.
```
