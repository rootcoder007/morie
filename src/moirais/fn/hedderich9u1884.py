...
__all__ = ["hedderich_chapter_9_unnumbered_1884"]


def hedderich_chapter_9_unnumbered_1884(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = [|15−(20 + 1)|]/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1884')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1884: GeneralStatistics expression (auto-extracted; see ref)."
