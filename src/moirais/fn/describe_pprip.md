...
`print(result)` render. See `moirais.fn.describe('pprip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pprip import *
import numpy as np
# See the function signature in fn/pprip.py for argument names.
```
