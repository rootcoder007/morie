# describe('ppbnd') — plasma_protein_binding
...
`print(result)` render. See `moirais.fn.describe('ppbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppbnd import *
import numpy as np
# See the function signature in fn/ppbnd.py for argument names.
```
