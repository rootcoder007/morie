...
`print(result)` render. See `moirais.fn.describe('zelrx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zelrx import *
import numpy as np
# See the function signature in fn/zelrx.py for argument names.
```
