...
__all__ = ["hedderich_chapter_9_unnumbered_2700"]


def hedderich_chapter_9_unnumbered_2700(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ω·P2 + (1−P2) = 2·0.3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2700')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2700: PowerAndDesign expression (auto-extracted; see ref)."
