...
`print(result)` render. See `moirais.fn.describe('md2dp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.md2dp import *
import numpy as np
# See the function signature in fn/md2dp.py for argument names.
```
