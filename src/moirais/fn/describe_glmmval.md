...
`print(result)` render. See `moirais.fn.describe('glmmval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmval import *
import numpy as np
# See the function signature in fn/glmmval.py for argument names.
```
