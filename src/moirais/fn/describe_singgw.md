# describe('singgw') — single_step_gblup
...
`print(result)` render. See `moirais.fn.describe('singgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.singgw import *
import numpy as np
# See the function signature in fn/singgw.py for argument names.
```
