# describe('poissp') — poisson_spatial_glm
...
`print(result)` render. See `moirais.fn.describe('poissp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poissp import *
import numpy as np
# See the function signature in fn/poissp.py for argument names.
```
