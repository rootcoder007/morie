# describe('jodrrc') — joseph_dirrec_strategy
...
`print(result)` render. See `moirais.fn.describe('jodrrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jodrrc import *
import numpy as np
# See the function signature in fn/jodrrc.py for argument names.
```
