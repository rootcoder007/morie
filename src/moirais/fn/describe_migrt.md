# describe('migrt') — net_migration_rate
...
`print(result)` render. See `moirais.fn.describe('migrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.migrt import *
import numpy as np
# See the function signature in fn/migrt.py for argument names.
```
