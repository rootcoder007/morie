...
`print(result)` render. See `moirais.fn.describe('odm_y')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_y import *
import numpy as np
# See the function signature in fn/odm_y.py for argument names.
```
