...
`print(result)` render. See `moirais.fn.describe('amuse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amuse import *
import numpy as np
# See the function signature in fn/amuse.py for argument names.
```
