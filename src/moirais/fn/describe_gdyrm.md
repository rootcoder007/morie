...
`print(result)` render. See `moirais.fn.describe('gdyrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdyrm import *
import numpy as np
# See the function signature in fn/gdyrm.py for argument names.
```
