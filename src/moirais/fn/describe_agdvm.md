...
`print(result)` render. See `moirais.fn.describe('agdvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdvm import *
import numpy as np
# See the function signature in fn/agdvm.py for argument names.
```
