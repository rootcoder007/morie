# describe('rgcpr') — rangayyan_cpr_analysis
...
`print(result)` render. See `moirais.fn.describe('rgcpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcpr import *
import numpy as np
# See the function signature in fn/rgcpr.py for argument names.
```
