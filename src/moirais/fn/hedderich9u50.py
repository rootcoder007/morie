...
__all__ = ["hedderich_chapter_9_unnumbered_50"]


def hedderich_chapter_9_unnumbered_50(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n√a = m·n√a;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u50')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u50: PowerAndDesign expression (auto-extracted; see ref)."
