...
`print(result)` render. See `moirais.fn.describe('rsalb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsalb import *
import numpy as np
# See the function signature in fn/rsalb.py for argument names.
```
