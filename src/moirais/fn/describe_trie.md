...
`print(result)` render. See `moirais.fn.describe('trie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trie import *
import numpy as np
# See the function signature in fn/trie.py for argument names.
```
