# describe('mafnpr') — ma_funnel_plot_data
...
`print(result)` render. See `moirais.fn.describe('mafnpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafnpr import *
import numpy as np
# See the function signature in fn/mafnpr.py for argument names.
```
