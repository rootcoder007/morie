...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_470"]


def guide_on_data_analysis_chapter_6_unnumbered_470(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] • y𝑗 = ∇𝑄(̂𝜃(𝑗+1)) − ∇𝑄(̂𝜃(𝑗))(change in gradient).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u470')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u470: GeneralStatistics expression (auto-extracted; see ref)."
