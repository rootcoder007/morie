...
__all__ = ["hedderich_chapter_9_unnumbered_2813"]


def hedderich_chapter_9_unnumbered_2813(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : ωM H = 1 against ωM H̸= 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2813')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2813: GeneralStatistics expression (auto-extracted; see ref)."
