...
`print(result)` render. See `moirais.fn.describe('lmmf1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmmf1 import *
import numpy as np
# See the function signature in fn/lmmf1.py for argument names.
```
