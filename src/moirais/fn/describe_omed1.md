...
`print(result)` render. See `moirais.fn.describe('omed1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omed1 import *
import numpy as np
# See the function signature in fn/omed1.py for argument names.
```
