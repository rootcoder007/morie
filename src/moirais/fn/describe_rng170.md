# describe('rng170') — rangayyan_ch3_rls_inverse_recursion
...
`print(result)` render. See `moirais.fn.describe('rng170')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng170 import *
import numpy as np
# See the function signature in fn/rng170.py for argument names.
```
