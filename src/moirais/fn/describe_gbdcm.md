...
`print(result)` render. See `moirais.fn.describe('gbdcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbdcm import *
import numpy as np
# See the function signature in fn/gbdcm.py for argument names.
```
