...
`print(result)` render. See `moirais.fn.describe('prphet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prphet import *
import numpy as np
# See the function signature in fn/prphet.py for argument names.
```
