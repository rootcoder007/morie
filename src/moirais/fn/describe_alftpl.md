# describe('alftpl') — alphafold_template_embed
...
`print(result)` render. See `moirais.fn.describe('alftpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alftpl import *
import numpy as np
# See the function signature in fn/alftpl.py for argument names.
```
