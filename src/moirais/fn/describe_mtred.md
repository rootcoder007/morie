...
`print(result)` render. See `moirais.fn.describe('mtred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtred import *
import numpy as np
# See the function signature in fn/mtred.py for argument names.
```
