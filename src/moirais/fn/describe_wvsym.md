...
`print(result)` render. See `moirais.fn.describe('wvsym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvsym import *
import numpy as np
# See the function signature in fn/wvsym.py for argument names.
```
