# describe('rcdhz') — recidivism_hazard
...
`print(result)` render. See `moirais.fn.describe('rcdhz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdhz import *
import numpy as np
# See the function signature in fn/rcdhz.py for argument names.
```
