# describe('grsmxp') — geron_softmax_probability
...
`print(result)` render. See `moirais.fn.describe('grsmxp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsmxp import *
import numpy as np
# See the function signature in fn/grsmxp.py for argument names.
```
