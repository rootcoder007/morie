...
`print(result)` render. See `moirais.fn.describe('trprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trprd import *
import numpy as np
# See the function signature in fn/trprd.py for argument names.
```
