# describe('rgmemb') — rangayyan_membrane_potential
...
`print(result)` render. See `moirais.fn.describe('rgmemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmemb import *
import numpy as np
# See the function signature in fn/rgmemb.py for argument names.
```
