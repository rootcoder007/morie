...
`print(result)` render. See `moirais.fn.describe('hyfac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyfac import *
import numpy as np
# See the function signature in fn/hyfac.py for argument names.
```
