# describe('elflt') — elliptic_filter
...
`print(result)` render. See `moirais.fn.describe('elflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elflt import *
import numpy as np
# See the function signature in fn/elflt.py for argument names.
```
