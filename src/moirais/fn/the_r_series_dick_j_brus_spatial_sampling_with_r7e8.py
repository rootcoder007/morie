...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_7_equation_8(x):
    """
    Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r7e8')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r7e8: Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R."
