...
`print(result)` render. See `moirais.fn.describe('varfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varfp import *
import numpy as np
# See the function signature in fn/varfp.py for argument names.
```
