...
`print(result)` render. See `moirais.fn.describe('eproc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eproc import *
import numpy as np
# See the function signature in fn/eproc.py for argument names.
```
