...
__all__ = ["wilcox_chapter_14_unnumbered_649"]


def wilcox_chapter_14_unnumbered_649(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rmrvar(x,y=NA,alpha=0.05, con=0, est=pbvar, hoch=TRUE, plotit=FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u649')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u649: GeneralStatistics expression (auto-extracted; see ref)."
