...
__all__ = ["hedderich_chapter_9_unnumbered_2583"]


def hedderich_chapter_9_unnumbered_2583(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Null hypothesis: π1 = π. The alternative hypothesis is: π1̸= π(or in the case of a one-sided
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2583')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2583: GeneralStatistics expression (auto-extracted; see ref)."
