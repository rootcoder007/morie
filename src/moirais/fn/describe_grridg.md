# describe('grridg') — geron_ridge_cost
...
`print(result)` render. See `moirais.fn.describe('grridg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grridg import *
import numpy as np
# See the function signature in fn/grridg.py for argument names.
```
