# describe('irthx') — irt_heteroskedastic
...
`print(result)` render. See `moirais.fn.describe('irthx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irthx import *
import numpy as np
# See the function signature in fn/irthx.py for argument names.
```
