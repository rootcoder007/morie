...
`print(result)` render. See `moirais.fn.describe('r_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r_es import *
import numpy as np
# See the function signature in fn/r_es.py for argument names.
```
