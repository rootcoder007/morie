...
__all__ = ["hedderich_chapter_9_unnumbered_1600"]


def hedderich_chapter_9_unnumbered_1600(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (2) n(p=0.001|r, P )≈10·n(p=0.01|r, P )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1600')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1600: GeneralStatistics expression (auto-extracted; see ref)."
