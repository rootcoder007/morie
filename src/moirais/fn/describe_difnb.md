...
`print(result)` render. See `moirais.fn.describe('difnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difnb import *
import numpy as np
# See the function signature in fn/difnb.py for argument names.
```
