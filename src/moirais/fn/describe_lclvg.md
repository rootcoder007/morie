...
`print(result)` render. See `moirais.fn.describe('lclvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lclvg import *
import numpy as np
# See the function signature in fn/lclvg.py for argument names.
```
