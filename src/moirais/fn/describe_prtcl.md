# describe('prtcl') — particle_filter
...
`print(result)` render. See `moirais.fn.describe('prtcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prtcl import *
import numpy as np
# See the function signature in fn/prtcl.py for argument names.
```
