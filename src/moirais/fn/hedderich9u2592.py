...
__all__ = ["hedderich_chapter_9_unnumbered_2592"]


def hedderich_chapter_9_unnumbered_2592(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: a significantly smaller P value (in the example for n1 = n2 = 300 : 18%−10% = 8% with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2592')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2592: GeneralStatistics expression (auto-extracted; see ref)."
