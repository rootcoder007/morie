...
`print(result)` render. See `moirais.fn.describe('dtgev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtgev import *
import numpy as np
# See the function signature in fn/dtgev.py for argument names.
```
