...
`print(result)` render. See `moirais.fn.describe('ksgnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksgnr import *
import numpy as np
# See the function signature in fn/ksgnr.py for argument names.
```
