...
__all__ = ["hedderich_chapter_9_unnumbered_2096"]


def hedderich_chapter_9_unnumbered_2096(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t = 2 . 7 9 8 , df = 7 , p− value = 0 . 0 2 6 6
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2096')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2096: GeneralStatistics expression (auto-extracted; see ref)."
