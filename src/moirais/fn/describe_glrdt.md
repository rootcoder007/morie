...
`print(result)` render. See `moirais.fn.describe('glrdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glrdt import *
import numpy as np
# See the function signature in fn/glrdt.py for argument names.
```
