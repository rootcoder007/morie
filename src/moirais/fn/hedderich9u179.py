...
__all__ = ["hedderich_chapter_9_unnumbered_179"]


def hedderich_chapter_9_unnumbered_179(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + r . t a u _b = ( prov − i n v ) / sqrt( ( prov + i n v + Tx ) * ( prov + i n v + Ty ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u179')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u179: GeneralStatistics expression (auto-extracted; see ref)."
