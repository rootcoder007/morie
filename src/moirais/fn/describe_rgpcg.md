# describe('rgpcg') — rangayyan_pcg_segments
...
`print(result)` render. See `moirais.fn.describe('rgpcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcg import *
import numpy as np
# See the function signature in fn/rgpcg.py for argument names.
```
