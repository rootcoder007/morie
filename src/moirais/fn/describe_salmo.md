...
`print(result)` render. See `moirais.fn.describe('salmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.salmo import *
import numpy as np
# See the function signature in fn/salmo.py for argument names.
```
