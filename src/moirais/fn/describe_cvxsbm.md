# describe('cvxsbm') — boyd_subgrad_method
...
`print(result)` render. See `moirais.fn.describe('cvxsbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsbm import *
import numpy as np
# See the function signature in fn/cvxsbm.py for argument names.
```
