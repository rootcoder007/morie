# describe('grtmp') — geron_temperature_sampling
...
`print(result)` render. See `moirais.fn.describe('grtmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtmp import *
import numpy as np
# See the function signature in fn/grtmp.py for argument names.
```
