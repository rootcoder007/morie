...
`print(result)` render. See `moirais.fn.describe('eslgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslgam import *
import numpy as np
# See the function signature in fn/eslgam.py for argument names.
```
