...
__all__ = ["hedderich_chapter_9_unnumbered_78"]


def hedderich_chapter_9_unnumbered_78(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > B <− matrix ( c ( 4 , 5 , 6 , 9 , 8 , 7 ) , nrow =3 , n c o l=2 , byrow=TRUE ) ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u78')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u78: GeneralStatistics expression (auto-extracted; see ref)."
