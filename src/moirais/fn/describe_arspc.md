...
`print(result)` render. See `moirais.fn.describe('arspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arspc import *
import numpy as np
# See the function signature in fn/arspc.py for argument names.
```
