# describe('sgdjk') — disjunctive_kriging
...
`print(result)` render. See `moirais.fn.describe('sgdjk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdjk import *
import numpy as np
# See the function signature in fn/sgdjk.py for argument names.
```
