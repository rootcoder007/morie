# describe('gb35rvn') — gibbons_rvn_test
...
`print(result)` render. See `moirais.fn.describe('gb35rvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb35rvn import *
import numpy as np
# See the function signature in fn/gb35rvn.py for argument names.
```
