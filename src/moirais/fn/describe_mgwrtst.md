...
`print(result)` render. See `moirais.fn.describe('mgwrtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrtst import *
import numpy as np
# See the function signature in fn/mgwrtst.py for argument names.
```
