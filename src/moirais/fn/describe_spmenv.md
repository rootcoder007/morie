# describe('spmenv') — schabenberger_moran_expectation
...
`print(result)` render. See `moirais.fn.describe('spmenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmenv import *
import numpy as np
# See the function signature in fn/spmenv.py for argument names.
```
