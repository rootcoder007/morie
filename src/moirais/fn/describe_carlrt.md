...
`print(result)` render. See `moirais.fn.describe('carlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carlrt import *
import numpy as np
# See the function signature in fn/carlrt.py for argument names.
```
