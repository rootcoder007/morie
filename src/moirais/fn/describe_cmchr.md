...
`print(result)` render. See `moirais.fn.describe('cmchr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmchr import *
import numpy as np
# See the function signature in fn/cmchr.py for argument names.
```
