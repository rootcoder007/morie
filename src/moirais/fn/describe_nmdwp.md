# describe('nmdwp') — dwnominate_polar
...
`print(result)` render. See `moirais.fn.describe('nmdwp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdwp import *
import numpy as np
# See the function signature in fn/nmdwp.py for argument names.
```
