# describe('msm194') — mvsml_ridge_lasso_elastic_eq_9_22
...
`print(result)` render. See `moirais.fn.describe('msm194')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm194 import *
import numpy as np
# See the function signature in fn/msm194.py for argument names.
```
