# describe('rng127') — rangayyan_ch3_bilinear_transformation
...
`print(result)` render. See `moirais.fn.describe('rng127')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng127 import *
import numpy as np
# See the function signature in fn/rng127.py for argument names.
```
