...
`print(result)` render. See `moirais.fn.describe('smsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smsim import *
import numpy as np
# See the function signature in fn/smsim.py for argument names.
```
