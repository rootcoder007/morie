...
__all__ = ["hedderich_chapter_9_unnumbered_736"]


def hedderich_chapter_9_unnumbered_736(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: Examples 1. For P (X≤3|9) with ˆz =|(3−9)|/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u736')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u736: CountModels expression (auto-extracted; see ref)."
