# describe('getis') — getis_ord_gi_star
...
`print(result)` render. See `moirais.fn.describe('getis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getis import *
import numpy as np
# See the function signature in fn/getis.py for argument names.
```
