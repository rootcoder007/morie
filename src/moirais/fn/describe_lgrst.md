...
`print(result)` render. See `moirais.fn.describe('lgrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgrst import *
import numpy as np
# See the function signature in fn/lgrst.py for argument names.
```
