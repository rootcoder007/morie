...
__all__ = ["hedderich_chapter_9_unnumbered_3439"]


def hedderich_chapter_9_unnumbered_3439(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] πij =P (X∩Y ) = P (X =xi∩Y =yj)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3439')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3439: ContingencyTables expression (auto-extracted; see ref)."
