...
`print(result)` render. See `moirais.fn.describe('tssmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssmf import *
import numpy as np
# See the function signature in fn/tssmf.py for argument names.
```
