...
`print(result)` render. See `moirais.fn.describe('thd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thd import *
import numpy as np
# See the function signature in fn/thd.py for argument names.
```
