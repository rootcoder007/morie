...
`print(result)` render. See `moirais.fn.describe('mtsBnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtsBnd import *
import numpy as np
# See the function signature in fn/mtsBnd.py for argument names.
```
