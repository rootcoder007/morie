...
`print(result)` render. See `moirais.fn.describe('specn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specn import *
import numpy as np
# See the function signature in fn/specn.py for argument names.
```
