# describe('fdcrt') — frontdoor_criterion
...
`print(result)` render. See `moirais.fn.describe('fdcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdcrt import *
import numpy as np
# See the function signature in fn/fdcrt.py for argument names.
```
