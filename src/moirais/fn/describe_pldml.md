...
`print(result)` render. See `moirais.fn.describe('pldml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pldml import *
import numpy as np
# See the function signature in fn/pldml.py for argument names.
```
