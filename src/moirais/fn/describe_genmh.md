...
`print(result)` render. See `moirais.fn.describe('genmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genmh import *
import numpy as np
# See the function signature in fn/genmh.py for argument names.
```
