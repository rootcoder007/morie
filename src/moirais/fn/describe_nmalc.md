...
`print(result)` render. See `moirais.fn.describe('nmalc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmalc import *
import numpy as np
# See the function signature in fn/nmalc.py for argument names.
```
