...
`print(result)` render. See `moirais.fn.describe('tmlqct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlqct import *
import numpy as np
# See the function signature in fn/tmlqct.py for argument names.
```
