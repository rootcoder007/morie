...
`print(result)` render. See `moirais.fn.describe('vmsrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmsrf import *
import numpy as np
# See the function signature in fn/vmsrf.py for argument names.
```
