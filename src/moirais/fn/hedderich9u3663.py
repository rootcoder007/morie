...
__all__ = ["hedderich_chapter_9_unnumbered_3663"]


def hedderich_chapter_9_unnumbered_3663(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: π1−π2 (McNemar) . . . . . . . . . . . . .711
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3663')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3663: GeneralStatistics expression (auto-extracted; see ref)."
