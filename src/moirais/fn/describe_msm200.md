# describe('msm200') — mvsml_ridge_lasso_elastic_eq_9_8
...
`print(result)` render. See `moirais.fn.describe('msm200')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm200 import *
import numpy as np
# See the function signature in fn/msm200.py for argument names.
```
