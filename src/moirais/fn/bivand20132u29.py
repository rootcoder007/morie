...
__all__ = ["bivand2013_chapter_2_unnumbered_29"]


def bivand2013_chapter_2_unnumbered_29(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +ellps=intl +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u29')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u29: GeneralStatistics expression (auto-extracted; see ref)."
