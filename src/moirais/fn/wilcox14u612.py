...
__all__ = ["wilcox_chapter_14_unnumbered_612"]


def wilcox_chapter_14_unnumbered_612(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] bi2KMS(r1=sum(elimna(x)), n1=length(elimna(x)), r2=sum(elimna(y)),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u612')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u612: GeneralStatistics expression (auto-extracted; see ref)."
