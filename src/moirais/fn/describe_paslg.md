...
`print(result)` render. See `moirais.fn.describe('paslg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paslg import *
import numpy as np
# See the function signature in fn/paslg.py for argument names.
```
