...
`print(result)` render. See `moirais.fn.describe('ubcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcls import *
import numpy as np
# See the function signature in fn/ubcls.py for argument names.
```
