# describe('gh_wn_rate_opt') — ghosal_white_noise_optimal_rate
...
`print(result)` render. See `moirais.fn.describe('gh_wn_rate_opt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_wn_rate_opt import *
import numpy as np
# See the function signature in fn/gh_wn_rate_opt.py for argument names.
```
