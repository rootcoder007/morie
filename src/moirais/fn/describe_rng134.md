# describe('rng134') — rangayyan_ch3_butterworth_lowpass_dft_indexed
...
`print(result)` render. See `moirais.fn.describe('rng134')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng134 import *
import numpy as np
# See the function signature in fn/rng134.py for argument names.
```
