# describe('wsmpst1') — wasserman_posterior_mean
...
`print(result)` render. See `moirais.fn.describe('wsmpst1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmpst1 import *
import numpy as np
# See the function signature in fn/wsmpst1.py for argument names.
```
