# describe('midegf') — mi_degrees_of_freedom
...
`print(result)` render. See `moirais.fn.describe('midegf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.midegf import *
import numpy as np
# See the function signature in fn/midegf.py for argument names.
```
