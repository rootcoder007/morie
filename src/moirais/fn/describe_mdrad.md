...
`print(result)` render. See `moirais.fn.describe('mdrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdrad import *
import numpy as np
# See the function signature in fn/mdrad.py for argument names.
```
