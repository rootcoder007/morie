# describe('percn') — perceptron_activation
...
`print(result)` render. See `moirais.fn.describe('percn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.percn import *
import numpy as np
# See the function signature in fn/percn.py for argument names.
```
