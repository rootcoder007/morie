# describe('intlpa') — interior_point_lp
...
`print(result)` render. See `moirais.fn.describe('intlpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intlpa import *
import numpy as np
# See the function signature in fn/intlpa.py for argument names.
```
