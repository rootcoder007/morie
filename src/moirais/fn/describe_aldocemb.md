# describe('aldocemb') — alammar_document_embedding_pool
...
`print(result)` render. See `moirais.fn.describe('aldocemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aldocemb import *
import numpy as np
# See the function signature in fn/aldocemb.py for argument names.
```
