...
__all__ = ["hedderich_chapter_9_unnumbered_251"]


def hedderich_chapter_9_unnumbered_251(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1 = [(11−36)2 +...+ (63−36)2]/(4−1) = 494.67
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u251')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u251: GeneralStatistics expression (auto-extracted; see ref)."
