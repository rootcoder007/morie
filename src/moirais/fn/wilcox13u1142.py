...
__all__ = ["wilcox_chapter_13_unnumbered_1142"]


def wilcox_chapter_13_unnumbered_1142(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: nmin=12, outfun=out, LP=TRUE, LPCI=FALSE, MID=TRUE, alpha=0.05, pch=".",...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1142')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1142: GeneralStatistics expression (auto-extracted; see ref)."
