...
`print(result)` render. See `moirais.fn.describe('mafshz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafshz import *
import numpy as np
# See the function signature in fn/mafshz.py for argument names.
```
