# describe('otunbal') — ot_unbalanced
...
`print(result)` render. See `moirais.fn.describe('otunbal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otunbal import *
import numpy as np
# See the function signature in fn/otunbal.py for argument names.
```
