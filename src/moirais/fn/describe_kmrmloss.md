# describe('kmrmloss') — kamath_reward_model_training_loss
...
`print(result)` render. See `moirais.fn.describe('kmrmloss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrmloss import *
import numpy as np
# See the function signature in fn/kmrmloss.py for argument names.
```
