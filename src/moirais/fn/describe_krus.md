...
`print(result)` render. See `moirais.fn.describe('krus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krus import *
import numpy as np
# See the function signature in fn/krus.py for argument names.
```
