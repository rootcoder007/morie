...
`print(result)` render. See `moirais.fn.describe('eno3s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eno3s import *
import numpy as np
# See the function signature in fn/eno3s.py for argument names.
```
