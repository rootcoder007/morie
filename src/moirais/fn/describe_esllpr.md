# describe('esllpr') — esl_local_linear
...
`print(result)` render. See `moirais.fn.describe('esllpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllpr import *
import numpy as np
# See the function signature in fn/esllpr.py for argument names.
```
