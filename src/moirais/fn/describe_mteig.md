...
`print(result)` render. See `moirais.fn.describe('mteig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mteig import *
import numpy as np
# See the function signature in fn/mteig.py for argument names.
```
