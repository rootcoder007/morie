...
`print(result)` render. See `moirais.fn.describe('grang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grang import *
import numpy as np
# See the function signature in fn/grang.py for argument names.
```
