...
__all__ = ["wilcox_chapter_13_unnumbered_1129"]


def wilcox_chapter_13_unnumbered_1129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lplot(x,y,scale=TRUE,xlab="FAT",ylab="FIBER",zlab="PLASMA RETINOL")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1129')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1129: GeneralStatistics expression (auto-extracted; see ref)."
