...
`print(result)` render. See `moirais.fn.describe('weisz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weisz import *
import numpy as np
# See the function signature in fn/weisz.py for argument names.
```
