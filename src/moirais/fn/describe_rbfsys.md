...
`print(result)` render. See `moirais.fn.describe('rbfsys')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfsys import *
import numpy as np
# See the function signature in fn/rbfsys.py for argument names.
```
