# describe('hmprc') — geron_precision_recall_curve
...
`print(result)` render. See `moirais.fn.describe('hmprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmprc import *
import numpy as np
# See the function signature in fn/hmprc.py for argument names.
```
