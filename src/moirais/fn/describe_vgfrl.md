...
`print(result)` render. See `moirais.fn.describe('vgfrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgfrl import *
import numpy as np
# See the function signature in fn/vgfrl.py for argument names.
```
