...
__all__ = ["hedderich_chapter_9_unnumbered_2776"]


def hedderich_chapter_9_unnumbered_2776(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n = (z1−α +z1−β)2[π1(1−π1) +π2(1−π2)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2776')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2776: PowerAndDesign expression (auto-extracted; see ref)."
