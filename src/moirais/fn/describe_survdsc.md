# describe('survdsc') — discrete_time_survival
...
`print(result)` render. See `moirais.fn.describe('survdsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survdsc import *
import numpy as np
# See the function signature in fn/survdsc.py for argument names.
```
