# describe('hmdctr') — geron_decoder_only
...
`print(result)` render. See `moirais.fn.describe('hmdctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdctr import *
import numpy as np
# See the function signature in fn/hmdctr.py for argument names.
```
