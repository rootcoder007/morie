...
`print(result)` render. See `moirais.fn.describe('agawd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agawd import *
import numpy as np
# See the function signature in fn/agawd.py for argument names.
```
