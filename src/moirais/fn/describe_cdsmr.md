# describe('cdsmr') — standardized_mortality_ratio
...
`print(result)` render. See `moirais.fn.describe('cdsmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdsmr import *
import numpy as np
# See the function signature in fn/cdsmr.py for argument names.
```
