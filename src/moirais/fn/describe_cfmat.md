...
`print(result)` render. See `moirais.fn.describe('cfmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfmat import *
import numpy as np
# See the function signature in fn/cfmat.py for argument names.
```
