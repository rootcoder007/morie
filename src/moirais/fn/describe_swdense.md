...
`print(result)` render. See `moirais.fn.describe('swdense')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swdense import *
import numpy as np
# See the function signature in fn/swdense.py for argument names.
```
