# describe('rfwht') — rfwht

## WHAT IT DOES

White noise random field baseline.
...
`print(result)` render. See `moirais.fn.describe('rfwht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfwht import *
import numpy as np
# See the function signature in fn/rfwht.py for argument names.
```
