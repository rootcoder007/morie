# describe('dpunit') — dp_unit_definition
...
`print(result)` render. See `moirais.fn.describe('dpunit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpunit import *
import numpy as np
# See the function signature in fn/dpunit.py for argument names.
```
