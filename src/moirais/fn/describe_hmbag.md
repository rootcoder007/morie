...
`print(result)` render. See `moirais.fn.describe('hmbag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbag import *
import numpy as np
# See the function signature in fn/hmbag.py for argument names.
```
