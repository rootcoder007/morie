...
`print(result)` render. See `moirais.fn.describe('mouse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mouse import *
import numpy as np
# See the function signature in fn/mouse.py for argument names.
```
