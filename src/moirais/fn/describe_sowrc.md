...
`print(result)` render. See `moirais.fn.describe('sowrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sowrc import *
import numpy as np
# See the function signature in fn/sowrc.py for argument names.
```
