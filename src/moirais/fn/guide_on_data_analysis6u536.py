...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_536"]


def guide_on_data_analysis_chapter_6_unnumbered_536(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸(𝑌𝑖𝑗) = (𝛽0𝑗 + 𝛽1𝑗𝑁𝑖𝑗)𝐼𝑁𝑖𝑗 ≤𝛼𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u536')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u536: GeneralStatistics expression (auto-extracted; see ref)."
