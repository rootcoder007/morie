...
`print(result)` render. See `moirais.fn.describe('dtmvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmvn import *
import numpy as np
# See the function signature in fn/dtmvn.py for argument names.
```
