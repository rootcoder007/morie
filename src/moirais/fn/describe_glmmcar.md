...
`print(result)` render. See `moirais.fn.describe('glmmcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmcar import *
import numpy as np
# See the function signature in fn/glmmcar.py for argument names.
```
