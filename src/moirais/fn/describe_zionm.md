# describe('zionm') — defense_allocation
...
`print(result)` render. See `moirais.fn.describe('zionm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zionm import *
import numpy as np
# See the function signature in fn/zionm.py for argument names.
```
