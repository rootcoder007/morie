...
`print(result)` render. See `moirais.fn.describe('xsrsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xsrsk import *
import numpy as np
# See the function signature in fn/xsrsk.py for argument names.
```
