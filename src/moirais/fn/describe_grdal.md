# describe('grdal') — geron_dalle_autoregressive_token
...
`print(result)` render. See `moirais.fn.describe('grdal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdal import *
import numpy as np
# See the function signature in fn/grdal.py for argument names.
```
