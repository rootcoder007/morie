# describe('msm174') — mvsml_ridge_lasso_elastic_eq_9_5
...
`print(result)` render. See `moirais.fn.describe('msm174')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm174 import *
import numpy as np
# See the function signature in fn/msm174.py for argument names.
```
