# describe('spric') — species_richness
...
`print(result)` render. See `moirais.fn.describe('spric')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spric import *
import numpy as np
# See the function signature in fn/spric.py for argument names.
```
