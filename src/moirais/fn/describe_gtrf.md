# describe('gtrf') — graph_transformer
...
`print(result)` render. See `moirais.fn.describe('gtrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gtrf import *
import numpy as np
# See the function signature in fn/gtrf.py for argument names.
```
