...
`print(result)` render. See `moirais.fn.describe('zehtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zehtm import *
import numpy as np
# See the function signature in fn/zehtm.py for argument names.
```
