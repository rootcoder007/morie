...
`print(result)` render. See `moirais.fn.describe('affrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.affrt import *
import numpy as np
# See the function signature in fn/affrt.py for argument names.
```
