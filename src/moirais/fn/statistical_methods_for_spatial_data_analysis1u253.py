...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_253"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_253(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u253')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u253: GeneralStatistics expression (auto-extracted; see ref)."
