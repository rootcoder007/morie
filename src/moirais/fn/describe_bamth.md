# describe('bamth') — bayesian_thinning
...
`print(result)` render. See `moirais.fn.describe('bamth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bamth import *
import numpy as np
# See the function signature in fn/bamth.py for argument names.
```
