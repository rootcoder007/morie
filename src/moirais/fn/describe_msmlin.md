...
`print(result)` render. See `moirais.fn.describe('msmlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmlin import *
import numpy as np
# See the function signature in fn/msmlin.py for argument names.
```
