...
`print(result)` render. See `moirais.fn.describe('sglfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglfn import *
import numpy as np
# See the function signature in fn/sglfn.py for argument names.
```
