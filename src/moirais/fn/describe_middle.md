...
`print(result)` render. See `moirais.fn.describe('middle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.middle import *
import numpy as np
# See the function signature in fn/middle.py for argument names.
```
