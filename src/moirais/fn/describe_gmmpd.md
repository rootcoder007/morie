...
`print(result)` render. See `moirais.fn.describe('gmmpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmmpd import *
import numpy as np
# See the function signature in fn/gmmpd.py for argument names.
```
