# describe('pmantl') — partial_mantel_test
...
`print(result)` render. See `moirais.fn.describe('pmantl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmantl import *
import numpy as np
# See the function signature in fn/pmantl.py for argument names.
```
