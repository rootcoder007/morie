...
`print(result)` render. See `moirais.fn.describe('difsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difsp import *
import numpy as np
# See the function signature in fn/difsp.py for argument names.
```
