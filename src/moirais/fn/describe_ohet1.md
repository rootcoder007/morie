# describe('ohet1') — otis_het_region
...
`print(result)` render. See `moirais.fn.describe('ohet1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ohet1 import *
import numpy as np
# See the function signature in fn/ohet1.py for argument names.
```
