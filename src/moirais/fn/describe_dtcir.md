...
`print(result)` render. See `moirais.fn.describe('dtcir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcir import *
import numpy as np
# See the function signature in fn/dtcir.py for argument names.
```
