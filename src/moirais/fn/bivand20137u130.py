...
__all__ = ["bivand2013_chapter_7_unnumbered_130"]


def bivand2013_chapter_7_unnumbered_130(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + weights = weights, sigma = bwasthma, nsim = 99, nrank = 2,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u130')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u130: GeneralStatistics expression (auto-extracted; see ref)."
