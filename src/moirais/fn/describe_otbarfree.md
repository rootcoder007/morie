# describe('otbarfree') — ot_barycenter_free
...
`print(result)` render. See `moirais.fn.describe('otbarfree')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otbarfree import *
import numpy as np
# See the function signature in fn/otbarfree.py for argument names.
```
