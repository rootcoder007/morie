# describe('paligi') — parametric_alibi
...
`print(result)` render. See `moirais.fn.describe('paligi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paligi import *
import numpy as np
# See the function signature in fn/paligi.py for argument names.
```
