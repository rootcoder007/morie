...
`print(result)` render. See `moirais.fn.describe('forstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forstr import *
import numpy as np
# See the function signature in fn/forstr.py for argument names.
```
