...
`print(result)` render. See `moirais.fn.describe('sogrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sogrv import *
import numpy as np
# See the function signature in fn/sogrv.py for argument names.
```
