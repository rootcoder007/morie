...
`print(result)` render. See `moirais.fn.describe('fhar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fhar import *
import numpy as np
# See the function signature in fn/fhar.py for argument names.
```
