...
`print(result)` render. See `moirais.fn.describe('rwksp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rwksp import *
import numpy as np
# See the function signature in fn/rwksp.py for argument names.
```
