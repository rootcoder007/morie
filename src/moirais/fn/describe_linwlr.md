# describe('linwlr') — linear_weighted_learner
...
`print(result)` render. See `moirais.fn.describe('linwlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linwlr import *
import numpy as np
# See the function signature in fn/linwlr.py for argument names.
```
