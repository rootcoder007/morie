...
`print(result)` render. See `moirais.fn.describe('sppdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppdiag import *
import numpy as np
# See the function signature in fn/sppdiag.py for argument names.
```
