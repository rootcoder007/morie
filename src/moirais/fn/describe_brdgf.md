# describe('brdgf') — bayes_ridge_gibbs
...
`print(result)` render. See `moirais.fn.describe('brdgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brdgf import *
import numpy as np
# See the function signature in fn/brdgf.py for argument names.
```
