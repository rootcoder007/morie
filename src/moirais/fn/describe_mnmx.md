...
`print(result)` render. See `moirais.fn.describe('mnmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnmx import *
import numpy as np
# See the function signature in fn/mnmx.py for argument names.
```
