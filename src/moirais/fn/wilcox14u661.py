...
__all__ = ["wilcox_chapter_14_unnumbered_661"]


def wilcox_chapter_14_unnumbered_661(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: F distribution with ν 1 = J − 1 and ν 2 = N − J degrees of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u661')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u661: GeneralStatistics expression (auto-extracted; see ref)."
