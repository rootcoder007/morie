...
__all__ = ["wilcox_chapter_13_unnumbered_1207"]


def wilcox_chapter_13_unnumbered_1207(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: interaction can be modeled with Y =β 0 +β 1X1 +β 2X2 +β 3X1X2 +e and where the least
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1207')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1207: GeneralStatistics expression (auto-extracted; see ref)."
