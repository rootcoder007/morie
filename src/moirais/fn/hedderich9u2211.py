...
__all__ = ["hedderich_chapter_9_unnumbered_2211"]


def hedderich_chapter_9_unnumbered_2211(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The expected value is E[W#] = np + 0.5n(n−1)p′, where in addition to p = P (X > 0), the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2211')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2211: GeneralStatistics expression (auto-extracted; see ref)."
