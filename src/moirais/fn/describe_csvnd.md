# describe('csvnd') — csvnd

## WHAT IT DOES

Vandalism pattern spatial
...
`print(result)` render. See `moirais.fn.describe('csvnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csvnd import *
import numpy as np
# See the function signature in fn/csvnd.py for argument names.
```
