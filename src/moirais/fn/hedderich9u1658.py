...
__all__ = ["hedderich_chapter_9_unnumbered_1658"]


def hedderich_chapter_9_unnumbered_1658(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: usually assumed to be symmetrical ( −δ<µd< + δ). Non-inferiority, therapeutic equivalence
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1658')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1658: GeneralStatistics expression (auto-extracted; see ref)."
