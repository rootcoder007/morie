# describe('snsmed') — sensitivity_mediation
...
`print(result)` render. See `moirais.fn.describe('snsmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snsmed import *
import numpy as np
# See the function signature in fn/snsmed.py for argument names.
```
