...
`print(result)` render. See `moirais.fn.describe('wqcya')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqcya import *
import numpy as np
# See the function signature in fn/wqcya.py for argument names.
```
