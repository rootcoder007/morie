# describe('joswc') — joseph_sliding_window_cv
...
`print(result)` render. See `moirais.fn.describe('joswc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joswc import *
import numpy as np
# See the function signature in fn/joswc.py for argument names.
```
