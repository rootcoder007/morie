...
__all__ = ["wilcox_chapter_5_unnumbered_374"]


def wilcox_chapter_5_unnumbered_374(x):
    """
    Resampling expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u374')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u374: Resampling expression (auto-extracted; see ref)."
