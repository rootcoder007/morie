...
`print(result)` render. See `moirais.fn.describe('ppint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppint import *
import numpy as np
# See the function signature in fn/ppint.py for argument names.
```
