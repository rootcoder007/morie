...
`print(result)` render. See `moirais.fn.describe('smean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smean import *
import numpy as np
# See the function signature in fn/smean.py for argument names.
```
