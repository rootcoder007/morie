...
__all__ = ["hedderich_chapter_9_unnumbered_2960"]


def hedderich_chapter_9_unnumbered_2960(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] αi =P (X =i), i = 1,...,r and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2960')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2960: GeneralStatistics expression (auto-extracted; see ref)."
