...
`print(result)` render. See `moirais.fn.describe('attkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attkr import *
import numpy as np
# See the function signature in fn/attkr.py for argument names.
```
