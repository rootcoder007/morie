...
`print(result)` render. See `moirais.fn.describe('ghke2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghke2 import *
import numpy as np
# See the function signature in fn/ghke2.py for argument names.
```
