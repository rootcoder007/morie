...
__all__ = ["hedderich_chapter_9_unnumbered_3137"]


def hedderich_chapter_9_unnumbered_3137(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (n−3) = z1−α/2 +zβ . (7.405)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3137')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3137: PowerAndDesign expression (auto-extracted; see ref)."
