...
`print(result)` render. See `moirais.fn.describe('scvelo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scvelo import *
import numpy as np
# See the function signature in fn/scvelo.py for argument names.
```
