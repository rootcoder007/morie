# describe('orbfd') — orbifold_spectrum
...
`print(result)` render. See `moirais.fn.describe('orbfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orbfd import *
import numpy as np
# See the function signature in fn/orbfd.py for argument names.
```
