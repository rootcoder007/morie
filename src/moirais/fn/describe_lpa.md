...
`print(result)` render. See `moirais.fn.describe('lpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpa import *
import numpy as np
# See the function signature in fn/lpa.py for argument names.
```
