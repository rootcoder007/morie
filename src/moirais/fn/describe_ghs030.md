# describe('ghs030') — ghosal_ch3_polya_tree_posterior_density
...
`print(result)` render. See `moirais.fn.describe('ghs030')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs030 import *
import numpy as np
# See the function signature in fn/ghs030.py for argument names.
```
