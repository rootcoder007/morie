# describe('r0') — basic_reproduction_number
...
`print(result)` render. See `moirais.fn.describe('r0')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r0 import *
import numpy as np
# See the function signature in fn/r0.py for argument names.
```
