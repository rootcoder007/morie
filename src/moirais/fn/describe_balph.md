...
`print(result)` render. See `moirais.fn.describe('balph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.balph import *
import numpy as np
# See the function signature in fn/balph.py for argument names.
```
