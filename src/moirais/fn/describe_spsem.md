# describe('spsem') — schabenberger_spatial_error_model
...
`print(result)` render. See `moirais.fn.describe('spsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsem import *
import numpy as np
# See the function signature in fn/spsem.py for argument names.
```
