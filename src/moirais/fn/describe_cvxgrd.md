# describe('cvxgrd') — boyd_gradient_descent
...
`print(result)` render. See `moirais.fn.describe('cvxgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxgrd import *
import numpy as np
# See the function signature in fn/cvxgrd.py for argument names.
```
