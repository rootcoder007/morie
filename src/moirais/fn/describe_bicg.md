# describe('bicg') — bayesian_information_criterion
...
`print(result)` render. See `moirais.fn.describe('bicg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bicg import *
import numpy as np
# See the function signature in fn/bicg.py for argument names.
```
