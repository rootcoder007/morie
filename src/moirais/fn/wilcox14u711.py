...
__all__ = ["wilcox_chapter_14_unnumbered_711"]


def wilcox_chapter_14_unnumbered_711(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: measure of location being used is equal to zero. That is, set Yij = Xij − ˆθ j as was done in
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u711')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u711: GeneralStatistics expression (auto-extracted; see ref)."
