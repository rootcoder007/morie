...
`print(result)` render. See `moirais.fn.describe('locdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.locdp import *
import numpy as np
# See the function signature in fn/locdp.py for argument names.
```
