# describe('hrzbr4a') — horowitz_binary_response_model
...
`print(result)` render. See `moirais.fn.describe('hrzbr4a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzbr4a import *
import numpy as np
# See the function signature in fn/hrzbr4a.py for argument names.
```
