...
`print(result)` render. See `moirais.fn.describe('abpln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpln import *
import numpy as np
# See the function signature in fn/abpln.py for argument names.
```
