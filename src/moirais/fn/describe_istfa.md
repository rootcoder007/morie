...
`print(result)` render. See `moirais.fn.describe('istfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.istfa import *
import numpy as np
# See the function signature in fn/istfa.py for argument names.
```
