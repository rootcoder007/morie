...
`print(result)` render. See `moirais.fn.describe('rey_sv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_sv import *
import numpy as np
# See the function signature in fn/rey_sv.py for argument names.
```
