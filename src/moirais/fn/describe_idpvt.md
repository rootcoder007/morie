...
`print(result)` render. See `moirais.fn.describe('idpvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpvt import *
import numpy as np
# See the function signature in fn/idpvt.py for argument names.
```
