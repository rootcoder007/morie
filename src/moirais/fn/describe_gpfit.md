...
`print(result)` render. See `moirais.fn.describe('gpfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpfit import *
import numpy as np
# See the function signature in fn/gpfit.py for argument names.
```
