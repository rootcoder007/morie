...
`print(result)` render. See `moirais.fn.describe('trbus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trbus import *
import numpy as np
# See the function signature in fn/trbus.py for argument names.
```
