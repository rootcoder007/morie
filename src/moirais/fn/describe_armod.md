...
`print(result)` render. See `moirais.fn.describe('armod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.armod import *
import numpy as np
# See the function signature in fn/armod.py for argument names.
```
