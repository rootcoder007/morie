# describe('zxcpg') — copula_gauss_sp

## WHAT IT DOES

Gaussian copula spatial
...
`print(result)` render. See `moirais.fn.describe('zxcpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxcpg import *
import numpy as np
# See the function signature in fn/zxcpg.py for argument names.
```
