...
__all__ = ["guide_on_data_analysis_chapter_26_unnumbered_1308"]


def guide_on_data_analysis_chapter_26_unnumbered_1308(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑡 = 𝛼 + 𝛽1𝑇𝑖𝑡 + 𝛽2𝑍𝑖 + 𝛽3𝑇𝑖𝑡 × 𝑍𝑖 + 𝜀𝑖𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis26u1308')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis26u1308: GeneralStatistics expression (auto-extracted; see ref)."
