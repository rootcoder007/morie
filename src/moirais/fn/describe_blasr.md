...
`print(result)` render. See `moirais.fn.describe('blasr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blasr import *
import numpy as np
# See the function signature in fn/blasr.py for argument names.
```
