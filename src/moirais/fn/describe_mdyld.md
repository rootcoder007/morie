...
`print(result)` render. See `moirais.fn.describe('mdyld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdyld import *
import numpy as np
# See the function signature in fn/mdyld.py for argument names.
```
