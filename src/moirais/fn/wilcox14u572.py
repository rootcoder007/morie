...
__all__ = ["wilcox_chapter_14_unnumbered_572"]


def wilcox_chapter_14_unnumbered_572(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: cision Rule : Reject H0: P = 0.5 if |W | ≥ t, where t is the 1 − α/2 quantile of a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u572')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u572: GeneralStatistics expression (auto-extracted; see ref)."
