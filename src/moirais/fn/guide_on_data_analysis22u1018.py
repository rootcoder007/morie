...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1018"]


def guide_on_data_analysis_chapter_22_unnumbered_1018(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1018')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1018: GeneralStatistics expression (auto-extracted; see ref)."
