...
__all__ = ["hedderich_chapter_9_unnumbered_2139"]


def hedderich_chapter_9_unnumbered_2139(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Since 1.65 < 1.96 = z0.975, the null hypothesis (e.g.: ˜µA = ˜µB) cannot be rejected with a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2139')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2139: GeneralStatistics expression (auto-extracted; see ref)."
