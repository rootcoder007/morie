...
`print(result)` render. See `moirais.fn.describe('zxgrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxgrc import *
import numpy as np
# See the function signature in fn/zxgrc.py for argument names.
```
