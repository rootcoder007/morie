...
`print(result)` render. See `moirais.fn.describe('vincnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vincnt import *
import numpy as np
# See the function signature in fn/vincnt.py for argument names.
```
