...
__all__ = ["hedderich_chapter_9_unnumbered_2422"]


def hedderich_chapter_9_unnumbered_2422(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + t a b 1 [ i , j ] <− qmvt ( 0 . 9 5 , df = df [ i ] , tail = " both " ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2422')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2422: GeneralStatistics expression (auto-extracted; see ref)."
