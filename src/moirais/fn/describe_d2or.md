...
`print(result)` render. See `moirais.fn.describe('d2or')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.d2or import *
import numpy as np
# See the function signature in fn/d2or.py for argument names.
```
