...
`print(result)` render. See `moirais.fn.describe('sosnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosnd import *
import numpy as np
# See the function signature in fn/sosnd.py for argument names.
```
