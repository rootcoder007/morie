...
`print(result)` render. See `moirais.fn.describe('csopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csopt import *
import numpy as np
# See the function signature in fn/csopt.py for argument names.
```
