...
`print(result)` render. See `moirais.fn.describe('wtbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wtbst import *
import numpy as np
# See the function signature in fn/wtbst.py for argument names.
```
