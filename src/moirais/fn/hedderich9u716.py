...
__all__ = ["hedderich_chapter_9_unnumbered_716"]


def hedderich_chapter_9_unnumbered_716(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u716')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u716: GeneralStatistics expression (auto-extracted; see ref)."
