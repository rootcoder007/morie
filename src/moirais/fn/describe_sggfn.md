# describe('sggfn') — g_function_nearest_neighbor
...
`print(result)` render. See `moirais.fn.describe('sggfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sggfn import *
import numpy as np
# See the function signature in fn/sggfn.py for argument names.
```
