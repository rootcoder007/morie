...
__all__ = ["hedderich_chapter_9_unnumbered_1175"]


def hedderich_chapter_9_unnumbered_1175(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (ˆp1−ˆp2)±z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1175')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1175: GeneralStatistics expression (auto-extracted; see ref)."
