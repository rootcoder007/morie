# describe('trped') — trped

## WHAT IT DOES

Pedestrian flow spatial
...
`print(result)` render. See `moirais.fn.describe('trped')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trped import *
import numpy as np
# See the function signature in fn/trped.py for argument names.
```
