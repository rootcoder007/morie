# describe('sghrmt') — hermite_polynomial
...
`print(result)` render. See `moirais.fn.describe('sghrmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sghrmt import *
import numpy as np
# See the function signature in fn/sghrmt.py for argument names.
```
