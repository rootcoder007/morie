# describe('alfmpv') — alphafold_multimer
...
`print(result)` render. See `moirais.fn.describe('alfmpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfmpv import *
import numpy as np
# See the function signature in fn/alfmpv.py for argument names.
```
