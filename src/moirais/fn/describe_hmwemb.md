# describe('hmwemb') — geron_word_embeddings
...
`print(result)` render. See `moirais.fn.describe('hmwemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmwemb import *
import numpy as np
# See the function signature in fn/hmwemb.py for argument names.
```
