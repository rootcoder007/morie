...
`print(result)` render. See `moirais.fn.describe('msmpoi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmpoi import *
import numpy as np
# See the function signature in fn/msmpoi.py for argument names.
```
