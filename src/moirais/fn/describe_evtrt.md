...
`print(result)` render. See `moirais.fn.describe('evtrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtrt import *
import numpy as np
# See the function signature in fn/evtrt.py for argument names.
```
