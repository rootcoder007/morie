# describe('gblupr') — gblup_estimator
...
`print(result)` render. See `moirais.fn.describe('gblupr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gblupr import *
import numpy as np
# See the function signature in fn/gblupr.py for argument names.
```
