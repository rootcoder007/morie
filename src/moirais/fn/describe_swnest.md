...
`print(result)` render. See `moirais.fn.describe('swnest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swnest import *
import numpy as np
# See the function signature in fn/swnest.py for argument names.
```
