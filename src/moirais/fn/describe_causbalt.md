# describe('causbalt') — causal_balance_test
...
`print(result)` render. See `moirais.fn.describe('causbalt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causbalt import *
import numpy as np
# See the function signature in fn/causbalt.py for argument names.
```
