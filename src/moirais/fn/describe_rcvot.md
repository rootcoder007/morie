...
`print(result)` render. See `moirais.fn.describe('rcvot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcvot import *
import numpy as np
# See the function signature in fn/rcvot.py for argument names.
```
