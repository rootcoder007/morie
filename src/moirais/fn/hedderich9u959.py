...
__all__ = ["hedderich_chapter_9_unnumbered_959"]


def hedderich_chapter_9_unnumbered_959(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.05 ort5;0.05;two−sided =t5;0.975 = 2.5706 (Table 5.8 read from the bottom).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u959')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u959: GeneralStatistics expression (auto-extracted; see ref)."
