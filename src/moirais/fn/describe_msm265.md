# describe('msm265') — mvsml_convolutional_nn_eq_14_1
...
`print(result)` render. See `moirais.fn.describe('msm265')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm265 import *
import numpy as np
# See the function signature in fn/msm265.py for argument names.
```
