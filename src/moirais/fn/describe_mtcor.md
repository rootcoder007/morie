...
`print(result)` render. See `moirais.fn.describe('mtcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcor import *
import numpy as np
# See the function signature in fn/mtcor.py for argument names.
```
