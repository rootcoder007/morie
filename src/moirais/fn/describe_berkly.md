# describe('berkly') — berkeley_earth
...
`print(result)` render. See `moirais.fn.describe('berkly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.berkly import *
import numpy as np
# See the function signature in fn/berkly.py for argument names.
```
