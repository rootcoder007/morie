...
__all__ = ["hedderich_chapter_9_unnumbered_935"]


def hedderich_chapter_9_unnumbered_935(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 6s/π=0.7797·s withs2= ∑x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u935')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u935: GeneralStatistics expression (auto-extracted; see ref)."
