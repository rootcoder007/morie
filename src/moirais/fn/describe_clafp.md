...
`print(result)` render. See `moirais.fn.describe('clafp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clafp import *
import numpy as np
# See the function signature in fn/clafp.py for argument names.
```
