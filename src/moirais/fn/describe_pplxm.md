# describe('pplxm') — perplexity_metric
...
`print(result)` render. See `moirais.fn.describe('pplxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pplxm import *
import numpy as np
# See the function signature in fn/pplxm.py for argument names.
```
