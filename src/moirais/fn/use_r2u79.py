...
__all__ = ["use_r_chapter_2_unnumbered_79"]


def use_r_chapter_2_unnumbered_79(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The values of the coefficients α, β1,...,β 5 are 5.53, 5.64, –0.774, –5.01,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u79')`` for the full guide.
...
def cheatsheet():
    return "use_r2u79: GeneralStatistics expression (auto-extracted; see ref)."
