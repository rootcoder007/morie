# describe('hrzcbsm') — horowitz_choice_based_sms
...
`print(result)` render. See `moirais.fn.describe('hrzcbsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzcbsm import *
import numpy as np
# See the function signature in fn/hrzcbsm.py for argument names.
```
