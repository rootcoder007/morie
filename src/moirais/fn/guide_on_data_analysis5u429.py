...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_429"]


def guide_on_data_analysis_chapter_5_unnumbered_429(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u429')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u429: GeneralStatistics expression (auto-extracted; see ref)."
