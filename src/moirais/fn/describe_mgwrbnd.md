...
`print(result)` render. See `moirais.fn.describe('mgwrbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrbnd import *
import numpy as np
# See the function signature in fn/mgwrbnd.py for argument names.
```
