# describe('ghs020') — ghosal_ch3_tree_countable_additivity
...
`print(result)` render. See `moirais.fn.describe('ghs020')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs020 import *
import numpy as np
# See the function signature in fn/ghs020.py for argument names.
```
