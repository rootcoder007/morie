...
def ca_chapter_2_unnumbered_36(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca2u36')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'sentence' (auto-extracted; see reference for full context)."},
    )
