...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_67"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_67(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If 0 < λi < 1 for i = 1, . . . , I, then
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u67')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u67: GeneralStatistics expression (auto-extracted; see ref)."
