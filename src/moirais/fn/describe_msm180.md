# describe('msm180') — mvsml_ridge_lasso_elastic_eq_9_6
...
`print(result)` render. See `moirais.fn.describe('msm180')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm180 import *
import numpy as np
# See the function signature in fn/msm180.py for argument names.
```
