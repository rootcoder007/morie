...
`print(result)` render. See `moirais.fn.describe('ftest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ftest import *
import numpy as np
# See the function signature in fn/ftest.py for argument names.
```
