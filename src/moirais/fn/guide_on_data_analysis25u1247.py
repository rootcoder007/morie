...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1247"]


def guide_on_data_analysis_chapter_25_unnumbered_1247(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> D = 0.17627, p-value = 0.3944
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1247')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1247: GeneralStatistics expression (auto-extracted; see ref)."
