...
`print(result)` render. See `moirais.fn.describe('hmsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsft import *
import numpy as np
# See the function signature in fn/hmsft.py for argument names.
```
