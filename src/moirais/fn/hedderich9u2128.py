...
__all__ = ["hedderich_chapter_9_unnumbered_2128"]


def hedderich_chapter_9_unnumbered_2128(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > r 2 <− sum ( rank [ group = = 2 ] ) ; r 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2128')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2128: GeneralStatistics expression (auto-extracted; see ref)."
