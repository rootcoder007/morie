...
`print(result)` render. See `moirais.fn.describe('lacgmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacgmc import *
import numpy as np
# See the function signature in fn/lacgmc.py for argument names.
```
