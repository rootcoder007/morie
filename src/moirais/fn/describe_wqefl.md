...
`print(result)` render. See `moirais.fn.describe('wqefl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqefl import *
import numpy as np
# See the function signature in fn/wqefl.py for argument names.
```
