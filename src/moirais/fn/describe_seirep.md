# describe('seirep') — seir_compartmental
...
`print(result)` render. See `moirais.fn.describe('seirep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seirep import *
import numpy as np
# See the function signature in fn/seirep.py for argument names.
```
