# describe('ghdpm') — ghosal_dpmixture_density
...
`print(result)` render. See `moirais.fn.describe('ghdpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghdpm import *
import numpy as np
# See the function signature in fn/ghdpm.py for argument names.
```
