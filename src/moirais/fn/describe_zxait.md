...
`print(result)` render. See `moirais.fn.describe('zxait')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxait import *
import numpy as np
# See the function signature in fn/zxait.py for argument names.
```
