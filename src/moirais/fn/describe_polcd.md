...
`print(result)` render. See `moirais.fn.describe('polcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polcd import *
import numpy as np
# See the function signature in fn/polcd.py for argument names.
```
