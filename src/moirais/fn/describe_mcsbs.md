...
`print(result)` render. See `moirais.fn.describe('mcsbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcsbs import *
import numpy as np
# See the function signature in fn/mcsbs.py for argument names.
```
