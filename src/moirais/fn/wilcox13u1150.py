...
__all__ = ["wilcox_chapter_13_unnumbered_1150"]


def wilcox_chapter_13_unnumbered_1150(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rundis(x,y,est=mom,plotit=TRUE,pyhat=FALSE,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1150')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1150: GeneralStatistics expression (auto-extracted; see ref)."
