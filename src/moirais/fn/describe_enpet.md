...
`print(result)` render. See `moirais.fn.describe('enpet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enpet import *
import numpy as np
# See the function signature in fn/enpet.py for argument names.
```
