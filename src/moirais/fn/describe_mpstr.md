...
`print(result)` render. See `moirais.fn.describe('mpstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpstr import *
import numpy as np
# See the function signature in fn/mpstr.py for argument names.
```
