...
`print(result)` render. See `moirais.fn.describe('plzro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plzro import *
import numpy as np
# See the function signature in fn/plzro.py for argument names.
```
