...
__all__ = ["hedderich_chapter_9_unnumbered_1898"]


def hedderich_chapter_9_unnumbered_1898(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + names ( prop ) = " Downwards Trend , P− value "
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1898')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1898: GeneralStatistics expression (auto-extracted; see ref)."
