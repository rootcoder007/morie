# describe('rcdcm') — recidivism_competing
...
`print(result)` render. See `moirais.fn.describe('rcdcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdcm import *
import numpy as np
# See the function signature in fn/rcdcm.py for argument names.
```
