# describe('svmnl') — multinomial_spatial
...
`print(result)` render. See `moirais.fn.describe('svmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmnl import *
import numpy as np
# See the function signature in fn/svmnl.py for argument names.
```
