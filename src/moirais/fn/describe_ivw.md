...
`print(result)` render. See `moirais.fn.describe('ivw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ivw import *
import numpy as np
# See the function signature in fn/ivw.py for argument names.
```
