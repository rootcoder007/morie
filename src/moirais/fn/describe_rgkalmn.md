# describe('rgkalmn') — rangayyan_kalman_filter
...
`print(result)` render. See `moirais.fn.describe('rgkalmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkalmn import *
import numpy as np
# See the function signature in fn/rgkalmn.py for argument names.
```
