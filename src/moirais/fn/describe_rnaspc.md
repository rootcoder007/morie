...
`print(result)` render. See `moirais.fn.describe('rnaspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnaspc import *
import numpy as np
# See the function signature in fn/rnaspc.py for argument names.
```
