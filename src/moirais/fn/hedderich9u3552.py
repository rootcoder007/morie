...
__all__ = ["hedderich_chapter_9_unnumbered_3552"]


def hedderich_chapter_9_unnumbered_3552(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] withSi(t) = P (Ti >t ) fori = 1, 2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3552')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3552: PowerAndDesign expression (auto-extracted; see ref)."
