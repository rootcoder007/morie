...
`print(result)` render. See `moirais.fn.describe('dk3si')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3si import *
import numpy as np
# See the function signature in fn/dk3si.py for argument names.
```
