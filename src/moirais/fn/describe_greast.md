# describe('greast') — geron_early_stopping
...
`print(result)` render. See `moirais.fn.describe('greast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.greast import *
import numpy as np
# See the function signature in fn/greast.py for argument names.
```
