...
`print(result)` render. See `moirais.fn.describe('cart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cart import *
import numpy as np
# See the function signature in fn/cart.py for argument names.
```
