...
__all__ = ["hedderich_chapter_9_unnumbered_2265"]


def hedderich_chapter_9_unnumbered_2265(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: given significance levelαifPone−sided≤αorPtwo−sided≤α.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2265')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2265: GeneralStatistics expression (auto-extracted; see ref)."
