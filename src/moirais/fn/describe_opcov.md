...
`print(result)` render. See `moirais.fn.describe('opcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opcov import *
import numpy as np
# See the function signature in fn/opcov.py for argument names.
```
