...
__all__ = ["wilcox_chapter_13_unnumbered_1192"]


def wilcox_chapter_13_unnumbered_1192(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: outfun=outpro, SEED=TRUE, MC=FALSE, tr=0.2,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1192')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1192: PowerAndDesign expression (auto-extracted; see ref)."
