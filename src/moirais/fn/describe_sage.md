...
`print(result)` render. See `moirais.fn.describe('sage')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sage import *
import numpy as np
# See the function signature in fn/sage.py for argument names.
```
