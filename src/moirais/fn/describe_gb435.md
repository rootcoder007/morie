# describe('gb435') — gibbons_ks_onesided_asymp
...
`print(result)` render. See `moirais.fn.describe('gb435')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb435 import *
import numpy as np
# See the function signature in fn/gb435.py for argument names.
```
