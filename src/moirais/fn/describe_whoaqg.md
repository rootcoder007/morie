# describe('whoaqg') — who_aqg_compliance
...
`print(result)` render. See `moirais.fn.describe('whoaqg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whoaqg import *
import numpy as np
# See the function signature in fn/whoaqg.py for argument names.
```
