# describe('kmyarn') — kamath_yarn_context_extrapolation
...
`print(result)` render. See `moirais.fn.describe('kmyarn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmyarn import *
import numpy as np
# See the function signature in fn/kmyarn.py for argument names.
```
