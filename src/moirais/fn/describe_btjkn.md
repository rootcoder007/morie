...
`print(result)` render. See `moirais.fn.describe('btjkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btjkn import *
import numpy as np
# See the function signature in fn/btjkn.py for argument names.
```
