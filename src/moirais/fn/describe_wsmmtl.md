# describe('wsmmtl') — wasserman_mutual_info
...
`print(result)` render. See `moirais.fn.describe('wsmmtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmtl import *
import numpy as np
# See the function signature in fn/wsmmtl.py for argument names.
```
