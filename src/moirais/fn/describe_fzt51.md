# describe('fzt51') — fauzi_thm5_1_naive_kernel_equiv
...
`print(result)` render. See `moirais.fn.describe('fzt51')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt51 import *
import numpy as np
# See the function signature in fn/fzt51.py for argument names.
```
