...
`print(result)` render. See `moirais.fn.describe('svtut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svtut import *
import numpy as np
# See the function signature in fn/svtut.py for argument names.
```
