# describe('rgmscart') — rangayyan_muscle_artifact
...
`print(result)` render. See `moirais.fn.describe('rgmscart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmscart import *
import numpy as np
# See the function signature in fn/rgmscart.py for argument names.
```
