...
`print(result)` render. See `moirais.fn.describe('irrgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irrgen import *
import numpy as np
# See the function signature in fn/irrgen.py for argument names.
```
