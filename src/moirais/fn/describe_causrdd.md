# describe('causrdd') — causal_rdd_local_lin
...
`print(result)` render. See `moirais.fn.describe('causrdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrdd import *
import numpy as np
# See the function signature in fn/causrdd.py for argument names.
```
