...
`print(result)` render. See `moirais.fn.describe('geeduc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geeduc import *
import numpy as np
# See the function signature in fn/geeduc.py for argument names.
```
