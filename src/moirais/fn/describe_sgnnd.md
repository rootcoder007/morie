# describe('sgnnd') — nearest_neighbor_distances
...
`print(result)` render. See `moirais.fn.describe('sgnnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnnd import *
import numpy as np
# See the function signature in fn/sgnnd.py for argument names.
```
