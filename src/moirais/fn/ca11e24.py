...
def ca_chapter_11_equation_24(x):
    """
    Logistic expression involving 'logit' (auto-extracted; see reference for full context).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca11e24')`` for the full guide.

    References
    ----------
    Advanced Statistics in Criminology and Criminal Justice (Weisburd, Wilson, Wooditch & Britt, 5th ed, Springer 2022), ch.11 eq.11.24
    """
...
def cheatsheet():
    return "ca11e24: Logistic expression involving 'logit' (auto-extracted; see reference for full context)."
