# describe('vidgen') — video_diffusion
...
`print(result)` render. See `moirais.fn.describe('vidgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vidgen import *
import numpy as np
# See the function signature in fn/vidgen.py for argument names.
```
