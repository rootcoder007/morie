...
`print(result)` render. See `moirais.fn.describe('svwut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwut import *
import numpy as np
# See the function signature in fn/svwut.py for argument names.
```
