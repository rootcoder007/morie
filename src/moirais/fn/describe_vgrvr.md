...
`print(result)` render. See `moirais.fn.describe('vgrvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgrvr import *
import numpy as np
# See the function signature in fn/vgrvr.py for argument names.
```
