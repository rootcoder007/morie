...
`print(result)` render. See `moirais.fn.describe('gdpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdpf import *
import numpy as np
# See the function signature in fn/gdpf.py for argument names.
```
