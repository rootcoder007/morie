...
__all__ = ["hedderich_chapter_9_unnumbered_2187"]


def hedderich_chapter_9_unnumbered_2187(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [(−0.04) + (−0.04)]/2 =−0.04 (0 .10 + 0.02)/2 = 0.06
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2187')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2187: GeneralStatistics expression (auto-extracted; see ref)."
