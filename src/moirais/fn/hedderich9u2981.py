...
__all__ = ["hedderich_chapter_9_unnumbered_2981"]


def hedderich_chapter_9_unnumbered_2981(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0≤ˆχ2≤n·Min[(r−1), (c−1)] (7.361)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2981')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2981: GeneralStatistics expression (auto-extracted; see ref)."
