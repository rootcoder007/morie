...
`print(result)` render. See `moirais.fn.describe('wave')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wave import *
import numpy as np
# See the function signature in fn/wave.py for argument names.
```
