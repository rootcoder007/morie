...
__all__ = ["wilcox_chapter_14_unnumbered_466"]


def wilcox_chapter_14_unnumbered_466(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: for testing H0:β 1 = · · · =β p = 0, the hypothesis that all p slopes are zero, it currently seems
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u466')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u466: GeneralStatistics expression (auto-extracted; see ref)."
