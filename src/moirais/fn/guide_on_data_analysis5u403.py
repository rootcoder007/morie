...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_403"]


def guide_on_data_analysis_chapter_5_unnumbered_403(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E(̂ ￿IGLS|X) =E(￿ + (X′￿−1X′￿−1￿)|X)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u403')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u403: GeneralStatistics expression (auto-extracted; see ref)."
