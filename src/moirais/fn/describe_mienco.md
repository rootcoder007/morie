# describe('mienco') — mi_neural_encoder
...
`print(result)` render. See `moirais.fn.describe('mienco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mienco import *
import numpy as np
# See the function signature in fn/mienco.py for argument names.
```
