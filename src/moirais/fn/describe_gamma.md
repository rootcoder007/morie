...
`print(result)` render. See `moirais.fn.describe('gamma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gamma import *
import numpy as np
# See the function signature in fn/gamma.py for argument names.
```
