...
__all__ = ["hedderich_chapter_9_unnumbered_631"]


def hedderich_chapter_9_unnumbered_631(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pbinom() the distribution shares on the left (lower.tail=TRUE,≤) or right (lower.tail=FALSE,>)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u631')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u631: GeneralStatistics expression (auto-extracted; see ref)."
