...
`print(result)` render. See `moirais.fn.describe('sarboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarboot import *
import numpy as np
# See the function signature in fn/sarboot.py for argument names.
```
