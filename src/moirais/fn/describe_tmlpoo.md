...
`print(result)` render. See `moirais.fn.describe('tmlpoo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlpoo import *
import numpy as np
# See the function signature in fn/tmlpoo.py for argument names.
```
