...
`print(result)` render. See `moirais.fn.describe('raklng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raklng import *
import numpy as np
# See the function signature in fn/raklng.py for argument names.
```
