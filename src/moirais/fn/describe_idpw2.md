...
`print(result)` render. See `moirais.fn.describe('idpw2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpw2 import *
import numpy as np
# See the function signature in fn/idpw2.py for argument names.
```
