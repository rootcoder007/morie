# describe('attfr') — attributable_fraction
...
`print(result)` render. See `moirais.fn.describe('attfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attfr import *
import numpy as np
# See the function signature in fn/attfr.py for argument names.
```
