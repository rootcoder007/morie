# describe('tranm') — transmission_tree
...
`print(result)` render. See `moirais.fn.describe('tranm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tranm import *
import numpy as np
# See the function signature in fn/tranm.py for argument names.
```
