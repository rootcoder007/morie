...
__all__ = ["hedderich_chapter_9_unnumbered_2421"]


def hedderich_chapter_9_unnumbered_2421(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α = 0.01 P = 1−α = 0.99
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2421')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2421: GeneralStatistics expression (auto-extracted; see ref)."
