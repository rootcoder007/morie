...
__all__ = ["hedderich_chapter_9_unnumbered_53"]


def hedderich_chapter_9_unnumbered_53(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 0.01 = 10−2 or lg 0.01 =−2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u53')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u53: PowerAndDesign expression (auto-extracted; see ref)."
