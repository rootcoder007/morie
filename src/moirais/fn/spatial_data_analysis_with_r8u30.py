...
__all__ = ["spatial_data_analysis_with_r_chapter_8_unnumbered_30"]


def spatial_data_analysis_with_r_chapter_8_unnumbered_30(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatial_data_analysis_with_r8u30')`` for the full guide.
...
def cheatsheet():
    return "spatial_data_analysis_with_r8u30: GeneralStatistics expression (auto-extracted; see ref)."
