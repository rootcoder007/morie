...
__all__ = ["wilcox_chapter_14_unnumbered_716"]


def wilcox_chapter_14_unnumbered_716(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: is true, then δ 12 = δ 13 = δ 23 = 0. To simplify matters, momentarily focus on δ 12 and δ 13.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u716')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u716: GeneralStatistics expression (auto-extracted; see ref)."
