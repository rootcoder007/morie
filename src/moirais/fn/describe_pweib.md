...
`print(result)` render. See `moirais.fn.describe('pweib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pweib import *
import numpy as np
# See the function signature in fn/pweib.py for argument names.
```
