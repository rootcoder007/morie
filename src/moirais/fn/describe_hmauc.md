...
`print(result)` render. See `moirais.fn.describe('hmauc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmauc import *
import numpy as np
# See the function signature in fn/hmauc.py for argument names.
```
