...
`print(result)` render. See `moirais.fn.describe('ncombo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ncombo import *
import numpy as np
# See the function signature in fn/ncombo.py for argument names.
```
