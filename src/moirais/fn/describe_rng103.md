# describe('rng103') — rangayyan_ch3_integral_causal
...
`print(result)` render. See `moirais.fn.describe('rng103')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng103 import *
import numpy as np
# See the function signature in fn/rng103.py for argument names.
```
