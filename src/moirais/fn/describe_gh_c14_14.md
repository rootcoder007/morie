# describe('gh_c14_14') — ghosal_nig_proc
...
`print(result)` render. See `moirais.fn.describe('gh_c14_14')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_14 import *
import numpy as np
# See the function signature in fn/gh_c14_14.py for argument names.
```
