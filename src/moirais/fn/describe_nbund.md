...
`print(result)` render. See `moirais.fn.describe('nbund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbund import *
import numpy as np
# See the function signature in fn/nbund.py for argument names.
```
