...
`print(result)` render. See `moirais.fn.describe('hydra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydra import *
import numpy as np
# See the function signature in fn/hydra.py for argument names.
```
