# describe('morloc') — local_morans_i
...
`print(result)` render. See `moirais.fn.describe('morloc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morloc import *
import numpy as np
# See the function signature in fn/morloc.py for argument names.
```
