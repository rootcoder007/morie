...
`print(result)` render. See `moirais.fn.describe('mvtpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtpl import *
import numpy as np
# See the function signature in fn/mvtpl.py for argument names.
```
