...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_193"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_193(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: β01 +β11xi +β21x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u193')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u193: GeneralStatistics expression (auto-extracted; see ref)."
