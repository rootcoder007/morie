# describe('grpcap') — geron_pca_projection
...
`print(result)` render. See `moirais.fn.describe('grpcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpcap import *
import numpy as np
# See the function signature in fn/grpcap.py for argument names.
```
