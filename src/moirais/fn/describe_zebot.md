...
`print(result)` render. See `moirais.fn.describe('zebot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zebot import *
import numpy as np
# See the function signature in fn/zebot.py for argument names.
```
