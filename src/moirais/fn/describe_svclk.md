# describe('svclk') — coalition_kernel
...
`print(result)` render. See `moirais.fn.describe('svclk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclk import *
import numpy as np
# See the function signature in fn/svclk.py for argument names.
```
