...
`print(result)` render. See `moirais.fn.describe('bgtet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgtet import *
import numpy as np
# See the function signature in fn/bgtet.py for argument names.
```
