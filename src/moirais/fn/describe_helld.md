...
`print(result)` render. See `moirais.fn.describe('helld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.helld import *
import numpy as np
# See the function signature in fn/helld.py for argument names.
```
