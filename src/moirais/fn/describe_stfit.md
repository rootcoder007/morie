# describe('stfit') — stfit

## WHAT IT DOES

Space-time covariance model fitting.
...
`print(result)` render. See `moirais.fn.describe('stfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stfit import *
import numpy as np
# See the function signature in fn/stfit.py for argument names.
```
