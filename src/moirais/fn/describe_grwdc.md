# describe('grwdc') — geron_adamw_decoupled_weight_decay
...
`print(result)` render. See `moirais.fn.describe('grwdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grwdc import *
import numpy as np
# See the function signature in fn/grwdc.py for argument names.
```
