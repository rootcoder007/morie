...
`print(result)` render. See `moirais.fn.describe('irtab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtab import *
import numpy as np
# See the function signature in fn/irtab.py for argument names.
```
