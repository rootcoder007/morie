# describe('rng124') — rangayyan_ch3_butterworth_squared_laplace
...
`print(result)` render. See `moirais.fn.describe('rng124')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng124 import *
import numpy as np
# See the function signature in fn/rng124.py for argument names.
```
