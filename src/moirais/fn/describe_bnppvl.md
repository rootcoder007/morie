# describe('bnppvl') — bnp_predictive_value
...
`print(result)` render. See `moirais.fn.describe('bnppvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnppvl import *
import numpy as np
# See the function signature in fn/bnppvl.py for argument names.
```
