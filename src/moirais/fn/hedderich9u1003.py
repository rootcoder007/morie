...
__all__ = ["hedderich_chapter_9_unnumbered_1003"]


def hedderich_chapter_9_unnumbered_1003(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y∗=ya +p·(yb−ya)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1003')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1003: GeneralStatistics expression (auto-extracted; see ref)."
