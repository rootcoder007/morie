...
`print(result)` render. See `moirais.fn.describe('svcos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcos import *
import numpy as np
# See the function signature in fn/svcos.py for argument names.
```
