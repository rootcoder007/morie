...
`print(result)` render. See `moirais.fn.describe('mahg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mahg import *
import numpy as np
# See the function signature in fn/mahg.py for argument names.
```
