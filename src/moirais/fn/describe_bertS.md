...
`print(result)` render. See `moirais.fn.describe('bertS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bertS import *
import numpy as np
# See the function signature in fn/bertS.py for argument names.
```
