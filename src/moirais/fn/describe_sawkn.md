...
`print(result)` render. See `moirais.fn.describe('sawkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawkn import *
import numpy as np
# See the function signature in fn/sawkn.py for argument names.
```
