# describe('manlmm') — ma_network_lme
...
`print(result)` render. See `moirais.fn.describe('manlmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manlmm import *
import numpy as np
# See the function signature in fn/manlmm.py for argument names.
```
