...
`print(result)` render. See `moirais.fn.describe('svnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnrm import *
import numpy as np
# See the function signature in fn/svnrm.py for argument names.
```
