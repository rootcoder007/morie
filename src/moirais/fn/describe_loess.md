...
`print(result)` render. See `moirais.fn.describe('loess')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.loess import *
import numpy as np
# See the function signature in fn/loess.py for argument names.
```
