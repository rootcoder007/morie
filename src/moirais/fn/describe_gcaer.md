...
`print(result)` render. See `moirais.fn.describe('gcaer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcaer import *
import numpy as np
# See the function signature in fn/gcaer.py for argument names.
```
