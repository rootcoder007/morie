...
`print(result)` render. See `moirais.fn.describe('clmnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clmnb import *
import numpy as np
# See the function signature in fn/clmnb.py for argument names.
```
