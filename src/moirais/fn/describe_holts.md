# describe('holts') — holts_method

## WHAT IT DOES

Holt's linear trend method. 'I love you.' 'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('holts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holts import *
import numpy as np
# See the function signature in fn/holts.py for argument names.
```
