...
`print(result)` render. See `moirais.fn.describe('dtlpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtlpl import *
import numpy as np
# See the function signature in fn/dtlpl.py for argument names.
```
