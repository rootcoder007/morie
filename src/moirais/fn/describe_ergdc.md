...
`print(result)` render. See `moirais.fn.describe('ergdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ergdc import *
import numpy as np
# See the function signature in fn/ergdc.py for argument names.
```
