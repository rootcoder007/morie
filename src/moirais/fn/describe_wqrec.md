...
`print(result)` render. See `moirais.fn.describe('wqrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqrec import *
import numpy as np
# See the function signature in fn/wqrec.py for argument names.
```
