...
`print(result)` render. See `moirais.fn.describe('mgwrstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrstd import *
import numpy as np
# See the function signature in fn/mgwrstd.py for argument names.
```
