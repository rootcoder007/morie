# describe('pendu') — pendulum

## WHAT IT DOES

Simple pendulum ODE solver. 'Time discovers truth. — Seneca'
...
`print(result)` render. See `moirais.fn.describe('pendu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pendu import *
import numpy as np
# See the function signature in fn/pendu.py for argument names.
```
