...
`print(result)` render. See `moirais.fn.describe('spslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spslp import *
import numpy as np
# See the function signature in fn/spslp.py for argument names.
```
