...
`print(result)` render. See `moirais.fn.describe('ppblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppblk import *
import numpy as np
# See the function signature in fn/ppblk.py for argument names.
```
