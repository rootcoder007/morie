# describe('rsmpl') — resample_signal
...
`print(result)` render. See `moirais.fn.describe('rsmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmpl import *
import numpy as np
# See the function signature in fn/rsmpl.py for argument names.
```
