# describe('empfun') — empty_space_function
...
`print(result)` render. See `moirais.fn.describe('empfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.empfun import *
import numpy as np
# See the function signature in fn/empfun.py for argument names.
```
