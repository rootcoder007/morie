...
`print(result)` render. See `moirais.fn.describe('kendt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kendt import *
import numpy as np
# See the function signature in fn/kendt.py for argument names.
```
