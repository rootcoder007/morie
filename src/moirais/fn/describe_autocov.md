...
`print(result)` render. See `moirais.fn.describe('autocov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.autocov import *
import numpy as np
# See the function signature in fn/autocov.py for argument names.
```
