# describe('vgexp') — vario_exponential
...
`print(result)` render. See `moirais.fn.describe('vgexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgexp import *
import numpy as np
# See the function signature in fn/vgexp.py for argument names.
```
