...
`print(result)` render. See `moirais.fn.describe('pphpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pphpp import *
import numpy as np
# See the function signature in fn/pphpp.py for argument names.
```
