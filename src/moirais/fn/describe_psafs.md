# describe('psafs') — population_attributable_fraction
...
`print(result)` render. See `moirais.fn.describe('psafs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psafs import *
import numpy as np
# See the function signature in fn/psafs.py for argument names.
```
