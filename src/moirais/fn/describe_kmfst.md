# describe('kmfst') — kamath_fasttext_subword
...
`print(result)` render. See `moirais.fn.describe('kmfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmfst import *
import numpy as np
# See the function signature in fn/kmfst.py for argument names.
```
