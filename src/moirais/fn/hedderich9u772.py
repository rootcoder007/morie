...
__all__ = ["hedderich_chapter_9_unnumbered_772"]


def hedderich_chapter_9_unnumbered_772(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: F (x)=2/πarcsin (√x)]; forp<1 andq<1,f (x) has a U-shaped course with a minimum at
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u772')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u772: GeneralStatistics expression (auto-extracted; see ref)."
