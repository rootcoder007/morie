# describe('zsste') — st_cressie_huang
...
`print(result)` render. See `moirais.fn.describe('zsste')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsste import *
import numpy as np
# See the function signature in fn/zsste.py for argument names.
```
