# describe('spsdm') — schabenberger_spatial_durbin_model
...
`print(result)` render. See `moirais.fn.describe('spsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsdm import *
import numpy as np
# See the function signature in fn/spsdm.py for argument names.
```
