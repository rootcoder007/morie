# describe('hepsa') — probabilistic_sensitivity
...
`print(result)` render. See `moirais.fn.describe('hepsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hepsa import *
import numpy as np
# See the function signature in fn/hepsa.py for argument names.
```
