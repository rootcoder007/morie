# describe('alhds') — alammar_hdbscan_cluster
...
`print(result)` render. See `moirais.fn.describe('alhds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alhds import *
import numpy as np
# See the function signature in fn/alhds.py for argument names.
```
