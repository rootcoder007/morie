# describe('hmfmap') — geron_feature_map
...
`print(result)` render. See `moirais.fn.describe('hmfmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfmap import *
import numpy as np
# See the function signature in fn/hmfmap.py for argument names.
```
