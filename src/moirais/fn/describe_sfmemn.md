...
`print(result)` render. See `moirais.fn.describe('sfmemn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfmemn import *
import numpy as np
# See the function signature in fn/sfmemn.py for argument names.
```
