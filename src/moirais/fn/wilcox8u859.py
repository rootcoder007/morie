...
__all__ = ["wilcox_chapter_8_unnumbered_859"]


def wilcox_chapter_8_unnumbered_859(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: bd1way(x, est = onestep, nboot = 599, alpha = 0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u859')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u859: Resampling expression (auto-extracted; see ref)."
