...
`print(result)` render. See `moirais.fn.describe('lacjoin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacjoin import *
import numpy as np
# See the function signature in fn/lacjoin.py for argument names.
```
