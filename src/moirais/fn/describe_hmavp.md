# describe('hmavp') — geron_average_pool
...
`print(result)` render. See `moirais.fn.describe('hmavp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmavp import *
import numpy as np
# See the function signature in fn/hmavp.py for argument names.
```
