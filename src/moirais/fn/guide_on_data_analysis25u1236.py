...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1236"]


def guide_on_data_analysis_chapter_25_unnumbered_1236(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝛽2,𝑝 = 𝐸[(y − ￿)′￿−1(x − ￿)]2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1236')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1236: GeneralStatistics expression (auto-extracted; see ref)."
