...
`print(result)` render. See `moirais.fn.describe('sbblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbblk import *
import numpy as np
# See the function signature in fn/sbblk.py for argument names.
```
