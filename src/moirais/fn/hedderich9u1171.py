...
__all__ = ["hedderich_chapter_9_unnumbered_1171"]


def hedderich_chapter_9_unnumbered_1171(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆp = 1, 95%-CI: πu = 100/(100 + 3.04) = 0.9705 = 0.97 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1171')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1171: GeneralStatistics expression (auto-extracted; see ref)."
