# describe('amwt') — am_weight_estimate
...
`print(result)` render. See `moirais.fn.describe('amwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amwt import *
import numpy as np
# See the function signature in fn/amwt.py for argument names.
```
