# describe('kvcmp') — kv_cache_compress
...
`print(result)` render. See `moirais.fn.describe('kvcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kvcmp import *
import numpy as np
# See the function signature in fn/kvcmp.py for argument names.
```
