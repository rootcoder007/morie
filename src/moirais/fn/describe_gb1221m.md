# describe('gb1221m') — gibbons_friedman_mult
...
`print(result)` render. See `moirais.fn.describe('gb1221m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1221m import *
import numpy as np
# See the function signature in fn/gb1221m.py for argument names.
```
