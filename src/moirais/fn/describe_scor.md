# describe('scor') — subscale_correlations
...
`print(result)` render. See `moirais.fn.describe('scor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scor import *
import numpy as np
# See the function signature in fn/scor.py for argument names.
```
