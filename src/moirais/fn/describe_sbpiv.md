...
`print(result)` render. See `moirais.fn.describe('sbpiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbpiv import *
import numpy as np
# See the function signature in fn/sbpiv.py for argument names.
```
