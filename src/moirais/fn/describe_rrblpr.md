...
`print(result)` render. See `moirais.fn.describe('rrblpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rrblpr import *
import numpy as np
# See the function signature in fn/rrblpr.py for argument names.
```
