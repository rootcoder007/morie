# describe('hmrdt') — geron_regression_tree
...
`print(result)` render. See `moirais.fn.describe('hmrdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrdt import *
import numpy as np
# See the function signature in fn/hmrdt.py for argument names.
```
