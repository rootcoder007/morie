# describe('dropr') — dropout_regularization
...
`print(result)` render. See `moirais.fn.describe('dropr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dropr import *
import numpy as np
# See the function signature in fn/dropr.py for argument names.
```
