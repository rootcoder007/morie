...
`print(result)` render. See `moirais.fn.describe('plgni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plgni import *
import numpy as np
# See the function signature in fn/plgni.py for argument names.
```
