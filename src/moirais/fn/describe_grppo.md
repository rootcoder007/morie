# describe('grppo') — geron_ppo_clipped_objective
...
`print(result)` render. See `moirais.fn.describe('grppo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grppo import *
import numpy as np
# See the function signature in fn/grppo.py for argument names.
```
