...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_13"]


def guide_on_data_analysis_chapter_2_unnumbered_13(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜕X = A + A′ − diag(A).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u13')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u13: GeneralStatistics expression (auto-extracted; see ref)."
