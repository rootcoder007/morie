# describe('wvar') — weighted_variance
...
`print(result)` render. See `moirais.fn.describe('wvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvar import *
import numpy as np
# See the function signature in fn/wvar.py for argument names.
```
