...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_305"]


def guide_on_data_analysis_chapter_5_unnumbered_305(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜕𝛽 [Y⊤Y − 2𝛽⊤X⊤Y + 𝛽⊤(X⊤X)𝛽] = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u305')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u305: GeneralStatistics expression (auto-extracted; see ref)."
