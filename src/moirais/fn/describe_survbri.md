...
`print(result)` render. See `moirais.fn.describe('survbri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survbri import *
import numpy as np
# See the function signature in fn/survbri.py for argument names.
```
