...
`print(result)` render. See `moirais.fn.describe('hhtrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hhtrf import *
import numpy as np
# See the function signature in fn/hhtrf.py for argument names.
```
