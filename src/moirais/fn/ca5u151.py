...
def ca_chapter_5_unnumbered_151(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u151')`` for the full guide.
...
def cheatsheet():
    return "ca5u151: GeneralStatistics expression involving 'conviction' (auto-extracted; see reference for full context)."
