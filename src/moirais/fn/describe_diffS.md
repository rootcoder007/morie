...
`print(result)` render. See `moirais.fn.describe('diffS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffS import *
import numpy as np
# See the function signature in fn/diffS.py for argument names.
```
