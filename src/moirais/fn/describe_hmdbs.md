...
`print(result)` render. See `moirais.fn.describe('hmdbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdbs import *
import numpy as np
# See the function signature in fn/hmdbs.py for argument names.
```
