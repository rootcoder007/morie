...
`print(result)` render. See `moirais.fn.describe('ctlbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctlbl import *
import numpy as np
# See the function signature in fn/ctlbl.py for argument names.
```
