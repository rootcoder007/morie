...
def ca_chapter_5_unnumbered_143(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u143')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Logistic expression involving 'category' (auto-extracted; see reference for full context)."},
    )
