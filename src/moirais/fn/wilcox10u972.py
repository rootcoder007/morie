...
__all__ = ["wilcox_chapter_10_unnumbered_972"]


def wilcox_chapter_10_unnumbered_972(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and the contrast coefficients are now c1 =c3 =c5 = 1 and c2 =c4 =c6 = −1.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u972')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u972: GeneralStatistics expression (auto-extracted; see ref)."
