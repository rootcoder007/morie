# describe('dpitst') — data_processing_inequality
...
`print(result)` render. See `moirais.fn.describe('dpitst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpitst import *
import numpy as np
# See the function signature in fn/dpitst.py for argument names.
```
