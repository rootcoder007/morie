...
`print(result)` render. See `moirais.fn.describe('swlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swlag import *
import numpy as np
# See the function signature in fn/swlag.py for argument names.
```
