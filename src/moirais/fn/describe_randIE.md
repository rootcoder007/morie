# describe('randIE') — randomized_intervention
...
`print(result)` render. See `moirais.fn.describe('randIE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.randIE import *
import numpy as np
# See the function signature in fn/randIE.py for argument names.
```
