...
`print(result)` render. See `moirais.fn.describe('expsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.expsv import *
import numpy as np
# See the function signature in fn/expsv.py for argument names.
```
