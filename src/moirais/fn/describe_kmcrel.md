# describe('kmcrel') — kamath_ragas_context_relevance
...
`print(result)` render. See `moirais.fn.describe('kmcrel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcrel import *
import numpy as np
# See the function signature in fn/kmcrel.py for argument names.
```
