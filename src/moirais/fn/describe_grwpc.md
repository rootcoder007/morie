# describe('grwpc') — geron_wordpiece_tokenizer_score
...
`print(result)` render. See `moirais.fn.describe('grwpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grwpc import *
import numpy as np
# See the function signature in fn/grwpc.py for argument names.
```
