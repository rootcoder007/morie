# describe('rng020') — rangayyan_ch3_time_averaged_acf
...
`print(result)` render. See `moirais.fn.describe('rng020')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng020 import *
import numpy as np
# See the function signature in fn/rng020.py for argument names.
```
