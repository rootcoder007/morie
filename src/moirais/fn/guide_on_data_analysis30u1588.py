...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1588"]


def guide_on_data_analysis_chapter_30_unnumbered_1588(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1588')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1588: GeneralStatistics expression (auto-extracted; see ref)."
