# describe('mispt') — missing_pattern
...
`print(result)` render. See `moirais.fn.describe('mispt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mispt import *
import numpy as np
# See the function signature in fn/mispt.py for argument names.
```
