...
__all__ = ["hedderich_chapter_9_unnumbered_3042"]


def hedderich_chapter_9_unnumbered_3042(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( nrow ( t a b )! =3 | ncol( t a b )! =3 ) { # checkdimensionoftab
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3042')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3042: GeneralStatistics expression (auto-extracted; see ref)."
