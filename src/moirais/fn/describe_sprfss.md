# describe('sprfss') — schabenberger_random_field_stationarity
...
`print(result)` render. See `moirais.fn.describe('sprfss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprfss import *
import numpy as np
# See the function signature in fn/sprfss.py for argument names.
```
