...
`print(result)` render. See `moirais.fn.describe('gb_clt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_clt import *
import numpy as np
# See the function signature in fn/gb_clt.py for argument names.
```
