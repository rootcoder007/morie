...
def ca_chapter_8_unnumbered_289(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8u289')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "MetaAnalysis expression involving 'critical' (auto-extracted; see reference for full context)."},
    )
