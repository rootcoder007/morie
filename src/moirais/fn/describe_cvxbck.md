# describe('cvxbck') — boyd_backtracking
...
`print(result)` render. See `moirais.fn.describe('cvxbck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxbck import *
import numpy as np
# See the function signature in fn/cvxbck.py for argument names.
```
