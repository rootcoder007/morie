...
`print(result)` render. See `moirais.fn.describe('csthf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csthf import *
import numpy as np
# See the function signature in fn/csthf.py for argument names.
```
