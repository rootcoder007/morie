...
`print(result)` render. See `moirais.fn.describe('lwe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lwe import *
import numpy as np
# See the function signature in fn/lwe.py for argument names.
```
