# describe('rng133') — rangayyan_ch3_butterworth_lowpass_direct_specification
...
`print(result)` render. See `moirais.fn.describe('rng133')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng133 import *
import numpy as np
# See the function signature in fn/rng133.py for argument names.
```
