...
`print(result)` render. See `moirais.fn.describe('smltrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smltrt import *
import numpy as np
# See the function signature in fn/smltrt.py for argument names.
```
