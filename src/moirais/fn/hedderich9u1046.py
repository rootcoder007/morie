...
__all__ = ["hedderich_chapter_9_unnumbered_1046"]


def hedderich_chapter_9_unnumbered_1046(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X =xi|Y =yj) = P (xi,y j)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1046')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1046: GeneralStatistics expression (auto-extracted; see ref)."
