# describe('gb1121') — gibbons_kendall_tau
...
`print(result)` render. See `moirais.fn.describe('gb1121')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1121 import *
import numpy as np
# See the function signature in fn/gb1121.py for argument names.
```
