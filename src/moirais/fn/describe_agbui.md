...
`print(result)` render. See `moirais.fn.describe('agbui')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbui import *
import numpy as np
# See the function signature in fn/agbui.py for argument names.
```
