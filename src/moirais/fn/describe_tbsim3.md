...
`print(result)` render. See `moirais.fn.describe('tbsim3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbsim3 import *
import numpy as np
# See the function signature in fn/tbsim3.py for argument names.
```
