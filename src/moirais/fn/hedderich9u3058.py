...
__all__ = ["hedderich_chapter_9_unnumbered_3058"]


def hedderich_chapter_9_unnumbered_3058(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the desired confidence interval: 95%-CI: 0.176π̄A−πB≤0.375 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3058')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3058: GeneralStatistics expression (auto-extracted; see ref)."
