# describe('dormm') — recurrence_quantification
...
`print(result)` render. See `moirais.fn.describe('dormm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dormm import *
import numpy as np
# See the function signature in fn/dormm.py for argument names.
```
