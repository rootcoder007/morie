...
`print(result)` render. See `moirais.fn.describe('chirg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chirg import *
import numpy as np
# See the function signature in fn/chirg.py for argument names.
```
