...
`print(result)` render. See `moirais.fn.describe('profl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.profl import *
import numpy as np
# See the function signature in fn/profl.py for argument names.
```
