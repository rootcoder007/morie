# describe('rcprd') — predicted_choice
...
`print(result)` render. See `moirais.fn.describe('rcprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcprd import *
import numpy as np
# See the function signature in fn/rcprd.py for argument names.
```
