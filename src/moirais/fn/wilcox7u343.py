...
__all__ = ["wilcox_chapter_7_unnumbered_343"]


def wilcox_chapter_7_unnumbered_343(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: s/ √ n = 22.4 − 26.4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u343')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u343: GeneralStatistics expression (auto-extracted; see ref)."
