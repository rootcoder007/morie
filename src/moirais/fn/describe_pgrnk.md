...
`print(result)` render. See `moirais.fn.describe('pgrnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgrnk import *
import numpy as np
# See the function signature in fn/pgrnk.py for argument names.
```
