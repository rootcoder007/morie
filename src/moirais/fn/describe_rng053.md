# describe('rng053') — rangayyan_ch3_z_transform_fir
...
`print(result)` render. See `moirais.fn.describe('rng053')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng053 import *
import numpy as np
# See the function signature in fn/rng053.py for argument names.
```
