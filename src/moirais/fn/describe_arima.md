...
`print(result)` render. See `moirais.fn.describe('arima')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arima import *
import numpy as np
# See the function signature in fn/arima.py for argument names.
```
