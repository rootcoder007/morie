...
`print(result)` render. See `moirais.fn.describe('nmead')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmead import *
import numpy as np
# See the function signature in fn/nmead.py for argument names.
```
