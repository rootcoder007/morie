...
`print(result)` render. See `moirais.fn.describe('dk3sm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3sm import *
import numpy as np
# See the function signature in fn/dk3sm.py for argument names.
```
