# describe('causivlim') — causal_iv_liml
...
`print(result)` render. See `moirais.fn.describe('causivlim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causivlim import *
import numpy as np
# See the function signature in fn/causivlim.py for argument names.
```
