# describe('sntmod') — sequential_target_models
...
`print(result)` render. See `moirais.fn.describe('sntmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntmod import *
import numpy as np
# See the function signature in fn/sntmod.py for argument names.
```
