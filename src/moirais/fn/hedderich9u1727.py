...
__all__ = ["hedderich_chapter_9_unnumbered_1727"]


def hedderich_chapter_9_unnumbered_1727(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.82/√n 0.86/√n 0.87/√n 0.90/√n 0.93/√n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1727')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1727: GeneralStatistics expression (auto-extracted; see ref)."
