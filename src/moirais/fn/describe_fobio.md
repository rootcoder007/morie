...
`print(result)` render. See `moirais.fn.describe('fobio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fobio import *
import numpy as np
# See the function signature in fn/fobio.py for argument names.
```
