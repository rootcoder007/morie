# describe('msm155') — mvsml_categorical_count_eq_8_12
...
`print(result)` render. See `moirais.fn.describe('msm155')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm155 import *
import numpy as np
# See the function signature in fn/msm155.py for argument names.
```
