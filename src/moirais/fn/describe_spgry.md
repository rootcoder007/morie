# describe('spgry') — schabenberger_geary_c
...
`print(result)` render. See `moirais.fn.describe('spgry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgry import *
import numpy as np
# See the function signature in fn/spgry.py for argument names.
```
