...
`print(result)` render. See `moirais.fn.describe('chlsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlsmp import *
import numpy as np
# See the function signature in fn/chlsmp.py for argument names.
```
