...
`print(result)` render. See `moirais.fn.describe('vtlgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtlgr import *
import numpy as np
# See the function signature in fn/vtlgr.py for argument names.
```
