# describe('msm003') — mvsml_general_eq_1_3
...
`print(result)` render. See `moirais.fn.describe('msm003')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm003 import *
import numpy as np
# See the function signature in fn/msm003.py for argument names.
```
