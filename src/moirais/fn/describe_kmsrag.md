# describe('kmsrag') — kamath_self_rag
...
`print(result)` render. See `moirais.fn.describe('kmsrag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmsrag import *
import numpy as np
# See the function signature in fn/kmsrag.py for argument names.
```
