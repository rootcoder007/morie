# describe('gb_jcd') — gibbons_jt_cd_form
...
`print(result)` render. See `moirais.fn.describe('gb_jcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_jcd import *
import numpy as np
# See the function signature in fn/gb_jcd.py for argument names.
```
