...
`print(result)` render. See `moirais.fn.describe('gammfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gammfn import *
import numpy as np
# See the function signature in fn/gammfn.py for argument names.
```
