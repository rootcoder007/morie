# describe('gb1241') — gibbons_concordance_w
...
`print(result)` render. See `moirais.fn.describe('gb1241')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1241 import *
import numpy as np
# See the function signature in fn/gb1241.py for argument names.
```
