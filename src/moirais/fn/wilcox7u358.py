...
__all__ = ["wilcox_chapter_7_unnumbered_358"]


def wilcox_chapter_7_unnumbered_358(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: P (T ≤ − 6) is estimated to be 0.025. In a similar manner, T(975) = 1.44 estimates the 0.975
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u358')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u358: GeneralStatistics expression (auto-extracted; see ref)."
