# describe('agmurc') — muzero_recurrent_inf
...
`print(result)` render. See `moirais.fn.describe('agmurc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmurc import *
import numpy as np
# See the function signature in fn/agmurc.py for argument names.
```
