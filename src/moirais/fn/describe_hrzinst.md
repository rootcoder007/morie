# describe('hrzinst') — horowitz_instruments_transformation
...
`print(result)` render. See `moirais.fn.describe('hrzinst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzinst import *
import numpy as np
# See the function signature in fn/hrzinst.py for argument names.
```
