...
__all__ = ["wilcox_chapter_2_unnumbered_292"]


def wilcox_chapter_2_unnumbered_292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: T distribution with ν =n − 1 degrees of freedom. Equivalently, reject if |T | ≥ c.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u292')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u292: GeneralStatistics expression (auto-extracted; see ref)."
