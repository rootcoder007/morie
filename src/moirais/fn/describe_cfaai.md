...
`print(result)` render. See `moirais.fn.describe('cfaai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfaai import *
import numpy as np
# See the function signature in fn/cfaai.py for argument names.
```
