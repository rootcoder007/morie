...
__all__ = ["hedderich_chapter_9_unnumbered_3227"]


def hedderich_chapter_9_unnumbered_3227(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: IfH0:β1 =β2 is rejected, it may be interesting to determine theintersection point of both lines:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3227')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3227: GeneralStatistics expression (auto-extracted; see ref)."
