...
`print(result)` render. See `moirais.fn.describe('dkkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkkrg import *
import numpy as np
# See the function signature in fn/dkkrg.py for argument names.
```
