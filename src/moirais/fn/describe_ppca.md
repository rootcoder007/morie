# describe('ppca') — probabilistic_pca
...
`print(result)` render. See `moirais.fn.describe('ppca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppca import *
import numpy as np
# See the function signature in fn/ppca.py for argument names.
```
