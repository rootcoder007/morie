# describe('msm247') — mvsml_reproducing_kernel_eq_10_6
...
`print(result)` render. See `moirais.fn.describe('msm247')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm247 import *
import numpy as np
# See the function signature in fn/msm247.py for argument names.
```
