# describe('bferg') — ferguson_bayesian_bootstrap
...
`print(result)` render. See `moirais.fn.describe('bferg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bferg import *
import numpy as np
# See the function signature in fn/bferg.py for argument names.
```
