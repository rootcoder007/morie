# describe('svcle') — coalition_equil
...
`print(result)` render. See `moirais.fn.describe('svcle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcle import *
import numpy as np
# See the function signature in fn/svcle.py for argument names.
```
