# describe('gh_iid_consist') — ghosal_iid_posterior_consistency
...
`print(result)` render. See `moirais.fn.describe('gh_iid_consist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_iid_consist import *
import numpy as np
# See the function signature in fn/gh_iid_consist.py for argument names.
```
