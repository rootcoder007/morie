# describe('netcms') — network_psychometrics
...
`print(result)` render. See `moirais.fn.describe('netcms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcms import *
import numpy as np
# See the function signature in fn/netcms.py for argument names.
```
