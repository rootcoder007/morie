...
__all__ = ["hedderich_chapter_9_unnumbered_490"]


def hedderich_chapter_9_unnumbered_490(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Youden Index: J =P (T +|K) +P (T−|¯K)−1 = Sensitivity + Specificity−1 (4.45)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u490')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u490: GeneralStatistics expression (auto-extracted; see ref)."
