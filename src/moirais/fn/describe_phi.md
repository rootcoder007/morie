...
`print(result)` render. See `moirais.fn.describe('phi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phi import *
import numpy as np
# See the function signature in fn/phi.py for argument names.
```
