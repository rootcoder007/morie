...
`print(result)` render. See `moirais.fn.describe('levdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.levdis import *
import numpy as np
# See the function signature in fn/levdis.py for argument names.
```
