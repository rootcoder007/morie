# describe('okrig') — ordinary_kriging
...
`print(result)` render. See `moirais.fn.describe('okrig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.okrig import *
import numpy as np
# See the function signature in fn/okrig.py for argument names.
```
