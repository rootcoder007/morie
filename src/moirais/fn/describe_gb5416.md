# describe('gb5416') — gibbons_sign_sampsize
...
`print(result)` render. See `moirais.fn.describe('gb5416')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5416 import *
import numpy as np
# See the function signature in fn/gb5416.py for argument names.
```
