...
`print(result)` render. See `moirais.fn.describe('hmbrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbrob import *
import numpy as np
# See the function signature in fn/hmbrob.py for argument names.
```
