# describe('sgint') — intensity_estimate
...
`print(result)` render. See `moirais.fn.describe('sgint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgint import *
import numpy as np
# See the function signature in fn/sgint.py for argument names.
```
