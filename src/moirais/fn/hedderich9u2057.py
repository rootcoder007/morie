...
__all__ = ["hedderich_chapter_9_unnumbered_2057"]


def hedderich_chapter_9_unnumbered_2057(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n (tν;1−α +tν;1−β) (7.110)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2057')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2057: PowerAndDesign expression (auto-extracted; see ref)."
