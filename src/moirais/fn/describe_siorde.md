# describe('siorde') — siorde

## WHAT IT DOES

SIS order relation correction.
...
`print(result)` render. See `moirais.fn.describe('siorde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siorde import *
import numpy as np
# See the function signature in fn/siorde.py for argument names.
```
