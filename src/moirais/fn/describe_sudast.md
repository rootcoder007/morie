...
`print(result)` render. See `moirais.fn.describe('sudast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sudast import *
import numpy as np
# See the function signature in fn/sudast.py for argument names.
```
