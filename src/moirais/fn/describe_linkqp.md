# describe('linkqp') — linking_stocking_lord
...
`print(result)` render. See `moirais.fn.describe('linkqp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linkqp import *
import numpy as np
# See the function signature in fn/linkqp.py for argument names.
```
