# describe('msm299') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm299')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm299 import *
import numpy as np
# See the function signature in fn/msm299.py for argument names.
```
