# describe('hmtsf') — geron_time_series_forecast
...
`print(result)` render. See `moirais.fn.describe('hmtsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtsf import *
import numpy as np
# See the function signature in fn/hmtsf.py for argument names.
```
