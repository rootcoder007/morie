...
`print(result)` render. See `moirais.fn.describe('plcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcnt import *
import numpy as np
# See the function signature in fn/plcnt.py for argument names.
```
