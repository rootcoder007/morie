# describe('elnet') — _soft_threshold

## WHAT IT DOES

Elastic net regression. 'The whole is greater than the sum of its parts. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('elnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elnet import *
import numpy as np
# See the function signature in fn/elnet.py for argument names.
```
