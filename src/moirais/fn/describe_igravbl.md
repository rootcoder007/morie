...
`print(result)` render. See `moirais.fn.describe('igravbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravbl import *
import numpy as np
# See the function signature in fn/igravbl.py for argument names.
```
