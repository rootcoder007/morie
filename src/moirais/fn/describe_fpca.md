...
`print(result)` render. See `moirais.fn.describe('fpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fpca import *
import numpy as np
# See the function signature in fn/fpca.py for argument names.
```
