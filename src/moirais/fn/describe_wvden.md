# describe('wvden') — _daubechies_filter
...
`print(result)` render. See `moirais.fn.describe('wvden')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvden import *
import numpy as np
# See the function signature in fn/wvden.py for argument names.
```
