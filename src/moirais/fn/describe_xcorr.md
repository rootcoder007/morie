# describe('xcorr') — cross_correlation
...
`print(result)` render. See `moirais.fn.describe('xcorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xcorr import *
import numpy as np
# See the function signature in fn/xcorr.py for argument names.
```
