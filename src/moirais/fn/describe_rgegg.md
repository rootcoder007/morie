...
`print(result)` render. See `moirais.fn.describe('rgegg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgegg import *
import numpy as np
# See the function signature in fn/rgegg.py for argument names.
```
