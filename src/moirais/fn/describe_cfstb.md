...
`print(result)` render. See `moirais.fn.describe('cfstb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfstb import *
import numpy as np
# See the function signature in fn/cfstb.py for argument names.
```
