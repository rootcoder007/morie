...
__all__ = ["hedderich_chapter_9_unnumbered_2820"]


def hedderich_chapter_9_unnumbered_2820(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + CHIefm <− sum ( S ) ; pval 2 <− pchisq ( CHIefm , df =1 , lower . tail =F )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2820')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2820: GeneralStatistics expression (auto-extracted; see ref)."
