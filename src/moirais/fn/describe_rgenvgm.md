# describe('rgenvgm') — rangayyan_envelogram
...
`print(result)` render. See `moirais.fn.describe('rgenvgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgenvgm import *
import numpy as np
# See the function signature in fn/rgenvgm.py for argument names.
```
