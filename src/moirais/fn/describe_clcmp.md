# describe('clcmp') — clcmp

## WHAT IT DOES

Compound spatial clustering
...
`print(result)` render. See `moirais.fn.describe('clcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcmp import *
import numpy as np
# See the function signature in fn/clcmp.py for argument names.
```
