# describe('tmlcps') — tmle_continuous_treatment
...
`print(result)` render. See `moirais.fn.describe('tmlcps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcps import *
import numpy as np
# See the function signature in fn/tmlcps.py for argument names.
```
