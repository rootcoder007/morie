...
`print(result)` render. See `moirais.fn.describe('saelm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saelm import *
import numpy as np
# See the function signature in fn/saelm.py for argument names.
```
