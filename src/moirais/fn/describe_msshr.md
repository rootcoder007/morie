...
`print(result)` render. See `moirais.fn.describe('msshr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msshr import *
import numpy as np
# See the function signature in fn/msshr.py for argument names.
```
