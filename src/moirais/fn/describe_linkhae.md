# describe('linkhae') — linking_haebara
...
`print(result)` render. See `moirais.fn.describe('linkhae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linkhae import *
import numpy as np
# See the function signature in fn/linkhae.py for argument names.
```
