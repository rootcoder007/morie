...
`print(result)` render. See `moirais.fn.describe('noidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.noidx import *
import numpy as np
# See the function signature in fn/noidx.py for argument names.
```
