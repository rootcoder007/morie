# describe('bbdim') — bb_dimensionality_select
...
`print(result)` render. See `moirais.fn.describe('bbdim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbdim import *
import numpy as np
# See the function signature in fn/bbdim.py for argument names.
```
