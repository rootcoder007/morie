# describe('bnseff') — bound_efficient
...
`print(result)` render. See `moirais.fn.describe('bnseff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnseff import *
import numpy as np
# See the function signature in fn/bnseff.py for argument names.
```
