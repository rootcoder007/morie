...
`print(result)` render. See `moirais.fn.describe('trent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trent import *
import numpy as np
# See the function signature in fn/trent.py for argument names.
```
