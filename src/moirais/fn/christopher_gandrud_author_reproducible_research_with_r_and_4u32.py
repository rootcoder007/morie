...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_32(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ```{r}, echo=FALSE, message=FALSE, results='asis'}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('Confine yourself to the present. — Marcus Aurelius')`` for the full guide.
