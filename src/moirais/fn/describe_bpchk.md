# describe('bpchk') — posterior_predictive_check
...
`print(result)` render. See `moirais.fn.describe('bpchk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpchk import *
import numpy as np
# See the function signature in fn/bpchk.py for argument names.
```
