...
`print(result)` render. See `moirais.fn.describe('ckflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ckflm import *
import numpy as np
# See the function signature in fn/ckflm.py for argument names.
```
