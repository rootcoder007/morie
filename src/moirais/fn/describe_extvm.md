# describe('extvm') — extreme_value_gev
...
`print(result)` render. See `moirais.fn.describe('extvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.extvm import *
import numpy as np
# See the function signature in fn/extvm.py for argument names.
```
