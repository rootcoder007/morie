# describe('eslsmp') — esl_subsampling
...
`print(result)` render. See `moirais.fn.describe('eslsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsmp import *
import numpy as np
# See the function signature in fn/eslsmp.py for argument names.
```
