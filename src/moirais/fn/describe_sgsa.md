# describe('sgsa') — simulated_annealing_spatial
...
`print(result)` render. See `moirais.fn.describe('sgsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsa import *
import numpy as np
# See the function signature in fn/sgsa.py for argument names.
```
