...
`print(result)` render. See `moirais.fn.describe('cmunn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmunn import *
import numpy as np
# See the function signature in fn/cmunn.py for argument names.
```
