...
__all__ = ["wilcox_chapter_13_unnumbered_1217"]


def wilcox_chapter_13_unnumbered_1217(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: kercon(x, y, pyhat = FALSE, cval = NA, plotit = TRUE, eout = FALSE, xout =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1217')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1217: GeneralStatistics expression (auto-extracted; see ref)."
