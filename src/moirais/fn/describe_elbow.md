...
`print(result)` render. See `moirais.fn.describe('elbow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elbow import *
import numpy as np
# See the function signature in fn/elbow.py for argument names.
```
