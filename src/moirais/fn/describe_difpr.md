# describe('difpr') — dif_purification
...
`print(result)` render. See `moirais.fn.describe('difpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difpr import *
import numpy as np
# See the function signature in fn/difpr.py for argument names.
```
