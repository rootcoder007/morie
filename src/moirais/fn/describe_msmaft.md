# describe('msmaft') — msm_accelerated_failure
...
`print(result)` render. See `moirais.fn.describe('msmaft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmaft import *
import numpy as np
# See the function signature in fn/msmaft.py for argument names.
```
