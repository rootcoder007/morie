...
`print(result)` render. See `moirais.fn.describe('mrtsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrtsq import *
import numpy as np
# See the function signature in fn/mrtsq.py for argument names.
```
