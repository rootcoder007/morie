...
`print(result)` render. See `moirais.fn.describe('opbat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opbat import *
import numpy as np
# See the function signature in fn/opbat.py for argument names.
```
