...
__all__ = ["wilcox_chapter_13_unnumbered_1214"]


def wilcox_chapter_13_unnumbered_1214(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1 +β 2X2 +e, this
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1214')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1214: GeneralStatistics expression (auto-extracted; see ref)."
