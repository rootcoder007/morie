# describe('btht') — boot_test_hypothesis
...
`print(result)` render. See `moirais.fn.describe('btht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btht import *
import numpy as np
# See the function signature in fn/btht.py for argument names.
```
