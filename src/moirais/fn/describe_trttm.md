...
`print(result)` render. See `moirais.fn.describe('trttm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trttm import *
import numpy as np
# See the function signature in fn/trttm.py for argument names.
```
