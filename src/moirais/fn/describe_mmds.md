...
`print(result)` render. See `moirais.fn.describe('mmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmds import *
import numpy as np
# See the function signature in fn/mmds.py for argument names.
```
