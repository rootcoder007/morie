...
`print(result)` render. See `moirais.fn.describe('fstfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fstfr import *
import numpy as np
# See the function signature in fn/fstfr.py for argument names.
```
