# describe('esllar') — esl_least_angle_reg
...
`print(result)` render. See `moirais.fn.describe('esllar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllar import *
import numpy as np
# See the function signature in fn/esllar.py for argument names.
```
