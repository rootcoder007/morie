...
`print(result)` render. See `moirais.fn.describe('holo_i')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_i import *
import numpy as np
# See the function signature in fn/holo_i.py for argument names.
```
