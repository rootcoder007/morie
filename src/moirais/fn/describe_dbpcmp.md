# describe('dbpcmp') — dbp_compliance
...
`print(result)` render. See `moirais.fn.describe('dbpcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbpcmp import *
import numpy as np
# See the function signature in fn/dbpcmp.py for argument names.
```
