# describe('gb971') — gibbons_sukhatme
...
`print(result)` render. See `moirais.fn.describe('gb971')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb971 import *
import numpy as np
# See the function signature in fn/gb971.py for argument names.
```
