...
`print(result)` render. See `moirais.fn.describe('mtlog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtlog import *
import numpy as np
# See the function signature in fn/mtlog.py for argument names.
```
