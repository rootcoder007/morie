...
`print(result)` render. See `moirais.fn.describe('sawnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawnb import *
import numpy as np
# See the function signature in fn/sawnb.py for argument names.
```
