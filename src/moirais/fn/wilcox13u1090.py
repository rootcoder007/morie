...
__all__ = ["wilcox_chapter_13_unnumbered_1090"]


def wilcox_chapter_13_unnumbered_1090(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: as the LMS estimator is achieved. However, h = [n/2] + [( p + 1)/2] is often used for technical
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1090')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1090: GeneralStatistics expression (auto-extracted; see ref)."
