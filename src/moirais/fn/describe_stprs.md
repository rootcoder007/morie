...
`print(result)` render. See `moirais.fn.describe('stprs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stprs import *
import numpy as np
# See the function signature in fn/stprs.py for argument names.
```
