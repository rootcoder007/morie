# describe('kmstgn') — kamath_summarize_from_feedback
...
`print(result)` render. See `moirais.fn.describe('kmstgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmstgn import *
import numpy as np
# See the function signature in fn/kmstgn.py for argument names.
```
