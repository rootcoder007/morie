...
`print(result)` render. See `moirais.fn.describe('stkse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkse import *
import numpy as np
# See the function signature in fn/stkse.py for argument names.
```
