...
`print(result)` render. See `moirais.fn.describe('adseqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adseqs import *
import numpy as np
# See the function signature in fn/adseqs.py for argument names.
```
