...
`print(result)` render. See `moirais.fn.describe('limmav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.limmav import *
import numpy as np
# See the function signature in fn/limmav.py for argument names.
```
