# describe('gh_c10_5') — ghosal_wn_adapt
...
`print(result)` render. See `moirais.fn.describe('gh_c10_5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c10_5 import *
import numpy as np
# See the function signature in fn/gh_c10_5.py for argument names.
```
