...
`print(result)` render. See `moirais.fn.describe('vdarea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdarea import *
import numpy as np
# See the function signature in fn/vdarea.py for argument names.
```
