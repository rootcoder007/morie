# describe('jotft') — joseph_temporal_fusion_transformer
...
`print(result)` render. See `moirais.fn.describe('jotft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jotft import *
import numpy as np
# See the function signature in fn/jotft.py for argument names.
```
