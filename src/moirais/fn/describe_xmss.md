...
`print(result)` render. See `moirais.fn.describe('xmss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xmss import *
import numpy as np
# See the function signature in fn/xmss.py for argument names.
```
