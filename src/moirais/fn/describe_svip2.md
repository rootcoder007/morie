...
`print(result)` render. See `moirais.fn.describe('svip2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svip2 import *
import numpy as np
# See the function signature in fn/svip2.py for argument names.
```
