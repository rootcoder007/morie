...
`print(result)` render. See `moirais.fn.describe('lrinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrinf import *
import numpy as np
# See the function signature in fn/lrinf.py for argument names.
```
