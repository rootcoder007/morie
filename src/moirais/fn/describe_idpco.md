...
`print(result)` render. See `moirais.fn.describe('idpco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpco import *
import numpy as np
# See the function signature in fn/idpco.py for argument names.
```
