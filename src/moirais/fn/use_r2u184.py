...
__all__ = ["use_r_chapter_2_unnumbered_184"]


def use_r_chapter_2_unnumbered_184(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u184')`` for the full guide.
...
def cheatsheet():
    return "use_r2u184: GeneralStatistics expression (auto-extracted; see ref)."
