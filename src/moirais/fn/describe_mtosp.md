# describe('mtosp') — mto_speed_analysis
...
`print(result)` render. See `moirais.fn.describe('mtosp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtosp import *
import numpy as np
# See the function signature in fn/mtosp.py for argument names.
```
