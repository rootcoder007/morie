# describe('spcplt') — plot_spectrum_fn
...
`print(result)` render. See `moirais.fn.describe('spcplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcplt import *
import numpy as np
# See the function signature in fn/spcplt.py for argument names.
```
