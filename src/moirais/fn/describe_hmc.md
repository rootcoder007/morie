...
`print(result)` render. See `moirais.fn.describe('hmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmc import *
import numpy as np
# See the function signature in fn/hmc.py for argument names.
```
