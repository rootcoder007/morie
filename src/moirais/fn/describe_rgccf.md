...
`print(result)` render. See `moirais.fn.describe('rgccf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgccf import *
import numpy as np
# See the function signature in fn/rgccf.py for argument names.
```
