...
__all__ = ["hedderich_chapter_9_unnumbered_2188"]


def hedderich_chapter_9_unnumbered_2188(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [(−0.13) + (0.06)]/2 =−0.035 (0 .09 + 0.03)/2 = 0.06
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2188')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2188: GeneralStatistics expression (auto-extracted; see ref)."
