...
`print(result)` render. See `moirais.fn.describe('adfrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adfrr import *
import numpy as np
# See the function signature in fn/adfrr.py for argument names.
```
