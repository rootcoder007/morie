...
__all__ = ["wilcox_chapter_10_unnumbered_997"]


def wilcox_chapter_10_unnumbered_997(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: rimul(J,K,x,alpha=0.05,p=J*K,grp=c(1:p))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u997')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u997: PowerAndDesign expression (auto-extracted; see ref)."
