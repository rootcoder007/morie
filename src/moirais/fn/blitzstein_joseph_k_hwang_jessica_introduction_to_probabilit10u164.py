...
__all__ = ["blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_10_unnumbered_164"]
...
def blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_10_unnumbered_164(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u164')`` for the full guide.
...
def cheatsheet():
    return "blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u164: GeneralStatistics expression (auto-extracted; see ref)."
