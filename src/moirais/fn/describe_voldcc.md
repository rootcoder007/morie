...
`print(result)` render. See `moirais.fn.describe('voldcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voldcc import *
import numpy as np
# See the function signature in fn/voldcc.py for argument names.
```
