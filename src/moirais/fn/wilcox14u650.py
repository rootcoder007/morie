...
__all__ = ["wilcox_chapter_14_unnumbered_650"]


def wilcox_chapter_14_unnumbered_650(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: lband(x,y=NA,alpha=0.05,plotit=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u650')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u650: PowerAndDesign expression (auto-extracted; see ref)."
