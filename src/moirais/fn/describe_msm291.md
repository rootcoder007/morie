# describe('msm291') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm291')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm291 import *
import numpy as np
# See the function signature in fn/msm291.py for argument names.
```
