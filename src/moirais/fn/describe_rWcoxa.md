...
`print(result)` render. See `moirais.fn.describe('rWcoxa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rWcoxa import *
import numpy as np
# See the function signature in fn/rWcoxa.py for argument names.
```
