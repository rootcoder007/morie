# describe('detfdt') — detrended_fluctuation
...
`print(result)` render. See `moirais.fn.describe('detfdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.detfdt import *
import numpy as np
# See the function signature in fn/detfdt.py for argument names.
```
