...
`print(result)` render. See `moirais.fn.describe('bullt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bullt import *
import numpy as np
# See the function signature in fn/bullt.py for argument names.
```
