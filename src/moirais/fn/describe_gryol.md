# describe('gryol') — geron_yolo_grid_loss
...
`print(result)` render. See `moirais.fn.describe('gryol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gryol import *
import numpy as np
# See the function signature in fn/gryol.py for argument names.
```
