...
`print(result)` render. See `moirais.fn.describe('umadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umadp import *
import numpy as np
# See the function signature in fn/umadp.py for argument names.
```
