# describe('km058') — kamath_ch4_lora_forward
...
`print(result)` render. See `moirais.fn.describe('km058')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km058 import *
import numpy as np
# See the function signature in fn/km058.py for argument names.
```
