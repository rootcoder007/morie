...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_807"]


def guide_on_data_analysis_chapter_11_unnumbered_807(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑇𝑖𝑗𝑐𝑡 = 𝛼0 + 𝑆𝑗𝑐𝑡𝛼1 + 𝑋𝑖𝑗𝑐𝑡𝛼2 + 𝑢𝑖𝑗𝑐𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u807')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u807: GeneralStatistics expression (auto-extracted; see ref)."
