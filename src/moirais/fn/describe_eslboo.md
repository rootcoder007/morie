# describe('eslboo') — esl_bootstrap_err
...
`print(result)` render. See `moirais.fn.describe('eslboo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslboo import *
import numpy as np
# See the function signature in fn/eslboo.py for argument names.
```
