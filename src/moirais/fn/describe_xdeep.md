...
`print(result)` render. See `moirais.fn.describe('xdeep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xdeep import *
import numpy as np
# See the function signature in fn/xdeep.py for argument names.
```
