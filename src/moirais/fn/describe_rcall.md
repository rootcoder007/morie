# describe('rcall') — roll_call_analysis
...
`print(result)` render. See `moirais.fn.describe('rcall')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcall import *
import numpy as np
# See the function signature in fn/rcall.py for argument names.
```
