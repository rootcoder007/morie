# describe('varimp') — var_impulse_response
...
`print(result)` render. See `moirais.fn.describe('varimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varimp import *
import numpy as np
# See the function signature in fn/varimp.py for argument names.
```
