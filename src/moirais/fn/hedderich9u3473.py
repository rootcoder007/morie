...
__all__ = ["hedderich_chapter_9_unnumbered_3473"]


def hedderich_chapter_9_unnumbered_3473(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: log ˆθij(k) = ˆλXY
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3473')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3473: GeneralStatistics expression (auto-extracted; see ref)."
