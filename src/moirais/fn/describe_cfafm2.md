# describe('cfafm2') — cfa_multifactor
...
`print(result)` render. See `moirais.fn.describe('cfafm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfafm2 import *
import numpy as np
# See the function signature in fn/cfafm2.py for argument names.
```
