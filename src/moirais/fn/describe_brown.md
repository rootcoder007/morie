...
`print(result)` render. See `moirais.fn.describe('brown')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brown import *
import numpy as np
# See the function signature in fn/brown.py for argument names.
```
