# describe('bbin') — bayesian_binomial
...
`print(result)` render. See `moirais.fn.describe('bbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbin import *
import numpy as np
# See the function signature in fn/bbin.py for argument names.
```
