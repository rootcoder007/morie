# describe('mwght') — molecular_weight
...
`print(result)` render. See `moirais.fn.describe('mwght')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mwght import *
import numpy as np
# See the function signature in fn/mwght.py for argument names.
```
