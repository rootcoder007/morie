# describe('spsarml') — schabenberger_sar_ml
...
`print(result)` render. See `moirais.fn.describe('spsarml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsarml import *
import numpy as np
# See the function signature in fn/spsarml.py for argument names.
```
