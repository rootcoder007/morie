# describe('km091') — kamath_ch6_demographic_representation
...
`print(result)` render. See `moirais.fn.describe('km091')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km091 import *
import numpy as np
# See the function signature in fn/km091.py for argument names.
```
