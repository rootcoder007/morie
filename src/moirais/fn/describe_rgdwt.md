...
`print(result)` render. See `moirais.fn.describe('rgdwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdwt import *
import numpy as np
# See the function signature in fn/rgdwt.py for argument names.
```
