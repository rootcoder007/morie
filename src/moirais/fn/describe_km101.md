# describe('km101') — kamath_ch6_toxic_fraction
...
`print(result)` render. See `moirais.fn.describe('km101')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km101 import *
import numpy as np
# See the function signature in fn/km101.py for argument names.
```
