...
`print(result)` render. See `moirais.fn.describe('forsnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forsnp import *
import numpy as np
# See the function signature in fn/forsnp.py for argument names.
```
