# describe('strmkr') — strauss_process
...
`print(result)` render. See `moirais.fn.describe('strmkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strmkr import *
import numpy as np
# See the function signature in fn/strmkr.py for argument names.
```
