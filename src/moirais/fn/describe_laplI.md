# describe('laplI') — inverse_laplace
...
`print(result)` render. See `moirais.fn.describe('laplI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laplI import *
import numpy as np
# See the function signature in fn/laplI.py for argument names.
```
