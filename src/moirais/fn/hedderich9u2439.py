...
__all__ = ["hedderich_chapter_9_unnumbered_2439"]


def hedderich_chapter_9_unnumbered_2439(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |¯xA−¯xB|= 15·10 + 5·9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2439')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2439: GeneralStatistics expression (auto-extracted; see ref)."
