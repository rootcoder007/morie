...
`print(result)` render. See `moirais.fn.describe('bocpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bocpd import *
import numpy as np
# See the function signature in fn/bocpd.py for argument names.
```
