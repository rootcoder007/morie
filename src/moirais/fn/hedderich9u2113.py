...
__all__ = ["hedderich_chapter_9_unnumbered_2113"]


def hedderich_chapter_9_unnumbered_2113(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] R2 =U1 + n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2113')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2113: PowerAndDesign expression (auto-extracted; see ref)."
