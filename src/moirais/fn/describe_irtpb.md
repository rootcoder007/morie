# describe('irtpb') — irt_probability
...
`print(result)` render. See `moirais.fn.describe('irtpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtpb import *
import numpy as np
# See the function signature in fn/irtpb.py for argument names.
```
