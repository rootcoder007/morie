# describe('ca1u12') — ca_chapter_1_unnumbered_12
...
E logit π() j x() = β0 + β1x1, Equation 1 :4
...
```python
from moirais.fn.ca1u12 import ca_chapter_1_unnumbered_12
import numpy as np
result = ca_chapter_1_unnumbered_12(np.random.default_rng(42).normal(0, 1, 100))
