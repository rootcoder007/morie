...
`print(result)` render. See `moirais.fn.describe('msstb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msstb import *
import numpy as np
# See the function signature in fn/msstb.py for argument names.
```
