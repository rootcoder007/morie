...
`print(result)` render. See `moirais.fn.describe('hydsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydsl import *
import numpy as np
# See the function signature in fn/hydsl.py for argument names.
```
