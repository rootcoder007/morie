...
`print(result)` render. See `moirais.fn.describe('msalc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msalc import *
import numpy as np
# See the function signature in fn/msalc.py for argument names.
```
