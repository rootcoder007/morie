...
`print(result)` render. See `moirais.fn.describe('maben')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maben import *
import numpy as np
# See the function signature in fn/maben.py for argument names.
```
