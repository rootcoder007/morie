...
`print(result)` render. See `moirais.fn.describe('cliffs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cliffs import *
import numpy as np
# See the function signature in fn/cliffs.py for argument names.
```
