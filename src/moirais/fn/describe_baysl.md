...
`print(result)` render. See `moirais.fn.describe('baysl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysl import *
import numpy as np
# See the function signature in fn/baysl.py for argument names.
```
