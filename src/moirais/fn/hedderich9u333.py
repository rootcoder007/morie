...
__all__ = ["hedderich_chapter_9_unnumbered_333"]


def hedderich_chapter_9_unnumbered_333(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] II a ∑x +b ∑x2 +c ∑x3 = ∑xy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u333')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u333: GeneralStatistics expression (auto-extracted; see ref)."
