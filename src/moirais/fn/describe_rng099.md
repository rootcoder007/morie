# describe('rng099') — rangayyan_ch3_ma_8point_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng099')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng099 import *
import numpy as np
# See the function signature in fn/rng099.py for argument names.
```
