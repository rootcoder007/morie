...
`print(result)` render. See `moirais.fn.describe('eslsvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsvc import *
import numpy as np
# See the function signature in fn/eslsvc.py for argument names.
```
