# describe('effnnt') — efficientnet_block
...
`print(result)` render. See `moirais.fn.describe('effnnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effnnt import *
import numpy as np
# See the function signature in fn/effnnt.py for argument names.
```
