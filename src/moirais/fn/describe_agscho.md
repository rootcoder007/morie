# describe('agscho') — alphazero_search_horizon
...
`print(result)` render. See `moirais.fn.describe('agscho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agscho import *
import numpy as np
# See the function signature in fn/agscho.py for argument names.
```
