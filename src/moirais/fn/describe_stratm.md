# describe('stratm') — stratified_mean
...
`print(result)` render. See `moirais.fn.describe('stratm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stratm import *
import numpy as np
# See the function signature in fn/stratm.py for argument names.
```
