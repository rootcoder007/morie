# describe('hmdbd') — geron_decision_boundary
...
`print(result)` render. See `moirais.fn.describe('hmdbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdbd import *
import numpy as np
# See the function signature in fn/hmdbd.py for argument names.
```
