# describe('stscan') — st_scan_statistic
...
`print(result)` render. See `moirais.fn.describe('stscan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stscan import *
import numpy as np
# See the function signature in fn/stscan.py for argument names.
```
