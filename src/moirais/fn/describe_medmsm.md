...
`print(result)` render. See `moirais.fn.describe('medmsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medmsm import *
import numpy as np
# See the function signature in fn/medmsm.py for argument names.
```
