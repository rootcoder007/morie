...
`print(result)` render. See `moirais.fn.describe('ghmgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghmgw import *
import numpy as np
# See the function signature in fn/ghmgw.py for argument names.
```
