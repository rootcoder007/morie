...
__all__ = ["hedderich_chapter_9_unnumbered_1205"]


def hedderich_chapter_9_unnumbered_1205(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X≤k|λ)P̄ (X≤k|λu) = 1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1205')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1205: CountModels expression (auto-extracted; see ref)."
