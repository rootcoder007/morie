...
`print(result)` render. See `moirais.fn.describe('sagjw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagjw import *
import numpy as np
# See the function signature in fn/sagjw.py for argument names.
```
