# describe('rng190') — rangayyan_ch4_pan_tompkins_peak_classification
...
`print(result)` render. See `moirais.fn.describe('rng190')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng190 import *
import numpy as np
# See the function signature in fn/rng190.py for argument names.
```
