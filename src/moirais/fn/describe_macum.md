...
`print(result)` render. See `moirais.fn.describe('macum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.macum import *
import numpy as np
# See the function signature in fn/macum.py for argument names.
```
