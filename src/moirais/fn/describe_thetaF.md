...
`print(result)` render. See `moirais.fn.describe('thetaF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thetaF import *
import numpy as np
# See the function signature in fn/thetaF.py for argument names.
```
