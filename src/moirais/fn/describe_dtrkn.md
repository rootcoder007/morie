...
`print(result)` render. See `moirais.fn.describe('dtrkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtrkn import *
import numpy as np
# See the function signature in fn/dtrkn.py for argument names.
```
