# describe('gb1241t') — gibbons_concordance_w_ties
...
`print(result)` render. See `moirais.fn.describe('gb1241t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1241t import *
import numpy as np
# See the function signature in fn/gb1241t.py for argument names.
```
