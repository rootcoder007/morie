# describe('krig') — _spherical_variogram
...
`print(result)` render. See `moirais.fn.describe('krig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krig import *
import numpy as np
# See the function signature in fn/krig.py for argument names.
```
