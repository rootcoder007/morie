...
`print(result)` render. See `moirais.fn.describe('ppclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppclp import *
import numpy as np
# See the function signature in fn/ppclp.py for argument names.
```
