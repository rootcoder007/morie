# describe('csttr') — custody_transfer_rate
...
`print(result)` render. See `moirais.fn.describe('csttr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csttr import *
import numpy as np
# See the function signature in fn/csttr.py for argument names.
```
