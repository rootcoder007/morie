...
`print(result)` render. See `moirais.fn.describe('hmprel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmprel import *
import numpy as np
# See the function signature in fn/hmprel.py for argument names.
```
