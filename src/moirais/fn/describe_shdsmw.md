...
`print(result)` render. See `moirais.fn.describe('shdsmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shdsmw import *
import numpy as np
# See the function signature in fn/shdsmw.py for argument names.
```
