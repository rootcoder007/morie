# describe('fanlz') — factor_analysis_ml
...
`print(result)` render. See `moirais.fn.describe('fanlz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fanlz import *
import numpy as np
# See the function signature in fn/fanlz.py for argument names.
```
