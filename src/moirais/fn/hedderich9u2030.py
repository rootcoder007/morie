...
__all__ = ["hedderich_chapter_9_unnumbered_2030"]


def hedderich_chapter_9_unnumbered_2030(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t = 2 . 2 3 7 8 , df = 1 1 . 1 4 1 , p− value = 0 . 0 2 3 3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2030')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2030: GeneralStatistics expression (auto-extracted; see ref)."
