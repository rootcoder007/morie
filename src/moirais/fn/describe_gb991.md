# describe('gb991') — gibbons_conover_scale
...
`print(result)` render. See `moirais.fn.describe('gb991')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb991 import *
import numpy as np
# See the function signature in fn/gb991.py for argument names.
```
