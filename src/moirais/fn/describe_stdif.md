...
`print(result)` render. See `moirais.fn.describe('stdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdif import *
import numpy as np
# See the function signature in fn/stdif.py for argument names.
```
