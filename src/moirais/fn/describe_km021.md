# describe('km021') — kamath_ch2_clm_loss
...
`print(result)` render. See `moirais.fn.describe('km021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km021 import *
import numpy as np
# See the function signature in fn/km021.py for argument names.
```
