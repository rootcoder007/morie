...
__all__ = ["wilcox_chapter_13_unnumbered_1283"]


def wilcox_chapter_13_unnumbered_1283(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: High n21 n22 n2+ =n21 +n22
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1283')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1283: GeneralStatistics expression (auto-extracted; see ref)."
