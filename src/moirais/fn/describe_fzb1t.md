# describe('fzb1t') — fauzi_b1_coefficient
...
`print(result)` render. See `moirais.fn.describe('fzb1t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzb1t import *
import numpy as np
# See the function signature in fn/fzb1t.py for argument names.
```
