# describe('alembc') — alammar_embedding_classifier
...
`print(result)` render. See `moirais.fn.describe('alembc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alembc import *
import numpy as np
# See the function signature in fn/alembc.py for argument names.
```
