...
__all__ = ["wilcox_chapter_14_unnumbered_806"]


def wilcox_chapter_14_unnumbered_806(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] t2way(x=plasma[,10],IV1=plasma[,2],IV2=plasma[,3])
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u806')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u806: GeneralStatistics expression (auto-extracted; see ref)."
