...
`print(result)` render. See `moirais.fn.describe('coxsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxsn import *
import numpy as np
# See the function signature in fn/coxsn.py for argument names.
```
