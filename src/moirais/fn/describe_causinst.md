# describe('causinst') — causal_iv_instrumental_dag
...
`print(result)` render. See `moirais.fn.describe('causinst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causinst import *
import numpy as np
# See the function signature in fn/causinst.py for argument names.
```
