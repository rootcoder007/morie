...
`print(result)` render. See `moirais.fn.describe('rghrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrv import *
import numpy as np
# See the function signature in fn/rghrv.py for argument names.
```
