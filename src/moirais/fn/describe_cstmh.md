# describe('cstmh') — custody_mental_health
...
`print(result)` render. See `moirais.fn.describe('cstmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstmh import *
import numpy as np
# See the function signature in fn/cstmh.py for argument names.
```
