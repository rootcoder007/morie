...
__all__ = ["wilcox_chapter_10_unnumbered_1008"]


def wilcox_chapter_10_unnumbered_1008(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] hD = 3.85 × 1.0328 = 3.976.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1008')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1008: GeneralStatistics expression (auto-extracted; see ref)."
