...
__all__ = ["hedderich_chapter_9_unnumbered_2735"]


def hedderich_chapter_9_unnumbered_2735(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2735')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2735: GeneralStatistics expression (auto-extracted; see ref)."
