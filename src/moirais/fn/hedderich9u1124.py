...
__all__ = ["hedderich_chapter_9_unnumbered_1124"]


def hedderich_chapter_9_unnumbered_1124(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: for (1−x/n) and subtract both limits from 100; e.g. ˆp =x/n = 20/25, for (1−20/25) = (5/25)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1124')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1124: GeneralStatistics expression (auto-extracted; see ref)."
