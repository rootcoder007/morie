...
`print(result)` render. See `moirais.fn.describe('vgxvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgxvg import *
import numpy as np
# See the function signature in fn/vgxvg.py for argument names.
```
