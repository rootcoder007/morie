...
`print(result)` render. See `moirais.fn.describe('dbscn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbscn import *
import numpy as np
# See the function signature in fn/dbscn.py for argument names.
```
