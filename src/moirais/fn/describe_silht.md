# describe('silht') — silhouette_score
...
`print(result)` render. See `moirais.fn.describe('silht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.silht import *
import numpy as np
# See the function signature in fn/silht.py for argument names.
```
