...
`print(result)` render. See `moirais.fn.describe('abcsmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcsmc import *
import numpy as np
# See the function signature in fn/abcsmc.py for argument names.
```
