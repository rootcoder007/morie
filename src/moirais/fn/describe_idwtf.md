# describe('idwtf') — _wavelet_filter
...
`print(result)` render. See `moirais.fn.describe('idwtf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwtf import *
import numpy as np
# See the function signature in fn/idwtf.py for argument names.
```
