# describe('hmvth') — geron_voting_hard
...
`print(result)` render. See `moirais.fn.describe('hmvth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvth import *
import numpy as np
# See the function signature in fn/hmvth.py for argument names.
```
