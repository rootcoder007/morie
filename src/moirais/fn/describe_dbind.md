...
`print(result)` render. See `moirais.fn.describe('dbind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbind import *
import numpy as np
# See the function signature in fn/dbind.py for argument names.
```
