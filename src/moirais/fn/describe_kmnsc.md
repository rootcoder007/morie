# describe('kmnsc') — kmeans_clustering
...
`print(result)` render. See `moirais.fn.describe('kmnsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmnsc import *
import numpy as np
# See the function signature in fn/kmnsc.py for argument names.
```
