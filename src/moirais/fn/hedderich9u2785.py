...
__all__ = ["hedderich_chapter_9_unnumbered_2785"]


def hedderich_chapter_9_unnumbered_2785(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( verum= c ( " strong " , " weak " ) , placebo =c ( " strong " , " weak " ) ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2785')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2785: GeneralStatistics expression (auto-extracted; see ref)."
