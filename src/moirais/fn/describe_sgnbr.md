...
`print(result)` render. See `moirais.fn.describe('sgnbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnbr import *
import numpy as np
# See the function signature in fn/sgnbr.py for argument names.
```
