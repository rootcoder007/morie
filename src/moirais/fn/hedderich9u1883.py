...
__all__ = ["hedderich_chapter_9_unnumbered_1883"]


def hedderich_chapter_9_unnumbered_1883(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: on random samples of sizesn1 = 20,n2 = 20, we get ˆr = 15. Since according to Tab.7.18ru;5% =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1883')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1883: GeneralStatistics expression (auto-extracted; see ref)."
