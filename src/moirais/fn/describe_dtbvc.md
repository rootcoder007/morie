...
`print(result)` render. See `moirais.fn.describe('dtbvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbvc import *
import numpy as np
# See the function signature in fn/dtbvc.py for argument names.
```
