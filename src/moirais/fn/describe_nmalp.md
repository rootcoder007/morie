...
`print(result)` render. See `moirais.fn.describe('nmalp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmalp import *
import numpy as np
# See the function signature in fn/nmalp.py for argument names.
```
