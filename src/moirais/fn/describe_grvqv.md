# describe('grvqv') — geron_vq_vae_codebook_loss
...
`print(result)` render. See `moirais.fn.describe('grvqv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grvqv import *
import numpy as np
# See the function signature in fn/grvqv.py for argument names.
```
