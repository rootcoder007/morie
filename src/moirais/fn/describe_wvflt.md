...
`print(result)` render. See `moirais.fn.describe('wvflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvflt import *
import numpy as np
# See the function signature in fn/wvflt.py for argument names.
```
