...
__all__ = ["wilcox_chapter_10_unnumbered_1032"]


def wilcox_chapter_10_unnumbered_1032(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 :µ 1 − µ 2 − µ 3 +µ 4 − µ 5 +µ 6 +µ 7 − µ 8 = 0. (12.13)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1032')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1032: GeneralStatistics expression (auto-extracted; see ref)."
