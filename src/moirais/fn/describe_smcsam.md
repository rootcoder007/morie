# describe('smcsam') — sequential_mc_sampler
...
`print(result)` render. See `moirais.fn.describe('smcsam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcsam import *
import numpy as np
# See the function signature in fn/smcsam.py for argument names.
```
