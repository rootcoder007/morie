...
`print(result)` render. See `moirais.fn.describe('lowsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lowsp import *
import numpy as np
# See the function signature in fn/lowsp.py for argument names.
```
