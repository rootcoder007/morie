...
`print(result)` render. See `moirais.fn.describe('upsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.upsmp import *
import numpy as np
# See the function signature in fn/upsmp.py for argument names.
```
