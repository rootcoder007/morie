# describe('hrvtd') — hrv_time_domain
...
`print(result)` render. See `moirais.fn.describe('hrvtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvtd import *
import numpy as np
# See the function signature in fn/hrvtd.py for argument names.
```
