...
__all__ = ["wilcox_chapter_14_unnumbered_740"]


def wilcox_chapter_14_unnumbered_740(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 1.51 + 10 − 1 = 0.05.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u740')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u740: PowerAndDesign expression (auto-extracted; see ref)."
