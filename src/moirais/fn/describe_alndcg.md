# describe('alndcg') — alammar_ndcg_at_k
...
`print(result)` render. See `moirais.fn.describe('alndcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alndcg import *
import numpy as np
# See the function signature in fn/alndcg.py for argument names.
```
