...
`print(result)` render. See `moirais.fn.describe('prwfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prwfp import *
import numpy as np
# See the function signature in fn/prwfp.py for argument names.
```
