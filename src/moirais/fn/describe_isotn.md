# describe('isotn') — isotonic_regression
...
`print(result)` render. See `moirais.fn.describe('isotn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isotn import *
import numpy as np
# See the function signature in fn/isotn.py for argument names.
```
