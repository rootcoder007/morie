# describe('gh_c14_2') — ghosal_ewens_esf
...
`print(result)` render. See `moirais.fn.describe('gh_c14_2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_2 import *
import numpy as np
# See the function signature in fn/gh_c14_2.py for argument names.
```
