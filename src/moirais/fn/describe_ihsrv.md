# describe('ihsrv') — indigenous_service_access
...
`print(result)` render. See `moirais.fn.describe('ihsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihsrv import *
import numpy as np
# See the function signature in fn/ihsrv.py for argument names.
```
