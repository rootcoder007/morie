# describe('kmperm') — kamath_permutation_lm_loss
...
`print(result)` render. See `moirais.fn.describe('kmperm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmperm import *
import numpy as np
# See the function signature in fn/kmperm.py for argument names.
```
