...
`print(result)` render. See `moirais.fn.describe('umgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umgrd import *
import numpy as np
# See the function signature in fn/umgrd.py for argument names.
```
