...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_34(x):
    """
    CentralTendency expression (auto-extracted; see ref).

    Formula: <<echo=FALSE, message=FALSE, warning=FALSE, out.width='7cm',
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('An unexamined life is not worth living. — Socrates')`` for the full guide.
