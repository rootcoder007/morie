# describe('emgrt') — emg_rms_threshold
...
`print(result)` render. See `moirais.fn.describe('emgrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emgrt import *
import numpy as np
# See the function signature in fn/emgrt.py for argument names.
```
