# describe('ps_wgt') — poststratification_weights
...
`print(result)` render. See `moirais.fn.describe('ps_wgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ps_wgt import *
import numpy as np
# See the function signature in fn/ps_wgt.py for argument names.
```
