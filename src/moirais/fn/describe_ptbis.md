...
`print(result)` render. See `moirais.fn.describe('ptbis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptbis import *
import numpy as np
# See the function signature in fn/ptbis.py for argument names.
```
