...
`print(result)` render. See `moirais.fn.describe('nttfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nttfn import *
import numpy as np
# See the function signature in fn/nttfn.py for argument names.
```
