...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_922"]


def guide_on_data_analysis_chapter_16_unnumbered_922(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u922')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u922: GeneralStatistics expression (auto-extracted; see ref)."
