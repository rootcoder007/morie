...
`print(result)` render. See `moirais.fn.describe('rspca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rspca import *
import numpy as np
# See the function signature in fn/rspca.py for argument names.
```
