# describe('cmpnt') — connected_components
...
`print(result)` render. See `moirais.fn.describe('cmpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpnt import *
import numpy as np
# See the function signature in fn/cmpnt.py for argument names.
```
