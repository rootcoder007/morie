...
`print(result)` render. See `moirais.fn.describe('hrmns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrmns import *
import numpy as np
# See the function signature in fn/hrmns.py for argument names.
```
