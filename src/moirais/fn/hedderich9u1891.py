...
__all__ = ["hedderich_chapter_9_unnumbered_1891"]


def hedderich_chapter_9_unnumbered_1891(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( apross == 1 ) { delete = ( length( x ) + 1 )/ 2 ; x = x [ − delete ] }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1891')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1891: GeneralStatistics expression (auto-extracted; see ref)."
