# describe('hmqat') — geron_quantization_aware_training
...
`print(result)` render. See `moirais.fn.describe('hmqat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmqat import *
import numpy as np
# See the function signature in fn/hmqat.py for argument names.
```
