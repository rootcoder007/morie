...
`print(result)` render. See `moirais.fn.describe('ubpdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubpdn import *
import numpy as np
# See the function signature in fn/ubpdn.py for argument names.
```
