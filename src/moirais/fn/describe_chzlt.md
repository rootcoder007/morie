# describe('chzlt') — cinelli_hazlett
...
`print(result)` render. See `moirais.fn.describe('chzlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chzlt import *
import numpy as np
# See the function signature in fn/chzlt.py for argument names.
```
