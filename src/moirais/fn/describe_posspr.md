# describe('posspr') — posterior_predictive
...
`print(result)` render. See `moirais.fn.describe('posspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.posspr import *
import numpy as np
# See the function signature in fn/posspr.py for argument names.
```
