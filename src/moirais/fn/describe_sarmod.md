# describe('sarmod') — spatial_lag_model
...
`print(result)` render. See `moirais.fn.describe('sarmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarmod import *
import numpy as np
# See the function signature in fn/sarmod.py for argument names.
```
