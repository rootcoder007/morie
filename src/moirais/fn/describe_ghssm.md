...
`print(result)` render. See `moirais.fn.describe('ghssm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghssm import *
import numpy as np
# See the function signature in fn/ghssm.py for argument names.
```
