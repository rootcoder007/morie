...
`print(result)` render. See `moirais.fn.describe('idisc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idisc import *
import numpy as np
# See the function signature in fn/idisc.py for argument names.
```
