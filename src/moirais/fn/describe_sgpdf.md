# describe('sgpdf') — positive_definiteness_check
...
`print(result)` render. See `moirais.fn.describe('sgpdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpdf import *
import numpy as np
# See the function signature in fn/sgpdf.py for argument names.
```
