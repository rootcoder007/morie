...
`print(result)` render. See `moirais.fn.describe('bayscm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayscm import *
import numpy as np
# See the function signature in fn/bayscm.py for argument names.
```
