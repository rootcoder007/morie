...
`print(result)` render. See `moirais.fn.describe('wvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvd import *
import numpy as np
# See the function signature in fn/wvd.py for argument names.
```
