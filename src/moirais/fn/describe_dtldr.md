# describe('dtldr') — data_loader_stats
...
`print(result)` render. See `moirais.fn.describe('dtldr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtldr import *
import numpy as np
# See the function signature in fn/dtldr.py for argument names.
```
