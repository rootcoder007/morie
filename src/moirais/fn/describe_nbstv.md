...
`print(result)` render. See `moirais.fn.describe('nbstv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbstv import *
import numpy as np
# See the function signature in fn/nbstv.py for argument names.
```
