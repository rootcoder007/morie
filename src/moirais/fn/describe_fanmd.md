# describe('fanmd') — fanova_decomposition
...
`print(result)` render. See `moirais.fn.describe('fanmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fanmd import *
import numpy as np
# See the function signature in fn/fanmd.py for argument names.
```
