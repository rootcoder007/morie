# describe('amci') — am_confidence_intervals
...
`print(result)` render. See `moirais.fn.describe('amci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amci import *
import numpy as np
# See the function signature in fn/amci.py for argument names.
```
