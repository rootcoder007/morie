# describe('wsmpsn') — wasserman_pearson_corr
...
`print(result)` render. See `moirais.fn.describe('wsmpsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmpsn import *
import numpy as np
# See the function signature in fn/wsmpsn.py for argument names.
```
