# describe('qedscr') — qed_drug_likeness
...
`print(result)` render. See `moirais.fn.describe('qedscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qedscr import *
import numpy as np
# See the function signature in fn/qedscr.py for argument names.
```
