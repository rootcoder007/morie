# describe('seqdt') — sequential_detect
...
`print(result)` render. See `moirais.fn.describe('seqdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seqdt import *
import numpy as np
# See the function signature in fn/seqdt.py for argument names.
```
