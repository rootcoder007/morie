...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_24(x):
    """
    Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner2e24')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e24: Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
