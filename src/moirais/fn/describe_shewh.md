...
`print(result)` render. See `moirais.fn.describe('shewh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shewh import *
import numpy as np
# See the function signature in fn/shewh.py for argument names.
```
