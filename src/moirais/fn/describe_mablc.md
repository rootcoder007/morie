...
`print(result)` render. See `moirais.fn.describe('mablc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mablc import *
import numpy as np
# See the function signature in fn/mablc.py for argument names.
```
