...
__all__ = ["wilcox_chapter_10_unnumbered_963"]


def wilcox_chapter_10_unnumbered_963(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 :µ 1 +µ 2 − µ 3 − µ 4 = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u963')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u963: GeneralStatistics expression (auto-extracted; see ref)."
