# describe('grridn') — geron_ridge_normal_equation
...
`print(result)` render. See `moirais.fn.describe('grridn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grridn import *
import numpy as np
# See the function signature in fn/grridn.py for argument names.
```
