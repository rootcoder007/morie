...
__all__ = ["hedderich_chapter_9_unnumbered_2880"]


def hedderich_chapter_9_unnumbered_2880(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = 59(18·3−27·12)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2880')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2880: GeneralStatistics expression (auto-extracted; see ref)."
