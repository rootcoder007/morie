# describe('nmbu') — nambu_goto_action
...
`print(result)` render. See `moirais.fn.describe('nmbu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmbu import *
import numpy as np
# See the function signature in fn/nmbu.py for argument names.
```
