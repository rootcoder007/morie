...
`print(result)` render. See `moirais.fn.describe('gchrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gchrc import *
import numpy as np
# See the function signature in fn/gchrc.py for argument names.
```
