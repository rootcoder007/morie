# describe('ca8e2') — ca_chapter_8_equation_2
...
```python
from moirais.fn.ca8e2 import ca_chapter_8_equation_2
import numpy as np
result = ca_chapter_8_equation_2(np.random.default_rng(42).normal(0, 1, 100))
