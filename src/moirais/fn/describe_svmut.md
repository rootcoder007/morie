...
`print(result)` render. See `moirais.fn.describe('svmut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmut import *
import numpy as np
# See the function signature in fn/svmut.py for argument names.
```
