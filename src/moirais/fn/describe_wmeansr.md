# describe('wmeansr') — weighted_mean_survey
...
`print(result)` render. See `moirais.fn.describe('wmeansr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wmeansr import *
import numpy as np
# See the function signature in fn/wmeansr.py for argument names.
```
