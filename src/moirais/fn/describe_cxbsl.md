...
`print(result)` render. See `moirais.fn.describe('cxbsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxbsl import *
import numpy as np
# See the function signature in fn/cxbsl.py for argument names.
```
