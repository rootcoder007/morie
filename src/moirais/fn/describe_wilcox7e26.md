# describe('wilcox7e26') — wilcox_chapter_7_equation_26
...
```python
from moirais.fn.wilcox7e26 import wilcox_chapter_7_equation_26
import numpy as np
result = wilcox_chapter_7_equation_26(np.random.default_rng(42).normal(0, 1, 100))
