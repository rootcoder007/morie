...
__all__ = ["hedderich_chapter_9_unnumbered_1493"]


def hedderich_chapter_9_unnumbered_1493(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: QM S + (k−1)Fα/2,ν1,ν2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1493')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1493: PowerAndDesign expression (auto-extracted; see ref)."
