# describe('hubrr') — huber_regression
...
`print(result)` render. See `moirais.fn.describe('hubrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubrr import *
import numpy as np
# See the function signature in fn/hubrr.py for argument names.
```
