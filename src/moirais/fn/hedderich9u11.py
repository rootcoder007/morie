...
__all__ = ["hedderich_chapter_9_unnumbered_11"]


def hedderich_chapter_9_unnumbered_11(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u11')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u11: GeneralStatistics expression (auto-extracted; see ref)."
