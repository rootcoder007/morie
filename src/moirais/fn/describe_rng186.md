# describe('rng186') — rangayyan_ch4_pan_tompkins_highpass_difference_eq
...
`print(result)` render. See `moirais.fn.describe('rng186')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng186 import *
import numpy as np
# See the function signature in fn/rng186.py for argument names.
```
