...
`print(result)` render. See `moirais.fn.describe('mcimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcimp import *
import numpy as np
# See the function signature in fn/mcimp.py for argument names.
```
