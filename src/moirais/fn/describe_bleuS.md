...
`print(result)` render. See `moirais.fn.describe('bleuS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bleuS import *
import numpy as np
# See the function signature in fn/bleuS.py for argument names.
```
