...
`print(result)` render. See `moirais.fn.describe('mapeto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapeto import *
import numpy as np
# See the function signature in fn/mapeto.py for argument names.
```
