...
`print(result)` render. See `moirais.fn.describe('crisk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crisk import *
import numpy as np
# See the function signature in fn/crisk.py for argument names.
```
