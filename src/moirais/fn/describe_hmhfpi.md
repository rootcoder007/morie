# describe('hmhfpi') — geron_hf_pipelines
...
`print(result)` render. See `moirais.fn.describe('hmhfpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhfpi import *
import numpy as np
# See the function signature in fn/hmhfpi.py for argument names.
```
