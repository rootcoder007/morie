# describe('rng025') — rangayyan_ch3_dirac_delta_unit_area
...
`print(result)` render. See `moirais.fn.describe('rng025')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng025 import *
import numpy as np
# See the function signature in fn/rng025.py for argument names.
```
