# describe('rng009') — rangayyan_ch3_sample_rms
...
`print(result)` render. See `moirais.fn.describe('rng009')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng009 import *
import numpy as np
# See the function signature in fn/rng009.py for argument names.
```
