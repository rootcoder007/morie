# describe('gb321') — gibbons_runs_joint_dist
...
`print(result)` render. See `moirais.fn.describe('gb321')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb321 import *
import numpy as np
# See the function signature in fn/gb321.py for argument names.
```
