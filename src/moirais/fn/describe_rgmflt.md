# describe('rgmflt') — rangayyan_matched_filter
...
`print(result)` render. See `moirais.fn.describe('rgmflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmflt import *
import numpy as np
# See the function signature in fn/rgmflt.py for argument names.
```
