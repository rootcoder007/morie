...
__all__ = ["wilcox_chapter_13_unnumbered_1322"]


def wilcox_chapter_13_unnumbered_1322(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1322')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1322: ContingencyTables expression (auto-extracted; see ref)."
