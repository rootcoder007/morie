...
__all__ = ["wilcox_chapter_14_unnumbered_512"]


def wilcox_chapter_14_unnumbered_512(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (column 12). The 0.95 confidence interval for ρ 12 − ρ 13, returned by the function TWOpov, is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u512')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u512: GeneralStatistics expression (auto-extracted; see ref)."
