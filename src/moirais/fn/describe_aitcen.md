# describe('aitcen') — aitchison_center
...
`print(result)` render. See `moirais.fn.describe('aitcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitcen import *
import numpy as np
# See the function signature in fn/aitcen.py for argument names.
```
