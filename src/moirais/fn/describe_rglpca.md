# describe('rglpca') — rangayyan_lpc_analysis
...
`print(result)` render. See `moirais.fn.describe('rglpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglpca import *
import numpy as np
# See the function signature in fn/rglpca.py for argument names.
```
