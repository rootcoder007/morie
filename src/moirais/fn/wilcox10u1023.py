...
__all__ = ["wilcox_chapter_10_unnumbered_1023"]


def wilcox_chapter_10_unnumbered_1023(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Dqcomhd(x,y,q = c(1.9)/10, nboot = 1000, plotit = TRUE, SEED = TRUE, xlab =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1023')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1023: GeneralStatistics expression (auto-extracted; see ref)."
