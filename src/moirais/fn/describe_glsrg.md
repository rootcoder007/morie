...
`print(result)` render. See `moirais.fn.describe('glsrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glsrg import *
import numpy as np
# See the function signature in fn/glsrg.py for argument names.
```
