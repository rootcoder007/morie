...
`print(result)` render. See `moirais.fn.describe('dtgpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtgpd import *
import numpy as np
# See the function signature in fn/dtgpd.py for argument names.
```
