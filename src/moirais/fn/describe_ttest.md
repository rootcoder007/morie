...
`print(result)` render. See `moirais.fn.describe('ttest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ttest import *
import numpy as np
# See the function signature in fn/ttest.py for argument names.
```
