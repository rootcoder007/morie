...
`print(result)` render. See `moirais.fn.describe('gawshd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gawshd import *
import numpy as np
# See the function signature in fn/gawshd.py for argument names.
```
