# describe('kmchin') — kamath_chinchilla_compute_optimal
...
`print(result)` render. See `moirais.fn.describe('kmchin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmchin import *
import numpy as np
# See the function signature in fn/kmchin.py for argument names.
```
