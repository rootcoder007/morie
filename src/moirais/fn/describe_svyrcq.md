# describe('svyrcq') — survey_quantile_reg
...
`print(result)` render. See `moirais.fn.describe('svyrcq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svyrcq import *
import numpy as np
# See the function signature in fn/svyrcq.py for argument names.
```
