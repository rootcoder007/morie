# describe('grq8') — geron_int8_quantization
...
`print(result)` render. See `moirais.fn.describe('grq8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grq8 import *
import numpy as np
# See the function signature in fn/grq8.py for argument names.
```
