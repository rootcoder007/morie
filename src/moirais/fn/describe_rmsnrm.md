...
`print(result)` render. See `moirais.fn.describe('rmsnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsnrm import *
import numpy as np
# See the function signature in fn/rmsnrm.py for argument names.
```
