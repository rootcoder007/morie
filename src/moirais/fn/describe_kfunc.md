...
`print(result)` render. See `moirais.fn.describe('kfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kfunc import *
import numpy as np
# See the function signature in fn/kfunc.py for argument names.
```
