# describe('kmweat') — kamath_weat_bias_score
...
`print(result)` render. See `moirais.fn.describe('kmweat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmweat import *
import numpy as np
# See the function signature in fn/kmweat.py for argument names.
```
