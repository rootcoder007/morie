...
`print(result)` render. See `moirais.fn.describe('idpts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpts import *
import numpy as np
# See the function signature in fn/idpts.py for argument names.
```
