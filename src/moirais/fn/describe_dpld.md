...
`print(result)` render. See `moirais.fn.describe('dpld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpld import *
import numpy as np
# See the function signature in fn/dpld.py for argument names.
```
