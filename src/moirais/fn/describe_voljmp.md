# describe('voljmp') — vol_jump_test_bnshep
...
`print(result)` render. See `moirais.fn.describe('voljmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voljmp import *
import numpy as np
# See the function signature in fn/voljmp.py for argument names.
```
