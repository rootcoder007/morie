# describe('eqrii') — relative_inequality
...
`print(result)` render. See `moirais.fn.describe('eqrii')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqrii import *
import numpy as np
# See the function signature in fn/eqrii.py for argument names.
```
