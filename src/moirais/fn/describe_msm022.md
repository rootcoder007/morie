# describe('msm022') — mvsml_linear_mixed_models_eq_5_3
...
`print(result)` render. See `moirais.fn.describe('msm022')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm022 import *
import numpy as np
# See the function signature in fn/msm022.py for argument names.
```
