...
`print(result)` render. See `moirais.fn.describe('dtzpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtzpf import *
import numpy as np
# See the function signature in fn/dtzpf.py for argument names.
```
