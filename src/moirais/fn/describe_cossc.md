...
`print(result)` render. See `moirais.fn.describe('cossc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cossc import *
import numpy as np
# See the function signature in fn/cossc.py for argument names.
```
