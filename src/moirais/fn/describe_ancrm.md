...
`print(result)` render. See `moirais.fn.describe('ancrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ancrm import *
import numpy as np
# See the function signature in fn/ancrm.py for argument names.
```
