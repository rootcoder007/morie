...
__all__ = ["hedderich_chapter_9_unnumbered_3594"]


def hedderich_chapter_9_unnumbered_3594(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3594')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3594: GeneralStatistics expression (auto-extracted; see ref)."
