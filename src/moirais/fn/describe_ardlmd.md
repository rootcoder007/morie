# describe('ardlmd') — ardl_bounds_test
...
`print(result)` render. See `moirais.fn.describe('ardlmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ardlmd import *
import numpy as np
# See the function signature in fn/ardlmd.py for argument names.
```
