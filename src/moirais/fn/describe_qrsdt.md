...
`print(result)` render. See `moirais.fn.describe('qrsdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrsdt import *
import numpy as np
# See the function signature in fn/qrsdt.py for argument names.
```
