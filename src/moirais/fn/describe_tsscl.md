...
`print(result)` render. See `moirais.fn.describe('tsscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsscl import *
import numpy as np
# See the function signature in fn/tsscl.py for argument names.
```
