# describe('hmmod') — geron_model_based
...
`print(result)` render. See `moirais.fn.describe('hmmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmod import *
import numpy as np
# See the function signature in fn/hmmod.py for argument names.
```
