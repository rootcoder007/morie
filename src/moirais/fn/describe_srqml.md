...
`print(result)` render. See `moirais.fn.describe('srqml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srqml import *
import numpy as np
# See the function signature in fn/srqml.py for argument names.
```
