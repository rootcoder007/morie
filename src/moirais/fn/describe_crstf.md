# describe('crstf') — crest_factor_fn
...
`print(result)` render. See `moirais.fn.describe('crstf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crstf import *
import numpy as np
# See the function signature in fn/crstf.py for argument names.
```
