...
__all__ = ["hedderich_chapter_9_unnumbered_2849"]


def hedderich_chapter_9_unnumbered_2849(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 80 = 5 > 2 and E(8) = 10·40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2849')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2849: GeneralStatistics expression (auto-extracted; see ref)."
