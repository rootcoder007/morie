...
`print(result)` render. See `moirais.fn.describe('plest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plest import *
import numpy as np
# See the function signature in fn/plest.py for argument names.
```
