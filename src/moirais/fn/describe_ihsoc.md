# describe('ihsoc') — social_determinants
...
`print(result)` render. See `moirais.fn.describe('ihsoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihsoc import *
import numpy as np
# See the function signature in fn/ihsoc.py for argument names.
```
