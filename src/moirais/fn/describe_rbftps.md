...
`print(result)` render. See `moirais.fn.describe('rbftps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbftps import *
import numpy as np
# See the function signature in fn/rbftps.py for argument names.
```
