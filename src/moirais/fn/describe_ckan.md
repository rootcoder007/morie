...
`print(result)` render. See `moirais.fn.describe('ckan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ckan import *
import numpy as np
# See the function signature in fn/ckan.py for argument names.
```
