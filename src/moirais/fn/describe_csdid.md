...
`print(result)` render. See `moirais.fn.describe('csdid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdid import *
import numpy as np
# See the function signature in fn/csdid.py for argument names.
```
