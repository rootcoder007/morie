...
`print(result)` render. See `moirais.fn.describe('ubcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcar import *
import numpy as np
# See the function signature in fn/ubcar.py for argument names.
```
