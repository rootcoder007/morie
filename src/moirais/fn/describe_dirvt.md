# describe('dirvt') — directional_vote
...
`print(result)` render. See `moirais.fn.describe('dirvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dirvt import *
import numpy as np
# See the function signature in fn/dirvt.py for argument names.
```
