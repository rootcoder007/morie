# describe('tqipb') — turboquant_inner_product_distortion_bound
...
`print(result)` render. See `moirais.fn.describe('tqipb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqipb import *
import numpy as np
# See the function signature in fn/tqipb.py for argument names.
```
