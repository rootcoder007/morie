...
`print(result)` render. See `moirais.fn.describe('r_t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r_t import *
import numpy as np
# See the function signature in fn/r_t.py for argument names.
```
