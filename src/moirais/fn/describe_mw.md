...
`print(result)` render. See `moirais.fn.describe('mw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mw import *
import numpy as np
# See the function signature in fn/mw.py for argument names.
```
