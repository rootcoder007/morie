...
`print(result)` render. See `moirais.fn.describe('mdnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdnsp import *
import numpy as np
# See the function signature in fn/mdnsp.py for argument names.
```
