...
__all__ = ["hedderich_chapter_9_unnumbered_1292"]


def hedderich_chapter_9_unnumbered_1292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n1−1,1−α/2s2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1292')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1292: GeneralStatistics expression (auto-extracted; see ref)."
