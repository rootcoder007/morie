...
`print(result)` render. See `moirais.fn.describe('asmolc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.asmolc import *
import numpy as np
# See the function signature in fn/asmolc.py for argument names.
```
