...
__all__ = ["wilcox_chapter_5_unnumbered_392"]


def wilcox_chapter_5_unnumbered_392(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 20. Given the following values for ¯X ands: (a) ¯X = 44, s = 10, (b) ¯X = 43, s = 10,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u392')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u392: PowerAndDesign expression (auto-extracted; see ref)."
