...
`print(result)` render. See `moirais.fn.describe('jrqbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jrqbst import *
import numpy as np
# See the function signature in fn/jrqbst.py for argument names.
```
