...
__all__ = ["wilcox_chapter_5_unnumbered_441"]


def wilcox_chapter_5_unnumbered_441(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where t is the 1 − α/2 quantile of Student’s t distribution with ν = n − p − 1 degrees of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u441')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u441: GeneralStatistics expression (auto-extracted; see ref)."
