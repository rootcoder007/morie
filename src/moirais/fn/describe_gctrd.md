...
`print(result)` render. See `moirais.fn.describe('gctrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gctrd import *
import numpy as np
# See the function signature in fn/gctrd.py for argument names.
```
