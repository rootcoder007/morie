# describe('bic') — bayesian_info_criterion

## WHAT IT DOES

Bayesian Information Criterion. 'Everything flows. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('bic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bic import *
import numpy as np
# See the function signature in fn/bic.py for argument names.
```
