# describe('gb47ad') — gibbons_anderson_darling
...
`print(result)` render. See `moirais.fn.describe('gb47ad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb47ad import *
import numpy as np
# See the function signature in fn/gb47ad.py for argument names.
```
