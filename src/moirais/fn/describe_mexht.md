...
`print(result)` render. See `moirais.fn.describe('mexht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mexht import *
import numpy as np
# See the function signature in fn/mexht.py for argument names.
```
