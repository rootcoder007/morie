...
`print(result)` render. See `moirais.fn.describe('fftsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fftsi import *
import numpy as np
# See the function signature in fn/fftsi.py for argument names.
```
