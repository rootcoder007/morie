...
`print(result)` render. See `moirais.fn.describe('gwrfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrfit import *
import numpy as np
# See the function signature in fn/gwrfit.py for argument names.
```
