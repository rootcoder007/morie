# describe('umap_') — _fuzzy_simplicial_set
...
`print(result)` render. See `moirais.fn.describe('umap_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umap_ import *
import numpy as np
# See the function signature in fn/umap_.py for argument names.
```
