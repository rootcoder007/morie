...
`print(result)` render. See `moirais.fn.describe('scnblrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scnblrt import *
import numpy as np
# See the function signature in fn/scnblrt.py for argument names.
```
