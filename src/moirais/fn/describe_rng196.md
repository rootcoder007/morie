# describe('rng196') — rangayyan_ch4_dicrotic_notch_second_derivative
...
`print(result)` render. See `moirais.fn.describe('rng196')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng196 import *
import numpy as np
# See the function signature in fn/rng196.py for argument names.
```
