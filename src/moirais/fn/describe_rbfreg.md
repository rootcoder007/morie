...
`print(result)` render. See `moirais.fn.describe('rbfreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfreg import *
import numpy as np
# See the function signature in fn/rbfreg.py for argument names.
```
