...
`print(result)` render. See `moirais.fn.describe('matnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matnm import *
import numpy as np
# See the function signature in fn/matnm.py for argument names.
```
