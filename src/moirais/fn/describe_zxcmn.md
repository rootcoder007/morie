# describe('zxcmn') — circular_mean_sp
...
`print(result)` render. See `moirais.fn.describe('zxcmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxcmn import *
import numpy as np
# See the function signature in fn/zxcmn.py for argument names.
```
