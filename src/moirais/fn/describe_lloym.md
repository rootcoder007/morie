...
`print(result)` render. See `moirais.fn.describe('lloym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lloym import *
import numpy as np
# See the function signature in fn/lloym.py for argument names.
```
