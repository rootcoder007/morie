# describe('rgwndw') — rangayyan_window_functions
...
`print(result)` render. See `moirais.fn.describe('rgwndw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwndw import *
import numpy as np
# See the function signature in fn/rgwndw.py for argument names.
```
