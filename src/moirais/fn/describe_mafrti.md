# describe('mafrti') — ma_freeman_tukey_inverse
...
`print(result)` render. See `moirais.fn.describe('mafrti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafrti import *
import numpy as np
# See the function signature in fn/mafrti.py for argument names.
```
