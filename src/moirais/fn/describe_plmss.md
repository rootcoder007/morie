...
`print(result)` render. See `moirais.fn.describe('plmss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plmss import *
import numpy as np
# See the function signature in fn/plmss.py for argument names.
```
