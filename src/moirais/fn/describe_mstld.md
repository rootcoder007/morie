...
`print(result)` render. See `moirais.fn.describe('mstld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstld import *
import numpy as np
# See the function signature in fn/mstld.py for argument names.
```
