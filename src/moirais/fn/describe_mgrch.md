# describe('mgrch') — bekk_garch_multivariate
...
`print(result)` render. See `moirais.fn.describe('mgrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgrch import *
import numpy as np
# See the function signature in fn/mgrch.py for argument names.
```
