...
`print(result)` render. See `moirais.fn.describe('redund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.redund import *
import numpy as np
# See the function signature in fn/redund.py for argument names.
```
