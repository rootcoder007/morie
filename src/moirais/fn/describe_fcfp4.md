# describe('fcfp4') — fcfp_4_fingerprint
...
`print(result)` render. See `moirais.fn.describe('fcfp4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fcfp4 import *
import numpy as np
# See the function signature in fn/fcfp4.py for argument names.
```
