# describe('wassdt') — wasserstein_1d
...
`print(result)` render. See `moirais.fn.describe('wassdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wassdt import *
import numpy as np
# See the function signature in fn/wassdt.py for argument names.
```
