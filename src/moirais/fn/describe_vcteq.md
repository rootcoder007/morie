...
`print(result)` render. See `moirais.fn.describe('vcteq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcteq import *
import numpy as np
# See the function signature in fn/vcteq.py for argument names.
```
