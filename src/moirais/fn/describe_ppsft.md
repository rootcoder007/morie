...
`print(result)` render. See `moirais.fn.describe('ppsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppsft import *
import numpy as np
# See the function signature in fn/ppsft.py for argument names.
```
