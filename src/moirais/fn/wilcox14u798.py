...
__all__ = ["wilcox_chapter_14_unnumbered_798"]


def wilcox_chapter_14_unnumbered_798(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: γ jk = µ jk − α j − β k − ¯µ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u798')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u798: GeneralStatistics expression (auto-extracted; see ref)."
