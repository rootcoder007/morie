...
`print(result)` render. See `moirais.fn.describe('bfgsop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfgsop import *
import numpy as np
# See the function signature in fn/bfgsop.py for argument names.
```
