# describe('causovlap') — causal_overlap_diagnostic
...
`print(result)` render. See `moirais.fn.describe('causovlap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causovlap import *
import numpy as np
# See the function signature in fn/causovlap.py for argument names.
```
