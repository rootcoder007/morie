...
`print(result)` render. See `moirais.fn.describe('pshmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pshmm import *
import numpy as np
# See the function signature in fn/pshmm.py for argument names.
```
