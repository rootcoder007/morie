...
__all__ = ["hedderich_chapter_9_unnumbered_2441"]


def hedderich_chapter_9_unnumbered_2441(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 4 =n1/(n1 +n2) = 15/(15 + 5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2441')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2441: GeneralStatistics expression (auto-extracted; see ref)."
