...
`print(result)` render. See `moirais.fn.describe('mle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mle import *
import numpy as np
# See the function signature in fn/mle.py for argument names.
```
