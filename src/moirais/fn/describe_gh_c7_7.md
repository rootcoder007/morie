# describe('gh_c7_7') — ghosal_spec_dens_con
...
`print(result)` render. See `moirais.fn.describe('gh_c7_7')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_7 import *
import numpy as np
# See the function signature in fn/gh_c7_7.py for argument names.
```
