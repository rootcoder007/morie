# describe('auglag') — augmented_lagrangian
...
`print(result)` render. See `moirais.fn.describe('auglag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.auglag import *
import numpy as np
# See the function signature in fn/auglag.py for argument names.
```
