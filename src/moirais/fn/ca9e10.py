...
def ca_chapter_9_equation_10(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca9e10')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Inference expression involving 'samples' (auto-extracted; see reference for full context)."},
    )
