...
`print(result)` render. See `moirais.fn.describe('ptgfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptgfn import *
import numpy as np
# See the function signature in fn/ptgfn.py for argument names.
```
