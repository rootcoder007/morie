...
`print(result)` render. See `moirais.fn.describe('vgcub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcub import *
import numpy as np
# See the function signature in fn/vgcub.py for argument names.
```
