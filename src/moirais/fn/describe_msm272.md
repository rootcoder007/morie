# describe('msm272') — mvsml_convolutional_nn_eq_14_9
...
`print(result)` render. See `moirais.fn.describe('msm272')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm272 import *
import numpy as np
# See the function signature in fn/msm272.py for argument names.
```
