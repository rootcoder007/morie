...
`print(result)` render. See `moirais.fn.describe('svsut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsut import *
import numpy as np
# See the function signature in fn/svsut.py for argument names.
```
