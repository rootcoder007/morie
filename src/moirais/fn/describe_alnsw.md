...
`print(result)` render. See `moirais.fn.describe('alnsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alnsw import *
import numpy as np
# See the function signature in fn/alnsw.py for argument names.
```
