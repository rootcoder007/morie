...
`print(result)` render. See `moirais.fn.describe('csrip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrip import *
import numpy as np
# See the function signature in fn/csrip.py for argument names.
```
