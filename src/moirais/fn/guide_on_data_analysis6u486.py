...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_486"]


def guide_on_data_analysis_chapter_6_unnumbered_486(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝜃𝑐 = 𝜃𝑐 + 𝜌(𝜃ℎ − 𝜃𝑐)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u486')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u486: GeneralStatistics expression (auto-extracted; see ref)."
