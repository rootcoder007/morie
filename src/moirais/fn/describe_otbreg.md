# describe('otbreg') — ot_bregman_proj
...
`print(result)` render. See `moirais.fn.describe('otbreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otbreg import *
import numpy as np
# See the function signature in fn/otbreg.py for argument names.
```
