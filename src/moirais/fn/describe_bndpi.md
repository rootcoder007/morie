...
`print(result)` render. See `moirais.fn.describe('bndpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpi import *
import numpy as np
# See the function signature in fn/bndpi.py for argument names.
```
