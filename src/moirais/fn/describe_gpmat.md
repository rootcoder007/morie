...
`print(result)` render. See `moirais.fn.describe('gpmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpmat import *
import numpy as np
# See the function signature in fn/gpmat.py for argument names.
```
