# describe('bbern') — bayesian_bernoulli
...
`print(result)` render. See `moirais.fn.describe('bbern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbern import *
import numpy as np
# See the function signature in fn/bbern.py for argument names.
```
