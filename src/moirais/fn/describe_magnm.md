...
`print(result)` render. See `moirais.fn.describe('magnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magnm import *
import numpy as np
# See the function signature in fn/magnm.py for argument names.
```
