# describe('frfgrf') — forest_fit_consistency
...
`print(result)` render. See `moirais.fn.describe('frfgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frfgrf import *
import numpy as np
# See the function signature in fn/frfgrf.py for argument names.
```
