...
`print(result)` render. See `moirais.fn.describe('motfom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.motfom import *
import numpy as np
# See the function signature in fn/motfom.py for argument names.
```
