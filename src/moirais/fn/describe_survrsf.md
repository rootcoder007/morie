# describe('survrsf') — random_survival_forest
...
`print(result)` render. See `moirais.fn.describe('survrsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survrsf import *
import numpy as np
# See the function signature in fn/survrsf.py for argument names.
```
