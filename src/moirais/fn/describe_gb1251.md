# describe('gb1251') — gibbons_partial_tau
...
`print(result)` render. See `moirais.fn.describe('gb1251')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1251 import *
import numpy as np
# See the function signature in fn/gb1251.py for argument names.
```
