...
__all__ = ["hedderich_chapter_9_unnumbered_860"]


def hedderich_chapter_9_unnumbered_860(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (4) P (8.89<X < 15.11) = 0.88;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u860')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u860: GeneralStatistics expression (auto-extracted; see ref)."
