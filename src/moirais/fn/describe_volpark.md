# describe('volpark') — vol_parkinson_range
...
`print(result)` render. See `moirais.fn.describe('volpark')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volpark import *
import numpy as np
# See the function signature in fn/volpark.py for argument names.
```
