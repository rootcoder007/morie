# describe('ipferd') — ipw_with_replicate
...
`print(result)` render. See `moirais.fn.describe('ipferd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipferd import *
import numpy as np
# See the function signature in fn/ipferd.py for argument names.
```
