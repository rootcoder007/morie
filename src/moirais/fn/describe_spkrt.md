# describe('spkrt') — spectral_kurtosis
...
`print(result)` render. See `moirais.fn.describe('spkrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkrt import *
import numpy as np
# See the function signature in fn/spkrt.py for argument names.
```
