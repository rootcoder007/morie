...
`print(result)` render. See `moirais.fn.describe('msink')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msink import *
import numpy as np
# See the function signature in fn/msink.py for argument names.
```
