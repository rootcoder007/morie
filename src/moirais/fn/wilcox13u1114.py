...
__all__ = ["wilcox_chapter_13_unnumbered_1114"]


def wilcox_chapter_13_unnumbered_1114(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outfun = outpro, SEED = TRUE, tr=0.2, crit = NULL, xlab = "X", ylab = "Y",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1114')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1114: GeneralStatistics expression (auto-extracted; see ref)."
