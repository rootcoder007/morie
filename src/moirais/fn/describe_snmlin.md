...
`print(result)` render. See `moirais.fn.describe('snmlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snmlin import *
import numpy as np
# See the function signature in fn/snmlin.py for argument names.
```
