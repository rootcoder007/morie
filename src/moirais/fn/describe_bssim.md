...
`print(result)` render. See `moirais.fn.describe('bssim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bssim import *
import numpy as np
# See the function signature in fn/bssim.py for argument names.
```
