# describe('hrzwfun') — horowitz_nls_weight_function
...
`print(result)` render. See `moirais.fn.describe('hrzwfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzwfun import *
import numpy as np
# See the function signature in fn/hrzwfun.py for argument names.
```
