# describe('fdwarp') — functional_warping
...
`print(result)` render. See `moirais.fn.describe('fdwarp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdwarp import *
import numpy as np
# See the function signature in fn/fdwarp.py for argument names.
```
