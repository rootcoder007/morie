...
__all__ = ["hedderich_chapter_9_unnumbered_2799"]


def hedderich_chapter_9_unnumbered_2799(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] √n√p(ψ−1)−z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2799')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2799: PowerAndDesign expression (auto-extracted; see ref)."
