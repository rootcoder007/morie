# describe('acsamp') — sample_autocorrelation
...
`print(result)` render. See `moirais.fn.describe('acsamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acsamp import *
import numpy as np
# See the function signature in fn/acsamp.py for argument names.
```
