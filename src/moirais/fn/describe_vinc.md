# describe('vinc') — validity_incremental
...
`print(result)` render. See `moirais.fn.describe('vinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vinc import *
import numpy as np
# See the function signature in fn/vinc.py for argument names.
```
