# describe('kabsch') — kabsch_superpose
...
`print(result)` render. See `moirais.fn.describe('kabsch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kabsch import *
import numpy as np
# See the function signature in fn/kabsch.py for argument names.
```
