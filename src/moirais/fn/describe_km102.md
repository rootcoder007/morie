# describe('km102') — kamath_ch6_lstm_chain_rule
...
`print(result)` render. See `moirais.fn.describe('km102')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km102 import *
import numpy as np
# See the function signature in fn/km102.py for argument names.
```
