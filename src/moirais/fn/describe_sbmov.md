...
`print(result)` render. See `moirais.fn.describe('sbmov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbmov import *
import numpy as np
# See the function signature in fn/sbmov.py for argument names.
```
