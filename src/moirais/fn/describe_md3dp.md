...
`print(result)` render. See `moirais.fn.describe('md3dp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.md3dp import *
import numpy as np
# See the function signature in fn/md3dp.py for argument names.
```
