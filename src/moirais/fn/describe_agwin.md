...
`print(result)` render. See `moirais.fn.describe('agwin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agwin import *
import numpy as np
# See the function signature in fn/agwin.py for argument names.
```
