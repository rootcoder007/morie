# describe('hmlof') — geron_local_outlier_factor
...
`print(result)` render. See `moirais.fn.describe('hmlof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlof import *
import numpy as np
# See the function signature in fn/hmlof.py for argument names.
```
