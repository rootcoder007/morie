# describe('dpols') — dp_linear_regression
...
`print(result)` render. See `moirais.fn.describe('dpols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpols import *
import numpy as np
# See the function signature in fn/dpols.py for argument names.
```
