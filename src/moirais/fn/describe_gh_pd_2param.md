# describe('gh_pd_2param') — ghosal_poisson_dirichlet
...
`print(result)` render. See `moirais.fn.describe('gh_pd_2param')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_pd_2param import *
import numpy as np
# See the function signature in fn/gh_pd_2param.py for argument names.
```
