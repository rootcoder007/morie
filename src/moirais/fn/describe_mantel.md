...
`print(result)` render. See `moirais.fn.describe('mantel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mantel import *
import numpy as np
# See the function signature in fn/mantel.py for argument names.
```
