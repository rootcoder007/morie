...
`print(result)` render. See `moirais.fn.describe('cfgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfgrd import *
import numpy as np
# See the function signature in fn/cfgrd.py for argument names.
```
