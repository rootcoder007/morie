...
__all__ = ["hedderich_chapter_9_unnumbered_3514"]


def hedderich_chapter_9_unnumbered_3514(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: χ2-test* ˆχ2 ˆχ2/VIF
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3514')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3514: PowerAndDesign expression (auto-extracted; see ref)."
