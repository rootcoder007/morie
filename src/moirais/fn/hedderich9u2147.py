...
__all__ = ["hedderich_chapter_9_unnumbered_2147"]


def hedderich_chapter_9_unnumbered_2147(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] d=0.2; P(X>Y)=0.56
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2147')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2147: GeneralStatistics expression (auto-extracted; see ref)."
