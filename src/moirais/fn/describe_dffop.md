...
`print(result)` render. See `moirais.fn.describe('dffop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dffop import *
import numpy as np
# See the function signature in fn/dffop.py for argument names.
```
