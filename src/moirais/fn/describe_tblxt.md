# describe('tblxt') — extract_tables

## WHAT IT DOES

HTML table extractor. 'Real knowledge is to know the extent of one's ignorance. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('tblxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tblxt import *
import numpy as np
# See the function signature in fn/tblxt.py for argument names.
```
