...
__all__ = ["hedderich_chapter_9_unnumbered_720"]


def hedderich_chapter_9_unnumbered_720(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] ·0.0013·0.9991997 = 0.1805; Task b) P (> 2P at.···) = 0 .3233.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u720')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u720: CountModels expression (auto-extracted; see ref)."
