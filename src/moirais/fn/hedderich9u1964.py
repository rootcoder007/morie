...
__all__ = ["hedderich_chapter_9_unnumbered_1964"]


def hedderich_chapter_9_unnumbered_1964(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + stat <− sn / sd ; p <− pchisq ( stat , df =K−1 , lower . tail =F )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1964')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1964: GeneralStatistics expression (auto-extracted; see ref)."
