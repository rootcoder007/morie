...
`print(result)` render. See `moirais.fn.describe('sdmconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmconv import *
import numpy as np
# See the function signature in fn/sdmconv.py for argument names.
```
