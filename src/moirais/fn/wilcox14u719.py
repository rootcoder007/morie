...
__all__ = ["wilcox_chapter_14_unnumbered_719"]


def wilcox_chapter_14_unnumbered_719(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: δ jk =θ j − θ k,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u719')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u719: Resampling expression (auto-extracted; see ref)."
