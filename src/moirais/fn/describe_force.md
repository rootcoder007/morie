...
`print(result)` render. See `moirais.fn.describe('force')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.force import *
import numpy as np
# See the function signature in fn/force.py for argument names.
```
