# describe('splfun') — schabenberger_l_function
...
`print(result)` render. See `moirais.fn.describe('splfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splfun import *
import numpy as np
# See the function signature in fn/splfun.py for argument names.
```
