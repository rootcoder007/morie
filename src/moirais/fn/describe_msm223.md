# describe('msm223') — mvsml_ridge_lasso_elastic_eq_9_38
...
`print(result)` render. See `moirais.fn.describe('msm223')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm223 import *
import numpy as np
# See the function signature in fn/msm223.py for argument names.
```
