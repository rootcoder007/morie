...
__all__ = ["hedderich_chapter_9_unnumbered_2602"]


def hedderich_chapter_9_unnumbered_2602(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 ={|5·6−25|−(5 + 1)/2}2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2602')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2602: GeneralStatistics expression (auto-extracted; see ref)."
