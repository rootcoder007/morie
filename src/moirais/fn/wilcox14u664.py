...
__all__ = ["wilcox_chapter_14_unnumbered_664"]


def wilcox_chapter_14_unnumbered_664(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: N = 10 + 10 + 10 = 30,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u664')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u664: GeneralStatistics expression (auto-extracted; see ref)."
