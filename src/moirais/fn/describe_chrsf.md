...
`print(result)` render. See `moirais.fn.describe('chrsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chrsf import *
import numpy as np
# See the function signature in fn/chrsf.py for argument names.
```
