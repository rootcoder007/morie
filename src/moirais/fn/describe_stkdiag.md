...
`print(result)` render. See `moirais.fn.describe('stkdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkdiag import *
import numpy as np
# See the function signature in fn/stkdiag.py for argument names.
```
