# describe('relu6') — relu6

## WHAT IT DOES

rReLU6 activation function.
...
`print(result)` render. See `moirais.fn.describe('relu6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relu6 import *
import numpy as np
# See the function signature in fn/relu6.py for argument names.
```
