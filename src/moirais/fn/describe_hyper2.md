# describe('hyper2') — hyperparam_optim_gp
...
`print(result)` render. See `moirais.fn.describe('hyper2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyper2 import *
import numpy as np
# See the function signature in fn/hyper2.py for argument names.
```
