# describe('tssae') — tssae

## WHAT IT DOES

Space-time autoencoder
...
`print(result)` render. See `moirais.fn.describe('tssae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssae import *
import numpy as np
# See the function signature in fn/tssae.py for argument names.
```
