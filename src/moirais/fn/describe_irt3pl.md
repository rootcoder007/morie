# describe('irt3pl') — three_parameter_logistic
...
`print(result)` render. See `moirais.fn.describe('irt3pl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt3pl import *
import numpy as np
# See the function signature in fn/irt3pl.py for argument names.
```
