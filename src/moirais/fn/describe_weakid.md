# describe('weakid') — weak_identification_mediation
...
`print(result)` render. See `moirais.fn.describe('weakid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weakid import *
import numpy as np
# See the function signature in fn/weakid.py for argument names.
```
