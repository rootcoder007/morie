# describe('grapl') — geron_average_pooling
...
`print(result)` render. See `moirais.fn.describe('grapl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grapl import *
import numpy as np
# See the function signature in fn/grapl.py for argument names.
```
