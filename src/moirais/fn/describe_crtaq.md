# describe('crtaq') — court_acquittal
...
`print(result)` render. See `moirais.fn.describe('crtaq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtaq import *
import numpy as np
# See the function signature in fn/crtaq.py for argument names.
```
