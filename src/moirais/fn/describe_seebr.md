# describe('seebr') — seebr

## WHAT IT DOES

Empirical Bayes rate mapping
...
`print(result)` render. See `moirais.fn.describe('seebr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seebr import *
import numpy as np
# See the function signature in fn/seebr.py for argument names.
```
