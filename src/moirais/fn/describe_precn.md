...
`print(result)` render. See `moirais.fn.describe('precn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.precn import *
import numpy as np
# See the function signature in fn/precn.py for argument names.
```
