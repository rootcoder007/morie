# describe('gb661s') — gibbons_mw_sampsize
...
`print(result)` render. See `moirais.fn.describe('gb661s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb661s import *
import numpy as np
# See the function signature in fn/gb661s.py for argument names.
```
