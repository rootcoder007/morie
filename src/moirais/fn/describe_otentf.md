# describe('otentf') — ot_free_energy
...
`print(result)` render. See `moirais.fn.describe('otentf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otentf import *
import numpy as np
# See the function signature in fn/otentf.py for argument names.
```
