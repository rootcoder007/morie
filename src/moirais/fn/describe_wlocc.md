...
`print(result)` render. See `moirais.fn.describe('wlocc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlocc import *
import numpy as np
# See the function signature in fn/wlocc.py for argument names.
```
