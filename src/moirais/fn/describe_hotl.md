...
`print(result)` render. See `moirais.fn.describe('hotl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotl import *
import numpy as np
# See the function signature in fn/hotl.py for argument names.
```
