# describe('albio') — alammar_bio_tagging
...
`print(result)` render. See `moirais.fn.describe('albio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.albio import *
import numpy as np
# See the function signature in fn/albio.py for argument names.
```
