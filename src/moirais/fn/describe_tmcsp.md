...
`print(result)` render. See `moirais.fn.describe('tmcsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmcsp import *
import numpy as np
# See the function signature in fn/tmcsp.py for argument names.
```
