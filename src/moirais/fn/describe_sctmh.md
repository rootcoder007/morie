...
`print(result)` render. See `moirais.fn.describe('sctmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sctmh import *
import numpy as np
# See the function signature in fn/sctmh.py for argument names.
```
