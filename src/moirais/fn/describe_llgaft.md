# describe('llgaft') — log_logistic_aft
...
`print(result)` render. See `moirais.fn.describe('llgaft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.llgaft import *
import numpy as np
# See the function signature in fn/llgaft.py for argument names.
```
