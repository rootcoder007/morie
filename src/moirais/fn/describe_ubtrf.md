...
`print(result)` render. See `moirais.fn.describe('ubtrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubtrf import *
import numpy as np
# See the function signature in fn/ubtrf.py for argument names.
```
