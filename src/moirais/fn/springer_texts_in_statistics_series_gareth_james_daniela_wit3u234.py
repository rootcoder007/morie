...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_234"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_234(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Y −ˆβ1X1 = β0 +β2X2 +ϵ.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u234')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u234: GeneralStatistics expression (auto-extracted; see ref)."
