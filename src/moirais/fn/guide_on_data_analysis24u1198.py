...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1198"]


def guide_on_data_analysis_chapter_24_unnumbered_1198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (𝑌𝑖𝑗𝑘 − ̄𝑌...)2 = 𝑏𝑛 ∑
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1198')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1198: GeneralStatistics expression (auto-extracted; see ref)."
