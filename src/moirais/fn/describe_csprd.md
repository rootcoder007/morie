# describe('csprd') — csprd

## WHAT IT DOES

Predictive policing spatial
...
`print(result)` render. See `moirais.fn.describe('csprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csprd import *
import numpy as np
# See the function signature in fn/csprd.py for argument names.
```
