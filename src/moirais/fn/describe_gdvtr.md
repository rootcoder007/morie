...
`print(result)` render. See `moirais.fn.describe('gdvtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdvtr import *
import numpy as np
# See the function signature in fn/gdvtr.py for argument names.
```
