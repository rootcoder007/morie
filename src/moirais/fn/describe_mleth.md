# describe('mleth') — mle_theta_estimator
...
`print(result)` render. See `moirais.fn.describe('mleth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mleth import *
import numpy as np
# See the function signature in fn/mleth.py for argument names.
```
