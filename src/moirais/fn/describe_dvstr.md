...
`print(result)` render. See `moirais.fn.describe('dvstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dvstr import *
import numpy as np
# See the function signature in fn/dvstr.py for argument names.
```
