# describe('hmlcos') — geron_cosine_annealing
...
`print(result)` render. See `moirais.fn.describe('hmlcos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlcos import *
import numpy as np
# See the function signature in fn/hmlcos.py for argument names.
```
