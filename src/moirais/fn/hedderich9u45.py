...
__all__ = ["hedderich_chapter_9_unnumbered_45"]


def hedderich_chapter_9_unnumbered_45(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u45')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u45: PowerAndDesign expression (auto-extracted; see ref)."
