# describe('dpchpr') — dp_changepoint
...
`print(result)` render. See `moirais.fn.describe('dpchpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpchpr import *
import numpy as np
# See the function signature in fn/dpchpr.py for argument names.
```
