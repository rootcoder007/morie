...
`print(result)` render. See `moirais.fn.describe('aglst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglst import *
import numpy as np
# See the function signature in fn/aglst.py for argument names.
```
