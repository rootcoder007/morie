# describe('sntmn') — sentence_mandatory_min
...
`print(result)` render. See `moirais.fn.describe('sntmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntmn import *
import numpy as np
# See the function signature in fn/sntmn.py for argument names.
```
