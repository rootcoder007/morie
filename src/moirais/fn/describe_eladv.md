...
`print(result)` render. See `moirais.fn.describe('eladv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eladv import *
import numpy as np
# See the function signature in fn/eladv.py for argument names.
```
