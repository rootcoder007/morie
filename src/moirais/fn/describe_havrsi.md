...
`print(result)` render. See `moirais.fn.describe('havrsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.havrsi import *
import numpy as np
# See the function signature in fn/havrsi.py for argument names.
```
