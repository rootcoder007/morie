...
`print(result)` render. See `moirais.fn.describe('sawcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawcn import *
import numpy as np
# See the function signature in fn/sawcn.py for argument names.
```
