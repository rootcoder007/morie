# describe('vacthr') — vaccination_threshold
...
`print(result)` render. See `moirais.fn.describe('vacthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vacthr import *
import numpy as np
# See the function signature in fn/vacthr.py for argument names.
```
