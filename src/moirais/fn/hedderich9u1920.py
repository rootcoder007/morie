...
__all__ = ["hedderich_chapter_9_unnumbered_1920"]


def hedderich_chapter_9_unnumbered_1920(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1920')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1920: PowerAndDesign expression (auto-extracted; see ref)."
