...
__all__ = ["hedderich_chapter_9_unnumbered_84"]


def hedderich_chapter_9_unnumbered_84(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u84')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u84: GeneralStatistics expression (auto-extracted; see ref)."
