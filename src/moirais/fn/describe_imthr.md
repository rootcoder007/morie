...
`print(result)` render. See `moirais.fn.describe('imthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imthr import *
import numpy as np
# See the function signature in fn/imthr.py for argument names.
```
