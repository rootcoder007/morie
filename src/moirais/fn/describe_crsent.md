...
`print(result)` render. See `moirais.fn.describe('crsent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsent import *
import numpy as np
# See the function signature in fn/crsent.py for argument names.
```
