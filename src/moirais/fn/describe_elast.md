...
`print(result)` render. See `moirais.fn.describe('elast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elast import *
import numpy as np
# See the function signature in fn/elast.py for argument names.
```
