...
`print(result)` render. See `moirais.fn.describe('ucbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ucbb import *
import numpy as np
# See the function signature in fn/ucbb.py for argument names.
```
