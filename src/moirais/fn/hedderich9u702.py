...
__all__ = ["hedderich_chapter_9_unnumbered_702"]


def hedderich_chapter_9_unnumbered_702(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x + 1P (X =x) or P (X =x−1) = x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u702')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u702: GeneralStatistics expression (auto-extracted; see ref)."
