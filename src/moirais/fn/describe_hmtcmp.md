# describe('hmtcmp') — geron_torch_compile
...
`print(result)` render. See `moirais.fn.describe('hmtcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtcmp import *
import numpy as np
# See the function signature in fn/hmtcmp.py for argument names.
```
