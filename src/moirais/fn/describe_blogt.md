# describe('blogt') — bayesian_logistic
...
`print(result)` render. See `moirais.fn.describe('blogt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blogt import *
import numpy as np
# See the function signature in fn/blogt.py for argument names.
```
