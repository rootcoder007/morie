# describe('bkngr') — burkov_ngram_mle
...
`print(result)` render. See `moirais.fn.describe('bkngr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkngr import *
import numpy as np
# See the function signature in fn/bkngr.py for argument names.
```
