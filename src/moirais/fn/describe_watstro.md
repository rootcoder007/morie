# describe('watstro') — watts_strogatz
...
`print(result)` render. See `moirais.fn.describe('watstro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.watstro import *
import numpy as np
# See the function signature in fn/watstro.py for argument names.
```
