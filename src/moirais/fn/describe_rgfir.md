# describe('rgfir') — rangayyan_fir_filter
...
`print(result)` render. See `moirais.fn.describe('rgfir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfir import *
import numpy as np
# See the function signature in fn/rgfir.py for argument names.
```
