# describe('mcar') — littles_mcar_test
...
`print(result)` render. See `moirais.fn.describe('mcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcar import *
import numpy as np
# See the function signature in fn/mcar.py for argument names.
```
