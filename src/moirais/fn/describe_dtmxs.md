...
`print(result)` render. See `moirais.fn.describe('dtmxs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmxs import *
import numpy as np
# See the function signature in fn/dtmxs.py for argument names.
```
