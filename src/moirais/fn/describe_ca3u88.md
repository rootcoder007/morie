# describe('ca3u88') — ca_chapter_3_unnumbered_88
...
y = 2.325 + 0.159x1 − 0.006 1 :68() + 0.014x1 1.68()
...
```python
from moirais.fn.ca3u88 import ca_chapter_3_unnumbered_88
import numpy as np
result = ca_chapter_3_unnumbered_88(np.random.default_rng(42).normal(0, 1, 100))
