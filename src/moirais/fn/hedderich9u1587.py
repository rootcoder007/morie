...
__all__ = ["hedderich_chapter_9_unnumbered_1587"]


def hedderich_chapter_9_unnumbered_1587(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If one chooses α=β, the probabilities of type 1 and type 2 errors are equal. Often, one simply
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1587')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1587: GeneralStatistics expression (auto-extracted; see ref)."
