# describe('gh_c11_5') — ghosal_gp_binreg_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c11_5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_5 import *
import numpy as np
# See the function signature in fn/gh_c11_5.py for argument names.
```
