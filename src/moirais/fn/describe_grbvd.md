# describe('grbvd') — geron_bias_variance_decomposition
...
`print(result)` render. See `moirais.fn.describe('grbvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbvd import *
import numpy as np
# See the function signature in fn/grbvd.py for argument names.
```
