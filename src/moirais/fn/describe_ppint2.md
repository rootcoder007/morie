...
`print(result)` render. See `moirais.fn.describe('ppint2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppint2 import *
import numpy as np
# See the function signature in fn/ppint2.py for argument names.
```
