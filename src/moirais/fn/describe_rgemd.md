...
`print(result)` render. See `moirais.fn.describe('rgemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemd import *
import numpy as np
# See the function signature in fn/rgemd.py for argument names.
```
