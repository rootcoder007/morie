...
def neighborhood_structures_and_crime_a_spatial_analysis_george__chapter_2_unnumbered_9(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('neighborhood_structures_and_crime_a_spatial_analysis_george_2u9')`` for the full guide.
...
def cheatsheet():
    return "neighborhood_structures_and_crime_a_spatial_analysis_george_2u9: Association expression (auto-extracted; see ref)."
