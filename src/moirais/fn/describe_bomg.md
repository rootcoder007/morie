...
`print(result)` render. See `moirais.fn.describe('bomg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bomg import *
import numpy as np
# See the function signature in fn/bomg.py for argument names.
```
