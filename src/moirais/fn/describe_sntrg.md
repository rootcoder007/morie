# describe('sntrg') — sentence_by_region
...
`print(result)` render. See `moirais.fn.describe('sntrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntrg import *
import numpy as np
# See the function signature in fn/sntrg.py for argument names.
```
