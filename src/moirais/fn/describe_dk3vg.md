...
`print(result)` render. See `moirais.fn.describe('dk3vg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3vg import *
import numpy as np
# See the function signature in fn/dk3vg.py for argument names.
```
