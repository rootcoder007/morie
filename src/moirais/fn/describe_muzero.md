...
`print(result)` render. See `moirais.fn.describe('muzero')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.muzero import *
import numpy as np
# See the function signature in fn/muzero.py for argument names.
```
