...
`print(result)` render. See `moirais.fn.describe('vgbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgbin import *
import numpy as np
# See the function signature in fn/vgbin.py for argument names.
```
