...
__all__ = ["wilcox_chapter_14_unnumbered_642"]


def wilcox_chapter_14_unnumbered_642(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 23, − 8, then U1 = 2 because after taking absolute values, 6 has a rank of 2. Similarly, U2 = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u642')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u642: GeneralStatistics expression (auto-extracted; see ref)."
