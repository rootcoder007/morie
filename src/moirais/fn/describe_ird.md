# describe('ird') — incidence_rate_difference
...
`print(result)` render. See `moirais.fn.describe('ird')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ird import *
import numpy as np
# See the function signature in fn/ird.py for argument names.
```
