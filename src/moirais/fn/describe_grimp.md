# describe('grimp') — geron_simple_imputer
...
`print(result)` render. See `moirais.fn.describe('grimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grimp import *
import numpy as np
# See the function signature in fn/grimp.py for argument names.
```
