# describe('hmfth') — geron_finetune_lm
...
`print(result)` render. See `moirais.fn.describe('hmfth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfth import *
import numpy as np
# See the function signature in fn/hmfth.py for argument names.
```
