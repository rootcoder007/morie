# describe('stexp') — stexp

## WHAT IT DOES

Space-time product-sum covariance.
...
`print(result)` render. See `moirais.fn.describe('stexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stexp import *
import numpy as np
# See the function signature in fn/stexp.py for argument names.
```
