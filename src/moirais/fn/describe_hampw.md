# describe('hampw') — hampel_three_part
...
`print(result)` render. See `moirais.fn.describe('hampw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hampw import *
import numpy as np
# See the function signature in fn/hampw.py for argument names.
```
