# describe('msm019') — mvsml_linear_mixed_models_eq_5_1
...
`print(result)` render. See `moirais.fn.describe('msm019')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm019 import *
import numpy as np
# See the function signature in fn/msm019.py for argument names.
```
