# describe('gb_mw2') — gibbons_mw_rs_equiv
...
`print(result)` render. See `moirais.fn.describe('gb_mw2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_mw2 import *
import numpy as np
# See the function signature in fn/gb_mw2.py for argument names.
```
