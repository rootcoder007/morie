...
`print(result)` render. See `moirais.fn.describe('swchr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swchr import *
import numpy as np
# See the function signature in fn/swchr.py for argument names.
```
