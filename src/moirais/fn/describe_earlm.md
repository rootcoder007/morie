...
`print(result)` render. See `moirais.fn.describe('earlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.earlm import *
import numpy as np
# See the function signature in fn/earlm.py for argument names.
```
