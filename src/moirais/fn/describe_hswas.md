...
`print(result)` render. See `moirais.fn.describe('hswas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hswas import *
import numpy as np
# See the function signature in fn/hswas.py for argument names.
```
