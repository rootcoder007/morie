...
`print(result)` render. See `moirais.fn.describe('rocau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rocau import *
import numpy as np
# See the function signature in fn/rocau.py for argument names.
```
