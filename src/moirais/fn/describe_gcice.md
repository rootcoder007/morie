...
`print(result)` render. See `moirais.fn.describe('gcice')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcice import *
import numpy as np
# See the function signature in fn/gcice.py for argument names.
```
