...
`print(result)` render. See `moirais.fn.describe('rgcwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcwt import *
import numpy as np
# See the function signature in fn/rgcwt.py for argument names.
```
