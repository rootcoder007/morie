...
`print(result)` render. See `moirais.fn.describe('wlibr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlibr import *
import numpy as np
# See the function signature in fn/wlibr.py for argument names.
```
