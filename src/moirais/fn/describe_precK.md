...
`print(result)` render. See `moirais.fn.describe('precK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.precK import *
import numpy as np
# See the function signature in fn/precK.py for argument names.
```
