# describe('copgau') — gaussian_copula
...
`print(result)` render. See `moirais.fn.describe('copgau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copgau import *
import numpy as np
# See the function signature in fn/copgau.py for argument names.
```
