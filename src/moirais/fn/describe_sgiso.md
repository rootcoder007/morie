...
`print(result)` render. See `moirais.fn.describe('sgiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgiso import *
import numpy as np
# See the function signature in fn/sgiso.py for argument names.
```
