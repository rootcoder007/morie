# describe('wfrep') — weighted_frequency
...
`print(result)` render. See `moirais.fn.describe('wfrep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wfrep import *
import numpy as np
# See the function signature in fn/wfrep.py for argument names.
```
