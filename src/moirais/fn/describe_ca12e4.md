# describe('ca12e4') — ca_chapter_12_equation_4
...
```python
from moirais.fn.ca12e4 import ca_chapter_12_equation_4
import numpy as np
result = ca_chapter_12_equation_4(np.random.default_rng(42).normal(0, 1, 100))
