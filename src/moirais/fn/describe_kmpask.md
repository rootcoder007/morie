# describe('kmpask') — kamath_pass_at_k
...
`print(result)` render. See `moirais.fn.describe('kmpask')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpask import *
import numpy as np
# See the function signature in fn/kmpask.py for argument names.
```
