# describe('conv1') — conv1

## WHAT IT DOES

r1D convolution (valid/same/full).
...
`print(result)` render. See `moirais.fn.describe('conv1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.conv1 import *
import numpy as np
# See the function signature in fn/conv1.py for argument names.
```
