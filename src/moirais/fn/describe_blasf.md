# describe('blasf') — bayesian_lasso_full
...
`print(result)` render. See `moirais.fn.describe('blasf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blasf import *
import numpy as np
# See the function signature in fn/blasf.py for argument names.
```
