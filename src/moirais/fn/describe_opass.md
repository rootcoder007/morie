...
`print(result)` render. See `moirais.fn.describe('opass')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opass import *
import numpy as np
# See the function signature in fn/opass.py for argument names.
```
