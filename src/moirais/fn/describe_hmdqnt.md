# describe('hmdqnt') — geron_dynamic_quantization
...
`print(result)` render. See `moirais.fn.describe('hmdqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdqnt import *
import numpy as np
# See the function signature in fn/hmdqnt.py for argument names.
```
