...
`print(result)` render. See `moirais.fn.describe('wsmbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbic import *
import numpy as np
# See the function signature in fn/wsmbic.py for argument names.
```
