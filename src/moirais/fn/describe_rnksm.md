...
`print(result)` render. See `moirais.fn.describe('rnksm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnksm import *
import numpy as np
# See the function signature in fn/rnksm.py for argument names.
```
