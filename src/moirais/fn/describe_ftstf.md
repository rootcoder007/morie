# describe('ftstf') — f_test_features
...
`print(result)` render. See `moirais.fn.describe('ftstf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ftstf import *
import numpy as np
# See the function signature in fn/ftstf.py for argument names.
```
