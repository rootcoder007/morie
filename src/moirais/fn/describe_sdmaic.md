...
`print(result)` render. See `moirais.fn.describe('sdmaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmaic import *
import numpy as np
# See the function signature in fn/sdmaic.py for argument names.
```
