...
`print(result)` render. See `moirais.fn.describe('matnK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matnK import *
import numpy as np
# See the function signature in fn/matnK.py for argument names.
```
