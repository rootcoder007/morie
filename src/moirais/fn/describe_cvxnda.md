# describe('cvxnda') — boyd_newton_decrement
...
`print(result)` render. See `moirais.fn.describe('cvxnda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxnda import *
import numpy as np
# See the function signature in fn/cvxnda.py for argument names.
```
