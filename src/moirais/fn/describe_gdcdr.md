...
`print(result)` render. See `moirais.fn.describe('gdcdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdcdr import *
import numpy as np
# See the function signature in fn/gdcdr.py for argument names.
```
