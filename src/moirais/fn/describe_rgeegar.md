# describe('rgeegar') — rangayyan_eeg_autocorr
...
`print(result)` render. See `moirais.fn.describe('rgeegar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeegar import *
import numpy as np
# See the function signature in fn/rgeegar.py for argument names.
```
