...
`print(result)` render. See `moirais.fn.describe('spcphs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcphs import *
import numpy as np
# See the function signature in fn/spcphs.py for argument names.
```
