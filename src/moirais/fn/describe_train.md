...
`print(result)` render. See `moirais.fn.describe('train')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.train import *
import numpy as np
# See the function signature in fn/train.py for argument names.
```
