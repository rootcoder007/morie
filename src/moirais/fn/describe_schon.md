...
`print(result)` render. See `moirais.fn.describe('schon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.schon import *
import numpy as np
# See the function signature in fn/schon.py for argument names.
```
