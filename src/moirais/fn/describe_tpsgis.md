# describe('tpsgis') — tps_geo_analysis
...
`print(result)` render. See `moirais.fn.describe('tpsgis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsgis import *
import numpy as np
# See the function signature in fn/tpsgis.py for argument names.
```
