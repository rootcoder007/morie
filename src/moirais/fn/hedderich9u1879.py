...
__all__ = ["hedderich_chapter_9_unnumbered_1879"]


def hedderich_chapter_9_unnumbered_1879(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1879')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1879: GeneralStatistics expression (auto-extracted; see ref)."
