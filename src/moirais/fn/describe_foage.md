# describe('foage') — foage

## WHAT IT DOES

Age class distribution spatial
...
`print(result)` render. See `moirais.fn.describe('foage')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foage import *
import numpy as np
# See the function signature in fn/foage.py for argument names.
```
