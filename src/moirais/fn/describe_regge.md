# describe('regge') — regge_trajectory
...
`print(result)` render. See `moirais.fn.describe('regge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.regge import *
import numpy as np
# See the function signature in fn/regge.py for argument names.
```
