# describe('cdmrt') — cause_specific_mortality
...
`print(result)` render. See `moirais.fn.describe('cdmrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdmrt import *
import numpy as np
# See the function signature in fn/cdmrt.py for argument names.
```
