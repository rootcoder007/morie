...
`print(result)` render. See `moirais.fn.describe('grogu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grogu import *
import numpy as np
# See the function signature in fn/grogu.py for argument names.
```
