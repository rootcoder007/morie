# describe('lmsaf') — lms_adaptive_filter
...
`print(result)` render. See `moirais.fn.describe('lmsaf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmsaf import *
import numpy as np
# See the function signature in fn/lmsaf.py for argument names.
```
