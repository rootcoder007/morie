# describe('alien') — alienation_index
...
`print(result)` render. See `moirais.fn.describe('alien')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alien import *
import numpy as np
# See the function signature in fn/alien.py for argument names.
```
