...
__all__ = ["hedderich_chapter_9_unnumbered_2274"]


def hedderich_chapter_9_unnumbered_2274(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For example, for n1=7 andn2=13 formula (7.175) is not fulfilled, since 3+ 4·7
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2274')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2274: GeneralStatistics expression (auto-extracted; see ref)."
