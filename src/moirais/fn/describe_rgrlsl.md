# describe('rgrlsl') — rangayyan_rls_lattice
...
`print(result)` render. See `moirais.fn.describe('rgrlsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrlsl import *
import numpy as np
# See the function signature in fn/rgrlsl.py for argument names.
```
