# describe('gb_blt') — gibbons_balance_incomplete
...
`print(result)` render. See `moirais.fn.describe('gb_blt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_blt import *
import numpy as np
# See the function signature in fn/gb_blt.py for argument names.
```
