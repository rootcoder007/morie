# describe('hmhebb') — geron_hebb_rule
...
`print(result)` render. See `moirais.fn.describe('hmhebb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhebb import *
import numpy as np
# See the function signature in fn/hmhebb.py for argument names.
```
