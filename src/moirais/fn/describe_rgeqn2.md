# describe('rgeqn2') — rangayyan_ch2_multivariate
...
`print(result)` render. See `moirais.fn.describe('rgeqn2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn2 import *
import numpy as np
# See the function signature in fn/rgeqn2.py for argument names.
```
