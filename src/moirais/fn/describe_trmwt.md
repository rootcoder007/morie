# describe('trmwt') — trimmed_weights
...
`print(result)` render. See `moirais.fn.describe('trmwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmwt import *
import numpy as np
# See the function signature in fn/trmwt.py for argument names.
```
