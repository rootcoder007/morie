...
`print(result)` render. See `moirais.fn.describe('geseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geseg import *
import numpy as np
# See the function signature in fn/geseg.py for argument names.
```
