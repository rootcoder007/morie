# describe('gh_c11_8') — ghosal_fbm_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c11_8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_8 import *
import numpy as np
# See the function signature in fn/gh_c11_8.py for argument names.
```
