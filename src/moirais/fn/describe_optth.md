# describe('optth') — optimal_threshold
...
`print(result)` render. See `moirais.fn.describe('optth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optth import *
import numpy as np
# See the function signature in fn/optth.py for argument names.
```
