# describe('hkeye') — precision_recall_at_k
...
`print(result)` render. See `moirais.fn.describe('hkeye')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hkeye import *
import numpy as np
# See the function signature in fn/hkeye.py for argument names.
```
