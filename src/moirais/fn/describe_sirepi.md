# describe('sirepi') — sir_compartmental
...
`print(result)` render. See `moirais.fn.describe('sirepi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirepi import *
import numpy as np
# See the function signature in fn/sirepi.py for argument names.
```
