# describe('ld') — linkage_disequilibrium
...
`print(result)` render. See `moirais.fn.describe('ld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ld import *
import numpy as np
# See the function signature in fn/ld.py for argument names.
```
