# describe('tmlinf') — tmle_inference
...
`print(result)` render. See `moirais.fn.describe('tmlinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlinf import *
import numpy as np
# See the function signature in fn/tmlinf.py for argument names.
```
