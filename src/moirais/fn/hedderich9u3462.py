...
__all__ = ["hedderich_chapter_9_unnumbered_3462"]


def hedderich_chapter_9_unnumbered_3462(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : θ= π11/π21
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3462')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3462: GeneralStatistics expression (auto-extracted; see ref)."
