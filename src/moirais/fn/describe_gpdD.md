# describe('gpdD') — gpd_distribution
...
`print(result)` render. See `moirais.fn.describe('gpdD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpdD import *
import numpy as np
# See the function signature in fn/gpdD.py for argument names.
```
