...
`print(result)` render. See `moirais.fn.describe('ultro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ultro import *
import numpy as np
# See the function signature in fn/ultro.py for argument names.
```
