...
`print(result)` render. See `moirais.fn.describe('bmsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmsim import *
import numpy as np
# See the function signature in fn/bmsim.py for argument names.
```
