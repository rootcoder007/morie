...
`print(result)` render. See `moirais.fn.describe('plr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plr import *
import numpy as np
# See the function signature in fn/plr.py for argument names.
```
