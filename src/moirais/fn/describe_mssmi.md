...
`print(result)` render. See `moirais.fn.describe('mssmi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssmi import *
import numpy as np
# See the function signature in fn/mssmi.py for argument names.
```
