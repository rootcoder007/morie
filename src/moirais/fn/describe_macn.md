...
`print(result)` render. See `moirais.fn.describe('macn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.macn import *
import numpy as np
# See the function signature in fn/macn.py for argument names.
```
