...
`print(result)` render. See `moirais.fn.describe('chlrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlrng import *
import numpy as np
# See the function signature in fn/chlrng.py for argument names.
```
