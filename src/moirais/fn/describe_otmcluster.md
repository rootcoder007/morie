# describe('otmcluster') — ot_clustering_w
...
`print(result)` render. See `moirais.fn.describe('otmcluster')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmcluster import *
import numpy as np
# See the function signature in fn/otmcluster.py for argument names.
```
