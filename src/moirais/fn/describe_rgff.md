# describe('rgff') — rangayyan_form_factor
...
`print(result)` render. See `moirais.fn.describe('rgff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgff import *
import numpy as np
# See the function signature in fn/rgff.py for argument names.
```
