# describe('gh_ap_g2') — ghosal_dir_moments
...
`print(result)` render. See `moirais.fn.describe('gh_ap_g2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_g2 import *
import numpy as np
# See the function signature in fn/gh_ap_g2.py for argument names.
```
