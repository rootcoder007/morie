...
`print(result)` render. See `moirais.fn.describe('wrd2v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wrd2v import *
import numpy as np
# See the function signature in fn/wrd2v.py for argument names.
```
