...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_921"]


def guide_on_data_analysis_chapter_16_unnumbered_921(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] −2ln(Λ) = −2ln (𝐿𝑟
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u921')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u921: GeneralStatistics expression (auto-extracted; see ref)."
