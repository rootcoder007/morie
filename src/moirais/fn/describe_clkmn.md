...
`print(result)` render. See `moirais.fn.describe('clkmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clkmn import *
import numpy as np
# See the function signature in fn/clkmn.py for argument names.
```
