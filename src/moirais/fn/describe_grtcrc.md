...
`print(result)` render. See `moirais.fn.describe('grtcrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtcrc import *
import numpy as np
# See the function signature in fn/grtcrc.py for argument names.
```
