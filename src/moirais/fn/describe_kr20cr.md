# describe('kr20cr') — kuder_richardson_20
...
`print(result)` render. See `moirais.fn.describe('kr20cr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kr20cr import *
import numpy as np
# See the function signature in fn/kr20cr.py for argument names.
```
