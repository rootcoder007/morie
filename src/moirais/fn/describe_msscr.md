...
`print(result)` render. See `moirais.fn.describe('msscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msscr import *
import numpy as np
# See the function signature in fn/msscr.py for argument names.
```
