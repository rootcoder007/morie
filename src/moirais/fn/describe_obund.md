...
`print(result)` render. See `moirais.fn.describe('obund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.obund import *
import numpy as np
# See the function signature in fn/obund.py for argument names.
```
