# describe('poltre') — polya_tree_prior
...
`print(result)` render. See `moirais.fn.describe('poltre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poltre import *
import numpy as np
# See the function signature in fn/poltre.py for argument names.
```
