# describe('linkmm') — linking_meanmean
...
`print(result)` render. See `moirais.fn.describe('linkmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linkmm import *
import numpy as np
# See the function signature in fn/linkmm.py for argument names.
```
