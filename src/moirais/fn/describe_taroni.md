...
`print(result)` render. See `moirais.fn.describe('taroni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taroni import *
import numpy as np
# See the function signature in fn/taroni.py for argument names.
```
