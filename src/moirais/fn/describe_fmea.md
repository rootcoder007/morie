...
`print(result)` render. See `moirais.fn.describe('fmea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fmea import *
import numpy as np
# See the function signature in fn/fmea.py for argument names.
```
