...
`print(result)` render. See `moirais.fn.describe('elent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elent import *
import numpy as np
# See the function signature in fn/elent.py for argument names.
```
