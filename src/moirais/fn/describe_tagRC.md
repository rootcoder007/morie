...
`print(result)` render. See `moirais.fn.describe('tagRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tagRC import *
import numpy as np
# See the function signature in fn/tagRC.py for argument names.
```
