...
`print(result)` render. See `moirais.fn.describe('dtcfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcfa import *
import numpy as np
# See the function signature in fn/dtcfa.py for argument names.
```
