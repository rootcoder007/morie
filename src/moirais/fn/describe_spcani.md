...
`print(result)` render. See `moirais.fn.describe('spcani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcani import *
import numpy as np
# See the function signature in fn/spcani.py for argument names.
```
