# describe('gb_kw2') — gibbons_kw_alt_form
...
`print(result)` render. See `moirais.fn.describe('gb_kw2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_kw2 import *
import numpy as np
# See the function signature in fn/gb_kw2.py for argument names.
```
