...
`print(result)` render. See `moirais.fn.describe('pldst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pldst import *
import numpy as np
# See the function signature in fn/pldst.py for argument names.
```
