# describe('oirt') — ordinal_irt_model
...
`print(result)` render. See `moirais.fn.describe('oirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oirt import *
import numpy as np
# See the function signature in fn/oirt.py for argument names.
```
