# describe('evrlci') — evt_return_level_ci
...
`print(result)` render. See `moirais.fn.describe('evrlci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evrlci import *
import numpy as np
# See the function signature in fn/evrlci.py for argument names.
```
