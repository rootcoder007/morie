...
`print(result)` render. See `moirais.fn.describe('tsstl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstl import *
import numpy as np
# See the function signature in fn/tsstl.py for argument names.
```
