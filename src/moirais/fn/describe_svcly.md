...
`print(result)` render. See `moirais.fn.describe('svcly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcly import *
import numpy as np
# See the function signature in fn/svcly.py for argument names.
```
