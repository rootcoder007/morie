# describe('abcgp') — abc_gp_emulator
...
`print(result)` render. See `moirais.fn.describe('abcgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcgp import *
import numpy as np
# See the function signature in fn/abcgp.py for argument names.
```
