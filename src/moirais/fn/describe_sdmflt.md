...
`print(result)` render. See `moirais.fn.describe('sdmflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmflt import *
import numpy as np
# See the function signature in fn/sdmflt.py for argument names.
```
