...
`print(result)` render. See `moirais.fn.describe('prcpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prcpt import *
import numpy as np
# See the function signature in fn/prcpt.py for argument names.
```
