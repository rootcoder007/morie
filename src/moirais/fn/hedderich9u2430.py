...
__all__ = ["hedderich_chapter_9_unnumbered_2430"]


def hedderich_chapter_9_unnumbered_2430(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (k−1)F(k−1;n−k;1−α) =Sα (7.232)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2430')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2430: GeneralStatistics expression (auto-extracted; see ref)."
