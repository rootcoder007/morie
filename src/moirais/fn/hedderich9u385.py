...
__all__ = ["hedderich_chapter_9_unnumbered_385"]


def hedderich_chapter_9_unnumbered_385(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A∪B) = 1 −P (A∪B) = 1−P ( ¯A∩¯B)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u385')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u385: GeneralStatistics expression (auto-extracted; see ref)."
