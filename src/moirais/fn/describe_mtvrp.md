...
`print(result)` render. See `moirais.fn.describe('mtvrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtvrp import *
import numpy as np
# See the function signature in fn/mtvrp.py for argument names.
```
