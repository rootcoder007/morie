...
`print(result)` render. See `moirais.fn.describe('drlp1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drlp1 import *
import numpy as np
# See the function signature in fn/drlp1.py for argument names.
```
