...
`print(result)` render. See `moirais.fn.describe('swdoub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swdoub import *
import numpy as np
# See the function signature in fn/swdoub.py for argument names.
```
