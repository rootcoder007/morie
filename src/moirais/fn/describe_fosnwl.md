# describe('fosnwl') — fosnwl

## WHAT IT DOES

Snow load risk spatial
...
`print(result)` render. See `moirais.fn.describe('fosnwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fosnwl import *
import numpy as np
# See the function signature in fn/fosnwl.py for argument names.
```
