...
`print(result)` render. See `moirais.fn.describe('geinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geinv import *
import numpy as np
# See the function signature in fn/geinv.py for argument names.
```
