...
`print(result)` render. See `moirais.fn.describe('topkS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.topkS import *
import numpy as np
# See the function signature in fn/topkS.py for argument names.
```
