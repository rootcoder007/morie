# describe('rskgp') — risk_group_profile
...
`print(result)` render. See `moirais.fn.describe('rskgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskgp import *
import numpy as np
# See the function signature in fn/rskgp.py for argument names.
```
