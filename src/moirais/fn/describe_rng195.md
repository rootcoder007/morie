# describe('rng195') — rangayyan_ch4_length_transformation
...
`print(result)` render. See `moirais.fn.describe('rng195')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng195 import *
import numpy as np
# See the function signature in fn/rng195.py for argument names.
```
