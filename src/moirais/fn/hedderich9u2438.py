...
__all__ = ["hedderich_chapter_9_unnumbered_2438"]


def hedderich_chapter_9_unnumbered_2438(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |¯xA−¯xB|= n1 ¯x1 +n2 ¯x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2438')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2438: GeneralStatistics expression (auto-extracted; see ref)."
