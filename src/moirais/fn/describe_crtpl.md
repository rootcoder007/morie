# describe('crtpl') — court_plea_rate
...
`print(result)` render. See `moirais.fn.describe('crtpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtpl import *
import numpy as np
# See the function signature in fn/crtpl.py for argument names.
```
