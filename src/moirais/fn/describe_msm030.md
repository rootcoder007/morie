# describe('msm030') — mvsml_linear_mixed_models_eq_5_5
...
`print(result)` render. See `moirais.fn.describe('msm030')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm030 import *
import numpy as np
# See the function signature in fn/msm030.py for argument names.
```
