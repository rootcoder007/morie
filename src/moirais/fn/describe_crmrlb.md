# describe('crmrlb') — cramer_rao_bound
...
`print(result)` render. See `moirais.fn.describe('crmrlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crmrlb import *
import numpy as np
# See the function signature in fn/crmrlb.py for argument names.
```
