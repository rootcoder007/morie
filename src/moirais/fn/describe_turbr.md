...
`print(result)` render. See `moirais.fn.describe('turbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.turbr import *
import numpy as np
# See the function signature in fn/turbr.py for argument names.
```
