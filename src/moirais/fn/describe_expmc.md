# describe('expmc') — exponential_mechanism
...
`print(result)` render. See `moirais.fn.describe('expmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.expmc import *
import numpy as np
# See the function signature in fn/expmc.py for argument names.
```
