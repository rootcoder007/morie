...
__all__ = ["hedderich_chapter_9_unnumbered_2752"]


def hedderich_chapter_9_unnumbered_2752(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and for table c P2+1 =P3 = 1·3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2752')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2752: GeneralStatistics expression (auto-extracted; see ref)."
