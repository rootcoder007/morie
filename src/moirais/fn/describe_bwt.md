...
`print(result)` render. See `moirais.fn.describe('bwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwt import *
import numpy as np
# See the function signature in fn/bwt.py for argument names.
```
