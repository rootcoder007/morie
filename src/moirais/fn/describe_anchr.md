...
`print(result)` render. See `moirais.fn.describe('anchr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anchr import *
import numpy as np
# See the function signature in fn/anchr.py for argument names.
```
