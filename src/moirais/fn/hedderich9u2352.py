...
__all__ = ["hedderich_chapter_9_unnumbered_2352"]


def hedderich_chapter_9_unnumbered_2352(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2352')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2352: CountModels expression (auto-extracted; see ref)."
