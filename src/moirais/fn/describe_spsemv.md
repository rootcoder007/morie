# describe('spsemv') — schabenberger_semivariogram_def
...
`print(result)` render. See `moirais.fn.describe('spsemv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsemv import *
import numpy as np
# See the function signature in fn/spsemv.py for argument names.
```
