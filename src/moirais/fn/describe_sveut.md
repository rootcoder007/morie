...
`print(result)` render. See `moirais.fn.describe('sveut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sveut import *
import numpy as np
# See the function signature in fn/sveut.py for argument names.
```
