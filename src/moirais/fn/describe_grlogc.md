# describe('grlogc') — geron_logistic_cross_entropy_cost
...
`print(result)` render. See `moirais.fn.describe('grlogc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlogc import *
import numpy as np
# See the function signature in fn/grlogc.py for argument names.
```
