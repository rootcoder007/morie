...
`print(result)` render. See `moirais.fn.describe('chpdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chpdl import *
import numpy as np
# See the function signature in fn/chpdl.py for argument names.
```
