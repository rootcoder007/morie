...
`print(result)` render. See `moirais.fn.describe('geemp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geemp import *
import numpy as np
# See the function signature in fn/geemp.py for argument names.
```
