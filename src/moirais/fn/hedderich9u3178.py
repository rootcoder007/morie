...
__all__ = ["hedderich_chapter_9_unnumbered_3178"]


def hedderich_chapter_9_unnumbered_3178(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( sep =" " , " \ n " , "Chow test : F=" , chow , " with " , k , " ; " , n−2 *k ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3178')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3178: GeneralStatistics expression (auto-extracted; see ref)."
