...
`print(result)` render. See `moirais.fn.describe('fosucc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fosucc import *
import numpy as np
# See the function signature in fn/fosucc.py for argument names.
```
