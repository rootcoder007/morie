...
`print(result)` render. See `moirais.fn.describe('cipsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cipsc import *
import numpy as np
# See the function signature in fn/cipsc.py for argument names.
```
