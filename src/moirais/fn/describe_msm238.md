# describe('msm238') — mvsml_general_eq_1_3
...
`print(result)` render. See `moirais.fn.describe('msm238')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm238 import *
import numpy as np
# See the function signature in fn/msm238.py for argument names.
```
