...
`print(result)` render. See `moirais.fn.describe('mfomf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mfomf import *
import numpy as np
# See the function signature in fn/mfomf.py for argument names.
```
