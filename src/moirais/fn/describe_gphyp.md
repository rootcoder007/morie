# describe('gphyp') — gaussian_process_marginal_likelihood
...
`print(result)` render. See `moirais.fn.describe('gphyp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gphyp import *
import numpy as np
# See the function signature in fn/gphyp.py for argument names.
```
