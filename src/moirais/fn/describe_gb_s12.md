# describe('gb_s12') — gibbons_smirnov_one_sided
...
`print(result)` render. See `moirais.fn.describe('gb_s12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_s12 import *
import numpy as np
# See the function signature in fn/gb_s12.py for argument names.
```
