...
`print(result)` render. See `moirais.fn.describe('agopn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agopn import *
import numpy as np
# See the function signature in fn/agopn.py for argument names.
```
