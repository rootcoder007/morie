...
__all__ = ["guide_on_data_analysis_chapter_8_unnumbered_633"]


def guide_on_data_analysis_chapter_8_unnumbered_633(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis8u633')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis8u633: GeneralStatistics expression (auto-extracted; see ref)."
