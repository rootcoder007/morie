...
`print(result)` render. See `moirais.fn.describe('trgrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trgrn import *
import numpy as np
# See the function signature in fn/trgrn.py for argument names.
```
