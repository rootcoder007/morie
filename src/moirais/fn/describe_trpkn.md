...
`print(result)` render. See `moirais.fn.describe('trpkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trpkn import *
import numpy as np
# See the function signature in fn/trpkn.py for argument names.
```
