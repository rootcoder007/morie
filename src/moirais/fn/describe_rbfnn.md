...
`print(result)` render. See `moirais.fn.describe('rbfnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfnn import *
import numpy as np
# See the function signature in fn/rbfnn.py for argument names.
```
