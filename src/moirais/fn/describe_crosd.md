...
`print(result)` render. See `moirais.fn.describe('crosd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crosd import *
import numpy as np
# See the function signature in fn/crosd.py for argument names.
```
