# describe('bumbl') — spectral_centroid

## WHAT IT DOES

Spectral centroid (buzz frequency). 'Patience is bitter, but its fruit is sweet. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('bumbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bumbl import *
import numpy as np
# See the function signature in fn/bumbl.py for argument names.
```
