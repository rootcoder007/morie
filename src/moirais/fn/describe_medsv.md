...
`print(result)` render. See `moirais.fn.describe('medsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medsv import *
import numpy as np
# See the function signature in fn/medsv.py for argument names.
```
