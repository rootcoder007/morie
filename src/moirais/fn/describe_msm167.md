# describe('msm167') — mvsml_ridge_lasso_elastic_eq_9_2
...
`print(result)` render. See `moirais.fn.describe('msm167')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm167 import *
import numpy as np
# See the function signature in fn/msm167.py for argument names.
```
