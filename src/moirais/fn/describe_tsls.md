...
`print(result)` render. See `moirais.fn.describe('tsls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsls import *
import numpy as np
# See the function signature in fn/tsls.py for argument names.
```
