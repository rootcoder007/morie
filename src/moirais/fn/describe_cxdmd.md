# describe('cxdmd') — complex_demodulation
...
`print(result)` render. See `moirais.fn.describe('cxdmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxdmd import *
import numpy as np
# See the function signature in fn/cxdmd.py for argument names.
```
