...
__all__ = ["bivand2013_chapter_7_unnumbered_286"]


def bivand2013_chapter_7_unnumbered_286(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + "negbin", 999, listw = col.W.tango, zero.policy = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u286')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u286: GeneralStatistics expression (auto-extracted; see ref)."
