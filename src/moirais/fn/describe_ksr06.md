# describe('ksr06') — kosorok_maximal_inequality
...
`print(result)` render. See `moirais.fn.describe('ksr06')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr06 import *
import numpy as np
# See the function signature in fn/ksr06.py for argument names.
```
