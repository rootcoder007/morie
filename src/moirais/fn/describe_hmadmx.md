...
`print(result)` render. See `moirais.fn.describe('hmadmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmadmx import *
import numpy as np
# See the function signature in fn/hmadmx.py for argument names.
```
