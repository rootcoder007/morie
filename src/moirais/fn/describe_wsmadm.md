# describe('wsmadm') — wasserman_admissible
...
`print(result)` render. See `moirais.fn.describe('wsmadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmadm import *
import numpy as np
# See the function signature in fn/wsmadm.py for argument names.
```
