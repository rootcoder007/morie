...
__all__ = ["spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_10_equation_11"]


def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_10_equation_11(x, cdf=None):
    """
    Multilevel equation extracted from spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818.

    Formula: [EQ] ys = zs + vs, (10.11)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_10e11')`` for the full guide.

    References
    ----------
    spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818, ch.10 eq.10.11
    """
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_10e11: Multilevel equation extracted from spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818."
