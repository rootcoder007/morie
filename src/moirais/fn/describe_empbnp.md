# describe('empbnp') — empirical_bayes_np
...
`print(result)` render. See `moirais.fn.describe('empbnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.empbnp import *
import numpy as np
# See the function signature in fn/empbnp.py for argument names.
```
