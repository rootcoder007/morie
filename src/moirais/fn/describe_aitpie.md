# describe('aitpie') — compositional_pielou
...
`print(result)` render. See `moirais.fn.describe('aitpie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitpie import *
import numpy as np
# See the function signature in fn/aitpie.py for argument names.
```
