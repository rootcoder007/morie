...
`print(result)` render. See `moirais.fn.describe('qq_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qq_ import *
import numpy as np
# See the function signature in fn/qq_.py for argument names.
```
