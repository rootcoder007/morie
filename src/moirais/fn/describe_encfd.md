...
`print(result)` render. See `moirais.fn.describe('encfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.encfd import *
import numpy as np
# See the function signature in fn/encfd.py for argument names.
```
