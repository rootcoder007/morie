...
`print(result)` render. See `moirais.fn.describe('mtrcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrcr import *
import numpy as np
# See the function signature in fn/mtrcr.py for argument names.
```
