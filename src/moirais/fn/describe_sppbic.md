...
`print(result)` render. See `moirais.fn.describe('sppbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppbic import *
import numpy as np
# See the function signature in fn/sppbic.py for argument names.
```
