...
`print(result)` render. See `moirais.fn.describe('vmspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmspc import *
import numpy as np
# See the function signature in fn/vmspc.py for argument names.
```
