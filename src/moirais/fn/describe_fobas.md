...
`print(result)` render. See `moirais.fn.describe('fobas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fobas import *
import numpy as np
# See the function signature in fn/fobas.py for argument names.
```
