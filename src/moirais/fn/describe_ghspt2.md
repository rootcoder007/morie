...
`print(result)` render. See `moirais.fn.describe('ghspt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghspt2 import *
import numpy as np
# See the function signature in fn/ghspt2.py for argument names.
```
