...
`print(result)` render. See `moirais.fn.describe('afevi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afevi import *
import numpy as np
# See the function signature in fn/afevi.py for argument names.
```
