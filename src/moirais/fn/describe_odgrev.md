# describe('odgrev') — outbreak_detection
...
`print(result)` render. See `moirais.fn.describe('odgrev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odgrev import *
import numpy as np
# See the function signature in fn/odgrev.py for argument names.
```
