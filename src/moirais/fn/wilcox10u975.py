...
__all__ = ["wilcox_chapter_10_unnumbered_975"]


def wilcox_chapter_10_unnumbered_975(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: So now the linear contrast coefficients are c1 = c4 = 1, c2 = c3 = −1, and c5 = c6 = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u975')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u975: GeneralStatistics expression (auto-extracted; see ref)."
