# describe('aitclos') — aitchison_closure
...
`print(result)` render. See `moirais.fn.describe('aitclos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitclos import *
import numpy as np
# See the function signature in fn/aitclos.py for argument names.
```
