# describe('sirtdy') — sir_age_structured
...
`print(result)` render. See `moirais.fn.describe('sirtdy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirtdy import *
import numpy as np
# See the function signature in fn/sirtdy.py for argument names.
```
