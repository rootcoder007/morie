...
`print(result)` render. See `moirais.fn.describe('rdkfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdkfp import *
import numpy as np
# See the function signature in fn/rdkfp.py for argument names.
```
