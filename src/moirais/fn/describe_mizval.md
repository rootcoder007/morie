...
`print(result)` render. See `moirais.fn.describe('mizval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mizval import *
import numpy as np
# See the function signature in fn/mizval.py for argument names.
```
