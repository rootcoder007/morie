# describe('fzmrl') — fauzi_mrl_asymptotic
...
`print(result)` render. See `moirais.fn.describe('fzmrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmrl import *
import numpy as np
# See the function signature in fn/fzmrl.py for argument names.
```
