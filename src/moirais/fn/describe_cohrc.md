...
`print(result)` render. See `moirais.fn.describe('cohrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cohrc import *
import numpy as np
# See the function signature in fn/cohrc.py for argument names.
```
