# describe('netei') — network_expected_influence
...
`print(result)` render. See `moirais.fn.describe('netei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netei import *
import numpy as np
# See the function signature in fn/netei.py for argument names.
```
