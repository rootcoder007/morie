...
`print(result)` render. See `moirais.fn.describe('zekls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zekls import *
import numpy as np
# See the function signature in fn/zekls.py for argument names.
```
