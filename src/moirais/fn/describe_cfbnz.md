...
`print(result)` render. See `moirais.fn.describe('cfbnz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfbnz import *
import numpy as np
# See the function signature in fn/cfbnz.py for argument names.
```
