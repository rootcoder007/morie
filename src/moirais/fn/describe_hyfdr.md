...
`print(result)` render. See `moirais.fn.describe('hyfdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyfdr import *
import numpy as np
# See the function signature in fn/hyfdr.py for argument names.
```
