...
`print(result)` render. See `moirais.fn.describe('agrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agrst import *
import numpy as np
# See the function signature in fn/agrst.py for argument names.
```
