...
`print(result)` render. See `moirais.fn.describe('rgsnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsnr import *
import numpy as np
# See the function signature in fn/rgsnr.py for argument names.
```
