...
`print(result)` render. See `moirais.fn.describe('stl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stl import *
import numpy as np
# See the function signature in fn/stl.py for argument names.
```
