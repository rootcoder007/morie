# describe('cvxstd') — boyd_steepest_desc
...
`print(result)` render. See `moirais.fn.describe('cvxstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxstd import *
import numpy as np
# See the function signature in fn/cvxstd.py for argument names.
```
