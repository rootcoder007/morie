...
`print(result)` render. See `moirais.fn.describe('lmrkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmrkt import *
import numpy as np
# See the function signature in fn/lmrkt.py for argument names.
```
