# describe('otfgw') — ot_fused_gromov_wasserstein
...
`print(result)` render. See `moirais.fn.describe('otfgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otfgw import *
import numpy as np
# See the function signature in fn/otfgw.py for argument names.
```
