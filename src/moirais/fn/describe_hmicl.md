# describe('hmicl') — geron_in_context_learning
...
`print(result)` render. See `moirais.fn.describe('hmicl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmicl import *
import numpy as np
# See the function signature in fn/hmicl.py for argument names.
```
