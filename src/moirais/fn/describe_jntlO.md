# describe('jntlO') — joint_loss_mixed_outcomes
...
`print(result)` render. See `moirais.fn.describe('jntlO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntlO import *
import numpy as np
# See the function signature in fn/jntlO.py for argument names.
```
