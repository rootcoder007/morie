...
`print(result)` render. See `moirais.fn.describe('cshmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cshmn import *
import numpy as np
# See the function signature in fn/cshmn.py for argument names.
```
