# describe('bndnvg') — bound_naive_gross
...
`print(result)` render. See `moirais.fn.describe('bndnvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndnvg import *
import numpy as np
# See the function signature in fn/bndnvg.py for argument names.
```
