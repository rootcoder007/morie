...
`print(result)` render. See `moirais.fn.describe('hmgpt3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgpt3 import *
import numpy as np
# See the function signature in fn/hmgpt3.py for argument names.
```
