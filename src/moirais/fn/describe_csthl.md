# describe('csthl') — custody_health_access
...
`print(result)` render. See `moirais.fn.describe('csthl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csthl import *
import numpy as np
# See the function signature in fn/csthl.py for argument names.
```
