# describe('herd') — herd_immunity_threshold
...
`print(result)` render. See `moirais.fn.describe('herd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.herd import *
import numpy as np
# See the function signature in fn/herd.py for argument names.
```
