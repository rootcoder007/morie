...
`print(result)` render. See `moirais.fn.describe('mvtfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtfe import *
import numpy as np
# See the function signature in fn/mvtfe.py for argument names.
```
