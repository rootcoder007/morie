...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_37(x):
    """
    CountModels equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner.

    Formula: where it is understood that n1 + n2 +· · ·+ nk = N. In the multinomial-co
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner1e37')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e37: CountModels equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
