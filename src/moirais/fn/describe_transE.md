...
`print(result)` render. See `moirais.fn.describe('transE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.transE import *
import numpy as np
# See the function signature in fn/transE.py for argument names.
```
