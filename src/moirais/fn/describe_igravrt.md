...
`print(result)` render. See `moirais.fn.describe('igravrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravrt import *
import numpy as np
# See the function signature in fn/igravrt.py for argument names.
```
