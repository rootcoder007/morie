...
`print(result)` render. See `moirais.fn.describe('boxmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boxmt import *
import numpy as np
# See the function signature in fn/boxmt.py for argument names.
```
