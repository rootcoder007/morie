...
`print(result)` render. See `moirais.fn.describe('patchT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.patchT import *
import numpy as np
# See the function signature in fn/patchT.py for argument names.
```
