...
`print(result)` render. See `moirais.fn.describe('svret')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svret import *
import numpy as np
# See the function signature in fn/svret.py for argument names.
```
