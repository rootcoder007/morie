...
`print(result)` render. See `moirais.fn.describe('msdim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdim import *
import numpy as np
# See the function signature in fn/msdim.py for argument names.
```
