# describe('hrzfnu') — horowitz_deconv_estimator
...
`print(result)` render. See `moirais.fn.describe('hrzfnu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzfnu import *
import numpy as np
# See the function signature in fn/hrzfnu.py for argument names.
```
