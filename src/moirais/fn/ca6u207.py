...
def ca_chapter_6_unnumbered_207(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca6u207')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "CountModels expression involving 'binomial' (auto-extracted; see reference for full context)."},
    )
