# describe('coxbsk') — cox_breslow_step
...
`print(result)` render. See `moirais.fn.describe('coxbsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxbsk import *
import numpy as np
# See the function signature in fn/coxbsk.py for argument names.
```
