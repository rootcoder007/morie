...
`print(result)` render. See `moirais.fn.describe('mgwrres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrres import *
import numpy as np
# See the function signature in fn/mgwrres.py for argument names.
```
