# describe('rcdtm') — recidivism_time
...
`print(result)` render. See `moirais.fn.describe('rcdtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdtm import *
import numpy as np
# See the function signature in fn/rcdtm.py for argument names.
```
