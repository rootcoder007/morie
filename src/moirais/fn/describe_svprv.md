...
`print(result)` render. See `moirais.fn.describe('svprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svprv import *
import numpy as np
# See the function signature in fn/svprv.py for argument names.
```
