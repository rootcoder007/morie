...
`print(result)` render. See `moirais.fn.describe('soero')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soero import *
import numpy as np
# See the function signature in fn/soero.py for argument names.
```
