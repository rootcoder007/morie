...
`print(result)` render. See `moirais.fn.describe('clstpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clstpp import *
import numpy as np
# See the function signature in fn/clstpp.py for argument names.
```
