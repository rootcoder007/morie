...
`print(result)` render. See `moirais.fn.describe('sbrub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbrub import *
import numpy as np
# See the function signature in fn/sbrub.py for argument names.
```
