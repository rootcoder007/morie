...
__all__ = ["hedderich_chapter_9_unnumbered_639"]


def hedderich_chapter_9_unnumbered_639(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.8 = −0.671. For the Bi(500; 0.8) distribution, the skewness =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u639')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u639: GeneralStatistics expression (auto-extracted; see ref)."
