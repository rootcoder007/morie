# describe('cvxsmt') — boyd_smooth_min
...
`print(result)` render. See `moirais.fn.describe('cvxsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsmt import *
import numpy as np
# See the function signature in fn/cvxsmt.py for argument names.
```
