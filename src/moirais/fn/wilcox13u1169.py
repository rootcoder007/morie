...
__all__ = ["wilcox_chapter_13_unnumbered_1169"]


def wilcox_chapter_13_unnumbered_1169(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: scor(x,y, plotit = TRUE, xlab = "VAR 1", ylab = "VAR 2", MC = FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1169')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1169: Resampling expression (auto-extracted; see ref)."
