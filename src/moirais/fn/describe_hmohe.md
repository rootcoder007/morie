# describe('hmohe') — geron_one_hot_encoding
...
`print(result)` render. See `moirais.fn.describe('hmohe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmohe import *
import numpy as np
# See the function signature in fn/hmohe.py for argument names.
```
