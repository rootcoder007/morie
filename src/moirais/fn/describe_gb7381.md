# describe('gb7381') — gibbons_cs_null_var
...
`print(result)` render. See `moirais.fn.describe('gb7381')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb7381 import *
import numpy as np
# See the function signature in fn/gb7381.py for argument names.
```
