...
`print(result)` render. See `moirais.fn.describe('sird')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sird import *
import numpy as np
# See the function signature in fn/sird.py for argument names.
```
