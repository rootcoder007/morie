...
__all__ = ["guide_on_data_analysis_chapter_10_unnumbered_765"]


def guide_on_data_analysis_chapter_10_unnumbered_765(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x = "x1", y = "x2") +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis10u765')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis10u765: GeneralStatistics expression (auto-extracted; see ref)."
