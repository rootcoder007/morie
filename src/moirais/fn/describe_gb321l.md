# describe('gb321l') — gibbons_distributing_objects
...
`print(result)` render. See `moirais.fn.describe('gb321l')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb321l import *
import numpy as np
# See the function signature in fn/gb321l.py for argument names.
```
