...
`print(result)` render. See `moirais.fn.describe('vmcvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcvl import *
import numpy as np
# See the function signature in fn/vmcvl.py for argument names.
```
