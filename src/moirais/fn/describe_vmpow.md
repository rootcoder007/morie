...
`print(result)` render. See `moirais.fn.describe('vmpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmpow import *
import numpy as np
# See the function signature in fn/vmpow.py for argument names.
```
