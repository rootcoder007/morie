...
__all__ = ["hedderich_chapter_9_unnumbered_2443"]


def hedderich_chapter_9_unnumbered_2443(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 4.66> 3.88 = S; II : ˆSII = 4.21> 3.88 = S) statistically significant differences (P = 0.01).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2443')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2443: GeneralStatistics expression (auto-extracted; see ref)."
