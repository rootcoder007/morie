# describe('km084') — kamath_ch6_lpbs_bias
...
`print(result)` render. See `moirais.fn.describe('km084')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km084 import *
import numpy as np
# See the function signature in fn/km084.py for argument names.
```
