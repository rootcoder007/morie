...
`print(result)` render. See `moirais.fn.describe('cdlmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdlmc import *
import numpy as np
# See the function signature in fn/cdlmc.py for argument names.
```
