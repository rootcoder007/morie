...
`print(result)` render. See `moirais.fn.describe('effic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effic import *
import numpy as np
# See the function signature in fn/effic.py for argument names.
```
