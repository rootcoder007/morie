# describe('guide_on_data_analysis14u901') — guide_on_data_analysis_chapter_14_unnumbered_901
...
import numpy as np
result = guide_on_data_analysis_chapter_14_unnumbered_901(np.random.default_rng(42).normal(0, 1, 100))
