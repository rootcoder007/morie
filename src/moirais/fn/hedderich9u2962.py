...
__all__ = ["hedderich_chapter_9_unnumbered_2962"]


def hedderich_chapter_9_unnumbered_2962(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : πij =P (X =i)·P (Y =j) = αiβj (7.355)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2962')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2962: GeneralStatistics expression (auto-extracted; see ref)."
