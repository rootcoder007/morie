...
`print(result)` render. See `moirais.fn.describe('entrd2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entrd2 import *
import numpy as np
# See the function signature in fn/entrd2.py for argument names.
```
