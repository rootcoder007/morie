...
`print(result)` render. See `moirais.fn.describe('gdtfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdtfr import *
import numpy as np
# See the function signature in fn/gdtfr.py for argument names.
```
