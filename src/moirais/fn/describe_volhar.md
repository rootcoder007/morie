...
`print(result)` render. See `moirais.fn.describe('volhar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volhar import *
import numpy as np
# See the function signature in fn/volhar.py for argument names.
```
