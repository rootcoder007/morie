# describe('kmfact') — kamath_factscore
...
`print(result)` render. See `moirais.fn.describe('kmfact')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmfact import *
import numpy as np
# See the function signature in fn/kmfact.py for argument names.
```
