# describe('sptau') — spatial_autocorrelation
...
`print(result)` render. See `moirais.fn.describe('sptau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptau import *
import numpy as np
# See the function signature in fn/sptau.py for argument names.
```
