# describe('sutva') — sutva_assumption
...
`print(result)` render. See `moirais.fn.describe('sutva')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sutva import *
import numpy as np
# See the function signature in fn/sutva.py for argument names.
```
