...
def ca_chapter_5_unnumbered_149(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u149')`` for the full guide.
...
def cheatsheet():
    return "ca5u149: GeneralStatistics expression involving 'conviction' (auto-extracted; see reference for full context)."
