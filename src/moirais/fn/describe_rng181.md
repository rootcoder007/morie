# describe('rng181') — rangayyan_ch4_pan_tompkins_lowpass_transfer
...
`print(result)` render. See `moirais.fn.describe('rng181')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng181 import *
import numpy as np
# See the function signature in fn/rng181.py for argument names.
```
