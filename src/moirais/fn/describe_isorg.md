# describe('isorg') — isotonic_regression
...
`print(result)` render. See `moirais.fn.describe('isorg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isorg import *
import numpy as np
# See the function signature in fn/isorg.py for argument names.
```
