...
`print(result)` render. See `moirais.fn.describe('sasRec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sasRec import *
import numpy as np
# See the function signature in fn/sasRec.py for argument names.
```
