...
`print(result)` render. See `moirais.fn.describe('arcee')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arcee import *
import numpy as np
# See the function signature in fn/arcee.py for argument names.
```
