...
`print(result)` render. See `moirais.fn.describe('rspan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rspan import *
import numpy as np
# See the function signature in fn/rspan.py for argument names.
```
