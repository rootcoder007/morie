...
__all__ = ["bivand2013_chapter_2_unnumbered_2"]


def bivand2013_chapter_2_unnumbered_2(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [1] "+proj=longlat +ellps=WGS84"
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u2')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u2: GeneralStatistics expression (auto-extracted; see ref)."
