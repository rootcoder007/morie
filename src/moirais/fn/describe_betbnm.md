...
`print(result)` render. See `moirais.fn.describe('betbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.betbnm import *
import numpy as np
# See the function signature in fn/betbnm.py for argument names.
```
