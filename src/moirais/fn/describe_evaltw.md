# describe('evaltw') — e_value_unmeasured_confounding
...
`print(result)` render. See `moirais.fn.describe('evaltw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evaltw import *
import numpy as np
# See the function signature in fn/evaltw.py for argument names.
```
