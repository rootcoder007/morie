...
`print(result)` render. See `moirais.fn.describe('nnextr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnextr import *
import numpy as np
# See the function signature in fn/nnextr.py for argument names.
```
