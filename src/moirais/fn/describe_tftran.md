# describe('tftran') — temporal_fusion_transformer
...
`print(result)` render. See `moirais.fn.describe('tftran')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tftran import *
import numpy as np
# See the function signature in fn/tftran.py for argument names.
```
