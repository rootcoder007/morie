...
__all__ = ["hedderich_chapter_9_unnumbered_733"]


def hedderich_chapter_9_unnumbered_733(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u733')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u733: CountModels expression (auto-extracted; see ref)."
