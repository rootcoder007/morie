...
__all__ = ["hedderich_chapter_9_unnumbered_2493"]


def hedderich_chapter_9_unnumbered_2493(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: withnA =nB =nC = 6 and ∑ni = 18 = N. Note: ∑ni > 12 where theni can be unequal;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2493')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2493: GeneralStatistics expression (auto-extracted; see ref)."
