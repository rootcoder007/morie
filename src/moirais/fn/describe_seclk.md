...
`print(result)` render. See `moirais.fn.describe('seclk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclk import *
import numpy as np
# See the function signature in fn/seclk.py for argument names.
```
