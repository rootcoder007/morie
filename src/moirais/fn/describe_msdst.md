...
`print(result)` render. See `moirais.fn.describe('msdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdst import *
import numpy as np
# See the function signature in fn/msdst.py for argument names.
```
