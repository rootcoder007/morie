# describe('otpush') — ot_pushforward_density
...
`print(result)` render. See `moirais.fn.describe('otpush')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otpush import *
import numpy as np
# See the function signature in fn/otpush.py for argument names.
```
