# describe('flmgcr') — flamingo_gated_cross
...
`print(result)` render. See `moirais.fn.describe('flmgcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flmgcr import *
import numpy as np
# See the function signature in fn/flmgcr.py for argument names.
```
