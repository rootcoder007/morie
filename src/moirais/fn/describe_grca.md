# describe('grca') — geron_cross_attention
...
`print(result)` render. See `moirais.fn.describe('grca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grca import *
import numpy as np
# See the function signature in fn/grca.py for argument names.
```
