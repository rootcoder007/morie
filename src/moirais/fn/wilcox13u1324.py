...
__all__ = ["wilcox_chapter_13_unnumbered_1324"]


def wilcox_chapter_13_unnumbered_1324(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1324')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1324: ContingencyTables expression (auto-extracted; see ref)."
