...
`print(result)` render. See `moirais.fn.describe('renyh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.renyh import *
import numpy as np
# See the function signature in fn/renyh.py for argument names.
```
