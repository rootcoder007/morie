...
`print(result)` render. See `moirais.fn.describe('opsca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opsca import *
import numpy as np
# See the function signature in fn/opsca.py for argument names.
```
