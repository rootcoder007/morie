...
`print(result)` render. See `moirais.fn.describe('svppo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svppo import *
import numpy as np
# See the function signature in fn/svppo.py for argument names.
```
