# describe('ctprx') — cutting_plane_proximity
...
`print(result)` render. See `moirais.fn.describe('ctprx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctprx import *
import numpy as np
# See the function signature in fn/ctprx.py for argument names.
```
