...
`print(result)` render. See `moirais.fn.describe('ccfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccfn import *
import numpy as np
# See the function signature in fn/ccfn.py for argument names.
```
