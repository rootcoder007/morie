...
`print(result)` render. See `moirais.fn.describe('hmtsne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtsne import *
import numpy as np
# See the function signature in fn/hmtsne.py for argument names.
```
