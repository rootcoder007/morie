...
__all__ = ["wilcox_chapter_13_unnumbered_1137"]


def wilcox_chapter_13_unnumbered_1137(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: dfmin=8, eout=FALSE, xout=FALSE, xlab="X", ylab="Y", outfun=out, LP=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1137')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1137: GeneralStatistics expression (auto-extracted; see ref)."
