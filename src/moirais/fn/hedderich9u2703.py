...
__all__ = ["hedderich_chapter_9_unnumbered_2703"]


def hedderich_chapter_9_unnumbered_2703(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] H0 : log( ω) = 0 vs. HA : log( ω)̸= 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2703')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2703: PowerAndDesign expression (auto-extracted; see ref)."
