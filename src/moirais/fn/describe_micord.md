...
`print(result)` render. See `moirais.fn.describe('micord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.micord import *
import numpy as np
# See the function signature in fn/micord.py for argument names.
```
