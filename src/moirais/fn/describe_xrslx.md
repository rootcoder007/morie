...
`print(result)` render. See `moirais.fn.describe('xrslx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrslx import *
import numpy as np
# See the function signature in fn/xrslx.py for argument names.
```
