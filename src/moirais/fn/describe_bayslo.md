...
`print(result)` render. See `moirais.fn.describe('bayslo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayslo import *
import numpy as np
# See the function signature in fn/bayslo.py for argument names.
```
