# describe('grtdb') — geron_transformer_decoder_block
...
`print(result)` render. See `moirais.fn.describe('grtdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtdb import *
import numpy as np
# See the function signature in fn/grtdb.py for argument names.
```
