# describe('mltch') — multiple_chains_combine
...
`print(result)` render. See `moirais.fn.describe('mltch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mltch import *
import numpy as np
# See the function signature in fn/mltch.py for argument names.
```
