...
`print(result)` render. See `moirais.fn.describe('fofwi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fofwi import *
import numpy as np
# See the function signature in fn/fofwi.py for argument names.
```
