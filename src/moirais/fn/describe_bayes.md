...
`print(result)` render. See `moirais.fn.describe('bayes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayes import *
import numpy as np
# See the function signature in fn/bayes.py for argument names.
```
