...
__all__ = ["wilcox_chapter_15_unnumbered_1393"]


def wilcox_chapter_15_unnumbered_1393(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n2 n1 = 3 n1 = 4 n1 = 5 n1 = 6 n1 = 7 n1 = 8 n1 = 9 n1 = 10
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1393')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1393: GeneralStatistics expression (auto-extracted; see ref)."
