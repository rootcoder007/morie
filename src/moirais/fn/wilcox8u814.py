...
__all__ = ["wilcox_chapter_8_unnumbered_814"]


def wilcox_chapter_8_unnumbered_814(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] H0 : ∆ 12 = ∆ 13 = · · · = ∆ J−1,J = 0. (10.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u814')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u814: PowerAndDesign expression (auto-extracted; see ref)."
