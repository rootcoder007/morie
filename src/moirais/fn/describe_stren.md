...
`print(result)` render. See `moirais.fn.describe('stren')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stren import *
import numpy as np
# See the function signature in fn/stren.py for argument names.
```
