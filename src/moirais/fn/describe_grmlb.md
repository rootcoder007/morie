# describe('grmlb') — geron_multilabel_classification
...
`print(result)` render. See `moirais.fn.describe('grmlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmlb import *
import numpy as np
# See the function signature in fn/grmlb.py for argument names.
```
