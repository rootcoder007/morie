...
__all__ = ["wilcox_chapter_13_unnumbered_1292"]


def wilcox_chapter_13_unnumbered_1292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: With ν = 1 degree of freedom and α = 0.05, the critical value is 3.84, and because 1 .4 <
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1292')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1292: GeneralStatistics expression (auto-extracted; see ref)."
