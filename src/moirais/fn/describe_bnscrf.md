# describe('bnscrf') — bound_credible_interval
...
`print(result)` render. See `moirais.fn.describe('bnscrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnscrf import *
import numpy as np
# See the function signature in fn/bnscrf.py for argument names.
```
