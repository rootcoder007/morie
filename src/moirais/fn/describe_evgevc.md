...
`print(result)` render. See `moirais.fn.describe('evgevc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevc import *
import numpy as np
# See the function signature in fn/evgevc.py for argument names.
```
