...
`print(result)` render. See `moirais.fn.describe('eslrdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslrdg import *
import numpy as np
# See the function signature in fn/eslrdg.py for argument names.
```
