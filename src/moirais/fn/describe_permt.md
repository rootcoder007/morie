# describe('permt') — permutation_test_general
...
`print(result)` render. See `moirais.fn.describe('permt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.permt import *
import numpy as np
# See the function signature in fn/permt.py for argument names.
```
