...
`print(result)` render. See `moirais.fn.describe('facta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.facta import *
import numpy as np
# See the function signature in fn/facta.py for argument names.
```
