...
__all__ = ["wilcox_chapter_14_unnumbered_684"]


def wilcox_chapter_14_unnumbered_684(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ¯X1 = 0.276039 ¯X2 = 0.195615 ¯X3 = 0.149543 ¯X4 = 0.399699
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u684')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u684: GeneralStatistics expression (auto-extracted; see ref)."
