...
`print(result)` render. See `moirais.fn.describe('lagop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lagop import *
import numpy as np
# See the function signature in fn/lagop.py for argument names.
```
