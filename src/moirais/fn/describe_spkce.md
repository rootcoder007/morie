# describe('spkce') — schabenberger_cov_param_estimation_kriging
...
`print(result)` render. See `moirais.fn.describe('spkce')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkce import *
import numpy as np
# See the function signature in fn/spkce.py for argument names.
```
