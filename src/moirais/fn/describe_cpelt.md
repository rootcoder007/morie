# describe('cpelt') — pelt_changepoint

## WHAT IT DOES

PELT change-point detection. 'Power! Unlimited power!'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('cpelt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpelt import *
import numpy as np
# See the function signature in fn/cpelt.py for argument names.
```
