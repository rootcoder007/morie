...
`print(result)` render. See `moirais.fn.describe('npivs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npivs import *
import numpy as np
# See the function signature in fn/npivs.py for argument names.
```
