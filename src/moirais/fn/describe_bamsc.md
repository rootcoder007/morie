# describe('bamsc') — bayesian_am_scaling
...
`print(result)` render. See `moirais.fn.describe('bamsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bamsc import *
import numpy as np
# See the function signature in fn/bamsc.py for argument names.
```
