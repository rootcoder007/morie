# describe('fltplt') — plot_filter_io_fn
...
`print(result)` render. See `moirais.fn.describe('fltplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fltplt import *
import numpy as np
# See the function signature in fn/fltplt.py for argument names.
```
