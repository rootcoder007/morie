...
`print(result)` render. See `moirais.fn.describe('kgrhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgrhs import *
import numpy as np
# See the function signature in fn/kgrhs.py for argument names.
```
