...
`print(result)` render. See `moirais.fn.describe('krgcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgcv import *
import numpy as np
# See the function signature in fn/krgcv.py for argument names.
```
