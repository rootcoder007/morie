...
`print(result)` render. See `moirais.fn.describe('umcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umcon import *
import numpy as np
# See the function signature in fn/umcon.py for argument names.
```
