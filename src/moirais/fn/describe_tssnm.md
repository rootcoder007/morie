# describe('tssnm') — tssnm

## WHAT IT DOES

Space-time NMF decomposition
...
`print(result)` render. See `moirais.fn.describe('tssnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssnm import *
import numpy as np
# See the function signature in fn/tssnm.py for argument names.
```
