...
__all__ = ["hedderich_chapter_9_unnumbered_960"]


def hedderich_chapter_9_unnumbered_960(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ☞ t∞;0.05;two−sided =t∞;0.975 =z0.975 = 1.96.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u960')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u960: GeneralStatistics expression (auto-extracted; see ref)."
