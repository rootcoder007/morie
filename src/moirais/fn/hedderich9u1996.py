...
__all__ = ["hedderich_chapter_9_unnumbered_1996"]


def hedderich_chapter_9_unnumbered_1996(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ST = 1 3 4 . 5 P− value ( two − sided ) = 0.02836551
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1996')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1996: GeneralStatistics expression (auto-extracted; see ref)."
