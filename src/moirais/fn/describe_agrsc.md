# describe('agrsc') — agreement_score_matrix
...
`print(result)` render. See `moirais.fn.describe('agrsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agrsc import *
import numpy as np
# See the function signature in fn/agrsc.py for argument names.
```
