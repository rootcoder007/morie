# describe('ksr16') — kosorok_influence_function
...
`print(result)` render. See `moirais.fn.describe('ksr16')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr16 import *
import numpy as np
# See the function signature in fn/ksr16.py for argument names.
```
