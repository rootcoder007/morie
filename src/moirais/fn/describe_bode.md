...
`print(result)` render. See `moirais.fn.describe('bode')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bode import *
import numpy as np
# See the function signature in fn/bode.py for argument names.
```
