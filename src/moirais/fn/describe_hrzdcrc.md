# describe('hrzdcrc') — horowitz_deconv_rate
...
`print(result)` render. See `moirais.fn.describe('hrzdcrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzdcrc import *
import numpy as np
# See the function signature in fn/hrzdcrc.py for argument names.
```
