# describe('causdidwd') — causal_did_wooldridge_eta
...
`print(result)` render. See `moirais.fn.describe('causdidwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdidwd import *
import numpy as np
# See the function signature in fn/causdidwd.py for argument names.
```
