...
`print(result)` render. See `moirais.fn.describe('agfdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agfdi import *
import numpy as np
# See the function signature in fn/agfdi.py for argument names.
```
