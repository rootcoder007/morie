...
`print(result)` render. See `moirais.fn.describe('lacbivl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacbivl import *
import numpy as np
# See the function signature in fn/lacbivl.py for argument names.
```
