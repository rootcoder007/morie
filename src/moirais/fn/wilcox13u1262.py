...
__all__ = ["wilcox_chapter_13_unnumbered_1262"]


def wilcox_chapter_13_unnumbered_1262(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ancdet(x1,y1,x2,y2,fr1=1,fr2=1,tr=0.2,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1262')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1262: PowerAndDesign expression (auto-extracted; see ref)."
