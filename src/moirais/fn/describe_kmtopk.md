# describe('kmtopk') — kamath_moe_top_k_gating
...
`print(result)` render. See `moirais.fn.describe('kmtopk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmtopk import *
import numpy as np
# See the function signature in fn/kmtopk.py for argument names.
```
