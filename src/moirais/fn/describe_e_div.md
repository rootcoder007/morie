...
`print(result)` render. See `moirais.fn.describe('e_div')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.e_div import *
import numpy as np
# See the function signature in fn/e_div.py for argument names.
```
