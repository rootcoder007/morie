# describe('rgstftp') — rangayyan_stft_params
...
`print(result)` render. See `moirais.fn.describe('rgstftp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgstftp import *
import numpy as np
# See the function signature in fn/rgstftp.py for argument names.
```
