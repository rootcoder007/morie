...
`print(result)` render. See `moirais.fn.describe('gf2ad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gf2ad import *
import numpy as np
# See the function signature in fn/gf2ad.py for argument names.
```
