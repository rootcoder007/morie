# describe('prbit') — ordinal_probit_coefficients
...
`print(result)` render. See `moirais.fn.describe('prbit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prbit import *
import numpy as np
# See the function signature in fn/prbit.py for argument names.
```
