...
__all__ = ["hedderich_chapter_9_unnumbered_2425"]


def hedderich_chapter_9_unnumbered_2425(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 7.41 withk = 6,..., 1 andν=N−k = 194 (according to table∼200) degrees of freedom.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2425')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2425: GeneralStatistics expression (auto-extracted; see ref)."
