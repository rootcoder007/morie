...
`print(result)` render. See `moirais.fn.describe('pauli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pauli import *
import numpy as np
# See the function signature in fn/pauli.py for argument names.
```
