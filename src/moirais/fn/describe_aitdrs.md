# describe('aitdrs') — dirichlet_sample
...
`print(result)` render. See `moirais.fn.describe('aitdrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdrs import *
import numpy as np
# See the function signature in fn/aitdrs.py for argument names.
```
