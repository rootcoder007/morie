...
`print(result)` render. See `moirais.fn.describe('gpregF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpregF import *
import numpy as np
# See the function signature in fn/gpregF.py for argument names.
```
