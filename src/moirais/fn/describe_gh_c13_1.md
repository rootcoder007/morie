# describe('gh_c13_1') — ghosal_surv_dp_post
...
`print(result)` render. See `moirais.fn.describe('gh_c13_1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_1 import *
import numpy as np
# See the function signature in fn/gh_c13_1.py for argument names.
```
