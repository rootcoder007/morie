# describe('multM') — multiple_mediators
...
`print(result)` render. See `moirais.fn.describe('multM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.multM import *
import numpy as np
# See the function signature in fn/multM.py for argument names.
```
