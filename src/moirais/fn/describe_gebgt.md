...
`print(result)` render. See `moirais.fn.describe('gebgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gebgt import *
import numpy as np
# See the function signature in fn/gebgt.py for argument names.
```
