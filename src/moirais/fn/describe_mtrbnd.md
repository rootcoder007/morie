# describe('mtrbnd') — monotone_treatment_response
...
`print(result)` render. See `moirais.fn.describe('mtrbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrbnd import *
import numpy as np
# See the function signature in fn/mtrbnd.py for argument names.
```
