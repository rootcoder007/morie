...
`print(result)` render. See `moirais.fn.describe('cm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cm import *
import numpy as np
# See the function signature in fn/cm.py for argument names.
```
