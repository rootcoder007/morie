# describe('hmauxpt') — geron_auxiliary_task_pretraining
...
`print(result)` render. See `moirais.fn.describe('hmauxpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmauxpt import *
import numpy as np
# See the function signature in fn/hmauxpt.py for argument names.
```
