# describe('hmnov') — geron_novelty_detection
...
`print(result)` render. See `moirais.fn.describe('hmnov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnov import *
import numpy as np
# See the function signature in fn/hmnov.py for argument names.
```
