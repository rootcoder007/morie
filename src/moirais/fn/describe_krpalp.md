# describe('krpalp') — krippendorff_alpha
...
`print(result)` render. See `moirais.fn.describe('krpalp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krpalp import *
import numpy as np
# See the function signature in fn/krpalp.py for argument names.
```
