...
`print(result)` render. See `moirais.fn.describe('odml3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml3 import *
import numpy as np
# See the function signature in fn/odml3.py for argument names.
```
