# describe('drhtg') — dr_did_heterogeneity
...
`print(result)` render. See `moirais.fn.describe('drhtg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drhtg import *
import numpy as np
# See the function signature in fn/drhtg.py for argument names.
```
