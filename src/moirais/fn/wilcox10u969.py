...
__all__ = ["wilcox_chapter_10_unnumbered_969"]


def wilcox_chapter_10_unnumbered_969(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 2, the linear contrast coefficients are c1 =c2 = 1, c3 =c4 = 0, and c5 =c6 = −1.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u969')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u969: GeneralStatistics expression (auto-extracted; see ref)."
