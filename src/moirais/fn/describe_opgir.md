...
`print(result)` render. See `moirais.fn.describe('opgir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opgir import *
import numpy as np
# See the function signature in fn/opgir.py for argument names.
```
