...
__all__ = ["hedderich_chapter_9_unnumbered_3476"]


def hedderich_chapter_9_unnumbered_3476(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + v . names =" y " , varying =l i s t ( 3 : 6 ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3476')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3476: GeneralStatistics expression (auto-extracted; see ref)."
