...
`print(result)` render. See `moirais.fn.describe('borda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.borda import *
import numpy as np
# See the function signature in fn/borda.py for argument names.
```
