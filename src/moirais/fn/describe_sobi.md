...
`print(result)` render. See `moirais.fn.describe('sobi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobi import *
import numpy as np
# See the function signature in fn/sobi.py for argument names.
```
