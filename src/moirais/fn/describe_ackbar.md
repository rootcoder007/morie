# describe('ackbar') — detect_outliers
...
`print(result)` render. See `moirais.fn.describe('ackbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ackbar import *
import numpy as np
# See the function signature in fn/ackbar.py for argument names.
```
