# describe('rghhmm') — rangayyan_hodgkin_huxley
...
`print(result)` render. See `moirais.fn.describe('rghhmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghhmm import *
import numpy as np
# See the function signature in fn/rghhmm.py for argument names.
```
