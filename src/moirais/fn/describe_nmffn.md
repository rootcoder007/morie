...
`print(result)` render. See `moirais.fn.describe('nmffn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmffn import *
import numpy as np
# See the function signature in fn/nmffn.py for argument names.
```
