...
`print(result)` render. See `moirais.fn.describe('gwrres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrres import *
import numpy as np
# See the function signature in fn/gwrres.py for argument names.
```
