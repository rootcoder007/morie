# describe('irtgpc') — generalized_partial_credit
...
`print(result)` render. See `moirais.fn.describe('irtgpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtgpc import *
import numpy as np
# See the function signature in fn/irtgpc.py for argument names.
```
