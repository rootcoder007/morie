# describe('medstg') — sequential_mediation
...
`print(result)` render. See `moirais.fn.describe('medstg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medstg import *
import numpy as np
# See the function signature in fn/medstg.py for argument names.
```
