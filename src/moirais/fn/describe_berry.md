...
`print(result)` render. See `moirais.fn.describe('berry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.berry import *
import numpy as np
# See the function signature in fn/berry.py for argument names.
```
