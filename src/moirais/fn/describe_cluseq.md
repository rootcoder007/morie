# describe('cluseq') — sequence_clustering
...
`print(result)` render. See `moirais.fn.describe('cluseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cluseq import *
import numpy as np
# See the function signature in fn/cluseq.py for argument names.
```
