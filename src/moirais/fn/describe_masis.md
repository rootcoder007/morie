...
`print(result)` render. See `moirais.fn.describe('masis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masis import *
import numpy as np
# See the function signature in fn/masis.py for argument names.
```
