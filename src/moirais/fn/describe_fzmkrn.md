# describe('fzmkrn') — fauzi_muller_fourth_order_kernel
...
`print(result)` render. See `moirais.fn.describe('fzmkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmkrn import *
import numpy as np
# See the function signature in fn/fzmkrn.py for argument names.
```
