...
`print(result)` render. See `moirais.fn.describe('kglam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kglam import *
import numpy as np
# See the function signature in fn/kglam.py for argument names.
```
