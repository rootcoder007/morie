...
`print(result)` render. See `moirais.fn.describe('mcanis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcanis import *
import numpy as np
# See the function signature in fn/mcanis.py for argument names.
```
