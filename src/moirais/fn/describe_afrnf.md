...
`print(result)` render. See `moirais.fn.describe('afrnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afrnf import *
import numpy as np
# See the function signature in fn/afrnf.py for argument names.
```
