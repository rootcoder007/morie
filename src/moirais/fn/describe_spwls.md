# describe('spwls') — schabenberger_wls_variogram
...
`print(result)` render. See `moirais.fn.describe('spwls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spwls import *
import numpy as np
# See the function signature in fn/spwls.py for argument names.
```
