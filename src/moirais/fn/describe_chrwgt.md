# describe('chrwgt') — censoring_at_risk_weight
...
`print(result)` render. See `moirais.fn.describe('chrwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chrwgt import *
import numpy as np
# See the function signature in fn/chrwgt.py for argument names.
```
