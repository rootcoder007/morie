# describe('rgrls') — rangayyan_rls_filter
...
`print(result)` render. See `moirais.fn.describe('rgrls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrls import *
import numpy as np
# See the function signature in fn/rgrls.py for argument names.
```
