# describe('efrnt') — efron_tie_correction
...
`print(result)` render. See `moirais.fn.describe('efrnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.efrnt import *
import numpy as np
# See the function signature in fn/efrnt.py for argument names.
```
