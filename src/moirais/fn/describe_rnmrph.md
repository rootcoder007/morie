...
`print(result)` render. See `moirais.fn.describe('rnmrph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnmrph import *
import numpy as np
# See the function signature in fn/rnmrph.py for argument names.
```
