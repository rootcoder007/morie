...
`print(result)` render. See `moirais.fn.describe('dtrlg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtrlg import *
import numpy as np
# See the function signature in fn/dtrlg.py for argument names.
```
