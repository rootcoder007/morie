...
`print(result)` render. See `moirais.fn.describe('eslpls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslpls import *
import numpy as np
# See the function signature in fn/eslpls.py for argument names.
```
