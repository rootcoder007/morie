# describe('logit') — logistic_regression
...
`print(result)` render. See `moirais.fn.describe('logit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logit import *
import numpy as np
# See the function signature in fn/logit.py for argument names.
```
