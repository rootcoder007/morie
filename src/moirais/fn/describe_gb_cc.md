# describe('gb_cc') — gibbons_continuity_corr
...
`print(result)` render. See `moirais.fn.describe('gb_cc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_cc import *
import numpy as np
# See the function signature in fn/gb_cc.py for argument names.
```
