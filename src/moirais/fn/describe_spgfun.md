# describe('spgfun') — schabenberger_g_function
...
`print(result)` render. See `moirais.fn.describe('spgfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgfun import *
import numpy as np
# See the function signature in fn/spgfun.py for argument names.
```
