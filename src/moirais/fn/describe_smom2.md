...
`print(result)` render. See `moirais.fn.describe('smom2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smom2 import *
import numpy as np
# See the function signature in fn/smom2.py for argument names.
```
