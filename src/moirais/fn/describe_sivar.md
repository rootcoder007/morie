...
`print(result)` render. See `moirais.fn.describe('sivar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sivar import *
import numpy as np
# See the function signature in fn/sivar.py for argument names.
```
