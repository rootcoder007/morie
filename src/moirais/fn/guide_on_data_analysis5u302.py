...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_302"]


def guide_on_data_analysis_chapter_5_unnumbered_302(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ‖Y − X𝛽‖2 = (Y − X𝛽)⊤(Y − X𝛽).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u302')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u302: GeneralStatistics expression (auto-extracted; see ref)."
