...
__all__ = ["wilcox_chapter_14_unnumbered_487"]


def wilcox_chapter_14_unnumbered_487(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: indt(x, y, nboot = 500, alpha = 0.05, flag = 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u487')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u487: GeneralStatistics expression (auto-extracted; see ref)."
