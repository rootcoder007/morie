# describe('kgtrn') — kriging_trend_surface
...
`print(result)` render. See `moirais.fn.describe('kgtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgtrn import *
import numpy as np
# See the function signature in fn/kgtrn.py for argument names.
```
