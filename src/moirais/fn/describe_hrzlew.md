# describe('hrzlew') — horowitz_lewbel_estimator
...
`print(result)` render. See `moirais.fn.describe('hrzlew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzlew import *
import numpy as np
# See the function signature in fn/hrzlew.py for argument names.
```
