...
__all__ = ["hedderich_chapter_9_unnumbered_3287"]


def hedderich_chapter_9_unnumbered_3287(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ′ˆϵ2)/(n1 +n2−2(k + 1))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3287')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3287: GeneralStatistics expression (auto-extracted; see ref)."
