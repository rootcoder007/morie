...
`print(result)` render. See `moirais.fn.describe('ksone')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksone import *
import numpy as np
# See the function signature in fn/ksone.py for argument names.
```
