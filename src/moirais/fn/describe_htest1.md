# describe('htest1') — horvitz_thompson
...
`print(result)` render. See `moirais.fn.describe('htest1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htest1 import *
import numpy as np
# See the function signature in fn/htest1.py for argument names.
```
