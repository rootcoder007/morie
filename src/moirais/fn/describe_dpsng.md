# describe('dpsng') — dp_singularity_test
...
`print(result)` render. See `moirais.fn.describe('dpsng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsng import *
import numpy as np
# See the function signature in fn/dpsng.py for argument names.
```
