...
def ca_chapter_11_equation_5(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca11e5')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Inference expression involving 'compute' (auto-extracted; see reference for full context)."},
    )
