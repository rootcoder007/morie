# describe('predi') — prediction_interval
...
`print(result)` render. See `moirais.fn.describe('predi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.predi import *
import numpy as np
# See the function signature in fn/predi.py for argument names.
```
