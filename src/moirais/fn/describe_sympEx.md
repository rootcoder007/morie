...
`print(result)` render. See `moirais.fn.describe('sympEx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sympEx import *
import numpy as np
# See the function signature in fn/sympEx.py for argument names.
```
