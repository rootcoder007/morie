# describe('itrlrn') — iterative_q_learning
...
`print(result)` render. See `moirais.fn.describe('itrlrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itrlrn import *
import numpy as np
# See the function signature in fn/itrlrn.py for argument names.
```
