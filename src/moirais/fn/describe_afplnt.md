# describe('afplnt') — afplnt

## WHAT IT DOES

Planting date spatial
...
`print(result)` render. See `moirais.fn.describe('afplnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afplnt import *
import numpy as np
# See the function signature in fn/afplnt.py for argument names.
```
