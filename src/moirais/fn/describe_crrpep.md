...
`print(result)` render. See `moirais.fn.describe('crrpep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crrpep import *
import numpy as np
# See the function signature in fn/crrpep.py for argument names.
```
