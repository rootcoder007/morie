...
`print(result)` render. See `moirais.fn.describe('alrsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrsk import *
import numpy as np
# See the function signature in fn/alrsk.py for argument names.
```
