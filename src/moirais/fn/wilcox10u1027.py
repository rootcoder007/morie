...
__all__ = ["wilcox_chapter_10_unnumbered_1027"]


def wilcox_chapter_10_unnumbered_1027(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: bwbmcp(J, K, x, tr = 0.2, con = 0, alpha = 0.05, dif = TRUE, pool=FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1027')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1027: PowerAndDesign expression (auto-extracted; see ref)."
