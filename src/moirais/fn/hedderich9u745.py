...
__all__ = ["hedderich_chapter_9_unnumbered_745"]


def hedderich_chapter_9_unnumbered_745(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X =k) = (−1)k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u745')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u745: CountModels expression (auto-extracted; see ref)."
