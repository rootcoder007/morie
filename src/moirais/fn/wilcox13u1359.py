...
__all__ = ["wilcox_chapter_13_unnumbered_1359"]


def wilcox_chapter_13_unnumbered_1359(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3. µ = 3, σ 2 = 1.6. 4. Smaller, σ 2 = 1.3. 5. Larger. 7. (a) 0.3, (b) 0.03/.3, (c) 0.09/.3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1359')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1359: GeneralStatistics expression (auto-extracted; see ref)."
