...
__all__ = ["wilcox_chapter_4_unnumbered_121"]


def wilcox_chapter_4_unnumbered_121(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E(X +c) = E(X) +c. (3.18)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u121')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u121: GeneralStatistics expression (auto-extracted; see ref)."
