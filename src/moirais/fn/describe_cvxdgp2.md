# describe('cvxdgp2') — boyd_duality_gap
...
`print(result)` render. See `moirais.fn.describe('cvxdgp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxdgp2 import *
import numpy as np
# See the function signature in fn/cvxdgp2.py for argument names.
```
