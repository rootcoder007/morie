# describe('matrwl') — matrwl

## WHAT IT DOES

Trawl survey spatial
...
`print(result)` render. See `moirais.fn.describe('matrwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matrwl import *
import numpy as np
# See the function signature in fn/matrwl.py for argument names.
```
