...
`print(result)` render. See `moirais.fn.describe('holo_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_r import *
import numpy as np
# See the function signature in fn/holo_r.py for argument names.
```
