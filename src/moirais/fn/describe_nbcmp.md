...
`print(result)` render. See `moirais.fn.describe('nbcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcmp import *
import numpy as np
# See the function signature in fn/nbcmp.py for argument names.
```
