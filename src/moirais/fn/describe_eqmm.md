# describe('eqmm') — equating_mean_mean
...
`print(result)` render. See `moirais.fn.describe('eqmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqmm import *
import numpy as np
# See the function signature in fn/eqmm.py for argument names.
```
