# describe('gh_c13_14') — ghosal_cox_post
...
`print(result)` render. See `moirais.fn.describe('gh_c13_14')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_14 import *
import numpy as np
# See the function signature in fn/gh_c13_14.py for argument names.
```
