...
`print(result)` render. See `moirais.fn.describe('cscpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscpt import *
import numpy as np
# See the function signature in fn/cscpt.py for argument names.
```
