...
`print(result)` render. See `moirais.fn.describe('kmcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcls import *
import numpy as np
# See the function signature in fn/kmcls.py for argument names.
```
