...
__all__ = ["hedderich_chapter_9_unnumbered_3669"]


def hedderich_chapter_9_unnumbered_3669(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : α1 =α2 . . . . . . . . . . . . . . . . . . . .792
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3669')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3669: GeneralStatistics expression (auto-extracted; see ref)."
