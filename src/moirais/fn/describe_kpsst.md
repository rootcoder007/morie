...
`print(result)` render. See `moirais.fn.describe('kpsst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpsst import *
import numpy as np
# See the function signature in fn/kpsst.py for argument names.
```
