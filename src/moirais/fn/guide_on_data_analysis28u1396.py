...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1396"]


def guide_on_data_analysis_chapter_28_unnumbered_1396(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑡 = 𝛽0 + 𝛽1 ∗ 𝑇 + 𝛽2 ∗ 𝐷 + 𝛽3 ∗ (𝑇 ∗ 𝐷) + 𝛽4 ∗ 𝑃 + 𝜖𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1396')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1396: GeneralStatistics expression (auto-extracted; see ref)."
