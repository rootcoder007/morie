# describe('gb641') — gibbons_median_test
...
`print(result)` render. See `moirais.fn.describe('gb641')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb641 import *
import numpy as np
# See the function signature in fn/gb641.py for argument names.
```
