...
`print(result)` render. See `moirais.fn.describe('gcadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcadp import *
import numpy as np
# See the function signature in fn/gcadp.py for argument names.
```
