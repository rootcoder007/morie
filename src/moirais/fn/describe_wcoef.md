...
`print(result)` render. See `moirais.fn.describe('wcoef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wcoef import *
import numpy as np
# See the function signature in fn/wcoef.py for argument names.
```
