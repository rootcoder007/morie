# describe('kmmsc') — kamath_moverscore
...
`print(result)` render. See `moirais.fn.describe('kmmsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmmsc import *
import numpy as np
# See the function signature in fn/kmmsc.py for argument names.
```
