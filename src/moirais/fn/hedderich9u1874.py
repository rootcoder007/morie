...
__all__ = ["hedderich_chapter_9_unnumbered_1874"]


def hedderich_chapter_9_unnumbered_1874(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (3−5)2 + (5−6)2 = 6, i.e.δ2/s2 = 6/10 = 0.60< 0.626 the null hypothesis can be rejected
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1874')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1874: GeneralStatistics expression (auto-extracted; see ref)."
