...
`print(result)` render. See `moirais.fn.describe('svlss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlss import *
import numpy as np
# See the function signature in fn/svlss.py for argument names.
```
