# describe('vinfer') — variational_inference
...
`print(result)` render. See `moirais.fn.describe('vinfer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vinfer import *
import numpy as np
# See the function signature in fn/vinfer.py for argument names.
```
