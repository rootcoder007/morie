# describe('hynut') — hynut

## WHAT IT DOES

Nutrient loading spatial
...
`print(result)` render. See `moirais.fn.describe('hynut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hynut import *
import numpy as np
# See the function signature in fn/hynut.py for argument names.
```
