...
`print(result)` render. See `moirais.fn.describe('secop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secop import *
import numpy as np
# See the function signature in fn/secop.py for argument names.
```
