# describe('linear') — linearization_se
...
`print(result)` render. See `moirais.fn.describe('linear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linear import *
import numpy as np
# See the function signature in fn/linear.py for argument names.
```
