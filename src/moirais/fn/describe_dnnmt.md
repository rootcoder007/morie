...
`print(result)` render. See `moirais.fn.describe('dnnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnnmt import *
import numpy as np
# See the function signature in fn/dnnmt.py for argument names.
```
