...
`print(result)` render. See `moirais.fn.describe('sdmres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmres import *
import numpy as np
# See the function signature in fn/sdmres.py for argument names.
```
