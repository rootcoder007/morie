...
__all__ = ["hedderich_chapter_9_unnumbered_590"]


def hedderich_chapter_9_unnumbered_590(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u590')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u590: PowerAndDesign expression (auto-extracted; see ref)."
