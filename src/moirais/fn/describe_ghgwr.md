...
`print(result)` render. See `moirais.fn.describe('ghgwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghgwr import *
import numpy as np
# See the function signature in fn/ghgwr.py for argument names.
```
