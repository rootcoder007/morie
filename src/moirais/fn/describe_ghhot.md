...
`print(result)` render. See `moirais.fn.describe('ghhot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghhot import *
import numpy as np
# See the function signature in fn/ghhot.py for argument names.
```
