...
__all__ = ["hedderich_chapter_9_unnumbered_1674"]


def hedderich_chapter_9_unnumbered_1674(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz2 = ˆχ2 = (A[−]−A[+])2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1674')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1674: GeneralStatistics expression (auto-extracted; see ref)."
