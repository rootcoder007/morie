...
`print(result)` render. See `moirais.fn.describe('efart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.efart import *
import numpy as np
# See the function signature in fn/efart.py for argument names.
```
