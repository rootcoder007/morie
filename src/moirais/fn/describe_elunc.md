...
`print(result)` render. See `moirais.fn.describe('elunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elunc import *
import numpy as np
# See the function signature in fn/elunc.py for argument names.
```
