...
`print(result)` render. See `moirais.fn.describe('wqdrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqdrk import *
import numpy as np
# See the function signature in fn/wqdrk.py for argument names.
```
