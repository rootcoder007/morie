# describe('johnsen') — johansen_test
...
`print(result)` render. See `moirais.fn.describe('johnsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johnsen import *
import numpy as np
# See the function signature in fn/johnsen.py for argument names.
```
