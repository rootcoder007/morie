...
`print(result)` render. See `moirais.fn.describe('prcep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prcep import *
import numpy as np
# See the function signature in fn/prcep.py for argument names.
```
