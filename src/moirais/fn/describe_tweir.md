...
`print(result)` render. See `moirais.fn.describe('tweir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tweir import *
import numpy as np
# See the function signature in fn/tweir.py for argument names.
```
