# describe('pwaic') — effective_parameters_waic
...
`print(result)` render. See `moirais.fn.describe('pwaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwaic import *
import numpy as np
# See the function signature in fn/pwaic.py for argument names.
```
