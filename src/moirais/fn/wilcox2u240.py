...
__all__ = ["wilcox_chapter_2_unnumbered_240"]


def wilcox_chapter_2_unnumbered_240(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 29. Compute a 0.95 confidence interval if (a) n = 10, ¯X = 26, s = 9, (b) n = 18,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u240')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u240: PowerAndDesign expression (auto-extracted; see ref)."
