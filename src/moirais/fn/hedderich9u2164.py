...
__all__ = ["hedderich_chapter_9_unnumbered_2164"]
...
def hedderich_chapter_9_unnumbered_2164(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2164')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2164: PowerAndDesign expression (auto-extracted; see ref)."
