...
`print(result)` render. See `moirais.fn.describe('lisa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lisa import *
import numpy as np
# See the function signature in fn/lisa.py for argument names.
```
