...
`print(result)` render. See `moirais.fn.describe('armam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.armam import *
import numpy as np
# See the function signature in fn/armam.py for argument names.
```
