# describe('polyc') — polychoric_corr
...
`print(result)` render. See `moirais.fn.describe('polyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polyc import *
import numpy as np
# See the function signature in fn/polyc.py for argument names.
```
