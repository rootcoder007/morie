# describe('hrzdcnm') — horowitz_deconv_normality
...
`print(result)` render. See `moirais.fn.describe('hrzdcnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzdcnm import *
import numpy as np
# See the function signature in fn/hrzdcnm.py for argument names.
```
