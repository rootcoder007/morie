# describe('gb433') — gibbons_ks_kolmogorov_limit
...
`print(result)` render. See `moirais.fn.describe('gb433')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb433 import *
import numpy as np
# See the function signature in fn/gb433.py for argument names.
```
