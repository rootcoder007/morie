# describe('vaceff') — vaccine_efficacy
...
`print(result)` render. See `moirais.fn.describe('vaceff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaceff import *
import numpy as np
# See the function signature in fn/vaceff.py for argument names.
```
