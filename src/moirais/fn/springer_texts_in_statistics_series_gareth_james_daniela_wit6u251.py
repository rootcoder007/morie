...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_251"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_251(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: β0 +β1X1 +β2X2 +... +βpXp < 0, (9.4)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u251')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u251: GeneralStatistics expression (auto-extracted; see ref)."
