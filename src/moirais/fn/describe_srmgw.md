...
`print(result)` render. See `moirais.fn.describe('srmgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmgw import *
import numpy as np
# See the function signature in fn/srmgw.py for argument names.
```
