# describe('ensrv') — ensemble_variance
...
`print(result)` render. See `moirais.fn.describe('ensrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ensrv import *
import numpy as np
# See the function signature in fn/ensrv.py for argument names.
```
