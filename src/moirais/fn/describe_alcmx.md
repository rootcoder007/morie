...
`print(result)` render. See `moirais.fn.describe('alcmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alcmx import *
import numpy as np
# See the function signature in fn/alcmx.py for argument names.
```
