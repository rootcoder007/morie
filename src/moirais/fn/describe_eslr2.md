...
`print(result)` render. See `moirais.fn.describe('eslr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslr2 import *
import numpy as np
# See the function signature in fn/eslr2.py for argument names.
```
