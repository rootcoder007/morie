# describe('rpl_rt') — rplace_region_trend
...
`print(result)` render. See `moirais.fn.describe('rpl_rt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_rt import *
import numpy as np
# See the function signature in fn/rpl_rt.py for argument names.
```
