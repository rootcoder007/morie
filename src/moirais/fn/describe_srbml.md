...
`print(result)` render. See `moirais.fn.describe('srbml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbml import *
import numpy as np
# See the function signature in fn/srbml.py for argument names.
```
