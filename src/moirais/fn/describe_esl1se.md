# describe('esl1se') — esl_one_se_rule
...
`print(result)` render. See `moirais.fn.describe('esl1se')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esl1se import *
import numpy as np
# See the function signature in fn/esl1se.py for argument names.
```
