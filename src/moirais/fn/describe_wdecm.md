...
`print(result)` render. See `moirais.fn.describe('wdecm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wdecm import *
import numpy as np
# See the function signature in fn/wdecm.py for argument names.
```
