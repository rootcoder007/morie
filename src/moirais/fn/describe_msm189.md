# describe('msm189') — mvsml_ridge_lasso_elastic_eq_9_17
...
`print(result)` render. See `moirais.fn.describe('msm189')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm189 import *
import numpy as np
# See the function signature in fn/msm189.py for argument names.
```
