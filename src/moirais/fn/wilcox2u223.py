...
__all__ = ["wilcox_chapter_2_unnumbered_223"]


def wilcox_chapter_2_unnumbered_223(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Appendix B. That is, if Z is a standard normal random variable, P (Z ≤ c) = 1 − α/2. To
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u223')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u223: GeneralStatistics expression (auto-extracted; see ref)."
