# describe('gh_var_dp_post') — ghosal_variational_dp_posterior
...
`print(result)` render. See `moirais.fn.describe('gh_var_dp_post')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_var_dp_post import *
import numpy as np
# See the function signature in fn/gh_var_dp_post.py for argument names.
```
