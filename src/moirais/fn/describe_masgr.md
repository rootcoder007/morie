...
`print(result)` render. See `moirais.fn.describe('masgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masgr import *
import numpy as np
# See the function signature in fn/masgr.py for argument names.
```
