...
__all__ = ["hedderich_chapter_9_unnumbered_3563"]


def hedderich_chapter_9_unnumbered_3563(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = exp(−λ0·exp(X′β)·t) = exp(−λ·t)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3563')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3563: GeneralStatistics expression (auto-extracted; see ref)."
