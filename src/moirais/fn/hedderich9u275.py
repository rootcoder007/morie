...
__all__ = ["hedderich_chapter_9_unnumbered_275"]


def hedderich_chapter_9_unnumbered_275(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] G∗=G·N/(N−1) with 0≤G∗≤1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u275')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u275: GeneralStatistics expression (auto-extracted; see ref)."
