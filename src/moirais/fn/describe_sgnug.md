# describe('sgnug') — nugget_effect_estimate
...
`print(result)` render. See `moirais.fn.describe('sgnug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnug import *
import numpy as np
# See the function signature in fn/sgnug.py for argument names.
```
