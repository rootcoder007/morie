# describe('msm098') — mvsml_bayesian_regression_pt2_eq_7_5
...
`print(result)` render. See `moirais.fn.describe('msm098')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm098 import *
import numpy as np
# See the function signature in fn/msm098.py for argument names.
```
