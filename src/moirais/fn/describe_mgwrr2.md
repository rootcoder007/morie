...
`print(result)` render. See `moirais.fn.describe('mgwrr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrr2 import *
import numpy as np
# See the function signature in fn/mgwrr2.py for argument names.
```
