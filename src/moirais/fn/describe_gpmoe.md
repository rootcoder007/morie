# describe('gpmoe') — gp_mixture_of_experts
...
`print(result)` render. See `moirais.fn.describe('gpmoe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpmoe import *
import numpy as np
# See the function signature in fn/gpmoe.py for argument names.
```
