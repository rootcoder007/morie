...
`print(result)` render. See `moirais.fn.describe('dpmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmed import *
import numpy as np
# See the function signature in fn/dpmed.py for argument names.
```
