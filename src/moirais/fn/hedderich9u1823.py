...
__all__ = ["hedderich_chapter_9_unnumbered_1823"]


def hedderich_chapter_9_unnumbered_1823(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: underH0 applies: c =µ0 +tν,1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1823')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1823: GeneralStatistics expression (auto-extracted; see ref)."
