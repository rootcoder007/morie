# describe('ssiz') — sample_size_means
...
`print(result)` render. See `moirais.fn.describe('ssiz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssiz import *
import numpy as np
# See the function signature in fn/ssiz.py for argument names.
```
