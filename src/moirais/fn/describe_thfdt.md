# describe('thfdt') — terry_hoeffding_test
...
`print(result)` render. See `moirais.fn.describe('thfdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thfdt import *
import numpy as np
# See the function signature in fn/thfdt.py for argument names.
```
