...
`print(result)` render. See `moirais.fn.describe('wvltdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvltdb import *
import numpy as np
# See the function signature in fn/wvltdb.py for argument names.
```
