# describe('betvae') — beta_vae_disentangle
...
`print(result)` render. See `moirais.fn.describe('betvae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.betvae import *
import numpy as np
# See the function signature in fn/betvae.py for argument names.
```
