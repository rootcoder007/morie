# describe('mmaxn') — minmax_normalization
...
`print(result)` render. See `moirais.fn.describe('mmaxn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmaxn import *
import numpy as np
# See the function signature in fn/mmaxn.py for argument names.
```
