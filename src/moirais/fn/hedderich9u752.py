...
__all__ = ["hedderich_chapter_9_unnumbered_752"]


def hedderich_chapter_9_unnumbered_752(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] > n =100; x <− 0 : 1 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u752')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u752: CountModels expression (auto-extracted; see ref)."
