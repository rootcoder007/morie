# describe('bndsdo') — bound_skewed_outcome
...
`print(result)` render. See `moirais.fn.describe('bndsdo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndsdo import *
import numpy as np
# See the function signature in fn/bndsdo.py for argument names.
```
