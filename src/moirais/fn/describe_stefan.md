# describe('stefan') — stefan_boltzmann
...
`print(result)` render. See `moirais.fn.describe('stefan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stefan import *
import numpy as np
# See the function signature in fn/stefan.py for argument names.
```
