# describe('cb14e1') — cb_chapter_14_equation_1
...
```python
from moirais.fn.cb14e1 import cb_chapter_14_equation_1
import numpy as np
result = cb_chapter_14_equation_1(np.random.default_rng(42).normal(0, 1, 100))
