...
`print(result)` render. See `moirais.fn.describe('ubpdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubpdm import *
import numpy as np
# See the function signature in fn/ubpdm.py for argument names.
```
