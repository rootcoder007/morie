# describe('theta') — watterson_theta
...
`print(result)` render. See `moirais.fn.describe('theta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.theta import *
import numpy as np
# See the function signature in fn/theta.py for argument names.
```
