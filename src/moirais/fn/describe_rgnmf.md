...
`print(result)` render. See `moirais.fn.describe('rgnmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgnmf import *
import numpy as np
# See the function signature in fn/rgnmf.py for argument names.
```
