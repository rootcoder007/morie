...
`print(result)` render. See `moirais.fn.describe('hybre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hybre import *
import numpy as np
# See the function signature in fn/hybre.py for argument names.
```
