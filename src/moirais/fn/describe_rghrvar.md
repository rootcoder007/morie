# describe('rghrvar') — rangayyan_hrv_ar_ratio
...
`print(result)` render. See `moirais.fn.describe('rghrvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrvar import *
import numpy as np
# See the function signature in fn/rghrvar.py for argument names.
```
