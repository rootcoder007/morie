# describe('bklap') — burkov_laplace_add_one
...
`print(result)` render. See `moirais.fn.describe('bklap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bklap import *
import numpy as np
# See the function signature in fn/bklap.py for argument names.
```
