...
`print(result)` render. See `moirais.fn.describe('hyphs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyphs import *
import numpy as np
# See the function signature in fn/hyphs.py for argument names.
```
