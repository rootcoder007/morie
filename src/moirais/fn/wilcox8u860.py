...
__all__ = ["wilcox_chapter_8_unnumbered_860"]


def wilcox_chapter_8_unnumbered_860(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: DiL =Xi,J −1 − XiJ.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u860')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u860: PowerAndDesign expression (auto-extracted; see ref)."
