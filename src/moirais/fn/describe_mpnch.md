...
`print(result)` render. See `moirais.fn.describe('mpnch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpnch import *
import numpy as np
# See the function signature in fn/mpnch.py for argument names.
```
