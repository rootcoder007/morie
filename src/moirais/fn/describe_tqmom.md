# describe('tqmom') — turboquant_normal_moment
...
`print(result)` render. See `moirais.fn.describe('tqmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqmom import *
import numpy as np
# See the function signature in fn/tqmom.py for argument names.
```
