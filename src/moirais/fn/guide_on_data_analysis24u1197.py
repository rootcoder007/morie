...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1197"]


def guide_on_data_analysis_chapter_24_unnumbered_1197(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑆𝑆𝑇𝑂 = 𝑆𝑆𝐴 + 𝑆𝑆𝐵(𝐴) + 𝑆𝑆𝐸
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1197')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1197: GeneralStatistics expression (auto-extracted; see ref)."
