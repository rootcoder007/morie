...
__all__ = ["wilcox_chapter_7_unnumbered_351"]


def wilcox_chapter_7_unnumbered_351(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: stein1.tr(x, del, alpha = 0.05, pow = 0.8, tr = 0.2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u351')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u351: PowerAndDesign expression (auto-extracted; see ref)."
