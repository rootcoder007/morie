# describe('zerad') — radiation_model
...
`print(result)` render. See `moirais.fn.describe('zerad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zerad import *
import numpy as np
# See the function signature in fn/zerad.py for argument names.
```
