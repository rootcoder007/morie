# describe('kmstb') — kamath_step_back_prompting
...
`print(result)` render. See `moirais.fn.describe('kmstb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmstb import *
import numpy as np
# See the function signature in fn/kmstb.py for argument names.
```
