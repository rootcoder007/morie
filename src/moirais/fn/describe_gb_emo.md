# describe('gb_emo') — gibbons_order_moments
...
`print(result)` render. See `moirais.fn.describe('gb_emo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_emo import *
import numpy as np
# See the function signature in fn/gb_emo.py for argument names.
```
