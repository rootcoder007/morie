...
__all__ = ["hedderich_chapter_9_unnumbered_1394"]


def hedderich_chapter_9_unnumbered_1394(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + − sum ( stats : : dweibull( yarn , shape , scale, l o g = TRUE ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1394')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1394: GeneralStatistics expression (auto-extracted; see ref)."
