...
__all__ = ["hedderich_chapter_9_unnumbered_531"]


def hedderich_chapter_9_unnumbered_531(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F (x) 0 1/6 1/6+1/6=1/3 1/6+1/3=1/2 1/6+1/2=2/3 1/6+2/3=5/6 1/6+5/6=1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u531')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u531: GeneralStatistics expression (auto-extracted; see ref)."
