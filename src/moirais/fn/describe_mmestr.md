# describe('mmestr') — mm_estimator_regression
...
`print(result)` render. See `moirais.fn.describe('mmestr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmestr import *
import numpy as np
# See the function signature in fn/mmestr.py for argument names.
```
