# describe('feat') — feature_importance
...
`print(result)` render. See `moirais.fn.describe('feat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.feat import *
import numpy as np
# See the function signature in fn/feat.py for argument names.
```
