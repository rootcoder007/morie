...
`print(result)` render. See `moirais.fn.describe('mi_st')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mi_st import *
import numpy as np
# See the function signature in fn/mi_st.py for argument names.
```
