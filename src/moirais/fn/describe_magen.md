...
`print(result)` render. See `moirais.fn.describe('magen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magen import *
import numpy as np
# See the function signature in fn/magen.py for argument names.
```
