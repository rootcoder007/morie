...
__all__ = ["hedderich_chapter_9_unnumbered_2954"]


def hedderich_chapter_9_unnumbered_2954(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: is evident with ˆλij =n·ˆπij =nnij.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2954')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2954: CountModels expression (auto-extracted; see ref)."
