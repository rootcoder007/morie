# describe('impfun') — genotype_imputation
...
`print(result)` render. See `moirais.fn.describe('impfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.impfun import *
import numpy as np
# See the function signature in fn/impfun.py for argument names.
```
