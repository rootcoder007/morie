...
`print(result)` render. See `moirais.fn.describe('tstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tstat import *
import numpy as np
# See the function signature in fn/tstat.py for argument names.
```
