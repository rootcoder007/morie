...
`print(result)` render. See `moirais.fn.describe('modlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modlr import *
import numpy as np
# See the function signature in fn/modlr.py for argument names.
```
