...
`print(result)` render. See `moirais.fn.describe('zemir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zemir import *
import numpy as np
# See the function signature in fn/zemir.py for argument names.
```
