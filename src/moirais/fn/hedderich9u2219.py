...
__all__ = ["hedderich_chapter_9_unnumbered_2219"]


def hedderich_chapter_9_unnumbered_2219(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2219')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2219: CountModels expression (auto-extracted; see ref)."
