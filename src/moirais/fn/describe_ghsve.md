# describe('ghsve') — ghosal_sieve_prior
...
`print(result)` render. See `moirais.fn.describe('ghsve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsve import *
import numpy as np
# See the function signature in fn/ghsve.py for argument names.
```
