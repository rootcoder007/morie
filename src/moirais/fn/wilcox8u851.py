...
__all__ = ["wilcox_chapter_8_unnumbered_851"]


def wilcox_chapter_8_unnumbered_851(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (c), where c = (1 − α )B rounded to the nearest integer.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u851')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u851: GeneralStatistics expression (auto-extracted; see ref)."
