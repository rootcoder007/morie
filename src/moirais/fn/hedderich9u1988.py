...
__all__ = ["hedderich_chapter_9_unnumbered_1988"]


def hedderich_chapter_9_unnumbered_1988(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( n% %2==1) { d <− d [ , c ( 1 : trunc ( n / 2 ) , ( trunc ( n / 2 ) + 2 ) : n ) ] ; n <− n − 1 }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1988')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1988: PowerAndDesign expression (auto-extracted; see ref)."
