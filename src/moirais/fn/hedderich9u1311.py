...
__all__ = ["hedderich_chapter_9_unnumbered_1311"]


def hedderich_chapter_9_unnumbered_1311(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆVar [log(ˆτ1)] + ˆVar [log(ˆτ2)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1311')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1311: GeneralStatistics expression (auto-extracted; see ref)."
