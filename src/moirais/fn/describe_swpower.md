...
`print(result)` render. See `moirais.fn.describe('swpower')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swpower import *
import numpy as np
# See the function signature in fn/swpower.py for argument names.
```
