# describe('hrzrob') — horowitz_rate_beta_estimation
...
`print(result)` render. See `moirais.fn.describe('hrzrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzrob import *
import numpy as np
# See the function signature in fn/hrzrob.py for argument names.
```
