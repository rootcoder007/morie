...
__all__ = ["hedderich_chapter_9_unnumbered_3072"]


def hedderich_chapter_9_unnumbered_3072(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + nrow =10 , n c o l=3 , byrow=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3072')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3072: GeneralStatistics expression (auto-extracted; see ref)."
