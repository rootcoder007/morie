...
`print(result)` render. See `moirais.fn.describe('topDn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.topDn import *
import numpy as np
# See the function signature in fn/topDn.py for argument names.
```
