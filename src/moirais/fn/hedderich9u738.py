...
__all__ = ["hedderich_chapter_9_unnumbered_738"]


def hedderich_chapter_9_unnumbered_738(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u738')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u738: GeneralStatistics expression (auto-extracted; see ref)."
