...
__all__ = ["wilcox_chapter_8_unnumbered_857"]


def wilcox_chapter_8_unnumbered_857(x):
    """
    Resampling expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u857')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u857: Resampling expression (auto-extracted; see ref)."
