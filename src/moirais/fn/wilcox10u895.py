...
__all__ = ["wilcox_chapter_10_unnumbered_895"]


def wilcox_chapter_10_unnumbered_895(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Decision Rule:H0 is rejected if FB ≥ f , where f is the 1 − α quantile of an F distribution
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u895')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u895: GeneralStatistics expression (auto-extracted; see ref)."
