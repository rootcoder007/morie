...
`print(result)` render. See `moirais.fn.describe('surxgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.surxgb import *
import numpy as np
# See the function signature in fn/surxgb.py for argument names.
```
