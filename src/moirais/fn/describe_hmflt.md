# describe('hmflt') — homomorphic_filter
...
`print(result)` render. See `moirais.fn.describe('hmflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmflt import *
import numpy as np
# See the function signature in fn/hmflt.py for argument names.
```
