# describe('embd') — embedding_similarity
...
`print(result)` render. See `moirais.fn.describe('embd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.embd import *
import numpy as np
# See the function signature in fn/embd.py for argument names.
```
