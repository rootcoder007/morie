# describe('mywkr') — modified_yule_walker_arma_fn
...
`print(result)` render. See `moirais.fn.describe('mywkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mywkr import *
import numpy as np
# See the function signature in fn/mywkr.py for argument names.
```
