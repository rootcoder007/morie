...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_935"]


def guide_on_data_analysis_chapter_16_unnumbered_935(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: axis.text = element_text(size = 12)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u935')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u935: GeneralStatistics expression (auto-extracted; see ref)."
