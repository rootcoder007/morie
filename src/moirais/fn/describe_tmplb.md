# describe('tmplb') — template_library
...
`print(result)` render. See `moirais.fn.describe('tmplb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmplb import *
import numpy as np
# See the function signature in fn/tmplb.py for argument names.
```
