...
__all__ = ["hedderich_chapter_9_unnumbered_2142"]


def hedderich_chapter_9_unnumbered_2142(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Z = 1 . 6 4 7 3 , p− value = 0 . 1 0 7 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2142')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2142: GeneralStatistics expression (auto-extracted; see ref)."
