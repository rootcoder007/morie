...
`print(result)` render. See `moirais.fn.describe('stkval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkval import *
import numpy as np
# See the function signature in fn/stkval.py for argument names.
```
