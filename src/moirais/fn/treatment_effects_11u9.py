...
__all__ = ["treatment_effects_1_chapter_1_unnumbered_9"]


def treatment_effects_1_chapter_1_unnumbered_9(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆαATE = ¯YT− ¯YC =βS. (9)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('treatment_effects_11u9')`` for the full guide.
...
def cheatsheet():
    return "treatment_effects_11u9: GeneralStatistics expression (auto-extracted; see ref)."
