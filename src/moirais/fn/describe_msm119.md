# describe('msm119') — mvsml_bayesian_regression_pt2_eq_7_10
...
`print(result)` render. See `moirais.fn.describe('msm119')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm119 import *
import numpy as np
# See the function signature in fn/msm119.py for argument names.
```
