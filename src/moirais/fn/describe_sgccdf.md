# describe('sgccdf') — conditional_cdf_indicator
...
`print(result)` render. See `moirais.fn.describe('sgccdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgccdf import *
import numpy as np
# See the function signature in fn/sgccdf.py for argument names.
```
