# describe('tpsrp') — tps_report_analysis
...
`print(result)` render. See `moirais.fn.describe('tpsrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsrp import *
import numpy as np
# See the function signature in fn/tpsrp.py for argument names.
```
