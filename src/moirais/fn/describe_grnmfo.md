# describe('grnmfo') — geron_nmf_objective
...
`print(result)` render. See `moirais.fn.describe('grnmfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnmfo import *
import numpy as np
# See the function signature in fn/grnmfo.py for argument names.
```
