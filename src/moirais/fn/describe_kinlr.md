...
`print(result)` render. See `moirais.fn.describe('kinlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kinlr import *
import numpy as np
# See the function signature in fn/kinlr.py for argument names.
```
