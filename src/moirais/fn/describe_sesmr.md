...
`print(result)` render. See `moirais.fn.describe('sesmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sesmr import *
import numpy as np
# See the function signature in fn/sesmr.py for argument names.
```
