...
`print(result)` render. See `moirais.fn.describe('drspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drspr import *
import numpy as np
# See the function signature in fn/drspr.py for argument names.
```
