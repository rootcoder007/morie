...
__all__ = ["bivand2013_chapter_7_unnumbered_119"]


def bivand2013_chapter_7_unnumbered_119(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + return(fv(res, valu = "D", fname = "D"))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u119')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u119: GeneralStatistics expression (auto-extracted; see ref)."
