# describe('hmpe') — geron_positional_encoding
...
`print(result)` render. See `moirais.fn.describe('hmpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpe import *
import numpy as np
# See the function signature in fn/hmpe.py for argument names.
```
