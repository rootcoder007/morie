# describe('msm082') — mvsml_bayesian_regression_eq_6_3
...
`print(result)` render. See `moirais.fn.describe('msm082')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm082 import *
import numpy as np
# See the function signature in fn/msm082.py for argument names.
```
