# describe('boxfd') — box_counting_fd
...
`print(result)` render. See `moirais.fn.describe('boxfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boxfd import *
import numpy as np
# See the function signature in fn/boxfd.py for argument names.
```
