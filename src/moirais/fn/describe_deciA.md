...
`print(result)` render. See `moirais.fn.describe('deciA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deciA import *
import numpy as np
# See the function signature in fn/deciA.py for argument names.
```
