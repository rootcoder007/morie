# describe('gh_c3_3') — ghosal_dir_simplex
...
`print(result)` render. See `moirais.fn.describe('gh_c3_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_3 import *
import numpy as np
# See the function signature in fn/gh_c3_3.py for argument names.
```
