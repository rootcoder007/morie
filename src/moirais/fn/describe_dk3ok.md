...
`print(result)` render. See `moirais.fn.describe('dk3ok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3ok import *
import numpy as np
# See the function signature in fn/dk3ok.py for argument names.
```
