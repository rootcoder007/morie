...
`print(result)` render. See `moirais.fn.describe('swadapt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swadapt import *
import numpy as np
# See the function signature in fn/swadapt.py for argument names.
```
