...
__all__ = ["bivand2013_chapter_7_unnumbered_240"]


def bivand2013_chapter_7_unnumbered_240(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: number of cases in regioni can be calculated as Ei = Pir+,wher er+ is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u240')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u240: GeneralStatistics expression (auto-extracted; see ref)."
