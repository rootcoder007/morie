...
`print(result)` render. See `moirais.fn.describe('gaelev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaelev import *
import numpy as np
# See the function signature in fn/gaelev.py for argument names.
```
