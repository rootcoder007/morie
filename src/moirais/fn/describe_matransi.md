# describe('matransi') — ma_logit_inverse
...
`print(result)` render. See `moirais.fn.describe('matransi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matransi import *
import numpy as np
# See the function signature in fn/matransi.py for argument names.
```
