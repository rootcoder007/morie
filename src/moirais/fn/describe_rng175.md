# describe('rng175') — rangayyan_ch3_rls_a_priori_error
...
`print(result)` render. See `moirais.fn.describe('rng175')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng175 import *
import numpy as np
# See the function signature in fn/rng175.py for argument names.
```
