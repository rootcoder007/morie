...
`print(result)` render. See `moirais.fn.describe('svqut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svqut import *
import numpy as np
# See the function signature in fn/svqut.py for argument names.
```
