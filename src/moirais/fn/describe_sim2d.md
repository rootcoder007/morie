# describe('sim2d') — simulate_2d_unfolding
...
`print(result)` render. See `moirais.fn.describe('sim2d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sim2d import *
import numpy as np
# See the function signature in fn/sim2d.py for argument names.
```
