...
__all__ = ["hedderich_chapter_9_unnumbered_2283"]


def hedderich_chapter_9_unnumbered_2283(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: distribution of (Xi−Yj)∼N (µ1−µ2; 2σ2) allows for a formulation of the test problem equivalent
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2283')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2283: GeneralStatistics expression (auto-extracted; see ref)."
