...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1189"]


def guide_on_data_analysis_chapter_24_unnumbered_1189(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑆𝑆𝑇𝑂 = 𝑆𝑆𝐵𝐿 + 𝑆𝑆𝑇𝑅 + 𝑆𝑆𝑖𝑛𝑡 + 𝑆𝑆𝑅𝑒𝑚
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1189')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1189: GeneralStatistics expression (auto-extracted; see ref)."
