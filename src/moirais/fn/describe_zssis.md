...
`print(result)` render. See `moirais.fn.describe('zssis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zssis import *
import numpy as np
# See the function signature in fn/zssis.py for argument names.
```
