# describe('dor') — diagnostic_odds_ratio
...
`print(result)` render. See `moirais.fn.describe('dor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dor import *
import numpy as np
# See the function signature in fn/dor.py for argument names.
```
