...
`print(result)` render. See `moirais.fn.describe('rsbai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsbai import *
import numpy as np
# See the function signature in fn/rsbai.py for argument names.
```
