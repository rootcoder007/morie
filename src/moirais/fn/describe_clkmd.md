...
`print(result)` render. See `moirais.fn.describe('clkmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clkmd import *
import numpy as np
# See the function signature in fn/clkmd.py for argument names.
```
