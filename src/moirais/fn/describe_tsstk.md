...
`print(result)` render. See `moirais.fn.describe('tsstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstk import *
import numpy as np
# See the function signature in fn/tsstk.py for argument names.
```
