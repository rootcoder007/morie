# describe('causiv2sls') — causal_iv_2sls
...
`print(result)` render. See `moirais.fn.describe('causiv2sls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causiv2sls import *
import numpy as np
# See the function signature in fn/causiv2sls.py for argument names.
```
