...
`print(result)` render. See `moirais.fn.describe('softmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.softmx import *
import numpy as np
# See the function signature in fn/softmx.py for argument names.
```
