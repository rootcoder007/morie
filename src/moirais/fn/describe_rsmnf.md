...
`print(result)` render. See `moirais.fn.describe('rsmnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmnf import *
import numpy as np
# See the function signature in fn/rsmnf.py for argument names.
```
