...
`print(result)` render. See `moirais.fn.describe('rsnbr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsnbr2 import *
import numpy as np
# See the function signature in fn/rsnbr2.py for argument names.
```
