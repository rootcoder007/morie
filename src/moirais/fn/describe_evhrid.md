# describe('evhrid') — evt_husler_reiss_dep
...
`print(result)` render. See `moirais.fn.describe('evhrid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evhrid import *
import numpy as np
# See the function signature in fn/evhrid.py for argument names.
```
