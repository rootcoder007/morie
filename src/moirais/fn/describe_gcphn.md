...
`print(result)` render. See `moirais.fn.describe('gcphn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcphn import *
import numpy as np
# See the function signature in fn/gcphn.py for argument names.
```
