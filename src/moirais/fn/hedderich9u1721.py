...
__all__ = ["hedderich_chapter_9_unnumbered_1721"]


def hedderich_chapter_9_unnumbered_1721(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : nblzD = 0 . 1 0 0 6 3 , p− value = 0 . 3 8 9 7
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1721')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1721: GeneralStatistics expression (auto-extracted; see ref)."
