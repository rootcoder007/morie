...
__all__ = ["wilcox_chapter_5_unnumbered_440"]


def wilcox_chapter_5_unnumbered_440(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: algebra is summarized in Appendix C.) The 1 − α confidence interval for β j is taken to be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u440')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u440: GeneralStatistics expression (auto-extracted; see ref)."
