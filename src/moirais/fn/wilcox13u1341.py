...
__all__ = ["wilcox_chapter_13_unnumbered_1341"]


def wilcox_chapter_13_unnumbered_1341(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] flag=(kypho[,2]=="present")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1341')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1341: GeneralStatistics expression (auto-extracted; see ref)."
