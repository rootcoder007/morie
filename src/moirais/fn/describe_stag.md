...
`print(result)` render. See `moirais.fn.describe('stag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stag import *
import numpy as np
# See the function signature in fn/stag.py for argument names.
```
