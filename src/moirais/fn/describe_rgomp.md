...
`print(result)` render. See `moirais.fn.describe('rgomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgomp import *
import numpy as np
# See the function signature in fn/rgomp.py for argument names.
```
