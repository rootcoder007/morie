# describe('tolim') — tolerance_limits
...
`print(result)` render. See `moirais.fn.describe('tolim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tolim import *
import numpy as np
# See the function signature in fn/tolim.py for argument names.
```
