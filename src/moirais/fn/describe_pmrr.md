# describe('pmrr') — pm_relative_risk
...
`print(result)` render. See `moirais.fn.describe('pmrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmrr import *
import numpy as np
# See the function signature in fn/pmrr.py for argument names.
```
