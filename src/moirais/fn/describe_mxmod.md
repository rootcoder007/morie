...
`print(result)` render. See `moirais.fn.describe('mxmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxmod import *
import numpy as np
# See the function signature in fn/mxmod.py for argument names.
```
