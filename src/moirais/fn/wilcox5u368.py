...
__all__ = ["wilcox_chapter_5_unnumbered_368"]


def wilcox_chapter_5_unnumbered_368(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: onesampb(x, est = onestep, alpha = 0.05, nboot = 2000)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u368')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u368: Resampling expression (auto-extracted; see ref)."
