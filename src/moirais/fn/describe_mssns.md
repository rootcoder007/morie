# describe('mssns') — missing_sensitivity_analysis
...
`print(result)` render. See `moirais.fn.describe('mssns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssns import *
import numpy as np
# See the function signature in fn/mssns.py for argument names.
```
