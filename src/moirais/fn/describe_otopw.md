# describe('otopw') — ot_optimised_potentials_warm
...
`print(result)` render. See `moirais.fn.describe('otopw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otopw import *
import numpy as np
# See the function signature in fn/otopw.py for argument names.
```
