# describe('smplts') — sample_lifetable
...
`print(result)` render. See `moirais.fn.describe('smplts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smplts import *
import numpy as np
# See the function signature in fn/smplts.py for argument names.
```
