...
`print(result)` render. See `moirais.fn.describe('ptlfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptlfn import *
import numpy as np
# See the function signature in fn/ptlfn.py for argument names.
```
