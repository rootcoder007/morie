...
`print(result)` render. See `moirais.fn.describe('plnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plnrm import *
import numpy as np
# See the function signature in fn/plnrm.py for argument names.
```
