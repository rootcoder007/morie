...
`print(result)` render. See `moirais.fn.describe('datumx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.datumx import *
import numpy as np
# See the function signature in fn/datumx.py for argument names.
```
