...
`print(result)` render. See `moirais.fn.describe('wsmlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlrt import *
import numpy as np
# See the function signature in fn/wsmlrt.py for argument names.
```
