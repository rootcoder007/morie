# describe('fzb4x') — fauzi_b4_coefficient
...
`print(result)` render. See `moirais.fn.describe('fzb4x')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzb4x import *
import numpy as np
# See the function signature in fn/fzb4x.py for argument names.
```
