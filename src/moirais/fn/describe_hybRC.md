...
`print(result)` render. See `moirais.fn.describe('hybRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hybRC import *
import numpy as np
# See the function signature in fn/hybRC.py for argument names.
```
