# describe('cmds') — classical_metric_mds
...
`print(result)` render. See `moirais.fn.describe('cmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmds import *
import numpy as np
# See the function signature in fn/cmds.py for argument names.
```
