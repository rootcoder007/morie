...
`print(result)` render. See `moirais.fn.describe('ghpme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghpme import *
import numpy as np
# See the function signature in fn/ghpme.py for argument names.
```
