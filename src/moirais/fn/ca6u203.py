...
def ca_chapter_6_unnumbered_203(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca6u203')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'poisson' (auto-extracted; see reference for full context)."},
    )
