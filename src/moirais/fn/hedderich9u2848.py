...
__all__ = ["hedderich_chapter_9_unnumbered_2848"]


def hedderich_chapter_9_unnumbered_2848(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] xk = 8, nk−xk = 2, E(2) = 10·40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2848')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2848: GeneralStatistics expression (auto-extracted; see ref)."
