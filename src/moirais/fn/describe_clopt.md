...
`print(result)` render. See `moirais.fn.describe('clopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clopt import *
import numpy as np
# See the function signature in fn/clopt.py for argument names.
```
