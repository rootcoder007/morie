# describe('rng244') — rangayyan_ch4_complex_cepstrum_closed_form
...
`print(result)` render. See `moirais.fn.describe('rng244')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng244 import *
import numpy as np
# See the function signature in fn/rng244.py for argument names.
```
