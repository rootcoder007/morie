...
`print(result)` render. See `moirais.fn.describe('drlea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drlea import *
import numpy as np
# See the function signature in fn/drlea.py for argument names.
```
