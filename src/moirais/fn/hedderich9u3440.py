...
__all__ = ["hedderich_chapter_9_unnumbered_3440"]


def hedderich_chapter_9_unnumbered_3440(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] πij =P (X∩Y ) = P (X)·P (Y ) = πi+·π+j with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3440')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3440: ContingencyTables expression (auto-extracted; see ref)."
