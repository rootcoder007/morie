# describe('htgcrf') — hetero_causal_forest
...
`print(result)` render. See `moirais.fn.describe('htgcrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htgcrf import *
import numpy as np
# See the function signature in fn/htgcrf.py for argument names.
```
