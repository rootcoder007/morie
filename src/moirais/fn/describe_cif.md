# describe('cif') — cumulative_incidence
...
`print(result)` render. See `moirais.fn.describe('cif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cif import *
import numpy as np
# See the function signature in fn/cif.py for argument names.
```
