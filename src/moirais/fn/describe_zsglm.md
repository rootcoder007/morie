# describe('zsglm') — spatial_glmm_sim
...
`print(result)` render. See `moirais.fn.describe('zsglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsglm import *
import numpy as np
# See the function signature in fn/zsglm.py for argument names.
```
