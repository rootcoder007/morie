# describe('sgthits') — sgt_hits_kleinberg
...
`print(result)` render. See `moirais.fn.describe('sgthits')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgthits import *
import numpy as np
# See the function signature in fn/sgthits.py for argument names.
```
