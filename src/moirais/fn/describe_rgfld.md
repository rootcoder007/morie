# describe('rgfld') — rangayyan_fisher_lda
...
`print(result)` render. See `moirais.fn.describe('rgfld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfld import *
import numpy as np
# See the function signature in fn/rgfld.py for argument names.
```
