# describe('sgtrn') — trans_gaussian_kriging
...
`print(result)` render. See `moirais.fn.describe('sgtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtrn import *
import numpy as np
# See the function signature in fn/sgtrn.py for argument names.
```
