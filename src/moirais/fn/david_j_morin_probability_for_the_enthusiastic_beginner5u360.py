...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_360(x):
    ...
    Formula: m = 0 (no correlation between X and Y ), we have σy = σz . All of the standard
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner5u360')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner5u360: Correlation expression (auto-extracted; see ref)."
