# describe('grxent') — geron_softmax_cross_entropy_cost
...
`print(result)` render. See `moirais.fn.describe('grxent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grxent import *
import numpy as np
# See the function signature in fn/grxent.py for argument names.
```
