# describe('klmcmc') — kl_mcmc_diagnostic
...
`print(result)` render. See `moirais.fn.describe('klmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klmcmc import *
import numpy as np
# See the function signature in fn/klmcmc.py for argument names.
```
