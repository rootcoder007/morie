...
__all__ = ["bivand2013_chapter_7_unnumbered_283"]


def bivand2013_chapter_7_unnumbered_283(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] pT =[ E1/E+,...,E n/E+]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u283')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u283: GeneralStatistics expression (auto-extracted; see ref)."
