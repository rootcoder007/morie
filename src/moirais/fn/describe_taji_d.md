...
`print(result)` render. See `moirais.fn.describe('taji_d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taji_d import *
import numpy as np
# See the function signature in fn/taji_d.py for argument names.
```
