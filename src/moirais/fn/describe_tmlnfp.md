# describe('tmlnfp') — tmle_non_inferiority
...
`print(result)` render. See `moirais.fn.describe('tmlnfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnfp import *
import numpy as np
# See the function signature in fn/tmlnfp.py for argument names.
```
