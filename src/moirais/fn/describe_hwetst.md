# describe('hwetst') — hardy_weinberg
...
`print(result)` render. See `moirais.fn.describe('hwetst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hwetst import *
import numpy as np
# See the function signature in fn/hwetst.py for argument names.
```
