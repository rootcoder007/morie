# describe('whtnse') — white_noise_test
...
`print(result)` render. See `moirais.fn.describe('whtnse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whtnse import *
import numpy as np
# See the function signature in fn/whtnse.py for argument names.
```
