...
__all__ = ["wilcox_chapter_4_unnumbered_153"]


def wilcox_chapter_4_unnumbered_153(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A verage ofs2 values is σ 2 = 0.49, i.e., E(s2) = σ 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u153')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u153: GeneralStatistics expression (auto-extracted; see ref)."
