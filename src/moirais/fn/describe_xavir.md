...
`print(result)` render. See `moirais.fn.describe('xavir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xavir import *
import numpy as np
# See the function signature in fn/xavir.py for argument names.
```
