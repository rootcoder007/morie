...
__all__ = ["hedderich_chapter_9_unnumbered_1508"]


def hedderich_chapter_9_unnumbered_1508(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] f (t)dt = 0.9 or P ( ¯X−k2SX̄≤¯X +k2S) = 0.9 (6.176)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1508')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1508: PowerAndDesign expression (auto-extracted; see ref)."
