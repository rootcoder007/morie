# describe('kanon') — k_anonymity_check
...
`print(result)` render. See `moirais.fn.describe('kanon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kanon import *
import numpy as np
# See the function signature in fn/kanon.py for argument names.
```
