...
`print(result)` render. See `moirais.fn.describe('pltrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pltrb import *
import numpy as np
# See the function signature in fn/pltrb.py for argument names.
```
