...
`print(result)` render. See `moirais.fn.describe('ghbuf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghbuf import *
import numpy as np
# See the function signature in fn/ghbuf.py for argument names.
```
