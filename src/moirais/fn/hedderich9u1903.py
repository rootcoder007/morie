...
__all__ = ["hedderich_chapter_9_unnumbered_1903"]


def hedderich_chapter_9_unnumbered_1903(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] < 1−P (X≤kc|n·λ0)≤α (7.72)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1903')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1903: CountModels expression (auto-extracted; see ref)."
