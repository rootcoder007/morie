...
`print(result)` render. See `moirais.fn.describe('vdchk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdchk import *
import numpy as np
# See the function signature in fn/vdchk.py for argument names.
```
