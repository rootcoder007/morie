...
__all__ = ["wilcox_chapter_13_unnumbered_1299"]


def wilcox_chapter_13_unnumbered_1299(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆδ = ˆ p1+ − ˆp+1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1299')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1299: GeneralStatistics expression (auto-extracted; see ref)."
