# describe('bivcn') — bivariate_causal_test
...
`print(result)` render. See `moirais.fn.describe('bivcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bivcn import *
import numpy as np
# See the function signature in fn/bivcn.py for argument names.
```
