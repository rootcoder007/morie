...
`print(result)` render. See `moirais.fn.describe('casim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.casim import *
import numpy as np
# See the function signature in fn/casim.py for argument names.
```
