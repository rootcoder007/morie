...
`print(result)` render. See `moirais.fn.describe('apre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apre import *
import numpy as np
# See the function signature in fn/apre.py for argument names.
```
