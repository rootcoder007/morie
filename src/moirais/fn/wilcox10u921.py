...
__all__ = ["wilcox_chapter_10_unnumbered_921"]


def wilcox_chapter_10_unnumbered_921(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α 2 = 1 − (1 − α )2/5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u921')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u921: GeneralStatistics expression (auto-extracted; see ref)."
