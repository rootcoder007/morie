...
`print(result)` render. See `moirais.fn.describe('impala')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.impala import *
import numpy as np
# See the function signature in fn/impala.py for argument names.
```
