# describe('aitcsq') — compositional_chisq
...
`print(result)` render. See `moirais.fn.describe('aitcsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitcsq import *
import numpy as np
# See the function signature in fn/aitcsq.py for argument names.
```
