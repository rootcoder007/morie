# describe('agpar') — party_unity_score
...
`print(result)` render. See `moirais.fn.describe('agpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agpar import *
import numpy as np
# See the function signature in fn/agpar.py for argument names.
```
