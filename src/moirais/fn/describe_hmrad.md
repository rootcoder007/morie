# describe('hmrad') — geron_reverse_autodiff
...
`print(result)` render. See `moirais.fn.describe('hmrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrad import *
import numpy as np
# See the function signature in fn/hmrad.py for argument names.
```
