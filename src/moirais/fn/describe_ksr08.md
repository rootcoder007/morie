# describe('ksr08') — kosorok_multiplier_bootstrap
...
`print(result)` render. See `moirais.fn.describe('ksr08')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr08 import *
import numpy as np
# See the function signature in fn/ksr08.py for argument names.
```
