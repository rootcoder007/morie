# describe('rgstvar') — rangayyan_tvlsi
...
`print(result)` render. See `moirais.fn.describe('rgstvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgstvar import *
import numpy as np
# See the function signature in fn/rgstvar.py for argument names.
```
