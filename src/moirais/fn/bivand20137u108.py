...
__all__ = ["bivand2013_chapter_7_unnumbered_108"]


def bivand2013_chapter_7_unnumbered_108(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1(x)= ρλ0(x)f(x−x0;θ),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u108')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u108: GeneralStatistics expression (auto-extracted; see ref)."
