...
`print(result)` render. See `moirais.fn.describe('gpt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpt2 import *
import numpy as np
# See the function signature in fn/gpt2.py for argument names.
```
