...
`print(result)` render. See `moirais.fn.describe('tcrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcrit import *
import numpy as np
# See the function signature in fn/tcrit.py for argument names.
```
