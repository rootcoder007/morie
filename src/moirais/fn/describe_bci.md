# describe('bci') — bayesian_credible_interval
...
`print(result)` render. See `moirais.fn.describe('bci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bci import *
import numpy as np
# See the function signature in fn/bci.py for argument names.
```
