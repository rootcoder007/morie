# describe('hmhplm') — geron_hidden_layers_heuristic
...
`print(result)` render. See `moirais.fn.describe('hmhplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhplm import *
import numpy as np
# See the function signature in fn/hmhplm.py for argument names.
```
