...
`print(result)` render. See `moirais.fn.describe('dkstv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkstv import *
import numpy as np
# See the function signature in fn/dkstv.py for argument names.
```
