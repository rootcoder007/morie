...
`print(result)` render. See `moirais.fn.describe('zsrbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrbf import *
import numpy as np
# See the function signature in fn/zsrbf.py for argument names.
```
