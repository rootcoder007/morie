# describe('rng036') — rangayyan_ch3_discrete_convolution_causal
...
`print(result)` render. See `moirais.fn.describe('rng036')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng036 import *
import numpy as np
# See the function signature in fn/rng036.py for argument names.
```
