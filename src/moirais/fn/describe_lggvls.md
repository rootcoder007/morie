# describe('lggvls') — laggedval_iptw
...
`print(result)` render. See `moirais.fn.describe('lggvls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lggvls import *
import numpy as np
# See the function signature in fn/lggvls.py for argument names.
```
