...
`print(result)` render. See `moirais.fn.describe('irtse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtse import *
import numpy as np
# See the function signature in fn/irtse.py for argument names.
```
