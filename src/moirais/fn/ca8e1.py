...
def ca_chapter_8_equation_1(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8e1')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "CentralTendency expression involving 'sampling' (auto-extracted; see reference for full context)."},
    )
