# describe('baysmplr') — sampler_dispatch
...
`print(result)` render. See `moirais.fn.describe('baysmplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysmplr import *
import numpy as np
# See the function signature in fn/baysmplr.py for argument names.
```
