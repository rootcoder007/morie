...
`print(result)` render. See `moirais.fn.describe('folidr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.folidr import *
import numpy as np
# See the function signature in fn/folidr.py for argument names.
```
