...
`print(result)` render. See `moirais.fn.describe('bcauz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcauz import *
import numpy as np
# See the function signature in fn/bcauz.py for argument names.
```
