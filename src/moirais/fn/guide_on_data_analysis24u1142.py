...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1142"]


def guide_on_data_analysis_chapter_24_unnumbered_1142(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑆𝑆𝐴𝐵 = 𝑆𝑆𝑇𝑅 − 𝑆𝑆𝐴 − 𝑆𝑆𝐵
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1142')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1142: GeneralStatistics expression (auto-extracted; see ref)."
