...
`print(result)` render. See `moirais.fn.describe('chlexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlexp import *
import numpy as np
# See the function signature in fn/chlexp.py for argument names.
```
