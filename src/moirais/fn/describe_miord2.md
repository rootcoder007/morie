...
`print(result)` render. See `moirais.fn.describe('miord2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miord2 import *
import numpy as np
# See the function signature in fn/miord2.py for argument names.
```
