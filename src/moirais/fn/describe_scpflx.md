...
`print(result)` render. See `moirais.fn.describe('scpflx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpflx import *
import numpy as np
# See the function signature in fn/scpflx.py for argument names.
```
