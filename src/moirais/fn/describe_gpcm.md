# describe('gpcm') — generalized_partial_credit
...
`print(result)` render. See `moirais.fn.describe('gpcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpcm import *
import numpy as np
# See the function signature in fn/gpcm.py for argument names.
```
