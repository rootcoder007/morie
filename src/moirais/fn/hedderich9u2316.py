...
__all__ = ["hedderich_chapter_9_unnumbered_2316"]


def hedderich_chapter_9_unnumbered_2316(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (5) =p(5)·1 = 0.62> 0.05. The next lower value is multiplied by 2,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2316')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2316: GeneralStatistics expression (auto-extracted; see ref)."
