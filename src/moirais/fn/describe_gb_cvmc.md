# describe('gb_cvmc') — gibbons_cramer_von_mises
...
`print(result)` render. See `moirais.fn.describe('gb_cvmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_cvmc import *
import numpy as np
# See the function signature in fn/gb_cvmc.py for argument names.
```
