# describe('tqscr') — turboquant_score_distortion
...
`print(result)` render. See `moirais.fn.describe('tqscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqscr import *
import numpy as np
# See the function signature in fn/tqscr.py for argument names.
```
