# describe('tmlnde2') — tmle_nde_interventional
...
`print(result)` render. See `moirais.fn.describe('tmlnde2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnde2 import *
import numpy as np
# See the function signature in fn/tmlnde2.py for argument names.
```
