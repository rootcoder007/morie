...
__all__ = ["hedderich_chapter_9_unnumbered_1407"]


def hedderich_chapter_9_unnumbered_1407(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ayx±tsayx = 7.729±5.695 95% -CI: 2.034≤αyx≤13.424
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1407')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1407: GeneralStatistics expression (auto-extracted; see ref)."
