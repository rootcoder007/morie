# describe('vgemp') — empirical_vario
...
`print(result)` render. See `moirais.fn.describe('vgemp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgemp import *
import numpy as np
# See the function signature in fn/vgemp.py for argument names.
```
