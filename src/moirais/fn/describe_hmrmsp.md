...
`print(result)` render. See `moirais.fn.describe('hmrmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrmsp import *
import numpy as np
# See the function signature in fn/hmrmsp.py for argument names.
```
