...
`print(result)` render. See `moirais.fn.describe('blockMx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blockMx import *
import numpy as np
# See the function signature in fn/blockMx.py for argument names.
```
