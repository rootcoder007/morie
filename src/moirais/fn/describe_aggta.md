...
`print(result)` render. See `moirais.fn.describe('aggta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aggta import *
import numpy as np
# See the function signature in fn/aggta.py for argument names.
```
