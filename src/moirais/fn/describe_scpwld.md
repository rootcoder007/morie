...
`print(result)` render. See `moirais.fn.describe('scpwld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpwld import *
import numpy as np
# See the function signature in fn/scpwld.py for argument names.
```
