...
__all__ = ["wilcox_chapter_14_unnumbered_715"]


def wilcox_chapter_14_unnumbered_715(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: δ 23 =θ 2 − θ 3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u715')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u715: GeneralStatistics expression (auto-extracted; see ref)."
