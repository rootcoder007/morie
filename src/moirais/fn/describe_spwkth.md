# describe('spwkth') — schabenberger_wiener_khinchin
...
`print(result)` render. See `moirais.fn.describe('spwkth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spwkth import *
import numpy as np
# See the function signature in fn/spwkth.py for argument names.
```
