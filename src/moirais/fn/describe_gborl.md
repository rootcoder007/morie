...
`print(result)` render. See `moirais.fn.describe('gborl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gborl import *
import numpy as np
# See the function signature in fn/gborl.py for argument names.
```
