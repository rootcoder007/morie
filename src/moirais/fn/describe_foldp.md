# describe('foldp') — folding_problem
...
`print(result)` render. See `moirais.fn.describe('foldp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foldp import *
import numpy as np
# See the function signature in fn/foldp.py for argument names.
```
