# describe('viras') — virasoro_algebra
...
`print(result)` render. See `moirais.fn.describe('viras')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.viras import *
import numpy as np
# See the function signature in fn/viras.py for argument names.
```
