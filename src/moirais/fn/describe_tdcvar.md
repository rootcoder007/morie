# describe('tdcvar') — time_dep_covariate
...
`print(result)` render. See `moirais.fn.describe('tdcvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdcvar import *
import numpy as np
# See the function signature in fn/tdcvar.py for argument names.
```
