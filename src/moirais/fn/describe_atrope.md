# describe('atrope') — rotary_position_embedding
...
`print(result)` render. See `moirais.fn.describe('atrope')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atrope import *
import numpy as np
# See the function signature in fn/atrope.py for argument names.
```
