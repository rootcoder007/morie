# describe('gb32vr') — gibbons_runs_var
...
`print(result)` render. See `moirais.fn.describe('gb32vr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32vr import *
import numpy as np
# See the function signature in fn/gb32vr.py for argument names.
```
