# describe('spvarm') — spherical_variogram_model
...
`print(result)` render. See `moirais.fn.describe('spvarm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spvarm import *
import numpy as np
# See the function signature in fn/spvarm.py for argument names.
```
