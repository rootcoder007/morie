...
`print(result)` render. See `moirais.fn.describe('medab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medab import *
import numpy as np
# See the function signature in fn/medab.py for argument names.
```
