...
__all__ = ["hedderich_chapter_9_unnumbered_2946"]


def hedderich_chapter_9_unnumbered_2946(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pv2 <− pchisq (B . min , df =1: k , lower . tail = FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2946')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2946: GeneralStatistics expression (auto-extracted; see ref)."
