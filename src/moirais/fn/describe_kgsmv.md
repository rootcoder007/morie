...
`print(result)` render. See `moirais.fn.describe('kgsmv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgsmv import *
import numpy as np
# See the function signature in fn/kgsmv.py for argument names.
```
