# describe('bndmnt') — bound_monotone_test
...
`print(result)` render. See `moirais.fn.describe('bndmnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndmnt import *
import numpy as np
# See the function signature in fn/bndmnt.py for argument names.
```
