# describe('nde') — natural_direct_effect
...
`print(result)` render. See `moirais.fn.describe('nde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nde import *
import numpy as np
# See the function signature in fn/nde.py for argument names.
```
