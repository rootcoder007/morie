...
__all__ = ["wilcox_chapter_7_unnumbered_356"]


def wilcox_chapter_7_unnumbered_356(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (tℓ ≤ T ≤ tu) = 0.95.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u356')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u356: GeneralStatistics expression (auto-extracted; see ref)."
