# describe('sslcl') — semi_supervised
...
`print(result)` render. See `moirais.fn.describe('sslcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sslcl import *
import numpy as np
# See the function signature in fn/sslcl.py for argument names.
```
