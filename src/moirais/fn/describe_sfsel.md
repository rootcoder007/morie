...
`print(result)` render. See `moirais.fn.describe('sfsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfsel import *
import numpy as np
# See the function signature in fn/sfsel.py for argument names.
```
