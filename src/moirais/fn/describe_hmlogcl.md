# describe('hmlogcl') — geron_logistic_cost
...
`print(result)` render. See `moirais.fn.describe('hmlogcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlogcl import *
import numpy as np
# See the function signature in fn/hmlogcl.py for argument names.
```
