# describe('hrzrateG') — horowitz_rate_G_estimation
...
`print(result)` render. See `moirais.fn.describe('hrzrateG')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzrateG import *
import numpy as np
# See the function signature in fn/hrzrateG.py for argument names.
```
