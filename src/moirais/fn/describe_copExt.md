# describe('copExt') — extremal_copula
...
`print(result)` render. See `moirais.fn.describe('copExt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copExt import *
import numpy as np
# See the function signature in fn/copExt.py for argument names.
```
