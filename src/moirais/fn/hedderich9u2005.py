...
__all__ = ["hedderich_chapter_9_unnumbered_2005"]


def hedderich_chapter_9_unnumbered_2005(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > i f (N% %2==0) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2005')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2005: GeneralStatistics expression (auto-extracted; see ref)."
