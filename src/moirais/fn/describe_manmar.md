# describe('manmar') — ma_network_indirect
...
`print(result)` render. See `moirais.fn.describe('manmar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manmar import *
import numpy as np
# See the function signature in fn/manmar.py for argument names.
```
