# describe('negct') — negative_control
...
`print(result)` render. See `moirais.fn.describe('negct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.negct import *
import numpy as np
# See the function signature in fn/negct.py for argument names.
```
