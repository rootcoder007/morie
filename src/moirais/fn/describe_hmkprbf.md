# describe('hmkprbf') — geron_kernel_pca_rbf
...
`print(result)` render. See `moirais.fn.describe('hmkprbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkprbf import *
import numpy as np
# See the function signature in fn/hmkprbf.py for argument names.
```
