...
`print(result)` render. See `moirais.fn.describe('droPDSI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.droPDSI import *
import numpy as np
# See the function signature in fn/droPDSI.py for argument names.
```
