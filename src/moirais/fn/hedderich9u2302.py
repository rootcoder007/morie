...
__all__ = ["hedderich_chapter_9_unnumbered_2302"]


def hedderich_chapter_9_unnumbered_2302(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f(a) Pr(P[1]<=0.05)=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2302')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2302: GeneralStatistics expression (auto-extracted; see ref)."
