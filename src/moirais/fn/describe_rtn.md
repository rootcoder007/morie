...
`print(result)` render. See `moirais.fn.describe('rtn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtn import *
import numpy as np
# See the function signature in fn/rtn.py for argument names.
```
