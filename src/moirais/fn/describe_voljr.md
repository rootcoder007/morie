# describe('voljr') — vol_jump_robust_var
...
`print(result)` render. See `moirais.fn.describe('voljr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voljr import *
import numpy as np
# See the function signature in fn/voljr.py for argument names.
```
