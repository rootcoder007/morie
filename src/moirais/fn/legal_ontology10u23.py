...
__all__ = ["legal_ontology_chapter_10_unnumbered_23"]


def legal_ontology_chapter_10_unnumbered_23(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('legal_ontology10u23')`` for the full guide.
...
def cheatsheet():
    return "legal_ontology10u23: GeneralStatistics expression (auto-extracted; see ref)."
