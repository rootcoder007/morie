...
`print(result)` render. See `moirais.fn.describe('sbkal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbkal import *
import numpy as np
# See the function signature in fn/sbkal.py for argument names.
```
