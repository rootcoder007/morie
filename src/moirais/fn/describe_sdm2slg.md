...
`print(result)` render. See `moirais.fn.describe('sdm2slg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdm2slg import *
import numpy as np
# See the function signature in fn/sdm2slg.py for argument names.
```
