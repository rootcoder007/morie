# describe('zinb') — zero_inflated_negbin
...
`print(result)` render. See `moirais.fn.describe('zinb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zinb import *
import numpy as np
# See the function signature in fn/zinb.py for argument names.
```
