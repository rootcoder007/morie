# describe('sgteig') — sgt_eigenvector_centrality
...
`print(result)` render. See `moirais.fn.describe('sgteig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgteig import *
import numpy as np
# See the function signature in fn/sgteig.py for argument names.
```
