...
`print(result)` render. See `moirais.fn.describe('ekfF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ekfF import *
import numpy as np
# See the function signature in fn/ekfF.py for argument names.
```
