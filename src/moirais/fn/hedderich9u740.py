...
__all__ = ["hedderich_chapter_9_unnumbered_740"]


def hedderich_chapter_9_unnumbered_740(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Above 2nd example:t = (4−10+1/6)2/10 = 3.403
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u740')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u740: GeneralStatistics expression (auto-extracted; see ref)."
