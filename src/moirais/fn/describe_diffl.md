# describe('diffl') — dif_flag_summary
...
`print(result)` render. See `moirais.fn.describe('diffl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffl import *
import numpy as np
# See the function signature in fn/diffl.py for argument names.
```
