...
__all__ = ["hedderich_chapter_9_unnumbered_2324"]


def hedderich_chapter_9_unnumbered_2324(x):
    """
    MetaAnalysis expression (auto-extracted; see ref).

    Formula: [EQ] i=1wizi÷k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2324')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2324: MetaAnalysis expression (auto-extracted; see ref)."
