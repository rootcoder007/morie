# describe('msm131') — mvsml_categorical_count_eq_8_4
...
`print(result)` render. See `moirais.fn.describe('msm131')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm131 import *
import numpy as np
# See the function signature in fn/msm131.py for argument names.
```
