...
`print(result)` render. See `moirais.fn.describe('itent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itent import *
import numpy as np
# See the function signature in fn/itent.py for argument names.
```
