...
`print(result)` render. See `moirais.fn.describe('nmdmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdmp import *
import numpy as np
# See the function signature in fn/nmdmp.py for argument names.
```
