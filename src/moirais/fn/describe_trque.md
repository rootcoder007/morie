...
`print(result)` render. See `moirais.fn.describe('trque')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trque import *
import numpy as np
# See the function signature in fn/trque.py for argument names.
```
