# describe('dfa') — detrended_fluctuation
...
`print(result)` render. See `moirais.fn.describe('dfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfa import *
import numpy as np
# See the function signature in fn/dfa.py for argument names.
```
