...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1271"]


def guide_on_data_analysis_chapter_25_unnumbered_1271(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1271')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1271: GeneralStatistics expression (auto-extracted; see ref)."
