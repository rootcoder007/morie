...
`print(result)` render. See `moirais.fn.describe('ispol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ispol import *
import numpy as np
# See the function signature in fn/ispol.py for argument names.
```
