...
`print(result)` render. See `moirais.fn.describe('pwr_t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwr_t import *
import numpy as np
# See the function signature in fn/pwr_t.py for argument names.
```
