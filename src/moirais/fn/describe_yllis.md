# describe('yllis') — years_of_life_lost
...
`print(result)` render. See `moirais.fn.describe('yllis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yllis import *
import numpy as np
# See the function signature in fn/yllis.py for argument names.
```
