...
`print(result)` render. See `moirais.fn.describe('pacar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacar import *
import numpy as np
# See the function signature in fn/pacar.py for argument names.
```
