...
__all__ = ["wilcox_chapter_4_unnumbered_207"]


def wilcox_chapter_4_unnumbered_207(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µ. Because there are 22 rats ( n = 22), the degrees of freedom are n − 1 = 22 − 1 = 21.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u207')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u207: GeneralStatistics expression (auto-extracted; see ref)."
