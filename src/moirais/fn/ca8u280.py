...
__all__ = ["ca_chapter_8_unnumbered_280"]


def ca_chapter_8_unnumbered_280(x):
    """
    CentralTendency expression involving 'ffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffi' (auto-extracted; see reference for full context).

    Formula: each of the group means with n1 = n2 = ... = nk.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8u280')`` for the full guide.
...
def cheatsheet():
    return "ca8u280: CentralTendency expression involving 'ffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffiffi' (auto-extracted; see reference for full context)."
