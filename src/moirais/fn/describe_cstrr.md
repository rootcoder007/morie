...
`print(result)` render. See `moirais.fn.describe('cstrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstrr import *
import numpy as np
# See the function signature in fn/cstrr.py for argument names.
```
