...
`print(result)` render. See `moirais.fn.describe('dfbts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfbts import *
import numpy as np
# See the function signature in fn/dfbts.py for argument names.
```
