# describe('rgbiorth') — rangayyan_biorthogonal_wvlt
...
`print(result)` render. See `moirais.fn.describe('rgbiorth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbiorth import *
import numpy as np
# See the function signature in fn/rgbiorth.py for argument names.
```
