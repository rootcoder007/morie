# describe('sgprn') — practical_range
...
`print(result)` render. See `moirais.fn.describe('sgprn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgprn import *
import numpy as np
# See the function signature in fn/sgprn.py for argument names.
```
