...
__all__ = ["bivand2013_chapter_2_unnumbered_12"]


def bivand2013_chapter_2_unnumbered_12(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > axis(2, at = c(326000 + 0.3 * 4000), cex.axis = 0.7)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u12')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u12: GeneralStatistics expression (auto-extracted; see ref)."
