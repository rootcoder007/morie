# describe('pdthr') — peak_detect_threshold
...
`print(result)` render. See `moirais.fn.describe('pdthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdthr import *
import numpy as np
# See the function signature in fn/pdthr.py for argument names.
```
