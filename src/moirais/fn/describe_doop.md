...
`print(result)` render. See `moirais.fn.describe('doop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.doop import *
import numpy as np
# See the function signature in fn/doop.py for argument names.
```
