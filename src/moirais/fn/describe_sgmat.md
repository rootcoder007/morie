# describe('sgmat') — matern_variogram
...
`print(result)` render. See `moirais.fn.describe('sgmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmat import *
import numpy as np
# See the function signature in fn/sgmat.py for argument names.
```
