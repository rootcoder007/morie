# describe('seiarp') — seira_asymptomatic
...
`print(result)` render. See `moirais.fn.describe('seiarp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seiarp import *
import numpy as np
# See the function signature in fn/seiarp.py for argument names.
```
