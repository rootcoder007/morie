...
`print(result)` render. See `moirais.fn.describe('eslfdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslfdr import *
import numpy as np
# See the function signature in fn/eslfdr.py for argument names.
```
