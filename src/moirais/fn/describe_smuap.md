# describe('smuap') — smuap_point_process_fn
...
`print(result)` render. See `moirais.fn.describe('smuap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smuap import *
import numpy as np
# See the function signature in fn/smuap.py for argument names.
```
