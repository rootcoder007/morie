...
`print(result)` render. See `moirais.fn.describe('percs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.percs import *
import numpy as np
# See the function signature in fn/percs.py for argument names.
```
