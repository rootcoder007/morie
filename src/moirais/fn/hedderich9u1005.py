...
__all__ = ["hedderich_chapter_9_unnumbered_1005"]


def hedderich_chapter_9_unnumbered_1005(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The linear interpolation for the values x1 = 5 andx2 = 6 between the points (xa,y a) = (2 , 2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1005')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1005: GeneralStatistics expression (auto-extracted; see ref)."
