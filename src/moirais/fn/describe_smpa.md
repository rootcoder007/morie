# describe('smpa') — smooth_sensitivity
...
`print(result)` render. See `moirais.fn.describe('smpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpa import *
import numpy as np
# See the function signature in fn/smpa.py for argument names.
```
