...
`print(result)` render. See `moirais.fn.describe('mcconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcconv import *
import numpy as np
# See the function signature in fn/mcconv.py for argument names.
```
