...
`print(result)` render. See `moirais.fn.describe('oracl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oracl import *
import numpy as np
# See the function signature in fn/oracl.py for argument names.
```
