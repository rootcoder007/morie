# describe('coiwv') — coiflet_wavelet
...
`print(result)` render. See `moirais.fn.describe('coiwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coiwv import *
import numpy as np
# See the function signature in fn/coiwv.py for argument names.
```
