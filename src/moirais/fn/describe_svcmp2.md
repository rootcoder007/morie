...
`print(result)` render. See `moirais.fn.describe('svcmp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcmp2 import *
import numpy as np
# See the function signature in fn/svcmp2.py for argument names.
```
