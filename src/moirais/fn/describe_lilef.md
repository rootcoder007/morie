...
`print(result)` render. See `moirais.fn.describe('lilef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lilef import *
import numpy as np
# See the function signature in fn/lilef.py for argument names.
```
