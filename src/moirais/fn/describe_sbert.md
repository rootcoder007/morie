...
`print(result)` render. See `moirais.fn.describe('sbert')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbert import *
import numpy as np
# See the function signature in fn/sbert.py for argument names.
```
