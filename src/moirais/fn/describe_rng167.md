# describe('rng167') — rangayyan_ch3_rls_phi_recursion
...
`print(result)` render. See `moirais.fn.describe('rng167')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng167 import *
import numpy as np
# See the function signature in fn/rng167.py for argument names.
```
