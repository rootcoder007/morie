# describe('wsmvit') — wasserman_viterbi
...
`print(result)` render. See `moirais.fn.describe('wsmvit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmvit import *
import numpy as np
# See the function signature in fn/wsmvit.py for argument names.
```
