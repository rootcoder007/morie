...
`print(result)` render. See `moirais.fn.describe('wznrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wznrr import *
import numpy as np
# See the function signature in fn/wznrr.py for argument names.
```
