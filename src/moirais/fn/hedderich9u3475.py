...
__all__ = ["hedderich_chapter_9_unnumbered_3475"]


def hedderich_chapter_9_unnumbered_3475(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺2, t3 = 3, t4 = 4; T = 4) on 4 cases in 2 groups, i.e., on a total of 8 cases (N = 8). The results
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3475')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3475: GeneralStatistics expression (auto-extracted; see ref)."
