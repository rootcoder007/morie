...
`print(result)` render. See `moirais.fn.describe('cdsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdsim import *
import numpy as np
# See the function signature in fn/cdsim.py for argument names.
```
