# describe('gradmo') — geron_adam_update
...
`print(result)` render. See `moirais.fn.describe('gradmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gradmo import *
import numpy as np
# See the function signature in fn/gradmo.py for argument names.
```
