...
`print(result)` render. See `moirais.fn.describe('sbprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbprt import *
import numpy as np
# See the function signature in fn/sbprt.py for argument names.
```
