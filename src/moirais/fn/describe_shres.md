# describe('shres') — schoenfeld_residual
...
`print(result)` render. See `moirais.fn.describe('shres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shres import *
import numpy as np
# See the function signature in fn/shres.py for argument names.
```
