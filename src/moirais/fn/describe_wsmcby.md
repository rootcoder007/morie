# describe('wsmcby') — wasserman_chebyshev_ineq
...
`print(result)` render. See `moirais.fn.describe('wsmcby')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcby import *
import numpy as np
# See the function signature in fn/wsmcby.py for argument names.
```
