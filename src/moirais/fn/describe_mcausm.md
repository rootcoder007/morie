# describe('mcausm') — multi_mediator_causal
...
`print(result)` render. See `moirais.fn.describe('mcausm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcausm import *
import numpy as np
# See the function signature in fn/mcausm.py for argument names.
```
