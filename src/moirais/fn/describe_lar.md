# describe('lar') — log_area_ratio_fn
...
`print(result)` render. See `moirais.fn.describe('lar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lar import *
import numpy as np
# See the function signature in fn/lar.py for argument names.
```
