# describe('mapth') — map_theta_estimator
...
`print(result)` render. See `moirais.fn.describe('mapth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapth import *
import numpy as np
# See the function signature in fn/mapth.py for argument names.
```
