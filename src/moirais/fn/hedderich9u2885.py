...
__all__ = ["hedderich_chapter_9_unnumbered_2885"]


def hedderich_chapter_9_unnumbered_2885(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For the samples 1 and 5 from the example withn1 =n5 = 30,p1 =r1/n1 = 18/30 = 0.60 and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2885')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2885: GeneralStatistics expression (auto-extracted; see ref)."
