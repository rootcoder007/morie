# describe('hw') — hardy_weinberg_test
...
`print(result)` render. See `moirais.fn.describe('hw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hw import *
import numpy as np
# See the function signature in fn/hw.py for argument names.
```
