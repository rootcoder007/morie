...
`print(result)` render. See `moirais.fn.describe('ptqdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptqdr import *
import numpy as np
# See the function signature in fn/ptqdr.py for argument names.
```
