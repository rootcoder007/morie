...
`print(result)` render. See `moirais.fn.describe('fpesc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fpesc import *
import numpy as np
# See the function signature in fn/fpesc.py for argument names.
```
