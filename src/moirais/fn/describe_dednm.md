...
`print(result)` render. See `moirais.fn.describe('dednm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dednm import *
import numpy as np
# See the function signature in fn/dednm.py for argument names.
```
