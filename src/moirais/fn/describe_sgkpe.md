# describe('sgkpe') — kriging_prediction_error
...
`print(result)` render. See `moirais.fn.describe('sgkpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgkpe import *
import numpy as np
# See the function signature in fn/sgkpe.py for argument names.
```
