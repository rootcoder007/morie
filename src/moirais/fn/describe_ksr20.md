# describe('ksr20') — kosorok_censoring_survival
...
`print(result)` render. See `moirais.fn.describe('ksr20')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr20 import *
import numpy as np
# See the function signature in fn/ksr20.py for argument names.
```
