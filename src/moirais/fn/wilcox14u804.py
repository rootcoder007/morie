...
__all__ = ["wilcox_chapter_14_unnumbered_804"]


def wilcox_chapter_14_unnumbered_804(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t2way(J,K,x,tr=0.2,grp=c(1:p),p=J*K,MAT=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u804')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u804: GeneralStatistics expression (auto-extracted; see ref)."
