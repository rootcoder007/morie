# describe('rgpzmod') — rangayyan_pole_zero_model
...
`print(result)` render. See `moirais.fn.describe('rgpzmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpzmod import *
import numpy as np
# See the function signature in fn/rgpzmod.py for argument names.
```
