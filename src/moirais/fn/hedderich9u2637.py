...
__all__ = ["hedderich_chapter_9_unnumbered_2637"]


def hedderich_chapter_9_unnumbered_2637(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = n(|ad−bc|−n/2)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2637')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2637: GeneralStatistics expression (auto-extracted; see ref)."
