...
`print(result)` render. See `moirais.fn.describe('adida')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adida import *
import numpy as np
# See the function signature in fn/adida.py for argument names.
```
