...
__all__ = ["wilcox_chapter_10_unnumbered_911"]


def wilcox_chapter_10_unnumbered_911(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] H0 :µ 1 =µ 2 =µ 3 =µ 4 =µ 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u911')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u911: PowerAndDesign expression (auto-extracted; see ref)."
