...
`print(result)` render. See `moirais.fn.describe('gibsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gibsp import *
import numpy as np
# See the function signature in fn/gibsp.py for argument names.
```
