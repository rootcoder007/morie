...
__all__ = ["hedderich_chapter_9_unnumbered_1388"]


def hedderich_chapter_9_unnumbered_1388(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > cv _ k i ( x , conf . level = 0 . 9 5 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1388')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1388: GeneralStatistics expression (auto-extracted; see ref)."
