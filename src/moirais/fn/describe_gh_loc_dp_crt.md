# describe('gh_loc_dp_crt') — ghosal_local_dp_rate
...
`print(result)` render. See `moirais.fn.describe('gh_loc_dp_crt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_loc_dp_crt import *
import numpy as np
# See the function signature in fn/gh_loc_dp_crt.py for argument names.
```
