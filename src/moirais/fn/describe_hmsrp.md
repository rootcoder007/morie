# describe('hmsrp') — geron_sparse_rand_projection
...
`print(result)` render. See `moirais.fn.describe('hmsrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsrp import *
import numpy as np
# See the function signature in fn/hmsrp.py for argument names.
```
