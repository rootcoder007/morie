...
`print(result)` render. See `moirais.fn.describe('thetml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thetml import *
import numpy as np
# See the function signature in fn/thetml.py for argument names.
```
