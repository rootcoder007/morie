# describe('pproc') — point_process_intensity
...
`print(result)` render. See `moirais.fn.describe('pproc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pproc import *
import numpy as np
# See the function signature in fn/pproc.py for argument names.
```
