# describe('aitip') — aitchison_inner_product
...
`print(result)` render. See `moirais.fn.describe('aitip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitip import *
import numpy as np
# See the function signature in fn/aitip.py for argument names.
```
