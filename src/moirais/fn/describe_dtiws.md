...
`print(result)` render. See `moirais.fn.describe('dtiws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtiws import *
import numpy as np
# See the function signature in fn/dtiws.py for argument names.
```
