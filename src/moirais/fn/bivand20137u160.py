...
__all__ = ["bivand2013_chapter_7_unnumbered_160"]


def bivand2013_chapter_7_unnumbered_160(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Error in predict.gstat(g, newdata=newdata, block=block, nsim=nsim:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u160')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u160: GeneralStatistics expression (auto-extracted; see ref)."
