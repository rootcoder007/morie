# describe('ocsvm') — oc_svm_classify
...
`print(result)` render. See `moirais.fn.describe('ocsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocsvm import *
import numpy as np
# See the function signature in fn/ocsvm.py for argument names.
```
