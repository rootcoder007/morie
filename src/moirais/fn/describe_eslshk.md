...
`print(result)` render. See `moirais.fn.describe('eslshk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslshk import *
import numpy as np
# See the function signature in fn/eslshk.py for argument names.
```
