# describe('eslnnt') — esl_neural_net
...
`print(result)` render. See `moirais.fn.describe('eslnnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnnt import *
import numpy as np
# See the function signature in fn/eslnnt.py for argument names.
```
