# describe('binmed') — binary_outcome_mediation
...
`print(result)` render. See `moirais.fn.describe('binmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.binmed import *
import numpy as np
# See the function signature in fn/binmed.py for argument names.
```
