...
`print(result)` render. See `moirais.fn.describe('sactv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sactv import *
import numpy as np
# See the function signature in fn/sactv.py for argument names.
```
