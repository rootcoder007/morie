# describe('km036') — kamath_ch2_gpt_supervised_obj
...
`print(result)` render. See `moirais.fn.describe('km036')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km036 import *
import numpy as np
# See the function signature in fn/km036.py for argument names.
```
