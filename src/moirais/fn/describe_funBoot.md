# describe('funBoot') — functional_bootstrap
...
`print(result)` render. See `moirais.fn.describe('funBoot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funBoot import *
import numpy as np
# See the function signature in fn/funBoot.py for argument names.
```
