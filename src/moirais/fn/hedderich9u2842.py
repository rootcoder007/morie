...
__all__ = ["hedderich_chapter_9_unnumbered_2842"]


def hedderich_chapter_9_unnumbered_2842(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Mantel − Haenszel X− squared = 8 3 . 2 1 5 , df = 1 , p− value < 2 . 2 e −16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2842')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2842: GeneralStatistics expression (auto-extracted; see ref)."
