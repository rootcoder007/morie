...
`print(result)` render. See `moirais.fn.describe('semhet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semhet import *
import numpy as np
# See the function signature in fn/semhet.py for argument names.
```
