...
`print(result)` render. See `moirais.fn.describe('enhil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enhil import *
import numpy as np
# See the function signature in fn/enhil.py for argument names.
```
