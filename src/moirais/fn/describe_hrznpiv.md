# describe('hrznpiv') — horowitz_npiv_model
...
`print(result)` render. See `moirais.fn.describe('hrznpiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznpiv import *
import numpy as np
# See the function signature in fn/hrznpiv.py for argument names.
```
