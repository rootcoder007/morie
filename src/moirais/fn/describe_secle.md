...
`print(result)` render. See `moirais.fn.describe('secle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secle import *
import numpy as np
# See the function signature in fn/secle.py for argument names.
```
