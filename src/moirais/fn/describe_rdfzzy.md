...
`print(result)` render. See `moirais.fn.describe('rdfzzy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdfzzy import *
import numpy as np
# See the function signature in fn/rdfzzy.py for argument names.
```
