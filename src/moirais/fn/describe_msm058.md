# describe('msm058') — mvsml_bayesian_regression_eq_6_1
...
`print(result)` render. See `moirais.fn.describe('msm058')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm058 import *
import numpy as np
# See the function signature in fn/msm058.py for argument names.
```
