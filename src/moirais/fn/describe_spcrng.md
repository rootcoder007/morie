...
`print(result)` render. See `moirais.fn.describe('spcrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcrng import *
import numpy as np
# See the function signature in fn/spcrng.py for argument names.
```
