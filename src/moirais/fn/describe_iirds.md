...
`print(result)` render. See `moirais.fn.describe('iirds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iirds import *
import numpy as np
# See the function signature in fn/iirds.py for argument names.
```
