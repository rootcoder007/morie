...
`print(result)` render. See `moirais.fn.describe('afsle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afsle import *
import numpy as np
# See the function signature in fn/afsle.py for argument names.
```
