...
`print(result)` render. See `moirais.fn.describe('rfpois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfpois import *
import numpy as np
# See the function signature in fn/rfpois.py for argument names.
```
