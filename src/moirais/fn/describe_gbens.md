# describe('gbens') — gradient_boosting_ensemble
...
`print(result)` render. See `moirais.fn.describe('gbens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbens import *
import numpy as np
# See the function signature in fn/gbens.py for argument names.
```
