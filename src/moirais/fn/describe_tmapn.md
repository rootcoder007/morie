# describe('tmapn') — torus_mapping_class
...
`print(result)` render. See `moirais.fn.describe('tmapn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmapn import *
import numpy as np
# See the function signature in fn/tmapn.py for argument names.
```
