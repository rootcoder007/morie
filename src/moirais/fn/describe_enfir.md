...
`print(result)` render. See `moirais.fn.describe('enfir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enfir import *
import numpy as np
# See the function signature in fn/enfir.py for argument names.
```
