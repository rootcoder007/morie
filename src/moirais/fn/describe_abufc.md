...
`print(result)` render. See `moirais.fn.describe('abufc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abufc import *
import numpy as np
# See the function signature in fn/abufc.py for argument names.
```
