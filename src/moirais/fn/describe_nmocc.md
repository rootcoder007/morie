...
`print(result)` render. See `moirais.fn.describe('nmocc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmocc import *
import numpy as np
# See the function signature in fn/nmocc.py for argument names.
```
