# describe('btiid') — boot_iid_resample
...
`print(result)` render. See `moirais.fn.describe('btiid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btiid import *
import numpy as np
# See the function signature in fn/btiid.py for argument names.
```
