...
`print(result)` render. See `moirais.fn.describe('taulep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taulep import *
import numpy as np
# See the function signature in fn/taulep.py for argument names.
```
