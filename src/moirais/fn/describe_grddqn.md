# describe('grddqn') — geron_double_dqn_target
...
`print(result)` render. See `moirais.fn.describe('grddqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grddqn import *
import numpy as np
# See the function signature in fn/grddqn.py for argument names.
```
