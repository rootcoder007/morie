# describe('propme') — proportion_mediated
...
`print(result)` render. See `moirais.fn.describe('propme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propme import *
import numpy as np
# See the function signature in fn/propme.py for argument names.
```
