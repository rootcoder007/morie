# describe('arrow') — directed_layout
...
`print(result)` render. See `moirais.fn.describe('arrow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arrow import *
import numpy as np
# See the function signature in fn/arrow.py for argument names.
```
