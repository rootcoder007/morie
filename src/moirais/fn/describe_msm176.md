# describe('msm176') — mvsml_ridge_lasso_elastic_eq_9_4
...
`print(result)` render. See `moirais.fn.describe('msm176')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm176 import *
import numpy as np
# See the function signature in fn/msm176.py for argument names.
```
