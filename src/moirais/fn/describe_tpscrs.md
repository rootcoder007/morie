# describe('tpscrs') — tps_crime_severity
...
`print(result)` render. See `moirais.fn.describe('tpscrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpscrs import *
import numpy as np
# See the function signature in fn/tpscrs.py for argument names.
```
