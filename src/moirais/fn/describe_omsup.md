...
`print(result)` render. See `moirais.fn.describe('omsup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omsup import *
import numpy as np
# See the function signature in fn/omsup.py for argument names.
```
