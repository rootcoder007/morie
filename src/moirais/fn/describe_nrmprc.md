# describe('nrmprc') — normalized_inverse_gauss
...
`print(result)` render. See `moirais.fn.describe('nrmprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrmprc import *
import numpy as np
# See the function signature in fn/nrmprc.py for argument names.
```
