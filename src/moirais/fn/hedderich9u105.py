...
__all__ = ["hedderich_chapter_9_unnumbered_105"]


def hedderich_chapter_9_unnumbered_105(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u105')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u105: GeneralStatistics expression (auto-extracted; see ref)."
