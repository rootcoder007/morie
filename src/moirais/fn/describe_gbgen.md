# describe('gbgen') — gradient_boosting_genomic
...
`print(result)` render. See `moirais.fn.describe('gbgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbgen import *
import numpy as np
# See the function signature in fn/gbgen.py for argument names.
```
