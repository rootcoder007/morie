# describe('hrzsicd') — horowitz_sim_id_discrete_x
...
`print(result)` render. See `moirais.fn.describe('hrzsicd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsicd import *
import numpy as np
# See the function signature in fn/hrzsicd.py for argument names.
```
