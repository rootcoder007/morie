...
`print(result)` render. See `moirais.fn.describe('dsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dsep import *
import numpy as np
# See the function signature in fn/dsep.py for argument names.
```
