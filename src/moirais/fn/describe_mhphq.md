...
`print(result)` render. See `moirais.fn.describe('mhphq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhphq import *
import numpy as np
# See the function signature in fn/mhphq.py for argument names.
```
