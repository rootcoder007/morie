...
`print(result)` render. See `moirais.fn.describe('mapst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapst import *
import numpy as np
# See the function signature in fn/mapst.py for argument names.
```
