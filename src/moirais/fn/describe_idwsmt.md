# describe('idwsmt') — inverse_distance_weighting
...
`print(result)` render. See `moirais.fn.describe('idwsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwsmt import *
import numpy as np
# See the function signature in fn/idwsmt.py for argument names.
```
