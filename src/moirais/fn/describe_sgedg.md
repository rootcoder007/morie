# describe('sgedg') — edge_correction
...
`print(result)` render. See `moirais.fn.describe('sgedg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgedg import *
import numpy as np
# See the function signature in fn/sgedg.py for argument names.
```
