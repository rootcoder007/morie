...
`print(result)` render. See `moirais.fn.describe('dpoF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpoF import *
import numpy as np
# See the function signature in fn/dpoF.py for argument names.
```
