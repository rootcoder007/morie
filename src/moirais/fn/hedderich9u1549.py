...
__all__ = ["hedderich_chapter_9_unnumbered_1549"]


def hedderich_chapter_9_unnumbered_1549(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: x! exp (−λ) Gamma(k0, λ0) k∗= k0 + x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1549')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1549: CountModels expression (auto-extracted; see ref)."
