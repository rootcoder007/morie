...
`print(result)` render. See `moirais.fn.describe('grrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrec import *
import numpy as np
# See the function signature in fn/grrec.py for argument names.
```
