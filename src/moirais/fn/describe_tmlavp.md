# describe('tmlavp') — tmle_average_predictiveness
...
`print(result)` render. See `moirais.fn.describe('tmlavp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlavp import *
import numpy as np
# See the function signature in fn/tmlavp.py for argument names.
```
