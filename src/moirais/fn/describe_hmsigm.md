...
`print(result)` render. See `moirais.fn.describe('hmsigm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsigm import *
import numpy as np
# See the function signature in fn/hmsigm.py for argument names.
```
