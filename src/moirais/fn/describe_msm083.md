# describe('msm083') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm083')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm083 import *
import numpy as np
# See the function signature in fn/msm083.py for argument names.
```
