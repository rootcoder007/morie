...
`print(result)` render. See `moirais.fn.describe('svmrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmrb import *
import numpy as np
# See the function signature in fn/svmrb.py for argument names.
```
