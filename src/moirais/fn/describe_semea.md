# describe('semea') — sem_measurement
...
`print(result)` render. See `moirais.fn.describe('semea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semea import *
import numpy as np
# See the function signature in fn/semea.py for argument names.
```
