...
`print(result)` render. See `moirais.fn.describe('tbnbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbnbnd import *
import numpy as np
# See the function signature in fn/tbnbnd.py for argument names.
```
