...
__all__ = ["hedderich_chapter_9_unnumbered_2783"]


def hedderich_chapter_9_unnumbered_2783(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (16−5−1)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2783')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2783: GeneralStatistics expression (auto-extracted; see ref)."
