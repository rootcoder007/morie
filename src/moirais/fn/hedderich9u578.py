...
__all__ = ["hedderich_chapter_9_unnumbered_578"]


def hedderich_chapter_9_unnumbered_578(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (|X−µ|<kσ)≥1−4/(9k2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u578')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u578: GeneralStatistics expression (auto-extracted; see ref)."
