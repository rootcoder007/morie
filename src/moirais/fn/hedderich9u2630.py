...
__all__ = ["hedderich_chapter_9_unnumbered_2630"]


def hedderich_chapter_9_unnumbered_2630(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (n−1)(a−c)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2630')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2630: PowerAndDesign expression (auto-extracted; see ref)."
