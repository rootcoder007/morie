# describe('gb321c') — gibbons_marginal_r1
...
`print(result)` render. See `moirais.fn.describe('gb321c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb321c import *
import numpy as np
# See the function signature in fn/gb321c.py for argument names.
```
