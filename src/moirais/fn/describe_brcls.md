...
`print(result)` render. See `moirais.fn.describe('brcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brcls import *
import numpy as np
# See the function signature in fn/brcls.py for argument names.
```
