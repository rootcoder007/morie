...
`print(result)` render. See `moirais.fn.describe('weighs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weighs import *
import numpy as np
# See the function signature in fn/weighs.py for argument names.
```
