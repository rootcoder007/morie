...
`print(result)` render. See `moirais.fn.describe('naoIdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.naoIdx import *
import numpy as np
# See the function signature in fn/naoIdx.py for argument names.
```
