...
`print(result)` render. See `moirais.fn.describe('semml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semml import *
import numpy as np
# See the function signature in fn/semml.py for argument names.
```
