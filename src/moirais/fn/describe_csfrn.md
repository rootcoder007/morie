...
`print(result)` render. See `moirais.fn.describe('csfrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csfrn import *
import numpy as np
# See the function signature in fn/csfrn.py for argument names.
```
