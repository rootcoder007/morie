# describe('zxtnd') — tensor_decomp_sp
...
`print(result)` render. See `moirais.fn.describe('zxtnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxtnd import *
import numpy as np
# See the function signature in fn/zxtnd.py for argument names.
```
