# describe('rng240') — rangayyan_ch4_complex_log_x_z
...
`print(result)` render. See `moirais.fn.describe('rng240')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng240 import *
import numpy as np
# See the function signature in fn/rng240.py for argument names.
```
