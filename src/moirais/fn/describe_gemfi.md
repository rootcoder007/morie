...
`print(result)` render. See `moirais.fn.describe('gemfi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gemfi import *
import numpy as np
# See the function signature in fn/gemfi.py for argument names.
```
