...
`print(result)` render. See `moirais.fn.describe('fzecdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzecdf import *
import numpy as np
# See the function signature in fn/fzecdf.py for argument names.
```
