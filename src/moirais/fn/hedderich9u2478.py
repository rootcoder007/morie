...
__all__ = ["hedderich_chapter_9_unnumbered_2478"]


def hedderich_chapter_9_unnumbered_2478(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Without subgrouping (k = 3,n = 8) one would get ˆH = 3.33< 5.99.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2478')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2478: GeneralStatistics expression (auto-extracted; see ref)."
