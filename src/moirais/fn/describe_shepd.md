# describe('shepd') — shepard_diagram
...
`print(result)` render. See `moirais.fn.describe('shepd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shepd import *
import numpy as np
# See the function signature in fn/shepd.py for argument names.
```
