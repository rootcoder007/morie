...
`print(result)` render. See `moirais.fn.describe('gnblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnblk import *
import numpy as np
# See the function signature in fn/gnblk.py for argument names.
```
