# describe('mdppol') — mdp_policy_iteration
...
`print(result)` render. See `moirais.fn.describe('mdppol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdppol import *
import numpy as np
# See the function signature in fn/mdppol.py for argument names.
```
