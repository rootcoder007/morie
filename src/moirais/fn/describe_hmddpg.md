...
`print(result)` render. See `moirais.fn.describe('hmddpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmddpg import *
import numpy as np
# See the function signature in fn/hmddpg.py for argument names.
```
