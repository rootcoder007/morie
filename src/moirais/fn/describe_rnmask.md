...
`print(result)` render. See `moirais.fn.describe('rnmask')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnmask import *
import numpy as np
# See the function signature in fn/rnmask.py for argument names.
```
