...
`print(result)` render. See `moirais.fn.describe('runsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.runsq import *
import numpy as np
# See the function signature in fn/runsq.py for argument names.
```
