...
`print(result)` render. See `moirais.fn.describe('wqcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqcd import *
import numpy as np
# See the function signature in fn/wqcd.py for argument names.
```
