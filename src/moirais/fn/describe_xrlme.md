...
`print(result)` render. See `moirais.fn.describe('xrlme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlme import *
import numpy as np
# See the function signature in fn/xrlme.py for argument names.
```
