# describe('scren') — screening_performance
...
`print(result)` render. See `moirais.fn.describe('scren')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scren import *
import numpy as np
# See the function signature in fn/scren.py for argument names.
```
