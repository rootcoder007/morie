# describe('agstkb') — alphazero_stockfish_baseline
...
`print(result)` render. See `moirais.fn.describe('agstkb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agstkb import *
import numpy as np
# See the function signature in fn/agstkb.py for argument names.
```
