...
`print(result)` render. See `moirais.fn.describe('cvtml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvtml import *
import numpy as np
# See the function signature in fn/cvtml.py for argument names.
```
