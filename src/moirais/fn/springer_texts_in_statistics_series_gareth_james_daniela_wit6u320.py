...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_320"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_320(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > x[y==0,2]= x[y==0 ,2]+2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u320')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u320: GeneralStatistics expression (auto-extracted; see ref)."
