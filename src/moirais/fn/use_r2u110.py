...
__all__ = ["use_r_chapter_2_unnumbered_110"]


def use_r_chapter_2_unnumbered_110(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the value of KI,λ(s) for an IPP with intensity λ(s)i s πs2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u110')`` for the full guide.
...
def cheatsheet():
    return "use_r2u110: GeneralStatistics expression (auto-extracted; see ref)."
