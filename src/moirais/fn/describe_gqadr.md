# describe('gqadr') — gauss_quadrature
...
`print(result)` render. See `moirais.fn.describe('gqadr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gqadr import *
import numpy as np
# See the function signature in fn/gqadr.py for argument names.
```
