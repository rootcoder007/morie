# describe('hrzycp') — horowitz_conditional_prediction
...
`print(result)` render. See `moirais.fn.describe('hrzycp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzycp import *
import numpy as np
# See the function signature in fn/hrzycp.py for argument names.
```
