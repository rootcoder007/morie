# describe('rgsclgr') — rangayyan_scalogram
...
`print(result)` render. See `moirais.fn.describe('rgsclgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsclgr import *
import numpy as np
# See the function signature in fn/rgsclgr.py for argument names.
```
