...
`print(result)` render. See `moirais.fn.describe('clsil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clsil import *
import numpy as np
# See the function signature in fn/clsil.py for argument names.
```
