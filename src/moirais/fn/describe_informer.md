# describe('informer') — informer_long_horizon
...
`print(result)` render. See `moirais.fn.describe('informer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.informer import *
import numpy as np
# See the function signature in fn/informer.py for argument names.
```
