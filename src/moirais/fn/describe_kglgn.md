# describe('kglgn') — lognormal_kriging
...
`print(result)` render. See `moirais.fn.describe('kglgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kglgn import *
import numpy as np
# See the function signature in fn/kglgn.py for argument names.
```
