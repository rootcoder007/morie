# describe('idwopt') — idwopt

## WHAT IT DOES

Optimal IDW power via LOOCV.
...
`print(result)` render. See `moirais.fn.describe('idwopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwopt import *
import numpy as np
# See the function signature in fn/idwopt.py for argument names.
```
