...
`print(result)` render. See `moirais.fn.describe('gbdpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbdpr import *
import numpy as np
# See the function signature in fn/gbdpr.py for argument names.
```
