...
__all__ = ["hedderich_chapter_9_unnumbered_3441"]


def hedderich_chapter_9_unnumbered_3441(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3441')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3441: ContingencyTables expression (auto-extracted; see ref)."
