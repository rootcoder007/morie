...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1400"]


def guide_on_data_analysis_chapter_28_unnumbered_1400(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑡 = 𝛽0 + 𝛽1𝑇𝑡 + 𝛽2𝐷𝑡 + 𝛽3(𝑇𝑡 × 𝐷𝑡) + 𝛽4𝑃𝑡 + 𝜖𝑡,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1400')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1400: GeneralStatistics expression (auto-extracted; see ref)."
