# describe('hmrgpt') — geron_regression_mlp_pytorch
...
`print(result)` render. See `moirais.fn.describe('hmrgpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrgpt import *
import numpy as np
# See the function signature in fn/hmrgpt.py for argument names.
```
