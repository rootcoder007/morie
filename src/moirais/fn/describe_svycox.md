...
`print(result)` render. See `moirais.fn.describe('svycox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svycox import *
import numpy as np
# See the function signature in fn/svycox.py for argument names.
```
