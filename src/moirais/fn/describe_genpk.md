# describe('genpk') — gen_parity_check
...
`print(result)` render. See `moirais.fn.describe('genpk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genpk import *
import numpy as np
# See the function signature in fn/genpk.py for argument names.
```
