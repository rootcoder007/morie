# describe('vdcal') — volume_of_distribution
...
`print(result)` render. See `moirais.fn.describe('vdcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdcal import *
import numpy as np
# See the function signature in fn/vdcal.py for argument names.
```
