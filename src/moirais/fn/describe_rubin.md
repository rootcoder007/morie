...
`print(result)` render. See `moirais.fn.describe('rubin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rubin import *
import numpy as np
# See the function signature in fn/rubin.py for argument names.
```
