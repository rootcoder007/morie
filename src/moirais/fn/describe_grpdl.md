...
`print(result)` render. See `moirais.fn.describe('grpdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpdl import *
import numpy as np
# See the function signature in fn/grpdl.py for argument names.
```
