...
`print(result)` render. See `moirais.fn.describe('hmtd3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtd3 import *
import numpy as np
# See the function signature in fn/hmtd3.py for argument names.
```
