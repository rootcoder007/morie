# describe('wbcide') — wooldridge_bjs_estimator
...
`print(result)` render. See `moirais.fn.describe('wbcide')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wbcide import *
import numpy as np
# See the function signature in fn/wbcide.py for argument names.
```
