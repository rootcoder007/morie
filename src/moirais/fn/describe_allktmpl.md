# describe('allktmpl') — alammar_instruction_data_template
...
`print(result)` render. See `moirais.fn.describe('allktmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.allktmpl import *
import numpy as np
# See the function signature in fn/allktmpl.py for argument names.
```
