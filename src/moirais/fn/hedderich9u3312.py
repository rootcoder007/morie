...
__all__ = ["hedderich_chapter_9_unnumbered_3312"]


def hedderich_chapter_9_unnumbered_3312(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The coefficients, in this example ˆα1 = 11.7, ˆα2 = 17.3 and ˆα3 = 9.5, are identical to the group
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3312')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3312: GeneralStatistics expression (auto-extracted; see ref)."
