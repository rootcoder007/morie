...
`print(result)` render. See `moirais.fn.describe('msemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msemb import *
import numpy as np
# See the function signature in fn/msemb.py for argument names.
```
