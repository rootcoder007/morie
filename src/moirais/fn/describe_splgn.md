...
`print(result)` render. See `moirais.fn.describe('splgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgn import *
import numpy as np
# See the function signature in fn/splgn.py for argument names.
```
