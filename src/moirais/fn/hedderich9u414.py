...
__all__ = ["hedderich_chapter_9_unnumbered_414"]


def hedderich_chapter_9_unnumbered_414(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (1)P (B|S) = P (B∩S)/P (S) = P (B)/P (S) = P (B)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u414')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u414: GeneralStatistics expression (auto-extracted; see ref)."
