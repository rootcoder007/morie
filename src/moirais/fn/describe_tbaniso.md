...
`print(result)` render. See `moirais.fn.describe('tbaniso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbaniso import *
import numpy as np
# See the function signature in fn/tbaniso.py for argument names.
```
