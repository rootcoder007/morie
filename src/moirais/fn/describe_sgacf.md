...
`print(result)` render. See `moirais.fn.describe('sgacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgacf import *
import numpy as np
# See the function signature in fn/sgacf.py for argument names.
```
