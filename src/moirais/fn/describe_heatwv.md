# describe('heatwv') — heat_wave_detect
...
`print(result)` render. See `moirais.fn.describe('heatwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heatwv import *
import numpy as np
# See the function signature in fn/heatwv.py for argument names.
```
