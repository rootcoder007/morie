...
`print(result)` render. See `moirais.fn.describe('vdvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdvor import *
import numpy as np
# See the function signature in fn/vdvor.py for argument names.
```
