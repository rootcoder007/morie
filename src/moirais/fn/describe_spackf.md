# describe('spackf') — schabenberger_autocorrelation_function
...
`print(result)` render. See `moirais.fn.describe('spackf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spackf import *
import numpy as np
# See the function signature in fn/spackf.py for argument names.
```
