# describe('rsmand') — rating_scale_andrich
...
`print(result)` render. See `moirais.fn.describe('rsmand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmand import *
import numpy as np
# See the function signature in fn/rsmand.py for argument names.
```
