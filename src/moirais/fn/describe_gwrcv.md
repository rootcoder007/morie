...
`print(result)` render. See `moirais.fn.describe('gwrcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrcv import *
import numpy as np
# See the function signature in fn/gwrcv.py for argument names.
```
