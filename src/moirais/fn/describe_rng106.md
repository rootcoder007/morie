# describe('rng106') — rangayyan_ch3_integrator_magnitude_response
...
`print(result)` render. See `moirais.fn.describe('rng106')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng106 import *
import numpy as np
# See the function signature in fn/rng106.py for argument names.
```
