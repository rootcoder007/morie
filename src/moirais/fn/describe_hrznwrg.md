# describe('hrznwrg') — horowitz_nw_estimator_g
...
`print(result)` render. See `moirais.fn.describe('hrznwrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznwrg import *
import numpy as np
# See the function signature in fn/hrznwrg.py for argument names.
```
