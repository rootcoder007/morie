...
`print(result)` render. See `moirais.fn.describe('trprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trprt import *
import numpy as np
# See the function signature in fn/trprt.py for argument names.
```
