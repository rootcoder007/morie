...
`print(result)` render. See `moirais.fn.describe('jnckt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jnckt import *
import numpy as np
# See the function signature in fn/jnckt.py for argument names.
```
