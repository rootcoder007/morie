...
__all__ = ["hedderich_chapter_9_unnumbered_3620"]


def hedderich_chapter_9_unnumbered_3620(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: no 1 eβ1 eβ2 1 eβ1 eβ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3620')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3620: GeneralStatistics expression (auto-extracted; see ref)."
