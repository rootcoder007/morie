...
`print(result)` render. See `moirais.fn.describe('nmdsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdsf import *
import numpy as np
# See the function signature in fn/nmdsf.py for argument names.
```
