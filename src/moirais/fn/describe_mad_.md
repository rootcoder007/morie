# describe('mad_') — median_abs_deviation
...
`print(result)` render. See `moirais.fn.describe('mad_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mad_ import *
import numpy as np
# See the function signature in fn/mad_.py for argument names.
```
