...
`print(result)` render. See `moirais.fn.describe('iqr_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iqr_ import *
import numpy as np
# See the function signature in fn/iqr_.py for argument names.
```
