# describe('gb731') — gibbons_linrank_moments
...
`print(result)` render. See `moirais.fn.describe('gb731')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb731 import *
import numpy as np
# See the function signature in fn/gb731.py for argument names.
```
