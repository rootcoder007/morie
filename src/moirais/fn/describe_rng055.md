# describe('rng055') — rangayyan_ch3_dtft_via_z
...
`print(result)` render. See `moirais.fn.describe('rng055')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng055 import *
import numpy as np
# See the function signature in fn/rng055.py for argument names.
```
