...
`print(result)` render. See `moirais.fn.describe('rkhsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkhsn import *
import numpy as np
# See the function signature in fn/rkhsn.py for argument names.
```
