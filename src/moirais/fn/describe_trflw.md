...
`print(result)` render. See `moirais.fn.describe('trflw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trflw import *
import numpy as np
# See the function signature in fn/trflw.py for argument names.
```
