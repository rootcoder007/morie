# describe('wmtrwn') — weights_row_normalize
...
`print(result)` render. See `moirais.fn.describe('wmtrwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wmtrwn import *
import numpy as np
# See the function signature in fn/wmtrwn.py for argument names.
```
