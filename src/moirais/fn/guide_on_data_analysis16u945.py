...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_945"]


def guide_on_data_analysis_chapter_16_unnumbered_945(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Raw_p = round(p_values[1.10], 3),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u945')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u945: GeneralStatistics expression (auto-extracted; see ref)."
