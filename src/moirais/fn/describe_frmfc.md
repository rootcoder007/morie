...
`print(result)` render. See `moirais.fn.describe('frmfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frmfc import *
import numpy as np
# See the function signature in fn/frmfc.py for argument names.
```
