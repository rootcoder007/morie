...
`print(result)` render. See `moirais.fn.describe('emprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emprc import *
import numpy as np
# See the function signature in fn/emprc.py for argument names.
```
