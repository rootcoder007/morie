...
`print(result)` render. See `moirais.fn.describe('feynp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.feynp import *
import numpy as np
# See the function signature in fn/feynp.py for argument names.
```
