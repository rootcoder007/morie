# describe('rng002') — rangayyan_ch3_mean_squared_value
...
`print(result)` render. See `moirais.fn.describe('rng002')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng002 import *
import numpy as np
# See the function signature in fn/rng002.py for argument names.
```
