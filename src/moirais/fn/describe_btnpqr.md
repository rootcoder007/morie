# describe('btnpqr') — boot_quantile_regression
...
`print(result)` render. See `moirais.fn.describe('btnpqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btnpqr import *
import numpy as np
# See the function signature in fn/btnpqr.py for argument names.
```
