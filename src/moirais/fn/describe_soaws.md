...
`print(result)` render. See `moirais.fn.describe('soaws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soaws import *
import numpy as np
# See the function signature in fn/soaws.py for argument names.
```
