...
`print(result)` render. See `moirais.fn.describe('hmrms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrms import *
import numpy as np
# See the function signature in fn/hmrms.py for argument names.
```
