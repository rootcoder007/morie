...
`print(result)` render. See `moirais.fn.describe('klmflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klmflt import *
import numpy as np
# See the function signature in fn/klmflt.py for argument names.
```
