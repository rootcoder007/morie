...
__all__ = ["hedderich_chapter_9_unnumbered_780"]


def hedderich_chapter_9_unnumbered_780(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and the inflection points at the positionsµ−σandµ+σ(see Fig. 5.23), has a great significance
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u780')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u780: GeneralStatistics expression (auto-extracted; see ref)."
