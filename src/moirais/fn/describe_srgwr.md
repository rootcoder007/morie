...
`print(result)` render. See `moirais.fn.describe('srgwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwr import *
import numpy as np
# See the function signature in fn/srgwr.py for argument names.
```
