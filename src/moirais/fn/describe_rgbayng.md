# describe('rgbayng') — rangayyan_bayes_gaussian
...
`print(result)` render. See `moirais.fn.describe('rgbayng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbayng import *
import numpy as np
# See the function signature in fn/rgbayng.py for argument names.
```
