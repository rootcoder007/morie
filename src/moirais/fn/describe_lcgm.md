...
`print(result)` render. See `moirais.fn.describe('lcgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lcgm import *
import numpy as np
# See the function signature in fn/lcgm.py for argument names.
```
