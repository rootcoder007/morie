# describe('ghtst') — ghosal_np_testing
...
`print(result)` render. See `moirais.fn.describe('ghtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghtst import *
import numpy as np
# See the function signature in fn/ghtst.py for argument names.
```
