...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_222"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_222(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1(x)= b1 +2c1x+3d1x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u222')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u222: GeneralStatistics expression (auto-extracted; see ref)."
