...
`print(result)` render. See `moirais.fn.describe('trnscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnscl import *
import numpy as np
# See the function signature in fn/trnscl.py for argument names.
```
