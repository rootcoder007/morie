...
`print(result)` render. See `moirais.fn.describe('bstop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bstop import *
import numpy as np
# See the function signature in fn/bstop.py for argument names.
```
