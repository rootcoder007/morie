# describe('sgtmodul') — sgt_modularity_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtmodul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtmodul import *
import numpy as np
# See the function signature in fn/sgtmodul.py for argument names.
```
