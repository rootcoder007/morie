...
__all__ = ["wilcox_chapter_13_unnumbered_1209"]


def wilcox_chapter_13_unnumbered_1209(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Y = X1 +X2 +X1X 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1209')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1209: GeneralStatistics expression (auto-extracted; see ref)."
