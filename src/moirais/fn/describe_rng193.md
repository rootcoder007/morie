# describe('rng193') — rangayyan_ch4_heart_rate_from_count
...
`print(result)` render. See `moirais.fn.describe('rng193')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng193 import *
import numpy as np
# See the function signature in fn/rng193.py for argument names.
```
