# describe('bhawz') — bayesian_hazard
...
`print(result)` render. See `moirais.fn.describe('bhawz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhawz import *
import numpy as np
# See the function signature in fn/bhawz.py for argument names.
```
