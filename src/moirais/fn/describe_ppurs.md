# describe('ppurs') — projection_pursuit
...
`print(result)` render. See `moirais.fn.describe('ppurs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppurs import *
import numpy as np
# See the function signature in fn/ppurs.py for argument names.
```
