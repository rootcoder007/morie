...
`print(result)` render. See `moirais.fn.describe('spprlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprlm import *
import numpy as np
# See the function signature in fn/spprlm.py for argument names.
```
