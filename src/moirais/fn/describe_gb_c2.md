# describe('gb_c2') — gibbons_chi2_yates
...
`print(result)` render. See `moirais.fn.describe('gb_c2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_c2 import *
import numpy as np
# See the function signature in fn/gb_c2.py for argument names.
```
