# describe('mtovh') — mto_vehicle_type
...
`print(result)` render. See `moirais.fn.describe('mtovh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtovh import *
import numpy as np
# See the function signature in fn/mtovh.py for argument names.
```
