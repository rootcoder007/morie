# describe('hmsup') — geron_supervised_learning
...
`print(result)` render. See `moirais.fn.describe('hmsup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsup import *
import numpy as np
# See the function signature in fn/hmsup.py for argument names.
```
