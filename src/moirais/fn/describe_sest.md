...
`print(result)` render. See `moirais.fn.describe('sest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sest import *
import numpy as np
# See the function signature in fn/sest.py for argument names.
```
