...
`print(result)` render. See `moirais.fn.describe('clshr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clshr import *
import numpy as np
# See the function signature in fn/clshr.py for argument names.
```
