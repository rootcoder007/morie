...
`print(result)` render. See `moirais.fn.describe('cyclo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cyclo import *
import numpy as np
# See the function signature in fn/cyclo.py for argument names.
```
