# describe('otsw') — ot_sliced_wasserstein
...
`print(result)` render. See `moirais.fn.describe('otsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsw import *
import numpy as np
# See the function signature in fn/otsw.py for argument names.
```
