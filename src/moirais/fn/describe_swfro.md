...
`print(result)` render. See `moirais.fn.describe('swfro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swfro import *
import numpy as np
# See the function signature in fn/swfro.py for argument names.
```
