# describe('ambtc') — am_bootstrap_se
...
`print(result)` render. See `moirais.fn.describe('ambtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ambtc import *
import numpy as np
# See the function signature in fn/ambtc.py for argument names.
```
