# describe('gh_ap_h1') — ghosal_inv_gauss
...
`print(result)` render. See `moirais.fn.describe('gh_ap_h1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_h1 import *
import numpy as np
# See the function signature in fn/gh_ap_h1.py for argument names.
```
