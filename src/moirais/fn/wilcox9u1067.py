...
__all__ = ["wilcox_chapter_9_unnumbered_1067"]


def wilcox_chapter_9_unnumbered_1067(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: Decision Rule: Reject if H ≥ c, wherec is the 1 − α quantile of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1067')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1067: ContingencyTables expression (auto-extracted; see ref)."
