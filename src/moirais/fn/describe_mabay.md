# describe('mabay') — ma_bayes_random_effects
...
`print(result)` render. See `moirais.fn.describe('mabay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mabay import *
import numpy as np
# See the function signature in fn/mabay.py for argument names.
```
