...
`print(result)` render. See `moirais.fn.describe('nbwnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbwnd import *
import numpy as np
# See the function signature in fn/nbwnd.py for argument names.
```
