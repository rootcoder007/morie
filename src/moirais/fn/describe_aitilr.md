...
`print(result)` render. See `moirais.fn.describe('aitilr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitilr import *
import numpy as np
# See the function signature in fn/aitilr.py for argument names.
```
