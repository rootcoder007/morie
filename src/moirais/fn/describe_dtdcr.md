...
`print(result)` render. See `moirais.fn.describe('dtdcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtdcr import *
import numpy as np
# See the function signature in fn/dtdcr.py for argument names.
```
