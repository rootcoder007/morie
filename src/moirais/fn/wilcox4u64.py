...
__all__ = ["wilcox_chapter_4_unnumbered_64"]


def wilcox_chapter_4_unnumbered_64(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Assume n = 10 and p = 0.5. From Table 2 in Appendix B, P (X ≤ 1) = 0 .011 and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u64')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u64: GeneralStatistics expression (auto-extracted; see ref)."
