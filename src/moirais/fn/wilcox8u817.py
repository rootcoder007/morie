...
__all__ = ["wilcox_chapter_8_unnumbered_817"]


def wilcox_chapter_8_unnumbered_817(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pbad2way(J,K,x,est=onestep,conall=T,alpha = 0.05,nboot=2000,grp =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u817')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u817: GeneralStatistics expression (auto-extracted; see ref)."
