# describe('attsp') — sparse_attention
...
`print(result)` render. See `moirais.fn.describe('attsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attsp import *
import numpy as np
# See the function signature in fn/attsp.py for argument names.
```
