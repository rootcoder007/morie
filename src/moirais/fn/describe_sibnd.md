...
`print(result)` render. See `moirais.fn.describe('sibnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sibnd import *
import numpy as np
# See the function signature in fn/sibnd.py for argument names.
```
