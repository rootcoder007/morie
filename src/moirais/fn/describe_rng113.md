# describe('rng113') — rangayyan_ch3_first_difference_frequency_response
...
`print(result)` render. See `moirais.fn.describe('rng113')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng113 import *
import numpy as np
# See the function signature in fn/rng113.py for argument names.
```
