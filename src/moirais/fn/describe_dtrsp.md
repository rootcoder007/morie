# describe('dtrsp') — decision_tree_split
...
`print(result)` render. See `moirais.fn.describe('dtrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtrsp import *
import numpy as np
# See the function signature in fn/dtrsp.py for argument names.
```
