# describe('rgeqn6b') — rangayyan_ch6_median_freq
...
`print(result)` render. See `moirais.fn.describe('rgeqn6b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn6b import *
import numpy as np
# See the function signature in fn/rgeqn6b.py for argument names.
```
