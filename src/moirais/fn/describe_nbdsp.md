# describe('nbdsp') — negative_binomial_dispersion
...
`print(result)` render. See `moirais.fn.describe('nbdsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbdsp import *
import numpy as np
# See the function signature in fn/nbdsp.py for argument names.
```
