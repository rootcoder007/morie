# describe('gb_smn') — gibbons_smirnov_2sided
...
`print(result)` render. See `moirais.fn.describe('gb_smn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_smn import *
import numpy as np
# See the function signature in fn/gb_smn.py for argument names.
```
