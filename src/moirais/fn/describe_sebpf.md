...
`print(result)` render. See `moirais.fn.describe('sebpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebpf import *
import numpy as np
# See the function signature in fn/sebpf.py for argument names.
```
