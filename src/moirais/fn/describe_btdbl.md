...
`print(result)` render. See `moirais.fn.describe('btdbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btdbl import *
import numpy as np
# See the function signature in fn/btdbl.py for argument names.
```
