...
`print(result)` render. See `moirais.fn.describe('vmhgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmhgm import *
import numpy as np
# See the function signature in fn/vmhgm.py for argument names.
```
