...
`print(result)` render. See `moirais.fn.describe('awgnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.awgnc import *
import numpy as np
# See the function signature in fn/awgnc.py for argument names.
```
