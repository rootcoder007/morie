...
__all__ = ["hedderich_chapter_9_unnumbered_496"]


def hedderich_chapter_9_unnumbered_496(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (K)·P (T +|K)+P ( ¯K)·P (T +|¯K) = 0.015·0.8667
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u496')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u496: GeneralStatistics expression (auto-extracted; see ref)."
