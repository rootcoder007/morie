...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_355"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_355(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ktc = max (0, xk,τt − xk,γc) ≥ 0, d′′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u355')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u355: GeneralStatistics expression (auto-extracted; see ref)."
