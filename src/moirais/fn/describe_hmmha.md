# describe('hmmha') — geron_multihead_attention
...
`print(result)` render. See `moirais.fn.describe('hmmha')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmha import *
import numpy as np
# See the function signature in fn/hmmha.py for argument names.
```
