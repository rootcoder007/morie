# describe('evgevlm') — evt_gev_lmoments
...
`print(result)` render. See `moirais.fn.describe('evgevlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevlm import *
import numpy as np
# See the function signature in fn/evgevlm.py for argument names.
```
