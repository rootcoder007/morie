# describe('eslsis') — esl_sis_screening
...
`print(result)` render. See `moirais.fn.describe('eslsis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsis import *
import numpy as np
# See the function signature in fn/eslsis.py for argument names.
```
