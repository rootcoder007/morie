# describe('tmlcat') — tmle_categorical_outcome
...
`print(result)` render. See `moirais.fn.describe('tmlcat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcat import *
import numpy as np
# See the function signature in fn/tmlcat.py for argument names.
```
