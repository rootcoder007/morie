...
`print(result)` render. See `moirais.fn.describe('svvlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svvlm import *
import numpy as np
# See the function signature in fn/svvlm.py for argument names.
```
