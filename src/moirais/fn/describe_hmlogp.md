# describe('hmlogp') — geron_logistic_probability
...
`print(result)` render. See `moirais.fn.describe('hmlogp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlogp import *
import numpy as np
# See the function signature in fn/hmlogp.py for argument names.
```
