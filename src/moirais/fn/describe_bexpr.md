# describe('bexpr') — boolean_eval

## WHAT IT DOES

Boolean expression evaluator. 'The whole is greater than the sum of its parts. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('bexpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bexpr import *
import numpy as np
# See the function signature in fn/bexpr.py for argument names.
```
