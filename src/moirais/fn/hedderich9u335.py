...
__all__ = ["hedderich_chapter_9_unnumbered_335"]


def hedderich_chapter_9_unnumbered_335(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: y1 = 1 + 1x + 0.05x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u335')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u335: GeneralStatistics expression (auto-extracted; see ref)."
