...
`print(result)` render. See `moirais.fn.describe('distM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.distM import *
import numpy as np
# See the function signature in fn/distM.py for argument names.
```
