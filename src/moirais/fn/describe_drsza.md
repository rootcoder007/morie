# describe('drsza') — dr_did_santanna_zhao
...
`print(result)` render. See `moirais.fn.describe('drsza')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drsza import *
import numpy as np
# See the function signature in fn/drsza.py for argument names.
```
