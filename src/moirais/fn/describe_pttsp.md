...
`print(result)` render. See `moirais.fn.describe('pttsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pttsp import *
import numpy as np
# See the function signature in fn/pttsp.py for argument names.
```
