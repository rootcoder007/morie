# describe('causdidsap') — causal_did_sun_abraham
...
`print(result)` render. See `moirais.fn.describe('causdidsap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdidsap import *
import numpy as np
# See the function signature in fn/causdidsap.py for argument names.
```
