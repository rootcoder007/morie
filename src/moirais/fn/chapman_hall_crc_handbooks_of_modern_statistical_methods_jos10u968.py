...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_968"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_968(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t,Qn,λn,G0 |= oP (n−1/2), that is, we use
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u968')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u968: GeneralStatistics expression (auto-extracted; see ref)."
