# describe('smr') — standardized_mortality_ratio
...
`print(result)` render. See `moirais.fn.describe('smr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smr import *
import numpy as np
# See the function signature in fn/smr.py for argument names.
```
