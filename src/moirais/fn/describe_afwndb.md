# describe('afwndb') — afwndb

## WHAT IT DOES

Windbreak design spatial
...
`print(result)` render. See `moirais.fn.describe('afwndb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afwndb import *
import numpy as np
# See the function signature in fn/afwndb.py for argument names.
```
