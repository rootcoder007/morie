...
`print(result)` render. See `moirais.fn.describe('qbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qbnm import *
import numpy as np
# See the function signature in fn/qbnm.py for argument names.
```
