# describe('rng141') — rangayyan_ch3_mse_cost_function
...
`print(result)` render. See `moirais.fn.describe('rng141')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng141 import *
import numpy as np
# See the function signature in fn/rng141.py for argument names.
```
