# describe('ca7u237') — ca_chapter_7_unnumbered_237
...
```python
from moirais.fn.ca7u237 import ca_chapter_7_unnumbered_237
import numpy as np
result = ca_chapter_7_unnumbered_237(np.random.default_rng(42).normal(0, 1, 100))
