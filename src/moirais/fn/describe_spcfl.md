# describe('spcfl') — spectral_flatness_fn
...
`print(result)` render. See `moirais.fn.describe('spcfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcfl import *
import numpy as np
# See the function signature in fn/spcfl.py for argument names.
```
