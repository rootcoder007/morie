# describe('ghs021') — ghosal_ch3_tailfree_max_bound
...
`print(result)` render. See `moirais.fn.describe('ghs021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs021 import *
import numpy as np
# See the function signature in fn/ghs021.py for argument names.
```
