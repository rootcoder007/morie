...
`print(result)` render. See `moirais.fn.describe('prmsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prmsc import *
import numpy as np
# See the function signature in fn/prmsc.py for argument names.
```
