# describe('volmsg') — vol_markov_switching_garch
...
`print(result)` render. See `moirais.fn.describe('volmsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volmsg import *
import numpy as np
# See the function signature in fn/volmsg.py for argument names.
```
