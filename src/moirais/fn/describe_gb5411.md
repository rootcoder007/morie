# describe('gb5411') — gibbons_sign_pvalue
...
`print(result)` render. See `moirais.fn.describe('gb5411')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5411 import *
import numpy as np
# See the function signature in fn/gb5411.py for argument names.
```
