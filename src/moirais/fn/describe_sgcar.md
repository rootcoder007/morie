# describe('sgcar') — conditional_autoregressive
...
`print(result)` render. See `moirais.fn.describe('sgcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcar import *
import numpy as np
# See the function signature in fn/sgcar.py for argument names.
```
