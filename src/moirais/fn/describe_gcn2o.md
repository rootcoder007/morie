...
`print(result)` render. See `moirais.fn.describe('gcn2o')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcn2o import *
import numpy as np
# See the function signature in fn/gcn2o.py for argument names.
```
