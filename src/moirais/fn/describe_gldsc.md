...
`print(result)` render. See `moirais.fn.describe('gldsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gldsc import *
import numpy as np
# See the function signature in fn/gldsc.py for argument names.
```
