# describe('hubsau') — hits_hub_authority
...
`print(result)` render. See `moirais.fn.describe('hubsau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubsau import *
import numpy as np
# See the function signature in fn/hubsau.py for argument names.
```
