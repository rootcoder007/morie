...
__all__ = ["hedderich_chapter_9_unnumbered_743"]


def hedderich_chapter_9_unnumbered_743(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] p−r = (1−q)−r =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u743')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u743: CountModels expression (auto-extracted; see ref)."
