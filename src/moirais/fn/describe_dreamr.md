...
`print(result)` render. See `moirais.fn.describe('dreamr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dreamr import *
import numpy as np
# See the function signature in fn/dreamr.py for argument names.
```
