...
`print(result)` render. See `moirais.fn.describe('dchsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dchsq import *
import numpy as np
# See the function signature in fn/dchsq.py for argument names.
```
