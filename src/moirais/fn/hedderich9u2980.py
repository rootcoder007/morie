...
__all__ = ["hedderich_chapter_9_unnumbered_2980"]


def hedderich_chapter_9_unnumbered_2980(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] LU = 21.576/[1−(1−1/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2980')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2980: GeneralStatistics expression (auto-extracted; see ref)."
