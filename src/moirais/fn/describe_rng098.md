# describe('rng098') — rangayyan_ch3_ma_8point_impulse_response
...
`print(result)` render. See `moirais.fn.describe('rng098')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng098 import *
import numpy as np
# See the function signature in fn/rng098.py for argument names.
```
