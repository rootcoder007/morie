# describe('gh_c12_3') — ghosal_strong_apx_dp
...
`print(result)` render. See `moirais.fn.describe('gh_c12_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_3 import *
import numpy as np
# See the function signature in fn/gh_c12_3.py for argument names.
```
