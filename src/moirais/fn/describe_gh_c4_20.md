# describe('gh_c4_20') — ghosal_mix_dp
...
`print(result)` render. See `moirais.fn.describe('gh_c4_20')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_20 import *
import numpy as np
# See the function signature in fn/gh_c4_20.py for argument names.
```
