...
__all__ = ["wilcox_chapter_8_unnumbered_824"]


def wilcox_chapter_8_unnumbered_824(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : ¯F1.(x) = ¯F2.(x) = · · · = ¯FJ.(x)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u824')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u824: GeneralStatistics expression (auto-extracted; see ref)."
