...
`print(result)` render. See `moirais.fn.describe('baytrace')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baytrace import *
import numpy as np
# See the function signature in fn/baytrace.py for argument names.
```
