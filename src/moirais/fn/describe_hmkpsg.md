# describe('hmkpsg') — geron_kernel_pca_sigmoid
...
`print(result)` render. See `moirais.fn.describe('hmkpsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkpsg import *
import numpy as np
# See the function signature in fn/hmkpsg.py for argument names.
```
