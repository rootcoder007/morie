...
`print(result)` render. See `moirais.fn.describe('dtjhm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtjhm import *
import numpy as np
# See the function signature in fn/dtjhm.py for argument names.
```
