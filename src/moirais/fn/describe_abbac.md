...
`print(result)` render. See `moirais.fn.describe('abbac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abbac import *
import numpy as np
# See the function signature in fn/abbac.py for argument names.
```
