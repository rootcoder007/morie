...
__all__ = ["guide_on_data_analysis_chapter_8_unnumbered_676"]


def guide_on_data_analysis_chapter_8_unnumbered_676(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: subset = age == "A2" & species == "S2",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis8u676')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis8u676: GeneralStatistics expression (auto-extracted; see ref)."
