...
`print(result)` render. See `moirais.fn.describe('stkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkde import *
import numpy as np
# See the function signature in fn/stkde.py for argument names.
```
