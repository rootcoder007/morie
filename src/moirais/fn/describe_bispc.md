...
`print(result)` render. See `moirais.fn.describe('bispc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bispc import *
import numpy as np
# See the function signature in fn/bispc.py for argument names.
```
