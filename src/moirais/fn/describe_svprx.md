...
`print(result)` render. See `moirais.fn.describe('svprx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svprx import *
import numpy as np
# See the function signature in fn/svprx.py for argument names.
```
