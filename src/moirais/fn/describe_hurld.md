...
`print(result)` render. See `moirais.fn.describe('hurld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hurld import *
import numpy as np
# See the function signature in fn/hurld.py for argument names.
```
