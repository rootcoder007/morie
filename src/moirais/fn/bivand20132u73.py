...
__all__ = ["bivand2013_chapter_2_unnumbered_73"]


def bivand2013_chapter_2_unnumbered_73(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + nrow(coordinates(p_r_dem))), grid_random = c(fivenum(g_r_dem$band1),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u73')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u73: GeneralStatistics expression (auto-extracted; see ref)."
