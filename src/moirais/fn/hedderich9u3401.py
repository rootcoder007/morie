...
__all__ = ["hedderich_chapter_9_unnumbered_3401"]


def hedderich_chapter_9_unnumbered_3401(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + { sum ( p . h >= tcut & x == 0 ) / sum ( x == 0 ) } )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3401')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3401: GeneralStatistics expression (auto-extracted; see ref)."
