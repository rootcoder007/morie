# describe('hmtvt') — geron_train_val_test_split
...
`print(result)` render. See `moirais.fn.describe('hmtvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtvt import *
import numpy as np
# See the function signature in fn/hmtvt.py for argument names.
```
