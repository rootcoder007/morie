...
`print(result)` render. See `moirais.fn.describe('krgef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgef import *
import numpy as np
# See the function signature in fn/krgef.py for argument names.
```
