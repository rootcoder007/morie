...
`print(result)` render. See `moirais.fn.describe('wvmra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvmra import *
import numpy as np
# See the function signature in fn/wvmra.py for argument names.
```
