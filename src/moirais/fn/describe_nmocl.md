...
`print(result)` render. See `moirais.fn.describe('nmocl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmocl import *
import numpy as np
# See the function signature in fn/nmocl.py for argument names.
```
