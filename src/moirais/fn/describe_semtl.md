...
`print(result)` render. See `moirais.fn.describe('semtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semtl import *
import numpy as np
# See the function signature in fn/semtl.py for argument names.
```
