...
`print(result)` render. See `moirais.fn.describe('vgsil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgsil import *
import numpy as np
# See the function signature in fn/vgsil.py for argument names.
```
