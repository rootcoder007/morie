# describe('kpmnsv') — kaplan_meier_survival
...
`print(result)` render. See `moirais.fn.describe('kpmnsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpmnsv import *
import numpy as np
# See the function signature in fn/kpmnsv.py for argument names.
```
