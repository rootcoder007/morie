...
`print(result)` render. See `moirais.fn.describe('afvwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afvwc import *
import numpy as np
# See the function signature in fn/afvwc.py for argument names.
```
