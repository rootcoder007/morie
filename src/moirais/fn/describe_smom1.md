...
`print(result)` render. See `moirais.fn.describe('smom1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smom1 import *
import numpy as np
# See the function signature in fn/smom1.py for argument names.
```
