# describe('scr_r') — subscale_er_composite_rel
...
`print(result)` render. See `moirais.fn.describe('scr_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scr_r import *
import numpy as np
# See the function signature in fn/scr_r.py for argument names.
```
