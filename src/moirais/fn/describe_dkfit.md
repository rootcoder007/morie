...
`print(result)` render. See `moirais.fn.describe('dkfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkfit import *
import numpy as np
# See the function signature in fn/dkfit.py for argument names.
```
