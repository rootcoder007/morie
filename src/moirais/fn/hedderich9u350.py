...
__all__ = ["hedderich_chapter_9_unnumbered_350"]


def hedderich_chapter_9_unnumbered_350(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] In·lga +(∑x)·lgb = ∑lgy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u350')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u350: GeneralStatistics expression (auto-extracted; see ref)."
