# describe('hedderich9u3119') — hedderich_chapter_9_unnumbered_3119
...
z1−α (one-sided) orz1−α/2 (two-sided), it can be assumed thatϱ1 =ϱ.
...
import numpy as np
result = hedderich_chapter_9_unnumbered_3119(np.random.default_rng(42).normal(0, 1, 100))
