# describe('rng225') — rangayyan_ch4_composite_signal_in_terms_of_g
...
`print(result)` render. See `moirais.fn.describe('rng225')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng225 import *
import numpy as np
# See the function signature in fn/rng225.py for argument names.
```
