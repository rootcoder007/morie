# describe('gb_ktv') — gibbons_kendall_tau_var
...
`print(result)` render. See `moirais.fn.describe('gb_ktv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ktv import *
import numpy as np
# See the function signature in fn/gb_ktv.py for argument names.
```
