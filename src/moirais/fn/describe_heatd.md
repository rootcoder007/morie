...
`print(result)` render. See `moirais.fn.describe('heatd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heatd import *
import numpy as np
# See the function signature in fn/heatd.py for argument names.
```
