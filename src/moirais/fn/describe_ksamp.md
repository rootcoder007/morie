# describe('ksamp') — k_sample_anderson_darling
...
`print(result)` render. See `moirais.fn.describe('ksamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksamp import *
import numpy as np
# See the function signature in fn/ksamp.py for argument names.
```
