# describe('volharj') — vol_har_rv_jump
...
`print(result)` render. See `moirais.fn.describe('volharj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volharj import *
import numpy as np
# See the function signature in fn/volharj.py for argument names.
```
