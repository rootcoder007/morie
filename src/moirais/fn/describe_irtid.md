# describe('irtid') — irt_identification_constraints
...
`print(result)` render. See `moirais.fn.describe('irtid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtid import *
import numpy as np
# See the function signature in fn/irtid.py for argument names.
```
