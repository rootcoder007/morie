# describe('hrzi1') — horowitz_index_model
...
`print(result)` render. See `moirais.fn.describe('hrzi1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzi1 import *
import numpy as np
# See the function signature in fn/hrzi1.py for argument names.
```
