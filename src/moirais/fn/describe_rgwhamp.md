# describe('rgwhamp') — rangayyan_hamming_window
...
`print(result)` render. See `moirais.fn.describe('rgwhamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwhamp import *
import numpy as np
# See the function signature in fn/rgwhamp.py for argument names.
```
