...
`print(result)` render. See `moirais.fn.describe('umsad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umsad import *
import numpy as np
# See the function signature in fn/umsad.py for argument names.
```
