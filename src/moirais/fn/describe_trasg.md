...
`print(result)` render. See `moirais.fn.describe('trasg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trasg import *
import numpy as np
# See the function signature in fn/trasg.py for argument names.
```
