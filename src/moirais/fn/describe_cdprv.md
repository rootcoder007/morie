# describe('cdprv') — chronic_disease_prevalence
...
`print(result)` render. See `moirais.fn.describe('cdprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdprv import *
import numpy as np
# See the function signature in fn/cdprv.py for argument names.
```
