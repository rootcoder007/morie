...
__all__ = ["hedderich_chapter_9_unnumbered_1082"]


def hedderich_chapter_9_unnumbered_1082(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: Note: Sinceσ2 =λalso holds, n−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1082')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1082: CountModels expression (auto-extracted; see ref)."
