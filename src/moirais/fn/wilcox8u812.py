...
__all__ = ["wilcox_chapter_8_unnumbered_812"]


def wilcox_chapter_8_unnumbered_812(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : ∆ 1 = · · · = ∆ J−1 = 0, (10.5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u812')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u812: GeneralStatistics expression (auto-extracted; see ref)."
