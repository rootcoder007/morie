...
`print(result)` render. See `moirais.fn.describe('acfbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfbi import *
import numpy as np
# See the function signature in fn/acfbi.py for argument names.
```
