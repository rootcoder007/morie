...
`print(result)` render. See `moirais.fn.describe('ate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ate import *
import numpy as np
# See the function signature in fn/ate.py for argument names.
```
