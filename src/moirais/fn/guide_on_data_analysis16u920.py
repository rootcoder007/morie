...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_920"]


def guide_on_data_analysis_chapter_16_unnumbered_920(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R = [0 1 −1 0 0 ] , q = [0]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u920')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u920: GeneralStatistics expression (auto-extracted; see ref)."
