# describe('cvxbgm') — boyd_basis_pursuit
...
`print(result)` render. See `moirais.fn.describe('cvxbgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxbgm import *
import numpy as np
# See the function signature in fn/cvxbgm.py for argument names.
```
