...
`print(result)` render. See `moirais.fn.describe('node2v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.node2v import *
import numpy as np
# See the function signature in fn/node2v.py for argument names.
```
