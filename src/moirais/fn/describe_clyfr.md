# describe('clyfr') — clayton_copula_frailty
...
`print(result)` render. See `moirais.fn.describe('clyfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clyfr import *
import numpy as np
# See the function signature in fn/clyfr.py for argument names.
```
