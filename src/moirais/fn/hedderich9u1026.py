...
__all__ = ["hedderich_chapter_9_unnumbered_1026"]


def hedderich_chapter_9_unnumbered_1026(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1026')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1026: CountModels expression (auto-extracted; see ref)."
