...
`print(result)` render. See `moirais.fn.describe('sskew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sskew import *
import numpy as np
# See the function signature in fn/sskew.py for argument names.
```
