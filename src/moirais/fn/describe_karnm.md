...
`print(result)` render. See `moirais.fn.describe('karnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.karnm import *
import numpy as np
# See the function signature in fn/karnm.py for argument names.
```
