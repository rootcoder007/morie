...
`print(result)` render. See `moirais.fn.describe('sawco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawco import *
import numpy as np
# See the function signature in fn/sawco.py for argument names.
```
