...
`print(result)` render. See `moirais.fn.describe('pid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pid import *
import numpy as np
# See the function signature in fn/pid.py for argument names.
```
