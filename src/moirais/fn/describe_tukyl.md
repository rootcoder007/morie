...
`print(result)` render. See `moirais.fn.describe('tukyl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tukyl import *
import numpy as np
# See the function signature in fn/tukyl.py for argument names.
```
