# describe('gh_c13_10') — ghosal_ntr_consist
...
`print(result)` render. See `moirais.fn.describe('gh_c13_10')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_10 import *
import numpy as np
# See the function signature in fn/gh_c13_10.py for argument names.
```
