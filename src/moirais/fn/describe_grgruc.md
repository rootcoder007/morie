# describe('grgruc') — geron_gru_cell
...
`print(result)` render. See `moirais.fn.describe('grgruc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgruc import *
import numpy as np
# See the function signature in fn/grgruc.py for argument names.
```
