...
`print(result)` render. See `moirais.fn.describe('sfloc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfloc import *
import numpy as np
# See the function signature in fn/sfloc.py for argument names.
```
