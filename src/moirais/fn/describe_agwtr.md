...
`print(result)` render. See `moirais.fn.describe('agwtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agwtr import *
import numpy as np
# See the function signature in fn/agwtr.py for argument names.
```
