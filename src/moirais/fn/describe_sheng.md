# describe('sheng') — shannon_energy_fn
...
`print(result)` render. See `moirais.fn.describe('sheng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sheng import *
import numpy as np
# See the function signature in fn/sheng.py for argument names.
```
