# describe('hrzormsc') — horowitz_ordered_max_score
...
`print(result)` render. See `moirais.fn.describe('hrzormsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzormsc import *
import numpy as np
# See the function signature in fn/hrzormsc.py for argument names.
```
