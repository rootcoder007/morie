...
`print(result)` render. See `moirais.fn.describe('ensea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ensea import *
import numpy as np
# See the function signature in fn/ensea.py for argument names.
```
