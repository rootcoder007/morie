# describe('spkwt') — schabenberger_kriging_weights
...
`print(result)` render. See `moirais.fn.describe('spkwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkwt import *
import numpy as np
# See the function signature in fn/spkwt.py for argument names.
```
