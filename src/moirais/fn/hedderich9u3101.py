...
__all__ = ["hedderich_chapter_9_unnumbered_3101"]


def hedderich_chapter_9_unnumbered_3101(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: With ˆt = 3.085 > 1.782 = t12;0.95 it can be assumed at the 5% level that there is a significantly
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3101')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3101: GeneralStatistics expression (auto-extracted; see ref)."
