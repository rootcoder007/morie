# describe('gb521') — gibbons_quantile_ci
...
`print(result)` render. See `moirais.fn.describe('gb521')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb521 import *
import numpy as np
# See the function signature in fn/gb521.py for argument names.
```
