...
`print(result)` render. See `moirais.fn.describe('cfmwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfmwc import *
import numpy as np
# See the function signature in fn/cfmwc.py for argument names.
```
