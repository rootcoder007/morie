# describe('phlpr') — phillips_perron
...
`print(result)` render. See `moirais.fn.describe('phlpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phlpr import *
import numpy as np
# See the function signature in fn/phlpr.py for argument names.
```
