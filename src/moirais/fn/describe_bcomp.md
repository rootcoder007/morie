# describe('bcomp') — bayesian_model_compare
...
`print(result)` render. See `moirais.fn.describe('bcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcomp import *
import numpy as np
# See the function signature in fn/bcomp.py for argument names.
```
