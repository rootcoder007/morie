...
`print(result)` render. See `moirais.fn.describe('vmbox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmbox import *
import numpy as np
# See the function signature in fn/vmbox.py for argument names.
```
