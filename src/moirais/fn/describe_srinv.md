# describe('srinv') — serial_interval
...
`print(result)` render. See `moirais.fn.describe('srinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srinv import *
import numpy as np
# See the function signature in fn/srinv.py for argument names.
```
