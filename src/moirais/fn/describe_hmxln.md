...
`print(result)` render. See `moirais.fn.describe('hmxln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmxln import *
import numpy as np
# See the function signature in fn/hmxln.py for argument names.
```
