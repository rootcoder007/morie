...
`print(result)` render. See `moirais.fn.describe('ubgas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubgas import *
import numpy as np
# See the function signature in fn/ubgas.py for argument names.
```
