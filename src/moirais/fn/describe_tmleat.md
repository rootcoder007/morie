...
`print(result)` render. See `moirais.fn.describe('tmleat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmleat import *
import numpy as np
# See the function signature in fn/tmleat.py for argument names.
```
