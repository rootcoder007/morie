...
`print(result)` render. See `moirais.fn.describe('mdunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdunc import *
import numpy as np
# See the function signature in fn/mdunc.py for argument names.
```
