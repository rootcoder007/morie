# describe('heicer') — incremental_cer
...
`print(result)` render. See `moirais.fn.describe('heicer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heicer import *
import numpy as np
# See the function signature in fn/heicer.py for argument names.
```
