# describe('rgvf') — rangayyan_vf_detect
...
`print(result)` render. See `moirais.fn.describe('rgvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvf import *
import numpy as np
# See the function signature in fn/rgvf.py for argument names.
```
