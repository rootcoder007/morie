...
`print(result)` render. See `moirais.fn.describe('bnhan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnhan import *
import numpy as np
# See the function signature in fn/bnhan.py for argument names.
```
