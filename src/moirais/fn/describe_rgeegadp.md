# describe('rgeegadp') — rangayyan_eeg_adaptive_seg
...
`print(result)` render. See `moirais.fn.describe('rgeegadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeegadp import *
import numpy as np
# See the function signature in fn/rgeegadp.py for argument names.
```
