# describe('gb1322e') — gibbons_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb1322e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1322e import *
import numpy as np
# See the function signature in fn/gb1322e.py for argument names.
```
