# describe('rng047') — rangayyan_ch3_lsi_parallel_combined_h
...
`print(result)` render. See `moirais.fn.describe('rng047')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng047 import *
import numpy as np
# See the function signature in fn/rng047.py for argument names.
```
