...
`print(result)` render. See `moirais.fn.describe('sbsqp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbsqp import *
import numpy as np
# See the function signature in fn/sbsqp.py for argument names.
```
