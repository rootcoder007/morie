...
`print(result)` render. See `moirais.fn.describe('semaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semaic import *
import numpy as np
# See the function signature in fn/semaic.py for argument names.
```
