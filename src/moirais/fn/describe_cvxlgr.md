# describe('cvxlgr') — boyd_logistic_loss
...
`print(result)` render. See `moirais.fn.describe('cvxlgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlgr import *
import numpy as np
# See the function signature in fn/cvxlgr.py for argument names.
```
