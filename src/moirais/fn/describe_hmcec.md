# describe('hmcec') — geron_cross_entropy_cost
...
`print(result)` render. See `moirais.fn.describe('hmcec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcec import *
import numpy as np
# See the function signature in fn/hmcec.py for argument names.
```
