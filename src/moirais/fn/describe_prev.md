# describe('prev') — point_prevalence
...
`print(result)` render. See `moirais.fn.describe('prev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prev import *
import numpy as np
# See the function signature in fn/prev.py for argument names.
```
