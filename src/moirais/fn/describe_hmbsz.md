# describe('hmbsz') — geron_batch_size_heuristic
...
`print(result)` render. See `moirais.fn.describe('hmbsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbsz import *
import numpy as np
# See the function signature in fn/hmbsz.py for argument names.
```
