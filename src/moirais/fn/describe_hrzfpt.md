# describe('hrzfpt') — horowitz_first_passage_time
...
`print(result)` render. See `moirais.fn.describe('hrzfpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzfpt import *
import numpy as np
# See the function signature in fn/hrzfpt.py for argument names.
```
