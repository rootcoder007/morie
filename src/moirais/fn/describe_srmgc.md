...
`print(result)` render. See `moirais.fn.describe('srmgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmgc import *
import numpy as np
# See the function signature in fn/srmgc.py for argument names.
```
