...
`print(result)` render. See `moirais.fn.describe('dtdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtdir import *
import numpy as np
# See the function signature in fn/dtdir.py for argument names.
```
