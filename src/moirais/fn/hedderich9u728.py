...
__all__ = ["hedderich_chapter_9_unnumbered_728"]


def hedderich_chapter_9_unnumbered_728(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u728')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u728: CountModels expression (auto-extracted; see ref)."
