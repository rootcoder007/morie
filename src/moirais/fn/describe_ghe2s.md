...
`print(result)` render. See `moirais.fn.describe('ghe2s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghe2s import *
import numpy as np
# See the function signature in fn/ghe2s.py for argument names.
```
