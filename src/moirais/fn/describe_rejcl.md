...
`print(result)` render. See `moirais.fn.describe('rejcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rejcl import *
import numpy as np
# See the function signature in fn/rejcl.py for argument names.
```
