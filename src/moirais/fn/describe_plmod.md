...
`print(result)` render. See `moirais.fn.describe('plmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plmod import *
import numpy as np
# See the function signature in fn/plmod.py for argument names.
```
