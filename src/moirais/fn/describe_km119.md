# describe('km119') — kamath_ch8_bertscore_recall
...
`print(result)` render. See `moirais.fn.describe('km119')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km119 import *
import numpy as np
# See the function signature in fn/km119.py for argument names.
```
