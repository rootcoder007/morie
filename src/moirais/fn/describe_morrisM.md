# describe('morrisM') — morris_screening
...
`print(result)` render. See `moirais.fn.describe('morrisM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morrisM import *
import numpy as np
# See the function signature in fn/morrisM.py for argument names.
```
