# describe('kmprf') — kamath_prefix_lm_mask
...
`print(result)` render. See `moirais.fn.describe('kmprf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmprf import *
import numpy as np
# See the function signature in fn/kmprf.py for argument names.
```
