# describe('wscrp') — web_scrape

## WHAT IT DOES

Web page fetch + text extraction. 'The whole is greater than the sum of its parts. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('wscrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wscrp import *
import numpy as np
# See the function signature in fn/wscrp.py for argument names.
```
