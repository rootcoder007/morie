...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1456(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1456')`` for the full guide.
