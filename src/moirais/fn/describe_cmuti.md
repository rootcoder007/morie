# describe('cmuti') — copula_mutual_information
...
`print(result)` render. See `moirais.fn.describe('cmuti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmuti import *
import numpy as np
# See the function signature in fn/cmuti.py for argument names.
```
