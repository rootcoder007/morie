# describe('hdpmix') — hierarchical_dp
...
`print(result)` render. See `moirais.fn.describe('hdpmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdpmix import *
import numpy as np
# See the function signature in fn/hdpmix.py for argument names.
```
