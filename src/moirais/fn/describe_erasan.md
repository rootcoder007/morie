...
`print(result)` render. See `moirais.fn.describe('erasan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.erasan import *
import numpy as np
# See the function signature in fn/erasan.py for argument names.
```
