...
__all__ = ["wilcox_chapter_14_unnumbered_765"]


def wilcox_chapter_14_unnumbered_765(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ¯X1 = 79.2 ¯X2 = 100 ¯X3 = 83.9 ¯X4 = 85.9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u765')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u765: GeneralStatistics expression (auto-extracted; see ref)."
