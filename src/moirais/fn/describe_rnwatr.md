...
`print(result)` render. See `moirais.fn.describe('rnwatr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnwatr import *
import numpy as np
# See the function signature in fn/rnwatr.py for argument names.
```
