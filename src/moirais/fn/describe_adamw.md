# describe('adamw') — adamw

## WHAT IT DOES

rAdamW optimizer with decoupled weight decay.
...
`print(result)` render. See `moirais.fn.describe('adamw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adamw import *
import numpy as np
# See the function signature in fn/adamw.py for argument names.
```
