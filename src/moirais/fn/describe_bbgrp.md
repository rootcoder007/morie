...
`print(result)` render. See `moirais.fn.describe('bbgrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbgrp import *
import numpy as np
# See the function signature in fn/bbgrp.py for argument names.
```
