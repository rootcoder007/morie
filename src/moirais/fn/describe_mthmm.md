...
`print(result)` render. See `moirais.fn.describe('mthmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mthmm import *
import numpy as np
# See the function signature in fn/mthmm.py for argument names.
```
