...
`print(result)` render. See `moirais.fn.describe('hmgpt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgpt2 import *
import numpy as np
# See the function signature in fn/hmgpt2.py for argument names.
```
