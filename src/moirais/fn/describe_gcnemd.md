...
`print(result)` render. See `moirais.fn.describe('gcnemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcnemd import *
import numpy as np
# See the function signature in fn/gcnemd.py for argument names.
```
