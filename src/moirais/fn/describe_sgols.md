# describe('sgols') — ols_spatial_diagnostics
...
`print(result)` render. See `moirais.fn.describe('sgols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgols import *
import numpy as np
# See the function signature in fn/sgols.py for argument names.
```
