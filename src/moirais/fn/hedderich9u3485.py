...
__all__ = ["hedderich_chapter_9_unnumbered_3485"]


def hedderich_chapter_9_unnumbered_3485(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + strip = strip . custom ( strip . names = TRUE, strip . levels = TRUE) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3485')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3485: GeneralStatistics expression (auto-extracted; see ref)."
