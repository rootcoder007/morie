...
`print(result)` render. See `moirais.fn.describe('gwpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwpca import *
import numpy as np
# See the function signature in fn/gwpca.py for argument names.
```
