# describe('propMd') — proportion_mediated
...
`print(result)` render. See `moirais.fn.describe('propMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propMd import *
import numpy as np
# See the function signature in fn/propMd.py for argument names.
```
