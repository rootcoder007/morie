...
__all__ = ["wilcox_chapter_2_unnumbered_301"]


def wilcox_chapter_2_unnumbered_301(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 22 rats ( n = 22), the degrees of freedom are n − 1 = 22 − 1 = 21. Because 1 − α = 0.95,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u301')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u301: GeneralStatistics expression (auto-extracted; see ref)."
