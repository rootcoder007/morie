# describe('kflsh') — acceleration_profile
...
`print(result)` render. See `moirais.fn.describe('kflsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kflsh import *
import numpy as np
# See the function signature in fn/kflsh.py for argument names.
```
