...
`print(result)` render. See `moirais.fn.describe('hmclip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmclip import *
import numpy as np
# See the function signature in fn/hmclip.py for argument names.
```
