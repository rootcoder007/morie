# describe('rng119') — rangayyan_ch3_three_point_central_diff_phase
...
`print(result)` render. See `moirais.fn.describe('rng119')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng119 import *
import numpy as np
# See the function signature in fn/rng119.py for argument names.
```
