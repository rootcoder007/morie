...
`print(result)` render. See `moirais.fn.describe('vtcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtcon import *
import numpy as np
# See the function signature in fn/vtcon.py for argument names.
```
