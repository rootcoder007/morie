...
__all__ = ["bivand2013_chapter_7_unnumbered_81"]


def bivand2013_chapter_7_unnumbered_81(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + nrank = 2, nsim = 99)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u81')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u81: GeneralStatistics expression (auto-extracted; see ref)."
