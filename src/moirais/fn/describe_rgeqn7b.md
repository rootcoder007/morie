# describe('rgeqn7b') — rangayyan_ch7_arma_error
...
`print(result)` render. See `moirais.fn.describe('rgeqn7b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn7b import *
import numpy as np
# See the function signature in fn/rgeqn7b.py for argument names.
```
