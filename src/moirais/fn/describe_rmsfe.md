...
`print(result)` render. See `moirais.fn.describe('rmsfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsfe import *
import numpy as np
# See the function signature in fn/rmsfe.py for argument names.
```
