# describe('msm318') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm318')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm318 import *
import numpy as np
# See the function signature in fn/msm318.py for argument names.
```
