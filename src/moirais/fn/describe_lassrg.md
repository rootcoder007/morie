# describe('lassrg') — lasso_regression
...
`print(result)` render. See `moirais.fn.describe('lassrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lassrg import *
import numpy as np
# See the function signature in fn/lassrg.py for argument names.
```
