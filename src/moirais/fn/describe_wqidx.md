# describe('wqidx') — water_quality_index
...
`print(result)` render. See `moirais.fn.describe('wqidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqidx import *
import numpy as np
# See the function signature in fn/wqidx.py for argument names.
```
