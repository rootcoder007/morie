...
__all__ = ["hedderich_chapter_9_unnumbered_2826"]


def hedderich_chapter_9_unnumbered_2826(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + dimnames = list ( K = c ( " I " , " I I " ) , E = c ( "+" , " −" ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2826')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2826: GeneralStatistics expression (auto-extracted; see ref)."
