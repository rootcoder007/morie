...
__all__ = ["hedderich_chapter_9_unnumbered_2002"]


def hedderich_chapter_9_unnumbered_2002(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] MN =Var [MN ] = nm(N + 1)(N 2−4)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2002')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2002: GeneralStatistics expression (auto-extracted; see ref)."
