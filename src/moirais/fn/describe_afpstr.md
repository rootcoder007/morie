...
`print(result)` render. See `moirais.fn.describe('afpstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afpstr import *
import numpy as np
# See the function signature in fn/afpstr.py for argument names.
```
