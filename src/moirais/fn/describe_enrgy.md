...
`print(result)` render. See `moirais.fn.describe('enrgy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enrgy import *
import numpy as np
# See the function signature in fn/enrgy.py for argument names.
```
