# describe('km104') — kamath_ch6_affect_lm
...
`print(result)` render. See `moirais.fn.describe('km104')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km104 import *
import numpy as np
# See the function signature in fn/km104.py for argument names.
```
