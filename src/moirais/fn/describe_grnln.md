# describe('grnln') — greens_convolve
...
`print(result)` render. See `moirais.fn.describe('grnln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnln import *
import numpy as np
# See the function signature in fn/grnln.py for argument names.
```
