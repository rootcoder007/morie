# describe('hrzdiscd') — horowitz_direct_discrete_x
...
`print(result)` render. See `moirais.fn.describe('hrzdiscd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzdiscd import *
import numpy as np
# See the function signature in fn/hrzdiscd.py for argument names.
```
