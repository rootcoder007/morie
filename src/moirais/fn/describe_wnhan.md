...
`print(result)` render. See `moirais.fn.describe('wnhan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnhan import *
import numpy as np
# See the function signature in fn/wnhan.py for argument names.
```
