...
__all__ = ["hedderich_chapter_9_unnumbered_858"]


def hedderich_chapter_9_unnumbered_858(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (2) P (X <8.89) = P (Z <−1.555) = 0.06;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u858')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u858: GeneralStatistics expression (auto-extracted; see ref)."
