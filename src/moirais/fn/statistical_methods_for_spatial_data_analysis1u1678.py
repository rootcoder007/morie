...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1678(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1678')`` for the full guide.
