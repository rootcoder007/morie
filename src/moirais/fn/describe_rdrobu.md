# describe('rdrobu') — calonico_cattaneo_titiunik
...
`print(result)` render. See `moirais.fn.describe('rdrobu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdrobu import *
import numpy as np
# See the function signature in fn/rdrobu.py for argument names.
```
