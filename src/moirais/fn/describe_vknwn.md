# describe('vknwn') — validity_known_groups
...
`print(result)` render. See `moirais.fn.describe('vknwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vknwn import *
import numpy as np
# See the function signature in fn/vknwn.py for argument names.
```
