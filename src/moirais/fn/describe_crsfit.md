# describe('crsfit') — cross_fit_one_step
...
`print(result)` render. See `moirais.fn.describe('crsfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsfit import *
import numpy as np
# See the function signature in fn/crsfit.py for argument names.
```
