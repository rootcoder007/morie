...
`print(result)` render. See `moirais.fn.describe('topkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.topkd import *
import numpy as np
# See the function signature in fn/topkd.py for argument names.
```
