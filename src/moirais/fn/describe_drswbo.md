# describe('drswbo') — dr_did_stratified_block
...
`print(result)` render. See `moirais.fn.describe('drswbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drswbo import *
import numpy as np
# See the function signature in fn/drswbo.py for argument names.
```
