# describe('svspc') — subspace_decompose_fn
...
`print(result)` render. See `moirais.fn.describe('svspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svspc import *
import numpy as np
# See the function signature in fn/svspc.py for argument names.
```
