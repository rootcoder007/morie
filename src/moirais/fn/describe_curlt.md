...
`print(result)` render. See `moirais.fn.describe('curlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.curlt import *
import numpy as np
# See the function signature in fn/curlt.py for argument names.
```
