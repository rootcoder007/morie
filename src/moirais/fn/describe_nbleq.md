...
`print(result)` render. See `moirais.fn.describe('nbleq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbleq import *
import numpy as np
# See the function signature in fn/nbleq.py for argument names.
```
