...
`print(result)` render. See `moirais.fn.describe('gru4r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gru4r import *
import numpy as np
# See the function signature in fn/gru4r.py for argument names.
```
