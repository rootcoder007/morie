# describe('josnv') — joseph_seasonal_naive
...
`print(result)` render. See `moirais.fn.describe('josnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.josnv import *
import numpy as np
# See the function signature in fn/josnv.py for argument names.
```
