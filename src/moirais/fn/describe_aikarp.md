...
`print(result)` render. See `moirais.fn.describe('aikarp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aikarp import *
import numpy as np
# See the function signature in fn/aikarp.py for argument names.
```
