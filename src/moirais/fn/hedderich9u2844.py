...
__all__ = ["hedderich_chapter_9_unnumbered_2844"]


def hedderich_chapter_9_unnumbered_2844(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ni1 =ai +bi; ni2 =ci +di andni =ni1 +ni2;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2844')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2844: GeneralStatistics expression (auto-extracted; see ref)."
