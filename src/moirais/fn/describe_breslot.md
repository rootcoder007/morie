# describe('breslot') — breslow_tie_correction
...
`print(result)` render. See `moirais.fn.describe('breslot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.breslot import *
import numpy as np
# See the function signature in fn/breslot.py for argument names.
```
