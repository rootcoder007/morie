...
`print(result)` render. See `moirais.fn.describe('sfdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfdr import *
import numpy as np
# See the function signature in fn/sfdr.py for argument names.
```
