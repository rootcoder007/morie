# describe('gb_plc') — gibbons_placement_def
...
`print(result)` render. See `moirais.fn.describe('gb_plc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_plc import *
import numpy as np
# See the function signature in fn/gb_plc.py for argument names.
```
