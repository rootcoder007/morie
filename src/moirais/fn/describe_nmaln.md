...
`print(result)` render. See `moirais.fn.describe('nmaln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmaln import *
import numpy as np
# See the function signature in fn/nmaln.py for argument names.
```
