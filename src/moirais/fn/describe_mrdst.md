# describe('mrdst') — mahalanobis_distance
...
`print(result)` render. See `moirais.fn.describe('mrdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrdst import *
import numpy as np
# See the function signature in fn/mrdst.py for argument names.
```
