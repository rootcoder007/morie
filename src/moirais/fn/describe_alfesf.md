# describe('alfesf') — esmfold_lm_only
...
`print(result)` render. See `moirais.fn.describe('alfesf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfesf import *
import numpy as np
# See the function signature in fn/alfesf.py for argument names.
```
