...
__all__ = ["wilcox_chapter_13_unnumbered_1109"]


def wilcox_chapter_13_unnumbered_1109(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outfun=out, SEED=TRUE, alpha=0.05, crit=NULL, null.value=0, plotPV=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1109')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1109: GeneralStatistics expression (auto-extracted; see ref)."
