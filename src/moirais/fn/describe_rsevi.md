...
`print(result)` render. See `moirais.fn.describe('rsevi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsevi import *
import numpy as np
# See the function signature in fn/rsevi.py for argument names.
```
