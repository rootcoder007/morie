...
`print(result)` render. See `moirais.fn.describe('sgann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgann import *
import numpy as np
# See the function signature in fn/sgann.py for argument names.
```
