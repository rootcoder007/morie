...
`print(result)` render. See `moirais.fn.describe('sdmlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmlrt import *
import numpy as np
# See the function signature in fn/sdmlrt.py for argument names.
```
