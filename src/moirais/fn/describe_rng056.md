# describe('rng056') — rangayyan_ch3_iir_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng056')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng056 import *
import numpy as np
# See the function signature in fn/rng056.py for argument names.
```
