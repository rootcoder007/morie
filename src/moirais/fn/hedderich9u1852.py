...
__all__ = ["hedderich_chapter_9_unnumbered_1852"]


def hedderich_chapter_9_unnumbered_1852(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: with the null hypothesisσ2 =σ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1852')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1852: GeneralStatistics expression (auto-extracted; see ref)."
