# describe('gb571z') — gibbons_wsrt_ties_zeros
...
`print(result)` render. See `moirais.fn.describe('gb571z')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb571z import *
import numpy as np
# See the function signature in fn/gb571z.py for argument names.
```
