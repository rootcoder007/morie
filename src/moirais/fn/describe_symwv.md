...
`print(result)` render. See `moirais.fn.describe('symwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.symwv import *
import numpy as np
# See the function signature in fn/symwv.py for argument names.
```
