# describe('hierdp') — hierarchical_dp_density
...
`print(result)` render. See `moirais.fn.describe('hierdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hierdp import *
import numpy as np
# See the function signature in fn/hierdp.py for argument names.
```
