...
`print(result)` render. See `moirais.fn.describe('csmhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csmhr import *
import numpy as np
# See the function signature in fn/csmhr.py for argument names.
```
