# describe('rng027') — rangayyan_ch3_unit_step_continuous
...
`print(result)` render. See `moirais.fn.describe('rng027')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng027 import *
import numpy as np
# See the function signature in fn/rng027.py for argument names.
```
