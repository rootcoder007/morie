...
`print(result)` render. See `moirais.fn.describe('csgpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csgpr import *
import numpy as np
# See the function signature in fn/csgpr.py for argument names.
```
