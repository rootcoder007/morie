...
`print(result)` render. See `moirais.fn.describe('vgmdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgmdr import *
import numpy as np
# See the function signature in fn/vgmdr.py for argument names.
```
