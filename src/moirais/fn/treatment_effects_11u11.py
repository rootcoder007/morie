...
__all__ = ["treatment_effects_1_chapter_1_unnumbered_11"]


def treatment_effects_1_chapter_1_unnumbered_11(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: E[Y0i|Di = 0,Xi] = E[Yi|Di = 0,Xi], and, as a result:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('treatment_effects_11u11')`` for the full guide.
...
def cheatsheet():
    return "treatment_effects_11u11: GeneralStatistics expression (auto-extracted; see ref)."
