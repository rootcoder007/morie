# describe('bndw') — bandwidth_compute
...
`print(result)` render. See `moirais.fn.describe('bndw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndw import *
import numpy as np
# See the function signature in fn/bndw.py for argument names.
```
