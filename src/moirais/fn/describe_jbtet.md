# describe('jbtet') — jarque_bera_test
...
`print(result)` render. See `moirais.fn.describe('jbtet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jbtet import *
import numpy as np
# See the function signature in fn/jbtet.py for argument names.
```
