# describe('gh_ap_b1') — ghosal_kl_props
...
`print(result)` render. See `moirais.fn.describe('gh_ap_b1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_b1 import *
import numpy as np
# See the function signature in fn/gh_ap_b1.py for argument names.
```
