...
`print(result)` render. See `moirais.fn.describe('fst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fst import *
import numpy as np
# See the function signature in fn/fst.py for argument names.
```
