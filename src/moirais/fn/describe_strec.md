...
`print(result)` render. See `moirais.fn.describe('strec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strec import *
import numpy as np
# See the function signature in fn/strec.py for argument names.
```
