# describe('dwnom') — dw_nominate_estimate
...
`print(result)` render. See `moirais.fn.describe('dwnom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwnom import *
import numpy as np
# See the function signature in fn/dwnom.py for argument names.
```
