# describe('smcuf') — smacof_unfolding
...
`print(result)` render. See `moirais.fn.describe('smcuf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcuf import *
import numpy as np
# See the function signature in fn/smcuf.py for argument names.
```
