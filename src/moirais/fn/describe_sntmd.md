# describe('sntmd') — sentence_by_group
...
`print(result)` render. See `moirais.fn.describe('sntmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntmd import *
import numpy as np
# See the function signature in fn/sntmd.py for argument names.
```
