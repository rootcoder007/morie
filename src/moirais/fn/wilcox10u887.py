...
__all__ = ["wilcox_chapter_10_unnumbered_887"]


def wilcox_chapter_10_unnumbered_887(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: sppba(J,K,x,est=onestep, grp = c(1:JK), avg=FALSE, nboot=500,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u887')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u887: GeneralStatistics expression (auto-extracted; see ref)."
