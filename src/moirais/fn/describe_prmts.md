# describe('prmts') — permutation_test_two
...
`print(result)` render. See `moirais.fn.describe('prmts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prmts import *
import numpy as np
# See the function signature in fn/prmts.py for argument names.
```
