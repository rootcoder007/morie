# describe('rng080') — rangayyan_ch3_parseval_theorem
...
`print(result)` render. See `moirais.fn.describe('rng080')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng080 import *
import numpy as np
# See the function signature in fn/rng080.py for argument names.
```
