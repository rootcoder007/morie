...
__all__ = ["hedderich_chapter_9_unnumbered_2031"]


def hedderich_chapter_9_unnumbered_2031(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 5% level, since ˆt = 2.24> 1.796 = t11; 0 .95 or the P-value 0.0233 is.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2031')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2031: GeneralStatistics expression (auto-extracted; see ref)."
