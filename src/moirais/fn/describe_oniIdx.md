...
`print(result)` render. See `moirais.fn.describe('oniIdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oniIdx import *
import numpy as np
# See the function signature in fn/oniIdx.py for argument names.
```
