# describe('prop_ci') — proportion_ci
...
`print(result)` render. See `moirais.fn.describe('prop_ci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prop_ci import *
import numpy as np
# See the function signature in fn/prop_ci.py for argument names.
```
