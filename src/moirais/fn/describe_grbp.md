# describe('grbp') — geron_backpropagation_gradient
...
`print(result)` render. See `moirais.fn.describe('grbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbp import *
import numpy as np
# See the function signature in fn/grbp.py for argument names.
```
