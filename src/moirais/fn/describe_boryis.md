# describe('boryis') — borusyak_jaravel_spiess
...
`print(result)` render. See `moirais.fn.describe('boryis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boryis import *
import numpy as np
# See the function signature in fn/boryis.py for argument names.
```
