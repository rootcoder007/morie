...
`print(result)` render. See `moirais.fn.describe('carvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carvr import *
import numpy as np
# See the function signature in fn/carvr.py for argument names.
```
