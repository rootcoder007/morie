# describe('sgsqs') — sequential_gaussian_sim
...
`print(result)` render. See `moirais.fn.describe('sgsqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsqs import *
import numpy as np
# See the function signature in fn/sgsqs.py for argument names.
```
