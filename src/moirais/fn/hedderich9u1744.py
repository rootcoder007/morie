...
__all__ = ["hedderich_chapter_9_unnumbered_1744"]


def hedderich_chapter_9_unnumbered_1744(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : x Q = 0 . 6 7 3 9 1 , p− value < 2 . 2 e −16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1744')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1744: GeneralStatistics expression (auto-extracted; see ref)."
