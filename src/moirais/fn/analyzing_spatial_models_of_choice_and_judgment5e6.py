...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_5_equation_6"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_5_equation_6(x, cdf=None):
    """
    GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.

    Formula: di2jky = (Xik − O jky )2                                   (5.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment5e6')`` for the full guide.
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment5e6: GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment."
