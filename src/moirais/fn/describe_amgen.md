# describe('amgen') — arma_generate_fn
...
`print(result)` render. See `moirais.fn.describe('amgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amgen import *
import numpy as np
# See the function signature in fn/amgen.py for argument names.
```
