...
`print(result)` render. See `moirais.fn.describe('sscure')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sscure import *
import numpy as np
# See the function signature in fn/sscure.py for argument names.
```
