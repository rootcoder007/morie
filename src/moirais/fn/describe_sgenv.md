# describe('sgenv') — simulation_envelope
...
`print(result)` render. See `moirais.fn.describe('sgenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgenv import *
import numpy as np
# See the function signature in fn/sgenv.py for argument names.
```
