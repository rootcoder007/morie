...
__all__ = ["hedderich_chapter_9_unnumbered_2777"]


def hedderich_chapter_9_unnumbered_2777(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] [∆−(π1−π2)]2 (7.317)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2777')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2777: PowerAndDesign expression (auto-extracted; see ref)."
