...
`print(result)` render. See `moirais.fn.describe('whtfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whtfn import *
import numpy as np
# See the function signature in fn/whtfn.py for argument names.
```
