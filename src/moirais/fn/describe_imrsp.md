# describe('imrsp') — impulse_response
...
`print(result)` render. See `moirais.fn.describe('imrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imrsp import *
import numpy as np
# See the function signature in fn/imrsp.py for argument names.
```
