...
`print(result)` render. See `moirais.fn.describe('aient')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aient import *
import numpy as np
# See the function signature in fn/aient.py for argument names.
```
