...
__all__ = ["bivand2013_chapter_2_unnumbered_19"]


def bivand2013_chapter_2_unnumbered_19(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par(pin = c(ratio * pin[2], pin[2]), xaxs = "i", yaxs = "i")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u19')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u19: GeneralStatistics expression (auto-extracted; see ref)."
