...
__all__ = ["wilcox_chapter_13_unnumbered_1237"]


def wilcox_chapter_13_unnumbered_1237(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ylab="p-values",ylab2="Y", theta=50, phi=25, MC=FALSE, nreps=1000,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1237')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1237: GeneralStatistics expression (auto-extracted; see ref)."
