# describe('aitsbp') — aitchison_sbp_basis
...
`print(result)` render. See `moirais.fn.describe('aitsbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitsbp import *
import numpy as np
# See the function signature in fn/aitsbp.py for argument names.
```
