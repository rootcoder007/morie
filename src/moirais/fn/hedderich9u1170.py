...
__all__ = ["hedderich_chapter_9_unnumbered_1170"]


def hedderich_chapter_9_unnumbered_1170(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆp = 0, 95%-CI: πo = 3.04/(100 + 3.04) = 0.0295 = 0.03
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1170')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1170: GeneralStatistics expression (auto-extracted; see ref)."
