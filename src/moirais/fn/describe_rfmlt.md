# describe('rfmlt') — rf_multivariate
...
`print(result)` render. See `moirais.fn.describe('rfmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfmlt import *
import numpy as np
# See the function signature in fn/rfmlt.py for argument names.
```
