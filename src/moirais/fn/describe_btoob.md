...
`print(result)` render. See `moirais.fn.describe('btoob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btoob import *
import numpy as np
# See the function signature in fn/btoob.py for argument names.
```
