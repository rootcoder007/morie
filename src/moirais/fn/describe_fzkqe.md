# describe('fzkqe') — fauzi_kernel_quantile_estimator
...
`print(result)` render. See `moirais.fn.describe('fzkqe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzkqe import *
import numpy as np
# See the function signature in fn/fzkqe.py for argument names.
```
