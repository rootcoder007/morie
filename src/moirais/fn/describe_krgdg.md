...
`print(result)` render. See `moirais.fn.describe('krgdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgdg import *
import numpy as np
# See the function signature in fn/krgdg.py for argument names.
```
