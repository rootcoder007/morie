# describe('hmfmn') — geron_fashion_mnist
...
`print(result)` render. See `moirais.fn.describe('hmfmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfmn import *
import numpy as np
# See the function signature in fn/hmfmn.py for argument names.
```
