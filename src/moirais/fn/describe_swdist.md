...
`print(result)` render. See `moirais.fn.describe('swdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swdist import *
import numpy as np
# See the function signature in fn/swdist.py for argument names.
```
