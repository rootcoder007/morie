# describe('hmpttn') — geron_pytorch_tensor
...
`print(result)` render. See `moirais.fn.describe('hmpttn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpttn import *
import numpy as np
# See the function signature in fn/hmpttn.py for argument names.
```
