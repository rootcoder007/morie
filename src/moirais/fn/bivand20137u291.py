...
__all__ = ["bivand2013_chapter_7_unnumbered_291"]


def bivand2013_chapter_7_unnumbered_291(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : θ(1) = ... = θ(n) = λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u291')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u291: GeneralStatistics expression (auto-extracted; see ref)."
