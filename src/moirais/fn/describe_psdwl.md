...
`print(result)` render. See `moirais.fn.describe('psdwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psdwl import *
import numpy as np
# See the function signature in fn/psdwl.py for argument names.
```
