...
`print(result)` render. See `moirais.fn.describe('svnrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnrv import *
import numpy as np
# See the function signature in fn/svnrv.py for argument names.
```
