# describe('vlfctn') — value_function_eval
...
`print(result)` render. See `moirais.fn.describe('vlfctn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vlfctn import *
import numpy as np
# See the function signature in fn/vlfctn.py for argument names.
```
