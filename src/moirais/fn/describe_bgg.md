...
`print(result)` render. See `moirais.fn.describe('bgg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgg import *
import numpy as np
# See the function signature in fn/bgg.py for argument names.
```
