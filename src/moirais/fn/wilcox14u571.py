...
__all__ = ["wilcox_chapter_14_unnumbered_571"]


def wilcox_chapter_14_unnumbered_571(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: is X1 = 45 and its rank is R1 = 5. Similarly, X2 = 12 and its rank is R2 = 1.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u571')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u571: GeneralStatistics expression (auto-extracted; see ref)."
