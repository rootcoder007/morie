# describe('missinM') — missing_mechanism_sensitivity
...
`print(result)` render. See `moirais.fn.describe('missinM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.missinM import *
import numpy as np
# See the function signature in fn/missinM.py for argument names.
```
