# describe('tqval') — turboquant_value_cache_quantization
...
`print(result)` render. See `moirais.fn.describe('tqval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqval import *
import numpy as np
# See the function signature in fn/tqval.py for argument names.
```
