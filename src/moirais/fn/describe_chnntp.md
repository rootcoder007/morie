# describe('chnntp') — channel_capacity
...
`print(result)` render. See `moirais.fn.describe('chnntp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chnntp import *
import numpy as np
# See the function signature in fn/chnntp.py for argument names.
```
