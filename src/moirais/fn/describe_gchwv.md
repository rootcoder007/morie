...
`print(result)` render. See `moirais.fn.describe('gchwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gchwv import *
import numpy as np
# See the function signature in fn/gchwv.py for argument names.
```
