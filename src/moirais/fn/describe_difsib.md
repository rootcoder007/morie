...
`print(result)` render. See `moirais.fn.describe('difsib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difsib import *
import numpy as np
# See the function signature in fn/difsib.py for argument names.
```
