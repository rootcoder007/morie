...
`print(result)` render. See `moirais.fn.describe('imfcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imfcr import *
import numpy as np
# See the function signature in fn/imfcr.py for argument names.
```
