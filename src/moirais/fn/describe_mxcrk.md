...
`print(result)` render. See `moirais.fn.describe('mxcrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxcrk import *
import numpy as np
# See the function signature in fn/mxcrk.py for argument names.
```
