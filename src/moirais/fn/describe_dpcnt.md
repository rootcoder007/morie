...
`print(result)` render. See `moirais.fn.describe('dpcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpcnt import *
import numpy as np
# See the function signature in fn/dpcnt.py for argument names.
```
