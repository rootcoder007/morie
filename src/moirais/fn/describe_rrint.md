...
`print(result)` render. See `moirais.fn.describe('rrint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rrint import *
import numpy as np
# See the function signature in fn/rrint.py for argument names.
```
