...
`print(result)` render. See `moirais.fn.describe('hyfpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyfpl import *
import numpy as np
# See the function signature in fn/hyfpl.py for argument names.
```
