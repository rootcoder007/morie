...
__all__ = ["wilcox_chapter_14_unnumbered_456"]


def wilcox_chapter_14_unnumbered_456(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where t is the 1 − α/2 quantile of Student’s t distribution with n − 2 degrees of freedom,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u456')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u456: GeneralStatistics expression (auto-extracted; see ref)."
