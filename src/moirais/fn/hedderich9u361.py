...
__all__ = ["hedderich_chapter_9_unnumbered_361"]


def hedderich_chapter_9_unnumbered_361(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Bk = [bk−1,b k) withbk =a +k·h fork = 1, 2,... (3.118)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u361')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u361: GeneralStatistics expression (auto-extracted; see ref)."
