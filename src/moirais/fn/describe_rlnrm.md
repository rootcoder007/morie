...
`print(result)` render. See `moirais.fn.describe('rlnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlnrm import *
import numpy as np
# See the function signature in fn/rlnrm.py for argument names.
```
