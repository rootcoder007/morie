# describe('fzt11') — fauzi_thm1_1_bias_mgkde
...
`print(result)` render. See `moirais.fn.describe('fzt11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt11 import *
import numpy as np
# See the function signature in fn/fzt11.py for argument names.
```
