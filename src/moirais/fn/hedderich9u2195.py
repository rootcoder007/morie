...
__all__ = ["hedderich_chapter_9_unnumbered_2195"]


def hedderich_chapter_9_unnumbered_2195(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( " \ n " , " Sign testfor " , n , " pairsofvalues : T=" ,T , " ; P =" , p . val , " \ n " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2195')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2195: GeneralStatistics expression (auto-extracted; see ref)."
