...
`print(result)` render. See `moirais.fn.describe('rdopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdopt import *
import numpy as np
# See the function signature in fn/rdopt.py for argument names.
```
