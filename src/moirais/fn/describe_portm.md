# describe('portm') — portmanteau_test
...
`print(result)` render. See `moirais.fn.describe('portm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.portm import *
import numpy as np
# See the function signature in fn/portm.py for argument names.
```
