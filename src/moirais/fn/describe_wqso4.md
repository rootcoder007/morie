...
`print(result)` render. See `moirais.fn.describe('wqso4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqso4 import *
import numpy as np
# See the function signature in fn/wqso4.py for argument names.
```
