...
`print(result)` render. See `moirais.fn.describe('nskov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nskov import *
import numpy as np
# See the function signature in fn/nskov.py for argument names.
```
