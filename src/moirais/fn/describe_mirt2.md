# describe('mirt2') — mirt_2d_compensatory
...
`print(result)` render. See `moirais.fn.describe('mirt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mirt2 import *
import numpy as np
# See the function signature in fn/mirt2.py for argument names.
```
