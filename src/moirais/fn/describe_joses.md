# describe('joses') — joseph_simple_exponential_smoothing
...
`print(result)` render. See `moirais.fn.describe('joses')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joses import *
import numpy as np
# See the function signature in fn/joses.py for argument names.
```
