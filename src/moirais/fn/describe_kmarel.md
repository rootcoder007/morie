# describe('kmarel') — kamath_ragas_answer_relevance
...
`print(result)` render. See `moirais.fn.describe('kmarel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmarel import *
import numpy as np
# See the function signature in fn/kmarel.py for argument names.
```
