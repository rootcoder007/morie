# describe('eqms') — equating_mean_sigma
...
`print(result)` render. See `moirais.fn.describe('eqms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqms import *
import numpy as np
# See the function signature in fn/eqms.py for argument names.
```
