# describe('msm093') — mvsml_bayesian_regression_pt2_eq_7_3
...
`print(result)` render. See `moirais.fn.describe('msm093')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm093 import *
import numpy as np
# See the function signature in fn/msm093.py for argument names.
```
