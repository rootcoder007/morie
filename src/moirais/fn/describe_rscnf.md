...
`print(result)` render. See `moirais.fn.describe('rscnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rscnf import *
import numpy as np
# See the function signature in fn/rscnf.py for argument names.
```
