# describe('causdiddc') — causal_did_de_chaisemartin
...
`print(result)` render. See `moirais.fn.describe('causdiddc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdiddc import *
import numpy as np
# See the function signature in fn/causdiddc.py for argument names.
```
