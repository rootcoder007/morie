...
__all__ = ["wilcox_chapter_10_unnumbered_919"]


def wilcox_chapter_10_unnumbered_919(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α 3 = 1 − (1 − α )3/5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u919')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u919: GeneralStatistics expression (auto-extracted; see ref)."
