...
`print(result)` render. See `moirais.fn.describe('mstri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstri import *
import numpy as np
# See the function signature in fn/mstri.py for argument names.
```
