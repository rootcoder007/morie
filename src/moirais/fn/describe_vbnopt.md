# describe('vbnopt') — variational_inference
...
`print(result)` render. See `moirais.fn.describe('vbnopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vbnopt import *
import numpy as np
# See the function signature in fn/vbnopt.py for argument names.
```
