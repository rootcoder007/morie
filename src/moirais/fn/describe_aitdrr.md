# describe('aitdrr') — dirichlet_regression
...
`print(result)` render. See `moirais.fn.describe('aitdrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdrr import *
import numpy as np
# See the function signature in fn/aitdrr.py for argument names.
```
