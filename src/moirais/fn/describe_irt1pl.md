# describe('irt1pl') — rasch_one_parameter
...
`print(result)` render. See `moirais.fn.describe('irt1pl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt1pl import *
import numpy as np
# See the function signature in fn/irt1pl.py for argument names.
```
