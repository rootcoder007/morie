...
__all__ = ["wilcox_chapter_10_unnumbered_951"]


def wilcox_chapter_10_unnumbered_951(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :P (X =x) = P (Y =x) (12.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u951')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u951: GeneralStatistics expression (auto-extracted; see ref)."
