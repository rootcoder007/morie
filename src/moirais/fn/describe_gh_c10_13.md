# describe('gh_c10_13') — ghosal_pt_null_tst
...
`print(result)` render. See `moirais.fn.describe('gh_c10_13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c10_13 import *
import numpy as np
# See the function signature in fn/gh_c10_13.py for argument names.
```
