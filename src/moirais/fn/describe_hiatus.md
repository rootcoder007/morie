...
`print(result)` render. See `moirais.fn.describe('hiatus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hiatus import *
import numpy as np
# See the function signature in fn/hiatus.py for argument names.
```
