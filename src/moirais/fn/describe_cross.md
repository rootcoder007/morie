# describe('cross') — crossover_analysis
...
`print(result)` render. See `moirais.fn.describe('cross')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cross import *
import numpy as np
# See the function signature in fn/cross.py for argument names.
```
