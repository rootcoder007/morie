# describe('spstcv') — schabenberger_st_cov_separable
...
`print(result)` render. See `moirais.fn.describe('spstcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spstcv import *
import numpy as np
# See the function signature in fn/spstcv.py for argument names.
```
