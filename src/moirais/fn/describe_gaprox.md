...
`print(result)` render. See `moirais.fn.describe('gaprox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaprox import *
import numpy as np
# See the function signature in fn/gaprox.py for argument names.
```
