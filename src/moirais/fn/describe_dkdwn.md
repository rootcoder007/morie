...
`print(result)` render. See `moirais.fn.describe('dkdwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkdwn import *
import numpy as np
# See the function signature in fn/dkdwn.py for argument names.
```
