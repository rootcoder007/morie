...
`print(result)` render. See `moirais.fn.describe('mtrpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrpr import *
import numpy as np
# See the function signature in fn/mtrpr.py for argument names.
```
