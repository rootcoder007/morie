...
`print(result)` render. See `moirais.fn.describe('coxph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxph import *
import numpy as np
# See the function signature in fn/coxph.py for argument names.
```
