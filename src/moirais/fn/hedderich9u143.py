...
__all__ = ["hedderich_chapter_9_unnumbered_143"]


def hedderich_chapter_9_unnumbered_143(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + densit y=c ( 1 0 , 1 5 , 1 8 , 2 0 ) ,angl e=c ( 4 5 , 1 3 5 , 4 5 , 1 3 5 ) ,c o l=" black " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u143')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u143: GeneralStatistics expression (auto-extracted; see ref)."
