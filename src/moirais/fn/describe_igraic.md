...
`print(result)` render. See `moirais.fn.describe('igraic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igraic import *
import numpy as np
# See the function signature in fn/igraic.py for argument names.
```
