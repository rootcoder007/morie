# describe('ensno') — ensno

## WHAT IT DOES

Snowfall spatial mapping
...
`print(result)` render. See `moirais.fn.describe('ensno')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ensno import *
import numpy as np
# See the function signature in fn/ensno.py for argument names.
```
