...
`print(result)` render. See `moirais.fn.describe('soman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soman import *
import numpy as np
# See the function signature in fn/soman.py for argument names.
```
