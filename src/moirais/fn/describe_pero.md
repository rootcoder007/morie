# describe('pero') — prioritized_experience_replay
...
`print(result)` render. See `moirais.fn.describe('pero')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pero import *
import numpy as np
# See the function signature in fn/pero.py for argument names.
```
