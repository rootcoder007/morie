...
`print(result)` render. See `moirais.fn.describe('shafp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shafp import *
import numpy as np
# See the function signature in fn/shafp.py for argument names.
```
