# describe('medf') — median_filter_signal
...
`print(result)` render. See `moirais.fn.describe('medf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medf import *
import numpy as np
# See the function signature in fn/medf.py for argument names.
```
