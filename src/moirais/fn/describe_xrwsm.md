...
`print(result)` render. See `moirais.fn.describe('xrwsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwsm import *
import numpy as np
# See the function signature in fn/xrwsm.py for argument names.
```
