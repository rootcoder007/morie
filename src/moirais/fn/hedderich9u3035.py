...
__all__ = ["hedderich_chapter_9_unnumbered_3035"]


def hedderich_chapter_9_unnumbered_3035(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: other hand, is tested with the Bowker test (ˆχ2 = 91.47> 27.86 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3035')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3035: GeneralStatistics expression (auto-extracted; see ref)."
