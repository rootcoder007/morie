# describe('gb_are3') — gibbons_are_dbl_exp
...
`print(result)` render. See `moirais.fn.describe('gb_are3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_are3 import *
import numpy as np
# See the function signature in fn/gb_are3.py for argument names.
```
