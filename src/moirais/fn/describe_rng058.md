# describe('rng058') — rangayyan_ch3_pole_zero_factored_form
...
`print(result)` render. See `moirais.fn.describe('rng058')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng058 import *
import numpy as np
# See the function signature in fn/rng058.py for argument names.
```
