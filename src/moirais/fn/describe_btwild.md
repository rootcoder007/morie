# describe('btwild') — boot_wild_regression
...
`print(result)` render. See `moirais.fn.describe('btwild')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btwild import *
import numpy as np
# See the function signature in fn/btwild.py for argument names.
```
