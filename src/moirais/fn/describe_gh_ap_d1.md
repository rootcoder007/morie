# describe('gh_ap_d1') — ghosal_exp_test
...
`print(result)` render. See `moirais.fn.describe('gh_ap_d1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_d1 import *
import numpy as np
# See the function signature in fn/gh_ap_d1.py for argument names.
```
