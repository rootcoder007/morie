...
`print(result)` render. See `moirais.fn.describe('wlhme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlhme import *
import numpy as np
# See the function signature in fn/wlhme.py for argument names.
```
