...
`print(result)` render. See `moirais.fn.describe('ssnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssnr import *
import numpy as np
# See the function signature in fn/ssnr.py for argument names.
```
