...
`print(result)` render. See `moirais.fn.describe('gnsaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsaic import *
import numpy as np
# See the function signature in fn/gnsaic.py for argument names.
```
