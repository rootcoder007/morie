# describe('msm296') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm296')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm296 import *
import numpy as np
# See the function signature in fn/msm296.py for argument names.
```
