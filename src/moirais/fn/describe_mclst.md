# describe('mclst') — model_based_cluster
...
`print(result)` render. See `moirais.fn.describe('mclst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mclst import *
import numpy as np
# See the function signature in fn/mclst.py for argument names.
```
