...
__all__ = ["wilcox_chapter_13_unnumbered_1275"]


def wilcox_chapter_13_unnumbered_1275(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: pwr.chisq.test(w = NULL, N = NULL, df = NULL, sig.level = 0.05, power =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1275')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1275: PowerAndDesign expression (auto-extracted; see ref)."
