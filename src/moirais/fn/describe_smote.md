...
`print(result)` render. See `moirais.fn.describe('smote')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smote import *
import numpy as np
# See the function signature in fn/smote.py for argument names.
```
