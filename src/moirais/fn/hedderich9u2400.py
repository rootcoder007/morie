...
__all__ = ["hedderich_chapter_9_unnumbered_2400"]


def hedderich_chapter_9_unnumbered_2400(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 9.43−6.59 = 2.84> 2.597 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2400')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2400: GeneralStatistics expression (auto-extracted; see ref)."
