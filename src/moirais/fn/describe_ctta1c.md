# describe('ctta1c') — ctt_alpha_classic
...
`print(result)` render. See `moirais.fn.describe('ctta1c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctta1c import *
import numpy as np
# See the function signature in fn/ctta1c.py for argument names.
```
