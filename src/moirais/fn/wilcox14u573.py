...
__all__ = ["wilcox_chapter_14_unnumbered_573"]


def wilcox_chapter_14_unnumbered_573(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u573')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u573: GeneralStatistics expression (auto-extracted; see ref)."
