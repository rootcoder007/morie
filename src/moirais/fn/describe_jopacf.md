# describe('jopacf') — joseph_partial_autocorrelation
...
`print(result)` render. See `moirais.fn.describe('jopacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jopacf import *
import numpy as np
# See the function signature in fn/jopacf.py for argument names.
```
