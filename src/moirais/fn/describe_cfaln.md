...
`print(result)` render. See `moirais.fn.describe('cfaln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfaln import *
import numpy as np
# See the function signature in fn/cfaln.py for argument names.
```
