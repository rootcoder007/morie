...
`print(result)` render. See `moirais.fn.describe('sfpve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfpve import *
import numpy as np
# See the function signature in fn/sfpve.py for argument names.
```
