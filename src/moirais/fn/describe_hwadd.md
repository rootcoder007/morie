# describe('hwadd') — holt_winters_additive
...
`print(result)` render. See `moirais.fn.describe('hwadd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hwadd import *
import numpy as np
# See the function signature in fn/hwadd.py for argument names.
```
