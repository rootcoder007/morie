# describe('wnrec') — rectangular_window
...
`print(result)` render. See `moirais.fn.describe('wnrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnrec import *
import numpy as np
# See the function signature in fn/wnrec.py for argument names.
```
