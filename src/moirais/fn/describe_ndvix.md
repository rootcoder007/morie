# describe('ndvix') — ndvi_exposure_rr
...
`print(result)` render. See `moirais.fn.describe('ndvix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ndvix import *
import numpy as np
# See the function signature in fn/ndvix.py for argument names.
```
