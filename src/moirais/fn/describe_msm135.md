# describe('msm135') — mvsml_categorical_count_eq_8_6
...
`print(result)` render. See `moirais.fn.describe('msm135')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm135 import *
import numpy as np
# See the function signature in fn/msm135.py for argument names.
```
