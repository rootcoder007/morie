# describe('msm304') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm304')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm304 import *
import numpy as np
# See the function signature in fn/msm304.py for argument names.
```
