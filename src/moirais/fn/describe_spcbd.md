...
`print(result)` render. See `moirais.fn.describe('spcbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcbd import *
import numpy as np
# See the function signature in fn/spcbd.py for argument names.
```
