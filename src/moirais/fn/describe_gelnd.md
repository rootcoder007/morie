...
`print(result)` render. See `moirais.fn.describe('gelnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gelnd import *
import numpy as np
# See the function signature in fn/gelnd.py for argument names.
```
