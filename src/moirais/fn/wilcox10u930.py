...
__all__ = ["wilcox_chapter_10_unnumbered_930"]


def wilcox_chapter_10_unnumbered_930(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 (0.11556 + 0.156) = ( −0.167 , 0.97).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u930')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u930: GeneralStatistics expression (auto-extracted; see ref)."
