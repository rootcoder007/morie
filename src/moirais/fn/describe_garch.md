...
`print(result)` render. See `moirais.fn.describe('garch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.garch import *
import numpy as np
# See the function signature in fn/garch.py for argument names.
```
