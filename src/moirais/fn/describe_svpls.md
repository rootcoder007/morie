...
`print(result)` render. See `moirais.fn.describe('svpls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpls import *
import numpy as np
# See the function signature in fn/svpls.py for argument names.
```
