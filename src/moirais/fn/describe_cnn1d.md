...
`print(result)` render. See `moirais.fn.describe('cnn1d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnn1d import *
import numpy as np
# See the function signature in fn/cnn1d.py for argument names.
```
