...
`print(result)` render. See `moirais.fn.describe('slearn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slearn import *
import numpy as np
# See the function signature in fn/slearn.py for argument names.
```
