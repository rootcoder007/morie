...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_800"]


def guide_on_data_analysis_chapter_11_unnumbered_800(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[(x𝑖𝑡 − ̄x𝑖)′(𝑢𝑖𝑡 − ̄ 𝑢𝑖)] = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u800')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u800: GeneralStatistics expression (auto-extracted; see ref)."
