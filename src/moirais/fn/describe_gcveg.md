...
`print(result)` render. See `moirais.fn.describe('gcveg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcveg import *
import numpy as np
# See the function signature in fn/gcveg.py for argument names.
```
