...
`print(result)` render. See `moirais.fn.describe('socmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socmp import *
import numpy as np
# See the function signature in fn/socmp.py for argument names.
```
