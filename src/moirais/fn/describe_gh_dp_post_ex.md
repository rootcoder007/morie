# describe('gh_dp_post_ex') — ghosal_dp_posterior_exact
...
`print(result)` render. See `moirais.fn.describe('gh_dp_post_ex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_dp_post_ex import *
import numpy as np
# See the function signature in fn/gh_dp_post_ex.py for argument names.
```
