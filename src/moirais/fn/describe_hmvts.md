# describe('hmvts') — geron_voting_soft
...
`print(result)` render. See `moirais.fn.describe('hmvts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvts import *
import numpy as np
# See the function signature in fn/hmvts.py for argument names.
```
