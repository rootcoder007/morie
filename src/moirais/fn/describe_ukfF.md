# describe('ukfF') — unscented_kalman
...
`print(result)` render. See `moirais.fn.describe('ukfF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ukfF import *
import numpy as np
# See the function signature in fn/ukfF.py for argument names.
```
