...
`print(result)` render. See `moirais.fn.describe('empbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.empbs import *
import numpy as np
# See the function signature in fn/empbs.py for argument names.
```
