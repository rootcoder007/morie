# describe('lglbl') — label_legislators
...
`print(result)` render. See `moirais.fn.describe('lglbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lglbl import *
import numpy as np
# See the function signature in fn/lglbl.py for argument names.
```
