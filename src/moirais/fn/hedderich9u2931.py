...
__all__ = ["hedderich_chapter_9_unnumbered_2931"]


def hedderich_chapter_9_unnumbered_2931(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (Xi−niπ0) < 0. The distribution of this test statistic, conditional on the reduced sums, can be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2931')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2931: GeneralStatistics expression (auto-extracted; see ref)."
