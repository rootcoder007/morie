...
`print(result)` render. See `moirais.fn.describe('mipol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mipol import *
import numpy as np
# See the function signature in fn/mipol.py for argument names.
```
