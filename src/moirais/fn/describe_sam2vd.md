# describe('sam2vd') — sam2_video_propagation
...
`print(result)` render. See `moirais.fn.describe('sam2vd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sam2vd import *
import numpy as np
# See the function signature in fn/sam2vd.py for argument names.
```
