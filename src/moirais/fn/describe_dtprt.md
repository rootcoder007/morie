...
`print(result)` render. See `moirais.fn.describe('dtprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtprt import *
import numpy as np
# See the function signature in fn/dtprt.py for argument names.
```
