...
`print(result)` render. See `moirais.fn.describe('mrkcsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrkcsr import *
import numpy as np
# See the function signature in fn/mrkcsr.py for argument names.
```
