...
`print(result)` render. See `moirais.fn.describe('baysrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysrr import *
import numpy as np
# See the function signature in fn/baysrr.py for argument names.
```
