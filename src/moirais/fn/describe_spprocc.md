...
`print(result)` render. See `moirais.fn.describe('spprocc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprocc import *
import numpy as np
# See the function signature in fn/spprocc.py for argument names.
```
