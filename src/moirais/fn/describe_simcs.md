...
`print(result)` render. See `moirais.fn.describe('simcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simcs import *
import numpy as np
# See the function signature in fn/simcs.py for argument names.
```
