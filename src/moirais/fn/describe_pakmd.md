...
`print(result)` render. See `moirais.fn.describe('pakmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pakmd import *
import numpy as np
# See the function signature in fn/pakmd.py for argument names.
```
