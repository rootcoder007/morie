# describe('mtoben') — mto_benefit_cost
...
`print(result)` render. See `moirais.fn.describe('mtoben')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtoben import *
import numpy as np
# See the function signature in fn/mtoben.py for argument names.
```
