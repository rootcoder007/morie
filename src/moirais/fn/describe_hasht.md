...
`print(result)` render. See `moirais.fn.describe('hasht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hasht import *
import numpy as np
# See the function signature in fn/hasht.py for argument names.
```
