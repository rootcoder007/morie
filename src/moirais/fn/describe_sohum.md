...
`print(result)` render. See `moirais.fn.describe('sohum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sohum import *
import numpy as np
# See the function signature in fn/sohum.py for argument names.
```
