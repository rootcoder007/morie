# describe('mnlog') — multinomial_logistic_penalized
...
`print(result)` render. See `moirais.fn.describe('mnlog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnlog import *
import numpy as np
# See the function signature in fn/mnlog.py for argument names.
```
