...
`print(result)` render. See `moirais.fn.describe('rgfsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfsp import *
import numpy as np
# See the function signature in fn/rgfsp.py for argument names.
```
