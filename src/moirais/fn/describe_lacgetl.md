...
`print(result)` render. See `moirais.fn.describe('lacgetl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacgetl import *
import numpy as np
# See the function signature in fn/lacgetl.py for argument names.
```
