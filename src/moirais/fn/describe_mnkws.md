...
`print(result)` render. See `moirais.fn.describe('mnkws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnkws import *
import numpy as np
# See the function signature in fn/mnkws.py for argument names.
```
