# describe('infcrv') — influence_function
...
`print(result)` render. See `moirais.fn.describe('infcrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infcrv import *
import numpy as np
# See the function signature in fn/infcrv.py for argument names.
```
