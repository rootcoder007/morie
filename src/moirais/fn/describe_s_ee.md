...
`print(result)` render. See `moirais.fn.describe('s_ee')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.s_ee import *
import numpy as np
# See the function signature in fn/s_ee.py for argument names.
```
