...
`print(result)` render. See `moirais.fn.describe('stckp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stckp import *
import numpy as np
# See the function signature in fn/stckp.py for argument names.
```
