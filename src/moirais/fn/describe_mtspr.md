...
`print(result)` render. See `moirais.fn.describe('mtspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtspr import *
import numpy as np
# See the function signature in fn/mtspr.py for argument names.
```
