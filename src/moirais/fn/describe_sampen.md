# describe('sampen') — sample_entropy
...
`print(result)` render. See `moirais.fn.describe('sampen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sampen import *
import numpy as np
# See the function signature in fn/sampen.py for argument names.
```
