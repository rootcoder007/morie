# describe('otcw') — ot_cyclical_weight
...
`print(result)` render. See `moirais.fn.describe('otcw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otcw import *
import numpy as np
# See the function signature in fn/otcw.py for argument names.
```
