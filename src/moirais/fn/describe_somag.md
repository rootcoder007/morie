# describe('somag') — somag

## WHAT IT DOES

Magnesium soil spatial
...
`print(result)` render. See `moirais.fn.describe('somag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.somag import *
import numpy as np
# See the function signature in fn/somag.py for argument names.
```
