# describe('mmort') — maternal_mortality
...
`print(result)` render. See `moirais.fn.describe('mmort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmort import *
import numpy as np
# See the function signature in fn/mmort.py for argument names.
```
