...
`print(result)` render. See `moirais.fn.describe('xrfgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrfgt import *
import numpy as np
# See the function signature in fn/xrfgt.py for argument names.
```
