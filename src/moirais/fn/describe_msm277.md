# describe('msm277') — mvsml_convolutional_nn_eq_14_10
...
`print(result)` render. See `moirais.fn.describe('msm277')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm277 import *
import numpy as np
# See the function signature in fn/msm277.py for argument names.
```
