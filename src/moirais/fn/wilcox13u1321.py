...
__all__ = ["wilcox_chapter_13_unnumbered_1321"]


def wilcox_chapter_13_unnumbered_1321(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆpc = 40(50) + 30(20) + 30(30)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1321')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1321: GeneralStatistics expression (auto-extracted; see ref)."
