...
`print(result)` render. See `moirais.fn.describe('lmrerr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmrerr2 import *
import numpy as np
# See the function signature in fn/lmrerr2.py for argument names.
```
