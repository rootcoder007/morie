...
`print(result)` render. See `moirais.fn.describe('flatn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flatn import *
import numpy as np
# See the function signature in fn/flatn.py for argument names.
```
