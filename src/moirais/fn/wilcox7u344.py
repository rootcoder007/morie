...
__all__ = ["wilcox_chapter_7_unnumbered_344"]


def wilcox_chapter_7_unnumbered_344(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 23 − 1 = 22 degrees of freedom, and α = 0.05, the critical value is c = 2.07.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u344')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u344: GeneralStatistics expression (auto-extracted; see ref)."
