...
`print(result)` render. See `moirais.fn.describe('truer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.truer import *
import numpy as np
# See the function signature in fn/truer.py for argument names.
```
