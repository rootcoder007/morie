# describe('flowmm') — max_flow_min_cut
...
`print(result)` render. See `moirais.fn.describe('flowmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flowmm import *
import numpy as np
# See the function signature in fn/flowmm.py for argument names.
```
