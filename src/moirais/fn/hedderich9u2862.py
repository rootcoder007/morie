...
__all__ = ["hedderich_chapter_9_unnumbered_2862"]


def hedderich_chapter_9_unnumbered_2862(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3 = N [b4(a1 +a2 +a3)−a4(b1 +b2 +b3)]2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2862')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2862: GeneralStatistics expression (auto-extracted; see ref)."
