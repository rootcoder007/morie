...
`print(result)` render. See `moirais.fn.describe('galois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.galois import *
import numpy as np
# See the function signature in fn/galois.py for argument names.
```
