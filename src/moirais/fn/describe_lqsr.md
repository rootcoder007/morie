...
`print(result)` render. See `moirais.fn.describe('lqsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lqsr import *
import numpy as np
# See the function signature in fn/lqsr.py for argument names.
```
