# describe('gh_c8_4') — ghosal_prior_mass_cnd
...
`print(result)` render. See `moirais.fn.describe('gh_c8_4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c8_4 import *
import numpy as np
# See the function signature in fn/gh_c8_4.py for argument names.
```
