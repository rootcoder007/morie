...
`print(result)` render. See `moirais.fn.describe('contour')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.contour import *
import numpy as np
# See the function signature in fn/contour.py for argument names.
```
