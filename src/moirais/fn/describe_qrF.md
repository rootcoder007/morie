# describe('qrF') — quantile_forecast
...
`print(result)` render. See `moirais.fn.describe('qrF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrF import *
import numpy as np
# See the function signature in fn/qrF.py for argument names.
```
