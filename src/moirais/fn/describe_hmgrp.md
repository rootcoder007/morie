# describe('hmgrp') — geron_gaussian_rand_projection
...
`print(result)` render. See `moirais.fn.describe('hmgrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgrp import *
import numpy as np
# See the function signature in fn/hmgrp.py for argument names.
```
