...
__all__ = ["bivand2013_chapter_2_unnumbered_74"]


def bivand2013_chapter_2_unnumbered_74(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + nrow(coordinates(g_r_dem))), grid_regular = c(fivenum(g_rg_dem$band1),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u74')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u74: GeneralStatistics expression (auto-extracted; see ref)."
