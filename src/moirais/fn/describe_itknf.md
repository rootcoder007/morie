...
`print(result)` render. See `moirais.fn.describe('itknf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itknf import *
import numpy as np
# See the function signature in fn/itknf.py for argument names.
```
