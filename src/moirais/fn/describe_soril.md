# describe('soril') — soril

## WHAT IT DOES

Rill erosion spatial
...
`print(result)` render. See `moirais.fn.describe('soril')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soril import *
import numpy as np
# See the function signature in fn/soril.py for argument names.
```
