# describe('riskdf') — risk_difference
...
`print(result)` render. See `moirais.fn.describe('riskdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.riskdf import *
import numpy as np
# See the function signature in fn/riskdf.py for argument names.
```
