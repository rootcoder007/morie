...
__all__ = ["wilcox_chapter_14_unnumbered_505"]


def wilcox_chapter_14_unnumbered_505(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆcorr(r12,r 13) = (r23 − 0.5r12r23)(1 − r2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u505')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u505: GeneralStatistics expression (auto-extracted; see ref)."
