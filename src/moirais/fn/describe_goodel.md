...
`print(result)` render. See `moirais.fn.describe('goodel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.goodel import *
import numpy as np
# See the function signature in fn/goodel.py for argument names.
```
