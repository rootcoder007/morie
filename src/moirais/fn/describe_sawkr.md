...
`print(result)` render. See `moirais.fn.describe('sawkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawkr import *
import numpy as np
# See the function signature in fn/sawkr.py for argument names.
```
