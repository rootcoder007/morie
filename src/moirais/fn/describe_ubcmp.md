...
`print(result)` render. See `moirais.fn.describe('ubcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcmp import *
import numpy as np
# See the function signature in fn/ubcmp.py for argument names.
```
