# describe('gh_c14_17') — ghosal_disc_rp_rel
...
`print(result)` render. See `moirais.fn.describe('gh_c14_17')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_17 import *
import numpy as np
# See the function signature in fn/gh_c14_17.py for argument names.
```
