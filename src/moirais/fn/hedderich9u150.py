...
__all__ = ["hedderich_chapter_9_unnumbered_150"]
...
def hedderich_chapter_9_unnumbered_150(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u150')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u150: Regression expression (auto-extracted; see ref)."
