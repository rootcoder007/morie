# describe('sudaly') — substance_daly
...
`print(result)` render. See `moirais.fn.describe('sudaly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sudaly import *
import numpy as np
# See the function signature in fn/sudaly.py for argument names.
```
