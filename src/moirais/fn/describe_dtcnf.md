...
`print(result)` render. See `moirais.fn.describe('dtcnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcnf import *
import numpy as np
# See the function signature in fn/dtcnf.py for argument names.
```
