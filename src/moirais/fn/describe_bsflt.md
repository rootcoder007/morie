# describe('bsflt') — bandstop_filter
...
`print(result)` render. See `moirais.fn.describe('bsflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsflt import *
import numpy as np
# See the function signature in fn/bsflt.py for argument names.
```
