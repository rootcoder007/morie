# describe('instf') — instantaneous_freq
...
`print(result)` render. See `moirais.fn.describe('instf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.instf import *
import numpy as np
# See the function signature in fn/instf.py for argument names.
```
