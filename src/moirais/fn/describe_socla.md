...
`print(result)` render. See `moirais.fn.describe('socla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socla import *
import numpy as np
# See the function signature in fn/socla.py for argument names.
```
