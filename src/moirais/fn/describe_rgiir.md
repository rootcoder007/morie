# describe('rgiir') — rangayyan_iir_filter
...
`print(result)` render. See `moirais.fn.describe('rgiir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgiir import *
import numpy as np
# See the function signature in fn/rgiir.py for argument names.
```
