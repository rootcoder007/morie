...
__all__ = ["hedderich_chapter_9_unnumbered_2625"]


def hedderich_chapter_9_unnumbered_2625(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (12−1)(1·1−5·5)2/64 = 4.89> 3.84 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2625')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2625: GeneralStatistics expression (auto-extracted; see ref)."
