...
`print(result)` render. See `moirais.fn.describe('itskw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itskw import *
import numpy as np
# See the function signature in fn/itskw.py for argument names.
```
