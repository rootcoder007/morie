# describe('gh_c3_13') — ghosal_polya_urn_pt
...
`print(result)` render. See `moirais.fn.describe('gh_c3_13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_13 import *
import numpy as np
# See the function signature in fn/gh_c3_13.py for argument names.
```
