...
`print(result)` render. See `moirais.fn.describe('brcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brcc import *
import numpy as np
# See the function signature in fn/brcc.py for argument names.
```
