# describe('tqrot') — turboquant_rotation_matrix
...
`print(result)` render. See `moirais.fn.describe('tqrot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqrot import *
import numpy as np
# See the function signature in fn/tqrot.py for argument names.
```
