...
__all__ = ["hedderich_chapter_9_unnumbered_1720"]


def hedderich_chapter_9_unnumbered_1720(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.01) with dn =√n−0.01 + 0.83/√n. Example: n = 40, α= 0.05, i.e. dn = (
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1720')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1720: GeneralStatistics expression (auto-extracted; see ref)."
