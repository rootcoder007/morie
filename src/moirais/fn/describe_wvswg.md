...
`print(result)` render. See `moirais.fn.describe('wvswg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvswg import *
import numpy as np
# See the function signature in fn/wvswg.py for argument names.
```
