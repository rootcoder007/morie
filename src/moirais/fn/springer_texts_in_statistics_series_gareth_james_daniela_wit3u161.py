...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_161"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_161(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + coefi=coef(object ,id=id)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u161')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u161: GeneralStatistics expression (auto-extracted; see ref)."
