...
`print(result)` render. See `moirais.fn.describe('csrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrob import *
import numpy as np
# See the function signature in fn/csrob.py for argument names.
```
