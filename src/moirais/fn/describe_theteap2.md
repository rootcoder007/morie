...
`print(result)` render. See `moirais.fn.describe('theteap2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.theteap2 import *
import numpy as np
# See the function signature in fn/theteap2.py for argument names.
```
