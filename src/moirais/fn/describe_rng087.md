# describe('rng087') — rangayyan_ch3_ma_filter_general
...
`print(result)` render. See `moirais.fn.describe('rng087')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng087 import *
import numpy as np
# See the function signature in fn/rng087.py for argument names.
```
