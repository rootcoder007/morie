# describe('rgvagkn') — rangayyan_vag_knee_cartilage
...
`print(result)` render. See `moirais.fn.describe('rgvagkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvagkn import *
import numpy as np
# See the function signature in fn/rgvagkn.py for argument names.
```
