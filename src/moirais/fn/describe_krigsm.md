# describe('krigsm') — ordinary_kriging
...
`print(result)` render. See `moirais.fn.describe('krigsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krigsm import *
import numpy as np
# See the function signature in fn/krigsm.py for argument names.
```
