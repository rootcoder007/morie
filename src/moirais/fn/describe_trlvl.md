...
`print(result)` render. See `moirais.fn.describe('trlvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trlvl import *
import numpy as np
# See the function signature in fn/trlvl.py for argument names.
```
