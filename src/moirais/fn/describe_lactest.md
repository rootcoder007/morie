...
`print(result)` render. See `moirais.fn.describe('lactest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lactest import *
import numpy as np
# See the function signature in fn/lactest.py for argument names.
```
