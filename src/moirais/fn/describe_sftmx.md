...
`print(result)` render. See `moirais.fn.describe('sftmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sftmx import *
import numpy as np
# See the function signature in fn/sftmx.py for argument names.
```
