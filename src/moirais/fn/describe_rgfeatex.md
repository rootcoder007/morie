# describe('rgfeatex') — rangayyan_feature_extract_bci
...
`print(result)` render. See `moirais.fn.describe('rgfeatex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfeatex import *
import numpy as np
# See the function signature in fn/rgfeatex.py for argument names.
```
