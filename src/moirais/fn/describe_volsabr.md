# describe('volsabr') — vol_sabr_implied
...
`print(result)` render. See `moirais.fn.describe('volsabr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volsabr import *
import numpy as np
# See the function signature in fn/volsabr.py for argument names.
```
