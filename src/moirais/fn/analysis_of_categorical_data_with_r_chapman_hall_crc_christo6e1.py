...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_1(x):
    """
    Dispersion equation extracted from Analysis of Categorical Data with R (Chapman & Hall CRC -- CHRISTOPHER R   LOUGHIN BILDER (THOMAS M ).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo6e1')`` for the full guide.
...
def cheatsheet():
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo6e1: Dispersion equation extracted from Analysis of Categorical Data with R (Chapman & Hall CRC -- CHRISTOPHER R   LOUGHIN BILDER (THOMAS M )."
