...
`print(result)` render. See `moirais.fn.describe('medSEM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medSEM import *
import numpy as np
# See the function signature in fn/medSEM.py for argument names.
```
