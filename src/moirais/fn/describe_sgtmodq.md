# describe('sgtmodq') — sgt_modularity_q
...
`print(result)` render. See `moirais.fn.describe('sgtmodq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtmodq import *
import numpy as np
# See the function signature in fn/sgtmodq.py for argument names.
```
