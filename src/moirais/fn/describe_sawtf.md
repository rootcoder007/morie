...
`print(result)` render. See `moirais.fn.describe('sawtf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawtf import *
import numpy as np
# See the function signature in fn/sawtf.py for argument names.
```
