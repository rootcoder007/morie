...
__all__ = ["hedderich_chapter_9_unnumbered_3529"]


def hedderich_chapter_9_unnumbered_3529(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] U (Θ) = ψ′(θ, y) = ∂y
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3529')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3529: GeneralStatistics expression (auto-extracted; see ref)."
