# describe('hrzkde') — horowitz_appendix_kde
...
`print(result)` render. See `moirais.fn.describe('hrzkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzkde import *
import numpy as np
# See the function signature in fn/hrzkde.py for argument names.
```
