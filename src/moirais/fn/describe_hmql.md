# describe('hmql') — geron_q_learning
...
`print(result)` render. See `moirais.fn.describe('hmql')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmql import *
import numpy as np
# See the function signature in fn/hmql.py for argument names.
```
