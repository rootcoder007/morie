...
`print(result)` render. See `moirais.fn.describe('orbit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orbit import *
import numpy as np
# See the function signature in fn/orbit.py for argument names.
```
