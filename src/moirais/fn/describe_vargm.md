# describe('vargm') — empirical_variogram
...
`print(result)` render. See `moirais.fn.describe('vargm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vargm import *
import numpy as np
# See the function signature in fn/vargm.py for argument names.
```
