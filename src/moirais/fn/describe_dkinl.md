...
`print(result)` render. See `moirais.fn.describe('dkinl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkinl import *
import numpy as np
# See the function signature in fn/dkinl.py for argument names.
```
