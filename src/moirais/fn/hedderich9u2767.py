...
__all__ = ["hedderich_chapter_9_unnumbered_2767"]


def hedderich_chapter_9_unnumbered_2767(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] z(∆) = ˆπ1−ˆπ2−∆√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2767')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2767: GeneralStatistics expression (auto-extracted; see ref)."
