...
`print(result)` render. See `moirais.fn.describe('flxipt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flxipt import *
import numpy as np
# See the function signature in fn/flxipt.py for argument names.
```
