...
`print(result)` render. See `moirais.fn.describe('rsrve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsrve import *
import numpy as np
# See the function signature in fn/rsrve.py for argument names.
```
