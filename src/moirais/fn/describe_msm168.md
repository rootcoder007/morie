# describe('msm168') — mvsml_ridge_lasso_elastic_eq_9_2
...
`print(result)` render. See `moirais.fn.describe('msm168')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm168 import *
import numpy as np
# See the function signature in fn/msm168.py for argument names.
```
