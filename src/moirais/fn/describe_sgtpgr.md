# describe('sgtpgr') — sgt_pagerank_power
...
`print(result)` render. See `moirais.fn.describe('sgtpgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtpgr import *
import numpy as np
# See the function signature in fn/sgtpgr.py for argument names.
```
