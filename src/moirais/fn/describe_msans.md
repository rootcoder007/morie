...
`print(result)` render. See `moirais.fn.describe('msans')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msans import *
import numpy as np
# See the function signature in fn/msans.py for argument names.
```
