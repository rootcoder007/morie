# describe('bdmnsl') — bound_monot_selection
...
`print(result)` render. See `moirais.fn.describe('bdmnsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdmnsl import *
import numpy as np
# See the function signature in fn/bdmnsl.py for argument names.
```
