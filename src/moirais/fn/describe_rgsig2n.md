# describe('rgsig2n') — rangayyan_signal_to_noise
...
`print(result)` render. See `moirais.fn.describe('rgsig2n')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsig2n import *
import numpy as np
# See the function signature in fn/rgsig2n.py for argument names.
```
