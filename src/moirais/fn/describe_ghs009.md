# describe('ghs009') — ghosal_ch3_stick_breaking_weights
...
`print(result)` render. See `moirais.fn.describe('ghs009')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs009 import *
import numpy as np
# See the function signature in fn/ghs009.py for argument names.
```
