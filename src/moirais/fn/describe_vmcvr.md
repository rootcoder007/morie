...
`print(result)` render. See `moirais.fn.describe('vmcvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcvr import *
import numpy as np
# See the function signature in fn/vmcvr.py for argument names.
```
