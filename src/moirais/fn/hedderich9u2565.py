...
__all__ = ["hedderich_chapter_9_unnumbered_2565"]


def hedderich_chapter_9_unnumbered_2565(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: value:µ1 =µ2 =...=µb.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2565')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2565: GeneralStatistics expression (auto-extracted; see ref)."
