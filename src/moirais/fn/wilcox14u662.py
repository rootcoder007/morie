...
__all__ = ["wilcox_chapter_14_unnumbered_662"]


def wilcox_chapter_14_unnumbered_662(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 72 + 92 + · · · + 142 = 3026,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u662')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u662: GeneralStatistics expression (auto-extracted; see ref)."
