# describe('grroc') — geron_roc_curve
...
`print(result)` render. See `moirais.fn.describe('grroc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grroc import *
import numpy as np
# See the function signature in fn/grroc.py for argument names.
```
