# describe('gstabwt') — stabilized_weights
...
`print(result)` render. See `moirais.fn.describe('gstabwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gstabwt import *
import numpy as np
# See the function signature in fn/gstabwt.py for argument names.
```
