...
`print(result)` render. See `moirais.fn.describe('nbhrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbhrs import *
import numpy as np
# See the function signature in fn/nbhrs.py for argument names.
```
