# describe('bnfwd') — batch_norm_forward
...
`print(result)` render. See `moirais.fn.describe('bnfwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnfwd import *
import numpy as np
# See the function signature in fn/bnfwd.py for argument names.
```
