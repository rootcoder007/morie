# describe('futl') — futility_boundary
...
`print(result)` render. See `moirais.fn.describe('futl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.futl import *
import numpy as np
# See the function signature in fn/futl.py for argument names.
```
