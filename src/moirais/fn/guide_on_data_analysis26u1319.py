...
__all__ = ["guide_on_data_analysis_chapter_26_unnumbered_1319"]


def guide_on_data_analysis_chapter_26_unnumbered_1319(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis26u1319')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis26u1319: GeneralStatistics expression (auto-extracted; see ref)."
