...
`print(result)` render. See `moirais.fn.describe('em_i')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.em_i import *
import numpy as np
# See the function signature in fn/em_i.py for argument names.
```
