# describe('evpdfn') — evt_pickands_dep_fn
...
`print(result)` render. See `moirais.fn.describe('evpdfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evpdfn import *
import numpy as np
# See the function signature in fn/evpdfn.py for argument names.
```
