...
`print(result)` render. See `moirais.fn.describe('vtmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtmod import *
import numpy as np
# See the function signature in fn/vtmod.py for argument names.
```
