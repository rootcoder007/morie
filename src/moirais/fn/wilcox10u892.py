...
__all__ = ["wilcox_chapter_10_unnumbered_892"]


def wilcox_chapter_10_unnumbered_892(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Decision Rule: Reject if FA ≥ f , where f is the 1 − α quantile of an F distribution with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u892')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u892: GeneralStatistics expression (auto-extracted; see ref)."
