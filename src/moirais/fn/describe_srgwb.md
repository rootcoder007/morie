...
`print(result)` render. See `moirais.fn.describe('srgwb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwb import *
import numpy as np
# See the function signature in fn/srgwb.py for argument names.
```
