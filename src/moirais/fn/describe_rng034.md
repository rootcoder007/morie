# describe('rng034') — rangayyan_ch3_discrete_delta
...
`print(result)` render. See `moirais.fn.describe('rng034')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng034 import *
import numpy as np
# See the function signature in fn/rng034.py for argument names.
```
