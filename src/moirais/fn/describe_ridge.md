# describe('ridge') — ridge_regression
...
`print(result)` render. See `moirais.fn.describe('ridge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ridge import *
import numpy as np
# See the function signature in fn/ridge.py for argument names.
```
