# describe('sgtreg') — sgt_resistance_distance_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtreg import *
import numpy as np
# See the function signature in fn/sgtreg.py for argument names.
```
