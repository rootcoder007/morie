...
`print(result)` render. See `moirais.fn.describe('semboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semboot import *
import numpy as np
# See the function signature in fn/semboot.py for argument names.
```
