# describe('rng226') — rangayyan_ch4_matched_filter_h_example
...
`print(result)` render. See `moirais.fn.describe('rng226')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng226 import *
import numpy as np
# See the function signature in fn/rng226.py for argument names.
```
