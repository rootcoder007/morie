...
`print(result)` render. See `moirais.fn.describe('agfgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agfgm import *
import numpy as np
# See the function signature in fn/agfgm.py for argument names.
```
