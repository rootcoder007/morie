# describe('rgccep') — rangayyan_complex_cepstrum
...
`print(result)` render. See `moirais.fn.describe('rgccep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgccep import *
import numpy as np
# See the function signature in fn/rgccep.py for argument names.
```
