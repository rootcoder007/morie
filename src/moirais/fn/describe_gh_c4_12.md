# describe('gh_c4_12') — ghosal_dp_discrete
...
`print(result)` render. See `moirais.fn.describe('gh_c4_12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_12 import *
import numpy as np
# See the function signature in fn/gh_c4_12.py for argument names.
```
