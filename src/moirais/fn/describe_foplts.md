...
`print(result)` render. See `moirais.fn.describe('foplts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foplts import *
import numpy as np
# See the function signature in fn/foplts.py for argument names.
```
