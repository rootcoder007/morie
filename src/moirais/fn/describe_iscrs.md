...
`print(result)` render. See `moirais.fn.describe('iscrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iscrs import *
import numpy as np
# See the function signature in fn/iscrs.py for argument names.
```
