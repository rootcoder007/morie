...
__all__ = ["hedderich_chapter_9_unnumbered_1725"]


def hedderich_chapter_9_unnumbered_1725(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > 40 0.55/√n 0.61/√n 0.65/√n 0.67/√n 0.70/√n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1725')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1725: GeneralStatistics expression (auto-extracted; see ref)."
