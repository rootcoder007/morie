...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1589"]


def guide_on_data_analysis_chapter_30_unnumbered_1589(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data = base_stagg |>
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1589')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1589: GeneralStatistics expression (auto-extracted; see ref)."
