...
`print(result)` render. See `moirais.fn.describe('mgwrtvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrtvl import *
import numpy as np
# See the function signature in fn/mgwrtvl.py for argument names.
```
