# describe('polar') — polar_decompose
...
`print(result)` render. See `moirais.fn.describe('polar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polar import *
import numpy as np
# See the function signature in fn/polar.py for argument names.
```
