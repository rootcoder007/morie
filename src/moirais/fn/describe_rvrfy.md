...
`print(result)` render. See `moirais.fn.describe('rvrfy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rvrfy import *
import numpy as np
# See the function signature in fn/rvrfy.py for argument names.
```
