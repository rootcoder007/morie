# describe('grlinf') — geron_linear_layer_forward
...
`print(result)` render. See `moirais.fn.describe('grlinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlinf import *
import numpy as np
# See the function signature in fn/grlinf.py for argument names.
```
