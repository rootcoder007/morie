...
`print(result)` render. See `moirais.fn.describe('anova')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anova import *
import numpy as np
# See the function signature in fn/anova.py for argument names.
```
