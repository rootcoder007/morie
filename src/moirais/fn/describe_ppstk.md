...
`print(result)` render. See `moirais.fn.describe('ppstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppstk import *
import numpy as np
# See the function signature in fn/ppstk.py for argument names.
```
