...
`print(result)` render. See `moirais.fn.describe('chsim3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chsim3 import *
import numpy as np
# See the function signature in fn/chsim3.py for argument names.
```
