...
`print(result)` render. See `moirais.fn.describe('xrcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrcar import *
import numpy as np
# See the function signature in fn/xrcar.py for argument names.
```
