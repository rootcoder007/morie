# describe('trnpt') — turning_points_test
...
`print(result)` render. See `moirais.fn.describe('trnpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnpt import *
import numpy as np
# See the function signature in fn/trnpt.py for argument names.
```
