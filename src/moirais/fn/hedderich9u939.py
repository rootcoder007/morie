...
__all__ = ["hedderich_chapter_9_unnumbered_939"]


def hedderich_chapter_9_unnumbered_939(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The estimation of the parameters in R according to (5.148) leads to ˆλ=749.76 and ˆδ=55.50 (here
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u939')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u939: GeneralStatistics expression (auto-extracted; see ref)."
