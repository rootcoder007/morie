...
`print(result)` render. See `moirais.fn.describe('matcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matcl import *
import numpy as np
# See the function signature in fn/matcl.py for argument names.
```
