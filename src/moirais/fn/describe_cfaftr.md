# describe('cfaftr') — cfa_one_factor
...
`print(result)` render. See `moirais.fn.describe('cfaftr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfaftr import *
import numpy as np
# See the function signature in fn/cfaftr.py for argument names.
```
