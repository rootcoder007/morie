# describe('nbreg') — negbin_regression
...
`print(result)` render. See `moirais.fn.describe('nbreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbreg import *
import numpy as np
# See the function signature in fn/nbreg.py for argument names.
```
