...
`print(result)` render. See `moirais.fn.describe('zsgpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgpv import *
import numpy as np
# See the function signature in fn/zsgpv.py for argument names.
```
