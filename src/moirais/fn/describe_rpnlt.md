# describe('rpnlt') — roughness_penalty
...
`print(result)` render. See `moirais.fn.describe('rpnlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpnlt import *
import numpy as np
# See the function signature in fn/rpnlt.py for argument names.
```
