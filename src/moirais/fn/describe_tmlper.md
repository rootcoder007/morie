...
`print(result)` render. See `moirais.fn.describe('tmlper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlper import *
import numpy as np
# See the function signature in fn/tmlper.py for argument names.
```
