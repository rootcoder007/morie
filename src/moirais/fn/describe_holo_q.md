...
`print(result)` render. See `moirais.fn.describe('holo_q')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_q import *
import numpy as np
# See the function signature in fn/holo_q.py for argument names.
```
