...
`print(result)` render. See `moirais.fn.describe('opbfg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opbfg import *
import numpy as np
# See the function signature in fn/opbfg.py for argument names.
```
