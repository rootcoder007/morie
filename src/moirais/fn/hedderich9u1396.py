...
__all__ = ["hedderich_chapter_9_unnumbered_1396"]


def hedderich_chapter_9_unnumbered_1396(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n−i + 1F2i,2(n−i+1),α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1396')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1396: GeneralStatistics expression (auto-extracted; see ref)."
