# describe('scltw') — probability_resample
...
`print(result)` render. See `moirais.fn.describe('scltw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scltw import *
import numpy as np
# See the function signature in fn/scltw.py for argument names.
```
