...
__all__ = ["hedderich_chapter_9_unnumbered_2791"]


def hedderich_chapter_9_unnumbered_2791(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] ˆp1−ˆp2 =b/n−c/n = (b−c)/n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2791')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2791: CausalInference expression (auto-extracted; see ref)."
