...
`print(result)` render. See `moirais.fn.describe('mtbtw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtbtw import *
import numpy as np
# See the function signature in fn/mtbtw.py for argument names.
```
