...
`print(result)` render. See `moirais.fn.describe('esd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esd import *
import numpy as np
# See the function signature in fn/esd.py for argument names.
```
