# describe('spmath') — schabenberger_matheron_estimator
...
`print(result)` render. See `moirais.fn.describe('spmath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmath import *
import numpy as np
# See the function signature in fn/spmath.py for argument names.
```
