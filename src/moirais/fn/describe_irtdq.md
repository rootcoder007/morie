# describe('irtdq') — irt_quadratic_utility
...
`print(result)` render. See `moirais.fn.describe('irtdq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtdq import *
import numpy as np
# See the function signature in fn/irtdq.py for argument names.
```
