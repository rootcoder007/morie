# describe('rng052') — rangayyan_ch3_z_transform_definition
...
`print(result)` render. See `moirais.fn.describe('rng052')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng052 import *
import numpy as np
# See the function signature in fn/rng052.py for argument names.
```
