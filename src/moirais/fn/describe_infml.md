...
`print(result)` render. See `moirais.fn.describe('infml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infml import *
import numpy as np
# See the function signature in fn/infml.py for argument names.
```
