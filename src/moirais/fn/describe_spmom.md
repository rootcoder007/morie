# describe('spmom') — spectral_moment_fn
...
`print(result)` render. See `moirais.fn.describe('spmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmom import *
import numpy as np
# See the function signature in fn/spmom.py for argument names.
```
