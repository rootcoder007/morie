...
`print(result)` render. See `moirais.fn.describe('hmpvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpvt import *
import numpy as np
# See the function signature in fn/hmpvt.py for argument names.
```
