...
`print(result)` render. See `moirais.fn.describe('polyak')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polyak import *
import numpy as np
# See the function signature in fn/polyak.py for argument names.
```
