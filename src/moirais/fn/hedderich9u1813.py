...
__all__ = ["hedderich_chapter_9_unnumbered_1813"]


def hedderich_chapter_9_unnumbered_1813(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: HA2 :µ<µ0 ˆt = ¯x−µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1813')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1813: GeneralStatistics expression (auto-extracted; see ref)."
