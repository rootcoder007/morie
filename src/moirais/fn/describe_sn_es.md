...
`print(result)` render. See `moirais.fn.describe('sn_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sn_es import *
import numpy as np
# See the function signature in fn/sn_es.py for argument names.
```
