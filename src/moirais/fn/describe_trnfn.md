# describe('trnfn') — transfer_function
...
`print(result)` render. See `moirais.fn.describe('trnfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnfn import *
import numpy as np
# See the function signature in fn/trnfn.py for argument names.
```
