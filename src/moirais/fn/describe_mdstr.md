...
`print(result)` render. See `moirais.fn.describe('mdstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdstr import *
import numpy as np
# See the function signature in fn/mdstr.py for argument names.
```
