...
`print(result)` render. See `moirais.fn.describe('cbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cbnd import *
import numpy as np
# See the function signature in fn/cbnd.py for argument names.
```
