...
`print(result)` render. See `moirais.fn.describe('irtif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtif import *
import numpy as np
# See the function signature in fn/irtif.py for argument names.
```
