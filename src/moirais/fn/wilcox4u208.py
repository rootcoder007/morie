...
__all__ = ["wilcox_chapter_4_unnumbered_208"]


def wilcox_chapter_4_unnumbered_208(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Because 1 − α = 0.95, α = 0.05, so α/2 = 0 .025, and 1 − α/2 = 0 .975. Referring to Table 4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u208')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u208: GeneralStatistics expression (auto-extracted; see ref)."
