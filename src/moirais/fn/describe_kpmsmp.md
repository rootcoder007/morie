# describe('kpmsmp') — km_simultaneous_band
...
`print(result)` render. See `moirais.fn.describe('kpmsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpmsmp import *
import numpy as np
# See the function signature in fn/kpmsmp.py for argument names.
```
