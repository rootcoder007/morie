...
__all__ = ["hedderich_chapter_9_unnumbered_2670"]


def hedderich_chapter_9_unnumbered_2670(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: lower triangle: α = 0.05; lower number: Power = 0.8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2670')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2670: PowerAndDesign expression (auto-extracted; see ref)."
