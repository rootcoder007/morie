...
`print(result)` render. See `moirais.fn.describe('hslin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hslin import *
import numpy as np
# See the function signature in fn/hslin.py for argument names.
```
