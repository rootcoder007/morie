...
`print(result)` render. See `moirais.fn.describe('trreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trreg import *
import numpy as np
# See the function signature in fn/trreg.py for argument names.
```
