# describe('sthet') — spacetime_heterogeneity
...
`print(result)` render. See `moirais.fn.describe('sthet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sthet import *
import numpy as np
# See the function signature in fn/sthet.py for argument names.
```
