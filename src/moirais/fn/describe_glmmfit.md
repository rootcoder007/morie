...
`print(result)` render. See `moirais.fn.describe('glmmfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmfit import *
import numpy as np
# See the function signature in fn/glmmfit.py for argument names.
```
