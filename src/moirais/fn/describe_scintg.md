# describe('scintg') — singlecell_integration
...
`print(result)` render. See `moirais.fn.describe('scintg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scintg import *
import numpy as np
# See the function signature in fn/scintg.py for argument names.
```
