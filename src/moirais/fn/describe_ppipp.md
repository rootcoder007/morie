...
`print(result)` render. See `moirais.fn.describe('ppipp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppipp import *
import numpy as np
# See the function signature in fn/ppipp.py for argument names.
```
