...
__all__ = ["hedderich_chapter_9_unnumbered_92"]


def hedderich_chapter_9_unnumbered_92(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The eigenvaluesλi (i = 1,..., n) of A result from the solution of the characteristic polynomial|A−λI|= 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u92')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u92: GeneralStatistics expression (auto-extracted; see ref)."
