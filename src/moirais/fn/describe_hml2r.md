# describe('hml2r') — geron_l2_regularization
...
`print(result)` render. See `moirais.fn.describe('hml2r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hml2r import *
import numpy as np
# See the function signature in fn/hml2r.py for argument names.
```
