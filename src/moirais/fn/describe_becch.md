...
`print(result)` render. See `moirais.fn.describe('becch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.becch import *
import numpy as np
# See the function signature in fn/becch.py for argument names.
```
