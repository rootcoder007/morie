...
`print(result)` render. See `moirais.fn.describe('pcfsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcfsp import *
import numpy as np
# See the function signature in fn/pcfsp.py for argument names.
```
