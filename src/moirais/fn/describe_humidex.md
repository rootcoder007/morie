...
`print(result)` render. See `moirais.fn.describe('humidex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.humidex import *
import numpy as np
# See the function signature in fn/humidex.py for argument names.
```
