...
__all__ = ["hedderich_chapter_9_unnumbered_920"]


def hedderich_chapter_9_unnumbered_920(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u920')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u920: GeneralStatistics expression (auto-extracted; see ref)."
