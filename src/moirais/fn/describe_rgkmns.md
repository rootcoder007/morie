# describe('rgkmns') — rangayyan_kmeans
...
`print(result)` render. See `moirais.fn.describe('rgkmns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkmns import *
import numpy as np
# See the function signature in fn/rgkmns.py for argument names.
```
