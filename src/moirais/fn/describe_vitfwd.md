...
`print(result)` render. See `moirais.fn.describe('vitfwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitfwd import *
import numpy as np
# See the function signature in fn/vitfwd.py for argument names.
```
