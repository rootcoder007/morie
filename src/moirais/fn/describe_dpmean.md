...
`print(result)` render. See `moirais.fn.describe('dpmean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmean import *
import numpy as np
# See the function signature in fn/dpmean.py for argument names.
```
