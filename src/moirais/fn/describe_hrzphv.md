# describe('hrzphv') — horowitz_ph_heterogeneity
...
`print(result)` render. See `moirais.fn.describe('hrzphv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzphv import *
import numpy as np
# See the function signature in fn/hrzphv.py for argument names.
```
