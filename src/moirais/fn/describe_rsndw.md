...
`print(result)` render. See `moirais.fn.describe('rsndw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsndw import *
import numpy as np
# See the function signature in fn/rsndw.py for argument names.
```
