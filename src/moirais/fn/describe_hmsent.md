# describe('hmsent') — geron_sentiment_analysis
...
`print(result)` render. See `moirais.fn.describe('hmsent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsent import *
import numpy as np
# See the function signature in fn/hmsent.py for argument names.
```
