# describe('rgdnot') — rangayyan_dicrotic_notch
...
`print(result)` render. See `moirais.fn.describe('rgdnot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdnot import *
import numpy as np
# See the function signature in fn/rgdnot.py for argument names.
```
