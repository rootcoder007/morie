...
`print(result)` render. See `moirais.fn.describe('rulfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rulfd import *
import numpy as np
# See the function signature in fn/rulfd.py for argument names.
```
