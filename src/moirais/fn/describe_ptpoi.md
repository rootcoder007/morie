# describe('ptpoi') — poisson_process
...
`print(result)` render. See `moirais.fn.describe('ptpoi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptpoi import *
import numpy as np
# See the function signature in fn/ptpoi.py for argument names.
```
