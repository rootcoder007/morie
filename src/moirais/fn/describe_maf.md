# describe('maf') — minor_allele_frequency
...
`print(result)` render. See `moirais.fn.describe('maf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maf import *
import numpy as np
# See the function signature in fn/maf.py for argument names.
```
