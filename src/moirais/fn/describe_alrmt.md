# describe('alrmt') — alammar_reward_model_training_bt
...
`print(result)` render. See `moirais.fn.describe('alrmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrmt import *
import numpy as np
# See the function signature in fn/alrmt.py for argument names.
```
