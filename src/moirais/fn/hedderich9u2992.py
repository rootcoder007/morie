...
__all__ = ["hedderich_chapter_9_unnumbered_2992"]


def hedderich_chapter_9_unnumbered_2992(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: V = 0 ⇔χ2 = 0 ⇔X,Y stochastically independent,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2992')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2992: ContingencyTables expression (auto-extracted; see ref)."
