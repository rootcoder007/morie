...
__all__ = ["hedderich_chapter_9_unnumbered_1701"]


def hedderich_chapter_9_unnumbered_1701(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆχ2=(1·302)−30=870] . For more details and critical limits, see Zahn and Roberts [ZR71].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1701')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1701: GeneralStatistics expression (auto-extracted; see ref)."
