...
`print(result)` render. See `moirais.fn.describe('sosom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosom import *
import numpy as np
# See the function signature in fn/sosom.py for argument names.
```
