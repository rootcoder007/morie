...
`print(result)` render. See `moirais.fn.describe('grauc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grauc import *
import numpy as np
# See the function signature in fn/grauc.py for argument names.
```
