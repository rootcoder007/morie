...
`print(result)` render. See `moirais.fn.describe('mtflw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtflw import *
import numpy as np
# See the function signature in fn/mtflw.py for argument names.
```
