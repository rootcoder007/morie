...
`print(result)` render. See `moirais.fn.describe('loo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.loo import *
import numpy as np
# See the function signature in fn/loo.py for argument names.
```
