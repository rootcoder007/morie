...
`print(result)` render. See `moirais.fn.describe('sppaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppaic import *
import numpy as np
# See the function signature in fn/sppaic.py for argument names.
```
