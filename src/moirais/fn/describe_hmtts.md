# describe('hmtts') — geron_train_test_split
...
`print(result)` render. See `moirais.fn.describe('hmtts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtts import *
import numpy as np
# See the function signature in fn/hmtts.py for argument names.
```
