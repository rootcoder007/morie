...
`print(result)` render. See `moirais.fn.describe('mirmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mirmf import *
import numpy as np
# See the function signature in fn/mirmf.py for argument names.
```
