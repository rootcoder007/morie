...
`print(result)` render. See `moirais.fn.describe('tmodu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmodu import *
import numpy as np
# See the function signature in fn/tmodu.py for argument names.
```
