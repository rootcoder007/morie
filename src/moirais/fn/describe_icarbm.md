...
`print(result)` render. See `moirais.fn.describe('icarbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icarbm import *
import numpy as np
# See the function signature in fn/icarbm.py for argument names.
```
