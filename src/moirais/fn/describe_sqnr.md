# describe('sqnr') — signal_quant_noise_ratio
...
`print(result)` render. See `moirais.fn.describe('sqnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqnr import *
import numpy as np
# See the function signature in fn/sqnr.py for argument names.
```
