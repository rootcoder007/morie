# describe('hmint8') — geron_int8_quant
...
`print(result)` render. See `moirais.fn.describe('hmint8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmint8 import *
import numpy as np
# See the function signature in fn/hmint8.py for argument names.
```
