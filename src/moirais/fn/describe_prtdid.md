...
`print(result)` render. See `moirais.fn.describe('prtdid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prtdid import *
import numpy as np
# See the function signature in fn/prtdid.py for argument names.
```
