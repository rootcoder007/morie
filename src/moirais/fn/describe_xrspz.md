...
`print(result)` render. See `moirais.fn.describe('xrspz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspz import *
import numpy as np
# See the function signature in fn/xrspz.py for argument names.
```
