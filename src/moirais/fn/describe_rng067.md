# describe('rng067') — rangayyan_ch3_dtft
...
`print(result)` render. See `moirais.fn.describe('rng067')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng067 import *
import numpy as np
# See the function signature in fn/rng067.py for argument names.
```
