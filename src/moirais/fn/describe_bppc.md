...
`print(result)` render. See `moirais.fn.describe('bppc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bppc import *
import numpy as np
# See the function signature in fn/bppc.py for argument names.
```
