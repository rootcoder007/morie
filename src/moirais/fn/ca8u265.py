...
def ca_chapter_8_unnumbered_265(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8u265')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "PowerAndDesign expression involving 'error' (auto-extracted; see reference for full context)."},
    )
