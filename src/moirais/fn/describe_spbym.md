# describe('spbym') — schabenberger_bym_model
...
`print(result)` render. See `moirais.fn.describe('spbym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spbym import *
import numpy as np
# See the function signature in fn/spbym.py for argument names.
```
