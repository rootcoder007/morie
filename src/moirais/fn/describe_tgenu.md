...
`print(result)` render. See `moirais.fn.describe('tgenu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgenu import *
import numpy as np
# See the function signature in fn/tgenu.py for argument names.
```
