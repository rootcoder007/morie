...
__all__ = ["hedderich_chapter_9_unnumbered_3106"]


def hedderich_chapter_9_unnumbered_3106(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (1−r2)(1−ϱ2) withν=n−2 (7.393)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3106')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3106: GeneralStatistics expression (auto-extracted; see ref)."
