...
__all__ = ["hedderich_chapter_9_unnumbered_2517"]


def hedderich_chapter_9_unnumbered_2517(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] −3·4·(3 + 1) = 3.5< 6.5 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2517')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2517: GeneralStatistics expression (auto-extracted; see ref)."
