...
`print(result)` render. See `moirais.fn.describe('dwnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwnsp import *
import numpy as np
# See the function signature in fn/dwnsp.py for argument names.
```
