# describe('aitsbc') — aitchison_subcomposition
...
`print(result)` render. See `moirais.fn.describe('aitsbc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitsbc import *
import numpy as np
# See the function signature in fn/aitsbc.py for argument names.
```
