...
def ca_chapter_11_equation_1(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca11e1')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Dispersion expression involving 'standardized' (auto-extracted; see reference for full context)."},
    )
