# describe('midor') — model_identify_estimate_refute
...
`print(result)` render. See `moirais.fn.describe('midor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.midor import *
import numpy as np
# See the function signature in fn/midor.py for argument names.
```
