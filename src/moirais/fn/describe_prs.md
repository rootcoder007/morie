# describe('prs') — polygenic_risk_score
...
`print(result)` render. See `moirais.fn.describe('prs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prs import *
import numpy as np
# See the function signature in fn/prs.py for argument names.
```
