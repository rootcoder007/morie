...
__all__ = ["wilcox_chapter_14_unnumbered_462"]


def wilcox_chapter_14_unnumbered_462(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: pwr.r.test(n = NULL, r = NULL, sig.level = 0.05, power = NULL, alternative =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u462')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u462: PowerAndDesign expression (auto-extracted; see ref)."
