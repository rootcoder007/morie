...
`print(result)` render. See `moirais.fn.describe('ctomeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctomeg import *
import numpy as np
# See the function signature in fn/ctomeg.py for argument names.
```
