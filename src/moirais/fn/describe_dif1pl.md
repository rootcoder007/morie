# describe('dif1pl') — dif_mantel_haenszel
...
`print(result)` render. See `moirais.fn.describe('dif1pl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dif1pl import *
import numpy as np
# See the function signature in fn/dif1pl.py for argument names.
```
