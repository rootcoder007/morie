# describe('sgtbn') — turning_bands_sim
...
`print(result)` render. See `moirais.fn.describe('sgtbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtbn import *
import numpy as np
# See the function signature in fn/sgtbn.py for argument names.
```
