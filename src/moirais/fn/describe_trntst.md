# describe('trntst') — transportability_test
...
`print(result)` render. See `moirais.fn.describe('trntst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trntst import *
import numpy as np
# See the function signature in fn/trntst.py for argument names.
```
