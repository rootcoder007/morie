# describe('rgmurm') — rangayyan_murmur_analysis
...
`print(result)` render. See `moirais.fn.describe('rgmurm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmurm import *
import numpy as np
# See the function signature in fn/rgmurm.py for argument names.
```
