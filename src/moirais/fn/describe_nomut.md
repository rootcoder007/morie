# describe('nomut') — nominate_utility
...
`print(result)` render. See `moirais.fn.describe('nomut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nomut import *
import numpy as np
# See the function signature in fn/nomut.py for argument names.
```
