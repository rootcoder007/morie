# describe('prcpl') — precision_recall_curve
...
`print(result)` render. See `moirais.fn.describe('prcpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prcpl import *
import numpy as np
# See the function signature in fn/prcpl.py for argument names.
```
