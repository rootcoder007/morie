# describe('poltrx') — polya_tree_extended
...
`print(result)` render. See `moirais.fn.describe('poltrx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poltrx import *
import numpy as np
# See the function signature in fn/poltrx.py for argument names.
```
