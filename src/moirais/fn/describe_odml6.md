# describe('odml6') — otis_dml_custody

## WHAT IT DOES

DML: custody type effect on outcome.
...
`print(result)` render. See `moirais.fn.describe('odml6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml6 import *
import numpy as np
# See the function signature in fn/odml6.py for argument names.
```
