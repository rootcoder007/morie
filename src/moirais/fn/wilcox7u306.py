...
__all__ = ["wilcox_chapter_7_unnumbered_306"]


def wilcox_chapter_7_unnumbered_306(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: power.t.test(n = NULL, delta = NULL, sd = 1, sig.level = 0.05, power = NULL,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u306')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u306: PowerAndDesign expression (auto-extracted; see ref)."
