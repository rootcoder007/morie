...
`print(result)` render. See `moirais.fn.describe('spflw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spflw import *
import numpy as np
# See the function signature in fn/spflw.py for argument names.
```
