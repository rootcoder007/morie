# describe('hecea') — cost_effectiveness_plane
...
`print(result)` render. See `moirais.fn.describe('hecea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hecea import *
import numpy as np
# See the function signature in fn/hecea.py for argument names.
```
