# describe('rcaus') — random_cause_refutation
...
`print(result)` render. See `moirais.fn.describe('rcaus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcaus import *
import numpy as np
# See the function signature in fn/rcaus.py for argument names.
```
