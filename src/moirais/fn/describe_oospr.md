...
`print(result)` render. See `moirais.fn.describe('oospr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oospr import *
import numpy as np
# See the function signature in fn/oospr.py for argument names.
```
