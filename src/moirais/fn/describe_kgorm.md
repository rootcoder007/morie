...
`print(result)` render. See `moirais.fn.describe('kgorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgorm import *
import numpy as np
# See the function signature in fn/kgorm.py for argument names.
```
