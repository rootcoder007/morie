...
__all__ = ["hedderich_chapter_9_unnumbered_2898"]


def hedderich_chapter_9_unnumbered_2898(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] πi =α+βxi (7.340)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2898')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2898: CountModels expression (auto-extracted; see ref)."
