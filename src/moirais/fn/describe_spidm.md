# describe('spidm') — web_graph_communities
...
`print(result)` render. See `moirais.fn.describe('spidm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spidm import *
import numpy as np
# See the function signature in fn/spidm.py for argument names.
```
