# describe('facov') — factor_analytic_covariance
...
`print(result)` render. See `moirais.fn.describe('facov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.facov import *
import numpy as np
# See the function signature in fn/facov.py for argument names.
```
