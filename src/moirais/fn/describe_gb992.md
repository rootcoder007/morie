# describe('gb992') — gibbons_fligner_killeen
...
`print(result)` render. See `moirais.fn.describe('gb992')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb992 import *
import numpy as np
# See the function signature in fn/gb992.py for argument names.
```
