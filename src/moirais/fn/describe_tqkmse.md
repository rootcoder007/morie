# describe('tqkmse') — turboquant_kv_mse
...
`print(result)` render. See `moirais.fn.describe('tqkmse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqkmse import *
import numpy as np
# See the function signature in fn/tqkmse.py for argument names.
```
