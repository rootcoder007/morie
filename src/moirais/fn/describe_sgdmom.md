...
`print(result)` render. See `moirais.fn.describe('sgdmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdmom import *
import numpy as np
# See the function signature in fn/sgdmom.py for argument names.
```
