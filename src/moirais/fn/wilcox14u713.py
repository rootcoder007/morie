...
__all__ = ["wilcox_chapter_14_unnumbered_713"]


def wilcox_chapter_14_unnumbered_713(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: δ 12 =θ 1 − θ 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u713')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u713: GeneralStatistics expression (auto-extracted; see ref)."
