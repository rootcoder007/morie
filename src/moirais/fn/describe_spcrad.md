# describe('spcrad') — spectral_radius
...
`print(result)` render. See `moirais.fn.describe('spcrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcrad import *
import numpy as np
# See the function signature in fn/spcrad.py for argument names.
```
