...
`print(result)` render. See `moirais.fn.describe('wqchl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqchl import *
import numpy as np
# See the function signature in fn/wqchl.py for argument names.
```
