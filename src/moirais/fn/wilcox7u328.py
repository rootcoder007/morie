...
__all__ = ["wilcox_chapter_7_unnumbered_328"]


def wilcox_chapter_7_unnumbered_328(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The example at the end of Section 5.3 used Student’s T to test H0:µ = 25 with α = 0.05,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u328')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u328: GeneralStatistics expression (auto-extracted; see ref)."
