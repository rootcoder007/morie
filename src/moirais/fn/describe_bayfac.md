...
`print(result)` render. See `moirais.fn.describe('bayfac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayfac import *
import numpy as np
# See the function signature in fn/bayfac.py for argument names.
```
