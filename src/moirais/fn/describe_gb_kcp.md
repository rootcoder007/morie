# describe('gb_kcp') — gibbons_ks_conf_band
...
`print(result)` render. See `moirais.fn.describe('gb_kcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_kcp import *
import numpy as np
# See the function signature in fn/gb_kcp.py for argument names.
```
