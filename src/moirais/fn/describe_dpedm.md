...
`print(result)` render. See `moirais.fn.describe('dpedm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpedm import *
import numpy as np
# See the function signature in fn/dpedm.py for argument names.
```
