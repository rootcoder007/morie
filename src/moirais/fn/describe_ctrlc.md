# describe('ctrlc') — control_comparison
...
`print(result)` render. See `moirais.fn.describe('ctrlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctrlc import *
import numpy as np
# See the function signature in fn/ctrlc.py for argument names.
```
