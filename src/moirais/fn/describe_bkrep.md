# describe('bkrep') — burkov_repetition_penalty
...
`print(result)` render. See `moirais.fn.describe('bkrep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkrep import *
import numpy as np
# See the function signature in fn/bkrep.py for argument names.
```
