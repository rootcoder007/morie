# describe('sstrlf') — surv_truncation_left
...
`print(result)` render. See `moirais.fn.describe('sstrlf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sstrlf import *
import numpy as np
# See the function signature in fn/sstrlf.py for argument names.
```
