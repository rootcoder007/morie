# describe('wghtm') — weighted_euclidean_model
...
`print(result)` render. See `moirais.fn.describe('wghtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wghtm import *
import numpy as np
# See the function signature in fn/wghtm.py for argument names.
```
