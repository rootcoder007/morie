...
`print(result)` render. See `moirais.fn.describe('igamma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igamma import *
import numpy as np
# See the function signature in fn/igamma.py for argument names.
```
