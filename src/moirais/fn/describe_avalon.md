# describe('avalon') — avalon_fingerprint
...
`print(result)` render. See `moirais.fn.describe('avalon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avalon import *
import numpy as np
# See the function signature in fn/avalon.py for argument names.
```
