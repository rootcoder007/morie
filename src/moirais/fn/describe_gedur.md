...
`print(result)` render. See `moirais.fn.describe('gedur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gedur import *
import numpy as np
# See the function signature in fn/gedur.py for argument names.
```
