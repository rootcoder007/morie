# describe('bbstr') — bayesian_bootstrap
...
`print(result)` render. See `moirais.fn.describe('bbstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbstr import *
import numpy as np
# See the function signature in fn/bbstr.py for argument names.
```
