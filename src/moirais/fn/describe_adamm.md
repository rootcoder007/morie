...
`print(result)` render. See `moirais.fn.describe('adamm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adamm import *
import numpy as np
# See the function signature in fn/adamm.py for argument names.
```
