...
`print(result)` render. See `moirais.fn.describe('rskov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskov import *
import numpy as np
# See the function signature in fn/rskov.py for argument names.
```
