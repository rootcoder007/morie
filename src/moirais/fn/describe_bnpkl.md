...
`print(result)` render. See `moirais.fn.describe('bnpkl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnpkl import *
import numpy as np
# See the function signature in fn/bnpkl.py for argument names.
```
