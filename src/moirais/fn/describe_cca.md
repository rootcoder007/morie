# describe('cca') — canonical_correlation
...
`print(result)` render. See `moirais.fn.describe('cca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cca import *
import numpy as np
# See the function signature in fn/cca.py for argument names.
```
