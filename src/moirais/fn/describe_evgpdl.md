# describe('evgpdl') — evt_gpd_loglik
...
`print(result)` render. See `moirais.fn.describe('evgpdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdl import *
import numpy as np
# See the function signature in fn/evgpdl.py for argument names.
```
