...
`print(result)` render. See `moirais.fn.describe('wvber')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvber import *
import numpy as np
# See the function signature in fn/wvber.py for argument names.
```
