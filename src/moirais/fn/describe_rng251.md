# describe('rng251') — rangayyan_ch4_log_echo_power_series_expansion
...
`print(result)` render. See `moirais.fn.describe('rng251')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng251 import *
import numpy as np
# See the function signature in fn/rng251.py for argument names.
```
