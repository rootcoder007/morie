...
`print(result)` render. See `moirais.fn.describe('ppmrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmrk import *
import numpy as np
# See the function signature in fn/ppmrk.py for argument names.
```
