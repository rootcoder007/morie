...
__all__ = ["hedderich_chapter_9_unnumbered_2123"]


def hedderich_chapter_9_unnumbered_2123(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 11 < 15 = U (8.8; 0.05; one-sided test) (Table 7.24), the null hypothesis µA≤µB is rejected
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2123')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2123: GeneralStatistics expression (auto-extracted; see ref)."
