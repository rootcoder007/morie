...
`print(result)` render. See `moirais.fn.describe('adfTst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adfTst import *
import numpy as np
# See the function signature in fn/adfTst.py for argument names.
```
