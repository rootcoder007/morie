# describe('sglnk') — lognormal_kriging
...
`print(result)` render. See `moirais.fn.describe('sglnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglnk import *
import numpy as np
# See the function signature in fn/sglnk.py for argument names.
```
