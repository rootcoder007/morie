...
__all__ = ["hedderich_chapter_9_unnumbered_2470"]


def hedderich_chapter_9_unnumbered_2470(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |¯Ri−¯Ri′|> q∞;k;0.95√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2470')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2470: GeneralStatistics expression (auto-extracted; see ref)."
