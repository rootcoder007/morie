# describe('grgbm') — geron_gradient_boosting_residual
...
`print(result)` render. See `moirais.fn.describe('grgbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgbm import *
import numpy as np
# See the function signature in fn/grgbm.py for argument names.
```
