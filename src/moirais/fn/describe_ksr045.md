# describe('ksr045') — kosorok_ch2_functional_delta_bootstrap
...
`print(result)` render. See `moirais.fn.describe('ksr045')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr045 import *
import numpy as np
# See the function signature in fn/ksr045.py for argument names.
```
