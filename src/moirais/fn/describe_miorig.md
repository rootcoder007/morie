...
`print(result)` render. See `moirais.fn.describe('miorig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miorig import *
import numpy as np
# See the function signature in fn/miorig.py for argument names.
```
