...
`print(result)` render. See `moirais.fn.describe('uminc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.uminc import *
import numpy as np
# See the function signature in fn/uminc.py for argument names.
```
