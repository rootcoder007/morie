...
`print(result)` render. See `moirais.fn.describe('rngnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rngnrm import *
import numpy as np
# See the function signature in fn/rngnrm.py for argument names.
```
