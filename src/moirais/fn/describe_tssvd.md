...
`print(result)` render. See `moirais.fn.describe('tssvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssvd import *
import numpy as np
# See the function signature in fn/tssvd.py for argument names.
```
