...
`print(result)` render. See `moirais.fn.describe('abpes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpes import *
import numpy as np
# See the function signature in fn/abpes.py for argument names.
```
