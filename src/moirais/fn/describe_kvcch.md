# describe('kvcch') — kvcch

## WHAT IT DOES

rKV-cache for autoregressive generation.
...
`print(result)` render. See `moirais.fn.describe('kvcch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kvcch import *
import numpy as np
# See the function signature in fn/kvcch.py for argument names.
```
