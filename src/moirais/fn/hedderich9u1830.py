...
__all__ = ["hedderich_chapter_9_unnumbered_1830"]


def hedderich_chapter_9_unnumbered_1830(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + type =" one . sample " , alternative =" one . sided " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1830')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1830: PowerAndDesign expression (auto-extracted; see ref)."
