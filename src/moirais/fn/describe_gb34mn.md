# describe('gb34mn') — gibbons_runs_ud_mean
...
`print(result)` render. See `moirais.fn.describe('gb34mn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb34mn import *
import numpy as np
# See the function signature in fn/gb34mn.py for argument names.
```
