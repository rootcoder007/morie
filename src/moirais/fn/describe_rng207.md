# describe('rng207') — rangayyan_ch4_matched_filter_input_ft
...
`print(result)` render. See `moirais.fn.describe('rng207')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng207 import *
import numpy as np
# See the function signature in fn/rng207.py for argument names.
```
