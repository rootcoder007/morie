...
`print(result)` render. See `moirais.fn.describe('ppbor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppbor import *
import numpy as np
# See the function signature in fn/ppbor.py for argument names.
```
