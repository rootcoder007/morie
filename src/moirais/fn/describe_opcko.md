# describe('opcko') — opcko

## WHAT IT DOES

Cuckoo search spatial
...
`print(result)` render. See `moirais.fn.describe('opcko')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opcko import *
import numpy as np
# See the function signature in fn/opcko.py for argument names.
```
