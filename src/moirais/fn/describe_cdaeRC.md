...
`print(result)` render. See `moirais.fn.describe('cdaeRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdaeRC import *
import numpy as np
# See the function signature in fn/cdaeRC.py for argument names.
```
