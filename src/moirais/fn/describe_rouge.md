...
`print(result)` render. See `moirais.fn.describe('rouge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rouge import *
import numpy as np
# See the function signature in fn/rouge.py for argument names.
```
