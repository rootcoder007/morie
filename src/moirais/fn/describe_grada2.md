# describe('grada2') — geron_adagrad_update
...
`print(result)` render. See `moirais.fn.describe('grada2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grada2 import *
import numpy as np
# See the function signature in fn/grada2.py for argument names.
```
