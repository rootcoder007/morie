...
__all__ = ["hedderich_chapter_9_unnumbered_2213"]


def hedderich_chapter_9_unnumbered_2213(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 4n(n−1) = n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2213')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2213: PowerAndDesign expression (auto-extracted; see ref)."
