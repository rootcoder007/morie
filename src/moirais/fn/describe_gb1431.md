# describe('gb1431') — gibbons_k2_contingency
...
`print(result)` render. See `moirais.fn.describe('gb1431')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1431 import *
import numpy as np
# See the function signature in fn/gb1431.py for argument names.
```
