...
`print(result)` render. See `moirais.fn.describe('segrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.segrf import *
import numpy as np
# See the function signature in fn/segrf.py for argument names.
```
