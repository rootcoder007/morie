# describe('rgapn') — rangayyan_approximate_entropy
...
`print(result)` render. See `moirais.fn.describe('rgapn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgapn import *
import numpy as np
# See the function signature in fn/rgapn.py for argument names.
```
