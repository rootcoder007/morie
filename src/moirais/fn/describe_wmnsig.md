# describe('wmnsig') — weighted_mean_test
...
`print(result)` render. See `moirais.fn.describe('wmnsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wmnsig import *
import numpy as np
# See the function signature in fn/wmnsig.py for argument names.
```
