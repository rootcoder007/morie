...
`print(result)` render. See `moirais.fn.describe('opabc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opabc import *
import numpy as np
# See the function signature in fn/opabc.py for argument names.
```
