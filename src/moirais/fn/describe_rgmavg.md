# describe('rgmavg') — rangayyan_moving_average
...
`print(result)` render. See `moirais.fn.describe('rgmavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmavg import *
import numpy as np
# See the function signature in fn/rgmavg.py for argument names.
```
