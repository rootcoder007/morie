# describe('vaces') — vaccine_efficacy_exact
...
`print(result)` render. See `moirais.fn.describe('vaces')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaces import *
import numpy as np
# See the function signature in fn/vaces.py for argument names.
```
