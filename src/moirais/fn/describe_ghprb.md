...
`print(result)` render. See `moirais.fn.describe('ghprb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghprb import *
import numpy as np
# See the function signature in fn/ghprb.py for argument names.
```
