...
`print(result)` render. See `moirais.fn.describe('dtwrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtwrn import *
import numpy as np
# See the function signature in fn/dtwrn.py for argument names.
```
