# describe('tmlmpi') — tmle_marginal_pim
...
`print(result)` render. See `moirais.fn.describe('tmlmpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmpi import *
import numpy as np
# See the function signature in fn/tmlmpi.py for argument names.
```
