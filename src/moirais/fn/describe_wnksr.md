...
`print(result)` render. See `moirais.fn.describe('wnksr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnksr import *
import numpy as np
# See the function signature in fn/wnksr.py for argument names.
```
