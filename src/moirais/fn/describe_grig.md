# describe('grig') — geron_information_gain
...
`print(result)` render. See `moirais.fn.describe('grig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grig import *
import numpy as np
# See the function signature in fn/grig.py for argument names.
```
