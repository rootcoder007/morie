# describe('clfrt') — classification_rate
...
`print(result)` render. See `moirais.fn.describe('clfrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clfrt import *
import numpy as np
# See the function signature in fn/clfrt.py for argument names.
```
