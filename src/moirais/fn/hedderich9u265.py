...
__all__ = ["hedderich_chapter_9_unnumbered_265"]


def hedderich_chapter_9_unnumbered_265(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: result fromb≈(xmax−xmin)/(1 + 3.32·lg (n)). For the example of BMI values withn = 60,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u265')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u265: GeneralStatistics expression (auto-extracted; see ref)."
