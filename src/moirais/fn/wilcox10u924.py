...
__all__ = ["wilcox_chapter_10_unnumbered_924"]


def wilcox_chapter_10_unnumbered_924(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If you haveJ = 4 groups and you plan to perform all pairwise comparisons, C = (4 2 − 4)/2 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u924')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u924: GeneralStatistics expression (auto-extracted; see ref)."
