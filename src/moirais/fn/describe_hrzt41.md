# describe('hrzt41') — horowitz_thm4_1_id_median
...
`print(result)` render. See `moirais.fn.describe('hrzt41')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzt41 import *
import numpy as np
# See the function signature in fn/hrzt41.py for argument names.
```
