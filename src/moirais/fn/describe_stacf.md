# describe('stacf') — st_autocorrelation
...
`print(result)` render. See `moirais.fn.describe('stacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stacf import *
import numpy as np
# See the function signature in fn/stacf.py for argument names.
```
