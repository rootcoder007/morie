# describe('prdmed') — product_of_coefficients
...
`print(result)` render. See `moirais.fn.describe('prdmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdmed import *
import numpy as np
# See the function signature in fn/prdmed.py for argument names.
```
