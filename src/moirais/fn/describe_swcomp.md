...
`print(result)` render. See `moirais.fn.describe('swcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swcomp import *
import numpy as np
# See the function signature in fn/swcomp.py for argument names.
```
