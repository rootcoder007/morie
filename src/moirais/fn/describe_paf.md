# describe('paf') — population_attributable_fraction
...
`print(result)` render. See `moirais.fn.describe('paf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paf import *
import numpy as np
# See the function signature in fn/paf.py for argument names.
```
