...
`print(result)` render. See `moirais.fn.describe('vctrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vctrs import *
import numpy as np
# See the function signature in fn/vctrs.py for argument names.
```
