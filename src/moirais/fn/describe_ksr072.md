# describe('ksr072'The happiness of your life depends upon the quality of your thoughts. — Marcus Aurelius's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('ksr072')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr072 import *
import numpy as np
# See the function signature in fn/ksr072.py for argument names.
```
