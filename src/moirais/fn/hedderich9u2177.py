...
__all__ = ["hedderich_chapter_9_unnumbered_2177"]


def hedderich_chapter_9_unnumbered_2177(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] k = 1 +Rn;0.05;two−sided (7.152)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2177')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2177: GeneralStatistics expression (auto-extracted; see ref)."
