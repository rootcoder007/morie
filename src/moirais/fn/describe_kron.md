# describe('kron') — kronecker_product
...
`print(result)` render. See `moirais.fn.describe('kron')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kron import *
import numpy as np
# See the function signature in fn/kron.py for argument names.
```
