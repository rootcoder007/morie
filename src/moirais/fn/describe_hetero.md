...
`print(result)` render. See `moirais.fn.describe('hetero')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hetero import *
import numpy as np
# See the function signature in fn/hetero.py for argument names.
```
