...
`print(result)` render. See `moirais.fn.describe('agpat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agpat import *
import numpy as np
# See the function signature in fn/agpat.py for argument names.
```
