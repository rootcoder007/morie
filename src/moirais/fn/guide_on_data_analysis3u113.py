...
__all__ = ["guide_on_data_analysis_chapter_3_unnumbered_113"]


def guide_on_data_analysis_chapter_3_unnumbered_113(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> A = 0.57968, p-value = 0.1207
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis3u113')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u113: GeneralStatistics expression (auto-extracted; see ref)."
