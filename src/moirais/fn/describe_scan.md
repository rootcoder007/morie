...
`print(result)` render. See `moirais.fn.describe('scan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scan import *
import numpy as np
# See the function signature in fn/scan.py for argument names.
```
