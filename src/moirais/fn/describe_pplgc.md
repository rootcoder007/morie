...
`print(result)` render. See `moirais.fn.describe('pplgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pplgc import *
import numpy as np
# See the function signature in fn/pplgc.py for argument names.
```
