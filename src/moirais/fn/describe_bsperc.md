...
`print(result)` render. See `moirais.fn.describe('bsperc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsperc import *
import numpy as np
# See the function signature in fn/bsperc.py for argument names.
```
