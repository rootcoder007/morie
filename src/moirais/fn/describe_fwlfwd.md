# describe('fwlfwd') — fully_corrective_fw
...
`print(result)` render. See `moirais.fn.describe('fwlfwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fwlfwd import *
import numpy as np
# See the function signature in fn/fwlfwd.py for argument names.
```
