...
__all__ = ["wilcox_chapter_4_unnumbered_19"]


def wilcox_chapter_4_unnumbered_19(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] IQR = 4.45 − (−17 .9) = 22.35.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u19')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u19: GeneralStatistics expression (auto-extracted; see ref)."
