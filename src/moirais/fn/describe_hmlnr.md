# describe('hmlnr') — geron_layer_norm_rnn
...
`print(result)` render. See `moirais.fn.describe('hmlnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlnr import *
import numpy as np
# See the function signature in fn/hmlnr.py for argument names.
```
