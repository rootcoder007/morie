...
__all__ = ["hedderich_chapter_9_unnumbered_132"]


def hedderich_chapter_9_unnumbered_132(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] = (2n−1)![n!(n−1)!] (2.81)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u132')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u132: Resampling expression (auto-extracted; see ref)."
