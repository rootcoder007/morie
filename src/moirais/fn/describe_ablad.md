...
`print(result)` render. See `moirais.fn.describe('ablad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ablad import *
import numpy as np
# See the function signature in fn/ablad.py for argument names.
```
