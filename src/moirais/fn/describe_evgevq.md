# describe('evgevq') — evt_gev_quantile
...
`print(result)` render. See `moirais.fn.describe('evgevq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevq import *
import numpy as np
# See the function signature in fn/evgevq.py for argument names.
```
