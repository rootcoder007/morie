# describe('msm087') — mvsml_bayesian_regression_pt2_eq_7_1
...
`print(result)` render. See `moirais.fn.describe('msm087')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm087 import *
import numpy as np
# See the function signature in fn/msm087.py for argument names.
```
