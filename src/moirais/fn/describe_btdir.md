# describe('btdir') — boot_dirichlet_weights
...
`print(result)` render. See `moirais.fn.describe('btdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btdir import *
import numpy as np
# See the function signature in fn/btdir.py for argument names.
```
