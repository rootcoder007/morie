# describe('gb631a') — gibbons_ks2_asymp
...
`print(result)` render. See `moirais.fn.describe('gb631a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb631a import *
import numpy as np
# See the function signature in fn/gb631a.py for argument names.
```
