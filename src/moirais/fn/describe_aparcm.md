...
`print(result)` render. See `moirais.fn.describe('aparcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aparcm import *
import numpy as np
# See the function signature in fn/aparcm.py for argument names.
```
