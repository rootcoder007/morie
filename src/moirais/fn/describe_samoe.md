...
`print(result)` render. See `moirais.fn.describe('samoe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samoe import *
import numpy as np
# See the function signature in fn/samoe.py for argument names.
```
