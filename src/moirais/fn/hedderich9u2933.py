...
__all__ = ["hedderich_chapter_9_unnumbered_2933"]


def hedderich_chapter_9_unnumbered_2933(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2933')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2933: CountModels expression (auto-extracted; see ref)."
