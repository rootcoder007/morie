...
__all__ = ["hedderich_chapter_9_unnumbered_2934"]


def hedderich_chapter_9_unnumbered_2934(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( d i r== " greater " ) result <− s . pelse
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2934')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2934: GeneralStatistics expression (auto-extracted; see ref)."
