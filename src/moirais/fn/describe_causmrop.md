# describe('causmrop') — causal_robins_g_formula
...
`print(result)` render. See `moirais.fn.describe('causmrop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmrop import *
import numpy as np
# See the function signature in fn/causmrop.py for argument names.
```
