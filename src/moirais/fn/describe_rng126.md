# describe('rng126') — rangayyan_ch3_butterworth_analog_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng126')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng126 import *
import numpy as np
# See the function signature in fn/rng126.py for argument names.
```
