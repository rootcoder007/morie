...
`print(result)` render. See `moirais.fn.describe('tfdft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tfdft import *
import numpy as np
# See the function signature in fn/tfdft.py for argument names.
```
