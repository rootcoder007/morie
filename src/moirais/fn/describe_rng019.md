# describe('rng019') — rangayyan_ch3_time_average_mean
...
`print(result)` render. See `moirais.fn.describe('rng019')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng019 import *
import numpy as np
# See the function signature in fn/rng019.py for argument names.
```
