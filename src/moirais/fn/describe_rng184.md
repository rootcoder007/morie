# describe('rng184') — rangayyan_ch4_pan_tompkins_highpass_lp_difference_eq
...
`print(result)` render. See `moirais.fn.describe('rng184')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng184 import *
import numpy as np
# See the function signature in fn/rng184.py for argument names.
```
