# describe('hmkppl') — geron_kernel_pca_poly
...
`print(result)` render. See `moirais.fn.describe('hmkppl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkppl import *
import numpy as np
# See the function signature in fn/hmkppl.py for argument names.
```
