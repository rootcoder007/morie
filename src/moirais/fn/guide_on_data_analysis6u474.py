...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_474"]


def guide_on_data_analysis_chapter_6_unnumbered_474(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜌𝑗 = 𝑄(̂𝜃(𝑗)) − 𝑄(̂𝜃(𝑗)+ 𝛿)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u474')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u474: GeneralStatistics expression (auto-extracted; see ref)."
