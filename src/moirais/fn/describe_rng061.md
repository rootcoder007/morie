# describe('rng061') — rangayyan_ch3_magnitude_response_from_pole_zero
...
`print(result)` render. See `moirais.fn.describe('rng061')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng061 import *
import numpy as np
# See the function signature in fn/rng061.py for argument names.
```
