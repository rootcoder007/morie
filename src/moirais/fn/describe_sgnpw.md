# describe('sgnpw') — sign_test_power
...
`print(result)` render. See `moirais.fn.describe('sgnpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnpw import *
import numpy as np
# See the function signature in fn/sgnpw.py for argument names.
```
