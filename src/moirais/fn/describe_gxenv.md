...
`print(result)` render. See `moirais.fn.describe('gxenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gxenv import *
import numpy as np
# See the function signature in fn/gxenv.py for argument names.
```
