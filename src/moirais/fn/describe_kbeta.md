...
`print(result)` render. See `moirais.fn.describe('kbeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbeta import *
import numpy as np
# See the function signature in fn/kbeta.py for argument names.
```
