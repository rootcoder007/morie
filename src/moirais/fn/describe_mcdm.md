...
`print(result)` render. See `moirais.fn.describe('mcdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcdm import *
import numpy as np
# See the function signature in fn/mcdm.py for argument names.
```
