# describe('odid1') — otis_did_policy
...
`print(result)` render. See `moirais.fn.describe('odid1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odid1 import *
import numpy as np
# See the function signature in fn/odid1.py for argument names.
```
