# describe('casct') — case_control_or
...
`print(result)` render. See `moirais.fn.describe('casct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.casct import *
import numpy as np
# See the function signature in fn/casct.py for argument names.
```
