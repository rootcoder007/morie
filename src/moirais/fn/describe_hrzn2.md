# describe('hrzn2') — horowitz_deconvolution
...
`print(result)` render. See `moirais.fn.describe('hrzn2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzn2 import *
import numpy as np
# See the function signature in fn/hrzn2.py for argument names.
```
