...
`print(result)` render. See `moirais.fn.describe('le')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.le import *
import numpy as np
# See the function signature in fn/le.py for argument names.
```
