...
`print(result)` render. See `moirais.fn.describe('zebym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zebym import *
import numpy as np
# See the function signature in fn/zebym.py for argument names.
```
