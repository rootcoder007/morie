# describe('gwas1') — gwas_single_snp
...
`print(result)` render. See `moirais.fn.describe('gwas1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwas1 import *
import numpy as np
# See the function signature in fn/gwas1.py for argument names.
```
