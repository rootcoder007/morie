...
`print(result)` render. See `moirais.fn.describe('mestm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mestm import *
import numpy as np
# See the function signature in fn/mestm.py for argument names.
```
