...
`print(result)` render. See `moirais.fn.describe('ghmlv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghmlv import *
import numpy as np
# See the function signature in fn/ghmlv.py for argument names.
```
