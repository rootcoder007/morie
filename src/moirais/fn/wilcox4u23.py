...
__all__ = ["wilcox_chapter_4_unnumbered_23"]


def wilcox_chapter_4_unnumbered_23(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u23')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u23: GeneralStatistics expression (auto-extracted; see ref)."
