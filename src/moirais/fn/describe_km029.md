# describe('km029') — kamath_ch2_sbo_loss
...
`print(result)` render. See `moirais.fn.describe('km029')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km029 import *
import numpy as np
# See the function signature in fn/km029.py for argument names.
```
