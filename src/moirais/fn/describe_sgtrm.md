...
`print(result)` render. See `moirais.fn.describe('sgtrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtrm import *
import numpy as np
# See the function signature in fn/sgtrm.py for argument names.
```
