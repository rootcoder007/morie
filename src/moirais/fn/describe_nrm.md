# describe('nrm') — nominal_response_bock
...
`print(result)` render. See `moirais.fn.describe('nrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrm import *
import numpy as np
# See the function signature in fn/nrm.py for argument names.
```
