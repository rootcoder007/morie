# describe('clogp2') — clogp_estimate
...
`print(result)` render. See `moirais.fn.describe('clogp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clogp2 import *
import numpy as np
# See the function signature in fn/clogp2.py for argument names.
```
