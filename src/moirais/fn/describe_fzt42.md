# describe('fzt42') — fauzi_thm4_2_surv2_bias_var
...
`print(result)` render. See `moirais.fn.describe('fzt42')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt42 import *
import numpy as np
# See the function signature in fn/fzt42.py for argument names.
```
