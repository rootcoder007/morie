...
`print(result)` render. See `moirais.fn.describe('vmgmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmgmt import *
import numpy as np
# See the function signature in fn/vmgmt.py for argument names.
```
