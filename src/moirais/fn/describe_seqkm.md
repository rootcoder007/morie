...
`print(result)` render. See `moirais.fn.describe('seqkm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seqkm import *
import numpy as np
# See the function signature in fn/seqkm.py for argument names.
```
