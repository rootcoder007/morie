# describe('slcmx') — slice_sampling_dp_mixture
...
`print(result)` render. See `moirais.fn.describe('slcmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slcmx import *
import numpy as np
# See the function signature in fn/slcmx.py for argument names.
```
