# describe('graut') — geron_autograd_chain_rule
...
`print(result)` render. See `moirais.fn.describe('graut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.graut import *
import numpy as np
# See the function signature in fn/graut.py for argument names.
```
