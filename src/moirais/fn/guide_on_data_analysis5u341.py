...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_341"]


def guide_on_data_analysis_chapter_5_unnumbered_341(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑦𝑡 = 𝜙𝑦𝑡−1 + 𝜖𝑡 + 𝛼𝜖𝑡−1,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u341')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u341: GeneralStatistics expression (auto-extracted; see ref)."
