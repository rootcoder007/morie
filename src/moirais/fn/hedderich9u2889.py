...
__all__ = ["hedderich_chapter_9_unnumbered_2889"]


def hedderich_chapter_9_unnumbered_2889(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: HA :πi̸=πi0 for at least onei
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2889')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2889: ContingencyTables expression (auto-extracted; see ref)."
