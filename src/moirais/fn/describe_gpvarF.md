...
`print(result)` render. See `moirais.fn.describe('gpvarF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpvarF import *
import numpy as np
# See the function signature in fn/gpvarF.py for argument names.
```
