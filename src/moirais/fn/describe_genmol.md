# describe('genmol') — generative_chemistry
...
`print(result)` render. See `moirais.fn.describe('genmol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genmol import *
import numpy as np
# See the function signature in fn/genmol.py for argument names.
```
