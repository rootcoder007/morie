...
`print(result)` render. See `moirais.fn.describe('ksmth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksmth import *
import numpy as np
# See the function signature in fn/ksmth.py for argument names.
```
