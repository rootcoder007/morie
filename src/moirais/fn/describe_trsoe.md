...
`print(result)` render. See `moirais.fn.describe('trsoe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsoe import *
import numpy as np
# See the function signature in fn/trsoe.py for argument names.
```
