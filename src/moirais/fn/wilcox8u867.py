...
__all__ = ["wilcox_chapter_8_unnumbered_867"]


def wilcox_chapter_8_unnumbered_867(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] A = nJ(J + 1)(2J + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u867')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u867: GeneralStatistics expression (auto-extracted; see ref)."
