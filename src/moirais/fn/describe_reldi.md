...
`print(result)` render. See `moirais.fn.describe('reldi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reldi import *
import numpy as np
# See the function signature in fn/reldi.py for argument names.
```
