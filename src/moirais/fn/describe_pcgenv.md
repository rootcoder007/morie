...
`print(result)` render. See `moirais.fn.describe('pcgenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcgenv import *
import numpy as np
# See the function signature in fn/pcgenv.py for argument names.
```
