...
`print(result)` render. See `moirais.fn.describe('rgppv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgppv import *
import numpy as np
# See the function signature in fn/rgppv.py for argument names.
```
