# describe('bnsipv') — bound_iv_partial
...
`print(result)` render. See `moirais.fn.describe('bnsipv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsipv import *
import numpy as np
# See the function signature in fn/bnsipv.py for argument names.
```
