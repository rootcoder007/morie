...
`print(result)` render. See `moirais.fn.describe('hmf1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmf1 import *
import numpy as np
# See the function signature in fn/hmf1.py for argument names.
```
