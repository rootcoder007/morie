...
`print(result)` render. See `moirais.fn.describe('sagge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagge import *
import numpy as np
# See the function signature in fn/sagge.py for argument names.
```
