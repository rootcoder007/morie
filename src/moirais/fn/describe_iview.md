...
`print(result)` render. See `moirais.fn.describe('iview')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iview import *
import numpy as np
# See the function signature in fn/iview.py for argument names.
```
