...
`print(result)` render. See `moirais.fn.describe('ppsal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppsal import *
import numpy as np
# See the function signature in fn/ppsal.py for argument names.
```
