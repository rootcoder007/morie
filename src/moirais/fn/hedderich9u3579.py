...
__all__ = ["hedderich_chapter_9_unnumbered_3579"]


def hedderich_chapter_9_unnumbered_3579(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (t) = λ·p·tp−1·exp(−(λt)p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3579')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3579: GeneralStatistics expression (auto-extracted; see ref)."
