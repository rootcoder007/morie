...
`print(result)` render. See `moirais.fn.describe('mxpl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxpl2 import *
import numpy as np
# See the function signature in fn/mxpl2.py for argument names.
```
