...
`print(result)` render. See `moirais.fn.describe('rschg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rschg import *
import numpy as np
# See the function signature in fn/rschg.py for argument names.
```
