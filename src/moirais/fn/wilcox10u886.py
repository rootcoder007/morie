...
__all__ = ["wilcox_chapter_10_unnumbered_886"]


def wilcox_chapter_10_unnumbered_886(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ d1 − θ d2 = 0. (11.11)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u886')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u886: GeneralStatistics expression (auto-extracted; see ref)."
