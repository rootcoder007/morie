# describe('expns') — exponential_smooth
...
`print(result)` render. See `moirais.fn.describe('expns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.expns import *
import numpy as np
# See the function signature in fn/expns.py for argument names.
```
