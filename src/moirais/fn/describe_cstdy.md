...
`print(result)` render. See `moirais.fn.describe('cstdy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstdy import *
import numpy as np
# See the function signature in fn/cstdy.py for argument names.
```
