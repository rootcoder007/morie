...
`print(result)` render. See `moirais.fn.describe('irtli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtli import *
import numpy as np
# See the function signature in fn/irtli.py for argument names.
```
