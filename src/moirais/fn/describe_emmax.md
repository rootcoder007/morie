# describe('emmax') — em_maximization_step
...
`print(result)` render. See `moirais.fn.describe('emmax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emmax import *
import numpy as np
# See the function signature in fn/emmax.py for argument names.
```
