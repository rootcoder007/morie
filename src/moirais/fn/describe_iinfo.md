# describe('iinfo') — item_information
...
`print(result)` render. See `moirais.fn.describe('iinfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iinfo import *
import numpy as np
# See the function signature in fn/iinfo.py for argument names.
```
