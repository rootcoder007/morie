...
`print(result)` render. See `moirais.fn.describe('luband')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luband import *
import numpy as np
# See the function signature in fn/luband.py for argument names.
```
