...
`print(result)` render. See `moirais.fn.describe('kolmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kolmc import *
import numpy as np
# See the function signature in fn/kolmc.py for argument names.
```
