...
`print(result)` render. See `moirais.fn.describe('gcnchb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcnchb import *
import numpy as np
# See the function signature in fn/gcnchb.py for argument names.
```
