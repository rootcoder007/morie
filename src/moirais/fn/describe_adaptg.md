...
`print(result)` render. See `moirais.fn.describe('adaptg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adaptg import *
import numpy as np
# See the function signature in fn/adaptg.py for argument names.
```
