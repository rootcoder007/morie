...
`print(result)` render. See `moirais.fn.describe('lucnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lucnd import *
import numpy as np
# See the function signature in fn/lucnd.py for argument names.
```
