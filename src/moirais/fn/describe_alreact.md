# describe('alreact') — alammar_react_agent_loop
...
`print(result)` render. See `moirais.fn.describe('alreact')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alreact import *
import numpy as np
# See the function signature in fn/alreact.py for argument names.
```
