# describe('otsktol') — ot_sinkhorn_tol
...
`print(result)` render. See `moirais.fn.describe('otsktol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsktol import *
import numpy as np
# See the function signature in fn/otsktol.py for argument names.
```
