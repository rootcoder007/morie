# describe('svmv2') — median_voter_2d
...
`print(result)` render. See `moirais.fn.describe('svmv2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmv2 import *
import numpy as np
# See the function signature in fn/svmv2.py for argument names.
```
