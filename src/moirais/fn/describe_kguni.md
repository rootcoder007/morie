# describe('kguni') — universal_kriging
...
`print(result)` render. See `moirais.fn.describe('kguni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kguni import *
import numpy as np
# See the function signature in fn/kguni.py for argument names.
```
