...
__all__ = ["hedderich_chapter_9_unnumbered_77"]


def hedderich_chapter_9_unnumbered_77(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] C(n×m) = A(n×k)B(k×m) (2.29)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u77')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u77: GeneralStatistics expression (auto-extracted; see ref)."
