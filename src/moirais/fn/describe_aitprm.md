# describe('aitprm') — compositional_permanova
...
`print(result)` render. See `moirais.fn.describe('aitprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitprm import *
import numpy as np
# See the function signature in fn/aitprm.py for argument names.
```
