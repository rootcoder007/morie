...
`print(result)` render. See `moirais.fn.describe('mfovsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mfovsm import *
import numpy as np
# See the function signature in fn/mfovsm.py for argument names.
```
