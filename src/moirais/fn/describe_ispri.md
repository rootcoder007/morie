...
`print(result)` render. See `moirais.fn.describe('ispri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ispri import *
import numpy as np
# See the function signature in fn/ispri.py for argument names.
```
