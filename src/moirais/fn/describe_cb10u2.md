# describe('cb10u2') — cb_chapter_10_unnumbered_2
...
(μ = 100; SD = 15). Since IQ is an integer, we nest our rnorm() argument
...
import numpy as np
result = cb_chapter_10_unnumbered_2(np.random.default_rng(42).normal(0, 1, 100))
