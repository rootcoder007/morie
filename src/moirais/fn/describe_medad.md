# describe('medad') — mediation_analysis
...
`print(result)` render. See `moirais.fn.describe('medad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medad import *
import numpy as np
# See the function signature in fn/medad.py for argument names.
```
