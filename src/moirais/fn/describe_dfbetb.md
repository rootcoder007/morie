...
`print(result)` render. See `moirais.fn.describe('dfbetb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfbetb import *
import numpy as np
# See the function signature in fn/dfbetb.py for argument names.
```
