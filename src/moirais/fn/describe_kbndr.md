...
`print(result)` render. See `moirais.fn.describe('kbndr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbndr import *
import numpy as np
# See the function signature in fn/kbndr.py for argument names.
```
