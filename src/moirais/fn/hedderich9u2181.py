...
__all__ = ["hedderich_chapter_9_unnumbered_2181"]


def hedderich_chapter_9_unnumbered_2181(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [(−0.13) + (−0.13)]/2 =−0.13 (0 .10 + 0.10)/2 = 0.10
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2181')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2181: GeneralStatistics expression (auto-extracted; see ref)."
