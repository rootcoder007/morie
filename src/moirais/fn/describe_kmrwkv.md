# describe('kmrwkv') — kamath_rwkv_time_mix
...
`print(result)` render. See `moirais.fn.describe('kmrwkv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrwkv import *
import numpy as np
# See the function signature in fn/kmrwkv.py for argument names.
```
