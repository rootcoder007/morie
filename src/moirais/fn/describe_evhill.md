# describe('evhill') — evt_hill_estimator
...
`print(result)` render. See `moirais.fn.describe('evhill')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evhill import *
import numpy as np
# See the function signature in fn/evhill.py for argument names.
```
