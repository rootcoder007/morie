...
__all__ = ["hedderich_chapter_9_unnumbered_2961"]


def hedderich_chapter_9_unnumbered_2961(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] βj =P (Y =j), j = 1,...,c .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2961')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2961: GeneralStatistics expression (auto-extracted; see ref)."
