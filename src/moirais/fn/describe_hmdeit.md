...
`print(result)` render. See `moirais.fn.describe('hmdeit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdeit import *
import numpy as np
# See the function signature in fn/hmdeit.py for argument names.
```
