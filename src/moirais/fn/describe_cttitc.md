# describe('cttitc') — ctt_item_total_corr
...
`print(result)` render. See `moirais.fn.describe('cttitc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cttitc import *
import numpy as np
# See the function signature in fn/cttitc.py for argument names.
```
