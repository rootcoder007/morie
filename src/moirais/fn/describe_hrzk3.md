# describe('hrzk3') — horowitz_local_linear
...
`print(result)` render. See `moirais.fn.describe('hrzk3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzk3 import *
import numpy as np
# See the function signature in fn/hrzk3.py for argument names.
```
