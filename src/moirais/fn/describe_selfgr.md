# describe('selfgr') — selfies_encode
...
`print(result)` render. See `moirais.fn.describe('selfgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.selfgr import *
import numpy as np
# See the function signature in fn/selfgr.py for argument names.
```
