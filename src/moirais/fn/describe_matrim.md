...
`print(result)` render. See `moirais.fn.describe('matrim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matrim import *
import numpy as np
# See the function signature in fn/matrim.py for argument names.
```
