# describe('msm323') — mvsml_functional_regression_eq_15_1
...
`print(result)` render. See `moirais.fn.describe('msm323')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm323 import *
import numpy as np
# See the function signature in fn/msm323.py for argument names.
```
