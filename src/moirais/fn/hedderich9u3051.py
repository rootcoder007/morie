...
__all__ = ["hedderich_chapter_9_unnumbered_3051"]


def hedderich_chapter_9_unnumbered_3051(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( " Person "=c ( " 1 " , " 2 " , " 3 " , " 4 " , " 5 " , " 6 " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3051')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3051: GeneralStatistics expression (auto-extracted; see ref)."
