# describe('mtchf') — matched_filter_detect
...
`print(result)` render. See `moirais.fn.describe('mtchf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtchf import *
import numpy as np
# See the function signature in fn/mtchf.py for argument names.
```
