...
`print(result)` render. See `moirais.fn.describe('qdanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qdanl import *
import numpy as np
# See the function signature in fn/qdanl.py for argument names.
```
