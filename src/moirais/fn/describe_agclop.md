# describe('agclop') — alphazero_optimizer
...
`print(result)` render. See `moirais.fn.describe('agclop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agclop import *
import numpy as np
# See the function signature in fn/agclop.py for argument names.
```
