# describe('hmgcl') — geron_gradient_clipping
...
`print(result)` render. See `moirais.fn.describe('hmgcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgcl import *
import numpy as np
# See the function signature in fn/hmgcl.py for argument names.
```
