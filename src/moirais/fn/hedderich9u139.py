...
__all__ = ["hedderich_chapter_9_unnumbered_139"]


def hedderich_chapter_9_unnumbered_139(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n = 2000 with two decimal places. Example:p = 33/189 = 0.17460 is given as a percentage
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u139')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u139: GeneralStatistics expression (auto-extracted; see ref)."
