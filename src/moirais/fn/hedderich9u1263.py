...
__all__ = ["hedderich_chapter_9_unnumbered_1263"]


def hedderich_chapter_9_unnumbered_1263(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] withz1−α/2 = 1.96 (α= 0.05),z1−α/2 = 2.58 (α= 0.01) andz1−α/2 = 3.29 (α= 0.001).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1263')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1263: GeneralStatistics expression (auto-extracted; see ref)."
