...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_887"]


def guide_on_data_analysis_chapter_14_unnumbered_887(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Δln(𝑦) = 𝛽1 ⋅ Δ𝑥1 ⇒ %Δ𝑦 ≈ 100 × 𝛽1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u887')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u887: GeneralStatistics expression (auto-extracted; see ref)."
