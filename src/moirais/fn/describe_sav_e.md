# describe('sav_e') — subscale_ee_ave
...
`print(result)` render. See `moirais.fn.describe('sav_e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sav_e import *
import numpy as np
# See the function signature in fn/sav_e.py for argument names.
```
