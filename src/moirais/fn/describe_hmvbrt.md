# describe('hmvbrt') — geron_videobert
...
`print(result)` render. See `moirais.fn.describe('hmvbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvbrt import *
import numpy as np
# See the function signature in fn/hmvbrt.py for argument names.
```
