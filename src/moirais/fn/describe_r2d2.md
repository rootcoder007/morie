# describe('r2d2') — cheatsheet

## WHAT IT DOES

R-squared. 'The only true wisdom is in knowing you know nothing. — Socrates'
...
`print(result)` render. See `moirais.fn.describe('r2d2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r2d2 import *
import numpy as np
# See the function signature in fn/r2d2.py for argument names.
```
