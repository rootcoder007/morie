...
`print(result)` render. See `moirais.fn.describe('hmppo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmppo import *
import numpy as np
# See the function signature in fn/hmppo.py for argument names.
```
