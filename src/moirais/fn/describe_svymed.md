...
`print(result)` render. See `moirais.fn.describe('svymed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svymed import *
import numpy as np
# See the function signature in fn/svymed.py for argument names.
```
