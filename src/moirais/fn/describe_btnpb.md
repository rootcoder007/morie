# describe('btnpb') — boot_nonoverlap_block
...
`print(result)` render. See `moirais.fn.describe('btnpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btnpb import *
import numpy as np
# See the function signature in fn/btnpb.py for argument names.
```
