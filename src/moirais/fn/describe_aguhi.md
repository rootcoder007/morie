...
`print(result)` render. See `moirais.fn.describe('aguhi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aguhi import *
import numpy as np
# See the function signature in fn/aguhi.py for argument names.
```
