# describe('rgfish') — rangayyan_fisher_criterion
...
`print(result)` render. See `moirais.fn.describe('rgfish')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfish import *
import numpy as np
# See the function signature in fn/rgfish.py for argument names.
```
