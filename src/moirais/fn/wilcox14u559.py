...
__all__ = ["wilcox_chapter_14_unnumbered_559"]


def wilcox_chapter_14_unnumbered_559(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u559')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u559: GeneralStatistics expression (auto-extracted; see ref)."
