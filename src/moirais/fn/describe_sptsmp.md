...
`print(result)` render. See `moirais.fn.describe('sptsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptsmp import *
import numpy as np
# See the function signature in fn/sptsmp.py for argument names.
```
