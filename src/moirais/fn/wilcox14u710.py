...
__all__ = ["wilcox_chapter_14_unnumbered_710"]


def wilcox_chapter_14_unnumbered_710(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u710')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u710: GeneralStatistics expression (auto-extracted; see ref)."
