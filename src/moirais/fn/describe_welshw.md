...
`print(result)` render. See `moirais.fn.describe('welshw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.welshw import *
import numpy as np
# See the function signature in fn/welshw.py for argument names.
```
