# describe('hmbp') — geron_backpropagation
...
`print(result)` render. See `moirais.fn.describe('hmbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbp import *
import numpy as np
# See the function signature in fn/hmbp.py for argument names.
```
