...
`print(result)` render. See `moirais.fn.describe('sggls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sggls import *
import numpy as np
# See the function signature in fn/sggls.py for argument names.
```
