...
`print(result)` render. See `moirais.fn.describe('mgwrcof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrcof import *
import numpy as np
# See the function signature in fn/mgwrcof.py for argument names.
```
