...
`print(result)` render. See `moirais.fn.describe('grphmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grphmr import *
import numpy as np
# See the function signature in fn/grphmr.py for argument names.
```
