...
`print(result)` render. See `moirais.fn.describe('gpdtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpdtc import *
import numpy as np
# See the function signature in fn/gpdtc.py for argument names.
```
