...
`print(result)` render. See `moirais.fn.describe('ukrig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ukrig import *
import numpy as np
# See the function signature in fn/ukrig.py for argument names.
```
