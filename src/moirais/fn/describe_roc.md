...
`print(result)` render. See `moirais.fn.describe('roc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.roc import *
import numpy as np
# See the function signature in fn/roc.py for argument names.
```
