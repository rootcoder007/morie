# describe('xrspn') — spatial_panel_fe
...
`print(result)` render. See `moirais.fn.describe('xrspn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspn import *
import numpy as np
# See the function signature in fn/xrspn.py for argument names.
```
