# describe('gmccsm') — g_methods_consistency
...
`print(result)` render. See `moirais.fn.describe('gmccsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmccsm import *
import numpy as np
# See the function signature in fn/gmccsm.py for argument names.
```
