...
`print(result)` render. See `moirais.fn.describe('eqthl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqthl import *
import numpy as np
# See the function signature in fn/eqthl.py for argument names.
```
