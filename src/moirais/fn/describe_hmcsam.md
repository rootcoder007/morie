# describe('hmcsam') — hamiltonian_mc
...
`print(result)` render. See `moirais.fn.describe('hmcsam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcsam import *
import numpy as np
# See the function signature in fn/hmcsam.py for argument names.
```
