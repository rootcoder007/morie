...
`print(result)` render. See `moirais.fn.describe('cumhz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cumhz import *
import numpy as np
# See the function signature in fn/cumhz.py for argument names.
```
