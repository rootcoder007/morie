# describe('km142') — kamath_ch9_itg_loss
...
`print(result)` render. See `moirais.fn.describe('km142')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km142 import *
import numpy as np
# See the function signature in fn/km142.py for argument names.
```
