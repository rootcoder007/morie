...
`print(result)` render. See `moirais.fn.describe('ihstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihstst import *
import numpy as np
# See the function signature in fn/ihstst.py for argument names.
```
