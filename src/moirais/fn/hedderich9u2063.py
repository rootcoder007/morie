...
__all__ = ["hedderich_chapter_9_unnumbered_2063"]


def hedderich_chapter_9_unnumbered_2063(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] Power = 1−β=P (tν,δ′>t ν,1−α/2) +P (tν,δ′<t ν,α/2) (7.112)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2063')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2063: PowerAndDesign expression (auto-extracted; see ref)."
