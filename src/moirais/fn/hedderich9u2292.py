...
__all__ = ["hedderich_chapter_9_unnumbered_2292"]


def hedderich_chapter_9_unnumbered_2292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: μ 1 μ 2- < -δ μ 1 μ 2- > +δ| μ1 μ |2- δ≤
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2292')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2292: GeneralStatistics expression (auto-extracted; see ref)."
