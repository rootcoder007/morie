# describe('grn002') — geron_ch4_linear_regression_prediction
...
`print(result)` render. See `moirais.fn.describe('grn002')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grn002 import *
import numpy as np
# See the function signature in fn/grn002.py for argument names.
```
