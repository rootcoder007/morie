...
`print(result)` render. See `moirais.fn.describe('secnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secnt import *
import numpy as np
# See the function signature in fn/secnt.py for argument names.
```
