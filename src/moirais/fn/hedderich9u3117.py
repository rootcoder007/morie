...
__all__ = ["hedderich_chapter_9_unnumbered_3117"]


def hedderich_chapter_9_unnumbered_3117(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: from Table 7.82 (forr = 1, ˙z =∞, forr = 0.999, ˙z = 3.80020). The conversion of small values
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3117')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3117: GeneralStatistics expression (auto-extracted; see ref)."
