# describe('km046') — kamath_ch3_prefix_prompt_template
...
`print(result)` render. See `moirais.fn.describe('km046')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km046 import *
import numpy as np
# See the function signature in fn/km046.py for argument names.
```
