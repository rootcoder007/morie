# describe('hapblk') — haplotype_block
...
`print(result)` render. See `moirais.fn.describe('hapblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hapblk import *
import numpy as np
# See the function signature in fn/hapblk.py for argument names.
```
