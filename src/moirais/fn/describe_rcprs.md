...
`print(result)` render. See `moirais.fn.describe('rcprs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcprs import *
import numpy as np
# See the function signature in fn/rcprs.py for argument names.
```
