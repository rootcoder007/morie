# describe('fuzzy') — fuzzy_membership
...
`print(result)` render. See `moirais.fn.describe('fuzzy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fuzzy import *
import numpy as np
# See the function signature in fn/fuzzy.py for argument names.
```
