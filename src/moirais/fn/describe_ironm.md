# describe('ironm') — armor_optimize

## WHAT IT DOES

Constrained linear programming optimizer. 'All models are wrong, but some are useful. — George E. P. Box' Stark
...
`print(result)` render. See `moirais.fn.describe('ironm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ironm import *
import numpy as np
# See the function signature in fn/ironm.py for argument names.
```
