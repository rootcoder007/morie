# describe('csptl') — csptl

## WHAT IT DOES

Police patrol spatial
...
`print(result)` render. See `moirais.fn.describe('csptl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csptl import *
import numpy as np
# See the function signature in fn/csptl.py for argument names.
```
