# describe('delny') — delaunay_simple

## WHAT IT DOES

Simplified Delaunay triangulation. 'You have power over your mind. — Marcus Aurelius'
...
`print(result)` render. See `moirais.fn.describe('delny')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.delny import *
import numpy as np
# See the function signature in fn/delny.py for argument names.
```
