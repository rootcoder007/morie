...
`print(result)` render. See `moirais.fn.describe('lvq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvq import *
import numpy as np
# See the function signature in fn/lvq.py for argument names.
```
