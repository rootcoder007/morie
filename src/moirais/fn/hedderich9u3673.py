...
__all__ = ["hedderich_chapter_9_unnumbered_3673"]


def hedderich_chapter_9_unnumbered_3673(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : λ=λ0 . . . . . . . . . . . . . . . . .516–518
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3673')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3673: GeneralStatistics expression (auto-extracted; see ref)."
