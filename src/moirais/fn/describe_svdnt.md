...
`print(result)` render. See `moirais.fn.describe('svdnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdnt import *
import numpy as np
# See the function signature in fn/svdnt.py for argument names.
```
