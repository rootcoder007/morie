# describe('gb733') — gibbons_linrank_covariance
...
`print(result)` render. See `moirais.fn.describe('gb733')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb733 import *
import numpy as np
# See the function signature in fn/gb733.py for argument names.
```
