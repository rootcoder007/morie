# describe('capam') — circular_mean

## WHAT IT DOES

Circular statistics — mean direction and concentration. 'What is now proved was once only imagined. — William Blake'
...
`print(result)` render. See `moirais.fn.describe('capam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.capam import *
import numpy as np
# See the function signature in fn/capam.py for argument names.
```
