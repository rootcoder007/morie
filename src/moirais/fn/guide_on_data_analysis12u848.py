...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_848"]


def guide_on_data_analysis_chapter_12_unnumbered_848(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑖 = Φ−1 (rank(𝑥𝑖) − 1/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u848')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u848: GeneralStatistics expression (auto-extracted; see ref)."
