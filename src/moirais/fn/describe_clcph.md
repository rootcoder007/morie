...
`print(result)` render. See `moirais.fn.describe('clcph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcph import *
import numpy as np
# See the function signature in fn/clcph.py for argument names.
```
