...
`print(result)` render. See `moirais.fn.describe('kgmtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgmtx import *
import numpy as np
# See the function signature in fn/kgmtx.py for argument names.
```
