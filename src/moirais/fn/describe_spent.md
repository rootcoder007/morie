# describe('spent') — spectral_entropy
...
`print(result)` render. See `moirais.fn.describe('spent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spent import *
import numpy as np
# See the function signature in fn/spent.py for argument names.
```
