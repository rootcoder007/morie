# describe('agsav') — agsav

## WHAT IT DOES

SAVI spatial analysis
...
`print(result)` render. See `moirais.fn.describe('agsav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agsav import *
import numpy as np
# See the function signature in fn/agsav.py for argument names.
```
