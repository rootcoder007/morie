# describe('scr_u') — subscale_ua_composite_rel
...
`print(result)` render. See `moirais.fn.describe('scr_u')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scr_u import *
import numpy as np
# See the function signature in fn/scr_u.py for argument names.
```
