# describe('apc') — age_period_cohort
...
`print(result)` render. See `moirais.fn.describe('apc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apc import *
import numpy as np
# See the function signature in fn/apc.py for argument names.
```
