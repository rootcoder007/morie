...
__all__ = ["hedderich_chapter_9_unnumbered_632"]


def hedderich_chapter_9_unnumbered_632(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆp = (0·15 + 1·63 + 2·66 + 3·47 + 4·9)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u632')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u632: GeneralStatistics expression (auto-extracted; see ref)."
