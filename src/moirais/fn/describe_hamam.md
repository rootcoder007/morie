# describe('hamam') — brownian_motion
...
`print(result)` render. See `moirais.fn.describe('hamam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hamam import *
import numpy as np
# See the function signature in fn/hamam.py for argument names.
```
