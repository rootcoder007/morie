# describe('fzt56') — fauzi_thm5_6_bdfree_ks_equiv
...
`print(result)` render. See `moirais.fn.describe('fzt56')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt56 import *
import numpy as np
# See the function signature in fn/fzt56.py for argument names.
```
