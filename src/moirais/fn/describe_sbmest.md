# describe('sbmest') — stochastic_block_model
...
`print(result)` render. See `moirais.fn.describe('sbmest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbmest import *
import numpy as np
# See the function signature in fn/sbmest.py for argument names.
```
