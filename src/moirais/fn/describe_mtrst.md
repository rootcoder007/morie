...
`print(result)` render. See `moirais.fn.describe('mtrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrst import *
import numpy as np
# See the function signature in fn/mtrst.py for argument names.
```
