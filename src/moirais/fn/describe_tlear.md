...
`print(result)` render. See `moirais.fn.describe('tlear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tlear import *
import numpy as np
# See the function signature in fn/tlear.py for argument names.
```
