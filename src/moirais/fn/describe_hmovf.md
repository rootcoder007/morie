# describe('hmovf') — geron_overfitting
...
`print(result)` render. See `moirais.fn.describe('hmovf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmovf import *
import numpy as np
# See the function signature in fn/hmovf.py for argument names.
```
