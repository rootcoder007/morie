...
`print(result)` render. See `moirais.fn.describe('srpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srpre import *
import numpy as np
# See the function signature in fn/srpre.py for argument names.
```
