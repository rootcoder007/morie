# describe('rgeqn10a') — rangayyan_ch10_cost_matrix
...
`print(result)` render. See `moirais.fn.describe('rgeqn10a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn10a import *
import numpy as np
# See the function signature in fn/rgeqn10a.py for argument names.
```
