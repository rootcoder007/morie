...
__all__ = ["hedderich_chapter_9_unnumbered_469"]


def hedderich_chapter_9_unnumbered_469(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (2)P2 = 1−P (A∪B∪C) = 1−0.80 = 0.20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u469')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u469: GeneralStatistics expression (auto-extracted; see ref)."
