...
__all__ = ["wilcox_chapter_4_unnumbered_120"]


def wilcox_chapter_4_unnumbered_120(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] by 12). More formally, if E(X) = µ = 5, then E(12X) = 12 × 5 = 60.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u120')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u120: GeneralStatistics expression (auto-extracted; see ref)."
