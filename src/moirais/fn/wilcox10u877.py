...
__all__ = ["wilcox_chapter_10_unnumbered_877"]


def wilcox_chapter_10_unnumbered_877(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Reject if Q/c ≥ f1−α , the 1 − α quantile of an F distribution with ν 1 and ν 2 degrees
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u877')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u877: GeneralStatistics expression (auto-extracted; see ref)."
