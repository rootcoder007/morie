...
`print(result)` render. See `moirais.fn.describe('spflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spflt import *
import numpy as np
# See the function signature in fn/spflt.py for argument names.
```
