...
__all__ = ["hedderich_chapter_9_unnumbered_3633"]


def hedderich_chapter_9_unnumbered_3633(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] AIC =−2(log(likelihood)) + 2p (8.172)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3633')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3633: GeneralStatistics expression (auto-extracted; see ref)."
