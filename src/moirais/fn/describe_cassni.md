...
`print(result)` render. See `moirais.fn.describe('cassni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cassni import *
import numpy as np
# See the function signature in fn/cassni.py for argument names.
```
