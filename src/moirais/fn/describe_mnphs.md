# describe('mnphs') — minimum_phase_correspondent
...
`print(result)` render. See `moirais.fn.describe('mnphs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnphs import *
import numpy as np
# See the function signature in fn/mnphs.py for argument names.
```
