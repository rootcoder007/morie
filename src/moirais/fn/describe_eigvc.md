# describe('eigvc') — extract_eigenvectors
...
`print(result)` render. See `moirais.fn.describe('eigvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigvc import *
import numpy as np
# See the function signature in fn/eigvc.py for argument names.
```
