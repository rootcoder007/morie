# describe('guide_on_data_analysis3u128') — guide_on_data_analysis_chapter_3_unnumbered_128
...
import numpy as np
result = guide_on_data_analysis_chapter_3_unnumbered_128(np.random.default_rng(42).normal(0, 1, 100))
