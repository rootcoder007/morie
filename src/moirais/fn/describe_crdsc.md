# describe('crdsc') — scale_coordinates
...
`print(result)` render. See `moirais.fn.describe('crdsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crdsc import *
import numpy as np
# See the function signature in fn/crdsc.py for argument names.
```
