...
`print(result)` render. See `moirais.fn.describe('sawnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawnv import *
import numpy as np
# See the function signature in fn/sawnv.py for argument names.
```
