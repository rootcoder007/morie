...
__all__ = ["wilcox_chapter_14_unnumbered_497"]


def wilcox_chapter_14_unnumbered_497(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: b1,0.8 = 1.5, b1,0.2 = −0.5, and Sd = 1.3, the 0.95 confidence interval is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u497')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u497: PowerAndDesign expression (auto-extracted; see ref)."
