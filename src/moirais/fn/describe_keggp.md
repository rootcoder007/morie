...
`print(result)` render. See `moirais.fn.describe('keggp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.keggp import *
import numpy as np
# See the function signature in fn/keggp.py for argument names.
```
