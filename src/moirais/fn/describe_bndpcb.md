# describe('bndpcb') — bound_pseudo_credible
...
`print(result)` render. See `moirais.fn.describe('bndpcb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpcb import *
import numpy as np
# See the function signature in fn/bndpcb.py for argument names.
```
