...
__all__ = ["wilcox_chapter_14_unnumbered_608"]


def wilcox_chapter_14_unnumbered_608(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] B = b +cv(1 − a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u608')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u608: ContingencyTables expression (auto-extracted; see ref)."
