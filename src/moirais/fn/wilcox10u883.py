...
__all__ = ["wilcox_chapter_10_unnumbered_883"]


def wilcox_chapter_10_unnumbered_883(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: of ¯θ j.. For levelsj andj′ of Factor A,j <j′, setδ ∗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u883')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u883: Resampling expression (auto-extracted; see ref)."
