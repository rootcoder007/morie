# describe('infrt') — infant_mortality_rate
...
`print(result)` render. See `moirais.fn.describe('infrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infrt import *
import numpy as np
# See the function signature in fn/infrt.py for argument names.
```
