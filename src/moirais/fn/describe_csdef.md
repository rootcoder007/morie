...
`print(result)` render. See `moirais.fn.describe('csdef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdef import *
import numpy as np
# See the function signature in fn/csdef.py for argument names.
```
