...
`print(result)` render. See `moirais.fn.describe('trupek')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trupek import *
import numpy as np
# See the function signature in fn/trupek.py for argument names.
```
