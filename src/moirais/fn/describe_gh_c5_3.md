# describe('gh_c5_3') — ghosal_cgibbs
...
`print(result)` render. See `moirais.fn.describe('gh_c5_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c5_3 import *
import numpy as np
# See the function signature in fn/gh_c5_3.py for argument names.
```
