# describe('offlrl') — offline_rl_cql
...
`print(result)` render. See `moirais.fn.describe('offlrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.offlrl import *
import numpy as np
# See the function signature in fn/offlrl.py for argument names.
```
