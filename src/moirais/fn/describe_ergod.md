# describe('ergod') — ergodicity_test
...
`print(result)` render. See `moirais.fn.describe('ergod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ergod import *
import numpy as np
# See the function signature in fn/ergod.py for argument names.
```
