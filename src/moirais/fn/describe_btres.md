# describe('btres') — boot_residual_regression
...
`print(result)` render. See `moirais.fn.describe('btres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btres import *
import numpy as np
# See the function signature in fn/btres.py for argument names.
```
