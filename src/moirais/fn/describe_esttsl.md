...
`print(result)` render. See `moirais.fn.describe('esttsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esttsl import *
import numpy as np
# See the function signature in fn/esttsl.py for argument names.
```
