# describe('hmflmg') — geron_flamingo
...
`print(result)` render. See `moirais.fn.describe('hmflmg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmflmg import *
import numpy as np
# See the function signature in fn/hmflmg.py for argument names.
```
