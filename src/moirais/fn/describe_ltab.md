...
`print(result)` render. See `moirais.fn.describe('ltab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltab import *
import numpy as np
# See the function signature in fn/ltab.py for argument names.
```
