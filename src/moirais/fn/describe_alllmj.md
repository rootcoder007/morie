# describe('alllmj') — alammar_llm_as_judge
...
`print(result)` render. See `moirais.fn.describe('alllmj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alllmj import *
import numpy as np
# See the function signature in fn/alllmj.py for argument names.
```
