# describe('bndvld') — bound_validity_check
...
`print(result)` render. See `moirais.fn.describe('bndvld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndvld import *
import numpy as np
# See the function signature in fn/bndvld.py for argument names.
```
