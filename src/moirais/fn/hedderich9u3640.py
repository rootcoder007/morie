...
__all__ = ["hedderich_chapter_9_unnumbered_3640"]


def hedderich_chapter_9_unnumbered_3640(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] rM i =δi−rCi (8.176)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3640')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3640: GeneralStatistics expression (auto-extracted; see ref)."
