...
`print(result)` render. See `moirais.fn.describe('mccrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mccrr import *
import numpy as np
# See the function signature in fn/mccrr.py for argument names.
```
