# describe('intmd4') — interaction_mediation_4way
...
`print(result)` render. See `moirais.fn.describe('intmd4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intmd4 import *
import numpy as np
# See the function signature in fn/intmd4.py for argument names.
```
