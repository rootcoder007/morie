...
`print(result)` render. See `moirais.fn.describe('trshr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trshr2 import *
import numpy as np
# See the function signature in fn/trshr2.py for argument names.
```
