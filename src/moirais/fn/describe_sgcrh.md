# describe('sgcrh') — cressie_hawkins
...
`print(result)` render. See `moirais.fn.describe('sgcrh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcrh import *
import numpy as np
# See the function signature in fn/sgcrh.py for argument names.
```
