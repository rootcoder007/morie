# describe('ljbx') — ljung_box_test_fn
...
`print(result)` render. See `moirais.fn.describe('ljbx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ljbx import *
import numpy as np
# See the function signature in fn/ljbx.py for argument names.
```
