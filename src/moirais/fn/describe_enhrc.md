...
`print(result)` render. See `moirais.fn.describe('enhrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enhrc import *
import numpy as np
# See the function signature in fn/enhrc.py for argument names.
```
