...
`print(result)` render. See `moirais.fn.describe('sceff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sceff import *
import numpy as np
# See the function signature in fn/sceff.py for argument names.
```
