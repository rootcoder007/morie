...
__all__ = ["design_of_observational_studies_chapter_3_unnumbered_202"]


def design_of_observational_studies_chapter_3_unnumbered_202(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = π ℓ (1 − π ℓ)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('design_of_observational_studies3u202')`` for the full guide.
...
def cheatsheet():
    return "design_of_observational_studies3u202: GeneralStatistics expression (auto-extracted; see ref)."
