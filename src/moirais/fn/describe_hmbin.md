# describe('hmbin') — geron_binary_classification
...
`print(result)` render. See `moirais.fn.describe('hmbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbin import *
import numpy as np
# See the function signature in fn/hmbin.py for argument names.
```
