# describe('rocop') — roc_optimal_cutoff
...
`print(result)` render. See `moirais.fn.describe('rocop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rocop import *
import numpy as np
# See the function signature in fn/rocop.py for argument names.
```
