# describe('pairm') — pairwise_matrix
...
`print(result)` render. See `moirais.fn.describe('pairm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pairm import *
import numpy as np
# See the function signature in fn/pairm.py for argument names.
```
