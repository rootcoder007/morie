...
`print(result)` render. See `moirais.fn.describe('elrun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elrun import *
import numpy as np
# See the function signature in fn/elrun.py for argument names.
```
