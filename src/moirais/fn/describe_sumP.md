...
`print(result)` render. See `moirais.fn.describe('sumP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sumP import *
import numpy as np
# See the function signature in fn/sumP.py for argument names.
```
