...
`print(result)` render. See `moirais.fn.describe('nbgvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbgvb import *
import numpy as np
# See the function signature in fn/nbgvb.py for argument names.
```
