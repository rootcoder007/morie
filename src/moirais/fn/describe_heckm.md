# describe('heckm') — heckman_correction
...
`print(result)` render. See `moirais.fn.describe('heckm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heckm import *
import numpy as np
# See the function signature in fn/heckm.py for argument names.
```
