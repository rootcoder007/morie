# describe('scleid') — leiden_clustering
...
`print(result)` render. See `moirais.fn.describe('scleid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scleid import *
import numpy as np
# See the function signature in fn/scleid.py for argument names.
```
