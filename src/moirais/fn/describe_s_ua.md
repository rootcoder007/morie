...
`print(result)` render. See `moirais.fn.describe('s_ua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.s_ua import *
import numpy as np
# See the function signature in fn/s_ua.py for argument names.
```
