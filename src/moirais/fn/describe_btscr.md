# describe('btscr') — boot_score_test
...
`print(result)` render. See `moirais.fn.describe('btscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btscr import *
import numpy as np
# See the function signature in fn/btscr.py for argument names.
```
