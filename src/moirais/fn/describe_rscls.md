...
`print(result)` render. See `moirais.fn.describe('rscls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rscls import *
import numpy as np
# See the function signature in fn/rscls.py for argument names.
```
