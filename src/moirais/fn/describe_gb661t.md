# describe('gb661t') — gibbons_mw_ties
...
`print(result)` render. See `moirais.fn.describe('gb661t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb661t import *
import numpy as np
# See the function signature in fn/gb661t.py for argument names.
```
