...
`print(result)` render. See `moirais.fn.describe('lstqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lstqr import *
import numpy as np
# See the function signature in fn/lstqr.py for argument names.
```
