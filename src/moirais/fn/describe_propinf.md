# describe('propinf') — property_inference
...
`print(result)` render. See `moirais.fn.describe('propinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propinf import *
import numpy as np
# See the function signature in fn/propinf.py for argument names.
```
