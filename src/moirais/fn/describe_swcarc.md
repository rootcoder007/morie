...
`print(result)` render. See `moirais.fn.describe('swcarc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swcarc import *
import numpy as np
# See the function signature in fn/swcarc.py for argument names.
```
