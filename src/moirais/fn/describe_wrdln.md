# describe('wrdln') — word_length_stats
...
`print(result)` render. See `moirais.fn.describe('wrdln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wrdln import *
import numpy as np
# See the function signature in fn/wrdln.py for argument names.
```
