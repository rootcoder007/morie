...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_7"]


def guide_on_data_analysis_chapter_2_unnumbered_7(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = [ (A − BD−1C)−1 −(A − BD−1C)−1BD−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u7')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u7: GeneralStatistics expression (auto-extracted; see ref)."
