...
`print(result)` render. See `moirais.fn.describe('irt3p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt3p import *
import numpy as np
# See the function signature in fn/irt3p.py for argument names.
```
