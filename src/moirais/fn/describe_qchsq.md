...
`print(result)` render. See `moirais.fn.describe('qchsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qchsq import *
import numpy as np
# See the function signature in fn/qchsq.py for argument names.
```
