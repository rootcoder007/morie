...
`print(result)` render. See `moirais.fn.describe('hmrvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrvn import *
import numpy as np
# See the function signature in fn/hmrvn.py for argument names.
```
