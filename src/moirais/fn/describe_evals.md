...
`print(result)` render. See `moirais.fn.describe('evals')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evals import *
import numpy as np
# See the function signature in fn/evals.py for argument names.
```
