...
`print(result)` render. See `moirais.fn.describe('swlowt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swlowt import *
import numpy as np
# See the function signature in fn/swlowt.py for argument names.
```
