# describe('bdrj') — backdoor_adjustment_formula
...
`print(result)` render. See `moirais.fn.describe('bdrj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdrj import *
import numpy as np
# See the function signature in fn/bdrj.py for argument names.
```
