...
__all__ = ["spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_12_equation_27"]


def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_12_equation_27(x, cdf=None):
    """
    Multilevel equation extracted from spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818.

    Formula: [EQ] At = HAt−1 + Jηt (12.27)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_12e27')`` for the full guide.

    References
    ----------
    spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818, ch.12 eq.12.27
    """
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_12e27: Multilevel equation extracted from spatiotemporal-methods-in-environmental-epidemiology-with-r-chapman-amp-hall-crc-texts-in-statistical-science-2nbsped-1032397810-9781032397818."
