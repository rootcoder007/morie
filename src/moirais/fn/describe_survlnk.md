# describe('survlnk') — link_function_survival
...
`print(result)` render. See `moirais.fn.describe('survlnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survlnk import *
import numpy as np
# See the function signature in fn/survlnk.py for argument names.
```
