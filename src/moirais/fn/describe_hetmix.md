# describe('hetmix') — heterogeneous_mixing
...
`print(result)` render. See `moirais.fn.describe('hetmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hetmix import *
import numpy as np
# See the function signature in fn/hetmix.py for argument names.
```
