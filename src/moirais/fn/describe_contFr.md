# describe('contFr') — continued_fraction
...
`print(result)` render. See `moirais.fn.describe('contFr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.contFr import *
import numpy as np
# See the function signature in fn/contFr.py for argument names.
```
