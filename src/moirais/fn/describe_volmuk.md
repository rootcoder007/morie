# describe('volmuk') — vol_multi_kernel_rk
...
`print(result)` render. See `moirais.fn.describe('volmuk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volmuk import *
import numpy as np
# See the function signature in fn/volmuk.py for argument names.
```
