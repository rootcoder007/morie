# describe('km118') — kamath_ch8_rouge_n
...
`print(result)` render. See `moirais.fn.describe('km118')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km118 import *
import numpy as np
# See the function signature in fn/km118.py for argument names.
```
