# describe('msm226') — mvsml_ridge_lasso_elastic_eq_9_41
...
`print(result)` render. See `moirais.fn.describe('msm226')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm226 import *
import numpy as np
# See the function signature in fn/msm226.py for argument names.
```
