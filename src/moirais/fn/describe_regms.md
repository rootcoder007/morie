# describe('regms') — regime_switching
...
`print(result)` render. See `moirais.fn.describe('regms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.regms import *
import numpy as np
# See the function signature in fn/regms.py for argument names.
```
