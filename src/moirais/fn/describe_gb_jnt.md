# describe('gb_jnt') — gibbons_joint_order
...
`print(result)` render. See `moirais.fn.describe('gb_jnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_jnt import *
import numpy as np
# See the function signature in fn/gb_jnt.py for argument names.
```
