# describe('saxR') — sax_representation
...
`print(result)` render. See `moirais.fn.describe('saxR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saxR import *
import numpy as np
# See the function signature in fn/saxR.py for argument names.
```
