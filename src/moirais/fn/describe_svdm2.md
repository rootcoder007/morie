...
`print(result)` render. See `moirais.fn.describe('svdm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdm2 import *
import numpy as np
# See the function signature in fn/svdm2.py for argument names.
```
