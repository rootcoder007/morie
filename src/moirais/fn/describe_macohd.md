...
`print(result)` render. See `moirais.fn.describe('macohd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.macohd import *
import numpy as np
# See the function signature in fn/macohd.py for argument names.
```
