# describe('sephy') — separating_hyperplane
...
`print(result)` render. See `moirais.fn.describe('sephy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sephy import *
import numpy as np
# See the function signature in fn/sephy.py for argument names.
```
