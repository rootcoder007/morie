...
`print(result)` render. See `moirais.fn.describe('isval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isval import *
import numpy as np
# See the function signature in fn/isval.py for argument names.
```
