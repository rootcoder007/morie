...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_244"]


def guide_on_data_analysis_chapter_4_unnumbered_244(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u244')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u244: GeneralStatistics expression (auto-extracted; see ref)."
