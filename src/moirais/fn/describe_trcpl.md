# describe('trcpl') — trace_plot_data
...
`print(result)` render. See `moirais.fn.describe('trcpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcpl import *
import numpy as np
# See the function signature in fn/trcpl.py for argument names.
```
