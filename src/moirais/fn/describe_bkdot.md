# describe('bkdot') — burkov_dot_product
...
`print(result)` render. See `moirais.fn.describe('bkdot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkdot import *
import numpy as np
# See the function signature in fn/bkdot.py for argument names.
```
