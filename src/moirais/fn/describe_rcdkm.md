...
`print(result)` render. See `moirais.fn.describe('rcdkm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdkm import *
import numpy as np
# See the function signature in fn/rcdkm.py for argument names.
```
