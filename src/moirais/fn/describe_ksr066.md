# describe('ksr066') — kosorok_ch3_z_estimator_no_bias
...
`print(result)` render. See `moirais.fn.describe('ksr066')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr066 import *
import numpy as np
# See the function signature in fn/ksr066.py for argument names.
```
