# describe('grxgbg') — geron_xgboost_gain
...
`print(result)` render. See `moirais.fn.describe('grxgbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grxgbg import *
import numpy as np
# See the function signature in fn/grxgbg.py for argument names.
```
