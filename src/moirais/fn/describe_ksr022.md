# describe('ksr022') — kosorok_ch1_multiplicative_intensity
...
`print(result)` render. See `moirais.fn.describe('ksr022')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr022 import *
import numpy as np
# See the function signature in fn/ksr022.py for argument names.
```
