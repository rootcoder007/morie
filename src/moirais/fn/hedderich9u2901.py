...
__all__ = ["hedderich_chapter_9_unnumbered_2901"]


def hedderich_chapter_9_unnumbered_2901(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ni(pi−p)2 = ˆχ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2901')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2901: GeneralStatistics expression (auto-extracted; see ref)."
