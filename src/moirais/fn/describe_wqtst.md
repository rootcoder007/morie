...
`print(result)` render. See `moirais.fn.describe('wqtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtst import *
import numpy as np
# See the function signature in fn/wqtst.py for argument names.
```
