...
`print(result)` render. See `moirais.fn.describe('heaps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heaps import *
import numpy as np
# See the function signature in fn/heaps.py for argument names.
```
