# describe('agmunw') — muzero_n_step_value
...
`print(result)` render. See `moirais.fn.describe('agmunw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmunw import *
import numpy as np
# See the function signature in fn/agmunw.py for argument names.
```
