...
__all__ = ["hedderich_chapter_9_unnumbered_787"]


def hedderich_chapter_9_unnumbered_787(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (µ−x|µ,σ) = f (µ+x|µ,σ)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u787')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u787: GeneralStatistics expression (auto-extracted; see ref)."
