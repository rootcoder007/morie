...
`print(result)` render. See `moirais.fn.describe('yangm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yangm import *
import numpy as np
# See the function signature in fn/yangm.py for argument names.
```
