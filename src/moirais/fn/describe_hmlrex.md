# describe('hmlrex') — geron_lr_exponential
...
`print(result)` render. See `moirais.fn.describe('hmlrex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrex import *
import numpy as np
# See the function signature in fn/hmlrex.py for argument names.
```
