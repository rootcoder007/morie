...
__all__ = ["hedderich_chapter_9_unnumbered_1963"]


def hedderich_chapter_9_unnumbered_1963(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = |(4/20)−(6/24)|√( 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1963')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1963: GeneralStatistics expression (auto-extracted; see ref)."
