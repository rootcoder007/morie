...
`print(result)` render. See `moirais.fn.describe('carjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carjac import *
import numpy as np
# See the function signature in fn/carjac.py for argument names.
```
