...
`print(result)` render. See `moirais.fn.describe('stnsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stnsep import *
import numpy as np
# See the function signature in fn/stnsep.py for argument names.
```
