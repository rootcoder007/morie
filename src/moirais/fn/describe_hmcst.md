# describe('hmcst') — geron_contrastive_learning
...
`print(result)` render. See `moirais.fn.describe('hmcst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcst import *
import numpy as np
# See the function signature in fn/hmcst.py for argument names.
```
