...
`print(result)` render. See `moirais.fn.describe('addrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.addrc import *
import numpy as np
# See the function signature in fn/addrc.py for argument names.
```
