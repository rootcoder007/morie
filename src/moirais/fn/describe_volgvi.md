# describe('volgvi') — vol_garch_var_impl
...
`print(result)` render. See `moirais.fn.describe('volgvi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgvi import *
import numpy as np
# See the function signature in fn/volgvi.py for argument names.
```
