...
`print(result)` render. See `moirais.fn.describe('sisim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sisim2 import *
import numpy as np
# See the function signature in fn/sisim2.py for argument names.
```
