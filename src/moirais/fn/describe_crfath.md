# describe('crfath') — causal_forest_wager_athey
...
`print(result)` render. See `moirais.fn.describe('crfath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfath import *
import numpy as np
# See the function signature in fn/crfath.py for argument names.
```
