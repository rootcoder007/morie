...
`print(result)` render. See `moirais.fn.describe('volhar1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volhar1 import *
import numpy as np
# See the function signature in fn/volhar1.py for argument names.
```
