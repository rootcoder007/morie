# describe('scree') — scree_plot_data
...
`print(result)` render. See `moirais.fn.describe('scree')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scree import *
import numpy as np
# See the function signature in fn/scree.py for argument names.
```
