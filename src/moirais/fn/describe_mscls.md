...
`print(result)` render. See `moirais.fn.describe('mscls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscls import *
import numpy as np
# See the function signature in fn/mscls.py for argument names.
```
