...
`print(result)` render. See `moirais.fn.describe('chltps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chltps import *
import numpy as np
# See the function signature in fn/chltps.py for argument names.
```
