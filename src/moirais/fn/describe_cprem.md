# describe('cprem') — credibility_premium
...
`print(result)` render. See `moirais.fn.describe('cprem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cprem import *
import numpy as np
# See the function signature in fn/cprem.py for argument names.
```
