# describe('attmh') — multi_head_attention
...
`print(result)` render. See `moirais.fn.describe('attmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attmh import *
import numpy as np
# See the function signature in fn/attmh.py for argument names.
```
