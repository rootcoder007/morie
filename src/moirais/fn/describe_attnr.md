# describe('attnr') — attenuation_ratio
...
`print(result)` render. See `moirais.fn.describe('attnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attnr import *
import numpy as np
# See the function signature in fn/attnr.py for argument names.
```
