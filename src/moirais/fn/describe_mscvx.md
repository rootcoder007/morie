...
`print(result)` render. See `moirais.fn.describe('mscvx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscvx import *
import numpy as np
# See the function signature in fn/mscvx.py for argument names.
```
