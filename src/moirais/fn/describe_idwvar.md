...
`print(result)` render. See `moirais.fn.describe('idwvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwvar import *
import numpy as np
# See the function signature in fn/idwvar.py for argument names.
```
