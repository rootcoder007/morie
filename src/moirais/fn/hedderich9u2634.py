...
__all__ = ["hedderich_chapter_9_unnumbered_2634"]


def hedderich_chapter_9_unnumbered_2634(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = 181(15·77−4·85)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2634')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2634: GeneralStatistics expression (auto-extracted; see ref)."
