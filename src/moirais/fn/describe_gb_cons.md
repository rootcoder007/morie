# describe('gb_cons') — gibbons_consistency
...
`print(result)` render. See `moirais.fn.describe('gb_cons')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_cons import *
import numpy as np
# See the function signature in fn/gb_cons.py for argument names.
```
