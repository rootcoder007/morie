...
`print(result)` render. See `moirais.fn.describe('ptffn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptffn import *
import numpy as np
# See the function signature in fn/ptffn.py for argument names.
```
