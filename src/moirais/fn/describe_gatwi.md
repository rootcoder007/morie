...
`print(result)` render. See `moirais.fn.describe('gatwi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatwi import *
import numpy as np
# See the function signature in fn/gatwi.py for argument names.
```
