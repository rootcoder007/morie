...
`print(result)` render. See `moirais.fn.describe('edtds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.edtds import *
import numpy as np
# See the function signature in fn/edtds.py for argument names.
```
