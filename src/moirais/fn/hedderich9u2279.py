...
__all__ = ["hedderich_chapter_9_unnumbered_2279"]


def hedderich_chapter_9_unnumbered_2279(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 8< 10< 13.7. Since T = 11 > 10, the null hypothesis (equality of the distribution functions
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2279')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2279: GeneralStatistics expression (auto-extracted; see ref)."
