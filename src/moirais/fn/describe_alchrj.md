# describe('alchrj') — alammar_chosen_rejected_template
...
`print(result)` render. See `moirais.fn.describe('alchrj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alchrj import *
import numpy as np
# See the function signature in fn/alchrj.py for argument names.
```
