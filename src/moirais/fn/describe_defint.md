# describe('defint') — definite_integral
...
`print(result)` render. See `moirais.fn.describe('defint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.defint import *
import numpy as np
# See the function signature in fn/defint.py for argument names.
```
