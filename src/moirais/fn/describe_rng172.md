# describe('rng172') — rangayyan_ch3_rls_p_recursion
...
`print(result)` render. See `moirais.fn.describe('rng172')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng172 import *
import numpy as np
# See the function signature in fn/rng172.py for argument names.
```
