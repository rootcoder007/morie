# describe('rgentrp') — rangayyan_spectral_entropy
...
`print(result)` render. See `moirais.fn.describe('rgentrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgentrp import *
import numpy as np
# See the function signature in fn/rgentrp.py for argument names.
```
