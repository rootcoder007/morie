...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_139"]


def guide_on_data_analysis_chapter_4_unnumbered_139(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: v = c(-t_critical, t_critical),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u139')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u139: GeneralStatistics expression (auto-extracted; see ref)."
