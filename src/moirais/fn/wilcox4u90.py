...
__all__ = ["wilcox_chapter_4_unnumbered_90"]


def wilcox_chapter_4_unnumbered_90(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: c is given by P (Z ≤ c) = 0.1. Referring to Table 1 in Appendix B, c = −1.28.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u90')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u90: GeneralStatistics expression (auto-extracted; see ref)."
