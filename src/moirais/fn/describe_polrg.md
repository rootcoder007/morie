# describe('polrg') — polynomial_regression
...
`print(result)` render. See `moirais.fn.describe('polrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polrg import *
import numpy as np
# See the function signature in fn/polrg.py for argument names.
```
