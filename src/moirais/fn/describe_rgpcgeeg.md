# describe('rgpcgeeg') — rangayyan_pcg_eeg_coupling
...
`print(result)` render. See `moirais.fn.describe('rgpcgeeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcgeeg import *
import numpy as np
# See the function signature in fn/rgpcgeeg.py for argument names.
```
