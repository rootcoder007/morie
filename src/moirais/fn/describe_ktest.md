...
`print(result)` render. See `moirais.fn.describe('ktest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ktest import *
import numpy as np
# See the function signature in fn/ktest.py for argument names.
```
