...
`print(result)` render. See `moirais.fn.describe('cokfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cokfl import *
import numpy as np
# See the function signature in fn/cokfl.py for argument names.
```
