# describe('odm_r') — otis_demo_region
...
`print(result)` render. See `moirais.fn.describe('odm_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_r import *
import numpy as np
# See the function signature in fn/odm_r.py for argument names.
```
