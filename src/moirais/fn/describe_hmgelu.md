...
`print(result)` render. See `moirais.fn.describe('hmgelu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgelu import *
import numpy as np
# See the function signature in fn/hmgelu.py for argument names.
```
