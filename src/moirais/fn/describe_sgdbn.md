# describe('sgdbn') — spatial_durbin_model
...
`print(result)` render. See `moirais.fn.describe('sgdbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdbn import *
import numpy as np
# See the function signature in fn/sgdbn.py for argument names.
```
