...
`print(result)` render. See `moirais.fn.describe('pabch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pabch import *
import numpy as np
# See the function signature in fn/pabch.py for argument names.
```
