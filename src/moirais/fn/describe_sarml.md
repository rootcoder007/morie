...
`print(result)` render. See `moirais.fn.describe('sarml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarml import *
import numpy as np
# See the function signature in fn/sarml.py for argument names.
```
