# describe('lambd') — genomic_inflation
...
`print(result)` render. See `moirais.fn.describe('lambd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lambd import *
import numpy as np
# See the function signature in fn/lambd.py for argument names.
```
