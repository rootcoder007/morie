# describe('pptest') — phillips_perron_unit_root
...
`print(result)` render. See `moirais.fn.describe('pptest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pptest import *
import numpy as np
# See the function signature in fn/pptest.py for argument names.
```
