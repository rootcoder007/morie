...
`print(result)` render. See `moirais.fn.describe('fwsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fwsel import *
import numpy as np
# See the function signature in fn/fwsel.py for argument names.
```
