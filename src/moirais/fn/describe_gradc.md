...
`print(result)` render. See `moirais.fn.describe('gradc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gradc import *
import numpy as np
# See the function signature in fn/gradc.py for argument names.
```
