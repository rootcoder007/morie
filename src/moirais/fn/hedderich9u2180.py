...
__all__ = ["hedderich_chapter_9_unnumbered_2180"]


def hedderich_chapter_9_unnumbered_2180(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺ −0.13−0.04−0.02 0 0 .02 0.03 0.06 0.09 0.10 the valuek = 1 + 5 = 6 is obtained according
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2180')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2180: GeneralStatistics expression (auto-extracted; see ref)."
