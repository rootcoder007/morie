...
__all__ = ["hedderich_chapter_9_unnumbered_986"]


def hedderich_chapter_9_unnumbered_986(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fx −Density of a (central)χ2 distribution withν+ 2i degrees of freedom and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u986')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u986: GeneralStatistics expression (auto-extracted; see ref)."
