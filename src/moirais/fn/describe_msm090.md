# describe('msm090') — mvsml_bayesian_regression_pt2_eq_7_1
...
`print(result)` render. See `moirais.fn.describe('msm090')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm090 import *
import numpy as np
# See the function signature in fn/msm090.py for argument names.
```
