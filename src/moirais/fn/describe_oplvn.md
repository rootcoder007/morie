...
`print(result)` render. See `moirais.fn.describe('oplvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oplvn import *
import numpy as np
# See the function signature in fn/oplvn.py for argument names.
```
