# describe('b204') — burkov_lm_ch2_trigram_count
...
`print(result)` render. See `moirais.fn.describe('b204')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b204 import *
import numpy as np
# See the function signature in fn/b204.py for argument names.
```
