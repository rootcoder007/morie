...
`print(result)` render. See `moirais.fn.describe('tsscn2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsscn2 import *
import numpy as np
# See the function signature in fn/tsscn2.py for argument names.
```
