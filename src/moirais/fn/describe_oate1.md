# describe('oate1') — otis_ate_region
...
`print(result)` render. See `moirais.fn.describe('oate1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oate1 import *
import numpy as np
# See the function signature in fn/oate1.py for argument names.
```
