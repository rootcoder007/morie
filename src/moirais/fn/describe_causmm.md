# describe('causmm') — causal_mahalanobis_match
...
`print(result)` render. See `moirais.fn.describe('causmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmm import *
import numpy as np
# See the function signature in fn/causmm.py for argument names.
```
