# describe('moetop') — moe_topk_routing
...
`print(result)` render. See `moirais.fn.describe('moetop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moetop import *
import numpy as np
# See the function signature in fn/moetop.py for argument names.
```
