# describe('locp') — local_polynomial
...
`print(result)` render. See `moirais.fn.describe('locp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.locp import *
import numpy as np
# See the function signature in fn/locp.py for argument names.
```
