# describe('smptst') — sample_test_msm
...
`print(result)` render. See `moirais.fn.describe('smptst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smptst import *
import numpy as np
# See the function signature in fn/smptst.py for argument names.
```
