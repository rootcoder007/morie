# describe('smigr') — smiles_grammar_parse
...
`print(result)` render. See `moirais.fn.describe('smigr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smigr import *
import numpy as np
# See the function signature in fn/smigr.py for argument names.
```
