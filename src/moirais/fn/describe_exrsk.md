...
`print(result)` render. See `moirais.fn.describe('exrsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.exrsk import *
import numpy as np
# See the function signature in fn/exrsk.py for argument names.
```
