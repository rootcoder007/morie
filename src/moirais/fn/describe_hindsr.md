...
`print(result)` render. See `moirais.fn.describe('hindsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hindsr import *
import numpy as np
# See the function signature in fn/hindsr.py for argument names.
```
