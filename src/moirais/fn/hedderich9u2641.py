...
__all__ = ["hedderich_chapter_9_unnumbered_2641"]


def hedderich_chapter_9_unnumbered_2641(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = 2.30 + 1.94 + 3.60 + 2.92 = 10.76 with 1 + 1 + 1 + 1 = 4DF.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2641')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2641: GeneralStatistics expression (auto-extracted; see ref)."
