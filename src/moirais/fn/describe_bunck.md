...
`print(result)` render. See `moirais.fn.describe('bunck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bunck import *
import numpy as np
# See the function signature in fn/bunck.py for argument names.
```
