...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_876"]


def guide_on_data_analysis_chapter_14_unnumbered_876(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑉adjusted = 𝑉 − (𝑘𝐴 − 𝑘𝐵)ln(𝑛)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u876')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u876: GeneralStatistics expression (auto-extracted; see ref)."
