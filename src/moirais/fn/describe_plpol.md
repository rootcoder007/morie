...
`print(result)` render. See `moirais.fn.describe('plpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plpol import *
import numpy as np
# See the function signature in fn/plpol.py for argument names.
```
