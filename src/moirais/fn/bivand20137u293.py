...
__all__ = ["bivand2013_chapter_7_unnumbered_293"]


def bivand2013_chapter_7_unnumbered_293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + "data.frame"), model = "negbin", 99, region = which(nc$NAME ==
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u293')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u293: GeneralStatistics expression (auto-extracted; see ref)."
