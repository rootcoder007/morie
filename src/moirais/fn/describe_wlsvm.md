...
`print(result)` render. See `moirais.fn.describe('wlsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlsvm import *
import numpy as np
# See the function signature in fn/wlsvm.py for argument names.
```
