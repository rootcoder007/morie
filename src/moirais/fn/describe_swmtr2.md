...
`print(result)` render. See `moirais.fn.describe('swmtr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swmtr2 import *
import numpy as np
# See the function signature in fn/swmtr2.py for argument names.
```
