# describe('wsmmcd') — wasserman_mcdiarmid
...
`print(result)` render. See `moirais.fn.describe('wsmmcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmcd import *
import numpy as np
# See the function signature in fn/wsmmcd.py for argument names.
```
