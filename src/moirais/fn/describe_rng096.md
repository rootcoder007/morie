# describe('rng096') — rangayyan_ch3_hann_phase_response
...
`print(result)` render. See `moirais.fn.describe('rng096')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng096 import *
import numpy as np
# See the function signature in fn/rng096.py for argument names.
```
