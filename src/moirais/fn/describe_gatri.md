...
`print(result)` render. See `moirais.fn.describe('gatri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatri import *
import numpy as np
# See the function signature in fn/gatri.py for argument names.
```
