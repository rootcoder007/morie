...
`print(result)` render. See `moirais.fn.describe('micrR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.micrR import *
import numpy as np
# See the function signature in fn/micrR.py for argument names.
```
