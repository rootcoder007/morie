...
`print(result)` render. See `moirais.fn.describe('sis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sis import *
import numpy as np
# See the function signature in fn/sis.py for argument names.
```
