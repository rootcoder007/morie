# describe('hsirt') — heteroskedastic_irt
...
`print(result)` render. See `moirais.fn.describe('hsirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsirt import *
import numpy as np
# See the function signature in fn/hsirt.py for argument names.
```
