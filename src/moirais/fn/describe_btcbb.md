# describe('btcbb') — boot_circular_block
...
`print(result)` render. See `moirais.fn.describe('btcbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btcbb import *
import numpy as np
# See the function signature in fn/btcbb.py for argument names.
```
