...
`print(result)` render. See `moirais.fn.describe('opslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opslp import *
import numpy as np
# See the function signature in fn/opslp.py for argument names.
```
