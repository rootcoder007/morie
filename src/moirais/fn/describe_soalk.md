# describe('soalk') — soalk

## WHAT IT DOES

Alkalinity soil spatial
...
`print(result)` render. See `moirais.fn.describe('soalk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soalk import *
import numpy as np
# See the function signature in fn/soalk.py for argument names.
```
