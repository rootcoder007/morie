# describe('alkvc2') — alammar_kv_cache_lookup
...
`print(result)` render. See `moirais.fn.describe('alkvc2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alkvc2 import *
import numpy as np
# See the function signature in fn/alkvc2.py for argument names.
```
