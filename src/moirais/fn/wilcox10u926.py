...
__all__ = ["wilcox_chapter_10_unnumbered_926"]


def wilcox_chapter_10_unnumbered_926(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and with α = 0.01 and ν = 20, the critical value is 3.83.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u926')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u926: GeneralStatistics expression (auto-extracted; see ref)."
