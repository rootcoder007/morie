# describe('hmgand') — geron_anomaly_gmm
...
`print(result)` render. See `moirais.fn.describe('hmgand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgand import *
import numpy as np
# See the function signature in fn/hmgand.py for argument names.
```
