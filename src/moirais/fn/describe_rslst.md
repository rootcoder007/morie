...
`print(result)` render. See `moirais.fn.describe('rslst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rslst import *
import numpy as np
# See the function signature in fn/rslst.py for argument names.
```
