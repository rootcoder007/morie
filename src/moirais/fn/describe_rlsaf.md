# describe('rlsaf') — rls_adaptive_filter
...
`print(result)` render. See `moirais.fn.describe('rlsaf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlsaf import *
import numpy as np
# See the function signature in fn/rlsaf.py for argument names.
```
