...
`print(result)` render. See `moirais.fn.describe('mltan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mltan import *
import numpy as np
# See the function signature in fn/mltan.py for argument names.
```
