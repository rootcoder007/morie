...
`print(result)` render. See `moirais.fn.describe('ssmkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssmkrn import *
import numpy as np
# See the function signature in fn/ssmkrn.py for argument names.
```
