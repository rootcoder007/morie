# describe('gh_c4_21') — ghosal_inv_dp
...
`print(result)` render. See `moirais.fn.describe('gh_c4_21')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_21 import *
import numpy as np
# See the function signature in fn/gh_c4_21.py for argument names.
```
