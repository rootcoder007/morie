...
__all__ = ["hedderich_chapter_9_unnumbered_2476"]


def hedderich_chapter_9_unnumbered_2476(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˙Ri ˙R1 = 74 ˙R2 = 36 ˙R3 = 46
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2476')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2476: GeneralStatistics expression (auto-extracted; see ref)."
