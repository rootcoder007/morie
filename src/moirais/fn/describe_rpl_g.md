# describe('rpl_g') — rplace_by_gender
...
`print(result)` render. See `moirais.fn.describe('rpl_g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_g import *
import numpy as np
# See the function signature in fn/rpl_g.py for argument names.
```
