# describe('spcgme') — spatial_concordance_kappa
...
`print(result)` render. See `moirais.fn.describe('spcgme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcgme import *
import numpy as np
# See the function signature in fn/spcgme.py for argument names.
```
