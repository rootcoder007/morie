...
__all__ = ["law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_7"]


def law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_7(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] EVC = .7($50 - $1) + .3($43.30 - $3.30) = $46.30.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u7')`` for the full guide.
...
def cheatsheet():
    return "law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u7: GeneralStatistics expression (auto-extracted; see ref)."
