...
`print(result)` render. See `moirais.fn.describe('ppmkv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmkv import *
import numpy as np
# See the function signature in fn/ppmkv.py for argument names.
```
