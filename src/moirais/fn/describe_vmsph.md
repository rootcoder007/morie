...
`print(result)` render. See `moirais.fn.describe('vmsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmsph import *
import numpy as np
# See the function signature in fn/vmsph.py for argument names.
```
