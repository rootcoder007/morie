...
`print(result)` render. See `moirais.fn.describe('bayreg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayreg2 import *
import numpy as np
# See the function signature in fn/bayreg2.py for argument names.
```
