# describe('clusca') — clustering_coefficient
...
`print(result)` render. See `moirais.fn.describe('clusca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clusca import *
import numpy as np
# See the function signature in fn/clusca.py for argument names.
```
