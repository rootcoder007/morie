# describe('rgadp') — rangayyan_adaptive_filter
...
`print(result)` render. See `moirais.fn.describe('rgadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgadp import *
import numpy as np
# See the function signature in fn/rgadp.py for argument names.
```
