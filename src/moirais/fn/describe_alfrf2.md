# describe('alfrf2') — rfdiffusion_protein
...
`print(result)` render. See `moirais.fn.describe('alfrf2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfrf2 import *
import numpy as np
# See the function signature in fn/alfrf2.py for argument names.
```
