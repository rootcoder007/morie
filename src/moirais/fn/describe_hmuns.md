# describe('hmuns') — geron_unsupervised_learning
...
`print(result)` render. See `moirais.fn.describe('hmuns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmuns import *
import numpy as np
# See the function signature in fn/hmuns.py for argument names.
```
