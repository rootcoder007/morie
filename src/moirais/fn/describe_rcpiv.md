...
`print(result)` render. See `moirais.fn.describe('rcpiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcpiv import *
import numpy as np
# See the function signature in fn/rcpiv.py for argument names.
```
