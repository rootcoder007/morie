...
__all__ = ["wilcox_chapter_14_unnumbered_790"]


def wilcox_chapter_14_unnumbered_790(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ifF ≥ f , the 1 − α quantile of an F distribution with ν 1 =K − 1 andν 2 =N − JK
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u790')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u790: GeneralStatistics expression (auto-extracted; see ref)."
