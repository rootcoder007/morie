...
`print(result)` render. See `moirais.fn.describe('ceemf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ceemf import *
import numpy as np
# See the function signature in fn/ceemf.py for argument names.
```
