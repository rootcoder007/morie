# describe('anddr') — anderson_darling
...
`print(result)` render. See `moirais.fn.describe('anddr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anddr import *
import numpy as np
# See the function signature in fn/anddr.py for argument names.
```
