# describe('poispr') — poisson_predictive
...
`print(result)` render. See `moirais.fn.describe('poispr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poispr import *
import numpy as np
# See the function signature in fn/poispr.py for argument names.
```
