# describe('msm217') — mvsml_ridge_lasso_elastic_eq_9_33
...
`print(result)` render. See `moirais.fn.describe('msm217')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm217 import *
import numpy as np
# See the function signature in fn/msm217.py for argument names.
```
