...
`print(result)` render. See `moirais.fn.describe('wsmpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmpca import *
import numpy as np
# See the function signature in fn/wsmpca.py for argument names.
```
