...
`print(result)` render. See `moirais.fn.describe('cpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpi import *
import numpy as np
# See the function signature in fn/cpi.py for argument names.
```
