# describe('reportm') — report_noisy_max
...
`print(result)` render. See `moirais.fn.describe('reportm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reportm import *
import numpy as np
# See the function signature in fn/reportm.py for argument names.
```
