# describe('schfd') — schoenfeld_test
...
`print(result)` render. See `moirais.fn.describe('schfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.schfd import *
import numpy as np
# See the function signature in fn/schfd.py for argument names.
```
