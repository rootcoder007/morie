...
`print(result)` render. See `moirais.fn.describe('ucfR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ucfR import *
import numpy as np
# See the function signature in fn/ucfR.py for argument names.
```
