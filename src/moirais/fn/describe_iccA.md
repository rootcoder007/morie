# describe('iccA') — icc_absolute_agreement
...
`print(result)` render. See `moirais.fn.describe('iccA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iccA import *
import numpy as np
# See the function signature in fn/iccA.py for argument names.
```
