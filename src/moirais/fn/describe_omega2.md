...
`print(result)` render. See `moirais.fn.describe('omega2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omega2 import *
import numpy as np
# See the function signature in fn/omega2.py for argument names.
```
