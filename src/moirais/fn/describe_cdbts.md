...
`print(result)` render. See `moirais.fn.describe('cdbts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdbts import *
import numpy as np
# See the function signature in fn/cdbts.py for argument names.
```
