# describe('hmclsn') — geron_classification_mlp
...
`print(result)` render. See `moirais.fn.describe('hmclsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmclsn import *
import numpy as np
# See the function signature in fn/hmclsn.py for argument names.
```
