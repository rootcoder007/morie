...
`print(result)` render. See `moirais.fn.describe('entsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entsg import *
import numpy as np
# See the function signature in fn/entsg.py for argument names.
```
