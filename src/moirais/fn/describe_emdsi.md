...
`print(result)` render. See `moirais.fn.describe('emdsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdsi import *
import numpy as np
# See the function signature in fn/emdsi.py for argument names.
```
