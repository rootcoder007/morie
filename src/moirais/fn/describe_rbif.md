...
`print(result)` render. See `moirais.fn.describe('rbif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbif import *
import numpy as np
# See the function signature in fn/rbif.py for argument names.
```
