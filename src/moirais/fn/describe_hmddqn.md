# describe('hmddqn') — geron_double_dqn
...
`print(result)` render. See `moirais.fn.describe('hmddqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmddqn import *
import numpy as np
# See the function signature in fn/hmddqn.py for argument names.
```
