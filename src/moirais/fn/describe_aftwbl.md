...
`print(result)` render. See `moirais.fn.describe('aftwbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftwbl import *
import numpy as np
# See the function signature in fn/aftwbl.py for argument names.
```
