...
`print(result)` render. See `moirais.fn.describe('mcmpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcmpp import *
import numpy as np
# See the function signature in fn/mcmpp.py for argument names.
```
