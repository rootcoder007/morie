...
`print(result)` render. See `moirais.fn.describe('svmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmpl import *
import numpy as np
# See the function signature in fn/svmpl.py for argument names.
```
