...
`print(result)` render. See `moirais.fn.describe('stprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stprd import *
import numpy as np
# See the function signature in fn/stprd.py for argument names.
```
