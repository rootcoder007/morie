# describe('msm080') — mvsml_bayesian_regression_eq_6_11
...
`print(result)` render. See `moirais.fn.describe('msm080')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm080 import *
import numpy as np
# See the function signature in fn/msm080.py for argument names.
```
