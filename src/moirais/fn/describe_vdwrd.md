# describe('vdwrd') — van_der_waerden_test
...
`print(result)` render. See `moirais.fn.describe('vdwrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdwrd import *
import numpy as np
# See the function signature in fn/vdwrd.py for argument names.
```
