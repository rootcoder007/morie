...
__all__ = ["hedderich_chapter_9_unnumbered_2858"]


def hedderich_chapter_9_unnumbered_2858(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 46·120·53·41(53 + 41) = 1.017< 5.024 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2858')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2858: GeneralStatistics expression (auto-extracted; see ref)."
