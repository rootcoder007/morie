...
`print(result)` render. See `moirais.fn.describe('pgrank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgrank import *
import numpy as np
# See the function signature in fn/pgrank.py for argument names.
```
