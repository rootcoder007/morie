# describe('otprm') — ot_permutation_test_w1
...
`print(result)` render. See `moirais.fn.describe('otprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otprm import *
import numpy as np
# See the function signature in fn/otprm.py for argument names.
```
