...
`print(result)` render. See `moirais.fn.describe('epkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epkrn import *
import numpy as np
# See the function signature in fn/epkrn.py for argument names.
```
