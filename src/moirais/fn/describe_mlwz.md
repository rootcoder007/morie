# describe('mlwz') — multilevel_within_cluster_z
...
`print(result)` render. See `moirais.fn.describe('mlwz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlwz import *
import numpy as np
# See the function signature in fn/mlwz.py for argument names.
```
