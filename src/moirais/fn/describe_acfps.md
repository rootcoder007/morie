# describe('acfps') — acf_from_psd_fn
...
`print(result)` render. See `moirais.fn.describe('acfps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfps import *
import numpy as np
# See the function signature in fn/acfps.py for argument names.
```
