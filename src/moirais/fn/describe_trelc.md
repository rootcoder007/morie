...
`print(result)` render. See `moirais.fn.describe('trelc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trelc import *
import numpy as np
# See the function signature in fn/trelc.py for argument names.
```
