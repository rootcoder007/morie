# describe('btbasic') — boot_basic_ci
...
`print(result)` render. See `moirais.fn.describe('btbasic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btbasic import *
import numpy as np
# See the function signature in fn/btbasic.py for argument names.
```
