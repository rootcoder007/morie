# describe('gb1331t') — gibbons_t_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb1331t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1331t import *
import numpy as np
# See the function signature in fn/gb1331t.py for argument names.
```
