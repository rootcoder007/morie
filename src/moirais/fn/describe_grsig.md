...
`print(result)` render. See `moirais.fn.describe('grsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsig import *
import numpy as np
# See the function signature in fn/grsig.py for argument names.
```
