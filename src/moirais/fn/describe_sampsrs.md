...
`print(result)` render. See `moirais.fn.describe('sampsrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sampsrs import *
import numpy as np
# See the function signature in fn/sampsrs.py for argument names.
```
