# describe('timesf') — timesfm_foundation
...
`print(result)` render. See `moirais.fn.describe('timesf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.timesf import *
import numpy as np
# See the function signature in fn/timesf.py for argument names.
```
