# describe('isodst') — isotropy_distance_test
...
`print(result)` render. See `moirais.fn.describe('isodst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isodst import *
import numpy as np
# See the function signature in fn/isodst.py for argument names.
```
