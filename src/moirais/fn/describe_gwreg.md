...
`print(result)` render. See `moirais.fn.describe('gwreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwreg import *
import numpy as np
# See the function signature in fn/gwreg.py for argument names.
```
