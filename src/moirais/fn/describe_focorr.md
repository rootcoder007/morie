...
`print(result)` render. See `moirais.fn.describe('focorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focorr import *
import numpy as np
# See the function signature in fn/focorr.py for argument names.
```
