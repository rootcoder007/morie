# describe('rcnst') — sinc_reconstruct
...
`print(result)` render. See `moirais.fn.describe('rcnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcnst import *
import numpy as np
# See the function signature in fn/rcnst.py for argument names.
```
