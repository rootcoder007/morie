...
`print(result)` render. See `moirais.fn.describe('meteor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.meteor import *
import numpy as np
# See the function signature in fn/meteor.py for argument names.
```
