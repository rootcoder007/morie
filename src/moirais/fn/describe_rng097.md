# describe('rng097') — rangayyan_ch3_ma_8point
...
`print(result)` render. See `moirais.fn.describe('rng097')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng097 import *
import numpy as np
# See the function signature in fn/rng097.py for argument names.
```
