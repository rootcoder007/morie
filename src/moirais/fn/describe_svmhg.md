# describe('svmhg') — svm_hinge_primal
...
`print(result)` render. See `moirais.fn.describe('svmhg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmhg import *
import numpy as np
# See the function signature in fn/svmhg.py for argument names.
```
