# describe('hrzsic') — horowitz_sim_identification
...
`print(result)` render. See `moirais.fn.describe('hrzsic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsic import *
import numpy as np
# See the function signature in fn/hrzsic.py for argument names.
```
