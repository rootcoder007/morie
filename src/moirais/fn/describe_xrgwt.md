...
`print(result)` render. See `moirais.fn.describe('xrgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwt import *
import numpy as np
# See the function signature in fn/xrgwt.py for argument names.
```
