# describe('ctmed') — control_median_test
...
`print(result)` render. See `moirais.fn.describe('ctmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctmed import *
import numpy as np
# See the function signature in fn/ctmed.py for argument names.
```
