...
`print(result)` render. See `moirais.fn.describe('hmmdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmdp import *
import numpy as np
# See the function signature in fn/hmmdp.py for argument names.
```
