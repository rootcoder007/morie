...
__all__ = ["wilcox_chapter_13_unnumbered_1320"]


def wilcox_chapter_13_unnumbered_1320(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆpc = n1.n.1 + · · · +nR.n.R
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1320')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1320: GeneralStatistics expression (auto-extracted; see ref)."
