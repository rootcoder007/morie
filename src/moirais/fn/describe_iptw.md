...
`print(result)` render. See `moirais.fn.describe('iptw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iptw import *
import numpy as np
# See the function signature in fn/iptw.py for argument names.
```
