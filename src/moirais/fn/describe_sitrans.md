...
`print(result)` render. See `moirais.fn.describe('sitrans')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sitrans import *
import numpy as np
# See the function signature in fn/sitrans.py for argument names.
```
