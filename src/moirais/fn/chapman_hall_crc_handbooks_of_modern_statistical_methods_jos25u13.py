...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_13"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_13(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Proposition 2.1. If λ = λ(x) = Pr( Z = 1 | x), then
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u13')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u13: GeneralStatistics expression (auto-extracted; see ref)."
