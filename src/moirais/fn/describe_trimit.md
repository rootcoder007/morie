# describe('trimit') — weight_trimming
...
`print(result)` render. See `moirais.fn.describe('trimit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trimit import *
import numpy as np
# See the function signature in fn/trimit.py for argument names.
```
