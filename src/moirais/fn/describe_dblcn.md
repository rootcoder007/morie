# describe('dblcn') — double_centering
...
`print(result)` render. See `moirais.fn.describe('dblcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dblcn import *
import numpy as np
# See the function signature in fn/dblcn.py for argument names.
```
