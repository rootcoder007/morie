...
__all__ = ["hedderich_chapter_9_unnumbered_577"]


def hedderich_chapter_9_unnumbered_577(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] or: P (µ−kσ <X <µ+kσ)≥1−4/(9k2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u577')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u577: GeneralStatistics expression (auto-extracted; see ref)."
