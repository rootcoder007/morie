...
`print(result)` render. See `moirais.fn.describe('krgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgwt import *
import numpy as np
# See the function signature in fn/krgwt.py for argument names.
```
