...
__all__ = ["wilcox_chapter_15_unnumbered_1395"]


def wilcox_chapter_15_unnumbered_1395(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] tr(A) = 5 + 1 = 6 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1395')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1395: GeneralStatistics expression (auto-extracted; see ref)."
