# describe('swoop') — lift_drag_polar
...
`print(result)` render. See `moirais.fn.describe('swoop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swoop import *
import numpy as np
# See the function signature in fn/swoop.py for argument names.
```
