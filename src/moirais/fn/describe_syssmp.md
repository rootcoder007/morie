...
`print(result)` render. See `moirais.fn.describe('syssmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.syssmp import *
import numpy as np
# See the function signature in fn/syssmp.py for argument names.
```
