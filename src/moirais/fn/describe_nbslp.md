...
`print(result)` render. See `moirais.fn.describe('nbslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbslp import *
import numpy as np
# See the function signature in fn/nbslp.py for argument names.
```
