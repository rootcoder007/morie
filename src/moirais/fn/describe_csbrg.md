...
`print(result)` render. See `moirais.fn.describe('csbrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csbrg import *
import numpy as np
# See the function signature in fn/csbrg.py for argument names.
```
