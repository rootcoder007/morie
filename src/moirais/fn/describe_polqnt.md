# describe('polqnt') — polar_quantization
...
`print(result)` render. See `moirais.fn.describe('polqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polqnt import *
import numpy as np
# See the function signature in fn/polqnt.py for argument names.
```
