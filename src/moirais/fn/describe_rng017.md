# describe('rng017') — rangayyan_ch3_acf_ensemble_estimate
...
`print(result)` render. See `moirais.fn.describe('rng017')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng017 import *
import numpy as np
# See the function signature in fn/rng017.py for argument names.
```
