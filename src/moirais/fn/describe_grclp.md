# describe('grclp') — geron_clip_contrastive_loss
...
`print(result)` render. See `moirais.fn.describe('grclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grclp import *
import numpy as np
# See the function signature in fn/grclp.py for argument names.
```
