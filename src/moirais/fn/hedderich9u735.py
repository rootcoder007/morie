...
__all__ = ["hedderich_chapter_9_unnumbered_735"]


def hedderich_chapter_9_unnumbered_735(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u735')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u735: CountModels expression (auto-extracted; see ref)."
