...
`print(result)` render. See `moirais.fn.describe('ochi2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ochi2 import *
import numpy as np
# See the function signature in fn/ochi2.py for argument names.
```
