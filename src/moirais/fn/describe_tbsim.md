...
`print(result)` render. See `moirais.fn.describe('tbsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbsim import *
import numpy as np
# See the function signature in fn/tbsim.py for argument names.
```
