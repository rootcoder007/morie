...
`print(result)` render. See `moirais.fn.describe('gcjet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcjet import *
import numpy as np
# See the function signature in fn/gcjet.py for argument names.
```
