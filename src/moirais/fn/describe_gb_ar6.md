# describe('gb_ar6') — gibbons_are_unif
...
`print(result)` render. See `moirais.fn.describe('gb_ar6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ar6 import *
import numpy as np
# See the function signature in fn/gb_ar6.py for argument names.
```
