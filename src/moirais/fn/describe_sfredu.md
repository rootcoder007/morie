...
`print(result)` render. See `moirais.fn.describe('sfredu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfredu import *
import numpy as np
# See the function signature in fn/sfredu.py for argument names.
```
