...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_14"]


def guide_on_data_analysis_chapter_2_unnumbered_14(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = {−X−1J𝑖𝑖X−1, 𝑖 = 𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u14')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u14: GeneralStatistics expression (auto-extracted; see ref)."
