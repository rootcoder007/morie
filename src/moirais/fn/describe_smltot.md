...
`print(result)` render. See `moirais.fn.describe('smltot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smltot import *
import numpy as np
# See the function signature in fn/smltot.py for argument names.
```
