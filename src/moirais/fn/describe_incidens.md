# describe('incidens') — incidence_rate
...
`print(result)` render. See `moirais.fn.describe('incidens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.incidens import *
import numpy as np
# See the function signature in fn/incidens.py for argument names.
```
