...
`print(result)` render. See `moirais.fn.describe('srsxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srsxe import *
import numpy as np
# See the function signature in fn/srsxe.py for argument names.
```
