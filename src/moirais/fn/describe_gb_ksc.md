# describe('gb_ksc') — gibbons_ks_cvm_comparison
...
`print(result)` render. See `moirais.fn.describe('gb_ksc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ksc import *
import numpy as np
# See the function signature in fn/gb_ksc.py for argument names.
```
