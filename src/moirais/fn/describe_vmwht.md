...
`print(result)` render. See `moirais.fn.describe('vmwht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmwht import *
import numpy as np
# See the function signature in fn/vmwht.py for argument names.
```
