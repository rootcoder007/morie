...
`print(result)` render. See `moirais.fn.describe('trdrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdrn import *
import numpy as np
# See the function signature in fn/trdrn.py for argument names.
```
