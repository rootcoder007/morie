# describe('rgwav') — rangayyan_wavelet_denoise
...
`print(result)` render. See `moirais.fn.describe('rgwav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwav import *
import numpy as np
# See the function signature in fn/rgwav.py for argument names.
```
