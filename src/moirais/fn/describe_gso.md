# describe('gso') — gram_schmidt_orth
...
`print(result)` render. See `moirais.fn.describe('gso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gso import *
import numpy as np
# See the function signature in fn/gso.py for argument names.
```
