...
`print(result)` render. See `moirais.fn.describe('dtft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtft import *
import numpy as np
# See the function signature in fn/dtft.py for argument names.
```
