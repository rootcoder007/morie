...
`print(result)` render. See `moirais.fn.describe('vacnnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vacnnt import *
import numpy as np
# See the function signature in fn/vacnnt.py for argument names.
```
