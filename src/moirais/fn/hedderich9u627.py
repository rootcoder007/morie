...
__all__ = ["hedderich_chapter_9_unnumbered_627"]


def hedderich_chapter_9_unnumbered_627(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] and P (X =x−1) = x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u627')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u627: CountModels expression (auto-extracted; see ref)."
