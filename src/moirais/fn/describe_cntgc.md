# describe('cntgc') — contingency_coefficient
...
`print(result)` render. See `moirais.fn.describe('cntgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cntgc import *
import numpy as np
# See the function signature in fn/cntgc.py for argument names.
```
