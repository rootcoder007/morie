...
`print(result)` render. See `moirais.fn.describe('ubwst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubwst import *
import numpy as np
# See the function signature in fn/ubwst.py for argument names.
```
