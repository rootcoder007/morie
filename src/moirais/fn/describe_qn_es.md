...
`print(result)` render. See `moirais.fn.describe('qn_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qn_es import *
import numpy as np
# See the function signature in fn/qn_es.py for argument names.
```
