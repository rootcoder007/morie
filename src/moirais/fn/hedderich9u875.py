...
__all__ = ["hedderich_chapter_9_unnumbered_875"]


def hedderich_chapter_9_unnumbered_875(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: σ and zb = b−µ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u875')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u875: GeneralStatistics expression (auto-extracted; see ref)."
