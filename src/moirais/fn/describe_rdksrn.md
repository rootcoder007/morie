...
`print(result)` render. See `moirais.fn.describe('rdksrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdksrn import *
import numpy as np
# See the function signature in fn/rdksrn.py for argument names.
```
