...
`print(result)` render. See `moirais.fn.describe('llama')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.llama import *
import numpy as np
# See the function signature in fn/llama.py for argument names.
```
