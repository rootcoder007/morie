...
`print(result)` render. See `moirais.fn.describe('mdprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdprt import *
import numpy as np
# See the function signature in fn/mdprt.py for argument names.
```
