...
`print(result)` render. See `moirais.fn.describe('msvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msvor import *
import numpy as np
# See the function signature in fn/msvor.py for argument names.
```
