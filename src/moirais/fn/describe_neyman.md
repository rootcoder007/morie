# describe('neyman') — neyman_allocation
...
`print(result)` render. See `moirais.fn.describe('neyman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neyman import *
import numpy as np
# See the function signature in fn/neyman.py for argument names.
```
