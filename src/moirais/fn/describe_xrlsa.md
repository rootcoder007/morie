...
`print(result)` render. See `moirais.fn.describe('xrlsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlsa import *
import numpy as np
# See the function signature in fn/xrlsa.py for argument names.
```
