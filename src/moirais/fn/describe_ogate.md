...
`print(result)` render. See `moirais.fn.describe('ogate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ogate import *
import numpy as np
# See the function signature in fn/ogate.py for argument names.
```
