...
__all__ = ["hedderich_chapter_9_unnumbered_2753"]


def hedderich_chapter_9_unnumbered_2753(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: In total:P =P1 +P2 +P3 = 0.0167 + 0.0013 + 0.0000 = 0.018.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2753')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2753: GeneralStatistics expression (auto-extracted; see ref)."
