...
__all__ = ["hedderich_chapter_9_unnumbered_1576"]


def hedderich_chapter_9_unnumbered_1576(x):
    """
    Bayesian expression (auto-extracted; see ref).

    Formula: µ∗= µ0·σ2/n + ¯x·σ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1576')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1576: Bayesian expression (auto-extracted; see ref)."
