...
`print(result)` render. See `moirais.fn.describe('irtml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtml import *
import numpy as np
# See the function signature in fn/irtml.py for argument names.
```
