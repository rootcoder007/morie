# describe('tmlcvc') — tmle_cv_targeting
...
`print(result)` render. See `moirais.fn.describe('tmlcvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcvc import *
import numpy as np
# See the function signature in fn/tmlcvc.py for argument names.
```
