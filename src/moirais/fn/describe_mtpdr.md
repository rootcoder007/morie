...
`print(result)` render. See `moirais.fn.describe('mtpdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtpdr import *
import numpy as np
# See the function signature in fn/mtpdr.py for argument names.
```
