...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_136"]


def information_theory_mackay_chapter_6_unnumbered_136(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] N = 1 N = 2 N = 4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u136')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u136: GeneralStatistics expression (auto-extracted; see ref)."
