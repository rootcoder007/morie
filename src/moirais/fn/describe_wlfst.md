...
`print(result)` render. See `moirais.fn.describe('wlfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlfst import *
import numpy as np
# See the function signature in fn/wlfst.py for argument names.
```
