...
`print(result)` render. See `moirais.fn.describe('svwpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwpm import *
import numpy as np
# See the function signature in fn/svwpm.py for argument names.
```
