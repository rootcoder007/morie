...
`print(result)` render. See `moirais.fn.describe('prgrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgrl import *
import numpy as np
# See the function signature in fn/prgrl.py for argument names.
```
