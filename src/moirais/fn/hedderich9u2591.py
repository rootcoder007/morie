...
__all__ = ["hedderich_chapter_9_unnumbered_2591"]


def hedderich_chapter_9_unnumbered_2591(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Table 7.56: Significant differencesD from percentages (n =n1 =n2≥100,α= 0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2591')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2591: GeneralStatistics expression (auto-extracted; see ref)."
