...
__all__ = ["wilcox_chapter_10_unnumbered_1039"]


def wilcox_chapter_10_unnumbered_1039(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: bwwmcppb(J, K, L, x, tr = 0.2, JKL = J * K * L, con = 0, alpha = 0.05, grp =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1039')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1039: GeneralStatistics expression (auto-extracted; see ref)."
