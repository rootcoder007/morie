...
`print(result)` render. See `moirais.fn.describe('pains3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pains3 import *
import numpy as np
# See the function signature in fn/pains3.py for argument names.
```
