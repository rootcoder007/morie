...
`print(result)` render. See `moirais.fn.describe('isngm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isngm import *
import numpy as np
# See the function signature in fn/isngm.py for argument names.
```
