...
__all__ = ["wilcox_chapter_13_unnumbered_1113"]


def wilcox_chapter_13_unnumbered_1113(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: regYband(x, y, regfun = tsreg, npts = NULL, nboot = 100, xout = FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1113')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1113: GeneralStatistics expression (auto-extracted; see ref)."
