...
__all__ = ["hedderich_chapter_9_unnumbered_2306"]


def hedderich_chapter_9_unnumbered_2306(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: hypotheses are correct (m0 = 0), thenV = 0 and in particularFDR = 0 andFWER = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2306')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2306: GeneralStatistics expression (auto-extracted; see ref)."
