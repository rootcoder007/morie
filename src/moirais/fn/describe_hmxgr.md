# describe('hmxgr') — geron_exploding_gradients
...
`print(result)` render. See `moirais.fn.describe('hmxgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmxgr import *
import numpy as np
# See the function signature in fn/hmxgr.py for argument names.
```
