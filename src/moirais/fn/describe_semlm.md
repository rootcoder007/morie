...
`print(result)` render. See `moirais.fn.describe('semlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semlm import *
import numpy as np
# See the function signature in fn/semlm.py for argument names.
```
