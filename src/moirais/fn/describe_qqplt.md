...
`print(result)` render. See `moirais.fn.describe('qqplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qqplt import *
import numpy as np
# See the function signature in fn/qqplt.py for argument names.
```
