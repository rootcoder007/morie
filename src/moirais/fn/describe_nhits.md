...
`print(result)` render. See `moirais.fn.describe('nhits')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nhits import *
import numpy as np
# See the function signature in fn/nhits.py for argument names.
```
