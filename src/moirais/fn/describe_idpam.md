...
`print(result)` render. See `moirais.fn.describe('idpam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpam import *
import numpy as np
# See the function signature in fn/idpam.py for argument names.
```
