# describe('sgqdr') — quadrat_count_test
...
`print(result)` render. See `moirais.fn.describe('sgqdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgqdr import *
import numpy as np
# See the function signature in fn/sgqdr.py for argument names.
```
