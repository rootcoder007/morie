# describe('cvm') — cramer_von_mises_test
...
`print(result)` render. See `moirais.fn.describe('cvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvm import *
import numpy as np
# See the function signature in fn/cvm.py for argument names.
```
