# describe('sppair') — schabenberger_pair_correlation
...
`print(result)` render. See `moirais.fn.describe('sppair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppair import *
import numpy as np
# See the function signature in fn/sppair.py for argument names.
```
