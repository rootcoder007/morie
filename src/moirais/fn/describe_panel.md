# describe('panel') — panel_regression
...
`print(result)` render. See `moirais.fn.describe('panel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.panel import *
import numpy as np
# See the function signature in fn/panel.py for argument names.
```
