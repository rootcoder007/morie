...
`print(result)` render. See `moirais.fn.describe('stkanim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkanim import *
import numpy as np
# See the function signature in fn/stkanim.py for argument names.
```
