...
`print(result)` render. See `moirais.fn.describe('vqgenc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vqgenc import *
import numpy as np
# See the function signature in fn/vqgenc.py for argument names.
```
