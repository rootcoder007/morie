...
`print(result)` render. See `moirais.fn.describe('agbck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbck import *
import numpy as np
# See the function signature in fn/agbck.py for argument names.
```
