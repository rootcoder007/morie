...
`print(result)` render. See `moirais.fn.describe('waved')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.waved import *
import numpy as np
# See the function signature in fn/waved.py for argument names.
```
