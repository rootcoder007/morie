# describe('tmlnsm') — tmle_non_smooth
...
`print(result)` render. See `moirais.fn.describe('tmlnsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnsm import *
import numpy as np
# See the function signature in fn/tmlnsm.py for argument names.
```
