...
`print(result)` render. See `moirais.fn.describe('dfreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfreg import *
import numpy as np
# See the function signature in fn/dfreg.py for argument names.
```
