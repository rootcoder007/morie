...
`print(result)` render. See `moirais.fn.describe('t5enc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.t5enc import *
import numpy as np
# See the function signature in fn/t5enc.py for argument names.
```
