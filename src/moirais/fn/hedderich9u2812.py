...
__all__ = ["hedderich_chapter_9_unnumbered_2812"]


def hedderich_chapter_9_unnumbered_2812(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] > npwr . mcnemar ( p = 0 . 1 2 5 , p s i = 3 . 2 , n =40)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2812')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2812: PowerAndDesign expression (auto-extracted; see ref)."
