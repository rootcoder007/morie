...
__all__ = ["hedderich_chapter_9_unnumbered_245"]


def hedderich_chapter_9_unnumbered_245(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [compare 100−5.13 = 94.87; 5.13% of 94.87 equals 4.87 and 94.87−4.87 = 90 ].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u245')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u245: GeneralStatistics expression (auto-extracted; see ref)."
