# describe('xrgwc') — gwr_coefficients
...
`print(result)` render. See `moirais.fn.describe('xrgwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwc import *
import numpy as np
# See the function signature in fn/xrgwc.py for argument names.
```
