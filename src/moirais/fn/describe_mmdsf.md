# describe('mmdsf') — metric_mds_torgerson
...
`print(result)` render. See `moirais.fn.describe('mmdsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmdsf import *
import numpy as np
# See the function signature in fn/mmdsf.py for argument names.
```
