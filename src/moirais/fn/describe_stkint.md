...
`print(result)` render. See `moirais.fn.describe('stkint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkint import *
import numpy as np
# See the function signature in fn/stkint.py for argument names.
```
