...
`print(result)` render. See `moirais.fn.describe('lampv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lampv import *
import numpy as np
# See the function signature in fn/lampv.py for argument names.
```
