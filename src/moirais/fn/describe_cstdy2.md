# describe('cstdy2') — custody_days_credit
...
`print(result)` render. See `moirais.fn.describe('cstdy2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstdy2 import *
import numpy as np
# See the function signature in fn/cstdy2.py for argument names.
```
