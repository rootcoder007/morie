# describe('metabd') — metagenome_binning
...
`print(result)` render. See `moirais.fn.describe('metabd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.metabd import *
import numpy as np
# See the function signature in fn/metabd.py for argument names.
```
