...
__all__ = ["wilcox_chapter_9_unnumbered_1081"]


def wilcox_chapter_9_unnumbered_1081(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: x=rmul(100,p=5,mar.fun=ghdist,h=0.2,rho=0.7)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1081')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1081: GeneralStatistics expression (auto-extracted; see ref)."
