...
`print(result)` render. See `moirais.fn.describe('spcgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcgm import *
import numpy as np
# See the function signature in fn/spcgm.py for argument names.
```
