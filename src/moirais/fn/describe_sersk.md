...
`print(result)` render. See `moirais.fn.describe('sersk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sersk import *
import numpy as np
# See the function signature in fn/sersk.py for argument names.
```
