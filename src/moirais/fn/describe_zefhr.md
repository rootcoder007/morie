...
`print(result)` render. See `moirais.fn.describe('zefhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zefhr import *
import numpy as np
# See the function signature in fn/zefhr.py for argument names.
```
