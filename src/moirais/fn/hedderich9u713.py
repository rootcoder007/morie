...
__all__ = ["hedderich_chapter_9_unnumbered_713"]


def hedderich_chapter_9_unnumbered_713(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 2) = λ2e−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u713')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u713: GeneralStatistics expression (auto-extracted; see ref)."
