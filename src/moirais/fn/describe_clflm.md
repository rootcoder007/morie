...
`print(result)` render. See `moirais.fn.describe('clflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clflm import *
import numpy as np
# See the function signature in fn/clflm.py for argument names.
```
