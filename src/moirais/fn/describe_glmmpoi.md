...
`print(result)` render. See `moirais.fn.describe('glmmpoi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmpoi import *
import numpy as np
# See the function signature in fn/glmmpoi.py for argument names.
```
