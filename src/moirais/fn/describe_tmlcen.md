# describe('tmlcen') — tmle_censoring
...
`print(result)` render. See `moirais.fn.describe('tmlcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcen import *
import numpy as np
# See the function signature in fn/tmlcen.py for argument names.
```
