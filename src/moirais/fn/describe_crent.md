...
`print(result)` render. See `moirais.fn.describe('crent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crent import *
import numpy as np
# See the function signature in fn/crent.py for argument names.
```
