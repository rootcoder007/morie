# describe('gh_c3_12') — ghosal_polya_tree_def
...
`print(result)` render. See `moirais.fn.describe('gh_c3_12')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_12 import *
import numpy as np
# See the function signature in fn/gh_c3_12.py for argument names.
```
