...
`print(result)` render. See `moirais.fn.describe('dat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dat import *
import numpy as np
# See the function signature in fn/dat.py for argument names.
```
