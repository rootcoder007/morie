# describe('linprm') — linear_programming
...
`print(result)` render. See `moirais.fn.describe('linprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linprm import *
import numpy as np
# See the function signature in fn/linprm.py for argument names.
```
