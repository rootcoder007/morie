# describe('bcntr') — bayesian_contraction_rate
...
`print(result)` render. See `moirais.fn.describe('bcntr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcntr import *
import numpy as np
# See the function signature in fn/bcntr.py for argument names.
```
