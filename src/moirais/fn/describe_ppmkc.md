...
`print(result)` render. See `moirais.fn.describe('ppmkc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmkc import *
import numpy as np
# See the function signature in fn/ppmkc.py for argument names.
```
