# describe('lmsreg') — least_median_squares
...
`print(result)` render. See `moirais.fn.describe('lmsreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmsreg import *
import numpy as np
# See the function signature in fn/lmsreg.py for argument names.
```
