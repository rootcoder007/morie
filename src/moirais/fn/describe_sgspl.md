...
`print(result)` render. See `moirais.fn.describe('sgspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgspl import *
import numpy as np
# See the function signature in fn/sgspl.py for argument names.
```
