# describe('volbpv') — vol_bipower_variation
...
`print(result)` render. See `moirais.fn.describe('volbpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volbpv import *
import numpy as np
# See the function signature in fn/volbpv.py for argument names.
```
