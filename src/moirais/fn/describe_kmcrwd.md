# describe('kmcrwd') — kamath_crowspairs_bias
...
`print(result)` render. See `moirais.fn.describe('kmcrwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcrwd import *
import numpy as np
# See the function signature in fn/kmcrwd.py for argument names.
```
