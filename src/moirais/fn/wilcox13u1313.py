...
__all__ = ["wilcox_chapter_13_unnumbered_1313"]


def wilcox_chapter_13_unnumbered_1313(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Y = 0 (Low) 1 − π (1) 1 − π (0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1313')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1313: GeneralStatistics expression (auto-extracted; see ref)."
