...
`print(result)` render. See `moirais.fn.describe('gcnao')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcnao import *
import numpy as np
# See the function signature in fn/gcnao.py for argument names.
```
