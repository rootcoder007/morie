# describe('genrgr') — calibration_greg
...
`print(result)` render. See `moirais.fn.describe('genrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genrgr import *
import numpy as np
# See the function signature in fn/genrgr.py for argument names.
```
