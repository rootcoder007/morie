...
__all__ = ["hedderich_chapter_9_unnumbered_760"]


def hedderich_chapter_9_unnumbered_760(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example:P (X≤1|10; 5; 5) = 0.103; ˆz (according to 5.90) = 1.298, i.e.P = 0.0971; with 0.75;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u760')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u760: GeneralStatistics expression (auto-extracted; see ref)."
