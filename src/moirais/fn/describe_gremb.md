# describe('gremb') — geron_embedding_lookup
...
`print(result)` render. See `moirais.fn.describe('gremb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gremb import *
import numpy as np
# See the function signature in fn/gremb.py for argument names.
```
