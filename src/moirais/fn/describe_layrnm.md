...
`print(result)` render. See `moirais.fn.describe('layrnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.layrnm import *
import numpy as np
# See the function signature in fn/layrnm.py for argument names.
```
