# describe('lftbl') — life_table_complete
...
`print(result)` render. See `moirais.fn.describe('lftbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lftbl import *
import numpy as np
# See the function signature in fn/lftbl.py for argument names.
```
