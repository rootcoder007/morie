# describe('spdetr') — spatial_detrending
...
`print(result)` render. See `moirais.fn.describe('spdetr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spdetr import *
import numpy as np
# See the function signature in fn/spdetr.py for argument names.
```
