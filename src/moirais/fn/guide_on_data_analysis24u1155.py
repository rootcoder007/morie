...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1155"]


def guide_on_data_analysis_chapter_24_unnumbered_1155(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝐻0 ∶ 𝜇𝑖𝑗 − 𝜇𝑖.. − 𝜇.𝑗. + 𝜇.. = 0 (No interaction)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1155')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1155: GeneralStatistics expression (auto-extracted; see ref)."
