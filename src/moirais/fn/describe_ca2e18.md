# describe('ca2e18') — ca_chapter_2_equation_18
...
F Δ = SSresidual Restricted() − SSresidual Full()
...
```python
from moirais.fn.ca2e18 import ca_chapter_2_equation_18
import numpy as np
result = ca_chapter_2_equation_18(np.random.default_rng(42).normal(0, 1, 100))
