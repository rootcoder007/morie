# describe('protdis') — protein_disorder
...
`print(result)` render. See `moirais.fn.describe('protdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.protdis import *
import numpy as np
# See the function signature in fn/protdis.py for argument names.
```
