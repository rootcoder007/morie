# describe('astlb') — astle_balding_grm
...
`print(result)` render. See `moirais.fn.describe('astlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.astlb import *
import numpy as np
# See the function signature in fn/astlb.py for argument names.
```
