# describe('km127') — kamath_ch8_geval_score
...
`print(result)` render. See `moirais.fn.describe('km127')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km127 import *
import numpy as np
# See the function signature in fn/km127.py for argument names.
```
