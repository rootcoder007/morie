# describe('arlin') — areal_interpolation
...
`print(result)` render. See `moirais.fn.describe('arlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arlin import *
import numpy as np
# See the function signature in fn/arlin.py for argument names.
```
