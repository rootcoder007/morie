...
__all__ = ["hedderich_chapter_9_unnumbered_2533"]


def hedderich_chapter_9_unnumbered_2533(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |RS−RB|= |21−57|= 36
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2533')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2533: GeneralStatistics expression (auto-extracted; see ref)."
