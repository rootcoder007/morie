# describe('itflr') — item_floor_ceiling
...
`print(result)` render. See `moirais.fn.describe('itflr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itflr import *
import numpy as np
# See the function signature in fn/itflr.py for argument names.
```
