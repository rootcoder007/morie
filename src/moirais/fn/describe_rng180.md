# describe('rng180') — rangayyan_ch4_qrs_smoothing_ma_filter
...
`print(result)` render. See `moirais.fn.describe('rng180')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng180 import *
import numpy as np
# See the function signature in fn/rng180.py for argument names.
```
