...
`print(result)` render. See `moirais.fn.describe('xrmgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrmgw import *
import numpy as np
# See the function signature in fn/xrmgw.py for argument names.
```
