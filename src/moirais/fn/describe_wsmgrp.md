# describe('wsmgrp') — wasserman_graphical_model
...
`print(result)` render. See `moirais.fn.describe('wsmgrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmgrp import *
import numpy as np
# See the function signature in fn/wsmgrp.py for argument names.
```
