# describe('incub') — incubation_period
...
`print(result)` render. See `moirais.fn.describe('incub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.incub import *
import numpy as np
# See the function signature in fn/incub.py for argument names.
```
