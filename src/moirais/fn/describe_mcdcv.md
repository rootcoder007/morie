# describe('mcdcv') — min_covariance_determinant
...
`print(result)` render. See `moirais.fn.describe('mcdcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcdcv import *
import numpy as np
# See the function signature in fn/mcdcv.py for argument names.
```
