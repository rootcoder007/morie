# describe('arord') — ar_order_select
...
`print(result)` render. See `moirais.fn.describe('arord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arord import *
import numpy as np
# See the function signature in fn/arord.py for argument names.
```
