# describe('gbdrf') — gbd_risk_factor
...
`print(result)` render. See `moirais.fn.describe('gbdrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbdrf import *
import numpy as np
# See the function signature in fn/gbdrf.py for argument names.
```
