# describe('linrg') — linear_regression_ols
...
`print(result)` render. See `moirais.fn.describe('linrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linrg import *
import numpy as np
# See the function signature in fn/linrg.py for argument names.
```
