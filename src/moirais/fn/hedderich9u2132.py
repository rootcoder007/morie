...
__all__ = ["hedderich_chapter_9_unnumbered_2132"]


def hedderich_chapter_9_unnumbered_2132(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SinceU = 9 > 3 = U (6; 5; 0.05; two−sided),H0 is not rejected at the 5% level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2132')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2132: GeneralStatistics expression (auto-extracted; see ref)."
