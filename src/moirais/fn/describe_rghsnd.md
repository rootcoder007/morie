# describe('rghsnd') — rangayyan_heart_sound_id
...
`print(result)` render. See `moirais.fn.describe('rghsnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghsnd import *
import numpy as np
# See the function signature in fn/rghsnd.py for argument names.
```
