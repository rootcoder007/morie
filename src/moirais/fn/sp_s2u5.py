...
__all__ = ["stochastic_physics_section_2_unnumbered_5"]


def stochastic_physics_section_2_unnumbered_5(x):
    """
    GeneralStochastic expression (auto-extracted; see reference).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('sp_s2u5')`` for the full guide.
...
def cheatsheet():
    return "sp_s2u5: GeneralStochastic expression (auto-extracted; see reference)."
