...
`print(result)` render. See `moirais.fn.describe('sensSlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sensSlp import *
import numpy as np
# See the function signature in fn/sensSlp.py for argument names.
```
