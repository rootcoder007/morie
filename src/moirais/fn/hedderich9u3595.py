...
__all__ = ["hedderich_chapter_9_unnumbered_3595"]


def hedderich_chapter_9_unnumbered_3595(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (δi·log(λ)−λ·Yi)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3595')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3595: GeneralStatistics expression (auto-extracted; see ref)."
