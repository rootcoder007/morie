# describe('rpl_r') — rplace_by_region
...
`print(result)` render. See `moirais.fn.describe('rpl_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_r import *
import numpy as np
# See the function signature in fn/rpl_r.py for argument names.
```
