# describe('medML') — ml_mediation_dml
...
`print(result)` render. See `moirais.fn.describe('medML')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medML import *
import numpy as np
# See the function signature in fn/medML.py for argument names.
```
