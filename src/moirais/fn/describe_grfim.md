# describe('grfim') — geron_feature_importance_mdi
...
`print(result)` render. See `moirais.fn.describe('grfim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grfim import *
import numpy as np
# See the function signature in fn/grfim.py for argument names.
```
