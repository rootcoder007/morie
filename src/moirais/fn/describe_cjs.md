# describe('cjs') — cjs_flow

## WHAT IT DOES

CJS flow / attrition calculation. 'Character is destiny. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('cjs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cjs import *
import numpy as np
# See the function signature in fn/cjs.py for argument names.
```
