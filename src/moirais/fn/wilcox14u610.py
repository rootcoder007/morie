...
__all__ = ["wilcox_chapter_14_unnumbered_610"]


def wilcox_chapter_14_unnumbered_610(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] twobinom(r1 = sum(x), n1 = length(x), r2 = sum(y), n2 = length(y), x = NA, y
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u610')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u610: PowerAndDesign expression (auto-extracted; see ref)."
