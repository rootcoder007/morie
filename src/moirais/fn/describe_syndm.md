# describe('syndm') — syndromic_score
...
`print(result)` render. See `moirais.fn.describe('syndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.syndm import *
import numpy as np
# See the function signature in fn/syndm.py for argument names.
```
