...
`print(result)` render. See `moirais.fn.describe('backDR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.backDR import *
import numpy as np
# See the function signature in fn/backDR.py for argument names.
```
