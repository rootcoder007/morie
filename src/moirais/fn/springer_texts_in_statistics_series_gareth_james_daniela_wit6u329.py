...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_329"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_329(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > y=1*(x1^2-x2^2 > 0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u329')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u329: GeneralStatistics expression (auto-extracted; see ref)."
