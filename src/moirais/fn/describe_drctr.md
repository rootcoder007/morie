...
`print(result)` render. See `moirais.fn.describe('drctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drctr import *
import numpy as np
# See the function signature in fn/drctr.py for argument names.
```
