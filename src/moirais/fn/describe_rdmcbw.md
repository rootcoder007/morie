# describe('rdmcbw') — mse_optimal_bandwidth_rdd
...
`print(result)` render. See `moirais.fn.describe('rdmcbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdmcbw import *
import numpy as np
# See the function signature in fn/rdmcbw.py for argument names.
```
