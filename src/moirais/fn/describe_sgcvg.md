# describe('sgcvg') — cross_validation_variogram
...
`print(result)` render. See `moirais.fn.describe('sgcvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcvg import *
import numpy as np
# See the function signature in fn/sgcvg.py for argument names.
```
