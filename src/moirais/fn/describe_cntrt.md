# describe('cntrt') — centroidal_time
...
`print(result)` render. See `moirais.fn.describe('cntrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cntrt import *
import numpy as np
# See the function signature in fn/cntrt.py for argument names.
```
