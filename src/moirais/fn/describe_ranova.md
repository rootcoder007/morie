# describe('ranova') — random_effects_anova_decomp
...
`print(result)` render. See `moirais.fn.describe('ranova')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ranova import *
import numpy as np
# See the function signature in fn/ranova.py for argument names.
```
