...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_826"]


def guide_on_data_analysis_chapter_11_unnumbered_826(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> z = 0.39906, p-value = 0.6551
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u826')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u826: GeneralStatistics expression (auto-extracted; see ref)."
