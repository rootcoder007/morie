# describe('ksr18') — kosorok_nelson_aalen
...
`print(result)` render. See `moirais.fn.describe('ksr18')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr18 import *
import numpy as np
# See the function signature in fn/ksr18.py for argument names.
```
