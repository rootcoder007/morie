...
`print(result)` render. See `moirais.fn.describe('paran')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paran import *
import numpy as np
# See the function signature in fn/paran.py for argument names.
```
