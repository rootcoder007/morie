...
__all__ = ["hedderich_chapter_9_unnumbered_3555"]


def hedderich_chapter_9_unnumbered_3555(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] P (E) = 1−S1 +S2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3555')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3555: PowerAndDesign expression (auto-extracted; see ref)."
