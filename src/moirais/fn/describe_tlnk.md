...
`print(result)` render. See `moirais.fn.describe('tlnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tlnk import *
import numpy as np
# See the function signature in fn/tlnk.py for argument names.
```
