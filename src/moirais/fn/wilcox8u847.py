...
__all__ = ["wilcox_chapter_8_unnumbered_847"]


def wilcox_chapter_8_unnumbered_847(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: blob= aov(dv ∼ myfactor + Error (subject/myfactor), data=mydata)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u847')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u847: GeneralStatistics expression (auto-extracted; see ref)."
