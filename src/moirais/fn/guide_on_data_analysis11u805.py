...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_805"]


def guide_on_data_analysis_chapter_11_unnumbered_805(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑔𝑚𝑡 = 𝑋𝑖𝑡𝛽𝑖 + 𝐼𝑗𝑡𝛼𝑖 + 𝛾𝑔 + 𝑢𝑖𝑗𝑔𝑚𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u805')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u805: GeneralStatistics expression (auto-extracted; see ref)."
