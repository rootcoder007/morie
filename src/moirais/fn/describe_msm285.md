# describe('msm285') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm285')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm285 import *
import numpy as np
# See the function signature in fn/msm285.py for argument names.
```
