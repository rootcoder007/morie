# describe('spglmk') — schabenberger_spatial_glm_kriging
...
`print(result)` render. See `moirais.fn.describe('spglmk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spglmk import *
import numpy as np
# See the function signature in fn/spglmk.py for argument names.
```
