...
`print(result)` render. See `moirais.fn.describe('vmswt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmswt import *
import numpy as np
# See the function signature in fn/vmswt.py for argument names.
```
