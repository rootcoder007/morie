...
`print(result)` render. See `moirais.fn.describe('tsstp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstp import *
import numpy as np
# See the function signature in fn/tsstp.py for argument names.
```
