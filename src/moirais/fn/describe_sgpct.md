...
`print(result)` render. See `moirais.fn.describe('sgpct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpct import *
import numpy as np
# See the function signature in fn/sgpct.py for argument names.
```
