# describe('grcvs') — geron_cross_validation_score
...
`print(result)` render. See `moirais.fn.describe('grcvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcvs import *
import numpy as np
# See the function signature in fn/grcvs.py for argument names.
```
