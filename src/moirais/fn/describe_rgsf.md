# describe('rgsf') — rangayyan_signal_features
...
`print(result)` render. See `moirais.fn.describe('rgsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsf import *
import numpy as np
# See the function signature in fn/rgsf.py for argument names.
```
