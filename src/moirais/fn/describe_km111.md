# describe('km111') — kamath_ch7_faithfulness_metric
...
`print(result)` render. See `moirais.fn.describe('km111')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km111 import *
import numpy as np
# See the function signature in fn/km111.py for argument names.
```
