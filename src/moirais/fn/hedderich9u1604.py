...
__all__ = ["hedderich_chapter_9_unnumbered_1604"]


def hedderich_chapter_9_unnumbered_1604(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: H0 rejected P (T∈Kα|H0)≤α P (T∈Kα|HA)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1604')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1604: PowerAndDesign expression (auto-extracted; see ref)."
