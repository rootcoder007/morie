...
`print(result)` render. See `moirais.fn.describe('polya')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polya import *
import numpy as np
# See the function signature in fn/polya.py for argument names.
```
