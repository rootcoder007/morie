...
__all__ = ["hedderich_chapter_9_unnumbered_1986"]


def hedderich_chapter_9_unnumbered_1986(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] becauseP (Z >2.162) = 0.0153, i.e.P≈0.03.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1986')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1986: GeneralStatistics expression (auto-extracted; see ref)."
