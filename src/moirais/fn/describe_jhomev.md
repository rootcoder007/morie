# describe('jhomev') — johansen_max_eigen
...
`print(result)` render. See `moirais.fn.describe('jhomev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jhomev import *
import numpy as np
# See the function signature in fn/jhomev.py for argument names.
```
