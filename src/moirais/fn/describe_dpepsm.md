...
`print(result)` render. See `moirais.fn.describe('dpepsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpepsm import *
import numpy as np
# See the function signature in fn/dpepsm.py for argument names.
```
