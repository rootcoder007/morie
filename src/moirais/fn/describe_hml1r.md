# describe('hml1r') — geron_l1_regularization
...
`print(result)` render. See `moirais.fn.describe('hml1r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hml1r import *
import numpy as np
# See the function signature in fn/hml1r.py for argument names.
```
