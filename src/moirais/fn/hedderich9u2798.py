...
__all__ = ["hedderich_chapter_9_unnumbered_2798"]


def hedderich_chapter_9_unnumbered_2798(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] w2 = ˆχ2/(a +b +c +d) (7.323)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2798')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2798: GeneralStatistics expression (auto-extracted; see ref)."
