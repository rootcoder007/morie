# describe('ppswos') — pps_without_replacement
...
`print(result)` render. See `moirais.fn.describe('ppswos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppswos import *
import numpy as np
# See the function signature in fn/ppswos.py for argument names.
```
