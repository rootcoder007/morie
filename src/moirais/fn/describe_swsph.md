...
`print(result)` render. See `moirais.fn.describe('swsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swsph import *
import numpy as np
# See the function signature in fn/swsph.py for argument names.
```
