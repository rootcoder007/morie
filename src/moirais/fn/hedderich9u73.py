...
__all__ = ["hedderich_chapter_9_unnumbered_73"]


def hedderich_chapter_9_unnumbered_73(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > B <− matrix ( c ( 4 , 5 , 6 , 9 , 8 , 7 ) , nrow =2 , n c o l=3 , byrow=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u73')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u73: GeneralStatistics expression (auto-extracted; see ref)."
