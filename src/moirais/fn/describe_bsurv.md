# describe('bsurv') — bayesian_survival
...
`print(result)` render. See `moirais.fn.describe('bsurv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsurv import *
import numpy as np
# See the function signature in fn/bsurv.py for argument names.
```
