# describe('spchol') — schabenberger_cholesky_sim
...
`print(result)` render. See `moirais.fn.describe('spchol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spchol import *
import numpy as np
# See the function signature in fn/spchol.py for argument names.
```
