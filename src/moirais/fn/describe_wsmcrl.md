# describe('wsmcrl') — wasserman_cramer_rao
...
`print(result)` render. See `moirais.fn.describe('wsmcrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcrl import *
import numpy as np
# See the function signature in fn/wsmcrl.py for argument names.
```
