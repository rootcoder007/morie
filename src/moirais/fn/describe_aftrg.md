...
`print(result)` render. See `moirais.fn.describe('aftrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftrg import *
import numpy as np
# See the function signature in fn/aftrg.py for argument names.
```
