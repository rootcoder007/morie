...
`print(result)` render. See `moirais.fn.describe('hmiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmiso import *
import numpy as np
# See the function signature in fn/hmiso.py for argument names.
```
