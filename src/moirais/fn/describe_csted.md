# describe('csted') — custody_education
...
`print(result)` render. See `moirais.fn.describe('csted')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csted import *
import numpy as np
# See the function signature in fn/csted.py for argument names.
```
