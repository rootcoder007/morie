...
`print(result)` render. See `moirais.fn.describe('wlshv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlshv import *
import numpy as np
# See the function signature in fn/wlshv.py for argument names.
```
