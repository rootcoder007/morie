...
`print(result)` render. See `moirais.fn.describe('afchl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afchl import *
import numpy as np
# See the function signature in fn/afchl.py for argument names.
```
