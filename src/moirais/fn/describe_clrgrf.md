...
`print(result)` render. See `moirais.fn.describe('clrgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clrgrf import *
import numpy as np
# See the function signature in fn/clrgrf.py for argument names.
```
