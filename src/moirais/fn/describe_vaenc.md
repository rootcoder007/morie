...
`print(result)` render. See `moirais.fn.describe('vaenc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaenc import *
import numpy as np
# See the function signature in fn/vaenc.py for argument names.
```
