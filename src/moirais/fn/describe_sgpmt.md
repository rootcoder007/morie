# describe('sgpmt') — permutation_test_spatial
...
`print(result)` render. See `moirais.fn.describe('sgpmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpmt import *
import numpy as np
# See the function signature in fn/sgpmt.py for argument names.
```
