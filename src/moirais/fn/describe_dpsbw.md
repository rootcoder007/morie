# describe('dpsbw') — stick_breaking_weights
...
`print(result)` render. See `moirais.fn.describe('dpsbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsbw import *
import numpy as np
# See the function signature in fn/dpsbw.py for argument names.
```
