...
__all__ = ["wilcox_chapter_10_unnumbered_966"]


def wilcox_chapter_10_unnumbered_966(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 2 =µ 1 +µ 2 − µ 5 − µ 6,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u966')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u966: GeneralStatistics expression (auto-extracted; see ref)."
