# describe('hrzphvnp') — horowitz_ph_frailty_nonpar
...
`print(result)` render. See `moirais.fn.describe('hrzphvnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzphvnp import *
import numpy as np
# See the function signature in fn/hrzphvnp.py for argument names.
```
