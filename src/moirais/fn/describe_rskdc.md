...
`print(result)` render. See `moirais.fn.describe('rskdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskdc import *
import numpy as np
# See the function signature in fn/rskdc.py for argument names.
```
