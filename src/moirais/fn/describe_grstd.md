# describe('grstd') — geron_standardization
...
`print(result)` render. See `moirais.fn.describe('grstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grstd import *
import numpy as np
# See the function signature in fn/grstd.py for argument names.
```
