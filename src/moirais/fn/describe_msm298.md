# describe('msm298') — mvsml_convolutional_nn_eq_14_5
...
`print(result)` render. See `moirais.fn.describe('msm298')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm298 import *
import numpy as np
# See the function signature in fn/msm298.py for argument names.
```
