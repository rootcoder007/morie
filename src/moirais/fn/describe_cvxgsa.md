# describe('cvxgsa') — boyd_generalized_p
...
`print(result)` render. See `moirais.fn.describe('cvxgsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxgsa import *
import numpy as np
# See the function signature in fn/cvxgsa.py for argument names.
```
