# describe('alzsc') — alammar_zero_shot_classification
...
`print(result)` render. See `moirais.fn.describe('alzsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alzsc import *
import numpy as np
# See the function signature in fn/alzsc.py for argument names.
```
