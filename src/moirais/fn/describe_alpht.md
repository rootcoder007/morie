...
`print(result)` render. See `moirais.fn.describe('alpht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alpht import *
import numpy as np
# See the function signature in fn/alpht.py for argument names.
```
