# describe('ptdlr') — pp_delaunay_resid
...
`print(result)` render. See `moirais.fn.describe('ptdlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptdlr import *
import numpy as np
# See the function signature in fn/ptdlr.py for argument names.
```
