...
`print(result)` render. See `moirais.fn.describe('bmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmds import *
import numpy as np
# See the function signature in fn/bmds.py for argument names.
```
