...
`print(result)` render. See `moirais.fn.describe('saraic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saraic import *
import numpy as np
# See the function signature in fn/saraic.py for argument names.
```
