...
`print(result)` render. See `moirais.fn.describe('rwsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rwsim import *
import numpy as np
# See the function signature in fn/rwsim.py for argument names.
```
