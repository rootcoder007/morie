...
__all__ = ["hedderich_chapter_9_unnumbered_622"]


def hedderich_chapter_9_unnumbered_622(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] A ¯A ¯A, ¯AA ¯A, ¯A ¯AA 1 P (X = 1) 3p(1−p)2 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u622')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u622: CountModels expression (auto-extracted; see ref)."
