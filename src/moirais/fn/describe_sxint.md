...
`print(result)` render. See `moirais.fn.describe('sxint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sxint import *
import numpy as np
# See the function signature in fn/sxint.py for argument names.
```
