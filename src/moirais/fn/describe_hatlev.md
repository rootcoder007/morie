...
`print(result)` render. See `moirais.fn.describe('hatlev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hatlev import *
import numpy as np
# See the function signature in fn/hatlev.py for argument names.
```
