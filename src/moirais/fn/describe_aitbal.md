# describe('aitbal') — aitchison_balance
...
`print(result)` render. See `moirais.fn.describe('aitbal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitbal import *
import numpy as np
# See the function signature in fn/aitbal.py for argument names.
```
