# describe('vacve') — vaccine_effectiveness
...
`print(result)` render. See `moirais.fn.describe('vacve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vacve import *
import numpy as np
# See the function signature in fn/vacve.py for argument names.
```
