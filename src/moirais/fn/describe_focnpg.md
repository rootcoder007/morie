...
`print(result)` render. See `moirais.fn.describe('focnpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focnpg import *
import numpy as np
# See the function signature in fn/focnpg.py for argument names.
```
