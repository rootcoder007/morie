# describe('grpoly') — geron_polynomial_features
...
`print(result)` render. See `moirais.fn.describe('grpoly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpoly import *
import numpy as np
# See the function signature in fn/grpoly.py for argument names.
```
