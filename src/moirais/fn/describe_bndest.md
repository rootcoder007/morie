# describe('bndest') — bound_estimation
...
`print(result)` render. See `moirais.fn.describe('bndest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndest import *
import numpy as np
# See the function signature in fn/bndest.py for argument names.
```
