...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_177"]


def guide_on_data_analysis_chapter_4_unnumbered_177(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] √ 𝑛(𝑛+1)(2𝑛+1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u177')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u177: GeneralStatistics expression (auto-extracted; see ref)."
