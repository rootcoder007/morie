# describe('smith') — bootstrap_resample
...
`print(result)` render. See `moirais.fn.describe('smith')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smith import *
import numpy as np
# See the function signature in fn/smith.py for argument names.
```
