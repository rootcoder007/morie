...
`print(result)` render. See `moirais.fn.describe('siurt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siurt import *
import numpy as np
# See the function signature in fn/siurt.py for argument names.
```
