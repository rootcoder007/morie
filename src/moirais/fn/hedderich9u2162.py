...
__all__ = ["hedderich_chapter_9_unnumbered_2162"]


def hedderich_chapter_9_unnumbered_2162(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + power =NULL, N=NULL, c = 0 . 5 ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2162')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2162: PowerAndDesign expression (auto-extracted; see ref)."
