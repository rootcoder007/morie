...
`print(result)` render. See `moirais.fn.describe('ecsTCR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecsTCR import *
import numpy as np
# See the function signature in fn/ecsTCR.py for argument names.
```
