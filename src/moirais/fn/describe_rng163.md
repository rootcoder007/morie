# describe('rng163') — rangayyan_ch3_rls_objective
...
`print(result)` render. See `moirais.fn.describe('rng163')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng163 import *
import numpy as np
# See the function signature in fn/rng163.py for argument names.
```
