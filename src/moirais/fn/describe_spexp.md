# describe('spexp') — schabenberger_exponential_variogram
...
`print(result)` render. See `moirais.fn.describe('spexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spexp import *
import numpy as np
# See the function signature in fn/spexp.py for argument names.
```
