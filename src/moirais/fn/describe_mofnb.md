...
`print(result)` render. See `moirais.fn.describe('mofnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mofnb import *
import numpy as np
# See the function signature in fn/mofnb.py for argument names.
```
