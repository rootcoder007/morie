...
`print(result)` render. See `moirais.fn.describe('carbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carbic import *
import numpy as np
# See the function signature in fn/carbic.py for argument names.
```
