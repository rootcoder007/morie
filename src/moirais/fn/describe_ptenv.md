...
`print(result)` render. See `moirais.fn.describe('ptenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptenv import *
import numpy as np
# See the function signature in fn/ptenv.py for argument names.
```
