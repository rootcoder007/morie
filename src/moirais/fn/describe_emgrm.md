...
`print(result)` render. See `moirais.fn.describe('emgrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emgrm import *
import numpy as np
# See the function signature in fn/emgrm.py for argument names.
```
