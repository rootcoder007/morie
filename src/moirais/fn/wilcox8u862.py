...
__all__ = ["wilcox_chapter_8_unnumbered_862"]


def wilcox_chapter_8_unnumbered_862(x):
    """
    Resampling expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u862')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u862: Resampling expression (auto-extracted; see ref)."
