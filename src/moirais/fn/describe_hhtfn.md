...
`print(result)` render. See `moirais.fn.describe('hhtfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hhtfn import *
import numpy as np
# See the function signature in fn/hhtfn.py for argument names.
```
