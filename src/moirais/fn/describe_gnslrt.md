...
`print(result)` render. See `moirais.fn.describe('gnslrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnslrt import *
import numpy as np
# See the function signature in fn/gnslrt.py for argument names.
```
