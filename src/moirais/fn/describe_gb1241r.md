# describe('gb1241r') — gibbons_concordance_rho_link
...
`print(result)` render. See `moirais.fn.describe('gb1241r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1241r import *
import numpy as np
# See the function signature in fn/gb1241r.py for argument names.
```
