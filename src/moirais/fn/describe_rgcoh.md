# describe('rgcoh') — rangayyan_coherence
...
`print(result)` render. See `moirais.fn.describe('rgcoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcoh import *
import numpy as np
# See the function signature in fn/rgcoh.py for argument names.
```
