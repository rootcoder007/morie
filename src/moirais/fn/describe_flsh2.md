# describe('flsh2') — flash_attention
...
`print(result)` render. See `moirais.fn.describe('flsh2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flsh2 import *
import numpy as np
# See the function signature in fn/flsh2.py for argument names.
```
