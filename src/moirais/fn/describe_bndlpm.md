# describe('bndlpm') — bound_lp_method
...
`print(result)` render. See `moirais.fn.describe('bndlpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndlpm import *
import numpy as np
# See the function signature in fn/bndlpm.py for argument names.
```
