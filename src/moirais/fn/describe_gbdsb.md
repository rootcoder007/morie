...
`print(result)` render. See `moirais.fn.describe('gbdsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbdsb import *
import numpy as np
# See the function signature in fn/gbdsb.py for argument names.
```
