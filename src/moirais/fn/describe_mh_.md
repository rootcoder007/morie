# describe('mh_') — metropolis_hastings
...
`print(result)` render. See `moirais.fn.describe('mh_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mh_ import *
import numpy as np
# See the function signature in fn/mh_.py for argument names.
```
