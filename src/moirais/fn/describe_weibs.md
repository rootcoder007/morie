...
`print(result)` render. See `moirais.fn.describe('weibs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weibs import *
import numpy as np
# See the function signature in fn/weibs.py for argument names.
```
