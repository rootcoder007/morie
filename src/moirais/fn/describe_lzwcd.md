...
`print(result)` render. See `moirais.fn.describe('lzwcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lzwcd import *
import numpy as np
# See the function signature in fn/lzwcd.py for argument names.
```
