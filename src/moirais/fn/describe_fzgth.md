# describe('fzgth') — fauzi_g_theta_distribution
...
`print(result)` render. See `moirais.fn.describe('fzgth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzgth import *
import numpy as np
# See the function signature in fn/fzgth.py for argument names.
```
