...
`print(result)` render. See `moirais.fn.describe('mednt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mednt import *
import numpy as np
# See the function signature in fn/mednt.py for argument names.
```
