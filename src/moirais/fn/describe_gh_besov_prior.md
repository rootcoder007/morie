# describe('gh_besov_prior') — ghosal_besov_prior
...
`print(result)` render. See `moirais.fn.describe('gh_besov_prior')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_besov_prior import *
import numpy as np
# See the function signature in fn/gh_besov_prior.py for argument names.
```
