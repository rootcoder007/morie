# describe('spclk') — schabenberger_composite_likelihood
...
`print(result)` render. See `moirais.fn.describe('spclk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spclk import *
import numpy as np
# See the function signature in fn/spclk.py for argument names.
```
