...
__all__ = ["bivand2013_chapter_7_unnumbered_82"]


def bivand2013_chapter_7_unnumbered_82(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F(r)=1 −exp{−λπr2}.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u82')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u82: GeneralStatistics expression (auto-extracted; see ref)."
