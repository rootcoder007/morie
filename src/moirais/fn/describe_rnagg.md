...
`print(result)` render. See `moirais.fn.describe('rnagg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnagg import *
import numpy as np
# See the function signature in fn/rnagg.py for argument names.
```
