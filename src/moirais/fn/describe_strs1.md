# describe('strs1') — stress1_measure
...
`print(result)` render. See `moirais.fn.describe('strs1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strs1 import *
import numpy as np
# See the function signature in fn/strs1.py for argument names.
```
