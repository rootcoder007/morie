# describe('alswa') — alammar_sliding_window_attention
...
`print(result)` render. See `moirais.fn.describe('alswa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alswa import *
import numpy as np
# See the function signature in fn/alswa.py for argument names.
```
