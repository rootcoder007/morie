...
`print(result)` render. See `moirais.fn.describe('admod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.admod import *
import numpy as np
# See the function signature in fn/admod.py for argument names.
```
