...
`print(result)` render. See `moirais.fn.describe('hyshr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyshr import *
import numpy as np
# See the function signature in fn/hyshr.py for argument names.
```
