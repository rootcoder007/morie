# describe('hoeff') — hoeffding_bound
...
`print(result)` render. See `moirais.fn.describe('hoeff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hoeff import *
import numpy as np
# See the function signature in fn/hoeff.py for argument names.
```
