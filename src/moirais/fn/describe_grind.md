...
`print(result)` render. See `moirais.fn.describe('grind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grind import *
import numpy as np
# See the function signature in fn/grind.py for argument names.
```
