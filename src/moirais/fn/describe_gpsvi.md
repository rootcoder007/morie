# describe('gpsvi') — gp_stochastic_vi
...
`print(result)` render. See `moirais.fn.describe('gpsvi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpsvi import *
import numpy as np
# See the function signature in fn/gpsvi.py for argument names.
```
