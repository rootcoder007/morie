...
`print(result)` render. See `moirais.fn.describe('nbiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbiso import *
import numpy as np
# See the function signature in fn/nbiso.py for argument names.
```
