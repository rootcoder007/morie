# describe('mscmcl') — matrix_completion_scm
...
`print(result)` render. See `moirais.fn.describe('mscmcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscmcl import *
import numpy as np
# See the function signature in fn/mscmcl.py for argument names.
```
