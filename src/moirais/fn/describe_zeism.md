...
`print(result)` render. See `moirais.fn.describe('zeism')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeism import *
import numpy as np
# See the function signature in fn/zeism.py for argument names.
```
