...
`print(result)` render. See `moirais.fn.describe('rmsyt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsyt import *
import numpy as np
# See the function signature in fn/rmsyt.py for argument names.
```
