...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1488"]


def guide_on_data_analysis_chapter_30_unnumbered_1488(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -6 x cohort = 9 0.88 (0.53)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1488')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1488: GeneralStatistics expression (auto-extracted; see ref)."
