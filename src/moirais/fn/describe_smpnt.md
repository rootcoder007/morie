...
`print(result)` render. See `moirais.fn.describe('smpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpnt import *
import numpy as np
# See the function signature in fn/smpnt.py for argument names.
```
