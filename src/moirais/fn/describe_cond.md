# describe('cond') — condition_number
...
`print(result)` render. See `moirais.fn.describe('cond')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cond import *
import numpy as np
# See the function signature in fn/cond.py for argument names.
```
