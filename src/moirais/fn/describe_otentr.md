# describe('otentr') — ot_entropy_regulariser
...
`print(result)` render. See `moirais.fn.describe('otentr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otentr import *
import numpy as np
# See the function signature in fn/otentr.py for argument names.
```
