# describe('mivbnd') — monotone_iv_bounds
...
`print(result)` render. See `moirais.fn.describe('mivbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mivbnd import *
import numpy as np
# See the function signature in fn/mivbnd.py for argument names.
```
