# describe('reidR') — reidentification_risk
...
`print(result)` render. See `moirais.fn.describe('reidR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reidR import *
import numpy as np
# See the function signature in fn/reidR.py for argument names.
```
