...
`print(result)` render. See `moirais.fn.describe('trpoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trpoc import *
import numpy as np
# See the function signature in fn/trpoc.py for argument names.
```
