...
__all__ = ["hedderich_chapter_9_unnumbered_1370"]


def hedderich_chapter_9_unnumbered_1370(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2.11≤σ≤0.0942
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1370')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1370: GeneralStatistics expression (auto-extracted; see ref)."
