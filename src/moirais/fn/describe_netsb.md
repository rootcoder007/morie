# describe('netsb') — network_stability
...
`print(result)` render. See `moirais.fn.describe('netsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netsb import *
import numpy as np
# See the function signature in fn/netsb.py for argument names.
```
