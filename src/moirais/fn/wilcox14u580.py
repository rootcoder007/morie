...
__all__ = ["wilcox_chapter_14_unnumbered_580"]


def wilcox_chapter_14_unnumbered_580(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: x = 22. This is because for x< 22 the lower confidence band extends down to −∞. That is,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u580')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u580: GeneralStatistics expression (auto-extracted; see ref)."
