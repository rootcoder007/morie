# describe('cpvar') — variance_changepoint
...
`print(result)` render. See `moirais.fn.describe('cpvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpvar import *
import numpy as np
# See the function signature in fn/cpvar.py for argument names.
```
