...
`print(result)` render. See `moirais.fn.describe('svlap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlap import *
import numpy as np
# See the function signature in fn/svlap.py for argument names.
```
