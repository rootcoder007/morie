...
`print(result)` render. See `moirais.fn.describe('recrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.recrd import *
import numpy as np
# See the function signature in fn/recrd.py for argument names.
```
