...
`print(result)` render. See `moirais.fn.describe('afslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslt import *
import numpy as np
# See the function signature in fn/afslt.py for argument names.
```
