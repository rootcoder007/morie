...
__all__ = ["wilcox_chapter_10_unnumbered_976"]


def wilcox_chapter_10_unnumbered_976(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 5 =µ 1 − µ 2 − µ 5 +µ 6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u976')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u976: GeneralStatistics expression (auto-extracted; see ref)."
