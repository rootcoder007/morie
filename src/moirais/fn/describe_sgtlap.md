...
`print(result)` render. See `moirais.fn.describe('sgtlap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtlap import *
import numpy as np
# See the function signature in fn/sgtlap.py for argument names.
```
