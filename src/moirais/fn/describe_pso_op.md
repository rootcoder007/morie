# describe('pso_op') — particle_swarm
...
`print(result)` render. See `moirais.fn.describe('pso_op')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pso_op import *
import numpy as np
# See the function signature in fn/pso_op.py for argument names.
```
