...
`print(result)` render. See `moirais.fn.describe('bcfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcfa import *
import numpy as np
# See the function signature in fn/bcfa.py for argument names.
```
