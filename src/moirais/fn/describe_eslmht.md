# describe('eslmht') — esl_holm_bonferroni
...
`print(result)` render. See `moirais.fn.describe('eslmht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslmht import *
import numpy as np
# See the function signature in fn/eslmht.py for argument names.
```
