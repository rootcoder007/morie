...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_125"]


def information_theory_mackay_chapter_6_unnumbered_125(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(y = Gjx= G) = 1=3;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u125')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u125: GeneralStatistics expression (auto-extracted; see ref)."
