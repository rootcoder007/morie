# describe('grctr') — geron_contrastive_infonce
...
`print(result)` render. See `moirais.fn.describe('grctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grctr import *
import numpy as np
# See the function signature in fn/grctr.py for argument names.
```
