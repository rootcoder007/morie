...
`print(result)` render. See `moirais.fn.describe('mpsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpsim import *
import numpy as np
# See the function signature in fn/mpsim.py for argument names.
```
