# describe('grdae') — geron_denoising_autoencoder
...
`print(result)` render. See `moirais.fn.describe('grdae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdae import *
import numpy as np
# See the function signature in fn/grdae.py for argument names.
```
