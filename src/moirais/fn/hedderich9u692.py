...
__all__ = ["hedderich_chapter_9_unnumbered_692"]


def hedderich_chapter_9_unnumbered_692(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 1|λ) = λe−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u692')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u692: CountModels expression (auto-extracted; see ref)."
