# describe('sgcnv') — convolution_representation
...
`print(result)` render. See `moirais.fn.describe('sgcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcnv import *
import numpy as np
# See the function signature in fn/sgcnv.py for argument names.
```
