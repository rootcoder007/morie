...
`print(result)` render. See `moirais.fn.describe('eslo63')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslo63 import *
import numpy as np
# See the function signature in fn/eslo63.py for argument names.
```
