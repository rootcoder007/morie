# describe('hurste') — hurst_exponent
...
`print(result)` render. See `moirais.fn.describe('hurste')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hurste import *
import numpy as np
# See the function signature in fn/hurste.py for argument names.
```
