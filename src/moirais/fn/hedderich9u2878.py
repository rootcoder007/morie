...
__all__ = ["hedderich_chapter_9_unnumbered_2878"]


def hedderich_chapter_9_unnumbered_2878(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: reaches the testH0 : πi =πi+1 at the level 2·α/k(from Sachs [Sac93]).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2878')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2878: GeneralStatistics expression (auto-extracted; see ref)."
