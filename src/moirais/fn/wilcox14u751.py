...
__all__ = ["wilcox_chapter_14_unnumbered_751"]


def wilcox_chapter_14_unnumbered_751(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆν 1 = ((J − 1) ∑qj)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u751')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u751: GeneralStatistics expression (auto-extracted; see ref)."
