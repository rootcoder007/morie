...
`print(result)` render. See `moirais.fn.describe('sireal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sireal import *
import numpy as np
# See the function signature in fn/sireal.py for argument names.
```
