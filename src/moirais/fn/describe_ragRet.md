...
`print(result)` render. See `moirais.fn.describe('ragRet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ragRet import *
import numpy as np
# See the function signature in fn/ragRet.py for argument names.
```
