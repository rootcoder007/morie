...
__all__ = ["hedderich_chapter_9_unnumbered_1885"]


def hedderich_chapter_9_unnumbered_1885(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 40(40−2)/[4(40−1)] = 1.922
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1885')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1885: GeneralStatistics expression (auto-extracted; see ref)."
