# describe('causfromle') — causal_e_value
...
`print(result)` render. See `moirais.fn.describe('causfromle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causfromle import *
import numpy as np
# See the function signature in fn/causfromle.py for argument names.
```
