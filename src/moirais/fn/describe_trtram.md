...
`print(result)` render. See `moirais.fn.describe('trtram')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trtram import *
import numpy as np
# See the function signature in fn/trtram.py for argument names.
```
