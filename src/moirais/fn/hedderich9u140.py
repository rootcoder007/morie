...
__all__ = ["hedderich_chapter_9_unnumbered_140"]


def hedderich_chapter_9_unnumbered_140(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 40/100 = 0.40 (40%) 200/1000 = 0.20 (20%) 50/500 = 0.10 (10%)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u140')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u140: GeneralStatistics expression (auto-extracted; see ref)."
