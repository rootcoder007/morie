# describe('otsd') — ot_sliced_distance_quant
...
`print(result)` render. See `moirais.fn.describe('otsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsd import *
import numpy as np
# See the function signature in fn/otsd.py for argument names.
```
