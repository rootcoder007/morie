...
`print(result)` render. See `moirais.fn.describe('irtsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtsp import *
import numpy as np
# See the function signature in fn/irtsp.py for argument names.
```
