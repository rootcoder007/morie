# describe('gamfr') — gamma_frailty_cox
...
`print(result)` render. See `moirais.fn.describe('gamfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gamfr import *
import numpy as np
# See the function signature in fn/gamfr.py for argument names.
```
