...
`print(result)` render. See `moirais.fn.describe('elcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elcmp import *
import numpy as np
# See the function signature in fn/elcmp.py for argument names.
```
