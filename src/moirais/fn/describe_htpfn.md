# describe('htpfn') — htp_functional_predictor
...
`print(result)` render. See `moirais.fn.describe('htpfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htpfn import *
import numpy as np
# See the function signature in fn/htpfn.py for argument names.
```
