# describe('gh_sup_norm_gp') — ghosal_sup_norm_contraction
...
`print(result)` render. See `moirais.fn.describe('gh_sup_norm_gp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_sup_norm_gp import *
import numpy as np
# See the function signature in fn/gh_sup_norm_gp.py for argument names.
```
