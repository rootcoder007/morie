# describe('spectc') — spectral_cluster
...
`print(result)` render. See `moirais.fn.describe('spectc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spectc import *
import numpy as np
# See the function signature in fn/spectc.py for argument names.
```
