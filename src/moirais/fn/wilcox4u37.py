...
__all__ = ["wilcox_chapter_4_unnumbered_37"]


def wilcox_chapter_4_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1(0.1) + 2(0.15) + 3(0.25) + 4(0.3) + 5(0.2) = 3.35.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u37')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u37: GeneralStatistics expression (auto-extracted; see ref)."
