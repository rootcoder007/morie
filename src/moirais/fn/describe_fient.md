# describe('fient') — fisher_information
...
`print(result)` render. See `moirais.fn.describe('fient')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fient import *
import numpy as np
# See the function signature in fn/fient.py for argument names.
```
