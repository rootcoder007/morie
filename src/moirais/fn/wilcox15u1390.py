...
__all__ = ["wilcox_chapter_15_unnumbered_1390"]


def wilcox_chapter_15_unnumbered_1390(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α ν = 5 ν = 6 ν = 7 ν = 8 ν = 9 ν = 14
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1390')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1390: GeneralStatistics expression (auto-extracted; see ref)."
