# describe('causivkm') — causal_iv_kleibergen_moreira
...
`print(result)` render. See `moirais.fn.describe('causivkm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causivkm import *
import numpy as np
# See the function signature in fn/causivkm.py for argument names.
```
