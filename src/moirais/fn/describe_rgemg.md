# describe('rgemg') — rangayyan_emg_rms
...
`print(result)` render. See `moirais.fn.describe('rgemg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemg import *
import numpy as np
# See the function signature in fn/rgemg.py for argument names.
```
