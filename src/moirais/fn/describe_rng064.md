# describe('rng064') — rangayyan_ch3_fourier_transform_omega
...
`print(result)` render. See `moirais.fn.describe('rng064')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng064 import *
import numpy as np
# See the function signature in fn/rng064.py for argument names.
```
