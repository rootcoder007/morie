# describe('rotrp') — rotary_position_embedding
...
`print(result)` render. See `moirais.fn.describe('rotrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rotrp import *
import numpy as np
# See the function signature in fn/rotrp.py for argument names.
```
