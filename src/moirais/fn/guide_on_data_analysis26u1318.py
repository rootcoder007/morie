...
__all__ = ["guide_on_data_analysis_chapter_26_unnumbered_1318"]


def guide_on_data_analysis_chapter_26_unnumbered_1318(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis26u1318')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis26u1318: GeneralStatistics expression (auto-extracted; see ref)."
