# describe('miefcl') — multiple_imputation_combine
...
`print(result)` render. See `moirais.fn.describe('miefcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miefcl import *
import numpy as np
# See the function signature in fn/miefcl.py for argument names.
```
