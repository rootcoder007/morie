# describe('hzbnds') — horowitz_manski_bounds
...
`print(result)` render. See `moirais.fn.describe('hzbnds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hzbnds import *
import numpy as np
# See the function signature in fn/hzbnds.py for argument names.
```
