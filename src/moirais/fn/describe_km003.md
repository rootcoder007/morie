# describe('km003') — kamath_ch2_context_simplest
...
`print(result)` render. See `moirais.fn.describe('km003')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km003 import *
import numpy as np
# See the function signature in fn/km003.py for argument names.
```
