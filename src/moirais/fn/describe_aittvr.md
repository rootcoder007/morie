# describe('aittvr') — aitchison_total_variance
...
`print(result)` render. See `moirais.fn.describe('aittvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aittvr import *
import numpy as np
# See the function signature in fn/aittvr.py for argument names.
```
