# describe('rgbhp') — rangayyan_butterworth_hp
...
`print(result)` render. See `moirais.fn.describe('rgbhp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbhp import *
import numpy as np
# See the function signature in fn/rgbhp.py for argument names.
```
