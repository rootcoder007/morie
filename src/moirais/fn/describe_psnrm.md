...
`print(result)` render. See `moirais.fn.describe('psnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psnrm import *
import numpy as np
# See the function signature in fn/psnrm.py for argument names.
```
