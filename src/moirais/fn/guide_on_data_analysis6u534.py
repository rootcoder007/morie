...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_534"]
...
def guide_on_data_analysis_chapter_6_unnumbered_534(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u534')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u534: GeneralStatistics expression (auto-extracted; see ref)."
