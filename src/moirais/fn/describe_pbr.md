...
`print(result)` render. See `moirais.fn.describe('pbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pbr import *
import numpy as np
# See the function signature in fn/pbr.py for argument names.
```
