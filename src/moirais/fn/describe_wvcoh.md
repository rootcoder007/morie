...
`print(result)` render. See `moirais.fn.describe('wvcoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvcoh import *
import numpy as np
# See the function signature in fn/wvcoh.py for argument names.
```
