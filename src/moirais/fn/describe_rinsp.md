...
`print(result)` render. See `moirais.fn.describe('rinsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rinsp import *
import numpy as np
# See the function signature in fn/rinsp.py for argument names.
```
