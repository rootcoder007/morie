# describe('dssim') — dssim

## WHAT IT DOES

Direct sampling simulation
...
`print(result)` render. See `moirais.fn.describe('dssim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dssim import *
import numpy as np
# See the function signature in fn/dssim.py for argument names.
```
