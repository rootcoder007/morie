...
`print(result)` render. See `moirais.fn.describe('clred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clred import *
import numpy as np
# See the function signature in fn/clred.py for argument names.
```
