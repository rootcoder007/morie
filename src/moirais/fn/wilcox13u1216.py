...
__all__ = ["wilcox_chapter_13_unnumbered_1216"]


def wilcox_chapter_13_unnumbered_1216(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: a reasonable strategy for checking the model Y =β 0 +β 1X1 +β 2X2 +β 3X1X2 +e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1216')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1216: GeneralStatistics expression (auto-extracted; see ref)."
