...
`print(result)` render. See `moirais.fn.describe('xrwrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwrk import *
import numpy as np
# See the function signature in fn/xrwrk.py for argument names.
```
