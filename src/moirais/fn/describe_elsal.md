...
`print(result)` render. See `moirais.fn.describe('elsal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elsal import *
import numpy as np
# See the function signature in fn/elsal.py for argument names.
```
