...
`print(result)` render. See `moirais.fn.describe('svchy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svchy import *
import numpy as np
# See the function signature in fn/svchy.py for argument names.
```
