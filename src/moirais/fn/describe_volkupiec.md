# describe('volkupiec') — vol_kupiec_var_test
...
`print(result)` render. See `moirais.fn.describe('volkupiec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volkupiec import *
import numpy as np
# See the function signature in fn/volkupiec.py for argument names.
```
