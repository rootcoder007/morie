...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_191"]


def guide_on_data_analysis_chapter_4_unnumbered_191(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑧 = ̄ 𝑦 − ̄ 𝑥 − 𝛿0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u191')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u191: GeneralStatistics expression (auto-extracted; see ref)."
