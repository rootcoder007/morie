...
`print(result)` render. See `moirais.fn.describe('limex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.limex import *
import numpy as np
# See the function signature in fn/limex.py for argument names.
```
