# describe('btsieve') — boot_sieve_general
...
`print(result)` render. See `moirais.fn.describe('btsieve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsieve import *
import numpy as np
# See the function signature in fn/btsieve.py for argument names.
```
