...
`print(result)` render. See `moirais.fn.describe('mtarf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtarf import *
import numpy as np
# See the function signature in fn/mtarf.py for argument names.
```
