...
`print(result)` render. See `moirais.fn.describe('gdlit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdlit import *
import numpy as np
# See the function signature in fn/gdlit.py for argument names.
```
