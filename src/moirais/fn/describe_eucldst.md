...
`print(result)` render. See `moirais.fn.describe('eucldst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eucldst import *
import numpy as np
# See the function signature in fn/eucldst.py for argument names.
```
