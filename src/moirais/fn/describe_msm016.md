# describe('msm016') — mvsml_linear_mixed_models_eq_5_3
...
`print(result)` render. See `moirais.fn.describe('msm016')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm016 import *
import numpy as np
# See the function signature in fn/msm016.py for argument names.
```
