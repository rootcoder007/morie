...
`print(result)` render. See `moirais.fn.describe('gmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmm import *
import numpy as np
# See the function signature in fn/gmm.py for argument names.
```
