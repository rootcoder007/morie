...
`print(result)` render. See `moirais.fn.describe('fostrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fostrm import *
import numpy as np
# See the function signature in fn/fostrm.py for argument names.
```
