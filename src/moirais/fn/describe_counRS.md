# describe('counRS') — counterfactual_rec
...
`print(result)` render. See `moirais.fn.describe('counRS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.counRS import *
import numpy as np
# See the function signature in fn/counRS.py for argument names.
```
