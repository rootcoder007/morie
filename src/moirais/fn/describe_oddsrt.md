...
`print(result)` render. See `moirais.fn.describe('oddsrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oddsrt import *
import numpy as np
# See the function signature in fn/oddsrt.py for argument names.
```
