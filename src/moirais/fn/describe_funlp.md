...
`print(result)` render. See `moirais.fn.describe('funlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funlp import *
import numpy as np
# See the function signature in fn/funlp.py for argument names.
```
