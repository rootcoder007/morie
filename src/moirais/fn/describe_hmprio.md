# describe('hmprio') — geron_perceiver_io
...
`print(result)` render. See `moirais.fn.describe('hmprio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmprio import *
import numpy as np
# See the function signature in fn/hmprio.py for argument names.
```
