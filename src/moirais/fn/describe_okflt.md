...
`print(result)` render. See `moirais.fn.describe('okflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.okflt import *
import numpy as np
# See the function signature in fn/okflt.py for argument names.
```
