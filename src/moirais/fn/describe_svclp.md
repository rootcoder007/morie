...
`print(result)` render. See `moirais.fn.describe('svclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclp import *
import numpy as np
# See the function signature in fn/svclp.py for argument names.
```
