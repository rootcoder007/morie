...
__all__ = ["hedderich_chapter_9_unnumbered_399"]


def hedderich_chapter_9_unnumbered_399(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A1∪A2∪...∪An) = 1−{[1−P (A1)]·[1−P (A2)]·...·[1−P (An)]} (4.15)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u399')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u399: GeneralStatistics expression (auto-extracted; see ref)."
