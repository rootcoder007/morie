# describe('spjc') — schabenberger_join_count
...
`print(result)` render. See `moirais.fn.describe('spjc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spjc import *
import numpy as np
# See the function signature in fn/spjc.py for argument names.
```
