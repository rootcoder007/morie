...
`print(result)` render. See `moirais.fn.describe('zxsls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsls import *
import numpy as np
# See the function signature in fn/zxsls.py for argument names.
```
