# describe('comlou') — louvain_communities
...
`print(result)` render. See `moirais.fn.describe('comlou')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comlou import *
import numpy as np
# See the function signature in fn/comlou.py for argument names.
```
