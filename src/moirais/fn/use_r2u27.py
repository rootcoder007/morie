...
__all__ = ["use_r_chapter_2_unnumbered_27"]


def use_r_chapter_2_unnumbered_27(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +init=epsg:4230 +proj=longlat +ellps=intl +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u27')`` for the full guide.
...
def cheatsheet():
    return "use_r2u27: GeneralStatistics expression (auto-extracted; see ref)."
