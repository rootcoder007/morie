# describe('emvbs') — evidence_maximization
...
`print(result)` render. See `moirais.fn.describe('emvbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emvbs import *
import numpy as np
# See the function signature in fn/emvbs.py for argument names.
```
