# describe('almnrl') — alammar_multiple_negatives_ranking
...
`print(result)` render. See `moirais.fn.describe('almnrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.almnrl import *
import numpy as np
# See the function signature in fn/almnrl.py for argument names.
```
