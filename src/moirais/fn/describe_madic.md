...
`print(result)` render. See `moirais.fn.describe('madic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madic import *
import numpy as np
# See the function signature in fn/madic.py for argument names.
```
