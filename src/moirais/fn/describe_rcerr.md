# describe('rcerr') — roll_call_errors
...
`print(result)` render. See `moirais.fn.describe('rcerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcerr import *
import numpy as np
# See the function signature in fn/rcerr.py for argument names.
```
