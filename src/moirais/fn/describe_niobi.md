...
`print(result)` render. See `moirais.fn.describe('niobi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.niobi import *
import numpy as np
# See the function signature in fn/niobi.py for argument names.
```
