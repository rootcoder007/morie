...
`print(result)` render. See `moirais.fn.describe('soslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soslt import *
import numpy as np
# See the function signature in fn/soslt.py for argument names.
```
