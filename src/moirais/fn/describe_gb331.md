# describe('gb331') — gibbons_run_lengths_dist
...
`print(result)` render. See `moirais.fn.describe('gb331')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb331 import *
import numpy as np
# See the function signature in fn/gb331.py for argument names.
```
