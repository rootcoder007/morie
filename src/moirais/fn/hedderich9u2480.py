...
__all__ = ["hedderich_chapter_9_unnumbered_2480"]


def hedderich_chapter_9_unnumbered_2480(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] RContr. = 75 R1 = 32 R2 = 29
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2480')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2480: GeneralStatistics expression (auto-extracted; see ref)."
