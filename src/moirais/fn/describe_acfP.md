...
`print(result)` render. See `moirais.fn.describe('acfP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfP import *
import numpy as np
# See the function signature in fn/acfP.py for argument names.
```
