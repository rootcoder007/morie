...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_12_equation_3(x):
    """
    PowerAndDesign equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r12e3')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r12e3: PowerAndDesign equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R."
