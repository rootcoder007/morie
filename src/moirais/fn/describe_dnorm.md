...
`print(result)` render. See `moirais.fn.describe('dnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnorm import *
import numpy as np
# See the function signature in fn/dnorm.py for argument names.
```
