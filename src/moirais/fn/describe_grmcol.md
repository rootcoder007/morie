# describe('grmcol') — geron_gan_mode_collapse_metric
...
`print(result)` render. See `moirais.fn.describe('grmcol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmcol import *
import numpy as np
# See the function signature in fn/grmcol.py for argument names.
```
