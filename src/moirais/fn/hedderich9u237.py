...
__all__ = ["hedderich_chapter_9_unnumbered_237"]


def hedderich_chapter_9_unnumbered_237(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2nd day: 100(1 +x)+ 100(1 + x)x = 100(1 +x)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u237')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u237: GeneralStatistics expression (auto-extracted; see ref)."
