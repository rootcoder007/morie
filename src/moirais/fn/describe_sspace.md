...
`print(result)` render. See `moirais.fn.describe('sspace')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sspace import *
import numpy as np
# See the function signature in fn/sspace.py for argument names.
```
