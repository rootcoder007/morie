# describe('ototk') — ot_kantorovich_dual_value
...
`print(result)` render. See `moirais.fn.describe('ototk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ototk import *
import numpy as np
# See the function signature in fn/ototk.py for argument names.
```
