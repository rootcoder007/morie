# describe('rng253') — rangayyan_ch4_power_cepstrum_definition
...
`print(result)` render. See `moirais.fn.describe('rng253')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng253 import *
import numpy as np
# See the function signature in fn/rng253.py for argument names.
```
