...
`print(result)` render. See `moirais.fn.describe('zsidp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsidp import *
import numpy as np
# See the function signature in fn/zsidp.py for argument names.
```
