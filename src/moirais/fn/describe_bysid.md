# describe('bysid') — bayesian_ideal_points
...
`print(result)` render. See `moirais.fn.describe('bysid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bysid import *
import numpy as np
# See the function signature in fn/bysid.py for argument names.
```
