# describe('rfpmi') — rf_permutation_importance
...
`print(result)` render. See `moirais.fn.describe('rfpmi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfpmi import *
import numpy as np
# See the function signature in fn/rfpmi.py for argument names.
```
