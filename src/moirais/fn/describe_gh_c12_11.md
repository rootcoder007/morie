# describe('gh_c12_11') — ghosal_cred_set_cov
...
`print(result)` render. See `moirais.fn.describe('gh_c12_11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_11 import *
import numpy as np
# See the function signature in fn/gh_c12_11.py for argument names.
```
