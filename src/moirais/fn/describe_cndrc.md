# describe('cndrc') — condorcet_winner
...
`print(result)` render. See `moirais.fn.describe('cndrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cndrc import *
import numpy as np
# See the function signature in fn/cndrc.py for argument names.
```
