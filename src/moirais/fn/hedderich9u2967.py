...
__all__ = ["hedderich_chapter_9_unnumbered_2967"]


def hedderich_chapter_9_unnumbered_2967(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ν= (r·c−1)−((r−1) + (c−1)) = r·c−r−c + 1 = (r−1)(c−1) .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2967')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2967: GeneralStatistics expression (auto-extracted; see ref)."
