# describe('spnest') — schabenberger_nested_variogram
...
`print(result)` render. See `moirais.fn.describe('spnest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnest import *
import numpy as np
# See the function signature in fn/spnest.py for argument names.
```
