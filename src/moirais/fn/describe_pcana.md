...
`print(result)` render. See `moirais.fn.describe('pcana')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcana import *
import numpy as np
# See the function signature in fn/pcana.py for argument names.
```
