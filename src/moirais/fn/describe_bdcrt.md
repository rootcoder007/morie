# describe('bdcrt') — backdoor_criterion
...
`print(result)` render. See `moirais.fn.describe('bdcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdcrt import *
import numpy as np
# See the function signature in fn/bdcrt.py for argument names.
```
