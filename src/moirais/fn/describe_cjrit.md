...
`print(result)` render. See `moirais.fn.describe('cjrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cjrit import *
import numpy as np
# See the function signature in fn/cjrit.py for argument names.
```
