# describe('km060') — kamath_ch4_krona_efficient
...
`print(result)` render. See `moirais.fn.describe('km060')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km060 import *
import numpy as np
# See the function signature in fn/km060.py for argument names.
```
