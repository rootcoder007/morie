# describe('hmhgb') — geron_histogram_gradient_boosting
...
`print(result)` render. See `moirais.fn.describe('hmhgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhgb import *
import numpy as np
# See the function signature in fn/hmhgb.py for argument names.
```
