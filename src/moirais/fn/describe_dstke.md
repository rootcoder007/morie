...
`print(result)` render. See `moirais.fn.describe('dstke')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dstke import *
import numpy as np
# See the function signature in fn/dstke.py for argument names.
```
