...
`print(result)` render. See `moirais.fn.describe('hmbart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbart import *
import numpy as np
# See the function signature in fn/hmbart.py for argument names.
```
