# describe('sgtpns') — sgt_perron_frobenius
...
`print(result)` render. See `moirais.fn.describe('sgtpns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtpns import *
import numpy as np
# See the function signature in fn/sgtpns.py for argument names.
```
