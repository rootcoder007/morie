...
`print(result)` render. See `moirais.fn.describe('ghebr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghebr import *
import numpy as np
# See the function signature in fn/ghebr.py for argument names.
```
