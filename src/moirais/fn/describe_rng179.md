# describe('rng179') — rangayyan_ch4_filtered_derivative_murthy
...
`print(result)` render. See `moirais.fn.describe('rng179')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng179 import *
import numpy as np
# See the function signature in fn/rng179.py for argument names.
```
