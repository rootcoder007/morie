# describe('johw') — joseph_holt_winters
...
`print(result)` render. See `moirais.fn.describe('johw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johw import *
import numpy as np
# See the function signature in fn/johw.py for argument names.
```
