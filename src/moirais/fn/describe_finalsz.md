# describe('finalsz') — final_epidemic_size
...
`print(result)` render. See `moirais.fn.describe('finalsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.finalsz import *
import numpy as np
# See the function signature in fn/finalsz.py for argument names.
```
