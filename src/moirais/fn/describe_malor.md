# describe('malor') — ma_log_odds_ratio
...
`print(result)` render. See `moirais.fn.describe('malor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.malor import *
import numpy as np
# See the function signature in fn/malor.py for argument names.
```
