# describe('degcen') — degree_centrality
...
`print(result)` render. See `moirais.fn.describe('degcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.degcen import *
import numpy as np
# See the function signature in fn/degcen.py for argument names.
```
