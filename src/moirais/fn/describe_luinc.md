...
`print(result)` render. See `moirais.fn.describe('luinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luinc import *
import numpy as np
# See the function signature in fn/luinc.py for argument names.
```
