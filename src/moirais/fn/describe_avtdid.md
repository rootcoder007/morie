# describe('avtdid') — avg_treatment_did
...
`print(result)` render. See `moirais.fn.describe('avtdid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avtdid import *
import numpy as np
# See the function signature in fn/avtdid.py for argument names.
```
