...
`print(result)` render. See `moirais.fn.describe('eqlrz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqlrz import *
import numpy as np
# See the function signature in fn/eqlrz.py for argument names.
```
