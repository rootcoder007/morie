...
`print(result)` render. See `moirais.fn.describe('hywte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hywte import *
import numpy as np
# See the function signature in fn/hywte.py for argument names.
```
