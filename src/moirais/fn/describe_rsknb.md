# describe('rsknb') — risk_nagelkerke
...
`print(result)` render. See `moirais.fn.describe('rsknb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsknb import *
import numpy as np
# See the function signature in fn/rsknb.py for argument names.
```
