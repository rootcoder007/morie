...
__all__ = ["hedderich_chapter_9_unnumbered_3602"]


def hedderich_chapter_9_unnumbered_3602(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] f (w) = exp(w)/(1 + exp(w))2 with σ= 1/p
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3602')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3602: Logistic expression (auto-extracted; see ref)."
