...
`print(result)` render. See `moirais.fn.describe('tsarx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsarx import *
import numpy as np
# See the function signature in fn/tsarx.py for argument names.
```
