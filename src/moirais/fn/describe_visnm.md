# describe('visnm') — mind_stone_cluster
...
`print(result)` render. See `moirais.fn.describe('visnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.visnm import *
import numpy as np
# See the function signature in fn/visnm.py for argument names.
```
