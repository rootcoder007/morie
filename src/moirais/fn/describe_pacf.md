...
`print(result)` render. See `moirais.fn.describe('pacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacf import *
import numpy as np
# See the function signature in fn/pacf.py for argument names.
```
