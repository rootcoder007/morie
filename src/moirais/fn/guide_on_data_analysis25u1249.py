...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1249"]


def guide_on_data_analysis_chapter_25_unnumbered_1249(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> D = 0.14503, p-value = 0.6449
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1249')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1249: GeneralStatistics expression (auto-extracted; see ref)."
