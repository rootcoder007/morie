...
`print(result)` render. See `moirais.fn.describe('ppenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppenv import *
import numpy as np
# See the function signature in fn/ppenv.py for argument names.
```
