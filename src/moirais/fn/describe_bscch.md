...
`print(result)` render. See `moirais.fn.describe('bscch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bscch import *
import numpy as np
# See the function signature in fn/bscch.py for argument names.
```
