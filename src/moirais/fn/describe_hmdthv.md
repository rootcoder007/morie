# describe('hmdthv') — geron_tree_high_variance
...
`print(result)` render. See `moirais.fn.describe('hmdthv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdthv import *
import numpy as np
# See the function signature in fn/hmdthv.py for argument names.
```
