...
`print(result)` render. See `moirais.fn.describe('co2Trnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.co2Trnd import *
import numpy as np
# See the function signature in fn/co2Trnd.py for argument names.
```
