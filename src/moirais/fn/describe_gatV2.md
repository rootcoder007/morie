...
`print(result)` render. See `moirais.fn.describe('gatV2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatV2 import *
import numpy as np
# See the function signature in fn/gatV2.py for argument names.
```
