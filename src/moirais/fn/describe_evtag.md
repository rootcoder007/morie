...
`print(result)` render. See `moirais.fn.describe('evtag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtag import *
import numpy as np
# See the function signature in fn/evtag.py for argument names.
```
