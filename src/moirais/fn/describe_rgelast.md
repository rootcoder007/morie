# describe('rgelast') — rangayyan_heart_elasticity
...
`print(result)` render. See `moirais.fn.describe('rgelast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgelast import *
import numpy as np
# See the function signature in fn/rgelast.py for argument names.
```
