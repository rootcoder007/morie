# describe('tetrc') — tetrachoric_corr
...
`print(result)` render. See `moirais.fn.describe('tetrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tetrc import *
import numpy as np
# See the function signature in fn/tetrc.py for argument names.
```
