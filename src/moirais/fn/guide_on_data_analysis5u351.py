...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_351"]


def guide_on_data_analysis_chapter_5_unnumbered_351(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Var( ̃𝛽 ∣ X) −Var( ̂𝛽 ∣ X) = 𝜎2 [CC′ − (X′X)−1] .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u351')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u351: GeneralStatistics expression (auto-extracted; see ref)."
