...
`print(result)` render. See `moirais.fn.describe('vmenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmenv import *
import numpy as np
# See the function signature in fn/vmenv.py for argument names.
```
