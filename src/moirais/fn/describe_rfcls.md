# describe('rfcls') — rf_classify_bio
...
`print(result)` render. See `moirais.fn.describe('rfcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfcls import *
import numpy as np
# See the function signature in fn/rfcls.py for argument names.
```
