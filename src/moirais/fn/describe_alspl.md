# describe('alspl') — alammar_sampling_decoding
...
`print(result)` render. See `moirais.fn.describe('alspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alspl import *
import numpy as np
# See the function signature in fn/alspl.py for argument names.
```
