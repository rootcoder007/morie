...
__all__ = ["hedderich_chapter_9_unnumbered_337"]


def hedderich_chapter_9_unnumbered_337(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: II 15a + 55b + 225c = 65
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u337')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u337: GeneralStatistics expression (auto-extracted; see ref)."
