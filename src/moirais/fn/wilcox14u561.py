...
__all__ = ["wilcox_chapter_14_unnumbered_561"]


def wilcox_chapter_14_unnumbered_561(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆσ 2 = (n1 − 1)s2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u561')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u561: GeneralStatistics expression (auto-extracted; see ref)."
