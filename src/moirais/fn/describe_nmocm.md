...
`print(result)` render. See `moirais.fn.describe('nmocm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmocm import *
import numpy as np
# See the function signature in fn/nmocm.py for argument names.
```
