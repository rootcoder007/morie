...
`print(result)` render. See `moirais.fn.describe('rspri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rspri import *
import numpy as np
# See the function signature in fn/rspri.py for argument names.
```
