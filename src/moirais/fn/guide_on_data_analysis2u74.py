...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_74"]


def guide_on_data_analysis_chapter_2_unnumbered_74(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑃(𝑋 = 𝑐) 𝑃(𝑐 − 0.5 < 𝑌 < 𝑐 + 0.5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u74')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u74: GeneralStatistics expression (auto-extracted; see ref)."
