...
__all__ = ["hedderich_chapter_9_unnumbered_122"]


def hedderich_chapter_9_unnumbered_122(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (x)dx =F (b)−F (a) = F (x)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u122')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u122: GeneralStatistics expression (auto-extracted; see ref)."
