# describe('mxtrn') — matrix_trace_norm
...
`print(result)` render. See `moirais.fn.describe('mxtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxtrn import *
import numpy as np
# See the function signature in fn/mxtrn.py for argument names.
```
