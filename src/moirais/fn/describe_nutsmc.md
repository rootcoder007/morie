...
`print(result)` render. See `moirais.fn.describe('nutsmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nutsmc import *
import numpy as np
# See the function signature in fn/nutsmc.py for argument names.
```
