# describe('taukcp') — kendalls_tau_copula
...
`print(result)` render. See `moirais.fn.describe('taukcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taukcp import *
import numpy as np
# See the function signature in fn/taukcp.py for argument names.
```
