# describe('rgft') — rangayyan_fourier_transform
...
`print(result)` render. See `moirais.fn.describe('rgft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgft import *
import numpy as np
# See the function signature in fn/rgft.py for argument names.
```
