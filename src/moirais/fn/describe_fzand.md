...
`print(result)` render. See `moirais.fn.describe('fzand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzand import *
import numpy as np
# See the function signature in fn/fzand.py for argument names.
```
