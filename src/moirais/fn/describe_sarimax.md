...
`print(result)` render. See `moirais.fn.describe('sarimax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarimax import *
import numpy as np
# See the function signature in fn/sarimax.py for argument names.
```
