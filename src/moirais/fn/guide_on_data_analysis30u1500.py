...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1500"]


def guide_on_data_analysis_chapter_30_unnumbered_1500(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -4 x cohort = 10 0.52 (0.60)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1500')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1500: GeneralStatistics expression (auto-extracted; see ref)."
