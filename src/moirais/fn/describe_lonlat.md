...
`print(result)` render. See `moirais.fn.describe('lonlat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lonlat import *
import numpy as np
# See the function signature in fn/lonlat.py for argument names.
```
