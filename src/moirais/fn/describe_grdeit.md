# describe('grdeit') — geron_deit_distillation_loss
...
`print(result)` render. See `moirais.fn.describe('grdeit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdeit import *
import numpy as np
# See the function signature in fn/grdeit.py for argument names.
```
