...
`print(result)` render. See `moirais.fn.describe('brrvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brrvar import *
import numpy as np
# See the function signature in fn/brrvar.py for argument names.
```
