# describe('vgani') — anisotropy_ratio
...
`print(result)` render. See `moirais.fn.describe('vgani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgani import *
import numpy as np
# See the function signature in fn/vgani.py for argument names.
```
