# describe('bwflt') — butterworth_filter
...
`print(result)` render. See `moirais.fn.describe('bwflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwflt import *
import numpy as np
# See the function signature in fn/bwflt.py for argument names.
```
