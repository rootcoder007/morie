# describe('rgntch') — rangayyan_notch_filter
...
`print(result)` render. See `moirais.fn.describe('rgntch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgntch import *
import numpy as np
# See the function signature in fn/rgntch.py for argument names.
```
