# describe('rng051') — rangayyan_ch3_lti_convolution_property
...
`print(result)` render. See `moirais.fn.describe('rng051')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng051 import *
import numpy as np
# See the function signature in fn/rng051.py for argument names.
```
