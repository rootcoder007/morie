...
__all__ = ["hedderich_chapter_9_unnumbered_2293"]


def hedderich_chapter_9_unnumbered_2293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [−δ,+δ] (see also Figure 7.20).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2293')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2293: GeneralStatistics expression (auto-extracted; see ref)."
