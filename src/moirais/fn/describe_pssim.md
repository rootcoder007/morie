...
`print(result)` render. See `moirais.fn.describe('pssim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pssim import *
import numpy as np
# See the function signature in fn/pssim.py for argument names.
```
