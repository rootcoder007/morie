...
__all__ = ["use_r_chapter_2_unnumbered_222"]


def use_r_chapter_2_unnumbered_222(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, gweight = gwr.Gauss, verbose = FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u222')`` for the full guide.
...
def cheatsheet():
    return "use_r2u222: GeneralStatistics expression (auto-extracted; see ref)."
