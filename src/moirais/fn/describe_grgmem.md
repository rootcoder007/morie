# describe('grgmem') — geron_gmm_em_step
...
`print(result)` render. See `moirais.fn.describe('grgmem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgmem import *
import numpy as np
# See the function signature in fn/grgmem.py for argument names.
```
