...
`print(result)` render. See `moirais.fn.describe('tstcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tstcr import *
import numpy as np
# See the function signature in fn/tstcr.py for argument names.
```
