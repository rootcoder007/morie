...
__all__ = ["hedderich_chapter_9_unnumbered_15"]


def hedderich_chapter_9_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (xi +yi) = (x1 +y1) + (x2 +y2) +...
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u15')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u15: GeneralStatistics expression (auto-extracted; see ref)."
