...
`print(result)` render. See `moirais.fn.describe('jjmsta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jjmsta import *
import numpy as np
# See the function signature in fn/jjmsta.py for argument names.
```
