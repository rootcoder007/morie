...
`print(result)` render. See `moirais.fn.describe('catw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catw import *
import numpy as np
# See the function signature in fn/catw.py for argument names.
```
