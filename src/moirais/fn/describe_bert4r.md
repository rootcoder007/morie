...
`print(result)` render. See `moirais.fn.describe('bert4r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bert4r import *
import numpy as np
# See the function signature in fn/bert4r.py for argument names.
```
