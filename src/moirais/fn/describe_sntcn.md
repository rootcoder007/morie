# describe('sntcn') — sentence_concurrency
...
`print(result)` render. See `moirais.fn.describe('sntcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntcn import *
import numpy as np
# See the function signature in fn/sntcn.py for argument names.
```
