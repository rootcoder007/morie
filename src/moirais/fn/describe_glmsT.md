...
`print(result)` render. See `moirais.fn.describe('glmsT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmsT import *
import numpy as np
# See the function signature in fn/glmsT.py for argument names.
```
