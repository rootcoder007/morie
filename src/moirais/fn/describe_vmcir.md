...
`print(result)` render. See `moirais.fn.describe('vmcir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcir import *
import numpy as np
# See the function signature in fn/vmcir.py for argument names.
```
