...
`print(result)` render. See `moirais.fn.describe('seibm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seibm import *
import numpy as np
# See the function signature in fn/seibm.py for argument names.
```
