...
`print(result)` render. See `moirais.fn.describe('ppmh2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmh2 import *
import numpy as np
# See the function signature in fn/ppmh2.py for argument names.
```
