# describe('rgecgfe') — rangayyan_fetal_ecg_single
...
`print(result)` render. See `moirais.fn.describe('rgecgfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgecgfe import *
import numpy as np
# See the function signature in fn/rgecgfe.py for argument names.
```
