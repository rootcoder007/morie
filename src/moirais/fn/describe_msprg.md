...
`print(result)` render. See `moirais.fn.describe('msprg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msprg import *
import numpy as np
# See the function signature in fn/msprg.py for argument names.
```
