# describe('rng227') — rangayyan_ch4_matched_filter_optimal_H_eeg
...
`print(result)` render. See `moirais.fn.describe('rng227')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng227 import *
import numpy as np
# See the function signature in fn/rng227.py for argument names.
```
