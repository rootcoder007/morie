...
`print(result)` render. See `moirais.fn.describe('clipan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clipan import *
import numpy as np
# See the function signature in fn/clipan.py for argument names.
```
