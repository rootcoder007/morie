# describe('gh_c12_1') — ghosal_infdim_bvm
...
`print(result)` render. See `moirais.fn.describe('gh_c12_1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_1 import *
import numpy as np
# See the function signature in fn/gh_c12_1.py for argument names.
```
