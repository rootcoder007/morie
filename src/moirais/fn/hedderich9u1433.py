...
__all__ = ["hedderich_chapter_9_unnumbered_1433"]


def hedderich_chapter_9_unnumbered_1433(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] P ( ˙z0.50≤˙zϱ≤˙z0.80) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1433')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1433: PowerAndDesign expression (auto-extracted; see ref)."
