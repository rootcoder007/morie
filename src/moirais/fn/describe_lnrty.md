...
`print(result)` render. See `moirais.fn.describe('lnrty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lnrty import *
import numpy as np
# See the function signature in fn/lnrty.py for argument names.
```
