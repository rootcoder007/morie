# describe('rng116') — rangayyan_ch3_three_point_central_difference
...
`print(result)` render. See `moirais.fn.describe('rng116')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng116 import *
import numpy as np
# See the function signature in fn/rng116.py for argument names.
```
