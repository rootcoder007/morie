...
`print(result)` render. See `moirais.fn.describe('dccgrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dccgrch import *
import numpy as np
# See the function signature in fn/dccgrch.py for argument names.
```
