# describe('gh_ap_k1') — ghosal_fano_ineq
...
`print(result)` render. See `moirais.fn.describe('gh_ap_k1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_k1 import *
import numpy as np
# See the function signature in fn/gh_ap_k1.py for argument names.
```
