# describe('svht2') — hotelling_2party
...
`print(result)` render. See `moirais.fn.describe('svht2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svht2 import *
import numpy as np
# See the function signature in fn/svht2.py for argument names.
```
