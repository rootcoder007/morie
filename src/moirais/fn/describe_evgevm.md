...
`print(result)` render. See `moirais.fn.describe('evgevm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevm import *
import numpy as np
# See the function signature in fn/evgevm.py for argument names.
```
