...
`print(result)` render. See `moirais.fn.describe('semsbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semsbn import *
import numpy as np
# See the function signature in fn/semsbn.py for argument names.
```
