# describe('rpl_ra') — rplace_region_age
...
`print(result)` render. See `moirais.fn.describe('rpl_ra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_ra import *
import numpy as np
# See the function signature in fn/rpl_ra.py for argument names.
```
