...
`print(result)` render. See `moirais.fn.describe('hmmae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmae import *
import numpy as np
# See the function signature in fn/hmmae.py for argument names.
```
