# describe('irtdc') — irt_discrimination_summary
...
`print(result)` render. See `moirais.fn.describe('irtdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtdc import *
import numpy as np
# See the function signature in fn/irtdc.py for argument names.
```
