# describe('ebalw') — entropy_balancing
...
`print(result)` render. See `moirais.fn.describe('ebalw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebalw import *
import numpy as np
# See the function signature in fn/ebalw.py for argument names.
```
