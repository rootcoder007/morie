# describe('rakedw') — rake_double_weights
...
`print(result)` render. See `moirais.fn.describe('rakedw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rakedw import *
import numpy as np
# See the function signature in fn/rakedw.py for argument names.
```
