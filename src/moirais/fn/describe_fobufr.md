...
`print(result)` render. See `moirais.fn.describe('fobufr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fobufr import *
import numpy as np
# See the function signature in fn/fobufr.py for argument names.
```
