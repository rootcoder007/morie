# describe('trcwgt') — truncated_combined_weights
...
`print(result)` render. See `moirais.fn.describe('trcwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcwgt import *
import numpy as np
# See the function signature in fn/trcwgt.py for argument names.
```
