...
`print(result)` render. See `moirais.fn.describe('csrtk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrtk import *
import numpy as np
# See the function signature in fn/csrtk.py for argument names.
```
