# describe('crtdv') — court_diversion
...
`print(result)` render. See `moirais.fn.describe('crtdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtdv import *
import numpy as np
# See the function signature in fn/crtdv.py for argument names.
```
