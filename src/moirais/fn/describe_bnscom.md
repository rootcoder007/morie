# describe('bnscom') — bound_compliance
...
`print(result)` render. See `moirais.fn.describe('bnscom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnscom import *
import numpy as np
# See the function signature in fn/bnscom.py for argument names.
```
