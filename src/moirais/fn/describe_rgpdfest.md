# describe('rgpdfest') — rangayyan_pdf_estimate
...
`print(result)` render. See `moirais.fn.describe('rgpdfest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpdfest import *
import numpy as np
# See the function signature in fn/rgpdfest.py for argument names.
```
