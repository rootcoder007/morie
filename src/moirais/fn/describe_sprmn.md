...
`print(result)` render. See `moirais.fn.describe('sprmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprmn import *
import numpy as np
# See the function signature in fn/sprmn.py for argument names.
```
