# describe('hrzmscr') — horowitz_manski_max_score
...
`print(result)` render. See `moirais.fn.describe('hrzmscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzmscr import *
import numpy as np
# See the function signature in fn/hrzmscr.py for argument names.
```
