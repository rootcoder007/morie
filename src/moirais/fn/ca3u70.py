...
def ca_chapter_3_unnumbered_70(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca3u70')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'represents' (auto-extracted; see reference for full context)."},
    )
