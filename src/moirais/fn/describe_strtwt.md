# describe('strtwt') — stratified_weights
...
`print(result)` render. See `moirais.fn.describe('strtwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strtwt import *
import numpy as np
# See the function signature in fn/strtwt.py for argument names.
```
