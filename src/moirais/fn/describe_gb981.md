# describe('gb981') — gibbons_scale_ci
...
`print(result)` render. See `moirais.fn.describe('gb981')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb981 import *
import numpy as np
# See the function signature in fn/gb981.py for argument names.
```
