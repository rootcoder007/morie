# describe('svpl2') — polarization_2d
...
`print(result)` render. See `moirais.fn.describe('svpl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpl2 import *
import numpy as np
# See the function signature in fn/svpl2.py for argument names.
```
