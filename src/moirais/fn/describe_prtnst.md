# describe('prtnst') — partition_test
...
`print(result)` render. See `moirais.fn.describe('prtnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prtnst import *
import numpy as np
# See the function signature in fn/prtnst.py for argument names.
```
