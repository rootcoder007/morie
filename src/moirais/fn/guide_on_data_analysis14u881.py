...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_881"]


def guide_on_data_analysis_chapter_14_unnumbered_881(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑎𝑑𝑗 = 1 −𝑆𝑆𝑅/(𝑛 − 𝑘)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u881')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u881: GeneralStatistics expression (auto-extracted; see ref)."
