...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_334"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_334(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 11 =0 .839 andφ21 =0 .544.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u334')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u334: GeneralStatistics expression (auto-extracted; see ref)."
