# describe('cslat') — causal_attention_mask
...
`print(result)` render. See `moirais.fn.describe('cslat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cslat import *
import numpy as np
# See the function signature in fn/cslat.py for argument names.
```
