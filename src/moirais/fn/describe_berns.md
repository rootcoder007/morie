# describe('berns') — bernstein_bound
...
`print(result)` render. See `moirais.fn.describe('berns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.berns import *
import numpy as np
# See the function signature in fn/berns.py for argument names.
```
