# describe('fpccor') — functional_correlation
...
`print(result)` render. See `moirais.fn.describe('fpccor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fpccor import *
import numpy as np
# See the function signature in fn/fpccor.py for argument names.
```
