# describe('clusmd') — butina_cluster
...
`print(result)` render. See `moirais.fn.describe('clusmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clusmd import *
import numpy as np
# See the function signature in fn/clusmd.py for argument names.
```
