# describe('msm169') — mvsml_ridge_lasso_elastic_eq_9_3
...
`print(result)` render. See `moirais.fn.describe('msm169')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm169 import *
import numpy as np
# See the function signature in fn/msm169.py for argument names.
```
