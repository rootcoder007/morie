# describe('msm092') — mvsml_bayesian_regression_pt2_eq_7_3
...
`print(result)` render. See `moirais.fn.describe('msm092')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm092 import *
import numpy as np
# See the function signature in fn/msm092.py for argument names.
```
