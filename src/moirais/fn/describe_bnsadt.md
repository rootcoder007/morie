# describe('bnsadt') — bound_adversarial
...
`print(result)` render. See `moirais.fn.describe('bnsadt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsadt import *
import numpy as np
# See the function signature in fn/bnsadt.py for argument names.
```
