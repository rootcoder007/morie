# describe('poppyr') — population_pyramid
...
`print(result)` render. See `moirais.fn.describe('poppyr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poppyr import *
import numpy as np
# See the function signature in fn/poppyr.py for argument names.
```
