...
`print(result)` render. See `moirais.fn.describe('hytss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hytss import *
import numpy as np
# See the function signature in fn/hytss.py for argument names.
```
