...
`print(result)` render. See `moirais.fn.describe('vol_t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vol_t import *
import numpy as np
# See the function signature in fn/vol_t.py for argument names.
```
