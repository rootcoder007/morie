...
`print(result)` render. See `moirais.fn.describe('burgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.burgp import *
import numpy as np
# See the function signature in fn/burgp.py for argument names.
```
