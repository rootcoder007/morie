# describe('synds') — syndromic_surveillance
...
`print(result)` render. See `moirais.fn.describe('synds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.synds import *
import numpy as np
# See the function signature in fn/synds.py for argument names.
```
