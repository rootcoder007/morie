# describe('msprp') — procrustes_part
...
`print(result)` render. See `moirais.fn.describe('msprp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msprp import *
import numpy as np
# See the function signature in fn/msprp.py for argument names.
```
