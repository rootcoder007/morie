# describe('ccelO') — categorical_crossentropy_loss
...
`print(result)` render. See `moirais.fn.describe('ccelO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccelO import *
import numpy as np
# See the function signature in fn/ccelO.py for argument names.
```
