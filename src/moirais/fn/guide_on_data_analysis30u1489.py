...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1489"]


def guide_on_data_analysis_chapter_30_unnumbered_1489(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -6 x cohort = 10 -0.40 (0.35)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1489')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1489: GeneralStatistics expression (auto-extracted; see ref)."
