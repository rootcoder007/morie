# describe('tmtrc') — trace_over_time
...
`print(result)` render. See `moirais.fn.describe('tmtrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmtrc import *
import numpy as np
# See the function signature in fn/tmtrc.py for argument names.
```
