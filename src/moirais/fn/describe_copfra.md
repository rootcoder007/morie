...
`print(result)` render. See `moirais.fn.describe('copfra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copfra import *
import numpy as np
# See the function signature in fn/copfra.py for argument names.
```
