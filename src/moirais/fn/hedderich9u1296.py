...
__all__ = ["hedderich_chapter_9_unnumbered_1296"]


def hedderich_chapter_9_unnumbered_1296(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 95%-CI: 0.552≤λ≤0.997
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1296')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1296: GeneralStatistics expression (auto-extracted; see ref)."
