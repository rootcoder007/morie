...
__all__ = ["hedderich_chapter_9_unnumbered_2888"]


def hedderich_chapter_9_unnumbered_2888(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: H0 :πi =πi0 i = 1,...,k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2888')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2888: ContingencyTables expression (auto-extracted; see ref)."
