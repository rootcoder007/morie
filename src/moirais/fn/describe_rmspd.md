# describe('rmspd') — rmsprop_optimize
...
`print(result)` render. See `moirais.fn.describe('rmspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmspd import *
import numpy as np
# See the function signature in fn/rmspd.py for argument names.
```
