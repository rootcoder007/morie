...
__all__ = ["wilcox_chapter_14_unnumbered_483"]


def wilcox_chapter_14_unnumbered_483(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :β 1 =β 2 = · · · =β p = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u483')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u483: GeneralStatistics expression (auto-extracted; see ref)."
