# describe('gh_c6_13') — ghosal_lecam_consist
...
`print(result)` render. See `moirais.fn.describe('gh_c6_13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c6_13 import *
import numpy as np
# See the function signature in fn/gh_c6_13.py for argument names.
```
