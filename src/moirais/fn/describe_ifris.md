# describe('ifris') — infection_fatality_rate
...
`print(result)` render. See `moirais.fn.describe('ifris')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ifris import *
import numpy as np
# See the function signature in fn/ifris.py for argument names.
```
