# describe('kmrrf') — kamath_reciprocal_rank_fusion
...
`print(result)` render. See `moirais.fn.describe('kmrrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrrf import *
import numpy as np
# See the function signature in fn/kmrrf.py for argument names.
```
