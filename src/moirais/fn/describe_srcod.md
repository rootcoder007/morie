...
`print(result)` render. See `moirais.fn.describe('srcod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srcod import *
import numpy as np
# See the function signature in fn/srcod.py for argument names.
```
