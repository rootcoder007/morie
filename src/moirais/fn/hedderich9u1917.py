...
__all__ = ["hedderich_chapter_9_unnumbered_1917"]


def hedderich_chapter_9_unnumbered_1917(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1917')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1917: CountModels expression (auto-extracted; see ref)."
