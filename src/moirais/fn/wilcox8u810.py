...
__all__ = ["wilcox_chapter_8_unnumbered_810"]


def wilcox_chapter_8_unnumbered_810(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: K (θ J1 +θ J2 + · · · +θ J K).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u810')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u810: Resampling expression (auto-extracted; see ref)."
