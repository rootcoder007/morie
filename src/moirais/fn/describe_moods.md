...
`print(result)` render. See `moirais.fn.describe('moods')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moods import *
import numpy as np
# See the function signature in fn/moods.py for argument names.
```
