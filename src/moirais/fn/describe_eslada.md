...
`print(result)` render. See `moirais.fn.describe('eslada')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslada import *
import numpy as np
# See the function signature in fn/eslada.py for argument names.
```
