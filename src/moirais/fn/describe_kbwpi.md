...
`print(result)` render. See `moirais.fn.describe('kbwpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbwpi import *
import numpy as np
# See the function signature in fn/kbwpi.py for argument names.
```
