...
`print(result)` render. See `moirais.fn.describe('enlnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enlnd import *
import numpy as np
# See the function signature in fn/enlnd.py for argument names.
```
