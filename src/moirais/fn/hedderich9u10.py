...
__all__ = ["hedderich_chapter_9_unnumbered_10"]


def hedderich_chapter_9_unnumbered_10(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: one writes x1 +x2 +...+xn = ∑i=n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u10')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u10: GeneralStatistics expression (auto-extracted; see ref)."
