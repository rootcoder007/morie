# describe('wilcox15e6') — wilcox_chapter_15_equation_6
...
```python
from moirais.fn.wilcox15e6 import wilcox_chapter_15_equation_6
import numpy as np
result = wilcox_chapter_15_equation_6(np.random.default_rng(42).normal(0, 1, 100))
