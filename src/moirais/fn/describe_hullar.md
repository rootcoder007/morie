...
`print(result)` render. See `moirais.fn.describe('hullar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hullar import *
import numpy as np
# See the function signature in fn/hullar.py for argument names.
```
