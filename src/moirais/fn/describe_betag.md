# describe('betag') — beta_regression
...
`print(result)` render. See `moirais.fn.describe('betag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.betag import *
import numpy as np
# See the function signature in fn/betag.py for argument names.
```
