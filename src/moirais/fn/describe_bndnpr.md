# describe('bndnpr') — bound_nonparam_regr
...
`print(result)` render. See `moirais.fn.describe('bndnpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndnpr import *
import numpy as np
# See the function signature in fn/bndnpr.py for argument names.
```
