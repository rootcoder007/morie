...
`print(result)` render. See `moirais.fn.describe('sparma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sparma import *
import numpy as np
# See the function signature in fn/sparma.py for argument names.
```
