...
`print(result)` render. See `moirais.fn.describe('poststs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poststs import *
import numpy as np
# See the function signature in fn/poststs.py for argument names.
```
