...
`print(result)` render. See `moirais.fn.describe('clsom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clsom import *
import numpy as np
# See the function signature in fn/clsom.py for argument names.
```
