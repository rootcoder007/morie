...
__all__ = ["hedderich_chapter_9_unnumbered_2738"]


def hedderich_chapter_9_unnumbered_2738(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] a +b +c +d = (a +b)/N
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2738')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2738: GeneralStatistics expression (auto-extracted; see ref)."
