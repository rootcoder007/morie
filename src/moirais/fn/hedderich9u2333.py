...
__all__ = ["hedderich_chapter_9_unnumbered_2333"]


def hedderich_chapter_9_unnumbered_2333(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: - normally distributed,N (µ,σ2) k< 10: Hartley, Cochran;k≥10: Bartlett
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2333')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2333: GeneralStatistics expression (auto-extracted; see ref)."
