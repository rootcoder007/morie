# describe('dualtc') — dual_total_correlation
...
`print(result)` render. See `moirais.fn.describe('dualtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dualtc import *
import numpy as np
# See the function signature in fn/dualtc.py for argument names.
```
