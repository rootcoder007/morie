# describe('rng128') — rangayyan_ch3_bilinear_unit_circle_relation
...
`print(result)` render. See `moirais.fn.describe('rng128')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng128 import *
import numpy as np
# See the function signature in fn/rng128.py for argument names.
```
