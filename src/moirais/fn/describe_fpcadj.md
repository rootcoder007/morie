# describe('fpcadj') — finite_population_corr
...
`print(result)` render. See `moirais.fn.describe('fpcadj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fpcadj import *
import numpy as np
# See the function signature in fn/fpcadj.py for argument names.
```
