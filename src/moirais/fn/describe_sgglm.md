# describe('sgglm') — spatial_glm_poisson
...
`print(result)` render. See `moirais.fn.describe('sgglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgglm import *
import numpy as np
# See the function signature in fn/sgglm.py for argument names.
```
