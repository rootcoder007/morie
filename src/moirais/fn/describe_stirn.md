# describe('stirn') — stirling_number
...
`print(result)` render. See `moirais.fn.describe('stirn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stirn import *
import numpy as np
# See the function signature in fn/stirn.py for argument names.
```
