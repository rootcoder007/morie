# describe('geglu') — geglu_activation
...
`print(result)` render. See `moirais.fn.describe('geglu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geglu import *
import numpy as np
# See the function signature in fn/geglu.py for argument names.
```
