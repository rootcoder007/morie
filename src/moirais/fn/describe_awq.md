# describe('awq') — activation_aware_quant
...
`print(result)` render. See `moirais.fn.describe('awq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.awq import *
import numpy as np
# See the function signature in fn/awq.py for argument names.
```
