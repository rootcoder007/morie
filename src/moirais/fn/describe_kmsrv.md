...
`print(result)` render. See `moirais.fn.describe('kmsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmsrv import *
import numpy as np
# See the function signature in fn/kmsrv.py for argument names.
```
