# describe('ksr062') — kosorok_ch3_pathwise_derivative
...
`print(result)` render. See `moirais.fn.describe('ksr062')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr062 import *
import numpy as np
# See the function signature in fn/ksr062.py for argument names.
```
