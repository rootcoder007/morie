...
`print(result)` render. See `moirais.fn.describe('egarcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egarcm import *
import numpy as np
# See the function signature in fn/egarcm.py for argument names.
```
