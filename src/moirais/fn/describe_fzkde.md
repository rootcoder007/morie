# describe('fzkde') — fauzi_standard_kde
...
`print(result)` render. See `moirais.fn.describe('fzkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzkde import *
import numpy as np
# See the function signature in fn/fzkde.py for argument names.
```
