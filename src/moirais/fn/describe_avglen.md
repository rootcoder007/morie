# describe('avglen') — avg_path_length
...
`print(result)` render. See `moirais.fn.describe('avglen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avglen import *
import numpy as np
# See the function signature in fn/avglen.py for argument names.
```
