# describe('dlgen') — deep_learning_genomic
...
`print(result)` render. See `moirais.fn.describe('dlgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlgen import *
import numpy as np
# See the function signature in fn/dlgen.py for argument names.
```
