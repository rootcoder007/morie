...
`print(result)` render. See `moirais.fn.describe('cohen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cohen import *
import numpy as np
# See the function signature in fn/cohen.py for argument names.
```
