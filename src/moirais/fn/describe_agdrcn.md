# describe('agdrcn') — alphazero_dirichlet_concentration
...
`print(result)` render. See `moirais.fn.describe('agdrcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdrcn import *
import numpy as np
# See the function signature in fn/agdrcn.py for argument names.
```
