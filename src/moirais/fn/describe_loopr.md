# describe('loopr') — loo_pareto_smooth
...
`print(result)` render. See `moirais.fn.describe('loopr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.loopr import *
import numpy as np
# See the function signature in fn/loopr.py for argument names.
```
