# describe('gnsetenr') — geneset_enrichment
...
`print(result)` render. See `moirais.fn.describe('gnsetenr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsetenr import *
import numpy as np
# See the function signature in fn/gnsetenr.py for argument names.
```
