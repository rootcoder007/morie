...
`print(result)` render. See `moirais.fn.describe('ubpxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubpxm import *
import numpy as np
# See the function signature in fn/ubpxm.py for argument names.
```
