# describe('atalib') — alibi_position_bias
...
`print(result)` render. See `moirais.fn.describe('atalib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atalib import *
import numpy as np
# See the function signature in fn/atalib.py for argument names.
```
