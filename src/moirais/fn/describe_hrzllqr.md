# describe('hrzllqr') — horowitz_local_linear_quantile
...
`print(result)` render. See `moirais.fn.describe('hrzllqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzllqr import *
import numpy as np
# See the function signature in fn/hrzllqr.py for argument names.
```
