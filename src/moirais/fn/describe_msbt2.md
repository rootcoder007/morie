...
`print(result)` render. See `moirais.fn.describe('msbt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msbt2 import *
import numpy as np
# See the function signature in fn/msbt2.py for argument names.
```
