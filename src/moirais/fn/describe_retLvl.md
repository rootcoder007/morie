...
`print(result)` render. See `moirais.fn.describe('retLvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.retLvl import *
import numpy as np
# See the function signature in fn/retLvl.py for argument names.
```
