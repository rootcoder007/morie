...
`print(result)` render. See `moirais.fn.describe('eslmdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslmdl import *
import numpy as np
# See the function signature in fn/eslmdl.py for argument names.
```
