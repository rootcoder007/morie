...
`print(result)` render. See `moirais.fn.describe('spkfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkfc import *
import numpy as np
# See the function signature in fn/spkfc.py for argument names.
```
