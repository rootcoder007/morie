# describe('msm269') — mvsml_convolutional_nn_eq_14_6
...
`print(result)` render. See `moirais.fn.describe('msm269')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm269 import *
import numpy as np
# See the function signature in fn/msm269.py for argument names.
```
