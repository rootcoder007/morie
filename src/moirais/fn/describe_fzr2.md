# describe('fzr2') — fauzi_r2_integral
...
`print(result)` render. See `moirais.fn.describe('fzr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzr2 import *
import numpy as np
# See the function signature in fn/fzr2.py for argument names.
```
