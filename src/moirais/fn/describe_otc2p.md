...
`print(result)` render. See `moirais.fn.describe('otc2p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otc2p import *
import numpy as np
# See the function signature in fn/otc2p.py for argument names.
```
