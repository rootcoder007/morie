...
`print(result)` render. See `moirais.fn.describe('tsarm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsarm import *
import numpy as np
# See the function signature in fn/tsarm.py for argument names.
```
