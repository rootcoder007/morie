# describe('wsmrrr') — wasserman_relative_risk
...
`print(result)` render. See `moirais.fn.describe('wsmrrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmrrr import *
import numpy as np
# See the function signature in fn/wsmrrr.py for argument names.
```
