# describe('vitatt') — vit_self_attention
...
`print(result)` render. See `moirais.fn.describe('vitatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitatt import *
import numpy as np
# See the function signature in fn/vitatt.py for argument names.
```
