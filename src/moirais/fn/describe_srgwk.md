...
`print(result)` render. See `moirais.fn.describe('srgwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwk import *
import numpy as np
# See the function signature in fn/srgwk.py for argument names.
```
