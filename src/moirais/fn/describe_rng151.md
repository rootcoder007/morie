# describe('rng151') — rangayyan_ch3_wiener_optimal_for_noise_removal
...
`print(result)` render. See `moirais.fn.describe('rng151')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng151 import *
import numpy as np
# See the function signature in fn/rng151.py for argument names.
```
