# describe('chrnf') — chernoff_distribution
...
`print(result)` render. See `moirais.fn.describe('chrnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chrnf import *
import numpy as np
# See the function signature in fn/chrnf.py for argument names.
```
