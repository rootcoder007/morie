# describe('trlsq') — total_least_squares
...
`print(result)` render. See `moirais.fn.describe('trlsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trlsq import *
import numpy as np
# See the function signature in fn/trlsq.py for argument names.
```
