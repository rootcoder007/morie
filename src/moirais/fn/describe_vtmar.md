...
`print(result)` render. See `moirais.fn.describe('vtmar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtmar import *
import numpy as np
# See the function signature in fn/vtmar.py for argument names.
```
