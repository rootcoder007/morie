...
`print(result)` render. See `moirais.fn.describe('sparsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sparsv import *
import numpy as np
# See the function signature in fn/sparsv.py for argument names.
```
