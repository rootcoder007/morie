...
`print(result)` render. See `moirais.fn.describe('adamO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adamO import *
import numpy as np
# See the function signature in fn/adamO.py for argument names.
```
