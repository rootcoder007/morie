# describe('naive') — naive_forecast

## WHAT IT DOES

Naive and seasonal naive forecast. 'What is now proved was once only imagined. — William Blake'
...
`print(result)` render. See `moirais.fn.describe('naive')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.naive import *
import numpy as np
# See the function signature in fn/naive.py for argument names.
```
