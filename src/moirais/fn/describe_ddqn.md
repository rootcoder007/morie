...
`print(result)` render. See `moirais.fn.describe('ddqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddqn import *
import numpy as np
# See the function signature in fn/ddqn.py for argument names.
```
