...
`print(result)` render. See `moirais.fn.describe('brtrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brtrf import *
import numpy as np
# See the function signature in fn/brtrf.py for argument names.
```
