# describe('gb641p') — gibbons_median_test_power
...
`print(result)` render. See `moirais.fn.describe('gb641p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb641p import *
import numpy as np
# See the function signature in fn/gb641p.py for argument names.
```
