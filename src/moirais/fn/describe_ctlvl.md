...
`print(result)` render. See `moirais.fn.describe('ctlvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctlvl import *
import numpy as np
# See the function signature in fn/ctlvl.py for argument names.
```
