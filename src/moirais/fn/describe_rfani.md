...
`print(result)` render. See `moirais.fn.describe('rfani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfani import *
import numpy as np
# See the function signature in fn/rfani.py for argument names.
```
