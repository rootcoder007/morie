...
`print(result)` render. See `moirais.fn.describe('plemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plemd import *
import numpy as np
# See the function signature in fn/plemd.py for argument names.
```
