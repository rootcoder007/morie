...
`print(result)` render. See `moirais.fn.describe('mavar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mavar import *
import numpy as np
# See the function signature in fn/mavar.py for argument names.
```
