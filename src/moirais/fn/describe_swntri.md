...
`print(result)` render. See `moirais.fn.describe('swntri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swntri import *
import numpy as np
# See the function signature in fn/swntri.py for argument names.
```
