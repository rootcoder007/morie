# describe('rng129') — rangayyan_ch3_bilinear_warping_omega_to_Omega
...
`print(result)` render. See `moirais.fn.describe('rng129')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng129 import *
import numpy as np
# See the function signature in fn/rng129.py for argument names.
```
