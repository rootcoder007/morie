...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_227"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_227(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (e) λ=0 ,m =3 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u227')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u227: GeneralStatistics expression (auto-extracted; see ref)."
