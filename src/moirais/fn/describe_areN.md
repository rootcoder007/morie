# describe('areN') — asymptotic_relative_efficiency
...
`print(result)` render. See `moirais.fn.describe('areN')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.areN import *
import numpy as np
# See the function signature in fn/areN.py for argument names.
```
