...
`print(result)` render. See `moirais.fn.describe('swknn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swknn import *
import numpy as np
# See the function signature in fn/swknn.py for argument names.
```
