# describe('grgan') — geron_gan_minimax
...
`print(result)` render. See `moirais.fn.describe('grgan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgan import *
import numpy as np
# See the function signature in fn/grgan.py for argument names.
```
