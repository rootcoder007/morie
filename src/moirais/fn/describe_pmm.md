...
`print(result)` render. See `moirais.fn.describe('pmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmm import *
import numpy as np
# See the function signature in fn/pmm.py for argument names.
```
