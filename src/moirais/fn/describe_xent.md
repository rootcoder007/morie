...
`print(result)` render. See `moirais.fn.describe('xent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xent import *
import numpy as np
# See the function signature in fn/xent.py for argument names.
```
