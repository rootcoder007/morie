...
`print(result)` render. See `moirais.fn.describe('psddb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psddb import *
import numpy as np
# See the function signature in fn/psddb.py for argument names.
```
