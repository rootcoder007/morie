...
`print(result)` render. See `moirais.fn.describe('hawkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hawkr import *
import numpy as np
# See the function signature in fn/hawkr.py for argument names.
```
