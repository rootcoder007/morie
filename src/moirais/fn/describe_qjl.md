...
`print(result)` render. See `moirais.fn.describe('qjl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qjl import *
import numpy as np
# See the function signature in fn/qjl.py for argument names.
```
