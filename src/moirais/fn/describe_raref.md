...
`print(result)` render. See `moirais.fn.describe('raref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raref import *
import numpy as np
# See the function signature in fn/raref.py for argument names.
```
