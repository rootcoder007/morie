...
__all__ = ["hedderich_chapter_9_unnumbered_715"]


def hedderich_chapter_9_unnumbered_715(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 3) = λ3e−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u715')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u715: GeneralStatistics expression (auto-extracted; see ref)."
