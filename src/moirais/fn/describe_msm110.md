# describe('msm110') — mvsml_bayesian_regression_pt2_eq_7_8
...
`print(result)` render. See `moirais.fn.describe('msm110')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm110 import *
import numpy as np
# See the function signature in fn/msm110.py for argument names.
```
