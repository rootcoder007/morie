...
__all__ = ["hedderich_chapter_9_unnumbered_1910"]


def hedderich_chapter_9_unnumbered_1910(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1) + P (X > 4|λ = 1) = 0 .0153 + 0.0037 = 0 .019 < 0.05.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1910')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1910: GeneralStatistics expression (auto-extracted; see ref)."
