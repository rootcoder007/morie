...
`print(result)` render. See `moirais.fn.describe('msdbc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdbc import *
import numpy as np
# See the function signature in fn/msdbc.py for argument names.
```
