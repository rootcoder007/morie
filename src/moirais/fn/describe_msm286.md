# describe('msm286') — mvsml_convolutional_nn_eq_14_10
...
`print(result)` render. See `moirais.fn.describe('msm286')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm286 import *
import numpy as np
# See the function signature in fn/msm286.py for argument names.
```
