# describe('gdupd') — gradient_descent_update
...
`print(result)` render. See `moirais.fn.describe('gdupd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdupd import *
import numpy as np
# See the function signature in fn/gdupd.py for argument names.
```
