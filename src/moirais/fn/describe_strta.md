# describe('strta') — stratified_analysis
...
`print(result)` render. See `moirais.fn.describe('strta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strta import *
import numpy as np
# See the function signature in fn/strta.py for argument names.
```
