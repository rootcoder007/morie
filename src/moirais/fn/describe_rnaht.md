...
`print(result)` render. See `moirais.fn.describe('rnaht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnaht import *
import numpy as np
# See the function signature in fn/rnaht.py for argument names.
```
