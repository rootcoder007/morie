...
`print(result)` render. See `moirais.fn.describe('abvoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abvoc import *
import numpy as np
# See the function signature in fn/abvoc.py for argument names.
```
