# describe('rgcry') — rangayyan_infant_cry
...
`print(result)` render. See `moirais.fn.describe('rgcry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcry import *
import numpy as np
# See the function signature in fn/rgcry.py for argument names.
```
