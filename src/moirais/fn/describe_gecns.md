...
`print(result)` render. See `moirais.fn.describe('gecns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gecns import *
import numpy as np
# See the function signature in fn/gecns.py for argument names.
```
