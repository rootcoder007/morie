# describe('rng147') — rangayyan_ch3_minimum_mse
...
`print(result)` render. See `moirais.fn.describe('rng147')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng147 import *
import numpy as np
# See the function signature in fn/rng147.py for argument names.
```
