# describe('hrzsmsrc') — horowitz_sms_rate
...
`print(result)` render. See `moirais.fn.describe('hrzsmsrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsmsrc import *
import numpy as np
# See the function signature in fn/hrzsmsrc.py for argument names.
```
