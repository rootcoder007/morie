# describe('gb651p') — gibbons_ctrl_median_power
...
`print(result)` render. See `moirais.fn.describe('gb651p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb651p import *
import numpy as np
# See the function signature in fn/gb651p.py for argument names.
```
