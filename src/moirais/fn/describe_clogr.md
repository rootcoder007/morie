# describe('clogr') — conditional_logistic
...
`print(result)` render. See `moirais.fn.describe('clogr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clogr import *
import numpy as np
# See the function signature in fn/clogr.py for argument names.
```
