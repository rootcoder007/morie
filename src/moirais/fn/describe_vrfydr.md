...
`print(result)` render. See `moirais.fn.describe('vrfydr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrfydr import *
import numpy as np
# See the function signature in fn/vrfydr.py for argument names.
```
