...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_445"]


def guide_on_data_analysis_chapter_6_unnumbered_445(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] a′￿ ± 𝑡(1−𝛼/2,𝑛−𝑝)𝑠√a′[F(̂ ￿)′F(̂ ￿)]−1a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u445')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u445: GeneralStatistics expression (auto-extracted; see ref)."
