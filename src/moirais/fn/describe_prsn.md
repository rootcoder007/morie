...
`print(result)` render. See `moirais.fn.describe('prsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsn import *
import numpy as np
# See the function signature in fn/prsn.py for argument names.
```
