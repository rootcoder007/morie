# describe('clbuvc') — club_upper_bound
...
`print(result)` render. See `moirais.fn.describe('clbuvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clbuvc import *
import numpy as np
# See the function signature in fn/clbuvc.py for argument names.
```
