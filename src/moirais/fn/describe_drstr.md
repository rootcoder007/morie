# describe('drstr') — multiverse_bootstrap
...
`print(result)` render. See `moirais.fn.describe('drstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drstr import *
import numpy as np
# See the function signature in fn/drstr.py for argument names.
```
