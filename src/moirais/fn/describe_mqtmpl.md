...
`print(result)` render. See `moirais.fn.describe('mqtmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mqtmpl import *
import numpy as np
# See the function signature in fn/mqtmpl.py for argument names.
```
