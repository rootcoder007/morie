# describe('fftpk') — fft_peaks

## WHAT IT DOES

Find dominant frequencies via FFT. 'The whole is greater than the sum of its parts. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('fftpk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fftpk import *
import numpy as np
# See the function signature in fn/fftpk.py for argument names.
```
