...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1193"]


def guide_on_data_analysis_chapter_24_unnumbered_1193(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘 = 𝜇.. + 𝛼𝑖 + 𝛽𝑗(𝑖)+ 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1193')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1193: GeneralStatistics expression (auto-extracted; see ref)."
