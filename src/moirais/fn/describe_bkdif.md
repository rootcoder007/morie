# describe('bkdif') — backward_difference
...
`print(result)` render. See `moirais.fn.describe('bkdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkdif import *
import numpy as np
# See the function signature in fn/bkdif.py for argument names.
```
