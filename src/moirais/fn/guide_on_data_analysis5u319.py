...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_319"]


def guide_on_data_analysis_chapter_5_unnumbered_319(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑦 = 𝛽0 + 𝑥1𝛽1 + 𝑥2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u319')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u319: GeneralStatistics expression (auto-extracted; see ref)."
