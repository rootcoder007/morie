# describe('tmlcic') — tmle_cluster_ic
...
`print(result)` render. See `moirais.fn.describe('tmlcic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcic import *
import numpy as np
# See the function signature in fn/tmlcic.py for argument names.
```
