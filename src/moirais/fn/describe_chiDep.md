# describe('chiDep') — chi_dependence
...
`print(result)` render. See `moirais.fn.describe('chiDep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chiDep import *
import numpy as np
# See the function signature in fn/chiDep.py for argument names.
```
