# describe('gelua') — gelua

## WHAT IT DOES

rGELU activation (exact and approximation).
...
`print(result)` render. See `moirais.fn.describe('gelua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gelua import *
import numpy as np
# See the function signature in fn/gelua.py for argument names.
```
