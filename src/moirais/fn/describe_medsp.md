...
`print(result)` render. See `moirais.fn.describe('medsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medsp import *
import numpy as np
# See the function signature in fn/medsp.py for argument names.
```
