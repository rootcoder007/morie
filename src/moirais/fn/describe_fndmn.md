# describe('fndmn') — fundamental_freq
...
`print(result)` render. See `moirais.fn.describe('fndmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fndmn import *
import numpy as np
# See the function signature in fn/fndmn.py for argument names.
```
