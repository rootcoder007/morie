...
def bookadvanced_elementsofstatisticallearning_chapter_4_unnumbered_188(x):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bookadvanced_elementsofstatisticallearning4u188')`` for the full guide.
...
def cheatsheet():
    return "bookadvanced_elementsofstatisticallearning4u188: Correlation expression (auto-extracted; see ref)."
