...
`print(result)` render. See `moirais.fn.describe('tfplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tfplt import *
import numpy as np
# See the function signature in fn/tfplt.py for argument names.
```
