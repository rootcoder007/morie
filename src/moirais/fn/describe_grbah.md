# describe('grbah') — geron_bahdanau_attention
...
`print(result)` render. See `moirais.fn.describe('grbah')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbah import *
import numpy as np
# See the function signature in fn/grbah.py for argument names.
```
