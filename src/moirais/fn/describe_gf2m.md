...
`print(result)` render. See `moirais.fn.describe('gf2m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gf2m import *
import numpy as np
# See the function signature in fn/gf2m.py for argument names.
```
