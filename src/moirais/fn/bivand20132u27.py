...
__all__ = ["bivand2013_chapter_2_unnumbered_27"]


def bivand2013_chapter_2_unnumbered_27(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ΔX=8 7±3m,ΔY = −96±3m,ΔZ = −120±3m, with a sign change on
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u27')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u27: GeneralStatistics expression (auto-extracted; see ref)."
