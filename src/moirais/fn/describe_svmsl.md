# describe('svmsl') — svm_soft_margin
...
`print(result)` render. See `moirais.fn.describe('svmsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmsl import *
import numpy as np
# See the function signature in fn/svmsl.py for argument names.
```
