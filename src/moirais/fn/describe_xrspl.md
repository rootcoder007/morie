...
`print(result)` render. See `moirais.fn.describe('xrspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspl import *
import numpy as np
# See the function signature in fn/xrspl.py for argument names.
```
