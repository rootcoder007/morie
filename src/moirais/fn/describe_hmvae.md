...
`print(result)` render. See `moirais.fn.describe('hmvae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvae import *
import numpy as np
# See the function signature in fn/hmvae.py for argument names.
```
