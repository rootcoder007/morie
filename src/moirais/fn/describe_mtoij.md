# describe('mtoij') — mto_injury_severity
...
`print(result)` render. See `moirais.fn.describe('mtoij')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtoij import *
import numpy as np
# See the function signature in fn/mtoij.py for argument names.
```
