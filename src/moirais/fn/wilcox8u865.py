...
__all__ = ["wilcox_chapter_8_unnumbered_865"]


def wilcox_chapter_8_unnumbered_865(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] D = (0 − ˆθ )S−1 (0 − ˆθ )′.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u865')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u865: PowerAndDesign expression (auto-extracted; see ref)."
