...
`print(result)` render. See `moirais.fn.describe('opmxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opmxm import *
import numpy as np
# See the function signature in fn/opmxm.py for argument names.
```
