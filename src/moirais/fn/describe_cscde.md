# describe('cscde') — cascade_classify
...
`print(result)` render. See `moirais.fn.describe('cscde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscde import *
import numpy as np
# See the function signature in fn/cscde.py for argument names.
```
