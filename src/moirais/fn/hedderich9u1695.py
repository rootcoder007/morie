...
__all__ = ["hedderich_chapter_9_unnumbered_1695"]


def hedderich_chapter_9_unnumbered_1695(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • Bi =ni = Observed frequency (occupancy number) of classi, i.e.,n =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1695')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1695: GeneralStatistics expression (auto-extracted; see ref)."
