...
__all__ = ["hedderich_chapter_9_unnumbered_2773"]


def hedderich_chapter_9_unnumbered_2773(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P =P (zZ̄1(+∆)) +P (z≥Z1(−∆))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2773')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2773: GeneralStatistics expression (auto-extracted; see ref)."
