...
__all__ = ["hedderich_chapter_9_unnumbered_1798"]


def hedderich_chapter_9_unnumbered_1798(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] p0 ps = 0.05 ps = 0.10 ps = 0.15 ps = 0.20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1798')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1798: CountModels expression (auto-extracted; see ref)."
