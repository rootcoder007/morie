...
`print(result)` render. See `moirais.fn.describe('wlibe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlibe import *
import numpy as np
# See the function signature in fn/wlibe.py for argument names.
```
