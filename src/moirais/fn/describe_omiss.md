# describe('omiss') — otis_missing_report
...
`print(result)` render. See `moirais.fn.describe('omiss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omiss import *
import numpy as np
# See the function signature in fn/omiss.py for argument names.
```
