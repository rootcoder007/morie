# describe('km139') — kamath_ch9_simvlm_prefixlm
...
`print(result)` render. See `moirais.fn.describe('km139')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km139 import *
import numpy as np
# See the function signature in fn/km139.py for argument names.
```
