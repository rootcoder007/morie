...
`print(result)` render. See `moirais.fn.describe('cload')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cload import *
import numpy as np
# See the function signature in fn/cload.py for argument names.
```
