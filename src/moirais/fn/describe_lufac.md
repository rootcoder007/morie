...
`print(result)` render. See `moirais.fn.describe('lufac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lufac import *
import numpy as np
# See the function signature in fn/lufac.py for argument names.
```
