...
`print(result)` render. See `moirais.fn.describe('swrow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swrow import *
import numpy as np
# See the function signature in fn/swrow.py for argument names.
```
