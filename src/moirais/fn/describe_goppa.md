...
`print(result)` render. See `moirais.fn.describe('goppa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.goppa import *
import numpy as np
# See the function signature in fn/goppa.py for argument names.
```
