...
__all__ = ["hedderich_chapter_9_unnumbered_804"]


def hedderich_chapter_9_unnumbered_804(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Due to symmetry:P = (0.04 ≦Z ≦ 4.00) = P (Z ≧ 0.04)−
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u804')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u804: GeneralStatistics expression (auto-extracted; see ref)."
