# describe('rng006') — rangayyan_ch3_entropy_continuous
...
`print(result)` render. See `moirais.fn.describe('rng006')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng006 import *
import numpy as np
# See the function signature in fn/rng006.py for argument names.
```
