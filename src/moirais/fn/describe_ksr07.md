# describe('ksr07') — kosorok_bootstrap_empirical
...
`print(result)` render. See `moirais.fn.describe('ksr07')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr07 import *
import numpy as np
# See the function signature in fn/ksr07.py for argument names.
```
