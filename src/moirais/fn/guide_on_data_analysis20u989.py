...
__all__ = ["guide_on_data_analysis_chapter_20_unnumbered_989"]


def guide_on_data_analysis_chapter_20_unnumbered_989(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌 = 𝑋𝛽 + 𝜀, 𝔼[𝜀 ∣ 𝑋] = 0, Var(𝜀 ∣ 𝑋) = 𝜎2𝐼.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis20u989')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis20u989: GeneralStatistics expression (auto-extracted; see ref)."
