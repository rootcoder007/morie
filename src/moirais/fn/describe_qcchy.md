...
`print(result)` render. See `moirais.fn.describe('qcchy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qcchy import *
import numpy as np
# See the function signature in fn/qcchy.py for argument names.
```
