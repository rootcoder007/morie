# describe('joacf') — joseph_autocorrelation_function
...
`print(result)` render. See `moirais.fn.describe('joacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joacf import *
import numpy as np
# See the function signature in fn/joacf.py for argument names.
```
