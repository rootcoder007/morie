...
def ca_chapter_1_unnumbered_12(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca1u12')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Logistic expression involving 'condition' (auto-extracted; see reference for full context)."},
    )
