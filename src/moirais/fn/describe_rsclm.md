...
`print(result)` render. See `moirais.fn.describe('rsclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsclm import *
import numpy as np
# See the function signature in fn/rsclm.py for argument names.
```
