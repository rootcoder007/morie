...
`print(result)` render. See `moirais.fn.describe('abhch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abhch import *
import numpy as np
# See the function signature in fn/abhch.py for argument names.
```
