# describe('smfd') — smooth_functional_data
...
`print(result)` render. See `moirais.fn.describe('smfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smfd import *
import numpy as np
# See the function signature in fn/smfd.py for argument names.
```
