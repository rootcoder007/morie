...
`print(result)` render. See `moirais.fn.describe('rskpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskpr import *
import numpy as np
# See the function signature in fn/rskpr.py for argument names.
```
