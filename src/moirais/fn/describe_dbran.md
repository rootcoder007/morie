# describe('dbran') — d_brane_tension
...
`print(result)` render. See `moirais.fn.describe('dbran')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbran import *
import numpy as np
# See the function signature in fn/dbran.py for argument names.
```
