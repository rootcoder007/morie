...
__all__ = ["bivand2013_chapter_7_unnumbered_192"]


def bivand2013_chapter_7_unnumbered_192(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lm(formula = Z ~ PEXPOSURE + PCTAGE65P + PCTOWNHOME, data = NY8,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u192')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u192: GeneralStatistics expression (auto-extracted; see ref)."
