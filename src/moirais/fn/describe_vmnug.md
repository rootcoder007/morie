...
`print(result)` render. See `moirais.fn.describe('vmnug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmnug import *
import numpy as np
# See the function signature in fn/vmnug.py for argument names.
```
