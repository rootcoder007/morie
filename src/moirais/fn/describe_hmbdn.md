# describe('hmbdn') — geron_bahdanau_attention
...
`print(result)` render. See `moirais.fn.describe('hmbdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbdn import *
import numpy as np
# See the function signature in fn/hmbdn.py for argument names.
```
