...
`print(result)` render. See `moirais.fn.describe('rstcw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rstcw import *
import numpy as np
# See the function signature in fn/rstcw.py for argument names.
```
