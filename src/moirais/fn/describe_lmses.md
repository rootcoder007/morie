# describe('lmses') — least_median_squares
...
`print(result)` render. See `moirais.fn.describe('lmses')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmses import *
import numpy as np
# See the function signature in fn/lmses.py for argument names.
```
