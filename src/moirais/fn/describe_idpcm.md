...
`print(result)` render. See `moirais.fn.describe('idpcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpcm import *
import numpy as np
# See the function signature in fn/idpcm.py for argument names.
```
