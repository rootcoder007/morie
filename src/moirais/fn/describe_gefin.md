...
`print(result)` render. See `moirais.fn.describe('gefin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gefin import *
import numpy as np
# See the function signature in fn/gefin.py for argument names.
```
