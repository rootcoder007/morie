...
`print(result)` render. See `moirais.fn.describe('dtfsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtfsk import *
import numpy as np
# See the function signature in fn/dtfsk.py for argument names.
```
