# describe('ltmcr') — little_mcar_test
...
`print(result)` render. See `moirais.fn.describe('ltmcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltmcr import *
import numpy as np
# See the function signature in fn/ltmcr.py for argument names.
```
