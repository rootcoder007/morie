# describe('simip') — simulate_ideal_points
...
`print(result)` render. See `moirais.fn.describe('simip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simip import *
import numpy as np
# See the function signature in fn/simip.py for argument names.
```
