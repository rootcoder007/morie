...
`print(result)` render. See `moirais.fn.describe('sghist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sghist import *
import numpy as np
# See the function signature in fn/sghist.py for argument names.
```
