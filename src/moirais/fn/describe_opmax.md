...
`print(result)` render. See `moirais.fn.describe('opmax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opmax import *
import numpy as np
# See the function signature in fn/opmax.py for argument names.
```
