...
__all__ = ["wilcox_chapter_4_unnumbered_211"]


def wilcox_chapter_4_unnumbered_211(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: valuesX1 = 1.5,X2 = −1.2, X3 = 3.89,X4 = 0.4, and X5 = −0.6. Random sampling means
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u211')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u211: GeneralStatistics expression (auto-extracted; see ref)."
