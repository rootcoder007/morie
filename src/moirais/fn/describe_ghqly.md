...
`print(result)` render. See `moirais.fn.describe('ghqly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghqly import *
import numpy as np
# See the function signature in fn/ghqly.py for argument names.
```
