# describe('survgen') — general_estimating_eq_surv
...
`print(result)` render. See `moirais.fn.describe('survgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survgen import *
import numpy as np
# See the function signature in fn/survgen.py for argument names.
```
