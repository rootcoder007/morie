...
__all__ = ["hedderich_chapter_9_unnumbered_2169"]


def hedderich_chapter_9_unnumbered_2169(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆR(n;α) = n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2169')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2169: GeneralStatistics expression (auto-extracted; see ref)."
