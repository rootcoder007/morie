# describe('alinfn') — alammar_infonce_loss
...
`print(result)` render. See `moirais.fn.describe('alinfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alinfn import *
import numpy as np
# See the function signature in fn/alinfn.py for argument names.
```
