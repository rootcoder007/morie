# describe('msm125') — mvsml_categorical_count_eq_8_2
...
`print(result)` render. See `moirais.fn.describe('msm125')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm125 import *
import numpy as np
# See the function signature in fn/msm125.py for argument names.
```
