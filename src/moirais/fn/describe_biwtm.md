# describe('biwtm') — biweight_midcorrelation

## WHAT IT DOES

Biweight midcorrelation. 'He who has a why to live can bear almost any how. — Friedrich Nietzsche'
...
`print(result)` render. See `moirais.fn.describe('biwtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.biwtm import *
import numpy as np
# See the function signature in fn/biwtm.py for argument names.
```
