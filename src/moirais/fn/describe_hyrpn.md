...
`print(result)` render. See `moirais.fn.describe('hyrpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyrpn import *
import numpy as np
# See the function signature in fn/hyrpn.py for argument names.
```
