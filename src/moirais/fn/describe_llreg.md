...
`print(result)` render. See `moirais.fn.describe('llreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.llreg import *
import numpy as np
# See the function signature in fn/llreg.py for argument names.
```
