...
__all__ = ["hedderich_chapter_9_unnumbered_3304"]


def hedderich_chapter_9_unnumbered_3304(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆF = RSS(p)−RSS(p+1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3304')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3304: GeneralStatistics expression (auto-extracted; see ref)."
