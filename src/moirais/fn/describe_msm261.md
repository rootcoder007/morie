# describe('msm261') — mvsml_convolutional_nn_eq_14_1
...
`print(result)` render. See `moirais.fn.describe('msm261')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm261 import *
import numpy as np
# See the function signature in fn/msm261.py for argument names.
```
