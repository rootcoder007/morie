...
`print(result)` render. See `moirais.fn.describe('splogit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splogit import *
import numpy as np
# See the function signature in fn/splogit.py for argument names.
```
