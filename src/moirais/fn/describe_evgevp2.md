...
`print(result)` render. See `moirais.fn.describe('evgevp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevp2 import *
import numpy as np
# See the function signature in fn/evgevp2.py for argument names.
```
