...
`print(result)` render. See `moirais.fn.describe('sclst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sclst import *
import numpy as np
# See the function signature in fn/sclst.py for argument names.
```
