...
`print(result)` render. See `moirais.fn.describe('lockm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lockm import *
import numpy as np
# See the function signature in fn/lockm.py for argument names.
```
