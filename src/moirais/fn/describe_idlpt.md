# describe('idlpt') — ideal_point_recovery
...
`print(result)` render. See `moirais.fn.describe('idlpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idlpt import *
import numpy as np
# See the function signature in fn/idlpt.py for argument names.
```
