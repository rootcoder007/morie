...
`print(result)` render. See `moirais.fn.describe('zxw84')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxw84 import *
import numpy as np
# See the function signature in fn/zxw84.py for argument names.
```
