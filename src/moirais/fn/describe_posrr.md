# describe('posrr') — posterior_predictive_replication
...
`print(result)` render. See `moirais.fn.describe('posrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.posrr import *
import numpy as np
# See the function signature in fn/posrr.py for argument names.
```
