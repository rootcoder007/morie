# describe('bayfin') — finite_mixture
...
`print(result)` render. See `moirais.fn.describe('bayfin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayfin import *
import numpy as np
# See the function signature in fn/bayfin.py for argument names.
```
