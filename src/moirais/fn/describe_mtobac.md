# describe('mtobac') — mto_bac_analysis
...
`print(result)` render. See `moirais.fn.describe('mtobac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtobac import *
import numpy as np
# See the function signature in fn/mtobac.py for argument names.
```
