# describe('rgcwvd') — rangayyan_cohen_class
...
`print(result)` render. See `moirais.fn.describe('rgcwvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcwvd import *
import numpy as np
# See the function signature in fn/rgcwvd.py for argument names.
```
