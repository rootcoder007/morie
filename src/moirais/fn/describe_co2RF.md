# describe('co2RF') — radiative_forcing_co2
...
`print(result)` render. See `moirais.fn.describe('co2RF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.co2RF import *
import numpy as np
# See the function signature in fn/co2RF.py for argument names.
```
