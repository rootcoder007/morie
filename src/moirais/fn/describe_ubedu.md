...
`print(result)` render. See `moirais.fn.describe('ubedu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubedu import *
import numpy as np
# See the function signature in fn/ubedu.py for argument names.
```
