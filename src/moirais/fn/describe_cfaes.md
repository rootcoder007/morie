...
`print(result)` render. See `moirais.fn.describe('cfaes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfaes import *
import numpy as np
# See the function signature in fn/cfaes.py for argument names.
```
