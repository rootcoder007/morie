...
`print(result)` render. See `moirais.fn.describe('ctvert')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctvert import *
import numpy as np
# See the function signature in fn/ctvert.py for argument names.
```
