# describe('stdmr') — standardized_mortality_ratio
...
`print(result)` render. See `moirais.fn.describe('stdmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdmr import *
import numpy as np
# See the function signature in fn/stdmr.py for argument names.
```
