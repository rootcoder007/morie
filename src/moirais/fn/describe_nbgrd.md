...
`print(result)` render. See `moirais.fn.describe('nbgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbgrd import *
import numpy as np
# See the function signature in fn/nbgrd.py for argument names.
```
