...
`print(result)` render. See `moirais.fn.describe('geinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geinc import *
import numpy as np
# See the function signature in fn/geinc.py for argument names.
```
