...
`print(result)` render. See `moirais.fn.describe('drlrnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drlrnr import *
import numpy as np
# See the function signature in fn/drlrnr.py for argument names.
```
