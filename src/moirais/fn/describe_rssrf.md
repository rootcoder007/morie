...
`print(result)` render. See `moirais.fn.describe('rssrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rssrf import *
import numpy as np
# See the function signature in fn/rssrf.py for argument names.
```
