# describe('eslprc') — esl_perceptron
...
`print(result)` render. See `moirais.fn.describe('eslprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslprc import *
import numpy as np
# See the function signature in fn/eslprc.py for argument names.
```
