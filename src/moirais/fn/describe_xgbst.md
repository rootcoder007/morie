# describe('xgbst') — xgboost_objective
...
`print(result)` render. See `moirais.fn.describe('xgbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xgbst import *
import numpy as np
# See the function signature in fn/xgbst.py for argument names.
```
