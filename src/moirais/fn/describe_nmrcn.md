# describe('nmrcn') — roll_call_normalize
...
`print(result)` render. See `moirais.fn.describe('nmrcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmrcn import *
import numpy as np
# See the function signature in fn/nmrcn.py for argument names.
```
