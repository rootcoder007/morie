# describe('unfld') — unfolding_model
...
`print(result)` render. See `moirais.fn.describe('unfld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unfld import *
import numpy as np
# See the function signature in fn/unfld.py for argument names.
```
