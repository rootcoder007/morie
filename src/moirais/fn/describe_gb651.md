# describe('gb651') — gibbons_ctrl_median
...
`print(result)` render. See `moirais.fn.describe('gb651')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb651 import *
import numpy as np
# See the function signature in fn/gb651.py for argument names.
```
