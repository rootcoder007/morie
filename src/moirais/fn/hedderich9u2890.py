...
__all__ = ["hedderich_chapter_9_unnumbered_2890"]


def hedderich_chapter_9_unnumbered_2890(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2890')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2890: GeneralStatistics expression (auto-extracted; see ref)."
