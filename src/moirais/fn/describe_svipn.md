# describe('svipn') — ideal_point_normal
...
`print(result)` render. See `moirais.fn.describe('svipn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipn import *
import numpy as np
# See the function signature in fn/svipn.py for argument names.
```
