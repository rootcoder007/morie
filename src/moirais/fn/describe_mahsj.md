...
`print(result)` render. See `moirais.fn.describe('mahsj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mahsj import *
import numpy as np
# See the function signature in fn/mahsj.py for argument names.
```
