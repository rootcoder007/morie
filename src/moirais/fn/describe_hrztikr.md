# describe('hrztikr') — horowitz_tikhonov_npiv
...
`print(result)` render. See `moirais.fn.describe('hrztikr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztikr import *
import numpy as np
# See the function signature in fn/hrztikr.py for argument names.
```
