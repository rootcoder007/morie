...
`print(result)` render. See `moirais.fn.describe('plwlf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plwlf import *
import numpy as np
# See the function signature in fn/plwlf.py for argument names.
```
