# describe('gb45lf') — gibbons_lilliefors_normal
...
`print(result)` render. See `moirais.fn.describe('gb45lf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb45lf import *
import numpy as np
# See the function signature in fn/gb45lf.py for argument names.
```
