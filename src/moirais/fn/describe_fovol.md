...
`print(result)` render. See `moirais.fn.describe('fovol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fovol import *
import numpy as np
# See the function signature in fn/fovol.py for argument names.
```
