...
`print(result)` render. See `moirais.fn.describe('elbdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elbdm import *
import numpy as np
# See the function signature in fn/elbdm.py for argument names.
```
