...
__all__ = ["hedderich_chapter_9_unnumbered_2883"]


def hedderich_chapter_9_unnumbered_2883(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |pi−pj|>q∞;k;1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2883')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2883: GeneralStatistics expression (auto-extracted; see ref)."
