# describe('gh_c14_6') — ghosal_ssp_post
...
`print(result)` render. See `moirais.fn.describe('gh_c14_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_6 import *
import numpy as np
# See the function signature in fn/gh_c14_6.py for argument names.
```
