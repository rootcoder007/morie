# describe('hotcld') — hot_cold_spots
...
`print(result)` render. See `moirais.fn.describe('hotcld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotcld import *
import numpy as np
# See the function signature in fn/hotcld.py for argument names.
```
