...
`print(result)` render. See `moirais.fn.describe('mai2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mai2 import *
import numpy as np
# See the function signature in fn/mai2.py for argument names.
```
