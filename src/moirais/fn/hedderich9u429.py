...
__all__ = ["hedderich_chapter_9_unnumbered_429"]


def hedderich_chapter_9_unnumbered_429(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (B) = 0.7 [cf.P (B|A) = 6/8 = 0.75]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u429')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u429: GeneralStatistics expression (auto-extracted; see ref)."
