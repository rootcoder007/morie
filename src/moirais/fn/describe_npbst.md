...
`print(result)` render. See `moirais.fn.describe('npbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npbst import *
import numpy as np
# See the function signature in fn/npbst.py for argument names.
```
