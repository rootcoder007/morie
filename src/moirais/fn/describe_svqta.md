...
`print(result)` render. See `moirais.fn.describe('svqta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svqta import *
import numpy as np
# See the function signature in fn/svqta.py for argument names.
```
