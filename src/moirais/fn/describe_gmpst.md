...
`print(result)` render. See `moirais.fn.describe('gmpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmpst import *
import numpy as np
# See the function signature in fn/gmpst.py for argument names.
```
