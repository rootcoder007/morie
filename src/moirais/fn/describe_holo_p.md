...
`print(result)` render. See `moirais.fn.describe('holo_p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_p import *
import numpy as np
# See the function signature in fn/holo_p.py for argument names.
```
