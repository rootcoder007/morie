...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_367"]


def guide_on_data_analysis_chapter_5_unnumbered_367(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2. Asymptotic normality of √𝑛(𝑛−1 ∑
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u367')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u367: GeneralStatistics expression (auto-extracted; see ref)."
