...
__all__ = ["hedderich_chapter_9_unnumbered_2949"]


def hedderich_chapter_9_unnumbered_2949(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2 and 3 from the example with the null hypothesis H0 : π2 = π3 = 0.60 against the alternative
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2949')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2949: GeneralStatistics expression (auto-extracted; see ref)."
