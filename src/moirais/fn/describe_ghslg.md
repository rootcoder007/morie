...
`print(result)` render. See `moirais.fn.describe('ghslg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghslg import *
import numpy as np
# See the function signature in fn/ghslg.py for argument names.
```
