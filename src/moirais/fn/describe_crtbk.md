...
`print(result)` render. See `moirais.fn.describe('crtbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtbk import *
import numpy as np
# See the function signature in fn/crtbk.py for argument names.
```
