...
`print(result)` render. See `moirais.fn.describe('srgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgmm import *
import numpy as np
# See the function signature in fn/srgmm.py for argument names.
```
