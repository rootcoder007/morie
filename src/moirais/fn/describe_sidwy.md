# describe('sidwy') — adversarial_perturb
...
`print(result)` render. See `moirais.fn.describe('sidwy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sidwy import *
import numpy as np
# See the function signature in fn/sidwy.py for argument names.
```
