...
`print(result)` render. See `moirais.fn.describe('srsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srsdm import *
import numpy as np
# See the function signature in fn/srsdm.py for argument names.
```
