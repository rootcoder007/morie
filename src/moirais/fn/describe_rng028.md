# describe('rng028') — rangayyan_ch3_sifting_property
...
`print(result)` render. See `moirais.fn.describe('rng028')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng028 import *
import numpy as np
# See the function signature in fn/rng028.py for argument names.
```
