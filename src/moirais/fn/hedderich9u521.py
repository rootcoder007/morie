...
__all__ = ["hedderich_chapter_9_unnumbered_521"]


def hedderich_chapter_9_unnumbered_521(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b) p = 300/900 = 0.333 c = 3/300 = 0.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u521')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u521: GeneralStatistics expression (auto-extracted; see ref)."
