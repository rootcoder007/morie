...
`print(result)` render. See `moirais.fn.describe('jacsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jacsim import *
import numpy as np
# See the function signature in fn/jacsim.py for argument names.
```
