...
`print(result)` render. See `moirais.fn.describe('pchzr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pchzr import *
import numpy as np
# See the function signature in fn/pchzr.py for argument names.
```
