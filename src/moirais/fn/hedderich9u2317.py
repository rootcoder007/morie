...
__all__ = ["hedderich_chapter_9_unnumbered_2317"]


def hedderich_chapter_9_unnumbered_2317(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R(t) = #{pi≤t; i = 1,...,m}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2317')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2317: GeneralStatistics expression (auto-extracted; see ref)."
