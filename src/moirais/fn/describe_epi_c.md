...
`print(result)` render. See `moirais.fn.describe('epi_c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epi_c import *
import numpy as np
# See the function signature in fn/epi_c.py for argument names.
```
