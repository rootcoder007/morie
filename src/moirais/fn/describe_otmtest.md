# describe('otmtest') — ot_mmd_two_sample
...
`print(result)` render. See `moirais.fn.describe('otmtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmtest import *
import numpy as np
# See the function signature in fn/otmtest.py for argument names.
```
