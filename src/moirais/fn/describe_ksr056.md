# describe('ksr056') — kosorok_ch2_lad_lipschitz_bound
...
`print(result)` render. See `moirais.fn.describe('ksr056')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr056 import *
import numpy as np
# See the function signature in fn/ksr056.py for argument names.
```
