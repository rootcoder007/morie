# describe('rgcorad') — rangayyan_coronary_ad
...
`print(result)` render. See `moirais.fn.describe('rgcorad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcorad import *
import numpy as np
# See the function signature in fn/rgcorad.py for argument names.
```
