# describe('rgwavstr') — rangayyan_wavelet_struct
...
`print(result)` render. See `moirais.fn.describe('rgwavstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwavstr import *
import numpy as np
# See the function signature in fn/rgwavstr.py for argument names.
```
