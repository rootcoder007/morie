...
`print(result)` render. See `moirais.fn.describe('lapfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lapfp import *
import numpy as np
# See the function signature in fn/lapfp.py for argument names.
```
