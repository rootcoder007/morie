# describe('grn011') — geron_ch4_lasso_regression_cost_function
...
`print(result)` render. See `moirais.fn.describe('grn011')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grn011 import *
import numpy as np
# See the function signature in fn/grn011.py for argument names.
```
