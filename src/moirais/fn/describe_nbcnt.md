...
`print(result)` render. See `moirais.fn.describe('nbcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcnt import *
import numpy as np
# See the function signature in fn/nbcnt.py for argument names.
```
