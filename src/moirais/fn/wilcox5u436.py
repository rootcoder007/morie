...
__all__ = ["wilcox_chapter_5_unnumbered_436"]


def wilcox_chapter_5_unnumbered_436(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: that 24 of the 47 values are below −0.29, so the proportion below −0.29 is 24 /47 = 0 .51.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u436')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u436: GeneralStatistics expression (auto-extracted; see ref)."
