# describe('eslrss2') — esl_total_sum_squares
...
`print(result)` render. See `moirais.fn.describe('eslrss2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslrss2 import *
import numpy as np
# See the function signature in fn/eslrss2.py for argument names.
```
