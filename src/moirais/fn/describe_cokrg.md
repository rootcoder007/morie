...
`print(result)` render. See `moirais.fn.describe('cokrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cokrg import *
import numpy as np
# See the function signature in fn/cokrg.py for argument names.
```
