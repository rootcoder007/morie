# describe('rng213') — rangayyan_ch4_peak_power_snr
...
`print(result)` render. See `moirais.fn.describe('rng213')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng213 import *
import numpy as np
# See the function signature in fn/rng213.py for argument names.
```
