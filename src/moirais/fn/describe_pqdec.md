# describe('pqdec') — polarquant_decode
...
`print(result)` render. See `moirais.fn.describe('pqdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pqdec import *
import numpy as np
# See the function signature in fn/pqdec.py for argument names.
```
