# describe('sntpr') — sentence_percentiles
...
`print(result)` render. See `moirais.fn.describe('sntpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntpr import *
import numpy as np
# See the function signature in fn/sntpr.py for argument names.
```
