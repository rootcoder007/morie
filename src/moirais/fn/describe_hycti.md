...
`print(result)` render. See `moirais.fn.describe('hycti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hycti import *
import numpy as np
# See the function signature in fn/hycti.py for argument names.
```
