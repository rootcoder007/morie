...
`print(result)` render. See `moirais.fn.describe('semsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semsig import *
import numpy as np
# See the function signature in fn/semsig.py for argument names.
```
