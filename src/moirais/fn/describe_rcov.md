...
`print(result)` render. See `moirais.fn.describe('rcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcov import *
import numpy as np
# See the function signature in fn/rcov.py for argument names.
```
