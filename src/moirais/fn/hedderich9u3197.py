...
__all__ = ["hedderich_chapter_9_unnumbered_3197"]


def hedderich_chapter_9_unnumbered_3197(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: βyx = 0 βyx̸= 0 ˆt =|byx|/sbyx≥tn−2;1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3197')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3197: GeneralStatistics expression (auto-extracted; see ref)."
