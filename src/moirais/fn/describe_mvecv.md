# describe('mvecv') — min_volume_ellipsoid
...
`print(result)` render. See `moirais.fn.describe('mvecv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvecv import *
import numpy as np
# See the function signature in fn/mvecv.py for argument names.
```
