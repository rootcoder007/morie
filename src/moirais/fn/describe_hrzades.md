# describe('hrzades') — horowitz_improved_ade
...
`print(result)` render. See `moirais.fn.describe('hrzades')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzades import *
import numpy as np
# See the function signature in fn/hrzades.py for argument names.
```
