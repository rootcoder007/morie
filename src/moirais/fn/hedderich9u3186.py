...
__all__ = ["hedderich_chapter_9_unnumbered_3186"]


def hedderich_chapter_9_unnumbered_3186(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: D W = 0 . 6 4 0 8 8 , p− value = 0.0001659
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3186')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3186: GeneralStatistics expression (auto-extracted; see ref)."
