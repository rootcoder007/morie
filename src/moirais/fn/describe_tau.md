...
`print(result)` render. See `moirais.fn.describe('tau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tau import *
import numpy as np
# See the function signature in fn/tau.py for argument names.
```
