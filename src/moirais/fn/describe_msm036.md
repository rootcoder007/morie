# describe('msm036') — mvsml_linear_mixed_models_eq_5_6
...
`print(result)` render. See `moirais.fn.describe('msm036')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm036 import *
import numpy as np
# See the function signature in fn/msm036.py for argument names.
```
