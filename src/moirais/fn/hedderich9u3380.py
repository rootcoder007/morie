...
__all__ = ["hedderich_chapter_9_unnumbered_3380"]


def hedderich_chapter_9_unnumbered_3380(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] logψ(a,b ) = g(x =b)−g(x =a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3380')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3380: GeneralStatistics expression (auto-extracted; see ref)."
