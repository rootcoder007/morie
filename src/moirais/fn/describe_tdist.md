...
`print(result)` render. See `moirais.fn.describe('tdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdist import *
import numpy as np
# See the function signature in fn/tdist.py for argument names.
```
