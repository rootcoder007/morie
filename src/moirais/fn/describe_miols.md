...
`print(result)` render. See `moirais.fn.describe('miols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miols import *
import numpy as np
# See the function signature in fn/miols.py for argument names.
```
