...
`print(result)` render. See `moirais.fn.describe('sobls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sobls import *
import numpy as np
# See the function signature in fn/sobls.py for argument names.
```
