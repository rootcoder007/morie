...
`print(result)` render. See `moirais.fn.describe('gccnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gccnv import *
import numpy as np
# See the function signature in fn/gccnv.py for argument names.
```
