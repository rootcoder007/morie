...
`print(result)` render. See `moirais.fn.describe('diffP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffP import *
import numpy as np
# See the function signature in fn/diffP.py for argument names.
```
