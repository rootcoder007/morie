# describe('grnag') — geron_nesterov_accelerated_gradient
...
`print(result)` render. See `moirais.fn.describe('grnag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnag import *
import numpy as np
# See the function signature in fn/grnag.py for argument names.
```
