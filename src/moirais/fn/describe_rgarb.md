# describe('rgarb') — rangayyan_ar_burg
...
`print(result)` render. See `moirais.fn.describe('rgarb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgarb import *
import numpy as np
# See the function signature in fn/rgarb.py for argument names.
```
