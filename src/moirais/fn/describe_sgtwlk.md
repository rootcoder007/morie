# describe('sgtwlk') — sgt_weisfeiler_leman_relabel
...
`print(result)` render. See `moirais.fn.describe('sgtwlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtwlk import *
import numpy as np
# See the function signature in fn/sgtwlk.py for argument names.
```
