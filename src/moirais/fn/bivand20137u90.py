...
__all__ = ["bivand2013_chapter_7_unnumbered_90"]


def bivand2013_chapter_7_unnumbered_90(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆK(s)=( n(n−1))−1|A|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u90')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u90: GeneralStatistics expression (auto-extracted; see ref)."
