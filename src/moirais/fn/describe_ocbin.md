# describe('ocbin') — oc_binary_choice
...
`print(result)` render. See `moirais.fn.describe('ocbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocbin import *
import numpy as np
# See the function signature in fn/ocbin.py for argument names.
```
