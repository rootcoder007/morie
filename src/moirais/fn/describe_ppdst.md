...
`print(result)` render. See `moirais.fn.describe('ppdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppdst import *
import numpy as np
# See the function signature in fn/ppdst.py for argument names.
```
