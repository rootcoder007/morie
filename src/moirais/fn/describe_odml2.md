...
`print(result)` render. See `moirais.fn.describe('odml2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml2 import *
import numpy as np
# See the function signature in fn/odml2.py for argument names.
```
