...
`print(result)` render. See `moirais.fn.describe('svgut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svgut import *
import numpy as np
# See the function signature in fn/svgut.py for argument names.
```
