...
__all__ = ["hedderich_chapter_9_unnumbered_3317"]


def hedderich_chapter_9_unnumbered_3317(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] αi =µi−γ (i = 1, 2, 3)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3317')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3317: GeneralStatistics expression (auto-extracted; see ref)."
