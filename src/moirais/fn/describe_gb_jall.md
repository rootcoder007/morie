# describe('gb_jall') — gibbons_joint_all_order
...
`print(result)` render. See `moirais.fn.describe('gb_jall')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_jall import *
import numpy as np
# See the function signature in fn/gb_jall.py for argument names.
```
