...
__all__ = ["hedderich_chapter_9_unnumbered_2081"]


def hedderich_chapter_9_unnumbered_2081(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: F− statistic : 3.350565 ( P− value = 0.04544368 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2081')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2081: GeneralStatistics expression (auto-extracted; see ref)."
