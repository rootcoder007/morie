# describe('convdv') — convex_divergence
...
`print(result)` render. See `moirais.fn.describe('convdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.convdv import *
import numpy as np
# See the function signature in fn/convdv.py for argument names.
```
