# describe('sscompv') — survival_competing_validation
...
`print(result)` render. See `moirais.fn.describe('sscompv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sscompv import *
import numpy as np
# See the function signature in fn/sscompv.py for argument names.
```
