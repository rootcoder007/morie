# describe('msm305') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm305')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm305 import *
import numpy as np
# See the function signature in fn/msm305.py for argument names.
```
