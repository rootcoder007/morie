...
`print(result)` render. See `moirais.fn.describe('stknbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stknbr import *
import numpy as np
# See the function signature in fn/stknbr.py for argument names.
```
