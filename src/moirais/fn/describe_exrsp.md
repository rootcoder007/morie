# describe('exrsp') — exposure_response
...
`print(result)` render. See `moirais.fn.describe('exrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.exrsp import *
import numpy as np
# See the function signature in fn/exrsp.py for argument names.
```
