...
`print(result)` render. See `moirais.fn.describe('josmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.josmap import *
import numpy as np
# See the function signature in fn/josmap.py for argument names.
```
