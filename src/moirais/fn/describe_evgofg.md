# describe('evgofg') — evt_gpd_anderson_darling
...
`print(result)` render. See `moirais.fn.describe('evgofg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgofg import *
import numpy as np
# See the function signature in fn/evgofg.py for argument names.
```
