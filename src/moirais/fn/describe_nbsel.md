...
`print(result)` render. See `moirais.fn.describe('nbsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbsel import *
import numpy as np
# See the function signature in fn/nbsel.py for argument names.
```
