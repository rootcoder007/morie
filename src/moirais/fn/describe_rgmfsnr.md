# describe('rgmfsnr') — rangayyan_matched_filter_snr
...
`print(result)` render. See `moirais.fn.describe('rgmfsnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmfsnr import *
import numpy as np
# See the function signature in fn/rgmfsnr.py for argument names.
```
