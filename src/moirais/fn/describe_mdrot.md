...
`print(result)` render. See `moirais.fn.describe('mdrot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdrot import *
import numpy as np
# See the function signature in fn/mdrot.py for argument names.
```
