# describe('bktf') — burkov_term_frequency
...
`print(result)` render. See `moirais.fn.describe('bktf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bktf import *
import numpy as np
# See the function signature in fn/bktf.py for argument names.
```
