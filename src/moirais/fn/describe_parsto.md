# describe('parsto') — parallel_trends_test
...
`print(result)` render. See `moirais.fn.describe('parsto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.parsto import *
import numpy as np
# See the function signature in fn/parsto.py for argument names.
```
