...
`print(result)` render. See `moirais.fn.describe('wqcod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqcod import *
import numpy as np
# See the function signature in fn/wqcod.py for argument names.
```
