# describe('hmneq') — geron_normal_equation
...
`print(result)` render. See `moirais.fn.describe('hmneq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmneq import *
import numpy as np
# See the function signature in fn/hmneq.py for argument names.
```
