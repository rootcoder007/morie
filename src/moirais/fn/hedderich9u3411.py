...
__all__ = ["hedderich_chapter_9_unnumbered_3411"]


def hedderich_chapter_9_unnumbered_3411(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (yi−λi)xi = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3411')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3411: GeneralStatistics expression (auto-extracted; see ref)."
