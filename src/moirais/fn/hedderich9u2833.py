...
__all__ = ["hedderich_chapter_9_unnumbered_2833"]


def hedderich_chapter_9_unnumbered_2833(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + OR = mantelhaen . test ( x ) $ estimate ; names (OR) = " " }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2833')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2833: GeneralStatistics expression (auto-extracted; see ref)."
