# describe('survcox') — cox_partial_likelihood
...
`print(result)` render. See `moirais.fn.describe('survcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survcox import *
import numpy as np
# See the function signature in fn/survcox.py for argument names.
```
