# describe('rglr') — rangayyan_logistic_regression
...
`print(result)` render. See `moirais.fn.describe('rglr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglr import *
import numpy as np
# See the function signature in fn/rglr.py for argument names.
```
