# describe('armcv') — ar_modified_cov_fn
...
`print(result)` render. See `moirais.fn.describe('armcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.armcv import *
import numpy as np
# See the function signature in fn/armcv.py for argument names.
```
