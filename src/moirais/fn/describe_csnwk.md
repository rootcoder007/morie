...
`print(result)` render. See `moirais.fn.describe('csnwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csnwk import *
import numpy as np
# See the function signature in fn/csnwk.py for argument names.
```
