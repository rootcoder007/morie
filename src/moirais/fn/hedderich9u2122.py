...
__all__ = ["hedderich_chapter_9_unnumbered_2122"]


def hedderich_chapter_9_unnumbered_2122(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Control:U1 +U2 = 64 = 8 ·8 = mn, sinceU1 = 11 < 53 = U2,U1 is the test statistic. Since
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2122')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2122: GeneralStatistics expression (auto-extracted; see ref)."
