...
`print(result)` render. See `moirais.fn.describe('afslk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslk import *
import numpy as np
# See the function signature in fn/afslk.py for argument names.
```
