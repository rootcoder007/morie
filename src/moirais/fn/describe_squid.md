...
`print(result)` render. See `moirais.fn.describe('squid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.squid import *
import numpy as np
# See the function signature in fn/squid.py for argument names.
```
