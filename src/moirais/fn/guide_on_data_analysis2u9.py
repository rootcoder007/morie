...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_9"]


def guide_on_data_analysis_chapter_2_unnumbered_9(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2. For a non-zero scalar 𝑏, (bA)−1 = b−1A−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u9')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u9: GeneralStatistics expression (auto-extracted; see ref)."
