# describe('ipsiMed') — interventional_psi
...
`print(result)` render. See `moirais.fn.describe('ipsiMed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipsiMed import *
import numpy as np
# See the function signature in fn/ipsiMed.py for argument names.
```
