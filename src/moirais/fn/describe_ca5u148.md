# describe('ca5u148') — ca_chapter_5_unnumbered_148
...
− ln PY = Trial Conviction()() − ln PY = Dismissal()()[]
...
```python
from moirais.fn.ca5u148 import ca_chapter_5_unnumbered_148
import numpy as np
result = ca_chapter_5_unnumbered_148(np.random.default_rng(42).normal(0, 1, 100))
