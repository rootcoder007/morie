...
`print(result)` render. See `moirais.fn.describe('amres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amres import *
import numpy as np
# See the function signature in fn/amres.py for argument names.
```
