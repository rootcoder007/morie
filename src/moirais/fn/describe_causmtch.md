# describe('causmtch') — causal_pair_matching
...
`print(result)` render. See `moirais.fn.describe('causmtch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmtch import *
import numpy as np
# See the function signature in fn/causmtch.py for argument names.
```
