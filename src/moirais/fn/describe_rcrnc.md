...
`print(result)` render. See `moirais.fn.describe('rcrnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcrnc import *
import numpy as np
# See the function signature in fn/rcrnc.py for argument names.
```
