# describe('grstra') — geron_stratified_split
...
`print(result)` render. See `moirais.fn.describe('grstra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grstra import *
import numpy as np
# See the function signature in fn/grstra.py for argument names.
```
