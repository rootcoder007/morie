# describe('claim') — claim_frequency
...
`print(result)` render. See `moirais.fn.describe('claim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.claim import *
import numpy as np
# See the function signature in fn/claim.py for argument names.
```
