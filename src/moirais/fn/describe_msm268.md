# describe('msm268') — mvsml_convolutional_nn_eq_14_5
...
`print(result)` render. See `moirais.fn.describe('msm268')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm268 import *
import numpy as np
# See the function signature in fn/msm268.py for argument names.
```
