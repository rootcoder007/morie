...
`print(result)` render. See `moirais.fn.describe('abpfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpfc import *
import numpy as np
# See the function signature in fn/abpfc.py for argument names.
```
