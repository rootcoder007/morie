# describe('hydis') — hydis

## WHAT IT DOES

Discharge estimation spatial
...
`print(result)` render. See `moirais.fn.describe('hydis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydis import *
import numpy as np
# See the function signature in fn/hydis.py for argument names.
```
