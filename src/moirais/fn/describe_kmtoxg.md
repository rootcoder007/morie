# describe('kmtoxg') — kamath_toxigen_score
...
`print(result)` render. See `moirais.fn.describe('kmtoxg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmtoxg import *
import numpy as np
# See the function signature in fn/kmtoxg.py for argument names.
```
