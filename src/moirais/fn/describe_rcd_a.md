# describe('rcd_a') — recidivism_by_age
...
`print(result)` render. See `moirais.fn.describe('rcd_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcd_a import *
import numpy as np
# See the function signature in fn/rcd_a.py for argument names.
```
