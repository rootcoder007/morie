# describe('teulr') — torus_euler_char
...
`print(result)` render. See `moirais.fn.describe('teulr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.teulr import *
import numpy as np
# See the function signature in fn/teulr.py for argument names.
```
