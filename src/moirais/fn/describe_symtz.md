# describe('symtz') — symmetrization_bound
...
`print(result)` render. See `moirais.fn.describe('symtz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.symtz import *
import numpy as np
# See the function signature in fn/symtz.py for argument names.
```
