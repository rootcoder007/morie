...
`print(result)` render. See `moirais.fn.describe('mldss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mldss import *
import numpy as np
# See the function signature in fn/mldss.py for argument names.
```
