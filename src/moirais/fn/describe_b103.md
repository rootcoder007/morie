# describe('b103') — burkov_lm_ch1_mse_cost
...
`print(result)` render. See `moirais.fn.describe('b103')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b103 import *
import numpy as np
# See the function signature in fn/b103.py for argument names.
```
