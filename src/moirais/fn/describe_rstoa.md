...
`print(result)` render. See `moirais.fn.describe('rstoa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rstoa import *
import numpy as np
# See the function signature in fn/rstoa.py for argument names.
```
