# describe('plctst') — placebo_test_did
...
`print(result)` render. See `moirais.fn.describe('plctst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plctst import *
import numpy as np
# See the function signature in fn/plctst.py for argument names.
```
