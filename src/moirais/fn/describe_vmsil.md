...
`print(result)` render. See `moirais.fn.describe('vmsil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmsil import *
import numpy as np
# See the function signature in fn/vmsil.py for argument names.
```
