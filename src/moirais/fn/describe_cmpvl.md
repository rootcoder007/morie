# describe('cmpvl') — compliance_violation
...
`print(result)` render. See `moirais.fn.describe('cmpvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpvl import *
import numpy as np
# See the function signature in fn/cmpvl.py for argument names.
```
