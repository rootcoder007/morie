# describe('km077') — kamath_ch6_factscore
...
`print(result)` render. See `moirais.fn.describe('km077')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km077 import *
import numpy as np
# See the function signature in fn/km077.py for argument names.
```
