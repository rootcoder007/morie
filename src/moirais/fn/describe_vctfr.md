...
`print(result)` render. See `moirais.fn.describe('vctfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vctfr import *
import numpy as np
# See the function signature in fn/vctfr.py for argument names.
```
