# describe('km035') — kamath_ch2_gpt_supervised_softmax
...
`print(result)` render. See `moirais.fn.describe('km035')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km035 import *
import numpy as np
# See the function signature in fn/km035.py for argument names.
```
