...
`print(result)` render. See `moirais.fn.describe('gcams')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcams import *
import numpy as np
# See the function signature in fn/gcams.py for argument names.
```
