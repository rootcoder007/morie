# describe('wsmwlx') — wasserman_wilcoxon
...
`print(result)` render. See `moirais.fn.describe('wsmwlx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmwlx import *
import numpy as np
# See the function signature in fn/wsmwlx.py for argument names.
```
