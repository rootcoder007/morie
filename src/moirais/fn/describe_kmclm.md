# describe('kmclm') — kamath_causal_lm_loss
...
`print(result)` render. See `moirais.fn.describe('kmclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmclm import *
import numpy as np
# See the function signature in fn/kmclm.py for argument names.
```
