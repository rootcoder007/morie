...
__all__ = ["hedderich_chapter_9_unnumbered_2814"]


def hedderich_chapter_9_unnumbered_2814(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1;1−α/2 = 3.841. A continuity correction can be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2814')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2814: GeneralStatistics expression (auto-extracted; see ref)."
