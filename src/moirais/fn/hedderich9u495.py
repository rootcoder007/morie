...
__all__ = ["hedderich_chapter_9_unnumbered_495"]


def hedderich_chapter_9_unnumbered_495(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b)P (K|T +)= P (K)·P (T +|K)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u495')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u495: GeneralStatistics expression (auto-extracted; see ref)."
