# describe('optsa') — simulated_anneal_mds
...
`print(result)` render. See `moirais.fn.describe('optsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optsa import *
import numpy as np
# See the function signature in fn/optsa.py for argument names.
```
