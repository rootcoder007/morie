# describe('emaxr') — em_step_random_effects
...
`print(result)` render. See `moirais.fn.describe('emaxr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emaxr import *
import numpy as np
# See the function signature in fn/emaxr.py for argument names.
```
