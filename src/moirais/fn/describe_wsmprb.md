# describe('wsmprb') — wasserman_parametric_boot
...
`print(result)` render. See `moirais.fn.describe('wsmprb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmprb import *
import numpy as np
# See the function signature in fn/wsmprb.py for argument names.
```
