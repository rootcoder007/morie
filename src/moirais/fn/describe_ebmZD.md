...
`print(result)` render. See `moirais.fn.describe('ebmZD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebmZD import *
import numpy as np
# See the function signature in fn/ebmZD.py for argument names.
```
