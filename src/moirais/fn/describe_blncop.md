# describe('blncop') — blomqvists_beta_copula
...
`print(result)` render. See `moirais.fn.describe('blncop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blncop import *
import numpy as np
# See the function signature in fn/blncop.py for argument names.
```
