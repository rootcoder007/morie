...
`print(result)` render. See `moirais.fn.describe('sawpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawpl import *
import numpy as np
# See the function signature in fn/sawpl.py for argument names.
```
