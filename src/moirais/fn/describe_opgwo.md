...
`print(result)` render. See `moirais.fn.describe('opgwo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opgwo import *
import numpy as np
# See the function signature in fn/opgwo.py for argument names.
```
