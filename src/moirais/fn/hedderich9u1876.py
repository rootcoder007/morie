...
__all__ = ["hedderich_chapter_9_unnumbered_1876"]


def hedderich_chapter_9_unnumbered_1876(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = |n(ˆr−1)−2n1n2|√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1876')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1876: GeneralStatistics expression (auto-extracted; see ref)."
