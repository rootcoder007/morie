...
`print(result)` render. See `moirais.fn.describe('maradr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maradr import *
import numpy as np
# See the function signature in fn/maradr.py for argument names.
```
