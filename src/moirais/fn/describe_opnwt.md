...
`print(result)` render. See `moirais.fn.describe('opnwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opnwt import *
import numpy as np
# See the function signature in fn/opnwt.py for argument names.
```
