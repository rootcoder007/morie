...
`print(result)` render. See `moirais.fn.describe('agiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agiso import *
import numpy as np
# See the function signature in fn/agiso.py for argument names.
```
