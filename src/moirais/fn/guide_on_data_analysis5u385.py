...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_385"]


def guide_on_data_analysis_chapter_5_unnumbered_385(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Influential_Observations = influential_obs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u385')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u385: GeneralStatistics expression (auto-extracted; see ref)."
