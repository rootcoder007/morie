...
`print(result)` render. See `moirais.fn.describe('tmsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmsen import *
import numpy as np
# See the function signature in fn/tmsen.py for argument names.
```
