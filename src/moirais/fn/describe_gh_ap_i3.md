# describe('gh_ap_i3') — ghosal_borell_tis
...
`print(result)` render. See `moirais.fn.describe('gh_ap_i3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_i3 import *
import numpy as np
# See the function signature in fn/gh_ap_i3.py for argument names.
```
