# describe('shkwv') — wave_equation_1d
...
`print(result)` render. See `moirais.fn.describe('shkwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shkwv import *
import numpy as np
# See the function signature in fn/shkwv.py for argument names.
```
