...
`print(result)` render. See `moirais.fn.describe('mdwsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdwsl import *
import numpy as np
# See the function signature in fn/mdwsl.py for argument names.
```
