...
`print(result)` render. See `moirais.fn.describe('hmmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmds import *
import numpy as np
# See the function signature in fn/hmmds.py for argument names.
```
