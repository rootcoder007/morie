...
__all__ = ["hedderich_chapter_9_unnumbered_739"]


def hedderich_chapter_9_unnumbered_739(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] witht = (k−λ+ 1/6)2/λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u739')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u739: GeneralStatistics expression (auto-extracted; see ref)."
