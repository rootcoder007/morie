# describe('tfinq') — time_freq_uncertainty
...
`print(result)` render. See `moirais.fn.describe('tfinq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tfinq import *
import numpy as np
# See the function signature in fn/tfinq.py for argument names.
```
