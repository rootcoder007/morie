# describe('fanocb') — fano_inequality
...
`print(result)` render. See `moirais.fn.describe('fanocb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fanocb import *
import numpy as np
# See the function signature in fn/fanocb.py for argument names.
```
