...
__all__ = ["wilcox_chapter_13_unnumbered_1231"]


def wilcox_chapter_13_unnumbered_1231(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outfun=out, nboot=100, SEED=TRUE, xlab="X", ylab="Y",...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1231')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1231: GeneralStatistics expression (auto-extracted; see ref)."
