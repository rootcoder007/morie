...
`print(result)` render. See `moirais.fn.describe('biccg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.biccg import *
import numpy as np
# See the function signature in fn/biccg.py for argument names.
```
