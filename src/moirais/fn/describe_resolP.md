# describe('resolP') — resolution_proof
...
`print(result)` render. See `moirais.fn.describe('resolP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.resolP import *
import numpy as np
# See the function signature in fn/resolP.py for argument names.
```
