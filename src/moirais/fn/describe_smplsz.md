# describe('smplsz') — sample_size_calc
...
`print(result)` render. See `moirais.fn.describe('smplsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smplsz import *
import numpy as np
# See the function signature in fn/smplsz.py for argument names.
```
