# describe('siubc') — siu_scrape_report

## WHAT IT DOES

SIU Ontario report HTML parser. 'Time discovers truth. — Seneca'
...
`print(result)` render. See `moirais.fn.describe('siubc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siubc import *
import numpy as np
# See the function signature in fn/siubc.py for argument names.
```
