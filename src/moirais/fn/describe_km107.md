# describe('km107') — kamath_ch6_pii_likelihood
...
`print(result)` render. See `moirais.fn.describe('km107')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km107 import *
import numpy as np
# See the function signature in fn/km107.py for argument names.
```
