...
__all__ = ["wilcox_chapter_13_unnumbered_1104"]


def wilcox_chapter_13_unnumbered_1104(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: grp = c(1:ncol(x)), nullvec = c(rep(0, length(grp))), xout = FALSE, outfun =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1104')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1104: GeneralStatistics expression (auto-extracted; see ref)."
