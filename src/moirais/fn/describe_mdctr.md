...
`print(result)` render. See `moirais.fn.describe('mdctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdctr import *
import numpy as np
# See the function signature in fn/mdctr.py for argument names.
```
