...
`print(result)` render. See `moirais.fn.describe('mvtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtst import *
import numpy as np
# See the function signature in fn/mvtst.py for argument names.
```
