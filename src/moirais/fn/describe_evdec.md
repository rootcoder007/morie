# describe('evdec') — evt_declustering_runs
...
`print(result)` render. See `moirais.fn.describe('evdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evdec import *
import numpy as np
# See the function signature in fn/evdec.py for argument names.
```
