# describe('neymal') — neyman_allocation
...
`print(result)` render. See `moirais.fn.describe('neymal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neymal import *
import numpy as np
# See the function signature in fn/neymal.py for argument names.
```
