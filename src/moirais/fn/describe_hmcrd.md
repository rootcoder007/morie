# describe('hmcrd') — geron_credit_assignment
...
`print(result)` render. See `moirais.fn.describe('hmcrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcrd import *
import numpy as np
# See the function signature in fn/hmcrd.py for argument names.
```
