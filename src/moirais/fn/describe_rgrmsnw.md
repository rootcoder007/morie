# describe('rgrmsnw') — rangayyan_rms_noise
...
`print(result)` render. See `moirais.fn.describe('rgrmsnw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrmsnw import *
import numpy as np
# See the function signature in fn/rgrmsnw.py for argument names.
```
