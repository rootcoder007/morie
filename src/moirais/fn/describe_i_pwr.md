# describe('i_pwr') — calculate_interaction_power
...
`print(result)` render. See `moirais.fn.describe('i_pwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.i_pwr import *
import numpy as np
# See the function signature in fn/i_pwr.py for argument names.
```
