# describe('kmpref') — kamath_prefix_tuning
...
`print(result)` render. See `moirais.fn.describe('kmpref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpref import *
import numpy as np
# See the function signature in fn/kmpref.py for argument names.
```
