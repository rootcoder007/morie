...
`print(result)` render. See `moirais.fn.describe('ppgey')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppgey import *
import numpy as np
# See the function signature in fn/ppgey.py for argument names.
```
