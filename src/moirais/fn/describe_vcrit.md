# describe('vcrit') — validity_criterion
...
`print(result)` render. See `moirais.fn.describe('vcrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcrit import *
import numpy as np
# See the function signature in fn/vcrit.py for argument names.
```
