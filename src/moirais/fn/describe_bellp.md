# describe('bellp') — bell_polynomial
...
`print(result)` render. See `moirais.fn.describe('bellp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bellp import *
import numpy as np
# See the function signature in fn/bellp.py for argument names.
```
