# describe('msm182') — mvsml_ridge_lasso_elastic_eq_9_7
...
`print(result)` render. See `moirais.fn.describe('msm182')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm182 import *
import numpy as np
# See the function signature in fn/msm182.py for argument names.
```
