# describe('pcgmur') — pcg_murmur_score
...
`print(result)` render. See `moirais.fn.describe('pcgmur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcgmur import *
import numpy as np
# See the function signature in fn/pcgmur.py for argument names.
```
