...
`print(result)` render. See `moirais.fn.describe('sdemjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemjac import *
import numpy as np
# See the function signature in fn/sdemjac.py for argument names.
```
