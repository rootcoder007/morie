...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_92(x):
    """
    Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner.

    Formula: every step here as we did in Eq. (4.92). The k = 0 and k − 1 terms don’t contribute
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner4e92')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e92: Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
