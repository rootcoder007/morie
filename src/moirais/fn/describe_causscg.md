# describe('causscg') — causal_generalised_sc
...
`print(result)` render. See `moirais.fn.describe('causscg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causscg import *
import numpy as np
# See the function signature in fn/causscg.py for argument names.
```
