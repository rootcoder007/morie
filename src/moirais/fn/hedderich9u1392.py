...
__all__ = ["hedderich_chapter_9_unnumbered_1392"]


def hedderich_chapter_9_unnumbered_1392(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y =−β·log(α) +β·x (6.125)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1392')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1392: GeneralStatistics expression (auto-extracted; see ref)."
