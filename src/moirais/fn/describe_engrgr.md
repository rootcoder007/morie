...
`print(result)` render. See `moirais.fn.describe('engrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.engrgr import *
import numpy as np
# See the function signature in fn/engrgr.py for argument names.
```
