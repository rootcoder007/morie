...
__all__ = ["hedderich_chapter_9_unnumbered_2003"]


def hedderich_chapter_9_unnumbered_2003(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: W = 6 0 . 5 , p− value = 0.002518
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2003')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2003: GeneralStatistics expression (auto-extracted; see ref)."
