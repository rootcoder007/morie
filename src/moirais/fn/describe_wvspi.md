...
`print(result)` render. See `moirais.fn.describe('wvspi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvspi import *
import numpy as np
# See the function signature in fn/wvspi.py for argument names.
```
