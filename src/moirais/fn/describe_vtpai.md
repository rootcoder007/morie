...
`print(result)` render. See `moirais.fn.describe('vtpai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtpai import *
import numpy as np
# See the function signature in fn/vtpai.py for argument names.
```
