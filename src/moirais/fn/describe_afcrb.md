...
`print(result)` render. See `moirais.fn.describe('afcrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afcrb import *
import numpy as np
# See the function signature in fn/afcrb.py for argument names.
```
