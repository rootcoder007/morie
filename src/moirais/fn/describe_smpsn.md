# describe('smpsn') — simpson_integrate
...
`print(result)` render. See `moirais.fn.describe('smpsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpsn import *
import numpy as np
# See the function signature in fn/smpsn.py for argument names.
```
