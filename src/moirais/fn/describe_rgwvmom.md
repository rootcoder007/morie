# describe('rgwvmom') — rangayyan_wavelet_moments
...
`print(result)` render. See `moirais.fn.describe('rgwvmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvmom import *
import numpy as np
# See the function signature in fn/rgwvmom.py for argument names.
```
