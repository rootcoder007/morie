...
__all__ = ["wilcox_chapter_2_unnumbered_260"]


def wilcox_chapter_2_unnumbered_260(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: α = 0.05, α = 0.01, and even α = 0.003.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u260')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u260: GeneralStatistics expression (auto-extracted; see ref)."
