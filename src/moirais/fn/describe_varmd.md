...
`print(result)` render. See `moirais.fn.describe('varmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varmd import *
import numpy as np
# See the function signature in fn/varmd.py for argument names.
```
