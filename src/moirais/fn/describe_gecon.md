...
`print(result)` render. See `moirais.fn.describe('gecon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gecon import *
import numpy as np
# See the function signature in fn/gecon.py for argument names.
```
