# describe('gb1141') — gibbons_tau_rho_relation
...
`print(result)` render. See `moirais.fn.describe('gb1141')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1141 import *
import numpy as np
# See the function signature in fn/gb1141.py for argument names.
```
