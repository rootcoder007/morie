...
`print(result)` render. See `moirais.fn.describe('aipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aipw import *
import numpy as np
# See the function signature in fn/aipw.py for argument names.
```
