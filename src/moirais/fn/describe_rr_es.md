...
`print(result)` render. See `moirais.fn.describe('rr_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rr_es import *
import numpy as np
# See the function signature in fn/rr_es.py for argument names.
```
