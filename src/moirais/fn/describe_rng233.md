# describe('rng233') — rangayyan_ch4_convolution_model
...
`print(result)` render. See `moirais.fn.describe('rng233')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng233 import *
import numpy as np
# See the function signature in fn/rng233.py for argument names.
```
