...
`print(result)` render. See `moirais.fn.describe('primal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.primal import *
import numpy as np
# See the function signature in fn/primal.py for argument names.
```
