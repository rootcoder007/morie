...
__all__ = ["hedderich_chapter_9_unnumbered_923"]


def hedderich_chapter_9_unnumbered_923(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] i f ( d i r== "max" ) return ( exp ( −exp ( −( z ) ) ) ) # maximum
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u923')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u923: GeneralStatistics expression (auto-extracted; see ref)."
