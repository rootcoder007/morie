# describe('agmupv') — muzero_predict_value
...
`print(result)` render. See `moirais.fn.describe('agmupv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmupv import *
import numpy as np
# See the function signature in fn/agmupv.py for argument names.
```
