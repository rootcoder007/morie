# describe('wsmcdf') — wasserman_empirical_cdf
...
`print(result)` render. See `moirais.fn.describe('wsmcdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcdf import *
import numpy as np
# See the function signature in fn/wsmcdf.py for argument names.
```
