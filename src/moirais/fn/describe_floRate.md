# describe('floRate') — flow_duration
...
`print(result)` render. See `moirais.fn.describe('floRate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.floRate import *
import numpy as np
# See the function signature in fn/floRate.py for argument names.
```
