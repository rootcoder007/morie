...
`print(result)` render. See `moirais.fn.describe('limT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.limT import *
import numpy as np
# See the function signature in fn/limT.py for argument names.
```
