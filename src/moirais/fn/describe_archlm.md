...
`print(result)` render. See `moirais.fn.describe('archlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.archlm import *
import numpy as np
# See the function signature in fn/archlm.py for argument names.
```
