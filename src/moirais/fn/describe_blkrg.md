...
`print(result)` render. See `moirais.fn.describe('blkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blkrg import *
import numpy as np
# See the function signature in fn/blkrg.py for argument names.
```
