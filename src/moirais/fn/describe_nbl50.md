...
`print(result)` render. See `moirais.fn.describe('nbl50')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbl50 import *
import numpy as np
# See the function signature in fn/nbl50.py for argument names.
```
