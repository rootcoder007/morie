...
__all__ = ["hedderich_chapter_9_unnumbered_2908"]


def hedderich_chapter_9_unnumbered_2908(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( any ( dim ( t a b ) = = 2 ) ) {i f ( transpose ==TRUE) { t a b <− t ( t a b ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2908')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2908: GeneralStatistics expression (auto-extracted; see ref)."
