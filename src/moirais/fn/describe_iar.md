# describe('iar') — indirect_age_adjustment
...
`print(result)` render. See `moirais.fn.describe('iar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iar import *
import numpy as np
# See the function signature in fn/iar.py for argument names.
```
