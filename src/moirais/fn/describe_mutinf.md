# describe('mutinf') — mutual_information
...
`print(result)` render. See `moirais.fn.describe('mutinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mutinf import *
import numpy as np
# See the function signature in fn/mutinf.py for argument names.
```
