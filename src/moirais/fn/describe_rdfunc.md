# describe('rdfunc') — rate_distortion
...
`print(result)` render. See `moirais.fn.describe('rdfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdfunc import *
import numpy as np
# See the function signature in fn/rdfunc.py for argument names.
```
