# describe('fzcov1') — fauzi_cov_surv_est1
...
`print(result)` render. See `moirais.fn.describe('fzcov1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzcov1 import *
import numpy as np
# See the function signature in fn/fzcov1.py for argument names.
```
