...
__all__ = ["hedderich_chapter_9_unnumbered_2593"]


def hedderich_chapter_9_unnumbered_2593(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆz =|arcsin√ˆp1−arcsin√ˆp2|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2593')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2593: GeneralStatistics expression (auto-extracted; see ref)."
