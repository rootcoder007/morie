# describe('spiso') — schabenberger_isotropy_condition
...
`print(result)` render. See `moirais.fn.describe('spiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spiso import *
import numpy as np
# See the function signature in fn/spiso.py for argument names.
```
