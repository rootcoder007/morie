# describe('kmcrag') — kamath_corrective_rag
...
`print(result)` render. See `moirais.fn.describe('kmcrag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcrag import *
import numpy as np
# See the function signature in fn/kmcrag.py for argument names.
```
