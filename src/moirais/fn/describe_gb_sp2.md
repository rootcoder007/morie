# describe('gb_sp2') — gibbons_spearman_exact
...
`print(result)` render. See `moirais.fn.describe('gb_sp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_sp2 import *
import numpy as np
# See the function signature in fn/gb_sp2.py for argument names.
```
