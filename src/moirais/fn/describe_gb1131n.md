# describe('gb1131n') — gibbons_spearman_asymp
...
`print(result)` render. See `moirais.fn.describe('gb1131n')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1131n import *
import numpy as np
# See the function signature in fn/gb1131n.py for argument names.
```
