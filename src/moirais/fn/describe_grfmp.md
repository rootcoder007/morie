# describe('grfmp') — geron_feature_map_dim
...
`print(result)` render. See `moirais.fn.describe('grfmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grfmp import *
import numpy as np
# See the function signature in fn/grfmp.py for argument names.
```
