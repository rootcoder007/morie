...
__all__ = ["wilcox_chapter_14_unnumbered_663"]


def wilcox_chapter_14_unnumbered_663(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: B = 7 + 9 + · · · + 14 = 290,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u663')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u663: GeneralStatistics expression (auto-extracted; see ref)."
