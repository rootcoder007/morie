...
`print(result)` render. See `moirais.fn.describe('sqsgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqsgm import *
import numpy as np
# See the function signature in fn/sqsgm.py for argument names.
```
