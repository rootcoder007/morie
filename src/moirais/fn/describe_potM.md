# describe('potM') — peaks_over_threshold
...
`print(result)` render. See `moirais.fn.describe('potM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.potM import *
import numpy as np
# See the function signature in fn/potM.py for argument names.
```
