# describe('irtras') — rating_scale_model
...
`print(result)` render. See `moirais.fn.describe('irtras')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtras import *
import numpy as np
# See the function signature in fn/irtras.py for argument names.
```
