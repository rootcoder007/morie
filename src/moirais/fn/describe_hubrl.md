...
`print(result)` render. See `moirais.fn.describe('hubrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubrl import *
import numpy as np
# See the function signature in fn/hubrl.py for argument names.
```
