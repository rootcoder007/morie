...
__all__ = ["hedderich_chapter_9_unnumbered_1043"]


def hedderich_chapter_9_unnumbered_1043(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (x,y ) = (P (X =x,Y =y) = P1(x)·P2(y) for all x,y (5.192)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1043')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1043: GeneralStatistics expression (auto-extracted; see ref)."
