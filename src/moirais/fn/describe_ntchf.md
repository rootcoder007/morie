...
`print(result)` render. See `moirais.fn.describe('ntchf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ntchf import *
import numpy as np
# See the function signature in fn/ntchf.py for argument names.
```
