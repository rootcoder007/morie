...
__all__ = ["bivand2013_chapter_2_unnumbered_26"]


def bivand2013_chapter_2_unnumbered_26(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +towgs84=-87,-98,-121,0,0,0,0 +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u26')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u26: GeneralStatistics expression (auto-extracted; see ref)."
