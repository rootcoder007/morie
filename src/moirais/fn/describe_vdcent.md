...
`print(result)` render. See `moirais.fn.describe('vdcent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdcent import *
import numpy as np
# See the function signature in fn/vdcent.py for argument names.
```
