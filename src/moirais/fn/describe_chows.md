...
`print(result)` render. See `moirais.fn.describe('chows')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chows import *
import numpy as np
# See the function signature in fn/chows.py for argument names.
```
