# describe('spmani') — schabenberger_mantel_standard
...
`print(result)` render. See `moirais.fn.describe('spmani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmani import *
import numpy as np
# See the function signature in fn/spmani.py for argument names.
```
