...
`print(result)` render. See `moirais.fn.describe('hmdetr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdetr import *
import numpy as np
# See the function signature in fn/hmdetr.py for argument names.
```
