...
`print(result)` render. See `moirais.fn.describe('ssfbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssfbk import *
import numpy as np
# See the function signature in fn/ssfbk.py for argument names.
```
