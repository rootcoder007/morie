...
`print(result)` render. See `moirais.fn.describe('wqwtp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqwtp import *
import numpy as np
# See the function signature in fn/wqwtp.py for argument names.
```
