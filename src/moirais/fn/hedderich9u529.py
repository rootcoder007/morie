...
__all__ = ["hedderich_chapter_9_unnumbered_529"]


def hedderich_chapter_9_unnumbered_529(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X >1) = 1−P (X≤1) = 1−1/6 = 5/6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u529')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u529: GeneralStatistics expression (auto-extracted; see ref)."
