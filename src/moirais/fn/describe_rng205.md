# describe('rng205') — rangayyan_ch4_csd_from_ccf
...
`print(result)` render. See `moirais.fn.describe('rng205')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng205 import *
import numpy as np
# See the function signature in fn/rng205.py for argument names.
```
