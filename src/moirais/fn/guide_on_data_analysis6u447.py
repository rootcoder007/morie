...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_447"]


def guide_on_data_analysis_chapter_6_unnumbered_447(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 𝜖0 − 𝑓0(𝜃)′[ ̂𝜃 − 𝜃]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u447')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u447: GeneralStatistics expression (auto-extracted; see ref)."
