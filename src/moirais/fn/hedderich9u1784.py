...
__all__ = ["hedderich_chapter_9_unnumbered_1784"]


def hedderich_chapter_9_unnumbered_1784(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1784')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1784: GeneralStatistics expression (auto-extracted; see ref)."
