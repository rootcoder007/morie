# describe('rng176') — rangayyan_ch4_qrs_first_derivative_balda
...
`print(result)` render. See `moirais.fn.describe('rng176')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng176 import *
import numpy as np
# See the function signature in fn/rng176.py for argument names.
```
