...
__all__ = ["hedderich_chapter_9_unnumbered_366"]


def hedderich_chapter_9_unnumbered_366(x):
    """
    Nonparametric expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfcol = c ( 1 , 3 ) , lwd =2 , font . a x i s=2 , b t y =" l " , ps =18)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u366')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u366: Nonparametric expression (auto-extracted; see ref)."
