# describe('grdds') — gradient_descent_vanilla
...
`print(result)` render. See `moirais.fn.describe('grdds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdds import *
import numpy as np
# See the function signature in fn/grdds.py for argument names.
```
