# describe('mmeeq') — henderson_mme_eq2_2
...
`print(result)` render. See `moirais.fn.describe('mmeeq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmeeq import *
import numpy as np
# See the function signature in fn/mmeeq.py for argument names.
```
