# describe('oeffn') — otis_effect_summary
...
`print(result)` render. See `moirais.fn.describe('oeffn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oeffn import *
import numpy as np
# See the function signature in fn/oeffn.py for argument names.
```
