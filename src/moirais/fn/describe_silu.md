...
`print(result)` render. See `moirais.fn.describe('silu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.silu import *
import numpy as np
# See the function signature in fn/silu.py for argument names.
```
