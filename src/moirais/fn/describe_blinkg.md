...
`print(result)` render. See `moirais.fn.describe('blinkg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blinkg import *
import numpy as np
# See the function signature in fn/blinkg.py for argument names.
```
