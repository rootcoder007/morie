# describe('svht3') — hotelling_3cand
...
`print(result)` render. See `moirais.fn.describe('svht3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svht3 import *
import numpy as np
# See the function signature in fn/svht3.py for argument names.
```
