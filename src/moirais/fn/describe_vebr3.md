...
`print(result)` render. See `moirais.fn.describe('vebr3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vebr3 import *
import numpy as np
# See the function signature in fn/vebr3.py for argument names.
```
