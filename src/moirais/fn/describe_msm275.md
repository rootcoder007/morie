# describe('msm275') — mvsml_convolutional_nn_eq_14_9
...
`print(result)` render. See `moirais.fn.describe('msm275')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm275 import *
import numpy as np
# See the function signature in fn/msm275.py for argument names.
```
