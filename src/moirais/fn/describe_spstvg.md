# describe('spstvg') — schabenberger_st_variogram
...
`print(result)` render. See `moirais.fn.describe('spstvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spstvg import *
import numpy as np
# See the function signature in fn/spstvg.py for argument names.
```
