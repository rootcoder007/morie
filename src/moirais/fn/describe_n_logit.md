# describe('n_logit') — sample_size_logistic
...
`print(result)` render. See `moirais.fn.describe('n_logit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.n_logit import *
import numpy as np
# See the function signature in fn/n_logit.py for argument names.
```
