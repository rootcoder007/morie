# describe('rng073') — rangayyan_ch3_twiddle_cos_sin
...
`print(result)` render. See `moirais.fn.describe('rng073')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng073 import *
import numpy as np
# See the function signature in fn/rng073.py for argument names.
```
