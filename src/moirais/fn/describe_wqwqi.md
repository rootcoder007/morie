...
`print(result)` render. See `moirais.fn.describe('wqwqi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqwqi import *
import numpy as np
# See the function signature in fn/wqwqi.py for argument names.
```
