...
`print(result)` render. See `moirais.fn.describe('maalk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maalk import *
import numpy as np
# See the function signature in fn/maalk.py for argument names.
```
