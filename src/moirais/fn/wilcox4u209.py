...
__all__ = ["wilcox_chapter_4_unnumbered_209"]


def wilcox_chapter_4_unnumbered_209(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: freedom is approximately c = 2.08. Because ¯X = 11 and s = 19, a 0.95 confidence interval is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u209')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u209: GeneralStatistics expression (auto-extracted; see ref)."
