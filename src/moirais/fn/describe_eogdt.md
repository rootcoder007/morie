...
`print(result)` render. See `moirais.fn.describe('eogdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eogdt import *
import numpy as np
# See the function signature in fn/eogdt.py for argument names.
```
