...
`print(result)` render. See `moirais.fn.describe('gc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gc import *
import numpy as np
# See the function signature in fn/gc.py for argument names.
```
