...
`print(result)` render. See `moirais.fn.describe('wqswi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqswi import *
import numpy as np
# See the function signature in fn/wqswi.py for argument names.
```
