...
__all__ = ["hedderich_chapter_9_unnumbered_170"]


def hedderich_chapter_9_unnumbered_170(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + vertical =TRUE, group . names =c ( " before " , " after " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u170')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u170: GeneralStatistics expression (auto-extracted; see ref)."
