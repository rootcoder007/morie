...
`print(result)` render. See `moirais.fn.describe('lrunt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrunt import *
import numpy as np
# See the function signature in fn/lrunt.py for argument names.
```
