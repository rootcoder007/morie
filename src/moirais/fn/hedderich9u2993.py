...
__all__ = ["hedderich_chapter_9_unnumbered_2993"]


def hedderich_chapter_9_unnumbered_2993(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2993')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2993: ContingencyTables expression (auto-extracted; see ref)."
