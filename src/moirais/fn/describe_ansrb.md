...
`print(result)` render. See `moirais.fn.describe('ansrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ansrb import *
import numpy as np
# See the function signature in fn/ansrb.py for argument names.
```
