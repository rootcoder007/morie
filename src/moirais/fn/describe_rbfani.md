...
`print(result)` render. See `moirais.fn.describe('rbfani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfani import *
import numpy as np
# See the function signature in fn/rbfani.py for argument names.
```
