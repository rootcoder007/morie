# describe('pages') — page_trend_test
...
`print(result)` render. See `moirais.fn.describe('pages')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pages import *
import numpy as np
# See the function signature in fn/pages.py for argument names.
```
