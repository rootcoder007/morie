...
`print(result)` render. See `moirais.fn.describe('rey_gm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_gm import *
import numpy as np
# See the function signature in fn/rey_gm.py for argument names.
```
