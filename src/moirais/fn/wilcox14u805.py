...
__all__ = ["wilcox_chapter_14_unnumbered_805"]


def wilcox_chapter_14_unnumbered_805(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lev.col=c(1.2),var.col=3,pr=TRUE,IV1=NULL,IV2=NULL)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u805')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u805: GeneralStatistics expression (auto-extracted; see ref)."
