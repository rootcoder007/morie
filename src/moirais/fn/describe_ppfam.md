...
`print(result)` render. See `moirais.fn.describe('ppfam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppfam import *
import numpy as np
# See the function signature in fn/ppfam.py for argument names.
```
