# describe('causipsw') — causal_iptw_attweights
...
`print(result)` render. See `moirais.fn.describe('causipsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causipsw import *
import numpy as np
# See the function signature in fn/causipsw.py for argument names.
```
