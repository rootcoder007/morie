...
__all__ = ["hedderich_chapter_9_unnumbered_727"]


def hedderich_chapter_9_unnumbered_727(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u727')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u727: CountModels expression (auto-extracted; see ref)."
