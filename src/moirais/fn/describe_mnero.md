# describe('mnero') — cellular_automaton
...
`print(result)` render. See `moirais.fn.describe('mnero')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnero import *
import numpy as np
# See the function signature in fn/mnero.py for argument names.
```
