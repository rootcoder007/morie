...
`print(result)` render. See `moirais.fn.describe('blsum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blsum import *
import numpy as np
# See the function signature in fn/blsum.py for argument names.
```
