# describe('dr_') — doubly_robust_ate
...
`print(result)` render. See `moirais.fn.describe('dr_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dr_ import *
import numpy as np
# See the function signature in fn/dr_.py for argument names.
```
