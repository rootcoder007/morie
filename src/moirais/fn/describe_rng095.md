# describe('rng095') — rangayyan_ch3_hann_magnitude_response
...
`print(result)` render. See `moirais.fn.describe('rng095')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng095 import *
import numpy as np
# See the function signature in fn/rng095.py for argument names.
```
