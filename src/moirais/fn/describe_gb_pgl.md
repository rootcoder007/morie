# describe('gb_pgl') — gibbons_page_exact
...
`print(result)` render. See `moirais.fn.describe('gb_pgl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_pgl import *
import numpy as np
# See the function signature in fn/gb_pgl.py for argument names.
```
