# describe('htmap') — heatmap_issue_weights
...
`print(result)` render. See `moirais.fn.describe('htmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htmap import *
import numpy as np
# See the function signature in fn/htmap.py for argument names.
```
