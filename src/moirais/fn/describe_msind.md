...
`print(result)` render. See `moirais.fn.describe('msind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msind import *
import numpy as np
# See the function signature in fn/msind.py for argument names.
```
