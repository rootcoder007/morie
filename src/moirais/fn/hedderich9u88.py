...
__all__ = ["hedderich_chapter_9_unnumbered_88"]


def hedderich_chapter_9_unnumbered_88(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (ABC)−1 = C−1B−1A−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u88')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u88: GeneralStatistics expression (auto-extracted; see ref)."
