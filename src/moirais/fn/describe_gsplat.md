# describe('gsplat') — gaussian_splatting
...
`print(result)` render. See `moirais.fn.describe('gsplat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gsplat import *
import numpy as np
# See the function signature in fn/gsplat.py for argument names.
```
