...
`print(result)` render. See `moirais.fn.describe('pplxy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pplxy import *
import numpy as np
# See the function signature in fn/pplxy.py for argument names.
```
