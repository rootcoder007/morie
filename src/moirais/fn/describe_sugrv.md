# describe('sugrv') — supergravity_action
...
`print(result)` render. See `moirais.fn.describe('sugrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sugrv import *
import numpy as np
# See the function signature in fn/sugrv.py for argument names.
```
