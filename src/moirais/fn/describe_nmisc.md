...
`print(result)` render. See `moirais.fn.describe('nmisc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmisc import *
import numpy as np
# See the function signature in fn/nmisc.py for argument names.
```
