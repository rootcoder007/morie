...
__all__ = ["hedderich_chapter_9_unnumbered_1832"]


def hedderich_chapter_9_unnumbered_1832(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: σ ≤−ε1 or µ−µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1832')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1832: GeneralStatistics expression (auto-extracted; see ref)."
