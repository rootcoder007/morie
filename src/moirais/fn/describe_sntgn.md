# describe('sntgn') — sentence_by_gender
...
`print(result)` render. See `moirais.fn.describe('sntgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntgn import *
import numpy as np
# See the function signature in fn/sntgn.py for argument names.
```
