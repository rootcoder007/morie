...
`print(result)` render. See `moirais.fn.describe('vmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmd import *
import numpy as np
# See the function signature in fn/vmd.py for argument names.
```
