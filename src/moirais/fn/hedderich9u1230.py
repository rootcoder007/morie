...
__all__ = ["hedderich_chapter_9_unnumbered_1230"]


def hedderich_chapter_9_unnumbered_1230(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆλ1 =k1/n1 = 69/1079.6 = 0.0639 ˆλ2 =k2/n2 = 12/467.9 = 0.0256
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1230')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1230: GeneralStatistics expression (auto-extracted; see ref)."
