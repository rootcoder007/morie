# describe('bayid') — bayesian_ideal_points
...
`print(result)` render. See `moirais.fn.describe('bayid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayid import *
import numpy as np
# See the function signature in fn/bayid.py for argument names.
```
