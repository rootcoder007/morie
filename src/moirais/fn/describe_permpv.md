...
`print(result)` render. See `moirais.fn.describe('permpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.permpv import *
import numpy as np
# See the function signature in fn/permpv.py for argument names.
```
