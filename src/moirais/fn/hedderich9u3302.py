...
__all__ = ["hedderich_chapter_9_unnumbered_3302"]


def hedderich_chapter_9_unnumbered_3302(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] a = 1−RSS/(n−(p + 1))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3302')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3302: GeneralStatistics expression (auto-extracted; see ref)."
