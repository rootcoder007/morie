# describe('respwt') — response_weight
...
`print(result)` render. See `moirais.fn.describe('respwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.respwt import *
import numpy as np
# See the function signature in fn/respwt.py for argument names.
```
