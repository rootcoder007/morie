# describe('pctmr') — percentile_modified_rank
...
`print(result)` render. See `moirais.fn.describe('pctmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pctmr import *
import numpy as np
# See the function signature in fn/pctmr.py for argument names.
```
