...
`print(result)` render. See `moirais.fn.describe('stlAn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stlAn import *
import numpy as np
# See the function signature in fn/stlAn.py for argument names.
```
