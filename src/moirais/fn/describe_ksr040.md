# describe('ksr040') — kosorok_ch2_bootstrap_donsker_iff
...
`print(result)` render. See `moirais.fn.describe('ksr040')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr040 import *
import numpy as np
# See the function signature in fn/ksr040.py for argument names.
```
