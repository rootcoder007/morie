# describe('rng118') — rangayyan_ch3_three_point_central_diff_magnitude
...
`print(result)` render. See `moirais.fn.describe('rng118')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng118 import *
import numpy as np
# See the function signature in fn/rng118.py for argument names.
```
