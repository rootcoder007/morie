# describe('hrzt1') — horowitz_treatment_effect
...
`print(result)` render. See `moirais.fn.describe('hrzt1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzt1 import *
import numpy as np
# See the function signature in fn/hrzt1.py for argument names.
```
