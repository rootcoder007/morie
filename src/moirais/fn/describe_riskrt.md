...
`print(result)` render. See `moirais.fn.describe('riskrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.riskrt import *
import numpy as np
# See the function signature in fn/riskrt.py for argument names.
```
