...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1091"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1091(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (iii) si ≤ ϱij ≤ Γsi for some si (i = 1, ..., I; j = 1, ..., ni).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1091')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1091: GeneralStatistics expression (auto-extracted; see ref)."
