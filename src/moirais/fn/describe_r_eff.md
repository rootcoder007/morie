...
`print(result)` render. See `moirais.fn.describe('r_eff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r_eff import *
import numpy as np
# See the function signature in fn/r_eff.py for argument names.
```
