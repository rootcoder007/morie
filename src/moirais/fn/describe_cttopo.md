...
`print(result)` render. See `moirais.fn.describe('cttopo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cttopo import *
import numpy as np
# See the function signature in fn/cttopo.py for argument names.
```
