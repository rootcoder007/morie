# describe('msm312') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm312')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm312 import *
import numpy as np
# See the function signature in fn/msm312.py for argument names.
```
