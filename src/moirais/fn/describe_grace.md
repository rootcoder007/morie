...
`print(result)` render. See `moirais.fn.describe('grace')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grace import *
import numpy as np
# See the function signature in fn/grace.py for argument names.
```
