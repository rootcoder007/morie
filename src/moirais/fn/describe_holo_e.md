...
`print(result)` render. See `moirais.fn.describe('holo_e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_e import *
import numpy as np
# See the function signature in fn/holo_e.py for argument names.
```
