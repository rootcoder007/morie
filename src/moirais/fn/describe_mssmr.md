# describe('mssmr') — smacof_replicate
...
`print(result)` render. See `moirais.fn.describe('mssmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssmr import *
import numpy as np
# See the function signature in fn/mssmr.py for argument names.
```
