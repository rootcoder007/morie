# describe('clocen') — closeness_centrality
...
`print(result)` render. See `moirais.fn.describe('clocen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clocen import *
import numpy as np
# See the function signature in fn/clocen.py for argument names.
```
