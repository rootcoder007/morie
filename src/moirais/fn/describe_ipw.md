# describe('ipw') — calculate_ipw_weights
...
`print(result)` render. See `moirais.fn.describe('ipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipw import *
import numpy as np
# See the function signature in fn/ipw.py for argument names.
```
