# describe('ghmmt') — ghosal_moment_matching
...
`print(result)` render. See `moirais.fn.describe('ghmmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghmmt import *
import numpy as np
# See the function signature in fn/ghmmt.py for argument names.
```
