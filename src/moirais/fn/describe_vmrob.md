...
`print(result)` render. See `moirais.fn.describe('vmrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmrob import *
import numpy as np
# See the function signature in fn/vmrob.py for argument names.
```
