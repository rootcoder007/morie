# describe('hedderich8e19') — hedderich_chapter_8_equation_19
...
ˆϵ = y−X ˆβ = y−ˆy = (I−H)y Estimation error
...
import numpy as np
result = hedderich_chapter_8_equation_19(np.random.default_rng(42).normal(0, 1, 100))
