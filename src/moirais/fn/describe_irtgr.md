# describe('irtgr') — _grm_category_probs
...
`print(result)` render. See `moirais.fn.describe('irtgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtgr import *
import numpy as np
# See the function signature in fn/irtgr.py for argument names.
```
