# describe('rng107') — rangayyan_ch3_integrator_phase_response
...
`print(result)` render. See `moirais.fn.describe('rng107')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng107 import *
import numpy as np
# See the function signature in fn/rng107.py for argument names.
```
