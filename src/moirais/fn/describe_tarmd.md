# describe('tarmd') — threshold_autoregression
...
`print(result)` render. See `moirais.fn.describe('tarmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tarmd import *
import numpy as np
# See the function signature in fn/tarmd.py for argument names.
```
