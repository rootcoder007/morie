# describe('optrs') — optrs

## WHAT IT DOES

Trust region spatial
...
`print(result)` render. See `moirais.fn.describe('optrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optrs import *
import numpy as np
# See the function signature in fn/optrs.py for argument names.
```
