...
`print(result)` render. See `moirais.fn.describe('sdmsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmsig import *
import numpy as np
# See the function signature in fn/sdmsig.py for argument names.
```
