# describe('bambn') — bayesian_burnin_trim
...
`print(result)` render. See `moirais.fn.describe('bambn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bambn import *
import numpy as np
# See the function signature in fn/bambn.py for argument names.
```
