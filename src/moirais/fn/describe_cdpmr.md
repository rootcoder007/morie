# describe('cdpmr') — proportionate_mortality
...
`print(result)` render. See `moirais.fn.describe('cdpmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdpmr import *
import numpy as np
# See the function signature in fn/cdpmr.py for argument names.
```
