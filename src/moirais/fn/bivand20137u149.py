...
__all__ = ["bivand2013_chapter_7_unnumbered_149"]


def bivand2013_chapter_7_unnumbered_149(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: which does check for pairwise Cauchy-Schwartzinequalities, that is|γij(h)|≤√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u149')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u149: GeneralStatistics expression (auto-extracted; see ref)."
