# describe('gctvc') — g_computation_time_varying
...
`print(result)` render. See `moirais.fn.describe('gctvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gctvc import *
import numpy as np
# See the function signature in fn/gctvc.py for argument names.
```
