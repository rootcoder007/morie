# describe('fmrset') — familial_mr_set
...
`print(result)` render. See `moirais.fn.describe('fmrset')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fmrset import *
import numpy as np
# See the function signature in fn/fmrset.py for argument names.
```
