# describe('smokpm') — wildfire_smoke_rr
...
`print(result)` render. See `moirais.fn.describe('smokpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smokpm import *
import numpy as np
# See the function signature in fn/smokpm.py for argument names.
```
