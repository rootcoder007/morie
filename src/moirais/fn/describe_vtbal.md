...
`print(result)` render. See `moirais.fn.describe('vtbal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtbal import *
import numpy as np
# See the function signature in fn/vtbal.py for argument names.
```
