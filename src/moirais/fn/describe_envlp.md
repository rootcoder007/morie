...
`print(result)` render. See `moirais.fn.describe('envlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.envlp import *
import numpy as np
# See the function signature in fn/envlp.py for argument names.
```
