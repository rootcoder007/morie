...
__all__ = ["hedderich_chapter_9_unnumbered_2623"]


def hedderich_chapter_9_unnumbered_2623(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (n−1)(ad−bc)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2623')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2623: ContingencyTables expression (auto-extracted; see ref)."
