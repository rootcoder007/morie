# describe('npstm') — nonparametric_tmle_survival
...
`print(result)` render. See `moirais.fn.describe('npstm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npstm import *
import numpy as np
# See the function signature in fn/npstm.py for argument names.
```
