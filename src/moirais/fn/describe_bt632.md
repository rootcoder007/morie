# describe('bt632') — boot_632_estimator
...
`print(result)` render. See `moirais.fn.describe('bt632')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bt632 import *
import numpy as np
# See the function signature in fn/bt632.py for argument names.
```
