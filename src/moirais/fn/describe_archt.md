...
`print(result)` render. See `moirais.fn.describe('archt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.archt import *
import numpy as np
# See the function signature in fn/archt.py for argument names.
```
