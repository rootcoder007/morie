# describe('bayisr') — importance_resample
...
`print(result)` render. See `moirais.fn.describe('bayisr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayisr import *
import numpy as np
# See the function signature in fn/bayisr.py for argument names.
```
