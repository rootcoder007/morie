...
__all__ = ["wilcox_chapter_13_unnumbered_1367"]


def wilcox_chapter_13_unnumbered_1367(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fail to reject. (c) T = 2.5, reject. 22. (a) T = 0.8, fail to reject. (b) T = 0.4, fail to reject. (c)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1367')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1367: GeneralStatistics expression (auto-extracted; see ref)."
