...
`print(result)` render. See `moirais.fn.describe('smtZ3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smtZ3 import *
import numpy as np
# See the function signature in fn/smtZ3.py for argument names.
```
