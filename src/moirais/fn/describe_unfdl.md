# describe('unfdl') — unfolding_analysis
...
`print(result)` render. See `moirais.fn.describe('unfdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unfdl import *
import numpy as np
# See the function signature in fn/unfdl.py for argument names.
```
