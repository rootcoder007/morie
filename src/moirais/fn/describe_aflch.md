...
`print(result)` render. See `moirais.fn.describe('aflch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aflch import *
import numpy as np
# See the function signature in fn/aflch.py for argument names.
```
