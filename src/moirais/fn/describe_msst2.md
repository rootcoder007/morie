...
`print(result)` render. See `moirais.fn.describe('msst2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msst2 import *
import numpy as np
# See the function signature in fn/msst2.py for argument names.
```
