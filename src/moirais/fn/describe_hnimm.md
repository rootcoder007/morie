# describe('hnimm') — herd_immunity_threshold
...
`print(result)` render. See `moirais.fn.describe('hnimm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hnimm import *
import numpy as np
# See the function signature in fn/hnimm.py for argument names.
```
