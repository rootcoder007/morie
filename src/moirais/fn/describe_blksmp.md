...
`print(result)` render. See `moirais.fn.describe('blksmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blksmp import *
import numpy as np
# See the function signature in fn/blksmp.py for argument names.
```
