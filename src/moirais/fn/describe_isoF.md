# describe('isoF') — isolation_forest
...
`print(result)` render. See `moirais.fn.describe('isoF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isoF import *
import numpy as np
# See the function signature in fn/isoF.py for argument names.
```
