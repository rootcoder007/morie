# describe('rglevd') — rangayyan_levinson_durbin
...
`print(result)` render. See `moirais.fn.describe('rglevd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglevd import *
import numpy as np
# See the function signature in fn/rglevd.py for argument names.
```
