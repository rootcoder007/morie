# describe('eslwlt') — esl_wavelet_smooth
...
`print(result)` render. See `moirais.fn.describe('eslwlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslwlt import *
import numpy as np
# See the function signature in fn/eslwlt.py for argument names.
```
