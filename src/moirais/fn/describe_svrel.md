...
`print(result)` render. See `moirais.fn.describe('svrel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrel import *
import numpy as np
# See the function signature in fn/svrel.py for argument names.
```
