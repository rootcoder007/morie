# describe('evpick') — evt_pickands_estimator
...
`print(result)` render. See `moirais.fn.describe('evpick')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evpick import *
import numpy as np
# See the function signature in fn/evpick.py for argument names.
```
