...
__all__ = ["hedderich_chapter_9_unnumbered_3069"]


def hedderich_chapter_9_unnumbered_3069(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] wij = 1−(i−j)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3069')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3069: ContingencyTables expression (auto-extracted; see ref)."
