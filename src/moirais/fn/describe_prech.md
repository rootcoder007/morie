# describe('prech') — proportional_reduction_error
...
`print(result)` render. See `moirais.fn.describe('prech')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prech import *
import numpy as np
# See the function signature in fn/prech.py for argument names.
```
