# describe('gb551') — gibbons_rank_order_stat
...
`print(result)` render. See `moirais.fn.describe('gb551')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb551 import *
import numpy as np
# See the function signature in fn/gb551.py for argument names.
```
