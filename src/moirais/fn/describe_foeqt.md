# describe('foeqt') — foeqt

## WHAT IT DOES

Equitability spatial
...
`print(result)` render. See `moirais.fn.describe('foeqt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foeqt import *
import numpy as np
# See the function signature in fn/foeqt.py for argument names.
```
