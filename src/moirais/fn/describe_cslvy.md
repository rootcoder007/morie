...
`print(result)` render. See `moirais.fn.describe('cslvy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cslvy import *
import numpy as np
# See the function signature in fn/cslvy.py for argument names.
```
