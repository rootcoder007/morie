...
`print(result)` render. See `moirais.fn.describe('csprs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csprs import *
import numpy as np
# See the function signature in fn/csprs.py for argument names.
```
