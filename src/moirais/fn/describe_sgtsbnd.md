# describe('sgtsbnd') — sgt_sbm_detect_threshold
...
`print(result)` render. See `moirais.fn.describe('sgtsbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsbnd import *
import numpy as np
# See the function signature in fn/sgtsbnd.py for argument names.
```
