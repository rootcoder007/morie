...
`print(result)` render. See `moirais.fn.describe('gduem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gduem import *
import numpy as np
# See the function signature in fn/gduem.py for argument names.
```
