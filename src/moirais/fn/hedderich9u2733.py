...
__all__ = ["hedderich_chapter_9_unnumbered_2733"]


def hedderich_chapter_9_unnumbered_2733(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ψ with ψ= P (K|R)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2733')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2733: GeneralStatistics expression (auto-extracted; see ref)."
