# describe('aftllg') — aft_log_logistic
...
`print(result)` render. See `moirais.fn.describe('aftllg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftllg import *
import numpy as np
# See the function signature in fn/aftllg.py for argument names.
```
