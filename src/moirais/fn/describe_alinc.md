...
`print(result)` render. See `moirais.fn.describe('alinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alinc import *
import numpy as np
# See the function signature in fn/alinc.py for argument names.
```
