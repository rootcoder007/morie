...
__all__ = ["hedderich_chapter_9_unnumbered_2596"]


def hedderich_chapter_9_unnumbered_2596(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = |(ˆp1−ˆp2)−d0)|√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2596')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2596: GeneralStatistics expression (auto-extracted; see ref)."
