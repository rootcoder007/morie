...
`print(result)` render. See `moirais.fn.describe('optds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optds import *
import numpy as np
# See the function signature in fn/optds.py for argument names.
```
