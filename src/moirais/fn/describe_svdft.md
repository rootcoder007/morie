...
`print(result)` render. See `moirais.fn.describe('svdft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdft import *
import numpy as np
# See the function signature in fn/svdft.py for argument names.
```
