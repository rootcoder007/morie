# describe('holog') — holographic_entropy
...
`print(result)` render. See `moirais.fn.describe('holog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holog import *
import numpy as np
# See the function signature in fn/holog.py for argument names.
```
