...
`print(result)` render. See `moirais.fn.describe('enpm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enpm2 import *
import numpy as np
# See the function signature in fn/enpm2.py for argument names.
```
