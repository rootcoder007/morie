# describe('hywtq') — hywtq

## WHAT IT DOES

Water quality index spatial
...
`print(result)` render. See `moirais.fn.describe('hywtq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hywtq import *
import numpy as np
# See the function signature in fn/hywtq.py for argument names.
```
