# describe('otsinkhorn') — ot_sinkhorn
...
`print(result)` render. See `moirais.fn.describe('otsinkhorn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsinkhorn import *
import numpy as np
# See the function signature in fn/otsinkhorn.py for argument names.
```
