...
`print(result)` render. See `moirais.fn.describe('nbtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbtrn import *
import numpy as np
# See the function signature in fn/nbtrn.py for argument names.
```
