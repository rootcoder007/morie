...
__all__ = ["hedderich_chapter_9_unnumbered_9"]


def hedderich_chapter_9_unnumbered_9(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: xi =x3 +x4 +x5, i.e. 5−3 + 1 = 3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u9')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u9: GeneralStatistics expression (auto-extracted; see ref)."
