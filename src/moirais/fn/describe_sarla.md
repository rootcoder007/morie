...
`print(result)` render. See `moirais.fn.describe('sarla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarla import *
import numpy as np
# See the function signature in fn/sarla.py for argument names.
```
