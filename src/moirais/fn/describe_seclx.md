...
`print(result)` render. See `moirais.fn.describe('seclx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclx import *
import numpy as np
# See the function signature in fn/seclx.py for argument names.
```
