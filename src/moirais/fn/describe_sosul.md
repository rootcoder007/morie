...
`print(result)` render. See `moirais.fn.describe('sosul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosul import *
import numpy as np
# See the function signature in fn/sosul.py for argument names.
```
