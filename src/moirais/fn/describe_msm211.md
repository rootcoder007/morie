# describe('msm211') — mvsml_ridge_lasso_elastic_eq_9_31
...
`print(result)` render. See `moirais.fn.describe('msm211')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm211 import *
import numpy as np
# See the function signature in fn/msm211.py for argument names.
```
