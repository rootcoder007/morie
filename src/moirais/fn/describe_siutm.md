...
`print(result)` render. See `moirais.fn.describe('siutm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siutm import *
import numpy as np
# See the function signature in fn/siutm.py for argument names.
```
