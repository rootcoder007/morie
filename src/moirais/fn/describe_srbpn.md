...
`print(result)` render. See `moirais.fn.describe('srbpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbpn import *
import numpy as np
# See the function signature in fn/srbpn.py for argument names.
```
