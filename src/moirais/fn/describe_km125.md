# describe('km125') — kamath_ch8_ngram_weight
...
`print(result)` render. See `moirais.fn.describe('km125')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km125 import *
import numpy as np
# See the function signature in fn/km125.py for argument names.
```
