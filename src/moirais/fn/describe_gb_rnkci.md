# describe('gb_rnkci') — gibbons_rank_ci
...
`print(result)` render. See `moirais.fn.describe('gb_rnkci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_rnkci import *
import numpy as np
# See the function signature in fn/gb_rnkci.py for argument names.
```
