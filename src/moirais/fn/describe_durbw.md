# describe('durbw') — durbin_watson_stat_fn
...
`print(result)` render. See `moirais.fn.describe('durbw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.durbw import *
import numpy as np
# See the function signature in fn/durbw.py for argument names.
```
