# describe('wilcox6e18') — wilcox_chapter_6_equation_18
...
```python
from moirais.fn.wilcox6e18 import wilcox_chapter_6_equation_18
import numpy as np
result = wilcox_chapter_6_equation_18(np.random.default_rng(42).normal(0, 1, 100))
