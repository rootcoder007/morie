# describe('darks') — dark_energy_eos
...
`print(result)` render. See `moirais.fn.describe('darks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.darks import *
import numpy as np
# See the function signature in fn/darks.py for argument names.
```
