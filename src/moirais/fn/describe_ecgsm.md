# describe('ecgsm') — ecg_12lead_simulate_fn
...
`print(result)` render. See `moirais.fn.describe('ecgsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecgsm import *
import numpy as np
# See the function signature in fn/ecgsm.py for argument names.
```
