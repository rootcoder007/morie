...
`print(result)` render. See `moirais.fn.describe('xrgwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwk import *
import numpy as np
# See the function signature in fn/xrgwk.py for argument names.
```
