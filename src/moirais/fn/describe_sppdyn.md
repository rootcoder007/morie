...
`print(result)` render. See `moirais.fn.describe('sppdyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppdyn import *
import numpy as np
# See the function signature in fn/sppdyn.py for argument names.
```
