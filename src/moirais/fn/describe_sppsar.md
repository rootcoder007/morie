...
`print(result)` render. See `moirais.fn.describe('sppsar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppsar import *
import numpy as np
# See the function signature in fn/sppsar.py for argument names.
```
