...
`print(result)` render. See `moirais.fn.describe('ghcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcox import *
import numpy as np
# See the function signature in fn/ghcox.py for argument names.
```
