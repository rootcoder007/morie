...
`print(result)` render. See `moirais.fn.describe('spcflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcflt import *
import numpy as np
# See the function signature in fn/spcflt.py for argument names.
```
