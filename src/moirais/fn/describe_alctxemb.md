# describe('alctxemb') — alammar_contextualized_embedding
...
`print(result)` render. See `moirais.fn.describe('alctxemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alctxemb import *
import numpy as np
# See the function signature in fn/alctxemb.py for argument names.
```
