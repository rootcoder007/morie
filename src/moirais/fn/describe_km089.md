# describe('km089') — kamath_ch6_sgs_invariance
...
`print(result)` render. See `moirais.fn.describe('km089')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km089 import *
import numpy as np
# See the function signature in fn/km089.py for argument names.
```
