...
`print(result)` render. See `moirais.fn.describe('srolm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srolm import *
import numpy as np
# See the function signature in fn/srolm.py for argument names.
```
