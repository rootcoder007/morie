# describe('msm020') — mvsml_linear_mixed_models_eq_5_4
...
`print(result)` render. See `moirais.fn.describe('msm020')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm020 import *
import numpy as np
# See the function signature in fn/msm020.py for argument names.
```
