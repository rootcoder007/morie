...
`print(result)` render. See `moirais.fn.describe('srqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srqnt import *
import numpy as np
# See the function signature in fn/srqnt.py for argument names.
```
