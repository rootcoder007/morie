# describe('gb_t1e') — gibbons_type1_error
...
`print(result)` render. See `moirais.fn.describe('gb_t1e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_t1e import *
import numpy as np
# See the function signature in fn/gb_t1e.py for argument names.
```
