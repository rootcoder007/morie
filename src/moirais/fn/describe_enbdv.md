...
`print(result)` render. See `moirais.fn.describe('enbdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enbdv import *
import numpy as np
# See the function signature in fn/enbdv.py for argument names.
```
