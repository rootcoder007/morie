...
`print(result)` render. See `moirais.fn.describe('snrdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snrdb import *
import numpy as np
# See the function signature in fn/snrdb.py for argument names.
```
