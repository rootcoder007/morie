...
__all__ = ["hedderich_chapter_9_unnumbered_3387"]


def hedderich_chapter_9_unnumbered_3387(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfrow= c ( 1 , 1 ) , lwd =2 , font . a x i s=2 , b t y =" l " , ps =15)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3387')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3387: GeneralStatistics expression (auto-extracted; see ref)."
