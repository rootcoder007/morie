...
`print(result)` render. See `moirais.fn.describe('otsobm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsobm import *
import numpy as np
# See the function signature in fn/otsobm.py for argument names.
```
