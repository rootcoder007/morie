# describe('totcorr') — total_correlation
...
`print(result)` render. See `moirais.fn.describe('totcorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.totcorr import *
import numpy as np
# See the function signature in fn/totcorr.py for argument names.
```
