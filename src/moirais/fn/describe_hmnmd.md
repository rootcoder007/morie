# describe('hmnmd') — geron_numerical_diff
...
`print(result)` render. See `moirais.fn.describe('hmnmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnmd import *
import numpy as np
# See the function signature in fn/hmnmd.py for argument names.
```
