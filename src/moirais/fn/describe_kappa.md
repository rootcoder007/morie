...
`print(result)` render. See `moirais.fn.describe('kappa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kappa import *
import numpy as np
# See the function signature in fn/kappa.py for argument names.
```
