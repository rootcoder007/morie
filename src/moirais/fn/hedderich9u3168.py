...
__all__ = ["hedderich_chapter_9_unnumbered_3168"]


def hedderich_chapter_9_unnumbered_3168(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The test statistic then results in ˆF = 0.066. Since ˆF < 6.94 = F2;4;0.95, the linearity hypothesis
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3168')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3168: GeneralStatistics expression (auto-extracted; see ref)."
