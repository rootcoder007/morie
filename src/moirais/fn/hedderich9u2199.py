...
__all__ = ["hedderich_chapter_9_unnumbered_2199"]


def hedderich_chapter_9_unnumbered_2199(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: at the 5% level, e.g., forn = 6,h = 0 with ˆz = 2.04 forn = 9,h = 1 with ˆz = 2; in both cases,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2199')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2199: GeneralStatistics expression (auto-extracted; see ref)."
