# describe('sasc1') — synthetic_accessibility
...
`print(result)` render. See `moirais.fn.describe('sasc1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sasc1 import *
import numpy as np
# See the function signature in fn/sasc1.py for argument names.
```
