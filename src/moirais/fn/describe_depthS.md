# describe('depthS') — simplicial_depth
...
`print(result)` render. See `moirais.fn.describe('depthS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depthS import *
import numpy as np
# See the function signature in fn/depthS.py for argument names.
```
