# describe('rgmtnart') — rangayyan_motion_artifact
...
`print(result)` render. See `moirais.fn.describe('rgmtnart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmtnart import *
import numpy as np
# See the function signature in fn/rgmtnart.py for argument names.
```
