...
__all__ = ["bivand2013_chapter_7_unnumbered_87"]


def bivand2013_chapter_7_unnumbered_87(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u87')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u87: GeneralStatistics expression (auto-extracted; see ref)."
