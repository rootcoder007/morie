...
__all__ = ["hedderich_chapter_9_unnumbered_1213"]


def hedderich_chapter_9_unnumbered_1213(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] + l _u <− 1 / ( 2*n ) * qchisq (1 − alph a/ 2 , df =2 *k +2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1213')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1213: CountModels expression (auto-extracted; see ref)."
