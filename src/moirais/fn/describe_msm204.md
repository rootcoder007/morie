# describe('msm204') — mvsml_ridge_lasso_elastic_eq_9_30
...
`print(result)` render. See `moirais.fn.describe('msm204')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm204 import *
import numpy as np
# See the function signature in fn/msm204.py for argument names.
```
