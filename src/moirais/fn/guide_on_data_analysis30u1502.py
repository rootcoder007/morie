...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1502"]


def guide_on_data_analysis_chapter_30_unnumbered_1502(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -3 x cohort = 5 -1.0 (0.97)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1502')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1502: GeneralStatistics expression (auto-extracted; see ref)."
