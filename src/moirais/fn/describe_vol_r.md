...
`print(result)` render. See `moirais.fn.describe('vol_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vol_r import *
import numpy as np
# See the function signature in fn/vol_r.py for argument names.
```
