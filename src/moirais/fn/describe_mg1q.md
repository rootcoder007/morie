...
`print(result)` render. See `moirais.fn.describe('mg1q')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mg1q import *
import numpy as np
# See the function signature in fn/mg1q.py for argument names.
```
