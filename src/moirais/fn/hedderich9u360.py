...
__all__ = ["hedderich_chapter_9_unnumbered_360"]


def hedderich_chapter_9_unnumbered_360(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: can be represented (x′=x·ex,y′= (siny)ey withex =ey = 1).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u360')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u360: PowerAndDesign expression (auto-extracted; see ref)."
