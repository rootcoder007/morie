# describe('rgknn') — rangayyan_knn_classifier
...
`print(result)` render. See `moirais.fn.describe('rgknn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgknn import *
import numpy as np
# See the function signature in fn/rgknn.py for argument names.
```
