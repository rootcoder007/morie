# describe('gb_pg2') — gibbons_page_asymp
...
`print(result)` render. See `moirais.fn.describe('gb_pg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_pg2 import *
import numpy as np
# See the function signature in fn/gb_pg2.py for argument names.
```
