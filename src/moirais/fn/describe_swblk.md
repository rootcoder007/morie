...
`print(result)` render. See `moirais.fn.describe('swblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swblk import *
import numpy as np
# See the function signature in fn/swblk.py for argument names.
```
