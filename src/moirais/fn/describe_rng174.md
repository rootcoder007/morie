# describe('rng174') — rangayyan_ch3_rls_weight_update_compact
...
`print(result)` render. See `moirais.fn.describe('rng174')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng174 import *
import numpy as np
# See the function signature in fn/rng174.py for argument names.
```
