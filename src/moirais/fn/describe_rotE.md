...
`print(result)` render. See `moirais.fn.describe('rotE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rotE import *
import numpy as np
# See the function signature in fn/rotE.py for argument names.
```
