...
__all__ = ["wilcox_chapter_13_unnumbered_1252"]


def wilcox_chapter_13_unnumbered_1252(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ancovaWMW(x1,y1,x2,y2, fr1=1, fr2=1, alpha=0.05, plotit=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1252')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1252: GeneralStatistics expression (auto-extracted; see ref)."
