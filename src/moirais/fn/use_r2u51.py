...
__all__ = ["use_r_chapter_2_unnumbered_51"]


def use_r_chapter_2_unnumbered_51(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u51')`` for the full guide.
...
def cheatsheet():
    return "use_r2u51: GeneralStatistics expression (auto-extracted; see ref)."
