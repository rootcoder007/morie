...
`print(result)` render. See `moirais.fn.describe('sppsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppsem import *
import numpy as np
# See the function signature in fn/sppsem.py for argument names.
```
