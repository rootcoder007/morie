# describe('syndc') — syndrome_compute
...
`print(result)` render. See `moirais.fn.describe('syndc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.syndc import *
import numpy as np
# See the function signature in fn/syndc.py for argument names.
```
