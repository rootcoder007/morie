# describe('clsng') — clsng

## WHAT IT DOES

Single linkage spatial
...
`print(result)` render. See `moirais.fn.describe('clsng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clsng import *
import numpy as np
# See the function signature in fn/clsng.py for argument names.
```
