# describe('depvln') — dependent_violation_test
...
`print(result)` render. See `moirais.fn.describe('depvln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depvln import *
import numpy as np
# See the function signature in fn/depvln.py for argument names.
```
