# describe('msm322') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm322')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm322 import *
import numpy as np
# See the function signature in fn/msm322.py for argument names.
```
