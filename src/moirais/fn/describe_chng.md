# describe('chng') — changepoint_detect
...
`print(result)` render. See `moirais.fn.describe('chng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chng import *
import numpy as np
# See the function signature in fn/chng.py for argument names.
```
