...
`print(result)` render. See `moirais.fn.describe('wqalg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqalg import *
import numpy as np
# See the function signature in fn/wqalg.py for argument names.
```
