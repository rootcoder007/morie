# describe('tmllng') — tmle_longitudinal
...
`print(result)` render. See `moirais.fn.describe('tmllng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmllng import *
import numpy as np
# See the function signature in fn/tmllng.py for argument names.
```
