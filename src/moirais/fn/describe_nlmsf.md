...
`print(result)` render. See `moirais.fn.describe('nlmsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nlmsf import *
import numpy as np
# See the function signature in fn/nlmsf.py for argument names.
```
