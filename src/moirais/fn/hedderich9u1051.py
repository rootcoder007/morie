...
__all__ = ["hedderich_chapter_9_unnumbered_1051"]


def hedderich_chapter_9_unnumbered_1051(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] for allxi,y j withP (X =xi)> 0, P(Y =yj)> 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1051')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1051: GeneralStatistics expression (auto-extracted; see ref)."
