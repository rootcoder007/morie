...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_49"]


def information_theory_mackay_chapter_6_unnumbered_49(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 states that pa = 1=6,pb = 5=6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u49')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u49: GeneralStatistics expression (auto-extracted; see ref)."
