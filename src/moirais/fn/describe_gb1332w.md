# describe('gb1332w') — gibbons_wrs_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb1332w')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1332w import *
import numpy as np
# See the function signature in fn/gb1332w.py for argument names.
```
