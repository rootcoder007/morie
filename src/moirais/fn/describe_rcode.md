# describe('rcode') — recode_responses
...
`print(result)` render. See `moirais.fn.describe('rcode')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcode import *
import numpy as np
# See the function signature in fn/rcode.py for argument names.
```
