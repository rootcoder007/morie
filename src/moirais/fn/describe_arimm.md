...
`print(result)` render. See `moirais.fn.describe('arimm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arimm import *
import numpy as np
# See the function signature in fn/arimm.py for argument names.
```
