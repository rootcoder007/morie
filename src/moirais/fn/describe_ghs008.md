# describe('ghs008') — ghosal_ch3_normalized_weights_prior
...
`print(result)` render. See `moirais.fn.describe('ghs008')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs008 import *
import numpy as np
# See the function signature in fn/ghs008.py for argument names.
```
