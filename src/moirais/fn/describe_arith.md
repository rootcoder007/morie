...
`print(result)` render. See `moirais.fn.describe('arith')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arith import *
import numpy as np
# See the function signature in fn/arith.py for argument names.
```
