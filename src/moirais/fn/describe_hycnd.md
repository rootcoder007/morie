...
`print(result)` render. See `moirais.fn.describe('hycnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hycnd import *
import numpy as np
# See the function signature in fn/hycnd.py for argument names.
```
