# describe('phmmsr') — profile_hmm_search
...
`print(result)` render. See `moirais.fn.describe('phmmsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phmmsr import *
import numpy as np
# See the function signature in fn/phmmsr.py for argument names.
```
