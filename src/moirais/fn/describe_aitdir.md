# describe('aitdir') — dirichlet_density
...
`print(result)` render. See `moirais.fn.describe('aitdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdir import *
import numpy as np
# See the function signature in fn/aitdir.py for argument names.
```
