...
`print(result)` render. See `moirais.fn.describe('ntrud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ntrud import *
import numpy as np
# See the function signature in fn/ntrud.py for argument names.
```
