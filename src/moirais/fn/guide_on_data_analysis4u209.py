...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_209"]


def guide_on_data_analysis_chapter_4_unnumbered_209(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑤𝑦 + 𝑤𝑥 = 𝑛(𝑛 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u209')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u209: GeneralStatistics expression (auto-extracted; see ref)."
