...
`print(result)` render. See `moirais.fn.describe('dftot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dftot import *
import numpy as np
# See the function signature in fn/dftot.py for argument names.
```
