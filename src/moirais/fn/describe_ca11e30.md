# describe('ca11e30') — ca_chapter_11_equation_30
...
```python
from moirais.fn.ca11e30 import ca_chapter_11_equation_30
import numpy as np
result = ca_chapter_11_equation_30(np.random.default_rng(42).normal(0, 1, 100))
