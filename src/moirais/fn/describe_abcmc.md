...
`print(result)` render. See `moirais.fn.describe('abcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcmc import *
import numpy as np
# See the function signature in fn/abcmc.py for argument names.
```
