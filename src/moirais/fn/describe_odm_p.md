# describe('odm_p') — otis_demo_proportion
...
`print(result)` render. See `moirais.fn.describe('odm_p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_p import *
import numpy as np
# See the function signature in fn/odm_p.py for argument names.
```
