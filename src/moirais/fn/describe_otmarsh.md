# describe('otmarsh') — ot_marginal_shift
...
`print(result)` render. See `moirais.fn.describe('otmarsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmarsh import *
import numpy as np
# See the function signature in fn/otmarsh.py for argument names.
```
