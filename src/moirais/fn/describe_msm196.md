# describe('msm196') — mvsml_ridge_lasso_elastic_eq_9_24
...
`print(result)` render. See `moirais.fn.describe('msm196')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm196 import *
import numpy as np
# See the function signature in fn/msm196.py for argument names.
```
