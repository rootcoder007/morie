...
`print(result)` render. See `moirais.fn.describe('rncost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rncost import *
import numpy as np
# See the function signature in fn/rncost.py for argument names.
```
