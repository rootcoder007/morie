...
__all__ = ["hedderich_chapter_9_unnumbered_2787"]


def hedderich_chapter_9_unnumbered_2787(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pchange = ˆp1 + ˆp2 = b +c
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2787')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2787: GeneralStatistics expression (auto-extracted; see ref)."
