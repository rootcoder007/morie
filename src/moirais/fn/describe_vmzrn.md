...
`print(result)` render. See `moirais.fn.describe('vmzrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmzrn import *
import numpy as np
# See the function signature in fn/vmzrn.py for argument names.
```
