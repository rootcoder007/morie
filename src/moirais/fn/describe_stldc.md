...
`print(result)` render. See `moirais.fn.describe('stldc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stldc import *
import numpy as np
# See the function signature in fn/stldc.py for argument names.
```
