# describe('acclso') — accelerated_lasso
...
`print(result)` render. See `moirais.fn.describe('acclso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acclso import *
import numpy as np
# See the function signature in fn/acclso.py for argument names.
```
