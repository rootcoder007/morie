# describe('hmenet') — geron_elastic_net
...
`print(result)` render. See `moirais.fn.describe('hmenet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmenet import *
import numpy as np
# See the function signature in fn/hmenet.py for argument names.
```
