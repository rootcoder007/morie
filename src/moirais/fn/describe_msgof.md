...
`print(result)` render. See `moirais.fn.describe('msgof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msgof import *
import numpy as np
# See the function signature in fn/msgof.py for argument names.
```
