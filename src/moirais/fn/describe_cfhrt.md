...
`print(result)` render. See `moirais.fn.describe('cfhrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfhrt import *
import numpy as np
# See the function signature in fn/cfhrt.py for argument names.
```
