# describe('kmpens') — kamath_prompt_ensemble
...
`print(result)` render. See `moirais.fn.describe('kmpens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpens import *
import numpy as np
# See the function signature in fn/kmpens.py for argument names.
```
