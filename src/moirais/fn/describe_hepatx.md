# describe('hepatx') — hepatotoxicity
...
`print(result)` render. See `moirais.fn.describe('hepatx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hepatx import *
import numpy as np
# See the function signature in fn/hepatx.py for argument names.
```
