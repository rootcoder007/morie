# describe('xspec') — cross_spectral_density
...
`print(result)` render. See `moirais.fn.describe('xspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xspec import *
import numpy as np
# See the function signature in fn/xspec.py for argument names.
```
