# describe('grlrex') — geron_lr_exponential_schedule
...
`print(result)` render. See `moirais.fn.describe('grlrex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlrex import *
import numpy as np
# See the function signature in fn/grlrex.py for argument names.
```
