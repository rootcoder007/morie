...
`print(result)` render. See `moirais.fn.describe('powsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.powsrv import *
import numpy as np
# See the function signature in fn/powsrv.py for argument names.
```
