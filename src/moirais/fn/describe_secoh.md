...
`print(result)` render. See `moirais.fn.describe('secoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secoh import *
import numpy as np
# See the function signature in fn/secoh.py for argument names.
```
