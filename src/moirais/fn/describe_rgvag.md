# describe('rgvag') — rangayyan_vag_analysis
...
`print(result)` render. See `moirais.fn.describe('rgvag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvag import *
import numpy as np
# See the function signature in fn/rgvag.py for argument names.
```
