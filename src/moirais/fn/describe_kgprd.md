# describe('kgprd') — kriging_predict
...
`print(result)` render. See `moirais.fn.describe('kgprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgprd import *
import numpy as np
# See the function signature in fn/kgprd.py for argument names.
```
