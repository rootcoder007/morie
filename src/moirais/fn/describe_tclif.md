...
`print(result)` render. See `moirais.fn.describe('tclif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tclif import *
import numpy as np
# See the function signature in fn/tclif.py for argument names.
```
