...
`print(result)` render. See `moirais.fn.describe('pskde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pskde import *
import numpy as np
# See the function signature in fn/pskde.py for argument names.
```
