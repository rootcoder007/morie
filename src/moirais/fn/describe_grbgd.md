# describe('grbgd') — geron_batch_gradient_descent
...
`print(result)` render. See `moirais.fn.describe('grbgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbgd import *
import numpy as np
# See the function signature in fn/grbgd.py for argument names.
```
