# describe('kgprb') — kriging_prob_map
...
`print(result)` render. See `moirais.fn.describe('kgprb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgprb import *
import numpy as np
# See the function signature in fn/kgprb.py for argument names.
```
