# describe('crfvar') — causal_forest_variance
...
`print(result)` render. See `moirais.fn.describe('crfvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfvar import *
import numpy as np
# See the function signature in fn/crfvar.py for argument names.
```
