...
def ca_chapter_11_equation_25(x):
    """
    Logistic expression involving 'logit' (auto-extracted; see reference for full context).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca11e25')`` for the full guide.

    References
    ----------
    Advanced Statistics in Criminology and Criminal Justice (Weisburd, Wilson, Wooditch & Britt, 5th ed, Springer 2022), ch.11 eq.11.25
    """
...
def cheatsheet():
    return "ca11e25: Logistic expression involving 'logit' (auto-extracted; see reference for full context)."
