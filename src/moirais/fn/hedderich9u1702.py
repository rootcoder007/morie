...
__all__ = ["hedderich_chapter_9_unnumbered_1702"]


def hedderich_chapter_9_unnumbered_1702(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: : 1 split? The calculation (with DF =k−1 = 3−1 = 2 ) shows ( ˆχ2 = 5.10 < 5.99 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1702')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1702: GeneralStatistics expression (auto-extracted; see ref)."
