# describe('eegplt') — plot_eeg_montage_fn
...
`print(result)` render. See `moirais.fn.describe('eegplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eegplt import *
import numpy as np
# See the function signature in fn/eegplt.py for argument names.
```
