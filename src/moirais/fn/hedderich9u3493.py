...
__all__ = ["hedderich_chapter_9_unnumbered_3493"]


def hedderich_chapter_9_unnumbered_3493(x):
    """
    Multilevel expression (auto-extracted; see ref).

    Formula: |D = (yi−Xi ˆβ|D)′V−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3493')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3493: Multilevel expression (auto-extracted; see ref)."
