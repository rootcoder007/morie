# describe('rfkrn') — random_fourier_features
...
`print(result)` render. See `moirais.fn.describe('rfkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfkrn import *
import numpy as np
# See the function signature in fn/rfkrn.py for argument names.
```
