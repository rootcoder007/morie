...
`print(result)` render. See `moirais.fn.describe('svdgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdgn import *
import numpy as np
# See the function signature in fn/svdgn.py for argument names.
```
