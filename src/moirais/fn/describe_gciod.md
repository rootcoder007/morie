...
`print(result)` render. See `moirais.fn.describe('gciod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gciod import *
import numpy as np
# See the function signature in fn/gciod.py for argument names.
```
