...
`print(result)` render. See `moirais.fn.describe('sgcsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcsr import *
import numpy as np
# See the function signature in fn/sgcsr.py for argument names.
```
