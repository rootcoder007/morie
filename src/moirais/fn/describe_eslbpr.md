...
`print(result)` render. See `moirais.fn.describe('eslbpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslbpr import *
import numpy as np
# See the function signature in fn/eslbpr.py for argument names.
```
