...
__all__ = ["hedderich_chapter_9_unnumbered_1547"]


def hedderich_chapter_9_unnumbered_1547(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] πx·(1−π)n−x Beta(p0, q 0) p∗= p0 + x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1547')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1547: CountModels expression (auto-extracted; see ref)."
