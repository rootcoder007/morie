# describe('msm158') — mvsml_categorical_count_eq_8_13
...
`print(result)` render. See `moirais.fn.describe('msm158')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm158 import *
import numpy as np
# See the function signature in fn/msm158.py for argument names.
```
