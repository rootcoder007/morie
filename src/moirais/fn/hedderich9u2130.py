...
__all__ = ["hedderich_chapter_9_unnumbered_2130"]


def hedderich_chapter_9_unnumbered_2130(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] U1 = 6·5 + 6(6 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2130')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2130: GeneralStatistics expression (auto-extracted; see ref)."
