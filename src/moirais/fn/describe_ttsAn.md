# describe('ttsAn') — twitter_anomaly
...
`print(result)` render. See `moirais.fn.describe('ttsAn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ttsAn import *
import numpy as np
# See the function signature in fn/ttsAn.py for argument names.
```
