# describe('gprgr') — gaussian_process_regression
...
`print(result)` render. See `moirais.fn.describe('gprgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gprgr import *
import numpy as np
# See the function signature in fn/gprgr.py for argument names.
```
