# describe('dwnmn') — dynamic_wnominate
...
`print(result)` render. See `moirais.fn.describe('dwnmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwnmn import *
import numpy as np
# See the function signature in fn/dwnmn.py for argument names.
```
