# describe('sintf') — natural_neighbor
...
`print(result)` render. See `moirais.fn.describe('sintf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sintf import *
import numpy as np
# See the function signature in fn/sintf.py for argument names.
```
