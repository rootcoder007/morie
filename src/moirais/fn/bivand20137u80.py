...
__all__ = ["bivand2013_chapter_7_unnumbered_80"]


def bivand2013_chapter_7_unnumbered_80(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + r = r, nrank = 2, nsim = 99)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u80')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u80: GeneralStatistics expression (auto-extracted; see ref)."
