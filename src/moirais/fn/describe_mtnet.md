...
`print(result)` render. See `moirais.fn.describe('mtnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtnet import *
import numpy as np
# See the function signature in fn/mtnet.py for argument names.
```
