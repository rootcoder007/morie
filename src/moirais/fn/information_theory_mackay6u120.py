...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_120"]


def information_theory_mackay_chapter_6_unnumbered_120(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u120')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u120: GeneralStatistics expression (auto-extracted; see ref)."
