# describe('nmwnc') — wnominate_class
...
`print(result)` render. See `moirais.fn.describe('nmwnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwnc import *
import numpy as np
# See the function signature in fn/nmwnc.py for argument names.
```
