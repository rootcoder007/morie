...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_896"]


def guide_on_data_analysis_chapter_14_unnumbered_896(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> BP = 7.8141, df = 2, p-value = 0.0201
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u896')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u896: GeneralStatistics expression (auto-extracted; see ref)."
