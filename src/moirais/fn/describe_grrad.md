# describe('grrad') — geron_reverse_mode_autodiff
...
`print(result)` render. See `moirais.fn.describe('grrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrad import *
import numpy as np
# See the function signature in fn/grrad.py for argument names.
```
