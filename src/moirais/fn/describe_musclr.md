...
`print(result)` render. See `moirais.fn.describe('musclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.musclr import *
import numpy as np
# See the function signature in fn/musclr.py for argument names.
```
