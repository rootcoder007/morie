...
`print(result)` render. See `moirais.fn.describe('fodsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fodsm import *
import numpy as np
# See the function signature in fn/fodsm.py for argument names.
```
