...
`print(result)` render. See `moirais.fn.describe('pcgflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcgflt import *
import numpy as np
# See the function signature in fn/pcgflt.py for argument names.
```
