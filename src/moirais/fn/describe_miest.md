...
`print(result)` render. See `moirais.fn.describe('miest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miest import *
import numpy as np
# See the function signature in fn/miest.py for argument names.
```
