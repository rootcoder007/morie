...
__all__ = ["hedderich_chapter_9_unnumbered_2922"]


def hedderich_chapter_9_unnumbered_2922(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2922')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2922: CountModels expression (auto-extracted; see ref)."
