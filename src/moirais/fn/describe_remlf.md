# describe('remlf') — reml_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('remlf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.remlf import *
import numpy as np
# See the function signature in fn/remlf.py for argument names.
```
