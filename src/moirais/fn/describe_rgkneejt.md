# describe('rgkneejt') — rangayyan_knee_joint_sound
...
`print(result)` render. See `moirais.fn.describe('rgkneejt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkneejt import *
import numpy as np
# See the function signature in fn/rgkneejt.py for argument names.
```
