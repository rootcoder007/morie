...
`print(result)` render. See `moirais.fn.describe('manit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manit import *
import numpy as np
# See the function signature in fn/manit.py for argument names.
```
