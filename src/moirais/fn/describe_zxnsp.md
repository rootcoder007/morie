# describe('zxnsp') — network_shortest
...
`print(result)` render. See `moirais.fn.describe('zxnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxnsp import *
import numpy as np
# See the function signature in fn/zxnsp.py for argument names.
```
