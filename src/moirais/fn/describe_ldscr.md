...
`print(result)` render. See `moirais.fn.describe('ldscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldscr import *
import numpy as np
# See the function signature in fn/ldscr.py for argument names.
```
