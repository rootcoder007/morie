# describe('mtlmm') — multi_trait_lmm
...
`print(result)` render. See `moirais.fn.describe('mtlmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtlmm import *
import numpy as np
# See the function signature in fn/mtlmm.py for argument names.
```
