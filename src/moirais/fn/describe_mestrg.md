# describe('mestrg') — m_estimator_regression
...
`print(result)` render. See `moirais.fn.describe('mestrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mestrg import *
import numpy as np
# See the function signature in fn/mestrg.py for argument names.
```
