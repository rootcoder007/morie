...
__all__ = ["bivand2013_chapter_2_unnumbered_31"]


def bivand2013_chapter_2_unnumbered_31(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] +init=epsg:2163 +proj=laea +lat_0=45 +lon_0=-100 +x_0=0 +y_0=0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u31')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u31: GeneralStatistics expression (auto-extracted; see ref)."
