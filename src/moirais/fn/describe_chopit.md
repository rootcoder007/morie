# describe('chopit') — chopit_vignette
...
`print(result)` render. See `moirais.fn.describe('chopit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chopit import *
import numpy as np
# See the function signature in fn/chopit.py for argument names.
```
