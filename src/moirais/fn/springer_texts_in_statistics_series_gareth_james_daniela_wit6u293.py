...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_293"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0 +β1X1 +... +βpXp as
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u293')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u293: GeneralStatistics expression (auto-extracted; see ref)."
