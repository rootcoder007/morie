...
`print(result)` render. See `moirais.fn.describe('sgreal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgreal import *
import numpy as np
# See the function signature in fn/sgreal.py for argument names.
```
