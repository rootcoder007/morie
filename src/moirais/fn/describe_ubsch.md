...
`print(result)` render. See `moirais.fn.describe('ubsch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubsch import *
import numpy as np
# See the function signature in fn/ubsch.py for argument names.
```
