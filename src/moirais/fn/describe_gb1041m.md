# describe('gb1041m') — gibbons_kw_mult_comp
...
`print(result)` render. See `moirais.fn.describe('gb1041m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1041m import *
import numpy as np
# See the function signature in fn/gb1041m.py for argument names.
```
