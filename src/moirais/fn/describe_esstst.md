# describe('esstst') — effective_sample_size
...
`print(result)` render. See `moirais.fn.describe('esstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esstst import *
import numpy as np
# See the function signature in fn/esstst.py for argument names.
```
