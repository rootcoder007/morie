...
__all__ = ["hedderich_chapter_9_unnumbered_2754"]


def hedderich_chapter_9_unnumbered_2754(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H0 : |π1−π2|>∆, i.e. (π1−π2) /∈[−∆,+∆] not equivalent
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2754')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2754: CountModels expression (auto-extracted; see ref)."
