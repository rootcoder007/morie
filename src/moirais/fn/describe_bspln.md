# describe('bspln') — bayesian_spline
...
`print(result)` render. See `moirais.fn.describe('bspln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bspln import *
import numpy as np
# See the function signature in fn/bspln.py for argument names.
```
