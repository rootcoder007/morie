# describe('rghgate') — rangayyan_hh_gating
...
`print(result)` render. See `moirais.fn.describe('rghgate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghgate import *
import numpy as np
# See the function signature in fn/rghgate.py for argument names.
```
