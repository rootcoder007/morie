# describe('cppgm') — changepoint_poisson
...
`print(result)` render. See `moirais.fn.describe('cppgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cppgm import *
import numpy as np
# See the function signature in fn/cppgm.py for argument names.
```
