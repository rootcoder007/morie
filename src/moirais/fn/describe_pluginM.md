# describe('pluginM') — plug_in_mediation
...
`print(result)` render. See `moirais.fn.describe('pluginM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pluginM import *
import numpy as np
# See the function signature in fn/pluginM.py for argument names.
```
