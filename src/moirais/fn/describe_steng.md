...
`print(result)` render. See `moirais.fn.describe('steng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.steng import *
import numpy as np
# See the function signature in fn/steng.py for argument names.
```
