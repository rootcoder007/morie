# describe('msm190') — mvsml_ridge_lasso_elastic_eq_9_18
...
`print(result)` render. See `moirais.fn.describe('msm190')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm190 import *
import numpy as np
# See the function signature in fn/msm190.py for argument names.
```
