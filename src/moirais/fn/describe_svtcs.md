...
`print(result)` render. See `moirais.fn.describe('svtcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svtcs import *
import numpy as np
# See the function signature in fn/svtcs.py for argument names.
```
