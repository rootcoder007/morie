# describe('wavlt') — wavelet_decompose
...
`print(result)` render. See `moirais.fn.describe('wavlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wavlt import *
import numpy as np
# See the function signature in fn/wavlt.py for argument names.
```
