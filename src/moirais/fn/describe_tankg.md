...
`print(result)` render. See `moirais.fn.describe('tankg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tankg import *
import numpy as np
# See the function signature in fn/tankg.py for argument names.
```
