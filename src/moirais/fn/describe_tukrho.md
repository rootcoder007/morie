# describe('tukrho') — tukey_biweight
...
`print(result)` render. See `moirais.fn.describe('tukrho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tukrho import *
import numpy as np
# See the function signature in fn/tukrho.py for argument names.
```
