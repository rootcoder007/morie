...
`print(result)` render. See `moirais.fn.describe('msadj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msadj import *
import numpy as np
# See the function signature in fn/msadj.py for argument names.
```
