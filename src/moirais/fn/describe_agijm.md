...
`print(result)` render. See `moirais.fn.describe('agijm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agijm import *
import numpy as np
# See the function signature in fn/agijm.py for argument names.
```
