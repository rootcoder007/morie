# describe('clrnt') — clearance_intrinsic
...
`print(result)` render. See `moirais.fn.describe('clrnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clrnt import *
import numpy as np
# See the function signature in fn/clrnt.py for argument names.
```
