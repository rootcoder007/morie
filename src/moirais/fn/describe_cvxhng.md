# describe('cvxhng') — boyd_hinge_loss
...
`print(result)` render. See `moirais.fn.describe('cvxhng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxhng import *
import numpy as np
# See the function signature in fn/cvxhng.py for argument names.
```
