# describe('opthr') — optimal_huber_k
...
`print(result)` render. See `moirais.fn.describe('opthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opthr import *
import numpy as np
# See the function signature in fn/opthr.py for argument names.
```
