...
`print(result)` render. See `moirais.fn.describe('msshd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msshd import *
import numpy as np
# See the function signature in fn/msshd.py for argument names.
```
