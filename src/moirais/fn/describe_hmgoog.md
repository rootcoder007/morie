# describe('hmgoog') — geron_googlenet
...
`print(result)` render. See `moirais.fn.describe('hmgoog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgoog import *
import numpy as np
# See the function signature in fn/hmgoog.py for argument names.
```
