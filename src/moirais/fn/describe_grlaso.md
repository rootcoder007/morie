# describe('grlaso') — geron_lasso_cost
...
`print(result)` render. See `moirais.fn.describe('grlaso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlaso import *
import numpy as np
# See the function signature in fn/grlaso.py for argument names.
```
