...
__all__ = ["wilcox_chapter_10_unnumbered_890"]


def wilcox_chapter_10_unnumbered_890(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :Fjk (x) − ¯Fj.(x) − ¯F.k(x) + ¯F..(x) = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u890')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u890: GeneralStatistics expression (auto-extracted; see ref)."
