# describe('spkpe') — schabenberger_kriging_pred_error
...
`print(result)` render. See `moirais.fn.describe('spkpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkpe import *
import numpy as np
# See the function signature in fn/spkpe.py for argument names.
```
