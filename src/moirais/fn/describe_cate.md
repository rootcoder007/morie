...
`print(result)` render. See `moirais.fn.describe('cate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cate import *
import numpy as np
# See the function signature in fn/cate.py for argument names.
```
