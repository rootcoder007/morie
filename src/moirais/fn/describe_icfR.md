...
`print(result)` render. See `moirais.fn.describe('icfR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icfR import *
import numpy as np
# See the function signature in fn/icfR.py for argument names.
```
