...
`print(result)` render. See `moirais.fn.describe('focrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focrb import *
import numpy as np
# See the function signature in fn/focrb.py for argument names.
```
