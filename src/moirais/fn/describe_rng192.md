# describe('rng192') — rangayyan_ch4_pan_tompkins_searchback_update
...
`print(result)` render. See `moirais.fn.describe('rng192')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng192 import *
import numpy as np
# See the function signature in fn/rng192.py for argument names.
```
