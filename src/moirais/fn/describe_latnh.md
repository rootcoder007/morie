# describe('latnh') — latin_hypercube
...
`print(result)` render. See `moirais.fn.describe('latnh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.latnh import *
import numpy as np
# See the function signature in fn/latnh.py for argument names.
```
