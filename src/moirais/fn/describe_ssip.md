# describe('ssip') — sample_size_proportions
...
`print(result)` render. See `moirais.fn.describe('ssip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssip import *
import numpy as np
# See the function signature in fn/ssip.py for argument names.
```
