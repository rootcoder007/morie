...
`print(result)` render. See `moirais.fn.describe('bartk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bartk import *
import numpy as np
# See the function signature in fn/bartk.py for argument names.
```
