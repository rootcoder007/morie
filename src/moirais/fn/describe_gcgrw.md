...
`print(result)` render. See `moirais.fn.describe('gcgrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcgrw import *
import numpy as np
# See the function signature in fn/gcgrw.py for argument names.
```
