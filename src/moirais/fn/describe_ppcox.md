...
`print(result)` render. See `moirais.fn.describe('ppcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppcox import *
import numpy as np
# See the function signature in fn/ppcox.py for argument names.
```
