...
`print(result)` render. See `moirais.fn.describe('dferr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dferr import *
import numpy as np
# See the function signature in fn/dferr.py for argument names.
```
