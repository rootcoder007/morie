...
`print(result)` render. See `moirais.fn.describe('agdom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdom import *
import numpy as np
# See the function signature in fn/agdom.py for argument names.
```
