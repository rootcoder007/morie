...
`print(result)` render. See `moirais.fn.describe('rsmxl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmxl import *
import numpy as np
# See the function signature in fn/rsmxl.py for argument names.
```
