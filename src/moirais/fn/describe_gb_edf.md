# describe('gb_edf') — gibbons_edf_def
...
`print(result)` render. See `moirais.fn.describe('gb_edf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_edf import *
import numpy as np
# See the function signature in fn/gb_edf.py for argument names.
```
