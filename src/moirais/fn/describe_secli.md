...
`print(result)` render. See `moirais.fn.describe('secli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secli import *
import numpy as np
# See the function signature in fn/secli.py for argument names.
```
