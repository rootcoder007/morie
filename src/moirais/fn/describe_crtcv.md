# describe('crtcv') — court_civil_liberties
...
`print(result)` render. See `moirais.fn.describe('crtcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtcv import *
import numpy as np
# See the function signature in fn/crtcv.py for argument names.
```
