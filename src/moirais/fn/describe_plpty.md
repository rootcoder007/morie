...
`print(result)` render. See `moirais.fn.describe('plpty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plpty import *
import numpy as np
# See the function signature in fn/plpty.py for argument names.
```
