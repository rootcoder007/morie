# describe('srmse') — root_mean_squared_error
...
`print(result)` render. See `moirais.fn.describe('srmse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmse import *
import numpy as np
# See the function signature in fn/srmse.py for argument names.
```
