...
`print(result)` render. See `moirais.fn.describe('carvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carvar import *
import numpy as np
# See the function signature in fn/carvar.py for argument names.
```
