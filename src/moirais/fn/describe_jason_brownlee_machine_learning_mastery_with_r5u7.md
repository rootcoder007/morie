...
You can read fields by attribute (`r.statistic`), index (`r["statistic'A journey of a thousand miles begins with a single step. — Lao Tzu's a RichResult; `isinstance(r, dict)`
