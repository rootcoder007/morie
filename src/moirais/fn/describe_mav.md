...
`print(result)` render. See `moirais.fn.describe('mav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mav import *
import numpy as np
# See the function signature in fn/mav.py for argument names.
```
