# describe('tdmed') — two_dimensional_mediation
...
`print(result)` render. See `moirais.fn.describe('tdmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdmed import *
import numpy as np
# See the function signature in fn/tdmed.py for argument names.
```
