...
`print(result)` render. See `moirais.fn.describe('gamtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gamtd import *
import numpy as np
# See the function signature in fn/gamtd.py for argument names.
```
