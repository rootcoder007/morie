# describe('gb_ttm') — gibbons_two_sample_t_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb_ttm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ttm import *
import numpy as np
# See the function signature in fn/gb_ttm.py for argument names.
```
