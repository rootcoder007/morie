...
__all__ = ["hedderich_chapter_9_unnumbered_3080"]


def hedderich_chapter_9_unnumbered_3080(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > d a t <− rbind ( Obs_A=o1 , Obs _B=o2 , Obs _C=o3 , Obs _D=o4 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3080')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3080: GeneralStatistics expression (auto-extracted; see ref)."
