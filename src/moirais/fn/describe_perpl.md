...
`print(result)` render. See `moirais.fn.describe('perpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.perpl import *
import numpy as np
# See the function signature in fn/perpl.py for argument names.
```
