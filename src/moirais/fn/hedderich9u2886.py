...
__all__ = ["hedderich_chapter_9_unnumbered_2886"]


def hedderich_chapter_9_unnumbered_2886(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] p5 = r5/n5 = 27/30 = 0.90, and p = 107/143 = 0.748 andα= 0.05, i.e. q∞;5;0.95 = 3.86
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2886')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2886: GeneralStatistics expression (auto-extracted; see ref)."
