...
`print(result)` render. See `moirais.fn.describe('difef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difef import *
import numpy as np
# See the function signature in fn/difef.py for argument names.
```
