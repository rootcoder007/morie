...
`print(result)` render. See `moirais.fn.describe('spprml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprml import *
import numpy as np
# See the function signature in fn/spprml.py for argument names.
```
