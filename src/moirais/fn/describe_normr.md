# describe('normr') — normalized_redundancy
...
`print(result)` render. See `moirais.fn.describe('normr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.normr import *
import numpy as np
# See the function signature in fn/normr.py for argument names.
```
