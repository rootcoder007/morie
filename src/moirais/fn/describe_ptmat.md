...
`print(result)` render. See `moirais.fn.describe('ptmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptmat import *
import numpy as np
# See the function signature in fn/ptmat.py for argument names.
```
