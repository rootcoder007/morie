...
`print(result)` render. See `moirais.fn.describe('adfts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adfts import *
import numpy as np
# See the function signature in fn/adfts.py for argument names.
```
