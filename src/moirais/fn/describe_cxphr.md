...
`print(result)` render. See `moirais.fn.describe('cxphr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxphr import *
import numpy as np
# See the function signature in fn/cxphr.py for argument names.
```
