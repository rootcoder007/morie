# describe('kmp2') — kamath_p_tuning_v2
...
`print(result)` render. See `moirais.fn.describe('kmp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmp2 import *
import numpy as np
# See the function signature in fn/kmp2.py for argument names.
```
