...
__all__ = ["use_r_chapter_2_unnumbered_224"]


def use_r_chapter_2_unnumbered_224(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: gwr(formula = Z ~ PEXPOSURE + PCTAGE65P + PCTOWNHOME, data = NY8,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u224')`` for the full guide.
...
def cheatsheet():
    return "use_r2u224: GeneralStatistics expression (auto-extracted; see ref)."
