...
__all__ = ["hedderich_chapter_9_unnumbered_2874"]


def hedderich_chapter_9_unnumbered_2874(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ...=πk) is tested using thek·2-field-χ2-test. IfH0 is not rejected, for not too small sample sizes,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2874')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2874: GeneralStatistics expression (auto-extracted; see ref)."
