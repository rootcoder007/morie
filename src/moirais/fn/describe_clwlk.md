...
`print(result)` render. See `moirais.fn.describe('clwlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clwlk import *
import numpy as np
# See the function signature in fn/clwlk.py for argument names.
```
