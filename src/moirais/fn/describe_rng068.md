# describe('rng068') — rangayyan_ch3_dft_K_samples
...
`print(result)` render. See `moirais.fn.describe('rng068')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng068 import *
import numpy as np
# See the function signature in fn/rng068.py for argument names.
```
