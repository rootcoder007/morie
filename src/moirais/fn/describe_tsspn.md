...
`print(result)` render. See `moirais.fn.describe('tsspn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsspn import *
import numpy as np
# See the function signature in fn/tsspn.py for argument names.
```
