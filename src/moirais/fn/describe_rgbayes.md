# describe('rgbayes') — rangayyan_bayes_classifier
...
`print(result)` render. See `moirais.fn.describe('rgbayes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbayes import *
import numpy as np
# See the function signature in fn/rgbayes.py for argument names.
```
