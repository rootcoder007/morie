# describe('cstfr') — custody_facility_rate
...
`print(result)` render. See `moirais.fn.describe('cstfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstfr import *
import numpy as np
# See the function signature in fn/cstfr.py for argument names.
```
