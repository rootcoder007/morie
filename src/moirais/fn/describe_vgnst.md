...
`print(result)` render. See `moirais.fn.describe('vgnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgnst import *
import numpy as np
# See the function signature in fn/vgnst.py for argument names.
```
