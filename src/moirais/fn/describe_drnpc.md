# describe('drnpc') — dr_did_neg_control
...
`print(result)` render. See `moirais.fn.describe('drnpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drnpc import *
import numpy as np
# See the function signature in fn/drnpc.py for argument names.
```
