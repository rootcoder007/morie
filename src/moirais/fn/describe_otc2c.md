# describe('otc2c') — ot_cost_pairwise
...
`print(result)` render. See `moirais.fn.describe('otc2c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otc2c import *
import numpy as np
# See the function signature in fn/otc2c.py for argument names.
```
