# describe('ksr038') — kosorok_ch2_donsker_uniform_entropy
...
`print(result)` render. See `moirais.fn.describe('ksr038')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr038 import *
import numpy as np
# See the function signature in fn/ksr038.py for argument names.
```
