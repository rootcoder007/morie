# describe('nignst') — normal_inv_gamma
...
`print(result)` render. See `moirais.fn.describe('nignst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nignst import *
import numpy as np
# See the function signature in fn/nignst.py for argument names.
```
