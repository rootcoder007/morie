...
`print(result)` render. See `moirais.fn.describe('klotz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klotz import *
import numpy as np
# See the function signature in fn/klotz.py for argument names.
```
