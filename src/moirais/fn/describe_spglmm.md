# describe('spglmm') — schabenberger_spatial_glmm
...
`print(result)` render. See `moirais.fn.describe('spglmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spglmm import *
import numpy as np
# See the function signature in fn/spglmm.py for argument names.
```
