...
`print(result)` render. See `moirais.fn.describe('snarl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snarl import *
import numpy as np
# See the function signature in fn/snarl.py for argument names.
```
