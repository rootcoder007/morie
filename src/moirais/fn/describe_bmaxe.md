# describe('bmaxe') — bayesian_model_averaging
...
`print(result)` render. See `moirais.fn.describe('bmaxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmaxe import *
import numpy as np
# See the function signature in fn/bmaxe.py for argument names.
```
