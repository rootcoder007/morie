...
`print(result)` render. See `moirais.fn.describe('mabegg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mabegg import *
import numpy as np
# See the function signature in fn/mabegg.py for argument names.
```
