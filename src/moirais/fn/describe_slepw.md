...
`print(result)` render. See `moirais.fn.describe('slepw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slepw import *
import numpy as np
# See the function signature in fn/slepw.py for argument names.
```
