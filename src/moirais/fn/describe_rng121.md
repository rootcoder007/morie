# describe('rng121') — rangayyan_ch3_baseline_wander_filter_z_form_b
...
`print(result)` render. See `moirais.fn.describe('rng121')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng121 import *
import numpy as np
# See the function signature in fn/rng121.py for argument names.
```
