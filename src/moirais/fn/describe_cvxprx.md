...
`print(result)` render. See `moirais.fn.describe('cvxprx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxprx import *
import numpy as np
# See the function signature in fn/cvxprx.py for argument names.
```
