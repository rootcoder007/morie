# describe('ksr073') — kosorok_ch3_max_likelihood_efficiency_corollary
...
`print(result)` render. See `moirais.fn.describe('ksr073')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr073 import *
import numpy as np
# See the function signature in fn/ksr073.py for argument names.
```
