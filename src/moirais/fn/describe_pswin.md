...
`print(result)` render. See `moirais.fn.describe('pswin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pswin import *
import numpy as np
# See the function signature in fn/pswin.py for argument names.
```
