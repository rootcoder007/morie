# describe('ismrt') — indirect_standardization
...
`print(result)` render. See `moirais.fn.describe('ismrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ismrt import *
import numpy as np
# See the function signature in fn/ismrt.py for argument names.
```
