# describe('gb_md3') — gibbons_median_ties
...
`print(result)` render. See `moirais.fn.describe('gb_md3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_md3 import *
import numpy as np
# See the function signature in fn/gb_md3.py for argument names.
```
