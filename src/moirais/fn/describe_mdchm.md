...
`print(result)` render. See `moirais.fn.describe('mdchm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdchm import *
import numpy as np
# See the function signature in fn/mdchm.py for argument names.
```
