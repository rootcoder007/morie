...
__all__ = ["hedderich_chapter_9_unnumbered_2254"]


def hedderich_chapter_9_unnumbered_2254(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2254')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2254: GeneralStatistics expression (auto-extracted; see ref)."
