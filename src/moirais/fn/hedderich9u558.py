...
__all__ = ["hedderich_chapter_9_unnumbered_558"]


def hedderich_chapter_9_unnumbered_558(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u558')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u558: GeneralStatistics expression (auto-extracted; see ref)."
