...
`print(result)` render. See `moirais.fn.describe('foshan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foshan import *
import numpy as np
# See the function signature in fn/foshan.py for argument names.
```
