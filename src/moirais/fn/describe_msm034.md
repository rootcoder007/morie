# describe('msm034') — mvsml_linear_mixed_models_eq_5_6
...
`print(result)` render. See `moirais.fn.describe('msm034')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm034 import *
import numpy as np
# See the function signature in fn/msm034.py for argument names.
```
