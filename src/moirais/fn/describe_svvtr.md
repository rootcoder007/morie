...
`print(result)` render. See `moirais.fn.describe('svvtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svvtr import *
import numpy as np
# See the function signature in fn/svvtr.py for argument names.
```
