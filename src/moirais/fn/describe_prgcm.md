# describe('prgcm') — program_completion
...
`print(result)` render. See `moirais.fn.describe('prgcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgcm import *
import numpy as np
# See the function signature in fn/prgcm.py for argument names.
```
