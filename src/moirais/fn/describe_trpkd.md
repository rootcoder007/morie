...
`print(result)` render. See `moirais.fn.describe('trpkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trpkd import *
import numpy as np
# See the function signature in fn/trpkd.py for argument names.
```
