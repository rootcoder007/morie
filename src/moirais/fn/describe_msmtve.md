# describe('msmtve') — msm_time_varying_exposure
...
`print(result)` render. See `moirais.fn.describe('msmtve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmtve import *
import numpy as np
# See the function signature in fn/msmtve.py for argument names.
```
