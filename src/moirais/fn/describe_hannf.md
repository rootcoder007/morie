...
`print(result)` render. See `moirais.fn.describe('hannf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hannf import *
import numpy as np
# See the function signature in fn/hannf.py for argument names.
```
