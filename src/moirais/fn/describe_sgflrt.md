# describe('sgflrt') — spatial_glmm_fit
...
`print(result)` render. See `moirais.fn.describe('sgflrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgflrt import *
import numpy as np
# See the function signature in fn/sgflrt.py for argument names.
```
