# describe('fzedg') — fauzi_edgeworth_quantile
...
`print(result)` render. See `moirais.fn.describe('fzedg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzedg import *
import numpy as np
# See the function signature in fn/fzedg.py for argument names.
```
