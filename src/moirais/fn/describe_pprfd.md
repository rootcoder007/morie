...
`print(result)` render. See `moirais.fn.describe('pprfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pprfd import *
import numpy as np
# See the function signature in fn/pprfd.py for argument names.
```
