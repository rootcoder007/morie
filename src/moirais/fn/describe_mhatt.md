# describe('mhatt') — mhatt

## WHAT IT DOES

rMulti-head attention (scaled dot-product).
...
`print(result)` render. See `moirais.fn.describe('mhatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhatt import *
import numpy as np
# See the function signature in fn/mhatt.py for argument names.
```
