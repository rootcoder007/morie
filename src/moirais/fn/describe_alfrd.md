...
`print(result)` render. See `moirais.fn.describe('alfrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfrd import *
import numpy as np
# See the function signature in fn/alfrd.py for argument names.
```
