...
__all__ = ["wilcox_chapter_8_unnumbered_811"]


def wilcox_chapter_8_unnumbered_811(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : Υ 1 = Υ 2 = · · · = Υ J.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u811')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u811: GeneralStatistics expression (auto-extracted; see ref)."
