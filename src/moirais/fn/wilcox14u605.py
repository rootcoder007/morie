...
__all__ = ["wilcox_chapter_14_unnumbered_605"]


def wilcox_chapter_14_unnumbered_605(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: into the R function twopcor. The 0.95 confidence interval for ρ 1 − ρ 2, the difference between
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u605')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u605: GeneralStatistics expression (auto-extracted; see ref)."
