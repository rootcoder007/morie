...
`print(result)` render. See `moirais.fn.describe('fofuel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fofuel import *
import numpy as np
# See the function signature in fn/fofuel.py for argument names.
```
