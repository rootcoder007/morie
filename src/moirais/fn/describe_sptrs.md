# describe('sptrs') — schabenberger_trend_surface
...
`print(result)` render. See `moirais.fn.describe('sptrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptrs import *
import numpy as np
# See the function signature in fn/sptrs.py for argument names.
```
