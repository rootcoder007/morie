...
`print(result)` render. See `moirais.fn.describe('gcpdo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcpdo import *
import numpy as np
# See the function signature in fn/gcpdo.py for argument names.
```
