# describe('hmroc') — geron_roc_curve
...
`print(result)` render. See `moirais.fn.describe('hmroc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmroc import *
import numpy as np
# See the function signature in fn/hmroc.py for argument names.
```
