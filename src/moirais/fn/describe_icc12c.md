...
`print(result)` render. See `moirais.fn.describe('icc12c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc12c import *
import numpy as np
# See the function signature in fn/icc12c.py for argument names.
```
