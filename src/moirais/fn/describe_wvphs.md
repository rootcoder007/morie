...
`print(result)` render. See `moirais.fn.describe('wvphs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvphs import *
import numpy as np
# See the function signature in fn/wvphs.py for argument names.
```
