...
__all__ = ["wilcox_chapter_13_unnumbered_1229"]


def wilcox_chapter_13_unnumbered_1229(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ancJN(x1,y1,x2,y2, pts=NULL, Dpts=FALSE,regfun=tsreg, fr1=1, fr2=1, SCAT =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1229')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1229: GeneralStatistics expression (auto-extracted; see ref)."
