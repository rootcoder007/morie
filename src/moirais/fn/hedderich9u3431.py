...
__all__ = ["hedderich_chapter_9_unnumbered_3431"]


def hedderich_chapter_9_unnumbered_3431(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: + famil y=" poisson " , data = rates ) ; summary ( mod )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3431')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3431: CountModels expression (auto-extracted; see ref)."
