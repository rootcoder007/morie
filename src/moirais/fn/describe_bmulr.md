# describe('bmulr') — bayesian_multinomial
...
`print(result)` render. See `moirais.fn.describe('bmulr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmulr import *
import numpy as np
# See the function signature in fn/bmulr.py for argument names.
```
