# describe('orfgrf') — orthogonal_random_forest
...
`print(result)` render. See `moirais.fn.describe('orfgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orfgrf import *
import numpy as np
# See the function signature in fn/orfgrf.py for argument names.
```
