...
`print(result)` render. See `moirais.fn.describe('svamn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svamn import *
import numpy as np
# See the function signature in fn/svamn.py for argument names.
```
