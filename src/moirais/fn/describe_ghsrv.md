...
`print(result)` render. See `moirais.fn.describe('ghsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsrv import *
import numpy as np
# See the function signature in fn/ghsrv.py for argument names.
```
