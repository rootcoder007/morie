...
`print(result)` render. See `moirais.fn.describe('rnafld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnafld import *
import numpy as np
# See the function signature in fn/rnafld.py for argument names.
```
