...
`print(result)` render. See `moirais.fn.describe('varqc1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varqc1 import *
import numpy as np
# See the function signature in fn/varqc1.py for argument names.
```
