...
`print(result)` render. See `moirais.fn.describe('adamopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adamopt import *
import numpy as np
# See the function signature in fn/adamopt.py for argument names.
```
