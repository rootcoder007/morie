...
`print(result)` render. See `moirais.fn.describe('imedg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imedg import *
import numpy as np
# See the function signature in fn/imedg.py for argument names.
```
