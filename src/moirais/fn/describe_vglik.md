...
`print(result)` render. See `moirais.fn.describe('vglik')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vglik import *
import numpy as np
# See the function signature in fn/vglik.py for argument names.
```
