...
__all__ = ["wilcox_chapter_4_unnumbered_18"]


def wilcox_chapter_4_unnumbered_18(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] q2 = (1 − 0.41667)(6.2) + 0.41667(2) = 4.45,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u18')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u18: GeneralStatistics expression (auto-extracted; see ref)."
