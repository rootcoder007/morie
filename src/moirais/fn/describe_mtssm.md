...
`print(result)` render. See `moirais.fn.describe('mtssm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtssm import *
import numpy as np
# See the function signature in fn/mtssm.py for argument names.
```
