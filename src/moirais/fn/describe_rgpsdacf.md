# describe('rgpsdacf') — rangayyan_psd_to_acf
...
`print(result)` render. See `moirais.fn.describe('rgpsdacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpsdacf import *
import numpy as np
# See the function signature in fn/rgpsdacf.py for argument names.
```
