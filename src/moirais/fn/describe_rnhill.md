...
`print(result)` render. See `moirais.fn.describe('rnhill')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnhill import *
import numpy as np
# See the function signature in fn/rnhill.py for argument names.
```
