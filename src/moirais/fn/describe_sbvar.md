...
`print(result)` render. See `moirais.fn.describe('sbvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbvar import *
import numpy as np
# See the function signature in fn/sbvar.py for argument names.
```
