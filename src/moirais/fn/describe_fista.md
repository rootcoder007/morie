...
`print(result)` render. See `moirais.fn.describe('fista')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fista import *
import numpy as np
# See the function signature in fn/fista.py for argument names.
```
