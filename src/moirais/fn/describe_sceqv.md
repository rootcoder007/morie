...
`print(result)` render. See `moirais.fn.describe('sceqv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sceqv import *
import numpy as np
# See the function signature in fn/sceqv.py for argument names.
```
