...
__all__ = ["wilcox_chapter_8_unnumbered_809"]


def wilcox_chapter_8_unnumbered_809(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: K (θ 21 +θ 22 + · · · +θ 2 K),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u809')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u809: Resampling expression (auto-extracted; see ref)."
