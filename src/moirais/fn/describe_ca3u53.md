# describe('ca3u53') — ca_chapter_3_unnumbered_53
...
West − South = 46.131 − 46.984 =− 0.853
...
```python
from moirais.fn.ca3u53 import ca_chapter_3_unnumbered_53
import numpy as np
result = ca_chapter_3_unnumbered_53(np.random.default_rng(42).normal(0, 1, 100))
