...
`print(result)` render. See `moirais.fn.describe('gnssig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnssig import *
import numpy as np
# See the function signature in fn/gnssig.py for argument names.
```
