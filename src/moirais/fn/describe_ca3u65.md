# describe('ca3u65') — ca_chapter_3_unnumbered_65
...
y = b0 + b2() + b1x1 + b3x1 = b0 + b2() + b1 + b3() x1
...
```python
from moirais.fn.ca3u65 import ca_chapter_3_unnumbered_65
import numpy as np
result = ca_chapter_3_unnumbered_65(np.random.default_rng(42).normal(0, 1, 100))
