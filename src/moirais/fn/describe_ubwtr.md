...
`print(result)` render. See `moirais.fn.describe('ubwtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubwtr import *
import numpy as np
# See the function signature in fn/ubwtr.py for argument names.
```
