...
`print(result)` render. See `moirais.fn.describe('csfrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csfrd import *
import numpy as np
# See the function signature in fn/csfrd.py for argument names.
```
