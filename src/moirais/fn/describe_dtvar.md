...
`print(result)` render. See `moirais.fn.describe('dtvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtvar import *
import numpy as np
# See the function signature in fn/dtvar.py for argument names.
```
