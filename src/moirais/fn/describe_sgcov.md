# describe('sgcov') — covariance_function_estimate
...
`print(result)` render. See `moirais.fn.describe('sgcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcov import *
import numpy as np
# See the function signature in fn/sgcov.py for argument names.
```
