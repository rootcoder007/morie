...
__all__ = ["hedderich_chapter_9_unnumbered_1257"]


def hedderich_chapter_9_unnumbered_1257(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] s√n≤µ≤¯x +tn−1;1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1257')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1257: GeneralStatistics expression (auto-extracted; see ref)."
