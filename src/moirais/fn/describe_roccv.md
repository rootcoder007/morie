...
`print(result)` render. See `moirais.fn.describe('roccv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.roccv import *
import numpy as np
# See the function signature in fn/roccv.py for argument names.
```
