...
`print(result)` render. See `moirais.fn.describe('survroc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survroc import *
import numpy as np
# See the function signature in fn/survroc.py for argument names.
```
