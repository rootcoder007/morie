# describe('hmord') — geron_ordinal_encoding
...
`print(result)` render. See `moirais.fn.describe('hmord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmord import *
import numpy as np
# See the function signature in fn/hmord.py for argument names.
```
