# describe('effsz') — effective_sample_size
...
`print(result)` render. See `moirais.fn.describe('effsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effsz import *
import numpy as np
# See the function signature in fn/effsz.py for argument names.
```
