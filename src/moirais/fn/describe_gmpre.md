# describe('gmpre') — geometric_mean_probability
...
`print(result)` render. See `moirais.fn.describe('gmpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmpre import *
import numpy as np
# See the function signature in fn/gmpre.py for argument names.
```
