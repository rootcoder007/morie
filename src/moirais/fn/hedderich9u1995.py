...
__all__ = ["hedderich_chapter_9_unnumbered_1995"]


def hedderich_chapter_9_unnumbered_1995(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + "ST =" , ST , "P− value ( two − sided ) =" , p . value , " \ n " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1995')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1995: GeneralStatistics expression (auto-extracted; see ref)."
