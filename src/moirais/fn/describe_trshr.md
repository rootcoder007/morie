...
`print(result)` render. See `moirais.fn.describe('trshr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trshr import *
import numpy as np
# See the function signature in fn/trshr.py for argument names.
```
