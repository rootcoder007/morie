...
`print(result)` render. See `moirais.fn.describe('sprbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprbk import *
import numpy as np
# See the function signature in fn/sprbk.py for argument names.
```
