...
`print(result)` render. See `moirais.fn.describe('tscls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tscls import *
import numpy as np
# See the function signature in fn/tscls.py for argument names.
```
