...
`print(result)` render. See `moirais.fn.describe('svd_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svd_ import *
import numpy as np
# See the function signature in fn/svd_.py for argument names.
```
