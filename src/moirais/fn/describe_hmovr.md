# describe('hmovr') — geron_one_vs_rest
...
`print(result)` render. See `moirais.fn.describe('hmovr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmovr import *
import numpy as np
# See the function signature in fn/hmovr.py for argument names.
```
