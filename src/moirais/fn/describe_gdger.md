...
`print(result)` render. See `moirais.fn.describe('gdger')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdger import *
import numpy as np
# See the function signature in fn/gdger.py for argument names.
```
