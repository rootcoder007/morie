# describe('km018') — kamath_ch2_layer_norm
...
`print(result)` render. See `moirais.fn.describe('km018')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km018 import *
import numpy as np
# See the function signature in fn/km018.py for argument names.
```
