...
`print(result)` render. See `moirais.fn.describe('mhgad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhgad import *
import numpy as np
# See the function signature in fn/mhgad.py for argument names.
```
