# describe('rng183') — rangayyan_ch4_pan_tompkins_highpass_lp_component
...
`print(result)` render. See `moirais.fn.describe('rng183')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng183 import *
import numpy as np
# See the function signature in fn/rng183.py for argument names.
```
