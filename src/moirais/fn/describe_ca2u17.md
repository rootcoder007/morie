# describe('ca2u17') — ca_chapter_2_unnumbered_17
...
```python
from moirais.fn.ca2u17 import ca_chapter_2_unnumbered_17
import numpy as np
result = ca_chapter_2_unnumbered_17(np.random.default_rng(42).normal(0, 1, 100))
