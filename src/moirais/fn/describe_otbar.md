# describe('otbar') — ot_barycenter_fixed
...
`print(result)` render. See `moirais.fn.describe('otbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otbar import *
import numpy as np
# See the function signature in fn/otbar.py for argument names.
```
