# describe('scumap') — umap_singlecell
...
`print(result)` render. See `moirais.fn.describe('scumap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scumap import *
import numpy as np
# See the function signature in fn/scumap.py for argument names.
```
