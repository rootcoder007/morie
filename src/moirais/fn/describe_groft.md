# describe('groft') — geron_overfitting_gap
...
`print(result)` render. See `moirais.fn.describe('groft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groft import *
import numpy as np
# See the function signature in fn/groft.py for argument names.
```
