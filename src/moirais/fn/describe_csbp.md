# describe('csbp') — basis_pursuit_l1
...
`print(result)` render. See `moirais.fn.describe('csbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csbp import *
import numpy as np
# See the function signature in fn/csbp.py for argument names.
```
