...
__all__ = ["bivand2013_chapter_2_unnumbered_8"]


def bivand2013_chapter_2_unnumbered_8(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + cellsize = cs, cells.dim = cd)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u8')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u8: GeneralStatistics expression (auto-extracted; see ref)."
