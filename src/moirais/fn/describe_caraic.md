...
`print(result)` render. See `moirais.fn.describe('caraic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caraic import *
import numpy as np
# See the function signature in fn/caraic.py for argument names.
```
