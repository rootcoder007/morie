...
`print(result)` render. See `moirais.fn.describe('glmmsar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmsar import *
import numpy as np
# See the function signature in fn/glmmsar.py for argument names.
```
