...
`print(result)` render. See `moirais.fn.describe('dlnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlnrm import *
import numpy as np
# See the function signature in fn/dlnrm.py for argument names.
```
