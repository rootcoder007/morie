# describe('grdyq') — geron_dynamic_quantization
...
`print(result)` render. See `moirais.fn.describe('grdyq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdyq import *
import numpy as np
# See the function signature in fn/grdyq.py for argument names.
```
