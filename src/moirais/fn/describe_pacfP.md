# describe('pacfP') — partial_autocorrelation
...
`print(result)` render. See `moirais.fn.describe('pacfP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacfP import *
import numpy as np
# See the function signature in fn/pacfP.py for argument names.
```
