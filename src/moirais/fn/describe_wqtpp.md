...
`print(result)` render. See `moirais.fn.describe('wqtpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtpp import *
import numpy as np
# See the function signature in fn/wqtpp.py for argument names.
```
