...
`print(result)` render. See `moirais.fn.describe('trrdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trrdb import *
import numpy as np
# See the function signature in fn/trrdb.py for argument names.
```
