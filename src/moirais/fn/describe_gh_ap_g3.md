# describe('gh_ap_g3') — ghosal_dir_marginal
...
`print(result)` render. See `moirais.fn.describe('gh_ap_g3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_g3 import *
import numpy as np
# See the function signature in fn/gh_ap_g3.py for argument names.
```
