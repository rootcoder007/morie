...
__all__ = ["bivand2013_chapter_7_unnumbered_115"]


def bivand2013_chapter_7_unnumbered_115(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: tribble(ccflag = spasthma$y, vars = D2_mat, alphas = 1, betas = 1,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u115')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u115: GeneralStatistics expression (auto-extracted; see ref)."
