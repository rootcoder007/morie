...
`print(result)` render. See `moirais.fn.describe('clden')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clden import *
import numpy as np
# See the function signature in fn/clden.py for argument names.
```
