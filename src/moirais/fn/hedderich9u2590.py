...
__all__ = ["hedderich_chapter_9_unnumbered_2590"]


def hedderich_chapter_9_unnumbered_2590(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (300+300)=0.14, ˆz=(0.18−0.10)/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2590')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2590: GeneralStatistics expression (auto-extracted; see ref)."
