...
__all__ = ["hedderich_chapter_9_unnumbered_1965"]


def hedderich_chapter_9_unnumbered_1965(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + result <− list ( " Chi − squarestatistic " = stat , " pval " = p )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1965')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1965: GeneralStatistics expression (auto-extracted; see ref)."
