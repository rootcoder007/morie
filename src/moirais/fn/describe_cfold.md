...
`print(result)` render. See `moirais.fn.describe('cfold')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfold import *
import numpy as np
# See the function signature in fn/cfold.py for argument names.
```
