...
`print(result)` render. See `moirais.fn.describe('mi_sc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mi_sc import *
import numpy as np
# See the function signature in fn/mi_sc.py for argument names.
```
