...
__all__ = ["hedderich_chapter_9_unnumbered_1223"]


def hedderich_chapter_9_unnumbered_1223(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: πk(1−π)m−k withk =k1 andm =k1 +k2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1223')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1223: CountModels expression (auto-extracted; see ref)."
