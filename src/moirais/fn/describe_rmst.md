...
`print(result)` render. See `moirais.fn.describe('rmst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmst import *
import numpy as np
# See the function signature in fn/rmst.py for argument names.
```
