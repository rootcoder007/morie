...
__all__ = ["hedderich_chapter_9_unnumbered_1340"]


def hedderich_chapter_9_unnumbered_1340(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x0,025 = 40 90% CI : 38 ≤ξ0,025≤41
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1340')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1340: GeneralStatistics expression (auto-extracted; see ref)."
