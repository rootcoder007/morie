...
`print(result)` render. See `moirais.fn.describe('afcntr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afcntr import *
import numpy as np
# See the function signature in fn/afcntr.py for argument names.
```
