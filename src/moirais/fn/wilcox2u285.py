...
__all__ = ["wilcox_chapter_2_unnumbered_285"]


def wilcox_chapter_2_unnumbered_285(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Forα = 0.025, the critical value is now c = 1.96, so power is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u285')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u285: PowerAndDesign expression (auto-extracted; see ref)."
