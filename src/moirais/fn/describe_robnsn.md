...
`print(result)` render. See `moirais.fn.describe('robnsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robnsn import *
import numpy as np
# See the function signature in fn/robnsn.py for argument names.
```
