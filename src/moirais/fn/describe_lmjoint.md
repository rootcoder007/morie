...
`print(result)` render. See `moirais.fn.describe('lmjoint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmjoint import *
import numpy as np
# See the function signature in fn/lmjoint.py for argument names.
```
