# describe('strpp') — stress_per_point
...
`print(result)` render. See `moirais.fn.describe('strpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strpp import *
import numpy as np
# See the function signature in fn/strpp.py for argument names.
```
