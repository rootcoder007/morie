...
`print(result)` render. See `moirais.fn.describe('motfsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.motfsr import *
import numpy as np
# See the function signature in fn/motfsr.py for argument names.
```
