...
`print(result)` render. See `moirais.fn.describe('agric')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agric import *
import numpy as np
# See the function signature in fn/agric.py for argument names.
```
