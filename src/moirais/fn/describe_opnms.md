...
`print(result)` render. See `moirais.fn.describe('opnms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opnms import *
import numpy as np
# See the function signature in fn/opnms.py for argument names.
```
