# describe('msm266') — mvsml_convolutional_nn_eq_14_2
...
`print(result)` render. See `moirais.fn.describe('msm266')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm266 import *
import numpy as np
# See the function signature in fn/msm266.py for argument names.
```
