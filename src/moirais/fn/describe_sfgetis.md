...
`print(result)` render. See `moirais.fn.describe('sfgetis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfgetis import *
import numpy as np
# See the function signature in fn/sfgetis.py for argument names.
```
