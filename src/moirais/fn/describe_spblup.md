# describe('spblup') — schabenberger_blup
...
`print(result)` render. See `moirais.fn.describe('spblup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spblup import *
import numpy as np
# See the function signature in fn/spblup.py for argument names.
```
