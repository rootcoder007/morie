...
`print(result)` render. See `moirais.fn.describe('gdlng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdlng import *
import numpy as np
# See the function signature in fn/gdlng.py for argument names.
```
