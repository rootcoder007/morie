# describe('kmmedu') — kamath_medusa_heads
...
`print(result)` render. See `moirais.fn.describe('kmmedu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmmedu import *
import numpy as np
# See the function signature in fn/kmmedu.py for argument names.
```
