# describe('gb_eqf') — gibbons_emp_quantile
...
`print(result)` render. See `moirais.fn.describe('gb_eqf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_eqf import *
import numpy as np
# See the function signature in fn/gb_eqf.py for argument names.
```
