...
`print(result)` render. See `moirais.fn.describe('hrsde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrsde import *
import numpy as np
# See the function signature in fn/hrsde.py for argument names.
```
