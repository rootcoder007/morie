...
`print(result)` render. See `moirais.fn.describe('rccut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rccut import *
import numpy as np
# See the function signature in fn/rccut.py for argument names.
```
