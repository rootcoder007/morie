...
__all__ = ["hedderich_chapter_9_unnumbered_691"]


def hedderich_chapter_9_unnumbered_691(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 0|λ) = e−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u691')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u691: CountModels expression (auto-extracted; see ref)."
