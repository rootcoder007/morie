# describe('dyirt') — dynamic_irt_estimate
...
`print(result)` render. See `moirais.fn.describe('dyirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dyirt import *
import numpy as np
# See the function signature in fn/dyirt.py for argument names.
```
