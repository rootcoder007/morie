# describe('seirc') — seir_compartmental
...
`print(result)` render. See `moirais.fn.describe('seirc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seirc import *
import numpy as np
# See the function signature in fn/seirc.py for argument names.
```
