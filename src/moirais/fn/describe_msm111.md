# describe('msm111') — mvsml_bayesian_regression_pt2_eq_7_7
...
`print(result)` render. See `moirais.fn.describe('msm111')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm111 import *
import numpy as np
# See the function signature in fn/msm111.py for argument names.
```
