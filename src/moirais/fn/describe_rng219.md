# describe('rng219') — rangayyan_ch4_triangle_inequality_vectors
...
`print(result)` render. See `moirais.fn.describe('rng219')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng219 import *
import numpy as np
# See the function signature in fn/rng219.py for argument names.
```
