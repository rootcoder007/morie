# describe('msm120') — mvsml_bayesian_regression_pt2_eq_7_6
...
`print(result)` render. See `moirais.fn.describe('msm120')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm120 import *
import numpy as np
# See the function signature in fn/msm120.py for argument names.
```
