...
`print(result)` render. See `moirais.fn.describe('pkflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pkflt import *
import numpy as np
# See the function signature in fn/pkflt.py for argument names.
```
