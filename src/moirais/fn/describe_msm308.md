# describe('msm308') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm308')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm308 import *
import numpy as np
# See the function signature in fn/msm308.py for argument names.
```
