# describe('hmigr') — geron_information_gain
...
`print(result)` render. See `moirais.fn.describe('hmigr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmigr import *
import numpy as np
# See the function signature in fn/hmigr.py for argument names.
```
