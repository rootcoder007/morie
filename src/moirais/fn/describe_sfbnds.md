# describe('sfbnds') — sharp_bounds_balke_pearl
...
`print(result)` render. See `moirais.fn.describe('sfbnds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfbnds import *
import numpy as np
# See the function signature in fn/sfbnds.py for argument names.
```
