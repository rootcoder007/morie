...
`print(result)` render. See `moirais.fn.describe('cscir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscir import *
import numpy as np
# See the function signature in fn/cscir.py for argument names.
```
