# describe('augmn') — albert_chib_augmentation
...
`print(result)` render. See `moirais.fn.describe('augmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.augmn import *
import numpy as np
# See the function signature in fn/augmn.py for argument names.
```
