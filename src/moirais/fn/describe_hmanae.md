# describe('hmanae') — geron_anomaly_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmanae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmanae import *
import numpy as np
# See the function signature in fn/hmanae.py for argument names.
```
