# describe('zinfl') — zero_inflated_poisson
...
`print(result)` render. See `moirais.fn.describe('zinfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zinfl import *
import numpy as np
# See the function signature in fn/zinfl.py for argument names.
```
