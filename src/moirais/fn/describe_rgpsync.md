# describe('rgpsync') — rangayyan_pcg_sync_avg
...
`print(result)` render. See `moirais.fn.describe('rgpsync')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpsync import *
import numpy as np
# See the function signature in fn/rgpsync.py for argument names.
```
