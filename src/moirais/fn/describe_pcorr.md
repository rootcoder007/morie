# describe('pcorr') — partial_correlation
...
`print(result)` render. See `moirais.fn.describe('pcorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcorr import *
import numpy as np
# See the function signature in fn/pcorr.py for argument names.
```
