# describe('gb734') — gibbons_linrank_symmetry_cond
...
`print(result)` render. See `moirais.fn.describe('gb734')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb734 import *
import numpy as np
# See the function signature in fn/gb734.py for argument names.
```
