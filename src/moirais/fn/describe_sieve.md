...
`print(result)` render. See `moirais.fn.describe('sieve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sieve import *
import numpy as np
# See the function signature in fn/sieve.py for argument names.
```
