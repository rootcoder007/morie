...
`print(result)` render. See `moirais.fn.describe('irlsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irlsf import *
import numpy as np
# See the function signature in fn/irlsf.py for argument names.
```
