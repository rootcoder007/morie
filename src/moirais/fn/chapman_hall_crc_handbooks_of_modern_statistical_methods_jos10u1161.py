...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1161"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_1161(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Let 0 < α′ ≤ α. We test H′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1161')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u1161: GeneralStatistics expression (auto-extracted; see ref)."
