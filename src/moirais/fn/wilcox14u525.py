...
__all__ = ["wilcox_chapter_14_unnumbered_525"]


def wilcox_chapter_14_unnumbered_525(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n2 = 36, ¯X2 = − 52.1, s2 = 88.4, s2/ √ n2 = 15
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u525')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u525: GeneralStatistics expression (auto-extracted; see ref)."
