...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_369"]


def guide_on_data_analysis_chapter_5_unnumbered_369(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ixi)−1√𝑛(𝑛−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u369')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u369: GeneralStatistics expression (auto-extracted; see ref)."
