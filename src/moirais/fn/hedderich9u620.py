...
__all__ = ["hedderich_chapter_9_unnumbered_620"]


def hedderich_chapter_9_unnumbered_620(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: Binomial distribution: n = 3, p = P (A), i.e. 1−p = P ( ¯A)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u620')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u620: CountModels expression (auto-extracted; see ref)."
