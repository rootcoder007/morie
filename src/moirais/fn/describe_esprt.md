...
`print(result)` render. See `moirais.fn.describe('esprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esprt import *
import numpy as np
# See the function signature in fn/esprt.py for argument names.
```
