# describe('lnfrm') — lognormal_frailty
...
`print(result)` render. See `moirais.fn.describe('lnfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lnfrm import *
import numpy as np
# See the function signature in fn/lnfrm.py for argument names.
```
