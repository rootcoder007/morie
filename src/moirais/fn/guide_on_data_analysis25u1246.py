...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1246"]


def guide_on_data_analysis_chapter_25_unnumbered_1246(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> D = 0.12182, p-value = 0.8351
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1246')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1246: GeneralStatistics expression (auto-extracted; see ref)."
