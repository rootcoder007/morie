...
`print(result)` render. See `moirais.fn.describe('sgcok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcok import *
import numpy as np
# See the function signature in fn/sgcok.py for argument names.
```
