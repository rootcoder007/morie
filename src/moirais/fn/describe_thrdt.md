# describe('thrdt') — threshold_detect
...
`print(result)` render. See `moirais.fn.describe('thrdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thrdt import *
import numpy as np
# See the function signature in fn/thrdt.py for argument names.
```
