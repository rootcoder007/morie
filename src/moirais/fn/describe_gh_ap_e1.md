# describe('gh_ap_e1') — ghosal_bernstein_poly
...
`print(result)` render. See `moirais.fn.describe('gh_ap_e1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_e1 import *
import numpy as np
# See the function signature in fn/gh_ap_e1.py for argument names.
```
