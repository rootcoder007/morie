...
`print(result)` render. See `moirais.fn.describe('deepF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deepF import *
import numpy as np
# See the function signature in fn/deepF.py for argument names.
```
