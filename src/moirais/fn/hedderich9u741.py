...
__all__ = ["hedderich_chapter_9_unnumbered_741"]


def hedderich_chapter_9_unnumbered_741(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: 10−4.597/36|= 1.892, i.e.P = 0.0293.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u741')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u741: CountModels expression (auto-extracted; see ref)."
