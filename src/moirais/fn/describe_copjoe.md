...
`print(result)` render. See `moirais.fn.describe('copjoe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copjoe import *
import numpy as np
# See the function signature in fn/copjoe.py for argument names.
```
