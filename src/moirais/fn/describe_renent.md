...
`print(result)` render. See `moirais.fn.describe('renent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.renent import *
import numpy as np
# See the function signature in fn/renent.py for argument names.
```
