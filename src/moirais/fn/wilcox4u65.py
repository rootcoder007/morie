...
__all__ = ["wilcox_chapter_4_unnumbered_65"]


def wilcox_chapter_4_unnumbered_65(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (2 ≤ X ≤ 8) = 0.989 − 0.011 = 0.978.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u65')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u65: GeneralStatistics expression (auto-extracted; see ref)."
