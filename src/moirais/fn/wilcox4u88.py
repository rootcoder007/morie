...
__all__ = ["wilcox_chapter_4_unnumbered_88"]


def wilcox_chapter_4_unnumbered_88(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: d = 1 − P (Z ≥ c) and then determine c such that
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u88')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u88: GeneralStatistics expression (auto-extracted; see ref)."
