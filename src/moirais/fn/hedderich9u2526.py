...
__all__ = ["hedderich_chapter_9_unnumbered_2526"]


def hedderich_chapter_9_unnumbered_2526(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: k≤10, for example when comparing four treatments with a control, a standard, forα= 0.05 and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2526')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2526: GeneralStatistics expression (auto-extracted; see ref)."
