# describe('rng212') — rangayyan_ch4_matched_filter_instantaneous_signal
...
`print(result)` render. See `moirais.fn.describe('rng212')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng212 import *
import numpy as np
# See the function signature in fn/rng212.py for argument names.
```
