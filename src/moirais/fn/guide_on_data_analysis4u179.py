...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_179"]


def guide_on_data_analysis_chapter_4_unnumbered_179(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • 𝑤𝑚𝑎𝑥 = max(𝑤+, 𝑤−)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u179')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u179: GeneralStatistics expression (auto-extracted; see ref)."
