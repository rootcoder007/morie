...
__all__ = ["hedderich_chapter_9_unnumbered_2277"]


def hedderich_chapter_9_unnumbered_2277(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] well as 7 forn1=n2≥20 (α=0.01).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2277')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2277: GeneralStatistics expression (auto-extracted; see ref)."
