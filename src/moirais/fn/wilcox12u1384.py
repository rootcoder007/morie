...
__all__ = ["wilcox_chapter_12_unnumbered_1384"]


def wilcox_chapter_12_unnumbered_1384(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 8(1/10 + 1 /10) /2 = 8 .94, q = 4.01, reject. (c) W = (20 − 12)/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1384')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1384: GeneralStatistics expression (auto-extracted; see ref)."
