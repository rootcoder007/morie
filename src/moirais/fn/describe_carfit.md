...
`print(result)` render. See `moirais.fn.describe('carfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carfit import *
import numpy as np
# See the function signature in fn/carfit.py for argument names.
```
