# describe('grmlr') — geron_regression_mlp_output
...
`print(result)` render. See `moirais.fn.describe('grmlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmlr import *
import numpy as np
# See the function signature in fn/grmlr.py for argument names.
```
