...
`print(result)` render. See `moirais.fn.describe('bkfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkfit import *
import numpy as np
# See the function signature in fn/bkfit.py for argument names.
```
