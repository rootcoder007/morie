# describe('gb1031') — gibbons_k_ctrl_median
...
`print(result)` render. See `moirais.fn.describe('gb1031')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1031 import *
import numpy as np
# See the function signature in fn/gb1031.py for argument names.
```
