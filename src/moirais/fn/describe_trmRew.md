# describe('trmRew') — term_rewriting
...
`print(result)` render. See `moirais.fn.describe('trmRew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmRew import *
import numpy as np
# See the function signature in fn/trmRew.py for argument names.
```
