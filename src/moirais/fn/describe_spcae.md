...
`print(result)` render. See `moirais.fn.describe('spcae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcae import *
import numpy as np
# See the function signature in fn/spcae.py for argument names.
```
