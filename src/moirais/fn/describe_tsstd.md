...
`print(result)` render. See `moirais.fn.describe('tsstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstd import *
import numpy as np
# See the function signature in fn/tsstd.py for argument names.
```
