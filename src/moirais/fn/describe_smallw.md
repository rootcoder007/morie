# describe('smallw') — small_world_sigma
...
`print(result)` render. See `moirais.fn.describe('smallw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smallw import *
import numpy as np
# See the function signature in fn/smallw.py for argument names.
```
