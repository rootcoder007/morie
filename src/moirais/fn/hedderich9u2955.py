...
__all__ = ["hedderich_chapter_9_unnumbered_2955"]


def hedderich_chapter_9_unnumbered_2955(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: leads to the estimates: ˆπij =nij/n =pij
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2955')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2955: CountModels expression (auto-extracted; see ref)."
