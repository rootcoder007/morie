...
`print(result)` render. See `moirais.fn.describe('kfcvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kfcvl import *
import numpy as np
# See the function signature in fn/kfcvl.py for argument names.
```
