# describe('msm009') — mvsml_overfitting_resampling_eq_4_14
...
`print(result)` render. See `moirais.fn.describe('msm009')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm009 import *
import numpy as np
# See the function signature in fn/msm009.py for argument names.
```
