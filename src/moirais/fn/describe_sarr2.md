...
`print(result)` render. See `moirais.fn.describe('sarr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarr2 import *
import numpy as np
# See the function signature in fn/sarr2.py for argument names.
```
