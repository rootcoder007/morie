...
__all__ = ["hedderich_chapter_9_unnumbered_2678"]


def hedderich_chapter_9_unnumbered_2678(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Three examples of Relative Risk or Odds Ratio for a +b +c +d = 200.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2678')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2678: GeneralStatistics expression (auto-extracted; see ref)."
