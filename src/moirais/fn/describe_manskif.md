# describe('manskif') — manski_bounds
...
`print(result)` render. See `moirais.fn.describe('manskif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manskif import *
import numpy as np
# See the function signature in fn/manskif.py for argument names.
```
