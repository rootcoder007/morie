# describe('rghfd') — rangayyan_higuchi_fd
...
`print(result)` render. See `moirais.fn.describe('rghfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghfd import *
import numpy as np
# See the function signature in fn/rghfd.py for argument names.
```
