# describe('blckw') — snr_degradation
...
`print(result)` render. See `moirais.fn.describe('blckw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blckw import *
import numpy as np
# See the function signature in fn/blckw.py for argument names.
```
