...
`print(result)` render. See `moirais.fn.describe('irteap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irteap import *
import numpy as np
# See the function signature in fn/irteap.py for argument names.
```
