# describe('gh_c4_8') — ghosal_dp_ndist
...
`print(result)` render. See `moirais.fn.describe('gh_c4_8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_8 import *
import numpy as np
# See the function signature in fn/gh_c4_8.py for argument names.
```
