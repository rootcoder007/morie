# describe('lassj') — lasso_objective
...
`print(result)` render. See `moirais.fn.describe('lassj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lassj import *
import numpy as np
# See the function signature in fn/lassj.py for argument names.
```
