# describe('hmlle') — geron_locally_linear_embedding
...
`print(result)` render. See `moirais.fn.describe('hmlle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlle import *
import numpy as np
# See the function signature in fn/hmlle.py for argument names.
```
