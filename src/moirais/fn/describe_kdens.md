...
`print(result)` render. See `moirais.fn.describe('kdens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kdens import *
import numpy as np
# See the function signature in fn/kdens.py for argument names.
```
