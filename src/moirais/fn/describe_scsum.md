...
`print(result)` render. See `moirais.fn.describe('scsum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scsum import *
import numpy as np
# See the function signature in fn/scsum.py for argument names.
```
