# describe('surdrl') — survey_dr_estimator
...
`print(result)` render. See `moirais.fn.describe('surdrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.surdrl import *
import numpy as np
# See the function signature in fn/surdrl.py for argument names.
```
