# describe('rng200') — rangayyan_ch4_continuous_dot_product
...
`print(result)` render. See `moirais.fn.describe('rng200')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng200 import *
import numpy as np
# See the function signature in fn/rng200.py for argument names.
```
