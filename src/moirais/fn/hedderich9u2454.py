...
__all__ = ["hedderich_chapter_9_unnumbered_2454"]


def hedderich_chapter_9_unnumbered_2454(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] i/ni 540.800 + 1134.375 + 1248.200 + 61.250 = 2984.625 = ∑k=4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2454')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2454: GeneralStatistics expression (auto-extracted; see ref)."
