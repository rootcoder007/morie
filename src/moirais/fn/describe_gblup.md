...
`print(result)` render. See `moirais.fn.describe('gblup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gblup import *
import numpy as np
# See the function signature in fn/gblup.py for argument names.
```
