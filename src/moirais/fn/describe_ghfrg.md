...
`print(result)` render. See `moirais.fn.describe('ghfrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghfrg import *
import numpy as np
# See the function signature in fn/ghfrg.py for argument names.
```
