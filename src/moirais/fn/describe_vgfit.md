...
`print(result)` render. See `moirais.fn.describe('vgfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgfit import *
import numpy as np
# See the function signature in fn/vgfit.py for argument names.
```
