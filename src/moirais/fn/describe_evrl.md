# describe('evrl') — evt_return_level
...
`print(result)` render. See `moirais.fn.describe('evrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evrl import *
import numpy as np
# See the function signature in fn/evrl.py for argument names.
```
