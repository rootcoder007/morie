...
`print(result)` render. See `moirais.fn.describe('retlv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.retlv import *
import numpy as np
# See the function signature in fn/retlv.py for argument names.
```
