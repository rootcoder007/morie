...
`print(result)` render. See `moirais.fn.describe('rclag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rclag import *
import numpy as np
# See the function signature in fn/rclag.py for argument names.
```
