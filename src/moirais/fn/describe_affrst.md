...
`print(result)` render. See `moirais.fn.describe('affrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.affrst import *
import numpy as np
# See the function signature in fn/affrst.py for argument names.
```
