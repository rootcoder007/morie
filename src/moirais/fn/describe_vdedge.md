...
`print(result)` render. See `moirais.fn.describe('vdedge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdedge import *
import numpy as np
# See the function signature in fn/vdedge.py for argument names.
```
