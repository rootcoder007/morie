...
`print(result)` render. See `moirais.fn.describe('geagm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geagm import *
import numpy as np
# See the function signature in fn/geagm.py for argument names.
```
