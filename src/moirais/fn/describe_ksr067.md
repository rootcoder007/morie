# describe('ksr067'Confine yourself to the present. — Marcus Aurelius's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('ksr067')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr067 import *
import numpy as np
# See the function signature in fn/ksr067.py for argument names.
```
