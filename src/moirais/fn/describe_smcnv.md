# describe('smcnv') — smacof_convergence
...
`print(result)` render. See `moirais.fn.describe('smcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcnv import *
import numpy as np
# See the function signature in fn/smcnv.py for argument names.
```
