# describe('jhoint') — johansen_trace
...
`print(result)` render. See `moirais.fn.describe('jhoint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jhoint import *
import numpy as np
# See the function signature in fn/jhoint.py for argument names.
```
