...
`print(result)` render. See `moirais.fn.describe('cdfen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdfen import *
import numpy as np
# See the function signature in fn/cdfen.py for argument names.
```
