...
`print(result)` render. See `moirais.fn.describe('icasg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icasg import *
import numpy as np
# See the function signature in fn/icasg.py for argument names.
```
