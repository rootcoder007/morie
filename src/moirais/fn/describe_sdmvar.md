...
`print(result)` render. See `moirais.fn.describe('sdmvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmvar import *
import numpy as np
# See the function signature in fn/sdmvar.py for argument names.
```
