# describe('fzbfkf') — fauzi_bdfree_kdfe_test
...
`print(result)` render. See `moirais.fn.describe('fzbfkf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzbfkf import *
import numpy as np
# See the function signature in fn/fzbfkf.py for argument names.
```
