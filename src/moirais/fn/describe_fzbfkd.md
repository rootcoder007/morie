# describe('fzbfkd') — fauzi_bdfree_kde
...
`print(result)` render. See `moirais.fn.describe('fzbfkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzbfkd import *
import numpy as np
# See the function signature in fn/fzbfkd.py for argument names.
```
