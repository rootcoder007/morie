...
`print(result)` render. See `moirais.fn.describe('cdcol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdcol import *
import numpy as np
# See the function signature in fn/cdcol.py for argument names.
```
