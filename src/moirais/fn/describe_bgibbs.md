...
`print(result)` render. See `moirais.fn.describe('bgibbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgibbs import *
import numpy as np
# See the function signature in fn/bgibbs.py for argument names.
```
