# describe('hrzaqm') — horowitz_additive_quantile
...
`print(result)` render. See `moirais.fn.describe('hrzaqm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzaqm import *
import numpy as np
# See the function signature in fn/hrzaqm.py for argument names.
```
