# describe('chand') — calinski_harabasz
...
`print(result)` render. See `moirais.fn.describe('chand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chand import *
import numpy as np
# See the function signature in fn/chand.py for argument names.
```
