...
__all__ = ["hedderich_chapter_9_unnumbered_670"]


def hedderich_chapter_9_unnumbered_670(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: number of votes for A,Y number of votes for B andZ = n−X−Y number of votes for C.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u670')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u670: GeneralStatistics expression (auto-extracted; see ref)."
