...
`print(result)` render. See `moirais.fn.describe('srgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgam import *
import numpy as np
# See the function signature in fn/srgam.py for argument names.
```
