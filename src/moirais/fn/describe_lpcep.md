# describe('lpcep') — lpc_to_cepstral_fn
...
`print(result)` render. See `moirais.fn.describe('lpcep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpcep import *
import numpy as np
# See the function signature in fn/lpcep.py for argument names.
```
