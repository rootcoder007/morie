...
__all__ = ["wilcox_chapter_14_unnumbered_451"]


def wilcox_chapter_14_unnumbered_451(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑(Yi − ¯Y )2 =r2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u451')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u451: GeneralStatistics expression (auto-extracted; see ref)."
