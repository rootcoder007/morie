# describe('gpsps') — gp_spectral_mixture
...
`print(result)` render. See `moirais.fn.describe('gpsps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpsps import *
import numpy as np
# See the function signature in fn/gpsps.py for argument names.
```
