...
__all__ = ["wilcox_chapter_13_unnumbered_1314"]


def wilcox_chapter_13_unnumbered_1314(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] g(1) = ln {π (1)/[1 − π (1)]}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1314')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1314: Logistic expression (auto-extracted; see ref)."
