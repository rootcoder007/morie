...
`print(result)` render. See `moirais.fn.describe('ppthm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppthm import *
import numpy as np
# See the function signature in fn/ppthm.py for argument names.
```
