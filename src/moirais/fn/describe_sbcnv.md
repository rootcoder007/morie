...
`print(result)` render. See `moirais.fn.describe('sbcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbcnv import *
import numpy as np
# See the function signature in fn/sbcnv.py for argument names.
```
