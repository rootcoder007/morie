...
`print(result)` render. See `moirais.fn.describe('lmrlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmrlag import *
import numpy as np
# See the function signature in fn/lmrlag.py for argument names.
```
