...
__all__ = ["wilcox_chapter_9_unnumbered_1065"]


def wilcox_chapter_9_unnumbered_1065(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Fj(x) = P (Xj1 ≤ x1,...,X jK ≤ xK).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1065')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1065: GeneralStatistics expression (auto-extracted; see ref)."
