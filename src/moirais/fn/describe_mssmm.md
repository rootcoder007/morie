...
`print(result)` render. See `moirais.fn.describe('mssmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssmm import *
import numpy as np
# See the function signature in fn/mssmm.py for argument names.
```
