...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_422"]


def guide_on_data_analysis_chapter_5_unnumbered_422(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸((xt − ￿xt−1)′(𝜖𝑡 − 𝜌𝜖𝑡−1)) = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u422')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u422: GeneralStatistics expression (auto-extracted; see ref)."
