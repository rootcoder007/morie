...
`print(result)` render. See `moirais.fn.describe('hma2c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hma2c import *
import numpy as np
# See the function signature in fn/hma2c.py for argument names.
```
