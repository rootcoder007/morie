...
__all__ = ["wilcox_chapter_10_unnumbered_957"]


def wilcox_chapter_10_unnumbered_957(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] would test both H0 :P (X ≤ 0) = P (Y ≤ 0) and H0 :P (X ≤ 1) = P (Y ≤ 1). The argument
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u957')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u957: GeneralStatistics expression (auto-extracted; see ref)."
