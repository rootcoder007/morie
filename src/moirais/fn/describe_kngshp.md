# describe('kngshp') — kinship_estimator
...
`print(result)` render. See `moirais.fn.describe('kngshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kngshp import *
import numpy as np
# See the function signature in fn/kngshp.py for argument names.
```
