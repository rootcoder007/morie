# describe('zxhrc') — hier_spatial_cross
...
`print(result)` render. See `moirais.fn.describe('zxhrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxhrc import *
import numpy as np
# See the function signature in fn/zxhrc.py for argument names.
```
