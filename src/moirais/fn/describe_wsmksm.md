# describe('wsmksm') — wasserman_ks_test
...
`print(result)` render. See `moirais.fn.describe('wsmksm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmksm import *
import numpy as np
# See the function signature in fn/wsmksm.py for argument names.
```
