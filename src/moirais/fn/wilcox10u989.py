...
__all__ = ["wilcox_chapter_10_unnumbered_989"]


def wilcox_chapter_10_unnumbered_989(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: msmed(x, y = NA, con = 0, alpha = 0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u989')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u989: GeneralStatistics expression (auto-extracted; see ref)."
