# describe('attsdp') — scaled_dot_product_attention
...
`print(result)` render. See `moirais.fn.describe('attsdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attsdp import *
import numpy as np
# See the function signature in fn/attsdp.py for argument names.
```
