...
`print(result)` render. See `moirais.fn.describe('ridgx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ridgx import *
import numpy as np
# See the function signature in fn/ridgx.py for argument names.
```
