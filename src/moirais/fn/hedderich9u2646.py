...
__all__ = ["hedderich_chapter_9_unnumbered_2646"]


def hedderich_chapter_9_unnumbered_2646(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (π1−π2)2 (7.282)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2646')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2646: PowerAndDesign expression (auto-extracted; see ref)."
