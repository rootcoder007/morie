# describe('cmprt') — compliance_rate
...
`print(result)` render. See `moirais.fn.describe('cmprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmprt import *
import numpy as np
# See the function signature in fn/cmprt.py for argument names.
```
