# describe('rgspres') — rangayyan_spectral_resolution
...
`print(result)` render. See `moirais.fn.describe('rgspres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgspres import *
import numpy as np
# See the function signature in fn/rgspres.py for argument names.
```
