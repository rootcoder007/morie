# describe('msm230') — mvsml_ridge_lasso_elastic_eq_9_43
...
`print(result)` render. See `moirais.fn.describe('msm230')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm230 import *
import numpy as np
# See the function signature in fn/msm230.py for argument names.
```
