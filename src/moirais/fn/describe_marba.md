# describe('marba') — ma_smd_var_correlated_designs
...
`print(result)` render. See `moirais.fn.describe('marba')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.marba import *
import numpy as np
# See the function signature in fn/marba.py for argument names.
```
