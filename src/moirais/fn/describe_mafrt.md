# describe('mafrt') — ma_freeman_tukey
...
`print(result)` render. See `moirais.fn.describe('mafrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafrt import *
import numpy as np
# See the function signature in fn/mafrt.py for argument names.
```
