# describe('geagr') — geagr

## WHAT IT DOES

Agriculture GDP spatial
...
`print(result)` render. See `moirais.fn.describe('geagr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geagr import *
import numpy as np
# See the function signature in fn/geagr.py for argument names.
```
