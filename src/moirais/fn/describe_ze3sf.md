...
`print(result)` render. See `moirais.fn.describe('ze3sf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ze3sf import *
import numpy as np
# See the function signature in fn/ze3sf.py for argument names.
```
