# describe('wsmmin') — wasserman_minimax
...
`print(result)` render. See `moirais.fn.describe('wsmmin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmin import *
import numpy as np
# See the function signature in fn/wsmmin.py for argument names.
```
