...
__all__ = ["hedderich_chapter_9_unnumbered_2763"]


def hedderich_chapter_9_unnumbered_2763(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (ˆπ1−ˆπ2)±z1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2763')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2763: GeneralStatistics expression (auto-extracted; see ref)."
