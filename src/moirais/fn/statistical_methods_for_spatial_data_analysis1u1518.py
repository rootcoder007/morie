...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1518(x):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1518')`` for the full guide.
