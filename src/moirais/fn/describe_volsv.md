# describe('volsv') — vol_sv_quasi_lik
...
`print(result)` render. See `moirais.fn.describe('volsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volsv import *
import numpy as np
# See the function signature in fn/volsv.py for argument names.
```
