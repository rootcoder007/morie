...
`print(result)` render. See `moirais.fn.describe('wsmmgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmgf import *
import numpy as np
# See the function signature in fn/wsmmgf.py for argument names.
```
