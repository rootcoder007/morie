...
`print(result)` render. See `moirais.fn.describe('csjrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csjrn import *
import numpy as np
# See the function signature in fn/csjrn.py for argument names.
```
