...
`print(result)` render. See `moirais.fn.describe('plidp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plidp import *
import numpy as np
# See the function signature in fn/plidp.py for argument names.
```
