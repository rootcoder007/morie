# describe('ctde') — controlled_direct_effect
...
`print(result)` render. See `moirais.fn.describe('ctde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctde import *
import numpy as np
# See the function signature in fn/ctde.py for argument names.
```
