...
`print(result)` render. See `moirais.fn.describe('idpfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpfl import *
import numpy as np
# See the function signature in fn/idpfl.py for argument names.
```
