# describe('phacf3') — pharmacophore_3d
...
`print(result)` render. See `moirais.fn.describe('phacf3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phacf3 import *
import numpy as np
# See the function signature in fn/phacf3.py for argument names.
```
