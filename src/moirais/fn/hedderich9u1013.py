...
__all__ = ["hedderich_chapter_9_unnumbered_1013"]


def hedderich_chapter_9_unnumbered_1013(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lnP∗= ln 0.90 + 17.2−15.987
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1013')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1013: GeneralStatistics expression (auto-extracted; see ref)."
