...
__all__ = ["hedderich_chapter_9_unnumbered_2314"]


def hedderich_chapter_9_unnumbered_2314(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] SH =max{j : p(j)≤α/(m−j + 1)}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2314')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2314: GeneralStatistics expression (auto-extracted; see ref)."
