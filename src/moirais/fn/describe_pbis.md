...
`print(result)` render. See `moirais.fn.describe('pbis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pbis import *
import numpy as np
# See the function signature in fn/pbis.py for argument names.
```
