# describe('mtord') — mto_road_segment
...
`print(result)` render. See `moirais.fn.describe('mtord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtord import *
import numpy as np
# See the function signature in fn/mtord.py for argument names.
```
