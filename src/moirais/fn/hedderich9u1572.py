...
__all__ = ["hedderich_chapter_9_unnumbered_1572"]


def hedderich_chapter_9_unnumbered_1572(x):
    """
    Bayesian expression (auto-extracted; see ref).

    Formula: [EQ] + while ( j > i & done == FALSE ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1572')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1572: Bayesian expression (auto-extracted; see ref)."
