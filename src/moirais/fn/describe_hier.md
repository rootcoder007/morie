...
`print(result)` render. See `moirais.fn.describe('hier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hier import *
import numpy as np
# See the function signature in fn/hier.py for argument names.
```
