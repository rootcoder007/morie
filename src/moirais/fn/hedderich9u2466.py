...
__all__ = ["hedderich_chapter_9_unnumbered_2466"]


def hedderich_chapter_9_unnumbered_2466(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: according to S. Siegel and N.J. Castellan [SC88]) , the quantilez1−α/k(k−1) is used here:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2466')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2466: GeneralStatistics expression (auto-extracted; see ref)."
