...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_66"]


def guide_on_data_analysis_chapter_2_unnumbered_66(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] rhyper(1000, m = 50, n = 20, k = 30),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u66')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u66: GeneralStatistics expression (auto-extracted; see ref)."
