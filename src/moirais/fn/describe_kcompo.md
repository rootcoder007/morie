# describe('kcompo') — k_step_dp_composition
...
`print(result)` render. See `moirais.fn.describe('kcompo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kcompo import *
import numpy as np
# See the function signature in fn/kcompo.py for argument names.
```
