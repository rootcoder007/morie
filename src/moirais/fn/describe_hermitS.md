# describe('hermitS') — hermite_basis
...
`print(result)` render. See `moirais.fn.describe('hermitS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hermitS import *
import numpy as np
# See the function signature in fn/hermitS.py for argument names.
```
