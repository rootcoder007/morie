...
`print(result)` render. See `moirais.fn.describe('wlmcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlmcp import *
import numpy as np
# See the function signature in fn/wlmcp.py for argument names.
```
