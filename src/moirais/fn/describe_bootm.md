...
`print(result)` render. See `moirais.fn.describe('bootm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bootm import *
import numpy as np
# See the function signature in fn/bootm.py for argument names.
```
