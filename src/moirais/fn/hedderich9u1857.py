...
__all__ = ["hedderich_chapter_9_unnumbered_1857"]


def hedderich_chapter_9_unnumbered_1857(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 7;0.95,H0 :σ2 =σ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1857')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1857: GeneralStatistics expression (auto-extracted; see ref)."
