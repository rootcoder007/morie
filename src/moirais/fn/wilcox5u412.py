...
__all__ = ["wilcox_chapter_5_unnumbered_412"]


def wilcox_chapter_5_unnumbered_412(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u412')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u412: GeneralStatistics expression (auto-extracted; see ref)."
