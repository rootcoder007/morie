# describe('gb1151') — gibbons_blomqvist_q
...
`print(result)` render. See `moirais.fn.describe('gb1151')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1151 import *
import numpy as np
# See the function signature in fn/gb1151.py for argument names.
```
