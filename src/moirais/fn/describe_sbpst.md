# describe('sbpst') — stick_breaking_post
...
`print(result)` render. See `moirais.fn.describe('sbpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbpst import *
import numpy as np
# See the function signature in fn/sbpst.py for argument names.
```
