...
`print(result)` render. See `moirais.fn.describe('gdhhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdhhs import *
import numpy as np
# See the function signature in fn/gdhhs.py for argument names.
```
