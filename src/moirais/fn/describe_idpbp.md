...
`print(result)` render. See `moirais.fn.describe('idpbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpbp import *
import numpy as np
# See the function signature in fn/idpbp.py for argument names.
```
