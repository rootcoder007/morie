...
__all__ = ["bivand2013_chapter_7_unnumbered_123"]


def bivand2013_chapter_7_unnumbered_123(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆKI, ˆλ(s)= |A|−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u123')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u123: GeneralStatistics expression (auto-extracted; see ref)."
