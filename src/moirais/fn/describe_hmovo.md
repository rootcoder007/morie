# describe('hmovo') — geron_one_vs_one
...
`print(result)` render. See `moirais.fn.describe('hmovo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmovo import *
import numpy as np
# See the function signature in fn/hmovo.py for argument names.
```
