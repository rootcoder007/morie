# describe('rng083') — rangayyan_ch3_even_odd_decomposition
...
`print(result)` render. See `moirais.fn.describe('rng083')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng083 import *
import numpy as np
# See the function signature in fn/rng083.py for argument names.
```
