...
`print(result)` render. See `moirais.fn.describe('simdk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simdk import *
import numpy as np
# See the function signature in fn/simdk.py for argument names.
```
