# describe('rgztf') — rangayyan_z_transform
...
`print(result)` render. See `moirais.fn.describe('rgztf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgztf import *
import numpy as np
# See the function signature in fn/rgztf.py for argument names.
```
