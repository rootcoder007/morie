...
`print(result)` render. See `moirais.fn.describe('hmbert')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbert import *
import numpy as np
# See the function signature in fn/hmbert.py for argument names.
```
