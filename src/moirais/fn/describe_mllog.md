# describe('mllog') — ml_log_likelihood_regression
...
`print(result)` render. See `moirais.fn.describe('mllog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mllog import *
import numpy as np
# See the function signature in fn/mllog.py for argument names.
```
