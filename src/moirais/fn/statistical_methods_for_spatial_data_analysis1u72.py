...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_72"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_72(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u72')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u72: GeneralStatistics expression (auto-extracted; see ref)."
