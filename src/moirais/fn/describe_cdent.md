# describe('cdent') — conditional_entropy
...
`print(result)` render. See `moirais.fn.describe('cdent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdent import *
import numpy as np
# See the function signature in fn/cdent.py for argument names.
```
