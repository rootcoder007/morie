...
`print(result)` render. See `moirais.fn.describe('machla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.machla import *
import numpy as np
# See the function signature in fn/machla.py for argument names.
```
