...
`print(result)` render. See `moirais.fn.describe('glmmre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmre import *
import numpy as np
# See the function signature in fn/glmmre.py for argument names.
```
