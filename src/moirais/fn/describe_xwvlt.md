...
`print(result)` render. See `moirais.fn.describe('xwvlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xwvlt import *
import numpy as np
# See the function signature in fn/xwvlt.py for argument names.
```
