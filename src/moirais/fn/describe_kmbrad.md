# describe('kmbrad') — kamath_bradley_terry_preference
...
`print(result)` render. See `moirais.fn.describe('kmbrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbrad import *
import numpy as np
# See the function signature in fn/kmbrad.py for argument names.
```
