# describe('sppois') — schabenberger_poisson_process
...
`print(result)` render. See `moirais.fn.describe('sppois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppois import *
import numpy as np
# See the function signature in fn/sppois.py for argument names.
```
