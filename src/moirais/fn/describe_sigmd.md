...
`print(result)` render. See `moirais.fn.describe('sigmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sigmd import *
import numpy as np
# See the function signature in fn/sigmd.py for argument names.
```
