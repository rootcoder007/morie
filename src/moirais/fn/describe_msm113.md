# describe('msm113') — mvsml_bayesian_regression_pt2_eq_7_9
...
`print(result)` render. See `moirais.fn.describe('msm113')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm113 import *
import numpy as np
# See the function signature in fn/msm113.py for argument names.
```
