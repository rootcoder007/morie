# describe('msm206') — mvsml_ridge_lasso_elastic_eq_9_28
...
`print(result)` render. See `moirais.fn.describe('msm206')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm206 import *
import numpy as np
# See the function signature in fn/msm206.py for argument names.
```
