# describe('samdec') — sam_mask_decoder
...
`print(result)` render. See `moirais.fn.describe('samdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samdec import *
import numpy as np
# See the function signature in fn/samdec.py for argument names.
```
