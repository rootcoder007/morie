# describe('tqmsb') — turboquant_mse_distortion_bound
...
`print(result)` render. See `moirais.fn.describe('tqmsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqmsb import *
import numpy as np
# See the function signature in fn/tqmsb.py for argument names.
```
