# describe('r0bayse') — basic_reproduction
...
`print(result)` render. See `moirais.fn.describe('r0bayse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r0bayse import *
import numpy as np
# See the function signature in fn/r0bayse.py for argument names.
```
