...
`print(result)` render. See `moirais.fn.describe('ulrnir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ulrnir import *
import numpy as np
# See the function signature in fn/ulrnir.py for argument names.
```
