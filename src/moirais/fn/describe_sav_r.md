# describe('sav_r') — subscale_er_ave
...
`print(result)` render. See `moirais.fn.describe('sav_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sav_r import *
import numpy as np
# See the function signature in fn/sav_r.py for argument names.
```
