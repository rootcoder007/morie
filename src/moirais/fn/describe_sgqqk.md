# describe('sgqqk') — qq_plot_kriging
...
`print(result)` render. See `moirais.fn.describe('sgqqk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgqqk import *
import numpy as np
# See the function signature in fn/sgqqk.py for argument names.
```
