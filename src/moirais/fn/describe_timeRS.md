...
`print(result)` render. See `moirais.fn.describe('timeRS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.timeRS import *
import numpy as np
# See the function signature in fn/timeRS.py for argument names.
```
