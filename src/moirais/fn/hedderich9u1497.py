...
__all__ = ["hedderich_chapter_9_unnumbered_1497"]


def hedderich_chapter_9_unnumbered_1497(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( t ==1 | t ==2) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1497')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1497: GeneralStatistics expression (auto-extracted; see ref)."
