# describe('ghs019') — ghosal_ch3_tree_set_probability
...
`print(result)` render. See `moirais.fn.describe('ghs019')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs019 import *
import numpy as np
# See the function signature in fn/ghs019.py for argument names.
```
