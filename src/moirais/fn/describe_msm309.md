# describe('msm309') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm309')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm309 import *
import numpy as np
# See the function signature in fn/msm309.py for argument names.
```
