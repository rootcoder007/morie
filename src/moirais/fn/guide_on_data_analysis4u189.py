...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_189"]


def guide_on_data_analysis_chapter_4_unnumbered_189(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑍 = ̄ 𝑦 − ̄ 𝑥 − (𝜇𝑦 − 𝜇𝑥)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u189')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u189: GeneralStatistics expression (auto-extracted; see ref)."
