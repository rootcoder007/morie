# describe('bkprp') — backpropagation
...
`print(result)` render. See `moirais.fn.describe('bkprp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkprp import *
import numpy as np
# See the function signature in fn/bkprp.py for argument names.
```
