# describe('icc2k') — icc_two_way_random_avg
...
`print(result)` render. See `moirais.fn.describe('icc2k')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc2k import *
import numpy as np
# See the function signature in fn/icc2k.py for argument names.
```
