...
`print(result)` render. See `moirais.fn.describe('legpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.legpb import *
import numpy as np
# See the function signature in fn/legpb.py for argument names.
```
