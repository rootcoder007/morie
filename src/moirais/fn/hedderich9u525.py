...
__all__ = ["hedderich_chapter_9_unnumbered_525"]


def hedderich_chapter_9_unnumbered_525(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (a<X<b ) =P (X<b )−P (X≤a) P (a<X≤b) =P (X≤b)−P (X≤a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u525')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u525: GeneralStatistics expression (auto-extracted; see ref)."
