...
`print(result)` render. See `moirais.fn.describe('spmxd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmxd import *
import numpy as np
# See the function signature in fn/spmxd.py for argument names.
```
