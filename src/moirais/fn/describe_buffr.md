...
`print(result)` render. See `moirais.fn.describe('buffr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.buffr import *
import numpy as np
# See the function signature in fn/buffr.py for argument names.
```
