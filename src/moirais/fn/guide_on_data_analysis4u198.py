...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_198"]


def guide_on_data_analysis_chapter_4_unnumbered_198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑡 = ̄ 𝑦 − ̄ 𝑥 − 𝛿0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u198')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u198: GeneralStatistics expression (auto-extracted; see ref)."
