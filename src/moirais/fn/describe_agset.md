...
`print(result)` render. See `moirais.fn.describe('agset')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agset import *
import numpy as np
# See the function signature in fn/agset.py for argument names.
```
