...
`print(result)` render. See `moirais.fn.describe('rey_mx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_mx import *
import numpy as np
# See the function signature in fn/rey_mx.py for argument names.
```
