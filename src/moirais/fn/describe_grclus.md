# describe('grclus') — graph_clustering
...
`print(result)` render. See `moirais.fn.describe('grclus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grclus import *
import numpy as np
# See the function signature in fn/grclus.py for argument names.
```
