# describe('emcnv') — em_convergence_check
...
`print(result)` render. See `moirais.fn.describe('emcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emcnv import *
import numpy as np
# See the function signature in fn/emcnv.py for argument names.
```
