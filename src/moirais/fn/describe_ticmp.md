# describe('ticmp') — total_information_content
...
`print(result)` render. See `moirais.fn.describe('ticmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ticmp import *
import numpy as np
# See the function signature in fn/ticmp.py for argument names.
```
