...
`print(result)` render. See `moirais.fn.describe('manht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manht import *
import numpy as np
# See the function signature in fn/manht.py for argument names.
```
