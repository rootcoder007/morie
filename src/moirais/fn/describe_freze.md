...
`print(result)` render. See `moirais.fn.describe('freze')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.freze import *
import numpy as np
# See the function signature in fn/freze.py for argument names.
```
