# describe('hmnpl') — geron_neurons_per_layer
...
`print(result)` render. See `moirais.fn.describe('hmnpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnpl import *
import numpy as np
# See the function signature in fn/hmnpl.py for argument names.
```
