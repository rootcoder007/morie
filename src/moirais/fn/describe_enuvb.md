...
`print(result)` render. See `moirais.fn.describe('enuvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enuvb import *
import numpy as np
# See the function signature in fn/enuvb.py for argument names.
```
