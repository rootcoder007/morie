...
`print(result)` render. See `moirais.fn.describe('km126')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km126 import *
import numpy as np
# See the function signature in fn/km126.py for argument names.
```
