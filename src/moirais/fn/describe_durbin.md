...
`print(result)` render. See `moirais.fn.describe('durbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.durbin import *
import numpy as np
# See the function signature in fn/durbin.py for argument names.
```
