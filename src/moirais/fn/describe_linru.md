...
`print(result)` render. See `moirais.fn.describe('linru')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linru import *
import numpy as np
# See the function signature in fn/linru.py for argument names.
```
