# describe('gb1231') — gibbons_page_test
...
`print(result)` render. See `moirais.fn.describe('gb1231')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1231 import *
import numpy as np
# See the function signature in fn/gb1231.py for argument names.
```
