...
`print(result)` render. See `moirais.fn.describe('nmwn2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwn2 import *
import numpy as np
# See the function signature in fn/nmwn2.py for argument names.
```
