...
__all__ = ["hedderich_chapter_9_unnumbered_1953"]


def hedderich_chapter_9_unnumbered_1953(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + alpha = 0 . 0 5 , alternative =" one − sided " ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1953')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1953: PowerAndDesign expression (auto-extracted; see ref)."
