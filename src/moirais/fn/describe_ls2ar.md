...
`print(result)` render. See `moirais.fn.describe('ls2ar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ls2ar import *
import numpy as np
# See the function signature in fn/ls2ar.py for argument names.
```
