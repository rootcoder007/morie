...
`print(result)` render. See `moirais.fn.describe('idwmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwmod import *
import numpy as np
# See the function signature in fn/idwmod.py for argument names.
```
