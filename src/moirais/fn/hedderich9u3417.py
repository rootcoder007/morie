...
__all__ = ["hedderich_chapter_9_unnumbered_3417"]


def hedderich_chapter_9_unnumbered_3417(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The deviance is asymptoticallyχ2-distributed withν=n−p−1 degrees of freedom. It can also
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3417')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3417: GeneralStatistics expression (auto-extracted; see ref)."
