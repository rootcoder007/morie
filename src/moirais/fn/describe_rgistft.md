# describe('rgistft') — rangayyan_istft
...
`print(result)` render. See `moirais.fn.describe('rgistft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgistft import *
import numpy as np
# See the function signature in fn/rgistft.py for argument names.
```
