...
`print(result)` render. See `moirais.fn.describe('swstoch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swstoch import *
import numpy as np
# See the function signature in fn/swstoch.py for argument names.
```
