...
`print(result)` render. See `moirais.fn.describe('dkupd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkupd import *
import numpy as np
# See the function signature in fn/dkupd.py for argument names.
```
