# describe('gb_wcin') — gibbons_concordance_incomplete
...
`print(result)` render. See `moirais.fn.describe('gb_wcin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wcin import *
import numpy as np
# See the function signature in fn/gb_wcin.py for argument names.
```
