# describe('hewtp') — willingness_to_pay
...
`print(result)` render. See `moirais.fn.describe('hewtp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hewtp import *
import numpy as np
# See the function signature in fn/hewtp.py for argument names.
```
