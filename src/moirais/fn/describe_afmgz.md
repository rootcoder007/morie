...
`print(result)` render. See `moirais.fn.describe('afmgz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afmgz import *
import numpy as np
# See the function signature in fn/afmgz.py for argument names.
```
