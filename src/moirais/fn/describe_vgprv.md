# describe('vgprv') — pairwise_rel_vario
...
`print(result)` render. See `moirais.fn.describe('vgprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgprv import *
import numpy as np
# See the function signature in fn/vgprv.py for argument names.
```
