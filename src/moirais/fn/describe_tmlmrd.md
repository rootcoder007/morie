# describe('tmlmrd') — tmle_marginal_rd

## WHAT IT DOES

TMLE for marginal risk difference.
...
`print(result)` render. See `moirais.fn.describe('tmlmrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmrd import *
import numpy as np
# See the function signature in fn/tmlmrd.py for argument names.
```
