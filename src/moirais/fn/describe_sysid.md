# describe('sysid') — system_identify_fn
...
`print(result)` render. See `moirais.fn.describe('sysid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sysid import *
import numpy as np
# See the function signature in fn/sysid.py for argument names.
```
