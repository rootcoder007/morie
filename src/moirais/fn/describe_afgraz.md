...
`print(result)` render. See `moirais.fn.describe('afgraz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afgraz import *
import numpy as np
# See the function signature in fn/afgraz.py for argument names.
```
