...
`print(result)` render. See `moirais.fn.describe('xricar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xricar import *
import numpy as np
# See the function signature in fn/xricar.py for argument names.
```
