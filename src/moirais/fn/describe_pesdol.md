# describe('pesdol') — pesaran_shin_dols
...
`print(result)` render. See `moirais.fn.describe('pesdol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pesdol import *
import numpy as np
# See the function signature in fn/pesdol.py for argument names.
```
