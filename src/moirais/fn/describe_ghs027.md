# describe('ghs027') — ghosal_ch3_tailfree_strong_support_event
...
`print(result)` render. See `moirais.fn.describe('ghs027')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs027 import *
import numpy as np
# See the function signature in fn/ghs027.py for argument names.
```
