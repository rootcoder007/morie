...
`print(result)` render. See `moirais.fn.describe('kswin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kswin import *
import numpy as np
# See the function signature in fn/kswin.py for argument names.
```
