...
__all__ = ["wilcox_chapter_14_unnumbered_762"]


def wilcox_chapter_14_unnumbered_762(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Decision Rule: Reject if F ≥ f , where f is the 1 − α quantile
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u762')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u762: GeneralStatistics expression (auto-extracted; see ref)."
