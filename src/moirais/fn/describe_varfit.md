...
`print(result)` render. See `moirais.fn.describe('varfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varfit import *
import numpy as np
# See the function signature in fn/varfit.py for argument names.
```
