...
`print(result)` render. See `moirais.fn.describe('tsmgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsmgw import *
import numpy as np
# See the function signature in fn/tsmgw.py for argument names.
```
