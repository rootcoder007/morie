# describe('wsmwhz') — wasserman_white_huber
...
`print(result)` render. See `moirais.fn.describe('wsmwhz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmwhz import *
import numpy as np
# See the function signature in fn/wsmwhz.py for argument names.
```
