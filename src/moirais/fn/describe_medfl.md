...
`print(result)` render. See `moirais.fn.describe('medfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medfl import *
import numpy as np
# See the function signature in fn/medfl.py for argument names.
```
