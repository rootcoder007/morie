# describe('pwexp') — piecewise_exponential
...
`print(result)` render. See `moirais.fn.describe('pwexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwexp import *
import numpy as np
# See the function signature in fn/pwexp.py for argument names.
```
