# describe('cbnrt') — causalbert_text
...
`print(result)` render. See `moirais.fn.describe('cbnrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cbnrt import *
import numpy as np
# See the function signature in fn/cbnrt.py for argument names.
```
