# describe('jomimi') — joseph_missing_data_imputation_ts
...
`print(result)` render. See `moirais.fn.describe('jomimi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jomimi import *
import numpy as np
# See the function signature in fn/jomimi.py for argument names.
```
