# describe('bndcvr') — bound_coverage_check
...
`print(result)` render. See `moirais.fn.describe('bndcvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndcvr import *
import numpy as np
# See the function signature in fn/bndcvr.py for argument names.
```
