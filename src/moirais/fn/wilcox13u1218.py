...
__all__ = ["wilcox_chapter_13_unnumbered_1218"]


def wilcox_chapter_13_unnumbered_1218(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: FALSE, outfun = out, iran = 0.05, xlab = "X", ylab = "Y", pch = "." )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1218')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1218: GeneralStatistics expression (auto-extracted; see ref)."
