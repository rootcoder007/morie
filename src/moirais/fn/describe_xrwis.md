...
`print(result)` render. See `moirais.fn.describe('xrwis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwis import *
import numpy as np
# See the function signature in fn/xrwis.py for argument names.
```
