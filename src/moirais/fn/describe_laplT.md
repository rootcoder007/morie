# describe('laplT') — laplace_transform
...
`print(result)` render. See `moirais.fn.describe('laplT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laplT import *
import numpy as np
# See the function signature in fn/laplT.py for argument names.
```
