# describe('bdmnto') — bound_monot_outcome
...
`print(result)` render. See `moirais.fn.describe('bdmnto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdmnto import *
import numpy as np
# See the function signature in fn/bdmnto.py for argument names.
```
