...
`print(result)` render. See `moirais.fn.describe('saldi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saldi import *
import numpy as np
# See the function signature in fn/saldi.py for argument names.
```
