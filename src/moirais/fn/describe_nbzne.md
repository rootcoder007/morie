...
`print(result)` render. See `moirais.fn.describe('nbzne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbzne import *
import numpy as np
# See the function signature in fn/nbzne.py for argument names.
```
