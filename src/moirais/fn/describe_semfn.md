# describe('semfn') — spectral_error_fn
...
`print(result)` render. See `moirais.fn.describe('semfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semfn import *
import numpy as np
# See the function signature in fn/semfn.py for argument names.
```
