...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_390"]


def guide_on_data_analysis_chapter_5_unnumbered_390(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Condition_Indices = condition_indices
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u390')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u390: GeneralStatistics expression (auto-extracted; see ref)."
