# describe('grovo') — geron_one_vs_one
...
`print(result)` render. See `moirais.fn.describe('grovo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grovo import *
import numpy as np
# See the function signature in fn/grovo.py for argument names.
```
