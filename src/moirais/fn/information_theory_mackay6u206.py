...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_206"]


def information_theory_mackay_chapter_6_unnumbered_206(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u206')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u206: GeneralStatistics expression (auto-extracted; see ref)."
