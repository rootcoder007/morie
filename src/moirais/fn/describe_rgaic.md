# describe('rgaic') — rangayyan_ar_order_aic
...
`print(result)` render. See `moirais.fn.describe('rgaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgaic import *
import numpy as np
# See the function signature in fn/rgaic.py for argument names.
```
