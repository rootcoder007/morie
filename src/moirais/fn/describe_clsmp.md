...
`print(result)` render. See `moirais.fn.describe('clsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clsmp import *
import numpy as np
# See the function signature in fn/clsmp.py for argument names.
```
