# describe('spcoef') — spearmans_rho_copula
...
`print(result)` render. See `moirais.fn.describe('spcoef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcoef import *
import numpy as np
# See the function signature in fn/spcoef.py for argument names.
```
