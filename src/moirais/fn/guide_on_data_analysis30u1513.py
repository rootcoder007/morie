...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1513"]


def guide_on_data_analysis_chapter_30_unnumbered_1513(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -2 x cohort = 8 0.43 (0.31)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1513')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1513: GeneralStatistics expression (auto-extracted; see ref)."
