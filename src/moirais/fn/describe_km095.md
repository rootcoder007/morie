# describe('km095') — kamath_ch6_gender_direction
...
`print(result)` render. See `moirais.fn.describe('km095')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km095 import *
import numpy as np
# See the function signature in fn/km095.py for argument names.
```
