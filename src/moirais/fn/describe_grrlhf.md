# describe('grrlhf') — geron_rlhf_reward_kl_objective
...
`print(result)` render. See `moirais.fn.describe('grrlhf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrlhf import *
import numpy as np
# See the function signature in fn/grrlhf.py for argument names.
```
