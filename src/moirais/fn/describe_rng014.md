# describe('rng014') — rangayyan_ch3_variance_of_sum_uncorrelated
...
`print(result)` render. See `moirais.fn.describe('rng014')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng014 import *
import numpy as np
# See the function signature in fn/rng014.py for argument names.
```
