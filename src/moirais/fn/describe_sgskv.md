# describe('sgskv') — simple_kriging_variance
...
`print(result)` render. See `moirais.fn.describe('sgskv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgskv import *
import numpy as np
# See the function signature in fn/sgskv.py for argument names.
```
