...
`print(result)` render. See `moirais.fn.describe('svcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcls import *
import numpy as np
# See the function signature in fn/svcls.py for argument names.
```
