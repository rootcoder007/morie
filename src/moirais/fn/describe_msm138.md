# describe('msm138') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm138')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm138 import *
import numpy as np
# See the function signature in fn/msm138.py for argument names.
```
