# describe('propc') — prophet_components
...
`print(result)` render. See `moirais.fn.describe('propc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propc import *
import numpy as np
# See the function signature in fn/propc.py for argument names.
```
