...
`print(result)` render. See `moirais.fn.describe('ppitb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppitb import *
import numpy as np
# See the function signature in fn/ppitb.py for argument names.
```
