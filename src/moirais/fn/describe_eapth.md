# describe('eapth') — eap_theta_estimator
...
`print(result)` render. See `moirais.fn.describe('eapth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eapth import *
import numpy as np
# See the function signature in fn/eapth.py for argument names.
```
