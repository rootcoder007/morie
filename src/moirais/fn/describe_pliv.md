...
`print(result)` render. See `moirais.fn.describe('pliv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pliv import *
import numpy as np
# See the function signature in fn/pliv.py for argument names.
```
