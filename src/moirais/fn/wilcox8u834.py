...
__all__ = ["wilcox_chapter_8_unnumbered_834"]


def wilcox_chapter_8_unnumbered_834(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u834')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u834: GeneralStatistics expression (auto-extracted; see ref)."
