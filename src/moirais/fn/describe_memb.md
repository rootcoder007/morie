# describe('memb') — membership_inference
...
`print(result)` render. See `moirais.fn.describe('memb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.memb import *
import numpy as np
# See the function signature in fn/memb.py for argument names.
```
