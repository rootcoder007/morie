...
`print(result)` render. See `moirais.fn.describe('alprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alprv import *
import numpy as np
# See the function signature in fn/alprv.py for argument names.
```
