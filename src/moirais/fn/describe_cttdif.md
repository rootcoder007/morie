# describe('cttdif') — ctt_difficulty
...
`print(result)` render. See `moirais.fn.describe('cttdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cttdif import *
import numpy as np
# See the function signature in fn/cttdif.py for argument names.
```
