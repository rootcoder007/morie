# describe('drvst') — dr_did_variance_stab
...
`print(result)` render. See `moirais.fn.describe('drvst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drvst import *
import numpy as np
# See the function signature in fn/drvst.py for argument names.
```
