...
__all__ = ["hedderich_chapter_9_unnumbered_3198"]


def hedderich_chapter_9_unnumbered_3198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: βyx≤0 βyx > 0 ˆt =byx/sbyx≥tn−2;1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3198')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3198: GeneralStatistics expression (auto-extracted; see ref)."
