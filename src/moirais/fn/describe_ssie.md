# describe('ssie') — sample_size_equivalence
...
`print(result)` render. See `moirais.fn.describe('ssie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssie import *
import numpy as np
# See the function signature in fn/ssie.py for argument names.
```
