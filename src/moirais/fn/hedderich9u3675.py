...
__all__ = ["hedderich_chapter_9_unnumbered_3675"]


def hedderich_chapter_9_unnumbered_3675(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : µ1 =µ2 =...=µk . . . . . . . . .612
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3675')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3675: GeneralStatistics expression (auto-extracted; see ref)."
