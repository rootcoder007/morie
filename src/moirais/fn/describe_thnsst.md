# describe('thnsst') — thiessen_polygons
...
`print(result)` render. See `moirais.fn.describe('thnsst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thnsst import *
import numpy as np
# See the function signature in fn/thnsst.py for argument names.
```
