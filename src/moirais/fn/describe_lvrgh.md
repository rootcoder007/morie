# describe('lvrgh') — hat_matrix_diagonal
...
`print(result)` render. See `moirais.fn.describe('lvrgh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvrgh import *
import numpy as np
# See the function signature in fn/lvrgh.py for argument names.
```
