# describe('insprt') — inspection_score
...
`print(result)` render. See `moirais.fn.describe('insprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.insprt import *
import numpy as np
# See the function signature in fn/insprt.py for argument names.
```
