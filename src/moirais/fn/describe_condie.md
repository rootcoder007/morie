# describe('condie') — conditional_indirect_effect
...
`print(result)` render. See `moirais.fn.describe('condie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.condie import *
import numpy as np
# See the function signature in fn/condie.py for argument names.
```
