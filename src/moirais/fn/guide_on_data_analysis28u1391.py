...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1391"]


def guide_on_data_analysis_chapter_28_unnumbered_1391(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: abline(v=T_star, lwd=2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1391')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1391: GeneralStatistics expression (auto-extracted; see ref)."
