# describe('eslvbt') — esl_var_beta_hat
...
`print(result)` render. See `moirais.fn.describe('eslvbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslvbt import *
import numpy as np
# See the function signature in fn/eslvbt.py for argument names.
```
