# describe('chwfst') — chow_forecast_test
...
`print(result)` render. See `moirais.fn.describe('chwfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chwfst import *
import numpy as np
# See the function signature in fn/chwfst.py for argument names.
```
