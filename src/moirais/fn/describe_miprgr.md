# describe('miprgr') — mip_branch_bound
...
`print(result)` render. See `moirais.fn.describe('miprgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miprgr import *
import numpy as np
# See the function signature in fn/miprgr.py for argument names.
```
