# describe('msm163') — mvsml_ridge_lasso_elastic_eq_9_1
...
`print(result)` render. See `moirais.fn.describe('msm163')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm163 import *
import numpy as np
# See the function signature in fn/msm163.py for argument names.
```
