...
`print(result)` render. See `moirais.fn.describe('afndv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afndv import *
import numpy as np
# See the function signature in fn/afndv.py for argument names.
```
