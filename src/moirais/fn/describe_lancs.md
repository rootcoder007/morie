...
`print(result)` render. See `moirais.fn.describe('lancs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lancs import *
import numpy as np
# See the function signature in fn/lancs.py for argument names.
```
