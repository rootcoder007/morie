...
__all__ = ["hedderich_chapter_9_unnumbered_2664"]


def hedderich_chapter_9_unnumbered_2664(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: π1−π2 0.5 0.3 0.1 0.1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2664')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2664: GeneralStatistics expression (auto-extracted; see ref)."
