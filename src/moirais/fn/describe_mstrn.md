# describe('mstrn') — multistate_transition_matrix
...
`print(result)` render. See `moirais.fn.describe('mstrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstrn import *
import numpy as np
# See the function signature in fn/mstrn.py for argument names.
```
