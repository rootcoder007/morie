...
`print(result)` render. See `moirais.fn.describe('clval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clval import *
import numpy as np
# See the function signature in fn/clval.py for argument names.
```
