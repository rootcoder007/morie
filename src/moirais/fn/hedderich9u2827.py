...
__all__ = ["hedderich_chapter_9_unnumbered_2827"]


def hedderich_chapter_9_unnumbered_2827(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] M H = 7.898 > 3.841 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2827')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2827: GeneralStatistics expression (auto-extracted; see ref)."
