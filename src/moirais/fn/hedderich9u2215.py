...
__all__ = ["hedderich_chapter_9_unnumbered_2215"]


def hedderich_chapter_9_unnumbered_2215(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n(W#) = (z1−α +z1−β)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2215')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2215: PowerAndDesign expression (auto-extracted; see ref)."
