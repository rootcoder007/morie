# describe('grnorm') — geron_normal_equation
...
`print(result)` render. See `moirais.fn.describe('grnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnorm import *
import numpy as np
# See the function signature in fn/grnorm.py for argument names.
```
