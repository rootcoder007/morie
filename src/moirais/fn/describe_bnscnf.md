# describe('bnscnf') — bound_confidence_set
...
`print(result)` render. See `moirais.fn.describe('bnscnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnscnf import *
import numpy as np
# See the function signature in fn/bnscnf.py for argument names.
```
