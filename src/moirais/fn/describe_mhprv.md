# describe('mhprv') — mental_health_prevalence
...
`print(result)` render. See `moirais.fn.describe('mhprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhprv import *
import numpy as np
# See the function signature in fn/mhprv.py for argument names.
```
