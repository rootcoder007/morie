...
`print(result)` render. See `moirais.fn.describe('bpsst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpsst import *
import numpy as np
# See the function signature in fn/bpsst.py for argument names.
```
