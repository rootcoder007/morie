...
`print(result)` render. See `moirais.fn.describe('grwsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grwsp import *
import numpy as np
# See the function signature in fn/grwsp.py for argument names.
```
