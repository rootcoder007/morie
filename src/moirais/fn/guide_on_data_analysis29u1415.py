...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1415"]


def guide_on_data_analysis_chapter_29_unnumbered_1415(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • Δ𝑖𝑡 = 𝑌𝑖(𝑡+1)− 𝑌𝑖𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1415')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1415: GeneralStatistics expression (auto-extracted; see ref)."
