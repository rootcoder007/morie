...
__all__ = ["bivand2013_chapter_7_unnumbered_118"]


def bivand2013_chapter_7_unnumbered_118(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: further options for the choice of the functionf(x−x0,α,β) to accommodate
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u118')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u118: GeneralStatistics expression (auto-extracted; see ref)."
