...
`print(result)` render. See `moirais.fn.describe('zstrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zstrd import *
import numpy as np
# See the function signature in fn/zstrd.py for argument names.
```
