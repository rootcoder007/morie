...
`print(result)` render. See `moirais.fn.describe('spcenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcenv import *
import numpy as np
# See the function signature in fn/spcenv.py for argument names.
```
