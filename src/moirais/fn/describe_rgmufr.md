# describe('rgmufr') — rangayyan_muap_firing_rate
...
`print(result)` render. See `moirais.fn.describe('rgmufr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmufr import *
import numpy as np
# See the function signature in fn/rgmufr.py for argument names.
```
