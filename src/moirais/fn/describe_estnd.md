# describe('estnd') — estimand_framework
...
`print(result)` render. See `moirais.fn.describe('estnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.estnd import *
import numpy as np
# See the function signature in fn/estnd.py for argument names.
```
