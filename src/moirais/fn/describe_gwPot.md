# describe('gwPot') — global_warming_potential
...
`print(result)` render. See `moirais.fn.describe('gwPot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwPot import *
import numpy as np
# See the function signature in fn/gwPot.py for argument names.
```
