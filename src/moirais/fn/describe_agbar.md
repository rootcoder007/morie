...
`print(result)` render. See `moirais.fn.describe('agbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbar import *
import numpy as np
# See the function signature in fn/agbar.py for argument names.
```
