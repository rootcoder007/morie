# describe('bneop') — birth_death_process
...
`print(result)` render. See `moirais.fn.describe('bneop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bneop import *
import numpy as np
# See the function signature in fn/bneop.py for argument names.
```
