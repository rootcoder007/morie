...
`print(result)` render. See `moirais.fn.describe('ptkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptkde import *
import numpy as np
# See the function signature in fn/ptkde.py for argument names.
```
