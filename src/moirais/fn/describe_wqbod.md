...
`print(result)` render. See `moirais.fn.describe('wqbod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqbod import *
import numpy as np
# See the function signature in fn/wqbod.py for argument names.
```
