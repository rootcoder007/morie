...
`print(result)` render. See `moirais.fn.describe('rdkkin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdkkin import *
import numpy as np
# See the function signature in fn/rdkkin.py for argument names.
```
