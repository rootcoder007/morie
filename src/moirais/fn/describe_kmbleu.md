# describe('kmbleu') — kamath_bleu_score
...
`print(result)` render. See `moirais.fn.describe('kmbleu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbleu import *
import numpy as np
# See the function signature in fn/kmbleu.py for argument names.
```
