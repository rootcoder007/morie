...
`print(result)` render. See `moirais.fn.describe('sugpln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sugpln import *
import numpy as np
# See the function signature in fn/sugpln.py for argument names.
```
