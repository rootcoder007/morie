...
`print(result)` render. See `moirais.fn.describe('tmarch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmarch import *
import numpy as np
# See the function signature in fn/tmarch.py for argument names.
```
