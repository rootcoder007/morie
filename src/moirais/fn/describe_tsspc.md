...
`print(result)` render. See `moirais.fn.describe('tsspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsspc import *
import numpy as np
# See the function signature in fn/tsspc.py for argument names.
```
