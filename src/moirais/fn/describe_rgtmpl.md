# describe('rgtmpl') — rangayyan_template_match
...
`print(result)` render. See `moirais.fn.describe('rgtmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgtmpl import *
import numpy as np
# See the function signature in fn/rgtmpl.py for argument names.
```
