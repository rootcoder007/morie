...
__all__ = ["hedderich_chapter_9_unnumbered_3315"]


def hedderich_chapter_9_unnumbered_3315(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: model estimates the effects against the first groupα2 = 5.6 = ˆµ2−ˆµ1 andα3 =−2.2 = ˆµ3−ˆµ1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3315')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3315: GeneralStatistics expression (auto-extracted; see ref)."
