...
__all__ = ["hedderich_chapter_9_unnumbered_3018"]


def hedderich_chapter_9_unnumbered_3018(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] = 30, 13> 9, 49 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3018')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3018: ContingencyTables expression (auto-extracted; see ref)."
