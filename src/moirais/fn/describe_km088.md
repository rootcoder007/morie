# describe('km088') — kamath_ch6_cat_metric
...
`print(result)` render. See `moirais.fn.describe('km088')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km088 import *
import numpy as np
# See the function signature in fn/km088.py for argument names.
```
