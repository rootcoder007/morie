...
`print(result)` render. See `moirais.fn.describe('glmmcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmcov import *
import numpy as np
# See the function signature in fn/glmmcov.py for argument names.
```
