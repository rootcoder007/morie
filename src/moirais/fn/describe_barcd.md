...
`print(result)` render. See `moirais.fn.describe('barcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.barcd import *
import numpy as np
# See the function signature in fn/barcd.py for argument names.
```
