# describe('mrkvr') — marker_variance
...
`print(result)` render. See `moirais.fn.describe('mrkvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrkvr import *
import numpy as np
# See the function signature in fn/mrkvr.py for argument names.
```
