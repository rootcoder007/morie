# describe('zedrc') — dose_resp_spatial
...
`print(result)` render. See `moirais.fn.describe('zedrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zedrc import *
import numpy as np
# See the function signature in fn/zedrc.py for argument names.
```
