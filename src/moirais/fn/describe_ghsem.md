...
`print(result)` render. See `moirais.fn.describe('ghsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsem import *
import numpy as np
# See the function signature in fn/ghsem.py for argument names.
```
