...
`print(result)` render. See `moirais.fn.describe('slag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slag import *
import numpy as np
# See the function signature in fn/slag.py for argument names.
```
