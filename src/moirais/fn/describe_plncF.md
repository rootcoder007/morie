# describe('plncF') — planck_function
...
`print(result)` render. See `moirais.fn.describe('plncF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plncF import *
import numpy as np
# See the function signature in fn/plncF.py for argument names.
```
