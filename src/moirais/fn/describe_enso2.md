...
`print(result)` render. See `moirais.fn.describe('enso2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enso2 import *
import numpy as np
# See the function signature in fn/enso2.py for argument names.
```
