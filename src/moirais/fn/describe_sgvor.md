# describe('sgvor') — voronoi_tessellation
...
`print(result)` render. See `moirais.fn.describe('sgvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgvor import *
import numpy as np
# See the function signature in fn/sgvor.py for argument names.
```
