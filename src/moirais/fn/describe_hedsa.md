# describe('hedsa') — deterministic_sensitivity
...
`print(result)` render. See `moirais.fn.describe('hedsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hedsa import *
import numpy as np
# See the function signature in fn/hedsa.py for argument names.
```
