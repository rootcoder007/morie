# describe('mpdcm') — matching_pursuit_decompose
...
`print(result)` render. See `moirais.fn.describe('mpdcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpdcm import *
import numpy as np
# See the function signature in fn/mpdcm.py for argument names.
```
