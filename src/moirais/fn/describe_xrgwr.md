...
`print(result)` render. See `moirais.fn.describe('xrgwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwr import *
import numpy as np
# See the function signature in fn/xrgwr.py for argument names.
```
