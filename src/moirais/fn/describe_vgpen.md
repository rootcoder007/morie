# describe('vgpen') — vario_pentaspherical
...
`print(result)` render. See `moirais.fn.describe('vgpen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgpen import *
import numpy as np
# See the function signature in fn/vgpen.py for argument names.
```
