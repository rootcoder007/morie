# describe('gdeld') — gdeld

## WHAT IT DOES

Elderly ratio spatial
...
`print(result)` render. See `moirais.fn.describe('gdeld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdeld import *
import numpy as np
# See the function signature in fn/gdeld.py for argument names.
```
