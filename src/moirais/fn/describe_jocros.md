# describe('jocros') — joseph_croston_intermittent
...
`print(result)` render. See `moirais.fn.describe('jocros')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jocros import *
import numpy as np
# See the function signature in fn/jocros.py for argument names.
```
