...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_6"]


def guide_on_data_analysis_chapter_2_unnumbered_6(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] • rank(A) =rank(A′) =rank(A′A) =rank(AA′)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u6')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u6: GeneralStatistics expression (auto-extracted; see ref)."
