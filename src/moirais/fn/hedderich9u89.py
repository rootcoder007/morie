...
__all__ = ["hedderich_chapter_9_unnumbered_89"]


def hedderich_chapter_9_unnumbered_89(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u89')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u89: GeneralStatistics expression (auto-extracted; see ref)."
