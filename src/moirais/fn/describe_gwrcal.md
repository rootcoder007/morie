# describe('gwrcal') — gwr_bandwidth_select
...
`print(result)` render. See `moirais.fn.describe('gwrcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrcal import *
import numpy as np
# See the function signature in fn/gwrcal.py for argument names.
```
