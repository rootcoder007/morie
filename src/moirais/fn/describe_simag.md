...
`print(result)` render. See `moirais.fn.describe('simag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simag import *
import numpy as np
# See the function signature in fn/simag.py for argument names.
```
