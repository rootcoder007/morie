...
`print(result)` render. See `moirais.fn.describe('lts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lts import *
import numpy as np
# See the function signature in fn/lts.py for argument names.
```
