...
`print(result)` render. See `moirais.fn.describe('croston')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.croston import *
import numpy as np
# See the function signature in fn/croston.py for argument names.
```
