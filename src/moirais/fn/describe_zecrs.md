# describe('zecrs') — carstairs_index
...
`print(result)` render. See `moirais.fn.describe('zecrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zecrs import *
import numpy as np
# See the function signature in fn/zecrs.py for argument names.
```
