...
`print(result)` render. See `moirais.fn.describe('diffu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffu import *
import numpy as np
# See the function signature in fn/diffu.py for argument names.
```
