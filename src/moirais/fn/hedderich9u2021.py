...
__all__ = ["hedderich_chapter_9_unnumbered_2021"]


def hedderich_chapter_9_unnumbered_2021(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If you testH0:µ1−µ2 =µ0 againstHA:µ1−µ2̸=µ0, the corresponding numerators [the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2021')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2021: GeneralStatistics expression (auto-extracted; see ref)."
