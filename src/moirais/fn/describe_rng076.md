# describe('rng076') — rangayyan_ch3_dft_convolution_property
...
`print(result)` render. See `moirais.fn.describe('rng076')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng076 import *
import numpy as np
# See the function signature in fn/rng076.py for argument names.
```
