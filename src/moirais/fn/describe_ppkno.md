...
`print(result)` render. See `moirais.fn.describe('ppkno')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppkno import *
import numpy as np
# See the function signature in fn/ppkno.py for argument names.
```
