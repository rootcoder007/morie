...
`print(result)` render. See `moirais.fn.describe('dtcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcar import *
import numpy as np
# See the function signature in fn/dtcar.py for argument names.
```
