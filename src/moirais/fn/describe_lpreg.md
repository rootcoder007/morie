...
`print(result)` render. See `moirais.fn.describe('lpreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpreg import *
import numpy as np
# See the function signature in fn/lpreg.py for argument names.
```
