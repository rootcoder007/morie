...
`print(result)` render. See `moirais.fn.describe('semwald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semwald import *
import numpy as np
# See the function signature in fn/semwald.py for argument names.
```
