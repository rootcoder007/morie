# describe('stbciw') — stabilized_censoring_weights
...
`print(result)` render. See `moirais.fn.describe('stbciw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stbciw import *
import numpy as np
# See the function signature in fn/stbciw.py for argument names.
```
