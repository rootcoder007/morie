...
`print(result)` render. See `moirais.fn.describe('gcgcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcgcm import *
import numpy as np
# See the function signature in fn/gcgcm.py for argument names.
```
