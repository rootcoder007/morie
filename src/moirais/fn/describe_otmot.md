# describe('otmot') — ot_multimarginal_iter
...
`print(result)` render. See `moirais.fn.describe('otmot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmot import *
import numpy as np
# See the function signature in fn/otmot.py for argument names.
```
