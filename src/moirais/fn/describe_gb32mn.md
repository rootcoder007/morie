# describe('gb32mn') — gibbons_runs_mean
...
`print(result)` render. See `moirais.fn.describe('gb32mn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32mn import *
import numpy as np
# See the function signature in fn/gb32mn.py for argument names.
```
