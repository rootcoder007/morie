...
`print(result)` render. See `moirais.fn.describe('snpblr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snpblr import *
import numpy as np
# See the function signature in fn/snpblr.py for argument names.
```
