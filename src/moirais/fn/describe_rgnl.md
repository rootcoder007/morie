# describe('rgnl') — rangayyan_nonlinear_features
...
`print(result)` render. See `moirais.fn.describe('rgnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgnl import *
import numpy as np
# See the function signature in fn/rgnl.py for argument names.
```
