...
`print(result)` render. See `moirais.fn.describe('zscor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscor import *
import numpy as np
# See the function signature in fn/zscor.py for argument names.
```
