...
`print(result)` render. See `moirais.fn.describe('sprmfdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprmfdi import *
import numpy as np
# See the function signature in fn/sprmfdi.py for argument names.
```
