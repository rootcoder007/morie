...
__all__ = ["wilcox_chapter_14_unnumbered_699"]


def wilcox_chapter_14_unnumbered_699(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u699')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u699: PowerAndDesign expression (auto-extracted; see ref)."
