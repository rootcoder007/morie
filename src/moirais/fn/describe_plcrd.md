...
`print(result)` render. See `moirais.fn.describe('plcrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcrd import *
import numpy as np
# See the function signature in fn/plcrd.py for argument names.
```
