...
`print(result)` render. See `moirais.fn.describe('lacvgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacvgm import *
import numpy as np
# See the function signature in fn/lacvgm.py for argument names.
```
