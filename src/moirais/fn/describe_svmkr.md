# describe('svmkr') — svm_kernel_trick
...
`print(result)` render. See `moirais.fn.describe('svmkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmkr import *
import numpy as np
# See the function signature in fn/svmkr.py for argument names.
```
