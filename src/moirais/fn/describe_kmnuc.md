# describe('kmnuc') — kamath_nucleus_sampling
...
`print(result)` render. See `moirais.fn.describe('kmnuc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmnuc import *
import numpy as np
# See the function signature in fn/kmnuc.py for argument names.
```
