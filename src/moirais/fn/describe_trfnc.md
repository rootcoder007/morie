# describe('trfnc') — transfer_function
...
`print(result)` render. See `moirais.fn.describe('trfnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trfnc import *
import numpy as np
# See the function signature in fn/trfnc.py for argument names.
```
