...
`print(result)` render. See `moirais.fn.describe('seclo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclo import *
import numpy as np
# See the function signature in fn/seclo.py for argument names.
```
