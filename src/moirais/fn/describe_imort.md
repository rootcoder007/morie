# describe('imort') — infant_mortality
...
`print(result)` render. See `moirais.fn.describe('imort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imort import *
import numpy as np
# See the function signature in fn/imort.py for argument names.
```
