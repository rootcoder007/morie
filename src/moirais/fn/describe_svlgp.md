...
`print(result)` render. See `moirais.fn.describe('svlgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlgp import *
import numpy as np
# See the function signature in fn/svlgp.py for argument names.
```
