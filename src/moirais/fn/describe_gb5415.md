# describe('gb5415') — gibbons_sign_simpower
...
`print(result)` render. See `moirais.fn.describe('gb5415')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5415 import *
import numpy as np
# See the function signature in fn/gb5415.py for argument names.
```
