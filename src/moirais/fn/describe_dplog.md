...
`print(result)` render. See `moirais.fn.describe('dplog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dplog import *
import numpy as np
# See the function signature in fn/dplog.py for argument names.
```
