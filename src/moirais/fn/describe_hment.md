# describe('hment') — geron_entropy_impurity
...
`print(result)` render. See `moirais.fn.describe('hment')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hment import *
import numpy as np
# See the function signature in fn/hment.py for argument names.
```
