...
__all__ = ["hedderich_chapter_9_unnumbered_1406"]


def hedderich_chapter_9_unnumbered_1406(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Given: ayx = 7.729;sayx = 2.862;n = 80; i.e.t78;0.975 = 1.99 1.99·2.862 = 5.695
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1406')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1406: GeneralStatistics expression (auto-extracted; see ref)."
