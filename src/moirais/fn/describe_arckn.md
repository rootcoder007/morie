# describe('arckn') — arc_cosine_kernel
...
`print(result)` render. See `moirais.fn.describe('arckn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arckn import *
import numpy as np
# See the function signature in fn/arckn.py for argument names.
```
