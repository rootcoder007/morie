# describe('rcdst') — distance_from_agreement
...
`print(result)` render. See `moirais.fn.describe('rcdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdst import *
import numpy as np
# See the function signature in fn/rcdst.py for argument names.
```
