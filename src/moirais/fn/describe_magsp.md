# describe('magsp') — magnitude_spectrum
...
`print(result)` render. See `moirais.fn.describe('magsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magsp import *
import numpy as np
# See the function signature in fn/magsp.py for argument names.
```
