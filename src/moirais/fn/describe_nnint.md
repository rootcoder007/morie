...
`print(result)` render. See `moirais.fn.describe('nnint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnint import *
import numpy as np
# See the function signature in fn/nnint.py for argument names.
```
