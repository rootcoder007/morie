...
`print(result)` render. See `moirais.fn.describe('slxbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxbic import *
import numpy as np
# See the function signature in fn/slxbic.py for argument names.
```
