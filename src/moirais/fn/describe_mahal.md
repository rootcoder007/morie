# describe('mahal') — mahalanobis_dist
...
`print(result)` render. See `moirais.fn.describe('mahal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mahal import *
import numpy as np
# See the function signature in fn/mahal.py for argument names.
```
