...
`print(result)` render. See `moirais.fn.describe('stk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stk import *
import numpy as np
# See the function signature in fn/stk.py for argument names.
```
