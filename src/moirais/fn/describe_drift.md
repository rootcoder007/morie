...
`print(result)` render. See `moirais.fn.describe('drift')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drift import *
import numpy as np
# See the function signature in fn/drift.py for argument names.
```
