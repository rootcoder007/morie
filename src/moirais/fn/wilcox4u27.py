...
__all__ = ["wilcox_chapter_4_unnumbered_27"]


def wilcox_chapter_4_unnumbered_27(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 227.47. Because u = 4 and ℓ = 0, 1.26(MADN )(4 − 0)/(19 − 4) = 56.79. So,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u27')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u27: GeneralStatistics expression (auto-extracted; see ref)."
