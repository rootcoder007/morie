...
__all__ = ["wilcox_chapter_13_unnumbered_1279"]


def wilcox_chapter_13_unnumbered_1279(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: High p11 p12 p1+ =p11 +p12
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1279')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1279: GeneralStatistics expression (auto-extracted; see ref)."
