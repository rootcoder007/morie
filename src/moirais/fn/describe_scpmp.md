...
`print(result)` render. See `moirais.fn.describe('scpmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpmp import *
import numpy as np
# See the function signature in fn/scpmp.py for argument names.
```
