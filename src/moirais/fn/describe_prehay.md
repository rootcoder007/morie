# describe('prehay') — preacher_hayes_indirect
...
`print(result)` render. See `moirais.fn.describe('prehay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prehay import *
import numpy as np
# See the function signature in fn/prehay.py for argument names.
```
