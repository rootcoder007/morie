...
__all__ = ["wilcox_chapter_14_unnumbered_701"]


def wilcox_chapter_14_unnumbered_701(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˜Xj = Tj{1 − (Nj − nj)bj}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u701')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u701: GeneralStatistics expression (auto-extracted; see ref)."
