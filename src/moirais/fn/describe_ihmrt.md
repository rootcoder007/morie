# describe('ihmrt') — indigenous_mortality
...
`print(result)` render. See `moirais.fn.describe('ihmrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihmrt import *
import numpy as np
# See the function signature in fn/ihmrt.py for argument names.
```
