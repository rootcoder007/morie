# describe('mlsit') — mlsmu6_single_iteration
...
`print(result)` render. See `moirais.fn.describe('mlsit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlsit import *
import numpy as np
# See the function signature in fn/mlsit.py for argument names.
```
