...
`print(result)` render. See `moirais.fn.describe('clskt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clskt import *
import numpy as np
# See the function signature in fn/clskt.py for argument names.
```
