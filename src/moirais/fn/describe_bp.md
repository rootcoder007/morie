# describe('bp') — breusch_pagan_test
...
`print(result)` render. See `moirais.fn.describe('bp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bp import *
import numpy as np
# See the function signature in fn/bp.py for argument names.
```
