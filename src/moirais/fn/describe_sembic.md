...
`print(result)` render. See `moirais.fn.describe('sembic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sembic import *
import numpy as np
# See the function signature in fn/sembic.py for argument names.
```
