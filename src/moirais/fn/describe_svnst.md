...
`print(result)` render. See `moirais.fn.describe('svnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnst import *
import numpy as np
# See the function signature in fn/svnst.py for argument names.
```
