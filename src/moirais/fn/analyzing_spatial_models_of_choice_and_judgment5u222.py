...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_5_unnumbered_222"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_5_unnumbered_222(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment5u222')`` for the full guide.
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment5u222: GeneralStatistics expression (auto-extracted; see ref)."
