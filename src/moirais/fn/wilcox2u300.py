...
__all__ = ["wilcox_chapter_2_unnumbered_300"]


def wilcox_chapter_2_unnumbered_300(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: environment. Here we compute a 1 − α = 0.95 confidence interval for µ. Because there are
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u300')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u300: GeneralStatistics expression (auto-extracted; see ref)."
