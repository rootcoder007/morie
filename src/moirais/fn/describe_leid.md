# describe('leid') — leiden_communities
...
`print(result)` render. See `moirais.fn.describe('leid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.leid import *
import numpy as np
# See the function signature in fn/leid.py for argument names.
```
