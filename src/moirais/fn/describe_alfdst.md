# describe('alfdst') — alphafold_distogram
...
`print(result)` render. See `moirais.fn.describe('alfdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfdst import *
import numpy as np
# See the function signature in fn/alfdst.py for argument names.
```
