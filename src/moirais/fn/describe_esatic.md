# describe('esatic') — eap_information
...
`print(result)` render. See `moirais.fn.describe('esatic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esatic import *
import numpy as np
# See the function signature in fn/esatic.py for argument names.
```
