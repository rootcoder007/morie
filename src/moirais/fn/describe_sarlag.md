# describe('sarlag') — spatial_ar_lag_model
...
`print(result)` render. See `moirais.fn.describe('sarlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarlag import *
import numpy as np
# See the function signature in fn/sarlag.py for argument names.
```
