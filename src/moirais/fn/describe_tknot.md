...
`print(result)` render. See `moirais.fn.describe('tknot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tknot import *
import numpy as np
# See the function signature in fn/tknot.py for argument names.
```
