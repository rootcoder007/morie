...
`print(result)` render. See `moirais.fn.describe('giss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.giss import *
import numpy as np
# See the function signature in fn/giss.py for argument names.
```
