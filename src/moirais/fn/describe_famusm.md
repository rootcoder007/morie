# describe('famusm') — family_based_assoc
...
`print(result)` render. See `moirais.fn.describe('famusm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.famusm import *
import numpy as np
# See the function signature in fn/famusm.py for argument names.
```
