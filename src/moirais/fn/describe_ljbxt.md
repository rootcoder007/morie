...
`print(result)` render. See `moirais.fn.describe('ljbxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ljbxt import *
import numpy as np
# See the function signature in fn/ljbxt.py for argument names.
```
