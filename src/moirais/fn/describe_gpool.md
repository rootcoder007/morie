# describe('gpool') — gpool

## WHAT IT DOES

rGlobal average pooling.
...
`print(result)` render. See `moirais.fn.describe('gpool')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpool import *
import numpy as np
# See the function signature in fn/gpool.py for argument names.
```
