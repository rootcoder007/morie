...
`print(result)` render. See `moirais.fn.describe('pabrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pabrd import *
import numpy as np
# See the function signature in fn/pabrd.py for argument names.
```
