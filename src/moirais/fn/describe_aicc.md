# describe('aicc') — corrected_aic

## WHAT IT DOES

Corrected AIC. 'No man ever steps in the same river twice. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('aicc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aicc import *
import numpy as np
# See the function signature in fn/aicc.py for argument names.
```
