...
`print(result)` render. See `moirais.fn.describe('mcavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcavg import *
import numpy as np
# See the function signature in fn/mcavg.py for argument names.
```
