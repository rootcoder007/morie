# describe('matrans') — ma_logit_transform
...
`print(result)` render. See `moirais.fn.describe('matrans')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matrans import *
import numpy as np
# See the function signature in fn/matrans.py for argument names.
```
