# describe('wsmboo') — wasserman_bootstrap
...
`print(result)` render. See `moirais.fn.describe('wsmboo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmboo import *
import numpy as np
# See the function signature in fn/wsmboo.py for argument names.
```
