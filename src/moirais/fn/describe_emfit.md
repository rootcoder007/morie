...
`print(result)` render. See `moirais.fn.describe('emfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emfit import *
import numpy as np
# See the function signature in fn/emfit.py for argument names.
```
