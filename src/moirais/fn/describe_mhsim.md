...
`print(result)` render. See `moirais.fn.describe('mhsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhsim import *
import numpy as np
# See the function signature in fn/mhsim.py for argument names.
```
