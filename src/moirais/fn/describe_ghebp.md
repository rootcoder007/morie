# describe('ghebp') — ghosal_empirical_bayes
...
`print(result)` render. See `moirais.fn.describe('ghebp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghebp import *
import numpy as np
# See the function signature in fn/ghebp.py for argument names.
```
