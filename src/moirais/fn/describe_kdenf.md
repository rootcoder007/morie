...
`print(result)` render. See `moirais.fn.describe('kdenf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kdenf import *
import numpy as np
# See the function signature in fn/kdenf.py for argument names.
```
