...
`print(result)` render. See `moirais.fn.describe('dilat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dilat import *
import numpy as np
# See the function signature in fn/dilat.py for argument names.
```
