# describe('ludc') — lu_decomposition
...
`print(result)` render. See `moirais.fn.describe('ludc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ludc import *
import numpy as np
# See the function signature in fn/ludc.py for argument names.
```
