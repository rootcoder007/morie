# describe('nonresp') — nonresponse_adjustment
...
`print(result)` render. See `moirais.fn.describe('nonresp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nonresp import *
import numpy as np
# See the function signature in fn/nonresp.py for argument names.
```
