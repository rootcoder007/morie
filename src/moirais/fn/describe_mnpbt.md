# describe('mnpbt') — multinomial_probit_spatial
...
`print(result)` render. See `moirais.fn.describe('mnpbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnpbt import *
import numpy as np
# See the function signature in fn/mnpbt.py for argument names.
```
