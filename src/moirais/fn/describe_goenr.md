...
`print(result)` render. See `moirais.fn.describe('goenr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.goenr import *
import numpy as np
# See the function signature in fn/goenr.py for argument names.
```
