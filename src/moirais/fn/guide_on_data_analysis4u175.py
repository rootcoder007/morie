...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_175"]


def guide_on_data_analysis_chapter_4_unnumbered_175(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑝-value = 2𝑃(𝑊 ≥ 𝑤𝑚𝑎𝑥) = 2𝑃(𝑊 ≤ 𝑤𝑚𝑖𝑛)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u175')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u175: GeneralStatistics expression (auto-extracted; see ref)."
