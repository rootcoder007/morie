...
__all__ = ["hedderich_chapter_9_unnumbered_518"]


def hedderich_chapter_9_unnumbered_518(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = n1(x0 +x1)−x1(n0 +n1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u518')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u518: GeneralStatistics expression (auto-extracted; see ref)."
