...
__all__ = ["wilcox_chapter_10_unnumbered_1014"]


def wilcox_chapter_10_unnumbered_1014(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ j =θ k (12.12)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1014')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1014: GeneralStatistics expression (auto-extracted; see ref)."
