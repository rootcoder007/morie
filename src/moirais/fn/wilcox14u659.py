...
__all__ = ["wilcox_chapter_14_unnumbered_659"]


def wilcox_chapter_14_unnumbered_659(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: G = SST − SSBG = A − C
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u659')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u659: PowerAndDesign expression (auto-extracted; see ref)."
