...
`print(result)` render. See `moirais.fn.describe('lacscor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacscor import *
import numpy as np
# See the function signature in fn/lacscor.py for argument names.
```
