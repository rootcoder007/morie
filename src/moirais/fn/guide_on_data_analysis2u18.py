...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_18"]


def guide_on_data_analysis_chapter_2_unnumbered_18(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u18')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u18: GeneralStatistics expression (auto-extracted; see ref)."
