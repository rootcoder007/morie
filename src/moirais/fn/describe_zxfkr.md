...
`print(result)` render. See `moirais.fn.describe('zxfkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxfkr import *
import numpy as np
# See the function signature in fn/zxfkr.py for argument names.
```
