...
`print(result)` render. See `moirais.fn.describe('bivrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bivrt import *
import numpy as np
# See the function signature in fn/bivrt.py for argument names.
```
