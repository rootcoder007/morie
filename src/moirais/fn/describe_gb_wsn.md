# describe('gb_wsn') — gibbons_wsrt_normal_approx
...
`print(result)` render. See `moirais.fn.describe('gb_wsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wsn import *
import numpy as np
# See the function signature in fn/gb_wsn.py for argument names.
```
