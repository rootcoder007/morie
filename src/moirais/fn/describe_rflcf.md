# describe('rflcf') — reflection_coefficients_fn
...
`print(result)` render. See `moirais.fn.describe('rflcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rflcf import *
import numpy as np
# See the function signature in fn/rflcf.py for argument names.
```
