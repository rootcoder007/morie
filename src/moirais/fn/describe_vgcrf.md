...
`print(result)` render. See `moirais.fn.describe('vgcrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcrf import *
import numpy as np
# See the function signature in fn/vgcrf.py for argument names.
```
