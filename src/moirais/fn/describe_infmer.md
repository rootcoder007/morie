...
`print(result)` render. See `moirais.fn.describe('infmer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infmer import *
import numpy as np
# See the function signature in fn/infmer.py for argument names.
```
