...
`print(result)` render. See `moirais.fn.describe('lstds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lstds import *
import numpy as np
# See the function signature in fn/lstds.py for argument names.
```
