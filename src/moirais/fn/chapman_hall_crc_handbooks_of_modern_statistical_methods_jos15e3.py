...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_15_equation_3"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_15_equation_3(x, cdf=None):
    """
    Regression equation extracted from [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference.

    Formula: β(Xi) = ∂πβ(Xi)/∂β. Equation (15.3) represents the sample analog
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos15e3')`` for the full guide.

    References
    ----------
    [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference, ch.15 eq.15.3
    """
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos15e3: Regression equation extracted from [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference."
