# describe('msm307') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm307')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm307 import *
import numpy as np
# See the function signature in fn/msm307.py for argument names.
```
