...
`print(result)` render. See `moirais.fn.describe('cmmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmmed import *
import numpy as np
# See the function signature in fn/cmmed.py for argument names.
```
