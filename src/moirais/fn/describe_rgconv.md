# describe('rgconv') — rangayyan_linear_convolution
...
`print(result)` render. See `moirais.fn.describe('rgconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgconv import *
import numpy as np
# See the function signature in fn/rgconv.py for argument names.
```
