# describe('alfevf') — alphafold_evoformer
...
`print(result)` render. See `moirais.fn.describe('alfevf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfevf import *
import numpy as np
# See the function signature in fn/alfevf.py for argument names.
```
