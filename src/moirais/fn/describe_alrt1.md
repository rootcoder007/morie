...
`print(result)` render. See `moirais.fn.describe('alrt1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrt1 import *
import numpy as np
# See the function signature in fn/alrt1.py for argument names.
```
