# describe('kmprln') — kamath_pre_ln_transformer
...
`print(result)` render. See `moirais.fn.describe('kmprln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmprln import *
import numpy as np
# See the function signature in fn/kmprln.py for argument names.
```
