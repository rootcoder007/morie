...
`print(result)` render. See `moirais.fn.describe('hmrlhf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrlhf import *
import numpy as np
# See the function signature in fn/hmrlhf.py for argument names.
```
