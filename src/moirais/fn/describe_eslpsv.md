...
`print(result)` render. See `moirais.fn.describe('eslpsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslpsv import *
import numpy as np
# See the function signature in fn/eslpsv.py for argument names.
```
