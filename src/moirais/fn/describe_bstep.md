# describe('bstep') — bayesian_changepoint
...
`print(result)` render. See `moirais.fn.describe('bstep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bstep import *
import numpy as np
# See the function signature in fn/bstep.py for argument names.
```
