# describe('cbgen') — codebook_generate
...
`print(result)` render. See `moirais.fn.describe('cbgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cbgen import *
import numpy as np
# See the function signature in fn/cbgen.py for argument names.
```
