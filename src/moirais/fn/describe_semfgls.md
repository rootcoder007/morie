...
`print(result)` render. See `moirais.fn.describe('semfgls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semfgls import *
import numpy as np
# See the function signature in fn/semfgls.py for argument names.
```
