...
`print(result)` render. See `moirais.fn.describe('lokde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lokde import *
import numpy as np
# See the function signature in fn/lokde.py for argument names.
```
