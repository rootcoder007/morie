...
`print(result)` render. See `moirais.fn.describe('krncr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krncr import *
import numpy as np
# See the function signature in fn/krncr.py for argument names.
```
