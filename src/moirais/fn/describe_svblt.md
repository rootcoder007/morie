...
`print(result)` render. See `moirais.fn.describe('svblt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svblt import *
import numpy as np
# See the function signature in fn/svblt.py for argument names.
```
