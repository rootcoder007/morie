...
`print(result)` render. See `moirais.fn.describe('ppitv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppitv import *
import numpy as np
# See the function signature in fn/ppitv.py for argument names.
```
