...
`print(result)` render. See `moirais.fn.describe('msdmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdmh import *
import numpy as np
# See the function signature in fn/msdmh.py for argument names.
```
