...
`print(result)` render. See `moirais.fn.describe('umsto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umsto import *
import numpy as np
# See the function signature in fn/umsto.py for argument names.
```
