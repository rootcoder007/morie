# describe('kgord') — ordinary_kriging
...
`print(result)` render. See `moirais.fn.describe('kgord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgord import *
import numpy as np
# See the function signature in fn/kgord.py for argument names.
```
