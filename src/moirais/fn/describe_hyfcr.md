...
`print(result)` render. See `moirais.fn.describe('hyfcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyfcr import *
import numpy as np
# See the function signature in fn/hyfcr.py for argument names.
```
