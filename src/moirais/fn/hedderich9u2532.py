...
__all__ = ["hedderich_chapter_9_unnumbered_2532"]


def hedderich_chapter_9_unnumbered_2532(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |RS−RC|= |21−68|= 47
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2532')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2532: GeneralStatistics expression (auto-extracted; see ref)."
