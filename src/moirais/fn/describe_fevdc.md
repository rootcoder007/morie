...
`print(result)` render. See `moirais.fn.describe('fevdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fevdc import *
import numpy as np
# See the function signature in fn/fevdc.py for argument names.
```
