...
`print(result)` render. See `moirais.fn.describe('xrlmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlmr import *
import numpy as np
# See the function signature in fn/xrlmr.py for argument names.
```
