...
`print(result)` render. See `moirais.fn.describe('prdur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdur import *
import numpy as np
# See the function signature in fn/prdur.py for argument names.
```
