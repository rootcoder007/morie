...
`print(result)` render. See `moirais.fn.describe('ubimv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubimv import *
import numpy as np
# See the function signature in fn/ubimv.py for argument names.
```
