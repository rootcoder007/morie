...
`print(result)` render. See `moirais.fn.describe('attck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attck import *
import numpy as np
# See the function signature in fn/attck.py for argument names.
```
