...
__all__ = ["hedderich_chapter_9_unnumbered_1405"]


def hedderich_chapter_9_unnumbered_1405(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] byx±tsbyx = 0.426±0.378 95%-CI: 0.048≤βyx≤0.804
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1405')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1405: GeneralStatistics expression (auto-extracted; see ref)."
