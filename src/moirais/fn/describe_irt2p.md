...
`print(result)` render. See `moirais.fn.describe('irt2p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt2p import *
import numpy as np
# See the function signature in fn/irt2p.py for argument names.
```
