...
`print(result)` render. See `moirais.fn.describe('firds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.firds import *
import numpy as np
# See the function signature in fn/firds.py for argument names.
```
