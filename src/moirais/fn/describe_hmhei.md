...
`print(result)` render. See `moirais.fn.describe('hmhei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhei import *
import numpy as np
# See the function signature in fn/hmhei.py for argument names.
```
