# describe('softm') — softm

## WHAT IT DOES

rSoftmax activation (numerically stable).
...
`print(result)` render. See `moirais.fn.describe('softm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.softm import *
import numpy as np
# See the function signature in fn/softm.py for argument names.
```
