# describe('bpscr') — bayesian_propensity
...
`print(result)` render. See `moirais.fn.describe('bpscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpscr import *
import numpy as np
# See the function signature in fn/bpscr.py for argument names.
```
