# describe('hmhpt') — geron_hyperparameter_tuning
...
`print(result)` render. See `moirais.fn.describe('hmhpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhpt import *
import numpy as np
# See the function signature in fn/hmhpt.py for argument names.
```
