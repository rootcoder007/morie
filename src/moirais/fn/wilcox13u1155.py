...
__all__ = ["wilcox_chapter_13_unnumbered_1155"]


def wilcox_chapter_13_unnumbered_1155(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Y =β 0 +f1(X1) + · · · +fp(Xp) +e, (14.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1155')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1155: GeneralStatistics expression (auto-extracted; see ref)."
