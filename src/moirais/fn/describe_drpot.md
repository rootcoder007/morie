...
`print(result)` render. See `moirais.fn.describe('drpot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drpot import *
import numpy as np
# See the function signature in fn/drpot.py for argument names.
```
