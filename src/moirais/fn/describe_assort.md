# describe('assort') — degree_assortativity
...
`print(result)` render. See `moirais.fn.describe('assort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.assort import *
import numpy as np
# See the function signature in fn/assort.py for argument names.
```
