...
`print(result)` render. See `moirais.fn.describe('baysa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysa import *
import numpy as np
# See the function signature in fn/baysa.py for argument names.
```
