...
`print(result)` render. See `moirais.fn.describe('ghdlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghdlm import *
import numpy as np
# See the function signature in fn/ghdlm.py for argument names.
```
