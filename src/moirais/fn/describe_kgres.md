# describe('kgres') — kriging_residual_map
...
`print(result)` render. See `moirais.fn.describe('kgres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgres import *
import numpy as np
# See the function signature in fn/kgres.py for argument names.
```
