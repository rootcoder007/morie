...
`print(result)` render. See `moirais.fn.describe('dtjhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtjhs import *
import numpy as np
# See the function signature in fn/dtjhs.py for argument names.
```
