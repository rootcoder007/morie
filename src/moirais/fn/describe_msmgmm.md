# describe('msmgmm') — msm_gmm_estimator
...
`print(result)` render. See `moirais.fn.describe('msmgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmgmm import *
import numpy as np
# See the function signature in fn/msmgmm.py for argument names.
```
