...
__all__ = ["hedderich_chapter_9_unnumbered_1960"]


def hedderich_chapter_9_unnumbered_1960(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Forn1 = 10, s1 = 4, ¯x1 = 20 andn2 = 12, s2 = 6, ¯x2 = 24 we get with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1960')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1960: GeneralStatistics expression (auto-extracted; see ref)."
