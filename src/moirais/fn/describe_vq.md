...
`print(result)` render. See `moirais.fn.describe('vq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vq import *
import numpy as np
# See the function signature in fn/vq.py for argument names.
```
