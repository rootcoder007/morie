...
`print(result)` render. See `moirais.fn.describe('lightG')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lightG import *
import numpy as np
# See the function signature in fn/lightG.py for argument names.
```
