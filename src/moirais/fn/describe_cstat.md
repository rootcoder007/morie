...
`print(result)` render. See `moirais.fn.describe('cstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstat import *
import numpy as np
# See the function signature in fn/cstat.py for argument names.
```
