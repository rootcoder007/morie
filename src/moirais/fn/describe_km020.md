# describe('km020') — kamath_ch2_ssl_loss
...
`print(result)` render. See `moirais.fn.describe('km020')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km020 import *
import numpy as np
# See the function signature in fn/km020.py for argument names.
```
