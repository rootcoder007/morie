...
`print(result)` render. See `moirais.fn.describe('cxsnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxsnl import *
import numpy as np
# See the function signature in fn/cxsnl.py for argument names.
```
