...
`print(result)` render. See `moirais.fn.describe('rcpnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcpnl import *
import numpy as np
# See the function signature in fn/rcpnl.py for argument names.
```
