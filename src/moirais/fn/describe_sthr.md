...
`print(result)` render. See `moirais.fn.describe('sthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sthr import *
import numpy as np
# See the function signature in fn/sthr.py for argument names.
```
