...
`print(result)` render. See `moirais.fn.describe('doseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.doseq import *
import numpy as np
# See the function signature in fn/doseq.py for argument names.
```
