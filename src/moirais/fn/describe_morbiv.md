# describe('morbiv') — bivariate_morans_i
...
`print(result)` render. See `moirais.fn.describe('morbiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morbiv import *
import numpy as np
# See the function signature in fn/morbiv.py for argument names.
```
