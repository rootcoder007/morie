# describe('fwxF') — fire_weather_index
...
`print(result)` render. See `moirais.fn.describe('fwxF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fwxF import *
import numpy as np
# See the function signature in fn/fwxF.py for argument names.
```
