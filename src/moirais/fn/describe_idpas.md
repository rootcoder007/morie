...
`print(result)` render. See `moirais.fn.describe('idpas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpas import *
import numpy as np
# See the function signature in fn/idpas.py for argument names.
```
