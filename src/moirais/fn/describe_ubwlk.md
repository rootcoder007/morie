# describe('ubwlk') — ubwlk

## WHAT IT DOES

Walkability index spatial
...
`print(result)` render. See `moirais.fn.describe('ubwlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubwlk import *
import numpy as np
# See the function signature in fn/ubwlk.py for argument names.
```
