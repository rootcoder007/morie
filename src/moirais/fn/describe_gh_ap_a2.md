# describe('gh_ap_a2') — ghosal_prohorov_metric
...
`print(result)` render. See `moirais.fn.describe('gh_ap_a2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_a2 import *
import numpy as np
# See the function signature in fn/gh_ap_a2.py for argument names.
```
