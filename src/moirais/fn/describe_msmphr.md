# describe('msmphr') — msm_proportional_hazards
...
`print(result)` render. See `moirais.fn.describe('msmphr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmphr import *
import numpy as np
# See the function signature in fn/msmphr.py for argument names.
```
