# describe('stacv') — spatiotemporal_autocovariance
...
`print(result)` render. See `moirais.fn.describe('stacv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stacv import *
import numpy as np
# See the function signature in fn/stacv.py for argument names.
```
