# describe('hmmlm') — geron_masked_lm
...
`print(result)` render. See `moirais.fn.describe('hmmlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmlm import *
import numpy as np
# See the function signature in fn/hmmlm.py for argument names.
```
