...
`print(result)` render. See `moirais.fn.describe('mazop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mazop import *
import numpy as np
# See the function signature in fn/mazop.py for argument names.
```
