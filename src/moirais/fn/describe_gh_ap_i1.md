# describe('gh_ap_i1') — ghosal_gp_sample_cont
...
`print(result)` render. See `moirais.fn.describe('gh_ap_i1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_i1 import *
import numpy as np
# See the function signature in fn/gh_ap_i1.py for argument names.
```
