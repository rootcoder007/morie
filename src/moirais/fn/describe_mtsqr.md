...
`print(result)` render. See `moirais.fn.describe('mtsqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtsqr import *
import numpy as np
# See the function signature in fn/mtsqr.py for argument names.
```
