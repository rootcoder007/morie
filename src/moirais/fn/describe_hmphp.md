# describe('hmphp') — geron_peephole_lstm
...
`print(result)` render. See `moirais.fn.describe('hmphp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmphp import *
import numpy as np
# See the function signature in fn/hmphp.py for argument names.
```
