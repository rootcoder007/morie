...
`print(result)` render. See `moirais.fn.describe('mtpkp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtpkp import *
import numpy as np
# See the function signature in fn/mtpkp.py for argument names.
```
