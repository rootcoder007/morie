...
__all__ = ["hedderich_chapter_9_unnumbered_3634"]


def hedderich_chapter_9_unnumbered_3634(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Likelihoodratiotest = 1 4 . 2 9 on 1 df , p=2e −04
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3634')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3634: GeneralStatistics expression (auto-extracted; see ref)."
