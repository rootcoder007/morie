...
`print(result)` render. See `moirais.fn.describe('zscnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscnf import *
import numpy as np
# See the function signature in fn/zscnf.py for argument names.
```
