# describe('krigCl') — ordinary_kriging
...
`print(result)` render. See `moirais.fn.describe('krigCl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krigCl import *
import numpy as np
# See the function signature in fn/krigCl.py for argument names.
```
