# describe('csrh') — cause_specific_hazard
...
`print(result)` render. See `moirais.fn.describe('csrh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrh import *
import numpy as np
# See the function signature in fn/csrh.py for argument names.
```
