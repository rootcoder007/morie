# describe('svipm') — ideal_point_mle
...
`print(result)` render. See `moirais.fn.describe('svipm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipm import *
import numpy as np
# See the function signature in fn/svipm.py for argument names.
```
