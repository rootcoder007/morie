# describe('didtwfe') — twoway_fixed_effects_did
...
`print(result)` render. See `moirais.fn.describe('didtwfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.didtwfe import *
import numpy as np
# See the function signature in fn/didtwfe.py for argument names.
```
