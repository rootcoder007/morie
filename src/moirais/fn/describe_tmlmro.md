# describe('tmlmro') — tmle_marginal_or

## WHAT IT DOES

TMLE for marginal odds ratio.
...
`print(result)` render. See `moirais.fn.describe('tmlmro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmro import *
import numpy as np
# See the function signature in fn/tmlmro.py for argument names.
```
