...
`print(result)` render. See `moirais.fn.describe('enhbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enhbt import *
import numpy as np
# See the function signature in fn/enhbt.py for argument names.
```
