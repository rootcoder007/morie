...
__all__ = ["wilcox_chapter_4_unnumbered_89"]


def wilcox_chapter_4_unnumbered_89(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To determine c ifP (Z ≥ c) = 0.9, first compute d = 1 − P (Z ≤ c) = 1 − 0.9 = 0.1. Then
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u89')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u89: GeneralStatistics expression (auto-extracted; see ref)."
