# describe('rndut') — random_utility_model
...
`print(result)` render. See `moirais.fn.describe('rndut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndut import *
import numpy as np
# See the function signature in fn/rndut.py for argument names.
```
