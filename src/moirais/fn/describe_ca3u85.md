# describe('ca3u85') — ca_chapter_3_unnumbered_85
...
```python
from moirais.fn.ca3u85 import ca_chapter_3_unnumbered_85
import numpy as np
result = ca_chapter_3_unnumbered_85(np.random.default_rng(42).normal(0, 1, 100))
