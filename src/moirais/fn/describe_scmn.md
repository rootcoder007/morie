...
`print(result)` render. See `moirais.fn.describe('scmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scmn import *
import numpy as np
# See the function signature in fn/scmn.py for argument names.
```
