# describe('bnpht') — bayesian_nonparametric_test
...
`print(result)` render. See `moirais.fn.describe('bnpht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnpht import *
import numpy as np
# See the function signature in fn/bnpht.py for argument names.
```
