...
`print(result)` render. See `moirais.fn.describe('ubpkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubpkn import *
import numpy as np
# See the function signature in fn/ubpkn.py for argument names.
```
