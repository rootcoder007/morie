...
`print(result)` render. See `moirais.fn.describe('gnsjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsjac import *
import numpy as np
# See the function signature in fn/gnsjac.py for argument names.
```
