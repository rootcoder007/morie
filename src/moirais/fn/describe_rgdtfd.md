# describe('rgdtfd') — rangayyan_decomp_tfd
...
`print(result)` render. See `moirais.fn.describe('rgdtfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdtfd import *
import numpy as np
# See the function signature in fn/rgdtfd.py for argument names.
```
