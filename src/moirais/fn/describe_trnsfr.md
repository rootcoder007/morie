# describe('trnsfr') — transfer_learning_msm
...
`print(result)` render. See `moirais.fn.describe('trnsfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnsfr import *
import numpy as np
# See the function signature in fn/trnsfr.py for argument names.
```
