...
`print(result)` render. See `moirais.fn.describe('zxtda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxtda import *
import numpy as np
# See the function signature in fn/zxtda.py for argument names.
```
