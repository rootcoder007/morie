# describe('fzhok') — fauzi_higher_order_kernel
...
`print(result)` render. See `moirais.fn.describe('fzhok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzhok import *
import numpy as np
# See the function signature in fn/fzhok.py for argument names.
```
