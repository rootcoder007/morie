...
`print(result)` render. See `moirais.fn.describe('sir_d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sir_d import *
import numpy as np
# See the function signature in fn/sir_d.py for argument names.
```
