# describe('envdt') — envelope_detect
...
`print(result)` render. See `moirais.fn.describe('envdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.envdt import *
import numpy as np
# See the function signature in fn/envdt.py for argument names.
```
