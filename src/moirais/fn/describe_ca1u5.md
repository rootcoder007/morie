# describe('ca1u5') — ca_chapter_1_unnumbered_5
...
```python
from moirais.fn.ca1u5 import ca_chapter_1_unnumbered_5
import numpy as np
result = ca_chapter_1_unnumbered_5(np.random.default_rng(42).normal(0, 1, 100))
