...
__all__ = ["hedderich_chapter_9_unnumbered_971"]


def hedderich_chapter_9_unnumbered_971(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u971')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u971: GeneralStatistics expression (auto-extracted; see ref)."
