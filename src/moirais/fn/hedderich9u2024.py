...
__all__ = ["hedderich_chapter_9_unnumbered_2024"]


def hedderich_chapter_9_unnumbered_2024(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: A simple example withk = 2 homogeneous subgroups (H0 :µ1 =µ2,HA :µ1̸=µ2,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2024')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2024: GeneralStatistics expression (auto-extracted; see ref)."
