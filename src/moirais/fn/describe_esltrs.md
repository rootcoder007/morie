# describe('esltrs') — esl_basis_truncated
...
`print(result)` render. See `moirais.fn.describe('esltrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esltrs import *
import numpy as np
# See the function signature in fn/esltrs.py for argument names.
```
