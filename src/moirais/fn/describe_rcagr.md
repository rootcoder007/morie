# describe('rcagr') — agreement_scores
...
`print(result)` render. See `moirais.fn.describe('rcagr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcagr import *
import numpy as np
# See the function signature in fn/rcagr.py for argument names.
```
