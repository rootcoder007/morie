...
`print(result)` render. See `moirais.fn.describe('sawvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawvr import *
import numpy as np
# See the function signature in fn/sawvr.py for argument names.
```
