# describe('aitzmu') — compositional_zero_multreplace
...
`print(result)` render. See `moirais.fn.describe('aitzmu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitzmu import *
import numpy as np
# See the function signature in fn/aitzmu.py for argument names.
```
