...
`print(result)` render. See `moirais.fn.describe('sveln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sveln import *
import numpy as np
# See the function signature in fn/sveln.py for argument names.
```
