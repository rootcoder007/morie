...
__all__ = ["use_r_chapter_2_unnumbered_223"]


def use_r_chapter_2_unnumbered_223(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + bandwidth = bwG, gweight = gwr.Gauss, hatmatrix = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u223')`` for the full guide.
...
def cheatsheet():
    return "use_r2u223: GeneralStatistics expression (auto-extracted; see ref)."
