# describe('hmsymd') — geron_symbolic_diff
...
`print(result)` render. See `moirais.fn.describe('hmsymd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsymd import *
import numpy as np
# See the function signature in fn/hmsymd.py for argument names.
```
