# describe('rnacov') — rna_covariance
...
`print(result)` render. See `moirais.fn.describe('rnacov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnacov import *
import numpy as np
# See the function signature in fn/rnacov.py for argument names.
```
