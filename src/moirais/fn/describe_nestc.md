...
`print(result)` render. See `moirais.fn.describe('nestc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nestc import *
import numpy as np
# See the function signature in fn/nestc.py for argument names.
```
