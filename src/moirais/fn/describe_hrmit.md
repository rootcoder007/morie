# describe('hrmit') — hermite_interp

## WHAT IT DOES

Hermite interpolation. 'Impressive. Most impressive.'You have power over your mind — not outside events. — Marcus Aurelius's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('hrmit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrmit import *
import numpy as np
# See the function signature in fn/hrmit.py for argument names.
```
