# describe('msm267') — mvsml_convolutional_nn_eq_14_4
...
`print(result)` render. See `moirais.fn.describe('msm267')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm267 import *
import numpy as np
# See the function signature in fn/msm267.py for argument names.
```
