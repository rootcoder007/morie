...
`print(result)` render. See `moirais.fn.describe('vitmlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitmlp import *
import numpy as np
# See the function signature in fn/vitmlp.py for argument names.
```
