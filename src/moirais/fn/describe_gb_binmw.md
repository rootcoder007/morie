# describe('gb_binmw') — gibbons_mw_binomial_link
...
`print(result)` render. See `moirais.fn.describe('gb_binmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_binmw import *
import numpy as np
# See the function signature in fn/gb_binmw.py for argument names.
```
