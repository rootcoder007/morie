# describe('ca11e22') — ca_chapter_11_equation_22
...
```python
from moirais.fn.ca11e22 import ca_chapter_11_equation_22
import numpy as np
result = ca_chapter_11_equation_22(np.random.default_rng(42).normal(0, 1, 100))
