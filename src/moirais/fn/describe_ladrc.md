# describe('ladrc') — ladder_of_causation
...
`print(result)` render. See `moirais.fn.describe('ladrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ladrc import *
import numpy as np
# See the function signature in fn/ladrc.py for argument names.
```
