...
`print(result)` render. See `moirais.fn.describe('wvjst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvjst import *
import numpy as np
# See the function signature in fn/wvjst.py for argument names.
```
