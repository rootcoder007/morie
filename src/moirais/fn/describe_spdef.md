...
`print(result)` render. See `moirais.fn.describe('spdef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spdef import *
import numpy as np
# See the function signature in fn/spdef.py for argument names.
```
