# describe('cvxrgl') — boyd_regularized_ls
...
`print(result)` render. See `moirais.fn.describe('cvxrgl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxrgl import *
import numpy as np
# See the function signature in fn/cvxrgl.py for argument names.
```
