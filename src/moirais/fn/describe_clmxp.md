...
`print(result)` render. See `moirais.fn.describe('clmxp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clmxp import *
import numpy as np
# See the function signature in fn/clmxp.py for argument names.
```
