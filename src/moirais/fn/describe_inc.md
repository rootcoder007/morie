...
`print(result)` render. See `moirais.fn.describe('inc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inc import *
import numpy as np
# See the function signature in fn/inc.py for argument names.
```
