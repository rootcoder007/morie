# describe('agdpck') — alphazero_data_pickle
...
`print(result)` render. See `moirais.fn.describe('agdpck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdpck import *
import numpy as np
# See the function signature in fn/agdpck.py for argument names.
```
