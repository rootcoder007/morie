...
def ca_chapter_8_equation_2(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8e2')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Dispersion expression involving 'difference' (auto-extracted; see reference for full context)."},
    )
