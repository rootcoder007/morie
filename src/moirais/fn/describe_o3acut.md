...
`print(result)` render. See `moirais.fn.describe('o3acut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.o3acut import *
import numpy as np
# See the function signature in fn/o3acut.py for argument names.
```
