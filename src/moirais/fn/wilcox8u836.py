...
__all__ = ["wilcox_chapter_8_unnumbered_836"]


def wilcox_chapter_8_unnumbered_836(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (µ 111 − µ 112) − (µ 121 − µ 122) = µ 111 − µ 112 − µ 121 +µ 122 ̸= 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u836')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u836: GeneralStatistics expression (auto-extracted; see ref)."
