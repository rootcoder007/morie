# describe('rbnd') — sensitivity_rosenbaum
...
`print(result)` render. See `moirais.fn.describe('rbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbnd import *
import numpy as np
# See the function signature in fn/rbnd.py for argument names.
```
