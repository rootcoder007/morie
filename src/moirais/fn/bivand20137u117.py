...
__all__ = ["bivand2013_chapter_7_unnumbered_117"]


def bivand2013_chapter_7_unnumbered_117(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + rho = RHO, alphas = 1, betas = 1, covars = Hay_mat,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u117')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u117: GeneralStatistics expression (auto-extracted; see ref)."
