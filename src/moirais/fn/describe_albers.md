...
`print(result)` render. See `moirais.fn.describe('albers')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.albers import *
import numpy as np
# See the function signature in fn/albers.py for argument names.
```
