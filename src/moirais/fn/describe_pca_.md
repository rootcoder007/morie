...
`print(result)` render. See `moirais.fn.describe('pca_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pca_ import *
import numpy as np
# See the function signature in fn/pca_.py for argument names.
```
