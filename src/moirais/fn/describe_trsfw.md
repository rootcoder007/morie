...
`print(result)` render. See `moirais.fn.describe('trsfw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsfw import *
import numpy as np
# See the function signature in fn/trsfw.py for argument names.
```
