# describe('hmipca') — geron_incremental_pca
...
`print(result)` render. See `moirais.fn.describe('hmipca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmipca import *
import numpy as np
# See the function signature in fn/hmipca.py for argument names.
```
