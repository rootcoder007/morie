...
__all__ = ["hedderich_chapter_9_unnumbered_2964"]


def hedderich_chapter_9_unnumbered_2964(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆβj =n.j/n.. j = 1,...,c
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2964')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2964: GeneralStatistics expression (auto-extracted; see ref)."
