# describe('dwtfn') — _daubechies_filter
...
`print(result)` render. See `moirais.fn.describe('dwtfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwtfn import *
import numpy as np
# See the function signature in fn/dwtfn.py for argument names.
```
