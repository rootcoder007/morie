...
`print(result)` render. See `moirais.fn.describe('agplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agplt import *
import numpy as np
# See the function signature in fn/agplt.py for argument names.
```
