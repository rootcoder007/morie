...
`print(result)` render. See `moirais.fn.describe('vecmF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vecmF import *
import numpy as np
# See the function signature in fn/vecmF.py for argument names.
```
