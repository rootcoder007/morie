...
__all__ = ["wilcox_chapter_9_unnumbered_1064"]


def wilcox_chapter_9_unnumbered_1064(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Rule: Reject if F ≥ f , where f is the 1 − α quantile
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1064')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1064: GeneralStatistics expression (auto-extracted; see ref)."
