...
`print(result)` render. See `moirais.fn.describe('survvae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survvae import *
import numpy as np
# See the function signature in fn/survvae.py for argument names.
```
