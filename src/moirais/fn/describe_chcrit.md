...
`print(result)` render. See `moirais.fn.describe('chcrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chcrit import *
import numpy as np
# See the function signature in fn/chcrit.py for argument names.
```
