# describe('mtoft') — mto_fatality_rate
...
`print(result)` render. See `moirais.fn.describe('mtoft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtoft import *
import numpy as np
# See the function signature in fn/mtoft.py for argument names.
```
