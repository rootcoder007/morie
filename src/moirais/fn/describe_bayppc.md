# describe('bayppc') — posterior_predictive_check
...
`print(result)` render. See `moirais.fn.describe('bayppc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayppc import *
import numpy as np
# See the function signature in fn/bayppc.py for argument names.
```
