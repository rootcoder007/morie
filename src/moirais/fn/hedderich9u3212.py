...
__all__ = ["hedderich_chapter_9_unnumbered_3212"]


def hedderich_chapter_9_unnumbered_3212(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2.862 = 2.64> 1.99 = t78;0.975
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3212')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3212: GeneralStatistics expression (auto-extracted; see ref)."
