...
`print(result)` render. See `moirais.fn.describe('svfxl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svfxl import *
import numpy as np
# See the function signature in fn/svfxl.py for argument names.
```
