# describe('ksr021') — kosorok_ch1_residual_empirical_distribution
...
`print(result)` render. See `moirais.fn.describe('ksr021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr021 import *
import numpy as np
# See the function signature in fn/ksr021.py for argument names.
```
