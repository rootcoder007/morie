# describe('marve') — ma_robust_variance_est
...
`print(result)` render. See `moirais.fn.describe('marve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.marve import *
import numpy as np
# See the function signature in fn/marve.py for argument names.
```
