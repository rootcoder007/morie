...
`print(result)` render. See `moirais.fn.describe('spcsim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcsim2 import *
import numpy as np
# See the function signature in fn/spcsim2.py for argument names.
```
