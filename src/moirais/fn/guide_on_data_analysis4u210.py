...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_210"]


def guide_on_data_analysis_chapter_4_unnumbered_210(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 49, p-value < 2.2e-16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u210')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u210: GeneralStatistics expression (auto-extracted; see ref)."
