...
`print(result)` render. See `moirais.fn.describe('colMet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.colMet import *
import numpy as np
# See the function signature in fn/colMet.py for argument names.
```
