...
`print(result)` render. See `moirais.fn.describe('zxfda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxfda import *
import numpy as np
# See the function signature in fn/zxfda.py for argument names.
```
