# describe('rng249') — rangayyan_ch4_fourier_signal_echo
...
`print(result)` render. See `moirais.fn.describe('rng249')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng249 import *
import numpy as np
# See the function signature in fn/rng249.py for argument names.
```
