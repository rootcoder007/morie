...
`print(result)` render. See `moirais.fn.describe('trbkl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trbkl import *
import numpy as np
# See the function signature in fn/trbkl.py for argument names.
```
