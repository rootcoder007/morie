...
`print(result)` render. See `moirais.fn.describe('slxols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxols import *
import numpy as np
# See the function signature in fn/slxols.py for argument names.
```
