# describe('svdrv') — directional_vote
...
`print(result)` render. See `moirais.fn.describe('svdrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdrv import *
import numpy as np
# See the function signature in fn/svdrv.py for argument names.
```
