# describe('bpc') — bits_per_character
...
`print(result)` render. See `moirais.fn.describe('bpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpc import *
import numpy as np
# See the function signature in fn/bpc.py for argument names.
```
