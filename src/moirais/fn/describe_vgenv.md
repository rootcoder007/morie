...
`print(result)` render. See `moirais.fn.describe('vgenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgenv import *
import numpy as np
# See the function signature in fn/vgenv.py for argument names.
```
