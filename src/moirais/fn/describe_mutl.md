# describe('mutl') — mutual_information
...
`print(result)` render. See `moirais.fn.describe('mutl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mutl import *
import numpy as np
# See the function signature in fn/mutl.py for argument names.
```
