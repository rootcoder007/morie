...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1637"]


def guide_on_data_analysis_chapter_30_unnumbered_1637(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: treatment_status_var = "California",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1637')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1637: GeneralStatistics expression (auto-extracted; see ref)."
