...
`print(result)` render. See `moirais.fn.describe('magsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magsd import *
import numpy as np
# See the function signature in fn/magsd.py for argument names.
```
