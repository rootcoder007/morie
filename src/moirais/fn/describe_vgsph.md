# describe('vgsph') — vario_spherical
...
`print(result)` render. See `moirais.fn.describe('vgsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgsph import *
import numpy as np
# See the function signature in fn/vgsph.py for argument names.
```
