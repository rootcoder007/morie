...
__all__ = ["wilcox_chapter_13_unnumbered_1182"]


def wilcox_chapter_13_unnumbered_1182(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: j <k. As previously indicated, method SA1 is limited to testing at the α = 0.05 level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1182')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1182: GeneralStatistics expression (auto-extracted; see ref)."
