...
`print(result)` render. See `moirais.fn.describe('nutss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nutss import *
import numpy as np
# See the function signature in fn/nutss.py for argument names.
```
