...
`print(result)` render. See `moirais.fn.describe('afslc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslc import *
import numpy as np
# See the function signature in fn/afslc.py for argument names.
```
