...
`print(result)` render. See `moirais.fn.describe('smatch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smatch import *
import numpy as np
# See the function signature in fn/smatch.py for argument names.
```
