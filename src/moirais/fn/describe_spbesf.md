# describe('spbesf') — schabenberger_bessel_function
...
`print(result)` render. See `moirais.fn.describe('spbesf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spbesf import *
import numpy as np
# See the function signature in fn/spbesf.py for argument names.
```
