...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_12(x, cdf=None):
    ...
    Formula: fert_long_sub$fert_cons[fert_long_sub$fert_cons ==
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('Study the past if you would define the future. — Confucius')`` for the full guide.
