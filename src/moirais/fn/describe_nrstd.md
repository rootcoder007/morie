...
`print(result)` render. See `moirais.fn.describe('nrstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrstd import *
import numpy as np
# See the function signature in fn/nrstd.py for argument names.
```
