# describe('msm193') — mvsml_ridge_lasso_elastic_eq_9_21
...
`print(result)` render. See `moirais.fn.describe('msm193')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm193 import *
import numpy as np
# See the function signature in fn/msm193.py for argument names.
```
