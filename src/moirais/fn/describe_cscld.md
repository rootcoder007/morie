...
`print(result)` render. See `moirais.fn.describe('cscld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscld import *
import numpy as np
# See the function signature in fn/cscld.py for argument names.
```
