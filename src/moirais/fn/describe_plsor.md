...
`print(result)` render. See `moirais.fn.describe('plsor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plsor import *
import numpy as np
# See the function signature in fn/plsor.py for argument names.
```
