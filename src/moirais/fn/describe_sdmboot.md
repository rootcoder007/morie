...
`print(result)` render. See `moirais.fn.describe('sdmboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmboot import *
import numpy as np
# See the function signature in fn/sdmboot.py for argument names.
```
