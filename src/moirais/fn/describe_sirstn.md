# describe('sirstn') — sir_stochastic
...
`print(result)` render. See `moirais.fn.describe('sirstn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirstn import *
import numpy as np
# See the function signature in fn/sirstn.py for argument names.
```
