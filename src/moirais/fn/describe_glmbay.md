...
`print(result)` render. See `moirais.fn.describe('glmbay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmbay import *
import numpy as np
# See the function signature in fn/glmbay.py for argument names.
```
