# describe('rng054') — rangayyan_ch3_z_transform_convolution
...
`print(result)` render. See `moirais.fn.describe('rng054')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng054 import *
import numpy as np
# See the function signature in fn/rng054.py for argument names.
```
