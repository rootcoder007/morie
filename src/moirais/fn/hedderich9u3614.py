...
__all__ = ["hedderich_chapter_9_unnumbered_3614"]


def hedderich_chapter_9_unnumbered_3614(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: coxph ( formula = Surv ( futime , fustat ) ~ age + r x + resid. ds +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3614')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3614: GeneralStatistics expression (auto-extracted; see ref)."
