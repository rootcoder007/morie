...
__all__ = ["guide_on_data_analysis_chapter_13_unnumbered_867"]


def guide_on_data_analysis_chapter_13_unnumbered_867(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: gg_miss_fct(x = variable1, fct = variable2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis13u867')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis13u867: GeneralStatistics expression (auto-extracted; see ref)."
