...
`print(result)` render. See `moirais.fn.describe('rsrfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsrfc import *
import numpy as np
# See the function signature in fn/rsrfc.py for argument names.
```
