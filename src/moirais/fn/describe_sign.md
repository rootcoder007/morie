...
`print(result)` render. See `moirais.fn.describe('sign')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sign import *
import numpy as np
# See the function signature in fn/sign.py for argument names.
```
