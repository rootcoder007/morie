...
`print(result)` render. See `moirais.fn.describe('h_mean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.h_mean import *
import numpy as np
# See the function signature in fn/h_mean.py for argument names.
```
