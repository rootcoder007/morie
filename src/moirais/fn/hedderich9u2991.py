...
__all__ = ["hedderich_chapter_9_unnumbered_2991"]


def hedderich_chapter_9_unnumbered_2991(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: χ2 =n·min (r−1, c−1) ⇔X,Y completely stochastically dependent (7.364)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2991')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2991: GeneralStatistics expression (auto-extracted; see ref)."
