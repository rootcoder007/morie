# describe('ca8u280') — ca_chapter_8_unnumbered_280
...
each of the group means with n1 = n2 = ... = nk.
...
```python
from moirais.fn.ca8u280 import ca_chapter_8_unnumbered_280
import numpy as np
result = ca_chapter_8_unnumbered_280(np.random.default_rng(42).normal(0, 1, 100))
