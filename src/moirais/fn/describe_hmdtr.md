# describe('hmdtr') — geron_tree_regularization
...
`print(result)` render. See `moirais.fn.describe('hmdtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdtr import *
import numpy as np
# See the function signature in fn/hmdtr.py for argument names.
```
