...
`print(result)` render. See `moirais.fn.describe('cmaopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmaopt import *
import numpy as np
# See the function signature in fn/cmaopt.py for argument names.
```
