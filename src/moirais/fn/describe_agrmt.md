# describe('agrmt') — agreement_score
...
`print(result)` render. See `moirais.fn.describe('agrmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agrmt import *
import numpy as np
# See the function signature in fn/agrmt.py for argument names.
```
