...
`print(result)` render. See `moirais.fn.describe('ivcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ivcrt import *
import numpy as np
# See the function signature in fn/ivcrt.py for argument names.
```
