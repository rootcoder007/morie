# describe('rrblp') — rrblup_marker_effects
...
`print(result)` render. See `moirais.fn.describe('rrblp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rrblp import *
import numpy as np
# See the function signature in fn/rrblp.py for argument names.
```
