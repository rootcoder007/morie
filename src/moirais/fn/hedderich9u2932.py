...
__all__ = ["hedderich_chapter_9_unnumbered_2932"]


def hedderich_chapter_9_unnumbered_2932(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: i > ˆB+) withs = count(Xi−niπ0)> 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2932')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2932: CountModels expression (auto-extracted; see ref)."
