...
`print(result)` render. See `moirais.fn.describe('slxwx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxwx import *
import numpy as np
# See the function signature in fn/slxwx.py for argument names.
```
