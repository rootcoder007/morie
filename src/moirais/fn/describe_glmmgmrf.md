...
`print(result)` render. See `moirais.fn.describe('glmmgmrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmgmrf import *
import numpy as np
# See the function signature in fn/glmmgmrf.py for argument names.
```
