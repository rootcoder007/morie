# describe('tnvest') — test_negative_design
...
`print(result)` render. See `moirais.fn.describe('tnvest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tnvest import *
import numpy as np
# See the function signature in fn/tnvest.py for argument names.
```
