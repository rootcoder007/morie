...
__all__ = ["hedderich_chapter_9_unnumbered_936"]


def hedderich_chapter_9_unnumbered_936(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: max(Xn+1,...,X n+m) = ˆλ+k·ˆδ with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u936')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u936: GeneralStatistics expression (auto-extracted; see ref)."
