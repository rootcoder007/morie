...
`print(result)` render. See `moirais.fn.describe('maoys')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maoys import *
import numpy as np
# See the function signature in fn/maoys.py for argument names.
```
