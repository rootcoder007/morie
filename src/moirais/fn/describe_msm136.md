# describe('msm136') — mvsml_categorical_count_eq_8_6
...
`print(result)` render. See `moirais.fn.describe('msm136')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm136 import *
import numpy as np
# See the function signature in fn/msm136.py for argument names.
```
