# describe('defdtr') — deformable_detr
...
`print(result)` render. See `moirais.fn.describe('defdtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.defdtr import *
import numpy as np
# See the function signature in fn/defdtr.py for argument names.
```
