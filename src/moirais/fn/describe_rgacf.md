# describe('rgacf') — rangayyan_acf_estimate
...
`print(result)` render. See `moirais.fn.describe('rgacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgacf import *
import numpy as np
# See the function signature in fn/rgacf.py for argument names.
```
