# describe('spgwrk') — schabenberger_gwr_kernels
...
`print(result)` render. See `moirais.fn.describe('spgwrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgwrk import *
import numpy as np
# See the function signature in fn/spgwrk.py for argument names.
```
