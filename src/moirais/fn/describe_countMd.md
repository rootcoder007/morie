# describe('countMd') — count_mediation
...
`print(result)` render. See `moirais.fn.describe('countMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.countMd import *
import numpy as np
# See the function signature in fn/countMd.py for argument names.
```
