# describe('ncoef') — normalize_coefficients
...
`print(result)` render. See `moirais.fn.describe('ncoef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ncoef import *
import numpy as np
# See the function signature in fn/ncoef.py for argument names.
```
