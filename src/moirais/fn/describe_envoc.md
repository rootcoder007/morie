...
`print(result)` render. See `moirais.fn.describe('envoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.envoc import *
import numpy as np
# See the function signature in fn/envoc.py for argument names.
```
