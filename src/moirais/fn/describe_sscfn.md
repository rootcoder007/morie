# describe('sscfn') — slope_sign_changes_fn
...
`print(result)` render. See `moirais.fn.describe('sscfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sscfn import *
import numpy as np
# See the function signature in fn/sscfn.py for argument names.
```
