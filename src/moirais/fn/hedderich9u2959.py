...
__all__ = ["hedderich_chapter_9_unnumbered_2959"]


def hedderich_chapter_9_unnumbered_2959(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: nij from table 7.73 are multinomially distributed with the parameters (π11,...,πrc)⊺ = π. To
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2959')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2959: GeneralStatistics expression (auto-extracted; see ref)."
