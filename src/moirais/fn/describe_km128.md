# describe('km128') — kamath_ch8_pass_at_k
...
`print(result)` render. See `moirais.fn.describe('km128')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km128 import *
import numpy as np
# See the function signature in fn/km128.py for argument names.
```
