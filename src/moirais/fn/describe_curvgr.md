...
`print(result)` render. See `moirais.fn.describe('curvgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.curvgr import *
import numpy as np
# See the function signature in fn/curvgr.py for argument names.
```
