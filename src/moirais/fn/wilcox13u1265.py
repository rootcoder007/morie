...
__all__ = ["wilcox_chapter_13_unnumbered_1265"]


def wilcox_chapter_13_unnumbered_1265(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: npts=25,p.crit=NULL,nreps=5000,SEED=TRUE,EST=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1265')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1265: PowerAndDesign expression (auto-extracted; see ref)."
