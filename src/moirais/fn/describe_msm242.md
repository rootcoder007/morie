# describe('msm242') — mvsml_preprocessing_eq_2_3
...
`print(result)` render. See `moirais.fn.describe('msm242')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm242 import *
import numpy as np
# See the function signature in fn/msm242.py for argument names.
```
