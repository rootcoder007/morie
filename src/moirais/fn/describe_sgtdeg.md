# describe('sgtdeg') — sgt_degree_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtdeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtdeg import *
import numpy as np
# See the function signature in fn/sgtdeg.py for argument names.
```
