...
`print(result)` render. See `moirais.fn.describe('afrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afrng import *
import numpy as np
# See the function signature in fn/afrng.py for argument names.
```
