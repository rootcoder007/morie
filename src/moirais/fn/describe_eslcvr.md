...
`print(result)` render. See `moirais.fn.describe('eslcvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslcvr import *
import numpy as np
# See the function signature in fn/eslcvr.py for argument names.
```
