# describe('wsmcfn') — wasserman_char_fn
...
`print(result)` render. See `moirais.fn.describe('wsmcfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcfn import *
import numpy as np
# See the function signature in fn/wsmcfn.py for argument names.
```
