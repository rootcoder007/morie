...
__all__ = ["hedderich_chapter_9_unnumbered_2553"]


def hedderich_chapter_9_unnumbered_2553(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Z = 3 . 1 1 7 7 , p− value = 0.001823
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2553')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2553: GeneralStatistics expression (auto-extracted; see ref)."
