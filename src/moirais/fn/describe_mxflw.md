...
`print(result)` render. See `moirais.fn.describe('mxflw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxflw import *
import numpy as np
# See the function signature in fn/mxflw.py for argument names.
```
