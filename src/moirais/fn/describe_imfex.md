...
`print(result)` render. See `moirais.fn.describe('imfex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imfex import *
import numpy as np
# See the function signature in fn/imfex.py for argument names.
```
