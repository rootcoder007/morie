# describe('phylo') — phylogenetic_diversity
...
`print(result)` render. See `moirais.fn.describe('phylo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phylo import *
import numpy as np
# See the function signature in fn/phylo.py for argument names.
```
