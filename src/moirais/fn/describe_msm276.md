# describe('msm276') — mvsml_convolutional_nn_eq_14_8
...
`print(result)` render. See `moirais.fn.describe('msm276')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm276 import *
import numpy as np
# See the function signature in fn/msm276.py for argument names.
```
