# describe('grrmsp') — geron_rmsprop_update
...
`print(result)` render. See `moirais.fn.describe('grrmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrmsp import *
import numpy as np
# See the function signature in fn/grrmsp.py for argument names.
```
