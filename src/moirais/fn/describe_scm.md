# describe('scm') — structural_causal_model
...
`print(result)` render. See `moirais.fn.describe('scm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scm import *
import numpy as np
# See the function signature in fn/scm.py for argument names.
```
