...
def ca_chapter_5_unnumbered_148(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u148')`` for the full guide.
...
def cheatsheet():
    return "ca5u148: GeneralStatistics expression involving 'conviction' (auto-extracted; see reference for full context)."
