...
`print(result)` render. See `moirais.fn.describe('svbut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svbut import *
import numpy as np
# See the function signature in fn/svbut.py for argument names.
```
