# describe('rng091') — rangayyan_ch3_hann_z_output
...
`print(result)` render. See `moirais.fn.describe('rng091')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng091 import *
import numpy as np
# See the function signature in fn/rng091.py for argument names.
```
