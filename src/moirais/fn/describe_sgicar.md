# describe('sgicar') — intrinsic_car_model
...
`print(result)` render. See `moirais.fn.describe('sgicar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgicar import *
import numpy as np
# See the function signature in fn/sgicar.py for argument names.
```
