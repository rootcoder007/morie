# describe('crlb') — cramer_rao_lower_bound
...
`print(result)` render. See `moirais.fn.describe('crlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crlb import *
import numpy as np
# See the function signature in fn/crlb.py for argument names.
```
