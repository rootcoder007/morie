...
__all__ = ["hedderich_chapter_9_unnumbered_805"]


def hedderich_chapter_9_unnumbered_805(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (Z ≧ 4.00) = 0.4840−0.0000 = 0.484.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u805')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u805: GeneralStatistics expression (auto-extracted; see ref)."
