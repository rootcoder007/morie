# describe('survtdc') — time_dep_concordance
...
`print(result)` render. See `moirais.fn.describe('survtdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survtdc import *
import numpy as np
# See the function signature in fn/survtdc.py for argument names.
```
