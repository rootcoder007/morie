...
`print(result)` render. See `moirais.fn.describe('ipctw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipctw import *
import numpy as np
# See the function signature in fn/ipctw.py for argument names.
```
