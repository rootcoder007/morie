...
`print(result)` render. See `moirais.fn.describe('fzkdfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzkdfe import *
import numpy as np
# See the function signature in fn/fzkdfe.py for argument names.
```
