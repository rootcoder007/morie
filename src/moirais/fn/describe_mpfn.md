...
`print(result)` render. See `moirais.fn.describe('mpfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpfn import *
import numpy as np
# See the function signature in fn/mpfn.py for argument names.
```
