...
__all__ = ["bivand2013_chapter_2_unnumbered_11"]


def bivand2013_chapter_2_unnumbered_11(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > axis(1, at = c(178000 + 0.2 * 2000), cex.axis = 0.7)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u11')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u11: GeneralStatistics expression (auto-extracted; see ref)."
