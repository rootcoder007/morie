# describe('hmtfm') — geron_transformer
...
`print(result)` render. See `moirais.fn.describe('hmtfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtfm import *
import numpy as np
# See the function signature in fn/hmtfm.py for argument names.
```
