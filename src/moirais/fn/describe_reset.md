# describe('reset') — ramsey_reset_test
...
`print(result)` render. See `moirais.fn.describe('reset')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reset import *
import numpy as np
# See the function signature in fn/reset.py for argument names.
```
