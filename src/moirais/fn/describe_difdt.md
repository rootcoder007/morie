...
`print(result)` render. See `moirais.fn.describe('difdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difdt import *
import numpy as np
# See the function signature in fn/difdt.py for argument names.
```
