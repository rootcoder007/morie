...
`print(result)` render. See `moirais.fn.describe('gdemg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdemg import *
import numpy as np
# See the function signature in fn/gdemg.py for argument names.
```
