...
`print(result)` render. See `moirais.fn.describe('zegin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zegin import *
import numpy as np
# See the function signature in fn/zegin.py for argument names.
```
