# describe('grvpi') — geron_state_value_function
...
`print(result)` render. See `moirais.fn.describe('grvpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grvpi import *
import numpy as np
# See the function signature in fn/grvpi.py for argument names.
```
