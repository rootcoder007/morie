...
`print(result)` render. See `moirais.fn.describe('sfglob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfglob import *
import numpy as np
# See the function signature in fn/sfglob.py for argument names.
```
