...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1501"]


def guide_on_data_analysis_chapter_30_unnumbered_1501(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -3 x cohort = 4 0.59 (0.68)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1501')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1501: GeneralStatistics expression (auto-extracted; see ref)."
