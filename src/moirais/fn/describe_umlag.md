...
`print(result)` render. See `moirais.fn.describe('umlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umlag import *
import numpy as np
# See the function signature in fn/umlag.py for argument names.
```
