# describe('psstr') — propensity_stratify
...
`print(result)` render. See `moirais.fn.describe('psstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psstr import *
import numpy as np
# See the function signature in fn/psstr.py for argument names.
```
