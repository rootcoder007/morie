# describe('elasrg') — elastic_net_regression
...
`print(result)` render. See `moirais.fn.describe('elasrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elasrg import *
import numpy as np
# See the function signature in fn/elasrg.py for argument names.
```
