# describe('rng155') — rangayyan_ch3_lms_filter_output
...
`print(result)` render. See `moirais.fn.describe('rng155')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng155 import *
import numpy as np
# See the function signature in fn/rng155.py for argument names.
```
