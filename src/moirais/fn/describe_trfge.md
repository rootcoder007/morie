# describe('trfge') — transformer_genomic
...
`print(result)` render. See `moirais.fn.describe('trfge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trfge import *
import numpy as np
# See the function signature in fn/trfge.py for argument names.
```
