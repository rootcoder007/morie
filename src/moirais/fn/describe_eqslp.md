# describe('eqslp') — slope_inequality
...
`print(result)` render. See `moirais.fn.describe('eqslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqslp import *
import numpy as np
# See the function signature in fn/eqslp.py for argument names.
```
