...
`print(result)` render. See `moirais.fn.describe('logls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logls import *
import numpy as np
# See the function signature in fn/logls.py for argument names.
```
