...
`print(result)` render. See `moirais.fn.describe('frail')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frail import *
import numpy as np
# See the function signature in fn/frail.py for argument names.
```
