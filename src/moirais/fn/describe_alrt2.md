# describe('alrt2') — alrt_sr

## WHAT IT DOES

Suicide risk alert prevalence by year.
...
`print(result)` render. See `moirais.fn.describe('alrt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrt2 import *
import numpy as np
# See the function signature in fn/alrt2.py for argument names.
```
