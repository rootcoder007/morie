# describe('rgsinc') — rangayyan_sinc_kernel
...
`print(result)` render. See `moirais.fn.describe('rgsinc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsinc import *
import numpy as np
# See the function signature in fn/rgsinc.py for argument names.
```
