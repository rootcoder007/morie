# describe('hmgmm') — geron_gaussian_mixture
...
`print(result)` render. See `moirais.fn.describe('hmgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgmm import *
import numpy as np
# See the function signature in fn/hmgmm.py for argument names.
```
