...
`print(result)` render. See `moirais.fn.describe('mosum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mosum import *
import numpy as np
# See the function signature in fn/mosum.py for argument names.
```
