# describe('rgarsp') — rangayyan_ar_spectrum
...
`print(result)` render. See `moirais.fn.describe('rgarsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgarsp import *
import numpy as np
# See the function signature in fn/rgarsp.py for argument names.
```
