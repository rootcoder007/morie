...
`print(result)` render. See `moirais.fn.describe('cminc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cminc import *
import numpy as np
# See the function signature in fn/cminc.py for argument names.
```
