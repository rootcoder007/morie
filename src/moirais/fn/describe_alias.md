...
`print(result)` render. See `moirais.fn.describe('alias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alias import *
import numpy as np
# See the function signature in fn/alias.py for argument names.
```
