# describe('rgmdl') — rangayyan_ar_order_mdl
...
`print(result)` render. See `moirais.fn.describe('rgmdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmdl import *
import numpy as np
# See the function signature in fn/rgmdl.py for argument names.
```
