...
`print(result)` render. See `moirais.fn.describe('nn_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nn_ import *
import numpy as np
# See the function signature in fn/nn_.py for argument names.
```
