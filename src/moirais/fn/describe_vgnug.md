...
`print(result)` render. See `moirais.fn.describe('vgnug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgnug import *
import numpy as np
# See the function signature in fn/vgnug.py for argument names.
```
