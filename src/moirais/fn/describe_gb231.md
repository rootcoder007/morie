# describe('gb231') — gibbons_edf_binomial
...
`print(result)` render. See `moirais.fn.describe('gb231')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb231 import *
import numpy as np
# See the function signature in fn/gb231.py for argument names.
```
