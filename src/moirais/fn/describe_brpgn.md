...
`print(result)` render. See `moirais.fn.describe('brpgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brpgn import *
import numpy as np
# See the function signature in fn/brpgn.py for argument names.
```
