...
`print(result)` render. See `moirais.fn.describe('rstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rstst import *
import numpy as np
# See the function signature in fn/rstst.py for argument names.
```
