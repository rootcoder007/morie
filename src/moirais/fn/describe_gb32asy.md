# describe('gb32asy') — gibbons_runs_asymp_normal
...
`print(result)` render. See `moirais.fn.describe('gb32asy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32asy import *
import numpy as np
# See the function signature in fn/gb32asy.py for argument names.
```
