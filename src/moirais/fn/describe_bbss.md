...
`print(result)` render. See `moirais.fn.describe('bbss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbss import *
import numpy as np
# See the function signature in fn/bbss.py for argument names.
```
