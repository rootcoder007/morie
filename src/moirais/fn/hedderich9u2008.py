...
__all__ = ["hedderich_chapter_9_unnumbered_2008"]


def hedderich_chapter_9_unnumbered_2008(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ˆt = |¯x1−¯x2|√[n1+n2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2008')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2008: PowerAndDesign expression (auto-extracted; see ref)."
