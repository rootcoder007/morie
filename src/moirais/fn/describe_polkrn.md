# describe('polkrn') — polynomial_kernel_msm
...
`print(result)` render. See `moirais.fn.describe('polkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polkrn import *
import numpy as np
# See the function signature in fn/polkrn.py for argument names.
```
