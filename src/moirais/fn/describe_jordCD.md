# describe('jordCD') — jordan_canonical
...
`print(result)` render. See `moirais.fn.describe('jordCD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jordCD import *
import numpy as np
# See the function signature in fn/jordCD.py for argument names.
```
