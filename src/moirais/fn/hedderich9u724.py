...
__all__ = ["hedderich_chapter_9_unnumbered_724"]


def hedderich_chapter_9_unnumbered_724(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pvalue <− pchisq ( stat , df =n −1 , lower . tail =F )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u724')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u724: GeneralStatistics expression (auto-extracted; see ref)."
