...
`print(result)` render. See `moirais.fn.describe('drcur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drcur import *
import numpy as np
# See the function signature in fn/drcur.py for argument names.
```
