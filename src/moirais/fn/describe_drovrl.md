# describe('drovrl') — dr_did_overlap_trim
...
`print(result)` render. See `moirais.fn.describe('drovrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drovrl import *
import numpy as np
# See the function signature in fn/drovrl.py for argument names.
```
