...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_unnumbered_597(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: testing H0 :βr = 0 vs. Ha :βr̸= 0 for r = 1, ..., 6. The Anova() function provides
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo3u597')`` for the full guide.
