# describe('fzavar') — fauzi_quantile_asymp_var
...
`print(result)` render. See `moirais.fn.describe('fzavar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzavar import *
import numpy as np
# See the function signature in fn/fzavar.py for argument names.
```
