...
__all__ = ["hedderich_chapter_9_unnumbered_801"]


def hedderich_chapter_9_unnumbered_801(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F (−z) = P (Z≤−z) = P (Z≥z) = 1−P (Zz̄) = 1−F (z) (5.109)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u801')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u801: GeneralStatistics expression (auto-extracted; see ref)."
