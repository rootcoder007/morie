# describe('mdsex') — convex_hull_mds
...
`print(result)` render. See `moirais.fn.describe('mdsex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsex import *
import numpy as np
# See the function signature in fn/mdsex.py for argument names.
```
