# describe('itdif') — item_difficulty
...
`print(result)` render. See `moirais.fn.describe('itdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itdif import *
import numpy as np
# See the function signature in fn/itdif.py for argument names.
```
