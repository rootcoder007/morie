...
`print(result)` render. See `moirais.fn.describe('sotex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sotex import *
import numpy as np
# See the function signature in fn/sotex.py for argument names.
```
