...
`print(result)` render. See `moirais.fn.describe('cfawl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfawl import *
import numpy as np
# See the function signature in fn/cfawl.py for argument names.
```
