...
`print(result)` render. See `moirais.fn.describe('cauchw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cauchw import *
import numpy as np
# See the function signature in fn/cauchw.py for argument names.
```
