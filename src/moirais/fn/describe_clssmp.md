...
`print(result)` render. See `moirais.fn.describe('clssmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clssmp import *
import numpy as np
# See the function signature in fn/clssmp.py for argument names.
```
