...
`print(result)` render. See `moirais.fn.describe('addns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.addns import *
import numpy as np
# See the function signature in fn/addns.py for argument names.
```
