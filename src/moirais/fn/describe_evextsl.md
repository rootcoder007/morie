# describe('evextsl') — evt_extremal_index_slidblk
...
`print(result)` render. See `moirais.fn.describe('evextsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evextsl import *
import numpy as np
# See the function signature in fn/evextsl.py for argument names.
```
