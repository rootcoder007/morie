...
`print(result)` render. See `moirais.fn.describe('svgau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svgau import *
import numpy as np
# See the function signature in fn/svgau.py for argument names.
```
