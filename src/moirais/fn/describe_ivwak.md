...
`print(result)` render. See `moirais.fn.describe('ivwak')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ivwak import *
import numpy as np
# See the function signature in fn/ivwak.py for argument names.
```
