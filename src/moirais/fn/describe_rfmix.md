...
`print(result)` render. See `moirais.fn.describe('rfmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfmix import *
import numpy as np
# See the function signature in fn/rfmix.py for argument names.
```
