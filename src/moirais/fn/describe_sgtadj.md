# describe('sgtadj') — sgt_adjacency_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtadj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtadj import *
import numpy as np
# See the function signature in fn/sgtadj.py for argument names.
```
