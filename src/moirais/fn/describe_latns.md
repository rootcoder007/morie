# describe('latns') — latin_hypercube
...
`print(result)` render. See `moirais.fn.describe('latns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.latns import *
import numpy as np
# See the function signature in fn/latns.py for argument names.
```
