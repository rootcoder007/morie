# describe('wlcxn') — wilcoxon_survival
...
`print(result)` render. See `moirais.fn.describe('wlcxn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcxn import *
import numpy as np
# See the function signature in fn/wlcxn.py for argument names.
```
