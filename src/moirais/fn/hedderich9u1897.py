...
__all__ = ["hedderich_chapter_9_unnumbered_1897"]


def hedderich_chapter_9_unnumbered_1897(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + rval <− list ( method = method , statistic = prop )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1897')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1897: GeneralStatistics expression (auto-extracted; see ref)."
