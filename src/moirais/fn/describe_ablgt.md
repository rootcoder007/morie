...
`print(result)` render. See `moirais.fn.describe('ablgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ablgt import *
import numpy as np
# See the function signature in fn/ablgt.py for argument names.
```
