# describe('icrf') — item_characteristic_curve
...
`print(result)` render. See `moirais.fn.describe('icrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icrf import *
import numpy as np
# See the function signature in fn/icrf.py for argument names.
```
