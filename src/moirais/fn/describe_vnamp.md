# describe('vnamp') — veneziano_amplitude
...
`print(result)` render. See `moirais.fn.describe('vnamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vnamp import *
import numpy as np
# See the function signature in fn/vnamp.py for argument names.
```
