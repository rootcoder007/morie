...
`print(result)` render. See `moirais.fn.describe('liouB')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.liouB import *
import numpy as np
# See the function signature in fn/liouB.py for argument names.
```
