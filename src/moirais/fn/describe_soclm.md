...
`print(result)` render. See `moirais.fn.describe('soclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soclm import *
import numpy as np
# See the function signature in fn/soclm.py for argument names.
```
