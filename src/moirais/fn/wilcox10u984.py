...
__all__ = ["wilcox_chapter_10_unnumbered_984"]


def wilcox_chapter_10_unnumbered_984(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Ψ 3 =µ 1 − µ 2 − µ 3 +µ 4.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u984')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u984: PowerAndDesign expression (auto-extracted; see ref)."
