# describe('swsmp') — systematic_with_random_start
...
`print(result)` render. See `moirais.fn.describe('swsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swsmp import *
import numpy as np
# See the function signature in fn/swsmp.py for argument names.
```
