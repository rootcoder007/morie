...
`print(result)` render. See `moirais.fn.describe('gnsml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsml import *
import numpy as np
# See the function signature in fn/gnsml.py for argument names.
```
