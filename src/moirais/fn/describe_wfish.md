# describe('wfish') — wordfish_scaling
...
`print(result)` render. See `moirais.fn.describe('wfish')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wfish import *
import numpy as np
# See the function signature in fn/wfish.py for argument names.
```
