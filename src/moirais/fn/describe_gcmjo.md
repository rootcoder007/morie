...
`print(result)` render. See `moirais.fn.describe('gcmjo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcmjo import *
import numpy as np
# See the function signature in fn/gcmjo.py for argument names.
```
