...
`print(result)` render. See `moirais.fn.describe('crsfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsfst import *
import numpy as np
# See the function signature in fn/crsfst.py for argument names.
```
