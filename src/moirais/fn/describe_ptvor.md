...
`print(result)` render. See `moirais.fn.describe('ptvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptvor import *
import numpy as np
# See the function signature in fn/ptvor.py for argument names.
```
