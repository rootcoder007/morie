...
__all__ = ["wilcox_chapter_14_unnumbered_503"]


def wilcox_chapter_14_unnumbered_503(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u503')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u503: PowerAndDesign expression (auto-extracted; see ref)."
