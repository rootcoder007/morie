# describe('psis') — pareto_smoothed_importance_sampling
...
`print(result)` render. See `moirais.fn.describe('psis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psis import *
import numpy as np
# See the function signature in fn/psis.py for argument names.
```
