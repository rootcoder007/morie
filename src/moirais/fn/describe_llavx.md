# describe('llavx') — llava_visual_chat
...
`print(result)` render. See `moirais.fn.describe('llavx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.llavx import *
import numpy as np
# See the function signature in fn/llavx.py for argument names.
```
