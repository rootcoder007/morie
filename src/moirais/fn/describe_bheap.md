# describe('bheap') — binary_heap

## WHAT IT DOES

Binary heap operations. 'Knowing yourself is the beginning of all wisdom. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('bheap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bheap import *
import numpy as np
# See the function signature in fn/bheap.py for argument names.
```
