...
`print(result)` render. See `moirais.fn.describe('gehpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gehpr import *
import numpy as np
# See the function signature in fn/gehpr.py for argument names.
```
