# describe('arimab') — arima_box_jenkins
...
`print(result)` render. See `moirais.fn.describe('arimab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arimab import *
import numpy as np
# See the function signature in fn/arimab.py for argument names.
```
