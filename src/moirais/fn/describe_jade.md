...
`print(result)` render. See `moirais.fn.describe('jade')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jade import *
import numpy as np
# See the function signature in fn/jade.py for argument names.
```
