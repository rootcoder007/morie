# describe('rgepiksv') — rangayyan_epilepsy_ksvd
...
`print(result)` render. See `moirais.fn.describe('rgepiksv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgepiksv import *
import numpy as np
# See the function signature in fn/rgepiksv.py for argument names.
```
