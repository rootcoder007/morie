# describe('gb_wrc') — gibbons_runs_critical
...
`print(result)` render. See `moirais.fn.describe('gb_wrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wrc import *
import numpy as np
# See the function signature in fn/gb_wrc.py for argument names.
```
