...
__all__ = ["hedderich_chapter_9_unnumbered_616"]


def hedderich_chapter_9_unnumbered_616(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] pk(1−p)(n−k) for k = 0, 1, 2,...,n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u616')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u616: CountModels expression (auto-extracted; see ref)."
