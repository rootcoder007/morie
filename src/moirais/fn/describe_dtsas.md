...
`print(result)` render. See `moirais.fn.describe('dtsas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtsas import *
import numpy as np
# See the function signature in fn/dtsas.py for argument names.
```
