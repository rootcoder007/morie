# describe('gpani') — gpani

## WHAT IT DOES

GP anisotropic ARD kernel.
...
`print(result)` render. See `moirais.fn.describe('gpani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpani import *
import numpy as np
# See the function signature in fn/gpani.py for argument names.
```
