...
__all__ = ["hedderich_chapter_9_unnumbered_696"]


def hedderich_chapter_9_unnumbered_696(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (λ) = e−λ·λλ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u696')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u696: GeneralStatistics expression (auto-extracted; see ref)."
