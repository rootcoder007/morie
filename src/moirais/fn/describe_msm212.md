# describe('msm212') — mvsml_ridge_lasso_elastic_eq_9_32
...
`print(result)` render. See `moirais.fn.describe('msm212')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm212 import *
import numpy as np
# See the function signature in fn/msm212.py for argument names.
```
