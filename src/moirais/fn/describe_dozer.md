# describe('dozer') — pid_tune

## WHAT IT DOES

PID controller tuning. 'Time discovers truth. — Seneca'
...
`print(result)` render. See `moirais.fn.describe('dozer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dozer import *
import numpy as np
# See the function signature in fn/dozer.py for argument names.
```
