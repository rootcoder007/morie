...
`print(result)` render. See `moirais.fn.describe('olswt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.olswt import *
import numpy as np
# See the function signature in fn/olswt.py for argument names.
```
