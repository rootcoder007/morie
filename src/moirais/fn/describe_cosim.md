...
`print(result)` render. See `moirais.fn.describe('cosim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cosim import *
import numpy as np
# See the function signature in fn/cosim.py for argument names.
```
