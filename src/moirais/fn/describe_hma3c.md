...
`print(result)` render. See `moirais.fn.describe('hma3c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hma3c import *
import numpy as np
# See the function signature in fn/hma3c.py for argument names.
```
