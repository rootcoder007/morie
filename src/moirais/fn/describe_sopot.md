...
`print(result)` render. See `moirais.fn.describe('sopot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sopot import *
import numpy as np
# See the function signature in fn/sopot.py for argument names.
```
