...
__all__ = ["hedderich_chapter_9_unnumbered_2749"]


def hedderich_chapter_9_unnumbered_2749(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: hypothesis (π1 =π2 or independence) (becauseP <0.05) is rejected at the 5% level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2749')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2749: GeneralStatistics expression (auto-extracted; see ref)."
