...
__all__ = ["hedderich_chapter_9_unnumbered_2134"]


def hedderich_chapter_9_unnumbered_2134(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 5.5 = (4 + 5 + 6 + 7)/4; for the two eights, you then get 8.5; the value 13 appears three times and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2134')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2134: GeneralStatistics expression (auto-extracted; see ref)."
