...
`print(result)` render. See `moirais.fn.describe('recur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.recur import *
import numpy as np
# See the function signature in fn/recur.py for argument names.
```
