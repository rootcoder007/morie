...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_841"]


def guide_on_data_analysis_chapter_11_unnumbered_841(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: vcov = newey_west ~ Month + Day
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u841')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u841: GeneralStatistics expression (auto-extracted; see ref)."
