...
`print(result)` render. See `moirais.fn.describe('tmlivc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlivc import *
import numpy as np
# See the function signature in fn/tmlivc.py for argument names.
```
