# describe('synct') — synthetic_control
...
`print(result)` render. See `moirais.fn.describe('synct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.synct import *
import numpy as np
# See the function signature in fn/synct.py for argument names.
```
