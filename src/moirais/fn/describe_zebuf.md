# describe('zebuf') — buffer_exposure
...
`print(result)` render. See `moirais.fn.describe('zebuf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zebuf import *
import numpy as np
# See the function signature in fn/zebuf.py for argument names.
```
