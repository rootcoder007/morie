# describe('dwnmt') — dw_nominate_score
...
`print(result)` render. See `moirais.fn.describe('dwnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwnmt import *
import numpy as np
# See the function signature in fn/dwnmt.py for argument names.
```
