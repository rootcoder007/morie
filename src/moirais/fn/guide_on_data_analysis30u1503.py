...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1503"]


def guide_on_data_analysis_chapter_30_unnumbered_1503(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -3 x cohort = 6 0.07 (0.65)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1503')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1503: GeneralStatistics expression (auto-extracted; see ref)."
