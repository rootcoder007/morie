...
`print(result)` render. See `moirais.fn.describe('lambrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lambrt import *
import numpy as np
# See the function signature in fn/lambrt.py for argument names.
```
