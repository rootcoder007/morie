...
`print(result)` render. See `moirais.fn.describe('semspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semspec import *
import numpy as np
# See the function signature in fn/semspec.py for argument names.
```
