...
`print(result)` render. See `moirais.fn.describe('ar1cl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ar1cl import *
import numpy as np
# See the function signature in fn/ar1cl.py for argument names.
```
