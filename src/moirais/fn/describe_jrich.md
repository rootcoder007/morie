# describe('jrich') — formant_extract
...
`print(result)` render. See `moirais.fn.describe('jrich')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jrich import *
import numpy as np
# See the function signature in fn/jrich.py for argument names.
```
