...
`print(result)` render. See `moirais.fn.describe('newtn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.newtn import *
import numpy as np
# See the function signature in fn/newtn.py for argument names.
```
