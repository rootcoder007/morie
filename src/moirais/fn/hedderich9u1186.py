...
__all__ = ["hedderich_chapter_9_unnumbered_1186"]


def hedderich_chapter_9_unnumbered_1186(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i−ψi fori = 1, 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1186')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1186: GeneralStatistics expression (auto-extracted; see ref)."
