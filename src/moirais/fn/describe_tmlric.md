# describe('tmlric') — tmle_rare_outcome
...
`print(result)` render. See `moirais.fn.describe('tmlric')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlric import *
import numpy as np
# See the function signature in fn/tmlric.py for argument names.
```
