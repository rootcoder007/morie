# describe('km071') — kamath_ch5_dpo_reward_optimal
...
`print(result)` render. See `moirais.fn.describe('km071')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km071 import *
import numpy as np
# See the function signature in fn/km071.py for argument names.
```
