...
`print(result)` render. See `moirais.fn.describe('lmrerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmrerr import *
import numpy as np
# See the function signature in fn/lmrerr.py for argument names.
```
