...
`print(result)` render. See `moirais.fn.describe('mtcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcon import *
import numpy as np
# See the function signature in fn/mtcon.py for argument names.
```
