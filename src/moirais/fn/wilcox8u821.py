...
__all__ = ["wilcox_chapter_8_unnumbered_821"]


def wilcox_chapter_8_unnumbered_821(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: That is, cii = 1 and ci,i+1 = −1; i = 1,...,J − 1 and CK is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u821')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u821: Resampling expression (auto-extracted; see ref)."
