...
`print(result)` render. See `moirais.fn.describe('kmean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmean import *
import numpy as np
# See the function signature in fn/kmean.py for argument names.
```
