...
`print(result)` render. See `moirais.fn.describe('sczip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sczip import *
import numpy as np
# See the function signature in fn/sczip.py for argument names.
```
