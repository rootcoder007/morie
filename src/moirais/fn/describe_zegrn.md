# describe('zegrn') — gradient_spatial
...
`print(result)` render. See `moirais.fn.describe('zegrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zegrn import *
import numpy as np
# See the function signature in fn/zegrn.py for argument names.
```
