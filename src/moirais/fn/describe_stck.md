...
`print(result)` render. See `moirais.fn.describe('stck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stck import *
import numpy as np
# See the function signature in fn/stck.py for argument names.
```
