...
__all__ = ["wilcox_chapter_14_unnumbered_683"]


def wilcox_chapter_14_unnumbered_683(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: U = 59.6 + 306 + 166.5 + 176.2 = 708.3,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u683')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u683: GeneralStatistics expression (auto-extracted; see ref)."
