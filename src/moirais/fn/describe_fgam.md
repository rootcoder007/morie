...
`print(result)` render. See `moirais.fn.describe('fgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fgam import *
import numpy as np
# See the function signature in fn/fgam.py for argument names.
```
