...
`print(result)` render. See `moirais.fn.describe('sardet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sardet import *
import numpy as np
# See the function signature in fn/sardet.py for argument names.
```
