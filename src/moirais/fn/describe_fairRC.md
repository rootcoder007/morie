...
`print(result)` render. See `moirais.fn.describe('fairRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fairRC import *
import numpy as np
# See the function signature in fn/fairRC.py for argument names.
```
