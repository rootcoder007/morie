...
__all__ = ["hedderich_chapter_9_unnumbered_87"]


def hedderich_chapter_9_unnumbered_87(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (AB)−1 = B−1A−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u87')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u87: GeneralStatistics expression (auto-extracted; see ref)."
