# describe('intinf') — interaction_information
...
`print(result)` render. See `moirais.fn.describe('intinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intinf import *
import numpy as np
# See the function signature in fn/intinf.py for argument names.
```
