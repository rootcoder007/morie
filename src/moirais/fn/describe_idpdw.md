...
`print(result)` render. See `moirais.fn.describe('idpdw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpdw import *
import numpy as np
# See the function signature in fn/idpdw.py for argument names.
```
