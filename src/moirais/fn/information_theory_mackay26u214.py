...
__all__ = ["information_theory_mackay_chapter_26_unnumbered_214"]


def information_theory_mackay_chapter_26_unnumbered_214(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] K ln(S=) for d =K=S
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay26u214')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay26u214: GeneralStatistics expression (auto-extracted; see ref)."
