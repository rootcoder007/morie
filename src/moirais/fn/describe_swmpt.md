# describe('swmpt') — biomass_estimate
...
`print(result)` render. See `moirais.fn.describe('swmpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swmpt import *
import numpy as np
# See the function signature in fn/swmpt.py for argument names.
```
