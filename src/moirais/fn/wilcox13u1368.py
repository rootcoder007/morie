...
__all__ = ["wilcox_chapter_13_unnumbered_1368"]


def wilcox_chapter_13_unnumbered_1368(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: T = 2, reject. 24. T = 0.39, fail to reject. 25. T = −2.61. Reject. 26. (a) Tt = .596, fail to
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1368')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1368: GeneralStatistics expression (auto-extracted; see ref)."
