...
__all__ = ["hedderich_chapter_9_unnumbered_116"]


def hedderich_chapter_9_unnumbered_116(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] N (t) = Nmax−(Nmax−N0)eλ0t , (λ0 < 0) (2.60)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u116')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u116: GeneralStatistics expression (auto-extracted; see ref)."
