# describe('rgeeg') — rangayyan_eeg_bands
...
`print(result)` render. See `moirais.fn.describe('rgeeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeeg import *
import numpy as np
# See the function signature in fn/rgeeg.py for argument names.
```
