...
`print(result)` render. See `moirais.fn.describe('tmlres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlres import *
import numpy as np
# See the function signature in fn/tmlres.py for argument names.
```
