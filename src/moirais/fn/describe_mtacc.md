...
`print(result)` render. See `moirais.fn.describe('mtacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtacc import *
import numpy as np
# See the function signature in fn/mtacc.py for argument names.
```
