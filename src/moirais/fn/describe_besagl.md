# describe('besagl') — besag_York_Mollie
...
`print(result)` render. See `moirais.fn.describe('besagl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.besagl import *
import numpy as np
# See the function signature in fn/besagl.py for argument names.
```
