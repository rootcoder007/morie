# describe('msm027') — mvsml_linear_mixed_models_eq_5_1
...
`print(result)` render. See `moirais.fn.describe('msm027')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm027 import *
import numpy as np
# See the function signature in fn/msm027.py for argument names.
```
