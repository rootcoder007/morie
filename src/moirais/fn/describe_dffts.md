...
`print(result)` render. See `moirais.fn.describe('dffts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dffts import *
import numpy as np
# See the function signature in fn/dffts.py for argument names.
```
