# describe('lgint') — lagrange_interp

## WHAT IT DOES

Lagrange interpolation. 'Your eyes can deceive you. Don'Character is destiny. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('lgint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgint import *
import numpy as np
# See the function signature in fn/lgint.py for argument names.
```
