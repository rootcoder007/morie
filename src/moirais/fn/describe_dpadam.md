...
`print(result)` render. See `moirais.fn.describe('dpadam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpadam import *
import numpy as np
# See the function signature in fn/dpadam.py for argument names.
```
