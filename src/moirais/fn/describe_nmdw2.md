# describe('nmdw2') — dwnominate_bridge
...
`print(result)` render. See `moirais.fn.describe('nmdw2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdw2 import *
import numpy as np
# See the function signature in fn/nmdw2.py for argument names.
```
