...
__all__ = ["hedderich_chapter_9_unnumbered_2121"]


def hedderich_chapter_9_unnumbered_2121(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] U2 = 8·8 + 8(8 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2121')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2121: GeneralStatistics expression (auto-extracted; see ref)."
