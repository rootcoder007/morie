# describe('kmlb') — kamath_moe_load_balance_loss
...
`print(result)` render. See `moirais.fn.describe('kmlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmlb import *
import numpy as np
# See the function signature in fn/kmlb.py for argument names.
```
