...
__all__ = ["bivand2013_chapter_7_unnumbered_140"]


def bivand2013_chapter_7_unnumbered_140(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Typically, visual fitting will minimise|γ(h)−ˆγ(h)| with emphasis on short
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u140')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u140: GeneralStatistics expression (auto-extracted; see ref)."
