# describe('wsmcov') — wasserman_covariance
...
`print(result)` render. See `moirais.fn.describe('wsmcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcov import *
import numpy as np
# See the function signature in fn/wsmcov.py for argument names.
```
