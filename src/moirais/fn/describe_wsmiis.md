# describe('wsmiis') — wasserman_importance_sampling
...
`print(result)` render. See `moirais.fn.describe('wsmiis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmiis import *
import numpy as np
# See the function signature in fn/wsmiis.py for argument names.
```
