...
`print(result)` render. See `moirais.fn.describe('cfshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfshp import *
import numpy as np
# See the function signature in fn/cfshp.py for argument names.
```
