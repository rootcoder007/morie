# describe('btci2g') — boot_ci_two_groups
...
`print(result)` render. See `moirais.fn.describe('btci2g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btci2g import *
import numpy as np
# See the function signature in fn/btci2g.py for argument names.
```
