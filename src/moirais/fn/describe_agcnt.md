...
`print(result)` render. See `moirais.fn.describe('agcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcnt import *
import numpy as np
# See the function signature in fn/agcnt.py for argument names.
```
