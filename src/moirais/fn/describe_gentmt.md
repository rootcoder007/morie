# describe('gentmt') — generalized_treatment_msm
...
`print(result)` render. See `moirais.fn.describe('gentmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gentmt import *
import numpy as np
# See the function signature in fn/gentmt.py for argument names.
```
