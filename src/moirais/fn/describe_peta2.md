# describe('peta2') — partial_eta_squared
...
`print(result)` render. See `moirais.fn.describe('peta2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.peta2 import *
import numpy as np
# See the function signature in fn/peta2.py for argument names.
```
