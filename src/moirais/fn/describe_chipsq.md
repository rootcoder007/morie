...
`print(result)` render. See `moirais.fn.describe('chipsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chipsq import *
import numpy as np
# See the function signature in fn/chipsq.py for argument names.
```
