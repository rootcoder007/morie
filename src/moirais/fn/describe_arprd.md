...
`print(result)` render. See `moirais.fn.describe('arprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arprd import *
import numpy as np
# See the function signature in fn/arprd.py for argument names.
```
