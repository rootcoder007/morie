...
__all__ = ["hedderich_chapter_9_unnumbered_80"]


def hedderich_chapter_9_unnumbered_80(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (B + C)A = BA + CA
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u80')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u80: GeneralStatistics expression (auto-extracted; see ref)."
