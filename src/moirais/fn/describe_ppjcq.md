...
`print(result)` render. See `moirais.fn.describe('ppjcq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppjcq import *
import numpy as np
# See the function signature in fn/ppjcq.py for argument names.
```
