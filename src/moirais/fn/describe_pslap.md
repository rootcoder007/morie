...
`print(result)` render. See `moirais.fn.describe('pslap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pslap import *
import numpy as np
# See the function signature in fn/pslap.py for argument names.
```
