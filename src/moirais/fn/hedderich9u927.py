...
__all__ = ["hedderich_chapter_9_unnumbered_927"]


def hedderich_chapter_9_unnumbered_927(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Some examples forλ=3 andδ=0.6 (1.0 and 1.4) are shown in Figure 5.39.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u927')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u927: GeneralStatistics expression (auto-extracted; see ref)."
