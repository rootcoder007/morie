# describe('kmpoln') — kamath_post_ln_transformer
...
`print(result)` render. See `moirais.fn.describe('kmpoln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmpoln import *
import numpy as np
# See the function signature in fn/kmpoln.py for argument names.
```
