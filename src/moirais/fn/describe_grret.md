# describe('grret') — geron_discounted_return
...
`print(result)` render. See `moirais.fn.describe('grret')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grret import *
import numpy as np
# See the function signature in fn/grret.py for argument names.
```
