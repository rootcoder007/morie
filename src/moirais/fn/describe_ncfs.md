...
`print(result)` render. See `moirais.fn.describe('ncfs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ncfs import *
import numpy as np
# See the function signature in fn/ncfs.py for argument names.
```
