...
`print(result)` render. See `moirais.fn.describe('chtchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chtchg import *
import numpy as np
# See the function signature in fn/chtchg.py for argument names.
```
