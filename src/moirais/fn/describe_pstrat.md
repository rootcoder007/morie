...
`print(result)` render. See `moirais.fn.describe('pstrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstrat import *
import numpy as np
# See the function signature in fn/pstrat.py for argument names.
```
