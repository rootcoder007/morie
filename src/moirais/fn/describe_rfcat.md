...
`print(result)` render. See `moirais.fn.describe('rfcat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfcat import *
import numpy as np
# See the function signature in fn/rfcat.py for argument names.
```
