...
`print(result)` render. See `moirais.fn.describe('aicsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aicsc import *
import numpy as np
# See the function signature in fn/aicsc.py for argument names.
```
