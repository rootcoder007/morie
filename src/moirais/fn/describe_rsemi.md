...
`print(result)` render. See `moirais.fn.describe('rsemi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsemi import *
import numpy as np
# See the function signature in fn/rsemi.py for argument names.
```
