...
def ca_chapter_2_equation_16(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca2e16')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'surprisingly' (auto-extracted; see reference for full context)."},
    )
