# describe('nxcor') — normalized_xcorr
...
`print(result)` render. See `moirais.fn.describe('nxcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nxcor import *
import numpy as np
# See the function signature in fn/nxcor.py for argument names.
```
