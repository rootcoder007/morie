...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_184"]


def guide_on_data_analysis_chapter_4_unnumbered_184(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> V = 52, p-value = 0.01443
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u184')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u184: GeneralStatistics expression (auto-extracted; see ref)."
