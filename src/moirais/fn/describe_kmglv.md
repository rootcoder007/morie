# describe('kmglv') — kamath_glove_cost
...
`print(result)` render. See `moirais.fn.describe('kmglv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmglv import *
import numpy as np
# See the function signature in fn/kmglv.py for argument names.
```
