...
`print(result)` render. See `moirais.fn.describe('sacdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacdet import *
import numpy as np
# See the function signature in fn/sacdet.py for argument names.
```
