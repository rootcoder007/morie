...
`print(result)` render. See `moirais.fn.describe('enfld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enfld import *
import numpy as np
# See the function signature in fn/enfld.py for argument names.
```
