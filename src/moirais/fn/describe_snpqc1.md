...
`print(result)` render. See `moirais.fn.describe('snpqc1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snpqc1 import *
import numpy as np
# See the function signature in fn/snpqc1.py for argument names.
```
