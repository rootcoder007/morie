...
__all__ = ["hedderich_chapter_9_unnumbered_464"]


def hedderich_chapter_9_unnumbered_464(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.5 + 0.5−0.5·0.5 = 0.75.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u464')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u464: GeneralStatistics expression (auto-extracted; see ref)."
