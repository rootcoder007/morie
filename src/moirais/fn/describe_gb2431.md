# describe('gb2431') — gibbons_binomial_beta_link
...
`print(result)` render. See `moirais.fn.describe('gb2431')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2431 import *
import numpy as np
# See the function signature in fn/gb2431.py for argument names.
```
