# describe('optms') — optimal_transport
...
`print(result)` render. See `moirais.fn.describe('optms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optms import *
import numpy as np
# See the function signature in fn/optms.py for argument names.
```
