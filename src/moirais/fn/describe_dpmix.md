# describe('dpmix') — dirichlet_process_mixture

## WHAT IT DOES

Dirichlet process mixture model via Gibbs sampling. 'The only true wisdom is in knowing you know nothing. — Socrates'
...
`print(result)` render. See `moirais.fn.describe('dpmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmix import *
import numpy as np
# See the function signature in fn/dpmix.py for argument names.
```
