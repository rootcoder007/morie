# describe('gb621t') — gibbons_ww2_ties
...
`print(result)` render. See `moirais.fn.describe('gb621t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb621t import *
import numpy as np
# See the function signature in fn/gb621t.py for argument names.
```
