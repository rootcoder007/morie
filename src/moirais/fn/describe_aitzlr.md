# describe('aitzlr') — compositional_zero_lrem
...
`print(result)` render. See `moirais.fn.describe('aitzlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitzlr import *
import numpy as np
# See the function signature in fn/aitzlr.py for argument names.
```
