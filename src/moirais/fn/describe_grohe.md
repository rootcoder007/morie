# describe('grohe') — geron_one_hot_encoding
...
`print(result)` render. See `moirais.fn.describe('grohe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grohe import *
import numpy as np
# See the function signature in fn/grohe.py for argument names.
```
