# describe('btbias') — boot_bias_estimator
...
`print(result)` render. See `moirais.fn.describe('btbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btbias import *
import numpy as np
# See the function signature in fn/btbias.py for argument names.
```
