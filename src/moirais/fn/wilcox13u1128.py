...
__all__ = ["wilcox_chapter_13_unnumbered_1128"]


def wilcox_chapter_13_unnumbered_1128(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SEED = TRUE, nboot = 100, pts = NULL, npts = 25, nreps = 2000,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1128')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1128: GeneralStatistics expression (auto-extracted; see ref)."
