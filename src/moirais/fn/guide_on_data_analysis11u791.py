...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_791"]


def guide_on_data_analysis_chapter_11_unnumbered_791(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑦𝑖 = x𝑖𝛽 +x𝑖𝑦1𝛾1 + ... +x𝑖𝑦𝑇𝛾𝑇 + 𝛿1𝑦1 + ... + 𝛿𝑇𝑦𝑇 + 𝜖𝑖
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u791')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u791: GeneralStatistics expression (auto-extracted; see ref)."
