# describe('hrzsitr') — horowitz_sieve_npiv
...
`print(result)` render. See `moirais.fn.describe('hrzsitr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsitr import *
import numpy as np
# See the function signature in fn/hrzsitr.py for argument names.
```
