...
`print(result)` render. See `moirais.fn.describe('ucr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ucr import *
import numpy as np
# See the function signature in fn/ucr.py for argument names.
```
