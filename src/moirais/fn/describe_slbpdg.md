# describe('slbpdg') — slice_break_dp
...
`print(result)` render. See `moirais.fn.describe('slbpdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slbpdg import *
import numpy as np
# See the function signature in fn/slbpdg.py for argument names.
```
