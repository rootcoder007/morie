...
`print(result)` render. See `moirais.fn.describe('mtodm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtodm import *
import numpy as np
# See the function signature in fn/mtodm.py for argument names.
```
