# describe('momento') — moment_foundation
...
`print(result)` render. See `moirais.fn.describe('momento')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.momento import *
import numpy as np
# See the function signature in fn/momento.py for argument names.
```
