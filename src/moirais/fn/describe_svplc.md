# describe('svplc') — plott_condition
...
`print(result)` render. See `moirais.fn.describe('svplc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svplc import *
import numpy as np
# See the function signature in fn/svplc.py for argument names.
```
