# describe('km040') — kamath_ch2_moe_topk_gating
...
`print(result)` render. See `moirais.fn.describe('km040')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km040 import *
import numpy as np
# See the function signature in fn/km040.py for argument names.
```
