...
`print(result)` render. See `moirais.fn.describe('gsageemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gsageemd import *
import numpy as np
# See the function signature in fn/gsageemd.py for argument names.
```
