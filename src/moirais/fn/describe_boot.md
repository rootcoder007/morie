...
`print(result)` render. See `moirais.fn.describe('boot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boot import *
import numpy as np
# See the function signature in fn/boot.py for argument names.
```
