...
`print(result)` render. See `moirais.fn.describe('mapef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapef import *
import numpy as np
# See the function signature in fn/mapef.py for argument names.
```
