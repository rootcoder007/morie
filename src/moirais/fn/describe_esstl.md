# describe('esstl') — effective_sample_size_tail
...
`print(result)` render. See `moirais.fn.describe('esstl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esstl import *
import numpy as np
# See the function signature in fn/esstl.py for argument names.
```
