...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_4_equation_15"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_4_equation_15(x, cdf=None):
    """
    GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.

    Formula: xik j = z jk +            xik −zjk          (4.14)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment4e15')`` for the full guide.

    References
    ----------
    Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment, ch.4 eq.4.15
    """
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment4e15: GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment."
