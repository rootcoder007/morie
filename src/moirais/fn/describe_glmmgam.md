...
`print(result)` render. See `moirais.fn.describe('glmmgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmgam import *
import numpy as np
# See the function signature in fn/glmmgam.py for argument names.
```
