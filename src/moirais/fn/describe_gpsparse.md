...
`print(result)` render. See `moirais.fn.describe('gpsparse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpsparse import *
import numpy as np
# See the function signature in fn/gpsparse.py for argument names.
```
