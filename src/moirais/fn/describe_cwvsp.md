# describe('cwvsp') — _morlet_wavelet
...
`print(result)` render. See `moirais.fn.describe('cwvsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cwvsp import *
import numpy as np
# See the function signature in fn/cwvsp.py for argument names.
```
