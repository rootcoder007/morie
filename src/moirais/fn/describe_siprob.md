...
`print(result)` render. See `moirais.fn.describe('siprob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siprob import *
import numpy as np
# See the function signature in fn/siprob.py for argument names.
```
