...
`print(result)` render. See `moirais.fn.describe('qlogi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qlogi import *
import numpy as np
# See the function signature in fn/qlogi.py for argument names.
```
