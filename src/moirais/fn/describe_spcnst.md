...
`print(result)` render. See `moirais.fn.describe('spcnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcnst import *
import numpy as np
# See the function signature in fn/spcnst.py for argument names.
```
