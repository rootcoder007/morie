...
__all__ = ["wilcox_chapter_14_unnumbered_528"]


def wilcox_chapter_14_unnumbered_528(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: power.t.test(n = NULL, delta=0.8,power=0.8)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u528')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u528: PowerAndDesign expression (auto-extracted; see ref)."
