# describe('ginemd') — graph_isomorphism_net
...
`print(result)` render. See `moirais.fn.describe('ginemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ginemd import *
import numpy as np
# See the function signature in fn/ginemd.py for argument names.
```
