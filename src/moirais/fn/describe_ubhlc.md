...
`print(result)` render. See `moirais.fn.describe('ubhlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubhlc import *
import numpy as np
# See the function signature in fn/ubhlc.py for argument names.
```
