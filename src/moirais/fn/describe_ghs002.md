# describe('ghs002') — ghosal_ch2_random_basis_expansion
...
`print(result)` render. See `moirais.fn.describe('ghs002')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs002 import *
import numpy as np
# See the function signature in fn/ghs002.py for argument names.
```
