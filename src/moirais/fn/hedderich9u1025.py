...
__all__ = ["hedderich_chapter_9_unnumbered_1025"]


def hedderich_chapter_9_unnumbered_1025(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1025')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1025: CountModels expression (auto-extracted; see ref)."
