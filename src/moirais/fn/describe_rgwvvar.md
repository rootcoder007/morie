# describe('rgwvvar') — rangayyan_wavelet_variance
...
`print(result)` render. See `moirais.fn.describe('rgwvvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvvar import *
import numpy as np
# See the function signature in fn/rgwvvar.py for argument names.
```
