# describe('evgevl') — evt_gev_loglik
...
`print(result)` render. See `moirais.fn.describe('evgevl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevl import *
import numpy as np
# See the function signature in fn/evgevl.py for argument names.
```
