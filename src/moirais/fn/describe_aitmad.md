# describe('aitmad') — compositional_mad
...
`print(result)` render. See `moirais.fn.describe('aitmad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitmad import *
import numpy as np
# See the function signature in fn/aitmad.py for argument names.
```
