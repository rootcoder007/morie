# describe('ibpfa') — indian_buffet_factor
...
`print(result)` render. See `moirais.fn.describe('ibpfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibpfa import *
import numpy as np
# See the function signature in fn/ibpfa.py for argument names.
```
