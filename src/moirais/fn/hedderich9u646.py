...
__all__ = ["hedderich_chapter_9_unnumbered_646"]


def hedderich_chapter_9_unnumbered_646(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For example, let’s determine P (16 < X≤26) for n = 100 and p = 0.25. Since np(1−p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u646')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u646: GeneralStatistics expression (auto-extracted; see ref)."
