...
`print(result)` render. See `moirais.fn.describe('netparf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netparf import *
import numpy as np
# See the function signature in fn/netparf.py for argument names.
```
