# describe('scrnp') — screening_properties
...
`print(result)` render. See `moirais.fn.describe('scrnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scrnp import *
import numpy as np
# See the function signature in fn/scrnp.py for argument names.
```
