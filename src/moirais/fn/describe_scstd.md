# describe('scstd') — score_standardize
...
`print(result)` render. See `moirais.fn.describe('scstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scstd import *
import numpy as np
# See the function signature in fn/scstd.py for argument names.
```
