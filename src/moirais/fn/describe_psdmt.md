...
`print(result)` render. See `moirais.fn.describe('psdmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psdmt import *
import numpy as np
# See the function signature in fn/psdmt.py for argument names.
```
