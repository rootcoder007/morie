...
__all__ = ["wilcox_chapter_10_unnumbered_874"]


def wilcox_chapter_10_unnumbered_874(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u874')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u874: GeneralStatistics expression (auto-extracted; see ref)."
