...
`print(result)` render. See `moirais.fn.describe('dkrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkrgr import *
import numpy as np
# See the function signature in fn/dkrgr.py for argument names.
```
