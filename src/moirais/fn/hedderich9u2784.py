...
__all__ = ["hedderich_chapter_9_unnumbered_2784"]


def hedderich_chapter_9_unnumbered_2784(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 16 + 5 = 4.762> 2.706 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2784')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2784: GeneralStatistics expression (auto-extracted; see ref)."
