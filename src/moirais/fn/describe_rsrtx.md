...
`print(result)` render. See `moirais.fn.describe('rsrtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsrtx import *
import numpy as np
# See the function signature in fn/rsrtx.py for argument names.
```
