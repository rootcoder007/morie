# describe('otdiv') — ot_sinkhorn_divergence
...
`print(result)` render. See `moirais.fn.describe('otdiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otdiv import *
import numpy as np
# See the function signature in fn/otdiv.py for argument names.
```
