# describe('gpcgs') — gp_classification_svgp
...
`print(result)` render. See `moirais.fn.describe('gpcgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpcgs import *
import numpy as np
# See the function signature in fn/gpcgs.py for argument names.
```
