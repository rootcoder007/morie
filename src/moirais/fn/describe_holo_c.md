...
`print(result)` render. See `moirais.fn.describe('holo_c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_c import *
import numpy as np
# See the function signature in fn/holo_c.py for argument names.
```
