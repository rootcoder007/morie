# describe('kmngrm') — kamath_ngram_language_model
...
`print(result)` render. See `moirais.fn.describe('kmngrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmngrm import *
import numpy as np
# See the function signature in fn/kmngrm.py for argument names.
```
