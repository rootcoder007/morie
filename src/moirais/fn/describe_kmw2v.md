# describe('kmw2v') — kamath_word2vec_skipgram
...
`print(result)` render. See `moirais.fn.describe('kmw2v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmw2v import *
import numpy as np
# See the function signature in fn/kmw2v.py for argument names.
```
