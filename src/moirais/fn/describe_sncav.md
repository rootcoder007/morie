...
`print(result)` render. See `moirais.fn.describe('sncav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sncav import *
import numpy as np
# See the function signature in fn/sncav.py for argument names.
```
