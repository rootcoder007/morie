# describe('rgicaart') — rangayyan_ica_artifact
...
`print(result)` render. See `moirais.fn.describe('rgicaart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgicaart import *
import numpy as np
# See the function signature in fn/rgicaart.py for argument names.
```
