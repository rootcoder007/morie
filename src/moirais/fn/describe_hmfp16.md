# describe('hmfp16') — geron_fp16_quant
...
`print(result)` render. See `moirais.fn.describe('hmfp16')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfp16 import *
import numpy as np
# See the function signature in fn/hmfp16.py for argument names.
```
