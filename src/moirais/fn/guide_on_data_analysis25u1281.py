...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1281"]


def guide_on_data_analysis_chapter_25_unnumbered_1281(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: y2_diff = com_y2 - state_y2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1281')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1281: GeneralStatistics expression (auto-extracted; see ref)."
