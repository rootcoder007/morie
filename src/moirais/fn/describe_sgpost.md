...
`print(result)` render. See `moirais.fn.describe('sgpost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpost import *
import numpy as np
# See the function signature in fn/sgpost.py for argument names.
```
