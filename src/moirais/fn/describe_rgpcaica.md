# describe('rgpcaica') — rangayyan_pca_vs_ica
...
`print(result)` render. See `moirais.fn.describe('rgpcaica')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcaica import *
import numpy as np
# See the function signature in fn/rgpcaica.py for argument names.
```
