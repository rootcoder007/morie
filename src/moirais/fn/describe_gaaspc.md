...
`print(result)` render. See `moirais.fn.describe('gaaspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaaspc import *
import numpy as np
# See the function signature in fn/gaaspc.py for argument names.
```
