# describe('johsn') — johansen_cointegration
...
`print(result)` render. See `moirais.fn.describe('johsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johsn import *
import numpy as np
# See the function signature in fn/johsn.py for argument names.
```
