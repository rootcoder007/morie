...
`print(result)` render. See `moirais.fn.describe('igravlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravlm import *
import numpy as np
# See the function signature in fn/igravlm.py for argument names.
```
