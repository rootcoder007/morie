# describe('yllyear') — yll_calculation
...
`print(result)` render. See `moirais.fn.describe('yllyear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yllyear import *
import numpy as np
# See the function signature in fn/yllyear.py for argument names.
```
