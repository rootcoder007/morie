...
`print(result)` render. See `moirais.fn.describe('gkpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gkpw import *
import numpy as np
# See the function signature in fn/gkpw.py for argument names.
```
