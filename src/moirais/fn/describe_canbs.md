...
`print(result)` render. See `moirais.fn.describe('canbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.canbs import *
import numpy as np
# See the function signature in fn/canbs.py for argument names.
```
