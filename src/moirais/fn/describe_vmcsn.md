...
`print(result)` render. See `moirais.fn.describe('vmcsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcsn import *
import numpy as np
# See the function signature in fn/vmcsn.py for argument names.
```
