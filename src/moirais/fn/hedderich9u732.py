...
__all__ = ["hedderich_chapter_9_unnumbered_732"]


def hedderich_chapter_9_unnumbered_732(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u732')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u732: CountModels expression (auto-extracted; see ref)."
