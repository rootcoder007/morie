...
`print(result)` render. See `moirais.fn.describe('enob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enob import *
import numpy as np
# See the function signature in fn/enob.py for argument names.
```
