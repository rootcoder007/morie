# describe('msm257') — mvsml_general_eq_1_222
...
`print(result)` render. See `moirais.fn.describe('msm257')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm257 import *
import numpy as np
# See the function signature in fn/msm257.py for argument names.
```
