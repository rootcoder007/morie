...
`print(result)` render. See `moirais.fn.describe('cmamn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmamn import *
import numpy as np
# See the function signature in fn/cmamn.py for argument names.
```
