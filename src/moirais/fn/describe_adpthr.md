# describe('adpthr') — adaptive_threshold_detect
...
`print(result)` render. See `moirais.fn.describe('adpthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adpthr import *
import numpy as np
# See the function signature in fn/adpthr.py for argument names.
```
