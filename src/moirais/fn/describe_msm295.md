# describe('msm295') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm295')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm295 import *
import numpy as np
# See the function signature in fn/msm295.py for argument names.
```
