...
`print(result)` render. See `moirais.fn.describe('bnsiii')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsiii import *
import numpy as np
# See the function signature in fn/bnsiii.py for argument names.
```
