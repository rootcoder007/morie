...
`print(result)` render. See `moirais.fn.describe('vmhol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmhol import *
import numpy as np
# See the function signature in fn/vmhol.py for argument names.
```
