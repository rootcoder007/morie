# describe('adptv') — adaptive_design
...
`print(result)` render. See `moirais.fn.describe('adptv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adptv import *
import numpy as np
# See the function signature in fn/adptv.py for argument names.
```
