# describe('sgok') — ordinary_kriging
...
`print(result)` render. See `moirais.fn.describe('sgok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgok import *
import numpy as np
# See the function signature in fn/sgok.py for argument names.
```
