...
`print(result)` render. See `moirais.fn.describe('srbsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbsd import *
import numpy as np
# See the function signature in fn/srbsd.py for argument names.
```
