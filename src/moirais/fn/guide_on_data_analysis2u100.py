...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_100"]


def guide_on_data_analysis_chapter_2_unnumbered_100(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: bind_rows("dat01" = dat01, "dat02" = dat02, .id = "id")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u100')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u100: GeneralStatistics expression (auto-extracted; see ref)."
