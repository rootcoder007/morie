...
__all__ = ["wilcox_chapter_10_unnumbered_1034"]


def wilcox_chapter_10_unnumbered_1034(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rm3mcp(J, K, L, x, tr = 0.2, alpha = 0.05, dif = TRUE, op = FALSE, grp = NA)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1034')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1034: GeneralStatistics expression (auto-extracted; see ref)."
