...
`print(result)` render. See `moirais.fn.describe('isown')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isown import *
import numpy as np
# See the function signature in fn/isown.py for argument names.
```
