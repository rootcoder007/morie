# describe('penls') — penalized_regression
...
`print(result)` render. See `moirais.fn.describe('penls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.penls import *
import numpy as np
# See the function signature in fn/penls.py for argument names.
```
