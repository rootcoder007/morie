...
`print(result)` render. See `moirais.fn.describe('olsrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.olsrg import *
import numpy as np
# See the function signature in fn/olsrg.py for argument names.
```
