...
__all__ = ["hedderich_chapter_9_unnumbered_2801"]


def hedderich_chapter_9_unnumbered_2801(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (ψ+ 1)−p(ψ−1)2 (7.324)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2801')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2801: PowerAndDesign expression (auto-extracted; see ref)."
