# describe('hmbel') — geron_bellman_optimality
...
`print(result)` render. See `moirais.fn.describe('hmbel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbel import *
import numpy as np
# See the function signature in fn/hmbel.py for argument names.
```
