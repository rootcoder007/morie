...
`print(result)` render. See `moirais.fn.describe('mtrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrob import *
import numpy as np
# See the function signature in fn/mtrob.py for argument names.
```
