# describe('opair') — otis_pairwise_compare
...
`print(result)` render. See `moirais.fn.describe('opair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opair import *
import numpy as np
# See the function signature in fn/opair.py for argument names.
```
