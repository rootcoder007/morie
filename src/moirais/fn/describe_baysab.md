...
`print(result)` render. See `moirais.fn.describe('baysab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysab import *
import numpy as np
# See the function signature in fn/baysab.py for argument names.
```
