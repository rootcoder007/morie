# describe('hrzq1') — horowitz_quantile_regression
...
`print(result)` render. See `moirais.fn.describe('hrzq1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzq1 import *
import numpy as np
# See the function signature in fn/hrzq1.py for argument names.
```
