...
`print(result)` render. See `moirais.fn.describe('baysr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysr import *
import numpy as np
# See the function signature in fn/baysr.py for argument names.
```
