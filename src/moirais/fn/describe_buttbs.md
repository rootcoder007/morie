# describe('buttbs') — butter_bandstop
...
`print(result)` render. See `moirais.fn.describe('buttbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.buttbs import *
import numpy as np
# See the function signature in fn/buttbs.py for argument names.
```
