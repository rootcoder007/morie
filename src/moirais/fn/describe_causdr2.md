# describe('causdr2') — causal_dr_orthogonal
...
`print(result)` render. See `moirais.fn.describe('causdr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdr2 import *
import numpy as np
# See the function signature in fn/causdr2.py for argument names.
```
