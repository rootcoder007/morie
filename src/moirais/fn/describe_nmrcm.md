# describe('nmrcm') — roll_call_matrix
...
`print(result)` render. See `moirais.fn.describe('nmrcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmrcm import *
import numpy as np
# See the function signature in fn/nmrcm.py for argument names.
```
