...
__all__ = ["wilcox_chapter_10_unnumbered_988"]


def wilcox_chapter_10_unnumbered_988(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: kbcon(x,con=0,tr=0.2,alpha=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u988')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u988: GeneralStatistics expression (auto-extracted; see ref)."
