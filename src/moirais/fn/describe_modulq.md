...
`print(result)` render. See `moirais.fn.describe('modulq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modulq import *
import numpy as np
# See the function signature in fn/modulq.py for argument names.
```
