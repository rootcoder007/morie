...
`print(result)` render. See `moirais.fn.describe('maxwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maxwl import *
import numpy as np
# See the function signature in fn/maxwl.py for argument names.
```
