...
`print(result)` render. See `moirais.fn.describe('loadds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.loadds import *
import numpy as np
# See the function signature in fn/loadds.py for argument names.
```
