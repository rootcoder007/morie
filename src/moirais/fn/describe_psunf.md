...
`print(result)` render. See `moirais.fn.describe('psunf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psunf import *
import numpy as np
# See the function signature in fn/psunf.py for argument names.
```
