# describe('benfd') — benfords_law_test
...
`print(result)` render. See `moirais.fn.describe('benfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.benfd import *
import numpy as np
# See the function signature in fn/benfd.py for argument names.
```
