# describe('gtime') — generation_time
...
`print(result)` render. See `moirais.fn.describe('gtime')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gtime import *
import numpy as np
# See the function signature in fn/gtime.py for argument names.
```
