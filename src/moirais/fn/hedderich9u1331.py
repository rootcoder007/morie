...
__all__ = ["hedderich_chapter_9_unnumbered_1331"]


def hedderich_chapter_9_unnumbered_1331(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (Bi(u−1; n, p)−Bi(l−1; n, p))≥1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1331')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1331: CountModels expression (auto-extracted; see ref)."
