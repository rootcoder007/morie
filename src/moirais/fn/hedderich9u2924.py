...
__all__ = ["hedderich_chapter_9_unnumbered_2924"]


def hedderich_chapter_9_unnumbered_2924(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i ni xi pi niπo xi−niπ0 (xi−niπo)2 niπo(1−π0) (xi−niπ0)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2924')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2924: GeneralStatistics expression (auto-extracted; see ref)."
