...
`print(result)` render. See `moirais.fn.describe('idwblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwblk import *
import numpy as np
# See the function signature in fn/idwblk.py for argument names.
```
