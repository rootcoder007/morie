...
`print(result)` render. See `moirais.fn.describe('csfrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csfrg import *
import numpy as np
# See the function signature in fn/csfrg.py for argument names.
```
