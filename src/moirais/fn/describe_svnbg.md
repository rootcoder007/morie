# describe('svnbg') — nash_bargain_sp
...
`print(result)` render. See `moirais.fn.describe('svnbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnbg import *
import numpy as np
# See the function signature in fn/svnbg.py for argument names.
```
