# describe('citym') — cityblock_model
...
`print(result)` render. See `moirais.fn.describe('citym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.citym import *
import numpy as np
# See the function signature in fn/citym.py for argument names.
```
