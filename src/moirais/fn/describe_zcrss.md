...
`print(result)` render. See `moirais.fn.describe('zcrss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zcrss import *
import numpy as np
# See the function signature in fn/zcrss.py for argument names.
```
