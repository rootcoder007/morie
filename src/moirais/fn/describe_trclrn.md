# describe('trclrn') — tree_based_regime
...
`print(result)` render. See `moirais.fn.describe('trclrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trclrn import *
import numpy as np
# See the function signature in fn/trclrn.py for argument names.
```
