# describe('fzcvm') — fauzi_cvm_smoothed
...
`print(result)` render. See `moirais.fn.describe('fzcvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzcvm import *
import numpy as np
# See the function signature in fn/fzcvm.py for argument names.
```
