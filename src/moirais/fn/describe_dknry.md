...
`print(result)` render. See `moirais.fn.describe('dknry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dknry import *
import numpy as np
# See the function signature in fn/dknry.py for argument names.
```
