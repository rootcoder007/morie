# describe('hmdldqn') — geron_dueling_dqn
...
`print(result)` render. See `moirais.fn.describe('hmdldqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdldqn import *
import numpy as np
# See the function signature in fn/hmdldqn.py for argument names.
```
