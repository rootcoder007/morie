...
`print(result)` render. See `moirais.fn.describe('gdcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdcmp import *
import numpy as np
# See the function signature in fn/gdcmp.py for argument names.
```
