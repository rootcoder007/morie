# describe('rpfrq') — rplace_frequency
...
`print(result)` render. See `moirais.fn.describe('rpfrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpfrq import *
import numpy as np
# See the function signature in fn/rpfrq.py for argument names.
```
