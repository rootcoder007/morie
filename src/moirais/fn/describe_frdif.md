# describe('frdif') — forward_difference
...
`print(result)` render. See `moirais.fn.describe('frdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frdif import *
import numpy as np
# See the function signature in fn/frdif.py for argument names.
```
