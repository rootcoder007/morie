# describe('rgeqn5a') — rangayyan_ch5_waveform_morph
...
`print(result)` render. See `moirais.fn.describe('rgeqn5a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn5a import *
import numpy as np
# See the function signature in fn/rgeqn5a.py for argument names.
```
