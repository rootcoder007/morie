# describe('screl') — score_reliability
...
`print(result)` render. See `moirais.fn.describe('screl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.screl import *
import numpy as np
# See the function signature in fn/screl.py for argument names.
```
