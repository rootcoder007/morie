...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1490"]


def guide_on_data_analysis_chapter_30_unnumbered_1490(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -5 x cohort = 6 -0.66 (0.91)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1490')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1490: GeneralStatistics expression (auto-extracted; see ref)."
