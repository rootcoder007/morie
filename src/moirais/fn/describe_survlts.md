# describe('survlts') — life_table_smoothed
...
`print(result)` render. See `moirais.fn.describe('survlts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survlts import *
import numpy as np
# See the function signature in fn/survlts.py for argument names.
```
