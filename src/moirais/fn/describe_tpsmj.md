# describe('tpsmj') — tps_major_crime
...
`print(result)` render. See `moirais.fn.describe('tpsmj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsmj import *
import numpy as np
# See the function signature in fn/tpsmj.py for argument names.
```
