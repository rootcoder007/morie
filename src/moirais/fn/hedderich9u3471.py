...
__all__ = ["hedderich_chapter_9_unnumbered_3471"]


def hedderich_chapter_9_unnumbered_3471(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: θij(k) = πijkπIJk
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3471')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3471: ContingencyTables expression (auto-extracted; see ref)."
