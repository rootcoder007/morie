# describe('ksr03') — kosorok_glivenko_cantelli
...
`print(result)` render. See `moirais.fn.describe('ksr03')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr03 import *
import numpy as np
# See the function signature in fn/ksr03.py for argument names.
```
