# describe('eqsl') — equating_stocking_lord
...
`print(result)` render. See `moirais.fn.describe('eqsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqsl import *
import numpy as np
# See the function signature in fn/eqsl.py for argument names.
```
