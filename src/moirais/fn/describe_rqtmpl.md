...
`print(result)` render. See `moirais.fn.describe('rqtmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rqtmpl import *
import numpy as np
# See the function signature in fn/rqtmpl.py for argument names.
```
