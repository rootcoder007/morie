...
__all__ = ["wilcox_chapter_15_unnumbered_1396"]


def wilcox_chapter_15_unnumbered_1396(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1396')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1396: GeneralStatistics expression (auto-extracted; see ref)."
