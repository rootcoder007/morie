# describe('ca7e1') — ca_chapter_7_equation_1
...
```python
from moirais.fn.ca7e1 import ca_chapter_7_equation_1
import numpy as np
result = ca_chapter_7_equation_1(np.random.default_rng(42).normal(0, 1, 100))
