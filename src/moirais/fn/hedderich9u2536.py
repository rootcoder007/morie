...
__all__ = ["hedderich_chapter_9_unnumbered_2536"]


def hedderich_chapter_9_unnumbered_2536(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: nk(k + 1)/12, whereW forα= 0.05 (0.01) is taken from the last line of table 7.37, or
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2536')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2536: GeneralStatistics expression (auto-extracted; see ref)."
