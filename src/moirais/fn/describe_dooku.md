...
`print(result)` render. See `moirais.fn.describe('dooku')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dooku import *
import numpy as np
# See the function signature in fn/dooku.py for argument names.
```
