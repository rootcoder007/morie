...
`print(result)` render. See `moirais.fn.describe('dpsgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsgd import *
import numpy as np
# See the function signature in fn/dpsgd.py for argument names.
```
