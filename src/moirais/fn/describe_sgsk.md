...
`print(result)` render. See `moirais.fn.describe('sgsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsk import *
import numpy as np
# See the function signature in fn/sgsk.py for argument names.
```
