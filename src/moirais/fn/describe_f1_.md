...
`print(result)` render. See `moirais.fn.describe('f1_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.f1_ import *
import numpy as np
# See the function signature in fn/f1_.py for argument names.
```
