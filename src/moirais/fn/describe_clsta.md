...
`print(result)` render. See `moirais.fn.describe('clsta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clsta import *
import numpy as np
# See the function signature in fn/clsta.py for argument names.
```
