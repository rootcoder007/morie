# describe('modr') — moderation_analysis
...
`print(result)` render. See `moirais.fn.describe('modr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modr import *
import numpy as np
# See the function signature in fn/modr.py for argument names.
```
