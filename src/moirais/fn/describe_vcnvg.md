# describe('vcnvg') — validity_convergent
...
`print(result)` render. See `moirais.fn.describe('vcnvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcnvg import *
import numpy as np
# See the function signature in fn/vcnvg.py for argument names.
```
