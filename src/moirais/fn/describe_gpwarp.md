...
`print(result)` render. See `moirais.fn.describe('gpwarp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpwarp import *
import numpy as np
# See the function signature in fn/gpwarp.py for argument names.
```
