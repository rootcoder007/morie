# describe('spsmsh') — spsm_shifted_intervention
...
`print(result)` render. See `moirais.fn.describe('spsmsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsmsh import *
import numpy as np
# See the function signature in fn/spsmsh.py for argument names.
```
