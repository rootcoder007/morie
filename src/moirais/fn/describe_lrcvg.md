...
`print(result)` render. See `moirais.fn.describe('lrcvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrcvg import *
import numpy as np
# See the function signature in fn/lrcvg.py for argument names.
```
