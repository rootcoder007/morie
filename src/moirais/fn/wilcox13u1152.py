...
__all__ = ["wilcox_chapter_13_unnumbered_1152"]


def wilcox_chapter_13_unnumbered_1152(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Y =β 0 +β 1X1 +e, compute the residuals, and use LOESS to predict the residuals based on
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1152')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1152: GeneralStatistics expression (auto-extracted; see ref)."
