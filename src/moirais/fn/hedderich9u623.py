...
__all__ = ["hedderich_chapter_9_unnumbered_623"]


def hedderich_chapter_9_unnumbered_623(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] AA ¯A, A ¯AA, ¯AAA 2 P (X = 2) 3p2(1−p) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u623')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u623: CountModels expression (auto-extracted; see ref)."
