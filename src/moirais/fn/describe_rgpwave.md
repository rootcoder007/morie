# describe('rgpwave') — rangayyan_p_wave_detect
...
`print(result)` render. See `moirais.fn.describe('rgpwave')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpwave import *
import numpy as np
# See the function signature in fn/rgpwave.py for argument names.
```
