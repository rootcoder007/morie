...
__all__ = ["hedderich_chapter_9_unnumbered_2459"]


def hedderich_chapter_9_unnumbered_2459(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Kruskal − Wallis chi − squared = 1 1 . 5 3 , df = 3 , p− value = 0.009179
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2459')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2459: GeneralStatistics expression (auto-extracted; see ref)."
