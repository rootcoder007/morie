# describe('gh_small_ball') — ghosal_small_ball_prob
...
`print(result)` render. See `moirais.fn.describe('gh_small_ball')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_small_ball import *
import numpy as np
# See the function signature in fn/gh_small_ball.py for argument names.
```
