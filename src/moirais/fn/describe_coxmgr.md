# describe('coxmgr') — cox_martingale_residuals
...
`print(result)` render. See `moirais.fn.describe('coxmgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxmgr import *
import numpy as np
# See the function signature in fn/coxmgr.py for argument names.
```
