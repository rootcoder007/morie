...
`print(result)` render. See `moirais.fn.describe('hmtlu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtlu import *
import numpy as np
# See the function signature in fn/hmtlu.py for argument names.
```
