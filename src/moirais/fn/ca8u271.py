...
def ca_chapter_8_unnumbered_271(x):
    """
    CentralTendency expression involving 'distribution' (auto-extracted; see reference for full context).

    Formula: δ = Mean test statistic population − Mean test statistic null Equation 8 :1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8u271')`` for the full guide.
