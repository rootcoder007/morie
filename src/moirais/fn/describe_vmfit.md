...
`print(result)` render. See `moirais.fn.describe('vmfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmfit import *
import numpy as np
# See the function signature in fn/vmfit.py for argument names.
```
