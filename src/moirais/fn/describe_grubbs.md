...
`print(result)` render. See `moirais.fn.describe('grubbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grubbs import *
import numpy as np
# See the function signature in fn/grubbs.py for argument names.
```
