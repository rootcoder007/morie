...
`print(result)` render. See `moirais.fn.describe('unifAlg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unifAlg import *
import numpy as np
# See the function signature in fn/unifAlg.py for argument names.
```
