# describe('cumcif') — cumulative_incidence_function
...
`print(result)` render. See `moirais.fn.describe('cumcif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cumcif import *
import numpy as np
# See the function signature in fn/cumcif.py for argument names.
```
