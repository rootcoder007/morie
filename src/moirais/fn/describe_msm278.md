# describe('msm278') — mvsml_convolutional_nn_eq_14_11
...
`print(result)` render. See `moirais.fn.describe('msm278')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm278 import *
import numpy as np
# See the function signature in fn/msm278.py for argument names.
```
