...
`print(result)` render. See `moirais.fn.describe('winz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.winz import *
import numpy as np
# See the function signature in fn/winz.py for argument names.
```
