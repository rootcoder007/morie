...
`print(result)` render. See `moirais.fn.describe('abmcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abmcr import *
import numpy as np
# See the function signature in fn/abmcr.py for argument names.
```
