# describe('granci') — granger_causality_info
...
`print(result)` render. See `moirais.fn.describe('granci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.granci import *
import numpy as np
# See the function signature in fn/granci.py for argument names.
```
