# describe('grkmpp') — geron_kmeans_pp_seeding
...
`print(result)` render. See `moirais.fn.describe('grkmpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkmpp import *
import numpy as np
# See the function signature in fn/grkmpp.py for argument names.
```
