...
`print(result)` render. See `moirais.fn.describe('ptkda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptkda import *
import numpy as np
# See the function signature in fn/ptkda.py for argument names.
```
