...
`print(result)` render. See `moirais.fn.describe('mtdia')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtdia import *
import numpy as np
# See the function signature in fn/mtdia.py for argument names.
```
