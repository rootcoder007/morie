# describe('cvxmin') — boyd_minimum_norm
...
`print(result)` render. See `moirais.fn.describe('cvxmin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxmin import *
import numpy as np
# See the function signature in fn/cvxmin.py for argument names.
```
