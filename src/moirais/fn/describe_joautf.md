# describe('joautf') — joseph_autoformer
...
`print(result)` render. See `moirais.fn.describe('joautf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joautf import *
import numpy as np
# See the function signature in fn/joautf.py for argument names.
```
