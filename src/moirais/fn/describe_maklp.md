...
`print(result)` render. See `moirais.fn.describe('maklp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maklp import *
import numpy as np
# See the function signature in fn/maklp.py for argument names.
```
