# describe('tmlcou') — tmle_count_outcome
...
`print(result)` render. See `moirais.fn.describe('tmlcou')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcou import *
import numpy as np
# See the function signature in fn/tmlcou.py for argument names.
```
