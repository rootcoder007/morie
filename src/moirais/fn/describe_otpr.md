...
`print(result)` render. See `moirais.fn.describe('otpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otpr import *
import numpy as np
# See the function signature in fn/otpr.py for argument names.
```
