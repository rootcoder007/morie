# describe('hmmbkm') — geron_minibatch_kmeans
...
`print(result)` render. See `moirais.fn.describe('hmmbkm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmbkm import *
import numpy as np
# See the function signature in fn/hmmbkm.py for argument names.
```
