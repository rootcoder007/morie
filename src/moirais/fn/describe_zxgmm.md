...
`print(result)` render. See `moirais.fn.describe('zxgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxgmm import *
import numpy as np
# See the function signature in fn/zxgmm.py for argument names.
```
