# describe('ggmaft') — generalized_gamma_aft
...
`print(result)` render. See `moirais.fn.describe('ggmaft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ggmaft import *
import numpy as np
# See the function signature in fn/ggmaft.py for argument names.
```
