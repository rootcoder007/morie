# describe('ghadp') — ghosal_adaptation
...
`print(result)` render. See `moirais.fn.describe('ghadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghadp import *
import numpy as np
# See the function signature in fn/ghadp.py for argument names.
```
