# describe('rng197') — rangayyan_ch4_dicrotic_notch_smoothed_squared
...
`print(result)` render. See `moirais.fn.describe('rng197')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng197 import *
import numpy as np
# See the function signature in fn/rng197.py for argument names.
```
