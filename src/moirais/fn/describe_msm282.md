# describe('msm282') — mvsml_convolutional_nn_eq_14_10
...
`print(result)` render. See `moirais.fn.describe('msm282')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm282 import *
import numpy as np
# See the function signature in fn/msm282.py for argument names.
```
