...
`print(result)` render. See `moirais.fn.describe('gccor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gccor import *
import numpy as np
# See the function signature in fn/gccor.py for argument names.
```
