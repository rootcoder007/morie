...
`print(result)` render. See `moirais.fn.describe('vddln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vddln import *
import numpy as np
# See the function signature in fn/vddln.py for argument names.
```
