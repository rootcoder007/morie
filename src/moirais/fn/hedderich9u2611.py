...
__all__ = ["hedderich_chapter_9_unnumbered_2611"]


def hedderich_chapter_9_unnumbered_2611(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Shannon −Wiener index inpopulationX = 0 . 5 4 0 3 and inpopulationy = 0 . 6 3 2 8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2611')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2611: GeneralStatistics expression (auto-extracted; see ref)."
