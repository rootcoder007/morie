...
`print(result)` render. See `moirais.fn.describe('splgaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgaic import *
import numpy as np
# See the function signature in fn/splgaic.py for argument names.
```
