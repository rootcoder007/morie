...
`print(result)` render. See `moirais.fn.describe('wdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wdist import *
import numpy as np
# See the function signature in fn/wdist.py for argument names.
```
