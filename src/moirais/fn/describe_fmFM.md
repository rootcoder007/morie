# describe('fmFM') — factorization_machines
...
`print(result)` render. See `moirais.fn.describe('fmFM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fmFM import *
import numpy as np
# See the function signature in fn/fmFM.py for argument names.
```
