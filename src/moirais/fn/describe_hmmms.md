# describe('hmmms') — geron_min_max_scaling
...
`print(result)` render. See `moirais.fn.describe('hmmms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmms import *
import numpy as np
# See the function signature in fn/hmmms.py for argument names.
```
