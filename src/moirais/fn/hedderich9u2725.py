...
__all__ = ["hedderich_chapter_9_unnumbered_2725"]


def hedderich_chapter_9_unnumbered_2725(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (r + 1)[ψπ(1−ψπ) +rπ(1−π)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2725')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2725: PowerAndDesign expression (auto-extracted; see ref)."
