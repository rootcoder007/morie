# describe('grcart') — geron_cart_split_cost
...
`print(result)` render. See `moirais.fn.describe('grcart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcart import *
import numpy as np
# See the function signature in fn/grcart.py for argument names.
```
