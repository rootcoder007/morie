...
`print(result)` render. See `moirais.fn.describe('xrwrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwrs import *
import numpy as np
# See the function signature in fn/xrwrs.py for argument names.
```
