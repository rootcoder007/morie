# describe('plcbsc') — placebo_scm_inference
...
`print(result)` render. See `moirais.fn.describe('plcbsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcbsc import *
import numpy as np
# See the function signature in fn/plcbsc.py for argument names.
```
