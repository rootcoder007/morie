# describe('cvxdle') — boyd_dual_norm
...
`print(result)` render. See `moirais.fn.describe('cvxdle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxdle import *
import numpy as np
# See the function signature in fn/cvxdle.py for argument names.
```
