# describe('supps') — superposition_test
...
`print(result)` render. See `moirais.fn.describe('supps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.supps import *
import numpy as np
# See the function signature in fn/supps.py for argument names.
```
