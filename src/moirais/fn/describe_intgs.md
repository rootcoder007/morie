# describe('intgs') — integrate_signal
...
`print(result)` render. See `moirais.fn.describe('intgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intgs import *
import numpy as np
# See the function signature in fn/intgs.py for argument names.
```
