# describe('rgfecg') — rangayyan_fetal_ecg
...
`print(result)` render. See `moirais.fn.describe('rgfecg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfecg import *
import numpy as np
# See the function signature in fn/rgfecg.py for argument names.
```
