# describe('pspln') — penalized_spline
...
`print(result)` render. See `moirais.fn.describe('pspln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pspln import *
import numpy as np
# See the function signature in fn/pspln.py for argument names.
```
