...
`print(result)` render. See `moirais.fn.describe('vmkbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmkbs import *
import numpy as np
# See the function signature in fn/vmkbs.py for argument names.
```
