...
__all__ = ["bivand2013_chapter_2_unnumbered_22"]


def bivand2013_chapter_2_unnumbered_22(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + legend = names(attr(q5Colours, "table")), bty = "n")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u22')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u22: GeneralStatistics expression (auto-extracted; see ref)."
