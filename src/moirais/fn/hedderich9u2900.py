...
__all__ = ["hedderich_chapter_9_unnumbered_2900"]


def hedderich_chapter_9_unnumbered_2900(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆπi =p +b(xi−¯x)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2900')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2900: GeneralStatistics expression (auto-extracted; see ref)."
