# describe('cvxsep') — boyd_separating_hyperplane
...
`print(result)` render. See `moirais.fn.describe('cvxsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsep import *
import numpy as np
# See the function signature in fn/cvxsep.py for argument names.
```
