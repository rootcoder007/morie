...
`print(result)` render. See `moirais.fn.describe('mcqmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcqmc import *
import numpy as np
# See the function signature in fn/mcqmc.py for argument names.
```
