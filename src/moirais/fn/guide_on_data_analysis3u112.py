...
__all__ = ["guide_on_data_analysis_chapter_3_unnumbered_112"]


def guide_on_data_analysis_chapter_3_unnumbered_112(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis3u112')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u112: GeneralStatistics expression (auto-extracted; see ref)."
