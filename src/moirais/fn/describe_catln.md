...
`print(result)` render. See `moirais.fn.describe('catln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catln import *
import numpy as np
# See the function signature in fn/catln.py for argument names.
```
