...
`print(result)` render. See `moirais.fn.describe('minkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.minkd import *
import numpy as np
# See the function signature in fn/minkd.py for argument names.
```
