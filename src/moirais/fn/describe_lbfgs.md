...
`print(result)` render. See `moirais.fn.describe('lbfgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lbfgs import *
import numpy as np
# See the function signature in fn/lbfgs.py for argument names.
```
