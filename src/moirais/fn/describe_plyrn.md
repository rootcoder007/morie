...
`print(result)` render. See `moirais.fn.describe('plyrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plyrn import *
import numpy as np
# See the function signature in fn/plyrn.py for argument names.
```
