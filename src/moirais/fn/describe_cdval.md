...
`print(result)` render. See `moirais.fn.describe('cdval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdval import *
import numpy as np
# See the function signature in fn/cdval.py for argument names.
```
