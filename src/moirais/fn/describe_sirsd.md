# describe('sirsd') — sirs_demographics
...
`print(result)` render. See `moirais.fn.describe('sirsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirsd import *
import numpy as np
# See the function signature in fn/sirsd.py for argument names.
```
