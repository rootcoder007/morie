# describe('fwpas') — forward_pass_dense
...
`print(result)` render. See `moirais.fn.describe('fwpas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fwpas import *
import numpy as np
# See the function signature in fn/fwpas.py for argument names.
```
