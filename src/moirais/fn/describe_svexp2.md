...
`print(result)` render. See `moirais.fn.describe('svexp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svexp2 import *
import numpy as np
# See the function signature in fn/svexp2.py for argument names.
```
