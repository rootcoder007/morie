...
`print(result)` render. See `moirais.fn.describe('aflai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aflai import *
import numpy as np
# See the function signature in fn/aflai.py for argument names.
```
