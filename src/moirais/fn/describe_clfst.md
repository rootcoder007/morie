# describe('clfst') — clfst

## WHAT IT DOES

Fast greedy spatial community
...
`print(result)` render. See `moirais.fn.describe('clfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clfst import *
import numpy as np
# See the function signature in fn/clfst.py for argument names.
```
