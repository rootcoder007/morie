...
`print(result)` render. See `moirais.fn.describe('gadrnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gadrnp import *
import numpy as np
# See the function signature in fn/gadrnp.py for argument names.
```
