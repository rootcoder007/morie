# describe('kmalbi') — kamath_alibi_bias
...
`print(result)` render. See `moirais.fn.describe('kmalbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmalbi import *
import numpy as np
# See the function signature in fn/kmalbi.py for argument names.
```
