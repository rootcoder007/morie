...
`print(result)` render. See `moirais.fn.describe('ibeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibeta import *
import numpy as np
# See the function signature in fn/ibeta.py for argument names.
```
