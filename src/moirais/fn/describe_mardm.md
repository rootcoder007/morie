# describe('mardm') — mardia_test

## WHAT IT DOES

Mardia multivariate normality test. 'A journey of a thousand miles begins with a single step. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('mardm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mardm import *
import numpy as np
# See the function signature in fn/mardm.py for argument names.
```
