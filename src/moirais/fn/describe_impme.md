# describe('impme') — impute_missing_mean
...
`print(result)` render. See `moirais.fn.describe('impme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.impme import *
import numpy as np
# See the function signature in fn/impme.py for argument names.
```
