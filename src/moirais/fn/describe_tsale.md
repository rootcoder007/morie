...
`print(result)` render. See `moirais.fn.describe('tsale')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsale import *
import numpy as np
# See the function signature in fn/tsale.py for argument names.
```
