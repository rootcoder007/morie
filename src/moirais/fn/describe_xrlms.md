...
`print(result)` render. See `moirais.fn.describe('xrlms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlms import *
import numpy as np
# See the function signature in fn/xrlms.py for argument names.
```
