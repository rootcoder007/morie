...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_73(x):
    ...
    Formula: E [ ˜s2] by n/(n − 1), we obtain the actual variance σ2 of the distribution. This
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner3e73')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e73: Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
