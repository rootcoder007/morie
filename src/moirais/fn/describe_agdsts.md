# describe('agdsts') — alphazero_distill_student
...
`print(result)` render. See `moirais.fn.describe('agdsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdsts import *
import numpy as np
# See the function signature in fn/agdsts.py for argument names.
```
