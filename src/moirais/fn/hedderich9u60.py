...
__all__ = ["hedderich_chapter_9_unnumbered_60"]


def hedderich_chapter_9_unnumbered_60(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] lg 6.30 = lg(63/10) = lg 63−lg 10 = 1.7993−1 = 0.7993]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u60')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u60: GeneralStatistics expression (auto-extracted; see ref)."
