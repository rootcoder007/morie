# describe('caltbR') — calibrated_rec
...
`print(result)` render. See `moirais.fn.describe('caltbR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caltbR import *
import numpy as np
# See the function signature in fn/caltbR.py for argument names.
```
