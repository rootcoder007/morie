...
`print(result)` render. See `moirais.fn.describe('sppde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppde import *
import numpy as np
# See the function signature in fn/sppde.py for argument names.
```
