...
`print(result)` render. See `moirais.fn.describe('babai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.babai import *
import numpy as np
# See the function signature in fn/babai.py for argument names.
```
