...
`print(result)` render. See `moirais.fn.describe('shrpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrpe import *
import numpy as np
# See the function signature in fn/shrpe.py for argument names.
```
