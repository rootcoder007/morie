# describe('aftgma') — aft_generalized_gamma
...
`print(result)` render. See `moirais.fn.describe('aftgma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aftgma import *
import numpy as np
# See the function signature in fn/aftgma.py for argument names.
```
