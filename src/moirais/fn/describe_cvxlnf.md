# describe('cvxlnf') — boyd_l1_fitting
...
`print(result)` render. See `moirais.fn.describe('cvxlnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlnf import *
import numpy as np
# See the function signature in fn/cvxlnf.py for argument names.
```
