...
`print(result)` render. See `moirais.fn.describe('pasoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pasoc import *
import numpy as np
# See the function signature in fn/pasoc.py for argument names.
```
