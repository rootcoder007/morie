...
`print(result)` render. See `moirais.fn.describe('kstwo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kstwo import *
import numpy as np
# See the function signature in fn/kstwo.py for argument names.
```
