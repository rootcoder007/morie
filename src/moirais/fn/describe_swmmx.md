...
`print(result)` render. See `moirais.fn.describe('swmmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swmmx import *
import numpy as np
# See the function signature in fn/swmmx.py for argument names.
```
