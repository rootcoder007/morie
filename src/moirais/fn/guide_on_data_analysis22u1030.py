...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1030"]


def guide_on_data_analysis_chapter_22_unnumbered_1030(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗 = 𝜇 + 𝜏𝑖 + 𝜖𝑖𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1030')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1030: GeneralStatistics expression (auto-extracted; see ref)."
