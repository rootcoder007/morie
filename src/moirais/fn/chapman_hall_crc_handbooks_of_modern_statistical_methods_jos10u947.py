...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_947"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_947(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: L(Qn,λ,δ0), for all h. This mapping AQn,λ(h)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u947')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u947: GeneralStatistics expression (auto-extracted; see ref)."
