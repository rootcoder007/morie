# describe('rgap') — rangayyan_action_potential
...
`print(result)` render. See `moirais.fn.describe('rgap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgap import *
import numpy as np
# See the function signature in fn/rgap.py for argument names.
```
