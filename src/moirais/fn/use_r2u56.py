...
__all__ = ["use_r_chapter_2_unnumbered_56"]


def use_r_chapter_2_unnumbered_56(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + plot(x =x+2 ,y=y-3 , ...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u56')`` for the full guide.
...
def cheatsheet():
    return "use_r2u56: GeneralStatistics expression (auto-extracted; see ref)."
