...
`print(result)` render. See `moirais.fn.describe('pdesl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdesl import *
import numpy as np
# See the function signature in fn/pdesl.py for argument names.
```
