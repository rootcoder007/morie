...
def andrew_b_lawson_using_r_for_bayesian_spatial_and_spatio_temp_chapter_14_unnumbered_12(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: n.sample=20000,rho.slo=1,rho.int=1,MALA=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('andrew_b_lawson_using_r_for_bayesian_spatial_and_spatio_temp14u12')`` for the full guide.
