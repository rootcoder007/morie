...
`print(result)` render. See `moirais.fn.describe('drspa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drspa import *
import numpy as np
# See the function signature in fn/drspa.py for argument names.
```
