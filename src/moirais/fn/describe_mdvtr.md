...
`print(result)` render. See `moirais.fn.describe('mdvtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdvtr import *
import numpy as np
# See the function signature in fn/mdvtr.py for argument names.
```
