...
`print(result)` render. See `moirais.fn.describe('schwz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.schwz import *
import numpy as np
# See the function signature in fn/schwz.py for argument names.
```
