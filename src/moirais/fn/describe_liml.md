...
`print(result)` render. See `moirais.fn.describe('liml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.liml import *
import numpy as np
# See the function signature in fn/liml.py for argument names.
```
