...
`print(result)` render. See `moirais.fn.describe('bnpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnpar import *
import numpy as np
# See the function signature in fn/bnpar.py for argument names.
```
