...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_30"]


def information_theory_mackay_chapter_6_unnumbered_30(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(x=0jy) = P(yjx=1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u30')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u30: GeneralStatistics expression (auto-extracted; see ref)."
