# describe('rng217') — rangayyan_ch4_schwarz_inequality_real
...
`print(result)` render. See `moirais.fn.describe('rng217')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng217 import *
import numpy as np
# See the function signature in fn/rng217.py for argument names.
```
