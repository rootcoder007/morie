...
`print(result)` render. See `moirais.fn.describe('altrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.altrn import *
import numpy as np
# See the function signature in fn/altrn.py for argument names.
```
