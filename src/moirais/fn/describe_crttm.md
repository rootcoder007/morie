# describe('crttm') — court_time_to_trial
...
`print(result)` render. See `moirais.fn.describe('crttm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crttm import *
import numpy as np
# See the function signature in fn/crttm.py for argument names.
```
