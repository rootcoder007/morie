# describe('btciqua') — boot_ci_quantile
...
`print(result)` render. See `moirais.fn.describe('btciqua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btciqua import *
import numpy as np
# See the function signature in fn/btciqua.py for argument names.
```
