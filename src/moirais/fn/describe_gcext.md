...
`print(result)` render. See `moirais.fn.describe('gcext')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcext import *
import numpy as np
# See the function signature in fn/gcext.py for argument names.
```
