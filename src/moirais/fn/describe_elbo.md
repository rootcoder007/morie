...
`print(result)` render. See `moirais.fn.describe('elbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elbo import *
import numpy as np
# See the function signature in fn/elbo.py for argument names.
```
