# describe('km045') — kamath_ch3_dante_cloze
...
`print(result)` render. See `moirais.fn.describe('km045')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km045 import *
import numpy as np
# See the function signature in fn/km045.py for argument names.
```
