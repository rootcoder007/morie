# describe('mdspl') — mds_spatial_map
...
`print(result)` render. See `moirais.fn.describe('mdspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdspl import *
import numpy as np
# See the function signature in fn/mdspl.py for argument names.
```
