# describe('rghier') — rangayyan_hierarchical_clust
...
`print(result)` render. See `moirais.fn.describe('rghier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghier import *
import numpy as np
# See the function signature in fn/rghier.py for argument names.
```
