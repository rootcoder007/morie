# describe('gplin') — gplin

## WHAT IT DOES

GP linear kernel regression.
...
`print(result)` render. See `moirais.fn.describe('gplin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gplin import *
import numpy as np
# See the function signature in fn/gplin.py for argument names.
```
