# describe('uncrt') — utility_uncertainty
...
`print(result)` render. See `moirais.fn.describe('uncrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.uncrt import *
import numpy as np
# See the function signature in fn/uncrt.py for argument names.
```
