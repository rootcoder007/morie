...
`print(result)` render. See `moirais.fn.describe('cspfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cspfn import *
import numpy as np
# See the function signature in fn/cspfn.py for argument names.
```
