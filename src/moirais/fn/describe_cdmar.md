...
`print(result)` render. See `moirais.fn.describe('cdmar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdmar import *
import numpy as np
# See the function signature in fn/cdmar.py for argument names.
```
