...
__all__ = ["hedderich_chapter_9_unnumbered_2755"]


def hedderich_chapter_9_unnumbered_2755(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: HA : |π1−π2|<∆, i.e. (π1−π2)∈[−∆,+∆] equivalent
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2755')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2755: CountModels expression (auto-extracted; see ref)."
