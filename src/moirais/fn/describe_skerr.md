# describe('skerr') — spatial_error_model
...
`print(result)` render. See `moirais.fn.describe('skerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.skerr import *
import numpy as np
# See the function signature in fn/skerr.py for argument names.
```
