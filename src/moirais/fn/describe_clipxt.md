# describe('clipxt') — clip_text_encoder
...
`print(result)` render. See `moirais.fn.describe('clipxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clipxt import *
import numpy as np
# See the function signature in fn/clipxt.py for argument names.
```
