...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_34"]


def guide_on_data_analysis_chapter_2_unnumbered_34(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3. 𝑃[𝑎 ≤ 𝑋 ≤ 𝑏] =∫
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u34')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u34: GeneralStatistics expression (auto-extracted; see ref)."
