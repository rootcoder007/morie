...
`print(result)` render. See `moirais.fn.describe('mi_cf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mi_cf import *
import numpy as np
# See the function signature in fn/mi_cf.py for argument names.
```
