# describe('rng239') — rangayyan_ch4_rational_z_transform_form
...
`print(result)` render. See `moirais.fn.describe('rng239')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng239 import *
import numpy as np
# See the function signature in fn/rng239.py for argument names.
```
