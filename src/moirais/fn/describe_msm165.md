# describe('msm165') — mvsml_ridge_lasso_elastic_eq_9_2
...
`print(result)` render. See `moirais.fn.describe('msm165')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm165 import *
import numpy as np
# See the function signature in fn/msm165.py for argument names.
```
