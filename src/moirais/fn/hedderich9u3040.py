...
__all__ = ["hedderich_chapter_9_unnumbered_3040"]


def hedderich_chapter_9_unnumbered_3040(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Sum n.1 = 60 n.2 = 30 n.3 = 10 n = 100
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3040')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3040: GeneralStatistics expression (auto-extracted; see ref)."
