...
`print(result)` render. See `moirais.fn.describe('theils')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.theils import *
import numpy as np
# See the function signature in fn/theils.py for argument names.
```
