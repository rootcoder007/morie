...
`print(result)` render. See `moirais.fn.describe('clxbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clxbr import *
import numpy as np
# See the function signature in fn/clxbr.py for argument names.
```
