# describe('causscd') — causal_synthetic_did
...
`print(result)` render. See `moirais.fn.describe('causscd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causscd import *
import numpy as np
# See the function signature in fn/causscd.py for argument names.
```
