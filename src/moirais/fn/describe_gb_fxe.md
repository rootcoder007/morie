# describe('gb_fxe') — gibbons_fisher_one_sided
...
`print(result)` render. See `moirais.fn.describe('gb_fxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_fxe import *
import numpy as np
# See the function signature in fn/gb_fxe.py for argument names.
```
