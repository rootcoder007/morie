...
def ca_chapter_10_unnumbered_337(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca10u337')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "CausalInference expression involving 'replacement' (auto-extracted; see reference for full context)."},
    )


def cheatsheet():
    return "ca10u337: CausalInference expression involving 'replacement' (auto-extracted; see reference for full context)."
