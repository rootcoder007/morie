...
`print(result)` render. See `moirais.fn.describe('gcsnw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcsnw import *
import numpy as np
# See the function signature in fn/gcsnw.py for argument names.
```
