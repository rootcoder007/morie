...
__all__ = ["hedderich_chapter_9_unnumbered_2334"]


def hedderich_chapter_9_unnumbered_2334(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: - higher thanN (µ,σ2) k< 10: Cochran;k≥10: Levene
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2334')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2334: GeneralStatistics expression (auto-extracted; see ref)."
