...
__all__ = ["wilcox_chapter_8_unnumbered_835"]


def wilcox_chapter_8_unnumbered_835(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where z1−α/ 2 is the 1 − α/2 quantile of a standard normal
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u835')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u835: GeneralStatistics expression (auto-extracted; see ref)."
