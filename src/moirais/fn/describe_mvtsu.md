...
`print(result)` render. See `moirais.fn.describe('mvtsu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtsu import *
import numpy as np
# See the function signature in fn/mvtsu.py for argument names.
```
