...
`print(result)` render. See `moirais.fn.describe('inspdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inspdr import *
import numpy as np
# See the function signature in fn/inspdr.py for argument names.
```
