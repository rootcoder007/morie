...
`print(result)` render. See `moirais.fn.describe('morph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morph import *
import numpy as np
# See the function signature in fn/morph.py for argument names.
```
