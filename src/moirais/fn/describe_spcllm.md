# describe('spcllm') — spatial_cluster_lisa
...
`print(result)` render. See `moirais.fn.describe('spcllm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcllm import *
import numpy as np
# See the function signature in fn/spcllm.py for argument names.
```
