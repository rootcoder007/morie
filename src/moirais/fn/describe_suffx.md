...
`print(result)` render. See `moirais.fn.describe('suffx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suffx import *
import numpy as np
# See the function signature in fn/suffx.py for argument names.
```
