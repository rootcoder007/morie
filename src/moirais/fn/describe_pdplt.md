...
`print(result)` render. See `moirais.fn.describe('pdplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdplt import *
import numpy as np
# See the function signature in fn/pdplt.py for argument names.
```
