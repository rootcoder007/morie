...
`print(result)` render. See `moirais.fn.describe('mased')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mased import *
import numpy as np
# See the function signature in fn/mased.py for argument names.
```
