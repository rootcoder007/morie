...
`print(result)` render. See `moirais.fn.describe('xrimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrimp import *
import numpy as np
# See the function signature in fn/xrimp.py for argument names.
```
