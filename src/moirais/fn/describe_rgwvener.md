# describe('rgwvener') — rangayyan_wavelet_energy
...
`print(result)` render. See `moirais.fn.describe('rgwvener')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvener import *
import numpy as np
# See the function signature in fn/rgwvener.py for argument names.
```
