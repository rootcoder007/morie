...
`print(result)` render. See `moirais.fn.describe('nnvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnvar import *
import numpy as np
# See the function signature in fn/nnvar.py for argument names.
```
