...
__all__ = ["hedderich_chapter_9_unnumbered_2626"]


def hedderich_chapter_9_unnumbered_2626(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆχ2 = 2.83< 3.84,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2626')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2626: GeneralStatistics expression (auto-extracted; see ref)."
