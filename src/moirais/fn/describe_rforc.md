...
`print(result)` render. See `moirais.fn.describe('rforc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rforc import *
import numpy as np
# See the function signature in fn/rforc.py for argument names.
```
