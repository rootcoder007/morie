...
__all__ = ["hedderich_chapter_9_unnumbered_1130"]


def hedderich_chapter_9_unnumbered_1130(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F -values: 2(7 + 1) = 16 ; 2(20−7) = 26 ; F16;26;0.025 = 2.36
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1130')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1130: GeneralStatistics expression (auto-extracted; see ref)."
