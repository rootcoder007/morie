# describe('bypvl') — bayesian_p_value
...
`print(result)` render. See `moirais.fn.describe('bypvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bypvl import *
import numpy as np
# See the function signature in fn/bypvl.py for argument names.
```
