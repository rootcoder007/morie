...
`print(result)` render. See `moirais.fn.describe('mdsta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsta import *
import numpy as np
# See the function signature in fn/mdsta.py for argument names.
```
