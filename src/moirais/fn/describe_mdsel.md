...
`print(result)` render. See `moirais.fn.describe('mdsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsel import *
import numpy as np
# See the function signature in fn/mdsel.py for argument names.
```
