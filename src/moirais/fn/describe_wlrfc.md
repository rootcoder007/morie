...
`print(result)` render. See `moirais.fn.describe('wlrfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlrfc import *
import numpy as np
# See the function signature in fn/wlrfc.py for argument names.
```
