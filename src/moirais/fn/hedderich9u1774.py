...
__all__ = ["hedderich_chapter_9_unnumbered_1774"]


def hedderich_chapter_9_unnumbered_1774(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: = 20% is tested against the alternative hypothesisπ1 < 20% (significance levelα= 0.05). We can
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1774')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1774: GeneralStatistics expression (auto-extracted; see ref)."
