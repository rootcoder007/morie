...
`print(result)` render. See `moirais.fn.describe('calbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.calbt import *
import numpy as np
# See the function signature in fn/calbt.py for argument names.
```
