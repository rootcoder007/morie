...
`print(result)` render. See `moirais.fn.describe('sppsac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppsac import *
import numpy as np
# See the function signature in fn/sppsac.py for argument names.
```
