...
`print(result)` render. See `moirais.fn.describe('studres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.studres import *
import numpy as np
# See the function signature in fn/studres.py for argument names.
```
