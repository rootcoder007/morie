# describe('msm170') — mvsml_ridge_lasso_elastic_eq_9_3
...
`print(result)` render. See `moirais.fn.describe('msm170')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm170 import *
import numpy as np
# See the function signature in fn/msm170.py for argument names.
```
