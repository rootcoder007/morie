...
`print(result)` render. See `moirais.fn.describe('eslsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsft import *
import numpy as np
# See the function signature in fn/eslsft.py for argument names.
```
