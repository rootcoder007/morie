...
__all__ = ["wilcox_chapter_13_unnumbered_1255"]


def wilcox_chapter_13_unnumbered_1255(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ancboot(x1,y1,x2,y2,fr1=1,fr2=1,tr=0.2,nboot=599,pts=NA,plotit = T)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1255')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1255: GeneralStatistics expression (auto-extracted; see ref)."
