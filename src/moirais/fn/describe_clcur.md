...
`print(result)` render. See `moirais.fn.describe('clcur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcur import *
import numpy as np
# See the function signature in fn/clcur.py for argument names.
```
