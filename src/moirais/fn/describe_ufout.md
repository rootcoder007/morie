# describe('ufout') — unfolding_outliers
...
`print(result)` render. See `moirais.fn.describe('ufout')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ufout import *
import numpy as np
# See the function signature in fn/ufout.py for argument names.
```
