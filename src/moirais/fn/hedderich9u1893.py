...
__all__ = ["hedderich_chapter_9_unnumbered_1893"]


def hedderich_chapter_9_unnumbered_1893(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + difference = x1−x2 ; signs = sign( difference )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1893')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1893: GeneralStatistics expression (auto-extracted; see ref)."
