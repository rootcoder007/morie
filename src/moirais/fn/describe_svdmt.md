...
`print(result)` render. See `moirais.fn.describe('svdmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdmt import *
import numpy as np
# See the function signature in fn/svdmt.py for argument names.
```
