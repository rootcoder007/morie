# describe('nnt') — number_needed_to_treat
...
`print(result)` render. See `moirais.fn.describe('nnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnt import *
import numpy as np
# See the function signature in fn/nnt.py for argument names.
```
