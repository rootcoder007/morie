...
__all__ = ["hedderich_chapter_9_unnumbered_2840"]


def hedderich_chapter_9_unnumbered_2840(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + df = round ( k −1 , 0 ) , P . Wert = round ( p , 6 ) ) ) ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2840')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2840: GeneralStatistics expression (auto-extracted; see ref)."
