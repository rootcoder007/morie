...
`print(result)` render. See `moirais.fn.describe('slxres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxres import *
import numpy as np
# See the function signature in fn/slxres.py for argument names.
```
