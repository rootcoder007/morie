# describe('posvt') — positivity_assumption
...
`print(result)` render. See `moirais.fn.describe('posvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.posvt import *
import numpy as np
# See the function signature in fn/posvt.py for argument names.
```
