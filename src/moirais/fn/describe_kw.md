# describe('kw') — kruskal_wallis_test
...
`print(result)` render. See `moirais.fn.describe('kw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kw import *
import numpy as np
# See the function signature in fn/kw.py for argument names.
```
