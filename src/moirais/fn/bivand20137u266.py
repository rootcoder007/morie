...
__all__ = ["bivand2013_chapter_7_unnumbered_266"]


def bivand2013_chapter_7_unnumbered_266(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + expected = nc$Expected, adj = nc.nb$adj, weights = nc.nb$weights,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u266')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u266: GeneralStatistics expression (auto-extracted; see ref)."
