# describe('gldvr') — goldfeld_quandt_test
...
`print(result)` render. See `moirais.fn.describe('gldvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gldvr import *
import numpy as np
# See the function signature in fn/gldvr.py for argument names.
```
