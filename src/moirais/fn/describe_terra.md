# describe('terra') — terrain_analysis
...
`print(result)` render. See `moirais.fn.describe('terra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.terra import *
import numpy as np
# See the function signature in fn/terra.py for argument names.
```
