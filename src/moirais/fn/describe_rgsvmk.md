# describe('rgsvmk') — rangayyan_svm_kernel
...
`print(result)` render. See `moirais.fn.describe('rgsvmk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsvmk import *
import numpy as np
# See the function signature in fn/rgsvmk.py for argument names.
```
