# describe('bfsdm') — bayes_factor_savage_dickey
...
`print(result)` render. See `moirais.fn.describe('bfsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfsdm import *
import numpy as np
# See the function signature in fn/bfsdm.py for argument names.
```
