# describe('moeswt') — moe_switch_routing
...
`print(result)` render. See `moirais.fn.describe('moeswt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moeswt import *
import numpy as np
# See the function signature in fn/moeswt.py for argument names.
```
