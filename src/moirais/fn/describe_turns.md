...
`print(result)` render. See `moirais.fn.describe('turns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.turns import *
import numpy as np
# See the function signature in fn/turns.py for argument names.
```
