...
`print(result)` render. See `moirais.fn.describe('wlbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlbrt import *
import numpy as np
# See the function signature in fn/wlbrt.py for argument names.
```
