...
`print(result)` render. See `moirais.fn.describe('epirf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epirf import *
import numpy as np
# See the function signature in fn/epirf.py for argument names.
```
