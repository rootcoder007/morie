...
__all__ = ["hedderich_chapter_9_unnumbered_1786"]


def hedderich_chapter_9_unnumbered_1786(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] n≥(z1−α +z1−β)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1786')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1786: CountModels expression (auto-extracted; see ref)."
