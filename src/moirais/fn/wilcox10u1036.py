...
__all__ = ["wilcox_chapter_10_unnumbered_1036"]


def wilcox_chapter_10_unnumbered_1036(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: K, L, x, tr = 0.2, JKL = J * K * L, con = 0, alpha = 0.05, grp =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1036')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1036: PowerAndDesign expression (auto-extracted; see ref)."
