# describe('gh_c7_3') — ghosal_exp_dens_kl
...
`print(result)` render. See `moirais.fn.describe('gh_c7_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_3 import *
import numpy as np
# See the function signature in fn/gh_c7_3.py for argument names.
```
