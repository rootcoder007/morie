...
__all__ = ["hedderich_chapter_9_unnumbered_655"]


def hedderich_chapter_9_unnumbered_655(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = (x−¯x)/s, for−0.5 we get (−0.5−20)/4.09 =−5.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u655')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u655: GeneralStatistics expression (auto-extracted; see ref)."
