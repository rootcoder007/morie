# describe('hmmcel') — geron_memory_cell
...
`print(result)` render. See `moirais.fn.describe('hmmcel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmcel import *
import numpy as np
# See the function signature in fn/hmmcel.py for argument names.
```
