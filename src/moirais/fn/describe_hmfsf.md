...
`print(result)` render. See `moirais.fn.describe('hmfsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfsf import *
import numpy as np
# See the function signature in fn/hmfsf.py for argument names.
```
