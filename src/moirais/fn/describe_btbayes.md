# describe('btbayes') — boot_bayesian
...
`print(result)` render. See `moirais.fn.describe('btbayes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btbayes import *
import numpy as np
# See the function signature in fn/btbayes.py for argument names.
```
