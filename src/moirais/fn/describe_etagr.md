# describe('etagr') — etiologic_fraction
...
`print(result)` render. See `moirais.fn.describe('etagr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.etagr import *
import numpy as np
# See the function signature in fn/etagr.py for argument names.
```
