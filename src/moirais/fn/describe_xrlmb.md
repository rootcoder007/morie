# describe('xrlmb') — lm_robust_error
...
`print(result)` render. See `moirais.fn.describe('xrlmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlmb import *
import numpy as np
# See the function signature in fn/xrlmb.py for argument names.
```
