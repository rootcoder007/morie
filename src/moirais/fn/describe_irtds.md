# describe('irtds') — irt_discrimination
...
`print(result)` render. See `moirais.fn.describe('irtds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtds import *
import numpy as np
# See the function signature in fn/irtds.py for argument names.
```
