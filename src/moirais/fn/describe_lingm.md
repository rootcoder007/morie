...
`print(result)` render. See `moirais.fn.describe('lingm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lingm import *
import numpy as np
# See the function signature in fn/lingm.py for argument names.
```
