...
__all__ = ["hedderich_chapter_9_unnumbered_130"]


def hedderich_chapter_9_unnumbered_130(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: letters, in total thus 26 + 262 + 263 = 18 278.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u130')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u130: GeneralStatistics expression (auto-extracted; see ref)."
