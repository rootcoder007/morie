...
`print(result)` render. See `moirais.fn.describe('sfaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfaic import *
import numpy as np
# See the function signature in fn/sfaic.py for argument names.
```
