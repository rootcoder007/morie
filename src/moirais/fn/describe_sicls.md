...
`print(result)` render. See `moirais.fn.describe('sicls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sicls import *
import numpy as np
# See the function signature in fn/sicls.py for argument names.
```
