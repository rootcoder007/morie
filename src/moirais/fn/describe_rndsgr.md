...
`print(result)` render. See `moirais.fn.describe('rndsgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndsgr import *
import numpy as np
# See the function signature in fn/rndsgr.py for argument names.
```
