...
`print(result)` render. See `moirais.fn.describe('wqtss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtss import *
import numpy as np
# See the function signature in fn/wqtss.py for argument names.
```
