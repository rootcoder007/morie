# describe('rgcxy') — rangayyan_coherence_cxy
...
`print(result)` render. See `moirais.fn.describe('rgcxy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcxy import *
import numpy as np
# See the function signature in fn/rgcxy.py for argument names.
```
