# describe('cmifn') — conditional_mutual_information
...
`print(result)` render. See `moirais.fn.describe('cmifn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmifn import *
import numpy as np
# See the function signature in fn/cmifn.py for argument names.
```
