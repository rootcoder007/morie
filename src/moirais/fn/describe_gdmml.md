...
`print(result)` render. See `moirais.fn.describe('gdmml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmml import *
import numpy as np
# See the function signature in fn/gdmml.py for argument names.
```
