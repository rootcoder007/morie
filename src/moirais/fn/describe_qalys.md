# describe('qalys') — qaly_computation
...
`print(result)` render. See `moirais.fn.describe('qalys')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qalys import *
import numpy as np
# See the function signature in fn/qalys.py for argument names.
```
