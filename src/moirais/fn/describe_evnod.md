# describe('evnod') — even_odd_decompose
...
`print(result)` render. See `moirais.fn.describe('evnod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evnod import *
import numpy as np
# See the function signature in fn/evnod.py for argument names.
```
