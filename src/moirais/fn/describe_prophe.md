# describe('prophe') — facebook_prophet
...
`print(result)` render. See `moirais.fn.describe('prophe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prophe import *
import numpy as np
# See the function signature in fn/prophe.py for argument names.
```
