...
`print(result)` render. See `moirais.fn.describe('tssgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssgr import *
import numpy as np
# See the function signature in fn/tssgr.py for argument names.
```
