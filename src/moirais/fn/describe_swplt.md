...
`print(result)` render. See `moirais.fn.describe('swplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swplt import *
import numpy as np
# See the function signature in fn/swplt.py for argument names.
```
