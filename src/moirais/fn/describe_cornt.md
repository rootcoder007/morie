# describe('cornt') — correlation_entropy
...
`print(result)` render. See `moirais.fn.describe('cornt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cornt import *
import numpy as np
# See the function signature in fn/cornt.py for argument names.
```
