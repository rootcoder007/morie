...
`print(result)` render. See `moirais.fn.describe('msdcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdcs import *
import numpy as np
# See the function signature in fn/msdcs.py for argument names.
```
