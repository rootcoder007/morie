...
`print(result)` render. See `moirais.fn.describe('sfrmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfrmf import *
import numpy as np
# See the function signature in fn/sfrmf.py for argument names.
```
