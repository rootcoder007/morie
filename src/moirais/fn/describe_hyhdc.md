...
`print(result)` render. See `moirais.fn.describe('hyhdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyhdc import *
import numpy as np
# See the function signature in fn/hyhdc.py for argument names.
```
