...
`print(result)` render. See `moirais.fn.describe('avail')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avail import *
import numpy as np
# See the function signature in fn/avail.py for argument names.
```
