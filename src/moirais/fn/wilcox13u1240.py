...
__all__ = ["wilcox_chapter_13_unnumbered_1240"]


def wilcox_chapter_13_unnumbered_1240(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SMM = TRUE, tr=0.2, nreps = 1000, MC = FALSE, pts = NULL, SEED = TRUE, nboot
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1240')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1240: GeneralStatistics expression (auto-extracted; see ref)."
