# describe('tmort') — temperature_mortality_vcurve
...
`print(result)` render. See `moirais.fn.describe('tmort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmort import *
import numpy as np
# See the function signature in fn/tmort.py for argument names.
```
