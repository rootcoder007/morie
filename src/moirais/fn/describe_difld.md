...
`print(result)` render. See `moirais.fn.describe('difld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difld import *
import numpy as np
# See the function signature in fn/difld.py for argument names.
```
