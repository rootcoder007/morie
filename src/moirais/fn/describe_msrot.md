...
`print(result)` render. See `moirais.fn.describe('msrot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msrot import *
import numpy as np
# See the function signature in fn/msrot.py for argument names.
```
