# describe('clagm') — clagm

## WHAT IT DOES

Agglomerative spatial cluster
...
`print(result)` render. See `moirais.fn.describe('clagm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clagm import *
import numpy as np
# See the function signature in fn/clagm.py for argument names.
```
