...
__all__ = ["hedderich_chapter_9_unnumbered_1780"]


def hedderich_chapter_9_unnumbered_1780(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H01 : pp̄0 HA1 : p > p 0 x > x o = np0 + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1780')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1780: CountModels expression (auto-extracted; see ref)."
