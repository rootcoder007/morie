# describe('gb2311') — gibbons_edf_mean_var
...
`print(result)` render. See `moirais.fn.describe('gb2311')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2311 import *
import numpy as np
# See the function signature in fn/gb2311.py for argument names.
```
