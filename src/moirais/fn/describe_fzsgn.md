# describe('fzsgn') — fauzi_smoothed_sign
...
`print(result)` render. See `moirais.fn.describe('fzsgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzsgn import *
import numpy as np
# See the function signature in fn/fzsgn.py for argument names.
```
