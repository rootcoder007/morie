...
`print(result)` render. See `moirais.fn.describe('seexr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seexr import *
import numpy as np
# See the function signature in fn/seexr.py for argument names.
```
