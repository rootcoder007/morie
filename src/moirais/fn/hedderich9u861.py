...
__all__ = ["hedderich_chapter_9_unnumbered_861"]


def hedderich_chapter_9_unnumbered_861(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: dnorm() (withµ= 0 andσ=1) forz=(x−¯x)/s (x are the class midpoints). The quality of the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u861')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u861: GeneralStatistics expression (auto-extracted; see ref)."
