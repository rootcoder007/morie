...
`print(result)` render. See `moirais.fn.describe('qnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qnorm import *
import numpy as np
# See the function signature in fn/qnorm.py for argument names.
```
