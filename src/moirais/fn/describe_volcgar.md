# describe('volcgar') — vol_cgarch_fit
...
`print(result)` render. See `moirais.fn.describe('volcgar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volcgar import *
import numpy as np
# See the function signature in fn/volcgar.py for argument names.
```
