...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1251"]


def guide_on_data_analysis_chapter_25_unnumbered_1251(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑠2/𝑛 = 𝑛( ̄ 𝑦 − 𝜇0)(𝑠2)−1( ̄ 𝑦 − 𝜇0).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1251')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1251: GeneralStatistics expression (auto-extracted; see ref)."
