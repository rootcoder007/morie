...
__all__ = ["hedderich_chapter_9_unnumbered_1916"]


def hedderich_chapter_9_unnumbered_1916(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] β=P (Zz̄β) = Φ(zβ) = P (Z≤|µ−µ0|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1916')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1916: CountModels expression (auto-extracted; see ref)."
