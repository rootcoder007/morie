# describe('armae') — arma_estimate_fn
...
`print(result)` render. See `moirais.fn.describe('armae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.armae import *
import numpy as np
# See the function signature in fn/armae.py for argument names.
```
