# describe('kmgrnd') — kamath_groundedness_reward
...
`print(result)` render. See `moirais.fn.describe('kmgrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmgrnd import *
import numpy as np
# See the function signature in fn/kmgrnd.py for argument names.
```
