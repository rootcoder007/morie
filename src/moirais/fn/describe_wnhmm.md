...
`print(result)` render. See `moirais.fn.describe('wnhmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnhmm import *
import numpy as np
# See the function signature in fn/wnhmm.py for argument names.
```
