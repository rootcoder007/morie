...
`print(result)` render. See `moirais.fn.describe('zxalb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxalb import *
import numpy as np
# See the function signature in fn/zxalb.py for argument names.
```
