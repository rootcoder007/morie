# describe('sgdop') — sgdop

## WHAT IT DOES

rStochastic gradient descent optimizer.
...
`print(result)` render. See `moirais.fn.describe('sgdop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdop import *
import numpy as np
# See the function signature in fn/sgdop.py for argument names.
```
