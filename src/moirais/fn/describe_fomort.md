...
`print(result)` render. See `moirais.fn.describe('fomort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fomort import *
import numpy as np
# See the function signature in fn/fomort.py for argument names.
```
