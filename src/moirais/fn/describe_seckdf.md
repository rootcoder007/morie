# describe('seckdf') — hkdf_extract_expand
...
`print(result)` render. See `moirais.fn.describe('seckdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seckdf import *
import numpy as np
# See the function signature in fn/seckdf.py for argument names.
```
