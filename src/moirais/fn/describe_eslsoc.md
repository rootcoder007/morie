# describe('eslsoc') — esl_self_organize
...
`print(result)` render. See `moirais.fn.describe('eslsoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsoc import *
import numpy as np
# See the function signature in fn/eslsoc.py for argument names.
```
