...
`print(result)` render. See `moirais.fn.describe('catsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catsc import *
import numpy as np
# See the function signature in fn/catsc.py for argument names.
```
