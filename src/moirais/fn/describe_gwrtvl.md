...
`print(result)` render. See `moirais.fn.describe('gwrtvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrtvl import *
import numpy as np
# See the function signature in fn/gwrtvl.py for argument names.
```
