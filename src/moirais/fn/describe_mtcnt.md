...
`print(result)` render. See `moirais.fn.describe('mtcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcnt import *
import numpy as np
# See the function signature in fn/mtcnt.py for argument names.
```
