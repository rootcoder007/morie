...
__all__ = ["hedderich_chapter_9_unnumbered_645"]


def hedderich_chapter_9_unnumbered_645(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Z̄1x̄2 + 0.5−np√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u645')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u645: GeneralStatistics expression (auto-extracted; see ref)."
