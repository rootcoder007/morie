# describe('gb821t') — gibbons_wrs_ties
...
`print(result)` render. See `moirais.fn.describe('gb821t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb821t import *
import numpy as np
# See the function signature in fn/gb821t.py for argument names.
```
