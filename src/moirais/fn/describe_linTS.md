...
`print(result)` render. See `moirais.fn.describe('linTS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linTS import *
import numpy as np
# See the function signature in fn/linTS.py for argument names.
```
