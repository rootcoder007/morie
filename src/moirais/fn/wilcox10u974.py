...
__all__ = ["wilcox_chapter_10_unnumbered_974"]


def wilcox_chapter_10_unnumbered_974(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 4 =µ 1 − µ 2 − µ 3 +µ 4.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u974')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u974: GeneralStatistics expression (auto-extracted; see ref)."
