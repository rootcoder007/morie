...
__all__ = ["hedderich_chapter_9_unnumbered_3038"]


def hedderich_chapter_9_unnumbered_3038(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] D2 n21 = 15 n22 = 20 n23 = 5 n2. = 40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3038')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3038: GeneralStatistics expression (auto-extracted; see ref)."
