...
__all__ = ["hedderich_chapter_9_unnumbered_3211"]


def hedderich_chapter_9_unnumbered_3211(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺ Given:ayx = 7.729;αyx = 15.292;sayx = 2.862;n = 80;α= 0.05 for two-sided
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3211')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3211: GeneralStatistics expression (auto-extracted; see ref)."
