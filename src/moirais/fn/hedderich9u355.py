...
__all__ = ["hedderich_chapter_9_unnumbered_355"]


def hedderich_chapter_9_unnumbered_355(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: y = aebx [ln y] = ln a + b[x] ln y x ln a b
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u355')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u355: PowerAndDesign expression (auto-extracted; see ref)."
