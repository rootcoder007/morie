...
`print(result)` render. See `moirais.fn.describe('chlann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlann import *
import numpy as np
# See the function signature in fn/chlann.py for argument names.
```
