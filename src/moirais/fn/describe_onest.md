...
`print(result)` render. See `moirais.fn.describe('onest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.onest import *
import numpy as np
# See the function signature in fn/onest.py for argument names.
```
