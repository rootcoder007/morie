...
__all__ = ["hedderich_chapter_9_unnumbered_2042"]


def hedderich_chapter_9_unnumbered_2042(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: parameters:H0:µ1 =µ2 can be rejected at the 5% level forn1 > 10 andn2 > 10 as soon
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2042')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2042: GeneralStatistics expression (auto-extracted; see ref)."
