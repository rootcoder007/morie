# describe('stmcb') — steiglitz_mcbride_fn
...
`print(result)` render. See `moirais.fn.describe('stmcb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stmcb import *
import numpy as np
# See the function signature in fn/stmcb.py for argument names.
```
