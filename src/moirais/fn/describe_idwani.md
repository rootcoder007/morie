...
`print(result)` render. See `moirais.fn.describe('idwani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwani import *
import numpy as np
# See the function signature in fn/idwani.py for argument names.
```
