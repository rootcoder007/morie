...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1511"]


def guide_on_data_analysis_chapter_30_unnumbered_1511(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -2 x cohort = 6 0.31 (0.83)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1511')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1511: GeneralStatistics expression (auto-extracted; see ref)."
