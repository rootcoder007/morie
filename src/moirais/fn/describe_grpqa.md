# describe('grpqa') — grouped_query_attention
...
`print(result)` render. See `moirais.fn.describe('grpqa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpqa import *
import numpy as np
# See the function signature in fn/grpqa.py for argument names.
```
