...
__all__ = ["hedderich_chapter_9_unnumbered_1862"]


def hedderich_chapter_9_unnumbered_1862(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1862')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1862: GeneralStatistics expression (auto-extracted; see ref)."
