# describe('sgpcf') — pair_correlation_function
...
`print(result)` render. See `moirais.fn.describe('sgpcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpcf import *
import numpy as np
# See the function signature in fn/sgpcf.py for argument names.
```
