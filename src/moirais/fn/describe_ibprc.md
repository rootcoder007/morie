# describe('ibprc') — indian_buffet_process
...
`print(result)` render. See `moirais.fn.describe('ibprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibprc import *
import numpy as np
# See the function signature in fn/ibprc.py for argument names.
```
