# describe('lrpos') — likelihood_ratio
...
`print(result)` render. See `moirais.fn.describe('lrpos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrpos import *
import numpy as np
# See the function signature in fn/lrpos.py for argument names.
```
