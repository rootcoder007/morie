...
`print(result)` render. See `moirais.fn.describe('svjhn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svjhn import *
import numpy as np
# See the function signature in fn/svjhn.py for argument names.
```
