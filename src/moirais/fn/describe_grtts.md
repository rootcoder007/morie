# describe('grtts') — geron_train_test_split
...
`print(result)` render. See `moirais.fn.describe('grtts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtts import *
import numpy as np
# See the function signature in fn/grtts.py for argument names.
```
