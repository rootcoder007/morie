...
`print(result)` render. See `moirais.fn.describe('logsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logsc import *
import numpy as np
# See the function signature in fn/logsc.py for argument names.
```
