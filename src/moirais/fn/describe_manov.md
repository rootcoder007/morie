...
`print(result)` render. See `moirais.fn.describe('manov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manov import *
import numpy as np
# See the function signature in fn/manov.py for argument names.
```
