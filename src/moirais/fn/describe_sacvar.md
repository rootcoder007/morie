...
`print(result)` render. See `moirais.fn.describe('sacvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacvar import *
import numpy as np
# See the function signature in fn/sacvar.py for argument names.
```
