...
`print(result)` render. See `moirais.fn.describe('stklhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stklhs import *
import numpy as np
# See the function signature in fn/stklhs.py for argument names.
```
