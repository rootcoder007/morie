# describe('snr2') — snijders_bosker_r2_level1
...
`print(result)` render. See `moirais.fn.describe('snr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snr2 import *
import numpy as np
# See the function signature in fn/snr2.py for argument names.
```
