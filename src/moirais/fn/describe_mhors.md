# describe('mhors') — mantel_haenszel_or
...
`print(result)` render. See `moirais.fn.describe('mhors')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhors import *
import numpy as np
# See the function signature in fn/mhors.py for argument names.
```
