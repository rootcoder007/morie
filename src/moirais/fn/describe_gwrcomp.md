...
`print(result)` render. See `moirais.fn.describe('gwrcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrcomp import *
import numpy as np
# See the function signature in fn/gwrcomp.py for argument names.
```
