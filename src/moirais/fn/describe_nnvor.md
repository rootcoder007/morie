...
`print(result)` render. See `moirais.fn.describe('nnvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnvor import *
import numpy as np
# See the function signature in fn/nnvor.py for argument names.
```
