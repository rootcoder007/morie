...
`print(result)` render. See `moirais.fn.describe('kmgev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmgev import *
import numpy as np
# See the function signature in fn/kmgev.py for argument names.
```
