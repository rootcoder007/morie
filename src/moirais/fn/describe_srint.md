# describe('srint') — serial_interval
...
`print(result)` render. See `moirais.fn.describe('srint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srint import *
import numpy as np
# See the function signature in fn/srint.py for argument names.
```
