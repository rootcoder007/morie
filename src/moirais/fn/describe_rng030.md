# describe('rng030') — rangayyan_ch3_continuous_convolution
...
`print(result)` render. See `moirais.fn.describe('rng030')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng030 import *
import numpy as np
# See the function signature in fn/rng030.py for argument names.
```
