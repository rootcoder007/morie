# describe('sgwls') — wls_variogram_fit
...
`print(result)` render. See `moirais.fn.describe('sgwls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgwls import *
import numpy as np
# See the function signature in fn/sgwls.py for argument names.
```
