# describe('osns1') — otis_sensitivity
...
`print(result)` render. See `moirais.fn.describe('osns1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.osns1 import *
import numpy as np
# See the function signature in fn/osns1.py for argument names.
```
