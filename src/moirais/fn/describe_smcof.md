...
`print(result)` render. See `moirais.fn.describe('smcof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcof import *
import numpy as np
# See the function signature in fn/smcof.py for argument names.
```
