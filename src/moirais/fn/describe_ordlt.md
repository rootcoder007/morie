...
`print(result)` render. See `moirais.fn.describe('ordlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ordlt import *
import numpy as np
# See the function signature in fn/ordlt.py for argument names.
```
