# describe('spvmr') — schabenberger_variance_mean_ratio
...
`print(result)` render. See `moirais.fn.describe('spvmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spvmr import *
import numpy as np
# See the function signature in fn/spvmr.py for argument names.
```
