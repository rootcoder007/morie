...
`print(result)` render. See `moirais.fn.describe('nutsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nutsm import *
import numpy as np
# See the function signature in fn/nutsm.py for argument names.
```
