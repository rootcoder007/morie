...
`print(result)` render. See `moirais.fn.describe('arnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arnrm import *
import numpy as np
# See the function signature in fn/arnrm.py for argument names.
```
