# describe('sptgk') — schabenberger_trans_gaussian_kriging
...
`print(result)` render. See `moirais.fn.describe('sptgk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptgk import *
import numpy as np
# See the function signature in fn/sptgk.py for argument names.
```
