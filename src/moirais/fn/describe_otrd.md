# describe('otrd') — otis_trend_summary
...
`print(result)` render. See `moirais.fn.describe('otrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otrd import *
import numpy as np
# See the function signature in fn/otrd.py for argument names.
```
