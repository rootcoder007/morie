...
`print(result)` render. See `moirais.fn.describe('nbrdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbrdm import *
import numpy as np
# See the function signature in fn/nbrdm.py for argument names.
```
