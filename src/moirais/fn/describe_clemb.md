...
`print(result)` render. See `moirais.fn.describe('clemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clemb import *
import numpy as np
# See the function signature in fn/clemb.py for argument names.
```
