...
__all__ = ["wilcox_chapter_8_unnumbered_828"]


def wilcox_chapter_8_unnumbered_828(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] p11,12 =P (Xi11 <X i12) + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u828')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u828: GeneralStatistics expression (auto-extracted; see ref)."
