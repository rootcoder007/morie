...
`print(result)` render. See `moirais.fn.describe('clclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clclr import *
import numpy as np
# See the function signature in fn/clclr.py for argument names.
```
