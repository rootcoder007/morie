...
`print(result)` render. See `moirais.fn.describe('ghdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghdst import *
import numpy as np
# See the function signature in fn/ghdst.py for argument names.
```
