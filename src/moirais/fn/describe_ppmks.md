...
`print(result)` render. See `moirais.fn.describe('ppmks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmks import *
import numpy as np
# See the function signature in fn/ppmks.py for argument names.
```
