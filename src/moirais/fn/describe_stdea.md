# describe('stdea') — st_diff_equation
...
`print(result)` render. See `moirais.fn.describe('stdea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdea import *
import numpy as np
# See the function signature in fn/stdea.py for argument names.
```
