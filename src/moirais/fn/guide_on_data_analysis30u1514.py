...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1514"]


def guide_on_data_analysis_chapter_30_unnumbered_1514(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -2 x cohort = 9 1.2 (0.82)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1514')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1514: GeneralStatistics expression (auto-extracted; see ref)."
