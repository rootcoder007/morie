# describe('sgrmr') — moran_residual_test
...
`print(result)` render. See `moirais.fn.describe('sgrmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgrmr import *
import numpy as np
# See the function signature in fn/sgrmr.py for argument names.
```
