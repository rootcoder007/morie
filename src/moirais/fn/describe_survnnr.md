# describe('survnnr') — survival_neural_net
...
`print(result)` render. See `moirais.fn.describe('survnnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survnnr import *
import numpy as np
# See the function signature in fn/survnnr.py for argument names.
```
