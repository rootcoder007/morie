# describe('smpth') — sampling_theorem_check
...
`print(result)` render. See `moirais.fn.describe('smpth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpth import *
import numpy as np
# See the function signature in fn/smpth.py for argument names.
```
