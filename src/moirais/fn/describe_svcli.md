...
`print(result)` render. See `moirais.fn.describe('svcli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcli import *
import numpy as np
# See the function signature in fn/svcli.py for argument names.
```
