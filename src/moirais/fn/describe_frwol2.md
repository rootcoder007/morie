...
`print(result)` render. See `moirais.fn.describe('frwol2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frwol2 import *
import numpy as np
# See the function signature in fn/frwol2.py for argument names.
```
