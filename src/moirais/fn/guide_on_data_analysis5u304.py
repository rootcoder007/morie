...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_304"]


def guide_on_data_analysis_chapter_5_unnumbered_304(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ‖Y − X𝛽‖2 = Y⊤Y − 2𝛽⊤X⊤Y + 𝛽⊤(X⊤X)𝛽.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u304')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u304: GeneralStatistics expression (auto-extracted; see ref)."
