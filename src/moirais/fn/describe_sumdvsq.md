...
`print(result)` render. See `moirais.fn.describe('sumdvsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sumdvsq import *
import numpy as np
# See the function signature in fn/sumdvsq.py for argument names.
```
