...
`print(result)` render. See `moirais.fn.describe('maerb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maerb import *
import numpy as np
# See the function signature in fn/maerb.py for argument names.
```
