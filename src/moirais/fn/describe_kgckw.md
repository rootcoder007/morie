...
`print(result)` render. See `moirais.fn.describe('kgckw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgckw import *
import numpy as np
# See the function signature in fn/kgckw.py for argument names.
```
