# describe('tinfo') — test_information
...
`print(result)` render. See `moirais.fn.describe('tinfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tinfo import *
import numpy as np
# See the function signature in fn/tinfo.py for argument names.
```
