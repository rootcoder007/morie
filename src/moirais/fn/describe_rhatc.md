# describe('rhatc') — r_hat_convergence
...
`print(result)` render. See `moirais.fn.describe('rhatc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rhatc import *
import numpy as np
# See the function signature in fn/rhatc.py for argument names.
```
