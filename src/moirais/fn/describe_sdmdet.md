...
`print(result)` render. See `moirais.fn.describe('sdmdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmdet import *
import numpy as np
# See the function signature in fn/sdmdet.py for argument names.
```
