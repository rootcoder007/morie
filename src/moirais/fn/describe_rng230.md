# describe('rng230') — rangayyan_ch4_homomorphic_multiplicative_signal
...
`print(result)` render. See `moirais.fn.describe('rng230')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng230 import *
import numpy as np
# See the function signature in fn/rng230.py for argument names.
```
