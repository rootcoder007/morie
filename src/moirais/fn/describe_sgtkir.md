# describe('sgtkir') — sgt_kirchhoff_index
...
`print(result)` render. See `moirais.fn.describe('sgtkir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtkir import *
import numpy as np
# See the function signature in fn/sgtkir.py for argument names.
```
