...
`print(result)` render. See `moirais.fn.describe('xgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xgb import *
import numpy as np
# See the function signature in fn/xgb.py for argument names.
```
