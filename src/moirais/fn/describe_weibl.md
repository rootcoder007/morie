...
`print(result)` render. See `moirais.fn.describe('weibl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weibl import *
import numpy as np
# See the function signature in fn/weibl.py for argument names.
```
