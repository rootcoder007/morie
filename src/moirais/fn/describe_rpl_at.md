# describe('rpl_at') — rplace_age_trend
...
`print(result)` render. See `moirais.fn.describe('rpl_at')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_at import *
import numpy as np
# See the function signature in fn/rpl_at.py for argument names.
```
