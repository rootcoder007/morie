# describe('rgelbow') — rangayyan_kmeans_elbow
...
`print(result)` render. See `moirais.fn.describe('rgelbow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgelbow import *
import numpy as np
# See the function signature in fn/rgelbow.py for argument names.
```
