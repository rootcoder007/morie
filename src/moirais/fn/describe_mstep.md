...
`print(result)` render. See `moirais.fn.describe('mstep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstep import *
import numpy as np
# See the function signature in fn/mstep.py for argument names.
```
