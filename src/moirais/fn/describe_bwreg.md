...
`print(result)` render. See `moirais.fn.describe('bwreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwreg import *
import numpy as np
# See the function signature in fn/bwreg.py for argument names.
```
