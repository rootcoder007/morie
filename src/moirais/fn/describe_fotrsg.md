...
`print(result)` render. See `moirais.fn.describe('fotrsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fotrsg import *
import numpy as np
# See the function signature in fn/fotrsg.py for argument names.
```
