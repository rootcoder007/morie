...
__all__ = ["hedderich_chapter_9_unnumbered_470"]


def hedderich_chapter_9_unnumbered_470(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (3)P3=P (A)−P (A∩B)−P (A∩C)+P (A∩B∩C)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u470')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u470: GeneralStatistics expression (auto-extracted; see ref)."
