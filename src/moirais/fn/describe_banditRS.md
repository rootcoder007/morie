# describe('banditRS') — contextual_bandit_rec
...
`print(result)` render. See `moirais.fn.describe('banditRS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.banditRS import *
import numpy as np
# See the function signature in fn/banditRS.py for argument names.
```
