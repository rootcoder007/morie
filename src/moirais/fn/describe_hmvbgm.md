# describe('hmvbgm') — geron_variational_bayes_gmm
...
`print(result)` render. See `moirais.fn.describe('hmvbgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvbgm import *
import numpy as np
# See the function signature in fn/hmvbgm.py for argument names.
```
