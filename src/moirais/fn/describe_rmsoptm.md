...
`print(result)` render. See `moirais.fn.describe('rmsoptm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsoptm import *
import numpy as np
# See the function signature in fn/rmsoptm.py for argument names.
```
