...
`print(result)` render. See `moirais.fn.describe('xrsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrsdm import *
import numpy as np
# See the function signature in fn/xrsdm.py for argument names.
```
