...
`print(result)` render. See `moirais.fn.describe('hmlstm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlstm import *
import numpy as np
# See the function signature in fn/hmlstm.py for argument names.
```
