# describe('wilcox3e15') — wilcox_chapter_3_equation_15
...
```python
from moirais.fn.wilcox3e15 import wilcox_chapter_3_equation_15
import numpy as np
result = wilcox_chapter_3_equation_15(np.random.default_rng(42).normal(0, 1, 100))
