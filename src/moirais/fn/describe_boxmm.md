...
`print(result)` render. See `moirais.fn.describe('boxmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boxmm import *
import numpy as np
# See the function signature in fn/boxmm.py for argument names.
```
