...
`print(result)` render. See `moirais.fn.describe('cksim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cksim import *
import numpy as np
# See the function signature in fn/cksim.py for argument names.
```
