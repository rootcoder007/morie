...
`print(result)` render. See `moirais.fn.describe('svmnl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmnl2 import *
import numpy as np
# See the function signature in fn/svmnl2.py for argument names.
```
