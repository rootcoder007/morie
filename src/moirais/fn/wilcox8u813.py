...
__all__ = ["wilcox_chapter_8_unnumbered_813"]


def wilcox_chapter_8_unnumbered_813(x):
    """
    Resampling expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u813')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u813: Resampling expression (auto-extracted; see ref)."
