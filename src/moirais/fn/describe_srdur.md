...
`print(result)` render. See `moirais.fn.describe('srdur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srdur import *
import numpy as np
# See the function signature in fn/srdur.py for argument names.
```
