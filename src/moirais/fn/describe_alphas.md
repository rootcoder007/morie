# describe('alphas') — alphazero_self_play
...
`print(result)` render. See `moirais.fn.describe('alphas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alphas import *
import numpy as np
# See the function signature in fn/alphas.py for argument names.
```
