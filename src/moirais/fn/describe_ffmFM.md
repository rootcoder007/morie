...
`print(result)` render. See `moirais.fn.describe('ffmFM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ffmFM import *
import numpy as np
# See the function signature in fn/ffmFM.py for argument names.
```
