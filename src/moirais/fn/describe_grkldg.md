# describe('grkldg') — geron_kl_divergence_gaussian
...
`print(result)` render. See `moirais.fn.describe('grkldg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkldg import *
import numpy as np
# See the function signature in fn/grkldg.py for argument names.
```
