# describe('procs') — procrustes_rotation
...
`print(result)` render. See `moirais.fn.describe('procs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.procs import *
import numpy as np
# See the function signature in fn/procs.py for argument names.
```
