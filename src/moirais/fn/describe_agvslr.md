# describe('agvslr') — alphazero_value_lr
...
`print(result)` render. See `moirais.fn.describe('agvslr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agvslr import *
import numpy as np
# See the function signature in fn/agvslr.py for argument names.
```
