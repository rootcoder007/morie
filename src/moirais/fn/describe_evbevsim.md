# describe('evbevsim') — evt_bv_evd_sim
...
`print(result)` render. See `moirais.fn.describe('evbevsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evbevsim import *
import numpy as np
# See the function signature in fn/evbevsim.py for argument names.
```
