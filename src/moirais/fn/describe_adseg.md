# describe('adseg') — adaptive_segment
...
`print(result)` render. See `moirais.fn.describe('adseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adseg import *
import numpy as np
# See the function signature in fn/adseg.py for argument names.
```
