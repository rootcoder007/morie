...
__all__ = ["wilcox_chapter_14_unnumbered_748"]


def wilcox_chapter_14_unnumbered_748(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: suppose α = 0 .05. Then n = 8, f0.025 = 0 .025, f0.975 = 4 .42, F = 6 .05, and the 0.95
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u748')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u748: GeneralStatistics expression (auto-extracted; see ref)."
