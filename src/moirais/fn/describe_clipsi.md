# describe('clipsi') — clip_similarity
...
`print(result)` render. See `moirais.fn.describe('clipsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clipsi import *
import numpy as np
# See the function signature in fn/clipsi.py for argument names.
```
