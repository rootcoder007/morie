# describe('rgica') — rangayyan_fastica
...
`print(result)` render. See `moirais.fn.describe('rgica')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgica import *
import numpy as np
# See the function signature in fn/rgica.py for argument names.
```
