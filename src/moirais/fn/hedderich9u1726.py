...
__all__ = ["hedderich_chapter_9_unnumbered_1726"]


def hedderich_chapter_9_unnumbered_1726(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.64/√n 0.69/√n 0.72/√n 0.75/√n 0.77/√n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1726')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1726: GeneralStatistics expression (auto-extracted; see ref)."
