...
__all__ = ["hedderich_chapter_9_unnumbered_2105"]


def hedderich_chapter_9_unnumbered_2105(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] U1 =mn + m(m + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2105')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2105: GeneralStatistics expression (auto-extracted; see ref)."
