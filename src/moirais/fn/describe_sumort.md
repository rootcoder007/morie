# describe('sumort') — substance_mortality
...
`print(result)` render. See `moirais.fn.describe('sumort')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sumort import *
import numpy as np
# See the function signature in fn/sumort.py for argument names.
```
