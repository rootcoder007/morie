# describe('jackvar') — jackknife_variance_survey
...
`print(result)` render. See `moirais.fn.describe('jackvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jackvar import *
import numpy as np
# See the function signature in fn/jackvar.py for argument names.
```
