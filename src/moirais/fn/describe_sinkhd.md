# describe('sinkhd') — sinkhorn_distance
...
`print(result)` render. See `moirais.fn.describe('sinkhd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sinkhd import *
import numpy as np
# See the function signature in fn/sinkhd.py for argument names.
```
