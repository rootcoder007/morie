# describe('srvey') — survey_prevalence
...
`print(result)` render. See `moirais.fn.describe('srvey')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srvey import *
import numpy as np
# See the function signature in fn/srvey.py for argument names.
```
