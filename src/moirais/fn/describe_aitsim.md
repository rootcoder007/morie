# describe('aitsim') — compositional_simpson
...
`print(result)` render. See `moirais.fn.describe('aitsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitsim import *
import numpy as np
# See the function signature in fn/aitsim.py for argument names.
```
