# describe('kmspn') — kamath_t5_span_corruption
...
`print(result)` render. See `moirais.fn.describe('kmspn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmspn import *
import numpy as np
# See the function signature in fn/kmspn.py for argument names.
```
