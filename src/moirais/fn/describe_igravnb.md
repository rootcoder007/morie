...
`print(result)` render. See `moirais.fn.describe('igravnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravnb import *
import numpy as np
# See the function signature in fn/igravnb.py for argument names.
```
