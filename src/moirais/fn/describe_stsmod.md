# describe('stsmod') — state_space_model
...
`print(result)` render. See `moirais.fn.describe('stsmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stsmod import *
import numpy as np
# See the function signature in fn/stsmod.py for argument names.
```
