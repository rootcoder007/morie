# describe('ghopt') — ghopt

## WHAT IT DOES

Optimal location health
...
`print(result)` render. See `moirais.fn.describe('ghopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghopt import *
import numpy as np
# See the function signature in fn/ghopt.py for argument names.
```
