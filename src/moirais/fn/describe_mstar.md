...
`print(result)` render. See `moirais.fn.describe('mstar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstar import *
import numpy as np
# See the function signature in fn/mstar.py for argument names.
```
