...
`print(result)` render. See `moirais.fn.describe('plgcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plgcv import *
import numpy as np
# See the function signature in fn/plgcv.py for argument names.
```
