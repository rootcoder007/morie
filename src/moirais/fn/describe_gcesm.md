...
`print(result)` render. See `moirais.fn.describe('gcesm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcesm import *
import numpy as np
# See the function signature in fn/gcesm.py for argument names.
```
