...
`print(result)` render. See `moirais.fn.describe('dft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dft import *
import numpy as np
# See the function signature in fn/dft.py for argument names.
```
