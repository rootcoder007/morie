# describe('caustrnsp') — causal_transportability_weights
...
`print(result)` render. See `moirais.fn.describe('caustrnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caustrnsp import *
import numpy as np
# See the function signature in fn/caustrnsp.py for argument names.
```
