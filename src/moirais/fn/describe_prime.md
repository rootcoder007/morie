...
`print(result)` render. See `moirais.fn.describe('prime')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prime import *
import numpy as np
# See the function signature in fn/prime.py for argument names.
```
