...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_37"]


def information_theory_mackay_chapter_6_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =pa +pc = 0.8: (2.82)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u37')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u37: GeneralStatistics expression (auto-extracted; see ref)."
