# describe('grlogg') — geron_logistic_cost_gradient
...
`print(result)` render. See `moirais.fn.describe('grlogg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlogg import *
import numpy as np
# See the function signature in fn/grlogg.py for argument names.
```
