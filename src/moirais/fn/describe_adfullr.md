# describe('adfullr') — adf_unit_root
...
`print(result)` render. See `moirais.fn.describe('adfullr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adfullr import *
import numpy as np
# See the function signature in fn/adfullr.py for argument names.
```
