# describe('hmlaso') — geron_lasso_cost
...
`print(result)` render. See `moirais.fn.describe('hmlaso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlaso import *
import numpy as np
# See the function signature in fn/hmlaso.py for argument names.
```
