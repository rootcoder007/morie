...
__all__ = ["hedderich_chapter_9_unnumbered_2909"]


def hedderich_chapter_9_unnumbered_2909(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + { stop( " Cochran − Armitage nur i n ( 2 , k ) − Tafel " , call. = FALSE ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2909')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2909: GeneralStatistics expression (auto-extracted; see ref)."
