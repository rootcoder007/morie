...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1140"]


def guide_on_data_analysis_chapter_24_unnumbered_1140(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑆𝑆𝑇𝑅 = 𝑆𝑆𝐴 + 𝑆𝑆𝐵 + 𝑆𝑆𝐴𝐵
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1140')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1140: GeneralStatistics expression (auto-extracted; see ref)."
