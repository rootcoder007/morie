...
`print(result)` render. See `moirais.fn.describe('donsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.donsk import *
import numpy as np
# See the function signature in fn/donsk.py for argument names.
```
