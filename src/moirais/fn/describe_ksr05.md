# describe('ksr05') — kosorok_bracketing_number
...
`print(result)` render. See `moirais.fn.describe('ksr05')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr05 import *
import numpy as np
# See the function signature in fn/ksr05.py for argument names.
```
