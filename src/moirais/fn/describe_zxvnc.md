...
`print(result)` render. See `moirais.fn.describe('zxvnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxvnc import *
import numpy as np
# See the function signature in fn/zxvnc.py for argument names.
```
