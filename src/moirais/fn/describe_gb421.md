# describe('gb421') — gibbons_chisq_gof
...
`print(result)` render. See `moirais.fn.describe('gb421')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb421 import *
import numpy as np
# See the function signature in fn/gb421.py for argument names.
```
