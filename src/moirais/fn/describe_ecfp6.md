# describe('ecfp6') — ecfp_6_fingerprint
...
`print(result)` render. See `moirais.fn.describe('ecfp6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecfp6 import *
import numpy as np
# See the function signature in fn/ecfp6.py for argument names.
```
