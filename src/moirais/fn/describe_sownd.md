...
`print(result)` render. See `moirais.fn.describe('sownd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sownd import *
import numpy as np
# See the function signature in fn/sownd.py for argument names.
```
