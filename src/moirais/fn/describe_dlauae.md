...
`print(result)` render. See `moirais.fn.describe('dlauae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlauae import *
import numpy as np
# See the function signature in fn/dlauae.py for argument names.
```
