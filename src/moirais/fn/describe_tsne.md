# describe('tsne') — _pairwise_sq_dist
...
`print(result)` render. See `moirais.fn.describe('tsne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsne import *
import numpy as np
# See the function signature in fn/tsne.py for argument names.
```
