...
`print(result)` render. See `moirais.fn.describe('grdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdst import *
import numpy as np
# See the function signature in fn/grdst.py for argument names.
```
