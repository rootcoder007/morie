...
`print(result)` render. See `moirais.fn.describe('chzrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chzrd import *
import numpy as np
# See the function signature in fn/chzrd.py for argument names.
```
