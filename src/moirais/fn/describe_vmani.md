...
`print(result)` render. See `moirais.fn.describe('vmani')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmani import *
import numpy as np
# See the function signature in fn/vmani.py for argument names.
```
