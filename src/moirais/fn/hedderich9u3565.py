...
__all__ = ["hedderich_chapter_9_unnumbered_3565"]


def hedderich_chapter_9_unnumbered_3565(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] µ=E[T ] = (λ0·exp(X′β))−1 = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3565')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3565: GeneralStatistics expression (auto-extracted; see ref)."
