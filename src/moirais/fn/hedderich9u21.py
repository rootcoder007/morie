...
__all__ = ["hedderich_chapter_9_unnumbered_21"]


def hedderich_chapter_9_unnumbered_21(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (2·4−3)2 + (2·5−3)2 = 4(16 + 25)−2·2·3(4 + 5) + 2·9 25 + 49 = 74 = 164 −108 + 18
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u21')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u21: GeneralStatistics expression (auto-extracted; see ref)."
