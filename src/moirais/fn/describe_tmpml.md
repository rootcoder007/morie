# describe('tmpml') — template_match_lib
...
`print(result)` render. See `moirais.fn.describe('tmpml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmpml import *
import numpy as np
# See the function signature in fn/tmpml.py for argument names.
```
