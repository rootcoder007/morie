...
__all__ = ["hedderich_chapter_9_unnumbered_2806"]


def hedderich_chapter_9_unnumbered_2806(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺0.125,ψ= 16/5 = 3.2 and forα= 0.05,z0.95 = 1.96:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2806')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2806: GeneralStatistics expression (auto-extracted; see ref)."
