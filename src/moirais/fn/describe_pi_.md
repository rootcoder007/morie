# describe('pi_') — nucleotide_diversity
...
`print(result)` render. See `moirais.fn.describe('pi_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pi_ import *
import numpy as np
# See the function signature in fn/pi_.py for argument names.
```
