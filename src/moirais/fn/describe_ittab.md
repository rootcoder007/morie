...
`print(result)` render. See `moirais.fn.describe('ittab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ittab import *
import numpy as np
# See the function signature in fn/ittab.py for argument names.
```
