...
`print(result)` render. See `moirais.fn.describe('cmbfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmbfl import *
import numpy as np
# See the function signature in fn/cmbfl.py for argument names.
```
