...
`print(result)` render. See `moirais.fn.describe('agcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcon import *
import numpy as np
# See the function signature in fn/agcon.py for argument names.
```
