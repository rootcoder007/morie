# describe('kmadap') — kamath_houlsby_adapter
...
`print(result)` render. See `moirais.fn.describe('kmadap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmadap import *
import numpy as np
# See the function signature in fn/kmadap.py for argument names.
```
