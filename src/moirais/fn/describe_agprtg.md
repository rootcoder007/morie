# describe('agprtg') — alphazero_priority_target
...
`print(result)` render. See `moirais.fn.describe('agprtg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agprtg import *
import numpy as np
# See the function signature in fn/agprtg.py for argument names.
```
