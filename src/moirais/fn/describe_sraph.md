# describe('sraph') — validate_inputs
...
`print(result)` render. See `moirais.fn.describe('sraph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sraph import *
import numpy as np
# See the function signature in fn/sraph.py for argument names.
```
