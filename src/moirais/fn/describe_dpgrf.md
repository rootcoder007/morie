# describe('dpgrf') — dp_grouped_random_field
...
`print(result)` render. See `moirais.fn.describe('dpgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgrf import *
import numpy as np
# See the function signature in fn/dpgrf.py for argument names.
```
