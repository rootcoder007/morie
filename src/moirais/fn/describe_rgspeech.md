# describe('rgspeech') — rangayyan_speech_features
...
`print(result)` render. See `moirais.fn.describe('rgspeech')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgspeech import *
import numpy as np
# See the function signature in fn/rgspeech.py for argument names.
```
