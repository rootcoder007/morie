# describe('bplag') — breusch_pagan_lm
...
`print(result)` render. See `moirais.fn.describe('bplag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bplag import *
import numpy as np
# See the function signature in fn/bplag.py for argument names.
```
