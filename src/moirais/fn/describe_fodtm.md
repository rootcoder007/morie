...
`print(result)` render. See `moirais.fn.describe('fodtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fodtm import *
import numpy as np
# See the function signature in fn/fodtm.py for argument names.
```
