...
`print(result)` render. See `moirais.fn.describe('hmseq2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmseq2 import *
import numpy as np
# See the function signature in fn/hmseq2.py for argument names.
```
