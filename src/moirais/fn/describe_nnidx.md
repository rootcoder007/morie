# describe('nnidx') — nearest_neighbor_index
...
`print(result)` render. See `moirais.fn.describe('nnidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnidx import *
import numpy as np
# See the function signature in fn/nnidx.py for argument names.
```
