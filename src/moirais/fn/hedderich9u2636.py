...
__all__ = ["hedderich_chapter_9_unnumbered_2636"]


def hedderich_chapter_9_unnumbered_2636(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Since ˆχ2 = 4.796 > 2.706 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2636')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2636: GeneralStatistics expression (auto-extracted; see ref)."
