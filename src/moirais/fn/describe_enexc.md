...
`print(result)` render. See `moirais.fn.describe('enexc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enexc import *
import numpy as np
# See the function signature in fn/enexc.py for argument names.
```
