...
__all__ = ["hedderich_chapter_9_unnumbered_1829"]


def hedderich_chapter_9_unnumbered_1829(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: effectδ= 15/30 = 0.5 at the 5% significance level
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1829')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1829: PowerAndDesign expression (auto-extracted; see ref)."
