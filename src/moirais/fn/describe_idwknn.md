...
`print(result)` render. See `moirais.fn.describe('idwknn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwknn import *
import numpy as np
# See the function signature in fn/idwknn.py for argument names.
```
