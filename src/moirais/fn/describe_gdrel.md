...
`print(result)` render. See `moirais.fn.describe('gdrel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdrel import *
import numpy as np
# See the function signature in fn/gdrel.py for argument names.
```
