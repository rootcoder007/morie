...
__all__ = ["hedderich_chapter_9_unnumbered_3032"]


def hedderich_chapter_9_unnumbered_3032(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] A = (465−470)2/(465 + 470−400) = 25/135 = 0.185< 3.841 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3032')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3032: GeneralStatistics expression (auto-extracted; see ref)."
