...
`print(result)` render. See `moirais.fn.describe('wvcol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvcol import *
import numpy as np
# See the function signature in fn/wvcol.py for argument names.
```
