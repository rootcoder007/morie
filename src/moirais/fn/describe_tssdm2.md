...
`print(result)` render. See `moirais.fn.describe('tssdm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssdm2 import *
import numpy as np
# See the function signature in fn/tssdm2.py for argument names.
```
