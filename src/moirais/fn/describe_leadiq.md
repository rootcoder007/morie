...
`print(result)` render. See `moirais.fn.describe('leadiq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.leadiq import *
import numpy as np
# See the function signature in fn/leadiq.py for argument names.
```
