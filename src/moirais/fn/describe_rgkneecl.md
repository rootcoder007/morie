# describe('rgkneecl') — rangayyan_knee_classify
...
`print(result)` render. See `moirais.fn.describe('rgkneecl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkneecl import *
import numpy as np
# See the function signature in fn/rgkneecl.py for argument names.
```
