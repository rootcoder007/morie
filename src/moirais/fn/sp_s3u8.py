...
__all__ = ["stochastic_physics_section_3_unnumbered_8"]


def stochastic_physics_section_3_unnumbered_8(x):
    """
    GeneralStochastic expression (auto-extracted; see reference).

    Formula: the criminal becomes 1−θ, where θ determines the severity
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('sp_s3u8')`` for the full guide.
...
def cheatsheet():
    return "sp_s3u8: GeneralStochastic expression (auto-extracted; see reference)."
