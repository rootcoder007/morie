# describe('causmnde') — causal_natural_decomposition
...
`print(result)` render. See `moirais.fn.describe('causmnde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmnde import *
import numpy as np
# See the function signature in fn/causmnde.py for argument names.
```
