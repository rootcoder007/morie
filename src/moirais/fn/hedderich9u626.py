...
__all__ = ["hedderich_chapter_9_unnumbered_626"]


def hedderich_chapter_9_unnumbered_626(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X =x + 1) = n−x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u626')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u626: CountModels expression (auto-extracted; see ref)."
