...
`print(result)` render. See `moirais.fn.describe('gpmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpmlt import *
import numpy as np
# See the function signature in fn/gpmlt.py for argument names.
```
