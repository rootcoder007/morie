# describe('spssoc') — schabenberger_stationary_cov_semivario
...
`print(result)` render. See `moirais.fn.describe('spssoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spssoc import *
import numpy as np
# See the function signature in fn/spssoc.py for argument names.
```
