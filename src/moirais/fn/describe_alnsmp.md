# describe('alnsmp') — alammar_negative_sampling_skipgram
...
`print(result)` render. See `moirais.fn.describe('alnsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alnsmp import *
import numpy as np
# See the function signature in fn/alnsmp.py for argument names.
```
