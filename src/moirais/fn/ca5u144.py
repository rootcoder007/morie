...
__all__ = ["ca_chapter_5_unnumbered_144"]


def ca_chapter_5_unnumbered_144(x):
    """
    Logistic expression involving 'logit' (auto-extracted; see reference for full context).

    Formula: logit y = 3jx() = ln Py = 3jx()
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u144')`` for the full guide.
...
def cheatsheet():
    return "ca5u144: Logistic expression involving 'logit' (auto-extracted; see reference for full context)."
