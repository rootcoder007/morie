...
`print(result)` render. See `moirais.fn.describe('wqno3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqno3 import *
import numpy as np
# See the function signature in fn/wqno3.py for argument names.
```
