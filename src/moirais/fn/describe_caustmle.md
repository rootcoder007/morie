# describe('caustmle') — causal_tmle_targeted
...
`print(result)` render. See `moirais.fn.describe('caustmle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caustmle import *
import numpy as np
# See the function signature in fn/caustmle.py for argument names.
```
