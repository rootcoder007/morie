...
`print(result)` render. See `moirais.fn.describe('dtbur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbur import *
import numpy as np
# See the function signature in fn/dtbur.py for argument names.
```
