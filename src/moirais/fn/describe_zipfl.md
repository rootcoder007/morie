...
`print(result)` render. See `moirais.fn.describe('zipfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zipfl import *
import numpy as np
# See the function signature in fn/zipfl.py for argument names.
```
