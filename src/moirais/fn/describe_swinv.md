...
`print(result)` render. See `moirais.fn.describe('swinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swinv import *
import numpy as np
# See the function signature in fn/swinv.py for argument names.
```
