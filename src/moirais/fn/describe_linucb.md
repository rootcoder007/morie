...
`print(result)` render. See `moirais.fn.describe('linucb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linucb import *
import numpy as np
# See the function signature in fn/linucb.py for argument names.
```
