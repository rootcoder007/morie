...
`print(result)` render. See `moirais.fn.describe('savgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.savgf import *
import numpy as np
# See the function signature in fn/savgf.py for argument names.
```
