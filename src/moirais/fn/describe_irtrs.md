...
`print(result)` render. See `moirais.fn.describe('irtrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtrs import *
import numpy as np
# See the function signature in fn/irtrs.py for argument names.
```
