...
`print(result)` render. See `moirais.fn.describe('zxmrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxmrc import *
import numpy as np
# See the function signature in fn/zxmrc.py for argument names.
```
