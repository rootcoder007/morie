...
`print(result)` render. See `moirais.fn.describe('cdqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdqnt import *
import numpy as np
# See the function signature in fn/cdqnt.py for argument names.
```
