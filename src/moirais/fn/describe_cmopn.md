...
`print(result)` render. See `moirais.fn.describe('cmopn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmopn import *
import numpy as np
# See the function signature in fn/cmopn.py for argument names.
```
