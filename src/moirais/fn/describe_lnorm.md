# describe('lnorm') — lnorm

## WHAT IT DOES

rLayer normalization.
...
`print(result)` render. See `moirais.fn.describe('lnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lnorm import *
import numpy as np
# See the function signature in fn/lnorm.py for argument names.
```
