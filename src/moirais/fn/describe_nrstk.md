...
`print(result)` render. See `moirais.fn.describe('nrstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrstk import *
import numpy as np
# See the function signature in fn/nrstk.py for argument names.
```
