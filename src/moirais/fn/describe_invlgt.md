...
`print(result)` render. See `moirais.fn.describe('invlgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.invlgt import *
import numpy as np
# See the function signature in fn/invlgt.py for argument names.
```
