# describe('baytsm') — bayes_time_series
...
`print(result)` render. See `moirais.fn.describe('baytsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baytsm import *
import numpy as np
# See the function signature in fn/baytsm.py for argument names.
```
