# describe('jodirc') — joseph_direct_multistep
...
`print(result)` render. See `moirais.fn.describe('jodirc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jodirc import *
import numpy as np
# See the function signature in fn/jodirc.py for argument names.
```
