...
`print(result)` render. See `moirais.fn.describe('maprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maprd import *
import numpy as np
# See the function signature in fn/maprd.py for argument names.
```
