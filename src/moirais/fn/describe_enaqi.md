...
`print(result)` render. See `moirais.fn.describe('enaqi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enaqi import *
import numpy as np
# See the function signature in fn/enaqi.py for argument names.
```
