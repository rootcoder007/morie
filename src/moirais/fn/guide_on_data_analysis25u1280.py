...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1280"]


def guide_on_data_analysis_chapter_25_unnumbered_1280(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: transmute(y1_diff = com_y1 - state_y1,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1280')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1280: GeneralStatistics expression (auto-extracted; see ref)."
