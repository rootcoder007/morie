# describe('rboot') — bootstrap_reliability
...
`print(result)` render. See `moirais.fn.describe('rboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rboot import *
import numpy as np
# See the function signature in fn/rboot.py for argument names.
```
