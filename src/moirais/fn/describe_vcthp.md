# describe('vcthp') — victim_help_seeking
...
`print(result)` render. See `moirais.fn.describe('vcthp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcthp import *
import numpy as np
# See the function signature in fn/vcthp.py for argument names.
```
