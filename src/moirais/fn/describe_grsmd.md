# describe('grsmd') — geron_symbolic_differentiation
...
`print(result)` render. See `moirais.fn.describe('grsmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsmd import *
import numpy as np
# See the function signature in fn/grsmd.py for argument names.
```
