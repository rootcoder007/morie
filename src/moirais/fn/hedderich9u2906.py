...
__all__ = ["hedderich_chapter_9_unnumbered_2906"]


def hedderich_chapter_9_unnumbered_2906(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆz = 1·0.611−1·0.200√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2906')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2906: GeneralStatistics expression (auto-extracted; see ref)."
