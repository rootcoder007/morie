...
`print(result)` render. See `moirais.fn.describe('rfgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfgam import *
import numpy as np
# See the function signature in fn/rfgam.py for argument names.
```
