# describe('otreg') — ot_regularised_dual
...
`print(result)` render. See `moirais.fn.describe('otreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otreg import *
import numpy as np
# See the function signature in fn/otreg.py for argument names.
```
