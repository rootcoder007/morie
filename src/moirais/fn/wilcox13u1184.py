...
__all__ = ["wilcox_chapter_13_unnumbered_1184"]


def wilcox_chapter_13_unnumbered_1184(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and data are generated from the model Y =β 1X1 +β 2X2 +ǫ, where β 1 = 1 and β 2 = 0. The
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1184')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1184: GeneralStatistics expression (auto-extracted; see ref)."
