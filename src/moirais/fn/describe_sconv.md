# describe('sconv') — subscale_convergent
...
`print(result)` render. See `moirais.fn.describe('sconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sconv import *
import numpy as np
# See the function signature in fn/sconv.py for argument names.
```
