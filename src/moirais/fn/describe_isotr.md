# describe('isotr') — isotonic_regression_disparity
...
`print(result)` render. See `moirais.fn.describe('isotr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isotr import *
import numpy as np
# See the function signature in fn/isotr.py for argument names.
```
