...
`print(result)` render. See `moirais.fn.describe('qjlcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qjlcs import *
import numpy as np
# See the function signature in fn/qjlcs.py for argument names.
```
