# describe('groverS') — grover_search
...
`print(result)` render. See `moirais.fn.describe('groverS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groverS import *
import numpy as np
# See the function signature in fn/groverS.py for argument names.
```
