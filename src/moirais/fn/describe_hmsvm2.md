# describe('hmsvm2') — geron_save_load_pytorch
...
`print(result)` render. See `moirais.fn.describe('hmsvm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsvm2 import *
import numpy as np
# See the function signature in fn/hmsvm2.py for argument names.
```
