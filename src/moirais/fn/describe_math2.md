...
`print(result)` render. See `moirais.fn.describe('math2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.math2 import *
import numpy as np
# See the function signature in fn/math2.py for argument names.
```
