# describe('eqdsp') — disparity_decompose
...
`print(result)` render. See `moirais.fn.describe('eqdsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqdsp import *
import numpy as np
# See the function signature in fn/eqdsp.py for argument names.
```
