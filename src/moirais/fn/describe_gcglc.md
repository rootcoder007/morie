...
`print(result)` render. See `moirais.fn.describe('gcglc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcglc import *
import numpy as np
# See the function signature in fn/gcglc.py for argument names.
```
