...
__all__ = ["wilcox_chapter_13_unnumbered_1110"]


def wilcox_chapter_13_unnumbered_1110(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: scale=TRUE, span=0.75, xlab="X", xlab1="X1", xlab2="X2", ylab="p-values",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1110')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1110: GeneralStatistics expression (auto-extracted; see ref)."
