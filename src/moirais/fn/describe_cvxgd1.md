# describe('cvxgd1') — boyd_grad_proj
...
`print(result)` render. See `moirais.fn.describe('cvxgd1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxgd1 import *
import numpy as np
# See the function signature in fn/cvxgd1.py for argument names.
```
