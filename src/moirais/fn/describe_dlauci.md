...
`print(result)` render. See `moirais.fn.describe('dlauci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlauci import *
import numpy as np
# See the function signature in fn/dlauci.py for argument names.
```
