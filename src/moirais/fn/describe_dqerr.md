...
`print(result)` render. See `moirais.fn.describe('dqerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dqerr import *
import numpy as np
# See the function signature in fn/dqerr.py for argument names.
```
