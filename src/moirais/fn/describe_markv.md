...
`print(result)` render. See `moirais.fn.describe('markv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.markv import *
import numpy as np
# See the function signature in fn/markv.py for argument names.
```
