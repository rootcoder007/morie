# describe('colst') — collider_structure
...
`print(result)` render. See `moirais.fn.describe('colst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.colst import *
import numpy as np
# See the function signature in fn/colst.py for argument names.
```
