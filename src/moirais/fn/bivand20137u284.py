...
__all__ = ["bivand2013_chapter_7_unnumbered_284"]


def bivand2013_chapter_7_unnumbered_284(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where aij =e x p{−dij/φ} and dij is the distance between regionsi and j,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u284')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u284: GeneralStatistics expression (auto-extracted; see ref)."
