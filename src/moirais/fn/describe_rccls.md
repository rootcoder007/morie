...
`print(result)` render. See `moirais.fn.describe('rccls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rccls import *
import numpy as np
# See the function signature in fn/rccls.py for argument names.
```
