...
`print(result)` render. See `moirais.fn.describe('dlogi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlogi import *
import numpy as np
# See the function signature in fn/dlogi.py for argument names.
```
