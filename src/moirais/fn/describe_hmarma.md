...
`print(result)` render. See `moirais.fn.describe('hmarma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmarma import *
import numpy as np
# See the function signature in fn/hmarma.py for argument names.
```
