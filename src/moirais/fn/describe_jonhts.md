...
`print(result)` render. See `moirais.fn.describe('jonhts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jonhts import *
import numpy as np
# See the function signature in fn/jonhts.py for argument names.
```
