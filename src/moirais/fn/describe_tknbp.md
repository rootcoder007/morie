...
`print(result)` render. See `moirais.fn.describe('tknbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tknbp import *
import numpy as np
# See the function signature in fn/tknbp.py for argument names.
```
