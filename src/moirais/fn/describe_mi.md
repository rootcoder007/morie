...
`print(result)` render. See `moirais.fn.describe('mi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mi import *
import numpy as np
# See the function signature in fn/mi.py for argument names.
```
