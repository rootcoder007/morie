# describe('rng005') — rangayyan_ch3_kurtosis
...
`print(result)` render. See `moirais.fn.describe('rng005')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng005 import *
import numpy as np
# See the function signature in fn/rng005.py for argument names.
```
