...
`print(result)` render. See `moirais.fn.describe('lmerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmerr import *
import numpy as np
# See the function signature in fn/lmerr.py for argument names.
```
