...
`print(result)` render. See `moirais.fn.describe('profk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.profk import *
import numpy as np
# See the function signature in fn/profk.py for argument names.
```
