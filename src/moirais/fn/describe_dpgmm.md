# describe('dpgmm') — dp_gaussian_mixture
...
`print(result)` render. See `moirais.fn.describe('dpgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgmm import *
import numpy as np
# See the function signature in fn/dpgmm.py for argument names.
```
