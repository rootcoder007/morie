# describe('hmsfts') — geron_softmax_score
...
`print(result)` render. See `moirais.fn.describe('hmsfts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsfts import *
import numpy as np
# See the function signature in fn/hmsfts.py for argument names.
```
