...
`print(result)` render. See `moirais.fn.describe('sinad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sinad import *
import numpy as np
# See the function signature in fn/sinad.py for argument names.
```
