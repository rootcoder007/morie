# describe('rgmuap') — rangayyan_muap
...
`print(result)` render. See `moirais.fn.describe('rgmuap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmuap import *
import numpy as np
# See the function signature in fn/rgmuap.py for argument names.
```
