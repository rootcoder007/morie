# describe('ksr11') — kosorok_efficient_score
...
`print(result)` render. See `moirais.fn.describe('ksr11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr11 import *
import numpy as np
# See the function signature in fn/ksr11.py for argument names.
```
