...
__all__ = ["wilcox_chapter_12_unnumbered_1385"]


def wilcox_chapter_12_unnumbered_1385(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆν = 37.7, c = 2.96, reject. (d) (20 − 12)/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1385')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1385: GeneralStatistics expression (auto-extracted; see ref)."
