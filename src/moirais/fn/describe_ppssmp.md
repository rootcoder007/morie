# describe('ppssmp') — cheatsheet

## WHAT IT DOES

Probability-proportional-to-size (PPS) sampling. 'Character is destiny. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('ppssmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppssmp import *
import numpy as np
# See the function signature in fn/ppssmp.py for argument names.
```
