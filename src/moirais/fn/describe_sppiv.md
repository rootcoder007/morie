...
`print(result)` render. See `moirais.fn.describe('sppiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppiv import *
import numpy as np
# See the function signature in fn/sppiv.py for argument names.
```
