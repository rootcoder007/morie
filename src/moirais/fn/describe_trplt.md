# describe('trplt') — trace_plot_data
...
`print(result)` render. See `moirais.fn.describe('trplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trplt import *
import numpy as np
# See the function signature in fn/trplt.py for argument names.
```
