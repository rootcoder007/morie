...
`print(result)` render. See `moirais.fn.describe('anmls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anmls import *
import numpy as np
# See the function signature in fn/anmls.py for argument names.
```
