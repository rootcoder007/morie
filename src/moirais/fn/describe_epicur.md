...
`print(result)` render. See `moirais.fn.describe('epicur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epicur import *
import numpy as np
# See the function signature in fn/epicur.py for argument names.
```
