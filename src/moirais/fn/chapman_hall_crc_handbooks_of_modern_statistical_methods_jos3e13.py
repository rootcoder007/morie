...
def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_3_equation_13(x, cdf=None):
    """
    Regression equation extracted from [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference.

    Formula: E [Yi|Zi, xi] = β0 + γ0Zi + Σβpxpi + ΣγpZiXpi, (3.13)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos3e13')`` for the full guide.

    References
    ----------
    [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference, ch.3 eq.3.13
    """
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos3e13: Regression equation extracted from [Chapman & Hall CRC Handbooks of Modern Statistical Methods] José R. Zubizarreta, Elizabeth A. Stuart, Dylan S. Small, Paul R - Handbook of Matching and Weighting Adjustments for Causal Inference."
