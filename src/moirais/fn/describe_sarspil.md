...
`print(result)` render. See `moirais.fn.describe('sarspil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarspil import *
import numpy as np
# See the function signature in fn/sarspil.py for argument names.
```
