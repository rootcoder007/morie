...
`print(result)` render. See `moirais.fn.describe('dijks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dijks import *
import numpy as np
# See the function signature in fn/dijks.py for argument names.
```
