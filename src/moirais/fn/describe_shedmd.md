# describe('shedmd') — viral_shedding_model
...
`print(result)` render. See `moirais.fn.describe('shedmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shedmd import *
import numpy as np
# See the function signature in fn/shedmd.py for argument names.
```
