# describe('msm014') — mvsml_linear_mixed_models_eq_5_1
...
`print(result)` render. See `moirais.fn.describe('msm014')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm014 import *
import numpy as np
# See the function signature in fn/msm014.py for argument names.
```
