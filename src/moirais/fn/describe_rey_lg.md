# describe('rey_lg') — logistic_regression

## WHAT IT DOES

Logistic regression via IRLS. 'Character is destiny. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('rey_lg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_lg import *
import numpy as np
# See the function signature in fn/rey_lg.py for argument names.
```
