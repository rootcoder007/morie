# describe('mamh') — ma_mantel_haenszel
...
`print(result)` render. See `moirais.fn.describe('mamh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mamh import *
import numpy as np
# See the function signature in fn/mamh.py for argument names.
```
