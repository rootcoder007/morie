...
`print(result)` render. See `moirais.fn.describe('carsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carsim import *
import numpy as np
# See the function signature in fn/carsim.py for argument names.
```
