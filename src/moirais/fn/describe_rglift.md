# describe('rglift') — rangayyan_liftering
...
`print(result)` render. See `moirais.fn.describe('rglift')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglift import *
import numpy as np
# See the function signature in fn/rglift.py for argument names.
```
