...
__all__ = ["hedderich_chapter_9_unnumbered_1716"]


def hedderich_chapter_9_unnumbered_1716(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (−0.5)(−2.996)=1.224).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1716')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1716: PowerAndDesign expression (auto-extracted; see ref)."
