...
`print(result)` render. See `moirais.fn.describe('encrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.encrl import *
import numpy as np
# See the function signature in fn/encrl.py for argument names.
```
