# describe('gbacon') — goodman_bacon_decomp
...
`print(result)` render. See `moirais.fn.describe('gbacon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbacon import *
import numpy as np
# See the function signature in fn/gbacon.py for argument names.
```
