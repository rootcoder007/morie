...
__all__ = ["hedderich_chapter_9_unnumbered_3095"]


def hedderich_chapter_9_unnumbered_3095(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (II) H0:ϱ≤0 [againstHA:ϱ>0]: ˆt≥tn−2;1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3095')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3095: PowerAndDesign expression (auto-extracted; see ref)."
