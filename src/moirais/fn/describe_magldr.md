...
`print(result)` render. See `moirais.fn.describe('magldr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magldr import *
import numpy as np
# See the function signature in fn/magldr.py for argument names.
```
