...
`print(result)` render. See `moirais.fn.describe('stkey')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkey import *
import numpy as np
# See the function signature in fn/stkey.py for argument names.
```
