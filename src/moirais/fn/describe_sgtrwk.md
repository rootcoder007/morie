# describe('sgtrwk') — sgt_random_walk_kernel
...
`print(result)` render. See `moirais.fn.describe('sgtrwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtrwk import *
import numpy as np
# See the function signature in fn/sgtrwk.py for argument names.
```
