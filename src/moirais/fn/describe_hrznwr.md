# describe('hrznwr') — horowitz_nw_regression
...
`print(result)` render. See `moirais.fn.describe('hrznwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznwr import *
import numpy as np
# See the function signature in fn/hrznwr.py for argument names.
```
