...
`print(result)` render. See `moirais.fn.describe('opall')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opall import *
import numpy as np
# See the function signature in fn/opall.py for argument names.
```
