# describe('alfipa') — alphafold_invariant_point
...
`print(result)` render. See `moirais.fn.describe('alfipa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfipa import *
import numpy as np
# See the function signature in fn/alfipa.py for argument names.
```
