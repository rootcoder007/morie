# describe('sgmplt') — plot_spectrogram_fn
...
`print(result)` render. See `moirais.fn.describe('sgmplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmplt import *
import numpy as np
# See the function signature in fn/sgmplt.py for argument names.
```
