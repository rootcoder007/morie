...
`print(result)` render. See `moirais.fn.describe('eps2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eps2 import *
import numpy as np
# See the function signature in fn/eps2.py for argument names.
```
