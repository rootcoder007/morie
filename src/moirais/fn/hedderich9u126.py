...
__all__ = ["hedderich_chapter_9_unnumbered_126"]


def hedderich_chapter_9_unnumbered_126(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺k = 2 people is 15: 1 (two women) + 8 (one man and one woman) + 6 (two men).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u126')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u126: GeneralStatistics expression (auto-extracted; see ref)."
