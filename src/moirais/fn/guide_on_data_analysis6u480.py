...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_480"]


def guide_on_data_analysis_chapter_6_unnumbered_480(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] B(𝑗+1)= B(𝑗)+ (Δ𝜃(𝑗)− B(𝑗)Δ𝐹(𝑗))(Δ𝜃(𝑗))′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u480')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u480: GeneralStatistics expression (auto-extracted; see ref)."
