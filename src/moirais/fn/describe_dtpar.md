...
`print(result)` render. See `moirais.fn.describe('dtpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtpar import *
import numpy as np
# See the function signature in fn/dtpar.py for argument names.
```
