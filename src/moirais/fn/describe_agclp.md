...
`print(result)` render. See `moirais.fn.describe('agclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agclp import *
import numpy as np
# See the function signature in fn/agclp.py for argument names.
```
