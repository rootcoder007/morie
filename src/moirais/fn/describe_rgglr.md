# describe('rgglr') — rangayyan_gen_likelihood_ratio
...
`print(result)` render. See `moirais.fn.describe('rgglr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgglr import *
import numpy as np
# See the function signature in fn/rgglr.py for argument names.
```
