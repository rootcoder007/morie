...
__all__ = ["hedderich_chapter_9_unnumbered_2288"]


def hedderich_chapter_9_unnumbered_2288(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: F1;m+n−2;α;N C with NC = mn
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2288')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2288: GeneralStatistics expression (auto-extracted; see ref)."
