# describe('simps') — simpson_integrate
...
`print(result)` render. See `moirais.fn.describe('simps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simps import *
import numpy as np
# See the function signature in fn/simps.py for argument names.
```
