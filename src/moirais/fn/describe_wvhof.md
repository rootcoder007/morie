...
`print(result)` render. See `moirais.fn.describe('wvhof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvhof import *
import numpy as np
# See the function signature in fn/wvhof.py for argument names.
```
