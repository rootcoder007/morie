...
`print(result)` render. See `moirais.fn.describe('ghcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcar import *
import numpy as np
# See the function signature in fn/ghcar.py for argument names.
```
