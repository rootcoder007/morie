...
__all__ = ["hedderich_chapter_9_unnumbered_501"]


def hedderich_chapter_9_unnumbered_501(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > pfn ( n= c ( 1 0 0 0 , 5 0 0 0 ) , prev = 0 . 0 1 , sens = 0 . 9 5 , spec = 0 . 9 0 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u501')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u501: GeneralStatistics expression (auto-extracted; see ref)."
