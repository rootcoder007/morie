# describe('rgppgwt') — rangayyan_ppg_wavelet
...
`print(result)` render. See `moirais.fn.describe('rgppgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgppgwt import *
import numpy as np
# See the function signature in fn/rgppgwt.py for argument names.
```
