...
`print(result)` render. See `moirais.fn.describe('gdlfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdlfe import *
import numpy as np
# See the function signature in fn/gdlfe.py for argument names.
```
