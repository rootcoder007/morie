# describe('joqr') — joseph_quantile_regression
...
`print(result)` render. See `moirais.fn.describe('joqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joqr import *
import numpy as np
# See the function signature in fn/joqr.py for argument names.
```
