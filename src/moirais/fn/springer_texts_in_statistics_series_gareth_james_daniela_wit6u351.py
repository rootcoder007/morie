...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_351"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_351(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > abline(h=139, col="red")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u351')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u351: GeneralStatistics expression (auto-extracted; see ref)."
