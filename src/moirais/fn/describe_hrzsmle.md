# describe('hrzsmle') — horowitz_semipar_mle_binary
...
`print(result)` render. See `moirais.fn.describe('hrzsmle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsmle import *
import numpy as np
# See the function signature in fn/hrzsmle.py for argument names.
```
