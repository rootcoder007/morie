...
`print(result)` render. See `moirais.fn.describe('dtree')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtree import *
import numpy as np
# See the function signature in fn/dtree.py for argument names.
```
