# describe('btjkab') — boot_jackknife_after_boot
...
`print(result)` render. See `moirais.fn.describe('btjkab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btjkab import *
import numpy as np
# See the function signature in fn/btjkab.py for argument names.
```
