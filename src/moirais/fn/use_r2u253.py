...
__all__ = ["use_r_chapter_2_unnumbered_253"]


def use_r_chapter_2_unnumbered_253(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u253')`` for the full guide.
...
def cheatsheet():
    return "use_r2u253: ContingencyTables expression (auto-extracted; see ref)."
