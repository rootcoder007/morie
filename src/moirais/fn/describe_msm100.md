# describe('msm100') — mvsml_bayesian_regression_pt2_eq_7_4
...
`print(result)` render. See `moirais.fn.describe('msm100')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm100 import *
import numpy as np
# See the function signature in fn/msm100.py for argument names.
```
