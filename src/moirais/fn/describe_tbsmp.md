...
`print(result)` render. See `moirais.fn.describe('tbsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbsmp import *
import numpy as np
# See the function signature in fn/tbsmp.py for argument names.
```
