...
`print(result)` render. See `moirais.fn.describe('wlgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlgam import *
import numpy as np
# See the function signature in fn/wlgam.py for argument names.
```
