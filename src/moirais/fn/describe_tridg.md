...
`print(result)` render. See `moirais.fn.describe('tridg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tridg import *
import numpy as np
# See the function signature in fn/tridg.py for argument names.
```
