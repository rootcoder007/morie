...
`print(result)` render. See `moirais.fn.describe('elimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elimp import *
import numpy as np
# See the function signature in fn/elimp.py for argument names.
```
