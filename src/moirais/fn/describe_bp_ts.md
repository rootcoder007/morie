...
`print(result)` render. See `moirais.fn.describe('bp_ts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bp_ts import *
import numpy as np
# See the function signature in fn/bp_ts.py for argument names.
```
