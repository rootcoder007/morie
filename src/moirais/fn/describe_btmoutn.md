# describe('btmoutn') — boot_m_out_of_n
...
`print(result)` render. See `moirais.fn.describe('btmoutn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btmoutn import *
import numpy as np
# See the function signature in fn/btmoutn.py for argument names.
```
