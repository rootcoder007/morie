...
`print(result)` render. See `moirais.fn.describe('mldsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mldsv import *
import numpy as np
# See the function signature in fn/mldsv.py for argument names.
```
