...
`print(result)` render. See `moirais.fn.describe('dtbng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbng import *
import numpy as np
# See the function signature in fn/dtbng.py for argument names.
```
