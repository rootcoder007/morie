...
__all__ = ["guide_on_data_analysis_chapter_10_unnumbered_711"]


def guide_on_data_analysis_chapter_10_unnumbered_711(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑖=1(𝑥𝑖 − 𝑥) 𝑦𝑖 𝐾(𝑥𝑖−𝑥
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis10u711')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis10u711: GeneralStatistics expression (auto-extracted; see ref)."
