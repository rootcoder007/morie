...
`print(result)` render. See `moirais.fn.describe('wldst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wldst import *
import numpy as np
# See the function signature in fn/wldst.py for argument names.
```
