...
`print(result)` render. See `moirais.fn.describe('mafeo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafeo import *
import numpy as np
# See the function signature in fn/mafeo.py for argument names.
```
