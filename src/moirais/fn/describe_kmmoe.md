# describe('kmmoe') — kamath_moe_router_softmax
...
`print(result)` render. See `moirais.fn.describe('kmmoe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmmoe import *
import numpy as np
# See the function signature in fn/kmmoe.py for argument names.
```
