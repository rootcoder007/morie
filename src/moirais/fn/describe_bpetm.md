# describe('bpetm') — bpe_train_merges
...
`print(result)` render. See `moirais.fn.describe('bpetm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpetm import *
import numpy as np
# See the function signature in fn/bpetm.py for argument names.
```
