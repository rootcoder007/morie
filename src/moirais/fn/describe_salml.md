...
`print(result)` render. See `moirais.fn.describe('salml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.salml import *
import numpy as np
# See the function signature in fn/salml.py for argument names.
```
