...
__all__ = ["hedderich_chapter_9_unnumbered_2467"]


def hedderich_chapter_9_unnumbered_2467(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |¯Ri−¯Ri′|≥z1−α/k(k−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2467')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2467: GeneralStatistics expression (auto-extracted; see ref)."
