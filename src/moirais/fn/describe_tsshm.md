...
`print(result)` render. See `moirais.fn.describe('tsshm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsshm import *
import numpy as np
# See the function signature in fn/tsshm.py for argument names.
```
