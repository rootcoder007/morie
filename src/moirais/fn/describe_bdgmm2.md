...
`print(result)` render. See `moirais.fn.describe('bdgmm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdgmm2 import *
import numpy as np
# See the function signature in fn/bdgmm2.py for argument names.
```
