# describe('ufr2') — unfolding_r_squared
...
`print(result)` render. See `moirais.fn.describe('ufr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ufr2 import *
import numpy as np
# See the function signature in fn/ufr2.py for argument names.
```
