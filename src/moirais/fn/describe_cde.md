# describe('cde') — controlled_direct_effect
...
`print(result)` render. See `moirais.fn.describe('cde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cde import *
import numpy as np
# See the function signature in fn/cde.py for argument names.
```
