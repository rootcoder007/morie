...
__all__ = ["hedderich_chapter_9_unnumbered_118"]


def hedderich_chapter_9_unnumbered_118(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: function of type (2.60) for the valuesN0 = 10,Nmax = 90 andλ0 =−0.2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u118')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u118: GeneralStatistics expression (auto-extracted; see ref)."
