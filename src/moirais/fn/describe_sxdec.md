...
`print(result)` render. See `moirais.fn.describe('sxdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sxdec import *
import numpy as np
# See the function signature in fn/sxdec.py for argument names.
```
