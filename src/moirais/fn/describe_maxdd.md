...
`print(result)` render. See `moirais.fn.describe('maxdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maxdd import *
import numpy as np
# See the function signature in fn/maxdd.py for argument names.
```
