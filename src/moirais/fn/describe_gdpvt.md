...
`print(result)` render. See `moirais.fn.describe('gdpvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdpvt import *
import numpy as np
# See the function signature in fn/gdpvt.py for argument names.
```
