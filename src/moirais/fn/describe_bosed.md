...
`print(result)` render. See `moirais.fn.describe('bosed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bosed import *
import numpy as np
# See the function signature in fn/bosed.py for argument names.
```
