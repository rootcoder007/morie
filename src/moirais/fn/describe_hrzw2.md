# describe('hrzw2') — horowitz_bandwidth_bootstrap
...
`print(result)` render. See `moirais.fn.describe('hrzw2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzw2 import *
import numpy as np
# See the function signature in fn/hrzw2.py for argument names.
```
