# describe('wsdt2d') — wasserstein_p_d
...
`print(result)` render. See `moirais.fn.describe('wsdt2d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsdt2d import *
import numpy as np
# See the function signature in fn/wsdt2d.py for argument names.
```
