...
`print(result)` render. See `moirais.fn.describe('hsmpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsmpt import *
import numpy as np
# See the function signature in fn/hsmpt.py for argument names.
```
