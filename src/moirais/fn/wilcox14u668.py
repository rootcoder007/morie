...
__all__ = ["wilcox_chapter_14_unnumbered_668"]


def wilcox_chapter_14_unnumbered_668(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] MSBG = 86.67/(3 − 1) = 43.335,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u668')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u668: GeneralStatistics expression (auto-extracted; see ref)."
