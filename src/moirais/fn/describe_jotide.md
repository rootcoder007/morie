# describe('jotide') — joseph_tide_encoder
...
`print(result)` render. See `moirais.fn.describe('jotide')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jotide import *
import numpy as np
# See the function signature in fn/jotide.py for argument names.
```
