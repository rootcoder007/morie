...
`print(result)` render. See `moirais.fn.describe('swlagf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swlagf import *
import numpy as np
# See the function signature in fn/swlagf.py for argument names.
```
