# describe('rgbci') — rangayyan_bci_nmf
...
`print(result)` render. See `moirais.fn.describe('rgbci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbci import *
import numpy as np
# See the function signature in fn/rgbci.py for argument names.
```
