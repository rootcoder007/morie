# describe('rgpark') — rangayyan_parkinson_multimodal
...
`print(result)` render. See `moirais.fn.describe('rgpark')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpark import *
import numpy as np
# See the function signature in fn/rgpark.py for argument names.
```
