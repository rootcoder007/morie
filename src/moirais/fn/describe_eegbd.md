# describe('eegbd') — plot_eeg_bands_fn
...
`print(result)` render. See `moirais.fn.describe('eegbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eegbd import *
import numpy as np
# See the function signature in fn/eegbd.py for argument names.
```
