# describe('aitdst') — aitchison_distance
...
`print(result)` render. See `moirais.fn.describe('aitdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdst import *
import numpy as np
# See the function signature in fn/aitdst.py for argument names.
```
