# describe('tmlnie') — tmle_natural_indirect
...
`print(result)` render. See `moirais.fn.describe('tmlnie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnie import *
import numpy as np
# See the function signature in fn/tmlnie.py for argument names.
```
