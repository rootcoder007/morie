...
`print(result)` render. See `moirais.fn.describe('lpflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpflt import *
import numpy as np
# See the function signature in fn/lpflt.py for argument names.
```
