...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1373"]


def guide_on_data_analysis_chapter_27_unnumbered_1373(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖 = 𝛽0 + 𝛽1𝑋𝑖 + 𝛽2𝑊𝑖 + 𝑢𝑖
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1373')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1373: GeneralStatistics expression (auto-extracted; see ref)."
