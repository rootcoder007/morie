...
`print(result)` render. See `moirais.fn.describe('mgwraic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwraic import *
import numpy as np
# See the function signature in fn/mgwraic.py for argument names.
```
