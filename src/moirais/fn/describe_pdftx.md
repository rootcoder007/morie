...
`print(result)` render. See `moirais.fn.describe('pdftx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdftx import *
import numpy as np
# See the function signature in fn/pdftx.py for argument names.
```
