# describe('co2eqv') — co2_equivalent
...
`print(result)` render. See `moirais.fn.describe('co2eqv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.co2eqv import *
import numpy as np
# See the function signature in fn/co2eqv.py for argument names.
```
