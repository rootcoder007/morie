# describe('wsmsmp') — wasserman_smoothing_spline
...
`print(result)` render. See `moirais.fn.describe('wsmsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmsmp import *
import numpy as np
# See the function signature in fn/wsmsmp.py for argument names.
```
