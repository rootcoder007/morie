# describe('cvxcen') — boyd_central_path
...
`print(result)` render. See `moirais.fn.describe('cvxcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxcen import *
import numpy as np
# See the function signature in fn/cvxcen.py for argument names.
```
