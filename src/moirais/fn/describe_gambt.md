# describe('gambt') — card_probability
...
`print(result)` render. See `moirais.fn.describe('gambt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gambt import *
import numpy as np
# See the function signature in fn/gambt.py for argument names.
```
