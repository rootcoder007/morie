...
`print(result)` render. See `moirais.fn.describe('delaun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.delaun import *
import numpy as np
# See the function signature in fn/delaun.py for argument names.
```
