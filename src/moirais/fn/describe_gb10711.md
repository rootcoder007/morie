# describe('gb10711') — gibbons_ctrl_normal_asymp
...
`print(result)` render. See `moirais.fn.describe('gb10711')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb10711 import *
import numpy as np
# See the function signature in fn/gb10711.py for argument names.
```
