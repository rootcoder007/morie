...
`print(result)` render. See `moirais.fn.describe('cstpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstpp import *
import numpy as np
# See the function signature in fn/cstpp.py for argument names.
```
