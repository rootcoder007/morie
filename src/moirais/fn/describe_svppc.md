...
`print(result)` render. See `moirais.fn.describe('svppc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svppc import *
import numpy as np
# See the function signature in fn/svppc.py for argument names.
```
