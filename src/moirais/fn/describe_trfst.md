...
`print(result)` render. See `moirais.fn.describe('trfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trfst import *
import numpy as np
# See the function signature in fn/trfst.py for argument names.
```
