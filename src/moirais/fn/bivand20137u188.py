...
__all__ = ["bivand2013_chapter_7_unnumbered_188"]


def bivand2013_chapter_7_unnumbered_188(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, listw = NYlistw)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u188')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u188: GeneralStatistics expression (auto-extracted; see ref)."
