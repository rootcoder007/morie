...
__all__ = ["hedderich_chapter_9_unnumbered_701"]


def hedderich_chapter_9_unnumbered_701(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X =x + 1) = λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u701')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u701: GeneralStatistics expression (auto-extracted; see ref)."
