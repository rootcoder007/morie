...
`print(result)` render. See `moirais.fn.describe('btwns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btwns import *
import numpy as np
# See the function signature in fn/btwns.py for argument names.
```
