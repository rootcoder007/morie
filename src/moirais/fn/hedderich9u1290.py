...
__all__ = ["hedderich_chapter_9_unnumbered_1290"]


def hedderich_chapter_9_unnumbered_1290(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (λ−≤λ≤λ+)≥1−α with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1290')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1290: GeneralStatistics expression (auto-extracted; see ref)."
