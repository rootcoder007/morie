# describe('agwgcl') — alphazero_weight_clipping
...
`print(result)` render. See `moirais.fn.describe('agwgcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agwgcl import *
import numpy as np
# See the function signature in fn/agwgcl.py for argument names.
```
