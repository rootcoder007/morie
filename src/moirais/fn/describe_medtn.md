# describe('medtn') — causal_mediation
...
`print(result)` render. See `moirais.fn.describe('medtn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medtn import *
import numpy as np
# See the function signature in fn/medtn.py for argument names.
```
