# describe('hmtpp') — geron_tensor_parallelism
...
`print(result)` render. See `moirais.fn.describe('hmtpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtpp import *
import numpy as np
# See the function signature in fn/hmtpp.py for argument names.
```
