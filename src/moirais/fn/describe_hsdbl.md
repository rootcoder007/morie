...
`print(result)` render. See `moirais.fn.describe('hsdbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsdbl import *
import numpy as np
# See the function signature in fn/hsdbl.py for argument names.
```
