...
__all__ = ["wilcox_chapter_13_unnumbered_1154"]


def wilcox_chapter_13_unnumbered_1154(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: shows the plot when the model Y =X1 +X2 +e is fit to the data and the goal is to check
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1154')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1154: GeneralStatistics expression (auto-extracted; see ref)."
