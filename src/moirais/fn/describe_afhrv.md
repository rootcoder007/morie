...
`print(result)` render. See `moirais.fn.describe('afhrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afhrv import *
import numpy as np
# See the function signature in fn/afhrv.py for argument names.
```
