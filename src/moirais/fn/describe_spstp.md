# describe('spstp') — schabenberger_st_point_process
...
`print(result)` render. See `moirais.fn.describe('spstp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spstp import *
import numpy as np
# See the function signature in fn/spstp.py for argument names.
```
