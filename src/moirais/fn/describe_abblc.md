...
`print(result)` render. See `moirais.fn.describe('abblc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abblc import *
import numpy as np
# See the function signature in fn/abblc.py for argument names.
```
