...
def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_9_unnumbered_278(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_9u278')`` for the full guide.
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_9u278: Association expression (auto-extracted; see ref)."
