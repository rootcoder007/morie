# describe('volbekk') — vol_bekk_garch
...
`print(result)` render. See `moirais.fn.describe('volbekk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volbekk import *
import numpy as np
# See the function signature in fn/volbekk.py for argument names.
```
