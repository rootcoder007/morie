...
`print(result)` render. See `moirais.fn.describe('rcsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcsim import *
import numpy as np
# See the function signature in fn/rcsim.py for argument names.
```
