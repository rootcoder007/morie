...
`print(result)` render. See `moirais.fn.describe('sofcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sofcl import *
import numpy as np
# See the function signature in fn/sofcl.py for argument names.
```
