...
`print(result)` render. See `moirais.fn.describe('servR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.servR import *
import numpy as np
# See the function signature in fn/servR.py for argument names.
```
