# describe('bayesm') — dp_bayesian_mechanism
...
`print(result)` render. See `moirais.fn.describe('bayesm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayesm import *
import numpy as np
# See the function signature in fn/bayesm.py for argument names.
```
