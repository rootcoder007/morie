...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1651"]


def guide_on_data_analysis_chapter_30_unnumbered_1651(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] mutate(min_y = min(y[y > 0])) |>
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1651')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1651: GeneralStatistics expression (auto-extracted; see ref)."
