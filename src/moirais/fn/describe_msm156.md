# describe('msm156') — mvsml_categorical_count_eq_8_12
...
`print(result)` render. See `moirais.fn.describe('msm156')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm156 import *
import numpy as np
# See the function signature in fn/msm156.py for argument names.
```
