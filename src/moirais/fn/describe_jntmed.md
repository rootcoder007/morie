# describe('jntmed') — joint_significance_test
...
`print(result)` render. See `moirais.fn.describe('jntmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntmed import *
import numpy as np
# See the function signature in fn/jntmed.py for argument names.
```
