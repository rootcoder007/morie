...
`print(result)` render. See `moirais.fn.describe('ssefn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssefn import *
import numpy as np
# See the function signature in fn/ssefn.py for argument names.
```
