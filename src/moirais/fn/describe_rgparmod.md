# describe('rgparmod') — rangayyan_parametric_sysid
...
`print(result)` render. See `moirais.fn.describe('rgparmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgparmod import *
import numpy as np
# See the function signature in fn/rgparmod.py for argument names.
```
