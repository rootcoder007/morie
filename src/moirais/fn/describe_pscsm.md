# describe('pscsm') — propensity_score_matching
...
`print(result)` render. See `moirais.fn.describe('pscsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pscsm import *
import numpy as np
# See the function signature in fn/pscsm.py for argument names.
```
