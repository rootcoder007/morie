...
`print(result)` render. See `moirais.fn.describe('secln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secln import *
import numpy as np
# See the function signature in fn/secln.py for argument names.
```
