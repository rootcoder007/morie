# describe('sgtgrn') — sgt_graph_neural_propagation
...
`print(result)` render. See `moirais.fn.describe('sgtgrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtgrn import *
import numpy as np
# See the function signature in fn/sgtgrn.py for argument names.
```
