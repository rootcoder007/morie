...
`print(result)` render. See `moirais.fn.describe('lgnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgnrm import *
import numpy as np
# See the function signature in fn/lgnrm.py for argument names.
```
