# describe('cdyld') — years_lived_disability
...
`print(result)` render. See `moirais.fn.describe('cdyld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdyld import *
import numpy as np
# See the function signature in fn/cdyld.py for argument names.
```
