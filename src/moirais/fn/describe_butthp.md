# describe('butthp') — butter_highpass
...
`print(result)` render. See `moirais.fn.describe('butthp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.butthp import *
import numpy as np
# See the function signature in fn/butthp.py for argument names.
```
