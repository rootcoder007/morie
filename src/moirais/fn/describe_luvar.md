...
`print(result)` render. See `moirais.fn.describe('luvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luvar import *
import numpy as np
# See the function signature in fn/luvar.py for argument names.
```
