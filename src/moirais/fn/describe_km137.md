# describe('km137') — kamath_ch9_itm_hard_negative
...
`print(result)` render. See `moirais.fn.describe('km137')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km137 import *
import numpy as np
# See the function signature in fn/km137.py for argument names.
```
