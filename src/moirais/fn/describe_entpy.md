...
`print(result)` render. See `moirais.fn.describe('entpy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entpy import *
import numpy as np
# See the function signature in fn/entpy.py for argument names.
```
