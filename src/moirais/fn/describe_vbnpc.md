# describe('vbnpc') — vb_nonparametric
...
`print(result)` render. See `moirais.fn.describe('vbnpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vbnpc import *
import numpy as np
# See the function signature in fn/vbnpc.py for argument names.
```
