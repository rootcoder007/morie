...
__all__ = ["hedderich_chapter_9_unnumbered_489"]


def hedderich_chapter_9_unnumbered_489(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If the diagnostic test is ideal, then a+d=n [Concordance rate: (a+d)/n≤1].FN (orb) are
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u489')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u489: GeneralStatistics expression (auto-extracted; see ref)."
