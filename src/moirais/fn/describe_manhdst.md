...
`print(result)` render. See `moirais.fn.describe('manhdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manhdst import *
import numpy as np
# See the function signature in fn/manhdst.py for argument names.
```
