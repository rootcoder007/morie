...
`print(result)` render. See `moirais.fn.describe('sqztf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqztf import *
import numpy as np
# See the function signature in fn/sqztf.py for argument names.
```
