# describe('hyplc') — harmonic_mean_estimator
...
`print(result)` render. See `moirais.fn.describe('hyplc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyplc import *
import numpy as np
# See the function signature in fn/hyplc.py for argument names.
```
