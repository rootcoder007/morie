# describe('bridgs') — bridge_sampling
...
`print(result)` render. See `moirais.fn.describe('bridgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bridgs import *
import numpy as np
# See the function signature in fn/bridgs.py for argument names.
```
