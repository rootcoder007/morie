...
`print(result)` render. See `moirais.fn.describe('gabsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gabsn import *
import numpy as np
# See the function signature in fn/gabsn.py for argument names.
```
