# describe('sgexp') — exponential_variogram
...
`print(result)` render. See `moirais.fn.describe('sgexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgexp import *
import numpy as np
# See the function signature in fn/sgexp.py for argument names.
```
