# describe('cslnc') — cosine_lr_schedule
...
`print(result)` render. See `moirais.fn.describe('cslnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cslnc import *
import numpy as np
# See the function signature in fn/cslnc.py for argument names.
```
