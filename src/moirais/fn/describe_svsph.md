...
`print(result)` render. See `moirais.fn.describe('svsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsph import *
import numpy as np
# See the function signature in fn/svsph.py for argument names.
```
