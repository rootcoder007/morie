...
__all__ = ["hedderich_chapter_9_unnumbered_538"]


def hedderich_chapter_9_unnumbered_538(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (2) P (X <a) = F (a)−P (X =a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u538')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u538: CountModels expression (auto-extracted; see ref)."
