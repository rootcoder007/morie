...
`print(result)` render. See `moirais.fn.describe('svdcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdcp import *
import numpy as np
# See the function signature in fn/svdcp.py for argument names.
```
