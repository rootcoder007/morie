...
`print(result)` render. See `moirais.fn.describe('afdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afdis import *
import numpy as np
# See the function signature in fn/afdis.py for argument names.
```
