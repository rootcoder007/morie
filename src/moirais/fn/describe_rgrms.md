...
`print(result)` render. See `moirais.fn.describe('rgrms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrms import *
import numpy as np
# See the function signature in fn/rgrms.py for argument names.
```
