...
`print(result)` render. See `moirais.fn.describe('mnfsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnfsp import *
import numpy as np
# See the function signature in fn/mnfsp.py for argument names.
```
