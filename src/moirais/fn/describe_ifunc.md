...
`print(result)` render. See `moirais.fn.describe('ifunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ifunc import *
import numpy as np
# See the function signature in fn/ifunc.py for argument names.
```
