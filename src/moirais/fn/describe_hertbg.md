...
`print(result)` render. See `moirais.fn.describe('hertbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hertbg import *
import numpy as np
# See the function signature in fn/hertbg.py for argument names.
```
