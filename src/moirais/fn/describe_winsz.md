...
`print(result)` render. See `moirais.fn.describe('winsz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.winsz import *
import numpy as np
# See the function signature in fn/winsz.py for argument names.
```
