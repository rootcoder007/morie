...
`print(result)` render. See `moirais.fn.describe('fermd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fermd import *
import numpy as np
# See the function signature in fn/fermd.py for argument names.
```
