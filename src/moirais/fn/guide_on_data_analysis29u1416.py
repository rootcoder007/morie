...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1416"]


def guide_on_data_analysis_chapter_29_unnumbered_1416(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1416')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1416: GeneralStatistics expression (auto-extracted; see ref)."
