...
`print(result)` render. See `moirais.fn.describe('cv1gn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cv1gn import *
import numpy as np
# See the function signature in fn/cv1gn.py for argument names.
```
