...
`print(result)` render. See `moirais.fn.describe('rkfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkfunc import *
import numpy as np
# See the function signature in fn/rkfunc.py for argument names.
```
