...
__all__ = ["hedderich_chapter_9_unnumbered_2621"]


def hedderich_chapter_9_unnumbered_2621(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 4 frequencies can be freely chosen:H0 is rejected if ˆχ2 >χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2621')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2621: GeneralStatistics expression (auto-extracted; see ref)."
