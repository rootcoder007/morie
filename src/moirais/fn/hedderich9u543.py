...
__all__ = ["hedderich_chapter_9_unnumbered_543"]


def hedderich_chapter_9_unnumbered_543(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (7) P (a<X <b ) = F (b)−F (a)−P (X =b)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u543')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u543: GeneralStatistics expression (auto-extracted; see ref)."
