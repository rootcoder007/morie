...
__all__ = ["hedderich_chapter_9_unnumbered_3321"]


def hedderich_chapter_9_unnumbered_3321(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆγ+ ˆα2 = ˆµ2 = 17, 34
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3321')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3321: GeneralStatistics expression (auto-extracted; see ref)."
