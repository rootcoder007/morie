...
`print(result)` render. See `moirais.fn.describe('sptrx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptrx import *
import numpy as np
# See the function signature in fn/sptrx.py for argument names.
```
