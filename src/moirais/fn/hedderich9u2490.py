...
__all__ = ["hedderich_chapter_9_unnumbered_2490"]


def hedderich_chapter_9_unnumbered_2490(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯RContr. = 5.17 ¯RA = 8.00 ¯RB = 13.00
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2490')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2490: GeneralStatistics expression (auto-extracted; see ref)."
