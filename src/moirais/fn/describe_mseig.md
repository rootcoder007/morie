...
`print(result)` render. See `moirais.fn.describe('mseig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mseig import *
import numpy as np
# See the function signature in fn/mseig.py for argument names.
```
