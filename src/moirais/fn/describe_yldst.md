# describe('yldst') — years_lived_with_disability
...
`print(result)` render. See `moirais.fn.describe('yldst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yldst import *
import numpy as np
# See the function signature in fn/yldst.py for argument names.
```
