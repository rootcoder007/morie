...
`print(result)` render. See `moirais.fn.describe('sespt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sespt import *
import numpy as np
# See the function signature in fn/sespt.py for argument names.
```
