...
`print(result)` render. See `moirais.fn.describe('perK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.perK import *
import numpy as np
# See the function signature in fn/perK.py for argument names.
```
