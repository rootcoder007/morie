...
`print(result)` render. See `moirais.fn.describe('hmrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrec import *
import numpy as np
# See the function signature in fn/hmrec.py for argument names.
```
