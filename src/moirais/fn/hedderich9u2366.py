...
__all__ = ["hedderich_chapter_9_unnumbered_2366"]


def hedderich_chapter_9_unnumbered_2366(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] with (7.209) ¯x = (2·5 + 4·4 + 3·6)/9 = 4.89
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2366')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2366: GeneralStatistics expression (auto-extracted; see ref)."
