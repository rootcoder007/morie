...
`print(result)` render. See `moirais.fn.describe('lfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lfunc import *
import numpy as np
# See the function signature in fn/lfunc.py for argument names.
```
