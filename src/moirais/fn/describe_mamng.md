...
`print(result)` render. See `moirais.fn.describe('mamng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mamng import *
import numpy as np
# See the function signature in fn/mamng.py for argument names.
```
