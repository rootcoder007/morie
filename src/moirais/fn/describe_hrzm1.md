# describe('hrzm1') — horowitz_mixture_model
...
`print(result)` render. See `moirais.fn.describe('hrzm1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzm1 import *
import numpy as np
# See the function signature in fn/hrzm1.py for argument names.
```
