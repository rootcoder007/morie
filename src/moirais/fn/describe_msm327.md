# describe('msm327') — mvsml_functional_regression_eq_15_3
...
`print(result)` render. See `moirais.fn.describe('msm327')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm327 import *
import numpy as np
# See the function signature in fn/msm327.py for argument names.
```
