...
`print(result)` render. See `moirais.fn.describe('gdmar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmar import *
import numpy as np
# See the function signature in fn/gdmar.py for argument names.
```
