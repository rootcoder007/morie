...
`print(result)` render. See `moirais.fn.describe('qlearn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qlearn import *
import numpy as np
# See the function signature in fn/qlearn.py for argument names.
```
