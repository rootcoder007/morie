...
`print(result)` render. See `moirais.fn.describe('tmspln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmspln import *
import numpy as np
# See the function signature in fn/tmspln.py for argument names.
```
