...
`print(result)` render. See `moirais.fn.describe('dkgak')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkgak import *
import numpy as np
# See the function signature in fn/dkgak.py for argument names.
```
