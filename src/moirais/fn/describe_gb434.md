# describe('gb434') — gibbons_ks_one_sided_dist
...
`print(result)` render. See `moirais.fn.describe('gb434')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb434 import *
import numpy as np
# See the function signature in fn/gb434.py for argument names.
```
