...
`print(result)` render. See `moirais.fn.describe('igravcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravcl import *
import numpy as np
# See the function signature in fn/igravcl.py for argument names.
```
