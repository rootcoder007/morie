# describe('penmth') — penalty_method
...
`print(result)` render. See `moirais.fn.describe('penmth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.penmth import *
import numpy as np
# See the function signature in fn/penmth.py for argument names.
```
