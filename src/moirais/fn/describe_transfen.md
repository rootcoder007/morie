# describe('transfen') — transfer_entropy_te
...
`print(result)` render. See `moirais.fn.describe('transfen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.transfen import *
import numpy as np
# See the function signature in fn/transfen.py for argument names.
```
