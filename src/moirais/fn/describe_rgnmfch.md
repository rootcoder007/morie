# describe('rgnmfch') — rangayyan_nmf_channel_sel
...
`print(result)` render. See `moirais.fn.describe('rgnmfch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgnmfch import *
import numpy as np
# See the function signature in fn/rgnmfch.py for argument names.
```
