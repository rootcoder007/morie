# describe('wsmodd') — wasserman_odds_ratio
...
`print(result)` render. See `moirais.fn.describe('wsmodd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmodd import *
import numpy as np
# See the function signature in fn/wsmodd.py for argument names.
```
