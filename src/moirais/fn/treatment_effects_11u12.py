...
__all__ = ["treatment_effects_1_chapter_1_unnumbered_12"]


def treatment_effects_1_chapter_1_unnumbered_12(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] αATE = E[Y1i−Y0i] = E[E[Y1i−Y0i|Xi]]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('treatment_effects_11u12')`` for the full guide.
...
def cheatsheet():
    return "treatment_effects_11u12: GeneralStatistics expression (auto-extracted; see ref)."
