...
`print(result)` render. See `moirais.fn.describe('jnpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jnpnt import *
import numpy as np
# See the function signature in fn/jnpnt.py for argument names.
```
