...
__all__ = ["wilcox_chapter_4_unnumbered_136"]


def wilcox_chapter_4_unnumbered_136(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b) P (Z >c) = 0.5040, (c) P (−c ≤ Z <c) = 0.9108, (d) P (−c ≤ Z ≤ c) = 0.8.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u136')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u136: GeneralStatistics expression (auto-extracted; see ref)."
