# describe('hmlrel') — geron_leaky_relu
...
`print(result)` render. See `moirais.fn.describe('hmlrel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrel import *
import numpy as np
# See the function signature in fn/hmlrel.py for argument names.
```
