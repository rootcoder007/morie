# describe('gbtcom') — goodman_bacon_3way
...
`print(result)` render. See `moirais.fn.describe('gbtcom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbtcom import *
import numpy as np
# See the function signature in fn/gbtcom.py for argument names.
```
