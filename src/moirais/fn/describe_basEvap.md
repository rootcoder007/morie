# describe('basEvap') — penman_monteith
...
`print(result)` render. See `moirais.fn.describe('basEvap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.basEvap import *
import numpy as np
# See the function signature in fn/basEvap.py for argument names.
```
