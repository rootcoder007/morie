# describe('nmrcf') — roll_call_filter
...
`print(result)` render. See `moirais.fn.describe('nmrcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmrcf import *
import numpy as np
# See the function signature in fn/nmrcf.py for argument names.
```
