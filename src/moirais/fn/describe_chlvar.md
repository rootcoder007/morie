...
`print(result)` render. See `moirais.fn.describe('chlvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlvar import *
import numpy as np
# See the function signature in fn/chlvar.py for argument names.
```
