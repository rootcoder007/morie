...
`print(result)` render. See `moirais.fn.describe('toppd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.toppd import *
import numpy as np
# See the function signature in fn/toppd.py for argument names.
```
