...
`print(result)` render. See `moirais.fn.describe('svpro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpro import *
import numpy as np
# See the function signature in fn/svpro.py for argument names.
```
