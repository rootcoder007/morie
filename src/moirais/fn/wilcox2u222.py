...
__all__ = ["wilcox_chapter_2_unnumbered_222"]


def wilcox_chapter_2_unnumbered_222(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u222')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u222: PowerAndDesign expression (auto-extracted; see ref)."
