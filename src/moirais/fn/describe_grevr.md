# describe('grevr') — geron_explained_variance_ratio
...
`print(result)` render. See `moirais.fn.describe('grevr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grevr import *
import numpy as np
# See the function signature in fn/grevr.py for argument names.
```
