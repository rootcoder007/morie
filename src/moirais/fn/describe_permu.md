# describe('permu') — permutation_count
...
`print(result)` render. See `moirais.fn.describe('permu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.permu import *
import numpy as np
# See the function signature in fn/permu.py for argument names.
```
