# describe('lvndr') — levinson_durbin_fn
...
`print(result)` render. See `moirais.fn.describe('lvndr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lvndr import *
import numpy as np
# See the function signature in fn/lvndr.py for argument names.
```
