# describe('hmmnl') — geron_multinomial_logistic
...
`print(result)` render. See `moirais.fn.describe('hmmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmnl import *
import numpy as np
# See the function signature in fn/hmmnl.py for argument names.
```
