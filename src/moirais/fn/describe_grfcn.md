# describe('grfcn') — geron_fcn_upsample
...
`print(result)` render. See `moirais.fn.describe('grfcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grfcn import *
import numpy as np
# See the function signature in fn/grfcn.py for argument names.
```
