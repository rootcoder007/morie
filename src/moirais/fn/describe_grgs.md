# describe('grgs') — geron_grid_search_cv
...
`print(result)` render. See `moirais.fn.describe('grgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgs import *
import numpy as np
# See the function signature in fn/grgs.py for argument names.
```
