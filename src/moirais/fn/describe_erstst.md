...
`print(result)` render. See `moirais.fn.describe('erstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.erstst import *
import numpy as np
# See the function signature in fn/erstst.py for argument names.
```
