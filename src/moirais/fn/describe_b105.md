# describe('b105') — burkov_lm_ch1_cosine_similarity
...
`print(result)` render. See `moirais.fn.describe('b105')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b105 import *
import numpy as np
# See the function signature in fn/b105.py for argument names.
```
