...
`print(result)` render. See `moirais.fn.describe('stdbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdbs import *
import numpy as np
# See the function signature in fn/stdbs.py for argument names.
```
