# describe('pfcrc') — preference_circles
...
`print(result)` render. See `moirais.fn.describe('pfcrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pfcrc import *
import numpy as np
# See the function signature in fn/pfcrc.py for argument names.
```
