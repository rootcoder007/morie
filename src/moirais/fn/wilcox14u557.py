...
__all__ = ["wilcox_chapter_14_unnumbered_557"]


def wilcox_chapter_14_unnumbered_557(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] cU =n2(n2 +n1 + 1) − cL.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u557')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u557: PowerAndDesign expression (auto-extracted; see ref)."
