...
def gibbons_kw_alt_form(groups, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Alternative formula for H statistic in terms of rank sums R_i"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Alternative formula for H statistic in terms of rank sums R_i"})
