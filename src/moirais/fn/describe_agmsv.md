...
`print(result)` render. See `moirais.fn.describe('agmsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmsv import *
import numpy as np
# See the function signature in fn/agmsv.py for argument names.
```
