# describe('ohist') — otis_histogram_data
...
`print(result)` render. See `moirais.fn.describe('ohist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ohist import *
import numpy as np
# See the function signature in fn/ohist.py for argument names.
```
