...
__all__ = ["wilcox_chapter_14_unnumbered_633"]


def wilcox_chapter_14_unnumbered_633(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] ˆpa = ˆp − 0.1(ˆq − 0.5).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u633')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u633: Resampling expression (auto-extracted; see ref)."
