...
`print(result)` render. See `moirais.fn.describe('hyslo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyslo import *
import numpy as np
# See the function signature in fn/hyslo.py for argument names.
```
