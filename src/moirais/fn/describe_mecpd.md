# describe('mecpd') — markov_equivalence_class
...
`print(result)` render. See `moirais.fn.describe('mecpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mecpd import *
import numpy as np
# See the function signature in fn/mecpd.py for argument names.
```
