...
`print(result)` render. See `moirais.fn.describe('srrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srrob import *
import numpy as np
# See the function signature in fn/srrob.py for argument names.
```
