# describe('jonaiv') — joseph_naive_forecast
...
`print(result)` render. See `moirais.fn.describe('jonaiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jonaiv import *
import numpy as np
# See the function signature in fn/jonaiv.py for argument names.
```
