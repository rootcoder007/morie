...
`print(result)` render. See `moirais.fn.describe('hc012')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hc012 import *
import numpy as np
# See the function signature in fn/hc012.py for argument names.
```
