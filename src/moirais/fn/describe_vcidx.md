...
`print(result)` render. See `moirais.fn.describe('vcidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcidx import *
import numpy as np
# See the function signature in fn/vcidx.py for argument names.
```
