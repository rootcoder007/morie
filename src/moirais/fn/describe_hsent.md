...
`print(result)` render. See `moirais.fn.describe('hsent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsent import *
import numpy as np
# See the function signature in fn/hsent.py for argument names.
```
