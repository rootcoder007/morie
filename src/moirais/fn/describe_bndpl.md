...
`print(result)` render. See `moirais.fn.describe('bndpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpl import *
import numpy as np
# See the function signature in fn/bndpl.py for argument names.
```
