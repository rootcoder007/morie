...
`print(result)` render. See `moirais.fn.describe('mtash')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtash import *
import numpy as np
# See the function signature in fn/mtash.py for argument names.
```
