# describe('genvdm') — d_study_decision
...
`print(result)` render. See `moirais.fn.describe('genvdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genvdm import *
import numpy as np
# See the function signature in fn/genvdm.py for argument names.
```
