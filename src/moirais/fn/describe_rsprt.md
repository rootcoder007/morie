# describe('rsprt') — respiratory_rate_fn
...
`print(result)` render. See `moirais.fn.describe('rsprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsprt import *
import numpy as np
# See the function signature in fn/rsprt.py for argument names.
```
