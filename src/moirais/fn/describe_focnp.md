...
`print(result)` render. See `moirais.fn.describe('focnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focnp import *
import numpy as np
# See the function signature in fn/focnp.py for argument names.
```
