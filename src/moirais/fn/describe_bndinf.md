# describe('bndinf') — bound_inference
...
`print(result)` render. See `moirais.fn.describe('bndinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndinf import *
import numpy as np
# See the function signature in fn/bndinf.py for argument names.
```
