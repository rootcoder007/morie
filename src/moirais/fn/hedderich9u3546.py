...
__all__ = ["hedderich_chapter_9_unnumbered_3546"]


def hedderich_chapter_9_unnumbered_3546(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] hi =P (T =ti|T≥ti) = pi
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3546')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3546: GeneralStatistics expression (auto-extracted; see ref)."
