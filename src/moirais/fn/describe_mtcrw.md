...
`print(result)` render. See `moirais.fn.describe('mtcrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcrw import *
import numpy as np
# See the function signature in fn/mtcrw.py for argument names.
```
