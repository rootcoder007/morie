...
`print(result)` render. See `moirais.fn.describe('rskap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskap import *
import numpy as np
# See the function signature in fn/rskap.py for argument names.
```
