...
`print(result)` render. See `moirais.fn.describe('nbcns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcns import *
import numpy as np
# See the function signature in fn/nbcns.py for argument names.
```
