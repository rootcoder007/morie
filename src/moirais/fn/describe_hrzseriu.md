# describe('hrzseriu') — horowitz_series_unknown_T
...
`print(result)` render. See `moirais.fn.describe('hrzseriu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzseriu import *
import numpy as np
# See the function signature in fn/hrzseriu.py for argument names.
```
