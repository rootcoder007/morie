...
__all__ = ["wilcox_chapter_9_unnumbered_1066"]


def wilcox_chapter_9_unnumbered_1066(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Xi − Xi′ = (Xi1 − Xi′ 1,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1066')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1066: GeneralStatistics expression (auto-extracted; see ref)."
