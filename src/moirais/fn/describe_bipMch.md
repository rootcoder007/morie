# describe('bipMch') — bipartite_matching
...
`print(result)` render. See `moirais.fn.describe('bipMch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bipMch import *
import numpy as np
# See the function signature in fn/bipMch.py for argument names.
```
