...
__all__ = ["wilcox_chapter_14_unnumbered_577"]


def wilcox_chapter_14_unnumbered_577(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ebarplot(x,y = NULL, nse = 1,xlab="Groups",ylab=NULL,tr=0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u577')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u577: GeneralStatistics expression (auto-extracted; see ref)."
