...
`print(result)` render. See `moirais.fn.describe('argen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.argen import *
import numpy as np
# See the function signature in fn/argen.py for argument names.
```
