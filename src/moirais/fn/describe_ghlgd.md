# describe('ghlgd') — ghosal_log_density
...
`print(result)` render. See `moirais.fn.describe('ghlgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghlgd import *
import numpy as np
# See the function signature in fn/ghlgd.py for argument names.
```
