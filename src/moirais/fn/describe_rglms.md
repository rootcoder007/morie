# describe('rglms') — rangayyan_lms_filter
...
`print(result)` render. See `moirais.fn.describe('rglms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglms import *
import numpy as np
# See the function signature in fn/rglms.py for argument names.
```
