...
`print(result)` render. See `moirais.fn.describe('vmdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmdir import *
import numpy as np
# See the function signature in fn/vmdir.py for argument names.
```
