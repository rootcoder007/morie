...
`print(result)` render. See `moirais.fn.describe('kdesm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kdesm import *
import numpy as np
# See the function signature in fn/kdesm.py for argument names.
```
