...
`print(result)` render. See `moirais.fn.describe('gnswald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnswald import *
import numpy as np
# See the function signature in fn/gnswald.py for argument names.
```
