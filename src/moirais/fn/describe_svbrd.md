...
`print(result)` render. See `moirais.fn.describe('svbrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svbrd import *
import numpy as np
# See the function signature in fn/svbrd.py for argument names.
```
