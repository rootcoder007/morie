# describe('lornz') — lorenz_curve

## WHAT IT DOES

Lorenz curve coordinates. 'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('lornz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lornz import *
import numpy as np
# See the function signature in fn/lornz.py for argument names.
```
