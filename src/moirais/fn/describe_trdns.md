...
`print(result)` render. See `moirais.fn.describe('trdns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdns import *
import numpy as np
# See the function signature in fn/trdns.py for argument names.
```
