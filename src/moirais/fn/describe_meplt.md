...
`print(result)` render. See `moirais.fn.describe('meplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.meplt import *
import numpy as np
# See the function signature in fn/meplt.py for argument names.
```
