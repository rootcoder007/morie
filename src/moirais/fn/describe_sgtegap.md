# describe('sgtegap') — sgt_eigengap_heuristic
...
`print(result)` render. See `moirais.fn.describe('sgtegap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtegap import *
import numpy as np
# See the function signature in fn/sgtegap.py for argument names.
```
