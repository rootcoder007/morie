# describe('asr') — age_standardized_rate
...
`print(result)` render. See `moirais.fn.describe('asr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.asr import *
import numpy as np
# See the function signature in fn/asr.py for argument names.
```
