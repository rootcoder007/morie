...
`print(result)` render. See `moirais.fn.describe('fastm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fastm import *
import numpy as np
# See the function signature in fn/fastm.py for argument names.
```
