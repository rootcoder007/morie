# describe('zerke') — risk_exceedance
...
`print(result)` render. See `moirais.fn.describe('zerke')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zerke import *
import numpy as np
# See the function signature in fn/zerke.py for argument names.
```
