# describe('katzcn') — katz_centrality
...
`print(result)` render. See `moirais.fn.describe('katzcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.katzcn import *
import numpy as np
# See the function signature in fn/katzcn.py for argument names.
```
