...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_111"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_111(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > y=x-2*x^2+rnorm (100)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u111')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u111: GeneralStatistics expression (auto-extracted; see ref)."
