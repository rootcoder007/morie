# describe('km105') — kamath_ch6_gedi_combined_loss
...
`print(result)` render. See `moirais.fn.describe('km105')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km105 import *
import numpy as np
# See the function signature in fn/km105.py for argument names.
```
