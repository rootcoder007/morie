...
__all__ = ["bivand2013_chapter_7_unnumbered_201"]


def bivand2013_chapter_7_unnumbered_201(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, family = "SAR", listw = NYlistw, llprof = 100)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u201')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u201: GeneralStatistics expression (auto-extracted; see ref)."
