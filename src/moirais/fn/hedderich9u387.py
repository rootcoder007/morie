...
__all__ = ["hedderich_chapter_9_unnumbered_387"]


def hedderich_chapter_9_unnumbered_387(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1 =P (S) =P (A∪¯A) =P (A) +P ( ¯A), i.e. P (A) = 1−P ( ¯A) (4.11)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u387')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u387: GeneralStatistics expression (auto-extracted; see ref)."
