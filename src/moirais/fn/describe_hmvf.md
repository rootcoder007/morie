# describe('hmvf') — geron_value_function
...
`print(result)` render. See `moirais.fn.describe('hmvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvf import *
import numpy as np
# See the function signature in fn/hmvf.py for argument names.
```
