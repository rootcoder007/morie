...
`print(result)` render. See `moirais.fn.describe('msref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msref import *
import numpy as np
# See the function signature in fn/msref.py for argument names.
```
