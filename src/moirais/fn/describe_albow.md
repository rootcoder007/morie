# describe('albow') — alammar_bag_of_words
...
`print(result)` render. See `moirais.fn.describe('albow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.albow import *
import numpy as np
# See the function signature in fn/albow.py for argument names.
```
