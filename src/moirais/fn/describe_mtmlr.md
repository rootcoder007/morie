...
`print(result)` render. See `moirais.fn.describe('mtmlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtmlr import *
import numpy as np
# See the function signature in fn/mtmlr.py for argument names.
```
