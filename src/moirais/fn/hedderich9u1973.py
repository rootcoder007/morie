...
__all__ = ["hedderich_chapter_9_unnumbered_1973"]


def hedderich_chapter_9_unnumbered_1973(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the ranks 1, 2, 3, 4 or, if we distribute average rank values, 2.5; 2.5; 2.5; 2.5 (cf. 1 + 2 + 3 + 4 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1973')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1973: GeneralStatistics expression (auto-extracted; see ref)."
