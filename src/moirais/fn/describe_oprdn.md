...
`print(result)` render. See `moirais.fn.describe('oprdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oprdn import *
import numpy as np
# See the function signature in fn/oprdn.py for argument names.
```
