...
`print(result)` render. See `moirais.fn.describe('kgorw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgorw import *
import numpy as np
# See the function signature in fn/kgorw.py for argument names.
```
