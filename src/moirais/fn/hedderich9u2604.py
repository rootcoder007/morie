...
__all__ = ["hedderich_chapter_9_unnumbered_2604"]


def hedderich_chapter_9_unnumbered_2604(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] b/[(a + 1)F1]≤β/α≤[(b + 1)F2]/a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2604')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2604: GeneralStatistics expression (auto-extracted; see ref)."
