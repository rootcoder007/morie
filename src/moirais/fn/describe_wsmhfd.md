# describe('wsmhfd') — wasserman_hoeffding
...
`print(result)` render. See `moirais.fn.describe('wsmhfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmhfd import *
import numpy as np
# See the function signature in fn/wsmhfd.py for argument names.
```
