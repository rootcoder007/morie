...
`print(result)` render. See `moirais.fn.describe('svag2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svag2 import *
import numpy as np
# See the function signature in fn/svag2.py for argument names.
```
