# describe('yangr') — yang_realized_relationship
...
`print(result)` render. See `moirais.fn.describe('yangr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yangr import *
import numpy as np
# See the function signature in fn/yangr.py for argument names.
```
