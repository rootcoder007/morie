# describe('replwt') — replicate_weights
...
`print(result)` render. See `moirais.fn.describe('replwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.replwt import *
import numpy as np
# See the function signature in fn/replwt.py for argument names.
```
