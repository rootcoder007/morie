...
`print(result)` render. See `moirais.fn.describe('defuz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.defuz import *
import numpy as np
# See the function signature in fn/defuz.py for argument names.
```
