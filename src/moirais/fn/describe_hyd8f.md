...
`print(result)` render. See `moirais.fn.describe('hyd8f')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyd8f import *
import numpy as np
# See the function signature in fn/hyd8f.py for argument names.
```
