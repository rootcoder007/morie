...
__all__ = ["wilcox_chapter_4_unnumbered_212"]


def wilcox_chapter_4_unnumbered_212(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] valuesX(1) ≤ X(2) ≤ X(3) ≤ X(4) ≤ X(5). If we observe X1 = 1.5, X2 = −1.2, X3 = 0.89,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u212')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u212: GeneralStatistics expression (auto-extracted; see ref)."
