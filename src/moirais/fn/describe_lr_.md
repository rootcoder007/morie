# describe('lr_') — likelihood_ratios
...
`print(result)` render. See `moirais.fn.describe('lr_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lr_ import *
import numpy as np
# See the function signature in fn/lr_.py for argument names.
```
