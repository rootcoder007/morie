...
`print(result)` render. See `moirais.fn.describe('nnwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnwgt import *
import numpy as np
# See the function signature in fn/nnwgt.py for argument names.
```
