...
`print(result)` render. See `moirais.fn.describe('annsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.annsi import *
import numpy as np
# See the function signature in fn/annsi.py for argument names.
```
