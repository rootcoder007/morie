...
`print(result)` render. See `moirais.fn.describe('hymfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hymfd import *
import numpy as np
# See the function signature in fn/hymfd.py for argument names.
```
