...
`print(result)` render. See `moirais.fn.describe('aucroc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aucroc import *
import numpy as np
# See the function signature in fn/aucroc.py for argument names.
```
