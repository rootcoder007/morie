...
`print(result)` render. See `moirais.fn.describe('rlsfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlsfl import *
import numpy as np
# See the function signature in fn/rlsfl.py for argument names.
```
