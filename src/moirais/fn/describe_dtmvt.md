...
`print(result)` render. See `moirais.fn.describe('dtmvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmvt import *
import numpy as np
# See the function signature in fn/dtmvt.py for argument names.
```
