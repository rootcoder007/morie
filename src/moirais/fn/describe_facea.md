...
`print(result)` render. See `moirais.fn.describe('facea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.facea import *
import numpy as np
# See the function signature in fn/facea.py for argument names.
```
