...
__all__ = ["bivand2013_chapter_7_unnumbered_164"]


def bivand2013_chapter_7_unnumbered_164(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + s1.fit, nsim = 6, indicators = TRUE, nmax = 40)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u164')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u164: GeneralStatistics expression (auto-extracted; see ref)."
