...
`print(result)` render. See `moirais.fn.describe('soper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soper import *
import numpy as np
# See the function signature in fn/soper.py for argument names.
```
