...
`print(result)` render. See `moirais.fn.describe('dphis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dphis import *
import numpy as np
# See the function signature in fn/dphis.py for argument names.
```
