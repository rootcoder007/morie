...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1397"]


def guide_on_data_analysis_chapter_28_unnumbered_1397(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: plot(df_its$T, df_its $Y, pch=16,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1397')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1397: GeneralStatistics expression (auto-extracted; see ref)."
