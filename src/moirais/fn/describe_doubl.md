...
`print(result)` render. See `moirais.fn.describe('doubl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.doubl import *
import numpy as np
# See the function signature in fn/doubl.py for argument names.
```
