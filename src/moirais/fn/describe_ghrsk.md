...
`print(result)` render. See `moirais.fn.describe('ghrsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghrsk import *
import numpy as np
# See the function signature in fn/ghrsk.py for argument names.
```
