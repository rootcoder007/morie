...
__all__ = ["hedderich_chapter_9_unnumbered_1146"]


def hedderich_chapter_9_unnumbered_1146(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˘p = (x + 3/8)/(n + 3/4)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1146')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1146: GeneralStatistics expression (auto-extracted; see ref)."
