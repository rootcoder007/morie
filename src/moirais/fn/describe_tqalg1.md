# describe('tqalg1') — turboquant_online_key_quantizer
...
`print(result)` render. See `moirais.fn.describe('tqalg1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqalg1 import *
import numpy as np
# See the function signature in fn/tqalg1.py for argument names.
```
