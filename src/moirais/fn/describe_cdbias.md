...
`print(result)` render. See `moirais.fn.describe('cdbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdbias import *
import numpy as np
# See the function signature in fn/cdbias.py for argument names.
```
