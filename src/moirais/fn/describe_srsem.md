...
`print(result)` render. See `moirais.fn.describe('srsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srsem import *
import numpy as np
# See the function signature in fn/srsem.py for argument names.
```
