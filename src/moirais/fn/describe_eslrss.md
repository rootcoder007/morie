# describe('eslrss') — esl_residual_sum_squares
...
`print(result)` render. See `moirais.fn.describe('eslrss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslrss import *
import numpy as np
# See the function signature in fn/eslrss.py for argument names.
```
