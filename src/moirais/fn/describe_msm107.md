# describe('msm107') — mvsml_bayesian_regression_pt2_eq_7_6
...
`print(result)` render. See `moirais.fn.describe('msm107')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm107 import *
import numpy as np
# See the function signature in fn/msm107.py for argument names.
```
