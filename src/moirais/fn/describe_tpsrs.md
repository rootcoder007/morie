# describe('tpsrs') — tps_response_time
...
`print(result)` render. See `moirais.fn.describe('tpsrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsrs import *
import numpy as np
# See the function signature in fn/tpsrs.py for argument names.
```
