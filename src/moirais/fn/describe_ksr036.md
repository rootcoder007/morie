# describe('ksr036') — kosorok_ch2_donsker_bracketing_theorem
...
`print(result)` render. See `moirais.fn.describe('ksr036')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr036 import *
import numpy as np
# See the function signature in fn/ksr036.py for argument names.
```
