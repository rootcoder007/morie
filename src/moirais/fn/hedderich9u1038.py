...
__all__ = ["hedderich_chapter_9_unnumbered_1038"]


def hedderich_chapter_9_unnumbered_1038(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: density functionfx,y =xye−(x+y) (cf. Figure 5.51).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1038')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1038: GeneralStatistics expression (auto-extracted; see ref)."
