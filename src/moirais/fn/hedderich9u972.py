...
__all__ = ["hedderich_chapter_9_unnumbered_972"]


def hedderich_chapter_9_unnumbered_972(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: δ= 0, 1, 2, 3, 4 are shown. Withδ= 0, the central t-distribution in (5.157) results.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u972')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u972: GeneralStatistics expression (auto-extracted; see ref)."
