# describe('qrswv') — qrs_waveform_features
...
`print(result)` render. See `moirais.fn.describe('qrswv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrswv import *
import numpy as np
# See the function signature in fn/qrswv.py for argument names.
```
