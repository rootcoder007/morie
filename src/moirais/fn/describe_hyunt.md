...
`print(result)` render. See `moirais.fn.describe('hyunt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyunt import *
import numpy as np
# See the function signature in fn/hyunt.py for argument names.
```
