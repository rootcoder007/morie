# describe('hmjl') — geron_johnson_lindenstrauss
...
`print(result)` render. See `moirais.fn.describe('hmjl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmjl import *
import numpy as np
# See the function signature in fn/hmjl.py for argument names.
```
