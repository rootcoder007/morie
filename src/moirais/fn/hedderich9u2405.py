...
__all__ = ["hedderich_chapter_9_unnumbered_2405"]


def hedderich_chapter_9_unnumbered_2405(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > n <− c ( n0 , nA , nB ) ; names ( n ) <− paste ( " Group " , c ( "K" , "A" , "B" ) , sep =" . " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2405')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2405: GeneralStatistics expression (auto-extracted; see ref)."
