# describe('strdis') — structural_distance
...
`print(result)` render. See `moirais.fn.describe('strdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strdis import *
import numpy as np
# See the function signature in fn/strdis.py for argument names.
```
