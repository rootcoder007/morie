...
`print(result)` render. See `moirais.fn.describe('scraw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scraw import *
import numpy as np
# See the function signature in fn/scraw.py for argument names.
```
