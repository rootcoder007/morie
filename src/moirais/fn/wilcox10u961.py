...
__all__ = ["wilcox_chapter_10_unnumbered_961"]


def wilcox_chapter_10_unnumbered_961(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: qcomhdMC(x, y, q = c(0.1, 0.25, 0.5, 0.75, 0.9), nboot = 2000, plotit =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u961')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u961: GeneralStatistics expression (auto-extracted; see ref)."
