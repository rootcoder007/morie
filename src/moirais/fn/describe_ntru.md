...
`print(result)` render. See `moirais.fn.describe('ntru')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ntru import *
import numpy as np
# See the function signature in fn/ntru.py for argument names.
```
