...
`print(result)` render. See `moirais.fn.describe('gpvfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpvfe import *
import numpy as np
# See the function signature in fn/gpvfe.py for argument names.
```
