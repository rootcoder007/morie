...
__all__ = ["hedderich_chapter_9_unnumbered_2520"]


def hedderich_chapter_9_unnumbered_2520(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R(n=4,k=3,α=0.01) = 8.0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2520')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2520: GeneralStatistics expression (auto-extracted; see ref)."
