# describe('sestrg') — s_estimator_regression
...
`print(result)` render. See `moirais.fn.describe('sestrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sestrg import *
import numpy as np
# See the function signature in fn/sestrg.py for argument names.
```
