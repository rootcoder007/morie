# describe('sv_dl') — structural_variant
...
`print(result)` render. See `moirais.fn.describe('sv_dl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sv_dl import *
import numpy as np
# See the function signature in fn/sv_dl.py for argument names.
```
