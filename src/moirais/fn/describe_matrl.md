...
`print(result)` render. See `moirais.fn.describe('matrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matrl import *
import numpy as np
# See the function signature in fn/matrl.py for argument names.
```
