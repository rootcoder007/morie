...
`print(result)` render. See `moirais.fn.describe('agndv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agndv import *
import numpy as np
# See the function signature in fn/agndv.py for argument names.
```
