...
`print(result)` render. See `moirais.fn.describe('emgmu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emgmu import *
import numpy as np
# See the function signature in fn/emgmu.py for argument names.
```
