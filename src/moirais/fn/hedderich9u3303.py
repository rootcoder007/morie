...
__all__ = ["hedderich_chapter_9_unnumbered_3303"]


def hedderich_chapter_9_unnumbered_3303(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆF = RSS(p−1)−RSS(p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3303')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3303: GeneralStatistics expression (auto-extracted; see ref)."
