...
`print(result)` render. See `moirais.fn.describe('ptdgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptdgm import *
import numpy as np
# See the function signature in fn/ptdgm.py for argument names.
```
