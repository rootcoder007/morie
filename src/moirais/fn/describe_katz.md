...
`print(result)` render. See `moirais.fn.describe('katz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.katz import *
import numpy as np
# See the function signature in fn/katz.py for argument names.
```
