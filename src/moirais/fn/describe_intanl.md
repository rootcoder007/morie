# describe('intanl') — interaction_analysis
...
`print(result)` render. See `moirais.fn.describe('intanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intanl import *
import numpy as np
# See the function signature in fn/intanl.py for argument names.
```
