...
`print(result)` render. See `moirais.fn.describe('latbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.latbnd import *
import numpy as np
# See the function signature in fn/latbnd.py for argument names.
```
