# describe('fzt15') — fauzi_thm1_5_consistency_mgkde
...
`print(result)` render. See `moirais.fn.describe('fzt15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt15 import *
import numpy as np
# See the function signature in fn/fzt15.py for argument names.
```
