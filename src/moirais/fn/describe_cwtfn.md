...
`print(result)` render. See `moirais.fn.describe('cwtfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cwtfn import *
import numpy as np
# See the function signature in fn/cwtfn.py for argument names.
```
