...
`print(result)` render. See `moirais.fn.describe('sacml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacml import *
import numpy as np
# See the function signature in fn/sacml.py for argument names.
```
