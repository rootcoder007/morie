# describe('hmeaf') — geron_error_analysis
...
`print(result)` render. See `moirais.fn.describe('hmeaf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmeaf import *
import numpy as np
# See the function signature in fn/hmeaf.py for argument names.
```
