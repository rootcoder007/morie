# describe('spkpf') — single_peaked_check
...
`print(result)` render. See `moirais.fn.describe('spkpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkpf import *
import numpy as np
# See the function signature in fn/spkpf.py for argument names.
```
