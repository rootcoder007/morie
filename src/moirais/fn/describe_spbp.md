# describe('spbp') — schabenberger_breusch_pagan
...
`print(result)` render. See `moirais.fn.describe('spbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spbp import *
import numpy as np
# See the function signature in fn/spbp.py for argument names.
```
