...
`print(result)` render. See `moirais.fn.describe('vmmad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmmad import *
import numpy as np
# See the function signature in fn/vmmad.py for argument names.
```
