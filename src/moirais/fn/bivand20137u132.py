...
__all__ = ["bivand2013_chapter_7_unnumbered_132"]


def bivand2013_chapter_7_unnumbered_132(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + ncases = ncases, prob = rep(ratiocc, npoints(pppasthma)))))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u132')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u132: GeneralStatistics expression (auto-extracted; see ref)."
