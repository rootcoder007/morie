...
`print(result)` render. See `moirais.fn.describe('chlpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlpow import *
import numpy as np
# See the function signature in fn/chlpow.py for argument names.
```
