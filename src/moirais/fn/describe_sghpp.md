# describe('sghpp') — homogeneous_poisson
...
`print(result)` render. See `moirais.fn.describe('sghpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sghpp import *
import numpy as np
# See the function signature in fn/sghpp.py for argument names.
```
