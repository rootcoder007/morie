# describe('frmlD') — formal_derivative
...
`print(result)` render. See `moirais.fn.describe('frmlD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frmlD import *
import numpy as np
# See the function signature in fn/frmlD.py for argument names.
```
