# describe('ltabl') — life_table_full
...
`print(result)` render. See `moirais.fn.describe('ltabl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltabl import *
import numpy as np
# See the function signature in fn/ltabl.py for argument names.
```
