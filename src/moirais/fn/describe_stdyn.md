...
`print(result)` render. See `moirais.fn.describe('stdyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdyn import *
import numpy as np
# See the function signature in fn/stdyn.py for argument names.
```
