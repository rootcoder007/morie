...
`print(result)` render. See `moirais.fn.describe('geexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geexp import *
import numpy as np
# See the function signature in fn/geexp.py for argument names.
```
