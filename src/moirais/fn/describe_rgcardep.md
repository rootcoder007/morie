# describe('rgcardep') — rangayyan_cardiac_elecphys
...
`print(result)` render. See `moirais.fn.describe('rgcardep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcardep import *
import numpy as np
# See the function signature in fn/rgcardep.py for argument names.
```
