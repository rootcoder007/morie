...
__all__ = ["hedderich_chapter_9_unnumbered_372"]


def hedderich_chapter_9_unnumbered_372(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > par ( mfrow= c ( 1 , 3 ) , lwd =2 , font . a x i s=2 , b t y =" l " , ps =18)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u372')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u372: GeneralStatistics expression (auto-extracted; see ref)."
