...
`print(result)` render. See `moirais.fn.describe('rmspf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmspf import *
import numpy as np
# See the function signature in fn/rmspf.py for argument names.
```
