...
__all__ = ["hedderich_chapter_9_unnumbered_3649"]


def hedderich_chapter_9_unnumbered_3649(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ☞ > replace( 1 : 1 0 , list =c ( 2 , 4 , 6 ) , values = c ( 2 0 , 40 , 6 0 ) ) # replace
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3649')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3649: GeneralStatistics expression (auto-extracted; see ref)."
