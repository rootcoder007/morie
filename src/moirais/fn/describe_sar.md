# describe('sar') — secondary_attack_rate
...
`print(result)` render. See `moirais.fn.describe('sar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sar import *
import numpy as np
# See the function signature in fn/sar.py for argument names.
```
