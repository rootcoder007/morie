# describe('msm133') — mvsml_categorical_count_eq_8_3
...
`print(result)` render. See `moirais.fn.describe('msm133')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm133 import *
import numpy as np
# See the function signature in fn/msm133.py for argument names.
```
