# describe('farsig') — farrington_signal
...
`print(result)` render. See `moirais.fn.describe('farsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.farsig import *
import numpy as np
# See the function signature in fn/farsig.py for argument names.
```
