...
`print(result)` render. See `moirais.fn.describe('scpbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpbic import *
import numpy as np
# See the function signature in fn/scpbic.py for argument names.
```
