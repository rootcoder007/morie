...
`print(result)` render. See `moirais.fn.describe('sdemml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemml import *
import numpy as np
# See the function signature in fn/sdemml.py for argument names.
```
