# describe('rgsemm') — rangayyan_spec_error_meas
...
`print(result)` render. See `moirais.fn.describe('rgsemm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsemm import *
import numpy as np
# See the function signature in fn/rgsemm.py for argument names.
```
