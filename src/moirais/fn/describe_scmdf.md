...
`print(result)` render. See `moirais.fn.describe('scmdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scmdf import *
import numpy as np
# See the function signature in fn/scmdf.py for argument names.
```
