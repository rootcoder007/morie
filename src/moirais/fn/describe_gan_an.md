...
`print(result)` render. See `moirais.fn.describe('gan_an')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gan_an import *
import numpy as np
# See the function signature in fn/gan_an.py for argument names.
```
