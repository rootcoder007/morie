...
`print(result)` render. See `moirais.fn.describe('arimax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arimax import *
import numpy as np
# See the function signature in fn/arimax.py for argument names.
```
