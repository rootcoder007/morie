...
`print(result)` render. See `moirais.fn.describe('icafn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icafn import *
import numpy as np
# See the function signature in fn/icafn.py for argument names.
```
