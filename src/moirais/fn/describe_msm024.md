# describe('msm024') — mvsml_linear_mixed_models_eq_5_3
...
`print(result)` render. See `moirais.fn.describe('msm024')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm024 import *
import numpy as np
# See the function signature in fn/msm024.py for argument names.
```
