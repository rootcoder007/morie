# describe('cmlmer') — compressed_lmm
...
`print(result)` render. See `moirais.fn.describe('cmlmer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmlmer import *
import numpy as np
# See the function signature in fn/cmlmer.py for argument names.
```
