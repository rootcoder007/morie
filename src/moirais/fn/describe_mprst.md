# describe('mprst') — matching_pursuit_fn
...
`print(result)` render. See `moirais.fn.describe('mprst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mprst import *
import numpy as np
# See the function signature in fn/mprst.py for argument names.
```
