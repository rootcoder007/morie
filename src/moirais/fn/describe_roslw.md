...
`print(result)` render. See `moirais.fn.describe('roslw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.roslw import *
import numpy as np
# See the function signature in fn/roslw.py for argument names.
```
