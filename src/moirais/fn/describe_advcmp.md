# describe('advcmp') — advanced_composition
...
`print(result)` render. See `moirais.fn.describe('advcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.advcmp import *
import numpy as np
# See the function signature in fn/advcmp.py for argument names.
```
