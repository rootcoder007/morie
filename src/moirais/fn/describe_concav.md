...
`print(result)` render. See `moirais.fn.describe('concav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.concav import *
import numpy as np
# See the function signature in fn/concav.py for argument names.
```
