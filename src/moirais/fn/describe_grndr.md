# describe('grndr') — grenander_estimator
...
`print(result)` render. See `moirais.fn.describe('grndr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grndr import *
import numpy as np
# See the function signature in fn/grndr.py for argument names.
```
