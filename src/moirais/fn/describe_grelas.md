# describe('grelas') — geron_elastic_net_cost
...
`print(result)` render. See `moirais.fn.describe('grelas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grelas import *
import numpy as np
# See the function signature in fn/grelas.py for argument names.
```
