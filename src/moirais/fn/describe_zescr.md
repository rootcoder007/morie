# describe('zescr') — spatial_cure_rate
...
`print(result)` render. See `moirais.fn.describe('zescr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zescr import *
import numpy as np
# See the function signature in fn/zescr.py for argument names.
```
