# describe('gh_c13_2') — ghosal_surv_dp_km
...
`print(result)` render. See `moirais.fn.describe('gh_c13_2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_2 import *
import numpy as np
# See the function signature in fn/gh_c13_2.py for argument names.
```
