...
`print(result)` render. See `moirais.fn.describe('gdlbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdlbr import *
import numpy as np
# See the function signature in fn/gdlbr.py for argument names.
```
