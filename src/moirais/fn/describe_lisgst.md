...
`print(result)` render. See `moirais.fn.describe('lisgst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lisgst import *
import numpy as np
# See the function signature in fn/lisgst.py for argument names.
```
