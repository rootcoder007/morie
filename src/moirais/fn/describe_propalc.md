# describe('propalc') — proportional_allocation
...
`print(result)` render. See `moirais.fn.describe('propalc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propalc import *
import numpy as np
# See the function signature in fn/propalc.py for argument names.
```
