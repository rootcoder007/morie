...
__all__ = ["bivand2013_chapter_2_unnumbered_25"]


def bivand2013_chapter_2_unnumbered_25(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +init=epsg:4230 +proj=longlat +ellps=intl
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u25')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u25: GeneralStatistics expression (auto-extracted; see ref)."
