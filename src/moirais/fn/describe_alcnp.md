# describe('alcnp') — alammar_chain_prompting
...
`print(result)` render. See `moirais.fn.describe('alcnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alcnp import *
import numpy as np
# See the function signature in fn/alcnp.py for argument names.
```
