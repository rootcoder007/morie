# describe('causrddh') — causal_rdd_imbens_kalyanaraman
...
`print(result)` render. See `moirais.fn.describe('causrddh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrddh import *
import numpy as np
# See the function signature in fn/causrddh.py for argument names.
```
