# describe('acvent') — differential_entropy
...
`print(result)` render. See `moirais.fn.describe('acvent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acvent import *
import numpy as np
# See the function signature in fn/acvent.py for argument names.
```
