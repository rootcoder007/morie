# describe('mlkem') — mlkem768_keygen
...
`print(result)` render. See `moirais.fn.describe('mlkem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlkem import *
import numpy as np
# See the function signature in fn/mlkem.py for argument names.
```
