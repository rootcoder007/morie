# describe('ghs024') — ghosal_ch3_tailfree_canonical_summability
...
`print(result)` render. See `moirais.fn.describe('ghs024')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs024 import *
import numpy as np
# See the function signature in fn/ghs024.py for argument names.
```
