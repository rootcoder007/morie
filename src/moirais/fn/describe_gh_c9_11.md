# describe('gh_c9_11') — ghosal_icens_dp_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c9_11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c9_11 import *
import numpy as np
# See the function signature in fn/gh_c9_11.py for argument names.
```
