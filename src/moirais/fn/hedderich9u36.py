...
__all__ = ["hedderich_chapter_9_unnumbered_36"]


def hedderich_chapter_9_unnumbered_36(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (n + 1) + (n + 1) + (n + 1) + . . . + (n + 1) + (n + 1) = n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u36')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u36: GeneralStatistics expression (auto-extracted; see ref)."
