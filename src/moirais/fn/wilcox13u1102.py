...
__all__ = ["wilcox_chapter_13_unnumbered_1102"]


def wilcox_chapter_13_unnumbered_1102(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: will test H0: β 2 =β 4 =β 7 = 0. The R function
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1102')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1102: GeneralStatistics expression (auto-extracted; see ref)."
