# describe('svclr') — condorcet_loser
...
`print(result)` render. See `moirais.fn.describe('svclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclr import *
import numpy as np
# See the function signature in fn/svclr.py for argument names.
```
