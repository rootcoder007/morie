# describe('msm151') — mvsml_categorical_count_eq_8_11
...
`print(result)` render. See `moirais.fn.describe('msm151')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm151 import *
import numpy as np
# See the function signature in fn/msm151.py for argument names.
```
