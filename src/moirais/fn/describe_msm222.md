# describe('msm222') — mvsml_ridge_lasso_elastic_eq_9_37
...
`print(result)` render. See `moirais.fn.describe('msm222')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm222 import *
import numpy as np
# See the function signature in fn/msm222.py for argument names.
```
