...
`print(result)` render. See `moirais.fn.describe('ismul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ismul import *
import numpy as np
# See the function signature in fn/ismul.py for argument names.
```
