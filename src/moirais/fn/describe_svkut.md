...
`print(result)` render. See `moirais.fn.describe('svkut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svkut import *
import numpy as np
# See the function signature in fn/svkut.py for argument names.
```
