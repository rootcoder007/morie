...
`print(result)` render. See `moirais.fn.describe('gchad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gchad import *
import numpy as np
# See the function signature in fn/gchad.py for argument names.
```
