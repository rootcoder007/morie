...
`print(result)` render. See `moirais.fn.describe('gwrbisq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrbisq import *
import numpy as np
# See the function signature in fn/gwrbisq.py for argument names.
```
