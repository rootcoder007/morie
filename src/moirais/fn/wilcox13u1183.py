...
__all__ = ["wilcox_chapter_13_unnumbered_1183"]


def wilcox_chapter_13_unnumbered_1183(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: sm2strv7(x,y,regfun=tsreg,nboot=500,alpha=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1183')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1183: GeneralStatistics expression (auto-extracted; see ref)."
