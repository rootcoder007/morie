...
`print(result)` render. See `moirais.fn.describe('seeby')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seeby import *
import numpy as np
# See the function signature in fn/seeby.py for argument names.
```
