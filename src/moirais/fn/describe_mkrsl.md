...
`print(result)` render. See `moirais.fn.describe('mkrsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mkrsl import *
import numpy as np
# See the function signature in fn/mkrsl.py for argument names.
```
