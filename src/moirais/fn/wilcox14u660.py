...
__all__ = ["wilcox_chapter_14_unnumbered_660"]


def wilcox_chapter_14_unnumbered_660(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: cision Rule : Reject H0 if F ≥ f , the 1 − α quantile of an
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u660')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u660: GeneralStatistics expression (auto-extracted; see ref)."
