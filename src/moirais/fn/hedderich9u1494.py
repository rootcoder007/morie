...
__all__ = ["hedderich_chapter_9_unnumbered_1494"]


def hedderich_chapter_9_unnumbered_1494(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: and ν1 =n−1, ν2 =n(k−1) degrees of freedom
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1494')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1494: PowerAndDesign expression (auto-extracted; see ref)."
