...
__all__ = ["hedderich_chapter_9_unnumbered_1137"]


def hedderich_chapter_9_unnumbered_1137(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.592−0.350 = 0.242> 0.196 = 0.350−0.154).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1137')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1137: GeneralStatistics expression (auto-extracted; see ref)."
