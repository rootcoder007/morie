...
__all__ = ["wilcox_chapter_13_unnumbered_1097"]


def wilcox_chapter_13_unnumbered_1097(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] D = (0 − ˆβ )S−1 (0 − ˆβ )′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1097')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1097: Resampling expression (auto-extracted; see ref)."
