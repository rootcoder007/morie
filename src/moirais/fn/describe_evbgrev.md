# describe('evbgrev') — evt_bayes_gev
...
`print(result)` render. See `moirais.fn.describe('evbgrev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evbgrev import *
import numpy as np
# See the function signature in fn/evbgrev.py for argument names.
```
