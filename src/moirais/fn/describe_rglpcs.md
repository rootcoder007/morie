# describe('rglpcs') — rangayyan_lpc_synthesis
...
`print(result)` render. See `moirais.fn.describe('rglpcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglpcs import *
import numpy as np
# See the function signature in fn/rglpcs.py for argument names.
```
