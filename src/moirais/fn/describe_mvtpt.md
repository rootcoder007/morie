...
`print(result)` render. See `moirais.fn.describe('mvtpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtpt import *
import numpy as np
# See the function signature in fn/mvtpt.py for argument names.
```
