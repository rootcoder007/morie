# describe('posem') — posem

## WHAT IT DOES

rPositional encoding (sinusoidal).
...
`print(result)` render. See `moirais.fn.describe('posem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.posem import *
import numpy as np
# See the function signature in fn/posem.py for argument names.
```
