# describe('sgtlpi') — sgt_laplacian_pseudoinverse
...
`print(result)` render. See `moirais.fn.describe('sgtlpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtlpi import *
import numpy as np
# See the function signature in fn/sgtlpi.py for argument names.
```
