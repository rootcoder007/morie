# describe('bkcgr') — burkov_computational_graph
...
`print(result)` render. See `moirais.fn.describe('bkcgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkcgr import *
import numpy as np
# See the function signature in fn/bkcgr.py for argument names.
```
