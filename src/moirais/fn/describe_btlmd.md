...
`print(result)` render. See `moirais.fn.describe('btlmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btlmd import *
import numpy as np
# See the function signature in fn/btlmd.py for argument names.
```
