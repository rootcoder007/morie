# describe('opred') — opred

## WHAT IT DOES

Spatial redistricting
...
`print(result)` render. See `moirais.fn.describe('opred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opred import *
import numpy as np
# See the function signature in fn/opred.py for argument names.
```
