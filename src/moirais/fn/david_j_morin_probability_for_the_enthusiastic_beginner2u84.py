...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_unnumbered_84(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner2u84')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner2u84: Dispersion expression (auto-extracted; see ref)."
