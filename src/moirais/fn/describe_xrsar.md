...
`print(result)` render. See `moirais.fn.describe('xrsar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrsar import *
import numpy as np
# See the function signature in fn/xrsar.py for argument names.
```
