...
`print(result)` render. See `moirais.fn.describe('mdcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdcov import *
import numpy as np
# See the function signature in fn/mdcov.py for argument names.
```
