# describe('funBand') — functional_band
...
`print(result)` render. See `moirais.fn.describe('funBand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funBand import *
import numpy as np
# See the function signature in fn/funBand.py for argument names.
```
