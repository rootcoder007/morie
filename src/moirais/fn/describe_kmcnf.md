...
`print(result)` render. See `moirais.fn.describe('kmcnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcnf import *
import numpy as np
# See the function signature in fn/kmcnf.py for argument names.
```
