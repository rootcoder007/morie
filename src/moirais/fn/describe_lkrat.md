# describe('lkrat') — likelihood_ratio
...
`print(result)` render. See `moirais.fn.describe('lkrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lkrat import *
import numpy as np
# See the function signature in fn/lkrat.py for argument names.
```
