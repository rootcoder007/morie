# describe('dwtA') — discrete_wavelet_anomaly
...
`print(result)` render. See `moirais.fn.describe('dwtA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwtA import *
import numpy as np
# See the function signature in fn/dwtA.py for argument names.
```
