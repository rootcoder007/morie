...
__all__ = ["hedderich_chapter_9_unnumbered_2483"]


def hedderich_chapter_9_unnumbered_2483(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ¯RContr. = 12.5 ¯R1 = 6.4 ¯R2 = 5.8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2483')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2483: GeneralStatistics expression (auto-extracted; see ref)."
