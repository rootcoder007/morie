# describe('fzcov2') — fauzi_cov_surv_est2
...
`print(result)` render. See `moirais.fn.describe('fzcov2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzcov2 import *
import numpy as np
# See the function signature in fn/fzcov2.py for argument names.
```
