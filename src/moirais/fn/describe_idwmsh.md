...
`print(result)` render. See `moirais.fn.describe('idwmsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwmsh import *
import numpy as np
# See the function signature in fn/idwmsh.py for argument names.
```
