...
`print(result)` render. See `moirais.fn.describe('svbnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svbnk import *
import numpy as np
# See the function signature in fn/svbnk.py for argument names.
```
