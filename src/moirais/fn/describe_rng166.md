# describe('rng166') — rangayyan_ch3_rls_theta_vector
...
`print(result)` render. See `moirais.fn.describe('rng166')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng166 import *
import numpy as np
# See the function signature in fn/rng166.py for argument names.
```
