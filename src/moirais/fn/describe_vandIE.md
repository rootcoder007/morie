# describe('vandIE') — vanderweele_decomposition
...
`print(result)` render. See `moirais.fn.describe('vandIE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vandIE import *
import numpy as np
# See the function signature in fn/vandIE.py for argument names.
```
