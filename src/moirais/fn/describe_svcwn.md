# describe('svcwn') — condorcet_winner
...
`print(result)` render. See `moirais.fn.describe('svcwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcwn import *
import numpy as np
# See the function signature in fn/svcwn.py for argument names.
```
