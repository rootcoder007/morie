...
`print(result)` render. See `moirais.fn.describe('uniona')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.uniona import *
import numpy as np
# See the function signature in fn/uniona.py for argument names.
```
