# describe('detrbb') — detr_set_prediction
...
`print(result)` render. See `moirais.fn.describe('detrbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.detrbb import *
import numpy as np
# See the function signature in fn/detrbb.py for argument names.
```
