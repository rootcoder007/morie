...
`print(result)` render. See `moirais.fn.describe('spcpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcpow import *
import numpy as np
# See the function signature in fn/spcpow.py for argument names.
```
