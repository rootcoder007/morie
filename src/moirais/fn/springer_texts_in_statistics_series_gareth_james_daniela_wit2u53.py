...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_53"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_53(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆδk(x)= x· ˆμk
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit2u53')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit2u53: GeneralStatistics expression (auto-extracted; see ref)."
