...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1497"]


def guide_on_data_analysis_chapter_30_unnumbered_1497(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -4 x cohort = 7 -0.43 (0.66)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1497')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1497: GeneralStatistics expression (auto-extracted; see ref)."
