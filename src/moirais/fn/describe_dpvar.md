...
`print(result)` render. See `moirais.fn.describe('dpvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpvar import *
import numpy as np
# See the function signature in fn/dpvar.py for argument names.
```
