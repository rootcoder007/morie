...
__all__ = ["bivand2013_chapter_2_unnumbered_30"]


def bivand2013_chapter_2_unnumbered_30(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > CRS("+init=epsg:2163")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u30')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u30: GeneralStatistics expression (auto-extracted; see ref)."
