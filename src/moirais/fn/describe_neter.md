...
`print(result)` render. See `moirais.fn.describe('neter')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neter import *
import numpy as np
# See the function signature in fn/neter.py for argument names.
```
