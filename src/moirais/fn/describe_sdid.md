...
`print(result)` render. See `moirais.fn.describe('sdid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdid import *
import numpy as np
# See the function signature in fn/sdid.py for argument names.
```
