# describe('kolcm') — kolmogorov_complexity
...
`print(result)` render. See `moirais.fn.describe('kolcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kolcm import *
import numpy as np
# See the function signature in fn/kolcm.py for argument names.
```
