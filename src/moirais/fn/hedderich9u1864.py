...
__all__ = ["hedderich_chapter_9_unnumbered_1864"]


def hedderich_chapter_9_unnumbered_1864(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µ=γ=c0 against HA : σ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1864')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1864: GeneralStatistics expression (auto-extracted; see ref)."
