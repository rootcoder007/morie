# describe('ginicop') — ginis_gamma_copula
...
`print(result)` render. See `moirais.fn.describe('ginicop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ginicop import *
import numpy as np
# See the function signature in fn/ginicop.py for argument names.
```
