...
__all__ = ["hedderich_chapter_9_unnumbered_580"]


def hedderich_chapter_9_unnumbered_580(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and accordingly: P (|X−µ|< 3σ)≥0.9506
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u580')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u580: GeneralStatistics expression (auto-extracted; see ref)."
