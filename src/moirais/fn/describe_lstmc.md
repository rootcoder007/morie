...
`print(result)` render. See `moirais.fn.describe('lstmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lstmc import *
import numpy as np
# See the function signature in fn/lstmc.py for argument names.
```
