...
`print(result)` render. See `moirais.fn.describe('oaipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oaipw import *
import numpy as np
# See the function signature in fn/oaipw.py for argument names.
```
