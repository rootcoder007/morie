...
`print(result)` render. See `moirais.fn.describe('tmlsbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsbg import *
import numpy as np
# See the function signature in fn/tmlsbg.py for argument names.
```
