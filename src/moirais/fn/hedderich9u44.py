...
__all__ = ["hedderich_chapter_9_unnumbered_44"]


def hedderich_chapter_9_unnumbered_44(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u44')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u44: PowerAndDesign expression (auto-extracted; see ref)."
