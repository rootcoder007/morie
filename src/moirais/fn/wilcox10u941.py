...
__all__ = ["wilcox_chapter_10_unnumbered_941"]


def wilcox_chapter_10_unnumbered_941(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u941')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u941: GeneralStatistics expression (auto-extracted; see ref)."
