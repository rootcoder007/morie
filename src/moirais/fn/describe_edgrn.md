...
`print(result)` render. See `moirais.fn.describe('edgrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.edgrn import *
import numpy as np
# See the function signature in fn/edgrn.py for argument names.
```
