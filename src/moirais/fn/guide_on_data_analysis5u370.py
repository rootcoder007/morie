...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_370"]


def guide_on_data_analysis_chapter_5_unnumbered_370(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u370')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u370: GeneralStatistics expression (auto-extracted; see ref)."
