...
`print(result)` render. See `moirais.fn.describe('svasp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svasp import *
import numpy as np
# See the function signature in fn/svasp.py for argument names.
```
