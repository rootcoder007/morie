# describe('msm031') — mvsml_linear_mixed_models_eq_5_5
...
`print(result)` render. See `moirais.fn.describe('msm031')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm031 import *
import numpy as np
# See the function signature in fn/msm031.py for argument names.
```
