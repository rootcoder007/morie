...
__all__ = ["hedderich_chapter_9_unnumbered_2231"]


def hedderich_chapter_9_unnumbered_2231(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Withx=50 and y=30, ˆz=2, 212 > 1, 96 = z1−α/2 (p=0, 027, two-sided) results, indicating a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2231')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2231: GeneralStatistics expression (auto-extracted; see ref)."
