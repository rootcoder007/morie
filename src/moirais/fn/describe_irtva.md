# describe('irtva') — irt_variance_legislator
...
`print(result)` render. See `moirais.fn.describe('irtva')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtva import *
import numpy as np
# See the function signature in fn/irtva.py for argument names.
```
