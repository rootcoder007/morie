...
`print(result)` render. See `moirais.fn.describe('sdmr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmr2 import *
import numpy as np
# See the function signature in fn/sdmr2.py for argument names.
```
