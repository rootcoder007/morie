...
`print(result)` render. See `moirais.fn.describe('glmmsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmsim import *
import numpy as np
# See the function signature in fn/glmmsim.py for argument names.
```
