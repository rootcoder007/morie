...
__all__ = ["law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_5"]


def law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_5(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] EVT = .5($100) + .5($0) - $20 = $30.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u5')`` for the full guide.
...
def cheatsheet():
    return "law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u5: GeneralStatistics expression (auto-extracted; see ref)."
