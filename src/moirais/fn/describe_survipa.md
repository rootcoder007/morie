...
`print(result)` render. See `moirais.fn.describe('survipa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survipa import *
import numpy as np
# See the function signature in fn/survipa.py for argument names.
```
