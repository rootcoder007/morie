# describe('msm161') — mvsml_ridge_lasso_elastic_eq_9_1
...
`print(result)` render. See `moirais.fn.describe('msm161')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm161 import *
import numpy as np
# See the function signature in fn/msm161.py for argument names.
```
