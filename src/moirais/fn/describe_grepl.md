# describe('grepl') — geron_epsilon_greedy
...
`print(result)` render. See `moirais.fn.describe('grepl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grepl import *
import numpy as np
# See the function signature in fn/grepl.py for argument names.
```
