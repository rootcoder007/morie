...
__all__ = ["hedderich_chapter_9_unnumbered_2226"]


def hedderich_chapter_9_unnumbered_2226(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: count 1 = 6 , expectedcount 1 = 11 , p− value = 0 .0 5 2 48
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2226')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2226: CountModels expression (auto-extracted; see ref)."
