...
__all__ = ["wilcox_chapter_14_unnumbered_755"]


def wilcox_chapter_14_unnumbered_755(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] T = −3( N + 1) + 12
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u755')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u755: GeneralStatistics expression (auto-extracted; see ref)."
