# describe('alfqud') — alphadev_quicksort_disc
...
`print(result)` render. See `moirais.fn.describe('alfqud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfqud import *
import numpy as np
# See the function signature in fn/alfqud.py for argument names.
```
