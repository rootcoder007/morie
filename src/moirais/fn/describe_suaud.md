...
`print(result)` render. See `moirais.fn.describe('suaud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suaud import *
import numpy as np
# See the function signature in fn/suaud.py for argument names.
```
