# describe('fzmgkd') — fauzi_modified_gamma_kde
...
`print(result)` render. See `moirais.fn.describe('fzmgkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmgkd import *
import numpy as np
# See the function signature in fn/fzmgkd.py for argument names.
```
