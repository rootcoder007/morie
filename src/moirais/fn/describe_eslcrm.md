# describe('eslcrm') — esl_cross_entropy
...
`print(result)` render. See `moirais.fn.describe('eslcrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslcrm import *
import numpy as np
# See the function signature in fn/eslcrm.py for argument names.
```
