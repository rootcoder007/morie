...
`print(result)` render. See `moirais.fn.describe('romg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.romg2 import *
import numpy as np
# See the function signature in fn/romg2.py for argument names.
```
