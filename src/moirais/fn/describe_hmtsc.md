# describe('hmtsc') — geron_torchscript
...
`print(result)` render. See `moirais.fn.describe('hmtsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtsc import *
import numpy as np
# See the function signature in fn/hmtsc.py for argument names.
```
