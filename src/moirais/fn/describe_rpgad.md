# describe('rpgad') — rdp_to_eps_delta
...
`print(result)` render. See `moirais.fn.describe('rpgad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpgad import *
import numpy as np
# See the function signature in fn/rpgad.py for argument names.
```
