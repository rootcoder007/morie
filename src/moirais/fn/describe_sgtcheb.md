# describe('sgtcheb') — sgt_cheeger_bound
...
`print(result)` render. See `moirais.fn.describe('sgtcheb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtcheb import *
import numpy as np
# See the function signature in fn/sgtcheb.py for argument names.
```
