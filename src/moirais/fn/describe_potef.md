# describe('potef') — potential_outcomes_individual
...
`print(result)` render. See `moirais.fn.describe('potef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.potef import *
import numpy as np
# See the function signature in fn/potef.py for argument names.
```
