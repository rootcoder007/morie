# describe('wsmnpb') — wasserman_nonparametric_boot
...
`print(result)` render. See `moirais.fn.describe('wsmnpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmnpb import *
import numpy as np
# See the function signature in fn/wsmnpb.py for argument names.
```
