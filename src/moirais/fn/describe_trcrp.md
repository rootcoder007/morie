...
`print(result)` render. See `moirais.fn.describe('trcrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcrp import *
import numpy as np
# See the function signature in fn/trcrp.py for argument names.
```
