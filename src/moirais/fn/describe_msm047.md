# describe('msm047') — mvsml_bayesian_regression_eq_6_2
...
`print(result)` render. See `moirais.fn.describe('msm047')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm047 import *
import numpy as np
# See the function signature in fn/msm047.py for argument names.
```
