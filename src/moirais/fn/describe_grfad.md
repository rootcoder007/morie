# describe('grfad') — geron_forward_mode_autodiff
...
`print(result)` render. See `moirais.fn.describe('grfad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grfad import *
import numpy as np
# See the function signature in fn/grfad.py for argument names.
```
