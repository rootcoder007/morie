# describe('rng072') — rangayyan_ch3_dft_via_twiddle
...
`print(result)` render. See `moirais.fn.describe('rng072')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng072 import *
import numpy as np
# See the function signature in fn/rng072.py for argument names.
```
