...
`print(result)` render. See `moirais.fn.describe('lmsarma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmsarma import *
import numpy as np
# See the function signature in fn/lmsarma.py for argument names.
```
