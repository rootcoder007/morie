...
`print(result)` render. See `moirais.fn.describe('trrds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trrds import *
import numpy as np
# See the function signature in fn/trrds.py for argument names.
```
