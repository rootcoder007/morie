...
`print(result)` render. See `moirais.fn.describe('eslbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslbic import *
import numpy as np
# See the function signature in fn/eslbic.py for argument names.
```
