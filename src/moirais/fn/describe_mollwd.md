...
`print(result)` render. See `moirais.fn.describe('mollwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mollwd import *
import numpy as np
# See the function signature in fn/mollwd.py for argument names.
```
