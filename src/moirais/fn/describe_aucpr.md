...
`print(result)` render. See `moirais.fn.describe('aucpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aucpr import *
import numpy as np
# See the function signature in fn/aucpr.py for argument names.
```
