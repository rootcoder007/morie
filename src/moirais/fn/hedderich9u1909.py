...
__all__ = ["hedderich_chapter_9_unnumbered_1909"]


def hedderich_chapter_9_unnumbered_1909(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] e.g. P (X ≥4|λ = 1) < 0.05; because P (X ≥4|λ = 1) = P (X = 4 |λ =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1909')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1909: GeneralStatistics expression (auto-extracted; see ref)."
