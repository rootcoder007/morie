...
`print(result)` render. See `moirais.fn.describe('opcom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opcom import *
import numpy as np
# See the function signature in fn/opcom.py for argument names.
```
