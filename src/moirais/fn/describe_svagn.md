...
`print(result)` render. See `moirais.fn.describe('svagn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svagn import *
import numpy as np
# See the function signature in fn/svagn.py for argument names.
```
