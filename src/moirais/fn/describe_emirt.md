# describe('emirt') — em_irt_estimate
...
`print(result)` render. See `moirais.fn.describe('emirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emirt import *
import numpy as np
# See the function signature in fn/emirt.py for argument names.
```
