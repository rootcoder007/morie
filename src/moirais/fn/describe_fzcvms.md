# describe('fzcvms') — fauzi_cvm_statistic
...
`print(result)` render. See `moirais.fn.describe('fzcvms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzcvms import *
import numpy as np
# See the function signature in fn/fzcvms.py for argument names.
```
