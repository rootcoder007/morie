...
`print(result)` render. See `moirais.fn.describe('autoI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.autoI import *
import numpy as np
# See the function signature in fn/autoI.py for argument names.
```
