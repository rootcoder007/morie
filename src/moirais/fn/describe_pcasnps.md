...
`print(result)` render. See `moirais.fn.describe('pcasnps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcasnps import *
import numpy as np
# See the function signature in fn/pcasnps.py for argument names.
```
