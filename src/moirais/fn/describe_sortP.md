...
`print(result)` render. See `moirais.fn.describe('sortP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sortP import *
import numpy as np
# See the function signature in fn/sortP.py for argument names.
```
