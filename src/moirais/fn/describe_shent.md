# describe('shent') — shannon_entropy
...
`print(result)` render. See `moirais.fn.describe('shent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shent import *
import numpy as np
# See the function signature in fn/shent.py for argument names.
```
