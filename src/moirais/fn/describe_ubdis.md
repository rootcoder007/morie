...
`print(result)` render. See `moirais.fn.describe('ubdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubdis import *
import numpy as np
# See the function signature in fn/ubdis.py for argument names.
```
