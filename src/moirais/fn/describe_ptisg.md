# describe('ptisg') — isotropic_guard
...
`print(result)` render. See `moirais.fn.describe('ptisg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptisg import *
import numpy as np
# See the function signature in fn/ptisg.py for argument names.
```
