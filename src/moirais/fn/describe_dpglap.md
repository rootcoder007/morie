# describe('dpglap') — dp_laplace_mechanism
...
`print(result)` render. See `moirais.fn.describe('dpglap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpglap import *
import numpy as np
# See the function signature in fn/dpglap.py for argument names.
```
