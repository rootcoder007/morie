...
`print(result)` render. See `moirais.fn.describe('mtpgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtpgr import *
import numpy as np
# See the function signature in fn/mtpgr.py for argument names.
```
