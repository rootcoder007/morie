# describe('matr') — ma_two_step_dl_he
...
`print(result)` render. See `moirais.fn.describe('matr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matr import *
import numpy as np
# See the function signature in fn/matr.py for argument names.
```
