...
`print(result)` render. See `moirais.fn.describe('tvorl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tvorl import *
import numpy as np
# See the function signature in fn/tvorl.py for argument names.
```
