...
__all__ = ["hedderich_chapter_9_unnumbered_2397"]


def hedderich_chapter_9_unnumbered_2397(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Given are ¯x1 = 9.43, ¯x2 = 6.59 and ¯x3 = 4.06, i.e. k = 3 ,n1 = n2 = n3 = 10 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2397')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2397: GeneralStatistics expression (auto-extracted; see ref)."
