# describe('hmpcac') — geron_principal_components
...
`print(result)` render. See `moirais.fn.describe('hmpcac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpcac import *
import numpy as np
# See the function signature in fn/hmpcac.py for argument names.
```
