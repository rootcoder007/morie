...
`print(result)` render. See `moirais.fn.describe('crpgib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crpgib import *
import numpy as np
# See the function signature in fn/crpgib.py for argument names.
```
