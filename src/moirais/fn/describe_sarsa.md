...
`print(result)` render. See `moirais.fn.describe('sarsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarsa import *
import numpy as np
# See the function signature in fn/sarsa.py for argument names.
```
