...
`print(result)` render. See `moirais.fn.describe('rudwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rudwn import *
import numpy as np
# See the function signature in fn/rudwn.py for argument names.
```
