# describe('tnie') — total_natural_indirect_effect
...
`print(result)` render. See `moirais.fn.describe('tnie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tnie import *
import numpy as np
# See the function signature in fn/tnie.py for argument names.
```
