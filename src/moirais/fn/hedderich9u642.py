...
__all__ = ["hedderich_chapter_9_unnumbered_642"]


def hedderich_chapter_9_unnumbered_642(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u642')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u642: CountModels expression (auto-extracted; see ref)."
