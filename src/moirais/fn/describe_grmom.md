# describe('grmom') — geron_momentum_update
...
`print(result)` render. See `moirais.fn.describe('grmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmom import *
import numpy as np
# See the function signature in fn/grmom.py for argument names.
```
