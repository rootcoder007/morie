# describe('gb_rnk') — gibbons_rank_def
...
`print(result)` render. See `moirais.fn.describe('gb_rnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_rnk import *
import numpy as np
# See the function signature in fn/gb_rnk.py for argument names.
```
