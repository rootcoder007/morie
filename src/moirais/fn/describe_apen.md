...
`print(result)` render. See `moirais.fn.describe('apen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apen import *
import numpy as np
# See the function signature in fn/apen.py for argument names.
```
