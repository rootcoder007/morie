# describe('gh_crm_def') — ghosal_completely_random_measure
...
`print(result)` render. See `moirais.fn.describe('gh_crm_def')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_crm_def import *
import numpy as np
# See the function signature in fn/gh_crm_def.py for argument names.
```
