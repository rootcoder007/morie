# describe('bnorm') — bayesian_normal
...
`print(result)` render. See `moirais.fn.describe('bnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnorm import *
import numpy as np
# See the function signature in fn/bnorm.py for argument names.
```
