# describe('simth') — simulate_thermometer
...
`print(result)` render. See `moirais.fn.describe('simth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simth import *
import numpy as np
# See the function signature in fn/simth.py for argument names.
```
