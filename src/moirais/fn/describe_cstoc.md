# describe('cstoc') — custody_occupancy
...
`print(result)` render. See `moirais.fn.describe('cstoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstoc import *
import numpy as np
# See the function signature in fn/cstoc.py for argument names.
```
