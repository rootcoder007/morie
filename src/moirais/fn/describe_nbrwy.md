...
`print(result)` render. See `moirais.fn.describe('nbrwy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbrwy import *
import numpy as np
# See the function signature in fn/nbrwy.py for argument names.
```
