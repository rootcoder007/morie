...
__all__ = ["hedderich_chapter_9_unnumbered_244"]


def hedderich_chapter_9_unnumbered_244(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1.5·0.6 = 0.9487 ; 0 .9487−1 =−0.0513 or −5.13%
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u244')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u244: GeneralStatistics expression (auto-extracted; see ref)."
