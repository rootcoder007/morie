...
`print(result)` render. See `moirais.fn.describe('clump')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clump import *
import numpy as np
# See the function signature in fn/clump.py for argument names.
```
