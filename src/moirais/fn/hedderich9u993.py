...
__all__ = ["hedderich_chapter_9_unnumbered_993"]


def hedderich_chapter_9_unnumbered_993(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ν,λ (λ>0) results in:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u993')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u993: GeneralStatistics expression (auto-extracted; see ref)."
