# describe('gb_wt2') — gibbons_ww_two_samp_runs
...
`print(result)` render. See `moirais.fn.describe('gb_wt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wt2 import *
import numpy as np
# See the function signature in fn/gb_wt2.py for argument names.
```
