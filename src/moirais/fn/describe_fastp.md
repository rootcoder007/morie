...
`print(result)` render. See `moirais.fn.describe('fastp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fastp import *
import numpy as np
# See the function signature in fn/fastp.py for argument names.
```
