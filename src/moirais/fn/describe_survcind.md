# describe('survcind') — survival_concordance
...
`print(result)` render. See `moirais.fn.describe('survcind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survcind import *
import numpy as np
# See the function signature in fn/survcind.py for argument names.
```
