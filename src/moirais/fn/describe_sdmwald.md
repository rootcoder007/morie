...
`print(result)` render. See `moirais.fn.describe('sdmwald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmwald import *
import numpy as np
# See the function signature in fn/sdmwald.py for argument names.
```
