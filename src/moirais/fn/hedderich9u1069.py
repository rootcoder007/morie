...
__all__ = ["hedderich_chapter_9_unnumbered_1069"]


def hedderich_chapter_9_unnumbered_1069(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =E(X 2)−2µE(X) +µ2 =E(X 2)−2µ2 +µ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1069')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1069: GeneralStatistics expression (auto-extracted; see ref)."
