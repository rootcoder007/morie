# describe('icc3k') — icc_two_way_mixed_avg
...
`print(result)` render. See `moirais.fn.describe('icc3k')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc3k import *
import numpy as np
# See the function signature in fn/icc3k.py for argument names.
```
