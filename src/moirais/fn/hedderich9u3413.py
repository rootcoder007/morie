...
__all__ = ["hedderich_chapter_9_unnumbered_3413"]


def hedderich_chapter_9_unnumbered_3413(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i=1(yi−ˆλi) = 0 only applies if a constant term is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3413')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3413: GeneralStatistics expression (auto-extracted; see ref)."
