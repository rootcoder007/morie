# describe('ocnrm') — oc_normal_vector
...
`print(result)` render. See `moirais.fn.describe('ocnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocnrm import *
import numpy as np
# See the function signature in fn/ocnrm.py for argument names.
```
