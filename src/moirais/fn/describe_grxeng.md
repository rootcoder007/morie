# describe('grxeng') — geron_softmax_cost_gradient
...
`print(result)` render. See `moirais.fn.describe('grxeng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grxeng import *
import numpy as np
# See the function signature in fn/grxeng.py for argument names.
```
