# describe('eac_ipw') — run_ebac_selection_ipw_analysis
...
`print(result)` render. See `moirais.fn.describe('eac_ipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eac_ipw import *
import numpy as np
# See the function signature in fn/eac_ipw.py for argument names.
```
