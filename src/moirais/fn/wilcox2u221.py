...
__all__ = ["wilcox_chapter_2_unnumbered_221"]


def wilcox_chapter_2_unnumbered_221(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: trials is 0.0207. So if we set k − 1 = 5, in which case k = 6 and n − k + 1 = 20 − 6 + 1 = 15,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u221')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u221: PowerAndDesign expression (auto-extracted; see ref)."
