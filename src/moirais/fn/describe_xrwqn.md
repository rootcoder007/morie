...
`print(result)` render. See `moirais.fn.describe('xrwqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwqn import *
import numpy as np
# See the function signature in fn/xrwqn.py for argument names.
```
