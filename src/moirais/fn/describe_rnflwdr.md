...
`print(result)` render. See `moirais.fn.describe('rnflwdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnflwdr import *
import numpy as np
# See the function signature in fn/rnflwdr.py for argument names.
```
