...
__all__ = ["hedderich_chapter_9_unnumbered_3273"]


def hedderich_chapter_9_unnumbered_3273(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( 1 : 2 0 , c ( " one " , " bodywt " , " brainwt " ) ) ) ; p <− 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3273')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3273: GeneralStatistics expression (auto-extracted; see ref)."
