# describe('bbeta') — bayesian_beta_binomial
...
`print(result)` render. See `moirais.fn.describe('bbeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbeta import *
import numpy as np
# See the function signature in fn/bbeta.py for argument names.
```
