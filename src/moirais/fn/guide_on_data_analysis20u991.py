...
__all__ = ["guide_on_data_analysis_chapter_20_unnumbered_991"]


def guide_on_data_analysis_chapter_20_unnumbered_991(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌 = 𝑋𝛽0 + 𝜀unless 𝔼[𝜀 ∣ 𝑋] = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis20u991')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis20u991: GeneralStatistics expression (auto-extracted; see ref)."
