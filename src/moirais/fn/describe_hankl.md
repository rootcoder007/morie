# describe('hankl') — hankel_matrix_fn
...
`print(result)` render. See `moirais.fn.describe('hankl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hankl import *
import numpy as np
# See the function signature in fn/hankl.py for argument names.
```
