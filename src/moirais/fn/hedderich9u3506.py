...
__all__ = ["hedderich_chapter_9_unnumbered_3506"]


def hedderich_chapter_9_unnumbered_3506(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Y|b∼N (Xβ + Zb, σ2I)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3506')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3506: GeneralStatistics expression (auto-extracted; see ref)."
