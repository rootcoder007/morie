...
__all__ = ["wilcox_chapter_15_unnumbered_1391"]


def wilcox_chapter_15_unnumbered_1391(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α ν = 19 ν = 24 ν = 29 ν = 39 ν = 59
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1391')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1391: GeneralStatistics expression (auto-extracted; see ref)."
