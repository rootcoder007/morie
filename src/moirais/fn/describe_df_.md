...
`print(result)` render. See `moirais.fn.describe('df_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.df_ import *
import numpy as np
# See the function signature in fn/df_.py for argument names.
```
