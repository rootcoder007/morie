# describe('rndsr') — random_search_cv
...
`print(result)` render. See `moirais.fn.describe('rndsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndsr import *
import numpy as np
# See the function signature in fn/rndsr.py for argument names.
```
