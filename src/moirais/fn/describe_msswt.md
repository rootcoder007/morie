# describe('msswt') — missing_data_weights
...
`print(result)` render. See `moirais.fn.describe('msswt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msswt import *
import numpy as np
# See the function signature in fn/msswt.py for argument names.
```
