# describe('vgjck') — vario_jackknife
...
`print(result)` render. See `moirais.fn.describe('vgjck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgjck import *
import numpy as np
# See the function signature in fn/vgjck.py for argument names.
```
