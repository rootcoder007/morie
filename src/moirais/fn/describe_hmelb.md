...
`print(result)` render. See `moirais.fn.describe('hmelb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmelb import *
import numpy as np
# See the function signature in fn/hmelb.py for argument names.
```
