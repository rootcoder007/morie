...
__all__ = ["wilcox_chapter_8_unnumbered_841"]


def wilcox_chapter_8_unnumbered_841(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯X1. = 240 + 230 + 200
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u841')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u841: GeneralStatistics expression (auto-extracted; see ref)."
