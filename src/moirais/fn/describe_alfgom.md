# describe('alfgom') — alphago_montecarlo
...
`print(result)` render. See `moirais.fn.describe('alfgom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfgom import *
import numpy as np
# See the function signature in fn/alfgom.py for argument names.
```
