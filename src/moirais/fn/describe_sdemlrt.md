...
`print(result)` render. See `moirais.fn.describe('sdemlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemlrt import *
import numpy as np
# See the function signature in fn/sdemlrt.py for argument names.
```
