# describe('gb1061m') — gibbons_jt_moments
...
`print(result)` render. See `moirais.fn.describe('gb1061m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1061m import *
import numpy as np
# See the function signature in fn/gb1061m.py for argument names.
```
