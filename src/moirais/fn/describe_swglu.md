...
`print(result)` render. See `moirais.fn.describe('swglu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swglu import *
import numpy as np
# See the function signature in fn/swglu.py for argument names.
```
