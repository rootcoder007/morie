# describe('fctvt') — factor_convert_levels
...
`print(result)` render. See `moirais.fn.describe('fctvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fctvt import *
import numpy as np
# See the function signature in fn/fctvt.py for argument names.
```
