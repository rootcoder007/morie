# describe('btpct') — boot_percentile_ci
...
`print(result)` render. See `moirais.fn.describe('btpct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btpct import *
import numpy as np
# See the function signature in fn/btpct.py for argument names.
```
