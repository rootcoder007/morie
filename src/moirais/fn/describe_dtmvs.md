...
`print(result)` render. See `moirais.fn.describe('dtmvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtmvs import *
import numpy as np
# See the function signature in fn/dtmvs.py for argument names.
```
