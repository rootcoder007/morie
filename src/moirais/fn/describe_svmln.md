...
`print(result)` render. See `moirais.fn.describe('svmln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmln import *
import numpy as np
# See the function signature in fn/svmln.py for argument names.
```
