...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_882"]


def guide_on_data_analysis_chapter_14_unnumbered_882(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 1 −(𝑛 − 1)(1 − 𝑅2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u882')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u882: GeneralStatistics expression (auto-extracted; see ref)."
