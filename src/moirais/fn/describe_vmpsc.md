...
`print(result)` render. See `moirais.fn.describe('vmpsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmpsc import *
import numpy as np
# See the function signature in fn/vmpsc.py for argument names.
```
