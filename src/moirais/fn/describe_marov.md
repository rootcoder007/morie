...
`print(result)` render. See `moirais.fn.describe('marov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.marov import *
import numpy as np
# See the function signature in fn/marov.py for argument names.
```
