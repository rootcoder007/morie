# describe('sgtkpc') — sgt_kernel_pca
...
`print(result)` render. See `moirais.fn.describe('sgtkpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtkpc import *
import numpy as np
# See the function signature in fn/sgtkpc.py for argument names.
```
