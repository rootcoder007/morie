# describe('rgfd1') — rangayyan_first_diff
...
`print(result)` render. See `moirais.fn.describe('rgfd1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfd1 import *
import numpy as np
# See the function signature in fn/rgfd1.py for argument names.
```
