...
__all__ = ["wilcox_chapter_4_unnumbered_92"]


def wilcox_chapter_4_unnumbered_92(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (Z ≤ c) = 1 +d
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u92')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u92: GeneralStatistics expression (auto-extracted; see ref)."
