...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_78"]


def information_theory_mackay_chapter_6_unnumbered_78(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] X; x6= y ) c+(x)6=c+(y): (5.4)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u78')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u78: GeneralStatistics expression (auto-extracted; see ref)."
