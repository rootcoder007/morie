# describe('rgpcgadp') — rangayyan_pcg_adaptive_seg
...
`print(result)` render. See `moirais.fn.describe('rgpcgadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcgadp import *
import numpy as np
# See the function signature in fn/rgpcgadp.py for argument names.
```
