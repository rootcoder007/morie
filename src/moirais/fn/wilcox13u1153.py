...
__all__ = ["wilcox_chapter_13_unnumbered_1153"]


def wilcox_chapter_13_unnumbered_1153(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: residual plot forX3 based on the residuals associated with the model Y =β 0+β 1X1+β 2X2+e,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1153')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1153: GeneralStatistics expression (auto-extracted; see ref)."
