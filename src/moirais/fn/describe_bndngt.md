# describe('bndngt') — bound_neg_treatment
...
`print(result)` render. See `moirais.fn.describe('bndngt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndngt import *
import numpy as np
# See the function signature in fn/bndngt.py for argument names.
```
