...
`print(result)` render. See `moirais.fn.describe('vgrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgrm import *
import numpy as np
# See the function signature in fn/vgrm.py for argument names.
```
