...
__all__ = ["hedderich_chapter_9_unnumbered_1123"]


def hedderich_chapter_9_unnumbered_1123(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x + (n−x + 1)F with F{F G1=2(n−x+1),F G2=2x,α/2}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1123')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1123: GeneralStatistics expression (auto-extracted; see ref)."
