# describe('gb_are2') — gibbons_are_normal_case
...
`print(result)` render. See `moirais.fn.describe('gb_are2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_are2 import *
import numpy as np
# See the function signature in fn/gb_are2.py for argument names.
```
