# describe('bbeas') — procrustes_shape
...
`print(result)` render. See `moirais.fn.describe('bbeas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbeas import *
import numpy as np
# See the function signature in fn/bbeas.py for argument names.
```
