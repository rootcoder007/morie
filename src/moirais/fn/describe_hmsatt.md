# describe('hmsatt') — geron_self_attention
...
`print(result)` render. See `moirais.fn.describe('hmsatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsatt import *
import numpy as np
# See the function signature in fn/hmsatt.py for argument names.
```
