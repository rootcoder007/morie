# describe('grkmo') — geron_kmeans_objective
...
`print(result)` render. See `moirais.fn.describe('grkmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkmo import *
import numpy as np
# See the function signature in fn/grkmo.py for argument names.
```
