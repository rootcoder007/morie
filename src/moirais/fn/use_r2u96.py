...
__all__ = ["use_r_chapter_2_unnumbered_96"]


def use_r_chapter_2_unnumbered_96(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u96')`` for the full guide.
...
def cheatsheet():
    return "use_r2u96: GeneralStatistics expression (auto-extracted; see ref)."
