...
__all__ = ["wilcox_chapter_13_unnumbered_1177"]


def wilcox_chapter_13_unnumbered_1177(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: lintest(x,y,regfun=tsreg,nboot=500,alpha=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1177')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1177: PowerAndDesign expression (auto-extracted; see ref)."
