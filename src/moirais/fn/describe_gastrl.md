...
`print(result)` render. See `moirais.fn.describe('gastrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gastrl import *
import numpy as np
# See the function signature in fn/gastrl.py for argument names.
```
