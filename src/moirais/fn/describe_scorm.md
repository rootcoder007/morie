# describe('scorm') — covariance_matrix
...
`print(result)` render. See `moirais.fn.describe('scorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scorm import *
import numpy as np
# See the function signature in fn/scorm.py for argument names.
```
