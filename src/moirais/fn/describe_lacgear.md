...
`print(result)` render. See `moirais.fn.describe('lacgear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacgear import *
import numpy as np
# See the function signature in fn/lacgear.py for argument names.
```
