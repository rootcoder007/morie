...
`print(result)` render. See `moirais.fn.describe('gdidp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdidp import *
import numpy as np
# See the function signature in fn/gdidp.py for argument names.
```
