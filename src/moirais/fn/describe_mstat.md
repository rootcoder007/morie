...
`print(result)` render. See `moirais.fn.describe('mstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstat import *
import numpy as np
# See the function signature in fn/mstat.py for argument names.
```
