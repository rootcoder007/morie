# describe('studrs') — studentized_residual
...
`print(result)` render. See `moirais.fn.describe('studrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.studrs import *
import numpy as np
# See the function signature in fn/studrs.py for argument names.
```
