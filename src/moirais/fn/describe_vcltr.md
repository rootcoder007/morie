# describe('vcltr') — vocal_tract_model_fn
...
`print(result)` render. See `moirais.fn.describe('vcltr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcltr import *
import numpy as np
# See the function signature in fn/vcltr.py for argument names.
```
