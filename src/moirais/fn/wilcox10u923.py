...
__all__ = ["wilcox_chapter_10_unnumbered_923"]


def wilcox_chapter_10_unnumbered_923(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: apply Fisher’s method based on p(3) ≤ · · · ≤ p(K) at the α/3 level. Continue in this fashion
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u923')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u923: GeneralStatistics expression (auto-extracted; see ref)."
