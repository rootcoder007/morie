# describe('grpex') — geron_prioritized_experience_weight
...
`print(result)` render. See `moirais.fn.describe('grpex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpex import *
import numpy as np
# See the function signature in fn/grpex.py for argument names.
```
