...
`print(result)` render. See `moirais.fn.describe('wqirg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqirg import *
import numpy as np
# See the function signature in fn/wqirg.py for argument names.
```
