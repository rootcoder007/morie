...
`print(result)` render. See `moirais.fn.describe('phoen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phoen import *
import numpy as np
# See the function signature in fn/phoen.py for argument names.
```
