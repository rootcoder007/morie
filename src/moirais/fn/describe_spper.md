...
`print(result)` render. See `moirais.fn.describe('spper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spper import *
import numpy as np
# See the function signature in fn/spper.py for argument names.
```
