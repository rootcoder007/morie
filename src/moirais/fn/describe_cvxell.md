# describe('cvxell') — boyd_minvol_ellipsoid
...
`print(result)` render. See `moirais.fn.describe('cvxell')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxell import *
import numpy as np
# See the function signature in fn/cvxell.py for argument names.
```
