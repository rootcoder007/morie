# describe('emllk') — em_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('emllk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emllk import *
import numpy as np
# See the function signature in fn/emllk.py for argument names.
```
