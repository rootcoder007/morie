# describe('cosdc') — cosine_decompose
...
`print(result)` render. See `moirais.fn.describe('cosdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cosdc import *
import numpy as np
# See the function signature in fn/cosdc.py for argument names.
```
