# describe('zepol') — pollution_surface
...
`print(result)` render. See `moirais.fn.describe('zepol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zepol import *
import numpy as np
# See the function signature in fn/zepol.py for argument names.
```
