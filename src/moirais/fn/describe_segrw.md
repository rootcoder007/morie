...
`print(result)` render. See `moirais.fn.describe('segrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.segrw import *
import numpy as np
# See the function signature in fn/segrw.py for argument names.
```
