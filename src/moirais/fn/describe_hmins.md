# describe('hmins') — geron_instance_based
...
`print(result)` render. See `moirais.fn.describe('hmins')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmins import *
import numpy as np
# See the function signature in fn/hmins.py for argument names.
```
