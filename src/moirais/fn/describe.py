...
"""describe(name) — pedagogical multi-section guide for any moirais.fn callable.

Per  and the rule in
memory `feedback_moirais_describe_feature.md`. Reads a sibling
...
def describe(name: str):
    """Pedagogical guide for a moirais.fn callable.
