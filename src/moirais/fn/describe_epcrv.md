# describe('epcrv') — epidemic_curve_analysis
...
`print(result)` render. See `moirais.fn.describe('epcrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epcrv import *
import numpy as np
# See the function signature in fn/epcrv.py for argument names.
```
