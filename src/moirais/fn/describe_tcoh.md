# describe('tcoh') — torus_cohomology
...
`print(result)` render. See `moirais.fn.describe('tcoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcoh import *
import numpy as np
# See the function signature in fn/tcoh.py for argument names.
```
