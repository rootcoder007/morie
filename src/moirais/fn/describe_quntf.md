# describe('quntf') — quantile_function
...
`print(result)` render. See `moirais.fn.describe('quntf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.quntf import *
import numpy as np
# See the function signature in fn/quntf.py for argument names.
```
