# describe('sav_u') — subscale_ua_ave
...
`print(result)` render. See `moirais.fn.describe('sav_u')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sav_u import *
import numpy as np
# See the function signature in fn/sav_u.py for argument names.
```
