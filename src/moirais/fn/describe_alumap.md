# describe('alumap') — alammar_umap_projection
...
`print(result)` render. See `moirais.fn.describe('alumap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alumap import *
import numpy as np
# See the function signature in fn/alumap.py for argument names.
```
