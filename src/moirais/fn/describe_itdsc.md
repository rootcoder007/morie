# describe('itdsc') — item_discrimination_all
...
`print(result)` render. See `moirais.fn.describe('itdsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itdsc import *
import numpy as np
# See the function signature in fn/itdsc.py for argument names.
```
