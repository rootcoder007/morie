# describe('rgar2cep') — rangayyan_ar_to_cepstrum
...
`print(result)` render. See `moirais.fn.describe('rgar2cep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgar2cep import *
import numpy as np
# See the function signature in fn/rgar2cep.py for argument names.
```
