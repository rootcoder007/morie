...
`print(result)` render. See `moirais.fn.describe('xrwcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwcn import *
import numpy as np
# See the function signature in fn/xrwcn.py for argument names.
```
