...
`print(result)` render. See `moirais.fn.describe('speccoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.speccoh import *
import numpy as np
# See the function signature in fn/speccoh.py for argument names.
```
