# describe('sdpwts') — semidefinite_program
...
`print(result)` render. See `moirais.fn.describe('sdpwts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdpwts import *
import numpy as np
# See the function signature in fn/sdpwts.py for argument names.
```
