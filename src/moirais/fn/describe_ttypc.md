# describe('ttypc') — typical_sampling
...
`print(result)` render. See `moirais.fn.describe('ttypc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ttypc import *
import numpy as np
# See the function signature in fn/ttypc.py for argument names.
```
