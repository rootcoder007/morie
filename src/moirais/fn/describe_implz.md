# describe('implz') — impulse_from_io_fn
...
`print(result)` render. See `moirais.fn.describe('implz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.implz import *
import numpy as np
# See the function signature in fn/implz.py for argument names.
```
