...
__all__ = ["wilcox_chapter_10_unnumbered_1024"]


def wilcox_chapter_10_unnumbered_1024(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: "Group 1", ylab = "Est.1-Est.2", na.rm = TRUE, alpha=0.05,ADJ.CI=TRUE) .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1024')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1024: GeneralStatistics expression (auto-extracted; see ref)."
