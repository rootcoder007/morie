# describe('copcla') — clayton_copula
...
`print(result)` render. See `moirais.fn.describe('copcla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copcla import *
import numpy as np
# See the function signature in fn/copcla.py for argument names.
```
