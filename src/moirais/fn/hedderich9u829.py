...
__all__ = ["hedderich_chapter_9_unnumbered_829"]


def hedderich_chapter_9_unnumbered_829(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Z = (Z1 +...+Zn)/√n is distributed according to N (0, 1) (5.120)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u829')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u829: GeneralStatistics expression (auto-extracted; see ref)."
