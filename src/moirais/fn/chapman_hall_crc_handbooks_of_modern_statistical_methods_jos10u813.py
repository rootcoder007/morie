...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_813"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_813(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: y.c1.form = "smoke˜age+race+educ+income+employ",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u813')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u813: GeneralStatistics expression (auto-extracted; see ref)."
