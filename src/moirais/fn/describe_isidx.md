...
`print(result)` render. See `moirais.fn.describe('isidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isidx import *
import numpy as np
# See the function signature in fn/isidx.py for argument names.
```
