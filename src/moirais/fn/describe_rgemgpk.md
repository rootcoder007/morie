# describe('rgemgpk') — rangayyan_emg_peak_freq
...
`print(result)` render. See `moirais.fn.describe('rgemgpk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemgpk import *
import numpy as np
# See the function signature in fn/rgemgpk.py for argument names.
```
