...
`print(result)` render. See `moirais.fn.describe('sguvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sguvar import *
import numpy as np
# See the function signature in fn/sguvar.py for argument names.
```
