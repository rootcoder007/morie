...
`print(result)` render. See `moirais.fn.describe('kgunt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgunt import *
import numpy as np
# See the function signature in fn/kgunt.py for argument names.
```
