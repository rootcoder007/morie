# describe('irpol') — irreducible_poly
...
`print(result)` render. See `moirais.fn.describe('irpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irpol import *
import numpy as np
# See the function signature in fn/irpol.py for argument names.
```
