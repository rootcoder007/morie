# describe('voltsr') — vol_two_scale_rv
...
`print(result)` render. See `moirais.fn.describe('voltsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voltsr import *
import numpy as np
# See the function signature in fn/voltsr.py for argument names.
```
