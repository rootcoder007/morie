...
__all__ = ["hedderich_chapter_9_unnumbered_1663"]


def hedderich_chapter_9_unnumbered_1663(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: superiorinferior -δ +δ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1663')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1663: GeneralStatistics expression (auto-extracted; see ref)."
