...
__all__ = ["wilcox_chapter_14_unnumbered_788"]


def wilcox_chapter_14_unnumbered_788(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: null hypothesis is rejected if F ≥ f , the 1 − α quantile of an F distribution with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u788')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u788: GeneralStatistics expression (auto-extracted; see ref)."
