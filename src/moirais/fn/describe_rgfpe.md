# describe('rgfpe') — rangayyan_ar_order_fpe
...
`print(result)` render. See `moirais.fn.describe('rgfpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfpe import *
import numpy as np
# See the function signature in fn/rgfpe.py for argument names.
```
