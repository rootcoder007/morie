# describe('rgstfts') — rangayyan_stft_spectrogram
...
`print(result)` render. See `moirais.fn.describe('rgstfts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgstfts import *
import numpy as np
# See the function signature in fn/rgstfts.py for argument names.
```
