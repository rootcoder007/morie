...
`print(result)` render. See `moirais.fn.describe('spprob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprob import *
import numpy as np
# See the function signature in fn/spprob.py for argument names.
```
