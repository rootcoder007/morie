...
`print(result)` render. See `moirais.fn.describe('nmpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmpol import *
import numpy as np
# See the function signature in fn/nmpol.py for argument names.
```
