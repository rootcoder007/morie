...
__all__ = ["hedderich_chapter_9_unnumbered_1566"]


def hedderich_chapter_9_unnumbered_1566(x):
    """
    Bayesian expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1566')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1566: Bayesian expression (auto-extracted; see ref)."
