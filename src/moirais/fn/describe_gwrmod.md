# describe('gwrmod') — geographically_weighted_regression
...
`print(result)` render. See `moirais.fn.describe('gwrmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrmod import *
import numpy as np
# See the function signature in fn/gwrmod.py for argument names.
```
