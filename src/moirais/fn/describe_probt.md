# describe('probt') — probit_regression
...
`print(result)` render. See `moirais.fn.describe('probt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.probt import *
import numpy as np
# See the function signature in fn/probt.py for argument names.
```
