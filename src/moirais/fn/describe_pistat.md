...
`print(result)` render. See `moirais.fn.describe('pistat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pistat import *
import numpy as np
# See the function signature in fn/pistat.py for argument names.
```
