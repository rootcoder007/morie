# describe('mtbf') — mtbf_estimate

## WHAT IT DOES

Mean Time Between Failures. 'Time discovers truth. — Seneca'
...
`print(result)` render. See `moirais.fn.describe('mtbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtbf import *
import numpy as np
# See the function signature in fn/mtbf.py for argument names.
```
