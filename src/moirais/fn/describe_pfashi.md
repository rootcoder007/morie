# describe('pfashi') — pfas_hazard_index
...
`print(result)` render. See `moirais.fn.describe('pfashi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pfashi import *
import numpy as np
# See the function signature in fn/pfashi.py for argument names.
```
