# describe('b205') — burkov_lm_ch2_perplexity
...
`print(result)` render. See `moirais.fn.describe('b205')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b205 import *
import numpy as np
# See the function signature in fn/b205.py for argument names.
```
