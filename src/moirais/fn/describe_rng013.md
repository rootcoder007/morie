# describe('rng013') — rangayyan_ch3_mean_of_sum
...
`print(result)` render. See `moirais.fn.describe('rng013')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng013 import *
import numpy as np
# See the function signature in fn/rng013.py for argument names.
```
