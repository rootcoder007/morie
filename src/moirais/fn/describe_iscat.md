...
`print(result)` render. See `moirais.fn.describe('iscat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iscat import *
import numpy as np
# See the function signature in fn/iscat.py for argument names.
```
