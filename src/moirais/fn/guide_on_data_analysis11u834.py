...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_834"]


def guide_on_data_analysis_chapter_11_unnumbered_834(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> BP = 98.223, df = 3, p-value < 2.2e-16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u834')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u834: GeneralStatistics expression (auto-extracted; see ref)."
