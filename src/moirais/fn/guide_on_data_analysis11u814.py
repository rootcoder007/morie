...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_814"]


def guide_on_data_analysis_chapter_11_unnumbered_814(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘𝑡 = 𝑌𝑖𝑗𝑘(𝑡−1)𝛼 + 𝑋𝑖𝑡𝛽 + 𝑇𝑖𝑡𝜏 + 𝑃𝑘 + 𝜖𝑖𝑗𝑘𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u814')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u814: GeneralStatistics expression (auto-extracted; see ref)."
