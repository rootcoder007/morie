...
__all__ = ["hedderich_chapter_9_unnumbered_2563"]


def hedderich_chapter_9_unnumbered_2563(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SAQA×B =SAQtotal−SAQA−SAQB−SAQin Interaction
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2563')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2563: GeneralStatistics expression (auto-extracted; see ref)."
