...
__all__ = ["bivand2013_chapter_7_unnumbered_199"]


def bivand2013_chapter_7_unnumbered_199(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, family = "SAR", listw = NYlistw, weights = POP8,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u199')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u199: GeneralStatistics expression (auto-extracted; see ref)."
