...
`print(result)` render. See `moirais.fn.describe('sawrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawrg import *
import numpy as np
# See the function signature in fn/sawrg.py for argument names.
```
