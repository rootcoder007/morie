# describe('aitlns') — logistic_normal_sample
...
`print(result)` render. See `moirais.fn.describe('aitlns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitlns import *
import numpy as np
# See the function signature in fn/aitlns.py for argument names.
```
