...
`print(result)` render. See `moirais.fn.describe('sarimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarimp import *
import numpy as np
# See the function signature in fn/sarimp.py for argument names.
```
