...
`print(result)` render. See `moirais.fn.describe('sbperm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbperm import *
import numpy as np
# See the function signature in fn/sbperm.py for argument names.
```
