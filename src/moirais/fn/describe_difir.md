...
`print(result)` render. See `moirais.fn.describe('difir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difir import *
import numpy as np
# See the function signature in fn/difir.py for argument names.
```
