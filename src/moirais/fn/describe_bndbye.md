# describe('bndbye') — bound_bayes_credible
...
`print(result)` render. See `moirais.fn.describe('bndbye')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndbye import *
import numpy as np
# See the function signature in fn/bndbye.py for argument names.
```
