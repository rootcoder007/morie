# describe('cocht') — cochrans_q_test
...
`print(result)` render. See `moirais.fn.describe('cocht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cocht import *
import numpy as np
# See the function signature in fn/cocht.py for argument names.
```
