...
`print(result)` render. See `moirais.fn.describe('youdj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.youdj import *
import numpy as np
# See the function signature in fn/youdj.py for argument names.
```
