...
__all__ = ["wilcox_chapter_10_unnumbered_880"]


def wilcox_chapter_10_unnumbered_880(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To elaborate slightly, imagine you observe Xijk (i = 1,...,n j; j = 1,...,J ; k = 1,...,K ).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u880')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u880: GeneralStatistics expression (auto-extracted; see ref)."
