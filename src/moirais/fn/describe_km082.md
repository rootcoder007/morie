# describe('km082') — kamath_ch6_weat_effect_size
...
`print(result)` render. See `moirais.fn.describe('km082')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km082 import *
import numpy as np
# See the function signature in fn/km082.py for argument names.
```
