...
`print(result)` render. See `moirais.fn.describe('msmwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmwt import *
import numpy as np
# See the function signature in fn/msmwt.py for argument names.
```
