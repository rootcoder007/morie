# describe('gh_c13_15') — ghosal_cox_bvm
...
`print(result)` render. See `moirais.fn.describe('gh_c13_15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_15 import *
import numpy as np
# See the function signature in fn/gh_c13_15.py for argument names.
```
