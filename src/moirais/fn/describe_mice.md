...
`print(result)` render. See `moirais.fn.describe('mice')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mice import *
import numpy as np
# See the function signature in fn/mice.py for argument names.
```
