# describe('grvots') — geron_soft_voting
...
`print(result)` render. See `moirais.fn.describe('grvots')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grvots import *
import numpy as np
# See the function signature in fn/grvots.py for argument names.
```
