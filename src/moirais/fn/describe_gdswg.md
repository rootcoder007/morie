...
`print(result)` render. See `moirais.fn.describe('gdswg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdswg import *
import numpy as np
# See the function signature in fn/gdswg.py for argument names.
```
