# describe('simrc') — simulate_roll_call
...
`print(result)` render. See `moirais.fn.describe('simrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simrc import *
import numpy as np
# See the function signature in fn/simrc.py for argument names.
```
