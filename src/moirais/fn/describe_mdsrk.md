# describe('mdsrk') — mds_reconstruct_distances
...
`print(result)` render. See `moirais.fn.describe('mdsrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsrk import *
import numpy as np
# See the function signature in fn/mdsrk.py for argument names.
```
