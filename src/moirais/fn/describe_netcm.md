# describe('netcm') — network_communities
...
`print(result)` render. See `moirais.fn.describe('netcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcm import *
import numpy as np
# See the function signature in fn/netcm.py for argument names.
```
