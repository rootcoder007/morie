...
__all__ = ["wilcox_chapter_13_unnumbered_1197"]


def wilcox_chapter_13_unnumbered_1197(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H1 :Y =β 0 +f1(X1) +f2(X2) +f3(X1,X 2) +e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1197')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1197: GeneralStatistics expression (auto-extracted; see ref)."
