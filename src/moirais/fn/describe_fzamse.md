# describe('fzamse') — fauzi_quantile_amse
...
`print(result)` render. See `moirais.fn.describe('fzamse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzamse import *
import numpy as np
# See the function signature in fn/fzamse.py for argument names.
```
