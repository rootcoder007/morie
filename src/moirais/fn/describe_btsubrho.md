# describe('btsubrho') — boot_subsample_rate
...
`print(result)` render. See `moirais.fn.describe('btsubrho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsubrho import *
import numpy as np
# See the function signature in fn/btsubrho.py for argument names.
```
