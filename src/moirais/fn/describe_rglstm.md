# describe('rglstm') — rangayyan_lstm_signal
...
`print(result)` render. See `moirais.fn.describe('rglstm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglstm import *
import numpy as np
# See the function signature in fn/rglstm.py for argument names.
```
