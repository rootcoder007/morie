...
`print(result)` render. See `moirais.fn.describe('nowcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nowcs import *
import numpy as np
# See the function signature in fn/nowcs.py for argument names.
```
