# describe('causdmliv') — causal_dml_iv
...
`print(result)` render. See `moirais.fn.describe('causdmliv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdmliv import *
import numpy as np
# See the function signature in fn/causdmliv.py for argument names.
```
