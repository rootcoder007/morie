# describe('cypin') — cyp450_inhibition
...
`print(result)` render. See `moirais.fn.describe('cypin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cypin import *
import numpy as np
# See the function signature in fn/cypin.py for argument names.
```
