...
`print(result)` render. See `moirais.fn.describe('dqnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dqnv import *
import numpy as np
# See the function signature in fn/dqnv.py for argument names.
```
