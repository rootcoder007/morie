# describe('lpcco') — lpc_coefficients_fn
...
`print(result)` render. See `moirais.fn.describe('lpcco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpcco import *
import numpy as np
# See the function signature in fn/lpcco.py for argument names.
```
