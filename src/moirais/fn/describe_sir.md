# describe('sir') — standardized_incidence_ratio
...
`print(result)` render. See `moirais.fn.describe('sir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sir import *
import numpy as np
# See the function signature in fn/sir.py for argument names.
```
