...
`print(result)` render. See `moirais.fn.describe('splrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splrg import *
import numpy as np
# See the function signature in fn/splrg.py for argument names.
```
