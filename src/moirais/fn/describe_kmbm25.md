# describe('kmbm25') — kamath_bm25_score
...
`print(result)` render. See `moirais.fn.describe('kmbm25')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbm25 import *
import numpy as np
# See the function signature in fn/kmbm25.py for argument names.
```
