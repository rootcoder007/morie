...
__all__ = ["hedderich_chapter_9_unnumbered_1787"]


def hedderich_chapter_9_unnumbered_1787(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (π−π0)2 ·(π0(1−π0) +π(1−π)) (7.44)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1787')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1787: CountModels expression (auto-extracted; see ref)."
