# describe('svhtm') — hotelling_multi
...
`print(result)` render. See `moirais.fn.describe('svhtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svhtm import *
import numpy as np
# See the function signature in fn/svhtm.py for argument names.
```
