# describe('msm303') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm303')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm303 import *
import numpy as np
# See the function signature in fn/msm303.py for argument names.
```
