...
`print(result)` render. See `moirais.fn.describe('mankt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mankt import *
import numpy as np
# See the function signature in fn/mankt.py for argument names.
```
