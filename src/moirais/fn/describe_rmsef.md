...
`print(result)` render. See `moirais.fn.describe('rmsef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsef import *
import numpy as np
# See the function signature in fn/rmsef.py for argument names.
```
