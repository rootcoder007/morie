# describe('alfsmd') — alphafold_msa_attention
...
`print(result)` render. See `moirais.fn.describe('alfsmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfsmd import *
import numpy as np
# See the function signature in fn/alfsmd.py for argument names.
```
