# describe('cancc') — canonical_correlation

## WHAT IT DOES

Canonical correlation analysis. 'Truth comes out of error more readily than out of confusion. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('cancc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cancc import *
import numpy as np
# See the function signature in fn/cancc.py for argument names.
```
