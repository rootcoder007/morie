...
`print(result)` render. See `moirais.fn.describe('mpmrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpmrg import *
import numpy as np
# See the function signature in fn/mpmrg.py for argument names.
```
