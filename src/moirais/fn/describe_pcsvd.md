...
`print(result)` render. See `moirais.fn.describe('pcsvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcsvd import *
import numpy as np
# See the function signature in fn/pcsvd.py for argument names.
```
