# describe('crt') — chinese_remainder
...
`print(result)` render. See `moirais.fn.describe('crt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crt import *
import numpy as np
# See the function signature in fn/crt.py for argument names.
```
