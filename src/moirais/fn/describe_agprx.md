...
`print(result)` render. See `moirais.fn.describe('agprx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agprx import *
import numpy as np
# See the function signature in fn/agprx.py for argument names.
```
