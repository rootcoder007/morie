...
`print(result)` render. See `moirais.fn.describe('swmtrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swmtrc import *
import numpy as np
# See the function signature in fn/swmtrc.py for argument names.
```
