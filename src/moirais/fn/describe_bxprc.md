# describe('bxprc') — box_pierce_test
...
`print(result)` render. See `moirais.fn.describe('bxprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bxprc import *
import numpy as np
# See the function signature in fn/bxprc.py for argument names.
```
