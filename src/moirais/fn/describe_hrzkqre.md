# describe('hrzkqre') — horowitz_kernel_quantile_reg
...
`print(result)` render. See `moirais.fn.describe('hrzkqre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzkqre import *
import numpy as np
# See the function signature in fn/hrzkqre.py for argument names.
```
