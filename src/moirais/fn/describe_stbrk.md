# describe('stbrk') — stick_breaking_weights
...
`print(result)` render. See `moirais.fn.describe('stbrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stbrk import *
import numpy as np
# See the function signature in fn/stbrk.py for argument names.
```
