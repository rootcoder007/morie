...
__all__ = ["bivand2013_chapter_2_unnumbered_47"]


def bivand2013_chapter_2_unnumbered_47(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + catNames = list(Cn), mvFlag = length(Cn))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u47')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u47: GeneralStatistics expression (auto-extracted; see ref)."
