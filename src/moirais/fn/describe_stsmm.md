...
`print(result)` render. See `moirais.fn.describe('stsmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stsmm import *
import numpy as np
# See the function signature in fn/stsmm.py for argument names.
```
