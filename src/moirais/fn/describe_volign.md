# describe('volign') — vol_igarch_fit
...
`print(result)` render. See `moirais.fn.describe('volign')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volign import *
import numpy as np
# See the function signature in fn/volign.py for argument names.
```
