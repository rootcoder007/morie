...
__all__ = ["hedderich_chapter_9_unnumbered_1662"]


def hedderich_chapter_9_unnumbered_1662(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 µd≤0 µd≥0 µd≤−δorµd≥+δ µd≤−δ µd≥+δ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1662')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1662: GeneralStatistics expression (auto-extracted; see ref)."
