# describe('crtap') — court_appeal_rate
...
`print(result)` render. See `moirais.fn.describe('crtap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtap import *
import numpy as np
# See the function signature in fn/crtap.py for argument names.
```
