...
__all__ = ["hedderich_chapter_9_unnumbered_1703"]


def hedderich_chapter_9_unnumbered_1703(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆχ2 = 14.8, a value that is greater than the tabulated χ2 value (11.07) for k−1 = 6 −1 = 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1703')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1703: GeneralStatistics expression (auto-extracted; see ref)."
