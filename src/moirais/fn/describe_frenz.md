# describe('frenz') — lyapunov_exponent
...
`print(result)` render. See `moirais.fn.describe('frenz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frenz import *
import numpy as np
# See the function signature in fn/frenz.py for argument names.
```
