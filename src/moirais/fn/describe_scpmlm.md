...
`print(result)` render. See `moirais.fn.describe('scpmlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpmlm import *
import numpy as np
# See the function signature in fn/scpmlm.py for argument names.
```
