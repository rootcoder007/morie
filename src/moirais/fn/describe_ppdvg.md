...
`print(result)` render. See `moirais.fn.describe('ppdvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppdvg import *
import numpy as np
# See the function signature in fn/ppdvg.py for argument names.
```
