# describe('irtnrm') — nominal_response
...
`print(result)` render. See `moirais.fn.describe('irtnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtnrm import *
import numpy as np
# See the function signature in fn/irtnrm.py for argument names.
```
