# describe('rgbhatt') — rangayyan_bhattacharyya
...
`print(result)` render. See `moirais.fn.describe('rgbhatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbhatt import *
import numpy as np
# See the function signature in fn/rgbhatt.py for argument names.
```
