# describe('frwil') — free_wilson_qsar
...
`print(result)` render. See `moirais.fn.describe('frwil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frwil import *
import numpy as np
# See the function signature in fn/frwil.py for argument names.
```
