...
`print(result)` render. See `moirais.fn.describe('looic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.looic import *
import numpy as np
# See the function signature in fn/looic.py for argument names.
```
