# describe('b203') — burkov_lm_ch2_lm_shorthand
...
`print(result)` render. See `moirais.fn.describe('b203')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b203 import *
import numpy as np
# See the function signature in fn/b203.py for argument names.
```
