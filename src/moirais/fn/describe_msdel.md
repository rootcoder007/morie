...
`print(result)` render. See `moirais.fn.describe('msdel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdel import *
import numpy as np
# See the function signature in fn/msdel.py for argument names.
```
