# describe('tpspn') — thin_plate_spline
...
`print(result)` render. See `moirais.fn.describe('tpspn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpspn import *
import numpy as np
# See the function signature in fn/tpspn.py for argument names.
```
