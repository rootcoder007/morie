# describe('gb32lu') — gibbons_runs_up_down_recur
...
`print(result)` render. See `moirais.fn.describe('gb32lu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32lu import *
import numpy as np
# See the function signature in fn/gb32lu.py for argument names.
```
