# describe('grwth') — exponential_growth_rate
...
`print(result)` render. See `moirais.fn.describe('grwth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grwth import *
import numpy as np
# See the function signature in fn/grwth.py for argument names.
```
