...
__all__ = ["guide_on_data_analysis_chapter_21_unnumbered_1004"]


def guide_on_data_analysis_chapter_21_unnumbered_1004(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Δ𝑆 = 𝑃𝐴𝑇𝐸 − 𝑆𝐴𝑇𝐸 =𝑁 − 𝑛
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis21u1004')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis21u1004: GeneralStatistics expression (auto-extracted; see ref)."
