# describe('hrzbwcv') — horowitz_bw_cv_sim
...
`print(result)` render. See `moirais.fn.describe('hrzbwcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzbwcv import *
import numpy as np
# See the function signature in fn/hrzbwcv.py for argument names.
```
