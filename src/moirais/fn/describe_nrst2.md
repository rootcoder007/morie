...
`print(result)` render. See `moirais.fn.describe('nrst2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrst2 import *
import numpy as np
# See the function signature in fn/nrst2.py for argument names.
```
