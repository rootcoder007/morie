...
`print(result)` render. See `moirais.fn.describe('knspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knspl import *
import numpy as np
# See the function signature in fn/knspl.py for argument names.
```
