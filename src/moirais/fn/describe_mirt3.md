# describe('mirt3') — mirt_3d_compensatory
...
`print(result)` render. See `moirais.fn.describe('mirt3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mirt3 import *
import numpy as np
# See the function signature in fn/mirt3.py for argument names.
```
