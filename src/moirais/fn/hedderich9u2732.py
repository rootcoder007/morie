...
__all__ = ["hedderich_chapter_9_unnumbered_2732"]


def hedderich_chapter_9_unnumbered_2732(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (K|R) = ψ−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2732')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2732: GeneralStatistics expression (auto-extracted; see ref)."
