# describe('sentl') — detection_metrics
...
`print(result)` render. See `moirais.fn.describe('sentl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sentl import *
import numpy as np
# See the function signature in fn/sentl.py for argument names.
```
