# describe('aitlrm') — compositional_lrmean
...
`print(result)` render. See `moirais.fn.describe('aitlrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitlrm import *
import numpy as np
# See the function signature in fn/aitlrm.py for argument names.
```
