# describe('rng081') — rangayyan_ch3_even_part
...
`print(result)` render. See `moirais.fn.describe('rng081')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng081 import *
import numpy as np
# See the function signature in fn/rng081.py for argument names.
```
