# describe('netcr') — network_correlation
...
`print(result)` render. See `moirais.fn.describe('netcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcr import *
import numpy as np
# See the function signature in fn/netcr.py for argument names.
```
