# describe('gb2313') — gibbons_edf_joint_moment
...
`print(result)` render. See `moirais.fn.describe('gb2313')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2313 import *
import numpy as np
# See the function signature in fn/gb2313.py for argument names.
```
