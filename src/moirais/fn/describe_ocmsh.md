...
`print(result)` render. See `moirais.fn.describe('ocmsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocmsh import *
import numpy as np
# See the function signature in fn/ocmsh.py for argument names.
```
