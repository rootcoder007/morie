...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_306"]


def guide_on_data_analysis_chapter_5_unnumbered_306(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜕𝛽 = −2X⊤Y + 2(X⊤X)𝛽.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u306')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u306: GeneralStatistics expression (auto-extracted; see ref)."
