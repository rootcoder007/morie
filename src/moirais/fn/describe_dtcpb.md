...
`print(result)` render. See `moirais.fn.describe('dtcpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpb import *
import numpy as np
# See the function signature in fn/dtcpb.py for argument names.
```
