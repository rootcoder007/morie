# describe('midas') — midas_regression
...
`print(result)` render. See `moirais.fn.describe('midas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.midas import *
import numpy as np
# See the function signature in fn/midas.py for argument names.
```
