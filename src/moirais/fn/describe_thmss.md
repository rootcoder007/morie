...
`print(result)` render. See `moirais.fn.describe('thmss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thmss import *
import numpy as np
# See the function signature in fn/thmss.py for argument names.
```
