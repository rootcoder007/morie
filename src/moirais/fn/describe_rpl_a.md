...
`print(result)` render. See `moirais.fn.describe('rpl_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_a import *
import numpy as np
# See the function signature in fn/rpl_a.py for argument names.
```
