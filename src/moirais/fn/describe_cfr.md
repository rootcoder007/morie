# describe('cfr') — case_fatality_rate
...
`print(result)` render. See `moirais.fn.describe('cfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfr import *
import numpy as np
# See the function signature in fn/cfr.py for argument names.
```
