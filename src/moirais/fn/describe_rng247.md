# describe('rng247') — rangayyan_ch4_signal_with_echo_output
...
`print(result)` render. See `moirais.fn.describe('rng247')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng247 import *
import numpy as np
# See the function signature in fn/rng247.py for argument names.
```
