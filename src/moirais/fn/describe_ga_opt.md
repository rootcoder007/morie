# describe('ga_opt') — genetic_algorithm
...
`print(result)` render. See `moirais.fn.describe('ga_opt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ga_opt import *
import numpy as np
# See the function signature in fn/ga_opt.py for argument names.
```
