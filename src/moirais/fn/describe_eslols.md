# describe('eslols') — esl_ols_normal_equations
...
`print(result)` render. See `moirais.fn.describe('eslols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslols import *
import numpy as np
# See the function signature in fn/eslols.py for argument names.
```
