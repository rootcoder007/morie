...
`print(result)` render. See `moirais.fn.describe('csevd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csevd import *
import numpy as np
# See the function signature in fn/csevd.py for argument names.
```
