...
__all__ = ["wilcox_chapter_8_unnumbered_861"]


def wilcox_chapter_8_unnumbered_861(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: rmdzero(x,est=onestep, grp = NA, nboot = NA, ...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u861')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u861: Resampling expression (auto-extracted; see ref)."
