# describe('radon') — radon_cancer_risk
...
`print(result)` render. See `moirais.fn.describe('radon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.radon import *
import numpy as np
# See the function signature in fn/radon.py for argument names.
```
