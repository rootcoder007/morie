# describe('sludg') — herschel_bulkley
...
`print(result)` render. See `moirais.fn.describe('sludg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sludg import *
import numpy as np
# See the function signature in fn/sludg.py for argument names.
```
