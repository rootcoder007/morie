# describe('survipw') — ipcw_estimator
...
`print(result)` render. See `moirais.fn.describe('survipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survipw import *
import numpy as np
# See the function signature in fn/survipw.py for argument names.
```
