...
`print(result)` render. See `moirais.fn.describe('cepst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cepst import *
import numpy as np
# See the function signature in fn/cepst.py for argument names.
```
