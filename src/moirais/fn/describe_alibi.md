...
`print(result)` render. See `moirais.fn.describe('alibi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alibi import *
import numpy as np
# See the function signature in fn/alibi.py for argument names.
```
