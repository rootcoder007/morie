...
`print(result)` render. See `moirais.fn.describe('eslism')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslism import *
import numpy as np
# See the function signature in fn/eslism.py for argument names.
```
