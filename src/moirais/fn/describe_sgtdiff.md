# describe('sgtdiff') — sgt_diffusion_kernel
...
`print(result)` render. See `moirais.fn.describe('sgtdiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtdiff import *
import numpy as np
# See the function signature in fn/sgtdiff.py for argument names.
```
