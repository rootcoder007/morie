...
`print(result)` render. See `moirais.fn.describe('stmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stmat import *
import numpy as np
# See the function signature in fn/stmat.py for argument names.
```
