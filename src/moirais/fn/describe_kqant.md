...
`print(result)` render. See `moirais.fn.describe('kqant')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kqant import *
import numpy as np
# See the function signature in fn/kqant.py for argument names.
```
