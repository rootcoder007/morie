...
`print(result)` render. See `moirais.fn.describe('ptthm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptthm import *
import numpy as np
# See the function signature in fn/ptthm.py for argument names.
```
