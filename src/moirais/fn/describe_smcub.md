# describe('smcub') — smacof_unfolding_basic
...
`print(result)` render. See `moirais.fn.describe('smcub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcub import *
import numpy as np
# See the function signature in fn/smcub.py for argument names.
```
