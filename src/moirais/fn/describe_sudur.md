# describe('sudur') — substance_duration
...
`print(result)` render. See `moirais.fn.describe('sudur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sudur import *
import numpy as np
# See the function signature in fn/sudur.py for argument names.
```
