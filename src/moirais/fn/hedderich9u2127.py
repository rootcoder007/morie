...
__all__ = ["hedderich_chapter_9_unnumbered_2127"]


def hedderich_chapter_9_unnumbered_2127(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > r 1 <− sum ( rank [ group = = 1 ] ) ; r 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2127')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2127: GeneralStatistics expression (auto-extracted; see ref)."
