...
`print(result)` render. See `moirais.fn.describe('msdmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdmc import *
import numpy as np
# See the function signature in fn/msdmc.py for argument names.
```
