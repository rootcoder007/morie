...
`print(result)` render. See `moirais.fn.describe('irr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irr import *
import numpy as np
# See the function signature in fn/irr.py for argument names.
```
