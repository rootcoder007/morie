# describe('randW') — random_walk_kernel
...
`print(result)` render. See `moirais.fn.describe('randW')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.randW import *
import numpy as np
# See the function signature in fn/randW.py for argument names.
```
