...
`print(result)` render. See `moirais.fn.describe('sdemimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemimp import *
import numpy as np
# See the function signature in fn/sdemimp.py for argument names.
```
