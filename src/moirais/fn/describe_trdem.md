...
`print(result)` render. See `moirais.fn.describe('trdem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdem import *
import numpy as np
# See the function signature in fn/trdem.py for argument names.
```
