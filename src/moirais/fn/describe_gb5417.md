# describe('gb5417') — gibbons_sign_median_ci
...
`print(result)` render. See `moirais.fn.describe('gb5417')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5417 import *
import numpy as np
# See the function signature in fn/gb5417.py for argument names.
```
