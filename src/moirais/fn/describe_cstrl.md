# describe('cstrl') — custody_release_type
...
`print(result)` render. See `moirais.fn.describe('cstrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstrl import *
import numpy as np
# See the function signature in fn/cstrl.py for argument names.
```
