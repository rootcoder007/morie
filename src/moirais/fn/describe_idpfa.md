...
`print(result)` render. See `moirais.fn.describe('idpfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpfa import *
import numpy as np
# See the function signature in fn/idpfa.py for argument names.
```
