# describe('osyn1') — otis_synth_region
...
`print(result)` render. See `moirais.fn.describe('osyn1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.osyn1 import *
import numpy as np
# See the function signature in fn/osyn1.py for argument names.
```
