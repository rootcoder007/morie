# describe('hmchrn') — geron_char_rnn
...
`print(result)` render. See `moirais.fn.describe('hmchrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmchrn import *
import numpy as np
# See the function signature in fn/hmchrn.py for argument names.
```
