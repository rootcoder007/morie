# describe('mxetA') — max_exceedance_curve
...
`print(result)` render. See `moirais.fn.describe('mxetA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxetA import *
import numpy as np
# See the function signature in fn/mxetA.py for argument names.
```
