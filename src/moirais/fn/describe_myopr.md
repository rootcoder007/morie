# describe('myopr') — myopulse_rate_fn
...
`print(result)` render. See `moirais.fn.describe('myopr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.myopr import *
import numpy as np
# See the function signature in fn/myopr.py for argument names.
```
