...
`print(result)` render. See `moirais.fn.describe('nmfsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmfsp import *
import numpy as np
# See the function signature in fn/nmfsp.py for argument names.
```
