...
`print(result)` render. See `moirais.fn.describe('lftrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lftrt import *
import numpy as np
# See the function signature in fn/lftrt.py for argument names.
```
