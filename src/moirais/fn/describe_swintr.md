# describe('swintr') — swin_transformer
...
`print(result)` render. See `moirais.fn.describe('swintr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swintr import *
import numpy as np
# See the function signature in fn/swintr.py for argument names.
```
