# describe('sunabr') — sun_abraham_did
...
`print(result)` render. See `moirais.fn.describe('sunabr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sunabr import *
import numpy as np
# See the function signature in fn/sunabr.py for argument names.
```
