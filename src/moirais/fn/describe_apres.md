...
`print(result)` render. See `moirais.fn.describe('apres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apres import *
import numpy as np
# See the function signature in fn/apres.py for argument names.
```
