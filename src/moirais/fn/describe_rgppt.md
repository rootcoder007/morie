# describe('rgppt') — rangayyan_point_process
...
`print(result)` render. See `moirais.fn.describe('rgppt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgppt import *
import numpy as np
# See the function signature in fn/rgppt.py for argument names.
```
