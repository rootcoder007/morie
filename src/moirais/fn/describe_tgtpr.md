...
`print(result)` render. See `moirais.fn.describe('tgtpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgtpr import *
import numpy as np
# See the function signature in fn/tgtpr.py for argument names.
```
