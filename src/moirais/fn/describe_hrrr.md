# describe('hrrr') — heart_rate_from_rr
...
`print(result)` render. See `moirais.fn.describe('hrrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrrr import *
import numpy as np
# See the function signature in fn/hrrr.py for argument names.
```
