...
`print(result)` render. See `moirais.fn.describe('sacimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacimp import *
import numpy as np
# See the function signature in fn/sacimp.py for argument names.
```
