# describe('rng188') — rangayyan_ch4_pan_tompkins_derivative_operator
...
`print(result)` render. See `moirais.fn.describe('rng188')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng188 import *
import numpy as np
# See the function signature in fn/rng188.py for argument names.
```
