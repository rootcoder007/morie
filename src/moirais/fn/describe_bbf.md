...
`print(result)` render. See `moirais.fn.describe('bbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbf import *
import numpy as np
# See the function signature in fn/bbf.py for argument names.
```
