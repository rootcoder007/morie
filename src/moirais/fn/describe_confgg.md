# describe('confgg') — configuration_model
...
`print(result)` render. See `moirais.fn.describe('confgg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.confgg import *
import numpy as np
# See the function signature in fn/confgg.py for argument names.
```
