...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1494"]


def guide_on_data_analysis_chapter_30_unnumbered_1494(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -5 x cohort = 10 -0.56 (0.46)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1494')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1494: GeneralStatistics expression (auto-extracted; see ref)."
