# describe('grtop') — geron_topk_sampling
...
`print(result)` render. See `moirais.fn.describe('grtop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtop import *
import numpy as np
# See the function signature in fn/grtop.py for argument names.
```
