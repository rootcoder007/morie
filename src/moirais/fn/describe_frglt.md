...
`print(result)` render. See `moirais.fn.describe('frglt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frglt import *
import numpy as np
# See the function signature in fn/frglt.py for argument names.
```
