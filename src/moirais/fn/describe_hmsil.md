# describe('hmsil') — geron_silhouette
...
`print(result)` render. See `moirais.fn.describe('hmsil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsil import *
import numpy as np
# See the function signature in fn/hmsil.py for argument names.
```
