...
`print(result)` render. See `moirais.fn.describe('srgwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwl import *
import numpy as np
# See the function signature in fn/srgwl.py for argument names.
```
