# describe('tmlnde') — tmle_natural_direct
...
`print(result)` render. See `moirais.fn.describe('tmlnde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnde import *
import numpy as np
# See the function signature in fn/tmlnde.py for argument names.
```
