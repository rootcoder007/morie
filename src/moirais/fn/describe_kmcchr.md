# describe('kmcchr') — kamath_christiano_deep_rl_feedback
...
`print(result)` render. See `moirais.fn.describe('kmcchr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcchr import *
import numpy as np
# See the function signature in fn/kmcchr.py for argument names.
```
