# describe('msm017') — mvsml_linear_mixed_models_eq_5_3
...
`print(result)` render. See `moirais.fn.describe('msm017')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm017 import *
import numpy as np
# See the function signature in fn/msm017.py for argument names.
```
