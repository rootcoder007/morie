# describe('wsmkbk') — wasserman_kullback_leibler
...
`print(result)` render. See `moirais.fn.describe('wsmkbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmkbk import *
import numpy as np
# See the function signature in fn/wsmkbk.py for argument names.
```
