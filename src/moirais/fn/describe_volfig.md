# describe('volfig') — vol_figarch_fit
...
`print(result)` render. See `moirais.fn.describe('volfig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volfig import *
import numpy as np
# See the function signature in fn/volfig.py for argument names.
```
