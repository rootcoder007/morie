...
__all__ = ["spatial_data_analysis_with_r_chapter_4_unnumbered_15"]


def spatial_data_analysis_with_r_chapter_4_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˓→+datum=WGS84 +units=m")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatial_data_analysis_with_r4u15')`` for the full guide.
...
def cheatsheet():
    return "spatial_data_analysis_with_r4u15: GeneralStatistics expression (auto-extracted; see ref)."
