...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_906"]


def guide_on_data_analysis_chapter_14_unnumbered_906(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u906')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u906: GeneralStatistics expression (auto-extracted; see ref)."
