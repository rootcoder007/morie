...
__all__ = ["hedderich_chapter_9_unnumbered_742"]


def hedderich_chapter_9_unnumbered_742(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] pr−1(1−p)k =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u742')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u742: CountModels expression (auto-extracted; see ref)."
