...
`print(result)` render. See `moirais.fn.describe('trmet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmet import *
import numpy as np
# See the function signature in fn/trmet.py for argument names.
```
