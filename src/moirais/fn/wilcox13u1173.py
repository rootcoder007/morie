...
__all__ = ["wilcox_chapter_13_unnumbered_1173"]


def wilcox_chapter_13_unnumbered_1173(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: reg2ci(x1, y1, x2, y2, regfun=tsreg, nboot=599, alpha=0.05, plotit=T)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1173')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1173: GeneralStatistics expression (auto-extracted; see ref)."
