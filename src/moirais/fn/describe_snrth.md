...
`print(result)` render. See `moirais.fn.describe('snrth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snrth import *
import numpy as np
# See the function signature in fn/snrth.py for argument names.
```
