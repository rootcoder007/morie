# describe('gh_c14_18') — ghosal_ksbp_def
...
`print(result)` render. See `moirais.fn.describe('gh_c14_18')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_18 import *
import numpy as np
# See the function signature in fn/gh_c14_18.py for argument names.
```
