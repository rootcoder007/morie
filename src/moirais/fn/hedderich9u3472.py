...
__all__ = ["hedderich_chapter_9_unnumbered_3472"]


def hedderich_chapter_9_unnumbered_3472(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: logθij(k) =λXY
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3472')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3472: GeneralStatistics expression (auto-extracted; see ref)."
