...
`print(result)` render. See `moirais.fn.describe('tq3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tq3 import *
import numpy as np
# See the function signature in fn/tq3.py for argument names.
```
