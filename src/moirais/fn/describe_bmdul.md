# describe('bmdul') — bayesian_mds_unfolding
...
`print(result)` render. See `moirais.fn.describe('bmdul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmdul import *
import numpy as np
# See the function signature in fn/bmdul.py for argument names.
```
