# describe('firth') — firth_logistic

## WHAT IT DOES

Firth penalized logistic regression. 'What is now proved was once only imagined. — William Blake'
...
`print(result)` render. See `moirais.fn.describe('firth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.firth import *
import numpy as np
# See the function signature in fn/firth.py for argument names.
```
