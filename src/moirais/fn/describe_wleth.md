# describe('wleth') — weighted_likelihood_theta
...
`print(result)` render. See `moirais.fn.describe('wleth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wleth import *
import numpy as np
# See the function signature in fn/wleth.py for argument names.
```
