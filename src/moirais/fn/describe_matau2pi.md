# describe('matau2pi') — ma_tau2_predict_interval
...
`print(result)` render. See `moirais.fn.describe('matau2pi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matau2pi import *
import numpy as np
# See the function signature in fn/matau2pi.py for argument names.
```
