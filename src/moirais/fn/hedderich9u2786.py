...
__all__ = ["hedderich_chapter_9_unnumbered_2786"]


def hedderich_chapter_9_unnumbered_2786(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: McNemar ’ s chi − squared = 4 . 7 6 1 9 , df = 1 , p− value = 0 . 0 2 9 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2786')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2786: GeneralStatistics expression (auto-extracted; see ref)."
