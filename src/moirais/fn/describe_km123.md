# describe('km123') — kamath_ch8_moverscore_distance
...
`print(result)` render. See `moirais.fn.describe('km123')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km123 import *
import numpy as np
# See the function signature in fn/km123.py for argument names.
```
