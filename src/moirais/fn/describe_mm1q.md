...
`print(result)` render. See `moirais.fn.describe('mm1q')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mm1q import *
import numpy as np
# See the function signature in fn/mm1q.py for argument names.
```
