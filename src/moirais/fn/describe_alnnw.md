# describe('alnnw') — needleman_wunsch
...
`print(result)` render. See `moirais.fn.describe('alnnw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alnnw import *
import numpy as np
# See the function signature in fn/alnnw.py for argument names.
```
