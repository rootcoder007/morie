# describe('drwgs') — dr_weighting_strategy
...
`print(result)` render. See `moirais.fn.describe('drwgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drwgs import *
import numpy as np
# See the function signature in fn/drwgs.py for argument names.
```
