...
__all__ = ["hedderich_chapter_9_unnumbered_2529"]


def hedderich_chapter_9_unnumbered_2529(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Check: Sum of all rank sums =n(k + 1)(k + 2)/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2529')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2529: GeneralStatistics expression (auto-extracted; see ref)."
