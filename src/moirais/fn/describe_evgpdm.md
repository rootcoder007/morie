...
`print(result)` render. See `moirais.fn.describe('evgpdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdm import *
import numpy as np
# See the function signature in fn/evgpdm.py for argument names.
```
