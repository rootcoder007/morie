...
__all__ = ["hedderich_chapter_9_unnumbered_1967"]


def hedderich_chapter_9_unnumbered_1967(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2. Sample (17 years): n2 = 23 ¯ x2 = 31.2 sec. s2 = 31.0 sec.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1967')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1967: GeneralStatistics expression (auto-extracted; see ref)."
