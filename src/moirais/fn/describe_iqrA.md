...
`print(result)` render. See `moirais.fn.describe('iqrA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iqrA import *
import numpy as np
# See the function signature in fn/iqrA.py for argument names.
```
