...
`print(result)` render. See `moirais.fn.describe('ghbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghbar import *
import numpy as np
# See the function signature in fn/ghbar.py for argument names.
```
