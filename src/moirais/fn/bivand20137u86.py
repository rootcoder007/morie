...
__all__ = ["bivand2013_chapter_7_unnumbered_86"]


def bivand2013_chapter_7_unnumbered_86(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + control = list(maxit = 1000, fnscale = -1) ,x=x )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u86')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u86: GeneralStatistics expression (auto-extracted; see ref)."
