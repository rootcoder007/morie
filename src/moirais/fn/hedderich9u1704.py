...
__all__ = ["hedderich_chapter_9_unnumbered_1704"]


def hedderich_chapter_9_unnumbered_1704(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] −n = [(6/60)(72 + 162 +...+ 92)]−60 = 14.8.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1704')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1704: GeneralStatistics expression (auto-extracted; see ref)."
