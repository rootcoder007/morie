# describe('whttk') — whittaker_smooth
...
`print(result)` render. See `moirais.fn.describe('whttk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whttk import *
import numpy as np
# See the function signature in fn/whttk.py for argument names.
```
