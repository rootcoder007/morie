...
`print(result)` render. See `moirais.fn.describe('tfidfV')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tfidfV import *
import numpy as np
# See the function signature in fn/tfidfV.py for argument names.
```
