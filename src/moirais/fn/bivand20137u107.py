...
__all__ = ["bivand2013_chapter_7_unnumbered_107"]


def bivand2013_chapter_7_unnumbered_107(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: UBRE score = -0.12348 Scale est. = 1 n = 1283
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u107')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u107: GeneralStatistics expression (auto-extracted; see ref)."
