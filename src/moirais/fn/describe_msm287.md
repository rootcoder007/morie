# describe('msm287') — mvsml_convolutional_nn_eq_14_11
...
`print(result)` render. See `moirais.fn.describe('msm287')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm287 import *
import numpy as np
# See the function signature in fn/msm287.py for argument names.
```
