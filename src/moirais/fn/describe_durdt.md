# describe('durdt') — duration_detect
...
`print(result)` render. See `moirais.fn.describe('durdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.durdt import *
import numpy as np
# See the function signature in fn/durdt.py for argument names.
```
