...
`print(result)` render. See `moirais.fn.describe('psbal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psbal import *
import numpy as np
# See the function signature in fn/psbal.py for argument names.
```
