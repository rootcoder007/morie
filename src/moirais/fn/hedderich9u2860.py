...
__all__ = ["hedderich_chapter_9_unnumbered_2860"]


def hedderich_chapter_9_unnumbered_2860(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 46·120·72(53 + 41) = 7.742> 5, 024 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2860')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2860: GeneralStatistics expression (auto-extracted; see ref)."
