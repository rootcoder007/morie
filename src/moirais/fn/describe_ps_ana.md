# describe('ps_ana') — run_propensity_ipw_analysis
...
`print(result)` render. See `moirais.fn.describe('ps_ana')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ps_ana import *
import numpy as np
# See the function signature in fn/ps_ana.py for argument names.
```
