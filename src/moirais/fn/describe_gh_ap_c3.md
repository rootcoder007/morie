# describe('gh_ap_c3') — ghosal_bracket_num
...
`print(result)` render. See `moirais.fn.describe('gh_ap_c3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_c3 import *
import numpy as np
# See the function signature in fn/gh_ap_c3.py for argument names.
```
