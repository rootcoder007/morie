...
__all__ = ["hedderich_chapter_9_unnumbered_1035"]


def hedderich_chapter_9_unnumbered_1035(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1035')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1035: GeneralStatistics expression (auto-extracted; see ref)."
