# describe('smacf') — smacof_algorithm
...
`print(result)` render. See `moirais.fn.describe('smacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smacf import *
import numpy as np
# See the function signature in fn/smacf.py for argument names.
```
