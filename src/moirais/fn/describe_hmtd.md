# describe('hmtd') — geron_td_learning
...
`print(result)` render. See `moirais.fn.describe('hmtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtd import *
import numpy as np
# See the function signature in fn/hmtd.py for argument names.
```
