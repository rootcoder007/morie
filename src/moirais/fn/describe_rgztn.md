# describe('rgztn') — regularization_path
...
`print(result)` render. See `moirais.fn.describe('rgztn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgztn import *
import numpy as np
# See the function signature in fn/rgztn.py for argument names.
```
