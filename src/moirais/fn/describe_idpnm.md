...
`print(result)` render. See `moirais.fn.describe('idpnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpnm import *
import numpy as np
# See the function signature in fn/idpnm.py for argument names.
```
