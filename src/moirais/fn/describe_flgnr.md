# describe('flgnr') — fligner_killeen
...
`print(result)` render. See `moirais.fn.describe('flgnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flgnr import *
import numpy as np
# See the function signature in fn/flgnr.py for argument names.
```
