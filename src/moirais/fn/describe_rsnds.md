...
`print(result)` render. See `moirais.fn.describe('rsnds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsnds import *
import numpy as np
# See the function signature in fn/rsnds.py for argument names.
```
