# describe('sgkvl') — kriging_cross_validation
...
`print(result)` render. See `moirais.fn.describe('sgkvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgkvl import *
import numpy as np
# See the function signature in fn/sgkvl.py for argument names.
```
