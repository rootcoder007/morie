# describe('eslnsl') — esl_natural_spline
...
`print(result)` render. See `moirais.fn.describe('eslnsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnsl import *
import numpy as np
# See the function signature in fn/eslnsl.py for argument names.
```
