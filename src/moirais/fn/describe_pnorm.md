...
`print(result)` render. See `moirais.fn.describe('pnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pnorm import *
import numpy as np
# See the function signature in fn/pnorm.py for argument names.
```
