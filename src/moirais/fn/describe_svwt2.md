...
`print(result)` render. See `moirais.fn.describe('svwt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwt2 import *
import numpy as np
# See the function signature in fn/svwt2.py for argument names.
```
