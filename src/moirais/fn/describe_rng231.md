# describe('rng231') — rangayyan_ch4_homomorphic_log_separation
...
`print(result)` render. See `moirais.fn.describe('rng231')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng231 import *
import numpy as np
# See the function signature in fn/rng231.py for argument names.
```
