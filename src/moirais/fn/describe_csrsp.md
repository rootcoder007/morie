...
`print(result)` render. See `moirais.fn.describe('csrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrsp import *
import numpy as np
# See the function signature in fn/csrsp.py for argument names.
```
