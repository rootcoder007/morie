...
`print(result)` render. See `moirais.fn.describe('carres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carres import *
import numpy as np
# See the function signature in fn/carres.py for argument names.
```
