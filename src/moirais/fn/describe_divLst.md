...
`print(result)` render. See `moirais.fn.describe('divLst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.divLst import *
import numpy as np
# See the function signature in fn/divLst.py for argument names.
```
