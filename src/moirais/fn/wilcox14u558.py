...
__all__ = ["wilcox_chapter_14_unnumbered_558"]


def wilcox_chapter_14_unnumbered_558(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] δ = 1 − 2P, (7.31)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u558')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u558: GeneralStatistics expression (auto-extracted; see ref)."
