# describe('spwgt') — spatial_weights
...
`print(result)` render. See `moirais.fn.describe('spwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spwgt import *
import numpy as np
# See the function signature in fn/spwgt.py for argument names.
```
