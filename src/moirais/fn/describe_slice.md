...
`print(result)` render. See `moirais.fn.describe('slice')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slice import *
import numpy as np
# See the function signature in fn/slice.py for argument names.
```
