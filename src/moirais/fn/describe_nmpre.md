...
`print(result)` render. See `moirais.fn.describe('nmpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmpre import *
import numpy as np
# See the function signature in fn/nmpre.py for argument names.
```
