...
`print(result)` render. See `moirais.fn.describe('goldsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.goldsc import *
import numpy as np
# See the function signature in fn/goldsc.py for argument names.
```
