...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1426"]


def guide_on_data_analysis_chapter_29_unnumbered_1426(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: treat_stat_var = "treatvar",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1426')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1426: GeneralStatistics expression (auto-extracted; see ref)."
