...
`print(result)` render. See `moirais.fn.describe('reproj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reproj import *
import numpy as np
# See the function signature in fn/reproj.py for argument names.
```
