...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_295"]


def guide_on_data_analysis_chapter_5_unnumbered_295(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = y′H′Hy + y′(I − H)′(I − H)y
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u295')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u295: GeneralStatistics expression (auto-extracted; see ref)."
