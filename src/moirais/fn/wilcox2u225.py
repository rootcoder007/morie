...
__all__ = ["wilcox_chapter_2_unnumbered_225"]


def wilcox_chapter_2_unnumbered_225(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] B = 81(x)(n − x − 1) − 9n − 8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u225')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u225: GeneralStatistics expression (auto-extracted; see ref)."
