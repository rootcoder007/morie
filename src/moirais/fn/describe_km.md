...
`print(result)` render. See `moirais.fn.describe('km')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km import *
import numpy as np
# See the function signature in fn/km.py for argument names.
```
