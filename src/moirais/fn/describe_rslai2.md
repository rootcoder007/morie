...
`print(result)` render. See `moirais.fn.describe('rslai2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rslai2 import *
import numpy as np
# See the function signature in fn/rslai2.py for argument names.
```
