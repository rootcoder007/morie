...
`print(result)` render. See `moirais.fn.describe('sawcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawcm import *
import numpy as np
# See the function signature in fn/sawcm.py for argument names.
```
