...
__all__ = ["guide_on_data_analysis_chapter_20_unnumbered_992"]


def guide_on_data_analysis_chapter_20_unnumbered_992(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌 = 𝛽1𝑋1 + 𝛽2𝑋2 + 𝜀, 𝔼[𝜀 ∣ 𝑋1, 𝑋2] = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis20u992')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis20u992: GeneralStatistics expression (auto-extracted; see ref)."
