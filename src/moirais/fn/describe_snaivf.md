# describe('snaivf') — seasonal_naive
...
`print(result)` render. See `moirais.fn.describe('snaivf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snaivf import *
import numpy as np
# See the function signature in fn/snaivf.py for argument names.
```
