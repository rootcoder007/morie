# describe('dkgnk') — dkgnk

## WHAT IT DOES

Gneiting ST covariance
...
`print(result)` render. See `moirais.fn.describe('dkgnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkgnk import *
import numpy as np
# See the function signature in fn/dkgnk.py for argument names.
```
