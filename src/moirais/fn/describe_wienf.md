...
`print(result)` render. See `moirais.fn.describe('wienf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wienf import *
import numpy as np
# See the function signature in fn/wienf.py for argument names.
```
