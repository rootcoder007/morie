# describe('bampr') — bayesian_am_posterior_summary
...
`print(result)` render. See `moirais.fn.describe('bampr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bampr import *
import numpy as np
# See the function signature in fn/bampr.py for argument names.
```
