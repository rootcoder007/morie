...
`print(result)` render. See `moirais.fn.describe('sbmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbmlt import *
import numpy as np
# See the function signature in fn/sbmlt.py for argument names.
```
