...
`print(result)` render. See `moirais.fn.describe('rfcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfcox import *
import numpy as np
# See the function signature in fn/rfcox.py for argument names.
```
