...
`print(result)` render. See `moirais.fn.describe('rgdfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdfa import *
import numpy as np
# See the function signature in fn/rgdfa.py for argument names.
```
