...
`print(result)` render. See `moirais.fn.describe('hmgru')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgru import *
import numpy as np
# See the function signature in fn/hmgru.py for argument names.
```
