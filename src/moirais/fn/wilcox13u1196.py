...
__all__ = ["wilcox_chapter_13_unnumbered_1196"]


def wilcox_chapter_13_unnumbered_1196(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Y = (β 0 +β 2X2) +β 1X1 +e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1196')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1196: GeneralStatistics expression (auto-extracted; see ref)."
