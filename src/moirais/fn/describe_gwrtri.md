...
`print(result)` render. See `moirais.fn.describe('gwrtri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrtri import *
import numpy as np
# See the function signature in fn/gwrtri.py for argument names.
```
