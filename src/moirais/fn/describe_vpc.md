# describe('vpc') — variance_partition_coefficient
...
`print(result)` render. See `moirais.fn.describe('vpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vpc import *
import numpy as np
# See the function signature in fn/vpc.py for argument names.
```
