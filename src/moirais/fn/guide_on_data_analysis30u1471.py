...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1471"]


def guide_on_data_analysis_chapter_30_unnumbered_1471(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ymax_ptwise = estimate + 1.96 * se
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1471')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1471: GeneralStatistics expression (auto-extracted; see ref)."
