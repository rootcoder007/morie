...
`print(result)` render. See `moirais.fn.describe('oqntl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oqntl import *
import numpy as np
# See the function signature in fn/oqntl.py for argument names.
```
