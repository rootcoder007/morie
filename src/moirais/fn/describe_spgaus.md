# describe('spgaus') — schabenberger_gaussian_variogram
...
`print(result)` render. See `moirais.fn.describe('spgaus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgaus import *
import numpy as np
# See the function signature in fn/spgaus.py for argument names.
```
