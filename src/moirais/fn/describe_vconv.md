# describe('vconv') — convergent_validity
...
`print(result)` render. See `moirais.fn.describe('vconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vconv import *
import numpy as np
# See the function signature in fn/vconv.py for argument names.
```
