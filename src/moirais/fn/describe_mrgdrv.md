# describe('mrgdrv') — martingale_concentration
...
`print(result)` render. See `moirais.fn.describe('mrgdrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrgdrv import *
import numpy as np
# See the function signature in fn/mrgdrv.py for argument names.
```
