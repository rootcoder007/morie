# describe('rescor') — rescore_consensus
...
`print(result)` render. See `moirais.fn.describe('rescor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rescor import *
import numpy as np
# See the function signature in fn/rescor.py for argument names.
```
