# describe('gh_c11_4') — ghosal_gp_dens_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c11_4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_4 import *
import numpy as np
# See the function signature in fn/gh_c11_4.py for argument names.
```
