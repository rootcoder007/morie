...
__all__ = ["wilcox_chapter_10_unnumbered_948"]


def wilcox_chapter_10_unnumbered_948(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: linconbt(x,con=0,tr=0.2,alpha = 0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u948')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u948: GeneralStatistics expression (auto-extracted; see ref)."
