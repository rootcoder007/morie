...
`print(result)` render. See `moirais.fn.describe('bnsmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsmo import *
import numpy as np
# See the function signature in fn/bnsmo.py for argument names.
```
