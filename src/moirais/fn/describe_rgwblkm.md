# describe('rgwblkm') — rangayyan_blackman_window
...
`print(result)` render. See `moirais.fn.describe('rgwblkm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwblkm import *
import numpy as np
# See the function signature in fn/rgwblkm.py for argument names.
```
