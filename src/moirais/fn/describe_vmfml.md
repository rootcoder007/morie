...
`print(result)` render. See `moirais.fn.describe('vmfml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmfml import *
import numpy as np
# See the function signature in fn/vmfml.py for argument names.
```
