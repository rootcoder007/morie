...
`print(result)` render. See `moirais.fn.describe('igravsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravsq import *
import numpy as np
# See the function signature in fn/igravsq.py for argument names.
```
