# describe('rng089') — rangayyan_ch3_hann_filter
...
`print(result)` render. See `moirais.fn.describe('rng089')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng089 import *
import numpy as np
# See the function signature in fn/rng089.py for argument names.
```
