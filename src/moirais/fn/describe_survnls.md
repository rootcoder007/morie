# describe('survnls') — nonlinear_least_squares_surv
...
`print(result)` render. See `moirais.fn.describe('survnls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survnls import *
import numpy as np
# See the function signature in fn/survnls.py for argument names.
```
