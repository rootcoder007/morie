...
`print(result)` render. See `moirais.fn.describe('forsdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forsdi import *
import numpy as np
# See the function signature in fn/forsdi.py for argument names.
```
