...
`print(result)` render. See `moirais.fn.describe('sieg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sieg import *
import numpy as np
# See the function signature in fn/sieg.py for argument names.
```
