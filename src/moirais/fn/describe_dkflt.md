...
`print(result)` render. See `moirais.fn.describe('dkflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkflt import *
import numpy as np
# See the function signature in fn/dkflt.py for argument names.
```
