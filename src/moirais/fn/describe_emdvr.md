# describe('emdvr') — emd_variance_ratio
...
`print(result)` render. See `moirais.fn.describe('emdvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdvr import *
import numpy as np
# See the function signature in fn/emdvr.py for argument names.
```
