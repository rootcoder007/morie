# describe('hrzph') — horowitz_proportional_hazards
...
`print(result)` render. See `moirais.fn.describe('hrzph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzph import *
import numpy as np
# See the function signature in fn/hrzph.py for argument names.
```
