...
`print(result)` render. See `moirais.fn.describe('hscon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hscon import *
import numpy as np
# See the function signature in fn/hscon.py for argument names.
```
