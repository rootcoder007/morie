# describe('gh_c7_6') — ghosal_pt_dens_con
...
`print(result)` render. See `moirais.fn.describe('gh_c7_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_6 import *
import numpy as np
# See the function signature in fn/gh_c7_6.py for argument names.
```
