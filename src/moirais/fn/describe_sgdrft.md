# describe('sgdrft') — external_drift_kriging
...
`print(result)` render. See `moirais.fn.describe('sgdrft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdrft import *
import numpy as np
# See the function signature in fn/sgdrft.py for argument names.
```
