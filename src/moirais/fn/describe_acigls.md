# describe('acigls') — adjusted_ipgls
...
`print(result)` render. See `moirais.fn.describe('acigls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acigls import *
import numpy as np
# See the function signature in fn/acigls.py for argument names.
```
