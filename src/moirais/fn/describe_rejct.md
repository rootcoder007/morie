# describe('rejct') — rejection_point
...
`print(result)` render. See `moirais.fn.describe('rejct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rejct import *
import numpy as np
# See the function signature in fn/rejct.py for argument names.
```
