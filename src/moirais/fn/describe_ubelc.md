...
`print(result)` render. See `moirais.fn.describe('ubelc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubelc import *
import numpy as np
# See the function signature in fn/ubelc.py for argument names.
```
