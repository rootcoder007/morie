...
`print(result)` render. See `moirais.fn.describe('hausr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hausr import *
import numpy as np
# See the function signature in fn/hausr.py for argument names.
```
