...
`print(result)` render. See `moirais.fn.describe('youdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.youdn import *
import numpy as np
# See the function signature in fn/youdn.py for argument names.
```
