# describe('aitpca') — aitchison_clr_pca
...
`print(result)` render. See `moirais.fn.describe('aitpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitpca import *
import numpy as np
# See the function signature in fn/aitpca.py for argument names.
```
