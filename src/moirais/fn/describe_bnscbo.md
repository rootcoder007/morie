# describe('bnscbo') — bound_compound_outcome
...
`print(result)` render. See `moirais.fn.describe('bnscbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnscbo import *
import numpy as np
# See the function signature in fn/bnscbo.py for argument names.
```
