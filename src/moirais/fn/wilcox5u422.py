...
__all__ = ["wilcox_chapter_5_unnumbered_422"]


def wilcox_chapter_5_unnumbered_422(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :β 1 = · · · =β p = 0, (6.11)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u422')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u422: GeneralStatistics expression (auto-extracted; see ref)."
