...
`print(result)` render. See `moirais.fn.describe('grimk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grimk import *
import numpy as np
# See the function signature in fn/grimk.py for argument names.
```
