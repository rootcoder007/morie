# describe('brnst') — bernstein_density_estimate
...
`print(result)` render. See `moirais.fn.describe('brnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brnst import *
import numpy as np
# See the function signature in fn/brnst.py for argument names.
```
