# describe('bgpre') — bayesian_gp_regression
...
`print(result)` render. See `moirais.fn.describe('bgpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgpre import *
import numpy as np
# See the function signature in fn/bgpre.py for argument names.
```
