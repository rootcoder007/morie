# describe('bmlnr') — bayesian_linear_regression
...
`print(result)` render. See `moirais.fn.describe('bmlnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmlnr import *
import numpy as np
# See the function signature in fn/bmlnr.py for argument names.
```
