...
`print(result)` render. See `moirais.fn.describe('dk3bl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3bl import *
import numpy as np
# See the function signature in fn/dk3bl.py for argument names.
```
