...
`print(result)` render. See `moirais.fn.describe('ldprun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldprun import *
import numpy as np
# See the function signature in fn/ldprun.py for argument names.
```
