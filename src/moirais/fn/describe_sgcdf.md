...
`print(result)` render. See `moirais.fn.describe('sgcdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcdf import *
import numpy as np
# See the function signature in fn/sgcdf.py for argument names.
```
