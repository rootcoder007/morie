# describe('sntdp') — sentence_disparity
...
`print(result)` render. See `moirais.fn.describe('sntdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntdp import *
import numpy as np
# See the function signature in fn/sntdp.py for argument names.
```
