# describe('mspro') — procrustes_orth
...
`print(result)` render. See `moirais.fn.describe('mspro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mspro import *
import numpy as np
# See the function signature in fn/mspro.py for argument names.
```
