# describe('almqr') — alammar_multi_query_retrieval
...
`print(result)` render. See `moirais.fn.describe('almqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.almqr import *
import numpy as np
# See the function signature in fn/almqr.py for argument names.
```
