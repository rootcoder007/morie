...
`print(result)` render. See `moirais.fn.describe('vmtmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmtmm import *
import numpy as np
# See the function signature in fn/vmtmm.py for argument names.
```
