...
`print(result)` render. See `moirais.fn.describe('mssmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssmw import *
import numpy as np
# See the function signature in fn/mssmw.py for argument names.
```
