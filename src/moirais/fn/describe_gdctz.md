...
`print(result)` render. See `moirais.fn.describe('gdctz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdctz import *
import numpy as np
# See the function signature in fn/gdctz.py for argument names.
```
