# describe('oocls') — optimal_classification
...
`print(result)` render. See `moirais.fn.describe('oocls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oocls import *
import numpy as np
# See the function signature in fn/oocls.py for argument names.
```
