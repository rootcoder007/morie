...
`print(result)` render. See `moirais.fn.describe('dkmvv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkmvv import *
import numpy as np
# See the function signature in fn/dkmvv.py for argument names.
```
