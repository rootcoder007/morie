# describe('bcdblk') — block_coordinate_descent
...
`print(result)` render. See `moirais.fn.describe('bcdblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcdblk import *
import numpy as np
# See the function signature in fn/bcdblk.py for argument names.
```
