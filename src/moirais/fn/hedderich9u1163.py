...
__all__ = ["hedderich_chapter_9_unnumbered_1163"]


def hedderich_chapter_9_unnumbered_1163(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Calculate the one-sided lower 99%-confidence limit πu based on ˆp = 1 forn = 60 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1163')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1163: GeneralStatistics expression (auto-extracted; see ref)."
