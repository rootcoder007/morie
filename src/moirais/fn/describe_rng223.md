# describe('rng223') — rangayyan_ch4_test_signal_three_events
...
`print(result)` render. See `moirais.fn.describe('rng223')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng223 import *
import numpy as np
# See the function signature in fn/rng223.py for argument names.
```
