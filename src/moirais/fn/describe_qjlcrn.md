# describe('qjlcrn') — qjl_compression
...
`print(result)` render. See `moirais.fn.describe('qjlcrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qjlcrn import *
import numpy as np
# See the function signature in fn/qjlcrn.py for argument names.
```
