# describe('bayima') — importance_sampling
...
`print(result)` render. See `moirais.fn.describe('bayima')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayima import *
import numpy as np
# See the function signature in fn/bayima.py for argument names.
```
