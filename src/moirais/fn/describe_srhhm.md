...
`print(result)` render. See `moirais.fn.describe('srhhm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srhhm import *
import numpy as np
# See the function signature in fn/srhhm.py for argument names.
```
