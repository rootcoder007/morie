# describe('fzb3t') — fauzi_b3_coefficient
...
`print(result)` render. See `moirais.fn.describe('fzb3t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzb3t import *
import numpy as np
# See the function signature in fn/fzb3t.py for argument names.
```
