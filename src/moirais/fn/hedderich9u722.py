...
__all__ = ["hedderich_chapter_9_unnumbered_722"]


def hedderich_chapter_9_unnumbered_722(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u722')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u722: CountModels expression (auto-extracted; see ref)."
