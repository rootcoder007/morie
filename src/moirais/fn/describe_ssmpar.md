# describe('ssmpar') — ssm_parallel_scan
...
`print(result)` render. See `moirais.fn.describe('ssmpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssmpar import *
import numpy as np
# See the function signature in fn/ssmpar.py for argument names.
```
