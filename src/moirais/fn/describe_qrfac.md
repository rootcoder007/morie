...
`print(result)` render. See `moirais.fn.describe('qrfac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrfac import *
import numpy as np
# See the function signature in fn/qrfac.py for argument names.
```
