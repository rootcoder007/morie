...
`print(result)` render. See `moirais.fn.describe('ocate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocate import *
import numpy as np
# See the function signature in fn/ocate.py for argument names.
```
