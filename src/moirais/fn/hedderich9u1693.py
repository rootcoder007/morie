...
__all__ = ["hedderich_chapter_9_unnumbered_1693"]


def hedderich_chapter_9_unnumbered_1693(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: as for not too smalln (see further below) the test statistic (7.28) i.e., ˆχ2 >χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1693')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1693: GeneralStatistics expression (auto-extracted; see ref)."
