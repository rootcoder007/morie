...
__all__ = ["hedderich_chapter_9_unnumbered_2342"]


def hedderich_chapter_9_unnumbered_2342(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: it results in ˆχ2 = 0.794/1.086 = 0.731< 5.99 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2342')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2342: GeneralStatistics expression (auto-extracted; see ref)."
