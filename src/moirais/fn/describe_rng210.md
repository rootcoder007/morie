# describe('rng210') — rangayyan_ch4_noise_psd_at_output
...
`print(result)` render. See `moirais.fn.describe('rng210')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng210 import *
import numpy as np
# See the function signature in fn/rng210.py for argument names.
```
