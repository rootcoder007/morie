...
`print(result)` render. See `moirais.fn.describe('jntfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntfr import *
import numpy as np
# See the function signature in fn/jntfr.py for argument names.
```
