# describe('spansm') — schabenberger_anselin_local_moran
...
`print(result)` render. See `moirais.fn.describe('spansm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spansm import *
import numpy as np
# See the function signature in fn/spansm.py for argument names.
```
