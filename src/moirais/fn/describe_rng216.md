# describe('rng216') — rangayyan_ch4_schwarz_inequality_complex
...
`print(result)` render. See `moirais.fn.describe('rng216')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng216 import *
import numpy as np
# See the function signature in fn/rng216.py for argument names.
```
