...
`print(result)` render. See `moirais.fn.describe('ghchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghchg import *
import numpy as np
# See the function signature in fn/ghchg.py for argument names.
```
