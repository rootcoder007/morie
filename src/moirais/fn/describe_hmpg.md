# describe('hmpg') — geron_policy_gradient
...
`print(result)` render. See `moirais.fn.describe('hmpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpg import *
import numpy as np
# See the function signature in fn/hmpg.py for argument names.
```
