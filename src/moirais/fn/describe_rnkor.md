# describe('rnkor') — rank_order_statistics
...
`print(result)` render. See `moirais.fn.describe('rnkor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnkor import *
import numpy as np
# See the function signature in fn/rnkor.py for argument names.
```
