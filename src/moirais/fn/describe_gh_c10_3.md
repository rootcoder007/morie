# describe('gh_c10_3') — ghosal_param_rate
...
`print(result)` render. See `moirais.fn.describe('gh_c10_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c10_3 import *
import numpy as np
# See the function signature in fn/gh_c10_3.py for argument names.
```
