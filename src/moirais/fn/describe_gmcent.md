# describe('gmcent') — grand_mean_centering
...
`print(result)` render. See `moirais.fn.describe('gmcent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmcent import *
import numpy as np
# See the function signature in fn/gmcent.py for argument names.
```
