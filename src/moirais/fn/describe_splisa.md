# describe('splisa') — schabenberger_lisa
...
`print(result)` render. See `moirais.fn.describe('splisa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splisa import *
import numpy as np
# See the function signature in fn/splisa.py for argument names.
```
