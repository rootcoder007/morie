...
__all__ = ["wilcox_chapter_10_unnumbered_881"]


def wilcox_chapter_10_unnumbered_881(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 :θ j1 − θ j′ 1 = 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u881')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u881: GeneralStatistics expression (auto-extracted; see ref)."
