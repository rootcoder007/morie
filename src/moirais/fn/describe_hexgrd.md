# describe('hexgrd') — hexagonal_grid
...
`print(result)` render. See `moirais.fn.describe('hexgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hexgrd import *
import numpy as np
# See the function signature in fn/hexgrd.py for argument names.
```
