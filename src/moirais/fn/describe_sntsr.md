# describe('sntsr') — sentence_served
...
`print(result)` render. See `moirais.fn.describe('sntsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntsr import *
import numpy as np
# See the function signature in fn/sntsr.py for argument names.
```
