...
`print(result)` render. See `moirais.fn.describe('ptmor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptmor import *
import numpy as np
# See the function signature in fn/ptmor.py for argument names.
```
