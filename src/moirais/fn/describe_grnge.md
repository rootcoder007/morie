...
`print(result)` render. See `moirais.fn.describe('grnge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grnge import *
import numpy as np
# See the function signature in fn/grnge.py for argument names.
```
