...
`print(result)` render. See `moirais.fn.describe('stlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stlin import *
import numpy as np
# See the function signature in fn/stlin.py for argument names.
```
