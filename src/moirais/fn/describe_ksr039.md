# describe('ksr039') — kosorok_ch2_weak_convergence_lipschitz
...
`print(result)` render. See `moirais.fn.describe('ksr039')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr039 import *
import numpy as np
# See the function signature in fn/ksr039.py for argument names.
```
