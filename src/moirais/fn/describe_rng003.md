# describe('rng003') — rangayyan_ch3_variance_continuous
...
`print(result)` render. See `moirais.fn.describe('rng003')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng003 import *
import numpy as np
# See the function signature in fn/rng003.py for argument names.
```
