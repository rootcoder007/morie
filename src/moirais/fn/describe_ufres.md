# describe('ufres') — unfolding_residuals
...
`print(result)` render. See `moirais.fn.describe('ufres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ufres import *
import numpy as np
# See the function signature in fn/ufres.py for argument names.
```
