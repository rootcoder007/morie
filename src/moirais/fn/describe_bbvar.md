# describe('bbvar') — bb_variance_explained
...
`print(result)` render. See `moirais.fn.describe('bbvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbvar import *
import numpy as np
# See the function signature in fn/bbvar.py for argument names.
```
