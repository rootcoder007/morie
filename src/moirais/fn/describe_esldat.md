...
`print(result)` render. See `moirais.fn.describe('esldat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esldat import *
import numpy as np
# See the function signature in fn/esldat.py for argument names.
```
