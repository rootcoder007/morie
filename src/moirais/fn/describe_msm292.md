# describe('msm292') — mvsml_convolutional_nn_eq_14_1
...
`print(result)` render. See `moirais.fn.describe('msm292')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm292 import *
import numpy as np
# See the function signature in fn/msm292.py for argument names.
```
