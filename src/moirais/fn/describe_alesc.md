...
`print(result)` render. See `moirais.fn.describe('alesc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alesc import *
import numpy as np
# See the function signature in fn/alesc.py for argument names.
```
