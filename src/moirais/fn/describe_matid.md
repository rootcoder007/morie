...
`print(result)` render. See `moirais.fn.describe('matid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matid import *
import numpy as np
# See the function signature in fn/matid.py for argument names.
```
