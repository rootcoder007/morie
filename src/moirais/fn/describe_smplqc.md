...
`print(result)` render. See `moirais.fn.describe('smplqc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smplqc import *
import numpy as np
# See the function signature in fn/smplqc.py for argument names.
```
