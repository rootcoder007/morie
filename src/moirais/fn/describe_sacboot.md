...
`print(result)` render. See `moirais.fn.describe('sacboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacboot import *
import numpy as np
# See the function signature in fn/sacboot.py for argument names.
```
