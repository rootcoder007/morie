...
`print(result)` render. See `moirais.fn.describe('hdint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdint import *
import numpy as np
# See the function signature in fn/hdint.py for argument names.
```
