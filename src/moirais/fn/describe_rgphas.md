# describe('rgphas') — rangayyan_phase_response
...
`print(result)` render. See `moirais.fn.describe('rgphas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgphas import *
import numpy as np
# See the function signature in fn/rgphas.py for argument names.
```
