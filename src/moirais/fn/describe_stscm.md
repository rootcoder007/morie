# describe('stscm') — byzantine_detect
...
`print(result)` render. See `moirais.fn.describe('stscm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stscm import *
import numpy as np
# See the function signature in fn/stscm.py for argument names.
```
