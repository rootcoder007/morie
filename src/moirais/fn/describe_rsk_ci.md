...
`print(result)` render. See `moirais.fn.describe('rsk_ci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsk_ci import *
import numpy as np
# See the function signature in fn/rsk_ci.py for argument names.
```
