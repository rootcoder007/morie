# describe('pt2nd') — second_order_pp
...
`print(result)` render. See `moirais.fn.describe('pt2nd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pt2nd import *
import numpy as np
# See the function signature in fn/pt2nd.py for argument names.
```
