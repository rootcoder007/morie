...
__all__ = ["hedderich_chapter_9_unnumbered_947"]


def hedderich_chapter_9_unnumbered_947(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 9.Γ(x)Γ(x−1) = π
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u947')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u947: GeneralStatistics expression (auto-extracted; see ref)."
