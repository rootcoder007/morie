...
`print(result)` render. See `moirais.fn.describe('kgmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgmsp import *
import numpy as np
# See the function signature in fn/kgmsp.py for argument names.
```
