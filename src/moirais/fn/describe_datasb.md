# describe('datasb') — data_subset_refutation
...
`print(result)` render. See `moirais.fn.describe('datasb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.datasb import *
import numpy as np
# See the function signature in fn/datasb.py for argument names.
```
