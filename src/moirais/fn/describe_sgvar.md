...
`print(result)` render. See `moirais.fn.describe('sgvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgvar import *
import numpy as np
# See the function signature in fn/sgvar.py for argument names.
```
