...
`print(result)` render. See `moirais.fn.describe('dtcvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcvg import *
import numpy as np
# See the function signature in fn/dtcvg.py for argument names.
```
