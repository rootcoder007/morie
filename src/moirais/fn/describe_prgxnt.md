...
`print(result)` render. See `moirais.fn.describe('prgxnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgxnt import *
import numpy as np
# See the function signature in fn/prgxnt.py for argument names.
```
