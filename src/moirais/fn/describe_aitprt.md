# describe('aitprt') — aitchison_perturbation
...
`print(result)` render. See `moirais.fn.describe('aitprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitprt import *
import numpy as np
# See the function signature in fn/aitprt.py for argument names.
```
