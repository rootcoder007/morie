...
`print(result)` render. See `moirais.fn.describe('xrlsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlsg import *
import numpy as np
# See the function signature in fn/xrlsg.py for argument names.
```
