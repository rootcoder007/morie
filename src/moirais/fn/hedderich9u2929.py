...
__all__ = ["hedderich_chapter_9_unnumbered_2929"]


def hedderich_chapter_9_unnumbered_2929(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑ (Xi−niπ0)2−
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2929')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2929: GeneralStatistics expression (auto-extracted; see ref)."
