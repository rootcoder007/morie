...
__all__ = ["hedderich_chapter_9_unnumbered_2864"]


def hedderich_chapter_9_unnumbered_2864(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz =|6/40−20/40|−80/(2·40·40)√[ 46−262/80
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2864')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2864: GeneralStatistics expression (auto-extracted; see ref)."
