# describe('rgpantp') — rangayyan_pan_tompkins
...
`print(result)` render. See `moirais.fn.describe('rgpantp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpantp import *
import numpy as np
# See the function signature in fn/rgpantp.py for argument names.
```
