# describe('frcst') — renewal_forecast
...
`print(result)` render. See `moirais.fn.describe('frcst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frcst import *
import numpy as np
# See the function signature in fn/frcst.py for argument names.
```
