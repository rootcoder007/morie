...
`print(result)` render. See `moirais.fn.describe('bcaci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcaci import *
import numpy as np
# See the function signature in fn/bcaci.py for argument names.
```
