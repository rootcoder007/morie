# describe('dunn') — dunn_test

## WHAT IT DOES

Dunn's post-hoc test. 'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('dunn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dunn import *
import numpy as np
# See the function signature in fn/dunn.py for argument names.
```
