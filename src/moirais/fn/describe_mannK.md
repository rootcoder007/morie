...
`print(result)` render. See `moirais.fn.describe('mannK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mannK import *
import numpy as np
# See the function signature in fn/mannK.py for argument names.
```
