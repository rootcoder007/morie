...
`print(result)` render. See `moirais.fn.describe('rcsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcsem import *
import numpy as np
# See the function signature in fn/rcsem.py for argument names.
```
