# describe('prgwt') — program_waitlist
...
`print(result)` render. See `moirais.fn.describe('prgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgwt import *
import numpy as np
# See the function signature in fn/prgwt.py for argument names.
```
