# describe('evchibd') — evt_chibar_dependence
...
`print(result)` render. See `moirais.fn.describe('evchibd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evchibd import *
import numpy as np
# See the function signature in fn/evchibd.py for argument names.
```
