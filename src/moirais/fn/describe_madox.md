...
`print(result)` render. See `moirais.fn.describe('madox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madox import *
import numpy as np
# See the function signature in fn/madox.py for argument names.
```
