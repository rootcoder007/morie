...
__all__ = ["hedderich_chapter_9_unnumbered_1661"]


def hedderich_chapter_9_unnumbered_1661(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] HA µd > 0 µd < 0 −δ <µd < +δ µd >−δ µd < +δ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1661')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1661: GeneralStatistics expression (auto-extracted; see ref)."
