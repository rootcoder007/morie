...
`print(result)` render. See `moirais.fn.describe('ldanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldanl import *
import numpy as np
# See the function signature in fn/ldanl.py for argument names.
```
