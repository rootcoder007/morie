...
`print(result)` render. See `moirais.fn.describe('gdinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdinf import *
import numpy as np
# See the function signature in fn/gdinf.py for argument names.
```
