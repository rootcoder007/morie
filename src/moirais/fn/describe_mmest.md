# describe('mmest') — _tukey_bisquare
...
`print(result)` render. See `moirais.fn.describe('mmest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmest import *
import numpy as np
# See the function signature in fn/mmest.py for argument names.
```
