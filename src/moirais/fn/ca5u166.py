...
def ca_chapter_5_unnumbered_166(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u166')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "CentralTendency expression involving 'effects' (auto-extracted; see reference for full context)."},
    )
