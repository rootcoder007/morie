...
`print(result)` render. See `moirais.fn.describe('cmvet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmvet import *
import numpy as np
# See the function signature in fn/cmvet.py for argument names.
```
