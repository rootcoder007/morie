...
`print(result)` render. See `moirais.fn.describe('dtcpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpg import *
import numpy as np
# See the function signature in fn/dtcpg.py for argument names.
```
