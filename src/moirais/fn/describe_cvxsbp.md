# describe('cvxsbp') — boyd_subgradient
...
`print(result)` render. See `moirais.fn.describe('cvxsbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsbp import *
import numpy as np
# See the function signature in fn/cvxsbp.py for argument names.
```
