# describe('fzkdf') — fauzi_kdfe_properties
...
`print(result)` render. See `moirais.fn.describe('fzkdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzkdf import *
import numpy as np
# See the function signature in fn/fzkdf.py for argument names.
```
