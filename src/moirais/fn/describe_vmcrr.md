...
`print(result)` render. See `moirais.fn.describe('vmcrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcrr import *
import numpy as np
# See the function signature in fn/vmcrr.py for argument names.
```
