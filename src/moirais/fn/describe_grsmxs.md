# describe('grsmxs') — geron_softmax_score
...
`print(result)` render. See `moirais.fn.describe('grsmxs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsmxs import *
import numpy as np
# See the function signature in fn/grsmxs.py for argument names.
```
