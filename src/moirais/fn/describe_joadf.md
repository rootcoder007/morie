# describe('joadf') — joseph_adf_unit_root_test
...
`print(result)` render. See `moirais.fn.describe('joadf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joadf import *
import numpy as np
# See the function signature in fn/joadf.py for argument names.
```
