...
`print(result)` render. See `moirais.fn.describe('semgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semgmm import *
import numpy as np
# See the function signature in fn/semgmm.py for argument names.
```
