...
__all__ = ["hedderich_chapter_9_unnumbered_1991"]


def hedderich_chapter_9_unnumbered_1991(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + elseif ( i% %2==1 & 1 <= i & i <=n / 2 ) { g [ i ] <− 2* i −1 }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1991')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1991: GeneralStatistics expression (auto-extracted; see ref)."
