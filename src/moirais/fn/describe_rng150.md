# describe('rng150') — rangayyan_ch3_wiener_frequency_response
...
`print(result)` render. See `moirais.fn.describe('rng150')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng150 import *
import numpy as np
# See the function signature in fn/rng150.py for argument names.
```
