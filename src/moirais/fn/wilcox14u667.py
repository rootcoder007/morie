...
__all__ = ["wilcox_chapter_14_unnumbered_667"]


def wilcox_chapter_14_unnumbered_667(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SSWG = 3026 − 2890 = 136,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u667')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u667: GeneralStatistics expression (auto-extracted; see ref)."
