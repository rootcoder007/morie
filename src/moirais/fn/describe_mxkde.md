...
`print(result)` render. See `moirais.fn.describe('mxkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxkde import *
import numpy as np
# See the function signature in fn/mxkde.py for argument names.
```
