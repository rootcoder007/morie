...
__all__ = ["hedderich_chapter_9_unnumbered_22"]


def hedderich_chapter_9_unnumbered_22(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺ xi = 1, 2, 3; (1 + 2 + 3) 2 = 36 = (1 2 + 22 + 32) + 2(1·2 + 1·3 + 2·3)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u22')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u22: GeneralStatistics expression (auto-extracted; see ref)."
