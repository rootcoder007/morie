...
`print(result)` render. See `moirais.fn.describe('mtinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtinf import *
import numpy as np
# See the function signature in fn/mtinf.py for argument names.
```
