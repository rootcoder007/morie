...
`print(result)` render. See `moirais.fn.describe('wqno2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqno2 import *
import numpy as np
# See the function signature in fn/wqno2.py for argument names.
```
