# describe('msm184') — mvsml_ridge_lasso_elastic_eq_9_9
...
`print(result)` render. See `moirais.fn.describe('msm184')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm184 import *
import numpy as np
# See the function signature in fn/msm184.py for argument names.
```
