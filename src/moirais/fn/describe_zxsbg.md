# describe('zxsbg') — spatial_bagging
...
`print(result)` render. See `moirais.fn.describe('zxsbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsbg import *
import numpy as np
# See the function signature in fn/zxsbg.py for argument names.
```
