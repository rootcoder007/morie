...
def ca_chapter_5_unnumbered_182(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca5u182')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Inference expression involving 'independent' (auto-extracted; see reference for full context)."},
    )
