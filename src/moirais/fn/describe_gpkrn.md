# describe('gpkrn') — squared_exponential_kernel
...
`print(result)` render. See `moirais.fn.describe('gpkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpkrn import *
import numpy as np
# See the function signature in fn/gpkrn.py for argument names.
```
