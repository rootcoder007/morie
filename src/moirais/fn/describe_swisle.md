...
`print(result)` render. See `moirais.fn.describe('swisle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swisle import *
import numpy as np
# See the function signature in fn/swisle.py for argument names.
```
