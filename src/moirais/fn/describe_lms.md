...
`print(result)` render. See `moirais.fn.describe('lms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lms import *
import numpy as np
# See the function signature in fn/lms.py for argument names.
```
