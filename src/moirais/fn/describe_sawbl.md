...
`print(result)` render. See `moirais.fn.describe('sawbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawbl import *
import numpy as np
# See the function signature in fn/sawbl.py for argument names.
```
