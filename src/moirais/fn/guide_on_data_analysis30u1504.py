...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1504"]


def guide_on_data_analysis_chapter_30_unnumbered_1504(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -3 x cohort = 7 -0.84 (0.80)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1504')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1504: GeneralStatistics expression (auto-extracted; see ref)."
