...
`print(result)` render. See `moirais.fn.describe('pmfsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmfsc import *
import numpy as np
# See the function signature in fn/pmfsc.py for argument names.
```
