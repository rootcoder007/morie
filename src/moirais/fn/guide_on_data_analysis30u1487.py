...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1487"]


def guide_on_data_analysis_chapter_30_unnumbered_1487(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -6 x cohort = 8 -0.66 (0.57)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1487')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1487: GeneralStatistics expression (auto-extracted; see ref)."
