...
`print(result)` render. See `moirais.fn.describe('evbgpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evbgpd import *
import numpy as np
# See the function signature in fn/evbgpd.py for argument names.
```
