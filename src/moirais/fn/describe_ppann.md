...
`print(result)` render. See `moirais.fn.describe('ppann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppann import *
import numpy as np
# See the function signature in fn/ppann.py for argument names.
```
