...
`print(result)` render. See `moirais.fn.describe('seclb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclb import *
import numpy as np
# See the function signature in fn/seclb.py for argument names.
```
