...
`print(result)` render. See `moirais.fn.describe('twave')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.twave import *
import numpy as np
# See the function signature in fn/twave.py for argument names.
```
