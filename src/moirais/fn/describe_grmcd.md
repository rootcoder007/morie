# describe('grmcd') — geron_mc_dropout
...
`print(result)` render. See `moirais.fn.describe('grmcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmcd import *
import numpy as np
# See the function signature in fn/grmcd.py for argument names.
```
