# describe('cov2s') — two_sample_coverage
...
`print(result)` render. See `moirais.fn.describe('cov2s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cov2s import *
import numpy as np
# See the function signature in fn/cov2s.py for argument names.
```
