...
`print(result)` render. See `moirais.fn.describe('ergmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ergmod import *
import numpy as np
# See the function signature in fn/ergmod.py for argument names.
```
