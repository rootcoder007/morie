...
`print(result)` render. See `moirais.fn.describe('soirn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soirn import *
import numpy as np
# See the function signature in fn/soirn.py for argument names.
```
