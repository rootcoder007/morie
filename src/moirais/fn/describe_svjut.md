...
`print(result)` render. See `moirais.fn.describe('svjut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svjut import *
import numpy as np
# See the function signature in fn/svjut.py for argument names.
```
