# describe('medCI') — asymmetric_indirect_ci
...
`print(result)` render. See `moirais.fn.describe('medCI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medCI import *
import numpy as np
# See the function signature in fn/medCI.py for argument names.
```
