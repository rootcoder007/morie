...
`print(result)` render. See `moirais.fn.describe('nwtrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwtrp import *
import numpy as np
# See the function signature in fn/nwtrp.py for argument names.
```
