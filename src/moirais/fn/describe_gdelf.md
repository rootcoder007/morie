...
`print(result)` render. See `moirais.fn.describe('gdelf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdelf import *
import numpy as np
# See the function signature in fn/gdelf.py for argument names.
```
