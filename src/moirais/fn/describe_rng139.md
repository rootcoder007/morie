# describe('rng139') — rangayyan_ch3_wiener_output_dot_product
...
`print(result)` render. See `moirais.fn.describe('rng139')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng139 import *
import numpy as np
# See the function signature in fn/rng139.py for argument names.
```
