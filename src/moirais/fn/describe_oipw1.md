# describe('oipw1') — otis_ipw_placement
...
`print(result)` render. See `moirais.fn.describe('oipw1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oipw1 import *
import numpy as np
# See the function signature in fn/oipw1.py for argument names.
```
