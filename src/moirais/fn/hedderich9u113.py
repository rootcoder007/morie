...
__all__ = ["hedderich_chapter_9_unnumbered_113"]


def hedderich_chapter_9_unnumbered_113(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Cotangent: y =ctg(x) = EF = Adjacent
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u113')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u113: GeneralStatistics expression (auto-extracted; see ref)."
