...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_36"]


def guide_on_data_analysis_chapter_2_unnumbered_36(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜇 = 𝐸[𝑋] ∑𝑥 𝑥𝑓(𝑥) ∫
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u36')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u36: GeneralStatistics expression (auto-extracted; see ref)."
