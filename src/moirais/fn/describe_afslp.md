...
`print(result)` render. See `moirais.fn.describe('afslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslp import *
import numpy as np
# See the function signature in fn/afslp.py for argument names.
```
