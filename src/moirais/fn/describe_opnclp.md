...
`print(result)` render. See `moirais.fn.describe('opnclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opnclp import *
import numpy as np
# See the function signature in fn/opnclp.py for argument names.
```
