...
`print(result)` render. See `moirais.fn.describe('pcasg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcasg import *
import numpy as np
# See the function signature in fn/pcasg.py for argument names.
```
