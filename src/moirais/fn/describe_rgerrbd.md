# describe('rgerrbd') — rangayyan_bayes_error_bound
...
`print(result)` render. See `moirais.fn.describe('rgerrbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgerrbd import *
import numpy as np
# See the function signature in fn/rgerrbd.py for argument names.
```
