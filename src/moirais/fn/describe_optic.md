...
`print(result)` render. See `moirais.fn.describe('optic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optic import *
import numpy as np
# See the function signature in fn/optic.py for argument names.
```
