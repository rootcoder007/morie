# describe('msm152') — mvsml_categorical_count_eq_8_12
...
`print(result)` render. See `moirais.fn.describe('msm152')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm152 import *
import numpy as np
# See the function signature in fn/msm152.py for argument names.
```
