# describe('elpd') — expected_log_pred

## WHAT IT DOES

Expected Log Predictive Density. 'Life is really simple, but we insist on making it complicated. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('elpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elpd import *
import numpy as np
# See the function signature in fn/elpd.py for argument names.
```
