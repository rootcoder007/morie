...
__all__ = ["hedderich_chapter_9_unnumbered_2936"]


def hedderich_chapter_9_unnumbered_2936(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( alternative == " two − sided " ) { # two−s ided
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2936')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2936: GeneralStatistics expression (auto-extracted; see ref)."
