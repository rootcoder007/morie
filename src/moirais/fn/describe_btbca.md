...
`print(result)` render. See `moirais.fn.describe('btbca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btbca import *
import numpy as np
# See the function signature in fn/btbca.py for argument names.
```
