# describe('rgacc') — rangayyan_accuracy
...
`print(result)` render. See `moirais.fn.describe('rgacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgacc import *
import numpy as np
# See the function signature in fn/rgacc.py for argument names.
```
