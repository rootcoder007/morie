# describe('lsf') — line_spectral_freq_fn
...
`print(result)` render. See `moirais.fn.describe('lsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lsf import *
import numpy as np
# See the function signature in fn/lsf.py for argument names.
```
