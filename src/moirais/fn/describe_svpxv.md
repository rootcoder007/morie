...
`print(result)` render. See `moirais.fn.describe('svpxv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpxv import *
import numpy as np
# See the function signature in fn/svpxv.py for argument names.
```
