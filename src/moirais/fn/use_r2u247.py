...
__all__ = ["use_r_chapter_2_unnumbered_247"]


def use_r_chapter_2_unnumbered_247(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u247')`` for the full guide.
...
def cheatsheet():
    return "use_r2u247: GeneralStatistics expression (auto-extracted; see ref)."
