...
`print(result)` render. See `moirais.fn.describe('zsgrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgrr import *
import numpy as np
# See the function signature in fn/zsgrr.py for argument names.
```
