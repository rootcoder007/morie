# describe('krgre') — krgre

## WHAT IT DOES

Kriging residual analysis
...
`print(result)` render. See `moirais.fn.describe('krgre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgre import *
import numpy as np
# See the function signature in fn/krgre.py for argument names.
```
