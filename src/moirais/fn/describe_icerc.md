...
`print(result)` render. See `moirais.fn.describe('icerc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icerc import *
import numpy as np
# See the function signature in fn/icerc.py for argument names.
```
