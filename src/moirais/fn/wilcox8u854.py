...
__all__ = ["wilcox_chapter_8_unnumbered_854"]


def wilcox_chapter_8_unnumbered_854(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u854')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u854: GeneralStatistics expression (auto-extracted; see ref)."
