...
`print(result)` render. See `moirais.fn.describe('nncvx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nncvx import *
import numpy as np
# See the function signature in fn/nncvx.py for argument names.
```
