...
`print(result)` render. See `moirais.fn.describe('csaor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csaor import *
import numpy as np
# See the function signature in fn/csaor.py for argument names.
```
