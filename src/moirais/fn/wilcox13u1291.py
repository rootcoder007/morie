...
__all__ = ["wilcox_chapter_13_unnumbered_1291"]


def wilcox_chapter_13_unnumbered_1291(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] ν = (R − 1)(C − 1).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1291')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1291: ContingencyTables expression (auto-extracted; see ref)."
