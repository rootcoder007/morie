...
`print(result)` render. See `moirais.fn.describe('psgmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psgmb import *
import numpy as np
# See the function signature in fn/psgmb.py for argument names.
```
