# describe('predg') — prediction_gain
...
`print(result)` render. See `moirais.fn.describe('predg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.predg import *
import numpy as np
# See the function signature in fn/predg.py for argument names.
```
