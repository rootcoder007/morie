...
__all__ = ["hedderich_chapter_9_unnumbered_152"]


def hedderich_chapter_9_unnumbered_152(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t a u_ Col : Row = 0 . 2 3 6 and t a u _Row : Col = 0 . 2 8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u152')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u152: GeneralStatistics expression (auto-extracted; see ref)."
