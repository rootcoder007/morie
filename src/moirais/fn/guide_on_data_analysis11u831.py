...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_831"]


def guide_on_data_analysis_chapter_11_unnumbered_831(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> z = 37.13, p-value < 2.2e-16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u831')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u831: GeneralStatistics expression (auto-extracted; see ref)."
