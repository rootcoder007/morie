...
`print(result)` render. See `moirais.fn.describe('fosimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fosimp import *
import numpy as np
# See the function signature in fn/fosimp.py for argument names.
```
