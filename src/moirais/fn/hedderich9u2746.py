...
__all__ = ["hedderich_chapter_9_unnumbered_2746"]


def hedderich_chapter_9_unnumbered_2746(x):
    """
    MetaAnalysis expression (auto-extracted; see ref).

    Formula: ARR =CER−EER = 0.20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2746')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2746: MetaAnalysis expression (auto-extracted; see ref)."
