...
`print(result)` render. See `moirais.fn.describe('robns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robns import *
import numpy as np
# See the function signature in fn/robns.py for argument names.
```
