...
`print(result)` render. See `moirais.fn.describe('clpfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clpfc import *
import numpy as np
# See the function signature in fn/clpfc.py for argument names.
```
