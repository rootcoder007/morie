...
`print(result)` render. See `moirais.fn.describe('catnxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catnxt import *
import numpy as np
# See the function signature in fn/catnxt.py for argument names.
```
