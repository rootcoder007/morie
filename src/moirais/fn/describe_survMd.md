# describe('survMd') — survival_mediation
...
`print(result)` render. See `moirais.fn.describe('survMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survMd import *
import numpy as np
# See the function signature in fn/survMd.py for argument names.
```
