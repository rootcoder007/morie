...
`print(result)` render. See `moirais.fn.describe('gdref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdref import *
import numpy as np
# See the function signature in fn/gdref.py for argument names.
```
