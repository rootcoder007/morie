# describe('sgkse') — standardized_prediction_error
...
`print(result)` render. See `moirais.fn.describe('sgkse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgkse import *
import numpy as np
# See the function signature in fn/sgkse.py for argument names.
```
