...
`print(result)` render. See `moirais.fn.describe('vdclip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdclip import *
import numpy as np
# See the function signature in fn/vdclip.py for argument names.
```
