...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_311"]


def guide_on_data_analysis_chapter_5_unnumbered_311(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑎 = 1 − 𝑆𝑆𝐸/(𝑛 − 𝑝)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u311')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u311: GeneralStatistics expression (auto-extracted; see ref)."
