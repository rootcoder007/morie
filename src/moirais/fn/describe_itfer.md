# describe('itfer') — interference_effects
...
`print(result)` render. See `moirais.fn.describe('itfer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itfer import *
import numpy as np
# See the function signature in fn/itfer.py for argument names.
```
