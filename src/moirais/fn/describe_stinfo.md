...
`print(result)` render. See `moirais.fn.describe('stinfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stinfo import *
import numpy as np
# See the function signature in fn/stinfo.py for argument names.
```
