...
`print(result)` render. See `moirais.fn.describe('sofm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sofm import *
import numpy as np
# See the function signature in fn/sofm.py for argument names.
```
