# describe('pdcoin') — pedroni_panel_cointegration
...
`print(result)` render. See `moirais.fn.describe('pdcoin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdcoin import *
import numpy as np
# See the function signature in fn/pdcoin.py for argument names.
```
