...
`print(result)` render. See `moirais.fn.describe('trkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trkrn import *
import numpy as np
# See the function signature in fn/trkrn.py for argument names.
```
