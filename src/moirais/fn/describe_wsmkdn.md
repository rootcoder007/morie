...
`print(result)` render. See `moirais.fn.describe('wsmkdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmkdn import *
import numpy as np
# See the function signature in fn/wsmkdn.py for argument names.
```
