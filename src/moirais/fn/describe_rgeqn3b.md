# describe('rgeqn3b') — rangayyan_ch3_correlation_sum
...
`print(result)` render. See `moirais.fn.describe('rgeqn3b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn3b import *
import numpy as np
# See the function signature in fn/rgeqn3b.py for argument names.
```
