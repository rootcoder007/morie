...
__all__ = ["hedderich_chapter_9_unnumbered_2001"]


def hedderich_chapter_9_unnumbered_2001(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] µMN =E[MN ] = n(N 2−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2001')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2001: GeneralStatistics expression (auto-extracted; see ref)."
