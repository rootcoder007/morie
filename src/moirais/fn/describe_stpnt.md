# describe('stpnt') — spacetime_intensity
...
`print(result)` render. See `moirais.fn.describe('stpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stpnt import *
import numpy as np
# See the function signature in fn/stpnt.py for argument names.
```
