...
__all__ = ["hedderich_chapter_9_unnumbered_1334"]


def hedderich_chapter_9_unnumbered_1334(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + plev <− pbinom ( upper −1 , size =n , prob =p )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1334')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1334: GeneralStatistics expression (auto-extracted; see ref)."
