# describe('gb1122t') — gibbons_kendall_ties
...
`print(result)` render. See `moirais.fn.describe('gb1122t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1122t import *
import numpy as np
# See the function signature in fn/gb1122t.py for argument names.
```
