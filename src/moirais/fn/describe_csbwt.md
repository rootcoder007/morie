...
`print(result)` render. See `moirais.fn.describe('csbwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csbwt import *
import numpy as np
# See the function signature in fn/csbwt.py for argument names.
```
