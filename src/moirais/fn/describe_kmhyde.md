# describe('kmhyde') — kamath_hyde_hypothetical_doc
...
`print(result)` render. See `moirais.fn.describe('kmhyde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmhyde import *
import numpy as np
# See the function signature in fn/kmhyde.py for argument names.
```
