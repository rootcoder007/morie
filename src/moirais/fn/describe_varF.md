# describe('varF') — vector_autoregression
...
`print(result)` render. See `moirais.fn.describe('varF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varF import *
import numpy as np
# See the function signature in fn/varF.py for argument names.
```
