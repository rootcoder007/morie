# describe('otws') — ot_wasserstein_1d
...
`print(result)` render. See `moirais.fn.describe('otws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otws import *
import numpy as np
# See the function signature in fn/otws.py for argument names.
```
