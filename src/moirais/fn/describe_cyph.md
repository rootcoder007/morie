...
`print(result)` render. See `moirais.fn.describe('cyph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cyph import *
import numpy as np
# See the function signature in fn/cyph.py for argument names.
```
