...
`print(result)` render. See `moirais.fn.describe('wlsrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlsrg import *
import numpy as np
# See the function signature in fn/wlsrg.py for argument names.
```
