# describe('dalyc') — daly_computation
...
`print(result)` render. See `moirais.fn.describe('dalyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dalyc import *
import numpy as np
# See the function signature in fn/dalyc.py for argument names.
```
