# describe('sgtlap2') — sgt_laplacian_eigenmaps
...
`print(result)` render. See `moirais.fn.describe('sgtlap2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtlap2 import *
import numpy as np
# See the function signature in fn/sgtlap2.py for argument names.
```
