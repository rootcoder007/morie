...
`print(result)` render. See `moirais.fn.describe('psinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psinv import *
import numpy as np
# See the function signature in fn/psinv.py for argument names.
```
