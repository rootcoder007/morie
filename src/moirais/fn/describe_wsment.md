# describe('wsment') — wasserman_entropy
...
`print(result)` render. See `moirais.fn.describe('wsment')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsment import *
import numpy as np
# See the function signature in fn/wsment.py for argument names.
```
