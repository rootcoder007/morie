...
`print(result)` render. See `moirais.fn.describe('mtstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtstr import *
import numpy as np
# See the function signature in fn/mtstr.py for argument names.
```
