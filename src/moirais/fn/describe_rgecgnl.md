# describe('rgecgnl') — rangayyan_ecg_normal_ectopic
...
`print(result)` render. See `moirais.fn.describe('rgecgnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgecgnl import *
import numpy as np
# See the function signature in fn/rgecgnl.py for argument names.
```
