...
`print(result)` render. See `moirais.fn.describe('rlear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlear import *
import numpy as np
# See the function signature in fn/rlear.py for argument names.
```
