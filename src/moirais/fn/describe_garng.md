...
`print(result)` render. See `moirais.fn.describe('garng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.garng import *
import numpy as np
# See the function signature in fn/garng.py for argument names.
```
