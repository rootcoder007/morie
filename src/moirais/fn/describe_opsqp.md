...
`print(result)` render. See `moirais.fn.describe('opsqp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opsqp import *
import numpy as np
# See the function signature in fn/opsqp.py for argument names.
```
