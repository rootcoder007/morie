...
`print(result)` render. See `moirais.fn.describe('spglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spglm import *
import numpy as np
# See the function signature in fn/spglm.py for argument names.
```
