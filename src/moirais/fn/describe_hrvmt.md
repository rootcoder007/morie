...
`print(result)` render. See `moirais.fn.describe('hrvmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvmt import *
import numpy as np
# See the function signature in fn/hrvmt.py for argument names.
```
