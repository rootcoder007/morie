# describe('hmsslc') — geron_semisupervised_cluster
...
`print(result)` render. See `moirais.fn.describe('hmsslc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsslc import *
import numpy as np
# See the function signature in fn/hmsslc.py for argument names.
```
