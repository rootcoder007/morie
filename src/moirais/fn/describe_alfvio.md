# describe('alfvio') — alphafold_violation
...
`print(result)` render. See `moirais.fn.describe('alfvio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfvio import *
import numpy as np
# See the function signature in fn/alfvio.py for argument names.
```
