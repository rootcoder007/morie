...
`print(result)` render. See `moirais.fn.describe('msmiv2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmiv2 import *
import numpy as np
# See the function signature in fn/msmiv2.py for argument names.
```
