...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_509"]


def guide_on_data_analysis_chapter_6_unnumbered_509(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: theme_minimal(base_size = 11) +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u509')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u509: GeneralStatistics expression (auto-extracted; see ref)."
