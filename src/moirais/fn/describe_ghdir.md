# describe('ghdir') — ghosal_dirichlet_posterior
...
`print(result)` render. See `moirais.fn.describe('ghdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghdir import *
import numpy as np
# See the function signature in fn/ghdir.py for argument names.
```
