...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_946"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_946(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n,λ,δ : δ} ⊂ Q through Qn,λ at δ = δ0 ≡ 0 indexed by a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u946')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u946: GeneralStatistics expression (auto-extracted; see ref)."
