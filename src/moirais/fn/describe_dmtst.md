...
`print(result)` render. See `moirais.fn.describe('dmtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmtst import *
import numpy as np
# See the function signature in fn/dmtst.py for argument names.
```
