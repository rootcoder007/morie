...
__all__ = ["hedderich_chapter_9_unnumbered_3437"]


def hedderich_chapter_9_unnumbered_3437(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3437')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3437: GeneralStatistics expression (auto-extracted; see ref)."
