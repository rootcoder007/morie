...
`print(result)` render. See `moirais.fn.describe('wndchl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wndchl import *
import numpy as np
# See the function signature in fn/wndchl.py for argument names.
```
