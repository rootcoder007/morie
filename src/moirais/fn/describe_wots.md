...
`print(result)` render. See `moirais.fn.describe('wots')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wots import *
import numpy as np
# See the function signature in fn/wots.py for argument names.
```
