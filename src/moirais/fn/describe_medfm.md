# describe('medfm') — mediation_formula
...
`print(result)` render. See `moirais.fn.describe('medfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medfm import *
import numpy as np
# See the function signature in fn/medfm.py for argument names.
```
