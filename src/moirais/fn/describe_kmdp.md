# describe('kmdp') — kamath_differential_privacy
...
`print(result)` render. See `moirais.fn.describe('kmdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmdp import *
import numpy as np
# See the function signature in fn/kmdp.py for argument names.
```
