...
__all__ = ["hedderich_chapter_9_unnumbered_668"]


def hedderich_chapter_9_unnumbered_668(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (≥2|1)≈1−2·0.368 = 0.264
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u668')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u668: CountModels expression (auto-extracted; see ref)."
