# describe('sgzts') — asymptotic_z_test
...
`print(result)` render. See `moirais.fn.describe('sgzts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgzts import *
import numpy as np
# See the function signature in fn/sgzts.py for argument names.
```
