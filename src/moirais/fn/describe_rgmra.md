...
`print(result)` render. See `moirais.fn.describe('rgmra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmra import *
import numpy as np
# See the function signature in fn/rgmra.py for argument names.
```
