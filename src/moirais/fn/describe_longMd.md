# describe('longMd') — longitudinal_mediation
...
`print(result)` render. See `moirais.fn.describe('longMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.longMd import *
import numpy as np
# See the function signature in fn/longMd.py for argument names.
```
