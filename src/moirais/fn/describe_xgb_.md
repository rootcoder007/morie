...
`print(result)` render. See `moirais.fn.describe('xgb_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xgb_ import *
import numpy as np
# See the function signature in fn/xgb_.py for argument names.
```
