...
`print(result)` render. See `moirais.fn.describe('bkmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkmed import *
import numpy as np
# See the function signature in fn/bkmed.py for argument names.
```
