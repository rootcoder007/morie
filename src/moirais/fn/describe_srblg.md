...
`print(result)` render. See `moirais.fn.describe('srblg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srblg import *
import numpy as np
# See the function signature in fn/srblg.py for argument names.
```
