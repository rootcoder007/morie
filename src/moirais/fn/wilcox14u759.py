...
__all__ = ["wilcox_chapter_14_unnumbered_759"]


def wilcox_chapter_14_unnumbered_759(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: R2 = 3 + 7 + 8 = 18, and R3 = 9 + 10 + 5 + 4 = 28. The number of groups is J = 3,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u759')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u759: GeneralStatistics expression (auto-extracted; see ref)."
