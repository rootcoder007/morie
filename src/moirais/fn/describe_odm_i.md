# describe('odm_i') — otis_demo_index
...
`print(result)` render. See `moirais.fn.describe('odm_i')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_i import *
import numpy as np
# See the function signature in fn/odm_i.py for argument names.
```
