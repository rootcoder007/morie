# describe('rgsepix') — rangayyan_separability_index
...
`print(result)` render. See `moirais.fn.describe('rgsepix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsepix import *
import numpy as np
# See the function signature in fn/rgsepix.py for argument names.
```
