# describe('eslnnb') — esl_naive_bayes
...
`print(result)` render. See `moirais.fn.describe('eslnnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnnb import *
import numpy as np
# See the function signature in fn/eslnnb.py for argument names.
```
