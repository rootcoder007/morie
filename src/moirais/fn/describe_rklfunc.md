...
`print(result)` render. See `moirais.fn.describe('rklfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rklfunc import *
import numpy as np
# See the function signature in fn/rklfunc.py for argument names.
```
