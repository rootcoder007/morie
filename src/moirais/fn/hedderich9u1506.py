...
__all__ = ["hedderich_chapter_9_unnumbered_1506"]


def hedderich_chapter_9_unnumbered_1506(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] √ (n−1)(1 + 1/n)z2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1506')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1506: GeneralStatistics expression (auto-extracted; see ref)."
