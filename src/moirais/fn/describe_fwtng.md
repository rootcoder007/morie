...
`print(result)` render. See `moirais.fn.describe('fwtng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fwtng import *
import numpy as np
# See the function signature in fn/fwtng.py for argument names.
```
