# describe('remeta') — random_effects_meta
...
`print(result)` render. See `moirais.fn.describe('remeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.remeta import *
import numpy as np
# See the function signature in fn/remeta.py for argument names.
```
