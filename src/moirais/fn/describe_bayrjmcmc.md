# describe('bayrjmcmc') — reversible_jump_mcmc
...
`print(result)` render. See `moirais.fn.describe('bayrjmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayrjmcmc import *
import numpy as np
# See the function signature in fn/bayrjmcmc.py for argument names.
```
