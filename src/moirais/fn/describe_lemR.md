...
`print(result)` render. See `moirais.fn.describe('lemR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lemR import *
import numpy as np
# See the function signature in fn/lemR.py for argument names.
```
