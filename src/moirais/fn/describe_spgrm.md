...
`print(result)` render. See `moirais.fn.describe('spgrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgrm import *
import numpy as np
# See the function signature in fn/spgrm.py for argument names.
```
