...
__all__ = ["wilcox_chapter_10_unnumbered_994"]


def wilcox_chapter_10_unnumbered_994(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: mcp2a(J,K,x,est=onestep,con=0,alpha=0.05,nboot=NA,grp=NA,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u994')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u994: GeneralStatistics expression (auto-extracted; see ref)."
