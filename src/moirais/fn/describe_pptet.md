...
`print(result)` render. See `moirais.fn.describe('pptet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pptet import *
import numpy as np
# See the function signature in fn/pptet.py for argument names.
```
