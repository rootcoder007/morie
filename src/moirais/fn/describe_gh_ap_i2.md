# describe('gh_ap_i2') — ghosal_dudley_entropy
...
`print(result)` render. See `moirais.fn.describe('gh_ap_i2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_i2 import *
import numpy as np
# See the function signature in fn/gh_ap_i2.py for argument names.
```
