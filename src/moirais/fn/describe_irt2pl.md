# describe('irt2pl') — two_parameter_logistic
...
`print(result)` render. See `moirais.fn.describe('irt2pl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt2pl import *
import numpy as np
# See the function signature in fn/irt2pl.py for argument names.
```
