...
__all__ = ["bivand2013_chapter_7_unnumbered_194"]


def bivand2013_chapter_7_unnumbered_194(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + data = NY8, family = "CAR", listw = NYlistw)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u194')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u194: GeneralStatistics expression (auto-extracted; see ref)."
