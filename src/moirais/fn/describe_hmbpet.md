# describe('hmbpet') — geron_bpe_tokenizer
...
`print(result)` render. See `moirais.fn.describe('hmbpet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbpet import *
import numpy as np
# See the function signature in fn/hmbpet.py for argument names.
```
