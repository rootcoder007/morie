...
`print(result)` render. See `moirais.fn.describe('cvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvar import *
import numpy as np
# See the function signature in fn/cvar.py for argument names.
```
