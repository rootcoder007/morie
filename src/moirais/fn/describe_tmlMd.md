...
`print(result)` render. See `moirais.fn.describe('tmlMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlMd import *
import numpy as np
# See the function signature in fn/tmlMd.py for argument names.
```
