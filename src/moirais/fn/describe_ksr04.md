# describe('ksr04') — kosorok_vc_dimension
...
`print(result)` render. See `moirais.fn.describe('ksr04')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr04 import *
import numpy as np
# See the function signature in fn/ksr04.py for argument names.
```
