...
`print(result)` render. See `moirais.fn.describe('fkrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fkrad import *
import numpy as np
# See the function signature in fn/fkrad.py for argument names.
```
