# describe('vardec') — var_variance_decomp
...
`print(result)` render. See `moirais.fn.describe('vardec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vardec import *
import numpy as np
# See the function signature in fn/vardec.py for argument names.
```
