...
__all__ = ["hedderich_chapter_9_unnumbered_3074"]


def hedderich_chapter_9_unnumbered_3074(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( Image = 1 : 1 0 , Examiner = c ( "U1" , "U2" , "U3" , "U4" , "U5" ) ) ) ; data
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3074')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3074: GeneralStatistics expression (auto-extracted; see ref)."
