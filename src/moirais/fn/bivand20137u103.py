...
__all__ = ["bivand2013_chapter_7_unnumbered_103"]


def bivand2013_chapter_7_unnumbered_103(x):
    """
    Spatial expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u103')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u103: Spatial expression (auto-extracted; see ref)."
