...
`print(result)` render. See `moirais.fn.describe('volyz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volyz import *
import numpy as np
# See the function signature in fn/volyz.py for argument names.
```
