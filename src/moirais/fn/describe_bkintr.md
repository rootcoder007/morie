# describe('bkintr') — burkov_ngram_interpolation
...
`print(result)` render. See `moirais.fn.describe('bkintr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkintr import *
import numpy as np
# See the function signature in fn/bkintr.py for argument names.
```
