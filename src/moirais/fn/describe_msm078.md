# describe('msm078') — mvsml_bayesian_regression_eq_6_9
...
`print(result)` render. See `moirais.fn.describe('msm078')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm078 import *
import numpy as np
# See the function signature in fn/msm078.py for argument names.
```
