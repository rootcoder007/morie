...
`print(result)` render. See `moirais.fn.describe('thom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thom import *
import numpy as np
# See the function signature in fn/thom.py for argument names.
```
