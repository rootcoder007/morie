...
`print(result)` render. See `moirais.fn.describe('diophs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diophs import *
import numpy as np
# See the function signature in fn/diophs.py for argument names.
```
