...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1424"]


def guide_on_data_analysis_chapter_29_unnumbered_1424(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: unit_id_var = "id",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1424')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1424: GeneralStatistics expression (auto-extracted; see ref)."
