...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_51"]


def guide_on_data_analysis_chapter_2_unnumbered_51(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: facet_wrap( ~ example, scales = "free") +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u51')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u51: GeneralStatistics expression (auto-extracted; see ref)."
