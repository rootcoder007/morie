# describe('rgchoi') — rangayyan_choi_williams
...
`print(result)` render. See `moirais.fn.describe('rgchoi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgchoi import *
import numpy as np
# See the function signature in fn/rgchoi.py for argument names.
```
