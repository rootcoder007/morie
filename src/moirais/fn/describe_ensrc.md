...
`print(result)` render. See `moirais.fn.describe('ensrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ensrc import *
import numpy as np
# See the function signature in fn/ensrc.py for argument names.
```
