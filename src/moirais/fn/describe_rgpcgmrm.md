# describe('rgpcgmrm') — rangayyan_pcg_murmur_detect
...
`print(result)` render. See `moirais.fn.describe('rgpcgmrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcgmrm import *
import numpy as np
# See the function signature in fn/rgpcgmrm.py for argument names.
```
