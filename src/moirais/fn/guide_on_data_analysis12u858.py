...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_858"]


def guide_on_data_analysis_chapter_12_unnumbered_858(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] bad = sum(credit == 0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u858')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u858: GeneralStatistics expression (auto-extracted; see ref)."
