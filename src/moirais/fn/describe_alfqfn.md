# describe('alfqfn') — alphazero_q_function
...
`print(result)` render. See `moirais.fn.describe('alfqfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfqfn import *
import numpy as np
# See the function signature in fn/alfqfn.py for argument names.
```
