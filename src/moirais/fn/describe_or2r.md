...
`print(result)` render. See `moirais.fn.describe('or2r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.or2r import *
import numpy as np
# See the function signature in fn/or2r.py for argument names.
```
