# describe('xvr') — partial_corr_matrix
...
`print(result)` render. See `moirais.fn.describe('xvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xvr import *
import numpy as np
# See the function signature in fn/xvr.py for argument names.
```
