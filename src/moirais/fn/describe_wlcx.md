...
`print(result)` render. See `moirais.fn.describe('wlcx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcx import *
import numpy as np
# See the function signature in fn/wlcx.py for argument names.
```
