...
`print(result)` render. See `moirais.fn.describe('tmbrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmbrk import *
import numpy as np
# See the function signature in fn/tmbrk.py for argument names.
```
