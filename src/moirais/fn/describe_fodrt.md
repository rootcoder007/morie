...
`print(result)` render. See `moirais.fn.describe('fodrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fodrt import *
import numpy as np
# See the function signature in fn/fodrt.py for argument names.
```
