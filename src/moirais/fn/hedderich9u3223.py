...
__all__ = ["hedderich_chapter_9_unnumbered_3223"]


def hedderich_chapter_9_unnumbered_3223(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To b: Since ˆt = 1.85< 1.99 = t86;0.975,H0 is not rejected at the 5% level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3223')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3223: GeneralStatistics expression (auto-extracted; see ref)."
