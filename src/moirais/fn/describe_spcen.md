# describe('spcen') — spectral_entropy_fn
...
`print(result)` render. See `moirais.fn.describe('spcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcen import *
import numpy as np
# See the function signature in fn/spcen.py for argument names.
```
