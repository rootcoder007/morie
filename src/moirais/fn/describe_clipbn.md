# describe('clipbn') — clip_image_text_align
...
`print(result)` render. See `moirais.fn.describe('clipbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clipbn import *
import numpy as np
# See the function signature in fn/clipbn.py for argument names.
```
