...
`print(result)` render. See `moirais.fn.describe('tssgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssgm import *
import numpy as np
# See the function signature in fn/tssgm.py for argument names.
```
