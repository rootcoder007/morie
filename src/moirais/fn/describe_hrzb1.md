# describe('hrzb1') — horowitz_binary_response
...
`print(result)` render. See `moirais.fn.describe('hrzb1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzb1 import *
import numpy as np
# See the function signature in fn/hrzb1.py for argument names.
```
