# describe('msm073') — mvsml_bayesian_regression_eq_6_8
...
`print(result)` render. See `moirais.fn.describe('msm073')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm073 import *
import numpy as np
# See the function signature in fn/msm073.py for argument names.
```
