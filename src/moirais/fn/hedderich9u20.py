...
__all__ = ["hedderich_chapter_9_unnumbered_20"]


def hedderich_chapter_9_unnumbered_20(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺ a = 2, b= 3, xi = 4 and 5, i.e. n = 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u20')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u20: GeneralStatistics expression (auto-extracted; see ref)."
