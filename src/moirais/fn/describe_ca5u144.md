# describe('ca5u144') — ca_chapter_5_unnumbered_144
...
```python
from moirais.fn.ca5u144 import ca_chapter_5_unnumbered_144
import numpy as np
result = ca_chapter_5_unnumbered_144(np.random.default_rng(42).normal(0, 1, 100))
