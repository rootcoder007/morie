...
__all__ = ["wilcox_chapter_14_unnumbered_465"]


def wilcox_chapter_14_unnumbered_465(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: givenX, is given by Y =β 0 +β 1X. A (rank inversion) method for testing hypotheses about
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u465')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u465: GeneralStatistics expression (auto-extracted; see ref)."
