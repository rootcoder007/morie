...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1021"]


def guide_on_data_analysis_chapter_22_unnumbered_1021(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌𝑖|𝐷𝑖 = 1] − 𝐸[𝑌𝑖|𝐷𝑖 = 0] = 𝐸[𝑌1𝑖 − 𝑌0𝑖]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1021')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1021: GeneralStatistics expression (auto-extracted; see ref)."
