...
__all__ = ["hedderich_chapter_9_unnumbered_2556"]


def hedderich_chapter_9_unnumbered_2556(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |Si−Sj|>t 1−α/2,(b−1)(k−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2556')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2556: GeneralStatistics expression (auto-extracted; see ref)."
