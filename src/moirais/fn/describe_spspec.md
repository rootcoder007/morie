# describe('spspec') — schabenberger_spectral_representation
...
`print(result)` render. See `moirais.fn.describe('spspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spspec import *
import numpy as np
# See the function signature in fn/spspec.py for argument names.
```
