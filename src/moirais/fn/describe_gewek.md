# describe('gewek') — geweke_diagnostic
...
`print(result)` render. See `moirais.fn.describe('gewek')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gewek import *
import numpy as np
# See the function signature in fn/gewek.py for argument names.
```
