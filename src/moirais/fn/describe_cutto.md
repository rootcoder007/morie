...
`print(result)` render. See `moirais.fn.describe('cutto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cutto import *
import numpy as np
# See the function signature in fn/cutto.py for argument names.
```
