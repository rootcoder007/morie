...
__all__ = ["wilcox_chapter_4_unnumbered_135"]


def wilcox_chapter_4_unnumbered_135(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b) P (Z <c) = .9732, (c) P (Z >c) = 0.5691, (d) P (−c ≤ Z ≤ c) = 0.2358.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u135')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u135: GeneralStatistics expression (auto-extracted; see ref)."
