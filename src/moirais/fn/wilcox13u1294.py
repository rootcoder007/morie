...
__all__ = ["wilcox_chapter_13_unnumbered_1294"]


def wilcox_chapter_13_unnumbered_1294(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x=matrix(c(8,5,67,20),ncol=2,byrow=T)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1294')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1294: GeneralStatistics expression (auto-extracted; see ref)."
