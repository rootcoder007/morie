...
`print(result)` render. See `moirais.fn.describe('voron')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voron import *
import numpy as np
# See the function signature in fn/voron.py for argument names.
```
