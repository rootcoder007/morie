# describe('spgls') — schabenberger_gls_spatial
...
`print(result)` render. See `moirais.fn.describe('spgls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgls import *
import numpy as np
# See the function signature in fn/spgls.py for argument names.
```
