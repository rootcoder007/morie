...
`print(result)` render. See `moirais.fn.describe('sdmspil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmspil import *
import numpy as np
# See the function signature in fn/sdmspil.py for argument names.
```
