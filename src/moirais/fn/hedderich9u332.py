...
__all__ = ["hedderich_chapter_9_unnumbered_332"]


def hedderich_chapter_9_unnumbered_332(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Ia·n +b ∑x +c ∑x2 = ∑y
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u332')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u332: GeneralStatistics expression (auto-extracted; see ref)."
