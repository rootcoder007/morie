# describe('mcd') — min_covariance_det
...
`print(result)` render. See `moirais.fn.describe('mcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcd import *
import numpy as np
# See the function signature in fn/mcd.py for argument names.
```
