# describe('msm260') — mvsml_deep_learning_eq_13_2
...
`print(result)` render. See `moirais.fn.describe('msm260')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm260 import *
import numpy as np
# See the function signature in fn/msm260.py for argument names.
```
