...
`print(result)` render. See `moirais.fn.describe('afsln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afsln import *
import numpy as np
# See the function signature in fn/afsln.py for argument names.
```
