...
__all__ = ["hedderich_chapter_9_unnumbered_644"]


def hedderich_chapter_9_unnumbered_644(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u644')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u644: GeneralStatistics expression (auto-extracted; see ref)."
