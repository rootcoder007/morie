...
`print(result)` render. See `moirais.fn.describe('vitfsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitfsv import *
import numpy as np
# See the function signature in fn/vitfsv.py for argument names.
```
