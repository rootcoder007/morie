...
`print(result)` render. See `moirais.fn.describe('euclP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.euclP import *
import numpy as np
# See the function signature in fn/euclP.py for argument names.
```
