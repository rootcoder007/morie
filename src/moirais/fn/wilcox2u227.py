...
__all__ = ["wilcox_chapter_2_unnumbered_227"]


def wilcox_chapter_2_unnumbered_227(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Let ˜X = X +c2/2, ˜ n = n +c2, ˜p = ˜X/ ˜n, ˜q = 1 − ˜p, in which case the 1 − α confidence
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u227')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u227: GeneralStatistics expression (auto-extracted; see ref)."
