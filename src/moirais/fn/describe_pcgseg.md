...
`print(result)` render. See `moirais.fn.describe('pcgseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcgseg import *
import numpy as np
# See the function signature in fn/pcgseg.py for argument names.
```
