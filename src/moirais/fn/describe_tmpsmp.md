...
`print(result)` render. See `moirais.fn.describe('tmpsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmpsmp import *
import numpy as np
# See the function signature in fn/tmpsmp.py for argument names.
```
