...
`print(result)` render. See `moirais.fn.describe('llker')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.llker import *
import numpy as np
# See the function signature in fn/llker.py for argument names.
```
