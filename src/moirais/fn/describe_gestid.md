# describe('gestid') — g_estimation_snm
...
`print(result)` render. See `moirais.fn.describe('gestid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gestid import *
import numpy as np
# See the function signature in fn/gestid.py for argument names.
```
