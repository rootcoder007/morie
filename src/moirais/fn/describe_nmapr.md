...
`print(result)` render. See `moirais.fn.describe('nmapr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmapr import *
import numpy as np
# See the function signature in fn/nmapr.py for argument names.
```
