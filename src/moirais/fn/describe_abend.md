...
`print(result)` render. See `moirais.fn.describe('abend')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abend import *
import numpy as np
# See the function signature in fn/abend.py for argument names.
```
