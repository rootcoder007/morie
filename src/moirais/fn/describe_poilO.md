# describe('poilO') — poisson_loss_dnn
...
`print(result)` render. See `moirais.fn.describe('poilO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poilO import *
import numpy as np
# See the function signature in fn/poilO.py for argument names.
```
