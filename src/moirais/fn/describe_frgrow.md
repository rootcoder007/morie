# describe('frgrow') — fragment_growing
...
`print(result)` render. See `moirais.fn.describe('frgrow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frgrow import *
import numpy as np
# See the function signature in fn/frgrow.py for argument names.
```
