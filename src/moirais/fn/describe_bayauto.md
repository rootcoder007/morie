# describe('bayauto') — autocorrelation_check
...
`print(result)` render. See `moirais.fn.describe('bayauto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayauto import *
import numpy as np
# See the function signature in fn/bayauto.py for argument names.
```
