...
`print(result)` render. See `moirais.fn.describe('si')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.si import *
import numpy as np
# See the function signature in fn/si.py for argument names.
```
