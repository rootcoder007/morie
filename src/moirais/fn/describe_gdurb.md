...
`print(result)` render. See `moirais.fn.describe('gdurb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdurb import *
import numpy as np
# See the function signature in fn/gdurb.py for argument names.
```
