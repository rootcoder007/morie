...
`print(result)` render. See `moirais.fn.describe('rfOOB')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfOOB import *
import numpy as np
# See the function signature in fn/rfOOB.py for argument names.
```
