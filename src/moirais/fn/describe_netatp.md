# describe('netatp') — network_attack_tolerance
...
`print(result)` render. See `moirais.fn.describe('netatp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netatp import *
import numpy as np
# See the function signature in fn/netatp.py for argument names.
```
