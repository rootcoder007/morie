...
__all__ = ["wilcox_chapter_7_unnumbered_348"]


def wilcox_chapter_7_unnumbered_348(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: |Tt| = | − 2.3| = 2.3 is greater than the critical value, reject the hypothesis that the trimmed
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u348')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u348: GeneralStatistics expression (auto-extracted; see ref)."
