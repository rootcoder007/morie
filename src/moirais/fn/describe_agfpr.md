...
`print(result)` render. See `moirais.fn.describe('agfpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agfpr import *
import numpy as np
# See the function signature in fn/agfpr.py for argument names.
```
