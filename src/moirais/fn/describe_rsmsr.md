...
`print(result)` render. See `moirais.fn.describe('rsmsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsmsr import *
import numpy as np
# See the function signature in fn/rsmsr.py for argument names.
```
