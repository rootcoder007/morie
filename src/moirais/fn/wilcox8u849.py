...
__all__ = ["wilcox_chapter_8_unnumbered_849"]


def wilcox_chapter_8_unnumbered_849(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ule: Reject if Ft ≥ f , the 1 − α quantile of an F distribution with degrees of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u849')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u849: GeneralStatistics expression (auto-extracted; see ref)."
