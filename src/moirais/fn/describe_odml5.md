# describe('odml5') — otis_dml_volatility
...
`print(result)` render. See `moirais.fn.describe('odml5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml5 import *
import numpy as np
# See the function signature in fn/odml5.py for argument names.
```
