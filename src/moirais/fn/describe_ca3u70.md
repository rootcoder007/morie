# describe('ca3u70') — ca_chapter_3_unnumbered_70
...
y = 2.322 + 0.185x1 − 0.115x2 + 0.21x1x2
...
```python
from moirais.fn.ca3u70 import ca_chapter_3_unnumbered_70
import numpy as np
result = ca_chapter_3_unnumbered_70(np.random.default_rng(42).normal(0, 1, 100))
