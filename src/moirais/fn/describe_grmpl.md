# describe('grmpl') — geron_max_pooling
...
`print(result)` render. See `moirais.fn.describe('grmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmpl import *
import numpy as np
# See the function signature in fn/grmpl.py for argument names.
```
