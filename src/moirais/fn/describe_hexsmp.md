...
`print(result)` render. See `moirais.fn.describe('hexsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hexsmp import *
import numpy as np
# See the function signature in fn/hexsmp.py for argument names.
```
