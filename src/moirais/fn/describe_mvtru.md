...
`print(result)` render. See `moirais.fn.describe('mvtru')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtru import *
import numpy as np
# See the function signature in fn/mvtru.py for argument names.
```
