# describe('ptmcmc') — parallel_tempering
...
`print(result)` render. See `moirais.fn.describe('ptmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptmcmc import *
import numpy as np
# See the function signature in fn/ptmcmc.py for argument names.
```
