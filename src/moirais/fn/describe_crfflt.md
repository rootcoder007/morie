# describe('crfflt') — christiano_fitzgerald
...
`print(result)` render. See `moirais.fn.describe('crfflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfflt import *
import numpy as np
# See the function signature in fn/crfflt.py for argument names.
```
