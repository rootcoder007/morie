...
__all__ = ["hedderich_chapter_9_unnumbered_3478"]


def hedderich_chapter_9_unnumbered_3478(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆF = 1.93 isF -distributed withν1 = 3 andν2 = 21 degrees of freedom, i.e., there is no significant
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3478')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3478: GeneralStatistics expression (auto-extracted; see ref)."
