...
`print(result)` render. See `moirais.fn.describe('sgthm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgthm import *
import numpy as np
# See the function signature in fn/sgthm.py for argument names.
```
