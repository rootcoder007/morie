...
__all__ = ["wilcox_chapter_13_unnumbered_1284"]


def wilcox_chapter_13_unnumbered_1284(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Total n+1 =n11 +n21 n+2 =n12 +n22 n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1284')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1284: GeneralStatistics expression (auto-extracted; see ref)."
