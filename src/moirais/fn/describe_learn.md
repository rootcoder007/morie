...
`print(result)` render. See `moirais.fn.describe('learn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.learn import *
import numpy as np
# See the function signature in fn/learn.py for argument names.
```
