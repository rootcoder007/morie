...
`print(result)` render. See `moirais.fn.describe('mldsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mldsa import *
import numpy as np
# See the function signature in fn/mldsa.py for argument names.
```
