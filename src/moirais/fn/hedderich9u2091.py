...
__all__ = ["hedderich_chapter_9_unnumbered_2091"]


def hedderich_chapter_9_unnumbered_2091(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] SPC = 100[(N−V )/(N +V )]% = 5.9% .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2091')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2091: CausalInference expression (auto-extracted; see ref)."
