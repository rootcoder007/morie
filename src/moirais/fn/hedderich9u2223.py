...
__all__ = ["hedderich_chapter_9_unnumbered_2223"]


def hedderich_chapter_9_unnumbered_2223(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Withx=10,y=2 andn1=n2=100 results forq0=2 a significant difference (p=0.0386, two-sided)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2223')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2223: GeneralStatistics expression (auto-extracted; see ref)."
