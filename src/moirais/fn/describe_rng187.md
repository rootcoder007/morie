# describe('rng187') — rangayyan_ch4_pan_tompkins_highpass_combined
...
`print(result)` render. See `moirais.fn.describe('rng187')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng187 import *
import numpy as np
# See the function signature in fn/rng187.py for argument names.
```
