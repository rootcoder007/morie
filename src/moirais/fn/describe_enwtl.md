...
`print(result)` render. See `moirais.fn.describe('enwtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enwtl import *
import numpy as np
# See the function signature in fn/enwtl.py for argument names.
```
