...
`print(result)` render. See `moirais.fn.describe('swsym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swsym import *
import numpy as np
# See the function signature in fn/swsym.py for argument names.
```
