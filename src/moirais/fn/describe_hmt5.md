...
`print(result)` render. See `moirais.fn.describe('hmt5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmt5 import *
import numpy as np
# See the function signature in fn/hmt5.py for argument names.
```
