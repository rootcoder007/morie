...
`print(result)` render. See `moirais.fn.describe('mtfpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtfpt import *
import numpy as np
# See the function signature in fn/mtfpt.py for argument names.
```
