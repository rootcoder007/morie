# describe('rng039') — rangayyan_ch3_ma_filter_11pt
...
`print(result)` render. See `moirais.fn.describe('rng039')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng039 import *
import numpy as np
# See the function signature in fn/rng039.py for argument names.
```
