...
__all__ = ["hedderich_chapter_9_unnumbered_1395"]


def hedderich_chapter_9_unnumbered_1395(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i F2(n−i+1),2i,α/2 + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1395')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1395: GeneralStatistics expression (auto-extracted; see ref)."
