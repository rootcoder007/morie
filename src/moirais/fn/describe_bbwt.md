# describe('bbwt') — bb_weight_matrix
...
`print(result)` render. See `moirais.fn.describe('bbwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbwt import *
import numpy as np
# See the function signature in fn/bbwt.py for argument names.
```
