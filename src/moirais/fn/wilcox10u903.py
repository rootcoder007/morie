...
__all__ = ["wilcox_chapter_10_unnumbered_903"]


def wilcox_chapter_10_unnumbered_903(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u903')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u903: GeneralStatistics expression (auto-extracted; see ref)."
