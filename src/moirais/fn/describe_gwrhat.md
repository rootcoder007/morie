...
`print(result)` render. See `moirais.fn.describe('gwrhat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrhat import *
import numpy as np
# See the function signature in fn/gwrhat.py for argument names.
```
