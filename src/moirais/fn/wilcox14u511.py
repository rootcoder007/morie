...
__all__ = ["wilcox_chapter_14_unnumbered_511"]


def wilcox_chapter_14_unnumbered_511(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: T 2 = r12r13r14 +r12r23r24 +r13r23r34 +r14r24r34
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u511')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u511: GeneralStatistics expression (auto-extracted; see ref)."
