# describe('scrng') — score_range_check
...
`print(result)` render. See `moirais.fn.describe('scrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scrng import *
import numpy as np
# See the function signature in fn/scrng.py for argument names.
```
