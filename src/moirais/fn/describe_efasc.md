...
`print(result)` render. See `moirais.fn.describe('efasc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.efasc import *
import numpy as np
# See the function signature in fn/efasc.py for argument names.
```
