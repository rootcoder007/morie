# describe('gb661v') — gibbons_mw_var
...
`print(result)` render. See `moirais.fn.describe('gb661v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb661v import *
import numpy as np
# See the function signature in fn/gb661v.py for argument names.
```
