# describe('ebayes') — empirical_bayes_shrinkage
...
`print(result)` render. See `moirais.fn.describe('ebayes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebayes import *
import numpy as np
# See the function signature in fn/ebayes.py for argument names.
```
