...
`print(result)` render. See `moirais.fn.describe('cllbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cllbl import *
import numpy as np
# See the function signature in fn/cllbl.py for argument names.
```
