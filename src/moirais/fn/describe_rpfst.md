...
`print(result)` render. See `moirais.fn.describe('rpfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpfst import *
import numpy as np
# See the function signature in fn/rpfst.py for argument names.
```
