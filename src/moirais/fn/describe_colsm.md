...
`print(result)` render. See `moirais.fn.describe('colsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.colsm import *
import numpy as np
# See the function signature in fn/colsm.py for argument names.
```
