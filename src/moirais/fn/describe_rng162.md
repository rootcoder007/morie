# describe('rng162') — rangayyan_ch3_lms_step_size_zhang
...
`print(result)` render. See `moirais.fn.describe('rng162')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng162 import *
import numpy as np
# See the function signature in fn/rng162.py for argument names.
```
