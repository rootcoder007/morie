...
__all__ = ["wilcox_chapter_14_unnumbered_565"]


def wilcox_chapter_14_unnumbered_565(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1 − ˆδ 2 +z2ˆσ 2 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u565')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u565: GeneralStatistics expression (auto-extracted; see ref)."
