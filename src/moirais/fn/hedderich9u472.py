...
__all__ = ["hedderich_chapter_9_unnumbered_472"]


def hedderich_chapter_9_unnumbered_472(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (4)P4 = 1−P (B∪C) = 1−P (B)−P (C)+P (B∩C) = 1−0.40−0.30+0.10 = 0.40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u472')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u472: GeneralStatistics expression (auto-extracted; see ref)."
