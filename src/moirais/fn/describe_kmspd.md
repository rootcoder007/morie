# describe('kmspd') — kamath_speculative_decoding
...
`print(result)` render. See `moirais.fn.describe('kmspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmspd import *
import numpy as np
# See the function signature in fn/kmspd.py for argument names.
```
