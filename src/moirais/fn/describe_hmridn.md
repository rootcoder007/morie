# describe('hmridn') — geron_ridge_normal
...
`print(result)` render. See `moirais.fn.describe('hmridn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmridn import *
import numpy as np
# See the function signature in fn/hmridn.py for argument names.
```
