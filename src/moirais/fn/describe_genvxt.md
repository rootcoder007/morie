# describe('genvxt') — generalizability_theory
...
`print(result)` render. See `moirais.fn.describe('genvxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genvxt import *
import numpy as np
# See the function signature in fn/genvxt.py for argument names.
```
