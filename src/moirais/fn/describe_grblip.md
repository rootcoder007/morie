# describe('grblip') — geron_blip_itm_itc
...
`print(result)` render. See `moirais.fn.describe('grblip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grblip import *
import numpy as np
# See the function signature in fn/grblip.py for argument names.
```
