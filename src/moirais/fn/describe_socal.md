...
`print(result)` render. See `moirais.fn.describe('socal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socal import *
import numpy as np
# See the function signature in fn/socal.py for argument names.
```
