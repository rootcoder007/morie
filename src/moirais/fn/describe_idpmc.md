...
`print(result)` render. See `moirais.fn.describe('idpmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpmc import *
import numpy as np
# See the function signature in fn/idpmc.py for argument names.
```
