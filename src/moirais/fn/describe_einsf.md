...
`print(result)` render. See `moirais.fn.describe('einsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.einsf import *
import numpy as np
# See the function signature in fn/einsf.py for argument names.
```
