# describe('gb1461') — gibbons_multinomial_gof
...
`print(result)` render. See `moirais.fn.describe('gb1461')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1461 import *
import numpy as np
# See the function signature in fn/gb1461.py for argument names.
```
