...
`print(result)` render. See `moirais.fn.describe('otemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otemd import *
import numpy as np
# See the function signature in fn/otemd.py for argument names.
```
