...
`print(result)` render. See `moirais.fn.describe('mpclp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpclp import *
import numpy as np
# See the function signature in fn/mpclp.py for argument names.
```
