# describe('jaccr') — jaccard_similarity
...
`print(result)` render. See `moirais.fn.describe('jaccr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jaccr import *
import numpy as np
# See the function signature in fn/jaccr.py for argument names.
```
