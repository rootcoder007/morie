...
__all__ = ["hedderich_chapter_9_unnumbered_945"]


def hedderich_chapter_9_unnumbered_945(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 7. Γ (n + 1) = nΓ(n) = n! forn = 1, 2, 3,...
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u945')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u945: CountModels expression (auto-extracted; see ref)."
