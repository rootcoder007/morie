...
`print(result)` render. See `moirais.fn.describe('rfmax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfmax import *
import numpy as np
# See the function signature in fn/rfmax.py for argument names.
```
