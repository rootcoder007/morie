# describe('impsm') — importance_sampling
...
`print(result)` render. See `moirais.fn.describe('impsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.impsm import *
import numpy as np
# See the function signature in fn/impsm.py for argument names.
```
