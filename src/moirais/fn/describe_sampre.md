# describe('sampre') — sam_prompt_encoder
...
`print(result)` render. See `moirais.fn.describe('sampre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sampre import *
import numpy as np
# See the function signature in fn/sampre.py for argument names.
```
