...
`print(result)` render. See `moirais.fn.describe('arimaF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arimaF import *
import numpy as np
# See the function signature in fn/arimaF.py for argument names.
```
