...
`print(result)` render. See `moirais.fn.describe('cfars')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfars import *
import numpy as np
# See the function signature in fn/cfars.py for argument names.
```
