# describe('tldepu') — upper_tail_dependence
...
`print(result)` render. See `moirais.fn.describe('tldepu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tldepu import *
import numpy as np
# See the function signature in fn/tldepu.py for argument names.
```
