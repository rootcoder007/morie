...
`print(result)` render. See `moirais.fn.describe('swflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swflm import *
import numpy as np
# See the function signature in fn/swflm.py for argument names.
```
