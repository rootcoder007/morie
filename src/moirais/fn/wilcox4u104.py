...
__all__ = ["wilcox_chapter_4_unnumbered_104"]


def wilcox_chapter_4_unnumbered_104(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =P (Z ≤ − 1) = 0.1587,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u104')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u104: GeneralStatistics expression (auto-extracted; see ref)."
