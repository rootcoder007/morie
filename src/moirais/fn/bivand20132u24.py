...
__all__ = ["bivand2013_chapter_2_unnumbered_24"]


def bivand2013_chapter_2_unnumbered_24(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > CRS("+init=epsg:4230")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u24')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u24: GeneralStatistics expression (auto-extracted; see ref)."
