...
`print(result)` render. See `moirais.fn.describe('csrac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrac import *
import numpy as np
# See the function signature in fn/csrac.py for argument names.
```
