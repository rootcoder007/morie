...
`print(result)` render. See `moirais.fn.describe('tmean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmean import *
import numpy as np
# See the function signature in fn/tmean.py for argument names.
```
