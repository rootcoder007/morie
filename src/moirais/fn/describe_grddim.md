# describe('grddim') — geron_ddim_sampling_step
...
`print(result)` render. See `moirais.fn.describe('grddim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grddim import *
import numpy as np
# See the function signature in fn/grddim.py for argument names.
```
