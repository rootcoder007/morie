# describe('hmpru') — geron_weight_pruning
...
`print(result)` render. See `moirais.fn.describe('hmpru')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpru import *
import numpy as np
# See the function signature in fn/hmpru.py for argument names.
```
