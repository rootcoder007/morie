...
`print(result)` render. See `moirais.fn.describe('rnnge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnnge import *
import numpy as np
# See the function signature in fn/rnnge.py for argument names.
```
