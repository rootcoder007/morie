# describe('bnstst') — bound_test_inference
...
`print(result)` render. See `moirais.fn.describe('bnstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnstst import *
import numpy as np
# See the function signature in fn/bnstst.py for argument names.
```
