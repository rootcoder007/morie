# describe('sechsh') — hash_chain_audit
...
`print(result)` render. See `moirais.fn.describe('sechsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sechsh import *
import numpy as np
# See the function signature in fn/sechsh.py for argument names.
```
