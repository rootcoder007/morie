...
__all__ = ["hedderich_chapter_9_unnumbered_661"]


def hedderich_chapter_9_unnumbered_661(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (X + 1)/(n + 1))−arcsin (√p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u661')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u661: GeneralStatistics expression (auto-extracted; see ref)."
