...
__all__ = ["wilcox_chapter_14_unnumbered_509"]


def wilcox_chapter_14_unnumbered_509(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u509')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u509: PowerAndDesign expression (auto-extracted; see ref)."
