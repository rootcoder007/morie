# describe('tm') — melting_temperature
...
`print(result)` render. See `moirais.fn.describe('tm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tm import *
import numpy as np
# See the function signature in fn/tm.py for argument names.
```
