...
__all__ = ["hedderich_chapter_9_unnumbered_1948"]


def hedderich_chapter_9_unnumbered_1948(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [142/(2·500)] + [122/(2·500)] = 3.430> 1.960; i.e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1948')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1948: GeneralStatistics expression (auto-extracted; see ref)."
