...
`print(result)` render. See `moirais.fn.describe('sigrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sigrn import *
import numpy as np
# See the function signature in fn/sigrn.py for argument names.
```
