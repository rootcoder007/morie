...
`print(result)` render. See `moirais.fn.describe('nbeats')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbeats import *
import numpy as np
# See the function signature in fn/nbeats.py for argument names.
```
