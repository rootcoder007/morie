...
`print(result)` render. See `moirais.fn.describe('gls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gls import *
import numpy as np
# See the function signature in fn/gls.py for argument names.
```
