# describe('bptet') — bowman_shenton_test
...
`print(result)` render. See `moirais.fn.describe('bptet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bptet import *
import numpy as np
# See the function signature in fn/bptet.py for argument names.
```
