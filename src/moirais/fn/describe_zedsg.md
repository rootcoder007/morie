# describe('zedsg') — disease_map_gamma
...
`print(result)` render. See `moirais.fn.describe('zedsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zedsg import *
import numpy as np
# See the function signature in fn/zedsg.py for argument names.
```
