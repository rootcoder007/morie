...
`print(result)` render. See `moirais.fn.describe('ncfRS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ncfRS import *
import numpy as np
# See the function signature in fn/ncfRS.py for argument names.
```
