...
`print(result)` render. See `moirais.fn.describe('npbcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npbcox import *
import numpy as np
# See the function signature in fn/npbcox.py for argument names.
```
