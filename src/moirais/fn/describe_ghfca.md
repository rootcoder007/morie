...
`print(result)` render. See `moirais.fn.describe('ghfca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghfca import *
import numpy as np
# See the function signature in fn/ghfca.py for argument names.
```
