...
`print(result)` render. See `moirais.fn.describe('tsser')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsser import *
import numpy as np
# See the function signature in fn/tsser.py for argument names.
```
