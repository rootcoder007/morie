...
`print(result)` render. See `moirais.fn.describe('enhum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enhum import *
import numpy as np
# See the function signature in fn/enhum.py for argument names.
```
