# describe('svipk') — ideal_point_kernel
...
`print(result)` render. See `moirais.fn.describe('svipk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipk import *
import numpy as np
# See the function signature in fn/svipk.py for argument names.
```
