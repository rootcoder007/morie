...
`print(result)` render. See `moirais.fn.describe('mctsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mctsr import *
import numpy as np
# See the function signature in fn/mctsr.py for argument names.
```
