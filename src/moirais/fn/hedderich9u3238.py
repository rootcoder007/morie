...
__all__ = ["hedderich_chapter_9_unnumbered_3238"]


def hedderich_chapter_9_unnumbered_3238(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆy−i =f−1(xi)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3238')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3238: GeneralStatistics expression (auto-extracted; see ref)."
