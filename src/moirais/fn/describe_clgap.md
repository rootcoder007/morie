...
`print(result)` render. See `moirais.fn.describe('clgap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clgap import *
import numpy as np
# See the function signature in fn/clgap.py for argument names.
```
