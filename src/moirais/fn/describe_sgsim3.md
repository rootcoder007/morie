...
`print(result)` render. See `moirais.fn.describe('sgsim3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsim3 import *
import numpy as np
# See the function signature in fn/sgsim3.py for argument names.
```
