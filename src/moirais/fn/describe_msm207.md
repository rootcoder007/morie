# describe('msm207') — mvsml_ridge_lasso_elastic_eq_9_30
...
`print(result)` render. See `moirais.fn.describe('msm207')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm207 import *
import numpy as np
# See the function signature in fn/msm207.py for argument names.
```
