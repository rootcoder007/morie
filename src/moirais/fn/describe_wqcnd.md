...
`print(result)` render. See `moirais.fn.describe('wqcnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqcnd import *
import numpy as np
# See the function signature in fn/wqcnd.py for argument names.
```
