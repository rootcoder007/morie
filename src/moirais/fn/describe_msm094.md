# describe('msm094') — mvsml_bayesian_regression_pt2_eq_7_1
...
`print(result)` render. See `moirais.fn.describe('msm094')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm094 import *
import numpy as np
# See the function signature in fn/msm094.py for argument names.
```
