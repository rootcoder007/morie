# describe('sirdm') — sir_age_demographics
...
`print(result)` render. See `moirais.fn.describe('sirdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirdm import *
import numpy as np
# See the function signature in fn/sirdm.py for argument names.
```
