...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_186"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_186(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] K−1(X)= I(cK−1 X̄<c K),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u186')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u186: GeneralStatistics expression (auto-extracted; see ref)."
