...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1188"]


def guide_on_data_analysis_chapter_24_unnumbered_1188(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑𝑖( ̄𝑌𝑖. − ̄𝑌..)2 ∑𝑗( ̄𝑌.𝑗 − ̄𝑌..)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1188')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1188: GeneralStatistics expression (auto-extracted; see ref)."
