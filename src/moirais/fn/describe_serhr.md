...
`print(result)` render. See `moirais.fn.describe('serhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.serhr import *
import numpy as np
# See the function signature in fn/serhr.py for argument names.
```
