...
__all__ = ["wilcox_chapter_8_unnumbered_864"]


def wilcox_chapter_8_unnumbered_864(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u864')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u864: PowerAndDesign expression (auto-extracted; see ref)."
