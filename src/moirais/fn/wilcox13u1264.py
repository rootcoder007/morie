...
__all__ = ["wilcox_chapter_13_unnumbered_1264"]


def wilcox_chapter_13_unnumbered_1264(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: pr=TRUE,xout=FALSE,outfun=out,MC=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1264')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1264: PowerAndDesign expression (auto-extracted; see ref)."
