# describe('bdiag') — mcmc_diagnostics
...
`print(result)` render. See `moirais.fn.describe('bdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdiag import *
import numpy as np
# See the function signature in fn/bdiag.py for argument names.
```
