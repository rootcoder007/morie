...
`print(result)` render. See `moirais.fn.describe('ipcwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipcwt import *
import numpy as np
# See the function signature in fn/ipcwt.py for argument names.
```
