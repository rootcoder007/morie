# describe('cstmd') — custody_medical
...
`print(result)` render. See `moirais.fn.describe('cstmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstmd import *
import numpy as np
# See the function signature in fn/cstmd.py for argument names.
```
