...
`print(result)` render. See `moirais.fn.describe('hylen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hylen import *
import numpy as np
# See the function signature in fn/hylen.py for argument names.
```
