...
__all__ = ["hedderich_chapter_9_unnumbered_3650"]


def hedderich_chapter_9_unnumbered_3650(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + i <− which ( x == old ) ; n i <− length ( i )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3650')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3650: GeneralStatistics expression (auto-extracted; see ref)."
