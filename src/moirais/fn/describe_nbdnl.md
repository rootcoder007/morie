...
`print(result)` render. See `moirais.fn.describe('nbdnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbdnl import *
import numpy as np
# See the function signature in fn/nbdnl.py for argument names.
```
