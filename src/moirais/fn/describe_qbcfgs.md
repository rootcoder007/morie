...
`print(result)` render. See `moirais.fn.describe('qbcfgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qbcfgs import *
import numpy as np
# See the function signature in fn/qbcfgs.py for argument names.
```
