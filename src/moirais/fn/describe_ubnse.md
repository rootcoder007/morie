...
`print(result)` render. See `moirais.fn.describe('ubnse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubnse import *
import numpy as np
# See the function signature in fn/ubnse.py for argument names.
```
