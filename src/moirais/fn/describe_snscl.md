...
`print(result)` render. See `moirais.fn.describe('snscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snscl import *
import numpy as np
# See the function signature in fn/snscl.py for argument names.
```
