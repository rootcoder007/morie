...
__all__ = ["wilcox_chapter_2_unnumbered_290"]


def wilcox_chapter_2_unnumbered_290(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: • For H0: µ ≤ µ 0, reject if T ≥ c, where now c is the 1 − α quantile of Student’s T
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u290')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u290: PowerAndDesign expression (auto-extracted; see ref)."
