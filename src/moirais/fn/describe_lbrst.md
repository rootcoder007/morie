# describe('lbrst') — lilliefors_test
...
`print(result)` render. See `moirais.fn.describe('lbrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lbrst import *
import numpy as np
# See the function signature in fn/lbrst.py for argument names.
```
