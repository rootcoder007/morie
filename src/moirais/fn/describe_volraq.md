# describe('volraq') — vol_realised_quadratic_var
...
`print(result)` render. See `moirais.fn.describe('volraq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volraq import *
import numpy as np
# See the function signature in fn/volraq.py for argument names.
```
