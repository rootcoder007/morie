# describe('gradaw') — geron_adaboost_weight_update
...
`print(result)` render. See `moirais.fn.describe('gradaw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gradaw import *
import numpy as np
# See the function signature in fn/gradaw.py for argument names.
```
