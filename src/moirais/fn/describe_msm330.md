# describe('msm330') — mvsml_functional_regression_eq_15_4
...
`print(result)` render. See `moirais.fn.describe('msm330')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm330 import *
import numpy as np
# See the function signature in fn/msm330.py for argument names.
```
