# describe('hmdtst') — geron_tree_sensitivity_scale
...
`print(result)` render. See `moirais.fn.describe('hmdtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdtst import *
import numpy as np
# See the function signature in fn/hmdtst.py for argument names.
```
