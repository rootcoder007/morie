# describe('hmlogg') — geron_logistic_gradient
...
`print(result)` render. See `moirais.fn.describe('hmlogg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlogg import *
import numpy as np
# See the function signature in fn/hmlogg.py for argument names.
```
