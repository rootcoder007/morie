# describe('grovr') — geron_one_vs_rest
...
`print(result)` render. See `moirais.fn.describe('grovr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grovr import *
import numpy as np
# See the function signature in fn/grovr.py for argument names.
```
