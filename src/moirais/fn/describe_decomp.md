# describe('decomp') — seasonal_decompose
...
`print(result)` render. See `moirais.fn.describe('decomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.decomp import *
import numpy as np
# See the function signature in fn/decomp.py for argument names.
```
