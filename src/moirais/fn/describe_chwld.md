# describe('chwld') — choi_williams_fn
...
`print(result)` render. See `moirais.fn.describe('chwld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chwld import *
import numpy as np
# See the function signature in fn/chwld.py for argument names.
```
