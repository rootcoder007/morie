...
`print(result)` render. See `moirais.fn.describe('ubgrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubgrn import *
import numpy as np
# See the function signature in fn/ubgrn.py for argument names.
```
