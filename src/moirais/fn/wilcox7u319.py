...
__all__ = ["wilcox_chapter_7_unnumbered_319"]


def wilcox_chapter_7_unnumbered_319(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: If N = n, the sample size is adequate. Here, N − n = 21 − 10 = 11. That is, 11 additional
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u319')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u319: PowerAndDesign expression (auto-extracted; see ref)."
