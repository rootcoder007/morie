...
__all__ = ["hedderich_chapter_9_unnumbered_2299"]


def hedderich_chapter_9_unnumbered_2299(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] α (%) m=1 m=2 m=3 m=4 m=5 m=6 m=7 m=8 m=9 m=10 m=15 m=20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2299')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2299: GeneralStatistics expression (auto-extracted; see ref)."
