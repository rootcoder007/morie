# describe('rgghk') — rangayyan_goldman_eqn
...
`print(result)` render. See `moirais.fn.describe('rgghk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgghk import *
import numpy as np
# See the function signature in fn/rgghk.py for argument names.
```
