# describe('lcsub') — longest_common_subseq
...
`print(result)` render. See `moirais.fn.describe('lcsub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lcsub import *
import numpy as np
# See the function signature in fn/lcsub.py for argument names.
```
