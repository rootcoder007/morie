# describe('btvinf') — boot_influence_fn
...
`print(result)` render. See `moirais.fn.describe('btvinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btvinf import *
import numpy as np
# See the function signature in fn/btvinf.py for argument names.
```
