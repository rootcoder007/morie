# describe('bidmn') — bidomain_model_fn
...
`print(result)` render. See `moirais.fn.describe('bidmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bidmn import *
import numpy as np
# See the function signature in fn/bidmn.py for argument names.
```
