# describe('survvar') — variance_cox_estimator
...
`print(result)` render. See `moirais.fn.describe('survvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survvar import *
import numpy as np
# See the function signature in fn/survvar.py for argument names.
```
