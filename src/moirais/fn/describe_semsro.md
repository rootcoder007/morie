...
`print(result)` render. See `moirais.fn.describe('semsro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semsro import *
import numpy as np
# See the function signature in fn/semsro.py for argument names.
```
