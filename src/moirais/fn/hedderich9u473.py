...
__all__ = ["hedderich_chapter_9_unnumbered_473"]


def hedderich_chapter_9_unnumbered_473(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (5)P5 =P (B∩C)−P (A∩B∩C) = 0.10−0.05 = 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u473')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u473: GeneralStatistics expression (auto-extracted; see ref)."
