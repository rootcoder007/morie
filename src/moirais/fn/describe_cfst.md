...
`print(result)` render. See `moirais.fn.describe('cfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfst import *
import numpy as np
# See the function signature in fn/cfst.py for argument names.
```
