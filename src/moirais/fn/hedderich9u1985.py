...
__all__ = ["hedderich_chapter_9_unnumbered_1985"]


def hedderich_chapter_9_unnumbered_1985(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 26.36 =−2.162 a slightly increased|ˆz|value compared to ˆz =−2.154,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1985')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1985: GeneralStatistics expression (auto-extracted; see ref)."
