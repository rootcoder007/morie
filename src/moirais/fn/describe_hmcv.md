# describe('hmcv') — geron_cross_validation
...
`print(result)` render. See `moirais.fn.describe('hmcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcv import *
import numpy as np
# See the function signature in fn/hmcv.py for argument names.
```
