...
__all__ = ["hedderich_chapter_9_unnumbered_1737"]


def hedderich_chapter_9_unnumbered_1737(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : cholA = 2 . 7 6 1 , p− value = 4 . 3 9 e −07
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1737')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1737: GeneralStatistics expression (auto-extracted; see ref)."
