...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1407"]


def guide_on_data_analysis_chapter_28_unnumbered_1407(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] # Y_t = beta_0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1407')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1407: GeneralStatistics expression (auto-extracted; see ref)."
