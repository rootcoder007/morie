...
__all__ = ["hedderich_chapter_9_unnumbered_2998"]


def hedderich_chapter_9_unnumbered_2998(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dimnames = list ( j o b =c ( " Worker " , " Employee " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2998')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2998: GeneralStatistics expression (auto-extracted; see ref)."
