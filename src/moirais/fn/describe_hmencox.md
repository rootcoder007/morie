# describe('hmencox') — geron_encoder_only
...
`print(result)` render. See `moirais.fn.describe('hmencox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmencox import *
import numpy as np
# See the function signature in fn/hmencox.py for argument names.
```
