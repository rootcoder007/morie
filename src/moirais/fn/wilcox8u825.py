...
__all__ = ["wilcox_chapter_8_unnumbered_825"]


def wilcox_chapter_8_unnumbered_825(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : ¯F.1(x) = ¯F.2(x) = · · · = ¯F.K(x).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u825')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u825: GeneralStatistics expression (auto-extracted; see ref)."
