# describe('msm021') — mvsml_linear_mixed_models_eq_5_4
...
`print(result)` render. See `moirais.fn.describe('msm021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm021 import *
import numpy as np
# See the function signature in fn/msm021.py for argument names.
```
