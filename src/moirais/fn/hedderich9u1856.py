...
__all__ = ["hedderich_chapter_9_unnumbered_1856"]


def hedderich_chapter_9_unnumbered_1856(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Since ˆχ2 = 20.00> 14.07 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1856')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1856: GeneralStatistics expression (auto-extracted; see ref)."
