...
__all__ = ["hedderich_chapter_9_unnumbered_1706"]


def hedderich_chapter_9_unnumbered_1706(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n≥60 and k≥7 as well as α= 0.10 or 0.05 [or 0.01].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1706')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1706: GeneralStatistics expression (auto-extracted; see ref)."
