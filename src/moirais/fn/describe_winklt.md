...
`print(result)` render. See `moirais.fn.describe('winklt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.winklt import *
import numpy as np
# See the function signature in fn/winklt.py for argument names.
```
