...
`print(result)` render. See `moirais.fn.describe('rho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rho import *
import numpy as np
# See the function signature in fn/rho.py for argument names.
```
