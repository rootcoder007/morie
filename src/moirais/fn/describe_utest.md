...
`print(result)` render. See `moirais.fn.describe('utest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.utest import *
import numpy as np
# See the function signature in fn/utest.py for argument names.
```
