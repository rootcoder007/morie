...
`print(result)` render. See `moirais.fn.describe('sdxlcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdxlcd import *
import numpy as np
# See the function signature in fn/sdxlcd.py for argument names.
```
