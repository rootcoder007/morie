# describe('hrzsmsci') — horowitz_sms_confidence
...
`print(result)` render. See `moirais.fn.describe('hrzsmsci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsmsci import *
import numpy as np
# See the function signature in fn/hrzsmsci.py for argument names.
```
