...
`print(result)` render. See `moirais.fn.describe('gcrcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcrcm import *
import numpy as np
# See the function signature in fn/gcrcm.py for argument names.
```
