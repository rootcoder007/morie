...
`print(result)` render. See `moirais.fn.describe('wideD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wideD import *
import numpy as np
# See the function signature in fn/wideD.py for argument names.
```
