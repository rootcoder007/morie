...
`print(result)` render. See `moirais.fn.describe('milrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.milrb import *
import numpy as np
# See the function signature in fn/milrb.py for argument names.
```
