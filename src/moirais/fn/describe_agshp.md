...
`print(result)` render. See `moirais.fn.describe('agshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agshp import *
import numpy as np
# See the function signature in fn/agshp.py for argument names.
```
