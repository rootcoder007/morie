# describe('rtwall') — rt_wallinga_teunis
...
`print(result)` render. See `moirais.fn.describe('rtwall')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtwall import *
import numpy as np
# See the function signature in fn/rtwall.py for argument names.
```
