# describe('binseg') — binary_segmentation
...
`print(result)` render. See `moirais.fn.describe('binseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.binseg import *
import numpy as np
# See the function signature in fn/binseg.py for argument names.
```
