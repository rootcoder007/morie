...
__all__ = ["use_r_chapter_2_unnumbered_109"]


def use_r_chapter_2_unnumbered_109(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: instead of an IPP we have an HPP (the intensity becomesλ(x)= λ). Similarly,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u109')`` for the full guide.
...
def cheatsheet():
    return "use_r2u109: GeneralStatistics expression (auto-extracted; see ref)."
