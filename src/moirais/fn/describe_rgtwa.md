# describe('rgtwa') — rangayyan_twave_alternans
...
`print(result)` render. See `moirais.fn.describe('rgtwa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgtwa import *
import numpy as np
# See the function signature in fn/rgtwa.py for argument names.
```
