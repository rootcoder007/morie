# describe('hmmnsh') — geron_mean_shift
...
`print(result)` render. See `moirais.fn.describe('hmmnsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmnsh import *
import numpy as np
# See the function signature in fn/hmmnsh.py for argument names.
```
