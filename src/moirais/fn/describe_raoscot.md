# describe('raoscot') — rao_scott_chisq
...
`print(result)` render. See `moirais.fn.describe('raoscot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.raoscot import *
import numpy as np
# See the function signature in fn/raoscot.py for argument names.
```
