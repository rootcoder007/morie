...
`print(result)` render. See `moirais.fn.describe('difag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difag import *
import numpy as np
# See the function signature in fn/difag.py for argument names.
```
