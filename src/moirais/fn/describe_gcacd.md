...
`print(result)` render. See `moirais.fn.describe('gcacd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcacd import *
import numpy as np
# See the function signature in fn/gcacd.py for argument names.
```
