# describe('klmsmh') — kalman_smoother
...
`print(result)` render. See `moirais.fn.describe('klmsmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klmsmh import *
import numpy as np
# See the function signature in fn/klmsmh.py for argument names.
```
