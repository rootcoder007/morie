# describe('rd_es') — risk_difference
...
`print(result)` render. See `moirais.fn.describe('rd_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rd_es import *
import numpy as np
# See the function signature in fn/rd_es.py for argument names.
```
