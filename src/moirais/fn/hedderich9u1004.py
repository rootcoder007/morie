...
__all__ = ["hedderich_chapter_9_unnumbered_1004"]


def hedderich_chapter_9_unnumbered_1004(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > approx ( x=c ( 2 , 7 ) , y= c ( 2 , 3 ) , xout =c ( 5 , 6 ) , method=" linear " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1004')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1004: GeneralStatistics expression (auto-extracted; see ref)."
