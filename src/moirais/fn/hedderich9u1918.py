...
__all__ = ["hedderich_chapter_9_unnumbered_1918"]


def hedderich_chapter_9_unnumbered_1918(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 1−β= 1−Φ(2√n(
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1918')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1918: CountModels expression (auto-extracted; see ref)."
