...
`print(result)` render. See `moirais.fn.describe('gebvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gebvs import *
import numpy as np
# See the function signature in fn/gebvs.py for argument names.
```
