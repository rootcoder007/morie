...
`print(result)` render. See `moirais.fn.describe('eucd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eucd import *
import numpy as np
# See the function signature in fn/eucd.py for argument names.
```
