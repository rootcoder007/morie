# describe('tvsbn') — tversky_similarity
...
`print(result)` render. See `moirais.fn.describe('tvsbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tvsbn import *
import numpy as np
# See the function signature in fn/tvsbn.py for argument names.
```
