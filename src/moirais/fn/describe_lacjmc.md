...
`print(result)` render. See `moirais.fn.describe('lacjmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacjmc import *
import numpy as np
# See the function signature in fn/lacjmc.py for argument names.
```
