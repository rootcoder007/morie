...
`print(result)` render. See `moirais.fn.describe('cntrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cntrl import *
import numpy as np
# See the function signature in fn/cntrl.py for argument names.
```
