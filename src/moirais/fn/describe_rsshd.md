...
`print(result)` render. See `moirais.fn.describe('rsshd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsshd import *
import numpy as np
# See the function signature in fn/rsshd.py for argument names.
```
