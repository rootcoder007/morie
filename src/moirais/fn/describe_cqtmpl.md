...
`print(result)` render. See `moirais.fn.describe('cqtmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cqtmpl import *
import numpy as np
# See the function signature in fn/cqtmpl.py for argument names.
```
