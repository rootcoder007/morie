...
`print(result)` render. See `moirais.fn.describe('qweib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qweib import *
import numpy as np
# See the function signature in fn/qweib.py for argument names.
```
