...
`print(result)` render. See `moirais.fn.describe('canny')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.canny import *
import numpy as np
# See the function signature in fn/canny.py for argument names.
```
