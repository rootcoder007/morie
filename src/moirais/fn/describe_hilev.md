# describe('hilev') — hilbert_envelope
...
`print(result)` render. See `moirais.fn.describe('hilev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hilev import *
import numpy as np
# See the function signature in fn/hilev.py for argument names.
```
