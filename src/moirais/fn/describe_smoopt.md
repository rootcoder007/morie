...
`print(result)` render. See `moirais.fn.describe('smoopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smoopt import *
import numpy as np
# See the function signature in fn/smoopt.py for argument names.
```
