...
`print(result)` render. See `moirais.fn.describe('masctc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masctc import *
import numpy as np
# See the function signature in fn/masctc.py for argument names.
```
