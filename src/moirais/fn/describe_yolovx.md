# describe('yolovx') — yolo_decoupled_head
...
`print(result)` render. See `moirais.fn.describe('yolovx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yolovx import *
import numpy as np
# See the function signature in fn/yolovx.py for argument names.
```
