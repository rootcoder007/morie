...
__all__ = ["hedderich_chapter_9_unnumbered_477"]


def hedderich_chapter_9_unnumbered_477(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: andP (E|A3) = 0.04, the total isP (E) = 0.5·0.01 + 0.3·0.03 + 0.2·0.04 = 0.022, a waste
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u477')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u477: GeneralStatistics expression (auto-extracted; see ref)."
