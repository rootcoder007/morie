...
`print(result)` render. See `moirais.fn.describe('gb631')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb631 import *
import numpy as np
# See the function signature in fn/gb631.py for argument names.
```
