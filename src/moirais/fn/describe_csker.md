...
`print(result)` render. See `moirais.fn.describe('csker')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csker import *
import numpy as np
# See the function signature in fn/csker.py for argument names.
```
