# describe('causdidev') — causal_did_eventstudy
...
`print(result)` render. See `moirais.fn.describe('causdidev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdidev import *
import numpy as np
# See the function signature in fn/causdidev.py for argument names.
```
