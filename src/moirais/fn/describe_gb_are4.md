# describe('gb_are4') — gibbons_are_kw
...
`print(result)` render. See `moirais.fn.describe('gb_are4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_are4 import *
import numpy as np
# See the function signature in fn/gb_are4.py for argument names.
```
