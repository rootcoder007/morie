# describe('tmlmct') — tmle_multivariate_treatment
...
`print(result)` render. See `moirais.fn.describe('tmlmct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmct import *
import numpy as np
# See the function signature in fn/tmlmct.py for argument names.
```
