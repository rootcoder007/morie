...
`print(result)` render. See `moirais.fn.describe('filsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.filsm import *
import numpy as np
# See the function signature in fn/filsm.py for argument names.
```
