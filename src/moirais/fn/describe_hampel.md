# describe('hampel') — hampel_redescend
...
`print(result)` render. See `moirais.fn.describe('hampel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hampel import *
import numpy as np
# See the function signature in fn/hampel.py for argument names.
```
