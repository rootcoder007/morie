# describe('dccmd') — dcc_multivariate_garch
...
`print(result)` render. See `moirais.fn.describe('dccmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dccmd import *
import numpy as np
# See the function signature in fn/dccmd.py for argument names.
```
