...
__all__ = ["hedderich_chapter_9_unnumbered_1134"]


def hedderich_chapter_9_unnumbered_1134(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 95%-CI: 0.154π̄≤0.592, e.g. 0.15π̄≤0.60.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1134')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1134: GeneralStatistics expression (auto-extracted; see ref)."
