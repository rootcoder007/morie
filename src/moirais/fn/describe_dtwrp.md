...
`print(result)` render. See `moirais.fn.describe('dtwrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtwrp import *
import numpy as np
# See the function signature in fn/dtwrp.py for argument names.
```
