# describe('cttdis') — ctt_discrimination
...
`print(result)` render. See `moirais.fn.describe('cttdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cttdis import *
import numpy as np
# See the function signature in fn/cttdis.py for argument names.
```
