# describe('rng164') — rangayyan_ch3_rls_normal_equation
...
`print(result)` render. See `moirais.fn.describe('rng164')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng164 import *
import numpy as np
# See the function signature in fn/rng164.py for argument names.
```
