# describe('grmms') — geron_minmax_scaler
...
`print(result)` render. See `moirais.fn.describe('grmms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmms import *
import numpy as np
# See the function signature in fn/grmms.py for argument names.
```
