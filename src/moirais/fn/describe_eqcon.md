# describe('eqcon') — concentration_index
...
`print(result)` render. See `moirais.fn.describe('eqcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqcon import *
import numpy as np
# See the function signature in fn/eqcon.py for argument names.
```
