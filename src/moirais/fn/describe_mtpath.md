...
`print(result)` render. See `moirais.fn.describe('mtpath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtpath import *
import numpy as np
# See the function signature in fn/mtpath.py for argument names.
```
