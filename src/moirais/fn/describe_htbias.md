...
`print(result)` render. See `moirais.fn.describe('htbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htbias import *
import numpy as np
# See the function signature in fn/htbias.py for argument names.
```
