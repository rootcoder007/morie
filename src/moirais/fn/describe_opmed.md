...
`print(result)` render. See `moirais.fn.describe('opmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opmed import *
import numpy as np
# See the function signature in fn/opmed.py for argument names.
```
