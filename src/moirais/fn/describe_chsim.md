...
`print(result)` render. See `moirais.fn.describe('chsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chsim import *
import numpy as np
# See the function signature in fn/chsim.py for argument names.
```
