# describe('rtsmpl') — rt_serial_interval
...
`print(result)` render. See `moirais.fn.describe('rtsmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtsmpl import *
import numpy as np
# See the function signature in fn/rtsmpl.py for argument names.
```
