...
`print(result)` render. See `moirais.fn.describe('mdrnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdrnk import *
import numpy as np
# See the function signature in fn/mdrnk.py for argument names.
```
