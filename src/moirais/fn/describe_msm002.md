# describe('msm002') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm002')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm002 import *
import numpy as np
# See the function signature in fn/msm002.py for argument names.
```
