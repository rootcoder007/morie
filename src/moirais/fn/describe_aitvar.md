# describe('aitvar') — aitchison_variation
...
`print(result)` render. See `moirais.fn.describe('aitvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitvar import *
import numpy as np
# See the function signature in fn/aitvar.py for argument names.
```
