# describe('kmmae') — kamath_multimodal_mae
...
`print(result)` render. See `moirais.fn.describe('kmmae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmmae import *
import numpy as np
# See the function signature in fn/kmmae.py for argument names.
```
