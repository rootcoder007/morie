...
`print(result)` render. See `moirais.fn.describe('cscpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscpr import *
import numpy as np
# See the function signature in fn/cscpr.py for argument names.
```
