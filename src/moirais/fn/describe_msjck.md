...
`print(result)` render. See `moirais.fn.describe('msjck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msjck import *
import numpy as np
# See the function signature in fn/msjck.py for argument names.
```
