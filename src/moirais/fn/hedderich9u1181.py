...
__all__ = ["hedderich_chapter_9_unnumbered_1181"]


def hedderich_chapter_9_unnumbered_1181(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˘p2 = (x2 + 1)/(n2 + 2) (otherwise as in (6.41))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1181')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1181: GeneralStatistics expression (auto-extracted; see ref)."
