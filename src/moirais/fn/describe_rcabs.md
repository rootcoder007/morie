...
`print(result)` render. See `moirais.fn.describe('rcabs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcabs import *
import numpy as np
# See the function signature in fn/rcabs.py for argument names.
```
