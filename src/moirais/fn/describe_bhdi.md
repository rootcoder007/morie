...
`print(result)` render. See `moirais.fn.describe('bhdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhdi import *
import numpy as np
# See the function signature in fn/bhdi.py for argument names.
```
