...
`print(result)` render. See `moirais.fn.describe('kpssTst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpssTst import *
import numpy as np
# See the function signature in fn/kpssTst.py for argument names.
```
