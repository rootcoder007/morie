...
__all__ = ["wilcox_chapter_13_unnumbered_1115"]


def wilcox_chapter_13_unnumbered_1115(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SCAT = TRUE, ADJ = TRUE, pr = TRUE, nreps = 1000, MC = FALSE, ...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1115')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1115: GeneralStatistics expression (auto-extracted; see ref)."
