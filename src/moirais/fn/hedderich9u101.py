...
__all__ = ["hedderich_chapter_9_unnumbered_101"]


def hedderich_chapter_9_unnumbered_101(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Fig. 2.6: Linear functionsy =f (x) = 2 + 3x andy =g(x) = 5−2x
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u101')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u101: GeneralStatistics expression (auto-extracted; see ref)."
