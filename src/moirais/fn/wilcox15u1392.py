...
__all__ = ["wilcox_chapter_15_unnumbered_1392"]


def wilcox_chapter_15_unnumbered_1392(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n α = .005 α = .01 α = .025 α = 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox15u1392')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1392: GeneralStatistics expression (auto-extracted; see ref)."
