# describe('idcon') — ideological_constraint
...
`print(result)` render. See `moirais.fn.describe('idcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idcon import *
import numpy as np
# See the function signature in fn/idcon.py for argument names.
```
