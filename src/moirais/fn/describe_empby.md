# describe('empby') — empirical_bayes
...
`print(result)` render. See `moirais.fn.describe('empby')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.empby import *
import numpy as np
# See the function signature in fn/empby.py for argument names.
```
