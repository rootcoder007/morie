...
`print(result)` render. See `moirais.fn.describe('dtlkj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtlkj import *
import numpy as np
# See the function signature in fn/dtlkj.py for argument names.
```
