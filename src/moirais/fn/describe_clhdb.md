...
`print(result)` render. See `moirais.fn.describe('clhdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clhdb import *
import numpy as np
# See the function signature in fn/clhdb.py for argument names.
```
