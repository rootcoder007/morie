...
`print(result)` render. See `moirais.fn.describe('afyld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afyld import *
import numpy as np
# See the function signature in fn/afyld.py for argument names.
```
