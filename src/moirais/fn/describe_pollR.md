...
`print(result)` render. See `moirais.fn.describe('pollR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pollR import *
import numpy as np
# See the function signature in fn/pollR.py for argument names.
```
