...
`print(result)` render. See `moirais.fn.describe('ubthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubthr import *
import numpy as np
# See the function signature in fn/ubthr.py for argument names.
```
