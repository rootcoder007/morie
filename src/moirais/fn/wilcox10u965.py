...
__all__ = ["wilcox_chapter_10_unnumbered_965"]


def wilcox_chapter_10_unnumbered_965(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 1 =µ 1 +µ 2 − µ 3 − µ 4,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u965')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u965: GeneralStatistics expression (auto-extracted; see ref)."
