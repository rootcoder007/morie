...
__all__ = ["wilcox_chapter_13_unnumbered_1163"]


def wilcox_chapter_13_unnumbered_1163(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1163')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1163: GeneralStatistics expression (auto-extracted; see ref)."
