...
`print(result)` render. See `moirais.fn.describe('mvtmj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtmj import *
import numpy as np
# See the function signature in fn/mvtmj.py for argument names.
```
