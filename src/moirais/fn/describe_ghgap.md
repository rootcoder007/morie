...
`print(result)` render. See `moirais.fn.describe('ghgap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghgap import *
import numpy as np
# See the function signature in fn/ghgap.py for argument names.
```
