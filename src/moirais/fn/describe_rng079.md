# describe('rng079') — rangayyan_ch3_periodic_convolution
...
`print(result)` render. See `moirais.fn.describe('rng079')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng079 import *
import numpy as np
# See the function signature in fn/rng079.py for argument names.
```
