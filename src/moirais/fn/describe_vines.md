...
`print(result)` render. See `moirais.fn.describe('vines')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vines import *
import numpy as np
# See the function signature in fn/vines.py for argument names.
```
