...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_220"]


def guide_on_data_analysis_chapter_4_unnumbered_220(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝐻0 ∶ 𝑝𝑖𝑗 = 𝑃(𝑌 = 𝑗|𝑋 = 𝑖) = 𝑝𝑗 for all 𝑖 and 𝑗.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u220')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u220: GeneralStatistics expression (auto-extracted; see ref)."
