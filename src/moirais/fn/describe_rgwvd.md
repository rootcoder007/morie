# describe('rgwvd') — rangayyan_wigner_ville
...
`print(result)` render. See `moirais.fn.describe('rgwvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvd import *
import numpy as np
# See the function signature in fn/rgwvd.py for argument names.
```
