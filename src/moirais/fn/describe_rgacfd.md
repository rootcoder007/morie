# describe('rgacfd') — rangayyan_acf_distance
...
`print(result)` render. See `moirais.fn.describe('rgacfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgacfd import *
import numpy as np
# See the function signature in fn/rgacfd.py for argument names.
```
