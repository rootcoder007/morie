# describe('agvirt') — alphazero_virtual_loss
...
`print(result)` render. See `moirais.fn.describe('agvirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agvirt import *
import numpy as np
# See the function signature in fn/agvirt.py for argument names.
```
