...
`print(result)` render. See `moirais.fn.describe('specf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specf import *
import numpy as np
# See the function signature in fn/specf.py for argument names.
```
