...
__all__ = ["hedderich_chapter_9_unnumbered_365"]


def hedderich_chapter_9_unnumbered_365(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] wi(x,h,x 1,...,x n) = K((x−xi)/h)∑n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u365')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u365: GeneralStatistics expression (auto-extracted; see ref)."
