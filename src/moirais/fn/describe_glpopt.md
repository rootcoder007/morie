...
`print(result)` render. See `moirais.fn.describe('glpopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glpopt import *
import numpy as np
# See the function signature in fn/glpopt.py for argument names.
```
