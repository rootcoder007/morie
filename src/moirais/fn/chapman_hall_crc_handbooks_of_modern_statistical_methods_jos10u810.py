...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_810"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_810(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: a.c.form = "lgb˜age+race+educ+income+employ",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u810')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u810: GeneralStatistics expression (auto-extracted; see ref)."
