...
__all__ = ["hedderich_chapter_9_unnumbered_2595"]


def hedderich_chapter_9_unnumbered_2595(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (ˆp1 =x1/n1, ˆp2 =x2/n2, ˆq1 = 1−ˆp1, ˆq2 = 1−ˆp2):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2595')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2595: GeneralStatistics expression (auto-extracted; see ref)."
