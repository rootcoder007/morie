# describe('rcdfr') — recidivism_fairness
...
`print(result)` render. See `moirais.fn.describe('rcdfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdfr import *
import numpy as np
# See the function signature in fn/rcdfr.py for argument names.
```
