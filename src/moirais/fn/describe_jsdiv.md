...
`print(result)` render. See `moirais.fn.describe('jsdiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jsdiv import *
import numpy as np
# See the function signature in fn/jsdiv.py for argument names.
```
