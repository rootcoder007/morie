# describe('rng191') — rangayyan_ch4_pan_tompkins_thresholds
...
`print(result)` render. See `moirais.fn.describe('rng191')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng191 import *
import numpy as np
# See the function signature in fn/rng191.py for argument names.
```
