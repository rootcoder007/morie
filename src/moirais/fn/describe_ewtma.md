# describe('ewtma') — ewma_volatility
...
`print(result)` render. See `moirais.fn.describe('ewtma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewtma import *
import numpy as np
# See the function signature in fn/ewtma.py for argument names.
```
