...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1042"]


def guide_on_data_analysis_chapter_22_unnumbered_1042(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖𝑗𝑘 = 𝜇 + 𝛼𝑖 + 𝛽𝑗 + 𝛾𝑘 + 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1042')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1042: GeneralStatistics expression (auto-extracted; see ref)."
