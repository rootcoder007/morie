# describe('volgargd') — vol_garch_ged
...
`print(result)` render. See `moirais.fn.describe('volgargd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgargd import *
import numpy as np
# See the function signature in fn/volgargd.py for argument names.
```
