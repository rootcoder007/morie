...
`print(result)` render. See `moirais.fn.describe('rtdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtdst import *
import numpy as np
# See the function signature in fn/rtdst.py for argument names.
```
