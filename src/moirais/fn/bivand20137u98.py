...
__all__ = ["bivand2013_chapter_7_unnumbered_98"]


def bivand2013_chapter_7_unnumbered_98(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: than ˆρ(xj), where the ˆρi(xj),i =1 ,...,R are the estimated ratios obtained
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u98')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u98: GeneralStatistics expression (auto-extracted; see ref)."
