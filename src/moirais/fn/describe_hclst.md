...
`print(result)` render. See `moirais.fn.describe('hclst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hclst import *
import numpy as np
# See the function signature in fn/hclst.py for argument names.
```
