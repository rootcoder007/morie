...
`print(result)` render. See `moirais.fn.describe('mslcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mslcl import *
import numpy as np
# See the function signature in fn/mslcl.py for argument names.
```
