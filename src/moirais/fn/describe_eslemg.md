...
`print(result)` render. See `moirais.fn.describe('eslemg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslemg import *
import numpy as np
# See the function signature in fn/eslemg.py for argument names.
```
