...
`print(result)` render. See `moirais.fn.describe('ppsamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppsamp import *
import numpy as np
# See the function signature in fn/ppsamp.py for argument names.
```
