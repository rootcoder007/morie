# describe('rgsam') — rangayyan_sample_entropy
...
`print(result)` render. See `moirais.fn.describe('rgsam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsam import *
import numpy as np
# See the function signature in fn/rgsam.py for argument names.
```
