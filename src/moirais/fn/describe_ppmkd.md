...
`print(result)` render. See `moirais.fn.describe('ppmkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmkd import *
import numpy as np
# See the function signature in fn/ppmkd.py for argument names.
```
