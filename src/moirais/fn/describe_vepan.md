...
`print(result)` render. See `moirais.fn.describe('vepan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vepan import *
import numpy as np
# See the function signature in fn/vepan.py for argument names.
```
