...
`print(result)` render. See `moirais.fn.describe('hyhlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyhlr import *
import numpy as np
# See the function signature in fn/hyhlr.py for argument names.
```
