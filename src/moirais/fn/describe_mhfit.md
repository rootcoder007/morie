...
`print(result)` render. See `moirais.fn.describe('mhfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhfit import *
import numpy as np
# See the function signature in fn/mhfit.py for argument names.
```
