...
`print(result)` render. See `moirais.fn.describe('r2or')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r2or import *
import numpy as np
# See the function signature in fn/r2or.py for argument names.
```
