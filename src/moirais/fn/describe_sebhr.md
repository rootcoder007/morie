...
`print(result)` render. See `moirais.fn.describe('sebhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebhr import *
import numpy as np
# See the function signature in fn/sebhr.py for argument names.
```
