...
__all__ = ["wilcox_chapter_10_unnumbered_970"]


def wilcox_chapter_10_unnumbered_970(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 :µ 1 +µ 3 +µ 5 − µ 2 − µ 4 − µ 6 = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u970')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u970: GeneralStatistics expression (auto-extracted; see ref)."
