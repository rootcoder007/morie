...
`print(result)` render. See `moirais.fn.describe('gwrtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrtst import *
import numpy as np
# See the function signature in fn/gwrtst.py for argument names.
```
