# describe('dinmlt') — dino_multicrop
...
`print(result)` render. See `moirais.fn.describe('dinmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dinmlt import *
import numpy as np
# See the function signature in fn/dinmlt.py for argument names.
```
