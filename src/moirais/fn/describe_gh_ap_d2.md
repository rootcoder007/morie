# describe('gh_ap_d2') — ghosal_lecam_lemma
...
`print(result)` render. See `moirais.fn.describe('gh_ap_d2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_d2 import *
import numpy as np
# See the function signature in fn/gh_ap_d2.py for argument names.
```
