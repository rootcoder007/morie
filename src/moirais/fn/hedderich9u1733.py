...
__all__ = ["hedderich_chapter_9_unnumbered_1733"]


def hedderich_chapter_9_unnumbered_1733(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : nblzW = 0 . 9 8 0 0 6 , p− value = 0 . 6 9 1 8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1733')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1733: GeneralStatistics expression (auto-extracted; see ref)."
