...
`print(result)` render. See `moirais.fn.describe('maacf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maacf import *
import numpy as np
# See the function signature in fn/maacf.py for argument names.
```
