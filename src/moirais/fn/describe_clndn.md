...
`print(result)` render. See `moirais.fn.describe('clndn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clndn import *
import numpy as np
# See the function signature in fn/clndn.py for argument names.
```
