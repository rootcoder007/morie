# describe('esumtv') — effective_resistance
...
`print(result)` render. See `moirais.fn.describe('esumtv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esumtv import *
import numpy as np
# See the function signature in fn/esumtv.py for argument names.
```
