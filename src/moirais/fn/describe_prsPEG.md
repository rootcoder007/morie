...
`print(result)` render. See `moirais.fn.describe('prsPEG')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsPEG import *
import numpy as np
# See the function signature in fn/prsPEG.py for argument names.
```
