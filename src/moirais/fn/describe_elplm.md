...
`print(result)` render. See `moirais.fn.describe('elplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elplm import *
import numpy as np
# See the function signature in fn/elplm.py for argument names.
```
