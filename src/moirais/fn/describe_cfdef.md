...
`print(result)` render. See `moirais.fn.describe('cfdef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfdef import *
import numpy as np
# See the function signature in fn/cfdef.py for argument names.
```
