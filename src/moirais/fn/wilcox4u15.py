...
__all__ = ["wilcox_chapter_4_unnumbered_15"]


def wilcox_chapter_4_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Rounding this last quantity down to the nearest integer gives j = 3, so h = 3.416667 − 3 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u15')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u15: GeneralStatistics expression (auto-extracted; see ref)."
