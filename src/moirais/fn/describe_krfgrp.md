# describe('krfgrp') — kronecker_graph
...
`print(result)` render. See `moirais.fn.describe('krfgrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krfgrp import *
import numpy as np
# See the function signature in fn/krfgrp.py for argument names.
```
