...
__all__ = ["wilcox_chapter_8_unnumbered_815"]


def wilcox_chapter_8_unnumbered_815(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Ψ jj ′ kk′ =θ jk − θ jk ′ +θ j′ k − θ j′ k′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u815')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u815: PowerAndDesign expression (auto-extracted; see ref)."
