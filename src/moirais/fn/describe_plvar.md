...
`print(result)` render. See `moirais.fn.describe('plvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plvar import *
import numpy as np
# See the function signature in fn/plvar.py for argument names.
```
