# describe('legal') — is_over_legal_limit
...
`print(result)` render. See `moirais.fn.describe('legal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.legal import *
import numpy as np
# See the function signature in fn/legal.py for argument names.
```
