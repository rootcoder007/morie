# describe('hrzbr5') — horowitz_bias_reduction_deconv
...
`print(result)` render. See `moirais.fn.describe('hrzbr5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzbr5 import *
import numpy as np
# See the function signature in fn/hrzbr5.py for argument names.
```
