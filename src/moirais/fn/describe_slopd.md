...
`print(result)` render. See `moirais.fn.describe('slopd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slopd import *
import numpy as np
# See the function signature in fn/slopd.py for argument names.
```
