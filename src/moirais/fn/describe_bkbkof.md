# describe('bkbkof') — burkov_ngram_backoff
...
`print(result)` render. See `moirais.fn.describe('bkbkof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkbkof import *
import numpy as np
# See the function signature in fn/bkbkof.py for argument names.
```
