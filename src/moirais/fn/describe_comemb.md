...
`print(result)` render. See `moirais.fn.describe('comemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comemb import *
import numpy as np
# See the function signature in fn/comemb.py for argument names.
```
