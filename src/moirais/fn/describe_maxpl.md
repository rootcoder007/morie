...
`print(result)` render. See `moirais.fn.describe('maxpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maxpl import *
import numpy as np
# See the function signature in fn/maxpl.py for argument names.
```
