...
`print(result)` render. See `moirais.fn.describe('spnsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnsm import *
import numpy as np
# See the function signature in fn/spnsm.py for argument names.
```
