# describe('rng023') — rangayyan_ch3_ccf_continuous
...
`print(result)` render. See `moirais.fn.describe('rng023')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng023 import *
import numpy as np
# See the function signature in fn/rng023.py for argument names.
```
