# describe('acfmc') — autocorrelation_mcmc
...
`print(result)` render. See `moirais.fn.describe('acfmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfmc import *
import numpy as np
# See the function signature in fn/acfmc.py for argument names.
```
