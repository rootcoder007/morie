...
`print(result)` render. See `moirais.fn.describe('sawnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawnr import *
import numpy as np
# See the function signature in fn/sawnr.py for argument names.
```
