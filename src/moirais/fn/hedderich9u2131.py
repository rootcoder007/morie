...
__all__ = ["hedderich_chapter_9_unnumbered_2131"]


def hedderich_chapter_9_unnumbered_2131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] U2 = 6·5 + 5(5 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2131')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2131: GeneralStatistics expression (auto-extracted; see ref)."
