...
`print(result)` render. See `moirais.fn.describe('xlear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xlear import *
import numpy as np
# See the function signature in fn/xlear.py for argument names.
```
