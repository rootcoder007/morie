...
`print(result)` render. See `moirais.fn.describe('ubspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubspr import *
import numpy as np
# See the function signature in fn/ubspr.py for argument names.
```
