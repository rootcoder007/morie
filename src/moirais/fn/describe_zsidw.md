...
`print(result)` render. See `moirais.fn.describe('zsidw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsidw import *
import numpy as np
# See the function signature in fn/zsidw.py for argument names.
```
