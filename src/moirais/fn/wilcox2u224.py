...
__all__ = ["wilcox_chapter_2_unnumbered_224"]


def wilcox_chapter_2_unnumbered_224(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] D = 81(x + 1)2 − 9(x + 1)(2 +c2) + 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u224')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u224: GeneralStatistics expression (auto-extracted; see ref)."
