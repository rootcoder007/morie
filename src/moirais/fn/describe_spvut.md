# describe('spvut') — spatial_utility
...
`print(result)` render. See `moirais.fn.describe('spvut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spvut import *
import numpy as np
# See the function signature in fn/spvut.py for argument names.
```
