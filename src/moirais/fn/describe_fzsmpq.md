# describe('fzsmpq') — fauzi_sample_quantile
...
`print(result)` render. See `moirais.fn.describe('fzsmpq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzsmpq import *
import numpy as np
# See the function signature in fn/fzsmpq.py for argument names.
```
