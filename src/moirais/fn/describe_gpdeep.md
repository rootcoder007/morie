...
`print(result)` render. See `moirais.fn.describe('gpdeep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpdeep import *
import numpy as np
# See the function signature in fn/gpdeep.py for argument names.
```
