# describe('rgeqn9b') — rangayyan_ch9_ica_ambiguity
...
`print(result)` render. See `moirais.fn.describe('rgeqn9b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn9b import *
import numpy as np
# See the function signature in fn/rgeqn9b.py for argument names.
```
