...
`print(result)` render. See `moirais.fn.describe('i2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.i2 import *
import numpy as np
# See the function signature in fn/i2.py for argument names.
```
