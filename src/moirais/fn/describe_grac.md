# describe('grac') — geron_actor_critic_advantage
...
`print(result)` render. See `moirais.fn.describe('grac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grac import *
import numpy as np
# See the function signature in fn/grac.py for argument names.
```
