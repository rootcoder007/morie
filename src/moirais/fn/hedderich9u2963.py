...
__all__ = ["hedderich_chapter_9_unnumbered_2963"]


def hedderich_chapter_9_unnumbered_2963(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆαi =ni./n.. i = 1,...,r
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2963')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2963: GeneralStatistics expression (auto-extracted; see ref)."
