# describe('rng165') — rangayyan_ch3_rls_phi_matrix
...
`print(result)` render. See `moirais.fn.describe('rng165')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng165 import *
import numpy as np
# See the function signature in fn/rng165.py for argument names.
```
