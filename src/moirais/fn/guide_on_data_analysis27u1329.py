...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1329"]


def guide_on_data_analysis_chapter_27_unnumbered_1329(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Γ = 𝐸[𝑌 (1) − 𝑌 (0)|𝑋 = 𝑐, 𝐷+ > 𝐷−, 𝑀 = 0].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1329')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1329: GeneralStatistics expression (auto-extracted; see ref)."
