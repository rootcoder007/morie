...
__all__ = ["hedderich_chapter_9_unnumbered_888"]


def hedderich_chapter_9_unnumbered_888(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u888')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u888: GeneralStatistics expression (auto-extracted; see ref)."
