# describe('jorolf') — joseph_rolling_window_feature
...
`print(result)` render. See `moirais.fn.describe('jorolf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jorolf import *
import numpy as np
# See the function signature in fn/jorolf.py for argument names.
```
