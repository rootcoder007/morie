...
`print(result)` render. See `moirais.fn.describe('pacnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacnd import *
import numpy as np
# See the function signature in fn/pacnd.py for argument names.
```
