# describe('expvar') — exponential_variogram_model
...
`print(result)` render. See `moirais.fn.describe('expvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.expvar import *
import numpy as np
# See the function signature in fn/expvar.py for argument names.
```
