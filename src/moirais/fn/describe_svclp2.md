...
`print(result)` render. See `moirais.fn.describe('svclp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclp2 import *
import numpy as np
# See the function signature in fn/svclp2.py for argument names.
```
