...
`print(result)` render. See `moirais.fn.describe('przpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.przpd import *
import numpy as np
# See the function signature in fn/przpd.py for argument names.
```
