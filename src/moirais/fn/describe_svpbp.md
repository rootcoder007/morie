...
`print(result)` render. See `moirais.fn.describe('svpbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpbp import *
import numpy as np
# See the function signature in fn/svpbp.py for argument names.
```
