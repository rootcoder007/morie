# describe('evrlpot') — evt_return_level_pot
...
`print(result)` render. See `moirais.fn.describe('evrlpot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evrlpot import *
import numpy as np
# See the function signature in fn/evrlpot.py for argument names.
```
