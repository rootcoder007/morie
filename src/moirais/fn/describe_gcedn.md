...
`print(result)` render. See `moirais.fn.describe('gcedn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcedn import *
import numpy as np
# See the function signature in fn/gcedn.py for argument names.
```
