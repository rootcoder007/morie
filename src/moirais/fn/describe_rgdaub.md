# describe('rgdaub') — rangayyan_daubechies
...
`print(result)` render. See `moirais.fn.describe('rgdaub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdaub import *
import numpy as np
# See the function signature in fn/rgdaub.py for argument names.
```
