# describe('tmlfed') — tmle_federated
...
`print(result)` render. See `moirais.fn.describe('tmlfed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlfed import *
import numpy as np
# See the function signature in fn/tmlfed.py for argument names.
```
