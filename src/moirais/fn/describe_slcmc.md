...
`print(result)` render. See `moirais.fn.describe('slcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slcmc import *
import numpy as np
# See the function signature in fn/slcmc.py for argument names.
```
