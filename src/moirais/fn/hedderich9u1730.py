...
__all__ = ["hedderich_chapter_9_unnumbered_1730"]


def hedderich_chapter_9_unnumbered_1730(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (3) 75/400=0.1875; (75 + 103)/400=0.445 etc.;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1730')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1730: GeneralStatistics expression (auto-extracted; see ref)."
