# describe('tqdist') — turboquant_distortion_bound
...
`print(result)` render. See `moirais.fn.describe('tqdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqdist import *
import numpy as np
# See the function signature in fn/tqdist.py for argument names.
```
