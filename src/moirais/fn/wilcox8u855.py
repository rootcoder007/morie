...
__all__ = ["wilcox_chapter_8_unnumbered_855"]


def wilcox_chapter_8_unnumbered_855(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where ¯θ = ∑ˆθ j/J is the average of the ˆθ j values. So Q measures the variation among
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u855')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u855: GeneralStatistics expression (auto-extracted; see ref)."
