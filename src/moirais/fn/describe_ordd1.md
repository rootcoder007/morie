...
`print(result)` render. See `moirais.fn.describe('ordd1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ordd1 import *
import numpy as np
# See the function signature in fn/ordd1.py for argument names.
```
