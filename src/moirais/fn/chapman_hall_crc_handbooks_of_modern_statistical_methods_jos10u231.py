...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_231"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_231(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Zij(Rij − λ0Dij) − ni
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u231')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u231: GeneralStatistics expression (auto-extracted; see ref)."
