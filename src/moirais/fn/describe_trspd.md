# describe('trspd') — trspd

## WHAT IT DOES

Traffic speed spatial
...
`print(result)` render. See `moirais.fn.describe('trspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trspd import *
import numpy as np
# See the function signature in fn/trspd.py for argument names.
```
