...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_213"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_213(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: D(τi, γj)xij + ω1z1 + ω2z2 (6.7)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u213')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u213: GeneralStatistics expression (auto-extracted; see ref)."
