...
__all__ = ["hedderich_chapter_9_unnumbered_3381"]


def hedderich_chapter_9_unnumbered_3381(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: =β0 +β1b−β0−β1a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3381')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3381: GeneralStatistics expression (auto-extracted; see ref)."
