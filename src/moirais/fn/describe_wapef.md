...
`print(result)` render. See `moirais.fn.describe('wapef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wapef import *
import numpy as np
# See the function signature in fn/wapef.py for argument names.
```
