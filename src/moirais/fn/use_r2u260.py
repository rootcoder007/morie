...
__all__ = ["use_r_chapter_2_unnumbered_260"]


def use_r_chapter_2_unnumbered_260(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: where aij =e x p{−dij/φ} and dij is the distance between regions i and j,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u260')`` for the full guide.
...
def cheatsheet():
    return "use_r2u260: GeneralStatistics expression (auto-extracted; see ref)."
