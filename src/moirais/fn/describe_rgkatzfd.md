# describe('rgkatzfd') — rangayyan_katz_fd
...
`print(result)` render. See `moirais.fn.describe('rgkatzfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgkatzfd import *
import numpy as np
# See the function signature in fn/rgkatzfd.py for argument names.
```
