# describe('sgsps') — spectral_grf_sim
...
`print(result)` render. See `moirais.fn.describe('sgsps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsps import *
import numpy as np
# See the function signature in fn/sgsps.py for argument names.
```
