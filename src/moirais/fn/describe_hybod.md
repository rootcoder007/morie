...
`print(result)` render. See `moirais.fn.describe('hybod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hybod import *
import numpy as np
# See the function signature in fn/hybod.py for argument names.
```
