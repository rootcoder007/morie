# describe('tmlpse') — tmle_path_specific
...
`print(result)` render. See `moirais.fn.describe('tmlpse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlpse import *
import numpy as np
# See the function signature in fn/tmlpse.py for argument names.
```
