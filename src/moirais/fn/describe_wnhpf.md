# describe('wnhpf') — wiener_hopf_solve
...
`print(result)` render. See `moirais.fn.describe('wnhpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnhpf import *
import numpy as np
# See the function signature in fn/wnhpf.py for argument names.
```
