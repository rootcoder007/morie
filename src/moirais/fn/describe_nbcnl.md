...
`print(result)` render. See `moirais.fn.describe('nbcnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcnl import *
import numpy as np
# See the function signature in fn/nbcnl.py for argument names.
```
