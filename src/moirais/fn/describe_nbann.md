...
`print(result)` render. See `moirais.fn.describe('nbann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbann import *
import numpy as np
# See the function signature in fn/nbann.py for argument names.
```
