# describe('sacmod') — spatial_combined
...
`print(result)` render. See `moirais.fn.describe('sacmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacmod import *
import numpy as np
# See the function signature in fn/sacmod.py for argument names.
```
