...
`print(result)` render. See `moirais.fn.describe('pgdsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgdsc import *
import numpy as np
# See the function signature in fn/pgdsc.py for argument names.
```
