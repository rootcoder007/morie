# describe('ghstk') — ghosal_stick_breaking_trunc
...
`print(result)` render. See `moirais.fn.describe('ghstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghstk import *
import numpy as np
# See the function signature in fn/ghstk.py for argument names.
```
