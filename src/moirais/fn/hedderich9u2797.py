...
__all__ = ["hedderich_chapter_9_unnumbered_2797"]


def hedderich_chapter_9_unnumbered_2797(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: McNemar ’ s chi − squared = 7 . 5 7 8 9 , df = 1 , p− value = 0.005905
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2797')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2797: GeneralStatistics expression (auto-extracted; see ref)."
