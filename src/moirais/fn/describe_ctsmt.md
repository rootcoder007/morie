...
`print(result)` render. See `moirais.fn.describe('ctsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctsmt import *
import numpy as np
# See the function signature in fn/ctsmt.py for argument names.
```
