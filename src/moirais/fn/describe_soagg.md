...
`print(result)` render. See `moirais.fn.describe('soagg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soagg import *
import numpy as np
# See the function signature in fn/soagg.py for argument names.
```
