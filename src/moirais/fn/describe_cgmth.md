...
`print(result)` render. See `moirais.fn.describe('cgmth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cgmth import *
import numpy as np
# See the function signature in fn/cgmth.py for argument names.
```
