# describe('jowink') — joseph_winkler_interval_score
...
`print(result)` render. See `moirais.fn.describe('jowink')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jowink import *
import numpy as np
# See the function signature in fn/jowink.py for argument names.
```
