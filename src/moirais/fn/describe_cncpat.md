# describe('cncpat') — controlnet_attach
...
`print(result)` render. See `moirais.fn.describe('cncpat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cncpat import *
import numpy as np
# See the function signature in fn/cncpat.py for argument names.
```
