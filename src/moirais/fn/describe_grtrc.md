# describe('grtrc') — geron_tree_classification_leaf
...
`print(result)` render. See `moirais.fn.describe('grtrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtrc import *
import numpy as np
# See the function signature in fn/grtrc.py for argument names.
```
