...
__all__ = ["hedderich_chapter_9_unnumbered_2020"]


def hedderich_chapter_9_unnumbered_2020(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Here,t =tν;1−α is the corresponding quantile of thet-distribution to be used.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2020')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2020: GeneralStatistics expression (auto-extracted; see ref)."
