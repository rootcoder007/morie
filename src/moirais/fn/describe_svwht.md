...
`print(result)` render. See `moirais.fn.describe('svwht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwht import *
import numpy as np
# See the function signature in fn/svwht.py for argument names.
```
