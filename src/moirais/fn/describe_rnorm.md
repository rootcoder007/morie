...
`print(result)` render. See `moirais.fn.describe('rnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnorm import *
import numpy as np
# See the function signature in fn/rnorm.py for argument names.
```
