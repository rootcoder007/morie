...
__all__ = ["bivand2013_chapter_2_unnumbered_28"]


def bivand2013_chapter_2_unnumbered_28(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +init=epsg:4230 +towgs84=-87,-96,-120,0,0,0,0 +proj=longlat
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u28')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u28: GeneralStatistics expression (auto-extracted; see ref)."
