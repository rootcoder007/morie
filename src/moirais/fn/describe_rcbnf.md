...
`print(result)` render. See `moirais.fn.describe('rcbnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcbnf import *
import numpy as np
# See the function signature in fn/rcbnf.py for argument names.
```
