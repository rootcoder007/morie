# describe('km066') — kamath_ch5_reward_kl_penalty
...
`print(result)` render. See `moirais.fn.describe('km066')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km066 import *
import numpy as np
# See the function signature in fn/km066.py for argument names.
```
