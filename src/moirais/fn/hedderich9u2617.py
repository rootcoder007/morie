...
__all__ = ["hedderich_chapter_9_unnumbered_2617"]


def hedderich_chapter_9_unnumbered_2617(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (a−Ea)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2617')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2617: GeneralStatistics expression (auto-extracted; see ref)."
