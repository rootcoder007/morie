...
`print(result)` render. See `moirais.fn.describe('abradn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abradn import *
import numpy as np
# See the function signature in fn/abradn.py for argument names.
```
