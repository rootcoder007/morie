...
`print(result)` render. See `moirais.fn.describe('hmdpo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdpo import *
import numpy as np
# See the function signature in fn/hmdpo.py for argument names.
```
