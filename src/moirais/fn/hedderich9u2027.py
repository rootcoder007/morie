...
__all__ = ["hedderich_chapter_9_unnumbered_2027"]


def hedderich_chapter_9_unnumbered_2027(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆt = [5(82−80)] + [5(94−90)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2027')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2027: GeneralStatistics expression (auto-extracted; see ref)."
