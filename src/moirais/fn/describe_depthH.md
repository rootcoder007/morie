# describe('depthH') — halfspace_depth
...
`print(result)` render. See `moirais.fn.describe('depthH')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depthH import *
import numpy as np
# See the function signature in fn/depthH.py for argument names.
```
