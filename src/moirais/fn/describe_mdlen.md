...
`print(result)` render. See `moirais.fn.describe('mdlen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdlen import *
import numpy as np
# See the function signature in fn/mdlen.py for argument names.
```
