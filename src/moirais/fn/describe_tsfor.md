...
`print(result)` render. See `moirais.fn.describe('tsfor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsfor import *
import numpy as np
# See the function signature in fn/tsfor.py for argument names.
```
