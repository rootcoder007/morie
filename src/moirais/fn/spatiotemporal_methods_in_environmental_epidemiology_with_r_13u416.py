...
__all__ = ["spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_13_unnumbered_416"]


def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_13_unnumbered_416(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_13u416')`` for the full guide.
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_13u416: GeneralStatistics expression (auto-extracted; see ref)."
