...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_178"]


def information_theory_mackay_chapter_6_unnumbered_178(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] a +b +c + =m +n +o + (12.2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u178')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u178: GeneralStatistics expression (auto-extracted; see ref)."
