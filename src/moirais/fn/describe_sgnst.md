# describe('sgnst') — nested_variogram
...
`print(result)` render. See `moirais.fn.describe('sgnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnst import *
import numpy as np
# See the function signature in fn/sgnst.py for argument names.
```
