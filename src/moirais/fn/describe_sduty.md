...
`print(result)` render. See `moirais.fn.describe('sduty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sduty import *
import numpy as np
# See the function signature in fn/sduty.py for argument names.
```
