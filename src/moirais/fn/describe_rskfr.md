...
`print(result)` render. See `moirais.fn.describe('rskfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskfr import *
import numpy as np
# See the function signature in fn/rskfr.py for argument names.
```
