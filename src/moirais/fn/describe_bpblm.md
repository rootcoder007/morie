...
`print(result)` render. See `moirais.fn.describe('bpblm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpblm import *
import numpy as np
# See the function signature in fn/bpblm.py for argument names.
```
