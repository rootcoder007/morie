# describe('hilsp') — hilbert_spectrum
...
`print(result)` render. See `moirais.fn.describe('hilsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hilsp import *
import numpy as np
# See the function signature in fn/hilsp.py for argument names.
```
