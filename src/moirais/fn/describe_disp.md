...
`print(result)` render. See `moirais.fn.describe('disp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.disp import *
import numpy as np
# See the function signature in fn/disp.py for argument names.
```
