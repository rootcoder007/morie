...
`print(result)` render. See `moirais.fn.describe('rscva')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rscva import *
import numpy as np
# See the function signature in fn/rscva.py for argument names.
```
