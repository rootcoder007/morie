...
def mm_estimator_regression(y, X):
    ...
    return RichResult(payload={"estimate": float(estimate), "se": float(se), "ci_lower": float(ci_lower), "ci_upper": float(ci_upper), "n": n, "method": "MM-estimator regression (Yohai)"})
