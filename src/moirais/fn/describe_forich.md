...
`print(result)` render. See `moirais.fn.describe('forich')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forich import *
import numpy as np
# See the function signature in fn/forich.py for argument names.
```
