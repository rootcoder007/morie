# describe('spcor') — semipartial_corr
...
`print(result)` render. See `moirais.fn.describe('spcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcor import *
import numpy as np
# See the function signature in fn/spcor.py for argument names.
```
