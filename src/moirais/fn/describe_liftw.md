...
`print(result)` render. See `moirais.fn.describe('liftw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.liftw import *
import numpy as np
# See the function signature in fn/liftw.py for argument names.
```
