...
`print(result)` render. See `moirais.fn.describe('glmmnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmnb import *
import numpy as np
# See the function signature in fn/glmmnb.py for argument names.
```
