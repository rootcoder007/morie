# describe('grql') — geron_q_learning_update
...
`print(result)` render. See `moirais.fn.describe('grql')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grql import *
import numpy as np
# See the function signature in fn/grql.py for argument names.
```
