# describe('arfmt') — ar_formant_extraction_fn
...
`print(result)` render. See `moirais.fn.describe('arfmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arfmt import *
import numpy as np
# See the function signature in fn/arfmt.py for argument names.
```
