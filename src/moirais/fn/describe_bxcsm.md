...
`print(result)` render. See `moirais.fn.describe('bxcsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bxcsm import *
import numpy as np
# See the function signature in fn/bxcsm.py for argument names.
```
