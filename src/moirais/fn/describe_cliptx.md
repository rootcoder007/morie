# describe('cliptx') — clip_image_text
...
`print(result)` render. See `moirais.fn.describe('cliptx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cliptx import *
import numpy as np
# See the function signature in fn/cliptx.py for argument names.
```
