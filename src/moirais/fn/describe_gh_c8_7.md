# describe('gh_c8_7') — ghosal_fin_apx_pri
...
`print(result)` render. See `moirais.fn.describe('gh_c8_7')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c8_7 import *
import numpy as np
# See the function signature in fn/gh_c8_7.py for argument names.
```
