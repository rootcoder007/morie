# describe('hmgrs') — geron_grid_search
...
`print(result)` render. See `moirais.fn.describe('hmgrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgrs import *
import numpy as np
# See the function signature in fn/hmgrs.py for argument names.
```
