# describe('rgbbb') — rangayyan_bundle_branch_block
...
`print(result)` render. See `moirais.fn.describe('rgbbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbbb import *
import numpy as np
# See the function signature in fn/rgbbb.py for argument names.
```
