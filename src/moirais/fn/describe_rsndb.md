...
`print(result)` render. See `moirais.fn.describe('rsndb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsndb import *
import numpy as np
# See the function signature in fn/rsndb.py for argument names.
```
