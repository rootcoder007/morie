...
`print(result)` render. See `moirais.fn.describe('hsasy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsasy import *
import numpy as np
# See the function signature in fn/hsasy.py for argument names.
```
