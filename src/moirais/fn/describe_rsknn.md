...
`print(result)` render. See `moirais.fn.describe('rsknn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsknn import *
import numpy as np
# See the function signature in fn/rsknn.py for argument names.
```
