...
__all__ = ["hedderich_chapter_9_unnumbered_107"]


def hedderich_chapter_9_unnumbered_107(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: y =a +b1x +b2x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u107')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u107: GeneralStatistics expression (auto-extracted; see ref)."
