...
__all__ = ["wilcox_chapter_13_unnumbered_1308"]


def wilcox_chapter_13_unnumbered_1308(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: wherez1−α/ 2 is the 1 − α/2 quantile of a standard normal distribution. This turns out to be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1308')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1308: GeneralStatistics expression (auto-extracted; see ref)."
