...
`print(result)` render. See `moirais.fn.describe('afdrns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afdrns import *
import numpy as np
# See the function signature in fn/afdrns.py for argument names.
```
