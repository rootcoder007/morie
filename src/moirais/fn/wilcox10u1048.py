...
__all__ = ["wilcox_chapter_10_unnumbered_1048"]


def wilcox_chapter_10_unnumbered_1048(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: out3d(x,outfun=outpro,xlab="Var 1",ylab="Var 2",zlab="Var 3",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1048')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1048: GeneralStatistics expression (auto-extracted; see ref)."
