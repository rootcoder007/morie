...
`print(result)` render. See `moirais.fn.describe('pwr_av')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwr_av import *
import numpy as np
# See the function signature in fn/pwr_av.py for argument names.
```
