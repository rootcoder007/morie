...
`print(result)` render. See `moirais.fn.describe('hmncsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmncsn import *
import numpy as np
# See the function signature in fn/hmncsn.py for argument names.
```
