# describe('msm124') — mvsml_categorical_count_eq_8_1
...
`print(result)` render. See `moirais.fn.describe('msm124')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm124 import *
import numpy as np
# See the function signature in fn/msm124.py for argument names.
```
