...
`print(result)` render. See `moirais.fn.describe('stkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkrg import *
import numpy as np
# See the function signature in fn/stkrg.py for argument names.
```
