# describe('fzr1') — fauzi_r1_integral
...
`print(result)` render. See `moirais.fn.describe('fzr1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzr1 import *
import numpy as np
# See the function signature in fn/fzr1.py for argument names.
```
