...
`print(result)` render. See `moirais.fn.describe('signt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.signt import *
import numpy as np
# See the function signature in fn/signt.py for argument names.
```
