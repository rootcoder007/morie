...
__all__ = ["hedderich_chapter_9_unnumbered_1191"]


def hedderich_chapter_9_unnumbered_1191(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + " \ nWilson score : " , round ( low2 , digits = 4 ) , " −" , round ( upp2 , digits = 4 ) , " \ n " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1191')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1191: GeneralStatistics expression (auto-extracted; see ref)."
