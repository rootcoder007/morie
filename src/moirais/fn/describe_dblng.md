...
`print(result)` render. See `moirais.fn.describe('dblng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dblng import *
import numpy as np
# See the function signature in fn/dblng.py for argument names.
```
