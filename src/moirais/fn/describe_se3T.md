...
`print(result)` render. See `moirais.fn.describe('se3T')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.se3T import *
import numpy as np
# See the function signature in fn/se3T.py for argument names.
```
