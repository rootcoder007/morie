...
`print(result)` render. See `moirais.fn.describe('hmstr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmstr2 import *
import numpy as np
# See the function signature in fn/hmstr2.py for argument names.
```
