...
__all__ = ["wilcox_chapter_10_unnumbered_937"]


def wilcox_chapter_10_unnumbered_937(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P[k] ≤ (C − k + 1)α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u937')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u937: GeneralStatistics expression (auto-extracted; see ref)."
