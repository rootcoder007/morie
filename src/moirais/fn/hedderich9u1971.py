...
__all__ = ["hedderich_chapter_9_unnumbered_1971"]


def hedderich_chapter_9_unnumbered_1971(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (α = 0.05 two-sided or α = 0.025 one-sided)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1971')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1971: GeneralStatistics expression (auto-extracted; see ref)."
