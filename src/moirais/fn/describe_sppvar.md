...
`print(result)` render. See `moirais.fn.describe('sppvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppvar import *
import numpy as np
# See the function signature in fn/sppvar.py for argument names.
```
