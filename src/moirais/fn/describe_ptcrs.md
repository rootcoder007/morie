...
`print(result)` render. See `moirais.fn.describe('ptcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptcrs import *
import numpy as np
# See the function signature in fn/ptcrs.py for argument names.
```
