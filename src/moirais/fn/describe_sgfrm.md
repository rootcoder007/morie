...
`print(result)` render. See `moirais.fn.describe('sgfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgfrm import *
import numpy as np
# See the function signature in fn/sgfrm.py for argument names.
```
