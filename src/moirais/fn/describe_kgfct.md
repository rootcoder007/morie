# describe('kgfct') — factorial_kriging
...
`print(result)` render. See `moirais.fn.describe('kgfct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgfct import *
import numpy as np
# See the function signature in fn/kgfct.py for argument names.
```
