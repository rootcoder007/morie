# describe('pcorp') — partial_correlation
...
`print(result)` render. See `moirais.fn.describe('pcorp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcorp import *
import numpy as np
# See the function signature in fn/pcorp.py for argument names.
```
