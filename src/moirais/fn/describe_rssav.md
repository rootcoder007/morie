...
`print(result)` render. See `moirais.fn.describe('rssav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rssav import *
import numpy as np
# See the function signature in fn/rssav.py for argument names.
```
