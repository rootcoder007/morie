...
`print(result)` render. See `moirais.fn.describe('lsdca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lsdca import *
import numpy as np
# See the function signature in fn/lsdca.py for argument names.
```
