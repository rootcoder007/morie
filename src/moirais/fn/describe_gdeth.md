...
`print(result)` render. See `moirais.fn.describe('gdeth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdeth import *
import numpy as np
# See the function signature in fn/gdeth.py for argument names.
```
