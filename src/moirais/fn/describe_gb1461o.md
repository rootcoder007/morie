# describe('gb1461o') — gibbons_ordered_categories
...
`print(result)` render. See `moirais.fn.describe('gb1461o')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1461o import *
import numpy as np
# See the function signature in fn/gb1461o.py for argument names.
```
