# describe('jorelm') — joseph_relative_mae
...
`print(result)` render. See `moirais.fn.describe('jorelm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jorelm import *
import numpy as np
# See the function signature in fn/jorelm.py for argument names.
```
