# describe('abfng') — abfng

## WHAT IT DOES

Fungal spore spatial
...
`print(result)` render. See `moirais.fn.describe('abfng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abfng import *
import numpy as np
# See the function signature in fn/abfng.py for argument names.
```
