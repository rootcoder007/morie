...
__all__ = ["hedderich_chapter_9_unnumbered_1262"]


def hedderich_chapter_9_unnumbered_1262(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: withtn−1,1−α do not include the parameter in an average of 100·α% of all samples, on the other
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1262')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1262: GeneralStatistics expression (auto-extracted; see ref)."
