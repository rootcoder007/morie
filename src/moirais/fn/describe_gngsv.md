...
`print(result)` render. See `moirais.fn.describe('gngsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gngsv import *
import numpy as np
# See the function signature in fn/gngsv.py for argument names.
```
