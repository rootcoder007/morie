...
__all__ = ["hedderich_chapter_9_unnumbered_2140"]


def hedderich_chapter_9_unnumbered_2140(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : A and B W = 4 7 . 5 , p− value = 0 . 1 1 0 9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2140')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2140: GeneralStatistics expression (auto-extracted; see ref)."
