# describe('wrdcl') — word_cloud_data

## WHAT IT DOES

Word frequency data for cloud visualization. 'Confine yourself to the present. — Marcus Aurelius'
...
`print(result)` render. See `moirais.fn.describe('wrdcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wrdcl import *
import numpy as np
# See the function signature in fn/wrdcl.py for argument names.
```
