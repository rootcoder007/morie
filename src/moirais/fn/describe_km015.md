# describe('km015') — kamath_ch2_multihead_head_i
...
`print(result)` render. See `moirais.fn.describe('km015')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km015 import *
import numpy as np
# See the function signature in fn/km015.py for argument names.
```
