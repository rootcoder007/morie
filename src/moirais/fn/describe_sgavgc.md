# describe('sgavgc') — average_covariance_block
...
`print(result)` render. See `moirais.fn.describe('sgavgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgavgc import *
import numpy as np
# See the function signature in fn/sgavgc.py for argument names.
```
