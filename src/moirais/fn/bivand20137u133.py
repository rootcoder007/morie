...
__all__ = ["bivand2013_chapter_7_unnumbered_133"]


def bivand2013_chapter_7_unnumbered_133(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + ncases = ncases, prob = prob)))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u133')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u133: GeneralStatistics expression (auto-extracted; see ref)."
