...
`print(result)` render. See `moirais.fn.describe('ubcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcon import *
import numpy as np
# See the function signature in fn/ubcon.py for argument names.
```
