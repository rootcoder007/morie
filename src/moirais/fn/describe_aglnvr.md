# describe('aglnvr') — alphazero_loss_var
...
`print(result)` render. See `moirais.fn.describe('aglnvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglnvr import *
import numpy as np
# See the function signature in fn/aglnvr.py for argument names.
```
