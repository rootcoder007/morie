# describe('swish') — swish

## WHAT IT DOES

rSwish activation function (SiLU).
...
`print(result)` render. See `moirais.fn.describe('swish')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swish import *
import numpy as np
# See the function signature in fn/swish.py for argument names.
```
