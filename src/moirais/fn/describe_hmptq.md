# describe('hmptq') — geron_static_quantization_ptq
...
`print(result)` render. See `moirais.fn.describe('hmptq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmptq import *
import numpy as np
# See the function signature in fn/hmptq.py for argument names.
```
