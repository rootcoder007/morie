...
__all__ = ["hedderich_chapter_9_unnumbered_1450"]


def hedderich_chapter_9_unnumbered_1450(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > K <− sum ( s <= −1) − . 5 * sum ( s == − 1 ) ; N <− length ( s ) # shift median
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1450')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1450: GeneralStatistics expression (auto-extracted; see ref)."
