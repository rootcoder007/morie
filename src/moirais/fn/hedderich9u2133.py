...
__all__ = ["hedderich_chapter_9_unnumbered_2133"]


def hedderich_chapter_9_unnumbered_2133(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: W = 9 , p− value = 0 . 3 2 9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2133')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2133: GeneralStatistics expression (auto-extracted; see ref)."
