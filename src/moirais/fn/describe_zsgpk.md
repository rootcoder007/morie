...
`print(result)` render. See `moirais.fn.describe('zsgpk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgpk import *
import numpy as np
# See the function signature in fn/zsgpk.py for argument names.
```
