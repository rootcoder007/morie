# describe('vitptm') — vit_patch_embed
...
`print(result)` render. See `moirais.fn.describe('vitptm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitptm import *
import numpy as np
# See the function signature in fn/vitptm.py for argument names.
```
