# describe('gb5717') — gibbons_wsrt_symmetry
...
`print(result)` render. See `moirais.fn.describe('gb5717')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5717 import *
import numpy as np
# See the function signature in fn/gb5717.py for argument names.
```
