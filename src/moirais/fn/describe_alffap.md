# describe('alffap') — alphafold_fape_loss
...
`print(result)` render. See `moirais.fn.describe('alffap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alffap import *
import numpy as np
# See the function signature in fn/alffap.py for argument names.
```
