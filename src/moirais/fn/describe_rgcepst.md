# describe('rgcepst') — rangayyan_cepstrum
...
`print(result)` render. See `moirais.fn.describe('rgcepst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcepst import *
import numpy as np
# See the function signature in fn/rgcepst.py for argument names.
```
