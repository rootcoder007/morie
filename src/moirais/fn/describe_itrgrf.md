...
`print(result)` render. See `moirais.fn.describe('itrgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itrgrf import *
import numpy as np
# See the function signature in fn/itrgrf.py for argument names.
```
