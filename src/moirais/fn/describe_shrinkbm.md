# describe('shrinkbm') — shrinkage_bayes
...
`print(result)` render. See `moirais.fn.describe('shrinkbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shrinkbm import *
import numpy as np
# See the function signature in fn/shrinkbm.py for argument names.
```
