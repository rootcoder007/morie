...
def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_212(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: Call: gam(formula = wage ∼ s(year , 4) + s(age , 5) + education ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u212')`` for the full guide.
