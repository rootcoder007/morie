...
`print(result)` render. See `moirais.fn.describe('jormse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jormse import *
import numpy as np
# See the function signature in fn/jormse.py for argument names.
```
