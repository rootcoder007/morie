# describe('irls') — iteratively_reweighted_ls
...
`print(result)` render. See `moirais.fn.describe('irls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irls import *
import numpy as np
# See the function signature in fn/irls.py for argument names.
```
