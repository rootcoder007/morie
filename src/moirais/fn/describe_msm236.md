# describe('msm236') — mvsml_general_eq_1_3
...
`print(result)` render. See `moirais.fn.describe('msm236')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm236 import *
import numpy as np
# See the function signature in fn/msm236.py for argument names.
```
