...
`print(result)` render. See `moirais.fn.describe('cusdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cusdt import *
import numpy as np
# See the function signature in fn/cusdt.py for argument names.
```
