# describe('km114') — kamath_ch8_bleu_precision
...
`print(result)` render. See `moirais.fn.describe('km114')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km114 import *
import numpy as np
# See the function signature in fn/km114.py for argument names.
```
