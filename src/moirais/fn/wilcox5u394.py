...
__all__ = ["wilcox_chapter_5_unnumbered_394"]


def wilcox_chapter_5_unnumbered_394(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 22. Given the following values for ¯X ands: (a) ¯X = 44, s = 10, (b) ¯X = 43, s = 10,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u394')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u394: PowerAndDesign expression (auto-extracted; see ref)."
