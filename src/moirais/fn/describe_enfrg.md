...
`print(result)` render. See `moirais.fn.describe('enfrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enfrg import *
import numpy as np
# See the function signature in fn/enfrg.py for argument names.
```
