...
`print(result)` render. See `moirais.fn.describe('simle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simle import *
import numpy as np
# See the function signature in fn/simle.py for argument names.
```
