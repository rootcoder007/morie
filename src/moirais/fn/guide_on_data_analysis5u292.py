...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_292"]


def guide_on_data_analysis_chapter_5_unnumbered_292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] HH = X(X′X)−1X′X(X′X)−1X′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u292')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u292: GeneralStatistics expression (auto-extracted; see ref)."
