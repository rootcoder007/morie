# describe('dpmmx') — dp_mixture_model
...
`print(result)` render. See `moirais.fn.describe('dpmmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmmx import *
import numpy as np
# See the function signature in fn/dpmmx.py for argument names.
```
