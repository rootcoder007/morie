# describe('tmlcll') — tmle_cross_lagged
...
`print(result)` render. See `moirais.fn.describe('tmlcll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcll import *
import numpy as np
# See the function signature in fn/tmlcll.py for argument names.
```
