# describe('ropedy') — rope_ntk_dynamic
...
`print(result)` render. See `moirais.fn.describe('ropedy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ropedy import *
import numpy as np
# See the function signature in fn/ropedy.py for argument names.
```
