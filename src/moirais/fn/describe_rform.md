# describe('rform') — parallel_form_reliability
...
`print(result)` render. See `moirais.fn.describe('rform')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rform import *
import numpy as np
# See the function signature in fn/rform.py for argument names.
```
