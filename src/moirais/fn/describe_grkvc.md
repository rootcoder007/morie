# describe('grkvc') — geron_kv_cache_compression
...
`print(result)` render. See `moirais.fn.describe('grkvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkvc import *
import numpy as np
# See the function signature in fn/grkvc.py for argument names.
```
