...
`print(result)` render. See `moirais.fn.describe('svqud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svqud import *
import numpy as np
# See the function signature in fn/svqud.py for argument names.
```
