# describe('msm128') — mvsml_categorical_count_eq_8_3
...
`print(result)` render. See `moirais.fn.describe('msm128')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm128 import *
import numpy as np
# See the function signature in fn/msm128.py for argument names.
```
