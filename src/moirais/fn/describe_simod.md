...
`print(result)` render. See `moirais.fn.describe('simod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simod import *
import numpy as np
# See the function signature in fn/simod.py for argument names.
```
