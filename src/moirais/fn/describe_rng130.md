# describe('rng130') — rangayyan_ch3_bilinear_warping_Omega_to_omega
...
`print(result)` render. See `moirais.fn.describe('rng130')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng130 import *
import numpy as np
# See the function signature in fn/rng130.py for argument names.
```
