...
`print(result)` render. See `moirais.fn.describe('nbind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbind import *
import numpy as np
# See the function signature in fn/nbind.py for argument names.
```
