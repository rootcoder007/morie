# describe('mstnk') — trustworthiness
...
`print(result)` render. See `moirais.fn.describe('mstnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mstnk import *
import numpy as np
# See the function signature in fn/mstnk.py for argument names.
```
