# describe('bunfl') — bayesian_unfolding
...
`print(result)` render. See `moirais.fn.describe('bunfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bunfl import *
import numpy as np
# See the function signature in fn/bunfl.py for argument names.
```
