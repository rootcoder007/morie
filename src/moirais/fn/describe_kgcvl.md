...
`print(result)` render. See `moirais.fn.describe('kgcvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgcvl import *
import numpy as np
# See the function signature in fn/kgcvl.py for argument names.
```
