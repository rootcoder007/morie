...
`print(result)` render. See `moirais.fn.describe('vachrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vachrd import *
import numpy as np
# See the function signature in fn/vachrd.py for argument names.
```
