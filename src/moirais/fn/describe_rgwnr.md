# describe('rgwnr') — rangayyan_wiener_filter
...
`print(result)` render. See `moirais.fn.describe('rgwnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwnr import *
import numpy as np
# See the function signature in fn/rgwnr.py for argument names.
```
