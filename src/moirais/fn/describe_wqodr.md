...
`print(result)` render. See `moirais.fn.describe('wqodr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqodr import *
import numpy as np
# See the function signature in fn/wqodr.py for argument names.
```
