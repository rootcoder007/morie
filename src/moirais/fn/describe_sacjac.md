...
`print(result)` render. See `moirais.fn.describe('sacjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacjac import *
import numpy as np
# See the function signature in fn/sacjac.py for argument names.
```
