...
`print(result)` render. See `moirais.fn.describe('vgcir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcir import *
import numpy as np
# See the function signature in fn/vgcir.py for argument names.
```
