# describe('msm187') — mvsml_ridge_lasso_elastic_eq_9_14
...
`print(result)` render. See `moirais.fn.describe('msm187')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm187 import *
import numpy as np
# See the function signature in fn/msm187.py for argument names.
```
