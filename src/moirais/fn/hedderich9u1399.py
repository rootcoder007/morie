...
__all__ = ["hedderich_chapter_9_unnumbered_1399"]


def hedderich_chapter_9_unnumbered_1399(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] For the sums we have: ∑x = 103, ∑y = 98∑x2 = 1593, ∑y2 = 1400∑xy = 1475
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1399')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1399: GeneralStatistics expression (auto-extracted; see ref)."
