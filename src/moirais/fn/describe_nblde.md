...
`print(result)` render. See `moirais.fn.describe('nblde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nblde import *
import numpy as np
# See the function signature in fn/nblde.py for argument names.
```
