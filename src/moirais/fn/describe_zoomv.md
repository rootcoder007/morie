# describe('zoomv') — velocity_profile
...
`print(result)` render. See `moirais.fn.describe('zoomv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zoomv import *
import numpy as np
# See the function signature in fn/zoomv.py for argument names.
```
