# describe('ktaup') — kendall_tau_partial
...
`print(result)` render. See `moirais.fn.describe('ktaup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ktaup import *
import numpy as np
# See the function signature in fn/ktaup.py for argument names.
```
