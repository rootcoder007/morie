...
__all__ = ["hedderich_chapter_9_unnumbered_3209"]


def hedderich_chapter_9_unnumbered_3209(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.190 = 0.39< 1.99 = t78;0.975
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3209')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3209: GeneralStatistics expression (auto-extracted; see ref)."
