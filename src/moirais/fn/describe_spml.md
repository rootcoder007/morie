# describe('spml') — schabenberger_ml_variogram
...
`print(result)` render. See `moirais.fn.describe('spml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spml import *
import numpy as np
# See the function signature in fn/spml.py for argument names.
```
