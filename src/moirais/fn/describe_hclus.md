# describe('hclus') — hierarchical_cluster
...
`print(result)` render. See `moirais.fn.describe('hclus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hclus import *
import numpy as np
# See the function signature in fn/hclus.py for argument names.
```
