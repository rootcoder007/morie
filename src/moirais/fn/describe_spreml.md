# describe('spreml') — schabenberger_reml_variogram
...
`print(result)` render. See `moirais.fn.describe('spreml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spreml import *
import numpy as np
# See the function signature in fn/spreml.py for argument names.
```
