...
`print(result)` render. See `moirais.fn.describe('ewok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewok import *
import numpy as np
# See the function signature in fn/ewok.py for argument names.
```
