...
`print(result)` render. See `moirais.fn.describe('sccut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sccut import *
import numpy as np
# See the function signature in fn/sccut.py for argument names.
```
