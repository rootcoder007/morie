# describe('rconv') — convergence_rate
...
`print(result)` render. See `moirais.fn.describe('rconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rconv import *
import numpy as np
# See the function signature in fn/rconv.py for argument names.
```
