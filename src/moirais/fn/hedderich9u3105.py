...
__all__ = ["hedderich_chapter_9_unnumbered_3105"]


def hedderich_chapter_9_unnumbered_3105(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1−r withν1 =ν2 =n−2 Kymn [Kym68] (7.392)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3105')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3105: GeneralStatistics expression (auto-extracted; see ref)."
