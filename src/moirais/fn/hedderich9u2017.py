...
__all__ = ["hedderich_chapter_9_unnumbered_2017"]


def hedderich_chapter_9_unnumbered_2017(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : x and y : t = −2.4765 , df = 11 , p− value = 0 .0 3 0 76
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2017')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2017: GeneralStatistics expression (auto-extracted; see ref)."
