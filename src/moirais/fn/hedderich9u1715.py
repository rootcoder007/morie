...
__all__ = ["hedderich_chapter_9_unnumbered_1715"]


def hedderich_chapter_9_unnumbered_1715(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] −0.5·ln(α/2) (e.g., α= 0.10; ln(0.10/2)= ln 0.05=−2.996, i.e.,√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1715')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1715: PowerAndDesign expression (auto-extracted; see ref)."
