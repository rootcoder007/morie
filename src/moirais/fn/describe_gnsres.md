...
`print(result)` render. See `moirais.fn.describe('gnsres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsres import *
import numpy as np
# See the function signature in fn/gnsres.py for argument names.
```
