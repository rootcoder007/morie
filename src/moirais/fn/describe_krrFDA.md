# describe('krrFDA') — kernel_ridge_regression
...
`print(result)` render. See `moirais.fn.describe('krrFDA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krrFDA import *
import numpy as np
# See the function signature in fn/krrFDA.py for argument names.
```
