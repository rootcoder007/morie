...
`print(result)` render. See `moirais.fn.describe('hzrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hzrat import *
import numpy as np
# See the function signature in fn/hzrat.py for argument names.
```
