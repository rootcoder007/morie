...
`print(result)` render. See `moirais.fn.describe('idwfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwfl import *
import numpy as np
# See the function signature in fn/idwfl.py for argument names.
```
