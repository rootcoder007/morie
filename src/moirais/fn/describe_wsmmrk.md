# describe('wsmmrk') — wasserman_markov_ineq
...
`print(result)` render. See `moirais.fn.describe('wsmmrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmrk import *
import numpy as np
# See the function signature in fn/wsmmrk.py for argument names.
```
