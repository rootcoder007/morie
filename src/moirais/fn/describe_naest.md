...
`print(result)` render. See `moirais.fn.describe('naest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.naest import *
import numpy as np
# See the function signature in fn/naest.py for argument names.
```
