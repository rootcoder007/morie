...
`print(result)` render. See `moirais.fn.describe('procp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.procp import *
import numpy as np
# See the function signature in fn/procp.py for argument names.
```
