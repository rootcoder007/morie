# describe('grdetr') — geron_detr_hungarian_matching
...
`print(result)` render. See `moirais.fn.describe('grdetr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdetr import *
import numpy as np
# See the function signature in fn/grdetr.py for argument names.
```
