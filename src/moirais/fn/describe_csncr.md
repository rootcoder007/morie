...
`print(result)` render. See `moirais.fn.describe('csncr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csncr import *
import numpy as np
# See the function signature in fn/csncr.py for argument names.
```
