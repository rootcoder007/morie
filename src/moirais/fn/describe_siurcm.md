# describe('siurcm') — siu_recommendation
...
`print(result)` render. See `moirais.fn.describe('siurcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siurcm import *
import numpy as np
# See the function signature in fn/siurcm.py for argument names.
```
