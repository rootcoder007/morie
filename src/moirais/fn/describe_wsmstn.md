# describe('wsmstn') — wasserman_sufficient
...
`print(result)` render. See `moirais.fn.describe('wsmstn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmstn import *
import numpy as np
# See the function signature in fn/wsmstn.py for argument names.
```
