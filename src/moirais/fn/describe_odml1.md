# describe('odml1') — otis_dml_region
...
`print(result)` render. See `moirais.fn.describe('odml1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml1 import *
import numpy as np
# See the function signature in fn/odml1.py for argument names.
```
