...
__all__ = ["wilcox_chapter_14_unnumbered_725"]


def wilcox_chapter_14_unnumbered_725(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: H0 :θ 1 − θ 2 =θ 2 − θ 3 = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u725')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u725: PowerAndDesign expression (auto-extracted; see ref)."
