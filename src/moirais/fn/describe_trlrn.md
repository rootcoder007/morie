...
`print(result)` render. See `moirais.fn.describe('trlrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trlrn import *
import numpy as np
# See the function signature in fn/trlrn.py for argument names.
```
