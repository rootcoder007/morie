# describe('bane') — structural_break
...
`print(result)` render. See `moirais.fn.describe('bane')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bane import *
import numpy as np
# See the function signature in fn/bane.py for argument names.
```
