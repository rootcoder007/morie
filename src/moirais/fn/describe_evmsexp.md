# describe('evmsexp') — evt_max_stable_logistic
...
`print(result)` render. See `moirais.fn.describe('evmsexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evmsexp import *
import numpy as np
# See the function signature in fn/evmsexp.py for argument names.
```
