...
`print(result)` render. See `moirais.fn.describe('rf_i')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rf_i import *
import numpy as np
# See the function signature in fn/rf_i.py for argument names.
```
