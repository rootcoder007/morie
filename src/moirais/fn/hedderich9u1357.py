...
__all__ = ["hedderich_chapter_9_unnumbered_1357"]


def hedderich_chapter_9_unnumbered_1357(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ≤σ2≤s2(n−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1357')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1357: GeneralStatistics expression (auto-extracted; see ref)."
