...
__all__ = ["hedderich_chapter_9_unnumbered_3551"]


def hedderich_chapter_9_unnumbered_3551(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑ˆe2i−∑d2i∑ˆe2i
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3551')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3551: GeneralStatistics expression (auto-extracted; see ref)."
