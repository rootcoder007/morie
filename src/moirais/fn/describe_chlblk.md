...
`print(result)` render. See `moirais.fn.describe('chlblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlblk import *
import numpy as np
# See the function signature in fn/chlblk.py for argument names.
```
