...
`print(result)` render. See `moirais.fn.describe('penrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.penrs import *
import numpy as np
# See the function signature in fn/penrs.py for argument names.
```
