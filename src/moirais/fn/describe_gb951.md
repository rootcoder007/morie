# describe('gb951') — gibbons_klotz_scale
...
`print(result)` render. See `moirais.fn.describe('gb951')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb951 import *
import numpy as np
# See the function signature in fn/gb951.py for argument names.
```
