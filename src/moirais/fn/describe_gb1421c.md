# describe('gb1421c') — gibbons_contingency_coeff
...
`print(result)` render. See `moirais.fn.describe('gb1421c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1421c import *
import numpy as np
# See the function signature in fn/gb1421c.py for argument names.
```
