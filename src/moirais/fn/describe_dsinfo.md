...
`print(result)` render. See `moirais.fn.describe('dsinfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dsinfo import *
import numpy as np
# See the function signature in fn/dsinfo.py for argument names.
```
