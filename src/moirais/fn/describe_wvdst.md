...
`print(result)` render. See `moirais.fn.describe('wvdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvdst import *
import numpy as np
# See the function signature in fn/wvdst.py for argument names.
```
