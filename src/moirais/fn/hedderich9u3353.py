...
__all__ = ["hedderich_chapter_9_unnumbered_3353"]


def hedderich_chapter_9_unnumbered_3353(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3353')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3353: GeneralStatistics expression (auto-extracted; see ref)."
