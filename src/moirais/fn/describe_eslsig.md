# describe('eslsig') — esl_residual_variance
...
`print(result)` render. See `moirais.fn.describe('eslsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsig import *
import numpy as np
# See the function signature in fn/eslsig.py for argument names.
```
