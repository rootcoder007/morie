# describe('kmverb') — kamath_verbalizer_mapping
...
`print(result)` render. See `moirais.fn.describe('kmverb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmverb import *
import numpy as np
# See the function signature in fn/kmverb.py for argument names.
```
