...
__all__ = ["bivand2013_chapter_2_unnumbered_20"]


def bivand2013_chapter_2_unnumbered_20(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + bty = "n", title = "measured")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u20')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u20: GeneralStatistics expression (auto-extracted; see ref)."
