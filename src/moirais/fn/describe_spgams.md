...
`print(result)` render. See `moirais.fn.describe('spgams')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgams import *
import numpy as np
# See the function signature in fn/spgams.py for argument names.
```
