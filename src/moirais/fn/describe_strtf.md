...
`print(result)` render. See `moirais.fn.describe('strtf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strtf import *
import numpy as np
# See the function signature in fn/strtf.py for argument names.
```
