...
`print(result)` render. See `moirais.fn.describe('ptcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptcox import *
import numpy as np
# See the function signature in fn/ptcox.py for argument names.
```
