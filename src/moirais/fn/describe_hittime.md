...
`print(result)` render. See `moirais.fn.describe('hittime')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hittime import *
import numpy as np
# See the function signature in fn/hittime.py for argument names.
```
