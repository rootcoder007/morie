...
`print(result)` render. See `moirais.fn.describe('agurb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agurb import *
import numpy as np
# See the function signature in fn/agurb.py for argument names.
```
