...
`print(result)` render. See `moirais.fn.describe('gpclf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpclf import *
import numpy as np
# See the function signature in fn/gpclf.py for argument names.
```
