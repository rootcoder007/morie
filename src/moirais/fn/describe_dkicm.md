...
`print(result)` render. See `moirais.fn.describe('dkicm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkicm import *
import numpy as np
# See the function signature in fn/dkicm.py for argument names.
```
