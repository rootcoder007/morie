# describe('fzmrb') — fauzi_mrl_boundary_free
...
`print(result)` render. See `moirais.fn.describe('fzmrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmrb import *
import numpy as np
# See the function signature in fn/fzmrb.py for argument names.
```
