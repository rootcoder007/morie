...
`print(result)` render. See `moirais.fn.describe('trtsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trtsp import *
import numpy as np
# See the function signature in fn/trtsp.py for argument names.
```
