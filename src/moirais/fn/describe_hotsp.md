...
`print(result)` render. See `moirais.fn.describe('hotsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotsp import *
import numpy as np
# See the function signature in fn/hotsp.py for argument names.
```
