...
`print(result)` render. See `moirais.fn.describe('sarwald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarwald import *
import numpy as np
# See the function signature in fn/sarwald.py for argument names.
```
