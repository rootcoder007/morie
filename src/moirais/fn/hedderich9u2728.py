...
__all__ = ["hedderich_chapter_9_unnumbered_2728"]


def hedderich_chapter_9_unnumbered_2728(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: β = 0.80 β = 0.90
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2728')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2728: PowerAndDesign expression (auto-extracted; see ref)."
