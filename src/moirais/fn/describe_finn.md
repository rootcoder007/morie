...
`print(result)` render. See `moirais.fn.describe('finn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.finn import *
import numpy as np
# See the function signature in fn/finn.py for argument names.
```
