...
__all__ = ["hedderich_chapter_9_unnumbered_1890"]


def hedderich_chapter_9_unnumbered_1890(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + method = " Cox− StuartTestfortrend change "
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1890')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1890: GeneralStatistics expression (auto-extracted; see ref)."
