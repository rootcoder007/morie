...
`print(result)` render. See `moirais.fn.describe('halft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.halft import *
import numpy as np
# See the function signature in fn/halft.py for argument names.
```
