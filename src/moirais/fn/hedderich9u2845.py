...
__all__ = ["hedderich_chapter_9_unnumbered_2845"]


def hedderich_chapter_9_unnumbered_2845(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pi = the average proportion, given bypi = (ai +ci)/ni and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2845')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2845: GeneralStatistics expression (auto-extracted; see ref)."
