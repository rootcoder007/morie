...
`print(result)` render. See `moirais.fn.describe('zxfpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxfpc import *
import numpy as np
# See the function signature in fn/zxfpc.py for argument names.
```
