# describe('msm235') — mvsml_ridge_lasso_elastic_eq_9_47
...
`print(result)` render. See `moirais.fn.describe('msm235')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm235 import *
import numpy as np
# See the function signature in fn/msm235.py for argument names.
```
