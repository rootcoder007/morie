# describe('otdwd') — ot_doubly_stoch_proj
...
`print(result)` render. See `moirais.fn.describe('otdwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otdwd import *
import numpy as np
# See the function signature in fn/otdwd.py for argument names.
```
