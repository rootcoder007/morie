...
`print(result)` render. See `moirais.fn.describe('supol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.supol import *
import numpy as np
# See the function signature in fn/supol.py for argument names.
```
