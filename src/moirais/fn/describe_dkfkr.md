...
`print(result)` render. See `moirais.fn.describe('dkfkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkfkr import *
import numpy as np
# See the function signature in fn/dkfkr.py for argument names.
```
