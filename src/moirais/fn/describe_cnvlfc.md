# describe('cnvlfc') — convergent_cross_mapping
...
`print(result)` render. See `moirais.fn.describe('cnvlfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnvlfc import *
import numpy as np
# See the function signature in fn/cnvlfc.py for argument names.
```
