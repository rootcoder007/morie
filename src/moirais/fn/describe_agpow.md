...
`print(result)` render. See `moirais.fn.describe('agpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agpow import *
import numpy as np
# See the function signature in fn/agpow.py for argument names.
```
