# describe('emkfst') — em_state_space
...
`print(result)` render. See `moirais.fn.describe('emkfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emkfst import *
import numpy as np
# See the function signature in fn/emkfst.py for argument names.
```
