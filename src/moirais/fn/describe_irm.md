...
`print(result)` render. See `moirais.fn.describe('irm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irm import *
import numpy as np
# See the function signature in fn/irm.py for argument names.
```
