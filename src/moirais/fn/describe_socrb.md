...
`print(result)` render. See `moirais.fn.describe('socrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socrb import *
import numpy as np
# See the function signature in fn/socrb.py for argument names.
```
