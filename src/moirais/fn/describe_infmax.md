# describe('infmax') — infomax_objective
...
`print(result)` render. See `moirais.fn.describe('infmax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infmax import *
import numpy as np
# See the function signature in fn/infmax.py for argument names.
```
