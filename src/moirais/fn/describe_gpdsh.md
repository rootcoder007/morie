# describe('gpdsh') — gp_density_shift
...
`print(result)` render. See `moirais.fn.describe('gpdsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpdsh import *
import numpy as np
# See the function signature in fn/gpdsh.py for argument names.
```
