...
`print(result)` render. See `moirais.fn.describe('hurds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hurds import *
import numpy as np
# See the function signature in fn/hurds.py for argument names.
```
