...
`print(result)` render. See `moirais.fn.describe('sarim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarim import *
import numpy as np
# See the function signature in fn/sarim.py for argument names.
```
