...
`print(result)` render. See `moirais.fn.describe('vmind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmind import *
import numpy as np
# See the function signature in fn/vmind.py for argument names.
```
