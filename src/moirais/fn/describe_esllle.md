...
`print(result)` render. See `moirais.fn.describe('esllle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllle import *
import numpy as np
# See the function signature in fn/esllle.py for argument names.
```
