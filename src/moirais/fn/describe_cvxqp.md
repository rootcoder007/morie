# describe('cvxqp') — boyd_quadratic_program
...
`print(result)` render. See `moirais.fn.describe('cvxqp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxqp import *
import numpy as np
# See the function signature in fn/cvxqp.py for argument names.
```
