...
`print(result)` render. See `moirais.fn.describe('sgmean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmean import *
import numpy as np
# See the function signature in fn/sgmean.py for argument names.
```
