...
`print(result)` render. See `moirais.fn.describe('msnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msnmt import *
import numpy as np
# See the function signature in fn/msnmt.py for argument names.
```
