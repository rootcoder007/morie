# describe('itrel') — item_reliability_index
...
`print(result)` render. See `moirais.fn.describe('itrel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itrel import *
import numpy as np
# See the function signature in fn/itrel.py for argument names.
```
