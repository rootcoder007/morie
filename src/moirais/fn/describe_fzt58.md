# describe('fzt58') — fauzi_thm5_8_smoothed_convergence
...
`print(result)` render. See `moirais.fn.describe('fzt58')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt58 import *
import numpy as np
# See the function signature in fn/fzt58.py for argument names.
```
