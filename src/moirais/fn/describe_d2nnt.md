...
`print(result)` render. See `moirais.fn.describe('d2nnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.d2nnt import *
import numpy as np
# See the function signature in fn/d2nnt.py for argument names.
```
