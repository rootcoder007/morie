...
`print(result)` render. See `moirais.fn.describe('pafuz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pafuz import *
import numpy as np
# See the function signature in fn/pafuz.py for argument names.
```
