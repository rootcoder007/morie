...
`print(result)` render. See `moirais.fn.describe('agcoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcoh import *
import numpy as np
# See the function signature in fn/agcoh.py for argument names.
```
