...
`print(result)` render. See `moirais.fn.describe('wqinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqinf import *
import numpy as np
# See the function signature in fn/wqinf.py for argument names.
```
