...
__all__ = ["hedderich_chapter_9_unnumbered_109"]


def hedderich_chapter_9_unnumbered_109(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y =b2(x−sx)2 +sy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u109')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u109: GeneralStatistics expression (auto-extracted; see ref)."
