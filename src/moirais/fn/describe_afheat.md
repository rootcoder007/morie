...
`print(result)` render. See `moirais.fn.describe('afheat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afheat import *
import numpy as np
# See the function signature in fn/afheat.py for argument names.
```
