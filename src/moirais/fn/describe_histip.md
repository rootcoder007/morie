# describe('histip') — histogram_ideal_points
...
`print(result)` render. See `moirais.fn.describe('histip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.histip import *
import numpy as np
# See the function signature in fn/histip.py for argument names.
```
