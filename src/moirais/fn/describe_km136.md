# describe('km136') — kamath_ch9_mml_vlm_loss
...
`print(result)` render. See `moirais.fn.describe('km136')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km136 import *
import numpy as np
# See the function signature in fn/km136.py for argument names.
```
