# describe('wnbrt') — bartlett_window
...
`print(result)` render. See `moirais.fn.describe('wnbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnbrt import *
import numpy as np
# See the function signature in fn/wnbrt.py for argument names.
```
