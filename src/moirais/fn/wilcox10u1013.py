...
__all__ = ["wilcox_chapter_10_unnumbered_1013"]


def wilcox_chapter_10_unnumbered_1013(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rmmcp(x,con = 0, tr = 0.2, alpha = 0.05, dif=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1013')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1013: GeneralStatistics expression (auto-extracted; see ref)."
