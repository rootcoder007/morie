# describe('grmsam') — graded_response_samejima
...
`print(result)` render. See `moirais.fn.describe('grmsam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmsam import *
import numpy as np
# See the function signature in fn/grmsam.py for argument names.
```
