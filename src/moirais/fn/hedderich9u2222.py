...
__all__ = ["hedderich_chapter_9_unnumbered_2222"]


def hedderich_chapter_9_unnumbered_2222(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H0 : λ1 =λ2 against HA : λ1̸=λ2 is then accordingly
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2222')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2222: CountModels expression (auto-extracted; see ref)."
