...
__all__ = ["hedderich_chapter_9_unnumbered_138"]


def hedderich_chapter_9_unnumbered_138(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u138')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u138: GeneralStatistics expression (auto-extracted; see ref)."
