# describe('rgecgwvf') — rangayyan_ecg_waveshape
...
`print(result)` render. See `moirais.fn.describe('rgecgwvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgecgwvf import *
import numpy as np
# See the function signature in fn/rgecgwvf.py for argument names.
```
