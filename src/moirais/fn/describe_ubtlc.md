...
`print(result)` render. See `moirais.fn.describe('ubtlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubtlc import *
import numpy as np
# See the function signature in fn/ubtlc.py for argument names.
```
