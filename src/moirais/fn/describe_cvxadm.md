...
`print(result)` render. See `moirais.fn.describe('cvxadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxadm import *
import numpy as np
# See the function signature in fn/cvxadm.py for argument names.
```
