# describe('dar') — direct_age_adjustment
...
`print(result)` render. See `moirais.fn.describe('dar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dar import *
import numpy as np
# See the function signature in fn/dar.py for argument names.
```
