...
__all__ = ["hedderich_chapter_9_unnumbered_2102"]


def hedderich_chapter_9_unnumbered_2102(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Qxy = (21·26 + 18·33 + 20·27 + 21·34)−80·120
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2102')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2102: GeneralStatistics expression (auto-extracted; see ref)."
