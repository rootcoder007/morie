# describe('crtbl') — court_bail_rate
...
`print(result)` render. See `moirais.fn.describe('crtbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtbl import *
import numpy as np
# See the function signature in fn/crtbl.py for argument names.
```
