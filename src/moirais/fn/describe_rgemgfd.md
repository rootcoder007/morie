# describe('rgemgfd') — rangayyan_emg_fractal_dim

## WHAT IT DOES

Fractal dimension of EMG in relation to muscle force.
...
`print(result)` render. See `moirais.fn.describe('rgemgfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemgfd import *
import numpy as np
# See the function signature in fn/rgemgfd.py for argument names.
```
