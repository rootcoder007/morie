# describe('sgtmp') — temperature_schedule
...
`print(result)` render. See `moirais.fn.describe('sgtmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtmp import *
import numpy as np
# See the function signature in fn/sgtmp.py for argument names.
```
