# describe('msm117') — mvsml_bayesian_regression_pt2_eq_7_7
...
`print(result)` render. See `moirais.fn.describe('msm117')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm117 import *
import numpy as np
# See the function signature in fn/msm117.py for argument names.
```
