...
__all__ = ["hedderich_chapter_9_unnumbered_494"]


def hedderich_chapter_9_unnumbered_494(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (a)P (T +|K) = P (T +∩K)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u494')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u494: GeneralStatistics expression (auto-extracted; see ref)."
