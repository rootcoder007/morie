...
__all__ = ["wilcox_chapter_10_unnumbered_1047"]


def wilcox_chapter_10_unnumbered_1047(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outproadMC(m, center = NA, plotit = T, op = T, MM = F, cop = 3, xlab = "VAR
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1047')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1047: GeneralStatistics expression (auto-extracted; see ref)."
