...
`print(result)` render. See `moirais.fn.describe('svfut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svfut import *
import numpy as np
# See the function signature in fn/svfut.py for argument names.
```
