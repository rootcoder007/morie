...
`print(result)` render. See `moirais.fn.describe('litlw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.litlw import *
import numpy as np
# See the function signature in fn/litlw.py for argument names.
```
