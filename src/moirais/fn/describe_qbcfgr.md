# describe('qbcfgr') — quantile_balanced_cf
...
`print(result)` render. See `moirais.fn.describe('qbcfgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qbcfgr import *
import numpy as np
# See the function signature in fn/qbcfgr.py for argument names.
```
