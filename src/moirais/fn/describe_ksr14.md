# describe('ksr14') — kosorok_profile_likelihood
...
`print(result)` render. See `moirais.fn.describe('ksr14')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr14 import *
import numpy as np
# See the function signature in fn/ksr14.py for argument names.
```
