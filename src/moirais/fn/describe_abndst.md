# describe('abndst') — abundance_estimation
...
`print(result)` render. See `moirais.fn.describe('abndst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abndst import *
import numpy as np
# See the function signature in fn/abndst.py for argument names.
```
