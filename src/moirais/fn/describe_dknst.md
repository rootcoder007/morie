...
`print(result)` render. See `moirais.fn.describe('dknst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dknst import *
import numpy as np
# See the function signature in fn/dknst.py for argument names.
```
