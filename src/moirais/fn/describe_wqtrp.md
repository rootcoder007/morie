...
`print(result)` render. See `moirais.fn.describe('wqtrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtrp import *
import numpy as np
# See the function signature in fn/wqtrp.py for argument names.
```
