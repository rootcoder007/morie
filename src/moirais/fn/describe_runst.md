...
`print(result)` render. See `moirais.fn.describe('runst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.runst import *
import numpy as np
# See the function signature in fn/runst.py for argument names.
```
