...
__all__ = ["wilcox_chapter_14_unnumbered_604"]


def wilcox_chapter_14_unnumbered_604(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: So if β 3 = 0, both groups have slope β 1 with different intercepts if β 2 ̸= 0. That is, the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u604')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u604: GeneralStatistics expression (auto-extracted; see ref)."
