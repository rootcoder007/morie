...
__all__ = ["hedderich_chapter_9_unnumbered_368"]


def hedderich_chapter_9_unnumbered_368(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] S(x) = b0 +b1x +b2x2 +b3x3 +b4(x−c1)3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u368')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u368: GeneralStatistics expression (auto-extracted; see ref)."
