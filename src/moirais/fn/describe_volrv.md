# describe('volrv') — vol_realised_variance
...
`print(result)` render. See `moirais.fn.describe('volrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrv import *
import numpy as np
# See the function signature in fn/volrv.py for argument names.
```
