# describe('pstmw') — ps_trimmed_weights
...
`print(result)` render. See `moirais.fn.describe('pstmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstmw import *
import numpy as np
# See the function signature in fn/pstmw.py for argument names.
```
