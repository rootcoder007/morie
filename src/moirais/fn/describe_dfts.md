...
`print(result)` render. See `moirais.fn.describe('dfts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfts import *
import numpy as np
# See the function signature in fn/dfts.py for argument names.
```
