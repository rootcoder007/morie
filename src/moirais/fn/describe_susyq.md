...
`print(result)` render. See `moirais.fn.describe('susyq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.susyq import *
import numpy as np
# See the function signature in fn/susyq.py for argument names.
```
