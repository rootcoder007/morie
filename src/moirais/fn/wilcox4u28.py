...
__all__ = ["wilcox_chapter_4_unnumbered_28"]


def wilcox_chapter_4_unnumbered_28(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯Xos = 56.79 + 227.47 = 284.26.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u28')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u28: GeneralStatistics expression (auto-extracted; see ref)."
