...
__all__ = ["wilcox_chapter_14_unnumbered_562"]


def wilcox_chapter_14_unnumbered_562(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the squared standard error of ˆδ . Let z be the 1 − α/2 quantile of a standard normal
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u562')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u562: GeneralStatistics expression (auto-extracted; see ref)."
