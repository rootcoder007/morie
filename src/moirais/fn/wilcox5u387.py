...
__all__ = ["wilcox_chapter_5_unnumbered_387"]


def wilcox_chapter_5_unnumbered_387(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: company has found that the average quality is µ = 232 with σ = 4. However,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u387')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u387: GeneralStatistics expression (auto-extracted; see ref)."
