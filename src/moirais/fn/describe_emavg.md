...
`print(result)` render. See `moirais.fn.describe('emavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emavg import *
import numpy as np
# See the function signature in fn/emavg.py for argument names.
```
