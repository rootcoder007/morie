...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_143"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_143(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] m:e=(n,m)∈E fe − ∑
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u143')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u143: GeneralStatistics expression (auto-extracted; see ref)."
