...
`print(result)` render. See `moirais.fn.describe('psnon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psnon import *
import numpy as np
# See the function signature in fn/psnon.py for argument names.
```
