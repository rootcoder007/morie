...
__all__ = ["hedderich_chapter_9_unnumbered_744"]


def hedderich_chapter_9_unnumbered_744(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u744')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u744: CountModels expression (auto-extracted; see ref)."
