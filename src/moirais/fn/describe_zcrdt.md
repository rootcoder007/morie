...
`print(result)` render. See `moirais.fn.describe('zcrdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zcrdt import *
import numpy as np
# See the function signature in fn/zcrdt.py for argument names.
```
