...
`print(result)` render. See `moirais.fn.describe('trtxi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trtxi import *
import numpy as np
# See the function signature in fn/trtxi.py for argument names.
```
