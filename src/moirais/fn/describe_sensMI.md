# describe('sensMI') — sensitivity_mediation_imbens
...
`print(result)` render. See `moirais.fn.describe('sensMI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sensMI import *
import numpy as np
# See the function signature in fn/sensMI.py for argument names.
```
