# describe('survcfg') — causal_survival_forest_grf
...
`print(result)` render. See `moirais.fn.describe('survcfg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survcfg import *
import numpy as np
# See the function signature in fn/survcfg.py for argument names.
```
