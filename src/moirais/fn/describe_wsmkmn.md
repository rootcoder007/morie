# describe('wsmkmn') — wasserman_kmeans
...
`print(result)` render. See `moirais.fn.describe('wsmkmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmkmn import *
import numpy as np
# See the function signature in fn/wsmkmn.py for argument names.
```
