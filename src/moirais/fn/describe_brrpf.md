# describe('brrpf') — brr_prior_posterior
...
`print(result)` render. See `moirais.fn.describe('brrpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brrpf import *
import numpy as np
# See the function signature in fn/brrpf.py for argument names.
```
