...
def hedderich_chapter_9_unnumbered_2911(x):
    ...
    Formula: + c a t( name=" Cochran − Armitage Testauf Trend " , " \ n " ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2911')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2911: Association expression (auto-extracted; see ref)."
