...
`print(result)` render. See `moirais.fn.describe('svucs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svucs import *
import numpy as np
# See the function signature in fn/svucs.py for argument names.
```
