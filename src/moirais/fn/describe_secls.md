...
`print(result)` render. See `moirais.fn.describe('secls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secls import *
import numpy as np
# See the function signature in fn/secls.py for argument names.
```
