# describe('msmcox') — msm_cox_marginal
...
`print(result)` render. See `moirais.fn.describe('msmcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmcox import *
import numpy as np
# See the function signature in fn/msmcox.py for argument names.
```
