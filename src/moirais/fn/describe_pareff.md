# describe('pareff') — population_attributable
...
`print(result)` render. See `moirais.fn.describe('pareff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pareff import *
import numpy as np
# See the function signature in fn/pareff.py for argument names.
```
