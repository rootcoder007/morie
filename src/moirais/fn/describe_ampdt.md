# describe('ampdt') — amplitude_detect
...
`print(result)` render. See `moirais.fn.describe('ampdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ampdt import *
import numpy as np
# See the function signature in fn/ampdt.py for argument names.
```
