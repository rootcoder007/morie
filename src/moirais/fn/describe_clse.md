...
`print(result)` render. See `moirais.fn.describe('clse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clse import *
import numpy as np
# See the function signature in fn/clse.py for argument names.
```
