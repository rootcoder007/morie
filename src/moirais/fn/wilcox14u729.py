...
__all__ = ["wilcox_chapter_14_unnumbered_729"]


def wilcox_chapter_14_unnumbered_729(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: F, MC=F, SEED=T, na.rm = F, ...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u729')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u729: ANOVA expression (auto-extracted; see ref)."
