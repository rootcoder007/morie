...
`print(result)` render. See `moirais.fn.describe('sterea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sterea import *
import numpy as np
# See the function signature in fn/sterea.py for argument names.
```
