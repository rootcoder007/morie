...
`print(result)` render. See `moirais.fn.describe('skurt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.skurt import *
import numpy as np
# See the function signature in fn/skurt.py for argument names.
```
