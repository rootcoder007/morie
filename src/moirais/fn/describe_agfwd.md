...
`print(result)` render. See `moirais.fn.describe('agfwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agfwd import *
import numpy as np
# See the function signature in fn/agfwd.py for argument names.
```
