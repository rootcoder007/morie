...
`print(result)` render. See `moirais.fn.describe('icc31c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc31c import *
import numpy as np
# See the function signature in fn/icc31c.py for argument names.
```
