# describe('msm162') — mvsml_ridge_lasso_elastic_eq_9_1
...
`print(result)` render. See `moirais.fn.describe('msm162')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm162 import *
import numpy as np
# See the function signature in fn/msm162.py for argument names.
```
