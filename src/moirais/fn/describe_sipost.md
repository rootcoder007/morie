...
`print(result)` render. See `moirais.fn.describe('sipost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sipost import *
import numpy as np
# See the function signature in fn/sipost.py for argument names.
```
