...
`print(result)` render. See `moirais.fn.describe('nebzr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nebzr import *
import numpy as np
# See the function signature in fn/nebzr.py for argument names.
```
