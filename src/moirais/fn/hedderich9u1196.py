...
__all__ = ["hedderich_chapter_9_unnumbered_1196"]


def hedderich_chapter_9_unnumbered_1196(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1196')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1196: PowerAndDesign expression (auto-extracted; see ref)."
