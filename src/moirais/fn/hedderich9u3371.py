...
__all__ = ["hedderich_chapter_9_unnumbered_3371"]


def hedderich_chapter_9_unnumbered_3371(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: little to the explanation (D =−3.16, withP = 0.076).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3371')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3371: GeneralStatistics expression (auto-extracted; see ref)."
