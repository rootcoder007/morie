# describe('wlcxsv') — wilcoxon_gehan
...
`print(result)` render. See `moirais.fn.describe('wlcxsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcxsv import *
import numpy as np
# See the function signature in fn/wlcxsv.py for argument names.
```
