...
`print(result)` render. See `moirais.fn.describe('evpot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evpot import *
import numpy as np
# See the function signature in fn/evpot.py for argument names.
```
