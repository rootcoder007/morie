...
`print(result)` render. See `moirais.fn.describe('malab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.malab import *
import numpy as np
# See the function signature in fn/malab.py for argument names.
```
