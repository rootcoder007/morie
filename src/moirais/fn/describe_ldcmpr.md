...
`print(result)` render. See `moirais.fn.describe('ldcmpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldcmpr import *
import numpy as np
# See the function signature in fn/ldcmpr.py for argument names.
```
