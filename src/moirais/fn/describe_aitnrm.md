# describe('aitnrm') — aitchison_norm
...
`print(result)` render. See `moirais.fn.describe('aitnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitnrm import *
import numpy as np
# See the function signature in fn/aitnrm.py for argument names.
```
