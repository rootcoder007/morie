...
`print(result)` render. See `moirais.fn.describe('cookd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cookd import *
import numpy as np
# See the function signature in fn/cookd.py for argument names.
```
