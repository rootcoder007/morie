# describe('mteff') — mteff

## WHAT IT DOES

Efficiency spatial network
...
`print(result)` render. See `moirais.fn.describe('mteff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mteff import *
import numpy as np
# See the function signature in fn/mteff.py for argument names.
```
