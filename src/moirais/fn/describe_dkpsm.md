# describe('dkpsm') — dkpsm

## WHAT IT DOES

Product-sum ST variogram
...
`print(result)` render. See `moirais.fn.describe('dkpsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkpsm import *
import numpy as np
# See the function signature in fn/dkpsm.py for argument names.
```
