...
`print(result)` render. See `moirais.fn.describe('swcond')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swcond import *
import numpy as np
# See the function signature in fn/swcond.py for argument names.
```
