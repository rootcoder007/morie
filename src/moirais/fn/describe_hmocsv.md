# describe('hmocsv') — geron_one_class_svm
...
`print(result)` render. See `moirais.fn.describe('hmocsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmocsv import *
import numpy as np
# See the function signature in fn/hmocsv.py for argument names.
```
