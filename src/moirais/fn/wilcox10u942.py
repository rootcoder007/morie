...
__all__ = ["wilcox_chapter_10_unnumbered_942"]


def wilcox_chapter_10_unnumbered_942(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: T able 12.5 Values of α c for α = 0.05 and 0.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u942')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u942: PowerAndDesign expression (auto-extracted; see ref)."
