# describe('hmmto') — geron_multioutput
...
`print(result)` render. See `moirais.fn.describe('hmmto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmto import *
import numpy as np
# See the function signature in fn/hmmto.py for argument names.
```
