# describe('rng117') — rangayyan_ch3_three_point_central_diff_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng117')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng117 import *
import numpy as np
# See the function signature in fn/rng117.py for argument names.
```
