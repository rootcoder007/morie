# describe('msm306') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm306')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm306 import *
import numpy as np
# See the function signature in fn/msm306.py for argument names.
```
