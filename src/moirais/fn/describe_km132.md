# describe('km132') — kamath_ch9_llm_signal_tokens
...
`print(result)` render. See `moirais.fn.describe('km132')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km132 import *
import numpy as np
# See the function signature in fn/km132.py for argument names.
```
