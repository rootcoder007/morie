...
`print(result)` render. See `moirais.fn.describe('cvxlse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlse import *
import numpy as np
# See the function signature in fn/cvxlse.py for argument names.
```
