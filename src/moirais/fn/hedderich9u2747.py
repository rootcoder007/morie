...
__all__ = ["hedderich_chapter_9_unnumbered_2747"]


def hedderich_chapter_9_unnumbered_2747(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: CER−EER±z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2747')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2747: GeneralStatistics expression (auto-extracted; see ref)."
