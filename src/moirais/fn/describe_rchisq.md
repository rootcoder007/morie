...
`print(result)` render. See `moirais.fn.describe('rchisq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rchisq import *
import numpy as np
# See the function signature in fn/rchisq.py for argument names.
```
