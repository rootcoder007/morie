...
`print(result)` render. See `moirais.fn.describe('stdfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdfp import *
import numpy as np
# See the function signature in fn/stdfp.py for argument names.
```
