...
`print(result)` render. See `moirais.fn.describe('mtotrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtotrn import *
import numpy as np
# See the function signature in fn/mtotrn.py for argument names.
```
