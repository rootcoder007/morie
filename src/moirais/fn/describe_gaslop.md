...
`print(result)` render. See `moirais.fn.describe('gaslop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaslop import *
import numpy as np
# See the function signature in fn/gaslop.py for argument names.
```
