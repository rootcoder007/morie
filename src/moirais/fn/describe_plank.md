...
`print(result)` render. See `moirais.fn.describe('plank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plank import *
import numpy as np
# See the function signature in fn/plank.py for argument names.
```
