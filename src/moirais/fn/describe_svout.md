...
`print(result)` render. See `moirais.fn.describe('svout')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svout import *
import numpy as np
# See the function signature in fn/svout.py for argument names.
```
