...
__all__ = ["wilcox_chapter_14_unnumbered_504"]


def wilcox_chapter_14_unnumbered_504(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u504')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u504: GeneralStatistics expression (auto-extracted; see ref)."
