# describe('sugen') — substance_by_gender
...
`print(result)` render. See `moirais.fn.describe('sugen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sugen import *
import numpy as np
# See the function signature in fn/sugen.py for argument names.
```
