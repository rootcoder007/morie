...
`print(result)` render. See `moirais.fn.describe('gemin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gemin import *
import numpy as np
# See the function signature in fn/gemin.py for argument names.
```
