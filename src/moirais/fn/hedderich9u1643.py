...
__all__ = ["hedderich_chapter_9_unnumbered_1643"]


def hedderich_chapter_9_unnumbered_1643(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1643')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1643: PowerAndDesign expression (auto-extracted; see ref)."
