# describe('rgrpsig') — rangayyan_resp_signal
...
`print(result)` render. See `moirais.fn.describe('rgrpsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrpsig import *
import numpy as np
# See the function signature in fn/rgrpsig.py for argument names.
```
