...
`print(result)` render. See `moirais.fn.describe('gwrpois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrpois import *
import numpy as np
# See the function signature in fn/gwrpois.py for argument names.
```
