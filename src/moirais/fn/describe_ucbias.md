# describe('ucbias') — unmeasured_conf_bias
...
`print(result)` render. See `moirais.fn.describe('ucbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ucbias import *
import numpy as np
# See the function signature in fn/ucbias.py for argument names.
```
