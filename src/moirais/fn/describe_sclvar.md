# describe('sclvar') — selection_coefficient
...
`print(result)` render. See `moirais.fn.describe('sclvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sclvar import *
import numpy as np
# See the function signature in fn/sclvar.py for argument names.
```
