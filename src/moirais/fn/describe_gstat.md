...
`print(result)` render. See `moirais.fn.describe('gstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gstat import *
import numpy as np
# See the function signature in fn/gstat.py for argument names.
```
