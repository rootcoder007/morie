# describe('nrgmwd') — normalized_random_measure
...
`print(result)` render. See `moirais.fn.describe('nrgmwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrgmwd import *
import numpy as np
# See the function signature in fn/nrgmwd.py for argument names.
```
