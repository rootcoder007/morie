# describe('sa_opt') — simulated_annealing
...
`print(result)` render. See `moirais.fn.describe('sa_opt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sa_opt import *
import numpy as np
# See the function signature in fn/sa_opt.py for argument names.
```
