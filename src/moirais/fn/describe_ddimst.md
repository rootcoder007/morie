...
`print(result)` render. See `moirais.fn.describe('ddimst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddimst import *
import numpy as np
# See the function signature in fn/ddimst.py for argument names.
```
