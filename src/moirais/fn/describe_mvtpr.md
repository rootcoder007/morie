...
`print(result)` render. See `moirais.fn.describe('mvtpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtpr import *
import numpy as np
# See the function signature in fn/mvtpr.py for argument names.
```
