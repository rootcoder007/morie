...
`print(result)` render. See `moirais.fn.describe('drlnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drlnr import *
import numpy as np
# See the function signature in fn/drlnr.py for argument names.
```
