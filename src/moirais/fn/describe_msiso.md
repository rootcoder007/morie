...
`print(result)` render. See `moirais.fn.describe('msiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msiso import *
import numpy as np
# See the function signature in fn/msiso.py for argument names.
```
