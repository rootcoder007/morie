# describe('hrzplrq') — horowitz_plr_quantile
...
`print(result)` render. See `moirais.fn.describe('hrzplrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzplrq import *
import numpy as np
# See the function signature in fn/hrzplrq.py for argument names.
```
