# describe('glb12r') — greatest_lower_bound
...
`print(result)` render. See `moirais.fn.describe('glb12r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glb12r import *
import numpy as np
# See the function signature in fn/glb12r.py for argument names.
```
