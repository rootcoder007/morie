...
`print(result)` render. See `moirais.fn.describe('geapt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geapt import *
import numpy as np
# See the function signature in fn/geapt.py for argument names.
```
