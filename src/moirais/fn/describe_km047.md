# describe('km047') — kamath_ch3_translate_prefix_prompt
...
`print(result)` render. See `moirais.fn.describe('km047')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km047 import *
import numpy as np
# See the function signature in fn/km047.py for argument names.
```
