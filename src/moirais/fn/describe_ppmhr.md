...
`print(result)` render. See `moirais.fn.describe('ppmhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmhr import *
import numpy as np
# See the function signature in fn/ppmhr.py for argument names.
```
