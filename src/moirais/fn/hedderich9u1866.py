...
__all__ = ["hedderich_chapter_9_unnumbered_1866"]


def hedderich_chapter_9_unnumbered_1866(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 is rejected if ˆz >z(1−α/2) (correspondingly for one-sided hypothesis also for ˆz >z(1−α)).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1866')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1866: GeneralStatistics expression (auto-extracted; see ref)."
