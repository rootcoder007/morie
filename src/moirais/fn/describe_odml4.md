# describe('odml4') — otis_dml_gender
...
`print(result)` render. See `moirais.fn.describe('odml4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odml4 import *
import numpy as np
# See the function signature in fn/odml4.py for argument names.
```
