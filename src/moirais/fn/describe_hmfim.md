# describe('hmfim') — geron_feature_importance
...
`print(result)` render. See `moirais.fn.describe('hmfim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfim import *
import numpy as np
# See the function signature in fn/hmfim.py for argument names.
```
