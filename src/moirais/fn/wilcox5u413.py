...
__all__ = ["wilcox_chapter_5_unnumbered_413"]


def wilcox_chapter_5_unnumbered_413(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: As for the intercept, β 0, a 1 − α confidence interval is given by
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u413')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u413: GeneralStatistics expression (auto-extracted; see ref)."
