# describe('jooutl') — joseph_ts_outlier_detection
...
`print(result)` render. See `moirais.fn.describe('jooutl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jooutl import *
import numpy as np
# See the function signature in fn/jooutl.py for argument names.
```
