...
__all__ = ["hedderich_chapter_9_unnumbered_1860"]


def hedderich_chapter_9_unnumbered_1860(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (100−1)·5/4 = 123.75> 123.23 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1860')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1860: GeneralStatistics expression (auto-extracted; see ref)."
