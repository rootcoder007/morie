# describe('chnvg') — chain_convergence_test
...
`print(result)` render. See `moirais.fn.describe('chnvg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chnvg import *
import numpy as np
# See the function signature in fn/chnvg.py for argument names.
```
