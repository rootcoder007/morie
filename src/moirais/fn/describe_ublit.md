...
`print(result)` render. See `moirais.fn.describe('ublit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ublit import *
import numpy as np
# See the function signature in fn/ublit.py for argument names.
```
