# describe('spnsr') — schabenberger_nugget_sill_range_effect
...
`print(result)` render. See `moirais.fn.describe('spnsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnsr import *
import numpy as np
# See the function signature in fn/spnsr.py for argument names.
```
