# describe('gh_gp_brow_prim') — ghosal_gp_brownian_primitive
...
`print(result)` render. See `moirais.fn.describe('gh_gp_brow_prim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_gp_brow_prim import *
import numpy as np
# See the function signature in fn/gh_gp_brow_prim.py for argument names.
```
