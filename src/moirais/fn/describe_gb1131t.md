# describe('gb1131t') — gibbons_spearman_ties
...
`print(result)` render. See `moirais.fn.describe('gb1131t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1131t import *
import numpy as np
# See the function signature in fn/gb1131t.py for argument names.
```
