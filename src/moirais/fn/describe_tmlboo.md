# describe('tmlboo') — tmle_bootstrap_ci
...
`print(result)` render. See `moirais.fn.describe('tmlboo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlboo import *
import numpy as np
# See the function signature in fn/tmlboo.py for argument names.
```
