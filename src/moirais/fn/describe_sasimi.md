# describe('sasimi') — tanimoto_similarity
...
`print(result)` render. See `moirais.fn.describe('sasimi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sasimi import *
import numpy as np
# See the function signature in fn/sasimi.py for argument names.
```
