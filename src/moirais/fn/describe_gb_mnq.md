# describe('gb_mnq') — gibbons_marginal_quant
...
`print(result)` render. See `moirais.fn.describe('gb_mnq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_mnq import *
import numpy as np
# See the function signature in fn/gb_mnq.py for argument names.
```
