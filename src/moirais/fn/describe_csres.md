...
`print(result)` render. See `moirais.fn.describe('csres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csres import *
import numpy as np
# See the function signature in fn/csres.py for argument names.
```
