...
`print(result)` render. See `moirais.fn.describe('sarsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarsim import *
import numpy as np
# See the function signature in fn/sarsim.py for argument names.
```
