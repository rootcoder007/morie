# describe('evextint') — evt_extremal_index_intervals
...
`print(result)` render. See `moirais.fn.describe('evextint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evextint import *
import numpy as np
# See the function signature in fn/evextint.py for argument names.
```
