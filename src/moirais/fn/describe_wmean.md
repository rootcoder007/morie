# describe('wmean') — winsorized_mean
...
`print(result)` render. See `moirais.fn.describe('wmean')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wmean import *
import numpy as np
# See the function signature in fn/wmean.py for argument names.
```
