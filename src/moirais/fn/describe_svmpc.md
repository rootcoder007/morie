# describe('svmpc') — multiparty_comp
...
`print(result)` render. See `moirais.fn.describe('svmpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmpc import *
import numpy as np
# See the function signature in fn/svmpc.py for argument names.
```
