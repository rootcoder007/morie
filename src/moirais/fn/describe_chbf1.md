# describe('chbf1') — chebyshev1_filter
...
`print(result)` render. See `moirais.fn.describe('chbf1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chbf1 import *
import numpy as np
# See the function signature in fn/chbf1.py for argument names.
```
