# describe('unfst') — unfolding_stress_diagnostic
...
`print(result)` render. See `moirais.fn.describe('unfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unfst import *
import numpy as np
# See the function signature in fn/unfst.py for argument names.
```
