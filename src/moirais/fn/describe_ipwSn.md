# describe('ipwSn') — ipw_sensitivity
...
`print(result)` render. See `moirais.fn.describe('ipwSn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipwSn import *
import numpy as np
# See the function signature in fn/ipwSn.py for argument names.
```
