# describe('grqat') — geron_quantization_aware_training
...
`print(result)` render. See `moirais.fn.describe('grqat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grqat import *
import numpy as np
# See the function signature in fn/grqat.py for argument names.
```
