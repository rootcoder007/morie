...
`print(result)` render. See `moirais.fn.describe('bonne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bonne import *
import numpy as np
# See the function signature in fn/bonne.py for argument names.
```
