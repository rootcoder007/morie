...
`print(result)` render. See `moirais.fn.describe('setT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.setT import *
import numpy as np
# See the function signature in fn/setT.py for argument names.
```
