...
`print(result)` render. See `moirais.fn.describe('ubcng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcng import *
import numpy as np
# See the function signature in fn/ubcng.py for argument names.
```
