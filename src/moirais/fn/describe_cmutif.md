# describe('cmutif') — conditional_mi
...
`print(result)` render. See `moirais.fn.describe('cmutif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmutif import *
import numpy as np
# See the function signature in fn/cmutif.py for argument names.
```
