# describe('suprv') — substance_prevalence
...
`print(result)` render. See `moirais.fn.describe('suprv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suprv import *
import numpy as np
# See the function signature in fn/suprv.py for argument names.
```
