...
`print(result)` render. See `moirais.fn.describe('grucl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grucl import *
import numpy as np
# See the function signature in fn/grucl.py for argument names.
```
