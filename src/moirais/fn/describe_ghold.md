...
`print(result)` render. See `moirais.fn.describe('ghold')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghold import *
import numpy as np
# See the function signature in fn/ghold.py for argument names.
```
