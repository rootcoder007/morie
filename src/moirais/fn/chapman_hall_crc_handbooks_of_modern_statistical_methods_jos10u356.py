...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_356"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_356(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ktc = max (0, xk,γc − xk,τt) ≥ 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u356')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u356: GeneralStatistics expression (auto-extracted; see ref)."
