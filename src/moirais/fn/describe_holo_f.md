...
`print(result)` render. See `moirais.fn.describe('holo_f')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_f import *
import numpy as np
# See the function signature in fn/holo_f.py for argument names.
```
