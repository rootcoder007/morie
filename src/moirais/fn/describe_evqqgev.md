# describe('evqqgev') — evt_gev_qq_plot
...
`print(result)` render. See `moirais.fn.describe('evqqgev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evqqgev import *
import numpy as np
# See the function signature in fn/evqqgev.py for argument names.
```
