# describe('ksr058') — kosorok_ch2_law_iterated_logarithm
...
`print(result)` render. See `moirais.fn.describe('ksr058')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr058 import *
import numpy as np
# See the function signature in fn/ksr058.py for argument names.
```
