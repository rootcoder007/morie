...
`print(result)` render. See `moirais.fn.describe('hmstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmstk import *
import numpy as np
# See the function signature in fn/hmstk.py for argument names.
```
