# describe('b102') — burkov_lm_ch1_squared_error
...
`print(result)` render. See `moirais.fn.describe('b102')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b102 import *
import numpy as np
# See the function signature in fn/b102.py for argument names.
```
