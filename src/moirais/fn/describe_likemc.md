# describe('likemc') — likelihood_mcmc_epi
...
`print(result)` render. See `moirais.fn.describe('likemc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.likemc import *
import numpy as np
# See the function signature in fn/likemc.py for argument names.
```
