...
__all__ = ["hedderich_chapter_9_unnumbered_1722"]


def hedderich_chapter_9_unnumbered_1722(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : cholD = 0 . 1 9 9 6 9 , p− value = 0.0003435
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1722')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1722: GeneralStatistics expression (auto-extracted; see ref)."
