# describe('siucmp') — siu_comparison
...
`print(result)` render. See `moirais.fn.describe('siucmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siucmp import *
import numpy as np
# See the function signature in fn/siucmp.py for argument names.
```
