# describe('csint') — cubic_spline_interp
...
`print(result)` render. See `moirais.fn.describe('csint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csint import *
import numpy as np
# See the function signature in fn/csint.py for argument names.
```
