# describe('sgtspn') — sgt_spanning_tree_count
...
`print(result)` render. See `moirais.fn.describe('sgtspn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtspn import *
import numpy as np
# See the function signature in fn/sgtspn.py for argument names.
```
