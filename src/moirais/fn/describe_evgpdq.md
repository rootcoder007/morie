# describe('evgpdq') — evt_gpd_quantile
...
`print(result)` render. See `moirais.fn.describe('evgpdq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdq import *
import numpy as np
# See the function signature in fn/evgpdq.py for argument names.
```
