...
`print(result)` render. See `moirais.fn.describe('altm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.altm import *
import numpy as np
# See the function signature in fn/altm.py for argument names.
```
