# describe('hmoob') — geron_oob_score
...
`print(result)` render. See `moirais.fn.describe('hmoob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmoob import *
import numpy as np
# See the function signature in fn/hmoob.py for argument names.
```
