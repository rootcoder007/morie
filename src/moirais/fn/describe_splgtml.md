...
`print(result)` render. See `moirais.fn.describe('splgtml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgtml import *
import numpy as np
# See the function signature in fn/splgtml.py for argument names.
```
