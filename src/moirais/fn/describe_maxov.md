...
`print(result)` render. See `moirais.fn.describe('maxov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maxov import *
import numpy as np
# See the function signature in fn/maxov.py for argument names.
```
