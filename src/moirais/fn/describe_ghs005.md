# describe('ghs005') — ghosal_ch2_location_scale_mixture_limit
...
`print(result)` render. See `moirais.fn.describe('ghs005')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs005 import *
import numpy as np
# See the function signature in fn/ghs005.py for argument names.
```
