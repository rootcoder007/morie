# describe('rng252') — rangayyan_ch4_complex_cepstrum_signal_with_echo
...
`print(result)` render. See `moirais.fn.describe('rng252')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng252 import *
import numpy as np
# See the function signature in fn/rng252.py for argument names.
```
