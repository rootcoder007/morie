...
__all__ = ["wilcox_chapter_10_unnumbered_967"]


def wilcox_chapter_10_unnumbered_967(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 3 =µ 3 +µ 4 − µ 5 − µ 6.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u967')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u967: GeneralStatistics expression (auto-extracted; see ref)."
