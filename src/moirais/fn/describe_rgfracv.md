# describe('rgfracv') — rangayyan_fractal_vag
...
`print(result)` render. See `moirais.fn.describe('rgfracv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfracv import *
import numpy as np
# See the function signature in fn/rgfracv.py for argument names.
```
