...
`print(result)` render. See `moirais.fn.describe('ppnyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppnyn import *
import numpy as np
# See the function signature in fn/ppnyn.py for argument names.
```
