...
`print(result)` render. See `moirais.fn.describe('gastrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gastrm import *
import numpy as np
# See the function signature in fn/gastrm.py for argument names.
```
