...
`print(result)` render. See `moirais.fn.describe('wllcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wllcp import *
import numpy as np
# See the function signature in fn/wllcp.py for argument names.
```
