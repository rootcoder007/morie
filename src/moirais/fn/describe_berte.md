...
`print(result)` render. See `moirais.fn.describe('berte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.berte import *
import numpy as np
# See the function signature in fn/berte.py for argument names.
```
