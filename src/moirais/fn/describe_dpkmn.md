...
`print(result)` render. See `moirais.fn.describe('dpkmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpkmn import *
import numpy as np
# See the function signature in fn/dpkmn.py for argument names.
```
