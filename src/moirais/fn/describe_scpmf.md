...
`print(result)` render. See `moirais.fn.describe('scpmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpmf import *
import numpy as np
# See the function signature in fn/scpmf.py for argument names.
```
