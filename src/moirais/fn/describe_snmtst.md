# describe('snmtst') — sensitivity_did
...
`print(result)` render. See `moirais.fn.describe('snmtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snmtst import *
import numpy as np
# See the function signature in fn/snmtst.py for argument names.
```
