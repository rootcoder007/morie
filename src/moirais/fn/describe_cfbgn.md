...
`print(result)` render. See `moirais.fn.describe('cfbgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfbgn import *
import numpy as np
# See the function signature in fn/cfbgn.py for argument names.
```
