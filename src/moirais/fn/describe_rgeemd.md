# describe('rgeemd') — rangayyan_eemd
...
`print(result)` render. See `moirais.fn.describe('rgeemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeemd import *
import numpy as np
# See the function signature in fn/rgeemd.py for argument names.
```
