# describe('hales') — health_adjusted_life_expectancy
...
`print(result)` render. See `moirais.fn.describe('hales')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hales import *
import numpy as np
# See the function signature in fn/hales.py for argument names.
```
