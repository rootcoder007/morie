# describe('tfund') — torus_fundamental_group
...
`print(result)` render. See `moirais.fn.describe('tfund')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tfund import *
import numpy as np
# See the function signature in fn/tfund.py for argument names.
```
