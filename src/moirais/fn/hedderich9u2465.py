...
__all__ = ["hedderich_chapter_9_unnumbered_2465"]


def hedderich_chapter_9_unnumbered_2465(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: With ˆH = 11.44> 5.801 = H forn = 6,k = 3 andP = 0.05 (from table 7.44),H0 is rejected
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2465')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2465: GeneralStatistics expression (auto-extracted; see ref)."
