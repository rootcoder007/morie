...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_139"]


def information_theory_mackay_chapter_6_unnumbered_139(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(x=1jy =0) = 0.15 0.1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u139')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u139: GeneralStatistics expression (auto-extracted; see ref)."
