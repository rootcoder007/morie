...
`print(result)` render. See `moirais.fn.describe('xrgwb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwb import *
import numpy as np
# See the function signature in fn/xrgwb.py for argument names.
```
