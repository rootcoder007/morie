# describe('gb641c') — gibbons_median_test_ci
...
`print(result)` render. See `moirais.fn.describe('gb641c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb641c import *
import numpy as np
# See the function signature in fn/gb641c.py for argument names.
```
