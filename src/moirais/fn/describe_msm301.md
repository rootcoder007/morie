# describe('msm301') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm301')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm301 import *
import numpy as np
# See the function signature in fn/msm301.py for argument names.
```
