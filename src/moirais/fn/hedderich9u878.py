...
__all__ = ["hedderich_chapter_9_unnumbered_878"]


def hedderich_chapter_9_unnumbered_878(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Fig. 5.32: Truncated normal distribution forµ=100 andσ=6 (8, 10) in the interval [95, 115]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u878')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u878: GeneralStatistics expression (auto-extracted; see ref)."
