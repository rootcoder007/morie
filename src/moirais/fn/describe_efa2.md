...
`print(result)` render. See `moirais.fn.describe('efa2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.efa2 import *
import numpy as np
# See the function signature in fn/efa2.py for argument names.
```
