...
`print(result)` render. See `moirais.fn.describe('ctfill')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctfill import *
import numpy as np
# See the function signature in fn/ctfill.py for argument names.
```
