...
`print(result)` render. See `moirais.fn.describe('ubpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubpol import *
import numpy as np
# See the function signature in fn/ubpol.py for argument names.
```
