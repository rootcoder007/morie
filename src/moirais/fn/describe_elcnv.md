...
`print(result)` render. See `moirais.fn.describe('elcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elcnv import *
import numpy as np
# See the function signature in fn/elcnv.py for argument names.
```
