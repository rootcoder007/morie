...
`print(result)` render. See `moirais.fn.describe('huberw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.huberw import *
import numpy as np
# See the function signature in fn/huberw.py for argument names.
```
