...
`print(result)` render. See `moirais.fn.describe('cfint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfint import *
import numpy as np
# See the function signature in fn/cfint.py for argument names.
```
