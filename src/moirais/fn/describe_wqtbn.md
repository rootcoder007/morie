...
`print(result)` render. See `moirais.fn.describe('wqtbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtbn import *
import numpy as np
# See the function signature in fn/wqtbn.py for argument names.
```
