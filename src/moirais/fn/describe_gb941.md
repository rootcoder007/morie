# describe('gb941') — gibbons_siegel_tukey
...
`print(result)` render. See `moirais.fn.describe('gb941')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb941 import *
import numpy as np
# See the function signature in fn/gb941.py for argument names.
```
