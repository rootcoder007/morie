...
`print(result)` render. See `moirais.fn.describe('svstl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svstl import *
import numpy as np
# See the function signature in fn/svstl.py for argument names.
```
