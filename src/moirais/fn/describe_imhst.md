# describe('imhst') — image_histogram
...
`print(result)` render. See `moirais.fn.describe('imhst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imhst import *
import numpy as np
# See the function signature in fn/imhst.py for argument names.
```
