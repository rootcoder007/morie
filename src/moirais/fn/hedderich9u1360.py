...
__all__ = ["hedderich_chapter_9_unnumbered_1360"]


def hedderich_chapter_9_unnumbered_1360(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 95%CI: 1.40≤σ2≤3.09.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1360')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1360: GeneralStatistics expression (auto-extracted; see ref)."
