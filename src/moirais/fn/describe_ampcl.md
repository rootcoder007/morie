# describe('ampcl') — amplitude_classify
...
`print(result)` render. See `moirais.fn.describe('ampcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ampcl import *
import numpy as np
# See the function signature in fn/ampcl.py for argument names.
```
