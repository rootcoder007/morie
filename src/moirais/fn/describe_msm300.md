# describe('msm300') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm300')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm300 import *
import numpy as np
# See the function signature in fn/msm300.py for argument names.
```
