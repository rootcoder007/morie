...
`print(result)` render. See `moirais.fn.describe('cmqrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmqrm import *
import numpy as np
# See the function signature in fn/cmqrm.py for argument names.
```
