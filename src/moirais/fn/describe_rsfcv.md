...
`print(result)` render. See `moirais.fn.describe('rsfcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsfcv import *
import numpy as np
# See the function signature in fn/rsfcv.py for argument names.
```
