...
`print(result)` render. See `moirais.fn.describe('aggcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aggcl import *
import numpy as np
# See the function signature in fn/aggcl.py for argument names.
```
