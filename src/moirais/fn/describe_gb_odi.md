# describe('gb_odi') — gibbons_odds_ratio
...
`print(result)` render. See `moirais.fn.describe('gb_odi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_odi import *
import numpy as np
# See the function signature in fn/gb_odi.py for argument names.
```
