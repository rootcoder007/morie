# describe('sysmpl') — systematic_sample
...
`print(result)` render. See `moirais.fn.describe('sysmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sysmpl import *
import numpy as np
# See the function signature in fn/sysmpl.py for argument names.
```
