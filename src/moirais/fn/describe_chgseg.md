# describe('chgseg') — changepoint_segmentation
...
`print(result)` render. See `moirais.fn.describe('chgseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chgseg import *
import numpy as np
# See the function signature in fn/chgseg.py for argument names.
```
