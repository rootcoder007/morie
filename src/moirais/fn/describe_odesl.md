...
`print(result)` render. See `moirais.fn.describe('odesl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odesl import *
import numpy as np
# See the function signature in fn/odesl.py for argument names.
```
