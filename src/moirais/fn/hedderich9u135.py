...
__all__ = ["hedderich_chapter_9_unnumbered_135"]


def hedderich_chapter_9_unnumbered_135(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u135')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u135: GeneralStatistics expression (auto-extracted; see ref)."
