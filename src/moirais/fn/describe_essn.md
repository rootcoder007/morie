# describe('essn') — effective_sample_size
...
`print(result)` render. See `moirais.fn.describe('essn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.essn import *
import numpy as np
# See the function signature in fn/essn.py for argument names.
```
