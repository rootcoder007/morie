...
`print(result)` render. See `moirais.fn.describe('geind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geind import *
import numpy as np
# See the function signature in fn/geind.py for argument names.
```
