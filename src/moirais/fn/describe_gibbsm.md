...
`print(result)` render. See `moirais.fn.describe('gibbsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gibbsm import *
import numpy as np
# See the function signature in fn/gibbsm.py for argument names.
```
