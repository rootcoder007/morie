...
__all__ = ["guide_on_data_analysis_chapter_8_unnumbered_664"]


def guide_on_data_analysis_chapter_8_unnumbered_664(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝜙𝑖𝑗 = 𝜌𝑖 + 𝛼𝑗 + 𝑒𝑖𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis8u664')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis8u664: GeneralStatistics expression (auto-extracted; see ref)."
