...
`print(result)` render. See `moirais.fn.describe('sgtspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtspc import *
import numpy as np
# See the function signature in fn/sgtspc.py for argument names.
```
