# describe('brtlt') — bartlett_psd_fn
...
`print(result)` render. See `moirais.fn.describe('brtlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brtlt import *
import numpy as np
# See the function signature in fn/brtlt.py for argument names.
```
