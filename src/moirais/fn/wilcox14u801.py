...
__all__ = ["wilcox_chapter_14_unnumbered_801"]


def wilcox_chapter_14_unnumbered_801(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Xijk = ¯µ +α j +β k +γ jk +ǫ ijk.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u801')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u801: GeneralStatistics expression (auto-extracted; see ref)."
