# describe('rgblwand') — rangayyan_baseline_wander
...
`print(result)` render. See `moirais.fn.describe('rgblwand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgblwand import *
import numpy as np
# See the function signature in fn/rgblwand.py for argument names.
```
