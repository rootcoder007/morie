# describe('msm066') — mvsml_bayesian_regression_eq_6_8
...
`print(result)` render. See `moirais.fn.describe('msm066')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm066 import *
import numpy as np
# See the function signature in fn/msm066.py for argument names.
```
