# describe('wsmlas') — wasserman_lasso
...
`print(result)` render. See `moirais.fn.describe('wsmlas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlas import *
import numpy as np
# See the function signature in fn/wsmlas.py for argument names.
```
