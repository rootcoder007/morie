# describe('gh_c3_2') — ghosal_stochastic_proc_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c3_2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_2 import *
import numpy as np
# See the function signature in fn/gh_c3_2.py for argument names.
```
