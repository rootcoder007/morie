...
`print(result)` render. See `moirais.fn.describe('surprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.surprl import *
import numpy as np
# See the function signature in fn/surprl.py for argument names.
```
