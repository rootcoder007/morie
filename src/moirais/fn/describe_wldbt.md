...
`print(result)` render. See `moirais.fn.describe('wldbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wldbt import *
import numpy as np
# See the function signature in fn/wldbt.py for argument names.
```
