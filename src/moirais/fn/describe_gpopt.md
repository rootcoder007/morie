...
`print(result)` render. See `moirais.fn.describe('gpopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpopt import *
import numpy as np
# See the function signature in fn/gpopt.py for argument names.
```
