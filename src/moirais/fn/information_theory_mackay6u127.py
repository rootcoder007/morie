...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_127"]


def information_theory_mackay_chapter_6_unnumbered_127(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0 y P(y = 0jx= 0) = 1;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u127')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u127: GeneralStatistics expression (auto-extracted; see ref)."
