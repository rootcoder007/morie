...
`print(result)` render. See `moirais.fn.describe('opskr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opskr import *
import numpy as np
# See the function signature in fn/opskr.py for argument names.
```
