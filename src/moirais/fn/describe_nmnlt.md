# describe('nmnlt') — nominate_scaling
...
`print(result)` render. See `moirais.fn.describe('nmnlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmnlt import *
import numpy as np
# See the function signature in fn/nmnlt.py for argument names.
```
