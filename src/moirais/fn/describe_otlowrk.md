# describe('otlowrk') — ot_low_rank_sinkhorn
...
`print(result)` render. See `moirais.fn.describe('otlowrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otlowrk import *
import numpy as np
# See the function signature in fn/otlowrk.py for argument names.
```
