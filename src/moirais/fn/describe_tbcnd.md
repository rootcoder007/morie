...
`print(result)` render. See `moirais.fn.describe('tbcnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbcnd import *
import numpy as np
# See the function signature in fn/tbcnd.py for argument names.
```
