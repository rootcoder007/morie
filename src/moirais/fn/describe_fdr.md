# describe('fdr') — benjamini_hochberg
...
`print(result)` render. See `moirais.fn.describe('fdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdr import *
import numpy as np
# See the function signature in fn/fdr.py for argument names.
```
