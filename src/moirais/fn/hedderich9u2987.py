...
__all__ = ["hedderich_chapter_9_unnumbered_2987"]


def hedderich_chapter_9_unnumbered_2987(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2= 119{[62/40 + 202/40 + 322/40]−582/120}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2987')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2987: GeneralStatistics expression (auto-extracted; see ref)."
