# describe('hetlc') — heterozygosity_locus
...
`print(result)` render. See `moirais.fn.describe('hetlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hetlc import *
import numpy as np
# See the function signature in fn/hetlc.py for argument names.
```
