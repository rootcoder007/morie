# describe('msm332') — mvsml_elements_lin_reg_eq_3_1
...
`print(result)` render. See `moirais.fn.describe('msm332')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm332 import *
import numpy as np
# See the function signature in fn/msm332.py for argument names.
```
