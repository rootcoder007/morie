# describe('cstre') — custody_readmit
...
`print(result)` render. See `moirais.fn.describe('cstre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstre import *
import numpy as np
# See the function signature in fn/cstre.py for argument names.
```
