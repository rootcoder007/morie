...
__all__ = ["hedderich_chapter_9_unnumbered_3672"]


def hedderich_chapter_9_unnumbered_3672(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : β0;yx =βyx . . . . . . . . . . . . . . . . .789
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3672')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3672: GeneralStatistics expression (auto-extracted; see ref)."
