# describe('annplt') — plot_annotated_signal_fn
...
`print(result)` render. See `moirais.fn.describe('annplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.annplt import *
import numpy as np
# See the function signature in fn/annplt.py for argument names.
```
