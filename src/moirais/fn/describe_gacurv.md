...
`print(result)` render. See `moirais.fn.describe('gacurv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gacurv import *
import numpy as np
# See the function signature in fn/gacurv.py for argument names.
```
