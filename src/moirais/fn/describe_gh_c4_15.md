# describe('gh_c4_15') — ghosal_dp_mutual_sing
...
`print(result)` render. See `moirais.fn.describe('gh_c4_15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_15 import *
import numpy as np
# See the function signature in fn/gh_c4_15.py for argument names.
```
