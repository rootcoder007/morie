...
`print(result)` render. See `moirais.fn.describe('lilf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lilf import *
import numpy as np
# See the function signature in fn/lilf.py for argument names.
```
