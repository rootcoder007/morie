...
`print(result)` render. See `moirais.fn.describe('nomgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nomgr import *
import numpy as np
# See the function signature in fn/nomgr.py for argument names.
```
