...
`print(result)` render. See `moirais.fn.describe('vol_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vol_a import *
import numpy as np
# See the function signature in fn/vol_a.py for argument names.
```
