# describe('hmcart') — geron_cart_algorithm
...
`print(result)` render. See `moirais.fn.describe('hmcart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcart import *
import numpy as np
# See the function signature in fn/hmcart.py for argument names.
```
