# describe('hmbnm') — geron_biological_neuron
...
`print(result)` render. See `moirais.fn.describe('hmbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbnm import *
import numpy as np
# See the function signature in fn/hmbnm.py for argument names.
```
