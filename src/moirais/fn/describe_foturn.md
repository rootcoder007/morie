...
`print(result)` render. See `moirais.fn.describe('foturn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foturn import *
import numpy as np
# See the function signature in fn/foturn.py for argument names.
```
