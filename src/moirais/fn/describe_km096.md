# describe('km096') — kamath_ch6_gender_projection_reg
...
`print(result)` render. See `moirais.fn.describe('km096')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km096 import *
import numpy as np
# See the function signature in fn/km096.py for argument names.
```
