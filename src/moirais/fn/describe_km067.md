# describe('km067') — kamath_ch5_rm_bradley_terry
...
`print(result)` render. See `moirais.fn.describe('km067')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km067 import *
import numpy as np
# See the function signature in fn/km067.py for argument names.
```
