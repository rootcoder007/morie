...
__all__ = ["hedderich_chapter_9_unnumbered_2564"]


def hedderich_chapter_9_unnumbered_2564(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: values:µ1 =µ2 =...=µa.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2564')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2564: GeneralStatistics expression (auto-extracted; see ref)."
