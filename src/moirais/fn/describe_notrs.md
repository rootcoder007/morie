...
`print(result)` render. See `moirais.fn.describe('notrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.notrs import *
import numpy as np
# See the function signature in fn/notrs.py for argument names.
```
