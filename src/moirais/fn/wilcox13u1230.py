...
__all__ = ["wilcox_chapter_13_unnumbered_1230"]


def wilcox_chapter_13_unnumbered_1230(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: TRUE, pch1 = "+", pch2 = "o", alpha=0.05, plotit=TRUE, xout=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1230')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1230: GeneralStatistics expression (auto-extracted; see ref)."
