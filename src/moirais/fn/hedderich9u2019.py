...
__all__ = ["hedderich_chapter_9_unnumbered_2019"]


def hedderich_chapter_9_unnumbered_2019(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: This results in the 95% CI: 0.1≤µ1−µ2≤2.9. The null hypothesis (µ1−µ2 = 0 ) must
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2019')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2019: GeneralStatistics expression (auto-extracted; see ref)."
