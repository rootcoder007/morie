...
`print(result)` render. See `moirais.fn.describe('grrmse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrmse import *
import numpy as np
# See the function signature in fn/grrmse.py for argument names.
```
