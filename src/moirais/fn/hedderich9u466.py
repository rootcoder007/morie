...
__all__ = ["hedderich_chapter_9_unnumbered_466"]


def hedderich_chapter_9_unnumbered_466(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A∩B) = 0.20 ; P (A∩C) = 0.15 ; P (B∩C) = 0.10 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u466')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u466: GeneralStatistics expression (auto-extracted; see ref)."
