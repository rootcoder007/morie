# describe('envjust') — environmental_justice_index
...
`print(result)` render. See `moirais.fn.describe('envjust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.envjust import *
import numpy as np
# See the function signature in fn/envjust.py for argument names.
```
