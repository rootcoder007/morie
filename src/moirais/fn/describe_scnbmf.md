...
`print(result)` render. See `moirais.fn.describe('scnbmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scnbmf import *
import numpy as np
# See the function signature in fn/scnbmf.py for argument names.
```
