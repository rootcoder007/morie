# describe('grdpmf') — geron_ddpm_forward_process
...
`print(result)` render. See `moirais.fn.describe('grdpmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdpmf import *
import numpy as np
# See the function signature in fn/grdpmf.py for argument names.
```
