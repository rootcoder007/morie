...
`print(result)` render. See `moirais.fn.describe('vmhrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmhrs import *
import numpy as np
# See the function signature in fn/vmhrs.py for argument names.
```
