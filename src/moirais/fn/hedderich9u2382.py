...
__all__ = ["hedderich_chapter_9_unnumbered_2382"]


def hedderich_chapter_9_unnumbered_2382(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2. Pairwise comparisons with a control (MCC, control);µi−µ0 for alli = 1,..., (k−1), thus
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2382')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2382: GeneralStatistics expression (auto-extracted; see ref)."
