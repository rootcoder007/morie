...
`print(result)` render. See `moirais.fn.describe('chlpiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlpiv import *
import numpy as np
# See the function signature in fn/chlpiv.py for argument names.
```
