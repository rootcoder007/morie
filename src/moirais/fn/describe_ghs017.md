# describe('ghs017') — ghosal_ch3_discrete_random_measure
...
`print(result)` render. See `moirais.fn.describe('ghs017')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs017 import *
import numpy as np
# See the function signature in fn/ghs017.py for argument names.
```
