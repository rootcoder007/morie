...
`print(result)` render. See `moirais.fn.describe('enpuf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enpuf import *
import numpy as np
# See the function signature in fn/enpuf.py for argument names.
```
