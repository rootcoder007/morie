# describe('grdcgan') — geron_dcgan_generator
...
`print(result)` render. See `moirais.fn.describe('grdcgan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdcgan import *
import numpy as np
# See the function signature in fn/grdcgan.py for argument names.
```
