# describe('msm202') — mvsml_ridge_lasso_elastic_eq_9_28
...
`print(result)` render. See `moirais.fn.describe('msm202')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm202 import *
import numpy as np
# See the function signature in fn/msm202.py for argument names.
```
