...
`print(result)` render. See `moirais.fn.describe('ar2ls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ar2ls import *
import numpy as np
# See the function signature in fn/ar2ls.py for argument names.
```
