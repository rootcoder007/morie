...
`print(result)` render. See `moirais.fn.describe('tbexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbexp import *
import numpy as np
# See the function signature in fn/tbexp.py for argument names.
```
