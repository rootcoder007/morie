# describe('nie') — natural_indirect_effect
...
`print(result)` render. See `moirais.fn.describe('nie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nie import *
import numpy as np
# See the function signature in fn/nie.py for argument names.
```
