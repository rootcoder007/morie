...
`print(result)` render. See `moirais.fn.describe('maphz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maphz import *
import numpy as np
# See the function signature in fn/maphz.py for argument names.
```
