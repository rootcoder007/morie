# describe('bvtrA') — bias_variance_tradeoff
...
`print(result)` render. See `moirais.fn.describe('bvtrA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bvtrA import *
import numpy as np
# See the function signature in fn/bvtrA.py for argument names.
```
