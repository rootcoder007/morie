...
`print(result)` render. See `moirais.fn.describe('mxinq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxinq import *
import numpy as np
# See the function signature in fn/mxinq.py for argument names.
```
