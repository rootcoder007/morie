# describe('sav_a') — subscale_ea_ave
...
`print(result)` render. See `moirais.fn.describe('sav_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sav_a import *
import numpy as np
# See the function signature in fn/sav_a.py for argument names.
```
