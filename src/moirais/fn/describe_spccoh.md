...
`print(result)` render. See `moirais.fn.describe('spccoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spccoh import *
import numpy as np
# See the function signature in fn/spccoh.py for argument names.
```
