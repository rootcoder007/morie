# describe('nwcen') — network_centrality
...
`print(result)` render. See `moirais.fn.describe('nwcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwcen import *
import numpy as np
# See the function signature in fn/nwcen.py for argument names.
```
