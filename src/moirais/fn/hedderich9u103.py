...
__all__ = ["hedderich_chapter_9_unnumbered_103"]


def hedderich_chapter_9_unnumbered_103(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u103')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u103: GeneralStatistics expression (auto-extracted; see ref)."
