...
`print(result)` render. See `moirais.fn.describe('csmrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csmrk import *
import numpy as np
# See the function signature in fn/csmrk.py for argument names.
```
