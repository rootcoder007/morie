...
`print(result)` render. See `moirais.fn.describe('myodt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.myodt import *
import numpy as np
# See the function signature in fn/myodt.py for argument names.
```
