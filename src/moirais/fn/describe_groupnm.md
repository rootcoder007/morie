...
`print(result)` render. See `moirais.fn.describe('groupnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groupnm import *
import numpy as np
# See the function signature in fn/groupnm.py for argument names.
```
