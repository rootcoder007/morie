...
`print(result)` render. See `moirais.fn.describe('carbym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carbym import *
import numpy as np
# See the function signature in fn/carbym.py for argument names.
```
