# describe('cvxhul') — boyd_convex_hull
...
`print(result)` render. See `moirais.fn.describe('cvxhul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxhul import *
import numpy as np
# See the function signature in fn/cvxhul.py for argument names.
```
