...
`print(result)` render. See `moirais.fn.describe('corrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.corrn import *
import numpy as np
# See the function signature in fn/corrn.py for argument names.
```
