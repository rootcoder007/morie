...
`print(result)` render. See `moirais.fn.describe('umnsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umnsh import *
import numpy as np
# See the function signature in fn/umnsh.py for argument names.
```
