# describe('sgukv') — universal_kriging_variance
...
`print(result)` render. See `moirais.fn.describe('sgukv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgukv import *
import numpy as np
# See the function signature in fn/sgukv.py for argument names.
```
