...
`print(result)` render. See `moirais.fn.describe('pqcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pqcmp import *
import numpy as np
# See the function signature in fn/pqcmp.py for argument names.
```
