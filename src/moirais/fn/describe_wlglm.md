...
`print(result)` render. See `moirais.fn.describe('wlglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlglm import *
import numpy as np
# See the function signature in fn/wlglm.py for argument names.
```
