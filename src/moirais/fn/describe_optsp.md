...
`print(result)` render. See `moirais.fn.describe('optsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optsp import *
import numpy as np
# See the function signature in fn/optsp.py for argument names.
```
