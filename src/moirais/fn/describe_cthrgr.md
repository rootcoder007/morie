# describe('cthrgr') — causal_three_layer_grf
...
`print(result)` render. See `moirais.fn.describe('cthrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cthrgr import *
import numpy as np
# See the function signature in fn/cthrgr.py for argument names.
```
