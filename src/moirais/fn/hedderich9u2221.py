...
__all__ = ["hedderich_chapter_9_unnumbered_2221"]


def hedderich_chapter_9_unnumbered_2221(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: and x = ˆλ1n1, y = ˆλ2n2, ˆλ1 > ˆλ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2221')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2221: CountModels expression (auto-extracted; see ref)."
