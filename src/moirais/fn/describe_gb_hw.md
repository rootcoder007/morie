# describe('gb_hw') — gibbons_hodges_wilcoxon
...
`print(result)` render. See `moirais.fn.describe('gb_hw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_hw import *
import numpy as np
# See the function signature in fn/gb_hw.py for argument names.
```
