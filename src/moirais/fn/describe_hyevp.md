...
`print(result)` render. See `moirais.fn.describe('hyevp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyevp import *
import numpy as np
# See the function signature in fn/hyevp.py for argument names.
```
