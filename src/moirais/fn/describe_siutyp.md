...
`print(result)` render. See `moirais.fn.describe('siutyp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siutyp import *
import numpy as np
# See the function signature in fn/siutyp.py for argument names.
```
