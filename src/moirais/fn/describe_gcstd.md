...
`print(result)` render. See `moirais.fn.describe('gcstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcstd import *
import numpy as np
# See the function signature in fn/gcstd.py for argument names.
```
