# describe('sbmdg2') — degree_corrected_sbm
...
`print(result)` render. See `moirais.fn.describe('sbmdg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbmdg2 import *
import numpy as np
# See the function signature in fn/sbmdg2.py for argument names.
```
