# describe('projp') — projection_pursuit
...
`print(result)` render. See `moirais.fn.describe('projp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.projp import *
import numpy as np
# See the function signature in fn/projp.py for argument names.
```
