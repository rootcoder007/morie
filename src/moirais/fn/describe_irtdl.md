...
`print(result)` render. See `moirais.fn.describe('irtdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtdl import *
import numpy as np
# See the function signature in fn/irtdl.py for argument names.
```
