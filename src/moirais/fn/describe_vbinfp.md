# describe('vbinfp') — variational_bound
...
`print(result)` render. See `moirais.fn.describe('vbinfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vbinfp import *
import numpy as np
# See the function signature in fn/vbinfp.py for argument names.
```
