...
`print(result)` render. See `moirais.fn.describe('ar_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ar_ import *
import numpy as np
# See the function signature in fn/ar_.py for argument names.
```
