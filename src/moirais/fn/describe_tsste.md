...
`print(result)` render. See `moirais.fn.describe('tsste')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsste import *
import numpy as np
# See the function signature in fn/tsste.py for argument names.
```
