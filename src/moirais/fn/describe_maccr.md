# describe('maccr') — multiclass_precision
...
`print(result)` render. See `moirais.fn.describe('maccr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maccr import *
import numpy as np
# See the function signature in fn/maccr.py for argument names.
```
