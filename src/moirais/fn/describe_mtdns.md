# describe('mtdns') — mtdns

## WHAT IT DOES

Density spatial network
...
`print(result)` render. See `moirais.fn.describe('mtdns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtdns import *
import numpy as np
# See the function signature in fn/mtdns.py for argument names.
```
