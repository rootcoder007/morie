...
`print(result)` render. See `moirais.fn.describe('netdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netdg import *
import numpy as np
# See the function signature in fn/netdg.py for argument names.
```
