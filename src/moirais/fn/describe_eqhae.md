# describe('eqhae') — equating_haebara
...
`print(result)` render. See `moirais.fn.describe('eqhae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqhae import *
import numpy as np
# See the function signature in fn/eqhae.py for argument names.
```
