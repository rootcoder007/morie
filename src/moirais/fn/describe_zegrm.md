# describe('zegrm') — gravity_migration
...
`print(result)` render. See `moirais.fn.describe('zegrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zegrm import *
import numpy as np
# See the function signature in fn/zegrm.py for argument names.
```
