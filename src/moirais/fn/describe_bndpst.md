# describe('bndpst') — bound_post_test
...
`print(result)` render. See `moirais.fn.describe('bndpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpst import *
import numpy as np
# See the function signature in fn/bndpst.py for argument names.
```
