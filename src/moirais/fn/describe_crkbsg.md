...
`print(result)` render. See `moirais.fn.describe('crkbsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crkbsg import *
import numpy as np
# See the function signature in fn/crkbsg.py for argument names.
```
