...
`print(result)` render. See `moirais.fn.describe('irtwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtwd import *
import numpy as np
# See the function signature in fn/irtwd.py for argument names.
```
