...
`print(result)` render. See `moirais.fn.describe('tbreal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbreal import *
import numpy as np
# See the function signature in fn/tbreal.py for argument names.
```
