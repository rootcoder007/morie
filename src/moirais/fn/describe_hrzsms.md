# describe('hrzsms') — horowitz_smoothed_max_score
...
`print(result)` render. See `moirais.fn.describe('hrzsms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsms import *
import numpy as np
# See the function signature in fn/hrzsms.py for argument names.
```
