# describe('wsmcrk') — wasserman_kernel_regression
...
`print(result)` render. See `moirais.fn.describe('wsmcrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcrk import *
import numpy as np
# See the function signature in fn/wsmcrk.py for argument names.
```
