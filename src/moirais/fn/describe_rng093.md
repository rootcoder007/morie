# describe('rng093') — rangayyan_ch3_hann_frequency_response_raw
...
`print(result)` render. See `moirais.fn.describe('rng093')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng093 import *
import numpy as np
# See the function signature in fn/rng093.py for argument names.
```
