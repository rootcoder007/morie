# describe('nuis') — nuisance_estimate
...
`print(result)` render. See `moirais.fn.describe('nuis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nuis import *
import numpy as np
# See the function signature in fn/nuis.py for argument names.
```
