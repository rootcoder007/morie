...
`print(result)` render. See `moirais.fn.describe('sfmoran')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfmoran import *
import numpy as np
# See the function signature in fn/sfmoran.py for argument names.
```
