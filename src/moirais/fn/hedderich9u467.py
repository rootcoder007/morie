...
__all__ = ["hedderich_chapter_9_unnumbered_467"]


def hedderich_chapter_9_unnumbered_467(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (1)P1 =P (A∪B∪C) = P (A)+P (B) +P (C)−P (A∩B)−P (A∩C)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u467')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u467: GeneralStatistics expression (auto-extracted; see ref)."
