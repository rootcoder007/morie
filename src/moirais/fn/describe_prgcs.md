# describe('prgcs') — program_cost_savings
...
`print(result)` render. See `moirais.fn.describe('prgcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgcs import *
import numpy as np
# See the function signature in fn/prgcs.py for argument names.
```
