...
def advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th_chapter_25_unnumbered_129(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th25u129')`` for the full guide.
