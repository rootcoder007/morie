...
`print(result)` render. See `moirais.fn.describe('varatr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varatr import *
import numpy as np
# See the function signature in fn/varatr.py for argument names.
```
