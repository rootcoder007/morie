...
`print(result)` render. See `moirais.fn.describe('late')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.late import *
import numpy as np
# See the function signature in fn/late.py for argument names.
```
