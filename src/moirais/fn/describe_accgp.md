# describe('accgp') — prediction_accuracy
...
`print(result)` render. See `moirais.fn.describe('accgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.accgp import *
import numpy as np
# See the function signature in fn/accgp.py for argument names.
```
