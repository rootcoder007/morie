# describe('cvxnch') — boyd_nuclear_norm
...
`print(result)` render. See `moirais.fn.describe('cvxnch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxnch import *
import numpy as np
# See the function signature in fn/cvxnch.py for argument names.
```
