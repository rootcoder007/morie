# describe('ldppm') — local_dp_planar_mechanism
...
`print(result)` render. See `moirais.fn.describe('ldppm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldppm import *
import numpy as np
# See the function signature in fn/ldppm.py for argument names.
```
