# describe('gb_spq') — gibbons_spearman_test
...
`print(result)` render. See `moirais.fn.describe('gb_spq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_spq import *
import numpy as np
# See the function signature in fn/gb_spq.py for argument names.
```
