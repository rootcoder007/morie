...
`print(result)` render. See `moirais.fn.describe('popst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.popst import *
import numpy as np
# See the function signature in fn/popst.py for argument names.
```
