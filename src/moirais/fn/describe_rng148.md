# describe('rng148') — rangayyan_ch3_wiener_convolution_relationship
...
`print(result)` render. See `moirais.fn.describe('rng148')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng148 import *
import numpy as np
# See the function signature in fn/rng148.py for argument names.
```
