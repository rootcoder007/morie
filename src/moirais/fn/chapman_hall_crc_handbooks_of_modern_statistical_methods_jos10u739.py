...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_739"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_739(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] { ˆψ(δ) − ˆcαˆσ(δ)/√n}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u739')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u739: GeneralStatistics expression (auto-extracted; see ref)."
