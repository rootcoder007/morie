# describe('hmkmlim') — geron_kmeans_limits
...
`print(result)` render. See `moirais.fn.describe('hmkmlim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkmlim import *
import numpy as np
# See the function signature in fn/hmkmlim.py for argument names.
```
