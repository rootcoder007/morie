...
`print(result)` render. See `moirais.fn.describe('gpper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpper import *
import numpy as np
# See the function signature in fn/gpper.py for argument names.
```
