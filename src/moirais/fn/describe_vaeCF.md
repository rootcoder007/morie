...
`print(result)` render. See `moirais.fn.describe('vaeCF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaeCF import *
import numpy as np
# See the function signature in fn/vaeCF.py for argument names.
```
