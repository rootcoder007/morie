# describe('cstag') — custody_age_profile
...
`print(result)` render. See `moirais.fn.describe('cstag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstag import *
import numpy as np
# See the function signature in fn/cstag.py for argument names.
```
