...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_215"]


def guide_on_data_analysis_chapter_4_unnumbered_215(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑝-value = 2𝑃(𝑈 ≥ 𝑢max) = 2𝑃(𝑈 ≤ 𝑢min).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u215')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u215: GeneralStatistics expression (auto-extracted; see ref)."
