# describe('matrxP') — matrix_profile
...
`print(result)` render. See `moirais.fn.describe('matrxP')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matrxP import *
import numpy as np
# See the function signature in fn/matrxP.py for argument names.
```
