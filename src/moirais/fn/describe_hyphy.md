...
`print(result)` render. See `moirais.fn.describe('hyphy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyphy import *
import numpy as np
# See the function signature in fn/hyphy.py for argument names.
```
