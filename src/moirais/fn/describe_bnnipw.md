# describe('bnnipw') — bound_no_iv_proxy
...
`print(result)` render. See `moirais.fn.describe('bnnipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnnipw import *
import numpy as np
# See the function signature in fn/bnnipw.py for argument names.
```
