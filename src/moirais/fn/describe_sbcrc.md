...
`print(result)` render. See `moirais.fn.describe('sbcrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbcrc import *
import numpy as np
# See the function signature in fn/sbcrc.py for argument names.
```
