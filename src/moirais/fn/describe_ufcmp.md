# describe('ufcmp') — compare_unfolding_methods
...
`print(result)` render. See `moirais.fn.describe('ufcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ufcmp import *
import numpy as np
# See the function signature in fn/ufcmp.py for argument names.
```
