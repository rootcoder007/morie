# describe('multipsr') — multi_stage_sampling
...
`print(result)` render. See `moirais.fn.describe('multipsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.multipsr import *
import numpy as np
# See the function signature in fn/multipsr.py for argument names.
```
