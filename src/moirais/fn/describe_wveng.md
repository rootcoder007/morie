...
`print(result)` render. See `moirais.fn.describe('wveng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wveng import *
import numpy as np
# See the function signature in fn/wveng.py for argument names.
```
