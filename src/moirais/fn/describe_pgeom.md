...
`print(result)` render. See `moirais.fn.describe('pgeom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pgeom import *
import numpy as np
# See the function signature in fn/pgeom.py for argument names.
```
