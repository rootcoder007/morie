# describe('prxgms') — proximal_gradient_method
...
`print(result)` render. See `moirais.fn.describe('prxgms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prxgms import *
import numpy as np
# See the function signature in fn/prxgms.py for argument names.
```
