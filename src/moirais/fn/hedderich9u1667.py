...
__all__ = ["hedderich_chapter_9_unnumbered_1667"]


def hedderich_chapter_9_unnumbered_1667(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: With the values F (2.5) = 0 .9938 and F (−2.5) = 0 .0062 from Table 5.6 on page 266 for the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1667')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1667: GeneralStatistics expression (auto-extracted; see ref)."
