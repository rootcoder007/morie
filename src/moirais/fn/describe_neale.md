# describe('neale') — neal_algorithm_8
...
`print(result)` render. See `moirais.fn.describe('neale')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neale import *
import numpy as np
# See the function signature in fn/neale.py for argument names.
```
