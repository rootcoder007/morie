# describe('hlbrt') — hilbert_envelope_fn
...
`print(result)` render. See `moirais.fn.describe('hlbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hlbrt import *
import numpy as np
# See the function signature in fn/hlbrt.py for argument names.
```
