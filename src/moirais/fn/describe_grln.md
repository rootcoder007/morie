# describe('grln') — geron_layer_normalization
...
`print(result)` render. See `moirais.fn.describe('grln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grln import *
import numpy as np
# See the function signature in fn/grln.py for argument names.
```
