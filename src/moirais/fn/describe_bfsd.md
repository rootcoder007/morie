# describe('bfsd') — bayes_factor_savage_dickey
...
`print(result)` render. See `moirais.fn.describe('bfsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfsd import *
import numpy as np
# See the function signature in fn/bfsd.py for argument names.
```
