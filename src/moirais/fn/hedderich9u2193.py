...
__all__ = ["hedderich_chapter_9_unnumbered_2193"]


def hedderich_chapter_9_unnumbered_2193(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( alternative == " greater " ) p . v a l <− 1− pbinom ( T−1 , n , 0 . 5 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2193')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2193: GeneralStatistics expression (auto-extracted; see ref)."
