...
`print(result)` render. See `moirais.fn.describe('snphw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snphw import *
import numpy as np
# See the function signature in fn/snphw.py for argument names.
```
