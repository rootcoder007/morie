...
`print(result)` render. See `moirais.fn.describe('issal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.issal import *
import numpy as np
# See the function signature in fn/issal.py for argument names.
```
