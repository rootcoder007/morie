...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1515"]


def guide_on_data_analysis_chapter_30_unnumbered_1515(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -2 x cohort = 10 -0.002 (0.68)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1515')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1515: GeneralStatistics expression (auto-extracted; see ref)."
