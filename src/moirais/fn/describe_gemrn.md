...
`print(result)` render. See `moirais.fn.describe('gemrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gemrn import *
import numpy as np
# See the function signature in fn/gemrn.py for argument names.
```
