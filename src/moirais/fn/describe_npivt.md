...
`print(result)` render. See `moirais.fn.describe('npivt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npivt import *
import numpy as np
# See the function signature in fn/npivt.py for argument names.
```
