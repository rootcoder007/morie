...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1207"]


def guide_on_data_analysis_chapter_24_unnumbered_1207(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] √𝑛 ∑𝑖 ∑𝑗(𝜇𝑖𝑗 − 𝜇𝑖. − 𝜇.𝑗 + 𝜇..)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1207')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1207: GeneralStatistics expression (auto-extracted; see ref)."
