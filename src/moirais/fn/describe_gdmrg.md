...
`print(result)` render. See `moirais.fn.describe('gdmrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmrg import *
import numpy as np
# See the function signature in fn/gdmrg.py for argument names.
```
