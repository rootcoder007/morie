...
`print(result)` render. See `moirais.fn.describe('rcrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcrnd import *
import numpy as np
# See the function signature in fn/rcrnd.py for argument names.
```
