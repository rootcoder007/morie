# describe('bwlmt') — bandwidth_limit
...
`print(result)` render. See `moirais.fn.describe('bwlmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwlmt import *
import numpy as np
# See the function signature in fn/bwlmt.py for argument names.
```
