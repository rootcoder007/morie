...
`print(result)` render. See `moirais.fn.describe('simin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simin import *
import numpy as np
# See the function signature in fn/simin.py for argument names.
```
