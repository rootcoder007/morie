# describe('hmplf') — geron_polynomial_features
...
`print(result)` render. See `moirais.fn.describe('hmplf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmplf import *
import numpy as np
# See the function signature in fn/hmplf.py for argument names.
```
