...
`print(result)` render. See `moirais.fn.describe('slxwald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxwald import *
import numpy as np
# See the function signature in fn/slxwald.py for argument names.
```
