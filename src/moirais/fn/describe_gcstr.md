...
`print(result)` render. See `moirais.fn.describe('gcstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcstr import *
import numpy as np
# See the function signature in fn/gcstr.py for argument names.
```
