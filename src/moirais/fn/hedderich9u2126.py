...
__all__ = ["hedderich_chapter_9_unnumbered_2126"]


def hedderich_chapter_9_unnumbered_2126(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ] = 211.125−5.875√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2126')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2126: GeneralStatistics expression (auto-extracted; see ref)."
