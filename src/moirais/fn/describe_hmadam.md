...
`print(result)` render. See `moirais.fn.describe('hmadam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmadam import *
import numpy as np
# See the function signature in fn/hmadam.py for argument names.
```
