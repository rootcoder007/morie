# describe('nwstb') — network_stability
...
`print(result)` render. See `moirais.fn.describe('nwstb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwstb import *
import numpy as np
# See the function signature in fn/nwstb.py for argument names.
```
