...
__all__ = ["hedderich_chapter_9_unnumbered_1736"]


def hedderich_chapter_9_unnumbered_1736(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : nblzA = 0 . 3 0 5 1 3 , p− value = 0 . 5 5 2 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1736')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1736: GeneralStatistics expression (auto-extracted; see ref)."
