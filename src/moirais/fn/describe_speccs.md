# describe('speccs') — cross_spectrum
...
`print(result)` render. See `moirais.fn.describe('speccs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.speccs import *
import numpy as np
# See the function signature in fn/speccs.py for argument names.
```
