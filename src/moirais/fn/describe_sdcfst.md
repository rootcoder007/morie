# describe('sdcfst') — semi_doubly_robust_forest
...
`print(result)` render. See `moirais.fn.describe('sdcfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdcfst import *
import numpy as np
# See the function signature in fn/sdcfst.py for argument names.
```
