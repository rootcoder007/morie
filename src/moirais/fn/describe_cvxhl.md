...
`print(result)` render. See `moirais.fn.describe('cvxhl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxhl import *
import numpy as np
# See the function signature in fn/cvxhl.py for argument names.
```
