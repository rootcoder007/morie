...
__all__ = ["hedderich_chapter_9_unnumbered_3008"]


def hedderich_chapter_9_unnumbered_3008(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3008')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3008: ContingencyTables expression (auto-extracted; see ref)."
