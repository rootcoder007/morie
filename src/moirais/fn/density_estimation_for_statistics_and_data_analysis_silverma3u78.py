...
__all__ = ["density_estimation_for_statistics_and_data_analysis_silverma_chapter_3_unnumbered_78"]
...
def density_estimation_for_statistics_and_data_analysis_silverma_chapter_3_unnumbered_78(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('density_estimation_for_statistics_and_data_analysis_silverma3u78')`` for the full guide.
...
def cheatsheet():
    return "density_estimation_for_statistics_and_data_analysis_silverma3u78: Nonparametric expression (auto-extracted; see ref)."
