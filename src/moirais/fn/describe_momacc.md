# describe('momacc') — moments_accountant
...
`print(result)` render. See `moirais.fn.describe('momacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.momacc import *
import numpy as np
# See the function signature in fn/momacc.py for argument names.
```
