...
`print(result)` render. See `moirais.fn.describe('holo_s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_s import *
import numpy as np
# See the function signature in fn/holo_s.py for argument names.
```
