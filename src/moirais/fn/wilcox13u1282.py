...
__all__ = ["wilcox_chapter_13_unnumbered_1282"]


def wilcox_chapter_13_unnumbered_1282(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: High n11 n12 n1+ =n11 +n12
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1282')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1282: GeneralStatistics expression (auto-extracted; see ref)."
