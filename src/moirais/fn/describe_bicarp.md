...
`print(result)` render. See `moirais.fn.describe('bicarp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bicarp import *
import numpy as np
# See the function signature in fn/bicarp.py for argument names.
```
