...
`print(result)` render. See `moirais.fn.describe('krust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krust import *
import numpy as np
# See the function signature in fn/krust.py for argument names.
```
