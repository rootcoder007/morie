...
`print(result)` render. See `moirais.fn.describe('dffit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dffit import *
import numpy as np
# See the function signature in fn/dffit.py for argument names.
```
