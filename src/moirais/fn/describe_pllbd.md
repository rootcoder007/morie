...
`print(result)` render. See `moirais.fn.describe('pllbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pllbd import *
import numpy as np
# See the function signature in fn/pllbd.py for argument names.
```
