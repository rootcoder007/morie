...
__all__ = ["hedderich_chapter_9_unnumbered_2032"]


def hedderich_chapter_9_unnumbered_2032(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ˆt = |¯x1−¯x2|√Q1 +Q2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2032')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2032: PowerAndDesign expression (auto-extracted; see ref)."
