# describe('almap') — alammar_mean_average_precision
...
`print(result)` render. See `moirais.fn.describe('almap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.almap import *
import numpy as np
# See the function signature in fn/almap.py for argument names.
```
