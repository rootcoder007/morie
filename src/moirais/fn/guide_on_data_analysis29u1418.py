...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1418"]


def guide_on_data_analysis_chapter_29_unnumbered_1418(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑖=1 𝑤𝑖 = 1, 𝑤𝑖 = 𝑁−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1418')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1418: GeneralStatistics expression (auto-extracted; see ref)."
