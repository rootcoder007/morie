# describe('mtodr') — mto_driver_risk
...
`print(result)` render. See `moirais.fn.describe('mtodr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtodr import *
import numpy as np
# See the function signature in fn/mtodr.py for argument names.
```
