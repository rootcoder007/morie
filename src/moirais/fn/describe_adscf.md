# describe('adscf') — ads_cft_dictionary
...
`print(result)` render. See `moirais.fn.describe('adscf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adscf import *
import numpy as np
# See the function signature in fn/adscf.py for argument names.
```
