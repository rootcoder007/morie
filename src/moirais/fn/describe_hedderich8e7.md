# describe('hedderich8e7') — hedderich_chapter_8_equation_7
...
The result of the estimationˆy = ˆβ0+ ˆβ1x = 1.28+0.053x, after which a corresponding cholesterol
...
import numpy as np
result = hedderich_chapter_8_equation_7(np.random.default_rng(42).normal(0, 1, 100))
