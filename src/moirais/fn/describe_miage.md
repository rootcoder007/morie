...
`print(result)` render. See `moirais.fn.describe('miage')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miage import *
import numpy as np
# See the function signature in fn/miage.py for argument names.
```
