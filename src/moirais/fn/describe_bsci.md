# describe('bsci') — bootstrap_effect_size_ci
...
`print(result)` render. See `moirais.fn.describe('bsci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsci import *
import numpy as np
# See the function signature in fn/bsci.py for argument names.
```
