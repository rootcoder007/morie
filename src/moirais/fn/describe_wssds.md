...
`print(result)` render. See `moirais.fn.describe('wssds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wssds import *
import numpy as np
# See the function signature in fn/wssds.py for argument names.
```
