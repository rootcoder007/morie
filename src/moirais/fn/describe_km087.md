# describe('km087') — kamath_ch6_cps_metric
...
`print(result)` render. See `moirais.fn.describe('km087')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km087 import *
import numpy as np
# See the function signature in fn/km087.py for argument names.
```
