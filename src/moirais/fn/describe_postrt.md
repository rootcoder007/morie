# describe('postrt') — post_stratification
...
`print(result)` render. See `moirais.fn.describe('postrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.postrt import *
import numpy as np
# See the function signature in fn/postrt.py for argument names.
```
