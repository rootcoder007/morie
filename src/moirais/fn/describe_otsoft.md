# describe('otsoft') — ot_softassignment
...
`print(result)` render. See `moirais.fn.describe('otsoft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otsoft import *
import numpy as np
# See the function signature in fn/otsoft.py for argument names.
```
