...
__all__ = ["hedderich_chapter_9_unnumbered_226"]


def hedderich_chapter_9_unnumbered_226(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] xn =x0·wn =x0·(1 +rt)n (3.44)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u226')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u226: GeneralStatistics expression (auto-extracted; see ref)."
