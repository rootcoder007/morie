# describe('sbcrk') — simulation_based_calibration_rank
...
`print(result)` render. See `moirais.fn.describe('sbcrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbcrk import *
import numpy as np
# See the function signature in fn/sbcrk.py for argument names.
```
