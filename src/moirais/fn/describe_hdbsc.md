...
`print(result)` render. See `moirais.fn.describe('hdbsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdbsc import *
import numpy as np
# See the function signature in fn/hdbsc.py for argument names.
```
