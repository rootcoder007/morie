...
`print(result)` render. See `moirais.fn.describe('ihgap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihgap import *
import numpy as np
# See the function signature in fn/ihgap.py for argument names.
```
