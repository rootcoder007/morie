...
`print(result)` render. See `moirais.fn.describe('hmsenet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsenet import *
import numpy as np
# See the function signature in fn/hmsenet.py for argument names.
```
