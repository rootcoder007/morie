...
`print(result)` render. See `moirais.fn.describe('sntpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntpl import *
import numpy as np
# See the function signature in fn/sntpl.py for argument names.
```
