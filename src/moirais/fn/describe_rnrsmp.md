...
`print(result)` render. See `moirais.fn.describe('rnrsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnrsmp import *
import numpy as np
# See the function signature in fn/rnrsmp.py for argument names.
```
