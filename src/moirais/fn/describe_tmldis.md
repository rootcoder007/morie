# describe('tmldis') — tmle_disparity
...
`print(result)` render. See `moirais.fn.describe('tmldis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmldis import *
import numpy as np
# See the function signature in fn/tmldis.py for argument names.
```
