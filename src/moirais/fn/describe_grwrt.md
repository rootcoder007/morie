# describe('grwrt') — population_growth_rate
...
`print(result)` render. See `moirais.fn.describe('grwrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grwrt import *
import numpy as np
# See the function signature in fn/grwrt.py for argument names.
```
