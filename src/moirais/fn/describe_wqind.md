...
`print(result)` render. See `moirais.fn.describe('wqind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqind import *
import numpy as np
# See the function signature in fn/wqind.py for argument names.
```
