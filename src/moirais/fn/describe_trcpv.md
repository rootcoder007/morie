...
`print(result)` render. See `moirais.fn.describe('trcpv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcpv import *
import numpy as np
# See the function signature in fn/trcpv.py for argument names.
```
