# describe('causshap') — causal_shap_decomposition
...
`print(result)` render. See `moirais.fn.describe('causshap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causshap import *
import numpy as np
# See the function signature in fn/causshap.py for argument names.
```
