# describe('gh_wn_gauss_pr') — ghosal_white_noise_gauss_prior
...
`print(result)` render. See `moirais.fn.describe('gh_wn_gauss_pr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_wn_gauss_pr import *
import numpy as np
# See the function signature in fn/gh_wn_gauss_pr.py for argument names.
```
