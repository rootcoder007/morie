...
`print(result)` render. See `moirais.fn.describe('gb661c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb661c import *
import numpy as np
# See the function signature in fn/gb661c.py for argument names.
```
