...
__all__ = ["wilcox_chapter_14_unnumbered_666"]


def wilcox_chapter_14_unnumbered_666(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SSBG = 2890 − 2902/30 = 86 .67,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u666')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u666: GeneralStatistics expression (auto-extracted; see ref)."
