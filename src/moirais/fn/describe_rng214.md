# describe('rng214') — rangayyan_ch4_signal_total_energy
...
`print(result)` render. See `moirais.fn.describe('rng214')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng214 import *
import numpy as np
# See the function signature in fn/rng214.py for argument names.
```
