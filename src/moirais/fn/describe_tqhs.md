# describe('tqhs') — turboquant_qjl_sign_quantizer
...
`print(result)` render. See `moirais.fn.describe('tqhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqhs import *
import numpy as np
# See the function signature in fn/tqhs.py for argument names.
```
