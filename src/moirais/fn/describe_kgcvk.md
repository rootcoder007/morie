# describe('kgcvk') — kriging_cv_kfold
...
`print(result)` render. See `moirais.fn.describe('kgcvk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgcvk import *
import numpy as np
# See the function signature in fn/kgcvk.py for argument names.
```
