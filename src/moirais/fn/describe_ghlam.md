...
`print(result)` render. See `moirais.fn.describe('ghlam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghlam import *
import numpy as np
# See the function signature in fn/ghlam.py for argument names.
```
