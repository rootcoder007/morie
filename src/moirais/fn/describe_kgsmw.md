...
`print(result)` render. See `moirais.fn.describe('kgsmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgsmw import *
import numpy as np
# See the function signature in fn/kgsmw.py for argument names.
```
