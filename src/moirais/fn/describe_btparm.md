# describe('btparm') — boot_parametric
...
`print(result)` render. See `moirais.fn.describe('btparm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btparm import *
import numpy as np
# See the function signature in fn/btparm.py for argument names.
```
