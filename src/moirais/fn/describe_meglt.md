# describe('meglt') — matrix_completion_low_rank
...
`print(result)` render. See `moirais.fn.describe('meglt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.meglt import *
import numpy as np
# See the function signature in fn/meglt.py for argument names.
```
