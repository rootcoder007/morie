...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_60"]


def information_theory_mackay_chapter_6_unnumbered_60(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 1/2 = 1/2 = 0:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u60')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u60: GeneralStatistics expression (auto-extracted; see ref)."
