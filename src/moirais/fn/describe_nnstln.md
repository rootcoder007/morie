...
`print(result)` render. See `moirais.fn.describe('nnstln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnstln import *
import numpy as np
# See the function signature in fn/nnstln.py for argument names.
```
