...
`print(result)` render. See `moirais.fn.describe('rey_tw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_tw import *
import numpy as np
# See the function signature in fn/rey_tw.py for argument names.
```
