# describe('wsmexp') — wasserman_expectation
...
`print(result)` render. See `moirais.fn.describe('wsmexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmexp import *
import numpy as np
# See the function signature in fn/wsmexp.py for argument names.
```
