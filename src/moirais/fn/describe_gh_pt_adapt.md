# describe('gh_pt_adapt') — ghosal_pt_adaptive
...
`print(result)` render. See `moirais.fn.describe('gh_pt_adapt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_pt_adapt import *
import numpy as np
# See the function signature in fn/gh_pt_adapt.py for argument names.
```
