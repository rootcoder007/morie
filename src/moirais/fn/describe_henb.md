# describe('henb') — net_monetary_benefit
...
`print(result)` render. See `moirais.fn.describe('henb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.henb import *
import numpy as np
# See the function signature in fn/henb.py for argument names.
```
