...
`print(result)` render. See `moirais.fn.describe('regmlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.regmlm import *
import numpy as np
# See the function signature in fn/regmlm.py for argument names.
```
