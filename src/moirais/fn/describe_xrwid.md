...
`print(result)` render. See `moirais.fn.describe('xrwid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwid import *
import numpy as np
# See the function signature in fn/xrwid.py for argument names.
```
