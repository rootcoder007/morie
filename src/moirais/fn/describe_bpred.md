# describe('bpred') — bayesian_predictive
...
`print(result)` render. See `moirais.fn.describe('bpred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpred import *
import numpy as np
# See the function signature in fn/bpred.py for argument names.
```
