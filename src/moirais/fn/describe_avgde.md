...
`print(result)` render. See `moirais.fn.describe('avgde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avgde import *
import numpy as np
# See the function signature in fn/avgde.py for argument names.
```
