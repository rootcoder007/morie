...
`print(result)` render. See `moirais.fn.describe('hyuaa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyuaa import *
import numpy as np
# See the function signature in fn/hyuaa.py for argument names.
```
