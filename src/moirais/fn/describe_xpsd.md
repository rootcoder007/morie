...
`print(result)` render. See `moirais.fn.describe('xpsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xpsd import *
import numpy as np
# See the function signature in fn/xpsd.py for argument names.
```
