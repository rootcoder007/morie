...
`print(result)` render. See `moirais.fn.describe('mvkov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvkov import *
import numpy as np
# See the function signature in fn/mvkov.py for argument names.
```
