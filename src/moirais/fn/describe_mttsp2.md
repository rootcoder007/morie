...
`print(result)` render. See `moirais.fn.describe('mttsp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mttsp2 import *
import numpy as np
# See the function signature in fn/mttsp2.py for argument names.
```
