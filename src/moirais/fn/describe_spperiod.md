# describe('spperiod') — schabenberger_periodogram
...
`print(result)` render. See `moirais.fn.describe('spperiod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spperiod import *
import numpy as np
# See the function signature in fn/spperiod.py for argument names.
```
