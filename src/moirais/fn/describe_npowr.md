...
`print(result)` render. See `moirais.fn.describe('npowr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npowr import *
import numpy as np
# See the function signature in fn/npowr.py for argument names.
```
