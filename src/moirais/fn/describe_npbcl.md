# describe('npbcl') — np_bayes_clustering
...
`print(result)` render. See `moirais.fn.describe('npbcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npbcl import *
import numpy as np
# See the function signature in fn/npbcl.py for argument names.
```
