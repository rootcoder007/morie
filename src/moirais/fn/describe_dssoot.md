# describe('dssoot') — bootstrap_indirect
...
`print(result)` render. See `moirais.fn.describe('dssoot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dssoot import *
import numpy as np
# See the function signature in fn/dssoot.py for argument names.
```
