...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_176"]


def guide_on_data_analysis_chapter_4_unnumbered_176(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑧 = 𝑤+ − 𝑛(𝑛+1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u176')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u176: GeneralStatistics expression (auto-extracted; see ref)."
