# describe('tmltrn') — tmle_transportability
...
`print(result)` render. See `moirais.fn.describe('tmltrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmltrn import *
import numpy as np
# See the function signature in fn/tmltrn.py for argument names.
```
