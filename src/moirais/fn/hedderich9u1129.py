...
__all__ = ["hedderich_chapter_9_unnumbered_1129"]


def hedderich_chapter_9_unnumbered_1129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Calculate the 95%-CI for πbased on ˆp = x/n = 7/20 = 0 .35 (F -values as 0.025
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1129')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1129: GeneralStatistics expression (auto-extracted; see ref)."
