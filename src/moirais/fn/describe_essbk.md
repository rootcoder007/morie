# describe('essbk') — effective_sample_size_bulk
...
`print(result)` render. See `moirais.fn.describe('essbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.essbk import *
import numpy as np
# See the function signature in fn/essbk.py for argument names.
```
