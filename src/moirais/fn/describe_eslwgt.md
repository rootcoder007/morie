# describe('eslwgt') — esl_weight_decay
...
`print(result)` render. See `moirais.fn.describe('eslwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslwgt import *
import numpy as np
# See the function signature in fn/eslwgt.py for argument names.
```
