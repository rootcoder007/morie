...
`print(result)` render. See `moirais.fn.describe('rskcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskcl import *
import numpy as np
# See the function signature in fn/rskcl.py for argument names.
```
