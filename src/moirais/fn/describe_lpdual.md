...
`print(result)` render. See `moirais.fn.describe('lpdual')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lpdual import *
import numpy as np
# See the function signature in fn/lpdual.py for argument names.
```
