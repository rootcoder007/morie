# describe('medint') — mediated_interaction
...
`print(result)` render. See `moirais.fn.describe('medint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medint import *
import numpy as np
# See the function signature in fn/medint.py for argument names.
```
