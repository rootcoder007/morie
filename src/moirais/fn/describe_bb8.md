...
`print(result)` render. See `moirais.fn.describe('bb8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bb8 import *
import numpy as np
# See the function signature in fn/bb8.py for argument names.
```
