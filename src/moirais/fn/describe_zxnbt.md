# describe('zxnbt') — network_between
...
`print(result)` render. See `moirais.fn.describe('zxnbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxnbt import *
import numpy as np
# See the function signature in fn/zxnbt.py for argument names.
```
