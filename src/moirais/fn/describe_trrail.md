...
`print(result)` render. See `moirais.fn.describe('trrail')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trrail import *
import numpy as np
# See the function signature in fn/trrail.py for argument names.
```
