# describe('masrcn') — mask_rcnn_segmentation
...
`print(result)` render. See `moirais.fn.describe('masrcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masrcn import *
import numpy as np
# See the function signature in fn/masrcn.py for argument names.
```
