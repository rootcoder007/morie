...
`print(result)` render. See `moirais.fn.describe('btsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsmp import *
import numpy as np
# See the function signature in fn/btsmp.py for argument names.
```
