# describe('rpl_ag') — rplace_age_gender
...
`print(result)` render. See `moirais.fn.describe('rpl_ag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_ag import *
import numpy as np
# See the function signature in fn/rpl_ag.py for argument names.
```
