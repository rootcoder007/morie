...
`print(result)` render. See `moirais.fn.describe('mtmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtmod import *
import numpy as np
# See the function signature in fn/mtmod.py for argument names.
```
