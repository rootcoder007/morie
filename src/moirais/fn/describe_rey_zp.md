...
`print(result)` render. See `moirais.fn.describe('rey_zp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_zp import *
import numpy as np
# See the function signature in fn/rey_zp.py for argument names.
```
