# describe('rng125') — rangayyan_ch3_butterworth_pole_positions
...
`print(result)` render. See `moirais.fn.describe('rng125')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng125 import *
import numpy as np
# See the function signature in fn/rng125.py for argument names.
```
