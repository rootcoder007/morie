...
__all__ = ["hedderich_chapter_9_unnumbered_1011"]


def hedderich_chapter_9_unnumbered_1011(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lny∗= lna +p·(lnb−lna)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1011')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1011: GeneralStatistics expression (auto-extracted; see ref)."
