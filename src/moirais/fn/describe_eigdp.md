# describe('eigdp') — eigen_decompose
...
`print(result)` render. See `moirais.fn.describe('eigdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigdp import *
import numpy as np
# See the function signature in fn/eigdp.py for argument names.
```
