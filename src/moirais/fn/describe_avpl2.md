...
`print(result)` render. See `moirais.fn.describe('avpl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.avpl2 import *
import numpy as np
# See the function signature in fn/avpl2.py for argument names.
```
