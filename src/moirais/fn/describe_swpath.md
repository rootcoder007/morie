...
`print(result)` render. See `moirais.fn.describe('swpath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swpath import *
import numpy as np
# See the function signature in fn/swpath.py for argument names.
```
