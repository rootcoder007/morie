...
__all__ = ["hedderich_chapter_9_unnumbered_1400"]


def hedderich_chapter_9_unnumbered_1400(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Qx = 1593−(103)2/7 = 77.429 Qy = 1400−(98)2/7 = 28
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1400')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1400: GeneralStatistics expression (auto-extracted; see ref)."
