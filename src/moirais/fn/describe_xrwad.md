...
`print(result)` render. See `moirais.fn.describe('xrwad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwad import *
import numpy as np
# See the function signature in fn/xrwad.py for argument names.
```
