# describe('bndnln') — bound_nonlinear
...
`print(result)` render. See `moirais.fn.describe('bndnln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndnln import *
import numpy as np
# See the function signature in fn/bndnln.py for argument names.
```
