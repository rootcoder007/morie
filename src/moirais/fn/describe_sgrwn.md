# describe('sgrwn') — row_normalize_weights
...
`print(result)` render. See `moirais.fn.describe('sgrwn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgrwn import *
import numpy as np
# See the function signature in fn/sgrwn.py for argument names.
```
