...
`print(result)` render. See `moirais.fn.describe('vqgdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vqgdec import *
import numpy as np
# See the function signature in fn/vqgdec.py for argument names.
```
