# describe('aitclri') — aitchison_clr_inverse
...
`print(result)` render. See `moirais.fn.describe('aitclri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitclri import *
import numpy as np
# See the function signature in fn/aitclri.py for argument names.
```
