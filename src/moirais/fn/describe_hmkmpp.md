# describe('hmkmpp') — geron_kmeans_plus_plus
...
`print(result)` render. See `moirais.fn.describe('hmkmpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkmpp import *
import numpy as np
# See the function signature in fn/hmkmpp.py for argument names.
```
