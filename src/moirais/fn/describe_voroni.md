...
`print(result)` render. See `moirais.fn.describe('voroni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voroni import *
import numpy as np
# See the function signature in fn/voroni.py for argument names.
```
