...
`print(result)` render. See `moirais.fn.describe('cnnge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnnge import *
import numpy as np
# See the function signature in fn/cnnge.py for argument names.
```
