# describe('blstn') — blast_nucleotide
...
`print(result)` render. See `moirais.fn.describe('blstn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blstn import *
import numpy as np
# See the function signature in fn/blstn.py for argument names.
```
