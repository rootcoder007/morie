...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_303"]


def guide_on_data_analysis_chapter_5_unnumbered_303(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (Y − X𝛽)⊤(Y − X𝛽) =Y⊤Y − Y⊤X𝛽 − 𝛽⊤X⊤Y + 𝛽⊤(X⊤X)𝛽.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u303')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u303: GeneralStatistics expression (auto-extracted; see ref)."
