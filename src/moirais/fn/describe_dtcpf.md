...
`print(result)` render. See `moirais.fn.describe('dtcpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpf import *
import numpy as np
# See the function signature in fn/dtcpf.py for argument names.
```
