# describe('rng199') — rangayyan_ch4_correlation_coefficient_normalized_dot
...
`print(result)` render. See `moirais.fn.describe('rng199')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng199 import *
import numpy as np
# See the function signature in fn/rng199.py for argument names.
```
