# describe('rbc') — rank_biserial_correlation
...
`print(result)` render. See `moirais.fn.describe('rbc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbc import *
import numpy as np
# See the function signature in fn/rbc.py for argument names.
```
