# describe('cramr') — cramer_rao_bound
...
`print(result)` render. See `moirais.fn.describe('cramr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cramr import *
import numpy as np
# See the function signature in fn/cramr.py for argument names.
```
