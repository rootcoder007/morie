...
`print(result)` render. See `moirais.fn.describe('ghbch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghbch import *
import numpy as np
# See the function signature in fn/ghbch.py for argument names.
```
