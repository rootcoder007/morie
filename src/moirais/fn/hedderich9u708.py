...
__all__ = ["hedderich_chapter_9_unnumbered_708"]


def hedderich_chapter_9_unnumbered_708(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] x λ = 0, 2 λ = 0, 5 λ = 0, 8 λ = 1 λ = 3 λ = 5 λ = 8 λ = 12 λ = 20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u708')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u708: CountModels expression (auto-extracted; see ref)."
