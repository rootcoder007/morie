...
`print(result)` render. See `moirais.fn.describe('arcit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arcit import *
import numpy as np
# See the function signature in fn/arcit.py for argument names.
```
