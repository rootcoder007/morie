...
__all__ = ["wilcox_chapter_14_unnumbered_775"]


def wilcox_chapter_14_unnumbered_775(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : ¯µ .1 = ¯µ .2 = · · · = ¯µ .K. (10.2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u775')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u775: GeneralStatistics expression (auto-extracted; see ref)."
