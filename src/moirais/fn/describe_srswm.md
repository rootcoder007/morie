...
`print(result)` render. See `moirais.fn.describe('srswm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srswm import *
import numpy as np
# See the function signature in fn/srswm.py for argument names.
```
