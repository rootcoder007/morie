# describe('gh_c12_5') — ghosal_eff_infl_fn
...
`print(result)` render. See `moirais.fn.describe('gh_c12_5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_5 import *
import numpy as np
# See the function signature in fn/gh_c12_5.py for argument names.
```
