...
`print(result)` render. See `moirais.fn.describe('mkdft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mkdft import *
import numpy as np
# See the function signature in fn/mkdft.py for argument names.
```
