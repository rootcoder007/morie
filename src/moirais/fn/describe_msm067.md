# describe('msm067') — mvsml_bayesian_regression_eq_6_9
...
`print(result)` render. See `moirais.fn.describe('msm067')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm067 import *
import numpy as np
# See the function signature in fn/msm067.py for argument names.
```
