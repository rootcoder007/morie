...
__all__ = ["hedderich_chapter_9_unnumbered_1198"]


def hedderich_chapter_9_unnumbered_1198(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 1−α/k;1 + 4ni(n−ni)/n]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1198')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1198: PowerAndDesign expression (auto-extracted; see ref)."
