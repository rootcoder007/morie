...
__all__ = ["hedderich_chapter_9_unnumbered_2938"]


def hedderich_chapter_9_unnumbered_2938(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + c a t( "B ( two − sided ) =" ,B , " , ( P =" , round ( p . val , 8 ) , " ) \ n " ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2938')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2938: GeneralStatistics expression (auto-extracted; see ref)."
