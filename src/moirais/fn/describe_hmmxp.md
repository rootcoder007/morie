...
`print(result)` render. See `moirais.fn.describe('hmmxp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmxp import *
import numpy as np
# See the function signature in fn/hmmxp.py for argument names.
```
