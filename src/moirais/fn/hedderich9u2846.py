...
__all__ = ["hedderich_chapter_9_unnumbered_2846"]


def hedderich_chapter_9_unnumbered_2846(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Di = the difference between the proportions:Di =ai/ni1−ci/ni2 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2846')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2846: GeneralStatistics expression (auto-extracted; see ref)."
