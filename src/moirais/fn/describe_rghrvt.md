# describe('rghrvt') — rangayyan_hrv_time_domain
...
`print(result)` render. See `moirais.fn.describe('rghrvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrvt import *
import numpy as np
# See the function signature in fn/rghrvt.py for argument names.
```
