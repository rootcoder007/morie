...
__all__ = ["hedderich_chapter_9_unnumbered_2457"]


def hedderich_chapter_9_unnumbered_2457(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Since ˆH = 11.523> 7.815 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2457')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2457: GeneralStatistics expression (auto-extracted; see ref)."
