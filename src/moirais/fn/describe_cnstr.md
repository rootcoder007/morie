...
`print(result)` render. See `moirais.fn.describe('cnstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnstr import *
import numpy as np
# See the function signature in fn/cnstr.py for argument names.
```
