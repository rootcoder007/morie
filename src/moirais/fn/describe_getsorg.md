...
`print(result)` render. See `moirais.fn.describe('getsorg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getsorg import *
import numpy as np
# See the function signature in fn/getsorg.py for argument names.
```
