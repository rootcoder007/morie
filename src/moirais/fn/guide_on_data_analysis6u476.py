...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_476"]


def guide_on_data_analysis_chapter_6_unnumbered_476(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] sqrt(sum(delta ^ 2)) == delta_j) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u476')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u476: GeneralStatistics expression (auto-extracted; see ref)."
