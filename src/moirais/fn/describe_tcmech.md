# describe('tcmech') — truncated_cdp_mechanism
...
`print(result)` render. See `moirais.fn.describe('tcmech')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcmech import *
import numpy as np
# See the function signature in fn/tcmech.py for argument names.
```
