# describe('gh_c6_1') — ghosal_weak_consist
...
`print(result)` render. See `moirais.fn.describe('gh_c6_1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c6_1 import *
import numpy as np
# See the function signature in fn/gh_c6_1.py for argument names.
```
