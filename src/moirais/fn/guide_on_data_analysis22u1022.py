...
__all__ = ["guide_on_data_analysis_chapter_22_unnumbered_1022"]


def guide_on_data_analysis_chapter_22_unnumbered_1022(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌0𝑖|𝐷𝑖 = 1] = 𝐸[𝑌0𝑖|𝐷𝑖 = 0]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis22u1022')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis22u1022: GeneralStatistics expression (auto-extracted; see ref)."
