# describe('km038') — kamath_ch2_gpt2_task_conditioning
...
`print(result)` render. See `moirais.fn.describe('km038')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km038 import *
import numpy as np
# See the function signature in fn/km038.py for argument names.
```
