...
`print(result)` render. See `moirais.fn.describe('ghsir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsir import *
import numpy as np
# See the function signature in fn/ghsir.py for argument names.
```
