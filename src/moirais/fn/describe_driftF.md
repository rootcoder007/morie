# describe('driftF') — drift_forecast
...
`print(result)` render. See `moirais.fn.describe('driftF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.driftF import *
import numpy as np
# See the function signature in fn/driftF.py for argument names.
```
