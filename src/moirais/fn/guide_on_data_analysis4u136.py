...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_136"]


def guide_on_data_analysis_chapter_4_unnumbered_136(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: c(density[t_values <= -t_critical], 0),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u136')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u136: GeneralStatistics expression (auto-extracted; see ref)."
