...
`print(result)` render. See `moirais.fn.describe('dtscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtscr import *
import numpy as np
# See the function signature in fn/dtscr.py for argument names.
```
