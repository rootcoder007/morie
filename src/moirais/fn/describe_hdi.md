# describe('hdi') — highest_density_interval
...
`print(result)` render. See `moirais.fn.describe('hdi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdi import *
import numpy as np
# See the function signature in fn/hdi.py for argument names.
```
