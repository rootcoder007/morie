...
__all__ = ["hedderich_chapter_9_unnumbered_2220"]


def hedderich_chapter_9_unnumbered_2220(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] q0 (1−pq0 )z−i≤α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2220')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2220: CountModels expression (auto-extracted; see ref)."
