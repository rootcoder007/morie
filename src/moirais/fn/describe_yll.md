# describe('yll') — years_of_life_lost
...
`print(result)` render. See `moirais.fn.describe('yll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yll import *
import numpy as np
# See the function signature in fn/yll.py for argument names.
```
