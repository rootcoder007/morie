# describe('vorone') — vorone

## WHAT IT DOES

Voronoi entropy measure
...
`print(result)` render. See `moirais.fn.describe('vorone')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vorone import *
import numpy as np
# See the function signature in fn/vorone.py for argument names.
```
