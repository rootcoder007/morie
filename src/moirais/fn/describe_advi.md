...
`print(result)` render. See `moirais.fn.describe('advi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.advi import *
import numpy as np
# See the function signature in fn/advi.py for argument names.
```
