# describe('prsid') — parseval_identity
...
`print(result)` render. See `moirais.fn.describe('prsid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsid import *
import numpy as np
# See the function signature in fn/prsid.py for argument names.
```
