# describe('bayth') — bayes_theorem_genomic
...
`print(result)` render. See `moirais.fn.describe('bayth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayth import *
import numpy as np
# See the function signature in fn/bayth.py for argument names.
```
