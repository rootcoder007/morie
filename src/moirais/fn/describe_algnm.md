# describe('algnm') — party_alignment
...
`print(result)` render. See `moirais.fn.describe('algnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.algnm import *
import numpy as np
# See the function signature in fn/algnm.py for argument names.
```
