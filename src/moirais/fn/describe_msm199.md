# describe('msm199') — mvsml_ridge_lasso_elastic_eq_9_7
...
`print(result)` render. See `moirais.fn.describe('msm199')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm199 import *
import numpy as np
# See the function signature in fn/msm199.py for argument names.
```
