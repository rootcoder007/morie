...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_968(x):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u968')`` for the full guide.
