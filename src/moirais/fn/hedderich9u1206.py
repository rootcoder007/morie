...
__all__ = ["hedderich_chapter_9_unnumbered_1206"]


def hedderich_chapter_9_unnumbered_1206(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X≥k|λ)P̄ (X≥k|λl) = 1−α/2 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1206')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1206: CountModels expression (auto-extracted; see ref)."
