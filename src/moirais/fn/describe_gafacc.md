...
`print(result)` render. See `moirais.fn.describe('gafacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gafacc import *
import numpy as np
# See the function signature in fn/gafacc.py for argument names.
```
