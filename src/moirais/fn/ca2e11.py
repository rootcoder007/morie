...
def ca_chapter_2_equation_11(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca2e11')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'introductory' (auto-extracted; see reference for full context)."},
    )
