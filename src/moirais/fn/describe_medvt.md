...
`print(result)` render. See `moirais.fn.describe('medvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medvt import *
import numpy as np
# See the function signature in fn/medvt.py for argument names.
```
