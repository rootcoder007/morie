...
__all__ = ["hedderich_chapter_9_unnumbered_2944"]


def hedderich_chapter_9_unnumbered_2944(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + elseif ( alternative == " less " ) { # one−s idedless
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2944')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2944: GeneralStatistics expression (auto-extracted; see ref)."
