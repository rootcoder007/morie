...
`print(result)` render. See `moirais.fn.describe('tlearn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tlearn import *
import numpy as np
# See the function signature in fn/tlearn.py for argument names.
```
