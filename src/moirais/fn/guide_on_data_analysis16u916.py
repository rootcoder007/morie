...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_916"]


def guide_on_data_analysis_chapter_16_unnumbered_916(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑊 = (̂𝜃 − 𝜃0)′[𝑐𝑜𝑣(̂𝜃)]−1(̂𝜃 − 𝜃0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u916')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u916: GeneralStatistics expression (auto-extracted; see ref)."
