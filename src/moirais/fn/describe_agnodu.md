# describe('agnodu') — alphazero_node_update
...
`print(result)` render. See `moirais.fn.describe('agnodu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agnodu import *
import numpy as np
# See the function signature in fn/agnodu.py for argument names.
```
