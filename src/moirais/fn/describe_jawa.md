...
`print(result)` render. See `moirais.fn.describe('jawa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jawa import *
import numpy as np
# See the function signature in fn/jawa.py for argument names.
```
