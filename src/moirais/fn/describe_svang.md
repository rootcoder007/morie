...
`print(result)` render. See `moirais.fn.describe('svang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svang import *
import numpy as np
# See the function signature in fn/svang.py for argument names.
```
