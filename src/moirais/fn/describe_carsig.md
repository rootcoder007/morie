...
`print(result)` render. See `moirais.fn.describe('carsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carsig import *
import numpy as np
# See the function signature in fn/carsig.py for argument names.
```
