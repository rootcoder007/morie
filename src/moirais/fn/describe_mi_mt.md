...
`print(result)` render. See `moirais.fn.describe('mi_mt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mi_mt import *
import numpy as np
# See the function signature in fn/mi_mt.py for argument names.
```
