# describe('kappaw') — weighted_kappa
...
`print(result)` render. See `moirais.fn.describe('kappaw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kappaw import *
import numpy as np
# See the function signature in fn/kappaw.py for argument names.
```
