...
`print(result)` render. See `moirais.fn.describe('sppbe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppbe import *
import numpy as np
# See the function signature in fn/sppbe.py for argument names.
```
