...
`print(result)` render. See `moirais.fn.describe('theil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.theil import *
import numpy as np
# See the function signature in fn/theil.py for argument names.
```
