...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1656"]


def guide_on_data_analysis_chapter_30_unnumbered_1656(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑠0 = ̂ 𝑔−1 − ̂ 𝑔−2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1656')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1656: GeneralStatistics expression (auto-extracted; see ref)."
