...
`print(result)` render. See `moirais.fn.describe('gwrfwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrfwl import *
import numpy as np
# See the function signature in fn/gwrfwl.py for argument names.
```
