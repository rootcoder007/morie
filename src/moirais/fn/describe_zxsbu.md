# describe('zxsbu') — spatial_cv_buffer
...
`print(result)` render. See `moirais.fn.describe('zxsbu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsbu import *
import numpy as np
# See the function signature in fn/zxsbu.py for argument names.
```
