...
`print(result)` render. See `moirais.fn.describe('idwshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwshp import *
import numpy as np
# See the function signature in fn/idwshp.py for argument names.
```
