...
`print(result)` render. See `moirais.fn.describe('svmvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmvt import *
import numpy as np
# See the function signature in fn/svmvt.py for argument names.
```
