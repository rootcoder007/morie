...
`print(result)` render. See `moirais.fn.describe('sympFa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sympFa import *
import numpy as np
# See the function signature in fn/sympFa.py for argument names.
```
