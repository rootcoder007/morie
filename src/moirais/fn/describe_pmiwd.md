# describe('pmiwd') — pointwise_mutual_info
...
`print(result)` render. See `moirais.fn.describe('pmiwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmiwd import *
import numpy as np
# See the function signature in fn/pmiwd.py for argument names.
```
