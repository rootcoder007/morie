...
`print(result)` render. See `moirais.fn.describe('spcsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcsts import *
import numpy as np
# See the function signature in fn/spcsts.py for argument names.
```
