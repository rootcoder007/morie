...
`print(result)` render. See `moirais.fn.describe('kgblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgblk import *
import numpy as np
# See the function signature in fn/kgblk.py for argument names.
```
