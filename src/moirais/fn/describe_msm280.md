# describe('msm280') — mvsml_convolutional_nn_eq_14_10
...
`print(result)` render. See `moirais.fn.describe('msm280')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm280 import *
import numpy as np
# See the function signature in fn/msm280.py for argument names.
```
