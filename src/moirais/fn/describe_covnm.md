...
`print(result)` render. See `moirais.fn.describe('covnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covnm import *
import numpy as np
# See the function signature in fn/covnm.py for argument names.
```
