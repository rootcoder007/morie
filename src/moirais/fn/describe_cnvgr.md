# describe('cnvgr') — convergence_rate
...
`print(result)` render. See `moirais.fn.describe('cnvgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnvgr import *
import numpy as np
# See the function signature in fn/cnvgr.py for argument names.
```
