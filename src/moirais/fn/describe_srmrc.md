...
`print(result)` render. See `moirais.fn.describe('srmrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmrc import *
import numpy as np
# See the function signature in fn/srmrc.py for argument names.
```
