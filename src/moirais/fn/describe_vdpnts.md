...
`print(result)` render. See `moirais.fn.describe('vdpnts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdpnts import *
import numpy as np
# See the function signature in fn/vdpnts.py for argument names.
```
