...
__all__ = ["wilcox_chapter_4_unnumbered_93"]


def wilcox_chapter_4_unnumbered_93(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To determine c ifP (−c ≤ Z ≤ c) = 0.9, let d =P (−c ≤ Z ≤ c) = 0.9 and then compute
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u93')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u93: GeneralStatistics expression (auto-extracted; see ref)."
