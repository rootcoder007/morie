...
`print(result)` render. See `moirais.fn.describe('bpe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpe import *
import numpy as np
# See the function signature in fn/bpe.py for argument names.
```
