# describe('causscss') — causal_synthetic_subset
...
`print(result)` render. See `moirais.fn.describe('causscss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causscss import *
import numpy as np
# See the function signature in fn/causscss.py for argument names.
```
