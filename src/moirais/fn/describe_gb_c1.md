# describe('gb_c1') — gibbons_chebyshev
...
`print(result)` render. See `moirais.fn.describe('gb_c1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_c1 import *
import numpy as np
# See the function signature in fn/gb_c1.py for argument names.
```
