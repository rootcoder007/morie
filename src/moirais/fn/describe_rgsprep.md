# describe('rgsprep') — rangayyan_sparse_rep
...
`print(result)` render. See `moirais.fn.describe('rgsprep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsprep import *
import numpy as np
# See the function signature in fn/rgsprep.py for argument names.
```
