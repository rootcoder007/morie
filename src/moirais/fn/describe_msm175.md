# describe('msm175') — mvsml_ridge_lasso_elastic_eq_9_6
...
`print(result)` render. See `moirais.fn.describe('msm175')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm175 import *
import numpy as np
# See the function signature in fn/msm175.py for argument names.
```
