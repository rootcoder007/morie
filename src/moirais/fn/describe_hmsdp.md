# describe('hmsdp') — geron_scaled_dot_product
...
`print(result)` render. See `moirais.fn.describe('hmsdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsdp import *
import numpy as np
# See the function signature in fn/hmsdp.py for argument names.
```
