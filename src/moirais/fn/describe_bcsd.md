# describe('bcsd') — bcsd_downscaling
...
`print(result)` render. See `moirais.fn.describe('bcsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcsd import *
import numpy as np
# See the function signature in fn/bcsd.py for argument names.
```
