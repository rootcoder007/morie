# describe('grdpmr') — geron_ddpm_reverse_step
...
`print(result)` render. See `moirais.fn.describe('grdpmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdpmr import *
import numpy as np
# See the function signature in fn/grdpmr.py for argument names.
```
