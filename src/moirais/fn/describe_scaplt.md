# describe('scaplt') — plot_scalogram_fn
...
`print(result)` render. See `moirais.fn.describe('scaplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scaplt import *
import numpy as np
# See the function signature in fn/scaplt.py for argument names.
```
