...
__all__ = ["hedderich_chapter_9_unnumbered_114"]


def hedderich_chapter_9_unnumbered_114(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The exponential functiony =ax (fora =e = 2.718282 the natural exponential function) only
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u114')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u114: GeneralStatistics expression (auto-extracted; see ref)."
