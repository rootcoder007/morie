...
`print(result)` render. See `moirais.fn.describe('scmpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scmpl import *
import numpy as np
# See the function signature in fn/scmpl.py for argument names.
```
