# describe('vrgft') — variogram_fitting
...
`print(result)` render. See `moirais.fn.describe('vrgft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrgft import *
import numpy as np
# See the function signature in fn/vrgft.py for argument names.
```
