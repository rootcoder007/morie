...
__all__ = ["hedderich_chapter_9_unnumbered_2899"]


def hedderich_chapter_9_unnumbered_2899(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: to the model ( 7.340) by H0: β= 0 . The estimation of βcan be done with the method of least
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2899')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2899: GeneralStatistics expression (auto-extracted; see ref)."
