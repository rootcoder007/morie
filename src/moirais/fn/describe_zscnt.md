...
`print(result)` render. See `moirais.fn.describe('zscnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zscnt import *
import numpy as np
# See the function signature in fn/zscnt.py for argument names.
```
