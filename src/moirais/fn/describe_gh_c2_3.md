# describe('gh_c2_3') — ghosal_gp_increasing_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c2_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c2_3 import *
import numpy as np
# See the function signature in fn/gh_c2_3.py for argument names.
```
