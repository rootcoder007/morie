...
`print(result)` render. See `moirais.fn.describe('irtfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtfl import *
import numpy as np
# See the function signature in fn/irtfl.py for argument names.
```
