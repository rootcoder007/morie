# describe('zeklr') — scan_retrospective
...
`print(result)` render. See `moirais.fn.describe('zeklr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeklr import *
import numpy as np
# See the function signature in fn/zeklr.py for argument names.
```
