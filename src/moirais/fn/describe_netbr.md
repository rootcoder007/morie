...
`print(result)` render. See `moirais.fn.describe('netbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netbr import *
import numpy as np
# See the function signature in fn/netbr.py for argument names.
```
