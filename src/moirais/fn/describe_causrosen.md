# describe('causrosen') — causal_rosenbaum_bound
...
`print(result)` render. See `moirais.fn.describe('causrosen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrosen import *
import numpy as np
# See the function signature in fn/causrosen.py for argument names.
```
