...
`print(result)` render. See `moirais.fn.describe('zstbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zstbs import *
import numpy as np
# See the function signature in fn/zstbs.py for argument names.
```
