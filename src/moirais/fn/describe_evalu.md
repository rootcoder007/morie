...
`print(result)` render. See `moirais.fn.describe('evalu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evalu import *
import numpy as np
# See the function signature in fn/evalu.py for argument names.
```
