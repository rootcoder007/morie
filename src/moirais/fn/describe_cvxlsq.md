# describe('cvxlsq') — boyd_least_squares
...
`print(result)` render. See `moirais.fn.describe('cvxlsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlsq import *
import numpy as np
# See the function signature in fn/cvxlsq.py for argument names.
```
