...
`print(result)` render. See `moirais.fn.describe('xrgns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgns import *
import numpy as np
# See the function signature in fn/xrgns.py for argument names.
```
