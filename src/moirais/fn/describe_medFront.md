...
`print(result)` render. See `moirais.fn.describe('medFront')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.medFront import *
import numpy as np
# See the function signature in fn/medFront.py for argument names.
```
