...
`print(result)` render. See `moirais.fn.describe('ovrsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ovrsmp import *
import numpy as np
# See the function signature in fn/ovrsmp.py for argument names.
```
