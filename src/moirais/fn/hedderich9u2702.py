...
__all__ = ["hedderich_chapter_9_unnumbered_2702"]


def hedderich_chapter_9_unnumbered_2702(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: H0 : ω= 1 vs. HA : ω̸= 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2702')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2702: PowerAndDesign expression (auto-extracted; see ref)."
