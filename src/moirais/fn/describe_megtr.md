# describe('megtr') — kronecker_decompose

## WHAT IT DOES

Kronecker product decomposition. 'Everything flows. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('megtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.megtr import *
import numpy as np
# See the function signature in fn/megtr.py for argument names.
```
