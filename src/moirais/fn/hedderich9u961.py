...
__all__ = ["hedderich_chapter_9_unnumbered_961"]


def hedderich_chapter_9_unnumbered_961(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: freedom,t60;0.05;two−sided =t60;0.975 = 2.0003 orP (t60≤−2.0003 andt60≥2.0003) = 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u961')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u961: GeneralStatistics expression (auto-extracted; see ref)."
