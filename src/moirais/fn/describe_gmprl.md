...
`print(result)` render. See `moirais.fn.describe('gmprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmprl import *
import numpy as np
# See the function signature in fn/gmprl.py for argument names.
```
