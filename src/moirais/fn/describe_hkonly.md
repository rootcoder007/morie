# describe('hkonly') — hadamard_response
...
`print(result)` render. See `moirais.fn.describe('hkonly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hkonly import *
import numpy as np
# See the function signature in fn/hkonly.py for argument names.
```
