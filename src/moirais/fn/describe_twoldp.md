# describe('twoldp') — two_locus_dprime
...
`print(result)` render. See `moirais.fn.describe('twoldp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.twoldp import *
import numpy as np
# See the function signature in fn/twoldp.py for argument names.
```
