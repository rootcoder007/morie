...
`print(result)` render. See `moirais.fn.describe('box_m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.box_m import *
import numpy as np
# See the function signature in fn/box_m.py for argument names.
```
