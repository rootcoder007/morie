# describe('pratt') — pretrained_attention
...
`print(result)` render. See `moirais.fn.describe('pratt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pratt import *
import numpy as np
# See the function signature in fn/pratt.py for argument names.
```
