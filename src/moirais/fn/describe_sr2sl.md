...
`print(result)` render. See `moirais.fn.describe('sr2sl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sr2sl import *
import numpy as np
# See the function signature in fn/sr2sl.py for argument names.
```
