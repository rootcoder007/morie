...
`print(result)` render. See `moirais.fn.describe('hydfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydfl import *
import numpy as np
# See the function signature in fn/hydfl.py for argument names.
```
