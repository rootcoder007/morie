...
__all__ = ["wilcox_chapter_14_unnumbered_447"]


def wilcox_chapter_14_unnumbered_447(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: computes confidence intervals for E(Y |X =Xi),i = 1,...,n . If the argument ADJ=TRUE, the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u447')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u447: GeneralStatistics expression (auto-extracted; see ref)."
