# describe('hellngd') — hellinger_distance
...
`print(result)` render. See `moirais.fn.describe('hellngd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hellngd import *
import numpy as np
# See the function signature in fn/hellngd.py for argument names.
```
