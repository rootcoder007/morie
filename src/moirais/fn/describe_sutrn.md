# describe('sutrn') — substance_trend
...
`print(result)` render. See `moirais.fn.describe('sutrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sutrn import *
import numpy as np
# See the function signature in fn/sutrn.py for argument names.
```
