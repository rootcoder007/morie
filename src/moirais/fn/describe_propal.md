# describe('propal') — proportional_allocation
...
`print(result)` render. See `moirais.fn.describe('propal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.propal import *
import numpy as np
# See the function signature in fn/propal.py for argument names.
```
