...
`print(result)` render. See `moirais.fn.describe('hmdrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdrp import *
import numpy as np
# See the function signature in fn/hmdrp.py for argument names.
```
