...
`print(result)` render. See `moirais.fn.describe('swspars')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swspars import *
import numpy as np
# See the function signature in fn/swspars.py for argument names.
```
