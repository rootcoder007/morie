# describe('fzwlc') — fauzi_smoothed_wilcoxon
...
`print(result)` render. See `moirais.fn.describe('fzwlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzwlc import *
import numpy as np
# See the function signature in fn/fzwlc.py for argument names.
```
