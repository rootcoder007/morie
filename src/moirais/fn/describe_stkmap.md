...
`print(result)` render. See `moirais.fn.describe('stkmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkmap import *
import numpy as np
# See the function signature in fn/stkmap.py for argument names.
```
