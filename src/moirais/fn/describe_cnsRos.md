# describe('cnsRos') — rosenbaum_bound_signed
...
`print(result)` render. See `moirais.fn.describe('cnsRos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnsRos import *
import numpy as np
# See the function signature in fn/cnsRos.py for argument names.
```
