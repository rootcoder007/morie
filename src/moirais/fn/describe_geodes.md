...
`print(result)` render. See `moirais.fn.describe('geodes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geodes import *
import numpy as np
# See the function signature in fn/geodes.py for argument names.
```
