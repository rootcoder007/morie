# describe('trnfen') — transfer_entropy
...
`print(result)` render. See `moirais.fn.describe('trnfen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnfen import *
import numpy as np
# See the function signature in fn/trnfen.py for argument names.
```
