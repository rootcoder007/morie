# describe('jt') — jonckheere_terpstra_test
...
`print(result)` render. See `moirais.fn.describe('jt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jt import *
import numpy as np
# See the function signature in fn/jt.py for argument names.
```
