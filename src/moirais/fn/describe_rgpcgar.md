# describe('rgpcgar') — rangayyan_pcg_ar_model
...
`print(result)` render. See `moirais.fn.describe('rgpcgar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcgar import *
import numpy as np
# See the function signature in fn/rgpcgar.py for argument names.
```
