...
`print(result)` render. See `moirais.fn.describe('gamra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gamra import *
import numpy as np
# See the function signature in fn/gamra.py for argument names.
```
