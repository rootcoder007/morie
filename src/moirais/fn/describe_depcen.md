# describe('depcen') — dependent_censoring_hazard
...
`print(result)` render. See `moirais.fn.describe('depcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depcen import *
import numpy as np
# See the function signature in fn/depcen.py for argument names.
```
