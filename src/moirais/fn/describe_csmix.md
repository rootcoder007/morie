...
`print(result)` render. See `moirais.fn.describe('csmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csmix import *
import numpy as np
# See the function signature in fn/csmix.py for argument names.
```
