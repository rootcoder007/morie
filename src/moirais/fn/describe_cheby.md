...
`print(result)` render. See `moirais.fn.describe('cheby')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cheby import *
import numpy as np
# See the function signature in fn/cheby.py for argument names.
```
