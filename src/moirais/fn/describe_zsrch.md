# describe('zsrch') — random_chisq_field
...
`print(result)` render. See `moirais.fn.describe('zsrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrch import *
import numpy as np
# See the function signature in fn/zsrch.py for argument names.
```
