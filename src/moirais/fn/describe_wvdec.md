...
`print(result)` render. See `moirais.fn.describe('wvdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvdec import *
import numpy as np
# See the function signature in fn/wvdec.py for argument names.
```
