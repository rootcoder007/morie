# describe('baynav') — variational_nf
...
`print(result)` render. See `moirais.fn.describe('baynav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baynav import *
import numpy as np
# See the function signature in fn/baynav.py for argument names.
```
