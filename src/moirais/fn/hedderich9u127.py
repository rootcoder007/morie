...
__all__ = ["hedderich_chapter_9_unnumbered_127"]


def hedderich_chapter_9_unnumbered_127(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (n−k)!k! = n(n−1)·...·(n−k + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u127')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u127: CountModels expression (auto-extracted; see ref)."
