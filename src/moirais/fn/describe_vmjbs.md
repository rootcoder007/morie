...
`print(result)` render. See `moirais.fn.describe('vmjbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmjbs import *
import numpy as np
# See the function signature in fn/vmjbs.py for argument names.
```
