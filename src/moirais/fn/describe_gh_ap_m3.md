# describe('gh_ap_m3') — ghosal_slice_sampler
...
`print(result)` render. See `moirais.fn.describe('gh_ap_m3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_m3 import *
import numpy as np
# See the function signature in fn/gh_ap_m3.py for argument names.
```
