...
`print(result)` render. See `moirais.fn.describe('ghsmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsmr import *
import numpy as np
# See the function signature in fn/ghsmr.py for argument names.
```
