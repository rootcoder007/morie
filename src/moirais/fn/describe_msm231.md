# describe('msm231') — mvsml_ridge_lasso_elastic_eq_9_44
...
`print(result)` render. See `moirais.fn.describe('msm231')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm231 import *
import numpy as np
# See the function signature in fn/msm231.py for argument names.
```
