...
`print(result)` render. See `moirais.fn.describe('irtmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtmp import *
import numpy as np
# See the function signature in fn/irtmp.py for argument names.
```
