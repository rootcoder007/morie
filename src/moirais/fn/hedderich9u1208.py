...
__all__ = ["hedderich_chapter_9_unnumbered_1208"]


def hedderich_chapter_9_unnumbered_1208(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: with χ2 = 2nλ and ν= 2k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1208')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1208: CountModels expression (auto-extracted; see ref)."
