...
`print(result)` render. See `moirais.fn.describe('clwrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clwrd import *
import numpy as np
# See the function signature in fn/clwrd.py for argument names.
```
