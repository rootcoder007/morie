...
__all__ = ["hedderich_chapter_9_unnumbered_937"]


def hedderich_chapter_9_unnumbered_937(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] k =γ+ log(m) = 0.57722 + log(m)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u937')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u937: GeneralStatistics expression (auto-extracted; see ref)."
