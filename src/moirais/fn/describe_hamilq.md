# describe('hamilq') — hamilton_q_changepoint
...
`print(result)` render. See `moirais.fn.describe('hamilq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hamilq import *
import numpy as np
# See the function signature in fn/hamilq.py for argument names.
```
