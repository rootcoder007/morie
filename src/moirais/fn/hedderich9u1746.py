...
__all__ = ["hedderich_chapter_9_unnumbered_1746"]


def hedderich_chapter_9_unnumbered_1746(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: T1 =|(x1−µ)/σ| x1 = the suspected outlier (7.39)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1746')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1746: PowerAndDesign expression (auto-extracted; see ref)."
