# describe('hrzora') — horowitz_two_step_oracle
...
`print(result)` render. See `moirais.fn.describe('hrzora')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzora import *
import numpy as np
# See the function signature in fn/hrzora.py for argument names.
```
