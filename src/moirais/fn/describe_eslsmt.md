# describe('eslsmt') — esl_smoothing_spline
...
`print(result)` render. See `moirais.fn.describe('eslsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsmt import *
import numpy as np
# See the function signature in fn/eslsmt.py for argument names.
```
