...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_183"]


def guide_on_data_analysis_chapter_4_unnumbered_183(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> V = 52, p-value = 0.009766
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u183')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u183: GeneralStatistics expression (auto-extracted; see ref)."
