# describe('dpkde') — dirichlet_process_kde
...
`print(result)` render. See `moirais.fn.describe('dpkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpkde import *
import numpy as np
# See the function signature in fn/dpkde.py for argument names.
```
