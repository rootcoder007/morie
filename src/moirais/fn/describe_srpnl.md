...
`print(result)` render. See `moirais.fn.describe('srpnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srpnl import *
import numpy as np
# See the function signature in fn/srpnl.py for argument names.
```
