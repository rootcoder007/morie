...
__all__ = ["hedderich_chapter_9_unnumbered_999"]


def hedderich_chapter_9_unnumbered_999(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F (m,n ; 1−α) = 1/F (n,m ;α) (5.179)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u999')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u999: GeneralStatistics expression (auto-extracted; see ref)."
