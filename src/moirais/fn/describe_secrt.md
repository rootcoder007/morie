# describe('secrt') — secondary_attack_rate
...
`print(result)` render. See `moirais.fn.describe('secrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secrt import *
import numpy as np
# See the function signature in fn/secrt.py for argument names.
```
