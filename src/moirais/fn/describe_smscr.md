...
`print(result)` render. See `moirais.fn.describe('smscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smscr import *
import numpy as np
# See the function signature in fn/smscr.py for argument names.
```
