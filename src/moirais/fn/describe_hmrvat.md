# describe('hmrvat') — geron_rnn_visual_attention
...
`print(result)` render. See `moirais.fn.describe('hmrvat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrvat import *
import numpy as np
# See the function signature in fn/hmrvat.py for argument names.
```
