# describe('rnkcr') — rank_correlation_test
...
`print(result)` render. See `moirais.fn.describe('rnkcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnkcr import *
import numpy as np
# See the function signature in fn/rnkcr.py for argument names.
```
