...
`print(result)` render. See `moirais.fn.describe('sens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sens import *
import numpy as np
# See the function signature in fn/sens.py for argument names.
```
