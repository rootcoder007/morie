...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1191"]


def guide_on_data_analysis_chapter_24_unnumbered_1191(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝜇𝑖𝑗 = 𝜇.. + 𝛼𝑖 + 𝛽𝑗(𝑖)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1191')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1191: GeneralStatistics expression (auto-extracted; see ref)."
