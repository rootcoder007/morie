...
__all__ = ["hedderich_chapter_9_unnumbered_1927"]


def hedderich_chapter_9_unnumbered_1927(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: α=0.10=βandk=1.5, it follows from (7.77)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1927')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1927: PowerAndDesign expression (auto-extracted; see ref)."
