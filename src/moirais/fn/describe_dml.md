# describe('dml') — estimate_double_ml
...
`print(result)` render. See `moirais.fn.describe('dml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dml import *
import numpy as np
# See the function signature in fn/dml.py for argument names.
```
