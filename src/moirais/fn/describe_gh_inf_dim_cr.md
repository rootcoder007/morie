# describe('gh_inf_dim_cr') — ghosal_inf_dim_credible
...
`print(result)` render. See `moirais.fn.describe('gh_inf_dim_cr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_inf_dim_cr import *
import numpy as np
# See the function signature in fn/gh_inf_dim_cr.py for argument names.
```
