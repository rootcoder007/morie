# describe('volrm') — vol_riskmetrics
...
`print(result)` render. See `moirais.fn.describe('volrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrm import *
import numpy as np
# See the function signature in fn/volrm.py for argument names.
```
