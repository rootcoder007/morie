...
__all__ = ["hedderich_chapter_9_unnumbered_3029"]


def hedderich_chapter_9_unnumbered_3029(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0,3 = 8.269< 8.887 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3029')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3029: GeneralStatistics expression (auto-extracted; see ref)."
