...
`print(result)` render. See `moirais.fn.describe('madMov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madMov import *
import numpy as np
# See the function signature in fn/madMov.py for argument names.
```
