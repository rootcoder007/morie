...
`print(result)` render. See `moirais.fn.describe('motiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.motiff import *
import numpy as np
# See the function signature in fn/motiff.py for argument names.
```
