...
`print(result)` render. See `moirais.fn.describe('vgfev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgfev import *
import numpy as np
# See the function signature in fn/vgfev.py for argument names.
```
