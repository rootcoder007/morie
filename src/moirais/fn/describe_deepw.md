...
`print(result)` render. See `moirais.fn.describe('deepw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deepw import *
import numpy as np
# See the function signature in fn/deepw.py for argument names.
```
