...
`print(result)` render. See `moirais.fn.describe('ibdmtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibdmtx import *
import numpy as np
# See the function signature in fn/ibdmtx.py for argument names.
```
