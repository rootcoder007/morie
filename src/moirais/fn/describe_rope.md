...
`print(result)` render. See `moirais.fn.describe('rope')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rope import *
import numpy as np
# See the function signature in fn/rope.py for argument names.
```
