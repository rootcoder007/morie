...
__all__ = ["hedderich_chapter_9_unnumbered_2307"]


def hedderich_chapter_9_unnumbered_2307(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] FDR =E[1|R> 0]·P (R> 0) = P (R> 0) = P (V > 0) = FWER .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2307')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2307: GeneralStatistics expression (auto-extracted; see ref)."
