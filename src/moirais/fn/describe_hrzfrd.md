# describe('hrzfrd') — horowitz_fredholm_eq
...
`print(result)` render. See `moirais.fn.describe('hrzfrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzfrd import *
import numpy as np
# See the function signature in fn/hrzfrd.py for argument names.
```
