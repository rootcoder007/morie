...
`print(result)` render. See `moirais.fn.describe('rwmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rwmh import *
import numpy as np
# See the function signature in fn/rwmh.py for argument names.
```
