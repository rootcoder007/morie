# describe('kminst') — kamath_instruction_tuning_loss
...
`print(result)` render. See `moirais.fn.describe('kminst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kminst import *
import numpy as np
# See the function signature in fn/kminst.py for argument names.
```
