...
`print(result)` render. See `moirais.fn.describe('clcrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcrp import *
import numpy as np
# See the function signature in fn/clcrp.py for argument names.
```
