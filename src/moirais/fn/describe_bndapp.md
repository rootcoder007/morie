# describe('bndapp') — bound_application
...
`print(result)` render. See `moirais.fn.describe('bndapp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndapp import *
import numpy as np
# See the function signature in fn/bndapp.py for argument names.
```
