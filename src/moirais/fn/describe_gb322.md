# describe('gb322') — gibbons_total_runs_dist
...
`print(result)` render. See `moirais.fn.describe('gb322')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb322 import *
import numpy as np
# See the function signature in fn/gb322.py for argument names.
```
