...
__all__ = ["wilcox_chapter_4_unnumbered_87"]


def wilcox_chapter_4_unnumbered_87(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A solution is obtained by noting that the area under the curve is 1, so P (Z ≥ c) = 1 −
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u87')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u87: GeneralStatistics expression (auto-extracted; see ref)."
