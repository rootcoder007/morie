...
`print(result)` render. See `moirais.fn.describe('trfry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trfry import *
import numpy as np
# See the function signature in fn/trfry.py for argument names.
```
