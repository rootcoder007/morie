...
`print(result)` render. See `moirais.fn.describe('secla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secla import *
import numpy as np
# See the function signature in fn/secla.py for argument names.
```
