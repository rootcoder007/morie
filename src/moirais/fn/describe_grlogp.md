# describe('grlogp') — geron_logistic_regression_probability
...
`print(result)` render. See `moirais.fn.describe('grlogp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlogp import *
import numpy as np
# See the function signature in fn/grlogp.py for argument names.
```
