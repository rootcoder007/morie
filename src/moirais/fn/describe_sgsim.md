...
`print(result)` render. See `moirais.fn.describe('sgsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsim import *
import numpy as np
# See the function signature in fn/sgsim.py for argument names.
```
