...
`print(result)` render. See `moirais.fn.describe('flops')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flops import *
import numpy as np
# See the function signature in fn/flops.py for argument names.
```
