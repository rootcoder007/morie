# describe('chgbcp') — bayesian_online_changepoint
...
`print(result)` render. See `moirais.fn.describe('chgbcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chgbcp import *
import numpy as np
# See the function signature in fn/chgbcp.py for argument names.
```
