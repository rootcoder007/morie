...
__all__ = ["use_r_chapter_2_unnumbered_251"]


def use_r_chapter_2_unnumbered_251(x):
    """
    Bayesian expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u251')`` for the full guide.
...
def cheatsheet():
    return "use_r2u251: Bayesian expression (auto-extracted; see ref)."
