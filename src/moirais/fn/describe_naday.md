# describe('naday') — nadaraya_watson
...
`print(result)` render. See `moirais.fn.describe('naday')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.naday import *
import numpy as np
# See the function signature in fn/naday.py for argument names.
```
