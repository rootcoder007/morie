...
__all__ = ["hedderich_chapter_9_unnumbered_705"]


def hedderich_chapter_9_unnumbered_705(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X≥2|1) = 1−P (X≤2−1) = 1−P (X≤1) = 1−(0.368 + 0.368)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u705')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u705: CountModels expression (auto-extracted; see ref)."
