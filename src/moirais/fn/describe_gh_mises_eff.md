# describe('gh_mises_eff') — ghosal_mises_efficiency
...
`print(result)` render. See `moirais.fn.describe('gh_mises_eff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_mises_eff import *
import numpy as np
# See the function signature in fn/gh_mises_eff.py for argument names.
```
