...
__all__ = ["wilcox_chapter_13_unnumbered_1280"]


def wilcox_chapter_13_unnumbered_1280(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: High p21 p22 p2+ =p21 +p22
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1280')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1280: GeneralStatistics expression (auto-extracted; see ref)."
