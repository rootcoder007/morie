...
`print(result)` render. See `moirais.fn.describe('rfstud')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfstud import *
import numpy as np
# See the function signature in fn/rfstud.py for argument names.
```
