# describe('ca8u317') — ca_chapter_8_unnumbered_317
...
```python
from moirais.fn.ca8u317 import ca_chapter_8_unnumbered_317
import numpy as np
result = ca_chapter_8_unnumbered_317(np.random.default_rng(42).normal(0, 1, 100))
