# describe('hmimp') — geron_imputation_median
...
`print(result)` render. See `moirais.fn.describe('hmimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmimp import *
import numpy as np
# See the function signature in fn/hmimp.py for argument names.
```
