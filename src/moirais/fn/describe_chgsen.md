# describe('chgsen') — change_of_variance
...
`print(result)` render. See `moirais.fn.describe('chgsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chgsen import *
import numpy as np
# See the function signature in fn/chgsen.py for argument names.
```
