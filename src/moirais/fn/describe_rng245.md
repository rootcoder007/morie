# describe('rng245') — rangayyan_ch4_complex_cepstrum_decay_bound
...
`print(result)` render. See `moirais.fn.describe('rng245')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng245 import *
import numpy as np
# See the function signature in fn/rng245.py for argument names.
```
