# describe('spmrit') — schabenberger_moran_i_residuals
...
`print(result)` render. See `moirais.fn.describe('spmrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmrit import *
import numpy as np
# See the function signature in fn/spmrit.py for argument names.
```
