# describe('kgdsj') — disjunctive_kriging
...
`print(result)` render. See `moirais.fn.describe('kgdsj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgdsj import *
import numpy as np
# See the function signature in fn/kgdsj.py for argument names.
```
