...
`print(result)` render. See `moirais.fn.describe('lmslx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmslx import *
import numpy as np
# See the function signature in fn/lmslx.py for argument names.
```
