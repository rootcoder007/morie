...
`print(result)` render. See `moirais.fn.describe('bmtme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmtme import *
import numpy as np
# See the function signature in fn/bmtme.py for argument names.
```
