...
__all__ = ["bivand2013_chapter_7_unnumbered_116"]


def bivand2013_chapter_7_unnumbered_116(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: tribble(ccflag = spasthma$y, rho = RHO, covars = Hay_mat, thetas = 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u116')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u116: GeneralStatistics expression (auto-extracted; see ref)."
