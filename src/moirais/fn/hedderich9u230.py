...
__all__ = ["hedderich_chapter_9_unnumbered_230"]


def hedderich_chapter_9_unnumbered_230(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: r in % per year is present, is tcr = (230 /r) lg(Qcr/Q0); e.g. Qcr/Q0 = 25 ; r = 7% ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u230')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u230: GeneralStatistics expression (auto-extracted; see ref)."
