...
`print(result)` render. See `moirais.fn.describe('or_es')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.or_es import *
import numpy as np
# See the function signature in fn/or_es.py for argument names.
```
