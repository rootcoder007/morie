...
`print(result)` render. See `moirais.fn.describe('svytbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svytbl import *
import numpy as np
# See the function signature in fn/svytbl.py for argument names.
```
