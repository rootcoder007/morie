# describe('tmlspl') — tmle_spillover
...
`print(result)` render. See `moirais.fn.describe('tmlspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlspl import *
import numpy as np
# See the function signature in fn/tmlspl.py for argument names.
```
