# describe('gwsblc') — gwas_block_combine
...
`print(result)` render. See `moirais.fn.describe('gwsblc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwsblc import *
import numpy as np
# See the function signature in fn/gwsblc.py for argument names.
```
