...
`print(result)` render. See `moirais.fn.describe('msflp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msflp import *
import numpy as np
# See the function signature in fn/msflp.py for argument names.
```
