...
`print(result)` render. See `moirais.fn.describe('stprod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stprod import *
import numpy as np
# See the function signature in fn/stprod.py for argument names.
```
