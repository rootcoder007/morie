...
`print(result)` render. See `moirais.fn.describe('cdcosm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdcosm import *
import numpy as np
# See the function signature in fn/cdcosm.py for argument names.
```
