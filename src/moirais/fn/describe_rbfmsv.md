...
`print(result)` render. See `moirais.fn.describe('rbfmsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfmsv import *
import numpy as np
# See the function signature in fn/rbfmsv.py for argument names.
```
