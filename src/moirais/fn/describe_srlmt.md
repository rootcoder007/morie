...
`print(result)` render. See `moirais.fn.describe('srlmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srlmt import *
import numpy as np
# See the function signature in fn/srlmt.py for argument names.
```
