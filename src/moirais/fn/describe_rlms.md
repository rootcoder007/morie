...
`print(result)` render. See `moirais.fn.describe('rlms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlms import *
import numpy as np
# See the function signature in fn/rlms.py for argument names.
```
