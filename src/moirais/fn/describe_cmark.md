# describe('cmark') — causal_markov_condition
...
`print(result)` render. See `moirais.fn.describe('cmark')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmark import *
import numpy as np
# See the function signature in fn/cmark.py for argument names.
```
