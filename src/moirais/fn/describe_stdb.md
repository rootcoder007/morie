# describe('stdb') — standardized_coefficients
...
`print(result)` render. See `moirais.fn.describe('stdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdb import *
import numpy as np
# See the function signature in fn/stdb.py for argument names.
```
