...
`print(result)` render. See `moirais.fn.describe('eldiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eldiv import *
import numpy as np
# See the function signature in fn/eldiv.py for argument names.
```
