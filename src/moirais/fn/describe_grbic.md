...
`print(result)` render. See `moirais.fn.describe('grbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbic import *
import numpy as np
# See the function signature in fn/grbic.py for argument names.
```
