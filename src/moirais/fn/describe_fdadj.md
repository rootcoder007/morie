# describe('fdadj') — frontdoor_adjustment
...
`print(result)` render. See `moirais.fn.describe('fdadj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdadj import *
import numpy as np
# See the function signature in fn/fdadj.py for argument names.
```
