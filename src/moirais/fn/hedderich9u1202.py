...
__all__ = ["hedderich_chapter_9_unnumbered_1202"]


def hedderich_chapter_9_unnumbered_1202(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + z <− qnorm ( p=1− alph a/ ( 2*m) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1202')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1202: GeneralStatistics expression (auto-extracted; see ref)."
