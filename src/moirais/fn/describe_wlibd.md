...
`print(result)` render. See `moirais.fn.describe('wlibd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlibd import *
import numpy as np
# See the function signature in fn/wlibd.py for argument names.
```
