...
__all__ = ["hedderich_chapter_9_unnumbered_1805"]


def hedderich_chapter_9_unnumbered_1805(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] With ˆχ2 = 5.36 > 3.84 = ˆχ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1805')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1805: GeneralStatistics expression (auto-extracted; see ref)."
