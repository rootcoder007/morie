# describe('zectr') — contact_trace_sp
...
`print(result)` render. See `moirais.fn.describe('zectr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zectr import *
import numpy as np
# See the function signature in fn/zectr.py for argument names.
```
