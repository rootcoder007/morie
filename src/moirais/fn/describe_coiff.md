...
`print(result)` render. See `moirais.fn.describe('coiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coiff import *
import numpy as np
# See the function signature in fn/coiff.py for argument names.
```
