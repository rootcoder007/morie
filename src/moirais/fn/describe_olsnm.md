# describe('olsnm') — ols_normal_equations
...
`print(result)` render. See `moirais.fn.describe('olsnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.olsnm import *
import numpy as np
# See the function signature in fn/olsnm.py for argument names.
```
