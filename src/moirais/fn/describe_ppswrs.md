# describe('ppswrs') — pps_with_replacement
...
`print(result)` render. See `moirais.fn.describe('ppswrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppswrs import *
import numpy as np
# See the function signature in fn/ppswrs.py for argument names.
```
