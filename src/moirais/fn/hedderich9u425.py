...
__all__ = ["hedderich_chapter_9_unnumbered_425"]


def hedderich_chapter_9_unnumbered_425(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (M ) +P ( ¯M∩F ) = 0.5401 + 0.4599·0.7143 = 0.8686.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u425')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u425: GeneralStatistics expression (auto-extracted; see ref)."
