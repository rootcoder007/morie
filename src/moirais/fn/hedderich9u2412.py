...
__all__ = ["hedderich_chapter_9_unnumbered_2412"]


def hedderich_chapter_9_unnumbered_2412(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t-distribution); the quantiles forα=0.10 (0.05) andα=0.05 (0.025) two-sided (one-sided) are
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2412')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2412: GeneralStatistics expression (auto-extracted; see ref)."
