...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_95"]


def information_theory_mackay_chapter_6_unnumbered_95(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: time=sec =bytes time=sec
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u95')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u95: GeneralStatistics expression (auto-extracted; see ref)."
