...
__all__ = ["hedderich_chapter_9_unnumbered_238"]


def hedderich_chapter_9_unnumbered_238(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3rd day: 100(1 +x)2+ 100(1 + x)2x = 100(1 +x)3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u238')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u238: GeneralStatistics expression (auto-extracted; see ref)."
