# describe('jocqr') — joseph_conformalized_quantile_regression
...
`print(result)` render. See `moirais.fn.describe('jocqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jocqr import *
import numpy as np
# See the function signature in fn/jocqr.py for argument names.
```
