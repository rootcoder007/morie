# describe('gb_wsp') — gibbons_concordance_preference
...
`print(result)` render. See `moirais.fn.describe('gb_wsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wsp import *
import numpy as np
# See the function signature in fn/gb_wsp.py for argument names.
```
