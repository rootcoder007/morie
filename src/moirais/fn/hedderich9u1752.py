...
__all__ = ["hedderich_chapter_9_unnumbered_1752"]


def hedderich_chapter_9_unnumbered_1752(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] HA : π >π0 (7.40)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1752')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1752: CountModels expression (auto-extracted; see ref)."
