# describe('gefrm') — gefrm

## WHAT IT DOES

Firm density spatial
...
`print(result)` render. See `moirais.fn.describe('gefrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gefrm import *
import numpy as np
# See the function signature in fn/gefrm.py for argument names.
```
