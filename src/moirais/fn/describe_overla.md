...
`print(result)` render. See `moirais.fn.describe('overla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.overla import *
import numpy as np
# See the function signature in fn/overla.py for argument names.
```
