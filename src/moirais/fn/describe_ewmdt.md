...
`print(result)` render. See `moirais.fn.describe('ewmdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewmdt import *
import numpy as np
# See the function signature in fn/ewmdt.py for argument names.
```
