# describe('spbayr') — schabenberger_bayesian_hierarchical
...
`print(result)` render. See `moirais.fn.describe('spbayr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spbayr import *
import numpy as np
# See the function signature in fn/spbayr.py for argument names.
```
