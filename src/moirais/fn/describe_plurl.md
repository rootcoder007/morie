...
`print(result)` render. See `moirais.fn.describe('plurl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plurl import *
import numpy as np
# See the function signature in fn/plurl.py for argument names.
```
