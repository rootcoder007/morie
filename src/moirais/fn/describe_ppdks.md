# describe('ppdks') — posterior_predictive_ks
...
`print(result)` render. See `moirais.fn.describe('ppdks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppdks import *
import numpy as np
# See the function signature in fn/ppdks.py for argument names.
```
