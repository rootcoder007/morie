...
`print(result)` render. See `moirais.fn.describe('knn_i')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knn_i import *
import numpy as np
# See the function signature in fn/knn_i.py for argument names.
```
