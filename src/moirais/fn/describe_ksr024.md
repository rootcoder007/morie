# describe('ksr024') — kosorok_ch1_partly_linear_logistic
...
`print(result)` render. See `moirais.fn.describe('ksr024')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr024 import *
import numpy as np
# See the function signature in fn/ksr024.py for argument names.
```
