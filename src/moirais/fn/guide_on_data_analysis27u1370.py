...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1370"]


def guide_on_data_analysis_chapter_27_unnumbered_1370(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑌𝑖 = 𝛽0 + 𝛽1𝑋𝑖 + 𝛽2𝑋2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1370')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1370: GeneralStatistics expression (auto-extracted; see ref)."
