# describe('whtns') — white_noise_gen
...
`print(result)` render. See `moirais.fn.describe('whtns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whtns import *
import numpy as np
# See the function signature in fn/whtns.py for argument names.
```
