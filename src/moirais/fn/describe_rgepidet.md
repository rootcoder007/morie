# describe('rgepidet') — rangayyan_epilepsy_detect
...
`print(result)` render. See `moirais.fn.describe('rgepidet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgepidet import *
import numpy as np
# See the function signature in fn/rgepidet.py for argument names.
```
