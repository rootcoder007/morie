# describe('wsmgmm') — wasserman_gmm_em
...
`print(result)` render. See `moirais.fn.describe('wsmgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmgmm import *
import numpy as np
# See the function signature in fn/wsmgmm.py for argument names.
```
