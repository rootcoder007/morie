# describe('agnnbk') — alphazero_resnet_block
...
`print(result)` render. See `moirais.fn.describe('agnnbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agnnbk import *
import numpy as np
# See the function signature in fn/agnnbk.py for argument names.
```
