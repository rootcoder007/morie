...
`print(result)` render. See `moirais.fn.describe('agmaj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmaj import *
import numpy as np
# See the function signature in fn/agmaj.py for argument names.
```
