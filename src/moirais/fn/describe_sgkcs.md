# describe('sgkcs') — kriging_conditional_sim
...
`print(result)` render. See `moirais.fn.describe('sgkcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgkcs import *
import numpy as np
# See the function signature in fn/sgkcs.py for argument names.
```
