...
`print(result)` render. See `moirais.fn.describe('bluerg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bluerg import *
import numpy as np
# See the function signature in fn/bluerg.py for argument names.
```
