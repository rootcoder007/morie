# describe('hubsa') — hits_hubs_authorities
...
`print(result)` render. See `moirais.fn.describe('hubsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubsa import *
import numpy as np
# See the function signature in fn/hubsa.py for argument names.
```
