...
`print(result)` render. See `moirais.fn.describe('trsgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsgn import *
import numpy as np
# See the function signature in fn/trsgn.py for argument names.
```
