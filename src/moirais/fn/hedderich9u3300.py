...
__all__ = ["hedderich_chapter_9_unnumbered_3300"]


def hedderich_chapter_9_unnumbered_3300(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆβi±t(n−p−1),1−α/2 ˆσ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3300')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3300: GeneralStatistics expression (auto-extracted; see ref)."
