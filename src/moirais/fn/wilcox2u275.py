...
__all__ = ["wilcox_chapter_2_unnumbered_275"]


def wilcox_chapter_2_unnumbered_275(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 3. H0: µ = µ 0. Now c is the 1 − α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u275')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u275: PowerAndDesign expression (auto-extracted; see ref)."
