# describe('sgchg') — sign_change_test
...
`print(result)` render. See `moirais.fn.describe('sgchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgchg import *
import numpy as np
# See the function signature in fn/sgchg.py for argument names.
```
