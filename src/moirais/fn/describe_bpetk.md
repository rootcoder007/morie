...
`print(result)` render. See `moirais.fn.describe('bpetk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpetk import *
import numpy as np
# See the function signature in fn/bpetk.py for argument names.
```
