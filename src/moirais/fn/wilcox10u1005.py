...
__all__ = ["wilcox_chapter_10_unnumbered_1005"]


def wilcox_chapter_10_unnumbered_1005(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 4 = 20, then N1 = max(25, [4/0.2699] + 1) = 25. Hence, no
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1005')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1005: GeneralStatistics expression (auto-extracted; see ref)."
