...
`print(result)` render. See `moirais.fn.describe('idpmk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpmk import *
import numpy as np
# See the function signature in fn/idpmk.py for argument names.
```
