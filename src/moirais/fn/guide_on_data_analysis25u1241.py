...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1241"]


def guide_on_data_analysis_chapter_25_unnumbered_1241(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 0.96829, p-value = 0.5794
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1241')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1241: GeneralStatistics expression (auto-extracted; see ref)."
