# describe('selbf') — selection_bias_factor

## WHAT IT DOES

Selection bias factor. 'The whole is greater than the sum of its parts. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('selbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.selbf import *
import numpy as np
# See the function signature in fn/selbf.py for argument names.
```
