...
`print(result)` render. See `moirais.fn.describe('bymds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bymds import *
import numpy as np
# See the function signature in fn/bymds.py for argument names.
```
