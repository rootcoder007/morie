...
`print(result)` render. See `moirais.fn.describe('warpL')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.warpL import *
import numpy as np
# See the function signature in fn/warpL.py for argument names.
```
