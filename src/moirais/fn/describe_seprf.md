...
`print(result)` render. See `moirais.fn.describe('seprf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seprf import *
import numpy as np
# See the function signature in fn/seprf.py for argument names.
```
