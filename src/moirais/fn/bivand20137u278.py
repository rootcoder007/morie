...
__all__ = ["bivand2013_chapter_7_unnumbered_278"]


def bivand2013_chapter_7_unnumbered_278(x):
    """
    ContingencyTables expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u278')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u278: ContingencyTables expression (auto-extracted; see ref)."
