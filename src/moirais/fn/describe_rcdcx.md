...
`print(result)` render. See `moirais.fn.describe('rcdcx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdcx import *
import numpy as np
# See the function signature in fn/rcdcx.py for argument names.
```
