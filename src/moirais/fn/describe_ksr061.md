# describe('ksr061') — kosorok_ch3_differentiable_quadratic_mean
...
`print(result)` render. See `moirais.fn.describe('ksr061')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr061 import *
import numpy as np
# See the function signature in fn/ksr061.py for argument names.
```
