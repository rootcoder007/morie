...
`print(result)` render. See `moirais.fn.describe('psvot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psvot import *
import numpy as np
# See the function signature in fn/psvot.py for argument names.
```
