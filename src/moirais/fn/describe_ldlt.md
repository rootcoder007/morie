...
`print(result)` render. See `moirais.fn.describe('ldlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldlt import *
import numpy as np
# See the function signature in fn/ldlt.py for argument names.
```
