...
__all__ = ["hedderich_chapter_9_unnumbered_3461"]


def hedderich_chapter_9_unnumbered_3461(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : log nπijk =µ+λX
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3461')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3461: GeneralStatistics expression (auto-extracted; see ref)."
