...
__all__ = ["hedderich_chapter_9_unnumbered_2148"]


def hedderich_chapter_9_unnumbered_2148(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] d=0.5; P(X>Y)=0.64
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2148')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2148: GeneralStatistics expression (auto-extracted; see ref)."
