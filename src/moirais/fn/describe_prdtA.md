# describe('prdtA') — prefix_evaluation
...
`print(result)` render. See `moirais.fn.describe('prdtA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdtA import *
import numpy as np
# See the function signature in fn/prdtA.py for argument names.
```
