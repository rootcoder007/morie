...
`print(result)` render. See `moirais.fn.describe('gmm2s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmm2s import *
import numpy as np
# See the function signature in fn/gmm2s.py for argument names.
```
