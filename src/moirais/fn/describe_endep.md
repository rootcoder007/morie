...
`print(result)` render. See `moirais.fn.describe('endep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.endep import *
import numpy as np
# See the function signature in fn/endep.py for argument names.
```
