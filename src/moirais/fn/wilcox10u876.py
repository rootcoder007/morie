...
__all__ = ["wilcox_chapter_10_unnumbered_876"]


def wilcox_chapter_10_unnumbered_876(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: FactorA, ℓ =J − 1, for Factor B, ℓ =K − 1, and for interactions, ℓ = (J − 1)(K − 1).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u876')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u876: GeneralStatistics expression (auto-extracted; see ref)."
