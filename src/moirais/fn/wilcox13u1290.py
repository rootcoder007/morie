...
__all__ = ["wilcox_chapter_13_unnumbered_1290"]


def wilcox_chapter_13_unnumbered_1290(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1290')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1290: GeneralStatistics expression (auto-extracted; see ref)."
