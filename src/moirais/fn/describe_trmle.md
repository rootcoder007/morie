...
`print(result)` render. See `moirais.fn.describe('trmle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmle import *
import numpy as np
# See the function signature in fn/trmle.py for argument names.
```
