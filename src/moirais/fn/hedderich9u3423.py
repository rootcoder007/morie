...
__all__ = ["hedderich_chapter_9_unnumbered_3423"]


def hedderich_chapter_9_unnumbered_3423(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: E[Yjk ] = µjk =cjk·λjk ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3423')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3423: CountModels expression (auto-extracted; see ref)."
