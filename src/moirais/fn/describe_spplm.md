...
`print(result)` render. See `moirais.fn.describe('spplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spplm import *
import numpy as np
# See the function signature in fn/spplm.py for argument names.
```
