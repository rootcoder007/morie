# describe('gcplx') — gaussian_complexity
...
`print(result)` render. See `moirais.fn.describe('gcplx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcplx import *
import numpy as np
# See the function signature in fn/gcplx.py for argument names.
```
