...
`print(result)` render. See `moirais.fn.describe('gracif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gracif import *
import numpy as np
# See the function signature in fn/gracif.py for argument names.
```
