...
`print(result)` render. See `moirais.fn.describe('tdual')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdual import *
import numpy as np
# See the function signature in fn/tdual.py for argument names.
```
