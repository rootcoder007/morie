...
`print(result)` render. See `moirais.fn.describe('samob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samob import *
import numpy as np
# See the function signature in fn/samob.py for argument names.
```
