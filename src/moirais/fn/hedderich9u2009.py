...
__all__ = ["hedderich_chapter_9_unnumbered_2009"]


def hedderich_chapter_9_unnumbered_2009(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] = |¯x1−¯x2|√[n1+n2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2009')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2009: PowerAndDesign expression (auto-extracted; see ref)."
