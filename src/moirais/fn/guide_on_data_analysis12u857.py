...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_857"]


def guide_on_data_analysis_chapter_12_unnumbered_857(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] good = sum(credit == 1),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u857')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u857: GeneralStatistics expression (auto-extracted; see ref)."
