...
`print(result)` render. See `moirais.fn.describe('frdmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frdmt import *
import numpy as np
# See the function signature in fn/frdmt.py for argument names.
```
