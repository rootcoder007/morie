# describe('dimens') — stout_dimensionality
...
`print(result)` render. See `moirais.fn.describe('dimens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dimens import *
import numpy as np
# See the function signature in fn/dimens.py for argument names.
```
