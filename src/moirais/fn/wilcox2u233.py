...
__all__ = ["wilcox_chapter_2_unnumbered_233"]


def wilcox_chapter_2_unnumbered_233(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ¯X = 185, (c) n = 50, σ = 30, ¯X = 19, compute a 0.95 confidence interval for the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u233')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u233: GeneralStatistics expression (auto-extracted; see ref)."
