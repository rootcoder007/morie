...
`print(result)` render. See `moirais.fn.describe('lll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lll import *
import numpy as np
# See the function signature in fn/lll.py for argument names.
```
