...
__all__ = ["wilcox_chapter_7_unnumbered_361"]


def wilcox_chapter_7_unnumbered_361(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] (ℓ) = −1.94 and −T ∗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u361')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u361: Resampling expression (auto-extracted; see ref)."
