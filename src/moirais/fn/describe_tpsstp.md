# describe('tpsstp') — tps_stop_and_search
...
`print(result)` render. See `moirais.fn.describe('tpsstp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsstp import *
import numpy as np
# See the function signature in fn/tpsstp.py for argument names.
```
