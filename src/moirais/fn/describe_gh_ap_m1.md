# describe('gh_ap_m1') — ghosal_mh_sampler
...
`print(result)` render. See `moirais.fn.describe('gh_ap_m1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_m1 import *
import numpy as np
# See the function signature in fn/gh_ap_m1.py for argument names.
```
