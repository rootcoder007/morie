...
`print(result)` render. See `moirais.fn.describe('lotka')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lotka import *
import numpy as np
# See the function signature in fn/lotka.py for argument names.
```
