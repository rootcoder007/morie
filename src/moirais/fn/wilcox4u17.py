...
__all__ = ["wilcox_chapter_4_unnumbered_17"]


def wilcox_chapter_4_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] q1 = (1 − 0.41667)(−19 .7) + 0.41667(−15 .4) = −17 .9.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u17')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u17: GeneralStatistics expression (auto-extracted; see ref)."
