...
`print(result)` render. See `moirais.fn.describe('adf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adf import *
import numpy as np
# See the function signature in fn/adf.py for argument names.
```
