...
`print(result)` render. See `moirais.fn.describe('hyhyd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyhyd import *
import numpy as np
# See the function signature in fn/hyhyd.py for argument names.
```
