# describe('blkbt') — blackbox_scaling_basic
...
`print(result)` render. See `moirais.fn.describe('blkbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blkbt import *
import numpy as np
# See the function signature in fn/blkbt.py for argument names.
```
