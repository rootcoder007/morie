...
__all__ = ["hedderich_chapter_9_unnumbered_2135"]


def hedderich_chapter_9_unnumbered_2135(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: receives the rank number (12 + 13 + 14)/3 = 13 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2135')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2135: GeneralStatistics expression (auto-extracted; see ref)."
