...
`print(result)` render. See `moirais.fn.describe('gatpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatpi import *
import numpy as np
# See the function signature in fn/gatpi.py for argument names.
```
