...
`print(result)` render. See `moirais.fn.describe('brtmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brtmh import *
import numpy as np
# See the function signature in fn/brtmh.py for argument names.
```
