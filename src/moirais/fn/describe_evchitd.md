# describe('evchitd') — evt_chi_tail_dependence
...
`print(result)` render. See `moirais.fn.describe('evchitd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evchitd import *
import numpy as np
# See the function signature in fn/evchitd.py for argument names.
```
