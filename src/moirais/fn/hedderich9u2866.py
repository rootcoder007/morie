...
__all__ = ["hedderich_chapter_9_unnumbered_2866"]


def hedderich_chapter_9_unnumbered_2866(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If a 95% confidence interval includes zero, then H0:πi =πi′cannot be rejected at the 5% level,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2866')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2866: GeneralStatistics expression (auto-extracted; see ref)."
