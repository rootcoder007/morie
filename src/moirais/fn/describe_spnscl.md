# describe('spnscl') — schabenberger_neyman_scott
...
`print(result)` render. See `moirais.fn.describe('spnscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spnscl import *
import numpy as np
# See the function signature in fn/spnscl.py for argument names.
```
