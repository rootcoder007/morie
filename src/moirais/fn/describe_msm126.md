# describe('msm126') — mvsml_categorical_count_eq_8_2
...
`print(result)` render. See `moirais.fn.describe('msm126')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm126 import *
import numpy as np
# See the function signature in fn/msm126.py for argument names.
```
