# describe('kchnls') — k_l_divergence_chain
...
`print(result)` render. See `moirais.fn.describe('kchnls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kchnls import *
import numpy as np
# See the function signature in fn/kchnls.py for argument names.
```
