# describe('rgseiz') — rangayyan_seizure_detect
...
`print(result)` render. See `moirais.fn.describe('rgseiz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgseiz import *
import numpy as np
# See the function signature in fn/rgseiz.py for argument names.
```
