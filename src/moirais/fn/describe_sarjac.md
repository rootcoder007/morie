...
`print(result)` render. See `moirais.fn.describe('sarjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarjac import *
import numpy as np
# See the function signature in fn/sarjac.py for argument names.
```
