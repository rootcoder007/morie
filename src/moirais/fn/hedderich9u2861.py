...
__all__ = ["hedderich_chapter_9_unnumbered_2861"]


def hedderich_chapter_9_unnumbered_2861(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 = N 2[b3(a1 +a2)−a3(b1 +b2)]2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2861')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2861: GeneralStatistics expression (auto-extracted; see ref)."
