...
`print(result)` render. See `moirais.fn.describe('gcprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcprm import *
import numpy as np
# See the function signature in fn/gcprm.py for argument names.
```
