# describe('zxsle') — spatial_elastic
...
`print(result)` render. See `moirais.fn.describe('zxsle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsle import *
import numpy as np
# See the function signature in fn/zxsle.py for argument names.
```
