# describe('susngl') — single_use_risk
...
`print(result)` render. See `moirais.fn.describe('susngl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.susngl import *
import numpy as np
# See the function signature in fn/susngl.py for argument names.
```
