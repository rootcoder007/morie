# describe('calib') — calibration_curve
...
`print(result)` render. See `moirais.fn.describe('calib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.calib import *
import numpy as np
# See the function signature in fn/calib.py for argument names.
```
