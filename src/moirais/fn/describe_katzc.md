# describe('katzc') — katz_centrality
...
`print(result)` render. See `moirais.fn.describe('katzc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.katzc import *
import numpy as np
# See the function signature in fn/katzc.py for argument names.
```
