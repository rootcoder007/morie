...
__all__ = ["wilcox_chapter_14_unnumbered_776"]


def wilcox_chapter_14_unnumbered_776(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µ 11 − µ 12 ̸=µ 21 − µ 22.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u776')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u776: GeneralStatistics expression (auto-extracted; see ref)."
