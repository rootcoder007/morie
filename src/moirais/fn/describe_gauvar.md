# describe('gauvar') — gaussian_variogram_model
...
`print(result)` render. See `moirais.fn.describe('gauvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gauvar import *
import numpy as np
# See the function signature in fn/gauvar.py for argument names.
```
