...
__all__ = ["hedderich_chapter_9_unnumbered_3400"]


def hedderich_chapter_9_unnumbered_3400(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] + { sum ( p . h >= tcut & x == 1 ) / sum ( x == 1 ) } )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3400')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3400: CountModels expression (auto-extracted; see ref)."
