...
`print(result)` render. See `moirais.fn.describe('bgsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgsim import *
import numpy as np
# See the function signature in fn/bgsim.py for argument names.
```
