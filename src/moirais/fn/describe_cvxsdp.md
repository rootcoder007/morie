...
`print(result)` render. See `moirais.fn.describe('cvxsdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsdp import *
import numpy as np
# See the function signature in fn/cvxsdp.py for argument names.
```
