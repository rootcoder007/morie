...
`print(result)` render. See `moirais.fn.describe('cszon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cszon import *
import numpy as np
# See the function signature in fn/cszon.py for argument names.
```
