...
`print(result)` render. See `moirais.fn.describe('plbdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plbdn import *
import numpy as np
# See the function signature in fn/plbdn.py for argument names.
```
