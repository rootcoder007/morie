# describe('sdscr') — subscale_discriminant
...
`print(result)` render. See `moirais.fn.describe('sdscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdscr import *
import numpy as np
# See the function signature in fn/sdscr.py for argument names.
```
