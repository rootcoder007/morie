...
__all__ = ["wilcox_chapter_14_unnumbered_442"]


def wilcox_chapter_14_unnumbered_442(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Let ¯h = ∑hii/n, eii = hii/ ¯h, and dii = min(4,e ii). Let A
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u442')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u442: GeneralStatistics expression (auto-extracted; see ref)."
