# describe('bic2b') — bayes_factor_bic
...
`print(result)` render. See `moirais.fn.describe('bic2b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bic2b import *
import numpy as np
# See the function signature in fn/bic2b.py for argument names.
```
