# describe('rgeqn5b') — rangayyan_ch5_waveform_length
...
`print(result)` render. See `moirais.fn.describe('rgeqn5b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn5b import *
import numpy as np
# See the function signature in fn/rgeqn5b.py for argument names.
```
