...
`print(result)` render. See `moirais.fn.describe('gh2sf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh2sf import *
import numpy as np
# See the function signature in fn/gh2sf.py for argument names.
```
