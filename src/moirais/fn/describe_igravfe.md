...
`print(result)` render. See `moirais.fn.describe('igravfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravfe import *
import numpy as np
# See the function signature in fn/igravfe.py for argument names.
```
