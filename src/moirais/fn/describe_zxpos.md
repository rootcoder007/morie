# describe('zxpos') — possibilistic_sp
...
`print(result)` render. See `moirais.fn.describe('zxpos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxpos import *
import numpy as np
# See the function signature in fn/zxpos.py for argument names.
```
