...
`print(result)` render. See `moirais.fn.describe('ovrla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ovrla import *
import numpy as np
# See the function signature in fn/ovrla.py for argument names.
```
