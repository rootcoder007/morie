...
__all__ = ["wilcox_chapter_7_unnumbered_341"]


def wilcox_chapter_7_unnumbered_341(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rejected if Tt ≥ c, where now c is the 1 − α quantile of Student’s T distribution with n− 2g − 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u341')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u341: GeneralStatistics expression (auto-extracted; see ref)."
