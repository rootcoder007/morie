...
`print(result)` render. See `moirais.fn.describe('seclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclm import *
import numpy as np
# See the function signature in fn/seclm.py for argument names.
```
