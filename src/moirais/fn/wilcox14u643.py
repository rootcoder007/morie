...
__all__ = ["wilcox_chapter_14_unnumbered_643"]


def wilcox_chapter_14_unnumbered_643(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] R2 = −3, R3 = 5, R4 = 2, and R5 = −1, then
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u643')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u643: PowerAndDesign expression (auto-extracted; see ref)."
