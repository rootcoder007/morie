...
__all__ = ["wilcox_chapter_13_unnumbered_1107"]


def wilcox_chapter_13_unnumbered_1107(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: function regci, the 0.95 confidence intervals for β 1 andβ 3 are (−0.28 , 5.93) and ( −2.3, 3.9),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1107')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1107: GeneralStatistics expression (auto-extracted; see ref)."
