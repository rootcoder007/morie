...
`print(result)` render. See `moirais.fn.describe('agcyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcyc import *
import numpy as np
# See the function signature in fn/agcyc.py for argument names.
```
