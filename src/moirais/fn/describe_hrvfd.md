# describe('hrvfd') — hrv_freq_domain
...
`print(result)` render. See `moirais.fn.describe('hrvfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrvfd import *
import numpy as np
# See the function signature in fn/hrvfd.py for argument names.
```
