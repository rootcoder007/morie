...
`print(result)` render. See `moirais.fn.describe('mtcps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcps import *
import numpy as np
# See the function signature in fn/mtcps.py for argument names.
```
