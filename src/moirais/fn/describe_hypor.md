...
`print(result)` render. See `moirais.fn.describe('hypor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hypor import *
import numpy as np
# See the function signature in fn/hypor.py for argument names.
```
