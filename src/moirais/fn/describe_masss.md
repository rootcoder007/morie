...
`print(result)` render. See `moirais.fn.describe('masss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masss import *
import numpy as np
# See the function signature in fn/masss.py for argument names.
```
