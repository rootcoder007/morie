...
__all__ = ["hedderich_chapter_9_unnumbered_915"]


def hedderich_chapter_9_unnumbered_915(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] δexp(−z−exp(−z))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u915')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u915: GeneralStatistics expression (auto-extracted; see ref)."
