...
`print(result)` render. See `moirais.fn.describe('kstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kstst import *
import numpy as np
# See the function signature in fn/kstst.py for argument names.
```
