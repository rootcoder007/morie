...
`print(result)` render. See `moirais.fn.describe('l1min')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.l1min import *
import numpy as np
# See the function signature in fn/l1min.py for argument names.
```
