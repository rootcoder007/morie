...
`print(result)` render. See `moirais.fn.describe('rceps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rceps import *
import numpy as np
# See the function signature in fn/rceps.py for argument names.
```
