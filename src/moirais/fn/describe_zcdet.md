# describe('zcdet') — zero_cross_detect
...
`print(result)` render. See `moirais.fn.describe('zcdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zcdet import *
import numpy as np
# See the function signature in fn/zcdet.py for argument names.
```
