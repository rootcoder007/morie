...
`print(result)` render. See `moirais.fn.describe('gptq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gptq import *
import numpy as np
# See the function signature in fn/gptq.py for argument names.
```
