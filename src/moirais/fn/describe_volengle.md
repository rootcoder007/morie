# describe('volengle') — vol_engle_lagrange
...
`print(result)` render. See `moirais.fn.describe('volengle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volengle import *
import numpy as np
# See the function signature in fn/volengle.py for argument names.
```
