...
__all__ = ["hedderich_chapter_9_unnumbered_2453"]


def hedderich_chapter_9_unnumbered_2453(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Fork = 3 andn1 =n2 =n3 =n, the 5% limits for n = 6 (7; 8) are given by the value 5.8 [5.801;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2453')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2453: GeneralStatistics expression (auto-extracted; see ref)."
