...
__all__ = ["hedderich_chapter_9_unnumbered_1907"]


def hedderich_chapter_9_unnumbered_1907(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X≥16|100·0.10) = 1−P (X≤15|100·0.10) = 0.0487
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1907')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1907: GeneralStatistics expression (auto-extracted; see ref)."
