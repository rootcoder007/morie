# describe('grprn') — geron_weight_pruning
...
`print(result)` render. See `moirais.fn.describe('grprn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grprn import *
import numpy as np
# See the function signature in fn/grprn.py for argument names.
```
