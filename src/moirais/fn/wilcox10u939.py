...
__all__ = ["wilcox_chapter_10_unnumbered_939"]


def wilcox_chapter_10_unnumbered_939(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3, (C − k + 1)α/C = 4(0.05)/6 = 0 .0333, and because P[3] = 0.015 ≤ 0.0333, reject this
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u939')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u939: GeneralStatistics expression (auto-extracted; see ref)."
