...
`print(result)` render. See `moirais.fn.describe('ppsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppsts import *
import numpy as np
# See the function signature in fn/ppsts.py for argument names.
```
