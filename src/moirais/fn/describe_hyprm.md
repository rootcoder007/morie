...
`print(result)` render. See `moirais.fn.describe('hyprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyprm import *
import numpy as np
# See the function signature in fn/hyprm.py for argument names.
```
