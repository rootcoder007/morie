...
`print(result)` render. See `moirais.fn.describe('socec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.socec import *
import numpy as np
# See the function signature in fn/socec.py for argument names.
```
