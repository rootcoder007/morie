# describe('agpuct') — alphazero_puct
...
`print(result)` render. See `moirais.fn.describe('agpuct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agpuct import *
import numpy as np
# See the function signature in fn/agpuct.py for argument names.
```
