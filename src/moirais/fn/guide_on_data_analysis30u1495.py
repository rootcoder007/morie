...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1495"]


def guide_on_data_analysis_chapter_30_unnumbered_1495(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -4 x cohort = 5 -0.98 (0.63)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1495')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1495: GeneralStatistics expression (auto-extracted; see ref)."
