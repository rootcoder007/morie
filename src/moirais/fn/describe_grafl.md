# describe('grafl') — graphlet_kernel
...
`print(result)` render. See `moirais.fn.describe('grafl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grafl import *
import numpy as np
# See the function signature in fn/grafl.py for argument names.
```
