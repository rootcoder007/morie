...
__all__ = ["use_r_chapter_2_unnumbered_117"]


def use_r_chapter_2_unnumbered_117(x):
    """
    Spatial expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u117')`` for the full guide.
...
def cheatsheet():
    return "use_r2u117: Spatial expression (auto-extracted; see ref)."
