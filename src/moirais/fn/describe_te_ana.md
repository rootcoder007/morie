# describe('te_ana') — _prepare_analysis_frame
...
`print(result)` render. See `moirais.fn.describe('te_ana')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.te_ana import *
import numpy as np
# See the function signature in fn/te_ana.py for argument names.
```
