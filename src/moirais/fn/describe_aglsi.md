...
`print(result)` render. See `moirais.fn.describe('aglsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aglsi import *
import numpy as np
# See the function signature in fn/aglsi.py for argument names.
```
