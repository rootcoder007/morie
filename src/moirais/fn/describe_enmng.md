...
`print(result)` render. See `moirais.fn.describe('enmng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enmng import *
import numpy as np
# See the function signature in fn/enmng.py for argument names.
```
