...
`print(result)` render. See `moirais.fn.describe('cvxmnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxmnr import *
import numpy as np
# See the function signature in fn/cvxmnr.py for argument names.
```
