...
__all__ = ["wilcox_chapter_14_unnumbered_535"]


def wilcox_chapter_14_unnumbered_535(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t.test(x, y = NULL,var.equal=FALSE,conf.level=0.95)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u535')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u535: GeneralStatistics expression (auto-extracted; see ref)."
