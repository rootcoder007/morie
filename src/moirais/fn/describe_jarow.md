...
`print(result)` render. See `moirais.fn.describe('jarow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jarow import *
import numpy as np
# See the function signature in fn/jarow.py for argument names.
```
