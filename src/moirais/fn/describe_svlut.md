...
`print(result)` render. See `moirais.fn.describe('svlut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlut import *
import numpy as np
# See the function signature in fn/svlut.py for argument names.
```
