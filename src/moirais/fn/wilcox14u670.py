...
__all__ = ["wilcox_chapter_14_unnumbered_670"]


def wilcox_chapter_14_unnumbered_670(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The degrees of freedom are ν 1 = 3 − 1 = 2 and ν 2 = 30 − 3 = 27. With α = 0.01, we see
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u670')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u670: GeneralStatistics expression (auto-extracted; see ref)."
