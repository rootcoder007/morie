# describe('rng144') — rangayyan_ch3_mse_gradient
...
`print(result)` render. See `moirais.fn.describe('rng144')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng144 import *
import numpy as np
# See the function signature in fn/rng144.py for argument names.
```
