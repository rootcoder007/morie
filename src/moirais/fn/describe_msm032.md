# describe('msm032') — mvsml_linear_mixed_models_eq_5_6
...
`print(result)` render. See `moirais.fn.describe('msm032')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm032 import *
import numpy as np
# See the function signature in fn/msm032.py for argument names.
```
