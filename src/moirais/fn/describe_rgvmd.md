...
`print(result)` render. See `moirais.fn.describe('rgvmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvmd import *
import numpy as np
# See the function signature in fn/rgvmd.py for argument names.
```
