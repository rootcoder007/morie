...
`print(result)` render. See `moirais.fn.describe('ubbke')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubbke import *
import numpy as np
# See the function signature in fn/ubbke.py for argument names.
```
