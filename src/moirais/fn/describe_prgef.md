...
`print(result)` render. See `moirais.fn.describe('prgef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgef import *
import numpy as np
# See the function signature in fn/prgef.py for argument names.
```
