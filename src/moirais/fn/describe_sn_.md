...
`print(result)` render. See `moirais.fn.describe('sn_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sn_ import *
import numpy as np
# See the function signature in fn/sn_.py for argument names.
```
