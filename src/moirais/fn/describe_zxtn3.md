...
`print(result)` render. See `moirais.fn.describe('zxtn3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxtn3 import *
import numpy as np
# See the function signature in fn/zxtn3.py for argument names.
```
