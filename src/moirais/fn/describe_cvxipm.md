# describe('cvxipm') — boyd_interior_point
...
`print(result)` render. See `moirais.fn.describe('cvxipm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxipm import *
import numpy as np
# See the function signature in fn/cvxipm.py for argument names.
```
