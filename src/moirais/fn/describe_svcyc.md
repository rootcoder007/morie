# describe('svcyc') — condorcet_cycle
...
`print(result)` render. See `moirais.fn.describe('svcyc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcyc import *
import numpy as np
# See the function signature in fn/svcyc.py for argument names.
```
