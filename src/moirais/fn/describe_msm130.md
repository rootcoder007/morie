# describe('msm130') — mvsml_categorical_count_eq_8_3
...
`print(result)` render. See `moirais.fn.describe('msm130')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm130 import *
import numpy as np
# See the function signature in fn/msm130.py for argument names.
```
