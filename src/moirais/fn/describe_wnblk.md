# describe('wnblk') — blackman_window
...
`print(result)` render. See `moirais.fn.describe('wnblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnblk import *
import numpy as np
# See the function signature in fn/wnblk.py for argument names.
```
