...
__all__ = ["wilcox_chapter_14_unnumbered_665"]


def wilcox_chapter_14_unnumbered_665(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: SST = 3026 − 2902/30 = 222 .67,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u665')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u665: GeneralStatistics expression (auto-extracted; see ref)."
