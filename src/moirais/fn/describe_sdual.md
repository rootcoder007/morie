...
`print(result)` render. See `moirais.fn.describe('sdual')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdual import *
import numpy as np
# See the function signature in fn/sdual.py for argument names.
```
