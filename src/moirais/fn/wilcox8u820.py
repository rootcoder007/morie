...
__all__ = ["wilcox_chapter_8_unnumbered_820"]


def wilcox_chapter_8_unnumbered_820(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] θ (J−1)K +1 θ (J−1)K +2 · · · θ JK
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u820')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u820: Resampling expression (auto-extracted; see ref)."
