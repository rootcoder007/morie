# describe('fzgkde') — fauzi_gamma_kde
...
`print(result)` render. See `moirais.fn.describe('fzgkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzgkde import *
import numpy as np
# See the function signature in fn/fzgkde.py for argument names.
```
