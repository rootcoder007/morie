# describe('lgobj') — logistic_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('lgobj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgobj import *
import numpy as np
# See the function signature in fn/lgobj.py for argument names.
```
