...
`print(result)` render. See `moirais.fn.describe('cvxntn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxntn import *
import numpy as np
# See the function signature in fn/cvxntn.py for argument names.
```
