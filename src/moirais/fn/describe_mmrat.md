# describe('mmrat') — maternal_mortality_ratio
...
`print(result)` render. See `moirais.fn.describe('mmrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmrat import *
import numpy as np
# See the function signature in fn/mmrat.py for argument names.
```
