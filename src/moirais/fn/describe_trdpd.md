# describe('trdpd') — tree_depth_saturation
...
`print(result)` render. See `moirais.fn.describe('trdpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdpd import *
import numpy as np
# See the function signature in fn/trdpd.py for argument names.
```
