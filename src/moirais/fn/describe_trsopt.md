# describe('trsopt') — trust_region_subproblem
...
`print(result)` render. See `moirais.fn.describe('trsopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsopt import *
import numpy as np
# See the function signature in fn/trsopt.py for argument names.
```
