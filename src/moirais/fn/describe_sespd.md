...
`print(result)` render. See `moirais.fn.describe('sespd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sespd import *
import numpy as np
# See the function signature in fn/sespd.py for argument names.
```
