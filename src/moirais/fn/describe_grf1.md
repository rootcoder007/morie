...
`print(result)` render. See `moirais.fn.describe('grf1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grf1 import *
import numpy as np
# See the function signature in fn/grf1.py for argument names.
```
