...
__all__ = ["hedderich_chapter_9_unnumbered_1773"]


def hedderich_chapter_9_unnumbered_1773(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i.e. x = 30 > 27.08 = x0,H01 is rejected at the 5% level for a one-sided question.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1773')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1773: GeneralStatistics expression (auto-extracted; see ref)."
