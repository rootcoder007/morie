...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_11_unnumbered_48(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r11u48')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r11u48: CentralTendency expression (auto-extracted; see ref)."
