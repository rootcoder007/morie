# describe('sgqag') — quadrat_aggregation
...
`print(result)` render. See `moirais.fn.describe('sgqag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgqag import *
import numpy as np
# See the function signature in fn/sgqag.py for argument names.
```
