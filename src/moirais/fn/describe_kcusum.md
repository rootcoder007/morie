...
`print(result)` render. See `moirais.fn.describe('kcusum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kcusum import *
import numpy as np
# See the function signature in fn/kcusum.py for argument names.
```
