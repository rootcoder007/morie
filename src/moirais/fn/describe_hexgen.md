...
`print(result)` render. See `moirais.fn.describe('hexgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hexgen import *
import numpy as np
# See the function signature in fn/hexgen.py for argument names.
```
