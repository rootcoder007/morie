...
`print(result)` render. See `moirais.fn.describe('stvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stvar import *
import numpy as np
# See the function signature in fn/stvar.py for argument names.
```
