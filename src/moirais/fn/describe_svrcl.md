# describe('svrcl') — roll_call_logit
...
`print(result)` render. See `moirais.fn.describe('svrcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrcl import *
import numpy as np
# See the function signature in fn/svrcl.py for argument names.
```
