# describe('hotdk') — hot_deck_impute
...
`print(result)` render. See `moirais.fn.describe('hotdk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotdk import *
import numpy as np
# See the function signature in fn/hotdk.py for argument names.
```
