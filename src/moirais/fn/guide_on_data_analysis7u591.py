...
__all__ = ["guide_on_data_analysis_chapter_7_unnumbered_591"]


def guide_on_data_analysis_chapter_7_unnumbered_591(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: X′V−1y = X′V−1X ̂ ￿
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis7u591')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis7u591: GeneralStatistics expression (auto-extracted; see ref)."
