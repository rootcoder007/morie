...
__all__ = ["hedderich_chapter_9_unnumbered_2505"]


def hedderich_chapter_9_unnumbered_2505(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Jonckheere − Terpstratest : statistic = 2 . 2 7 2 P = 0 . 0 1 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2505')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2505: GeneralStatistics expression (auto-extracted; see ref)."
