# describe('bgcls') — bagging_classify
...
`print(result)` render. See `moirais.fn.describe('bgcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgcls import *
import numpy as np
# See the function signature in fn/bgcls.py for argument names.
```
