# describe('hmlcv') — geron_learning_curves
...
`print(result)` render. See `moirais.fn.describe('hmlcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlcv import *
import numpy as np
# See the function signature in fn/hmlcv.py for argument names.
```
