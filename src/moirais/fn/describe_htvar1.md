...
`print(result)` render. See `moirais.fn.describe('htvar1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htvar1 import *
import numpy as np
# See the function signature in fn/htvar1.py for argument names.
```
