# describe('fapca') — factor_pca_compare
...
`print(result)` render. See `moirais.fn.describe('fapca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fapca import *
import numpy as np
# See the function signature in fn/fapca.py for argument names.
```
