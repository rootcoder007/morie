# describe('km023') — kamath_ch2_rtd_loss
...
`print(result)` render. See `moirais.fn.describe('km023')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km023 import *
import numpy as np
# See the function signature in fn/km023.py for argument names.
```
