# describe('yarn') — yarn_context_scaling
...
`print(result)` render. See `moirais.fn.describe('yarn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yarn import *
import numpy as np
# See the function signature in fn/yarn.py for argument names.
```
