...
`print(result)` render. See `moirais.fn.describe('alrt3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrt3 import *
import numpy as np
# See the function signature in fn/alrt3.py for argument names.
```
