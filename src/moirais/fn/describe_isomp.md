# describe('isomp') — isomap

## WHAT IT DOES

Isomap embedding. 'Truly wonderful the mind of a child is.'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('isomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isomp import *
import numpy as np
# See the function signature in fn/isomp.py for argument names.
```
