# describe('bpgtr') — breusch_pagan_test
...
`print(result)` render. See `moirais.fn.describe('bpgtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpgtr import *
import numpy as np
# See the function signature in fn/bpgtr.py for argument names.
```
