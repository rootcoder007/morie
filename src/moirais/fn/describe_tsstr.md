...
`print(result)` render. See `moirais.fn.describe('tsstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstr import *
import numpy as np
# See the function signature in fn/tsstr.py for argument names.
```
