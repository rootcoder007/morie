...
__all__ = ["hedderich_chapter_9_unnumbered_1235"]


def hedderich_chapter_9_unnumbered_1235(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 9·(Observed + 1) + z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1235')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1235: GeneralStatistics expression (auto-extracted; see ref)."
