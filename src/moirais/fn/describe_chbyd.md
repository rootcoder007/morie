...
`print(result)` render. See `moirais.fn.describe('chbyd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chbyd import *
import numpy as np
# See the function signature in fn/chbyd.py for argument names.
```
