# describe('wilcox7u306') — wilcox_chapter_7_unnumbered_306
...
```python
from moirais.fn.wilcox7u306 import wilcox_chapter_7_unnumbered_306
import numpy as np
result = wilcox_chapter_7_unnumbered_306(np.random.default_rng(42).normal(0, 1, 100))
