...
__all__ = ["hedderich_chapter_9_unnumbered_2141"]


def hedderich_chapter_9_unnumbered_2141(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + distribution = " exact " , conf . i n t = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2141')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2141: GeneralStatistics expression (auto-extracted; see ref)."
