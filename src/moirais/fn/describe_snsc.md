...
`print(result)` render. See `moirais.fn.describe('snsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snsc import *
import numpy as np
# See the function signature in fn/snsc.py for argument names.
```
