...
`print(result)` render. See `moirais.fn.describe('ridgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ridgs import *
import numpy as np
# See the function signature in fn/ridgs.py for argument names.
```
