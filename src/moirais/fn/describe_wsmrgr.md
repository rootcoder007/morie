# describe('wsmrgr') — wasserman_ridge
...
`print(result)` render. See `moirais.fn.describe('wsmrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmrgr import *
import numpy as np
# See the function signature in fn/wsmrgr.py for argument names.
```
