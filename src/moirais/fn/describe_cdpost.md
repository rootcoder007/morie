...
`print(result)` render. See `moirais.fn.describe('cdpost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdpost import *
import numpy as np
# See the function signature in fn/cdpost.py for argument names.
```
