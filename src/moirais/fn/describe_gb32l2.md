# describe('gb32l2') — gibbons_vandermonde_id1
...
`print(result)` render. See `moirais.fn.describe('gb32l2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32l2 import *
import numpy as np
# See the function signature in fn/gb32l2.py for argument names.
```
