...
__all__ = ["hedderich_chapter_9_unnumbered_2904"]


def hedderich_chapter_9_unnumbered_2904(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =5.220>5.024=χ1−0.05/2;ν=1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2904')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2904: GeneralStatistics expression (auto-extracted; see ref)."
