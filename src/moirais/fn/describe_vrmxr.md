...
`print(result)` render. See `moirais.fn.describe('vrmxr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrmxr import *
import numpy as np
# See the function signature in fn/vrmxr.py for argument names.
```
