...
__all__ = ["hedderich_chapter_9_unnumbered_1892"]


def hedderich_chapter_9_unnumbered_1892(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + x1 = x [ 1 : half ] ; x2 = x [ ( half + 1 ) : ( length( x ) ) ]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1892')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1892: GeneralStatistics expression (auto-extracted; see ref)."
