# describe('rng018') — rangayyan_ch3_ensemble_average_function
...
`print(result)` render. See `moirais.fn.describe('rng018')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng018 import *
import numpy as np
# See the function signature in fn/rng018.py for argument names.
```
