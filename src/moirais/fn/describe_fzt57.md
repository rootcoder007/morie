# describe('fzt57') — fauzi_thm5_7_bdfree_cvm_equiv
...
`print(result)` render. See `moirais.fn.describe('fzt57')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt57 import *
import numpy as np
# See the function signature in fn/fzt57.py for argument names.
```
