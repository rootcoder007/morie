...
__all__ = ["hedderich_chapter_9_unnumbered_2054"]


def hedderich_chapter_9_unnumbered_2054(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: one-sided Test(1−β) two-sided Test (1−β)|µ1−µ2|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2054')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2054: PowerAndDesign expression (auto-extracted; see ref)."
