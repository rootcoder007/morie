...
`print(result)` render. See `moirais.fn.describe('nngrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nngrd import *
import numpy as np
# See the function signature in fn/nngrd.py for argument names.
```
