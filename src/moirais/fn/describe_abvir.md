...
`print(result)` render. See `moirais.fn.describe('abvir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abvir import *
import numpy as np
# See the function signature in fn/abvir.py for argument names.
```
