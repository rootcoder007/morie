...
__all__ = ["hedderich_chapter_9_unnumbered_853"]


def hedderich_chapter_9_unnumbered_853(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µ∓1.96σ= 150∓1.96·10 we obtain the quantilesx0.025 = 130.4 andx0.975 = 169.6 and thus
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u853')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u853: GeneralStatistics expression (auto-extracted; see ref)."
