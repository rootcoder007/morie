...
`print(result)` render. See `moirais.fn.describe('opzon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opzon import *
import numpy as np
# See the function signature in fn/opzon.py for argument names.
```
