...
`print(result)` render. See `moirais.fn.describe('slcsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slcsp import *
import numpy as np
# See the function signature in fn/slcsp.py for argument names.
```
