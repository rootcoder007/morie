# describe('vginv') — indicator_vario
...
`print(result)` render. See `moirais.fn.describe('vginv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vginv import *
import numpy as np
# See the function signature in fn/vginv.py for argument names.
```
