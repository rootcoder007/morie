# describe('gh_c11_6') — ghosal_bm_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c11_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_6 import *
import numpy as np
# See the function signature in fn/gh_c11_6.py for argument names.
```
