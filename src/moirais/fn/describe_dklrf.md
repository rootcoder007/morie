...
`print(result)` render. See `moirais.fn.describe('dklrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dklrf import *
import numpy as np
# See the function signature in fn/dklrf.py for argument names.
```
