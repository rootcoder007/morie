...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1173"]


def guide_on_data_analysis_chapter_24_unnumbered_1173(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑆𝑆𝑇𝑅 = 𝑛 ∑( ̄ 𝑟.𝑗 − ̄ 𝑟..)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1173')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1173: GeneralStatistics expression (auto-extracted; see ref)."
