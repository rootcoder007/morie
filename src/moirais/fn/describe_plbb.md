# describe('plbb') — plot_blackbox_result
...
`print(result)` render. See `moirais.fn.describe('plbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plbb import *
import numpy as np
# See the function signature in fn/plbb.py for argument names.
```
