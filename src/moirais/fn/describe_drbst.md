# describe('drbst') — dr_did_bootstrap
...
`print(result)` render. See `moirais.fn.describe('drbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drbst import *
import numpy as np
# See the function signature in fn/drbst.py for argument names.
```
