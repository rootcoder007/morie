...
`print(result)` render. See `moirais.fn.describe('logcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logcl import *
import numpy as np
# See the function signature in fn/logcl.py for argument names.
```
