...
`print(result)` render. See `moirais.fn.describe('dkcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkcrs import *
import numpy as np
# See the function signature in fn/dkcrs.py for argument names.
```
