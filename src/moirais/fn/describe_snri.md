# describe('snri') — snr_improvement_fn
...
`print(result)` render. See `moirais.fn.describe('snri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snri import *
import numpy as np
# See the function signature in fn/snri.py for argument names.
```
