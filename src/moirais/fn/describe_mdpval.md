# describe('mdpval') — mdp_value_iteration
...
`print(result)` render. See `moirais.fn.describe('mdpval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdpval import *
import numpy as np
# See the function signature in fn/mdpval.py for argument names.
```
