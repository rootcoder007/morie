...
__all__ = ["hedderich_chapter_9_unnumbered_278"]


def hedderich_chapter_9_unnumbered_278(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + xlab =" Age [ months ] " , ylab =" Height [ cm ] " ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u278')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u278: GeneralStatistics expression (auto-extracted; see ref)."
