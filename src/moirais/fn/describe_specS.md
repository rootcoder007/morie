# describe('specS') — speculative_decoding
...
`print(result)` render. See `moirais.fn.describe('specS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specS import *
import numpy as np
# See the function signature in fn/specS.py for argument names.
```
