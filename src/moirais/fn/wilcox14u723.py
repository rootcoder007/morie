...
__all__ = ["wilcox_chapter_14_unnumbered_723"]


def wilcox_chapter_14_unnumbered_723(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Notice that with three groups ( J = 3), θ 1 = θ 2 = θ 3 can be true if and only if θ 1 = θ 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u723')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u723: GeneralStatistics expression (auto-extracted; see ref)."
