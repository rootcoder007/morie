# describe('tmlsta') — tmle_stabilized
...
`print(result)` render. See `moirais.fn.describe('tmlsta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsta import *
import numpy as np
# See the function signature in fn/tmlsta.py for argument names.
```
