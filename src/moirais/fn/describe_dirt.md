# describe('dirt') — dynamic_irt_model
...
`print(result)` render. See `moirais.fn.describe('dirt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dirt import *
import numpy as np
# See the function signature in fn/dirt.py for argument names.
```
