# describe('kmbpb') — kamath_bits_per_byte
...
`print(result)` render. See `moirais.fn.describe('kmbpb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbpb import *
import numpy as np
# See the function signature in fn/kmbpb.py for argument names.
```
