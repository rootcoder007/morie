# describe('bndvar') — bound_variance_term
...
`print(result)` render. See `moirais.fn.describe('bndvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndvar import *
import numpy as np
# See the function signature in fn/bndvar.py for argument names.
```
