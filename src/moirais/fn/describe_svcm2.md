...
`print(result)` render. See `moirais.fn.describe('svcm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcm2 import *
import numpy as np
# See the function signature in fn/svcm2.py for argument names.
```
