# describe('ewmav') — ewma_volatility
...
`print(result)` render. See `moirais.fn.describe('ewmav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewmav import *
import numpy as np
# See the function signature in fn/ewmav.py for argument names.
```
