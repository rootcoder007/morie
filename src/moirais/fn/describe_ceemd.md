...
`print(result)` render. See `moirais.fn.describe('ceemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ceemd import *
import numpy as np
# See the function signature in fn/ceemd.py for argument names.
```
