...
`print(result)` render. See `moirais.fn.describe('unetbk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unetbk import *
import numpy as np
# See the function signature in fn/unetbk.py for argument names.
```
