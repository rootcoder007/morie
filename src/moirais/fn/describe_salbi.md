...
`print(result)` render. See `moirais.fn.describe('salbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.salbi import *
import numpy as np
# See the function signature in fn/salbi.py for argument names.
```
