...
`print(result)` render. See `moirais.fn.describe('ptmrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptmrk import *
import numpy as np
# See the function signature in fn/ptmrk.py for argument names.
```
