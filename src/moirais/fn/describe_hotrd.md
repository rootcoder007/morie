# describe('hotrd') — newton_convergence
...
`print(result)` render. See `moirais.fn.describe('hotrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotrd import *
import numpy as np
# See the function signature in fn/hotrd.py for argument names.
```
