# describe('stckc') — stacking_classify
...
`print(result)` render. See `moirais.fn.describe('stckc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stckc import *
import numpy as np
# See the function signature in fn/stckc.py for argument names.
```
