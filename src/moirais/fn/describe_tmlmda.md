# describe('tmlmda') — tmle_missing_data
...
`print(result)` render. See `moirais.fn.describe('tmlmda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmda import *
import numpy as np
# See the function signature in fn/tmlmda.py for argument names.
```
