# describe('rgwhann') — rangayyan_hann_window
...
`print(result)` render. See `moirais.fn.describe('rgwhann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwhann import *
import numpy as np
# See the function signature in fn/rgwhann.py for argument names.
```
