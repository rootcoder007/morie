...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_195"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_195(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: β02 +β12xi +β22x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u195')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u195: GeneralStatistics expression (auto-extracted; see ref)."
