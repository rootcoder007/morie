...
__all__ = ["wilcox_chapter_5_unnumbered_386"]


def wilcox_chapter_5_unnumbered_386(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 9. If ¯X = 23 and α = 0.025, can you make a decision about whether to reject H0:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u386')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u386: GeneralStatistics expression (auto-extracted; see ref)."
