# describe('db4fn') — daubechies_coeffs
...
`print(result)` render. See `moirais.fn.describe('db4fn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.db4fn import *
import numpy as np
# See the function signature in fn/db4fn.py for argument names.
```
