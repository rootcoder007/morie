# describe('vdisc') — discriminant_validity
...
`print(result)` render. See `moirais.fn.describe('vdisc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdisc import *
import numpy as np
# See the function signature in fn/vdisc.py for argument names.
```
