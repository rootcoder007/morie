# describe('hrzsieqr') — horowitz_series_quantile
...
`print(result)` render. See `moirais.fn.describe('hrzsieqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsieqr import *
import numpy as np
# See the function signature in fn/hrzsieqr.py for argument names.
```
