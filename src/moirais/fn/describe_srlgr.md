...
`print(result)` render. See `moirais.fn.describe('srlgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srlgr import *
import numpy as np
# See the function signature in fn/srlgr.py for argument names.
```
