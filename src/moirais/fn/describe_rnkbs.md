# describe('rnkbs') — rank_based_test
...
`print(result)` render. See `moirais.fn.describe('rnkbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnkbs import *
import numpy as np
# See the function signature in fn/rnkbs.py for argument names.
```
