# describe('buttbp') — butter_bandpass
...
`print(result)` render. See `moirais.fn.describe('buttbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.buttbp import *
import numpy as np
# See the function signature in fn/buttbp.py for argument names.
```
