# describe('rhatd') — rhat_diagnostic
...
`print(result)` render. See `moirais.fn.describe('rhatd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rhatd import *
import numpy as np
# See the function signature in fn/rhatd.py for argument names.
```
