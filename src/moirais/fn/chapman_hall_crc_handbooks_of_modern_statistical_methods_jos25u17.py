...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_17"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_25_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Pr{ Z = 1 | λ, f (x)} = E[Pr{ Z = 1 | x, λ, f (x)} | λ, f (x)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u17')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos25u17: GeneralStatistics expression (auto-extracted; see ref)."
