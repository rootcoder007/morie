...
__all__ = ["hedderich_chapter_9_unnumbered_2424"]


def hedderich_chapter_9_unnumbered_2424(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] N = 200 ¯x = 15.38 s = 15.26
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2424')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2424: GeneralStatistics expression (auto-extracted; see ref)."
