...
`print(result)` render. See `moirais.fn.describe('theteap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.theteap import *
import numpy as np
# See the function signature in fn/theteap.py for argument names.
```
