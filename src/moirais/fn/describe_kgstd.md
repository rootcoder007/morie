# describe('kgstd') — kriging_std_error
...
`print(result)` render. See `moirais.fn.describe('kgstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgstd import *
import numpy as np
# See the function signature in fn/kgstd.py for argument names.
```
