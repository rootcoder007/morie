...
__all__ = ["hedderich_chapter_9_unnumbered_2782"]


def hedderich_chapter_9_unnumbered_2782(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (|b−c|−1)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2782')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2782: GeneralStatistics expression (auto-extracted; see ref)."
