# describe('rkhsc') — rkhs_kernel_regression
...
`print(result)` render. See `moirais.fn.describe('rkhsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkhsc import *
import numpy as np
# See the function signature in fn/rkhsc.py for argument names.
```
