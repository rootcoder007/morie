# describe('rgpsd2hz') — rangayyan_psd_to_hz
...
`print(result)` render. See `moirais.fn.describe('rgpsd2hz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpsd2hz import *
import numpy as np
# See the function signature in fn/rgpsd2hz.py for argument names.
```
