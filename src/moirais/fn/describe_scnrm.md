...
`print(result)` render. See `moirais.fn.describe('scnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scnrm import *
import numpy as np
# See the function signature in fn/scnrm.py for argument names.
```
