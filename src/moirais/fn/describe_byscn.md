# describe('byscn') — bayes_cpi_prior
...
`print(result)` render. See `moirais.fn.describe('byscn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.byscn import *
import numpy as np
# See the function signature in fn/byscn.py for argument names.
```
