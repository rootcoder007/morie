...
`print(result)` render. See `moirais.fn.describe('mczone')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mczone import *
import numpy as np
# See the function signature in fn/mczone.py for argument names.
```
