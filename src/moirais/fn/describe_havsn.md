# describe('havsn') — haversine_distance

## WHAT IT DOES

Haversine great-circle distance. 'Out of chaos, comes order. — Friedrich Nietzsche'
...
`print(result)` render. See `moirais.fn.describe('havsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.havsn import *
import numpy as np
# See the function signature in fn/havsn.py for argument names.
```
