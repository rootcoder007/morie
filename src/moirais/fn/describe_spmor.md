# describe('spmor') — schabenberger_moran_i
...
`print(result)` render. See `moirais.fn.describe('spmor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmor import *
import numpy as np
# See the function signature in fn/spmor.py for argument names.
```
