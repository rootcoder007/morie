...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_16"]


def guide_on_data_analysis_chapter_2_unnumbered_16(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 2. For each column 𝑗 = 𝑖 + 1, 𝑖 + 2, … , 𝑛:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u16')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u16: GeneralStatistics expression (auto-extracted; see ref)."
