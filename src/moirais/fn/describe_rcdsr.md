# describe('rcdsr') — recidivism_survival
...
`print(result)` render. See `moirais.fn.describe('rcdsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdsr import *
import numpy as np
# See the function signature in fn/rcdsr.py for argument names.
```
