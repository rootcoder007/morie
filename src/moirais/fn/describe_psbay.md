...
`print(result)` render. See `moirais.fn.describe('psbay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psbay import *
import numpy as np
# See the function signature in fn/psbay.py for argument names.
```
