# describe('rng065') — rangayyan_ch3_fourier_transform_f
...
`print(result)` render. See `moirais.fn.describe('rng065')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng065 import *
import numpy as np
# See the function signature in fn/rng065.py for argument names.
```
