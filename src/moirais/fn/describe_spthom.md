# describe('spthom') — schabenberger_thomas_process
...
`print(result)` render. See `moirais.fn.describe('spthom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spthom import *
import numpy as np
# See the function signature in fn/spthom.py for argument names.
```
