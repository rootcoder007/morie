# describe('kmuni') — kamath_unigram_lm_tokenizer
...
`print(result)` render. See `moirais.fn.describe('kmuni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmuni import *
import numpy as np
# See the function signature in fn/kmuni.py for argument names.
```
