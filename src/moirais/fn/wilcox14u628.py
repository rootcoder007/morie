...
__all__ = ["wilcox_chapter_14_unnumbered_628"]


def wilcox_chapter_14_unnumbered_628(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: than or equal to X(g+1)j, set Yij = X(g+1)j, and if Xij is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u628')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u628: GeneralStatistics expression (auto-extracted; see ref)."
