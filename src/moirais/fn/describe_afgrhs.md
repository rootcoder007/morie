...
`print(result)` render. See `moirais.fn.describe('afgrhs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afgrhs import *
import numpy as np
# See the function signature in fn/afgrhs.py for argument names.
```
