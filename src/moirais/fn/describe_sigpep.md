# describe('sigpep') — signal_peptide
...
`print(result)` render. See `moirais.fn.describe('sigpep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sigpep import *
import numpy as np
# See the function signature in fn/sigpep.py for argument names.
```
