...
`print(result)` render. See `moirais.fn.describe('dixon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dixon import *
import numpy as np
# See the function signature in fn/dixon.py for argument names.
```
