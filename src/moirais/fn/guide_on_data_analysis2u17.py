...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_17"]


def guide_on_data_analysis_chapter_2_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u17')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u17: GeneralStatistics expression (auto-extracted; see ref)."
