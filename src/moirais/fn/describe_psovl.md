...
`print(result)` render. See `moirais.fn.describe('psovl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psovl import *
import numpy as np
# See the function signature in fn/psovl.py for argument names.
```
