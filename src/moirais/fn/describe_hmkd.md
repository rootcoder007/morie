# describe('hmkd') — geron_knowledge_distillation
...
`print(result)` render. See `moirais.fn.describe('hmkd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkd import *
import numpy as np
# See the function signature in fn/hmkd.py for argument names.
```
