# describe('cpmnr') — mean_changepoint
...
`print(result)` render. See `moirais.fn.describe('cpmnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpmnr import *
import numpy as np
# See the function signature in fn/cpmnr.py for argument names.
```
