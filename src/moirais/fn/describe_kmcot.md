# describe('kmcot') — kamath_chain_of_thought
...
`print(result)` render. See `moirais.fn.describe('kmcot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcot import *
import numpy as np
# See the function signature in fn/kmcot.py for argument names.
```
