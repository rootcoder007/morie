# describe('conv2') — conv2

## WHAT IT DOES

r2D convolution (forward pass).
...
`print(result)` render. See `moirais.fn.describe('conv2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.conv2 import *
import numpy as np
# See the function signature in fn/conv2.py for argument names.
```
