# describe('explor') — intrinsic_motivation
...
`print(result)` render. See `moirais.fn.describe('explor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.explor import *
import numpy as np
# See the function signature in fn/explor.py for argument names.
```
