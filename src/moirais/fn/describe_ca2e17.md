# describe('ca2e17') — ca_chapter_2_equation_17
...
```python
from moirais.fn.ca2e17 import ca_chapter_2_equation_17
import numpy as np
result = ca_chapter_2_equation_17(np.random.default_rng(42).normal(0, 1, 100))
