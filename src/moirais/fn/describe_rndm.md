...
`print(result)` render. See `moirais.fn.describe('rndm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndm import *
import numpy as np
# See the function signature in fn/rndm.py for argument names.
```
