# describe('grpre') — geron_precision
...
`print(result)` render. See `moirais.fn.describe('grpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpre import *
import numpy as np
# See the function signature in fn/grpre.py for argument names.
```
