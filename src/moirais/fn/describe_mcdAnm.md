...
`print(result)` render. See `moirais.fn.describe('mcdAnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcdAnm import *
import numpy as np
# See the function signature in fn/mcdAnm.py for argument names.
```
