...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_33(x):
    """
    Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner3e33')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e33: Dispersion equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
