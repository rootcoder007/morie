# describe('sirsv') — sirs_vaccination
...
`print(result)` render. See `moirais.fn.describe('sirsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sirsv import *
import numpy as np
# See the function signature in fn/sirsv.py for argument names.
```
