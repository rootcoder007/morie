...
`print(result)` render. See `moirais.fn.describe('vmfrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmfrs import *
import numpy as np
# See the function signature in fn/vmfrs.py for argument names.
```
