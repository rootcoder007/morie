# describe('bamse') — bayesian_se_from_posterior
...
`print(result)` render. See `moirais.fn.describe('bamse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bamse import *
import numpy as np
# See the function signature in fn/bamse.py for argument names.
```
