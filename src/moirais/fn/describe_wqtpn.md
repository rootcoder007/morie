...
`print(result)` render. See `moirais.fn.describe('wqtpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtpn import *
import numpy as np
# See the function signature in fn/wqtpn.py for argument names.
```
