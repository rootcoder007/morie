...
`print(result)` render. See `moirais.fn.describe('kpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpca import *
import numpy as np
# See the function signature in fn/kpca.py for argument names.
```
