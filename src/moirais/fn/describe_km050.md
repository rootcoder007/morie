# describe('km050') — kamath_ch3_back_translation_prob
...
`print(result)` render. See `moirais.fn.describe('km050')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km050 import *
import numpy as np
# See the function signature in fn/km050.py for argument names.
```
