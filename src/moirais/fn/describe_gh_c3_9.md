# describe('gh_c3_9') — ghosal_quantile_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c3_9')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_9 import *
import numpy as np
# See the function signature in fn/gh_c3_9.py for argument names.
```
