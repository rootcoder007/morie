...
`print(result)` render. See `moirais.fn.describe('btlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btlrt import *
import numpy as np
# See the function signature in fn/btlrt.py for argument names.
```
