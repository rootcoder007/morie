# describe('prgsv') — program_survival
...
`print(result)` render. See `moirais.fn.describe('prgsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgsv import *
import numpy as np
# See the function signature in fn/prgsv.py for argument names.
```
