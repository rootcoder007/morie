...
`print(result)` render. See `moirais.fn.describe('afbufr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afbufr import *
import numpy as np
# See the function signature in fn/afbufr.py for argument names.
```
