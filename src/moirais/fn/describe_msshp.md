...
`print(result)` render. See `moirais.fn.describe('msshp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msshp import *
import numpy as np
# See the function signature in fn/msshp.py for argument names.
```
