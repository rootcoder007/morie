...
`print(result)` render. See `moirais.fn.describe('agenn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agenn import *
import numpy as np
# See the function signature in fn/agenn.py for argument names.
```
