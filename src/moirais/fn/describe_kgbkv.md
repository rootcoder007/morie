...
`print(result)` render. See `moirais.fn.describe('kgbkv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgbkv import *
import numpy as np
# See the function signature in fn/kgbkv.py for argument names.
```
