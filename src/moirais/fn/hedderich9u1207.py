...
__all__ = ["hedderich_chapter_9_unnumbered_1207"]


def hedderich_chapter_9_unnumbered_1207(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] i! = 1−P (χ2|ν)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1207')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1207: CountModels expression (auto-extracted; see ref)."
