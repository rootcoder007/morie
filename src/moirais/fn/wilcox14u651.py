...
__all__ = ["wilcox_chapter_14_unnumbered_651"]


def wilcox_chapter_14_unnumbered_651(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Apply the Wilcoxon signed rank test with α = 0.05. Verify that W = 0.7565 and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u651')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u651: GeneralStatistics expression (auto-extracted; see ref)."
