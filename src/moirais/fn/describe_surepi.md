# describe('surepi') — surveillance_signal
...
`print(result)` render. See `moirais.fn.describe('surepi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.surepi import *
import numpy as np
# See the function signature in fn/surepi.py for argument names.
```
