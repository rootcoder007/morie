# describe('rf_') — random_forest_simple
...
`print(result)` render. See `moirais.fn.describe('rf_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rf_ import *
import numpy as np
# See the function signature in fn/rf_.py for argument names.
```
