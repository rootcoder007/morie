...
`print(result)` render. See `moirais.fn.describe('hubbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hubbl import *
import numpy as np
# See the function signature in fn/hubbl.py for argument names.
```
