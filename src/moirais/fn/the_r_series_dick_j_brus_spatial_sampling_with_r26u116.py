...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_26_unnumbered_116(x):
    """
    CentralTendency expression (auto-extracted; see ref).

    Formula: mseKED = sum(w_h * mseKED_h),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r26u116')`` for the full guide.
