# describe('manct') — ma_continuity_correction
...
`print(result)` render. See `moirais.fn.describe('manct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manct import *
import numpy as np
# See the function signature in fn/manct.py for argument names.
```
