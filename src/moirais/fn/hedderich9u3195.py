...
__all__ = ["hedderich_chapter_9_unnumbered_3195"]


def hedderich_chapter_9_unnumbered_3195(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y.x = ∑[yi−(a +bxi)]2/(n−2).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3195')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3195: GeneralStatistics expression (auto-extracted; see ref)."
