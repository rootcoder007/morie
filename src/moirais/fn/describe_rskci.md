# describe('rskci') — risk_concordance
...
`print(result)` render. See `moirais.fn.describe('rskci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskci import *
import numpy as np
# See the function signature in fn/rskci.py for argument names.
```
