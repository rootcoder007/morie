...
`print(result)` render. See `moirais.fn.describe('rsatm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsatm import *
import numpy as np
# See the function signature in fn/rsatm.py for argument names.
```
