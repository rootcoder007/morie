# describe('gb_spv') — gibbons_spearman_rho_var
...
`print(result)` render. See `moirais.fn.describe('gb_spv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_spv import *
import numpy as np
# See the function signature in fn/gb_spv.py for argument names.
```
