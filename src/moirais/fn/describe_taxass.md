# describe('taxass') — taxonomic_assignment
...
`print(result)` render. See `moirais.fn.describe('taxass')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taxass import *
import numpy as np
# See the function signature in fn/taxass.py for argument names.
```
