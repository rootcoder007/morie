...
__all__ = ["wilcox_chapter_13_unnumbered_1307"]


def wilcox_chapter_13_unnumbered_1307(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1307')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1307: GeneralStatistics expression (auto-extracted; see ref)."
