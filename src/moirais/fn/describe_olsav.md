...
`print(result)` render. See `moirais.fn.describe('olsav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.olsav import *
import numpy as np
# See the function signature in fn/olsav.py for argument names.
```
