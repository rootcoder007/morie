# describe('rgburg') — rangayyan_burg_method
...
`print(result)` render. See `moirais.fn.describe('rgburg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgburg import *
import numpy as np
# See the function signature in fn/rgburg.py for argument names.
```
