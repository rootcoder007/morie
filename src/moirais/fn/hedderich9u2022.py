...
__all__ = ["hedderich_chapter_9_unnumbered_2022"]


def hedderich_chapter_9_unnumbered_2022(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: HA1 :...>µ0 HA2 :...<µ0 HA3 :...̸=µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2022')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2022: GeneralStatistics expression (auto-extracted; see ref)."
