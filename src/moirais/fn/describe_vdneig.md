...
`print(result)` render. See `moirais.fn.describe('vdneig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdneig import *
import numpy as np
# See the function signature in fn/vdneig.py for argument names.
```
