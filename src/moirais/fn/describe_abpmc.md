...
`print(result)` render. See `moirais.fn.describe('abpmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpmc import *
import numpy as np
# See the function signature in fn/abpmc.py for argument names.
```
