# describe('censr') — censored_regression
...
`print(result)` render. See `moirais.fn.describe('censr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.censr import *
import numpy as np
# See the function signature in fn/censr.py for argument names.
```
