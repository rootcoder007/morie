...
`print(result)` render. See `moirais.fn.describe('mca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mca import *
import numpy as np
# See the function signature in fn/mca.py for argument names.
```
