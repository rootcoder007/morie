...
__all__ = ["wilcox_chapter_10_unnumbered_875"]


def wilcox_chapter_10_unnumbered_875(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: approximately, an F distribution with ν 1 =ℓ andν 2 =ℓ(ℓ + 2)/(3 A) degrees of freedom. For
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u875')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u875: GeneralStatistics expression (auto-extracted; see ref)."
