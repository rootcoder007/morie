...
__all__ = ["hedderich_chapter_9_unnumbered_1939"]


def hedderich_chapter_9_unnumbered_1939(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1939')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1939: PowerAndDesign expression (auto-extracted; see ref)."
