...
`print(result)` render. See `moirais.fn.describe('tmlmrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmrk import *
import numpy as np
# See the function signature in fn/tmlmrk.py for argument names.
```
