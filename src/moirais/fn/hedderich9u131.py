...
__all__ = ["hedderich_chapter_9_unnumbered_131"]


def hedderich_chapter_9_unnumbered_131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u131')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u131: GeneralStatistics expression (auto-extracted; see ref)."
