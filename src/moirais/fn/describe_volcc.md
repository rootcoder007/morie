# describe('volcc') — vol_christoffersen_cc
...
`print(result)` render. See `moirais.fn.describe('volcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volcc import *
import numpy as np
# See the function signature in fn/volcc.py for argument names.
```
