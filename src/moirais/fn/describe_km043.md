# describe('km043') — kamath_ch3_prompt_softmax_label
...
`print(result)` render. See `moirais.fn.describe('km043')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km043 import *
import numpy as np
# See the function signature in fn/km043.py for argument names.
```
