...
`print(result)` render. See `moirais.fn.describe('deff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deff import *
import numpy as np
# See the function signature in fn/deff.py for argument names.
```
