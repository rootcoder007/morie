...
`print(result)` render. See `moirais.fn.describe('holo_b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_b import *
import numpy as np
# See the function signature in fn/holo_b.py for argument names.
```
