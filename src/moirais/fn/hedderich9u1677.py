...
__all__ = ["hedderich_chapter_9_unnumbered_1677"]


def hedderich_chapter_9_unnumbered_1677(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Forn = 12 observations, letA[−] = 9 andA[+] = 3. The null hypothesis of symmetry
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1677')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1677: GeneralStatistics expression (auto-extracted; see ref)."
