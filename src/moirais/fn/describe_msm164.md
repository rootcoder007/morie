# describe('msm164') — mvsml_ridge_lasso_elastic_eq_9_1
...
`print(result)` render. See `moirais.fn.describe('msm164')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm164 import *
import numpy as np
# See the function signature in fn/msm164.py for argument names.
```
