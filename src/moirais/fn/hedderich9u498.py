...
__all__ = ["hedderich_chapter_9_unnumbered_498"]


def hedderich_chapter_9_unnumbered_498(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The equality of sensitivity [P (T +|K) = Se] and specificity [P (T−|¯K) = Sp] of the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u498')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u498: GeneralStatistics expression (auto-extracted; see ref)."
