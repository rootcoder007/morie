# describe('rcd_g') — recidivism_by_gender
...
`print(result)` render. See `moirais.fn.describe('rcd_g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcd_g import *
import numpy as np
# See the function signature in fn/rcd_g.py for argument names.
```
