...
`print(result)` render. See `moirais.fn.describe('dtcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcmp import *
import numpy as np
# See the function signature in fn/dtcmp.py for argument names.
```
