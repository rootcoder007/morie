# describe('mTriple') — triply_robust_mediation
...
`print(result)` render. See `moirais.fn.describe('mTriple')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mTriple import *
import numpy as np
# See the function signature in fn/mTriple.py for argument names.
```
