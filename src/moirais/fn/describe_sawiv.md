...
`print(result)` render. See `moirais.fn.describe('sawiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawiv import *
import numpy as np
# See the function signature in fn/sawiv.py for argument names.
```
