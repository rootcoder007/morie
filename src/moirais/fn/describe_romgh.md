# describe('romgh') — omega_hierarchical_sub
...
`print(result)` render. See `moirais.fn.describe('romgh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.romgh import *
import numpy as np
# See the function signature in fn/romgh.py for argument names.
```
