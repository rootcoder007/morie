...
`print(result)` render. See `moirais.fn.describe('mtxrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtxrl import *
import numpy as np
# See the function signature in fn/mtxrl.py for argument names.
```
