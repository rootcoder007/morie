# describe('spcrhk') — schabenberger_cressie_hawkins
...
`print(result)` render. See `moirais.fn.describe('spcrhk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcrhk import *
import numpy as np
# See the function signature in fn/spcrhk.py for argument names.
```
