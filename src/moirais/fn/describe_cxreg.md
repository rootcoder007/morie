...
`print(result)` render. See `moirais.fn.describe('cxreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cxreg import *
import numpy as np
# See the function signature in fn/cxreg.py for argument names.
```
