# describe('kmppok') — kamath_ppo_rlhf_objective
...
`print(result)` render. See `moirais.fn.describe('kmppok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmppok import *
import numpy as np
# See the function signature in fn/kmppok.py for argument names.
```
