...
`print(result)` render. See `moirais.fn.describe('oppso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oppso import *
import numpy as np
# See the function signature in fn/oppso.py for argument names.
```
