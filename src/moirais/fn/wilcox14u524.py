...
__all__ = ["wilcox_chapter_14_unnumbered_524"]


def wilcox_chapter_14_unnumbered_524(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n1 = 20, ¯X1 = 18.0, s1 = 60.1, s1/ √ n1 = 13
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u524')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u524: GeneralStatistics expression (auto-extracted; see ref)."
