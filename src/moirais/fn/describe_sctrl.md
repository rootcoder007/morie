# describe('sctrl') — synthetic_control
...
`print(result)` render. See `moirais.fn.describe('sctrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sctrl import *
import numpy as np
# See the function signature in fn/sctrl.py for argument names.
```
