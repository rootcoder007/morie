...
`print(result)` render. See `moirais.fn.describe('qlnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qlnrm import *
import numpy as np
# See the function signature in fn/qlnrm.py for argument names.
```
