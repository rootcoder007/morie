# describe('gb_kws') — gibbons_kw_chi2_approx
...
`print(result)` render. See `moirais.fn.describe('gb_kws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_kws import *
import numpy as np
# See the function signature in fn/gb_kws.py for argument names.
```
