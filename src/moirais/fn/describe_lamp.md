...
`print(result)` render. See `moirais.fn.describe('lamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lamp import *
import numpy as np
# See the function signature in fn/lamp.py for argument names.
```
