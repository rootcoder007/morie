...
`print(result)` render. See `moirais.fn.describe('tmses')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmses import *
import numpy as np
# See the function signature in fn/tmses.py for argument names.
```
