...
`print(result)` render. See `moirais.fn.describe('hamrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hamrm import *
import numpy as np
# See the function signature in fn/hamrm.py for argument names.
```
