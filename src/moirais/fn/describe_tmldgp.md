# describe('tmldgp') — tmle_doubly_robust_pen
...
`print(result)` render. See `moirais.fn.describe('tmldgp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmldgp import *
import numpy as np
# See the function signature in fn/tmldgp.py for argument names.
```
