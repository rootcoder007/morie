# describe('hrzsim') — horowitz_single_index_model
...
`print(result)` render. See `moirais.fn.describe('hrzsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsim import *
import numpy as np
# See the function signature in fn/hrzsim.py for argument names.
```
