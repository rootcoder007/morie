...
`print(result)` render. See `moirais.fn.describe('smcopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smcopt import *
import numpy as np
# See the function signature in fn/smcopt.py for argument names.
```
