...
`print(result)` render. See `moirais.fn.describe('srgwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwd import *
import numpy as np
# See the function signature in fn/srgwd.py for argument names.
```
