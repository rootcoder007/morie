# describe('eigvl') — extract_eigenvalues
...
`print(result)` render. See `moirais.fn.describe('eigvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigvl import *
import numpy as np
# See the function signature in fn/eigvl.py for argument names.
```
