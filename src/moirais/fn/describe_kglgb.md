# describe('kglgb') — lk_backtransform
...
`print(result)` render. See `moirais.fn.describe('kglgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kglgb import *
import numpy as np
# See the function signature in fn/kglgb.py for argument names.
```
