...
__all__ = ["wilcox_chapter_13_unnumbered_1191"]


def wilcox_chapter_13_unnumbered_1191(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: regIVcom(x,y, IV1=1, IV2=2, regfun=tsreg, nboot=200, xout=FALSE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1191')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1191: PowerAndDesign expression (auto-extracted; see ref)."
