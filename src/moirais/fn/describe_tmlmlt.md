# describe('tmlmlt') — tmle_multiple_treatments
...
`print(result)` render. See `moirais.fn.describe('tmlmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmlt import *
import numpy as np
# See the function signature in fn/tmlmlt.py for argument names.
```
