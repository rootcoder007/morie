# describe('bfact') — bayes_factor_savage_dickey
...
`print(result)` render. See `moirais.fn.describe('bfact')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfact import *
import numpy as np
# See the function signature in fn/bfact.py for argument names.
```
