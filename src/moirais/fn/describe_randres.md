# describe('randres') — randomized_response
...
`print(result)` render. See `moirais.fn.describe('randres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.randres import *
import numpy as np
# See the function signature in fn/randres.py for argument names.
```
