...
`print(result)` render. See `moirais.fn.describe('stgwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stgwr import *
import numpy as np
# See the function signature in fn/stgwr.py for argument names.
```
