# describe('msm149') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm149')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm149 import *
import numpy as np
# See the function signature in fn/msm149.py for argument names.
```
