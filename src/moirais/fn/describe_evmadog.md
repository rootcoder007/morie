...
`print(result)` render. See `moirais.fn.describe('evmadog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evmadog import *
import numpy as np
# See the function signature in fn/evmadog.py for argument names.
```
