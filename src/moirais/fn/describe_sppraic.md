...
`print(result)` render. See `moirais.fn.describe('sppraic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppraic import *
import numpy as np
# See the function signature in fn/sppraic.py for argument names.
```
