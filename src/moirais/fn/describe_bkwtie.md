# describe('bkwtie') — burkov_weight_tying
...
`print(result)` render. See `moirais.fn.describe('bkwtie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkwtie import *
import numpy as np
# See the function signature in fn/bkwtie.py for argument names.
```
