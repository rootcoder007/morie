# describe('nopar') — nominate_parameters
...
`print(result)` render. See `moirais.fn.describe('nopar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nopar import *
import numpy as np
# See the function signature in fn/nopar.py for argument names.
```
