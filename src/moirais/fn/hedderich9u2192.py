...
__all__ = ["hedderich_chapter_9_unnumbered_2192"]


def hedderich_chapter_9_unnumbered_2192(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( alternative == " less " ) p . v a l <− pbinom ( T , n , 0 . 5 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2192')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2192: GeneralStatistics expression (auto-extracted; see ref)."
