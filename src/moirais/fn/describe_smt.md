# describe('smt') — semiparametric_max
...
`print(result)` render. See `moirais.fn.describe('smt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smt import *
import numpy as np
# See the function signature in fn/smt.py for argument names.
```
