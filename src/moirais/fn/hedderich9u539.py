...
__all__ = ["hedderich_chapter_9_unnumbered_539"]


def hedderich_chapter_9_unnumbered_539(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (3) P (X >a) = 1−F (a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u539')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u539: CountModels expression (auto-extracted; see ref)."
