...
`print(result)` render. See `moirais.fn.describe('tssfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssfa import *
import numpy as np
# See the function signature in fn/tssfa.py for argument names.
```
