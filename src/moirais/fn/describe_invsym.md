...
`print(result)` render. See `moirais.fn.describe('invsym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.invsym import *
import numpy as np
# See the function signature in fn/invsym.py for argument names.
```
