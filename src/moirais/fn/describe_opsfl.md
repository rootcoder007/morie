...
`print(result)` render. See `moirais.fn.describe('opsfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opsfl import *
import numpy as np
# See the function signature in fn/opsfl.py for argument names.
```
