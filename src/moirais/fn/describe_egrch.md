...
`print(result)` render. See `moirais.fn.describe('egrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egrch import *
import numpy as np
# See the function signature in fn/egrch.py for argument names.
```
