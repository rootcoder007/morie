...
`print(result)` render. See `moirais.fn.describe('nwest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwest import *
import numpy as np
# See the function signature in fn/nwest.py for argument names.
```
