...
`print(result)` render. See `moirais.fn.describe('midif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.midif import *
import numpy as np
# See the function signature in fn/midif.py for argument names.
```
