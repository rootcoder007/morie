# describe('msm294') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm294')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm294 import *
import numpy as np
# See the function signature in fn/msm294.py for argument names.
```
