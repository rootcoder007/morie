...
`print(result)` render. See `moirais.fn.describe('ghexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghexp import *
import numpy as np
# See the function signature in fn/ghexp.py for argument names.
```
