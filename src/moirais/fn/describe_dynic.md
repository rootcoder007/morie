...
`print(result)` render. See `moirais.fn.describe('dynic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dynic import *
import numpy as np
# See the function signature in fn/dynic.py for argument names.
```
