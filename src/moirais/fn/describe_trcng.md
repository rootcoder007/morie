...
`print(result)` render. See `moirais.fn.describe('trcng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcng import *
import numpy as np
# See the function signature in fn/trcng.py for argument names.
```
