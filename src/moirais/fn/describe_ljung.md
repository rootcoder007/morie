...
`print(result)` render. See `moirais.fn.describe('ljung')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ljung import *
import numpy as np
# See the function signature in fn/ljung.py for argument names.
```
