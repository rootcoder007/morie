...
__all__ = ["hedderich_chapter_9_unnumbered_1125"]


def hedderich_chapter_9_unnumbered_1125(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: read 6.83 to 40.70 and get the 95%-CI: 100−40.70 = 59.30 to 93.17 = 100−6.83, i.e. 0.593≤
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1125')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1125: GeneralStatistics expression (auto-extracted; see ref)."
