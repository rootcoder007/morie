...
`print(result)` render. See `moirais.fn.describe('gdmig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmig import *
import numpy as np
# See the function signature in fn/gdmig.py for argument names.
```
