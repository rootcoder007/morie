...
__all__ = ["hedderich_chapter_9_unnumbered_3299"]


def hedderich_chapter_9_unnumbered_3299(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] RSS = (y−ˆy)′(y−ˆy) = ( y−X ˆβ)′(y−X ˆβ) = ˆϵ′ˆϵ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3299')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3299: GeneralStatistics expression (auto-extracted; see ref)."
