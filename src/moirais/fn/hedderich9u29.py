...
__all__ = ["hedderich_chapter_9_unnumbered_29"]


def hedderich_chapter_9_unnumbered_29(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] −·−= + (−8) : (−2) = +4 = 4 −·+ =−(−8) : (+2) = −4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u29')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u29: GeneralStatistics expression (auto-extracted; see ref)."
