# describe('pmedex') — proportion_te_explained
...
`print(result)` render. See `moirais.fn.describe('pmedex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmedex import *
import numpy as np
# See the function signature in fn/pmedex.py for argument names.
```
