...
`print(result)` render. See `moirais.fn.describe('dpcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpcov import *
import numpy as np
# See the function signature in fn/dpcov.py for argument names.
```
