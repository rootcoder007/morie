# describe('hrzdimr') — horowitz_dimension_reduction
...
`print(result)` render. See `moirais.fn.describe('hrzdimr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzdimr import *
import numpy as np
# See the function signature in fn/hrzdimr.py for argument names.
```
