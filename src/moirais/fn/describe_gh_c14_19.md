# describe('gh_c14_19') — ghosal_local_dp
...
`print(result)` render. See `moirais.fn.describe('gh_c14_19')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_19 import *
import numpy as np
# See the function signature in fn/gh_c14_19.py for argument names.
```
