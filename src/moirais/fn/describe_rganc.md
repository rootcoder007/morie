...
`print(result)` render. See `moirais.fn.describe('rganc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rganc import *
import numpy as np
# See the function signature in fn/rganc.py for argument names.
```
