...
__all__ = ["hedderich_chapter_9_unnumbered_3041"]


def hedderich_chapter_9_unnumbered_3041(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The elementary calculation according to 7.372 with R results in ˆχ2=14 (P =0.0009) and shows
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3041')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3041: GeneralStatistics expression (auto-extracted; see ref)."
