# describe('ca6u207') — ca_chapter_6_unnumbered_207
...
LR test =− 2 − 147.5251() − − 147.4533()[] = 0.14:
...
```python
from moirais.fn.ca6u207 import ca_chapter_6_unnumbered_207
import numpy as np
result = ca_chapter_6_unnumbered_207(np.random.default_rng(42).normal(0, 1, 100))
