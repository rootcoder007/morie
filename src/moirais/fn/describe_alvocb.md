# describe('alvocb') — alammar_tokenizer_vocab_overlap
...
`print(result)` render. See `moirais.fn.describe('alvocb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alvocb import *
import numpy as np
# See the function signature in fn/alvocb.py for argument names.
```
