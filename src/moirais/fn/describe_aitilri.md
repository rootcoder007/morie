# describe('aitilri') — aitchison_ilr_inverse
...
`print(result)` render. See `moirais.fn.describe('aitilri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitilri import *
import numpy as np
# See the function signature in fn/aitilri.py for argument names.
```
