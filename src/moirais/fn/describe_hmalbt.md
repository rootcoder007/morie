...
`print(result)` render. See `moirais.fn.describe('hmalbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmalbt import *
import numpy as np
# See the function signature in fn/hmalbt.py for argument names.
```
