...
__all__ = ["hedderich_chapter_9_unnumbered_843"]


def hedderich_chapter_9_unnumbered_843(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] To b)x=90,z= 90−100
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u843')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u843: GeneralStatistics expression (auto-extracted; see ref)."
