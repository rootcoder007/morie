# describe('mareml') — ma_random_reml
...
`print(result)` render. See `moirais.fn.describe('mareml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mareml import *
import numpy as np
# See the function signature in fn/mareml.py for argument names.
```
