...
`print(result)` render. See `moirais.fn.describe('cddaly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cddaly import *
import numpy as np
# See the function signature in fn/cddaly.py for argument names.
```
