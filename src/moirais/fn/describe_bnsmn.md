...
`print(result)` render. See `moirais.fn.describe('bnsmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsmn import *
import numpy as np
# See the function signature in fn/bnsmn.py for argument names.
```
