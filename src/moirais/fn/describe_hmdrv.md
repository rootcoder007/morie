# describe('hmdrv') — geron_diffusion_reverse
...
`print(result)` render. See `moirais.fn.describe('hmdrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdrv import *
import numpy as np
# See the function signature in fn/hmdrv.py for argument names.
```
