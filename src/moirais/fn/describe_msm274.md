# describe('msm274') — mvsml_convolutional_nn_eq_14_5
...
`print(result)` render. See `moirais.fn.describe('msm274')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm274 import *
import numpy as np
# See the function signature in fn/msm274.py for argument names.
```
