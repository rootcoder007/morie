# describe('plrgrf') — partial_linear_grf
...
`print(result)` render. See `moirais.fn.describe('plrgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plrgrf import *
import numpy as np
# See the function signature in fn/plrgrf.py for argument names.
```
