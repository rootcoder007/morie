...
`print(result)` render. See `moirais.fn.describe('ophdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ophdb import *
import numpy as np
# See the function signature in fn/ophdb.py for argument names.
```
