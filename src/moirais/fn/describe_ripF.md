# describe('ripF') — ripley_f_function
...
`print(result)` render. See `moirais.fn.describe('ripF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ripF import *
import numpy as np
# See the function signature in fn/ripF.py for argument names.
```
