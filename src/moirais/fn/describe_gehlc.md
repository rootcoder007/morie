...
`print(result)` render. See `moirais.fn.describe('gehlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gehlc import *
import numpy as np
# See the function signature in fn/gehlc.py for argument names.
```
