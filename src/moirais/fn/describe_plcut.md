# describe('plcut') — plot_cutting_lines_data
...
`print(result)` render. See `moirais.fn.describe('plcut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcut import *
import numpy as np
# See the function signature in fn/plcut.py for argument names.
```
