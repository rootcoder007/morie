...
`print(result)` render. See `moirais.fn.describe('sampsys')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sampsys import *
import numpy as np
# See the function signature in fn/sampsys.py for argument names.
```
