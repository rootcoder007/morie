# describe('sensIM') — imai_sensitivity_rho
...
`print(result)` render. See `moirais.fn.describe('sensIM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sensIM import *
import numpy as np
# See the function signature in fn/sensIM.py for argument names.
```
