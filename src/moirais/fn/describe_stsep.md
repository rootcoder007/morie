...
`print(result)` render. See `moirais.fn.describe('stsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stsep import *
import numpy as np
# See the function signature in fn/stsep.py for argument names.
```
