# describe('msmest') — marginal_structural_model
...
`print(result)` render. See `moirais.fn.describe('msmest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmest import *
import numpy as np
# See the function signature in fn/msmest.py for argument names.
```
