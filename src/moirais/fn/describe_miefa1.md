...
`print(result)` render. See `moirais.fn.describe('miefa1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miefa1 import *
import numpy as np
# See the function signature in fn/miefa1.py for argument names.
```
