# describe('bonec') — weibull_analysis
...
`print(result)` render. See `moirais.fn.describe('bonec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bonec import *
import numpy as np
# See the function signature in fn/bonec.py for argument names.
```
