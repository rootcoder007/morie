...
`print(result)` render. See `moirais.fn.describe('dtbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbic import *
import numpy as np
# See the function signature in fn/dtbic.py for argument names.
```
