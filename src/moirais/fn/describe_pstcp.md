# describe('pstcp') — posterior_compare_params
...
`print(result)` render. See `moirais.fn.describe('pstcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstcp import *
import numpy as np
# See the function signature in fn/pstcp.py for argument names.
```
