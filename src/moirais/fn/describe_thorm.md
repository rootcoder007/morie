# describe('thorm') — bonferroni_correction

## WHAT IT DOES

Bonferroni correction for multiple hypothesis testing. 'You have power over your mind. — Marcus Aurelius'
...
`print(result)` render. See `moirais.fn.describe('thorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thorm import *
import numpy as np
# See the function signature in fn/thorm.py for argument names.
```
