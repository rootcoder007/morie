# describe('cmptm') — compliance_timeline
...
`print(result)` render. See `moirais.fn.describe('cmptm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmptm import *
import numpy as np
# See the function signature in fn/cmptm.py for argument names.
```
