...
`print(result)` render. See `moirais.fn.describe('sowtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sowtr import *
import numpy as np
# See the function signature in fn/sowtr.py for argument names.
```
