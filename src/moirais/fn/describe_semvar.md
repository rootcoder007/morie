...
`print(result)` render. See `moirais.fn.describe('semvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semvar import *
import numpy as np
# See the function signature in fn/semvar.py for argument names.
```
