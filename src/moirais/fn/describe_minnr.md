# describe('minnr') — min_distance_classify
...
`print(result)` render. See `moirais.fn.describe('minnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.minnr import *
import numpy as np
# See the function signature in fn/minnr.py for argument names.
```
