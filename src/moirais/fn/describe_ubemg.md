...
`print(result)` render. See `moirais.fn.describe('ubemg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubemg import *
import numpy as np
# See the function signature in fn/ubemg.py for argument names.
```
