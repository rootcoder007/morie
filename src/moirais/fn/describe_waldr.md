...
`print(result)` render. See `moirais.fn.describe('waldr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.waldr import *
import numpy as np
# See the function signature in fn/waldr.py for argument names.
```
