...
__all__ = ["hedderich_chapter_9_unnumbered_541"]


def hedderich_chapter_9_unnumbered_541(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (5) P (a<X ≤b) = F (b)−F (a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u541')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u541: GeneralStatistics expression (auto-extracted; see ref)."
