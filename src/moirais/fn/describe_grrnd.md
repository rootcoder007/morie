# describe('grrnd') — geron_randomized_search_cv
...
`print(result)` render. See `moirais.fn.describe('grrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrnd import *
import numpy as np
# See the function signature in fn/grrnd.py for argument names.
```
