...
__all__ = ["bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_541"]


def bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_541(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bookadvanced_elementsofstatisticallearning3u541')`` for the full guide.
...
def cheatsheet():
    return "bookadvanced_elementsofstatisticallearning3u541: GeneralStatistics expression (auto-extracted; see ref)."
