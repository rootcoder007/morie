...
`print(result)` render. See `moirais.fn.describe('idpw1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpw1 import *
import numpy as np
# See the function signature in fn/idpw1.py for argument names.
```
