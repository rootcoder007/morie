# describe('crfsel') — causal_forest_selection
...
`print(result)` render. See `moirais.fn.describe('crfsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfsel import *
import numpy as np
# See the function signature in fn/crfsel.py for argument names.
```
