...
`print(result)` render. See `moirais.fn.describe('svrcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrcs import *
import numpy as np
# See the function signature in fn/svrcs.py for argument names.
```
