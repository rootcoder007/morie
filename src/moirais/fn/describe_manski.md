# describe('manski') — manski_no_assumption_bounds
...
`print(result)` render. See `moirais.fn.describe('manski')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manski import *
import numpy as np
# See the function signature in fn/manski.py for argument names.
```
