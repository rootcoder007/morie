# describe('sgokv') — ordinary_kriging_variance
...
`print(result)` render. See `moirais.fn.describe('sgokv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgokv import *
import numpy as np
# See the function signature in fn/sgokv.py for argument names.
```
