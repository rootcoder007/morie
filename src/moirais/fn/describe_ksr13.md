# describe('ksr13') — kosorok_tangent_space
...
`print(result)` render. See `moirais.fn.describe('ksr13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr13 import *
import numpy as np
# See the function signature in fn/ksr13.py for argument names.
```
