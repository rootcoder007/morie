...
__all__ = ["hedderich_chapter_9_unnumbered_1271"]


def hedderich_chapter_9_unnumbered_1271(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ¯X−t S√n≤µ≤¯X +t S√n (6.77)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1271')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1271: GeneralStatistics expression (auto-extracted; see ref)."
