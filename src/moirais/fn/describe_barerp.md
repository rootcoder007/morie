# describe('barerp') — barrier_method
...
`print(result)` render. See `moirais.fn.describe('barerp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.barerp import *
import numpy as np
# See the function signature in fn/barerp.py for argument names.
```
