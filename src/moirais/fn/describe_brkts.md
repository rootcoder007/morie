...
`print(result)` render. See `moirais.fn.describe('brkts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brkts import *
import numpy as np
# See the function signature in fn/brkts.py for argument names.
```
