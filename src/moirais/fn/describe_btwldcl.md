# describe('btwldcl') — boot_wild_cluster
...
`print(result)` render. See `moirais.fn.describe('btwldcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btwldcl import *
import numpy as np
# See the function signature in fn/btwldcl.py for argument names.
```
