# describe('hmwpt') — geron_wordpiece_tokenizer
...
`print(result)` render. See `moirais.fn.describe('hmwpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmwpt import *
import numpy as np
# See the function signature in fn/hmwpt.py for argument names.
```
