# describe('ubhsg') — ubhsg

## WHAT IT DOES

Housing density spatial
...
`print(result)` render. See `moirais.fn.describe('ubhsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubhsg import *
import numpy as np
# See the function signature in fn/ubhsg.py for argument names.
```
