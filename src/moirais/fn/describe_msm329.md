# describe('msm329') — mvsml_functional_regression_eq_15_4
...
`print(result)` render. See `moirais.fn.describe('msm329')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm329 import *
import numpy as np
# See the function signature in fn/msm329.py for argument names.
```
