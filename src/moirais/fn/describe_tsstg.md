...
`print(result)` render. See `moirais.fn.describe('tsstg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstg import *
import numpy as np
# See the function signature in fn/tsstg.py for argument names.
```
