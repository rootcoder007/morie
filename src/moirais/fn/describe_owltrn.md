# describe('owltrn') — outcome_weighted_learning
...
`print(result)` render. See `moirais.fn.describe('owltrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.owltrn import *
import numpy as np
# See the function signature in fn/owltrn.py for argument names.
```
