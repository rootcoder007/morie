...
__all__ = ["hedderich_chapter_9_unnumbered_2978"]


def hedderich_chapter_9_unnumbered_2978(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] LU = ˆχ2/[1−(1−1/√ν)/n] (7.360)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2978')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2978: ContingencyTables expression (auto-extracted; see ref)."
