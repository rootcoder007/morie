...
`print(result)` render. See `moirais.fn.describe('maorw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maorw import *
import numpy as np
# See the function signature in fn/maorw.py for argument names.
```
