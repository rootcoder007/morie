...
`print(result)` render. See `moirais.fn.describe('clldn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clldn import *
import numpy as np
# See the function signature in fn/clldn.py for argument names.
```
