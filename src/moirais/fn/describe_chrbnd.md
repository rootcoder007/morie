# describe('chrbnd') — chernozhukov_rosen_bounds
...
`print(result)` render. See `moirais.fn.describe('chrbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chrbnd import *
import numpy as np
# See the function signature in fn/chrbnd.py for argument names.
```
