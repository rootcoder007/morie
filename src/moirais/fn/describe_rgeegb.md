# describe('rgeegb') — rangayyan_eeg_rhythms
...
`print(result)` render. See `moirais.fn.describe('rgeegb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeegb import *
import numpy as np
# See the function signature in fn/rgeegb.py for argument names.
```
