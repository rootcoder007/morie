...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_13_equation_17(x):
    """
    Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r13e17')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r13e17: Dispersion equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R."
