...
`print(result)` render. See `moirais.fn.describe('afpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afpst import *
import numpy as np
# See the function signature in fn/afpst.py for argument names.
```
