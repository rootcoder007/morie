...
`print(result)` render. See `moirais.fn.describe('lmsfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmsfl import *
import numpy as np
# See the function signature in fn/lmsfl.py for argument names.
```
