...
`print(result)` render. See `moirais.fn.describe('ghpcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghpcn import *
import numpy as np
# See the function signature in fn/ghpcn.py for argument names.
```
