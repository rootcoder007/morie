# describe('boot2') — bootstrap_two_sample
...
`print(result)` render. See `moirais.fn.describe('boot2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boot2 import *
import numpy as np
# See the function signature in fn/boot2.py for argument names.
```
