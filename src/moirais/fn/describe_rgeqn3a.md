# describe('rgeqn3a') — rangayyan_ch3_convolution_sum
...
`print(result)` render. See `moirais.fn.describe('rgeqn3a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn3a import *
import numpy as np
# See the function signature in fn/rgeqn3a.py for argument names.
```
