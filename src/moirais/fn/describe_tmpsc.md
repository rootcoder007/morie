# describe('tmpsc') — temperature_scaling
...
`print(result)` render. See `moirais.fn.describe('tmpsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmpsc import *
import numpy as np
# See the function signature in fn/tmpsc.py for argument names.
```
