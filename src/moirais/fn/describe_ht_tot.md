# describe('ht_tot') — horvitz_thompson_total
...
`print(result)` render. See `moirais.fn.describe('ht_tot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ht_tot import *
import numpy as np
# See the function signature in fn/ht_tot.py for argument names.
```
