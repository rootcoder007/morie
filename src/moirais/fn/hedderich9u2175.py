...
__all__ = ["hedderich_chapter_9_unnumbered_2175"]


def hedderich_chapter_9_unnumbered_2175(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: V = 2 2 . 5 , p− value = 0 . 5 7 4 9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2175')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2175: GeneralStatistics expression (auto-extracted; see ref)."
