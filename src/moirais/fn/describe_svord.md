...
`print(result)` render. See `moirais.fn.describe('svord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svord import *
import numpy as np
# See the function signature in fn/svord.py for argument names.
```
