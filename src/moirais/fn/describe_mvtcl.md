...
`print(result)` render. See `moirais.fn.describe('mvtcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtcl import *
import numpy as np
# See the function signature in fn/mvtcl.py for argument names.
```
