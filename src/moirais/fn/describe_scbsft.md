# describe('scbsft') — sc_with_baseline_shift
...
`print(result)` render. See `moirais.fn.describe('scbsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scbsft import *
import numpy as np
# See the function signature in fn/scbsft.py for argument names.
```
