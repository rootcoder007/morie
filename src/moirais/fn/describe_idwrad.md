...
`print(result)` render. See `moirais.fn.describe('idwrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwrad import *
import numpy as np
# See the function signature in fn/idwrad.py for argument names.
```
