...
`print(result)` render. See `moirais.fn.describe('gwrstd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrstd import *
import numpy as np
# See the function signature in fn/gwrstd.py for argument names.
```
