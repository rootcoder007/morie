...
__all__ = ["hedderich_chapter_9_unnumbered_3496"]


def hedderich_chapter_9_unnumbered_3496(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] β′= (β0, β1) and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3496')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3496: GeneralStatistics expression (auto-extracted; see ref)."
