...
__all__ = ["hedderich_chapter_9_unnumbered_28"]


def hedderich_chapter_9_unnumbered_28(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + : + = + results in plus + :−=−results in minus
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u28')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u28: GeneralStatistics expression (auto-extracted; see ref)."
