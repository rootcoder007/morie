...
`print(result)` render. See `moirais.fn.describe('gernt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gernt import *
import numpy as np
# See the function signature in fn/gernt.py for argument names.
```
