...
`print(result)` render. See `moirais.fn.describe('harqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.harqn import *
import numpy as np
# See the function signature in fn/harqn.py for argument names.
```
