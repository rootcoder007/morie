# describe('intrl') — interrupted_time_series
...
`print(result)` render. See `moirais.fn.describe('intrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intrl import *
import numpy as np
# See the function signature in fn/intrl.py for argument names.
```
