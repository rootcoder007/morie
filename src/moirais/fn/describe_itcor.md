...
`print(result)` render. See `moirais.fn.describe('itcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itcor import *
import numpy as np
# See the function signature in fn/itcor.py for argument names.
```
