...
`print(result)` render. See `moirais.fn.describe('ravag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ravag import *
import numpy as np
# See the function signature in fn/ravag.py for argument names.
```
