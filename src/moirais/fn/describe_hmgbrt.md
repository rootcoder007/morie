# describe('hmgbrt') — geron_gradient_boosting
...
`print(result)` render. See `moirais.fn.describe('hmgbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgbrt import *
import numpy as np
# See the function signature in fn/hmgbrt.py for argument names.
```
