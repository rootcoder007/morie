...
`print(result)` render. See `moirais.fn.describe('mtent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtent import *
import numpy as np
# See the function signature in fn/mtent.py for argument names.
```
