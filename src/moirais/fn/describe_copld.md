# describe('copld') — copeland_method
...
`print(result)` render. See `moirais.fn.describe('copld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copld import *
import numpy as np
# See the function signature in fn/copld.py for argument names.
```
