# describe('laplmo') — laplacian_eigen
...
`print(result)` render. See `moirais.fn.describe('laplmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laplmo import *
import numpy as np
# See the function signature in fn/laplmo.py for argument names.
```
