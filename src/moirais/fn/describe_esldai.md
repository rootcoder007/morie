# describe('esldai') — esl_dirichlet_proc
...
`print(result)` render. See `moirais.fn.describe('esldai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esldai import *
import numpy as np
# See the function signature in fn/esldai.py for argument names.
```
