# describe('hmxcpt') — geron_xception
...
`print(result)` render. See `moirais.fn.describe('hmxcpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmxcpt import *
import numpy as np
# See the function signature in fn/hmxcpt.py for argument names.
```
