...
`print(result)` render. See `moirais.fn.describe('xpehh1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xpehh1 import *
import numpy as np
# See the function signature in fn/xpehh1.py for argument names.
```
