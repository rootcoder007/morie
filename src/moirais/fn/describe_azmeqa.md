...
`print(result)` render. See `moirais.fn.describe('azmeqa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.azmeqa import *
import numpy as np
# See the function signature in fn/azmeqa.py for argument names.
```
