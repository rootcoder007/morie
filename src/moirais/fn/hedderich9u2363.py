...
__all__ = ["hedderich_chapter_9_unnumbered_2363"]


def hedderich_chapter_9_unnumbered_2363(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆF >F(k−1;n−k;1−α).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2363')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2363: GeneralStatistics expression (auto-extracted; see ref)."
