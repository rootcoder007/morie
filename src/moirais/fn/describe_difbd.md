...
`print(result)` render. See `moirais.fn.describe('difbd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difbd import *
import numpy as np
# See the function signature in fn/difbd.py for argument names.
```
