...
`print(result)` render. See `moirais.fn.describe('kgmae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgmae import *
import numpy as np
# See the function signature in fn/kgmae.py for argument names.
```
