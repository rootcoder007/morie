...
`print(result)` render. See `moirais.fn.describe('rbfimq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfimq import *
import numpy as np
# See the function signature in fn/rbfimq.py for argument names.
```
