# describe('brreg') — bayesian_ridge_regression
...
`print(result)` render. See `moirais.fn.describe('brreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brreg import *
import numpy as np
# See the function signature in fn/brreg.py for argument names.
```
