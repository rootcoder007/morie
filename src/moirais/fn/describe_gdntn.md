...
`print(result)` render. See `moirais.fn.describe('gdntn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdntn import *
import numpy as np
# See the function signature in fn/gdntn.py for argument names.
```
