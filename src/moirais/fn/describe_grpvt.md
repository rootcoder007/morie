# describe('grpvt') — geron_pyramid_vit_stage
...
`print(result)` render. See `moirais.fn.describe('grpvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpvt import *
import numpy as np
# See the function signature in fn/grpvt.py for argument names.
```
