...
`print(result)` render. See `moirais.fn.describe('svhut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svhut import *
import numpy as np
# See the function signature in fn/svhut.py for argument names.
```
