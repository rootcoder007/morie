...
`print(result)` render. See `moirais.fn.describe('benRea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.benRea import *
import numpy as np
# See the function signature in fn/benRea.py for argument names.
```
