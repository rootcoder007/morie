...
__all__ = ["hedderich_chapter_9_unnumbered_2541"]


def hedderich_chapter_9_unnumbered_2541(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: L = 1R1 + 2R2 +...+kRk =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2541')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2541: CausalInference expression (auto-extracted; see ref)."
