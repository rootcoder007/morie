...
`print(result)` render. See `moirais.fn.describe('pwpgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwpgt import *
import numpy as np
# See the function signature in fn/pwpgt.py for argument names.
```
