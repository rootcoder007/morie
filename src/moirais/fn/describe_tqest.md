# describe('tqest') — turboquant_estimate_scores
...
`print(result)` render. See `moirais.fn.describe('tqest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqest import *
import numpy as np
# See the function signature in fn/tqest.py for argument names.
```
