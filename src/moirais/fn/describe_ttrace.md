# describe('ttrace') — contact_tracing_yield
...
`print(result)` render. See `moirais.fn.describe('ttrace')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ttrace import *
import numpy as np
# See the function signature in fn/ttrace.py for argument names.
```
