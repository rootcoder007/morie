...
`print(result)` render. See `moirais.fn.describe('chcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chcap import *
import numpy as np
# See the function signature in fn/chcap.py for argument names.
```
