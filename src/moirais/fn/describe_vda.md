...
`print(result)` render. See `moirais.fn.describe('vda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vda import *
import numpy as np
# See the function signature in fn/vda.py for argument names.
```
