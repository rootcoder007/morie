# describe('eudst') — euclidean_utility
...
`print(result)` render. See `moirais.fn.describe('eudst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eudst import *
import numpy as np
# See the function signature in fn/eudst.py for argument names.
```
