# describe('gevD') — gev_distribution
...
`print(result)` render. See `moirais.fn.describe('gevD')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gevD import *
import numpy as np
# See the function signature in fn/gevD.py for argument names.
```
