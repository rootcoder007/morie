# describe('gb432') — gibbons_ks_exact_dist
...
`print(result)` render. See `moirais.fn.describe('gb432')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb432 import *
import numpy as np
# See the function signature in fn/gb432.py for argument names.
```
