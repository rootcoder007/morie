...
`print(result)` render. See `moirais.fn.describe('dkchg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkchg import *
import numpy as np
# See the function signature in fn/dkchg.py for argument names.
```
