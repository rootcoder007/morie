...
`print(result)` render. See `moirais.fn.describe('plsqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plsqs import *
import numpy as np
# See the function signature in fn/plsqs.py for argument names.
```
