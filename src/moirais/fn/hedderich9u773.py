...
__all__ = ["hedderich_chapter_9_unnumbered_773"]


def hedderich_chapter_9_unnumbered_773(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x=(p−1)/(p +q−2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u773')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u773: GeneralStatistics expression (auto-extracted; see ref)."
