# describe('rgeqn4') — rangayyan_ch4_qrs_slope
...
`print(result)` render. See `moirais.fn.describe('rgeqn4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn4 import *
import numpy as np
# See the function signature in fn/rgeqn4.py for argument names.
```
