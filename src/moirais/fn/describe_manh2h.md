# describe('manh2h') — ma_network_node_split
...
`print(result)` render. See `moirais.fn.describe('manh2h')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manh2h import *
import numpy as np
# See the function signature in fn/manh2h.py for argument names.
```
