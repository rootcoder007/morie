...
__all__ = ["hedderich_chapter_9_unnumbered_465"]


def hedderich_chapter_9_unnumbered_465(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺P (A) = 0.50 ; P (B) = 0.40 ; P (C) = 0.30 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u465')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u465: GeneralStatistics expression (auto-extracted; see ref)."
