# describe('cmptr') — compliance_trend
...
`print(result)` render. See `moirais.fn.describe('cmptr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmptr import *
import numpy as np
# See the function signature in fn/cmptr.py for argument names.
```
