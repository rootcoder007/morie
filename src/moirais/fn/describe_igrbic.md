...
`print(result)` render. See `moirais.fn.describe('igrbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igrbic import *
import numpy as np
# See the function signature in fn/igrbic.py for argument names.
```
