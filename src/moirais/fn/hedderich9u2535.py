...
__all__ = ["hedderich_chapter_9_unnumbered_2535"]


def hedderich_chapter_9_unnumbered_2535(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |RS−RD|= |21−30|= 9 < 21.13
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2535')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2535: GeneralStatistics expression (auto-extracted; see ref)."
