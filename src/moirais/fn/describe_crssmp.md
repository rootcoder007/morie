...
`print(result)` render. See `moirais.fn.describe('crssmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crssmp import *
import numpy as np
# See the function signature in fn/crssmp.py for argument names.
```
