...
`print(result)` render. See `moirais.fn.describe('sprtobt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprtobt import *
import numpy as np
# See the function signature in fn/sprtobt.py for argument names.
```
