...
`print(result)` render. See `moirais.fn.describe('zfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zfm import *
import numpy as np
# See the function signature in fn/zfm.py for argument names.
```
