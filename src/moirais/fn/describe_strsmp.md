...
`print(result)` render. See `moirais.fn.describe('strsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strsmp import *
import numpy as np
# See the function signature in fn/strsmp.py for argument names.
```
