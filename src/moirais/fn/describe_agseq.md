...
`print(result)` render. See `moirais.fn.describe('agseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agseq import *
import numpy as np
# See the function signature in fn/agseq.py for argument names.
```
