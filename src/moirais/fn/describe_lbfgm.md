...
`print(result)` render. See `moirais.fn.describe('lbfgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lbfgm import *
import numpy as np
# See the function signature in fn/lbfgm.py for argument names.
```
