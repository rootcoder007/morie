# describe('lupiv') — lupiv

## WHAT IT DOES

LU pivoting for numerical stability.
...
`print(result)` render. See `moirais.fn.describe('lupiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lupiv import *
import numpy as np
# See the function signature in fn/lupiv.py for argument names.
```
