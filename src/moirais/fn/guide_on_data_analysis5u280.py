...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_280"]


def guide_on_data_analysis_chapter_5_unnumbered_280(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] y = "Slope (beta_1)" ) +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u280')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u280: GeneralStatistics expression (auto-extracted; see ref)."
