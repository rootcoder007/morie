...
`print(result)` render. See `moirais.fn.describe('bkz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkz import *
import numpy as np
# See the function signature in fn/bkz.py for argument names.
```
