...
`print(result)` render. See `moirais.fn.describe('swrook')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swrook import *
import numpy as np
# See the function signature in fn/swrook.py for argument names.
```
