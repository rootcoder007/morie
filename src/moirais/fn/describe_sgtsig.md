# describe('sgtsig') — sgt_signless_laplacian
...
`print(result)` render. See `moirais.fn.describe('sgtsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsig import *
import numpy as np
# See the function signature in fn/sgtsig.py for argument names.
```
