...
`print(result)` render. See `moirais.fn.describe('maspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maspc import *
import numpy as np
# See the function signature in fn/maspc.py for argument names.
```
