...
__all__ = ["wilcox_chapter_13_unnumbered_1316"]


def wilcox_chapter_13_unnumbered_1316(x):
    """
    Logistic expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1316')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1316: Logistic expression (auto-extracted; see ref)."
