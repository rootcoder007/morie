# describe('cohsp') — coherence_spectrum
...
`print(result)` render. See `moirais.fn.describe('cohsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cohsp import *
import numpy as np
# See the function signature in fn/cohsp.py for argument names.
```
