...
`print(result)` render. See `moirais.fn.describe('ppspx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppspx import *
import numpy as np
# See the function signature in fn/ppspx.py for argument names.
```
