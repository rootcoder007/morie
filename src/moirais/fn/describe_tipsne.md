# describe('tipsne') — tipping_point_sensitivity
...
`print(result)` render. See `moirais.fn.describe('tipsne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tipsne import *
import numpy as np
# See the function signature in fn/tipsne.py for argument names.
```
