# describe('grbptt') — geron_backprop_through_time
...
`print(result)` render. See `moirais.fn.describe('grbptt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbptt import *
import numpy as np
# See the function signature in fn/grbptt.py for argument names.
```
