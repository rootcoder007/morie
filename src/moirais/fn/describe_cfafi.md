...
`print(result)` render. See `moirais.fn.describe('cfafi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfafi import *
import numpy as np
# See the function signature in fn/cfafi.py for argument names.
```
