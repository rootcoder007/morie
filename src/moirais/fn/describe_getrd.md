...
`print(result)` render. See `moirais.fn.describe('getrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getrd import *
import numpy as np
# See the function signature in fn/getrd.py for argument names.
```
