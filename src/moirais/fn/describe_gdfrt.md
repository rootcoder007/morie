...
`print(result)` render. See `moirais.fn.describe('gdfrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdfrt import *
import numpy as np
# See the function signature in fn/gdfrt.py for argument names.
```
