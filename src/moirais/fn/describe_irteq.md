...
`print(result)` render. See `moirais.fn.describe('irteq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irteq import *
import numpy as np
# See the function signature in fn/irteq.py for argument names.
```
