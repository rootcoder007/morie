...
`print(result)` render. See `moirais.fn.describe('igravwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravwl import *
import numpy as np
# See the function signature in fn/igravwl.py for argument names.
```
