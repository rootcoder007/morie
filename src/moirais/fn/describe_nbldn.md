...
`print(result)` render. See `moirais.fn.describe('nbldn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbldn import *
import numpy as np
# See the function signature in fn/nbldn.py for argument names.
```
