...
`print(result)` render. See `moirais.fn.describe('seclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclr import *
import numpy as np
# See the function signature in fn/seclr.py for argument names.
```
