# describe('km115') — kamath_ch8_bleu_n_geom_mean
...
`print(result)` render. See `moirais.fn.describe('km115')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km115 import *
import numpy as np
# See the function signature in fn/km115.py for argument names.
```
