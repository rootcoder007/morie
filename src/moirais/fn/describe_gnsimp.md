...
`print(result)` render. See `moirais.fn.describe('gnsimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsimp import *
import numpy as np
# See the function signature in fn/gnsimp.py for argument names.
```
