...
`print(result)` render. See `moirais.fn.describe('sacsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacsig import *
import numpy as np
# See the function signature in fn/sacsig.py for argument names.
```
