# describe('wsmdlm') — wasserman_delta_method
...
`print(result)` render. See `moirais.fn.describe('wsmdlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmdlm import *
import numpy as np
# See the function signature in fn/wsmdlm.py for argument names.
```
