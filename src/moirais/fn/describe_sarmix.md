# describe('sarmix') — spatial_ar_combined
...
`print(result)` render. See `moirais.fn.describe('sarmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarmix import *
import numpy as np
# See the function signature in fn/sarmix.py for argument names.
```
