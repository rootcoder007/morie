# describe('wsmcb') — wasserman_dkw_cb
...
`print(result)` render. See `moirais.fn.describe('wsmcb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmcb import *
import numpy as np
# See the function signature in fn/wsmcb.py for argument names.
```
