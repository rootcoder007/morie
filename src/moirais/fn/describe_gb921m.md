# describe('gb921m') — gibbons_mood_moments
...
`print(result)` render. See `moirais.fn.describe('gb921m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb921m import *
import numpy as np
# See the function signature in fn/gb921m.py for argument names.
```
