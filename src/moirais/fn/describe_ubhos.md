...
`print(result)` render. See `moirais.fn.describe('ubhos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubhos import *
import numpy as np
# See the function signature in fn/ubhos.py for argument names.
```
