# describe('rgyw') — rangayyan_yule_walker
...
`print(result)` render. See `moirais.fn.describe('rgyw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgyw import *
import numpy as np
# See the function signature in fn/rgyw.py for argument names.
```
