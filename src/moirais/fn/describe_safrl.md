...
`print(result)` render. See `moirais.fn.describe('safrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.safrl import *
import numpy as np
# See the function signature in fn/safrl.py for argument names.
```
