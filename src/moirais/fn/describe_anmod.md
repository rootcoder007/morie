# describe('anmod') — additive_noise_model
...
`print(result)` render. See `moirais.fn.describe('anmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anmod import *
import numpy as np
# See the function signature in fn/anmod.py for argument names.
```
