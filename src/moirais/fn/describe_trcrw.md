...
`print(result)` render. See `moirais.fn.describe('trcrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trcrw import *
import numpy as np
# See the function signature in fn/trcrw.py for argument names.
```
