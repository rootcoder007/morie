...
`print(result)` render. See `moirais.fn.describe('opfln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opfln import *
import numpy as np
# See the function signature in fn/opfln.py for argument names.
```
