...
`print(result)` render. See `moirais.fn.describe('madsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madsc import *
import numpy as np
# See the function signature in fn/madsc.py for argument names.
```
