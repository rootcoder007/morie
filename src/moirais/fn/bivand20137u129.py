...
__all__ = ["bivand2013_chapter_7_unnumbered_129"]


def bivand2013_chapter_7_unnumbered_129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + return(fv(res, valu = "KI", fname = "K_[I,lambda]"))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u129')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u129: GeneralStatistics expression (auto-extracted; see ref)."
