...
`print(result)` render. See `moirais.fn.describe('ate_d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ate_d import *
import numpy as np
# See the function signature in fn/ate_d.py for argument names.
```
