...
__all__ = ["hedderich_chapter_9_unnumbered_747"]


def hedderich_chapter_9_unnumbered_747(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] k + 1 ·P (X =k) withP (X = 0) = pr (5.75)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u747')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u747: CountModels expression (auto-extracted; see ref)."
