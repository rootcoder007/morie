...
`print(result)` render. See `moirais.fn.describe('tdcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdcox import *
import numpy as np
# See the function signature in fn/tdcox.py for argument names.
```
