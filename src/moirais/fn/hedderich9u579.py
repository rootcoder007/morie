...
__all__ = ["hedderich_chapter_9_unnumbered_579"]


def hedderich_chapter_9_unnumbered_579(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] e.g. P (|X−µ|< 2σ)≥1−(4/36) = 8/9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u579')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u579: GeneralStatistics expression (auto-extracted; see ref)."
