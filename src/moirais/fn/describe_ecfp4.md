# describe('ecfp4') — ecfp_4_fingerprint
...
`print(result)` render. See `moirais.fn.describe('ecfp4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecfp4 import *
import numpy as np
# See the function signature in fn/ecfp4.py for argument names.
```
