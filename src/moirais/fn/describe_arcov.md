# describe('arcov') — ar_covariance_fn
...
`print(result)` render. See `moirais.fn.describe('arcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arcov import *
import numpy as np
# See the function signature in fn/arcov.py for argument names.
```
