...
`print(result)` render. See `moirais.fn.describe('ewma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewma import *
import numpy as np
# See the function signature in fn/ewma.py for argument names.
```
