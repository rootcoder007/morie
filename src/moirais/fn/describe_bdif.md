...
`print(result)` render. See `moirais.fn.describe('bdif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdif import *
import numpy as np
# See the function signature in fn/bdif.py for argument names.
```
