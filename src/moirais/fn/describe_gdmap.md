...
`print(result)` render. See `moirais.fn.describe('gdmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmap import *
import numpy as np
# See the function signature in fn/gdmap.py for argument names.
```
