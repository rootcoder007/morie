...
`print(result)` render. See `moirais.fn.describe('svnlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnlp import *
import numpy as np
# See the function signature in fn/svnlp.py for argument names.
```
