...
__all__ = ["guide_on_data_analysis_chapter_20_unnumbered_990"]


def guide_on_data_analysis_chapter_20_unnumbered_990(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌𝑖 = 𝐷𝑖𝑌𝑖(1) + (1 − 𝐷𝑖)𝑌𝑖(0).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis20u990')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis20u990: GeneralStatistics expression (auto-extracted; see ref)."
