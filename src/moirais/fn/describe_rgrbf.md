# describe('rgrbf') — rangayyan_rbf_network
...
`print(result)` render. See `moirais.fn.describe('rgrbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrbf import *
import numpy as np
# See the function signature in fn/rgrbf.py for argument names.
```
