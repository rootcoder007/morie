...
`print(result)` render. See `moirais.fn.describe('gccwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gccwv import *
import numpy as np
# See the function signature in fn/gccwv.py for argument names.
```
