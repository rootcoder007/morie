...
`print(result)` render. See `moirais.fn.describe('dkloc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkloc import *
import numpy as np
# See the function signature in fn/dkloc.py for argument names.
```
