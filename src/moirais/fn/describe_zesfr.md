# describe('zesfr') — spatial_frailty
...
`print(result)` render. See `moirais.fn.describe('zesfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zesfr import *
import numpy as np
# See the function signature in fn/zesfr.py for argument names.
```
