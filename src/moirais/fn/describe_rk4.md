...
`print(result)` render. See `moirais.fn.describe('rk4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rk4 import *
import numpy as np
# See the function signature in fn/rk4.py for argument names.
```
