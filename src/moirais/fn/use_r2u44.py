...
__all__ = ["use_r_chapter_2_unnumbered_44"]


def use_r_chapter_2_unnumbered_44(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: projection +proj=utm +zone=13 +a=6378206.4 +rf=294.9786982 +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u44')`` for the full guide.
...
def cheatsheet():
    return "use_r2u44: GeneralStatistics expression (auto-extracted; see ref)."
