# describe('msm205') — mvsml_ridge_lasso_elastic_eq_9_30
...
`print(result)` render. See `moirais.fn.describe('msm205')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm205 import *
import numpy as np
# See the function signature in fn/msm205.py for argument names.
```
