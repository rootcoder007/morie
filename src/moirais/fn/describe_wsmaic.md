...
`print(result)` render. See `moirais.fn.describe('wsmaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmaic import *
import numpy as np
# See the function signature in fn/wsmaic.py for argument names.
```
