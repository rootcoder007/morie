# describe('acplt') — autocorrelation_data
...
`print(result)` render. See `moirais.fn.describe('acplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acplt import *
import numpy as np
# See the function signature in fn/acplt.py for argument names.
```
