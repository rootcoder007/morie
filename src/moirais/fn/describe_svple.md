# describe('svple') — polarization_er
...
`print(result)` render. See `moirais.fn.describe('svple')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svple import *
import numpy as np
# See the function signature in fn/svple.py for argument names.
```
