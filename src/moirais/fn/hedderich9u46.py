...
__all__ = ["hedderich_chapter_9_unnumbered_46"]


def hedderich_chapter_9_unnumbered_46(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u46')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u46: PowerAndDesign expression (auto-extracted; see ref)."
