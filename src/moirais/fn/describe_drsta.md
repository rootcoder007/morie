# describe('drsta') — dr_staggered_design
...
`print(result)` render. See `moirais.fn.describe('drsta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drsta import *
import numpy as np
# See the function signature in fn/drsta.py for argument names.
```
