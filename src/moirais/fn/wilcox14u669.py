...
__all__ = ["wilcox_chapter_14_unnumbered_669"]


def wilcox_chapter_14_unnumbered_669(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] MSWG = 136/(30 − 3) = 5.03,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u669')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u669: GeneralStatistics expression (auto-extracted; see ref)."
