# describe('hmpmps') — geron_mps_acceleration
...
`print(result)` render. See `moirais.fn.describe('hmpmps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpmps import *
import numpy as np
# See the function signature in fn/hmpmps.py for argument names.
```
