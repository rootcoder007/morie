...
`print(result)` render. See `moirais.fn.describe('dtaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtaic import *
import numpy as np
# See the function signature in fn/dtaic.py for argument names.
```
