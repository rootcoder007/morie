# describe('msmnbi') — msm_negative_binomial
...
`print(result)` render. See `moirais.fn.describe('msmnbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmnbi import *
import numpy as np
# See the function signature in fn/msmnbi.py for argument names.
```
