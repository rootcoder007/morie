# describe('spgwr') — schabenberger_gwr
...
`print(result)` render. See `moirais.fn.describe('spgwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgwr import *
import numpy as np
# See the function signature in fn/spgwr.py for argument names.
```
