...
`print(result)` render. See `moirais.fn.describe('difpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difpst import *
import numpy as np
# See the function signature in fn/difpst.py for argument names.
```
