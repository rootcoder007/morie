...
`print(result)` render. See `moirais.fn.describe('pcaov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcaov import *
import numpy as np
# See the function signature in fn/pcaov.py for argument names.
```
