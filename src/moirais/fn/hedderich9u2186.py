...
__all__ = ["hedderich_chapter_9_unnumbered_2186"]


def hedderich_chapter_9_unnumbered_2186(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [(−0.13) + (0.03)]/2 =−0.05 (0.10 + 0.03)/2 = 0.065
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2186')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2186: GeneralStatistics expression (auto-extracted; see ref)."
