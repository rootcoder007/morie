# describe('km001') — kamath_ch2_unidirectional_encoder_state
...
`print(result)` render. See `moirais.fn.describe('km001')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km001 import *
import numpy as np
# See the function signature in fn/km001.py for argument names.
```
