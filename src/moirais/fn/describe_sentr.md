...
`print(result)` render. See `moirais.fn.describe('sentr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sentr import *
import numpy as np
# See the function signature in fn/sentr.py for argument names.
```
