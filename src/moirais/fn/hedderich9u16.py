...
__all__ = ["hedderich_chapter_9_unnumbered_16"]


def hedderich_chapter_9_unnumbered_16(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = (x1 +x2 +...) + (y1 +y2 +...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u16')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u16: GeneralStatistics expression (auto-extracted; see ref)."
