# describe('hrzaml') — horowitz_additive_nonid_link
...
`print(result)` render. See `moirais.fn.describe('hrzaml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzaml import *
import numpy as np
# See the function signature in fn/hrzaml.py for argument names.
```
