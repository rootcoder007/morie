# describe('hmdbrt') — geron_distilbert
...
`print(result)` render. See `moirais.fn.describe('hmdbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdbrt import *
import numpy as np
# See the function signature in fn/hmdbrt.py for argument names.
```
