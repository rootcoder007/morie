...
`print(result)` render. See `moirais.fn.describe('maeggr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maeggr import *
import numpy as np
# See the function signature in fn/maeggr.py for argument names.
```
