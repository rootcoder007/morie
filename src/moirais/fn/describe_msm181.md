# describe('msm181') — mvsml_ridge_lasso_elastic_eq_9_6
...
`print(result)` render. See `moirais.fn.describe('msm181')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm181 import *
import numpy as np
# See the function signature in fn/msm181.py for argument names.
```
