# describe('hmnmt') — geron_encoder_decoder_nmt
...
`print(result)` render. See `moirais.fn.describe('hmnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnmt import *
import numpy as np
# See the function signature in fn/hmnmt.py for argument names.
```
