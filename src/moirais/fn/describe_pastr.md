...
`print(result)` render. See `moirais.fn.describe('pastr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pastr import *
import numpy as np
# See the function signature in fn/pastr.py for argument names.
```
