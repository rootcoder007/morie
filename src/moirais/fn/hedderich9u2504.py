...
__all__ = ["hedderich_chapter_9_unnumbered_2504"]


def hedderich_chapter_9_unnumbered_2504(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + c a t( " Jonckheere − Terpstratest : " , " statistic =" ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2504')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2504: GeneralStatistics expression (auto-extracted; see ref)."
