...
`print(result)` render. See `moirais.fn.describe('ptnni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptnni import *
import numpy as np
# See the function signature in fn/ptnni.py for argument names.
```
