# describe('gb_rng') — gibbons_range_dist
...
`print(result)` render. See `moirais.fn.describe('gb_rng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_rng import *
import numpy as np
# See the function signature in fn/gb_rng.py for argument names.
```
