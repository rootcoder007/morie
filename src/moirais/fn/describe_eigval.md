...
`print(result)` render. See `moirais.fn.describe('eigval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigval import *
import numpy as np
# See the function signature in fn/eigval.py for argument names.
```
