...
`print(result)` render. See `moirais.fn.describe('maest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maest import *
import numpy as np
# See the function signature in fn/maest.py for argument names.
```
