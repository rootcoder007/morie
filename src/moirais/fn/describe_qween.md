...
`print(result)` render. See `moirais.fn.describe('qween')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qween import *
import numpy as np
# See the function signature in fn/qween.py for argument names.
```
