# describe('dstcm') — distance_comparison
...
`print(result)` render. See `moirais.fn.describe('dstcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dstcm import *
import numpy as np
# See the function signature in fn/dstcm.py for argument names.
```
