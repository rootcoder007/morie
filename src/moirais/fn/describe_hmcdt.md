# describe('hmcdt') — geron_classification_tree
...
`print(result)` render. See `moirais.fn.describe('hmcdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcdt import *
import numpy as np
# See the function signature in fn/hmcdt.py for argument names.
```
