# describe('manut') — manut

## WHAT IT DOES

Nutrient marine spatial
...
`print(result)` render. See `moirais.fn.describe('manut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manut import *
import numpy as np
# See the function signature in fn/manut.py for argument names.
```
