...
`print(result)` render. See `moirais.fn.describe('dcchy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcchy import *
import numpy as np
# See the function signature in fn/dcchy.py for argument names.
```
