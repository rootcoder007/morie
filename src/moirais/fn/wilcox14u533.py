...
__all__ = ["wilcox_chapter_14_unnumbered_533"]


def wilcox_chapter_14_unnumbered_533(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A 1 − α confidence interval for µ 1 − µ 2 is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u533')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u533: GeneralStatistics expression (auto-extracted; see ref)."
