...
`print(result)` render. See `moirais.fn.describe('gepvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gepvt import *
import numpy as np
# See the function signature in fn/gepvt.py for argument names.
```
