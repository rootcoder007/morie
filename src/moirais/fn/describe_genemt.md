# describe('genemt') — gene_meta_analysis
...
`print(result)` render. See `moirais.fn.describe('genemt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.genemt import *
import numpy as np
# See the function signature in fn/genemt.py for argument names.
```
