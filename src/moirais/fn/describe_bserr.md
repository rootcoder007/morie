...
`print(result)` render. See `moirais.fn.describe('bserr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bserr import *
import numpy as np
# See the function signature in fn/bserr.py for argument names.
```
