...
`print(result)` render. See `moirais.fn.describe('ptpcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptpcf import *
import numpy as np
# See the function signature in fn/ptpcf.py for argument names.
```
