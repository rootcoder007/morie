# describe('nvect') — normal_vector_projection
...
`print(result)` render. See `moirais.fn.describe('nvect')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nvect import *
import numpy as np
# See the function signature in fn/nvect.py for argument names.
```
