# describe('evextidx') — evt_extremal_index_runs
...
`print(result)` render. See `moirais.fn.describe('evextidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evextidx import *
import numpy as np
# See the function signature in fn/evextidx.py for argument names.
```
