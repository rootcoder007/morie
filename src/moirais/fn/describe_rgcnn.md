# describe('rgcnn') — rangayyan_cnn_signal
...
`print(result)` render. See `moirais.fn.describe('rgcnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcnn import *
import numpy as np
# See the function signature in fn/rgcnn.py for argument names.
```
