# describe('polyCh') — chebyshev_basis
...
`print(result)` render. See `moirais.fn.describe('polyCh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polyCh import *
import numpy as np
# See the function signature in fn/polyCh.py for argument names.
```
