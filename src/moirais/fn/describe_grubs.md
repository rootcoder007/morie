...
`print(result)` render. See `moirais.fn.describe('grubs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grubs import *
import numpy as np
# See the function signature in fn/grubs.py for argument names.
```
