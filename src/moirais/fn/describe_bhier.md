# describe('bhier') — bayesian_hierarchical
...
`print(result)` render. See `moirais.fn.describe('bhier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhier import *
import numpy as np
# See the function signature in fn/bhier.py for argument names.
```
