# describe('rgmcn') — rangayyan_mcnemar_test
...
`print(result)` render. See `moirais.fn.describe('rgmcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmcn import *
import numpy as np
# See the function signature in fn/rgmcn.py for argument names.
```
