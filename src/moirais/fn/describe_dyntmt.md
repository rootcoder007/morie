# describe('dyntmt') — dynamic_marginal_msm
...
`print(result)` render. See `moirais.fn.describe('dyntmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dyntmt import *
import numpy as np
# See the function signature in fn/dyntmt.py for argument names.
```
