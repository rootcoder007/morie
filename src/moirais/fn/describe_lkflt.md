...
`print(result)` render. See `moirais.fn.describe('lkflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lkflt import *
import numpy as np
# See the function signature in fn/lkflt.py for argument names.
```
