...
`print(result)` render. See `moirais.fn.describe('rnzonl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnzonl import *
import numpy as np
# See the function signature in fn/rnzonl.py for argument names.
```
