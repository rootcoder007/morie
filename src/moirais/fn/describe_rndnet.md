# describe('rndnet') — random_network_distillation
...
`print(result)` render. See `moirais.fn.describe('rndnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rndnet import *
import numpy as np
# See the function signature in fn/rndnet.py for argument names.
```
