# describe('rgldsp') — rangayyan_dictionary_sparse
...
`print(result)` render. See `moirais.fn.describe('rgldsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgldsp import *
import numpy as np
# See the function signature in fn/rgldsp.py for argument names.
```
