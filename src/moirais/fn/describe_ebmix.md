...
`print(result)` render. See `moirais.fn.describe('ebmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ebmix import *
import numpy as np
# See the function signature in fn/ebmix.py for argument names.
```
