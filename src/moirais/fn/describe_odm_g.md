# describe('odm_g') — otis_demo_gender
...
`print(result)` render. See `moirais.fn.describe('odm_g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_g import *
import numpy as np
# See the function signature in fn/odm_g.py for argument names.
```
