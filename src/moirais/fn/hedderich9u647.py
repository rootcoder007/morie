...
__all__ = ["hedderich_chapter_9_unnumbered_647"]


def hedderich_chapter_9_unnumbered_647(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =P (−1.963<Z 1≤0.346).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u647')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u647: GeneralStatistics expression (auto-extracted; see ref)."
