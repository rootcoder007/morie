# describe('crfhte') — causal_forest_hte_test
...
`print(result)` render. See `moirais.fn.describe('crfhte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crfhte import *
import numpy as np
# See the function signature in fn/crfhte.py for argument names.
```
