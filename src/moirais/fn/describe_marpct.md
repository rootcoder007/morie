# describe('marpct') — ma_percent_heterogeneity_R2
...
`print(result)` render. See `moirais.fn.describe('marpct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.marpct import *
import numpy as np
# See the function signature in fn/marpct.py for argument names.
```
