# describe('grcos') — geron_conv_output_size
...
`print(result)` render. See `moirais.fn.describe('grcos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcos import *
import numpy as np
# See the function signature in fn/grcos.py for argument names.
```
