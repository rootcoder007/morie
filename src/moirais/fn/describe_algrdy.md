# describe('algrdy') — alammar_greedy_decoding
...
`print(result)` render. See `moirais.fn.describe('algrdy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.algrdy import *
import numpy as np
# See the function signature in fn/algrdy.py for argument names.
```
