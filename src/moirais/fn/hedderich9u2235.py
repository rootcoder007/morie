...
__all__ = ["hedderich_chapter_9_unnumbered_2235"]


def hedderich_chapter_9_unnumbered_2235(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: among exposed individuals is at least twice as high (α=0.05 one-sided andβ=0.20, power 80%).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2235')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2235: GeneralStatistics expression (auto-extracted; see ref)."
