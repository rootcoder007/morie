# describe('gphtr') — gp_heteroscedastic
...
`print(result)` render. See `moirais.fn.describe('gphtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gphtr import *
import numpy as np
# See the function signature in fn/gphtr.py for argument names.
```
