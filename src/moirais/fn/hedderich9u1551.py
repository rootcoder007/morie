...
__all__ = ["hedderich_chapter_9_unnumbered_1551"]


def hedderich_chapter_9_unnumbered_1551(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: λ·exp (−λx) Gamma(k0, λ0) k∗= k0 + n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1551')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1551: CountModels expression (auto-extracted; see ref)."
