...
`print(result)` render. See `moirais.fn.describe('bbr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbr2 import *
import numpy as np
# See the function signature in fn/bbr2.py for argument names.
```
