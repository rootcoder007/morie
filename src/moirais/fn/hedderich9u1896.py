...
__all__ = ["hedderich_chapter_9_unnumbered_1896"]


def hedderich_chapter_9_unnumbered_1896(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + names ( prop ) = " Upword trend , P− value "
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1896')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1896: GeneralStatistics expression (auto-extracted; see ref)."
