...
__all__ = ["wilcox_chapter_14_unnumbered_560"]


def wilcox_chapter_14_unnumbered_560(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: An estimate of δ =P (Xi1 >X i2) − P (Xi1 <X i2) is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u560')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u560: GeneralStatistics expression (auto-extracted; see ref)."
