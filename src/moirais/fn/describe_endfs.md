...
`print(result)` render. See `moirais.fn.describe('endfs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.endfs import *
import numpy as np
# See the function signature in fn/endfs.py for argument names.
```
