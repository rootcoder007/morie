...
__all__ = ["stochastic_physics_section_3_unnumbered_15"]


def stochastic_physics_section_3_unnumbered_15(x):
    """
    GeneralStochastic expression (auto-extracted; see reference).

    Formula: areh = 0.3,τ = 1.5 andθ = 0.35, which indicates that the most
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('sp_s3u15')`` for the full guide.
...
def cheatsheet():
    return "sp_s3u15: GeneralStochastic expression (auto-extracted; see reference)."
