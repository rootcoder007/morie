# describe('spspec2') — schabenberger_spectral_sim
...
`print(result)` render. See `moirais.fn.describe('spspec2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spspec2 import *
import numpy as np
# See the function signature in fn/spspec2.py for argument names.
```
