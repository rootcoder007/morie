...
`print(result)` render. See `moirais.fn.describe('svmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmc import *
import numpy as np
# See the function signature in fn/svmc.py for argument names.
```
