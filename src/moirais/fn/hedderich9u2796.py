...
__all__ = ["hedderich_chapter_9_unnumbered_2796"]


def hedderich_chapter_9_unnumbered_2796(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] dimnames = list ( c ( "+" , " −" ) , c ( "+" , " −" ) ) ) ; holiday
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2796')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2796: GeneralStatistics expression (auto-extracted; see ref)."
