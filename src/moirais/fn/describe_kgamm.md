...
`print(result)` render. See `moirais.fn.describe('kgamm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgamm import *
import numpy as np
# See the function signature in fn/kgamm.py for argument names.
```
