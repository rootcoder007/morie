...
`print(result)` render. See `moirais.fn.describe('mginv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mginv import *
import numpy as np
# See the function signature in fn/mginv.py for argument names.
```
