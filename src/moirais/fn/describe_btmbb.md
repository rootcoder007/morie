# describe('btmbb') — boot_moving_block
...
`print(result)` render. See `moirais.fn.describe('btmbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btmbb import *
import numpy as np
# See the function signature in fn/btmbb.py for argument names.
```
