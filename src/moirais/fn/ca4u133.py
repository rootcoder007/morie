...
def ca_chapter_4_unnumbered_133(x):
    """
    Regression expression involving 'characteristics' (auto-extracted; see reference for full context).

    Formula: Sex (1 = male, 0 = female) 0.44 0.50 − 0.42 0.19
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca4u133')`` for the full guide.
    ...
    return RichResult(
        title="Regression expression involving 'characteristics' (auto-extracted; see reference for full context).",
        summary_lines=[
            ("Estimate", result),
            ("Standard error", se),
            ("n", n),
