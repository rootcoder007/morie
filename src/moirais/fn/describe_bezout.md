...
`print(result)` render. See `moirais.fn.describe('bezout')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bezout import *
import numpy as np
# See the function signature in fn/bezout.py for argument names.
```
