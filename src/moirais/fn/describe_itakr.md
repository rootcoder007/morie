...
`print(result)` render. See `moirais.fn.describe('itakr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itakr import *
import numpy as np
# See the function signature in fn/itakr.py for argument names.
```
