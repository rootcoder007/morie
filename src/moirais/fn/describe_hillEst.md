# describe('hillEst') — hill_estimator
...
`print(result)` render. See `moirais.fn.describe('hillEst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hillEst import *
import numpy as np
# See the function signature in fn/hillEst.py for argument names.
```
