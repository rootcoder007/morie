# describe('crrcim') — cumulative_incidence
...
`print(result)` render. See `moirais.fn.describe('crrcim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crrcim import *
import numpy as np
# See the function signature in fn/crrcim.py for argument names.
```
