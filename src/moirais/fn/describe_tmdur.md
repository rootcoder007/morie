...
`print(result)` render. See `moirais.fn.describe('tmdur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmdur import *
import numpy as np
# See the function signature in fn/tmdur.py for argument names.
```
