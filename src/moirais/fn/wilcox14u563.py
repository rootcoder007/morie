...
__all__ = ["wilcox_chapter_14_unnumbered_563"]


def wilcox_chapter_14_unnumbered_563(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u563')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u563: GeneralStatistics expression (auto-extracted; see ref)."
