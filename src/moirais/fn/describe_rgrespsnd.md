# describe('rgrespsnd') — rangayyan_respiratory_sound
...
`print(result)` render. See `moirais.fn.describe('rgrespsnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrespsnd import *
import numpy as np
# See the function signature in fn/rgrespsnd.py for argument names.
```
