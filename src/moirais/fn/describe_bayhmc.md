...
`print(result)` render. See `moirais.fn.describe('bayhmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayhmc import *
import numpy as np
# See the function signature in fn/bayhmc.py for argument names.
```
