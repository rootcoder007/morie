# describe('esldct') — esl_decision_tree
...
`print(result)` render. See `moirais.fn.describe('esldct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esldct import *
import numpy as np
# See the function signature in fn/esldct.py for argument names.
```
