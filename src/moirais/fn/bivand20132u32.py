...
__all__ = ["bivand2013_chapter_2_unnumbered_32"]


def bivand2013_chapter_2_unnumbered_32(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +a=6370997 +b=6370997 +units=m +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u32')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u32: GeneralStatistics expression (auto-extracted; see ref)."
