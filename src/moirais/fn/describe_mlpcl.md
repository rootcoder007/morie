...
`print(result)` render. See `moirais.fn.describe('mlpcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlpcl import *
import numpy as np
# See the function signature in fn/mlpcl.py for argument names.
```
