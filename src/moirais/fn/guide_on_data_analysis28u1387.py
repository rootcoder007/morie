...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1387"]


def guide_on_data_analysis_chapter_28_unnumbered_1387(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: plot(df_full$t, df_full $Y, pch=16,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1387')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1387: GeneralStatistics expression (auto-extracted; see ref)."
