# describe('msm313') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm313')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm313 import *
import numpy as np
# See the function signature in fn/msm313.py for argument names.
```
