...
__all__ = ["hedderich_chapter_9_unnumbered_540"]


def hedderich_chapter_9_unnumbered_540(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (4) P (X≥a) = 1−F (a) +P (X =a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u540')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u540: CountModels expression (auto-extracted; see ref)."
