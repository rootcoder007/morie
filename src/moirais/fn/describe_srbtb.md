...
`print(result)` render. See `moirais.fn.describe('srbtb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbtb import *
import numpy as np
# See the function signature in fn/srbtb.py for argument names.
```
