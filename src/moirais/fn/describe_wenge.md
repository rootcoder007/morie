# describe('wenge') — weight_based_mediation
...
`print(result)` render. See `moirais.fn.describe('wenge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wenge import *
import numpy as np
# See the function signature in fn/wenge.py for argument names.
```
