...
`print(result)` render. See `moirais.fn.describe('storm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.storm import *
import numpy as np
# See the function signature in fn/storm.py for argument names.
```
