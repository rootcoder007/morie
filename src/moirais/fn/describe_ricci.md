...
`print(result)` render. See `moirais.fn.describe('ricci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ricci import *
import numpy as np
# See the function signature in fn/ricci.py for argument names.
```
