# describe('causipsw0') — causal_iptw_atoweights
...
`print(result)` render. See `moirais.fn.describe('causipsw0')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causipsw0 import *
import numpy as np
# See the function signature in fn/causipsw0.py for argument names.
```
