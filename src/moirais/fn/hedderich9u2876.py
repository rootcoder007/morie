...
__all__ = ["hedderich_chapter_9_unnumbered_2876"]


def hedderich_chapter_9_unnumbered_2876(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the less extreme relative frequencies are compared, i.e., H0 : π1 = πk−1 andH0 : π2 = πk,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2876')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2876: GeneralStatistics expression (auto-extracted; see ref)."
