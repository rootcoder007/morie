...
`print(result)` render. See `moirais.fn.describe('plnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plnet import *
import numpy as np
# See the function signature in fn/plnet.py for argument names.
```
