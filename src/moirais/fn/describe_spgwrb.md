# describe('spgwrb') — schabenberger_gwr_bandwidth
...
`print(result)` render. See `moirais.fn.describe('spgwrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgwrb import *
import numpy as np
# See the function signature in fn/spgwrb.py for argument names.
```
