# describe('drblr') — doubly_robust_learner
...
`print(result)` render. See `moirais.fn.describe('drblr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drblr import *
import numpy as np
# See the function signature in fn/drblr.py for argument names.
```
