# describe('kmbsco') — kamath_bertscore
...
`print(result)` render. See `moirais.fn.describe('kmbsco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmbsco import *
import numpy as np
# See the function signature in fn/kmbsco.py for argument names.
```
