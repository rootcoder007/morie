...
__all__ = ["hedderich_chapter_9_unnumbered_3146"]


def hedderich_chapter_9_unnumbered_3146(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Since ˆχ2 = 1.83 is significantly smaller thanχ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3146')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3146: GeneralStatistics expression (auto-extracted; see ref)."
