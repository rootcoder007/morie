# describe('rglindsep') — rangayyan_lin_discr_sep
...
`print(result)` render. See `moirais.fn.describe('rglindsep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglindsep import *
import numpy as np
# See the function signature in fn/rglindsep.py for argument names.
```
