...
`print(result)` render. See `moirais.fn.describe('archtt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.archtt import *
import numpy as np
# See the function signature in fn/archtt.py for argument names.
```
