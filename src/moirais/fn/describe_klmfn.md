# describe('klmfn') — kalman_filter_fn
...
`print(result)` render. See `moirais.fn.describe('klmfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klmfn import *
import numpy as np
# See the function signature in fn/klmfn.py for argument names.
```
