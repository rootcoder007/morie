...
__all__ = ["hedderich_chapter_9_unnumbered_2645"]


def hedderich_chapter_9_unnumbered_2645(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] π1(1−π1) +π2(1−π2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2645')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2645: PowerAndDesign expression (auto-extracted; see ref)."
