# describe('nmdwt') — dwnominate_trend
...
`print(result)` render. See `moirais.fn.describe('nmdwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmdwt import *
import numpy as np
# See the function signature in fn/nmdwt.py for argument names.
```
