...
`print(result)` render. See `moirais.fn.describe('att')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.att import *
import numpy as np
# See the function signature in fn/att.py for argument names.
```
