...
__all__ = ["hedderich_chapter_9_unnumbered_3671"]


def hedderich_chapter_9_unnumbered_3671(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : β1 =β2 . . . . . . . . . . . . . . . . . . . . .790
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3671')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3671: GeneralStatistics expression (auto-extracted; see ref)."
