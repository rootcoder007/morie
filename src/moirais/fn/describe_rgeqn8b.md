# describe('rgeqn8b') — rangayyan_ch8_glr_threshold
...
`print(result)` render. See `moirais.fn.describe('rgeqn8b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn8b import *
import numpy as np
# See the function signature in fn/rgeqn8b.py for argument names.
```
