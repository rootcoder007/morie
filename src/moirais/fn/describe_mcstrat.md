...
`print(result)` render. See `moirais.fn.describe('mcstrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcstrat import *
import numpy as np
# See the function signature in fn/mcstrat.py for argument names.
```
