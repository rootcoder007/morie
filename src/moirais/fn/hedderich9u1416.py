...
__all__ = ["hedderich_chapter_9_unnumbered_1416"]


def hedderich_chapter_9_unnumbered_1416(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: x=16 according to ( 6.148):Bx=const.=tsy·x·
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1416')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1416: GeneralStatistics expression (auto-extracted; see ref)."
