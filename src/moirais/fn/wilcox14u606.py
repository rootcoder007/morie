...
__all__ = ["wilcox_chapter_14_unnumbered_606"]


def wilcox_chapter_14_unnumbered_606(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1− α/ 2 where z1− α/ 2 is the 1 − α quantile of a standard normal distribution. (So
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u606')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u606: GeneralStatistics expression (auto-extracted; see ref)."
