# describe('rgqrs') — rangayyan_qrs_detect
...
`print(result)` render. See `moirais.fn.describe('rgqrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgqrs import *
import numpy as np
# See the function signature in fn/rgqrs.py for argument names.
```
