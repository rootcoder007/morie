...
`print(result)` render. See `moirais.fn.describe('gsrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gsrch import *
import numpy as np
# See the function signature in fn/gsrch.py for argument names.
```
