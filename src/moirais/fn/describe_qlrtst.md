# describe('qlrtst') — quandt_likelihood_ratio
...
`print(result)` render. See `moirais.fn.describe('qlrtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qlrtst import *
import numpy as np
# See the function signature in fn/qlrtst.py for argument names.
```
