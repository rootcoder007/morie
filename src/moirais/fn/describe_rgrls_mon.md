# describe('rgrls_mon') — rangayyan_rls_monitor
...
`print(result)` render. See `moirais.fn.describe('rgrls_mon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgrls_mon import *
import numpy as np
# See the function signature in fn/rgrls_mon.py for argument names.
```
