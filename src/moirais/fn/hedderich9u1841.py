...
__all__ = ["hedderich_chapter_9_unnumbered_1841"]


def hedderich_chapter_9_unnumbered_1841(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆRn = 8 + 7 + ...+ 2 = 26
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1841')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1841: GeneralStatistics expression (auto-extracted; see ref)."
