# describe('rgexecg') — rangayyan_exercise_ecg
...
`print(result)` render. See `moirais.fn.describe('rgexecg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgexecg import *
import numpy as np
# See the function signature in fn/rgexecg.py for argument names.
```
