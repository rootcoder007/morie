...
__all__ = ["hedderich_chapter_9_unnumbered_3564"]


def hedderich_chapter_9_unnumbered_3564(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (t) = λ·exp(−λ·t) with λ=λ0·exp(X′β)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3564')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3564: GeneralStatistics expression (auto-extracted; see ref)."
