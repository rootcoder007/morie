# describe('spwgts') — spline_weights
...
`print(result)` render. See `moirais.fn.describe('spwgts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spwgts import *
import numpy as np
# See the function signature in fn/spwgts.py for argument names.
```
