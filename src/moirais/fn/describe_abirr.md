...
`print(result)` render. See `moirais.fn.describe('abirr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abirr import *
import numpy as np
# See the function signature in fn/abirr.py for argument names.
```
