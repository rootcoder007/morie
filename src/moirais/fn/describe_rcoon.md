# describe('rcoon') — hohmann_transfer
...
`print(result)` render. See `moirais.fn.describe('rcoon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcoon import *
import numpy as np
# See the function signature in fn/rcoon.py for argument names.
```
