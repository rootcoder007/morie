...
`print(result)` render. See `moirais.fn.describe('fdiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdiff import *
import numpy as np
# See the function signature in fn/fdiff.py for argument names.
```
