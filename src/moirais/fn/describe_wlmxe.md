...
`print(result)` render. See `moirais.fn.describe('wlmxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlmxe import *
import numpy as np
# See the function signature in fn/wlmxe.py for argument names.
```
