...
__all__ = ["hedderich_chapter_9_unnumbered_673"]


def hedderich_chapter_9_unnumbered_673(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > P <− rep (NA, 1 5 ) ; f o r ( i i n 1 : 1 5 ) P [ i ] <− dmultinom (M[ , i ] , prob =p )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u673')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u673: GeneralStatistics expression (auto-extracted; see ref)."
