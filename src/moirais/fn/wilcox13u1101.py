...
__all__ = ["wilcox_chapter_13_unnumbered_1101"]


def wilcox_chapter_13_unnumbered_1101(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: can include the intercept term. For example, setting grp=c(0,3) will test H0: β 0 =β 3 = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1101')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1101: GeneralStatistics expression (auto-extracted; see ref)."
