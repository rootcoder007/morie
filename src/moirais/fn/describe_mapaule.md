# describe('mapaule') — ma_paule_mandel
...
`print(result)` render. See `moirais.fn.describe('mapaule')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mapaule import *
import numpy as np
# See the function signature in fn/mapaule.py for argument names.
```
