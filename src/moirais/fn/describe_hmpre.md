# describe('hmpre') — geron_precision
...
`print(result)` render. See `moirais.fn.describe('hmpre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpre import *
import numpy as np
# See the function signature in fn/hmpre.py for argument names.
```
