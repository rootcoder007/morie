# describe('doctide') — de_chaisemartin_dhaultfoeuille
...
`print(result)` render. See `moirais.fn.describe('doctide')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.doctide import *
import numpy as np
# See the function signature in fn/doctide.py for argument names.
```
