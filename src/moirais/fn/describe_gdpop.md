...
`print(result)` render. See `moirais.fn.describe('gdpop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdpop import *
import numpy as np
# See the function signature in fn/gdpop.py for argument names.
```
