...
`print(result)` render. See `moirais.fn.describe('pwrdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwrdb import *
import numpy as np
# See the function signature in fn/pwrdb.py for argument names.
```
