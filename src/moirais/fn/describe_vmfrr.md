...
`print(result)` render. See `moirais.fn.describe('vmfrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmfrr import *
import numpy as np
# See the function signature in fn/vmfrr.py for argument names.
```
