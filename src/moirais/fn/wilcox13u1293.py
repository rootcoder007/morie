...
__all__ = ["wilcox_chapter_13_unnumbered_1293"]


def wilcox_chapter_13_unnumbered_1293(x):
    """
    MetaAnalysis expression (auto-extracted; see ref).

    Formula: [EQ] ∑ ∑ (pij − pi+pj+)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1293')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1293: MetaAnalysis expression (auto-extracted; see ref)."
