# describe('hmrwd') — geron_reward_function
...
`print(result)` render. See `moirais.fn.describe('hmrwd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrwd import *
import numpy as np
# See the function signature in fn/hmrwd.py for argument names.
```
