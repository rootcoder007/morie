...
`print(result)` render. See `moirais.fn.describe('ppstg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppstg import *
import numpy as np
# See the function signature in fn/ppstg.py for argument names.
```
