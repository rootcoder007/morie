# describe('rgbp') — rangayyan_basis_pursuit
...
`print(result)` render. See `moirais.fn.describe('rgbp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbp import *
import numpy as np
# See the function signature in fn/rgbp.py for argument names.
```
