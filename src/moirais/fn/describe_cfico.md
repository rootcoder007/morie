...
`print(result)` render. See `moirais.fn.describe('cfico')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfico import *
import numpy as np
# See the function signature in fn/cfico.py for argument names.
```
