# describe('unitnr') — unit_nonresponse
...
`print(result)` render. See `moirais.fn.describe('unitnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unitnr import *
import numpy as np
# See the function signature in fn/unitnr.py for argument names.
```
