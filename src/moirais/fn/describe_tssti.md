...
`print(result)` render. See `moirais.fn.describe('tssti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssti import *
import numpy as np
# See the function signature in fn/tssti.py for argument names.
```
