# describe('hmdfw') — geron_diffusion_forward
...
`print(result)` render. See `moirais.fn.describe('hmdfw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdfw import *
import numpy as np
# See the function signature in fn/hmdfw.py for argument names.
```
