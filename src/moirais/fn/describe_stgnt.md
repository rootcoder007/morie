...
`print(result)` render. See `moirais.fn.describe('stgnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stgnt import *
import numpy as np
# See the function signature in fn/stgnt.py for argument names.
```
