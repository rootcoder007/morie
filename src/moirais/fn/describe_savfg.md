# describe('savfg') — save_figure

## WHAT IT DOES

Save figure helper. 'You have power over your mind. — Marcus Aurelius'
...
`print(result)` render. See `moirais.fn.describe('savfg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.savfg import *
import numpy as np
# See the function signature in fn/savfg.py for argument names.
```
