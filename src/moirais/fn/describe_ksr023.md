# describe('ksr023') — kosorok_ch1_cox_estimating_equation
...
`print(result)` render. See `moirais.fn.describe('ksr023')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr023 import *
import numpy as np
# See the function signature in fn/ksr023.py for argument names.
```
