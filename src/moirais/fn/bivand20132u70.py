...
__all__ = ["bivand2013_chapter_2_unnumbered_70"]


def bivand2013_chapter_2_unnumbered_70(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > length(rnGI) == length(unique(rnGI))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u70')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u70: GeneralStatistics expression (auto-extracted; see ref)."
