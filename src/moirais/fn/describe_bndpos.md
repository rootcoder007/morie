# describe('bndpos') — bound_pos_treatment
...
`print(result)` render. See `moirais.fn.describe('bndpos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndpos import *
import numpy as np
# See the function signature in fn/bndpos.py for argument names.
```
