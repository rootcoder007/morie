...
__all__ = ["hedderich_chapter_9_unnumbered_2562"]


def hedderich_chapter_9_unnumbered_2562(x):
    """
    Multilevel expression (auto-extracted; see ref).

    Formula: SAQtotal =SAQA +SAQB +SAQA×B +SAQin with
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2562')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2562: Multilevel expression (auto-extracted; see ref)."
