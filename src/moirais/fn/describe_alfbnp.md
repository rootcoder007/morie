# describe('alfbnp') — af3_protein_ligand
...
`print(result)` render. See `moirais.fn.describe('alfbnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfbnp import *
import numpy as np
# See the function signature in fn/alfbnp.py for argument names.
```
