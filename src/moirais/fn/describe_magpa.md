# describe('magpa') — ma_glmm_ipd_proportion
...
`print(result)` render. See `moirais.fn.describe('magpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magpa import *
import numpy as np
# See the function signature in fn/magpa.py for argument names.
```
