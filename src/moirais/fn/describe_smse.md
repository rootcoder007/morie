# describe('smse') — mean_squared_error
...
`print(result)` render. See `moirais.fn.describe('smse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smse import *
import numpy as np
# See the function signature in fn/smse.py for argument names.
```
