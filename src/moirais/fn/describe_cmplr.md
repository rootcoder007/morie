...
`print(result)` render. See `moirais.fn.describe('cmplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmplr import *
import numpy as np
# See the function signature in fn/cmplr.py for argument names.
```
