...
`print(result)` render. See `moirais.fn.describe('hmmnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmnr import *
import numpy as np
# See the function signature in fn/hmmnr.py for argument names.
```
