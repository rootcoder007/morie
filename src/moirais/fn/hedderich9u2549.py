...
__all__ = ["hedderich_chapter_9_unnumbered_2549"]


def hedderich_chapter_9_unnumbered_2549(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 3.12>z 0,95 = 1.645
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2549')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2549: GeneralStatistics expression (auto-extracted; see ref)."
