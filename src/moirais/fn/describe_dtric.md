...
`print(result)` render. See `moirais.fn.describe('dtric')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtric import *
import numpy as np
# See the function signature in fn/dtric.py for argument names.
```
