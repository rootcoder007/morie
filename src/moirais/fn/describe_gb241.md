# describe('gb241') — gibbons_order_cdf
...
`print(result)` render. See `moirais.fn.describe('gb241')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb241 import *
import numpy as np
# See the function signature in fn/gb241.py for argument names.
```
