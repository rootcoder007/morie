...
`print(result)` render. See `moirais.fn.describe('vtblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtblk import *
import numpy as np
# See the function signature in fn/vtblk.py for argument names.
```
