...
__all__ = ["hedderich_chapter_9_unnumbered_2667"]


def hedderich_chapter_9_unnumbered_2667(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: differenceπ1−π2 = 0.9−0.1 = 0.8 withn1 =n2 = 6 is rather trivial.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2667')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2667: GeneralStatistics expression (auto-extracted; see ref)."
