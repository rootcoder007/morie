# describe('mainf') — ma_influence_diagnostics
...
`print(result)` render. See `moirais.fn.describe('mainf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mainf import *
import numpy as np
# See the function signature in fn/mainf.py for argument names.
```
