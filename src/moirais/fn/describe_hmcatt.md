# describe('hmcatt') — geron_cross_attention
...
`print(result)` render. See `moirais.fn.describe('hmcatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcatt import *
import numpy as np
# See the function signature in fn/hmcatt.py for argument names.
```
