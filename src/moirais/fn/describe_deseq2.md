# describe('deseq2') — deseq2_differential
...
`print(result)` render. See `moirais.fn.describe('deseq2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deseq2 import *
import numpy as np
# See the function signature in fn/deseq2.py for argument names.
```
