...
`print(result)` render. See `moirais.fn.describe('wvscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvscl import *
import numpy as np
# See the function signature in fn/wvscl.py for argument names.
```
