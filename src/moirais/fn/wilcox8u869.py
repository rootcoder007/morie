...
__all__ = ["wilcox_chapter_8_unnumbered_869"]


def wilcox_chapter_8_unnumbered_869(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ifF ≥ f1−α , or if A =B, where f1−α is the 1 − α of an F distribution with ν 1 =J − 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u869')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u869: GeneralStatistics expression (auto-extracted; see ref)."
