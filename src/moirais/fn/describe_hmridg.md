# describe('hmridg') — geron_ridge_cost
...
`print(result)` render. See `moirais.fn.describe('hmridg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmridg import *
import numpy as np
# See the function signature in fn/hmridg.py for argument names.
```
