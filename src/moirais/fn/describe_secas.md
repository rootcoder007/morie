...
`print(result)` render. See `moirais.fn.describe('secas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secas import *
import numpy as np
# See the function signature in fn/secas.py for argument names.
```
