# describe('hrzplr') — horowitz_robinson_plr
...
`print(result)` render. See `moirais.fn.describe('hrzplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzplr import *
import numpy as np
# See the function signature in fn/hrzplr.py for argument names.
```
