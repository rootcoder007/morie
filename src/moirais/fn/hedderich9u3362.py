...
__all__ = ["hedderich_chapter_9_unnumbered_3362"]


def hedderich_chapter_9_unnumbered_3362(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The statistic ˆG is distributed like χ2 under the null hypothesis H0: β1 = 0 with one degree of
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3362')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3362: GeneralStatistics expression (auto-extracted; see ref)."
