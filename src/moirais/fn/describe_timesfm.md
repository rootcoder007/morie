...
`print(result)` render. See `moirais.fn.describe('timesfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.timesfm import *
import numpy as np
# See the function signature in fn/timesfm.py for argument names.
```
