# describe('alfreq') — alphafold_recycling
...
`print(result)` render. See `moirais.fn.describe('alfreq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfreq import *
import numpy as np
# See the function signature in fn/alfreq.py for argument names.
```
