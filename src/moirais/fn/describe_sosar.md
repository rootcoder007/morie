...
`print(result)` render. See `moirais.fn.describe('sosar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosar import *
import numpy as np
# See the function signature in fn/sosar.py for argument names.
```
