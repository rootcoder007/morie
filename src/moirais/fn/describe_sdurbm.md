# describe('sdurbm') — spatial_durbin_model
...
`print(result)` render. See `moirais.fn.describe('sdurbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdurbm import *
import numpy as np
# See the function signature in fn/sdurbm.py for argument names.
```
