...
__all__ = ["hedderich_chapter_9_unnumbered_2601"]


def hedderich_chapter_9_unnumbered_2601(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Do the frequenciesa=6 andb=25 correspond to the ratioξ=β/α=5/1 (α=0.05)?
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2601')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2601: GeneralStatistics expression (auto-extracted; see ref)."
