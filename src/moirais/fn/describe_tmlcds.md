...
`print(result)` render. See `moirais.fn.describe('tmlcds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcds import *
import numpy as np
# See the function signature in fn/tmlcds.py for argument names.
```
