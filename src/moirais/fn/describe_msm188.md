# describe('msm188') — mvsml_ridge_lasso_elastic_eq_9_15
...
`print(result)` render. See `moirais.fn.describe('msm188')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm188 import *
import numpy as np
# See the function signature in fn/msm188.py for argument names.
```
