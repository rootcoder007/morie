...
`print(result)` render. See `moirais.fn.describe('ghmxc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghmxc import *
import numpy as np
# See the function signature in fn/ghmxc.py for argument names.
```
