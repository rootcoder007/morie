...
`print(result)` render. See `moirais.fn.describe('svpap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpap import *
import numpy as np
# See the function signature in fn/svpap.py for argument names.
```
