...
`print(result)` render. See `moirais.fn.describe('dk3dr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3dr import *
import numpy as np
# See the function signature in fn/dk3dr.py for argument names.
```
