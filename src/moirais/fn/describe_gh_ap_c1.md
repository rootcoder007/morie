# describe('gh_ap_c1') — ghosal_covering_num
...
`print(result)` render. See `moirais.fn.describe('gh_ap_c1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_c1 import *
import numpy as np
# See the function signature in fn/gh_ap_c1.py for argument names.
```
