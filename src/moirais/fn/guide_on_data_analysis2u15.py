...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_15"]


def guide_on_data_analysis_chapter_2_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u15')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u15: GeneralStatistics expression (auto-extracted; see ref)."
