...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1347"]


def guide_on_data_analysis_chapter_27_unnumbered_1347(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌 (0)|𝑋 = 𝑥, 𝐶𝑖 = 𝑐] =lim
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1347')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1347: GeneralStatistics expression (auto-extracted; see ref)."
