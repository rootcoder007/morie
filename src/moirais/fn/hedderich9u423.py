...
__all__ = ["hedderich_chapter_9_unnumbered_423"]


def hedderich_chapter_9_unnumbered_423(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b) P (M∩F ) +P (M∩¯F ) +P ( ¯M∩F ) = 0.3858 + 0.1543 + 0.3285 = 0.8686 or
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u423')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u423: GeneralStatistics expression (auto-extracted; see ref)."
