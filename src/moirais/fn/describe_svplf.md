# describe('svplf') — polarization_aff
...
`print(result)` render. See `moirais.fn.describe('svplf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svplf import *
import numpy as np
# See the function signature in fn/svplf.py for argument names.
```
