...
`print(result)` render. See `moirais.fn.describe('ctrfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctrfn import *
import numpy as np
# See the function signature in fn/ctrfn.py for argument names.
```
