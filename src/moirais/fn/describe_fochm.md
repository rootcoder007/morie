...
`print(result)` render. See `moirais.fn.describe('fochm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fochm import *
import numpy as np
# See the function signature in fn/fochm.py for argument names.
```
