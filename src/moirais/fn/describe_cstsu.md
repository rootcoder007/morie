# describe('cstsu') — custody_substance
...
`print(result)` render. See `moirais.fn.describe('cstsu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstsu import *
import numpy as np
# See the function signature in fn/cstsu.py for argument names.
```
