# describe('rgeqn7a') — rangayyan_ch7_ar_prediction_err
...
`print(result)` render. See `moirais.fn.describe('rgeqn7a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn7a import *
import numpy as np
# See the function signature in fn/rgeqn7a.py for argument names.
```
