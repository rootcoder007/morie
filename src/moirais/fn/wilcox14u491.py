...
__all__ = ["wilcox_chapter_14_unnumbered_491"]


def wilcox_chapter_14_unnumbered_491(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: qregci(x, y, nboot = 100, alpha = 0.05, qval = 0.5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u491')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u491: GeneralStatistics expression (auto-extracted; see ref)."
