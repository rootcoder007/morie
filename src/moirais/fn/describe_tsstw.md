...
`print(result)` render. See `moirais.fn.describe('tsstw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstw import *
import numpy as np
# See the function signature in fn/tsstw.py for argument names.
```
