# describe('gh_ap_k2') — ghosal_assouad_lemma
...
`print(result)` render. See `moirais.fn.describe('gh_ap_k2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_k2 import *
import numpy as np
# See the function signature in fn/gh_ap_k2.py for argument names.
```
