# describe('fzchsp') — fauzi_chung_smirnov
...
`print(result)` render. See `moirais.fn.describe('fzchsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzchsp import *
import numpy as np
# See the function signature in fn/fzchsp.py for argument names.
```
