...
`print(result)` render. See `moirais.fn.describe('gpdkl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpdkl import *
import numpy as np
# See the function signature in fn/gpdkl.py for argument names.
```
