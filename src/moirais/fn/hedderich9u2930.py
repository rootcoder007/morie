...
__all__ = ["hedderich_chapter_9_unnumbered_2930"]


def hedderich_chapter_9_unnumbered_2930(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: In the test statistic, only the summands are recorded in which the numerator (Xi−niπ0)> 0 or
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2930')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2930: GeneralStatistics expression (auto-extracted; see ref)."
