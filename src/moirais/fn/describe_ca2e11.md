# describe('ca2e11') — ca_chapter_2_equation_11
...
```python
from moirais.fn.ca2e11 import ca_chapter_2_equation_11
import numpy as np
result = ca_chapter_2_equation_11(np.random.default_rng(42).normal(0, 1, 100))
