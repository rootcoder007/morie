...
__all__ = ["hedderich_chapter_9_unnumbered_2436"]


def hedderich_chapter_9_unnumbered_2436(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 3 (¯x3 + ¯x4 + ¯x5) = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2436')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2436: GeneralStatistics expression (auto-extracted; see ref)."
