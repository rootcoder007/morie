# describe('msm013') — mvsml_linear_mixed_models_eq_5_1
...
`print(result)` render. See `moirais.fn.describe('msm013')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm013 import *
import numpy as np
# See the function signature in fn/msm013.py for argument names.
```
