# describe('spmatr') — schabenberger_matern_covariance
...
`print(result)` render. See `moirais.fn.describe('spmatr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmatr import *
import numpy as np
# See the function signature in fn/spmatr.py for argument names.
```
