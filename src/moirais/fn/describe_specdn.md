# describe('specdn') — spectral_density
...
`print(result)` render. See `moirais.fn.describe('specdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specdn import *
import numpy as np
# See the function signature in fn/specdn.py for argument names.
```
