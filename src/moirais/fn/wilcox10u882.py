...
__all__ = ["wilcox_chapter_10_unnumbered_882"]


def wilcox_chapter_10_unnumbered_882(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ jk − θ j′ k = 0 (11.9)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u882')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u882: GeneralStatistics expression (auto-extracted; see ref)."
