...
`print(result)` render. See `moirais.fn.describe('kgunw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgunw import *
import numpy as np
# See the function signature in fn/kgunw.py for argument names.
```
