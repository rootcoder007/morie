...
`print(result)` render. See `moirais.fn.describe('volgjr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgjr import *
import numpy as np
# See the function signature in fn/volgjr.py for argument names.
```
