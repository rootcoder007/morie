# describe('ksr17') — kosorok_counting_process
...
`print(result)` render. See `moirais.fn.describe('ksr17')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr17 import *
import numpy as np
# See the function signature in fn/ksr17.py for argument names.
```
