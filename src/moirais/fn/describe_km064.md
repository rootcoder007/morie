# describe('km064') — kamath_ch4_loftq_objective
...
`print(result)` render. See `moirais.fn.describe('km064')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km064 import *
import numpy as np
# See the function signature in fn/km064.py for argument names.
```
