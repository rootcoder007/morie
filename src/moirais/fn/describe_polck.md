...
`print(result)` render. See `moirais.fn.describe('polck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polck import *
import numpy as np
# See the function signature in fn/polck.py for argument names.
```
