...
`print(result)` render. See `moirais.fn.describe('zesmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zesmr import *
import numpy as np
# See the function signature in fn/zesmr.py for argument names.
```
