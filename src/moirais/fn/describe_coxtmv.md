# describe('coxtmv') — cox_time_varying
...
`print(result)` render. See `moirais.fn.describe('coxtmv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxtmv import *
import numpy as np
# See the function signature in fn/coxtmv.py for argument names.
```
