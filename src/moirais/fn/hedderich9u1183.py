...
__all__ = ["hedderich_chapter_9_unnumbered_1183"]


def hedderich_chapter_9_unnumbered_1183(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (ˆp1−l1)2 + (u2−ˆp2)2 ; ϵ=
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1183')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1183: GeneralStatistics expression (auto-extracted; see ref)."
