...
`print(result)` render. See `moirais.fn.describe('fuznt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fuznt import *
import numpy as np
# See the function signature in fn/fuznt.py for argument names.
```
