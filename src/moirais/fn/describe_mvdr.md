# describe('mvdr') — mvdr_spectrum_fn
...
`print(result)` render. See `moirais.fn.describe('mvdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvdr import *
import numpy as np
# See the function signature in fn/mvdr.py for argument names.
```
