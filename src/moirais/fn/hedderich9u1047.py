...
__all__ = ["hedderich_chapter_9_unnumbered_1047"]


def hedderich_chapter_9_unnumbered_1047(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (Y =yj|X =xi) = P (xi,y j)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1047')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1047: GeneralStatistics expression (auto-extracted; see ref)."
