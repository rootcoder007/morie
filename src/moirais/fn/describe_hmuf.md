# describe('hmuf') — geron_underfitting
...
`print(result)` render. See `moirais.fn.describe('hmuf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmuf import *
import numpy as np
# See the function signature in fn/hmuf.py for argument names.
```
