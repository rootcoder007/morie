# describe('rng255') — rangayyan_ch4_power_cepstrum_relation_to_complex
...
`print(result)` render. See `moirais.fn.describe('rng255')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng255 import *
import numpy as np
# See the function signature in fn/rng255.py for argument names.
```
