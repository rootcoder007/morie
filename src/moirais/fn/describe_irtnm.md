...
`print(result)` render. See `moirais.fn.describe('irtnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtnm import *
import numpy as np
# See the function signature in fn/irtnm.py for argument names.
```
