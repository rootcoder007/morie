...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_3"]


def guide_on_data_analysis_chapter_2_unnumbered_3(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (AB)−1 = B−1A−1 (Inverse reverses order in a product)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u3')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u3: GeneralStatistics expression (auto-extracted; see ref)."
