...
`print(result)` render. See `moirais.fn.describe('srmdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmdc import *
import numpy as np
# See the function signature in fn/srmdc.py for argument names.
```
