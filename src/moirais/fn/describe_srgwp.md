...
`print(result)` render. See `moirais.fn.describe('srgwp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwp import *
import numpy as np
# See the function signature in fn/srgwp.py for argument names.
```
