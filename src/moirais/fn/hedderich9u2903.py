...
__all__ = ["hedderich_chapter_9_unnumbered_2903"]


def hedderich_chapter_9_unnumbered_2903(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] p = ∑yi/n = 40/80 = 0.50
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2903')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2903: GeneralStatistics expression (auto-extracted; see ref)."
