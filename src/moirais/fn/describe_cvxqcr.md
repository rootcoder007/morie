# describe('cvxqcr') — boyd_quadratic_constraint
...
`print(result)` render. See `moirais.fn.describe('cvxqcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxqcr import *
import numpy as np
# See the function signature in fn/cvxqcr.py for argument names.
```
