# describe('drcsa') — dr_callaway_santanna
...
`print(result)` render. See `moirais.fn.describe('drcsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drcsa import *
import numpy as np
# See the function signature in fn/drcsa.py for argument names.
```
