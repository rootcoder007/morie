# describe('wndwm') — window_function

## WHAT IT DOES

Window functions. 'Everything flows. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('wndwm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wndwm import *
import numpy as np
# See the function signature in fn/wndwm.py for argument names.
```
