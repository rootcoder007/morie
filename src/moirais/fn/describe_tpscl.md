# describe('tpscl') — tps_clearance_rate
...
`print(result)` render. See `moirais.fn.describe('tpscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpscl import *
import numpy as np
# See the function signature in fn/tpscl.py for argument names.
```
