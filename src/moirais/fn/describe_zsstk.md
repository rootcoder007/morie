...
`print(result)` render. See `moirais.fn.describe('zsstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsstk import *
import numpy as np
# See the function signature in fn/zsstk.py for argument names.
```
