...
`print(result)` render. See `moirais.fn.describe('srpdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srpdm import *
import numpy as np
# See the function signature in fn/srpdm.py for argument names.
```
