# describe('ess') — effective_sample_size
...
`print(result)` render. See `moirais.fn.describe('ess')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ess import *
import numpy as np
# See the function signature in fn/ess.py for argument names.
```
