...
`print(result)` render. See `moirais.fn.describe('hmnmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnmf import *
import numpy as np
# See the function signature in fn/hmnmf.py for argument names.
```
