# describe('wsmhmm') — wasserman_hmm_forward
...
`print(result)` render. See `moirais.fn.describe('wsmhmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmhmm import *
import numpy as np
# See the function signature in fn/wsmhmm.py for argument names.
```
