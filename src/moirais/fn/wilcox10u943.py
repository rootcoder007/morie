...
__all__ = ["wilcox_chapter_10_unnumbered_943"]


def wilcox_chapter_10_unnumbered_943(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: c α = 0.05 α = 0.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u943')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u943: PowerAndDesign expression (auto-extracted; see ref)."
