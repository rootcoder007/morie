...
`print(result)` render. See `moirais.fn.describe('fodiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fodiv import *
import numpy as np
# See the function signature in fn/fodiv.py for argument names.
```
