# describe('msm171') — mvsml_ridge_lasso_elastic_eq_9_4
...
`print(result)` render. See `moirais.fn.describe('msm171')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm171 import *
import numpy as np
# See the function signature in fn/msm171.py for argument names.
```
