...
`print(result)` render. See `moirais.fn.describe('typst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.typst import *
import numpy as np
# See the function signature in fn/typst.py for argument names.
```
