# describe('odm_e') — otis_demo_equity
...
`print(result)` render. See `moirais.fn.describe('odm_e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_e import *
import numpy as np
# See the function signature in fn/odm_e.py for argument names.
```
