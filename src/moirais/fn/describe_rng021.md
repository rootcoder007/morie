# describe('rng021') — rangayyan_ch3_covariance
...
`print(result)` render. See `moirais.fn.describe('rng021')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng021 import *
import numpy as np
# See the function signature in fn/rng021.py for argument names.
```
