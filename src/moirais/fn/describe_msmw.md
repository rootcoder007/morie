# describe('msmw') — marginal_structural
...
`print(result)` render. See `moirais.fn.describe('msmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmw import *
import numpy as np
# See the function signature in fn/msmw.py for argument names.
```
