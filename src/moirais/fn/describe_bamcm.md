# describe('bamcm') — bayesian_am_mcmc_sample
...
`print(result)` render. See `moirais.fn.describe('bamcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bamcm import *
import numpy as np
# See the function signature in fn/bamcm.py for argument names.
```
