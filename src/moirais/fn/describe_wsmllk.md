# describe('wsmllk') — wasserman_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('wsmllk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmllk import *
import numpy as np
# See the function signature in fn/wsmllk.py for argument names.
```
