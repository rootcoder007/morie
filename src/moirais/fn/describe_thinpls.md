# describe('thinpls') — thin_plate_spline
...
`print(result)` render. See `moirais.fn.describe('thinpls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thinpls import *
import numpy as np
# See the function signature in fn/thinpls.py for argument names.
```
