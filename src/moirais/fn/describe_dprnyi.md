# describe('dprnyi') — renyi_dp_composition
...
`print(result)` render. See `moirais.fn.describe('dprnyi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dprnyi import *
import numpy as np
# See the function signature in fn/dprnyi.py for argument names.
```
