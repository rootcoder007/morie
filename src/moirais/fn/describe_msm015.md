# describe('msm015') — mvsml_linear_mixed_models_eq_5_3
...
`print(result)` render. See `moirais.fn.describe('msm015')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm015 import *
import numpy as np
# See the function signature in fn/msm015.py for argument names.
```
