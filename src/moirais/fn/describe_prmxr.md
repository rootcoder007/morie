...
`print(result)` render. See `moirais.fn.describe('prmxr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prmxr import *
import numpy as np
# See the function signature in fn/prmxr.py for argument names.
```
