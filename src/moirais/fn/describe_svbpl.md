...
`print(result)` render. See `moirais.fn.describe('svbpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svbpl import *
import numpy as np
# See the function signature in fn/svbpl.py for argument names.
```
