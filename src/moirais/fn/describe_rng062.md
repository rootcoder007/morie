# describe('rng062') — rangayyan_ch3_phase_response_from_pole_zero
...
`print(result)` render. See `moirais.fn.describe('rng062')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng062 import *
import numpy as np
# See the function signature in fn/rng062.py for argument names.
```
