...
__all__ = ["hedderich_chapter_9_unnumbered_2477"]


def hedderich_chapter_9_unnumbered_2477(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆH + = 7.46> 5.99 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2477')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2477: GeneralStatistics expression (auto-extracted; see ref)."
