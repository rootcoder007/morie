# describe('msm096') — mvsml_bayesian_regression_eq_6_7
...
`print(result)` render. See `moirais.fn.describe('msm096')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm096 import *
import numpy as np
# See the function signature in fn/msm096.py for argument names.
```
