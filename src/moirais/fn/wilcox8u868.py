...
__all__ = ["wilcox_chapter_8_unnumbered_868"]


def wilcox_chapter_8_unnumbered_868(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F = (n − 1)(B − C)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u868')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u868: GeneralStatistics expression (auto-extracted; see ref)."
