...
__all__ = ["hedderich_chapter_9_unnumbered_2771"]


def hedderich_chapter_9_unnumbered_2771(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˜π1 = (r1 +r2 +∆·n2)/(n1 +n2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2771')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2771: GeneralStatistics expression (auto-extracted; see ref)."
