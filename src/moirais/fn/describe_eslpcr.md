...
`print(result)` render. See `moirais.fn.describe('eslpcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslpcr import *
import numpy as np
# See the function signature in fn/eslpcr.py for argument names.
```
