...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_809"]


def guide_on_data_analysis_chapter_11_unnumbered_809(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑇𝑖𝑗𝑐𝑡 = 𝛽0 + 𝑆𝑗𝑐𝑡𝛽1 + 𝑋𝑖𝑗𝑐𝑡𝛽2 + 𝜇𝑗𝑐 + 𝜖𝑖𝑗𝑐𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u809')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u809: GeneralStatistics expression (auto-extracted; see ref)."
