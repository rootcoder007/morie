# describe('vmdfn') — variational_mode_decompose
...
`print(result)` render. See `moirais.fn.describe('vmdfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmdfn import *
import numpy as np
# See the function signature in fn/vmdfn.py for argument names.
```
