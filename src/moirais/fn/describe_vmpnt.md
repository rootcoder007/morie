...
`print(result)` render. See `moirais.fn.describe('vmpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmpnt import *
import numpy as np
# See the function signature in fn/vmpnt.py for argument names.
```
