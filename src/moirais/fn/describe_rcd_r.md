# describe('rcd_r') — recidivism_by_region
...
`print(result)` render. See `moirais.fn.describe('rcd_r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcd_r import *
import numpy as np
# See the function signature in fn/rcd_r.py for argument names.
```
