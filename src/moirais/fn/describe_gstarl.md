...
`print(result)` render. See `moirais.fn.describe('gstarl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gstarl import *
import numpy as np
# See the function signature in fn/gstarl.py for argument names.
```
