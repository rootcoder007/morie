# describe('kapco') — kappa_coefficient
...
`print(result)` render. See `moirais.fn.describe('kapco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kapco import *
import numpy as np
# See the function signature in fn/kapco.py for argument names.
```
