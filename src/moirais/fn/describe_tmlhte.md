# describe('tmlhte') — tmle_heterogeneous
...
`print(result)` render. See `moirais.fn.describe('tmlhte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlhte import *
import numpy as np
# See the function signature in fn/tmlhte.py for argument names.
```
