...
`print(result)` render. See `moirais.fn.describe('spp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spp import *
import numpy as np
# See the function signature in fn/spp.py for argument names.
```
