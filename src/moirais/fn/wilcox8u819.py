...
__all__ = ["wilcox_chapter_8_unnumbered_819"]


def wilcox_chapter_8_unnumbered_819(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: Factor θ K+1 θ K+2 · · · θ 2K
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u819')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u819: Resampling expression (auto-extracted; see ref)."
