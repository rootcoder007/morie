...
`print(result)` render. See `moirais.fn.describe('somol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.somol import *
import numpy as np
# See the function signature in fn/somol.py for argument names.
```
