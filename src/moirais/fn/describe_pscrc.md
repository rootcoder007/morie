...
`print(result)` render. See `moirais.fn.describe('pscrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pscrc import *
import numpy as np
# See the function signature in fn/pscrc.py for argument names.
```
