# describe('gh_c9_9') — ghosal_wn_conj_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c9_9')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c9_9 import *
import numpy as np
# See the function signature in fn/gh_c9_9.py for argument names.
```
