# describe('gredsq') — geron_encoder_decoder_seq2seq
...
`print(result)` render. See `moirais.fn.describe('gredsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gredsq import *
import numpy as np
# See the function signature in fn/gredsq.py for argument names.
```
