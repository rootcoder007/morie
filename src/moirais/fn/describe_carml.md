...
`print(result)` render. See `moirais.fn.describe('carml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carml import *
import numpy as np
# See the function signature in fn/carml.py for argument names.
```
