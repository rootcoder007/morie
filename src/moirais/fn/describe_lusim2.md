...
`print(result)` render. See `moirais.fn.describe('lusim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lusim2 import *
import numpy as np
# See the function signature in fn/lusim2.py for argument names.
```
