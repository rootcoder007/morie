...
`print(result)` render. See `moirais.fn.describe('tsgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsgwt import *
import numpy as np
# See the function signature in fn/tsgwt.py for argument names.
```
