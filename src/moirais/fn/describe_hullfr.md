...
`print(result)` render. See `moirais.fn.describe('hullfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hullfr import *
import numpy as np
# See the function signature in fn/hullfr.py for argument names.
```
