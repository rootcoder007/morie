...
`print(result)` render. See `moirais.fn.describe('knnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knnc import *
import numpy as np
# See the function signature in fn/knnc.py for argument names.
```
