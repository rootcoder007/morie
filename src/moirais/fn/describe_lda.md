...
`print(result)` render. See `moirais.fn.describe('lda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lda import *
import numpy as np
# See the function signature in fn/lda.py for argument names.
```
