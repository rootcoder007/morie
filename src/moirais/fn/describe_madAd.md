# describe('madAd') — mad_anomaly_score
...
`print(result)` render. See `moirais.fn.describe('madAd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.madAd import *
import numpy as np
# See the function signature in fn/madAd.py for argument names.
```
