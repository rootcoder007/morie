# describe('sgans') — anisotropy_correction
...
`print(result)` render. See `moirais.fn.describe('sgans')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgans import *
import numpy as np
# See the function signature in fn/sgans.py for argument names.
```
