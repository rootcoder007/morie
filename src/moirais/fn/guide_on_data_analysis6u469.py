...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_469"]


def guide_on_data_analysis_chapter_6_unnumbered_469(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • s𝑗 = ̂𝜃(𝑗+1)− ̂𝜃(𝑗)(change in parameters).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u469')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u469: GeneralStatistics expression (auto-extracted; see ref)."
