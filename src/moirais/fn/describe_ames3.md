# describe('ames3') — ames_mutagenicity
...
`print(result)` render. See `moirais.fn.describe('ames3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ames3 import *
import numpy as np
# See the function signature in fn/ames3.py for argument names.
```
