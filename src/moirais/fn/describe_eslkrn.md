# describe('eslkrn') — esl_kernel_density
...
`print(result)` render. See `moirais.fn.describe('eslkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslkrn import *
import numpy as np
# See the function signature in fn/eslkrn.py for argument names.
```
