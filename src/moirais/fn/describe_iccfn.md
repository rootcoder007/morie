...
`print(result)` render. See `moirais.fn.describe('iccfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.iccfn import *
import numpy as np
# See the function signature in fn/iccfn.py for argument names.
```
