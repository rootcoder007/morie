...
`print(result)` render. See `moirais.fn.describe('minorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.minorm import *
import numpy as np
# See the function signature in fn/minorm.py for argument names.
```
