...
`print(result)` render. See `moirais.fn.describe('logrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logrt import *
import numpy as np
# See the function signature in fn/logrt.py for argument names.
```
