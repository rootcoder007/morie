# describe('aitpow') — aitchison_powering
...
`print(result)` render. See `moirais.fn.describe('aitpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitpow import *
import numpy as np
# See the function signature in fn/aitpow.py for argument names.
```
