...
`print(result)` render. See `moirais.fn.describe('kdgof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kdgof import *
import numpy as np
# See the function signature in fn/kdgof.py for argument names.
```
