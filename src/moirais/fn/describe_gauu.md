# describe('gauu') — gaussian_utility
...
`print(result)` render. See `moirais.fn.describe('gauu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gauu import *
import numpy as np
# See the function signature in fn/gauu.py for argument names.
```
