...
`print(result)` render. See `moirais.fn.describe('enplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enplm import *
import numpy as np
# See the function signature in fn/enplm.py for argument names.
```
