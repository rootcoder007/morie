...
`print(result)` render. See `moirais.fn.describe('shpvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shpvl import *
import numpy as np
# See the function signature in fn/shpvl.py for argument names.
```
