# describe('gb_hg2') — gibbons_hodges_lehmann_2
...
`print(result)` render. See `moirais.fn.describe('gb_hg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_hg2 import *
import numpy as np
# See the function signature in fn/gb_hg2.py for argument names.
```
