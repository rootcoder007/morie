...
__all__ = ["wilcox_chapter_8_unnumbered_822"]


def wilcox_chapter_8_unnumbered_822(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 : Ψ 1 = · · · = Ψ (J−1)( K−1) = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u822')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u822: GeneralStatistics expression (auto-extracted; see ref)."
