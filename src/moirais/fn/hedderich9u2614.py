...
__all__ = ["hedderich_chapter_9_unnumbered_2614"]


def hedderich_chapter_9_unnumbered_2614(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: andc/n2 from the ratio (a +c)/n (corresponding to homogeneity: a/n1 = c/n2 = (a +c)/n)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2614')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2614: GeneralStatistics expression (auto-extracted; see ref)."
