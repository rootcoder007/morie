# describe('km024') — kamath_ch2_std_loss
...
`print(result)` render. See `moirais.fn.describe('km024')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km024 import *
import numpy as np
# See the function signature in fn/km024.py for argument names.
```
