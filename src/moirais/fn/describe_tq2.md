...
`print(result)` render. See `moirais.fn.describe('tq2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tq2 import *
import numpy as np
# See the function signature in fn/tq2.py for argument names.
```
