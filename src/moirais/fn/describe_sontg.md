...
`print(result)` render. See `moirais.fn.describe('sontg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sontg import *
import numpy as np
# See the function signature in fn/sontg.py for argument names.
```
