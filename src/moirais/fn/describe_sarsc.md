...
`print(result)` render. See `moirais.fn.describe('sarsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarsc import *
import numpy as np
# See the function signature in fn/sarsc.py for argument names.
```
