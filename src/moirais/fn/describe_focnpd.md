...
`print(result)` render. See `moirais.fn.describe('focnpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.focnpd import *
import numpy as np
# See the function signature in fn/focnpd.py for argument names.
```
