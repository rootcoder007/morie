# describe('infbtl') — information_bottleneck
...
`print(result)` render. See `moirais.fn.describe('infbtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infbtl import *
import numpy as np
# See the function signature in fn/infbtl.py for argument names.
```
