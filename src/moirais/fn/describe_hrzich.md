# describe('hrzich') — horowitz_ichimura_estimator
...
`print(result)` render. See `moirais.fn.describe('hrzich')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzich import *
import numpy as np
# See the function signature in fn/hrzich.py for argument names.
```
