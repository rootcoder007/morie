# describe('daly') — disability_adjusted_life_years
...
`print(result)` render. See `moirais.fn.describe('daly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.daly import *
import numpy as np
# See the function signature in fn/daly.py for argument names.
```
