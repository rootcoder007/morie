# describe('vrgm') — variogram_estimation
...
`print(result)` render. See `moirais.fn.describe('vrgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrgm import *
import numpy as np
# See the function signature in fn/vrgm.py for argument names.
```
