# describe('ptlgc') — log_gaussian_cox
...
`print(result)` render. See `moirais.fn.describe('ptlgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptlgc import *
import numpy as np
# See the function signature in fn/ptlgc.py for argument names.
```
