...
`print(result)` render. See `moirais.fn.describe('hycur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hycur import *
import numpy as np
# See the function signature in fn/hycur.py for argument names.
```
