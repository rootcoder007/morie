...
`print(result)` render. See `moirais.fn.describe('srpfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srpfe import *
import numpy as np
# See the function signature in fn/srpfe.py for argument names.
```
