# describe('wvpkt') — wavelet_packets
...
`print(result)` render. See `moirais.fn.describe('wvpkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvpkt import *
import numpy as np
# See the function signature in fn/wvpkt.py for argument names.
```
