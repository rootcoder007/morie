...
`print(result)` render. See `moirais.fn.describe('rpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpca import *
import numpy as np
# See the function signature in fn/rpca.py for argument names.
```
