# describe('rgturns') — rangayyan_turns_count
...
`print(result)` render. See `moirais.fn.describe('rgturns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgturns import *
import numpy as np
# See the function signature in fn/rgturns.py for argument names.
```
