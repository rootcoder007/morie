...
__all__ = ["hedderich_chapter_9_unnumbered_3651"]


def hedderich_chapter_9_unnumbered_3651(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + x <− replace ( x , list = i , values = rep ( new , n i ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3651')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3651: GeneralStatistics expression (auto-extracted; see ref)."
