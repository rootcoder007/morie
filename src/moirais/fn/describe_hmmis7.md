# describe('hmmis7') — geron_mistral7b
...
`print(result)` render. See `moirais.fn.describe('hmmis7')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmis7 import *
import numpy as np
# See the function signature in fn/hmmis7.py for argument names.
```
