...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_3_equation_26"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_3_equation_26(x, cdf=None):
    """
    GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.

    Formula: Ψ∗ = W˜ Gf + E1                        (3.26)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment3e26')`` for the full guide.

    References
    ----------
    Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment, ch.3 eq.3.26
    """
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment3e26: GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment."
