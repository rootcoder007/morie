# describe('larspec') — lars_optimizer
...
`print(result)` render. See `moirais.fn.describe('larspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.larspec import *
import numpy as np
# See the function signature in fn/larspec.py for argument names.
```
