...
`print(result)` render. See `moirais.fn.describe('copt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copt import *
import numpy as np
# See the function signature in fn/copt.py for argument names.
```
