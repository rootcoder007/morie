# describe('gb_pp') — gibbons_pp_plot
...
`print(result)` render. See `moirais.fn.describe('gb_pp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_pp import *
import numpy as np
# See the function signature in fn/gb_pp.py for argument names.
```
