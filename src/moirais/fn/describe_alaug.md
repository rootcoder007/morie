# describe('alaug') — alammar_augmented_sbert
...
`print(result)` render. See `moirais.fn.describe('alaug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alaug import *
import numpy as np
# See the function signature in fn/alaug.py for argument names.
```
