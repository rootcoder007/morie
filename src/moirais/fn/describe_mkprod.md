# describe('mkprod') — mackinnon_distribution_products
...
`print(result)` render. See `moirais.fn.describe('mkprod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mkprod import *
import numpy as np
# See the function signature in fn/mkprod.py for argument names.
```
