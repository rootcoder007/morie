# describe('birt') — bayesian_irt_2pl
...
`print(result)` render. See `moirais.fn.describe('birt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.birt import *
import numpy as np
# See the function signature in fn/birt.py for argument names.
```
