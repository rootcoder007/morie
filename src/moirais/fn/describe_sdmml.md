...
`print(result)` render. See `moirais.fn.describe('sdmml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmml import *
import numpy as np
# See the function signature in fn/sdmml.py for argument names.
```
