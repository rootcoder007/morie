# describe('gh_contr_rate2') — ghosal_contraction_rate_iid
...
`print(result)` render. See `moirais.fn.describe('gh_contr_rate2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_contr_rate2 import *
import numpy as np
# See the function signature in fn/gh_contr_rate2.py for argument names.
```
