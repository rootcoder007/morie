...
__all__ = ["hedderich_chapter_9_unnumbered_2112"]


def hedderich_chapter_9_unnumbered_2112(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R1 =U2 + m(m + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2112')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2112: GeneralStatistics expression (auto-extracted; see ref)."
