...
`print(result)` render. See `moirais.fn.describe('lurng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lurng import *
import numpy as np
# See the function signature in fn/lurng.py for argument names.
```
