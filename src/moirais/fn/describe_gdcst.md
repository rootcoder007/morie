...
`print(result)` render. See `moirais.fn.describe('gdcst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdcst import *
import numpy as np
# See the function signature in fn/gdcst.py for argument names.
```
