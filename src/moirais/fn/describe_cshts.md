...
`print(result)` render. See `moirais.fn.describe('cshts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cshts import *
import numpy as np
# See the function signature in fn/cshts.py for argument names.
```
