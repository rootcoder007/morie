# describe('bndsmw') — bound_simul_weights
...
`print(result)` render. See `moirais.fn.describe('bndsmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndsmw import *
import numpy as np
# See the function signature in fn/bndsmw.py for argument names.
```
