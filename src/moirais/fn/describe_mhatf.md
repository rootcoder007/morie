# describe('mhatf') — multi_head_attention_full
...
`print(result)` render. See `moirais.fn.describe('mhatf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhatf import *
import numpy as np
# See the function signature in fn/mhatf.py for argument names.
```
