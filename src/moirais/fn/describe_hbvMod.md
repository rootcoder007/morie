...
`print(result)` render. See `moirais.fn.describe('hbvMod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hbvMod import *
import numpy as np
# See the function signature in fn/hbvMod.py for argument names.
```
