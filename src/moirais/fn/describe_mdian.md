# describe('mdian') — mediation_analysis
...
`print(result)` render. See `moirais.fn.describe('mdian')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdian import *
import numpy as np
# See the function signature in fn/mdian.py for argument names.
```
