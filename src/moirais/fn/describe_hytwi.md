...
`print(result)` render. See `moirais.fn.describe('hytwi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hytwi import *
import numpy as np
# See the function signature in fn/hytwi.py for argument names.
```
