# describe('sptag') — spatial_agreement
...
`print(result)` render. See `moirais.fn.describe('sptag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptag import *
import numpy as np
# See the function signature in fn/sptag.py for argument names.
```
