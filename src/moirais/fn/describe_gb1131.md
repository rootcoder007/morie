# describe('gb1131') — gibbons_spearman_rho
...
`print(result)` render. See `moirais.fn.describe('gb1131')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1131 import *
import numpy as np
# See the function signature in fn/gb1131.py for argument names.
```
