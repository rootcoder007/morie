# describe('epbias') — exposure_misclass_bias
...
`print(result)` render. See `moirais.fn.describe('epbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epbias import *
import numpy as np
# See the function signature in fn/epbias.py for argument names.
```
