# describe('shanen') — shannon_entropy
...
`print(result)` render. See `moirais.fn.describe('shanen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shanen import *
import numpy as np
# See the function signature in fn/shanen.py for argument names.
```
