# describe('gb_rco') — gibbons_rank_corr_partial
...
`print(result)` render. See `moirais.fn.describe('gb_rco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_rco import *
import numpy as np
# See the function signature in fn/gb_rco.py for argument names.
```
