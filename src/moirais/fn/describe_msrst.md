...
`print(result)` render. See `moirais.fn.describe('msrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msrst import *
import numpy as np
# See the function signature in fn/msrst.py for argument names.
```
