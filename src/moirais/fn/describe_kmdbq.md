# describe('kmdbq') — kamath_double_quantization
...
`print(result)` render. See `moirais.fn.describe('kmdbq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmdbq import *
import numpy as np
# See the function signature in fn/kmdbq.py for argument names.
```
