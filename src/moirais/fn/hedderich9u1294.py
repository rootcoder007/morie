...
__all__ = ["hedderich_chapter_9_unnumbered_1294"]


def hedderich_chapter_9_unnumbered_1294(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Control group: n2 = 32 . ¯x2 = 15.25 .s1 = 8.55
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1294')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1294: GeneralStatistics expression (auto-extracted; see ref)."
