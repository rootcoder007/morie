# describe('ghs006') — ghosal_ch2_feller_density_approximation
...
`print(result)` render. See `moirais.fn.describe('ghs006')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs006 import *
import numpy as np
# See the function signature in fn/ghs006.py for argument names.
```
