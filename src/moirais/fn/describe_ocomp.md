# describe('ocomp') — otis_group_compare
...
`print(result)` render. See `moirais.fn.describe('ocomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocomp import *
import numpy as np
# See the function signature in fn/ocomp.py for argument names.
```
