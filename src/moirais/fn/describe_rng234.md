# describe('rng234') — rangayyan_ch4_fourier_convolution_property
...
`print(result)` render. See `moirais.fn.describe('rng234')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng234 import *
import numpy as np
# See the function signature in fn/rng234.py for argument names.
```
