# describe('botUp') — bottom_up_aggregation
...
`print(result)` render. See `moirais.fn.describe('botUp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.botUp import *
import numpy as np
# See the function signature in fn/botUp.py for argument names.
```
