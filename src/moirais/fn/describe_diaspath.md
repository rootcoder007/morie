...
`print(result)` render. See `moirais.fn.describe('diaspath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diaspath import *
import numpy as np
# See the function signature in fn/diaspath.py for argument names.
```
