# describe('grtrv') — geron_tree_regression_leaf
...
`print(result)` render. See `moirais.fn.describe('grtrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtrv import *
import numpy as np
# See the function signature in fn/grtrv.py for argument names.
```
