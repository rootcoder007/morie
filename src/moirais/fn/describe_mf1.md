...
`print(result)` render. See `moirais.fn.describe('mf1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mf1 import *
import numpy as np
# See the function signature in fn/mf1.py for argument names.
```
