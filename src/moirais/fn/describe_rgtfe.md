# describe('rgtfe') — rangayyan_transfer_func_est
...
`print(result)` render. See `moirais.fn.describe('rgtfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgtfe import *
import numpy as np
# See the function signature in fn/rgtfe.py for argument names.
```
