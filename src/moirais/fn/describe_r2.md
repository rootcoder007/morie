...
`print(result)` render. See `moirais.fn.describe('r2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r2 import *
import numpy as np
# See the function signature in fn/r2.py for argument names.
```
