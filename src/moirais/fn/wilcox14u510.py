...
__all__ = ["wilcox_chapter_14_unnumbered_510"]


def wilcox_chapter_14_unnumbered_510(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u510')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u510: PowerAndDesign expression (auto-extracted; see ref)."
