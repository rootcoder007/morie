...
`print(result)` render. See `moirais.fn.describe('graic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.graic import *
import numpy as np
# See the function signature in fn/graic.py for argument names.
```
