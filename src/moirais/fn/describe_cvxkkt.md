...
`print(result)` render. See `moirais.fn.describe('cvxkkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxkkt import *
import numpy as np
# See the function signature in fn/cvxkkt.py for argument names.
```
