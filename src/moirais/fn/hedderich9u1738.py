...
__all__ = ["hedderich_chapter_9_unnumbered_1738"]


def hedderich_chapter_9_unnumbered_1738(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > Q <− quantile ( x , p= c ( 0 . 2 5 , 0 . 5 , 0 . 7 5 ) ) ; Q1 <− Q [ 1 ] ; Q3 <− Q [ 3 ]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1738')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1738: GeneralStatistics expression (auto-extracted; see ref)."
