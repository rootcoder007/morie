# describe('sgtest') — sgt_estrada_index
...
`print(result)` render. See `moirais.fn.describe('sgtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtest import *
import numpy as np
# See the function signature in fn/sgtest.py for argument names.
```
