...
__all__ = ["hedderich_chapter_9_unnumbered_3004"]


def hedderich_chapter_9_unnumbered_3004(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: n + ˆχ2 CC korr V =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3004')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3004: ContingencyTables expression (auto-extracted; see ref)."
