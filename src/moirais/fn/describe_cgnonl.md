...
`print(result)` render. See `moirais.fn.describe('cgnonl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cgnonl import *
import numpy as np
# See the function signature in fn/cgnonl.py for argument names.
```
