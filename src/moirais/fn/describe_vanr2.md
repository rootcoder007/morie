# describe('vanr2') — vanraden_method2
...
`print(result)` render. See `moirais.fn.describe('vanr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vanr2 import *
import numpy as np
# See the function signature in fn/vanr2.py for argument names.
```
