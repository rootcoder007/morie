...
`print(result)` render. See `moirais.fn.describe('nbppr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbppr import *
import numpy as np
# See the function signature in fn/nbppr.py for argument names.
```
