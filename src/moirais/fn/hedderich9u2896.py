...
__all__ = ["hedderich_chapter_9_unnumbered_2896"]


def hedderich_chapter_9_unnumbered_2896(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: all equally likely, thusπiA = 3/20 = 0.15 fori = 1,..., 5. How large is the power of a χ2-test
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2896')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2896: GeneralStatistics expression (auto-extracted; see ref)."
