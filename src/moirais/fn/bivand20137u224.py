...
__all__ = ["bivand2013_chapter_7_unnumbered_224"]


def bivand2013_chapter_7_unnumbered_224(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: impact measures for the lag model, andSr(W)=( (I−ρW)−1(Iβr −Wγr))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u224')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u224: GeneralStatistics expression (auto-extracted; see ref)."
