# describe('typtr') — type_token_ratio

## WHAT IT DOES

Type-token ratio (lexical diversity). 'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('typtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.typtr import *
import numpy as np
# See the function signature in fn/typtr.py for argument names.
```
