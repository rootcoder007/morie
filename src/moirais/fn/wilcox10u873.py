...
__all__ = ["wilcox_chapter_10_unnumbered_873"]


def wilcox_chapter_10_unnumbered_873(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: k of Factor B (i = 1,...,n j; j = 1,...,J and k = 1,...,K ). The test statistic is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u873')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u873: GeneralStatistics expression (auto-extracted; see ref)."
