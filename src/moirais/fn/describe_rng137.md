# describe('rng137') — rangayyan_ch3_estimation_error
...
`print(result)` render. See `moirais.fn.describe('rng137')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng137 import *
import numpy as np
# See the function signature in fn/rng137.py for argument names.
```
