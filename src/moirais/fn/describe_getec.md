...
`print(result)` render. See `moirais.fn.describe('getec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getec import *
import numpy as np
# See the function signature in fn/getec.py for argument names.
```
