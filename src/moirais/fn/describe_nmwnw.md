# describe('nmwnw') — wnominate_weight
...
`print(result)` render. See `moirais.fn.describe('nmwnw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwnw import *
import numpy as np
# See the function signature in fn/nmwnw.py for argument names.
```
