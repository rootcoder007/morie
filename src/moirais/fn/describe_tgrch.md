...
`print(result)` render. See `moirais.fn.describe('tgrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgrch import *
import numpy as np
# See the function signature in fn/tgrch.py for argument names.
```
