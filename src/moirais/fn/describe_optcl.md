# describe('optcl') — optimal_classification
...
`print(result)` render. See `moirais.fn.describe('optcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optcl import *
import numpy as np
# See the function signature in fn/optcl.py for argument names.
```
