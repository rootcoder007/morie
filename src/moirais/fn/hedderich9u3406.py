...
__all__ = ["hedderich_chapter_9_unnumbered_3406"]


def hedderich_chapter_9_unnumbered_3406(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: exp (β0 +β1·x1 +...+βp·xp) %
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3406')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3406: GeneralStatistics expression (auto-extracted; see ref)."
