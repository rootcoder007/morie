# describe('oralb') — oral_bioavailability
...
`print(result)` render. See `moirais.fn.describe('oralb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oralb import *
import numpy as np
# See the function signature in fn/oralb.py for argument names.
```
