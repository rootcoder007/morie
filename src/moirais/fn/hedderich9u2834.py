...
__all__ = ["hedderich_chapter_9_unnumbered_2834"]


def hedderich_chapter_9_unnumbered_2834(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + mj <− apply ( x [ , , j ] , MARGIN=1 , sum )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2834')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2834: GeneralStatistics expression (auto-extracted; see ref)."
