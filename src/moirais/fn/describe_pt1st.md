...
`print(result)` render. See `moirais.fn.describe('pt1st')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pt1st import *
import numpy as np
# See the function signature in fn/pt1st.py for argument names.
```
