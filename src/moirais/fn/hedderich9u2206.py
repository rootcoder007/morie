...
__all__ = ["hedderich_chapter_9_unnumbered_2206"]


def hedderich_chapter_9_unnumbered_2206(x):
    """
    MetaAnalysis expression (auto-extracted; see ref).

    Formula: [EQ] 1−p = P (X >0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2206')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2206: MetaAnalysis expression (auto-extracted; see ref)."
