# describe('spsann') — schabenberger_simulated_annealing
...
`print(result)` render. See `moirais.fn.describe('spsann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spsann import *
import numpy as np
# See the function signature in fn/spsann.py for argument names.
```
