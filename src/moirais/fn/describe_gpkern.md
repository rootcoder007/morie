# describe('gpkern') — gp_kernel_compose
...
`print(result)` render. See `moirais.fn.describe('gpkern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpkern import *
import numpy as np
# See the function signature in fn/gpkern.py for argument names.
```
