...
`print(result)` render. See `moirais.fn.describe('geods')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geods import *
import numpy as np
# See the function signature in fn/geods.py for argument names.
```
