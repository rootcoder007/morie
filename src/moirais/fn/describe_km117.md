# describe('km117') — kamath_ch8_bleu_final
...
`print(result)` render. See `moirais.fn.describe('km117')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km117 import *
import numpy as np
# See the function signature in fn/km117.py for argument names.
```
