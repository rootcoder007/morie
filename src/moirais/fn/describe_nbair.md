...
`print(result)` render. See `moirais.fn.describe('nbair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbair import *
import numpy as np
# See the function signature in fn/nbair.py for argument names.
```
