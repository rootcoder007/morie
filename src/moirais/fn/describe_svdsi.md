...
`print(result)` render. See `moirais.fn.describe('svdsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdsi import *
import numpy as np
# See the function signature in fn/svdsi.py for argument names.
```
