# describe('rkhsb') — rkhs_bayesian_kernel
...
`print(result)` render. See `moirais.fn.describe('rkhsb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkhsb import *
import numpy as np
# See the function signature in fn/rkhsb.py for argument names.
```
