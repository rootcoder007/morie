...
`print(result)` render. See `moirais.fn.describe('kylo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kylo import *
import numpy as np
# See the function signature in fn/kylo.py for argument names.
```
