...
`print(result)` render. See `moirais.fn.describe('fobark')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fobark import *
import numpy as np
# See the function signature in fn/fobark.py for argument names.
```
