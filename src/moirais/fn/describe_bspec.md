...
`print(result)` render. See `moirais.fn.describe('bspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bspec import *
import numpy as np
# See the function signature in fn/bspec.py for argument names.
```
