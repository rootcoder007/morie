...
__all__ = ["hedderich_chapter_9_unnumbered_2884"]


def hedderich_chapter_9_unnumbered_2884(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and 1≤i<j ≤k, pi =ri/ni with 1≤i≤k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2884')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2884: GeneralStatistics expression (auto-extracted; see ref)."
