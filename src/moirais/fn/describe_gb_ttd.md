# describe('gb_ttd') — gibbons_total_runs_dist_table
...
`print(result)` render. See `moirais.fn.describe('gb_ttd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ttd import *
import numpy as np
# See the function signature in fn/gb_ttd.py for argument names.
```
