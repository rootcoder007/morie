# describe('msm239') — mvsml_general_eq_1_3
...
`print(result)` render. See `moirais.fn.describe('msm239')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm239 import *
import numpy as np
# See the function signature in fn/msm239.py for argument names.
```
