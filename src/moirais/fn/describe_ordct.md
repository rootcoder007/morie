# describe('ordct') — ordered_categories
...
`print(result)` render. See `moirais.fn.describe('ordct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ordct import *
import numpy as np
# See the function signature in fn/ordct.py for argument names.
```
