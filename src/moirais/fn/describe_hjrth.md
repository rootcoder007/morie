...
`print(result)` render. See `moirais.fn.describe('hjrth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hjrth import *
import numpy as np
# See the function signature in fn/hjrth.py for argument names.
```
