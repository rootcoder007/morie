# describe('kmdpr') — kamath_dense_passage_retrieval
...
`print(result)` render. See `moirais.fn.describe('kmdpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmdpr import *
import numpy as np
# See the function signature in fn/kmdpr.py for argument names.
```
