# describe('msm219') — mvsml_ridge_lasso_elastic_eq_9_35
...
`print(result)` render. See `moirais.fn.describe('msm219')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm219 import *
import numpy as np
# See the function signature in fn/msm219.py for argument names.
```
