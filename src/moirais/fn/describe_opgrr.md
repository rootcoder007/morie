...
`print(result)` render. See `moirais.fn.describe('opgrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opgrr import *
import numpy as np
# See the function signature in fn/opgrr.py for argument names.
```
