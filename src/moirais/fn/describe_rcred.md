...
`print(result)` render. See `moirais.fn.describe('rcred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcred import *
import numpy as np
# See the function signature in fn/rcred.py for argument names.
```
