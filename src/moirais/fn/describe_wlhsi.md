...
`print(result)` render. See `moirais.fn.describe('wlhsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlhsi import *
import numpy as np
# See the function signature in fn/wlhsi.py for argument names.
```
