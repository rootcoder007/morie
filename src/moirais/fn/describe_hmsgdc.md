# describe('hmsgdc') — geron_sgd_classifier
...
`print(result)` render. See `moirais.fn.describe('hmsgdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsgdc import *
import numpy as np
# See the function signature in fn/hmsgdc.py for argument names.
```
