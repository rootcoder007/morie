...
`print(result)` render. See `moirais.fn.describe('sllrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sllrn import *
import numpy as np
# See the function signature in fn/sllrn.py for argument names.
```
