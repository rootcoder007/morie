...
`print(result)` render. See `moirais.fn.describe('dimNet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dimNet import *
import numpy as np
# See the function signature in fn/dimNet.py for argument names.
```
