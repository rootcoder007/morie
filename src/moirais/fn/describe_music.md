# describe('music') — music_spectrum_fn
...
`print(result)` render. See `moirais.fn.describe('music')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.music import *
import numpy as np
# See the function signature in fn/music.py for argument names.
```
