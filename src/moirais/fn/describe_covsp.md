# describe('covsp') — one_sample_coverage
...
`print(result)` render. See `moirais.fn.describe('covsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covsp import *
import numpy as np
# See the function signature in fn/covsp.py for argument names.
```
