# describe('survrls') — restricted_lifetime
...
`print(result)` render. See `moirais.fn.describe('survrls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survrls import *
import numpy as np
# See the function signature in fn/survrls.py for argument names.
```
