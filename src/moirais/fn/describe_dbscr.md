# describe('dbscr') — dbscan_dr

## WHAT IT DOES

DBSCAN clustering (DescriptiveResult). 'I'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('dbscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbscr import *
import numpy as np
# See the function signature in fn/dbscr.py for argument names.
```
