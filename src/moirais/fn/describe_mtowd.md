# describe('mtowd') — mto_weather_factor
...
`print(result)` render. See `moirais.fn.describe('mtowd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtowd import *
import numpy as np
# See the function signature in fn/mtowd.py for argument names.
```
