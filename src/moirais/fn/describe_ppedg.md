...
`print(result)` render. See `moirais.fn.describe('ppedg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppedg import *
import numpy as np
# See the function signature in fn/ppedg.py for argument names.
```
