# describe('snpest') — sn_pseudo_estimate
...
`print(result)` render. See `moirais.fn.describe('snpest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snpest import *
import numpy as np
# See the function signature in fn/snpest.py for argument names.
```
