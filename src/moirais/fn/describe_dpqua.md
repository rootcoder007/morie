...
`print(result)` render. See `moirais.fn.describe('dpqua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpqua import *
import numpy as np
# See the function signature in fn/dpqua.py for argument names.
```
