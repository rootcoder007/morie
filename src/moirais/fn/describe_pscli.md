...
`print(result)` render. See `moirais.fn.describe('pscli')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pscli import *
import numpy as np
# See the function signature in fn/pscli.py for argument names.
```
