...
`print(result)` render. See `moirais.fn.describe('xfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xfit import *
import numpy as np
# See the function signature in fn/xfit.py for argument names.
```
