# describe('attrInf') — attribute_inference
...
`print(result)` render. See `moirais.fn.describe('attrInf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attrInf import *
import numpy as np
# See the function signature in fn/attrInf.py for argument names.
```
