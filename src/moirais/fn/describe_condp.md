# describe('condp') — conditional_prob
...
`print(result)` render. See `moirais.fn.describe('condp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.condp import *
import numpy as np
# See the function signature in fn/condp.py for argument names.
```
