# describe('tpsrt') — topological_sort

## WHAT IT DOES

Topological sort of a DAG. 'Your eyes can deceive you; don'Our greatest glory is not in never falling, but in rising every time we fall. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('tpsrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsrt import *
import numpy as np
# See the function signature in fn/tpsrt.py for argument names.
```
