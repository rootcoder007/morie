...
`print(result)` render. See `moirais.fn.describe('ubseg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubseg import *
import numpy as np
# See the function signature in fn/ubseg.py for argument names.
```
