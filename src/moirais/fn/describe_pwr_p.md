# describe('pwr_p') — power_prop_test
...
`print(result)` render. See `moirais.fn.describe('pwr_p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pwr_p import *
import numpy as np
# See the function signature in fn/pwr_p.py for argument names.
```
