...
__all__ = ["hedderich_chapter_9_unnumbered_2609"]


def hedderich_chapter_9_unnumbered_2609(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] i=1xi·lg2xi−(∑k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2609')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2609: GeneralStatistics expression (auto-extracted; see ref)."
