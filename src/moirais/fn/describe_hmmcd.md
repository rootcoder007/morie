# describe('hmmcd') — geron_mc_dropout
...
`print(result)` render. See `moirais.fn.describe('hmmcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmcd import *
import numpy as np
# See the function signature in fn/hmmcd.py for argument names.
```
