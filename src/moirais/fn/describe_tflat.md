...
`print(result)` render. See `moirais.fn.describe('tflat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tflat import *
import numpy as np
# See the function signature in fn/tflat.py for argument names.
```
