...
__all__ = ["hedderich_chapter_9_unnumbered_916"]


def hedderich_chapter_9_unnumbered_916(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Fmax(x) = exp(−exp(−z))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u916')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u916: GeneralStatistics expression (auto-extracted; see ref)."
