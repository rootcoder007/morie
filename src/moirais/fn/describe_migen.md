...
`print(result)` render. See `moirais.fn.describe('migen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.migen import *
import numpy as np
# See the function signature in fn/migen.py for argument names.
```
