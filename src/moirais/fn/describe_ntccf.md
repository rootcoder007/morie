# describe('ntccf') — network_clustering_coeff
...
`print(result)` render. See `moirais.fn.describe('ntccf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ntccf import *
import numpy as np
# See the function signature in fn/ntccf.py for argument names.
```
