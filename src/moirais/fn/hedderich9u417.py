...
__all__ = ["hedderich_chapter_9_unnumbered_417"]


def hedderich_chapter_9_unnumbered_417(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (B∩A) = P (A)·P (B|A) = 0.6·0.7 = 0.42.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u417')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u417: GeneralStatistics expression (auto-extracted; see ref)."
