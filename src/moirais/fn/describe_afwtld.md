...
`print(result)` render. See `moirais.fn.describe('afwtld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afwtld import *
import numpy as np
# See the function signature in fn/afwtld.py for argument names.
```
