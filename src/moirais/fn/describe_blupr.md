# describe('blupr') — blup_random_intercept
...
`print(result)` render. See `moirais.fn.describe('blupr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blupr import *
import numpy as np
# See the function signature in fn/blupr.py for argument names.
```
