# describe('fnscale') — functional_scale
...
`print(result)` render. See `moirais.fn.describe('fnscale')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fnscale import *
import numpy as np
# See the function signature in fn/fnscale.py for argument names.
```
