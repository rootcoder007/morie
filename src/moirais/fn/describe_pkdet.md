# describe('pkdet') — peak_detect_advanced
...
`print(result)` render. See `moirais.fn.describe('pkdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pkdet import *
import numpy as np
# See the function signature in fn/pkdet.py for argument names.
```
