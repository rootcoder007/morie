...
`print(result)` render. See `moirais.fn.describe('csdrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdrg import *
import numpy as np
# See the function signature in fn/csdrg.py for argument names.
```
