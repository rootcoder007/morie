...
`print(result)` render. See `moirais.fn.describe('bnklw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnklw import *
import numpy as np
# See the function signature in fn/bnklw.py for argument names.
```
