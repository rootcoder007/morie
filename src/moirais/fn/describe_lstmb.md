...
`print(result)` render. See `moirais.fn.describe('lstmb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lstmb import *
import numpy as np
# See the function signature in fn/lstmb.py for argument names.
```
