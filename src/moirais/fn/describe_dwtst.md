...
`print(result)` render. See `moirais.fn.describe('dwtst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dwtst import *
import numpy as np
# See the function signature in fn/dwtst.py for argument names.
```
