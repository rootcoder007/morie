# describe('lottosi') — lottery_sampling
...
`print(result)` render. See `moirais.fn.describe('lottosi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lottosi import *
import numpy as np
# See the function signature in fn/lottosi.py for argument names.
```
