...
`print(result)` render. See `moirais.fn.describe('rcsca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcsca import *
import numpy as np
# See the function signature in fn/rcsca.py for argument names.
```
