# describe('btpair') — boot_pairs_regression
...
`print(result)` render. See `moirais.fn.describe('btpair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btpair import *
import numpy as np
# See the function signature in fn/btpair.py for argument names.
```
