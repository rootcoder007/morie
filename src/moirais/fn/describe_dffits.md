...
`print(result)` render. See `moirais.fn.describe('dffits')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dffits import *
import numpy as np
# See the function signature in fn/dffits.py for argument names.
```
