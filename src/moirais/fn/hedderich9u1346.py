...
__all__ = ["hedderich_chapter_9_unnumbered_1346"]


def hedderich_chapter_9_unnumbered_1346(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] nnpar≈α/2·(1−α/2)·
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1346')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1346: PowerAndDesign expression (auto-extracted; see ref)."
