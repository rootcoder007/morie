...
`print(result)` render. See `moirais.fn.describe('wvbnz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvbnz import *
import numpy as np
# See the function signature in fn/wvbnz.py for argument names.
```
