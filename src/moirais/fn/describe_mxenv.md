# describe('mxenv') — multi_env_model
...
`print(result)` render. See `moirais.fn.describe('mxenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxenv import *
import numpy as np
# See the function signature in fn/mxenv.py for argument names.
```
