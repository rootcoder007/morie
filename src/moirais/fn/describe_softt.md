# describe('softt') — soft_threshold_fn
...
`print(result)` render. See `moirais.fn.describe('softt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.softt import *
import numpy as np
# See the function signature in fn/softt.py for argument names.
```
