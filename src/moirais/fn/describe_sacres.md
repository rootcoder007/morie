...
`print(result)` render. See `moirais.fn.describe('sacres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacres import *
import numpy as np
# See the function signature in fn/sacres.py for argument names.
```
