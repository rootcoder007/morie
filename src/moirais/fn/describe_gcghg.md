...
`print(result)` render. See `moirais.fn.describe('gcghg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcghg import *
import numpy as np
# See the function signature in fn/gcghg.py for argument names.
```
