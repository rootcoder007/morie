# describe('compdp') — basic_composition
...
`print(result)` render. See `moirais.fn.describe('compdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.compdp import *
import numpy as np
# See the function signature in fn/compdp.py for argument names.
```
