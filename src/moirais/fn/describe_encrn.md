...
`print(result)` render. See `moirais.fn.describe('encrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.encrn import *
import numpy as np
# See the function signature in fn/encrn.py for argument names.
```
