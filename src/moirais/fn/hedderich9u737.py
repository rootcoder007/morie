...
__all__ = ["hedderich_chapter_9_unnumbered_737"]


def hedderich_chapter_9_unnumbered_737(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 2. ForP (X≤4|10) with ˆz =|(4−10)|/
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u737')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u737: CountModels expression (auto-extracted; see ref)."
