# describe('aitbcp') — compositional_bray_curtis
...
`print(result)` render. See `moirais.fn.describe('aitbcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitbcp import *
import numpy as np
# See the function signature in fn/aitbcp.py for argument names.
```
