# describe('msm150') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm150')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm150 import *
import numpy as np
# See the function signature in fn/msm150.py for argument names.
```
