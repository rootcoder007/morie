# describe('tqlld') — turboquant_lloyd_max_codebook
...
`print(result)` render. See `moirais.fn.describe('tqlld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqlld import *
import numpy as np
# See the function signature in fn/tqlld.py for argument names.
```
