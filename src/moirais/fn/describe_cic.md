# describe('cic') — changes_in_changes
...
`print(result)` render. See `moirais.fn.describe('cic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cic import *
import numpy as np
# See the function signature in fn/cic.py for argument names.
```
