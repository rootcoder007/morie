# describe('ultra') — ensemble_aggregate
...
`print(result)` render. See `moirais.fn.describe('ultra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ultra import *
import numpy as np
# See the function signature in fn/ultra.py for argument names.
```
