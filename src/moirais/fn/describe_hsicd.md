# describe('hsicd') — hsic_independence
...
`print(result)` render. See `moirais.fn.describe('hsicd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsicd import *
import numpy as np
# See the function signature in fn/hsicd.py for argument names.
```
