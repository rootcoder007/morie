...
__all__ = ["hedderich_chapter_9_unnumbered_3504"]


def hedderich_chapter_9_unnumbered_3504(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: + data = long , random = ~ 1 | case)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3504')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3504: ANOVA expression (auto-extracted; see ref)."
