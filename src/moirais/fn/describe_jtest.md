# describe('jtest') — jtest

## WHAT IT DOES

J-test spatial clustering
...
`print(result)` render. See `moirais.fn.describe('jtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jtest import *
import numpy as np
# See the function signature in fn/jtest.py for argument names.
```
