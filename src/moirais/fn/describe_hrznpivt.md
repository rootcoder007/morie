# describe('hrznpivt') — horowitz_npiv_unknown_T
...
`print(result)` render. See `moirais.fn.describe('hrznpivt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznpivt import *
import numpy as np
# See the function signature in fn/hrznpivt.py for argument names.
```
