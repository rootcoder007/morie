# describe('trsfn') — transfer_entropy
...
`print(result)` render. See `moirais.fn.describe('trsfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsfn import *
import numpy as np
# See the function signature in fn/trsfn.py for argument names.
```
