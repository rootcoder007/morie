...
`print(result)` render. See `moirais.fn.describe('rotgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rotgrd import *
import numpy as np
# See the function signature in fn/rotgrd.py for argument names.
```
