...
__all__ = ["wilcox_chapter_4_unnumbered_46"]


def wilcox_chapter_4_unnumbered_46(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X =x) =P (Y =y), (3.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u46')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u46: GeneralStatistics expression (auto-extracted; see ref)."
