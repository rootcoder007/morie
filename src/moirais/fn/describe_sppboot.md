...
`print(result)` render. See `moirais.fn.describe('sppboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppboot import *
import numpy as np
# See the function signature in fn/sppboot.py for argument names.
```
