...
__all__ = ["guide_on_data_analysis_chapter_8_unnumbered_667"]


def guide_on_data_analysis_chapter_8_unnumbered_667(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑦𝑖𝑗𝑘 = 𝜇 + 𝑖𝑖 + 𝑣𝑗 + (𝑖𝑣)𝑖𝑗 + 𝑓𝑘 + 𝜖𝑖𝑗𝑘
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis8u667')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis8u667: GeneralStatistics expression (auto-extracted; see ref)."
