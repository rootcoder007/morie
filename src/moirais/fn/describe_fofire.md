...
`print(result)` render. See `moirais.fn.describe('fofire')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fofire import *
import numpy as np
# See the function signature in fn/fofire.py for argument names.
```
