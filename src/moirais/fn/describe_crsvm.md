...
`print(result)` render. See `moirais.fn.describe('crsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crsvm import *
import numpy as np
# See the function signature in fn/crsvm.py for argument names.
```
