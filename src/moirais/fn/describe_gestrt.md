# describe('gestrt') — gestrt

## WHAT IT DOES

Startup density spatial
...
`print(result)` render. See `moirais.fn.describe('gestrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gestrt import *
import numpy as np
# See the function signature in fn/gestrt.py for argument names.
```
