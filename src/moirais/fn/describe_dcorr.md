# describe('dcorr') — distance_correlation
...
`print(result)` render. See `moirais.fn.describe('dcorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcorr import *
import numpy as np
# See the function signature in fn/dcorr.py for argument names.
```
