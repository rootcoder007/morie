...
`print(result)` render. See `moirais.fn.describe('asorxx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.asorxx import *
import numpy as np
# See the function signature in fn/asorxx.py for argument names.
```
