...
__all__ = ["hedderich_chapter_9_unnumbered_1889"]


def hedderich_chapter_9_unnumbered_1889(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: P (T≤ˆt|H0)≤αapplies accordingly.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1889')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1889: CountModels expression (auto-extracted; see ref)."
