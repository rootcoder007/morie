# describe('hrztpar') — horowitz_parametric_T
...
`print(result)` render. See `moirais.fn.describe('hrztpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztpar import *
import numpy as np
# See the function signature in fn/hrztpar.py for argument names.
```
