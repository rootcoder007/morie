# describe('osumm') — otis_summary_table
...
`print(result)` render. See `moirais.fn.describe('osumm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.osumm import *
import numpy as np
# See the function signature in fn/osumm.py for argument names.
```
