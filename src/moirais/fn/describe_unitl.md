# describe('unitl') — unit_length_normalization
...
`print(result)` render. See `moirais.fn.describe('unitl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unitl import *
import numpy as np
# See the function signature in fn/unitl.py for argument names.
```
