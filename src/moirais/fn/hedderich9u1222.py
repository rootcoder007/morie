...
__all__ = ["hedderich_chapter_9_unnumbered_1222"]


def hedderich_chapter_9_unnumbered_1222(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (Y =k|X +Y =m) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1222')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1222: CountModels expression (auto-extracted; see ref)."
