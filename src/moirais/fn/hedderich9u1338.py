...
__all__ = ["hedderich_chapter_9_unnumbered_1338"]


def hedderich_chapter_9_unnumbered_1338(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (α= 0.05,z1−α/2 =z0.975 = 1.960) (cf. H.E. Solberg [Sol83], p. 759).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1338')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1338: GeneralStatistics expression (auto-extracted; see ref)."
