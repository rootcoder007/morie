# describe('sgtsck') — sgt_spectral_clustering_k
...
`print(result)` render. See `moirais.fn.describe('sgtsck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsck import *
import numpy as np
# See the function signature in fn/sgtsck.py for argument names.
```
