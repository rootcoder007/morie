# describe('hrzpanel') — horowitz_panel_deconv
...
`print(result)` render. See `moirais.fn.describe('hrzpanel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzpanel import *
import numpy as np
# See the function signature in fn/hrzpanel.py for argument names.
```
