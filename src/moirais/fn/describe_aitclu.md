# describe('aitclu') — compositional_kmeans
...
`print(result)` render. See `moirais.fn.describe('aitclu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitclu import *
import numpy as np
# See the function signature in fn/aitclu.py for argument names.
```
