...
__all__ = ["wilcox_chapter_13_unnumbered_1253"]


def wilcox_chapter_13_unnumbered_1253(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pts=NA,xout=FALSE, outfun=out,LP=TRUE, sm=FALSE, est=hd,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1253')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1253: GeneralStatistics expression (auto-extracted; see ref)."
