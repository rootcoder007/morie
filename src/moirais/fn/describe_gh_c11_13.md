# describe('gh_c11_13') — ghosal_gp_adapt_thm
...
`print(result)` render. See `moirais.fn.describe('gh_c11_13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c11_13 import *
import numpy as np
# See the function signature in fn/gh_c11_13.py for argument names.
```
