# describe('rng042') — rangayyan_ch3_lsi_series_total
...
`print(result)` render. See `moirais.fn.describe('rng042')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng042 import *
import numpy as np
# See the function signature in fn/rng042.py for argument names.
```
