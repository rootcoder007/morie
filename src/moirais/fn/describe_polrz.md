# describe('polrz') — polarization_index
...
`print(result)` render. See `moirais.fn.describe('polrz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polrz import *
import numpy as np
# See the function signature in fn/polrz.py for argument names.
```
