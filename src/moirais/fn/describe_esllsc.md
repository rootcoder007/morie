...
`print(result)` render. See `moirais.fn.describe('esllsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllsc import *
import numpy as np
# See the function signature in fn/esllsc.py for argument names.
```
