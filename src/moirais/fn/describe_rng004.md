# describe('rng004') — rangayyan_ch3_skewness
...
`print(result)` render. See `moirais.fn.describe('rng004')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng004 import *
import numpy as np
# See the function signature in fn/rng004.py for argument names.
```
