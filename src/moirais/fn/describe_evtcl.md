...
`print(result)` render. See `moirais.fn.describe('evtcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtcl import *
import numpy as np
# See the function signature in fn/evtcl.py for argument names.
```
