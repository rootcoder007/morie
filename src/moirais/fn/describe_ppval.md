...
`print(result)` render. See `moirais.fn.describe('ppval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppval import *
import numpy as np
# See the function signature in fn/ppval.py for argument names.
```
