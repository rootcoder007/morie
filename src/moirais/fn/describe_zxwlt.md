# describe('zxwlt') — wavelet_spatial
...
`print(result)` render. See `moirais.fn.describe('zxwlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxwlt import *
import numpy as np
# See the function signature in fn/zxwlt.py for argument names.
```
