...
`print(result)` render. See `moirais.fn.describe('sorun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sorun import *
import numpy as np
# See the function signature in fn/sorun.py for argument names.
```
