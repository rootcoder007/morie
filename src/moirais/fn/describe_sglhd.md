...
`print(result)` render. See `moirais.fn.describe('sglhd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglhd import *
import numpy as np
# See the function signature in fn/sglhd.py for argument names.
```
