...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1245"]


def guide_on_data_analysis_chapter_25_unnumbered_1245(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 0.94107, p-value = 0.1424
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1245')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1245: GeneralStatistics expression (auto-extracted; see ref)."
