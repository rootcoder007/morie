...
`print(result)` render. See `moirais.fn.describe('stukrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stukrg import *
import numpy as np
# See the function signature in fn/stukrg.py for argument names.
```
