# describe('sgtclo') — sgt_closeness_centrality
...
`print(result)` render. See `moirais.fn.describe('sgtclo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtclo import *
import numpy as np
# See the function signature in fn/sgtclo.py for argument names.
```
