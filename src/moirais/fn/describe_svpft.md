...
`print(result)` render. See `moirais.fn.describe('svpft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpft import *
import numpy as np
# See the function signature in fn/svpft.py for argument names.
```
