# describe('immid') — index_moderated_mediation
...
`print(result)` render. See `moirais.fn.describe('immid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.immid import *
import numpy as np
# See the function signature in fn/immid.py for argument names.
```
