# describe('specA') — spectral_anomaly
...
`print(result)` render. See `moirais.fn.describe('specA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specA import *
import numpy as np
# See the function signature in fn/specA.py for argument names.
```
