...
__all__ = ["hedderich_chapter_9_unnumbered_2841"]


def hedderich_chapter_9_unnumbered_2841(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + dim=c ( 2 , 2 , 6 ) , dimnames = list ( c ( " exposed " , " n o t exposed " ) ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2841')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2841: GeneralStatistics expression (auto-extracted; see ref)."
