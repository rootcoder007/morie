...
`print(result)` render. See `moirais.fn.describe('agci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agci import *
import numpy as np
# See the function signature in fn/agci.py for argument names.
```
