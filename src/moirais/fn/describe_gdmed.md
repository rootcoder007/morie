...
`print(result)` render. See `moirais.fn.describe('gdmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmed import *
import numpy as np
# See the function signature in fn/gdmed.py for argument names.
```
