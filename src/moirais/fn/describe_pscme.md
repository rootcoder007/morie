# describe('pscme') — path_specific_causal_effect
...
`print(result)` render. See `moirais.fn.describe('pscme')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pscme import *
import numpy as np
# See the function signature in fn/pscme.py for argument names.
```
