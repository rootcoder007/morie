# describe('snrqt') — snr_quantization
...
`print(result)` render. See `moirais.fn.describe('snrqt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snrqt import *
import numpy as np
# See the function signature in fn/snrqt.py for argument names.
```
