# describe('vilbrt') — vilbert_two_stream
...
`print(result)` render. See `moirais.fn.describe('vilbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vilbrt import *
import numpy as np
# See the function signature in fn/vilbrt.py for argument names.
```
