# describe('alsft') — alammar_setfit_twostep
...
`print(result)` render. See `moirais.fn.describe('alsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alsft import *
import numpy as np
# See the function signature in fn/alsft.py for argument names.
```
