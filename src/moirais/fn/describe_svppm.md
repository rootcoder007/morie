# describe('svppm') — party_manifesto
...
`print(result)` render. See `moirais.fn.describe('svppm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svppm import *
import numpy as np
# See the function signature in fn/svppm.py for argument names.
```
