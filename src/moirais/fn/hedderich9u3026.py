...
__all__ = ["hedderich_chapter_9_unnumbered_3026"]


def hedderich_chapter_9_unnumbered_3026(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1,2 = 9, 232> 9, 21 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3026')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3026: GeneralStatistics expression (auto-extracted; see ref)."
