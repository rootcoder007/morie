# describe('msin2') — indscal_weights
...
`print(result)` render. See `moirais.fn.describe('msin2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msin2 import *
import numpy as np
# See the function signature in fn/msin2.py for argument names.
```
