# describe('msm213') — mvsml_ridge_lasso_elastic_eq_9_33
...
`print(result)` render. See `moirais.fn.describe('msm213')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm213 import *
import numpy as np
# See the function signature in fn/msm213.py for argument names.
```
