# describe('chrnff') — chernoff_bound
...
`print(result)` render. See `moirais.fn.describe('chrnff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chrnff import *
import numpy as np
# See the function signature in fn/chrnff.py for argument names.
```
