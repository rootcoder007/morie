...
`print(result)` render. See `moirais.fn.describe('rsndv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsndv import *
import numpy as np
# See the function signature in fn/rsndv.py for argument names.
```
