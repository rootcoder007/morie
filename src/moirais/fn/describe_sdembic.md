...
`print(result)` render. See `moirais.fn.describe('sdembic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdembic import *
import numpy as np
# See the function signature in fn/sdembic.py for argument names.
```
