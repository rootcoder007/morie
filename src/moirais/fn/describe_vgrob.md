...
`print(result)` render. See `moirais.fn.describe('vgrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgrob import *
import numpy as np
# See the function signature in fn/vgrob.py for argument names.
```
