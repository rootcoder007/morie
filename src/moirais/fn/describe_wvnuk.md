...
`print(result)` render. See `moirais.fn.describe('wvnuk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvnuk import *
import numpy as np
# See the function signature in fn/wvnuk.py for argument names.
```
