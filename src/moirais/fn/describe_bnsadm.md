# describe('bnsadm') — bound_admissible_estimators
...
`print(result)` render. See `moirais.fn.describe('bnsadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnsadm import *
import numpy as np
# See the function signature in fn/bnsadm.py for argument names.
```
