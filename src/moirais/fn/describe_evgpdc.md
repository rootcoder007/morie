...
`print(result)` render. See `moirais.fn.describe('evgpdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdc import *
import numpy as np
# See the function signature in fn/evgpdc.py for argument names.
```
