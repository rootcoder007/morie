...
__all__ = ["hedderich_chapter_9_unnumbered_2877"]


def hedderich_chapter_9_unnumbered_2877(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : π1 = πk−2 andH0 : π3 = πk, each at the level 2·α/[k(k−3)], etc. until one possibly
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2877')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2877: GeneralStatistics expression (auto-extracted; see ref)."
