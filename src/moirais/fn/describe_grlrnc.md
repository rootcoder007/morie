# describe('grlrnc') — geron_learning_curves
...
`print(result)` render. See `moirais.fn.describe('grlrnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlrnc import *
import numpy as np
# See the function signature in fn/grlrnc.py for argument names.
```
