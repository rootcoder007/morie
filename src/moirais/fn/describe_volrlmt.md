# describe('volrlmt') — vol_realised_log_vol_ar
...
`print(result)` render. See `moirais.fn.describe('volrlmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrlmt import *
import numpy as np
# See the function signature in fn/volrlmt.py for argument names.
```
