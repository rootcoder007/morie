# describe('stimp') — plot_stimuli_positions
...
`print(result)` render. See `moirais.fn.describe('stimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stimp import *
import numpy as np
# See the function signature in fn/stimp.py for argument names.
```
