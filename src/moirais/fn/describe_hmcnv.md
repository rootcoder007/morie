# describe('hmcnv') — geron_convolutional_layer
...
`print(result)` render. See `moirais.fn.describe('hmcnv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcnv import *
import numpy as np
# See the function signature in fn/hmcnv.py for argument names.
```
