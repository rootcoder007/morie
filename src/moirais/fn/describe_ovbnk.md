# describe('ovbnk') — oster_omitted_bias_bound
...
`print(result)` render. See `moirais.fn.describe('ovbnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ovbnk import *
import numpy as np
# See the function signature in fn/ovbnk.py for argument names.
```
