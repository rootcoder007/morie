# describe('grvit') — geron_vit_patch_embedding
...
`print(result)` render. See `moirais.fn.describe('grvit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grvit import *
import numpy as np
# See the function signature in fn/grvit.py for argument names.
```
