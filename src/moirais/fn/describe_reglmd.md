# describe('reglmd') — regression_estimator
...
`print(result)` render. See `moirais.fn.describe('reglmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reglmd import *
import numpy as np
# See the function signature in fn/reglmd.py for argument names.
```
