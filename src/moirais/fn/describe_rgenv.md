# describe('rgenv') — rangayyan_envelope
...
`print(result)` render. See `moirais.fn.describe('rgenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgenv import *
import numpy as np
# See the function signature in fn/rgenv.py for argument names.
```
