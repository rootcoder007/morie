# describe('msm132') — mvsml_categorical_count_eq_8_5
...
`print(result)` render. See `moirais.fn.describe('msm132')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm132 import *
import numpy as np
# See the function signature in fn/msm132.py for argument names.
```
