# describe('csfgrf') — causal_survival_forest
...
`print(result)` render. See `moirais.fn.describe('csfgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csfgrf import *
import numpy as np
# See the function signature in fn/csfgrf.py for argument names.
```
