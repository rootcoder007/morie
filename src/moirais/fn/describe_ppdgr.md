...
`print(result)` render. See `moirais.fn.describe('ppdgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppdgr import *
import numpy as np
# See the function signature in fn/ppdgr.py for argument names.
```
