...
__all__ = ["bivand2013_chapter_7_unnumbered_84"]


def bivand2013_chapter_7_unnumbered_84(x):
    """
    Spatial expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u84')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u84: Spatial expression (auto-extracted; see ref)."
