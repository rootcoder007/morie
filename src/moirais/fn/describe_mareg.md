# describe('mareg') — ma_meta_regression
...
`print(result)` render. See `moirais.fn.describe('mareg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mareg import *
import numpy as np
# See the function signature in fn/mareg.py for argument names.
```
