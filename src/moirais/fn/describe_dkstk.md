...
`print(result)` render. See `moirais.fn.describe('dkstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkstk import *
import numpy as np
# See the function signature in fn/dkstk.py for argument names.
```
