...
__all__ = ["hedderich_chapter_9_unnumbered_746"]


def hedderich_chapter_9_unnumbered_746(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X =k + 1) = (r +k)(1−p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u746')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u746: CountModels expression (auto-extracted; see ref)."
