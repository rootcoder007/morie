...
`print(result)` render. See `moirais.fn.describe('dcnvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcnvl import *
import numpy as np
# See the function signature in fn/dcnvl.py for argument names.
```
