...
`print(result)` render. See `moirais.fn.describe('hscir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hscir import *
import numpy as np
# See the function signature in fn/hscir.py for argument names.
```
