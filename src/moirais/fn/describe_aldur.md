...
`print(result)` render. See `moirais.fn.describe('aldur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aldur import *
import numpy as np
# See the function signature in fn/aldur.py for argument names.
```
