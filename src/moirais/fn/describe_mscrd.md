...
`print(result)` render. See `moirais.fn.describe('mscrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscrd import *
import numpy as np
# See the function signature in fn/mscrd.py for argument names.
```
