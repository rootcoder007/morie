...
`print(result)` render. See `moirais.fn.describe('lacun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacun import *
import numpy as np
# See the function signature in fn/lacun.py for argument names.
```
