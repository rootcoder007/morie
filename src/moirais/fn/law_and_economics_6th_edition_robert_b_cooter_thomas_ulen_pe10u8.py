...
__all__ = ["law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_8"]


def law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_8(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: cooperative value =+ $5 - $1 - $5 - $1 =- $2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u8')`` for the full guide.
...
def cheatsheet():
    return "law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u8: GeneralStatistics expression (auto-extracted; see ref)."
