# describe('cyclE') — cyclone_intensity
...
`print(result)` render. See `moirais.fn.describe('cyclE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cyclE import *
import numpy as np
# See the function signature in fn/cyclE.py for argument names.
```
