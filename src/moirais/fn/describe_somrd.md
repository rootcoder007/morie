...
`print(result)` render. See `moirais.fn.describe('somrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.somrd import *
import numpy as np
# See the function signature in fn/somrd.py for argument names.
```
