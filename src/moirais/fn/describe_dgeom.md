...
`print(result)` render. See `moirais.fn.describe('dgeom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dgeom import *
import numpy as np
# See the function signature in fn/dgeom.py for argument names.
```
