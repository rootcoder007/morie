...
`print(result)` render. See `moirais.fn.describe('plkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plkt import *
import numpy as np
# See the function signature in fn/plkt.py for argument names.
```
