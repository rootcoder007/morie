...
`print(result)` render. See `moirais.fn.describe('trsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trsig import *
import numpy as np
# See the function signature in fn/trsig.py for argument names.
```
