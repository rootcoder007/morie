...
`print(result)` render. See `moirais.fn.describe('spprmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprmf import *
import numpy as np
# See the function signature in fn/spprmf.py for argument names.
```
