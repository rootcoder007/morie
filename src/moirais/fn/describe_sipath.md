...
`print(result)` render. See `moirais.fn.describe('sipath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sipath import *
import numpy as np
# See the function signature in fn/sipath.py for argument names.
```
