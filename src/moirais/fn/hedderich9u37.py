...
__all__ = ["hedderich_chapter_9_unnumbered_37"]


def hedderich_chapter_9_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The double sum isn(n + 1) and must still be divided by 2: 100·101/2=50·101=5050.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u37')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u37: GeneralStatistics expression (auto-extracted; see ref)."
