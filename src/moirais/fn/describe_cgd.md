# describe('cgd') — conjugate_gradient
...
`print(result)` render. See `moirais.fn.describe('cgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cgd import *
import numpy as np
# See the function signature in fn/cgd.py for argument names.
```
