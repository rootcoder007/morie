# describe('bbtrs') — blackbox_transpose
...
`print(result)` render. See `moirais.fn.describe('bbtrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbtrs import *
import numpy as np
# See the function signature in fn/bbtrs.py for argument names.
```
