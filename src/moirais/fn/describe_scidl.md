# describe('scidl') — scatter_ideal_points
...
`print(result)` render. See `moirais.fn.describe('scidl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scidl import *
import numpy as np
# See the function signature in fn/scidl.py for argument names.
```
