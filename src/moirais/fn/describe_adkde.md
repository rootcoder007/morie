...
`print(result)` render. See `moirais.fn.describe('adkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adkde import *
import numpy as np
# See the function signature in fn/adkde.py for argument names.
```
