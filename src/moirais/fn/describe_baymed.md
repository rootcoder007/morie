# describe('baymed') — bayes_mediation
...
`print(result)` render. See `moirais.fn.describe('baymed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baymed import *
import numpy as np
# See the function signature in fn/baymed.py for argument names.
```
