...
__all__ = ["wilcox_chapter_8_unnumbered_870"]


def wilcox_chapter_8_unnumbered_870(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and ν 2 = (n − 1)(J − 1) degrees of freedom.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u870')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u870: GeneralStatistics expression (auto-extracted; see ref)."
