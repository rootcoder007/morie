...
`print(result)` render. See `moirais.fn.describe('gaview')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaview import *
import numpy as np
# See the function signature in fn/gaview.py for argument names.
```
