...
`print(result)` render. See `moirais.fn.describe('rlts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlts import *
import numpy as np
# See the function signature in fn/rlts.py for argument names.
```
