# describe('spkfun') — schabenberger_k_function
...
`print(result)` render. See `moirais.fn.describe('spkfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkfun import *
import numpy as np
# See the function signature in fn/spkfun.py for argument names.
```
