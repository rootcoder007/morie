# describe('bndmsg') — bound_missing_outcome
...
`print(result)` render. See `moirais.fn.describe('bndmsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndmsg import *
import numpy as np
# See the function signature in fn/bndmsg.py for argument names.
```
