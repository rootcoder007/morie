...
`print(result)` render. See `moirais.fn.describe('opaco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opaco import *
import numpy as np
# See the function signature in fn/opaco.py for argument names.
```
