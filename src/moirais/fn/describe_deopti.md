# describe('deopti') — differential_evolution
...
`print(result)` render. See `moirais.fn.describe('deopti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deopti import *
import numpy as np
# See the function signature in fn/deopti.py for argument names.
```
