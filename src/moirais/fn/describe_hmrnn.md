# describe('hmrnn') — geron_recurrent_neuron
...
`print(result)` render. See `moirais.fn.describe('hmrnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrnn import *
import numpy as np
# See the function signature in fn/hmrnn.py for argument names.
```
