...
`print(result)` render. See `moirais.fn.describe('gmatx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmatx import *
import numpy as np
# See the function signature in fn/gmatx.py for argument names.
```
