...
`print(result)` render. See `moirais.fn.describe('tbats')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbats import *
import numpy as np
# See the function signature in fn/tbats.py for argument names.
```
