...
`print(result)` render. See `moirais.fn.describe('wlnmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlnmx import *
import numpy as np
# See the function signature in fn/wlnmx.py for argument names.
```
