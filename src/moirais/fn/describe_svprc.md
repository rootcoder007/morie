...
`print(result)` render. See `moirais.fn.describe('svprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svprc import *
import numpy as np
# See the function signature in fn/svprc.py for argument names.
```
