...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1443"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1443(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1443')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u1443: GeneralStatistics expression (auto-extracted; see ref)."
