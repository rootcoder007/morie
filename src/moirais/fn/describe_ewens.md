# describe('ewens') — ewens_partition
...
`print(result)` render. See `moirais.fn.describe('ewens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ewens import *
import numpy as np
# See the function signature in fn/ewens.py for argument names.
```
