...
`print(result)` render. See `moirais.fn.describe('tjfun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tjfun import *
import numpy as np
# See the function signature in fn/tjfun.py for argument names.
```
