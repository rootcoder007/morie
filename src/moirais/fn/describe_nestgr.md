...
`print(result)` render. See `moirais.fn.describe('nestgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nestgr import *
import numpy as np
# See the function signature in fn/nestgr.py for argument names.
```
