...
`print(result)` render. See `moirais.fn.describe('difub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difub import *
import numpy as np
# See the function signature in fn/difub.py for argument names.
```
