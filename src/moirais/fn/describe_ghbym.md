...
`print(result)` render. See `moirais.fn.describe('ghbym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghbym import *
import numpy as np
# See the function signature in fn/ghbym.py for argument names.
```
