...
`print(result)` render. See `moirais.fn.describe('ppnnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppnnd import *
import numpy as np
# See the function signature in fn/ppnnd.py for argument names.
```
