...
`print(result)` render. See `moirais.fn.describe('msdef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msdef import *
import numpy as np
# See the function signature in fn/msdef.py for argument names.
```
