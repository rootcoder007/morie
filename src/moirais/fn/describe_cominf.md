...
`print(result)` render. See `moirais.fn.describe('cominf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cominf import *
import numpy as np
# See the function signature in fn/cominf.py for argument names.
```
