...
__all__ = ["hedderich_chapter_9_unnumbered_2910"]


def hedderich_chapter_9_unnumbered_2910(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + p <− 2*pnorm ( abs ( z ) , lower . tail =FALSE ) # P−v alue two−s ided
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2910')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2910: GeneralStatistics expression (auto-extracted; see ref)."
