# describe('ksr027') — kosorok_ch2_law_large_numbers_pointwise
...
`print(result)` render. See `moirais.fn.describe('ksr027')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr027 import *
import numpy as np
# See the function signature in fn/ksr027.py for argument names.
```
