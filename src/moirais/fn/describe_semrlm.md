...
`print(result)` render. See `moirais.fn.describe('semrlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semrlm import *
import numpy as np
# See the function signature in fn/semrlm.py for argument names.
```
