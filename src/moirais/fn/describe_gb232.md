# describe('gb232') — gibbons_glivenko_cantelli
...
`print(result)` render. See `moirais.fn.describe('gb232')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb232 import *
import numpy as np
# See the function signature in fn/gb232.py for argument names.
```
