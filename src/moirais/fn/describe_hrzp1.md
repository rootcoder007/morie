# describe('hrzp1') — horowitz_plr_estimator
...
`print(result)` render. See `moirais.fn.describe('hrzp1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzp1 import *
import numpy as np
# See the function signature in fn/hrzp1.py for argument names.
```
