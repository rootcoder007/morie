...
`print(result)` render. See `moirais.fn.describe('rmssg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmssg import *
import numpy as np
# See the function signature in fn/rmssg.py for argument names.
```
