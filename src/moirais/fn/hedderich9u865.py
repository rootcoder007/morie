...
__all__ = ["hedderich_chapter_9_unnumbered_865"]


def hedderich_chapter_9_unnumbered_865(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: If the random variablesXi follow a Bernoulli distribution, i.e.P (Xi = 1) = p andP (Xi = 0) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u865')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u865: GeneralStatistics expression (auto-extracted; see ref)."
