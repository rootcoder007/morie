...
`print(result)` render. See `moirais.fn.describe('mgwrdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrdg import *
import numpy as np
# See the function signature in fn/mgwrdg.py for argument names.
```
