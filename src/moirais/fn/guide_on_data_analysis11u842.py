...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_842"]


def guide_on_data_analysis_chapter_11_unnumbered_842(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: vcov = newey_west(2) ~ Month + Day
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u842')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u842: GeneralStatistics expression (auto-extracted; see ref)."
