...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_5"]


def guide_on_data_analysis_chapter_2_unnumbered_5(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = [𝑎11𝑏11 + 𝑎12𝑏21 + 𝑎13𝑏31 ∑
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u5')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u5: GeneralStatistics expression (auto-extracted; see ref)."
