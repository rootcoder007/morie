...
`print(result)` render. See `moirais.fn.describe('splhf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splhf import *
import numpy as np
# See the function signature in fn/splhf.py for argument names.
```
