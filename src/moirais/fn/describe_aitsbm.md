# describe('aitsbm') — compositional_simbias
...
`print(result)` render. See `moirais.fn.describe('aitsbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitsbm import *
import numpy as np
# See the function signature in fn/aitsbm.py for argument names.
```
