...
`print(result)` render. See `moirais.fn.describe('clist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clist import *
import numpy as np
# See the function signature in fn/clist.py for argument names.
```
