# describe('grcvf') — geron_conv2d_forward
...
`print(result)` render. See `moirais.fn.describe('grcvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcvf import *
import numpy as np
# See the function signature in fn/grcvf.py for argument names.
```
