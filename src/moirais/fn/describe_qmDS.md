# describe('qmDS') — quantile_mapping
...
`print(result)` render. See `moirais.fn.describe('qmDS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qmDS import *
import numpy as np
# See the function signature in fn/qmDS.py for argument names.
```
