...
`print(result)` render. See `moirais.fn.describe('ageve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ageve import *
import numpy as np
# See the function signature in fn/ageve.py for argument names.
```
