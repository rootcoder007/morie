# describe('joexw') — joseph_expanding_window_cv
...
`print(result)` render. See `moirais.fn.describe('joexw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joexw import *
import numpy as np
# See the function signature in fn/joexw.py for argument names.
```
