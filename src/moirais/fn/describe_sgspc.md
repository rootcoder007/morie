# describe('sgspc') — spectral_density
...
`print(result)` render. See `moirais.fn.describe('sgspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgspc import *
import numpy as np
# See the function signature in fn/sgspc.py for argument names.
```
