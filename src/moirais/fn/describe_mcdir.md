# describe('mcdir') — mcdiarmid_bound
...
`print(result)` render. See `moirais.fn.describe('mcdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcdir import *
import numpy as np
# See the function signature in fn/mcdir.py for argument names.
```
