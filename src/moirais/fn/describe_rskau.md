...
`print(result)` render. See `moirais.fn.describe('rskau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskau import *
import numpy as np
# See the function signature in fn/rskau.py for argument names.
```
