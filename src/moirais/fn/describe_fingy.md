...
`print(result)` render. See `moirais.fn.describe('fingy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fingy import *
import numpy as np
# See the function signature in fn/fingy.py for argument names.
```
