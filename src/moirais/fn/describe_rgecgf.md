# describe('rgecgf') — rangayyan_ecg_features
...
`print(result)` render. See `moirais.fn.describe('rgecgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgecgf import *
import numpy as np
# See the function signature in fn/rgecgf.py for argument names.
```
