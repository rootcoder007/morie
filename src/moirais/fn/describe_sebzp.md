...
`print(result)` render. See `moirais.fn.describe('sebzp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebzp import *
import numpy as np
# See the function signature in fn/sebzp.py for argument names.
```
