...
`print(result)` render. See `moirais.fn.describe('eta2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eta2 import *
import numpy as np
# See the function signature in fn/eta2.py for argument names.
```
