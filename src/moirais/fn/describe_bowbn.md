# describe('bowbn') — bow_ban_theorem
...
`print(result)` render. See `moirais.fn.describe('bowbn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bowbn import *
import numpy as np
# See the function signature in fn/bowbn.py for argument names.
```
