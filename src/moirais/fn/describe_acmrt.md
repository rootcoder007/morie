# describe('acmrt') — age_cause_mortality
...
`print(result)` render. See `moirais.fn.describe('acmrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acmrt import *
import numpy as np
# See the function signature in fn/acmrt.py for argument names.
```
