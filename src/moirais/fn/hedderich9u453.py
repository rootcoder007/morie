...
__all__ = ["hedderich_chapter_9_unnumbered_453"]


def hedderich_chapter_9_unnumbered_453(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (E1∩E2∩E3) = P (E1)·P (E2|E1)·P (E3|E2) = 0.20·0.30·0.05 = 0.003 = 0.3%.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u453')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u453: GeneralStatistics expression (auto-extracted; see ref)."
