...
`print(result)` render. See `moirais.fn.describe('deepar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deepar import *
import numpy as np
# See the function signature in fn/deepar.py for argument names.
```
