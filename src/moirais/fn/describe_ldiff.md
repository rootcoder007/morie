# describe('ldiff') — l_diversity_check
...
`print(result)` render. See `moirais.fn.describe('ldiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldiff import *
import numpy as np
# See the function signature in fn/ldiff.py for argument names.
```
