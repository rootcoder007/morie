# describe('sfcret') — surface_retrieval
...
`print(result)` render. See `moirais.fn.describe('sfcret')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfcret import *
import numpy as np
# See the function signature in fn/sfcret.py for argument names.
```
