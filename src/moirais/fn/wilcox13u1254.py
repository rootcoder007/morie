...
__all__ = ["wilcox_chapter_13_unnumbered_1254"]


def wilcox_chapter_13_unnumbered_1254(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ancpb(x1,y1,x2,y2, est=hd, pts=NA, fr1=1, fr2=1, nboot=599, plotit=TRUE,...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1254')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1254: GeneralStatistics expression (auto-extracted; see ref)."
