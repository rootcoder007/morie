...
`print(result)` render. See `moirais.fn.describe('enstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enstr import *
import numpy as np
# See the function signature in fn/enstr.py for argument names.
```
