...
__all__ = ["hedderich_chapter_9_unnumbered_3155"]


def hedderich_chapter_9_unnumbered_3155(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 3.3085≥1.96 = z0.975 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3155')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3155: GeneralStatistics expression (auto-extracted; see ref)."
