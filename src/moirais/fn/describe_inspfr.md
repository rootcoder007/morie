# describe('inspfr') — inspection_fail_rate
...
`print(result)` render. See `moirais.fn.describe('inspfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inspfr import *
import numpy as np
# See the function signature in fn/inspfr.py for argument names.
```
