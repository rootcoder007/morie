...
`print(result)` render. See `moirais.fn.describe('mdang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdang import *
import numpy as np
# See the function signature in fn/mdang.py for argument names.
```
