# describe('fowndf') — fowndf

## WHAT IT DOES

Windfall risk spatial
...
`print(result)` render. See `moirais.fn.describe('fowndf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fowndf import *
import numpy as np
# See the function signature in fn/fowndf.py for argument names.
```
