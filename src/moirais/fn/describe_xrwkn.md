...
`print(result)` render. See `moirais.fn.describe('xrwkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwkn import *
import numpy as np
# See the function signature in fn/xrwkn.py for argument names.
```
