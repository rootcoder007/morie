...
`print(result)` render. See `moirais.fn.describe('psopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psopt import *
import numpy as np
# See the function signature in fn/psopt.py for argument names.
```
