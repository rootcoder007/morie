...
__all__ = ["hedderich_chapter_9_unnumbered_2578"]


def hedderich_chapter_9_unnumbered_2578(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • distribute the number of repetitions proportionally forσ̸=const.:n1/n2 =σ1/σ2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2578')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2578: GeneralStatistics expression (auto-extracted; see ref)."
