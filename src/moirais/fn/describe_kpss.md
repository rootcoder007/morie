...
`print(result)` render. See `moirais.fn.describe('kpss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpss import *
import numpy as np
# See the function signature in fn/kpss.py for argument names.
```
