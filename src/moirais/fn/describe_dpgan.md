...
`print(result)` render. See `moirais.fn.describe('dpgan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgan import *
import numpy as np
# See the function signature in fn/dpgan.py for argument names.
```
