...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1296"]


def guide_on_data_analysis_chapter_25_unnumbered_1296(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: scale_x_continuous(name = "GPA") +
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1296')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1296: GeneralStatistics expression (auto-extracted; see ref)."
