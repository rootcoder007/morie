...
`print(result)` render. See `moirais.fn.describe('stsgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stsgm import *
import numpy as np
# See the function signature in fn/stsgm.py for argument names.
```
