# describe('oclin') — oc_cutting_line
...
`print(result)` render. See `moirais.fn.describe('oclin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oclin import *
import numpy as np
# See the function signature in fn/oclin.py for argument names.
```
