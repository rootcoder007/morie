...
__all__ = ["hedderich_chapter_9_unnumbered_1556"]


def hedderich_chapter_9_unnumbered_1556(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] p∗=p0 + 12 = 21.78 and q∗=q0 + 30−12 = 40.82 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1556')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1556: CountModels expression (auto-extracted; see ref)."
