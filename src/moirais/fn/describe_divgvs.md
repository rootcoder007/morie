# describe('divgvs') — discriminant_validity
...
`print(result)` render. See `moirais.fn.describe('divgvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.divgvs import *
import numpy as np
# See the function signature in fn/divgvs.py for argument names.
```
