...
`print(result)` render. See `moirais.fn.describe('bhpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhpd import *
import numpy as np
# See the function signature in fn/bhpd.py for argument names.
```
