# describe('drvdt') — derivative_detect
...
`print(result)` render. See `moirais.fn.describe('drvdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drvdt import *
import numpy as np
# See the function signature in fn/drvdt.py for argument names.
```
