# describe('causrddf') — causal_rdd_fuzzy
...
`print(result)` render. See `moirais.fn.describe('causrddf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrddf import *
import numpy as np
# See the function signature in fn/causrddf.py for argument names.
```
