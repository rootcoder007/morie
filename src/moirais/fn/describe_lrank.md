...
`print(result)` render. See `moirais.fn.describe('lrank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrank import *
import numpy as np
# See the function signature in fn/lrank.py for argument names.
```
