...
`print(result)` render. See `moirais.fn.describe('eslnmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslnmf import *
import numpy as np
# See the function signature in fn/eslnmf.py for argument names.
```
