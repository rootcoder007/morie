...
__all__ = ["hedderich_chapter_9_unnumbered_3233"]


def hedderich_chapter_9_unnumbered_3233(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (n1 = ∑ni1;n2 = ∑ni2).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3233')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3233: GeneralStatistics expression (auto-extracted; see ref)."
