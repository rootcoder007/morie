...
`print(result)` render. See `moirais.fn.describe('hmgan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgan import *
import numpy as np
# See the function signature in fn/hmgan.py for argument names.
```
