...
`print(result)` render. See `moirais.fn.describe('sagsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagsp import *
import numpy as np
# See the function signature in fn/sagsp.py for argument names.
```
