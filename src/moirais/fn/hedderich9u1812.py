...
__all__ = ["hedderich_chapter_9_unnumbered_1812"]


def hedderich_chapter_9_unnumbered_1812(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: s ·√n>t n−1;1−α to the right of ˆt
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1812')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1812: GeneralStatistics expression (auto-extracted; see ref)."
