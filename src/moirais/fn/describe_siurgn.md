...
`print(result)` render. See `moirais.fn.describe('siurgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siurgn import *
import numpy as np
# See the function signature in fn/siurgn.py for argument names.
```
