...
`print(result)` render. See `moirais.fn.describe('vmsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmsel import *
import numpy as np
# See the function signature in fn/vmsel.py for argument names.
```
