...
`print(result)` render. See `moirais.fn.describe('agdvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdvs import *
import numpy as np
# See the function signature in fn/agdvs.py for argument names.
```
