# describe('hrzfneps') — horowitz_panel_density_estimators
...
`print(result)` render. See `moirais.fn.describe('hrzfneps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzfneps import *
import numpy as np
# See the function signature in fn/hrzfneps.py for argument names.
```
