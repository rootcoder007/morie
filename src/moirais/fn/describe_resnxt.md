...
`print(result)` render. See `moirais.fn.describe('resnxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.resnxt import *
import numpy as np
# See the function signature in fn/resnxt.py for argument names.
```
