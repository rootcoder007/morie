# describe('rcdrp') — drop_influential_votes
...
`print(result)` render. See `moirais.fn.describe('rcdrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdrp import *
import numpy as np
# See the function signature in fn/rcdrp.py for argument names.
```
