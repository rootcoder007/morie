...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1243"]


def guide_on_data_analysis_chapter_25_unnumbered_1243(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 0.95709, p-value = 0.3375
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1243')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1243: GeneralStatistics expression (auto-extracted; see ref)."
