# describe('tmldyn') — tmle_dynamic_regime
...
`print(result)` render. See `moirais.fn.describe('tmldyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmldyn import *
import numpy as np
# See the function signature in fn/tmldyn.py for argument names.
```
