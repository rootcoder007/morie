# describe('grrep') — geron_reparameterization_trick
...
`print(result)` render. See `moirais.fn.describe('grrep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrep import *
import numpy as np
# See the function signature in fn/grrep.py for argument names.
```
