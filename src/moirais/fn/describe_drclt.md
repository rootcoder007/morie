# describe('drclt') — dr_clustered_did
...
`print(result)` render. See `moirais.fn.describe('drclt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drclt import *
import numpy as np
# See the function signature in fn/drclt.py for argument names.
```
