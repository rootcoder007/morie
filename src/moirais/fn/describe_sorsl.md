...
`print(result)` render. See `moirais.fn.describe('sorsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sorsl import *
import numpy as np
# See the function signature in fn/sorsl.py for argument names.
```
