...
`print(result)` render. See `moirais.fn.describe('wlcmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcmr import *
import numpy as np
# See the function signature in fn/wlcmr.py for argument names.
```
