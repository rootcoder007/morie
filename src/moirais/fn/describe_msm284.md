# describe('msm284') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm284')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm284 import *
import numpy as np
# See the function signature in fn/msm284.py for argument names.
```
