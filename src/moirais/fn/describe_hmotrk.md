# describe('hmotrk') — geron_object_tracking
...
`print(result)` render. See `moirais.fn.describe('hmotrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmotrk import *
import numpy as np
# See the function signature in fn/hmotrk.py for argument names.
```
