# describe('tmlrec') — tmle_recurrent
...
`print(result)` render. See `moirais.fn.describe('tmlrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlrec import *
import numpy as np
# See the function signature in fn/tmlrec.py for argument names.
```
