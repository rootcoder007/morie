# describe('perfat') — performer_favor_attention
...
`print(result)` render. See `moirais.fn.describe('perfat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.perfat import *
import numpy as np
# See the function signature in fn/perfat.py for argument names.
```
