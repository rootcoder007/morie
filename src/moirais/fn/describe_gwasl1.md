...
`print(result)` render. See `moirais.fn.describe('gwasl1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwasl1 import *
import numpy as np
# See the function signature in fn/gwasl1.py for argument names.
```
