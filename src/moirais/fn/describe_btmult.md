# describe('btmult') — boot_multinomial_weights
...
`print(result)` render. See `moirais.fn.describe('btmult')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btmult import *
import numpy as np
# See the function signature in fn/btmult.py for argument names.
```
