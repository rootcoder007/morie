...
`print(result)` render. See `moirais.fn.describe('rbfk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfk import *
import numpy as np
# See the function signature in fn/rbfk.py for argument names.
```
