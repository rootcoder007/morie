# describe('effsiz') — effective_sample_size
...
`print(result)` render. See `moirais.fn.describe('effsiz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effsiz import *
import numpy as np
# See the function signature in fn/effsiz.py for argument names.
```
