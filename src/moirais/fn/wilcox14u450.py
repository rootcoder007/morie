...
__all__ = ["wilcox_chapter_14_unnumbered_450"]


def wilcox_chapter_14_unnumbered_450(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑(Yi − ¯Y )2 − ∑(Yi − ˆYi)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u450')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u450: GeneralStatistics expression (auto-extracted; see ref)."
