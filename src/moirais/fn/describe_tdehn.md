...
`print(result)` render. See `moirais.fn.describe('tdehn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdehn import *
import numpy as np
# See the function signature in fn/tdehn.py for argument names.
```
