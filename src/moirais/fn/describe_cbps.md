# describe('cbps') — covariate_balance_ps
...
`print(result)` render. See `moirais.fn.describe('cbps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cbps import *
import numpy as np
# See the function signature in fn/cbps.py for argument names.
```
