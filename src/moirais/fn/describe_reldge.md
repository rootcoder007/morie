# describe('reldge') — reliability_gebv
...
`print(result)` render. See `moirais.fn.describe('reldge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reldge import *
import numpy as np
# See the function signature in fn/reldge.py for argument names.
```
