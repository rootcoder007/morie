...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_443"]


def guide_on_data_analysis_chapter_5_unnumbered_443(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: mm_fit = predict(mm_model, newdata = data)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u443')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u443: GeneralStatistics expression (auto-extracted; see ref)."
