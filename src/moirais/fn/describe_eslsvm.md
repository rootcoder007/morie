# describe('eslsvm') — esl_svm_kernel
...
`print(result)` render. See `moirais.fn.describe('eslsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsvm import *
import numpy as np
# See the function signature in fn/eslsvm.py for argument names.
```
