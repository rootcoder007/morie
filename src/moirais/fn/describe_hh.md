...
`print(result)` render. See `moirais.fn.describe('hh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hh import *
import numpy as np
# See the function signature in fn/hh.py for argument names.
```
