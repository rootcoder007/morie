...
`print(result)` render. See `moirais.fn.describe('tssrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssrn import *
import numpy as np
# See the function signature in fn/tssrn.py for argument names.
```
