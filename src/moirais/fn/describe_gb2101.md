# describe('gb2101') — gibbons_asymp_order_normal
...
`print(result)` render. See `moirais.fn.describe('gb2101')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2101 import *
import numpy as np
# See the function signature in fn/gb2101.py for argument names.
```
