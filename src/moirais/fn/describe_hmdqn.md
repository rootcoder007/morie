...
`print(result)` render. See `moirais.fn.describe('hmdqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdqn import *
import numpy as np
# See the function signature in fn/hmdqn.py for argument names.
```
