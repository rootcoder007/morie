# describe('aitzlk') — compositional_zero_lrda
...
`print(result)` render. See `moirais.fn.describe('aitzlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitzlk import *
import numpy as np
# See the function signature in fn/aitzlk.py for argument names.
```
