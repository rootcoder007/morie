...
`print(result)` render. See `moirais.fn.describe('cochr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cochr import *
import numpy as np
# See the function signature in fn/cochr.py for argument names.
```
