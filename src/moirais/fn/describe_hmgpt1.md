...
`print(result)` render. See `moirais.fn.describe('hmgpt1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgpt1 import *
import numpy as np
# See the function signature in fn/hmgpt1.py for argument names.
```
