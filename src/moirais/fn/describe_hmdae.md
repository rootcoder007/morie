# describe('hmdae') — geron_denoising_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmdae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdae import *
import numpy as np
# See the function signature in fn/hmdae.py for argument names.
```
