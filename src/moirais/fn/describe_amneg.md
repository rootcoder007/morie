# describe('amneg') — am_negative_weights
...
`print(result)` render. See `moirais.fn.describe('amneg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amneg import *
import numpy as np
# See the function signature in fn/amneg.py for argument names.
```
