...
__all__ = ["wilcox_chapter_7_unnumbered_362"]


def wilcox_chapter_7_unnumbered_362(x):
    """
    Resampling expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u362')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u362: Resampling expression (auto-extracted; see ref)."
