# describe('cbamod') — cbam_attention
...
`print(result)` render. See `moirais.fn.describe('cbamod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cbamod import *
import numpy as np
# See the function signature in fn/cbamod.py for argument names.
```
