...
`print(result)` render. See `moirais.fn.describe('pcchy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcchy import *
import numpy as np
# See the function signature in fn/pcchy.py for argument names.
```
