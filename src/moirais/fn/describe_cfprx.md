...
`print(result)` render. See `moirais.fn.describe('cfprx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfprx import *
import numpy as np
# See the function signature in fn/cfprx.py for argument names.
```
