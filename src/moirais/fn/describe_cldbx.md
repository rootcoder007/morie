...
`print(result)` render. See `moirais.fn.describe('cldbx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cldbx import *
import numpy as np
# See the function signature in fn/cldbx.py for argument names.
```
