# describe('sir_v') — sir_vaccination
...
`print(result)` render. See `moirais.fn.describe('sir_v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sir_v import *
import numpy as np
# See the function signature in fn/sir_v.py for argument names.
```
