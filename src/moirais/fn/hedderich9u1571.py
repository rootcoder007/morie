...
__all__ = ["hedderich_chapter_9_unnumbered_1571"]


def hedderich_chapter_9_unnumbered_1571(x):
    """
    Bayesian expression (auto-extracted; see ref).

    Formula: [EQ] > while ( i < stop & done == FALSE ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1571')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1571: Bayesian expression (auto-extracted; see ref)."
