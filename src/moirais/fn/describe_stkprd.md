...
`print(result)` render. See `moirais.fn.describe('stkprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkprd import *
import numpy as np
# See the function signature in fn/stkprd.py for argument names.
```
