# describe('recid') — recidivism_rate
...
`print(result)` render. See `moirais.fn.describe('recid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.recid import *
import numpy as np
# See the function signature in fn/recid.py for argument names.
```
