# describe('crssp') — correspondence_analysis
...
`print(result)` render. See `moirais.fn.describe('crssp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crssp import *
import numpy as np
# See the function signature in fn/crssp.py for argument names.
```
