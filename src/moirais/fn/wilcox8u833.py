...
__all__ = ["wilcox_chapter_8_unnumbered_833"]


def wilcox_chapter_8_unnumbered_833(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u833')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u833: GeneralStatistics expression (auto-extracted; see ref)."
