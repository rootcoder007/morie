...
`print(result)` render. See `moirais.fn.describe('zxgws')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxgws import *
import numpy as np
# See the function signature in fn/zxgws.py for argument names.
```
