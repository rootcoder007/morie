# describe('msm026') — mvsml_linear_mixed_models_eq_5_5
...
`print(result)` render. See `moirais.fn.describe('msm026')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm026 import *
import numpy as np
# See the function signature in fn/msm026.py for argument names.
```
