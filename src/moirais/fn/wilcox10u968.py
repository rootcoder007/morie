...
__all__ = ["wilcox_chapter_10_unnumbered_968"]


def wilcox_chapter_10_unnumbered_968(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For Ψ 1, the linear contrast coefficients are c1 =c2 = 1, c3 =c4 = −1, and c5 =c6 = 0. For
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u968')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u968: GeneralStatistics expression (auto-extracted; see ref)."
