# describe('km063') — kamath_ch4_vera_forward
...
`print(result)` render. See `moirais.fn.describe('km063')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km063 import *
import numpy as np
# See the function signature in fn/km063.py for argument names.
```
