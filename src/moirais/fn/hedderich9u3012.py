...
__all__ = ["hedderich_chapter_9_unnumbered_3012"]


def hedderich_chapter_9_unnumbered_3012(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] DF =2 DF =3 DF =4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3012')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3012: ContingencyTables expression (auto-extracted; see ref)."
