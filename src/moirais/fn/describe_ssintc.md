# describe('ssintc') — interval_censored_survival
...
`print(result)` render. See `moirais.fn.describe('ssintc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssintc import *
import numpy as np
# See the function signature in fn/ssintc.py for argument names.
```
