...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_502"]


def guide_on_data_analysis_chapter_6_unnumbered_502(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: eval_f = eval_f,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u502')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u502: GeneralStatistics expression (auto-extracted; see ref)."
