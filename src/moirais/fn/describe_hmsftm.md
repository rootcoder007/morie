# describe('hmsftm') — geron_softmax_function
...
`print(result)` render. See `moirais.fn.describe('hmsftm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsftm import *
import numpy as np
# See the function signature in fn/hmsftm.py for argument names.
```
