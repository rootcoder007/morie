...
__all__ = ["hedderich_chapter_9_unnumbered_3090"]


def hedderich_chapter_9_unnumbered_3090(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: parameters:µx,µy,σx,σy). The cross-section parallel to the xy-plane is a circle for ϱ= 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3090')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3090: GeneralStatistics expression (auto-extracted; see ref)."
