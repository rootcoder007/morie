# describe('msm311') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm311')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm311 import *
import numpy as np
# See the function signature in fn/msm311.py for argument names.
```
