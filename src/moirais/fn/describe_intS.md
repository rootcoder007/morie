# describe('intS') — symbolic_integrate
...
`print(result)` render. See `moirais.fn.describe('intS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intS import *
import numpy as np
# See the function signature in fn/intS.py for argument names.
```
