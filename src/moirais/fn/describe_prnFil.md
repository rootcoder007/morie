# describe('prnFil') — prophet_changepoint
...
`print(result)` render. See `moirais.fn.describe('prnFil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prnFil import *
import numpy as np
# See the function signature in fn/prnFil.py for argument names.
```
