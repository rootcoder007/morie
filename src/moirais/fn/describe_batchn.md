...
`print(result)` render. See `moirais.fn.describe('batchn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.batchn import *
import numpy as np
# See the function signature in fn/batchn.py for argument names.
```
