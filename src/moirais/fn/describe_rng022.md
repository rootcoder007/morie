# describe('rng022') — rangayyan_ch3_correlation_coefficient
...
`print(result)` render. See `moirais.fn.describe('rng022')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng022 import *
import numpy as np
# See the function signature in fn/rng022.py for argument names.
```
