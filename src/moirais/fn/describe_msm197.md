# describe('msm197') — mvsml_ridge_lasso_elastic_eq_9_25
...
`print(result)` render. See `moirais.fn.describe('msm197')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm197 import *
import numpy as np
# See the function signature in fn/msm197.py for argument names.
```
