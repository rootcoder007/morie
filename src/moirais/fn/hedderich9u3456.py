...
__all__ = ["hedderich_chapter_9_unnumbered_3456"]


def hedderich_chapter_9_unnumbered_3456(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : πijk =π+j+πi+k⇒lognπijk =µ+λX
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3456')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3456: GeneralStatistics expression (auto-extracted; see ref)."
