...
`print(result)` render. See `moirais.fn.describe('cossim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cossim import *
import numpy as np
# See the function signature in fn/cossim.py for argument names.
```
