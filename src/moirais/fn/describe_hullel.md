...
`print(result)` render. See `moirais.fn.describe('hullel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hullel import *
import numpy as np
# See the function signature in fn/hullel.py for argument names.
```
