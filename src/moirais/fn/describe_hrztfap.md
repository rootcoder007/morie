# describe('hrztfap') — horowitz_T_F_asymp_props
...
`print(result)` render. See `moirais.fn.describe('hrztfap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrztfap import *
import numpy as np
# See the function signature in fn/hrztfap.py for argument names.
```
