...
`print(result)` render. See `moirais.fn.describe('sppre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppre import *
import numpy as np
# See the function signature in fn/sppre.py for argument names.
```
