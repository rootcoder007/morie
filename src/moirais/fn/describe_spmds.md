# describe('spmds') — schabenberger_multidim_scaling
...
`print(result)` render. See `moirais.fn.describe('spmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmds import *
import numpy as np
# See the function signature in fn/spmds.py for argument names.
```
