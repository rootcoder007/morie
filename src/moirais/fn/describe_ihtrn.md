# describe('ihtrn') — indigenous_health_trend
...
`print(result)` render. See `moirais.fn.describe('ihtrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ihtrn import *
import numpy as np
# See the function signature in fn/ihtrn.py for argument names.
```
