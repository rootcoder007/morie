...
`print(result)` render. See `moirais.fn.describe('spccir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spccir import *
import numpy as np
# See the function signature in fn/spccir.py for argument names.
```
