...
__all__ = ["wilcox_chapter_4_unnumbered_122"]


def wilcox_chapter_4_unnumbered_122(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u122')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u122: GeneralStatistics expression (auto-extracted; see ref)."
