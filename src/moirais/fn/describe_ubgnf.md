...
`print(result)` render. See `moirais.fn.describe('ubgnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubgnf import *
import numpy as np
# See the function signature in fn/ubgnf.py for argument names.
```
