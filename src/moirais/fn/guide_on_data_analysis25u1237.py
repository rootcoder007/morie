...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1237"]


def guide_on_data_analysis_chapter_25_unnumbered_1237(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝛽1,𝑝 = 0, 𝛽 2,𝑝 = 𝑝(𝑝 + 2).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1237')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1237: GeneralStatistics expression (auto-extracted; see ref)."
