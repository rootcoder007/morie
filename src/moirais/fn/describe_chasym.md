# describe('chasym') — check_asymptote_msm
...
`print(result)` render. See `moirais.fn.describe('chasym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chasym import *
import numpy as np
# See the function signature in fn/chasym.py for argument names.
```
