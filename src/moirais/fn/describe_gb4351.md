# describe('gb4351') — gibbons_ks_chi2_approx
...
`print(result)` render. See `moirais.fn.describe('gb4351')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb4351 import *
import numpy as np
# See the function signature in fn/gb4351.py for argument names.
```
