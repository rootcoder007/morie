# describe('rgswtden') — rangayyan_swt_denoise
...
`print(result)` render. See `moirais.fn.describe('rgswtden')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgswtden import *
import numpy as np
# See the function signature in fn/rgswtden.py for argument names.
```
