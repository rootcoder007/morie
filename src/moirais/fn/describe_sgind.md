# describe('sgind') — indicator_kriging
...
`print(result)` render. See `moirais.fn.describe('sgind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgind import *
import numpy as np
# See the function signature in fn/sgind.py for argument names.
```
