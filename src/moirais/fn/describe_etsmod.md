...
`print(result)` render. See `moirais.fn.describe('etsmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.etsmod import *
import numpy as np
# See the function signature in fn/etsmod.py for argument names.
```
