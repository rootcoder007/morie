...
`print(result)` render. See `moirais.fn.describe('ghclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghclr import *
import numpy as np
# See the function signature in fn/ghclr.py for argument names.
```
