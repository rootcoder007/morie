...
__all__ = ["wilcox_chapter_5_unnumbered_424"]


def wilcox_chapter_5_unnumbered_424(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: If there are four predictors and the sample size is 20, then p = 4, n = 20, ν 1 = 4,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u424')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u424: PowerAndDesign expression (auto-extracted; see ref)."
