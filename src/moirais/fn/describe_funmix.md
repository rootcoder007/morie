# describe('funmix') — functional_mixture
...
`print(result)` render. See `moirais.fn.describe('funmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funmix import *
import numpy as np
# See the function signature in fn/funmix.py for argument names.
```
