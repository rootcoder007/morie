...
`print(result)` render. See `moirais.fn.describe('bwkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bwkrn import *
import numpy as np
# See the function signature in fn/bwkrn.py for argument names.
```
