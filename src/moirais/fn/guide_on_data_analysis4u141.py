...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_141"]


def guide_on_data_analysis_chapter_4_unnumbered_141(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1 − 𝛼 = 𝑃 (−𝑡𝛼/2;𝑛−1≤ ̄ 𝑦 − 𝜇
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u141')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u141: GeneralStatistics expression (auto-extracted; see ref)."
