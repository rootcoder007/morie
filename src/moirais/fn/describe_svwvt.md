...
`print(result)` render. See `moirais.fn.describe('svwvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwvt import *
import numpy as np
# See the function signature in fn/svwvt.py for argument names.
```
