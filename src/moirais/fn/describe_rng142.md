# describe('rng142') — rangayyan_ch3_cross_correlation_vector
...
`print(result)` render. See `moirais.fn.describe('rng142')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng142 import *
import numpy as np
# See the function signature in fn/rng142.py for argument names.
```
