...
`print(result)` render. See `moirais.fn.describe('cfabi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfabi import *
import numpy as np
# See the function signature in fn/cfabi.py for argument names.
```
