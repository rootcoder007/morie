# describe('grpio') — geron_perceiver_io
...
`print(result)` render. See `moirais.fn.describe('grpio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpio import *
import numpy as np
# See the function signature in fn/grpio.py for argument names.
```
