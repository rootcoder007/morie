...
`print(result)` render. See `moirais.fn.describe('brop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brop import *
import numpy as np
# See the function signature in fn/brop.py for argument names.
```
