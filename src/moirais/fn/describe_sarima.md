# describe('sarima') — seasonal_arima
...
`print(result)` render. See `moirais.fn.describe('sarima')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarima import *
import numpy as np
# See the function signature in fn/sarima.py for argument names.
```
