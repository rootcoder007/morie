# describe('kmcrb') — kamath_cross_encoder_rerank
...
`print(result)` render. See `moirais.fn.describe('kmcrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcrb import *
import numpy as np
# See the function signature in fn/kmcrb.py for argument names.
```
