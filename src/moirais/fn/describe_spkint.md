# describe('spkint') — spike_information
...
`print(result)` render. See `moirais.fn.describe('spkint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkint import *
import numpy as np
# See the function signature in fn/spkint.py for argument names.
```
