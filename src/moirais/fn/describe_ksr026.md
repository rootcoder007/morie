# describe('ksr026') — kosorok_ch2_empirical_distribution_function
...
`print(result)` render. See `moirais.fn.describe('ksr026')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr026 import *
import numpy as np
# See the function signature in fn/ksr026.py for argument names.
```
