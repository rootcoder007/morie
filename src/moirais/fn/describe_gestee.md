# describe('gestee') — gauss_subgaussian_estimator
...
`print(result)` render. See `moirais.fn.describe('gestee')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gestee import *
import numpy as np
# See the function signature in fn/gestee.py for argument names.
```
