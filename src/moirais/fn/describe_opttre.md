# describe('opttre') — optimal_tree_regime
...
`print(result)` render. See `moirais.fn.describe('opttre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opttre import *
import numpy as np
# See the function signature in fn/opttre.py for argument names.
```
