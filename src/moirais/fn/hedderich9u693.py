...
__all__ = ["hedderich_chapter_9_unnumbered_693"]


def hedderich_chapter_9_unnumbered_693(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 2|λ) = λ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u693')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u693: CountModels expression (auto-extracted; see ref)."
