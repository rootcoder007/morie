# describe('spdmt') — sparse_diagonal
...
`print(result)` render. See `moirais.fn.describe('spdmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spdmt import *
import numpy as np
# See the function signature in fn/spdmt.py for argument names.
```
