...
__all__ = ["hedderich_chapter_9_unnumbered_3131"]


def hedderich_chapter_9_unnumbered_3131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 28 + 23−6 = 0.8733
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3131')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3131: GeneralStatistics expression (auto-extracted; see ref)."
