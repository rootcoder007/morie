...
__all__ = ["wilcox_chapter_14_unnumbered_754"]


def wilcox_chapter_14_unnumbered_754(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :F1(x) = F2(x) = · · · =FJ (x), (9.12)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u754')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u754: GeneralStatistics expression (auto-extracted; see ref)."
