# describe('rgpzp') — rangayyan_pole_zero_plot
...
`print(result)` render. See `moirais.fn.describe('rgpzp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpzp import *
import numpy as np
# See the function signature in fn/rgpzp.py for argument names.
```
