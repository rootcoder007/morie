# describe('ammat') — am_matrix_setup
...
`print(result)` render. See `moirais.fn.describe('ammat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ammat import *
import numpy as np
# See the function signature in fn/ammat.py for argument names.
```
