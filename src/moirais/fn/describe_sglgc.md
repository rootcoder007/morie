# describe('sglgc') — lag_class_binning
...
`print(result)` render. See `moirais.fn.describe('sglgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglgc import *
import numpy as np
# See the function signature in fn/sglgc.py for argument names.
```
