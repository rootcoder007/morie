...
__all__ = ["wilcox_chapter_13_unnumbered_1198"]


def wilcox_chapter_13_unnumbered_1198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: olshc4.inter(x,y, alpha = 0.05, xout = FALSE, outfun = out, ...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1198')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1198: GeneralStatistics expression (auto-extracted; see ref)."
