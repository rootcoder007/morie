# describe('bnstvr') — bound_treatment_variation
...
`print(result)` render. See `moirais.fn.describe('bnstvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnstvr import *
import numpy as np
# See the function signature in fn/bnstvr.py for argument names.
```
