# describe('fclust') — functional_clustering
...
`print(result)` render. See `moirais.fn.describe('fclust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fclust import *
import numpy as np
# See the function signature in fn/fclust.py for argument names.
```
