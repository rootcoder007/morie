...
__all__ = ["hedderich_chapter_9_unnumbered_3152"]


def hedderich_chapter_9_unnumbered_3152(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] r = 2 sin(0.5236·0.840) = 2 sin 0.4398 = 2·0.426 = 0.852 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3152')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3152: GeneralStatistics expression (auto-extracted; see ref)."
