...
__all__ = ["hedderich_chapter_9_unnumbered_2303"]


def hedderich_chapter_9_unnumbered_2303(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f(a) Pr(min(P[i])<=0.05)=0.401
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2303')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2303: GeneralStatistics expression (auto-extracted; see ref)."
