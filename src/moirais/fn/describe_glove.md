...
`print(result)` render. See `moirais.fn.describe('glove')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glove import *
import numpy as np
# See the function signature in fn/glove.py for argument names.
```
