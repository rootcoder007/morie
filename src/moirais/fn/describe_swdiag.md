...
`print(result)` render. See `moirais.fn.describe('swdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swdiag import *
import numpy as np
# See the function signature in fn/swdiag.py for argument names.
```
