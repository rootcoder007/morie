# describe('insptr') — inspection_trend
...
`print(result)` render. See `moirais.fn.describe('insptr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.insptr import *
import numpy as np
# See the function signature in fn/insptr.py for argument names.
```
