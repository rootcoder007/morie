...
__all__ = ["hedderich_chapter_9_unnumbered_1536"]


def hedderich_chapter_9_unnumbered_1536(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] m] ≈¯x±tn−1;(1−α/(2m)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1536')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1536: GeneralStatistics expression (auto-extracted; see ref)."
