# describe('hmspae') — geron_sparse_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmspae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmspae import *
import numpy as np
# See the function signature in fn/hmspae.py for argument names.
```
