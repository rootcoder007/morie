...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1101"]


def guide_on_data_analysis_chapter_24_unnumbered_1101(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐻0 ∶ 𝜇 + 𝜏1 = 𝜇 + 𝜏2 = ⋯ = 𝜇 + 𝜏𝑎,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1101')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1101: GeneralStatistics expression (auto-extracted; see ref)."
