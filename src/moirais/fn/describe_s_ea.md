...
`print(result)` render. See `moirais.fn.describe('s_ea')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.s_ea import *
import numpy as np
# See the function signature in fn/s_ea.py for argument names.
```
