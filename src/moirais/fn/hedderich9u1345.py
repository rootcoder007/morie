...
__all__ = ["hedderich_chapter_9_unnumbered_1345"]


def hedderich_chapter_9_unnumbered_1345(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] [φ(z1−α/2)·z1−β/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1345')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1345: PowerAndDesign expression (auto-extracted; see ref)."
