# describe('rng146') — rangayyan_ch3_optimal_wiener_filter
...
`print(result)` render. See `moirais.fn.describe('rng146')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng146 import *
import numpy as np
# See the function signature in fn/rng146.py for argument names.
```
