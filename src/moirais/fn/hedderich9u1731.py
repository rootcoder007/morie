...
__all__ = ["hedderich_chapter_9_unnumbered_1731"]


def hedderich_chapter_9_unnumbered_1731(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (4)P (X = 0|λ=1.8)=1.80e−1.8/0!=1/e1.8/1=1/6.05/1=0.1653;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1731')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1731: GeneralStatistics expression (auto-extracted; see ref)."
