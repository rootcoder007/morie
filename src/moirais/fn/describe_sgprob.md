...
`print(result)` render. See `moirais.fn.describe('sgprob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgprob import *
import numpy as np
# See the function signature in fn/sgprob.py for argument names.
```
