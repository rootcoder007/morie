...
__all__ = ["hedderich_chapter_9_unnumbered_1859"]


def hedderich_chapter_9_unnumbered_1859(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Forn = 100, s2 = 5 andσ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1859')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1859: GeneralStatistics expression (auto-extracted; see ref)."
