...
`print(result)` render. See `moirais.fn.describe('absbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.absbs import *
import numpy as np
# See the function signature in fn/absbs.py for argument names.
```
