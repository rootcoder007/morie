...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_15"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_2_unnumbered_15(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > y=2+2*x1+0.3*x2+rnorm (100)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit2u15')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit2u15: GeneralStatistics expression (auto-extracted; see ref)."
