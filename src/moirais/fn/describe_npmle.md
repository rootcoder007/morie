...
`print(result)` render. See `moirais.fn.describe('npmle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npmle import *
import numpy as np
# See the function signature in fn/npmle.py for argument names.
```
