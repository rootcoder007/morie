# describe('rgbbnorm') — rangayyan_ecg_bbb_normal
...
`print(result)` render. See `moirais.fn.describe('rgbbnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbbnorm import *
import numpy as np
# See the function signature in fn/rgbbnorm.py for argument names.
```
