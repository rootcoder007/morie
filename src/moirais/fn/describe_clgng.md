# describe('clgng') — clgng

## WHAT IT DOES

Growing neural gas spatial
...
`print(result)` render. See `moirais.fn.describe('clgng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clgng import *
import numpy as np
# See the function signature in fn/clgng.py for argument names.
```
