# describe('opwoa') — opwoa

## WHAT IT DOES

Whale optimization spatial
...
`print(result)` render. See `moirais.fn.describe('opwoa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opwoa import *
import numpy as np
# See the function signature in fn/opwoa.py for argument names.
```
