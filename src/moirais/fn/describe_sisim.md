...
`print(result)` render. See `moirais.fn.describe('sisim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sisim import *
import numpy as np
# See the function signature in fn/sisim.py for argument names.
```
