# describe('gb_frd2') — gibbons_friedman_ties
...
`print(result)` render. See `moirais.fn.describe('gb_frd2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_frd2 import *
import numpy as np
# See the function signature in fn/gb_frd2.py for argument names.
```
