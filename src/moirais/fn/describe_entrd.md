...
`print(result)` render. See `moirais.fn.describe('entrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entrd import *
import numpy as np
# See the function signature in fn/entrd.py for argument names.
```
