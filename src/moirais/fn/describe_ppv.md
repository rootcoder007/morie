...
`print(result)` render. See `moirais.fn.describe('ppv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppv import *
import numpy as np
# See the function signature in fn/ppv.py for argument names.
```
