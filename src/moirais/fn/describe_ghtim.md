...
`print(result)` render. See `moirais.fn.describe('ghtim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghtim import *
import numpy as np
# See the function signature in fn/ghtim.py for argument names.
```
