# describe('ca8e5') — ca_chapter_8_equation_5
...
```python
from moirais.fn.ca8e5 import ca_chapter_8_equation_5
import numpy as np
result = ca_chapter_8_equation_5(np.random.default_rng(42).normal(0, 1, 100))
