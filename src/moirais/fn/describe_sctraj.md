# describe('sctraj') — scrnaseq_trajectory
...
`print(result)` render. See `moirais.fn.describe('sctraj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sctraj import *
import numpy as np
# See the function signature in fn/sctraj.py for argument names.
```
