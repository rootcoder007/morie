# describe('ari') — automated_readability

## WHAT IT DOES

Automated Readability Index. 'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('ari')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ari import *
import numpy as np
# See the function signature in fn/ari.py for argument names.
```
