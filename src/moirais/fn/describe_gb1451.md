# describe('gb1451') — gibbons_mcnemar
...
`print(result)` render. See `moirais.fn.describe('gb1451')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1451 import *
import numpy as np
# See the function signature in fn/gb1451.py for argument names.
```
