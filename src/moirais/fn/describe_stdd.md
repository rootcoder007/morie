...
`print(result)` render. See `moirais.fn.describe('stdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stdd import *
import numpy as np
# See the function signature in fn/stdd.py for argument names.
```
