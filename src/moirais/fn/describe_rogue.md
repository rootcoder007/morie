# describe('rogue') — absorption_features
...
`print(result)` render. See `moirais.fn.describe('rogue')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rogue import *
import numpy as np
# See the function signature in fn/rogue.py for argument names.
```
