...
`print(result)` render. See `moirais.fn.describe('krgsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgsm import *
import numpy as np
# See the function signature in fn/krgsm.py for argument names.
```
