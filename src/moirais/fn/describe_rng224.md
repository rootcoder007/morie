# describe('rng224') — rangayyan_ch4_basic_signal_g
...
`print(result)` render. See `moirais.fn.describe('rng224')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng224 import *
import numpy as np
# See the function signature in fn/rng224.py for argument names.
```
