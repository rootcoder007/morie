# describe('cityb') — city_block_distance
...
`print(result)` render. See `moirais.fn.describe('cityb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cityb import *
import numpy as np
# See the function signature in fn/cityb.py for argument names.
```
