...
`print(result)` render. See `moirais.fn.describe('sawad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawad import *
import numpy as np
# See the function signature in fn/sawad.py for argument names.
```
