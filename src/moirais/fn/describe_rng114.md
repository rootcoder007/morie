# describe('rng114') — rangayyan_ch3_first_difference_magnitude
...
`print(result)` render. See `moirais.fn.describe('rng114')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng114 import *
import numpy as np
# See the function signature in fn/rng114.py for argument names.
```
