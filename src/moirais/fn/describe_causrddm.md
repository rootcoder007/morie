# describe('causrddm') — causal_rdd_manipulation
...
`print(result)` render. See `moirais.fn.describe('causrddm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrddm import *
import numpy as np
# See the function signature in fn/causrddm.py for argument names.
```
