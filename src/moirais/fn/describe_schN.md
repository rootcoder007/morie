...
`print(result)` render. See `moirais.fn.describe('schN')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.schN import *
import numpy as np
# See the function signature in fn/schN.py for argument names.
```
