...
__all__ = ["hedderich_chapter_9_unnumbered_329"]


def hedderich_chapter_9_unnumbered_329(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Qxy = ∑(x−¯x)(y−¯y)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u329')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u329: GeneralStatistics expression (auto-extracted; see ref)."
