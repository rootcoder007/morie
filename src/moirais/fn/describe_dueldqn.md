...
`print(result)` render. See `moirais.fn.describe('dueldqn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dueldqn import *
import numpy as np
# See the function signature in fn/dueldqn.py for argument names.
```
