# describe('hmsgdu') — geron_sgd_update
...
`print(result)` render. See `moirais.fn.describe('hmsgdu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmsgdu import *
import numpy as np
# See the function signature in fn/hmsgdu.py for argument names.
```
