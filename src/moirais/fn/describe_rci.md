...
`print(result)` render. See `moirais.fn.describe('rci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rci import *
import numpy as np
# See the function signature in fn/rci.py for argument names.
```
