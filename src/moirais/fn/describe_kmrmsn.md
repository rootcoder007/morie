# describe('kmrmsn') — kamath_rms_norm
...
`print(result)` render. See `moirais.fn.describe('kmrmsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrmsn import *
import numpy as np
# See the function signature in fn/kmrmsn.py for argument names.
```
