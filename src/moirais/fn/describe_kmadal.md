# describe('kmadal') — kamath_adalora_rank_allocation
...
`print(result)` render. See `moirais.fn.describe('kmadal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmadal import *
import numpy as np
# See the function signature in fn/kmadal.py for argument names.
```
