# describe('svclv') — coalition_value
...
`print(result)` render. See `moirais.fn.describe('svclv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svclv import *
import numpy as np
# See the function signature in fn/svclv.py for argument names.
```
