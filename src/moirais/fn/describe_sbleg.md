...
`print(result)` render. See `moirais.fn.describe('sbleg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbleg import *
import numpy as np
# See the function signature in fn/sbleg.py for argument names.
```
