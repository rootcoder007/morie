...
`print(result)` render. See `moirais.fn.describe('svwdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svwdm import *
import numpy as np
# See the function signature in fn/svwdm.py for argument names.
```
