# describe('grmnr') — geron_max_norm_regularization
...
`print(result)` render. See `moirais.fn.describe('grmnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmnr import *
import numpy as np
# See the function signature in fn/grmnr.py for argument names.
```
