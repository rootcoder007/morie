# describe('cndnt') — conditional_entropy
...
`print(result)` render. See `moirais.fn.describe('cndnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cndnt import *
import numpy as np
# See the function signature in fn/cndnt.py for argument names.
```
