...
`print(result)` render. See `moirais.fn.describe('tbsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbsph import *
import numpy as np
# See the function signature in fn/tbsph.py for argument names.
```
