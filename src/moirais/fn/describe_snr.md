...
`print(result)` render. See `moirais.fn.describe('snr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snr import *
import numpy as np
# See the function signature in fn/snr.py for argument names.
```
