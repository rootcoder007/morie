# describe('oprop') — otis_proportions
...
`print(result)` render. See `moirais.fn.describe('oprop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oprop import *
import numpy as np
# See the function signature in fn/oprop.py for argument names.
```
