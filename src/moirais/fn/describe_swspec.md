...
`print(result)` render. See `moirais.fn.describe('swspec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swspec import *
import numpy as np
# See the function signature in fn/swspec.py for argument names.
```
