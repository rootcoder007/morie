# describe('bnskmt') — bound_kernel_moment
...
`print(result)` render. See `moirais.fn.describe('bnskmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnskmt import *
import numpy as np
# See the function signature in fn/bnskmt.py for argument names.
```
