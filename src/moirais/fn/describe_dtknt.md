...
`print(result)` render. See `moirais.fn.describe('dtknt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtknt import *
import numpy as np
# See the function signature in fn/dtknt.py for argument names.
```
