...
__all__ = ["hedderich_chapter_9_unnumbered_3278"]


def hedderich_chapter_9_unnumbered_3278(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] j = (y−ˆyi̸=j) (ˆxj−xj) ( j = 1, . . . , p)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3278')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3278: GeneralStatistics expression (auto-extracted; see ref)."
