# describe('rng010') — rangayyan_ch3_sample_std
...
`print(result)` render. See `moirais.fn.describe('rng010')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng010 import *
import numpy as np
# See the function signature in fn/rng010.py for argument names.
```
