...
`print(result)` render. See `moirais.fn.describe('mish')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mish import *
import numpy as np
# See the function signature in fn/mish.py for argument names.
```
