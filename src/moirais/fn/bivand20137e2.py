...
def bivand2013_chapter_7_equation_2(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137e2')`` for the full guide.
    ...
    if n < 2:
        return hypothesis_test_result(
            ...
            extra_summary=[("n", n)],
            extra_payload={"n": n, "method": "GeneralStatistics equation extracted from bivand2013.", "p_value": float("nan")},
        )
    x_sorted = np.sort(x)
    if cdf is None:
    ...
    return hypothesis_test_result(
        ...
        extra_summary=[("n", n)],
        extra_payload={"n": n, "method": "GeneralStatistics equation extracted from bivand2013.", "p_value": float(p_value)},
    )
