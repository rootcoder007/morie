...
__all__ = ["hedderich_chapter_9_unnumbered_3228"]


def hedderich_chapter_9_unnumbered_3228(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] x1 = (a2−a1)/(b1−b2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3228')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3228: GeneralStatistics expression (auto-extracted; see ref)."
