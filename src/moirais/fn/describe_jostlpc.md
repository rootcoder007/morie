# describe('jostlpc') — joseph_stl_decomposition
...
`print(result)` render. See `moirais.fn.describe('jostlpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jostlpc import *
import numpy as np
# See the function signature in fn/jostlpc.py for argument names.
```
