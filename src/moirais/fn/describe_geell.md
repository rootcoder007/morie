...
`print(result)` render. See `moirais.fn.describe('geell')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geell import *
import numpy as np
# See the function signature in fn/geell.py for argument names.
```
