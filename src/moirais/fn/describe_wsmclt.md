...
`print(result)` render. See `moirais.fn.describe('wsmclt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmclt import *
import numpy as np
# See the function signature in fn/wsmclt.py for argument names.
```
