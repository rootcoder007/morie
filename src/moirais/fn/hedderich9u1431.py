...
__all__ = ["hedderich_chapter_9_unnumbered_1431"]


def hedderich_chapter_9_unnumbered_1431(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ˙zo−˙zu = 2z1−α/2·s ˙z = 2z1−α/2√n−3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1431')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1431: PowerAndDesign expression (auto-extracted; see ref)."
