...
`print(result)` render. See `moirais.fn.describe('cnnbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnnbs import *
import numpy as np
# See the function signature in fn/cnnbs.py for argument names.
```
