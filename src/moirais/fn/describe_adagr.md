...
`print(result)` render. See `moirais.fn.describe('adagr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adagr import *
import numpy as np
# See the function signature in fn/adagr.py for argument names.
```
