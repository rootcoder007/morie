...
`print(result)` render. See `moirais.fn.describe('nbspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbspc import *
import numpy as np
# See the function signature in fn/nbspc.py for argument names.
```
