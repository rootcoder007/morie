...
`print(result)` render. See `moirais.fn.describe('idwbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwbar import *
import numpy as np
# See the function signature in fn/idwbar.py for argument names.
```
