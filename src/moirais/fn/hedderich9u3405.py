...
__all__ = ["hedderich_chapter_9_unnumbered_3405"]


def hedderich_chapter_9_unnumbered_3405(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E[Y ] = λ= exp (β0 +β1·x1 +...+βp·xp)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3405')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3405: GeneralStatistics expression (auto-extracted; see ref)."
