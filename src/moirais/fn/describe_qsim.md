...
`print(result)` render. See `moirais.fn.describe('qsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qsim import *
import numpy as np
# See the function signature in fn/qsim.py for argument names.
```
