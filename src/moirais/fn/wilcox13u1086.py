...
__all__ = ["wilcox_chapter_13_unnumbered_1086"]


def wilcox_chapter_13_unnumbered_1086(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: tsreg(x,y, xout=FALSE, outfun=outpro, iter=10, varfun=pbvar, corfun=pbcor,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1086')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1086: GeneralStatistics expression (auto-extracted; see ref)."
