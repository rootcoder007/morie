...
`print(result)` render. See `moirais.fn.describe('tikto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tikto import *
import numpy as np
# See the function signature in fn/tikto.py for argument names.
```
