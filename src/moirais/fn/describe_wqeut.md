...
`print(result)` render. See `moirais.fn.describe('wqeut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqeut import *
import numpy as np
# See the function signature in fn/wqeut.py for argument names.
```
