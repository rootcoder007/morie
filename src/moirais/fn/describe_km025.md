# describe('km025') — kamath_ch2_rts_loss
...
`print(result)` render. See `moirais.fn.describe('km025')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km025 import *
import numpy as np
# See the function signature in fn/km025.py for argument names.
```
