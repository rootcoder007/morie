# describe('zsblk') — block_bootstrap
...
`print(result)` render. See `moirais.fn.describe('zsblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsblk import *
import numpy as np
# See the function signature in fn/zsblk.py for argument names.
```
