# describe('causdid2') — causal_did_2x2
...
`print(result)` render. See `moirais.fn.describe('causdid2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdid2 import *
import numpy as np
# See the function signature in fn/causdid2.py for argument names.
```
