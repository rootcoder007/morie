...
`print(result)` render. See `moirais.fn.describe('kmsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmsem import *
import numpy as np
# See the function signature in fn/kmsem.py for argument names.
```
