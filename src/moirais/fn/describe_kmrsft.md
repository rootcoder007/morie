# describe('kmrsft') — kamath_rejection_sampling_finetune
...
`print(result)` render. See `moirais.fn.describe('kmrsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmrsft import *
import numpy as np
# See the function signature in fn/kmrsft.py for argument names.
```
