...
`print(result)` render. See `moirais.fn.describe('sinst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sinst import *
import numpy as np
# See the function signature in fn/sinst.py for argument names.
```
