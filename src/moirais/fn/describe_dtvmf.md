...
`print(result)` render. See `moirais.fn.describe('dtvmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtvmf import *
import numpy as np
# See the function signature in fn/dtvmf.py for argument names.
```
