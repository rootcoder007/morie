# describe('irtprc'Knowing yourself is the beginning of all wisdom. — Aristotle's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('irtprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtprc import *
import numpy as np
# See the function signature in fn/irtprc.py for argument names.
```
