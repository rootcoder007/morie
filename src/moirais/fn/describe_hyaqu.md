...
`print(result)` render. See `moirais.fn.describe('hyaqu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyaqu import *
import numpy as np
# See the function signature in fn/hyaqu.py for argument names.
```
