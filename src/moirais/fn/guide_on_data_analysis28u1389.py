...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1389"]


def guide_on_data_analysis_chapter_28_unnumbered_1389(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: plot(df_local$t, df_local $Y, pch=16,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1389')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1389: GeneralStatistics expression (auto-extracted; see ref)."
