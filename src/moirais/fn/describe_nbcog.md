...
`print(result)` render. See `moirais.fn.describe('nbcog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcog import *
import numpy as np
# See the function signature in fn/nbcog.py for argument names.
```
