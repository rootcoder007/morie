...
`print(result)` render. See `moirais.fn.describe('sarlrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarlrt import *
import numpy as np
# See the function signature in fn/sarlrt.py for argument names.
```
