# describe('volrls') — vol_recursive_least_sq
...
`print(result)` render. See `moirais.fn.describe('volrls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrls import *
import numpy as np
# See the function signature in fn/volrls.py for argument names.
```
