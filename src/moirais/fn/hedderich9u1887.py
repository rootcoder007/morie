...
__all__ = ["hedderich_chapter_9_unnumbered_1887"]


def hedderich_chapter_9_unnumbered_1887(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (16·22−29)/90 = 4.83/1.89 = 2.56> 1.96 = z0.95.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1887')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1887: GeneralStatistics expression (auto-extracted; see ref)."
