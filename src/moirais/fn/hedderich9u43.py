...
__all__ = ["hedderich_chapter_9_unnumbered_43"]


def hedderich_chapter_9_unnumbered_43(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u43')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u43: PowerAndDesign expression (auto-extracted; see ref)."
