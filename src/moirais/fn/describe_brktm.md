# describe('brktm') — berkson_bias_test
...
`print(result)` render. See `moirais.fn.describe('brktm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brktm import *
import numpy as np
# See the function signature in fn/brktm.py for argument names.
```
