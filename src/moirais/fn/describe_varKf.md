...
`print(result)` render. See `moirais.fn.describe('varKf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varKf import *
import numpy as np
# See the function signature in fn/varKf.py for argument names.
```
