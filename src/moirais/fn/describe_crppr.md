# describe('crppr') — chinese_restaurant_process
...
`print(result)` render. See `moirais.fn.describe('crppr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crppr import *
import numpy as np
# See the function signature in fn/crppr.py for argument names.
```
