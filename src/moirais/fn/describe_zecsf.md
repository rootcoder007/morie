# describe('zecsf') — concentration_srf
...
`print(result)` render. See `moirais.fn.describe('zecsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zecsf import *
import numpy as np
# See the function signature in fn/zecsf.py for argument names.
```
