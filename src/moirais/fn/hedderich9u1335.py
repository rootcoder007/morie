...
__all__ = ["hedderich_chapter_9_unnumbered_1335"]


def hedderich_chapter_9_unnumbered_1335(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + − pbinom ( lower −1 , size =n , prob =p ) }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1335')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1335: GeneralStatistics expression (auto-extracted; see ref)."
