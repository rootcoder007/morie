...
__all__ = ["hedderich_chapter_9_unnumbered_1176"]


def hedderich_chapter_9_unnumbered_1176(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: ˆp1 = 140/200 = 0.7 and ˆp2 = 150/250 = 0.6 ; ˆp1−ˆp2 = 0.1 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1176')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1176: GeneralStatistics expression (auto-extracted; see ref)."
