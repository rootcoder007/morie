...
`print(result)` render. See `moirais.fn.describe('stanis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stanis import *
import numpy as np
# See the function signature in fn/stanis.py for argument names.
```
