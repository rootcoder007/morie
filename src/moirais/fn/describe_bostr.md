...
`print(result)` render. See `moirais.fn.describe('bostr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bostr import *
import numpy as np
# See the function signature in fn/bostr.py for argument names.
```
