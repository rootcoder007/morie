# describe('miestn') — mi_neural_estimator
...
`print(result)` render. See `moirais.fn.describe('miestn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miestn import *
import numpy as np
# See the function signature in fn/miestn.py for argument names.
```
