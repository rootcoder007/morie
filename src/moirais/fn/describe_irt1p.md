...
`print(result)` render. See `moirais.fn.describe('irt1p')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt1p import *
import numpy as np
# See the function signature in fn/irt1p.py for argument names.
```
