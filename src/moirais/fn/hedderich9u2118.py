...
__all__ = ["hedderich_chapter_9_unnumbered_2118"]


def hedderich_chapter_9_unnumbered_2118(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: R = 89 4 +6 +10+11 +13+14+15+16
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2118')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2118: GeneralStatistics expression (auto-extracted; see ref)."
