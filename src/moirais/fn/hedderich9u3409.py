...
__all__ = ["hedderich_chapter_9_unnumbered_3409"]


def hedderich_chapter_9_unnumbered_3409(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ∂β =λixi with xi = (1,x i1,...,x ip)′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3409')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3409: GeneralStatistics expression (auto-extracted; see ref)."
