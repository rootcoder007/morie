...
`print(result)` render. See `moirais.fn.describe('dksmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dksmt import *
import numpy as np
# See the function signature in fn/dksmt.py for argument names.
```
