# describe('sawdn') — sawdn

## WHAT IT DOES

Spatial weight distance band
...
`print(result)` render. See `moirais.fn.describe('sawdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawdn import *
import numpy as np
# See the function signature in fn/sawdn.py for argument names.
```
