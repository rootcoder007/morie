...
`print(result)` render. See `moirais.fn.describe('ldpcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldpcg import *
import numpy as np
# See the function signature in fn/ldpcg.py for argument names.
```
