# describe('snr2u') — snijders_bosker_r2_level2
...
`print(result)` render. See `moirais.fn.describe('snr2u')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snr2u import *
import numpy as np
# See the function signature in fn/snr2u.py for argument names.
```
