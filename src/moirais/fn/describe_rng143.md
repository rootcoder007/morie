# describe('rng143') — rangayyan_ch3_autocorrelation_matrix
...
`print(result)` render. See `moirais.fn.describe('rng143')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng143 import *
import numpy as np
# See the function signature in fn/rng143.py for argument names.
```
