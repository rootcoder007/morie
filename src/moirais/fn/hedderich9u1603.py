...
__all__ = ["hedderich_chapter_9_unnumbered_1603"]


def hedderich_chapter_9_unnumbered_1603(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 :π≤0.5 and HA :π >0.5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1603')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1603: GeneralStatistics expression (auto-extracted; see ref)."
