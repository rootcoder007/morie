# describe('jorec') — joseph_recursive_multistep
...
`print(result)` render. See `moirais.fn.describe('jorec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jorec import *
import numpy as np
# See the function signature in fn/jorec.py for argument names.
```
