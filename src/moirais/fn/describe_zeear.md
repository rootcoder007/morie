...
`print(result)` render. See `moirais.fn.describe('zeear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeear import *
import numpy as np
# See the function signature in fn/zeear.py for argument names.
```
