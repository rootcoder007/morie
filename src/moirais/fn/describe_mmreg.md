...
`print(result)` render. See `moirais.fn.describe('mmreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mmreg import *
import numpy as np
# See the function signature in fn/mmreg.py for argument names.
```
