...
`print(result)` render. See `moirais.fn.describe('unstgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.unstgr import *
import numpy as np
# See the function signature in fn/unstgr.py for argument names.
```
