...
`print(result)` render. See `moirais.fn.describe('hurst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hurst import *
import numpy as np
# See the function signature in fn/hurst.py for argument names.
```
