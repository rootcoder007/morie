...
`print(result)` render. See `moirais.fn.describe('stkrgv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stkrgv import *
import numpy as np
# See the function signature in fn/stkrgv.py for argument names.
```
