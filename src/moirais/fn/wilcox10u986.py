...
__all__ = ["wilcox_chapter_10_unnumbered_986"]


def wilcox_chapter_10_unnumbered_986(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u986')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u986: GeneralStatistics expression (auto-extracted; see ref)."
