...
def ca_chapter_9_unnumbered_328(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca9u328')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "CentralTendency expression involving 'differences' (auto-extracted; see reference for full context)."},
    )


def cheatsheet():
    return "ca9u328: CentralTendency expression involving 'differences' (auto-extracted; see reference for full context)."
