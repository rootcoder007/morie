...
`print(result)` render. See `moirais.fn.describe('saggt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saggt import *
import numpy as np
# See the function signature in fn/saggt.py for argument names.
```
