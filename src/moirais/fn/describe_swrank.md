...
`print(result)` render. See `moirais.fn.describe('swrank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swrank import *
import numpy as np
# See the function signature in fn/swrank.py for argument names.
```
