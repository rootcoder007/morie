# describe('fnorm') — feature_normalize
...
`print(result)` render. See `moirais.fn.describe('fnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fnorm import *
import numpy as np
# See the function signature in fn/fnorm.py for argument names.
```
