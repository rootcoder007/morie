# describe('diflrt') — dif_likelihood_ratio
...
`print(result)` render. See `moirais.fn.describe('diflrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diflrt import *
import numpy as np
# See the function signature in fn/diflrt.py for argument names.
```
