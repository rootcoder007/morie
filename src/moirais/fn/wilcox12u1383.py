...
__all__ = ["wilcox_chapter_12_unnumbered_1383"]


def wilcox_chapter_12_unnumbered_1383(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 8(1/10 + 1 /10) = 6 .325ν = 50 − 5 = 45, reject. (b) T = |20 −
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1383')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1383: GeneralStatistics expression (auto-extracted; see ref)."
