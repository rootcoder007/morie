# describe('pacor') — predictive_ability_pearson
...
`print(result)` render. See `moirais.fn.describe('pacor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pacor import *
import numpy as np
# See the function signature in fn/pacor.py for argument names.
```
