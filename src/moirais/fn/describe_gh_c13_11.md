# describe('gh_c13_11') — ghosal_ntr_bvm
...
`print(result)` render. See `moirais.fn.describe('gh_c13_11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c13_11 import *
import numpy as np
# See the function signature in fn/gh_c13_11.py for argument names.
```
