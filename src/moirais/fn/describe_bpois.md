# describe('bpois') — bayesian_poisson
...
`print(result)` render. See `moirais.fn.describe('bpois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpois import *
import numpy as np
# See the function signature in fn/bpois.py for argument names.
```
