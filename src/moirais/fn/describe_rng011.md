# describe('rng011') — rangayyan_ch3_shannon_entropy_discrete
...
`print(result)` render. See `moirais.fn.describe('rng011')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng011 import *
import numpy as np
# See the function signature in fn/rng011.py for argument names.
```
