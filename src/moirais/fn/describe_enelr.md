...
`print(result)` render. See `moirais.fn.describe('enelr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enelr import *
import numpy as np
# See the function signature in fn/enelr.py for argument names.
```
