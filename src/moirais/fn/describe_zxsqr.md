# describe('zxsqr') — spatial_quantile
...
`print(result)` render. See `moirais.fn.describe('zxsqr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsqr import *
import numpy as np
# See the function signature in fn/zxsqr.py for argument names.
```
