# describe('cnffvw') — cinelli_hazlett_robust
...
`print(result)` render. See `moirais.fn.describe('cnffvw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnffvw import *
import numpy as np
# See the function signature in fn/cnffvw.py for argument names.
```
