...
`print(result)` render. See `moirais.fn.describe('saclrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saclrt import *
import numpy as np
# See the function signature in fn/saclrt.py for argument names.
```
