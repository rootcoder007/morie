# describe('hmmdc') — geron_mode_collapse
...
`print(result)` render. See `moirais.fn.describe('hmmdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmdc import *
import numpy as np
# See the function signature in fn/hmmdc.py for argument names.
```
