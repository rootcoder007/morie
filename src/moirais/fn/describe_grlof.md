# describe('grlof') — geron_local_outlier_factor
...
`print(result)` render. See `moirais.fn.describe('grlof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlof import *
import numpy as np
# See the function signature in fn/grlof.py for argument names.
```
