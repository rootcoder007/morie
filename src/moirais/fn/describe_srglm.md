...
`print(result)` render. See `moirais.fn.describe('srglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srglm import *
import numpy as np
# See the function signature in fn/srglm.py for argument names.
```
