...
__all__ = ["hedderich_chapter_9_unnumbered_2137"]


def hedderich_chapter_9_unnumbered_2137(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 −83.5 = 16.5 U2 = 8·8 + 8(8 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2137')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2137: GeneralStatistics expression (auto-extracted; see ref)."
