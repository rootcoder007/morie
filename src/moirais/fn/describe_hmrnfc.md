# describe('hmrnfc') — geron_reinforce
...
`print(result)` render. See `moirais.fn.describe('hmrnfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrnfc import *
import numpy as np
# See the function signature in fn/hmrnfc.py for argument names.
```
