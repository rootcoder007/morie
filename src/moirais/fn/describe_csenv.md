...
`print(result)` render. See `moirais.fn.describe('csenv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csenv import *
import numpy as np
# See the function signature in fn/csenv.py for argument names.
```
