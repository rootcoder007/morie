...
`print(result)` render. See `moirais.fn.describe('flowmin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flowmin import *
import numpy as np
# See the function signature in fn/flowmin.py for argument names.
```
