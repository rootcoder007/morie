# describe('npbsr') — np_bayes_survival
...
`print(result)` render. See `moirais.fn.describe('npbsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npbsr import *
import numpy as np
# See the function signature in fn/npbsr.py for argument names.
```
