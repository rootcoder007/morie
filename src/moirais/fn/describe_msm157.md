# describe('msm157') — mvsml_categorical_count_eq_8_10
...
`print(result)` render. See `moirais.fn.describe('msm157')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm157 import *
import numpy as np
# See the function signature in fn/msm157.py for argument names.
```
