# describe('hmcrg') — hierarchical_model
...
`print(result)` render. See `moirais.fn.describe('hmcrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcrg import *
import numpy as np
# See the function signature in fn/hmcrg.py for argument names.
```
