# describe('evtsthr') — evt_threshold_select_lvar
...
`print(result)` render. See `moirais.fn.describe('evtsthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtsthr import *
import numpy as np
# See the function signature in fn/evtsthr.py for argument names.
```
