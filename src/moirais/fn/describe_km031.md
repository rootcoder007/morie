# describe('km031') — kamath_ch2_sop_loss
...
`print(result)` render. See `moirais.fn.describe('km031')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km031 import *
import numpy as np
# See the function signature in fn/km031.py for argument names.
```
