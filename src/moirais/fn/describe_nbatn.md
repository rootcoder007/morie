...
`print(result)` render. See `moirais.fn.describe('nbatn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbatn import *
import numpy as np
# See the function signature in fn/nbatn.py for argument names.
```
