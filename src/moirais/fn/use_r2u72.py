...
__all__ = ["use_r_chapter_2_unnumbered_72"]


def use_r_chapter_2_unnumbered_72(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: that is λ(x)= λ> 0, ∀x ∈ A, and that events appear independently of each
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u72')`` for the full guide.
...
def cheatsheet():
    return "use_r2u72: GeneralStatistics expression (auto-extracted; see ref)."
