# describe('balan') — balanced_accuracy
...
`print(result)` render. See `moirais.fn.describe('balan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.balan import *
import numpy as np
# See the function signature in fn/balan.py for argument names.
```
