...
`print(result)` render. See `moirais.fn.describe('wqnh3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqnh3 import *
import numpy as np
# See the function signature in fn/wqnh3.py for argument names.
```
