# describe('km143') — kamath_ch9_fom_loss
...
`print(result)` render. See `moirais.fn.describe('km143')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km143 import *
import numpy as np
# See the function signature in fn/km143.py for argument names.
```
