...
`print(result)` render. See `moirais.fn.describe('quadr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.quadr import *
import numpy as np
# See the function signature in fn/quadr.py for argument names.
```
