...
`print(result)` render. See `moirais.fn.describe('cpads')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cpads import *
import numpy as np
# See the function signature in fn/cpads.py for argument names.
```
