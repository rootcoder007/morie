# describe('alftrm') — alphafold_triangle_mult
...
`print(result)` render. See `moirais.fn.describe('alftrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alftrm import *
import numpy as np
# See the function signature in fn/alftrm.py for argument names.
```
