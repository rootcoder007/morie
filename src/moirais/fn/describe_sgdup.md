...
`print(result)` render. See `moirais.fn.describe('sgdup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdup import *
import numpy as np
# See the function signature in fn/sgdup.py for argument names.
```
