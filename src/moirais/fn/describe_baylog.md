# describe('baylog') — bayes_logistic
...
`print(result)` render. See `moirais.fn.describe('baylog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baylog import *
import numpy as np
# See the function signature in fn/baylog.py for argument names.
```
