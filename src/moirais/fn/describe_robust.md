# describe('robust') — eval_robustness
...
`print(result)` render. See `moirais.fn.describe('robust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robust import *
import numpy as np
# See the function signature in fn/robust.py for argument names.
```
