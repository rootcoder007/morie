...
__all__ = ["hedderich_chapter_9_unnumbered_108"]


def hedderich_chapter_9_unnumbered_108(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Fig. 2.7: Quadratic functionsy =f (x) = 1−2x + 3x2 andy =g(x) = 4 + 5x−3x2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u108')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u108: GeneralStatistics expression (auto-extracted; see ref)."
