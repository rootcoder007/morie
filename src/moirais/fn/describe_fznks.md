# describe('fznks') — fauzi_naive_kernel_ks
...
`print(result)` render. See `moirais.fn.describe('fznks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fznks import *
import numpy as np
# See the function signature in fn/fznks.py for argument names.
```
