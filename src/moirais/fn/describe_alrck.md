# describe('alrck') — alammar_recall_at_k
...
`print(result)` render. See `moirais.fn.describe('alrck')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alrck import *
import numpy as np
# See the function signature in fn/alrck.py for argument names.
```
