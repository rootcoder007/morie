...
__all__ = ["hedderich_chapter_9_unnumbered_1919"]


def hedderich_chapter_9_unnumbered_1919(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] λ−√λ0) +z1−α) (7.74)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1919')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1919: PowerAndDesign expression (auto-extracted; see ref)."
