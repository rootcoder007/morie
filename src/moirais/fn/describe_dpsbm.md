# describe('dpsbm') — dp_stochastic_block
...
`print(result)` render. See `moirais.fn.describe('dpsbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpsbm import *
import numpy as np
# See the function signature in fn/dpsbm.py for argument names.
```
