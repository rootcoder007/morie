...
__all__ = ["wilcox_chapter_10_unnumbered_1015"]


def wilcox_chapter_10_unnumbered_1015(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: rmmcppb(x,y=NA,alpha=0.05,con=0,est=onestep,plotit=TRUE,dif=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1015')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1015: PowerAndDesign expression (auto-extracted; see ref)."
