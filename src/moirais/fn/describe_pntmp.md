# describe('pntmp') — pan_tompkins_qrs
...
`print(result)` render. See `moirais.fn.describe('pntmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pntmp import *
import numpy as np
# See the function signature in fn/pntmp.py for argument names.
```
