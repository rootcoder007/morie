# describe('eaiprl') — aipw_efficient_influence
...
`print(result)` render. See `moirais.fn.describe('eaiprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eaiprl import *
import numpy as np
# See the function signature in fn/eaiprl.py for argument names.
```
