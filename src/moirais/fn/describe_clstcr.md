# describe('clstcr') — cluster_causal_inference
...
`print(result)` render. See `moirais.fn.describe('clstcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clstcr import *
import numpy as np
# See the function signature in fn/clstcr.py for argument names.
```
