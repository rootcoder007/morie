...
`print(result)` render. See `moirais.fn.describe('wqgwi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqgwi import *
import numpy as np
# See the function signature in fn/wqgwi.py for argument names.
```
