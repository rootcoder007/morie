# describe('johbu') — joseph_bottom_up_reconciliation
...
`print(result)` render. See `moirais.fn.describe('johbu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johbu import *
import numpy as np
# See the function signature in fn/johbu.py for argument names.
```
