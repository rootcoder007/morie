...
__all__ = ["hedderich_chapter_9_unnumbered_503"]


def hedderich_chapter_9_unnumbered_503(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: J′=w·Sensitivity + (1−w)·Specificity with 0<w< 1 (weightw) (4.50)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u503')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u503: GeneralStatistics expression (auto-extracted; see ref)."
