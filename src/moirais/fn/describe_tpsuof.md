# describe('tpsuof') — tps_use_of_force
...
`print(result)` render. See `moirais.fn.describe('tpsuof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsuof import *
import numpy as np
# See the function signature in fn/tpsuof.py for argument names.
```
