# describe('ident') — identifiability_conditions
...
`print(result)` render. See `moirais.fn.describe('ident')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ident import *
import numpy as np
# See the function signature in fn/ident.py for argument names.
```
