...
`print(result)` render. See `moirais.fn.describe('geary')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geary import *
import numpy as np
# See the function signature in fn/geary.py for argument names.
```
