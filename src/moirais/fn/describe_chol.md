# describe('chol') — cholesky_decompose
...
`print(result)` render. See `moirais.fn.describe('chol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chol import *
import numpy as np
# See the function signature in fn/chol.py for argument names.
```
