# describe('agevi') — agevi

## WHAT IT DOES

EVI spatial analysis
...
`print(result)` render. See `moirais.fn.describe('agevi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agevi import *
import numpy as np
# See the function signature in fn/agevi.py for argument names.
```
