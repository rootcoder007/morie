...
`print(result)` render. See `moirais.fn.describe('lrfor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrfor import *
import numpy as np
# See the function signature in fn/lrfor.py for argument names.
```
