...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1201"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1201(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1201')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u1201: GeneralStatistics expression (auto-extracted; see ref)."
