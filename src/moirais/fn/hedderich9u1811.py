...
__all__ = ["hedderich_chapter_9_unnumbered_1811"]


def hedderich_chapter_9_unnumbered_1811(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: HA1 :µ>µ0 ˆt = ¯x−µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1811')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1811: GeneralStatistics expression (auto-extracted; see ref)."
