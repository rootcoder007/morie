...
__all__ = ["wilcox_chapter_13_unnumbered_1296"]


def wilcox_chapter_13_unnumbered_1296(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: pwr.chisq.test(w=0.1,N=100,df=1,alpha=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1296')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1296: ContingencyTables expression (auto-extracted; see ref)."
