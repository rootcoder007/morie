...
`print(result)` render. See `moirais.fn.describe('cfmdc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfmdc import *
import numpy as np
# See the function signature in fn/cfmdc.py for argument names.
```
