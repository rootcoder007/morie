...
`print(result)` render. See `moirais.fn.describe('nwint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwint import *
import numpy as np
# See the function signature in fn/nwint.py for argument names.
```
