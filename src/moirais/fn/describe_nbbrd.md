...
`print(result)` render. See `moirais.fn.describe('nbbrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbbrd import *
import numpy as np
# See the function signature in fn/nbbrd.py for argument names.
```
