# describe('aithil') — compositional_hill
...
`print(result)` render. See `moirais.fn.describe('aithil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aithil import *
import numpy as np
# See the function signature in fn/aithil.py for argument names.
```
