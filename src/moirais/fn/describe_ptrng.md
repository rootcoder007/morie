...
`print(result)` render. See `moirais.fn.describe('ptrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptrng import *
import numpy as np
# See the function signature in fn/ptrng.py for argument names.
```
