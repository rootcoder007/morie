# describe('msm290') — mvsml_convolutional_nn_eq_14_12
...
`print(result)` render. See `moirais.fn.describe('msm290')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm290 import *
import numpy as np
# See the function signature in fn/msm290.py for argument names.
```
