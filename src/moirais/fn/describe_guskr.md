...
`print(result)` render. See `moirais.fn.describe('guskr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.guskr import *
import numpy as np
# See the function signature in fn/guskr.py for argument names.
```
