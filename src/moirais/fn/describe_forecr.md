# describe('forecr') — forecr

## WHAT IT DOES

Recruitment rate spatial
...
`print(result)` render. See `moirais.fn.describe('forecr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forecr import *
import numpy as np
# See the function signature in fn/forecr.py for argument names.
```
