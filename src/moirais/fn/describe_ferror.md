# describe('ferror') — fader_renewable
...
`print(result)` render. See `moirais.fn.describe('ferror')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ferror import *
import numpy as np
# See the function signature in fn/ferror.py for argument names.
```
