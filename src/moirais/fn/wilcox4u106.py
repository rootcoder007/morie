...
__all__ = ["wilcox_chapter_4_unnumbered_106"]


def wilcox_chapter_4_unnumbered_106(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: their weight loss is standard normal (so µ = 0 and σ = 1). As for adults who have dieted to
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u106')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u106: GeneralStatistics expression (auto-extracted; see ref)."
