...
`print(result)` render. See `moirais.fn.describe('kcvms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kcvms import *
import numpy as np
# See the function signature in fn/kcvms.py for argument names.
```
