...
`print(result)` render. See `moirais.fn.describe('isatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isatt import *
import numpy as np
# See the function signature in fn/isatt.py for argument names.
```
