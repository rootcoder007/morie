# describe('cgsol') — conjugate_gradient
...
`print(result)` render. See `moirais.fn.describe('cgsol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cgsol import *
import numpy as np
# See the function signature in fn/cgsol.py for argument names.
```
