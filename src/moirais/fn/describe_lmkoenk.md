...
`print(result)` render. See `moirais.fn.describe('lmkoenk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmkoenk import *
import numpy as np
# See the function signature in fn/lmkoenk.py for argument names.
```
