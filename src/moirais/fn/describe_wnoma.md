# describe('wnoma') — wnominate_alternating
...
`print(result)` render. See `moirais.fn.describe('wnoma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnoma import *
import numpy as np
# See the function signature in fn/wnoma.py for argument names.
```
