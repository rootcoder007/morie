# describe('aitamg') — aitchison_amalgamation
...
`print(result)` render. See `moirais.fn.describe('aitamg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitamg import *
import numpy as np
# See the function signature in fn/aitamg.py for argument names.
```
