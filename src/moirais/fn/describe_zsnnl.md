...
`print(result)` render. See `moirais.fn.describe('zsnnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsnnl import *
import numpy as np
# See the function signature in fn/zsnnl.py for argument names.
```
