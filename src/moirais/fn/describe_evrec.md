# describe('evrec') — evt_record_count
...
`print(result)` render. See `moirais.fn.describe('evrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evrec import *
import numpy as np
# See the function signature in fn/evrec.py for argument names.
```
