...
`print(result)` render. See `moirais.fn.describe('wlgnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlgnf import *
import numpy as np
# See the function signature in fn/wlgnf.py for argument names.
```
