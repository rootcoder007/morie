# describe('fzsrv') — fauzi_survival_kernel
...
`print(result)` render. See `moirais.fn.describe('fzsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzsrv import *
import numpy as np
# See the function signature in fn/fzsrv.py for argument names.
```
