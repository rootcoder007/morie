...
__all__ = ["bivand2013_chapter_2_unnumbered_17"]


def bivand2013_chapter_2_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + labels = parse(text = as.character(at_proj$labels)),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u17')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u17: GeneralStatistics expression (auto-extracted; see ref)."
