...
__all__ = ["wilcox_chapter_14_unnumbered_554"]


def wilcox_chapter_14_unnumbered_554(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: yhbt(x, y, tr = 0.15, alpha = 0.05, nboot = 600,PV=F) .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u554')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u554: PowerAndDesign expression (auto-extracted; see ref)."
