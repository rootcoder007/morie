# describe('smoth') — epidemic_smooth
...
`print(result)` render. See `moirais.fn.describe('smoth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smoth import *
import numpy as np
# See the function signature in fn/smoth.py for argument names.
```
