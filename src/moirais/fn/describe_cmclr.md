...
`print(result)` render. See `moirais.fn.describe('cmclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmclr import *
import numpy as np
# See the function signature in fn/cmclr.py for argument names.
```
