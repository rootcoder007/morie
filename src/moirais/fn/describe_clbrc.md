...
`print(result)` render. See `moirais.fn.describe('clbrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clbrc import *
import numpy as np
# See the function signature in fn/clbrc.py for argument names.
```
