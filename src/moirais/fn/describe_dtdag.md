...
`print(result)` render. See `moirais.fn.describe('dtdag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtdag import *
import numpy as np
# See the function signature in fn/dtdag.py for argument names.
```
