# describe('clfcm') — clfcm

## WHAT IT DOES

Fuzzy CM-means spatial
...
`print(result)` render. See `moirais.fn.describe('clfcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clfcm import *
import numpy as np
# See the function signature in fn/clfcm.py for argument names.
```
