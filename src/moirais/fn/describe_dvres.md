# describe('dvres') — deviance_residual_cox
...
`print(result)` render. See `moirais.fn.describe('dvres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dvres import *
import numpy as np
# See the function signature in fn/dvres.py for argument names.
```
