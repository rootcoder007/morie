...
__all__ = ["bivand2013_chapter_7_unnumbered_239"]


def bivand2013_chapter_7_unnumbered_239(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: UBRE score = 0.2815 Scale est. = 1 n = 281
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u239')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u239: GeneralStatistics expression (auto-extracted; see ref)."
