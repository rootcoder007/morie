# describe('svmep') — svr_epsilon_insensitive
...
`print(result)` render. See `moirais.fn.describe('svmep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmep import *
import numpy as np
# See the function signature in fn/svmep.py for argument names.
```
