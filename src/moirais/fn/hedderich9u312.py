...
__all__ = ["hedderich_chapter_9_unnumbered_312"]


def hedderich_chapter_9_unnumbered_312(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] i−(∑xi)2 = sxy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u312')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u312: GeneralStatistics expression (auto-extracted; see ref)."
