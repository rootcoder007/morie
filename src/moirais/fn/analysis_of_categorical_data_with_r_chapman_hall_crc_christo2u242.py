...
__all__ = ["analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_2_unnumbered_242"]


def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_2_unnumbered_242(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo2u242')`` for the full guide.
...
def cheatsheet():
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo2u242: GeneralStatistics expression (auto-extracted; see ref)."
