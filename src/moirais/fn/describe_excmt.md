# describe('excmt') — excess_mortality
...
`print(result)` render. See `moirais.fn.describe('excmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.excmt import *
import numpy as np
# See the function signature in fn/excmt.py for argument names.
```
