...
`print(result)` render. See `moirais.fn.describe('paget')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paget import *
import numpy as np
# See the function signature in fn/paget.py for argument names.
```
