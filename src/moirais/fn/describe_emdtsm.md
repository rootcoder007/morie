# describe('emdtsm') — emd_decomposition
...
`print(result)` render. See `moirais.fn.describe('emdtsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdtsm import *
import numpy as np
# See the function signature in fn/emdtsm.py for argument names.
```
