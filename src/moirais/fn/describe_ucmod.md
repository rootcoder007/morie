# describe('ucmod') — unobserved_components
...
`print(result)` render. See `moirais.fn.describe('ucmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ucmod import *
import numpy as np
# See the function signature in fn/ucmod.py for argument names.
```
