...
__all__ = ["bivand2013_chapter_2_unnumbered_18"]


def bivand2013_chapter_2_unnumbered_18(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > X11(width = 10, height = 10)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u18')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u18: GeneralStatistics expression (auto-extracted; see ref)."
