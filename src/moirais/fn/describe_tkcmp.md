# describe('tkcmp') — tucker_decompose
...
`print(result)` render. See `moirais.fn.describe('tkcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tkcmp import *
import numpy as np
# See the function signature in fn/tkcmp.py for argument names.
```
