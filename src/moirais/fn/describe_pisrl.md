...
`print(result)` render. See `moirais.fn.describe('pisrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pisrl import *
import numpy as np
# See the function signature in fn/pisrl.py for argument names.
```
