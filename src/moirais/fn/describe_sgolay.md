...
`print(result)` render. See `moirais.fn.describe('sgolay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgolay import *
import numpy as np
# See the function signature in fn/sgolay.py for argument names.
```
