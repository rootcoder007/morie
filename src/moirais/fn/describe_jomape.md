...
`print(result)` render. See `moirais.fn.describe('jomape')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jomape import *
import numpy as np
# See the function signature in fn/jomape.py for argument names.
```
