# describe('cmprk') — competing_risks
...
`print(result)` render. See `moirais.fn.describe('cmprk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmprk import *
import numpy as np
# See the function signature in fn/cmprk.py for argument names.
```
