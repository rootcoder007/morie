# describe('spln') — spline_regression

## WHAT IT DOES

Cubic spline regression. 'The only true wisdom is in knowing you know nothing. — Socrates'
...
`print(result)` render. See `moirais.fn.describe('spln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spln import *
import numpy as np
# See the function signature in fn/spln.py for argument names.
```
