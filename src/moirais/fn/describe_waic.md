...
`print(result)` render. See `moirais.fn.describe('waic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.waic import *
import numpy as np
# See the function signature in fn/waic.py for argument names.
```
