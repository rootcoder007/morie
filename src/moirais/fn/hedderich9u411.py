...
__all__ = ["hedderich_chapter_9_unnumbered_411"]


def hedderich_chapter_9_unnumbered_411(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (Digit) = lg(Digit + 1)−lg(Digit)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u411')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u411: GeneralStatistics expression (auto-extracted; see ref)."
