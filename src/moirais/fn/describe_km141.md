# describe('km141') — kamath_ch9_itm_loss
...
`print(result)` render. See `moirais.fn.describe('km141')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km141 import *
import numpy as np
# See the function signature in fn/km141.py for argument names.
```
