# describe('comlpa') — label_propagation
...
`print(result)` render. See `moirais.fn.describe('comlpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comlpa import *
import numpy as np
# See the function signature in fn/comlpa.py for argument names.
```
