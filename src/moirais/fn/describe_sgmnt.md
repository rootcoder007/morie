...
`print(result)` render. See `moirais.fn.describe('sgmnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmnt import *
import numpy as np
# See the function signature in fn/sgmnt.py for argument names.
```
