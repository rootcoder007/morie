...
`print(result)` render. See `moirais.fn.describe('svord2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svord2 import *
import numpy as np
# See the function signature in fn/svord2.py for argument names.
```
