...
__all__ = ["hedderich_chapter_9_unnumbered_367"]


def hedderich_chapter_9_unnumbered_367(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Si(x) = b0i +b1ix +b2ix2 +b3ix3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u367')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u367: GeneralStatistics expression (auto-extracted; see ref)."
