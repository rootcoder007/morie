# describe('msprc') — procrustes_corr
...
`print(result)` render. See `moirais.fn.describe('msprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msprc import *
import numpy as np
# See the function signature in fn/msprc.py for argument names.
```
