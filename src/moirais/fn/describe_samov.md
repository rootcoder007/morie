...
`print(result)` render. See `moirais.fn.describe('samov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samov import *
import numpy as np
# See the function signature in fn/samov.py for argument names.
```
