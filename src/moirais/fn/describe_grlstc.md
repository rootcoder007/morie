# describe('grlstc') — geron_lstm_cell
...
`print(result)` render. See `moirais.fn.describe('grlstc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlstc import *
import numpy as np
# See the function signature in fn/grlstc.py for argument names.
```
