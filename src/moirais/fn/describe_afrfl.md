...
`print(result)` render. See `moirais.fn.describe('afrfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afrfl import *
import numpy as np
# See the function signature in fn/afrfl.py for argument names.
```
