...
__all__ = ["hedderich_chapter_9_unnumbered_2821"]


def hedderich_chapter_9_unnumbered_2821(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + " Chiquadrat − M H: " , round ( CHImh , 4 ) , " ( P \ b= \ b " , round ( pval1 , 5 ) , " \ b ) " , " \ n " ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2821')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2821: GeneralStatistics expression (auto-extracted; see ref)."
