...
`print(result)` render. See `moirais.fn.describe('ising')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ising import *
import numpy as np
# See the function signature in fn/ising.py for argument names.
```
