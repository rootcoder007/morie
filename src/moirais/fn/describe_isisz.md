...
`print(result)` render. See `moirais.fn.describe('isisz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isisz import *
import numpy as np
# See the function signature in fn/isisz.py for argument names.
```
