# describe('rng153') — rangayyan_ch3_anc_primary_input_model
...
`print(result)` render. See `moirais.fn.describe('rng153')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng153 import *
import numpy as np
# See the function signature in fn/rng153.py for argument names.
```
