# describe('bkprd') — backward_prediction_fn
...
`print(result)` render. See `moirais.fn.describe('bkprd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkprd import *
import numpy as np
# See the function signature in fn/bkprd.py for argument names.
```
