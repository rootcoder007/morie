# describe('gh_c1_3') — ghosal_prior_posterior_update
...
`print(result)` render. See `moirais.fn.describe('gh_c1_3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c1_3 import *
import numpy as np
# See the function signature in fn/gh_c1_3.py for argument names.
```
