# describe('kmitm') — kamath_image_text_matching
...
`print(result)` render. See `moirais.fn.describe('kmitm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmitm import *
import numpy as np
# See the function signature in fn/kmitm.py for argument names.
```
