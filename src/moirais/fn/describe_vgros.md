...
`print(result)` render. See `moirais.fn.describe('vgros')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgros import *
import numpy as np
# See the function signature in fn/vgros.py for argument names.
```
