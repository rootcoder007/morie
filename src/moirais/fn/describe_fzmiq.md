# describe('fzmiq') — fauzi_moment_ineq_ustat
...
`print(result)` render. See `moirais.fn.describe('fzmiq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmiq import *
import numpy as np
# See the function signature in fn/fzmiq.py for argument names.
```
