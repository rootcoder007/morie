...
`print(result)` render. See `moirais.fn.describe('adbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adbst import *
import numpy as np
# See the function signature in fn/adbst.py for argument names.
```
