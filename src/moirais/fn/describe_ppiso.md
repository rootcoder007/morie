...
`print(result)` render. See `moirais.fn.describe('ppiso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppiso import *
import numpy as np
# See the function signature in fn/ppiso.py for argument names.
```
