...
`print(result)` render. See `moirais.fn.describe('nmgmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmgmp import *
import numpy as np
# See the function signature in fn/nmgmp.py for argument names.
```
