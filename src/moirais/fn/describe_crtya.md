...
`print(result)` render. See `moirais.fn.describe('crtya')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtya import *
import numpy as np
# See the function signature in fn/crtya.py for argument names.
```
