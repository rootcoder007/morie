# describe('wsmbgn') — wasserman_bagging
...
`print(result)` render. See `moirais.fn.describe('wsmbgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbgn import *
import numpy as np
# See the function signature in fn/wsmbgn.py for argument names.
```
