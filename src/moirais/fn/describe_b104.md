# describe('b104') — burkov_lm_ch1_linear_vector
...
`print(result)` render. See `moirais.fn.describe('b104')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b104 import *
import numpy as np
# See the function signature in fn/b104.py for argument names.
```
