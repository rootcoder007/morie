...
`print(result)` render. See `moirais.fn.describe('wlsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlsrv import *
import numpy as np
# See the function signature in fn/wlsrv.py for argument names.
```
