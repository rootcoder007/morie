...
__all__ = ["hedderich_chapter_9_unnumbered_2956"]


def hedderich_chapter_9_unnumbered_2956(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: j|i with πj|i =πij/πi. (7.352)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2956')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2956: CountModels expression (auto-extracted; see ref)."
