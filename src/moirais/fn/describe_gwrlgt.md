...
`print(result)` render. See `moirais.fn.describe('gwrlgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrlgt import *
import numpy as np
# See the function signature in fn/gwrlgt.py for argument names.
```
