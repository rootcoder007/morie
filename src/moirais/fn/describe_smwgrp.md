# describe('smwgrp') — small_worldness
...
`print(result)` render. See `moirais.fn.describe('smwgrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smwgrp import *
import numpy as np
# See the function signature in fn/smwgrp.py for argument names.
```
