# describe('spcar') — schabenberger_car_model
...
`print(result)` render. See `moirais.fn.describe('spcar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcar import *
import numpy as np
# See the function signature in fn/spcar.py for argument names.
```
