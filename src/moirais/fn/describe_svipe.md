...
`print(result)` render. See `moirais.fn.describe('svipe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipe import *
import numpy as np
# See the function signature in fn/svipe.py for argument names.
```
