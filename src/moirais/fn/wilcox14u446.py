...
__all__ = ["wilcox_chapter_14_unnumbered_446"]


def wilcox_chapter_14_unnumbered_446(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: xlab="X",ylab="Y",nreps=5000,pch=".",CI=FALSE,ADJ=TRUE,SEED=TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u446')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u446: GeneralStatistics expression (auto-extracted; see ref)."
