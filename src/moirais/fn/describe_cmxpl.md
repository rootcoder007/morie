...
`print(result)` render. See `moirais.fn.describe('cmxpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmxpl import *
import numpy as np
# See the function signature in fn/cmxpl.py for argument names.
```
