# describe('sucost') — substance_cost
...
`print(result)` render. See `moirais.fn.describe('sucost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sucost import *
import numpy as np
# See the function signature in fn/sucost.py for argument names.
```
