# describe('msm273') — mvsml_convolutional_nn_eq_14_4
...
`print(result)` render. See `moirais.fn.describe('msm273')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm273 import *
import numpy as np
# See the function signature in fn/msm273.py for argument names.
```
