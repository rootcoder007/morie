# describe('rng094') — rangayyan_ch3_hann_frequency_response_simplified
...
`print(result)` render. See `moirais.fn.describe('rng094')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng094 import *
import numpy as np
# See the function signature in fn/rng094.py for argument names.
```
