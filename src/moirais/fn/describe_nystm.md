# describe('nystm') — nystrom_approximation
...
`print(result)` render. See `moirais.fn.describe('nystm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nystm import *
import numpy as np
# See the function signature in fn/nystm.py for argument names.
```
