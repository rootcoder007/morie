...
`print(result)` render. See `moirais.fn.describe('cscyb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscyb import *
import numpy as np
# See the function signature in fn/cscyb.py for argument names.
```
