# describe('nvrmt') — normal_var_ratio_test
...
`print(result)` render. See `moirais.fn.describe('nvrmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nvrmt import *
import numpy as np
# See the function signature in fn/nvrmt.py for argument names.
```
