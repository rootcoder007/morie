...
__all__ = ["hedderich_chapter_9_unnumbered_1765"]


def hedderich_chapter_9_unnumbered_1765(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 0(1−π0)n−i <α (7.43)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1765')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1765: CountModels expression (auto-extracted; see ref)."
