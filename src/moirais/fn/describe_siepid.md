...
`print(result)` render. See `moirais.fn.describe('siepid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siepid import *
import numpy as np
# See the function signature in fn/siepid.py for argument names.
```
