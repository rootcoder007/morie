# describe('hrzbwopt') — horowitz_optimal_bandwidth_kde
...
`print(result)` render. See `moirais.fn.describe('hrzbwopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzbwopt import *
import numpy as np
# See the function signature in fn/hrzbwopt.py for argument names.
```
