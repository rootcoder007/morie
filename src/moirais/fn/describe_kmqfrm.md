# describe('kmqfrm') — kamath_q_former
...
`print(result)` render. See `moirais.fn.describe('kmqfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmqfrm import *
import numpy as np
# See the function signature in fn/kmqfrm.py for argument names.
```
