...
`print(result)` render. See `moirais.fn.describe('gbrwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbrwv import *
import numpy as np
# See the function signature in fn/gbrwv.py for argument names.
```
