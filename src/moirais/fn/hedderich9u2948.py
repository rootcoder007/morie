...
__all__ = ["hedderich_chapter_9_unnumbered_2948"]


def hedderich_chapter_9_unnumbered_2948(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] B ( two − sided ) = 28.19595 , ( P = 3 . 3 e −06 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2948')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2948: GeneralStatistics expression (auto-extracted; see ref)."
