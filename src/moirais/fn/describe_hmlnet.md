...
`print(result)` render. See `moirais.fn.describe('hmlnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlnet import *
import numpy as np
# See the function signature in fn/hmlnet.py for argument names.
```
