# describe('krigun') — universal_kriging
...
`print(result)` render. See `moirais.fn.describe('krigun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krigun import *
import numpy as np
# See the function signature in fn/krigun.py for argument names.
```
