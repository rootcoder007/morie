...
`print(result)` render. See `moirais.fn.describe('blpil')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blpil import *
import numpy as np
# See the function signature in fn/blpil.py for argument names.
```
