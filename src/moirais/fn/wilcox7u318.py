...
__all__ = ["wilcox_chapter_7_unnumbered_318"]


def wilcox_chapter_7_unnumbered_318(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] N = max(10, [(21.4)2/22 .6] + 1) = max(10, 21) = 21.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u318')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u318: PowerAndDesign expression (auto-extracted; see ref)."
