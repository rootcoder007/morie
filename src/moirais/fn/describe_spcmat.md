...
`print(result)` render. See `moirais.fn.describe('spcmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcmat import *
import numpy as np
# See the function signature in fn/spcmat.py for argument names.
```
