...
`print(result)` render. See `moirais.fn.describe('svgmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svgmp import *
import numpy as np
# See the function signature in fn/svgmp.py for argument names.
```
