# describe('agdcon') — agd_constrained
...
`print(result)` render. See `moirais.fn.describe('agdcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdcon import *
import numpy as np
# See the function signature in fn/agdcon.py for argument names.
```
