...
`print(result)` render. See `moirais.fn.describe('wlcrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcrr import *
import numpy as np
# See the function signature in fn/wlcrr.py for argument names.
```
