...
`print(result)` render. See `moirais.fn.describe('sener')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sener import *
import numpy as np
# See the function signature in fn/sener.py for argument names.
```
