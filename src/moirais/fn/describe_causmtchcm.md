# describe('causmtchcm') — causal_caliper_matching
...
`print(result)` render. See `moirais.fn.describe('causmtchcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmtchcm import *
import numpy as np
# See the function signature in fn/causmtchcm.py for argument names.
```
