...
`print(result)` render. See `moirais.fn.describe('stknl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stknl import *
import numpy as np
# See the function signature in fn/stknl.py for argument names.
```
