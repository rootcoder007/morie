...
`print(result)` render. See `moirais.fn.describe('dteig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dteig import *
import numpy as np
# See the function signature in fn/dteig.py for argument names.
```
