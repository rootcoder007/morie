...
def stochastic_physics_section_3_unnumbered_12(x):
    """
    GeneralStochastic expression (auto-extracted; see reference).

    Formula: will serve as witnesses to crimes. Parameters δ, θ and ϵ are
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('sp_s3u12')`` for the full guide.
...
def cheatsheet():
    return "sp_s3u12: GeneralStochastic expression (auto-extracted; see reference)."
