...
`print(result)` render. See `moirais.fn.describe('sarsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarsig import *
import numpy as np
# See the function signature in fn/sarsig.py for argument names.
```
