...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_859"]


def guide_on_data_analysis_chapter_12_unnumbered_859(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: WoE = log(dist_good / dist_bad)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u859')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u859: GeneralStatistics expression (auto-extracted; see ref)."
