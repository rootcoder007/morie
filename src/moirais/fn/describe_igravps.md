...
`print(result)` render. See `moirais.fn.describe('igravps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igravps import *
import numpy as np
# See the function signature in fn/igravps.py for argument names.
```
