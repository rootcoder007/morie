...
`print(result)` render. See `moirais.fn.describe('ctisoq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctisoq import *
import numpy as np
# See the function signature in fn/ctisoq.py for argument names.
```
