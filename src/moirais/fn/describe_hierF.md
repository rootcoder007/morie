# describe('hierF') — hierarchical_forecast
...
`print(result)` render. See `moirais.fn.describe('hierF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hierF import *
import numpy as np
# See the function signature in fn/hierF.py for argument names.
```
