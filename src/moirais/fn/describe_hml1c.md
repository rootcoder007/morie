# describe('hml1c') — geron_one_cycle
...
`print(result)` render. See `moirais.fn.describe('hml1c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hml1c import *
import numpy as np
# See the function signature in fn/hml1c.py for argument names.
```
