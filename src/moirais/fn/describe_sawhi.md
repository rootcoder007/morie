# describe('sawhi') — sawhi

## WHAT IT DOES

Spatial weight histogram
...
`print(result)` render. See `moirais.fn.describe('sawhi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawhi import *
import numpy as np
# See the function signature in fn/sawhi.py for argument names.
```
