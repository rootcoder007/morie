...
__all__ = ["bivand2013_chapter_7_unnumbered_295"]


def bivand2013_chapter_7_unnumbered_295(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: log(θi,t)= α+βxi +vi +wt
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u295')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u295: GeneralStatistics expression (auto-extracted; see ref)."
