# describe('dpgem') — gem_distribution
...
`print(result)` render. See `moirais.fn.describe('dpgem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgem import *
import numpy as np
# See the function signature in fn/dpgem.py for argument names.
```
