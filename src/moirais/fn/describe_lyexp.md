...
`print(result)` render. See `moirais.fn.describe('lyexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lyexp import *
import numpy as np
# See the function signature in fn/lyexp.py for argument names.
```
