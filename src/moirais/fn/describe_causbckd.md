# describe('causbckd') — causal_backdoor_estimate
...
`print(result)` render. See `moirais.fn.describe('causbckd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causbckd import *
import numpy as np
# See the function signature in fn/causbckd.py for argument names.
```
