...
`print(result)` render. See `moirais.fn.describe('sagjo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagjo import *
import numpy as np
# See the function signature in fn/sagjo.py for argument names.
```
