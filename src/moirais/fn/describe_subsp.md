...
`print(result)` render. See `moirais.fn.describe('subsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.subsp import *
import numpy as np
# See the function signature in fn/subsp.py for argument names.
```
