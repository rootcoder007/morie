# describe('fzt23') — fauzi_thm2_3_var_brdkdfe
...
`print(result)` render. See `moirais.fn.describe('fzt23')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt23 import *
import numpy as np
# See the function signature in fn/fzt23.py for argument names.
```
