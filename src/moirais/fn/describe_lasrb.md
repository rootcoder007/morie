...
`print(result)` render. See `moirais.fn.describe('lasrb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lasrb import *
import numpy as np
# See the function signature in fn/lasrb.py for argument names.
```
