...
__all__ = ["wilcox_chapter_13_unnumbered_1335"]


def wilcox_chapter_13_unnumbered_1335(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1335')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1335: CountModels expression (auto-extracted; see ref)."
