...
`print(result)` render. See `moirais.fn.describe('pldyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pldyn import *
import numpy as np
# See the function signature in fn/pldyn.py for argument names.
```
