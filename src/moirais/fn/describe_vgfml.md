...
`print(result)` render. See `moirais.fn.describe('vgfml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgfml import *
import numpy as np
# See the function signature in fn/vgfml.py for argument names.
```
