# describe('cmplt') — capture_recapture
...
`print(result)` render. See `moirais.fn.describe('cmplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmplt import *
import numpy as np
# See the function signature in fn/cmplt.py for argument names.
```
