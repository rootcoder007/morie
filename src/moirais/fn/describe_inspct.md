...
`print(result)` render. See `moirais.fn.describe('inspct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inspct import *
import numpy as np
# See the function signature in fn/inspct.py for argument names.
```
