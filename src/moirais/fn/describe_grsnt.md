# describe('grsnt') — geron_sentiment_binary
...
`print(result)` render. See `moirais.fn.describe('grsnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsnt import *
import numpy as np
# See the function signature in fn/grsnt.py for argument names.
```
