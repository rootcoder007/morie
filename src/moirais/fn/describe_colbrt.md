...
`print(result)` render. See `moirais.fn.describe('colbrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.colbrt import *
import numpy as np
# See the function signature in fn/colbrt.py for argument names.
```
