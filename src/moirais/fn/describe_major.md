...
`print(result)` render. See `moirais.fn.describe('major')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.major import *
import numpy as np
# See the function signature in fn/major.py for argument names.
```
