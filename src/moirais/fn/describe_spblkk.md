# describe('spblkk') — schabenberger_block_kriging
...
`print(result)` render. See `moirais.fn.describe('spblkk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spblkk import *
import numpy as np
# See the function signature in fn/spblkk.py for argument names.
```
