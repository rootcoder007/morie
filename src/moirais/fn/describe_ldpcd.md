...
`print(result)` render. See `moirais.fn.describe('ldpcd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldpcd import *
import numpy as np
# See the function signature in fn/ldpcd.py for argument names.
```
