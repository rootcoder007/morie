...
`print(result)` render. See `moirais.fn.describe('semkp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semkp import *
import numpy as np
# See the function signature in fn/semkp.py for argument names.
```
