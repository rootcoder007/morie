...
__all__ = ["hedderich_chapter_9_unnumbered_2628"]


def hedderich_chapter_9_unnumbered_2628(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (12−1)(6·6−0·0)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2628')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2628: PowerAndDesign expression (auto-extracted; see ref)."
