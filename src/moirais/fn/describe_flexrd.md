# describe('flexrd') — flexible_receptor_dock
...
`print(result)` render. See `moirais.fn.describe('flexrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flexrd import *
import numpy as np
# See the function signature in fn/flexrd.py for argument names.
```
