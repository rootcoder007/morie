...
`print(result)` render. See `moirais.fn.describe('stvario')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stvario import *
import numpy as np
# See the function signature in fn/stvario.py for argument names.
```
