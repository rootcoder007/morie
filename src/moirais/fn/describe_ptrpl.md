# describe('ptrpl') — ripley_correction
...
`print(result)` render. See `moirais.fn.describe('ptrpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptrpl import *
import numpy as np
# See the function signature in fn/ptrpl.py for argument names.
```
