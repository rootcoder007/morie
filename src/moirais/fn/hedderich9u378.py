...
__all__ = ["hedderich_chapter_9_unnumbered_378"]


def hedderich_chapter_9_unnumbered_378(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Example:A ={2, 4}B ={1, 2}A∪B ={1, 2, 4}.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u378')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u378: GeneralStatistics expression (auto-extracted; see ref)."
