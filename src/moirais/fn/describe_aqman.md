# describe('aqman') — idw_interpolate
...
`print(result)` render. See `moirais.fn.describe('aqman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aqman import *
import numpy as np
# See the function signature in fn/aqman.py for argument names.
```
