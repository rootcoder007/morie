...
__all__ = ["hedderich_chapter_9_unnumbered_2713"]


def hedderich_chapter_9_unnumbered_2713(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] P1/(1−P1) = 1√ω
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2713')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2713: PowerAndDesign expression (auto-extracted; see ref)."
