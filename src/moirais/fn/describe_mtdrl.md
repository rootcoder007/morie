...
`print(result)` render. See `moirais.fn.describe('mtdrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtdrl import *
import numpy as np
# See the function signature in fn/mtdrl.py for argument names.
```
