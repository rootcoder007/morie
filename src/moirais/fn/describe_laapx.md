# describe('laapx') — laplace_approximation
...
`print(result)` render. See `moirais.fn.describe('laapx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laapx import *
import numpy as np
# See the function signature in fn/laapx.py for argument names.
```
