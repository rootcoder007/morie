...
`print(result)` render. See `moirais.fn.describe('windu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.windu import *
import numpy as np
# See the function signature in fn/windu.py for argument names.
```
