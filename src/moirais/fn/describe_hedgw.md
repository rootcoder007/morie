...
`print(result)` render. See `moirais.fn.describe('hedgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hedgw import *
import numpy as np
# See the function signature in fn/hedgw.py for argument names.
```
