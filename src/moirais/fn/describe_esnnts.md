# describe('esnnts') — echo_state_network
...
`print(result)` render. See `moirais.fn.describe('esnnts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esnnts import *
import numpy as np
# See the function signature in fn/esnnts.py for argument names.
```
