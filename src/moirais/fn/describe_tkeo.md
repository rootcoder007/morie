...
`print(result)` render. See `moirais.fn.describe('tkeo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tkeo import *
import numpy as np
# See the function signature in fn/tkeo.py for argument names.
```
