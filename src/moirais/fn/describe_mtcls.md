...
`print(result)` render. See `moirais.fn.describe('mtcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtcls import *
import numpy as np
# See the function signature in fn/mtcls.py for argument names.
```
