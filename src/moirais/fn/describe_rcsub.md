# describe('rcsub') — subset_roll_calls
...
`print(result)` render. See `moirais.fn.describe('rcsub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcsub import *
import numpy as np
# See the function signature in fn/rcsub.py for argument names.
```
