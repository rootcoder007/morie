# describe('sppow') — schabenberger_power_variogram
...
`print(result)` render. See `moirais.fn.describe('sppow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppow import *
import numpy as np
# See the function signature in fn/sppow.py for argument names.
```
