...
`print(result)` render. See `moirais.fn.describe('amr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.amr2 import *
import numpy as np
# See the function signature in fn/amr2.py for argument names.
```
