...
`print(result)` render. See `moirais.fn.describe('or_ci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.or_ci import *
import numpy as np
# See the function signature in fn/or_ci.py for argument names.
```
