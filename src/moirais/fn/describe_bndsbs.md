# describe('bndsbs') — bound_subset_inference
...
`print(result)` render. See `moirais.fn.describe('bndsbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndsbs import *
import numpy as np
# See the function signature in fn/bndsbs.py for argument names.
```
