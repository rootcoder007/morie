...
__all__ = ["wilcox_chapter_13_unnumbered_1171"]


def wilcox_chapter_13_unnumbered_1171(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :β 11 =β 12, (14.12)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1171')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1171: GeneralStatistics expression (auto-extracted; see ref)."
