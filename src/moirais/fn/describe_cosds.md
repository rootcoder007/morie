# describe('cosds') — cosine_distance
...
`print(result)` render. See `moirais.fn.describe('cosds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cosds import *
import numpy as np
# See the function signature in fn/cosds.py for argument names.
```
