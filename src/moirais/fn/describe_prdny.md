# describe('prdny') — prony_method_fn
...
`print(result)` render. See `moirais.fn.describe('prdny')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdny import *
import numpy as np
# See the function signature in fn/prdny.py for argument names.
```
