...
`print(result)` render. See `moirais.fn.describe('foptch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foptch import *
import numpy as np
# See the function signature in fn/foptch.py for argument names.
```
