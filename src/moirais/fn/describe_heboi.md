# describe('heboi') — burden_of_illness
...
`print(result)` render. See `moirais.fn.describe('heboi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heboi import *
import numpy as np
# See the function signature in fn/heboi.py for argument names.
```
