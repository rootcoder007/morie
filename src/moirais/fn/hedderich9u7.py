...
__all__ = ["hedderich_chapter_9_unnumbered_7"]


def hedderich_chapter_9_unnumbered_7(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Subtraction: Minuend−Subtrahend = Calculated Difference [13−8 = 5]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u7')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u7: GeneralStatistics expression (auto-extracted; see ref)."
