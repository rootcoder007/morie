...
__all__ = ["hedderich_chapter_9_unnumbered_1961"]


def hedderich_chapter_9_unnumbered_1961(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] V = (10−1)(4/20) + (12−1)(6/24)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1961')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1961: GeneralStatistics expression (auto-extracted; see ref)."
