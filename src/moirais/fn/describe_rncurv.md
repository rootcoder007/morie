...
`print(result)` render. See `moirais.fn.describe('rncurv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rncurv import *
import numpy as np
# See the function signature in fn/rncurv.py for argument names.
```
