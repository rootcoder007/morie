...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_6_equation_32"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_6_equation_32(x, cdf=None):
    """
    GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment6e32')`` for the full guide.

    References
    ----------
    Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment, ch.6 eq.6.32
    """
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment6e32: GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment."
