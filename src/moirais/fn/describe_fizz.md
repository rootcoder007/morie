...
`print(result)` render. See `moirais.fn.describe('fizz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fizz import *
import numpy as np
# See the function signature in fn/fizz.py for argument names.
```
