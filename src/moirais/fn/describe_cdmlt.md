...
`print(result)` render. See `moirais.fn.describe('cdmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdmlt import *
import numpy as np
# See the function signature in fn/cdmlt.py for argument names.
```
