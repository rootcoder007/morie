...
__all__ = ["hedderich_chapter_9_unnumbered_711"]


def hedderich_chapter_9_unnumbered_711(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 1) = λ1e−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u711')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u711: GeneralStatistics expression (auto-extracted; see ref)."
