# describe('mtotm') — mto_temporal_pattern
...
`print(result)` render. See `moirais.fn.describe('mtotm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtotm import *
import numpy as np
# See the function signature in fn/mtotm.py for argument names.
```
