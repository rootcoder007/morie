...
`print(result)` render. See `moirais.fn.describe('vtpar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtpar import *
import numpy as np
# See the function signature in fn/vtpar.py for argument names.
```
