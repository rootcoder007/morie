...
`print(result)` render. See `moirais.fn.describe('mssmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssmc import *
import numpy as np
# See the function signature in fn/mssmc.py for argument names.
```
