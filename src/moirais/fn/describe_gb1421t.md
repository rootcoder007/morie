# describe('gb1421t') — gibbons_phi_cramers_v
...
`print(result)` render. See `moirais.fn.describe('gb1421t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1421t import *
import numpy as np
# See the function signature in fn/gb1421t.py for argument names.
```
