...
`print(result)` render. See `moirais.fn.describe('ummec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ummec import *
import numpy as np
# See the function signature in fn/ummec.py for argument names.
```
