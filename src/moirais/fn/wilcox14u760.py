...
__all__ = ["wilcox_chapter_14_unnumbered_760"]


def wilcox_chapter_14_unnumbered_760(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: approximatelyc = 5.99 with α = 0.05. Because there are no ties among the N observations,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u760')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u760: GeneralStatistics expression (auto-extracted; see ref)."
