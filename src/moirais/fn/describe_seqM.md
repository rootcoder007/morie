# describe('seqM') — sequential_mediators
...
`print(result)` render. See `moirais.fn.describe('seqM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seqM import *
import numpy as np
# See the function signature in fn/seqM.py for argument names.
```
