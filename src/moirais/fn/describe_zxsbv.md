# describe('zxsbv') — spatial_cv_block
...
`print(result)` render. See `moirais.fn.describe('zxsbv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsbv import *
import numpy as np
# See the function signature in fn/zxsbv.py for argument names.
```
