...
`print(result)` render. See `moirais.fn.describe('cybrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cybrg import *
import numpy as np
# See the function signature in fn/cybrg.py for argument names.
```
