...
`print(result)` render. See `moirais.fn.describe('shang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shang import *
import numpy as np
# See the function signature in fn/shang.py for argument names.
```
