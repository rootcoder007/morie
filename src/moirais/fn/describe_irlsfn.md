...
`print(result)` render. See `moirais.fn.describe('irlsfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irlsfn import *
import numpy as np
# See the function signature in fn/irlsfn.py for argument names.
```
