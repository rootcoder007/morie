# describe('gb833') — gibbons_pct_mod_rank_loc
...
`print(result)` render. See `moirais.fn.describe('gb833')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb833 import *
import numpy as np
# See the function signature in fn/gb833.py for argument names.
```
