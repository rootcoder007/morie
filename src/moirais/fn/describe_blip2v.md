...
`print(result)` render. See `moirais.fn.describe('blip2v')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blip2v import *
import numpy as np
# See the function signature in fn/blip2v.py for argument names.
```
