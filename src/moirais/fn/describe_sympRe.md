# describe('sympRe') — sympy_simplify
...
`print(result)` render. See `moirais.fn.describe('sympRe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sympRe import *
import numpy as np
# See the function signature in fn/sympRe.py for argument names.
```
