# describe('grsft') — geron_sft_objective
...
`print(result)` render. See `moirais.fn.describe('grsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsft import *
import numpy as np
# See the function signature in fn/grsft.py for argument names.
```
