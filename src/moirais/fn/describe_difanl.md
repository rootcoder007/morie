...
`print(result)` render. See `moirais.fn.describe('difanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difanl import *
import numpy as np
# See the function signature in fn/difanl.py for argument names.
```
