...
`print(result)` render. See `moirais.fn.describe('idwgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idwgrd import *
import numpy as np
# See the function signature in fn/idwgrd.py for argument names.
```
