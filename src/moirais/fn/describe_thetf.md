# describe('thetf') — theta_method

## WHAT IT DOES

Theta forecasting method. 'Your eyes can deceive you. Don'Errors using inadequate data are much less than those using no data at all. — Charles Babbage'
...
`print(result)` render. See `moirais.fn.describe('thetf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thetf import *
import numpy as np
# See the function signature in fn/thetf.py for argument names.
```
