...
`print(result)` render. See `moirais.fn.describe('agrev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agrev import *
import numpy as np
# See the function signature in fn/agrev.py for argument names.
```
