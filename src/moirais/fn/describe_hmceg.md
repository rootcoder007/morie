# describe('hmceg') — geron_cross_entropy_gradient
...
`print(result)` render. See `moirais.fn.describe('hmceg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmceg import *
import numpy as np
# See the function signature in fn/hmceg.py for argument names.
```
