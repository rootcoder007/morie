...
`print(result)` render. See `moirais.fn.describe('wqtsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqtsi import *
import numpy as np
# See the function signature in fn/wqtsi.py for argument names.
```
