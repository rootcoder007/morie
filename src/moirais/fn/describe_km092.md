# describe('km092') — kamath_ch6_stereotypical_assoc
...
`print(result)` render. See `moirais.fn.describe('km092')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km092 import *
import numpy as np
# See the function signature in fn/km092.py for argument names.
```
