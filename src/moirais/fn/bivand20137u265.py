...
__all__ = ["bivand2013_chapter_7_unnumbered_265"]


def bivand2013_chapter_7_unnumbered_265(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + nonwhite = nc$nwprop, adj = nc.nb$adj, weights = nc.nb$weights,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u265')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u265: GeneralStatistics expression (auto-extracted; see ref)."
