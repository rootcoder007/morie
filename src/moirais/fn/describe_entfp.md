...
`print(result)` render. See `moirais.fn.describe('entfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entfp import *
import numpy as np
# See the function signature in fn/entfp.py for argument names.
```
