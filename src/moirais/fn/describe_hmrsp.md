# describe('hmrsp') — geron_random_subspaces
...
`print(result)` render. See `moirais.fn.describe('hmrsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrsp import *
import numpy as np
# See the function signature in fn/hmrsp.py for argument names.
```
