# describe('irtmh1') — dif_mantel_haenszel
...
`print(result)` render. See `moirais.fn.describe('irtmh1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtmh1 import *
import numpy as np
# See the function signature in fn/irtmh1.py for argument names.
```
