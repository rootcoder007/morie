# describe('foreld') — foreld

## WHAT IT DOES

Relative density spatial
...
`print(result)` render. See `moirais.fn.describe('foreld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foreld import *
import numpy as np
# See the function signature in fn/foreld.py for argument names.
```
