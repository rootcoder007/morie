...
`print(result)` render. See `moirais.fn.describe('neom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neom import *
import numpy as np
# See the function signature in fn/neom.py for argument names.
```
