# describe('cmpct') — compactify_torus
...
`print(result)` render. See `moirais.fn.describe('cmpct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpct import *
import numpy as np
# See the function signature in fn/cmpct.py for argument names.
```
