# describe('hmrl') — geron_reinforcement_learning
...
`print(result)` render. See `moirais.fn.describe('hmrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrl import *
import numpy as np
# See the function signature in fn/hmrl.py for argument names.
```
