# describe('hmlrl') — geron_linear_regression_life
...
`print(result)` render. See `moirais.fn.describe('hmlrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrl import *
import numpy as np
# See the function signature in fn/hmlrl.py for argument names.
```
