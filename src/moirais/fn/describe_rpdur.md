# describe('rpdur') — rplace_duration
...
`print(result)` render. See `moirais.fn.describe('rpdur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpdur import *
import numpy as np
# See the function signature in fn/rpdur.py for argument names.
```
