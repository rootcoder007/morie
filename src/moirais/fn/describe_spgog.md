# describe('spgog') — schabenberger_getis_ord_g
...
`print(result)` render. See `moirais.fn.describe('spgog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgog import *
import numpy as np
# See the function signature in fn/spgog.py for argument names.
```
