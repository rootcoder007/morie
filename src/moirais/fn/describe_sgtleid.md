# describe('sgtleid') — sgt_leiden_step
...
`print(result)` render. See `moirais.fn.describe('sgtleid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtleid import *
import numpy as np
# See the function signature in fn/sgtleid.py for argument names.
```
