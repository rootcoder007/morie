# describe('msm310') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm310')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm310 import *
import numpy as np
# See the function signature in fn/msm310.py for argument names.
```
