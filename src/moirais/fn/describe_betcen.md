# describe('betcen') — betweenness_centrality
...
`print(result)` render. See `moirais.fn.describe('betcen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.betcen import *
import numpy as np
# See the function signature in fn/betcen.py for argument names.
```
