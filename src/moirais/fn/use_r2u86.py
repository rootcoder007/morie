...
__all__ = ["use_r_chapter_2_unnumbered_86"]


def use_r_chapter_2_unnumbered_86(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u86')`` for the full guide.
...
def cheatsheet():
    return "use_r2u86: GeneralStatistics expression (auto-extracted; see ref)."
