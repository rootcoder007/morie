...
`print(result)` render. See `moirais.fn.describe('rskbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskbs import *
import numpy as np
# See the function signature in fn/rskbs.py for argument names.
```
