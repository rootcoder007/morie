...
`print(result)` render. See `moirais.fn.describe('sttrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sttrn import *
import numpy as np
# See the function signature in fn/sttrn.py for argument names.
```
