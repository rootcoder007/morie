# describe('gpregb') — gp_regression_bayes
...
`print(result)` render. See `moirais.fn.describe('gpregb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpregb import *
import numpy as np
# See the function signature in fn/gpregb.py for argument names.
```
