# describe('rgbwbnd') — rangayyan_bandwidth
...
`print(result)` render. See `moirais.fn.describe('rgbwbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbwbnd import *
import numpy as np
# See the function signature in fn/rgbwbnd.py for argument names.
```
