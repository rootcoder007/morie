# describe('chemsc') — chemscore_dock
...
`print(result)` render. See `moirais.fn.describe('chemsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chemsc import *
import numpy as np
# See the function signature in fn/chemsc.py for argument names.
```
