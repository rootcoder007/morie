# describe('srvfn') — survival_function
...
`print(result)` render. See `moirais.fn.describe('srvfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srvfn import *
import numpy as np
# See the function signature in fn/srvfn.py for argument names.
```
