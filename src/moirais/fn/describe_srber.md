...
`print(result)` render. See `moirais.fn.describe('srber')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srber import *
import numpy as np
# See the function signature in fn/srber.py for argument names.
```
