# describe('dic') — deviance_info_criterion
...
`print(result)` render. See `moirais.fn.describe('dic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dic import *
import numpy as np
# See the function signature in fn/dic.py for argument names.
```
