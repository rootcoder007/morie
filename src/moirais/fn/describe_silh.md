# describe('silh') — silhouette_score
...
`print(result)` render. See `moirais.fn.describe('silh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.silh import *
import numpy as np
# See the function signature in fn/silh.py for argument names.
```
