...
`print(result)` render. See `moirais.fn.describe('svrcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrcp import *
import numpy as np
# See the function signature in fn/svrcp.py for argument names.
```
