# describe('msm072') — mvsml_bayesian_regression_eq_6_10
...
`print(result)` render. See `moirais.fn.describe('msm072')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm072 import *
import numpy as np
# See the function signature in fn/msm072.py for argument names.
```
