# describe('msm314') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm314')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm314 import *
import numpy as np
# See the function signature in fn/msm314.py for argument names.
```
