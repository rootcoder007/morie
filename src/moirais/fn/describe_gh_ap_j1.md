# describe('gh_ap_j1') — ghosal_levy_ito
...
`print(result)` render. See `moirais.fn.describe('gh_ap_j1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_j1 import *
import numpy as np
# See the function signature in fn/gh_ap_j1.py for argument names.
```
