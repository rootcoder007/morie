...
`print(result)` render. See `moirais.fn.describe('agsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agsim import *
import numpy as np
# See the function signature in fn/agsim.py for argument names.
```
