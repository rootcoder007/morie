# describe('sgnsc') — normal_score_transform
...
`print(result)` render. See `moirais.fn.describe('sgnsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgnsc import *
import numpy as np
# See the function signature in fn/sgnsc.py for argument names.
```
