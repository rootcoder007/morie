# describe('gh_ap_a3') — ghosal_tv_distance
...
`print(result)` render. See `moirais.fn.describe('gh_ap_a3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_a3 import *
import numpy as np
# See the function signature in fn/gh_ap_a3.py for argument names.
```
