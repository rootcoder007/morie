# describe('gh_c14_21') — ghosal_ord_dep_sbp
...
`print(result)` render. See `moirais.fn.describe('gh_c14_21')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_21 import *
import numpy as np
# See the function signature in fn/gh_c14_21.py for argument names.
```
