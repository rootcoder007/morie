...
`print(result)` render. See `moirais.fn.describe('fbmsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fbmsn import *
import numpy as np
# See the function signature in fn/fbmsn.py for argument names.
```
