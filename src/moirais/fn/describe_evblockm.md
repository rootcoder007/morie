# describe('evblockm') — evt_block_maxima_fit
...
`print(result)` render. See `moirais.fn.describe('evblockm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evblockm import *
import numpy as np
# See the function signature in fn/evblockm.py for argument names.
```
