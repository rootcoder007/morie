...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_222"]


def guide_on_data_analysis_chapter_4_unnumbered_222(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑀2 = (|𝑛12 − 𝑛21| − 0.5)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u222')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u222: GeneralStatistics expression (auto-extracted; see ref)."
