...
__all__ = ["hedderich_chapter_9_unnumbered_236"]


def hedderich_chapter_9_unnumbered_236(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1st day: 100 + 100x = 100(1 +x)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u236')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u236: GeneralStatistics expression (auto-extracted; see ref)."
