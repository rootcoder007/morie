...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1242"]


def guide_on_data_analysis_chapter_25_unnumbered_1242(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> W = 0.93644, p-value = 0.1104
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1242')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1242: GeneralStatistics expression (auto-extracted; see ref)."
