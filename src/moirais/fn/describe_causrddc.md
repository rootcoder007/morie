# describe('causrddc') — causal_rdd_ccft_bw
...
`print(result)` render. See `moirais.fn.describe('causrddc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causrddc import *
import numpy as np
# See the function signature in fn/causrddc.py for argument names.
```
