# describe('agbnch') — alphazero_benchmark_eval
...
`print(result)` render. See `moirais.fn.describe('agbnch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbnch import *
import numpy as np
# See the function signature in fn/agbnch.py for argument names.
```
