# describe('mlmMd') — multilevel_mediation
...
`print(result)` render. See `moirais.fn.describe('mlmMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlmMd import *
import numpy as np
# See the function signature in fn/mlmMd.py for argument names.
```
