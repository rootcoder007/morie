...
__all__ = ["hedderich_chapter_9_unnumbered_624"]


def hedderich_chapter_9_unnumbered_624(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] px(1−p)3−x = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u624')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u624: CountModels expression (auto-extracted; see ref)."
