...
`print(result)` render. See `moirais.fn.describe('tcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcls import *
import numpy as np
# See the function signature in fn/tcls.py for argument names.
```
