...
`print(result)` render. See `moirais.fn.describe('zxsgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsgb import *
import numpy as np
# See the function signature in fn/zxsgb.py for argument names.
```
