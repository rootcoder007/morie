...
`print(result)` render. See `moirais.fn.describe('bstsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bstsn import *
import numpy as np
# See the function signature in fn/bstsn.py for argument names.
```
