...
`print(result)` render. See `moirais.fn.describe('zxutm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxutm import *
import numpy as np
# See the function signature in fn/zxutm.py for argument names.
```
