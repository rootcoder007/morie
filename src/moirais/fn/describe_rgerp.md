# describe('rgerp') — rangayyan_erp_features
...
`print(result)` render. See `moirais.fn.describe('rgerp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgerp import *
import numpy as np
# See the function signature in fn/rgerp.py for argument names.
```
