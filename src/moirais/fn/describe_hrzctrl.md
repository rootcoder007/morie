# describe('hrzctrl') — horowitz_control_function
...
`print(result)` render. See `moirais.fn.describe('hrzctrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzctrl import *
import numpy as np
# See the function signature in fn/hrzctrl.py for argument names.
```
