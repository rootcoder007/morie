...
`print(result)` render. See `moirais.fn.describe('jnent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jnent import *
import numpy as np
# See the function signature in fn/jnent.py for argument names.
```
