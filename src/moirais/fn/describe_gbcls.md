# describe('gbcls') — gbm_classify_bio
...
`print(result)` render. See `moirais.fn.describe('gbcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbcls import *
import numpy as np
# See the function signature in fn/gbcls.py for argument names.
```
