# describe('btbg') — boot_bagging_predict
...
`print(result)` render. See `moirais.fn.describe('btbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btbg import *
import numpy as np
# See the function signature in fn/btbg.py for argument names.
```
