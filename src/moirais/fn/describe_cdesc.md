...
`print(result)` render. See `moirais.fn.describe('cdesc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdesc import *
import numpy as np
# See the function signature in fn/cdesc.py for argument names.
```
