...
`print(result)` render. See `moirais.fn.describe('egan2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egan2 import *
import numpy as np
# See the function signature in fn/egan2.py for argument names.
```
