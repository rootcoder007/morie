# describe('grgmll') — geron_gmm_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('grgmll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgmll import *
import numpy as np
# See the function signature in fn/grgmll.py for argument names.
```
