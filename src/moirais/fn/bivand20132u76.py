...
__all__ = ["bivand2013_chapter_2_unnumbered_76"]


def bivand2013_chapter_2_unnumbered_76(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + fn = sum, na.rm = TRUE))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u76')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u76: GeneralStatistics expression (auto-extracted; see ref)."
