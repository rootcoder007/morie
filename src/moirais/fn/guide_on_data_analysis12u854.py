...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_854"]


def guide_on_data_analysis_chapter_12_unnumbered_854(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] − log(−𝑥𝑖 + 1) if 𝜆 = 2, 𝑥𝑖 < 0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u854')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u854: GeneralStatistics expression (auto-extracted; see ref)."
