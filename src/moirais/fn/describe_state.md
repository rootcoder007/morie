...
`print(result)` render. See `moirais.fn.describe('state')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.state import *
import numpy as np
# See the function signature in fn/state.py for argument names.
```
