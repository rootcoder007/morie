...
`print(result)` render. See `moirais.fn.describe('ptkdb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptkdb import *
import numpy as np
# See the function signature in fn/ptkdb.py for argument names.
```
