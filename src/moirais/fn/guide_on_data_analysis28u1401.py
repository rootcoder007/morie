...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1401"]


def guide_on_data_analysis_chapter_28_unnumbered_1401(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1401')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1401: GeneralStatistics expression (auto-extracted; see ref)."
