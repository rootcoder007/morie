...
`print(result)` render. See `moirais.fn.describe('sacbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacbic import *
import numpy as np
# See the function signature in fn/sacbic.py for argument names.
```
