...
`print(result)` render. See `moirais.fn.describe('alphsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alphsh import *
import numpy as np
# See the function signature in fn/alphsh.py for argument names.
```
