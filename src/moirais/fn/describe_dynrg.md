...
`print(result)` render. See `moirais.fn.describe('dynrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dynrg import *
import numpy as np
# See the function signature in fn/dynrg.py for argument names.
```
