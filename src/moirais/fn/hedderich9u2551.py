...
__all__ = ["hedderich_chapter_9_unnumbered_2551"]


def hedderich_chapter_9_unnumbered_2551(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] L = 252 p ( table) <=.01
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2551')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2551: GeneralStatistics expression (auto-extracted; see ref)."
