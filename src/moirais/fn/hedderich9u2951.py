...
__all__ = ["hedderich_chapter_9_unnumbered_2951"]


def hedderich_chapter_9_unnumbered_2951(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] B ( one − sidedgreater ) = 7.421634 , ( P = 0.00917102 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2951')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2951: GeneralStatistics expression (auto-extracted; see ref)."
