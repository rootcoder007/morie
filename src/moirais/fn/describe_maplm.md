...
`print(result)` render. See `moirais.fn.describe('maplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maplm import *
import numpy as np
# See the function signature in fn/maplm.py for argument names.
```
