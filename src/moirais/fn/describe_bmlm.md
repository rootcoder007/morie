# describe('bmlm') — bayesian_multilevel
...
`print(result)` render. See `moirais.fn.describe('bmlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmlm import *
import numpy as np
# See the function signature in fn/bmlm.py for argument names.
```
