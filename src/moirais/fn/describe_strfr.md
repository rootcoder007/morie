# describe('strfr') — luminosity_function
...
`print(result)` render. See `moirais.fn.describe('strfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strfr import *
import numpy as np
# See the function signature in fn/strfr.py for argument names.
```
