...
`print(result)` render. See `moirais.fn.describe('oladd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oladd import *
import numpy as np
# See the function signature in fn/oladd.py for argument names.
```
