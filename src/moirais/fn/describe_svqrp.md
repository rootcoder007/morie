...
`print(result)` render. See `moirais.fn.describe('svqrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svqrp import *
import numpy as np
# See the function signature in fn/svqrp.py for argument names.
```
