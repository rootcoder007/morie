# describe('ali') — ali_mikhail_haq_copula
...
`print(result)` render. See `moirais.fn.describe('ali')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ali import *
import numpy as np
# See the function signature in fn/ali.py for argument names.
```
