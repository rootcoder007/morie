# describe('kndll') — kendall_concordance
...
`print(result)` render. See `moirais.fn.describe('kndll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kndll import *
import numpy as np
# See the function signature in fn/kndll.py for argument names.
```
