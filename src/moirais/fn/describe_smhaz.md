...
`print(result)` render. See `moirais.fn.describe('smhaz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smhaz import *
import numpy as np
# See the function signature in fn/smhaz.py for argument names.
```
