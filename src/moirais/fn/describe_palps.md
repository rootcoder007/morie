# describe('palps') — parallel_analysis
...
`print(result)` render. See `moirais.fn.describe('palps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.palps import *
import numpy as np
# See the function signature in fn/palps.py for argument names.
```
