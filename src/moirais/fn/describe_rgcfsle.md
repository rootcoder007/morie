# describe('rgcfsle') — rangayyan_coupled_freq_select
...
`print(result)` render. See `moirais.fn.describe('rgcfsle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcfsle import *
import numpy as np
# See the function signature in fn/rgcfsle.py for argument names.
```
