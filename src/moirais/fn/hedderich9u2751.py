...
__all__ = ["hedderich_chapter_9_unnumbered_2751"]


def hedderich_chapter_9_unnumbered_2751(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: for table b P1+1 =P2 = 2·4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2751')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2751: GeneralStatistics expression (auto-extracted; see ref)."
