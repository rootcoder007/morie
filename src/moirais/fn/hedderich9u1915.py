...
__all__ = ["hedderich_chapter_9_unnumbered_1915"]


def hedderich_chapter_9_unnumbered_1915(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: X∼Pois (λ), µ=n·λ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1915')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1915: CountModels expression (auto-extracted; see ref)."
