...
`print(result)` render. See `moirais.fn.describe('lssmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lssmo import *
import numpy as np
# See the function signature in fn/lssmo.py for argument names.
```
