...
`print(result)` render. See `moirais.fn.describe('tpair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpair import *
import numpy as np
# See the function signature in fn/tpair.py for argument names.
```
