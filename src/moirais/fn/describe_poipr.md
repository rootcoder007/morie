# describe('poipr') — poisson_penalized_regression
...
`print(result)` render. See `moirais.fn.describe('poipr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.poipr import *
import numpy as np
# See the function signature in fn/poipr.py for argument names.
```
