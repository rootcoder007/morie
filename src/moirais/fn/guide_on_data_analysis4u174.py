...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_174"]


def guide_on_data_analysis_chapter_4_unnumbered_174(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] p-value = 𝑃(𝑊 ≥ 𝑤+) = 𝑃(𝑊 ≤ 𝑤−)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u174')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u174: GeneralStatistics expression (auto-extracted; see ref)."
