# describe('heinz') — he_initialization
...
`print(result)` render. See `moirais.fn.describe('heinz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heinz import *
import numpy as np
# See the function signature in fn/heinz.py for argument names.
```
