...
`print(result)` render. See `moirais.fn.describe('frdmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frdmn import *
import numpy as np
# See the function signature in fn/frdmn.py for argument names.
```
