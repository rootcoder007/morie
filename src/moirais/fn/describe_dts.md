...
`print(result)` render. See `moirais.fn.describe('dts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dts import *
import numpy as np
# See the function signature in fn/dts.py for argument names.
```
