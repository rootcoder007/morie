...
`print(result)` render. See `moirais.fn.describe('appvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.appvl import *
import numpy as np
# See the function signature in fn/appvl.py for argument names.
```
