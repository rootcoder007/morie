...
__all__ = ["hedderich_chapter_9_unnumbered_2723"]


def hedderich_chapter_9_unnumbered_2723(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] z1−β = π(|ψ−1|)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2723')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2723: GeneralStatistics expression (auto-extracted; see ref)."
