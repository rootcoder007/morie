# describe('gb831') — gibbons_terry_hoeffding
...
`print(result)` render. See `moirais.fn.describe('gb831')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb831 import *
import numpy as np
# See the function signature in fn/gb831.py for argument names.
```
