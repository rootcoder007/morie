...
__all__ = ["use_r_chapter_2_unnumbered_42"]


def use_r_chapter_2_unnumbered_42(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +y_0=463000 +ellps=bessel +units=m +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u42')`` for the full guide.
...
def cheatsheet():
    return "use_r2u42: GeneralStatistics expression (auto-extracted; see ref)."
