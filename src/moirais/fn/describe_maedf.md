...
`print(result)` render. See `moirais.fn.describe('maedf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maedf import *
import numpy as np
# See the function signature in fn/maedf.py for argument names.
```
