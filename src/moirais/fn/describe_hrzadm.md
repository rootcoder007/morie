# describe('hrzadm') — horowitz_additive_model
...
`print(result)` render. See `moirais.fn.describe('hrzadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzadm import *
import numpy as np
# See the function signature in fn/hrzadm.py for argument names.
```
