...
__all__ = ["hedderich_chapter_9_unnumbered_3399"]


def hedderich_chapter_9_unnumbered_3399(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] > t <− seq ( 0 , 1 , lengt h=100)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3399')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3399: CountModels expression (auto-extracted; see ref)."
