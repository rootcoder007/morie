# describe('volnsig') — vol_nelson_skew_garch
...
`print(result)` render. See `moirais.fn.describe('volnsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volnsig import *
import numpy as np
# See the function signature in fn/volnsig.py for argument names.
```
