...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_489"]


def guide_on_data_analysis_chapter_6_unnumbered_489(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝜃new = 𝜃old + (𝜃old − 𝜃prev).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u489')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u489: GeneralStatistics expression (auto-extracted; see ref)."
