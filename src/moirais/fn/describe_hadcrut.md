...
`print(result)` render. See `moirais.fn.describe('hadcrut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hadcrut import *
import numpy as np
# See the function signature in fn/hadcrut.py for argument names.
```
