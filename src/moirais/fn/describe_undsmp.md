...
`print(result)` render. See `moirais.fn.describe('undsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.undsmp import *
import numpy as np
# See the function signature in fn/undsmp.py for argument names.
```
