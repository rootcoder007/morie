...
`print(result)` render. See `moirais.fn.describe('wlrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlrst import *
import numpy as np
# See the function signature in fn/wlrst.py for argument names.
```
