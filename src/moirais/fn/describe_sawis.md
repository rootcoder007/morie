...
`print(result)` render. See `moirais.fn.describe('sawis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawis import *
import numpy as np
# See the function signature in fn/sawis.py for argument names.
```
