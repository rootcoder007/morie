# describe('cvxprl') — boyd_perspective
...
`print(result)` render. See `moirais.fn.describe('cvxprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxprl import *
import numpy as np
# See the function signature in fn/cvxprl.py for argument names.
```
