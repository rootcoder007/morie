...
`print(result)` render. See `moirais.fn.describe('gdinm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdinm import *
import numpy as np
# See the function signature in fn/gdinm.py for argument names.
```
