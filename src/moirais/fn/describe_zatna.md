# describe('zatna') — palindrome_detect
...
`print(result)` render. See `moirais.fn.describe('zatna')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zatna import *
import numpy as np
# See the function signature in fn/zatna.py for argument names.
```
