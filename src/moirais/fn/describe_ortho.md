# describe('ortho') — orthogonal_score
...
`print(result)` render. See `moirais.fn.describe('ortho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ortho import *
import numpy as np
# See the function signature in fn/ortho.py for argument names.
```
