...
`print(result)` render. See `moirais.fn.describe('bysop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bysop import *
import numpy as np
# See the function signature in fn/bysop.py for argument names.
```
