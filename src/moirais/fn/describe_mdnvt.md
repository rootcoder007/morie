...
`print(result)` render. See `moirais.fn.describe('mdnvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdnvt import *
import numpy as np
# See the function signature in fn/mdnvt.py for argument names.
```
