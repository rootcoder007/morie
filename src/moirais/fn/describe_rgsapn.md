# describe('rgsapn') — rangayyan_sleep_apnea
...
`print(result)` render. See `moirais.fn.describe('rgsapn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsapn import *
import numpy as np
# See the function signature in fn/rgsapn.py for argument names.
```
