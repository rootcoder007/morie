# describe('gb35mv') — gibbons_rvn_moments
...
`print(result)` render. See `moirais.fn.describe('gb35mv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb35mv import *
import numpy as np
# See the function signature in fn/gb35mv.py for argument names.
```
