...
`print(result)` render. See `moirais.fn.describe('srhm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srhm2 import *
import numpy as np
# See the function signature in fn/srhm2.py for argument names.
```
