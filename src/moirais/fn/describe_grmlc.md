# describe('grmlc') — geron_classification_mlp_output
...
`print(result)` render. See `moirais.fn.describe('grmlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmlc import *
import numpy as np
# See the function signature in fn/grmlc.py for argument names.
```
