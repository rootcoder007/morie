...
`print(result)` render. See `moirais.fn.describe('igrav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igrav import *
import numpy as np
# See the function signature in fn/igrav.py for argument names.
```
