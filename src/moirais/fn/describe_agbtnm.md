# describe('agbtnm') — alphazero_batch_norm
...
`print(result)` render. See `moirais.fn.describe('agbtnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbtnm import *
import numpy as np
# See the function signature in fn/agbtnm.py for argument names.
```
