...
__all__ = ["hedderich_chapter_9_unnumbered_24"]


def hedderich_chapter_9_unnumbered_24(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Examples: 2 + 3·8 = 2 + 24 = 26
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u24')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u24: GeneralStatistics expression (auto-extracted; see ref)."
