# describe('gb332') — gibbons_type1_run_lengths
...
`print(result)` render. See `moirais.fn.describe('gb332')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb332 import *
import numpy as np
# See the function signature in fn/gb332.py for argument names.
```
