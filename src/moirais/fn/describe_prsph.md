...
`print(result)` render. See `moirais.fn.describe('prsph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsph import *
import numpy as np
# See the function signature in fn/prsph.py for argument names.
```
