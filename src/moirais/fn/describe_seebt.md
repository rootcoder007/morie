...
`print(result)` render. See `moirais.fn.describe('seebt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seebt import *
import numpy as np
# See the function signature in fn/seebt.py for argument names.
```
