# describe('rghrvmod') — rangayyan_hrv_ar_model
...
`print(result)` render. See `moirais.fn.describe('rghrvmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrvmod import *
import numpy as np
# See the function signature in fn/rghrvmod.py for argument names.
```
