...
`print(result)` render. See `moirais.fn.describe('csdmv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdmv import *
import numpy as np
# See the function signature in fn/csdmv.py for argument names.
```
