...
`print(result)` render. See `moirais.fn.describe('advinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.advinf import *
import numpy as np
# See the function signature in fn/advinf.py for argument names.
```
