...
__all__ = ["hedderich_chapter_9_unnumbered_1145"]


def hedderich_chapter_9_unnumbered_1145(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺exactlyk = 20 sick people (cases) could be recorded (n = 100 + 20 = 120 ). The estimate
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1145')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1145: GeneralStatistics expression (auto-extracted; see ref)."
