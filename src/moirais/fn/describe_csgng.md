...
`print(result)` render. See `moirais.fn.describe('csgng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csgng import *
import numpy as np
# See the function signature in fn/csgng.py for argument names.
```
