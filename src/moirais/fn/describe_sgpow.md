# describe('sgpow') — power_variogram
...
`print(result)` render. See `moirais.fn.describe('sgpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpow import *
import numpy as np
# See the function signature in fn/sgpow.py for argument names.
```
