...
__all__ = ["bivand2013_chapter_7_unnumbered_285"]


def bivand2013_chapter_7_unnumbered_285(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + }, phi = phi), style = "C")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u285')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u285: GeneralStatistics expression (auto-extracted; see ref)."
