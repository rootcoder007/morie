...
`print(result)` render. See `moirais.fn.describe('trmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmod import *
import numpy as np
# See the function signature in fn/trmod.py for argument names.
```
