...
__all__ = ["hedderich_chapter_9_unnumbered_1895"]


def hedderich_chapter_9_unnumbered_1895(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pos = signs [ signs > 0 ] ; neg = signs [ signs <0]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1895')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1895: GeneralStatistics expression (auto-extracted; see ref)."
