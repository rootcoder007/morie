# describe('hajek') — cheatsheet

## WHAT IT DOES

Hajek estimator for population mean. 'Real knowledge is to know the extent of one's ignorance. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('hajek')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hajek import *
import numpy as np
# See the function signature in fn/hajek.py for argument names.
```
