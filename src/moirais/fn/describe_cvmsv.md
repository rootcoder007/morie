# describe('cvmsv') — cramer_von_mises
...
`print(result)` render. See `moirais.fn.describe('cvmsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvmsv import *
import numpy as np
# See the function signature in fn/cvmsv.py for argument names.
```
