# describe('mrvsn') — granger_causality
...
`print(result)` render. See `moirais.fn.describe('mrvsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrvsn import *
import numpy as np
# See the function signature in fn/mrvsn.py for argument names.
```
