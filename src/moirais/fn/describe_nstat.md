# describe('nstat') — nonstationary_covariance
...
`print(result)` render. See `moirais.fn.describe('nstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nstat import *
import numpy as np
# See the function signature in fn/nstat.py for argument names.
```
