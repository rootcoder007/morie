...
__all__ = ["wilcox_chapter_4_unnumbered_195"]


def wilcox_chapter_4_unnumbered_195(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (T ≥ c) = 1 − P (T ≤ c), (4.7)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u195')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u195: GeneralStatistics expression (auto-extracted; see ref)."
