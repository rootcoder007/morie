...
`print(result)` render. See `moirais.fn.describe('ghgrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghgrv import *
import numpy as np
# See the function signature in fn/ghgrv.py for argument names.
```
