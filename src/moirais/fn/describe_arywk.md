# describe('arywk') — ar_yule_walker_fn
...
`print(result)` render. See `moirais.fn.describe('arywk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arywk import *
import numpy as np
# See the function signature in fn/arywk.py for argument names.
```
