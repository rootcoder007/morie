# describe('rgpowerl') — rangayyan_powerline_removal
...
`print(result)` render. See `moirais.fn.describe('rgpowerl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpowerl import *
import numpy as np
# See the function signature in fn/rgpowerl.py for argument names.
```
