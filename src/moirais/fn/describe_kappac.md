...
`print(result)` render. See `moirais.fn.describe('kappac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kappac import *
import numpy as np
# See the function signature in fn/kappac.py for argument names.
```
