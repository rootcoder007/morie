...
`print(result)` render. See `moirais.fn.describe('plwgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plwgn import *
import numpy as np
# See the function signature in fn/plwgn.py for argument names.
```
