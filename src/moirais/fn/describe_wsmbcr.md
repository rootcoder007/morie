# describe('wsmbcr') — wasserman_credible_interval
...
`print(result)` render. See `moirais.fn.describe('wsmbcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbcr import *
import numpy as np
# See the function signature in fn/wsmbcr.py for argument names.
```
