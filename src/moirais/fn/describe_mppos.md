...
`print(result)` render. See `moirais.fn.describe('mppos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mppos import *
import numpy as np
# See the function signature in fn/mppos.py for argument names.
```
