...
__all__ = ["hedderich_chapter_9_unnumbered_1814"]


def hedderich_chapter_9_unnumbered_1814(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: s ·√n< −tn−1;1−α to the left of−ˆt
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1814')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1814: GeneralStatistics expression (auto-extracted; see ref)."
