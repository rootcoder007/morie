# describe('diffsm') — diffusion_score_matching
...
`print(result)` render. See `moirais.fn.describe('diffsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffsm import *
import numpy as np
# See the function signature in fn/diffsm.py for argument names.
```
