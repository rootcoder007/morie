...
`print(result)` render. See `moirais.fn.describe('nmwno')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwno import *
import numpy as np
# See the function signature in fn/nmwno.py for argument names.
```
