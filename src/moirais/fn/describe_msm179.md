# describe('msm179') — mvsml_ridge_lasso_elastic_eq_9_6
...
`print(result)` render. See `moirais.fn.describe('msm179')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm179 import *
import numpy as np
# See the function signature in fn/msm179.py for argument names.
```
