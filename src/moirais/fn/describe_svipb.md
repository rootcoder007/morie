# describe('svipb') — ideal_point_bayes
...
`print(result)` render. See `moirais.fn.describe('svipb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svipb import *
import numpy as np
# See the function signature in fn/svipb.py for argument names.
```
