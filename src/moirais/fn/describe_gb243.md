# describe('gb243') — gibbons_order_beta
...
`print(result)` render. See `moirais.fn.describe('gb243')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb243 import *
import numpy as np
# See the function signature in fn/gb243.py for argument names.
```
