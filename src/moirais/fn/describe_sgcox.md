...
`print(result)` render. See `moirais.fn.describe('sgcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcox import *
import numpy as np
# See the function signature in fn/sgcox.py for argument names.
```
