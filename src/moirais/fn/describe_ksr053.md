# describe('ksr053') — kosorok_ch2_kaplan_meier_inverse
...
`print(result)` render. See `moirais.fn.describe('ksr053')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr053 import *
import numpy as np
# See the function signature in fn/ksr053.py for argument names.
```
