...
`print(result)` render. See `moirais.fn.describe('vmnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmnst import *
import numpy as np
# See the function signature in fn/vmnst.py for argument names.
```
