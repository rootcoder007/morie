# describe('wsmasm') — wasserman_mle_asymptotic
...
`print(result)` render. See `moirais.fn.describe('wsmasm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmasm import *
import numpy as np
# See the function signature in fn/wsmasm.py for argument names.
```
