# describe('vface') — validity_face_content
...
`print(result)` render. See `moirais.fn.describe('vface')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vface import *
import numpy as np
# See the function signature in fn/vface.py for argument names.
```
