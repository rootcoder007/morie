...
`print(result)` render. See `moirais.fn.describe('adgrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adgrad import *
import numpy as np
# See the function signature in fn/adgrad.py for argument names.
```
