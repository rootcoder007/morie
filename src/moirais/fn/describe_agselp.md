# describe('agselp') — alphazero_self_play_eval
...
`print(result)` render. See `moirais.fn.describe('agselp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agselp import *
import numpy as np
# See the function signature in fn/agselp.py for argument names.
```
