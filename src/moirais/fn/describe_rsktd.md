...
`print(result)` render. See `moirais.fn.describe('rsktd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsktd import *
import numpy as np
# See the function signature in fn/rsktd.py for argument names.
```
