# describe('insft') — instantaneous_freq
...
`print(result)` render. See `moirais.fn.describe('insft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.insft import *
import numpy as np
# See the function signature in fn/insft.py for argument names.
```
