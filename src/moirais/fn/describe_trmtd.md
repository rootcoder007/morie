...
`print(result)` render. See `moirais.fn.describe('trmtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmtd import *
import numpy as np
# See the function signature in fn/trmtd.py for argument names.
```
