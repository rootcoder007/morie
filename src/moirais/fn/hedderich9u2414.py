...
__all__ = ["hedderich_chapter_9_unnumbered_2414"]


def hedderich_chapter_9_unnumbered_2414(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: α = 0.05 two-sided (α = 0.025 one-sided)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2414')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2414: GeneralStatistics expression (auto-extracted; see ref)."
