# describe('infgnt') — information_geometry
...
`print(result)` render. See `moirais.fn.describe('infgnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infgnt import *
import numpy as np
# See the function signature in fn/infgnt.py for argument names.
```
