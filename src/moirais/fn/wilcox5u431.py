...
__all__ = ["wilcox_chapter_5_unnumbered_431"]


def wilcox_chapter_5_unnumbered_431(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: or the aggression data, ¯X = 28.5 and sx = 27.45. The first entry in Table 6.3 has X1 = 3,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u431')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u431: GeneralStatistics expression (auto-extracted; see ref)."
