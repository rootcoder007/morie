...
__all__ = ["bivand2013_chapter_7_unnumbered_204"]


def bivand2013_chapter_7_unnumbered_204(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: BP = 9.214, df = 3, p-value = 0.02658
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u204')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u204: GeneralStatistics expression (auto-extracted; see ref)."
