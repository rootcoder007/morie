# describe('swinmw') — swin_msa_window
...
`print(result)` render. See `moirais.fn.describe('swinmw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swinmw import *
import numpy as np
# See the function signature in fn/swinmw.py for argument names.
```
