...
`print(result)` render. See `moirais.fn.describe('zxclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxclr import *
import numpy as np
# See the function signature in fn/zxclr.py for argument names.
```
