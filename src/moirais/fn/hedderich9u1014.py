...
__all__ = ["hedderich_chapter_9_unnumbered_1014"]


def hedderich_chapter_9_unnumbered_1014(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =−0.105 + 0.523·0.054 =−0.0767
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1014')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1014: GeneralStatistics expression (auto-extracted; see ref)."
