# describe('rgsavg') — rangayyan_sync_average
...
`print(result)` render. See `moirais.fn.describe('rgsavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsavg import *
import numpy as np
# See the function signature in fn/rgsavg.py for argument names.
```
