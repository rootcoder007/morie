# describe('cstlk') — custody_lockdown_freq
...
`print(result)` render. See `moirais.fn.describe('cstlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstlk import *
import numpy as np
# See the function signature in fn/cstlk.py for argument names.
```
