...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_11(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fert_long_sub$country[fert_long_sub$country ==
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('When I let go of what I am, I become what I might be. — Lao Tzu')`` for the full guide.
