# describe('afslm') — afslm

## WHAT IT DOES

Soil moisture spatial
...
`print(result)` render. See `moirais.fn.describe('afslm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslm import *
import numpy as np
# See the function signature in fn/afslm.py for argument names.
```
