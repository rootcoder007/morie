# describe('manfd') — manifold_functional
...
`print(result)` render. See `moirais.fn.describe('manfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.manfd import *
import numpy as np
# See the function signature in fn/manfd.py for argument names.
```
