...
`print(result)` render. See `moirais.fn.describe('msrsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msrsq import *
import numpy as np
# See the function signature in fn/msrsq.py for argument names.
```
