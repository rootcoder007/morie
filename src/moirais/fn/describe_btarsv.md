...
`print(result)` render. See `moirais.fn.describe('btarsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btarsv import *
import numpy as np
# See the function signature in fn/btarsv.py for argument names.
```
