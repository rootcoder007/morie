# describe('msm173') — mvsml_ridge_lasso_elastic_eq_9_5
...
`print(result)` render. See `moirais.fn.describe('msm173')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm173 import *
import numpy as np
# See the function signature in fn/msm173.py for argument names.
```
