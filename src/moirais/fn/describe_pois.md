# describe('pois') — poisson_regression
...
`print(result)` render. See `moirais.fn.describe('pois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pois import *
import numpy as np
# See the function signature in fn/pois.py for argument names.
```
