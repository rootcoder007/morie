...
`print(result)` render. See `moirais.fn.describe('rsrei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsrei import *
import numpy as np
# See the function signature in fn/rsrei.py for argument names.
```
