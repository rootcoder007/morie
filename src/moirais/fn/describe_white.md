...
`print(result)` render. See `moirais.fn.describe('white')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.white import *
import numpy as np
# See the function signature in fn/white.py for argument names.
```
