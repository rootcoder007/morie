# describe('stngrd') — stn_spatial_transform
...
`print(result)` render. See `moirais.fn.describe('stngrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stngrd import *
import numpy as np
# See the function signature in fn/stngrd.py for argument names.
```
