...
`print(result)` render. See `moirais.fn.describe('elprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elprm import *
import numpy as np
# See the function signature in fn/elprm.py for argument names.
```
