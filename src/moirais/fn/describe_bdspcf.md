# describe('bdspcf') — bound_specification
...
`print(result)` render. See `moirais.fn.describe('bdspcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdspcf import *
import numpy as np
# See the function signature in fn/bdspcf.py for argument names.
```
