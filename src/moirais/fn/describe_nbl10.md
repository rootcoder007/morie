...
`print(result)` render. See `moirais.fn.describe('nbl10')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbl10 import *
import numpy as np
# See the function signature in fn/nbl10.py for argument names.
```
