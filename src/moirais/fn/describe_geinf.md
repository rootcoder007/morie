...
`print(result)` render. See `moirais.fn.describe('geinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geinf import *
import numpy as np
# See the function signature in fn/geinf.py for argument names.
```
