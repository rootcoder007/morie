# describe('hmmsec') — geron_linreg_mse_cost
...
`print(result)` render. See `moirais.fn.describe('hmmsec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmsec import *
import numpy as np
# See the function signature in fn/hmmsec.py for argument names.
```
