# describe('km090') — kamath_ch6_co_occurrence_bias
...
`print(result)` render. See `moirais.fn.describe('km090')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km090 import *
import numpy as np
# See the function signature in fn/km090.py for argument names.
```
