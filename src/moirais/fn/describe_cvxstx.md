# describe('cvxstx') — boyd_strict_convex
...
`print(result)` render. See `moirais.fn.describe('cvxstx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxstx import *
import numpy as np
# See the function signature in fn/cvxstx.py for argument names.
```
