...
`print(result)` render. See `moirais.fn.describe('covrat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covrat import *
import numpy as np
# See the function signature in fn/covrat.py for argument names.
```
