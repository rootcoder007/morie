...
__all__ = ["hedderich_chapter_9_unnumbered_1878"]


def hedderich_chapter_9_unnumbered_1878(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆr≤ru;α/2 or ˆr≥ro;α/2 or ˆz≥z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1878')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1878: GeneralStatistics expression (auto-extracted; see ref)."
