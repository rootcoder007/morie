...
`print(result)` render. See `moirais.fn.describe('comgir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comgir import *
import numpy as np
# See the function signature in fn/comgir.py for argument names.
```
