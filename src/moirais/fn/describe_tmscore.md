...
`print(result)` render. See `moirais.fn.describe('tmscore')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmscore import *
import numpy as np
# See the function signature in fn/tmscore.py for argument names.
```
