...
__all__ = ["hedderich_chapter_9_unnumbered_2594"]


def hedderich_chapter_9_unnumbered_2594(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For the test of the null hypothesis:π1−π2 =d0 againstHA:π1−π2̸=d0 (or<d 0 or>d 0) use
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2594')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2594: GeneralStatistics expression (auto-extracted; see ref)."
