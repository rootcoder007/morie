...
`print(result)` render. See `moirais.fn.describe('fbmsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fbmsi import *
import numpy as np
# See the function signature in fn/fbmsi.py for argument names.
```
