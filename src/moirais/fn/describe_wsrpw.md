...
`print(result)` render. See `moirais.fn.describe('wsrpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsrpw import *
import numpy as np
# See the function signature in fn/wsrpw.py for argument names.
```
