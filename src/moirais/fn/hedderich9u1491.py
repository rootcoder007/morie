...
__all__ = ["hedderich_chapter_9_unnumbered_1491"]


def hedderich_chapter_9_unnumbered_1491(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: QM S + (k−1)F1−α/2,ν1,ν2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1491')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1491: PowerAndDesign expression (auto-extracted; see ref)."
