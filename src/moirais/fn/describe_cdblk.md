...
`print(result)` render. See `moirais.fn.describe('cdblk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdblk import *
import numpy as np
# See the function signature in fn/cdblk.py for argument names.
```
