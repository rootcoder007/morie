# describe('gb1321') — gibbons_are_def
...
`print(result)` render. See `moirais.fn.describe('gb1321')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1321 import *
import numpy as np
# See the function signature in fn/gb1321.py for argument names.
```
