...
`print(result)` render. See `moirais.fn.describe('hygrw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hygrw import *
import numpy as np
# See the function signature in fn/hygrw.py for argument names.
```
