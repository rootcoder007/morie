...
`print(result)` render. See `moirais.fn.describe('rfnst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfnst import *
import numpy as np
# See the function signature in fn/rfnst.py for argument names.
```
