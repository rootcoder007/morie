...
`print(result)` render. See `moirais.fn.describe('sgtnsne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtnsne import *
import numpy as np
# See the function signature in fn/sgtnsne.py for argument names.
```
