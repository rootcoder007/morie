...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_5(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The same general format applies to the two types of LaTeX chunks. In Sweavestyle chunks, we type: <<ex-label>>=. Try not to use spaces or periods in
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('Look well into thyself; there is a source which will always spring up. — Marcus Aurelius')`` for the full guide.
