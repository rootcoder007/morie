# describe('btsca') — bootstrap_scaling_se
...
`print(result)` render. See `moirais.fn.describe('btsca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsca import *
import numpy as np
# See the function signature in fn/btsca.py for argument names.
```
