...
`print(result)` render. See `moirais.fn.describe('krgnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krgnb import *
import numpy as np
# See the function signature in fn/krgnb.py for argument names.
```
