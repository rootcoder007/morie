# describe('gatep') — gate_estimation
...
`print(result)` render. See `moirais.fn.describe('gatep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatep import *
import numpy as np
# See the function signature in fn/gatep.py for argument names.
```
