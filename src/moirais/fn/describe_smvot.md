# describe('smvot') — simulate_voting_spatial
...
`print(result)` render. See `moirais.fn.describe('smvot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smvot import *
import numpy as np
# See the function signature in fn/smvot.py for argument names.
```
