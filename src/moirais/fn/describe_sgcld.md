# describe('sgcld') — variogram_cloud
...
`print(result)` render. See `moirais.fn.describe('sgcld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcld import *
import numpy as np
# See the function signature in fn/sgcld.py for argument names.
```
