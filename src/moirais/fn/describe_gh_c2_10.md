# describe('gh_c2_10') — ghosal_np_poisson_reg
...
`print(result)` render. See `moirais.fn.describe('gh_c2_10')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c2_10 import *
import numpy as np
# See the function signature in fn/gh_c2_10.py for argument names.
```
