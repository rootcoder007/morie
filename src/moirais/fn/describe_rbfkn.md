...
`print(result)` render. See `moirais.fn.describe('rbfkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfkn import *
import numpy as np
# See the function signature in fn/rbfkn.py for argument names.
```
