# describe('hrzhot') — horowitz_T_F_estimators
...
`print(result)` render. See `moirais.fn.describe('hrzhot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzhot import *
import numpy as np
# See the function signature in fn/hrzhot.py for argument names.
```
