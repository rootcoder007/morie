...
`print(result)` render. See `moirais.fn.describe('hmmlpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmlpf import *
import numpy as np
# See the function signature in fn/hmmlpf.py for argument names.
```
