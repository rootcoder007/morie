# describe('rgneural') — rangayyan_neural_decode
...
`print(result)` render. See `moirais.fn.describe('rgneural')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgneural import *
import numpy as np
# See the function signature in fn/rgneural.py for argument names.
```
