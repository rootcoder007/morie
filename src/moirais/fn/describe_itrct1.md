# describe('itrct1') — interaction_did
...
`print(result)` render. See `moirais.fn.describe('itrct1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itrct1 import *
import numpy as np
# See the function signature in fn/itrct1.py for argument names.
```
