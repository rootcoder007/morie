# describe('tukeyw') — tukey_biweight
...
`print(result)` render. See `moirais.fn.describe('tukeyw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tukeyw import *
import numpy as np
# See the function signature in fn/tukeyw.py for argument names.
```
