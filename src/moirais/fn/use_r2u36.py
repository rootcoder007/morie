...
__all__ = ["use_r_chapter_2_unnumbered_36"]


def use_r_chapter_2_unnumbered_36(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: projection +proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('use_r2u36')`` for the full guide.
...
def cheatsheet():
    return "use_r2u36: GeneralStatistics expression (auto-extracted; see ref)."
