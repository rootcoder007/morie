# describe('ghcrt') — ghosal_contraction_rate
...
`print(result)` render. See `moirais.fn.describe('ghcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcrt import *
import numpy as np
# See the function signature in fn/ghcrt.py for argument names.
```
