# describe('kfcve') — k_fold_cv_error
...
`print(result)` render. See `moirais.fn.describe('kfcve')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kfcve import *
import numpy as np
# See the function signature in fn/kfcve.py for argument names.
```
