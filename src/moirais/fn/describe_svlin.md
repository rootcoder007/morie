...
`print(result)` render. See `moirais.fn.describe('svlin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svlin import *
import numpy as np
# See the function signature in fn/svlin.py for argument names.
```
