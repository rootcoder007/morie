...
`print(result)` render. See `moirais.fn.describe('moelyr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.moelyr import *
import numpy as np
# See the function signature in fn/moelyr.py for argument names.
```
