# describe('pposc') — posterior_predictive_check
...
`print(result)` render. See `moirais.fn.describe('pposc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pposc import *
import numpy as np
# See the function signature in fn/pposc.py for argument names.
```
