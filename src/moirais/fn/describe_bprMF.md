...
`print(result)` render. See `moirais.fn.describe('bprMF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bprMF import *
import numpy as np
# See the function signature in fn/bprMF.py for argument names.
```
