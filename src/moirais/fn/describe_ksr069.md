# describe('ksr069') — kosorok_ch3_cox_likelihood_breslow
...
`print(result)` render. See `moirais.fn.describe('ksr069')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr069 import *
import numpy as np
# See the function signature in fn/ksr069.py for argument names.
```
