...
__all__ = ["wilcox_chapter_10_unnumbered_1028"]


def wilcox_chapter_10_unnumbered_1028(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: bwmcppb(J, K, x, tr = 0.2, alpha = 0.05, nboot = 500, bhop = F)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1028')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1028: GeneralStatistics expression (auto-extracted; see ref)."
