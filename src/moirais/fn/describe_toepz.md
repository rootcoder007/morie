# describe('toepz') — toeplitz_matrix
...
`print(result)` render. See `moirais.fn.describe('toepz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.toepz import *
import numpy as np
# See the function signature in fn/toepz.py for argument names.
```
