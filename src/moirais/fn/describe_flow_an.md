# describe('flow_an') — normalizing_flow_anomaly
...
`print(result)` render. See `moirais.fn.describe('flow_an')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flow_an import *
import numpy as np
# See the function signature in fn/flow_an.py for argument names.
```
