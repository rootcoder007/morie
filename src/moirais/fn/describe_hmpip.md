...
`print(result)` render. See `moirais.fn.describe('hmpip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpip import *
import numpy as np
# See the function signature in fn/hmpip.py for argument names.
```
