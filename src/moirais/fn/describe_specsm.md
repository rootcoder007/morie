# describe('specsm') — spectral_smoothed
...
`print(result)` render. See `moirais.fn.describe('specsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specsm import *
import numpy as np
# See the function signature in fn/specsm.py for argument names.
```
