...
__all__ = ["hedderich_chapter_9_unnumbered_2296"]


def hedderich_chapter_9_unnumbered_2296(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1−2α, the associated test decision on equivalence maintains the chosen significance levelα!
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2296')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2296: GeneralStatistics expression (auto-extracted; see ref)."
