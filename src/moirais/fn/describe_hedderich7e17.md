# describe('hedderich7e17') — hedderich_chapter_7_equation_17
...
import numpy as np
result = hedderich_chapter_7_equation_17(np.random.default_rng(42).normal(0, 1, 100))
