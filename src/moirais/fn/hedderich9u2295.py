...
__all__ = ["hedderich_chapter_9_unnumbered_2295"]


def hedderich_chapter_9_unnumbered_2295(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: CI2 : [−∞; ¯d +tn−1,1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2295')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2295: GeneralStatistics expression (auto-extracted; see ref)."
