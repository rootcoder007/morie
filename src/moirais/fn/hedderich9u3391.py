...
__all__ = ["hedderich_chapter_9_unnumbered_3391"]


def hedderich_chapter_9_unnumbered_3391(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: + trace = FALSE , direction =" both " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3391')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3391: ANOVA expression (auto-extracted; see ref)."
