...
__all__ = ["guide_on_data_analysis_chapter_21_unnumbered_1000"]


def guide_on_data_analysis_chapter_21_unnumbered_1000(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌𝑖|𝐼𝑖 = 1 = 𝑇𝑖𝑌𝑖(1) + (1 − 𝑇𝑖)𝑌𝑖(0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis21u1000')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis21u1000: GeneralStatistics expression (auto-extracted; see ref)."
