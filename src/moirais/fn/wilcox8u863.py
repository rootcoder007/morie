...
__all__ = ["wilcox_chapter_8_unnumbered_863"]


def wilcox_chapter_8_unnumbered_863(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 3. Let ˆθ = ( ˆθ 1,..., ˆθ L), ˆθ ∗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u863')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u863: PowerAndDesign expression (auto-extracted; see ref)."
