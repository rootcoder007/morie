...
`print(result)` render. See `moirais.fn.describe('vrfy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrfy import *
import numpy as np
# See the function signature in fn/vrfy.py for argument names.
```
