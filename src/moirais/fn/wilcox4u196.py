...
__all__ = ["wilcox_chapter_4_unnumbered_196"]


def wilcox_chapter_4_unnumbered_196(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: wherec is any constant that might be of interest. For example, with ν = 4, P (T ≤ 2.132) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u196')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u196: GeneralStatistics expression (auto-extracted; see ref)."
