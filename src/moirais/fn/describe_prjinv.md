...
`print(result)` render. See `moirais.fn.describe('prjinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prjinv import *
import numpy as np
# See the function signature in fn/prjinv.py for argument names.
```
