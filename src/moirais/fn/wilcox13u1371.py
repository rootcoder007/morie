...
__all__ = ["wilcox_chapter_13_unnumbered_1371"]


def wilcox_chapter_13_unnumbered_1371(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 11.25(0.083333) = 9 .3, ν = 48, reject. 4. W = (45 −
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1371')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1371: GeneralStatistics expression (auto-extracted; see ref)."
