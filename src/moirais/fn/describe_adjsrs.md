...
`print(result)` render. See `moirais.fn.describe('adjsrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adjsrs import *
import numpy as np
# See the function signature in fn/adjsrs.py for argument names.
```
