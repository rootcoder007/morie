...
`print(result)` render. See `moirais.fn.describe('spowr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spowr import *
import numpy as np
# See the function signature in fn/spowr.py for argument names.
```
