# describe('gh_c14_13') — ghosal_pk_levy
...
`print(result)` render. See `moirais.fn.describe('gh_c14_13')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_13 import *
import numpy as np
# See the function signature in fn/gh_c14_13.py for argument names.
```
