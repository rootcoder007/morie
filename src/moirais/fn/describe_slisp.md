...
`print(result)` render. See `moirais.fn.describe('slisp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slisp import *
import numpy as np
# See the function signature in fn/slisp.py for argument names.
```
