# describe('distq') — distributional_rl
...
`print(result)` render. See `moirais.fn.describe('distq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.distq import *
import numpy as np
# See the function signature in fn/distq.py for argument names.
```
