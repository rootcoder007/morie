# describe('logln') — loglinear_model
...
`print(result)` render. See `moirais.fn.describe('logln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.logln import *
import numpy as np
# See the function signature in fn/logln.py for argument names.
```
