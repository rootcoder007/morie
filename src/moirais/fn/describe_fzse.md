# describe('fzse') — fauzi_sign_moments
...
`print(result)` render. See `moirais.fn.describe('fzse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzse import *
import numpy as np
# See the function signature in fn/fzse.py for argument names.
```
