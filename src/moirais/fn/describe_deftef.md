...
`print(result)` render. See `moirais.fn.describe('deftef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deftef import *
import numpy as np
# See the function signature in fn/deftef.py for argument names.
```
