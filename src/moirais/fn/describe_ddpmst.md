...
`print(result)` render. See `moirais.fn.describe('ddpmst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddpmst import *
import numpy as np
# See the function signature in fn/ddpmst.py for argument names.
```
