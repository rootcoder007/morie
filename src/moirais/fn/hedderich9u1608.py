...
__all__ = ["hedderich_chapter_9_unnumbered_1608"]


def hedderich_chapter_9_unnumbered_1608(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (a) HA :µ<µ0 = 20 and H0 :µ≥µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1608')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1608: GeneralStatistics expression (auto-extracted; see ref)."
