...
`print(result)` render. See `moirais.fn.describe('brscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brscr import *
import numpy as np
# See the function signature in fn/brscr.py for argument names.
```
