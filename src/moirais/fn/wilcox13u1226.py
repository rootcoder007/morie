...
__all__ = ["wilcox_chapter_13_unnumbered_1226"]


def wilcox_chapter_13_unnumbered_1226(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Mj(x) = β 0j +β 1jx.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1226')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1226: GeneralStatistics expression (auto-extracted; see ref)."
