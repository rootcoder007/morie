# describe('adGAN') — adversarial_anomaly
...
`print(result)` render. See `moirais.fn.describe('adGAN')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adGAN import *
import numpy as np
# See the function signature in fn/adGAN.py for argument names.
```
