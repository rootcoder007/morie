...
`print(result)` render. See `moirais.fn.describe('svdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdir import *
import numpy as np
# See the function signature in fn/svdir.py for argument names.
```
