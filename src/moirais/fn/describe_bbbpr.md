# describe('bbbpr') — bbb_permeability
...
`print(result)` render. See `moirais.fn.describe('bbbpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bbbpr import *
import numpy as np
# See the function signature in fn/bbbpr.py for argument names.
```
