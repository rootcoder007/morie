# describe('abrtm') — farrington_aberration
...
`print(result)` render. See `moirais.fn.describe('abrtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abrtm import *
import numpy as np
# See the function signature in fn/abrtm.py for argument names.
```
