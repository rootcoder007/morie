...
`print(result)` render. See `moirais.fn.describe('sdemres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemres import *
import numpy as np
# See the function signature in fn/sdemres.py for argument names.
```
