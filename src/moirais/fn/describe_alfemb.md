# describe('alfemb') — alphafold_embedding_init
...
`print(result)` render. See `moirais.fn.describe('alfemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfemb import *
import numpy as np
# See the function signature in fn/alfemb.py for argument names.
```
