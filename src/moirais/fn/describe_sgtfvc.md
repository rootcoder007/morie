# describe('sgtfvc') — sgt_fiedler_vector
...
`print(result)` render. See `moirais.fn.describe('sgtfvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtfvc import *
import numpy as np
# See the function signature in fn/sgtfvc.py for argument names.
```
