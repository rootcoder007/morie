# describe('lambopt') — lamb_optimizer
...
`print(result)` render. See `moirais.fn.describe('lambopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lambopt import *
import numpy as np
# See the function signature in fn/lambopt.py for argument names.
```
