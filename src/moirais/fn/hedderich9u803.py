...
__all__ = ["hedderich_chapter_9_unnumbered_803"]


def hedderich_chapter_9_unnumbered_803(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 3. Calculate P =P (−4.00 ≦Z ≦−0.04) to 3 decimal places.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u803')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u803: GeneralStatistics expression (auto-extracted; see ref)."
