...
`print(result)` render. See `moirais.fn.describe('wqaqu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqaqu import *
import numpy as np
# See the function signature in fn/wqaqu.py for argument names.
```
