# describe('mdfrq') — median_frequency
...
`print(result)` render. See `moirais.fn.describe('mdfrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdfrq import *
import numpy as np
# See the function signature in fn/mdfrq.py for argument names.
```
