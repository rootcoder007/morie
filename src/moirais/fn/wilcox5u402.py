...
__all__ = ["wilcox_chapter_5_unnumbered_402"]


def wilcox_chapter_5_unnumbered_402(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u402')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u402: GeneralStatistics expression (auto-extracted; see ref)."
