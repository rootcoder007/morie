...
`print(result)` render. See `moirais.fn.describe('snsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snsim import *
import numpy as np
# See the function signature in fn/snsim.py for argument names.
```
