...
`print(result)` render. See `moirais.fn.describe('cscpt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cscpt2 import *
import numpy as np
# See the function signature in fn/cscpt2.py for argument names.
```
