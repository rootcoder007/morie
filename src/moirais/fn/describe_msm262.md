# describe('msm262') — mvsml_convolutional_nn_eq_14_2
...
`print(result)` render. See `moirais.fn.describe('msm262')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm262 import *
import numpy as np
# See the function signature in fn/msm262.py for argument names.
```
