...
`print(result)` render. See `moirais.fn.describe('sawdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawdl import *
import numpy as np
# See the function signature in fn/sawdl.py for argument names.
```
