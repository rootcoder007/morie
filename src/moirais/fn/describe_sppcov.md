...
`print(result)` render. See `moirais.fn.describe('sppcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppcov import *
import numpy as np
# See the function signature in fn/sppcov.py for argument names.
```
