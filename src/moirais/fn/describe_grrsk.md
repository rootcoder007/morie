# describe('grrsk') — geron_resnet_skip
...
`print(result)` render. See `moirais.fn.describe('grrsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrsk import *
import numpy as np
# See the function signature in fn/grrsk.py for argument names.
```
