...
`print(result)` render. See `moirais.fn.describe('contRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.contRC import *
import numpy as np
# See the function signature in fn/contRC.py for argument names.
```
