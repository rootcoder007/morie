# describe('convgs') — convergent_validity
...
`print(result)` render. See `moirais.fn.describe('convgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.convgs import *
import numpy as np
# See the function signature in fn/convgs.py for argument names.
```
