# describe('lcfsdq') — lc_first_sd_query
...
`print(result)` render. See `moirais.fn.describe('lcfsdq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lcfsdq import *
import numpy as np
# See the function signature in fn/lcfsdq.py for argument names.
```
