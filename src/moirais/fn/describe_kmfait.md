# describe('kmfait') — kamath_ragas_faithfulness
...
`print(result)` render. See `moirais.fn.describe('kmfait')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmfait import *
import numpy as np
# See the function signature in fn/kmfait.py for argument names.
```
