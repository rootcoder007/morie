...
__all__ = ["hedderich_chapter_9_unnumbered_1800"]


def hedderich_chapter_9_unnumbered_1800(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] L(π) = log(πx(1−π)n−x) = x log(π) + (n−x) log(1−π) (7.46)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1800')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1800: CountModels expression (auto-extracted; see ref)."
