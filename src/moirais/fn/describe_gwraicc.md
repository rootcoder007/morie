...
`print(result)` render. See `moirais.fn.describe('gwraicc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwraicc import *
import numpy as np
# See the function signature in fn/gwraicc.py for argument names.
```
