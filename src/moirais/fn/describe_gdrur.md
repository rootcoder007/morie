...
`print(result)` render. See `moirais.fn.describe('gdrur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdrur import *
import numpy as np
# See the function signature in fn/gdrur.py for argument names.
```
