# describe('dgrds') — degree_distribution
...
`print(result)` render. See `moirais.fn.describe('dgrds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dgrds import *
import numpy as np
# See the function signature in fn/dgrds.py for argument names.
```
