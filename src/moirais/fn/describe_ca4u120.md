# describe('ca4u120') — ca_chapter_4_unnumbered_120
...
```python
from moirais.fn.ca4u120 import ca_chapter_4_unnumbered_120
import numpy as np
result = ca_chapter_4_unnumbered_120(np.random.default_rng(42).normal(0, 1, 100))
