...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1187"]


def guide_on_data_analysis_chapter_24_unnumbered_1187(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ∑𝑖 ∑𝑗( ̄𝑌𝑖. − ̄𝑌..)(̄𝑌.𝑗 − ̄𝑌..)𝑌𝑖𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1187')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1187: GeneralStatistics expression (auto-extracted; see ref)."
