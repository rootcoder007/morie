# describe('mbgrd') — mini_batch_gradient
...
`print(result)` render. See `moirais.fn.describe('mbgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mbgrd import *
import numpy as np
# See the function signature in fn/mbgrd.py for argument names.
```
