...
`print(result)` render. See `moirais.fn.describe('mawav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mawav import *
import numpy as np
# See the function signature in fn/mawav.py for argument names.
```
