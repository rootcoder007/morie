...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1292"]


def guide_on_data_analysis_chapter_25_unnumbered_1292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E = M′Y′[I − X(X′X)−1X′]YM
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1292')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1292: GeneralStatistics expression (auto-extracted; see ref)."
