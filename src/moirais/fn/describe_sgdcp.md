# describe('sgdcp') — data_decomposition
...
`print(result)` render. See `moirais.fn.describe('sgdcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgdcp import *
import numpy as np
# See the function signature in fn/sgdcp.py for argument names.
```
