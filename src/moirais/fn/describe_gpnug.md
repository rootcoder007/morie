...
`print(result)` render. See `moirais.fn.describe('gpnug')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpnug import *
import numpy as np
# See the function signature in fn/gpnug.py for argument names.
```
