...
`print(result)` render. See `moirais.fn.describe('hux')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hux import *
import numpy as np
# See the function signature in fn/hux.py for argument names.
```
