# describe('b101') — burkov_lm_ch1_linear_function
...
`print(result)` render. See `moirais.fn.describe('b101')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.b101 import *
import numpy as np
# See the function signature in fn/b101.py for argument names.
```
