# describe('xenty') — xenty

## WHAT IT DOES

rCross-entropy loss (binary and multi-class).
...
`print(result)` render. See `moirais.fn.describe('xenty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xenty import *
import numpy as np
# See the function signature in fn/xenty.py for argument names.
```
