...
__all__ = ["wilcox_chapter_5_unnumbered_423"]


def wilcox_chapter_5_unnumbered_423(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: called an F distribution with ν 1 =p andν 2 =n − p − 1 degrees of freedom. That is, the null
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u423')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u423: GeneralStatistics expression (auto-extracted; see ref)."
