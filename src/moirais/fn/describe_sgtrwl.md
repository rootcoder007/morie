# describe('sgtrwl') — sgt_random_walk_laplacian
...
`print(result)` render. See `moirais.fn.describe('sgtrwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtrwl import *
import numpy as np
# See the function signature in fn/sgtrwl.py for argument names.
```
