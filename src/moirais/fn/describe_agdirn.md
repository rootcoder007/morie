# describe('agdirn') — alphazero_dirichlet_noise
...
`print(result)` render. See `moirais.fn.describe('agdirn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agdirn import *
import numpy as np
# See the function signature in fn/agdirn.py for argument names.
```
