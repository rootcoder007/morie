# describe('rcdpr') — recidivism_predictors
...
`print(result)` render. See `moirais.fn.describe('rcdpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdpr import *
import numpy as np
# See the function signature in fn/rcdpr.py for argument names.
```
