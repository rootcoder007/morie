...
`print(result)` render. See `moirais.fn.describe('sppfe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppfe import *
import numpy as np
# See the function signature in fn/sppfe.py for argument names.
```
