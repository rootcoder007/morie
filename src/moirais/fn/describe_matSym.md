# describe('matSym') — matrix_symbolic
...
`print(result)` render. See `moirais.fn.describe('matSym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matSym import *
import numpy as np
# See the function signature in fn/matSym.py for argument names.
```
