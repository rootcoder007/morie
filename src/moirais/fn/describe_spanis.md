# describe('spanis') — schabenberger_geometric_anisotropy
...
`print(result)` render. See `moirais.fn.describe('spanis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spanis import *
import numpy as np
# See the function signature in fn/spanis.py for argument names.
```
