# describe('gh_ap_b2') — ghosal_kl_variation
...
`print(result)` render. See `moirais.fn.describe('gh_ap_b2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_b2 import *
import numpy as np
# See the function signature in fn/gh_ap_b2.py for argument names.
```
