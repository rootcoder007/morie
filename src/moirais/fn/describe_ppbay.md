...
`print(result)` render. See `moirais.fn.describe('ppbay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppbay import *
import numpy as np
# See the function signature in fn/ppbay.py for argument names.
```
