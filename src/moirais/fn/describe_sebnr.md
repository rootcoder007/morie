...
`print(result)` render. See `moirais.fn.describe('sebnr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebnr import *
import numpy as np
# See the function signature in fn/sebnr.py for argument names.
```
