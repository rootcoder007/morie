...
__all__ = ["hedderich_chapter_9_unnumbered_1070"]


def hedderich_chapter_9_unnumbered_1070(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] holds: Var(S) =E(S2)−[E(S)]2>0 i.e. [E(S)]2<E(S2)=σ2 and E(S)<σ.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1070')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1070: GeneralStatistics expression (auto-extracted; see ref)."
