# describe('eslthl') — esl_thin_plate_spline
...
`print(result)` render. See `moirais.fn.describe('eslthl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslthl import *
import numpy as np
# See the function signature in fn/eslthl.py for argument names.
```
