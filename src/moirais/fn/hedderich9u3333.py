...
__all__ = ["hedderich_chapter_9_unnumbered_3333"]


def hedderich_chapter_9_unnumbered_3333(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆη= 1/5(ˆµ1. + ˆµ2. + ˆµ3. + ˆµ.1 + ˆµ.2) = 12.624
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3333')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3333: GeneralStatistics expression (auto-extracted; see ref)."
