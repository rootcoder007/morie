...
`print(result)` render. See `moirais.fn.describe('mttrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mttrs import *
import numpy as np
# See the function signature in fn/mttrs.py for argument names.
```
