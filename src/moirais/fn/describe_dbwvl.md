# describe('dbwvl') — daubechies_wavelet
...
`print(result)` render. See `moirais.fn.describe('dbwvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbwvl import *
import numpy as np
# See the function signature in fn/dbwvl.py for argument names.
```
