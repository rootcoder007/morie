...
__all__ = ["hedderich_chapter_9_unnumbered_1062"]


def hedderich_chapter_9_unnumbered_1062(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: n/N = 0,15) is to be obtained from a group ofN =800 people, i.e.n = 0,15·800 = 120 , then
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1062')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1062: GeneralStatistics expression (auto-extracted; see ref)."
