...
`print(result)` render. See `moirais.fn.describe('cssfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cssfd import *
import numpy as np
# See the function signature in fn/cssfd.py for argument names.
```
