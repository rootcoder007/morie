...
def ca_chapter_6_unnumbered_190(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca6u190')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'expressed' (auto-extracted; see reference for full context)."},
    )
