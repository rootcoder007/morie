...
__all__ = ["hedderich_chapter_9_unnumbered_2023"]


def hedderich_chapter_9_unnumbered_2023(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] i=1(n1i +n2i−2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2023')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2023: GeneralStatistics expression (auto-extracted; see ref)."
