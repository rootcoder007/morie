...
`print(result)` render. See `moirais.fn.describe('binom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.binom import *
import numpy as np
# See the function signature in fn/binom.py for argument names.
```
