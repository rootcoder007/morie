...
`print(result)` render. See `moirais.fn.describe('srbnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbnb import *
import numpy as np
# See the function signature in fn/srbnb.py for argument names.
```
