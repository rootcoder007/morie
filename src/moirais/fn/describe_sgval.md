...
`print(result)` render. See `moirais.fn.describe('sgval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgval import *
import numpy as np
# See the function signature in fn/sgval.py for argument names.
```
