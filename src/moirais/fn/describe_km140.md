# describe('km140') — kamath_ch9_moc_loss
...
`print(result)` render. See `moirais.fn.describe('km140')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km140 import *
import numpy as np
# See the function signature in fn/km140.py for argument names.
```
