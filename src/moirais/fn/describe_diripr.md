# describe('diripr') — dirichlet_multinomial
...
`print(result)` render. See `moirais.fn.describe('diripr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diripr import *
import numpy as np
# See the function signature in fn/diripr.py for argument names.
```
