# describe('gb1323') — gibbons_are_twosided
...
`print(result)` render. See `moirais.fn.describe('gb1323')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1323 import *
import numpy as np
# See the function signature in fn/gb1323.py for argument names.
```
