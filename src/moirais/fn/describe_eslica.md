...
`print(result)` render. See `moirais.fn.describe('eslica')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslica import *
import numpy as np
# See the function signature in fn/eslica.py for argument names.
```
