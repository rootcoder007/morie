...
`print(result)` render. See `moirais.fn.describe('swbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swbin import *
import numpy as np
# See the function signature in fn/swbin.py for argument names.
```
