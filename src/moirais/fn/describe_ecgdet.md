...
`print(result)` render. See `moirais.fn.describe('ecgdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecgdet import *
import numpy as np
# See the function signature in fn/ecgdet.py for argument names.
```
