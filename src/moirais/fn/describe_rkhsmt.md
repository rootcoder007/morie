# describe('rkhsmt') — rkhs_multitrait
...
`print(result)` render. See `moirais.fn.describe('rkhsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkhsmt import *
import numpy as np
# See the function signature in fn/rkhsmt.py for argument names.
```
