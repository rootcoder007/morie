...
__all__ = ["hedderich_chapter_9_unnumbered_2958"]


def hedderich_chapter_9_unnumbered_2958(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: order of tea preparation based on taste (Y = 1 tea first,Y = 2 milk first), whether tea (X = 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2958')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2958: GeneralStatistics expression (auto-extracted; see ref)."
