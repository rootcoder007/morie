# describe('dnpos') — density_positive_weights
...
`print(result)` render. See `moirais.fn.describe('dnpos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnpos import *
import numpy as np
# See the function signature in fn/dnpos.py for argument names.
```
