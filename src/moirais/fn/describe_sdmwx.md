...
`print(result)` render. See `moirais.fn.describe('sdmwx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmwx import *
import numpy as np
# See the function signature in fn/sdmwx.py for argument names.
```
