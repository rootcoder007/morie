...
__all__ = ["hedderich_chapter_9_unnumbered_2227"]


def hedderich_chapter_9_unnumbered_2227(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: count 1 = 5 , expectedcount 1 = 11 , p− value = 0 . 0 1 6 9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2227')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2227: CountModels expression (auto-extracted; see ref)."
