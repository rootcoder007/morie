# describe('rtest') — retest_reliability
...
`print(result)` render. See `moirais.fn.describe('rtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtest import *
import numpy as np
# See the function signature in fn/rtest.py for argument names.
```
