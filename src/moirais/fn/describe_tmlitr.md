# describe('tmlitr') — tmle_individual_regime
...
`print(result)` render. See `moirais.fn.describe('tmlitr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlitr import *
import numpy as np
# See the function signature in fn/tmlitr.py for argument names.
```
