# describe('teagr') — teager_energy_fn
...
`print(result)` render. See `moirais.fn.describe('teagr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.teagr import *
import numpy as np
# See the function signature in fn/teagr.py for argument names.
```
