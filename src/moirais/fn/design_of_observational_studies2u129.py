...
__all__ = ["design_of_observational_studies_chapter_2_unnumbered_129"]


def design_of_observational_studies_chapter_2_unnumbered_129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('design_of_observational_studies2u129')`` for the full guide.
...
def cheatsheet():
    return "design_of_observational_studies2u129: GeneralStatistics expression (auto-extracted; see ref)."
