...
`print(result)` render. See `moirais.fn.describe('rssmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rssmc import *
import numpy as np
# See the function signature in fn/rssmc.py for argument names.
```
