# describe('wvent') — wavelet_entropy
...
`print(result)` render. See `moirais.fn.describe('wvent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvent import *
import numpy as np
# See the function signature in fn/wvent.py for argument names.
```
