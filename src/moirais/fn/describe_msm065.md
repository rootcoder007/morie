# describe('msm065') — mvsml_bayesian_regression_eq_6_8
...
`print(result)` render. See `moirais.fn.describe('msm065')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm065 import *
import numpy as np
# See the function signature in fn/msm065.py for argument names.
```
