...
`print(result)` render. See `moirais.fn.describe('wvenr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvenr import *
import numpy as np
# See the function signature in fn/wvenr.py for argument names.
```
