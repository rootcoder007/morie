...
`print(result)` render. See `moirais.fn.describe('tssgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssgn import *
import numpy as np
# See the function signature in fn/tssgn.py for argument names.
```
