# describe('msm061') — mvsml_bayesian_regression_eq_6_6
...
`print(result)` render. See `moirais.fn.describe('msm061')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm061 import *
import numpy as np
# See the function signature in fn/msm061.py for argument names.
```
