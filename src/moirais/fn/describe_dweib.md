...
`print(result)` render. See `moirais.fn.describe('dweib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dweib import *
import numpy as np
# See the function signature in fn/dweib.py for argument names.
```
