...
`print(result)` render. See `moirais.fn.describe('kscvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kscvs import *
import numpy as np
# See the function signature in fn/kscvs.py for argument names.
```
