# describe('ghbvm') — ghosal_bernstein_von_mises
...
`print(result)` render. See `moirais.fn.describe('ghbvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghbvm import *
import numpy as np
# See the function signature in fn/ghbvm.py for argument names.
```
