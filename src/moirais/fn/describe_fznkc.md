# describe('fznkc') — fauzi_naive_kernel_cvm
...
`print(result)` render. See `moirais.fn.describe('fznkc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fznkc import *
import numpy as np
# See the function signature in fn/fznkc.py for argument names.
```
