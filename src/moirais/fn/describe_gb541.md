# describe('gb541') — gibbons_sign_test
...
`print(result)` render. See `moirais.fn.describe('gb541')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb541 import *
import numpy as np
# See the function signature in fn/gb541.py for argument names.
```
