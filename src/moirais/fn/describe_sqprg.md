...
`print(result)` render. See `moirais.fn.describe('sqprg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqprg import *
import numpy as np
# See the function signature in fn/sqprg.py for argument names.
```
