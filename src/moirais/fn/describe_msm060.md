# describe('msm060') — mvsml_bayesian_regression_eq_6_1
...
`print(result)` render. See `moirais.fn.describe('msm060')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm060 import *
import numpy as np
# See the function signature in fn/msm060.py for argument names.
```
