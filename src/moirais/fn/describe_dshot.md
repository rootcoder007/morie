...
`print(result)` render. See `moirais.fn.describe('dshot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dshot import *
import numpy as np
# See the function signature in fn/dshot.py for argument names.
```
