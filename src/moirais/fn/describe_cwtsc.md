...
`print(result)` render. See `moirais.fn.describe('cwtsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cwtsc import *
import numpy as np
# See the function signature in fn/cwtsc.py for argument names.
```
