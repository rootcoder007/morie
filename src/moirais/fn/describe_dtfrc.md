...
`print(result)` render. See `moirais.fn.describe('dtfrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtfrc import *
import numpy as np
# See the function signature in fn/dtfrc.py for argument names.
```
