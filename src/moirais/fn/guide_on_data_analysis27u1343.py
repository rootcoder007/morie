...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1343"]


def guide_on_data_analysis_chapter_27_unnumbered_1343(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌 |𝑋 = 𝑐 + ℎ] − 𝐸[𝑌 |𝑋 = 𝑐 − ℎ]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1343')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1343: GeneralStatistics expression (auto-extracted; see ref)."
