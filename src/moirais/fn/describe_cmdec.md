...
`print(result)` render. See `moirais.fn.describe('cmdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmdec import *
import numpy as np
# See the function signature in fn/cmdec.py for argument names.
```
