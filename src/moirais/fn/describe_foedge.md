...
`print(result)` render. See `moirais.fn.describe('foedge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foedge import *
import numpy as np
# See the function signature in fn/foedge.py for argument names.
```
