...
__all__ = ["hedderich_chapter_9_unnumbered_129"]


def hedderich_chapter_9_unnumbered_129(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u129')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u129: GeneralStatistics expression (auto-extracted; see ref)."
