...
`print(result)` render. See `moirais.fn.describe('inlasm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inlasm import *
import numpy as np
# See the function signature in fn/inlasm.py for argument names.
```
