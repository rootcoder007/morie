...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_785"]


def guide_on_data_analysis_chapter_11_unnumbered_785(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Δ𝑦𝑡 = 𝛼 + 𝜃𝑦𝑡−1 + 𝛾1Δ𝑦𝑡−1 + ⋯ + 𝛾𝑝Δ𝑦𝑡−𝑝 + 𝑣𝑡
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u785')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u785: GeneralStatistics expression (auto-extracted; see ref)."
