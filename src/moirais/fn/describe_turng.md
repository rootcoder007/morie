...
`print(result)` render. See `moirais.fn.describe('turng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.turng import *
import numpy as np
# See the function signature in fn/turng.py for argument names.
```
