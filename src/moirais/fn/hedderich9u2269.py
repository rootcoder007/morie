...
__all__ = ["hedderich_chapter_9_unnumbered_2269"]


def hedderich_chapter_9_unnumbered_2269(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Z = −1.5341 , p− value = 0. 0 6 72 9
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2269')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2269: GeneralStatistics expression (auto-extracted; see ref)."
