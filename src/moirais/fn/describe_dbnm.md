...
`print(result)` render. See `moirais.fn.describe('dbnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dbnm import *
import numpy as np
# See the function signature in fn/dbnm.py for argument names.
```
