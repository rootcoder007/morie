# describe('cfaer') — cfa_expected_change
...
`print(result)` render. See `moirais.fn.describe('cfaer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfaer import *
import numpy as np
# See the function signature in fn/cfaer.py for argument names.
```
