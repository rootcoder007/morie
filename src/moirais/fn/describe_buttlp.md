# describe('buttlp') — butter_lowpass
...
`print(result)` render. See `moirais.fn.describe('buttlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.buttlp import *
import numpy as np
# See the function signature in fn/buttlp.py for argument names.
```
