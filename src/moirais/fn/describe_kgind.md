# describe('kgind') — indicator_kriging
...
`print(result)` render. See `moirais.fn.describe('kgind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgind import *
import numpy as np
# See the function signature in fn/kgind.py for argument names.
```
