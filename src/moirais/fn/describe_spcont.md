# describe('spcont') — schabenberger_spatial_continuity
...
`print(result)` render. See `moirais.fn.describe('spcont')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcont import *
import numpy as np
# See the function signature in fn/spcont.py for argument names.
```
