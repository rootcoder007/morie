...
`print(result)` render. See `moirais.fn.describe('prnkpg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prnkpg import *
import numpy as np
# See the function signature in fn/prnkpg.py for argument names.
```
