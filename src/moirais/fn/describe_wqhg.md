...
`print(result)` render. See `moirais.fn.describe('wqhg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqhg import *
import numpy as np
# See the function signature in fn/wqhg.py for argument names.
```
