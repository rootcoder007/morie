...
__all__ = ["hedderich_chapter_9_unnumbered_19"]


def hedderich_chapter_9_unnumbered_19(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] k = (n−m + 1)k, (m<n )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u19')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u19: GeneralStatistics expression (auto-extracted; see ref)."
