...
__all__ = ["hedderich_chapter_9_unnumbered_2873"]


def hedderich_chapter_9_unnumbered_2873(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The global hypothesis of the equality of several (k) ordered proportion values (H0 : π1 =π2 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2873')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2873: GeneralStatistics expression (auto-extracted; see ref)."
