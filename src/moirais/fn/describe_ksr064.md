# describe('ksr064') — kosorok_ch3_cox_partial_likelihood
...
`print(result)` render. See `moirais.fn.describe('ksr064')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr064 import *
import numpy as np
# See the function signature in fn/ksr064.py for argument names.
```
