...
`print(result)` render. See `moirais.fn.describe('siprj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siprj import *
import numpy as np
# See the function signature in fn/siprj.py for argument names.
```
