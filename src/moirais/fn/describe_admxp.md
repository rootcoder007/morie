...
`print(result)` render. See `moirais.fn.describe('admxp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.admxp import *
import numpy as np
# See the function signature in fn/admxp.py for argument names.
```
