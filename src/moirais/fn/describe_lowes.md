...
`print(result)` render. See `moirais.fn.describe('lowes')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lowes import *
import numpy as np
# See the function signature in fn/lowes.py for argument names.
```
