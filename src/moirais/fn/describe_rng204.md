# describe('rng204') — rangayyan_ch4_psd_from_acf
...
`print(result)` render. See `moirais.fn.describe('rng204')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng204 import *
import numpy as np
# See the function signature in fn/rng204.py for argument names.
```
