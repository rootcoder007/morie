...
`print(result)` render. See `moirais.fn.describe('micev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.micev import *
import numpy as np
# See the function signature in fn/micev.py for argument names.
```
