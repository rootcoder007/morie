...
`print(result)` render. See `moirais.fn.describe('sdiff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdiff import *
import numpy as np
# See the function signature in fn/sdiff.py for argument names.
```
