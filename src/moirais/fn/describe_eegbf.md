# describe('eegbf') — eeg_band_filter_fn
...
`print(result)` render. See `moirais.fn.describe('eegbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eegbf import *
import numpy as np
# See the function signature in fn/eegbf.py for argument names.
```
