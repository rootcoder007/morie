# describe('rng135') — rangayyan_ch3_butterworth_highpass_dft_indexed
...
`print(result)` render. See `moirais.fn.describe('rng135')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng135 import *
import numpy as np
# See the function signature in fn/rng135.py for argument names.
```
