# describe('bmcmc') — metropolis_hastings
...
`print(result)` render. See `moirais.fn.describe('bmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bmcmc import *
import numpy as np
# See the function signature in fn/bmcmc.py for argument names.
```
