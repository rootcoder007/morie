...
__all__ = ["hedderich_chapter_9_unnumbered_592"]


def hedderich_chapter_9_unnumbered_592(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 4 =µ4 + 6µ2σ2 + 3σ4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u592')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u592: PowerAndDesign expression (auto-extracted; see ref)."
