...
`print(result)` render. See `moirais.fn.describe('prgdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgdm import *
import numpy as np
# See the function signature in fn/prgdm.py for argument names.
```
