# describe('kmap') — kamath_autoprompt_gradient_search
...
`print(result)` render. See `moirais.fn.describe('kmap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmap import *
import numpy as np
# See the function signature in fn/kmap.py for argument names.
```
