...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1209"]


def guide_on_data_analysis_chapter_24_unnumbered_1209(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] √𝑛𝑏 ∑(𝜇𝑖. − 𝜇..)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1209')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1209: GeneralStatistics expression (auto-extracted; see ref)."
