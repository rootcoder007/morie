# describe('rgeqn10b') — rangayyan_ch10_roc_optimal
...
`print(result)` render. See `moirais.fn.describe('rgeqn10b')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn10b import *
import numpy as np
# See the function signature in fn/rgeqn10b.py for argument names.
```
