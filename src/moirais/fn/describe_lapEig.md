# describe('lapEig') — laplacian_eigenmaps
...
`print(result)` render. See `moirais.fn.describe('lapEig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lapEig import *
import numpy as np
# See the function signature in fn/lapEig.py for argument names.
```
