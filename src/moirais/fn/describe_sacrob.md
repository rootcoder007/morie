...
`print(result)` render. See `moirais.fn.describe('sacrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacrob import *
import numpy as np
# See the function signature in fn/sacrob.py for argument names.
```
