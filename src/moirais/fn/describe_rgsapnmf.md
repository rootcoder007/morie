# describe('rgsapnmf') — rangayyan_sleep_apnea_nmf
...
`print(result)` render. See `moirais.fn.describe('rgsapnmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsapnmf import *
import numpy as np
# See the function signature in fn/rgsapnmf.py for argument names.
```
