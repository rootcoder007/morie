...
`print(result)` render. See `moirais.fn.describe('salgo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.salgo import *
import numpy as np
# See the function signature in fn/salgo.py for argument names.
```
