# describe('rgecgemu') — rangayyan_ecg_emg_coupling
...
`print(result)` render. See `moirais.fn.describe('rgecgemu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgecgemu import *
import numpy as np
# See the function signature in fn/rgecgemu.py for argument names.
```
