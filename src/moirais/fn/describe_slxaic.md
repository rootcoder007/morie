...
`print(result)` render. See `moirais.fn.describe('slxaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxaic import *
import numpy as np
# See the function signature in fn/slxaic.py for argument names.
```
