...
`print(result)` render. See `moirais.fn.describe('bigtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bigtm import *
import numpy as np
# See the function signature in fn/bigtm.py for argument names.
```
