# describe('mhmcmc') — metropolis_hastings
...
`print(result)` render. See `moirais.fn.describe('mhmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhmcmc import *
import numpy as np
# See the function signature in fn/mhmcmc.py for argument names.
```
