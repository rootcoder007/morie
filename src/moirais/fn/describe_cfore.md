...
`print(result)` render. See `moirais.fn.describe('cfore')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfore import *
import numpy as np
# See the function signature in fn/cfore.py for argument names.
```
