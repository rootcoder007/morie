# describe('nwalg') — needleman_wunsch
...
`print(result)` render. See `moirais.fn.describe('nwalg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwalg import *
import numpy as np
# See the function signature in fn/nwalg.py for argument names.
```
