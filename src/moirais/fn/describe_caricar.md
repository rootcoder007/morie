...
`print(result)` render. See `moirais.fn.describe('caricar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.caricar import *
import numpy as np
# See the function signature in fn/caricar.py for argument names.
```
