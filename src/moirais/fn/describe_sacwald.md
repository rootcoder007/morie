...
`print(result)` render. See `moirais.fn.describe('sacwald')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sacwald import *
import numpy as np
# See the function signature in fn/sacwald.py for argument names.
```
