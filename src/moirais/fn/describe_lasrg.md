# describe('lasrg') — _soft_threshold
...
`print(result)` render. See `moirais.fn.describe('lasrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lasrg import *
import numpy as np
# See the function signature in fn/lasrg.py for argument names.
```
