# describe('corrm') — correlation_matrix
...
`print(result)` render. See `moirais.fn.describe('corrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.corrm import *
import numpy as np
# See the function signature in fn/corrm.py for argument names.
```
