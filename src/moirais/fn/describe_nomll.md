# describe('nomll') — nominate_loglikelihood
...
`print(result)` render. See `moirais.fn.describe('nomll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nomll import *
import numpy as np
# See the function signature in fn/nomll.py for argument names.
```
