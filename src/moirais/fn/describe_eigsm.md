# describe('eigsm') — eigen_symmetric
...
`print(result)` render. See `moirais.fn.describe('eigsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eigsm import *
import numpy as np
# See the function signature in fn/eigsm.py for argument names.
```
