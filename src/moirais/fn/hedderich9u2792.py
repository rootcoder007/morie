...
__all__ = ["hedderich_chapter_9_unnumbered_2792"]


def hedderich_chapter_9_unnumbered_2792(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] b +c/n<π1−π2 < (b−c)/n + 1.96
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2792')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2792: CausalInference expression (auto-extracted; see ref)."
