# describe('alfrz') — alammar_layer_freezing
...
`print(result)` render. See `moirais.fn.describe('alfrz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfrz import *
import numpy as np
# See the function signature in fn/alfrz.py for argument names.
```
