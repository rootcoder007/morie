...
__all__ = ["wilcox_chapter_10_unnumbered_1046"]


def wilcox_chapter_10_unnumbered_1046(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outproMC(m, gval,center = NA, plotit = T, op = T, MM = F, cop = 3, xlab =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1046')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1046: GeneralStatistics expression (auto-extracted; see ref)."
