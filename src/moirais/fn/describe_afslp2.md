...
`print(result)` render. See `moirais.fn.describe('afslp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afslp2 import *
import numpy as np
# See the function signature in fn/afslp2.py for argument names.
```
