# describe('strat') — stratified_mean
...
`print(result)` render. See `moirais.fn.describe('strat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strat import *
import numpy as np
# See the function signature in fn/strat.py for argument names.
```
