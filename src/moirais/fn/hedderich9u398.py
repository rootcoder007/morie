...
__all__ = ["hedderich_chapter_9_unnumbered_398"]


def hedderich_chapter_9_unnumbered_398(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A∪B∪C) = P (A) +P (B) +P (C)−P (A∩B)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u398')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u398: GeneralStatistics expression (auto-extracted; see ref)."
