...
__all__ = ["hedderich_chapter_9_unnumbered_663"]


def hedderich_chapter_9_unnumbered_663(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: ˆλ=np = 4000·1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u663')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u663: CountModels expression (auto-extracted; see ref)."
