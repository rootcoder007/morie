...
`print(result)` render. See `moirais.fn.describe('stpor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stpor import *
import numpy as np
# See the function signature in fn/stpor.py for argument names.
```
