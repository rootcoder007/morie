...
__all__ = ["hedderich_chapter_9_unnumbered_802"]


def hedderich_chapter_9_unnumbered_802(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] F (−1.0) = P (Z≥1.0) = 0.1587.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u802')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u802: GeneralStatistics expression (auto-extracted; see ref)."
