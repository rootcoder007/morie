# describe('perm') — permutation_test

## WHAT IT DOES

Permutation test. 'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('perm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.perm import *
import numpy as np
# See the function signature in fn/perm.py for argument names.
```
