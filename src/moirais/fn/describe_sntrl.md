# describe('sntrl') — sentence_by_year
...
`print(result)` render. See `moirais.fn.describe('sntrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntrl import *
import numpy as np
# See the function signature in fn/sntrl.py for argument names.
```
