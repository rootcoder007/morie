# describe('cb15e3') — cb_chapter_15_equation_3
...
```python
from moirais.fn.cb15e3 import cb_chapter_15_equation_3
import numpy as np
result = cb_chapter_15_equation_3(np.random.default_rng(42).normal(0, 1, 100))
