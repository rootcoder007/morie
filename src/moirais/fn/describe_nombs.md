# describe('nombs') — nominate_bootstrap_se
...
`print(result)` render. See `moirais.fn.describe('nombs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nombs import *
import numpy as np
# See the function signature in fn/nombs.py for argument names.
```
