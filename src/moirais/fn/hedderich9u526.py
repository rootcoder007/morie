...
__all__ = ["hedderich_chapter_9_unnumbered_526"]


def hedderich_chapter_9_unnumbered_526(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (aX̄<b ) =P (X<b )−P (X<a ) P (aX̄≤b) =P (X≤b)−P (X<a ) (5.2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u526')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u526: GeneralStatistics expression (auto-extracted; see ref)."
