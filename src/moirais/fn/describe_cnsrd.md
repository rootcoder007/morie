...
`print(result)` render. See `moirais.fn.describe('cnsrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cnsrd import *
import numpy as np
# See the function signature in fn/cnsrd.py for argument names.
```
