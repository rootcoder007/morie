# describe('stpwz') — stepped_wedge_design
...
`print(result)` render. See `moirais.fn.describe('stpwz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stpwz import *
import numpy as np
# See the function signature in fn/stpwz.py for argument names.
```
