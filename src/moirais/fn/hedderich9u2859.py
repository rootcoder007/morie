...
__all__ = ["hedderich_chapter_9_unnumbered_2859"]


def hedderich_chapter_9_unnumbered_2859(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 = 166[60(17 + 17)−12(36 + 24)]2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2859')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2859: GeneralStatistics expression (auto-extracted; see ref)."
