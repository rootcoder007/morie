...
__all__ = ["hedderich_chapter_9_unnumbered_1525"]


def hedderich_chapter_9_unnumbered_1525(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] N β = 0.90 β = 0.95 β = 0.90 β = 0.95
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1525')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1525: PowerAndDesign expression (auto-extracted; see ref)."
