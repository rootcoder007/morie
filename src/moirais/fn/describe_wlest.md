...
`print(result)` render. See `moirais.fn.describe('wlest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlest import *
import numpy as np
# See the function signature in fn/wlest.py for argument names.
```
