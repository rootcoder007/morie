# describe('grprc') — geron_precision_recall_curve
...
`print(result)` render. See `moirais.fn.describe('grprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grprc import *
import numpy as np
# See the function signature in fn/grprc.py for argument names.
```
