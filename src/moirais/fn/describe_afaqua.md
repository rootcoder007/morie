...
`print(result)` render. See `moirais.fn.describe('afaqua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afaqua import *
import numpy as np
# See the function signature in fn/afaqua.py for argument names.
```
