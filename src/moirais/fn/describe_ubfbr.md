...
`print(result)` render. See `moirais.fn.describe('ubfbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubfbr import *
import numpy as np
# See the function signature in fn/ubfbr.py for argument names.
```
