...
`print(result)` render. See `moirais.fn.describe('relps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relps import *
import numpy as np
# See the function signature in fn/relps.py for argument names.
```
