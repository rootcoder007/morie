...
`print(result)` render. See `moirais.fn.describe('svcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svcmp import *
import numpy as np
# See the function signature in fn/svcmp.py for argument names.
```
