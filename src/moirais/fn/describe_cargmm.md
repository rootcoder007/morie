...
`print(result)` render. See `moirais.fn.describe('cargmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cargmm import *
import numpy as np
# See the function signature in fn/cargmm.py for argument names.
```
