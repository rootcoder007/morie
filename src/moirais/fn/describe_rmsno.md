...
`print(result)` render. See `moirais.fn.describe('rmsno')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsno import *
import numpy as np
# See the function signature in fn/rmsno.py for argument names.
```
