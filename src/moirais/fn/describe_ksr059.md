# describe('ksr059') — kosorok_ch2_kmt_strong_approximation
...
`print(result)` render. See `moirais.fn.describe('ksr059')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr059 import *
import numpy as np
# See the function signature in fn/ksr059.py for argument names.
```
