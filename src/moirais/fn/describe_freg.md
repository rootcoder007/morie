# describe('freg') — function_register
...
`print(result)` render. See `moirais.fn.describe('freg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.freg import *
import numpy as np
# See the function signature in fn/freg.py for argument names.
```
