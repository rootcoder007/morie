...
`print(result)` render. See `moirais.fn.describe('nrstm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrstm import *
import numpy as np
# See the function signature in fn/nrstm.py for argument names.
```
