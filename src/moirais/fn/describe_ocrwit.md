# describe('ocrwit') — ocr_wit_layout
...
`print(result)` render. See `moirais.fn.describe('ocrwit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocrwit import *
import numpy as np
# See the function signature in fn/ocrwit.py for argument names.
```
