...
__all__ = ["hedderich_chapter_9_unnumbered_1302"]


def hedderich_chapter_9_unnumbered_1302(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [ 1 ] " 1 2 . 3 1 <= 3 1 . 1 3 <= 7 8 . 7 2 "
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1302')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1302: GeneralStatistics expression (auto-extracted; see ref)."
