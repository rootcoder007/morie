...
`print(result)` render. See `moirais.fn.describe('chlmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlmat import *
import numpy as np
# See the function signature in fn/chlmat.py for argument names.
```
