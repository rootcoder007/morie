...
__all__ = ["hedderich_chapter_9_unnumbered_497"]


def hedderich_chapter_9_unnumbered_497(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Prevalence Se = Sp = 0, 95 Se = Sp = 0, 99
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u497')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u497: GeneralStatistics expression (auto-extracted; see ref)."
