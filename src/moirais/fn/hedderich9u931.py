...
__all__ = ["hedderich_chapter_9_unnumbered_931"]


def hedderich_chapter_9_unnumbered_931(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u931')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u931: PowerAndDesign expression (auto-extracted; see ref)."
