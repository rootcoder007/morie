# describe('kmvera') — kamath_vera_adapter
...
`print(result)` render. See `moirais.fn.describe('kmvera')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmvera import *
import numpy as np
# See the function signature in fn/kmvera.py for argument names.
```
