# describe('convnx') — convnext_block
...
`print(result)` render. See `moirais.fn.describe('convnx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.convnx import *
import numpy as np
# See the function signature in fn/convnx.py for argument names.
```
