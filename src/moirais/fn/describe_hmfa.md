# describe('hmfa') — geron_flash_attention
...
`print(result)` render. See `moirais.fn.describe('hmfa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfa import *
import numpy as np
# See the function signature in fn/hmfa.py for argument names.
```
