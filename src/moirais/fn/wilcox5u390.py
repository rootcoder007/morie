...
__all__ = ["wilcox_chapter_5_unnumbered_390"]


def wilcox_chapter_5_unnumbered_390(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: 15. For n = 49, α = 0.05,σ = 10, and H0:µ = 50, verify that power is approximately
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u390')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u390: PowerAndDesign expression (auto-extracted; see ref)."
