...
`print(result)` render. See `moirais.fn.describe('dmlir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmlir import *
import numpy as np
# See the function signature in fn/dmlir.py for argument names.
```
