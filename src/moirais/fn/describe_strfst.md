...
`print(result)` render. See `moirais.fn.describe('strfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strfst import *
import numpy as np
# See the function signature in fn/strfst.py for argument names.
```
