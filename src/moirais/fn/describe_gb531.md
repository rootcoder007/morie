# describe('gb531') — gibbons_quantile_test
...
`print(result)` render. See `moirais.fn.describe('gb531')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb531 import *
import numpy as np
# See the function signature in fn/gb531.py for argument names.
```
