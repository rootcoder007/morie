# describe('cvxcvc') — boyd_convex_combination
...
`print(result)` render. See `moirais.fn.describe('cvxcvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxcvc import *
import numpy as np
# See the function signature in fn/cvxcvc.py for argument names.
```
