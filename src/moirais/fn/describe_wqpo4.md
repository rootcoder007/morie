...
`print(result)` render. See `moirais.fn.describe('wqpo4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqpo4 import *
import numpy as np
# See the function signature in fn/wqpo4.py for argument names.
```
