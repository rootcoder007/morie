...
`print(result)` render. See `moirais.fn.describe('dk4dr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk4dr import *
import numpy as np
# See the function signature in fn/dk4dr.py for argument names.
```
