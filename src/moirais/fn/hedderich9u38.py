...
__all__ = ["hedderich_chapter_9_unnumbered_38"]


def hedderich_chapter_9_unnumbered_38(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u38')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u38: PowerAndDesign expression (auto-extracted; see ref)."
