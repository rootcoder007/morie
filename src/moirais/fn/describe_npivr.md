...
`print(result)` render. See `moirais.fn.describe('npivr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npivr import *
import numpy as np
# See the function signature in fn/npivr.py for argument names.
```
