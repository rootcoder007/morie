...
`print(result)` render. See `moirais.fn.describe('npqnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.npqnt import *
import numpy as np
# See the function signature in fn/npqnt.py for argument names.
```
