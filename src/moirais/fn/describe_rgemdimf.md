# describe('rgemdimf') — rangayyan_emd_imf
...
`print(result)` render. See `moirais.fn.describe('rgemdimf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemdimf import *
import numpy as np
# See the function signature in fn/rgemdimf.py for argument names.
```
