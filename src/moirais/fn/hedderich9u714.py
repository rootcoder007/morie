...
__all__ = ["hedderich_chapter_9_unnumbered_714"]


def hedderich_chapter_9_unnumbered_714(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u714')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u714: GeneralStatistics expression (auto-extracted; see ref)."
