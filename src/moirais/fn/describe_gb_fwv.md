# describe('gb_fwv') — gibbons_friedman_variance
...
`print(result)` render. See `moirais.fn.describe('gb_fwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_fwv import *
import numpy as np
# See the function signature in fn/gb_fwv.py for argument names.
```
