...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_483"]


def guide_on_data_analysis_chapter_6_unnumbered_483(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Θ = 𝜃1 × 𝜃2 × ⋯ × 𝜃𝑝.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u483')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u483: GeneralStatistics expression (auto-extracted; see ref)."
