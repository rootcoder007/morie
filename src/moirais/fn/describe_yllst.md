# describe('yllst') — years_of_life_lost_std
...
`print(result)` render. See `moirais.fn.describe('yllst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yllst import *
import numpy as np
# See the function signature in fn/yllst.py for argument names.
```
