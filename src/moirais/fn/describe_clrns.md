# describe('clrns') — colored_noise_gen
...
`print(result)` render. See `moirais.fn.describe('clrns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clrns import *
import numpy as np
# See the function signature in fn/clrns.py for argument names.
```
