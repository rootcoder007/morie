# describe('pcmpr1') — prediction_compression
...
`print(result)` render. See `moirais.fn.describe('pcmpr1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcmpr1 import *
import numpy as np
# See the function signature in fn/pcmpr1.py for argument names.
```
