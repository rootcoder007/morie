# describe('km130') — kamath_ch9_input_alignment_loss
...
`print(result)` render. See `moirais.fn.describe('km130')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km130 import *
import numpy as np
# See the function signature in fn/km130.py for argument names.
```
