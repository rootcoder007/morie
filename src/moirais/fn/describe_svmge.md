...
`print(result)` render. See `moirais.fn.describe('svmge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmge import *
import numpy as np
# See the function signature in fn/svmge.py for argument names.
```
