# describe('ophho') — ophho

## WHAT IT DOES

Harris hawks optimizer spatial
...
`print(result)` render. See `moirais.fn.describe('ophho')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ophho import *
import numpy as np
# See the function signature in fn/ophho.py for argument names.
```
