# describe('ca5u147') — ca_chapter_5_unnumbered_147
...
```python
from moirais.fn.ca5u147 import ca_chapter_5_unnumbered_147
import numpy as np
result = ca_chapter_5_unnumbered_147(np.random.default_rng(42).normal(0, 1, 100))
