...
`print(result)` render. See `moirais.fn.describe('relu2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relu2 import *
import numpy as np
# See the function signature in fn/relu2.py for argument names.
```
