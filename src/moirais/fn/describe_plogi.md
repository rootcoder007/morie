...
`print(result)` render. See `moirais.fn.describe('plogi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plogi import *
import numpy as np
# See the function signature in fn/plogi.py for argument names.
```
