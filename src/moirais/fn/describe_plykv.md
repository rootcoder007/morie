# describe('plykv') — polyakov_action
...
`print(result)` render. See `moirais.fn.describe('plykv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plykv import *
import numpy as np
# See the function signature in fn/plykv.py for argument names.
```
