...
`print(result)` render. See `moirais.fn.describe('bench')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bench import *
import numpy as np
# See the function signature in fn/bench.py for argument names.
```
