# describe('netsts') — neural_ts_lstm
...
`print(result)` render. See `moirais.fn.describe('netsts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netsts import *
import numpy as np
# See the function signature in fn/netsts.py for argument names.
```
