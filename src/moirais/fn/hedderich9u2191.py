...
__all__ = ["hedderich_chapter_9_unnumbered_2191"]


def hedderich_chapter_9_unnumbered_2191(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + n <− sum ( ( x−y ) ! =0 ) # differencesunequalzero
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2191')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2191: GeneralStatistics expression (auto-extracted; see ref)."
