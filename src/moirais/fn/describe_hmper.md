# describe('hmper') — geron_prioritized_replay
...
`print(result)` render. See `moirais.fn.describe('hmper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmper import *
import numpy as np
# See the function signature in fn/hmper.py for argument names.
```
