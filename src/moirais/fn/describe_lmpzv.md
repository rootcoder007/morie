...
`print(result)` render. See `moirais.fn.describe('lmpzv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmpzv import *
import numpy as np
# See the function signature in fn/lmpzv.py for argument names.
```
