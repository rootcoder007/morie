# describe('snttm') — sentence_time_served
...
`print(result)` render. See `moirais.fn.describe('snttm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snttm import *
import numpy as np
# See the function signature in fn/snttm.py for argument names.
```
