...
__all__ = ["wilcox_chapter_14_unnumbered_500"]


def wilcox_chapter_14_unnumbered_500(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0: β j = 0 (j = 1, 2, 3, 4) has p-values 0.07, 0.5, 0.9 and 0.84, respectively. That is, we fail
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u500')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u500: GeneralStatistics expression (auto-extracted; see ref)."
