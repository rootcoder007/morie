# describe('bndfre') — bound_frequentist
...
`print(result)` render. See `moirais.fn.describe('bndfre')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndfre import *
import numpy as np
# See the function signature in fn/bndfre.py for argument names.
```
