# describe('hedderich8e78') — hedderich_chapter_8_equation_78
...
100 exp (β0 +β1·(x1 + 1) +...+βp·xp)−exp (β0 +β1·x1 +...+βp·xp)
...
import numpy as np
result = hedderich_chapter_8_equation_78(np.random.default_rng(42).normal(0, 1, 100))
