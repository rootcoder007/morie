...
`print(result)` render. See `moirais.fn.describe('agcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcmp import *
import numpy as np
# See the function signature in fn/agcmp.py for argument names.
```
