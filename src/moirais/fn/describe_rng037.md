# describe('rng037') — rangayyan_ch3_discrete_convolution_causal_alt
...
`print(result)` render. See `moirais.fn.describe('rng037')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng037 import *
import numpy as np
# See the function signature in fn/rng037.py for argument names.
```
