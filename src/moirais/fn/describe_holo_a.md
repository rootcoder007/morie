...
`print(result)` render. See `moirais.fn.describe('holo_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_a import *
import numpy as np
# See the function signature in fn/holo_a.py for argument names.
```
