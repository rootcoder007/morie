...
`print(result)` render. See `moirais.fn.describe('chlbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlbnd import *
import numpy as np
# See the function signature in fn/chlbnd.py for argument names.
```
