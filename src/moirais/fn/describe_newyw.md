...
`print(result)` render. See `moirais.fn.describe('newyw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.newyw import *
import numpy as np
# See the function signature in fn/newyw.py for argument names.
```
