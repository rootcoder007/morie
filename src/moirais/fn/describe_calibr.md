# describe('calibr') — calibration_estimator
...
`print(result)` render. See `moirais.fn.describe('calibr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.calibr import *
import numpy as np
# See the function signature in fn/calibr.py for argument names.
```
