# describe('hmencd') — geron_encoder_decoder_transformer
...
`print(result)` render. See `moirais.fn.describe('hmencd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmencd import *
import numpy as np
# See the function signature in fn/hmencd.py for argument names.
```
