...
`print(result)` render. See `moirais.fn.describe('siconn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siconn import *
import numpy as np
# See the function signature in fn/siconn.py for argument names.
```
