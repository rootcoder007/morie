...
`print(result)` render. See `moirais.fn.describe('hssal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hssal import *
import numpy as np
# See the function signature in fn/hssal.py for argument names.
```
