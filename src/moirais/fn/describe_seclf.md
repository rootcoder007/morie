...
`print(result)` render. See `moirais.fn.describe('seclf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclf import *
import numpy as np
# See the function signature in fn/seclf.py for argument names.
```
