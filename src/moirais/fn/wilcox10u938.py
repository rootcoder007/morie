...
__all__ = ["wilcox_chapter_10_unnumbered_938"]


def wilcox_chapter_10_unnumbered_938(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] because C = 6, we see that ( C − k + 1)α/C = 5(0.05)/6 = 0 .0417. Because P[2] = 0.130 >
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u938')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u938: GeneralStatistics expression (auto-extracted; see ref)."
