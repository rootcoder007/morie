# describe('gatemd') — graph_attention_net
...
`print(result)` render. See `moirais.fn.describe('gatemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gatemd import *
import numpy as np
# See the function signature in fn/gatemd.py for argument names.
```
