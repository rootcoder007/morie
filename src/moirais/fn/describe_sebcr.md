...
`print(result)` render. See `moirais.fn.describe('sebcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebcr import *
import numpy as np
# See the function signature in fn/sebcr.py for argument names.
```
