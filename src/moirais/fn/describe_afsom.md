...
`print(result)` render. See `moirais.fn.describe('afsom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afsom import *
import numpy as np
# See the function signature in fn/afsom.py for argument names.
```
