...
`print(result)` render. See `moirais.fn.describe('csrkstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrkstst import *
import numpy as np
# See the function signature in fn/csrkstst.py for argument names.
```
