# describe('svplr') — polarization_1d
...
`print(result)` render. See `moirais.fn.describe('svplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svplr import *
import numpy as np
# See the function signature in fn/svplr.py for argument names.
```
