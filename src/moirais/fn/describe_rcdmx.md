# describe('rcdmx') — recidivism_mixture
...
`print(result)` render. See `moirais.fn.describe('rcdmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdmx import *
import numpy as np
# See the function signature in fn/rcdmx.py for argument names.
```
