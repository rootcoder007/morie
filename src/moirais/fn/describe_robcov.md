# describe('robcov') — sandwich_robust_se
...
`print(result)` render. See `moirais.fn.describe('robcov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robcov import *
import numpy as np
# See the function signature in fn/robcov.py for argument names.
```
