...
`print(result)` render. See `moirais.fn.describe('wqhrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqhrd import *
import numpy as np
# See the function signature in fn/wqhrd.py for argument names.
```
