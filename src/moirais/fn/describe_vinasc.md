# describe('vinasc') — autodock_vina_score
...
`print(result)` render. See `moirais.fn.describe('vinasc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vinasc import *
import numpy as np
# See the function signature in fn/vinasc.py for argument names.
```
