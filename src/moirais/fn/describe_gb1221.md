# describe('gb1221') — gibbons_friedman
...
`print(result)` render. See `moirais.fn.describe('gb1221')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1221 import *
import numpy as np
# See the function signature in fn/gb1221.py for argument names.
```
