...
`print(result)` render. See `moirais.fn.describe('stiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stiag import *
import numpy as np
# See the function signature in fn/stiag.py for argument names.
```
