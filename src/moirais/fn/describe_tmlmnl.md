# describe('tmlmnl') — tmle_machine_learning
...
`print(result)` render. See `moirais.fn.describe('tmlmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlmnl import *
import numpy as np
# See the function signature in fn/tmlmnl.py for argument names.
```
