...
__all__ = ["hedderich_chapter_9_unnumbered_1871"]


def hedderich_chapter_9_unnumbered_1871(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.5 + 0.252 = 0.8< 1.96 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1871')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1871: GeneralStatistics expression (auto-extracted; see ref)."
