...
`print(result)` render. See `moirais.fn.describe('hymnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hymnd import *
import numpy as np
# See the function signature in fn/hymnd.py for argument names.
```
