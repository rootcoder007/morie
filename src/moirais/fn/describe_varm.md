...
`print(result)` render. See `moirais.fn.describe('varm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varm import *
import numpy as np
# See the function signature in fn/varm.py for argument names.
```
