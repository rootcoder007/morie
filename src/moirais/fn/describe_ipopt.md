...
`print(result)` render. See `moirais.fn.describe('ipopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipopt import *
import numpy as np
# See the function signature in fn/ipopt.py for argument names.
```
