...
__all__ = ["hedderich_chapter_9_unnumbered_2838"]


def hedderich_chapter_9_unnumbered_2838(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + p <− 1− pchisq ( X2 .stat , df =k −1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2838')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2838: GeneralStatistics expression (auto-extracted; see ref)."
