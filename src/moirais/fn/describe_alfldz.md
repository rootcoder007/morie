# describe('alfldz') — alphafold_loss_decomposition
...
`print(result)` render. See `moirais.fn.describe('alfldz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfldz import *
import numpy as np
# See the function signature in fn/alfldz.py for argument names.
```
