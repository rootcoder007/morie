...
`print(result)` render. See `moirais.fn.describe('mpflk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpflk import *
import numpy as np
# See the function signature in fn/mpflk.py for argument names.
```
