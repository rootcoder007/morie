# describe('cohrt') — cohort_risk_ratio
...
`print(result)` render. See `moirais.fn.describe('cohrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cohrt import *
import numpy as np
# See the function signature in fn/cohrt.py for argument names.
```
