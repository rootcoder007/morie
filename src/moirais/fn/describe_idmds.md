...
`print(result)` render. See `moirais.fn.describe('idmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idmds import *
import numpy as np
# See the function signature in fn/idmds.py for argument names.
```
