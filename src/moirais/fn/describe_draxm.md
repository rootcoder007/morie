# describe('draxm') — destroyer_decompose
...
`print(result)` render. See `moirais.fn.describe('draxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.draxm import *
import numpy as np
# See the function signature in fn/draxm.py for argument names.
```
