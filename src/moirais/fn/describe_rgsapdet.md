# describe('rgsapdet') — rangayyan_sleep_apnea_detect
...
`print(result)` render. See `moirais.fn.describe('rgsapdet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsapdet import *
import numpy as np
# See the function signature in fn/rgsapdet.py for argument names.
```
