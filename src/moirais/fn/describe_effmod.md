# describe('effmod') — effect_modification
...
`print(result)` render. See `moirais.fn.describe('effmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.effmod import *
import numpy as np
# See the function signature in fn/effmod.py for argument names.
```
