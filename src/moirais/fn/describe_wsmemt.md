# describe('wsmemt') — wasserman_em_algorithm
...
`print(result)` render. See `moirais.fn.describe('wsmemt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmemt import *
import numpy as np
# See the function signature in fn/wsmemt.py for argument names.
```
