...
`print(result)` render. See `moirais.fn.describe('mrsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrsrv import *
import numpy as np
# See the function signature in fn/mrsrv.py for argument names.
```
