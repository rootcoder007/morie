...
__all__ = ["wilcox_chapter_7_unnumbered_327"]


def wilcox_chapter_7_unnumbered_327(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: stein1(x,del,alpha=0.05,pow=0.8,oneside=FALSE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u327')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u327: PowerAndDesign expression (auto-extracted; see ref)."
