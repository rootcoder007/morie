...
__all__ = ["hedderich_chapter_9_unnumbered_1148"]


def hedderich_chapter_9_unnumbered_1148(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.987−1/7 = 0.725; 0 .988−1/8 = 0.726; 0 .989−1/9 = 0.723 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1148')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1148: GeneralStatistics expression (auto-extracted; see ref)."
