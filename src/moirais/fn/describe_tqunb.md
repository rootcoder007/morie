# describe('tqunb') — turboquant_prodqjl_unbiasedness
...
`print(result)` render. See `moirais.fn.describe('tqunb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqunb import *
import numpy as np
# See the function signature in fn/tqunb.py for argument names.
```
