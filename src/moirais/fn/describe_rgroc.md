# describe('rgroc') — rangayyan_roc_curve
...
`print(result)` render. See `moirais.fn.describe('rgroc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgroc import *
import numpy as np
# See the function signature in fn/rgroc.py for argument names.
```
