# describe('eslprt') — esl_partial_dependence
...
`print(result)` render. See `moirais.fn.describe('eslprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslprt import *
import numpy as np
# See the function signature in fn/eslprt.py for argument names.
```
