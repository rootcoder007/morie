# describe('grpsp') — group_sparse_decompose
...
`print(result)` render. See `moirais.fn.describe('grpsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpsp import *
import numpy as np
# See the function signature in fn/grpsp.py for argument names.
```
