# describe('gh_c7_1') — ghosal_pt_kl_prop
...
`print(result)` render. See `moirais.fn.describe('gh_c7_1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_1 import *
import numpy as np
# See the function signature in fn/gh_c7_1.py for argument names.
```
