...
__all__ = ["wilcox_chapter_14_unnumbered_576"]


def wilcox_chapter_14_unnumbered_576(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: sband(x,y, flag = FALSE, plotit = TRUE, xlab = "x (First Group)", ylab =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u576')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u576: GeneralStatistics expression (auto-extracted; see ref)."
