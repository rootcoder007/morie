# describe('tmlvts') — tmle_var_targeting
...
`print(result)` render. See `moirais.fn.describe('tmlvts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlvts import *
import numpy as np
# See the function signature in fn/tmlvts.py for argument names.
```
