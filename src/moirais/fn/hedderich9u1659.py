...
__all__ = ["hedderich_chapter_9_unnumbered_1659"]


def hedderich_chapter_9_unnumbered_1659(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (non-inferiority), on the other hand, aims at the exclusion targeted in only one direction (µd>−δ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1659')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1659: GeneralStatistics expression (auto-extracted; see ref)."
