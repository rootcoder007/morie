...
`print(result)` render. See `moirais.fn.describe('auc_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.auc_ import *
import numpy as np
# See the function signature in fn/auc_.py for argument names.
```
