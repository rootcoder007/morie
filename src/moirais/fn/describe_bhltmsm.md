# describe('bhltmsm') — behavioral_health_msm
...
`print(result)` render. See `moirais.fn.describe('bhltmsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bhltmsm import *
import numpy as np
# See the function signature in fn/bhltmsm.py for argument names.
```
