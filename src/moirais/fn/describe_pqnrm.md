# describe('pqnrm') — polar_normalize
...
`print(result)` render. See `moirais.fn.describe('pqnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pqnrm import *
import numpy as np
# See the function signature in fn/pqnrm.py for argument names.
```
