...
`print(result)` render. See `moirais.fn.describe('stord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stord import *
import numpy as np
# See the function signature in fn/stord.py for argument names.
```
