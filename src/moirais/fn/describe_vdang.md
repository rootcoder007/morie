...
`print(result)` render. See `moirais.fn.describe('vdang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdang import *
import numpy as np
# See the function signature in fn/vdang.py for argument names.
```
