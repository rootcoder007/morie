# describe('rrand') — randomized_response
...
`print(result)` render. See `moirais.fn.describe('rrand')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rrand import *
import numpy as np
# See the function signature in fn/rrand.py for argument names.
```
