...
`print(result)` render. See `moirais.fn.describe('stmet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stmet import *
import numpy as np
# See the function signature in fn/stmet.py for argument names.
```
