# describe('splgk') — schabenberger_lognormal_kriging
...
`print(result)` render. See `moirais.fn.describe('splgk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgk import *
import numpy as np
# See the function signature in fn/splgk.py for argument names.
```
