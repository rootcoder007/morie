# describe('ripK') — ripley_k_function
...
`print(result)` render. See `moirais.fn.describe('ripK')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ripK import *
import numpy as np
# See the function signature in fn/ripK.py for argument names.
```
