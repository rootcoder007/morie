...
`print(result)` render. See `moirais.fn.describe('siaepi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siaepi import *
import numpy as np
# See the function signature in fn/siaepi.py for argument names.
```
