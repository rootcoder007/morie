...
`print(result)` render. See `moirais.fn.describe('hmalex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmalex import *
import numpy as np
# See the function signature in fn/hmalex.py for argument names.
```
