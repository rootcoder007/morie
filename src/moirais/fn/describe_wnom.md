# describe('wnom') — wnominate_estimate
...
`print(result)` render. See `moirais.fn.describe('wnom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnom import *
import numpy as np
# See the function signature in fn/wnom.py for argument names.
```
