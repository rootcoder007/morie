# describe('multi') — multinomial_logit
...
`print(result)` render. See `moirais.fn.describe('multi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.multi import *
import numpy as np
# See the function signature in fn/multi.py for argument names.
```
