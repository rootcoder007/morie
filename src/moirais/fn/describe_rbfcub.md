...
`print(result)` render. See `moirais.fn.describe('rbfcub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfcub import *
import numpy as np
# See the function signature in fn/rbfcub.py for argument names.
```
