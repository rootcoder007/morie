# describe('ggrcst') — granger_causality
...
`print(result)` render. See `moirais.fn.describe('ggrcst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ggrcst import *
import numpy as np
# See the function signature in fn/ggrcst.py for argument names.
```
