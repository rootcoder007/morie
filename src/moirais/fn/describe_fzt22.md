# describe('fzt22') — fauzi_thm2_2_bias_brdkdfe
...
`print(result)` render. See `moirais.fn.describe('fzt22')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt22 import *
import numpy as np
# See the function signature in fn/fzt22.py for argument names.
```
