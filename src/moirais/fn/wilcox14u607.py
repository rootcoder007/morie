...
__all__ = ["wilcox_chapter_14_unnumbered_607"]


def wilcox_chapter_14_unnumbered_607(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] V =u{ (2 − a)a − b2} + 2v(1 − a)b
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u607')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u607: ContingencyTables expression (auto-extracted; see ref)."
