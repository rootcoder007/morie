...
__all__ = ["design_of_observational_studies_chapter_20_unnumbered_704"]


def design_of_observational_studies_chapter_20_unnumbered_704(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('design_of_observational_studies20u704')`` for the full guide.
...
def cheatsheet():
    return "design_of_observational_studies20u704: GeneralStatistics expression (auto-extracted; see ref)."
