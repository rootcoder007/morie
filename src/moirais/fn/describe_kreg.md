# describe('kreg') — kernel_regression

## WHAT IT DOES

Nadaraya-Watson kernel regression. 'Knowing others is intelligence; knowing yourself is true wisdom. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('kreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kreg import *
import numpy as np
# See the function signature in fn/kreg.py for argument names.
```
