...
`print(result)` render. See `moirais.fn.describe('evgevp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgevp import *
import numpy as np
# See the function signature in fn/evgevp.py for argument names.
```
