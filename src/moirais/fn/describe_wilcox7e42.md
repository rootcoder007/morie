# describe('wilcox7e42') — wilcox_chapter_7_equation_42
...
```python
from moirais.fn.wilcox7e42 import wilcox_chapter_7_equation_42
import numpy as np
result = wilcox_chapter_7_equation_42(np.random.default_rng(42).normal(0, 1, 100))
