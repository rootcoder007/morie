# describe('gnorm') — gnorm

## WHAT IT DOES

rGroup normalization.
...
`print(result)` render. See `moirais.fn.describe('gnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnorm import *
import numpy as np
# See the function signature in fn/gnorm.py for argument names.
```
