...
__all__ = ["hedderich_chapter_9_unnumbered_846"]


def hedderich_chapter_9_unnumbered_846(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P = [0.5−P (Z≥1.5)] + [0.5−P (Z≥1.0)]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u846')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u846: GeneralStatistics expression (auto-extracted; see ref)."
