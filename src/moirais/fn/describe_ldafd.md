...
`print(result)` render. See `moirais.fn.describe('ldafd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ldafd import *
import numpy as np
# See the function signature in fn/ldafd.py for argument names.
```
