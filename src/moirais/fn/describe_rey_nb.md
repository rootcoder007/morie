...
`print(result)` render. See `moirais.fn.describe('rey_nb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_nb import *
import numpy as np
# See the function signature in fn/rey_nb.py for argument names.
```
