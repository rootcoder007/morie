# describe('gb_qq') — gibbons_qq_plot
...
`print(result)` render. See `moirais.fn.describe('gb_qq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_qq import *
import numpy as np
# See the function signature in fn/gb_qq.py for argument names.
```
