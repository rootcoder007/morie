...
__all__ = ["hedderich_chapter_9_unnumbered_726"]


def hedderich_chapter_9_unnumbered_726(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u726')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u726: CountModels expression (auto-extracted; see ref)."
