# describe('riskr') — risch_integration
...
`print(result)` render. See `moirais.fn.describe('riskr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.riskr import *
import numpy as np
# See the function signature in fn/riskr.py for argument names.
```
