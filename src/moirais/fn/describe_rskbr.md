...
`print(result)` render. See `moirais.fn.describe('rskbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rskbr import *
import numpy as np
# See the function signature in fn/rskbr.py for argument names.
```
