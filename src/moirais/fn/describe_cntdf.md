# describe('cntdf') — central_difference
...
`print(result)` render. See `moirais.fn.describe('cntdf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cntdf import *
import numpy as np
# See the function signature in fn/cntdf.py for argument names.
```
