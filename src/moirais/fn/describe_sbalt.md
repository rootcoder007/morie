...
`print(result)` render. See `moirais.fn.describe('sbalt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbalt import *
import numpy as np
# See the function signature in fn/sbalt.py for argument names.
```
