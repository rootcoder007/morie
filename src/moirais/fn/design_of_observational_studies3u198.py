...
__all__ = ["design_of_observational_studies_chapter_3_unnumbered_198"]


def design_of_observational_studies_chapter_3_unnumbered_198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('design_of_observational_studies3u198')`` for the full guide.
...
def cheatsheet():
    return "design_of_observational_studies3u198: GeneralStatistics expression (auto-extracted; see ref)."
