# describe('rgcorart') — rangayyan_coronary_sound
...
`print(result)` render. See `moirais.fn.describe('rgcorart')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcorart import *
import numpy as np
# See the function signature in fn/rgcorart.py for argument names.
```
