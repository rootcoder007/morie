...
`print(result)` render. See `moirais.fn.describe('mcnmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcnmr import *
import numpy as np
# See the function signature in fn/mcnmr.py for argument names.
```
