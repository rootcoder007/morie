# describe('grduel') — geron_dueling_dqn
...
`print(result)` render. See `moirais.fn.describe('grduel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grduel import *
import numpy as np
# See the function signature in fn/grduel.py for argument names.
```
