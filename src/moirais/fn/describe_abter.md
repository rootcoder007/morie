...
`print(result)` render. See `moirais.fn.describe('abter')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abter import *
import numpy as np
# See the function signature in fn/abter.py for argument names.
```
