# describe('ghcls') — ghosal_np_classification
...
`print(result)` render. See `moirais.fn.describe('ghcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcls import *
import numpy as np
# See the function signature in fn/ghcls.py for argument names.
```
