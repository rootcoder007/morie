# describe('hrzdeconv') — horowitz_deconvolution_density
...
`print(result)` render. See `moirais.fn.describe('hrzdeconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzdeconv import *
import numpy as np
# See the function signature in fn/hrzdeconv.py for argument names.
```
