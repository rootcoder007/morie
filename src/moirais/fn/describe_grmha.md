# describe('grmha') — geron_multi_head_attention
...
`print(result)` render. See `moirais.fn.describe('grmha')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmha import *
import numpy as np
# See the function signature in fn/grmha.py for argument names.
```
