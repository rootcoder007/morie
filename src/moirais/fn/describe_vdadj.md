...
`print(result)` render. See `moirais.fn.describe('vdadj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdadj import *
import numpy as np
# See the function signature in fn/vdadj.py for argument names.
```
