...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_126"]


def information_theory_mackay_chapter_6_unnumbered_126(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(y = Hjx= G) = 1=3;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u126')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u126: GeneralStatistics expression (auto-extracted; see ref)."
