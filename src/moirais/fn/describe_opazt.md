...
`print(result)` render. See `moirais.fn.describe('opazt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opazt import *
import numpy as np
# See the function signature in fn/opazt.py for argument names.
```
