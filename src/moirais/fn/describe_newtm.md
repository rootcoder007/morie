...
`print(result)` render. See `moirais.fn.describe('newtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.newtm import *
import numpy as np
# See the function signature in fn/newtm.py for argument names.
```
