...
`print(result)` render. See `moirais.fn.describe('vitbgi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vitbgi import *
import numpy as np
# See the function signature in fn/vitbgi.py for argument names.
```
