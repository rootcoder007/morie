# describe('matccd') — matched_case_control
...
`print(result)` render. See `moirais.fn.describe('matccd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.matccd import *
import numpy as np
# See the function signature in fn/matccd.py for argument names.
```
