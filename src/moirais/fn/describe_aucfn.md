...
`print(result)` render. See `moirais.fn.describe('aucfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aucfn import *
import numpy as np
# See the function signature in fn/aucfn.py for argument names.
```
