...
`print(result)` render. See `moirais.fn.describe('renyi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.renyi import *
import numpy as np
# See the function signature in fn/renyi.py for argument names.
```
