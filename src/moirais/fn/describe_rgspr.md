# describe('rgspr') — rangayyan_spectral_power_ratio
...
`print(result)` render. See `moirais.fn.describe('rgspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgspr import *
import numpy as np
# See the function signature in fn/rgspr.py for argument names.
```
