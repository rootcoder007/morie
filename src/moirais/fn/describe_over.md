# describe('over') — overlap_diagnostics
...
`print(result)` render. See `moirais.fn.describe('over')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.over import *
import numpy as np
# See the function signature in fn/over.py for argument names.
```
