...
__all__ = ["hedderich_chapter_9_unnumbered_866"]


def hedderich_chapter_9_unnumbered_866(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: i=1Xi−np√npq <z
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u866')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u866: CountModels expression (auto-extracted; see ref)."
