...
`print(result)` render. See `moirais.fn.describe('pageH')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pageH import *
import numpy as np
# See the function signature in fn/pageH.py for argument names.
```
