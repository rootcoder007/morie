...
`print(result)` render. See `moirais.fn.describe('opffa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opffa import *
import numpy as np
# See the function signature in fn/opffa.py for argument names.
```
