...
`print(result)` render. See `moirais.fn.describe('evtdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evtdn import *
import numpy as np
# See the function signature in fn/evtdn.py for argument names.
```
