# describe('msm035') — mvsml_linear_mixed_models_eq_5_6
...
`print(result)` render. See `moirais.fn.describe('msm035')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm035 import *
import numpy as np
# See the function signature in fn/msm035.py for argument names.
```
