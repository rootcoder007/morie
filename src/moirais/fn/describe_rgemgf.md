# describe('rgemgf') — rangayyan_emg_force

## WHAT IT DOES

EMG-force relationship analysis (RMS vs. contraction level).
...
`print(result)` render. See `moirais.fn.describe('rgemgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemgf import *
import numpy as np
# See the function signature in fn/rgemgf.py for argument names.
```
