# describe('retnet') — retnet_retention
...
`print(result)` render. See `moirais.fn.describe('retnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.retnet import *
import numpy as np
# See the function signature in fn/retnet.py for argument names.
```
