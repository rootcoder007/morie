...
`print(result)` render. See `moirais.fn.describe('scpboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scpboot import *
import numpy as np
# See the function signature in fn/scpboot.py for argument names.
```
