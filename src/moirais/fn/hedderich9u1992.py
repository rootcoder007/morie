...
__all__ = ["hedderich_chapter_9_unnumbered_1992"]


def hedderich_chapter_9_unnumbered_1992(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + elseif ( i% %2==1 & n / 2< i & i <n ) { g [ i ] <− 2* ( n− i )+1 }
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1992')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1992: GeneralStatistics expression (auto-extracted; see ref)."
