# describe('dpmdn') — dirichlet_process_mixture_density
...
`print(result)` render. See `moirais.fn.describe('dpmdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmdn import *
import numpy as np
# See the function signature in fn/dpmdn.py for argument names.
```
