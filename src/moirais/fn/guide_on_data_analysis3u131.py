...
__all__ = ["guide_on_data_analysis_chapter_3_unnumbered_131"]


def guide_on_data_analysis_chapter_3_unnumbered_131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: A = sample(1.4, replace = TRUE, size = n),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis3u131')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u131: GeneralStatistics expression (auto-extracted; see ref)."
