...
`print(result)` render. See `moirais.fn.describe('chaos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chaos import *
import numpy as np
# See the function signature in fn/chaos.py for argument names.
```
