...
`print(result)` render. See `moirais.fn.describe('droSPI')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.droSPI import *
import numpy as np
# See the function signature in fn/droSPI.py for argument names.
```
