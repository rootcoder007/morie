...
`print(result)` render. See `moirais.fn.describe('srbpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srbpr import *
import numpy as np
# See the function signature in fn/srbpr.py for argument names.
```
