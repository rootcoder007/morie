# describe('rgfm') — rangayyan_fm_signal
...
`print(result)` render. See `moirais.fn.describe('rgfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfm import *
import numpy as np
# See the function signature in fn/rgfm.py for argument names.
```
