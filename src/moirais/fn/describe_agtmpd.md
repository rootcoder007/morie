# describe('agtmpd') — alphazero_temp_decay
...
`print(result)` render. See `moirais.fn.describe('agtmpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agtmpd import *
import numpy as np
# See the function signature in fn/agtmpd.py for argument names.
```
