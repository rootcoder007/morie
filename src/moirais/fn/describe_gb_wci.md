# describe('gb_wci') — gibbons_concordance_signif
...
`print(result)` render. See `moirais.fn.describe('gb_wci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wci import *
import numpy as np
# See the function signature in fn/gb_wci.py for argument names.
```
