...
`print(result)` render. See `moirais.fn.describe('dkmvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkmvc import *
import numpy as np
# See the function signature in fn/dkmvc.py for argument names.
```
