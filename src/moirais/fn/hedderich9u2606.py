...
__all__ = ["hedderich_chapter_9_unnumbered_2606"]


def hedderich_chapter_9_unnumbered_2606(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ✺25/6 = 4.17. We test H0 using the 95% confidence interval: F1 = F14;50;0.975 = 2.14; F2 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2606')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2606: GeneralStatistics expression (auto-extracted; see ref)."
