# describe('gh_dp_reg_post') — ghosal_dp_regression_posterior
...
`print(result)` render. See `moirais.fn.describe('gh_dp_reg_post')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_dp_reg_post import *
import numpy as np
# See the function signature in fn/gh_dp_reg_post.py for argument names.
```
