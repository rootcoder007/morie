# describe('spkfnn') — schabenberger_cross_validation_kriging
...
`print(result)` render. See `moirais.fn.describe('spkfnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spkfnn import *
import numpy as np
# See the function signature in fn/spkfnn.py for argument names.
```
