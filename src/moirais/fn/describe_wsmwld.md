# describe('wsmwld') — wasserman_wald
...
`print(result)` render. See `moirais.fn.describe('wsmwld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmwld import *
import numpy as np
# See the function signature in fn/wsmwld.py for argument names.
```
