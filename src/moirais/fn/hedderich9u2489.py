...
__all__ = ["hedderich_chapter_9_unnumbered_2489"]


def hedderich_chapter_9_unnumbered_2489(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: nContr. = 6 nA = 5 nB = 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2489')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2489: GeneralStatistics expression (auto-extracted; see ref)."
