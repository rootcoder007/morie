# describe('dnneg') — density_negative_weights
...
`print(result)` render. See `moirais.fn.describe('dnneg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnneg import *
import numpy as np
# See the function signature in fn/dnneg.py for argument names.
```
