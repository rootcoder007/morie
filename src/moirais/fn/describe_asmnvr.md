# describe('asmnvr') — genome_assembly
...
`print(result)` render. See `moirais.fn.describe('asmnvr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.asmnvr import *
import numpy as np
# See the function signature in fn/asmnvr.py for argument names.
```
