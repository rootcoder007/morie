# describe('odisp') — otis_disparity_index
...
`print(result)` render. See `moirais.fn.describe('odisp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odisp import *
import numpy as np
# See the function signature in fn/odisp.py for argument names.
```
