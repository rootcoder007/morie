...
`print(result)` render. See `moirais.fn.describe('idppc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idppc import *
import numpy as np
# See the function signature in fn/idppc.py for argument names.
```
