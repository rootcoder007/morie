...
`print(result)` render. See `moirais.fn.describe('spgee')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spgee import *
import numpy as np
# See the function signature in fn/spgee.py for argument names.
```
