...
`print(result)` render. See `moirais.fn.describe('cllvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cllvn import *
import numpy as np
# See the function signature in fn/cllvn.py for argument names.
```
