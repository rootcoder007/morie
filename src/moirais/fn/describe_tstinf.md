# describe('tstinf') — test_information
...
`print(result)` render. See `moirais.fn.describe('tstinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tstinf import *
import numpy as np
# See the function signature in fn/tstinf.py for argument names.
```
