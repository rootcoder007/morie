# describe('joaci') — joseph_adaptive_conformal_inference
...
`print(result)` render. See `moirais.fn.describe('joaci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joaci import *
import numpy as np
# See the function signature in fn/joaci.py for argument names.
```
