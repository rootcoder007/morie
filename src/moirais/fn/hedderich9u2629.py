...
__all__ = ["hedderich_chapter_9_unnumbered_2629"]


def hedderich_chapter_9_unnumbered_2629(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = n(a−c)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2629')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2629: PowerAndDesign expression (auto-extracted; see ref)."
