...
`print(result)` render. See `moirais.fn.describe('morisp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morisp import *
import numpy as np
# See the function signature in fn/morisp.py for argument names.
```
