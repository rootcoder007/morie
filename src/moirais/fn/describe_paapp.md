...
`print(result)` render. See `moirais.fn.describe('paapp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paapp import *
import numpy as np
# See the function signature in fn/paapp.py for argument names.
```
