...
`print(result)` render. See `moirais.fn.describe('wdemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wdemb import *
import numpy as np
# See the function signature in fn/wdemb.py for argument names.
```
