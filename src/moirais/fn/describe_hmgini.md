# describe('hmgini') — geron_gini_impurity
...
`print(result)` render. See `moirais.fn.describe('hmgini')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmgini import *
import numpy as np
# See the function signature in fn/hmgini.py for argument names.
```
