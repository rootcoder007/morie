...
`print(result)` render. See `moirais.fn.describe('coher')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coher import *
import numpy as np
# See the function signature in fn/coher.py for argument names.
```
