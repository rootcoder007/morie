# describe('cmprg') — compliance_by_region
...
`print(result)` render. See `moirais.fn.describe('cmprg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmprg import *
import numpy as np
# See the function signature in fn/cmprg.py for argument names.
```
