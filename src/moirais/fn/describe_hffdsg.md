# describe('hffdsg') — hoeffding_inequality
...
`print(result)` render. See `moirais.fn.describe('hffdsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hffdsg import *
import numpy as np
# See the function signature in fn/hffdsg.py for argument names.
```
