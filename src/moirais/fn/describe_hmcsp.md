...
`print(result)` render. See `moirais.fn.describe('hmcsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcsp import *
import numpy as np
# See the function signature in fn/hmcsp.py for argument names.
```
