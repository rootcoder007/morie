...
__all__ = ["hedderich_chapter_9_unnumbered_1045"]


def hedderich_chapter_9_unnumbered_1045(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (A∩B) = P (X =x,Y =y)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1045')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1045: GeneralStatistics expression (auto-extracted; see ref)."
