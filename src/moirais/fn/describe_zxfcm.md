# describe('zxfcm') — fuzzy_cmeans_sp
...
`print(result)` render. See `moirais.fn.describe('zxfcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxfcm import *
import numpy as np
# See the function signature in fn/zxfcm.py for argument names.
```
