...
`print(result)` render. See `moirais.fn.describe('weisL')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.weisL import *
import numpy as np
# See the function signature in fn/weisL.py for argument names.
```
