...
`print(result)` render. See `moirais.fn.describe('mabuoy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mabuoy import *
import numpy as np
# See the function signature in fn/mabuoy.py for argument names.
```
