...
`print(result)` render. See `moirais.fn.describe('rgsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgsvm import *
import numpy as np
# See the function signature in fn/rgsvm.py for argument names.
```
