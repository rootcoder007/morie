# describe('voldoc') — vol_decomposed_realised
...
`print(result)` render. See `moirais.fn.describe('voldoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.voldoc import *
import numpy as np
# See the function signature in fn/voldoc.py for argument names.
```
