# describe('wquan') — weighted_quantile
...
`print(result)` render. See `moirais.fn.describe('wquan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wquan import *
import numpy as np
# See the function signature in fn/wquan.py for argument names.
```
