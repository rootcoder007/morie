# describe('grtnh') — geron_tanh_activation
...
`print(result)` render. See `moirais.fn.describe('grtnh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtnh import *
import numpy as np
# See the function signature in fn/grtnh.py for argument names.
```
