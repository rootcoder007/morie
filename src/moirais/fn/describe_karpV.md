# describe('karpV') — genetic_programming
...
`print(result)` render. See `moirais.fn.describe('karpV')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.karpV import *
import numpy as np
# See the function signature in fn/karpV.py for argument names.
```
