# describe('lddst') — local_dirichlet_density_estimate
...
`print(result)` render. See `moirais.fn.describe('lddst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lddst import *
import numpy as np
# See the function signature in fn/lddst.py for argument names.
```
