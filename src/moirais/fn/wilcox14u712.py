...
__all__ = ["wilcox_chapter_14_unnumbered_712"]


def wilcox_chapter_14_unnumbered_712(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: (u), where u = (1 − α )B, rounded to the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u712')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u712: Resampling expression (auto-extracted; see ref)."
