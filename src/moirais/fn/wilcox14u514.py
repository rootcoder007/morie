...
__all__ = ["wilcox_chapter_14_unnumbered_514"]


def wilcox_chapter_14_unnumbered_514(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Verify that you do not reject H0 :β 1 = 0 using α = 0.05. Is this result consistent
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u514')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u514: GeneralStatistics expression (auto-extracted; see ref)."
