...
`print(result)` render. See `moirais.fn.describe('dk4vg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk4vg import *
import numpy as np
# See the function signature in fn/dk4vg.py for argument names.
```
