...
`print(result)` render. See `moirais.fn.describe('aitalr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitalr import *
import numpy as np
# See the function signature in fn/aitalr.py for argument names.
```
