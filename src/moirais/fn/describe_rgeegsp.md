# describe('rgeegsp') — rangayyan_eeg_spectral
...
`print(result)` render. See `moirais.fn.describe('rgeegsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeegsp import *
import numpy as np
# See the function signature in fn/rgeegsp.py for argument names.
```
