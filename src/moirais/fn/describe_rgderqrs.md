# describe('rgderqrs') — rangayyan_deriv_qrs
...
`print(result)` render. See `moirais.fn.describe('rgderqrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgderqrs import *
import numpy as np
# See the function signature in fn/rgderqrs.py for argument names.
```
