# describe('msm062') — mvsml_bayesian_regression_eq_6_6
...
`print(result)` render. See `moirais.fn.describe('msm062')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm062 import *
import numpy as np
# See the function signature in fn/msm062.py for argument names.
```
