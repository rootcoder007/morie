...
`print(result)` render. See `moirais.fn.describe('zcrit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zcrit import *
import numpy as np
# See the function signature in fn/zcrit.py for argument names.
```
