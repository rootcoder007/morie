...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_35"]


def information_theory_mackay_chapter_6_unnumbered_35(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E [1=P(x)] =E [f(x)] = 3: (2.78)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u35')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u35: GeneralStatistics expression (auto-extracted; see ref)."
