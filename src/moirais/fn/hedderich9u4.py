...
__all__ = ["hedderich_chapter_9_unnumbered_4"]


def hedderich_chapter_9_unnumbered_4(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: compression)y =bx (b> 1 /b< 1), e.g., length in meters = length in feet times 0.3048.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u4')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u4: GeneralStatistics expression (auto-extracted; see ref)."
