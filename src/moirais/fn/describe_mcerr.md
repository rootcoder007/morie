...
`print(result)` render. See `moirais.fn.describe('mcerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcerr import *
import numpy as np
# See the function signature in fn/mcerr.py for argument names.
```
