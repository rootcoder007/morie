# describe('expos') — exposure_assessment
...
`print(result)` render. See `moirais.fn.describe('expos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.expos import *
import numpy as np
# See the function signature in fn/expos.py for argument names.
```
