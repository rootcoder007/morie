# describe('msm221') — mvsml_ridge_lasso_elastic_eq_9_37
...
`print(result)` render. See `moirais.fn.describe('msm221')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm221 import *
import numpy as np
# See the function signature in fn/msm221.py for argument names.
```
