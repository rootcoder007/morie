...
`print(result)` render. See `moirais.fn.describe('haarf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.haarf import *
import numpy as np
# See the function signature in fn/haarf.py for argument names.
```
