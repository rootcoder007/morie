...
`print(result)` render. See `moirais.fn.describe('skflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.skflt import *
import numpy as np
# See the function signature in fn/skflt.py for argument names.
```
