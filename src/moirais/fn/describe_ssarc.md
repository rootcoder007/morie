# describe('ssarc') — ssa_reconstruct_fn
...
`print(result)` render. See `moirais.fn.describe('ssarc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssarc import *
import numpy as np
# See the function signature in fn/ssarc.py for argument names.
```
