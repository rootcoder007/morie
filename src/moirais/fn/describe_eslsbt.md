...
`print(result)` render. See `moirais.fn.describe('eslsbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslsbt import *
import numpy as np
# See the function signature in fn/eslsbt.py for argument names.
```
