...
__all__ = ["hedderich_chapter_9_unnumbered_3037"]


def hedderich_chapter_9_unnumbered_3037(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] D1 n11 = 35 n12 = 5 n13 = 0 n1. = 40
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3037')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3037: GeneralStatistics expression (auto-extracted; see ref)."
