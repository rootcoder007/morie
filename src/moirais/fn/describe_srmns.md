...
`print(result)` render. See `moirais.fn.describe('srmns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmns import *
import numpy as np
# See the function signature in fn/srmns.py for argument names.
```
