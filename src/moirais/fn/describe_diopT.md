...
`print(result)` render. See `moirais.fn.describe('diopT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diopT import *
import numpy as np
# See the function signature in fn/diopT.py for argument names.
```
