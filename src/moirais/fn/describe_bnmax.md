...
`print(result)` render. See `moirais.fn.describe('bnmax')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnmax import *
import numpy as np
# See the function signature in fn/bnmax.py for argument names.
```
