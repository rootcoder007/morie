...
`print(result)` render. See `moirais.fn.describe('ccdsgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccdsgn import *
import numpy as np
# See the function signature in fn/ccdsgn.py for argument names.
```
