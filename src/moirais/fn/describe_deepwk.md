...
`print(result)` render. See `moirais.fn.describe('deepwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deepwk import *
import numpy as np
# See the function signature in fn/deepwk.py for argument names.
```
