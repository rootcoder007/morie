# describe('odm_s') — otis_demo_standardize
...
`print(result)` render. See `moirais.fn.describe('odm_s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_s import *
import numpy as np
# See the function signature in fn/odm_s.py for argument names.
```
