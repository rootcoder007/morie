# describe('groot') — logistic_growth
...
`print(result)` render. See `moirais.fn.describe('groot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groot import *
import numpy as np
# See the function signature in fn/groot.py for argument names.
```
