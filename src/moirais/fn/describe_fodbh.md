# describe('fodbh') — fodbh

## WHAT IT DOES

DBH distribution spatial
...
`print(result)` render. See `moirais.fn.describe('fodbh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fodbh import *
import numpy as np
# See the function signature in fn/fodbh.py for argument names.
```
