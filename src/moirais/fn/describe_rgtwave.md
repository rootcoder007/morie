# describe('rgtwave') — rangayyan_t_wave_detect
...
`print(result)` render. See `moirais.fn.describe('rgtwave')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgtwave import *
import numpy as np
# See the function signature in fn/rgtwave.py for argument names.
```
