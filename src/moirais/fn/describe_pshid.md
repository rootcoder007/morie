...
`print(result)` render. See `moirais.fn.describe('pshid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pshid import *
import numpy as np
# See the function signature in fn/pshid.py for argument names.
```
