# describe('survc') — survival_concordance
...
`print(result)` render. See `moirais.fn.describe('survc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survc import *
import numpy as np
# See the function signature in fn/survc.py for argument names.
```
