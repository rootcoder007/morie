...
`print(result)` render. See `moirais.fn.describe('siutrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siutrn import *
import numpy as np
# See the function signature in fn/siutrn.py for argument names.
```
