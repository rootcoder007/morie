# describe('rgvocal') — rangayyan_vocal_tract
...
`print(result)` render. See `moirais.fn.describe('rgvocal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvocal import *
import numpy as np
# See the function signature in fn/rgvocal.py for argument names.
```
