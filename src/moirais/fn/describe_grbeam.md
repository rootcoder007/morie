# describe('grbeam') — geron_beam_search_decoder
...
`print(result)` render. See `moirais.fn.describe('grbeam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbeam import *
import numpy as np
# See the function signature in fn/grbeam.py for argument names.
```
