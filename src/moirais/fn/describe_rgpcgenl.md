# describe('rgpcgenl') — rangayyan_pcg_envelope_avg
...
`print(result)` render. See `moirais.fn.describe('rgpcgenl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpcgenl import *
import numpy as np
# See the function signature in fn/rgpcgenl.py for argument names.
```
