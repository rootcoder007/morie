...
`print(result)` render. See `moirais.fn.describe('latdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.latdt import *
import numpy as np
# See the function signature in fn/latdt.py for argument names.
```
