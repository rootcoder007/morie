# describe('icerr') — incremental_cost_effectiveness_ratio
...
`print(result)` render. See `moirais.fn.describe('icerr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icerr import *
import numpy as np
# See the function signature in fn/icerr.py for argument names.
```
