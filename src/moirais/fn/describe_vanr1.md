# describe('vanr1') — vanraden_method1
...
`print(result)` render. See `moirais.fn.describe('vanr1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vanr1 import *
import numpy as np
# See the function signature in fn/vanr1.py for argument names.
```
