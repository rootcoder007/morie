# describe('vaccv') — vaccine_coverage
...
`print(result)` render. See `moirais.fn.describe('vaccv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vaccv import *
import numpy as np
# See the function signature in fn/vaccv.py for argument names.
```
