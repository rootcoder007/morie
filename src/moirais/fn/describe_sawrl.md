...
`print(result)` render. See `moirais.fn.describe('sawrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawrl import *
import numpy as np
# See the function signature in fn/sawrl.py for argument names.
```
