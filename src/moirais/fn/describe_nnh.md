# describe('nnh') — number_needed_to_harm
...
`print(result)` render. See `moirais.fn.describe('nnh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnh import *
import numpy as np
# See the function signature in fn/nnh.py for argument names.
```
