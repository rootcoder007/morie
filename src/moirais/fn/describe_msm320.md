# describe('msm320') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm320')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm320 import *
import numpy as np
# See the function signature in fn/msm320.py for argument names.
```
