...
`print(result)` render. See `moirais.fn.describe('sfmemp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfmemp import *
import numpy as np
# See the function signature in fn/sfmemp.py for argument names.
```
