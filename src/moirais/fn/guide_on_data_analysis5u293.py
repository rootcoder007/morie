...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_293"]


def guide_on_data_analysis_chapter_5_unnumbered_293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] I − H = I − X(X′X)−1X′,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u293')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u293: GeneralStatistics expression (auto-extracted; see ref)."
