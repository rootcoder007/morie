...
__all__ = ["wilcox_chapter_7_unnumbered_321"]


def wilcox_chapter_7_unnumbered_321(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox7u321')`` for the full guide.
...
def cheatsheet():
    return "wilcox7u321: PowerAndDesign expression (auto-extracted; see ref)."
