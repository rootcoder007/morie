...
`print(result)` render. See `moirais.fn.describe('grest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grest import *
import numpy as np
# See the function signature in fn/grest.py for argument names.
```
