# describe('pmcrt') — pepe_mori_cif_test
...
`print(result)` render. See `moirais.fn.describe('pmcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmcrt import *
import numpy as np
# See the function signature in fn/pmcrt.py for argument names.
```
