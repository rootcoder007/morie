# describe('msm012') — mvsml_linear_mixed_models_eq_5_2
...
`print(result)` render. See `moirais.fn.describe('msm012')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm012 import *
import numpy as np
# See the function signature in fn/msm012.py for argument names.
```
