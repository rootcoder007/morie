# describe('sgtcheeg') — sgt_cheeger_constant
...
`print(result)` render. See `moirais.fn.describe('sgtcheeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtcheeg import *
import numpy as np
# See the function signature in fn/sgtcheeg.py for argument names.
```
