# describe('hodprc') — hodrick_prescott
...
`print(result)` render. See `moirais.fn.describe('hodprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hodprc import *
import numpy as np
# See the function signature in fn/hodprc.py for argument names.
```
