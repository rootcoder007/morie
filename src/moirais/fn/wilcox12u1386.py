...
__all__ = ["wilcox_chapter_12_unnumbered_1386"]


def wilcox_chapter_12_unnumbered_1386(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] .5(5/10 + 6 /10) = 10 .79, q = 4.06, reject. (e)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1386')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1386: GeneralStatistics expression (auto-extracted; see ref)."
