# describe('rgosflt') — rangayyan_order_stat_flt
...
`print(result)` render. See `moirais.fn.describe('rgosflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgosflt import *
import numpy as np
# See the function signature in fn/rgosflt.py for argument names.
```
