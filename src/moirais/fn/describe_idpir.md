...
`print(result)` render. See `moirais.fn.describe('idpir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idpir import *
import numpy as np
# See the function signature in fn/idpir.py for argument names.
```
