# describe('hmbntr') — geron_batch_normalization
...
`print(result)` render. See `moirais.fn.describe('hmbntr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbntr import *
import numpy as np
# See the function signature in fn/hmbntr.py for argument names.
```
