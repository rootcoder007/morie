...
`print(result)` render. See `moirais.fn.describe('sawnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawnm import *
import numpy as np
# See the function signature in fn/sawnm.py for argument names.
```
