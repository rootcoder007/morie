...
__all__ = ["hedderich_chapter_9_unnumbered_2124"]


def hedderich_chapter_9_unnumbered_2124(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 2.205> 1.645 = z0.95
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2124')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2124: GeneralStatistics expression (auto-extracted; see ref)."
