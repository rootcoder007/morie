...
__all__ = ["hedderich_chapter_9_unnumbered_3674"]


def hedderich_chapter_9_unnumbered_3674(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3674')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3674: GeneralStatistics expression (auto-extracted; see ref)."
