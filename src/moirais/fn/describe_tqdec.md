# describe('tqdec') — turboquant_decode
...
`print(result)` render. See `moirais.fn.describe('tqdec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqdec import *
import numpy as np
# See the function signature in fn/tqdec.py for argument names.
```
