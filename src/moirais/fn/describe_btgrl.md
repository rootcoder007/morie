# describe('btgrl') — bagplot_outliers
...
`print(result)` render. See `moirais.fn.describe('btgrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btgrl import *
import numpy as np
# See the function signature in fn/btgrl.py for argument names.
```
