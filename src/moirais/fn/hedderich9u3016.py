...
__all__ = ["hedderich_chapter_9_unnumbered_3016"]


def hedderich_chapter_9_unnumbered_3016(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: + p . expr <− quote ( pchisq ( quant , df =nu , ncp = n * w^2 , lower =FALSE ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3016')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3016: ContingencyTables expression (auto-extracted; see ref)."
