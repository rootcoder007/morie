# describe('otpot') — ot_pot_log_potentials
...
`print(result)` render. See `moirais.fn.describe('otpot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otpot import *
import numpy as np
# See the function signature in fn/otpot.py for argument names.
```
