...
`print(result)` render. See `moirais.fn.describe('kgrms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgrms import *
import numpy as np
# See the function signature in fn/kgrms.py for argument names.
```
