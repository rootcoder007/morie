# describe('ghs018') — ghosal_ch3_tree_splitting_variables
...
`print(result)` render. See `moirais.fn.describe('ghs018')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs018 import *
import numpy as np
# See the function signature in fn/ghs018.py for argument names.
```
