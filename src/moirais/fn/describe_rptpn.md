# describe('rptpn') — repetition_penalty
...
`print(result)` render. See `moirais.fn.describe('rptpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rptpn import *
import numpy as np
# See the function signature in fn/rptpn.py for argument names.
```
