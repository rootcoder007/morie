...
__all__ = ["hedderich_chapter_9_unnumbered_3670"]


def hedderich_chapter_9_unnumbered_3670(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0 : α0;yx =αyx . . . . . . . . . . . . . . . . .790
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3670')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3670: GeneralStatistics expression (auto-extracted; see ref)."
