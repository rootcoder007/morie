...
`print(result)` render. See `moirais.fn.describe('hmxgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmxgb import *
import numpy as np
# See the function signature in fn/hmxgb.py for argument names.
```
