# describe('tnsrd') — tensor_decompose
...
`print(result)` render. See `moirais.fn.describe('tnsrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tnsrd import *
import numpy as np
# See the function signature in fn/tnsrd.py for argument names.
```
