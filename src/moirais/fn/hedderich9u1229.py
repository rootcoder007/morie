...
__all__ = ["hedderich_chapter_9_unnumbered_1229"]


def hedderich_chapter_9_unnumbered_1229(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] exp (z1−α/2·ˆσ)ρ̄≤ˆρ·exp (z1−α/2·ˆσ)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1229')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1229: CountModels expression (auto-extracted; see ref)."
