...
__all__ = ["wilcox_chapter_13_unnumbered_1176"]


def wilcox_chapter_13_unnumbered_1176(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (u), where u = (1 − α )B
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1176')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1176: GeneralStatistics expression (auto-extracted; see ref)."
