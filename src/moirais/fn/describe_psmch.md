# describe('psmch') — propensity_match
...
`print(result)` render. See `moirais.fn.describe('psmch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psmch import *
import numpy as np
# See the function signature in fn/psmch.py for argument names.
```
