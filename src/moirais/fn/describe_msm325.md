# describe('msm325') — mvsml_functional_regression_eq_15_2
...
`print(result)` render. See `moirais.fn.describe('msm325')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm325 import *
import numpy as np
# See the function signature in fn/msm325.py for argument names.
```
