# describe('snpeff') — variant_effect
...
`print(result)` render. See `moirais.fn.describe('snpeff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.snpeff import *
import numpy as np
# See the function signature in fn/snpeff.py for argument names.
```
