...
__all__ = ["wilcox_chapter_2_unnumbered_302"]


def wilcox_chapter_2_unnumbered_302(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0.05, so α/2 = 0 .025, and 1 − α/2 = 0 .975. Referring to Table 4 in Appendix B,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u302')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u302: GeneralStatistics expression (auto-extracted; see ref)."
