# describe('rigdg') — ridge_regression
...
`print(result)` render. See `moirais.fn.describe('rigdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rigdg import *
import numpy as np
# See the function signature in fn/rigdg.py for argument names.
```
