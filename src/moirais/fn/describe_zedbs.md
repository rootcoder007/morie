...
`print(result)` render. See `moirais.fn.describe('zedbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zedbs import *
import numpy as np
# See the function signature in fn/zedbs.py for argument names.
```
