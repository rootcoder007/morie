# describe('relua') — relu_activation
...
`print(result)` render. See `moirais.fn.describe('relua')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.relua import *
import numpy as np
# See the function signature in fn/relua.py for argument names.
```
