...
`print(result)` render. See `moirais.fn.describe('holo_d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_d import *
import numpy as np
# See the function signature in fn/holo_d.py for argument names.
```
