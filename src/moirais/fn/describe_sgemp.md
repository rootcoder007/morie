# describe('sgemp') — empirical_semivariogram
...
`print(result)` render. See `moirais.fn.describe('sgemp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgemp import *
import numpy as np
# See the function signature in fn/sgemp.py for argument names.
```
