# describe('gb34vr') — gibbons_runs_ud_var
...
`print(result)` render. See `moirais.fn.describe('gb34vr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb34vr import *
import numpy as np
# See the function signature in fn/gb34vr.py for argument names.
```
