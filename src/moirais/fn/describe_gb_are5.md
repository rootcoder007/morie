# describe('gb_are5') — gibbons_are_scale_tests
...
`print(result)` render. See `moirais.fn.describe('gb_are5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_are5 import *
import numpy as np
# See the function signature in fn/gb_are5.py for argument names.
```
