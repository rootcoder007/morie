...
`print(result)` render. See `moirais.fn.describe('ntruc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ntruc import *
import numpy as np
# See the function signature in fn/ntruc.py for argument names.
```
