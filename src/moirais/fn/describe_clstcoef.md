# describe('clstcoef') — clustering_coefficient
...
`print(result)` render. See `moirais.fn.describe('clstcoef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clstcoef import *
import numpy as np
# See the function signature in fn/clstcoef.py for argument names.
```
