# describe('agmuef') — muzero_efficient_exploration
...
`print(result)` render. See `moirais.fn.describe('agmuef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmuef import *
import numpy as np
# See the function signature in fn/agmuef.py for argument names.
```
