...
__all__ = ["guide_on_data_analysis_chapter_14_unnumbered_871"]


def guide_on_data_analysis_chapter_14_unnumbered_871(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝐿𝑅 = −2 (ln 𝐿𝑅 − ln 𝐿𝑈)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis14u871')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis14u871: GeneralStatistics expression (auto-extracted; see ref)."
