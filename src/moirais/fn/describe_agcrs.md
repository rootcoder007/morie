...
`print(result)` render. See `moirais.fn.describe('agcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agcrs import *
import numpy as np
# See the function signature in fn/agcrs.py for argument names.
```
