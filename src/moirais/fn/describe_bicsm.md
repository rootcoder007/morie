...
`print(result)` render. See `moirais.fn.describe('bicsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bicsm import *
import numpy as np
# See the function signature in fn/bicsm.py for argument names.
```
