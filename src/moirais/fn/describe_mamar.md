...
`print(result)` render. See `moirais.fn.describe('mamar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mamar import *
import numpy as np
# See the function signature in fn/mamar.py for argument names.
```
