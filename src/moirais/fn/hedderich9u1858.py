...
__all__ = ["hedderich_chapter_9_unnumbered_1858"]


def hedderich_chapter_9_unnumbered_1858(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 0 must be rejected in favor ofHA :σ2 >σ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1858')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1858: GeneralStatistics expression (auto-extracted; see ref)."
