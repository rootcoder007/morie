# describe('vrnrm') — normalized_variance
...
`print(result)` render. See `moirais.fn.describe('vrnrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrnrm import *
import numpy as np
# See the function signature in fn/vrnrm.py for argument names.
```
