...
`print(result)` render. See `moirais.fn.describe('ahsoka')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ahsoka import *
import numpy as np
# See the function signature in fn/ahsoka.py for argument names.
```
