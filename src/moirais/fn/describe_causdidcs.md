# describe('causdidcs') — causal_did_callaway_sa
...
`print(result)` render. See `moirais.fn.describe('causdidcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causdidcs import *
import numpy as np
# See the function signature in fn/causdidcs.py for argument names.
```
