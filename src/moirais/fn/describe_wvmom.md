...
`print(result)` render. See `moirais.fn.describe('wvmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvmom import *
import numpy as np
# See the function signature in fn/wvmom.py for argument names.
```
