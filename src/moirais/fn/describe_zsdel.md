...
`print(result)` render. See `moirais.fn.describe('zsdel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsdel import *
import numpy as np
# See the function signature in fn/zsdel.py for argument names.
```
