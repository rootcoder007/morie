# describe('docl3') — do_calculus_rules
...
`print(result)` render. See `moirais.fn.describe('docl3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.docl3 import *
import numpy as np
# See the function signature in fn/docl3.py for argument names.
```
