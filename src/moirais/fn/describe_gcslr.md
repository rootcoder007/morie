...
`print(result)` render. See `moirais.fn.describe('gcslr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcslr import *
import numpy as np
# See the function signature in fn/gcslr.py for argument names.
```
