...
`print(result)` render. See `moirais.fn.describe('prsLL')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsLL import *
import numpy as np
# See the function signature in fn/prsLL.py for argument names.
```
