# describe('rpenc') — rpenc

## WHAT IT DOES

rRotary positional encoding (RoPE).
...
`print(result)` render. See `moirais.fn.describe('rpenc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpenc import *
import numpy as np
# See the function signature in fn/rpenc.py for argument names.
```
