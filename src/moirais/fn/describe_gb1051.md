# describe('gb1051') — gibbons_k_rank_alt
...
`print(result)` render. See `moirais.fn.describe('gb1051')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1051 import *
import numpy as np
# See the function signature in fn/gb1051.py for argument names.
```
