# describe('quadu') — quadratic_utility
...
`print(result)` render. See `moirais.fn.describe('quadu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.quadu import *
import numpy as np
# See the function signature in fn/quadu.py for argument names.
```
