...
`print(result)` render. See `moirais.fn.describe('gcssp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcssp import *
import numpy as np
# See the function signature in fn/gcssp.py for argument names.
```
