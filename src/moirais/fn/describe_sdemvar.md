...
`print(result)` render. See `moirais.fn.describe('sdemvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemvar import *
import numpy as np
# See the function signature in fn/sdemvar.py for argument names.
```
