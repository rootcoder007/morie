...
`print(result)` render. See `moirais.fn.describe('trace')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trace import *
import numpy as np
# See the function signature in fn/trace.py for argument names.
```
