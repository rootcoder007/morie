...
`print(result)` render. See `moirais.fn.describe('scrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scrst import *
import numpy as np
# See the function signature in fn/scrst.py for argument names.
```
