# describe('ar2rc') — ar_to_reflection
...
`print(result)` render. See `moirais.fn.describe('ar2rc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ar2rc import *
import numpy as np
# See the function signature in fn/ar2rc.py for argument names.
```
