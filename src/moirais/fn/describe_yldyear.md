# describe('yldyear') — yld_calculation
...
`print(result)` render. See `moirais.fn.describe('yldyear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.yldyear import *
import numpy as np
# See the function signature in fn/yldyear.py for argument names.
```
