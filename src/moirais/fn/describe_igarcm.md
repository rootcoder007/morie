# describe('igarcm') — igarch_integrated
...
`print(result)` render. See `moirais.fn.describe('igarcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.igarcm import *
import numpy as np
# See the function signature in fn/igarcm.py for argument names.
```
