# describe('evppgev') — evt_gev_pp_plot
...
`print(result)` render. See `moirais.fn.describe('evppgev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evppgev import *
import numpy as np
# See the function signature in fn/evppgev.py for argument names.
```
