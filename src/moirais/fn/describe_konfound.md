...
`print(result)` render. See `moirais.fn.describe('konfound')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.konfound import *
import numpy as np
# See the function signature in fn/konfound.py for argument names.
```
