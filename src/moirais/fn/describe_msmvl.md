# describe('msmvl') — elastic_deformation
...
`print(result)` render. See `moirais.fn.describe('msmvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmvl import *
import numpy as np
# See the function signature in fn/msmvl.py for argument names.
```
