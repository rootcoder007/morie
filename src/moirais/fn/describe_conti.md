# describe('conti') — continued_fraction_pi
...
`print(result)` render. See `moirais.fn.describe('conti')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.conti import *
import numpy as np
# See the function signature in fn/conti.py for argument names.
```
