# describe('tmlqsa') — tmle_quasi_score
...
`print(result)` render. See `moirais.fn.describe('tmlqsa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlqsa import *
import numpy as np
# See the function signature in fn/tmlqsa.py for argument names.
```
