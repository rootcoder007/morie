...
`print(result)` render. See `moirais.fn.describe('bfac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfac import *
import numpy as np
# See the function signature in fn/bfac.py for argument names.
```
