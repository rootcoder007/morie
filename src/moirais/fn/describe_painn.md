...
`print(result)` render. See `moirais.fn.describe('painn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.painn import *
import numpy as np
# See the function signature in fn/painn.py for argument names.
```
