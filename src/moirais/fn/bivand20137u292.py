...
__all__ = ["bivand2013_chapter_7_unnumbered_292"]


def bivand2013_chapter_7_unnumbered_292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H1 : θ(1) ≥... ≥θ(n)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u292')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u292: GeneralStatistics expression (auto-extracted; see ref)."
