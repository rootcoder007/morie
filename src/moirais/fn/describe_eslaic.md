...
`print(result)` render. See `moirais.fn.describe('eslaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslaic import *
import numpy as np
# See the function signature in fn/eslaic.py for argument names.
```
