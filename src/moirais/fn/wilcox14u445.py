...
__all__ = ["wilcox_chapter_14_unnumbered_445"]


def wilcox_chapter_14_unnumbered_445(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: olshc4band(x,y,alpha=0.05,xout=FALSE,outfun=outpro,plotit=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u445')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u445: PowerAndDesign expression (auto-extracted; see ref)."
