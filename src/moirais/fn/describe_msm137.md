# describe('msm137') — mvsml_categorical_count_eq_8_7
...
`print(result)` render. See `moirais.fn.describe('msm137')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm137 import *
import numpy as np
# See the function signature in fn/msm137.py for argument names.
```
