# describe('blups') — blup_random_slope
...
`print(result)` render. See `moirais.fn.describe('blups')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blups import *
import numpy as np
# See the function signature in fn/blups.py for argument names.
```
