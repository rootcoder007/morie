# describe('cvxqsv') — boyd_qcqp_relaxation
...
`print(result)` render. See `moirais.fn.describe('cvxqsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxqsv import *
import numpy as np
# See the function signature in fn/cvxqsv.py for argument names.
```
