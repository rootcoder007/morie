...
`print(result)` render. See `moirais.fn.describe('laclihh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laclihh import *
import numpy as np
# See the function signature in fn/laclihh.py for argument names.
```
