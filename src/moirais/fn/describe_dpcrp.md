# describe('dpcrp') — chinese_restaurant_process
...
`print(result)` render. See `moirais.fn.describe('dpcrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpcrp import *
import numpy as np
# See the function signature in fn/dpcrp.py for argument names.
```
