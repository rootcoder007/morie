...
__all__ = ["hedderich_chapter_9_unnumbered_1950"]


def hedderich_chapter_9_unnumbered_1950(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1950')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1950: PowerAndDesign expression (auto-extracted; see ref)."
