...
`print(result)` render. See `moirais.fn.describe('edgfp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.edgfp import *
import numpy as np
# See the function signature in fn/edgfp.py for argument names.
```
