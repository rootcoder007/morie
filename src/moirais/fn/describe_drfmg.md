# describe('drfmg') — drift_magnitude
...
`print(result)` render. See `moirais.fn.describe('drfmg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drfmg import *
import numpy as np
# See the function signature in fn/drfmg.py for argument names.
```
