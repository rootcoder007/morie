# describe('rgam') — rangayyan_am_signal
...
`print(result)` render. See `moirais.fn.describe('rgam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgam import *
import numpy as np
# See the function signature in fn/rgam.py for argument names.
```
