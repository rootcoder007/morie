# describe('ascmcl') — augmented_synthetic_control
...
`print(result)` render. See `moirais.fn.describe('ascmcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ascmcl import *
import numpy as np
# See the function signature in fn/ascmcl.py for argument names.
```
