...
__all__ = ["wilcox_chapter_14_unnumbered_714"]


def wilcox_chapter_14_unnumbered_714(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: δ 13 =θ 1 − θ 3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u714')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u714: GeneralStatistics expression (auto-extracted; see ref)."
