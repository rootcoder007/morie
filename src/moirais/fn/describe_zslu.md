...
`print(result)` render. See `moirais.fn.describe('zslu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zslu import *
import numpy as np
# See the function signature in fn/zslu.py for argument names.
```
