...
__all__ = ["hedderich_chapter_9_unnumbered_17"]


def hedderich_chapter_9_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: kxi =kx1 +kx2 +...=k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u17')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u17: GeneralStatistics expression (auto-extracted; see ref)."
