...
`print(result)` render. See `moirais.fn.describe('cvxsoc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxsoc import *
import numpy as np
# See the function signature in fn/cvxsoc.py for argument names.
```
