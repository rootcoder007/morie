...
`print(result)` render. See `moirais.fn.describe('wlog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlog import *
import numpy as np
# See the function signature in fn/wlog.py for argument names.
```
