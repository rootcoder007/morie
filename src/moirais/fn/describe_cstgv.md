# describe('cstgv') — custody_grievance_rate
...
`print(result)` render. See `moirais.fn.describe('cstgv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstgv import *
import numpy as np
# See the function signature in fn/cstgv.py for argument names.
```
