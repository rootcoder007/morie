...
`print(result)` render. See `moirais.fn.describe('gescd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gescd import *
import numpy as np
# See the function signature in fn/gescd.py for argument names.
```
