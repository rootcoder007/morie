# describe('msm302') — mvsml_convolutional_nn_eq_14_14
...
`print(result)` render. See `moirais.fn.describe('msm302')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm302 import *
import numpy as np
# See the function signature in fn/msm302.py for argument names.
```
