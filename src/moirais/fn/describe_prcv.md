...
`print(result)` render. See `moirais.fn.describe('prcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prcv import *
import numpy as np
# See the function signature in fn/prcv.py for argument names.
```
