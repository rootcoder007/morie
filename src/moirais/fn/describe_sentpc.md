...
`print(result)` render. See `moirais.fn.describe('sentpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sentpc import *
import numpy as np
# See the function signature in fn/sentpc.py for argument names.
```
