...
`print(result)` render. See `moirais.fn.describe('dkkrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkkrn import *
import numpy as np
# See the function signature in fn/dkkrn.py for argument names.
```
