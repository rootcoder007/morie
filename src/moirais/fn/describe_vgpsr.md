# describe('vgpsr') — partial_sill_ratio
...
`print(result)` render. See `moirais.fn.describe('vgpsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgpsr import *
import numpy as np
# See the function signature in fn/vgpsr.py for argument names.
```
