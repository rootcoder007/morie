# describe('gh_c7_8') — ghosal_loc_semipara
...
`print(result)` render. See `moirais.fn.describe('gh_c7_8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_8 import *
import numpy as np
# See the function signature in fn/gh_c7_8.py for argument names.
```
