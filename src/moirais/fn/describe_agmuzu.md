# describe('agmuzu') — muzero_world_model
...
`print(result)` render. See `moirais.fn.describe('agmuzu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmuzu import *
import numpy as np
# See the function signature in fn/agmuzu.py for argument names.
```
