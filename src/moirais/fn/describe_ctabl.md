# describe('ctabl') — contingency_table

## WHAT IT DOES

Contingency table with chi-squared test. 'You have power over your mind. — Marcus Aurelius'
...
`print(result)` render. See `moirais.fn.describe('ctabl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctabl import *
import numpy as np
# See the function signature in fn/ctabl.py for argument names.
```
