...
`print(result)` render. See `moirais.fn.describe('awltrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.awltrn import *
import numpy as np
# See the function signature in fn/awltrn.py for argument names.
```
