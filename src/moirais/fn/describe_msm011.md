# describe('msm011') — mvsml_linear_mixed_models_eq_5_2
...
`print(result)` render. See `moirais.fn.describe('msm011')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm011 import *
import numpy as np
# See the function signature in fn/msm011.py for argument names.
```
