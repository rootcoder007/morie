...
`print(result)` render. See `moirais.fn.describe('rssvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rssvm import *
import numpy as np
# See the function signature in fn/rssvm.py for argument names.
```
