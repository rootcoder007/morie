...
__all__ = ["wilcox_chapter_10_unnumbered_947"]


def wilcox_chapter_10_unnumbered_947(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 7. Let u = (1 − α )B, rounded to the nearest integer. Then the confidence interval
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u947')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u947: GeneralStatistics expression (auto-extracted; see ref)."
