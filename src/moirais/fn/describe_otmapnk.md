# describe('otmapnk') — ot_map_neural_kantorovich
...
`print(result)` render. See `moirais.fn.describe('otmapnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmapnk import *
import numpy as np
# See the function signature in fn/otmapnk.py for argument names.
```
