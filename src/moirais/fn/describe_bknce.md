# describe('bknce') — burkov_noise_contrastive_estimation
...
`print(result)` render. See `moirais.fn.describe('bknce')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bknce import *
import numpy as np
# See the function signature in fn/bknce.py for argument names.
```
