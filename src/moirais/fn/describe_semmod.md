# describe('semmod') — spatial_error_model
...
`print(result)` render. See `moirais.fn.describe('semmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semmod import *
import numpy as np
# See the function signature in fn/semmod.py for argument names.
```
