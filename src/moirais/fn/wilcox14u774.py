...
__all__ = ["wilcox_chapter_14_unnumbered_774"]


def wilcox_chapter_14_unnumbered_774(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] H0 :β 1 = · · · =β K = 0,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u774')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u774: GeneralStatistics expression (auto-extracted; see ref)."
