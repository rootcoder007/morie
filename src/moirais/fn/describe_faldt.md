# describe('faldt') — fall_time_detect
...
`print(result)` render. See `moirais.fn.describe('faldt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.faldt import *
import numpy as np
# See the function signature in fn/faldt.py for argument names.
```
