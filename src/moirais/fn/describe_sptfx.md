...
`print(result)` render. See `moirais.fn.describe('sptfx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptfx import *
import numpy as np
# See the function signature in fn/sptfx.py for argument names.
```
