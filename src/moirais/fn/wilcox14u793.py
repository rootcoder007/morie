...
__all__ = ["wilcox_chapter_14_unnumbered_793"]


def wilcox_chapter_14_unnumbered_793(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: levels. Table 10.6 indicates that N − JK = 6, but JK = 6, so N − JK = N − 6 = 6, and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u793')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u793: GeneralStatistics expression (auto-extracted; see ref)."
