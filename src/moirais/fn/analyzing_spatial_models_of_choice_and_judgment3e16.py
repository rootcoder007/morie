...
__all__ = ["analyzing_spatial_models_of_choice_and_judgment_chapter_3_equation_16"]


def analyzing_spatial_models_of_choice_and_judgment_chapter_3_equation_16(x, cdf=None):
    """
    GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.

    Formula: σ (X) = ∑ w jm d 2jm (X) + ∑ w jm
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment3e16')`` for the full guide.

    References
    ----------
    Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment, ch.3 eq.3.16
    """
...
def cheatsheet():
    return "analyzing_spatial_models_of_choice_and_judgment3e16: GeneralStatistics equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment."
