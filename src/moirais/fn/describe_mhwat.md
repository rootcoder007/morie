# describe('mhwat') — wait_time_analysis
...
`print(result)` render. See `moirais.fn.describe('mhwat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhwat import *
import numpy as np
# See the function signature in fn/mhwat.py for argument names.
```
