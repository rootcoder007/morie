...
`print(result)` render. See `moirais.fn.describe('grkfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkfd import *
import numpy as np
# See the function signature in fn/grkfd.py for argument names.
```
