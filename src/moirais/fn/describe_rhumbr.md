...
`print(result)` render. See `moirais.fn.describe('rhumbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rhumbr import *
import numpy as np
# See the function signature in fn/rhumbr.py for argument names.
```
