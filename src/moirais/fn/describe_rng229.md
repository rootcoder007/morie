# describe('rng229') — rangayyan_ch4_matched_filter_output_psd
...
`print(result)` render. See `moirais.fn.describe('rng229')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng229 import *
import numpy as np
# See the function signature in fn/rng229.py for argument names.
```
