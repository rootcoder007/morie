...
`print(result)` render. See `moirais.fn.describe('dlasm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlasm import *
import numpy as np
# See the function signature in fn/dlasm.py for argument names.
```
