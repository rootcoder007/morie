...
`print(result)` render. See `moirais.fn.describe('kblup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kblup import *
import numpy as np
# See the function signature in fn/kblup.py for argument names.
```
