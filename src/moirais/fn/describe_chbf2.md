# describe('chbf2') — chebyshev2_filter
...
`print(result)` render. See `moirais.fn.describe('chbf2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chbf2 import *
import numpy as np
# See the function signature in fn/chbf2.py for argument names.
```
