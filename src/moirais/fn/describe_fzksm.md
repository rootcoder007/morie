# describe('fzksm') — fauzi_ks_smoothed
...
`print(result)` render. See `moirais.fn.describe('fzksm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzksm import *
import numpy as np
# See the function signature in fn/fzksm.py for argument names.
```
