# describe('icc1k') — icc_one_way_average
...
`print(result)` render. See `moirais.fn.describe('icc1k')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc1k import *
import numpy as np
# See the function signature in fn/icc1k.py for argument names.
```
