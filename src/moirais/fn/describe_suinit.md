# describe('suinit') — initiation_age
...
`print(result)` render. See `moirais.fn.describe('suinit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suinit import *
import numpy as np
# See the function signature in fn/suinit.py for argument names.
```
