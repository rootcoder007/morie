...
__all__ = ["wilcox_chapter_5_unnumbered_426"]


def wilcox_chapter_5_unnumbered_426(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ols(x, y, xout = FALSE, outfun = outpro, plotit = FALSE, xlab = "X", ylab =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u426')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u426: GeneralStatistics expression (auto-extracted; see ref)."
