# describe('egcoin') — engle_granger_2step
...
`print(result)` render. See `moirais.fn.describe('egcoin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egcoin import *
import numpy as np
# See the function signature in fn/egcoin.py for argument names.
```
