# describe('rghomo') — rangayyan_homomorphic
...
`print(result)` render. See `moirais.fn.describe('rghomo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghomo import *
import numpy as np
# See the function signature in fn/rghomo.py for argument names.
```
