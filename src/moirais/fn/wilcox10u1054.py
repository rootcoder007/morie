...
__all__ = ["wilcox_chapter_10_unnumbered_1054"]


def wilcox_chapter_10_unnumbered_1054(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] H0 :θ 1 − θ 2 = 0. (13.5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1054')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1054: Resampling expression (auto-extracted; see ref)."
