# describe('whtinv') — walsh_hadamard_inverse
...
`print(result)` render. See `moirais.fn.describe('whtinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.whtinv import *
import numpy as np
# See the function signature in fn/whtinv.py for argument names.
```
