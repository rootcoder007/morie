# describe('causivla') — causal_iv_late
...
`print(result)` render. See `moirais.fn.describe('causivla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causivla import *
import numpy as np
# See the function signature in fn/causivla.py for argument names.
```
