# describe('msm139') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm139')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm139 import *
import numpy as np
# See the function signature in fn/msm139.py for argument names.
```
