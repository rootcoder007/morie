# describe('eslmix') — esl_gaussian_mixture
...
`print(result)` render. See `moirais.fn.describe('eslmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslmix import *
import numpy as np
# See the function signature in fn/eslmix.py for argument names.
```
