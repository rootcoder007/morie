# describe('ghs022') — ghosal_ch3_tailfree_cell_counts
...
`print(result)` render. See `moirais.fn.describe('ghs022')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs022 import *
import numpy as np
# See the function signature in fn/ghs022.py for argument names.
```
