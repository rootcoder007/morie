# describe('wsmbpc') — wasserman_bootstrap_percentile
...
`print(result)` render. See `moirais.fn.describe('wsmbpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbpc import *
import numpy as np
# See the function signature in fn/wsmbpc.py for argument names.
```
