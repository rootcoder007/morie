...
`print(result)` render. See `moirais.fn.describe('svnut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svnut import *
import numpy as np
# See the function signature in fn/svnut.py for argument names.
```
