...
`print(result)` render. See `moirais.fn.describe('jllem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jllem import *
import numpy as np
# See the function signature in fn/jllem.py for argument names.
```
