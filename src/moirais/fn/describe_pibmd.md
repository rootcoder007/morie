# describe('pibmd') — prior_informativeness_bias_diagnostic
...
`print(result)` render. See `moirais.fn.describe('pibmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pibmd import *
import numpy as np
# See the function signature in fn/pibmd.py for argument names.
```
