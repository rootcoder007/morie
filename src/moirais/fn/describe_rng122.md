# describe('rng122') — rangayyan_ch3_baseline_wander_filter_difference_eq
...
`print(result)` render. See `moirais.fn.describe('rng122')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng122 import *
import numpy as np
# See the function signature in fn/rng122.py for argument names.
```
