# describe('gh_c14_11') — ghosal_py_powerlaw
...
`print(result)` render. See `moirais.fn.describe('gh_c14_11')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_11 import *
import numpy as np
# See the function signature in fn/gh_c14_11.py for argument names.
```
