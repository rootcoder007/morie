...
`print(result)` render. See `moirais.fn.describe('cvxslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxslt import *
import numpy as np
# See the function signature in fn/cvxslt.py for argument names.
```
