# describe('hrzw1') — horowitz_wild_bootstrap
...
`print(result)` render. See `moirais.fn.describe('hrzw1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzw1 import *
import numpy as np
# See the function signature in fn/hrzw1.py for argument names.
```
