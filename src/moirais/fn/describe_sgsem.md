# describe('sgsem') — sem_error_model
...
`print(result)` render. See `moirais.fn.describe('sgsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsem import *
import numpy as np
# See the function signature in fn/sgsem.py for argument names.
```
