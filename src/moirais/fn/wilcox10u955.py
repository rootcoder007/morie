...
__all__ = ["wilcox_chapter_10_unnumbered_955"]


def wilcox_chapter_10_unnumbered_955(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X ≤ x) = P (Y ≤ x).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u955')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u955: GeneralStatistics expression (auto-extracted; see ref)."
