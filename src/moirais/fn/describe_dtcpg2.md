...
`print(result)` render. See `moirais.fn.describe('dtcpg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpg2 import *
import numpy as np
# See the function signature in fn/dtcpg2.py for argument names.
```
