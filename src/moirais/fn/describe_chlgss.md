...
`print(result)` render. See `moirais.fn.describe('chlgss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlgss import *
import numpy as np
# See the function signature in fn/chlgss.py for argument names.
```
