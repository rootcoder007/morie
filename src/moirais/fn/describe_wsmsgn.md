# describe('wsmsgn') — wasserman_sign_test
...
`print(result)` render. See `moirais.fn.describe('wsmsgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmsgn import *
import numpy as np
# See the function signature in fn/wsmsgn.py for argument names.
```
