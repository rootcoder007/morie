...
`print(result)` render. See `moirais.fn.describe('ltest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ltest import *
import numpy as np
# See the function signature in fn/ltest.py for argument names.
```
