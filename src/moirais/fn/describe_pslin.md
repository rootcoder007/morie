...
`print(result)` render. See `moirais.fn.describe('pslin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pslin import *
import numpy as np
# See the function signature in fn/pslin.py for argument names.
```
