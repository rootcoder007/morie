# describe('hmmxp2'Out of chaos, comes order. — Friedrich Nietzsche's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('hmmxp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmxp2 import *
import numpy as np
# See the function signature in fn/hmmxp2.py for argument names.
```
