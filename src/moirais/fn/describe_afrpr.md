...
`print(result)` render. See `moirais.fn.describe('afrpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afrpr import *
import numpy as np
# See the function signature in fn/afrpr.py for argument names.
```
