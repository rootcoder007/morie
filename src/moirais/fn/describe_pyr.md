# describe('pyr') — person_years_at_risk
...
`print(result)` render. See `moirais.fn.describe('pyr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pyr import *
import numpy as np
# See the function signature in fn/pyr.py for argument names.
```
