...
`print(result)` render. See `moirais.fn.describe('chles')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chles import *
import numpy as np
# See the function signature in fn/chles.py for argument names.
```
