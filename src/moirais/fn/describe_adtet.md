# describe('adtet') — anderson_darling_test
...
`print(result)` render. See `moirais.fn.describe('adtet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adtet import *
import numpy as np
# See the function signature in fn/adtet.py for argument names.
```
