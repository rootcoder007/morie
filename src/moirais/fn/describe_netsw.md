# describe('netsw') — network_small_world
...
`print(result)` render. See `moirais.fn.describe('netsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netsw import *
import numpy as np
# See the function signature in fn/netsw.py for argument names.
```
