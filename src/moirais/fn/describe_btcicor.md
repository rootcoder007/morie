# describe('btcicor') — boot_ci_correlation
...
`print(result)` render. See `moirais.fn.describe('btcicor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btcicor import *
import numpy as np
# See the function signature in fn/btcicor.py for argument names.
```
