# describe('otmaprc') — ot_map_recovery_brenier
...
`print(result)` render. See `moirais.fn.describe('otmaprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmaprc import *
import numpy as np
# See the function signature in fn/otmaprc.py for argument names.
```
