...
`print(result)` render. See `moirais.fn.describe('magal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.magal import *
import numpy as np
# See the function signature in fn/magal.py for argument names.
```
