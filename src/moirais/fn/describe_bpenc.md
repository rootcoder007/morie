...
`print(result)` render. See `moirais.fn.describe('bpenc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bpenc import *
import numpy as np
# See the function signature in fn/bpenc.py for argument names.
```
