...
`print(result)` render. See `moirais.fn.describe('sihlh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sihlh import *
import numpy as np
# See the function signature in fn/sihlh.py for argument names.
```
