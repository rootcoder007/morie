...
`print(result)` render. See `moirais.fn.describe('frd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frd import *
import numpy as np
# See the function signature in fn/frd.py for argument names.
```
