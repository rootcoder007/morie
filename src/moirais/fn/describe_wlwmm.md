# describe('wlwmm') — wlw_marginal_model
...
`print(result)` render. See `moirais.fn.describe('wlwmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlwmm import *
import numpy as np
# See the function signature in fn/wlwmm.py for argument names.
```
