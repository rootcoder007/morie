# describe('egrgrf') — egregious_loss_forest
...
`print(result)` render. See `moirais.fn.describe('egrgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egrgrf import *
import numpy as np
# See the function signature in fn/egrgrf.py for argument names.
```
