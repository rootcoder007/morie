# describe('netcls') — closeness_centrality
...
`print(result)` render. See `moirais.fn.describe('netcls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcls import *
import numpy as np
# See the function signature in fn/netcls.py for argument names.
```
