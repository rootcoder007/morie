...
__all__ = ["hedderich_chapter_9_unnumbered_2758"]


def hedderich_chapter_9_unnumbered_2758(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: In the first case (a), the alternativeπ2 > π1−∆applies, thusπ2 is not inferior (noninferiority),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2758')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2758: GeneralStatistics expression (auto-extracted; see ref)."
