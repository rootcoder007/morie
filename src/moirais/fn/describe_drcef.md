# describe('drcef') — dr_callaway_event_study
...
`print(result)` render. See `moirais.fn.describe('drcef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drcef import *
import numpy as np
# See the function signature in fn/drcef.py for argument names.
```
