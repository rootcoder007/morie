...
`print(result)` render. See `moirais.fn.describe('seclt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclt import *
import numpy as np
# See the function signature in fn/seclt.py for argument names.
```
