...
__all__ = ["hedderich_chapter_9_unnumbered_96"]


def hedderich_chapter_9_unnumbered_96(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • A matrix A is negative semidefinite, ifλi≤0 and at least oneλi = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u96')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u96: GeneralStatistics expression (auto-extracted; see ref)."
