# describe('spskrg') — schabenberger_simple_kriging
...
`print(result)` render. See `moirais.fn.describe('spskrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spskrg import *
import numpy as np
# See the function signature in fn/spskrg.py for argument names.
```
