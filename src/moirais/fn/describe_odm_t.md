# describe('odm_t') — otis_demo_trend
...
`print(result)` render. See `moirais.fn.describe('odm_t')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_t import *
import numpy as np
# See the function signature in fn/odm_t.py for argument names.
```
