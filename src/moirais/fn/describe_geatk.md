...
`print(result)` render. See `moirais.fn.describe('geatk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.geatk import *
import numpy as np
# See the function signature in fn/geatk.py for argument names.
```
