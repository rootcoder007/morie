...
`print(result)` render. See `moirais.fn.describe('mtexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtexp import *
import numpy as np
# See the function signature in fn/mtexp.py for argument names.
```
