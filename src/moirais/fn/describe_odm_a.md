...
`print(result)` render. See `moirais.fn.describe('odm_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odm_a import *
import numpy as np
# See the function signature in fn/odm_a.py for argument names.
```
