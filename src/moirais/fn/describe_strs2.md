# describe('strs2') — stress2_measure
...
`print(result)` render. See `moirais.fn.describe('strs2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strs2 import *
import numpy as np
# See the function signature in fn/strs2.py for argument names.
```
