...
__all__ = ["information_theory_mackay_chapter_10_unnumbered_5"]


def information_theory_mackay_chapter_10_unnumbered_5(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t5 + 2t2 + 2t3 +t1 +t4 +t6 = even; (1.51)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay10u5')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay10u5: GeneralStatistics expression (auto-extracted; see ref)."
