# describe('km044') — kamath_ch3_prompt_search_argmax
...
`print(result)` render. See `moirais.fn.describe('km044')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km044 import *
import numpy as np
# See the function signature in fn/km044.py for argument names.
```
