# describe('euclm') — euclidean_model
...
`print(result)` render. See `moirais.fn.describe('euclm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.euclm import *
import numpy as np
# See the function signature in fn/euclm.py for argument names.
```
