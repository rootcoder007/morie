# describe('sgtsbm') — sgt_spectral_clustering_2
...
`print(result)` render. See `moirais.fn.describe('sgtsbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsbm import *
import numpy as np
# See the function signature in fn/sgtsbm.py for argument names.
```
