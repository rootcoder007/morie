...
`print(result)` render. See `moirais.fn.describe('pcaev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcaev import *
import numpy as np
# See the function signature in fn/pcaev.py for argument names.
```
