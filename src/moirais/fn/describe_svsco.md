...
`print(result)` render. See `moirais.fn.describe('svsco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsco import *
import numpy as np
# See the function signature in fn/svsco.py for argument names.
```
