# describe('jolagf') — joseph_lag_feature
...
`print(result)` render. See `moirais.fn.describe('jolagf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jolagf import *
import numpy as np
# See the function signature in fn/jolagf.py for argument names.
```
