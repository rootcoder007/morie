...
`print(result)` render. See `moirais.fn.describe('tost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tost import *
import numpy as np
# See the function signature in fn/tost.py for argument names.
```
