# describe('jsdcm') — joint_sparse_decompose
...
`print(result)` render. See `moirais.fn.describe('jsdcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jsdcm import *
import numpy as np
# See the function signature in fn/jsdcm.py for argument names.
```
