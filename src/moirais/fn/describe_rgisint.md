# describe('rgisint') — rangayyan_isometric_contraction

## WHAT IT DOES

Analysis of EMG during isometric contraction (ZCR vs. force).
...
`print(result)` render. See `moirais.fn.describe('rgisint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgisint import *
import numpy as np
# See the function signature in fn/rgisint.py for argument names.
```
