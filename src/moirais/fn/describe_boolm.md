# describe('boolm') — boolean_minimize
...
`print(result)` render. See `moirais.fn.describe('boolm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.boolm import *
import numpy as np
# See the function signature in fn/boolm.py for argument names.
```
