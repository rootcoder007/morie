# describe('hmwrst') — geron_warm_restarts
...
`print(result)` render. See `moirais.fn.describe('hmwrst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmwrst import *
import numpy as np
# See the function signature in fn/hmwrst.py for argument names.
```
