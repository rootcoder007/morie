...
`print(result)` render. See `moirais.fn.describe('dk3uk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3uk import *
import numpy as np
# See the function signature in fn/dk3uk.py for argument names.
```
