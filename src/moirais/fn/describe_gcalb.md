...
`print(result)` render. See `moirais.fn.describe('gcalb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcalb import *
import numpy as np
# See the function signature in fn/gcalb.py for argument names.
```
