# describe('msm143') — mvsml_categorical_count_eq_8_9
...
`print(result)` render. See `moirais.fn.describe('msm143')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm143 import *
import numpy as np
# See the function signature in fn/msm143.py for argument names.
```
