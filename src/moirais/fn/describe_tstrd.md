# describe('tstrd') — tstrd

## WHAT IT DOES

Space-time trend surface
...
`print(result)` render. See `moirais.fn.describe('tstrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tstrd import *
import numpy as np
# See the function signature in fn/tstrd.py for argument names.
```
