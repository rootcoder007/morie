# describe('reasn') — reassigned_stft
...
`print(result)` render. See `moirais.fn.describe('reasn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reasn import *
import numpy as np
# See the function signature in fn/reasn.py for argument names.
```
