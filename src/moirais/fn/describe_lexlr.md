...
`print(result)` render. See `moirais.fn.describe('lexlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lexlr import *
import numpy as np
# See the function signature in fn/lexlr.py for argument names.
```
