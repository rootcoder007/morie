# describe('msm297') — mvsml_convolutional_nn_eq_14_4
...
`print(result)` render. See `moirais.fn.describe('msm297')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm297 import *
import numpy as np
# See the function signature in fn/msm297.py for argument names.
```
