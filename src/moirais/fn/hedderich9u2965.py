...
__all__ = ["hedderich_chapter_9_unnumbered_2965"]


def hedderich_chapter_9_unnumbered_2965(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆnij =n·ˆπij =nˆαi ˆβj = ni.n.j
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2965')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2965: GeneralStatistics expression (auto-extracted; see ref)."
