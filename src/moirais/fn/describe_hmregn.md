# describe('hmregn') — geron_regression_mlp
...
`print(result)` render. See `moirais.fn.describe('hmregn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmregn import *
import numpy as np
# See the function signature in fn/hmregn.py for argument names.
```
