# describe('tparm') — torus_parametric
...
`print(result)` render. See `moirais.fn.describe('tparm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tparm import *
import numpy as np
# See the function signature in fn/tparm.py for argument names.
```
