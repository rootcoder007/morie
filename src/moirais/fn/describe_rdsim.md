...
`print(result)` render. See `moirais.fn.describe('rdsim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdsim import *
import numpy as np
# See the function signature in fn/rdsim.py for argument names.
```
