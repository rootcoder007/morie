# describe('infcrt') — information_criterion
...
`print(result)` render. See `moirais.fn.describe('infcrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.infcrt import *
import numpy as np
# See the function signature in fn/infcrt.py for argument names.
```
