# describe('grrein') — geron_reinforce_policy_gradient
...
`print(result)` render. See `moirais.fn.describe('grrein')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grrein import *
import numpy as np
# See the function signature in fn/grrein.py for argument names.
```
