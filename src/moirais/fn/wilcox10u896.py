...
__all__ = ["wilcox_chapter_10_unnumbered_896"]


def wilcox_chapter_10_unnumbered_896(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Decision Rule : Reject if FA ≥ f (or if FAB ≥ f ), where f is the 1 − α quantile of an F
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u896')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u896: GeneralStatistics expression (auto-extracted; see ref)."
