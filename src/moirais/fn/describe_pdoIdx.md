...
`print(result)` render. See `moirais.fn.describe('pdoIdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdoIdx import *
import numpy as np
# See the function signature in fn/pdoIdx.py for argument names.
```
