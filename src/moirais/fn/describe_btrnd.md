# describe('btrnd') — boot_rng_seeded
...
`print(result)` render. See `moirais.fn.describe('btrnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btrnd import *
import numpy as np
# See the function signature in fn/btrnd.py for argument names.
```
