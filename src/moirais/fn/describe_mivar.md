...
`print(result)` render. See `moirais.fn.describe('mivar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mivar import *
import numpy as np
# See the function signature in fn/mivar.py for argument names.
```
