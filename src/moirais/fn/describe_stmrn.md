# describe('stmrn') — spacetime_moran_scatter
...
`print(result)` render. See `moirais.fn.describe('stmrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stmrn import *
import numpy as np
# See the function signature in fn/stmrn.py for argument names.
```
