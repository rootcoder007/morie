...
`print(result)` render. See `moirais.fn.describe('bsboot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsboot import *
import numpy as np
# See the function signature in fn/bsboot.py for argument names.
```
