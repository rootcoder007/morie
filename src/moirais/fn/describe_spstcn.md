# describe('spstcn') — schabenberger_st_cov_nonsep
...
`print(result)` render. See `moirais.fn.describe('spstcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spstcn import *
import numpy as np
# See the function signature in fn/spstcn.py for argument names.
```
