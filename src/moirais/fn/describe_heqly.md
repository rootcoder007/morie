# describe('heqly') — quality_adjusted_ly
...
`print(result)` render. See `moirais.fn.describe('heqly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heqly import *
import numpy as np
# See the function signature in fn/heqly.py for argument names.
```
