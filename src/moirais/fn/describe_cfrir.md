# describe('cfrir') — case_fatality_rate
...
`print(result)` render. See `moirais.fn.describe('cfrir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfrir import *
import numpy as np
# See the function signature in fn/cfrir.py for argument names.
```
