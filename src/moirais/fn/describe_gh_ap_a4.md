# describe('gh_ap_a4') — ghosal_hellinger_dist
...
`print(result)` render. See `moirais.fn.describe('gh_ap_a4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_a4 import *
import numpy as np
# See the function signature in fn/gh_ap_a4.py for argument names.
```
