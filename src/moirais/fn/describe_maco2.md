...
`print(result)` render. See `moirais.fn.describe('maco2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maco2 import *
import numpy as np
# See the function signature in fn/maco2.py for argument names.
```
