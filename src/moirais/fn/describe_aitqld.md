# describe('aitqld') — compositional_quantile_dist
...
`print(result)` render. See `moirais.fn.describe('aitqld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitqld import *
import numpy as np
# See the function signature in fn/aitqld.py for argument names.
```
