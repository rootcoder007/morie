# describe('bdintp') — bound_intersection
...
`print(result)` render. See `moirais.fn.describe('bdintp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdintp import *
import numpy as np
# See the function signature in fn/bdintp.py for argument names.
```
