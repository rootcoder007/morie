# describe('rng220') — rangayyan_ch4_matched_filter_optimal_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng220')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng220 import *
import numpy as np
# See the function signature in fn/rng220.py for argument names.
```
