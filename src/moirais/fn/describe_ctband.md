...
`print(result)` render. See `moirais.fn.describe('ctband')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctband import *
import numpy as np
# See the function signature in fn/ctband.py for argument names.
```
