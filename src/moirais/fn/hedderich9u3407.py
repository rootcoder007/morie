...
__all__ = ["hedderich_chapter_9_unnumbered_3407"]


def hedderich_chapter_9_unnumbered_3407(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 100[exp (β1)−1]%
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3407')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3407: GeneralStatistics expression (auto-extracted; see ref)."
