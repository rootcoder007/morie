# describe('dinopr') — dino_self_distill
...
`print(result)` render. See `moirais.fn.describe('dinopr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dinopr import *
import numpy as np
# See the function signature in fn/dinopr.py for argument names.
```
