# describe('gh_c2_6') — ghosal_mixture_basis_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c2_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c2_6 import *
import numpy as np
# See the function signature in fn/gh_c2_6.py for argument names.
```
