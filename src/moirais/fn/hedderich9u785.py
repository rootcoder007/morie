...
__all__ = ["hedderich_chapter_9_unnumbered_785"]


def hedderich_chapter_9_unnumbered_785(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µ−σ ≈0.6·ymax
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u785')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u785: GeneralStatistics expression (auto-extracted; see ref)."
