# describe('msm316') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm316')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm316 import *
import numpy as np
# See the function signature in fn/msm316.py for argument names.
```
