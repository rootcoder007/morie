...
__all__ = ["hedderich_chapter_9_unnumbered_1391"]


def hedderich_chapter_9_unnumbered_1391(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] n1≈0.5n2 n1=n2 n1≈0.5n2 n1=n2 n1≈0.5n2 n1=n2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1391')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1391: PowerAndDesign expression (auto-extracted; see ref)."
