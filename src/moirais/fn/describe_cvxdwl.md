# describe('cvxdwl') — boyd_dual_function
...
`print(result)` render. See `moirais.fn.describe('cvxdwl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxdwl import *
import numpy as np
# See the function signature in fn/cvxdwl.py for argument names.
```
