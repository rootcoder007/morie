# describe('trajd') — trajectory_distance
...
`print(result)` render. See `moirais.fn.describe('trajd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trajd import *
import numpy as np
# See the function signature in fn/trajd.py for argument names.
```
