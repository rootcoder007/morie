# describe('hrzn1') — horowitz_nonparametric_iv
...
`print(result)` render. See `moirais.fn.describe('hrzn1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzn1 import *
import numpy as np
# See the function signature in fn/hrzn1.py for argument names.
```
