...
`print(result)` render. See `moirais.fn.describe('lrsch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrsch import *
import numpy as np
# See the function signature in fn/lrsch.py for argument names.
```
