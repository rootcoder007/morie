# describe('zsmvb') — moving_block_boot
...
`print(result)` render. See `moirais.fn.describe('zsmvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsmvb import *
import numpy as np
# See the function signature in fn/zsmvb.py for argument names.
```
