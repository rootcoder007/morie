# describe('hysdt') — hysteresis_detect
...
`print(result)` render. See `moirais.fn.describe('hysdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hysdt import *
import numpy as np
# See the function signature in fn/hysdt.py for argument names.
```
