# describe('ksr028') — kosorok_ch2_glivenko_cantelli_classical
...
`print(result)` render. See `moirais.fn.describe('ksr028')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr028 import *
import numpy as np
# See the function signature in fn/ksr028.py for argument names.
```
