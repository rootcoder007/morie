...
`print(result)` render. See `moirais.fn.describe('rey_ol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey_ol import *
import numpy as np
# See the function signature in fn/rey_ol.py for argument names.
```
