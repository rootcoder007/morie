# describe('sglgt') — spatial_logistic
...
`print(result)` render. See `moirais.fn.describe('sglgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglgt import *
import numpy as np
# See the function signature in fn/sglgt.py for argument names.
```
