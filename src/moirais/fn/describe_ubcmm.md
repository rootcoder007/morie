...
`print(result)` render. See `moirais.fn.describe('ubcmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcmm import *
import numpy as np
# See the function signature in fn/ubcmm.py for argument names.
```
