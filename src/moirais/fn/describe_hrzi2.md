# describe('hrzi2') — horowitz_average_derivative
...
`print(result)` render. See `moirais.fn.describe('hrzi2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzi2 import *
import numpy as np
# See the function signature in fn/hrzi2.py for argument names.
```
