...
`print(result)` render. See `moirais.fn.describe('ctclip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctclip import *
import numpy as np
# See the function signature in fn/ctclip.py for argument names.
```
