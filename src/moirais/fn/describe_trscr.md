...
`print(result)` render. See `moirais.fn.describe('trscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trscr import *
import numpy as np
# See the function signature in fn/trscr.py for argument names.
```
