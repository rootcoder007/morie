# describe('msm237') — mvsml_general_eq_1_3
...
`print(result)` render. See `moirais.fn.describe('msm237')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm237 import *
import numpy as np
# See the function signature in fn/msm237.py for argument names.
```
