...
__all__ = ["wilcox_chapter_9_unnumbered_1077"]


def wilcox_chapter_9_unnumbered_1077(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: regpca(x,cor=T,SCORES = FALSE, scree=TRUE, xlab="Principal
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1077')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1077: GeneralStatistics expression (auto-extracted; see ref)."
