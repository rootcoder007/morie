...
__all__ = ["hedderich_chapter_9_unnumbered_2810"]


def hedderich_chapter_9_unnumbered_2810(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (ψ+ 1)−p(ψ−1)2]2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2810')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2810: PowerAndDesign expression (auto-extracted; see ref)."
