# describe('ksr046') — kosorok_ch2_z_estimator_consistency
...
`print(result)` render. See `moirais.fn.describe('ksr046')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr046 import *
import numpy as np
# See the function signature in fn/ksr046.py for argument names.
```
