...
`print(result)` render. See `moirais.fn.describe('ricei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ricei import *
import numpy as np
# See the function signature in fn/ricei.py for argument names.
```
