...
__all__ = ["hedderich_chapter_9_unnumbered_141"]


def hedderich_chapter_9_unnumbered_141(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (0.4·100 + 0.2·1000 + 0.1·500)/1600 = 0.181 (18 .1%)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u141')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u141: GeneralStatistics expression (auto-extracted; see ref)."
