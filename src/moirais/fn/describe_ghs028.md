# describe('ghs028') — ghosal_ch3_polya_tree_first_two_moments
...
`print(result)` render. See `moirais.fn.describe('ghs028')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs028 import *
import numpy as np
# See the function signature in fn/ghs028.py for argument names.
```
