# describe('eercl') — equal_error_rate
...
`print(result)` render. See `moirais.fn.describe('eercl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eercl import *
import numpy as np
# See the function signature in fn/eercl.py for argument names.
```
