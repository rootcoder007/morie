# describe('grpels') — geron_peephole_lstm_cell
...
`print(result)` render. See `moirais.fn.describe('grpels')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grpels import *
import numpy as np
# See the function signature in fn/grpels.py for argument names.
```
