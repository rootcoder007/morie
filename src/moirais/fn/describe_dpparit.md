# describe('dpparit') — pitman_yor_process
...
`print(result)` render. See `moirais.fn.describe('dpparit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpparit import *
import numpy as np
# See the function signature in fn/dpparit.py for argument names.
```
