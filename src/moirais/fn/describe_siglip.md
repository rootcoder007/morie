# describe('siglip') — siglip_pairwise
...
`print(result)` render. See `moirais.fn.describe('siglip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siglip import *
import numpy as np
# See the function signature in fn/siglip.py for argument names.
```
