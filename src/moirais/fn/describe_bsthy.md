# describe('bsthy') — basic_space_dim_test
...
`print(result)` render. See `moirais.fn.describe('bsthy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bsthy import *
import numpy as np
# See the function signature in fn/bsthy.py for argument names.
```
