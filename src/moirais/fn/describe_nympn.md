...
`print(result)` render. See `moirais.fn.describe('nympn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nympn import *
import numpy as np
# See the function signature in fn/nympn.py for argument names.
```
