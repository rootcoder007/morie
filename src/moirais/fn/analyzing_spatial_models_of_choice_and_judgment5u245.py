...
def analyzing_spatial_models_of_choice_and_judgment_chapter_5_unnumbered_245(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analyzing_spatial_models_of_choice_and_judgment5u245')`` for the full guide.
