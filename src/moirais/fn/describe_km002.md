# describe('km002') — kamath_ch2_context_vector
...
`print(result)` render. See `moirais.fn.describe('km002')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km002 import *
import numpy as np
# See the function signature in fn/km002.py for argument names.
```
