...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_402(x):
    """
    Regression expression (auto-extracted; see ref).

    Formula: [EQ] σy___X = Yrσx
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner5u402')`` for the full guide.
