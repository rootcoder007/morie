# describe('aitbi') — aitchison_biplot
...
`print(result)` render. See `moirais.fn.describe('aitbi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitbi import *
import numpy as np
# See the function signature in fn/aitbi.py for argument names.
```
