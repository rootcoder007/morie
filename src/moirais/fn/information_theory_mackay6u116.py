...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_116"]


def information_theory_mackay_chapter_6_unnumbered_116(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(y = 0jx= 1) = f;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u116')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u116: GeneralStatistics expression (auto-extracted; see ref)."
