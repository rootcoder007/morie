...
__all__ = ["wilcox_chapter_14_unnumbered_586"]


def wilcox_chapter_14_unnumbered_586(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: might differ. So if the goal is to compute a confidence interval for τ 1 − τ 2, the Brown–Forsythe
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u586')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u586: GeneralStatistics expression (auto-extracted; see ref)."
