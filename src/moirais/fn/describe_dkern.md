...
`print(result)` render. See `moirais.fn.describe('dkern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkern import *
import numpy as np
# See the function signature in fn/dkern.py for argument names.
```
