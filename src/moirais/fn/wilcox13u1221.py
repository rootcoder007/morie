...
__all__ = ["wilcox_chapter_13_unnumbered_1221"]


def wilcox_chapter_13_unnumbered_1221(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: X1 +X2 +X1X2 +e is incorrect; the true model is Y =X1 +X2 +X1X 2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1221')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1221: PowerAndDesign expression (auto-extracted; see ref)."
