...
__all__ = ["treatment_effects_1_chapter_1_unnumbered_13"]


def treatment_effects_1_chapter_1_unnumbered_13(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (E[Yi|Di = 1,Xi]− E[Yi|Di = 0,Xi])dF (Xi). (11)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('treatment_effects_11u13')`` for the full guide.
...
def cheatsheet():
    return "treatment_effects_11u13: GeneralStatistics expression (auto-extracted; see ref)."
