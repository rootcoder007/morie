...
`print(result)` render. See `moirais.fn.describe('ddpest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddpest import *
import numpy as np
# See the function signature in fn/ddpest.py for argument names.
```
