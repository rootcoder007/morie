# describe('gh_ap_f1') — ghosal_donsker_class
...
`print(result)` render. See `moirais.fn.describe('gh_ap_f1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_f1 import *
import numpy as np
# See the function signature in fn/gh_ap_f1.py for argument names.
```
