...
__all__ = ["wilcox_chapter_14_unnumbered_644"]


def wilcox_chapter_14_unnumbered_644(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u644')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u644: PowerAndDesign expression (auto-extracted; see ref)."
