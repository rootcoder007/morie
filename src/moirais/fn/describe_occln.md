# describe('occln') — oc_cutting_line
...
`print(result)` render. See `moirais.fn.describe('occln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.occln import *
import numpy as np
# See the function signature in fn/occln.py for argument names.
```
