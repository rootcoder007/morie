# describe('tmlsbs') — tmle_subset_selection
...
`print(result)` render. See `moirais.fn.describe('tmlsbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsbs import *
import numpy as np
# See the function signature in fn/tmlsbs.py for argument names.
```
