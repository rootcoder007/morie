# describe('mhst1') — mantel_haenszel_or
...
`print(result)` render. See `moirais.fn.describe('mhst1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhst1 import *
import numpy as np
# See the function signature in fn/mhst1.py for argument names.
```
