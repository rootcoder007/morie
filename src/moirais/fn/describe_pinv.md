...
`print(result)` render. See `moirais.fn.describe('pinv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pinv import *
import numpy as np
# See the function signature in fn/pinv.py for argument names.
```
