# describe('idw') — inverse_distance_weighting
...
`print(result)` render. See `moirais.fn.describe('idw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idw import *
import numpy as np
# See the function signature in fn/idw.py for argument names.
```
