...
`print(result)` render. See `moirais.fn.describe('hmdcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmdcg import *
import numpy as np
# See the function signature in fn/hmdcg.py for argument names.
```
