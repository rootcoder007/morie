# describe('mcelc') — mceliece_encrypt
...
`print(result)` render. See `moirais.fn.describe('mcelc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcelc import *
import numpy as np
# See the function signature in fn/mcelc.py for argument names.
```
