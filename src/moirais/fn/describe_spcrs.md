# describe('spcrs') — spatial_cross_validation
...
`print(result)` render. See `moirais.fn.describe('spcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcrs import *
import numpy as np
# See the function signature in fn/spcrs.py for argument names.
```
