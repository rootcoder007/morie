# describe('msm319') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm319')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm319 import *
import numpy as np
# See the function signature in fn/msm319.py for argument names.
```
