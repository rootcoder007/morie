...
`print(result)` render. See `moirais.fn.describe('siavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siavg import *
import numpy as np
# See the function signature in fn/siavg.py for argument names.
```
