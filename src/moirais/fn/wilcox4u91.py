...
__all__ = ["wilcox_chapter_4_unnumbered_91"]


def wilcox_chapter_4_unnumbered_91(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Letting d =P (−c ≤ Z ≤ c), the answer is given by
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u91')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u91: GeneralStatistics expression (auto-extracted; see ref)."
