...
__all__ = ["wilcox_chapter_14_unnumbered_646"]


def wilcox_chapter_14_unnumbered_646(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the critical value corresponds to α/2 = 0 .025 and is 0, so reject if W ≤ 0. The upper critical
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u646')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u646: GeneralStatistics expression (auto-extracted; see ref)."
