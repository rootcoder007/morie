# describe('spols') — schabenberger_ols_variogram
...
`print(result)` render. See `moirais.fn.describe('spols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spols import *
import numpy as np
# See the function signature in fn/spols.py for argument names.
```
