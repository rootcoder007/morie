...
__all__ = ["hedderich_chapter_9_unnumbered_1287"]


def hedderich_chapter_9_unnumbered_1287(x):
    """
    CausalInference expression (auto-extracted; see ref).

    Formula: [EQ] n = 8 ∑di = 9.2 ∑d2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1287')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1287: CausalInference expression (auto-extracted; see ref)."
