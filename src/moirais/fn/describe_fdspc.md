# describe('fdspc') — fractal_dim_from_psd
...
`print(result)` render. See `moirais.fn.describe('fdspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdspc import *
import numpy as np
# See the function signature in fn/fdspc.py for argument names.
```
