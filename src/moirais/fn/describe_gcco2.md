...
`print(result)` render. See `moirais.fn.describe('gcco2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcco2 import *
import numpy as np
# See the function signature in fn/gcco2.py for argument names.
```
