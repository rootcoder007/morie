# describe('catstop') — cat_stopping_rule
...
`print(result)` render. See `moirais.fn.describe('catstop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.catstop import *
import numpy as np
# See the function signature in fn/catstop.py for argument names.
```
