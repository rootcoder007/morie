...
__all__ = ["hedderich_chapter_9_unnumbered_2560"]


def hedderich_chapter_9_unnumbered_2560(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: xi,j,k fori = 1, 2,...,a ;j = 1, 2,...,b andk = 1, 2,...,n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2560')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2560: GeneralStatistics expression (auto-extracted; see ref)."
