# describe('svrce') — roll_call_error
...
`print(result)` render. See `moirais.fn.describe('svrce')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrce import *
import numpy as np
# See the function signature in fn/svrce.py for argument names.
```
