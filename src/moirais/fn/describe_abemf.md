...
`print(result)` render. See `moirais.fn.describe('abemf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abemf import *
import numpy as np
# See the function signature in fn/abemf.py for argument names.
```
