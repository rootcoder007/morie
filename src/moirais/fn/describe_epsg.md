...
`print(result)` render. See `moirais.fn.describe('epsg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epsg import *
import numpy as np
# See the function signature in fn/epsg.py for argument names.
```
