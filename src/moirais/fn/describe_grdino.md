# describe('grdino') — geron_dino_self_distillation
...
`print(result)` render. See `moirais.fn.describe('grdino')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdino import *
import numpy as np
# See the function signature in fn/grdino.py for argument names.
```
