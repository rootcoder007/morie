# describe('ripJ') — ripley_j_function
...
`print(result)` render. See `moirais.fn.describe('ripJ')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ripJ import *
import numpy as np
# See the function signature in fn/ripJ.py for argument names.
```
