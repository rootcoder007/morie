# describe('joavg') — joseph_average_forecast
...
`print(result)` render. See `moirais.fn.describe('joavg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joavg import *
import numpy as np
# See the function signature in fn/joavg.py for argument names.
```
