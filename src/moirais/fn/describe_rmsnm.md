...
`print(result)` render. See `moirais.fn.describe('rmsnm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsnm import *
import numpy as np
# See the function signature in fn/rmsnm.py for argument names.
```
