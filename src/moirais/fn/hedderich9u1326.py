...
__all__ = ["hedderich_chapter_9_unnumbered_1326"]


def hedderich_chapter_9_unnumbered_1326(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (˜x−˜y)±z1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1326')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1326: PowerAndDesign expression (auto-extracted; see ref)."
