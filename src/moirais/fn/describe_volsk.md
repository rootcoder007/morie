# describe('volsk') — vol_stochastic_kalman
...
`print(result)` render. See `moirais.fn.describe('volsk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volsk import *
import numpy as np
# See the function signature in fn/volsk.py for argument names.
```
