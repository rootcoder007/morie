# describe('rgcrl') — rangayyan_correlation_dimension
...
`print(result)` render. See `moirais.fn.describe('rgcrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcrl import *
import numpy as np
# See the function signature in fn/rgcrl.py for argument names.
```
