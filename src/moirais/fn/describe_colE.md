...
`print(result)` render. See `moirais.fn.describe('colE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.colE import *
import numpy as np
# See the function signature in fn/colE.py for argument names.
```
