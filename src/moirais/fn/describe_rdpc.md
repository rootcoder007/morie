...
`print(result)` render. See `moirais.fn.describe('rdpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdpc import *
import numpy as np
# See the function signature in fn/rdpc.py for argument names.
```
