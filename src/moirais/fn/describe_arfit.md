...
`print(result)` render. See `moirais.fn.describe('arfit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arfit import *
import numpy as np
# See the function signature in fn/arfit.py for argument names.
```
