...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1505"]


def guide_on_data_analysis_chapter_30_unnumbered_1505(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -3 x cohort = 8 -0.78 (0.70)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1505')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1505: GeneralStatistics expression (auto-extracted; see ref)."
