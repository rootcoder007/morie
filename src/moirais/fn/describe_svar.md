...
`print(result)` render. See `moirais.fn.describe('svar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svar import *
import numpy as np
# See the function signature in fn/svar.py for argument names.
```
