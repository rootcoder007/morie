# describe('esllgr') — esl_logistic_reg
...
`print(result)` render. See `moirais.fn.describe('esllgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esllgr import *
import numpy as np
# See the function signature in fn/esllgr.py for argument names.
```
