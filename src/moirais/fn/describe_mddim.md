...
`print(result)` render. See `moirais.fn.describe('mddim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mddim import *
import numpy as np
# See the function signature in fn/mddim.py for argument names.
```
