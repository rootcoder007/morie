...
`print(result)` render. See `moirais.fn.describe('biscn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.biscn import *
import numpy as np
# See the function signature in fn/biscn.py for argument names.
```
