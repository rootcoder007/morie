# describe('rng171') — rangayyan_ch3_rls_kalman_gain
...
`print(result)` render. See `moirais.fn.describe('rng171')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng171 import *
import numpy as np
# See the function signature in fn/rng171.py for argument names.
```
