# describe('polyt') — polya_tree_construction
...
`print(result)` render. See `moirais.fn.describe('polyt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polyt import *
import numpy as np
# See the function signature in fn/polyt.py for argument names.
```
