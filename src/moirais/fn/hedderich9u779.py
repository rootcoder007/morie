...
__all__ = ["hedderich_chapter_9_unnumbered_779"]


def hedderich_chapter_9_unnumbered_779(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (with a,b > 0). In Figure 5.22, the two constants are a = b = 1 or a = 3 and b = 1/3: An
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u779')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u779: GeneralStatistics expression (auto-extracted; see ref)."
