# describe('csphr') — cutting_plane_sphere
...
`print(result)` render. See `moirais.fn.describe('csphr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csphr import *
import numpy as np
# See the function signature in fn/csphr.py for argument names.
```
