# describe('coxres') — cox_schoenfeld_residuals
...
`print(result)` render. See `moirais.fn.describe('coxres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxres import *
import numpy as np
# See the function signature in fn/coxres.py for argument names.
```
