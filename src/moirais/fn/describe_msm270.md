# describe('msm270') — mvsml_convolutional_nn_eq_14_7
...
`print(result)` render. See `moirais.fn.describe('msm270')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm270 import *
import numpy as np
# See the function signature in fn/msm270.py for argument names.
```
