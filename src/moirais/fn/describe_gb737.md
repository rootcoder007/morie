# describe('gb737') — gibbons_linrank_properties
...
`print(result)` render. See `moirais.fn.describe('gb737')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb737 import *
import numpy as np
# See the function signature in fn/gb737.py for argument names.
```
