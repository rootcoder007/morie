# describe('kmnxtg') — kamath_nextgpt_any2any
...
`print(result)` render. See `moirais.fn.describe('kmnxtg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmnxtg import *
import numpy as np
# See the function signature in fn/kmnxtg.py for argument names.
```
