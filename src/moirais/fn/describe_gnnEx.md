...
`print(result)` render. See `moirais.fn.describe('gnnEx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnnEx import *
import numpy as np
# See the function signature in fn/gnnEx.py for argument names.
```
