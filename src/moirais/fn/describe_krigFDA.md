...
`print(result)` render. See `moirais.fn.describe('krigFDA')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.krigFDA import *
import numpy as np
# See the function signature in fn/krigFDA.py for argument names.
```
