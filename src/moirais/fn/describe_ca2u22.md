# describe('ca2u22') — ca_chapter_2_unnumbered_22
...
```python
from moirais.fn.ca2u22 import ca_chapter_2_unnumbered_22
import numpy as np
result = ca_chapter_2_unnumbered_22(np.random.default_rng(42).normal(0, 1, 100))
