...
def wilcox_chapter_13_unnumbered_1297(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: pwr.chisq.test(w=0.1,power=0.9,df=1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1297')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1297: PowerAndDesign expression (auto-extracted; see ref)."
