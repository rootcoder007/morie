...
`print(result)` render. See `moirais.fn.describe('herit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.herit import *
import numpy as np
# See the function signature in fn/herit.py for argument names.
```
