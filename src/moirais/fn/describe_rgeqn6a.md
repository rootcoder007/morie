# describe('rgeqn6a') — rangayyan_ch6_mean_freq
...
`print(result)` render. See `moirais.fn.describe('rgeqn6a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn6a import *
import numpy as np
# See the function signature in fn/rgeqn6a.py for argument names.
```
