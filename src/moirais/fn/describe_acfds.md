...
`print(result)` render. See `moirais.fn.describe('acfds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acfds import *
import numpy as np
# See the function signature in fn/acfds.py for argument names.
```
