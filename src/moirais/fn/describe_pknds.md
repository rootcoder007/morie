# describe('pknds') — partial_kendall
...
`print(result)` render. See `moirais.fn.describe('pknds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pknds import *
import numpy as np
# See the function signature in fn/pknds.py for argument names.
```
