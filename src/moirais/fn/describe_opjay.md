...
`print(result)` render. See `moirais.fn.describe('opjay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opjay import *
import numpy as np
# See the function signature in fn/opjay.py for argument names.
```
