...
`print(result)` render. See `moirais.fn.describe('lifeq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lifeq import *
import numpy as np
# See the function signature in fn/lifeq.py for argument names.
```
