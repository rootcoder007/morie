...
`print(result)` render. See `moirais.fn.describe('rsica')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsica import *
import numpy as np
# See the function signature in fn/rsica.py for argument names.
```
