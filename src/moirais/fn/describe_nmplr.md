...
`print(result)` render. See `moirais.fn.describe('nmplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmplr import *
import numpy as np
# See the function signature in fn/nmplr.py for argument names.
```
