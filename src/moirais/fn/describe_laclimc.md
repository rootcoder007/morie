...
`print(result)` render. See `moirais.fn.describe('laclimc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laclimc import *
import numpy as np
# See the function signature in fn/laclimc.py for argument names.
```
