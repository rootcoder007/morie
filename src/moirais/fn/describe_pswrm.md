...
`print(result)` render. See `moirais.fn.describe('pswrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pswrm import *
import numpy as np
# See the function signature in fn/pswrm.py for argument names.
```
