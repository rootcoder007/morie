...
`print(result)` render. See `moirais.fn.describe('fotrnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fotrnk import *
import numpy as np
# See the function signature in fn/fotrnk.py for argument names.
```
