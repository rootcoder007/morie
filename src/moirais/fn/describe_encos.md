...
`print(result)` render. See `moirais.fn.describe('encos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.encos import *
import numpy as np
# See the function signature in fn/encos.py for argument names.
```
