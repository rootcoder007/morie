...
`print(result)` render. See `moirais.fn.describe('gpsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpsmp import *
import numpy as np
# See the function signature in fn/gpsmp.py for argument names.
```
