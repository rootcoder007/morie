...
`print(result)` render. See `moirais.fn.describe('epimet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epimet import *
import numpy as np
# See the function signature in fn/epimet.py for argument names.
```
