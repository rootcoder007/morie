# describe('msm178') — mvsml_ridge_lasso_elastic_eq_9_6
...
`print(result)` render. See `moirais.fn.describe('msm178')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm178 import *
import numpy as np
# See the function signature in fn/msm178.py for argument names.
```
