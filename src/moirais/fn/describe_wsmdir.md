# describe('wsmdir') — wasserman_directed_graph
...
`print(result)` render. See `moirais.fn.describe('wsmdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmdir import *
import numpy as np
# See the function signature in fn/wsmdir.py for argument names.
```
