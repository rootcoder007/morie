# describe('netcp') — network_compare
...
`print(result)` render. See `moirais.fn.describe('netcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcp import *
import numpy as np
# See the function signature in fn/netcp.py for argument names.
```
