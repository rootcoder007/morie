# describe('stcrs') — spacetime_crosscorr
...
`print(result)` render. See `moirais.fn.describe('stcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stcrs import *
import numpy as np
# See the function signature in fn/stcrs.py for argument names.
```
