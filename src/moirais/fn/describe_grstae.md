# describe('grstae') — geron_stacked_autoencoder
...
`print(result)` render. See `moirais.fn.describe('grstae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grstae import *
import numpy as np
# See the function signature in fn/grstae.py for argument names.
```
