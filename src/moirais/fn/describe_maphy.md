...
`print(result)` render. See `moirais.fn.describe('maphy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maphy import *
import numpy as np
# See the function signature in fn/maphy.py for argument names.
```
