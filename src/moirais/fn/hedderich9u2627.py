...
__all__ = ["hedderich_chapter_9_unnumbered_2627"]


def hedderich_chapter_9_unnumbered_2627(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2≤(n−1) (7.278)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2627')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2627: GeneralStatistics expression (auto-extracted; see ref)."
