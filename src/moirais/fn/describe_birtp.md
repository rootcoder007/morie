# describe('birtp') — bayesian_irt_posterior
...
`print(result)` render. See `moirais.fn.describe('birtp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.birtp import *
import numpy as np
# See the function signature in fn/birtp.py for argument names.
```
