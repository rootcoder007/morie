# describe('gb46le') — gibbons_lilliefors_exp
...
`print(result)` render. See `moirais.fn.describe('gb46le')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb46le import *
import numpy as np
# See the function signature in fn/gb46le.py for argument names.
```
