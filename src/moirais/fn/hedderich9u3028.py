...
__all__ = ["hedderich_chapter_9_unnumbered_3028"]


def hedderich_chapter_9_unnumbered_3028(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: of samples (excluding the control sample), ν=k−1 = number of categories minus 1 andαthe
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3028')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3028: GeneralStatistics expression (auto-extracted; see ref)."
