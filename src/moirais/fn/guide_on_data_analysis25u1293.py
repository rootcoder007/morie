...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1293"]


def guide_on_data_analysis_chapter_25_unnumbered_1293(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E = M′[Y′Y − ̂B′(X′X)−1 ̂B]M
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1293')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1293: GeneralStatistics expression (auto-extracted; see ref)."
