# describe('grlrco') — geron_lr_cosine_annealing
...
`print(result)` render. See `moirais.fn.describe('grlrco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grlrco import *
import numpy as np
# See the function signature in fn/grlrco.py for argument names.
```
