...
__all__ = ["wilcox_chapter_2_unnumbered_270"]


def wilcox_chapter_2_unnumbered_270(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 3. H0: µ =µ 0. Reject H0 if Z ≥ c or if Z ≤ − c, where now c is the 1 − α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u270')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u270: GeneralStatistics expression (auto-extracted; see ref)."
