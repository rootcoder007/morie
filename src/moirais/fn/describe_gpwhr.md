...
`print(result)` render. See `moirais.fn.describe('gpwhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpwhr import *
import numpy as np
# See the function signature in fn/gpwhr.py for argument names.
```
