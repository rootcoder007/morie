...
`print(result)` render. See `moirais.fn.describe('ppitd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppitd import *
import numpy as np
# See the function signature in fn/ppitd.py for argument names.
```
