...
`print(result)` render. See `moirais.fn.describe('fscor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fscor import *
import numpy as np
# See the function signature in fn/fscor.py for argument names.
```
