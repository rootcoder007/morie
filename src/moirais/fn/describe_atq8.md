...
`print(result)` render. See `moirais.fn.describe('atq8')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atq8 import *
import numpy as np
# See the function signature in fn/atq8.py for argument names.
```
