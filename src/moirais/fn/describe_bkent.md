...
`print(result)` render. See `moirais.fn.describe('bkent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkent import *
import numpy as np
# See the function signature in fn/bkent.py for argument names.
```
