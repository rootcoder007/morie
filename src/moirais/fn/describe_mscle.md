# describe('mscle') — multiscale_entropy
...
`print(result)` render. See `moirais.fn.describe('mscle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mscle import *
import numpy as np
# See the function signature in fn/mscle.py for argument names.
```
