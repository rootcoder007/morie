# describe('msm127') — mvsml_categorical_count_eq_8_1
...
`print(result)` render. See `moirais.fn.describe('msm127')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm127 import *
import numpy as np
# See the function signature in fn/msm127.py for argument names.
```
