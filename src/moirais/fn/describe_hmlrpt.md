# describe('hmlrpt') — geron_linreg_pytorch
...
`print(result)` render. See `moirais.fn.describe('hmlrpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrpt import *
import numpy as np
# See the function signature in fn/hmlrpt.py for argument names.
```
