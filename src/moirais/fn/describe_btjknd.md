# describe('btjknd') — boot_jackknife_d
...
`print(result)` render. See `moirais.fn.describe('btjknd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btjknd import *
import numpy as np
# See the function signature in fn/btjknd.py for argument names.
```
