# describe('sent') — sentence_stats

## WHAT IT DOES

Sentence length distribution stats. 'Who'Real knowledge is to know the extent of one's ignorance. — Confucius'
...
`print(result)` render. See `moirais.fn.describe('sent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sent import *
import numpy as np
# See the function signature in fn/sent.py for argument names.
```
