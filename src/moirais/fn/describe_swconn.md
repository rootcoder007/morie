...
`print(result)` render. See `moirais.fn.describe('swconn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swconn import *
import numpy as np
# See the function signature in fn/swconn.py for argument names.
```
