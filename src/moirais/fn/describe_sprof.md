# describe('sprof') — spectral_rolloff
...
`print(result)` render. See `moirais.fn.describe('sprof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprof import *
import numpy as np
# See the function signature in fn/sprof.py for argument names.
```
