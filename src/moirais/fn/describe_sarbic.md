...
`print(result)` render. See `moirais.fn.describe('sarbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarbic import *
import numpy as np
# See the function signature in fn/sarbic.py for argument names.
```
