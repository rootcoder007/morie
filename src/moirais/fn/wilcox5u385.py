...
__all__ = ["wilcox_chapter_5_unnumbered_385"]


def wilcox_chapter_5_unnumbered_385(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 6. Given that ¯X = 120, σ = 5, n = 49, and α = 0.05, test H0: µ > 130, assuming
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u385')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u385: GeneralStatistics expression (auto-extracted; see ref)."
