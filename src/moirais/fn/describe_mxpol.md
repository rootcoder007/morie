# describe('mxpol') — maxpool_forward
...
`print(result)` render. See `moirais.fn.describe('mxpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxpol import *
import numpy as np
# See the function signature in fn/mxpol.py for argument names.
```
