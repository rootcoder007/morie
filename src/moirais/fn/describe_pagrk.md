...
`print(result)` render. See `moirais.fn.describe('pagrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pagrk import *
import numpy as np
# See the function signature in fn/pagrk.py for argument names.
```
