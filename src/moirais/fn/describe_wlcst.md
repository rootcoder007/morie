...
`print(result)` render. See `moirais.fn.describe('wlcst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlcst import *
import numpy as np
# See the function signature in fn/wlcst.py for argument names.
```
