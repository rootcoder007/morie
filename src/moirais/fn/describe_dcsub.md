...
`print(result)` render. See `moirais.fn.describe('dcsub')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dcsub import *
import numpy as np
# See the function signature in fn/dcsub.py for argument names.
```
