# describe('cymnf') — calabi_yau_hodge
...
`print(result)` render. See `moirais.fn.describe('cymnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cymnf import *
import numpy as np
# See the function signature in fn/cymnf.py for argument names.
```
