...
`print(result)` render. See `moirais.fn.describe('difev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difev import *
import numpy as np
# See the function signature in fn/difev.py for argument names.
```
