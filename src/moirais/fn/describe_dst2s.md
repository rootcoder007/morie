# describe('dst2s') — distance_to_squared
...
`print(result)` render. See `moirais.fn.describe('dst2s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dst2s import *
import numpy as np
# See the function signature in fn/dst2s.py for argument names.
```
