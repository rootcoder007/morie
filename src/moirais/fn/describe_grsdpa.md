# describe('grsdpa') — geron_scaled_dot_product_attention
...
`print(result)` render. See `moirais.fn.describe('grsdpa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsdpa import *
import numpy as np
# See the function signature in fn/grsdpa.py for argument names.
```
