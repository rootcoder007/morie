# describe('gb_wss') — gibbons_wrs_normal_approx
...
`print(result)` render. See `moirais.fn.describe('gb_wss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_wss import *
import numpy as np
# See the function signature in fn/gb_wss.py for argument names.
```
