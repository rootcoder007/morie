...
`print(result)` render. See `moirais.fn.describe('eslbrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslbrm import *
import numpy as np
# See the function signature in fn/eslbrm.py for argument names.
```
