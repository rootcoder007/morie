# describe('hrzade') — horowitz_average_derivative
...
`print(result)` render. See `moirais.fn.describe('hrzade')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzade import *
import numpy as np
# See the function signature in fn/hrzade.py for argument names.
```
