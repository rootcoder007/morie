# describe('msm191') — mvsml_ridge_lasso_elastic_eq_9_19
...
`print(result)` render. See `moirais.fn.describe('msm191')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm191 import *
import numpy as np
# See the function signature in fn/msm191.py for argument names.
```
