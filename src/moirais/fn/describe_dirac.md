...
`print(result)` render. See `moirais.fn.describe('dirac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dirac import *
import numpy as np
# See the function signature in fn/dirac.py for argument names.
```
