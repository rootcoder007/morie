...
`print(result)` render. See `moirais.fn.describe('xrim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrim2 import *
import numpy as np
# See the function signature in fn/xrim2.py for argument names.
```
