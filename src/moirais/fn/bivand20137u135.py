...
__all__ = ["bivand2013_chapter_7_unnumbered_135"]


def bivand2013_chapter_7_unnumbered_135(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] w(si)= ||si −s0||−p,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u135')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u135: GeneralStatistics expression (auto-extracted; see ref)."
