# describe('msm321') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm321')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm321 import *
import numpy as np
# See the function signature in fn/msm321.py for argument names.
```
