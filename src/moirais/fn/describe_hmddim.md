...
`print(result)` render. See `moirais.fn.describe('hmddim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmddim import *
import numpy as np
# See the function signature in fn/hmddim.py for argument names.
```
