# describe('kmfew') — kamath_few_shot_exemplar_selection
...
`print(result)` render. See `moirais.fn.describe('kmfew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmfew import *
import numpy as np
# See the function signature in fn/kmfew.py for argument names.
```
