# describe('hmngd') — hamming_distance_sets
...
`print(result)` render. See `moirais.fn.describe('hmngd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmngd import *
import numpy as np
# See the function signature in fn/hmngd.py for argument names.
```
