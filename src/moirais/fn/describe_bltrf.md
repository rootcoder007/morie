# describe('bltrf') — bilinear_transform
...
`print(result)` render. See `moirais.fn.describe('bltrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bltrf import *
import numpy as np
# See the function signature in fn/bltrf.py for argument names.
```
