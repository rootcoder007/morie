...
`print(result)` render. See `moirais.fn.describe('hmvilb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvilb import *
import numpy as np
# See the function signature in fn/hmvilb.py for argument names.
```
