...
`print(result)` render. See `moirais.fn.describe('trbks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trbks import *
import numpy as np
# See the function signature in fn/trbks.py for argument names.
```
