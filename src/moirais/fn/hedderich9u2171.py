...
__all__ = ["hedderich_chapter_9_unnumbered_2171"]


def hedderich_chapter_9_unnumbered_2171(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Control 22.5 + 13.5 = 36 = 8(8 + 1) /2 i.e. ˆR = 13.5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2171')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2171: GeneralStatistics expression (auto-extracted; see ref)."
