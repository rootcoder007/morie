...
__all__ = ["hedderich_chapter_9_unnumbered_2789"]


def hedderich_chapter_9_unnumbered_2789(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H0 : π= 0.5 and HA : π̸= 0.5 (two-sided)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2789')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2789: CountModels expression (auto-extracted; see ref)."
