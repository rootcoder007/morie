# describe('tmldta') — tmle_data_adaptive
...
`print(result)` render. See `moirais.fn.describe('tmldta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmldta import *
import numpy as np
# See the function signature in fn/tmldta.py for argument names.
```
