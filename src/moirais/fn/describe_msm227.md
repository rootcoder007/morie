# describe('msm227') — mvsml_ridge_lasso_elastic_eq_9_42
...
`print(result)` render. See `moirais.fn.describe('msm227')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm227 import *
import numpy as np
# See the function signature in fn/msm227.py for argument names.
```
