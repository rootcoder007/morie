...
__all__ = ["hedderich_chapter_9_unnumbered_3623"]


def hedderich_chapter_9_unnumbered_3623(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (δx) eδxx+δyy eδxx+δyy+γxyxy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3623')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3623: GeneralStatistics expression (auto-extracted; see ref)."
