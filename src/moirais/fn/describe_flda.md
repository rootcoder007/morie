...
`print(result)` render. See `moirais.fn.describe('flda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.flda import *
import numpy as np
# See the function signature in fn/flda.py for argument names.
```
