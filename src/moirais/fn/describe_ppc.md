# describe('ppc') — posterior_predictive_check
...
`print(result)` render. See `moirais.fn.describe('ppc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppc import *
import numpy as np
# See the function signature in fn/ppc.py for argument names.
```
