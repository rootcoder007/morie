...
__all__ = ["hedderich_chapter_9_unnumbered_2613"]


def hedderich_chapter_9_unnumbered_2613(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Sum a + c b + d n1 + n2 = n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2613')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2613: GeneralStatistics expression (auto-extracted; see ref)."
