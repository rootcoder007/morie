# describe('ublib') — ublib

## WHAT IT DOES

Library coverage spatial
...
`print(result)` render. See `moirais.fn.describe('ublib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ublib import *
import numpy as np
# See the function signature in fn/ublib.py for argument names.
```
