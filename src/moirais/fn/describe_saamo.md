...
`print(result)` render. See `moirais.fn.describe('saamo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.saamo import *
import numpy as np
# See the function signature in fn/saamo.py for argument names.
```
