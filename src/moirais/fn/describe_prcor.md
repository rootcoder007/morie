...
`print(result)` render. See `moirais.fn.describe('prcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prcor import *
import numpy as np
# See the function signature in fn/prcor.py for argument names.
```
