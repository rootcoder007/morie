...
`print(result)` render. See `moirais.fn.describe('svpd2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpd2 import *
import numpy as np
# See the function signature in fn/svpd2.py for argument names.
```
