...
`print(result)` render. See `moirais.fn.describe('samsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samsp import *
import numpy as np
# See the function signature in fn/samsp.py for argument names.
```
