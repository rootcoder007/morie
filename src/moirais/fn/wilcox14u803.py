...
__all__ = ["wilcox_chapter_14_unnumbered_803"]


def wilcox_chapter_14_unnumbered_803(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u803')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u803: GeneralStatistics expression (auto-extracted; see ref)."
