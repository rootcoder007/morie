# describe('lasso') — _soft_threshold
...
`print(result)` render. See `moirais.fn.describe('lasso')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lasso import *
import numpy as np
# See the function signature in fn/lasso.py for argument names.
```
