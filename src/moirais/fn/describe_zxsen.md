# describe('zxsen') — spatial_stacking
...
`print(result)` render. See `moirais.fn.describe('zxsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsen import *
import numpy as np
# See the function signature in fn/zxsen.py for argument names.
```
