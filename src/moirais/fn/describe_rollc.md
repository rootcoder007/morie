# describe('rollc') — roll_call_analysis
...
`print(result)` render. See `moirais.fn.describe('rollc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rollc import *
import numpy as np
# See the function signature in fn/rollc.py for argument names.
```
