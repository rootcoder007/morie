...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_380"]


def guide_on_data_analysis_chapter_5_unnumbered_380(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Hat_Values = hat_values,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u380')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u380: GeneralStatistics expression (auto-extracted; see ref)."
