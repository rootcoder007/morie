# describe('orisk') — otis_risk_table
...
`print(result)` render. See `moirais.fn.describe('orisk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orisk import *
import numpy as np
# See the function signature in fn/orisk.py for argument names.
```
