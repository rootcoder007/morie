...
`print(result)` render. See `moirais.fn.describe('page')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.page import *
import numpy as np
# See the function signature in fn/page.py for argument names.
```
