# describe('evdedh') — evt_dekkers_einmahl_dehaan
...
`print(result)` render. See `moirais.fn.describe('evdedh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evdedh import *
import numpy as np
# See the function signature in fn/evdedh.py for argument names.
```
