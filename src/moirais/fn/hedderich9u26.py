...
__all__ = ["hedderich_chapter_9_unnumbered_26"]


def hedderich_chapter_9_unnumbered_26(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: whole numbers, a number range in which every subtraction task has a solution (e.g.: 8−12 = −4).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u26')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u26: GeneralStatistics expression (auto-extracted; see ref)."
