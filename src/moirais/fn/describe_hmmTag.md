...
`print(result)` render. See `moirais.fn.describe('hmmTag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmTag import *
import numpy as np
# See the function signature in fn/hmmTag.py for argument names.
```
