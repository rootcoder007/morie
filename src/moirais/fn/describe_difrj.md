...
`print(result)` render. See `moirais.fn.describe('difrj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difrj import *
import numpy as np
# See the function signature in fn/difrj.py for argument names.
```
