# describe('rng059') — rangayyan_ch3_pole_zero_factored_form_alt
...
`print(result)` render. See `moirais.fn.describe('rng059')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng059 import *
import numpy as np
# See the function signature in fn/rng059.py for argument names.
```
