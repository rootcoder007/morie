# describe('itr2dd') — itr_optimal_did
...
`print(result)` render. See `moirais.fn.describe('itr2dd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itr2dd import *
import numpy as np
# See the function signature in fn/itr2dd.py for argument names.
```
