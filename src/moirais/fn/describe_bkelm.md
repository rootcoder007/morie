# describe('bkelm') — burkov_elman_rnn
...
`print(result)` render. See `moirais.fn.describe('bkelm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkelm import *
import numpy as np
# See the function signature in fn/bkelm.py for argument names.
```
