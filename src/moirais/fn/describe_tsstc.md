...
`print(result)` render. See `moirais.fn.describe('tsstc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstc import *
import numpy as np
# See the function signature in fn/tsstc.py for argument names.
```
