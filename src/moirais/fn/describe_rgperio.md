# describe('rgperio') — rangayyan_periodogram
...
`print(result)` render. See `moirais.fn.describe('rgperio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgperio import *
import numpy as np
# See the function signature in fn/rgperio.py for argument names.
```
