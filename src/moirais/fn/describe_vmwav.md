...
`print(result)` render. See `moirais.fn.describe('vmwav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmwav import *
import numpy as np
# See the function signature in fn/vmwav.py for argument names.
```
