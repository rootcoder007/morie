...
`print(result)` render. See `moirais.fn.describe('spphaus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spphaus import *
import numpy as np
# See the function signature in fn/spphaus.py for argument names.
```
