# describe('sqntz') — quantize_signal
...
`print(result)` render. See `moirais.fn.describe('sqntz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqntz import *
import numpy as np
# See the function signature in fn/sqntz.py for argument names.
```
