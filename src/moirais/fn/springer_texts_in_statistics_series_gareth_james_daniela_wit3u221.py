...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_221"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_3_unnumbered_221(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: f1(x)= a1 +b1x+c1x2 +d1x3,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit3u221')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit3u221: GeneralStatistics expression (auto-extracted; see ref)."
