...
__all__ = ["hedderich_chapter_9_unnumbered_117"]


def hedderich_chapter_9_unnumbered_117(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u117')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u117: GeneralStatistics expression (auto-extracted; see ref)."
