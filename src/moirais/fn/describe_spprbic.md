...
`print(result)` render. See `moirais.fn.describe('spprbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spprbic import *
import numpy as np
# See the function signature in fn/spprbic.py for argument names.
```
