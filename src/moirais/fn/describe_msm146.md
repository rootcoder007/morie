# describe('msm146') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm146')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm146 import *
import numpy as np
# See the function signature in fn/msm146.py for argument names.
```
