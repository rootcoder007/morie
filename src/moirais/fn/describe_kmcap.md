# describe('kmcap') — kamath_expert_capacity_factor
...
`print(result)` render. See `moirais.fn.describe('kmcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcap import *
import numpy as np
# See the function signature in fn/kmcap.py for argument names.
```
