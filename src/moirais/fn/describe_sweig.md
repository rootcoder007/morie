...
`print(result)` render. See `moirais.fn.describe('sweig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sweig import *
import numpy as np
# See the function signature in fn/sweig.py for argument names.
```
