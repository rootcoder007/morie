...
`print(result)` render. See `moirais.fn.describe('nadmf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nadmf import *
import numpy as np
# See the function signature in fn/nadmf.py for argument names.
```
