...
`print(result)` render. See `moirais.fn.describe('gmatv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gmatv import *
import numpy as np
# See the function signature in fn/gmatv.py for argument names.
```
