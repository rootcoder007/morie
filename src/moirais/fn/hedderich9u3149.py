...
__all__ = ["hedderich_chapter_9_unnumbered_3149"]


def hedderich_chapter_9_unnumbered_3149(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0:ϱS = 0 against HA:ϱS̸= 0 ; α= 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3149')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3149: GeneralStatistics expression (auto-extracted; see ref)."
