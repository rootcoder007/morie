...
`print(result)` render. See `moirais.fn.describe('pettit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pettit import *
import numpy as np
# See the function signature in fn/pettit.py for argument names.
```
