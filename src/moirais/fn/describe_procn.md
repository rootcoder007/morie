...
`print(result)` render. See `moirais.fn.describe('procn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.procn import *
import numpy as np
# See the function signature in fn/procn.py for argument names.
```
