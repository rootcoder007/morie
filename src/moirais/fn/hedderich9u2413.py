...
__all__ = ["hedderich_chapter_9_unnumbered_2413"]


def hedderich_chapter_9_unnumbered_2413(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: α = 0.10 two-sided (α = 0.05 one-sided)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2413')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2413: GeneralStatistics expression (auto-extracted; see ref)."
