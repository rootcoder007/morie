...
`print(result)` render. See `moirais.fn.describe('shply')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shply import *
import numpy as np
# See the function signature in fn/shply.py for argument names.
```
