...
`print(result)` render. See `moirais.fn.describe('kdist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kdist import *
import numpy as np
# See the function signature in fn/kdist.py for argument names.
```
