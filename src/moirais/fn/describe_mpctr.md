...
`print(result)` render. See `moirais.fn.describe('mpctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpctr import *
import numpy as np
# See the function signature in fn/mpctr.py for argument names.
```
