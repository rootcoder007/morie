...
`print(result)` render. See `moirais.fn.describe('alco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alco import *
import numpy as np
# See the function signature in fn/alco.py for argument names.
```
