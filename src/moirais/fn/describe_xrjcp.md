# describe('xrjcp') — join_count_perm
...
`print(result)` render. See `moirais.fn.describe('xrjcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrjcp import *
import numpy as np
# See the function signature in fn/xrjcp.py for argument names.
```
