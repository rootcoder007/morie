# describe('gbm') — gradient_boosting
...
`print(result)` render. See `moirais.fn.describe('gbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbm import *
import numpy as np
# See the function signature in fn/gbm.py for argument names.
```
