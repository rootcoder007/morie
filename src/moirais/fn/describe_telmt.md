# describe('telmt') — telemetry_drift
...
`print(result)` render. See `moirais.fn.describe('telmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.telmt import *
import numpy as np
# See the function signature in fn/telmt.py for argument names.
```
