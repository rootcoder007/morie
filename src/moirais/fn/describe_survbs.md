# describe('survbs') — survival_bootstrap_se
...
`print(result)` render. See `moirais.fn.describe('survbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survbs import *
import numpy as np
# See the function signature in fn/survbs.py for argument names.
```
