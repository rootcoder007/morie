# describe('hmaen') — geron_autoencoder
...
`print(result)` render. See `moirais.fn.describe('hmaen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmaen import *
import numpy as np
# See the function signature in fn/hmaen.py for argument names.
```
