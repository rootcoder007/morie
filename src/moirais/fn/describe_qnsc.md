...
`print(result)` render. See `moirais.fn.describe('qnsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qnsc import *
import numpy as np
# See the function signature in fn/qnsc.py for argument names.
```
