# describe('gh_c2_2') — ghosal_gp_prior_def
...
`print(result)` render. See `moirais.fn.describe('gh_c2_2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c2_2 import *
import numpy as np
# See the function signature in fn/gh_c2_2.py for argument names.
```
