# describe('gfunc') — pair_correlation
...
`print(result)` render. See `moirais.fn.describe('gfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gfunc import *
import numpy as np
# See the function signature in fn/gfunc.py for argument names.
```
