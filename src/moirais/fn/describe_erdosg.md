# describe('erdosg') — erdos_renyi_gnp
...
`print(result)` render. See `moirais.fn.describe('erdosg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.erdosg import *
import numpy as np
# See the function signature in fn/erdosg.py for argument names.
```
