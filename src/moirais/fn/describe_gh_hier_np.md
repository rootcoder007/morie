# describe('gh_hier_np') — ghosal_hierarchical_np
...
`print(result)` render. See `moirais.fn.describe('gh_hier_np')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_hier_np import *
import numpy as np
# See the function signature in fn/gh_hier_np.py for argument names.
```
