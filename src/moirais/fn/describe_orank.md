# describe('orank') — otis_rank_regions
...
`print(result)` render. See `moirais.fn.describe('orank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.orank import *
import numpy as np
# See the function signature in fn/orank.py for argument names.
```
