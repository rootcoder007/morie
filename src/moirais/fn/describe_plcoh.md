...
`print(result)` render. See `moirais.fn.describe('plcoh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plcoh import *
import numpy as np
# See the function signature in fn/plcoh.py for argument names.
```
