...
`print(result)` render. See `moirais.fn.describe('indsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.indsc import *
import numpy as np
# See the function signature in fn/indsc.py for argument names.
```
