...
`print(result)` render. See `moirais.fn.describe('gwrdlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrdlt import *
import numpy as np
# See the function signature in fn/gwrdlt.py for argument names.
```
