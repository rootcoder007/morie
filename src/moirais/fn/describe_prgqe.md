# describe('prgqe') — program_quasi_exp
...
`print(result)` render. See `moirais.fn.describe('prgqe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgqe import *
import numpy as np
# See the function signature in fn/prgqe.py for argument names.
```
