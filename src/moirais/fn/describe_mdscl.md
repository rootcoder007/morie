...
`print(result)` render. See `moirais.fn.describe('mdscl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdscl import *
import numpy as np
# See the function signature in fn/mdscl.py for argument names.
```
