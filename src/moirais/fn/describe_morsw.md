...
`print(result)` render. See `moirais.fn.describe('morsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.morsw import *
import numpy as np
# See the function signature in fn/morsw.py for argument names.
```
