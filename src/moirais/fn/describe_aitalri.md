# describe('aitalri') — aitchison_alr_inverse
...
`print(result)` render. See `moirais.fn.describe('aitalri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitalri import *
import numpy as np
# See the function signature in fn/aitalri.py for argument names.
```
