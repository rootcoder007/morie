...
`print(result)` render. See `moirais.fn.describe('fstat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fstat import *
import numpy as np
# See the function signature in fn/fstat.py for argument names.
```
