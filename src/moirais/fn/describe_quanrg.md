# describe('quanrg') — quantile_regression
...
`print(result)` render. See `moirais.fn.describe('quanrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.quanrg import *
import numpy as np
# See the function signature in fn/quanrg.py for argument names.
```
