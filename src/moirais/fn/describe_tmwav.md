...
`print(result)` render. See `moirais.fn.describe('tmwav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmwav import *
import numpy as np
# See the function signature in fn/tmwav.py for argument names.
```
