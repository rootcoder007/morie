...
`print(result)` render. See `moirais.fn.describe('ghdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghdis import *
import numpy as np
# See the function signature in fn/ghdis.py for argument names.
```
