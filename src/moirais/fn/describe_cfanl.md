...
`print(result)` render. See `moirais.fn.describe('cfanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfanl import *
import numpy as np
# See the function signature in fn/cfanl.py for argument names.
```
