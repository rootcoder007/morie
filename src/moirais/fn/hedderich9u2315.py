...
__all__ = ["hedderich_chapter_9_unnumbered_2315"]


def hedderich_chapter_9_unnumbered_2315(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] BH =max{j : p(j)≤α·j
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2315')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2315: PowerAndDesign expression (auto-extracted; see ref)."
