...
`print(result)` render. See `moirais.fn.describe('bgodf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgodf import *
import numpy as np
# See the function signature in fn/bgodf.py for argument names.
```
