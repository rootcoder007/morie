...
__all__ = ["hedderich_chapter_9_unnumbered_2092"]


def hedderich_chapter_9_unnumbered_2092(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: againstHA: µd > 0 or µd < 0 or in the two-sided test µd̸= 0 . In addition, ( 7.124) is always
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2092')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2092: GeneralStatistics expression (auto-extracted; see ref)."
