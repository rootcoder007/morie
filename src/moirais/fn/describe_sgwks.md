# describe('sgwks') — weak_stationarity_test
...
`print(result)` render. See `moirais.fn.describe('sgwks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgwks import *
import numpy as np
# See the function signature in fn/sgwks.py for argument names.
```
