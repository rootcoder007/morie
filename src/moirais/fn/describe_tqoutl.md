# describe('tqoutl') — turboquant_outlier_channel_split
...
`print(result)` render. See `moirais.fn.describe('tqoutl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqoutl import *
import numpy as np
# See the function signature in fn/tqoutl.py for argument names.
```
