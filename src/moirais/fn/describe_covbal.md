# describe('covbal') — covariate_balance_check
...
`print(result)` render. See `moirais.fn.describe('covbal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covbal import *
import numpy as np
# See the function signature in fn/covbal.py for argument names.
```
