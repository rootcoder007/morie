...
__all__ = ["hedderich_chapter_9_unnumbered_932"]


def hedderich_chapter_9_unnumbered_932(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] i=1xi exp(−xi/ˆδ)∑n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u932')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u932: PowerAndDesign expression (auto-extracted; see ref)."
