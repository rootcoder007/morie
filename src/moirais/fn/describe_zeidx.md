...
`print(result)` render. See `moirais.fn.describe('zeidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeidx import *
import numpy as np
# See the function signature in fn/zeidx.py for argument names.
```
