# describe('gb5714') — gibbons_wsrt_sampsize
...
`print(result)` render. See `moirais.fn.describe('gb5714')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5714 import *
import numpy as np
# See the function signature in fn/gb5714.py for argument names.
```
