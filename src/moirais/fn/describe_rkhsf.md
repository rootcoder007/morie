...
`print(result)` render. See `moirais.fn.describe('rkhsf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rkhsf import *
import numpy as np
# See the function signature in fn/rkhsf.py for argument names.
```
