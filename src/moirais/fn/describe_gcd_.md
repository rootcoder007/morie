...
`print(result)` render. See `moirais.fn.describe('gcd_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcd_ import *
import numpy as np
# See the function signature in fn/gcd_.py for argument names.
```
