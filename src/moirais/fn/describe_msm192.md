# describe('msm192') — mvsml_ridge_lasso_elastic_eq_9_20
...
`print(result)` render. See `moirais.fn.describe('msm192')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm192 import *
import numpy as np
# See the function signature in fn/msm192.py for argument names.
```
