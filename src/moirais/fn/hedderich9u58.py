...
__all__ = ["hedderich_chapter_9_unnumbered_58"]


def hedderich_chapter_9_unnumbered_58(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = lgc−1 = (−1) lgc = −lgc
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u58')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u58: GeneralStatistics expression (auto-extracted; see ref)."
