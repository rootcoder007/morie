...
`print(result)` render. See `moirais.fn.describe('volccc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volccc import *
import numpy as np
# See the function signature in fn/volccc.py for argument names.
```
