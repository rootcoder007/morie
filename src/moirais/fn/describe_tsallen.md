# describe('tsallen') — tsallis_entropy
...
`print(result)` render. See `moirais.fn.describe('tsallen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsallen import *
import numpy as np
# See the function signature in fn/tsallen.py for argument names.
```
