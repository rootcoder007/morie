...
__all__ = ["hedderich_chapter_9_unnumbered_2194"]


def hedderich_chapter_9_unnumbered_2194(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + i f ( alternative == " two − sided " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2194')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2194: GeneralStatistics expression (auto-extracted; see ref)."
