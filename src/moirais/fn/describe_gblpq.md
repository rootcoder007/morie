# describe('gblpq') — gblup_equivalence
...
`print(result)` render. See `moirais.fn.describe('gblpq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gblpq import *
import numpy as np
# See the function signature in fn/gblpq.py for argument names.
```
