# describe('rcfcv') — reflection_to_ar
...
`print(result)` render. See `moirais.fn.describe('rcfcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcfcv import *
import numpy as np
# See the function signature in fn/rcfcv.py for argument names.
```
