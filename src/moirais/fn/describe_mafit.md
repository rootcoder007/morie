...
`print(result)` render. See `moirais.fn.describe('mafit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafit import *
import numpy as np
# See the function signature in fn/mafit.py for argument names.
```
