# describe('hrzaul') — horowitz_additive_unknown_link
...
`print(result)` render. See `moirais.fn.describe('hrzaul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzaul import *
import numpy as np
# See the function signature in fn/hrzaul.py for argument names.
```
