...
`print(result)` render. See `moirais.fn.describe('robpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.robpca import *
import numpy as np
# See the function signature in fn/robpca.py for argument names.
```
