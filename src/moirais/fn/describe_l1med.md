...
`print(result)` render. See `moirais.fn.describe('l1med')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.l1med import *
import numpy as np
# See the function signature in fn/l1med.py for argument names.
```
