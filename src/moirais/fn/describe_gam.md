...
`print(result)` render. See `moirais.fn.describe('gam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gam import *
import numpy as np
# See the function signature in fn/gam.py for argument names.
```
