...
`print(result)` render. See `moirais.fn.describe('agalb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agalb import *
import numpy as np
# See the function signature in fn/agalb.py for argument names.
```
