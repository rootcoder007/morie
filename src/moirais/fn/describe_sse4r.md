...
`print(result)` render. See `moirais.fn.describe('sse4r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sse4r import *
import numpy as np
# See the function signature in fn/sse4r.py for argument names.
```
