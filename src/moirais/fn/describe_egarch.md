...
`print(result)` render. See `moirais.fn.describe('egarch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.egarch import *
import numpy as np
# See the function signature in fn/egarch.py for argument names.
```
