# describe('bonf') — bonferroni_correction
...
`print(result)` render. See `moirais.fn.describe('bonf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bonf import *
import numpy as np
# See the function signature in fn/bonf.py for argument names.
```
