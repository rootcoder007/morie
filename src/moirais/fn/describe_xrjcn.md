...
`print(result)` render. See `moirais.fn.describe('xrjcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrjcn import *
import numpy as np
# See the function signature in fn/xrjcn.py for argument names.
```
