# describe('spcokr') — schabenberger_cokriging
...
`print(result)` render. See `moirais.fn.describe('spcokr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spcokr import *
import numpy as np
# See the function signature in fn/spcokr.py for argument names.
```
