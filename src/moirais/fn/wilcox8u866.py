...
__all__ = ["wilcox_chapter_8_unnumbered_866"]


def wilcox_chapter_8_unnumbered_866(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: 7. Reject if D ≥ d(u), where u = (1 − α )B, rounded
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u866')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u866: Resampling expression (auto-extracted; see ref)."
