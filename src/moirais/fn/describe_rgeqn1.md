# describe('rgeqn1') — rangayyan_ch1_signal_stats
...
`print(result)` render. See `moirais.fn.describe('rgeqn1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgeqn1 import *
import numpy as np
# See the function signature in fn/rgeqn1.py for argument names.
```
