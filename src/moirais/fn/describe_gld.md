...
`print(result)` render. See `moirais.fn.describe('gld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gld import *
import numpy as np
# See the function signature in fn/gld.py for argument names.
```
