...
`print(result)` render. See `moirais.fn.describe('plafp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plafp import *
import numpy as np
# See the function signature in fn/plafp.py for argument names.
```
