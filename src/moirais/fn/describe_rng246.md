# describe('rng246') — rangayyan_ch4_signal_with_echo_input
...
`print(result)` render. See `moirais.fn.describe('rng246')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng246 import *
import numpy as np
# See the function signature in fn/rng246.py for argument names.
```
