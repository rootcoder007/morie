# describe('shdiv') — shannon_diversity
...
`print(result)` render. See `moirais.fn.describe('shdiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shdiv import *
import numpy as np
# See the function signature in fn/shdiv.py for argument names.
```
