...
__all__ = ["hedderich_chapter_9_unnumbered_2320"]


def hedderich_chapter_9_unnumbered_2320(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2320')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2320: GeneralStatistics expression (auto-extracted; see ref)."
