# describe('mavi') — ma_var_inflation_correlated
...
`print(result)` render. See `moirais.fn.describe('mavi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mavi import *
import numpy as np
# See the function signature in fn/mavi.py for argument names.
```
