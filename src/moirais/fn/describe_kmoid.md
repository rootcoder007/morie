...
`print(result)` render. See `moirais.fn.describe('kmoid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmoid import *
import numpy as np
# See the function signature in fn/kmoid.py for argument names.
```
