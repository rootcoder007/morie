...
`print(result)` render. See `moirais.fn.describe('slear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slear import *
import numpy as np
# See the function signature in fn/slear.py for argument names.
```
