...
__all__ = ["wilcox_chapter_14_unnumbered_513"]


def wilcox_chapter_14_unnumbered_513(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Verify that r = 0.4 and that you reject H0: β 1 = 0 with α = 0.05 and the R
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u513')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u513: GeneralStatistics expression (auto-extracted; see ref)."
