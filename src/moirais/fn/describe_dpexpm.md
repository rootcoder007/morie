# describe('dpexpm') — dp_exponential_mechanism
...
`print(result)` render. See `moirais.fn.describe('dpexpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpexpm import *
import numpy as np
# See the function signature in fn/dpexpm.py for argument names.
```
