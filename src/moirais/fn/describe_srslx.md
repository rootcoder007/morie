...
`print(result)` render. See `moirais.fn.describe('srslx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srslx import *
import numpy as np
# See the function signature in fn/srslx.py for argument names.
```
