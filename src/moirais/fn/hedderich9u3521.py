...
__all__ = ["hedderich_chapter_9_unnumbered_3521"]
...
def hedderich_chapter_9_unnumbered_3521(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3521')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3521: CentralTendency expression (auto-extracted; see ref)."
