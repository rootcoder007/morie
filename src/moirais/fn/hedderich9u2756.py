...
__all__ = ["hedderich_chapter_9_unnumbered_2756"]


def hedderich_chapter_9_unnumbered_2756(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (a)H01 : π1−π2≥+∆ vs.HA1 : π1−π2 < +∆
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2756')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2756: GeneralStatistics expression (auto-extracted; see ref)."
