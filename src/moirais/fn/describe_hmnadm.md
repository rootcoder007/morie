...
`print(result)` render. See `moirais.fn.describe('hmnadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnadm import *
import numpy as np
# See the function signature in fn/hmnadm.py for argument names.
```
