# describe('longrd') — long_read_polish
...
`print(result)` render. See `moirais.fn.describe('longrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.longrd import *
import numpy as np
# See the function signature in fn/longrd.py for argument names.
```
