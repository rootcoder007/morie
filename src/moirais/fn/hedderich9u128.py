...
__all__ = ["hedderich_chapter_9_unnumbered_128"]


def hedderich_chapter_9_unnumbered_128(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] (n−k)! =n(n−1)·...·(n−k + 1) (2.76)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u128')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u128: CountModels expression (auto-extracted; see ref)."
