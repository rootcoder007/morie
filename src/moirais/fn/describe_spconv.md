# describe('spconv') — schabenberger_convolution_representation
...
`print(result)` render. See `moirais.fn.describe('spconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spconv import *
import numpy as np
# See the function signature in fn/spconv.py for argument names.
```
