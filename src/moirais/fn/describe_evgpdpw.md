...
`print(result)` render. See `moirais.fn.describe('evgpdpw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgpdpw import *
import numpy as np
# See the function signature in fn/evgpdpw.py for argument names.
```
