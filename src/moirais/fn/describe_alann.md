# describe('alann') — alammar_approximate_nearest_neighbor
...
`print(result)` render. See `moirais.fn.describe('alann')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alann import *
import numpy as np
# See the function signature in fn/alann.py for argument names.
```
