# describe('sgmci') — monte_carlo_spatial_test
...
`print(result)` render. See `moirais.fn.describe('sgmci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmci import *
import numpy as np
# See the function signature in fn/sgmci.py for argument names.
```
