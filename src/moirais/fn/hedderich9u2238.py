...
__all__ = ["hedderich_chapter_9_unnumbered_2238"]


def hedderich_chapter_9_unnumbered_2238(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆD = max x|ˆF1,n1 (x)−ˆF2,n2 (x)|= max x|ˆP (X1x̄)−ˆP (X2x̄)|
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2238')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2238: GeneralStatistics expression (auto-extracted; see ref)."
