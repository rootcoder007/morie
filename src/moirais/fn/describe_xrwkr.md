...
`print(result)` render. See `moirais.fn.describe('xrwkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwkr import *
import numpy as np
# See the function signature in fn/xrwkr.py for argument names.
```
