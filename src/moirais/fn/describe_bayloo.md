...
`print(result)` render. See `moirais.fn.describe('bayloo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayloo import *
import numpy as np
# See the function signature in fn/bayloo.py for argument names.
```
