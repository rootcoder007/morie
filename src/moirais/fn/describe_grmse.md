# describe('grmse') — geron_linreg_mse_cost
...
`print(result)` render. See `moirais.fn.describe('grmse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmse import *
import numpy as np
# See the function signature in fn/grmse.py for argument names.
```
