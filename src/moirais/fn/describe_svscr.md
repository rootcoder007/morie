...
`print(result)` render. See `moirais.fn.describe('svscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svscr import *
import numpy as np
# See the function signature in fn/svscr.py for argument names.
```
