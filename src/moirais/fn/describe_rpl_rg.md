# describe('rpl_rg') — rplace_region_gender
...
`print(result)` render. See `moirais.fn.describe('rpl_rg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rpl_rg import *
import numpy as np
# See the function signature in fn/rpl_rg.py for argument names.
```
