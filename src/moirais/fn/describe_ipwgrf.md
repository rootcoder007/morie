...
`print(result)` render. See `moirais.fn.describe('ipwgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipwgrf import *
import numpy as np
# See the function signature in fn/ipwgrf.py for argument names.
```
