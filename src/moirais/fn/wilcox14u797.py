...
__all__ = ["wilcox_chapter_14_unnumbered_797"]


def wilcox_chapter_14_unnumbered_797(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u797')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u797: GeneralStatistics expression (auto-extracted; see ref)."
