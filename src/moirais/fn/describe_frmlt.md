# describe('frmlt') — framelet_decompose
...
`print(result)` render. See `moirais.fn.describe('frmlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frmlt import *
import numpy as np
# See the function signature in fn/frmlt.py for argument names.
```
