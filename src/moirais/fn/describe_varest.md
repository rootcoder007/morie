# describe('varest') — vector_autoregression
...
`print(result)` render. See `moirais.fn.describe('varest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varest import *
import numpy as np
# See the function signature in fn/varest.py for argument names.
```
