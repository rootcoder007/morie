...
__all__ = ["hedderich_chapter_9_unnumbered_3031"]


def hedderich_chapter_9_unnumbered_3031(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + pval <− pchisq ( stat , df =k * ( k −1) / 2 , lower . tail = FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3031')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3031: GeneralStatistics expression (auto-extracted; see ref)."
