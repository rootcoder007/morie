# describe('dpedt') — dp_exchangeable_distribution
...
`print(result)` render. See `moirais.fn.describe('dpedt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpedt import *
import numpy as np
# See the function signature in fn/dpedt.py for argument names.
```
