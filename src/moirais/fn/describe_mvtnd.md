...
`print(result)` render. See `moirais.fn.describe('mvtnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvtnd import *
import numpy as np
# See the function signature in fn/mvtnd.py for argument names.
```
