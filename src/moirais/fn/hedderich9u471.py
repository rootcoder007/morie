...
__all__ = ["hedderich_chapter_9_unnumbered_471"]


def hedderich_chapter_9_unnumbered_471(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 0.50−0.20−0.15+0.05 = 0.20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u471')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u471: GeneralStatistics expression (auto-extracted; see ref)."
