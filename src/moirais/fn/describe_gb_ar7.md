# describe('gb_ar7') — gibbons_are_logistic
...
`print(result)` render. See `moirais.fn.describe('gb_ar7')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ar7 import *
import numpy as np
# See the function signature in fn/gb_ar7.py for argument names.
```
