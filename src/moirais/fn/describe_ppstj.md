...
`print(result)` render. See `moirais.fn.describe('ppstj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppstj import *
import numpy as np
# See the function signature in fn/ppstj.py for argument names.
```
