...
__all__ = ["hedderich_chapter_9_unnumbered_2364"]


def hedderich_chapter_9_unnumbered_2364(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = [(3−5)2+(7−5)2]+[(4−4)2+(2−4)2+...+[(8−6)2+(4−6)2+(6−6)2]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2364')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2364: GeneralStatistics expression (auto-extracted; see ref)."
