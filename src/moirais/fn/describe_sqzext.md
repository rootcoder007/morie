# describe('sqzext') — squeeze_excite
...
`print(result)` render. See `moirais.fn.describe('sqzext')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqzext import *
import numpy as np
# See the function signature in fn/sqzext.py for argument names.
```
