...
`print(result)` render. See `moirais.fn.describe('svmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmix import *
import numpy as np
# See the function signature in fn/svmix.py for argument names.
```
