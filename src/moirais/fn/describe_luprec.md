...
`print(result)` render. See `moirais.fn.describe('luprec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.luprec import *
import numpy as np
# See the function signature in fn/luprec.py for argument names.
```
