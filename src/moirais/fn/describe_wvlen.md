# describe('wvlen') — waveform_length_fn
...
`print(result)` render. See `moirais.fn.describe('wvlen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvlen import *
import numpy as np
# See the function signature in fn/wvlen.py for argument names.
```
