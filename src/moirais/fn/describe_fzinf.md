# describe('fzinf') — fuzzy_inference
...
`print(result)` render. See `moirais.fn.describe('fzinf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzinf import *
import numpy as np
# See the function signature in fn/fzinf.py for argument names.
```
