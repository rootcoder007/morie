...
`print(result)` render. See `moirais.fn.describe('svblp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svblp import *
import numpy as np
# See the function signature in fn/svblp.py for argument names.
```
