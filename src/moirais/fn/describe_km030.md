# describe('km030') — kamath_ch2_nsp_loss
...
`print(result)` render. See `moirais.fn.describe('km030')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km030 import *
import numpy as np
# See the function signature in fn/km030.py for argument names.
```
