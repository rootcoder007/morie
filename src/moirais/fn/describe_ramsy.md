# describe('ramsy') — ramsey_reset_test
...
`print(result)` render. See `moirais.fn.describe('ramsy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ramsy import *
import numpy as np
# See the function signature in fn/ramsy.py for argument names.
```
