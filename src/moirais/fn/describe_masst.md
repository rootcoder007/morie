...
`print(result)` render. See `moirais.fn.describe('masst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.masst import *
import numpy as np
# See the function signature in fn/masst.py for argument names.
```
