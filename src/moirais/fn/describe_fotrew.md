# describe('fotrew') — fotrew

## WHAT IT DOES

Tree detection LiDAR
...
`print(result)` render. See `moirais.fn.describe('fotrew')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fotrew import *
import numpy as np
# See the function signature in fn/fotrew.py for argument names.
```
