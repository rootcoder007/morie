...
`print(result)` render. See `moirais.fn.describe('dk4ok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk4ok import *
import numpy as np
# See the function signature in fn/dk4ok.py for argument names.
```
