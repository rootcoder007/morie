# describe('zeitv') — travel_time_catch
...
`print(result)` render. See `moirais.fn.describe('zeitv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zeitv import *
import numpy as np
# See the function signature in fn/zeitv.py for argument names.
```
