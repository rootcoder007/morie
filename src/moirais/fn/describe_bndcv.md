...
`print(result)` render. See `moirais.fn.describe('bndcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndcv import *
import numpy as np
# See the function signature in fn/bndcv.py for argument names.
```
