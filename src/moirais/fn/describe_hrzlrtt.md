# describe('hrzlrtt') — horowitz_likelihood_ratio_test
...
`print(result)` render. See `moirais.fn.describe('hrzlrtt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzlrtt import *
import numpy as np
# See the function signature in fn/hrzlrtt.py for argument names.
```
