...
`print(result)` render. See `moirais.fn.describe('hmumap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmumap import *
import numpy as np
# See the function signature in fn/hmumap.py for argument names.
```
