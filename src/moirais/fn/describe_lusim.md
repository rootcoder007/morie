...
`print(result)` render. See `moirais.fn.describe('lusim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lusim import *
import numpy as np
# See the function signature in fn/lusim.py for argument names.
```
