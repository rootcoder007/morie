...
`print(result)` render. See `moirais.fn.describe('tausc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tausc import *
import numpy as np
# See the function signature in fn/tausc.py for argument names.
```
