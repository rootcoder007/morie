# describe('itval') — item_validity_index
...
`print(result)` render. See `moirais.fn.describe('itval')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itval import *
import numpy as np
# See the function signature in fn/itval.py for argument names.
```
