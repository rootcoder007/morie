# describe('ca9e1') — ca_chapter_9_equation_1
...
```python
from moirais.fn.ca9e1 import ca_chapter_9_equation_1
import numpy as np
result = ca_chapter_9_equation_1(np.random.default_rng(42).normal(0, 1, 100))
