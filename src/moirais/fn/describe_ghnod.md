...
`print(result)` render. See `moirais.fn.describe('ghnod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghnod import *
import numpy as np
# See the function signature in fn/ghnod.py for argument names.
```
