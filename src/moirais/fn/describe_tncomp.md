# describe('tncomp') — compound_diversity
...
`print(result)` render. See `moirais.fn.describe('tncomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tncomp import *
import numpy as np
# See the function signature in fn/tncomp.py for argument names.
```
