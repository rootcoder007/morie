...
`print(result)` render. See `moirais.fn.describe('agspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agspr import *
import numpy as np
# See the function signature in fn/agspr.py for argument names.
```
