...
`print(result)` render. See `moirais.fn.describe('vgpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgpow import *
import numpy as np
# See the function signature in fn/vgpow.py for argument names.
```
