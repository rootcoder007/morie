# describe('lradp') — lradp

## WHAT IT DOES

rLearning rate scheduler with cosine annealing.
...
`print(result)` render. See `moirais.fn.describe('lradp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lradp import *
import numpy as np
# See the function signature in fn/lradp.py for argument names.
```
