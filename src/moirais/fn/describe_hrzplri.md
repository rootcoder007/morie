# describe('hrzplri') — horowitz_plr_identification
...
`print(result)` render. See `moirais.fn.describe('hrzplri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzplri import *
import numpy as np
# See the function signature in fn/hrzplri.py for argument names.
```
