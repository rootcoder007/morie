# describe('sentn') — sentiment_lexicon
...
`print(result)` render. See `moirais.fn.describe('sentn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sentn import *
import numpy as np
# See the function signature in fn/sentn.py for argument names.
```
