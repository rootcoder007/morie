...
`print(result)` render. See `moirais.fn.describe('semap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semap import *
import numpy as np
# See the function signature in fn/semap.py for argument names.
```
