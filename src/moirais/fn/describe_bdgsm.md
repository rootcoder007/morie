# describe('bdgsm') — bridge_sampling_marginal
...
`print(result)` render. See `moirais.fn.describe('bdgsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdgsm import *
import numpy as np
# See the function signature in fn/bdgsm.py for argument names.
```
