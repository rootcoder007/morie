...
__all__ = ["hedderich_chapter_9_unnumbered_2523"]


def hedderich_chapter_9_unnumbered_2523(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Friedman chi − squared = 3 . 5 , df = 2 , p− value = 0 . 1 7 3 8
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2523')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2523: GeneralStatistics expression (auto-extracted; see ref)."
