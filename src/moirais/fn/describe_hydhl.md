...
`print(result)` render. See `moirais.fn.describe('hydhl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hydhl import *
import numpy as np
# See the function signature in fn/hydhl.py for argument names.
```
