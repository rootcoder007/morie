# describe('bayocl') — bayes_outlier_dp
...
`print(result)` render. See `moirais.fn.describe('bayocl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayocl import *
import numpy as np
# See the function signature in fn/bayocl.py for argument names.
```
