...
`print(result)` render. See `moirais.fn.describe('paord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.paord import *
import numpy as np
# See the function signature in fn/paord.py for argument names.
```
