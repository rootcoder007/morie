# describe('spqkv') — sparse_attention
...
`print(result)` render. See `moirais.fn.describe('spqkv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spqkv import *
import numpy as np
# See the function signature in fn/spqkv.py for argument names.
```
