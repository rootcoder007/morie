# describe('odesc') — otis_demographic_summary
...
`print(result)` render. See `moirais.fn.describe('odesc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.odesc import *
import numpy as np
# See the function signature in fn/odesc.py for argument names.
```
