# describe('malrr') — ma_log_risk_ratio
...
`print(result)` render. See `moirais.fn.describe('malrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.malrr import *
import numpy as np
# See the function signature in fn/malrr.py for argument names.
```
