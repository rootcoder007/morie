...
`print(result)` render. See `moirais.fn.describe('hmfcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfcn import *
import numpy as np
# See the function signature in fn/hmfcn.py for argument names.
```
