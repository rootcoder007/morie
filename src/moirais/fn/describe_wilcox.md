# describe('wilcox') — wilcoxon_signed_rank_test
...
`print(result)` render. See `moirais.fn.describe('wilcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wilcox import *
import numpy as np
# See the function signature in fn/wilcox.py for argument names.
```
