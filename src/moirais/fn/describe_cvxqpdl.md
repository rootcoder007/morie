...
`print(result)` render. See `moirais.fn.describe('cvxqpdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxqpdl import *
import numpy as np
# See the function signature in fn/cvxqpdl.py for argument names.
```
