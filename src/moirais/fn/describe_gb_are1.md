# describe('gb_are1') — gibbons_are_sign_wilcoxon
...
`print(result)` render. See `moirais.fn.describe('gb_are1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_are1 import *
import numpy as np
# See the function signature in fn/gb_are1.py for argument names.
```
