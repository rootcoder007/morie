...
`print(result)` render. See `moirais.fn.describe('csmtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csmtx import *
import numpy as np
# See the function signature in fn/csmtx.py for argument names.
```
