# describe('rgricca') — rangayyan_riccati_eq
...
`print(result)` render. See `moirais.fn.describe('rgricca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgricca import *
import numpy as np
# See the function signature in fn/rgricca.py for argument names.
```
