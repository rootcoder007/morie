# describe('ld50r') — acute_toxicity_ld50
...
`print(result)` render. See `moirais.fn.describe('ld50r')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ld50r import *
import numpy as np
# See the function signature in fn/ld50r.py for argument names.
```
