...
def ca_chapter_7_equation_1(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca7e1')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "Regression expression involving 'multilevel' (auto-extracted; see reference for full context)."},
    )
