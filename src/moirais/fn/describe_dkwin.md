...
`print(result)` render. See `moirais.fn.describe('dkwin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkwin import *
import numpy as np
# See the function signature in fn/dkwin.py for argument names.
```
