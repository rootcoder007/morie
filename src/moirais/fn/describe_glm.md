...
`print(result)` render. See `moirais.fn.describe('glm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glm import *
import numpy as np
# See the function signature in fn/glm.py for argument names.
```
