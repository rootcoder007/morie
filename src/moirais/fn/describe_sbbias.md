...
`print(result)` render. See `moirais.fn.describe('sbbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbbias import *
import numpy as np
# See the function signature in fn/sbbias.py for argument names.
```
