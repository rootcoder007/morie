...
`print(result)` render. See `moirais.fn.describe('vtnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtnet import *
import numpy as np
# See the function signature in fn/vtnet.py for argument names.
```
