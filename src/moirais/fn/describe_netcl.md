# describe('netcl') — network_closeness
...
`print(result)` render. See `moirais.fn.describe('netcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netcl import *
import numpy as np
# See the function signature in fn/netcl.py for argument names.
```
