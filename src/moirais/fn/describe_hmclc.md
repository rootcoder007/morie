# describe('hmclc') — geron_classification_localization
...
`print(result)` render. See `moirais.fn.describe('hmclc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmclc import *
import numpy as np
# See the function signature in fn/hmclc.py for argument names.
```
