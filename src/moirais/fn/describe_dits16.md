# describe('dits16') — dit_diffusion_transformer
...
`print(result)` render. See `moirais.fn.describe('dits16')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dits16 import *
import numpy as np
# See the function signature in fn/dits16.py for argument names.
```
