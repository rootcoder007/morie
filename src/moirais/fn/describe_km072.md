# describe('km072') — kamath_ch5_bradley_terry_pref
...
`print(result)` render. See `moirais.fn.describe('km072')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km072 import *
import numpy as np
# See the function signature in fn/km072.py for argument names.
```
