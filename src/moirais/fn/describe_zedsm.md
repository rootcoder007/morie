# describe('zedsm') — disease_map_pois
...
`print(result)` render. See `moirais.fn.describe('zedsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zedsm import *
import numpy as np
# See the function signature in fn/zedsm.py for argument names.
```
