...
`print(result)` render. See `moirais.fn.describe('enspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enspd import *
import numpy as np
# See the function signature in fn/enspd.py for argument names.
```
