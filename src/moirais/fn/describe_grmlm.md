# describe('grmlm') — geron_bert_mlm_loss
...
`print(result)` render. See `moirais.fn.describe('grmlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grmlm import *
import numpy as np
# See the function signature in fn/grmlm.py for argument names.
```
