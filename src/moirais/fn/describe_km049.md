# describe('km049') — kamath_ch3_top1_prompt_metric
...
`print(result)` render. See `moirais.fn.describe('km049')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km049 import *
import numpy as np
# See the function signature in fn/km049.py for argument names.
```
