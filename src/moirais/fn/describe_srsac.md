...
`print(result)` render. See `moirais.fn.describe('srsac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srsac import *
import numpy as np
# See the function signature in fn/srsac.py for argument names.
```
