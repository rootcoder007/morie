...
`print(result)` render. See `moirais.fn.describe('htidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.htidx import *
import numpy as np
# See the function signature in fn/htidx.py for argument names.
```
