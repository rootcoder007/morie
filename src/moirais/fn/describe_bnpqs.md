# describe('bnpqs') — bayesian_nonparametric_quantiles
...
`print(result)` render. See `moirais.fn.describe('bnpqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnpqs import *
import numpy as np
# See the function signature in fn/bnpqs.py for argument names.
```
