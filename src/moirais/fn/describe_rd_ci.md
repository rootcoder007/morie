# describe('rd_ci') — risk_difference_ci
...
`print(result)` render. See `moirais.fn.describe('rd_ci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rd_ci import *
import numpy as np
# See the function signature in fn/rd_ci.py for argument names.
```
