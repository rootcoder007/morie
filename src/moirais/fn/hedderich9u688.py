...
__all__ = ["hedderich_chapter_9_unnumbered_688"]


def hedderich_chapter_9_unnumbered_688(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u688')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u688: CountModels expression (auto-extracted; see ref)."
