# describe('gb571m') — gibbons_wsrt_mean
...
`print(result)` render. See `moirais.fn.describe('gb571m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb571m import *
import numpy as np
# See the function signature in fn/gb571m.py for argument names.
```
