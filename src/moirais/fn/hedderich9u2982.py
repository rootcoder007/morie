...
__all__ = ["hedderich_chapter_9_unnumbered_2982"]


def hedderich_chapter_9_unnumbered_2982(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 0.20: 95% CI for πSY ;+−πN 2;+=(0.45−0.20)±√
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2982')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2982: GeneralStatistics expression (auto-extracted; see ref)."
