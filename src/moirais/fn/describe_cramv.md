...
`print(result)` render. See `moirais.fn.describe('cramv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cramv import *
import numpy as np
# See the function signature in fn/cramv.py for argument names.
```
