...
__all__ = ["wilcox_chapter_13_unnumbered_1087"]


def wilcox_chapter_13_unnumbered_1087(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: plotit=FALSE, WARN=TRUE, HD=FALSE, OPT=FALSE, xlab="X",ylab="Y",...)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1087')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1087: GeneralStatistics expression (auto-extracted; see ref)."
