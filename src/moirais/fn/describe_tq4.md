...
`print(result)` render. See `moirais.fn.describe('tq4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tq4 import *
import numpy as np
# See the function signature in fn/tq4.py for argument names.
```
