...
`print(result)` render. See `moirais.fn.describe('tokst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tokst import *
import numpy as np
# See the function signature in fn/tokst.py for argument names.
```
