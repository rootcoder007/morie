# describe('fzt53') — fauzi_thm5_3_bdfree_normality
...
`print(result)` render. See `moirais.fn.describe('fzt53')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt53 import *
import numpy as np
# See the function signature in fn/fzt53.py for argument names.
```
