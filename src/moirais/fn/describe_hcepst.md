# describe('hcepst') — complex_cepstrum
...
`print(result)` render. See `moirais.fn.describe('hcepst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hcepst import *
import numpy as np
# See the function signature in fn/hcepst.py for argument names.
```
