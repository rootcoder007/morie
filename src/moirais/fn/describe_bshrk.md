# describe('bshrk') — bayesian_horseshoe
...
`print(result)` render. See `moirais.fn.describe('bshrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bshrk import *
import numpy as np
# See the function signature in fn/bshrk.py for argument names.
```
