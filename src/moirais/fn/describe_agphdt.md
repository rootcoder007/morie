# describe('agphdt') — alphazero_policy_head
...
`print(result)` render. See `moirais.fn.describe('agphdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agphdt import *
import numpy as np
# See the function signature in fn/agphdt.py for argument names.
```
