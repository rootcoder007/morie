...
`print(result)` render. See `moirais.fn.describe('sdemcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemcf import *
import numpy as np
# See the function signature in fn/sdemcf.py for argument names.
```
