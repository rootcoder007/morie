...
`print(result)` render. See `moirais.fn.describe('xrsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrsem import *
import numpy as np
# See the function signature in fn/xrsem.py for argument names.
```
