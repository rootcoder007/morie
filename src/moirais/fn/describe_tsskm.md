...
`print(result)` render. See `moirais.fn.describe('tsskm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsskm import *
import numpy as np
# See the function signature in fn/tsskm.py for argument names.
```
