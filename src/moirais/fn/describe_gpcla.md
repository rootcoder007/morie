# describe('gpcla') — gp_classification
...
`print(result)` render. See `moirais.fn.describe('gpcla')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpcla import *
import numpy as np
# See the function signature in fn/gpcla.py for argument names.
```
