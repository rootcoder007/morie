# describe('spbino') — schabenberger_binomial_process
...
`print(result)` render. See `moirais.fn.describe('spbino')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spbino import *
import numpy as np
# See the function signature in fn/spbino.py for argument names.
```
