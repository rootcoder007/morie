...
`print(result)` render. See `moirais.fn.describe('qboIdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qboIdx import *
import numpy as np
# See the function signature in fn/qboIdx.py for argument names.
```
