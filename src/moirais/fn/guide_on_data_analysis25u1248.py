...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1248"]


def guide_on_data_analysis_chapter_25_unnumbered_1248(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> D = 0.10542, p-value = 0.9348
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1248')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1248: GeneralStatistics expression (auto-extracted; see ref)."
