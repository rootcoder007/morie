# describe('vargpc') — variational_gp_classifier
...
`print(result)` render. See `moirais.fn.describe('vargpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vargpc import *
import numpy as np
# See the function signature in fn/vargpc.py for argument names.
```
