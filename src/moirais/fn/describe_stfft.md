...
`print(result)` render. See `moirais.fn.describe('stfft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stfft import *
import numpy as np
# See the function signature in fn/stfft.py for argument names.
```
