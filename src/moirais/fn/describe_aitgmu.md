# describe('aitgmu') — aitchison_geomean
...
`print(result)` render. See `moirais.fn.describe('aitgmu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitgmu import *
import numpy as np
# See the function signature in fn/aitgmu.py for argument names.
```
