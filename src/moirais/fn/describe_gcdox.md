...
`print(result)` render. See `moirais.fn.describe('gcdox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcdox import *
import numpy as np
# See the function signature in fn/gcdox.py for argument names.
```
