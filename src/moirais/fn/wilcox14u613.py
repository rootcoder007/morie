...
__all__ = ["wilcox_chapter_14_unnumbered_613"]


def wilcox_chapter_14_unnumbered_613(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n2=length(elimna(y)), x=NA, y=NA, alpha=0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u613')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u613: GeneralStatistics expression (auto-extracted; see ref)."
