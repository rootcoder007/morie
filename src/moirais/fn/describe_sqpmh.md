...
`print(result)` render. See `moirais.fn.describe('sqpmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sqpmh import *
import numpy as np
# See the function signature in fn/sqpmh.py for argument names.
```
