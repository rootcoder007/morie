# describe('nprphet') — neural_prophet
...
`print(result)` render. See `moirais.fn.describe('nprphet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nprphet import *
import numpy as np
# See the function signature in fn/nprphet.py for argument names.
```
