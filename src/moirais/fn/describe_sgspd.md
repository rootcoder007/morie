# describe('sgspd') — space_deformation
...
`print(result)` render. See `moirais.fn.describe('sgspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgspd import *
import numpy as np
# See the function signature in fn/sgspd.py for argument names.
```
