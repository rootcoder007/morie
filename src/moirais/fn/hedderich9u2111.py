...
__all__ = ["hedderich_chapter_9_unnumbered_2111"]


def hedderich_chapter_9_unnumbered_2111(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Table 7.24: Continuation of Table 7.24: One-sided testα=0.025; two-sidedα=0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2111')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2111: GeneralStatistics expression (auto-extracted; see ref)."
