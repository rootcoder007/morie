# describe('rgvagadp') — rangayyan_vag_adaptive_tfd
...
`print(result)` render. See `moirais.fn.describe('rgvagadp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvagadp import *
import numpy as np
# See the function signature in fn/rgvagadp.py for argument names.
```
