...
`print(result)` render. See `moirais.fn.describe('sagjb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagjb import *
import numpy as np
# See the function signature in fn/sagjb.py for argument names.
```
