# describe('irt4pl') — four_parameter_logistic
...
`print(result)` render. See `moirais.fn.describe('irt4pl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irt4pl import *
import numpy as np
# See the function signature in fn/irt4pl.py for argument names.
```
