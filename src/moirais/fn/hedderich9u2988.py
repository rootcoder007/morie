...
__all__ = ["hedderich_chapter_9_unnumbered_2988"]


def hedderich_chapter_9_unnumbered_2988(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Since ˆχ2 = 20.164> 5.9915 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2988')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2988: GeneralStatistics expression (auto-extracted; see ref)."
