# describe('hrzpanms') — horowitz_panel_max_score
...
`print(result)` render. See `moirais.fn.describe('hrzpanms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzpanms import *
import numpy as np
# See the function signature in fn/hrzpanms.py for argument names.
```
