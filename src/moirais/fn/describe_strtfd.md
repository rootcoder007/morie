# describe('strtfd') — stratified_design
...
`print(result)` render. See `moirais.fn.describe('strtfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strtfd import *
import numpy as np
# See the function signature in fn/strtfd.py for argument names.
```
