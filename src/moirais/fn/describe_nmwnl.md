# describe('nmwnl') — wnominate_loglik
...
`print(result)` render. See `moirais.fn.describe('nmwnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwnl import *
import numpy as np
# See the function signature in fn/nmwnl.py for argument names.
```
