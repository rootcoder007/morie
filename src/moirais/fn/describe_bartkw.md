# describe('bartkw') — bartlett_kernel_weights
...
`print(result)` render. See `moirais.fn.describe('bartkw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bartkw import *
import numpy as np
# See the function signature in fn/bartkw.py for argument names.
```
