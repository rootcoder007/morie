# describe('fzbwc') — fauzi_quantile_bw_condition
...
`print(result)` render. See `moirais.fn.describe('fzbwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzbwc import *
import numpy as np
# See the function signature in fn/fzbwc.py for argument names.
```
