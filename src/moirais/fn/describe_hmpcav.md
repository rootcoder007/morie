# describe('hmpcav') — geron_pca_variance
...
`print(result)` render. See `moirais.fn.describe('hmpcav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpcav import *
import numpy as np
# See the function signature in fn/hmpcav.py for argument names.
```
