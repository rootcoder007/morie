# describe('ppvpr') — ppv_prevalence

## WHAT IT DOES

Prevalence-based predictive values. 'What is now proved was once only imagined. — William Blake'
...
`print(result)` render. See `moirais.fn.describe('ppvpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppvpr import *
import numpy as np
# See the function signature in fn/ppvpr.py for argument names.
```
