...
`print(result)` render. See `moirais.fn.describe('entro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entro import *
import numpy as np
# See the function signature in fn/entro.py for argument names.
```
