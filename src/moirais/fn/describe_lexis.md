# describe('lexis') — lexis_diagram_data
...
`print(result)` render. See `moirais.fn.describe('lexis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lexis import *
import numpy as np
# See the function signature in fn/lexis.py for argument names.
```
