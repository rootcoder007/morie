...
`print(result)` render. See `moirais.fn.describe('cokrig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cokrig import *
import numpy as np
# See the function signature in fn/cokrig.py for argument names.
```
