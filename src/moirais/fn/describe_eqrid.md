# describe('eqrid') — racial_disparity_index
...
`print(result)` render. See `moirais.fn.describe('eqrid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqrid import *
import numpy as np
# See the function signature in fn/eqrid.py for argument names.
```
