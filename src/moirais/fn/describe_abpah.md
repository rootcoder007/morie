...
`print(result)` render. See `moirais.fn.describe('abpah')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpah import *
import numpy as np
# See the function signature in fn/abpah.py for argument names.
```
