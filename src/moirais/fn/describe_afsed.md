# describe('afsed') — afsed

## WHAT IT DOES

Sedimentation risk spatial
...
`print(result)` render. See `moirais.fn.describe('afsed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afsed import *
import numpy as np
# See the function signature in fn/afsed.py for argument names.
```
