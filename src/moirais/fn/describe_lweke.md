# describe('lweke') — lwe_key_exchange
...
`print(result)` render. See `moirais.fn.describe('lweke')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lweke import *
import numpy as np
# See the function signature in fn/lweke.py for argument names.
```
