...
`print(result)` render. See `moirais.fn.describe('chsim2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chsim2 import *
import numpy as np
# See the function signature in fn/chsim2.py for argument names.
```
