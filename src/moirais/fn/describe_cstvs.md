...
`print(result)` render. See `moirais.fn.describe('cstvs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstvs import *
import numpy as np
# See the function signature in fn/cstvs.py for argument names.
```
