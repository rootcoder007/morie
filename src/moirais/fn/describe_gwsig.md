...
`print(result)` render. See `moirais.fn.describe('gwsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwsig import *
import numpy as np
# See the function signature in fn/gwsig.py for argument names.
```
