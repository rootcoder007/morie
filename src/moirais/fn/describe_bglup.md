# describe('bglup') — bayes_cpi_genomic
...
`print(result)` render. See `moirais.fn.describe('bglup')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bglup import *
import numpy as np
# See the function signature in fn/bglup.py for argument names.
```
