...
`print(result)` render. See `moirais.fn.describe('afsavh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afsavh import *
import numpy as np
# See the function signature in fn/afsavh.py for argument names.
```
