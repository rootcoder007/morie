# describe('lismor') — local_morans_i
...
`print(result)` render. See `moirais.fn.describe('lismor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lismor import *
import numpy as np
# See the function signature in fn/lismor.py for argument names.
```
