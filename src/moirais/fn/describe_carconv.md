...
`print(result)` render. See `moirais.fn.describe('carconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.carconv import *
import numpy as np
# See the function signature in fn/carconv.py for argument names.
```
