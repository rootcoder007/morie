...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_87"]


def information_theory_mackay_chapter_6_unnumbered_87(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P(x1 =a1) +P(x1 =a2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('information_theory_mackay6u87')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u87: GeneralStatistics expression (auto-extracted; see ref)."
