# describe('grqpi') — geron_action_value_function
...
`print(result)` render. See `moirais.fn.describe('grqpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grqpi import *
import numpy as np
# See the function signature in fn/grqpi.py for argument names.
```
