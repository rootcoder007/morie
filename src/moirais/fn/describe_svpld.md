# describe('svpld') — polarization_dim
...
`print(result)` render. See `moirais.fn.describe('svpld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpld import *
import numpy as np
# See the function signature in fn/svpld.py for argument names.
```
