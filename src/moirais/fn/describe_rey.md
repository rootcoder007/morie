# describe('rey') — linear_regression
...
`print(result)` render. See `moirais.fn.describe('rey')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rey import *
import numpy as np
# See the function signature in fn/rey.py for argument names.
```
