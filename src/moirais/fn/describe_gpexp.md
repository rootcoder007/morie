...
`print(result)` render. See `moirais.fn.describe('gpexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpexp import *
import numpy as np
# See the function signature in fn/gpexp.py for argument names.
```
