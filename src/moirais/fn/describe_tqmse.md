...
`print(result)` render. See `moirais.fn.describe('tqmse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqmse import *
import numpy as np
# See the function signature in fn/tqmse.py for argument names.
```
