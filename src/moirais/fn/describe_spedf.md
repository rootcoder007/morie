# describe('spedf') — spectral_edge_freq
...
`print(result)` render. See `moirais.fn.describe('spedf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spedf import *
import numpy as np
# See the function signature in fn/spedf.py for argument names.
```
