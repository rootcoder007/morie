# describe('hmfad') — geron_forward_autodiff
...
`print(result)` render. See `moirais.fn.describe('hmfad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmfad import *
import numpy as np
# See the function signature in fn/hmfad.py for argument names.
```
