...
__all__ = ["wilcox_chapter_2_unnumbered_229"]


def wilcox_chapter_2_unnumbered_229(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: acbinomci(x = sum(y), nn = length(y), y = NA, n = NA, alpha = 0.05)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox2u229')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u229: GeneralStatistics expression (auto-extracted; see ref)."
