...
`print(result)` render. See `moirais.fn.describe('rbfcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfcv import *
import numpy as np
# See the function signature in fn/rbfcv.py for argument names.
```
