...
`print(result)` render. See `moirais.fn.describe('sawer')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawer import *
import numpy as np
# See the function signature in fn/sawer.py for argument names.
```
