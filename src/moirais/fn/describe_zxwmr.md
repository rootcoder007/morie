...
`print(result)` render. See `moirais.fn.describe('zxwmr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxwmr import *
import numpy as np
# See the function signature in fn/zxwmr.py for argument names.
```
