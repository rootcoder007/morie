...
`print(result)` render. See `moirais.fn.describe('taskm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.taskm import *
import numpy as np
# See the function signature in fn/taskm.py for argument names.
```
