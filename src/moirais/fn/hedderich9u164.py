...
__all__ = ["hedderich_chapter_9_unnumbered_164"]


def hedderich_chapter_9_unnumbered_164(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For the calculation of quantiles from classified observations, theα-quantile (0<α< 1) is used:
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u164')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u164: GeneralStatistics expression (auto-extracted; see ref)."
