...
`print(result)` render. See `moirais.fn.describe('hmarim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmarim import *
import numpy as np
# See the function signature in fn/hmarim.py for argument names.
```
