...
__all__ = ["bivand2013_chapter_2_unnumbered_23"]


def bivand2013_chapter_2_unnumbered_23(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 159 +proj=longlat +ellps=intl +towgs84=-87,-98,-121,0,0,0,0 +no_defs
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u23')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u23: GeneralStatistics expression (auto-extracted; see ref)."
