...
__all__ = ["hedderich_chapter_9_unnumbered_2710"]


def hedderich_chapter_9_unnumbered_2710(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + zalpha <− qnorm ( alph a/ 2 , lower . tail = FALSE )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2710')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2710: PowerAndDesign expression (auto-extracted; see ref)."
