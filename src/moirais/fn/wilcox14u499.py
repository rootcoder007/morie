...
__all__ = ["wilcox_chapter_14_unnumbered_499"]


def wilcox_chapter_14_unnumbered_499(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: regpre(x,y,regfun = lsfit, error = absfun, nboot = 100, model = NA)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u499')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u499: Resampling expression (auto-extracted; see ref)."
