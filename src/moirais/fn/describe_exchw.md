...
`print(result)` render. See `moirais.fn.describe('exchw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.exchw import *
import numpy as np
# See the function signature in fn/exchw.py for argument names.
```
