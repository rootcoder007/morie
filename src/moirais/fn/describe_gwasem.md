...
`print(result)` render. See `moirais.fn.describe('gwasem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwasem import *
import numpy as np
# See the function signature in fn/gwasem.py for argument names.
```
