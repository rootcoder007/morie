# describe('mctsel') — mcts_selection
...
`print(result)` render. See `moirais.fn.describe('mctsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mctsel import *
import numpy as np
# See the function signature in fn/mctsel.py for argument names.
```
