# describe('wsmbay') — wasserman_posterior
...
`print(result)` render. See `moirais.fn.describe('wsmbay')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbay import *
import numpy as np
# See the function signature in fn/wsmbay.py for argument names.
```
