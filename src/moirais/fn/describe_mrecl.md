# describe('mrecl') — multiclass_recall
...
`print(result)` render. See `moirais.fn.describe('mrecl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mrecl import *
import numpy as np
# See the function signature in fn/mrecl.py for argument names.
```
