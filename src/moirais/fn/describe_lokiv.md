...
`print(result)` render. See `moirais.fn.describe('lokiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lokiv import *
import numpy as np
# See the function signature in fn/lokiv.py for argument names.
```
