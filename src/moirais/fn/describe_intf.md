# describe('intf') — integrate_function
...
`print(result)` render. See `moirais.fn.describe('intf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intf import *
import numpy as np
# See the function signature in fn/intf.py for argument names.
```
