...
`print(result)` render. See `moirais.fn.describe('isagd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isagd import *
import numpy as np
# See the function signature in fn/isagd.py for argument names.
```
