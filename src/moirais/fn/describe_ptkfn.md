...
`print(result)` render. See `moirais.fn.describe('ptkfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptkfn import *
import numpy as np
# See the function signature in fn/ptkfn.py for argument names.
```
