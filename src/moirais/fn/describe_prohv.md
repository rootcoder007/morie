# describe('prohv') — prohorov_metric
...
`print(result)` render. See `moirais.fn.describe('prohv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prohv import *
import numpy as np
# See the function signature in fn/prohv.py for argument names.
```
