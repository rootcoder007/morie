# describe('pmgbrd') — pm_gemm_burden
...
`print(result)` render. See `moirais.fn.describe('pmgbrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmgbrd import *
import numpy as np
# See the function signature in fn/pmgbrd.py for argument names.
```
