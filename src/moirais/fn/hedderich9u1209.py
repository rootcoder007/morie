...
__all__ = ["hedderich_chapter_9_unnumbered_1209"]


def hedderich_chapter_9_unnumbered_1209(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1209')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1209: CountModels expression (auto-extracted; see ref)."
