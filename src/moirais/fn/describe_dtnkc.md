...
`print(result)` render. See `moirais.fn.describe('dtnkc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtnkc import *
import numpy as np
# See the function signature in fn/dtnkc.py for argument names.
```
