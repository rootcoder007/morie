...
__all__ = ["hedderich_chapter_9_unnumbered_709"]


def hedderich_chapter_9_unnumbered_709(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 0) = λ0e−λ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u709')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u709: GeneralStatistics expression (auto-extracted; see ref)."
