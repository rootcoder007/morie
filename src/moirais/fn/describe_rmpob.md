...
`print(result)` render. See `moirais.fn.describe('rmpob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmpob import *
import numpy as np
# See the function signature in fn/rmpob.py for argument names.
```
