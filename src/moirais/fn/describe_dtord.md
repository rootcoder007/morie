...
`print(result)` render. See `moirais.fn.describe('dtord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtord import *
import numpy as np
# See the function signature in fn/dtord.py for argument names.
```
