...
__all__ = ["hedderich_chapter_9_unnumbered_1390"]


def hedderich_chapter_9_unnumbered_1390(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Deviation p=0.25 p=0.50 p=0.75
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1390')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1390: PowerAndDesign expression (auto-extracted; see ref)."
