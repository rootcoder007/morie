...
`print(result)` render. See `moirais.fn.describe('ljbox2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ljbox2 import *
import numpy as np
# See the function signature in fn/ljbox2.py for argument names.
```
