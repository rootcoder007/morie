...
`print(result)` render. See `moirais.fn.describe('pppnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pppnl import *
import numpy as np
# See the function signature in fn/pppnl.py for argument names.
```
