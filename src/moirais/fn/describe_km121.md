# describe('km121') — kamath_ch8_bertscore_f1
...
`print(result)` render. See `moirais.fn.describe('km121')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km121 import *
import numpy as np
# See the function signature in fn/km121.py for argument names.
```
