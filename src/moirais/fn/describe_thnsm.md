...
`print(result)` render. See `moirais.fn.describe('thnsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thnsm import *
import numpy as np
# See the function signature in fn/thnsm.py for argument names.
```
