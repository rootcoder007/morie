...
`print(result)` render. See `moirais.fn.describe('vtseq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtseq import *
import numpy as np
# See the function signature in fn/vtseq.py for argument names.
```
