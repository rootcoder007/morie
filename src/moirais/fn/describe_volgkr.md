# describe('volgkr') — vol_garman_klass
...
`print(result)` render. See `moirais.fn.describe('volgkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgkr import *
import numpy as np
# See the function signature in fn/volgkr.py for argument names.
```
