# describe('cfahi') — cfa_hierarchical
...
`print(result)` render. See `moirais.fn.describe('cfahi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfahi import *
import numpy as np
# See the function signature in fn/cfahi.py for argument names.
```
