# describe('secrtt') — rotating_token_envelope
...
`print(result)` render. See `moirais.fn.describe('secrtt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.secrtt import *
import numpy as np
# See the function signature in fn/secrtt.py for argument names.
```
