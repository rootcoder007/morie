...
`print(result)` render. See `moirais.fn.describe('suprm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.suprm import *
import numpy as np
# See the function signature in fn/suprm.py for argument names.
```
