...
`print(result)` render. See `moirais.fn.describe('xrwds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrwds import *
import numpy as np
# See the function signature in fn/xrwds.py for argument names.
```
