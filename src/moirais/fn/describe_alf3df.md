# describe('alf3df') — af3_diffusion_step
...
`print(result)` render. See `moirais.fn.describe('alf3df')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alf3df import *
import numpy as np
# See the function signature in fn/alf3df.py for argument names.
```
