# describe('rslnk') — residual_connection
...
`print(result)` render. See `moirais.fn.describe('rslnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rslnk import *
import numpy as np
# See the function signature in fn/rslnk.py for argument names.
```
