# describe('grgcl') — geron_gradient_clipping
...
`print(result)` render. See `moirais.fn.describe('grgcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grgcl import *
import numpy as np
# See the function signature in fn/grgcl.py for argument names.
```
