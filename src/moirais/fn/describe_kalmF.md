...
`print(result)` render. See `moirais.fn.describe('kalmF')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kalmF import *
import numpy as np
# See the function signature in fn/kalmF.py for argument names.
```
