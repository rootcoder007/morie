...
`print(result)` render. See `moirais.fn.describe('dkstf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkstf import *
import numpy as np
# See the function signature in fn/dkstf.py for argument names.
```
