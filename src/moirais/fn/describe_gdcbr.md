...
`print(result)` render. See `moirais.fn.describe('gdcbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdcbr import *
import numpy as np
# See the function signature in fn/gdcbr.py for argument names.
```
