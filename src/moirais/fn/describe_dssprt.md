# describe('dssprt') — dssp_secondary
...
`print(result)` render. See `moirais.fn.describe('dssprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dssprt import *
import numpy as np
# See the function signature in fn/dssprt.py for argument names.
```
