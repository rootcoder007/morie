# describe('scr_a') — subscale_ea_composite_rel
...
`print(result)` render. See `moirais.fn.describe('scr_a')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scr_a import *
import numpy as np
# See the function signature in fn/scr_a.py for argument names.
```
