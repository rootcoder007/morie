# describe('sschin') — chained_imputation
...
`print(result)` render. See `moirais.fn.describe('sschin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sschin import *
import numpy as np
# See the function signature in fn/sschin.py for argument names.
```
