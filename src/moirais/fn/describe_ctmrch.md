...
`print(result)` render. See `moirais.fn.describe('ctmrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ctmrch import *
import numpy as np
# See the function signature in fn/ctmrch.py for argument names.
```
