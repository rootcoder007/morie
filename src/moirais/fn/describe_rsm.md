...
`print(result)` render. See `moirais.fn.describe('rsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsm import *
import numpy as np
# See the function signature in fn/rsm.py for argument names.
```
