# describe('fzksst') — fauzi_ks_statistic
...
`print(result)` render. See `moirais.fn.describe('fzksst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzksst import *
import numpy as np
# See the function signature in fn/fzksst.py for argument names.
```
