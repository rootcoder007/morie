# describe('bnebi') — bayesian_negbinom
...
`print(result)` render. See `moirais.fn.describe('bnebi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnebi import *
import numpy as np
# See the function signature in fn/bnebi.py for argument names.
```
