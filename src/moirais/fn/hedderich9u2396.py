...
__all__ = ["hedderich_chapter_9_unnumbered_2396"]


def hedderich_chapter_9_unnumbered_2396(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: and are given forα= 0.01 andα= 0.05 in Table 7.38 (from Sachs [Sac90]).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2396')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2396: GeneralStatistics expression (auto-extracted; see ref)."
