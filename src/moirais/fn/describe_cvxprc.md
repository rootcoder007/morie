# describe('cvxprc') — boyd_projection
...
`print(result)` render. See `moirais.fn.describe('cvxprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxprc import *
import numpy as np
# See the function signature in fn/cvxprc.py for argument names.
```
