...
__all__ = ["hedderich_chapter_9_unnumbered_433"]


def hedderich_chapter_9_unnumbered_433(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] WithP (A∪B) = P (A) +P (B)−P (A∩B) andP (A∪B)≤1 we get
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u433')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u433: GeneralStatistics expression (auto-extracted; see ref)."
