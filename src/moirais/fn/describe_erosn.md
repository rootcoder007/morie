...
`print(result)` render. See `moirais.fn.describe('erosn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.erosn import *
import numpy as np
# See the function signature in fn/erosn.py for argument names.
```
