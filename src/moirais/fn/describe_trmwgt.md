...
`print(result)` render. See `moirais.fn.describe('trmwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trmwgt import *
import numpy as np
# See the function signature in fn/trmwgt.py for argument names.
```
