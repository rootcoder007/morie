...
`print(result)` render. See `moirais.fn.describe('pptst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pptst import *
import numpy as np
# See the function signature in fn/pptst.py for argument names.
```
