...
__all__ = ["hedderich_chapter_9_unnumbered_2106"]


def hedderich_chapter_9_unnumbered_2106(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 −R1 U2 =mn + n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2106')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2106: GeneralStatistics expression (auto-extracted; see ref)."
