...
`print(result)` render. See `moirais.fn.describe('rnsum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnsum import *
import numpy as np
# See the function signature in fn/rnsum.py for argument names.
```
