...
`print(result)` render. See `moirais.fn.describe('tmlrbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlrbt import *
import numpy as np
# See the function signature in fn/tmlrbt.py for argument names.
```
