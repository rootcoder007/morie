# describe('binMd') — binary_outcome_mediation
...
`print(result)` render. See `moirais.fn.describe('binMd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.binMd import *
import numpy as np
# See the function signature in fn/binMd.py for argument names.
```
