# describe('cal_wg') — calibration_weights
...
`print(result)` render. See `moirais.fn.describe('cal_wg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cal_wg import *
import numpy as np
# See the function signature in fn/cal_wg.py for argument names.
```
