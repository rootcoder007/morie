...
__all__ = ["hedderich_chapter_9_unnumbered_3006"]


def hedderich_chapter_9_unnumbered_3006(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: expected ˆz = 2.034> 1.96, i.e.P = 2·0.021 = 0.042.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3006')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3006: PowerAndDesign expression (auto-extracted; see ref)."
