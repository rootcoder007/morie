...
`print(result)` render. See `moirais.fn.describe('arma')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arma import *
import numpy as np
# See the function signature in fn/arma.py for argument names.
```
