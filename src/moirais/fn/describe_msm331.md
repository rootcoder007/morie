# describe('msm331') — mvsml_functional_regression_eq_15_4
...
`print(result)` render. See `moirais.fn.describe('msm331')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm331 import *
import numpy as np
# See the function signature in fn/msm331.py for argument names.
```
