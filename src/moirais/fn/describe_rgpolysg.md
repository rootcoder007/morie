# describe('rgpolysg') — rangayyan_polysomnography
...
`print(result)` render. See `moirais.fn.describe('rgpolysg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpolysg import *
import numpy as np
# See the function signature in fn/rgpolysg.py for argument names.
```
