# describe('anom') — alpha_nominate_estimate
...
`print(result)` render. See `moirais.fn.describe('anom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anom import *
import numpy as np
# See the function signature in fn/anom.py for argument names.
```
