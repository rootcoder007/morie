...
__all__ = ["hedderich_chapter_9_unnumbered_2287"]


def hedderich_chapter_9_unnumbered_2287(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: is less than the critical value, which can be derived for the symmetric case (ϵ1 =ϵ2 =ϵ) from the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2287')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2287: GeneralStatistics expression (auto-extracted; see ref)."
