# describe('kmicl') — kamath_in_context_learning_prob
...
`print(result)` render. See `moirais.fn.describe('kmicl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmicl import *
import numpy as np
# See the function signature in fn/kmicl.py for argument names.
```
