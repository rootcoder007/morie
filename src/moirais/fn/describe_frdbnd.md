# describe('frdbnd') — frechet_hoeffding_bounds
...
`print(result)` render. See `moirais.fn.describe('frdbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.frdbnd import *
import numpy as np
# See the function signature in fn/frdbnd.py for argument names.
```
