...
__all__ = ["hedderich_chapter_9_unnumbered_3180"]


def hedderich_chapter_9_unnumbered_3180(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Chow test : F =10.72839 with 2 ; 8 degreesof freedom ( P− value = 0.005440255)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3180')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3180: GeneralStatistics expression (auto-extracted; see ref)."
