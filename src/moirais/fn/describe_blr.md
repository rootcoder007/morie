# describe('blr') — bayesian_linear_regression
...
`print(result)` render. See `moirais.fn.describe('blr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.blr import *
import numpy as np
# See the function signature in fn/blr.py for argument names.
```
