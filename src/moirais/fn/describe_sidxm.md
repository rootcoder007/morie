...
`print(result)` render. See `moirais.fn.describe('sidxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sidxm import *
import numpy as np
# See the function signature in fn/sidxm.py for argument names.
```
