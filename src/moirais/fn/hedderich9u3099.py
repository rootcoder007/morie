...
__all__ = ["hedderich_chapter_9_unnumbered_3099"]


def hedderich_chapter_9_unnumbered_3099(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺ n = 14; r = 0.9660; H0:ϱ≤0.8; HA:ϱ>0.8; α= 0.05;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3099')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3099: GeneralStatistics expression (auto-extracted; see ref)."
