# describe('alnmt') — alpha_nominate_score
...
`print(result)` render. See `moirais.fn.describe('alnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alnmt import *
import numpy as np
# See the function signature in fn/alnmt.py for argument names.
```
