...
__all__ = ["hedderich_chapter_9_unnumbered_66"]


def hedderich_chapter_9_unnumbered_66(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The relative error of the difference is: (14−6)/(14 + 6) = 8/20 = 0.40,±40%!
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u66')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u66: GeneralStatistics expression (auto-extracted; see ref)."
