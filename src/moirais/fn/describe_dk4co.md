...
`print(result)` render. See `moirais.fn.describe('dk4co')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk4co import *
import numpy as np
# See the function signature in fn/dk4co.py for argument names.
```
