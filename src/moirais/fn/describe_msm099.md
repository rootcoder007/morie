# describe('msm099') — mvsml_bayesian_regression_pt2_eq_7_3
...
`print(result)` render. See `moirais.fn.describe('msm099')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm099 import *
import numpy as np
# See the function signature in fn/msm099.py for argument names.
```
