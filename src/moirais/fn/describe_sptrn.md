# describe('sptrn') — spatial_trend_surface
...
`print(result)` render. See `moirais.fn.describe('sptrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sptrn import *
import numpy as np
# See the function signature in fn/sptrn.py for argument names.
```
