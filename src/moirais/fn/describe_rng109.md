# describe('rng109') — rangayyan_ch3_ma_8point_recursive_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng109')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng109 import *
import numpy as np
# See the function signature in fn/rng109.py for argument names.
```
