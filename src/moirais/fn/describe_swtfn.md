...
`print(result)` render. See `moirais.fn.describe('swtfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swtfn import *
import numpy as np
# See the function signature in fn/swtfn.py for argument names.
```
