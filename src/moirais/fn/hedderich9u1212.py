...
__all__ = ["hedderich_chapter_9_unnumbered_1212"]


def hedderich_chapter_9_unnumbered_1212(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] + l _ l <− 1 / ( 2*n ) * qchisq ( alph a/ 2 , df =2 *k )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1212')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1212: CountModels expression (auto-extracted; see ref)."
