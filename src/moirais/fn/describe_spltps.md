...
`print(result)` render. See `moirais.fn.describe('spltps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spltps import *
import numpy as np
# See the function signature in fn/spltps.py for argument names.
```
