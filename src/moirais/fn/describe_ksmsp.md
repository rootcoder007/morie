...
`print(result)` render. See `moirais.fn.describe('ksmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksmsp import *
import numpy as np
# See the function signature in fn/ksmsp.py for argument names.
```
