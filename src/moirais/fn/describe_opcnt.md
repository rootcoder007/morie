# describe('opcnt') — opcnt

## WHAT IT DOES

Spatial p-center problem
...
`print(result)` render. See `moirais.fn.describe('opcnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opcnt import *
import numpy as np
# See the function signature in fn/opcnt.py for argument names.
```
