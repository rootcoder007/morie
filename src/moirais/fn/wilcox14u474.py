...
__all__ = ["wilcox_chapter_14_unnumbered_474"]


def wilcox_chapter_14_unnumbered_474(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: B. For example, with α = 0.05, c = 3.8415.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u474')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u474: ContingencyTables expression (auto-extracted; see ref)."
