# describe('ddrbnd') — deer_dr_bounds
...
`print(result)` render. See `moirais.fn.describe('ddrbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ddrbnd import *
import numpy as np
# See the function signature in fn/ddrbnd.py for argument names.
```
