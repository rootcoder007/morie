...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_442"]


def guide_on_data_analysis_chapter_5_unnumbered_442(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: lts_fit = fitted(lts_model),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u442')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u442: GeneralStatistics expression (auto-extracted; see ref)."
