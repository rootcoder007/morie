...
__all__ = ["hedderich_chapter_9_unnumbered_917"]


def hedderich_chapter_9_unnumbered_917(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] max(q) = λ−δlog(−log(q))
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u917')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u917: GeneralStatistics expression (auto-extracted; see ref)."
