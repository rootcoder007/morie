# describe('nnd') — number_needed_to_diagnose
...
`print(result)` render. See `moirais.fn.describe('nnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnd import *
import numpy as np
# See the function signature in fn/nnd.py for argument names.
```
