...
`print(result)` render. See `moirais.fn.describe('enlgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enlgt import *
import numpy as np
# See the function signature in fn/enlgt.py for argument names.
```
