# describe('wavts') — wavelet_time_series
...
`print(result)` render. See `moirais.fn.describe('wavts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wavts import *
import numpy as np
# See the function signature in fn/wavts.py for argument names.
```
