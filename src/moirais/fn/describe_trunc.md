# describe('trunc') — truncated_regression
...
`print(result)` render. See `moirais.fn.describe('trunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trunc import *
import numpy as np
# See the function signature in fn/trunc.py for argument names.
```
