# describe('ertdm') — earth_movers_dist
...
`print(result)` render. See `moirais.fn.describe('ertdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ertdm import *
import numpy as np
# See the function signature in fn/ertdm.py for argument names.
```
