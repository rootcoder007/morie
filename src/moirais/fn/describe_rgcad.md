# describe('rgcad') — rangayyan_cad_pipeline
...
`print(result)` render. See `moirais.fn.describe('rgcad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcad import *
import numpy as np
# See the function signature in fn/rgcad.py for argument names.
```
