...
`print(result)` render. See `moirais.fn.describe('msmlog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmlog import *
import numpy as np
# See the function signature in fn/msmlog.py for argument names.
```
