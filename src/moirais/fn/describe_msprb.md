...
`print(result)` render. See `moirais.fn.describe('msprb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msprb import *
import numpy as np
# See the function signature in fn/msprb.py for argument names.
```
