...
`print(result)` render. See `moirais.fn.describe('acf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acf import *
import numpy as np
# See the function signature in fn/acf.py for argument names.
```
