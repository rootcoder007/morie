...
`print(result)` render. See `moirais.fn.describe('nbl90')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbl90 import *
import numpy as np
# See the function signature in fn/nbl90.py for argument names.
```
