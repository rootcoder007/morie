# describe('fnlm') — function_on_function
...
`print(result)` render. See `moirais.fn.describe('fnlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fnlm import *
import numpy as np
# See the function signature in fn/fnlm.py for argument names.
```
