...
`print(result)` render. See `moirais.fn.describe('dlbcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dlbcox import *
import numpy as np
# See the function signature in fn/dlbcox.py for argument names.
```
