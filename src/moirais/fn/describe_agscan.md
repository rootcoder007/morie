# describe('agscan') — alphazero_self_consistency
...
`print(result)` render. See `moirais.fn.describe('agscan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agscan import *
import numpy as np
# See the function signature in fn/agscan.py for argument names.
```
