...
__all__ = ["hedderich_chapter_9_unnumbered_914"]


def hedderich_chapter_9_unnumbered_914(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (min(Y1,...,Y k)x̄) = 1−(1−F (x))k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u914')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u914: GeneralStatistics expression (auto-extracted; see ref)."
