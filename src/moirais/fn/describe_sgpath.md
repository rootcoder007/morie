...
`print(result)` render. See `moirais.fn.describe('sgpath')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpath import *
import numpy as np
# See the function signature in fn/sgpath.py for argument names.
```
