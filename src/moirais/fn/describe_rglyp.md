# describe('rglyp') — rangayyan_lyapunov
...
`print(result)` render. See `moirais.fn.describe('rglyp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglyp import *
import numpy as np
# See the function signature in fn/rglyp.py for argument names.
```
