# describe('copha') — cophenetic_correlation
...
`print(result)` render. See `moirais.fn.describe('copha')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copha import *
import numpy as np
# See the function signature in fn/copha.py for argument names.
```
