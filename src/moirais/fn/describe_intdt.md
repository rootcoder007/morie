# describe('intdt') — interval_detect
...
`print(result)` render. See `moirais.fn.describe('intdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intdt import *
import numpy as np
# See the function signature in fn/intdt.py for argument names.
```
