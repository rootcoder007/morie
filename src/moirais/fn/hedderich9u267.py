...
__all__ = ["hedderich_chapter_9_unnumbered_267"]


def hedderich_chapter_9_unnumbered_267(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: This results in a class width ofb = 2 orb = 3; in Table 3.8,b = 2 (k = 10 classes) was chosen.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u267')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u267: GeneralStatistics expression (auto-extracted; see ref)."
