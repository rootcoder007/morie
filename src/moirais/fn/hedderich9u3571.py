...
__all__ = ["hedderich_chapter_9_unnumbered_3571"]


def hedderich_chapter_9_unnumbered_3571(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The influencing variable is the therapy group ( k=1). The intercept is estimated by ˆα0=6.333
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3571')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3571: GeneralStatistics expression (auto-extracted; see ref)."
