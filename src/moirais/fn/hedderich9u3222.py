...
__all__ = ["hedderich_chapter_9_unnumbered_3222"]


def hedderich_chapter_9_unnumbered_3222(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: To a: Since ˆt = 1.85> 1.66 = t86;0.95,H0 is rejected at the 5% level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3222')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3222: GeneralStatistics expression (auto-extracted; see ref)."
