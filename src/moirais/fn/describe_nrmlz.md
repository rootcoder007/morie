# describe('nrmlz') — normalize_signal
...
`print(result)` render. See `moirais.fn.describe('nrmlz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nrmlz import *
import numpy as np
# See the function signature in fn/nrmlz.py for argument names.
```
