# describe('km028') — kamath_ch2_alm_loss
...
`print(result)` render. See `moirais.fn.describe('km028')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km028 import *
import numpy as np
# See the function signature in fn/km028.py for argument names.
```
