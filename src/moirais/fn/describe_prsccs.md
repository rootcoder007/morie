...
`print(result)` render. See `moirais.fn.describe('prsccs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsccs import *
import numpy as np
# See the function signature in fn/prsccs.py for argument names.
```
