...
`print(result)` render. See `moirais.fn.describe('eslmds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslmds import *
import numpy as np
# See the function signature in fn/eslmds.py for argument names.
```
