# describe('linkPr') — link_prediction
...
`print(result)` render. See `moirais.fn.describe('linkPr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linkPr import *
import numpy as np
# See the function signature in fn/linkPr.py for argument names.
```
