# describe('ghcon') — ghosal_posterior_consistency
...
`print(result)` render. See `moirais.fn.describe('ghcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghcon import *
import numpy as np
# See the function signature in fn/ghcon.py for argument names.
```
