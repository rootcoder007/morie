...
__all__ = ["hedderich_chapter_9_unnumbered_2603"]


def hedderich_chapter_9_unnumbered_2603(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 5(6+25) =0.026<3.841. The deviation 25/6 = 4.17
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2603')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2603: GeneralStatistics expression (auto-extracted; see ref)."
