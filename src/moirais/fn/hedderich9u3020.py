...
__all__ = ["hedderich_chapter_9_unnumbered_3020"]


def hedderich_chapter_9_unnumbered_3020(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [Generally,Hij : πij = πi.p.j against Aij : πij ̸= πi.π.j with i = 1,...,r (row) and j =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3020')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3020: GeneralStatistics expression (auto-extracted; see ref)."
