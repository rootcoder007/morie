...
__all__ = ["hedderich_chapter_9_unnumbered_2502"]


def hedderich_chapter_9_unnumbered_2502(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] {152(2·15+3)−[52(2·5+3)+52(2·5+3)+52(2·5+3)]}/72 = 9.465
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2502')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2502: GeneralStatistics expression (auto-extracted; see ref)."
