...
`print(result)` render. See `moirais.fn.describe('mgwrcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrcv import *
import numpy as np
# See the function signature in fn/mgwrcv.py for argument names.
```
