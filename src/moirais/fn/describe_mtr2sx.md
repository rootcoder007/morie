# describe('mtr2sx') — sex_specific_mr
...
`print(result)` render. See `moirais.fn.describe('mtr2sx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtr2sx import *
import numpy as np
# See the function signature in fn/mtr2sx.py for argument names.
```
