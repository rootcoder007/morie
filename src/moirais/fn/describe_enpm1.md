...
`print(result)` render. See `moirais.fn.describe('enpm1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enpm1 import *
import numpy as np
# See the function signature in fn/enpm1.py for argument names.
```
