...
`print(result)` render. See `moirais.fn.describe('dvsrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dvsrv import *
import numpy as np
# See the function signature in fn/dvsrv.py for argument names.
```
