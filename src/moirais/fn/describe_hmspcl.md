# describe('hmspcl') — geron_spectral_clustering
...
`print(result)` render. See `moirais.fn.describe('hmspcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmspcl import *
import numpy as np
# See the function signature in fn/hmspcl.py for argument names.
```
