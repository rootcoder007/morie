...
`print(result)` render. See `moirais.fn.describe('vgrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgrng import *
import numpy as np
# See the function signature in fn/vgrng.py for argument names.
```
