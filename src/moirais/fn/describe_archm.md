...
`print(result)` render. See `moirais.fn.describe('archm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.archm import *
import numpy as np
# See the function signature in fn/archm.py for argument names.
```
