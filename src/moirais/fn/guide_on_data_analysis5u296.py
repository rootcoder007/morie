...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_296"]


def guide_on_data_analysis_chapter_5_unnumbered_296(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = y′Hy + y′(I − H)y.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u296')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u296: GeneralStatistics expression (auto-extracted; see ref)."
