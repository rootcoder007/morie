# describe('mthry') — m_theory_dimension
...
`print(result)` render. See `moirais.fn.describe('mthry')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mthry import *
import numpy as np
# See the function signature in fn/mthry.py for argument names.
```
