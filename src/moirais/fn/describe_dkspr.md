...
`print(result)` render. See `moirais.fn.describe('dkspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkspr import *
import numpy as np
# See the function signature in fn/dkspr.py for argument names.
```
