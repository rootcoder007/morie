...
__all__ = ["wilcox_chapter_14_unnumbered_536"]


def wilcox_chapter_14_unnumbered_536(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: t = 3.1564, df = 54, p-value = 0.0026
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u536')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u536: GeneralStatistics expression (auto-extracted; see ref)."
