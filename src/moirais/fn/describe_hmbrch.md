...
`print(result)` render. See `moirais.fn.describe('hmbrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbrch import *
import numpy as np
# See the function signature in fn/hmbrch.py for argument names.
```
