# describe('hrzphd') — horowitz_ph_discrete_obs
...
`print(result)` render. See `moirais.fn.describe('hrzphd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzphd import *
import numpy as np
# See the function signature in fn/hrzphd.py for argument names.
```
