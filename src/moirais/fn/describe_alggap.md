# describe('alggap') — algebraic_connectivity
...
`print(result)` render. See `moirais.fn.describe('alggap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alggap import *
import numpy as np
# See the function signature in fn/alggap.py for argument names.
```
