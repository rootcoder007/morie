# describe('hmhftn') — geron_hf_trainer
...
`print(result)` render. See `moirais.fn.describe('hmhftn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhftn import *
import numpy as np
# See the function signature in fn/hmhftn.py for argument names.
```
