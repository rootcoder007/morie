# describe('cvxbar') — boyd_log_barrier
...
`print(result)` render. See `moirais.fn.describe('cvxbar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxbar import *
import numpy as np
# See the function signature in fn/cvxbar.py for argument names.
```
