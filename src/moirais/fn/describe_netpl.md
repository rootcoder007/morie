# describe('netpl') — network_path_length
...
`print(result)` render. See `moirais.fn.describe('netpl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netpl import *
import numpy as np
# See the function signature in fn/netpl.py for argument names.
```
