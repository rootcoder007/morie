# describe('rsltn') — freq_resolution
...
`print(result)` render. See `moirais.fn.describe('rsltn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsltn import *
import numpy as np
# See the function signature in fn/rsltn.py for argument names.
```
