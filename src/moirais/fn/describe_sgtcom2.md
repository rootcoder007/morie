# describe('sgtcom2') — sgt_communicability_matrix
...
`print(result)` render. See `moirais.fn.describe('sgtcom2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtcom2 import *
import numpy as np
# See the function signature in fn/sgtcom2.py for argument names.
```
