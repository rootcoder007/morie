# describe('drupt') — drupt

## WHAT IT DOES

rDropout regularization (forward pass).
...
`print(result)` render. See `moirais.fn.describe('drupt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drupt import *
import numpy as np
# See the function signature in fn/drupt.py for argument names.
```
