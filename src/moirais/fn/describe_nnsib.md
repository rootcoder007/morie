...
`print(result)` render. See `moirais.fn.describe('nnsib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnsib import *
import numpy as np
# See the function signature in fn/nnsib.py for argument names.
```
