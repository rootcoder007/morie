# describe('andmnh') — andrews_monahan_hac
...
`print(result)` render. See `moirais.fn.describe('andmnh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.andmnh import *
import numpy as np
# See the function signature in fn/andmnh.py for argument names.
```
