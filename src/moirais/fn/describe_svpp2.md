...
`print(result)` render. See `moirais.fn.describe('svpp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpp2 import *
import numpy as np
# See the function signature in fn/svpp2.py for argument names.
```
