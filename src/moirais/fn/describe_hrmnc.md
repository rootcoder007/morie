...
`print(result)` render. See `moirais.fn.describe('hrmnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrmnc import *
import numpy as np
# See the function signature in fn/hrmnc.py for argument names.
```
