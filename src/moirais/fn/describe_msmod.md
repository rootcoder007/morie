...
`print(result)` render. See `moirais.fn.describe('msmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msmod import *
import numpy as np
# See the function signature in fn/msmod.py for argument names.
```
