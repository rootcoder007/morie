...
`print(result)` render. See `moirais.fn.describe('bnskt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnskt2 import *
import numpy as np
# See the function signature in fn/bnskt2.py for argument names.
```
