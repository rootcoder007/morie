# describe('agvhdt') — alphazero_value_head
...
`print(result)` render. See `moirais.fn.describe('agvhdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agvhdt import *
import numpy as np
# See the function signature in fn/agvhdt.py for argument names.
```
