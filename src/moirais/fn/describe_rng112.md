# describe('rng112') — rangayyan_ch3_first_difference_transfer_function
...
`print(result)` render. See `moirais.fn.describe('rng112')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng112 import *
import numpy as np
# See the function signature in fn/rng112.py for argument names.
```
