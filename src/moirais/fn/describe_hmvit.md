# describe('hmvit') — geron_vision_transformer
...
`print(result)` render. See `moirais.fn.describe('hmvit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmvit import *
import numpy as np
# See the function signature in fn/hmvit.py for argument names.
```
