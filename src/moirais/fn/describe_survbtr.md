# describe('survbtr') — bart_survival
...
`print(result)` render. See `moirais.fn.describe('survbtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survbtr import *
import numpy as np
# See the function signature in fn/survbtr.py for argument names.
```
