# describe('aitdrl') — dirichlet_loglik
...
`print(result)` render. See `moirais.fn.describe('aitdrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitdrl import *
import numpy as np
# See the function signature in fn/aitdrl.py for argument names.
```
