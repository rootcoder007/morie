...
__all__ = ["wilcox_chapter_14_unnumbered_635"]


def wilcox_chapter_14_unnumbered_635(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: FALSE, grp = NA, hoch = FALSE, nboot = NA, BA = TRUE, xlab = "Group 1", ylab
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u635')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u635: GeneralStatistics expression (auto-extracted; see ref)."
