...
`print(result)` render. See `moirais.fn.describe('shYa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shYa import *
import numpy as np
# See the function signature in fn/shYa.py for argument names.
```
