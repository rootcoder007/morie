...
`print(result)` render. See `moirais.fn.describe('mnfrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnfrq import *
import numpy as np
# See the function signature in fn/mnfrq.py for argument names.
```
