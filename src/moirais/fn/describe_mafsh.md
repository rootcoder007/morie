...
`print(result)` render. See `moirais.fn.describe('mafsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafsh import *
import numpy as np
# See the function signature in fn/mafsh.py for argument names.
```
