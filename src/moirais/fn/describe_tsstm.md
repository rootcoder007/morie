...
`print(result)` render. See `moirais.fn.describe('tsstm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstm import *
import numpy as np
# See the function signature in fn/tsstm.py for argument names.
```
