...
`print(result)` render. See `moirais.fn.describe('gerdx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gerdx import *
import numpy as np
# See the function signature in fn/gerdx.py for argument names.
```
