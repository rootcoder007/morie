# describe('instp') — instantaneous_phase
...
`print(result)` render. See `moirais.fn.describe('instp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.instp import *
import numpy as np
# See the function signature in fn/instp.py for argument names.
```
