# describe('msm071') — mvsml_bayesian_regression_eq_6_9
...
`print(result)` render. See `moirais.fn.describe('msm071')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm071 import *
import numpy as np
# See the function signature in fn/msm071.py for argument names.
```
