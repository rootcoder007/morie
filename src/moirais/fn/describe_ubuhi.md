...
`print(result)` render. See `moirais.fn.describe('ubuhi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubuhi import *
import numpy as np
# See the function signature in fn/ubuhi.py for argument names.
```
