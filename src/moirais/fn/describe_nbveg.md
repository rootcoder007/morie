...
`print(result)` render. See `moirais.fn.describe('nbveg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbveg import *
import numpy as np
# See the function signature in fn/nbveg.py for argument names.
```
