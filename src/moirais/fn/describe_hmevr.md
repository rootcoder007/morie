# describe('hmevr') — geron_explained_variance_ratio
...
`print(result)` render. See `moirais.fn.describe('hmevr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmevr import *
import numpy as np
# See the function signature in fn/hmevr.py for argument names.
```
