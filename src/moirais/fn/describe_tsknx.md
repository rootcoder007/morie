...
`print(result)` render. See `moirais.fn.describe('tsknx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsknx import *
import numpy as np
# See the function signature in fn/tsknx.py for argument names.
```
