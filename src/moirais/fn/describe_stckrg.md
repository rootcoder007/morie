...
`print(result)` render. See `moirais.fn.describe('stckrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stckrg import *
import numpy as np
# See the function signature in fn/stckrg.py for argument names.
```
