...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1358"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1358(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('statistical_methods_for_spatial_data_analysis1u1358')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u1358: GeneralStatistics expression (auto-extracted; see ref)."
