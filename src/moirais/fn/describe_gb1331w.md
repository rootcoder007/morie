# describe('gb1331w') — gibbons_wsrt_efficacy
...
`print(result)` render. See `moirais.fn.describe('gb1331w')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1331w import *
import numpy as np
# See the function signature in fn/gb1331w.py for argument names.
```
