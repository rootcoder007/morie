# describe('km149') — kamath_ch9_flamingo_factorized
...
`print(result)` render. See `moirais.fn.describe('km149')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km149 import *
import numpy as np
# See the function signature in fn/km149.py for argument names.
```
