# describe('sgchol') — cholesky_grf_sim
...
`print(result)` render. See `moirais.fn.describe('sgchol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgchol import *
import numpy as np
# See the function signature in fn/sgchol.py for argument names.
```
