# describe('mvout') — multivariate_outlier
...
`print(result)` render. See `moirais.fn.describe('mvout')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvout import *
import numpy as np
# See the function signature in fn/mvout.py for argument names.
```
