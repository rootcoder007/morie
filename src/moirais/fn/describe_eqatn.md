...
`print(result)` render. See `moirais.fn.describe('eqatn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqatn import *
import numpy as np
# See the function signature in fn/eqatn.py for argument names.
```
