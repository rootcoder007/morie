...
__all__ = ["hedderich_chapter_9_unnumbered_2153"]


def hedderich_chapter_9_unnumbered_2153(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: U′andU′′withU′+U′′=n·m. As a rule, the valueU = min (U′, U′′) is used for the hypothesis
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2153')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2153: GeneralStatistics expression (auto-extracted; see ref)."
