# describe('agplog') — alphazero_play_log
...
`print(result)` render. See `moirais.fn.describe('agplog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agplog import *
import numpy as np
# See the function signature in fn/agplog.py for argument names.
```
