# describe('spmidw') — schabenberger_idw
...
`print(result)` render. See `moirais.fn.describe('spmidw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spmidw import *
import numpy as np
# See the function signature in fn/spmidw.py for argument names.
```
