# describe('hrzrank') — horowitz_semipar_rank
...
`print(result)` render. See `moirais.fn.describe('hrzrank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzrank import *
import numpy as np
# See the function signature in fn/hrzrank.py for argument names.
```
