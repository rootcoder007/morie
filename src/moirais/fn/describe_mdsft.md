# describe('mdsft') — mds_fit_statistics
...
`print(result)` render. See `moirais.fn.describe('mdsft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsft import *
import numpy as np
# See the function signature in fn/mdsft.py for argument names.
```
