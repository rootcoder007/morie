...
`print(result)` render. See `moirais.fn.describe('kgdsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgdsh import *
import numpy as np
# See the function signature in fn/kgdsh.py for argument names.
```
