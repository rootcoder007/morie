# describe('acpra') — acceptance_rate_diagnostic
...
`print(result)` render. See `moirais.fn.describe('acpra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acpra import *
import numpy as np
# See the function signature in fn/acpra.py for argument names.
```
