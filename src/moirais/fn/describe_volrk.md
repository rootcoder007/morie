# describe('volrk') — vol_realised_kernel
...
`print(result)` render. See `moirais.fn.describe('volrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volrk import *
import numpy as np
# See the function signature in fn/volrk.py for argument names.
```
