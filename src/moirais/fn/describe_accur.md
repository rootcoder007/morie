...
`print(result)` render. See `moirais.fn.describe('accur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.accur import *
import numpy as np
# See the function signature in fn/accur.py for argument names.
```
