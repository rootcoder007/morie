...
`print(result)` render. See `moirais.fn.describe('sdmbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmbic import *
import numpy as np
# See the function signature in fn/sdmbic.py for argument names.
```
