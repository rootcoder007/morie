# describe('ngppr') — normalized_gamma_process
...
`print(result)` render. See `moirais.fn.describe('ngppr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ngppr import *
import numpy as np
# See the function signature in fn/ngppr.py for argument names.
```
