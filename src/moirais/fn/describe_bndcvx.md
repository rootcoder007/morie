# describe('bndcvx') — bound_convex_estimator
...
`print(result)` render. See `moirais.fn.describe('bndcvx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndcvx import *
import numpy as np
# See the function signature in fn/bndcvx.py for argument names.
```
