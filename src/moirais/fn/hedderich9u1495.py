...
__all__ = ["hedderich_chapter_9_unnumbered_1495"]


def hedderich_chapter_9_unnumbered_1495(x):
    """
    ANOVA expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1495')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1495: ANOVA expression (auto-extracted; see ref)."
