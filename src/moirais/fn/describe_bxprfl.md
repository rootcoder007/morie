...
`print(result)` render. See `moirais.fn.describe('bxprfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bxprfl import *
import numpy as np
# See the function signature in fn/bxprfl.py for argument names.
```
