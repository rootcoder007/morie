...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_equation_3(x):
    """
    Probability equation extracted from Analysis of Categorical Data with R (Chapman & Hall CRC -- CHRISTOPHER R   LOUGHIN BILDER (THOMAS M ).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo3e3')`` for the full guide.
...
def cheatsheet():
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo3e3: Probability equation extracted from Analysis of Categorical Data with R (Chapman & Hall CRC -- CHRISTOPHER R   LOUGHIN BILDER (THOMAS M )."
