...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_307"]


def guide_on_data_analysis_chapter_5_unnumbered_307(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: −2X⊤Y + 2X⊤X𝛽 = 0.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u307')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u307: GeneralStatistics expression (auto-extracted; see ref)."
