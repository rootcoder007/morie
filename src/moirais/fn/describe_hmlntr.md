# describe('hmlntr') — geron_layer_normalization
...
`print(result)` render. See `moirais.fn.describe('hmlntr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlntr import *
import numpy as np
# See the function signature in fn/hmlntr.py for argument names.
```
