...
__all__ = ["hedderich_chapter_9_unnumbered_1981"]


def hedderich_chapter_9_unnumbered_1981(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = [2·76−210 + 1]/26.4575 =−2.154 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1981')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1981: GeneralStatistics expression (auto-extracted; see ref)."
