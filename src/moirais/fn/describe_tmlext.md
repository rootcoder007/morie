# describe('tmlext') — tmle_external_data
...
`print(result)` render. See `moirais.fn.describe('tmlext')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlext import *
import numpy as np
# See the function signature in fn/tmlext.py for argument names.
```
