...
`print(result)` render. See `moirais.fn.describe('fbnds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fbnds import *
import numpy as np
# See the function signature in fn/fbnds.py for argument names.
```
