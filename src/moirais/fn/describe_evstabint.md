# describe('evstabint') — evt_xi_ci_profile
...
`print(result)` render. See `moirais.fn.describe('evstabint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evstabint import *
import numpy as np
# See the function signature in fn/evstabint.py for argument names.
```
