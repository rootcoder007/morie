...
__all__ = ["wilcox_chapter_8_unnumbered_808"]


def wilcox_chapter_8_unnumbered_808(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: K (θ 11 +θ 12 + · · · +θ 1 K),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox8u808')`` for the full guide.
...
def cheatsheet():
    return "wilcox8u808: Resampling expression (auto-extracted; see ref)."
