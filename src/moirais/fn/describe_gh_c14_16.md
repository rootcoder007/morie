# describe('gh_c14_16') — ghosal_ncrm_levy
...
`print(result)` render. See `moirais.fn.describe('gh_c14_16')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_16 import *
import numpy as np
# See the function signature in fn/gh_c14_16.py for argument names.
```
