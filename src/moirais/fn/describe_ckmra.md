...
`print(result)` render. See `moirais.fn.describe('ckmra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ckmra import *
import numpy as np
# See the function signature in fn/ckmra.py for argument names.
```
