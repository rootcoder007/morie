# describe('rgwvpkt') — rangayyan_wavelet_packet
...
`print(result)` render. See `moirais.fn.describe('rgwvpkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvpkt import *
import numpy as np
# See the function signature in fn/rgwvpkt.py for argument names.
```
