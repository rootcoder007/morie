...
`print(result)` render. See `moirais.fn.describe('sppgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppgmm import *
import numpy as np
# See the function signature in fn/sppgmm.py for argument names.
```
