# describe('oatt1') — otis_att_region
...
`print(result)` render. See `moirais.fn.describe('oatt1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oatt1 import *
import numpy as np
# See the function signature in fn/oatt1.py for argument names.
```
