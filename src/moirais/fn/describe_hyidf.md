...
`print(result)` render. See `moirais.fn.describe('hyidf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyidf import *
import numpy as np
# See the function signature in fn/hyidf.py for argument names.
```
