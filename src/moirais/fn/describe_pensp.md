...
`print(result)` render. See `moirais.fn.describe('pensp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pensp import *
import numpy as np
# See the function signature in fn/pensp.py for argument names.
```
