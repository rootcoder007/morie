...
`print(result)` render. See `moirais.fn.describe('renrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.renrg import *
import numpy as np
# See the function signature in fn/renrg.py for argument names.
```
