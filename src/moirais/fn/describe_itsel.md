...
`print(result)` render. See `moirais.fn.describe('itsel')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itsel import *
import numpy as np
# See the function signature in fn/itsel.py for argument names.
```
