# describe('rng066') — rangayyan_ch3_inverse_fourier_transform
...
`print(result)` render. See `moirais.fn.describe('rng066')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng066 import *
import numpy as np
# See the function signature in fn/rng066.py for argument names.
```
