...
`print(result)` render. See `moirais.fn.describe('difmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.difmh import *
import numpy as np
# See the function signature in fn/difmh.py for argument names.
```
