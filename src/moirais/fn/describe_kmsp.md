# describe('kmsp') — kamath_sentencepiece_tokenizer
...
`print(result)` render. See `moirais.fn.describe('kmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmsp import *
import numpy as np
# See the function signature in fn/kmsp.py for argument names.
```
