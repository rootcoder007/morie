# describe('msm114') — mvsml_bayesian_regression_pt2_eq_7_7
...
`print(result)` render. See `moirais.fn.describe('msm114')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm114 import *
import numpy as np
# See the function signature in fn/msm114.py for argument names.
```
