# describe('msm281') — mvsml_convolutional_nn_eq_14_11
...
`print(result)` render. See `moirais.fn.describe('msm281')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm281 import *
import numpy as np
# See the function signature in fn/msm281.py for argument names.
```
