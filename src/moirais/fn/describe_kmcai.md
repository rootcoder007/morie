# describe('kmcai') — kamath_constitutional_ai_loop
...
`print(result)` render. See `moirais.fn.describe('kmcai')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmcai import *
import numpy as np
# See the function signature in fn/kmcai.py for argument names.
```
