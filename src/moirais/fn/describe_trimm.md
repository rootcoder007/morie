...
`print(result)` render. See `moirais.fn.describe('trimm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trimm import *
import numpy as np
# See the function signature in fn/trimm.py for argument names.
```
