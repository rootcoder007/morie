...
__all__ = ["hedderich_chapter_9_unnumbered_1970"]


def hedderich_chapter_9_unnumbered_1970(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R1 +R2 = (n1 +n2)(n1 +n2 + 1)/2 (7.87)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1970')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1970: GeneralStatistics expression (auto-extracted; see ref)."
