...
`print(result)` render. See `moirais.fn.describe('rbfgss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfgss import *
import numpy as np
# See the function signature in fn/rbfgss.py for argument names.
```
