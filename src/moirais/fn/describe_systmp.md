# describe('systmp') — systematic_sampling
...
`print(result)` render. See `moirais.fn.describe('systmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.systmp import *
import numpy as np
# See the function signature in fn/systmp.py for argument names.
```
