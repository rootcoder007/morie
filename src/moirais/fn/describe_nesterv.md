# describe('nesterv') — nesterov_accelerated
...
`print(result)` render. See `moirais.fn.describe('nesterv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nesterv import *
import numpy as np
# See the function signature in fn/nesterv.py for argument names.
```
