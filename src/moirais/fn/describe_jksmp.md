...
`print(result)` render. See `moirais.fn.describe('jksmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jksmp import *
import numpy as np
# See the function signature in fn/jksmp.py for argument names.
```
