# describe('ccmem') — cross_classified_membership
...
`print(result)` render. See `moirais.fn.describe('ccmem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccmem import *
import numpy as np
# See the function signature in fn/ccmem.py for argument names.
```
