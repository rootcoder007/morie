# describe('jomint') — joseph_mint_reconciliation
...
`print(result)` render. See `moirais.fn.describe('jomint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jomint import *
import numpy as np
# See the function signature in fn/jomint.py for argument names.
```
