...
__all__ = ["hedderich_chapter_9_unnumbered_1596"]


def hedderich_chapter_9_unnumbered_1596(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] forp=0.05 (0.01; 0.005; 0.001),r=1,..., 5 andP =1% (5%, 10%, 20%, 50%, 80%, 90%, 95%,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1596')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1596: GeneralStatistics expression (auto-extracted; see ref)."
