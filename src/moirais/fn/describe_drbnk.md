...
`print(result)` render. See `moirais.fn.describe('drbnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drbnk import *
import numpy as np
# See the function signature in fn/drbnk.py for argument names.
```
