# describe('hmbftn') — geron_bert_finetune
...
`print(result)` render. See `moirais.fn.describe('hmbftn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbftn import *
import numpy as np
# See the function signature in fn/hmbftn.py for argument names.
```
