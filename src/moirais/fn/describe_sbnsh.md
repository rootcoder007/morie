...
`print(result)` render. See `moirais.fn.describe('sbnsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbnsh import *
import numpy as np
# See the function signature in fn/sbnsh.py for argument names.
```
