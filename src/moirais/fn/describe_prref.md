# describe('prref') — procrustes_reflection
...
`print(result)` render. See `moirais.fn.describe('prref')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prref import *
import numpy as np
# See the function signature in fn/prref.py for argument names.
```
