...
__all__ = ["law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_6"]


def law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe_chapter_10_unnumbered_6(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] EVA = .1($100) + .9($0) - $20 =- $10.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u6')`` for the full guide.
...
def cheatsheet():
    return "law_and_economics_6th_edition_robert_b_cooter_thomas_ulen_pe10u6: GeneralStatistics expression (auto-extracted; see ref)."
