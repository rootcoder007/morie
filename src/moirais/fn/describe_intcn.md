...
`print(result)` render. See `moirais.fn.describe('intcn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.intcn import *
import numpy as np
# See the function signature in fn/intcn.py for argument names.
```
