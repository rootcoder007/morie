...
`print(result)` render. See `moirais.fn.describe('tskrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tskrf import *
import numpy as np
# See the function signature in fn/tskrf.py for argument names.
```
