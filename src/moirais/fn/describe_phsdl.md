...
`print(result)` render. See `moirais.fn.describe('phsdl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phsdl import *
import numpy as np
# See the function signature in fn/phsdl.py for argument names.
```
