# describe('sxrhrt') — sex_specific_h2
...
`print(result)` render. See `moirais.fn.describe('sxrhrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sxrhrt import *
import numpy as np
# See the function signature in fn/sxrhrt.py for argument names.
```
