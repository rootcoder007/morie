# describe('gdman') — goodman_kruskal_gamma
...
`print(result)` render. See `moirais.fn.describe('gdman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdman import *
import numpy as np
# See the function signature in fn/gdman.py for argument names.
```
