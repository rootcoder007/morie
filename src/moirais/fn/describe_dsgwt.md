...
`print(result)` render. See `moirais.fn.describe('dsgwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dsgwt import *
import numpy as np
# See the function signature in fn/dsgwt.py for argument names.
```
