...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1636"]


def guide_on_data_analysis_chapter_30_unnumbered_1636(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: metrics_and_names = list("Rate" = "Rate"),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1636')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1636: GeneralStatistics expression (auto-extracted; see ref)."
