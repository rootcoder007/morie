# describe('msm293') — mvsml_convolutional_nn_eq_14_13
...
`print(result)` render. See `moirais.fn.describe('msm293')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm293 import *
import numpy as np
# See the function signature in fn/msm293.py for argument names.
```
