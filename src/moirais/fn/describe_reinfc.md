...
`print(result)` render. See `moirais.fn.describe('reinfc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reinfc import *
import numpy as np
# See the function signature in fn/reinfc.py for argument names.
```
