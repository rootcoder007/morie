# describe('alcap') — alammar_image_captioning_pipeline
...
`print(result)` render. See `moirais.fn.describe('alcap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alcap import *
import numpy as np
# See the function signature in fn/alcap.py for argument names.
```
