# describe('lrp') — likelihood_ratios
...
`print(result)` render. See `moirais.fn.describe('lrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrp import *
import numpy as np
# See the function signature in fn/lrp.py for argument names.
```
