# describe('gh_c12_6') — ghosal_semipara_eff
...
`print(result)` render. See `moirais.fn.describe('gh_c12_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c12_6 import *
import numpy as np
# See the function signature in fn/gh_c12_6.py for argument names.
```
