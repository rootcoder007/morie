# describe('msm116') — mvsml_bayesian_regression_pt2_eq_7_9
...
`print(result)` render. See `moirais.fn.describe('msm116')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm116 import *
import numpy as np
# See the function signature in fn/msm116.py for argument names.
```
