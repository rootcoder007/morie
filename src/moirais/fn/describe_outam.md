# describe('outam') — outlier_detection_am
...
`print(result)` render. See `moirais.fn.describe('outam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.outam import *
import numpy as np
# See the function signature in fn/outam.py for argument names.
```
