...
`print(result)` render. See `moirais.fn.describe('rlogi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlogi import *
import numpy as np
# See the function signature in fn/rlogi.py for argument names.
```
