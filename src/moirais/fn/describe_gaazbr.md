...
`print(result)` render. See `moirais.fn.describe('gaazbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gaazbr import *
import numpy as np
# See the function signature in fn/gaazbr.py for argument names.
```
