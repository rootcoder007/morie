# describe('msm251') — mvsml_reproducing_kernel_eq_10_13
...
`print(result)` render. See `moirais.fn.describe('msm251')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm251 import *
import numpy as np
# See the function signature in fn/msm251.py for argument names.
```
