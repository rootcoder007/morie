...
`print(result)` render. See `moirais.fn.describe('abpcb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abpcb import *
import numpy as np
# See the function signature in fn/abpcb.py for argument names.
```
