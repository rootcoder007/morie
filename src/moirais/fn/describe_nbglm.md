...
`print(result)` render. See `moirais.fn.describe('nbglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbglm import *
import numpy as np
# See the function signature in fn/nbglm.py for argument names.
```
