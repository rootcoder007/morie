...
`print(result)` render. See `moirais.fn.describe('lacgetg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lacgetg import *
import numpy as np
# See the function signature in fn/lacgetg.py for argument names.
```
