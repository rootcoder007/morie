# describe('tmltsm') — tmle_two_stage
...
`print(result)` render. See `moirais.fn.describe('tmltsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmltsm import *
import numpy as np
# See the function signature in fn/tmltsm.py for argument names.
```
