...
`print(result)` render. See `moirais.fn.describe('sgsar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgsar import *
import numpy as np
# See the function signature in fn/sgsar.py for argument names.
```
