...
`print(result)` render. See `moirais.fn.describe('kgsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgsmp import *
import numpy as np
# See the function signature in fn/kgsmp.py for argument names.
```
