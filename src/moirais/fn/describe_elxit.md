...
`print(result)` render. See `moirais.fn.describe('elxit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elxit import *
import numpy as np
# See the function signature in fn/elxit.py for argument names.
```
