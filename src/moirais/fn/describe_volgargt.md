...
`print(result)` render. See `moirais.fn.describe('volgargt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgargt import *
import numpy as np
# See the function signature in fn/volgargt.py for argument names.
```
