...
`print(result)` render. See `moirais.fn.describe('pheno2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pheno2 import *
import numpy as np
# See the function signature in fn/pheno2.py for argument names.
```
