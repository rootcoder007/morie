...
`print(result)` render. See `moirais.fn.describe('getisg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.getisg import *
import numpy as np
# See the function signature in fn/getisg.py for argument names.
```
