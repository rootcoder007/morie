...
`print(result)` render. See `moirais.fn.describe('wlkde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlkde import *
import numpy as np
# See the function signature in fn/wlkde.py for argument names.
```
