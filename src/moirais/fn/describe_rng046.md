# describe('rng046') — rangayyan_ch3_lsi_parallel_total
...
`print(result)` render. See `moirais.fn.describe('rng046')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng046 import *
import numpy as np
# See the function signature in fn/rng046.py for argument names.
```
