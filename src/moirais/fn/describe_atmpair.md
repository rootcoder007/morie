...
`print(result)` render. See `moirais.fn.describe('atmpair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atmpair import *
import numpy as np
# See the function signature in fn/atmpair.py for argument names.
```
