...
`print(result)` render. See `moirais.fn.describe('mpgov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpgov import *
import numpy as np
# See the function signature in fn/mpgov.py for argument names.
```
