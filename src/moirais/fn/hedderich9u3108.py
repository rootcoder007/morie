...
__all__ = ["hedderich_chapter_9_unnumbered_3108"]


def hedderich_chapter_9_unnumbered_3108(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ✺ n = 30: r12 = 0.85 r13 = 0.71 r23 = 0.80 forα= 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3108')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3108: GeneralStatistics expression (auto-extracted; see ref)."
