...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_421"]


def guide_on_data_analysis_chapter_5_unnumbered_421(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ̃ 𝑦𝑡 = 𝑦𝑡 − ̂ 𝜌 ⋅ 𝑦𝑡−1, ̃ x𝑡 = x𝑡 − ̂ 𝜌 ⋅x𝑡−1.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u421')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u421: GeneralStatistics expression (auto-extracted; see ref)."
