# describe('coxdfb') — cox_dfbeta_influence
...
`print(result)` render. See `moirais.fn.describe('coxdfb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coxdfb import *
import numpy as np
# See the function signature in fn/coxdfb.py for argument names.
```
