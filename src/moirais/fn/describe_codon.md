...
`print(result)` render. See `moirais.fn.describe('codon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.codon import *
import numpy as np
# See the function signature in fn/codon.py for argument names.
```
