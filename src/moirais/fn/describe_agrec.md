# describe('agrec') — andersen_gill_recurrent
...
`print(result)` render. See `moirais.fn.describe('agrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agrec import *
import numpy as np
# See the function signature in fn/agrec.py for argument names.
```
