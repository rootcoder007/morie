...
`print(result)` render. See `moirais.fn.describe('gsmsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gsmsp import *
import numpy as np
# See the function signature in fn/gsmsp.py for argument names.
```
