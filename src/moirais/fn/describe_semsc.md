...
`print(result)` render. See `moirais.fn.describe('semsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semsc import *
import numpy as np
# See the function signature in fn/semsc.py for argument names.
```
