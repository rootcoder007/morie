...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_10_equation_32(x):
    """
    CentralTendency equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r10e32')`` for the full guide.
...
def cheatsheet():
    return "the_r_series_dick_j_brus_spatial_sampling_with_r10e32: CentralTendency equation extracted from [The R Series] Dick J. Brus - Spatial Sampling with R."
