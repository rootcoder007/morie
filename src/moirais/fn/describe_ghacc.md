...
`print(result)` render. See `moirais.fn.describe('ghacc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghacc import *
import numpy as np
# See the function signature in fn/ghacc.py for argument names.
```
