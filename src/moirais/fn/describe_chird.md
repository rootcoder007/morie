...
`print(result)` render. See `moirais.fn.describe('chird')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chird import *
import numpy as np
# See the function signature in fn/chird.py for argument names.
```
