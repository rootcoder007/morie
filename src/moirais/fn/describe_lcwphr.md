# describe('lcwphr') — latent_class_weighted
...
`print(result)` render. See `moirais.fn.describe('lcwphr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lcwphr import *
import numpy as np
# See the function signature in fn/lcwphr.py for argument names.
```
