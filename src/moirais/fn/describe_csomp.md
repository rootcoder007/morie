...
`print(result)` render. See `moirais.fn.describe('csomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csomp import *
import numpy as np
# See the function signature in fn/csomp.py for argument names.
```
