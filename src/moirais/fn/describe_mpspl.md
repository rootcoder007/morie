...
`print(result)` render. See `moirais.fn.describe('mpspl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpspl import *
import numpy as np
# See the function signature in fn/mpspl.py for argument names.
```
