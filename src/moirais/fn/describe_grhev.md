# describe('grhev') — geron_heaviside_step
...
`print(result)` render. See `moirais.fn.describe('grhev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grhev import *
import numpy as np
# See the function signature in fn/grhev.py for argument names.
```
