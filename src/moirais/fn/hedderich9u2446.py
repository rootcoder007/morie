...
__all__ = ["hedderich_chapter_9_unnumbered_2446"]


def hedderich_chapter_9_unnumbered_2446(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (also according to (7.234) ˆS = 4.09> 2.59 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2446')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2446: GeneralStatistics expression (auto-extracted; see ref)."
