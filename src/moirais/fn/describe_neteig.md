# describe('neteig') — eigenvector_centrality
...
`print(result)` render. See `moirais.fn.describe('neteig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.neteig import *
import numpy as np
# See the function signature in fn/neteig.py for argument names.
```
