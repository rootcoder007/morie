...
__all__ = ["hedderich_chapter_9_unnumbered_136"]


def hedderich_chapter_9_unnumbered_136(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > mode <− ( names ( v t [ v t == max( v t ) ] ) ) ; mode
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u136')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u136: GeneralStatistics expression (auto-extracted; see ref)."
