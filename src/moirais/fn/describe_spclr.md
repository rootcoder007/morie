# describe('spclr') — spectral_clustering
...
`print(result)` render. See `moirais.fn.describe('spclr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spclr import *
import numpy as np
# See the function signature in fn/spclr.py for argument names.
```
