...
`print(result)` render. See `moirais.fn.describe('hyefl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyefl import *
import numpy as np
# See the function signature in fn/hyefl.py for argument names.
```
