...
__all__ = ["wilcox_chapter_10_unnumbered_893"]


def wilcox_chapter_10_unnumbered_893(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n = ∑nj (so N =nK),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u893')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u893: GeneralStatistics expression (auto-extracted; see ref)."
