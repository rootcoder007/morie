...
`print(result)` render. See `moirais.fn.describe('rfsmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfsmt import *
import numpy as np
# See the function signature in fn/rfsmt.py for argument names.
```
