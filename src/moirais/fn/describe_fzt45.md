# describe('fzt45') — fauzi_thm4_5_mrl_consistency
...
`print(result)` render. See `moirais.fn.describe('fzt45')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzt45 import *
import numpy as np
# See the function signature in fn/fzt45.py for argument names.
```
