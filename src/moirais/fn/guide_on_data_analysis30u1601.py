...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1601"]


def guide_on_data_analysis_chapter_30_unnumbered_1601(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝔼[𝐷 1{𝑇 = 1}]− 𝐷 1{𝑇 = 0}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1601')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1601: GeneralStatistics expression (auto-extracted; see ref)."
