...
`print(result)` render. See `moirais.fn.describe('prsLR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsLR import *
import numpy as np
# See the function signature in fn/prsLR.py for argument names.
```
