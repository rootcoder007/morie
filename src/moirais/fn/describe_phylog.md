# describe('phylog') — phylogenetic_dating
...
`print(result)` render. See `moirais.fn.describe('phylog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phylog import *
import numpy as np
# See the function signature in fn/phylog.py for argument names.
```
