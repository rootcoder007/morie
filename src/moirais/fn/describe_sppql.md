# describe('sppql') — schabenberger_pql_glmm
...
`print(result)` render. See `moirais.fn.describe('sppql')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sppql import *
import numpy as np
# See the function signature in fn/sppql.py for argument names.
```
