...
`print(result)` render. See `moirais.fn.describe('wvrec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvrec import *
import numpy as np
# See the function signature in fn/wvrec.py for argument names.
```
