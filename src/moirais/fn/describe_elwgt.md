...
`print(result)` render. See `moirais.fn.describe('elwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elwgt import *
import numpy as np
# See the function signature in fn/elwgt.py for argument names.
```
