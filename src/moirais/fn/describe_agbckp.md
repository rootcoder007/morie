# describe('agbckp') — alphazero_backup
...
`print(result)` render. See `moirais.fn.describe('agbckp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbckp import *
import numpy as np
# See the function signature in fn/agbckp.py for argument names.
```
