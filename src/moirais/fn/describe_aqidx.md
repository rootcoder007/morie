# describe('aqidx') — air_quality_index
...
`print(result)` render. See `moirais.fn.describe('aqidx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aqidx import *
import numpy as np
# See the function signature in fn/aqidx.py for argument names.
```
