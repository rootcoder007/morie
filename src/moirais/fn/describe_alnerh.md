# describe('alnerh') — alammar_ner_token_head
...
`print(result)` render. See `moirais.fn.describe('alnerh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alnerh import *
import numpy as np
# See the function signature in fn/alnerh.py for argument names.
```
