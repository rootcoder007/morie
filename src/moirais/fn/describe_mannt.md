...
`print(result)` render. See `moirais.fn.describe('mannt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mannt import *
import numpy as np
# See the function signature in fn/mannt.py for argument names.
```
