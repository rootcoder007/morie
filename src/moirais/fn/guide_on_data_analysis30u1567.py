...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1567"]


def guide_on_data_analysis_chapter_30_unnumbered_1567(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: first_stage = ~ x1 | id + year,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1567')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1567: GeneralStatistics expression (auto-extracted; see ref)."
