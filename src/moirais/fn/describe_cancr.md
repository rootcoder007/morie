# describe('cancr') — canonical_correlation
...
`print(result)` render. See `moirais.fn.describe('cancr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cancr import *
import numpy as np
# See the function signature in fn/cancr.py for argument names.
```
