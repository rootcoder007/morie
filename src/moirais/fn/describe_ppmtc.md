...
`print(result)` render. See `moirais.fn.describe('ppmtc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmtc import *
import numpy as np
# See the function signature in fn/ppmtc.py for argument names.
```
