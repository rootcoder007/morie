...
`print(result)` render. See `moirais.fn.describe('phicx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phicx import *
import numpy as np
# See the function signature in fn/phicx.py for argument names.
```
