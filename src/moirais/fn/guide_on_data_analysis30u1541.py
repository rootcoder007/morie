...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1541"]


def guide_on_data_analysis_chapter_30_unnumbered_1541(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑖𝑡 = {𝑖′ ∶ 𝑖′ ∈ ℳ𝑖𝑡, 𝑆𝑖𝑡(𝑖′) < 𝐶, 𝑆𝑖𝑡 ≤ 𝑆(𝐽)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1541')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1541: GeneralStatistics expression (auto-extracted; see ref)."
