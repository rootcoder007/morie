...
`print(result)` render. See `moirais.fn.describe('mcint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcint import *
import numpy as np
# See the function signature in fn/mcint.py for argument names.
```
