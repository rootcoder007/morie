# describe('fbank') — filter_bank_design
...
`print(result)` render. See `moirais.fn.describe('fbank')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fbank import *
import numpy as np
# See the function signature in fn/fbank.py for argument names.
```
