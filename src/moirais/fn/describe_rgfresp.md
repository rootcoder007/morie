# describe('rgfresp') — rangayyan_freq_response
...
`print(result)` render. See `moirais.fn.describe('rgfresp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgfresp import *
import numpy as np
# See the function signature in fn/rgfresp.py for argument names.
```
