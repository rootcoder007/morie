...
`print(result)` render. See `moirais.fn.describe('tssop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssop import *
import numpy as np
# See the function signature in fn/tssop.py for argument names.
```
