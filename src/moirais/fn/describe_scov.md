# describe('scov') — sample_covariance
...
`print(result)` render. See `moirais.fn.describe('scov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scov import *
import numpy as np
# See the function signature in fn/scov.py for argument names.
```
