...
`print(result)` render. See `moirais.fn.describe('emgfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emgfr import *
import numpy as np
# See the function signature in fn/emgfr.py for argument names.
```
