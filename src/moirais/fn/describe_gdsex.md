...
`print(result)` render. See `moirais.fn.describe('gdsex')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdsex import *
import numpy as np
# See the function signature in fn/gdsex.py for argument names.
```
