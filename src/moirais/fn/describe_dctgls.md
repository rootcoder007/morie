# describe('dctgls') — doubly_censored_gls
...
`print(result)` render. See `moirais.fn.describe('dctgls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dctgls import *
import numpy as np
# See the function signature in fn/dctgls.py for argument names.
```
