...
__all__ = ["hedderich_chapter_9_unnumbered_74"]


def hedderich_chapter_9_unnumbered_74(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u74')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u74: GeneralStatistics expression (auto-extracted; see ref)."
