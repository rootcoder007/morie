...
`print(result)` render. See `moirais.fn.describe('bkflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkflt import *
import numpy as np
# See the function signature in fn/bkflt.py for argument names.
```
