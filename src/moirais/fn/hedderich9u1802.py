...
__all__ = ["hedderich_chapter_9_unnumbered_1802"]


def hedderich_chapter_9_unnumbered_1802(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: underHA: LA =x log(ˆπ) + (n−x) log(1−ˆπ)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1802')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1802: GeneralStatistics expression (auto-extracted; see ref)."
