# describe('srsiz') — sample_size_proportion
...
`print(result)` render. See `moirais.fn.describe('srsiz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srsiz import *
import numpy as np
# See the function signature in fn/srsiz.py for argument names.
```
