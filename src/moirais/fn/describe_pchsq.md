...
`print(result)` render. See `moirais.fn.describe('pchsq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pchsq import *
import numpy as np
# See the function signature in fn/pchsq.py for argument names.
```
