# describe('msm185') — mvsml_ridge_lasso_elastic_eq_9_12
...
`print(result)` render. See `moirais.fn.describe('msm185')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm185 import *
import numpy as np
# See the function signature in fn/msm185.py for argument names.
```
