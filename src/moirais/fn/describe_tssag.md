...
`print(result)` render. See `moirais.fn.describe('tssag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tssag import *
import numpy as np
# See the function signature in fn/tssag.py for argument names.
```
