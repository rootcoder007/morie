...
`print(result)` render. See `moirais.fn.describe('jntent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jntent import *
import numpy as np
# See the function signature in fn/jntent.py for argument names.
```
