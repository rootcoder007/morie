...
__all__ = ["hedderich_chapter_9_unnumbered_2156"]


def hedderich_chapter_9_unnumbered_2156(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Y ) = ˙p byµ=E[U ] = m·n·˙p. Under the null hypothesis
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2156')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2156: PowerAndDesign expression (auto-extracted; see ref)."
