# describe('agmurt') — muzero_reanalyze_target
...
`print(result)` render. See `moirais.fn.describe('agmurt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agmurt import *
import numpy as np
# See the function signature in fn/agmurt.py for argument names.
```
