# describe('rgmfcc') — rangayyan_mfcc
...
`print(result)` render. See `moirais.fn.describe('rgmfcc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmfcc import *
import numpy as np
# See the function signature in fn/rgmfcc.py for argument names.
```
