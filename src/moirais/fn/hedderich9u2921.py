...
__all__ = ["hedderich_chapter_9_unnumbered_2921"]


def hedderich_chapter_9_unnumbered_2921(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: HA : πi̸=π0 for at least onei, (i = 1,...,k )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2921')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2921: CountModels expression (auto-extracted; see ref)."
