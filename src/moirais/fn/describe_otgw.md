# describe('otgw') — ot_gromov_wasserstein
...
`print(result)` render. See `moirais.fn.describe('otgw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otgw import *
import numpy as np
# See the function signature in fn/otgw.py for argument names.
```
