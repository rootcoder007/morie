# describe('rcdds') — recidivism_desistance
...
`print(result)` render. See `moirais.fn.describe('rcdds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdds import *
import numpy as np
# See the function signature in fn/rcdds.py for argument names.
```
