# describe('mdsmm') — mds_missing_data
...
`print(result)` render. See `moirais.fn.describe('mdsmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdsmm import *
import numpy as np
# See the function signature in fn/mdsmm.py for argument names.
```
