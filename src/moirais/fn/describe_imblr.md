# describe('imblr') — gaussian_blur

## WHAT IT DOES

Gaussian blur via convolution. 'A journey of a thousand miles begins with a single step. — Lao Tzu'
...
`print(result)` render. See `moirais.fn.describe('imblr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.imblr import *
import numpy as np
# See the function signature in fn/imblr.py for argument names.
```
