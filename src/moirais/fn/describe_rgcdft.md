# describe('rgcdft') — rangayyan_circular_conv_dft
...
`print(result)` render. See `moirais.fn.describe('rgcdft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcdft import *
import numpy as np
# See the function signature in fn/rgcdft.py for argument names.
```
