...
`print(result)` render. See `moirais.fn.describe('astc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.astc import *
import numpy as np
# See the function signature in fn/astc.py for argument names.
```
