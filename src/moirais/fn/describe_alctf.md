# describe('alctf') — alammar_c_tfidf
...
`print(result)` render. See `moirais.fn.describe('alctf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alctf import *
import numpy as np
# See the function signature in fn/alctf.py for argument names.
```
