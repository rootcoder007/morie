...
`print(result)` render. See `moirais.fn.describe('bkcbow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkcbow import *
import numpy as np
# See the function signature in fn/bkcbow.py for argument names.
```
