# describe('comspr') — spectral_clustering
...
`print(result)` render. See `moirais.fn.describe('comspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.comspr import *
import numpy as np
# See the function signature in fn/comspr.py for argument names.
```
