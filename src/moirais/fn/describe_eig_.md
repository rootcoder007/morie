...
`print(result)` render. See `moirais.fn.describe('eig_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eig_ import *
import numpy as np
# See the function signature in fn/eig_.py for argument names.
```
