# describe('gb_mci') — gibbons_mcnemar_ci
...
`print(result)` render. See `moirais.fn.describe('gb_mci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_mci import *
import numpy as np
# See the function signature in fn/gb_mci.py for argument names.
```
