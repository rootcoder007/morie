# describe('prdgm') — periodogram_estimate
...
`print(result)` render. See `moirais.fn.describe('prdgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdgm import *
import numpy as np
# See the function signature in fn/prdgm.py for argument names.
```
