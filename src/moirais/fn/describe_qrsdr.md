...
`print(result)` render. See `moirais.fn.describe('qrsdr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qrsdr import *
import numpy as np
# See the function signature in fn/qrsdr.py for argument names.
```
