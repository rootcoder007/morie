# describe('gross') — gross_error_sensitivity
...
`print(result)` render. See `moirais.fn.describe('gross')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gross import *
import numpy as np
# See the function signature in fn/gross.py for argument names.
```
