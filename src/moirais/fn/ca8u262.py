...
def ca_chapter_8_unnumbered_262(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca8u262')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={"estimate": result, "se": se, "n": n, "method": "PowerAndDesign expression involving 'probability' (auto-extracted; see reference for full context)."},
    )


def cheatsheet():
    return "ca8u262: PowerAndDesign expression involving 'probability' (auto-extracted; see reference for full context)."
