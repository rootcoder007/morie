# describe('gh_c4_4') — ghosal_dp_cov
...
`print(result)` render. See `moirais.fn.describe('gh_c4_4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c4_4 import *
import numpy as np
# See the function signature in fn/gh_c4_4.py for argument names.
```
