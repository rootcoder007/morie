...
`print(result)` render. See `moirais.fn.describe('nqstf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nqstf import *
import numpy as np
# See the function signature in fn/nqstf.py for argument names.
```
