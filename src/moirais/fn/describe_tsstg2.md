...
`print(result)` render. See `moirais.fn.describe('tsstg2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsstg2 import *
import numpy as np
# See the function signature in fn/tsstg2.py for argument names.
```
