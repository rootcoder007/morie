# describe('msm103') — mvsml_bayesian_regression_pt2_eq_7_3
...
`print(result)` render. See `moirais.fn.describe('msm103')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm103 import *
import numpy as np
# See the function signature in fn/msm103.py for argument names.
```
