...
__all__ = ["wilcox_chapter_14_unnumbered_677"]


def wilcox_chapter_14_unnumbered_677(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: anova.power(groups=NULL,n=NULL,delta=NULL,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u677')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u677: ANOVA expression (auto-extracted; see ref)."
