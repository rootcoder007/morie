...
__all__ = ["hedderich_chapter_9_unnumbered_1955"]


def hedderich_chapter_9_unnumbered_1955(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: ✺ n1=n2=n=31 cases per sample are required.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1955')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1955: PowerAndDesign expression (auto-extracted; see ref)."
