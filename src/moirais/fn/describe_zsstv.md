...
`print(result)` render. See `moirais.fn.describe('zsstv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsstv import *
import numpy as np
# See the function signature in fn/zsstv.py for argument names.
```
