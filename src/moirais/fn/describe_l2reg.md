# describe('l2reg') — l2_weight_regularization
...
`print(result)` render. See `moirais.fn.describe('l2reg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.l2reg import *
import numpy as np
# See the function signature in fn/l2reg.py for argument names.
```
