...
__all__ = ["hedderich_chapter_9_unnumbered_3526"]


def hedderich_chapter_9_unnumbered_3526(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] g(µij) = log (µij) V (µij) = µij ϕ= 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3526')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3526: Logistic expression (auto-extracted; see ref)."
