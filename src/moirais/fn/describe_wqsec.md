...
`print(result)` render. See `moirais.fn.describe('wqsec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wqsec import *
import numpy as np
# See the function signature in fn/wqsec.py for argument names.
```
