# describe('pcadr') — pca_dimensionality_reduction
...
`print(result)` render. See `moirais.fn.describe('pcadr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcadr import *
import numpy as np
# See the function signature in fn/pcadr.py for argument names.
```
