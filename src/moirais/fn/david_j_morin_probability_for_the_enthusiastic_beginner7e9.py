...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_7_equation_9(x):
    ...
    Formula: we can use the approximation in Eq. (7.9) (with x ≡ − a) to write e−a ≈ 1 − a
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner7e9')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner7e9: CountModels equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
