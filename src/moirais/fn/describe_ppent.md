...
`print(result)` render. See `moirais.fn.describe('ppent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppent import *
import numpy as np
# See the function signature in fn/ppent.py for argument names.
```
