...
`print(result)` render. See `moirais.fn.describe('csast')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csast import *
import numpy as np
# See the function signature in fn/csast.py for argument names.
```
