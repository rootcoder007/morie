...
`print(result)` render. See `moirais.fn.describe('enno2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enno2 import *
import numpy as np
# See the function signature in fn/enno2.py for argument names.
```
