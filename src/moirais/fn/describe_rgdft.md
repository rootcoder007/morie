...
`print(result)` render. See `moirais.fn.describe('rgdft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgdft import *
import numpy as np
# See the function signature in fn/rgdft.py for argument names.
```
