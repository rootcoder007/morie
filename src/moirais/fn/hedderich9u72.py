...
__all__ = ["hedderich_chapter_9_unnumbered_72"]


def hedderich_chapter_9_unnumbered_72(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] cij =aij±bij ∀i,j ⇔C(n×m) = A(n×m)±B(n×m) (2.25)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u72')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u72: GeneralStatistics expression (auto-extracted; see ref)."
