...
`print(result)` render. See `moirais.fn.describe('abodr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abodr import *
import numpy as np
# See the function signature in fn/abodr.py for argument names.
```
