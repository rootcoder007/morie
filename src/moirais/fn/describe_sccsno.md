# describe('sccsno') — sccs_no_replacement
...
`print(result)` render. See `moirais.fn.describe('sccsno')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sccsno import *
import numpy as np
# See the function signature in fn/sccsno.py for argument names.
```
