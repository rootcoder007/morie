# describe('gbdag') — gbd_age_pattern
...
`print(result)` render. See `moirais.fn.describe('gbdag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gbdag import *
import numpy as np
# See the function signature in fn/gbdag.py for argument names.
```
