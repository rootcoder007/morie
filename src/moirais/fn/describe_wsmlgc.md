# describe('wsmlgc') — wasserman_log_linear
...
`print(result)` render. See `moirais.fn.describe('wsmlgc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlgc import *
import numpy as np
# See the function signature in fn/wsmlgc.py for argument names.
```
