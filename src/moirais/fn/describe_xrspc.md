# describe('xrspc') — spatial_poisson
...
`print(result)` render. See `moirais.fn.describe('xrspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspc import *
import numpy as np
# See the function signature in fn/xrspc.py for argument names.
```
