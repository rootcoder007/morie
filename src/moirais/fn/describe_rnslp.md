...
`print(result)` render. See `moirais.fn.describe('rnslp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rnslp import *
import numpy as np
# See the function signature in fn/rnslp.py for argument names.
```
