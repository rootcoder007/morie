...
__all__ = ["hedderich_chapter_9_unnumbered_2208"]


def hedderich_chapter_9_unnumbered_2208(x):
    """
    MetaAnalysis expression (auto-extracted; see ref).

    Formula: β = 0.10 β = 0.20
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2208')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2208: MetaAnalysis expression (auto-extracted; see ref)."
