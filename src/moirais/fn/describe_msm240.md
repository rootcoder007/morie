# describe('msm240') — mvsml_preprocessing_eq_2_1
...
`print(result)` render. See `moirais.fn.describe('msm240')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm240 import *
import numpy as np
# See the function signature in fn/msm240.py for argument names.
```
