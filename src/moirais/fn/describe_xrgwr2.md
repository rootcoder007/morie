...
`print(result)` render. See `moirais.fn.describe('xrgwr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrgwr2 import *
import numpy as np
# See the function signature in fn/xrgwr2.py for argument names.
```
