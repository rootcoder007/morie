...
`print(result)` render. See `moirais.fn.describe('cldun')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cldun import *
import numpy as np
# See the function signature in fn/cldun.py for argument names.
```
