# describe('minfo') — mutual_information
...
`print(result)` render. See `moirais.fn.describe('minfo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.minfo import *
import numpy as np
# See the function signature in fn/minfo.py for argument names.
```
