...
`print(result)` render. See `moirais.fn.describe('curei')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.curei import *
import numpy as np
# See the function signature in fn/curei.py for argument names.
```
