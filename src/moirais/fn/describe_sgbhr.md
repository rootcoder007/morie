# describe('sgbhr') — bayesian_hierarchical_spatial
...
`print(result)` render. See `moirais.fn.describe('sgbhr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgbhr import *
import numpy as np
# See the function signature in fn/sgbhr.py for argument names.
```
