...
`print(result)` render. See `moirais.fn.describe('dnvtwo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnvtwo import *
import numpy as np
# See the function signature in fn/dnvtwo.py for argument names.
```
