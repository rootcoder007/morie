...
`print(result)` render. See `moirais.fn.describe('cfspa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfspa import *
import numpy as np
# See the function signature in fn/cfspa.py for argument names.
```
