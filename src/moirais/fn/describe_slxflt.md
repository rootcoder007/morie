...
`print(result)` render. See `moirais.fn.describe('slxflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slxflt import *
import numpy as np
# See the function signature in fn/slxflt.py for argument names.
```
