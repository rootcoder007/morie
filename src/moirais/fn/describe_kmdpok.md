# describe('kmdpok') — kamath_dpo_loss
...
`print(result)` render. See `moirais.fn.describe('kmdpok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmdpok import *
import numpy as np
# See the function signature in fn/kmdpok.py for argument names.
```
