...
`print(result)` render. See `moirais.fn.describe('proxm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.proxm import *
import numpy as np
# See the function signature in fn/proxm.py for argument names.
```
