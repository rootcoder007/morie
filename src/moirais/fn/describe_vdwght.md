# describe('vdwght') — vdwght

## WHAT IT DOES

Voronoi area-weighted interpolation.
...
`print(result)` render. See `moirais.fn.describe('vdwght')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdwght import *
import numpy as np
# See the function signature in fn/vdwght.py for argument names.
```
