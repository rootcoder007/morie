...
`print(result)` render. See `moirais.fn.describe('entest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entest import *
import numpy as np
# See the function signature in fn/entest.py for argument names.
```
