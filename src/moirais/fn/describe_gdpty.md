...
`print(result)` render. See `moirais.fn.describe('gdpty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdpty import *
import numpy as np
# See the function signature in fn/gdpty.py for argument names.
```
