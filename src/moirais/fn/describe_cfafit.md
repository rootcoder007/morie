# describe('cfafit') — cfa_fit_indices
...
`print(result)` render. See `moirais.fn.describe('cfafit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfafit import *
import numpy as np
# See the function signature in fn/cfafit.py for argument names.
```
