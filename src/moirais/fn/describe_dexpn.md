...
`print(result)` render. See `moirais.fn.describe('dexpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dexpn import *
import numpy as np
# See the function signature in fn/dexpn.py for argument names.
```
