...
`print(result)` render. See `moirais.fn.describe('rfbrow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfbrow import *
import numpy as np
# See the function signature in fn/rfbrow.py for argument names.
```
