...
__all__ = ["hedderich_chapter_9_unnumbered_1745"]


def hedderich_chapter_9_unnumbered_1745(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: data : x G = 3 . 6 1 0 4 5 , U = 0 . 2 7 7 8 2 , p− value = 2 . 1 1 3 e −05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1745')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1745: GeneralStatistics expression (auto-extracted; see ref)."
