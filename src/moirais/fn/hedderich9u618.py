...
__all__ = ["hedderich_chapter_9_unnumbered_618"]


def hedderich_chapter_9_unnumbered_618(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u618')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u618: CountModels expression (auto-extracted; see ref)."
