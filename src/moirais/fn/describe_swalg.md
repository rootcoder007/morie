# describe('swalg') — smith_waterman

## WHAT IT DOES

Smith-Waterman local sequence alignment. 'Great, kid. Don'Everything flows. — Heraclitus'
...
`print(result)` render. See `moirais.fn.describe('swalg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swalg import *
import numpy as np
# See the function signature in fn/swalg.py for argument names.
```
