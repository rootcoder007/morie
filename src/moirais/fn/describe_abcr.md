...
`print(result)` render. See `moirais.fn.describe('abcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcr import *
import numpy as np
# See the function signature in fn/abcr.py for argument names.
```
