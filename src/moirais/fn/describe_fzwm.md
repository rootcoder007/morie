# describe('fzwm') — fauzi_wilcoxon_moments
...
`print(result)` render. See `moirais.fn.describe('fzwm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzwm import *
import numpy as np
# See the function signature in fn/fzwm.py for argument names.
```
