...
`print(result)` render. See `moirais.fn.describe('kgeqv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgeqv import *
import numpy as np
# See the function signature in fn/kgeqv.py for argument names.
```
