...
`print(result)` render. See `moirais.fn.describe('klgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klgrd import *
import numpy as np
# See the function signature in fn/klgrd.py for argument names.
```
