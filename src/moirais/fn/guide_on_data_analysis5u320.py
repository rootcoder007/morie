...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_320"]


def guide_on_data_analysis_chapter_5_unnumbered_320(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑦 = 𝛽0 + 𝑥1𝛽1 + 𝑥2𝛽2 + 𝑥1𝑥2𝛽3 + 𝜖
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u320')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u320: GeneralStatistics expression (auto-extracted; see ref)."
