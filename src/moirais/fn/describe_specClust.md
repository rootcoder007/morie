# describe('specClust') — spectral_clustering
...
`print(result)` render. See `moirais.fn.describe('specClust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.specClust import *
import numpy as np
# See the function signature in fn/specClust.py for argument names.
```
