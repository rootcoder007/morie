# describe('cutln') — cutting_line_mesh
...
`print(result)` render. See `moirais.fn.describe('cutln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cutln import *
import numpy as np
# See the function signature in fn/cutln.py for argument names.
```
