# describe('gpkrr') — gp_kernel_ridge_reg
...
`print(result)` render. See `moirais.fn.describe('gpkrr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpkrr import *
import numpy as np
# See the function signature in fn/gpkrr.py for argument names.
```
