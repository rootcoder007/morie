...
`print(result)` render. See `moirais.fn.describe('lmrlag2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmrlag2 import *
import numpy as np
# See the function signature in fn/lmrlag2.py for argument names.
```
