# describe('bnshrt') — bound_short_panel
...
`print(result)` render. See `moirais.fn.describe('bnshrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnshrt import *
import numpy as np
# See the function signature in fn/bnshrt.py for argument names.
```
