...
__all__ = ["wilcox_chapter_10_unnumbered_1004"]


def wilcox_chapter_10_unnumbered_1004(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ = µ 1 +µ 2 − µ 3 − µ 4,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1004')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1004: GeneralStatistics expression (auto-extracted; see ref)."
