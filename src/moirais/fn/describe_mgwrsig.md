...
`print(result)` render. See `moirais.fn.describe('mgwrsig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mgwrsig import *
import numpy as np
# See the function signature in fn/mgwrsig.py for argument names.
```
