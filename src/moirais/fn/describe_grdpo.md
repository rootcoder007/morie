...
`print(result)` render. See `moirais.fn.describe('grdpo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdpo import *
import numpy as np
# See the function signature in fn/grdpo.py for argument names.
```
