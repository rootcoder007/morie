# describe('rng074') — rangayyan_ch3_dft_real_imag_decomposition
...
`print(result)` render. See `moirais.fn.describe('rng074')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng074 import *
import numpy as np
# See the function signature in fn/rng074.py for argument names.
```
