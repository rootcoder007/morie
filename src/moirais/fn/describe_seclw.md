...
`print(result)` render. See `moirais.fn.describe('seclw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclw import *
import numpy as np
# See the function signature in fn/seclw.py for argument names.
```
