...
__all__ = ["hedderich_chapter_9_unnumbered_2173"]


def hedderich_chapter_9_unnumbered_2173(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: i−ti)/12 [r = number of ties,ti = multiplicity of thei-th tie].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2173')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2173: GeneralStatistics expression (auto-extracted; see ref)."
