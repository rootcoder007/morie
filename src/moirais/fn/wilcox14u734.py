...
__all__ = ["wilcox_chapter_14_unnumbered_734"]


def wilcox_chapter_14_unnumbered_734(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: reject if F ≥ f1−α , where f1−α is the 1 − α quantile of an F distribution with ν 1 =J − 1 and
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u734')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u734: GeneralStatistics expression (auto-extracted; see ref)."
