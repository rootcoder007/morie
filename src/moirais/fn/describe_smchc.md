# describe('smchc') — simulate_choice_prob
...
`print(result)` render. See `moirais.fn.describe('smchc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smchc import *
import numpy as np
# See the function signature in fn/smchc.py for argument names.
```
