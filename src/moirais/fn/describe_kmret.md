# describe('kmret') — kamath_retnet_retention
...
`print(result)` render. See `moirais.fn.describe('kmret')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmret import *
import numpy as np
# See the function signature in fn/kmret.py for argument names.
```
