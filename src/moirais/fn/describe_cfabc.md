...
`print(result)` render. See `moirais.fn.describe('cfabc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfabc import *
import numpy as np
# See the function signature in fn/cfabc.py for argument names.
```
