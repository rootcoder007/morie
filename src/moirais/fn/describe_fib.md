...
`print(result)` render. See `moirais.fn.describe('fib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fib import *
import numpy as np
# See the function signature in fn/fib.py for argument names.
```
