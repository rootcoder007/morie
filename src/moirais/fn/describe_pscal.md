...
`print(result)` render. See `moirais.fn.describe('pscal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pscal import *
import numpy as np
# See the function signature in fn/pscal.py for argument names.
```
