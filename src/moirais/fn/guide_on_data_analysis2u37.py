...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_37"]


def guide_on_data_analysis_chapter_2_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑚𝑋(𝑡) = 𝐸[𝑒𝑡𝑋] =∫
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u37')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u37: GeneralStatistics expression (auto-extracted; see ref)."
