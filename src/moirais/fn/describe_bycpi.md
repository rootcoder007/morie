...
`print(result)` render. See `moirais.fn.describe('bycpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bycpi import *
import numpy as np
# See the function signature in fn/bycpi.py for argument names.
```
