# describe('kmstst') — kamath_stereoset_bias
...
`print(result)` render. See `moirais.fn.describe('kmstst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmstst import *
import numpy as np
# See the function signature in fn/kmstst.py for argument names.
```
