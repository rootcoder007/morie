...
`print(result)` render. See `moirais.fn.describe('splgtlm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgtlm import *
import numpy as np
# See the function signature in fn/splgtlm.py for argument names.
```
