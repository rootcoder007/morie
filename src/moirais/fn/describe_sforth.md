...
`print(result)` render. See `moirais.fn.describe('sforth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sforth import *
import numpy as np
# See the function signature in fn/sforth.py for argument names.
```
