...
__all__ = ["guide_on_data_analysis_chapter_10_unnumbered_728"]


def guide_on_data_analysis_chapter_10_unnumbered_728(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis10u728')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis10u728: GeneralStatistics expression (auto-extracted; see ref)."
