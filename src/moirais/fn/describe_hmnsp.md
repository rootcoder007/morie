# describe('hmnsp') — geron_next_sentence_prediction
...
`print(result)` render. See `moirais.fn.describe('hmnsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnsp import *
import numpy as np
# See the function signature in fn/hmnsp.py for argument names.
```
