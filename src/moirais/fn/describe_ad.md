...
`print(result)` render. See `moirais.fn.describe('ad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ad import *
import numpy as np
# See the function signature in fn/ad.py for argument names.
```
