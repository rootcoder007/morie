...
__all__ = ["hedderich_chapter_9_unnumbered_2997"]


def hedderich_chapter_9_unnumbered_2997(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + n c o l=4 , byrow=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2997')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2997: GeneralStatistics expression (auto-extracted; see ref)."
