...
`print(result)` render. See `moirais.fn.describe('xrflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrflt import *
import numpy as np
# See the function signature in fn/xrflt.py for argument names.
```
