# describe('eslscd') — esl_sparse_pca
...
`print(result)` render. See `moirais.fn.describe('eslscd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslscd import *
import numpy as np
# See the function signature in fn/eslscd.py for argument names.
```
