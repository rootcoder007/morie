# describe('ripL') — ripley_l_function
...
`print(result)` render. See `moirais.fn.describe('ripL')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ripL import *
import numpy as np
# See the function signature in fn/ripL.py for argument names.
```
