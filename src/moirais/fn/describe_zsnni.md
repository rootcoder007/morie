# describe('zsnni') — natural_neighbor
...
`print(result)` render. See `moirais.fn.describe('zsnni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsnni import *
import numpy as np
# See the function signature in fn/zsnni.py for argument names.
```
