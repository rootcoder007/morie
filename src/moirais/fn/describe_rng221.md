# describe('rng221') — rangayyan_ch4_matched_filter_impulse_response
...
`print(result)` render. See `moirais.fn.describe('rng221')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng221 import *
import numpy as np
# See the function signature in fn/rng221.py for argument names.
```
