...
`print(result)` render. See `moirais.fn.describe('rflgn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rflgn import *
import numpy as np
# See the function signature in fn/rflgn.py for argument names.
```
