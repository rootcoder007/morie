...
__all__ = ["hedderich_chapter_9_unnumbered_146"]


def hedderich_chapter_9_unnumbered_146(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + densit y=c ( 1 0 , 1 5 , 1 8 , 2 0 ) ,angl e=c ( 4 5 , 1 3 5 , 4 5 , 1 3 5 ) ,c o l=" black " , cex = 1 . 7 )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u146')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u146: GeneralStatistics expression (auto-extracted; see ref)."
