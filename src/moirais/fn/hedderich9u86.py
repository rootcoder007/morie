...
__all__ = ["hedderich_chapter_9_unnumbered_86"]


def hedderich_chapter_9_unnumbered_86(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u86')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u86: GeneralStatistics expression (auto-extracted; see ref)."
