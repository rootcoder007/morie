# describe('sgrsv') — relative_structured_variability
...
`print(result)` render. See `moirais.fn.describe('sgrsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgrsv import *
import numpy as np
# See the function signature in fn/sgrsv.py for argument names.
```
