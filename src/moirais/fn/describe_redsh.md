...
`print(result)` render. See `moirais.fn.describe('redsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.redsh import *
import numpy as np
# See the function signature in fn/redsh.py for argument names.
```
