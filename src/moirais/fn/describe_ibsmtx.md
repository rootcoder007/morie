...
`print(result)` render. See `moirais.fn.describe('ibsmtx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ibsmtx import *
import numpy as np
# See the function signature in fn/ibsmtx.py for argument names.
```
