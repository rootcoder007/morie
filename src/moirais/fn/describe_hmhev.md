# describe('hmhev') — geron_heaviside
...
`print(result)` render. See `moirais.fn.describe('hmhev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmhev import *
import numpy as np
# See the function signature in fn/hmhev.py for argument names.
```
