...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1655"]


def guide_on_data_analysis_chapter_30_unnumbered_1655(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝑀0 = max𝑠<0 | ̂ 𝑔𝑠 − ̂ 𝑔𝑠−1|.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1655')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1655: GeneralStatistics expression (auto-extracted; see ref)."
