...
`print(result)` render. See `moirais.fn.describe('clens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clens import *
import numpy as np
# See the function signature in fn/clens.py for argument names.
```
