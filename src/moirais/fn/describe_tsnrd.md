...
`print(result)` render. See `moirais.fn.describe('tsnrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsnrd import *
import numpy as np
# See the function signature in fn/tsnrd.py for argument names.
```
