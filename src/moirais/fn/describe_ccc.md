...
`print(result)` render. See `moirais.fn.describe('ccc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ccc import *
import numpy as np
# See the function signature in fn/ccc.py for argument names.
```
