...
`print(result)` render. See `moirais.fn.describe('agfrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agfrc import *
import numpy as np
# See the function signature in fn/agfrc.py for argument names.
```
