...
`print(result)` render. See `moirais.fn.describe('semconv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semconv import *
import numpy as np
# See the function signature in fn/semconv.py for argument names.
```
