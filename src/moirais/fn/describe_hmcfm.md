# describe('hmcfm') — geron_confusion_matrix
...
`print(result)` render. See `moirais.fn.describe('hmcfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcfm import *
import numpy as np
# See the function signature in fn/hmcfm.py for argument names.
```
