# describe('ocorr') — otis_correlation
...
`print(result)` render. See `moirais.fn.describe('ocorr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocorr import *
import numpy as np
# See the function signature in fn/ocorr.py for argument names.
```
