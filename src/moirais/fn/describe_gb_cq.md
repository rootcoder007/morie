# describe('gb_cq') — gibbons_cramers_contingency
...
`print(result)` render. See `moirais.fn.describe('gb_cq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_cq import *
import numpy as np
# See the function signature in fn/gb_cq.py for argument names.
```
