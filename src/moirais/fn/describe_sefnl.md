...
`print(result)` render. See `moirais.fn.describe('sefnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sefnl import *
import numpy as np
# See the function signature in fn/sefnl.py for argument names.
```
