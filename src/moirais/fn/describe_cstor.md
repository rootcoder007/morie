...
`print(result)` render. See `moirais.fn.describe('cstor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cstor import *
import numpy as np
# See the function signature in fn/cstor.py for argument names.
```
