...
`print(result)` render. See `moirais.fn.describe('gevac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gevac import *
import numpy as np
# See the function signature in fn/gevac.py for argument names.
```
