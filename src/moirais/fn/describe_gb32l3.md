# describe('gb32l3') — gibbons_vandermonde_id2
...
`print(result)` render. See `moirais.fn.describe('gb32l3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb32l3 import *
import numpy as np
# See the function signature in fn/gb32l3.py for argument names.
```
