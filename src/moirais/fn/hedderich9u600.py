...
__all__ = ["hedderich_chapter_9_unnumbered_600"]


def hedderich_chapter_9_unnumbered_600(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: with 2550 = 40 + 72 + 660 + 864 + 914.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u600')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u600: GeneralStatistics expression (auto-extracted; see ref)."
