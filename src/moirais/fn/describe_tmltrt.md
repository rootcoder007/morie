# describe('tmltrt') — tmle_truncation
...
`print(result)` render. See `moirais.fn.describe('tmltrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmltrt import *
import numpy as np
# See the function signature in fn/tmltrt.py for argument names.
```
