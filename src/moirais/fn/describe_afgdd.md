...
`print(result)` render. See `moirais.fn.describe('afgdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afgdd import *
import numpy as np
# See the function signature in fn/afgdd.py for argument names.
```
