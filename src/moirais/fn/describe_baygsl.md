...
`print(result)` render. See `moirais.fn.describe('baygsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baygsl import *
import numpy as np
# See the function signature in fn/baygsl.py for argument names.
```
