# describe('ssnri') — snr_improvement
...
`print(result)` render. See `moirais.fn.describe('ssnri')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ssnri import *
import numpy as np
# See the function signature in fn/ssnri.py for argument names.
```
