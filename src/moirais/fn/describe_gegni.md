...
`print(result)` render. See `moirais.fn.describe('gegni')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gegni import *
import numpy as np
# See the function signature in fn/gegni.py for argument names.
```
