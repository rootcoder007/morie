...
`print(result)` render. See `moirais.fn.describe('nnlap')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nnlap import *
import numpy as np
# See the function signature in fn/nnlap.py for argument names.
```
