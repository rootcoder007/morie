# describe('evgofa') — evt_gev_anderson_darling
...
`print(result)` render. See `moirais.fn.describe('evgofa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evgofa import *
import numpy as np
# See the function signature in fn/evgofa.py for argument names.
```
