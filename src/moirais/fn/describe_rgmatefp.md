# describe('rgmatefp') — rangayyan_maternal_ecg_filter
...
`print(result)` render. See `moirais.fn.describe('rgmatefp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgmatefp import *
import numpy as np
# See the function signature in fn/rgmatefp.py for argument names.
```
