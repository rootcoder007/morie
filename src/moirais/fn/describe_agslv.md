...
`print(result)` render. See `moirais.fn.describe('agslv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agslv import *
import numpy as np
# See the function signature in fn/agslv.py for argument names.
```
