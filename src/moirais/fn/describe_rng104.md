# describe('rng104') — rangayyan_ch3_fourier_of_integral
...
`print(result)` render. See `moirais.fn.describe('rng104')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng104 import *
import numpy as np
# See the function signature in fn/rng104.py for argument names.
```
