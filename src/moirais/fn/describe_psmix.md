...
`print(result)` render. See `moirais.fn.describe('psmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psmix import *
import numpy as np
# See the function signature in fn/psmix.py for argument names.
```
