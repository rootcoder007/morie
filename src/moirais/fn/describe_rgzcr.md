# describe('rgzcr') — rangayyan_zero_crossing
...
`print(result)` render. See `moirais.fn.describe('rgzcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgzcr import *
import numpy as np
# See the function signature in fn/rgzcr.py for argument names.
```
