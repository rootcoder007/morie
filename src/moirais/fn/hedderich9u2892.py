...
__all__ = ["hedderich_chapter_9_unnumbered_2892"]


def hedderich_chapter_9_unnumbered_2892(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] Power = 1−β=P (χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2892')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2892: PowerAndDesign expression (auto-extracted; see ref)."
