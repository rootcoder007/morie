# describe('hdprc') — hierarchical_dirichlet_process
...
`print(result)` render. See `moirais.fn.describe('hdprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdprc import *
import numpy as np
# See the function signature in fn/hdprc.py for argument names.
```
