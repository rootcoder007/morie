...
`print(result)` render. See `moirais.fn.describe('sbstt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbstt import *
import numpy as np
# See the function signature in fn/sbstt.py for argument names.
```
