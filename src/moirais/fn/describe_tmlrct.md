# describe('tmlrct') — tmle_rct_assisted
...
`print(result)` render. See `moirais.fn.describe('tmlrct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlrct import *
import numpy as np
# See the function signature in fn/tmlrct.py for argument names.
```
