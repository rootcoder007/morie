...
`print(result)` render. See `moirais.fn.describe('dtrot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtrot import *
import numpy as np
# See the function signature in fn/dtrot.py for argument names.
```
