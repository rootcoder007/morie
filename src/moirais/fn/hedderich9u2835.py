...
__all__ = ["hedderich_chapter_9_unnumbered_2835"]


def hedderich_chapter_9_unnumbered_2835(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + n j <− apply ( x [ , , j ] , MARGIN=2 , sum )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2835')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2835: GeneralStatistics expression (auto-extracted; see ref)."
