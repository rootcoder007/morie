# describe('sdmmod') — spatial_durbin
...
`print(result)` render. See `moirais.fn.describe('sdmmod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmmod import *
import numpy as np
# See the function signature in fn/sdmmod.py for argument names.
```
