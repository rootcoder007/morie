...
`print(result)` render. See `moirais.fn.describe('huffc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.huffc import *
import numpy as np
# See the function signature in fn/huffc.py for argument names.
```
