...
`print(result)` render. See `moirais.fn.describe('annty')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.annty import *
import numpy as np
# See the function signature in fn/annty.py for argument names.
```
