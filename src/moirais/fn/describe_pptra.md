...
`print(result)` render. See `moirais.fn.describe('pptra')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pptra import *
import numpy as np
# See the function signature in fn/pptra.py for argument names.
```
