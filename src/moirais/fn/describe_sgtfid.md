# describe('sgtfid') — sgt_fiedler_value
...
`print(result)` render. See `moirais.fn.describe('sgtfid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtfid import *
import numpy as np
# See the function signature in fn/sgtfid.py for argument names.
```
