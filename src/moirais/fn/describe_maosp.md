...
`print(result)` render. See `moirais.fn.describe('maosp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maosp import *
import numpy as np
# See the function signature in fn/maosp.py for argument names.
```
