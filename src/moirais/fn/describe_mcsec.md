# describe('mcsec') — mcmc_standard_error
...
`print(result)` render. See `moirais.fn.describe('mcsec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcsec import *
import numpy as np
# See the function signature in fn/mcsec.py for argument names.
```
