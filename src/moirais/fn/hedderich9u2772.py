...
__all__ = ["hedderich_chapter_9_unnumbered_2772"]


def hedderich_chapter_9_unnumbered_2772(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˜π2 = (r1 +r2−∆·n1)/(n1 +n2) = ˜π1−∆
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2772')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2772: GeneralStatistics expression (auto-extracted; see ref)."
