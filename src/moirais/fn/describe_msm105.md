# describe('msm105') — mvsml_bayesian_regression_pt2_eq_7_2
...
`print(result)` render. See `moirais.fn.describe('msm105')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm105 import *
import numpy as np
# See the function signature in fn/msm105.py for argument names.
```
