...
__all__ = ["wilcox_chapter_10_unnumbered_971"]


def wilcox_chapter_10_unnumbered_971(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Ψ 1 =µ 1 +µ 3 +µ 5 − µ 2 − µ 4 − µ 6
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u971')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u971: GeneralStatistics expression (auto-extracted; see ref)."
