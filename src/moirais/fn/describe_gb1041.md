# describe('gb1041') — gibbons_kruskal_wallis
...
`print(result)` render. See `moirais.fn.describe('gb1041')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1041 import *
import numpy as np
# See the function signature in fn/gb1041.py for argument names.
```
