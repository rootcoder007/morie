...
`print(result)` render. See `moirais.fn.describe('timesnet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.timesnet import *
import numpy as np
# See the function signature in fn/timesnet.py for argument names.
```
