...
`print(result)` render. See `moirais.fn.describe('cosmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cosmx import *
import numpy as np
# See the function signature in fn/cosmx.py for argument names.
```
