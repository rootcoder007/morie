# describe('msm166') — mvsml_ridge_lasso_elastic_eq_9_2
...
`print(result)` render. See `moirais.fn.describe('msm166')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm166 import *
import numpy as np
# See the function signature in fn/msm166.py for argument names.
```
