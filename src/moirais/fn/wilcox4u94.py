...
__all__ = ["wilcox_chapter_4_unnumbered_94"]


def wilcox_chapter_4_unnumbered_94(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: (1 +d)/2 = (1 + 0 .9)/2 = 0 .95. Then c is given by P (Z ≤ c) = 0.95. Referring to Table 1 in
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u94')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u94: GeneralStatistics expression (auto-extracted; see ref)."
