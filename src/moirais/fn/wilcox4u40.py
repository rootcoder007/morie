...
__all__ = ["wilcox_chapter_4_unnumbered_40"]


def wilcox_chapter_4_unnumbered_40(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: associated with these ratings are p(1) = 0.2,p(2) = 0.4,p(3) = 0.3, and p(4) = 0.1, then the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u40')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u40: GeneralStatistics expression (auto-extracted; see ref)."
