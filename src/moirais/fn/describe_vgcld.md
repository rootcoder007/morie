...
`print(result)` render. See `moirais.fn.describe('vgcld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgcld import *
import numpy as np
# See the function signature in fn/vgcld.py for argument names.
```
