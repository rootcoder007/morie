# describe('greed') — greed

## WHAT IT DOES

rGreedy decoding with temperature.
...
`print(result)` render. See `moirais.fn.describe('greed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.greed import *
import numpy as np
# See the function signature in fn/greed.py for argument names.
```
