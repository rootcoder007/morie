...
`print(result)` render. See `moirais.fn.describe('prdldm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prdldm import *
import numpy as np
# See the function signature in fn/prdldm.py for argument names.
```
