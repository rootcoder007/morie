...
__all__ = ["wilcox_chapter_14_unnumbered_752"]


def wilcox_chapter_14_unnumbered_752(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (∑qj)2 + (J − 2)J ∑q2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u752')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u752: GeneralStatistics expression (auto-extracted; see ref)."
