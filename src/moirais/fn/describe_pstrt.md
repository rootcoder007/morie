...
`print(result)` render. See `moirais.fn.describe('pstrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstrt import *
import numpy as np
# See the function signature in fn/pstrt.py for argument names.
```
