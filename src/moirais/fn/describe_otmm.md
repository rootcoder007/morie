# describe('otmm') — ot_minibatch_loss
...
`print(result)` render. See `moirais.fn.describe('otmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmm import *
import numpy as np
# See the function signature in fn/otmm.py for argument names.
```
