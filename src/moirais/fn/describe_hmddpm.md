...
`print(result)` render. See `moirais.fn.describe('hmddpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmddpm import *
import numpy as np
# See the function signature in fn/hmddpm.py for argument names.
```
