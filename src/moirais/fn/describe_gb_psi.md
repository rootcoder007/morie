# describe('gb_psi') — gibbons_pitman_efficiency
...
`print(result)` render. See `moirais.fn.describe('gb_psi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_psi import *
import numpy as np
# See the function signature in fn/gb_psi.py for argument names.
```
