...
`print(result)` render. See `moirais.fn.describe('hmmom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmom import *
import numpy as np
# See the function signature in fn/hmmom.py for argument names.
```
