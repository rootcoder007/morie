# describe('volgar') — vol_garch11_fit
...
`print(result)` render. See `moirais.fn.describe('volgar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgar import *
import numpy as np
# See the function signature in fn/volgar.py for argument names.
```
