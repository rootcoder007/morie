...
`print(result)` render. See `moirais.fn.describe('enrfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enrfl import *
import numpy as np
# See the function signature in fn/enrfl.py for argument names.
```
