# describe('rlslt') — rls_lattice_filter_fn
...
`print(result)` render. See `moirais.fn.describe('rlslt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rlslt import *
import numpy as np
# See the function signature in fn/rlslt.py for argument names.
```
