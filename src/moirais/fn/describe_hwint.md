...
`print(result)` render. See `moirais.fn.describe('hwint')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hwint import *
import numpy as np
# See the function signature in fn/hwint.py for argument names.
```
