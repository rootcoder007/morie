# describe('codeg') — wigner_semicircle
...
`print(result)` render. See `moirais.fn.describe('codeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.codeg import *
import numpy as np
# See the function signature in fn/codeg.py for argument names.
```
