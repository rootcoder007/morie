...
__all__ = ["wilcox_chapter_10_unnumbered_1026"]


def wilcox_chapter_10_unnumbered_1026(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: bwmcp(J, K, x, tr = 0.2, alpha = 0.05,con=0, nboot=599)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1026')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1026: Resampling expression (auto-extracted; see ref)."
