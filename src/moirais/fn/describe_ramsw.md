...
`print(result)` render. See `moirais.fn.describe('ramsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ramsw import *
import numpy as np
# See the function signature in fn/ramsw.py for argument names.
```
