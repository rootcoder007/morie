# describe('depthM') — mahalanobis_depth
...
`print(result)` render. See `moirais.fn.describe('depthM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.depthM import *
import numpy as np
# See the function signature in fn/depthM.py for argument names.
```
