...
`print(result)` render. See `moirais.fn.describe('nusnc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nusnc import *
import numpy as np
# See the function signature in fn/nusnc.py for argument names.
```
