...
`print(result)` render. See `moirais.fn.describe('glmmbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmbin import *
import numpy as np
# See the function signature in fn/glmmbin.py for argument names.
```
