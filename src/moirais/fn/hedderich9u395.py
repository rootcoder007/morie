...
__all__ = ["hedderich_chapter_9_unnumbered_395"]


def hedderich_chapter_9_unnumbered_395(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (H)+P (L)−P (H∩L)−P (H∩L) = P (H)+P (L)−2P (H∩L) = 0.6+0.5−2·0.3 = 0.5.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u395')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u395: GeneralStatistics expression (auto-extracted; see ref)."
