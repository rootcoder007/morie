# describe('gb_med') — gibbons_median_dist
...
`print(result)` render. See `moirais.fn.describe('gb_med')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_med import *
import numpy as np
# See the function signature in fn/gb_med.py for argument names.
```
