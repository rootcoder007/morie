...
__all__ = ["hedderich_chapter_9_unnumbered_1610"]


def hedderich_chapter_9_unnumbered_1610(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (c) HA :µ̸=µ0 = 20 and H0 :µ=µ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1610')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1610: GeneralStatistics expression (auto-extracted; see ref)."
