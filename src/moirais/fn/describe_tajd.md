...
`print(result)` render. See `moirais.fn.describe('tajd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tajd import *
import numpy as np
# See the function signature in fn/tajd.py for argument names.
```
