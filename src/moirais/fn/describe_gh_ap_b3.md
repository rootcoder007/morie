# describe('gh_ap_b3') — ghosal_renyi_div
...
`print(result)` render. See `moirais.fn.describe('gh_ap_b3')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_b3 import *
import numpy as np
# See the function signature in fn/gh_ap_b3.py for argument names.
```
