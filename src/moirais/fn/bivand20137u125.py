...
__all__ = ["bivand2013_chapter_7_unnumbered_125"]


def bivand2013_chapter_7_unnumbered_125(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] λ1(x)= λ0(x)f(z(x);θ).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u125')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u125: GeneralStatistics expression (auto-extracted; see ref)."
