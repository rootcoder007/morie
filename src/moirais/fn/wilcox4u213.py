...
__all__ = ["wilcox_chapter_4_unnumbered_213"]


def wilcox_chapter_4_unnumbered_213(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: X4 = 0.4, and X5 = −0.6, then X(1) = −1.2 is the smallest of the five values, X(2) = −0.6 is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u213')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u213: GeneralStatistics expression (auto-extracted; see ref)."
