...
__all__ = ["hedderich_chapter_9_unnumbered_163"]


def hedderich_chapter_9_unnumbered_163(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 (x(k) +x(k+1)): k =n·α otherwise
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u163')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u163: GeneralStatistics expression (auto-extracted; see ref)."
