# describe('ghs031') — ghosal_ch3_polya_tree_mixture_post_density
...
`print(result)` render. See `moirais.fn.describe('ghs031')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs031 import *
import numpy as np
# See the function signature in fn/ghs031.py for argument names.
```
