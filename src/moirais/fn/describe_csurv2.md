# describe('csurv2') — causal_survival_blp
...
`print(result)` render. See `moirais.fn.describe('csurv2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csurv2 import *
import numpy as np
# See the function signature in fn/csurv2.py for argument names.
```
