...
`print(result)` render. See `moirais.fn.describe('bdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bdd import *
import numpy as np
# See the function signature in fn/bdd.py for argument names.
```
