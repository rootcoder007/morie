# describe('chisq') — chi_square_test
...
`print(result)` render. See `moirais.fn.describe('chisq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chisq import *
import numpy as np
# See the function signature in fn/chisq.py for argument names.
```
