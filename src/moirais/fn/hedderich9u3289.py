...
__all__ = ["hedderich_chapter_9_unnumbered_3289"]


def hedderich_chapter_9_unnumbered_3289(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: the statisticF follows approx. anF -distribution withν1=k+1 andν2=n1+n2−2(k+1) degrees
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3289')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3289: GeneralStatistics expression (auto-extracted; see ref)."
