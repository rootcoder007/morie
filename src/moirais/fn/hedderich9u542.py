...
__all__ = ["hedderich_chapter_9_unnumbered_542"]


def hedderich_chapter_9_unnumbered_542(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (6) P (aX̄≤b) = F (b)−F (a) +P (X =a)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u542')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u542: GeneralStatistics expression (auto-extracted; see ref)."
