...
__all__ = ["bivand2013_chapter_2_unnumbered_75"]


def bivand2013_chapter_2_unnumbered_75(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + TimeObj = ecd.y, interval = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u75')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u75: GeneralStatistics expression (auto-extracted; see ref)."
