...
__all__ = ["hedderich_chapter_9_unnumbered_1793"]


def hedderich_chapter_9_unnumbered_1793(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] 1−P (X = 0) = P (X >0) = 1−(1−π)n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1793')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1793: CountModels expression (auto-extracted; see ref)."
