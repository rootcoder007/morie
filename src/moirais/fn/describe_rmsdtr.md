...
`print(result)` render. See `moirais.fn.describe('rmsdtr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmsdtr import *
import numpy as np
# See the function signature in fn/rmsdtr.py for argument names.
```
