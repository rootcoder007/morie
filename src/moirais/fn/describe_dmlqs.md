...
`print(result)` render. See `moirais.fn.describe('dmlqs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmlqs import *
import numpy as np
# See the function signature in fn/dmlqs.py for argument names.
```
