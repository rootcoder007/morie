# describe('gh_c14_15') — ghosal_ncrm_def
...
`print(result)` render. See `moirais.fn.describe('gh_c14_15')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_15 import *
import numpy as np
# See the function signature in fn/gh_c14_15.py for argument names.
```
