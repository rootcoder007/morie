...
__all__ = ["hedderich_chapter_9_unnumbered_1638"]


def hedderich_chapter_9_unnumbered_1638(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (¯xn >A|µ0) = α= 1−Φ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1638')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1638: GeneralStatistics expression (auto-extracted; see ref)."
