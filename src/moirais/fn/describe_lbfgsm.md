...
`print(result)` render. See `moirais.fn.describe('lbfgsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lbfgsm import *
import numpy as np
# See the function signature in fn/lbfgsm.py for argument names.
```
