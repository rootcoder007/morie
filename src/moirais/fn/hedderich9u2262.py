...
__all__ = ["hedderich_chapter_9_unnumbered_2262"]


def hedderich_chapter_9_unnumbered_2262(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (c) P for non-overlap = 2·5!·5!/10! = 1/126 = 0.008< 0.05 (s.s.).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2262')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2262: GeneralStatistics expression (auto-extracted; see ref)."
