# describe('aitsdv') — compositional_shannon
...
`print(result)` render. See `moirais.fn.describe('aitsdv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitsdv import *
import numpy as np
# See the function signature in fn/aitsdv.py for argument names.
```
