...
`print(result)` render. See `moirais.fn.describe('dk3sk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dk3sk import *
import numpy as np
# See the function signature in fn/dk3sk.py for argument names.
```
