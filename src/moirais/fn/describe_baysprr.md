# describe('baysprr') — sparsity_horseshoe
...
`print(result)` render. See `moirais.fn.describe('baysprr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysprr import *
import numpy as np
# See the function signature in fn/baysprr.py for argument names.
```
