# describe('ptinp') — point_in_polygon
...
`print(result)` render. See `moirais.fn.describe('ptinp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptinp import *
import numpy as np
# See the function signature in fn/ptinp.py for argument names.
```
