# describe('alfbk2') — alphafold_backbone
...
`print(result)` render. See `moirais.fn.describe('alfbk2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfbk2 import *
import numpy as np
# See the function signature in fn/alfbk2.py for argument names.
```
