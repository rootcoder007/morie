# describe('otmqd') — ot_quantization_distortion
...
`print(result)` render. See `moirais.fn.describe('otmqd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmqd import *
import numpy as np
# See the function signature in fn/otmqd.py for argument names.
```
