# describe('rng256') — rangayyan_ch4_power_spectrum_signal_echo
...
`print(result)` render. See `moirais.fn.describe('rng256')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng256 import *
import numpy as np
# See the function signature in fn/rng256.py for argument names.
```
