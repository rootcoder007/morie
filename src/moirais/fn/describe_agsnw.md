...
`print(result)` render. See `moirais.fn.describe('agsnw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agsnw import *
import numpy as np
# See the function signature in fn/agsnw.py for argument names.
```
