# describe('resac') — residual_acf_fn
...
`print(result)` render. See `moirais.fn.describe('resac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.resac import *
import numpy as np
# See the function signature in fn/resac.py for argument names.
```
