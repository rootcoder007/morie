# describe('bkbpc') — burkov_bits_per_character
...
`print(result)` render. See `moirais.fn.describe('bkbpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkbpc import *
import numpy as np
# See the function signature in fn/bkbpc.py for argument names.
```
