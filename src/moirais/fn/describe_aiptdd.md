...
`print(result)` render. See `moirais.fn.describe('aiptdd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aiptdd import *
import numpy as np
# See the function signature in fn/aiptdd.py for argument names.
```
