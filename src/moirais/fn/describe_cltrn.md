# describe('cltrn') — cluster_trial_size
...
`print(result)` render. See `moirais.fn.describe('cltrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cltrn import *
import numpy as np
# See the function signature in fn/cltrn.py for argument names.
```
