...
`print(result)` render. See `moirais.fn.describe('bktfid')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bktfid import *
import numpy as np
# See the function signature in fn/bktfid.py for argument names.
```
