...
`print(result)` render. See `moirais.fn.describe('fofrag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fofrag import *
import numpy as np
# See the function signature in fn/fofrag.py for argument names.
```
