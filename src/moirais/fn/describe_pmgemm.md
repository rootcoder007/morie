...
`print(result)` render. See `moirais.fn.describe('pmgemm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pmgemm import *
import numpy as np
# See the function signature in fn/pmgemm.py for argument names.
```
