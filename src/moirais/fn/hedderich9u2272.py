...
__all__ = ["hedderich_chapter_9_unnumbered_2272"]


def hedderich_chapter_9_unnumbered_2272(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Z = 1 . 8 9 5 , p− value = 0. 0 3 12 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2272')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2272: GeneralStatistics expression (auto-extracted; see ref)."
