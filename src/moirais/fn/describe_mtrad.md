...
`print(result)` render. See `moirais.fn.describe('mtrad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtrad import *
import numpy as np
# See the function signature in fn/mtrad.py for argument names.
```
