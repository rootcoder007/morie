...
__all__ = ["hedderich_chapter_9_unnumbered_2099"]


def hedderich_chapter_9_unnumbered_2099(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: would be 1.15 + 1.895·0.411 = 1.15 + 0.78 or 1.93, i.e., 95% CLupper:µd = 1.93 orµd≤1.93.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2099')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2099: GeneralStatistics expression (auto-extracted; see ref)."
