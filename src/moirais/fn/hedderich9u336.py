...
__all__ = ["hedderich_chapter_9_unnumbered_336"]


def hedderich_chapter_9_unnumbered_336(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: I 5a + 15b + 55c = 19
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u336')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u336: GeneralStatistics expression (auto-extracted; see ref)."
