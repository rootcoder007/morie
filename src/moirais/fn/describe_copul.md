# describe('copul') — copula_estimation
...
`print(result)` render. See `moirais.fn.describe('copul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copul import *
import numpy as np
# See the function signature in fn/copul.py for argument names.
```
