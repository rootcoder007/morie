# describe('msebl') — mse_loss_continuous
...
`print(result)` render. See `moirais.fn.describe('msebl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msebl import *
import numpy as np
# See the function signature in fn/msebl.py for argument names.
```
