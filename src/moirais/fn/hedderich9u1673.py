...
__all__ = ["hedderich_chapter_9_unnumbered_1673"]


def hedderich_chapter_9_unnumbered_1673(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1673')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1673: CountModels expression (auto-extracted; see ref)."
