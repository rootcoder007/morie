...
`print(result)` render. See `moirais.fn.describe('kbias')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kbias import *
import numpy as np
# See the function signature in fn/kbias.py for argument names.
```
