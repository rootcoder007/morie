# describe('wvpvt') — wvpvt

## WHAT IT DOES

Pivot probability spatial.
...
`print(result)` render. See `moirais.fn.describe('wvpvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvpvt import *
import numpy as np
# See the function signature in fn/wvpvt.py for argument names.
```
