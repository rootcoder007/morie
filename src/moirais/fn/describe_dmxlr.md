...
`print(result)` render. See `moirais.fn.describe('dmxlr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dmxlr import *
import numpy as np
# See the function signature in fn/dmxlr.py for argument names.
```
