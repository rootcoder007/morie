...
`print(result)` render. See `moirais.fn.describe('holo_g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_g import *
import numpy as np
# See the function signature in fn/holo_g.py for argument names.
```
