...
__all__ = ["hedderich_chapter_9_unnumbered_856"]


def hedderich_chapter_9_unnumbered_856(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] z = (8.89−12.00)/2.00 =−3.11/2.00 =−1.555;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u856')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u856: GeneralStatistics expression (auto-extracted; see ref)."
