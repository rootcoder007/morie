...
__all__ = ["hedderich_chapter_9_unnumbered_3336"]


def hedderich_chapter_9_unnumbered_3336(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ˆµ3. = ˆη+ ˆα3 = 11.83
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3336')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3336: GeneralStatistics expression (auto-extracted; see ref)."
