# describe('msm333') — mvsml_elements_lin_reg_eq_3_1
...
`print(result)` render. See `moirais.fn.describe('msm333')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm333 import *
import numpy as np
# See the function signature in fn/msm333.py for argument names.
```
