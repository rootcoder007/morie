...
`print(result)` render. See `moirais.fn.describe('cliff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cliff import *
import numpy as np
# See the function signature in fn/cliff.py for argument names.
```
