...
`print(result)` render. See `moirais.fn.describe('stcox')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stcox import *
import numpy as np
# See the function signature in fn/stcox.py for argument names.
```
