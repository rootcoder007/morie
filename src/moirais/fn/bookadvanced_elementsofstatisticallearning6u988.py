...
__all__ = ["bookadvanced_elementsofstatisticallearning_chapter_6_unnumbered_988"]
...
def bookadvanced_elementsofstatisticallearning_chapter_6_unnumbered_988(x, cdf=None):
    """The art of doing mathematics consists in finding that special case which contains all the germs of generality. — David Hilbert"statistic"]`` / ``result.get(...)`` keep working),
        ...
        See ``moirais.fn.describe('bookadvanced_elementsofstatisticallearning6u988')`` for the full guide.
...
def cheatsheet():
    return "bookadvanced_elementsofstatisticallearning6u988: GeneralStatistics expression (auto-extracted; see ref)."
