# describe('sebir') — sebir

## WHAT IT DOES

ICAR spatial rate model
...
`print(result)` render. See `moirais.fn.describe('sebir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebir import *
import numpy as np
# See the function signature in fn/sebir.py for argument names.
```
