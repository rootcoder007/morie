...
`print(result)` render. See `moirais.fn.describe('openf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.openf import *
import numpy as np
# See the function signature in fn/openf.py for argument names.
```
