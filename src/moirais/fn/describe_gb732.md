# describe('gb732') — gibbons_linrank_mean_var
...
`print(result)` render. See `moirais.fn.describe('gb732')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb732 import *
import numpy as np
# See the function signature in fn/gb732.py for argument names.
```
