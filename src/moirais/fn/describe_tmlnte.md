# describe('tmlnte') — tmle_natural_total
...
`print(result)` render. See `moirais.fn.describe('tmlnte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlnte import *
import numpy as np
# See the function signature in fn/tmlnte.py for argument names.
```
