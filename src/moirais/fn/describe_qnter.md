# describe('qnter') — quantization_error
...
`print(result)` render. See `moirais.fn.describe('qnter')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qnter import *
import numpy as np
# See the function signature in fn/qnter.py for argument names.
```
