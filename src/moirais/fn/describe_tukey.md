...
`print(result)` render. See `moirais.fn.describe('tukey')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tukey import *
import numpy as np
# See the function signature in fn/tukey.py for argument names.
```
