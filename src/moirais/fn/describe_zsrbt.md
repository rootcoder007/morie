...
`print(result)` render. See `moirais.fn.describe('zsrbt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrbt import *
import numpy as np
# See the function signature in fn/zsrbt.py for argument names.
```
