...
`print(result)` render. See `moirais.fn.describe('hsdiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hsdiv import *
import numpy as np
# See the function signature in fn/hsdiv.py for argument names.
```
