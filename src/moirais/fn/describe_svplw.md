# describe('svplw') — polarization_wolf
...
`print(result)` render. See `moirais.fn.describe('svplw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svplw import *
import numpy as np
# See the function signature in fn/svplw.py for argument names.
```
