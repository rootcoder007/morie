...
__all__ = ["hedderich_chapter_9_unnumbered_2945"]


def hedderich_chapter_9_unnumbered_2945(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + theta <− pbinom ( round ( n*p . 0 ) , n , prob =p . 0 , lower . tail = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2945')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2945: GeneralStatistics expression (auto-extracted; see ref)."
