...
`print(result)` render. See `moirais.fn.describe('agprf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agprf import *
import numpy as np
# See the function signature in fn/agprf.py for argument names.
```
