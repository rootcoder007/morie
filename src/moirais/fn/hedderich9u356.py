...
__all__ = ["hedderich_chapter_9_unnumbered_356"]


def hedderich_chapter_9_unnumbered_356(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: y = axb [ln y] = ln a + b[ln x] ln y ln x ln a b
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u356')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u356: PowerAndDesign expression (auto-extracted; see ref)."
