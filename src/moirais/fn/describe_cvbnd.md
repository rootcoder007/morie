...
`print(result)` render. See `moirais.fn.describe('cvbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvbnd import *
import numpy as np
# See the function signature in fn/cvbnd.py for argument names.
```
