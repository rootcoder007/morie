# describe('volopn') — vol_implied_volatility_bs
...
`print(result)` render. See `moirais.fn.describe('volopn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volopn import *
import numpy as np
# See the function signature in fn/volopn.py for argument names.
```
