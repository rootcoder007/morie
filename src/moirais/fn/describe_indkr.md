...
`print(result)` render. See `moirais.fn.describe('indkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.indkr import *
import numpy as np
# See the function signature in fn/indkr.py for argument names.
```
