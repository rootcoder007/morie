...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1564"]


def guide_on_data_analysis_chapter_30_unnumbered_1564(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑌𝑖𝑡 = 𝑊𝑖𝑡𝑌𝑖𝑡(1) + (1 − 𝑊𝑖𝑡)𝑌𝑖𝑡(0)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1564')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1564: GeneralStatistics expression (auto-extracted; see ref)."
