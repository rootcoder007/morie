...
__all__ = ["hedderich_chapter_9_unnumbered_3414"]


def hedderich_chapter_9_unnumbered_3414(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (yi log (ˆλi)−ˆλi)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3414')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3414: GeneralStatistics expression (auto-extracted; see ref)."
