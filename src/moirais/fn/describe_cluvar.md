# describe('cluvar') — cluster_variance
...
`print(result)` render. See `moirais.fn.describe('cluvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cluvar import *
import numpy as np
# See the function signature in fn/cluvar.py for argument names.
```
