...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_905"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_905(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fR = Nonlin., fτ = Nonlin. 0.40 0.65 0.13 –
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u905')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u905: GeneralStatistics expression (auto-extracted; see ref)."
