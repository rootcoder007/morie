...
`print(result)` render. See `moirais.fn.describe('or2d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.or2d import *
import numpy as np
# See the function signature in fn/or2d.py for argument names.
```
