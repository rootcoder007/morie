...
__all__ = ["hedderich_chapter_9_unnumbered_2481"]


def hedderich_chapter_9_unnumbered_2481(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Control of rank sums: ∑Ri = 136 = 16·17/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2481')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2481: GeneralStatistics expression (auto-extracted; see ref)."
