...
`print(result)` render. See `moirais.fn.describe('dtbvp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtbvp import *
import numpy as np
# See the function signature in fn/dtbvp.py for argument names.
```
