...
`print(result)` render. See `moirais.fn.describe('pppos')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pppos import *
import numpy as np
# See the function signature in fn/pppos.py for argument names.
```
