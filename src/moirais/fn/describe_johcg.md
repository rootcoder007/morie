...
`print(result)` render. See `moirais.fn.describe('johcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.johcg import *
import numpy as np
# See the function signature in fn/johcg.py for argument names.
```
