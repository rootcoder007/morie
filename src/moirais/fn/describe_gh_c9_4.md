# describe('gh_c9_4') — ghosal_dpm_norm_crt
...
`print(result)` render. See `moirais.fn.describe('gh_c9_4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c9_4 import *
import numpy as np
# See the function signature in fn/gh_c9_4.py for argument names.
```
