...
`print(result)` render. See `moirais.fn.describe('gate')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gate import *
import numpy as np
# See the function signature in fn/gate.py for argument names.
```
