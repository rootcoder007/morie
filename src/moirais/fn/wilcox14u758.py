...
__all__ = ["wilcox_chapter_14_unnumbered_758"]


def wilcox_chapter_14_unnumbered_758(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: and so forth. The sums of the ranks corresponding to each group are R1 = 1 + 6 + 2 = 9,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u758')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u758: ContingencyTables expression (auto-extracted; see ref)."
