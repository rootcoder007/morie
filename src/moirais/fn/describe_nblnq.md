...
`print(result)` render. See `moirais.fn.describe('nblnq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nblnq import *
import numpy as np
# See the function signature in fn/nblnq.py for argument names.
```
