# describe('gb5414') — gibbons_sign_power
...
`print(result)` render. See `moirais.fn.describe('gb5414')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5414 import *
import numpy as np
# See the function signature in fn/gb5414.py for argument names.
```
