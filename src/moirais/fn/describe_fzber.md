# describe('fzber') — fauzi_berry_esseen_quantile
...
`print(result)` render. See `moirais.fn.describe('fzber')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzber import *
import numpy as np
# See the function signature in fn/fzber.py for argument names.
```
