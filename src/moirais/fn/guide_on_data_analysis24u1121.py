...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1121"]


def guide_on_data_analysis_chapter_24_unnumbered_1121(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 𝜇𝑖𝑗 = 𝜇.. + 𝛼𝑖 + 𝛽𝑗 + (𝛼𝛽)𝑖𝑗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1121')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1121: GeneralStatistics expression (auto-extracted; see ref)."
