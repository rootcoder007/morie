...
`print(result)` render. See `moirais.fn.describe('vorper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vorper import *
import numpy as np
# See the function signature in fn/vorper.py for argument names.
```
