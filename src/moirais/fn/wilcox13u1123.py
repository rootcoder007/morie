...
__all__ = ["wilcox_chapter_13_unnumbered_1123"]


def wilcox_chapter_13_unnumbered_1123(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: expand=0.5, low.span=2/3, varfun=pbvar,family="gaussian", scale=TRUE,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1123')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1123: GeneralStatistics expression (auto-extracted; see ref)."
