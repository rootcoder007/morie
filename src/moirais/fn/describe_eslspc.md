# describe('eslspc') — esl_spectral_cluster
...
`print(result)` render. See `moirais.fn.describe('eslspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslspc import *
import numpy as np
# See the function signature in fn/eslspc.py for argument names.
```
