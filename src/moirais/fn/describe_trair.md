...
`print(result)` render. See `moirais.fn.describe('trair')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trair import *
import numpy as np
# See the function signature in fn/trair.py for argument names.
```
