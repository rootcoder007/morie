...
`print(result)` render. See `moirais.fn.describe('sgpad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgpad import *
import numpy as np
# See the function signature in fn/sgpad.py for argument names.
```
