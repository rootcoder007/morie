...
__all__ = ["hedderich_chapter_9_unnumbered_2115"]


def hedderich_chapter_9_unnumbered_2115(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆz = |(R1/m)−(R2/n)|√[ (m+n)2−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2115')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2115: GeneralStatistics expression (auto-extracted; see ref)."
