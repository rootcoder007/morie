# describe('ghs025') — ghosal_ch3_tailfree_density_product
...
`print(result)` render. See `moirais.fn.describe('ghs025')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghs025 import *
import numpy as np
# See the function signature in fn/ghs025.py for argument names.
```
