...
`print(result)` render. See `moirais.fn.describe('ngnest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ngnest import *
import numpy as np
# See the function signature in fn/ngnest.py for argument names.
```
