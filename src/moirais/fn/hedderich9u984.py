...
__all__ = ["hedderich_chapter_9_unnumbered_984"]


def hedderich_chapter_9_unnumbered_984(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (Xi−µ)2; E(S′2) = σ2; Var(S′2) = 2σ4
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u984')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u984: GeneralStatistics expression (auto-extracted; see ref)."
