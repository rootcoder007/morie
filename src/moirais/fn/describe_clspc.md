...
`print(result)` render. See `moirais.fn.describe('clspc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clspc import *
import numpy as np
# See the function signature in fn/clspc.py for argument names.
```
