# describe('mtoped') — mto_pedestrian
...
`print(result)` render. See `moirais.fn.describe('mtoped')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtoped import *
import numpy as np
# See the function signature in fn/mtoped.py for argument names.
```
