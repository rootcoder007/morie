# describe('rng110') — rangayyan_ch3_ma_8point_sinc_frequency_response
...
`print(result)` render. See `moirais.fn.describe('rng110')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng110 import *
import numpy as np
# See the function signature in fn/rng110.py for argument names.
```
