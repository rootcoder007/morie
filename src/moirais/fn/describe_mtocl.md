# describe('mtocl') — mto_collision_rate
...
`print(result)` render. See `moirais.fn.describe('mtocl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtocl import *
import numpy as np
# See the function signature in fn/mtocl.py for argument names.
```
