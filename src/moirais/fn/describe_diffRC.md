...
`print(result)` render. See `moirais.fn.describe('diffRC')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffRC import *
import numpy as np
# See the function signature in fn/diffRC.py for argument names.
```
