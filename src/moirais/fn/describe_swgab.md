...
`print(result)` render. See `moirais.fn.describe('swgab')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swgab import *
import numpy as np
# See the function signature in fn/swgab.py for argument names.
```
