# describe('rng198') — rangayyan_ch4_dot_product_discrete
...
`print(result)` render. See `moirais.fn.describe('rng198')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng198 import *
import numpy as np
# See the function signature in fn/rng198.py for argument names.
```
