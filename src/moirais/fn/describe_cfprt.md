...
`print(result)` render. See `moirais.fn.describe('cfprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfprt import *
import numpy as np
# See the function signature in fn/cfprt.py for argument names.
```
