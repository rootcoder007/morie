# describe('lordzs') — lord_chi_square
...
`print(result)` render. See `moirais.fn.describe('lordzs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lordzs import *
import numpy as np
# See the function signature in fn/lordzs.py for argument names.
```
