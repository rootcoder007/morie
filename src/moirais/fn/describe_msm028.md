# describe('msm028') — mvsml_linear_mixed_models_eq_5_5a
...
`print(result)` render. See `moirais.fn.describe('msm028')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm028 import *
import numpy as np
# See the function signature in fn/msm028.py for argument names.
```
