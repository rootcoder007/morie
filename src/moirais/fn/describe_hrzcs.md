# describe('hrzcs') — horowitz_curse_dimensionality
...
`print(result)` render. See `moirais.fn.describe('hrzcs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzcs import *
import numpy as np
# See the function signature in fn/hrzcs.py for argument names.
```
