...
`print(result)` render. See `moirais.fn.describe('brdge')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brdge import *
import numpy as np
# See the function signature in fn/brdge.py for argument names.
```
