...
`print(result)` render. See `moirais.fn.describe('rbfcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfcomp import *
import numpy as np
# See the function signature in fn/rbfcomp.py for argument names.
```
