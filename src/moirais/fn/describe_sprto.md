...
`print(result)` render. See `moirais.fn.describe('sprto')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprto import *
import numpy as np
# See the function signature in fn/sprto.py for argument names.
```
