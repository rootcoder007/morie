...
`print(result)` render. See `moirais.fn.describe('gevcf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gevcf import *
import numpy as np
# See the function signature in fn/gevcf.py for argument names.
```
