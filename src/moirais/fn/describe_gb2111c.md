# describe('gb2111c') — gibbons_elementary_coverage_beta
...
`print(result)` render. See `moirais.fn.describe('gb2111c')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb2111c import *
import numpy as np
# See the function signature in fn/gb2111c.py for argument names.
```
