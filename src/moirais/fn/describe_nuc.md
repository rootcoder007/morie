...
`print(result)` render. See `moirais.fn.describe('nuc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nuc import *
import numpy as np
# See the function signature in fn/nuc.py for argument names.
```
