...
`print(result)` render. See `moirais.fn.describe('mtdsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtdsp import *
import numpy as np
# See the function signature in fn/mtdsp.py for argument names.
```
