...
__all__ = ["hedderich_chapter_9_unnumbered_3311"]


def hedderich_chapter_9_unnumbered_3311(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The model can also be described via a matrixX (design matrix) in matrix notationY =Xβ + ϵ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3311')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3311: GeneralStatistics expression (auto-extracted; see ref)."
