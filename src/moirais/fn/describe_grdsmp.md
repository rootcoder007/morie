...
`print(result)` render. See `moirais.fn.describe('grdsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdsmp import *
import numpy as np
# See the function signature in fn/grdsmp.py for argument names.
```
