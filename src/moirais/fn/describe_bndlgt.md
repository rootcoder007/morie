# describe('bndlgt') — bound_logistic
...
`print(result)` render. See `moirais.fn.describe('bndlgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndlgt import *
import numpy as np
# See the function signature in fn/bndlgt.py for argument names.
```
