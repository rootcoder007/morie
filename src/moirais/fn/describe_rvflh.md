# describe('rvflh') — causal_reversal_test
...
`print(result)` render. See `moirais.fn.describe('rvflh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rvflh import *
import numpy as np
# See the function signature in fn/rvflh.py for argument names.
```
