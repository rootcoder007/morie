...
__all__ = ["hedderich_chapter_9_unnumbered_729"]


def hedderich_chapter_9_unnumbered_729(x):
    """
    CountModels expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u729')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u729: CountModels expression (auto-extracted; see ref)."
