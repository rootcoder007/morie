...
`print(result)` render. See `moirais.fn.describe('gdmrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdmrt import *
import numpy as np
# See the function signature in fn/gdmrt.py for argument names.
```
