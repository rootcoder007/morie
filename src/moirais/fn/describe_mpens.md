...
`print(result)` render. See `moirais.fn.describe('mpens')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpens import *
import numpy as np
# See the function signature in fn/mpens.py for argument names.
```
