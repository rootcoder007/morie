# describe('mahks') — ma_hartung_knapp
...
`print(result)` render. See `moirais.fn.describe('mahks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mahks import *
import numpy as np
# See the function signature in fn/mahks.py for argument names.
```
