...
__all__ = ["hedderich_chapter_9_unnumbered_3148"]


def hedderich_chapter_9_unnumbered_3148(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: checked. This value is compared withJS;α = [zα +tn−2;α]/2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3148')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3148: GeneralStatistics expression (auto-extracted; see ref)."
