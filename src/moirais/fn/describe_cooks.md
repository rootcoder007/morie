...
`print(result)` render. See `moirais.fn.describe('cooks')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cooks import *
import numpy as np
# See the function signature in fn/cooks.py for argument names.
```
