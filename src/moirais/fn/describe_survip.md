# describe('survip') — survey_p_value
...
`print(result)` render. See `moirais.fn.describe('survip')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survip import *
import numpy as np
# See the function signature in fn/survip.py for argument names.
```
