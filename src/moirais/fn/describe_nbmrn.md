...
`print(result)` render. See `moirais.fn.describe('nbmrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbmrn import *
import numpy as np
# See the function signature in fn/nbmrn.py for argument names.
```
