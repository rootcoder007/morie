...
__all__ = ["hedderich_chapter_9_unnumbered_3094"]


def hedderich_chapter_9_unnumbered_3094(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (I) H0:ϱ= 0 [againstHA:ϱ̸= 0]: |ˆt|≥tn−2;1−α/2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3094')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3094: PowerAndDesign expression (auto-extracted; see ref)."
