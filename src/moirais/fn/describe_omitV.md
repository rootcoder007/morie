# describe('omitV') — omitted_variable_bias
...
`print(result)` render. See `moirais.fn.describe('omitV')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omitV import *
import numpy as np
# See the function signature in fn/omitV.py for argument names.
```
