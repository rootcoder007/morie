...
`print(result)` render. See `moirais.fn.describe('ubcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubcrs import *
import numpy as np
# See the function signature in fn/ubcrs.py for argument names.
```
