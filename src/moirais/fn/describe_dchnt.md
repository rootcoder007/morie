...
`print(result)` render. See `moirais.fn.describe('dchnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dchnt import *
import numpy as np
# See the function signature in fn/dchnt.py for argument names.
```
