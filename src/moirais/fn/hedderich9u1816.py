...
__all__ = ["hedderich_chapter_9_unnumbered_1816"]


def hedderich_chapter_9_unnumbered_1816(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: s ·√n>t n−1;1−α/2 to the right/left of±ˆt
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1816')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1816: GeneralStatistics expression (auto-extracted; see ref)."
