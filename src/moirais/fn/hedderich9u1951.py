...
__all__ = ["hedderich_chapter_9_unnumbered_1951"]


def hedderich_chapter_9_unnumbered_1951(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 1·F1−α < F <∞) (7.83)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1951')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1951: PowerAndDesign expression (auto-extracted; see ref)."
