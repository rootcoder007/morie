...
`print(result)` render. See `moirais.fn.describe('svip1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svip1 import *
import numpy as np
# See the function signature in fn/svip1.py for argument names.
```
