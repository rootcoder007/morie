# describe('gb661') — gibbons_mannwhitney
...
`print(result)` render. See `moirais.fn.describe('gb661')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb661 import *
import numpy as np
# See the function signature in fn/gb661.py for argument names.
```
