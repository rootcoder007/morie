...
`print(result)` render. See `moirais.fn.describe('garchm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.garchm import *
import numpy as np
# See the function signature in fn/garchm.py for argument names.
```
