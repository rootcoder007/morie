# describe('volsd') — vol_simple_diff
...
`print(result)` render. See `moirais.fn.describe('volsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volsd import *
import numpy as np
# See the function signature in fn/volsd.py for argument names.
```
