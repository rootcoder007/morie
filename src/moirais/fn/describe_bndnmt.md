# describe('bndnmt') — bound_no_monotonicity
...
`print(result)` render. See `moirais.fn.describe('bndnmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndnmt import *
import numpy as np
# See the function signature in fn/bndnmt.py for argument names.
```
