# describe('fnDist') — functional_distance
...
`print(result)` render. See `moirais.fn.describe('fnDist')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fnDist import *
import numpy as np
# See the function signature in fn/fnDist.py for argument names.
```
