...
`print(result)` render. See `moirais.fn.describe('profds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.profds import *
import numpy as np
# See the function signature in fn/profds.py for argument names.
```
