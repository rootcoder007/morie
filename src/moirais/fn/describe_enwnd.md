...
`print(result)` render. See `moirais.fn.describe('enwnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enwnd import *
import numpy as np
# See the function signature in fn/enwnd.py for argument names.
```
