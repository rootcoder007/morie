...
__all__ = ["hedderich_chapter_9_unnumbered_2774"]


def hedderich_chapter_9_unnumbered_2774(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =P (zZ̄1(+∆)) + [1−P (zZ̄1(−∆))]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2774')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2774: GeneralStatistics expression (auto-extracted; see ref)."
