# describe('rng086') — rangayyan_ch3_normalized_cross_correlation_template
...
`print(result)` render. See `moirais.fn.describe('rng086')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng086 import *
import numpy as np
# See the function signature in fn/rng086.py for argument names.
```
