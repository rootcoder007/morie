# describe('otplan') — ot_plan_to_map
...
`print(result)` render. See `moirais.fn.describe('otplan')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otplan import *
import numpy as np
# See the function signature in fn/otplan.py for argument names.
```
