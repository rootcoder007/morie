# describe('thomp') — thompson_sampling
...
`print(result)` render. See `moirais.fn.describe('thomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thomp import *
import numpy as np
# See the function signature in fn/thomp.py for argument names.
```
