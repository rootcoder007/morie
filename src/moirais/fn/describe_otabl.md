...
`print(result)` render. See `moirais.fn.describe('otabl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otabl import *
import numpy as np
# See the function signature in fn/otabl.py for argument names.
```
