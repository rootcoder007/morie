# describe('rotbnd') — rotatable_bond_count
...
`print(result)` render. See `moirais.fn.describe('rotbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rotbnd import *
import numpy as np
# See the function signature in fn/rotbnd.py for argument names.
```
