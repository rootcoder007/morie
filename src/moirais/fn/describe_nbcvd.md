...
`print(result)` render. See `moirais.fn.describe('nbcvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nbcvd import *
import numpy as np
# See the function signature in fn/nbcvd.py for argument names.
```
