# describe('hmrpt') — geron_random_patches
...
`print(result)` render. See `moirais.fn.describe('hmrpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrpt import *
import numpy as np
# See the function signature in fn/hmrpt.py for argument names.
```
