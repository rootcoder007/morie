...
`print(result)` render. See `moirais.fn.describe('psdpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.psdpr import *
import numpy as np
# See the function signature in fn/psdpr.py for argument names.
```
