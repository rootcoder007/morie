# describe('rng156') — rangayyan_ch3_lms_estimation_error
...
`print(result)` render. See `moirais.fn.describe('rng156')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng156 import *
import numpy as np
# See the function signature in fn/rng156.py for argument names.
```
