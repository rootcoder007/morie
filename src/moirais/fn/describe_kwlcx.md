...
`print(result)` render. See `moirais.fn.describe('kwlcx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kwlcx import *
import numpy as np
# See the function signature in fn/kwlcx.py for argument names.
```
