...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_143"]


def guide_on_data_analysis_chapter_4_unnumbered_143(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑠√𝑛 ≤ 𝜇 ≤ ̄ 𝑦 + 𝑡𝛼/2;𝑛−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u143')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u143: GeneralStatistics expression (auto-extracted; see ref)."
