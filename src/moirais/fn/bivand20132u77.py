...
__all__ = ["bivand2013_chapter_2_unnumbered_77"]


def bivand2013_chapter_2_unnumbered_77(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + asp = 0.5, xlab = "Sites, ordered by time", colorkey = ck)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u77')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u77: GeneralStatistics expression (auto-extracted; see ref)."
