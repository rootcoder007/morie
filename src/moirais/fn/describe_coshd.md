...
`print(result)` render. See `moirais.fn.describe('coshd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.coshd import *
import numpy as np
# See the function signature in fn/coshd.py for argument names.
```
