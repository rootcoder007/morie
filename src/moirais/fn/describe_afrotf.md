...
`print(result)` render. See `moirais.fn.describe('afrotf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afrotf import *
import numpy as np
# See the function signature in fn/afrotf.py for argument names.
```
