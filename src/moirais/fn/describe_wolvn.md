...
`print(result)` render. See `moirais.fn.describe('wolvn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wolvn import *
import numpy as np
# See the function signature in fn/wolvn.py for argument names.
```
