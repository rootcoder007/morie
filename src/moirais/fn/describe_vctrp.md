...
`print(result)` render. See `moirais.fn.describe('vctrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vctrp import *
import numpy as np
# See the function signature in fn/vctrp.py for argument names.
```
