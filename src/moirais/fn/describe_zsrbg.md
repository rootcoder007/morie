...
`print(result)` render. See `moirais.fn.describe('zsrbg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrbg import *
import numpy as np
# See the function signature in fn/zsrbg.py for argument names.
```
