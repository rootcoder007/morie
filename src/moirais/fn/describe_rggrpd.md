# describe('rggrpd') — rangayyan_group_delay
...
`print(result)` render. See `moirais.fn.describe('rggrpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rggrpd import *
import numpy as np
# See the function signature in fn/rggrpd.py for argument names.
```
