...
`print(result)` render. See `moirais.fn.describe('hitsR')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hitsR import *
import numpy as np
# See the function signature in fn/hitsR.py for argument names.
```
