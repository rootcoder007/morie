...
def ca_chapter_11_equation_14(x):
    """
    Correlation expression involving 'ffiffiffiffiffiffiffiffiffiffiffi' (auto-extracted; see reference for full context).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('ca11e14')`` for the full guide.
    ...
    if n < 3:
        return hypothesis_test_result(
            ...
            extra_summary=[("n", n)],
            extra_payload={"n": n, "method": "Correlation expression involving 'ffiffiffiffiffiffiffiffiffiffiffi' (auto-extracted; see reference for full context)."},
        )
    ...
    return hypothesis_test_result(
        ...
        extra_summary=[("n", n)],
        extra_payload={"n": n, "method": "Correlation expression involving 'ffiffiffiffiffiffiffiffiffiffiffi' (auto-extracted; see reference for full context).", "p_value": float(result.pvalue)},
    )
