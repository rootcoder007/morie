# describe('dblrt') — population_doubling
...
`print(result)` render. See `moirais.fn.describe('dblrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dblrt import *
import numpy as np
# See the function signature in fn/dblrt.py for argument names.
```
