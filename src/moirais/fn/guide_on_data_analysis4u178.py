...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_178"]


def guide_on_data_analysis_chapter_4_unnumbered_178(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2 + 𝑧𝛼√𝑛(𝑛 + 1)(2𝑛 + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u178')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u178: GeneralStatistics expression (auto-extracted; see ref)."
