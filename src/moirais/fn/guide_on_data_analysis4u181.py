...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_181"]


def guide_on_data_analysis_chapter_4_unnumbered_181(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • Suppose 𝑦1 = −1, 𝑦2 = 3, 𝑦3 = −3, and 𝑦4 = 5.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u181')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u181: GeneralStatistics expression (auto-extracted; see ref)."
