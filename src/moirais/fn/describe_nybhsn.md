# describe('nybhsn') — nyblom_hansen_stability
...
`print(result)` render. See `moirais.fn.describe('nybhsn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nybhsn import *
import numpy as np
# See the function signature in fn/nybhsn.py for argument names.
```
