# describe('mafft') — mafft_alignment
...
`print(result)` render. See `moirais.fn.describe('mafft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mafft import *
import numpy as np
# See the function signature in fn/mafft.py for argument names.
```
