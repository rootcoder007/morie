...
`print(result)` render. See `moirais.fn.describe('simul')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.simul import *
import numpy as np
# See the function signature in fn/simul.py for argument names.
```
