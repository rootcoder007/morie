# describe('rglindf') — rangayyan_linear_discrim
...
`print(result)` render. See `moirais.fn.describe('rglindf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rglindf import *
import numpy as np
# See the function signature in fn/rglindf.py for argument names.
```
