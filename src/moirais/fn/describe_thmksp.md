# describe('thmksp') — thomas_cluster
...
`print(result)` render. See `moirais.fn.describe('thmksp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thmksp import *
import numpy as np
# See the function signature in fn/thmksp.py for argument names.
```
