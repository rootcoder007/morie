...
`print(result)` render. See `moirais.fn.describe('mtdeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtdeg import *
import numpy as np
# See the function signature in fn/mtdeg.py for argument names.
```
