# describe('rcdsm') — recidivism_rate
...
`print(result)` render. See `moirais.fn.describe('rcdsm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdsm import *
import numpy as np
# See the function signature in fn/rcdsm.py for argument names.
```
