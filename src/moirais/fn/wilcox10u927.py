...
__all__ = ["wilcox_chapter_10_unnumbered_927"]


def wilcox_chapter_10_unnumbered_927(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: all pairs of groups with α = 0.05, then C = 6, and the confidence interval for the difference
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u927')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u927: GeneralStatistics expression (auto-extracted; see ref)."
