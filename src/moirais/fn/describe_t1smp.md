# describe('t1smp') — one_sample_t_test
...
`print(result)` render. See `moirais.fn.describe('t1smp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.t1smp import *
import numpy as np
# See the function signature in fn/t1smp.py for argument names.
```
