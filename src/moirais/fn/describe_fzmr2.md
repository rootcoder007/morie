...
`print(result)` render. See `moirais.fn.describe('fzmr2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fzmr2 import *
import numpy as np
# See the function signature in fn/fzmr2.py for argument names.
```
