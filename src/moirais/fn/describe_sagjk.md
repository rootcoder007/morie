...
`print(result)` render. See `moirais.fn.describe('sagjk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagjk import *
import numpy as np
# See the function signature in fn/sagjk.py for argument names.
```
