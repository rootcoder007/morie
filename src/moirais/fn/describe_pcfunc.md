# describe('pcfunc') — pair_correlation_function
...
`print(result)` render. See `moirais.fn.describe('pcfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcfunc import *
import numpy as np
# See the function signature in fn/pcfunc.py for argument names.
```
