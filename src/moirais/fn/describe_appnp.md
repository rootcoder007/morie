...
`print(result)` render. See `moirais.fn.describe('appnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.appnp import *
import numpy as np
# See the function signature in fn/appnp.py for argument names.
```
