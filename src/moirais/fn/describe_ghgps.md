# describe('ghgps') — ghosal_gp_squared_exponential
...
`print(result)` render. See `moirais.fn.describe('ghgps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghgps import *
import numpy as np
# See the function signature in fn/ghgps.py for argument names.
```
