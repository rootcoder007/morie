# describe('cmpls') — computable_complexity
...
`print(result)` render. See `moirais.fn.describe('cmpls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmpls import *
import numpy as np
# See the function signature in fn/cmpls.py for argument names.
```
