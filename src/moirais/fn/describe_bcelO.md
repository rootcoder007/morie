# describe('bcelO') — binary_crossentropy_loss
...
`print(result)` render. See `moirais.fn.describe('bcelO')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcelO import *
import numpy as np
# See the function signature in fn/bcelO.py for argument names.
```
