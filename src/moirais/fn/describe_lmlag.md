...
`print(result)` render. See `moirais.fn.describe('lmlag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmlag import *
import numpy as np
# See the function signature in fn/lmlag.py for argument names.
```
