# describe('grbo') — geron_bellman_optimality
...
`print(result)` render. See `moirais.fn.describe('grbo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbo import *
import numpy as np
# See the function signature in fn/grbo.py for argument names.
```
