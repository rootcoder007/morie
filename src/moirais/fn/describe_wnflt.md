...
`print(result)` render. See `moirais.fn.describe('wnflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnflt import *
import numpy as np
# See the function signature in fn/wnflt.py for argument names.
```
