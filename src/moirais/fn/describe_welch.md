...
`print(result)` render. See `moirais.fn.describe('welch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.welch import *
import numpy as np
# See the function signature in fn/welch.py for argument names.
```
