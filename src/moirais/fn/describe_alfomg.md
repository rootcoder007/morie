# describe('alfomg') — openfold_msa_pair
...
`print(result)` render. See `moirais.fn.describe('alfomg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfomg import *
import numpy as np
# See the function signature in fn/alfomg.py for argument names.
```
