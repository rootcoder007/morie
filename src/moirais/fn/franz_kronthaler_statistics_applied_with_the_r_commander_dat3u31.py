...
def franz_kronthaler_statistics_applied_with_the_r_commander_dat_chapter_3_unnumbered_31(x):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('franz_kronthaler_statistics_applied_with_the_r_commander_dat3u31')`` for the full guide.
