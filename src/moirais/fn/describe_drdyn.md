...
`print(result)` render. See `moirais.fn.describe('drdyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drdyn import *
import numpy as np
# See the function signature in fn/drdyn.py for argument names.
```
