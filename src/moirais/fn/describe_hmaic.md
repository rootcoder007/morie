...
`print(result)` render. See `moirais.fn.describe('hmaic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmaic import *
import numpy as np
# See the function signature in fn/hmaic.py for argument names.
```
