...
`print(result)` render. See `moirais.fn.describe('xrlml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrlml import *
import numpy as np
# See the function signature in fn/xrlml.py for argument names.
```
