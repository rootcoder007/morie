# describe('rng057') — rangayyan_ch3_iir_difference_equation
...
`print(result)` render. See `moirais.fn.describe('rng057')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng057 import *
import numpy as np
# See the function signature in fn/rng057.py for argument names.
```
