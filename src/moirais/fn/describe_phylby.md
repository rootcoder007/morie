# describe('phylby') — bayesian_phylogeny
...
`print(result)` render. See `moirais.fn.describe('phylby')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.phylby import *
import numpy as np
# See the function signature in fn/phylby.py for argument names.
```
