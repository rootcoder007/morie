# describe('msm209') — mvsml_ridge_lasso_elastic_eq_9_29
...
`print(result)` render. See `moirais.fn.describe('msm209')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm209 import *
import numpy as np
# See the function signature in fn/msm209.py for argument names.
```
