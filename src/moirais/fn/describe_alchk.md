# describe('alchk') — alammar_recursive_chunking
...
`print(result)` render. See `moirais.fn.describe('alchk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alchk import *
import numpy as np
# See the function signature in fn/alchk.py for argument names.
```
