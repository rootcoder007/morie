...
`print(result)` render. See `moirais.fn.describe('kldiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kldiv import *
import numpy as np
# See the function signature in fn/kldiv.py for argument names.
```
