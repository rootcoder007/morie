...
`print(result)` render. See `moirais.fn.describe('hound')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hound import *
import numpy as np
# See the function signature in fn/hound.py for argument names.
```
