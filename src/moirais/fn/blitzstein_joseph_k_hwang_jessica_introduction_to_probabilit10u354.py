...
__all__ = ["blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_10_unnumbered_354"]
...
def blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_10_unnumbered_354(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u354')`` for the full guide.
...
def cheatsheet():
    return "blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u354: GeneralStatistics expression (auto-extracted; see ref)."
