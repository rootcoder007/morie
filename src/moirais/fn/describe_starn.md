...
`print(result)` render. See `moirais.fn.describe('starn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.starn import *
import numpy as np
# See the function signature in fn/starn.py for argument names.
```
