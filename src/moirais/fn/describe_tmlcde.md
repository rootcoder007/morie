# describe('tmlcde') — tmle_controlled_direct
...
`print(result)` render. See `moirais.fn.describe('tmlcde')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcde import *
import numpy as np
# See the function signature in fn/tmlcde.py for argument names.
```
