...
`print(result)` render. See `moirais.fn.describe('mxfsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mxfsp import *
import numpy as np
# See the function signature in fn/mxfsp.py for argument names.
```
