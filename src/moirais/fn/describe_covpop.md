# describe('covpop') — coverage_correction
...
`print(result)` render. See `moirais.fn.describe('covpop')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.covpop import *
import numpy as np
# See the function signature in fn/covpop.py for argument names.
```
