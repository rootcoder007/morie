...
`print(result)` render. See `moirais.fn.describe('markg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.markg import *
import numpy as np
# See the function signature in fn/markg.py for argument names.
```
