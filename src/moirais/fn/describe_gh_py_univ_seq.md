# describe('gh_py_univ_seq') — ghosal_py_universal_sequence
...
`print(result)` render. See `moirais.fn.describe('gh_py_univ_seq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_py_univ_seq import *
import numpy as np
# See the function signature in fn/gh_py_univ_seq.py for argument names.
```
