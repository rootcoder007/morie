...
`print(result)` render. See `moirais.fn.describe('eemd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eemd import *
import numpy as np
# See the function signature in fn/eemd.py for argument names.
```
