# describe('bkern') — bayesian_kernel_regression
...
`print(result)` render. See `moirais.fn.describe('bkern')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkern import *
import numpy as np
# See the function signature in fn/bkern.py for argument names.
```
