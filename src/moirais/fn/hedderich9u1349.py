...
__all__ = ["hedderich_chapter_9_unnumbered_1349"]


def hedderich_chapter_9_unnumbered_1349(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: + " n − parametric =" , par , " \ n " , " n − nonparametric =" , nonpar , " \ n " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1349')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1349: PowerAndDesign expression (auto-extracted; see ref)."
