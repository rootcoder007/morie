...
`print(result)` render. See `moirais.fn.describe('minkw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.minkw import *
import numpy as np
# See the function signature in fn/minkw.py for argument names.
```
