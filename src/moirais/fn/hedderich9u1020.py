...
__all__ = ["hedderich_chapter_9_unnumbered_1020"]


def hedderich_chapter_9_unnumbered_1020(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Soughtν1 = 12,ν2 = 8,α= 0.05,F = ? .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1020')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1020: GeneralStatistics expression (auto-extracted; see ref)."
