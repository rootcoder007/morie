...
`print(result)` render. See `moirais.fn.describe('vmprl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmprl import *
import numpy as np
# See the function signature in fn/vmprl.py for argument names.
```
