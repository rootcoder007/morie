...
`print(result)` render. See `moirais.fn.describe('vr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vr import *
import numpy as np
# See the function signature in fn/vr.py for argument names.
```
