# describe('stquo') — status_quo_spatial
...
`print(result)` render. See `moirais.fn.describe('stquo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stquo import *
import numpy as np
# See the function signature in fn/stquo.py for argument names.
```
