...
`print(result)` render. See `moirais.fn.describe('wvbas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvbas import *
import numpy as np
# See the function signature in fn/wvbas.py for argument names.
```
