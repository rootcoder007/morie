# describe('rgcorec') — rangayyan_correlation_coeff
...
`print(result)` render. See `moirais.fn.describe('rgcorec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcorec import *
import numpy as np
# See the function signature in fn/rgcorec.py for argument names.
```
