# describe('hmbgdg') — geron_batch_gd_grad
...
`print(result)` render. See `moirais.fn.describe('hmbgdg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmbgdg import *
import numpy as np
# See the function signature in fn/hmbgdg.py for argument names.
```
