# describe('kmsc') — kamath_self_consistency
...
`print(result)` render. See `moirais.fn.describe('kmsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kmsc import *
import numpy as np
# See the function signature in fn/kmsc.py for argument names.
```
