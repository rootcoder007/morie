...
`print(result)` render. See `moirais.fn.describe('laclihl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laclihl import *
import numpy as np
# See the function signature in fn/laclihl.py for argument names.
```
