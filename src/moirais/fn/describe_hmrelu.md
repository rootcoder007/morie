...
`print(result)` render. See `moirais.fn.describe('hmrelu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrelu import *
import numpy as np
# See the function signature in fn/hmrelu.py for argument names.
```
