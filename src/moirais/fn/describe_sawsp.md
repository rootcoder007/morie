...
`print(result)` render. See `moirais.fn.describe('sawsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sawsp import *
import numpy as np
# See the function signature in fn/sawsp.py for argument names.
```
