...
`print(result)` render. See `moirais.fn.describe('tgtrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tgtrl import *
import numpy as np
# See the function signature in fn/tgtrl.py for argument names.
```
