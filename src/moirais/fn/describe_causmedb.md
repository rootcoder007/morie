# describe('causmedb') — causal_mediation_baron_kenny
...
`print(result)` render. See `moirais.fn.describe('causmedb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmedb import *
import numpy as np
# See the function signature in fn/causmedb.py for argument names.
```
