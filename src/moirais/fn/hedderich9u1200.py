...
__all__ = ["hedderich_chapter_9_unnumbered_1200"]


def hedderich_chapter_9_unnumbered_1200(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] n1 = 56 n2 = 72 n3 = 73 n4 = 59 n5 = 62
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1200')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1200: GeneralStatistics expression (auto-extracted; see ref)."
