...
__all__ = ["hedderich_chapter_9_unnumbered_2326"]


def hedderich_chapter_9_unnumbered_2326(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > stouffer _ test ( p=c ( 0 . 0 4 , 0 . 0 7 , 0 . 1 0 ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2326')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2326: GeneralStatistics expression (auto-extracted; see ref)."
