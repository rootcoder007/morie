...
`print(result)` render. See `moirais.fn.describe('zee2s')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zee2s import *
import numpy as np
# See the function signature in fn/zee2s.py for argument names.
```
