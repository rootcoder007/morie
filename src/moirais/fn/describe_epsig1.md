...
`print(result)` render. See `moirais.fn.describe('epsig1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.epsig1 import *
import numpy as np
# See the function signature in fn/epsig1.py for argument names.
```
