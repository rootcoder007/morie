...
__all__ = ["hedderich_chapter_9_unnumbered_2923"]


def hedderich_chapter_9_unnumbered_2923(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: niπ0(1−π0)∼χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2923')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2923: CountModels expression (auto-extracted; see ref)."
