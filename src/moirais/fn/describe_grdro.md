...
`print(result)` render. See `moirais.fn.describe('grdro')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdro import *
import numpy as np
# See the function signature in fn/grdro.py for argument names.
```
