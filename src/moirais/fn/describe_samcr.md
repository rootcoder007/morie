...
`print(result)` render. See `moirais.fn.describe('samcr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.samcr import *
import numpy as np
# See the function signature in fn/samcr.py for argument names.
```
