...
`print(result)` render. See `moirais.fn.describe('rgengn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgengn import *
import numpy as np
# See the function signature in fn/rgengn.py for argument names.
```
