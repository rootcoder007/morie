...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_844"]


def guide_on_data_analysis_chapter_11_unnumbered_844(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ssc = ssc(adj = TRUE, cluster.adj = TRUE)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis11u844')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u844: GeneralStatistics expression (auto-extracted; see ref)."
