...
__all__ = ["hedderich_chapter_9_unnumbered_1160"]


def hedderich_chapter_9_unnumbered_1160(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Example: Calculate the one-sided upper 95%-confidence limit πo based on ˆp = 0 forn = 60 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1160')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1160: GeneralStatistics expression (auto-extracted; see ref)."
