# describe('hotlg') — hotelling_model
...
`print(result)` render. See `moirais.fn.describe('hotlg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hotlg import *
import numpy as np
# See the function signature in fn/hotlg.py for argument names.
```
