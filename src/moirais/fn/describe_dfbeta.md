...
`print(result)` render. See `moirais.fn.describe('dfbeta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dfbeta import *
import numpy as np
# See the function signature in fn/dfbeta.py for argument names.
```
