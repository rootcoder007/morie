# describe('sntvl') — sentence_volatility
...
`print(result)` render. See `moirais.fn.describe('sntvl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sntvl import *
import numpy as np
# See the function signature in fn/sntvl.py for argument names.
```
