# describe('hmc1d') — geron_causal_1d_conv
...
`print(result)` render. See `moirais.fn.describe('hmc1d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmc1d import *
import numpy as np
# See the function signature in fn/hmc1d.py for argument names.
```
