# describe('rgpros') — rangayyan_prosthetic_valve
...
`print(result)` render. See `moirais.fn.describe('rgpros')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpros import *
import numpy as np
# See the function signature in fn/rgpros.py for argument names.
```
