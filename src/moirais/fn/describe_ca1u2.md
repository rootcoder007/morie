# describe('ca1u2') — ca_chapter_1_unnumbered_2
...
Ŷ = β0 + β1x1 + β2x2 + ⋯ + βkxk, Equation 1 :1
...
```python
from moirais.fn.ca1u2 import ca_chapter_1_unnumbered_2
import numpy as np
result = ca_chapter_1_unnumbered_2(np.random.default_rng(42).normal(0, 1, 100))
