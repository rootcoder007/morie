# describe('notch') — notch_filter_signal
...
`print(result)` render. See `moirais.fn.describe('notch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.notch import *
import numpy as np
# See the function signature in fn/notch.py for argument names.
```
