...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_20"]


def guide_on_data_analysis_chapter_2_unnumbered_20(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 32) =√20 − (22 + 22) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u20')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u20: GeneralStatistics expression (auto-extracted; see ref)."
