...
__all__ = ["hedderich_chapter_9_unnumbered_1781"]


def hedderich_chapter_9_unnumbered_1781(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H02 : p≥p0 HA2 : p < p 0 x < x u = np0−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1781')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1781: CountModels expression (auto-extracted; see ref)."
