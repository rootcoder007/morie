...
`print(result)` render. See `moirais.fn.describe('gclus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gclus import *
import numpy as np
# See the function signature in fn/gclus.py for argument names.
```
