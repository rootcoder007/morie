...
`print(result)` render. See `moirais.fn.describe('tlatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tlatt import *
import numpy as np
# See the function signature in fn/tlatt.py for argument names.
```
