...
`print(result)` render. See `moirais.fn.describe('dtwsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtwsh import *
import numpy as np
# See the function signature in fn/dtwsh.py for argument names.
```
