# describe('gh_c14_24') — ghosal_ibp_stickbr
...
`print(result)` render. See `moirais.fn.describe('gh_c14_24')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c14_24 import *
import numpy as np
# See the function signature in fn/gh_c14_24.py for argument names.
```
