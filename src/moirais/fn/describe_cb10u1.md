# describe('cb10u1') — cb_chapter_10_unnumbered_1
...
on a simulated dataset of intelligence quotient (IQ) scores, which are normally distributed in the US population (μ = 100; SD = 15). We do this by
...
import numpy as np
result = cb_chapter_10_unnumbered_1(np.random.default_rng(42).normal(0, 1, 100))
