# describe('hrzweib') — horowitz_weibull_heterogeneity
...
`print(result)` render. See `moirais.fn.describe('hrzweib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzweib import *
import numpy as np
# See the function signature in fn/hrzweib.py for argument names.
```
