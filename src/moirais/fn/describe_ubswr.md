...
`print(result)` render. See `moirais.fn.describe('ubswr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubswr import *
import numpy as np
# See the function signature in fn/ubswr.py for argument names.
```
