...
`print(result)` render. See `moirais.fn.describe('spchst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spchst import *
import numpy as np
# See the function signature in fn/spchst.py for argument names.
```
