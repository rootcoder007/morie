# describe('wsmfis') — wasserman_fisher_info
...
`print(result)` render. See `moirais.fn.describe('wsmfis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmfis import *
import numpy as np
# See the function signature in fn/wsmfis.py for argument names.
```
