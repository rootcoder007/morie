...
__all__ = ["franz_kronthaler_statistics_applied_with_the_r_commander_dat_chapter_3_unnumbered_17"]


def franz_kronthaler_statistics_applied_with_the_r_commander_dat_chapter_3_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('franz_kronthaler_statistics_applied_with_the_r_commander_dat3u17')`` for the full guide.
...
def cheatsheet():
    return "franz_kronthaler_statistics_applied_with_the_r_commander_dat3u17: GeneralStatistics expression (auto-extracted; see ref)."
