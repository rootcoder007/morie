# describe('sctsne') — tsne_embedding
...
`print(result)` render. See `moirais.fn.describe('sctsne')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sctsne import *
import numpy as np
# See the function signature in fn/sctsne.py for argument names.
```
