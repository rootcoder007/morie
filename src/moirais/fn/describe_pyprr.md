# describe('pyprr') — pitman_yor_process
...
`print(result)` render. See `moirais.fn.describe('pyprr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pyprr import *
import numpy as np
# See the function signature in fn/pyprr.py for argument names.
```
