...
`print(result)` render. See `moirais.fn.describe('ghspt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghspt import *
import numpy as np
# See the function signature in fn/ghspt.py for argument names.
```
