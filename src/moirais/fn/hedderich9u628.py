...
__all__ = ["hedderich_chapter_9_unnumbered_628"]


def hedderich_chapter_9_unnumbered_628(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] pk(1−p)n−k = 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u628')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u628: CountModels expression (auto-extracted; see ref)."
