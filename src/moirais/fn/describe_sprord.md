...
`print(result)` render. See `moirais.fn.describe('sprord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sprord import *
import numpy as np
# See the function signature in fn/sprord.py for argument names.
```
