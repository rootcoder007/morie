...
`print(result)` render. See `moirais.fn.describe('holo_h')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_h import *
import numpy as np
# See the function signature in fn/holo_h.py for argument names.
```
