...
`print(result)` render. See `moirais.fn.describe('mptfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mptfd import *
import numpy as np
# See the function signature in fn/mptfd.py for argument names.
```
