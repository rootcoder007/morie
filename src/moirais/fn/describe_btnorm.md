# describe('btnorm') — boot_normal_ci
...
`print(result)` render. See `moirais.fn.describe('btnorm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btnorm import *
import numpy as np
# See the function signature in fn/btnorm.py for argument names.
```
