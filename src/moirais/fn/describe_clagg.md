# describe('clagg') — clagg

## WHAT IT DOES

Aggregation spatial method
...
`print(result)` render. See `moirais.fn.describe('clagg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clagg import *
import numpy as np
# See the function signature in fn/clagg.py for argument names.
```
