...
`print(result)` render. See `moirais.fn.describe('hmpas')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmpas import *
import numpy as np
# See the function signature in fn/hmpas.py for argument names.
```
