...
`print(result)` render. See `moirais.fn.describe('agimv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agimv import *
import numpy as np
# See the function signature in fn/agimv.py for argument names.
```
