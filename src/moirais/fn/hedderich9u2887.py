...
__all__ = ["hedderich_chapter_9_unnumbered_2887"]


def hedderich_chapter_9_unnumbered_2887(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |p1−p5|=|0.60−0.90|= 0.30< 0.306
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2887')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2887: GeneralStatistics expression (auto-extracted; see ref)."
