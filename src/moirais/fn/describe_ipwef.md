...
`print(result)` render. See `moirais.fn.describe('ipwef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ipwef import *
import numpy as np
# See the function signature in fn/ipwef.py for argument names.
```
