# describe('bkunit') — burkov_unit_vector
...
`print(result)` render. See `moirais.fn.describe('bkunit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkunit import *
import numpy as np
# See the function signature in fn/bkunit.py for argument names.
```
