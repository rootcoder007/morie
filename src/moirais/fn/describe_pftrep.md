# describe('pftrep') — particle_filter_epi
...
`print(result)` render. See `moirais.fn.describe('pftrep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pftrep import *
import numpy as np
# See the function signature in fn/pftrep.py for argument names.
```
