...
`print(result)` render. See `moirais.fn.describe('pdfen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pdfen import *
import numpy as np
# See the function signature in fn/pdfen.py for argument names.
```
