...
`print(result)` render. See `moirais.fn.describe('gccld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gccld import *
import numpy as np
# See the function signature in fn/gccld.py for argument names.
```
