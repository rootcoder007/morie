...
`print(result)` render. See `moirais.fn.describe('dkglb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dkglb import *
import numpy as np
# See the function signature in fn/dkglb.py for argument names.
```
