# describe('spwvd') — smoothed_pseudo_wvd_fn
...
`print(result)` render. See `moirais.fn.describe('spwvd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spwvd import *
import numpy as np
# See the function signature in fn/spwvd.py for argument names.
```
