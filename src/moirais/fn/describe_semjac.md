...
`print(result)` render. See `moirais.fn.describe('semjac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semjac import *
import numpy as np
# See the function signature in fn/semjac.py for argument names.
```
