# describe('ksr10') — kosorok_m_estimator
...
`print(result)` render. See `moirais.fn.describe('ksr10')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr10 import *
import numpy as np
# See the function signature in fn/ksr10.py for argument names.
```
