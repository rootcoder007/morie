...
`print(result)` render. See `moirais.fn.describe('ghtrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghtrd import *
import numpy as np
# See the function signature in fn/ghtrd.py for argument names.
```
