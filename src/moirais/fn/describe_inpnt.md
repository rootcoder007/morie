# describe('inpnt') — interior_point_lp
...
`print(result)` render. See `moirais.fn.describe('inpnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.inpnt import *
import numpy as np
# See the function signature in fn/inpnt.py for argument names.
```
