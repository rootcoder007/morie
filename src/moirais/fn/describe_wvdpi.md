...
`print(result)` render. See `moirais.fn.describe('wvdpi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvdpi import *
import numpy as np
# See the function signature in fn/wvdpi.py for argument names.
```
