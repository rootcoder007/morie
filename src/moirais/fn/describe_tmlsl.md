# describe('tmlsl') — tmle_super_learner
...
`print(result)` render. See `moirais.fn.describe('tmlsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsl import *
import numpy as np
# See the function signature in fn/tmlsl.py for argument names.
```
