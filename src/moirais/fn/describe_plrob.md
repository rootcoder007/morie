...
`print(result)` render. See `moirais.fn.describe('plrob')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plrob import *
import numpy as np
# See the function signature in fn/plrob.py for argument names.
```
