...
`print(result)` render. See `moirais.fn.describe('emtxt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emtxt import *
import numpy as np
# See the function signature in fn/emtxt.py for argument names.
```
