# describe('zsrgf') — random_gauss_field
...
`print(result)` render. See `moirais.fn.describe('zsrgf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsrgf import *
import numpy as np
# See the function signature in fn/zsrgf.py for argument names.
```
