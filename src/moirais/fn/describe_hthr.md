...
`print(result)` render. See `moirais.fn.describe('hthr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hthr import *
import numpy as np
# See the function signature in fn/hthr.py for argument names.
```
