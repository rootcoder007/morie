# describe('forwsr') — forward_search
...
`print(result)` render. See `moirais.fn.describe('forwsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.forwsr import *
import numpy as np
# See the function signature in fn/forwsr.py for argument names.
```
