# describe('rgentrwv') — rangayyan_wavelet_entropy
...
`print(result)` render. See `moirais.fn.describe('rgentrwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgentrwv import *
import numpy as np
# See the function signature in fn/rgentrwv.py for argument names.
```
