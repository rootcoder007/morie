# describe('btsbb') — boot_stationary_block
...
`print(result)` render. See `moirais.fn.describe('btsbb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsbb import *
import numpy as np
# See the function signature in fn/btsbb.py for argument names.
```
