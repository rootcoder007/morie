# describe('tqpol') — turboquant_polar_transform
...
`print(result)` render. See `moirais.fn.describe('tqpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqpol import *
import numpy as np
# See the function signature in fn/tqpol.py for argument names.
```
