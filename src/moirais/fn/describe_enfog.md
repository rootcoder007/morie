...
`print(result)` render. See `moirais.fn.describe('enfog')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enfog import *
import numpy as np
# See the function signature in fn/enfog.py for argument names.
```
