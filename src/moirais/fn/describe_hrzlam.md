# describe('hrzlam') — horowitz_baseline_hazard_est
...
`print(result)` render. See `moirais.fn.describe('hrzlam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzlam import *
import numpy as np
# See the function signature in fn/hrzlam.py for argument names.
```
