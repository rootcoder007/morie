...
`print(result)` render. See `moirais.fn.describe('dtcpt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpt import *
import numpy as np
# See the function signature in fn/dtcpt.py for argument names.
```
