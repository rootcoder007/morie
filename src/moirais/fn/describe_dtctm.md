...
`print(result)` render. See `moirais.fn.describe('dtctm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtctm import *
import numpy as np
# See the function signature in fn/dtctm.py for argument names.
```
