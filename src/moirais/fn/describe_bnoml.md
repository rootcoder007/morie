# describe('bnoml') — bayesian_binomial
...
`print(result)` render. See `moirais.fn.describe('bnoml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnoml import *
import numpy as np
# See the function signature in fn/bnoml.py for argument names.
```
