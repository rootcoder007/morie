...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_92(x):
    """
    CentralTendency equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner6e92')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e92: CentralTendency equation extracted from David J. Morin - Probability  For the Enthusiastic Beginner."
