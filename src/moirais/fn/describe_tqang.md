# describe('tqang') — turboquant_angle_quantization
...
`print(result)` render. See `moirais.fn.describe('tqang')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqang import *
import numpy as np
# See the function signature in fn/tqang.py for argument names.
```
