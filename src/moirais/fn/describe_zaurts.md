# describe('zaurts') — zivot_andrews_unit_root
...
`print(result)` render. See `moirais.fn.describe('zaurts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zaurts import *
import numpy as np
# See the function signature in fn/zaurts.py for argument names.
```
