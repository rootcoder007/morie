...
__all__ = ["hedderich_chapter_9_unnumbered_671"]


def hedderich_chapter_9_unnumbered_671(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Fig. 5.11: Multinomial distribution fork=3 (two-dimensional) andn=4 withpA=0.4,pB=0.3
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u671')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u671: GeneralStatistics expression (auto-extracted; see ref)."
