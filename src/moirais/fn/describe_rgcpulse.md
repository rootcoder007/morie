# describe('rgcpulse') — rangayyan_carotid_pulse
...
`print(result)` render. See `moirais.fn.describe('rgcpulse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcpulse import *
import numpy as np
# See the function signature in fn/rgcpulse.py for argument names.
```
