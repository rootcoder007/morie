...
`print(result)` render. See `moirais.fn.describe('gf2iv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gf2iv import *
import numpy as np
# See the function signature in fn/gf2iv.py for argument names.
```
