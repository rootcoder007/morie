...
`print(result)` render. See `moirais.fn.describe('tcrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tcrv import *
import numpy as np
# See the function signature in fn/tcrv.py for argument names.
```
