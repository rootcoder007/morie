# describe('sgtmix') — sgt_mixing_time
...
`print(result)` render. See `moirais.fn.describe('sgtmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtmix import *
import numpy as np
# See the function signature in fn/sgtmix.py for argument names.
```
