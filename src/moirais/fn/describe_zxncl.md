# describe('zxncl') — network_cluster_sp
...
`print(result)` render. See `moirais.fn.describe('zxncl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxncl import *
import numpy as np
# See the function signature in fn/zxncl.py for argument names.
```
