...
`print(result)` render. See `moirais.fn.describe('sfeig')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfeig import *
import numpy as np
# See the function signature in fn/sfeig.py for argument names.
```
