# describe('nmala') — alpha_nom_accept
...
`print(result)` render. See `moirais.fn.describe('nmala')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmala import *
import numpy as np
# See the function signature in fn/nmala.py for argument names.
```
