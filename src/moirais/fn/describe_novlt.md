...
`print(result)` render. See `moirais.fn.describe('novlt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.novlt import *
import numpy as np
# See the function signature in fn/novlt.py for argument names.
```
