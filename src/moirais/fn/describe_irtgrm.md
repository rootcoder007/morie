# describe('irtgrm') — graded_response
...
`print(result)` render. See `moirais.fn.describe('irtgrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtgrm import *
import numpy as np
# See the function signature in fn/irtgrm.py for argument names.
```
