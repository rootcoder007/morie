# describe('slowdp') — slow_dp_truncate
...
`print(result)` render. See `moirais.fn.describe('slowdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slowdp import *
import numpy as np
# See the function signature in fn/slowdp.py for argument names.
```
