...
__all__ = ["bivand2013_chapter_7_unnumbered_282"]


def bivand2013_chapter_7_unnumbered_282(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] rT =[ O1/O+,...,O n/O+]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u282')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u282: GeneralStatistics expression (auto-extracted; see ref)."
