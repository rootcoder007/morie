...
`print(result)` render. See `moirais.fn.describe('umkkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umkkt import *
import numpy as np
# See the function signature in fn/umkkt.py for argument names.
```
