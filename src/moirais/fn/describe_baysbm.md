# describe('baysbm') — bayes_b_marker
...
`print(result)` render. See `moirais.fn.describe('baysbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.baysbm import *
import numpy as np
# See the function signature in fn/baysbm.py for argument names.
```
