...
`print(result)` render. See `moirais.fn.describe('mtktz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtktz import *
import numpy as np
# See the function signature in fn/mtktz.py for argument names.
```
