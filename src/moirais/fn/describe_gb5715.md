# describe('gb5715') — gibbons_wsrt_ci
...
`print(result)` render. See `moirais.fn.describe('gb5715')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5715 import *
import numpy as np
# See the function signature in fn/gb5715.py for argument names.
```
