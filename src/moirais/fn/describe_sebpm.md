...
`print(result)` render. See `moirais.fn.describe('sebpm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sebpm import *
import numpy as np
# See the function signature in fn/sebpm.py for argument names.
```
