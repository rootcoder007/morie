# describe('maacst') — maacst

## WHAT IT DOES

Acoustic survey spatial
...
`print(result)` render. See `moirais.fn.describe('maacst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.maacst import *
import numpy as np
# See the function signature in fn/maacst.py for argument names.
```
