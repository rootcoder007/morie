# describe('hrzs1') — horowitz_sample_selection
...
`print(result)` render. See `moirais.fn.describe('hrzs1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzs1 import *
import numpy as np
# See the function signature in fn/hrzs1.py for argument names.
```
