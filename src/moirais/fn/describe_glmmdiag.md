...
`print(result)` render. See `moirais.fn.describe('glmmdiag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glmmdiag import *
import numpy as np
# See the function signature in fn/glmmdiag.py for argument names.
```
