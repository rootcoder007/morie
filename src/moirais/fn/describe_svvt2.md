...
`print(result)` render. See `moirais.fn.describe('svvt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svvt2 import *
import numpy as np
# See the function signature in fn/svvt2.py for argument names.
```
