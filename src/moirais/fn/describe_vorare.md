...
`print(result)` render. See `moirais.fn.describe('vorare')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vorare import *
import numpy as np
# See the function signature in fn/vorare.py for argument names.
```
