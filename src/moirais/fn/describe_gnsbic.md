...
`print(result)` render. See `moirais.fn.describe('gnsbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gnsbic import *
import numpy as np
# See the function signature in fn/gnsbic.py for argument names.
```
