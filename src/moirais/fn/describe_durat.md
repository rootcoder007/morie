...
`print(result)` render. See `moirais.fn.describe('durat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.durat import *
import numpy as np
# See the function signature in fn/durat.py for argument names.
```
