# describe('svbnz') — banzhaf_spatial
...
`print(result)` render. See `moirais.fn.describe('svbnz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svbnz import *
import numpy as np
# See the function signature in fn/svbnz.py for argument names.
```
