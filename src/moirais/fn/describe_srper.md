...
`print(result)` render. See `moirais.fn.describe('srper')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srper import *
import numpy as np
# See the function signature in fn/srper.py for argument names.
```
