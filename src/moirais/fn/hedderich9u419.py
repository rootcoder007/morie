...
__all__ = ["hedderich_chapter_9_unnumbered_419"]


def hedderich_chapter_9_unnumbered_419(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] δ >0, then also ψ >1 and ω >1 (4.26)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u419')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u419: GeneralStatistics expression (auto-extracted; see ref)."
