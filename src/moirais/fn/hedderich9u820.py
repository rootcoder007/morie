...
__all__ = ["hedderich_chapter_9_unnumbered_820"]


def hedderich_chapter_9_unnumbered_820(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (−2Z̄≤+2) = 0 .95450
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u820')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u820: GeneralStatistics expression (auto-extracted; see ref)."
