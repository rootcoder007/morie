...
`print(result)` render. See `moirais.fn.describe('emdfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.emdfn import *
import numpy as np
# See the function signature in fn/emdfn.py for argument names.
```
