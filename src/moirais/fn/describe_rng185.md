# describe('rng185') — rangayyan_ch4_pan_tompkins_highpass_transfer
...
`print(result)` render. See `moirais.fn.describe('rng185')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng185 import *
import numpy as np
# See the function signature in fn/rng185.py for argument names.
```
