# describe('rng161') — rangayyan_ch3_lms_variable_step
...
`print(result)` render. See `moirais.fn.describe('rng161')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng161 import *
import numpy as np
# See the function signature in fn/rng161.py for argument names.
```
