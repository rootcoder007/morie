# describe('sgipp') — inhomogeneous_poisson
...
`print(result)` render. See `moirais.fn.describe('sgipp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgipp import *
import numpy as np
# See the function signature in fn/sgipp.py for argument names.
```
