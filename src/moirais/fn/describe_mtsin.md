# describe('mtsin') — mtsin

## WHAT IT DOES

Sinuosity index movement
...
`print(result)` render. See `moirais.fn.describe('mtsin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtsin import *
import numpy as np
# See the function signature in fn/mtsin.py for argument names.
```
