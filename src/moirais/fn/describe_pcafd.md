...
`print(result)` render. See `moirais.fn.describe('pcafd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcafd import *
import numpy as np
# See the function signature in fn/pcafd.py for argument names.
```
