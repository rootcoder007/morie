...
__all__ = ["wilcox_chapter_13_unnumbered_1356"]


def wilcox_chapter_13_unnumbered_1356(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: The p-values for H0:β 1 = 0 and H0:β 2 = 0 are 0.009 and 0.013, respectively. So in contrast
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1356')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1356: GeneralStatistics expression (auto-extracted; see ref)."
