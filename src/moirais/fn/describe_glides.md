# describe('glides') — glide_score_proxy
...
`print(result)` render. See `moirais.fn.describe('glides')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glides import *
import numpy as np
# See the function signature in fn/glides.py for argument names.
```
