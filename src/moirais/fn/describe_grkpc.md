# describe('grkpc') — geron_kernel_pca_rbf
...
`print(result)` render. See `moirais.fn.describe('grkpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grkpc import *
import numpy as np
# See the function signature in fn/grkpc.py for argument names.
```
