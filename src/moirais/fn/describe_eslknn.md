...
`print(result)` render. See `moirais.fn.describe('eslknn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslknn import *
import numpy as np
# See the function signature in fn/eslknn.py for argument names.
```
