...
`print(result)` render. See `moirais.fn.describe('dtcpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpc import *
import numpy as np
# See the function signature in fn/dtcpc.py for argument names.
```
