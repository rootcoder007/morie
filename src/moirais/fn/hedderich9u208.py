...
__all__ = ["hedderich_chapter_9_unnumbered_208"]


def hedderich_chapter_9_unnumbered_208(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Vr[%] = s/¯x√n 100 for all x> 0 and s
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u208')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u208: GeneralStatistics expression (auto-extracted; see ref)."
