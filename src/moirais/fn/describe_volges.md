# describe('volges') — vol_garch_es_impl
...
`print(result)` render. See `moirais.fn.describe('volges')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volges import *
import numpy as np
# See the function signature in fn/volges.py for argument names.
```
