...
`print(result)` render. See `moirais.fn.describe('hyord')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyord import *
import numpy as np
# See the function signature in fn/hyord.py for argument names.
```
