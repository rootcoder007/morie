...
`print(result)` render. See `moirais.fn.describe('jackone')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jackone import *
import numpy as np
# See the function signature in fn/jackone.py for argument names.
```
