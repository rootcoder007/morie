...
`print(result)` render. See `moirais.fn.describe('zxvms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxvms import *
import numpy as np
# See the function signature in fn/zxvms.py for argument names.
```
