...
`print(result)` render. See `moirais.fn.describe('cvgen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvgen import *
import numpy as np
# See the function signature in fn/cvgen.py for argument names.
```
