# describe('newraf') — newton_raphson
...
`print(result)` render. See `moirais.fn.describe('newraf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.newraf import *
import numpy as np
# See the function signature in fn/newraf.py for argument names.
```
