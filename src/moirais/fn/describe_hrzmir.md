# describe('hrzmir') — horowitz_marginal_integration
...
`print(result)` render. See `moirais.fn.describe('hrzmir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzmir import *
import numpy as np
# See the function signature in fn/hrzmir.py for argument names.
```
