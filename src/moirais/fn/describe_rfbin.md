...
`print(result)` render. See `moirais.fn.describe('rfbin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfbin import *
import numpy as np
# See the function signature in fn/rfbin.py for argument names.
```
