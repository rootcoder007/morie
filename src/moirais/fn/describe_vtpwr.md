# describe('vtpwr') — voting_power_index
...
`print(result)` render. See `moirais.fn.describe('vtpwr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtpwr import *
import numpy as np
# See the function signature in fn/vtpwr.py for argument names.
```
