# describe('pinsk1') — pinsker_inequality
...
`print(result)` render. See `moirais.fn.describe('pinsk1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pinsk1 import *
import numpy as np
# See the function signature in fn/pinsk1.py for argument names.
```
