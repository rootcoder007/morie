# describe('mhcom') — comorbidity_index
...
`print(result)` render. See `moirais.fn.describe('mhcom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mhcom import *
import numpy as np
# See the function signature in fn/mhcom.py for argument names.
```
