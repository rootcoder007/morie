# describe('schur') — schur_decompose
...
`print(result)` render. See `moirais.fn.describe('schur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.schur import *
import numpy as np
# See the function signature in fn/schur.py for argument names.
```
