# describe('cvxlif') — boyd_linf_fitting
...
`print(result)` render. See `moirais.fn.describe('cvxlif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxlif import *
import numpy as np
# See the function signature in fn/cvxlif.py for argument names.
```
