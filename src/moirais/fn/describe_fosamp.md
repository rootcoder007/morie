...
`print(result)` render. See `moirais.fn.describe('fosamp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fosamp import *
import numpy as np
# See the function signature in fn/fosamp.py for argument names.
```
