# describe('hmstz') — geron_standardization
...
`print(result)` render. See `moirais.fn.describe('hmstz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmstz import *
import numpy as np
# See the function signature in fn/hmstz.py for argument names.
```
