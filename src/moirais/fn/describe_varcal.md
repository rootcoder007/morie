# describe('varcal') — variant_calling
...
`print(result)` render. See `moirais.fn.describe('varcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varcal import *
import numpy as np
# See the function signature in fn/varcal.py for argument names.
```
