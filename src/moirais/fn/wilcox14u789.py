...
__all__ = ["wilcox_chapter_14_unnumbered_789"]


def wilcox_chapter_14_unnumbered_789(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ν 1 =J − 1 and ν 2 =N − JK degrees of freedom.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u789')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u789: GeneralStatistics expression (auto-extracted; see ref)."
