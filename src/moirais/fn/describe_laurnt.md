# describe('laurnt') — laurent_series
...
`print(result)` render. See `moirais.fn.describe('laurnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.laurnt import *
import numpy as np
# See the function signature in fn/laurnt.py for argument names.
```
