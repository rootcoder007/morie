...
__all__ = ["hedderich_chapter_9_unnumbered_2276"]


def hedderich_chapter_9_unnumbered_2276(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: orb, are given by Westlake [Wes71]: 4 for 10≤n1=n2≤15 and 5 forn1=n2≥16 (α=0.05) as
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2276')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2276: GeneralStatistics expression (auto-extracted; see ref)."
