...
__all__ = ["bivand2013_chapter_2_unnumbered_69"]


def bivand2013_chapter_2_unnumbered_69(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + threshold = 1000L, convergence = 5L, memory = 300L)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u69')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u69: GeneralStatistics expression (auto-extracted; see ref)."
