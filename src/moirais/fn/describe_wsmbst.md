# describe('wsmbst') — wasserman_boosting

## WHAT IT DOES

Boosting (AdaBoost weights).
...
`print(result)` render. See `moirais.fn.describe('wsmbst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmbst import *
import numpy as np
# See the function signature in fn/wsmbst.py for argument names.
```
