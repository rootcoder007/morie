...
`print(result)` render. See `moirais.fn.describe('hmtanh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmtanh import *
import numpy as np
# See the function signature in fn/hmtanh.py for argument names.
```
