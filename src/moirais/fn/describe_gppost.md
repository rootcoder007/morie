...
`print(result)` render. See `moirais.fn.describe('gppost')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gppost import *
import numpy as np
# See the function signature in fn/gppost.py for argument names.
```
