...
`print(result)` render. See `moirais.fn.describe('knear')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.knear import *
import numpy as np
# See the function signature in fn/knear.py for argument names.
```
