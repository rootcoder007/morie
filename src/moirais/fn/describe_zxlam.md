...
`print(result)` render. See `moirais.fn.describe('zxlam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxlam import *
import numpy as np
# See the function signature in fn/zxlam.py for argument names.
```
