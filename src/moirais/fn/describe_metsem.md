# describe('metsem') — metagenome_assembly
...
`print(result)` render. See `moirais.fn.describe('metsem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.metsem import *
import numpy as np
# See the function signature in fn/metsem.py for argument names.
```
