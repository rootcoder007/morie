...
`print(result)` render. See `moirais.fn.describe('clelb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clelb import *
import numpy as np
# See the function signature in fn/clelb.py for argument names.
```
