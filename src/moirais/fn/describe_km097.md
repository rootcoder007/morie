# describe('km097') — kamath_ch6_ear_entropy_reg
...
`print(result)` render. See `moirais.fn.describe('km097')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km097 import *
import numpy as np
# See the function signature in fn/km097.py for argument names.
```
