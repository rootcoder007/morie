...
__all__ = ["wilcox_chapter_5_unnumbered_405"]


def wilcox_chapter_5_unnumbered_405(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: r1 =Y1 − ˆY1 = 170 + 26.3 = 196.3. Table 6.2 summarizes the ˆY values and residuals for the
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox5u405')`` for the full guide.
...
def cheatsheet():
    return "wilcox5u405: GeneralStatistics expression (auto-extracted; see ref)."
