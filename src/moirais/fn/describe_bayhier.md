# describe('bayhier') — hierarchical_pooling
...
`print(result)` render. See `moirais.fn.describe('bayhier')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayhier import *
import numpy as np
# See the function signature in fn/bayhier.py for argument names.
```
