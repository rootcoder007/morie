...
__all__ = ["treatment_effects_1_chapter_1_unnumbered_47"]


def treatment_effects_1_chapter_1_unnumbered_47(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] E[Yi|W1i = 1]− E[Yi|W0i = 1]
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('treatment_effects_11u47')`` for the full guide.
...
def cheatsheet():
    return "treatment_effects_11u47: GeneralStatistics expression (auto-extracted; see ref)."
