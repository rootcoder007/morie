# describe('deja') — detect_duplicates
...
`print(result)` render. See `moirais.fn.describe('deja')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deja import *
import numpy as np
# See the function signature in fn/deja.py for argument names.
```
