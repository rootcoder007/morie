...
`print(result)` render. See `moirais.fn.describe('cmstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmstr import *
import numpy as np
# See the function signature in fn/cmstr.py for argument names.
```
