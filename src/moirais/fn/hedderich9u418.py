...
__all__ = ["hedderich_chapter_9_unnumbered_418"]


def hedderich_chapter_9_unnumbered_418(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Delta: δ=P (K|R)−P (K|¯R) as attributable risk. (4.23)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u418')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u418: GeneralStatistics expression (auto-extracted; see ref)."
