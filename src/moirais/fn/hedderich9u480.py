...
__all__ = ["hedderich_chapter_9_unnumbered_480"]


def hedderich_chapter_9_unnumbered_480(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.072 = 0.833 = 1−P (F|K)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u480')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u480: GeneralStatistics expression (auto-extracted; see ref)."
