# describe('alfcnf') — alphafold_confidence
...
`print(result)` render. See `moirais.fn.describe('alfcnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alfcnf import *
import numpy as np
# See the function signature in fn/alfcnf.py for argument names.
```
