# describe('diffmed') — difference_in_coefficients
...
`print(result)` render. See `moirais.fn.describe('diffmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.diffmed import *
import numpy as np
# See the function signature in fn/diffmed.py for argument names.
```
