...
`print(result)` render. See `moirais.fn.describe('smpsl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpsl import *
import numpy as np
# See the function signature in fn/smpsl.py for argument names.
```
