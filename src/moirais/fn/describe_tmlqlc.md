# describe('tmlqlc') — tmle_qlearning
...
`print(result)` render. See `moirais.fn.describe('tmlqlc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlqlc import *
import numpy as np
# See the function signature in fn/tmlqlc.py for argument names.
```
