# describe('aitjsd') — compositional_jsd
...
`print(result)` render. See `moirais.fn.describe('aitjsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitjsd import *
import numpy as np
# See the function signature in fn/aitjsd.py for argument names.
```
