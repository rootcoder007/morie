# describe('rgminph') — rangayyan_min_phase
...
`print(result)` render. See `moirais.fn.describe('rgminph')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgminph import *
import numpy as np
# See the function signature in fn/rgminph.py for argument names.
```
