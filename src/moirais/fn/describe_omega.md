...
`print(result)` render. See `moirais.fn.describe('omega')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.omega import *
import numpy as np
# See the function signature in fn/omega.py for argument names.
```
