...
`print(result)` render. See `moirais.fn.describe('idft')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.idft import *
import numpy as np
# See the function signature in fn/idft.py for argument names.
```
