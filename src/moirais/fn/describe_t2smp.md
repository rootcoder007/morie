# describe('t2smp') — two_sample_t_test
...
`print(result)` render. See `moirais.fn.describe('t2smp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.t2smp import *
import numpy as np
# See the function signature in fn/t2smp.py for argument names.
```
