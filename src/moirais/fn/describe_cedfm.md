...
`print(result)` render. See `moirais.fn.describe('cedfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cedfm import *
import numpy as np
# See the function signature in fn/cedfm.py for argument names.
```
