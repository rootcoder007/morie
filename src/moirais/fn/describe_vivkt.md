# describe('vivkt') — vansteelandt_vanderweele
...
`print(result)` render. See `moirais.fn.describe('vivkt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vivkt import *
import numpy as np
# See the function signature in fn/vivkt.py for argument names.
```
