...
__all__ = ["hedderich_chapter_9_unnumbered_1573"]


def hedderich_chapter_9_unnumbered_1573(x):
    """
    Bayesian expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( dens [ i ] == dens [ j ] ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1573')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1573: Bayesian expression (auto-extracted; see ref)."
