# describe('vtest') — validity_test_retest
...
`print(result)` render. See `moirais.fn.describe('vtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vtest import *
import numpy as np
# See the function signature in fn/vtest.py for argument names.
```
