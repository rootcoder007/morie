...
__all__ = ["wilcox_chapter_13_unnumbered_1370"]


def wilcox_chapter_13_unnumbered_1370(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 4. 0.87. 6. b1 = −0.0355, b0 = 39.93. 7. b1 = .0039, b0 = 0.485. 9. b1 = 0.0754, b0 =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1370')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1370: GeneralStatistics expression (auto-extracted; see ref)."
