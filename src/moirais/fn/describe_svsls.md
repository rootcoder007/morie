...
`print(result)` render. See `moirais.fn.describe('svsls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svsls import *
import numpy as np
# See the function signature in fn/svsls.py for argument names.
```
