# describe('rng208') — rangayyan_ch4_matched_filter_output_inverse_ft
...
`print(result)` render. See `moirais.fn.describe('rng208')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng208 import *
import numpy as np
# See the function signature in fn/rng208.py for argument names.
```
