# describe('netbtw') — betweenness_centrality
...
`print(result)` render. See `moirais.fn.describe('netbtw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netbtw import *
import numpy as np
# See the function signature in fn/netbtw.py for argument names.
```
