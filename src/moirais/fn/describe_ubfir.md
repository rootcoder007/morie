...
`print(result)` render. See `moirais.fn.describe('ubfir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubfir import *
import numpy as np
# See the function signature in fn/ubfir.py for argument names.
```
