# describe('rosenb') — rosenbaum_bounds
...
`print(result)` render. See `moirais.fn.describe('rosenb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rosenb import *
import numpy as np
# See the function signature in fn/rosenb.py for argument names.
```
