# describe('ksr029') — kosorok_ch2_glivenko_cantelli_class
...
`print(result)` render. See `moirais.fn.describe('ksr029')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr029 import *
import numpy as np
# See the function signature in fn/ksr029.py for argument names.
```
