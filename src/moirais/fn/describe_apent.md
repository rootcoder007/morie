# describe('apent') — approximate_entropy
...
`print(result)` render. See `moirais.fn.describe('apent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.apent import *
import numpy as np
# See the function signature in fn/apent.py for argument names.
```
