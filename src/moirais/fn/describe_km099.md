# describe('km099') — kamath_ch6_emt_metric
...
`print(result)` render. See `moirais.fn.describe('km099')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km099 import *
import numpy as np
# See the function signature in fn/km099.py for argument names.
```
