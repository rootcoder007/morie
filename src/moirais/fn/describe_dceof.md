# describe('dceof') — dice_coefficient
...
`print(result)` render. See `moirais.fn.describe('dceof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dceof import *
import numpy as np
# See the function signature in fn/dceof.py for argument names.
```
