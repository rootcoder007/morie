...
`print(result)` render. See `moirais.fn.describe('adwin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adwin import *
import numpy as np
# See the function signature in fn/adwin.py for argument names.
```
