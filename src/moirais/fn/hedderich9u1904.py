...
__all__ = ["hedderich_chapter_9_unnumbered_1904"]


def hedderich_chapter_9_unnumbered_1904(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] (1−β) = P (X≤kc|n·λA) (7.73)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1904')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1904: PowerAndDesign expression (auto-extracted; see ref)."
