...
__all__ = ["hedderich_chapter_9_unnumbered_2952"]


def hedderich_chapter_9_unnumbered_2952(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] Y Y = 1 Y = 2 . . . Y = j . . . Y = c Sum
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2952')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2952: ContingencyTables expression (auto-extracted; see ref)."
