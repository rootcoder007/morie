# describe('rng012') — rangayyan_ch3_signal_plus_noise_model
...
`print(result)` render. See `moirais.fn.describe('rng012')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng012 import *
import numpy as np
# See the function signature in fn/rng012.py for argument names.
```
