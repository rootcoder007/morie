# describe('hrzmim') — horowitz_multiple_index_model
...
`print(result)` render. See `moirais.fn.describe('hrzmim')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzmim import *
import numpy as np
# See the function signature in fn/hrzmim.py for argument names.
```
