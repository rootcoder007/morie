# describe('sdcdis') — spatial_data_distortion
...
`print(result)` render. See `moirais.fn.describe('sdcdis')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdcdis import *
import numpy as np
# See the function signature in fn/sdcdis.py for argument names.
```
