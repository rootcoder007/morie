# describe('shfrm') — shared_frailty_marginal
...
`print(result)` render. See `moirais.fn.describe('shfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shfrm import *
import numpy as np
# See the function signature in fn/shfrm.py for argument names.
```
