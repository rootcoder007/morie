# describe('msm147') — mvsml_categorical_count_eq_8_11
...
`print(result)` render. See `moirais.fn.describe('msm147')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm147 import *
import numpy as np
# See the function signature in fn/msm147.py for argument names.
```
