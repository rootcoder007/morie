...
`print(result)` render. See `moirais.fn.describe('dicon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dicon import *
import numpy as np
# See the function signature in fn/dicon.py for argument names.
```
