...
`print(result)` render. See `moirais.fn.describe('rweib')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rweib import *
import numpy as np
# See the function signature in fn/rweib.py for argument names.
```
