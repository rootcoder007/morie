...
`print(result)` render. See `moirais.fn.describe('rdanl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rdanl import *
import numpy as np
# See the function signature in fn/rdanl.py for argument names.
```
