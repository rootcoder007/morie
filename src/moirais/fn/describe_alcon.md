# describe('alcon') — algorithm_convergence
...
`print(result)` render. See `moirais.fn.describe('alcon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alcon import *
import numpy as np
# See the function signature in fn/alcon.py for argument names.
```
