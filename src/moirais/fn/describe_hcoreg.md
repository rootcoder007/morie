# describe('hcoreg') — hardcore_process
...
`print(result)` render. See `moirais.fn.describe('hcoreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hcoreg import *
import numpy as np
# See the function signature in fn/hcoreg.py for argument names.
```
