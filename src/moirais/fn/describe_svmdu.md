...
`print(result)` render. See `moirais.fn.describe('svmdu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmdu import *
import numpy as np
# See the function signature in fn/svmdu.py for argument names.
```
