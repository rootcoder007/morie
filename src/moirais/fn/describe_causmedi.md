# describe('causmedi') — causal_mediation_imai
...
`print(result)` render. See `moirais.fn.describe('causmedi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causmedi import *
import numpy as np
# See the function signature in fn/causmedi.py for argument names.
```
