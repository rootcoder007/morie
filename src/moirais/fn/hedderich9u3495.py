...
__all__ = ["hedderich_chapter_9_unnumbered_3495"]


def hedderich_chapter_9_unnumbered_3495(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: yi = Xi·β + Zi·bi + ϵi
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3495')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3495: GeneralStatistics expression (auto-extracted; see ref)."
