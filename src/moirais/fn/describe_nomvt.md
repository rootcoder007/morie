# describe('nomvt') — nominate_vote_prob_fn
...
`print(result)` render. See `moirais.fn.describe('nomvt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nomvt import *
import numpy as np
# See the function signature in fn/nomvt.py for argument names.
```
