...
`print(result)` render. See `moirais.fn.describe('clgmx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clgmx import *
import numpy as np
# See the function signature in fn/clgmx.py for argument names.
```
