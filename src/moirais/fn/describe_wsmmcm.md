# describe('wsmmcm') — wasserman_mcmc_metropolis
...
`print(result)` render. See `moirais.fn.describe('wsmmcm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmcm import *
import numpy as np
# See the function signature in fn/wsmmcm.py for argument names.
```
