...
`print(result)` render. See `moirais.fn.describe('plam')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plam import *
import numpy as np
# See the function signature in fn/plam.py for argument names.
```
