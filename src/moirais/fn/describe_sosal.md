...
`print(result)` render. See `moirais.fn.describe('sosal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosal import *
import numpy as np
# See the function signature in fn/sosal.py for argument names.
```
