...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_101"]


def guide_on_data_analysis_chapter_2_unnumbered_101(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: str_remove(names, pattern = ", [[:print:]]+" )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis2u101')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u101: GeneralStatistics expression (auto-extracted; see ref)."
