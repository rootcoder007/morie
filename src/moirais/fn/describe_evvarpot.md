...
`print(result)` render. See `moirais.fn.describe('evvarpot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.evvarpot import *
import numpy as np
# See the function signature in fn/evvarpot.py for argument names.
```
