# describe('rng032') — rangayyan_ch3_causal_convolution
...
`print(result)` render. See `moirais.fn.describe('rng032')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng032 import *
import numpy as np
# See the function signature in fn/rng032.py for argument names.
```
