# describe('ecgplt') — plot_ecg_leads_fn
...
`print(result)` render. See `moirais.fn.describe('ecgplt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecgplt import *
import numpy as np
# See the function signature in fn/ecgplt.py for argument names.
```
