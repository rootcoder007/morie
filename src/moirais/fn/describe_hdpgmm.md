# describe('hdpgmm') — hdp_gaussian_mixture
...
`print(result)` render. See `moirais.fn.describe('hdpgmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdpgmm import *
import numpy as np
# See the function signature in fn/hdpgmm.py for argument names.
```
