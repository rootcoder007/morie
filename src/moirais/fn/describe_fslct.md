# describe('fslct') — feature_select_variance
...
`print(result)` render. See `moirais.fn.describe('fslct')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fslct import *
import numpy as np
# See the function signature in fn/fslct.py for argument names.
```
