# describe('grsae') — geron_sparse_autoencoder
...
`print(result)` render. See `moirais.fn.describe('grsae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grsae import *
import numpy as np
# See the function signature in fn/grsae.py for argument names.
```
