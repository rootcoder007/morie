# describe('msm140') — mvsml_categorical_count_eq_8_8
...
`print(result)` render. See `moirais.fn.describe('msm140')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm140 import *
import numpy as np
# See the function signature in fn/msm140.py for argument names.
```
