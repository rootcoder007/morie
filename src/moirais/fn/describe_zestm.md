...
`print(result)` render. See `moirais.fn.describe('zestm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zestm import *
import numpy as np
# See the function signature in fn/zestm.py for argument names.
```
