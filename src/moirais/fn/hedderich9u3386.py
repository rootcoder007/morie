...
__all__ = ["hedderich_chapter_9_unnumbered_3386"]


def hedderich_chapter_9_unnumbered_3386(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > new . d <− data . frame ( Age= c ( 1 2 , 2 4 , 6 0 ) , Number= c ( 2 , 4 , 6 ) , Start = c ( 1 5 , 10 , 5 ) )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3386')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3386: GeneralStatistics expression (auto-extracted; see ref)."
