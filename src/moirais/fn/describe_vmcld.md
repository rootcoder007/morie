...
`print(result)` render. See `moirais.fn.describe('vmcld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmcld import *
import numpy as np
# See the function signature in fn/vmcld.py for argument names.
```
