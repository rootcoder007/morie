...
`print(result)` render. See `moirais.fn.describe('swqueen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.swqueen import *
import numpy as np
# See the function signature in fn/swqueen.py for argument names.
```
