...
`print(result)` render. See `moirais.fn.describe('prsv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prsv import *
import numpy as np
# See the function signature in fn/prsv.py for argument names.
```
