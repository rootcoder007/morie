# describe('prratio') — prevalence_ratio
...
`print(result)` render. See `moirais.fn.describe('prratio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prratio import *
import numpy as np
# See the function signature in fn/prratio.py for argument names.
```
