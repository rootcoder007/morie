# describe('reffec') — effective_reproduction
...
`print(result)` render. See `moirais.fn.describe('reffec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reffec import *
import numpy as np
# See the function signature in fn/reffec.py for argument names.
```
