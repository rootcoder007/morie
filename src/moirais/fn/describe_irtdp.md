...
`print(result)` render. See `moirais.fn.describe('irtdp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtdp import *
import numpy as np
# See the function signature in fn/irtdp.py for argument names.
```
