...
`print(result)` render. See `moirais.fn.describe('gcprc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcprc import *
import numpy as np
# See the function signature in fn/gcprc.py for argument names.
```
