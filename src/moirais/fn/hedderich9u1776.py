...
__all__ = ["hedderich_chapter_9_unnumbered_1776"]


def hedderich_chapter_9_unnumbered_1776(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1776')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1776: GeneralStatistics expression (auto-extracted; see ref)."
