# describe('causipw') — causal_ipw_truncated
...
`print(result)` render. See `moirais.fn.describe('causipw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causipw import *
import numpy as np
# See the function signature in fn/causipw.py for argument names.
```
