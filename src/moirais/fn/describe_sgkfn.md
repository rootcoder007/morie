# describe('sgkfn') — ripley_k_function
...
`print(result)` render. See `moirais.fn.describe('sgkfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgkfn import *
import numpy as np
# See the function signature in fn/sgkfn.py for argument names.
```
