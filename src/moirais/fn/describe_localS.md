...
`print(result)` render. See `moirais.fn.describe('localS')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.localS import *
import numpy as np
# See the function signature in fn/localS.py for argument names.
```
