...
`print(result)` render. See `moirais.fn.describe('stahdo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stahdo import *
import numpy as np
# See the function signature in fn/stahdo.py for argument names.
```
