# describe('regest') — regression_estimator
...
`print(result)` render. See `moirais.fn.describe('regest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.regest import *
import numpy as np
# See the function signature in fn/regest.py for argument names.
```
