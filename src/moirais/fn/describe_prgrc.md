# describe('prgrc') — program_recidivism
...
`print(result)` render. See `moirais.fn.describe('prgrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prgrc import *
import numpy as np
# See the function signature in fn/prgrc.py for argument names.
```
