...
__all__ = ["guide_on_data_analysis_chapter_25_unnumbered_1250"]


def guide_on_data_analysis_chapter_25_unnumbered_1250(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> D = 0.1107, p-value = 0.9076
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis25u1250')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis25u1250: GeneralStatistics expression (auto-extracted; see ref)."
