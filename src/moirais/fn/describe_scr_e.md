# describe('scr_e') — subscale_ee_composite_rel
...
`print(result)` render. See `moirais.fn.describe('scr_e')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scr_e import *
import numpy as np
# See the function signature in fn/scr_e.py for argument names.
```
