# describe('otmsw') — ot_max_sliced_w
...
`print(result)` render. See `moirais.fn.describe('otmsw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmsw import *
import numpy as np
# See the function signature in fn/otmsw.py for argument names.
```
