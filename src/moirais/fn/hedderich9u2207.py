...
__all__ = ["hedderich_chapter_9_unnumbered_2207"]


def hedderich_chapter_9_unnumbered_2207(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] α= 0.10; 0.05; 0.01 orβ= 0.10 andβ= 0.20.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2207')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2207: PowerAndDesign expression (auto-extracted; see ref)."
