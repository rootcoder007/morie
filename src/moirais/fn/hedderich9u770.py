...
__all__ = ["hedderich_chapter_9_unnumbered_770"]


def hedderich_chapter_9_unnumbered_770(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] µ−σ/3<X <µ+σ/3 (5.96)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u770')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u770: GeneralStatistics expression (auto-extracted; see ref)."
