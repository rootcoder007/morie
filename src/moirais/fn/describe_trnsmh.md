# describe('trnsmh') — transmembrane_topology
...
`print(result)` render. See `moirais.fn.describe('trnsmh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnsmh import *
import numpy as np
# See the function signature in fn/trnsmh.py for argument names.
```
