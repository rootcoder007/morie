# describe('msm241') — mvsml_preprocessing_eq_2_2
...
`print(result)` render. See `moirais.fn.describe('msm241')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm241 import *
import numpy as np
# See the function signature in fn/msm241.py for argument names.
```
