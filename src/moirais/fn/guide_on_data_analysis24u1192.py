...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1192"]


def guide_on_data_analysis_chapter_24_unnumbered_1192(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝜇𝑖𝑗 = 𝜇.. + (𝜇𝑖. − 𝜇..) + (𝜇𝑖𝑗 − 𝜇𝑖.)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1192')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1192: GeneralStatistics expression (auto-extracted; see ref)."
