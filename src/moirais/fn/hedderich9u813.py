...
__all__ = ["hedderich_chapter_9_unnumbered_813"]


def hedderich_chapter_9_unnumbered_813(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: +3σ +4σ+2σ-2σ -1σ-3σ-4σ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u813')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u813: GeneralStatistics expression (auto-extracted; see ref)."
