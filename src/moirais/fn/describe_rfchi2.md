...
`print(result)` render. See `moirais.fn.describe('rfchi2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rfchi2 import *
import numpy as np
# See the function signature in fn/rfchi2.py for argument names.
```
