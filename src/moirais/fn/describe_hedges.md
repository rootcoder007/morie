...
`print(result)` render. See `moirais.fn.describe('hedges')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hedges import *
import numpy as np
# See the function signature in fn/hedges.py for argument names.
```
