# describe('causivar') — causal_iv_anderson_rubin
...
`print(result)` render. See `moirais.fn.describe('causivar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.causivar import *
import numpy as np
# See the function signature in fn/causivar.py for argument names.
```
