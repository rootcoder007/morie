...
`print(result)` render. See `moirais.fn.describe('sicosm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sicosm import *
import numpy as np
# See the function signature in fn/sicosm.py for argument names.
```
