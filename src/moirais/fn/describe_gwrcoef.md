...
`print(result)` render. See `moirais.fn.describe('gwrcoef')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gwrcoef import *
import numpy as np
# See the function signature in fn/gwrcoef.py for argument names.
```
