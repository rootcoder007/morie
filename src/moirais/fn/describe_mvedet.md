...
`print(result)` render. See `moirais.fn.describe('mvedet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvedet import *
import numpy as np
# See the function signature in fn/mvedet.py for argument names.
```
