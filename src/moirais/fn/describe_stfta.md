...
`print(result)` render. See `moirais.fn.describe('stfta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stfta import *
import numpy as np
# See the function signature in fn/stfta.py for argument names.
```
