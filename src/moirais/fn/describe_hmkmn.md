...
`print(result)` render. See `moirais.fn.describe('hmkmn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkmn import *
import numpy as np
# See the function signature in fn/hmkmn.py for argument names.
```
