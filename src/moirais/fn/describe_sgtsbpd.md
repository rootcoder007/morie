# describe('sgtsbpd') — sgt_spectral_radius
...
`print(result)` render. See `moirais.fn.describe('sgtsbpd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtsbpd import *
import numpy as np
# See the function signature in fn/sgtsbpd.py for argument names.
```
