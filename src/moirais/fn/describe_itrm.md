# describe('itrm') — interim_analysis
...
`print(result)` render. See `moirais.fn.describe('itrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itrm import *
import numpy as np
# See the function signature in fn/itrm.py for argument names.
```
