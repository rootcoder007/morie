...
`print(result)` render. See `moirais.fn.describe('entqm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.entqm import *
import numpy as np
# See the function signature in fn/entqm.py for argument names.
```
