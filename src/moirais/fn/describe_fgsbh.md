# describe('fgsbh') — fine_gray_subdistribution_hazard
...
`print(result)` render. See `moirais.fn.describe('fgsbh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fgsbh import *
import numpy as np
# See the function signature in fn/fgsbh.py for argument names.
```
