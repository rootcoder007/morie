...
`print(result)` render. See `moirais.fn.describe('bspwv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bspwv import *
import numpy as np
# See the function signature in fn/bspwv.py for argument names.
```
