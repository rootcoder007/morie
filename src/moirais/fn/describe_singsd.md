# describe('singsd') — singular_spectrum
...
`print(result)` render. See `moirais.fn.describe('singsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.singsd import *
import numpy as np
# See the function signature in fn/singsd.py for argument names.
```
