...
`print(result)` render. See `moirais.fn.describe('zxsvm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsvm import *
import numpy as np
# See the function signature in fn/zxsvm.py for argument names.
```
