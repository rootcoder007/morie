...
__all__ = ["hedderich_chapter_9_unnumbered_1261"]


def hedderich_chapter_9_unnumbered_1261(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (¯x−t s√n≤µ) = (1−α) or P (µ≤¯x +t s√n ) = (1−α) (6.72)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1261')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1261: GeneralStatistics expression (auto-extracted; see ref)."
