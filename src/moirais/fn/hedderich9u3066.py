...
__all__ = ["hedderich_chapter_9_unnumbered_3066"]


def hedderich_chapter_9_unnumbered_3066(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: pairwise comparisons of differences πi−πj (i < j)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3066')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3066: GeneralStatistics expression (auto-extracted; see ref)."
