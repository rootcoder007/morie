...
__all__ = ["guide_on_data_analysis_chapter_4_unnumbered_180"]


def guide_on_data_analysis_chapter_4_unnumbered_180(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: • 𝑤𝑚𝑖𝑛 = min(𝑤+, 𝑤−)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis4u180')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis4u180: GeneralStatistics expression (auto-extracted; see ref)."
