...
`print(result)` render. See `moirais.fn.describe('ada')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ada import *
import numpy as np
# See the function signature in fn/ada.py for argument names.
```
