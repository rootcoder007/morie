# describe('irtpc'All models are wrong, but some are useful. — George E. P. Box's source for the canonical
...
`print(result)` render. See `moirais.fn.describe('irtpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtpc import *
import numpy as np
# See the function signature in fn/irtpc.py for argument names.
```
