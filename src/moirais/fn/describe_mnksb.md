...
`print(result)` render. See `moirais.fn.describe('mnksb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mnksb import *
import numpy as np
# See the function signature in fn/mnksb.py for argument names.
```
