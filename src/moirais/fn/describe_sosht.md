...
`print(result)` render. See `moirais.fn.describe('sosht')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sosht import *
import numpy as np
# See the function signature in fn/sosht.py for argument names.
```
