# describe('xrspr') — spatial_panel_re
...
`print(result)` render. See `moirais.fn.describe('xrspr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspr import *
import numpy as np
# See the function signature in fn/xrspr.py for argument names.
```
