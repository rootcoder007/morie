# describe('cdccm') — charlson_comorbidity
...
`print(result)` render. See `moirais.fn.describe('cdccm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdccm import *
import numpy as np
# See the function signature in fn/cdccm.py for argument names.
```
