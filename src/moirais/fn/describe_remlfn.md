...
`print(result)` render. See `moirais.fn.describe('remlfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.remlfn import *
import numpy as np
# See the function signature in fn/remlfn.py for argument names.
```
