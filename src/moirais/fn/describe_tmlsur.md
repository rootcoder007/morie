...
`print(result)` render. See `moirais.fn.describe('tmlsur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsur import *
import numpy as np
# See the function signature in fn/tmlsur.py for argument names.
```
