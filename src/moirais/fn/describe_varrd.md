# describe('varrd') — variance_reduction_split
...
`print(result)` render. See `moirais.fn.describe('varrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.varrd import *
import numpy as np
# See the function signature in fn/varrd.py for argument names.
```
