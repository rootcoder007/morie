# describe('thrtmt') — threshold_treatment_msm
...
`print(result)` render. See `moirais.fn.describe('thrtmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.thrtmt import *
import numpy as np
# See the function signature in fn/thrtmt.py for argument names.
```
