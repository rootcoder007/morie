...
`print(result)` render. See `moirais.fn.describe('abcnnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.abcnnt import *
import numpy as np
# See the function signature in fn/abcnnt.py for argument names.
```
