...
`print(result)` render. See `moirais.fn.describe('wlbbm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wlbbm import *
import numpy as np
# See the function signature in fn/wlbbm.py for argument names.
```
