# describe('bcred') — credible_interval
...
`print(result)` render. See `moirais.fn.describe('bcred')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bcred import *
import numpy as np
# See the function signature in fn/bcred.py for argument names.
```
