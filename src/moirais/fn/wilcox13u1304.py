...
__all__ = ["wilcox_chapter_13_unnumbered_1304"]


def wilcox_chapter_13_unnumbered_1304(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1304')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1304: GeneralStatistics expression (auto-extracted; see ref)."
