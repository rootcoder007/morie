...
`print(result)` render. See `moirais.fn.describe('dtcpj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtcpj import *
import numpy as np
# See the function signature in fn/dtcpj.py for argument names.
```
