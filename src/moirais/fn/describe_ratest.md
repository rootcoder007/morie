# describe('ratest') — ratio_estimator
...
`print(result)` render. See `moirais.fn.describe('ratest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ratest import *
import numpy as np
# See the function signature in fn/ratest.py for argument names.
```
