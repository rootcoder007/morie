...
`print(result)` render. See `moirais.fn.describe('svdpp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svdpp import *
import numpy as np
# See the function signature in fn/svdpp.py for argument names.
```
