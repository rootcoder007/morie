# describe('attnq') — scaled_dot_product_attention
...
`print(result)` render. See `moirais.fn.describe('attnq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.attnq import *
import numpy as np
# See the function signature in fn/attnq.py for argument names.
```
