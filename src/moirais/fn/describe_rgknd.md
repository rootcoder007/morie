...
`print(result)` render. See `moirais.fn.describe('rgknd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgknd import *
import numpy as np
# See the function signature in fn/rgknd.py for argument names.
```
