# describe('dpprr') — dirichlet_process_prior_predictive

## WHAT IT DOES

Dirichlet process prior predictive distribution. 'Real knowledge is to know the extent of one\'Patience is bitter, but its fruit is sweet. — Aristotle'
...
`print(result)` render. See `moirais.fn.describe('dpprr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpprr import *
import numpy as np
# See the function signature in fn/dpprr.py for argument names.
```
