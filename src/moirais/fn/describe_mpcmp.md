...
`print(result)` render. See `moirais.fn.describe('mpcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mpcmp import *
import numpy as np
# See the function signature in fn/mpcmp.py for argument names.
```
