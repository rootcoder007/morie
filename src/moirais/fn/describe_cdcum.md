# describe('cdcum') — cumulative_incidence
...
`print(result)` render. See `moirais.fn.describe('cdcum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdcum import *
import numpy as np
# See the function signature in fn/cdcum.py for argument names.
```
