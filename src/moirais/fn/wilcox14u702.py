...
__all__ = ["wilcox_chapter_14_unnumbered_702"]


def wilcox_chapter_14_unnumbered_702(x):
    """
    ANOVA expression (auto-extracted; see ref).

    Formula: bdanova1(x, alpha = 0.05, power = 0.9, delta = NA)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u702')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u702: ANOVA expression (auto-extracted; see ref)."
