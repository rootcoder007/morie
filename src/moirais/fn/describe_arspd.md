...
`print(result)` render. See `moirais.fn.describe('arspd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.arspd import *
import numpy as np
# See the function signature in fn/arspd.py for argument names.
```
