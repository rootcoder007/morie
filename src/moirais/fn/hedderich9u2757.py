...
__all__ = ["hedderich_chapter_9_unnumbered_2757"]


def hedderich_chapter_9_unnumbered_2757(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (b)H02 : π1−π2≤−∆ vs.HA2 : π1−π2 >−∆
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2757')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2757: GeneralStatistics expression (auto-extracted; see ref)."
