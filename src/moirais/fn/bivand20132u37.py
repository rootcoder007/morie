...
__all__ = ["bivand2013_chapter_2_unnumbered_37"]


def bivand2013_chapter_2_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > length(pal) == length(brks) - 1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u37')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u37: GeneralStatistics expression (auto-extracted; see ref)."
