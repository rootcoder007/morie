# describe('dpmem') — dirichlet_process_mixture
...
`print(result)` render. See `moirais.fn.describe('dpmem')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpmem import *
import numpy as np
# See the function signature in fn/dpmem.py for argument names.
```
