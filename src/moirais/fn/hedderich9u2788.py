...
__all__ = ["hedderich_chapter_9_unnumbered_2788"]


def hedderich_chapter_9_unnumbered_2788(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X≤5|n = 21,p = 0.5) =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2788')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2788: CountModels expression (auto-extracted; see ref)."
