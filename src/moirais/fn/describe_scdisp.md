...
`print(result)` render. See `moirais.fn.describe('scdisp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scdisp import *
import numpy as np
# See the function signature in fn/scdisp.py for argument names.
```
