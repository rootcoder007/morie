...
`print(result)` render. See `moirais.fn.describe('enwsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.enwsp import *
import numpy as np
# See the function signature in fn/enwsp.py for argument names.
```
