...
`print(result)` render. See `moirais.fn.describe('atoms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.atoms import *
import numpy as np
# See the function signature in fn/atoms.py for argument names.
```
