...
`print(result)` render. See `moirais.fn.describe('ubprk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubprk import *
import numpy as np
# See the function signature in fn/ubprk.py for argument names.
```
