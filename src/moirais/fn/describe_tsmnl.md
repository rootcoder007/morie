# describe('tsmnl') — tsmnl

## WHAT IT DOES

Mantel test for association
...
`print(result)` render. See `moirais.fn.describe('tsmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tsmnl import *
import numpy as np
# See the function signature in fn/tsmnl.py for argument names.
```
