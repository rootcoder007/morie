...
`print(result)` render. See `moirais.fn.describe('gdflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdflm import *
import numpy as np
# See the function signature in fn/gdflm.py for argument names.
```
