...
`print(result)` render. See `moirais.fn.describe('tbbnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbbnd import *
import numpy as np
# See the function signature in fn/tbbnd.py for argument names.
```
