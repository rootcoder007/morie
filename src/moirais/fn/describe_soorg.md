...
`print(result)` render. See `moirais.fn.describe('soorg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soorg import *
import numpy as np
# See the function signature in fn/soorg.py for argument names.
```
