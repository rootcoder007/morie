# describe('km100') — kamath_ch6_toxicity_probability
...
`print(result)` render. See `moirais.fn.describe('km100')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km100 import *
import numpy as np
# See the function signature in fn/km100.py for argument names.
```
