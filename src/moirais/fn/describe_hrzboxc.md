# describe('hrzboxc') — horowitz_box_cox
...
`print(result)` render. See `moirais.fn.describe('hrzboxc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzboxc import *
import numpy as np
# See the function signature in fn/hrzboxc.py for argument names.
```
