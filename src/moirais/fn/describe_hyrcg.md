...
`print(result)` render. See `moirais.fn.describe('hyrcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyrcg import *
import numpy as np
# See the function signature in fn/hyrcg.py for argument names.
```
