...
__all__ = ["hedderich_chapter_9_unnumbered_703"]


def hedderich_chapter_9_unnumbered_703(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (Xx̄) = F (x) = e−λ ∑
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u703')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u703: CountModels expression (auto-extracted; see ref)."
