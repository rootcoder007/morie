# describe('grbrnn') — geron_bidirectional_rnn
...
`print(result)` render. See `moirais.fn.describe('grbrnn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grbrnn import *
import numpy as np
# See the function signature in fn/grbrnn.py for argument names.
```
