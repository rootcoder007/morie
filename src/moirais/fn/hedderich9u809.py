...
__all__ = ["hedderich_chapter_9_unnumbered_809"]


def hedderich_chapter_9_unnumbered_809(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (c) P (85[mg/dl]X̄≤105[mg/dl]) = P (Z≤1.5)−P (Z≤−0.5)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u809')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u809: GeneralStatistics expression (auto-extracted; see ref)."
