# describe('grcae') — geron_convolutional_autoencoder
...
`print(result)` render. See `moirais.fn.describe('grcae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grcae import *
import numpy as np
# See the function signature in fn/grcae.py for argument names.
```
