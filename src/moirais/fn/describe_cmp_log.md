...
`print(result)` render. See `moirais.fn.describe('cmp_log')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cmp_log import *
import numpy as np
# See the function signature in fn/cmp_log.py for argument names.
```
