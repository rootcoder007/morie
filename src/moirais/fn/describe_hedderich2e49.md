# describe('hedderich2e49') — hedderich_chapter_2_equation_49
...
2. The coefficient matrix A has full column rankrg(An,m) = m<n
...
import numpy as np
result = hedderich_chapter_2_equation_49(np.random.default_rng(42).normal(0, 1, 100))
