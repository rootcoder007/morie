...
__all__ = ["hedderich_chapter_9_unnumbered_1783"]


def hedderich_chapter_9_unnumbered_1783(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: hypothesisπ1 > 0.40 with ˆp1 = 0.46 (significance levelα= 0.05). Since the sample comprises
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1783')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1783: GeneralStatistics expression (auto-extracted; see ref)."
