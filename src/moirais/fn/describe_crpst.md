# describe('crpst') — chinese_restaurant_process

## WHAT IT DOES

Chinese restaurant process simulation. 'Knowledge itself is power. — Francis Bacon'
...
`print(result)` render. See `moirais.fn.describe('crpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crpst import *
import numpy as np
# See the function signature in fn/crpst.py for argument names.
```
