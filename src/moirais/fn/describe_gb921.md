# describe('gb921') — gibbons_mood_scale
...
`print(result)` render. See `moirais.fn.describe('gb921')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb921 import *
import numpy as np
# See the function signature in fn/gb921.py for argument names.
```
