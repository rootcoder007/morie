# describe('ca2e9') — ca_chapter_2_equation_9
...
```python
from moirais.fn.ca2e9 import ca_chapter_2_equation_9
import numpy as np
result = ca_chapter_2_equation_9(np.random.default_rng(42).normal(0, 1, 100))
