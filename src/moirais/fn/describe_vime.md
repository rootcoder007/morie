# describe('vime') — empirical_orthogonal_func
...
`print(result)` render. See `moirais.fn.describe('vime')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vime import *
import numpy as np
# See the function signature in fn/vime.py for argument names.
```
