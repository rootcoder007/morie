# describe('olrFn') — outgoing_longwave
...
`print(result)` render. See `moirais.fn.describe('olrFn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.olrFn import *
import numpy as np
# See the function signature in fn/olrFn.py for argument names.
```
