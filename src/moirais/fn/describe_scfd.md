# describe('scfd') — scalar_on_function
...
`print(result)` render. See `moirais.fn.describe('scfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scfd import *
import numpy as np
# See the function signature in fn/scfd.py for argument names.
```
