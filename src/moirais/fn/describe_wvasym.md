...
`print(result)` render. See `moirais.fn.describe('wvasym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvasym import *
import numpy as np
# See the function signature in fn/wvasym.py for argument names.
```
