...
__all__ = ["hedderich_chapter_9_unnumbered_1592"]


def hedderich_chapter_9_unnumbered_1592(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 0.05 (two-sided):⇒z0.975 = 1.960< 2.024 = 3·0.6745
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1592')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1592: GeneralStatistics expression (auto-extracted; see ref)."
