# describe('modlar') — modularity_newman
...
`print(result)` render. See `moirais.fn.describe('modlar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modlar import *
import numpy as np
# See the function signature in fn/modlar.py for argument names.
```
