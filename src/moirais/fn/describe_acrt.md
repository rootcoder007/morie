...
`print(result)` render. See `moirais.fn.describe('acrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.acrt import *
import numpy as np
# See the function signature in fn/acrt.py for argument names.
```
