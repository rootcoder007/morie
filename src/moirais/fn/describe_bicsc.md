...
`print(result)` render. See `moirais.fn.describe('bicsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bicsc import *
import numpy as np
# See the function signature in fn/bicsc.py for argument names.
```
