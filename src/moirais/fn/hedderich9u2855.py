...
__all__ = ["hedderich_chapter_9_unnumbered_2855"]


def hedderich_chapter_9_unnumbered_2855(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: simple formulas. The ˆχ2 of the r·c table, based on (r−1)(c−1) = νdegrees of freedom (r
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2855')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2855: GeneralStatistics expression (auto-extracted; see ref)."
