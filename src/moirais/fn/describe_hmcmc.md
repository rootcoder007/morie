...
`print(result)` render. See `moirais.fn.describe('hmcmc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcmc import *
import numpy as np
# See the function signature in fn/hmcmc.py for argument names.
```
