...
`print(result)` render. See `moirais.fn.describe('ppstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppstr import *
import numpy as np
# See the function signature in fn/ppstr.py for argument names.
```
