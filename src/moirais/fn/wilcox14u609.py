...
__all__ = ["wilcox_chapter_14_unnumbered_609"]


def wilcox_chapter_14_unnumbered_609(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: Beal’s 1 − α confidence interval for p1 − p2 is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u609')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u609: ContingencyTables expression (auto-extracted; see ref)."
