...
`print(result)` render. See `moirais.fn.describe('barte')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.barte import *
import numpy as np
# See the function signature in fn/barte.py for argument names.
```
