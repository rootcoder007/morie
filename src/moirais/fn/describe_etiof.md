# describe('etiof') — etiologic_fraction
...
`print(result)` render. See `moirais.fn.describe('etiof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.etiof import *
import numpy as np
# See the function signature in fn/etiof.py for argument names.
```
