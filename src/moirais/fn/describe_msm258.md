# describe('msm258') — mvsml_elements_lin_reg_eq_3_5
...
`print(result)` render. See `moirais.fn.describe('msm258')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm258 import *
import numpy as np
# See the function signature in fn/msm258.py for argument names.
```
