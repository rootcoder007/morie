...
__all__ = ["hedderich_chapter_9_unnumbered_488"]


def hedderich_chapter_9_unnumbered_488(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [test negative] a + b + c + d = n
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u488')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u488: GeneralStatistics expression (auto-extracted; see ref)."
