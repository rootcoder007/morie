...
`print(result)` render. See `moirais.fn.describe('groebn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.groebn import *
import numpy as np
# See the function signature in fn/groebn.py for argument names.
```
