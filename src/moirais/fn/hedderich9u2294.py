...
__all__ = ["hedderich_chapter_9_unnumbered_2294"]


def hedderich_chapter_9_unnumbered_2294(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: CI1 : [ ¯d−tn−1,1−α
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2294')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2294: GeneralStatistics expression (auto-extracted; see ref)."
