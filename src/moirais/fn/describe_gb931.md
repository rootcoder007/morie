# describe('gb931') — gibbons_fab_test
...
`print(result)` render. See `moirais.fn.describe('gb931')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb931 import *
import numpy as np
# See the function signature in fn/gb931.py for argument names.
```
