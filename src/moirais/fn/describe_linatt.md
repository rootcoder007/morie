# describe('linatt') — linformer_linear_attention
...
`print(result)` render. See `moirais.fn.describe('linatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.linatt import *
import numpy as np
# See the function signature in fn/linatt.py for argument names.
```
