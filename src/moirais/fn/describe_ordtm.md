# describe('ordtm') — ordinal_threshold_model
...
`print(result)` render. See `moirais.fn.describe('ordtm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ordtm import *
import numpy as np
# See the function signature in fn/ordtm.py for argument names.
```
