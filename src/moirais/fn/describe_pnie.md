# describe('pnie') — pure_natural_indirect_effect
...
`print(result)` render. See `moirais.fn.describe('pnie')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pnie import *
import numpy as np
# See the function signature in fn/pnie.py for argument names.
```
