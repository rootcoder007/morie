# describe('admix') — admixture_proportions
...
`print(result)` render. See `moirais.fn.describe('admix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.admix import *
import numpy as np
# See the function signature in fn/admix.py for argument names.
```
