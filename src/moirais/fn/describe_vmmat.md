...
`print(result)` render. See `moirais.fn.describe('vmmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmmat import *
import numpy as np
# See the function signature in fn/vmmat.py for argument names.
```
