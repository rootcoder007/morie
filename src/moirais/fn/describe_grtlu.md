# describe('grtlu') — geron_threshold_logic_unit
...
`print(result)` render. See `moirais.fn.describe('grtlu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grtlu import *
import numpy as np
# See the function signature in fn/grtlu.py for argument names.
```
