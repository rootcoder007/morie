# describe('volnois') — vol_noise_variance_est
...
`print(result)` render. See `moirais.fn.describe('volnois')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volnois import *
import numpy as np
# See the function signature in fn/volnois.py for argument names.
```
