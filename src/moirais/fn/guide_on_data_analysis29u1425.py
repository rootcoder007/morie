...
__all__ = ["guide_on_data_analysis_chapter_29_unnumbered_1425"]


def guide_on_data_analysis_chapter_29_unnumbered_1425(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: treated_period_var = "year_treated",
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis29u1425')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis29u1425: GeneralStatistics expression (auto-extracted; see ref)."
