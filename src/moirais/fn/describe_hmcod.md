# describe('hmcod') — geron_curse_dimensionality
...
`print(result)` render. See `moirais.fn.describe('hmcod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcod import *
import numpy as np
# See the function signature in fn/hmcod.py for argument names.
```
