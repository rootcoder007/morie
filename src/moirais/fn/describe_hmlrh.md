# describe('hmlrh') — geron_learning_rate_heuristic
...
`print(result)` render. See `moirais.fn.describe('hmlrh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmlrh import *
import numpy as np
# See the function signature in fn/hmlrh.py for argument names.
```
