...
__all__ = ["hedderich_chapter_9_unnumbered_1361"]


def hedderich_chapter_9_unnumbered_1361(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆσ2 = s2(n−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1361')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1361: GeneralStatistics expression (auto-extracted; see ref)."
