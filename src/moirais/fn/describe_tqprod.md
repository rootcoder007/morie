# describe('tqprod') — turboquant_qjl_product_estimator
...
`print(result)` render. See `moirais.fn.describe('tqprod')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tqprod import *
import numpy as np
# See the function signature in fn/tqprod.py for argument names.
```
