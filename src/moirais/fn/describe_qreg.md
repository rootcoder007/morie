# describe('qreg') — quantile_regression
...
`print(result)` render. See `moirais.fn.describe('qreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qreg import *
import numpy as np
# See the function signature in fn/qreg.py for argument names.
```
