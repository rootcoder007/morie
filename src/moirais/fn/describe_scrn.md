# describe('scrn') — screening_metrics
...
`print(result)` render. See `moirais.fn.describe('scrn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scrn import *
import numpy as np
# See the function signature in fn/scrn.py for argument names.
```
