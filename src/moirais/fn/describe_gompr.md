...
`print(result)` render. See `moirais.fn.describe('gompr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gompr import *
import numpy as np
# See the function signature in fn/gompr.py for argument names.
```
