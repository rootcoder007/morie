...
`print(result)` render. See `moirais.fn.describe('zesir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zesir import *
import numpy as np
# See the function signature in fn/zesir.py for argument names.
```
