# describe('gb1061') — gibbons_jonckheere
...
`print(result)` render. See `moirais.fn.describe('gb1061')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1061 import *
import numpy as np
# See the function signature in fn/gb1061.py for argument names.
```
