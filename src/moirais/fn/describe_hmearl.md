# describe('hmearl') — geron_early_stopping
...
`print(result)` render. See `moirais.fn.describe('hmearl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmearl import *
import numpy as np
# See the function signature in fn/hmearl.py for argument names.
```
