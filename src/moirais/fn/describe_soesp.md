...
`print(result)` render. See `moirais.fn.describe('soesp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.soesp import *
import numpy as np
# See the function signature in fn/soesp.py for argument names.
```
