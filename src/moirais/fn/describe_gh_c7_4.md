# describe('gh_c7_4') — ghosal_norm_mix_con
...
`print(result)` render. See `moirais.fn.describe('gh_c7_4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c7_4 import *
import numpy as np
# See the function signature in fn/gh_c7_4.py for argument names.
```
