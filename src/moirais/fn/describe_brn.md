...
`print(result)` render. See `moirais.fn.describe('brn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brn import *
import numpy as np
# See the function signature in fn/brn.py for argument names.
```
