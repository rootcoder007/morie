# describe('sgcrv') — cross_variogram
...
`print(result)` render. See `moirais.fn.describe('sgcrv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgcrv import *
import numpy as np
# See the function signature in fn/sgcrv.py for argument names.
```
