...
`print(result)` render. See `moirais.fn.describe('trnrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trnrg import *
import numpy as np
# See the function signature in fn/trnrg.py for argument names.
```
