...
`print(result)` render. See `moirais.fn.describe('agbll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.agbll import *
import numpy as np
# See the function signature in fn/agbll.py for argument names.
```
