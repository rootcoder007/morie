# describe('lgrtn') — log_spectral_dist
...
`print(result)` render. See `moirais.fn.describe('lgrtn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lgrtn import *
import numpy as np
# See the function signature in fn/lgrtn.py for argument names.
```
