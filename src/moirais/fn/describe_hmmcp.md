# describe('hmmcp') — geron_model_context_protocol
...
`print(result)` render. See `moirais.fn.describe('hmmcp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmcp import *
import numpy as np
# See the function signature in fn/hmmcp.py for argument names.
```
