# describe('clust') — clustering_coefficient
...
`print(result)` render. See `moirais.fn.describe('clust')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clust import *
import numpy as np
# See the function signature in fn/clust.py for argument names.
```
