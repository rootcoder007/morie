...
__all__ = ["hedderich_chapter_9_unnumbered_13"]


def hedderich_chapter_9_unnumbered_13(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u13')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u13: GeneralStatistics expression (auto-extracted; see ref)."
