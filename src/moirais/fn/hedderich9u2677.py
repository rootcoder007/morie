...
__all__ = ["hedderich_chapter_9_unnumbered_2677"]


def hedderich_chapter_9_unnumbered_2677(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2677')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2677: GeneralStatistics expression (auto-extracted; see ref)."
