...
`print(result)` render. See `moirais.fn.describe('prest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.prest import *
import numpy as np
# See the function signature in fn/prest.py for argument names.
```
