# describe('gb_ssj') — gibbons_sign_sample_size_2
...
`print(result)` render. See `moirais.fn.describe('gb_ssj')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_ssj import *
import numpy as np
# See the function signature in fn/gb_ssj.py for argument names.
```
