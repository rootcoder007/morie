# describe('msm160') — mvsml_general_eq_1_2
...
`print(result)` render. See `moirais.fn.describe('msm160')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm160 import *
import numpy as np
# See the function signature in fn/msm160.py for argument names.
```
