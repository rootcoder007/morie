# describe('ecccen') — eccentricity_centrality
...
`print(result)` render. See `moirais.fn.describe('ecccen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ecccen import *
import numpy as np
# See the function signature in fn/ecccen.py for argument names.
```
