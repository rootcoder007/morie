...
`print(result)` render. See `moirais.fn.describe('svpnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svpnl import *
import numpy as np
# See the function signature in fn/svpnl.py for argument names.
```
