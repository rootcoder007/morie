# describe('gh_c3_6') — ghosal_dense_subset_prior
...
`print(result)` render. See `moirais.fn.describe('gh_c3_6')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_c3_6 import *
import numpy as np
# See the function signature in fn/gh_c3_6.py for argument names.
```
