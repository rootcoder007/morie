# describe('sgmwc') — moving_window_cov
...
`print(result)` render. See `moirais.fn.describe('sgmwc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgmwc import *
import numpy as np
# See the function signature in fn/sgmwc.py for argument names.
```
