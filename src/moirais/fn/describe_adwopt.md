...
`print(result)` render. See `moirais.fn.describe('adwopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.adwopt import *
import numpy as np
# See the function signature in fn/adwopt.py for argument names.
```
