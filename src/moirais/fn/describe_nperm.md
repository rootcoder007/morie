...
`print(result)` render. See `moirais.fn.describe('nperm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nperm import *
import numpy as np
# See the function signature in fn/nperm.py for argument names.
```
