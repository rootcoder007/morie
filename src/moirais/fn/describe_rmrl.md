...
`print(result)` render. See `moirais.fn.describe('rmrl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rmrl import *
import numpy as np
# See the function signature in fn/rmrl.py for argument names.
```
