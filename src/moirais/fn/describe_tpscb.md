# describe('tpscb') — tps_cost_benefit
...
`print(result)` render. See `moirais.fn.describe('tpscb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpscb import *
import numpy as np
# See the function signature in fn/tpscb.py for argument names.
```
