...
`print(result)` render. See `moirais.fn.describe('movav')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.movav import *
import numpy as np
# See the function signature in fn/movav.py for argument names.
```
