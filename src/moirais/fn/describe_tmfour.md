...
`print(result)` render. See `moirais.fn.describe('tmfour')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmfour import *
import numpy as np
# See the function signature in fn/tmfour.py for argument names.
```
