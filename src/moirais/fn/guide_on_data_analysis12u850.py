...
__all__ = ["guide_on_data_analysis_chapter_12_unnumbered_850"]


def guide_on_data_analysis_chapter_12_unnumbered_850(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: breaks = hist(l_dist, plot = FALSE)$breaks,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis12u850')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis12u850: GeneralStatistics expression (auto-extracted; see ref)."
