...
__all__ = ["hedderich_chapter_9_unnumbered_515"]


def hedderich_chapter_9_unnumbered_515(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: incidence density can be described byCI = 1−exp(−T·I). If the population is in equilibrium
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u515')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u515: GeneralStatistics expression (auto-extracted; see ref)."
