...
`print(result)` render. See `moirais.fn.describe('elbmk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elbmk import *
import numpy as np
# See the function signature in fn/elbmk.py for argument names.
```
