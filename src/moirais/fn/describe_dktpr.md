...
`print(result)` render. See `moirais.fn.describe('dktpr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dktpr import *
import numpy as np
# See the function signature in fn/dktpr.py for argument names.
```
