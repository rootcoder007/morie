...
__all__ = ["hedderich_chapter_9_unnumbered_2312"]


def hedderich_chapter_9_unnumbered_2312(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] Ho =min{j : p(j) >α/(m−j + 1)}
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2312')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2312: PowerAndDesign expression (auto-extracted; see ref)."
