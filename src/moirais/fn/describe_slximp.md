...
`print(result)` render. See `moirais.fn.describe('slximp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.slximp import *
import numpy as np
# See the function signature in fn/slximp.py for argument names.
```
