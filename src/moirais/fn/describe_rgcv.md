# describe('rgcv') — generalizability_coeff
...
`print(result)` render. See `moirais.fn.describe('rgcv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcv import *
import numpy as np
# See the function signature in fn/rgcv.py for argument names.
```
