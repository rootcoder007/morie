# describe('lmmll') — lmm_log_likelihood
...
`print(result)` render. See `moirais.fn.describe('lmmll')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lmmll import *
import numpy as np
# See the function signature in fn/lmmll.py for argument names.
```
