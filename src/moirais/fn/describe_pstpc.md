# describe('pstpc') — posterior_predictive_check
...
`print(result)` render. See `moirais.fn.describe('pstpc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pstpc import *
import numpy as np
# See the function signature in fn/pstpc.py for argument names.
```
