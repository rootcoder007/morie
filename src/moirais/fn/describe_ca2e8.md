# describe('ca2e8') — ca_chapter_2_equation_8
...
```python
from moirais.fn.ca2e8 import ca_chapter_2_equation_8
import numpy as np
result = ca_chapter_2_equation_8(np.random.default_rng(42).normal(0, 1, 100))
