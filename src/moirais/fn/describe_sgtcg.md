# describe('sgtcg') — sgt_commute_distance
...
`print(result)` render. See `moirais.fn.describe('sgtcg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtcg import *
import numpy as np
# See the function signature in fn/sgtcg.py for argument names.
```
