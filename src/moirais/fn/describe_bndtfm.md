# describe('bndtfm') — bound_transform
...
`print(result)` render. See `moirais.fn.describe('bndtfm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bndtfm import *
import numpy as np
# See the function signature in fn/bndtfm.py for argument names.
```
