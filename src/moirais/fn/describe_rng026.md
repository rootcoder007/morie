# describe('rng026') — rangayyan_ch3_dirac_delta_limit_form
...
`print(result)` render. See `moirais.fn.describe('rng026')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng026 import *
import numpy as np
# See the function signature in fn/rng026.py for argument names.
```
