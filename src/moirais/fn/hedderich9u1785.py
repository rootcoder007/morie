...
__all__ = ["hedderich_chapter_9_unnumbered_1785"]


def hedderich_chapter_9_unnumbered_1785(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P{ˆp1 ≦ 0.46|π= 0.40}= 0.0037< 0.05
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1785')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1785: GeneralStatistics expression (auto-extracted; see ref)."
