...
`print(result)` render. See `moirais.fn.describe('umdyn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.umdyn import *
import numpy as np
# See the function signature in fn/umdyn.py for argument names.
```
