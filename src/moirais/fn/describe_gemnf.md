...
`print(result)` render. See `moirais.fn.describe('gemnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gemnf import *
import numpy as np
# See the function signature in fn/gemnf.py for argument names.
```
