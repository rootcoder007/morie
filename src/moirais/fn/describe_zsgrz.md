...
`print(result)` render. See `moirais.fn.describe('zsgrz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgrz import *
import numpy as np
# See the function signature in fn/zsgrz.py for argument names.
```
