...
`print(result)` render. See `moirais.fn.describe('rappor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rappor import *
import numpy as np
# See the function signature in fn/rappor.py for argument names.
```
