...
__all__ = ["guide_on_data_analysis_chapter_27_unnumbered_1356"]


def guide_on_data_analysis_chapter_27_unnumbered_1356(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝐸[𝑌 (0)|𝑋1 = 𝑥1, 𝑋2 = 𝑥2] = lim
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis27u1356')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis27u1356: GeneralStatistics expression (auto-extracted; see ref)."
