...
__all__ = ["hedderich_chapter_9_unnumbered_3613"]


def hedderich_chapter_9_unnumbered_3613(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] =p log(λ) +p log(ti)   +x′
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3613')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3613: GeneralStatistics expression (auto-extracted; see ref)."
