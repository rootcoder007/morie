# describe('chlkrg') — chlkrg

## WHAT IT DOES

Cholesky-kriging hybrid simulation.
...
`print(result)` render. See `moirais.fn.describe('chlkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.chlkrg import *
import numpy as np
# See the function signature in fn/chlkrg.py for argument names.
```
