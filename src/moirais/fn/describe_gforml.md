# describe('gforml') — robins_g_formula
...
`print(result)` render. See `moirais.fn.describe('gforml')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gforml import *
import numpy as np
# See the function signature in fn/gforml.py for argument names.
```
