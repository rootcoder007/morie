# describe('svrps') — rank_prob_score
...
`print(result)` render. See `moirais.fn.describe('svrps')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svrps import *
import numpy as np
# See the function signature in fn/svrps.py for argument names.
```
