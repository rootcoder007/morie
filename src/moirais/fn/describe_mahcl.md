...
`print(result)` render. See `moirais.fn.describe('mahcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mahcl import *
import numpy as np
# See the function signature in fn/mahcl.py for argument names.
```
