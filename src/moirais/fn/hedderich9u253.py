...
__all__ = ["hedderich_chapter_9_unnumbered_253"]


def hedderich_chapter_9_unnumbered_253(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] f (x +∆x)−f (x) = ∆y= df
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u253')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u253: GeneralStatistics expression (auto-extracted; see ref)."
