# describe('srkgr') — srkgr

## WHAT IT DOES

Spatial kelejian-prucha model
...
`print(result)` render. See `moirais.fn.describe('srkgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srkgr import *
import numpy as np
# See the function signature in fn/srkgr.py for argument names.
```
