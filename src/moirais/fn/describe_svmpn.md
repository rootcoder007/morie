# describe('svmpn') — multiparty_nash
...
`print(result)` render. See `moirais.fn.describe('svmpn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmpn import *
import numpy as np
# See the function signature in fn/svmpn.py for argument names.
```
