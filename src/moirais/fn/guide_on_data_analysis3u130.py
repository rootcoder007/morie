...
__all__ = ["guide_on_data_analysis_chapter_3_unnumbered_130"]


def guide_on_data_analysis_chapter_3_unnumbered_130(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: B = sample(c(0, 1), replace = TRUE, size = n)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis3u130')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u130: GeneralStatistics expression (auto-extracted; see ref)."
