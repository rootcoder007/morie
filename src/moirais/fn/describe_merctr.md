...
`print(result)` render. See `moirais.fn.describe('merctr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.merctr import *
import numpy as np
# See the function signature in fn/merctr.py for argument names.
```
