...
`print(result)` render. See `moirais.fn.describe('miest1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.miest1 import *
import numpy as np
# See the function signature in fn/miest1.py for argument names.
```
