# describe('incrtio') — incidence_rate_ratio
...
`print(result)` render. See `moirais.fn.describe('incrtio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.incrtio import *
import numpy as np
# See the function signature in fn/incrtio.py for argument names.
```
