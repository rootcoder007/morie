...
`print(result)` render. See `moirais.fn.describe('spec')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spec import *
import numpy as np
# See the function signature in fn/spec.py for argument names.
```
