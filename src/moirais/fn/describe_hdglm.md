...
`print(result)` render. See `moirais.fn.describe('hdglm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdglm import *
import numpy as np
# See the function signature in fn/hdglm.py for argument names.
```
