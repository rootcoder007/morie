...
`print(result)` render. See `moirais.fn.describe('mcesm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mcesm import *
import numpy as np
# See the function signature in fn/mcesm.py for argument names.
```
