# describe('did') — diff_in_diff

## WHAT IT DOES

Difference-in-differences. 'Errors using inadequate data are much less than those using no data at all. — Charles Babbage'
...
`print(result)` render. See `moirais.fn.describe('did')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.did import *
import numpy as np
# See the function signature in fn/did.py for argument names.
```
