# describe('alldat') — alammar_lda_topic_distribution
...
`print(result)` render. See `moirais.fn.describe('alldat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alldat import *
import numpy as np
# See the function signature in fn/alldat.py for argument names.
```
