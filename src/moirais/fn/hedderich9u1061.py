...
__all__ = ["hedderich_chapter_9_unnumbered_1061"]


def hedderich_chapter_9_unnumbered_1061(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: µy +ϱσy(x−µx)/σx, σy
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1061')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1061: GeneralStatistics expression (auto-extracted; see ref)."
