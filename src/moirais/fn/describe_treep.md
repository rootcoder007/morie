...
`print(result)` render. See `moirais.fn.describe('treep')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.treep import *
import numpy as np
# See the function signature in fn/treep.py for argument names.
```
