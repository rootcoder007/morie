...
`print(result)` render. See `moirais.fn.describe('sdmolsi')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmolsi import *
import numpy as np
# See the function signature in fn/sdmolsi.py for argument names.
```
