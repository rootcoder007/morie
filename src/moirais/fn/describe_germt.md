...
`print(result)` render. See `moirais.fn.describe('germt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.germt import *
import numpy as np
# See the function signature in fn/germt.py for argument names.
```
