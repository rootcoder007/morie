# describe('volpow') — vol_power_variation
...
`print(result)` render. See `moirais.fn.describe('volpow')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volpow import *
import numpy as np
# See the function signature in fn/volpow.py for argument names.
```
