...
`print(result)` render. See `moirais.fn.describe('ovrlp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ovrlp import *
import numpy as np
# See the function signature in fn/ovrlp.py for argument names.
```
