...
`print(result)` render. See `moirais.fn.describe('nscov')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nscov import *
import numpy as np
# See the function signature in fn/nscov.py for argument names.
```
