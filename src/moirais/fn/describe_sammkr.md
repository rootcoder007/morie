# describe('sammkr') — sam_multi_mask_rank
...
`print(result)` render. See `moirais.fn.describe('sammkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sammkr import *
import numpy as np
# See the function signature in fn/sammkr.py for argument names.
```
