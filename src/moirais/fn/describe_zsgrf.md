...
`print(result)` render. See `moirais.fn.describe('zsgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsgrf import *
import numpy as np
# See the function signature in fn/zsgrf.py for argument names.
```
