# describe('bal') — balance_diagnostics
...
`print(result)` render. See `moirais.fn.describe('bal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bal import *
import numpy as np
# See the function signature in fn/bal.py for argument names.
```
