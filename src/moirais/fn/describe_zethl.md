...
`print(result)` render. See `moirais.fn.describe('zethl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zethl import *
import numpy as np
# See the function signature in fn/zethl.py for argument names.
```
