# describe('jodif') — joseph_differencing
...
`print(result)` render. See `moirais.fn.describe('jodif')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jodif import *
import numpy as np
# See the function signature in fn/jodif.py for argument names.
```
