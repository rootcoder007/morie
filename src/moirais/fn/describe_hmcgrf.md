# describe('hmcgrf') — geron_computational_graph
...
`print(result)` render. See `moirais.fn.describe('hmcgrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmcgrf import *
import numpy as np
# See the function signature in fn/hmcgrf.py for argument names.
```
