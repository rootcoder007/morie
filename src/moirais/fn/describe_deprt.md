# describe('deprt') — dependency_ratio
...
`print(result)` render. See `moirais.fn.describe('deprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.deprt import *
import numpy as np
# See the function signature in fn/deprt.py for argument names.
```
