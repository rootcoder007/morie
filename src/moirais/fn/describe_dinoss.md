# describe('dinoss') — dino_centering
...
`print(result)` render. See `moirais.fn.describe('dinoss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dinoss import *
import numpy as np
# See the function signature in fn/dinoss.py for argument names.
```
