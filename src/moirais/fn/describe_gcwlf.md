...
`print(result)` render. See `moirais.fn.describe('gcwlf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcwlf import *
import numpy as np
# See the function signature in fn/gcwlf.py for argument names.
```
