# describe('drovw') — dr_overlap_weighted
...
`print(result)` render. See `moirais.fn.describe('drovw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drovw import *
import numpy as np
# See the function signature in fn/drovw.py for argument names.
```
