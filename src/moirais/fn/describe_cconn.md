...
`print(result)` render. See `moirais.fn.describe('cconn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cconn import *
import numpy as np
# See the function signature in fn/cconn.py for argument names.
```
