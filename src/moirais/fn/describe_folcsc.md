...
`print(result)` render. See `moirais.fn.describe('folcsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.folcsc import *
import numpy as np
# See the function signature in fn/folcsc.py for argument names.
```
