...
__all__ = ["guide_on_data_analysis_chapter_6_unnumbered_538"]


def guide_on_data_analysis_chapter_6_unnumbered_538(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] data = dat[dat$depth == 60,])
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis6u538')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis6u538: GeneralStatistics expression (auto-extracted; see ref)."
