# describe('zerrk') — relative_risk_kern
...
`print(result)` render. See `moirais.fn.describe('zerrk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zerrk import *
import numpy as np
# See the function signature in fn/zerrk.py for argument names.
```
