# describe('nocse') — nominate_confidence_interval
...
`print(result)` render. See `moirais.fn.describe('nocse')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nocse import *
import numpy as np
# See the function signature in fn/nocse.py for argument names.
```
