...
__all__ = ["hedderich_chapter_9_unnumbered_1194"]


def hedderich_chapter_9_unnumbered_1194(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Example: ˆp = 0.4 CV = 0.1 N = 4000
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1194')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1194: PowerAndDesign expression (auto-extracted; see ref)."
