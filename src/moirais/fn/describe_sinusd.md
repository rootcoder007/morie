...
`print(result)` render. See `moirais.fn.describe('sinusd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sinusd import *
import numpy as np
# See the function signature in fn/sinusd.py for argument names.
```
