# describe('tmlcom') — tmle_compositional
...
`print(result)` render. See `moirais.fn.describe('tmlcom')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcom import *
import numpy as np
# See the function signature in fn/tmlcom.py for argument names.
```
