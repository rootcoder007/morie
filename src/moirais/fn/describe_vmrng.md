...
`print(result)` render. See `moirais.fn.describe('vmrng')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmrng import *
import numpy as np
# See the function signature in fn/vmrng.py for argument names.
```
