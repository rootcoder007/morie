...
__all__ = ["hedderich_chapter_9_unnumbered_3109"]


def hedderich_chapter_9_unnumbered_3109(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] |R|= (1−0.852−0.712−0.802) + (2·0.85·0.71·0.80) = 0.099
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3109')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3109: GeneralStatistics expression (auto-extracted; see ref)."
