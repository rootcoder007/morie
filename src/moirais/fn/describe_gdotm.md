...
`print(result)` render. See `moirais.fn.describe('gdotm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gdotm import *
import numpy as np
# See the function signature in fn/gdotm.py for argument names.
```
