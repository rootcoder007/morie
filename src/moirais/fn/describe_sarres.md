...
`print(result)` render. See `moirais.fn.describe('sarres')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarres import *
import numpy as np
# See the function signature in fn/sarres.py for argument names.
```
