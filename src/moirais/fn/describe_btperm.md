# describe('btperm') — boot_permutation_test
...
`print(result)` render. See `moirais.fn.describe('btperm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btperm import *
import numpy as np
# See the function signature in fn/btperm.py for argument names.
```
