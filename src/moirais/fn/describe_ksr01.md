# describe('ksr01') — kosorok_empirical_process
...
`print(result)` render. See `moirais.fn.describe('ksr01')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr01 import *
import numpy as np
# See the function signature in fn/ksr01.py for argument names.
```
