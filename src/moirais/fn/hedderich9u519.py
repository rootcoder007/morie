...
__all__ = ["hedderich_chapter_9_unnumbered_519"]


def hedderich_chapter_9_unnumbered_519(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (a)p = 300/900 = 0.333 c = 30/300 = 0.10
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u519')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u519: GeneralStatistics expression (auto-extracted; see ref)."
