# describe('shazm') — simultaneous_test
...
`print(result)` render. See `moirais.fn.describe('shazm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shazm import *
import numpy as np
# See the function signature in fn/shazm.py for argument names.
```
