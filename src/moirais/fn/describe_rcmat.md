# describe('rcmat') — rectangular_matrix
...
`print(result)` render. See `moirais.fn.describe('rcmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcmat import *
import numpy as np
# See the function signature in fn/rcmat.py for argument names.
```
