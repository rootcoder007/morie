...
`print(result)` render. See `moirais.fn.describe('srmix')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srmix import *
import numpy as np
# See the function signature in fn/srmix.py for argument names.
```
