# describe('sgwts') — spatial_weights_matrix
...
`print(result)` render. See `moirais.fn.describe('sgwts')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgwts import *
import numpy as np
# See the function signature in fn/sgwts.py for argument names.
```
