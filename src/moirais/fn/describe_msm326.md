# describe('msm326') — mvsml_functional_regression_eq_15_2
...
`print(result)` render. See `moirais.fn.describe('msm326')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm326 import *
import numpy as np
# See the function signature in fn/msm326.py for argument names.
```
