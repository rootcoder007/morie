# describe('vgdir') — directional_vario
...
`print(result)` render. See `moirais.fn.describe('vgdir')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgdir import *
import numpy as np
# See the function signature in fn/vgdir.py for argument names.
```
