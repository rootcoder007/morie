...
__all__ = ["hedderich_chapter_9_unnumbered_154"]


def hedderich_chapter_9_unnumbered_154(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 5.3 instead of ranks 1, 2, 3, each the middle rank (1 + 2 + 3)/3 = 2 , i.e., 2, 2, 2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u154')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u154: GeneralStatistics expression (auto-extracted; see ref)."
