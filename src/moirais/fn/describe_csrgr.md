...
`print(result)` render. See `moirais.fn.describe('csrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csrgr import *
import numpy as np
# See the function signature in fn/csrgr.py for argument names.
```
