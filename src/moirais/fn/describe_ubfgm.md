...
`print(result)` render. See `moirais.fn.describe('ubfgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ubfgm import *
import numpy as np
# See the function signature in fn/ubfgm.py for argument names.
```
