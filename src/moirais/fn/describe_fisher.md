# describe('fisher') — fisher_exact_test
...
`print(result)` render. See `moirais.fn.describe('fisher')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fisher import *
import numpy as np
# See the function signature in fn/fisher.py for argument names.
```
