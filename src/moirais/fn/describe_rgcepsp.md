# describe('rgcepsp') — rangayyan_cepstrum_pitch
...
`print(result)` render. See `moirais.fn.describe('rgcepsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcepsp import *
import numpy as np
# See the function signature in fn/rgcepsp.py for argument names.
```
