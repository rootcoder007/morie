...
__all__ = ["hedderich_chapter_9_unnumbered_2016"]


def hedderich_chapter_9_unnumbered_2016(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: There are n1 +n2−2 = 28 degrees of freedom available, i.e. t28;0.975 = 2.048. Since ˆt =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2016')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2016: GeneralStatistics expression (auto-extracted; see ref)."
