# describe('hrzasym') — horowitz_one_step_efficient
...
`print(result)` render. See `moirais.fn.describe('hrzasym')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzasym import *
import numpy as np
# See the function signature in fn/hrzasym.py for argument names.
```
