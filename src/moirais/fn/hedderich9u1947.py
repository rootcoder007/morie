...
__all__ = ["hedderich_chapter_9_unnumbered_1947"]


def hedderich_chapter_9_unnumbered_1947(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: Example: Given ares1 = 14 s2 = 12 n1 =n2 = 500 ;
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1947')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1947: PowerAndDesign expression (auto-extracted; see ref)."
