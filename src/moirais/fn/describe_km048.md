# describe('km048') — kamath_ch3_cloze_prompt_template
...
`print(result)` render. See `moirais.fn.describe('km048')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km048 import *
import numpy as np
# See the function signature in fn/km048.py for argument names.
```
