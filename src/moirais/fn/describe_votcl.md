# describe('votcl') — voting_classify
...
`print(result)` render. See `moirais.fn.describe('votcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.votcl import *
import numpy as np
# See the function signature in fn/votcl.py for argument names.
```
