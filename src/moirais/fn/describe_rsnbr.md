...
`print(result)` render. See `moirais.fn.describe('rsnbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsnbr import *
import numpy as np
# See the function signature in fn/rsnbr.py for argument names.
```
