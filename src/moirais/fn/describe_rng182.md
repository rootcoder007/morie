# describe('rng182') — rangayyan_ch4_pan_tompkins_lowpass_difference_eq
...
`print(result)` render. See `moirais.fn.describe('rng182')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng182 import *
import numpy as np
# See the function signature in fn/rng182.py for argument names.
```
