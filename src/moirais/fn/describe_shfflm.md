...
`print(result)` render. See `moirais.fn.describe('shfflm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shfflm import *
import numpy as np
# See the function signature in fn/shfflm.py for argument names.
```
