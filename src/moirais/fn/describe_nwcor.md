# describe('nwcor') — network_correlation
...
`print(result)` render. See `moirais.fn.describe('nwcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nwcor import *
import numpy as np
# See the function signature in fn/nwcor.py for argument names.
```
