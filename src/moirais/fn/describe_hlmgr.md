# describe('hlmgr') — hlm_gamma_matrix
...
`print(result)` render. See `moirais.fn.describe('hlmgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hlmgr import *
import numpy as np
# See the function signature in fn/hlmgr.py for argument names.
```
