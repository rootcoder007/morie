...
`print(result)` render. See `moirais.fn.describe('ppmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ppmnl import *
import numpy as np
# See the function signature in fn/ppmnl.py for argument names.
```
