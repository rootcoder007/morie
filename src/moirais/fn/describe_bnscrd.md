# describe('bnscrd') — bound_causal_rd
...
`print(result)` render. See `moirais.fn.describe('bnscrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnscrd import *
import numpy as np
# See the function signature in fn/bnscrd.py for argument names.
```
