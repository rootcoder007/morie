...
`print(result)` render. See `moirais.fn.describe('vmstb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmstb import *
import numpy as np
# See the function signature in fn/vmstb.py for argument names.
```
