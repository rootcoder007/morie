...
`print(result)` render. See `moirais.fn.describe('mchfl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mchfl import *
import numpy as np
# See the function signature in fn/mchfl.py for argument names.
```
