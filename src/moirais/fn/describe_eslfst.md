...
`print(result)` render. See `moirais.fn.describe('eslfst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslfst import *
import numpy as np
# See the function signature in fn/eslfst.py for argument names.
```
