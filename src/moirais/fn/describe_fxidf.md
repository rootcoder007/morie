# describe('fxidf') — effect_modification
...
`print(result)` render. See `moirais.fn.describe('fxidf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fxidf import *
import numpy as np
# See the function signature in fn/fxidf.py for argument names.
```
