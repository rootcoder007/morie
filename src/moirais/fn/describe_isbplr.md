...
`print(result)` render. See `moirais.fn.describe('isbplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isbplr import *
import numpy as np
# See the function signature in fn/isbplr.py for argument names.
```
