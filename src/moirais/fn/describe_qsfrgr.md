# describe('qsfrgr') — quantile_survival_forest
...
`print(result)` render. See `moirais.fn.describe('qsfrgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qsfrgr import *
import numpy as np
# See the function signature in fn/qsfrgr.py for argument names.
```
