...
`print(result)` render. See `moirais.fn.describe('fdisc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fdisc import *
import numpy as np
# See the function signature in fn/fdisc.py for argument names.
```
