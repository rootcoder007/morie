...
__all__ = ["wilcox_chapter_12_unnumbered_1382"]


def wilcox_chapter_12_unnumbered_1382(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 8.77, q = 4.1, reject. (e) f = 2.47, S =
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox12u1382')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1382: PowerAndDesign expression (auto-extracted; see ref)."
