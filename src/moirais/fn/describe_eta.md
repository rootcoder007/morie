...
`print(result)` render. See `moirais.fn.describe('eta')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eta import *
import numpy as np
# See the function signature in fn/eta.py for argument names.
```
