# describe('strpf') — string_partition
...
`print(result)` render. See `moirais.fn.describe('strpf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.strpf import *
import numpy as np
# See the function signature in fn/strpf.py for argument names.
```
