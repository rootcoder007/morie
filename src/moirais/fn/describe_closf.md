...
`print(result)` render. See `moirais.fn.describe('closf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.closf import *
import numpy as np
# See the function signature in fn/closf.py for argument names.
```
