# describe('sglss') — squared_error_loss
...
`print(result)` render. See `moirais.fn.describe('sglss')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sglss import *
import numpy as np
# See the function signature in fn/sglss.py for argument names.
```
