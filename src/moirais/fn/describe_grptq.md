# describe('grptq') — geron_static_ptq
...
`print(result)` render. See `moirais.fn.describe('grptq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grptq import *
import numpy as np
# See the function signature in fn/grptq.py for argument names.
```
