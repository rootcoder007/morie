...
`print(result)` render. See `moirais.fn.describe('sfmemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sfmemb import *
import numpy as np
# See the function signature in fn/sfmemb.py for argument names.
```
