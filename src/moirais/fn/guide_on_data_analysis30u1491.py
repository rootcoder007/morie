...
__all__ = ["guide_on_data_analysis_chapter_30_unnumbered_1491"]


def guide_on_data_analysis_chapter_30_unnumbered_1491(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] #> year = -5 x cohort = 7 -0.32 (0.70)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis30u1491')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis30u1491: GeneralStatistics expression (auto-extracted; see ref)."
