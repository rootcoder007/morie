...
`print(result)` render. See `moirais.fn.describe('rtefv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rtefv import *
import numpy as np
# See the function signature in fn/rtefv.py for argument names.
```
