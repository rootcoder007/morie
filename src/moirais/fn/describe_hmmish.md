...
`print(result)` render. See `moirais.fn.describe('hmmish')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmish import *
import numpy as np
# See the function signature in fn/hmmish.py for argument names.
```
