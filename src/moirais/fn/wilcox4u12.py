...
__all__ = ["wilcox_chapter_4_unnumbered_12"]


def wilcox_chapter_4_unnumbered_12(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] q1 = (1 − h)X(j) +hX(j+1), (2.6)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u12')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u12: GeneralStatistics expression (auto-extracted; see ref)."
