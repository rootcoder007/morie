# describe('rgtwamx') — rangayyan_twa_spectral_mx
...
`print(result)` render. See `moirais.fn.describe('rgtwamx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgtwamx import *
import numpy as np
# See the function signature in fn/rgtwamx.py for argument names.
```
