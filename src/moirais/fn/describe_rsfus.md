...
`print(result)` render. See `moirais.fn.describe('rsfus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsfus import *
import numpy as np
# See the function signature in fn/rsfus.py for argument names.
```
