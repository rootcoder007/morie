# describe('ksr047') — kosorok_ch2_kaplan_meier_self_consistency
...
`print(result)` render. See `moirais.fn.describe('ksr047')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr047 import *
import numpy as np
# See the function signature in fn/ksr047.py for argument names.
```
