...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_277"]


def guide_on_data_analysis_chapter_5_unnumbered_277(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = 1 − 𝑃(𝐴1) − 𝑃(𝐴2) + 𝑃(𝐴1 ∩ 𝐴2),
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u277')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u277: GeneralStatistics expression (auto-extracted; see ref)."
