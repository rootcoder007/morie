...
`print(result)` render. See `moirais.fn.describe('irv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irv import *
import numpy as np
# See the function signature in fn/irv.py for argument names.
```
