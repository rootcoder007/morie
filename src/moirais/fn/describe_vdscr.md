# describe('vdscr') — validity_discriminant
...
`print(result)` render. See `moirais.fn.describe('vdscr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vdscr import *
import numpy as np
# See the function signature in fn/vdscr.py for argument names.
```
