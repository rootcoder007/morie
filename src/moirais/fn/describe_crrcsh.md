# describe('crrcsh') — cause_specific_hazard
...
`print(result)` render. See `moirais.fn.describe('crrcsh')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crrcsh import *
import numpy as np
# See the function signature in fn/crrcsh.py for argument names.
```
