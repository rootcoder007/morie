# describe('cvxprg') — boyd_proximal_grad
...
`print(result)` render. See `moirais.fn.describe('cvxprg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxprg import *
import numpy as np
# See the function signature in fn/cvxprg.py for argument names.
```
