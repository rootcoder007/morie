...
__all__ = ["wilcox_chapter_10_unnumbered_1045"]


def wilcox_chapter_10_unnumbered_1045(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: outproad(m,gval = NA, center = NA, plotit = T, op = T, MM = F, cop = 3, xlab
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u1045')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u1045: GeneralStatistics expression (auto-extracted; see ref)."
