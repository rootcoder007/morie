# describe('volgo') — vol_garch_orthogonal
...
`print(result)` render. See `moirais.fn.describe('volgo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volgo import *
import numpy as np
# See the function signature in fn/volgo.py for argument names.
```
