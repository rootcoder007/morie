# describe('modwt') — modwt_decompose
...
`print(result)` render. See `moirais.fn.describe('modwt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modwt import *
import numpy as np
# See the function signature in fn/modwt.py for argument names.
```
