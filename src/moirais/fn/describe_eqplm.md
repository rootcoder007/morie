...
`print(result)` render. See `moirais.fn.describe('eqplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eqplm import *
import numpy as np
# See the function signature in fn/eqplm.py for argument names.
```
