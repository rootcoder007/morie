# describe('btciratio') — boot_ci_ratio
...
`print(result)` render. See `moirais.fn.describe('btciratio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btciratio import *
import numpy as np
# See the function signature in fn/btciratio.py for argument names.
```
