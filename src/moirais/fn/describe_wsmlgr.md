# describe('wsmlgr') — wasserman_logistic_regression
...
`print(result)` render. See `moirais.fn.describe('wsmlgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlgr import *
import numpy as np
# See the function signature in fn/wsmlgr.py for argument names.
```
