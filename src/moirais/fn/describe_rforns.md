...
`print(result)` render. See `moirais.fn.describe('rforns')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rforns import *
import numpy as np
# See the function signature in fn/rforns.py for argument names.
```
