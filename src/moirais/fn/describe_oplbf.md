...
`print(result)` render. See `moirais.fn.describe('oplbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.oplbf import *
import numpy as np
# See the function signature in fn/oplbf.py for argument names.
```
