...
__all__ = ["bivand2013_chapter_7_unnumbered_267"]


def bivand2013_chapter_7_unnumbered_267(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + beta = 0, precu = 0.001, precv = 0.001)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u267')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u267: GeneralStatistics expression (auto-extracted; see ref)."
