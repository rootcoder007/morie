...
`print(result)` render. See `moirais.fn.describe('siuot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siuot import *
import numpy as np
# See the function signature in fn/siuot.py for argument names.
```
