# describe('gb5712') — gibbons_wsrt_power
...
`print(result)` render. See `moirais.fn.describe('gb5712')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb5712 import *
import numpy as np
# See the function signature in fn/gb5712.py for argument names.
```
