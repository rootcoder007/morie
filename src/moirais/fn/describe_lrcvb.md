# describe('lrcvb') — learning_curve_bio
...
`print(result)` render. See `moirais.fn.describe('lrcvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lrcvb import *
import numpy as np
# See the function signature in fn/lrcvb.py for argument names.
```
