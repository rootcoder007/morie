...
`print(result)` render. See `moirais.fn.describe('erfunc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.erfunc import *
import numpy as np
# See the function signature in fn/erfunc.py for argument names.
```
