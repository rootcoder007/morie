...
__all__ = ["hedderich_chapter_9_unnumbered_1147"]


def hedderich_chapter_9_unnumbered_1147(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] (1−p) = 1−0.02 = 0.98, i.e.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1147')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1147: GeneralStatistics expression (auto-extracted; see ref)."
