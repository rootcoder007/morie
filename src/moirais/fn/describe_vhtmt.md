...
`print(result)` render. See `moirais.fn.describe('vhtmt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vhtmt import *
import numpy as np
# See the function signature in fn/vhtmt.py for argument names.
```
