# describe('hmrsc') — geron_randomized_search
...
`print(result)` render. See `moirais.fn.describe('hmrsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmrsc import *
import numpy as np
# See the function signature in fn/hmrsc.py for argument names.
```
