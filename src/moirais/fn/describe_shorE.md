...
`print(result)` render. See `moirais.fn.describe('shorE')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shorE import *
import numpy as np
# See the function signature in fn/shorE.py for argument names.
```
