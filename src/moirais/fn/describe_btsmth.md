...
`print(result)` render. See `moirais.fn.describe('btsmth')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btsmth import *
import numpy as np
# See the function signature in fn/btsmth.py for argument names.
```
