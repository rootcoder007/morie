# describe('mood') — mood_median_test
...
`print(result)` render. See `moirais.fn.describe('mood')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mood import *
import numpy as np
# See the function signature in fn/mood.py for argument names.
```
