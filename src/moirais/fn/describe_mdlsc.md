...
`print(result)` render. See `moirais.fn.describe('mdlsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mdlsc import *
import numpy as np
# See the function signature in fn/mdlsc.py for argument names.
```
