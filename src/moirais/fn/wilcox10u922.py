...
__all__ = ["wilcox_chapter_10_unnumbered_922"]


def wilcox_chapter_10_unnumbered_922(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: by implication, the hypotheses H0: µ 1 = µ 3, H0: µ 1 = µ 4, and H0: µ 3 = µ 4 would not be
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox10u922')`` for the full guide.
...
def cheatsheet():
    return "wilcox10u922: GeneralStatistics expression (auto-extracted; see ref)."
