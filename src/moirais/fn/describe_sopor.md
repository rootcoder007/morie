...
`print(result)` render. See `moirais.fn.describe('sopor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sopor import *
import numpy as np
# See the function signature in fn/sopor.py for argument names.
```
