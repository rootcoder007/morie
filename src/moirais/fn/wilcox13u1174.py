...
__all__ = ["wilcox_chapter_13_unnumbered_1174"]


def wilcox_chapter_13_unnumbered_1174(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: β 0,...,β p, Y = β 0 +β 1X1 + · · · +β pXp +e. Here, it is not assumed that the error term is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1174')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1174: GeneralStatistics expression (auto-extracted; see ref)."
