# describe('vrmed') — variance_based_mediation
...
`print(result)` render. See `moirais.fn.describe('vrmed')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrmed import *
import numpy as np
# See the function signature in fn/vrmed.py for argument names.
```
