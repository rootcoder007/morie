# describe('lscur') — loss_curve_analysis
...
`print(result)` render. See `moirais.fn.describe('lscur')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lscur import *
import numpy as np
# See the function signature in fn/lscur.py for argument names.
```
