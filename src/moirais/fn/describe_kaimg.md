...
`print(result)` render. See `moirais.fn.describe('kaimg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kaimg import *
import numpy as np
# See the function signature in fn/kaimg.py for argument names.
```
