# describe('rgemdtwa') — rangayyan_emd_twa
...
`print(result)` render. See `moirais.fn.describe('rgemdtwa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgemdtwa import *
import numpy as np
# See the function signature in fn/rgemdtwa.py for argument names.
```
