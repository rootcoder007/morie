# describe('ofreq') — otis_freq_table
...
`print(result)` render. See `moirais.fn.describe('ofreq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ofreq import *
import numpy as np
# See the function signature in fn/ofreq.py for argument names.
```
