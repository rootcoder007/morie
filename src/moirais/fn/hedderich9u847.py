...
__all__ = ["hedderich_chapter_9_unnumbered_847"]


def hedderich_chapter_9_unnumbered_847(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P = [0.5−0.06681] + [0.5−0.15866] = 0.77453 .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u847')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u847: GeneralStatistics expression (auto-extracted; see ref)."
