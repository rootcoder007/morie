...
`print(result)` render. See `moirais.fn.describe('ghsdm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghsdm import *
import numpy as np
# See the function signature in fn/ghsdm.py for argument names.
```
