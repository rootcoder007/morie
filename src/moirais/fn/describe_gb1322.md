# describe('gb1322') — gibbons_are_formula
...
`print(result)` render. See `moirais.fn.describe('gb1322')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb1322 import *
import numpy as np
# See the function signature in fn/gb1322.py for argument names.
```
