...
`print(result)` render. See `moirais.fn.describe('hyrch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hyrch import *
import numpy as np
# See the function signature in fn/hyrch.py for argument names.
```
