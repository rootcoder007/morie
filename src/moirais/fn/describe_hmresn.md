...
`print(result)` render. See `moirais.fn.describe('hmresn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmresn import *
import numpy as np
# See the function signature in fn/hmresn.py for argument names.
```
