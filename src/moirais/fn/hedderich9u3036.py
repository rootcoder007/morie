...
__all__ = ["hedderich_chapter_9_unnumbered_3036"]


def hedderich_chapter_9_unnumbered_3036(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: H0 : pi. =p.j for alli=j=1,...,k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3036')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3036: ContingencyTables expression (auto-extracted; see ref)."
