...
`print(result)` render. See `moirais.fn.describe('bnut')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bnut import *
import numpy as np
# See the function signature in fn/bnut.py for argument names.
```
