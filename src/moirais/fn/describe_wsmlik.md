# describe('wsmlik') — wasserman_likelihood
...
`print(result)` render. See `moirais.fn.describe('wsmlik')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlik import *
import numpy as np
# See the function signature in fn/wsmlik.py for argument names.
```
