# describe('sgtbtw') — sgt_betweenness_centrality
...
`print(result)` render. See `moirais.fn.describe('sgtbtw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sgtbtw import *
import numpy as np
# See the function signature in fn/sgtbtw.py for argument names.
```
