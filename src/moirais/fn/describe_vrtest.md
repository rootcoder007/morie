# describe('vrtest') — variance_component_lr_boundary
...
`print(result)` render. See `moirais.fn.describe('vrtest')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrtest import *
import numpy as np
# See the function signature in fn/vrtest.py for argument names.
```
