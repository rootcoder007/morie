# describe('otmd') — ot_mahalanobis_distance_ot
...
`print(result)` render. See `moirais.fn.describe('otmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmd import *
import numpy as np
# See the function signature in fn/otmd.py for argument names.
```
