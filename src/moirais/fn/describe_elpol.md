...
`print(result)` render. See `moirais.fn.describe('elpol')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.elpol import *
import numpy as np
# See the function signature in fn/elpol.py for argument names.
```
