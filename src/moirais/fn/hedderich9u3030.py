...
__all__ = ["hedderich_chapter_9_unnumbered_3030"]


def hedderich_chapter_9_unnumbered_3030(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 22 + 8 = 33.333> 16.266 = χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3030')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3030: GeneralStatistics expression (auto-extracted; see ref)."
