# describe('siuof') — siu_officer_force

## WHAT IT DOES

Use of force in SIU cases analysis.
...
`print(result)` render. See `moirais.fn.describe('siuof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.siuof import *
import numpy as np
# See the function signature in fn/siuof.py for argument names.
```
