# describe('msm109') — mvsml_bayesian_regression_pt2_eq_7_7
...
`print(result)` render. See `moirais.fn.describe('msm109')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm109 import *
import numpy as np
# See the function signature in fn/msm109.py for argument names.
```
