# describe('algqa') — alammar_grouped_query_attention
...
`print(result)` render. See `moirais.fn.describe('algqa')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.algqa import *
import numpy as np
# See the function signature in fn/algqa.py for argument names.
```
