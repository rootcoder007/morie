...
`print(result)` render. See `moirais.fn.describe('gcupw')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcupw import *
import numpy as np
# See the function signature in fn/gcupw.py for argument names.
```
