...
__all__ = ["hedderich_chapter_9_unnumbered_2990"]


def hedderich_chapter_9_unnumbered_2990(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] χ2≤n·min (r−1, c−1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2990')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2990: GeneralStatistics expression (auto-extracted; see ref)."
