...
__all__ = ["hedderich_chapter_9_unnumbered_821"]


def hedderich_chapter_9_unnumbered_821(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] P (−3Z̄≤+3) = 0 .99730
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u821')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u821: GeneralStatistics expression (auto-extracted; see ref)."
