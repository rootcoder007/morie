...
`print(result)` render. See `moirais.fn.describe('svmxu')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmxu import *
import numpy as np
# See the function signature in fn/svmxu.py for argument names.
```
