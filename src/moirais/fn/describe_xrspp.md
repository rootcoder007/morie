...
`print(result)` render. See `moirais.fn.describe('xrspp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrspp import *
import numpy as np
# See the function signature in fn/xrspp.py for argument names.
```
