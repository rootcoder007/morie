...
__all__ = ["wilcox_chapter_13_unnumbered_1369"]


def wilcox_chapter_13_unnumbered_1369(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: reject. (b) Tt = 0.298, fail to reject. (c) Tt = 0.894, fail to reject. 28. Tt = −3.1, reject. 29.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1369')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1369: GeneralStatistics expression (auto-extracted; see ref)."
