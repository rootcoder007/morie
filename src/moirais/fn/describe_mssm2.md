...
`print(result)` render. See `moirais.fn.describe('mssm2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mssm2 import *
import numpy as np
# See the function signature in fn/mssm2.py for argument names.
```
