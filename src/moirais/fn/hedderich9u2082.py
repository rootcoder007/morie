...
__all__ = ["hedderich_chapter_9_unnumbered_2082"]


def hedderich_chapter_9_unnumbered_2082(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] D2 = (¯ x1−¯ x2)′W−1 (¯ x1−¯ x2) (7.115)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2082')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2082: GeneralStatistics expression (auto-extracted; see ref)."
