...
`print(result)` render. See `moirais.fn.describe('irtlk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtlk import *
import numpy as np
# See the function signature in fn/irtlk.py for argument names.
```
