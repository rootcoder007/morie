# describe('khatd') — pareto_k_diagnostic
...
`print(result)` render. See `moirais.fn.describe('khatd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.khatd import *
import numpy as np
# See the function signature in fn/khatd.py for argument names.
```
