# describe('tmlsen') — tmle_sensitivity_unmeasured
...
`print(result)` render. See `moirais.fn.describe('tmlsen')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlsen import *
import numpy as np
# See the function signature in fn/tmlsen.py for argument names.
```
