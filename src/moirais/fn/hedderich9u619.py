...
__all__ = ["hedderich_chapter_9_unnumbered_619"]


def hedderich_chapter_9_unnumbered_619(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] px(1−p)n−x = 1 (5.49)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u619')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u619: CountModels expression (auto-extracted; see ref)."
