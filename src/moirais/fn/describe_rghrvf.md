# describe('rghrvf') — rangayyan_hrv_freq_domain
...
`print(result)` render. See `moirais.fn.describe('rghrvf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghrvf import *
import numpy as np
# See the function signature in fn/rghrvf.py for argument names.
```
