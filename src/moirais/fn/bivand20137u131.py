...
__all__ = ["bivand2013_chapter_7_unnumbered_131"]


def bivand2013_chapter_7_unnumbered_131(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + savefuns = TRUE, simulate = expression(rlabelp(pppasthma,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u131')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u131: GeneralStatistics expression (auto-extracted; see ref)."
