# describe('gb738') — gibbons_chernoff_savage
...
`print(result)` render. See `moirais.fn.describe('gb738')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb738 import *
import numpy as np
# See the function signature in fn/gb738.py for argument names.
```
