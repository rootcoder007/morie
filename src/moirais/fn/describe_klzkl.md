# describe('klzkl') — kaluza_klein_spectrum
...
`print(result)` render. See `moirais.fn.describe('klzkl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.klzkl import *
import numpy as np
# See the function signature in fn/klzkl.py for argument names.
```
