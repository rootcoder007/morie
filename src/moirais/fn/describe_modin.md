...
`print(result)` render. See `moirais.fn.describe('modin')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.modin import *
import numpy as np
# See the function signature in fn/modin.py for argument names.
```
