...
`print(result)` render. See `moirais.fn.describe('rgqda')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgqda import *
import numpy as np
# See the function signature in fn/rgqda.py for argument names.
```
