# describe('mtgbl') — multi_trait_gblup
...
`print(result)` render. See `moirais.fn.describe('mtgbl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mtgbl import *
import numpy as np
# See the function signature in fn/mtgbl.py for argument names.
```
