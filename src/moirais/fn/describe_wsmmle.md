...
`print(result)` render. See `moirais.fn.describe('wsmmle')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmmle import *
import numpy as np
# See the function signature in fn/wsmmle.py for argument names.
```
