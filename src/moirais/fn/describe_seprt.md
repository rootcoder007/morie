# describe('seprt') — detect_separation
...
`print(result)` render. See `moirais.fn.describe('seprt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seprt import *
import numpy as np
# See the function signature in fn/seprt.py for argument names.
```
