# describe('rng035') — rangayyan_ch3_discrete_unit_step
...
`print(result)` render. See `moirais.fn.describe('rng035')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng035 import *
import numpy as np
# See the function signature in fn/rng035.py for argument names.
```
