...
`print(result)` render. See `moirais.fn.describe('mds_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mds_ import *
import numpy as np
# See the function signature in fn/mds_.py for argument names.
```
