# describe('joboxc') — joseph_box_cox_transform
...
`print(result)` render. See `moirais.fn.describe('joboxc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.joboxc import *
import numpy as np
# See the function signature in fn/joboxc.py for argument names.
```
