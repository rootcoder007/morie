# describe('hmstr') — geron_stratified_sampling
...
`print(result)` render. See `moirais.fn.describe('hmstr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmstr import *
import numpy as np
# See the function signature in fn/hmstr.py for argument names.
```
