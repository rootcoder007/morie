# describe('rng007') — rangayyan_ch3_sample_mean
...
`print(result)` render. See `moirais.fn.describe('rng007')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng007 import *
import numpy as np
# See the function signature in fn/rng007.py for argument names.
```
