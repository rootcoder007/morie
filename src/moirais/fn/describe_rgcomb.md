# describe('rgcomb') — rangayyan_comb_filter
...
`print(result)` render. See `moirais.fn.describe('rgcomb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgcomb import *
import numpy as np
# See the function signature in fn/rgcomb.py for argument names.
```
