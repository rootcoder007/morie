...
`print(result)` render. See `moirais.fn.describe('rsend')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsend import *
import numpy as np
# See the function signature in fn/rsend.py for argument names.
```
