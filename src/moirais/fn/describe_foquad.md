...
`print(result)` render. See `moirais.fn.describe('foquad')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.foquad import *
import numpy as np
# See the function signature in fn/foquad.py for argument names.
```
