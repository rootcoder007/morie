# describe('ksr044') — kosorok_ch2_quantile_taylor_bounds
...
`print(result)` render. See `moirais.fn.describe('ksr044')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr044 import *
import numpy as np
# See the function signature in fn/ksr044.py for argument names.
```
