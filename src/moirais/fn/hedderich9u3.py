...
__all__ = ["hedderich_chapter_9_unnumbered_3"]


def hedderich_chapter_9_unnumbered_3(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: andb = 32; by the way,−40◦C =−40◦F; to Kelvin: 0◦C = 273.15 K and 0 K =−273.15◦C].
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3: GeneralStatistics expression (auto-extracted; see ref)."
