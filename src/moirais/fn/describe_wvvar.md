# describe('wvvar') — wavelet_variance
...
`print(result)` render. See `moirais.fn.describe('wvvar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvvar import *
import numpy as np
# See the function signature in fn/wvvar.py for argument names.
```
