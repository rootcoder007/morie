# describe('wnomp') — wnominate_probability
...
`print(result)` render. See `moirais.fn.describe('wnomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wnomp import *
import numpy as np
# See the function signature in fn/wnomp.py for argument names.
```
