...
`print(result)` render. See `moirais.fn.describe('vmgau')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmgau import *
import numpy as np
# See the function signature in fn/vmgau.py for argument names.
```
