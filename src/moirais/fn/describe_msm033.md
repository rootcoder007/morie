# describe('msm033') — mvsml_linear_mixed_models_eq_5_6
...
`print(result)` render. See `moirais.fn.describe('msm033')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm033 import *
import numpy as np
# See the function signature in fn/msm033.py for argument names.
```
