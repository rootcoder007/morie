...
__all__ = ["hedderich_chapter_9_unnumbered_664"]


def hedderich_chapter_9_unnumbered_664(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: [EQ] P (X = 5, ˆλ= 2) = e−2·25
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u664')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u664: CountModels expression (auto-extracted; see ref)."
