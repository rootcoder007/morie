...
`print(result)` render. See `moirais.fn.describe('clstal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clstal import *
import numpy as np
# See the function signature in fn/clstal.py for argument names.
```
