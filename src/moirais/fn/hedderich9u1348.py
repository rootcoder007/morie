...
__all__ = ["hedderich_chapter_9_unnumbered_1348"]


def hedderich_chapter_9_unnumbered_1348(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] + i f ( side == " two − sided " ) {
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1348')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1348: GeneralStatistics expression (auto-extracted; see ref)."
