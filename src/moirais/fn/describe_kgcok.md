...
`print(result)` render. See `moirais.fn.describe('kgcok')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgcok import *
import numpy as np
# See the function signature in fn/kgcok.py for argument names.
```
