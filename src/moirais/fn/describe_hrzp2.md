# describe('hrzp2') — horowitz_plr_bandwidth
...
`print(result)` render. See `moirais.fn.describe('hrzp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzp2 import *
import numpy as np
# See the function signature in fn/hrzp2.py for argument names.
```
