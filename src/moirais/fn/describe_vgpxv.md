# describe('vgpxv') — pseudo_cross_vario
...
`print(result)` render. See `moirais.fn.describe('vgpxv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vgpxv import *
import numpy as np
# See the function signature in fn/vgpxv.py for argument names.
```
