# describe('jopatt') — joseph_patchtst
...
`print(result)` render. See `moirais.fn.describe('jopatt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jopatt import *
import numpy as np
# See the function signature in fn/jopatt.py for argument names.
```
