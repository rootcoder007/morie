...
`print(result)` render. See `moirais.fn.describe('vmdmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vmdmp import *
import numpy as np
# See the function signature in fn/vmdmp.py for argument names.
```
