...
`print(result)` render. See `moirais.fn.describe('sarols')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarols import *
import numpy as np
# See the function signature in fn/sarols.py for argument names.
```
