# describe('rgppg') — rangayyan_ppg_features
...
`print(result)` render. See `moirais.fn.describe('rgppg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgppg import *
import numpy as np
# See the function signature in fn/rgppg.py for argument names.
```
