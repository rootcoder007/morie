...
`print(result)` render. See `moirais.fn.describe('nfact')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nfact import *
import numpy as np
# See the function signature in fn/nfact.py for argument names.
```
