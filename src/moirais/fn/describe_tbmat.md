# describe('tbmat') — tbmat

## WHAT IT DOES

Turning bands Matern covariance.
...
`print(result)` render. See `moirais.fn.describe('tbmat')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tbmat import *
import numpy as np
# See the function signature in fn/tbmat.py for argument names.
```
