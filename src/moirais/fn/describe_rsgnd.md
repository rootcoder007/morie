...
`print(result)` render. See `moirais.fn.describe('rsgnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rsgnd import *
import numpy as np
# See the function signature in fn/rsgnd.py for argument names.
```
