# describe('volcorpst') — vol_corradi_swan_persistence
...
`print(result)` render. See `moirais.fn.describe('volcorpst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.volcorpst import *
import numpy as np
# See the function signature in fn/volcorpst.py for argument names.
```
