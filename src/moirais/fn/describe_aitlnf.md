# describe('aitlnf') — logistic_normal_fit
...
`print(result)` render. See `moirais.fn.describe('aitlnf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitlnf import *
import numpy as np
# See the function signature in fn/aitlnf.py for argument names.
```
