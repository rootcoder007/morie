# describe('nmrcy') — roll_call_yea_nay
...
`print(result)` render. See `moirais.fn.describe('nmrcy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmrcy import *
import numpy as np
# See the function signature in fn/nmrcy.py for argument names.
```
