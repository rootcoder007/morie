...
__all__ = ["spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_2_unnumbered_17"]


def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_2_unnumbered_17(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] p(Y|β , φ , θ ) ∝
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_2u17')`` for the full guide.
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_2u17: GeneralStatistics expression (auto-extracted; see ref)."
