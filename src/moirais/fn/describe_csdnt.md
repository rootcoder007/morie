...
`print(result)` render. See `moirais.fn.describe('csdnt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.csdnt import *
import numpy as np
# See the function signature in fn/csdnt.py for argument names.
```
