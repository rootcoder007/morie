...
__all__ = ["hedderich_chapter_9_unnumbered_2891"]


def hedderich_chapter_9_unnumbered_2891(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Here, the πi0 (i = 1,...,k ) are the probabilities assumed under the null hypothesis and n =∑k
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2891')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2891: GeneralStatistics expression (auto-extracted; see ref)."
