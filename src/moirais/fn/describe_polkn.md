# describe('polkn') — polynomial_kernel
...
`print(result)` render. See `moirais.fn.describe('polkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.polkn import *
import numpy as np
# See the function signature in fn/polkn.py for argument names.
```
