# describe('vcont') — content_validity_ratio
...
`print(result)` render. See `moirais.fn.describe('vcont')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vcont import *
import numpy as np
# See the function signature in fn/vcont.py for argument names.
```
