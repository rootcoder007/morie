...
`print(result)` render. See `moirais.fn.describe('stbkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.stbkrg import *
import numpy as np
# See the function signature in fn/stbkrg.py for argument names.
```
