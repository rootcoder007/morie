# describe('grdbs') — geron_dbscan_core_point
...
`print(result)` render. See `moirais.fn.describe('grdbs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grdbs import *
import numpy as np
# See the function signature in fn/grdbs.py for argument names.
```
