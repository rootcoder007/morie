...
`print(result)` render. See `moirais.fn.describe('svmopt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svmopt import *
import numpy as np
# See the function signature in fn/svmopt.py for argument names.
```
