# describe('rcdrt') — recidivism_trend
...
`print(result)` render. See `moirais.fn.describe('rcdrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rcdrt import *
import numpy as np
# See the function signature in fn/rcdrt.py for argument names.
```
