# describe('lncon') — linear_convolution
...
`print(result)` render. See `moirais.fn.describe('lncon')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lncon import *
import numpy as np
# See the function signature in fn/lncon.py for argument names.
```
