# describe('esmoeg') — esem_target_rotation
...
`print(result)` render. See `moirais.fn.describe('esmoeg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.esmoeg import *
import numpy as np
# See the function signature in fn/esmoeg.py for argument names.
```
