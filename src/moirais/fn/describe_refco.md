# describe('refco') — reflection_coeff_fn
...
`print(result)` render. See `moirais.fn.describe('refco')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.refco import *
import numpy as np
# See the function signature in fn/refco.py for argument names.
```
