...
`print(result)` render. See `moirais.fn.describe('plsev')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.plsev import *
import numpy as np
# See the function signature in fn/plsev.py for argument names.
```
