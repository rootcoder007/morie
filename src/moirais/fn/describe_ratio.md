# describe('ratio') — ratio_estimator
...
`print(result)` render. See `moirais.fn.describe('ratio')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ratio import *
import numpy as np
# See the function signature in fn/ratio.py for argument names.
```
