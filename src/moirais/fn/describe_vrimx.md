...
`print(result)` render. See `moirais.fn.describe('vrimx')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.vrimx import *
import numpy as np
# See the function signature in fn/vrimx.py for argument names.
```
