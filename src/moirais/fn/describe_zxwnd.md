...
`print(result)` render. See `moirais.fn.describe('zxwnd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxwnd import *
import numpy as np
# See the function signature in fn/zxwnd.py for argument names.
```
