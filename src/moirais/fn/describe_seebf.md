...
`print(result)` render. See `moirais.fn.describe('seebf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seebf import *
import numpy as np
# See the function signature in fn/seebf.py for argument names.
```
