# describe('desigeff') — design_effect
...
`print(result)` render. See `moirais.fn.describe('desigeff')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.desigeff import *
import numpy as np
# See the function signature in fn/desigeff.py for argument names.
```
