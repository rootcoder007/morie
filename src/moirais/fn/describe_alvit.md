# describe('alvit') — alammar_vit_patch_embedding
...
`print(result)` render. See `moirais.fn.describe('alvit')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.alvit import *
import numpy as np
# See the function signature in fn/alvit.py for argument names.
```
