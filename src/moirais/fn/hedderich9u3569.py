...
__all__ = ["hedderich_chapter_9_unnumbered_3569"]


def hedderich_chapter_9_unnumbered_3569(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: survreg (formula = Surv ( time , status) ~ group , data = chemo , dist = " exponential " )
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3569')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3569: GeneralStatistics expression (auto-extracted; see ref)."
