...
`print(result)` render. See `moirais.fn.describe('dnntt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dnntt import *
import numpy as np
# See the function signature in fn/dnntt.py for argument names.
```
