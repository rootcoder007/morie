...
`print(result)` render. See `moirais.fn.describe('pca_g')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pca_g import *
import numpy as np
# See the function signature in fn/pca_g.py for argument names.
```
