...
`print(result)` render. See `moirais.fn.describe('dtasy')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtasy import *
import numpy as np
# See the function signature in fn/dtasy.py for argument names.
```
