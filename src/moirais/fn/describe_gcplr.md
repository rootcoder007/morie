...
`print(result)` render. See `moirais.fn.describe('gcplr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcplr import *
import numpy as np
# See the function signature in fn/gcplr.py for argument names.
```
