# describe('aitlnp') — logistic_normal_pdf
...
`print(result)` render. See `moirais.fn.describe('aitlnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aitlnp import *
import numpy as np
# See the function signature in fn/aitlnp.py for argument names.
```
