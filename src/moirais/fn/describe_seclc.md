...
`print(result)` render. See `moirais.fn.describe('seclc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.seclc import *
import numpy as np
# See the function signature in fn/seclc.py for argument names.
```
