# describe('hrzsiqm') — horowitz_sim_quantile
...
`print(result)` render. See `moirais.fn.describe('hrzsiqm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzsiqm import *
import numpy as np
# See the function signature in fn/hrzsiqm.py for argument names.
```
