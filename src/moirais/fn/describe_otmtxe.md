# describe('otmtxe') — ot_matrix_scaling
...
`print(result)` render. See `moirais.fn.describe('otmtxe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.otmtxe import *
import numpy as np
# See the function signature in fn/otmtxe.py for argument names.
```
