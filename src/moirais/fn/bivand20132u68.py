...
__all__ = ["bivand2013_chapter_2_unnumbered_68"]


def bivand2013_chapter_2_unnumbered_68(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: + ns_res = respan[2], elev = "DEM_resamp")
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20132u68')`` for the full guide.
...
def cheatsheet():
    return "bivand20132u68: GeneralStatistics expression (auto-extracted; see ref)."
