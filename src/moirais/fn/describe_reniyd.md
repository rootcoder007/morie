...
`print(result)` render. See `moirais.fn.describe('reniyd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.reniyd import *
import numpy as np
# See the function signature in fn/reniyd.py for argument names.
```
