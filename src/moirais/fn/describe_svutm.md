...
`print(result)` render. See `moirais.fn.describe('svutm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svutm import *
import numpy as np
# See the function signature in fn/svutm.py for argument names.
```
