# describe('kpmnci') — km_pointwise_ci
...
`print(result)` render. See `moirais.fn.describe('kpmnci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kpmnci import *
import numpy as np
# See the function signature in fn/kpmnci.py for argument names.
```
