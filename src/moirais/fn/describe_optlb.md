...
`print(result)` render. See `moirais.fn.describe('optlb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.optlb import *
import numpy as np
# See the function signature in fn/optlb.py for argument names.
```
