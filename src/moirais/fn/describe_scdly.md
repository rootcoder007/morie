...
`print(result)` render. See `moirais.fn.describe('scdly')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.scdly import *
import numpy as np
# See the function signature in fn/scdly.py for argument names.
```
