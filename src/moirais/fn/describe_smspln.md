# describe('smspln') — smoothing_spline
...
`print(result)` render. See `moirais.fn.describe('smspln')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smspln import *
import numpy as np
# See the function signature in fn/smspln.py for argument names.
```
