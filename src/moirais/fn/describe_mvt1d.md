...
`print(result)` render. See `moirais.fn.describe('mvt1d')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mvt1d import *
import numpy as np
# See the function signature in fn/mvt1d.py for argument names.
```
