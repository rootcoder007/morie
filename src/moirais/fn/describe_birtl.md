# describe('birtl') — bayesian_irt_likelihood
...
`print(result)` render. See `moirais.fn.describe('birtl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.birtl import *
import numpy as np
# See the function signature in fn/birtl.py for argument names.
```
