# describe('svhtd') — hotelling_downs
...
`print(result)` render. See `moirais.fn.describe('svhtd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svhtd import *
import numpy as np
# See the function signature in fn/svhtd.py for argument names.
```
