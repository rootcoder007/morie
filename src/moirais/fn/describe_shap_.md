...
`print(result)` render. See `moirais.fn.describe('shap_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.shap_ import *
import numpy as np
# See the function signature in fn/shap_.py for argument names.
```
