...
__all__ = ["design_of_observational_studies_chapter_4_unnumbered_292"]


def design_of_observational_studies_chapter_4_unnumbered_292(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: rTi j − rCi j = β
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('design_of_observational_studies4u292')`` for the full guide.
...
def cheatsheet():
    return "design_of_observational_studies4u292: GeneralStatistics expression (auto-extracted; see ref)."
