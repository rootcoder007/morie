# describe('mlscv') — mlsmu6_convergence_check
...
`print(result)` render. See `moirais.fn.describe('mlscv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mlscv import *
import numpy as np
# See the function signature in fn/mlscv.py for argument names.
```
