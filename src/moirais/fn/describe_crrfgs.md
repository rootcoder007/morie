# describe('crrfgs') — competing_risks_fg
...
`print(result)` render. See `moirais.fn.describe('crrfgs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crrfgs import *
import numpy as np
# See the function signature in fn/crrfgs.py for argument names.
```
