...
__all__ = ["hedderich_chapter_9_unnumbered_507"]


def hedderich_chapter_9_unnumbered_507(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: posttest %. of disease (+;−) = 90.91 ; NA %
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u507')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u507: GeneralStatistics expression (auto-extracted; see ref)."
