...
__all__ = ["wilcox_chapter_9_unnumbered_1058"]


def wilcox_chapter_9_unnumbered_1058(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: with ν 1 =J − 1 and ν 2 =N − p − 1 degrees of freedom. R uses an F distribution to get an
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox9u1058')`` for the full guide.
...
def cheatsheet():
    return "wilcox9u1058: GeneralStatistics expression (auto-extracted; see ref)."
