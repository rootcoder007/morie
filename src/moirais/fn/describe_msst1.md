...
`print(result)` render. See `moirais.fn.describe('msst1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msst1 import *
import numpy as np
# See the function signature in fn/msst1.py for argument names.
```
