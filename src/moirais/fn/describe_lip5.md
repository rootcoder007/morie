# describe('lip5') — lipinski_rule_of_5
...
`print(result)` render. See `moirais.fn.describe('lip5')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lip5 import *
import numpy as np
# See the function signature in fn/lip5.py for argument names.
```
