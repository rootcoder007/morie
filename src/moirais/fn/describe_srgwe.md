...
`print(result)` render. See `moirais.fn.describe('srgwe')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srgwe import *
import numpy as np
# See the function signature in fn/srgwe.py for argument names.
```
