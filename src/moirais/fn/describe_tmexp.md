...
`print(result)` render. See `moirais.fn.describe('tmexp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmexp import *
import numpy as np
# See the function signature in fn/tmexp.py for argument names.
```
