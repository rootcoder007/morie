...
`print(result)` render. See `moirais.fn.describe('tdede')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tdede import *
import numpy as np
# See the function signature in fn/tdede.py for argument names.
```
