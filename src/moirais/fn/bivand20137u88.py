...
__all__ = ["bivand2013_chapter_7_unnumbered_88"]


def bivand2013_chapter_7_unnumbered_88(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] > ppm(Q = lmaple, trend = ~ x+y+ I(x^2) + I(y^2) + I(x *
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('bivand20137u88')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u88: GeneralStatistics expression (auto-extracted; see ref)."
