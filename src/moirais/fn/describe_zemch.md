# describe('zemch') — maternal_child_map
...
`print(result)` render. See `moirais.fn.describe('zemch')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zemch import *
import numpy as np
# See the function signature in fn/zemch.py for argument names.
```
