# describe('uncr') — entropy_production
...
`print(result)` render. See `moirais.fn.describe('uncr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.uncr import *
import numpy as np
# See the function signature in fn/uncr.py for argument names.
```
