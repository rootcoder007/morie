...
`print(result)` render. See `moirais.fn.describe('drvhz')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.drvhz import *
import numpy as np
# See the function signature in fn/drvhz.py for argument names.
```
