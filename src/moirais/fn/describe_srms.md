...
`print(result)` render. See `moirais.fn.describe('srms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.srms import *
import numpy as np
# See the function signature in fn/srms.py for argument names.
```
