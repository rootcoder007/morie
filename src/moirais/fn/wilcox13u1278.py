...
__all__ = ["wilcox_chapter_13_unnumbered_1278"]


def wilcox_chapter_13_unnumbered_1278(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: pwr.chisq.test(w=.3,N=87,df=3)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1278')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1278: PowerAndDesign expression (auto-extracted; see ref)."
