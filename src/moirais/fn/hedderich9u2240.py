...
__all__ = ["hedderich_chapter_9_unnumbered_2240"]


def hedderich_chapter_9_unnumbered_2240(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: D = 0 . 6 , p− value = 0 .0 4 3 11
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2240')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2240: GeneralStatistics expression (auto-extracted; see ref)."
