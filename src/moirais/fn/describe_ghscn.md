...
`print(result)` render. See `moirais.fn.describe('ghscn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghscn import *
import numpy as np
# See the function signature in fn/ghscn.py for argument names.
```
