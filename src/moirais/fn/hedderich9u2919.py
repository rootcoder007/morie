...
__all__ = ["hedderich_chapter_9_unnumbered_2919"]


def hedderich_chapter_9_unnumbered_2919(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: X− squared = 6 . 5 7 0 1 , df = 1 , p− value = 0 .0 1 0 37
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2919')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2919: GeneralStatistics expression (auto-extracted; see ref)."
