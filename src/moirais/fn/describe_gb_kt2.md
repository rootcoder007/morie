# describe('gb_kt2') — gibbons_kendall_exact
...
`print(result)` render. See `moirais.fn.describe('gb_kt2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_kt2 import *
import numpy as np
# See the function signature in fn/gb_kt2.py for argument names.
```
