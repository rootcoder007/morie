...
`print(result)` render. See `moirais.fn.describe('nmwnp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nmwnp import *
import numpy as np
# See the function signature in fn/nmwnp.py for argument names.
```
