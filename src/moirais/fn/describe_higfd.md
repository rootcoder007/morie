...
`print(result)` render. See `moirais.fn.describe('higfd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.higfd import *
import numpy as np
# See the function signature in fn/higfd.py for argument names.
```
