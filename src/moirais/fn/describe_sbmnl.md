...
`print(result)` render. See `moirais.fn.describe('sbmnl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sbmnl import *
import numpy as np
# See the function signature in fn/sbmnl.py for argument names.
```
