...
__all__ = ["hedderich_chapter_9_unnumbered_1840"]


def hedderich_chapter_9_unnumbered_1840(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] R(n;α) = n(n + 1)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1840')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1840: GeneralStatistics expression (auto-extracted; see ref)."
