...
__all__ = ["hedderich_chapter_9_unnumbered_3236"]


def hedderich_chapter_9_unnumbered_3236(x):
    """
    Resampling expression (auto-extracted; see ref).

    Formula: [EQ] ˜Θc =n ˆΘ−(n−1) ˆΘ∗
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3236')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3236: Resampling expression (auto-extracted; see ref)."
