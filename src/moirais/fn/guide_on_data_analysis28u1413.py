...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1413"]


def guide_on_data_analysis_chapter_28_unnumbered_1413(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: Control Periods = {𝑡 − 𝑘, 𝑡 + 𝑘}, 𝑘 ∈ ℕ
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis28u1413')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1413: GeneralStatistics expression (auto-extracted; see ref)."
