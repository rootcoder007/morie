...
`print(result)` render. See `moirais.fn.describe('gcomp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcomp import *
import numpy as np
# See the function signature in fn/gcomp.py for argument names.
```
