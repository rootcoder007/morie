...
`print(result)` render. See `moirais.fn.describe('rbfgrd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbfgrd import *
import numpy as np
# See the function signature in fn/rbfgrd.py for argument names.
```
