# describe('ghreg') — ghosal_np_regression
...
`print(result)` render. See `moirais.fn.describe('ghreg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ghreg import *
import numpy as np
# See the function signature in fn/ghreg.py for argument names.
```
