...
`print(result)` render. See `moirais.fn.describe('copfr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.copfr import *
import numpy as np
# See the function signature in fn/copfr.py for argument names.
```
