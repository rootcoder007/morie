...
`print(result)` render. See `moirais.fn.describe('cfa4')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cfa4 import *
import numpy as np
# See the function signature in fn/cfa4.py for argument names.
```
