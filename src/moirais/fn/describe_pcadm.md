# describe('pcadm') — pca_dimension_reduction
...
`print(result)` render. See `moirais.fn.describe('pcadm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.pcadm import *
import numpy as np
# See the function signature in fn/pcadm.py for argument names.
```
