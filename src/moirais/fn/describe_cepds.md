# describe('cepds') — cepstral_distance
...
`print(result)` render. See `moirais.fn.describe('cepds')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cepds import *
import numpy as np
# See the function signature in fn/cepds.py for argument names.
```
