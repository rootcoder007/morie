...
`print(result)` render. See `moirais.fn.describe('ptipo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ptipo import *
import numpy as np
# See the function signature in fn/ptipo.py for argument names.
```
