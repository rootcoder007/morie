...
__all__ = ["hedderich_chapter_9_unnumbered_520"]


def hedderich_chapter_9_unnumbered_520(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] IE = (0.333−0.1)/(0.333·0.9 = 0.78)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u520')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u520: GeneralStatistics expression (auto-extracted; see ref)."
