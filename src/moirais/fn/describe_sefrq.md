# describe('sefrq') — spectral_edge_freq
...
`print(result)` render. See `moirais.fn.describe('sefrq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sefrq import *
import numpy as np
# See the function signature in fn/sefrq.py for argument names.
```
