...
`print(result)` render. See `moirais.fn.describe('sdmimp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdmimp import *
import numpy as np
# See the function signature in fn/sdmimp.py for argument names.
```
