# describe('gpsfn') — gp_sparse_inducing
...
`print(result)` render. See `moirais.fn.describe('gpsfn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gpsfn import *
import numpy as np
# See the function signature in fn/gpsfn.py for argument names.
```
