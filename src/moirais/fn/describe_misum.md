...
`print(result)` render. See `moirais.fn.describe('misum')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.misum import *
import numpy as np
# See the function signature in fn/misum.py for argument names.
```
