# describe('hmunsp') — geron_unsupervised_pretraining
...
`print(result)` render. See `moirais.fn.describe('hmunsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmunsp import *
import numpy as np
# See the function signature in fn/hmunsp.py for argument names.
```
