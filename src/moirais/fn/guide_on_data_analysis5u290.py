...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_290"]


def guide_on_data_analysis_chapter_5_unnumbered_290(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: abline(h = 0, col = "red", lty = 2)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis5u290')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u290: GeneralStatistics expression (auto-extracted; see ref)."
