# describe('rghmm') — rangayyan_fitzhugh_nagumo
...
`print(result)` render. See `moirais.fn.describe('rghmm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rghmm import *
import numpy as np
# See the function signature in fn/rghmm.py for argument names.
```
