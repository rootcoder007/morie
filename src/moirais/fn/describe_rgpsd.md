...
`print(result)` render. See `moirais.fn.describe('rgpsd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgpsd import *
import numpy as np
# See the function signature in fn/rgpsd.py for argument names.
```
