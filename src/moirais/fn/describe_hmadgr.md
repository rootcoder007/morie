...
`print(result)` render. See `moirais.fn.describe('hmadgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmadgr import *
import numpy as np
# See the function signature in fn/hmadgr.py for argument names.
```
