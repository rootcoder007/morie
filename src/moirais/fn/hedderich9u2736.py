...
__all__ = ["hedderich_chapter_9_unnumbered_2736"]


def hedderich_chapter_9_unnumbered_2736(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: For not too small productPRF·ˆψ, sayPRF( ˆψ−1)> 9,PAR> 9/10 will be.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2736')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2736: GeneralStatistics expression (auto-extracted; see ref)."
