...
`print(result)` render. See `moirais.fn.describe('hmnag')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmnag import *
import numpy as np
# See the function signature in fn/hmnag.py for argument names.
```
