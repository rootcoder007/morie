# describe('spman') — schabenberger_mantel_test
...
`print(result)` render. See `moirais.fn.describe('spman')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spman import *
import numpy as np
# See the function signature in fn/spman.py for argument names.
```
