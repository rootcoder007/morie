# describe('kymkr') — information_gain
...
`print(result)` render. See `moirais.fn.describe('kymkr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kymkr import *
import numpy as np
# See the function signature in fn/kymkr.py for argument names.
```
