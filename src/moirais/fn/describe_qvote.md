# describe('qvote') — quadratic_voting
...
`print(result)` render. See `moirais.fn.describe('qvote')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.qvote import *
import numpy as np
# See the function signature in fn/qvote.py for argument names.
```
