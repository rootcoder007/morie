...
`print(result)` render. See `moirais.fn.describe('eegar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eegar import *
import numpy as np
# See the function signature in fn/eegar.py for argument names.
```
