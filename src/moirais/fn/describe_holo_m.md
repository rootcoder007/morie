...
`print(result)` render. See `moirais.fn.describe('holo_m')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.holo_m import *
import numpy as np
# See the function signature in fn/holo_m.py for argument names.
```
