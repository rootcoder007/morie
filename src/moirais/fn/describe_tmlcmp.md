# describe('tmlcmp') — tmle_competing_risks
...
`print(result)` render. See `moirais.fn.describe('tmlcmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmlcmp import *
import numpy as np
# See the function signature in fn/tmlcmp.py for argument names.
```
