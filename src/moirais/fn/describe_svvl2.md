...
`print(result)` render. See `moirais.fn.describe('svvl2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svvl2 import *
import numpy as np
# See the function signature in fn/svvl2.py for argument names.
```
