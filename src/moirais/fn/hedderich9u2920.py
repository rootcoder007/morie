...
__all__ = ["hedderich_chapter_9_unnumbered_2920"]


def hedderich_chapter_9_unnumbered_2920(x):
    """
    CountModels expression (auto-extracted; see ref).

    Formula: H0 : π1 =π2 =...=πk =π0 for a fixedπ0
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2920')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2920: CountModels expression (auto-extracted; see ref)."
