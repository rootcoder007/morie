...
__all__ = ["hedderich_chapter_9_unnumbered_2482"]


def hedderich_chapter_9_unnumbered_2482(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] nContr. = 6 n1 = 5 n2 = 5
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2482')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2482: GeneralStatistics expression (auto-extracted; see ref)."
