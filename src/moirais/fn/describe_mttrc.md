...
`print(result)` render. See `moirais.fn.describe('mttrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.mttrc import *
import numpy as np
# See the function signature in fn/mttrc.py for argument names.
```
