...
__all__ = ["wilcox_chapter_14_unnumbered_615"]


def wilcox_chapter_14_unnumbered_615(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: power.prop.test(n = 50, p1 = 0.50, p2 = 0.75)
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u615')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u615: PowerAndDesign expression (auto-extracted; see ref)."
