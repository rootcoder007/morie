# describe('msm118') — mvsml_bayesian_regression_pt2_eq_7_7
...
`print(result)` render. See `moirais.fn.describe('msm118')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.msm118 import *
import numpy as np
# See the function signature in fn/msm118.py for argument names.
```
