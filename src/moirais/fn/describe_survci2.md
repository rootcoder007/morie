# describe('survci2') — uno_concordance
...
`print(result)` render. See `moirais.fn.describe('survci2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.survci2 import *
import numpy as np
# See the function signature in fn/survci2.py for argument names.
```
