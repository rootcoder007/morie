# describe('rgwvcor') — rangayyan_wavelet_corr
...
`print(result)` render. See `moirais.fn.describe('rgwvcor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgwvcor import *
import numpy as np
# See the function signature in fn/rgwvcor.py for argument names.
```
