# describe('xrmgb') — mgwr_bandwidths
...
`print(result)` render. See `moirais.fn.describe('xrmgb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.xrmgb import *
import numpy as np
# See the function signature in fn/xrmgb.py for argument names.
```
