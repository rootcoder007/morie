# describe('bgpcl') — bayesian_gp_classification
...
`print(result)` render. See `moirais.fn.describe('bgpcl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bgpcl import *
import numpy as np
# See the function signature in fn/bgpcl.py for argument names.
```
