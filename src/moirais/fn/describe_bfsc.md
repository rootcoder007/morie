# describe('bfsc') — bayesian_factor_scores
...
`print(result)` render. See `moirais.fn.describe('bfsc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bfsc import *
import numpy as np
# See the function signature in fn/bfsc.py for argument names.
```
