# describe('wmtwgt') — weights_matrix
...
`print(result)` render. See `moirais.fn.describe('wmtwgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wmtwgt import *
import numpy as np
# See the function signature in fn/wmtwgt.py for argument names.
```
