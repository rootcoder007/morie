# describe('cssant') — callaway_santanna
...
`print(result)` render. See `moirais.fn.describe('cssant')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cssant import *
import numpy as np
# See the function signature in fn/cssant.py for argument names.
```
