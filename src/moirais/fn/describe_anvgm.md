...
`print(result)` render. See `moirais.fn.describe('anvgm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.anvgm import *
import numpy as np
# See the function signature in fn/anvgm.py for argument names.
```
