# describe('rgbartl') — rangayyan_bartlett_psd
...
`print(result)` render. See `moirais.fn.describe('rgbartl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgbartl import *
import numpy as np
# See the function signature in fn/rgbartl.py for argument names.
```
