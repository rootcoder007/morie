# describe('ocmtmd') — outcome_model_diagnostic
...
`print(result)` render. See `moirais.fn.describe('ocmtmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ocmtmd import *
import numpy as np
# See the function signature in fn/ocmtmd.py for argument names.
```
