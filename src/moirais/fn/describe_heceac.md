...
`print(result)` render. See `moirais.fn.describe('heceac')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.heceac import *
import numpy as np
# See the function signature in fn/heceac.py for argument names.
```
