...
__all__ = ["hedderich_chapter_9_unnumbered_2149"]


def hedderich_chapter_9_unnumbered_2149(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] d=0.8; P(X>Y)=0.71
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2149')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2149: GeneralStatistics expression (auto-extracted; see ref)."
