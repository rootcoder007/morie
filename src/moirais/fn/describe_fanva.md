...
`print(result)` render. See `moirais.fn.describe('fanva')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.fanva import *
import numpy as np
# See the function signature in fn/fanva.py for argument names.
```
