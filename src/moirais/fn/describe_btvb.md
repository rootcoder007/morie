# describe('btvb') — boot_var_estimator
...
`print(result)` render. See `moirais.fn.describe('btvb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.btvb import *
import numpy as np
# See the function signature in fn/btvb.py for argument names.
```
