...
`print(result)` render. See `moirais.fn.describe('semflt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.semflt import *
import numpy as np
# See the function signature in fn/semflt.py for argument names.
```
