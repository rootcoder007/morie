...
`print(result)` render. See `moirais.fn.describe('opdbr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opdbr import *
import numpy as np
# See the function signature in fn/opdbr.py for argument names.
```
