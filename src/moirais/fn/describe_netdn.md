# describe('netdn') — network_density
...
`print(result)` render. See `moirais.fn.describe('netdn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.netdn import *
import numpy as np
# See the function signature in fn/netdn.py for argument names.
```
