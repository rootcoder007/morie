...
`print(result)` render. See `moirais.fn.describe('kgckv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgckv import *
import numpy as np
# See the function signature in fn/kgckv.py for argument names.
```
