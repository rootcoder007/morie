# describe('icc_') — intraclass_correlation
...
`print(result)` render. See `moirais.fn.describe('icc_')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.icc_ import *
import numpy as np
# See the function signature in fn/icc_.py for argument names.
```
