...
`print(result)` render. See `moirais.fn.describe('balsmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.balsmp import *
import numpy as np
# See the function signature in fn/balsmp.py for argument names.
```
