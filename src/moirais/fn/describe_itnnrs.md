# describe('itnnrs') — item_nonresponse
...
`print(result)` render. See `moirais.fn.describe('itnnrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.itnnrs import *
import numpy as np
# See the function signature in fn/itnnrs.py for argument names.
```
