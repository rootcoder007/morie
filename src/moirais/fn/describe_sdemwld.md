...
`print(result)` render. See `moirais.fn.describe('sdemwld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sdemwld import *
import numpy as np
# See the function signature in fn/sdemwld.py for argument names.
```
