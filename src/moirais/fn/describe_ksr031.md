# describe('ksr031') — kosorok_ch2_weak_convergence_tightness
...
`print(result)` render. See `moirais.fn.describe('ksr031')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr031 import *
import numpy as np
# See the function signature in fn/ksr031.py for argument names.
```
