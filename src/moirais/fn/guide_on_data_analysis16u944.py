...
__all__ = ["guide_on_data_analysis_chapter_16_unnumbered_944"]


def guide_on_data_analysis_chapter_16_unnumbered_944(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] BY_Adjusted = round(p_by, 3)) |> head()
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis16u944')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis16u944: GeneralStatistics expression (auto-extracted; see ref)."
