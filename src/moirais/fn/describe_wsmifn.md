# describe('wsmifn') — wasserman_influence_function
...
`print(result)` render. See `moirais.fn.describe('wsmifn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmifn import *
import numpy as np
# See the function signature in fn/wsmifn.py for argument names.
```
