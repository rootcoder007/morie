...
`print(result)` render. See `moirais.fn.describe('cusms')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cusms import *
import numpy as np
# See the function signature in fn/cusms.py for argument names.
```
