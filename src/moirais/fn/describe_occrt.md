# describe('occrt') — occupational_injury_rate
...
`print(result)` render. See `moirais.fn.describe('occrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.occrt import *
import numpy as np
# See the function signature in fn/occrt.py for argument names.
```
