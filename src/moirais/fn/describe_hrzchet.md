# describe('hrzchet') — horowitz_chen_estimator_T
...
`print(result)` render. See `moirais.fn.describe('hrzchet')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrzchet import *
import numpy as np
# See the function signature in fn/hrzchet.py for argument names.
```
