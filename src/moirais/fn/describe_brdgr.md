# describe('brdgr') — bridge_observations
...
`print(result)` render. See `moirais.fn.describe('brdgr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.brdgr import *
import numpy as np
# See the function signature in fn/brdgr.py for argument names.
```
