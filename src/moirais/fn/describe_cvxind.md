# describe('cvxind') — boyd_indicator
...
`print(result)` render. See `moirais.fn.describe('cvxind')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cvxind import *
import numpy as np
# See the function signature in fn/cvxind.py for argument names.
```
