# describe('km042') — kamath_ch3_prompt_label_mapping
...
`print(result)` render. See `moirais.fn.describe('km042')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km042 import *
import numpy as np
# See the function signature in fn/km042.py for argument names.
```
