...
`print(result)` render. See `moirais.fn.describe('hysnk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hysnk import *
import numpy as np
# See the function signature in fn/hysnk.py for argument names.
```
