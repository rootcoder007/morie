...
__all__ = ["wilcox_chapter_14_unnumbered_579"]


def wilcox_chapter_14_unnumbered_579(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: sband(x,y, flag = F, plotit = T, xlab = "x (First Group)", ylab = "Delta") .
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u579')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u579: GeneralStatistics expression (auto-extracted; see ref)."
