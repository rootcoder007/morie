# describe('rng236') — rangayyan_ch4_complex_cepstrum_definition
...
`print(result)` render. See `moirais.fn.describe('rng236')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng236 import *
import numpy as np
# See the function signature in fn/rng236.py for argument names.
```
