# describe('bkhwk') — bekenstein_hawking
...
`print(result)` render. See `moirais.fn.describe('bkhwk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkhwk import *
import numpy as np
# See the function signature in fn/bkhwk.py for argument names.
```
