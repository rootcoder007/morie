# describe('trvrp') — trvrp

## WHAT IT DOES

VRP transport spatial
...
`print(result)` render. See `moirais.fn.describe('trvrp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trvrp import *
import numpy as np
# See the function signature in fn/trvrp.py for argument names.
```
