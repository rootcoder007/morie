# describe('hmkvc') — geron_kv_cache_compress
...
`print(result)` render. See `moirais.fn.describe('hmkvc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmkvc import *
import numpy as np
# See the function signature in fn/hmkvc.py for argument names.
```
