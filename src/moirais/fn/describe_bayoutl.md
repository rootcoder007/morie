# describe('bayoutl') — bayes_outlier
...
`print(result)` render. See `moirais.fn.describe('bayoutl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bayoutl import *
import numpy as np
# See the function signature in fn/bayoutl.py for argument names.
```
