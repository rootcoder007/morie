...
`print(result)` render. See `moirais.fn.describe('runs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.runs import *
import numpy as np
# See the function signature in fn/runs.py for argument names.
```
