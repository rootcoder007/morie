# describe('ksr02') — kosorok_donsker_class
...
`print(result)` render. See `moirais.fn.describe('ksr02')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr02 import *
import numpy as np
# See the function signature in fn/ksr02.py for argument names.
```
