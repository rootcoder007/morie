...
__all__ = ["wilcox_chapter_14_unnumbered_749"]


def wilcox_chapter_14_unnumbered_749(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ¯X1 = 4.75 ¯X2 = 4.62 ¯X3 = 7.75
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox14u749')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u749: GeneralStatistics expression (auto-extracted; see ref)."
