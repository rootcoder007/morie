# describe('eslprq') — esl_prototype_lvq
...
`print(result)` render. See `moirais.fn.describe('eslprq')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.eslprq import *
import numpy as np
# See the function signature in fn/eslprq.py for argument names.
```
