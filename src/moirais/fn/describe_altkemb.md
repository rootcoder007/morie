# describe('altkemb') — alammar_token_embedding_lookup
...
`print(result)` render. See `moirais.fn.describe('altkemb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.altkemb import *
import numpy as np
# See the function signature in fn/altkemb.py for argument names.
```
