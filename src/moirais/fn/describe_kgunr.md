...
`print(result)` render. See `moirais.fn.describe('kgunr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.kgunr import *
import numpy as np
# See the function signature in fn/kgunr.py for argument names.
```
