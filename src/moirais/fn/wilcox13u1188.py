...
__all__ = ["wilcox_chapter_13_unnumbered_1188"]


def wilcox_chapter_13_unnumbered_1188(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] Y =β 0 +β 1X1 +β 2X2 + (λ 1(X1) +λ 2(X2))ǫ,
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1188')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1188: GeneralStatistics expression (auto-extracted; see ref)."
