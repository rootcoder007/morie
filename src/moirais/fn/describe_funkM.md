...
`print(result)` render. See `moirais.fn.describe('funkM')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.funkM import *
import numpy as np
# See the function signature in fn/funkM.py for argument names.
```
