# describe('trdst') — trdst

## WHAT IT DOES

Trip distribution spatial
...
`print(result)` render. See `moirais.fn.describe('trdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.trdst import *
import numpy as np
# See the function signature in fn/trdst.py for argument names.
```
