...
`print(result)` render. See `moirais.fn.describe('clcal')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.clcal import *
import numpy as np
# See the function signature in fn/clcal.py for argument names.
```
