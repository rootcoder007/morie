# describe('wbgt') — wet_bulb_globe_temp
...
`print(result)` render. See `moirais.fn.describe('wbgt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wbgt import *
import numpy as np
# See the function signature in fn/wbgt.py for argument names.
```
