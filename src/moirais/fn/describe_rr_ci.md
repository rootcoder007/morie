...
`print(result)` render. See `moirais.fn.describe('rr_ci')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rr_ci import *
import numpy as np
# See the function signature in fn/rr_ci.py for argument names.
```
