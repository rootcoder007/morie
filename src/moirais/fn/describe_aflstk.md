# describe('aflstk') — aflstk

## WHAT IT DOES

Livestock density spatial
...
`print(result)` render. See `moirais.fn.describe('aflstk')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.aflstk import *
import numpy as np
# See the function signature in fn/aflstk.py for argument names.
```
