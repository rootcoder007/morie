...
`print(result)` render. See `moirais.fn.describe('cdkrg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cdkrg import *
import numpy as np
# See the function signature in fn/cdkrg.py for argument names.
```
