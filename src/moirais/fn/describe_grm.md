# describe('grm') — genetic_relatedness
...
`print(result)` render. See `moirais.fn.describe('grm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grm import *
import numpy as np
# See the function signature in fn/grm.py for argument names.
```
