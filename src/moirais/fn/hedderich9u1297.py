...
__all__ = ["hedderich_chapter_9_unnumbered_1297"]
...
def hedderich_chapter_9_unnumbered_1297(x):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1297')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1297: CentralTendency expression (auto-extracted; see ref)."
