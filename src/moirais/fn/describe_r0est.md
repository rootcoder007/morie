# describe('r0est') — r0_next_generation
...
`print(result)` render. See `moirais.fn.describe('r0est')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.r0est import *
import numpy as np
# See the function signature in fn/r0est.py for argument names.
```
