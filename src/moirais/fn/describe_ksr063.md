# describe('ksr063') — kosorok_ch3_cox_efficient_score_beta
...
`print(result)` render. See `moirais.fn.describe('ksr063')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.ksr063 import *
import numpy as np
# See the function signature in fn/ksr063.py for argument names.
```
