# describe('smae') — mean_absolute_error
...
`print(result)` render. See `moirais.fn.describe('smae')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smae import *
import numpy as np
# See the function signature in fn/smae.py for argument names.
```
