# describe('wsmlsr') — wasserman_least_squares
...
`print(result)` render. See `moirais.fn.describe('wsmlsr')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wsmlsr import *
import numpy as np
# See the function signature in fn/wsmlsr.py for argument names.
```
