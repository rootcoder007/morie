# describe('bifrc') — bifurcation_data
...
`print(result)` render. See `moirais.fn.describe('bifrc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bifrc import *
import numpy as np
# See the function signature in fn/bifrc.py for argument names.
```
