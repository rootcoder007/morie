...
__all__ = ["hedderich_chapter_9_unnumbered_1855"]


def hedderich_chapter_9_unnumbered_1855(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] ˆχ2 = (40−50)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1855')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1855: GeneralStatistics expression (auto-extracted; see ref)."
