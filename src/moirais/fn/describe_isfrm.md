...
`print(result)` render. See `moirais.fn.describe('isfrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.isfrm import *
import numpy as np
# See the function signature in fn/isfrm.py for argument names.
```
