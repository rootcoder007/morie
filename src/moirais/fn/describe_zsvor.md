...
`print(result)` render. See `moirais.fn.describe('zsvor')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zsvor import *
import numpy as np
# See the function signature in fn/zsvor.py for argument names.
```
