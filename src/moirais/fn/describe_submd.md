...
`print(result)` render. See `moirais.fn.describe('submd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.submd import *
import numpy as np
# See the function signature in fn/submd.py for argument names.
```
