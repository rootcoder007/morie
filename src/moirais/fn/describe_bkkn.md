# describe('bkkn') — burkov_kneser_ney
...
`print(result)` render. See `moirais.fn.describe('bkkn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.bkkn import *
import numpy as np
# See the function signature in fn/bkkn.py for argument names.
```
