...
`print(result)` render. See `moirais.fn.describe('hmblp2')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmblp2 import *
import numpy as np
# See the function signature in fn/hmblp2.py for argument names.
```
