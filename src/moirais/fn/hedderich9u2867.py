...
__all__ = ["hedderich_chapter_9_unnumbered_2867"]


def hedderich_chapter_9_unnumbered_2867(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: otherwiseHA:πi̸=πi′is to be accepted at this level.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2867')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2867: GeneralStatistics expression (auto-extracted; see ref)."
