...
__all__ = ["hedderich_chapter_9_unnumbered_2428"]


def hedderich_chapter_9_unnumbered_2428(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 2; c3 =c4 =c5 =−1
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2428')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2428: GeneralStatistics expression (auto-extracted; see ref)."
