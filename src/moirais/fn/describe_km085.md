# describe('km085') — kamath_ch6_cbs_variance
...
`print(result)` render. See `moirais.fn.describe('km085')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km085 import *
import numpy as np
# See the function signature in fn/km085.py for argument names.
```
