...
`print(result)` render. See `moirais.fn.describe('dtlmd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dtlmd import *
import numpy as np
# See the function signature in fn/dtlmd.py for argument names.
```
