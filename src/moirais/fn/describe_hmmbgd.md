# describe('hmmbgd') — geron_minibatch_gd
...
`print(result)` render. See `moirais.fn.describe('hmmbgd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hmmbgd import *
import numpy as np
# See the function signature in fn/hmmbgd.py for argument names.
```
