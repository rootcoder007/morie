...
`print(result)` render. See `moirais.fn.describe('sagmo')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sagmo import *
import numpy as np
# See the function signature in fn/sagmo.py for argument names.
```
