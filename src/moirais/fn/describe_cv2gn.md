...
`print(result)` render. See `moirais.fn.describe('cv2gn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.cv2gn import *
import numpy as np
# See the function signature in fn/cv2gn.py for argument names.
```
