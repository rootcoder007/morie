...
`print(result)` render. See `moirais.fn.describe('smpbf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.smpbf import *
import numpy as np
# See the function signature in fn/smpbf.py for argument names.
```
