...
`print(result)` render. See `moirais.fn.describe('svddp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.svddp import *
import numpy as np
# See the function signature in fn/svddp.py for argument names.
```
