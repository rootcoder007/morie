# describe('dpgaus') — dp_gaussian_mechanism
...
`print(result)` render. See `moirais.fn.describe('dpgaus')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dpgaus import *
import numpy as np
# See the function signature in fn/dpgaus.py for argument names.
```
