# describe('irtrm') — irt_rasch_residuals
...
`print(result)` render. See `moirais.fn.describe('irtrm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.irtrm import *
import numpy as np
# See the function signature in fn/irtrm.py for argument names.
```
