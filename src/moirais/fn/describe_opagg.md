# describe('opagg') — opagg

## WHAT IT DOES

Spatial aggregation problem
...
`print(result)` render. See `moirais.fn.describe('opagg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.opagg import *
import numpy as np
# See the function signature in fn/opagg.py for argument names.
```
