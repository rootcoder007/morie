# describe('km134') — kamath_ch9_clip_text_to_image
...
`print(result)` render. See `moirais.fn.describe('km134')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.km134 import *
import numpy as np
# See the function signature in fn/km134.py for argument names.
```
