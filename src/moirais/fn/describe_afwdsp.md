...
`print(result)` render. See `moirais.fn.describe('afwdsp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.afwdsp import *
import numpy as np
# See the function signature in fn/afwdsp.py for argument names.
```
