...
`print(result)` render. See `moirais.fn.describe('rbpca')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rbpca import *
import numpy as np
# See the function signature in fn/rbpca.py for argument names.
```
