# describe('risdt') — rise_time_detect
...
`print(result)` render. See `moirais.fn.describe('risdt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.risdt import *
import numpy as np
# See the function signature in fn/risdt.py for argument names.
```
