...
`print(result)` render. See `moirais.fn.describe('wvcrs')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wvcrs import *
import numpy as np
# See the function signature in fn/wvcrs.py for argument names.
```
