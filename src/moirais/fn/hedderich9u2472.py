...
__all__ = ["hedderich_chapter_9_unnumbered_2472"]


def hedderich_chapter_9_unnumbered_2472(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: chi − squared = 1 1 . 4 5 3 , p− value = 0.0005001
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2472')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2472: GeneralStatistics expression (auto-extracted; see ref)."
