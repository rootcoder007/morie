# describe('tpsnb') — tps_neighborhood
...
`print(result)` render. See `moirais.fn.describe('tpsnb')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpsnb import *
import numpy as np
# See the function signature in fn/tpsnb.py for argument names.
```
