...
`print(result)` render. See `moirais.fn.describe('zxsrf')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.zxsrf import *
import numpy as np
# See the function signature in fn/zxsrf.py for argument names.
```
