...
__all__ = ["wilcox_chapter_4_unnumbered_38"]


def wilcox_chapter_4_unnumbered_38(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 1(0.15) + 2(0.2) + 3(0.25) + 4(0.3) + 5(0.1) = 3.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox4u38')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u38: GeneralStatistics expression (auto-extracted; see ref)."
