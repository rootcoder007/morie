...
`print(result)` render. See `moirais.fn.describe('splgbic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.splgbic import *
import numpy as np
# See the function signature in fn/splgbic.py for argument names.
```
