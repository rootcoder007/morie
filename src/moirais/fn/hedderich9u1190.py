...
__all__ = ["hedderich_chapter_9_unnumbered_1190"]
...
def hedderich_chapter_9_unnumbered_1190(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1190')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1190: GeneralStatistics expression (auto-extracted; see ref)."
