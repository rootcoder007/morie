...
__all__ = ["wilcox_chapter_13_unnumbered_1227"]


def wilcox_chapter_13_unnumbered_1227(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: an approximate 1 − α confidence interval for M1(x) − M2(x) is
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('wilcox13u1227')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1227: PowerAndDesign expression (auto-extracted; see ref)."
