...
`print(result)` render. See `moirais.fn.describe('rgvmg')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rgvmg import *
import numpy as np
# See the function signature in fn/rgvmg.py for argument names.
```
