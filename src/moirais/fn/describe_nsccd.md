# describe('nsccd') — new_user_cohort
...
`print(result)` render. See `moirais.fn.describe('nsccd')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.nsccd import *
import numpy as np
# See the function signature in fn/nsccd.py for argument names.
```
