# describe('grent') — geron_shannon_entropy
...
`print(result)` render. See `moirais.fn.describe('grent')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.grent import *
import numpy as np
# See the function signature in fn/grent.py for argument names.
```
