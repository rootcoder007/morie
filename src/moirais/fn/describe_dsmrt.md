# describe('dsmrt') — direct_standardization
...
`print(result)` render. See `moirais.fn.describe('dsmrt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.dsmrt import *
import numpy as np
# See the function signature in fn/dsmrt.py for argument names.
```
