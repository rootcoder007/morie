...
__all__ = ["hedderich_chapter_9_unnumbered_2750"]


def hedderich_chapter_9_unnumbered_2750(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: H0: p1 = p2; HA1: p1 < p 2; HA2: p1̸= p2.
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2750')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2750: GeneralStatistics expression (auto-extracted; see ref)."
