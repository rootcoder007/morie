# describe('tmplm') — template_match_detect
...
`print(result)` render. See `moirais.fn.describe('tmplm')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tmplm import *
import numpy as np
# See the function signature in fn/tmplm.py for argument names.
```
