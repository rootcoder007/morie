...
__all__ = ["hedderich_chapter_9_unnumbered_1133"]


def hedderich_chapter_9_unnumbered_1133(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 20−7+(7+1)2.36 = 0.592
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1133')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1133: GeneralStatistics expression (auto-extracted; see ref)."
