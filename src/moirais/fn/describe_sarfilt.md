...
`print(result)` render. See `moirais.fn.describe('sarfilt')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.sarfilt import *
import numpy as np
# See the function signature in fn/sarfilt.py for argument names.
```
