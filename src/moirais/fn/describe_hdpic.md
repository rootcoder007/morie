# describe('hdpic') — highest_density_credible_interval
...
`print(result)` render. See `moirais.fn.describe('hdpic')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hdpic import *
import numpy as np
# See the function signature in fn/hdpic.py for argument names.
```
