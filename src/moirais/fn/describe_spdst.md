# describe('spdst') — spatial_distance
...
`print(result)` render. See `moirais.fn.describe('spdst')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spdst import *
import numpy as np
# See the function signature in fn/spdst.py for argument names.
```
