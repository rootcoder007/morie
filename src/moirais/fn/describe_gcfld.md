...
`print(result)` render. See `moirais.fn.describe('gcfld')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gcfld import *
import numpy as np
# See the function signature in fn/gcfld.py for argument names.
```
