...
__all__ = ["hedderich_chapter_9_unnumbered_1012"]


def hedderich_chapter_9_unnumbered_1012(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ln 0.95−ln 0.90 = ˆχ2−χ2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u1012')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1012: GeneralStatistics expression (auto-extracted; see ref)."
