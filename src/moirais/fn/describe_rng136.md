# describe('rng136') — rangayyan_ch3_notch_filter_60Hz
...
`print(result)` render. See `moirais.fn.describe('rng136')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.rng136 import *
import numpy as np
# See the function signature in fn/rng136.py for argument names.
```
