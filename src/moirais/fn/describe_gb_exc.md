# describe('gb_exc') — gibbons_exceedance_stat
...
`print(result)` render. See `moirais.fn.describe('gb_exc')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_exc import *
import numpy as np
# See the function signature in fn/gb_exc.py for argument names.
```
