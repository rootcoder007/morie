...
__all__ = ["hedderich_chapter_9_unnumbered_3021"]


def hedderich_chapter_9_unnumbered_3021(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: 1,...,c (column); the πi,j are the field (cell) probabilities, the πi. andπ.j are the corresponding
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u3021')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3021: GeneralStatistics expression (auto-extracted; see ref)."
