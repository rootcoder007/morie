...
`print(result)` render. See `moirais.fn.describe('jarjar')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.jarjar import *
import numpy as np
# See the function signature in fn/jarjar.py for argument names.
```
