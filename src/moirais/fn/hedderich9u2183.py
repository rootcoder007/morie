...
__all__ = ["hedderich_chapter_9_unnumbered_2183"]


def hedderich_chapter_9_unnumbered_2183(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] [(−0.13) + (−0.02)]/2 =−0.075 (0 .09 + 0.09)/2 = 0.09
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('hedderich9u2183')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2183: GeneralStatistics expression (auto-extracted; see ref)."
