...
__all__ = ["guide_on_data_analysis_chapter_24_unnumbered_1170"]


def guide_on_data_analysis_chapter_24_unnumbered_1170(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] 𝑆𝑆𝑇𝑅 = ∑ 𝑛𝑖( ̄ 𝑟𝑖. − ̄ 𝑟..)2
    ...
    result : RichResult
        ...
        See ``moirais.fn.describe('guide_on_data_analysis24u1170')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis24u1170: GeneralStatistics expression (auto-extracted; see ref)."
