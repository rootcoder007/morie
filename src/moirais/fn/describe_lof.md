# describe('lof') — local_outlier_factor
...
`print(result)` render. See `moirais.fn.describe('lof')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.lof import *
import numpy as np
# See the function signature in fn/lof.py for argument names.
```
