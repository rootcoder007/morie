...
`print(result)` render. See `moirais.fn.describe('wls')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.wls import *
import numpy as np
# See the function signature in fn/wls.py for argument names.
```
