...
`print(result)` render. See `moirais.fn.describe('spvot')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.spvot import *
import numpy as np
# See the function signature in fn/spvot.py for argument names.
```
