# describe('crtT') — chinese_remainder
...
`print(result)` render. See `moirais.fn.describe('crtT')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.crtT import *
import numpy as np
# See the function signature in fn/crtT.py for argument names.
```
