# describe('hrznqiv') — horowitz_nonpar_quantile_iv
...
`print(result)` render. See `moirais.fn.describe('hrznqiv')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.hrznqiv import *
import numpy as np
# See the function signature in fn/hrznqiv.py for argument names.
```
