# describe('tpscmp') — tps_complaint_rate
...
`print(result)` render. See `moirais.fn.describe('tpscmp')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.tpscmp import *
import numpy as np
# See the function signature in fn/tpscmp.py for argument names.
```
