...
`print(result)` render. See `moirais.fn.describe('glivn')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.glivn import *
import numpy as np
# See the function signature in fn/glivn.py for argument names.
```
