# describe('gb_hgl') — gibbons_hodges_lehmann
...
`print(result)` render. See `moirais.fn.describe('gb_hgl')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gb_hgl import *
import numpy as np
# See the function signature in fn/gb_hgl.py for argument names.
```
