# describe('gh_ap_a1') — ghosal_weak_conv_def
...
`print(result)` render. See `moirais.fn.describe('gh_ap_a1')` for guidance.

## WORKED EXAMPLE

```python
from moirais.fn.gh_ap_a1 import *
import numpy as np
# See the function signature in fn/gh_ap_a1.py for argument names.
```
