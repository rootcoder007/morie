"""Built-in scientific computing editor for MOIRAIS.
...
Usage:
    moirais edit myfile.py           # open or create
    moirais edit analysis.R --run    # enable ctrl+r to run after save
    moirais exec co test.py          # create in cofs/ and open
"""
