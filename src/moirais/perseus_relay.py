...
Usage:
    python -m moirais.perseus_relay                    # default :8421
    python -m moirais.perseus_relay --port 9000        # custom port
    python -m moirais.perseus_relay --token mysecret   # require auth token

Then from any machine:
    moirais percy --cloud https://your-server:8421 "What is Moran's I?"
