"""Rich live-progress wrapper for MOIRAIS pipeline execution.

Provides :class:`PipelineTracker` which wraps :func:`moirais.modules.run_module`
...
CLI (automatic when TTY detected)::
    ...
    moirais pipeline --all -y   # rich progress bars in interactive terminals
"""
...
def execute_pipeline_with_progress(
    ...
    *,
    ...
    """Run the MOIRAIS pipeline with rich progress display.

    Drop-in replacement for :func:`moirais.runner.execute_pipeline`.  Auto-detects
