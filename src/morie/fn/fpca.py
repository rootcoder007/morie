...
The functional version is taken from the primary source the book itself
cites for functional data, Ramsay, J., Hooker, G. and Graves, S. (2009),
*Functional Data Analysis with R and MATLAB*, Springer, whose Karhunen-
Loeve expansion is
...
is what makes this the functional and not the multivariate problem.
"""
