...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e64: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_64() -> Deprecated; use :func:`morie.fn.joint_density_factorizes` instead."
