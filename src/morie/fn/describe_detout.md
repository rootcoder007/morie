# describe('detout') — detect_outliers
...
`print(result)` render. See `morie.fn.describe('detout')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.detout import *
import numpy as np
# See the function signature in fn/detout.py for argument names.
```
