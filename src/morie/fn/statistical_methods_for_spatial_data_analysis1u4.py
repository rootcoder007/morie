...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_4(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.statistical_methods_for_spatial_data_analysis1u4.statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_4 is not implemented yet: its former body returned a "
