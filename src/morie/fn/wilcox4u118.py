...
__all__ = ["wilcox_chapter_4_unnumbered_118"]


def wilcox_chapter_4_unnumbered_118(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: probability that Y = 1 and X = 1 is p(1, 1) = 0 .13, and p(2, 3) = 0 .18. To compute the
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox4u118')`` for the full guide.
...
def cheatsheet():
    return "wilcox4u118: Correlation expression (auto-extracted; see ref)."
