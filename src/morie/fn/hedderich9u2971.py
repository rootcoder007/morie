...
__all__ = ["hedderich_chapter_9_unnumbered_2971"]


def hedderich_chapter_9_unnumbered_2971(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u2971')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2971: Correlation expression (auto-extracted; see ref)."
