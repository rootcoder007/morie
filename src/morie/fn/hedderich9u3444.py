...
__all__ = ["hedderich_chapter_9_unnumbered_3444"]


def hedderich_chapter_9_unnumbered_3444(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: X− squared = 4 . 8 1 9 5 , d f = 6 , p− value = 0 . 5 6 7 2
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u3444')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u3444: Correlation expression (auto-extracted; see ref)."
