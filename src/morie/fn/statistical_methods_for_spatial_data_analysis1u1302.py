...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1302"]


def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1302(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: = VarS [S(s)] + E[σ2 I]
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('statistical_methods_for_spatial_data_analysis1u1302')`` for the full guide.
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u1302: Correlation expression (auto-extracted; see ref)."
