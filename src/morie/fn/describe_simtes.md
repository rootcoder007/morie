# describe('simtes') — simultaneous_test
...
`print(result)` render. See `morie.fn.describe('simtes')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.simtes import *
import numpy as np
# See the function signature in fn/simtes.py for argument names.
```
