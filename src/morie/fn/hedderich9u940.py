...
__all__ = ["hedderich_chapter_9_unnumbered_940"]


def hedderich_chapter_9_unnumbered_940(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: [EQ] Γ(k)xk−1e−λx forx> 0,λ>0 andk> 0 (5.150)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u940')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u940: Association expression (auto-extracted; see ref)."
