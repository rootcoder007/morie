...
def nncv(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.nncv.nncv is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "nncv({}) -> Natural neighbor cross-validation."
