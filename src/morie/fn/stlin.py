...
def stlin(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stlin.stlin is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stlin({}) -> Linear space-time covariance combination."
