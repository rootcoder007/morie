# describe('revsim') — revised_simplex

## WHAT IT DOES

Constrained linear programming optimizer.
...
`print(result)` render. See `morie.fn.describe('revsim')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.revsim import *
import numpy as np
# See the function signature in fn/revsim.py for argument names.
```
