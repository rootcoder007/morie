...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r21e4: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_21_equation_4() -> Deprecated; use :func:`morie.fn.kriging_weights_covariance` instead."
