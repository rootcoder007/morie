...
__all__ = ["softsvm", "mvsml_ridge_lasso_elastic_eq_9_36"]

mvsml_ridge_lasso_elastic_eq_9_36 = softsvm


def cheatsheet():
    return "msm220: Support vector classifier (soft margin) (see msm218)"
