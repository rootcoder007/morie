# describe('coomat') — cooccurrence_matrix
...
`print(result)` render. See `morie.fn.describe('coomat')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.coomat import *
import numpy as np
# See the function signature in fn/coomat.py for argument names.
```
