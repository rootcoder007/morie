...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e26: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_26() -> Deprecated; use :func:`morie.fn.var_sum_with_cov` instead."
