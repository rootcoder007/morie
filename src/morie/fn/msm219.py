...
__all__ = ["softsvm", "mvsml_ridge_lasso_elastic_eq_9_35"]

mvsml_ridge_lasso_elastic_eq_9_35 = softsvm


def cheatsheet():
    return "msm219: Support vector classifier (soft margin) (see msm218)"
