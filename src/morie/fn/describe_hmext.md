# describe('hmext') — geron_extra_trees
...
`print(result)` render. See `morie.fn.describe('hmext')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.hmext import *
import numpy as np
# See the function signature in fn/hmext.py for argument names.
```
