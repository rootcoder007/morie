...
__all__ = ["hedderich_chapter_9_unnumbered_2852"]


def hedderich_chapter_9_unnumbered_2852(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: X− squared = 5 . 4 9 5 4 , d f = 2 , p− value = 0 .0 6 4 07
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u2852')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2852: Correlation expression (auto-extracted; see ref)."
