...
"""Kamath Eq 2.23: the replaced token detection (RTD) discriminative loss."""
...
def kamath_ch2_rtd_loss(xhat, d):
    ...
    Language Models: A Deep Dive*, Springer, Ch 2, Eq 2.23, printed
    p. 51.

    Examples
    --------
    >>> import math
    >>> out = kamath_ch2_rtd_loss([0.5, 0.5], [1, 0])
...
def cheatsheet():
    return "km023: per-token binary CE against original/replaced labels"
