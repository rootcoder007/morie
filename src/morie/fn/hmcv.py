...
def geron_cross_validation(X, y, k):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "K-fold cross-validation for honest generalization estimate"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "K-fold cross-validation for honest generalization estimate",
        }
    )
