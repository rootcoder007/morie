# describe('ca3u71') — ca_chapter_3_unnumbered_71
...
y = 2.322 + 0.185x1 − 0.115 1() + 0.021x1 1()
...
```python
from morie.fn.ca3u71 import ca_chapter_3_unnumbered_71
import numpy as np
result = ca_chapter_3_unnumbered_71(np.random.default_rng(42).normal(0, 1, 100))
