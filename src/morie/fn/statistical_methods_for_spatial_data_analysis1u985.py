...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_985"]
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u985: GeneralStatistics expression (auto-extracted; see ref)."
