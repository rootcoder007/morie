...
def vdadj(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.vdadj.vdadj is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "vdadj({}) -> Voronoi adjacency matrix from tessellation."
