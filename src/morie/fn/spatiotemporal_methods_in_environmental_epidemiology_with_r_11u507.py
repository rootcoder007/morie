...
__all__ = ["spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_11_unnumbered_507"]


def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_11_unnumbered_507(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: where Σ1|2≡ Σ11− Σ12Σ−1
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_11u507')`` for the full guide.
...
def cheatsheet():
    return "spatiotemporal_methods_in_environmental_epidemiology_with_r_11u507: Association expression (auto-extracted; see ref)."
