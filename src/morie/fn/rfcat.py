...
def rfcat(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfcat.rfcat is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfcat({}) -> Categorical random field multi-class."
