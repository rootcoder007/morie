# describe('fzc1x') — fauzi_c1_coefficient
...
`print(result)` render. See `morie.fn.describe('fzc1x')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.fzc1x import *
import numpy as np
# See the function signature in fn/fzc1x.py for argument names.
```
