# describe('ca2u36') — ca_chapter_2_unnumbered_36
...
```python
from morie.fn.ca2u36 import ca_chapter_2_unnumbered_36
import numpy as np
result = ca_chapter_2_unnumbered_36(np.random.default_rng(42).normal(0, 1, 100))
