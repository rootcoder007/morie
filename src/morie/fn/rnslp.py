...
def rnslp(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rnslp.rnslp is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rnslp({}) -> Raster slope from DEM."
