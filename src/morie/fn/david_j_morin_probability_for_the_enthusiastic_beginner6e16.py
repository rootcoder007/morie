...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_16(x, y=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner6e16')`` for the full guide.
    ...
    raise NotImplementedError(
        "morie.fn.david_j_morin_probability_for_the_enthusiastic_beginner6e16.david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_16 is not implemented yet: its former body returned a "
