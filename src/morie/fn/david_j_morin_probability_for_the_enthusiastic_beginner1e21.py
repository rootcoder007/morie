...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e21: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_21() -> Deprecated; use :func:`morie.fn.binomial_expansion` instead."
