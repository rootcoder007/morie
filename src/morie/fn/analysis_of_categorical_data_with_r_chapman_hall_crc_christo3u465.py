...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_unnumbered_465(x, y=None):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo3u465')`` for the full guide.
