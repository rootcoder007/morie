...
def gpvfe(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpvfe.gpvfe is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpvfe({}) -> GP variational free energy bound."
