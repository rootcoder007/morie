...
def nnsib(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.nnsib.nnsib is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "nnsib({}) -> Sibson natural neighbor interpolation."
