...
def information_theory_mackay_chapter_26_unnumbered_210(x, y=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('information_theory_mackay26u210')`` for the full guide.
    ...
    raise NotImplementedError(
        "morie.fn.information_theory_mackay26u210.information_theory_mackay_chapter_26_unnumbered_210 is not implemented yet: its former body returned a "
