...
def sgval(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sgval.sgval is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sgval({}) -> SGS cross-validation leave-one-out."
