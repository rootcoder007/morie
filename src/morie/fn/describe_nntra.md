...
`print(result)` render. See `morie.fn.describe('nntra')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.nntra import *
import numpy as np
# See the function signature in fn/nntra.py for argument names.
```
