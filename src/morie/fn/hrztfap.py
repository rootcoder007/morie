...
def horowitz_T_F_asymp_props(x, y, bandwidth):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Asymptotic properties of Horowitz's T_n and F_n estimators"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Asymptotic properties of Horowitz's T_n and F_n estimators",
        }
    )
