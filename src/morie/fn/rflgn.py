...
def rflgn(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rflgn.rflgn is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rflgn({}) -> Log-normal random field transformation."
