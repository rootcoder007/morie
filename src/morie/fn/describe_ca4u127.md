# describe('ca4u127') — ca_chapter_4_unnumbered_127
...
```python
from morie.fn.ca4u127 import ca_chapter_4_unnumbered_127
import numpy as np
result = ca_chapter_4_unnumbered_127(np.random.default_rng(42).normal(0, 1, 100))
