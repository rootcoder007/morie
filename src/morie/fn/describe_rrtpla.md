...
`print(result)` render. See `morie.fn.describe('rrtpla')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.rrtpla import *
import numpy as np
# See the function signature in fn/rrtpla.py for argument names.
```
