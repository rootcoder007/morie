...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e3: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_3(ps) -> Deprecated; use :func:`morie.fn.pandind` instead."
