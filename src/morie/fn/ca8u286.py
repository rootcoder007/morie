...
__all__ = ["ca_chapter_8_unnumbered_286"]


def ca_chapter_8_unnumbered_286(x1, x2):
    """
    MetaAnalysis expression involving 'distribution' (auto-extracted; see reference for full context).

    Formula: effect size has λ = 48, β < 0.0001, and power > 0.9999. Similar to the
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('ca8u286')`` for the full guide.
...
def cheatsheet():
    return "ca8u286: MetaAnalysis expression involving 'distribution' (auto-extracted; see reference for full context)."
