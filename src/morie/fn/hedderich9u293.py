...
__all__ = ["hedderich_chapter_9_unnumbered_293"]


def hedderich_chapter_9_unnumbered_293(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: D2 = 39 rS = 1−6·39
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u293')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u293: Correlation expression (auto-extracted; see ref)."
