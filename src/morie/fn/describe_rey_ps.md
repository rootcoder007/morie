# describe('rey_ps') — poisson_regression

## WHAT IT DOES

Poisson regression. 'Character is destiny. — Heraclitus'The happiness of your life depends upon the quality of your thoughts. — Marcus Aurelius's source for the canonical
...
`print(result)` render. See `morie.fn.describe('rey_ps')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.rey_ps import *
import numpy as np
# See the function signature in fn/rey_ps.py for argument names.
```
