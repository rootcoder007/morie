...
def cdcol(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdcol.cdcol is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdcol({}) -> Co-located co-kriging simulation."
