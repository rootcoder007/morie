# describe('gr1cy') — geron_1cycle_schedule
...
`print(result)` render. See `morie.fn.describe('gr1cy')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gr1cy import *
import numpy as np
# See the function signature in fn/gr1cy.py for argument names.
```
