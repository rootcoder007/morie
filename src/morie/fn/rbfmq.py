...
def rbfmq(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rbfmq.rbfmq is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rbfmq({}) -> Multiquadric RBF interpolation."
