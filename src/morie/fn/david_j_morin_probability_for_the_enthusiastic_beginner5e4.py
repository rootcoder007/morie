...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner5e4: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_equation_4(x, n) -> Deprecated; use :func:`morie.fn.gaussapx` instead."
