...
def blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_10_unnumbered_291(x):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u291')`` for the full guide.
...
def cheatsheet():
    return "blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit10u291: Association expression (auto-extracted; see ref)."
