# describe('otsinkit') — ot_sinkhorn_iter_count
...
`print(result)` render. See `morie.fn.describe('otsinkit')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.otsinkit import *
import numpy as np
# See the function signature in fn/otsinkit.py for argument names.
```
