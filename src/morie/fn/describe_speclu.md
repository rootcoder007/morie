# describe('speclu') — rbf_spectral_cluster
...
`print(result)` render. See `morie.fn.describe('speclu')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.speclu import *
import numpy as np
# See the function signature in fn/speclu.py for argument names.
```
