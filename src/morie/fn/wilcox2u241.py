...
__all__ = ["wilcox_chapter_2_unnumbered_241"]


def wilcox_chapter_2_unnumbered_241(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] ¯X = 132, s = 20, (c) n = 25, ¯X = 52, s = 12.
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox2u241')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u241: PowerAndDesign expression (auto-extracted; see ref)."
