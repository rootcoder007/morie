...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_66(x):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_66() is the book-coordinate name for popvar(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e66: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_66(x) -> Deprecated; use :func:`morie.fn.popvar` instead."
