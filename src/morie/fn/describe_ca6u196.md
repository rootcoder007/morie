# describe('ca6u196') — ca_chapter_6_unnumbered_196
...
ln y() = b0 + b1x1 + offset x2() Equation 6 :7
...
```python
from morie.fn.ca6u196 import ca_chapter_6_unnumbered_196
import numpy as np
result = ca_chapter_6_unnumbered_196(np.random.default_rng(42).normal(0, 1, 100))
