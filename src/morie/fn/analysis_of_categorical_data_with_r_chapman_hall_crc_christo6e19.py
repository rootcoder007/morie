...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_19(x, y=None):
    """
    Correlation equation extracted from Analysis of Categorical Data with R (Chapman & Hall CRC -- CHRISTOPHER R   LOUGHIN BILDER (THOMAS M ).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo6e19')`` for the full guide.
