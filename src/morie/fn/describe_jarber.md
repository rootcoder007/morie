...
`print(result)` render. See `morie.fn.describe('jarber')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.jarber import *
import numpy as np
# See the function signature in fn/jarber.py for argument names.
```
