# describe('nwcom') — network_community
...
`print(result)` render. See `morie.fn.describe('nwcom')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.nwcom import *
import numpy as np
# See the function signature in fn/nwcom.py for argument names.
```
