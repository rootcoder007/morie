# describe('eladef') — elastic_deformation
...
`print(result)` render. See `morie.fn.describe('eladef')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.eladef import *
import numpy as np
# See the function signature in fn/eladef.py for argument names.
```
