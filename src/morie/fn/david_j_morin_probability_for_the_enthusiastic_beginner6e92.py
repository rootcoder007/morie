...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e92: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_92(x, y) -> Deprecated; use :func:`morie.fn.lsqresid` instead."
