...
`print(result)` render. See `morie.fn.describe('powfit')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.powfit import *
import numpy as np
# See the function signature in fn/powfit.py for argument names.
```
