...
def sicls(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sicls.sicls is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sicls({}) -> SIS class proportion reproduction."
