...
`print(result)` render. See `morie.fn.describe('mmddis')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.mmddis import *
import numpy as np
# See the function signature in fn/mmddis.py for argument names.
```
