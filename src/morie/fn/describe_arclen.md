...
`print(result)` render. See `morie.fn.describe('arclen')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.arclen import *
import numpy as np
# See the function signature in fn/arclen.py for argument names.
```
