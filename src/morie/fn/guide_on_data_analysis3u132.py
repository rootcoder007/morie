...
__all__ = ["guide_on_data_analysis_chapter_3_unnumbered_132"]


def guide_on_data_analysis_chapter_3_unnumbered_132(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: B = sample(1.6, replace = TRUE, size = n)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis3u132')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u132: Correlation expression (auto-extracted; see ref)."
