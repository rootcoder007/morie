...
def cdmar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdmar.cdmar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdmar({}) -> Markov-Bayes co-simulation."
