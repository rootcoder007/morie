...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e45: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_45(sigma, n) -> Deprecated; use :func:`morie.fn.sdiidsum` instead."
