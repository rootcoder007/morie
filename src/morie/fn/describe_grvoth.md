# describe('grvoth') — geron_hard_voting
...
`print(result)` render. See `morie.fn.describe('grvoth')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.grvoth import *
import numpy as np
# See the function signature in fn/grvoth.py for argument names.
```
