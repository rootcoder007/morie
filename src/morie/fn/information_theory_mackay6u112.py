...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_112"]


def information_theory_mackay_chapter_6_unnumbered_112(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] I(X;Y ) =H(X)H(XjY ) = 3=8 bits.
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('information_theory_mackay6u112')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u112: GeneralStatistics expression (auto-extracted; see ref)."
