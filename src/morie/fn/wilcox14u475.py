...
__all__ = ["wilcox_chapter_14_unnumbered_475"]


def wilcox_chapter_14_unnumbered_475(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: (B). Letting ℓ = 0.025B, rounded to the nearest integer, and u = B − ℓ, an approximate
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u475')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u475: Correlation expression (auto-extracted; see ref)."
