...
__all__ = ["multinomial_block_update"]


def multinomial_block_update(X, y, beta0, beta, lam=1.0, cls=0, baseline_last=True):
...
def cheatsheet():
    return "msm112: Block-coordinate update for the multinomial model"
