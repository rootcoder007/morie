...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e47: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_47(x, y) -> Deprecated; use :func:`morie.fn.lsqfit` instead."
