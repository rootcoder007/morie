...
def rkhs_multitrait(Y, K, n_iter=200, X=None, Z1=None, v_T=None, S_T=None,
    ...
    X : array-like, optional
        ...
        the trait intercepts mu.  Do NOT include an intercept column: mu
        is already the intercept, and an X that carries one leaves beta
        unidentified.  The solve is ridged, so both arms still agree on a
        value, but that value means nothing.
