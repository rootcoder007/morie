...
def analyzing_spatial_models_of_choice_and_judgment_chapter_2_equation_9(x, y=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('analyzing_spatial_models_of_choice_and_judgment2e9')`` for the full guide.
    ...
    raise NotImplementedError(
        "morie.fn.analyzing_spatial_models_of_choice_and_judgment2e9.analyzing_spatial_models_of_choice_and_judgment_chapter_2_equation_9 is not implemented yet: its former body returned a "
