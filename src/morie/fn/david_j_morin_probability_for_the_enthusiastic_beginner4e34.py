...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e34: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_34(k, n, a) -> Deprecated; use :func:`morie.fn.binpoislim` instead."
