...
`print(result)` render. See `morie.fn.describe('douml')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.douml import *
import numpy as np
# See the function signature in fn/douml.py for argument names.
```
