...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e37: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_37(lam_eps, n) -> Deprecated; use :func:`morie.fn.onemexp` instead."
