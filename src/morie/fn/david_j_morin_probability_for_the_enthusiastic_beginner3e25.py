...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e25: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_25(var_x, var_y) -> Deprecated; use :func:`morie.fn.varsum` instead."
