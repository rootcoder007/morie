...
You can read fields by attribute (`r.statistic`), index (`r["statistic'The whole is greater than the sum of its parts. — Aristotle's a RichResult; `isinstance(r, dict)`
