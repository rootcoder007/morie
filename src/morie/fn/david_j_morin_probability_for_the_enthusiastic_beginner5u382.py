...
__all__ = ["david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_382"]


def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_382(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner5u382')`` for the full guide.
...
def cheatsheet():
    return "david_j_morin_probability_for_the_enthusiastic_beginner5u382: Correlation expression (auto-extracted; see ref)."
