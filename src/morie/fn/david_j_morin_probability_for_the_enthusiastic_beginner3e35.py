...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_35(values, probs):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_35() is the book-coordinate name for pmfvar(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e35: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_35(values, probs) -> Deprecated; use :func:`morie.fn.pmfvar` instead."
