...
def guide_on_data_analysis_chapter_3_unnumbered_123(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: B = sample(1.6, replace = TRUE, size = 100) # Nominal variable
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis3u123')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis3u123: ContingencyTables expression (auto-extracted; see ref)."
