...
def ca_chapter_4_unnumbered_132(x):
    """
    CentralTendency expression involving 'likelihood' (auto-extracted; see reference for full context).

    Formula: Race (1 = white, 0 = nonwhite) 0.75 0.43 − 0.42 0.30
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('ca4u132')`` for the full guide.
    ...
    return RichResult(
        title="CentralTendency expression involving 'likelihood' (auto-extracted; see reference for full context).",
        summary_lines=[
            ("Estimate", result),
            ("Standard error", se),
            ("n", n),
