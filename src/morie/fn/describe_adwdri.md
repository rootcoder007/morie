...
`print(result)` render. See `morie.fn.describe('adwdri')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.adwdri import *
import numpy as np
# See the function signature in fn/adwdri.py for argument names.
```
