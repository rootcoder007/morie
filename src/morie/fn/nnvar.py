...
def nnvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.nnvar.nnvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "nnvar({}) -> Natural neighbor variance estimation."
