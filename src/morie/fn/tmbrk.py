...
def tmbrk(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmbrk.tmbrk is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmbrk({}) -> Temporal structural break detection."
