...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r3e21: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_3_equation_21() -> Deprecated; use :func:`morie.fn.infinite_total_variance` instead."
