...
def sbbnd(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbbnd.sbbnd is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbbnd({}) -> Bootstrap confidence bands spatial field."
