...
def ctsmt(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.ctsmt.ctsmt is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "ctsmt({}) -> Contour line smoothing B-spline."
