...
def luvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.luvar.luvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "luvar({}) -> LU simulation variance scaling."
