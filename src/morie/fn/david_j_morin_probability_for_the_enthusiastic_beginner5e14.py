...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner5e14: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_equation_14() -> Deprecated; use :func:`morie.fn.gaussian_approx_n` instead."
