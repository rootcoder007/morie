# describe('hedderich9u294') — hedderich_chapter_9_unnumbered_294
...
import numpy as np
result = hedderich_chapter_9_unnumbered_294(np.random.default_rng(42).normal(0, 1, 100))
