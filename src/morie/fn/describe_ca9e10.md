# describe('ca9e10') — ca_chapter_9_equation_10
...
```python
from morie.fn.ca9e10 import ca_chapter_9_equation_10
import numpy as np
result = ca_chapter_9_equation_10(np.random.default_rng(42).normal(0, 1, 100))
