...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e9: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_9() -> Deprecated; use :func:`morie.fn.chain_rule` instead."
