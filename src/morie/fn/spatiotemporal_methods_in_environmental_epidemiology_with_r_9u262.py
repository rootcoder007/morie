...
def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_9_unnumbered_262(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('spatiotemporal_methods_in_environmental_epidemiology_with_r_9u262')`` for the full guide.
