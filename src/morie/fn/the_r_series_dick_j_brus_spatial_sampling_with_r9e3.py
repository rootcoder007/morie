...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r9e3: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_9_equation_3() -> Deprecated; use :func:`morie.fn.balanced_variance` instead."
