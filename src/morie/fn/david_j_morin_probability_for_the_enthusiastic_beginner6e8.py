...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e8: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_8(x, y) -> Deprecated; use :func:`morie.fn.covzmean` instead."
