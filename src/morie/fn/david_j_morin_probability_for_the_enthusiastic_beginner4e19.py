...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e19: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_19() -> Deprecated; use :func:`morie.fn.poisson_mean_rate` instead."
