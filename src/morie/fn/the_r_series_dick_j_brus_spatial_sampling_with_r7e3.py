...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r7e3: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_7_equation_3() -> Deprecated; use :func:`morie.fn.twostage_variance_components` instead."
