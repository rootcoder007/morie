...
def analyzing_spatial_models_of_choice_and_judgment_chapter_6_equation_4(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('analyzing_spatial_models_of_choice_and_judgment6e4')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={
            ...
            "se": se,
            "n": n,
            "method": "Resampling equation extracted from Cahoon, Hinich & Ordeshook (1978) Analyzing Spatial Models of Choice and Judgment.",
        },
    )
