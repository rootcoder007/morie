...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e18: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_18() -> Deprecated; use :func:`morie.fn.poisson_small_interval` instead."
