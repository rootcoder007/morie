...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e23: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_23(t, dt, lam) -> Deprecated; use :func:`morie.fn.expintp` instead."
