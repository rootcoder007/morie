...
`print(result)` render. See `morie.fn.describe('pidtun')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.pidtun import *
import numpy as np
# See the function signature in fn/pidtun.py for argument names.
```
