...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_35(x):
    """
    CentralTendency expression (auto-extracted; see ref).

    Formula: [EQ] out.height='7cm'>>=
...
def cheatsheet():
    return "christopher_gandrud_author_reproducible_research_with_r_and_4u35() -> CentralTendency expression (auto-extracted; see ref)"
