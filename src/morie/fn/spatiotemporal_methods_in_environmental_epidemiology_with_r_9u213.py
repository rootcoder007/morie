...
def spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_9_unnumbered_213(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.spatiotemporal_methods_in_environmental_epidemiology_with_r_9u213.spatiotemporal_methods_in_environmental_epidemiology_with_r__chapter_9_unnumbered_213 is not implemented yet: its former body returned a "
