...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r24e4: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_24_equation_4() -> Deprecated; use :func:`morie.fn.augmented_kriging_variance` instead."
