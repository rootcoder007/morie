...
"""Kamath Eq 2.25: the random token substitution (RTS) discriminative loss."""
...
def kamath_ch2_rts_loss(xhat, d):
    ...
    Language Models: A Deep Dive*, Springer, Ch 2, Eq 2.25, printed
    p. 52.

    Examples
    --------
    >>> import math
    >>> out = kamath_ch2_rts_loss([0.5, 0.5], [1, 0])
...
def cheatsheet():
    return "km025: per-token binary CE against original/replaced labels"
