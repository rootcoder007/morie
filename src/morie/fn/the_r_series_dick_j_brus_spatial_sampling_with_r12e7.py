...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r12e7: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_12_equation_7() -> Deprecated; use :func:`morie.fn.n_for_mean_length` instead."
