...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e66: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_66(n, p) -> Deprecated; use :func:`morie.fn.binommom2` instead."
