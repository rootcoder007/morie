...
`print(result)` render. See `morie.fn.describe('hazker')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.hazker import *
import numpy as np
# See the function signature in fn/hazker.py for argument names.
```
