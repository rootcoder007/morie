...
def tbvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbvar.tbvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbvar({}) -> Turning bands variance artifact correction."
