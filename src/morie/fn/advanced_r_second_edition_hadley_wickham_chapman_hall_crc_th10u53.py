...
__all__ = ["advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th_chapter_10_unnumbered_53"]
...
def cheatsheet():
    return "advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th10u53: GeneralStatistics expression (auto-extracted; see ref)."
