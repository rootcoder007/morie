...
`print(result)` render. See `morie.fn.describe('waltes')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.waltes import *
import numpy as np
# See the function signature in fn/waltes.py for argument names.
```
