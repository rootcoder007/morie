# describe('depmod') — depletion_model
...
`print(result)` render. See `morie.fn.describe('depmod')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.depmod import *
import numpy as np
# See the function signature in fn/depmod.py for argument names.
```
