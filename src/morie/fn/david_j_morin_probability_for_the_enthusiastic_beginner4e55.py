...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e55: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_55() -> Deprecated; use :func:`morie.fn.density_expectation` instead."
