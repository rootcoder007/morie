...
`print(result)` render. See `morie.fn.describe('witin')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.witin import *
import numpy as np
# See the function signature in fn/witin.py for argument names.
```
