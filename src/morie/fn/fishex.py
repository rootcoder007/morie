...
from ._stats_core import fisher_exact


def fishex(table: Union[Sequence, np.ndarray], alternative: str = "two-sided"):
...
def cheatsheet() -> str:
    return "fishex: fishex(table, alternative) -> Fisher's exact test for a 2x2 contingency table."
