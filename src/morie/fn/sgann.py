...
def sgann(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sgann.sgann is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sgann({}) -> SGS annealing perturbation for reproduction."
