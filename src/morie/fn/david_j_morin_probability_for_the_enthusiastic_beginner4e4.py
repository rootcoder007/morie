...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e4: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_4(grid, density, center, width) -> Deprecated; use :func:`morie.fn.densprobc` instead."
