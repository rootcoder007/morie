# describe('gb2112') — gibbons_block_freq_dist
...
`print(result)` render. See `morie.fn.describe('gb2112')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gb2112 import *
import numpy as np
# See the function signature in fn/gb2112.py for argument names.
```
