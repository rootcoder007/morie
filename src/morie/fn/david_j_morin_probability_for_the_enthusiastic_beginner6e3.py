...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_3(m, sigma_x, sigma_z):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_3() is the book-coordinate name for linmodel(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e3: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_3(m, sigma_x, sigma_z) -> Deprecated; use :func:`morie.fn.linmodel` instead."
