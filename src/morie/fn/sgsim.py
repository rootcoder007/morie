...
def sgsim(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sgsim.sgsim is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sgsim({}) -> Sequential Gaussian simulation core."
