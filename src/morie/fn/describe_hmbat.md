# describe('hmbat') — geron_batch_learning
...
`print(result)` render. See `morie.fn.describe('hmbat')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.hmbat import *
import numpy as np
# See the function signature in fn/hmbat.py for argument names.
```
