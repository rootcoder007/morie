...
def horowitz_manski_max_score(x, y):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Manski (1975) maximum-score estimator for binary response"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Manski (1975) maximum-score estimator for binary response",
        }
    )
