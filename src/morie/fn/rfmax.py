...
def rfmax(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfmax.rfmax is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfmax({}) -> Max-stable random field for extremes."
