...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e49: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_49() -> Deprecated; use :func:`morie.fn.conditional_subset` instead."
