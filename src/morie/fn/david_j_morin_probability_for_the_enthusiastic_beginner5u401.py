...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_unnumbered_401(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner5u401')`` for the full guide.
...
def cheatsheet():
    return (
        "david_j_morin_probability_for_the_enthusiastic_beginner5u401: Regression expression (auto-extracted; see ref)."
    )
