# describe('ca11e1') — ca_chapter_11_equation_1
...
```python
from morie.fn.ca11e1 import ca_chapter_11_equation_1
import numpy as np
result = ca_chapter_11_equation_1(np.random.default_rng(42).normal(0, 1, 100))
