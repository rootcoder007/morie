# describe('ghs032') — ghosal_ch3_polya_tree_density_bounds
...
`print(result)` render. See `morie.fn.describe('ghs032')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.ghs032 import *
import numpy as np
# See the function signature in fn/ghs032.py for argument names.
```
