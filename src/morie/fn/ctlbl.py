...
def ctlbl(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.ctlbl.ctlbl is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "ctlbl({}) -> Contour label placement algorithm."
