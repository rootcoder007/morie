...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_unnumbered_79(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner2u79')`` for the full guide.
...
def cheatsheet():
    return (
        "david_j_morin_probability_for_the_enthusiastic_beginner2u79: Dispersion expression (auto-extracted; see ref)."
    )
