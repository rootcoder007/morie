...
__all__ = ["bivand2013_chapter_7_unnumbered_205"]


def bivand2013_chapter_7_unnumbered_205(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('bivand20137u205')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u205: Correlation expression (auto-extracted; see ref)."
