...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e51: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_51(n, N) -> Deprecated; use :func:`morie.fn.starbrec` instead."
