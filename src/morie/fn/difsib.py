...
def dif_sibtest(y, group, studied=None, matching=None, correction=False, reference=None):
    ...
    reference : optional
        ...
        the first value encountered, which makes the SIGN of ``beta``
        depend on row order -- pass this explicitly whenever the
