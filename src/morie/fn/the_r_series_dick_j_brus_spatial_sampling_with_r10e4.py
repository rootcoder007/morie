...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r10e4: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_10_equation_4() -> Deprecated; use :func:`morie.fn.gls_population_slope` instead."
