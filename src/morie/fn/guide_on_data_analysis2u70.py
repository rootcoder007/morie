...
__all__ = ["guide_on_data_analysis_chapter_2_unnumbered_70"]


def guide_on_data_analysis_chapter_2_unnumbered_70(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: • If 𝑛 is an integer and 𝑛 > 1, then Γ(𝑛) = (𝑛 − 1)!
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis2u70')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis2u70: Association expression (auto-extracted; see ref)."
