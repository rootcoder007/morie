...
def ca_chapter_5_unnumbered_152(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('ca5u152')`` for the full guide.
...
def cheatsheet():
    return (
        "ca5u152: GeneralStatistics expression involving 'conviction' (auto-extracted; see reference for full context)."
    )
