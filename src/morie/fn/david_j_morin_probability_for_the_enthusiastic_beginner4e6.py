...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_6(k, n, p):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_6() is the book-coordinate name for binompmf(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e6: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_6(k, n, p) -> Deprecated; use :func:`morie.fn.binompmf` instead."
