# describe('entpro') — entropy_production
...
`print(result)` render. See `morie.fn.describe('entpro')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.entpro import *
import numpy as np
# See the function signature in fn/entpro.py for argument names.
```
