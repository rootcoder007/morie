...
def hedderich_chapter_9_unnumbered_953(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.hedderich9u953.hedderich_chapter_9_unnumbered_953 is not implemented yet: its former body returned a "
