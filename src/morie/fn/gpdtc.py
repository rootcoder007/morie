...
def gpdtc(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpdtc.gpdtc is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpdtc({}) -> GP deterministic training conditional."
