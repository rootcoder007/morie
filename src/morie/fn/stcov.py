...
def stcov(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stcov.stcov is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stcov({}) -> Space-time separable covariance model."
