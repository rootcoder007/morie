...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner7e31: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_7_equation_31(x, delta) -> Deprecated; use :func:`morie.fn.diffquot2` instead."
