...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_2(p_a, p_b):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_2() is the book-coordinate name for pandind(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e2: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_2(p_a, p_b) -> Deprecated; use :func:`morie.fn.pandind` instead."
