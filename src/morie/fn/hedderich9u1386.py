...
__all__ = ["hedderich_chapter_9_unnumbered_1386"]


def hedderich_chapter_9_unnumbered_1386(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: n−1,1−α/2 q2 =χ2
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u1386')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u1386: PowerAndDesign expression (auto-extracted; see ref)."
