...
def tbsph(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbsph.tbsph is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbsph({}) -> Turning bands spherical covariance."
