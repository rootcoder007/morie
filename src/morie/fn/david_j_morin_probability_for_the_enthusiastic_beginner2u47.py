...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_unnumbered_47(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('david_j_morin_probability_for_the_enthusiastic_beginner2u47')`` for the full guide.
...
def cheatsheet():
    return (
        "david_j_morin_probability_for_the_enthusiastic_beginner2u47: Probability expression (auto-extracted; see ref)."
    )
