...
deterministic given the data.  When treatment is independent of the
history -- the propensity fit returns the marginal frequency itself --
every stabilised weight is exactly one, and V_hat reduces to the plain
mean of Y over the subjects who follow the rule.  That is the degenerate
identity this module is anchored on; it is NOT true in general that the
weights collapse merely because everyone follows.
"""
