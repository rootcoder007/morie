...
def bookadvanced_elementsofstatisticallearning_chapter_8_equation_41(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('bookadvanced_elementsofstatisticallearning8e41')`` for the full guide.
    ...
    raise NotImplementedError(
        "morie.fn.bookadvanced_elementsofstatisticallearning8e41.bookadvanced_elementsofstatisticallearning_chapter_8_equation_41 is not implemented yet: its former body returned a "
