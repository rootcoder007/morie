...
def tbsim(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbsim.tbsim is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbsim({}) -> Turning bands simulation 2D."
