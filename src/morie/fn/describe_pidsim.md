...
`print(result)` render. See `morie.fn.describe('pidsim')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.pidsim import *
import numpy as np
# See the function signature in fn/pidsim.py for argument names.
```
