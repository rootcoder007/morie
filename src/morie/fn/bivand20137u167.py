...
__all__ = ["bivand2013_chapter_7_unnumbered_167"]


def bivand2013_chapter_7_unnumbered_167(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: dense representation of the (I −ρW) matrix to simulate spatial autocorrelation within the invIrW function, where W is a weights matrix, ρis
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('bivand20137u167')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u167: Correlation expression (auto-extracted; see ref)."
