...
def rfnst(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfnst.rfnst is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfnst({}) -> Nonstationary random field deformation."
