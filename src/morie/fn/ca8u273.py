...
__all__ = ["ca_chapter_8_unnumbered_273"]


def ca_chapter_8_unnumbered_273(x1, x2):
    """
    MetaAnalysis expression involving 'distribution' (auto-extracted; see reference for full context).

    Formula: effect size. To determine β and by extension statistical power, or 1 − β,w e
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('ca8u273')`` for the full guide.
    ...
    return RichResult(
        ...
        payload={
            ...
            "se": se,
            "n": n,
            "method": "MetaAnalysis expression involving 'distribution' (auto-extracted; see reference for full context).",
        },
    )


def cheatsheet():
    return "ca8u273: MetaAnalysis expression involving 'distribution' (auto-extracted; see reference for full context)."
