...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1161(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.statistical_methods_for_spatial_data_analysis1u1161.statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1161 is not implemented yet: its former body returned a "
