...
__all__ = ["hedderich_chapter_9_unnumbered_352"]


def hedderich_chapter_9_unnumbered_352(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] > n l s ( y ~ a *b^x , start = list ( a = 1 , b = 1 ) )
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u352')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u352: Correlation expression (auto-extracted; see ref)."
