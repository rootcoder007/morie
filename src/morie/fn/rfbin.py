...
def rfbin(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfbin.rfbin is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfbin({}) -> Binary random field threshold indicator."
