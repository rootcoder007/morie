...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_198"]


def information_theory_mackay_chapter_6_unnumbered_198(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] = H2(f) +NCfC ' H2(f) +Nf: (17.33)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('information_theory_mackay6u198')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u198: GeneralStatistics expression (auto-extracted; see ref)."
