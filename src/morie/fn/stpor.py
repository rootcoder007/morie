...
def stpor(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stpor.stpor is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stpor({}) -> Porcu-Gregori space-time covariance."
