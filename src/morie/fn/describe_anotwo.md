...
`print(result)` render. See `morie.fn.describe('anotwo')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.anotwo import *
import numpy as np
# See the function signature in fn/anotwo.py for argument names.
```
