...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo3e11: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_equation_11() -> Deprecated; use :func:`morie.fn.proportional_odds_logit` instead."
