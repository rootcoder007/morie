...
def cheeger(A):
    ...
    -------
    RichResult
        ``sweep_min``, ``lower_bound`` (lambda_2/2), ``lambda2``, ``cut_set``, ``fiedler``, ``n``.
    ...
    return RichResult(payload={
        "sweep_min": best, "lower_bound": lam2 / 2.0, "lambda2": lam2,
        "cut_set": bestset, "fiedler": f, "n": n,
