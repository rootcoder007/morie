...
__all__ = ["wilcox_chapter_14_unnumbered_597"]


def wilcox_chapter_14_unnumbered_597(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u597')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u597: Correlation expression (auto-extracted; see ref)."
