# describe('spatial_data_analysis_with_r2u5') — spatial_data_analysis_with_r_chapter_2_unnumbered_5
...
import numpy as np
result = spatial_data_analysis_with_r_chapter_2_unnumbered_5(np.random.default_rng(42).normal(0, 1, 100))
