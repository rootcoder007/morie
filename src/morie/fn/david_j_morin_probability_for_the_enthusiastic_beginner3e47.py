...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e47: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_47(n, p) -> Deprecated; use :func:`morie.fn.sdbinom` instead."
