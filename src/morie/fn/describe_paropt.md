# describe('paropt') — pareto_optimize
...
`print(result)` render. See `morie.fn.describe('paropt')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.paropt import *
import numpy as np
# See the function signature in fn/paropt.py for argument names.
```
