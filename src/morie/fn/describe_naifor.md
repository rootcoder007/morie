# describe('naifor') — naive_forecast
...
`print(result)` render. See `morie.fn.describe('naifor')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.naifor import *
import numpy as np
# See the function signature in fn/naifor.py for argument names.
```
