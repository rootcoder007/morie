...
def andrew_b_lawson_using_r_for_bayesian_spatial_and_spatio_temp_chapter_6_equation_17(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.andrew_b_lawson_using_r_for_bayesian_spatial_and_spatio_temp6e17.andrew_b_lawson_using_r_for_bayesian_spatial_and_spatio_temp_chapter_6_equation_17 is not implemented yet: its former body returned a "
