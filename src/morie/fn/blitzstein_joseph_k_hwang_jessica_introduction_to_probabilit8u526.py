...
__all__ = ["blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit_chapter_8_unnumbered_526"]
...
def cheatsheet():
    return "blitzstein_joseph_k_hwang_jessica_introduction_to_probabilit8u526: GeneralStatistics expression (auto-extracted; see ref)."
