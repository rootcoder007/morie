...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_30(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: ymin = lower, ymax = upper)) +
...
def cheatsheet():
    return "christopher_gandrud_author_reproducible_research_with_r_and_4u30() -> GeneralStatistics expression (auto-extracted; see ref)"
