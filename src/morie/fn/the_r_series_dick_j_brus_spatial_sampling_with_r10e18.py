...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r10e18: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_10_equation_18() -> Deprecated; use :func:`morie.fn.g_weighted_variance` instead."
