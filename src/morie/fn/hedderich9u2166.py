...
__all__ = ["hedderich_chapter_9_unnumbered_2166"]


def hedderich_chapter_9_unnumbered_2166(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] > noether ( alpha = 0 . 1 0 ,power = 0 . 8 0 , t = 0 . 5 , p=2 / 3 )
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u2166')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2166: PowerAndDesign expression (auto-extracted; see ref)."
