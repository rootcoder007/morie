# describe('infgai') — information_gain
...
`print(result)` render. See `morie.fn.describe('infgai')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.infgai import *
import numpy as np
# See the function signature in fn/infgai.py for argument names.
```
