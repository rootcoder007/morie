...
__all__ = ["wilcox_chapter_13_unnumbered_1315"]


def wilcox_chapter_13_unnumbered_1315(x):
    """
    Logistic expression (auto-extracted; see ref).

    Formula: [EQ] g(0) = ln {π (0)/[1 − π (0)]}.
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox13u1315')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1315: Logistic expression (auto-extracted; see ref)."
