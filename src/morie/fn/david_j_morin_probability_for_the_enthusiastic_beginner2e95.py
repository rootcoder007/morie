...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e95: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_95(p, k) -> Deprecated; use :func:`morie.fn.piidint` instead."
