...
def rfcox(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfcox.rfcox is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfcox({}) -> Cox process intensity random field."
