...
__all__ = ["rangayyan_ch3_lsi_parallel_combined_h"]
...
def rangayyan_ch3_lsi_parallel_combined_h(h_1, h_2, n):
    ...
    return RichResult(payload={"estimate": result, "se": se, "n": n, "method": "Combined impulse response of two LSI systems in parallel is their sum."})


def cheatsheet():
    return "rng047: Combined impulse response of two LSI systems in parallel is their sum."
