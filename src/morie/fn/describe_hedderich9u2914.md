# describe('hedderich9u2914') — hedderich_chapter_9_unnumbered_2914
...
+ " Chi − squaredtotal : " , c h i . gesamt = round ( chi , 3 ) , " \ n " )
...
import numpy as np
result = hedderich_chapter_9_unnumbered_2914(np.random.default_rng(42).normal(0, 1, 100))
