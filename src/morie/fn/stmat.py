...
def stmat(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stmat.stmat is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stmat({}) -> Space-time Matern covariance."
