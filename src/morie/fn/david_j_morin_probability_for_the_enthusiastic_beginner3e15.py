...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e15: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_15(e_x, n) -> Deprecated; use :func:`morie.fn.esumiid` instead."
