...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e96: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_96(n, p) -> Deprecated; use :func:`morie.fn.binompeak` instead."
