...
__all__ = ["wilcox_chapter_2_unnumbered_230"]


def wilcox_chapter_2_unnumbered_230(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] = sum(y), nn = length(y), y = NULL, alpha = 0.05)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox2u230')`` for the full guide.
...
def cheatsheet():
    return "wilcox2u230: Correlation expression (auto-extracted; see ref)."
