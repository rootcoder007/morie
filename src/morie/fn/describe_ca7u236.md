# describe('ca7u236') — ca_chapter_7_unnumbered_236
...
```python
from morie.fn.ca7u236 import ca_chapter_7_unnumbered_236
import numpy as np
result = ca_chapter_7_unnumbered_236(np.random.default_rng(42).normal(0, 1, 100))
