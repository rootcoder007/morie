...
def cdkrg(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdkrg.cdkrg is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdkrg({}) -> Conditional kriging for simulation conditioning."
