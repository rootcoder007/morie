# describe('ca12u362') — ca_chapter_12_unnumbered_362
...
```python
from morie.fn.ca12u362 import ca_chapter_12_unnumbered_362
import numpy as np
result = ca_chapter_12_unnumbered_362(np.random.default_rng(42).normal(0, 1, 100))
