# describe('fzc1c6') — fauzi_conditions_c1_c6
...
`print(result)` render. See `morie.fn.describe('fzc1c6')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.fzc1c6 import *
import numpy as np
# See the function signature in fn/fzc1c6.py for argument names.
```
