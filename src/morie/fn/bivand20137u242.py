...
__all__ = ["bivand2013_chapter_7_unnumbered_242"]


def bivand2013_chapter_7_unnumbered_242(x, y=None):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('bivand20137u242')`` for the full guide.
...
def cheatsheet():
    return "bivand20137u242: Association expression (auto-extracted; see ref)."
