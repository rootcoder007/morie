...
`print(result)` render. See `morie.fn.describe('grosta')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.grosta import *
import numpy as np
# See the function signature in fn/grosta.py for argument names.
```
