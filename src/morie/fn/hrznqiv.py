...
def horowitz_nonpar_quantile_iv(x, y, w, tau):
    ...
    return RichResult(payload={"estimate": float(estimate), "se": float(se), "ci_lower": float(ci_lower), "ci_upper": float(ci_upper), "n": n, "method": "Nonparametric quantile IV estimation"})
