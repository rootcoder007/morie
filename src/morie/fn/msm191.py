...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_19"]

mvsml_ridge_lasso_elastic_eq_9_19 = qplincon


def cheatsheet():
    return "msm191: Quadratic program under one linear inequality (see msm188)"
