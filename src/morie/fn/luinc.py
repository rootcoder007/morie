...
def luinc(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.luinc.luinc is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "luinc({}) -> LU incomplete factorization approximation."
