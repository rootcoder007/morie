...
`print(result)` render. See `morie.fn.describe('ghosig')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.ghosig import *
import numpy as np
# See the function signature in fn/ghosig.py for argument names.
```
