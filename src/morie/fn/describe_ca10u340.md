# describe('ca10u340') — ca_chapter_10_unnumbered_340
...
```python
from morie.fn.ca10u340 import ca_chapter_10_unnumbered_340
import numpy as np
result = ca_chapter_10_unnumbered_340(np.random.default_rng(42).normal(0, 1, 100))
