...
__all__ = ["hedderich_chapter_9_unnumbered_941"]


def hedderich_chapter_9_unnumbered_941(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: k> 1 it always holdsf (0) = 0 , the density has a maximum value at(k−1)/λand then falls again
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u941')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u941: Association expression (auto-extracted; see ref)."
