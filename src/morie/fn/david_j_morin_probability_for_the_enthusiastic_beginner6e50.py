...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e50: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_50(x, y) -> Deprecated; use :func:`morie.fn.lsqrev` instead."
