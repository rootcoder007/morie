...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_76(m=1.0, sigma_x=7.5, sigma_z=10.6):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_76() is the book-coordinate name for linmodel(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e76: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_76(m, sigma_x, sigma_z) -> Deprecated; use :func:`morie.fn.linmodel` instead."
