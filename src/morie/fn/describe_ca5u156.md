# describe('ca5u156') — ca_chapter_5_unnumbered_156
...
= τ0,m + b1x1 + b2x2 + ... + bkxk Equation 5 :8
...
```python
from morie.fn.ca5u156 import ca_chapter_5_unnumbered_156
import numpy as np
result = ca_chapter_5_unnumbered_156(np.random.default_rng(42).normal(0, 1, 100))
