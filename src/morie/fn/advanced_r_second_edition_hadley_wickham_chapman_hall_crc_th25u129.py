...
def advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th_chapter_25_unnumbered_129(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: [EQ] for(int j = 0; j < thin; j++) {
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th25u129')`` for the full guide.
...
def cheatsheet():
    return "advanced_r_second_edition_hadley_wickham_chapman_hall_crc_th25u129: Association expression (auto-extracted; see ref)."
