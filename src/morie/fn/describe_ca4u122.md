# describe('ca4u122') — ca_chapter_4_unnumbered_122
...
```python
from morie.fn.ca4u122 import ca_chapter_4_unnumbered_122
import numpy as np
result = ca_chapter_4_unnumbered_122(np.random.default_rng(42).normal(0, 1, 100))
