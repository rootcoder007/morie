...
`print(result)` render. See `morie.fn.describe('levfli')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.levfli import *
import numpy as np
# See the function signature in fn/levfli.py for argument names.
```
