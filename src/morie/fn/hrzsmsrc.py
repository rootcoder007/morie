...
def horowitz_sms_rate(n, smoothness_order):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Rate of convergence of smoothed maximum-score estimator"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Rate of convergence of smoothed maximum-score estimator",
        }
    )
