...
def rfgam(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfgam.rfgam is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfgam({}) -> Gamma random field via anamorphosis."
