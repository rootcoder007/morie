...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r24e3: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_24_equation_3() -> Deprecated; use :func:`morie.fn.variance_of_kriging_variance` instead."
