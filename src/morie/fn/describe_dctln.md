...
`print(result)` render. See `morie.fn.describe('dctln')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.dctln import *
import numpy as np
# See the function signature in fn/dctln.py for argument names.
```
