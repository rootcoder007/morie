...
def tbgss(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbgss.tbgss is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbgss({}) -> Turning bands Gaussian covariance."
