...
def stmet(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stmet.stmet is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stmet({}) -> Space-time integrated metric covariance."
