...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_6(x, cdf=None):
    ...
    Formula: RlMdmv1p25Xy5thJUhkKGvjtV-dkAIsUXP-AL4ffI/preview?slide=id.g362da58057_0_1 .
...
def cheatsheet():
    return "christopher_gandrud_author_reproducible_research_with_r_and_4u6() -> GeneralStatistics expression (auto-extracted; see ref)"
