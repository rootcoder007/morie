# describe('ca8u318') — ca_chapter_8_unnumbered_318
...
[EQ] pwr.f2.test(u = 8, v = 91, f2 = .02/(1-.02),
...
import numpy as np
result = ca_chapter_8_unnumbered_318(np.random.default_rng(42).normal(0, 1, 100))
