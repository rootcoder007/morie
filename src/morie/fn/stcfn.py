...
def stcfn(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stcfn.stcfn is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stcfn({}) -> Space-time correlation function evaluation."
