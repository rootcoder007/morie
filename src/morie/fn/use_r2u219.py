...
__all__ = ["use_r_chapter_2_unnumbered_219"]


def use_r_chapter_2_unnumbered_219(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: + listw = NYlistwW, alpha = 0.5)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('use_r2u219')`` for the full guide.
...
def cheatsheet():
    return "use_r2u219: Correlation expression (auto-extracted; see ref)."
