...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo3e1: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_3_equation_1() -> Deprecated; use :func:`morie.fn.multinomial_pmf` instead."
