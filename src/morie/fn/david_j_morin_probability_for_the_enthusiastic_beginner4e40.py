...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e40: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_40(k, a) -> Deprecated; use :func:`morie.fn.poispmf` instead."
