...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo4e6: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_4_equation_6() -> Deprecated; use :func:`morie.fn.loglinear_saturated_mean` instead."
