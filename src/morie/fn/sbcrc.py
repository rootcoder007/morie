...
def sbcrc(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbcrc.sbcrc is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbcrc({}) -> Circular block bootstrap spatial."
