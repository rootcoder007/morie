...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r7e13: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_7_equation_13() -> Deprecated; use :func:`morie.fn.twostage_total_si` instead."
