...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e65: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_65() -> Deprecated; use :func:`morie.fn.exact_half_heads` instead."
