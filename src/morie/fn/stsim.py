...
def stsim(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stsim.stsim is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stsim({}) -> Space-time random field simulation."
