...
`print(result)` render. See `morie.fn.describe('catfit')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.catfit import *
import numpy as np
# See the function signature in fn/catfit.py for argument names.
```
