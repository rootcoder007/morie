...
def gibbons_k2_contingency(table, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Special results for kx2 contingency tables: equivalence to other tests"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Special results for kx2 contingency tables: equivalence to other tests"})
