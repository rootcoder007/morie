# describe('detlea') — detect_leakage
...
`print(result)` render. See `morie.fn.describe('detlea')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.detlea import *
import numpy as np
# See the function signature in fn/detlea.py for argument names.
```
