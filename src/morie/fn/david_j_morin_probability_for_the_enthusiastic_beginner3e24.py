...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e24: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_24() -> Deprecated; use :func:`morie.fn.var_scale` instead."
