...
def tbens(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbens.tbens is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbens({}) -> Turning bands ensemble statistics."
