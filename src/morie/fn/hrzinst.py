...
def horowitz_instruments_transformation(x, y, z):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Choosing instruments for transformation model estimation"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Choosing instruments for transformation model estimation",
        }
    )
