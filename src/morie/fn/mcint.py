...
def mcint(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.mcint.mcint is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "mcint({}) -> Monte Carlo spatial integration estimate."
