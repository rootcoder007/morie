...
__all__ = ["hedderich_chapter_9_unnumbered_2640"]


def hedderich_chapter_9_unnumbered_2640(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: X− squared = 3 . 8 1 0 7 , df = 1 , p− value = 0 .0 5 0 93
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u2640')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2640: Correlation expression (auto-extracted; see ref)."
