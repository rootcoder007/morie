...
__all__ = ["hedderich_chapter_9_unnumbered_296"]


def hedderich_chapter_9_unnumbered_296(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] (83−8)−(18 + 24) = 0.4935
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u296')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u296: Correlation expression (auto-extracted; see ref)."
