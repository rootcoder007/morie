...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e32: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_32(k, n, b) -> Deprecated; use :func:`morie.fn.binomdie` instead."
