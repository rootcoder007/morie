...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_71(sigma, n):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_71() is the book-coordinate name for sdiidsum(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e71: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_71(sigma, n) -> Deprecated; use :func:`morie.fn.sdiidsum` instead."
