# describe('gb2111') — gibbons_tolerance_beta
...
`print(result)` render. See `morie.fn.describe('gb2111')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gb2111 import *
import numpy as np
# See the function signature in fn/gb2111.py for argument names.
```
