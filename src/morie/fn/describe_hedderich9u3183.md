# describe('hedderich9u3183') — hedderich_chapter_9_unnumbered_3183
...
yt = 3 + 2xt +ut for t = 1,..., 20 withX∼N (µ= 100, σ2 = 10 2) and
...
import numpy as np
result = hedderich_chapter_9_unnumbered_3183(np.random.default_rng(42).normal(0, 1, 100))
