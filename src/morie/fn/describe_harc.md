...
`print(result)` render. See `morie.fn.describe('harc')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.harc import *
import numpy as np
# See the function signature in fn/harc.py for argument names.
```
