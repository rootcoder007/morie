...
__all__ = ["svmsdual", "mvsml_ridge_lasso_elastic_eq_9_45"]

mvsml_ridge_lasso_elastic_eq_9_45 = svmsdual


def cheatsheet():
    return "msm232: Wolfe dual of the support vector classifier (see msm231)"
