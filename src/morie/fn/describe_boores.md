# describe('boores') — bootstrap_resample
...
`print(result)` render. See `morie.fn.describe('boores')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.boores import *
import numpy as np
# See the function signature in fn/boores.py for argument names.
```
