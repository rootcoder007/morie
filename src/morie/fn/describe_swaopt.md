# describe('swaopt') — swarm_optimize
...
`print(result)` render. See `morie.fn.describe('swaopt')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.swaopt import *
import numpy as np
# See the function signature in fn/swaopt.py for argument names.
```
