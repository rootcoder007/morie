...
`print(result)` render. See `morie.fn.describe('gaubea')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gaubea import *
import numpy as np
# See the function signature in fn/gaubea.py for argument names.
```
