...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e94: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_94(a) -> Deprecated; use :func:`morie.fn.poisvar` instead."
