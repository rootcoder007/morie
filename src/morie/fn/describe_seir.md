...
`print(result)` render. See `morie.fn.describe('seir')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.seir import *
import numpy as np
# See the function signature in fn/seir.py for argument names.
```
