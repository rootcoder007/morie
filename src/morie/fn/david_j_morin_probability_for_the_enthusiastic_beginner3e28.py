...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e28: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_28() -> Deprecated; use :func:`morie.fn.twocoinvar` instead."
