...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e23: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_23(y) -> Deprecated; use :func:`morie.fn.bestconst` instead."
