...
`print(result)` render. See `morie.fn.describe('timstr')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.timstr import *
import numpy as np
# See the function signature in fn/timstr.py for argument names.
```
