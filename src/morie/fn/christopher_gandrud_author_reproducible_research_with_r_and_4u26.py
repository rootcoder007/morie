...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_26(x):
    ...
    Formula: ```{r echo=FALSE, fig.align='center', out.width='8cm'}
...
def cheatsheet():
    return 'christopher_gandrud_author_reproducible_research_with_r_and_4u26() -> CentralTendency expression (auto-extracted; see ref)'
