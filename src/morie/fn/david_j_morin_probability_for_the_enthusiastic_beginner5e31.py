...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner5e31: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_equation_31() -> Deprecated; use :func:`morie.fn.pmf_sd` instead."
