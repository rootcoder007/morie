...
"""Kamath Eq 2.26: the shuffled language modelling (SLM) pretraining loss."""
...
def kamath_ch2_slm_loss(x, R_x):
    ...
    return RichResult(payload={
        ...
        "method": "shuffled language modelling (SLM) loss (Kamath Eq 2.26)"})


def cheatsheet():
    return "km026: -mean log P over the shuffled positions R_x"
