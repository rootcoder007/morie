...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_23() -> Deprecated; use :func:`morie.fn.posterior_density_binomial` instead."
