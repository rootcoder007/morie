...
__all__ = ["wilcox_chapter_14_unnumbered_458"]


def wilcox_chapter_14_unnumbered_458(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] 1 − (−0.286) 2 = −2.
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u458')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u458: Correlation expression (auto-extracted; see ref)."
