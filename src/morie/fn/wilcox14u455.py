...
__all__ = ["wilcox_chapter_14_unnumbered_455"]


def wilcox_chapter_14_unnumbered_455(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: A point worth stressing is that although independence implies that ρ = 0, ρ = 0 does
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u455')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u455: Correlation expression (auto-extracted; see ref)."
