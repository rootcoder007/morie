...
__all__ = ["wilcox_chapter_14_unnumbered_463"]


def wilcox_chapter_14_unnumbered_463(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: have power equal to 0.8 when ρ = 0.5 and the Type I error probability is α = 0.01. The R
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u463')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u463: Correlation expression (auto-extracted; see ref)."
