...
def rangayyan_burg_method(x, order, fs):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Burg method for AR spectral estimation (maximum entropy)"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Burg method for AR spectral estimation (maximum entropy)",
        }
    )
