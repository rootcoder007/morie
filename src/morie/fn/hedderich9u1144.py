...
def hedderich_chapter_9_unnumbered_1144(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.hedderich9u1144.hedderich_chapter_9_unnumbered_1144 is not implemented yet: its former body returned a "
