...
def stgnt(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stgnt.stgnt is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stgnt({}) -> Gneiting space-time covariance model."
