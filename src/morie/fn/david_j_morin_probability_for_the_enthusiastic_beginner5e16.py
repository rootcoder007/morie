...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner5e16: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_5_equation_16(k, a) -> Deprecated; use :func:`morie.fn.poisstirl` instead."
