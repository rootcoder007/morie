...
__all__ = ["wilcox_chapter_12_unnumbered_1379"]


def wilcox_chapter_12_unnumbered_1379(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: [EQ] 11.6(1/20 + 1 /20) = 4 .64 ν = 100 − 5 =
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox12u1379')`` for the full guide.
...
def cheatsheet():
    return "wilcox12u1379: PowerAndDesign expression (auto-extracted; see ref)."
