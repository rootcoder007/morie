...
Chapter 9 throughout: eqs (9.2)-(9.8), (9.13)-(9.18), Sec. 9.1 on why
space and time are not concatenated, Sec. 9.3 on validity, and the
Example 9.1 worked cases. Every entry below is the book's own, except
the last two, which postdate it.
...
attribute the classical estimator that eq (9.18) extends to space-time.
The English exposition usually cited in its place is Matheron, G.
(1963) "Principles of geostatistics", *Economic Geology* 58(8),
1246-1266, doi:10.2113/gsecongeo.58.8.1246.

Posa, D. (1993) "A simple description of spatial-temporal processes",
*Computational Statistics & Data Analysis* 15, 425-437 -- eq (9.6).

Cressie, N. & Huang, H.-C. (1999) "Classes of nonseparable,
spatio-temporal stationary covariance functions", *Journal of the
American Statistical Association* 94, 1330-1340 -- the class Gneiting
(2002) found to contain invalid members, which is why
`is_valid_covariance` checks (9.5) numerically.
...
590-600 -- eq (9.8), and the SUFFICIENT validity conditions.

De Cesare, L., Myers, D. & Posa, D. (2001) "Estimating and modeling
space-time correlation structures", *Statistics and Probability
Letters* 51(1), 9-14 -- the product-sum model.

De Iaco, S., Myers, D. E. & Posa, D. (2002) "Nonseparable space-time
covariance models: some parametric families", *Mathematical Geology*
34(1), 23-42.

Ma, C. (2002) "Spatio-temporal covariance functions generated by
mixtures", *Mathematical Geology* 34(8), 965-975 -- eqs (9.13), (9.14),
(9.16) and Example 9.1.

Jones, R. H. & Zhang, Y. (1997) "Models for continuous stationary
space-time processes", in Gregoire, T. G., Brillinger, D. R., Diggle,
P. J., Russek-Cohen, E., Warren, W. G. & Wolfinger, R. D. (eds.),
*Modeling Longitudinal and Spatially Correlated Data*, Springer, New
York, 289-298 -- eq (9.17), the zero-order Hankel transform.

Whittle, P. (1954) "On stationary processes in the plane", *Biometrika*
41, 434-449 -- the elementary process used as the spatial component.

Mitchell, M. W. & Gumpertz, M. L. (2003) "Spatio-temporal prediction
inside a free-air CO2 enrichment system", *Journal of Agricultural,
Biological, and Environmental Statistics* 8(3), 310-327.
...
605-610 -- the boundary correction applied by `separability_test`.

Fisher, R. A., Thornton, H. G. & MacKenzie, W. A. (1922) "The accuracy
of the plating method of estimating the density of bacterial
populations", *Annals of Applied Biology* 9, 325-359 -- the index of
dispersion I = X^2/(rc-1) used with eq (3.3).

Postdating the book, and verified independently:

Golub, G. H. & Welsch, J. H. (1969) "Calculation of Gauss quadrature
rules", *Mathematics of Computation* 23(106), 221-230,
doi:10.1090/S0025-5718-69-99647-1 -- the node-and-weight algorithm, not
a book method.

Zastavnyi, V. P. & Porcu, E. (2011) "Characterization theorems for the
Gneiting class of space-time covariances", *Bernoulli* 17(1), 456-465,
doi:10.3150/10-BEJ278 -- the NECESSARY conditions, which is why
enforcing Gneiting's bounds is documented here as conservative rather
than as law.
