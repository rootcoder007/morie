# describe('defall') — defense_allocation
...
`print(result)` render. See `morie.fn.describe('defall')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.defall import *
import numpy as np
# See the function signature in fn/defall.py for argument names.
```
