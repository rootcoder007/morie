...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e13: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_13() -> Deprecated; use :func:`morie.fn.slope_from_cov` instead."
