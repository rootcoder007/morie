...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_9() -> Deprecated; use :func:`morie.fn.survey_proportion_variance` instead."
