...
You can read fields by attribute (`r.statistic`), index (`r["statistic'Difficulties strengthen the mind, as labor does the body. — Seneca's a RichResult; `isinstance(r, dict)`
