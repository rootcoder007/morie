...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e92: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_92(a) -> Deprecated; use :func:`morie.fn.poismean` instead."
