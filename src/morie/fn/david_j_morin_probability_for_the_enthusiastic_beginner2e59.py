...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e59: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_59(p_a, p_z_given_a, p_z_given_not_a) -> Deprecated; use :func:`morie.fn.bayesexp` instead."
