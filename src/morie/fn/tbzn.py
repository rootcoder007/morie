...
def tbzn(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbzn.tbzn is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbzn({}) -> Turning bands zone anisotropy rotation."
