...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_3(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: begin with the following head: <<>>=. The code chunk is closed with an at
...
def cheatsheet():
    return 'christopher_gandrud_author_reproducible_research_with_r_and_4u3() -> GeneralStatistics expression (auto-extracted; see ref)'
