...
__all__ = ["wilcox_chapter_14_unnumbered_599"]


def wilcox_chapter_14_unnumbered_599(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: where ℓ = 7 and u = 593 if N < 40; ℓ = 8 and u = 592 if 40 ≤ N < 80; ℓ = 11 and
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u599')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u599: Correlation expression (auto-extracted; see ref)."
