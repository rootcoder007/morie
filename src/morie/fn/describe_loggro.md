# describe('loggro') — logistic_growth
...
`print(result)` render. See `morie.fn.describe('loggro')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.loggro import *
import numpy as np
# See the function signature in fn/loggro.py for argument names.
```
