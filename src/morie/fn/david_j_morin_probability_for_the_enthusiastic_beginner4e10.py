...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e10: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_10() -> Deprecated; use :func:`morie.fn.binomial_pmf_vector` instead."
