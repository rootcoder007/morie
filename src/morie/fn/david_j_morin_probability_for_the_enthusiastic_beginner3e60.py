...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e60: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_60(x) -> Deprecated; use :func:`morie.fn.popvar` instead."
