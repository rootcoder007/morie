...
`print(result)` render. See `morie.fn.describe('astpat')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.astpat import *
import numpy as np
# See the function signature in fn/astpat.py for argument names.
```
