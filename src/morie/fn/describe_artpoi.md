# describe('artpoi') — articulation_points
...
`print(result)` render. See `morie.fn.describe('artpoi')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.artpoi import *
import numpy as np
# See the function signature in fn/artpoi.py for argument names.
```
