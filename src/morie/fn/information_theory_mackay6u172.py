...
__all__ = ["information_theory_mackay_chapter_6_unnumbered_172"]


def information_theory_mackay_chapter_6_unnumbered_172(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: [EQ] SubstituteP(yjx) = exp((yx)2=22)=
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('information_theory_mackay6u172')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay6u172: GeneralStatistics expression (auto-extracted; see ref)."
