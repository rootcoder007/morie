...
__all__ = ["guide_on_data_analysis_chapter_11_unnumbered_821"]


def guide_on_data_analysis_chapter_11_unnumbered_821(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] #> z = 4.6612, p-value = 3.144e-06
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis11u821')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis11u821: Correlation expression (auto-extracted; see ref)."
