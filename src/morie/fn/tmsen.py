...
def tmsen(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmsen.tmsen is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmsen({}) -> Sen slope temporal trend estimator."
