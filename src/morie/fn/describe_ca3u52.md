# describe('ca3u52') — ca_chapter_3_unnumbered_52
...
Northeast − South = 45.145 − 46.984 =− 1.839
...
```python
from morie.fn.ca3u52 import ca_chapter_3_unnumbered_52
import numpy as np
result = ca_chapter_3_unnumbered_52(np.random.default_rng(42).normal(0, 1, 100))
