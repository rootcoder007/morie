...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e1: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_1() -> Deprecated; use :func:`morie.fn.factorial` instead."
