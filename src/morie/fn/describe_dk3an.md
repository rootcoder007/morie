...
`print(result)` render. See `morie.fn.describe('dk3an')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.dk3an import *
import numpy as np
# See the function signature in fn/dk3an.py for argument names.
```
