...
__all__ = ["guide_on_data_analysis_chapter_28_unnumbered_1411"]


def guide_on_data_analysis_chapter_28_unnumbered_1411(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: cat(" (1) Local RDiT => estimated local jump = " , round(tau_hat,2), "\n")
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis28u1411')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis28u1411: Association expression (auto-extracted; see ref)."
