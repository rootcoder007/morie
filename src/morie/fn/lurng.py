...
def lurng(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.lurng.lurng is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "lurng({}) -> LU simulation range-dependent correlation."
