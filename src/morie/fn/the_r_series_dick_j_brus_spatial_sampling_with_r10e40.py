...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r10e40: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_10_equation_40() -> Deprecated; use :func:`morie.fn.mixed_calibration_si` instead."
