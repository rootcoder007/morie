# describe('detmet') — detection_metrics
...
`print(result)` render. See `morie.fn.describe('detmet')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.detmet import *
import numpy as np
# See the function signature in fn/detmet.py for argument names.
```
