# describe('gh_c14_20') — ghosal_probit_sbp
...
`print(result)` render. See `morie.fn.describe('gh_c14_20')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gh_c14_20 import *
import numpy as np
# See the function signature in fn/gh_c14_20.py for argument names.
```
