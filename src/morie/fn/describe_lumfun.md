# describe('lumfun') — luminosity_function
...
`print(result)` render. See `morie.fn.describe('lumfun')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.lumfun import *
import numpy as np
# See the function signature in fn/lumfun.py for argument names.
```
