...
`print(result)` render. See `morie.fn.describe('resq')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.resq import *
import numpy as np
# See the function signature in fn/resq.py for argument names.
```
