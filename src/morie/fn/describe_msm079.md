# describe('msm079') — mvsml_bayesian_regression_eq_6_11
...
`print(result)` render. See `morie.fn.describe('msm079')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.msm079 import *
import numpy as np
# See the function signature in fn/msm079.py for argument names.
```
