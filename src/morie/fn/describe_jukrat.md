# describe('jukrat') — jukes_cantor_rate
...
`print(result)` render. See `morie.fn.describe('jukrat')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.jukrat import *
import numpy as np
# See the function signature in fn/jukrat.py for argument names.
```
