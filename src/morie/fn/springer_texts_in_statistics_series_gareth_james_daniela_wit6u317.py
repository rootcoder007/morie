...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_317"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_317(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: gamma=2, cost=1,decision .values=T)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u317')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u317: Association expression (auto-extracted; see ref)."
