...
def vdvor(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.vdvor.vdvor is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "vdvor({}) -> Voronoi diagram 2D tessellation."
