...
`print(result)` render. See `morie.fn.describe('getax')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.getax import *
import numpy as np
# See the function signature in fn/getax.py for argument names.
```
