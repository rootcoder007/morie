...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_25(t, dt, lam):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_25() is the book-coordinate name for expintp(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e25: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_25(t, dt, lam) -> Deprecated; use :func:`morie.fn.expintp` instead."
