...
def vdchk(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.vdchk.vdchk is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "vdchk({}) -> Delaunay in-circle criterion check."
