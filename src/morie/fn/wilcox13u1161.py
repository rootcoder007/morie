...
__all__ = ["wilcox_chapter_13_unnumbered_1161"]


def wilcox_chapter_13_unnumbered_1161(x, y=None):
    """
    Association expression (auto-extracted; see ref).
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox13u1161')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1161: Association expression (auto-extracted; see ref)."
