...
`print(result)` render. See `morie.fn.describe('summar')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.summar import *
import numpy as np
# See the function signature in fn/summar.py for argument names.
```
