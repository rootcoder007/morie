...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e93: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_93(sigma, N) -> Deprecated; use :func:`morie.fn.sdxbar` instead."
