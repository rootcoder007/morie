...
def tmses(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmses.tmses is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmses({}) -> Temporal seasonal decomposition STL."
