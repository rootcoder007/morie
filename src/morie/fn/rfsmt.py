...
def rfsmt(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfsmt.rfsmt is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfsmt({}) -> Smooth random field low-frequency component."
