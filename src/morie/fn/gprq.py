...
def gprq(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gprq.gprq is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gprq({}) -> GP rational quadratic kernel."
