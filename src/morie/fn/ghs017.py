...
def ghosal_ch3_discrete_random_measure(W_i, theta_i):
    ...
    return RichResult(
        payload={
            ...
            "se": se,
            "n": n,
            "method": "Discrete random probability measure on X expressed as an infinite weighted sum of point masses at random locations theta_i with stick-breaking weights W_i.",
        }
    )
