# describe('jacd') — jackknife_delete_d
...
`print(result)` render. See `morie.fn.describe('jacd')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.jacd import *
import numpy as np
# See the function signature in fn/jacd.py for argument names.
```
