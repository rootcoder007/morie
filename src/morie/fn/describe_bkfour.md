# describe('bkfour') — baron_kenny_four_step
...
`print(result)` render. See `morie.fn.describe('bkfour')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.bkfour import *
import numpy as np
# See the function signature in fn/bkfour.py for argument names.
```
