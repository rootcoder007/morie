# describe('hedderich9u2913') — hedderich_chapter_9_unnumbered_2913
...
+ " Chi − squarederror : " , c h i . e r r = round ( c h i . e , 3 ) , " \ n " ,
...
import numpy as np
result = hedderich_chapter_9_unnumbered_2913(np.random.default_rng(42).normal(0, 1, 100))
