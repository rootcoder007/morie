...
`print(result)` render. See `morie.fn.describe('tsnred')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.tsnred import *
import numpy as np
# See the function signature in fn/tsnred.py for argument names.
```
