...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo1e5: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_1_equation_5() -> Deprecated; use :func:`morie.fn.beta_pdf` instead."
