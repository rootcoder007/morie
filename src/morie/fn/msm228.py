...
__all__ = ["svmkkt", "mvsml_ridge_lasso_elastic_eq_9_43"]

mvsml_ridge_lasso_elastic_eq_9_43 = svmkkt


def cheatsheet():
    return "msm228: Karush-Kuhn-Tucker conditions of the support vector classifier (see msm223)"
