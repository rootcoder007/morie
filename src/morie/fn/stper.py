...
def stper(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stper.stper is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stper({}) -> Periodic space-time covariance model."
