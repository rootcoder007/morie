# describe('winmea') — winsorized_mean
...
`print(result)` render. See `morie.fn.describe('winmea')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.winmea import *
import numpy as np
# See the function signature in fn/winmea.py for argument names.
```
