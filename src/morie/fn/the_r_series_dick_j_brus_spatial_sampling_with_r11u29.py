...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_11_unnumbered_29(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('the_r_series_dick_j_brus_spatial_sampling_with_r11u29')`` for the full guide.
...
def cheatsheet():
    return (
        "the_r_series_dick_j_brus_spatial_sampling_with_r11u29: CentralTendency expression (auto-extracted; see ref)."
    )
