...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e51: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_51(n) -> Deprecated; use :func:`morie.fn.sdcoinsum` instead."
