...
def analyzing_spatial_models_of_choice_and_judgment_chapter_6_equation_40(x):
    ...
    raise NotImplementedError(
        "morie.fn.analyzing_spatial_models_of_choice_and_judgment6e40.analyzing_spatial_models_of_choice_and_judgment_chapter_6_equation_40 is not implemented yet: its former body returned a "
