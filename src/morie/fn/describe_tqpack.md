# describe('tqpack') — turboquant_bit_pack_indices
...
`print(result)` render. See `morie.fn.describe('tqpack')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.tqpack import *
import numpy as np
# See the function signature in fn/tqpack.py for argument names.
```
