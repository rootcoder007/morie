...
def cdval(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdval.cdval is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdval({}) -> Conditional simulation validation E-type."
