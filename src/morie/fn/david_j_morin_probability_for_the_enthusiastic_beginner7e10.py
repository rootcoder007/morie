...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner7e10: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_7_equation_10(a, terms) -> Deprecated; use :func:`morie.fn.poisnorm` instead."
