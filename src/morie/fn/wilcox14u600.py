...
__all__ = ["wilcox_chapter_14_unnumbered_600"]


def wilcox_chapter_14_unnumbered_600(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] u = 588 if 80 ≤ N <180; ℓ = 14 and u = 585 if 180 ≤ N <250; and ℓ = 15 and u = 584 if
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u600')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u600: Correlation expression (auto-extracted; see ref)."
