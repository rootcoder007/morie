...
eq. (8.67): the stub generator pasted the same one-sample
...
def hedderich_chapter_8_equation_67(*args, **kwargs):
    """Deprecated; use :func:`morie.fn.lrresid` instead."""
    warnings.warn(
        "hedderich_chapter_8_equation_67() is the book-coordinate name for lrresid(); "
...
def cheatsheet() -> str:
    return "hedderich8e67: hedderich_chapter_8_equation_67() -> Deprecated; use :func:`morie.fn.lrresid` instead."
