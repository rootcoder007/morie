...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_46(x, y):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_46() is the book-coordinate name for lsqfit(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e46: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_46(x, y) -> Deprecated; use :func:`morie.fn.lsqfit` instead."
