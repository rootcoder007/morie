...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e46: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_46() -> Deprecated; use :func:`morie.fn.sd_bernoulli` instead."
