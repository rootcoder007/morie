...
def gpper(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpper.gpper is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpper({}) -> GP periodic kernel regression."
