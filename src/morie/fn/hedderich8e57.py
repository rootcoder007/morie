...
eq. (8.57): the stub generator pasted the same one-sample
...
def hedderich_chapter_8_equation_57(*args, **kwargs):
    """Deprecated; use :func:`morie.fn.lrwald` instead."""
    warnings.warn(
        "hedderich_chapter_8_equation_57() is the book-coordinate name for lrwald(); "
...
def cheatsheet() -> str:
    return "hedderich8e57: hedderich_chapter_8_equation_57() -> Deprecated; use :func:`morie.fn.lrwald` instead."
