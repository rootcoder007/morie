...
def gibbons_friedman_ties(data, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Friedman statistic with correction for tied observations"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Friedman statistic with correction for tied observations"})
