...
`print(result)` render. See `morie.fn.describe('hott2')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.hott2 import *
import numpy as np
# See the function signature in fn/hott2.py for argument names.
```
