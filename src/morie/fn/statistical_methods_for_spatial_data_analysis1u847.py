...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_847"]
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u847: Spatial expression (auto-extracted; see ref)."
