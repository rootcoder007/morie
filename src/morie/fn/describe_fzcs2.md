# describe('fzcs2') — fauzi_cum_surv_est2
...
`print(result)` render. See `morie.fn.describe('fzcs2')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.fzcs2 import *
import numpy as np
# See the function signature in fn/fzcs2.py for argument names.
```
