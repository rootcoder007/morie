# describe('allreg') — allometric_regression
...
`print(result)` render. See `morie.fn.describe('allreg')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.allreg import *
import numpy as np
# See the function signature in fn/allreg.py for argument names.
```
