...
__all__ = ["svmkkt", "mvsml_ridge_lasso_elastic_eq_9_41"]

mvsml_ridge_lasso_elastic_eq_9_41 = svmkkt


def cheatsheet():
    return "msm226: Karush-Kuhn-Tucker conditions of the support vector classifier (see msm223)"
