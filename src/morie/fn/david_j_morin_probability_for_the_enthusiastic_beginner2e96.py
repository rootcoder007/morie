...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e96: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_96() -> Deprecated; use :func:`morie.fn.at_least_one_of_iid` instead."
