...
def bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_602(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.bookadvanced_elementsofstatisticallearning3u602.bookadvanced_elementsofstatisticallearning_chapter_3_unnumbered_602 is not implemented yet: its former body returned a "
