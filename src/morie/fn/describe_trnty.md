...
`print(result)` render. See `morie.fn.describe('trnty')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.trnty import *
import numpy as np
# See the function signature in fn/trnty.py for argument names.
```
