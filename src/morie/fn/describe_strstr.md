...
`print(result)` render. See `morie.fn.describe('strstr')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.strstr import *
import numpy as np
# See the function signature in fn/strstr.py for argument names.
```
