...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner2e24: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_24() -> Deprecated; use :func:`morie.fn.classify_events` instead."
