...
def stiag(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stiag.stiag is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stiag({}) -> Iaco-Cesare space-time covariance."
