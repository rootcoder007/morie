...
def rfani(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rfani.rfani is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rfani({}) -> Anisotropic random field with rotation."
