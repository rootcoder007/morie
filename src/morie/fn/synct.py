...
def synthetic_control(Y, unit_id, time_id, treated_unit, treatment_time):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Synthetic control estimator for comparative case studies"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Synthetic control estimator for comparative case studies",
        }
    )
