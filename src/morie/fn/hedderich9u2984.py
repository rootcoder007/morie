...
def hedderich_chapter_9_unnumbered_2984(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.hedderich9u2984.hedderich_chapter_9_unnumbered_2984 is not implemented yet: its former body returned a "
