...
__all__ = ["wilcox_chapter_14_unnumbered_598"]


def wilcox_chapter_14_unnumbered_598(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: difference between the population correlation coefficients ( ρ 1 − ρ 2) is
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u598')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u598: Correlation expression (auto-extracted; see ref)."
