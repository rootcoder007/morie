...
def tmmk(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmmk.tmmk is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmmk({}) -> Mann-Kendall trend test with slope."
