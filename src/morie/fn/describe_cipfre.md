# describe('cipfre') — cipher_frequency
...
`print(result)` render. See `morie.fn.describe('cipfre')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.cipfre import *
import numpy as np
# See the function signature in fn/cipfre.py for argument names.
```
