# describe('information_theory_mackay28e22') — information_theory_mackay_chapter_28_equation_22
...
import numpy as np
result = information_theory_mackay_chapter_28_equation_22(np.random.default_rng(42).normal(0, 1, 100))
