# describe('spdjkr') — schabenberger_disjunctive_kriging
...
`print(result)` render. See `morie.fn.describe('spdjkr')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.spdjkr import *
import numpy as np
# See the function signature in fn/spdjkr.py for argument names.
```
