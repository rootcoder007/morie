...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r25e8: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_25_equation_8() -> Deprecated; use :func:`morie.fn.classification_indicator` instead."
