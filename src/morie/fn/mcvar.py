...
def mcvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.mcvar.mcvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "mcvar({}) -> Monte Carlo variance reduction techniques."
