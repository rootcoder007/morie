# describe('gh_c14_25') — ghosal_ibp_poisson
...
`print(result)` render. See `morie.fn.describe('gh_c14_25')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gh_c14_25 import *
import numpy as np
# See the function signature in fn/gh_c14_25.py for argument names.
```
