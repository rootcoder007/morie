...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e30: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_30() -> Deprecated; use :func:`morie.fn.exponential_crossing_time` instead."
