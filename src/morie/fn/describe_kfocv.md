...
`print(result)` render. See `morie.fn.describe('kfocv')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.kfocv import *
import numpy as np
# See the function signature in fn/kfocv.py for argument names.
```
