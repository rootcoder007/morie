...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner7e11: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_7_equation_11(a, kmax) -> Deprecated; use :func:`morie.fn.poissum1` instead."
