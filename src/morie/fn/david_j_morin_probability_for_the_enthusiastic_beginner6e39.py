...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e39: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_39(m, xavg) -> Deprecated; use :func:`morie.fn.groupavg` instead."
