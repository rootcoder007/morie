# describe('guide_on_data_analysis1e10') — guide_on_data_analysis_chapter_1_equation_10
...
import numpy as np
result = guide_on_data_analysis_chapter_1_equation_10(np.random.default_rng(42).normal(0, 1, 100))
