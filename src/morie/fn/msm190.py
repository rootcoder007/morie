...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_18"]

mvsml_ridge_lasso_elastic_eq_9_18 = qplincon


def cheatsheet():
    return "msm190: Quadratic program under one linear inequality (see msm188)"
