...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e22: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_22() -> Deprecated; use :func:`morie.fn.bernoulli_variance` instead."
