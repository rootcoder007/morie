...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_37(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).
...
def cheatsheet():
    return "christopher_gandrud_author_reproducible_research_with_r_and_4u37() -> GeneralStatistics expression (auto-extracted; see ref)"
