...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_14(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: fert_long_sub$fert_cons_group[fert_cons >= 81 &
...
def cheatsheet():
    return 'christopher_gandrud_author_reproducible_research_with_r_and_4u14() -> GeneralStatistics expression (auto-extracted; see ref)'
