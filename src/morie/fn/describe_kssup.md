...
`print(result)` render. See `morie.fn.describe('kssup')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.kssup import *
import numpy as np
# See the function signature in fn/kssup.py for argument names.
```
