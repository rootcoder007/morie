...
def ghosal_beta_ker(x):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Beta kernel for bounded-support DPM density estimation"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Beta kernel for bounded-support DPM density estimation",
        }
    )
