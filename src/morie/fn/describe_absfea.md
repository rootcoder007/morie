# describe('absfea') — absorption_features
...
`print(result)` render. See `morie.fn.describe('absfea')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.absfea import *
import numpy as np
# See the function signature in fn/absfea.py for argument names.
```
