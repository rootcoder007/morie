# describe('damatt') — damped_attenuation
...
`print(result)` render. See `morie.fn.describe('damatt')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.damatt import *
import numpy as np
# See the function signature in fn/damatt.py for argument names.
```
