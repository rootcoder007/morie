...
`print(result)` render. See `morie.fn.describe('cvsbas')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.cvsbas import *
import numpy as np
# See the function signature in fn/cvsbas.py for argument names.
```
