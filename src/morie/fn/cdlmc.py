...
def cdlmc(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdlmc.cdlmc is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdlmc({}) -> Linear model of co-regionalization simulation."
