...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e35: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_35(ns, N) -> Deprecated; use :func:`morie.fn.multinom` instead."
