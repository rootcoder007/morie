# describe('parmat') — partial_corr_matrix
...
`print(result)` render. See `morie.fn.describe('parmat')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.parmat import *
import numpy as np
# See the function signature in fn/parmat.py for argument names.
```
