...
__all__ = ["svmkkt", "mvsml_ridge_lasso_elastic_eq_9_42"]

mvsml_ridge_lasso_elastic_eq_9_42 = svmkkt


def cheatsheet():
    return "msm227: Karush-Kuhn-Tucker conditions of the support vector classifier (see msm223)"
