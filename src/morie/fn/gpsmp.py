...
def gpsmp(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpsmp.gpsmp is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpsmp({}) -> GP prior sample path generation."
