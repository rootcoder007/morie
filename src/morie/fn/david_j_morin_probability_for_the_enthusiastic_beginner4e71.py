...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e71: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_71() -> Deprecated; use :func:`morie.fn.hypergeometric_pmf` instead."
