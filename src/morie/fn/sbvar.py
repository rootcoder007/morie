...
def sbvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbvar.sbvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbvar({}) -> Spatial bootstrap variance estimation."
