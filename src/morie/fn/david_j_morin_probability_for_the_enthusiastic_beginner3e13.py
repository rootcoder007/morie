...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e13: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_13() -> Deprecated; use :func:`morie.fn.expectation_linear` instead."
