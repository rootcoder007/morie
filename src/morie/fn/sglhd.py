...
def sglhd(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sglhd.sglhd is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sglhd({}) -> SGS Latin hypercube stratified sampling."
