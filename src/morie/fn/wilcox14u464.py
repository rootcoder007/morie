...
__all__ = ["wilcox_chapter_14_unnumbered_464"]


def wilcox_chapter_14_unnumbered_464(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: command pwr.r.test(r=0.5,power=0.80,sig.level=0.01) returns
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u464')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u464: Correlation expression (auto-extracted; see ref)."
