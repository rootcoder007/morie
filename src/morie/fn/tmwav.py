...
def tmwav(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmwav.tmwav is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmwav({}) -> Wavelet temporal detrending."
