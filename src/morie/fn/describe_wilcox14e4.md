# describe('wilcox14e4') — wilcox_chapter_14_equation_4
...
standard normal distribution when β 1 = β 0 = 0. Then, for a given sample size, n, a
...
import numpy as np
result = wilcox_chapter_14_equation_4(np.random.default_rng(42).normal(0, 1, 100))
