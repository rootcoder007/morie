# describe('guide_on_data_analysis3u119') — guide_on_data_analysis_chapter_3_unnumbered_119
...
import numpy as np
result = guide_on_data_analysis_chapter_3_unnumbered_119(np.random.default_rng(42).normal(0, 1, 100))
