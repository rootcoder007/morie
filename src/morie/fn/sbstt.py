...
def sbstt(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbstt.sbstt is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbstt({}) -> Stationary bootstrap spatial autocorrelated."
