...
def schabenberger_cov_param_estimation_kriging(coords, z, variogram_model):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Covariance parameter estimation for kriging (LS, ML, REML)"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Covariance parameter estimation for kriging (LS, ML, REML)",
        }
    )
