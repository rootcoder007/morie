...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e21: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_21() -> Deprecated; use :func:`morie.fn.coinvar` instead."
