...
def mcsbs(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.mcsbs.mcsbs is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "mcsbs({}) -> Monte Carlo sample-based simulation."
