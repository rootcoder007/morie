...
def cdblk(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdblk.cdblk is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdblk({}) -> Conditional block simulation averaging."
