...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e57: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_57() -> Deprecated; use :func:`morie.fn.stars_and_bars` instead."
