...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo4e3: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_4_equation_3() -> Deprecated; use :func:`morie.fn.poisson_loglik` instead."
