...
def lucnd(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.lucnd.lucnd is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "lucnd({}) -> LU conditional simulation update step."
