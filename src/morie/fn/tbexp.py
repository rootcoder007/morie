...
def tbexp(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbexp.tbexp is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbexp({}) -> Turning bands exponential covariance."
