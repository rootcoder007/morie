...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e38: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_38() -> Deprecated; use :func:`morie.fn.retestiq` instead."
