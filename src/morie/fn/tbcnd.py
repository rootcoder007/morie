...
def tbcnd(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbcnd.tbcnd is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbcnd({}) -> Turning bands conditional simulation."
