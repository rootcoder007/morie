...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo1e7: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_1_equation_7() -> Deprecated; use :func:`morie.fn.pearson_chi2_two_groups` instead."
