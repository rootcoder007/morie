...
`print(result)` render. See `morie.fn.describe('moncar')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.moncar import *
import numpy as np
# See the function signature in fn/moncar.py for argument names.
```
