# describe('expsm') — exponential_smooth
...
`print(result)` render. See `morie.fn.describe('expsm')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.expsm import *
import numpy as np
# See the function signature in fn/expsm.py for argument names.
```
