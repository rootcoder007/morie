...
__all__ = ["wilcox_chapter_13_unnumbered_1141"]


def wilcox_chapter_13_unnumbered_1141(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: rplotCIv2(x,y,tr=0.2, fr=0.5, p.crit=NA, plotit=TRUE, scat=TRUE, SEED=TRUE,
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox13u1141')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1141: Correlation expression (auto-extracted; see ref)."
