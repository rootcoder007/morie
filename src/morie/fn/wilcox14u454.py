...
__all__ = ["wilcox_chapter_14_unnumbered_454"]


def wilcox_chapter_14_unnumbered_454(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: ρ = 0.8. In the right panel, again X andY are normal, but now ρ = 0.2. So under normality,
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u454')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u454: Correlation expression (auto-extracted; see ref)."
