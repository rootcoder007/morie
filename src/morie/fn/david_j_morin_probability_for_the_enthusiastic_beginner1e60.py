...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e60: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_60(n, k) -> Deprecated; use :func:`morie.fn.pascalid` instead."
