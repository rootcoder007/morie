...
`print(result)` render. See `morie.fn.describe('lsbemb')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.lsbemb import *
import numpy as np
# See the function signature in fn/lsbemb.py for argument names.
```
