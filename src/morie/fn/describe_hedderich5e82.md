# describe('hedderich5e82') — hedderich_chapter_5_equation_82
...
[EQ] F (n) = P (X≤n) = 1−(1−p)n for n = 1, 2, 3,... (5.82)
...
import numpy as np
result = hedderich_chapter_5_equation_82(np.random.default_rng(42).normal(0, 1, 100))
