...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r24e1: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_24_equation_1() -> Deprecated; use :func:`morie.fn.nested_anova_prediction` instead."
