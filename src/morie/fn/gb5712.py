...
def gibbons_wsrt_power(theta, n, alpha, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Power function of Wilcoxon signed-rank test under location shift"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Power function of Wilcoxon signed-rank test under location shift"})
