...
`print(result)` render. See `morie.fn.describe('ravsco')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.ravsco import *
import numpy as np
# See the function signature in fn/ravsco.py for argument names.
```
