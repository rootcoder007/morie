...
def sbmov(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbmov.sbmov is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbmov({}) -> Moving block bootstrap spatial."
