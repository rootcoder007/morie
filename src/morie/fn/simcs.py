...
def simcs(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.simcs.simcs is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "simcs({}) -> SIS Markov chain categorical simulation."
