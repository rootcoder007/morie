...
def sgvar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sgvar.sgvar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sgvar({}) -> SGS variance from ensemble of realizations."
