# describe('guide_on_data_analysis7u567') — guide_on_data_analysis_chapter_7_unnumbered_567
...
import numpy as np
result = guide_on_data_analysis_chapter_7_unnumbered_567(np.random.default_rng(42).normal(0, 1, 100))
