...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_24"]

mvsml_ridge_lasso_elastic_eq_9_24 = qplincon


def cheatsheet():
    return "msm196: Quadratic program under one linear inequality (see msm188)"
