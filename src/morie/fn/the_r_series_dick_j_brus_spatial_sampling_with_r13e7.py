...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r13e7: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_13_equation_7() -> Deprecated; use :func:`morie.fn.mean_semivariance_equal_area` instead."
