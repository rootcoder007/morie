...
def sbpiv(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sbpiv.sbpiv is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sbpiv({}) -> Spatial bootstrap pivotal confidence interval."
