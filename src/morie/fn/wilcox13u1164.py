...
__all__ = ["wilcox_chapter_13_unnumbered_1164"]


def wilcox_chapter_13_unnumbered_1164(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: decreases as X increases. In addition, ρ s = −1 if the association is monotonic decreasing
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox13u1164')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1164: Correlation expression (auto-extracted; see ref)."
