...
__all__ = ["wilcox_chapter_13_unnumbered_1160"]


def wilcox_chapter_13_unnumbered_1160(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: Kij = −1. Kendall’s tau is the average of all Kij values for which i < j. More succinctly,
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox13u1160')`` for the full guide.
...
def cheatsheet():
    return "wilcox13u1160: Association expression (auto-extracted; see ref)."
