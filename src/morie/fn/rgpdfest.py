...
def rangayyan_pdf_estimate(x, bins, bw):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Probability density function estimation of VAG signals"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Probability density function estimation of VAG signals",
        }
    )
