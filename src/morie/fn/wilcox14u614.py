...
__all__ = ["wilcox_chapter_14_unnumbered_614"]


def wilcox_chapter_14_unnumbered_614(x):
    """
    PowerAndDesign expression (auto-extracted; see ref).

    Formula: power.prop.test(n = NULL, p1 = NULL, p2 = NULL, sig.level = 0.05, power =
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u614')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u614: PowerAndDesign expression (auto-extracted; see ref)."
