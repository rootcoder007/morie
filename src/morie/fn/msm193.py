...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_21"]

mvsml_ridge_lasso_elastic_eq_9_21 = qplincon


def cheatsheet():
    return "msm193: Quadratic program under one linear inequality (see msm188)"
