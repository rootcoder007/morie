...
def sivar(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sivar.sivar is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sivar({}) -> SIS variogram indicator reproduction."
