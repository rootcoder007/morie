...
`print(result)` render. See `morie.fn.describe('jamste')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.jamste import *
import numpy as np
# See the function signature in fn/jamste.py for argument names.
```
