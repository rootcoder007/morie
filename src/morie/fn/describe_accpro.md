# describe('accpro') — acceleration_profile
...
`print(result)` render. See `morie.fn.describe('accpro')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.accpro import *
import numpy as np
# See the function signature in fn/accpro.py for argument names.
```
