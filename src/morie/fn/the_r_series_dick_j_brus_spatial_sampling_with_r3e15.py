...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r3e15: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_3_equation_15() -> Deprecated; use :func:`morie.fn.confidence_interval` instead."
