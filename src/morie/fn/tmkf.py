...
def tmkf(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmkf.tmkf is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmkf({}) -> Kalman filter temporal state estimation."
