...
def ghosal_gauss_ker(x):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "Gaussian location-scale kernel for DPM density estimation"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "Gaussian location-scale kernel for DPM density estimation",
        }
    )
