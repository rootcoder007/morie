...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r7e11: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_7_equation_11() -> Deprecated; use :func:`morie.fn.twostage_optimal_n_budget` instead."
