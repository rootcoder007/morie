# describe('b201') — burkov_lm_ch2_categorical_cross_entropy
...
`print(result)` render. See `morie.fn.describe('b201')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.b201 import *
import numpy as np
# See the function signature in fn/b201.py for argument names.
```
