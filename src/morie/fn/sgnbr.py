...
def sgnbr(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.sgnbr.sgnbr is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "sgnbr({}) -> SGS neighborhood search for conditioning data."
