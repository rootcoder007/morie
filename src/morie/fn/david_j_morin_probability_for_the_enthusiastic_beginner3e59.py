...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e59: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_59(values, probs) -> Deprecated; use :func:`morie.fn.pmfvar` instead."
