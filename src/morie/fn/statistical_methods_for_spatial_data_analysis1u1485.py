...
__all__ = ["statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1485"]
...
def cheatsheet():
    return "statistical_methods_for_spatial_data_analysis1u1485: GeneralStatistics expression (auto-extracted; see ref)."
