# describe('paldet') — palindrome_detect
...
`print(result)` render. See `morie.fn.describe('paldet')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.paldet import *
import numpy as np
# See the function signature in fn/paldet.py for argument names.
```
