...
def lusim(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.lusim.lusim is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "lusim({}) -> LU decomposition Gaussian field simulation."
