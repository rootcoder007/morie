...
__all__ = ["wilcox_chapter_15_unnumbered_1394"]


def wilcox_chapter_15_unnumbered_1394(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: ith and jth measures. Then the correlation matrix is R = (rij). If p = 3, r12 =.2, r13 =.4
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox15u1394')`` for the full guide.
...
def cheatsheet():
    return "wilcox15u1394: Correlation expression (auto-extracted; see ref)."
