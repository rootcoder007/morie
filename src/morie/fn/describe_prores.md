# describe('prores') — probability_resample
...
`print(result)` render. See `morie.fn.describe('prores')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.prores import *
import numpy as np
# See the function signature in fn/prores.py for argument names.
```
