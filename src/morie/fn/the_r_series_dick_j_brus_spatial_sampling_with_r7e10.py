...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r7e10: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_7_equation_10() -> Deprecated; use :func:`morie.fn.twostage_optimal_m` instead."
