...
`print(result)` render. See `morie.fn.describe('winros')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.winros import *
import numpy as np
# See the function signature in fn/winros.py for argument names.
```
