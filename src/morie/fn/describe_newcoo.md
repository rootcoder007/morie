# describe('newcoo') — newton_cooling
...
`print(result)` render. See `morie.fn.describe('newcoo')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.newcoo import *
import numpy as np
# See the function signature in fn/newcoo.py for argument names.
```
