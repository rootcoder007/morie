...
def fauzi_b3_coefficient(t, g_func, density):
    ...
    if n < 1:
        return RichResult(
            payload={"estimate": np.nan, "n": 0, "method": "b_3(t) coefficient in cumulative survival estimator 2 bias"}
        )
    ...
    return RichResult(
        payload={
            ...
            "n": n,
            "method": "b_3(t) coefficient in cumulative survival estimator 2 bias",
        }
    )
