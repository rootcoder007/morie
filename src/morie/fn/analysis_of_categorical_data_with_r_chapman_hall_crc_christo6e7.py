...
def cheatsheet() -> str:
    return "analysis_of_categorical_data_with_r_chapman_hall_crc_christo6e7: analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_6_equation_7() -> Deprecated; use :func:`morie.fn.weighted_category_total` instead."
