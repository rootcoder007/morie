...
def tbbnd(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tbbnd.tbbnd is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tbbnd({}) -> Turning bands line process generator."
