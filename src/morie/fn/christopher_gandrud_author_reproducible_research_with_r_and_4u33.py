...
def christopher_gandrud_author_reproducible_research_with_r_and__chapter_4_unnumbered_33(x, cdf=None):
    """
    GeneralStatistics expression (auto-extracted; see ref).

    Formula: <<Global, include=FALSE>>=
...
def cheatsheet():
    return "christopher_gandrud_author_reproducible_research_with_r_and_4u33() -> GeneralStatistics expression (auto-extracted; see ref)"
