...
__all__ = ["information_theory_mackay_chapter_26_unnumbered_211"]


def information_theory_mackay_chapter_26_unnumbered_211(x, y=None):
    """
    Association expression (auto-extracted; see ref).

    Formula: which gives S = 244,K=S = 41,
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('information_theory_mackay26u211')`` for the full guide.
...
def cheatsheet():
    return "information_theory_mackay26u211: Association expression (auto-extracted; see ref)."
