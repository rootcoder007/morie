...
def cheatsheet() -> str:
    return "the_r_series_dick_j_brus_spatial_sampling_with_r9e2: the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_9_equation_2() -> Deprecated; use :func:`morie.fn.regression_total` instead."
