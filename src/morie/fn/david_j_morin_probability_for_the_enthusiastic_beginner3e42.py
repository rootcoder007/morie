...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e42: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_42(sigma_x, sigma_y) -> Deprecated; use :func:`morie.fn.sdsum` instead."
