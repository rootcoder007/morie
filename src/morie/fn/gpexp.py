...
def gpexp(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpexp.gpexp is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpexp({}) -> GP squared exponential kernel regression."
