...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner1e3: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_1_equation_3() -> Deprecated; use :func:`morie.fn.permutations_count` instead."
