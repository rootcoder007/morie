...
def wilcox_chapter_14_unnumbered_489(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: to reject H0 : ρ = 0 at the α = 0.05 level using Student’s T. So we fail to conclude that
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u489')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u489: Correlation expression (auto-extracted; see ref)."
