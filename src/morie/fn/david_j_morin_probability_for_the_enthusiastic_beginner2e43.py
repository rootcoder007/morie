...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_2_equation_43() -> Deprecated; use :func:`morie.fn.at_most_two_suits_probability` instead."
