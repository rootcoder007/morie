# describe('trusvd') — svd_rank_reduce
...
`print(result)` render. See `morie.fn.describe('trusvd')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.trusvd import *
import numpy as np
# See the function signature in fn/trusvd.py for argument names.
```
