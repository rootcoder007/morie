...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1686(x, y=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('statistical_methods_for_spatial_data_analysis1u1686')`` for the full guide.
    ...
    raise NotImplementedError(
        "morie.fn.statistical_methods_for_spatial_data_analysis1u1686.statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1686 is not implemented yet: its former body returned a "
