...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner6e5: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_6_equation_5(m, sigma_x, sigma_z) -> Deprecated; use :func:`morie.fn.linmodel` instead."
