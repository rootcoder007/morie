# describe('ca3u81') — ca_chapter_3_unnumbered_81
...
```python
from morie.fn.ca3u81 import ca_chapter_3_unnumbered_81
import numpy as np
result = ca_chapter_3_unnumbered_81(np.random.default_rng(42).normal(0, 1, 100))
