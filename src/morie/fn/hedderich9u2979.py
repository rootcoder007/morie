...
__all__ = ["hedderich_chapter_9_unnumbered_2979"]


def hedderich_chapter_9_unnumbered_2979(x):
    """
    ContingencyTables expression (auto-extracted; see ref).

    Formula: [EQ] LU = ˆχ2/[1−(3/2n)] (7.360a)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('hedderich9u2979')`` for the full guide.
...
def cheatsheet():
    return "hedderich9u2979: ContingencyTables expression (auto-extracted; see ref)."
