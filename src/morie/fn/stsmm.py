...
def stsmm(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.stsmm.stsmm is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "stsmm({}) -> Space-time sum-metric covariance."
