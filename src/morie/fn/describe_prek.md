...
`print(result)` render. See `morie.fn.describe('prek')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.prek import *
import numpy as np
# See the function signature in fn/prek.py for argument names.
```
