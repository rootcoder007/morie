...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_25"]

mvsml_ridge_lasso_elastic_eq_9_25 = qplincon


def cheatsheet():
    return "msm197: Quadratic program under one linear inequality (see msm188)"
