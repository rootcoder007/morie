...
def gpclf(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.gpclf.gpclf is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "gpclf({}) -> GP binary classification Laplace approx."
