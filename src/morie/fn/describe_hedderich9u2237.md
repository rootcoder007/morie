# describe('hedderich9u2237') — hedderich_chapter_9_unnumbered_2237
...
H0 : λi =λ0 (for alli = 1,...,k ) against HA : λi̸=λ0 (for at least onei) .
...
import numpy as np
result = hedderich_chapter_9_unnumbered_2237(np.random.default_rng(42).normal(0, 1, 100))
