...
def manski_no_assumption_outcome(y, D, X, y_min, y_max):
    ...
    across strata; it is reported separately, never merged into the
    first pair, and is flagged empty when the strata disagree.
    ...
    RichResult
        ...
        ``inter_upper``, ``inter_empty``, ``n_strata``, ``n``.
    ...
    return RichResult(payload={
        ...
        "inter_lower": ilo, "inter_upper": ihi,
        "inter_empty": 1.0 if ilo > ihi else 0.0,
        "n_strata": len(levels), "n": n,
