...
__all__ = ["wolfedual", "mvsml_ridge_lasso_elastic_eq_9_14"]

mvsml_ridge_lasso_elastic_eq_9_14 = wolfedual


def cheatsheet():
    return "msm187: Wolfe dual of a constrained program (see msm184)"
