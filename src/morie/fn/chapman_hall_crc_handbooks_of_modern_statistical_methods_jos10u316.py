...
__all__ = ["chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_316"]


def chapman_hall_crc_handbooks_of_modern_statistical_methods_jos_chapter_10_unnumbered_316(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: p K = 2p + 1 κΓ,α Bonferroni
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u316')`` for the full guide.
...
def cheatsheet():
    return "chapman_hall_crc_handbooks_of_modern_statistical_methods_jos10u316: Correlation expression (auto-extracted; see ref)."
