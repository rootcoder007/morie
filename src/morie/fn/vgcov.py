...
def covariogram(coords, values, *, nbins=15):
    """Covariogram function
    ...
    return SpatialResult(
        ...
        statistic=sill,
        p_value=None,
        extra={"lags": lags, "gamma": gamma, "sill": sill, "ci_low": None, "ci_high": None, "method": "covariogram"},
    )
...
def cheatsheet() -> str:
    return "covariogram({}) -> Covariogram function"
