...
def gibbons_chi2_yates(table, cdf=None):
    ...
    if n < 2:
        return RichResult(payload={"statistic": np.nan, "p_value": np.nan, "n": n, "method": "Yates continuity correction for 2x2 chi-square test"})
    ...
    return RichResult(payload={"statistic": float(statistic), "p_value": float(p_value), "n": n, "method": "Yates continuity correction for 2x2 chi-square test"})
