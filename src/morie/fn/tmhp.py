...
def tmhp(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.tmhp.tmhp is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "tmhp({}) -> Hodrick-Prescott temporal trend filter."
