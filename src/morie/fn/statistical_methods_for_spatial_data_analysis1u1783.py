...
def statistical_methods_for_spatial_data_analysis_chapter_1_unnumbered_1783(x, cdf=None):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('statistical_methods_for_spatial_data_analysis1u1783')`` for the full guide.
...
def cheatsheet():
    return (
        "statistical_methods_for_spatial_data_analysis1u1783: GeneralStatistics expression (auto-extracted; see ref)."
    )
