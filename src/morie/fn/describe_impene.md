...
`print(result)` render. See `morie.fn.describe('impene')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.impene import *
import numpy as np
# See the function signature in fn/impene.py for argument names.
```
