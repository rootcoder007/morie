# describe('gb_frs') — gibbons_friedman_chi2_approp
...
`print(result)` render. See `morie.fn.describe('gb_frs')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.gb_frs import *
import numpy as np
# See the function signature in fn/gb_frs.py for argument names.
```
