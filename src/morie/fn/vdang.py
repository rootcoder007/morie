...
def vdang(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.vdang.vdang is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "vdang({}) -> Delaunay angle quality check."
