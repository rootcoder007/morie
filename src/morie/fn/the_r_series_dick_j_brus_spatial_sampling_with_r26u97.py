...
def the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_26_unnumbered_97(x, y=None):
    ...
    raise NotImplementedError(
        "morie.fn.the_r_series_dick_j_brus_spatial_sampling_with_r26u97.the_r_series_dick_j_brus_spatial_sampling_with_r_chapter_26_unnumbered_97 is not implemented yet: its former body returned a "
