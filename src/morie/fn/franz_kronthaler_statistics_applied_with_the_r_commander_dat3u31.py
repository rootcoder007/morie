...
def franz_kronthaler_statistics_applied_with_the_r_commander_dat_chapter_3_unnumbered_31(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] 1 − (−0.29)2 =− 0.74
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('franz_kronthaler_statistics_applied_with_the_r_commander_dat3u31')`` for the full guide.
...
def cheatsheet():
    return "franz_kronthaler_statistics_applied_with_the_r_commander_dat3u31: Correlation expression (auto-extracted; see ref)."
