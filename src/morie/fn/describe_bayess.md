# describe('bayess') — effective_sample_size_bayes
...
`print(result)` render. See `morie.fn.describe('bayess')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.bayess import *
import numpy as np
# See the function signature in fn/bayess.py for argument names.
```
