...
def nnvor(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.nnvor.nnvor is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "nnvor({}) -> Voronoi-based natural neighbor weights."
