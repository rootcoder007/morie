...
def analysis_of_categorical_data_with_r_chapman_hall_crc_christo_chapter_2_unnumbered_88(x):
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('analysis_of_categorical_data_with_r_chapman_hall_crc_christo2u88')`` for the full guide.
...
def cheatsheet():
    return (
        "analysis_of_categorical_data_with_r_chapman_hall_crc_christo2u88: ANOVA expression (auto-extracted; see ref)."
    )
