...
def cdsim(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.cdsim.cdsim is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "cdsim({}) -> Conditional simulation at data locations."
