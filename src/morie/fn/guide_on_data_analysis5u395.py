...
__all__ = ["guide_on_data_analysis_chapter_5_unnumbered_395"]


def guide_on_data_analysis_chapter_5_unnumbered_395(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] #> DW = 1.3624, p-value = 0.02061
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('guide_on_data_analysis5u395')`` for the full guide.
...
def cheatsheet():
    return "guide_on_data_analysis5u395: Correlation expression (auto-extracted; see ref)."
