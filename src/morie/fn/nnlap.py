...
def nnlap(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.nnlap.nnlap is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "nnlap({}) -> Laplace / non-Sibsonian natural neighbor."
