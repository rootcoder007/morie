...
def david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_31(variances):
    ...
    warnings.warn(
        "david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_31() is the book-coordinate name for varsum(); "
...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner3e31: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_3_equation_31(variances) -> Deprecated; use :func:`morie.fn.varsum` instead."
