...
def cheatsheet() -> str:
    return "david_j_morin_probability_for_the_enthusiastic_beginner4e95: david_j_morin_probability_for_the_enthusiastic_beginner_chapter_4_equation_95(n, p) -> Deprecated; use :func:`morie.fn.poispeak` instead."
