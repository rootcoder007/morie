...
def rbfcv(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.rbfcv.rbfcv is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "rbfcv({}) -> RBF cross-validation shape parameter."
