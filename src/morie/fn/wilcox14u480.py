...
__all__ = ["wilcox_chapter_14_unnumbered_480"]


def wilcox_chapter_14_unnumbered_480(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: confidence interval of ( −0.503 , −0.008). So now reject H0 : ρ = 0 (because the confidence
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('wilcox14u480')`` for the full guide.
...
def cheatsheet():
    return "wilcox14u480: Correlation expression (auto-extracted; see ref)."
