# describe('lifpol') — lift_drag_polar
...
`print(result)` render. See `morie.fn.describe('lifpol')` for guidance.

## WORKED EXAMPLE

```python
from morie.fn.lifpol import *
import numpy as np
# See the function signature in fn/lifpol.py for argument names.
```
