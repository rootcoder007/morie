...
__all__ = ["qplincon", "mvsml_ridge_lasso_elastic_eq_9_26"]

mvsml_ridge_lasso_elastic_eq_9_26 = qplincon


def cheatsheet():
    return "msm198: Quadratic program under one linear inequality (see msm188)"
