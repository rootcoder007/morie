...
def simdk(data=None, coords=None, n=100, seed=42, **kwargs):
    ...
    **kwargs
    ...
    raise NotImplementedError(
        "morie.fn.simdk.simdk is not implemented yet: its former body returned a "
...
def cheatsheet() -> str:
    return "simdk({}) -> SIS median indicator kriging variant."
