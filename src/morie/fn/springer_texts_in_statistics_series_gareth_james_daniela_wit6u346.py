...
__all__ = ["springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_346"]


def springer_texts_in_statistics_series_gareth_james_daniela_wit_chapter_6_unnumbered_346(x, y=None):
    """
    Correlation expression (auto-extracted; see ref).

    Formula: [EQ] > x=matrix(rnorm (30*3), ncol=3)
    ...
    result : RichResult
        ...
        See ``morie.fn.describe('springer_texts_in_statistics_series_gareth_james_daniela_wit6u346')`` for the full guide.
...
def cheatsheet():
    return "springer_texts_in_statistics_series_gareth_james_daniela_wit6u346: Correlation expression (auto-extracted; see ref)."
