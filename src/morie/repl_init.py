...
def _inject_convenience(ns: dict) -> None:
    ...
    def ls():
        """List user variables."""
        skip = {"__name__", "__builtins__", "__doc__", "np", "pd", "morie"}
        user = {
    ...
    def run_module(name=None, **kwargs):
        ...
        if name is None:
            ...
            modules()
            return
        from morie.modules import run_module as _rm
    ...
    def doctor():
        ...
        from morie.doctor import run_doctor
    ...
    def version():
        ...
        print(f"  morie {getattr(morie, '__version__', 'dev')}")
