...
module (Numba-JIT'd $O(n)$ for the exponential kernel and parallel
$O(n^2)$ JIT path for non-Markovian kernels).  The \code{compare\_hawkes\_kernels}
routine fits all 8 (kernel $\times$ baseline) combinations and ranks by AIC:
