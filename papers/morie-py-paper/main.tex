...
Version~0.9.5.4 is released on the Python Package Index (PyPI)
at
...
The honest limits, as of v0.9.5.4: the \code{morie.crypto}
educational primitives ship on the \proglang{Python} side and
are planned as a native \proglang{R} + Rcpp port for v1.0.0;
the \code{morie.describe()} pedagogical narratives ship on the
\proglang{Python} side and an \proglang{R} equivalent is
planned for v0.9.5.5.
