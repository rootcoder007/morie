...
parity verified at v0.9.5.4.  The \code{missing\_stats} label
...
limits, as of v0.9.5.4: there is no \code{R6} class layer (an
earlier sketch was removed as needless complexity); there is
no CRAN binary (deliberate, pending a v1.0 freeze); the
cryptography subset is on a future-release roadmap; and the
\code{describe()} pedagogical narratives ship on the
\proglang{Python} side ahead of the \proglang{R} side, a
parity gap I will close.
