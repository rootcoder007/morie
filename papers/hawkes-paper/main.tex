...
The fitted $\hat\eta$ for property crime sits at $0.97$--$0.98$, pressed against the stationarity boundary.  The Filimonov--Sornette 2015 \citep{filimonov2015apparent} small-sample near-criticality bias is a real concern at these values; the time-rescaling residual diagnostics of §\ref{sec:gof} are the more reliable indicator of model adequacy than the point estimate of $\hat\eta$ alone.
...
(compiled-core likelihood path; full source at
...
\begin{CodeChunk}
\begin{CodeInput}
>>> from morie import morie_fetch_tps  # (R-side wrapper; Python uses raw CSV)
>>> import pandas as pd
