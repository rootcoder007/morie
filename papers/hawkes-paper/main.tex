...
pronounced /ˈmɔɪraɪ/ (``MOY-rye''), like the Greek \textit{Moirai},
...
paths for the non-Markovian kernels).  Section~\ref{sec:application}.B retains the original
$n=2{,}000$ sub-sample for backwards comparability with the prior sub-sampled analyses; readers seeking the canonical post-v0.2.1 Hawkes
...
Both tables are reproducible end-to-end from a fresh install of MORIE
