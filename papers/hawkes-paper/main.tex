...
\subsection{2019 contiguous-year re-fit (full-sample, JIT-accelerated)}\label{sec:application-2019}
...
(JIT-accelerated likelihood path; full source at
...
directly on the JIT-accelerated likelihood path, with no
