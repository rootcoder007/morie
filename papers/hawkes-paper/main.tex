...
\citep{Mohler2011,short2010pde}.  We follow the spatial-physics-of
...
\citep{bacry2015hawkes,gould2013limit}.  In urban crime data we
...
the Fates.}, and (c) apply the full
...
Following \citep{kwan2024ergodic,kwan2025nonstationary} we adopt an
...
$\Theta \subset \Rset^d$.  After the time change $N^n_t \defeq \tilde
...
The fitted $\hat\eta$ for the Assault series sits at $0.97$--$0.98$, pressed against the stationarity boundary.  The Filimonov--Sornette 2015 \citep{filimonov2015apparent} small-sample near-criticality bias is a real concern at these values; the time-rescaling residual diagnostics of §\ref{sec:gof} are the more reliable indicator of model adequacy than the point estimate of $\hat\eta$ alone.
...
We have given a self-contained derivation of the likelihood, score,
...
implemented the full machinery in \pkg{morie}.  Markovian and
